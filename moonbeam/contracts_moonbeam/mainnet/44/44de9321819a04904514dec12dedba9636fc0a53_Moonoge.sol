...
contract Moonoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Moonoge";
    string constant _symbol = "Moonoge";
    ...
    uint256 public _walletMax = 100 * 10**3 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x4e67854dABc07328a9F9ab00C606380886854b74;
        devWallet = 0x444b60A81067C98Ada9358686e0a82b2A4F7aF6B;
