...
contract NarwhalCurveRouter is INarwhalTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    ICurveRouter public constant curvePool = ICurveRouter(0xace58a26b8Db90498eF0330fDC9C2655db0C45E2);
    IERC20 public constant dai = IERC20(0xc234A67a4F840E61adE794be47de455361b52413); // 0
    IERC20 public constant usdc = IERC20(0x8f552a71EFE5eeFc207Bf75485b356A0b3f01eC9); // 1
