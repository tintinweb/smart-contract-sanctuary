...
contract TokenReserve is Ownable {
    using SafeERC20 for IERC20;

    IMultiFeeDistribution public feeDistribution;

    constructor(IMultiFeeDistribution _feeDistribution) {
    ...
    function distribute(IERC20 _token, uint256 _amount) external onlyOwner {
        require(_amount <= balance(_token), "Not enough fund");
        _token.safeIncreaseAllowance(address(feeDistribution), _amount);
        feeDistribution.notifyRewardAmount(_token, _amount);
    }
