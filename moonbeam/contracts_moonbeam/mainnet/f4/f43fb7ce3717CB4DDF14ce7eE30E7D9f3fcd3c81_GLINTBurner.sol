...
// File contracts/lpsplitter/GLINTBurner.sol
...
contract GLINTBurner is Ownable {
    ...
    function furnace() external {
        ...
        _swap(WGLMR, address(GLINT), wglmrBalance / 2, address(this)); // convert GLMR to GLINT for burning
        _swap(WGLMR, usdc, wglmrBalance / 2, address(this)); // convert GLMR to USDC for treasury
