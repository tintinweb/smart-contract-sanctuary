...
contract StrategyStellaXcDOTGLMRLp is StrategyStellaFarmBaseV2 {
    uint256 public xcDOT_glmr_poolId = 10;

    // Token addresses
    address public xcDOT_glmr_lp = 0xa927E1e1E044CA1D9fe1854585003477331fE2Af;
    address public xcDOT = 0xFfFFfFff1FcaCBd218EDc0EbA20Fc2308C778080;
    address public rewarderContract = 0x505b0A5458dd12605b84Bb2928Dd2BC5b44993b9;
        ...
        )
    {
        ...
        swapRoutes[xcDOT] = [glmr, xcDOT];
    }

    // **** Views ****

    function getName() external pure override returns (string memory) {
        return "StrategyStellaXcDOTGlmrLp";
    }
}
