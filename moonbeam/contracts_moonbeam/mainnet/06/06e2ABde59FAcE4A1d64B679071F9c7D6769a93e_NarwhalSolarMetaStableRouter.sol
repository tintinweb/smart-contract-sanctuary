...
// File: contracts/routes/NarwhalSolarMetaStableRouter.sol
...
contract NarwhalSolarMetaStableRouter is INarwhalTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    IStableSwap public constant pool = IStableSwap(0xBF9a163089eFcfF640ADE4B610232e6a10C8Cc82);
    IStableSwap public constant basePool = IStableSwap(0x91416C884190122F6D8911dE1Ef401cf2ADEC627);
    IERC20 public constant ust = IERC20(0x085416975fe14C2A731a97eC38B9bF8135231F62); // 0
    ...
    function trade(
        ...
        returns(uint256 _destAmount)
    {
        (uint256 i, uint256 j, bool toBase) = getTokenIndexes(_src, _dest);
        require(_src == ust || _dest == ust, "Source or Destination must be UST");
    ...
    function getTokenIndexes(
        ...
        public
        pure
        returns(uint256 i, uint256 j, bool toBase)
    {
