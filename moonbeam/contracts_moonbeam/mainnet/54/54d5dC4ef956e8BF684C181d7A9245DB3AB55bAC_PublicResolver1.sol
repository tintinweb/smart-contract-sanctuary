 ...
 * address.
 */
contract PublicResolver1 is Multicallable, ABIResolver, AddrResolver, ContentHashResolver, DNSResolver, InterfaceResolver, NameResolver, PubkeyResolver, TextResolver {
    ENS ens;
    ...
    function setApprovalForAll(address operator, bool approved) external{
        require(
            msg.sender != operator,
            "PublicResolver ERC1155: setting approval status for self"
        );
