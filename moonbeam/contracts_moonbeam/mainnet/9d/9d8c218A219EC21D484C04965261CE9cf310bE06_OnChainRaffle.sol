...
contract OnChainRaffle is RrpRequesterV0 {
    ...
    // select winners and remove them from the candidates array. This is not
    ...
    function selectWinners(uint256 winnerBatchSize) external onlyOwner {
        ...
        // uint256 batchSize = winners.length + winnerBatchSize <= MAX_WINNERS ? winnerBatchSize : MAX_WINNERS - winners.length;
     ...
     *       of 1500 and it's a view function.
     */
