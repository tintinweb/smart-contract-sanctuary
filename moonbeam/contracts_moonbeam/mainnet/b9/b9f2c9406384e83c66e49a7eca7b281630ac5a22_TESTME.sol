/**
 *Submitted for verification at moonbeam.moonscan.io on 2022-04-12
*/
...
contract TESTME is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "testme";
    string private constant _symbol = "testme";
    ...
    address payable private _marketingAddress = payable(0x4185B4b3c6C14189c31d2b65339Be0695968C056);
    address payable private _teamAddress = payable(0x3aC2C825bA8C04eff6A66D58A0753edc4FA56969);
    address payable private _devAddress = payable(0x0ADD752481BF1a63c19fd6Ee29f3C19C85080Ace);
    ...
    constructor() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x40F1fEF0Fe68Fd10ff904070ee00a7769EE7fe34);//ropstenn 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //bsc test 0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//bsc main net 0x10ED43C718714eb63d5aA57B78B54704E256024E);
