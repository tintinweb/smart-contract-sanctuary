...
contract CandleStickAuction is RrpRequesterV0 {
    ...
    uint256 public cooldownPeriod = 55 minutes; // only 1 request per hour is allowed
    ...
    function updateCooldown(uint256 cooldown) external onlyOwner {
