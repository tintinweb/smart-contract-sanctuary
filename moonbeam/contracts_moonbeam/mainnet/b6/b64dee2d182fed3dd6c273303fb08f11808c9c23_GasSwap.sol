...
// File contracts/gasless/EIP712Base.sol


pragma solidity ^0.8.7;
// Inspired by: https://github.com/maticnetwork/pos-portal/blob/master/contracts/common/NativeMetaTransaction.sol
...
// File contracts/gasless/EIP712MetaTransaction.sol

pragma solidity ^0.8.7;

// Inspired by: https://github.com/maticnetwork/pos-portal/blob/master/contracts/common/EIP712Base.sol
...
// File contracts/gasless/IStellaRouter.sol
...
// File contracts/gasless/IToken.sol
...
// File contracts/gasless/GasSwap.sol
...
contract GasSwap is Ownable, ReentrancyGuard, EIP712MetaTransaction("GasSwap", "2") {
    address public immutable WGLMR = 0xAcc15dC74880C9944775448304B263D191c6077F;
    ...
    IStellaRouter public stellaRouter;
    ...
    constructor(address router) {
        stellaRouter = IStellaRouter(router);
    }
    ...
    function changeRouter(address newTarget) external onlyOwner {
        ...
        stellaRouter = IStellaRouter(newTarget);
    }
    ...
    function swap(bytes calldata swapCallData) external nonReentrant returns (uint256) {
        ...
        require(path[path.length - 1] == WGLMR, "INVALID_OUTPUT_TOKEN");
        ...
        sellToken.approve(address(stellaRouter), amountIn);

        stellaRouter.swapExactTokensForETH(
            amountIn,
            amountOutMin,
            path,
            address(this),
