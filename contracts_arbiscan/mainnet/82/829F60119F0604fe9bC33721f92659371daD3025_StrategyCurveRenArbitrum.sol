...
// File: contracts/StrategyCurveRenArbitrum.sol
...
contract StrategyCurveRenArbitrum{
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = 0x3E01dD8a5E1fb3481F0F589056b428Fc308AF0Fb;

    address public constant CRV = 0x11cDb42B0EB46D95f990BeDD4695A6e3fA034978;

    address public reward = 0x11cDb42B0EB46D95f990BeDD4695A6e3fA034978;
    ...
    address public constant CURVE_POOL = 0x960ea3e3C7FB317332d990873d354E18d7645590;
    // Swap here
    ...
    function doAppovals() public {
        ...
        IERC20(WBTC).safeApprove(CURVE_POOL, type(uint256).max);
    }

    function getName() external pure returns (string memory) {
        return "StrategyCurveRenArbitrum";
    }
    ...
    function setGauge(address newGauge) external {
        ...
        ICurveGauge(GAUGE).deposit(IERC20(want).balanceOf(address(this)));
    }

    function deposit() public {
        ICurveGauge(GAUGE).deposit(balanceOfWant());
    }
    ...
    function harvest() public {
        ...
        uint256 rewardsToReinvest = IERC20(reward).balanceOf(address(this));
        ...
        ICurveStableSwapREN(CURVE_POOL).add_liquidity(
            [0, IERC20(WBTC).balanceOf(address(this)), 0],
            0
        );
