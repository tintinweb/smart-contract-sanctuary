/**
 *Submitted for verification at arbiscan.io on 2021-11-04
*/
...
contract ComboOracle_UniV2_UniV3 is Owned {
    ...
    constructor (
        ...
        collateral_address = _starting_addresses[2];

        // Oracle info
        combo_oracle = ComboOracle(_starting_addresses[3]);

        // UniV2 / SLP
        router = IUniswapV2Router02(_starting_addresses[4]);

        // UniV3
        univ3_factory = IUniswapV3Factory(_starting_addresses[5]);
        univ3_positions = INonfungiblePositionManager(_starting_addresses[6]);
        univ3_router = ISwapRouter(_starting_addresses[7]);
