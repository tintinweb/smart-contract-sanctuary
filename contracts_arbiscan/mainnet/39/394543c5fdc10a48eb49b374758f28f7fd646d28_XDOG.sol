...
contract XDOG is IERC20, Auth {
    ...
    string constant _name = "XDOG";
    string constant _symbol = "XDOG";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxBuyTxAmount = 50000 * (10 ** _decimals); 
    uint256 public _maxSellTxAmount = 50000 * (10 ** _decimals); 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x45BA29F2297d6607E4bD79A53A4f996b52600A51;
