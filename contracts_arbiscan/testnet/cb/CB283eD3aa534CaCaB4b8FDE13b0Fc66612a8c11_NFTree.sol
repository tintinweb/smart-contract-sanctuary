...
contract NFTree is ERC721Enumerable, Ownable {
    ...
    address private _artistAddress = 0x20712a28e98B3a8E8e49d267704514e6644CBF1b; 
    ...
    constructor() ERC721("test2", "test2") {
       ...
       //Declare all the christmasSpirit tiers
        //Tree
        TIERS[0] = [100, 900, 1000, 1000, 1000, 1000, 5000];
        //lights
        TIERS[1] = [100, 900, 1000, 8000]; 
        //Base
        TIERS[2] = [100, 900, 1000, 1000, 2000, 5000];
        //Tinsel
        TIERS[3] = [100, 900, 1000, 1000, 7000];
    }
   ...
   /**
        ...
        returns (string memory)
    {
        ...
        svgString = string(
            abi.encodePacked(
                '<svg id="c" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 17 22" > ',
                svgString,
                "<style>rect{width:1px;height:1px;}.c00{fill:#bc9dff}.c01{fill:#fff200}.c02{fill:#e3e3e3}.c03{fill:#ff3600}.c04{fill:#f2ff00}.c05{fill:#00ff1b}.c06{fill:#1b00ff}.c07{fill:#639bff}.c08{fill:#5fcde4}.c09{fill:#663931}.c10{fill:#99e550}.c11{fill:#d77bba}.c12{fill:#857bd7}.c13{fill:#df7426}.c14{fill:#f8e0da}.c15{fill:#ac3232}.c16{fill:#983030}.c17{fill:#ac3231}.c18{fill:#ddffc5}.c19{fill:#ffa6a6}.c20{fill:#ffffff}.c21{fill:#4b682e}.c22{fill:#7cdd90}.c23{fill:#fcffc0}.c24{fill:#b2dd93}.c25{fill:#fbf236}.c26{fill:#cfc72f}.c27{fill:#398a30}.c28{fill:#c0dbff}</style></svg>"
