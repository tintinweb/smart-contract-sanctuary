...
//    require(msg.sender == l2CustomGateway, "ONLY_l2CUSTOMGATEWAY");
   ...
   */
  function __MaviaTokenL2_init(address _l2CustomGateway, address _l1Address) public initializer {
   ...
   * @dev Bridge burn
   */
  function updateArbConfig(address _l2CustomGateway, address _l1Address) external onlyOwner {
    l2CustomGateway = _l2CustomGateway;
    l1Address = _l1Address;
  }
}
