...
contract Legion is Initializable, LegionState {
    ...
    function safeMint(address _to) external override onlyAdminOrOwner whenNotPaused returns(uint256) {
    ...
    function setTokenURI(uint256 _tokenId, string calldata _tokenURI) external onlyAdminOrOwner whenNotPaused {
...
abstract contract LegionState is Initializable, ILegion, AdminableUpgradeable, ERC721URIStorageUpgradeable {
    ...
    function __LegionState_init() internal initializer {
        ...
        ERC721Upgradeable.__ERC721_init("Legion", "LEGION");
