...
// ║╣ ╔╩╦╝║ ║╚╗╔╝║╣ ╠╦╝╚═╗║╣
// ╚═╝╩ ╚═╚═╝ ╚╝ ╚═╝╩╚═╚═╝╚═╝
contract Exoverse is ERC721Enumerable, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	string public _contractBaseURI = "https://api.xxxxxx.io/metadata/";
	...
	address[] private addressList = [
		0xdB2D562D3286B7D1FD86a2bA14802314F3c02661,
	...
	uint256[] private shareList = [7, 4, 6, 6];

	constructor() ERC721("EXOVERSE", "EVE") PaymentSplitter(addressList, shareList) {
	...
	/**
	 * @dev paid usage of EVE outside the blockchain
	 */
	function cAction(
		uint256 nftID,
		uint256 id,
