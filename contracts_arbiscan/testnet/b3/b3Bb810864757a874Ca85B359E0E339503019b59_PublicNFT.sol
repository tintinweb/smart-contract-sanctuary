...
contract PublicNFT is ERC721Enumerable, Ownable {
    ...
    function mintWithPrice(address toAddress, uint256 count, uint256 price) payable public {
      require(!locked, "It's locked");
      require(msg.value == price, "Payable wrong value");
      require(toAddress != address(0), "To address error");
      require(count > 0, "Count can't be 0");
