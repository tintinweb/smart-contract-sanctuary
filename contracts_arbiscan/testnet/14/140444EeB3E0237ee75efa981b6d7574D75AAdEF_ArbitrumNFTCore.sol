 ...
 */
contract ArbitrumNFTCore is ERC1967UpgradeUpgradeable, OwnableUpgradeable {
    // Mintable NFTs
    IL2NFT public gm;
    IL2NFT public ga;
    IL2NFT public gn;
    ...
    uint256 private claimedCounter; // Count of addresses which have claimed free NFTs
    ...
    function mintGN(bytes32[] memory merkleProof) external {
        require(
            xassetLev0.balanceOf(msg.sender) >= levValueThreshold ||
                ...
                xassetLev2.balanceOf(msg.sender) >= levValueThreshold
        );
        whitelistedAddresses.verify(msg.sender, merkleProof);
        gn.mint(msg.sender);
    }
    ...
    /**
     * Set minimum amount of xAsset3x tokens
