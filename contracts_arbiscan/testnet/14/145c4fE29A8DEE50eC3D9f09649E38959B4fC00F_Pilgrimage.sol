...
contract Pilgrimage is Initializable, PilgrimageTimeKeeper {
    ...
    whenNotPaused
    {
        ...
        emit PilgrimagesStarted(msg.sender, _pilgrimagesStarted, block.timestamp + pilgrimageLength);
...
abstract contract PilgrimageState is Initializable, IPilgrimage, AdminableUpgradeable {
    ...
    event PilgrimagesStarted(address indexed _user, uint256 indexed _numberStarted, uint256 indexed _finishTime);
