...
interface IMaviaNFT {
   ...
   * @dev Burnable
   */
  function fBurn(uint256 _id) external; //by BURNER_ROLE
}
...
contract MaviaNFT is ERC721Upgradeable, OwnableUpgradeable, AccessControlUpgradeable, IMaviaNFT, IMaviaCreator {
  ...
  /**
   * @dev Mint a new NFT
   * @param _pAccount Address of the token owner
   * @param _pId token id
   */
  function fMint(address _pAccount, uint256 _pId) external override onlyRole(MINTER_ROLE) {
