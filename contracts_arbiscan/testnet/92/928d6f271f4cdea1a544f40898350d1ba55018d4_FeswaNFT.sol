...
//    uint256 public constant OPEN_BID_DURATION = (3600 * 10);      // For test
    ...
    uint256 public constant AIRDROP_RATE_FOR_NEXT_BIDDER = 40_000;      // 10_000 / 1, BNB = 1; MATIC = 100 ; Arbitrum: 40_000

    // Airdrop rate for Bid winner: 50000 FESW/BNB
    uint256 public constant AIRDROP_RATE_FOR_WINNER = 200_000;          // 50_000 / 1; Arbitrum: 200_000

    // Minimum price increase for tender: 0.02 BNB
    uint256 public constant MINIMUM_PRICE_INCREACE = 5e15;              //  2e16 * 1; Arbitrum: 5e15

    // Max price for NFT sale: 100,000 BNB
    uint256 public constant MAX_SALE_PRICE = 250_000e18;                // 1000_000e18 * 1; Arbitrum: 250_000e18
