...
contract Data {
  ...
  function collect(uint256 _realmId) external {
    ...
    require(
      ...
      "Data: You are currently collecting"
    );
  ...
  function addToBuildQueue(
    ...
    require(_queueSlot < _limit, "Data: _queueSlot not available");
    require(
      block.timestamp > buildTime[_realmId][_queueSlot],
      "Data: You are currently building"
    );
  ...
  function remove(
    ...
    require(_amount <= data[_realmId][_type], "Data: Not enough metrics");
