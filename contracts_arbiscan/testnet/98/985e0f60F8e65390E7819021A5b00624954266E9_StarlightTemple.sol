...
contract StarlightTemple is Initializable, StarlightTempleContracts {
    ...
    whenNotPaused
    {
        ...
        for(uint256 i = 0; i < _numberOfConstellations; i++) {
            legionMetadataStore.increaseConstellationRank(_tokenId, Constellation(i), _maxConstellation);
        }
    }
...
abstract contract StarlightTempleState is Initializable, IStarlightTemple, ERC1155HolderUpgradeable, AdminableUpgradeable {
    ...
    function __StarlightTempleState_init() internal initializer {
        ...
        currentRankToNeededStarlight.push(10);
        currentRankToNeededStarlight.push(15);
        currentRankToNeededStarlight.push(20);
        currentRankToNeededStarlight.push(25);
        currentRankToNeededStarlight.push(30);
        currentRankToNeededStarlight.push(35);
        currentRankToNeededStarlight.push(40);
    }
}
