...
//$GANG is 100% owned by the community of Gutter Species
contract GANG is IGANG, Context, ERC20, ERC20Burnable, Ownable {
	mapping(address => bool) controllers;
	uint256 public MAX_SUPPLY = 9999999999 ether;

	constructor() ERC20("$GANG", "$GANG") {
		//no ico, no presale, no team allocation or any other fancy stuff
		//100% community owned
	}
	...
	//should call renounce ownership for permanent
	...
	function transferFrom(
		...
		address recipient,
		uint256 amount
	) public virtual override(ERC20, IGANG) returns (bool) {
