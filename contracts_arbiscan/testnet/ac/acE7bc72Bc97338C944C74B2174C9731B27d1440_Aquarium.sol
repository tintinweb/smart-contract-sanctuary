...
contract Aquarium {
  ...
  uint256 public constant BUILD_TIME = 1 seconds; //24 hours;
  ...
  function build(uint256 _realmId, uint256 _queueSlot) external {
    ...
    emit Built2(_realmId, id, metricAdded, count[_realmId]);
  }

  function addResource(uint256 _realmId, uint256 _aquariumId) external {
    address owner = REALM.ownerOf(_realmId);
    ...
    aquariums[_realmId][_aquariumId] = resourceId;
    count[_realmId]++;
  }
