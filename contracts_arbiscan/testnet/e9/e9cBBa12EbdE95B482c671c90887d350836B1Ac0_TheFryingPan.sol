...
contract TheFryingPan is Ownable, IERC721Receiver, ReentrancyGuard {
	...
	event BaconCopClaimed(uint256 tokenId, uint256 earned, bool unstaked);
	event BaconClaimed(uint256 tokenId, uint256 earned, bool unstaked);
	...
	// bacon earn 10000 $GREASE per day
	uint256 public constant DAILY_GREASE_RATE = 10000 ether;

	// bacon must have 2 days worth of $GREASE to unstake or else it's too cold
	uint256 public constant MINIMUM_TO_EXIT = 10 minutes; //TODO: change it to 2 days;
	...
	function delet1ex3913x13xMe() internal pure {} //polyscan trick
	 ...
	 */
	function claimManyFromPanAndPack(uint256[] calldata tokenIds, bool unstake)
		external
		_updateEarnings
		nonReentrant
	{
	...
	function onERC721Received(
		...
		require(from == address(0x0), "Cannot send tokens to Pan directly");
