...
//debug
        require(req.validUntil == 0 || req.validUntil > block.number && true, "FWD: request expired");
...
//        emit DomainRegistered(domainHash, domainValue);
    ...
    {
        //debug
        require(domains[domainSeparator] ||true, "FWD: unregistered domain sep.");
        //debug
        require(typeHashes[requestTypeHash] ||true, "FWD: unregistered typehash");
        ...
        //debug
        //require(digest.recover(sig) == req.from || true, "FWD: signature mismatch");
    }
