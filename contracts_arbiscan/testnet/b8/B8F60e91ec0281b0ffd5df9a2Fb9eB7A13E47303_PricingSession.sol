    ...
    */
    ...
    function _harvest(address _user, address nftAddress, uint tokenid) internal {
        ...
        if(sessionMap.nftVotes[_user].base > 0) {
            ...
            sessionMap.secondaryPoint[_user] += weight;
            sessionCheck.secondaryPoints += weight;
        ...
        uint commission = sessionMap.amountHarvested[_user] * PostSessionLibrary.setCommission(address(Treasury).balance) / 10000;
