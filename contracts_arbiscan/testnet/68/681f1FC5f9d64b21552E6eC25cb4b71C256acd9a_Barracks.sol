...
contract Barracks is Initializable, BarracksContracts {
    ...
    contractsAreSet
    {
        ...
        legionMetadataStore.setInitialMetadataForLegion(msg.sender, _newlyMintedTokenId, LegionGeneration.RECRUIT, LegionClass.RECRUIT, LegionRarity.RECRUIT);
