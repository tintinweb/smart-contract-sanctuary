...
contract FarmlandCharacters is FarmlandCollectible {
        ...
        override
    {
        ...
        collectibleTrait.trait1 = random(80, msg.sender).add(20);               // stamina
        collectibleTrait.trait2 = random(80, msg.sender).add(20);               // strength
        collectibleTrait.trait3 = random(80, msg.sender).add(20);               // speed
        collectibleTrait.trait4 = random(80, msg.sender).add(20);               // courage
        collectibleTrait.trait5 = random(80, msg.sender).add(20);               // intelligence
    }
}
...
abstract contract FarmlandCollectible is ERC721, Ownable, ReentrancyGuard, Pausable, Initializable {
    ...
    /**
     * @dev PUBLIC: Initialise the nonce used to generate pseudo random numbers
     */
    ...
    /**
     * @dev PUBLIC: Stores segments for Farmland Collectibles, can be used the owners to group or stamp collectibles
     */
...
// EVENTS
        ...
        whenNotPaused
    {
        ...
        for(uint256 i = 0; i < numTokens; i++){
            ...
            _safeMint(msg.sender, id);                                                    // Mint the Collectible
            _setTokenURI(id, string(abi.encodePacked(id.toString(),".json")));            // Store the Token URI
        }
    }
        ...
        whenNotPaused
    {
        ...
        emit CharacterBoosted(msg.sender, id, trait, boost, traitBoostPrice * boost);               // Write an event
        traitPaymentContract.safeTransferFrom(msg.sender, address(this), traitBoostPrice * boost);  // Take the payment for the boost
    }
        ...
        whenNotPaused
    {
        ...
        emit CharacterSegmented(msg.sender, id, segmentIndex, segment);     // Write an event
    }
...
// ADMIN FUNCTIONS
    ...
    function initialize(string memory uri, uint256 reservedSupply, uint256 maximumSupply, uint256 characterPrice, uint256 boostPrice, address traitPaymentContractAddress)
        external
        onlyOwner
        initializer
    {
    ...
    // Enable changes the payment contract address
