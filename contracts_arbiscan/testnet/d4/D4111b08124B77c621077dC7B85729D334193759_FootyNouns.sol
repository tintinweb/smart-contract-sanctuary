...
contract FootyNouns is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function toggleLive() external onlyOwner nonReentrant {
        isLive = !isLive;
    }
    ...
    function setDescriptor(IFootyDescriptor _descriptor)
        external
        onlyOwner
        nonReentrant
    {
    ...
    function setSeeder(IFootySeeder _seeder) external onlyOwner nonReentrant {
        seeder = _seeder;
    }

    function setMintOnePrice(uint256 newMintOnePrice)
        external
        onlyOwner
        nonReentrant
    {
    ...
    function setMintThreePrice(uint256 newMintThreePrice)
        external
        onlyOwner
        nonReentrant
    {
    ...
    function setMintFivePrice(uint256 newMintFivePrice)
        external
        onlyOwner
        nonReentrant
    {
    ...
    function setMaxFreeSupply(uint256 newMaxFreeSupply)
        external
        onlyOwner
        nonReentrant
    {
