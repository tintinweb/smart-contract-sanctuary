...
contract CommunityIssuance is ICommunityIssuance, Ownable, CheckContract, BaseMath {
    ...
    *
    * Minutes in half year: 60*24*365/2 = 262800
    *
    * For 50% of remaining tokens issued each HALF-year, with minutes as time units, we have:
    * 
    * F ** 262800 = 0.5
    * 
    * Re-arranging:
    ...
    * 262800 * ln(F) = ln(0.5)
    * F = 0.5 ** (1/262800)
    * F = 0.9999973624571291 
    * ISSUANCE_FACTOR = F*1e18
    */
    uint constant public ISSUANCE_FACTOR = 999997362457129088;
    ...
    * 
    * Set to 320M (slightly less than 1/3) of total LQTY supply.
    */
    uint constant public LQTYSupplyCap = 320e24; // 320 million
