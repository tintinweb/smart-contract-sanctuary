...
contract StakingV1 is IERC721Receiver {
  ...
  function stake(uint256 _realmId) external {
    ...
    staker.builtAt = block.timestamp;
  ...
  function collect(uint256 _realmId) external {
    // TODO: might need to check that msg.sender is not address(0)
    ...
    uint256 multiplier = _collectedDaysElapsed(_realmId);
    (uint256 tier1, uint256 tier2) = _stakeMultipliers(_realmId);
    ...
    // Gold + (tier1 + rarity)
    uint256 gold = DATA.gold(_realmId).add(tier1.mul(metric));
    uint256 religion = DATA.religion(_realmId).add(tier1.mul(metric));
  ...
  function steal(uint256 _realmId, uint256 _stealerRealmId) external {
    ...
    require(multiplier > 5, "Collector: Stealing not allowed yet");
  ...
  // Internal
  //=======================================
  function _stakeMultipliers(uint256 _realmId)
    internal
    view
    returns (uint256, uint256)
  {
    ...
    return (multiplier.div(14), multiplier.div(7));
  }
  ...
  function _build(uint256 _realmId) internal {
    ...
    // TODO
    //if (rarity > 0) {
    //RESOURCE.add(_realmId, resourceId, rarity);
    //}
    ...
    returns (uint256)
  {
    ...
    return _daysElapsed(staker.stakedAt);
  }
