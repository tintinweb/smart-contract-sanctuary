...
contract FarmlandTractors is ERC721, Ownable, ReentrancyGuard, Pausable, Initializable, FarmlandCollectible {

    constructor() ERC721("Farmland Tractors", "TRACTOR") public {
        isPaused(true);
    }

    function initialize(string memory uri_, uint256 reserved_, uint256 maxSupply_, uint256 price_) 
        external
        onlyOwner
        initializer
    {
