...
// STATE VARIABLES
     ...
     */
    uint256 public winnerPercent = 63;

    /**
     * @dev SuperDraw % of total
     */
    uint256 public superDrawPercent = 5;

    /**
     * @dev Next Draw % of total
     */
    ...
    /**
     * @dev This is the contract NFT contract for ticket receipts
     */
...
// MODIFIERS
    ...
    modifier drawComplete(uint256 drawIndex) {
        ...
        require(draw.drawStatus == State.Closed,                      "This draw is still ongoing");
        _;
    }
...
// PUBLIC FUNCTIONS
        ...
        withinDeadline
    {
        ...
        itemsContract.claimItem(itemID, numTickets, _msgSender());                           // Mint Ticket Tokens
        ...
        afterDeadline
    {
        ...
        if (numberOfPlayers > 0 ) {
            ...
            nextDrawAmount = draw.prizePool * nextDrawPercent / 100;                  // Calculate the amount to be rolled into the next draw
            superDrawPrizePool += draw.prizePool * superDrawPercent / 100;            // Updates the super draw prize pool
        } else {
...
// VRF callback
    ...
    /**
     * @dev PUBLIC: VRF co-ordinator chooses winner
     */
...
// ADMIN FUNCTIONS
    ...
    /**
     * @dev ADMIN: Enable changes to the random number generator address
     */
    ...
    /**
     * @dev ADMIN: Enable changes to the Farmland Items address
     */
    ...
    /**
     * @dev ADMIN: Enable changes to the Farmland Item ID
     */
...
// GETTERS
    ...
    /**
     * @dev PUBLIC: Return number of tickets per players for a draw
     */
...
interface IFarmlandItems {
    function buyItem(uint256 itemID, uint256 amount, address recipient) external;
    function claimItem(uint256 itemID, uint256 amount, address recipient) external;
}
