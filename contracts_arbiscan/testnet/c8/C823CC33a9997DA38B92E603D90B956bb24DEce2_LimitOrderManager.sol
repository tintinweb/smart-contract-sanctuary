...
contract LimitOrderManager is
    ...
    function _checkSignature(address _token0, address _token1, uint24 _fee,
        uint160 _sqrtPriceX96, uint128 _amount0, uint128 _amount1,
        address _owner, bytes memory _signature) internal pure {

        bytes32 hash = keccak256(abi.encodePacked(
                _token0, _token1, _fee, _sqrtPriceX96, _amount0, _amount1, _owner
            )
        );
