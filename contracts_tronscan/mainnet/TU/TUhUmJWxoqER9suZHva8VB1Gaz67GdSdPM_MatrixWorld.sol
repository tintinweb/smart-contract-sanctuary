...
contract Consts {
    ...
    string public constant TOKEN_NAME = "MatrixWorld";
    string public constant TOKEN_SYMBOL = "MWORLD";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x30C1C20E2a0586A7bEeAe5E8F80F125C3C174eaa;
    bool public constant CONTINUE_MINTING = true;
}


contract MatrixWorld is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
