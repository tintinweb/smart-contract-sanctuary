...
contract FinexToken {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "Finex Token";
    ...
    uint256 public tokenPriceInitial_ = 10;
    uint256 public tokenPriceIncremental_ = 10;
    uint256 public buyPercent = 10000;
    uint256 public sellPercent = 10000;
    uint256 public tokenPercent = 11000;
    uint256 public stakingReturn = 5;
    ...
    constructor(address payable _sonk) public {
