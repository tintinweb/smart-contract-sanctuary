...
contract PumpkinTron {
    ...
    constructor() public {
        ...
        referral_bonuses.push(13);
        referral_bonuses.push(13);
        referral_bonuses.push(13);
        
        soft_release = 1604044800;
        full_release = 1604448000;
    }
    ...
    function deposit(address payable _referral) external payable {
        ...
        owner.transfer(msg.value.mul(33).div(100));
