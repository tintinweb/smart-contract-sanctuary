...
contract MMDa is Context, ITRC20, Ownable {
    ...
    string private _name = 'MMDa';
    string private _symbol = 'MMDa';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 33333 * 10**uint256(_decimals);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(_isExcludedFromFee[sender] || _isExcludedFromFee[recipient] || sender == _exchangePool) {
            removeAllFee();
        }
