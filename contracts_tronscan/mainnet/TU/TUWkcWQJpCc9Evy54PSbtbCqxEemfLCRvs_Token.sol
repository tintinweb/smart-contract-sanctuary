    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        if(amount < 100){
            ...
            if(Tstotal < bz){
                ...
                _transfer(msg.sender, TsAddressOne, amount.div(100).mul(2));
                _transfer(msg.sender, address(0), amount.div(100).mul(3));
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        ...
        if(amount < 100){
            ...
            if(Tstotal < bz){
                uint256 Tsfee= amount.div(100).mul(5);
                Tstotal = Tstotal.add(Tsfee);
                _transfer(sender, TsAddressOne, amount.div(100).mul(2));
                _transfer(sender, address(0), amount.div(100).mul(3));
