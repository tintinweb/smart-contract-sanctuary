...
contract EarthDesert is Context, IERC20, Ownable {
    ...
    string private _name = 'Earth Desert';
    string private _symbol = 'EDS';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 9600 * 10**uint256(_decimals);
