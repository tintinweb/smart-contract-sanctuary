...
contract TronFoundation is Ownable {
    using SafeMath for uint256;
    uint256 private constant INTEREST_CYCLE = 1 days;
    uint256 private constant DEVELOPER_ENTRY_RATE = 700; //per thousand
    uint256 private constant ADMIN_ENTRY_RATE = 20;
    uint256 private constant REFERENCE_RATE = 60;
    uint256 private constant DEVELOPER_EXIT_RATE = 100; //per thousand
    uint256 private constant ADMIN_EXIT_RATE = 300;


    uint256 public constant REFERENCE_LEVEL1_RATE = 50;
    uint256 public constant REFERENCE_LEVEL2_RATE = 50;
    uint256 public constant REFERENCE_LEVEL3_RATE = 50;
    uint256 public constant REFERENCE_LEVEL4_RATE = 50;
