...
contract PoolRun {
   address payable public ownerWallet;
    ...
    uint REGESTRATION_FESS=60  * (10**6);
    ...
    uint pool7_price=6000 * (10**6);
    uint pool8_price=8000 * (10**6);
    uint pool9_price=10000 * (10**6);
    uint pool10_price=12000 * (10**6);
    uint pool11_price=15000 * (10**6) ;
    uint pool12_price=18000 * (10**6);
    ...
    UserStruct[] public requests;
       ...
       constructor(address payable _creator1) public {
        ...
        LEVEL_PRICE[1] = 40 * (10**6);
        LEVEL_PRICE[2] = 4 * (10**6);
        LEVEL_PRICE[3] = 2 * (10**6);
        LEVEL_PRICE[4] = 2 * (10**6);
      unlimited_level_price= 2 * (10**6);
