...
contract LXL is Context, IERC20, Ownable {
    ...
    string private _name = "LXL";
    string private _symbol = "LXL";
    uint8 private _decimals = 6;

    address private _burnPool = 0x000000000000000000000000000000000000dEaD;

    address private fundAddress =
        address(0xbee75F46539f32912123D76Aee114F40bcC02703);
    ...
    uint256 public MAX_STOP_FEE_TOTAL = 19401127 * 10**uint256(_decimals);
