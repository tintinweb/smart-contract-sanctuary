...
contract TronSKY {
	...
	uint256[] public REFERRAL_PERCENTS = [100, 70, 20, 10];
	uint256 constant public MARKETING_FEE = 25;
	uint256 constant public PROJECT_FEE = 25;
    ...
    function register(address _addr, address _affAddr) private {
      ...
      address _affAddr5 = users[_affAddr4].referrer;
      ...
      users[_affAddr4].aff3sum = users[_affAddr4].aff3sum.add(1);
    }
	...
	function migrationUser(address registerAddress, address referrer, uint amountDeposit) public {
	...
	function getUserLevel4(address userAddress) public view returns(uint256) {
		return users[userAddress].aff4sum;
	}
