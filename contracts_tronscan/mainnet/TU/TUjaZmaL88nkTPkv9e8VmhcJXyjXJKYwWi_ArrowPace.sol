...
Only for www.arrowpace.io community members.
*/
...
contract ArrowPace {
    ...
    constructor(address ownerAddress) public {
        ...
        for (uint8 i = 2; i <= LAST_LEVEL; i++) {
            levelPrice[i] = levelPrice[i-1] + 100 trx;
        }
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        lastUserId++;
         totalearnedtrx = totalearnedtrx+400 trx;
    ...
    function getA3Matrix(address userAddress, uint8 level) public view returns(address, address[] memory, uint, bool) {
