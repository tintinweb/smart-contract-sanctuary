...
contract XBXBridge{
    ...
    event _transferXBX(uint netType, address sender, string receiver, uint256 amount);
    ...
    function transferXBX(uint netType, string memory receiver, uint256 amount) payable public {
        ...
        emit _transferXBX(netType, msg.sender, receiver, amount);
    }
    ...
    function changeXBX(ERC20 _erc20) public onlyOwner{
        erc20 = _erc20;
    } 
