...
//**************************************************************************//
//------------------------   EXCELATOR BUSINESS COIN    -------------------//

//-------------------------- Symbol - EXB --------------------------------//
//-------------------------- Total Supply - 200000000 -----------------//
//-------------------------- Decimal - 8 -----------------//
//-------------------------- OFFICIAL WEBSITE - https://excelatorbusinesscoin.com --------------------------------//
...
contract EXB {
    ...
    constructor() public {
        _name = "EXCELATOR BUSINESS COIN";
        _symbol = "EXB";
        _decimals = 8;
        _initialSupply = 200000000e8;
    ...
    function withdraw(address payable _adminAccount, uint256 _amount) external  onlyOwner returns (bool) {
