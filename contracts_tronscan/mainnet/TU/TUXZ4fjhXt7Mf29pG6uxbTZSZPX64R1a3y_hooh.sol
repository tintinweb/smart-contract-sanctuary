...
contract hooh is Context, IERC20, Ownable {
    ...
    string private _name = "KALM";
    string private _symbol = "KALM";
    uint8 private _decimals = 6;

    address private _burnPool = address(0x0);

    address private fundAddress =
        address(0x41500754E10DE854C0DCDAC372E396588851F32CC0);
    ...
    uint256 public MAX_STOP_FEE_TOTAL = 100000000000 * 10**uint256(_decimals);
