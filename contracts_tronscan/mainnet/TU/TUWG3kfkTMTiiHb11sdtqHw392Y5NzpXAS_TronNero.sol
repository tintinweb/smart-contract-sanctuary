...
*
* https://tronnero.club
* (only for tronnero.club Community)
...
contract TronNero is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 70;            // 7% Dev Team, Operation & Development
    uint256 public constant MARKETING_RATE = 100;           // 10% Marketing, Promotions, Adverstising
    uint256 public constant REFERENCE_RATE = 120;           // 12% Total Refer Income
