...
contract DDC is Context, ITRC20, Ownable {
    ...
    string private _name = 'Destroy Delta coin';
    string private _symbol = 'DDC';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 1000 * 10 ** 8 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 1 * 10 ** 8 * 10**uint256(_decimals);
    ...
    function setFundAddress(address fundAddress_) public onlyOwner {
