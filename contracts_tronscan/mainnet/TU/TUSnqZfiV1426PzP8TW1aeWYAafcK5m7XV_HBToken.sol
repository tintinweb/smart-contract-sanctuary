...
contract HBToken is Context, IERC20, Ownable {
...
uint256 private _tTotal = 12666 * 10**6;
uint256 private _rTotal = (MAX - (MAX % _tTotal));
uint256 private _tFeeTotal;
uint256 private _tBurnTotal;

string private _name = 'HB Token';
string private _symbol = 'HB';
uint8 private _decimals = 6;
address private _burnPool = 0x000000000000000000000000000000000000dEaD;
address private fundAddress = address(0x87A1A0729d2cE8AcC5289b5D2CdbdD3D8c040EC6
);
...
uint256 public MAX_STOP_FEE_TOTAL = 6388 * 10**uint256(_decimals);
