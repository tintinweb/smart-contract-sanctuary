...
=== 'BCBT' contract with following features ===
    ...
    => deflation - burning 2% of token every transfer
...
contract BCBTToken is owned {
    ...
    string constant public name = "BCBT";
    string constant public symbol = "BCBT";
    uint256 constant public decimals = 8;
    uint256 public totalSupply = 10000 * (10**decimals);   //1 billion tokens
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        //deflation burn logic - 2% burn on every transaction. Below lines will never overflow, so no SafeMath needed
        uint newAmount = _value - (_value * 2 / 100);
