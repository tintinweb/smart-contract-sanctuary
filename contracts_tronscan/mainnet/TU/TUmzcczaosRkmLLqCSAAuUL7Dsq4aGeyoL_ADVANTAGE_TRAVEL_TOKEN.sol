//SourceUnit: ADVANTAGE_TRAVEL_TOKEN_0p.sol
...
contract ADVANTAGE_TRAVEL_TOKEN is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 820000000 * 10**8; // 8 hundred 20 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Advantage Travel Token';
    ...
    uint256 public _fundFee = 0; //0 percentage to fundation
