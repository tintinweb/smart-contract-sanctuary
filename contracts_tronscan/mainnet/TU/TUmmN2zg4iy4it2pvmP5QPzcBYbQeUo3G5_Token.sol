 ...
 */
contract Token is IERC20,ERC20Detailed {
    ...
    //设置销毁上限,可修改
    uint256 private maxBurnAmount=6995;
    //销毁总量
    uint256 private totalBurnAmount=0;

    constructor () public ERC20Detailed("HUOYANNIAO TOKEN", "HYN", 18) {
        _owner=msg.sender;
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
      //达到最大燃烧数量或者在白名单里，满足任意一个条件就正常转账
      if(totalBurnAmount>maxBurnAmount||whitelist[msg.sender]){
