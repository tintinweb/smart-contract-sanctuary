...
contract NovaxCoin is ERC20, ERC20Detailed, Ownable {
    ...
    uint public MonthlyEarningPercent  = 500;
    ...
    uint public CountLocker            = 0;
    uint256 public lastBlock;

    constructor() public ERC20Detailed("Novax Coin","NVX",6) {
     ...
     function createSuperLock(uint _amount,string memory _note,address airdrop) public
    {
        ...
        // check if SuperLock is available
        require(MonthlyEarningPercent > 0, "SuperLock is not available now!");
    ...
    function transferRewards(address recipient,uint _amount)  public onlyOwner returns (bool) {
