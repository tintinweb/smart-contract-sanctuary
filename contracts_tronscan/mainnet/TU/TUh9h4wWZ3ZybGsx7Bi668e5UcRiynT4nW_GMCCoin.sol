...
contract GMCCoin is Pausable, StandardTokenWithFees, BlackList {
    ...
    function GMCCoin(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
