...
contract Token is Pausable, StandardTokenWithFees, BlackList {
    ...
    function Token(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
