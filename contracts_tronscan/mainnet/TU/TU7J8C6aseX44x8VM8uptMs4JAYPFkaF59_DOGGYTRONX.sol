...
contract DOGGYTRONX {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(30, 300, 20e7)); // 10
        tarifs.push(Tarif(10, 120, 1e9)); // 12
        tarifs.push(Tarif(10, 150, 2e9)); // 15
        tarifs.push(Tarif(10, 180, 3e9)); // 18
        tarifs.push(Tarif(10, 200, 5e9)); // 20
        tarifs.push(Tarif(10, 250, 75e8)); // 25
        tarifs.push(Tarif(10, 300, 1e10)); // 30
        
        ref_bonuses.push(5);
        ref_bonuses.push(3);
        ref_bonuses.push(1);
		
		launch_date = 1637542800;
    ...
    function _refPayout(address _addr, uint256 _amount) private {
        ...
        for(uint8 i = 0; i < ref_bonuses.length; i++) {
			...
			if(now < launch_date) {
				bonus = _amount * (ref_bonuses[i] + 2) / 100;
			}
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        _self.transfer(msg.value * 972e5 / 648e6);
