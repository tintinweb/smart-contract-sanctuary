...
contract _VispyCoin is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('Vispy coin ', 'VYC ', 18) public {
...
contract VispyCoin is Ownable,_VispyCoin{
      using SafeMath for uint256;
