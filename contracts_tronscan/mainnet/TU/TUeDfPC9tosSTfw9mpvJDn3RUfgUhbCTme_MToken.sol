...
contract MToken is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    constructor(uint8 dec, uint256 amount, address payable reciever) ERC20("MetaVerse", "MT") {
        _decimals = dec;
        _mint(reciever, amount * 10 ** dec);
        holder = 1;
    }
