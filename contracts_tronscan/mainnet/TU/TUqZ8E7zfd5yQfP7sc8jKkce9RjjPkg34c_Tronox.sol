//SourceUnit: Tronox.sol

/*
 * 
 *   Tronox-Invest || investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://tronox-invest.com                                  │
 *   │                                                                       │  
 *   │   Telegram Live Support: https://t.me/tronoxinvest_support            |
 *   │   Telegram Public Group: https://t.me/tronoxinvest                    |
 *   │   Telegram News Channel: https://t.me/tronoxinvest_news               |
 *   |                                                                       |
 *   |   YouTube: https://www.youtube.com/channel/UCyDWfRKVz7nOOpU-e-3PepA   |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *
 *   - Officially registered company name: TRONOX INVESTMENT HOLDINGS LIMITED  LTD (#11880284)
 *   - Company status: https://beta.companieshouse.gov.uk/company/11880284
 *   - Certificate of incorporation: https://tronox-invest.com/img/CertificateTronoxInvest.pdf
 *
 *   [SMART-CONTRACT AUDITION AND SAFETY]
 *
 *   - Audited by independent company Inspectius (https://inspectius.com)
 *   - Audition certificate: https://tronox-invest.com/audition.pdf
 *
 */
...
contract Tronox {
	...
	function getUserPercentRate(address userAddress) public view returns (uint256) {
		...
		if (isActive(userAddress)) {
			uint256 timeMultiplier = (now.sub(user.checkpoint)).div(TIME_STEP) * 2;
	...
	function getUserTotalWithdrawn(address userAddress) public view returns(uint256) {
		...
		amount = amount.add(user.bonusPaid);
		
		return amount;
	}

	function getUserTotalReferrers(address userAddress) public view returns(uint256) {
	    User storage user = users[userAddress];

		return user.bonusPaid;
