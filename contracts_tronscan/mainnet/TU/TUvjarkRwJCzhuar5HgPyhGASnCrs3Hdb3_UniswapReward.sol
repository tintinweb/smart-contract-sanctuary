...
contract LPTokenWrapper is IPool,Governance {
    ...
    IERC20 public _lpToken = IERC20(0xa2447D57267BaBA1815DCcB5BD919201C4372Da9); //todo
...
contract UniswapReward is LPTokenWrapper{
    ...
    IERC20 public _rewardToken = IERC20(0xa614f803B6FD780986A42c78Ec9c7f77e6DeD13C);    //todo
    ...
    modifier checkHalve() {
        if (block.timestamp >= _periodFinish) {
            ...
            // _SKY.mint(address(this), _initReward);          //todo
