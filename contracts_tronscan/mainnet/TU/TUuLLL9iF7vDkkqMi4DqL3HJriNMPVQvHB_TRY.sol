...
contract GlobalsAndUtility is ERC20 {
    ...
    */
        ...
        external
    {
        ...
        require(g._currentDay > CLAIM_PHASE_START_DAY, "TRY: Too early");

        if (beforeDay != 0) {
            require(beforeDay <= g._currentDay, "TRY: beforeDay cannot be in the future");
    ...
    {
        require(beginDay < endDay && endDay <= globals.dailyDataCount, "TRY: range invalid");
        ...
        view
    {
        ...
        require(stakeIdParam == stRef.stakeId, "TRY: stakeIdParam not in stake");
...
contract StakeableToken is GlobalsAndUtility {
        ...
        external
    {
        ...
        require(newStakedDays >= MIN_STAKE_DAYS, "TRY: newStakedDays lower than minimum");
        ...
        external
    {
        ...
        require(stakeLists[stakerAddr].length != 0, "TRY: Empty stake list");
        require(stakeIndex < stakeLists[stakerAddr].length, "TRY: stakeIndex invalid");
        ...
        require(g._currentDay >= st._lockedDay + st._stakedDays, "TRY: Stake not fully served");

        /* Stake must still be locked */
        require(st._unlockedDay == 0, "TRY: Stake already unlocked");
        ...
        external
    {
        ...
        /* require() is more informative than the default assert() */
        require(stakeListRef.length != 0, "TRY: Empty stake list");
        require(stakeIndex < stakeListRef.length, "TRY: stakeIndex invalid");
        ...
        internal
    {
        ...
        require(newStakedDays <= MAX_STAKE_DAYS, "TRY: newStakedDays higher than maximum");
        ...
        require(newStakeShares != 0, "TRY: newStakedSuns must be at least minimum shareRate");
        ...
        returns (uint256 bonusSuns)
    {
        /*
            ...
            Bonus percentage scaled 0% to 10% for the first 7M TRY of stake.
...
contract TransformableToken is StakeableToken {
    ...
    function xfLobbyEnter(address referrerAddr)
        ...
        payable
    {
	require(_currentDay() > 0, "TRY: Auction has not begun yet");

        uint256 enterDay = _currentDay();

        uint256 rawAmount = msg.value;
        require(rawAmount != 0, "TRY: Amount required");
    ...
    function xfLobbyExit(uint256 enterDay, uint256 count)
        external
    {
        require(enterDay < _currentDay(), "TRY: Round is not complete");
        ...
        if (count != 0) {
            require(count <= qRef.tailIndex - headIndex, "TRY: count invalid");
            endIndex = headIndex + count;
        } else {
            endIndex = qRef.tailIndex;
            require(headIndex < endIndex, "TRY: count invalid");
        }
        ...
        external
    {
        ...
        require(address(this).balance != 0, "TRY: No value");

        require(LAST_FLUSHED_DAY < _currentDay(), "TRY: Invalid day");
        ...
        returns (uint256 rawAmount, address referrerAddr)
    {
        ...
        require(entry.rawAmount != 0, "TRY: Param invalid");
...
contract TRY is TransformableToken {
    constructor()
        public
    {
