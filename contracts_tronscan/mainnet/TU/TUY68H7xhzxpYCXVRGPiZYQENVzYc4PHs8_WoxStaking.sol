...
contract WoxStaking is Ownable {
    ...
    /**
        @notice stake WOX to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sWOX from warmup
    ...
    /**
        @notice forfeit sWOX in warmup and retrieve WOX
     */
    ...
    /**
        @notice returns the sWOX index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract WOX holdings, including bonuses provided
        @return uint
     */
