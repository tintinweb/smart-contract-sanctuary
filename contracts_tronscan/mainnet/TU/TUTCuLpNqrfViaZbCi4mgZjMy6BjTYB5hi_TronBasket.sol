...
contract TrxChain is Ownable, Destructible, Pausable {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        else require(_amount >= 0.1 *  (10 ** 6) && _amount <= cycles[0], "Bad amount");
...
contract TronBasket is TrxChain {
