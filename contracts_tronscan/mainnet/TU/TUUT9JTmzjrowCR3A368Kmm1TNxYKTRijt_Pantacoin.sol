...
contract _Pantacoin is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('Pantacoin ', 'PTC', 18) public {
...
contract Pantacoin is Ownable,_Pantacoin{
      using SafeMath for uint256;
