...
/*
 * 
 *   TRONFISSION REVOLUTION - investment platform based on TRX blockchain smart-contract technology. Safe and legit

        https://tronfission.live
 *
 ...
 *   - Total income: 350% (deposit included)
 *   - Withdraw any time
 *   - 40% Reinvestment Mechanism

 *   [AFFILIATE PROGRAM]
 *
 *   Share your referral link with your partners and get additional bonuses.
 *   - 10-level referral commission: 10% - 4% - 2% - 1% - 0.5% -0.5% - 0.5% - 0.5% - 0.5% - 0.5%
 *
 *   ────────────────────────────────────────────────────────────────────────
 *
 *
...
contract Tronfission {
    using SafeMath for uint256;

    uint256 constant public INVEST_MIN_AMOUNT = 100 trx;
    uint256 constant public BASE_PERCENT = 35; 
    uint256[] public REFERRAL_PERCENTS = [100, 40, 20, 10, 5 ,5, 5, 5, 5, 5];
    uint256 constant public MARKETINGFUND = 100;
    uint256 constant public PROJECTFUND = 50;
    uint256 constant public ACCUMULATE = 50;
    ...
    function withdraw() public {
        ...
        reinvest(msg.sender,totalAmount.mul(40).div(100)); //40% reinvestment
        
        userWithdrawn[msg.sender] = userWithdrawn[msg.sender].add(totalAmount.mul(60).div(100));
        ...
        emit Withdrawn(msg.sender, totalAmount.mul(60).div(100)); //60% withdrawable dividends
