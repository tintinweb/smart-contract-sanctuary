...
/*
 *   www.startron.club - Decentralized short-term investments powered by the Tron Blockchain Technology.
 *
 *   ┌────────────────────────────────────────────────────────────┐  
 *   │         Official Website: https://startron.club/           │
 *   └────────────────────────────────────────────────────────────┘ 
 *
 *   [HOW TO JOIN]
 *
 *   1) Connect TRON browser extension TronLink or TronMask, or mobile wallet apps like TronWallet or TokenPocket.
 ...
 *   [INVESTMENT PLANS]
 * 
 *   - [I] - Maximum income  : 300% in 60 Days,  5% Daily ROI
 * 
 *   - [II] - Maximum income  : 240% in 40 Days, 6% Daily ROI
 * 
 *   - [III] - Maximum income  : 200% in 25 Days, 8% Daily ROI
 * 
 *   - [IV] - Maximum income  : 150% in 15 Days, 10% Daily ROI
 * 
 *   [REFERRAL PROGRAM]
 *
