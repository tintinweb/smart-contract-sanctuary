...
contract DLVToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1990000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'DLV Token';
    string private _symbol = 'DLV';
    ...
    uint256 public MAX_STOP_FEE_TOTAL = 510000 * 10**uint256(_decimals);
   ...
   function calculateBurnFee(uint256 _amount) private view returns (uint256) {
    ...
    function setFundFeePercent(uint256 fundFee) public onlyOwner {
        _fundFee = fundFee;
    }
