...
contract LionCoin is Pausable, StandardTokenWithFees, BlackList {
    ...
    function LionCoin(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
