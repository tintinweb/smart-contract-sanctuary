...
contract CJHJToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function CJHJToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
