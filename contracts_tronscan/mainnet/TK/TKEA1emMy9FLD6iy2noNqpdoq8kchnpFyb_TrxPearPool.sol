...
// File: contracts/base-pool/SafeMath.sol
...
// File: contracts/base-pool/IERC20.sol
...
// File: contracts/base-pool/ERC20Detailed.sol
...
// File: contracts/base-pool/SafeERC20.sol
...
// File: contracts/base-pool/Initializable.sol
...
// File: contracts/base-pool/LPTokenWrapper.sol
...
// File: contracts/base-pool/ITradePair.sol
...
// File: contracts/trx-pear-pool/TrxPearBasePool.sol
...
contract TrxPearBasePool is LPTokenWrapper {
    using SafeERC20 for IERC20;

    uint256 public constant UINT_MAX_VALUE = uint256(-1);

    IERC20 public tokenAddress;   
    ITradePair public tradePairAddress;                      
    ...
    event LiquiAdded(address indexed user, uint256 liquiAmount);
    event TokenBought(address indexed user, uint256 tokenAmount);   
    ...
    constructor (address _warranteeAddress, address _tokenAddress, address _tradePairAddress, uint256 _initreward, uint256 _starttime, uint256 _stoptime) public {
        deployer = msg.sender;

        super.initialize(_warranteeAddress);
        tokenAddress = IERC20(_tokenAddress);

        tokenAddress.approve(_tradePairAddress, UINT_MAX_VALUE);

        IERC20(_warranteeAddress).approve(_tradePairAddress, UINT_MAX_VALUE);
        
        tradePairAddress = ITradePair(_tradePairAddress);
    ...
    function removeLiqui() onlyDeployer public {
        uint256 trx_amount;
        (trx_amount,) = tradePairAddress.removeLiquidity(tradePairAddress.balanceOf(address(this)), 1, 1, block.timestamp + 3600);
        deployer.transfer(trx_amount);
    }
...
// File: contracts/trx-pear-pool/TrxPearPool.sol

pragma solidity >=0.4.23 <0.6.0;


contract TrxPearPool is TrxPearBasePool {
    // address _warranteeAddress, address _tokenAddress, address _tradePairAddress, uint256 _initreward, uint256 _starttime, uint256 _stoptime
    constructor() public TrxPearBasePool(0x37a2812A6c2cd9C46a47Db3c42c03aC79b649747, 0x52d7a6a6D568e7BfE19092201cC6bCf2DDeB54f9, 0x37a2812A6c2cd9C46a47Db3c42c03aC79b649747, 180000, 1604322000, 1609506000){
