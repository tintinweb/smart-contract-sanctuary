...
contract JustTron {
    ...
    function _whaleBonus(address _adr) view private returns(uint16){
        ...
        else if(cur_investment >= 250000000000){ _bonus = 350; }
        else if(cur_investment >= 100000000000){ _bonus = 250; }
        else if(cur_investment >= 25000000000){ _bonus = 175; }
        else if(cur_investment >= 10000000000){ _bonus = 150; }
        else if(cur_investment >= 2500000000){ _bonus = 125; }
		else if(cur_investment >= 100000000){ _bonus = 100; }
        return _bonus;
    }
