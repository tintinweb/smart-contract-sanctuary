...
contract BabyEarthToken is ERC20, ERC20Detailed{
    ...
    constructor(address _address) public ERC20Detailed("Baby Earth Token", "BABYEARTH", 18){
        	owner = msg.sender;	
