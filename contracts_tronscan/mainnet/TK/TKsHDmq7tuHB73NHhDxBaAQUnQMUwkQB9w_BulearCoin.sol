...
contract BulearCoin is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("BulearCoin", "BULRC", 6){
        require(gr != address(0), "invalid gr");
        _mint(gr, 100000 * 10000 * 10 ** 6);
    }
}
