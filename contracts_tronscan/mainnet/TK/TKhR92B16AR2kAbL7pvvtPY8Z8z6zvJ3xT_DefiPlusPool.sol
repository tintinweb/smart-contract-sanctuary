...
contract DefiPlusPool is LPTokenWrapper, IRewardDistributionRecipient {
    // DefiPlusToken,"41B77AF26F9AEDF3ED8EBABDB36CB4C8F7624651B2"
    ITRC20 public DefiPlusToken= ITRC20(0x41B77AF26F9AEDF3ED8EBABDB36CB4C8F7624651B2);
    uint256 public DURATION = 1_209_600; // 14 days

    uint256 public starttime = 1603816131; 
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (trueReward > 0) {
            ...
            DefiPlusToken.safeTransfer(msg.sender, trueReward);
    ...
    */
    ...
    onlyOwner
    {
        require(to_ != address(0), "must not 0");
        require(amount_ > 0, "must gt 0");
        require(token_ != DefiPlusToken, "must not DefiPlusToken");
