...
/**
 * @dev Extension of `ERC20` that adds a set of accounts with the `BurnerRole`,
 * which have permission to mint (create) new tokens as they see fit.
 *
 * At construction, the deployer of the contract is the only burner.
 */
...
contract PPToken is ERC20Capped, /*ERC20Mintable,*/ ERC20Burnable {
    /**
     * - cap: 1000000000000000000000000000 (100 mil)
     * - init: 250000000000000000000000000 ( 25 mil)
     */
    constructor () public ERC20Capped(100000000000000000000000000) ERC20("Price Party Token", "PPT") {
        // mint to sender init tokens
        mint(msg.sender, 25000000000000000000000000);
    }
