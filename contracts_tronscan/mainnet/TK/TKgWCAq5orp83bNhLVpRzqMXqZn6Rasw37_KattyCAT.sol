//SourceUnit: KattyCAT_flatten.sol
...
contract KattyCAT is Context, ITRC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 5 * 10**10;

    string private constant _name = 'KattyCAT'; 
    string private constant _symbol = 'KATTYCAT';
    ...
    constructor () public {
        ...
        justswapExchange = IJustswapExchange(
            IJustswapFactory(address(0xeEd9e56a5CdDaA15eF0C42984884a8AFCf1BdEbb)).createExchange(address(this))
        );
    ...
    function _transfer(
        ...
        // tokens that we need to initiate a swap.add(liquidity lock?
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 TRXAmount) private {
        ...
        // add the liquidity
        justswapExchange.addLiquidity.value(TRXAmount)(
    ...
    //this mTRXod is responsible for taking all fee, if takeFee is true
