...
contract TronEmpire is Ownable {
    ...
    uint256 public constant REFERRER_CODE = 1111; //default
    ...
    constructor() public {
        ...
        marketingAccount_ = address(0x41A6FFD18BCE86F7B3ACC7A3BD874BDB15623FF2F6);  
        adminAccount_ = address(0x4183B000206C59609B9EA7947FD681DDFC5FE8C114);
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(90, 13*60*60*24)); //13 days
        investmentPlans_.push(Objects.Plan(70, 20*60*60*24)); //20 days
        investmentPlans_.push(Objects.Plan(50, 35*60*60*24)); //35 days
        investmentPlans_.push(Objects.Plan(30, 70*60*60*24)); //70 days
    ...
    function withdraw() public {
        ...
        require(uid2Investor[uid].timer < now, "withdrawal is available only once every 32 hours");

        uid2Investor[uid].timer = now + 32 hours;
