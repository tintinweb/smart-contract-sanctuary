...
/*
* PoTJ Tee Are Ex
* Proof of Trevon James on TRX
* Don't Talk To Me Unless It's About Intangible Coins.
* 25% Entry / 10% Exit / 35% Masternode / 2% Tewkens Transfer / 2% Service Fee
*
*/
...
contract Gamey {
    ...
    uint256 constant internal tokenPrice_ = 100;
    ...
    function sell(uint256 _amountOfTokens) onlyBagholders public {
        ...
        uint256 _dividends = (_tron * exitFee_) / 100;
    ...
    function sellPrice() public view returns (uint256) {
        ...
        uint256 dividends = SafeMath.div(SafeMath.mul(_tron, exitFee_ ), 100);
    ...
    function purchaseTokens(uint256 _incomingTron, address _referredBy) internal returns (uint256) {
        ...
        hiredFeeAddress.transfer(SafeMath.div(SafeMath.mul(_incomingTron, 2), 100));
