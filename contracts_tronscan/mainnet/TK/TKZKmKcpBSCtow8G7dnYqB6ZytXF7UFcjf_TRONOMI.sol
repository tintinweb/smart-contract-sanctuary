//SourceUnit: Tronomi.sol

/*
 * 
 *   TRONOMI - Investment platform based on TRON blockchain. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 ...
 *   2) Send any TRX amount (minimum 100 TRX) using our website invest button.
 ...
 *   - Contract total amount bonus: +0.1% for every 1,000,00 TRX on platform balance 
 * 
 *   - Minimum investment: 100 TRX, no maximal limit
 ...
 *   - 5.5% Advertising and promotion, technical support
 *   - 7.5% Affiliate program bonuses
 *   - 5.5% Tronomi token development
 *
 *
 */
