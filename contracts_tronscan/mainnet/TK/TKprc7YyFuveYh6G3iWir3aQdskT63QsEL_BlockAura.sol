...
contract BlockAura is TRC20, TRC20Detailed, TRC20Mintable, TRC20Burnable, TRC20Pausable {

    address public staker;
    uint256 public transferFee = 5; // 0.001 % if feeDenominator = 10000
    uint256 public mintFee = 5; // 0.001 % if feeDenominator = 10000
    ...
    constructor(address _staker)
        ...
        TRC20Mintable()
        TRC20Pausable()
        TRC20Detailed("BlockAura", "BACT", 8)
        TRC20()
        public {
        staker = _staker;
    }
