...
// File: openzeppelin-solidity/contracts/token/TRC20/TRC20Basic.sol
...
// File: openzeppelin-solidity/contracts/token/TRC20/BasicToken.sol
...
// File: openzeppelin-solidity/contracts/token/TRC20/StandardToken.sol
...
// File: openzeppelin-solidity/contracts/token/TRC20/MintableToken.sol
 ...
 * It is meant to be used as perpetual mineable token.
 */
contract BNKRTokenX is MintableToken {
    ...
    string public constant name = "Bankroll Extended Token";
    string public constant symbol = "BNKRX"; // solium-disable-line uppercase
    ...
    constructor() Ownable() public {
        //Genesis mints 100K for use in seeding liquidity
        mint(owner,1e11);
    }
