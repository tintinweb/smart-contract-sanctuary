...
contract tronB is Owned, TRC20Interface {
  ...
  // TAKE TRX 
  // ----------------------------------------------------------------------------
  function takeTRX(uint256 amount) onlyOwner public returns(uint256 balance){
