...
contract TronCasheROI {
    ...
    constructor(address _troncashAddress) public {
      ...
      troncashAddress = _troncashAddress;
    }
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint256 troncashReserve = depositAmount.mul(feedToTronCashe).div(commissionDivisor);
        troncashAddress.transfer(troncashReserve);
        troncashDividend = troncashDividend.add(troncashReserve);
    ...
    function ownerZerooutTronCasheDividend() public {
