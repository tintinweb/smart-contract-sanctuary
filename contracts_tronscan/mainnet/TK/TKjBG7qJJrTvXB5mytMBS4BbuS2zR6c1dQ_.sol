...
contract Consts {
    ...
    string public constant TOKEN_NAME = "WeSwap";
    string public constant TOKEN_SYMBOL = "WES";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x79dc4d6e8d5218ec9fef7c3c66d68f2b7f5429fc;
...
contract MainToken is Consts, FreezableMintableToken, BurnableToken, Pausable {
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x79dc4d6e8d5218ec9fef7c3c66d68f2b7f5429fc)];
        uint[1] memory amounts = [uint(50000000000000)];
