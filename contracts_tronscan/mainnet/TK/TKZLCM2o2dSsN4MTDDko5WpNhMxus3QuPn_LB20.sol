...
contract LB20 is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 9980 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'LB20';
    string private _symbol = 'LB20';
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 998 * 10**uint256(_decimals);
