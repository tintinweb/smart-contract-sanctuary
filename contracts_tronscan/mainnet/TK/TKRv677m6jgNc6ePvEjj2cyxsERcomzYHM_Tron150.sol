...
contract Tron150 {
    ...
    uint private releaseTime = 1607563800;
    ...
    constructor() public {
      owner = msg.sender;
      planes[0]=Plans("Plan 1",150,0);
      planes[1]=Plans("Plan 2",160,0);
    }
    ...
    function deposit(address payable _affAddr, uint posplan) public payable  returns(bool){
        ...
        require(posplan==1 && depositAmount <= 49999000000,"is low the amount.");
