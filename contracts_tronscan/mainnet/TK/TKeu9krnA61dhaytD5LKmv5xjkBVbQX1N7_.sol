...
contract Consts {
    ...
    string public constant TOKEN_NAME = "LAMONTE";
    string public constant TOKEN_SYMBOL = "LMT";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x90099e1384184f7f1f49a5d3f029f89983bcd828;
...
contract MainToken is Consts, FreezableMintableToken, BurnableToken, Pausable {
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x90099e1384184f7f1f49a5d3f029f89983bcd828)];
        uint[1] memory amounts = [uint(1000000000)];
