...
contract TNT is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 31314 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'TNToken';
    string private _symbol = 'TNT';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41af24900c6dbf18e147ca32ff610519d9ae0deeea);
