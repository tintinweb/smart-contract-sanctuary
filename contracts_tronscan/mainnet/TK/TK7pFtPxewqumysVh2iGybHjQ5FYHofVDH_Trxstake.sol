//SourceUnit: Trxstake.sol

 /*   trxstake - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *   The only official platform of original trxstake team! All other platforms with the same contract code are FAKE!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://trxstake.space                                     │
 *   │                                                                       │
 *   │   Telegram Live Support: @trxstake                               |
 *   │   Telegram Public Group: @trxstake                               |
 *   |                                                                       |
 *   |   YouTube: youtube.com/channel/UCQxDOGguiKsCCZgRQWSEeiw               |           
 *   |   E-mail: admin@trxstake.space                                        |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral commission: 8% - 5% - 4% - 2% -1%
 *
 *   [FUNDS DISTRIBUTION]
 *
...
contract Trxstake {
	...
	uint256[] public REFERRAL_PERCENTS = [80, 50, 40, 20, 10];
	...
	constructor(address payable wallet, uint256 startDate) public {
        ...
        plans.push(Plan(9, 80));
        plans.push(Plan(18, 70));
        plans.push(Plan(27, 60));
        plans.push(Plan(9, 80));
        plans.push(Plan(18, 70));
        plans.push(Plan(27, 60));
	}
