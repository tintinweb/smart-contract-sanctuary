...
contract NewBankOfTron is Ownable {
    ...
    uint256 private constant REFERENCE_RATE = 0;
    uint256 private constant DEVELOPER_EXIT_RATE = 0; //per thousand
    uint256 private constant ADMIN_EXIT_RATE = 0;
    ...
    uint256 public constant REFERRER_CODE = 777; //default

    uint256 public latestReferrerCode;
    uint256 private totalInvestments_;
    uint256 public totalinvested_; 
    uint256 public totalinvestor_;
