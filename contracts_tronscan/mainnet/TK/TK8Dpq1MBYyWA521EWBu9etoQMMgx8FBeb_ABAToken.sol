...
contract ABAToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function ABAToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
