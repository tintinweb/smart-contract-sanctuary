...
contract GameConfig {
  ...
  uint256 public BOX_GAME_PROFITABILITY_INCREASING_TIME_INTERVAL = 1 days; 

  uint256 public BOX_GAME_ADMIN_WITHDRAW_TIME_INTERVAL = 7 days; 

  
  uint256[4] public COOKING_TIME = [3 days, 6 days, 12 days, 18 days]; 

  
  uint256 public TIME_INTERVAL_BETWEEN_STIRRINGS = 24 hours; 
  uint256 public CRAFTING_ACCELERATION_TIME_INTERVAL = 1 hours; 

  
  uint256 public TIME_DAY = 1 days; 

  
  uint256[4] public COOKING_PRICE = [5, 50, 500, 2500]; 
  ...
  uint256[4] public ADMIN_FEES = [600, 700, 900, 1000]; 
