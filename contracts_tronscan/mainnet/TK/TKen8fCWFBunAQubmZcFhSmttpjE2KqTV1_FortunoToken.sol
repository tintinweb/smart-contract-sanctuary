...
contract FortunoToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function FortunoToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
