...
contract Vizcoin is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 33000000;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Vizcoin", "VIZ", 8){
        	owner = msg.sender;	
