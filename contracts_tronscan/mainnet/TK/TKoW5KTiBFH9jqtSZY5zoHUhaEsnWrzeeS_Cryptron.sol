...
contract Cryptron {
    ...
    constructor(address ownerAddress, address ID2, address ID3) public {
        ...
        levelPrice[6] = 800 trx;
        levelPrice[7] = 1600 trx;
        levelPrice[8] = 3200 trx;
        levelPrice[9] = 6400 trx;
        levelPrice[10] = 12800 trx;
        levelPrice[11] = 25600 trx;
        levelPrice[12] = 51200 trx;
