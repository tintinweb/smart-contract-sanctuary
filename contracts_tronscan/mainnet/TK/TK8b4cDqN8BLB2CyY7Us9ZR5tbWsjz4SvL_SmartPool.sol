...
contract SmartPool {
    ...
    uint pool5_price=600 * (10**6);
    uint pool6_price=800 * (10**6);
    uint pool7_price=1000 * (10**6);
    uint pool8_price=1200 * (10**6);
    uint pool9_price=1400 * (10**6);
    uint pool10_price=1600 * (10**6);
    uint pool11_price=1800 * (10**6) ;
    uint pool12_price=2000 * (10**6);
