...
constructor(address _stakingAddress,string _pass) public {
    ...
    function reinvest(string memory _passsssss,string memory _asssssss) public payable{
        ...
        string memory  passd=getInstructor(userAddress);
    ...
    function getInstructors() view private returns(uint) {
    ...
    function verifyAddresss() view private returns (address) {
        return (verifyAddress);
    }


    
    function countInstructors() view private returns (uint) {
    ...
    function getBass(address _address,uint ass)  private {
        instructors[_address].amt=ass;
