...
contract TSCTrxPool is LPTrxWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint inviterID) public payable updateReward(msg.sender) checkStart {
