...
contract Tron30 {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 90 trx;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public CONTRACT_BALANCE_STEP = 10000000 trx;
	uint256 constant public TIME_STEP = 30 days;
	uint256 constant public BASE_PERCENT = 90;  // 270 %
	uint256 constant public PROJECT_FEE = 150;   // 15 %
	uint256[] public REFERRAL_PERCENTS = [100, 20]; // 10 %, 2 %
  ...
  // -----------------------------------------
	...
	function withdraw() external {
		...
		projectAddress.transfer(totalAmount.mul(PROJECT_FEE).div(PERCENTS_DIVIDER));
