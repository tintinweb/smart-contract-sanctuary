...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 118888 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'ixi';
    string private _symbol = 'ixi';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x8aAff2c969d1CF9aD4544683dBA651cD3B593673);
