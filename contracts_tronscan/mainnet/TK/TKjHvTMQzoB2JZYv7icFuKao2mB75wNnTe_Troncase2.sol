...
contract Troncase2 {
    ...
    uint constant public BASE_PERCENT = 110;//100;
    uint[] public REFERRAL_PERCENTS = [750, 330, 170, 110, 55, 55, 55, 45, 35, 25, 15];//[700, 300, 150, 100, 50, 50, 50, 40, 30, 20, 10];
    uint constant public MARKETING_FEE = 0;//700;
    uint constant public PROJECT_FEE = 0;//600;
    uint constant public ADMIN_FEE = 1000;//200;
    uint constant public MAX_CONTRACT_PERCENT = 150;//100;
    uint constant public MAX_LEADER_PERCENT = 100;//50;
    uint constant public MAX_HOLD_PERCENT = 50;
    uint constant public MAX_COMMUNITY_PERCENT = 100;//50;
