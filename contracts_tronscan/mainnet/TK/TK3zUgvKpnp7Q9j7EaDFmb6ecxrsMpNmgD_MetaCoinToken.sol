...
contract MetaCoinToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function MetaCoinToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
...
contract StandardTokenWithFees is StandardToken, Ownable {
  ...
  function calcFee(uint _value) constant private returns (uint) {
