...
contract DKSTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'DKS TOKEN';
    string private _symbol = 'DKS';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x0000000000000000000000000000000000000000;
    
    address private fundAddress = address(0x41E3B0BE71F867184DA135521EF1C712BD04F254B1);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 2888 * 10**uint256(_decimals);
