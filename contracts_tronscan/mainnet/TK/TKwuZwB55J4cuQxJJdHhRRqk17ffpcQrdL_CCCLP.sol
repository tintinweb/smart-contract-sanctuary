...
contract CCCLP {
    ...
    IERC20 public _CCC = IERC20(0x41ae6432c334efc81ac47eabf6c279c91cfae4bb69);
    ...
    function _deposit(uint256 value) private {
        ...
        _CCC.transferFrom(msg.sender, address(this), value);
    ...
    function Redeem() external {      
        ...
        _CCC.transfer(msg.sender, payouts);
    }
    ...
    function contractInfo() public view returns(uint256 totalDeposited, uint256 totalWithdraw, uint256 balance, uint256 addressNum){
        return (total_deposited, total_withdraw, _CCC.balanceOf(address(this)), lastUserId-1);
    }
}