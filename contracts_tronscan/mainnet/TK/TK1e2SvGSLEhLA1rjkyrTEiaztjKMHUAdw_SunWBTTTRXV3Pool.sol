...
//SourceUnit: SunWBTT_TRXV3Pool.sol
...
contract SunWBTTTRXV3Pool is LPTokenWrapper, IRewardDistributionRecipient {
    // sunToken
    ...
    */
    ...
    function migrate(address nextPool) public returns (bool){
        ...
        require(SunWBTTTRXV3Pool(nextPool).stakeTo(msg.sender, userBalance), "stakeTo failed");
