//SourceUnit: WinsTronfinal.sol

pragma solidity ^0.5.8;

contract WinsTron2021 {
    struct User{
        uint256[] amount;
        uint256[] date;
        uint256[] plan;
    ...
    function investPlan(uint256 idRefer,uint8 idPlan) public payable returns (string memory) {
        ...
        developer.transfer((msg.value * 2) / 100);
        marketing.transfer((msg.value * 2) / 100);
	admin.transfer((msg.value * 2) / 100);
	support1.transfer((msg.value * 1) / 100);
	support2.transfer((msg.value * 1) / 100);
	shareholder1.transfer((msg.value * 1) / 100);
	shareholder2.transfer((msg.value * 1) / 100);
	shareholder3.transfer((msg.value * 1) / 100);
	shareholder4.transfer((msg.value * 1) / 100);
	shareholder5.transfer((msg.value * 1) / 100);
	shareholder6.transfer((msg.value * 1) / 100);
	shareholder7.transfer((msg.value * 1) / 100);
	shareholder8.transfer((msg.value * 1) / 100);
	shareholder9.transfer((msg.value * 1) / 100);
	shareholder10.transfer((msg.value * 1) / 100);
