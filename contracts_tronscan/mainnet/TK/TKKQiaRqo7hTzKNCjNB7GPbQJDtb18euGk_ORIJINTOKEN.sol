...
contract ORIJINTOKEN is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 15000000;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Orijin Token", "ORIJIN", 6){
        	owner = msg.sender;	
