...
contract TronRelaxSafe {
    ...
    */
    ...
    function set_extra_factor_percentage( uint8 factor ) external onlyOwner {
        extra_factor_percentage = factor;
    }

    function set_amount_step_percentage( uint256 amount ) external onlyOwner {
        amount_step_percentage = amount;
    }

    function set_limit_extra_percentage( uint8 limit ) external onlyOwner {
        limit_extra_percentage = limit;
    }
