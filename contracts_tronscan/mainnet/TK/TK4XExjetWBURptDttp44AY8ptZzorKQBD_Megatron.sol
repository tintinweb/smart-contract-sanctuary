...
contract Megatron {
    ...
    constructor(address _leaderPooladdress) public {
  ...
  function payReferral(uint level,address _useraddress) internal {
    ...
    function pushCountchild(uint _level,address user) internal {
            ...
            if(countchild <= 84 && user != address(0)){
                ...
                if(countchild < 84){
                    ...
                    if(parentAddress != address(0)){
                       pushCountchild(_level,parentAddress);
                    }
