...
contract BYY is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 3998 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'BYY';
    string private _symbol = 'BY';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41054cdd4f372c60e9836d0e546057c6f514f6f185);
