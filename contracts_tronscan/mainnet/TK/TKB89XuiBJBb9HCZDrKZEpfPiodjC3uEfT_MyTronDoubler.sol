//SourceUnit: mytrondoubler.sol

/*
 *	MY TRON DOUBLER - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://mytrondoubler.com                                  │
 *   │                                                                       │  
 *   │   Telegram Public Group: https://t.me/mytrondoubler                   │
 *   |                                                                       │
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [INSTRUCTION]
 ...
 *   - 1% Daily return on your Deposit (maximum 200 days) 100% Passive.
 ...
 *   - Matching commission bonus on partners income every time they make a withdraw max 5 levels (5%-3%-2%-1%-1%)
 *   - 1 new level is activated for each direct partner, maximum 5 levels
 *   - Minimal deposit: 100 TRX to 100k TRX and maximum of 2M TRX from 4th cycle
 *   - Earnings every moment, withdraw any time
 *
 *   [FUNDS]
 *
 *   - 82% Platform main balance, participants payouts
 *   - 3% Pooling fund bouns expenses
...
contract MyTronDoubler {
    ...
    constructor(address payable _owner) public {
        ...
        pool_fund = 0xE047bFfc4260936c196b34e64a0bBb0c343C97dE;
        admin_fee = 0x2740f8eE321f86B3118ceC8EB811eD04a6948234;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        admin_fee.transfer(_amount * 5 / 100);  // 5%
        pool_fund.transfer(_amount * 3 / 100);  // 3%
    }
