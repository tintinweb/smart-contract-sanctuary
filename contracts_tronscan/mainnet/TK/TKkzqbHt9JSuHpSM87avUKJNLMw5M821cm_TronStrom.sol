...
contract TronStrom {
    ...
    uint public devCommission = 7;
    uint public commissionDivisor = 100;
    uint private minuteRate = 5208333;
    uint public releaseTime = 1594562400;
    ...
    function distributeDividends(uint256 amount) public restrict returns (bool) {
