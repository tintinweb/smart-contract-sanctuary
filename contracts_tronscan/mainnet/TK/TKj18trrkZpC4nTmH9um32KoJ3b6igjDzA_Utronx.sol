...
contract Utronx {
  ...
  uint START_AT = 24395412;
  
  address public marketingAddress;
  address public ownerAddress;
  uint constant public MARKETING_FEE = 12;
  ...
  constructor(address _marketingAddress,address _ownerAddress) public {
     marketingAddress = _marketingAddress;
     ownerAddress = _ownerAddress;

     tariffs.push(Tariff(16 * 28800, 121));
     tariffs.push(Tariff(25 * 28800, 150));
     tariffs.push(Tariff(45 * 28800, 202));
     tariffs.push(Tariff(777 * 28800, 777));
  ...
  function deposit(uint tariff, address referer) external payable {
    ...
    register(referer);
    marketingAddress.transfer(msg.value*MARKETING_FEE/100);
