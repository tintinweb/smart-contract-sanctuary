...
*
* Crowdfunding And Investment Program: 1% Daily ROI for 50 Days
...
contract DCF150in50 is Ownable {
    ...
    uint256 public constant REFERENCE_LEVEL2_RATE = 35;     // 3.5% Level 2 Income
    uint256 public constant REFERENCE_LEVEL3_RATE = 15;     // 1.5% Level 3 Income
    uint256 public constant MINIMUM = 100e6;                // Minimum investment : 100 TRX
    uint256 public constant REFERRER_CODE = 1234;           // Root ID : 1234
    uint256 public constant PLAN_INTEREST = 30;             // 3% Daily Return INVESTMENT AND INTEREST
    uint256 public constant PLAN_TERM = 50 days;            // 50 Days
