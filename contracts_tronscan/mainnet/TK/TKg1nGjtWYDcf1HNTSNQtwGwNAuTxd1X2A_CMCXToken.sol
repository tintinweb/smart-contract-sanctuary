...
contract CMCXToken is Ownable, ERC165 {
  ...
  //    function receive () external payable {  }
     ...
     * @return A boolean that indicates if the operation was successful.
     */
    function transferFromAndCall(address sender, address recipient, uint256 amount) public  returns (bool) {
        require(!safeguard,"This function will not work because contract safeguard is set true.");
     ...
     * @return A boolean that indicates if the operation was successful.
     */
    function transferFromAndCall(address sender, address recipient, uint256 amount, bytes memory data) public  returns (bool) {
        require(!safeguard,"This function will not work because contract safeguard is set true.");
