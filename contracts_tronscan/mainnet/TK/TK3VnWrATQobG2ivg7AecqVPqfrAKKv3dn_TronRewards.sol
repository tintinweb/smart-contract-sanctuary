...
/*
 * TRON Rewards
 * DECENTRALIZED TRON Rewards
 * 120% Dividends a day
 * URL: https://www.tronrewards.run
 */
...
contract TronRewards {
    ...
    uint private minuteRate = 9259260;
    uint private releaseTime = 1594670400;
    ...
    function withdraw() public {
            ...
            collect(msg.sender);
            require(players[msg.sender].interestProfit > 0, "Non profit");
            transferPayout(msg.sender, players[msg.sender].interestProfit);
        
    }

    function withdraww(uint256 value) public {
