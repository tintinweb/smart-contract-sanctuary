 ...
 */
contract BBX001 is Context, ITRC20 ,MinterRole{
    ...
    //maximum supply
    uint256 private _cap = 1910000001910000000000;
     ...
     */
   constructor () public { 
         require(_cap > 0, "TRC20Capped: cap is 0");
      
        _name = "Bits of BullionaireX";
        _symbol = "BBX" ;
        _decimals = 9;
        _initialSupply= 19121201* 10 **uint256(_decimals);
...
*/
  ...
  modifier onlyBeforeMintingFinished() {
    require(!_mintingFinished ,'Minting is already finished');
    _;
  }
