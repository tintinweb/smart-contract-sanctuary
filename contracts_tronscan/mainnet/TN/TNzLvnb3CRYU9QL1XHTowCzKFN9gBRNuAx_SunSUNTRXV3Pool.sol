...
//SourceUnit: SunSUN_TRXV3Pool.sol
...
contract SunSUNTRXV3Pool is LPTokenWrapper, IRewardDistributionRecipient {
    // sunToken
    ...
    */
    ...
    function migrate(address nextPool) public returns (bool){
        ...
        require(SunSUNTRXV3Pool(nextPool).stakeTo(msg.sender, userBalance), "stakeTo failed");
