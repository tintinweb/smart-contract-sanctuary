...
contract CFT is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 9777 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = 'CFT';
    ...
    //�����ѵ�ַ
    address private fundAddress = address(0x41E08F0C98C281E572C7BAB942C0E6CE5B209B605D);
    ...
    //������ȼ�պ��ﵽ������ֵ�����Ƴ�����������
    uint256 public  MAX_STOP_FEE_TOTAL = 2021 * 10**uint256(_decimals);
    uint256 private maxSale= 5000* 10**18;
    constructor () public {
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        //�ﵽ����ȼ��feeʱ�Ƴ������ѣ������ж��Ƿ����ų������У��Ǿ��Ƴ����ã�����ת�ˣ�ת�����ָ�������
        ...
        if(Address.isContract(recipient)){
          require(amount<=maxSale,"超过最大卖出数量");
          removeAllFee();
          _transferStandard(sender, recipient, amount);
          restoreAllFee();
          return;
