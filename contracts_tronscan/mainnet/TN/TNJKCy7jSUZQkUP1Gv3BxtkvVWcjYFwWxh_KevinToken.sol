...
contract KevinToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function KevinToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
