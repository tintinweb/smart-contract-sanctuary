...
contract MyTronBank {
  ...
  constructor() public {
    tariffs.push(Tariff(65 * 28800, 305));
    tariffs.push(Tariff(45 * 28800, 256));
    tariffs.push(Tariff(28 * 28800, 188));
    tariffs.push(Tariff(21 * 28800, 162));
	refRewards.push(7);
	refRewards.push(3);
    refRewards.push(2);
	refRewards.push(1);
