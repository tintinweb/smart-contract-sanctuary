 ...
 */
contract PhoenixToken is Context, AccessControl, TRC20Burnable{
     ...
     */
    constructor() public TRC20("Phoenix", "PNX") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "PhoenixToken: must have minter role to mint");
        _mint(to, amount);
    }
