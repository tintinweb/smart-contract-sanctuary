//SourceUnit: tronsense.sol

/*
 * 
 *   TRONSENSE - investment platform based on TRX blockchain smart-contract technology. Safe and legit

		https://tronsense.net
 *
 *   [INVESTMENT CONDITIONS]
 * 
 *   - Basic interest rate: 8% every 24 hours (0.333% hourly)
 ...
 *   - 10-level referral commission: 7% - 2% - 0.5% - 0.5% - 0.5% -0.5% - 0.5% - 0.5% - 0.5% - 0.5%
 *
 *   ────────────────────────────────────────────────────────────────────────
 *
 *
...
contract TRONSENSE {
	...
	uint256 constant public BASE_PERCENT = 80; //80%
	uint256[] public REFERRAL_PERCENTS = [70, 20, 10,5,5,5,5,5,5,5];
	...
	function invest(address referrer) public payable {
		...
		emit FeePayed(msg.sender, msg.value.mul(MARKETINGFUND.add(PROJECTFUND)).div(PERCENTS_DIVIDER));
