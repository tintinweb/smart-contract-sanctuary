...
contract GM_P {
    ...
    constructor(address ownerAddress, address ID2, address ID3) public {
        ...
        users[ownerAddress].m2Matrix[2].firstLevelJuniors.push(ID2);
        users[ownerAddress].m2Matrix[2].firstLevelJuniors.push(ID3);

        users[ownerAddress].m2Matrix[3].firstLevelJuniors.push(ID2);
        users[ownerAddress].m2Matrix[3].firstLevelJuniors.push(ID3);

        users[ownerAddress].m2Matrix[4].firstLevelJuniors.push(ID2);
        users[ownerAddress].m2Matrix[4].firstLevelJuniors.push(ID3);

        users[ownerAddress].m2Matrix[5].firstLevelJuniors.push(ID2);
        users[ownerAddress].m2Matrix[5].firstLevelJuniors.push(ID3);

        users[ownerAddress].m2Matrix[6].firstLevelJuniors.push(ID2);
        users[ownerAddress].m2Matrix[6].firstLevelJuniors.push(ID3);

        users[ID2].m1Matrix[1].Senior = ownerAddress;
        users[ID3].m1Matrix[1].Senior = ownerAddress;

        users[ID2].m2Matrix[1].Senior = ownerAddress;
        users[ID3].m2Matrix[1].Senior = ownerAddress;

        users[ID2].m2Matrix[2].Senior = ownerAddress;
        users[ID3].m2Matrix[2].Senior = ownerAddress;

        users[ID2].m2Matrix[3].Senior = ownerAddress;
        users[ID3].m2Matrix[3].Senior = ownerAddress;

        users[ID2].m2Matrix[4].Senior = ownerAddress;
        users[ID3].m2Matrix[4].Senior = ownerAddress;

        users[ID2].m2Matrix[5].Senior = ownerAddress;
        users[ID3].m2Matrix[5].Senior = ownerAddress;

        users[ID2].m2Matrix[6].Senior = ownerAddress;
        users[ID3].m2Matrix[6].Senior = ownerAddress;
    ...
    function updateM2referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].m2Matrix[level].firstLevelJuniors.length < 2) {
            ...
            emit NewUserPlace(userAddress, referrerAddress, 1, level, uint8(users[referrerAddress].m2Matrix[level].firstLevelJuniors.length));
