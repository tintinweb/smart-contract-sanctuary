...
contract _ARABCOIN is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('ARABCOIN', 'ARB', 18) public {
...
contract ARABCOIN is Ownable,_ARABCOIN
{
      using SafeMath for uint256;
   constructor() public{
   }
