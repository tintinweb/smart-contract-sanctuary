...
contract Owned {
    ...
    constructor() public {
        owner = address(0x410C362EB2ABF713F9147BB0070DCF3D1265CECB8B);
    }
...
contract Token is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        sale = 3000000 * 10**uint(decimals);
        reserve = 4000000 * 10**uint(decimals);
    ...
    function buyTokens(address payable reffer) public payable {
        ...
        //stage 1 - 1602900000 (17 oct)  : end time - 1604109600 (31 oct 2020)
        //stage 2 - 1604196000 (1 nov ) : end time - 1605405600 (15 nov 2020)
        //stage 3 - 1605492000 (16 nov) : end time - 1606701600 (30 nov 2020)
        
        // calculate token amount to be created
        /*
        if(now >= 1602900000 && now <= 1604109600){
            phase=1;
        }
        else if(now >= 1604196000 && now <= 1605405600){
            phase=2;
        }
        else if(now >= 1605492000 && now <= 1606701600){
            phase=3;
        }
        else{
       ...
       // distribute Refferal
       if(reffer != address(0) && balances[reffer] >=142*1e6){
