...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 131419 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'DYS Token';
    string private _symbol = 'DYS';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x418076D13A4F79F086E383FF3A695303D9486AE01F);
