...
/*
 * 
 *   BTT - BITLOTO188.COM | BSB BITLOTO TOKEN
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://bitloto188.com                                     │
 *   │                                                                       │   
 *   │   Contract Address: TN9LxHjZ8nxTdHoEj5CkT9DwxiBwpbfVrA                │
 *   │   Company: LOTTO NETWORK LIMITED . No . 08285053 - UK                 │
 *   |   E-mail: admin@bitloto188.com                                        |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 */
...
contract BSB_BITLOTO_TOKEN is StandardToken {
    string public name = "BSB BITLOTO TOKEN";
    string public symbol = "BSB";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 3500000 * 10 ** uint256(decimals);
