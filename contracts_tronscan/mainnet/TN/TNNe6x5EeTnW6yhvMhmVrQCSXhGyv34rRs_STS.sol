...
contract ERC20 is IERC20 {
    ...
    uint256 private _sayNo = 2.1 * 10000 * 1000000000000000000 ; 
     /**
      * Token holder :
      *     a.Holding tokens
    ...
    function getTotalUnLockAmount() internal view returns (uint256) {
        ...
        totalUnLock = dayDiff.mul(7210).mul(1000000000000000000);
        uint256 firstUnLock = 100 * 7210 * 1000000000000000000;
        totalUnLock=totalUnLock.add(firstUnLock);
        //check totalSupply overflow
        if(totalUnLock >= (721 * 10000 * 1000000000000000000)){
           return 721 * 10000 * 1000000000000000000;
        }
 ...
 * `ERC20` functions.
 */
contract STS is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Time Secret", "STS", 18) {
        _mint(msg.sender, 721 * 10000 * 1000000000000000000 );
    }
}
