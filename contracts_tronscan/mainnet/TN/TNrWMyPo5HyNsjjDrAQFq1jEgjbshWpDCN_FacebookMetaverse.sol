//SourceUnit: FacebookMetaverse.sol
...
contract FacebookMetaverse is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 22112021;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Facebook Metaverse", "FMETA", 6){
        	owner = msg.sender;	
