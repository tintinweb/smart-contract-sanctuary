...
contract TronLike2 {
	...
	uint256[] public REFERRAL_PERCENTS = [50, 10, 5,5,5,5,5,5,5,5];
	...
	uint256 constant public  INTENVAL = 2 hours;
	...
	function withdraw() public {
		...
		require( block.timestamp > user.updateTime.add(INTENVAL),'Try again in 2 hours');
