...
contract DK is ERC20token, ERC677Token {
    ...
    function partake(address payable _affAddr, uint amount) public payable{
        require(amount == 200 || amount == 500 || amount == 1000, "Please enter the specified quantity");
    ...
    function getTeamInfo() public view returns(uint team200length, uint team500length, uint team1000length){
        team200length = team200.length;
