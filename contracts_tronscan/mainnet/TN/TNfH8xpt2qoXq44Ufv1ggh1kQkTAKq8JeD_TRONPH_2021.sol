//SourceUnit: TronPilipinasTron.sol
...
contract TRONPH_2021 {
    ...
    uint256  public dev_fee = 35;
    uint256  public admin1_fee = 35;
    ...
    address payable public dev_account = address(0x41D91BCDA07390FC8D323B55621C51837C79384452);
    address payable public admin_account1 = address(0x41D91BCDA07390FC8D323B55621C51837C79384452);
    address payable public admin_account2 = address(0x41D91BCDA07390FC8D323B55621C51837C79384452);
    address payable public insurance_account = address(0x41CF6F95542B37C4E6532390195A3FF26CB1F95CC1);
    address payable public general_insurance_account = address(0x41CF6F95542B37C4E6532390195A3FF26CB1F95CC1);
