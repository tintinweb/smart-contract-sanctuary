...
contract  MHWToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 100000000000000 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = ' MHW Token';
    string private _symbol = ' MHW';
    uint8 private _decimals = 4;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x069e81A04743E299ae278340627e0b2dcB6C08b6);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 10000000000000 * 10**uint256(_decimals);
