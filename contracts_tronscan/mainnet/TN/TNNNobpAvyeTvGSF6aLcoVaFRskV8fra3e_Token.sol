...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 105000000000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'XWKS Token';
    string private _symbol = 'XWKS';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41569C3A729DE94C43BDA477221B9C9F1F9E5F8B86);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 9999999 * 10**uint256(_decimals);
