...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'BBJH';
    string private _symbol = 'BBJH';
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 2100000 * 10**uint256(_decimals);
    ...
    function setExcludePool(address excludePool) public onlyOwner {
        _excludePool = excludePool;
    }
