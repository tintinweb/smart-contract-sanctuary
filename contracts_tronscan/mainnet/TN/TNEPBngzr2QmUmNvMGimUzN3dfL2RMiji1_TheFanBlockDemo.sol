...
//SourceUnit: TheFanBlockDemo.sol
...
contract TheFanBlockDemo is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 100;

    constructor() public ERC721Full("TheFanBlockDemo", "TFBD") {
    _setBaseURI("https://thefanblock.com/swag-card-sample");
    }
