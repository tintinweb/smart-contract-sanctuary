...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0x416C46E92AB48B5FE01B7416CD796566341992E78D); // Stake Token address
...
contract NYCTRXLP is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public nyc = IERC20(0x41F54551A0C5B9CBC2BFEDF77F4850959A91FEB1B5);
    
    uint256 public constant DURATION = 30 days;
    uint256 public constant rewardDebuff = 24 hours;

    uint256 public starttime = 1623945600;
    ...
    function getReward() public updateReward(msg.sender)  checkStart{
        ...
        if (reward > 0) {
            ...
            safeNCYTransfer(msg.sender, reward);
            
            safeNCYTransfer(project1, reward.mul(4).div(100));
            ...
            if(referralRelationships[msg.sender]!=address(0))
            {
                ...
                safeNCYTransfer(referrer, referrerFee); 
    ...
    function safeNCYTransfer(address _to, uint256 _amount) internal {
        uint256 nycBalance = nyc.balanceOf(address(this));
        if(_amount > nycBalance) {
            nyc.safeTransfer(_to, nycBalance);
        } else {
            nyc.safeTransfer(_to, _amount);
        }
