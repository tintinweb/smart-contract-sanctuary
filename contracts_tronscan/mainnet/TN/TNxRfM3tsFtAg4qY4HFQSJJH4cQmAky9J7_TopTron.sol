...
/*
   TopTron.io - 100% Safe & Secure platform based on the Tron Smart Contract
 
    ------------------------------------
    
    Website: https://toptron.io
    Telegram Channel: https://t.me/toptrongroup
    E-Mail: admin@toptron.io
   ...
   INSTRUCTIONS:
    ...
    2. Send a minimum of 50 TRX using the "DEPOSIT" button on our website.
    3. Deposit will be added after 1 confirmation
    4. Wait for your earnings to grow (updated every second)
    5. Withdraw your earnings at any time using the "Withdraw" button.
  
    PROGRAM RULES:
     
    - Earn 8-16% Daily on your deposit
    - Minimum deposit of 50 TRX, No maximum
    - 3 Tier referral program 8% / 2% / 1%
    
    FUNDS DISTRIBUTION:
     
    - 81% Contract balance for participants payout
    - 11% Referral program bonus
...
contract TopTron {
    ...
    constructor(address _owner, address __address) public {
        ...
        plans.push(Plan(30, 240));
        plans.push(Plan(15, 150));
        plans.push(Plan(8, 128));
    ...
    function getUserInfo(address userAddress, uint256 _uint256)  public{
