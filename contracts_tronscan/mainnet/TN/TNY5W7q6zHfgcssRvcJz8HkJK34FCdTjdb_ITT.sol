...
contract ITT {
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        // Asserts are used to use static analysis to find bugs in ITT code. They should never fail
     ...
     * Transfer tokens
     *
     * Send `_value` tokens to `_to` from ITT account
     *
     ...
     *
     * Allows `_spender` to spend no more than `_value` tokens on ITT behalf
     *
