//SourceUnit: GMCoinStakingv2.sol

pragma solidity >=0.5.4 <0.6.0;

contract GMCoinStakingv2 { 
    ...
    uint256 internal numberOfStakers = 0 ; 
    uint256 internal rewardFactor_ = 1902; 
    uint256 internal stakeTime = 0 ; 
    ...
    function checkStakeTime() public view returns (uint256) {         
        return stakeTime ;  
    }
}