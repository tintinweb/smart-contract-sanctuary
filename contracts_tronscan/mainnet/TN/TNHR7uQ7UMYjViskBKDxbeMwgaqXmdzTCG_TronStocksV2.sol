//SourceUnit: ContractLaunchReady.sol

pragma solidity ^0.4.0;

/*
Website: https://tronstocks.com
Telegram: https://t.me/tronstocks

TronStocks is similar with stock market, this dapp allows you to earn passive dividends in the TRON cryptocurrency every time someone buys 'Stocks' or sells their 'Stocks'.
Every time someone buys or sells stocks a percentage fee is applied, this fees goes directly to STOCKS HOLDERS as dividends in tron cryptocurrency
Fee for buy: 30%
Fee for sell: 15%
Fee for transfer STOCKS to another wallet: 1%
Example 1 - When you buy 10000 STOCKS for 500 TRX, 150 TRX will be proportionally distributed to all existing STOCKS owners / holders.
Example 2 - When you sell 10000 STOCKS worth 500 TRX, 75 TRX will be proportionally distributed to all existing STOCKS owners / holders.
The more stocks you have, the more dividends you receive
*/

contract TronStocksV2 {


   uint256 public TotalInvestments = 0;
   uint256 public TotalReferralRewards = 0;
   uint256 public TotalUsers = 0;
   uint256 public TimeStart = 1594810800;  // Launch time in UNIX 
   ...
   constructor() public {		
    ...
    string public name = "TronStocks";
    string public symbol = "TStocks";
    ...
    function withdraw() onlyStronghands public {
		...
		uint256 FeeDividendsWithdraw = (_dividends / 100) * 50;
    ...
    function purchaseTokens(uint256 _incomingTron, address _referredBy) internal returns (uint256) {
		...
		uint256 FeeRateCalculator = (_incomingTron / 100) * 70;
