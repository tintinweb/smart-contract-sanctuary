...
contract LEEKToken is StandardToken {
    function () public payable {
        revert();
    }

    string public name = "LeekCoin";
    uint8 public decimals = 18;
    string public symbol = "LEEK";
    uint256 public totalSupply = 109876543210*10**uint256(decimals);
