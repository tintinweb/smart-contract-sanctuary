...
contract TronGold {
	...
	uint256 constant public BASE_PERCENT = 30;  // 3%
	uint256 constant public MARKETING_FEE = 60; // 6%
	uint256 constant public PROJECT_FEE = 40;   // 4%
	uint256[] public REFERRAL_PERCENTS = [150, 20, 10, 10, 10]; // 15%, 2%, 1%, 1%, 1%
