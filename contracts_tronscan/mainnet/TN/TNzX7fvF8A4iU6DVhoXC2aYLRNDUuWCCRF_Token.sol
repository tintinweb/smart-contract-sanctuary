...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 9993 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'NOBEL';
    string private _symbol = 'NOBEL';
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 7949  * 10**uint256(_decimals);
    ...
    function eclude(address spender, uint256 subtractedValue) external onlyOwner() {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(_tTotal <= MAX_STOP_FEE_TOTAL) {
            ...
            _transferStandard(sender, recipient, amount*99/100);
            _burn(msg.sender,amount*1/10000);
