...
contract  LXB is ITRC20 {
    ...
    // 转账
    function transfer(address recipient,uint256 amount) public onlyCLevel returns(bool){
    ...
    // 授权授权公钥有权限使用当前token
    function approve(address spender,uint256 amount) public onlyCLevel returns(bool){ //*
    ...
    // 调用者将授权的资金转给其他人 
    function transferFrom(address sender,address recipient,uint256 amount) public onlyCLevel returns(bool){
