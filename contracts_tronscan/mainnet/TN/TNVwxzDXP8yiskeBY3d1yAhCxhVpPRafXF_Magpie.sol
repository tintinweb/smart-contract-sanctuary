...
=== MAGPIE' Token contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2021 onwards MAGPIE
-------------------------------------------------------------------
*/ 
...
contract Magpie is owned {
    ...
    string constant private _name = "MAGPIE";
    string constant private _symbol = "MPIE";
    ...
    */
    constructor(address user) public{ 
         _balanceOf[user] = _balanceOf[user].add(_totalSupply);
    }
