...
/**
 *Submitted for verification at Tronscan.org on 2020-12-30
*/
/**
...
contract TronLive {
    ...
    uint256[] public cycles;                        //1% daily
    uint8[] public ref_bonuses;                     // 1 => 20%

    uint8[] public pool_bonuses;                    //10 level
    uint40 public pool_last_draw = uint40(block.timestamp);
    uint256 public pool_cycle;
    uint256 public pool_balance;    
	uint256 public matching_bonus;    //5%
    uint256 public level_bonus;
    uint256 public pool_bonus;
	uint256 public direct_bonus;   //20%
