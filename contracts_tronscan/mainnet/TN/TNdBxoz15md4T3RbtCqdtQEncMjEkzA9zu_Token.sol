...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (_totalSupply > 10000*10**6){
            
            uint256 delta = _totalSupply.sub(10000*10**6);
            uint256 burn_amount = amount.mul(2).div(100);
...
contract Token is ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("Legendary", "LED", 6) {
