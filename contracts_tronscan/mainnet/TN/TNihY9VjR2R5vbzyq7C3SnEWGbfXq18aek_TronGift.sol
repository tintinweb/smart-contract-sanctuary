...
struct Tariff {
  ...
  constructor() public {
    tariffs.push(Tariff(16 * 28800, 134));
    tariffs.push(Tariff(24 * 28800, 180));
    tariffs.push(Tariff(32 * 28800, 214));
    tariffs.push(Tariff(40 * 28800, 240));
