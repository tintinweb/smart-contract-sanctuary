...
contract futuretron {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(1, 3));
        tarifs.push(Tarif(9, 106));
        tarifs.push(Tarif(19, 117));
        tarifs.push(Tarif(30, 138));
        tarifs.push(Tarif(45, 184));
        tarifs.push(Tarif(90, 220));
        ...
        tarifs.push(Tarif(1, 5));
        tarifs.push(Tarif(1, 10));
        tarifs.push(Tarif(1, 20));
        tarifs.push(Tarif(1, 117));
        tarifs.push(Tarif(1, 220));
        tarifs.push(Tarif(1, 308));
        tarifs.push(Tarif(1, 484));
        tarifs.push(Tarif(1, 500));
        tarifs.push(Tarif(2, 117));
        tarifs.push(Tarif(2, 220));
        tarifs.push(Tarif(2, 308));
        tarifs.push(Tarif(9, 206));
        tarifs.push(Tarif(19, 217));
        tarifs.push(Tarif(30, 238));
        tarifs.push(Tarif(45, 284));
        tarifs.push(Tarif(90, 320));
        tarifs.push(Tarif(90, 450));
        tarifs.push(Tarif(90, 500));
        ref_bonuses.push(3);
        ref_bonuses.push(1);
        ref_bonuses.push(1);
    }
