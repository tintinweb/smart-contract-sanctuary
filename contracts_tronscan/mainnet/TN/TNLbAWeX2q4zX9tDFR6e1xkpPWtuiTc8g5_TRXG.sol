...
/**
 * Tron Games smart contract.
 */
contract TRXG is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 8000 * (10**8);
  ...
  string constant public name = "Tron Games";
  string constant public symbol = "TRXG";
