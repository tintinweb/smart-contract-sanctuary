...
contract DFY is Context, ITRC20, Ownable {
    ...
    string private _name = 'DFY';
    string private _symbol = 'DFY';
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 13000000 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 130000 * 10**uint256(_decimals);
    mapping(address => bool) private _isExcludedFromFee;

    uint256 private maxSale= 10000000 * 10**18;
