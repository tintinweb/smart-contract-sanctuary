...
contract SAToken is ITRC20, BaseTRC20 {
    constructor(address gr, address rewardAddress) public BaseTRC20("SA", "SA", 8, 10, rewardAddress){
        require(gr != address(0), "invalid gr");
        require(rewardAddress != address(0), "invalid rewardAddress");
        _mint(gr, 80000000 * 10 ** 8);
    }
}
