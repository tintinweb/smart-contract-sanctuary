...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'ERZ Token';
    string private _symbol = 'ERZ';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0xcdcd77c04102C3EF86C41A557C62ADED33FDCD4CD3F1AE8512);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 131419 * 10**uint256(_decimals);
