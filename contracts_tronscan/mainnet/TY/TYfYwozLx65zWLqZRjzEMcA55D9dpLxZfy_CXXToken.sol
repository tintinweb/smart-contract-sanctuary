...
contract CXXToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Meteor';
    string private _symbol = 'MT9';
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 10000000 * 10**uint256(_decimals);

    constructor (address adminAddress,address devAddress) public {
        fundAddress = devAddress;
