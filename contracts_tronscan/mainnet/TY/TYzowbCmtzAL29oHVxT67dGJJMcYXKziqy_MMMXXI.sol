...
using SafeMath for *;
  ...
  uint256 private constant MIN_DEPOSIT = 500*1000000;
  ...
  constructor () public {
    ...
    investors[founder[10]].status = Status.P;
    ...
    investors[address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152)].id = cuid++;
    investors[address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152)].referrer = founder[1];
    investors[address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152)].deposits[0] = Deposit({tariff_id: 1, amount: 5000000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152)].invested = 5000000000;
    investors[address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152)].numDeposits = 1;
    investors[address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152)].status = Status.P;
    investors[address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152)].referralCount = 3;

    investors[address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172)].id = cuid++;
    investors[address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172)].referrer = founder[1];
    investors[address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172)].deposits[0] = Deposit({tariff_id: 1, amount: 39600000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172)].invested = 39600000000;
    investors[address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172)].numDeposits = 1;
    investors[address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172)].status = Status.I;
    investors[address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172)].referralCount = 4;

    investors[address(0x41234bcab61485a76ea6d4ff84fe3583fc87d5e487)].id = cuid++;
    investors[address(0x41234bcab61485a76ea6d4ff84fe3583fc87d5e487)].deposits[0] = Deposit({tariff_id: 1, amount: 20000000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x41234bcab61485a76ea6d4ff84fe3583fc87d5e487)].invested = 20000000000;
    investors[address(0x41234bcab61485a76ea6d4ff84fe3583fc87d5e487)].numDeposits = 1;
    investors[address(0x41234bcab61485a76ea6d4ff84fe3583fc87d5e487)].status = Status.I;
    investors[address(0x41234bcab61485a76ea6d4ff84fe3583fc87d5e487)].referrer = founder[1];

    investors[address(0x411ca8ebf097dfba86ec4ef53a0b52138f29a4181f)].id = cuid++;
    investors[address(0x411ca8ebf097dfba86ec4ef53a0b52138f29a4181f)].referrer = address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172);
    investors[address(0x411ca8ebf097dfba86ec4ef53a0b52138f29a4181f)].deposits[0] = Deposit({tariff_id: 1, amount: 29770000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x411ca8ebf097dfba86ec4ef53a0b52138f29a4181f)].invested = 29770000000;
    investors[address(0x411ca8ebf097dfba86ec4ef53a0b52138f29a4181f)].numDeposits = 1;
    investors[address(0x411ca8ebf097dfba86ec4ef53a0b52138f29a4181f)].status = Status.I;

    investors[address(0x418b5781c2c82d7d39672cd55b16e35df2907151cd)].id = cuid++;
    investors[address(0x418b5781c2c82d7d39672cd55b16e35df2907151cd)].referrer = address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172);
    investors[address(0x418b5781c2c82d7d39672cd55b16e35df2907151cd)].deposits[0] = Deposit({tariff_id: 1, amount: 32370000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x418b5781c2c82d7d39672cd55b16e35df2907151cd)].invested = 32370000000;
    investors[address(0x418b5781c2c82d7d39672cd55b16e35df2907151cd)].numDeposits = 1;
    investors[address(0x418b5781c2c82d7d39672cd55b16e35df2907151cd)].status = Status.I;

    investors[address(0x41549d88e46f1615becfa7a4244f77f58eecefdaae)].id = cuid++;
    investors[address(0x41549d88e46f1615becfa7a4244f77f58eecefdaae)].referrer = address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172);
    investors[address(0x41549d88e46f1615becfa7a4244f77f58eecefdaae)].deposits[0] = Deposit({tariff_id: 1, amount: 32500000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x41549d88e46f1615becfa7a4244f77f58eecefdaae)].invested = 32500000000;
    investors[address(0x41549d88e46f1615becfa7a4244f77f58eecefdaae)].numDeposits = 1;
    investors[address(0x41549d88e46f1615becfa7a4244f77f58eecefdaae)].status = Status.I;

    investors[address(0x419b5dd3d6dc8e3b8df86d1e0721d3c49a7c46bdb8)].id = cuid++;
    investors[address(0x419b5dd3d6dc8e3b8df86d1e0721d3c49a7c46bdb8)].referrer = address(0x4184203b2d3f439ccfb204e091b03f98de2bfcd172);
    investors[address(0x419b5dd3d6dc8e3b8df86d1e0721d3c49a7c46bdb8)].deposits[0] = Deposit({tariff_id: 1, amount: 20800000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x419b5dd3d6dc8e3b8df86d1e0721d3c49a7c46bdb8)].invested = 20800000000;
    investors[address(0x419b5dd3d6dc8e3b8df86d1e0721d3c49a7c46bdb8)].status = Status.I;
    investors[address(0x419b5dd3d6dc8e3b8df86d1e0721d3c49a7c46bdb8)].numDeposits = 1;

    investors[address(0x4157d36a40e7f070f05f1ba4dc2a2aee2813667bc2)].id = cuid++;
    investors[address(0x4157d36a40e7f070f05f1ba4dc2a2aee2813667bc2)].referrer = address(address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152));
    investors[address(0x4157d36a40e7f070f05f1ba4dc2a2aee2813667bc2)].numDeposits = 1;
    investors[address(0x4157d36a40e7f070f05f1ba4dc2a2aee2813667bc2)].status = Status.P;

    investors[address(0x41ddcd3fec283bbe4463443733671064aeba326584)].id = cuid++;
    investors[address(0x41ddcd3fec283bbe4463443733671064aeba326584)].referrer = address(0x4157d36a40e7f070f05f1ba4dc2a2aee2813667bc2);
    investors[address(0x41ddcd3fec283bbe4463443733671064aeba326584)].deposits[0] = Deposit({tariff_id: 1, amount: 8500000000, at: round, paid_out: 0, to_pay: 0, closed: false});
    investors[address(0x41ddcd3fec283bbe4463443733671064aeba326584)].invested = 8500000000;
    investors[address(0x41ddcd3fec283bbe4463443733671064aeba326584)].numDeposits = 1;
    investors[address(0x41ddcd3fec283bbe4463443733671064aeba326584)].status = Status.I;

    investors[address(0x4157b135c40ae1a2de364e1ed01fd4b9d00e656514)].id = cuid++;
    investors[address(0x4157b135c40ae1a2de364e1ed01fd4b9d00e656514)].referrer = address(address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152));
    investors[address(0x4157b135c40ae1a2de364e1ed01fd4b9d00e656514)].numDeposits = 1;
    investors[address(0x4157b135c40ae1a2de364e1ed01fd4b9d00e656514)].status = Status.P;

    investors[address(0x41f73c47515183f89853919acf71518a4908088a59)].id = cuid++;
    investors[address(0x41f73c47515183f89853919acf71518a4908088a59)].referrer = address(address(0x4145cde38de01e93fa7d18e4096cc1f43573bed152));
    investors[address(0x41f73c47515183f89853919acf71518a4908088a59)].numDeposits = 1;
    investors[address(0x41f73c47515183f89853919acf71518a4908088a59)].status = Status.P;
    investors[address(0x41fc69e8f419a245409d0c0d5ed9718d8909dfe75e)].id = cuid++;
    investors[address(0x41fc69e8f419a245409d0c0d5ed9718d8909dfe75e)].referrer = founder[3];
    investors[address(0x41fc69e8f419a245409d0c0d5ed9718d8909dfe75e)].numDeposits = 1;
    investors[address(0x41fc69e8f419a245409d0c0d5ed9718d8909dfe75e)].status = Status.P;
      ...
      if( investors[user].deposits[did].amount >= MIN_DEPOSIT ) {
        ...
        if (dep.tariff_id == 0 || dep.tariff_id == 1) {
          ...
          if (depositDay > 0 && ! investors[user].deposits[did].closed ) {
            ...
            uint256 curAmount = amountDay.mul(depositDay);
            uint256 toPay = curAmount.sub(investors[user].deposits[did].paid_out);
            if ( toPay > diff ) {
              return diff;
            } else {
              return toPay;
