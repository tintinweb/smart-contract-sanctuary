...
contract BlackList is Ownable, BasicToken {
    ...
    /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded TXCA) ///////
...
contract TXCAToken is Pausable, StandardToken, BlackList {
    ...
    function TXCAToken(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
