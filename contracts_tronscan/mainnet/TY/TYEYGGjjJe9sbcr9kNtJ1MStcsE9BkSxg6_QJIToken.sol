...
contract QJIToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 26666 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'QJI Token';
    string private _symbol = 'QJI';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x4140868A72BE530B2C205687D026585A98C4E2F614);
