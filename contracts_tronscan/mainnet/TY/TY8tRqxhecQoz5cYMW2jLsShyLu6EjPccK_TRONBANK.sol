...
contract TRONBANK {
    ...
    uint256 public feedToTronbank = 2;
    uint256 public commissionDivisor = 100;
    uint256 public startTime = 1575150000;
    uint256 public tronbankDividend = 0;

    address public owner;
    address devAddress;
    address marketingAddress;
    address tronbankAddress;
    ...
    constructor(address _tronbankAddress) public {
      ...
      tronbankAddress = _tronbankAddress;
    }
    ...
    function deposit(address _affAddr) public payable {
        ...
        //uint256 tronbankReserve = depositAmount.mul(feedToTronbank).div(commissionDivisor);
        //tronbankAddress.transfer(tronbankReserve);
        //tronbankDividend = tronbankDividend.add(tronbankReserve);
    ...
    function withdraw() public {
        ...
        Player storage player = players[msg.sender];
	uint256 withdrawAmount = player.interestProfit;
        player.trxDeposit = player.trxDeposit.sub(withdrawAmount/2);
        calculateCurrLevel(msg.sender);
    ...
    function ownerZeroouttronBankDividend() public {
