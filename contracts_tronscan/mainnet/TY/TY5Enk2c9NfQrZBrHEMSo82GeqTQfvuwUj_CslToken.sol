...
contract CslToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("CSLTOKEN", "CSL", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 100000000000 * 10 ** 18);
    }
}

//SourceUnit: ITRC201.sol
