...
//Blockchain changes the world-star chart
...
contract StarChart is Pausable, StandardTokenWithFees, BlackList {
    ...
    function StarChart(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
