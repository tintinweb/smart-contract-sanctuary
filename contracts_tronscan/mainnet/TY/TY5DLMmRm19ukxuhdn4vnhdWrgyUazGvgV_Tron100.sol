...
/*  tron100.site | (tm)(c) 2021 A.C IT Group (ACIG)  */
...
contract Tron100 {
    ...
    constructor() public {
        ...
        soft_release = 1609765200;
        full_release = 1609804800;
    }

    function deposit(address _referral) external payable {
        require(now > soft_release, "Not launched");
        require(msg.value >= 3e7, "Minimal deposit: 30 TRX");
