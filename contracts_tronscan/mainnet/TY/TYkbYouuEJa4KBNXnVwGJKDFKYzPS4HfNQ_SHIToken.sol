...
// Enable optimization
pragma solidity ^0.6.0;
contract SHIToken is ERC20, ERC20Detailed {
    constructor () public ERC20Detailed("SHIToken", "Shit", 8, 1990000) {
        _mint(_msgSender(), uint256(amount()) * (10 ** uint256(decimals())));
    }
}