...
contract DogiMonToken is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 100000;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Dogimon Token", "DMON", 6){
        	owner = msg.sender;	
