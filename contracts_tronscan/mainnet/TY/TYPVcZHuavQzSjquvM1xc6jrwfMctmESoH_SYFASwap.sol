...
contract SYFASwap {
    ...
    uint256 public idoAmount = 2000000;

    uint256 public alreadyIDO = 0;

    uint256 public price = 6100;
    
    uint256 public minAmount = 1e6;
    ...
    function setIDOAmount(uint256 _idoAmount) public {
        require(msg.sender == contractOwner, "Must be owner");
    ...
    function swap() public payable {
        ...
        require(amount >= minAmount, "Less than the limit");
        
        alreadyIDO = alreadyIDO.add(amount);
        
        uint256 sucAmount = amount.mul(price);
        
        token.safeTransfer(msg.sender, sucAmount) ; 
