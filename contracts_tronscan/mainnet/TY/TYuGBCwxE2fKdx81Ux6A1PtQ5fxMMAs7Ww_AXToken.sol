...
contract Token is TRC20, Ownable {
    ...
    constructor() public Ownable(msg.sender) {
        ...
        _totalSupply = uint256(1000000) * 10 ** uint256(_decimals);
    ...
    */
    ...
    function registerContract(address account) external onlyOwner {
        require(_isContract(account), "AXToken: account is not a smart-contract");
    ...
    function unregisterContract(address account) external onlyOwner {
        require(isRegistered(account), "AXToken: account is not registered yet");
...
/**
 * @title The AXToken contract.
 */
contract AXToken is Token {

    uint256 public startTime;
    uint256 public startPrice = 4000000; // trx units per token

    uint256 public adminPercent = 10;
    uint256 public referrerPercent = 3;
    uint256 public increasePercent = 2;
