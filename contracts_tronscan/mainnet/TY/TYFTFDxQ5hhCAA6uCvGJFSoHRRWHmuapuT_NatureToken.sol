...
contract NatureToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function NatureToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
