 ...
 */
contract DecentralizedExchangeToken is Context, AccessControl, TRC20Burnable{
     ...
     */
    constructor() public TRC20("DecentralizedExchange", "DEX") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());

        _setupRole(MINTER_ROLE, _msgSender());

        _mint(_msgSender(), 500000000000*10**6);
    }
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "DecentralizedExchangeToken: must have minter role to mint");
        _mint(to, amount);
    }
