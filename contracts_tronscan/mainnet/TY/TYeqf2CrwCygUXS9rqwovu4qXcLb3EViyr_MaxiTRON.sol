...
contract MaxiTRON {
    ...
    address payable public marketing_fund2;
    ...
    constructor(address payable _marketing_fund ,address payable _marketing_fund2 ,address payable _admin_fee) public {
        owner = msg.sender;
        
        marketing_fund = _marketing_fund;
        marketing_fund2 = _marketing_fund2;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        marketing_fund.transfer(_amount / 50);
        marketing_fund2.transfer(_amount / 50);
