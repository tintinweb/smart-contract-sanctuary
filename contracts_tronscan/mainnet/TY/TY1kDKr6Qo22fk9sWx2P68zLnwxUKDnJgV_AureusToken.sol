 ...
 */
contract AureusToken is Context, AccessControl, TRC20Burnable{
     ...
     */
    constructor() public TRC20("Aureus", "ARS") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "AureusToken: must have minter role to mint");
        _mint(to, amount);
    }
