...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'Eminer Fans';
    string private _symbol = 'EM';
    uint8 private _decimals = 8;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x2FF4Ae6C442fE902A33Ddd5FB528dB8cDBcf2f44);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 6 * 10**uint256(_decimals);
