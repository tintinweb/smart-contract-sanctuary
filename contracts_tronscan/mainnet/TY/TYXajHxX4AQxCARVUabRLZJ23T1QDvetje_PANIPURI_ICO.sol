...
contract PANIPURI_ICO {
	...
	uint256 precision = 1000000000000000000;   //Decimal places of the token
   ...
   function () payable public{
    ...
    function createTokens(address) payable public{
        ...
        tokencontract.transferFrom(wallet, msg.sender, ((tokens.div(1000000)).mul(precision)).mul(currentRate));
        
        totalTokensSoldTillNow = totalTokensSoldTillNow.add(((tokens.div(1000000)).mul(precision)).mul(currentRate)); 
