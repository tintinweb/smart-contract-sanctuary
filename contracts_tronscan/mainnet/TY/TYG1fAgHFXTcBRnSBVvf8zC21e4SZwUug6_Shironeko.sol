...
contract Shironeko is Pausable, StandardTokenWithFees, BlackList {

    address public upgradedAddress;
    bool public deprecated;
    
    function Shironeko() public {
         decimals = 18;
    ...
    // function Shironeko(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
