...
contract WaterBridgeExToken is DSTokenBase(0), DSStop {
    string  public  symbol;
    string   public  name = "W10";
    uint256  public  decimals = 6; 
	mapping (address => uint256) public freezeOf;
    constructor(string memory symbol_, string memory name_, uint256 initialSupply) public {
        symbol = symbol_;
        name = name_;
   ...
   function freeze(address guy,uint256 wad)  public  {
    ...
    function unfreeze(address guy,uint256 wad)  public {
        if (guy != msg.sender && _approvals[guy][msg.sender] != uint256(-1)) {
            _approvals[guy][msg.sender] = sub(_approvals[guy][msg.sender], wad);
        }
