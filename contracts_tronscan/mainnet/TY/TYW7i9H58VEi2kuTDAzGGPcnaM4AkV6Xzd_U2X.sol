...
contract _ERC20 is Context, TRC20 {
    ...
    /* allocating 5 million tokens for promotion, airdrop, liquidity, dev share and to fund development of next project "Razor Bridge"*/
...
contract TransformableToken is StakeableToken {
    ...
    {
        /* 24657534246  = ~ 90000 * SUNS_PER_DIV /365  */
        if (EnterDay > 0 && EnterDay <= 365) {                                     
            waasLobby = CLAIM_STARTING_AMOUNT - ((EnterDay - 1) * 24657534246);
        } else {
