...
contract Token is TRC20, TRC20Detailed {
    ...
    constructor () public TRC20Detailed("VLINK TOKEN", "VLG", 8) {
        _mint(msg.sender, 999999999 * (10 ** uint256(decimals())));
    }
}


//SourceUnit: VLGToken.sol
...
contract VLGToken is TRC20, TRC20Detailed {
    constructor () public TRC20Detailed("VLG Token", "VLG", 8) {
        _mint(msg.sender, 999999999 * (10 ** uint256(decimals())));
    }
}