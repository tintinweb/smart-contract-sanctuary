...
contract MYTRONdotCash {
  ...
  constructor() public {
    tariffs.push(Tariff(175 * 28800, 350));
    tariffs.push(Tariff(175 * 28800, 180));
    tariffs.push(Tariff(175 * 28800, 100));
    tariffs.push(Tariff(175 * 28800, 130));
