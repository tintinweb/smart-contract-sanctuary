...
contract JUSTSWAPTEST is Pausable, StandardTokenWithFees, BlackList {
    ...
    function JUSTSWAPTEST(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
