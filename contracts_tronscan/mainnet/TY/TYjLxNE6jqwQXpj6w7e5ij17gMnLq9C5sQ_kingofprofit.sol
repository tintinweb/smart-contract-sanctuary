//SourceUnit: kingofprofit.sol

/*
 * 
 *  Welcome to KingOfProfit.pw   invest tron - Open Investment on Smart Contract!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://Invest-tron.com                                  │
 *   │                                                                       │  
 *   │   Telegram Live Support: https://t.me/KingOfProfit.pws             |
 *   │   Telegram Public Group: https://t.me/KingOfProfit.pw              |
 *   │                                                                       |
...
contract kingofprofit {
    ...
    constructor(address _stakingAddress) public {
        ...
        tarifs.push(Tarif(61, 305));
        tarifs.push(Tarif(45, 256));
        tarifs.push(Tarif(28, 188));
        tarifs.push(Tarif(21, 162));
		        tarifs.push(Tarif(21, 162));
        tarifs.push(Tarif(21, 162));
        tarifs.push(Tarif(21, 162));
        tarifs.push(Tarif(21, 162));
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        stakingAddress.transfer(msg.value.mul(20).div(100));
