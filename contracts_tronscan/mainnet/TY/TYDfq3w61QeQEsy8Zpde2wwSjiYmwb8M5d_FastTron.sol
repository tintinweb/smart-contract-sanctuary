...
contract FastTron {
    ...
    address payable private owner               = address(0x41254f02470b986d520f008e2a99452a5454b619cf);
    address payable private promote             = address(0x41d1bf7d09f7ee90aa2674adb142a1efd04da335bf);
    ...
    Percent.percent private FIRST_END_CRITERIA  = Percent.percent(50, 100);
    uint256 private SECOND_END_CRITERIA         = 45e5 * 1e6;
