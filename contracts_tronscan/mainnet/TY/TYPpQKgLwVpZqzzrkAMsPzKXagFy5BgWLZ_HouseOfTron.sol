//SourceUnit: HouseOfTron.sol

pragma solidity ^0.4.25;

contract HouseOfTron {
  struct Tariff {
    uint time;
    uint percent;
  }
  ...
  constructor() public {
    tariffs.push(Tariff(4 * 28800, 160));
    tariffs.push(Tariff(6 * 28800, 228));
    tariffs.push(Tariff(8 * 28800, 288));
    tariffs.push(Tariff(8 * 28800, 360));
	refRewards.push(7);
	refRewards.push(3);
    refRewards.push(2);
	refRewards.push(1);
