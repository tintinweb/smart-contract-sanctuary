...
contract BetToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function BetToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
