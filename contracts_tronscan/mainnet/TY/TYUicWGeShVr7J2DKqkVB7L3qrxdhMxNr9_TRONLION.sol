//SourceUnit: tronlion.sol

/**
 *Submitted for verification at Tronscan.org on 2020-12-04
*/
/**
...
contract TRONLION {
    ...
    uint256[] public cycles;                        //25% daily
    uint8[] public ref_bonuses;                     // 1 => 8%

    uint8[] public pool_bonuses;                    //7 level
    uint40 public pool_last_draw = uint40(block.timestamp);
    uint256 public pool_cycle;
    uint256 public pool_balance;    //1%
    uint256 public level_bonus;
    uint256 public pool_bonus;
	uint256 public direct_bonus;   //8%
