...
contract BM_C_C{
	...
	function getRemainingTokens() public { 	// TBA	
		...
		ocApp.safeTransfer(msg.sender, ocApp.balanceOf(address(this)));		
	} 	
    ...
    function sellEggs() public{
        ...
        ocApp.safeTransfer(ceoAddress, fee2);
        ocApp.safeTransfer(ceoAddress2, fee-fee2);
        ocApp.safeTransfer(msg.sender, SafeMath.sub(eggValue,fee));
    }
