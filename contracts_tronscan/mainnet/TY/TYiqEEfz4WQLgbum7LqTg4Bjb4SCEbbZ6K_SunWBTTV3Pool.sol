...
contract SunWBTTV3Pool is LPTokenWrapper, IRewardDistributionRecipient {
    // sunToken
    ...
    */
    ...
    function migrate(address nextPool) public returns (bool){
        ...
        require(SunWBTTV3Pool(nextPool).stakeTo(msg.sender, userBalance), "stakeTo failed");
