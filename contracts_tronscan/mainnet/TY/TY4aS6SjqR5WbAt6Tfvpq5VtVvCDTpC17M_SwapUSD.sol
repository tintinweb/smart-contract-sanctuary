...
contract _SwapUSD is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('SwapUSD', 'SUDT', 18) public {
...
contract SwapUSD is Ownable,_SwapUSD
{
      using SafeMath for uint256;
   constructor() public{
   }
