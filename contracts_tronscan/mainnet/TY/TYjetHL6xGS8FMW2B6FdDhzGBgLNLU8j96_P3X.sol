...
contract P3X{
    ...
    function exit() public checkStart {
        address _customerAddress = msg.sender;
    ...
    function withdraw() public checkStart onlyStronghands{
    ...
    function sell(uint256 _amountOfTokens) public onlyBagholders checkStart {
        address _customerAddress = msg.sender;
    ...
    function purchaseTokens(uint256 _incomingTron) internal checkStart returns (uint256) {
        address _customerAddress = msg.sender;
