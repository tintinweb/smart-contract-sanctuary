...
contract Consts {
    ...
    string public constant TOKEN_NAME = "USD JSB";
    string public constant TOKEN_SYMBOL = "USJ";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0xc4A04e9cAcb1111B7B25214d7B4628eAE6866253;
    bool public constant CONTINUE_MINTING = true;
}


contract USD_JSB is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
