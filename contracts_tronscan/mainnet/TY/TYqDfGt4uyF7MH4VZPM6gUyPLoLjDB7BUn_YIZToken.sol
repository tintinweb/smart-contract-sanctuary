...
contract YIZToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("YIZ TOKEN", "YIZ", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 36000 * 1000 * 10 ** 18);  //3600万   小数点18位
    }
}