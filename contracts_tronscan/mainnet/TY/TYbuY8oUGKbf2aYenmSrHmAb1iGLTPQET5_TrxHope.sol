...
contract TrxHope{
    ...
    uint private releaseTime = 100800;  //November 09,2020, 12pm UTC
    ...
    //Esta funcion no la llamo yo, sino que la llama otra funcion dentro del contrato
    ...
    //llamo a esta para cuando el usuario quiera cobrar
    ...
    //Esta tampoco se llama, es interna
