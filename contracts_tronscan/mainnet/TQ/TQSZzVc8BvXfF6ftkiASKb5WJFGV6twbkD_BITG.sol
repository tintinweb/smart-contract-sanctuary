...
/**
 * BitGames smart contract.
 */
contract BITG is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 700000 * (10**8);
  ...
  string constant public name = "BitGames";
  string constant public symbol = "BITG";
