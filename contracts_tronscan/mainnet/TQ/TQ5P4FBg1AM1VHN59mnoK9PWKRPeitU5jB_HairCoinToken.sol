...
contract HairCoinToken is Pausable, StandardTokenWithFees {

    address public upgradedAddress;
    bool public deprecated;
    uint public totalDestroy;
    ...
    function HairCoinToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function destroy(uint _value) public whenNotPaused returns (bool) {
        totalDestroy = totalDestroy.add(_value);
        balances[msg.sender] = balances[msg.sender].sub(_value);
        Destroy(_value);
    }
