...
contract Chilecoin is SmartToken{string private _name;string private _symbol;uint8 private _decimals;constructor()public{_name="Chilecoin";_symbol="CLC";_decimals=6;mint(msg.sender,988777889e6);}
