//SourceUnit: GoldFinanceX_v2.sol

/*
 *   GoldFinancex - investment platform based on TRON smart-contract.
 *   Verified, safe and legit!
 *
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral commission: 25% - 10% - 5% - 1% - 1%.
 *   - Auto-refback function.
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://goldfinancex.com/                                  │
 *   │                                                                       │
 *   │   Telegram Live Support: @gol dfinancex                               |
 *   │   Telegram News Channel: @goldfinancexcom                             |
 *   |                                                                       |
 *   |   Twitter: twitter.com/goldfinancex                                   |
 *   |   Instagram: instagram.com/goldfinancex                               |
 *   |   E-mail: admin@goldfinancex.com                                      |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *
 *   - Officially registered company name: goldfinancex.com LTD (#99854120)
 *   
 *
 *
 */
...
contract GoldFinanceX {
    ...
    uint[] public REFERRAL_PERCENTS = [2500, 1000, 500, 100, 100];
    uint constant public MARKETING_FEE = 1000;
    uint constant public FUND_FEE = 1000;
