...
contract SriCoin is TRC20Detailed,TRC20,Ownable,TRC20Burnable,TRC20Mintable {


    constructor()
        public
         TRC20Detailed ("SRI COIN", "SRIC", 18) {
            _mint(msg.sender, 999999999 * (10 ** uint256(18)));
        }
