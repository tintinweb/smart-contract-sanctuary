...
contract ITRC20 is TRC20Events {
    ...
    function approve(address from, uint value) public returns (bool);
    function transfer(address from, uint value) public returns (bool);
...
/*********   JNB  Token  *******************/
contract JiNiu is ITRC20, TRC20Detailed 
{
    constructor(address gr) public TRC20Detailed("JiNiu", "JNB", 6)
{
