...
contract AGGREGATOR3K is SafeMath,owned{
		struct UserInfo {
				address userAddress;
		...
		uint256 mixInvestmentAmount = 10 * 10 ** uint256(decimals) ;
		...
		constructor() public {
				...
				subcoinAddress = 0xEB615CB0C4C0B025435AB078E979D07723BFD825;
		...
		function registration(uint256 amount,uint256 serialNumber) external {
				...
				require(amount >= mixInvestmentAmount, "Minimum investment: 10u");
