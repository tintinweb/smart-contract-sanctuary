//SourceUnit: TronTravelsBTT.sol

/*! ===========================================================================================================
+                                                                                                             + 
+    TronTravelsBTT.sol | (c) 2020 by Groeßg | License-Identifier: BSD-3-Clause                               +  
+                                                                                                             +
+                                                                                                             +
+    Telegram Group: https://t.me/trontravels                                                                 +
+    For FAQs, Please visit https://www.trontravelsdapp.com/ or our chat group                                + 
+    Admins and Investors are working together to deliver our commitment of fairness and transparency.        +
+    Our main objective is to make all investors profit. We listen and continously learn.                     +
+    Please continue to support us as you have supported us with our TRX Project.                             +
+    Company Registration No : (On Process)                                                                   +
+                                                                                                             +
+                                                                                                             +
=============================================================================================================*/
...
contract TronTravelsBTT {
  ...
  constructor() public {
    tariffs.push(Tariff(18 * 28800, 120));
    tariffs.push(Tariff(24 * 28800, 140));
    tariffs.push(Tariff(30 * 28800, 160));
    tariffs.push(Tariff(36 * 28800, 180));
