...
* - Personal hold-bonus: +0.15% for every 24 hours without withdrawal
* - Contract total amount bonus: +0.15% for every 1,000,000 TRX on platform address balance
*
...
* - Certificate of incorporation: https://spaceoftron.com/img/certificate.pdf
*
* [SMART-CONTRACT AUDITION AND SAFETY]
*
* - Audited by independent company Telescr.in (https://telescr.in)
* - Audition certificate: https://spaceoftron.com/audition.pdf
* - Video-audit: https://spaceoftron.com/review.avi
*
*/
...
contract SpaceOfTron {
    ...
    uint256 constant public MULTIPLIER = 15;
    ...
    function getContractBalanceRate() public view returns (uint256) {
        uint256 contractBalance = address(this).balance;
        uint256 contractBalancePercent = contractBalance.div(BALANCE_STEP);
