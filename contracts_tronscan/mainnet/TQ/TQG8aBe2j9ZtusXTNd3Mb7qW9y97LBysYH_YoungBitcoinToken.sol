...
//SourceUnit: YoungBitcoinToken.sol
...
contract YoungBitcoinToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("Young Bitcoin Token", "YBTC", 6){
        require(gr != address(0), "invalid gr");
        _mint(gr, 19870821 * 100000 * 10 ** 6);
    }
}