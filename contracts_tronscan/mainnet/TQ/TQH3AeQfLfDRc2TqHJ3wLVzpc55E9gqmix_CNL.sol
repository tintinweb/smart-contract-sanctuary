...
contract CNL is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 19900000000 * 10**6;
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 199000000 * 10**uint256(_decimals);
