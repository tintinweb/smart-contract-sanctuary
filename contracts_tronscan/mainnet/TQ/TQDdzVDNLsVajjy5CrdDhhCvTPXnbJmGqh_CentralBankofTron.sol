...
contract CentralBankofTron {
    ...
    function _referralFee() private {
        ...
        if (referralLevelCount[msg.sender][3] != false) {
            referralBonus[referralLevel[msg.sender][1]] += msg.value.mul(3).div(100);
            referralBonus[referralLevel[msg.sender][2]] += msg.value.mul(5).div(
                100
            );
            referralBonus[referralLevel[msg.sender][3]] += msg.value.mul(10).div(
                100
            );
            ...
            if (referralLevelCount[msg.sender][2] != false) {
                referralBonus[referralLevel[msg.sender][1]] += msg.value.mul(5).div(100);
                ...
                referralBonus[referralLevel[msg.sender][1]] += msg.value.mul(10).div(100);
    ...
    function _reinvestment() public payable _withdrawDividend {
        ...
        /* @dev here 18% is deducted to different referral persons */
        if (referralLevelCount[msg.sender][3] != false) {
            referralBonus[referralLevel[msg.sender][1]] += _reinvestmentAmount.mul(3).div(
                100
            );
            ...
            if (referralLevelCount[msg.sender][2] != false) {
                referralBonus[referralLevel[msg.sender][1]] += _reinvestmentAmount.mul(5).div(
                    100
                );
                referralBonus[referralLevel[msg.sender][2]] += _reinvestmentAmount.mul(10).div(100);

                totalReferralBonus += _reinvestmentAmount.mul(15).div(100);
            } else {
                referralBonus[referralLevel[msg.sender][1]] += _reinvestmentAmount.mul(10).div(
                    100
                );

                totalReferralBonus += _reinvestmentAmount.mul(10).div(100);
            }
        }
    ...
    function claimROI() public payable {
        ...
        /* @dev here 18% is deducted to different referral persons */
        if (referralLevelCount[msg.sender][3] != false) {
            referralBonus[referralLevel[msg.sender][1]] += users[msg.sender]
                .compoundAsset
                .mul(3)
                .div(100);
            ...
            if (referralLevelCount[msg.sender][2] != false) {
                ...
                totalReferralBonus += users[msg.sender].compoundAsset.mul(15).div(100);
            } else {
                referralBonus[referralLevel[msg.sender][1]] += users[msg.sender]
                    .compoundAsset
                    .mul(10)
                ...
                totalReferralBonus += users[msg.sender].compoundAsset.mul(10).div(100);
            }
        }
