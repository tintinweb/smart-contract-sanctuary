//SourceUnit: TronReserve.sol

pragma solidity ^0.4.25;

// * Welcome To Tron Reserve!
// * Tron Reserve is a Self Governing Dividend Distribution Contract on Tron.
// * By depositing your Tron in the reserve, you become an entitled member of the contract. Member benefits include:
// * * 15% Daily Dividends on your deposit for LIFE.
// * * 20% Toal commission on referrals up to 8 levels.
// * Come be a part of a total REVOLUTION in earning!

contract TronReserve {       
