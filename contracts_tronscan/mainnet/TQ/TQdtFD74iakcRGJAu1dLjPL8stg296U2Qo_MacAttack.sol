...
contract MacAttack is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 100;

    constructor() public ERC721Full("MacAttack", "MacAtt") {
    _setBaseURI("https://thefanblock.com/wp-content/uploads/2021/11/MacAttack.json");
    }
