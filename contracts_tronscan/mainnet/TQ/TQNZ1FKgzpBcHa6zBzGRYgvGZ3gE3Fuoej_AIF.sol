 ...
 * `ERC20` functions.
 */
contract AIF is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Artificial intelligence farm", "AIF", 18) {
        _mint(msg.sender, 2100 * 10000 * 1000000000000000000 );
    }
}
...
contract ERC20 is IERC20 {
    ...
    function getTotalUnLockAmount() internal view returns (uint256) {
        ...
        _totalUnLock = dayDiff.mul(3835).mul(1000000000000000000);
        if(_totalUnLock >= (2100 * 10000 * 1000000000000000000)){
           return 2100 * 10000 * 1000000000000000000;
        }
