...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // which can be also obtained as `TRC721TokenReceiver(0).onERC721Received.selector`
    ...
    */
     ...
     * forwarded in {TRC721TokenReceiver-onERC721Received} to contract recipients.
     */
    ...
    /**
     * @dev Internal function to invoke {TRC721TokenReceiver-onERC721Received} on a target address.
...
contract ArtworkNFT is ERC721Pausable, AccessControl, Ownable {
    ...
    function mint(address to, string memory _tokenURI) public payable returns (uint256 tokenId) {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Only admin can do");
        tokenId = nextTokenId;
        _mint(to, tokenId);
        nextTokenId++;
