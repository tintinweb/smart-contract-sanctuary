...
contract MetaGrow is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 9800;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Meta Grow", "METAGROW", 6){
        	owner = msg.sender;	
