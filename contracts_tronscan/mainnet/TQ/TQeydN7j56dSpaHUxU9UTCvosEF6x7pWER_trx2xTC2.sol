//SourceUnit: trx2x.sol

 /*  Trx2x is the perfect solution to the new age of smart contracts with a combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *	-->REALISTIC ACHIEVABLE BONUS incentives!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://trx2x.com         								 │
 * 	 │																		 │
 *   │   Trx2x - The Perfect Solution For Smart Contracts						 │
 *	 │                                                                       │
 *	 │	 Upto and over 2% Daily ROI					   						       	 │
 *	 │                                                                       │
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 11-level referral commission: 5% - 3% - 1.5% - 1% - 0.5% - 0.5% - 0.5% - 0.4% - 0.3% - 0.2% - 0.1% 
 *   
 */
...
contract trx2xTC2 {
    ...
    uint constant public INVEST_MAX_AMOUNT = 500000 trx;
    uint constant public BASE_PERCENT = 100;
    uint[] public REFERRAL_PERCENTS = [500, 300, 150, 100, 50, 50, 50, 40, 30, 20, 10];
    ...
    uint constant public COMMUNITY_BONUS_STEP = 200000;
