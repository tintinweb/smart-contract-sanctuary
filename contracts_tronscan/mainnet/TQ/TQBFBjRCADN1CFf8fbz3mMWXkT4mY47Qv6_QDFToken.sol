...
contract QDFToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("Queen Defi Token", "QDF", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 1000000000 * 10 ** 18);
    }
}
