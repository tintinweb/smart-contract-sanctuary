...
contract TronWorld {
    ...
    function withdraw() payable external {
		...
		// limit to 1 withdraw every 30 minutes
		require(player.last_withdraw < now - 1800);
