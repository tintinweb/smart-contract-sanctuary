...
contract ERC20 is IERC20 {
     ...
     */
    function _burn(address sender, address recipient, uint256 value) internal {
        require(sender != address(0), "ERC20: burn from the zero address");
        require(recipient != address(0), "ERC20: burn to the zero address");
 ...
 * `ERC20` functions.
 */
contract LUKET is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("LUKET", "LUKET", 6) {
