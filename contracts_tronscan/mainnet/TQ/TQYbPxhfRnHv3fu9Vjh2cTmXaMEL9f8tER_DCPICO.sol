...
/**
 * @title DCPICO
 * @dev DCPICO contract is Ownable
 **/
contract DCPICO is Ownable {
    using SafeMath for uint256;
    Token token;

    uint256 public constant RATE = 100; // Number of tokens per TRX
    uint256 public constant CAP = 1000000; // Cap in TRX
    uint256 public constant START = 1621422026012; // Apr 19, 2021 @ 12:00 EST
    uint256 public constant DAYS = 90; // 90 Day

    uint256 public constant initialTokens = 10000000 * 10**6; // Initial number of tokens available
    ...
    /**
     * DCPICO
     * @dev DCPICO constructor
     **/
    function DCPICO(address _tokenAddr) public {
