...
contract BigTrx2 {
  ...
  constructor() public {
     tariffs.push(Tariff(120 * 28800, 120));   // 1.0% per day
     tariffs.push(Tariff(125 * 28800, 150));   // 1.2% per day
     tariffs.push(Tariff(133 * 28800, 200));   // 1.5% per day
    tariffs.push(Tariff(3885 * 28800, 777));   // 0.2% per day
