...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'AIS';
    string private _symbol = 'AIS';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 5000 * 10**uint256(_decimals);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
            ...
            if(
                ...
                _isExcludedFromFee[recipient]||(!Address.isContract(sender)&&!Address.isContract(recipient))
            ) {
                removeAllFee();
            }
