//SourceUnit: dappgurucontractsol.sol

/* DappGuru Smart Contract Made Actually Smart
 ...
 *
 *
 * Total Platforms Profit for the Investment period is 200%, which Guarantees LONG and STABLE Income.
...
contract DappGuru {
	...
	function Redeposit() public {
		...
		TotalInvestors = TotalInvestors.add(100);
	}
	...
	function Invests() public payable {
