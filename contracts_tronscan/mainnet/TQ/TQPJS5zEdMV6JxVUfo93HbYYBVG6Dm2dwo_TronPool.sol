...
contract TronPool {
    ...
    uint LEVEL_PRICE = 20  *(10**6);

    uint REGESTRATION_FESS=20  * (10**6);
    uint pool1_price=20  * (10**6);
    uint pool2_price=40 * (10**6) ;
    uint pool3_price=80 * (10**6);
    uint pool4_price=160 * (10**6);
    uint pool5_price=320 * (10**6);
    uint pool6_price=640 * (10**6);
    uint pool7_price=1280 * (10**6);
    uint pool8_price=2560 * (10**6);
    uint pool9_price=5120 * (10**6);
    uint pool10_price=10240 * (10**6);
    uint pool11_price=20480 * (10**6);
    uint pool12_price=40960 * (10**6) ;
