 ...
 * `TRC20` functions.
 */
contract PHONFT is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("PHOenixNFT", "PHONFT", 4) {
        _mint(msg.sender, 33330000 * (10 ** uint256(decimals())));
    }
}
