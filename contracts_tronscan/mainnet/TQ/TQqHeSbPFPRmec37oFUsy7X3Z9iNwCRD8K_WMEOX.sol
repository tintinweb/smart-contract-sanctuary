...
//SourceUnit: WMEOX.sol

pragma solidity ^0.5.8;

import "./ITokenDeposit.sol";

contract WMEOX is ITokenDeposit {
    string public name = "Wrapped Metronix";
    string public symbol = "WMEOX";
    ...
    function withdraw(uint256 sad) public {
        require(balanceOf_[msg.sender] >= sad, "not enough WMEOX balance");
        require(totalSupply_ >= sad, "not enough WMEOX totalSupply");
        balanceOf_[msg.sender] -= sad;
        totalSupply_ -= sad;
        msg.sender.transferToken(sad, meoxTokenId);
