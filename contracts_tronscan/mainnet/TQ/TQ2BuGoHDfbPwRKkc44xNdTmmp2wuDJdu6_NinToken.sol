...
contract NinToken is StandardToken {

    string public name = "Next Innovation Coin";
    string public symbol = "NIN";
    uint8 public decimals = 8;
    uint256 public INITIAL_SUPPLY = 500000000*10**8;
    ...
    function burn(address _target, uint256 _value) external onlyOwner returns (bool) {
        require(_target != address(0));
        require(_value > 0);
