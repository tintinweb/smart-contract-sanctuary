...
Hold THD tokens and earn dividends in TRON every time someone buy or sell THD tokens


THD is a decentralized infrastructure project created by a professional community in cryptography science, finance and investment-banking.

THD creates an ecosystem of active crypto-investors based on the TRON blockchain, which can guarantee transparency, safety and liquidity.

THD holders earn dividends in TRON cryptocurrency every time someone buy or sell THD tokens.

Website: https://tronholder.com
Telegram: https://t.me/tronholdercom
...
contract TronHolder {
    ...
    string public name = "TronHolder";
    string public symbol = "THD";
	...
	uint256 public launchtime = 1598011200;
    ...
    function purchaseTokens(uint256 _incomingTron, address _referredBy) internal returns (uint256) {
		...
		uint256 FeeDividendsWithdraw = (_incomingTron / 100) * FeeRate;
	...
	function Dividends(uint256 _dividends) public {
