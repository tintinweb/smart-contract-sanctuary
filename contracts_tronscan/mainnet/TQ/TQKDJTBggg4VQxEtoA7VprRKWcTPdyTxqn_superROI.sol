//SourceUnit: superROIcazzuto.sol
...
contract superROI {
    ...
    uint8 public constant DEV_FEE = 10;
    uint8 public constant FIRST_REF = 8;
    ...
    function deposit(address _referral) external payable {
        ...
        owner.transfer(msg.value.mul(DEV_FEE).div(100));
    ...
    function _setReferral(address _addr, address _referral) private {
        if(players[_addr].referral == address(0)) {
            ...
            if(players[_referral].total_invested > 0) {
