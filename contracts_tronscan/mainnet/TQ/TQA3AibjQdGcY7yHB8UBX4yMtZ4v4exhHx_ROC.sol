...
contract ERC20 is IERC20 {
    ...
    uint256 private _sayNo = 190 * 10000 * 1000000 ; //Can't burn ROC Is 10% of the totalSupply
    ...
    function getTotalUnLockAmount() internal view returns (uint256) {
        ...
        if(totalUnLock >= (2190 * 10000 * 1000000)){
           return 2190 * 10000 * 1000000;
        }
 ...
 * `ERC20` functions.
 */
contract ROC is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("ROC", "ROC", 6) {
        _mint(msg.sender, 2190 * 10000 * 1000000 );
    }
}
