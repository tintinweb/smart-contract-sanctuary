...
contract Intercoin is SmartToken{string private _name;string private _symbol;uint8 private _decimals;constructor()public{_name="Intercoin";_symbol="INTC";_decimals=6;mint(msg.sender,888888888888e6);}
