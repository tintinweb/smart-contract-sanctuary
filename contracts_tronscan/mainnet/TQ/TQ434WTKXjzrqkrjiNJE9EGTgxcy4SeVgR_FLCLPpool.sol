...
contract FLCLPpool is LPTokenWrapper {
    ...
    constructor(
        ...
        stoptime = block.timestamp + 67500000;
    ...
    function exit(uint value) public updateReward(msg.sender) {
        uint256 amount = balanceOf(msg.sender);
        require(amount >= value, "large value");

        super.withdraw(value, 0);
