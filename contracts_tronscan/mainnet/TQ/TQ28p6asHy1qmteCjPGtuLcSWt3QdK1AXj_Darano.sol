...
// Darano TRC20 Token
//
// Main wallet : TZ972Y7PiJ1sdUwkL5QMKuc6kJjE7XK63U
// Symbol         : DRA
// Name           : Darano
// Total supply   : 100 000 000
// Decimals       : 18
//
// (c) by Darano Limited. 2019
// ----------------------------------------------------------------------------
...
contract ERC20Interface {
    ...
    // ------------------------------------------------------------------------
contract Darano is ERC20Interface{
    string public name = "Darano";
    ...
    event Approval(address indexed tokenOwner, address indexed spender, uint tokens);
    // ------------------------------------------------------------------------
    // Constructor With 100 000 000 supply, All deployed tokens sent to Main wallet
    // ------------------------------------------------------------------------
    constructor() public{
