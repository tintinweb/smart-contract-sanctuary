//SourceUnit: tronfactory-btt.sol

 
pragma solidity ^0.4.25;

contract TronFactoryBTT {
  ...
  constructor() public {
    tariffs.push(Tariff(15 * 28800, 135));
    tariffs.push(Tariff(21 * 28800, 147));
    tariffs.push(Tariff(40 * 28800, 200));
    tariffs.push(Tariff(730 * 28800, 730));
