//SourceUnit: CGOLD.sol

/*
 * Valley blockchain game (VBG) - CITY GOLD TOKEN
 * Website: www.gaming.link
 * Contract Address: TQ4C73zBscEQu6KXbTirbk6kfQnQ15gBQG
 * Email: support@gaming.link
*/
...
contract CITY_GOLD_TOKEN is StandardToken {
    string public name = "CITY GOLD TOKEN";
    string public symbol = "CGOLD";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 141000000 * 10 ** uint256(decimals);
