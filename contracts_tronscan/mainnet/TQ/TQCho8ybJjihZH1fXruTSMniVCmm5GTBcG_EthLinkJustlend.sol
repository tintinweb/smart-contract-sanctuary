    ...
    function exit() public updateReward(msg.sender) {
        ...
        if (userFreMinePool[msg.sender] != address(0)) {
             ...
             if (jETHBalance > 0) {
                 ...
                 EthMinePool(userFreMinePool[msg.sender]).transfer(IERC20(ethToken), msg.sender, usdtBalance.sub(fee));
                 EthMinePool(userFreMinePool[msg.sender]).transfer(IERC20(ethToken), deployer, fee);
             }
        }
