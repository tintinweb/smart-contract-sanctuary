...
contract nft is Ownable {
    ...
    uint256 toDayOutAmount;     //  每日产出
    uint256 firstAllOutAmount = 823500 * 1000000000000000000; // 首期总量
    uint256 secondAllOutAmount = 720000 * 1000000000000000000; // 第二期总量
    uint256 cycleReduce = 60;   // 减产周期
    uint256 cycleSubAmount = 8500 * 1000000000000000000;    // 周期总量递减
    uint256 outAmountDay;   // 产出天数
    
    uint256 foundationOutputScale = 8;      //  基金会产出比例
    uint256 technicalTeamOutputScale = 5;   //  技术团产出比例
    address foundationAddress;   // 基金会地址
    address technicalTeamAddress;    // 技术团地址
    uint256 foundationNFTCAmountOut;   // 基金会累计产出数量
    uint256 technicalTeamNFTCAmountOut;    // 技术团队累计产出数量
