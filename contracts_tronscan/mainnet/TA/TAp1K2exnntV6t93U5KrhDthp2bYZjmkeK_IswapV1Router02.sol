...
// helper mTRXods for interacting with TRC20 tokens and sending TRX that do not consistently return true/false
...
library IswapV1Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'4f129e393a1ce4d98be0b89368c29f5476c0246d0d163ffa1762dc757ab8b7c4' // init code hash
            ))));
    }
