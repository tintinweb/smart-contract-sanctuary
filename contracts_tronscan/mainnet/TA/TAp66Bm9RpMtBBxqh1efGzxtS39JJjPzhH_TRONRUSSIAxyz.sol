...
contract TRONRUSSIAxyz {
	...
	uint256 constant public BASE_PERCENT = 600;  // 60% BASIC INTEREST PLUS 1% DAILY
	uint256 constant public MARKETING_FEE = 200; // 20%
