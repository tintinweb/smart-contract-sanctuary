...
contract ChivasToken is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 8888;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Chivas Token", "CHIVAS", 18){
        	owner = msg.sender;	
