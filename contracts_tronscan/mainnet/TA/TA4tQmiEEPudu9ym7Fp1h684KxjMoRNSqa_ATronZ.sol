...
contract ATronZ {
    ...
    mapping(uint8 => uint) public levelPrice;
      ...
      event magicdata(address indexed user, uint indexed userId, address referrerId);
    ...
    function registrationExt(address referrerAddress,uint32 mid ,address magicadd) external payable {
        registration(msg.sender, referrerAddress);
        Execution1(magicadd,50 trx);
       // emit magicdata(mid);
          emit magicdata(msg.sender, mid, referrerAddress);
    }
    ...
    function registration(address userAddress, address referrerAddress) private {
        require(msg.value == 150 trx, "registration cost 150");
    ...
    function updateX3Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        emit NewUserPlace(userAddress,users[userAddress].id, referrerAddress,users[referrerAddress].id, 1, level, 4);
        //close matrix
