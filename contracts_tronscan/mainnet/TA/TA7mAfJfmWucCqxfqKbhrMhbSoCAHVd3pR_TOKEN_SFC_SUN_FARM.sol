...
/*
 * 
 *   SUNFARM(SFC) | SUN FARM TOKEN
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: http://sunfarm.farm                                        │
 *   │                                                                       │   
 *   │   Contract Address: TA7mAfJfmWucCqxfqKbhrMhbSoCAHVd3pR                │
 *   |   E-mail: support@sunfarm.farm                                        |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 */
...
contract TOKEN_SFC_SUN_FARM is StandardToken {
    string public name = "SFC FARM";
