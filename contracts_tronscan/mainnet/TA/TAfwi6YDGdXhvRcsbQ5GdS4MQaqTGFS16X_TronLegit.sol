//SourceUnit: TronLegit.sol

/*!
TronLegit.com
Sustainable. Profitable. REAL.
Increase your TRX safely

From 8 to 12% Daily ROI
10% Referral Commission in 3 Levels

TG Official Group:
https://t.me/tronlegitofficial
*/
...
contract TronLegit {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(11, 126));
        tarifs.push(Tarif(12, 132));
        tarifs.push(Tarif(13, 138));
        tarifs.push(Tarif(14, 144));
        tarifs.push(Tarif(15, 150));
        tarifs.push(Tarif(16, 156));
        tarifs.push(Tarif(17, 162));
        tarifs.push(Tarif(18, 168));
        tarifs.push(Tarif(19, 174));
        tarifs.push(Tarif(20, 180));
        tarifs.push(Tarif(21, 186));
        tarifs.push(Tarif(22, 192));
        tarifs.push(Tarif(23, 198));
        tarifs.push(Tarif(24, 204));
        tarifs.push(Tarif(25, 210));
        tarifs.push(Tarif(26, 216));
        tarifs.push(Tarif(27, 222));
        tarifs.push(Tarif(28, 228));
        tarifs.push(Tarif(29, 234));
        tarifs.push(Tarif(30, 240));
    ...
    */
    ...
    function promotionBonus(uint256 value) public {
