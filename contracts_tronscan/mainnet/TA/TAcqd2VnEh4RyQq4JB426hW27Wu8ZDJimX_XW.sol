...
contract XW is Context, IERC20, Ownable {
    ...
    string private _name = 'XW';
    string private _symbol = 'XW';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x413DF20E87505C463DA8E3AAD07D5ABDF300C81211);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 288 * 10**uint256(_decimals);
