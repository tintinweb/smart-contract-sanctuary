...
contract SuperToken is Ownable, TRC20 {
    ...
    string public constant symbol = "TSUP";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 21 * 10**7 * 10**DECIMALS;
