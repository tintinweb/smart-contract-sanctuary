...
contract EtixToken is ERC20, ERC20Detailed ,Ownable {

    uint256 public lastBlock;
    mapping(address => bool) public admins;

    constructor() public ERC20Detailed("Etix Coin","Etix",6) {
    ...
    function transferWithMemo(uint256 _amount, address _to, string memory _memo)  public returns(uint256) {
