//SourceUnit: Tronbit.sol

/*
 * 
 *   Tronbit - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://tronbit.net                                       │
 *   │                                                                       │  
 *   │                  													 |
 *   │   Telegram Public Group: https://t.me/Tronbitgroup                 	 |
 *   │   Telegram News Channel: https://t.me/Tronbitnews                  	 |
 *   |                                                                       |
 *   |                           											 |
 *   |    																	 |
 *   |   E-mail: info@tronbit.net                                          |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 * 
 *   - Basic interest rate: +2% every 24 hours (+0.0416% hourly)
 *   - Personal hold-bonus: +0.1% for every 24 hours without withdraw 
 *   - Contract total amount bonus: +0.1% for every 1,500,00 TRX on platform address balance 
 * 
 ...
 *
 *   - Officially registered company name: tronbit LTD (#12739027)
 *   - Company status: https://beta.companieshouse.gov.uk/company/12935114
 *   - Certificate of incorporation: https://tronbit.net/img/certificate.pdf
 *
...
contract Tronbit {
	...
	uint256 constant public CONTRACT_BALANCE_STEP = 1500000 trx;
	...
	function getUserDownlineCount(address userAddress) public view returns(uint256, uint256, uint256, uint256) {
		return (users[userAddress].level1, users[userAddress].level2, users[userAddress].level3,users[userAddress].bonus);
	}
