...
contract sWoxToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked WOX", "sWOX", 9) ERC20Permit() {
    ...
    /**
        @notice increases sWOX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sWOX
