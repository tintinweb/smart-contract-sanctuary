...
contract Token is ERC20, Ownable {
  ...
  bool feeForWhiteList = true;

  // can burn
  bool canBurn;

  constructor() ERC20("Feixiang coin", "TFC", 18) {
    uint256 initSupply = 1288 * 10**uint256(decimals());
  ...
  function _transfer(
    ...
    if (feeStatus && feeRate > 0 && feeTo != address(0)) {
      // after start time, got fee
