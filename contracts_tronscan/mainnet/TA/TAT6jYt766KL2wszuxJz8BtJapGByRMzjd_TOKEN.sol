//SourceUnit: token (2).sol

/**
 *Submitted for verification at hecoinfo.com on 2021-06-05
*/
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10000 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'FHB Token';
    string private _symbol = 'FHB';
    uint8 private _decimals =12;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x4117bbad47b8845751d7d2b9683398bcbc30eb69c9);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 27 * 10**uint256(_decimals);
