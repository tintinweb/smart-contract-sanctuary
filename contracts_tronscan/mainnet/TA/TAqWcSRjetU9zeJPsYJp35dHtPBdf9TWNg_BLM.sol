...
contract BLM is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 1300 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'BLM Token';
    string private _symbol = 'BLM';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41CFD79E1F06779A13CF6FD2CEA2D195CF0F6B68FC);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 99 * 10**uint256(_decimals);
