//SourceUnit: UTEXEXCHANGETOKEN.sol
...
contract UtexExchangeToken is Token {
...
contract UTEX is UtexExchangeToken {

  constructor() UtexExchangeToken ("UtexExchangeToken ", " UTEX ", 8, 10000000) public {}
