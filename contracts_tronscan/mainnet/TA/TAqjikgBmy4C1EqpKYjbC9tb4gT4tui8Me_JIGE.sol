...
contract JIGE is Context, ITRC20, Ownable {
    ...
    string private _name = 'JIGE';
    string private _symbol = 'JIGE';
    ...
    function setExchangejige(address exchangePool) public onlyOwner {
