...
contract KACOToken is Context, IERC20, Ownable {
    ...
    string private _name = 'KACO';
    string private _symbol = 'KACO';
    ...
    constructor (address _burnAddress, address _fundAddress, address _lpAddress) public {
