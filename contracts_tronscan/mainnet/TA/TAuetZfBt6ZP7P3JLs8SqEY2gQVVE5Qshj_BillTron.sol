...
contract BillTron {
    ...
    uint private releaseTime = 1608004800;
    ...
    struct Player {
        ...
        uint256 aff1sum;       //2 Level Referral Commission
        uint256 aff2sum;
    }
    Plans [2] planes;
    ...
    constructor() public {
      owner = msg.sender;
      planes[0]=Plans("Plan 1",50,0);
      planes[1]=Plans("Plan 2",60,2);
    }
    ...
    function deposit(address payable _affAddr, uint posplan) public payable  returns(bool){
        ...
        require(players[msg.sender].cant != veces,"out of cant");
    ...
    function distributeRef(uint256 _trx, address payable _affFrom) private{
        ...
        if (_affAddr1 != address(0)) {
            _affRewards = getPercent(_trx,15);
