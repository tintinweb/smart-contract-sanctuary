//SourceUnit: perfectpool.sol

pragma solidity 0.5.9;

contract PerfectPool {
    ...
    uint pool5_price=500 * (10**6);
    uint pool6_price=600 * (10**6);
    uint pool7_price=700 * (10**6);
    uint pool8_price=800 * (10**6);
    uint pool9_price=900 * (10**6);
    uint pool10_price=1000 * (10**6);
    uint pool11_price=1100 * (10**6) ;
    uint pool12_price=1200  * (10**6);
