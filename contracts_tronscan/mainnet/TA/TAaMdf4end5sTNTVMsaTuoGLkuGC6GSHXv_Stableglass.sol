...
contract Stableglass {
    ...
    address internal floodmakerAddress;
    ...
    constructor(address _floodmakerAddress) public {
        floodmakerAddress = _floodmakerAddress;
        
        maker = Floodmaker(floodmakerAddress);
    }
    ...
    function sell(uint256 _amountOfTokens) onlyTokenHolders public {
        ...
        maker.depositTRX.value(_totalFloodmakerContribution);
    ...
    function purchaseTokens(address _customerAddress, uint256 _incomingTron) internal returns (uint256) {
        ...
        maker.depositTRX.value(_floodmakerFee);
