...
contract SyntheticTRX is SyntheticToken {
    using SafeTRC20 for ITRC20;
    
    uint256 internal constant _decimals = 6;

    constructor() SyntheticToken(_decimals) public {}
...
contract SyntheticToken is ITRC20, Rescuable {
    using SafeMath for uint256;
