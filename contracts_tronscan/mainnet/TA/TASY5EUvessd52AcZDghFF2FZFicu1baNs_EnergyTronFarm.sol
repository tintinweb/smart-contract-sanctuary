...
contract EnergyTronFarm is Ownable {
    using SafeMath for uint256;

    uint256 public constant DEVELOPER_RATE = 100; //per thousand
    ...
    uint256 public constant ACTIVATION_TIME = 0;

    uint256 public constant MINIMUM = 200000000; //minimum investment needed
    ...
    constructor() public {
        ...
        marketingAccount_ = address(0x41CCC74BC7DF6D97097C43071C875A15ABC81FF111);  
        adminAccount_ = address(0x4165FA002967896BAB0BF8C374D2A8E824F51DA8E5);
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(50, 40*60*60*24)); //40 days
        investmentPlans_.push(Objects.Plan(60, 40*60*60*24)); //40 days
        investmentPlans_.push(Objects.Plan(64, 40*60*60*24)); //40 days
        investmentPlans_.push(Objects.Plan(70, 40*60*60*24)); //40 days
