...
contract Tk {
     ...
     */
    uint256 initialSupply = 999888;
    string tokenName = 'TANKE';
    string tokenSymbol = 'Tk';
    constructor() public {
        ownerAddr = address(0x41F0C1943385F9E86BFDA96AB3030CDA5134137943);
        totalSupply = initialSupply * 10 ** uint256(decimals);  // Update total supply with the decimal amount
    balanceOf[ownerAddr] = totalSupply;              // Give the creator all initial tokens
