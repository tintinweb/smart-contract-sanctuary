...
contract TronSter {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(7, 160));
        tarifs.push(Tarif(8, 166));
        tarifs.push(Tarif(9, 172));
        tarifs.push(Tarif(10, 178));
        tarifs.push(Tarif(11, 184));
        tarifs.push(Tarif(12, 190));
        tarifs.push(Tarif(13, 196));
        tarifs.push(Tarif(14, 202));
        tarifs.push(Tarif(15, 208));
        tarifs.push(Tarif(16, 214));
        tarifs.push(Tarif(17, 220));
        tarifs.push(Tarif(18, 226));
        tarifs.push(Tarif(19, 232));
        tarifs.push(Tarif(20, 238));
        tarifs.push(Tarif(21, 244));
        tarifs.push(Tarif(22, 250));
        tarifs.push(Tarif(23, 256));
        tarifs.push(Tarif(24, 262));
        tarifs.push(Tarif(25, 268));
        tarifs.push(Tarif(26, 274));
        tarifs.push(Tarif(27, 280));
        tarifs.push(Tarif(28, 286));
        tarifs.push(Tarif(29, 292));
        tarifs.push(Tarif(30, 298));
