//SourceUnit: justglobal-final.sol
...
contract justglobal {
    ...
    address payable public jst_address;
    ...
    uint40 public pool_last_draw = 1609646400;
    uint256 public pool_cycle;
    uint256 public pool_balance;
    
    uint8[] public cd_pool_bonus;
    uint40 public cd_pool_last_draw = 1609646400;
    ...
    event ReceiveSomething(address indexed addr);
    
    constructor() public {
        owner = msg.sender;
        
        admin_fee = 0x673d4c36eE24168e7fdaa006c5F1B38b821496FE;
        
        jst_address = 0x18FD0626DAF3Af02389AEf3ED87dB9C33F638ffa;
        
        level_1_addr = 0xCB03A8E9Cc4D09E4d92Ff16A2Eb741A57BDa5C40;
        ...
        cycles.push(200000000000000000000000);
        cycles.push(600000000000000000000000);
        cycles.push(1800000000000000000000000);
        cycles.push(5400000000000000000000000);
        cycles.push(15000000000000000000000000);
    }
    ...
    */
    ...
    function depositToken(address _upline) external
    {
        ...
        uint256 min_deposit  = 300000000000000000000;
        ...
        if(cd_pool_last_draw + 1 days  < block.timestamp)
        {
            _drawCDPool();
        }
        ...
        uint chain_fun_amount = (_amount * 5/100);
