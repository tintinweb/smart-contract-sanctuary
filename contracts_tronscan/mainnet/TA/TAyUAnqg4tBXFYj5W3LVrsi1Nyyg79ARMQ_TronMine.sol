...
contract TronMine {
    ...
    uint private minuteRate = 810187; //DAILY 7%
    ...
    function register(address _addr, address _affAddr) private{
      ...
      players[_affAddr5].aff4sum = players[_affAddr5].aff5sum.add(1);
      players[_affAddr6].aff4sum = players[_affAddr6].aff6sum.add(1);
    }
