...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 21000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'XRK Token';
    string private _symbol = 'XRK';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x418E738A4E8EF2B81567C4E7167A34154F8C84ACC4);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 9999 * 10**uint256(_decimals);
