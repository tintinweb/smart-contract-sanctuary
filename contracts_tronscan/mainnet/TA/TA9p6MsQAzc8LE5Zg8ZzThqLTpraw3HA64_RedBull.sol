...
contract RedBull {
  ...
  constructor() public {
    owner = address(0x4C7eC19C43d90ED1AB0Fce49EECb1a00f05654Bc);
    industrious = address(0x29DEaA844E3BE8Cf52DE150BE7Fd53A74DE7f9de);
  ...
  function massUpdateIncomes() external {
    require(industrious == msg.sender, "Insufficient permissions");
