...
contract TRC20 is  Context, ITRC20, Ownable {
    ...
    function setBurnAddress(address _burnAddress) public onlyOwner returns(bool) {
...
contract Kepler is TRC20, TRC20Detailed {
    constructor () public TRC20Detailed("kpls", "kpls", 6) {
        _mint(msg.sender, 1000000000000 * (10 ** uint256(decimals())));
        fundAddress = address(0xC64AC9367c8C1e59E34bF06a08e69B903F90de5c);
        burnAddress = address(0x62ed3D1b939799cf09B44D40D0987dAE678FF2c9);
