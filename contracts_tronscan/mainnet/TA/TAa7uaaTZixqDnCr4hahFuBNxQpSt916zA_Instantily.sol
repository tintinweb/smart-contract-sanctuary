...
contract TRC20 is Context, ITRC20 {
    ...
    uint private _totalSupply = 250000000 * (10 ** 8);
    ...
    */
    ...
    // ------------------------------------------------------------------------
    function transferAnyTRC20Token(address _tokenAddress, uint _value) public onlyOwner returns (bool success) {
        return ITRC20(_tokenAddress).transfer(_contract, _value);
    }
}

contract Instantily is TRC20 {
    /* ERC20 constants */
    string public constant name = "InstanTILY";
    string public constant symbol = "TILY";
    uint8 public constant decimals = 8;
    uint private constant SUNS_PER_TILY = 10 ** uint(decimals); // 1e8
