...
contract BET is ERC20, ERC20Detailed {
    ...
    constructor() public ERC20Detailed("BET Coin", "BET", 8) {
        _owner = msg.sender;
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "BET: Caller is not the owner");
        _;
    }
    ...
    function issue() public onlyOwner returns (bool) {
        require(_node != address(0), "BET: node is the zero address");
        require(_productor != address(0), "BET: productor is the zero address");
        require(_suanli != address(0), "BET: suanli is the zero address");
        require(block.timestamp.sub(_lastTime) >= 86400, "BET: It's not time yet");
    ...
    function bindNode(address addressNode) public onlyOwner returns (bool) {
        require(addressNode != address(0), "BET: New node is the zero address");
        _node = addressNode;
    ...
    function bindSuanli(address addressSuanli) public onlyOwner returns (bool) {
        require(addressSuanli != address(0), "BET: New suanli is the zero address");
    ...
    function bindProductor(address addressProductor) public onlyOwner returns (bool) {
        require(addressProductor != address(0), "BET: New productor is the zero address");
    ...
    function transferOwnership(address newOwner) public onlyOwner returns (bool) {
        require(newOwner != address(0), "BET: New owner is the zero address");
        _newOwner = newOwner;
    ...
    function acceptOwnership() public returns (bool) {
        require(msg.sender == _newOwner, "BET: Caller is not the new owner");
        _owner = _newOwner;
        _newOwner = address(0);
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(amount >= minimum, "BET: burn amount should be greater than or equal to 100000000");
        require(amount.mod(minimum) == 0, "BET: burn amount must be a multiple of 100000000");
