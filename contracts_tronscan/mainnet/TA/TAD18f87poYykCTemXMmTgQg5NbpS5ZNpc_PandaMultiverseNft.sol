//SourceUnit: PandaMultiverseNft.sol
...
contract PandaMultiverseNft is ERC20, ERC20Detailed{
    ...
    constructor(address _address) public ERC20Detailed("Panda Multiverse Nft", "PMVNFT", 3){
        	owner = msg.sender;	
