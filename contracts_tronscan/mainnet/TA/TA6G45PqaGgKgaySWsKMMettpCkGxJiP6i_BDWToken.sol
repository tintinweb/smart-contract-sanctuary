...
contract BDWToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Broadway Token';
    string private _symbol = 'BDW';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x418b3ab4caa65f765fc4f49e0a01188fe3092da7e0);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 17888 * 10**uint256(_decimals);
