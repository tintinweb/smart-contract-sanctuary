//SourceUnit: DogeZilla.sol

// SPDX-License-Identifier: DogeZilla
...
contract hooh is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000000000000000000 * 10**6;
    ...
    uint256 public MAX_STOP_FEE_TOTAL = 69000000000000000 * 10**uint256(_decimals);
