...
/*  CONTRACT OFFICIAL LAUNCHES DECEMBER 21, 2020
 *	X3Tron - 300% Total ROI | 10% Referral Commission in 4 Levels | Verified Contract | 50TRX Minimum
 *
 */
...
contract X3Tron{
  ...
  constructor() public {
    ...
    tariffs.push(Tariff(30 * 28800, 310));
    tariffs.push(Tariff(40 * 28800, 320));
    tariffs.push(Tariff(50 * 28800, 340));
