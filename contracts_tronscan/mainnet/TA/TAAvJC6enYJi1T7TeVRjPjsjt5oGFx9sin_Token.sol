...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 13141 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Bole';
    string private _symbol = 'Bole';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41b37cd3a3aeec63b2337ca974deca78acdf613756);
