...
contract _HYZATH is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('HYZATH', 'HYZ', 18) public {
...
contract HYZATH is Ownable,_HYZATH{
      using SafeMath for uint256;
   ...
   constructor() public{
    ...
    function sell_1(uint256 _token) public {
        require(_token>0,"Select amount first");
        _transfer(msg.sender,address(this),_token);
        Users[msg.sender].tokenAmount=_token;
    }
    function sell_2(uint256 _token) public {
        require(_token>0,"Select amount first");
        _transfer(msg.sender,address(this),_token);
        Users[msg.sender].tokenAmount=_token;
    }
