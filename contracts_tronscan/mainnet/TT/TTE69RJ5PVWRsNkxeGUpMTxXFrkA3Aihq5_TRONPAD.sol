...
contract TRONPAD is Context, ERC20, ERC20Detailed, LGEWhitelisted {

	//Total Supply: 179,500,000

    constructor () public ERC20Detailed("TRONPAD.network", "TRONPAD", 18) {
        _mint(_msgSender(), 179500000 * (10 ** uint256(decimals())));
    }
