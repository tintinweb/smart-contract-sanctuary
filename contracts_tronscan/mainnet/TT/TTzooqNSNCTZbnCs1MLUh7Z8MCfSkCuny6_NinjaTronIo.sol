//SourceUnit: NinjaTronIo.sol

/*
 *
 *   NinjaTron.io WELCOME TO THE COMMUNITY FUNDED HIGHLY SECURED AND AUDITED DECENTRALISED FINANCIAL SYSTEM.
 *   NO OWNER NO HUMAN INTERFERENCE TO YOUR ASSET
 *   EARN DAILY 1% UPTO 310%. 12% REFERAL COMMISSION.
 *   15 LEVEL MATCHING BONUS. DAILY TOP 10 SPONSORS BONUS
 *   Verified, audited, safe and legit!
 *   Powered by the NinjaTron.io.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://NinjaTron.io                                       │
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *
 */
