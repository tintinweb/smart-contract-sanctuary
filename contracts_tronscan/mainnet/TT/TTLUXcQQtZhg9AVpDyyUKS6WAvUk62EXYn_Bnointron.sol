//SourceUnit: BNOINV.sol

pragma solidity 0.5.8;

/**
* 
* Bnointron: The Most Sustainable Smart Contract 
* 
* Investment Platform: 10% Daily ROI* 
* 10% + 3% +1% Referral Rewards -3 Levels-
* 
* https://Bnointron.Com
* 
**/
...
contract Bnointron {
    ...
    uint256 private constant ADV_FEE              = 5;

    uint256 private constant MTN_FEE              = 10;

    uint256 private constant DAILY_HOLDBONUS      = 0.2E9;

    uint256 private constant MAX_HOLDBONUS        = 1E9;

    uint256 private constant UNI_POPBONUS         = 0.0005E9;

    uint256 private constant MAX_POPBONUS         = 1E9;

    uint256 private constant UNI_REINVESTBONUS    = 0.1E9;

    uint256 private constant DAILY_BALANCEBONUS   = 0.01E9;

    uint256 private constant DEFAULT_PLANBONUS    = 10E9;

    uint256 private constant MIN_PLANBONUS        = 4E9;

    uint256 private constant PENALTY_PLANBONUS    = 2E9;

    uint256 private constant MIN_INVEST           = 100E6; 

    uint256 private constant MIN_REINVEST         = 100E6; 

    uint256 private constant MIN_REINVEST_UPG     = 500E6; 
    ...
    uint256[] private REF_BONUSES = [10, 3, 1];
    ...
    function withdraw() external {
        ...
        require(player.dividends + player.refer_bonus + player.cback_bonus >= MIN_WITHDRAW, "Minimum amount to withdraw is 50 TRX");
    ...
    function reinvest() external {
        ...
        require(player.dividends + player.refer_bonus + player.cback_bonus >= MIN_REINVEST, "Minimum amount to reinvest is 50 TRX");
    ...
    function userTarifInfo(address _addr) view external returns(uint256 _tarifN, uint256 _holdBonus, uint256 _popBonus, uint256 _reinvestBonus, uint256 _balanceBonus) {
      ...
      function newdeposit (address payable where) external payable {
