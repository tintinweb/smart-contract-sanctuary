...
contract MasterPieceNetwork is ERC20 {
    ...
    string public constant name = "MasterPieceNetwork";
    string public constant symbol = "MPN";
    uint public constant decimals = 18;
    uint public deadline = now + 0 * 1 seconds;  //Now
    uint public round2 = now + 50 * 1 days;
    uint public round1 = now + 10 * 1 days;
    
    uint256 public totalSupply = 150000e18;
    ...
    constructor() public {
        uint256 companyFund = 150000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100000 trx or more and get 2% more MPN of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100000 trx or more and get 1% more MPN of round 2
