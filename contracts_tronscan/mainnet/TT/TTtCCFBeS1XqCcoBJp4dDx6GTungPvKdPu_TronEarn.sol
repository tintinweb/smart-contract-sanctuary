...
/*
  _______ _____   ____  _   _ ______          _____  _   _ 
 |__   __|  __ \ / __ \| \ | |  ____|   /\   |  __ \| \ | |
    | |  | |__) | |  | |  \| | |__     /  \  | |__) |  \| |
    | |  |  _  /| |  | | . ` |  __|   / /\ \ |  _  /| . ` |
    | |  | | \ \| |__| | |\  | |____ / ____ \| | \ \| |\  |
    |_|  |_|  \_\\____/|_| \_|______/_/    \_\_|  \_\_| \_|
                                               tronearn.com
                       
Email: support@tronearn.com
Telegram: https://t.me/tronearn
...
contract TronEarn is SysCtrl {
    ...
    constructor() public {
        ...
        builds.push(Build({price: 400 trx, payout_per_hour: 0.75 trx, life_days: 50}));
        builds.push(Build({price: 1700 trx, payout_per_hour: 3.66 trx, life_days: 40}));
        builds.push(Build({price: 5000 trx, payout_per_hour: 11 trx, life_days: 35}));
        builds.push(Build({price: 15500 trx, payout_per_hour: 45 trx, life_days: 25}));
        builds.push(Build({price: 50800 trx, payout_per_hour: 130 trx, life_days: 20}));
    }
    ...
    function depositAndBuyBuild(uint _build) payable external {
        _deposit(msg.sender, msg.value);
        _buyBuild(msg.sender, _build);
    }
    
    function depositAndBuyBuilds(uint[] _builds) payable external {
        require(_builds.length > 0, "Empty builds");
...
/* 
This contract has been reviewed and audited
*/