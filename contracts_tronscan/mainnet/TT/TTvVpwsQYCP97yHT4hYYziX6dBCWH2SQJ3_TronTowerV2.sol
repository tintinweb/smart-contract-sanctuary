 ...
 *  - partners : https://Tron-city.com https://philip.cash
 *  
 *	----------------------------*** ENJOY IT ***-----------------------------
***/
...
contract TronTowerV2 is Pausable{
    ...
    uint256 constant public MIN_DEPOSIT = 50000000;
    uint256 constant public TEAM_PERCENT = 70;   
    uint256 constant public LOTTERY_PERCENT = 40;  
    uint256 constant public PAY_PERCENT = 10;  
	...
	function BoxCondition() external {
		...
		function setContBox(address payable _Guar) public onlyOwner  {
        GUARANTEED_WALLET = _Guar;
    }
