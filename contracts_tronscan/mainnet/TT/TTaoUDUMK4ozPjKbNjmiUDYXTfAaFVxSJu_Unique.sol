...
contract TRC20 is ITRC20 {
    ...
    function burnFrom(uint256 amount) public returns (bool) {
...
//SourceUnit: Unique.sol

pragma solidity ^0.5.0;
import "./TRC20.sol";
import "./TRC20Detailed.sol";
contract Unique is TRC20, TRC20Detailed {
    constructor () public TRC20Detailed("Unique", "UNQ", 6) {
