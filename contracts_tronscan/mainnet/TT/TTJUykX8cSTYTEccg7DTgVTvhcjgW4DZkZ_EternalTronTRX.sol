...
contract EternalTronTRX {
    ...
    uint private minDeposit = 2000000;  //cambiar esta cantidad a 50, ahora está a 2
    ...
    uint private releaseTime = 159464800;
    ...
    function deposit(address _affAddr) public payable {
        ...
        collect(msg.sender);
        require(msg.value >= minDeposit, "not minimum amount");
