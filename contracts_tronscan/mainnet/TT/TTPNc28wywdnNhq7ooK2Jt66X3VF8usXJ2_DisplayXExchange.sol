...
contract DisplayXExchange is Ownable{
    ...
    uint256 public tokenMinPurchase = 300000000;
    ...
    function ExchangeTRXforToken(address _addr, uint256 _amount) private {
		...
		require(_amount >= tokenMinPurchase, "Less than the minimum amount of deposit requirement");
    ...
    function PurchaseDPX() public payable {
	
		require(msg.value >= tokenMinPurchase, "Less than the minimum amount of deposit requirement");
    ...
    function updateMinimalPurchase(uint256 newMinimalValue) public onlyOwner {
        tokenMinPurchase = newMinimalValue;
    }
