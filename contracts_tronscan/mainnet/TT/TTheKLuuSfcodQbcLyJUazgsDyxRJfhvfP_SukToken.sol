 ...
 */
contract SukToken is
    TRC20Burnable,
    TRC20Detailed("SunStake", "SuK", 18),
    Ownable
{
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "SUK: caller is not a minter");
        _;
    }

    modifier mintingNotLocked() {
        require(!isMintingLocked(), "SUK: minting is locked");
        _;
    }
    ...
    function isMinter(address account) public view returns (bool) {
        require(account != address(0), "SUK: account is the zero address");
    ...
    function addMinter(address account) public onlyOwner {
        require(!isMinter(account), "SUK: already a minter");
    ...
    function removeMinter(address account) public onlyOwner {
        require(isMinter(account), "SUK: not a minter");
