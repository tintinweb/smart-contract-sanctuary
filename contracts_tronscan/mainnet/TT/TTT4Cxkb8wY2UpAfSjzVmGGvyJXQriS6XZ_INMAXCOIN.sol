...
contract Consts {
    ...
    string public constant TOKEN_NAME = "INMAXCOIN";
    string public constant TOKEN_SYMBOL = "INXC";
...
contract INMAXCOIN is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
