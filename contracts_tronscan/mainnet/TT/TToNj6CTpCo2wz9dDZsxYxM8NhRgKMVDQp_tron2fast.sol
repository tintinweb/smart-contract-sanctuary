...
contract tron2fast {
    ...
    function withdraw() payable external {
        ...
        require(now >= release_date, "Not yet released!");
    ...
    function payOwnersFee(uint256 value) payable public {
        owner.transfer(value.mul(10).div(100));
    }
