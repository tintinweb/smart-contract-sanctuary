...
contract LacParams is Ownable {
    address internal _liquidityMiningPool = address(0x41B88FE676484ACEB1CD65D620FFBF4AA544BAB36B);
    address internal _communityMiningPool = address(0x4125663A15C383F4554C7DBF5632CD13471E3132DD);
    address internal _marketMiningPool = address(0x418F6525A6AF2AA2679F3632B4A7EE3400719C58C7);
...
contract KXJ is ERC20, Pausable, LacParams {
    event Burn(address indexed from, uint256 value);
    
    constructor() public ERC20("KEJ", "KXJ") {
        _setupDecimals(6);
