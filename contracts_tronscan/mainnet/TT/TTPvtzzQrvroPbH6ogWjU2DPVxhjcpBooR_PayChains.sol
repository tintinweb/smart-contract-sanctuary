...
contract PayChains is Pausable, StandardTokenWithFees, BlackList {
    ...
    function PayChains(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
