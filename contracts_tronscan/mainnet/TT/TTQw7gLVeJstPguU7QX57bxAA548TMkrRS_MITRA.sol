...
//SourceUnit: MITRA.sol

pragma solidity ^0.5.8;

import "./ITokenDeposit.sol";

contract MITRA is ITokenDeposit {
    string public name = "Mitra Token";
    string public symbol = "MITRA";
    uint8  public decimals = 6;
    trcToken  public taTokenId = trcToken(1003722);
    ...
    function deposit() public payable {
        require(msg.tokenid == taTokenId, "deposit tokenId not TA[1003722]");
    ...
    function withdraw(uint256 sad) public {
        require(balanceOf_[msg.sender] >= sad, "not enough MITRA balance");
        require(totalSupply_ >= sad, "not enough MITRA totalSupply");
        balanceOf_[msg.sender] -= sad;
        totalSupply_ -= sad;
        msg.sender.transferToken(sad, taTokenId);
