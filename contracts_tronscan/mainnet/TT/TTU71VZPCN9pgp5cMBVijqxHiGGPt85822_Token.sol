...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'D13';
    string private _symbol = 'D13';
    uint8 private _decimals = 8;
    uint256 private _totalSupply = 365 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 365 * 10**uint256(_decimals);
