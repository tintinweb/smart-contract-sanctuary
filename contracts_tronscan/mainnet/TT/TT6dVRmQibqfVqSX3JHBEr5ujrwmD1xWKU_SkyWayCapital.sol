...
contract SkyWayCapital is StandardToken {
    string public name = "SkyWay Capital";
    string public symbol = "SKYWAY";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 68134856249 * 10 ** uint256(decimals);
