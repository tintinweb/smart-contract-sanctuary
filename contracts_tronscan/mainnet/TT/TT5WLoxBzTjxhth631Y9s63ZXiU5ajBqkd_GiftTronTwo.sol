//SourceUnit: gifttrontwo.sol

 
pragma solidity ^0.4.25;

contract GiftTronTwo {
  struct Tariff {
    uint time;
    uint percent;
  }
  ...
  constructor() public {
    tariffs.push(Tariff(10 * 28800, 110));
    tariffs.push(Tariff(15 * 28800, 115));
    tariffs.push(Tariff(20 * 28800, 120));
    tariffs.push(Tariff(30 * 28800, 140));
