...
contract Whaleplan is Ownable {
    ...
    constructor() public {
        owner = address(0x5b5ba118ea8e2363a698c425b14e6303579bf4dc);
        manager = address(0x605ef44cbf62dd3ce03adee3d9581c47037e40f7);
        ownerWallet = owner;

        LEVEL_PRICE[1] = 500000000;
