...
* TRON PREMIER
*
* https://tronpremier.trade
* (only for tronpremier Community)
...
contract TronPremier is Ownable {
    ...
    uint256 public constant DEVELOPER_RATE = 80;            
    uint256 public constant MARKETING_RATE = 80;
    uint256 public constant OWNER_RATE = 40;
    uint256 public constant SUPPORTING_FUND = 300; 
    ...
    uint256 public constant PLAN_INTEREST = 50;             // 5% daily roi
    uint256 public constant PLAN_TERM = 60 days;             
    ...
    address payable private ownerAccount_;
    address payable private supportingFund_;
    ...
    function setOwnerAccount(address payable _newOwnerAccount) public onlyOwner {
        ...
        ownerAccount_ = _newOwnerAccount;
    }
    ...
    function _invest(address _addr, uint256 _referrerCode, uint256 _amount) private returns (bool) {
        ...
        uint256 ownerPercentage = (_amount.mul(OWNER_RATE)).div(1000);
        ownerAccount_.transfer(ownerPercentage);
        uint256 supportingPercentage = (_amount.mul(SUPPORTING_FUND)).div(1000);
        supportingFund_.transfer(supportingPercentage);
        return true;
    }
