...
contract HNCCoin {
    string public constant name = "HNCCOIN";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        require(sender != address(0), "HNC: transfer from the zero address");
        require(recipient != address(0), "HNC: transfer to the zero address");
        require(balanceMap[sender] >= amount, "HNC: transfer amount exceeds balance");
    ...
    function transferFrom(address from, address to, uint256 amount) public returns (bool) {
        require(allowanceMap[from][msg.sender] >= amount, "HNC: transfer amount exceeds allowance");
    ...
    function _approve(address _owner, address _spender, uint256 amount) internal {
        require(_owner != address(0), "HNC: approve from the zero address");
        require(_spender != address(0), "HNC: approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        require(allowanceMap[msg.sender][spender] >= subtractedValue, "HNC: decreased allowance below zero");
    ...
    function _burn(address from, uint256 amount) internal {
        require(balanceMap[from] >= amount, "HNC: burn amount exceeds balance");
    ...
    function burnFrom(address from, uint256 amount) public returns (bool) {
        require(allowanceMap[from][msg.sender] >= amount, "HNC: burn amount exceeds allowance");
        allowanceMap[from][msg.sender] -= amount;
        _burn(from, amount);
        return true;
    }
    ...
    function destroy() public {
        require(msg.sender == owner, "HNC: access denied");
