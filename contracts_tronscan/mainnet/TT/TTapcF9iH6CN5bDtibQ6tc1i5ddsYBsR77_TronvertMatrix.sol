...
contract TronvertMatrix {
    ...
    constructor(address ownerAddress, address ID2, address ID3) public {
        ...
        levelPrice[3] = 50 trx;
        levelPrice[4] = 80 trx;
        levelPrice[5] = 100 trx;
        levelPrice[6] = 200 trx;
        levelPrice[7] = 300 trx;
        levelPrice[8] = 500 trx;
        levelPrice[9] = 700 trx;
        levelPrice[10] = 900 trx;
        levelPrice[11] = 1000 trx;
        levelPrice[12] = 1500 trx;
        levelPrice[13] = 2000 trx;
        levelPrice[14] = 2500 trx;
        levelPrice[15] = 3000 trx;
        levelPrice[16] = 3500 trx;
        levelPrice[17] = 4000 trx;
        levelPrice[18] = 5000 trx;
        ...
        users[ownerAddress].m1Matrix[1].referrals.push(ID2);
        users[ownerAddress].m1Matrix[1].referrals.push(ID3);
        
        users[ownerAddress].m2Matrix[1].firstLevelReferrals.push(ID2);
        users[ownerAddress].m2Matrix[1].firstLevelReferrals.push(ID3);
        
        users[ID2].m1Matrix[1].currentReferrer = ownerAddress;
        users[ID3].m1Matrix[1].currentReferrer = ownerAddress;
    ...
    function buyNewLevel(uint8 matrix, uint8 level) external payable {
        ...
        if (matrix == 1) {
            ...
            users[msg.sender].m1Matrix[level].currentReferrer = m1referrer;
    ...
    function registration(address userAddress, address referrerAddress) private {
        require(msg.value == 40 trx, "registration cost 40 trx");
        ...
        users[userAddress].m1Matrix[1].currentReferrer = m1referrer;
    ...
    function updateM2referrerSecondLevel(address userAddress, address referrerAddress, uint8 level) private {
        ...
        address[] memory x6 = users[users[referrerAddress].m2Matrix[level].currentReferrer].m2Matrix[level].firstLevelReferrals;
