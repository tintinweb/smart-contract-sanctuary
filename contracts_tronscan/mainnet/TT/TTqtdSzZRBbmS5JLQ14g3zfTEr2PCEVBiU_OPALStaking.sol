//SourceUnit: OPL-Staking-Contract-Live.sol

/*
 * Opals (OPL) Staking  - Stake OPL tokens and earn staking rewards...
 * Main Website - www.opalstaking.io
 * 0.3 to 0.9 Percent daily staking rewards depending upon your staking amount
 */
...
contract OPALStaking {
    ...
    uint public netInvested;
    uint private minDepositSize1 = 50000000;
    uint private minDepositSize2 = 5000000000;
    uint private minDepositSize3 = 10000000000;
    uint private minDepositSize4 = 20000000000;
    uint private minDepositSize5 = 50000000000;
    uint private minDepositSize6 = 70000000000;
    uint private minDepositSize7 = 90000000000;
    uint private interestRateDivisor = 10000000000000;
    
    uint private UnstakingTrxFee = 100000000;
    
    uint public LoadedRewards = 18000000000000;
    uint public AllowedRewards = 10800000000000;
    ...
    uint public Interest1 = 100;
    uint public Interest2 = 125;
    uint public Interest3 = 150;
    uint public Interest4 = 175;
    uint public Interest5 = 200;
    uint public Interest6 = 225;
    uint public Interest7 = 250;
    uint public MarketingFee1 = 3;
    uint public MarketingFee2 = 2;
    uint public MarketingFee3 = 5;
    uint public commissionDivisor = 100;
    uint public collectProfit;
    uint private minuteRate;
    uint private minuteRate1 = 347223;
    uint private minuteRate2 = 462963;
    uint private minuteRate3 = 578704;
    uint private minuteRate4 = 694445;
    uint private minuteRate5 = 810187;
    uint private minuteRate6 = 925926;
    uint private minuteRate7 = 1041667;
    uint private enablestaking = 1;
    ...
    function deposit(address _affAddr, uint256 amount) public {
        ...
        uint deductvalue = depositAmount.mul(25).div(commissionDivisor);
        LoadedRewards = LoadedRewards.sub(deductvalue);

        totalInvested = totalInvested.add(depositAmount);
        netInvested = netInvested.add(depositAmount);
        uint marketing_Fees1 = depositAmount.mul(MarketingFee1).div(commissionDivisor);
        uint marketing_Fees2 = depositAmount.mul(MarketingFee2).div(commissionDivisor);
        uint marketing_Fees3 = depositAmount.mul(MarketingFee3).div(commissionDivisor);
    ...
    function withdrawMyInvestment() public payable {
        TokenContract tokencontract = TokenContract(tokenContractAddress);
        Player storage player = players[msg.sender];
        //require(msg.sender.balance>=UnstakingTrxFee, "Insufficient balance");
        ...
        require(contBal>player.trxDeposit, "Amount greater than the contract balance");
     ...
     function maxStakeRewards(address _addr) internal view returns (uint) {
      ...
      uint256 maxstakingrewards = (player.trxDeposit.mul(Interest).div(commissionDivisor));
    ...
    function collect(address _addr) internal {
       ...
       uint256 contBal = tokencontract.balanceOf(address(this));
        ...
        if (secPassed > 0 && player.time > 0) {
         ...
         if (collectProfit > contBal){collectProfit = 0;}
