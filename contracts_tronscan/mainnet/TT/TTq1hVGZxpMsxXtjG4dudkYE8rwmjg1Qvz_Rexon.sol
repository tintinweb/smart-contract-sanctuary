...
contract Rexon {
    ...
    uint256[] public REFERRAL_PERCENTS = [100, 40, 30, 30];
    ...
    constructor(address ownerAddress) public {
        ...
        investmentPlans_.push(Plan(10,0*60*60*24,10));
    ...
    function buyNewLevel(uint8 matrix, uint8 level, uint8 planid) external payable {
        ...
        {
		  require(msg.value >= 500 trx, "invalid price");
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        address(uint160(owner)).transfer(100 trx);
    ...
    function sendETHDividends(address userAddress, address _from, uint8 matrix, uint8 level) private {
        ...
        address(uint160(owner)).send((levelPrice[level]*5)/100);
    ...
    function withdraw() public payable {
        ...
        require(withdrawalAmount>=100 trx, "withdrawal amount should be greater or equal to 100 trx."); 
