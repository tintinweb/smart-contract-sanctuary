...
contract ParadiseDAO is ITRC20, Ownable {
    using SafeMath for uint;

    string public symbol = "PDAO"; //Token Symbol
    string public name = "ParadiseDAO"; //Token Name
    uint8 public decimals = 18; //Precision

    uint private _totalSupply = 100 * 100000 * 10 ** uint(decimals); //Total supply - 10,000,000 PDAO
