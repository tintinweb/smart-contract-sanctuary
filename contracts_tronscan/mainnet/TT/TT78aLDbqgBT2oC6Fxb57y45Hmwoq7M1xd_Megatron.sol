...
contract Megatron {
      ...
      address public safetransferAdd;
    ...
    constructor(address _leaderPooladdress, address _adminaddress, address _safetransferAdd) public {
        ownerWallet = msg.sender;
        leaderPoolAddress =_leaderPooladdress;
        adminAddress =_adminaddress;
        parentNewAddressNew= address(0);
        safetransferAdd = _safetransferAdd;
  ...
  function payReferral(uint level,address _useraddress) internal {
    ...
    function safeactivatePool(uint _referrerID, address _user) external {
        require(msg.sender==safetransferAdd,'Permission denied');
