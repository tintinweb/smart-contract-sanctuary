...
contract R8 is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 5688 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'R8';
    string private _symbol = 'R8';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41410439f68b07bc53397c154740dc267854a362b2);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 1688 * 10**uint256(_decimals);
