//SourceUnit: TronNet.sol

pragma solidity ^0.4.25;

/*! TronNet.sol | (c) 2020 Develop by PiOf (Tron-net.site) */
...
contract TronNet {
  ...
  constructor() public {
    tariffs.push(Tariff(6 * 28800, 156));
    tariffs.push(Tariff(8 * 28800, 192));
    tariffs.push(Tariff(11 * 28800, 242));
    tariffs.push(Tariff(15 * 28800, 300));
