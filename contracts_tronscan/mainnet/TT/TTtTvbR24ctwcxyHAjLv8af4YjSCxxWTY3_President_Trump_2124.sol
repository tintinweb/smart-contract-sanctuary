...
contract Consts {
    ...
    string public constant TOKEN_NAME = "President Trump 2124";
    string public constant TOKEN_SYMBOL = "TRP";
...
contract President_Trump_2124 is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
