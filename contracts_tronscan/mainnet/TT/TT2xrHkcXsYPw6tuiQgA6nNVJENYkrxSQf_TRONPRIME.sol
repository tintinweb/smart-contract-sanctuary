...
/*
 *  TRONPRIME - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://tron-prime.com                                     │
 *   │                                                                       │  
 *   │   Telegram Group: https://t.me/tronprimegroup                         |
 *   │   Telegram Channel: https://t.me/tronprimechannel                     |
 *   |   E-mail: team@tron-prime.com                                         |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *   [INVESTMENT CONDITIONS]
 * 
 *   - Basic interest rate: 5.5% every 24 hours (+0.229% hourly)
 *   - Personal hold-bonus: +0.1% for every 24 hours without withdraw 
 *   - Contract total amount bonus: +1% for every 2,000,00 TRX on platform address balance 
 * 
 *   - Minimum deposit: 100 TRX, no maximum limit
...
contract TRONPRIME {
	...
	uint256 constant public PROJECT_SUSTAIN = 60;
	uint256[] public REFF_PERCENT = [50, 20, 10, 5, 5];
	...
	function invest(address referrer) public payable {
		...
		projectAddress.transfer(msg.value.mul(PROJECT_SUSTAIN).div(PERCENTS_DIVIDER));
