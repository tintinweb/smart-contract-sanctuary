...
contract OSKTRXLP is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public osk = IERC20(0x415D03449B5A4EAFF0E9275089B1F100F096C6FD2C);
    ...
    function getReward() public updateReward(msg.sender)  checkStart{
        ...
        if (reward > 0) {
            ...
            // osk.mint(governance, reward.mul(20).div(100)); // dev
            safeOSKTransfer(governance, reward.mul(20).div(100)); // dev
