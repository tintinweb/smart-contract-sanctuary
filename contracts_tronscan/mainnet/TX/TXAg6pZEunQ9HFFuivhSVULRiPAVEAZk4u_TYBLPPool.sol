...
contract LPTokenWrapper is Ownable{
    ...
    IERC20 public lpToken = IERC20(0x410efcdbf9956fc1ae62a496c9397af561068b08e3);
...
contract TYBLPPool is LPTokenWrapper {
    ...
    function getApy() public view returns(uint256 _apy) {
        if(totalSupply() > 0 && rewardRate > 0) {
            _apy = rewardRate.mul(1 days).mul(365).mul(1e8).div(totalSupply());
        }
    }
