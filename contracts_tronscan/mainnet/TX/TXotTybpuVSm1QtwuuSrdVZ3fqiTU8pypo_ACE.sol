...
contract ACE is TRC20, TRC20Detailed, Ownable {
  ...
  uint256 public constant TOKEN_PRICE_INCREASING_MONTHLY_PERCENT = 142;
  ...
  =            PUBLIC FUNCTIONS           =
  =======================================*/
  constructor() public TRC20Detailed("Ace Token", "ACE", 6) {
