//SourceUnit: TronSavings.sol

pragma solidity ^0.4.25;

contract TronSavings {
    ...
    uint256 private interestRateDivisor = 9000000000000;
    uint256 public devCommission = 2;
    uint256 public commissionDivisor = 100;
    uint256 private minuteRate = 3125000;
    uint256 private releaseTime = 1594308600;
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint256 feedEarn = depositAmount.mul(devCommission).mul(10).div(
            commissionDivisor
        );
        uint256 feedtrx = feedEarn.div(2);
    ...
    function distributeRef(uint256 _trx, address _affFrom) private {
        uint256 _allaff = (_trx.mul(34)).div(100);
        ...
        if (_affAddr1 != address(0)) {
            _affRewards = (_trx.mul(14)).div(100);
