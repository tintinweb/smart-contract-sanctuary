//SourceUnit: Tronex2.sol

/*
 * 
 *   TRONex2 - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website：https://www.tronex2.cc                                     │
 *   │   News：    https://t.me/TRONex2_cc                                   │  
 *   │   Twitter：  https://twitter.com/TRONex_2                             |
 *   |    E-mail:     tronex_2@outlook.com                                   |
 *   |    Official  Group：https://t.me/Tronex2c                             |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 * - Total contract bonus:platform address balance for every increase of 3,000,000 TRX+ 0.1%,capped at a maximum of 16%
 *
 ...
 *   - 10-level referral commission: 4% - 2% - 0.5% - 0.5% - ...
 *
 *   [FUNDS DISTRIBUTION]
 *
...
contract TRONEX2 {
	...
	function getContractBalanceRate() public view returns (uint256) {
		...
		if(contractBalancePercent > 150){
			contractBalancePercent = 150;
		}
