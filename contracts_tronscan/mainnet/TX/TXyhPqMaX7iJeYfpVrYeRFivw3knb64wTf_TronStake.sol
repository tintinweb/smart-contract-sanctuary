//SourceUnit: TronStake.sol
 ...
 /*   TronStake - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *   The only official platform of original TronStake team! All other platforms with the same contract code are FAKE!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://tronstake.com                                      │
 *   │                                                                       │
 *   │   Telegram Live Support: @tronstakedefi                               |
 *   │   Telegram Public Group: @tronstakedapp                               |
 *   |                                                                       |
 *   |   YouTube: youtube.com/channel/UCQxDOGguiKsCCZgRQWSEeiw               |           
 *   |   E-mail: admin@tronstake.com                                         |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
