...
contract NGNDToken is TRC20, TRC20Detailed,TRC20Burnable, MinterRole {
    uint8 private constant _decimals = 8;
    uint256 private constant _maxMint = 10000000 * (10 ** uint256(_decimals)); //
    uint256 private constant _cap = _maxMint * 20000000000000000000000000000000000000; // 
    uint private constant _mintInterval = 60 * 60 * 1 * 0; // 
    uint private _lastMint = 0;

constructor ()
        TRC20Detailed("Digital Naira", "NGND", _decimals)
        TRC20()
        public
    {}
