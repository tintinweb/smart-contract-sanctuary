...
contract MLCToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function MLCToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
