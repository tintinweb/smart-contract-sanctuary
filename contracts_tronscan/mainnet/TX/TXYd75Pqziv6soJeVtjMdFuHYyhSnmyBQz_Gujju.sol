...
contract TRC20Basic is ITRC20,Pausable {
...
contract Gujju is TRC20Basic {
    string public constant name = "Gujju Coins";
    string public constant symbol = "Gujju";
