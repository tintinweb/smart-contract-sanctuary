...
contract DNFToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function DNFToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
