...
contract YETITOKEN is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 100000000000;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("YETI TOKEN", "YETI", 6){
        	owner = msg.sender;	
