...
//SourceUnit: HyperHoldingToken.sol
 ...
 */
contract HyperHoldingToken is Context, AccessControl, TRC20Burnable{
     ...
     */
    constructor() public TRC20("Hyper Holding", "HYHO") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "HyperHoldingToken: must have minter role to mint");
        _mint(to, amount);
    }
