 ...
 * `TRC20` functions.
 */
contract SuntecCoin is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor (uint256 _totalSupply) public TRC20Detailed("Suntec Coin", "STC", 5) {
...
contract TRC20 is ITRC20 {
    ...
    string _msg_success = "Success";
    string _msg_auth = "Sender not authorized.";
    ...
    modifier onlyOwner(address _account){
        require(msg.sender == _account, _msg_auth);
        _;
    }
    ...
    // function leaveContract() public onlyOwner(ownerAddress) onlyAfter(creationTime + 5 minutes) {
    //   delete ownerAddress;
    // }

    // /// destroy the contract and reclaim the leftover funds.
    // function distroy() public onlyOwner(ownerAddress) {
    ...
    function _myAddress() public view returns (address) {
        return msg.sender;
    }
    
    function _myBalance() public view returns (uint256) {
