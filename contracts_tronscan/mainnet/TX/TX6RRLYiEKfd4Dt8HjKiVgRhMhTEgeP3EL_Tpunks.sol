 ...
 */
contract Tpunks is Context, Ownable, TRC165, ITpunks, IERC721Metadata {
    ...
    uint256 private punks_per_colum = 1000;
    ...
    uint256 public airDrop_reward = 500 trx;
    ...
    function initializeOwners(address[] memory users) onlyOwner public {
        require(!start_sale, 'You can not do it when sale is start');
        
        for(uint256 i=0; i<users.length;i++){
            _safeMint(users[i], punks_index[0]);
            punks_index[0]++;
        }
    }
