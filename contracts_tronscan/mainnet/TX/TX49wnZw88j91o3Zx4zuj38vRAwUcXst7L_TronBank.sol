//SourceUnit: tronbank.sol
 ...
 /*  TronBank is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://tronbank.space         							 │
 * 	 │																		 │
 *   │   TronBank - Next Generation Communıty Program						 │
 *	 │                                                                       │
 *	 │	 Upto 2.5% Daily ROI + 1% Hold Bonus	   					       	 │
 *	 │                                                                       │
...
contract TronBank {
    ...
    uint constant public INVEST_MIN_AMOUNT = 70 trx;
    uint constant public INVEST_MAX_AMOUNT = 5000000 trx;
