//SourceUnit: trontower2.sol

/*
 *	TRON TOWER - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://TronTower.com                                         │
 *   │                                                                       │  
 *   │   Telegram Live Support: https://t.me/TronTowersupport                  |
 *   │   Telegram Public Group: https://t.me/TronTowergroup                    |
 *   │   Telegram News Channel: https://t.me/TronTowernews                    |
 *   |                                                                       |
 *   |   Twitter: https://twitter.com/get_tron                          |
 *   |   YouTube: https://www.youtube.com/channel/UCidk8kIKQ3SqfzqNSEhwHDQ   |
 *   |   E-mail: admin@TronTower.com                                            |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *   ────────────────────────────────────────────────────────────────────────
 ...
 *
 *   - Officially registered company name: TRON TOWER LIMITED (#12890649)
 *   - Company status: https://beta.companieshouse.gov.uk/company/12890649
...
contract TronTower is Pausable{
    ...
    uint256[] public BOX_RATE_DIVIDER = [3160000, 2160000, 1728000, 1440000];
    uint256[] public BOX_PERIOD = [0, 50 days, 28 days, 20 days];
    uint256 constant public MIN_DEPOSIT = 5000000;
    uint256 constant public ADMIN_PERCENT = 0;
    uint256 constant public LOTTERY_PERCENT = 40;
    address payable constant public ADMIN_WALLET = address(0);
