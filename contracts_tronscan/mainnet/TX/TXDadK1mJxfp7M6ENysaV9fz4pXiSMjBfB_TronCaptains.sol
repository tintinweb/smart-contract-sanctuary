//SourceUnit: TronCaptains.sol

pragma solidity ^0.4.25;

contract TronCaptains {
  struct Investor {
    bool registered;
    address referrer;
    uint balanceRef;
  ...
  function withdrawable(address user) public view returns (uint amount) {
    ...
    return investor.paidAt > 0 ? investor.invested * (block.timestamp - investor.paidAt) * 3 / DAY / 10 : 0;
  }
