...
contract Rockettron {
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint feed2earn = depositAmount.mul(devCommission).mul(3).div(commissionDivisor);

      
         msg.sender.transfer(msg.value / 200);
