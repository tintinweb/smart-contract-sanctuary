 ...
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://www.tronplan.cc                                    │
 *   │                                                                       │  
 *   │                                                                       |
 *   |   YouTube: https://youtu.be/KUfBQZlpLRs                               |
 *   |   Developers_wechat:  hbzsks2015                                                 |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
		...
		if (user.referrer != address(0)) {
			...
			for (uint256 i = 0; i < 10; i++) {
				if (upline != address(0)) {
					...
					users[upline].referralReward[i] = users[upline].referralReward[i].add(amount);
