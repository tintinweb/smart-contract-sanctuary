...
contract DMSToken is TRC20("DMSToken", "DMS"), Ownable {
    using SafeMath for uint256;
    ...
    constructor() public {
         ...
         * @notice Set Admin
         */
        function setAdmin(address newer) public onlyOwner returns (bool) {
            _admin = newer;
         ...
         * @notice Add node
         */
        function addNode(address node) public onlyAdmin returns (bool) {
         ...
         * @notice Remove node
         */
        function removeNode(address node) public onlyAdmin returns (bool) {
    ...
    public
        ...
        function actualAmount(
            ...
            //20% of the burned part is accumulated to the pool
            uint256 part2 = burned.mul(20).div(100);

            //50% is directly burned
            uint256 part3 = burned.mul(50).div(100);
            ...
            _mint(getParent(target), part1.mul(50).div(100)); //parent 1 50%
            _mint(getParent(getParent(target)), part1.mul(30).div(100)); //parent 2 30%
            _mint(getParent(getParent(getParent(target))), part1.mul(20).div(100)); //parent 3 20%
