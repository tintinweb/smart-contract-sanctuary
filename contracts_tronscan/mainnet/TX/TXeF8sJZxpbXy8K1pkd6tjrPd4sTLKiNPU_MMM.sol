...
contract MMM is Context, IERC20, Ownable {
    ...
    string private _name = "MMM Token";
    string private _symbol = "MMM";
    uint8 private _decimals = 18;

    uint256 public _taxFee = 0; // 2% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 3; // 2% added to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 5; // 2% burn fee
    uint256 private _previousBurnFee = _burnFee;

    uint256 public marketingAndDevelopment = 7; // 2% Marketing and Development
