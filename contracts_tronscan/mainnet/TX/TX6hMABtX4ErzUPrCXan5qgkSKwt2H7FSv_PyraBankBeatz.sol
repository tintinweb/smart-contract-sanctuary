//SourceUnit: beatz.sol

pragma solidity ^0.4.24;

contract PyraBankBeatz {
    ...
    string public name = "Pyrabank BeatzCoin";
    string public symbol = "PYRA";
    uint8 constant public decimals = 18;
    uint8 constant internal dividendFee_ = 15;
    uint8 constant internal transferFee_ = 7;
    uint8 constant internal refferalFee_ = 33;
    uint256 constant internal tokenPrice_ = 35525;
    uint256 constant internal magnitude = 2 ** 64;
    uint256 public stakingRequirement = 220000e18;
    ...
    function totalTronBalance() public view returns (uint256) {
        return address(this).tokenBalance(1002413);
    }
