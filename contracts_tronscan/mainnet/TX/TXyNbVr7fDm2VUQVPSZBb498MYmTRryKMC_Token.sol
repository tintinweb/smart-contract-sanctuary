...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'Fover';
    string private _symbol = 'Fover';
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 699300 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 9300 * 10**uint256(_decimals);
