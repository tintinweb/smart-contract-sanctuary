//SourceUnit: StarTron100.sol

pragma solidity 0.5.9;

contract StarTron100 {
    ...
    constructor() public {
        ...
        soft_release = 1608804000;
        full_release = 1608858000;
    }

    function deposit(address _referral) external payable {
        require(uint256(block.timestamp) > soft_release, "Contract not yet launch");
	...
	owner.transfer(amountLess25 * 10 /100);
