...
/**
 * Game Station smart contract.
 */
contract GAST is AbstractToken {
  /**
  ...
  string constant public name = "Game Station";
  string constant public symbol = "GAST";
