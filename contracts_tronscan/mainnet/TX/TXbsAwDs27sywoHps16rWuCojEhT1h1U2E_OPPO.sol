...
contract OPPO is ITRC20, Pausable, ReentrancyGuard {
    ...
    // Creator address, which will be black forever,
    // and will not burn as `from`.
    ...
    constructor(
        ...
        _blackRewardAddressSet.add(_creatorAddress);
    ...
    function _transfer(
        ...
        // If `_creatorAddress` sends tokens, will not burn.
        if (from == _creatorAddress) {
            _transferWithoutBurn(from, to, value);
            return;
        }
