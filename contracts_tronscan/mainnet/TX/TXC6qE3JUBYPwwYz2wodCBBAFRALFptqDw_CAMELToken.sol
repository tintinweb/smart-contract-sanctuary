...
contract CAMELToken is TRC20, TRC20Detailed, TRC20Burnable, Ownable {

    constructor() TRC20Detailed("CAMEL TOKEN", "CAMEL", 6) public {
        _mint(msg.sender, 1680000 * (10 ** uint256(decimals())));
    }
