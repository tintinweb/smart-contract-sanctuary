...
contract CPP is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 68000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'CPP';
    string private _symbol = 'CPP';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x419B225BDA8612CFCDD5383CE11154C96A7C305ABE);
