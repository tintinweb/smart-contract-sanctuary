...
* TronFenix 
* 
* Investment Platform: 20% Daily ROI* 
* 5% + 3% +1% Referral Rewards -3 Levels-
* 
* https://TronFenix.Com
* 
**/
...
contract TronFenix {
    ...
    uint256 private constant MTN_FEE              = 5;
    ...
    uint256 private constant DEFAULT_PLANBONUS    = 20E9;

    uint256 private constant MIN_PLANBONUS        = 5E9;

    uint256 private constant PENALTY_PLANBONUS    = 15E9;
    ...
    uint256[] private REF_BONUSES = [5, 3, 1];
