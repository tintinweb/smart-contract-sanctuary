...
contract GPXToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 6688000 * 10**6;
    ...
    address private fundAddress = address(0x417D1F7331EF0028B1B142EEE1A417D9D07381EA71);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 66880 * 10**uint256(_decimals);
