//SourceUnit: MillionsMoneyTrx.sol

pragma solidity  >=0.4.23 <0.6.0;

contract MillionsMoneyTrx {
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        users[userAddress].x3Matrix[1].currentReferrer = freeX3Referrer; // need to change ds
        updateX3Referrer(userAddress, freeX3Referrer, 1);

        updateX6Referrer(userAddress, findFreeX6Referrer(userAddress, 1), 1);
        address(uint160(referrerAddress)).transfer(50000000); // Direct Income
    ...
    function updateX3Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (referrerAddress != owner) {
            ...
            emit Reinvest(owner, owner, userAddress, 1, level);
        }
    }

    function updateX6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        require(users[referrerAddress].activeX6Levels[level], "150. Referrer level is inactive");
    ...
    function updateX6ReferrerSecondLevel(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (referrerAddress != owner) {
            ...
            emit Reinvest(owner, owner, userAddress, 2, level);
