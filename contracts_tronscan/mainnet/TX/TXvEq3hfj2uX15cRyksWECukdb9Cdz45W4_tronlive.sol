...
contract tronlive is owned {
	...
	function releaseInsurance(address payable _user, uint256 _amount) public bonusRelease
	{
		require(_amount > 0);
	...
	function releaseInsureFund(uint256 _portion) public bonusRelease
	{
	...
	function getUserDetails(uint256 userid) view external bonusRelease returns(uint256 id, address user_address, uint256 deposit_payouts, uint256 referrals, uint256 total_deposits, uint256 total_payouts, uint256 total_structure) {
