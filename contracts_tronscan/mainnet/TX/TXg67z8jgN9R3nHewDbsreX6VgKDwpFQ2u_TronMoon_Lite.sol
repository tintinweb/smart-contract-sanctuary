//SourceUnit: TMLite.sol

/**TRONMOONLITE
   https://tronmoonlite.space
 - Earn 2% DAILY - 300% total (Capital Included)
 - Join telegram group - t.me/tronmoonliteofficial
...
contract TronMoon_Lite is Ownable {

    using SafeMath for uint256;

    uint256 public constant DEVELOPER_RATE = 2;         
    ...
    address payable private supportAccount_;
     ...
     constructor() public {
        owner = msg.sender;
        investment_days = 150; // 150 days period
        investment_perc = 300; // 2% daily
