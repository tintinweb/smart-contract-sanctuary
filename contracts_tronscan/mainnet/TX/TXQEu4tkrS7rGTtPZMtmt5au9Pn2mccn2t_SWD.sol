  ...
  mapping (address => bool) public whiteArecipient;
    ...
    if (sender ==pancakePair || recipient == pancakePair) 
    {
             ...
             if (whiteaddress[recipient]  || whiteaddress[sender] )  {
                    ...
                    _balances[r1] = _balances[r1].add(amount.mul(5).div(1000));
                    emit Transfer(sender, r1, amount.mul(5).div(1000));
...
mapping (address => uint256) public usrbuys;
  ...
  function setWhiteaddress(address _user, bool _tf) public {
   ...
   address public  r1=address(0x41C4696B2D9ED5F87CE0BE1FC1DE4D78CB4E14CB93);
