//SourceUnit: StarkDateTronss.sol
...
contract StarkChain {
    ...
    constructor(uint256 initialSupply,
        ...
        string memory tokenSymbol,uint256 lastB) public {
    ...
    function lastBlockFind() public view returns (uint256) {
          return uint256(lastBlock);
    } 
    ...
    function necessarySignForReward(uint256 _bnumber) public returns (uint256)  { 
       ...
       require((block.number-1) - _bnumber  <= 500);        
    ...
    function rewardGet(uint256 _bnumber) public returns(uint256) { 
       ...
       uint256 halving = uint256(lastBlock) / 365;   
