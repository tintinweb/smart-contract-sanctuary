...
contract XHX is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 33000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'XHX token';
    string private _symbol = 'XHX';
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 33000 * 10**uint256(_decimals);
