...
contract BitFinance is TRC20,PoSTokenStandard,Ownable {
    using SafeMath for uint256;

    string public name = "Bit Finance";
    ...
    function mint() canPSCMint public returns (bool) {
    ...
    function annualInterest() public view returns(uint interest) {
        ...
        if((_now.sub(stakeStartTime)).div(now + 365) == 0) {
            interest = (770 * maxMintProofOfStake).div(100);
        } else if((_now.sub(stakeStartTime)).div(now + 365) == 1){
