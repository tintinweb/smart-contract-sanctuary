...
contract TRC20Token is Ownable, MintableToken {
    ...
    constructor(string memory _name, string memory _symbol, bool _infiniteSupply, uint256 _premine, uint256 _supplyCap) public {
        name = _name;
        symbol = _symbol;
    ...
    function mint(address _to, uint256 _amount) public returns (bool) {
        ...
        if (mintedSupply_ == targetSupply) {mintingFinished = true;}
