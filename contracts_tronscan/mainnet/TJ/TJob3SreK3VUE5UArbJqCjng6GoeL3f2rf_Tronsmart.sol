//SourceUnit: tronsmart.sol
 ...
 /*  Tronsmart is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://Tronsmart.pro         							 │
 * 	 │																		 │
 *   │   Tronsmart - Next Generation Communıty Program						 │
 *	 │                                                                       │
 *	 │	 2.5% Daily ROI + 1% PERSONAL HOLD-BONUS					       	 │
 *	 │                                                                       │
