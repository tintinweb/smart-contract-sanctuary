//SourceUnit: TronLenderFINAL.sol

/*   TronLender SafeTested
 *
 /$$$$$$$$/$$$$$$$  /$$$$$$ /$$   /$$/$$      /$$$$$$$$/$$   /$$/$$$$$$$ /$$$$$$$$/$$$$$$$ 
|__  $$__| $$__  $$/$$__  $| $$$ | $| $$     | $$_____| $$$ | $| $$__  $| $$_____| $$__  $$
   ...
   | $$  | $$  \ $| $$  | $| $$\  $$| $$     | $$     | $$\  $$| $$  | $| $$     | $$  \ $$
   | $$  | $$  | $|  $$$$$$| $$ \  $| $$$$$$$| $$$$$$$| $$ \  $| $$$$$$$| $$$$$$$| $$  | $$
   |__/  |__/  |__/\______/|__/  \__|________|________|__/  \__|_______/|________|__/  |__/
...
contract TronLender {
    ...
    constructor(address _insurance) public {
        owner = msg.sender;
        insurance = _insurance;

        investment_days = 10;
        investment_perc = 1500;
        ...
        soft_release = 1615708800;
        full_release = 1615716800;
    }
    ...
    function withdraw() payable external {
        ...
        //REINVEST
        uint256 _45Percent = amount.mul(25).div(100);
        //REINVEST
        uint256 amountLess25 = amount.mul(35).div(100);

        autoreinvest(_25Percent);

        player.dividends = 0;
        player.referral_bonus = 0;
        player.total_withdrawn += _25Percent;
        total_withdrawn += _25Percent;

        msg.sender.transfer(_45Percent);
        insurance.transfer(amountLess25);

        emit Withdraw(msg.sender, _25Percent);
    }
