...
contract Ownable is Context, TRC20 {
...
contract Dcbits is TRC20, TRC20Detailed, Ownable {
    constructor() TRC20Detailed("DCBITS", "DCBT", 8) public {
        _mint(msg.sender, 50000000 * (10 ** 8));
    }
}