...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[sender] = _balances[sender].sub(amount.mul(90).div(100));
...
contract Token is ERC20, ERC20Detailed {
     ...
     */
    constructor (address user) public ERC20Detailed("Pegasus chain", "PSC", 18) {
        _mint(user, 99999 * (10 ** uint256(decimals())));
    }
}