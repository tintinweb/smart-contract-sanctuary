...
contract TronX {
    ...
    uint public techCommission = 1000; // 3.00%
    uint public markCommission = 1000; // 3.00%

    
    
    uint public Aff = 1700; // 24.00%
    uint public Aff1 = 750; // 7.50%
    uint public Aff1A = 800; // 8.00%
    uint public Aff1B = 1000; // 10.00%
    uint public Aff2 = 200; // 5%
    uint public Aff3 = 100; // 3%
    uint public Aff4 = 100; // 2%
