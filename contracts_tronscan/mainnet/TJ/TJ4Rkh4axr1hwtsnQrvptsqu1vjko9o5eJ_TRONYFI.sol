...
contract TRONYFI {
    ...
    */
    ...
    uint256 internal tokenPriceInitial_ = 2 * (10 ** uint256(6));
    ...
    function withdrawDailyStake() internal {
    ...
    function reStake(uint256 _amount)
        ...
        public
        {
            require(_amount<=tokenBalanceLedger_[msg.sender]);
            require(tokenStakeBalanceLedger_[msg.sender]>0);
            withdrawDailyStake(); //Withdraws Daily Stake Before ReStaking
