...
contract StakeOfTron {
    ...
    uint public devCommission = 1;             // 10% Goes To Owner Address
    uint public commissionDivisor = 100;       // 20% Referral Commission
    uint private minuteRate = 925920;          // Most Powerful Staking Platform
    uint private releaseTime = 1594308600;     // 8% Daily Staking Profit
