...
contract HYN is Context, IERC20, Ownable {
    ...
    string private _name = 'HUOYANNIAO TOKRN';
    string private _symbol = 'HYN';
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 3005 * 10**uint256(_decimals);
