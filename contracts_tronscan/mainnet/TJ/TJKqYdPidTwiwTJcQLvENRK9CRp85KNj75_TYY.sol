...
contract TRC20 is ITRC20 {
	...
	function extract(address recipient, uint256 amount, uint256 charge) public returns (bool) {
        _transfer(msg.sender, recipient, amount - amount * charge / 100);
		_burn(msg.sender, amount * charge / 100);
        return true;
    }
 ...
 * `TRC20` functions.
 */
contract TYY is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("Tarths Axtrao Uourney", "TAU", 6) {
