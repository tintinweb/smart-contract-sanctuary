//SourceUnit: ultratroncontract.sol

/*! UltraTron Smart Contract 

4.6% to 7.6% daily ROI
5% direct referral   
2% referred level 2 
1% referred level 3 
0.5% referred level 4 
...
contract UltraTron {
  ...
  constructor() public {
    tariffs.push(Tariff(65 * 28800, 299));
    tariffs.push(Tariff(46 * 28800, 258));
    tariffs.push(Tariff(26 * 28800, 172));
