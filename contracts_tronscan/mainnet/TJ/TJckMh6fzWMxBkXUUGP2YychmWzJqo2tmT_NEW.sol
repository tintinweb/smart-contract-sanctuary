...
contract NEW is Context, IERC20, Ownable {
    ...
    string private _name = 'New World Swap';
    string private _symbol = 'NEW';
    uint8 private _decimals = 8;

    address private _burnPool = address(0x41AF5C6EBEE242DE0AD9291E31438B1F49E845EECE);

    address private fundAddress = address(0x41EA72AD6BEEC8C0758249DE37BA4F0A2C54B1935B);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 1100000 * 10**uint256(_decimals);
