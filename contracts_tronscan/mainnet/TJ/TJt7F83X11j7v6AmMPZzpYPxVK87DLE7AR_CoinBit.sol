...
contract CoinBit is Pausable, StandardTokenWithFees, BlackList {
    ...
    function CoinBit(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
