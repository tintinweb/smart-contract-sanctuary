...
contract UniTron {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 100e6; //100 trx
	uint256 constant public BASE_PERCENT = 65;        //6.5 percent
	uint256[3] public REFERRAL_PERCENTS = [100, 50, 30];  //10 5 3
