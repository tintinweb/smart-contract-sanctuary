...
contract NEB is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 13800 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Taurus pass card';
    string private _symbol = 'NEB';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x419cbf78b7d441932a06712040e114dca5643d2095);
