...
* TronHeroOfficial
*
* https://tronheroofficial.com
* (only for tronheroofficial.com Community)
...
contract TronHeroOfficial is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 60;            // 6% Team, Operation & Development
    uint256 public constant MARKETING_RATE = 60;            // 6% Marketing
