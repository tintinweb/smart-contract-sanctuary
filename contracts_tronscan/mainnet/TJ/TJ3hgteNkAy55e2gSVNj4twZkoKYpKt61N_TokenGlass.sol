...
contract TokenGlass {
    ...
    string public name = "Arcadium X BTT";
    string public symbol = "BTTX";
    uint8 constant public decimals = 18;
    uint8 constant internal dividendFee_ = 10;
    uint256 constant internal tokenPrice_ = 1000000;
    ...
    function getTokenBalance(address accountAddress) public view returns (uint256){return accountAddress.tokenBalance(1002000);}
    ...
    function totalTronBalance() public view returns (uint256) {return address(this).tokenBalance(1002000);}
