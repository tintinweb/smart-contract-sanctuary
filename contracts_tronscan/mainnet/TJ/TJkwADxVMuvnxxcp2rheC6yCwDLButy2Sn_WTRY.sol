...
contract WTRY is Context, ITRC20, Ownable {
    ...
    string private _name = 'WTRY';
    string private _symbol = 'WTRY';
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 100 * 10**uint256(_decimals);
    ...
    function setExchangeWTRY(address exchangePool) public onlyOwner {
