//SourceUnit: GMR_Token.sol

pragma solidity >=0.4.23 <=0.6.0;


contract GrowMore_Token {
    ...
    string tokenName = 'GrowMore';
    string tokenSymbol = 'GMR';
    constructor() public {
...
function transferTRX(address payable _to, uint256 _value) external isOwner returns (bool success) {
    ...
    function transferTron(address _to, uint256 _value) external isOwner returns (bool success) {
