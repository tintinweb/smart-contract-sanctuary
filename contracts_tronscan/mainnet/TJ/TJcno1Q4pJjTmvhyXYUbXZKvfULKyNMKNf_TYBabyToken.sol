...
contract TYBabyToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 1100000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'TYBaby Token';
    string private _symbol = 'TYBaby';
