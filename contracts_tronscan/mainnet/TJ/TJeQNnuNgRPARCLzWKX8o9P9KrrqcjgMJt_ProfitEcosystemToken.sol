...
contract ProfitEcosystemToken is ITRC20, TRC20Detailed {
    constructor(address genesis) public TRC20Detailed("PROFITECOSYSTEMTOKEN", "PES", 4){
        require(genesis != address(0), "invalid genesis");
        _mint(genesis, 1000000000 * 10 ** 4);
    }
}
