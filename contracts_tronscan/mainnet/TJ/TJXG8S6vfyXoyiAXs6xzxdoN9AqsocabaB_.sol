...
contract Consts {
    ...
    string public constant TOKEN_NAME = "AMT Coin";
    string public constant TOKEN_SYMBOL = "AMT";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x01ab71c57737f305486e4ffaaad6520591ed3e1f;
...
contract MainToken is Consts, FreezableMintableToken, BurnableToken, Pausable {
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x01ab71c57737f305486e4ffaaad6520591ed3e1f)];
        uint[1] memory amounts = [uint(1000000000000000)];
