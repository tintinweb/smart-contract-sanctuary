 ...
 * `TRC20` functions.
 */
contract BrvToken is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("BrvToken", "BRV", 6) {
        _mint(msg.sender, 22500000 * (10 ** uint256(decimals())));
    }
}
