...
//SourceUnit: Gerai Pulsa Coin.sol
...
contract GeraiPulsaCoin is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("Gerai Pulsa Coin", "GPC", 8){
        require(gr != address(0), "invalid gr");
        _mint(gr, 250000000 * 10 ** 8);
    }
}
