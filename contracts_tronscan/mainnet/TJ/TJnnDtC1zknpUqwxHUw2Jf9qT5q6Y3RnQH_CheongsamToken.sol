...
contract CheongsamToken is ERC20, ERC20Detailed{
    ...
    constructor(address _address) public ERC20Detailed("Cheongsam Token", "CHEONGSAM", 6){
        	owner = msg.sender;	
