...
contract TronEpunks is ITRC721 {
	...
	string public constant Tpunk_PROVENANCE = "B0FD57F9F8F64DFFADC5E5D6A53AF9A91866BE3E8C3E47260FACED43DCB93BE2";
    ...
    string internal nftName = "Epunks";
    string internal nftSymbol = "TEPunks";
    ...
    uint internal nftPrice = 10000000;
    ...
    function tokenURI(uint256 _tokenId) external view validNFToken(_tokenId) returns (string memory) {
        return string(abi.encodePacked("https://entertainerpunks.com/api/Epunks/", toString(_tokenId)));
    }
