...
contract TronXpress {
    ...
    address payable private dev_fund;
    ...
    constructor(address payable _owner, address payable _dev_fund, address payable _admin_fee, address payable _ad_fund) public {
        owner = _owner;
        dev_fund = _dev_fund;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        dev_fund.transfer(_amount * 4 / 100);
    ...
    function getdevFund() public view returns(address){
        require(msg.sender == owner);
        return dev_fund;
    }
