 ...
 * `TRC20` functions.
 */
contract NOTELINK is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("NOTELINK", "NOTEL", 6) {
        _mint(msg.sender, 770000000 * (10 ** uint256(decimals())));
    }
}
