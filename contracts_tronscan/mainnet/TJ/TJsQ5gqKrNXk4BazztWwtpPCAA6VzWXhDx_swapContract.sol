...
contract swapContract is AccessControl {
    ...
    function getOtherBlockchainAvailableByNum(uint128 blockchain)
        external
        view
        returns (bool)
    {
    ...
    function transferToUserWithoutFee(address user, uint256 amount)
        external
        onlyOwner
    {
    ...
    function transferToUserWithFee(
        ...
        require(
            !isProcessedTransaction(originalTxHash),
    ...
    function setFeeAmountOfBlockchain(uint128 blockchainNum, uint128 feeAmount)
        external
        onlyOwnerAndManager
    {
