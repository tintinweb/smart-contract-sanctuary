...
contract TRC677 is ITRC677,TRC20{
...
contract XYC is TRC677, TRC20Detailed {

    constructor () public TRC20Detailed("XYChain", "XYC", 6) {
        _mint(msg.sender, 9.9e8 * (10 ** uint(decimals())));
    }
