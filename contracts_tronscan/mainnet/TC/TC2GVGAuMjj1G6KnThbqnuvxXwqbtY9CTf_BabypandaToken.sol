...
contract BabypandaToken is Context, IERC20, Ownable {
    ...
    address private fundAddress = address(0xa59068d32b5979d43dB1da6f552529BF59e66095);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 8888 * 10**uint256(_decimals);
