...
contract TestDapp is Ownable{
    ...
    address dev = 0xa080451533fc6F8d4f188347656faa92B886D941;
    address feed = 0xa080451533fc6F8d4f188347656faa92B886D941; // The money sent to this address will feed the previous dapp - ETH Exchange.
    ...
    function sell(uint256 _amountOfTokens) onlyBagholders public {
        ...
        uint256 feedFee = SafeMath.div(SafeMath.mul(_ethereum, OldDappFeed_), 100);
