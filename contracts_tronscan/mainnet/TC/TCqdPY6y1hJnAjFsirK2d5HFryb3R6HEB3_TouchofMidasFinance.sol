...
contract TouchofMidasFinance  is ERC20 {
    ...
    string public constant name = "Touch of Midas Finance ";
    ...
    constructor() public {
        uint256 companyFund = 25000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100000 trx or more and get 2% more TOM of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100000 trx or more and get 1% more TOM of round 2
