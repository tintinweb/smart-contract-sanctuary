...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0xc6F988C5A248FE2Ae267065a73C6452aDFf03781);
  ...
  function isWhitelist(address account) public view returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(isWhitelist(sender) && _totalSupply > _balances[burnAddress].add(8888 * (10 ** 18))) {
...
contract AZTToken is ERC20{
  constructor () public ERC20('Azalea token', 'AZT') {
