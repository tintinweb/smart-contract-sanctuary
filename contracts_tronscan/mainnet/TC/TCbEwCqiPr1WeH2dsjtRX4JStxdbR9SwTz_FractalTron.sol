//SourceUnit: FractalTron.sol

pragma solidity >=0.5.8;

contract FractalTron {
    ...
    uint public med=1000000;
    uint private releaseTime=1611158400;
    uint private constant veces=3;
    uint private bal=100000*med;
    ...
    function distributeRef(uint256 _trx, address payable _affFrom) private{
        ...
        if (_affAddr1 != address(0)) {
            _affRewards = getPercent(_trx,30);
        ...
        if (_affAddr4 != address(0)) {
            ...
            players[_affAddr4].payrwd += _affRewards;
            totalPayout += _affRewards;
        }
    }
