...
contract TRC20 is Context, ITRC20 {
    ...
    function transferFrom(
        ...
        _approve(
            sender,
            _msgSender(),
            _allowances[sender][_msgSender()].sub(amount, 'TRC20: transfer amount exceeds allowance')
        );
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        _approve(
            _msgSender(),
            spender,
            _allowances[_msgSender()][spender].sub(subtractedValue, 'TRC20: decreased allowance below zero')
        );
        return true;
    }
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(
            account,
            _msgSender(),
            _allowances[account][_msgSender()].sub(amount, 'TRC20: burn amount exceeds allowance')
        );
    }
}

contract JDOG is TRC20, Ownable {
    constructor() TRC20("JDOG Token", "JDOG") {
