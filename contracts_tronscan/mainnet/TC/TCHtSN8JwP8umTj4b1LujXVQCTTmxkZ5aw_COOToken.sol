...
contract COOToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 19800 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'COO Token';
    string private _symbol = 'COO';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x915c3Ad6333025340e1Eb502b23C1c6d5e125110);
