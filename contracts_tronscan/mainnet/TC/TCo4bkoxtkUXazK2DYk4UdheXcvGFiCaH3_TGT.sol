...
contract TGT {
    ...
    function buy(address referrerAddress) external payable {
        ...
        require(msg.value == 5000 || msg.value == 100000 || msg.value == 200000 || msg.value == 500000
            || msg.value == 1000000 || msg.value == 5000000 || msg.value == 10000000 || msg.value == 100000000);
    ...
    function getAllProfitAmount(address user) public view returns (uint) {
        return
            getProfitFrom(user, 50000, 95) +
            getProfitFrom(user, 100000, 96) +
            getProfitFrom(user, 200000, 97) +
            getProfitFrom(user, 500000, 98) +
            getProfitFrom(user, 1000000, 99) +
            getProfitFrom(user, 5000000, 100) +
            getProfitFrom(user, 10000000, 101) +
            getProfitFrom(user, 100000000, 102);
    }
    ...
    function upgrade(address referrerAddress) external payable {
        require(msg.tokenid == tokenId);
        require(upgrades[msg.sender] == 0 && msg.tokenvalue == 50000000 ||
          upgrades[msg.sender] == 1 && msg.tokenvalue == 100000000 ||
          upgrades[msg.sender] == 2 && msg.tokenvalue == 300000000 ||
          upgrades[msg.sender] == 3 && msg.tokenvalue == 1000000000 ||
          upgrades[msg.sender] == 4 && msg.tokenvalue == 10000000000);
