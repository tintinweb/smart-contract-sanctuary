//SourceUnit: Opals-Tron.sol

pragma solidity 0.5.10;

/* Opals Tron - www.opalstron.io
...
contract OPALS is ERC20token, ERC677Token {
    string public name = "OPALS";
    ...
    constructor() public {
      owner = msg.sender;
	  _mint(owner, 6400000e6); //20% Pre-Mine to the owner...(It includes the airdrop, bounty and giveaways too...)
      _mint(marketing1, 3200000e6); //10% Pre-Mine to the marketing team...
    }
    ...
    function deposit(address payable _affAddr) public payable {
        ...
        numberOfTokens = depositAmount.div(2); // 0.50 OPALS for each TRX during the presale...
        }
        else{
        numberOfTokens = depositAmount.div(10); // 0.1 OPALS for each TRX after presale....
        }
  ...
  function getProfit(address _addr) public view returns (uint) {
   ...
   return collectProfit.add(player.interestProfit);
       ...
       function directSale(uint _amount) public payable {
        ...
        _mint(msg.sender, depositAmount.div(1)); // 1 OPALS for each TRX during the direct sale... But no divs...
        totalInvested = totalInvested.add(depositAmount);
