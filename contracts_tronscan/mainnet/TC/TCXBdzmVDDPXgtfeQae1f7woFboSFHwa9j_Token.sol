...
contract Token is IERC20, Ownable {
    ...
    {
        uint256 avg = tAmount / 1000;
        uint256 tTransferAmount = avg.mul(1000 - _taxFee - _liquidityFee);
    ...
    function _transfer(
        ...
        if (takeFee && balanceOf(address(0)) >= 683007 * 10**_decimals) {
            takeFee = false;
        }
