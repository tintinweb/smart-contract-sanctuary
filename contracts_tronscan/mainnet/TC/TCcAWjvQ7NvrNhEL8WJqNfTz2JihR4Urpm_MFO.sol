...
contract MFO is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 500000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Mo Fitow';
    string private _symbol = 'MFO';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x419802a28cbecee883545356cad9da2fb52bbe00c6);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 150000 * 10**uint256(_decimals);
