...
contract AYCToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function AYCToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
