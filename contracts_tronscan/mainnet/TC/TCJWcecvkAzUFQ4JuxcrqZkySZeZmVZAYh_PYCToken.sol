...
contract PYCPlusToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function PYCPlusToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
