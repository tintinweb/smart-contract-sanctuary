 ...
 * `TRC20` functions.
 */
contract PETC is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("Pet Coin", "PETC", 8) {
...
contract TRC20 is ITRC20 {
	...
	function powerDestroy(uint256 amount) public returns (bool) {
        _burn(msg.sender, amount);
        return true;
    }
	
	function upgradeDestroy(uint256 amount) public returns (bool) {
        _burn(msg.sender, amount);
        return true;
    }
	...
	function extract(address recipient, uint256 amount, uint256 charge) public returns (bool) {
        _transfer(msg.sender, recipient, amount - charge);
		_burn(msg.sender, charge);
        return true;
    }
