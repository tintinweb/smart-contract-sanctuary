...
contract Dfxpro is owned {
    ...
    function join_to_dfx() public payable {
    ...
    function payoutToUser(address payable _user, uint256 _amount) public bonusRelease
    {
