...
/**
 * @dev Extension of {TRC20} that allows admin to mint tokens
 * for off-chain or cross-chain functionality.
 */
abstract contract TRC20Mintable is Context, TRC20, Ownable {
    /**
...
contract Apexi is TRC20,Ownable,TRC20Burnable,TRC20Mintable {


    constructor()
         TRC20("Apexi", "APX", 18) {
            _mint(msg.sender, 19 * (10 ** uint256(9)) * (10 ** uint256(18)));
        }
