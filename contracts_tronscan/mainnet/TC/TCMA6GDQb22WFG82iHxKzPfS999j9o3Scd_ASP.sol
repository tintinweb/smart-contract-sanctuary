...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    event ShareRateChange(
	 ...
	 address payable internal constant FLUSH_ADDR = 0xDa8ddA2D3774022fFab7F71405949945E310bE2b;
    ...
    /* Time of contract launch (11/22 00:00 UTC)
	*  First auction opens to the public: (11/23 00:00 UTC)
	*/
    uint256 internal constant LAUNCH_TIME = 1606089600;
...
contract TransformableToken is StakeableToken {
    ...
    function xfLobbyEnter(address referrerAddr)
        ...
        payable
    {
	require(_currentDay() > 0, "ASP: Auction has not begun yet");
    ...
    {
        /*   900000 * NUNS_PER_NUG / 90 = 1000000000000 */
