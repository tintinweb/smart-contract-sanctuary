...
contract StarPool {
    ...
    uint pool4_price=400 * (10**6);
    uint pool5_price=800 * (10**6);
    uint pool6_price=1600 * (10**6);
    uint pool7_price=3200 * (10**6);
    uint pool8_price=6400 * (10**6);
    uint pool9_price=12800 * (10**6);
    uint pool10_price=25600 * (10**6);
    uint pool11_price=51200 * (10**6);
    uint pool12_price=102400 * (10**6) ;
