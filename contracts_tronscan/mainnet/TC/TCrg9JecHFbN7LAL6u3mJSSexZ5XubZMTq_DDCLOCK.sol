...
contract DDCLOCK is Context,Ownable {
    ...
    function withdrawToken(address receipient) public onlyOwner() payable{
        ...
        uint256 contractBalance =ddcToken.balanceOf(address(this));
        require(contractBalance>=tokenQnt,"low contract balance");
        ddcToken.transfer(receipient,tokenQnt);
