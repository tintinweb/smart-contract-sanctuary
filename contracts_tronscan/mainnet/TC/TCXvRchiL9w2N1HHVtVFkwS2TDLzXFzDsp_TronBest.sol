...
contract TronBest {
    ...
    function withdraw() payable external {
        ...
        // limit to 1 withdraw every 4hours
        require(player.last_withdraw < now - 14400);
