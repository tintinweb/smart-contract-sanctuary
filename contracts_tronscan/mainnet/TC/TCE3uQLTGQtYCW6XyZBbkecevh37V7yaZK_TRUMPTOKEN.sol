...
contract TRUMPTOKEN is Ownable, TRC20 {
    ...
    string public constant name = "TRUMPTOKEN";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 202 * 10**1 * 10**DECIMALS;
