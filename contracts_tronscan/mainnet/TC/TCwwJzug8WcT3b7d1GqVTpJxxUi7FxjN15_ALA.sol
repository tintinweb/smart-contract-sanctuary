...
contract ALA is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 7700 * 10**6;
    ...
    string private _symbol = 'ALA';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41E4B8D82206C4AF90B036B2A8AB62CAD08574AB5E);
