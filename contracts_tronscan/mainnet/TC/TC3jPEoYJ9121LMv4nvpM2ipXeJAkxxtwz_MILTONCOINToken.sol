...
contract MILTONCOINToken is owned {
    ...
    string constant private _name = "MILTON COIN";
    string constant private _symbol = "MTC";
    uint256 constant private _decimals = 6;
    uint256 private _totalSupply = 600000000 * (10**_decimals);         //60 million tokens
    uint256 constant public maxSupply = 600000000 * (10**_decimals);    //60 million tokens
