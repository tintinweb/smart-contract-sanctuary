...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0x41B191BF3792529A8D83DB0E6F19D95F0647E39CD8); // Stake Token address
...
contract HJGTRXLP is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public hjg = IERC20(0x41E66599FD919B2FAAA1E5A2B0AB3FDA1F8EC597A6);
    
    uint256 public constant DURATION = 365 days; 

    uint256 public starttime = 1629907200;
    ...
    function getReward() public updateReward(msg.sender)  checkStart{
        ...
        if (reward > 0) {
            ...
            safeHJGTransfer(msg.sender, reward); 
            ...
            if(referralRelationships[msg.sender]!=address(0))
            {
                ...
                safeHJGTransfer(referrer, referrerFee); 
    ...
    function safeHJGTransfer(address _to, uint256 _amount) internal {
        uint256 hjgBalance = hjg.balanceOf(address(this));
        if(_amount > hjgBalance) {
            hjg.safeTransfer(_to, hjgBalance);
        } else {
            hjg.safeTransfer(_to, _amount);
        }
