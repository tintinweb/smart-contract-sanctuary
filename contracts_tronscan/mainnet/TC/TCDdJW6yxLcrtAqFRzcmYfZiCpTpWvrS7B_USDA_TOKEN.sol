...
/*
 *
 *   USDA TOKEN | USDA COIN MINING
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://usda.to                                            │
 *   │                                                                       │
 *   │   Contract Address: TCDdJW6yxLcrtAqFRzcmYfZiCpTpWvrS7B                │
 *   |   E-mail: contact@usda.to                                             |
 *   └───────────────────────────────────────────────────────────────────────┘
 */
...
contract USDA_TOKEN is StandardToken {
    string public name = "USDA Exchangeable Coin";
    string public symbol = "USDA";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 9000000000000 * 10 ** uint256(decimals);
