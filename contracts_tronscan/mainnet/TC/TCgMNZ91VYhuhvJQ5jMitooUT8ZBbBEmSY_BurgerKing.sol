...
/**
 * @title BurgerKing ERC20 token
 * @dev  
 *      The goal of BurgerKing is to maintain a stable price of 1$.
 *      Based on the Ampleforth protocol.
 */
contract BurgerKing is ERC20Detailed, Ownable {
    ...
    constructor()
        ERC20Detailed("Burger King", "BK", uint8(DECIMALS))
        public
    {
