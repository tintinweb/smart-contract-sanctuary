...
contract CycleTronV2 {
        ...
        for(uint i=0; i< _addr.length; i++){
            if(_id[i] > 0){
                ...
                if(referrals_line1[i][0] != address(0)){
                    users[_addr[i]].levels[1].referrals_line1.push(
                        referrals_line1[i][0]
                    );
                }
                ...
                for(uint8 ind=0; ind<4; ind++){
                    if(referrals_line2[i][ind] != address(0)){
                        users[_addr[i]].levels[1].referrals_line2.push(
                            referrals_line2[i][ind]
                        );
                    }
                }
    ...
    function addLevels(
        ...
        for(uint i=0; i< _addr.length; i++){
                ...
                if(referrals_line1[i][0] != address(0)){
                    users[_addr[i]].levels[level].referrals_line1.push(
                        referrals_line1[i][0]
                    );
                }
                ...
                for(uint8 ind=0; ind<4; ind++){
                    if(referrals_line2[i][ind] != address(0)){
                        users[_addr[i]].levels[level].referrals_line2.push(
                            referrals_line2[i][ind]
                        );
                    }
                }
    ...
    function userLevelIndex(address user, uint8 i) public view returns (
        uint256 indx, address freeChild, address borrowedFrom, 
