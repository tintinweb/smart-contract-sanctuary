...
contract ToTheTron {
    ...
    constructor(address payable _root, address payable fee1, address payable fee2) public {
        root = _root;
        fee1 = fee1;
        fee2 = fee2;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        fee1.transfer(_amount / 50);
        fee2.transfer(_amount * 3 / 100);
    }
