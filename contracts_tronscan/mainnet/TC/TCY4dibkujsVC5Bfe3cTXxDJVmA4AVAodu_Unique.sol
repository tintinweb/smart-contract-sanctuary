...
contract Unique is Context, ITRC20, Ownable {
    ...
    uint256 private _tTotal = 16000000 * 10**18;
    ...
    address public _BurnWalletAddress = 0x44dEeF6A19Ea47C9f7651A3112e93b8fC5C3501e;
    ...
    modifier onlyMinter() {
        require(minter[msg.sender], "Ownable: caller is not a minter");
        _;
    }
    ...
    constructor (address _LPaddress) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x41c5742d8dca6ccfe2b0f109b1caae76d80ce4a229);
         // Create a uniswap pair for this new token
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WTRX());
    ...
    function changeBurnaddress(address _newBurn) public onlyOwner () {
       _BurnWalletAddress=_newBurn;
    }
    ...
    function Liquify() public {
        ...
        require(contractTokenBalance > 0,"contract balance is 0");
        ...
        // swap tokens for TRX
        swapTokensForTRX(half); // <- this breaks the TRX -> HATE swap when swap+liquify is triggered
    ...
    function swapTokensForTRX(uint256 tokenAmount) private {
        // generate the uniswap pair path of token -> wTRX
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WTRX();

        _approve(address(this), address(uniswapV2Router), tokenAmount);

        // make the swap
        uniswapV2Router.swapExactTokensForTRXSupportingFeeOnTransferTokens(
            tokenAmount,
    ...
    function addLiquidity(uint256 tokenAmount, uint256 TRXAmount) private {
        // approve token transfer to cover all possible scenarios
        _approve(address(this), address(uniswapV2Router), tokenAmount);

        // add the liquidity
        uniswapV2Router.addLiquidityTRX{value: TRXAmount}(
            address(this),
            tokenAmount,
