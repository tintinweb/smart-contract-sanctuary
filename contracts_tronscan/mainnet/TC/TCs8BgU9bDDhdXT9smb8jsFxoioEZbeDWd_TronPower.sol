...
contract TronPower {
	...
	uint256 constant public CONTRACT_BALANCE_STEP = 5000 trx;
	uint256 constant public TIME_STEP = 1 days;
	uint256 constant public BASE_PERCENT = 120;  // 12%
	uint256 constant public MARKETING_FEE = 100; 
	uint256 constant public PROJECT_FEE = 50;   
	uint256[] public REFERRAL_PERCENTS = [200, 50, 50, 50, 50]; // 20%, 5%, 5%, 5%, 5%
