...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 2100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'XHL';
    string private _symbol = 'XHL';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0xe452fb702171069AbE5590A7bb478196fE81390E);
