...
contract _SwapDollar is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('SwapDollar', 'SUDT', 18) public {
...
contract SwapDollar is Ownable,_SwapDollar
{
      using SafeMath for uint256;
   constructor() public{
   }
