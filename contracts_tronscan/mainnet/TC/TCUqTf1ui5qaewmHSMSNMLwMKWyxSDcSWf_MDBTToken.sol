...
contract MDBTToken is Ownable,TRC20,TRC20Detailed,TRC20Burnable,TRC20Pausable {
    using SafeMath for uint256;

    //9999999
    constructor(uint256 totalSupply) TRC20Detailed("Meta Data Business Token", "MDBT", 10) public {
        _mint(msg.sender, totalSupply.mul(uint256(10000000000)));
    }
