...
contract Done is LockBox{
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        require(balanceOf[_from] - balanceFrozen(msg.sender) >= _value, "fondos insuficientes por congelaci�n");
...
contract DONE is owned, Done {
    ...
    ) Done(initialSupply, tokenName, tokenSymbol) public {}
    ...
    function freezeDONE(uint _value, uint _unlockTime) public {
        require(ids[msg.sender]);
        require(balanceOf[msg.sender] >= _value);
