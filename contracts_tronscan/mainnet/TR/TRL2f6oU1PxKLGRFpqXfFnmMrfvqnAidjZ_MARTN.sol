...
contract MARTN is Context, ITRC20, Ownable {
    ...
    uint256 private constant _tTotal = 168 * 10**6 * 10**18;
    ...
    uint256 public numTokensSellToAddToLiquidity = 84* 10**2 * 10**18;

    string private constant _name = 'MARTN'; 
