...
contract HACToken is PausableToken {
    string  public  constant name = "Health and Culture";
    ...
    function HACToken(address _admin, uint _totalTokenAmount) public
    {
        admin = _admin;
        totalSupply = _totalTokenAmount;
        balances[msg.sender] = _totalTokenAmount;
        Transfer(address(0), msg.sender, _totalTokenAmount);
    }
