...
/*
Website: https://trondeposit.com
Telegram: https://t.me/trondepositcom
Telegram Owner: https://t.me/trondepositadmin

From 7.07% to 34.67% Daily ROI
Deposit Period: 3-30 Days
23% 3lvl Referral Rewards
...
contract TronDeposit {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(3, 104));
		tarifs.push(Tarif(4, 108));
		tarifs.push(Tarif(5, 112));
		tarifs.push(Tarif(6, 116));
		tarifs.push(Tarif(7, 120));
        tarifs.push(Tarif(8, 124));
        tarifs.push(Tarif(9, 128));
        tarifs.push(Tarif(10, 132));
        tarifs.push(Tarif(11, 136));
        tarifs.push(Tarif(12, 140));
        tarifs.push(Tarif(13, 144));
        tarifs.push(Tarif(14, 148));
        tarifs.push(Tarif(15, 152));
        tarifs.push(Tarif(16, 156));
        tarifs.push(Tarif(17, 160));
        tarifs.push(Tarif(18, 164));
        tarifs.push(Tarif(19, 168));
        tarifs.push(Tarif(20, 172));
        tarifs.push(Tarif(21, 176));
        tarifs.push(Tarif(22, 180));
        tarifs.push(Tarif(23, 184));
        tarifs.push(Tarif(24, 188));
        tarifs.push(Tarif(25, 192));
        tarifs.push(Tarif(26, 196));
        tarifs.push(Tarif(27, 200));
        tarifs.push(Tarif(28, 204));
        tarifs.push(Tarif(29, 208));
        tarifs.push(Tarif(30, 212));
