...
contract SmartMillionsLottery {
    ...
    event LotteryEntered(uint256 _lotteryId, address _entryAddress, string indexed ticketHash, uint256 entryId);
    event LotteryWinner(uint256 _lotteryId, address _lotteryWinner, string indexed ticketHash, uint256 entryId);
    event LotteryCreated(uint256 _lotteryId);
    event LotteryCanceled(uint256 _lotteryId);
    event LotteryFinalized(uint256 _lotteryId, string indexed ticketHash);
