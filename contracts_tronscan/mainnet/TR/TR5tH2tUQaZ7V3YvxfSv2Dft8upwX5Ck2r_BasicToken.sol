...
contract CloudChian is StandardToken{
string public constant name = "CloudChian"; // solium-disable-line uppercase
string public constant symbol = "CCC"; // solium-disable-line uppercase
uint8 public constant decimals = 6; // solium-disable-line uppercase
uint256 public constant INITIAL_SUPPLY = 50000000e6; //这里是发行总量 * 精度


/**
* @dev Constructor that gives msg.sender all of existing tokens.
*/
constructor() CloudChian() public {
