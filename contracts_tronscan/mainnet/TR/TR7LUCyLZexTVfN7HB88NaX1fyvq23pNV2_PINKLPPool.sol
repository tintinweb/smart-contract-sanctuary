...
contract LPTokenWrapper {
    ...
    IERC20 public lpToken = IERC20(0x41458b36fd12becb5f12d24dd066f1a85162da8dbe);
...
contract PINKLPPool is LPTokenWrapper, IRewardDistributionRecipient, DateWrapper {
    ...
    function getApy() public view returns(uint256 _apy) {
        if(totalSupply() > 0 && rewardRate > 0) {
            _apy = rewardRate.mul(1 days).mul(365).mul(1e6).div(totalSupply());
        }
    }
