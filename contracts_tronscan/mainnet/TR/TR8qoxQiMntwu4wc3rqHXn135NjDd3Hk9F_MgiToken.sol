...
contract MgiToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function MgiToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
