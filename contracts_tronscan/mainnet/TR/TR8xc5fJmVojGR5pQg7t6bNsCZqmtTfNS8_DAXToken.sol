...
contract DAXToken is Context, ITRC20, Ownable {
    ...
    string private _name = 'DAX';
    string private _symbol = 'DAX';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 7143 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 4143 * 10**uint256(_decimals);
