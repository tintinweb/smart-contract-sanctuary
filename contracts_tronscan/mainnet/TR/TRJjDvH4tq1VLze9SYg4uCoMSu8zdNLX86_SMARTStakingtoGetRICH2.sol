...
//SourceUnit: SMARTStakingtoGetRICH2.sol
...
contract SMARTStakingtoGetRICH2 is ReentrancyGuard {
    ...
    function createNewStake(uint256 id, uint256 smart) private {
        ...
        stakers[id].finishStake = startStake.add(oneYearToSeconds);
    ...
    function addNewStake(uint256 stakeAmount) public returns (bool, uint256) {
        ...
        uint256 stakeAmountInDecimal = stakeAmount;
        ...
        uint256 maxAmount = 1000000000000000000;

        require(stakeAmountInDecimal >= minAmount, "Value min 0.001 Smart");
        require(stakeAmountInDecimal <= maxAmount, "Value max 1 Smart");
