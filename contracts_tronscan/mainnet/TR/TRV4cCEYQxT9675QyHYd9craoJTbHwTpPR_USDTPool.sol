...
contract Pool is AdminRemedy {
    ...
    ITRC20 public liquorContract = ITRC20(0x41499E922079D0B4CC83F6E289C6C3812E210EE031); // TXvLsjHxtwXD3fJaLYF86NvWvUZtNNdqy1
...
contract USDTPool is Pool {
    constructor() public Pool(address(0x41A614F803B6FD780986A42C78EC9C7F77E6DED13C), 6250*10**14, true, 1599724800, 1e8, 9 seconds, 28800) {}
}
