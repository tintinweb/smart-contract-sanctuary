...
contract DappToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("DAPP TOKEN", "DAPP", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 30000000 * 10 ** 18);
    }
}
