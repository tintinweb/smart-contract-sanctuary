...
contract TronWorld {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(10, 150, 100000000)); // 15%
        tarifs.push(Tarif(15, 250, 500000000)); // 16.6%
        tarifs.push(Tarif(20, 350, 1000000000));// 17.6%
        ref_bonuses.push(7);
        ref_bonuses.push(3);
        ref_bonuses.push(1);
    }
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= tarifs[_tarif].minimum, "Zero amount");

        Player storage player = players[msg.sender];

        require(player.deposits.length < 250, "Max 250 deposits per address");
