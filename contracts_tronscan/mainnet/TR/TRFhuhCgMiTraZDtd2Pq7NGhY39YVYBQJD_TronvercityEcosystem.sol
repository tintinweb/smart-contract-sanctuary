...
* |                                                                       |
* |                                                                       |
* | Audit Conclusion (ENG): https://tronvercity.com/audit_eng.pdf         |
* └───────────────────────────────────────────────────────────────────────┘
*
* [USAGE INSTRUCTION]
*
...
*
* - Basic interest rate: +1% every 24 hours (+0.041% hourly)
* - Personal hold-bonus: +0.3% for every 24 hours without withdrawal
* - Contract turnover bonus: +0.3% for every 1,000,000 TRX of Total Turnover (deposited + withdrawn) of smart-contract
...
* - Certificate of incorporation: https://tronvercity.com/img/cert.pdf
*
* [SMART-CONTRACT AUDITION AND SAFETY]
*
* - Audited by independent company Telescr.in (https://telescr.in)
* - Audition certificate: https://tronvercity.com/audit.pdf & on Auditor Website
*
*/

pragma solidity 0.5.10;

contract TronvercityEcosystem {
    ...
    uint256 constant public MAX_BLOCK_TIME = 3 days;
    ...
    function getContractRate() public view returns (uint256) {
        ...
        return BASE_PERCENT.add(contractPercent.mul(30));
    }
    ...
    function getUserPercentRate(address userAddress) public view returns (uint256) {
        ...
        if (isActive(userAddress)) {
            uint256 timeMultiplier = (now.sub(user.checkpoint)).div(TIME_STEP).mul(30);
