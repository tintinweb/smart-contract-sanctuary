...
contract TronMax {
    ...
    uint256 private constant TRONMAX_FEE         = 10; 
    uint256 private constant DAILY_HOLDBONUS      = 1E9;
    uint256 private constant MAX_HOLDBONUS        = 5E9;
    uint256 private constant DEFAULT_PLANBONUS    = 1E10; // 10%
    uint256 private constant MIN_PLANBONUS        = 2E9;
    uint256 private constant PENALTY_PLANBONUS    = 5E9;
    uint256 private constant MIN_INVEST           = 1E8;         
    uint256 private constant MAX_PLANPROFIT       = 240;
    uint256 private constant CONTRACT_TIMETOSTART = 23 * 3520;
    ...
    function payTronMaxFee(uint256 val) private {
        uint256 amount = (val * (TRONMAX_FEE + (MAX_HOLDBONUS / DAILY_HOLDBONUS))) / 1e2;
