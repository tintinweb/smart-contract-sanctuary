...
contract FSToken is StandardToken {
    function () public payable {
        revert();
    }

    string public name = "Financial supermarket";
    uint8 public decimals = 8;
    string public symbol = "FS";
    uint256 public totalSupply = 39999*10**uint256(decimals);
