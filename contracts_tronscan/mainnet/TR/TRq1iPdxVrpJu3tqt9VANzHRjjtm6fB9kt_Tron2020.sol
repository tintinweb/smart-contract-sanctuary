...
contract Tron2020 {
    ...
    constructor(address _stakingAddress) public {
        ...
        tarifs.push(Tarif(365, 730,50000000));
        tarifs.push(Tarif(50, 200,50000000));
        tarifs.push(Tarif(30, 150,50000000));
        tarifs.push(Tarif(20, 140,50000000));
        tarifs.push(Tarif(15, 120,50000000));
