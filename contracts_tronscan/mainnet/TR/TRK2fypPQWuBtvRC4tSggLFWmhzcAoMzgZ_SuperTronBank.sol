//SourceUnit: SuperTronBank.sol

pragma solidity ^0.4.25;

contract SuperTronBank {
  struct Tariff {
    uint time;
    uint percent;
  }
  ...
  constructor() public {
    tariffs.push(Tariff(200 * 28800, 900));
    tariffs.push(Tariff(46 * 28800, 253));
    tariffs.push(Tariff(26 * 28800, 169));
    tariffs.push(Tariff(18 * 28800, 135));
