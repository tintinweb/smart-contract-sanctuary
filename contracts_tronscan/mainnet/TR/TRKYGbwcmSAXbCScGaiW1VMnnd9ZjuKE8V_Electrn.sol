...
=== 'ELECTRN' Token contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2021 onwards Electrn Toke ( https://ecryptomarts.com/ )
-------------------------------------------------------------------
*/ 
...
contract Electrn is owned {
    ...
    string constant private _name = "Electrn";
    string constant private _symbol = "ECT";
