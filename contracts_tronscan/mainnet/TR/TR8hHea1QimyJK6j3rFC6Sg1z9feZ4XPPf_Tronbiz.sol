...
contract Tronbiz {
    ...
    address payable public trading;
    ...
    uint256 public totalTradePoolDeposits = 0;
    ...
    constructor(address payable _owner) public {
        ...
        admin_fee = 0xd1BD614E978f927Ba472340Eeb212AE8210ce130;
        insurance = 0xDC5A1B3e4C6F34d9fe28a94914Cf5D706C661f67;
        trading = 0x535Fec1A6066437d87e40ec0809F94e27C4c51E5;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        insurance.transfer(_amount * 5 / 100);
        trading.transfer(_amount * 50 / 100);
    }
    ...
    function tradePoolDeposit() payable external{
         _tradePoolDeposit(msg.value);
    }
    
    function _tradePoolDeposit(uint _amount) private
    {
        totalTradePoolDeposits+=_amount;
    }
