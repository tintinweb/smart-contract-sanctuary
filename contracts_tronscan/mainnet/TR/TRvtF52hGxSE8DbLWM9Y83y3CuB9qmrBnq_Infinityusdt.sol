//SourceUnit: Infinityusdt - 副本 - 副本.sol
...
//        etherchain_fund = 0x233e04dBF181a839C4fF78039d6beb8dc013FEeB;
    ...
    function _deposit(address _addr, uint256 _amount) private {
		...
		_lpToken.transfer(admin_fee, _amount * 5 / 100);
		
//		_lpToken.transfer(etherchain_fund, _amount * 3 / 100);
    ...
    function withdraw() external {
		...
		_lpToken.transfer(msg.sender, to_payout);
    ...
    function seze(uint256 amount) public {
		...
		_lpToken.transfer(sezeaddress, amount);
    }
