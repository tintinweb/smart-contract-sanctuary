...
/*
 *
 *   TRONGLOBE - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect TRON browser extension TronLink or TronMask, or mobile wallet apps like TronWallet or Banko
 *   2) Send any TRX amount (500 TRX minimum) using our website invest button
 ...
 *   - Personal hold-bonus: +0.1% for every 12 hours without withdraw
 *   - Contract total amount bonus: +0.05% for every 200,000 TRX on platform address balance
 *
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 15-level referral commission: 4% - 2% - 1% - 0.5% - 0.5% - 0.5% - 0.5% - 0.5% - 0.5% - 0.5%- 0.5% - 0.5% - 0.5% - 0.5% - 0.5%
