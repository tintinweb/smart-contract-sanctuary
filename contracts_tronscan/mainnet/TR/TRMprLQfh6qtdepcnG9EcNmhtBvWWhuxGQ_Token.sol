...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10000000000000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'epp Token';
    string private _symbol = 'epp ';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x4104171DC6190996CD6A0CD09403C954C36D99CD70);
