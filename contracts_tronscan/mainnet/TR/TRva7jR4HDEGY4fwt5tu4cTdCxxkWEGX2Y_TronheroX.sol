...
* TRONHEROX!
* 
*THE ONLY ONE 100% SAFE SMART CONTRACT ON TRON BLOCKCHAIN
* 
*REFERRAL REWARDS 5% +4% +1%     
* 
* Get 204% of Your Investment
* 
* 
* 
*/
...
contract TronheroX {
    ...
    constructor() public {
     ...
     tarifs.push(Tarif(120,204,10000000));
     ref_bonuses.push(5);
     ref_bonuses.push(4);
     ref_bonuses.push(1);
    }
  ...
  function Invest(address user) external payable {
