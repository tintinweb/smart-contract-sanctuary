...
contract CRSToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 118000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = 'CRS TOKEN';
    string private _symbol = 'CRS';
    uint8 private _decimals = 8;

    address private _burnPool = address(0x411A30EEE30D92BC1F3F41ECDB2DED5A127D60C9E2);

    address private fundAddress = address(0x419A609BA4984A44A9A3140A86D0115C3445AF5F64);
