...
contract TronQuest {
	...
	constructor(address payable devAddr, address payable projectAddr, uint256 start) public {
		require(devAddr != address(0) && projectAddr != address(0));
		devAddress = devAddr;
