...
// ----------------------------------------------------------------------------
// CryptoStake Token (CSX) Token
//

// Symbol         : CSX
// Name           : CryptoStake Token
// Total supply   : 21,00,000
// Decimals       : 6
// https://www.cryptostake.uk/
//
// ----------------------------------------------------------------------------
...
// ------------------------------------------------------------------------
contract CryptoStakeToken is ITRC20{
    string public name = "CryptoStake Token";
    ...
    function recoverLostTrx() public {
        require(msg.sender == founder, "onlyFounder");
