...
contract TRC20Detailed is BaseTRC20 {
    ...
    constructor (string memory name, string memory symbol, uint8 decimals) public BaseTRC20() {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
    }
...
contract WEWIN is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("WEWIN", "WEWIN", 6){
        require(gr != address(0), "invalid gr");
        _mint(gr, 210000000 * 10 ** 6);
    }
}