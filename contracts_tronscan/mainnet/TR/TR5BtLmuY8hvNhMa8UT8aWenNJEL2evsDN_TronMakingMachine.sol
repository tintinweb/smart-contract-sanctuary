...
Symbol          : TMM
Name            : Tron Making Machine
Total supply    : 50,00000
Decimals        : 6
...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "Tron Making Machine"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "TMM".
   */
...
contract TronMakingMachine is CommonToken {

  constructor() CommonToken("Tron Making Machine", "TMM", 6, 5000000) public {}
