...
//TRON FUTURES
//Earn 3% - 5% per day upto 300%
//Join telegram group - t.me/tronfuturesglobal
...
contract TronFutures is Ownable {
    ...
    function setDeveloper(address payable _newDevAccount) public {
       require(_newDevAccount != address(0));
        developer = _newDevAccount;
    }
    function setMarketing(address payable _newMarketingAccount) public {
