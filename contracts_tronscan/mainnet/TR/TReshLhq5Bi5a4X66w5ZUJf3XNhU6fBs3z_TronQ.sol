 ...
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://TronQ.io                                           │
 *   │   Email  : contact@tronq.io                                           │
 *   └───────────────────────────────────────────────────────────────────────┘
 *      
 *      
 *
...
contract TronQ is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 50;
    uint256 public constant MARKETING_RATE = 50;
    uint256 public constant REFERENCE_RATE = 120;
    ...
    uint256 public constant PLAN_INTEREST = 50;
