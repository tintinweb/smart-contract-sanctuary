...
contract MINERToken is StandardToken {
    function () public payable {
        revert();
    }

    string public name = "Mining Token";
    uint8 public decimals = 18;
    string public symbol = "MINER";
    uint256 public totalSupply = 102400000000*10**uint256(decimals);
