//SourceUnit: MoonWalker.sol

/*

#MoonWalker
✔️ NFT Competitions
✔️ MoonWalker Tracker
...
🔥 50% of the supply is burned already
...
pragma solidity ^0.4.25;
	...
	*/
	contract MoonWalker is ERC20Interface, SafeMath {
		...
		constructor() public {
        	symbol = "MWK";
			name = "MoonWalker Token";
			decimals = 8;
			_totalSupply = 1000000000000000000000000000000000 ;
			balances[0x606e873a1f8C7F5dfb4985C96dF2e7303899402b] = _totalSupply;
			emit Transfer(address(0), 0x606e873a1f8C7F5dfb4985C96dF2e7303899402b, _totalSupply);
		}
