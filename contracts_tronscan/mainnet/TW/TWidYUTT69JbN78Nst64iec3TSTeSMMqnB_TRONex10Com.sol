//SourceUnit: tronex10.sol

/*
 *
 *   TRONex10.COM - investment platform based on TRON smart-contract.
 *   Verified, audited, safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://tronex10.com                                       │
 *   │                                                                       │
 *   │   Telegram Live Support: https://t.me/tronex10                        |
 *   │   Telegram Public Group: @tronex10                                    |
 *   │   Telegram News Channel: @tronex10                                    |
 *   |                                                                       |
 *   |   Twitter: twitter.com/tronex10                                       |
 *   |   YouTube: youtube.com/channel/tronex10                               |
 *   |   Instagram: instagram.com/tronex10                                   |
 *   |   E-mail: admin@tronex10.com                                          |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *
 *   - Basic interest rate: +10% every 24 hours (+0.4166% hourly).
 *   - Personal hold-bonus: +1% for every 12 hours without withdraw.
 *
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral commission: 25% - 10% - 5% - 2% - 1%.
 *   - Auto-refback function.
 *
 *   [FUNDS DISTRIBUTION]
 *
 *   - 90% Platform main balance, participants payouts, Affiliate Program Bonuses.
 ...
 *   - Certificate of incorporation: https://tronex10.com/img/certificate.pdf
 *
 *   [SMART-CONTRACT AUDITION AND SAFETY]
 *
 *   - Audited by independent company GROX Solutions (Webiste: https://grox.solutions)
 *   - Audition certificate: https://tronex10.com/files/audit_en.pdf
 *
 */

pragma solidity 0.5.10;

contract TRONex10Com {
    ...
    uint[] public REFERRAL_PERCENTS = [2500, 1000, 500, 200, 100];
    ...
    function getUserPercentRate(address userAddress) public view returns (uint) {
        ...
        if (isActive(userAddress)) {
            uint timeMultiplier = (block.timestamp.sub(uint(user.checkpoint))).div(TIME_STEP.div(2)).mul(100);
