//SourceUnit: TronMultiplier12.sol

pragma solidity 0.5.9;

contract TronMultiplier12Hour {
    ...
    function withdraw() payable external {
        Player storage player = players[msg.sender];
        require(uint256(block.timestamp) > player.last_withdrawal,"Countdown is running");
        _payout(msg.sender);
