//SourceUnit: DigiLotto100.sol

pragma solidity 0.5.9;

contract DigiLotto_V2 {
...
function DirectBet2D(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betqty) public payable {
        ...
        betList2D[currBet2DID] = msg.sender;
		betDetail2D[currBet2DID] = betStruct;			
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet2DID, "2D", currBetNumber, currBetQuantity, currBetQuantity * singlebet_price , true, false, false, false, now);
...
function DirectBet3D(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betqty) public payable {
        ...
        betList3D[currBet3DID] = msg.sender;
		betDetail3D[currBet3DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet3DID, "3D", currBetNumber, currBetQuantity, currBetQuantity * singlebet_price , true, false, false, false, now);
...
function DirectBet4D(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betnumber4, uint _betqty) public payable {
        ...
        betList4D[currBet4DID] = msg.sender;
		betDetail4D[currBet4DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet4DID, "4D", currBetNumber, currBetQuantity, currBetQuantity * singlebet_price , true, false, false, false, now);
...
function RollFrontBet2D(uint _drawnumber, uint _betnumber1, uint _betqty) public payable {
        ...
        betList2D[currBet2DID] = msg.sender;
		betDetail2D[currBet2DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet2DID, "2D", currBetNumber, currBetQuantity, currBetQuantity * 10 * singlebet_price , false, false, true, false, now);
...
function RollFrontBet3D(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betqty) public payable {
        ...
        betList3D[currBet3DID] = msg.sender;
		betDetail3D[currBet3DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet3DID, "3D", currBetNumber, currBetQuantity, currBetQuantity * 10 * singlebet_price , false, false, true, false, now);
...
function RollFrontBet4D(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betqty) public payable {
        ...
        betList4D[currBet4DID] = msg.sender;
		betDetail4D[currBet4DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet4DID, "4D", currBetNumber, currBetQuantity, currBetQuantity * 10 * singlebet_price , false, false, true, false, now);
...
function RollBackBet2D(uint _drawnumber, uint _betnumber1, uint _betqty) public payable {
        ...
        betList2D[currBet2DID] = msg.sender;
		betDetail2D[currBet2DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet2DID, "2D", currBetNumber, currBetQuantity, currBetQuantity * 10 * singlebet_price , false, false, false, true, now);
...
function RollBackBet3D(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betqty) public payable {
        ...
        betList3D[currBet3DID] = msg.sender;
		betDetail3D[currBet3DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet3DID, "3D", currBetNumber, currBetQuantity, currBetQuantity * 10 * singlebet_price , false, false, false, true, now);
...
function RollBackBet4D(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betqty) public payable {
        ...
        betList4D[currBet4DID] = msg.sender;
		betDetail4D[currBet4DID] = betStruct;				
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet4DID, "4D", currBetNumber, currBetQuantity, currBetQuantity * 10 * singlebet_price , false, false, false, true, now);
...
function PermutationBet3D_3(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betqty) public payable {
		...
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet3DID, "3D", currBetNumber, currBetQuantity, currBetQuantity * 3 * singlebet_price , false, true, false, false, now);
		sendBalance(currBetUserID);
}
...
function PermutationBet3D_6(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betqty) public payable {
		...
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet3DID, "3D", currBetNumber, currBetQuantity, currBetQuantity * 6 * singlebet_price , false, true, false, false, now);
		sendBalance(currBetUserID);
}
...
function PermutationBet4D_4(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betnumber4, uint _betqty) public payable {
		...
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet4DID, "4D", currBetNumber, currBetQuantity, currBetQuantity * 4 * singlebet_price , false, true, false, false, now);
		sendBalance(currBetUserID);
}
...
function PermutationBet4D_6(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betnumber4, uint _betqty) public payable {
		...
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet4DID, "4D", currBetNumber, currBetQuantity, currBetQuantity * 6 * singlebet_price , false, true, false, false, now);
		sendBalance(currBetUserID);
}
...
function PermutationBet4D_12(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betnumber4, uint _betqty) public payable {
		...
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet4DID, "4D", currBetNumber, currBetQuantity, currBetQuantity * 12 * singlebet_price , false, true, false, false, now);
		sendBalance(currBetUserID);
}
...
function PermutationBet4D_24(uint _drawnumber, uint _betnumber1, uint _betnumber2, uint _betnumber3, uint _betnumber4, uint _betqty) public payable {
		...
		emit addbet(msg.sender, currBetUserID, currBetDrawNumber, currBet4DID, "4D", currBetNumber, currBetQuantity, currBetQuantity * 24 * singlebet_price , false, true, false, false, now);
		sendBalance(currBetUserID);
}
