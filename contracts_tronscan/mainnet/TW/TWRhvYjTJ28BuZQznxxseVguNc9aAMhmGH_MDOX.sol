 ...
 * 
 * Provides information on the current execution context, including the
...
contract ERC20 is Context, TRC20 {
    ...
    uint256 private _totalSupply = 50000 * (10 ** 8);
...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    uint256 internal constant LAUNCH_TIME = 1609981200;
					    
					    

    /* Start of claim phase */
    uint256 internal constant PRE_CLAIM_DAYS = 1;
    /* reduce amount of tokens to 5000 */
    uint256 internal constant CLAIM_STARTING_AMOUNT = 5000 * (10 ** 8);
    /* reduce amount of tokens to 1000 */
    uint256 internal constant CLAIM_LOWEST_AMOUNT = 1000 * (10 ** 8);
