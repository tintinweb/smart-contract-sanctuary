...
contract LRB is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 38888 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'little Raccoon';
    string private _symbol = 'LRB';
    uint8 private _decimals = 4;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x410DCD2068903281DE3E8F6EA2282007F1382F779E);
