...
contract ERC20 is IERC20 {
    ...
    uint256 private _sayNo = 888 * 10000 * 1000000 ; //Can't burn ROC Is 10% of the totalSupply
 ...
 * `ERC20` functions.
 */
contract GC is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("GC", "GC", 6) {
        _mint(msg.sender, 8888 * 10000 * 1000000 );
    }
}
