...
contract TRONtopia_Dividend_Pool is owned{
    ...
    */
    function updateContractAddresses(address _topiaTokenContractAddress, address _refPoolContractAddress, address _leaderBoardContractAddress, address _voucherContractAddress, address _topiaFreezingContractAddress ) public onlyOwner returns(string){
