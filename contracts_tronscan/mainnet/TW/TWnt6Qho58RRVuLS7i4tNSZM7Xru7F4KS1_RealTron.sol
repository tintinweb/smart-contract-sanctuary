...
contract RealTron {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(100, 95));//Will be multiplied by 4 beacuse of uint8 limitations
        tarifs.push(Tarif(100, 120));
        tarifs.push(Tarif(100, 145));
        ...
        for(uint256 i = 0; i < player.deposits.length; i++) {
            ...
            if(from < to) {
                    ...
                    if(player.total_invested<1000e7){
                        value += dep.amount * (to - from) * 95 * 4 / tarif.life_days / 8640000;
                    }
                    if(player.total_invested>=1000e7){
                        value += dep.amount * (to - from) * 120 * 4 / tarif.life_days / 8640000;
                    }
                    if(player.total_invested>=10000e7){
                        value += dep.amount * (to - from) * 25 * 4 / tarif.life_days / 8640000; // (120+25)*4/100= 5.8%
                    }
            }
        }
