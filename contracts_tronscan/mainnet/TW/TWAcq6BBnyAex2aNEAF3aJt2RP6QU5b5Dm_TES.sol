 ...
 * `ERC20` functions.
 */
contract TES is ERC20, ERC20Detailed {
    ...
    constructor() public ERC20Detailed("Telephone exchange system", "TES", 8) {
        _owner = msg.sender;
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "TES: Caller is not the owner");
        _;
    }
    ...
    function issue() public onlyOwner returns (bool) {
        require(_node != address(0), "TES: node is the zero address");
        require(_productor != address(0), "TES: productor is the zero address");
        require(_suanli != address(0), "TES: suanli is the zero address");
        require(block.timestamp.sub(_lastTime) >= 86400, "TES: It's not time yet");
    ...
    function bindNode(address addressNode) public onlyOwner returns (bool) {
        require(addressNode != address(0), "TES: New node is the zero address");
        _node = addressNode;
    ...
    function bindSuanli(address addressSuanli) public onlyOwner returns (bool) {
        require(addressSuanli != address(0), "TES: New suanli is the zero address");
    ...
    function bindProductor(address addressProductor) public onlyOwner returns (bool) {
        require(addressProductor != address(0), "TES: New productor is the zero address");
    ...
    function transferOwnership(address newOwner) public onlyOwner returns (bool) {
        require(newOwner != address(0), "TES: New owner is the zero address");
        _newOwner = newOwner;
    ...
    function acceptOwnership() public returns (bool) {
        require(msg.sender == _newOwner, "TES: Caller is not the new owner");
        _owner = _newOwner;
        _newOwner = address(0);
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(amount >= minimum, "TES: burn amount should be greater than or equal to 100000000");
        require(amount.mod(minimum) == 0, "TES: burn amount must be a multiple of 100000000");
        _burn(msg.sender, amount);
