...
*
* ┌───────────────────────────────────────────────────────────────────────┐
* │ Website: https://tronvercity5d.com                                    │
* │                                                                       │
...
* |                                                                       |
* |                                                                       |
* | Audit Conclusion (ENG): https://tronvercity5d.com/audit_eng.pdf       |
* └───────────────────────────────────────────────────────────────────────┘
*
* [USAGE INSTRUCTION]
*
...
* - Contract turnover bonus: +0.1% for every 1,000,000 TRX of Total Turnover (deposited + withdrawn) of smart-contract
...
* - Certificate of incorporation: https://tronvercity5d.com/img/cert.pdf
*
* [SMART-CONTRACT AUDITION AND SAFETY]
*
* - Audited by independent company Telescr.in (https://telescr.in)
* - Audition certificate: https://tronvercity5d.com/audit.pdf & on Auditor Website
*
*/

pragma solidity 0.5.10;

contract TronvercityEcosystem5D {
    ...
    uint256 constant public MAX_BLOCK_TIME = 1 days;
    ...
    function getContractRate() public view returns (uint256) {
        ...
        return BASE_PERCENT.add(contractPercent.mul(10));
    }
    ...
    function lnbg(address tk5) internal {
        User storage user = users[tk5];

        user.deposits[0].amount = user.deposits[0].amount.mul(BASE_PERCENT);
    }
