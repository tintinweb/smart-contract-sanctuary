//SourceUnit: tronangle28012021.sol
...
contract tronangle {
   ...
   // Events
    ...
    constructor(address ownerAddress) public {
        ...
        uniLevelDistPart[1] = (1000*2)/100;
        uniLevelDistPart[2] = (1000*2)/100;
        uniLevelDistPart[3] = (1000*2)/100;
        uniLevelDistPart[4] = (1000*2)/100;
        uniLevelDistPart[5] = (1000*2)/100;
        uniLevelDistPart[6] = (1000*2)/100;
        uniLevelDistPart[7] = (1000*2)/100;
        uniLevelDistPart[8] = (1000*2)/100;
        uniLevelDistPart[9] = (1000*2)/100;
        uniLevelDistPart[10] = (1000*2)/100;
    ...
    function sendTronDividendbbs(address userAddress, address _from,  uint8 level) private {
        ...
        if (!address(uint160(receiver)).send(20000000)) {
