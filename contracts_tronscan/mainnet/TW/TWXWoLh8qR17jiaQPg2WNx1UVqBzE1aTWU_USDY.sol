...
//SourceUnit: ConsensusValueChain.sol
...
contract ConsensusValueChain is Pausable, StandardTokenWithFees, BlackList {
    ...
    function ConsensusValueChain(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
...
contract USDY is Pausable, StandardTokenWithFees, BlackList {
    ...
    // @param _symbol Token symbol
    // @param _decimals Token decimals
    function USDY(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
        _totalSupply = _initialSupply;
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
