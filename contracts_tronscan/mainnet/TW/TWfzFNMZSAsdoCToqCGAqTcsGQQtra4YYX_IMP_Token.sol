...
=== 'IMP Token' Token contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2021 onwards Imperiumtron ( https://imperiumworld.io/ )
-------------------------------------------------------------------
*/ 
...
contract IMP_Token is owned {
    ...
    string constant private _name = "IMP Token";
    string constant private _symbol = "IMP";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 constant public maxSupply = 35000 * (10**_decimals);    //35 thousands tokens max
