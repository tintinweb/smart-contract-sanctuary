...
contract RewardToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("Reward Token", "REWARD", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 1000000 * 10 ** 18);
    }
}
