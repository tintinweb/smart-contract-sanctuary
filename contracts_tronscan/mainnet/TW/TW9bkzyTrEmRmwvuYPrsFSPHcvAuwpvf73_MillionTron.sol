...
contract MillionTron {
   address payable public ownerWallet;
    ...
    uint pool4_price=600 * (10**6);
    uint pool5_price=1000 * (10**6);
    uint pool6_price=1500 * (10**6);
    uint pool7_price=1800 * (10**6);
    uint pool8_price=2400 * (10**6);
    uint pool9_price=3000 * (10**6);
    uint pool10_price=3600 * (10**6);
    ...
    UserStruct[] public requests;
       ...
       constructor(address payable _creator1) public {
        ...
        LEVEL_PRICE[1] = 30 * (10**6);
        LEVEL_PRICE[2] = 15 * (10**6);
        LEVEL_PRICE[3] = 5 * (10**6);
        unlimited_level_price= 0 * (10**6);
