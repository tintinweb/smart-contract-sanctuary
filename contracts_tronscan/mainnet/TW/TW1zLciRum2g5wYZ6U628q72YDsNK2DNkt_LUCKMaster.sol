...
//SourceUnit: LUCKMaster.sol

pragma solidity 0.5.12;

import "./LUCKToken.sol";

contract LUCKMaster is Ownable {
    using SafeMath for uint256;

    LUCK public rewardToken;
    ...
    constructor(LUCK _rewardToken) public {
    ...
    function stake(address _referrer) public payable {
        if (msg.sender == owner() || msg.value < 100 trx) {
            _refund();
        } else {
    ...
    function _stake(
        ...
        require(_amount >= 100 trx, 'Too low value');
    ...
    function unstake(uint256 _amount) public {
        ...
        user.investment = user.investment.sub(
            _amount,
            'LUCKMaster::unstake: Insufficient funds'
        );
    ...
    function stats() view public returns (
        ...
        totalLUCK = rewardToken.totalSupply();
