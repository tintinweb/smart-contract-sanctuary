...
contract EBLToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function EBLToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
