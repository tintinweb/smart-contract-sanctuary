...
contract KITTYCOIN is StandardToken {
    string public name = "Kittycoin Token";
    string public symbol = "KITTYCOIN";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 7500000000000 * 10 ** uint256(decimals);
