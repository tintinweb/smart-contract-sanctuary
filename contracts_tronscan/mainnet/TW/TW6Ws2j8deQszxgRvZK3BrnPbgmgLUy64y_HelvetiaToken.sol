...
contract HelvetiaToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function HelvetiaToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
