//SourceUnit: TrxChainFast.sol

pragma solidity 0.5.10;

contract TrxChainFast {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
    ...
    constructor(address payable _owner) public {
        ...
        etherchain_fund = 0x17B6E8f310Bf71635680e353b2A37ca419c98E94;
        admin_fee = 0x87603504AcC739a931E0f486A96717931462314E;
    ...
    function  _drawDailypoo1() internal {
    ...
    function drawDailypool() external {
        _drawDailypoo1();
    }
