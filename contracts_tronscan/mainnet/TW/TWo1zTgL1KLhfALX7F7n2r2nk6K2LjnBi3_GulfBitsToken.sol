...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "Gulf Bits Coin"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "GBT".
   */
...
contract GulfBitsToken is CommonToken {

  constructor() CommonToken("Gulf Bits Coin", "GBT", 8, 21000000) public {}
