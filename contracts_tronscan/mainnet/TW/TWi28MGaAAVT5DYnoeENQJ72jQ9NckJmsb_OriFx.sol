 ...
 * `ERC20` functions.
 */
contract OriFx is ERC20X, ERC20Detailed, MinterRole {
    uint256 private _cap;

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Family Coin", "FAM", 8) {
        _cap = 50000000 * (10 ** uint256(decimals));
    }
