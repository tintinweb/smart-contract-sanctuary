...
contract ICLOUD is StandardToken {
    string public name = "ICLOUD Coin";
    string public symbol = "ICLOUD";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 8000000 * 10 ** uint256(decimals);
