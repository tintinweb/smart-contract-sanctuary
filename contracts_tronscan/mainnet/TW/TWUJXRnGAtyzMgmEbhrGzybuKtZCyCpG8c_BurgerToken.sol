...
contract BurgerToken is TRC20 , Context , Ownable{
    ...
    constructor() {
        ...
        maxSellAmountPerDay = 1000 * 10**_decimals;
        maxSellAmountPerTxn = 1000 * 10**_decimals;    
        maxBuyAmountPerDay = 50000 * 10**_decimals;
        maxBuyAmountPerTxn = 5000 * 10**_decimals;    
        maxBurnAmount = 5000000 * 10**_decimals;
    }
