...
contract TH is Context, ITRC20, Ownable {
    ...
    string private _name = 'TH3';
    string private _symbol = 'TH3';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 60000 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 6000 * 10**uint256(_decimals);
