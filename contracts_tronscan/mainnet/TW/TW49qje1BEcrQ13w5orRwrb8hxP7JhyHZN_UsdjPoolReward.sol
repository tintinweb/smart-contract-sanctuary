...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0x41834295921a488d9d42b4b3021ed1a3c39fb0f03e);
...
contract UsdjPoolReward is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    uint256 public starttime = 1599616680;
    ...
    modifier checkhalve(){
        if (block.timestamp >= periodFinish) {
            ...
            dragon.mint(address(this),initreward);
        ...
        updateReward(address(0))
    {
        ...
        dragon.mint(address(this),reward);
