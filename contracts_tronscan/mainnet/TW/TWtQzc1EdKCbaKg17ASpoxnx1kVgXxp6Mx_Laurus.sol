...
contract _Laurus is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('Laurus', 'LSCN', 18) public {
...
contract Laurus is Ownable,_Laurus
{
      using SafeMath for uint256;
   constructor() public{
   }
