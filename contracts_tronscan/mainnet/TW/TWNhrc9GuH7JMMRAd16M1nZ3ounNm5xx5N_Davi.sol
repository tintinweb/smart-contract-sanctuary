...
contract Davi is Context, IERC20, Ownable {
    ...
    string private _name = "Medusa";
    string private _symbol = "Medusa";
    uint8 private _decimals = 6;

    address private _burnPool = address(0x0);

    address private fundAddress =
        address(0x41ba2e7ed6e78947e2fd456ec621cb018cea9cc673);
