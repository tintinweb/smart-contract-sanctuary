...
contract Bttwin {
    ...
    function BttwinTron(address _owner, address _executor) public {
        owner = _owner;
        executor = _executor;
    }
    ...
    function transferToken(address payable toAddress, uint256 tokenValue, trcToken id) public payable returns (bool transferBool){
