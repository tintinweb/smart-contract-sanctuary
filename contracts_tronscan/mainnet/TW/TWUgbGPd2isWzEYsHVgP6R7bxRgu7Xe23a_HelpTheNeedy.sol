...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "Help the needy"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "HTN".
   */
...
contract HelpTheNeedy is CommonToken {

  constructor() CommonToken("Help The Needy", "HTN", 6, 60000) public {}
