//SourceUnit: mining2.sol

/**
                                         𝕎𝕖𝕓𝕤𝕚𝕥𝕖: 𝕙𝕥𝕥𝕡://𝕋𝕣𝕠𝕟𝕄𝕚𝕟𝕚𝕟𝕘.𝕚𝕠
           
                                   𝕋𝕖𝕝𝕖𝕘𝕣𝕒𝕞: 𝕙𝕥𝕥𝕡𝕤://𝕥.𝕞𝕖/𝕋𝕣𝕠𝕟𝕄𝕚𝕟𝕚𝕟𝕘_𝕆𝕗𝕗𝕚𝕔𝕚𝕒𝕝
*/

pragma solidity ^0.4.25;

contract TronMining {        // TieUp with   Tron-in-Bank
    ...
    uint public devCommission = 6;             // 60% Goes To Mining Address
    uint public commissionDivisor = 100;       // Mining Address : TQqK1aqY1vspSzeyVj1VpjYJqBCJBp3kWm
    uint private minuteRate = 1157400;         // 10% to 100% Daily Mining Profit
