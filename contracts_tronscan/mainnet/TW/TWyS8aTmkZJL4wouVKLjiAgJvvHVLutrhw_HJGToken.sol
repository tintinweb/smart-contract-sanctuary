...
contract HJGToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 688888 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;
   
    string private _name = 'Golden fruit';
    string private _symbol = 'HJG';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x0000000000000000000000000000000000000000;
    
    address private fundAddress = address(0x41C44A4CCC06375678F1321D682EDD423C3951D29F);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 38888 * 10**uint256(_decimals);
    constructor () public {
