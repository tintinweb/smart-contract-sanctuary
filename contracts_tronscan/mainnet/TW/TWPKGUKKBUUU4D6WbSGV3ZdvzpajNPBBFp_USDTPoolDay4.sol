...
//SourceUnit: USDTPoolDay4.sol

pragma solidity =0.5.4;

import "Pool.sol";

contract USDTPoolDay4 is Pool {
    constructor() public Pool(address(0x41A614F803B6FD780986A42C78EC9C7F77E6DED13C),  1041*10**14, true, 1599984000, 1e12, 9 seconds, 9600) {}
}
