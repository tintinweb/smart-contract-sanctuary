//SourceUnit: HPTToken_v_1.sol

/*
*
*   ┌───────────────────────────────────────────────────────────────────────┐
*   │         We and our team decided to create our own HPT token,          │
*   │               for quick transfers between HPT members,                │
*   │       in the future we will create the HPTPAY payment system,         │
 ...
 */
contract HPTToken is ERC20Mintable, ERC20Detailed {
    ...
    constructor(address initialOwner, address recipient) public ERC20Detailed("HPTPAY", "HPT", 4) Ownable(initialOwner) {
        // creating of inital supply
        uint256 INITIAL_SUPPLY = 8888888e4;
