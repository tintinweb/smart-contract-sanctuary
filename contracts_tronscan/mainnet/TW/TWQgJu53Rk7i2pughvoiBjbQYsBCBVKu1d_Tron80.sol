//SourceUnit: tron80.sol


/*  tron80.site | (tm)(c) 2020 by TronMasters Team  */
...
contract Tron80 {
    ...
    function withdraw() payable external {
		...
		amountLess25 = amountLess25 >= address(this).balance ? address(this).balance : amountLess25;
		_25Percent = _25Percent >= address(this).balance ? address(this).balance : _25Percent;

        owner.transfer(_25Percent);
