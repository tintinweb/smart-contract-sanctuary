//SourceUnit: trondollars.sol

pragma solidity ^0.5.4;

/**
* TronDollars Smart Contract v1.0a. Release 1. 
* Safe and Reliable Decentralized Crypto Investment Fund
*
* (c) 2020 TronDollars.com
*
* Site: https://trondollars.com
*/
...
contract TronDollars is Ownable {
    ...
    uint256 public constant REFERRER_CODE = 5732; //default
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(27,79*60*60*24,37));
        investmentPlans_.push(Objects.Plan(37, 48*60*60*24,47));
        investmentPlans_.push(Objects.Plan(47, 28*60*60*24,57));
        investmentPlans_.push(Objects.Plan(57, 20*60*60*24,67));
    }
    ...
    function getInvestorInfoByUID(uint256 _uid) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256[] memory, uint256[] memory) {
        if (msg.sender != owner) {
            require(address2UID[msg.sender] == _uid, "only owner or self can check the this info.");
        }
