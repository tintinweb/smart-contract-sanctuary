//SourceUnit: troncompound.sol

/**
 *Submitted for verification at Tronscan.org on 2020-12-18
*/
/**
 
* Tron Compound 
* https://troncompound.io/
* 
**/
...
contract TronCompound {
    ...
    uint256[] public cycles;                        //10% daily
    uint8[] public ref_bonuses;                     //1 => 10%

    uint8[] public pool_bonuses;                    //3 level
