//SourceUnit: trx_tq 转出需要approve.sol
...
contract TrxBridge{
    ...
    event Approval(address indexed to, uint256 value);

    constructor (address _watcher) public payable{
        watcher = _watcher;
    }
    /**
     * isContract
