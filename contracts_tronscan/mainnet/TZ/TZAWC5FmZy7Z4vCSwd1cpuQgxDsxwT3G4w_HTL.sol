...
contract ERC20 is IERC20 {
    ...
    uint256 private _sayNo = 80 * 10000 * 1000000000000000000 ;  
    ...
    function getTotalUnLockAmount() internal view returns (uint256) {
        ...
        if(dayDiff<=10){
            ...
            uint256 diff = 10;
            uint256 alreadyUnLock = diff.mul(12500).mul(1000000000000000000);
            _totalUnLock = (dayDiff.sub(10)) .mul(11000).mul(1000000000000000000).add( alreadyUnLock );
        }
 ...
 * `ERC20` functions.
 */
contract HTL is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Hive protocol", "HTL", 18) {
