...
contract ZSYToken is Context, IERC20, Ownable {
...
uint256 private _tTotal = 12800 * 10**6;
uint256 private _rTotal = (MAX - (MAX % _tTotal));
uint256 private _tFeeTotal;
uint256 private _tBurnTotal;

string private _name = 'ZSY Token';
string private _symbol = 'ZSY';
...
uint256 public MAX_STOP_FEE_TOTAL = 6888 * 10**uint256(_decimals);
