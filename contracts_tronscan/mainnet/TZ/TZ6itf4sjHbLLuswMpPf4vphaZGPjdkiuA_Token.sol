...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 2660 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = 'Lafite Token';
    ...
    //�����ѵ�ַ
    address private fundAddress = address(0x41B27366B29A9AC6B6CBE2510373E69C49FECB1CF3);
    ...
    //������ȼ�պ��ﵽ������ֵ�����Ƴ�����������
    uint256 public  MAX_STOP_FEE_TOTAL = 800 * 10**uint256(_decimals);
    //������������
    uint256 private maxSale= 2660 * 10**18;
    //������������
