//SourceUnit: tron-matrix.sol

pragma solidity 0.5.9;

contract Tron_matrix {
    ...
    uint REGESTRATION_FESS=2500  * (10**6);
    uint pool1_price=5000  * (10**6);
    uint pool2_price=15000 * (10**6) ;
    uint pool3_price=45000 * (10**6);
    uint pool4_price=135000 * (10**6);
    uint pool5_price=405000 * (10**6);
    uint pool6_price=1215000 * (10**6);
    uint pool7_price=3645000 * (10**6);
    uint pool8_price=10935000 * (10**6);
    uint LEVEL_PRICE = 5000  *(10**6);
    ...
    pool8activeUserID=pool8currUserID;
      ...
      function buyPool2() public payable {
        ...
        if(pool2users[pool2Currentuser].payment_received>=4)
        {
            pool2activeUserID+=1;
        }
      ...
      function buyPool3() public payable {
        ...
        if(pool3users[pool3Currentuser].payment_received>=5)
        {
            pool3activeUserID+=1;
        }
      ...
      function buyPool4() public payable {
        ...
        if(pool4users[pool4Currentuser].payment_received>=6)
        {
            pool4activeUserID+=1;
        }
      ...
      function buyPool5() public payable {
        ...
        if(pool5users[pool5Currentuser].payment_received>=7)
        {
            pool5activeUserID+=1;
        }
      ...
      function buyPool6() public payable {
        ...
        if(pool6users[pool6Currentuser].payment_received>=8)
        {
            pool6activeUserID+=1;
        }
      ...
      function buyPool7() public payable {
        ...
        if(pool7users[pool7Currentuser].payment_received>=9)
        {
            pool7activeUserID+=1;
        }
      ...
      function buyPool8() public payable {
        ...
        if(pool8users[pool8Currentuser].payment_received>=100)
        {
            pool8activeUserID+=1;
        }
