...
contract Tronfuture {
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        if(users[_addr].upline != address(0)) {
            users[users[_addr].upline].direct_bonus += _amount * 7 / 100;
    ...
    function withdraw() external {
        ...
        admin_fee.transfer(to_payout * 2 / 100);
        to_payout -= to_payout * 2 /100; 
    ...
    function Rocket( uint _amount) external {
    ...
    */
    ...
    function contractInfo() view external returns(uint256 _total_users, uint256 _total_deposited, uint256 _total_withdraw, uint40 _pool_last_draw, uint256 _pool_balance, uint256 _pool_lider,uint256 con_bal) {
