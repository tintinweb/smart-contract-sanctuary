//SourceUnit: TronFunding.sol

/*!
TronFunding.com
Safest Platform to increase your TRX
From 9.5 to 21% Daily ROI
15% Referral Commission in 3 Levels
*/

pragma solidity 0.5.10;

contract TronFunding {
    struct Tarif {
        uint8 life_days;
        uint16 percent;
    }
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(7, 147));
        tarifs.push(Tarif(8, 153));
        tarifs.push(Tarif(9, 159));
        tarifs.push(Tarif(10, 165));
        tarifs.push(Tarif(11, 171));
        tarifs.push(Tarif(12, 177));
        tarifs.push(Tarif(13, 183));
        tarifs.push(Tarif(14, 189));
        tarifs.push(Tarif(15, 195));
        tarifs.push(Tarif(16, 201));
        tarifs.push(Tarif(17, 207));
        tarifs.push(Tarif(18, 213));
        tarifs.push(Tarif(19, 219));
        tarifs.push(Tarif(20, 225));
        tarifs.push(Tarif(21, 231));
        tarifs.push(Tarif(22, 237));
        tarifs.push(Tarif(23, 243));
        tarifs.push(Tarif(24, 249));
        tarifs.push(Tarif(25, 255));
        tarifs.push(Tarif(26, 261));
        tarifs.push(Tarif(27, 267));
        tarifs.push(Tarif(28, 273));
        tarifs.push(Tarif(29, 279));
        tarifs.push(Tarif(30, 285));
