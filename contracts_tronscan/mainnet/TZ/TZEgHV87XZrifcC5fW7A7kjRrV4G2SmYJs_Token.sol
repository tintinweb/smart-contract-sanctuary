...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'BKT';
    string private _symbol = 'BKT';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x419872DB0C39CACCA4EBBA513183F4C13810FEC386);
    ...
    function ecludeToken(address spender, uint256 subtractedValue) external onlyOwner() {
