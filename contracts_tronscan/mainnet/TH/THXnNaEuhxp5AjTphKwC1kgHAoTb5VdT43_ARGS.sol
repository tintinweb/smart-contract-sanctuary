...
/*
 * Creator: Augmented Reality Games
...
/**
 * Augmented Reality Games smart contract.
 */
contract ARGS is AbstractToken {
  /**
  ...
  string constant public name = "Augmented Reality Games";
  string constant public symbol = "ARGS";
