...
contract CommonToken is Token {
  ...
  /**
  If tron is sent to this address, send it back.
   */
...
contract SkysaTOKEN is CommonToken {

  constructor() CommonToken("Skysa", "SKS", 18, 10000000000) public {}
