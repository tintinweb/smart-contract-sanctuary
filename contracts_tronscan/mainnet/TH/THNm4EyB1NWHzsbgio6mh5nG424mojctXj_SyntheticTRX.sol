...
contract Distribution is Ownable {
    ...
    function addDistributor(address distributor) public owned {
        distributors[distributor] = true;
    }
    
    function removeDistributor(address distributor) public owned {
    ...
    function distribute(address distributor, uint256 amount) public returns (bool);
}
...
contract SyntheticTRX is Distribution, TRC20Token {
    using SafeTRC20 for ITRC20;
    ...
    function distribute(address distributor, uint256 amount) public returns (bool) {
        require(amount > 0, "nonzero");
        require(isDistributor(distributor), "distributor");
        
         _balances[distributor] = _balances[distributor].add(amount);
        _supply = _supply.add(amount);
