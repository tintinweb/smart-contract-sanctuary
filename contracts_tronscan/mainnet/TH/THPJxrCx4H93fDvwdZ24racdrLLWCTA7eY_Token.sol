...
/**
 * @title Rosa Project Token
 * @dev Rambod Taati
 * Note The first cryptocurrency to support developers.
 */
contract Token is TRC20, TRC20Detailed {
    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor() public TRC20Detailed("Rosa_Project_Token", "RPT", 18) {
        _mint(msg.sender, 9630000000 * (10**uint256(decimals())));
    }
}