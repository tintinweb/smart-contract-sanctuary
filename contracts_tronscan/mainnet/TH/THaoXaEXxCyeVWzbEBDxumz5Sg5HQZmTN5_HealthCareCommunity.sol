...
// File: contracts\HealthCareCommunity.sol
...
contract HealthCareCommunity is Context, ERC20, ERC20Detailed, ERC20Pausable {
    constructor() public ERC20Detailed('Health Care Community', 'HCC', 6) {
        _mint(_msgSender(), 51000000 * (10 ** uint256(decimals())));
    }
}