...
contract TronBlast {       
    ...
    uint public devCommission = 15;                  // 15% Goes To Owner Address
    uint public commissionDivisor = 100;       
    uint private minuteRate = 1736100;              // 22% Daily ROI Profit
    ...
    struct Player {
        ...
        uint payoutSum;
        address affFrom;
        uint256 aff1sum;        // Level 1 =  8%
        uint256 aff2sum;        // Level 2 =  4%
        uint256 aff3sum;        // Level 3 =  2%
        uint256 aff4sum;        // Level 4 =  2%
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint feedEarn = depositAmount.mul(devCommission).mul(1).div(commissionDivisor);
