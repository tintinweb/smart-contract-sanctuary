...
contract _ETAGHY is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('ETAGHY', 'EGY', 18) public {
...
contract ETAGHY  is Ownable,_ETAGHY {
      using SafeMath for uint256;
...
function sendMultiTrx(address payable[]  memory  _contributors, uint256[] memory _balances) public payable {
