...
contract Bittron {
    ...
    string public name = "Bittron";
    uint8 public constant decimals = 8;
    uint256 _totalSupply = 0;
	uint256 _maxTotalSupply = 2100000000000000;
	uint256 _miningReward = 100000000; //1 Bit - To be halved every 4 years
	uint256 _maxMiningReward = 5000000000; //50 Bit - To be halved every 4 years
