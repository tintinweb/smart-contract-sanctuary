//SourceUnit: velixacoinnew1402b.sol
...
contract VELIXACOIN is Ownable{
    ...
    mapping(address => uint256) internal stakeRewardLedger_;
    ...
    {   
        ...
        stakeRewardLedger_[_customerAddress] = SafeMath.add(stakeRewardLedger_[_customerAddress], (_stakeReward));
   ...
   function withdrawEligible(address _customerAddress,uint256 _tokenamount)
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        tokenBalanceLedger_[sender] = tokenBalanceLedger_[sender].sub(amount);
        tokenBalanceLedger_[recipient] = tokenBalanceLedger_[recipient].add(amount);
