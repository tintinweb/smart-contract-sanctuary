...
/*
 *
 *   Axeo.finance - investment platform based on AXE token smart-contract (TRON blockchain).
 *   Verified, audited, safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://axeo.finance                                       │
 *   │                                                                       │
 *   │   Telegram Public Group: @axeo_finance                                |
 *   |   E-mail: axeo@axeo.finance                                          |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect TRON browser extension TronLink or TronMask, or mobile wallet apps like TronWallet or Banko
 *   2) Send any AXE amount using our website invest button. Dont send coin directly on contract address!
 ...
 *   - Contract total amount bonus: +0.05% for every 30,000 AXE on platform address balance
 *
 *   - No Minimal Deposit
 ...
 *   - 10% Development, technical support, marketing and promotion expenses, moderators and support team salary
 *
 *   ────────────────────────────────────────────────────────────────────────
 *
 */
...
contract Axeo {
    ...
    function toggleEndContract()public{
    ...
    function getUserPercentRate(address userAddress) public view returns (uint) {
        ...
        if (isActive(userAddress)) {
            // ((1625559953000 - 1625559713000) / 43200000) * 5
    ...
    function getUserReferralsStats(address userAddress) public view returns (address, uint16, uint16, uint128, uint24[1] memory) {
        User storage user = users[userAddress];
