...
contract lucky_tron {
	...
	uint256 constant public BASE_PERCENT = 350;  // 35% BASIC INTEREST PLUS 1% DAILY
	uint256 constant public MARKETING_FEE = 100; // 10%
	uint256 constant public PROJECT_FEE = 100;   // 10%
	uint256[] public REFERRAL_PERCENTS = [100, 50, 30]; // 10%,5%, 3%
