...
contract BM_B_C{
    ...
    constructor(IERC20 _ocApp, address payable exchangeAddress) public{
	// BTC token address: TN3W4H6rK2ce4vX9YnFQHwKENnHjoxb3m9,  exchange address: TKAtLoCB529zusLfLVkGvLNis6okwjB7jf
	...
	function buyEggs(address ref) public payable{
		...
		uint256 _amount = justswap.trxToTokenTransferInput.value(msg.value)(1, now + 100000000, address(this));
