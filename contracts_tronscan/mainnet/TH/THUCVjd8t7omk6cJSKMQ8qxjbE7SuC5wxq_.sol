...
contract Consts {
    ...
    string public constant TOKEN_NAME = "SEED NUT";
    string public constant TOKEN_SYMBOL = "NUT";
...
contract MainToken is Consts, FreezableMintableToken, BurnableToken, Pausable {
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0xfb946b746fb3660f22edfc5cd074bc8344bf9ef6)];
        uint[1] memory amounts = [uint(20000000000)];
