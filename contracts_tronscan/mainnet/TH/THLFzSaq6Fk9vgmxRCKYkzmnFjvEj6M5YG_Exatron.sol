//SourceUnit: Exatron.sol
    ...
    contract Exatron {
        ...
        constructor(address _stakingAddress) public {
            ...
            tarifs.push(Tarif(200, 1000,25000000));
            tarifs.push(Tarif(40, 240,25000000));
            tarifs.push(Tarif(30, 210,25000000));
            tarifs.push(Tarif(15, 135,25000000));
        ...
        function deposit(uint8 _tarif, address _upline) external payable {
            ...
            //owner.transfer(msg.value.mul(5).div(100));
                ...
                uint feed1earn = depositAmount.mul(5).div(100);
                uint feed2earn = depositAmount.mul(35).div(1000);
                uint feed3earn = depositAmount.mul(25).div(1000);
                uint feed4earn = depositAmount.mul(1).div(100);
        ...
        */
        ...
        function getStructure(address _addr) view external returns(uint256 for_withdraw, uint256 withdrawable_bonus, uint256 total_invested, uint256 total_withdrawn, uint256 total_match_bonus,uint256 total_team,uint256 L1,uint256 L2,uint256 L3)
        {
             Player storage player = players[_addr];
              uint256 payout = this.payoutOf(_addr);
