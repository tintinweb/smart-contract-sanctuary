...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* ERC20 constants */
    string public constant name = "NUI";
        ...
        external
    {
        ...
        require(g._currentDay > CLAIM_PHASE_START_DAY, "NUI: Too early");

        if (beforeDay != 0) {
            require(beforeDay <= g._currentDay, "NUI: beforeDay cannot be in the future");
    ...
    {
        require(beginDay < endDay && endDay <= globals.dailyDataCount, "NUI: range invalid");
        ...
        view
    {
        ...
        require(stakeIdParam == stRef.stakeId, "NUI: stakeIdParam not in stake");
...
contract StakeableToken is GlobalsAndUtility {
        ...
        external
    {
        ...
        require(newStakedDays >= MIN_STAKE_DAYS, "NUI: newStakedDays lower than minimum");
        ...
        external
    {
        ...
        require(stakeLists[stakerAddr].length != 0, "NUI: Empty stake list");
        require(stakeIndex < stakeLists[stakerAddr].length, "NUI: stakeIndex invalid");
        ...
        require(g._currentDay >= st._lockedDay + st._stakedDays, "NUI: Stake not fully served");

        /* Stake must still be locked */
        require(st._unlockedDay == 0, "NUI: Stake already unlocked");
        ...
        external
    {
        ...
        /* require() is more informative than the default assert() */
        require(stakeListRef.length != 0, "NUI: Empty stake list");
        require(stakeIndex < stakeListRef.length, "NUI: stakeIndex invalid");
        ...
        internal
    {
        ...
        require(newStakedDays <= MAX_STAKE_DAYS, "NUI: newStakedDays higher than maximum");
        ...
        require(newStakeShares != 0, "NUI: newStakedSuns must be at least minimum shareRate");
        ...
        returns (uint256 bonusSuns)
    {
        /*
            ...
            Bonus percentage scaled 0% to 10% for the first 7M NUI of stake.
...
contract TransformableToken is StakeableToken {
    ...
    function xfLobbyExit(uint256 enterDay, uint256 count)
        external
    {
        require(enterDay < _currentDay(), "NUI: Round is not complete");
        ...
        if (count != 0) {
            require(count <= qRef.tailIndex - headIndex, "NUI: count invalid");
            endIndex = headIndex + count;
        } else {
            endIndex = qRef.tailIndex;
            require(headIndex < endIndex, "NUI: count invalid");
        }
        ...
        returns (uint256 rawAmount, address referrerAddr)
    {
        ...
        require(entry.rawAmount != 0, "NUI: Param invalid");
...
contract NUI is TransformableToken {
    constructor()
        public
    {
