...
contract FBYToken is Context, IERC20, Ownable {
    ...
    string private _name = 'GFX Token';
    string private _symbol = 'GFX';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x417fb9fd3f1020709adc8b5f54b539fbdb1b4e5249);
