...
contract TronGold {
    ...
    constructor() public payable {
        owner = msg.sender;
        plans[0] = Plan({planDuration: 0, planProfit: 6000});
        plans[1] = Plan({planDuration: 30, planProfit: 7000});
        plans[2] = Plan({planDuration: 20, planProfit: 8000});
        plans[3] = Plan({planDuration: 15, planProfit: 9000});
    }
