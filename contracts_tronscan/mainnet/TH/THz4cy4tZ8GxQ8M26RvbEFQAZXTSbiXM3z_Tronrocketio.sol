//SourceUnit: tronrocketio.sol

pragma solidity ^0.5.4;

contract Tronrocketio
{
    ...
    function withdraw(uint256 withdrawType, address payable addr) payable public {
        if(withdrawType == 0) {
            ...
            uint256 amount = player.dividends + player.referral_bonus + player.override_bonus;
    ...
    function userInfo(address _addr) view public returns(uint256 for_withdraw, uint256 withdrawable_referral_bonus,uint256 withdrawable_override_bonus, uint256 invested, uint256 withdrawn, uint256 referral_bonus, uint256 override_bonus, uint256[8] memory referrals, uint256 total_profit) {
