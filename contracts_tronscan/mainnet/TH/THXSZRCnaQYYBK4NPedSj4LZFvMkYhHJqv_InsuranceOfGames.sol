...
//SourceUnit: InsuranceOfGames.sol
...
contract InsuranceOfGames is Context, IERC20, Ownable {
    ...
    string private _name = 'Insurance Of Games';
    string private _symbol = 'IOG';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 512178 * 10**uint256(_decimals);

    address private _fundAddress;

    uint256 public _fundFee = 99;
