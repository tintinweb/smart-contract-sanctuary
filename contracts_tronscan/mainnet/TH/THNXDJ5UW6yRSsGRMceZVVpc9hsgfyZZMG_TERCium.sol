...
//
/**
 * @dev Contract for wrapping TRC10 version of TERC into TRC20 version
 */
contract TERCium is WrappedToken {
    constructor() WrappedToken("TERCium", "TERC", 4, 1003075) {}
}