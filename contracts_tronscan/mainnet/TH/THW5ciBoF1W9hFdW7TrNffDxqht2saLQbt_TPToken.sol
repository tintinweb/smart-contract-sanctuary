...
contract TPToken {
    ...
    //transfer
    uint256 feeMaxPercent = 3;   

    //init  
    address burnAddress = 0x0000000000000000000000000000000000000000;   
    address initAddress = 0x14f4cB90d37fe6344f7f9043258f68a21b52417A;

    uint256 public maxBurnAmount;
    uint256 public curBurnAmount=0;
    ...
    constructor(string memory _tokenName, string memory _tokenSymbol, uint8 _decimalUnits, uint256 _initialAmount) public {
        ...
        maxBurnAmount=69000* 10 ** uint256(_decimalUnits);  
        name = _tokenName;
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        ...
        if (curBurnAmount < maxBurnAmount) {
            uint256 burn = _value.mul(feeMaxPercent).div(denominator);
