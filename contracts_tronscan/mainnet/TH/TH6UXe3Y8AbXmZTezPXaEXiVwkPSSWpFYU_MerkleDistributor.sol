...
//SourceUnit: IMerkleDistributor.sol
...
//SourceUnit: MerkleDistributor.sol
...
contract MerkleDistributor is IMerkleDistributor {
    ...
    event RecoverTrx(address indexed destination, uint256 indexed amount);
    ...
    */
     ...
     * @param _destination User address
    ...
    function recoverTrx(
        ...
        require(address(this) != _destination, "Invalid address");

        require(
            (address(uint160(_destination)).send(_amount)),
            "Recover Trx Failed"
        );

        emit RecoverTrx(_destination, _amount);
    }
    ...
    function recoverToken(
        ...
        emit RecoverToken(_token, _destination, _amount);
    }
}


//SourceUnit: MerkleProof.sol
