//SourceUnit: MEOW COIN.sol

pragma solidity ^0.5.0;
// ----------------------------------------------------------------------------
// ⚙️'name' token contract, Meow Coin(MEOW)
//
// 😻Meow Coin created by people who love Cats!❤️
//
// 🧐see our site for more information: https://www.meowcoin.best/
// ----------------------------------------------------------------------------
/**
TRC20 Token
...
contract MeowCoin is CommonToken {

  constructor() CommonToken("Meow Coin", "MEOW", 6, 99999000000) public {}
