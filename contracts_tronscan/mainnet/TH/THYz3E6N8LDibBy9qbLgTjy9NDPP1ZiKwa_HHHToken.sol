...
contract HHHToken is ERC20,ERC20Detailed,Ownable,Pausable {
    ...
    /**
     * @dev onlyOwner Called by a pauser to pause, triggers stopped state.
     */
    ...
    /**
     * @dev onlyOwner Called by a pauser to unpause, returns to normal state.
     */
    ...
    /**
     * @dev onlyOwner Called by a freeze to unfreeze, returns to normal state.
     */
   ...
   /**
     * @dev Returns the frozen of the account status.
     */
    ...
    */
    ...
    /**
     * @dev onlyOwner See {ERC20-_burnFrom}  batch more
     */
   ...
   /**
     * @dev See {ERC20-_transfer}  batch more
     */
   ...
   /**
     * @dev onlyOwner See {ERC20-_mint}  batch more
     */
