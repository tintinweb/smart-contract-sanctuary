...
contract EUROTron is TRC20Token {
  ...
  constructor(address payable _ownerOne, address payable _ownerTwo, address payable _ownerThree, address payable _ownerFour) TRC20Token("EUROTron", "EUROT", 6, 1000000000) public {
  ...
  function unVote() public {
	...
	function withdraw() public {
		if (msg.sender == ownerTwo){
			...
			ownerTwo.transfer(contractBalance);
