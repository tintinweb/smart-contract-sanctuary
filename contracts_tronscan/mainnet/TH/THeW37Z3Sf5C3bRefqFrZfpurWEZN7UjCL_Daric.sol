...
/**
 * @title Basic
 * @dev Simpler version of  interface
...
contract Daric is Pausable, StandardTokenWithFees, BlackList {
    ...
    function Daric(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
