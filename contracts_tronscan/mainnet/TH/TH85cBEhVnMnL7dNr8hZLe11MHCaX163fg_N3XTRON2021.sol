//SourceUnit: n3xtron2021.sol

pragma solidity 0.5.9;

contract N3XTRON2021 {
...
/*   n3xtron - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
*   This method allows users to leavae their stake , with 50% of their initial investment. for whatever reason
*   
*/
	...
	function getCutAndRunThreshHold(address userAddress) public view returns(uint256 amount) {
			amount = getUserTotalAtStake(userAddress).div(2);   //50%
