...
contract InvestTron {
  ...
  constructor() public {
    tariffs.push(Tariff(3 * 28800, 123));
    tariffs.push(Tariff(6 * 28800, 169));
    tariffs.push(Tariff(9 * 28800, 239));
    tariffs.push(Tariff(12 * 28800, 269));
