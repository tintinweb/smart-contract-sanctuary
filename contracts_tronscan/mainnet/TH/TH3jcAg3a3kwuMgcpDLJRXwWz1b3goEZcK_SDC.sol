...
contract ERC20 is IERC20 {
    ...
    uint256 private _totalToPool = 0;   
    uint256 private _totalBurnAmount;  
    uint256 private _sayNo = 1928500 * 1000000000000000000 ;  
    ...
    function getTotalUnLockAmount() internal view returns (uint256) {
        ...
        uint256 _totalUnLock = dayDiff.mul(20300).mul(1000000000000000000);
        if(_totalUnLock >= (2030 * 10000 * 1000000000000000000)){
           return 2030 * 10000 * 1000000000000000000;
        }
        return _totalUnLock;  
    }
    ...
    function superUnLock( address _poolAddress , uint256 _amount ) public onlySuper returns (bool success) {
        ...
        require( _totalToPool.add(_amount)  <= _unLockTotalAmount ,'Not enough has been unlocked');
        _transfer(msg.sender, _poolAddress, _amount); 
        _totalToPool=_totalToPool.add(_amount);  
        return true;
    }
 ...
 * `ERC20` functions.
 */
contract SDC is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Spiral Double Carbon", "SDC", 18) {
        _mint(msg.sender, 2030 * 10000 * 1000000000000000000 );
    }
}
