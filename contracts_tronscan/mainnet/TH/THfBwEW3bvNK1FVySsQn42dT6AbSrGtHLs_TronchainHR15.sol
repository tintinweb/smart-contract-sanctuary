//SourceUnit: TronchainHR15.sol

pragma solidity ^0.4.25;

contract TronchainHR15 {
    ...
    uint private releaseTime = 1594648800;
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint feedEarn = depositAmount.mul(devCommission).mul(4).div(commissionDivisor);
