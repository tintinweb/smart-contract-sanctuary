...
contract MmdtToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function MmdtToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
