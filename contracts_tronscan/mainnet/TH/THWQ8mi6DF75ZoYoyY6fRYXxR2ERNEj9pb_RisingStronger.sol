...
contract RisingStronger is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 6;

    constructor() public ERC721Full("RisingStronger", "RST21") {
    _setBaseURI("https://thefanblock.com/wp-content/uploads/2021/09/RisingStrongerTogether.json");
    }
