...
contract PayChain is Pausable, StandardTokenWithFees, BlackList {
    ...
    function PayChain(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
