...
contract PinkEthPool is LPTokenWrapper, IRewardDistributionRecipient, DateWrapper {
    ...
    constructor(uint256 _startTime, address _lp, address _token) public {
        lpToken = IERC20(_lp);
        token = IERC20(_token);
        initReward = 400000 * 10 ** 6;
