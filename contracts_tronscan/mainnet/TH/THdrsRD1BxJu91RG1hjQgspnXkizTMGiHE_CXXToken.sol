...
contract CXXToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 11000000 * 10**6;
    ...
    address private fundAddress = address(0x55131DaA2504FcBD13748962b3ac5C00aB213477);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 16800 * 10**uint256(_decimals);
