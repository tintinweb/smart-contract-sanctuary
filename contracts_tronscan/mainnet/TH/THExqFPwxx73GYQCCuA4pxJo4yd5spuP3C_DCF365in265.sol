//SourceUnit: DCF365in265.sol

/**
* DigitalCurrency.Fund
* www.digitalcurrency.fund
* https://www.digitalcurrency.fund
*
* Crowdfunding And Investment Program: 1% Daily ROI for 265 Days
* Daily Return Rate of 1% per contract. 
* * 
* Referral Program
* 1st Level = 10%
* 2nd Level = 5%
...
contract DCF365in265 is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 250;           // 25% AI Devlopment Team and Trading Fund
    uint256 public constant MARKETING_RATE = 100;           // 10% Marketing, Promotions, Adverstising, Office Expenses
    uint256 public constant REFERENCE_RATE = 175;           // 17.5% Total Refer Income
    ...
    uint256 public constant REFERENCE_LEVEL3_RATE = 25;     // 2.5% Level 3 Income
    uint256 public constant MINIMUM = 100e6;                // Minimum investment : 100 TRX
    uint256 public constant REFERRER_CODE = 1234;           // Root ID : 1234
    uint256 public constant PLAN_INTEREST = 14;             // 1.4% Daily Return FACTORED BY THE LOSS OF A DAY
    uint256 public constant PLAN_TERM = 261 days;           // 261 Days 
    ...
    address payable public developerAccount_;
    address payable public marketingAccount_;
