...
contract KJG is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 8600 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'KJG Token';
    string private _symbol = 'KJG';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41B106CED9219EE068D349E4EE372277F6C0F60644);
