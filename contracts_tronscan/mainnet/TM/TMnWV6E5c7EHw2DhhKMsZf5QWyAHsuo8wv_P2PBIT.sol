...
contract ERC20Interface {
  /**
  Returns the name of the token - e.g. "P2PBIT"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "P2P".
   */
...
contract P2PBIT is CommonToken {

  constructor() CommonToken("P2PBIT", "P2P", 18, 1000000) public {}
