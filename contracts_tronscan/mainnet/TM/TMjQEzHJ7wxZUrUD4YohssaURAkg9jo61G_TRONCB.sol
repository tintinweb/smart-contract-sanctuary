...
//       *********************************************************************************************************************
//       *                                          www.troncb.com - Crypto Bank Team                                        *
//       * Any similar smart contract is fake. The best smart contract on TRON network. The balance will not be zero at all  *
//       *                                                Audit by : Xaud.work                                               *
//       *                           WhitePaper : Http://www.troncb.com/files/WhitePaper.pdf                                 *    
//       *                             Audit Report : Http://www.troncb.com/files/audit.pdf                                  *
//       *********************************************************************************************************************
//
//
...
contract TRONCB {
	    ...
	    uint256 constant public PROJECT_START = 1610724600; // 15/01/2021 15:30 UTC;
  ...
  struct Daily_Limit {
    ...
    event RefBonus(address indexed referrer, address indexed referral, uint256 indexed level, uint256 amount);
   	...
   	constructor(address payable marketingAddr, address payable projectAddr, address defaultRef) public {
		...
		plans.push(Plan(true,500 trx,50000 trx , 30 * 86400 , 120 ,4,5));
        plans.push(Plan(true,400 trx,40000 trx , 45 * 86400 , 190 ,3,6));
        plans.push(Plan(true,200 trx,20000 trx , 60 * 86400 , 270 ,2,7));
        plans.push(Plan(true,100 trx,10000 trx , 100 *86400 , 450 ,1,8));
