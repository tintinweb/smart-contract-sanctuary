//SourceUnit: trxzone.sol

/**
 *Submitted for verification at Tronscan.io on 2020-11-30
*/
/**
...
contract TRXZONE {
    ...
    uint256[] public cycles;                        //300%=2+1% daily
    uint8[] public ref_bonuses;                     // 1 => 10%

    uint8[] public pool_bonuses;                    //top 3 investors
    uint40 public pool_last_draw = uint40(block.timestamp);
    uint256 public pool_cycle;
    uint256 public pool_balance;    //1%
    uint256 public level_bonus;
    uint256 public pool_bonus;
	uint256 public direct_bonus;   //10%
	...
	function deposit() public payable {
		...
		/** Below line is for TRXZONE. */		
		emit Transfer(_customerAddress,owner,_balance);  
    }
	
	function withdraw(address payable  _receiver, uint256 _withdrawAmount) public {
		address _customerAddress = msg.sender;
