//SourceUnit: New808coinTRC20Contract.sol

pragma solidity ^0.4.25;

/**
New808token TRC20 contract
Symbol        : TR808
Name          : New808token
Decimals      : 8
Owner Account : TXnZxPaNMj9oLizLhq5927rf4QKUXy67FG
...
*/
contract New808token is TRC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        contract_owner = msg.sender; // didarmetu
        balances[contract_owner] = 1000000 * 10 ** 8;
        emit Transfer(address(0), contract_owner, 1000000 * 10 ** 8);
    }
    ...
    */
    ...
    /**
    Mintable TRC20
    Simple TRC20 Token example, with mintable token creation
    Based on code by TokenMarketNet: https://github.com/TokenMarketNet/smart-contracts/blob/master/contracts/MintableToken.sol
    */
    function CreateTR808(address to, uint tokens) public returns (bool success) {
    ...
    /** Burn Tokens */
    function BurnTR808(uint tokens) public returns (bool success) {
