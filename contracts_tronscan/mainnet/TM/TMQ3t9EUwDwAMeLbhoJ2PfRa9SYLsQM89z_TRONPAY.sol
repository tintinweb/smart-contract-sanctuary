...
contract TRONPAY {
    ...
    address payable public TRONPAY_fund;
...
constructor(address payable _owner, address payable _TRONPAY_fund,address payable _admin_fee) public {
        owner = _owner;
        
        TRONPAY_fund = _TRONPAY_fund;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        TRONPAY_fund.transfer(_amount * 3 / 100);
