//SourceUnit: test_10_03_2021.sol
  ...
  //  uint private minuteRate = 0;  
   ...
   function register(address _addr, address _affAddr) private{
    ...
    function finalwithdraw() public {
     ...
     totalcycleWithdraw = totalcycleWithdraw.add((withdrawAmount * 97) / 100);
    ...
    player.reqwithdraw = player.reqwithdraw + _withdrawAmount; 
     player.withdrawtime = getActualActivationCycle();
     player.withdrawtime = player.withdrawtime.add(30 minutes);
     totalcycleWithdraw = totalcycleWithdraw.add((_withdrawAmount * 97) / 100);
  ...
  de pending...teniendo como referencia el n final.
   ...
   // function realProfit(address _addr) public view returns (uint){
    ...
    //}
     ...
     if (_depAmount > totalcycleWithdraw){
         totalcycleWithdraw = 0;
