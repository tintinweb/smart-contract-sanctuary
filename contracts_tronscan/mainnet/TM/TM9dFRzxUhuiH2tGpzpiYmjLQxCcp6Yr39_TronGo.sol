//SourceUnit: TronGo.sol

 /*  TronGo - Community Contribution pool with daily ROI (Return Of Investment) based on TRX blockchain smart-contract technology. 
 ...
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://trongo.space                                     │
 *   │                                                                       │
 *   │   Telegram Public Group and Support: @trongoofficial                |
 *   |                                                                       |        
 *   |                                       
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 ...
 *
 *   - ROI (return of Investment): 4.5% To 9.5% Based on smart contract balance every 24h - max 300%  for every deposit.
	...
	function currentroi() view public returns(uint256){
	    uint256 _ROI;
	     uint256 contractbalance=address(this).balance;
	         if(contractbalance>750000000000){
	             return _ROI=950;
	         }
	         else{
	             uint additional = contractbalance/150000000000;
	             _ROI=450+(additional*100);
	             return _ROI;
	         }
	}
	// from here
