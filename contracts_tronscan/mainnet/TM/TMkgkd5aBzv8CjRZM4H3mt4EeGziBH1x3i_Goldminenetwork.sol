//SourceUnit: Goldminenetwork.sol
 ...
 *   2) Send any GMNE amount using our website invest button. Dont send coin directly to contract address!
 ...
 *   - Contract total amount bonus: +0.05% for every 30,000 GMNE on platform address balance
 *
 *   - No Minimal Deposit
