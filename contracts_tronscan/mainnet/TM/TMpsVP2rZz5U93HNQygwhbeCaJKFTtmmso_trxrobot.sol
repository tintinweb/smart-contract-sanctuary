...
contract trxrobot {
    ...
    function deposit(address _referral) external payable {
        ...
        if(player.milestones[2] == false && player.total_invested >= 50000000000){
    ...
    function userInfo(address _addr) view external returns(uint256 for_withdraw, uint256 withdrawable_referral_bonus, uint256 invested, uint256 withdrawn, uint256 referral_bonus, uint8 bonus_percent, uint256[8] memory referrals, bool[8] memory milestones) {
        ...
        if(player.last_payout != 0 && player.last_payout < (block.timestamp-86400)){ milestones[3] = true; _bonus_perc += 10; }
