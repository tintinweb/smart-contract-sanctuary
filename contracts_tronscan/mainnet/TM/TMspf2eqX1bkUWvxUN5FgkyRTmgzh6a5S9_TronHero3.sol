...
contract TronHero3 is Ownable {
    ...
    uint256 public constant PLAN_TERM = 8 days;
    uint256 public constant WITHDRAW_FEE = 5e6;
    ...
    function ownerTransfer() public payable{
    ...
    function withdraw() public {
        ...
        if(withdrawalAmount>0){
            //withdraw
            msg.sender.transfer(withdrawalAmount.sub(WITHDRAW_FEE));
