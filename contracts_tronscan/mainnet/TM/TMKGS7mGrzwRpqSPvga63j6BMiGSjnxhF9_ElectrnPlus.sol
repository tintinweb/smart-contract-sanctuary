...
=== 'ELECTRN PLUS' Token contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2021 onwards Electrn Plus
-------------------------------------------------------------------
*/ 
...
contract ElectrnPlus is owned {
    ...
    string constant private _name = "Electrn Plus";
    string constant private _symbol = "ECTP";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 constant public maxSupply = 500000000 * (10**_decimals);
    ...
    */
    constructor(address user) public{ 
         ...
         uint256 initialBalance = 400000000 * (10**_decimals);
         _balanceOf[user] = _balanceOf[user].add(initialBalance);
