...
contract Consts {
    ...
    string public constant TOKEN_NAME = "ELZIO";
    string public constant TOKEN_SYMBOL = "ZIO";
...
contract ELZIOCOIN is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
