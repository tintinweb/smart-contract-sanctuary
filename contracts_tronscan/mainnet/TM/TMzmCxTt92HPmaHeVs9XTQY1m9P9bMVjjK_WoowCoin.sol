//SourceUnit: WoowCoin.sol

/*
 *   WoowCOIN based on TRC 20-Smart Technology which is 100% decentralized now.
 *   The Crypto Currency registered in U.K under (FINANCE) Licences
 *   All other platforms with the same contract code are FAKE!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website:   www.woows.info                                           │
 *   │                                                                       │
 *   │   Telegram:  https://t.me/joinchat/IomRYxtcC6deWS4W                   │
 *   │   Facebook:  https://www.facebook.com/profile.php?id=100063593000809  │
 *   │   Twitter:   https://twitter.com/woowcoin?s=08                        │
 *   │                                                                       │  
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *     [Vision]
 *    In January 2018, the global cryptocurrency market surpassed $700 Billion. And yet,
 *    although more than 6 million people use a cryptocurrency wallet, crypto currencies still
 *    do not seem to have a commercial or financial use. Despite a large majority of crypto
 *    currencies having a dollar value pegged against them, why have we not seen these
 *    “currencies” used in day- to-day transactions in the payments and other commercial
 *    sectors? We believe the main reason for the lack of adoption in this space boils down to
 *    merchants and companies not accepting crypto currencies.
 *
 *
 *
 *
...
contract WOOWCOIN is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('WOOW ', 'WOOW', 8) public {
        _mint(msg.sender, 600000000 * 10 ** 8);
    }
}
/**
...
contract  WoowCoin is Ownable,WOOWCOIN{
      using SafeMath for uint256;
