...
contract LUX is ITokenDeposit {
    string public name = "LuxurCoin";
    string public symbol = "LUX";
    uint8  public decimals = 6;
    trcToken  public LUXTokenId = trcToken(1003892);
    ...
    function deposit() public payable {
        require(msg.tokenid == LUXTokenId, "deposit tokenId not LUX[1003892]");
    ...
    function withdraw(uint256 sad) public {
        require(balanceOf_[msg.sender] >= sad, "not enough LUX balance");
        require(totalSupply_ >= sad, "not enough LUX totalSupply");
        balanceOf_[msg.sender] -= sad;
        totalSupply_ -= sad;
        msg.sender.transferToken(sad, LUXTokenId);
