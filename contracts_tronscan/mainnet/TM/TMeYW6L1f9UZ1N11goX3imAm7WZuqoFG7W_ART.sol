 ...
 * `ERC20` functions.
 */
contract ART is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Artist", "ART", 18) {
...
contract ERC20 is IERC20 {
    ...
    uint256 private _sayNo = 20 * 10000 * 1000000000000000000 ;
    address private superAdmin;

    // Secondary The only management is to manage illegal users to obtain OILT by abnormal means
