...
contract ZTron {
    ...
    uint private releaseTime=1605679200;
    ...
    function getPer(address pla, uint pos) private {
        ...
        if(now >= releaseTime){
            ...
            player.deposits[pos].tmp = now + 3 days;
            player.deposits[pos].per = 60;
        }else{
            player.deposits[pos].time = releaseTime;
            player.deposits[pos].tmp = releaseTime + 3 days;
            player.deposits[pos].per = 80;
        }
    }
