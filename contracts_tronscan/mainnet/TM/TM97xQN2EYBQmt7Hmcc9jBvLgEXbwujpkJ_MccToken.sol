...
contract BaseTRC20 is Governance,Context, ITRC20 {
    ...
    uint256 public  _rewardRate = 500;
...
contract MccToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("MCC TOKEN", "MCC", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 1800000 * 10 ** 18);
    }
}