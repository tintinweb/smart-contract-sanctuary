//SourceUnit: tronHold.sol

 /*  TronHold is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://TronHold.space     								 │
 * 	 │																		 │
 *   │   TronHold - Next Generation Communıty Program						 │
 *	 │                                                                       │
...
contract TronHold {
    ...
    uint constant public INVEST_MAX_AMOUNT = 50000 trx;
