...
// REX is the governance token for the RexTRON Community that highlights the need for financial independence and cryptopreneurship across all borders.
...
contract REXImplementor is TRC20, Ownable {
    ...
    constructor() public TRC20("Rextron Token", "REX", msg.sender) {
...
contract REX is REXImplementor {
    using SafeMath for uint256;
