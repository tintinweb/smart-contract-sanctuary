...
contract _Tronswap is ERC20, ERC20Detailed, ERC20Burnable {
    constructor() ERC20Detailed('Tronswap DAO', 'TSWC', 18) public {
...
contract Tronswap  is Ownable,_Tronswap {
      using SafeMath for uint256;
