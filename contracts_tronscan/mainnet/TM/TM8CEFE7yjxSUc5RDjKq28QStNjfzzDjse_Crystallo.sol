...
contract _crystallo is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('Crystallo Coin', 'CTO', 18) public {
        _mint(msg.sender,  17860000 *10** 18);
    }
}
...
contract Crystallo  is Ownable,_crystallo {
      using SafeMath for uint256;
