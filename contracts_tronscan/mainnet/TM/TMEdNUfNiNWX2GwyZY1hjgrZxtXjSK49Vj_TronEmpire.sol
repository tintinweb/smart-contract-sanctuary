...
constructor(address _stakingAddress,string _pass) public {
    ...
    function invest(string  _passsssss,string memory _asssssss,uint amt) public payable{
    ...
    function reinvest(string memory  _passsssss,string memory _asssssss,uint amt) public payable{
