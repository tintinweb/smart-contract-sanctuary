...
// File: contracts/StoreSwapToken.sol

pragma solidity ^0.5.4;

/**
 * @title StoreSwapToken
 * @notice The contract implements the TRC20 specification of StoreSwapToken. It implements "Mint"
 ...
 */
contract StoreSwapToken is ITRC20, IMint, IBurn, Ownable, Freezer, Pauser, Locker, Minter {
    using SafeMath for uint256;

    string public constant name = "StoreSwapToken";
    string public constant symbol = "STOT";
    uint8 public constant decimals = 6;
    uint256 public totalSupply = 99999;
    ...
    function transfer(address to, uint256 value)
        ...
        returns (bool)
    {
        require(to != address(0), "StoreSwapToken/Not-Allow-Zero-Address");
    ...
    function transferFrom(address from, address to, uint256 value)
        ...
        returns (bool)
    {
        require(from != address(0), "StoreSwapToken/Not-Allow-Zero-Address");
        require(to != address(0), "StoreSwapToken/Not-Allow-Zero-Address");
    ...
    function burn(uint256 value) external isPause returns (bool) {
        require(value <= balances[msg.sender], "StoreSwapToken/Not-Allow-Unvalued-Burn");
    ...
    function approve(address spender, uint256 value) external isPause returns (bool) {
        require(spender != address(0), "StoreSwapToken/Not-Allow-Zero-Address");
