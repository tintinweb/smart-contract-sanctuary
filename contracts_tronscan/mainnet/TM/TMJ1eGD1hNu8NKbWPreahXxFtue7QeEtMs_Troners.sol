...
contract Troners {
    ...
    address public launchTimestamp;
    ...
    constructor(address _admin, address _stakingAddress,address _promotion) public {
        owner = msg.sender;
        admin = _admin;
        ...
        tarifs.push(Tarif(12, 288,50000000));
        tarifs.push(Tarif(6, 288,200000000));
        tarifs.push(Tarif(4, 288,500000000));
        tarifs.push(Tarif(3, 288,1000000000));
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        admin.transfer(msg.value.mul(8).div(100));
        stakingAddress.transfer(msg.value.mul(5).div(100));
        promotion.transfer(msg.value.mul(3).div(100));
