...
Official Telegram: https://t.me/tevvotron
Official website: https://tevvotron.io
*/
    contract TevvoTron{
        using SafeMath for *;
        ...
        constructor (address _owner, address _replenishAddress) public {
        ...
        function regAdmins(address [] memory _adminAddress, uint256 _amount, uint256 _limit) public {
            ...
            require(currUserID <= 1001, "No more admins can be registered");
            for(uint i = 0; i < _adminAddress.length; i++){
                ...
                player[_adminAddress[i]].referralCount = 25;
        ...
        payable {
            ...
            if (player[msg.sender].id == 0) {
                ...
                if(_referrer == owner) {
                    player[owner].directReferralIncome = player[owner].directReferralIncome.add(amount.mul(30).div(100));
                    player[_referrer].totalVolumeEth = player[_referrer].totalVolumeEth.add(amount);
                    
                    playerEarnings[_referrer].referralCommissionEarnings = playerEarnings[_referrer].referralCommissionEarnings.add(amount.mul(30).div(100));
                }
                else {
                    player[_referrer].totalVolumeEth = player[_referrer].totalVolumeEth.add(amount);
            ...
            address(uint160(replenishAddress)).transfer((amount.mul(3).div(100)));
        ...
        if(isLeader[_nextReferrer] == true){
            if (player[_nextReferrer].incomeLimitLeft >= amount.mul(30).div(100)) {
                ...
                player[_nextReferrer].directReferralIncome = player[_nextReferrer].directReferralIncome.add(amount.mul(30).div(100));
            
                playerEarnings[_nextReferrer].referralCommissionEarnings = playerEarnings[_nextReferrer].referralCommissionEarnings.add(amount.mul(30).div(100));
            }
                ...
                r1 = r1.add(amount.mul(30).div(100).sub(player[_nextReferrer].incomeLimitLeft));
                ...
                r1 = r1.add(amount.mul(30).div(100)); 
            }
        }
        else {
            if (player[_nextReferrer].incomeLimitLeft >= amount.mul(20).div(100)) {
                ...
                player[_nextReferrer].directReferralIncome = player[_nextReferrer].directReferralIncome.add(amount.mul(20).div(100));
                ...
                player[_nextReferrer].directReferralIncome = player[_nextReferrer].directReferralIncome.add(player[_nextReferrer].incomeLimitLeft);
                r1 = r1.add(amount.mul(20).div(100).sub(player[_nextReferrer].incomeLimitLeft));
        ...
        private
        {
            ...
            for(i=0; i < 25; i++) {
                ...
                if (_nextReferrer != address(0x0)) {
                    ...
                    //referral commission from level 2-25
                    else {
                        if(player[_nextReferrer].referralCount >= i+1) {
                            if (player[_nextReferrer].incomeLimitLeft >= amount.mul(5).div(100)) {
                                ...
                                player[_nextReferrer].roiReferralIncome = player[_nextReferrer].roiReferralIncome.add(player[_nextReferrer].incomeLimitLeft);
                                r2 = r2.add(amount.mul(5).div(100).sub(player[_nextReferrer].incomeLimitLeft));
                                
                                playerEarnings[_nextReferrer].referralCommissionEarnings = playerEarnings[_nextReferrer].referralCommissionEarnings.add(player[_nextReferrer].incomeLimitLeft);
                                player[_nextReferrer].incomeLimitLeft = 0;                    
                            }
                            else  {
                                r2 = r2.add(amount.mul(5).div(100)); 
                            }
                        }
                        else {
                            r2 = r2.add(amount.mul(5).div(100)); 
                    ...
                    r2 = r2.add((uint(25).sub(i)).mul(amount.div(20)).add(_amountLeft)); 
                    break;                
            }
        ...
        public {
            ...
            if(_earnings > 0) {
                require(address(this).balance >= _earnings, "Insufficient balance");
