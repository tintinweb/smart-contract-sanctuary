...
contract MIMIToken  is ERC20 {
    ...
    string public constant name = "MIMI Token";
    ...
    uint256 public totalSupply = 1400000e18;
    ...
    constructor() public {
        uint256 companyFund = 1400000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100000 trx or more and get 2% more MIMI of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100000 trx or more and get 1% more MIMI of round 2
