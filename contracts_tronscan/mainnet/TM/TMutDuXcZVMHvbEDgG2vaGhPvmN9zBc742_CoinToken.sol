...
contract CoinToken is Pausable, StandardTokenWithFees, BlackList {

    address public upgradedAddress;
    bool public deprecated;
    
    function CoinToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
