...
contract TokenGlass {
    ...
    string public name = "GOACT D1VS";
    string public symbol = "GD1V";
    ...
    function buy(address _referredBy) public payable returns (uint256) {
        require(msg.tokenid==1003016);
        purchaseTokens(msg.tokenvalue, _referredBy);
    }

    function getTokenBalance(address accountAddress) public view returns (uint256){return accountAddress.tokenBalance(1003016);}
    ...
    function totalTronBalance() public view returns (uint256) {return address(this).tokenBalance(1003016);}
