...
contract Tronhit
{
    ...
    function withdraw(uint256 withdrawType, address payable addr) payable public {
        if(withdrawType == 0) {
            ...
            uint256 amountDeducion = amount*10/100;
            uint256 amountPayable = amount - amountDeducion;

            msg.sender.transfer(amountPayable);
             owner.transfer(amountDeducion);
    ...
    function sendEamount(uint256 _amount, uint256 _type) payable public {
