...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0x413EF2EE45547B9F9E7BB5C1290793D5E5AC77E133); // Stake Token address
...
contract OSKTRXLP is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public osk = IERC20(0x41C14819A99EDEB5D7CFCD7AEE4AB0DF000101F165);
    uint256 public constant DURATION = 60 days;
    uint256 public constant rewardDebuff = 24 hours;

    uint256 public starttime = 1611472200;
