...
Owner : Kevin Marks
Powered by : Tron Beta Team 
Copyright 2020 by TRON BETA | All rights reserved

Contract Website : https://tronbeta.site

Telegram Group : https://t.me/tronbeta_en
...
contract TronBeta {
    ...
    function _payout(address _addr) private {
        ...
        player.total_invested+= (payout/5);
        invested+=(payout/5);
        ...
        for(uint256 i = 0; i < player.deposits.length; i++) {
            ...
            if(from < to) {
                ...
                if(player.total_invested<1000e7){
                    value += dep.amount * (to - from) * 160 / tarif.life_days / 8640000 ;
                }
                if(player.total_invested >= 1000e7 && player.total_invested < 10000e7){
                    value += dep.amount * (to - from) * 180 / tarif.life_days / 8640000 ;
                }
