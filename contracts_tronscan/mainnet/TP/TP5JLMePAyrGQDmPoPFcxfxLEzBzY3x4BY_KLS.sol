...
contract KLS is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 18888 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'KLS Token';
    string private _symbol = 'KLS';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x4114CD631F71B7CC60065BD33B6B63A690675C63F7);
