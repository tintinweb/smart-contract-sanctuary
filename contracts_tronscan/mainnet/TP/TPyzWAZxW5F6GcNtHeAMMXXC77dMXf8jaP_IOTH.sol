...
contract IOTH {
    ...
    string tokenName = 'IOTH';
    string tokenSymbol = 'IOTH';
    constructor() public {
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        // Asserts are used to use static analysis to find bugs in IOTH code. They should never fail
     ...
     * Transfer tokens
     *
     * Send `_value` tokens to `_to` from IOTH account
     *
     ...
     *
     * Allows `_spender` to spend no more than `_value` tokens on IOTH behalf
     *
