...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'KLA';
    string private _symbol = 'KLA';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x2a1e9E0633953D629553f43196A15f2a81e1017B;
    
    address private fundAddress = address(0xdD5658741F4c4Ae863fBe9b9D64f1FDf4066Bf09);
    ...
    uint256 public _burnFee = 24;
    uint256 private _previousBurnFee = _burnFee;
    uint256 public _fundFee = 36;
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 52000 * 10**uint256(_decimals);
