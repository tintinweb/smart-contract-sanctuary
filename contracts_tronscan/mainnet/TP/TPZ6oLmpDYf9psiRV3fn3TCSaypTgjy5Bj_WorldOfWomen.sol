...
library Errors {
    string constant NOT_OWNER = 'Only contract owner';
...
contract WorldOfWomen is ITRC721, ITRC165, ITRC721Metadata, ITRC721Enumerable {
    using EnumerableSet for EnumerableSet.UintSet;
    // using EnumerableSetMarket for EnumerableSetMarket.MarketLotSet;

    string internal _name = "WorldOFWomen";
    string internal _symbol = "WOFW";

    uint256 internal totalMinted = 0;
    uint256 internal totalMigrated = 0;

    uint256 public constant MINTING_LIMIT = 10000;
    string public constant LICENCE_URL = "https://worldofwomen.io/license";

    uint256 public mintingPrice = 10000000;
    uint256 public minimumMarketPrice = 1000000000;
    ...
    function tokenURI(uint256 _tokenId) external view override returns (string memory) {
        return string(abi.encodePacked("https://worldofwomen.io/gallery/detail/", Utils.uintToString(_tokenId)));
    }
    ...
    function getLicence() external view returns (string memory) {
        return LICENCE_URL;
    }
