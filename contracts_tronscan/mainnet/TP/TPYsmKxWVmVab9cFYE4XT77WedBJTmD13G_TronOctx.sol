...
contract TronOctx {
	...
	IERC20 rewardToken = IERC20(0x418162773F2789D1056E338849C1843E5B7D1FBC99);   //token OCTX defi
	...
	uint256 constant devRate = 2;
	uint256 constant founderRate = 8;
	address payable devAddr;
	address payable founderAddr;
	...
	function freeze(address _ref) public payable {
		...
		devAddr.transfer(amount.mul(devRate).div(PERCENTS_DIVIDER));
		founderAddr.transfer(amount.mul(founderRate).div(PERCENTS_DIVIDER));
