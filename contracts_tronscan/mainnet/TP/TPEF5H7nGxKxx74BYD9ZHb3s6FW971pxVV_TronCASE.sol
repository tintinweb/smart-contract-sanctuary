...
contract TronCASE {
    ...
    uint256[] public REFERRAL_PERCENTS = [70, 31, 13, 9, 8, 6, 5, 4, 3, 2, 1];
    ...
    function withdraw() public {
        ...
        if (referralBonus > 0) {
            ...
            totalBonus  = totalBonus.add(referralBonus);
            user.bonus = 0;
        }
    ...
    function contractInfo() view external returns(uint256 _totalUsers, uint256 _totalInvested,   uint256 _totalWithdrawn, uint256 _totalDeposites, uint256 _totalBonus ) {
        return (totalUsers, totalInvested, totalWithdrawn, totalDeposits, totalBonus);
    }
