...
contract SHC {
    ...
    function deposit(address _upline,uint256 price) payable  IsInitialized external {
        ...
        nbToken_.transferFrom(msg.sender, projectAddress, price * 1e18 * 95 / 100);
        nbToken_.transferFrom(msg.sender, team1, price * 1e18 * 3 / 100);
        nbToken_.transferFrom(msg.sender, team2, price * 1e18 * 2 / 100);
    }
    function withdraw() external {
        ...
        if(users[msg.sender].payouts < max_payout && users[msg.sender].match_bonus > 0) {
         ...
         nbToken_.transfer(msg.sender,to_payout * 1000000000000000000);//1：1token
