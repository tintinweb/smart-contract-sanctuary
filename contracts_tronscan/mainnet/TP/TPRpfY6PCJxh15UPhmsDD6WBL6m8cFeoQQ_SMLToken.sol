...
contract SMLToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function SMLToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
