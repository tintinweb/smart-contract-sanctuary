//SourceUnit: edutron_network_UPDATED.sol

pragma solidity 0.5.10;
/**
* 
* A PROGRAM FOR FINANCIAL MANAGEMENT AND DISTRIBUTION OF AFFILIATE INCOME BUILT ON TRON SMART CONTRACT TECHNOLOGY
* https://edutronnetwork.org/
*
**/
contract EduTronNetwork {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
