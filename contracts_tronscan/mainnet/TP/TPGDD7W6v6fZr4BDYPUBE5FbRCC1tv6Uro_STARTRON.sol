//SourceUnit: star-tron.sol

/*
 * 
 *   star-tron.org - Decentralized short-term investments powered by the tron blockchain technology.
 *
 *   Official Launch Date: 00:00 GMT - November 29, 2020
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Official Website: https://star-tron.org/                             │
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [HOW TO JOIN]
 *
