//SourceUnit: TronIncome50.sol

pragma solidity ^0.4.25;

contract TronIncome50 {
    ...
    uint256 public comissionsRate = 30;
    uint256 public commissionDivisor = 100;
    uint256 public startTime = 1594738800; //1594738800
    ...
    constructor() public {
      ...
      level_[0] =  Level(8680556, minDepositSize); //daily 75
      level_[1] =  Level(8796296, 5000 * TRON);    //daily 76
      level_[2] =  Level(8912037, 10000 * TRON);   //daily 77
      level_[3] =  Level(9027778, 20000 * TRON);   //daily 78
      level_[4] =  Level(9259259, 50000 * TRON);   //daily 80
