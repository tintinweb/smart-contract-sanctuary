//SourceUnit: SmartX.sol

/*
* https://smartx.io [World's Best smart All in one Smart ComPlan]
...
contract TRC20 is Context, ITRC20 {
    ...
    uint private _totalSupply = 65000000 * (10 ** 6);
...
contract SmartX is TRC20 {
    /* ERC20 constants */
    string public constant name = "SmartX";
    string public constant symbol = "SMX";
    uint8 public constant decimals = 6;
    uint private constant SUNS_PER_SRX = 10 ** uint(decimals); // 1e6
