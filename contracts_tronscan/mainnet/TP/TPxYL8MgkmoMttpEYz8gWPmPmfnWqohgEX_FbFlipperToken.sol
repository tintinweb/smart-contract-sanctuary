...
contract FbFlipperToken is StandardToken {
    

    string public name = "FB Flipper Token";
    uint8 public decimals = 18;
    string public symbol = "FLIPPER";
    uint256 public totalSupply = 999*10**uint256(decimals);
