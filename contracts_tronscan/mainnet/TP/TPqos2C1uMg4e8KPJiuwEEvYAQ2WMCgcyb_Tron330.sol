//SourceUnit: tron33.sol

/**TRON330
 (Audited by HazeCrypto)
 - Earn 15% DAILY - Until 330%
 - Join telegram group - t.me/Tron330official
 - 10% Referal Rewards - 3 Levels
 - 25% Auto Reinvest
...
contract Tron330 is Ownable {
    ...
    uint256 public constant CONTRACT_LIMIT = 60;
    uint8 auto_reinvest_percentage = 25;
    ...
    function deposit(address _referral) external payable {
        ...
        require(player.deposits.length < 199, "Max 199 deposits per address");
        ...
        supportFunding.transfer(msg.value.mul(3).div(100));
    ...
    function withdraw() payable external {
        ...
        if(amount_withdrawable>0){
            ...
            require( currentBalance.sub(amount_withdrawable)  >= contract_balance.mul(CONTRACT_LIMIT).div(100), "60% contract balance limit"); 
