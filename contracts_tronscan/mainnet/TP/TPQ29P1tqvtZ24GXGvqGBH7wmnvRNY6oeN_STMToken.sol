...
contract STMToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function STMToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
