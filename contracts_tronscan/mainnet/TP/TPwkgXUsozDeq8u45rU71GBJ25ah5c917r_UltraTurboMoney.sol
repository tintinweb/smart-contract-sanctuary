//SourceUnit: turbomoney.sol

pragma solidity 0.5.9;

contract UltraTurboMoney {
    ...
    uint LEVEL_PRICE = 150  *(10**6);

    uint REGESTRATION_FESS=150  * (10**6);
    uint pool1_price=150  * (10**6);
    uint pool2_price=300 * (10**6) ;
    uint pool3_price=600 * (10**6);
    uint pool4_price=1200 * (10**6);
    uint pool5_price=2400 * (10**6);
    uint pool6_price=4800 * (10**6);
    uint pool7_price=9600 * (10**6);
    uint pool8_price=19200 * (10**6);
