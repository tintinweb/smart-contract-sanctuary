 ...
 */
contract AMAXTokenX is MintableToken {
    ...
    string public constant name = "MRWEB Extended Token";
    string public constant symbol = "AMAX"; // solium-disable-line uppercase
