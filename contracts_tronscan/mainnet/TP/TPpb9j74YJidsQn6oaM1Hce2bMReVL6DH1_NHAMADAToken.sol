...
contract NHAMADAToken is ITRC20, TRC20Detailed {
    ...
    constructor( ) public TRC20Detailed("NHAMADATOKEN", "NHMD", 6){
    ...
    function transfer(address _to, uint256 _amount) public returns(bool)
    {
        ...
        if(msg.sender == owner)
        {
          ...
          //  delete pendingTransactionList[id];
            emit SoldToken(msg.sender, _to, _amount);
        }
