...
contract SunSUNV3Pool is LPTokenWrapper, IRewardDistributionRecipient {
    // sunToken
    ...
    */
    ...
    function migrate(address nextPool) public returns (bool){
        ...
        require(SunSUNV3Pool(nextPool).stakeTo(msg.sender, userBalance), "stakeTo failed");
