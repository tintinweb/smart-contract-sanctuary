//SourceUnit: E2E Token creation solidity file_EasyToEarn.sol
...
contract REDBULL is StandardToken, BurnableToken, TRC20Mintable {

    using SafeMath for uint;

    string constant public symbol = "E2E";
    string constant public name = "REDBULL";

    uint8 constant public decimals = 8;
    uint256 public constant decimalFactor = 10 ** uint256(decimals);
    uint256 public constant INITIAL_SUPPLY = 20000000* decimalFactor;
    uint256 constant total_mint_supply  = 15000000 * decimalFactor; 
    
    constructor(address ownerAddress) public {
        totalSupply_ = INITIAL_SUPPLY;
        // Initial token distribution
        preSale(ownerAddress,INITIAL_SUPPLY);
    }
