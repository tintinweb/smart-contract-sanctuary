//SourceUnit: btttrianglefinal.sol

pragma solidity >= 0.5.0;



contract BTT_Triangle{
  ...
  event Investment(string  member_name, uint package);
    ...
    function multisendTRX(address payable[]  memory  _contributors, uint256[] memory _balances,uint256 _package) public payable { 
    require(_package >=1000, "Minimum Package Amount Is 1000");      
        uint256 i = 0;
    trcToken id=1002000;
    ...
    function multisendwithdrawBtt(address payable[]  memory  _contributors, uint256[] memory _balances) public payable {
