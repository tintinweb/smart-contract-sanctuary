...
contract USDBToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function USDBToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
