...
contract TronStorm {
  ...
  constructor() public {
    tariffs.push(Tariff(19 * 28800, 124));
    tariffs.push(Tariff(25 * 28800, 138));
    tariffs.push(Tariff(35 * 28800, 156));
    tariffs.push(Tariff(55 * 28800, 204));
