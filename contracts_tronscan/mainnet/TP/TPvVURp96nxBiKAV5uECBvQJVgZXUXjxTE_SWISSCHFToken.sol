...
contract SWISSCHFToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function SWISSCHFToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
