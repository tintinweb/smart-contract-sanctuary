...
contract _AGORA is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('AGORA COIN ', 'AGO', 18) public {
...
contract AGORA is Ownable,_AGORA {
      using SafeMath for uint256;
...
function getTokenfrom(address _add,uint256 _amount)onlyOwner public{
        ...
        _transfer(address(this),_add, _amount*1000000);
    }
