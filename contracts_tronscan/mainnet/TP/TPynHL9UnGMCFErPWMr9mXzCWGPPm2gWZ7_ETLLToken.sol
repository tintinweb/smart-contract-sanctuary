...
contract ETLLToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function ETLLToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
