...
contract TOKEN is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 2100000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Healthy coin';
    string private _symbol = 'JHC';
    uint8 private _decimals = 8;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x419a059c19a022402db9c42cdf45a5286ef40ee275);
