...
contract TronEmperor {
    ...
    constructor() public {
        ...
        soft_release = 1616083200;
        full_release = 1616090400;
    }
    ...
    function withdraw() payable external {
        ...
        //========== get80Percent
        uint256 _40Percent = amount.mul(80).div(100);
        uint256 amountLess40 = amount.sub(_40Percent);

        autoreinvest(_40Percent);

        player.dividends = 0;
        player.referral_bonus = 0;
        player.total_withdrawn += amountLess40;
        total_withdrawn += amountLess40;

        msg.sender.transfer(amountLess40);

        emit Withdraw(msg.sender, amountLess40);
    }
