...
//SourceUnit: SunUSDJ_TRXV3Pool.sol
...
contract SunUSDJTRXV3Pool is LPTokenWrapper, IRewardDistributionRecipient {
    // sunToken
    ...
    */
    ...
    function migrate(address nextPool) public returns (bool){
        ...
        require(SunUSDJTRXV3Pool(nextPool).stakeTo(msg.sender, userBalance), "stakeTo failed");
