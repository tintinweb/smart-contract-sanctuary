//SourceUnit: TronI_Investment.sol
...
contract TRONI is Ownable{
   ...
   // address payable public etherchain_fund;
    ...
    uint256 public constant MARKETING_RATE = 100;            // 10% Community Backup Fund
    ...
    function withdraw() external {
        ...
        msg.sender.transfer(to_payout.mul(90).div(100));
