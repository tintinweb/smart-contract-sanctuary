//SourceUnit: YFbaby.sol

// SPDX-License-Identifier:  SimPL-2.0
pragma solidity ^0.8.6;

contract YFbaby {
    string public name = "YFbaby";
    string public symbol = "YFbaby";
    ...
    function bonus_reward() public returns (bool) {
        ...
        emit Transfer(address(this), pairAddr, lpReward);
        return true;
    }
    ...
    function _transfer(
        ...
        if (fee > 0) {
            ...
            //LP分红
            uint256 lpReward = (fee - produceReward - operateReward);
            balanceOf[address(this)] += lpReward;

            emit Transfer(sender, address(this), fee);
            emit Transfer(address(this), produceOwner, produceReward);
            emit Transfer(address(this), operateOwner, operateReward);
        }
