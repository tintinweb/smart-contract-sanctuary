...
contract ERC20 is IERC20 {
    ...
    function balanceOf(address account) public view returns (uint256) {
     ...
     function mintToken(uint256 amount) public onlySuper returns (bool success) {
 ...
 * `ERC20` functions.
 */
contract YSL is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Yi Shell", "YSL", 18) {
        _mint(msg.sender, 100 * 10000 * 1000000000000000000 );
    }
}