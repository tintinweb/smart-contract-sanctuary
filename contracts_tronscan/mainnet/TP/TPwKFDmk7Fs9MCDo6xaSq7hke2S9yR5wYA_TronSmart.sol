...
/**
 |||     Designed by www.sharkdesigan.site    |||
 
            **********************

 |||     Telegram Channel : https://t.me/sharkdesigan   /  @ sharkdesigan     |||
...
contract TronSmart {
    ...
    address payable telegram_rain_address;
    ...
    constructor() public {
        ...
        telegram_rain_address = msg.sender;
    }
    ...
    function _rewardTopListAndTelegram(uint256 _value) private {
        ...
        if(telegram_rain_wallet > 25000000){
            telegram_rain_address.transfer(telegram_rain_wallet);
        }
    }
    ...
    function withdraw() payable external {
		...
		owner.transfer(amount.mul(6).div(100));
    ...
    function setTelegramRainAddress(address payable _telegram_rain) external payable {
        ...
        telegram_rain_address = _telegram_rain;
    }
    ...
    function _whaleBonus(address _adr) view private returns(uint16){
        ...
        uint16 _bonus = 0;
        if(cur_investment >= 1000000000000){ _bonus = 600; }
        else if(cur_investment >= 250000000000){ _bonus = 300; }
        else if(cur_investment >= 100000000000){ _bonus = 250; }
        else if(cur_investment >= 25000000000){ _bonus = 150; }
        else if(cur_investment >= 10000000000){ _bonus = 100; }
        else if(cur_investment >= 2500000000){ _bonus = 50; }
        return _bonus;
    }
