...
contract TronInvestor {
	...
	uint256 public totalTronInvestor;
	...
	function reinvest(address referrer, uint8 plan,uint256 amountInvest,address userAdress) public payable {
		...
		totalTronInvestor = totalTronInvestor.add(amountInvest);
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		totalTronInvestor = totalTronInvestor.add(msg.value);
	...
	function withdraw() public {
		...
		reinvest(user.referrer, 4,reInvestAmount,msg.sender);
