...
/*
 *
 *   nitroinvest.net - investment platform based on NOFE token smart-contract (TRON blockchain).
 ...
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect TRON browser extension TronLink or Klever, or mobile wallet apps like TronWallet or Banko
 *   2) Send any NOFE amount using our website invest button. Dont send coin directly on contract address!
 ...
 *   - Contract total amount bonus: +0.05% for every 500,000 NOFE on platform address balance
 *
 *   - No Minimal Deposit
