...
contract _BETCOIN is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('BETCOIN', 'BET', 18) public {
...
contract BETCOIN  is Ownable,_BETCOIN {
      using SafeMath for uint256;
