...
contract TronPlus {
    ...
    function deposit(address _referral) external payable {
        ...
        require(msg.value >= 200 * 1e6, "Minimal deposit: 200 TRX");
    ...
    function withdraw() external {
        ...
        uint256 feeDeduction = amount.mul(15).div(100);
        uint256 trxToWithdraw = amount.sub(feeDeduction);
        
        owner.transfer(feeDeduction);
        msg.sender.transfer(trxToWithdraw);

        emit Withdraw(msg.sender, trxToWithdraw);
    }
    ...
    //     uint256 feeDeduction = amount.mul(15).div(100);
    //     uint256 trxToInvest = amount.sub(feeDeduction);
        
    //     player.dividends = 0;
    //     player.referral_bonus = 0;
    //     player.total_invested += trxToInvest;
    //     total_withdrawn += amount;


    //     _setReferral(msg.sender, players[msg.sender].referral);
    ...
    //     player.total_invested += trxToInvest;
    //     total_invested += trxToInvest;

    //     _referralPayout(msg.sender, trxToInvest);
