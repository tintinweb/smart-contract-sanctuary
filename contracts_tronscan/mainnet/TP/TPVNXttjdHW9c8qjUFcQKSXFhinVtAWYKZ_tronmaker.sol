//SourceUnit: tronfile.sol

/*
 *	TRON 2 GET - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://tronmaker.com                                         │
 *   │                                                                       │  
 *   │   Telegram Live Support: https://t.me/tronmakersupport                  |
 *   │   Telegram Public Group: https://t.me/tronmakergroup                    |
 *   │   Telegram News Channel: https://t.me/tronmakernews                    |
 *   |                                                                       |
 *   |   Twitter: https://twitter.com/get_tron                          |
 *   |   YouTube: https://www.youtube.com/channel/UCidk8kIKQ3SqfzqNSEhwHDQ   |
 *   |   E-mail: admin@tronmaker.com                                            |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   - Certificate of incorporation: https://tronmaker.com/img/certificate.pdf
 *
 *
 *   ────────────────────────────────────────────────────────────────────────
 *
