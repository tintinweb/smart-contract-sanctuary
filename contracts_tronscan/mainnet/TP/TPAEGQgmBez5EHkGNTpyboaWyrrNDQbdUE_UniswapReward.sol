...
contract LPTokenWrapper is IPool,Governance {
    ...
    IERC20 public _lpToken = IERC20(0x3dbB29ace9e850360773de63226AFc037EA580C0); //todo
...
contract UniswapReward is LPTokenWrapper{
    ...
    IERC20 public _rewardToken = IERC20(0x2967C318a01cb50EB1F5bB99943b01012AD758f1);    //todo
