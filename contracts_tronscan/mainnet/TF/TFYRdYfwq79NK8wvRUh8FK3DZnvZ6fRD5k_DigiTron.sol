...
contract DigiTron {
	...
	function withdraw() public {
		...
		uint256 totalStakes = getUserTotalDeposits(address(this));

		require(contractBalance > totalAmount, "Contract cannot fulfill due to low balance");
		require(totalStakes < 20, "You have reached your limit of 20 stakes");
