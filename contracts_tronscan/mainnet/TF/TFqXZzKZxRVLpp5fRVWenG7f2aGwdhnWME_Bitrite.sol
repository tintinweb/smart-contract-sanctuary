...
contract Bitrite{
    ...
    function setSupportCharge(uint32 fees) external onlyAdmin{
        support_charge = fees;
    }
    ...
    function deposit() payable public returns(uint){  
        ...
        uint256 support_fees = msg.tokenvalue.mul(support_charge).div(100);
        admin.transferToken(support_fees,token);
