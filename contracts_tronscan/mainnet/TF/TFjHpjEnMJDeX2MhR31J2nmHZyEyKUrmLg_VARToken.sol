...
contract VARToken is Context, ITRC20, Ownable {
    ...
    uint256 private _fundFee = 2; // 0.2%
    uint256 private _previousFundFee = _fundFee;
    uint256 public  MAX_STOP_FEE_TOTAL = 99999 * 10**uint256(_decimals);
    ...
    function updateFundAddress (address fundAddress) public onlyOwner{
        _fundAddress = fundAddress;
