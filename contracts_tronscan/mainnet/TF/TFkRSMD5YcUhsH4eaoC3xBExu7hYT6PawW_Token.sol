 ...
 * `TRC20` functions.
 *
 * The purpose of this token is to record keep initial investment into arbitrage bot
 * Initial investment is always kept as arbitrage capital if investor decides to cash out
 * Arbitrage profit is used to buy and burn tokens, increasing the value of the tokens
 * Whitepaper/image link: https://imgur.com/gallery/CpSSUYg
 */
contract Token is TRC20, TRC20Detailed {
     ...
     */
    constructor () public TRC20Detailed("Arbitrage Token", "ATOKEN", 18) {
