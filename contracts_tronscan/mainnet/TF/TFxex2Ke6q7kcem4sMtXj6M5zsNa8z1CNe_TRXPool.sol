...
contract TRXPool is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public token;
    ...
    function stake(address ref) public payable updateReward(msg.sender) {
        require(msg.value > 0, "Cannot stake 0");
        require(
            block.timestamp > startTime && block.timestamp < periodFinish,
            "Must in time"
        );
        super.stake(msg.value, ref);
