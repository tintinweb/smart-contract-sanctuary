//SourceUnit: ORANGE COIN Token.sol
...
contract ORANGECOINToken is owned {
    ...
    string constant private _name = "ORANGE COIN";
    string constant private _symbol = "ORG";
    uint256 constant private _decimals = 6;
    uint256 private _totalSupply = 5000000000 * (10**_decimals);         //500 million tokens
    uint256 constant public maxSupply = 5000000000 * (10**_decimals);    //500 million tokens
     ...
     */
    function airdrop(address[] memory recipients,uint256[] memory tokenAmount) public returns(bool) {
