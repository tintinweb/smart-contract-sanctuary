//SourceUnit: tronsky.sol

/*
 *
 *   TronSky.tech - investment platform built on TRX blockchain smart-contract technology. Safe and lasting!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://tronsky.tech                                       │
 *   │                                                                       │                            
 *   │   Telegram Public Group: @tronskytron                                 |
 *   │   Telegram News Channel: @tronskyofficial                             |
 *   |                                                                       |                                        
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 ...
 *
 *   - Basic interest rate: +2% every 24 hours
 *   - Personal hold-bonus: +1% for every 24 hours without withdraw
 *   - Contract total amount bonus: +0.1% for every 1.000.000,00 TRX on platform address balance
 *
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral commission: 5% - 7% - 3% - 2% - 1%
 *
 *   [FUNDS DISTRIBUTION]
 *
 *   - 70% Platform main balance, participants payouts
...
contract TronSky {
	...
	uint256 constant public PERCENTS_DIVIDER = 50;
	uint256 constant public CONTRACT_BALANCE_STEP = 1000000 trx;
	uint256 constant public TIME_STEP = 1 days;
	uint256 constant public BASE_PERCENT = 20;  // 2%
	uint256 constant public MARKETING_FEE = 80; // 8%
	uint256 constant public PROJECT_FEE = 30;   // 3%
	uint256[] public REFERRAL_PERCENTS = [50, 70, 30, 20, 10]; // 5%, 7%, 3%, 2%, 1%
