...
contract MyAdvancedToken is owned, TokenMerito {
    /**
    ...
    /**
     * @dev price of the token related to token.
     */
    ...
    /**
     * @dev Purcahse token and transfer when user send token to the contract address.
     *  
     * Requirements:
     *
    ...
    /** @dev Withdraw `amount` of token from smart contract to owner.
     *
     * Requirements:
     *
    ...
    /** @dev Withdraw all amount of token from smart contract to owner.
     *
     * Requirements:
     *
