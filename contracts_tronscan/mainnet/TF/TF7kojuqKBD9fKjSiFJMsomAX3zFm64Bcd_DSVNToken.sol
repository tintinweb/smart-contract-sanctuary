...
contract TRC20Interface {
	...
	string public name;
	/**
	Returns the symbol of the token. E.g. "MIX".
	 */
	...
	/**
	MUST trigger when tokens are transferred, including zero vale transfers.
	 */
...
/**
Function to receive approval and execute function in one all.
 */
...
contract Token is TRC20Interface, Owned {
	...
	/**
	Intenal transfer, only can be called by this contract
		*/
...
contract DSVNToken is CommonToken {

	constructor() CommonToken("DSVN Token", "DSVN", 6, 100000000) public {}
