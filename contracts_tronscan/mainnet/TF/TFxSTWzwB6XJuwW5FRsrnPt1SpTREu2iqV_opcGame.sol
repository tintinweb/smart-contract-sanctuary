...
contract opcGame{
    ...
    constructor(IERC20 airdropAddr,address checkAddr) public{
        ...
        team1 = address(0x86122cC2e269cCf8CB3A78208027Bc9D8121c7fF); //1.5
        team4 = address(0x9758b6D73Caf71c28EE83eBC45496135946a1854);//1.5
        team2 = address(0xDC25f8504197Ff9Acf672FB7Fd220c99200Ed3fd); //4%
        team3 = address(0x397C13230Da6f3a48DBF2a02eE2210c801585bA2);//5%
        setPriceMan = address(0xb6860367FD1638f01214D71Da33d466dA983b0Fe);
