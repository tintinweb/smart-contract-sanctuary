...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Jsb Swap Pool";
    string public constant TOKEN_SYMBOL = "JSB";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x2F429FF0AF689F2aFafE630C37288e0E8ae0e616;
    bool public constant CONTINUE_MINTING = true;
}


contract Jsb_Swap_Pool is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
