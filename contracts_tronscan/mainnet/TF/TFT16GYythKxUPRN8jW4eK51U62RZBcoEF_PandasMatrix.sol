...
contract PandasMatrix {
    ...
    function putDetails(address referrerAddress) internal {
        ...
        players[msg.sender].p4Matrix[1].firstReferrer = referrerAddress;
    }
    ...
    function playersp5Matrix(address userAddress, uint8 level) public view returns(address, address[] memory, bool) {
