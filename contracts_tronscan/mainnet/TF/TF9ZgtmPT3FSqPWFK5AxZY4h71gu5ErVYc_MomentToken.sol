...
contract UpgradedStandardToken is StandardToken {
    ...
    function transferAndLockByLegacy(
        address from,
        address to,
        uint256 value,
        uint256 releaseDate
...
contract MomentToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function transferAndLock(
        ...
        if (deprecated) {
            return
                UpgradedStandardToken(upgradedAddress).transferAndLockByLegacy(
                    msg.sender,
                    _receiver,
                    _amount,
                    _releaseDate
