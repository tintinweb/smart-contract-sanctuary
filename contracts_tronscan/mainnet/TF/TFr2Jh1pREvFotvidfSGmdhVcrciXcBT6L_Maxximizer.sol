...
contract Maxximizer {
    ...
    address payable public insurance_address;
	...
	constructor() public {
        ...
        insurance_address = 0x31aa4BedE2ebD80346acD8a01B99B809438EAa5B;
        withdraw_fee=12;
        daily_percent=2;
        limit_percent=400;
	...
	function _deposit(address _addr, uint256 _amount) private {
        ...
        insurance_address.transfer(_amount / 100);
	...
	*/
	function deposit() payable external {
		...
		total_deposited +=_amount;
		insurance_address.transfer(_amount / 100);
        platform_fee.transfer(_amount * 2 / 100);
    }
