...
contract DeFiTronFinance is Ownable {
    ...
    uint256[4] public PLANS_PERIODS = [6 days, 12 days, 18 days, 28 days];
    uint256[4] public PLANS_PERCENTS = [7, 14, 24, 40];
    ...
    address payable public PROMOTION_ADDRESS = address(0x3a1c3068C2684419D8234CD943E51fD54C6fE657);
    uint256[4] public PROMOTION_PERCENTS = [20, 20, 20, 20]; 

    address payable public constant DEFAULT_REFERRER = address(0x3a1c3068C2684419D8234CD943E51fD54C6fE657);
