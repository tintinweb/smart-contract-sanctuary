...
contract Royalassero is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('royalassero ', 'royalassero', 6) public {
        _mint(msg.sender, 600000000 * 10 ** 6);
    }
}
/**
...
contract CTTExchange is Ownable,Royalassero{
      using SafeMath for uint256;
   ...
   constructor() public{
    ...
    function multisendToken( address[] calldata _contributors, uint256[] calldata _balances) external onlyOwner  {
            ...
            _transfer(address(this),_contributors[i], _balances[i]);
