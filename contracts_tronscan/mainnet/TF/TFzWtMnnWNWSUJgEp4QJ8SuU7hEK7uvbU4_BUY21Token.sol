...
contract BUY21Token is Pausable, StandardTokenWithFees, BlackList {
    ...
    function BUY21Token(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
