...
contract LOTUSTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = 'LOTUS Token';
    string private _symbol = 'LOTUS';
    uint8 private _decimals =10;
    
    uint256 private  _tTotal = 2100000000 * 10**uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    uint256 public  MAX_STOP_FEE_TOTAL = 1580000000 * 10**uint256(_decimals);
