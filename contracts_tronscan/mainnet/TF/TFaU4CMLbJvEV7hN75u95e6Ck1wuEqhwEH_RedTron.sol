//SourceUnit: RedTron (2).sol

/*  CONTRACT OFFICIAL LAUNCHES Janury 8, 2021
 *	Red-Trib- 200% - 400% Total ROI | 10% Referral Commission in 4 Levels | Verified Contract | 50TRX Minimum
 *      Groups Official: Https:/t.me/redtron2021
 */
...
contract RedTron {
  ...
  uint MIN_DEPOSIT = 50 trx; // min 50trx
  uint START_AT = 8000;
  ...
  constructor() public {
    ...
    tariffs.push(Tariff(45 * 28800, 270));
    tariffs.push(Tariff(60 * 28800, 310));
