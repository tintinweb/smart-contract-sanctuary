...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    function transferFrom(
        ...
        uint256 sub_value = amount.add(fee);

        _approve(
            sender,
            _msgSender(),
            _allowances[sender][_msgSender()].sub(sub_value, 'BEP20: transfer amount exceeds allowance')
        );
        return true;
    }
...
contract BFEXToken is BEP20("BFEX", "BFEX", 18) {
