 ...
 * `TRC20` functions.
 */
contract BBITToken is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("BBIT", "BBIT", 2) {
        _mint(msg.sender, 731000000 * (10 ** uint256(decimals())));
    }
}
