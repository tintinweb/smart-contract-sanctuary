...
*
* Crowdfunding And Investment Program: 1% Daily ROI for 10 Days
...
contract DCF110in10v2 is Ownable {
    ...
    uint256 public constant REFERENCE_RATE = 85;            // 8.5% Total Refer Income
    uint256 public constant REFERENCE_LEVEL1_RATE = 50;     // 5% Level 1 Income
    uint256 public constant REFERENCE_LEVEL2_RATE = 25;     // 2.5% Level 2 Income
    uint256 public constant REFERENCE_LEVEL3_RATE = 10;     // 1% Level 3 Income
    uint256 public constant MINIMUM = 100e6;                // Minimum investment : 100 TRX
    uint256 public constant REFERRER_CODE = 1234;           // Root ID : 1000
    uint256 public constant PLAN_INTEREST = 110;            // 11% Daily Return
