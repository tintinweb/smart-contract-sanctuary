...
contract MetaZodiac is TRC721Full,Ownable{
    ...
    function mintNFT(address collector_address, uint256 tokenId,string memory tokenURI,string memory btfsHash) onlyOwner public {
        //mint token
