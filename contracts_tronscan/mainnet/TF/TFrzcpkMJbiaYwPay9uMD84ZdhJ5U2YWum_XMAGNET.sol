...
contract XMAGNET is TRC20 {
    ...
    constructor () public {
        ...
        decimals = 18;
        owner = msg.sender;
        totalSupply = 5000000*(10**uint256(decimals)); // 5 million
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        if(locked && unlocked[msg.sender] != true)
         revert("Tokens locked until end of presale");
    ...
    function setPresaleAddress(address _PresaleAddress) public onlyOwner {
        require(PresaleAddress == address(0), "MCOIN::PresaleAddress: already set");
