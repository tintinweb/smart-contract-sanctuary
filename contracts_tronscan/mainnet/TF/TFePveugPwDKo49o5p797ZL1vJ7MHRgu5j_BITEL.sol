...
/*
 *
 *   biteltoken - investment platform based on BITEL token smart-contract (TRON blockchain).
 *   Verified, audited, safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://biteltoken.com                  		             │
 *   │                                                                       │
 *   │                                   									 │
 *   │   Telegram Public Group: @BITELTALK             	                     │
 *   │   Telegram News Channel: @BITELTOKEN                                  │
 *   │                                                                       │
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 ...
 *   2) Send any BITEL amount using our website invest button. Dont send coin directly on contract address!
 ...
 *   - Contract total amount bonus: +0.05% for every 500,000 BITELTOKEN on platform address balance
 *
 *   - No Minimal Deposit
