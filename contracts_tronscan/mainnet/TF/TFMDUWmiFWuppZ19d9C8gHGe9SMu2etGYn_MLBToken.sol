...
contract MLBToken is StandardToken {
    function () public payable {
        revert();
    }

    string public name = "MLBToken";
    uint8 public decimals = 18;
    string public symbol = "MLB";
    uint256 public totalSupply = 6666*10**uint256(decimals);
