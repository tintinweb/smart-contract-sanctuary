//SourceUnit: NovaTron2.sol

/**
*
* TronNova
*
* https://www.tronnova.app
* (only for TRON NOVA Community)
* Crowdfunding And Investment Program: 2% Daily ROI up to 200%.
* Referral Program
* 1st Level = 10%
* 2nd Level = 5%
* 3rd Level = 3%
...
contract TronNova is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 60;            // 6% Team, Operation & Development
    uint256 public constant MARKETING_RATE = 20;            // 2% Marketing
    ...
    uint256 public constant PLAN_TERM = 100 days;           // 100 Days
    uint256 public constant CONTRACT_LIMIT = 800;           // 20% Unlocked for Withdrawal Daily
    uint256 public constant ACTIVATION_TIME = 1612310399;   // Date activation  Tuesday, 2 February 2021 23:59:59
    ...
    function invest(uint256 _referrerCode) isActivated public payable {
