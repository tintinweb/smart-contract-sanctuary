...
contract IRewardDistributionRecipient is Ownable {
    ...
    function modifyRewardRate(uint256 reward) external;
...
// TSS-TRX LP pool, stake TSS-TRX LP, reward TSS
contract TSStrxLP_250_TokenPool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    constructor() public{
        ...
        rewardRate = uint(685 * (10 ** 18)) / 1 days;
    }
    ...
    function modifyRewardRate(uint256 reward) external onlyRewardDistribution updateReward(address(0))
    {
