...
contract TRXFORD {
    ...
    constructor() public {
        ...
        ref_bonuses.push(600);
        ref_bonuses.push(400);
        ref_bonuses.push(300);
        ...
        if (
            ...
            for (uint256 i = 0; i < 10; i++) {
                if (_upline != address(0)) {
                    if (i == 0) {
                        usersLevel[_upline].level1 = usersLevel[_upline]
                            .level1
                            .add(1);
                    } else if (i == 1) {
                        usersLevel[_upline].level2 = usersLevel[_upline]
                            .level2
                            .add(1);
                    } else if (i == 2) {
                        usersLevel[_upline].level3 = usersLevel[_upline]
                            .level3
                            .add(1);
                    } else if (i == 3) {
                        usersLevel[_upline].level4 = usersLevel[_upline]
                            .level4
                            .add(1);
                    } else if (i == 4) {
                        usersLevel[_upline].level5 = usersLevel[_upline]
                            .level5
                            .add(1);
                    } else if (i == 5) {
                        usersLevel[_upline].level6 = usersLevel[_upline]
                            .level6
                            .add(1);
                    } else if (i == 6) {
                        usersLevel[_upline].level7 = usersLevel[_upline]
                            .level7
                            .add(1);
                    } else if (i == 7) {
                        usersLevel[_upline].level8 = usersLevel[_upline]
                            .level8
                            .add(1);
                    } else if (i == 8) {
                        usersLevel[_upline].level9 = usersLevel[_upline]
                            .level9
                            .add(1);
                    } else if (i == 9) {
                        usersLevel[_upline].level10 = usersLevel[_upline]
                            .level10
                            .add(1);
                    }
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        if (users[_addr].deposit_time > 0) {
            ...
            require(
                _amount >= cycles[0] && (_amount % cycles[0]) == 0,
                "Bad amount"
            );
            total_users++;
        } else
        ...
        returns (uint256 payout, uint256 max_payout)
    {
        ...
        if (users[_addr].deposit_payouts < max_payout) {
            uint8 roi_per = 15;
            payout =
                (((users[_addr].deposit_amount * roi_per) / 1000) *
    ...
    */
    ...
    function poolTopInfo()
        external
        view
        returns (address[5] memory addrs, uint256[5] memory deps)
    {
        for (uint8 i = 0; i < pool_bonuses.length; i++) {
            if (pool_top[i] == address(0)) break;
    ...
    {
        return (
            usersLevel[userAddress].level1,
            usersLevel[userAddress].level2,
            usersLevel[userAddress].level3,
            usersLevel[userAddress].level4,
            usersLevel[userAddress].level5,
            usersLevel[userAddress].level6,
            usersLevel[userAddress].level7
        );
    }

    function getUserNextLevelCount(address userAddress)
        public
        view
        returns (
            uint256 level8,
    ...
    {
        return (
            usersLevel[userAddress].level8,
            usersLevel[userAddress].level9,
            usersLevel[userAddress].level10
        );
    }
}