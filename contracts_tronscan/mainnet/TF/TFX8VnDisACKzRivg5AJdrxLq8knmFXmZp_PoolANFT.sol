...
//SourceUnit: PoolANFT.sol

pragma solidity ^0.5.8;
import "./IJustswapExchange.sol";
contract PoolANFT {

    address payable public  constant exchange_addr = address(0x4145e9243fDa43537E5e2E489c2A8fb53f1Dc86659) ;




    function addLiqui(uint256 min_liquidity, uint256 max_tokens, uint256 deadline)  public payable returns (uint256){

        uint256 res =  IJustswapExchange(exchange_addr).addLiquidity(min_liquidity, max_tokens, deadline);
