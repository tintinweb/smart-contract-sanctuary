...
contract MixsToken is StandardToken {
    string public name = "STREAMIX";
    string public symbol = "MIXS";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 900000000 * 10 ** uint256(decimals);
