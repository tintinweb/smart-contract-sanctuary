...
contract MAXIMA is TRC20, TRC20Detailed, TRC20Burnable, Ownable {

    constructor() TRC20Detailed("MAXIMA", "MAX", 8) public {
        _mint(msg.sender, 666000000 * (10 ** uint256(decimals())));
    }
