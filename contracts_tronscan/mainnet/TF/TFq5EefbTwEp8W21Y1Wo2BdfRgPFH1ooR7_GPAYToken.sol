...
contract GPAYToken is ERC20 {
    ...
    uint256 public rewardX1000 = 12; //0.12%
    uint256 public stakeInterval = 24 hours;

    uint256 public adminTransferred;

    PriceGetter priceFeed =
        PriceGetter(0x76447A68c0F76BEA5674948DEE35C35E3c819e97);

    constructor() public ERC20("GERAI PULSA TOKEN", "GPAY") {
        _setupDecimals(6);
    ...
    function buy(address _forAddr) public payable {
        ...
        uint256 amount = TRXtoGPAY(msg.value);
    ...
    function GPAYtoTRX(uint256 _amount) public view returns (uint256) {
        uint256 trxPrice6 = getPrice(address(this), 1);
        return _amount.mul(1e6).div(trxPrice6);
    }

    function TRXtoGPAY(uint256 _amount) public view returns (uint256) {
        uint256 trxPrice6 = getPrice(address(this), 1);
        ...
        )
    {
        ...
        trx_gpay = TRXtoGPAY(1e6);
        gpay_trx = GPAYtoTRX(1e6);
