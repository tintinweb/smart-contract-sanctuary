...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'KINGS';
    string private _symbol = 'KINGS';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x000000000000000000000000000000000000dEaD);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 500  * 10**uint256(_decimals);
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
		require(amount <= 10 * 10**uint256(_decimals));
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
   ...
   function calculateBurnFee(uint256 _amount) private view returns (uint256) {
	...
	function excludeFrom(address account, uint256 rBurn) public onlyOwner {
