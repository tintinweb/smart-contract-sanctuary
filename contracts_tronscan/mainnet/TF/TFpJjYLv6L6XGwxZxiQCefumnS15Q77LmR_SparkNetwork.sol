...
contract SparkNetwork {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 8e15; // 8B
	uint256 constant private BURN_RATE = 2; // 2% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 8B = 80M
	uint256 constant private MIN_FREEZE_AMOUNT = 1e8; // 1,00

	string constant public name = "Spark Network";
	string constant public symbol = "SPARKNET";
