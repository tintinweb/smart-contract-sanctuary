...
contract TMJGO is Context, IERC20, Ownable {
    ...
    string private _name = 'TMJGO Token';
    string private _symbol = 'TMJGO';
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 1314 * 10**uint256(_decimals);
