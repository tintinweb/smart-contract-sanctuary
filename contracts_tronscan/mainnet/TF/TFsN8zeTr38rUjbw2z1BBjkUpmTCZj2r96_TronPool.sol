...
contract TronPool {
    ...
    uint REGESTRATION_FESS = 135 trx;
    uint pool1_price = 40 trx;
    ...
    constructor(address payable _creator1,address payable _FeeAddress) public {
        ownerWallet = msg.sender;
           creator1=_creator1;
        FeeAddress=_FeeAddress;
        LEVEL_PRICE[1] = 40 trx;
        ...
        LEVEL_PRICE[8] = 64800 trx;
        LEVEL_PRICE[9] = 12800 trx;
    ...
    function buyPool1(uint _referrerID) public payable {
        ...
        FeeAddress.transfer((msg.value.mul(5)).div(100));
    ...
    function buyPool2(address sender,uint value) internal {
        ...
        require(value == 105 trx, 'Incorrect Value');
       ...
       FeeAddress.transfer((pool2_price.mul(5)).div(100));
    ...
    function buyPool3(address sender,uint value) internal {
        ...
        require(value == 210 trx, 'Incorrect Value');
        ...
        FeeAddress.transfer((pool3_price.mul(5)).div(100));
    ...
    function buyPool4(address sender,uint value) internal {
        ...
        require(value == 420 trx, 'Incorrect Value');
...
FeeAddress.transfer((pool4_price.mul(5)).div(100));
    ...
    function buyPool5(address sender,uint value) internal {
        ...
        require(value == 840 trx, 'Incorrect Value');
    ...
    FeeAddress.transfer((pool5_price.mul(5)).div(100));
    ...
    function buyPool6(address sender,uint value) internal {
        ...
        require(value == 1680 trx, 'Incorrect Value');
    ...
    FeeAddress.transfer((pool6_price.mul(5)).div(100));
    ...
    function buyPool7(address sender,uint value) internal {
        ...
        require(value == 3360 trx, 'Incorrect Value');
    ...
    FeeAddress.transfer((pool7_price.mul(5)).div(100));
    ...
    function buyPool8(address sender,uint value) internal {
        ...
        require(value == 6720 trx, 'Incorrect Value');
     ...
     FeeAddress.transfer((pool8_price.mul(5)).div(100));
    ...
    function buyPool9(address sender,uint value) internal {
        ...
        require(value == 13440 trx, 'Incorrect Value');
        ...
        FeeAddress.transfer((pool9_price.mul(5)).div(100));
