...
contract ShillitApp is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 9999999999;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Shillit App", "SHILL", 6){
        	owner = msg.sender;	
