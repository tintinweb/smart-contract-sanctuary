...
contract Fastron is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 100; //per thousand
    uint256 public constant MARKETING_RATE = 100;
    uint256 public constant REFERENCE_RATE = 140;
    ...
    uint256 public constant REFERRER_CODE = 6609;
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(30, 0)); //5% , lifetime
    }
