...
contract SevenPeak {
    ...
    function deposit(address _referral) external payable {
        require(msg.value >= 20e7, "Zero amount");
       ...
       if(player.deposits.length == 0){
        ...
        _referralPayout(msg.sender, msg.value.mul(15).div(100));

        owner.transfer(msg.value.mul(25).div(100));    // 25% to Admin
