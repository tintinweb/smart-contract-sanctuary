...
contract phoenix{
    ...
    function lockyCheck(address ply) internal{
        ...
        for(uint256 i=0;i<len;i++){
            ...
            if(totalIn > plyRel[dl.luckList[i]].pr_totalSonInversted){
                newList[i] = ply;
                if(i !=3){
        ...
        //if(totalIn > DayLucky[Days].referralsAmount1){
            ...
            dl.referralsAmount1 = plyRel[dl.luck1].pr_totalSonInversted;
            dl.luck2 = dl.luckList[1];
            dl.referralsAmount2 = plyRel[dl.luck2].pr_totalSonInversted;
            dl.luck3 = dl.luckList[2];
            dl.referralsAmount3 = plyRel[dl.luck3].pr_totalSonInversted;
            dl.luck4 = dl.luckList[3];
            dl.referralsAmount4 = plyRel[dl.luck4].pr_totalSonInversted;
