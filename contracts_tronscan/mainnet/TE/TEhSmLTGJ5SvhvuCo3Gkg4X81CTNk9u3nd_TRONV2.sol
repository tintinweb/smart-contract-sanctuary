//SourceUnit: TRON3GET.sol

/*
 *	TRON V2 - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://tronv2.com                                         │
 *   │                                                                       │  
 *   │   Telegram Public Group: https://t.me/tronv2group                     |
 *   |                                                                       |            
 *   |   E-mail: support@tronv2.com                                          |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *
 *   - Officially registered company name: TRON V2 LIMITED (#12890649)
 *   - Company status: https://beta.companieshouse.gov.uk/company/12890649
 *   - Certificate of incorporation: https://tronv2.com/img/certificate.pdf
 *
 *
 *   ────────────────────────────────────────────────────────────────────────
 *
