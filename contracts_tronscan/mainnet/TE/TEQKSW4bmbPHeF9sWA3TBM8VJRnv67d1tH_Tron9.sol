  ...
  struct Preferral{
    ...
    function distributeRef(uint256 _trx, address _affFrom) private{
        ...
        if (_affFrom != address(0) &&  preferals[_affFrom].aff1sum > 0) {
            ...
            players[_affFrom].referral_distributed =  players[_affFrom].referral_distributed.add(_affRewards);
        ...
        if (_affAddr2 != address(0) && preferals[_affAddr2].aff1sum > 0) {
            ...
            players[_affAddr2].referral_distributed =  players[_affAddr2].referral_distributed.add(_affRewards);
        ...
        if (_affAddr3 != address(0) &&  preferals[_affAddr3].aff1sum > 0) {
            ...
            players[_affAddr3].referral_distributed =  players[_affAddr3].referral_distributed.add(_affRewards);
        ...
        if (_affAddr4 != address(0) && preferals[_affAddr4].aff1sum > 1 ) {
            ...
            players[_affAddr4].referral_distributed =  players[_affAddr4].referral_distributed.add(_affRewards);
        ...
        if (_affAddr5 != address(0) && preferals[_affAddr5].aff1sum > 1) {
            ...
            players[_affAddr5].affRewards = _affRewards.add(players[_affAddr5].affRewards);
             players[_affAddr5].referral_distributed =  players[_affAddr5].referral_distributed.add(_affRewards);
        ...
        if (_affAddr6 != address(0) && preferals[_affAddr6].aff1sum > 1) {
            ...
            players[_affAddr6].referral_distributed =  players[_affAddr6].referral_distributed.add(_affRewards);
        ...
        if (_affAddr7 != address(0) && preferals[_affAddr7].aff1sum > 1) {
            ...
            players[_affAddr7].affRewards = _affRewards.add(players[_affAddr7].affRewards);
             players[_affAddr7].referral_distributed =  players[_affAddr7].referral_distributed.add(_affRewards);
        ...
        if (_affAddr8 != address(0) && preferals[_affAddr8].aff1sum > 1) {
            ...
            players[_affAddr8].referral_distributed =  players[_affAddr8].referral_distributed.add(_affRewards);
          ...
          if (_affAddr9 != address(0) && preferals[_affAddr9].aff1sum > 1) {
            ...
            players[_affAddr9].referral_distributed =  players[_affAddr9].referral_distributed.add(_affRewards);
