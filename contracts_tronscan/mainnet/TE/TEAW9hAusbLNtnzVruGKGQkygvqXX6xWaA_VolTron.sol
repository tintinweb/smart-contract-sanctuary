...
contract VolTron {
	...
	uint256 constant public CONTRACT_BALANCE_STEP = 777000 trx;
	uint256 constant public TIME_STEP = 1 days;
	uint256 constant public BASE_PERCENT = 77;  // 7.7%
	uint256 constant public MARKETING_FEE = 100; // 10%
	uint256 constant public PROJECT_FEE = 100;   // 10%
	uint256[] public REFERRAL_PERCENTS = [70, 20, 5]; // 7%, 2%, 0.5%
