...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "Dzire Token"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "DZR".
   */
...
contract TRXDzireToken is CommonToken {

  constructor() CommonToken("Dzire Token", "DZR", 6, 1000000) public {}
