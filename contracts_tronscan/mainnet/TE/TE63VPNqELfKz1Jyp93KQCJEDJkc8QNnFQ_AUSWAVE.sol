 ...
 * `TRC20` functions.
 */
contract AUSWAVE is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("AUSWAVE", "AUSWAVE", 18) {
        _mint(msg.sender, 1000000000 * (9 ** uint256(decimals())));
    }
}
