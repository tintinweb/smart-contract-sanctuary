...
contract JXBToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 100000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'JXB Token';
    string private _symbol = 'JXB';
    uint8 private _decimals = 8;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41dd3c150a0bb45ef7d382ac89e7aa8757d6b9bf38);
