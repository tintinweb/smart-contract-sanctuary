...
contract PYCToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function PYCToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
