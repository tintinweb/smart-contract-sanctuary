...
contract TopiaFreeze is owned 
{
    ...
    */
    ...
    function unfreezeTopia(uint256 amountToUnFreeze, bool forceUnfreeze) public returns (bool)
    {
        ...
        uint256 freezingTier = userFrozens[caller].freezingTier;
        if (! forceUnfreeze)
        {
        ...
        userFrozens[caller].unFreezingAmount = amountToUnFreeze;
    ...
    function releaseTopia() public returns (bool)
    {
        ...
        require(now - userFrozens[caller].unFreezingTime >= 86400 , "can not release before 24 Hr.");
