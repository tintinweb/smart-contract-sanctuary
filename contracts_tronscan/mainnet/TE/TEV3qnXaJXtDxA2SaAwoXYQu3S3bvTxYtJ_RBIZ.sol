 ...
 */
contract RBIZ is StandardToken, ERC677Token,Ownable {
   using SafeMath for uint256;
  string public constant name = 'RBIZ';
  string public constant symbol = 'RBIZ';
  uint8 public constant decimals = 6;
  uint256 public  totalSupply = 2*10**13; // 
