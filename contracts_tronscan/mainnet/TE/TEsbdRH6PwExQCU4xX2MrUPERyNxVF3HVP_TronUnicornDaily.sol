//SourceUnit: TronUnicornDaily.sol

pragma solidity 0.4.25;

contract TronUnicornDaily {
    ...
    uint256 public releaseTime = 1607957084;
    ...
    constructor() public {
        ...
        unicorn_price = 25000000;

        tarifs.push(Tarif(300, 1500));
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        unicorn.transfer(msg.value.mul(3).div(100));
