...
contract BLIFECoin is TRC20, TRC20Detailed, TRC20Mintable, TRC20Burnable, TRC20Pausable {

    address public staker;
    uint256 public transferFee = 0; // 0.001 % if feeDenominator = 10000
    uint256 public mintFee = 0; // 0.001 % if feeDenominator = 10000
    uint256 public feeDenominator = 0;
    ...
    constructor(address _staker)
        ...
        TRC20Mintable()
        TRC20Pausable()
        TRC20Detailed("BLIFE Coin", "BLI", 8)
        TRC20()
        public {
        staker = _staker;
    }
