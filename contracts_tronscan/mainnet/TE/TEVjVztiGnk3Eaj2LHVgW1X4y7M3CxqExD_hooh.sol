...
contract hooh is Context, IERC20, Ownable {
    ...
    string private _name = "WMSJ";
    string private _symbol = "WMSJ";
    uint8 private _decimals = 6;

    address private _burnPool = address(0x0);

    address private fundAddress =
        address(0x4104E85B525106F318B72CB84776E66BB858417C3C);
    ...
    uint256 public MAX_STOP_FEE_TOTAL = 1000000 * 10**uint256(_decimals);
