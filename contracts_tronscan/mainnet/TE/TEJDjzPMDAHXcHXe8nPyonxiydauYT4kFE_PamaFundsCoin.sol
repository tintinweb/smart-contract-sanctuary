...
contract PamaFundsCoin is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("PamaFundsCoin", "PFC", 6){
        require(gr != address(0), "invalid gr");
        _mint(gr, 10000 * 10000 * 10 ** 6);
    }
}
