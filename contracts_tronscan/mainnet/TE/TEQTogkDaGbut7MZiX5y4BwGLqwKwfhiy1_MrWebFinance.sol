...
contract MrWebFinance {
    ...
    */
    ...
    function depositToContract(uint256 _amount) public payable{
        require(msg.sender == tokenOwner, 'Token can only be deposited by token owner!');
        require(_amount > 0, "Amount can not be zero!");
        address contract_ = tokenAddr_;
        ERC20Interface =  IERC20(contract_);
        
        require(ERC20Interface.balanceOf(msg.sender) > 0, "Not enough amout to deposit!");
        
        ERC20Interface.transferFrom(tokenOwner, address(this), _amount);
    }
}