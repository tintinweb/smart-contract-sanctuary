...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (_totalSupply > 1000000*10**6){
            
            uint256 delta = _totalSupply.sub(1000000*10**6);
...
contract Token is ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("FY", "FY", 6) {
        _mint(msg.sender, 10526316 * (10 ** uint256(decimals())));
    }
}