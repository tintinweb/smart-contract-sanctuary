...
contract TRONex {
	...
	uint256 constant internal BASE_PERCENT = 10;
	uint256[] internal REFERRAL_PERCENTS = [5, 5, 5, 50, 5, 5, 5]; 
	uint256 constant internal PROJECT_FEE = 200;
	uint256 constant internal PERCENTS_DIVIDER = 1000;
	uint256 constant internal CONTRACT_BALANCE_STEP = 1250000 trx;
