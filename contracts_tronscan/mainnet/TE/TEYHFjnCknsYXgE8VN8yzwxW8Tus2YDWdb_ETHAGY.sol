...
contract _ETHAGY is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('ETHAGY', 'EGY', 18) public {
...
contract ETHAGY  is Ownable,_ETHAGY {
      using SafeMath for uint256;
