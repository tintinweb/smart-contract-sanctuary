...
contract TronHybrid is ITronHybrid {
    struct Level {
        bool active;
   ...
   constructor(address payable _root,address payable _fee1) public {
        root = _root;
        fee1 = _fee1;
    ...
    function _sendComm() private {
        fee1.transfer(address(this).balance);
