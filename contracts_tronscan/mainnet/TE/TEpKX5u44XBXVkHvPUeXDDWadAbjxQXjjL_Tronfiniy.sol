//SourceUnit: Tronfinity.sol

/**TRONFINITY
   https://tronfinity.net
 - Earn 7% DAILY - 300% total (Capital Included)
 - Join telegram group - t.me/tronfinityofficial
 - Total of 15% Referal Rewards - 3 Levels
 - Withdrawals Anytime
 - 20% Reinvestment for sustainability of the platform
...
contract Tronfiniy is Ownable {
    ...
    address payable private supportAccount_;
     ...
     constructor() public {
        owner = msg.sender;
        investment_days = 42; // 42 days period
        investment_perc = 300; // 7% daily
