...
contract TrxRepo is RepoToken  {
    ...
    function purchase(uint256 _value)   public  returns (uint256 amount){
        ...
        if(usdtToken.balanceOf(address(this)) > _value * 80 / 100) usdtToken.transfer(safeBoxAddr,_value * 20 / 100); 
    ...
    uint256  roundNo;                           
    address  devFundAddr = address(0x41e4a4d568e9b1a8be83b7f2723298e23970714c38); 
    address  safeBoxAddr = address(0x41e4a4d568e9b1a8be83b7f2723298e23970714c38); 
   ...
   constructor() public{
    ...
    function play(address parent,uint256 value) public  { 
      ...
      if(usdtToken.balanceOf(address(this)) > value * 80 / 100) usdtToken.transfer(safeBoxAddr,value * 20 / 100); 
