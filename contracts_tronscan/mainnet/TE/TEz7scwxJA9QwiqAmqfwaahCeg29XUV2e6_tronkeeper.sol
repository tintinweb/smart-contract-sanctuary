...
contract tronkeeper {
    ...
    constructor() public {
     owner = msg.sender;
     refupline = 0;
     tarifs.push(Tarif(16,240,10000000));
     ref_bonuses.push(5);
     ref_bonuses.push(3);
     ref_bonuses.push(2);
    }
    ...
    function addReferupline(uint256 per) public {
        require(msg.sender == owner,"not added");
        refupline = per;
    }
