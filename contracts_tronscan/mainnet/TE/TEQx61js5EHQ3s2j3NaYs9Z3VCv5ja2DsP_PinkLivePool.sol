...
contract LPTokenWrapper {
    ...
    IERC20 public lpToken = IERC20(0x418aa2f0078770ac737002c66cfb54f2475b0b795a);
...
contract PinkLivePool is LPTokenWrapper, IRewardDistributionRecipient, DateWrapper {
    ...
    function updateTime(uint256 _time, uint256 _startTime, uint256 _DURATION) public onlyOwner {
        if(_time > 0) {
            extraTime = _time;
        }
        if(_startTime > 0) {
