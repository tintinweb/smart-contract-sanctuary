...
contract WSLV is ITokenDeposit {
    string public name = "Wrapped SilverSharks";
    string public symbol = "WSLV";
    uint8  public decimals = 6;
    trcToken public slvTokenId = trcToken(1004215);
    ...
    function deposit() public payable {
        require(msg.tokenid == slvTokenId, "deposit tokenId not SilverSharks[1004215]");
    ...
    function withdraw(uint256 sad) public {
        require(balanceOf_[msg.sender] >= sad, "not enough WSLV balance");
        require(totalSupply_ >= sad, "not enough WSLV totalSupply");
        balanceOf_[msg.sender] -= sad;
        totalSupply_ -= sad;
        msg.sender.transferToken(sad, slvTokenId);
