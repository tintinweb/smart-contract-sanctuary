...
// SalmonToken with Governance.
interface SalmonTokenI {
...
contract SalmonToken is TokenBase, IERC20, Ownable {

    string  private _name     = "SalmonToken";
    string  private _symbol   = "SLM";
    uint8   private _decimals = 18;

    function mint(address _to, uint256 _amount) public onlyOwner {
        emit Transfer(owner(), _to, _amount);
        _totalSupply = _totalSupply.add(_amount);
        _balance[_to] = _balance[_to].add(_amount);
    }

    function burn(uint _amount) public {
         require(_balance[msg.sender] >= _amount, "ERR_INSUFFICIENT_BAL");
         _balance[msg.sender] = _balance[address(this)].sub(_amount);
