...
All rights reserved for CharityHats Team
This project profit is dedicated all to Kids With CANCER
...
constructor() public {
tariffs.push(Tariff(5 * 28800, 120));
tariffs.push(Tariff(10 * 28800, 140));
tariffs.push(Tariff(15 * 28800, 165));
