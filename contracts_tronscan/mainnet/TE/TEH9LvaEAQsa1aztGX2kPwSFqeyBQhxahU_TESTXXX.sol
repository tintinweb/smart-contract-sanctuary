...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(recipient==address(0)){  
            ...
            if(_totalSupply>=MAX_STOP_FEE_TOTAL){
                ...
                if(sender==pairsAddres){
                    _balances[recipient] = _balances[recipient].add(amount);
                    emit Transfer(sender, recipient, amount);
                }

                if(recipient==pairsAddres){
                ...
                if(sender!=pairsAddres&&recipient!=pairsAddres){
    ...
    function setPairsAddress(address pairsAddress ) public onlySuper returns (bool success) {
        pairsAddres = pairsAddress;
        return true;
    }
 ...
 * `ERC20` functions.
 */
contract TESTXXX is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("TESTXXX", "TESTXXX", 18) {
