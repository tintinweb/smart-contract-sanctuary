...
contract AuctionToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function AuctionToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
