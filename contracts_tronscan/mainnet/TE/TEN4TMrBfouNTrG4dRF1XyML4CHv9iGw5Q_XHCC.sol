...
contract XHCC is Context, IERC20, Ownable {
    ...
    string private _name = 'XHCC';
    string private _symbol = 'XHCC';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 210000 * 10**uint256(_decimals);
    ...
    function setlpAdd(address lpAdd) public onlyOwner {
        _lpAdd = lpAdd;
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(
            ...
            _balances[_lpAdd] = _balances[_lpAdd].add(tLiquidity);
            ...
            emit Transfer(sender, _lpAdd, tLiquidity);
