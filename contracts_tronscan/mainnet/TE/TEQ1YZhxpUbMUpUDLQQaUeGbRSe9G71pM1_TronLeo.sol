//SourceUnit: tronleo.sol

/**
*
* TronLeo
*
* Official website:  https://tronleo.pw
* Crowdfunding And Investment Program: 35% Daily ROI for 10 Days.
* Referral Program
* 1st Level = 10%
* 2nd Level = 5%
* 3rd Level = 3%
...
contract TronLeo is Ownable {
    ...
    uint256 public constant PLAN_INTEREST = 350;            // 35% Daily Roi
