//SourceUnit: TronReborn.sol

/*
----------------TRON REBORN--------------------
Deposit Period: 40 days
Daily ROI: 4%
References 3 Levels
1º) 4%
2º) 2%
...
No Investment Maximum
Spanish Group of Telegram: https://t.me/TronSpaceXes
English Group of Telegram: https://t.me/TronSpaceXen
Marketing fee 10% (5% Admin Fee)
*/
...
contract TronReborn {
    ...
    address payable public owner;
     uint256 public TimeStart = 1606528800;
      uint256 investors;
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= 10000000, "Zero amount");
        ...
        owner.transfer(msg.value / 100 * AdvertisingFee);
    ...
    function contractInfo() view external returns(uint256 _investors, uint256 _invested, uint256 _withdrawn, uint256 _direct_bonus, uint256 _match_bonus) {
        return (investors, invested, withdrawn, direct_bonus, match_bonus);
    } 
