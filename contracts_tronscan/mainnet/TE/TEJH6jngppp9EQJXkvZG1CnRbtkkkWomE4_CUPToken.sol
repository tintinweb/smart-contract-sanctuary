...
contract CUPToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function CUPToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
