...
contract TrxBull {
	...
	uint256 public REFERRAL_PERCENTS_Total = 180;
	uint256 constant public PROJECT_FEE = 80;
	uint256 constant public REINVEST_PERCENT = 200;
	...
	function reinvest(address referrer, uint8 plan,uint256 amountInvest,address userAdress) public payable {
		...
		totalTrxBull = totalTrxBull.add(amountInvest);
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		totalTrxBull = totalTrxBull.add(msg.value);
