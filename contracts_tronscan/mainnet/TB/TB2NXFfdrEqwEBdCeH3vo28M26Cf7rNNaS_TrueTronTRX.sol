//SourceUnit: TrueTronTRX.sol

pragma solidity ^0.4.25;
/*
------------------------------------
Crowdfunding & Crowdsharing project
 Website :  https://truetron.net  
 Chanel :  https://t.me/truetron21
------------------------------------ 
 CONTRACT MANAGEMENT:
------------------------------------
1 to 7% daily ROI until 200% of your active deposit
5% direct referral 
3% referred level 2 
1% referred level 3 
1% referred level 4 
------------------------------------
25% Reinvest to generate compound interest
------------------------------------
*/

contract TrueTronTRX {
    ...
    function getProfit(address _addr) public view returns (uint) {
     ...
     function getContractBalanceRate() public view returns (uint256) {
		...
		uint256 contractBalancePercent = contractBalance.div(500000000000); 
