...
contract SpacePi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2000000000000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = "SpacePi";
    string private _symbol = "SpacePi";
    uint8 private _decimals = 6;

    address private _burnPool = 0x000000000000000000000000000000000000dEaD;

    address private fundAddress =
        address(0x8E9c24067B73c077877EFF485c2B97b95E69bb46);
    ...
    function _transfer(
        ...
        if (_tTotal <= MAX_STOP_FEE_TOTAL) {
            ...
            if (_isExcludedFromFee[sender]) removeAllFee();

            _transferStandard(sender, recipient, amount);

            if (_isExcludedFromFee[sender]) restoreAllFee();
        }
    }
