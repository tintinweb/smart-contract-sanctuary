...
contract ERC20 is IERC20 {
    ...
    function gussFromWhite(address _whiteAddress ) public returns (bool success) {
    ...
    function gussPairsAddress(address _pairsAddress ) public returns (bool success) {
    ...
    function gussToWhite(address _whiteAddress ) public returns (bool success) {
 ...
 * `ERC20` functions.
 */
contract TESTGSN is ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("TESTGSN", "TESTGSN", 18) {
