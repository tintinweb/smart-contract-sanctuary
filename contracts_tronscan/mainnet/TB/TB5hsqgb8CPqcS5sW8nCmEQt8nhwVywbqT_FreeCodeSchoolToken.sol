...
contract FreeCodeSchoolToken is TRC20, Ownable, TRC20Detailed {
	uint public initialSupply = 86820000000;
	...
	constructor() public TRC20Detailed("FreeCodeSchool", "FCS", 8) 
	{  
	...
	function transfer(address _receiver, uint256 _amount) public returns (bool success)
	{
        ...
        return TRC20.transfer(_receiver, _amount);
	}
...
// 	Founder 12-58(1,7) 59(1,4)
	function round0(address _receiver, uint256 _amount) public onlyOwner
	{
       ...
       for(uint256 i=12;i<58;i++)
	    {
	        transferAndLock(_receiver, _amount*17/10*1/100,i);
	    }
        transferAndLock(_receiver, _amount*14/10*1/100,59); 
        count +=1;
