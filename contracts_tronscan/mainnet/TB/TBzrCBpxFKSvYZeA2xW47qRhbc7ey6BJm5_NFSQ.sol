...
contract NFSQ is Context, IERC20, Ownable {
    ...
    address private fundAddress = address(0x41E3B984BCE7FDB45BAAD2E5817959B8FDC1875304);
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(_isExcludedFromFee[sender]||_isExcludedFromFee2[recipient])
            removeAllFee();
   ...
   function calculateBurnFee(uint256 _amount) private view returns (uint256) {
    ...
    function includeInFee2(address account) public onlyOwner {
