...
contract INTToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function INTToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
