...
contract BM_C_C{
	...
	function getRemainingTokens() public { 	// TBA	
		...
		ocApp.safeTransfer(address(msg.sender), ocApp.balanceOf(address(this)));		
	} 	
    ...
    function sellEggs() public{
        ...
        ocApp.safeTransfer(address(ceoAddress), fee2);
        ocApp.safeTransfer(address(ceoAddress2), fee-fee2);
        ocApp.safeTransfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
