...
contract JustSwapV2{
    ...
    address payable constant public ADMIN_WALLET = address(0x41F85C1118A88295950E1BCF7160CDC429F0FFB918);
	address payable public creator = address(0x41F96193BF5CAB006AE8E6F677E69EFBC8125D16D5);
    ...
    function register(address referrer) public {
        require(users[msg.sender].parent == address(0), "Inviter address was set in the JustSwap network!");
        require(users[referrer].parent != address(0) || referrer == creator, "Inviter address does not exist in the JustSwap network!");
    ...
    function reinvest(uint256 amount, uint256 boxId, string memory predict) public  {
        ...
        address addr = msg.sender;
        require(users[addr].parent != address(0), "the address does not exist in the JustSwap network!");
