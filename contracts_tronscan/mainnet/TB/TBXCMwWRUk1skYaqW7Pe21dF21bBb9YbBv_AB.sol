...
contract AB is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal  {
        ...
        if( transferCheckerAddress != address(0)){
            (uint256 transferToAmount, uint256 transferToFeeDistributorAmount) = ITransferFee(transferCheckerAddress).calculateAmountsAfterFee(sender, recipient, amount);
            ...
            if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
                ...
                if(feeDistributor != address(0)){
                    IVault(feeDistributor).addRewards(transferToFeeDistributorAmount);
                }
            }
        }
        else{
