...
contract ERC20 is Context, IERC20 {
    ...
    function setCap(uint256 x) internal {
        _totalSupplycap = x;
    }
 ...
 * allowances. See {IERC20-approve}.
 */
contract ERC20X is Context, IERC20 {
    using SafeMath for uint256;
 ...
 * `ERC20` functions.
 */
contract Ori20 is ERC20X, ERC20Detailed, MinterRole {
    uint256 private _cap;

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Champion Club", "CC", 8) {
...
//SourceUnit: WhitelistedRole.sol
