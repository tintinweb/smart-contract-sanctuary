...
contract ERC20 is IERC20, Ownable {
    ...
    function _burn(address account, uint256 value) internal {
        require(account != address(0), "CoinFactory: burn from the zero address");
...
contract CoinFactory is ERC20, CoinFactoryAdminRole {
    ...
    function burn(address account, uint256 amount) public onlyCoinFactoryAdmin returns (bool) {
...
contract BTCPayToken is ERC20, ERC20Pausable, CoinFactory, Blacklist {
    ...
    constructor (uint256 initialSupply, string memory _name, string memory _symbol, uint8 _decimals) public {
        ...
        symbol = _symbol;
        decimals = _decimals;
        super._init(msg.sender, initialSupply * 10 ** uint256(decimals));
    }
