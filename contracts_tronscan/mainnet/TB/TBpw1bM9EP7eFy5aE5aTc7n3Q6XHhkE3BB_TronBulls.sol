...
contract TronBulls {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(14, 146));
        tarifs.push(Tarif(15, 151));
        tarifs.push(Tarif(16, 156));
        tarifs.push(Tarif(17, 161));
        tarifs.push(Tarif(18, 166));
        tarifs.push(Tarif(19, 171));
        tarifs.push(Tarif(20, 176));
        tarifs.push(Tarif(21, 181));
        tarifs.push(Tarif(22, 186));
        tarifs.push(Tarif(23, 191));
        tarifs.push(Tarif(24, 196));
        tarifs.push(Tarif(25, 201));
        tarifs.push(Tarif(26, 206));
        tarifs.push(Tarif(27, 211));
        tarifs.push(Tarif(28, 216));
        tarifs.push(Tarif(29, 221));
        tarifs.push(Tarif(30, 226));
    ...
    function deposit(uint8 _tarif, address _upline) public payable {
        require(_tarif >= 0 && _tarif <=16, "Wrong Tarif");
