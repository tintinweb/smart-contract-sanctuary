...
contract Staking is Ownable {
    ...
    function createStake(uint256 _stake) public {
        avv.transferFrom(msg.sender, address(this), _stake);
    ...
    function removeStake(uint256 _stake) public {
        ...
        avv.transfer(address(this), _stake);
    }
        ...
        returns (bool, uint256)
    {
        for (uint256 index = 0; index < stakeholders.length; index++) {
            if (_address == stakeholders[index]) return (true, index);
        }
        return (false, 0);
    }
    ...
    function withdrawReward() public {
        ...
        avv.transfer(address(this), reward);
    }
