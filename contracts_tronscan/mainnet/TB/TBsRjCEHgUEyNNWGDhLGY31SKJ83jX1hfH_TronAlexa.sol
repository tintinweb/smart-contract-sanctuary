...
contract TronAlexa is Ownable {
    ...
    mapping(uint256 => Objects.LevelIncome) public uid2LevelIncome;
    ...
    function _calculateReferrerReward(uint256 _uid, uint256 _investment, uint256 _referrerCode) private {
        ...
        if (_referrerCode != 0) {
            ...
            if (_ref1 != 0) {
                ...
                uid2LevelIncome[_ref1].level1RefAmount = uid2LevelIncome[_ref1].level1RefAmount.add(_refAmount);
            ...
            if (_ref2 != 0) {
                ...
                uid2LevelIncome[_ref2].level2RefAmount = uid2LevelIncome[_ref2].level2RefAmount.add(_refAmount);
            ...
            if (_ref3 != 0) {
                ...
                uid2LevelIncome[_ref3].level3RefAmount = uid2LevelIncome[_ref3].level3RefAmount.add(_refAmount);
            ...
            if (_ref4 != 0) {
                _refAmount = (_investment.mul(REFERENCE_LEVEL4_RATE)).div(1000);
                 uid2LevelIncome[_ref4].level4RefAmount = uid2LevelIncome[_ref4].level4RefAmount.add(_refAmount);
            ...
            if (_ref5 != 0) {
                ...
                uid2LevelIncome[_ref5].level5RefAmount = uid2LevelIncome[_ref5].level5RefAmount.add(_refAmount);
