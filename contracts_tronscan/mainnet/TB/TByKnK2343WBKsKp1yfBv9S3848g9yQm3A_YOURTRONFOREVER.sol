//SourceUnit: YOURTRON10.sol

pragma solidity 0.4.25;

contract YOURTRONFOREVER {
    ...
    uint256   public investment_days;
    ...
    constructor() public {
        ...
        investment_days = 360;  //360 DAYS  10% PERCENT DAILY
        investment_perc = 3600; //3600%
        ...
        //soft_release = 1617530400;  // April 4 2021
        //full_release = 1617532200;
    }
...
modifier onlyOwner() {
    ...
    function deposit(address _referral) external payable {
        ...
        owner.transfer(msg.value.mul(12).div(100));  //12% DEV marketing and mods
