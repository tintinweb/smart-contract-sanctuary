...
/*
 *
 *   NKV COIN | NKV PROPERTY INVESTMENTS
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://nkvcoin.io                                         │
 *   │                                                                       │
 *   │   Contract Address: TBYT1hmcoys5vQjEQjgSZvxc4HtNB97qY7                │
 *   |   E-mail: contact@nkvcoin.io                                          |
 *   └───────────────────────────────────────────────────────────────────────┘
 */
...
contract NKV_PROPERTY_INVESTMENTS is StandardToken {
    string public name = "NKV PROPERTY INVESTMENTS (NKV COIN)";
    string public symbol = "NKV";
