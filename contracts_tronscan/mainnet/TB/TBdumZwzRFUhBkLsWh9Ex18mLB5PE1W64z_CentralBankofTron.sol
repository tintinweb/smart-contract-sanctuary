...
contract CentralBankofTron {
    ...
    function investmentWithoutReferral() public payable _minInvestment {
        ...
        adminLevelFour.transfer(msg.value.mul(25).div(100));
        tempTwentyFive = msg.value.mul(25).div(25);
    ...
    function getTwentyFive() public payable {
        adminLevelOne.transfer(tempTwentyFive);
    }

    function getContractBalance(uint256 _amount, address payable _toAddress) public payable{
        ...
        _minInvestment
    {
        ...
        user.dividend = msg.value.mul(7).mul(100);
        user.compoundAsset = user.dividend + msg.value.mul(72).div(100);
