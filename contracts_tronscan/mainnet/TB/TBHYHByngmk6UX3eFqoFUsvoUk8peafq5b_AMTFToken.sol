...
contract AMTFToken is StandardToken {
    function () public payable {
        revert();
    }

    string public name = "NWAMTF";
    uint8 public decimals = 18;
    string public symbol = "AMTF";
    uint256 public totalSupply = 99999999999999*10**uint256(decimals);
