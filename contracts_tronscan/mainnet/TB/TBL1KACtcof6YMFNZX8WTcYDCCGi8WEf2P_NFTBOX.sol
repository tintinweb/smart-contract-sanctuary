...
contract NFTBOX is Context, ITRC20, Ownable {
    ...
    uint256 private constant _tTotal = 10**17 * 10**8;
    ...
    uint256 public numTokensSellToAddToLiquidity = 5* 10**10 * 10**8;

    string private constant _name = 'NFTBOX.FUN'; 
    string private constant _symbol = 'NFTBOX';
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        uint256 rate) = _getValues(amount, takeFee ? _taxFee : 0, takeFee ? _liquidityFee : 0);
