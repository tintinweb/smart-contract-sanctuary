//SourceUnit: tronxx.sol

 /*  Tronxx - Community Contribution pool with daily ROC (Return Of Contribution) based on TRX blockchain smart-contract technology. 
 ...
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://tronxx.io         								 │
 * 	 │																		 │
 *   │   Tronxx - Smart Sustainable Contract								 │
 *	 │                                                                       │
 *	 │	 Upto 7.5% Daily ROI					   							 │
 *	 │																		 │
 ...
 *   3) Invite your friends and earn some referral bonus. Help the smart contract balance to grow and have fun
 *   4) Withdraw earnings (dividends+referral) using our website "Withdraw" button 
 *
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral commission: 10% - 3% - 2% - 1% - 1% 
...
contract Tronxx {
	...
	function invest(address referrer) public payable returns(bool){
        ...
        if(users[msg.sender].deposits.length == 0){
            ...
            uint256 fees=(msg.value.div(1000)).mul(100);
	...
	function currentroi() view public returns(uint256){
	    uint256 _ROI;
	     uint256 contractbalance=address(this).balance;
	         if(contractbalance>2500000000000){
	             return _ROI=750;
	         }
	         else{
	             uint additional = contractbalance/500000000000;
