...
contract TMT is ERC20token, ERC677Token {
    string public name = "TMT MONEY";
    ...
    uint public devCommission = 12;
    uint public commissionDivisor = 100;
    uint private minuteRateMiltiplier = 115741; //DAILY 1% Multiplier 
    uint private releaseTime = 1595160000; //GMT: Sunday, 19 July 2020 г., 12:00:00
    ...
    constructor() public {
      owner = msg.sender;
	  _mint(owner, 10e6); // SEND 10 TMT FOR INITIALIZATION
    }
    ...
    function deposit(address payable _affAddr) public payable {
		...
		_mint(msg.sender, depositAmount.div(10)); // send 0.1 TMT for each TRX
