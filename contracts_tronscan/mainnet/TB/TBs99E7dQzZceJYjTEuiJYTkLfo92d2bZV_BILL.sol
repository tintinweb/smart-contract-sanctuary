...
contract BILL is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 18888 * 10**6;
    ...
    address private fundAddress = address(0x41c97107240c52e2a83a3bf2858ac64ec8024ae913);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 9444 * 10**uint256(_decimals);
