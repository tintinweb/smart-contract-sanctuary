...
contract Consts {
    ...
    string public constant TOKEN_NAME = "JSB BANK";
    string public constant TOKEN_SYMBOL = "JSB";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x4a46897A2BEf0C87cF2a2Ea2C8CaBf7322C15FB8;
    bool public constant CONTINUE_MINTING = true;
}


contract JSB_BANK is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
