...
contract MainContract{
	...
	uint256 public _ktNum = 0;
	uint256 public _ktMaxNum = 1000;
	...
	constructor() public {
		owner = msg.sender;
		zhaohui=IERC20(0x41e121c8c88feadacac692e34e424ed6b9d052f335);
		zbttoken=IERC20(0x411a5a32bd07c33cd8d9f4bd158f235613480c7eef);
		zbt=address(0x41e121c8c88feadacac692e34e424ed6b9d052f335);
	}
	modifier onlyOwner() {
	...
	function withDrawKtToken() public returns (bool){
		require(_ktNum<_ktMaxNum);
	...
	function setKtmax(uint256 ktMaxNum) public onlyOwner returns (bool){
		_ktMaxNum = ktMaxNum;
		return true;
	}
	...
	function getUserDataV1(IERC20 t) public view returns (uint256[] memory){
		...
		(,int0,int1,int2,int3,int4,int5,int6) = zbttoken.getSingleInfo(account,address(t));
