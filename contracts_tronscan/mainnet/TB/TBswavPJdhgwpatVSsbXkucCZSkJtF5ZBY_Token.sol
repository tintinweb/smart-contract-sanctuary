...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 880000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = 'LHB';
    string private _symbol = 'LHB';
    uint8 private _decimals = 18;

    address private _burnPool = 0x000000000000000000000000000000000000dEaD;

    address private fundAddress = address(0x413B38A90361B4A7295B79F77B3B26BBAD36A1BC73);
