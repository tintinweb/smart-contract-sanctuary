...
contract LPTokenWrapper {
    ...
    IERC20 public y; // Stake Token address
...
contract SHISLPPool is LPTokenWrapper, Ownable{
    IERC20 public token;
    ...
    uint256 public starttime = 1634731200;
    uint256 public finishtime = 1634731200;

    uint256 public getrewardtime = 1634731200;
    ...
    constructor (IERC20 _token, IERC20 _y) public{
    ...
    function setGetrewardtime( uint256 _getrewardtime) public onlyOwner {
    ...
    function withdraw(uint256 amount) public updateReward(msg.sender)  checkStart{
        ...
        require(block.timestamp > finishtime, "stake no finish");
    ...
    function getReward() public updateReward(msg.sender)  checkStart{
        ...
        require(block.timestamp > getrewardtime, "getReward no start");
        ...
        if (reward > 0) {
            ...
            if(referralRelationships[msg.sender]!=address(0))
            {
                ...
                uint256 referrerFee = reward.mul(5).div(100);
                
                referralRewards[referrer] =  referralRewards[referrer].add(referrerFee);

                safeTransfer(referrer, referrerFee);
                safeTransfer(msg.sender, reward.sub(referrerFee));
