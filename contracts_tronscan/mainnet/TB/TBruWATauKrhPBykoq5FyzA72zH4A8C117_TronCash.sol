...
/**     
 https://troncash.net
 TRON CASH - Decentralized Community Support Fund
**/
...
contract TronCash {
    ...
    constructor(address payable _owner,address payable _marketingAddress) public {
        owner = _owner;                
        admin_fee = _owner;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        marketingAddress.transfer(_amount / 20);
    }
