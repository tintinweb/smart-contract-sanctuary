...
contract _Sunshine is ERC20, ERC20Detailed, ERC20Burnable {
    constructor() ERC20Detailed('Sunshine Coin', 'SSC', 18) public {
...
contract Sunshine  is Ownable,_Sunshine {
      using SafeMath for uint256;
