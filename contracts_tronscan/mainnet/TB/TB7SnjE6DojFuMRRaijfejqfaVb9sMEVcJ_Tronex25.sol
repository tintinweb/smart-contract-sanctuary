//SourceUnit: tronex25.sol

/*
 *	TRONEX25 - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://tronex25.com                                       │
 *   │                                                                       │  
 *   │   Telegram Public Group: https://t.me/tronex25                        |
 *   |                                                                       |            
 *   |   E-mail: support@tronex25.com                                        |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 */
...
contract Tronex25{
  ...
  constructor() public {
    tariffs.push(Tariff(5 * 28800, 135));
    tariffs.push(Tariff(10 * 28800, 210));
    tariffs.push(Tariff(20 * 28800, 250));
    tariffs.push(Tariff(120 * 28800, 500));
