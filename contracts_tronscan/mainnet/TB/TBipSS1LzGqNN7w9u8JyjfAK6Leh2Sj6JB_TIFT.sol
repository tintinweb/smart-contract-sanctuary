//SourceUnit: tift_token_v2.sol

////////////////////////////////////////////////////////
///                                                  ///
/// 			TIFT TOKEN MAIN CONTRACT v.2         ///
///													 ///
////////////////////////////////////////////////////////
...
contract TIFT is ERC20, Detailed, Mintable, Burnable {
    string public _name = "True Investment Finance";
    ...
    function IncreaseTokenAmount(uint256 _amount) public {
        _IncreaseTokenAmount(_amount);
    }        
	
    function _IncreaseTokenAmount(uint256 _amount) internal {    
