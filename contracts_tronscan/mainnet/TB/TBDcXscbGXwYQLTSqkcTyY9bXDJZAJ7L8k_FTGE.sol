...
contract FTGE is Context, IERC20, Ownable {
    ...
    string private _name = 'FTGE Token';
    string private _symbol = 'FTGE';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41CB29A55431EA310AAC2B92BE9C000C06DB4C86C7);
