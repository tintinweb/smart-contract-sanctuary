...
contract CCP is owned {
    ...
    string constant private _name = "ClipCrypto";
    string constant private _symbol = "CCP";
    uint256 constant private _decimals = 6;
    uint256 private _totalSupply = 151000 * (10**_decimals);         //151000 tokens
    uint256 constant public maxSupply = 151000 * (10**_decimals);    //151000 tokens
