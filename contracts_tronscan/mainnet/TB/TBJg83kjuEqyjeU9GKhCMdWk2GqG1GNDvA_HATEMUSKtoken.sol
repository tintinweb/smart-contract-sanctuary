//SourceUnit: token HATEMUSK.sol

pragma solidity ^0.5.0;
//---------------------------------------------------------------
// If you hate Elon Musk, buy token HATEMUSK now.
//
// Buy min 0.1 usdt trc20 = 10 token HATEMUSK.
//
// Levels of token HATEMUSK :1 token = 1% you hate Elon Musk.
//
// 10-20 token : dislike Elon Musk.
// 30-50 token : really dislike.
// 100-200 token : hate.
// 300 token or more  : very hate.
// 1.000 token or more : very very hate.
// 10.000 token or more : detest.
// 100.000 token or more : sick of Elon Musk.
//---------------------------------------------------------------
/**
TRC20 Token
...
contract HATEMUSKtoken is CommonToken {

  constructor() CommonToken("HATEMUSK Token","HATEMUSK",1,4000000000) public {}
