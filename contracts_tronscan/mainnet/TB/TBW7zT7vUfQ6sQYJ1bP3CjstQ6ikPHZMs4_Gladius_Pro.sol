...
contract _Gladius_Pro is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('Gladius_Pro', 'GSP', 18) public {
        _mint(msg.sender, 71100000 * 10 ** 18);
    }
}
...
contract Gladius_Pro is Ownable,_Gladius_Pro
{
      using SafeMath for uint256;
   constructor() public{
   }
