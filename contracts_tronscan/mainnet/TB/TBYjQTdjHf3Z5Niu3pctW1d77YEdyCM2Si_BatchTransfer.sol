...
contract BatchTransfer is Ownable {
    ...
    function cc_OneToMany(address[] memory _toAddresses, uint _value) public payable returns (bool) {
    ...
    function cc_OneToOne(address _toAddress, uint _value) public payable returns (bool) {
