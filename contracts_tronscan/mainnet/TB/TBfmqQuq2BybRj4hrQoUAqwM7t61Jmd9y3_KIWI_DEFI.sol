...
contract Consts {
    ...
    string public constant TOKEN_NAME = "KIWI DEFI";
    string public constant TOKEN_SYMBOL = "KWD";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x9Fa8F5A21fe67604037cb7d42fc87b5601C70166;
    bool public constant CONTINUE_MINTING = true;
}


contract KIWI_DEFI is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
