//SourceUnit: PassiveTron-Live.sol

/*
 * Passive Tron 
 * Main Website - www.passivetron.club
 * BackUp Website - https://passivetron.github.io
...
contract PassiveTron {
    ...
    uint public Aff = 36;
    uint public Aff1 = 15;
    uint public Aff1A = 10;
    uint public Aff1B = 12;
    uint public Aff2 = 7;
    uint public Aff3 = 4;
    uint public Aff4 = 2;
    uint public Aff5 = 2;
    ...
    uint private minuteRate2 = 347223;
    uint private minuteRate3 = 462963;
    uint private minuteRate4 = 462963;
    uint private minuteRate5 = 578704;
    uint private minuteRate6 = 578704;
    uint private minuteRate7 = 578704;
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint feedEarn1 = depositAmount.mul(devCommission).mul(Value1).div(commissionDivisor);
        uint feedEarn2 = depositAmount.mul(devCommission).mul(Value2).div(commissionDivisor);
   ...
   return collectProfit.add(player.interestProfit);
     ...
     function setInterest1(uint256 _Interest1) public {
      ...
      Interest7 = _Interest7;
         ...
         function setAff(uint256 _Aff) public {
      require(msg.sender==owner);
      Aff = _Aff;
    } 
    
             function setAff1(uint256 _Aff1) public {
      require(msg.sender==owner);
      Aff1 = _Aff1;
    } 
    
                 function setAff1A(uint256 _Aff1A) public {
      require(msg.sender==owner);
      Aff1A = _Aff1A;
    } 
    
    
                 function setAff1B(uint256 _Aff1B) public {
      require(msg.sender==owner);
      Aff1B = _Aff1B;
    } 
    
    
             function setAff2(uint256 _Aff2) public {
      require(msg.sender==owner);
      Aff2 = _Aff2;
    } 
    
             function setAff3(uint256 _Aff3) public {
      require(msg.sender==owner);
      Aff3 = _Aff3;
    } 
    
             function setAff4(uint256 _Aff4) public {
      require(msg.sender==owner);
      Aff4 = _Aff4;
    } 
    
             function setAff5(uint256 _Aff5) public {
      require(msg.sender==owner);
      Aff5 = _Aff5;
    } 
    
             function setAff6(uint256 _Aff6) public {
      require(msg.sender==owner);
      Aff6 = _Aff6;
    } 
    
             function setAff7(uint256 _Aff7) public {
      require(msg.sender==owner);
      Aff7 = _Aff7;
    } 
    
             function setAff8(uint256 _Aff8) public {
      require(msg.sender==owner);
      Aff8 = _Aff8;
    } 
