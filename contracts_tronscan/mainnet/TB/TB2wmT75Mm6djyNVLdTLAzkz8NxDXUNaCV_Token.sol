...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'DGzilla';
    string private _symbol = 'DGzilla';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 100000000000000000000 * 10**uint256(_decimals);
