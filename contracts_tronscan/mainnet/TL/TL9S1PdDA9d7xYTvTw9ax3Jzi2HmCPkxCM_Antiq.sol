 ...
 * `TRC20` functions.
 */
contract Antiq is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("Antiq", "ANQ", 10) {
        _mint(msg.sender, 3750000000 * (10 ** uint256(decimals())));
    }
}
...
contract TRC20 is ITRC20 {
   ...
   uint256 public _startDate;
    ...
    enum supplyStatus{First,Second,Third,Fourth,Fifth}
    supplyStatus _currentSupplyStatus;
    /**
    ...
    function _mint(address payable account, uint256 amount) internal {
        ...
        _currentSupplyStatus=supplyStatus.First;
     ...
     function _supply() external {
         ...
         if((block.timestamp>(_startDate +(30*84600))) && (_currentSupplyStatus==supplyStatus.First)){
             amount=3750000000 * (10 ** uint256(10));
             _currentSupplyStatus=supplyStatus.Second;
         }
           if((block.timestamp>(_startDate +(60*84600))) && (_currentSupplyStatus==supplyStatus.Second)){
              amount=3750000000 * (10 ** uint256(10));
             _currentSupplyStatus=supplyStatus.Third;
         }
              if((block.timestamp>(_startDate +(90*84600))) && (_currentSupplyStatus==supplyStatus.Third)){
              amount=3750000000 * (10 ** uint256(10));
             _currentSupplyStatus=supplyStatus.Fourth;
         }
                if((block.timestamp>(_startDate +(365*84600))) && (_currentSupplyStatus==supplyStatus.Fourth)){
              amount=35000000000 * (10 ** uint256(10));
             _currentSupplyStatus=supplyStatus.Fifth;
         }
         if(amount>0){
                     _totalSupply = _totalSupply.add(amount);
