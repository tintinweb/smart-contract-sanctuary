...
contract PGT is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 13888 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = 'PGT';
    string private _symbol = 'PGT';
    uint8 private _decimals = 18;

    address private _burnPool = 0x000000000000000000000000000000000000dEaD;

    //�����ѵ�ַ
    address private fundAddress = address(0x41A3846AE50E0C711B73AA61D1E5A927E9A6A42FE3);
    ...
    uint256 private maxSale= 50* 10**18;
    constructor () public {
