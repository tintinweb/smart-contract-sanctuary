...
/**
* Contracts and libraries below are from OpenZeppelin, except JustNFT
**/
...
contract NFTTestToken is TRC721Full,Ownable{
    ...
    function mintJust(address collector_address, uint256 tokenId,string memory tokenURI,string memory btfsHash) onlyOwner public {
        //mint token
