...
contract MegaTrust {
    ...
    constructor(address payable _owner, address payable _addfund, address payable _trxfee) public {
        owner = _owner;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        trx_fee.transfer(_amount * 5 / 100);
        addfund.transfer(_amount * 5 / 100);
