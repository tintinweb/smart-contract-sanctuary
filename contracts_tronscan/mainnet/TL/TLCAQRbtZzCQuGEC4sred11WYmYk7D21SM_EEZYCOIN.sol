...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "EEZY COIN"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "EEZY".
   */
...
contract EEZYCOIN is CommonToken {

  constructor() CommonToken("EEZY COIN", "EEZY", 6, 250000000) public {}
