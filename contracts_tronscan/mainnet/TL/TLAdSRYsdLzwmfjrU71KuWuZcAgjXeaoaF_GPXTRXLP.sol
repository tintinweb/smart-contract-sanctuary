...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0x4109803966BC84CC07A4DD30917B5493BA5AA82EE8); // Stake Token address
...
contract GPXTRXLP is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public gpx = IERC20(0x41E6EC474CF2C1C1115EF92FEF2C3CCE15E002CBDA);
    
    uint256 public constant DURATION = 370 days; 

    uint256 public starttime = 1628496447;
    ...
    function getReward() public updateReward(msg.sender)  checkStart{
        ...
        if (reward > 0) {
            ...
            safeGPXTransfer(msg.sender, reward); 
            ...
            if(referralRelationships[msg.sender]!=address(0))
            {
                ...
                safeGPXTransfer(referrer, referrerFee); 
    ...
    function safeGPXTransfer(address _to, uint256 _amount) internal {
        uint256 gpxBalance = gpx.balanceOf(address(this));
        if(_amount > gpxBalance) {
            gpx.safeTransfer(_to, gpxBalance);
        } else {
            gpx.safeTransfer(_to, _amount);
        }
