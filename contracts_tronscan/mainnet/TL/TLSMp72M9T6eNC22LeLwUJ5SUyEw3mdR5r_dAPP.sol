//SourceUnit: withdrawalContract.sol
...
contract dAPP is ownable, Verifier {
    using SafeMath for uint256;
    ...
    constructor(WYZTH _tokenaddress, address _sigAddress) public {
    ...
    function sendMultiEth(
        address payable[] calldata userAddress,
