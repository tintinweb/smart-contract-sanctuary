...
contract Bee is Util, WhitelistAdminRole,CoinTokenWrapper {
   ...
   //TPyuLc5etD3gC1o4WNqBYt3VBN8keneB8E
    ...
    //TATYuV2drogKHqg6cxo7WhAnuEV5XPpbpr
    ...
    //更新用户等级   //todo 在这里修改用户等姐计算 保存用户所有一级下级，每次选出最大持币人
