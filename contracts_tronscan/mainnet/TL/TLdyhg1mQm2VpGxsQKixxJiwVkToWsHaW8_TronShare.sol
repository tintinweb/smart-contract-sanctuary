...
/*!  tronshare.sol | (c) 2020 Develop by BelovITLab LLC (smartcontract.ru), author @stupidlovejoy | SPDX-License-Identifier: MIT License */
...
contract TronShare {
    ...
    constructor() public {
        owner = 0xFed7f0f649994110ae4e487B199293de6b420C4C;

        tarifs.push(Tarif(7, 1500));
        tarifs.push(Tarif(8, 1565));
        tarifs.push(Tarif(9, 1630));
        tarifs.push(Tarif(10, 1695));
        tarifs.push(Tarif(11, 1760));
        tarifs.push(Tarif(12, 1825));
        tarifs.push(Tarif(13, 1890));
        tarifs.push(Tarif(14, 1955));
        tarifs.push(Tarif(15, 2020));
        tarifs.push(Tarif(16, 2085));
        tarifs.push(Tarif(17, 2150));
        tarifs.push(Tarif(18, 2215));
        tarifs.push(Tarif(19, 2280));
        tarifs.push(Tarif(20, 2345));
        tarifs.push(Tarif(21, 2410));
        tarifs.push(Tarif(22, 2475));
        tarifs.push(Tarif(23, 2540));
        tarifs.push(Tarif(24, 2605));
        tarifs.push(Tarif(25, 2670));
        tarifs.push(Tarif(26, 2735));
        tarifs.push(Tarif(27, 2800));
        tarifs.push(Tarif(28, 2865));
        tarifs.push(Tarif(29, 2930));
        tarifs.push(Tarif(30, 2995));
