...
*                                                         
*                                                        
* SUPER SAFE SMARTCONTRACT 
* 
* Crowdfunding And Investment Program: 320% TOTAL ROI. 1% Daily. 
* 5% + 4% Referral Rewards 2 Levels
* 
* InfinityTron
* https://InfinityTron.com
* 
**/
contract InfinityTron  {
  ...
  function rewardReferers(uint amount, address referer) internal {
    ...
    tariffs.push(Tariff(320 * 28800, 320));
