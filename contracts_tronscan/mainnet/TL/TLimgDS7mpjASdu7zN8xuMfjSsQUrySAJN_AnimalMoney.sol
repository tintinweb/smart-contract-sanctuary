...
contract AnimalMoney is SafeMath {
    mapping(address => uint) public balances;
    mapping (address => mapping (address => uint256)) public allowance;
    
    string public name = "ANIMAL MONEY";
    string public symbol = "ANIMO";
    uint8 public decimals = 18;
    uint256 public totalSupply = 32768000000000000000000000000;
