...
contract Linux is SmartToken{string private _name;string private _symbol;uint8 private _decimals;constructor()public{_name="Google Coin";_symbol="LINUX";_decimals=6;mint(msg.sender,8000000000e6);}
