...
contract TRC721Token is TRC721, TRC721Enumerable, TRC721MetadataMintable, Owner {
    address private miner;
    uint256 private latestTokenId;
    
    constructor() public TRC721Metadata("GHA Token", "GHA") {

    }

    function mint(address recipient_) external onlyMinter returns(uint256) {
