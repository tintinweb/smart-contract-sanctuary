...
contract MyTrx {
    ...
    uint256 constant public ADDITION_PER_DAY = 2;
    uint256[] public REFERRAL_PERCENTS = [100, 40, 10, 10, 10, 10];
    uint256 constant public BURN_PERCENT = 2000;
    uint256 constant public DEFAULT_USER_PERCENT = 100;
    uint256 constant public PERCENTS_DIVIDER = 1000;
    uint256 constant public STATE_CHANGE_PERCENT = 10;
    ...
    uint256 constant public CONTRACT_BONUS_DIVIDER = 20000;
    ...
    function calcUserInvestReward(address userAddr) public view returns (uint256) {
        ...
        uint256 restAmount = totalInvestedAmount.sub(totalWithdrawnAmount);
        uint256 tmpContractBonus = restAmount.div(CONTRACT_BONUS_DIVIDER.mul(TRX_TO_HOE_RATE).mul(1 trx)).mul(1 trx).mul(TRX_TO_HOE_RATE);
        ...
        uint256 durationAddition = duration.div(TIME_STEP).mul(ADDITION_PER_DAY);
