//SourceUnit: Troncase2.sol
 ...
 /*  Troncase2 is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://troncase2.io         								 │
 * 	 │																		 │
 *   │   Troncase2 - Next Generation Communıty Program						 │
 *	 │                                                                       │
 *	 │	 Upto 2% Daily ROI					   						       	 │
 *	 │                                                                       │
...
contract Troncase2 {
    ...
    uint constant public INVEST_MIN_AMOUNT = 10 trx;
