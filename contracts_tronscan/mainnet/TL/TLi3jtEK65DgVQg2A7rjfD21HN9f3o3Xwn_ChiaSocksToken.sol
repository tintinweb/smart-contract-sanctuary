...
contract ChiaSocksToken is Governance, ERC20Detailed{
    ...
    //todo reward pool!
    address public _rewardPool = 0x263754A6Ca9526eB249c51eb8774ccb99E33ce14;
    //todo burn pool!
    address public _burnPool = 0x263754A6Ca9526eB249c51eb8774ccb99E33ce14;
    ...
    */
    ...
    constructor () public ERC20Detailed("ChiaSocks", "XCH", _decimals) {
        uint256 _exp = _decimals;
         _maxSupply = 100000 * (10**_exp);
    }
