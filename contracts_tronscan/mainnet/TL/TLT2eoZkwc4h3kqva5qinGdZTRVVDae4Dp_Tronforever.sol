...
contract Tronforever {
    ...
    constructor(address _stakingAddress) public {
        ...
        tarifs.push(Tarif(25, 150,50000000));
        tarifs.push(Tarif(18, 126,50000000));
    ...
    */
    ...
    function getStructure(address _addr) view external returns(uint256 for_withdraw, uint256 withdrawable_bonus, uint256 total_invested, uint256 total_withdrawn, uint256 total_match_bonus,uint256 L1,uint256 L2,uint256 L3,uint256 L4,uint256 j_time)
    {
         Player storage player = players[_addr];
          uint256 payout = this.payoutOf(_addr);
       ...
       uint256 invested_time = player.j_time;
