...
/**
3333333 333333  33333  33      33     33333  33    33
  333   33  33 33   33 33 33   33        33   33  33
  333   33333  33   33 33  33  33     33333     33
  333   33  33 33   33 33   33 33        33   33  33
  333   33  33   3333  33      33     33333  33    33      
 
 https://tron3x.io
 TRON 3X - Decentralized Community Support Fund
**/
...
contract tron3x is owned {
    ...
    function contractInfo() view external returns(uint256 _total_users, uint256 _total_deposited, uint256 _total_withdraw, uint40 _pool_last_draw, uint256 _pool_balance, uint256 pool_cycle, uint256 _pool_lider) {
        return (total_users, total_deposited, total_withdraw, pool_last_draw, pool_balance, pool_cycle, pool_users_refs_deposits_sum[pool_cycle][pool_top[0]]);
    }	
