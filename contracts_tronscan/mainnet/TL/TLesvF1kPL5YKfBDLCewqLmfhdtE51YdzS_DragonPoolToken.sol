//SourceUnit: DragonPoolToken.sol
...
contract DragonPoolToken is ERC20, ERC20Detailed{
    ...
    constructor(address _address) public ERC20Detailed("Dragon Pool Token", "DRAGONPOOL", 18){
        	owner = msg.sender;	
