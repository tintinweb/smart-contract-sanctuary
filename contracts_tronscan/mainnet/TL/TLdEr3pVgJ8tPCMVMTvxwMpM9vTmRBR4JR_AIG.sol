...
/**
 * AiGate smart contract.
 */
contract AIG is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 100000000 * (10**6);
  ...
  string constant public name = "AiGate";
  string constant public symbol = "AIG";
