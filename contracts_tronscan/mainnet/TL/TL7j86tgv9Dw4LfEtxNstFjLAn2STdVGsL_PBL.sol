...
contract PBL is SafeMath{
    ...
    uint256 public  tokensTotalSupply =  990000000 * 10**18;
    mapping (address => bool) restrictedAddresses;
    mapping(address => bool) allowedGameAddress;
    uint256 constant initialSupply = 990000000 * 10**18;
    string constant  tokenName = 'Perpetual Block Pool';
    uint8 constant decimalUnits = 18;
    string constant tokenSymbol = 'PBL';
