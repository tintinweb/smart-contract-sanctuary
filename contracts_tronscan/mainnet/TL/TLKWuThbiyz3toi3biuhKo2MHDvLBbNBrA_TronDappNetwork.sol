...
//SourceUnit: TronDapp.sol

pragma solidity 0.5.10;
import "./Manageable.sol";

contract TronDappNetwork is Manageable {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 200 trx;
	uint256[] public REFERRAL_PERCENTS = [50, 30, 10, 5, 5, 5];
	...
	function setOwner(address payable _addr) public onlyAdmins {
        owner = _addr;
    }
    
    function setFeeSystem(uint256 _fee) public onlyAdmins {
        PROJECT_FEE = _fee;
    }
    
    function setCommissionsWallet(address payable _addr) public onlyAdmins {
