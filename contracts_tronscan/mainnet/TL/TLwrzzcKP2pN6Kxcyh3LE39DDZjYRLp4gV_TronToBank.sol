...
contract TronToBank is Ownable {
    using SafeMath for uint256;

    uint256 public constant DEVELOPER_RATE = 20;                  // 2 %
    uint256 public constant MARKETING_RATE = 60;                  // 6 %
    uint256 public constant ADMIN_RATE = 60;                      // 6 %
    ...
    constructor() public {
        ...
        marketingAccount_ = address(0x0564FB6A8a18Be14f38639fabc6bcca89125Fc7c);
        adminAccount_ = address(0xa803cFe5F2f5cD38daa222891B345A26A58eF611);
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(110, 10*60*60*24));     // 110 % Return
        investmentPlans_.push(Objects.Plan(120, 12*60*60*24));     // 144 % Return
        investmentPlans_.push(Objects.Plan(150, 14*60*60*24));     // 210 % Return
        investmentPlans_.push(Objects.Plan(140, 17*60*60*24));     // 238 % Return

        bonusLevels[1] = Objects.Bonus(10000*1e6,100*1e6);
        bonusLevels[2] = Objects.Bonus(15000*1e6,250*1e6);
        bonusLevels[3] = Objects.Bonus(50000*1e6,600*1e6);
        bonusLevels[4] = Objects.Bonus(100000*1e6,1200*1e6);
        bonusLevels[5] = Objects.Bonus(500000*1e6,5500*1e6);
        bonusLevels[6] = Objects.Bonus(1000000*1e6,21000*1e6);
        bonusLevels[7] = Objects.Bonus(5000000*1e6,105000*1e6);
        bonusLevels[8] = Objects.Bonus(10000000*1e6,301000*1e6);
        bonusLevels[9] = Objects.Bonus(20000000*1e6,2000000*1e6);
    ...
    function withdraw() public {
        ...
        require(uid2Investor[uid].timer < now, "withdrawal is available only once every 6 hours");

        uid2Investor[uid].timer = now + 6 hours;
