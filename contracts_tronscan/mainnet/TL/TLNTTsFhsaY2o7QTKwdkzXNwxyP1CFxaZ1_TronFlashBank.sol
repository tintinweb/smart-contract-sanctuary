//SourceUnit: TronFlashBank.sol

pragma solidity 0.4.25;


contract TronFlashBank {
    struct Tarif {
        uint16 life_days;
        uint16 percent;
    }
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(1000, 6000)); // 6%
        tarifs.push(Tarif(45, 315)); // 7%
        tarifs.push(Tarif(25, 200)); // 8%
        tarifs.push(Tarif(15, 135)); // 9%
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= 20000000, "min amount 20trx");
