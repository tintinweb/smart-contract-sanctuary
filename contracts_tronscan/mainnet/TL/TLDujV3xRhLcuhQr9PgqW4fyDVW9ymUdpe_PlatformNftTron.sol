//SourceUnit: PlatformNftTron.sol
...
library Address {
     ...
     * ====
     */
    function isContractA(address account) internal view returns (bool) {
    ...
    function functionCallWithValue(address target, bytes memory data, uint256 value, string memory errorMessage) internal returns (bytes memory) {
        ...
        require(isContractA(target), "Address: call to non-contract");
    ...
    function functionStaticCall(address target, bytes memory data, string memory errorMessage) internal view returns (bytes memory) {
        require(isContractA(target), "Address: static call to non-contract");
    ...
    function functionDelegateCall(address target, bytes memory data, string memory errorMessage) internal returns (bytes memory) {
        require(isContractA(target), "Address: delegate call to non-contract");
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/token/TRC721/ITRC721Receiver.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/token/TRC721/ITRC721Enumerable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/token/TRC721/ITRC721Metadata.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/introspection/ITRC165.sol




// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/token/TRC721/ITRC721.sol


// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/introspection/TRC165.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/token/TRC721/TRC721.sol
...
contract TRC721 is Context, TRC165, ITRC721, ITRC721Metadata, ITRC721Enumerable {
    ...
    */
    ...
    function _burn(uint256 tokenId) internal virtual {
        address owner = TRC721.ownerOf(tokenId); // internal owner
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(TRC721.ownerOf(tokenId) == from, "TRC721: transfer of token that is not own"); // internal owner
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(TRC721.ownerOf(tokenId), to, tokenId); // internal owner
    }
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v3.4.2/contracts/token/TRC721/TRC721Burnable.sol
...
/**
 * platform-nft.com NFT Contract
 *
 */

contract PlatformNftTron is Context, TRC721Burnable {
    ...
    //Minting
    uint256 public constant TOKEN_PRICE = 1500 trx;
    ...
    //Bonus system
    uint public constant REFERRAL_PTRCENT = 10;
    mapping(address => uint) public userTotalReferrals;

    uint public constant SUPERLIST_ONE_PTRCENT = 3;
    uint public constant SUPERLIST_ONE_ENTER_COUNT = 29;

    uint public constant SUPERLIST_TWO_PTRCENT = 7;
    uint public constant SUPERLIST_TWO_ENTER_COUNT =  99;
    ...
    //External info
    string public constant BASE_URL = "https://api.trabbitars.com/nft/getMetadata/";
    ...
    address  _owner = 0x3425a012B32316Ad1C5F7D9f5D71f0296A1cF4b1;
    address constant _ignoreReferral = 0x3425a012B32316Ad1C5F7D9f5D71f0296A1cF4b1;
    ...
    constructor() public TRC721("ETCBits", "EBIT") {
        _owner = _msgSender();
    ...
    function takeUser() external payable  returns(uint){
        ...
        payable(msg.sender).transfer(users[msg.sender].wallet);
    ...
    function mint(address to, address payable referral) public payable{
        ...
        referral.transfer(msg.value.mul(REFERRAL_PTRCENT).div(100));
        ...
        if(poolEnabled){
            ...
            //Save user mint amount
            users[msg.sender].countMint+=tokensMintedNow;
            ...
            if(poolUserLevelOne>0){
                everylevelOneTrx = ((TOKEN_PRICE * SUPERLIST_ONE_PTRCENT)/100) / poolUserLevelOne;
            }else{
                ownerTrx += SUPERLIST_ONE_PTRCENT;
            }


            if(poolUserLevelTwo>0){
                everylevelTwoTrx = ((TOKEN_PRICE * SUPERLIST_TWO_PTRCENT)/100) / poolUserLevelTwo;
            }else{
                ownerTrx += SUPERLIST_TWO_PTRCENT;
            }
            ...
            ownerAmount += (TOKEN_PRICE * tokensMintedNow  * firstTrx)/100;
    ...
    /**
     * Enable or disable pool mechanisms
     */
    function setPoolStatus(bool _status) public _ownerOnly {
        poolEnabled = _status;
    }
    ...
    fallback()  external payable {
        mint(payable(msg.sender), payable(_owner));
    }
