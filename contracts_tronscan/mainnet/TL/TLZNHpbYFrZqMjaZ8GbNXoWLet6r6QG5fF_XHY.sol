...
contract XHY is Context, IERC20, Ownable {
    ...
    string private _name = 'XHY Token';
    string private _symbol = 'XHY';
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 2008 * 10**uint256(_decimals);
