//SourceUnit: tronraiser.sol
 ...
 /*  TronRaiser is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://TronRaiser.space         							 │
 * 	 │																		 │
 *   │   TronRaiser - Next Generation Communıty Program						 │
 *	 │                                                                       │
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 11-level referral commission: 7% - 3% - 1.5% - 1% - 0.5% - 0.5% - 0.5% - 0.4% - 0.3% - 0.2% - 0.1% 
 *   
 */
