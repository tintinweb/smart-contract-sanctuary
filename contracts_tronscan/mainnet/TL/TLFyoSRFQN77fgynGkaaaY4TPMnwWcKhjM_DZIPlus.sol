...
contract DZIPlus is Ownable, TRC20 {
    ...
    string public constant name = "DZIPlus";
    string public constant symbol = "DZIP";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 100 * 10**8 * 10**DECIMALS;
