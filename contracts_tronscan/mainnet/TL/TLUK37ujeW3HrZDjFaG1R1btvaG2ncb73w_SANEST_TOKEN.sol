...
contract SANEST_TOKEN is StandardToken {
    string public name = "SANEST TOKEN";
    string public symbol = "SANEST";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 5000000000 * 10 ** uint256(decimals);
