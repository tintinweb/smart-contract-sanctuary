...
//SourceUnit: SunUSDT_TRXV3Pool.sol
...
contract SunUSDTTRXV3Pool is LPTokenWrapper, IRewardDistributionRecipient {
    // sunToken
    ...
    */
    ...
    function migrate(address nextPool) public returns (bool){
        ...
        require(SunUSDTTRXV3Pool(nextPool).stakeTo(msg.sender, userBalance), "stakeTo failed");
