//SourceUnit: Moeda Coletiva 2020.sol
 ...
 * @title Roles of users
 *
 * @dev User roles for CWC Contract
 */
 ...
 */
contract CWC is ERC20BasicToken, ERC20, PropertyStorage {

    mapping(address => mapping(address => uint256)) internal allowed;

    uint256 public totalSupply = 100000000000000;
    string public name = "Collective Working Coin";
