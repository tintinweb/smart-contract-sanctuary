...
contract BaycTron is ITRC721, ITRC165, ITRC721Metadata, ITRC721Enumerable {
    ...
    string internal _name = "BOREDAPE";
    string internal _symbol = "BAYCT";
    ...
    function tokenURI(uint256 _tokenId) external view override returns (string memory) {
        return string(abi.encodePacked("https://bayctron.com/bored/", Utils.uintToString(_tokenId)));
    }
