...
contract _TronSwap9 is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('TronSwap9 ', 'TS9', 18) public {
...
contract TronSwap9  is Ownable,_TronSwap9 {
      using SafeMath for uint256;
