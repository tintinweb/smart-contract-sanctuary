...
contract TYBToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function TYBToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
        _totalSupply = _initialSupply * 10 ** uint256(decimals);
        balances[owner] = _initialSupply * 10 ** uint256(decimals);
        deprecated = false;
    }
