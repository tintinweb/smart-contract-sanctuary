...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 22222 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'FLLS';
    string private _symbol = 'FLLS';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41c03283af45669da28cadacc22f9561ffd7068155);
    address private taxAddress = address(0x41787acf5d341ed4318a06b48c94ddbc8f12d3315d);
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _rOwned[fundAddress] = _rOwned[fundAddress].add(tFund.mul(currentRate));
         ...
         _rOwned[taxAddress] = _rOwned[taxAddress].add(tFee.mul(currentRate));
