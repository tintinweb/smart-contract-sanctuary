...
contract VnnToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function VnnToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
