...
contract Tronzen is Ownable {
    ...
    uint256 public constant MARKETING_FEE = 80;
    uint256 public constant DEVELOPER_FEE = 40;
    uint256 public constant ADMIN_FEE = 80;
    
    uint256 public PLAN_INTEREST = 50;
    ...
    constructor(address payable mrkAddr,address payable devprAddr,address payable admAddr) public {
        require(!isContract(mrkAddr) && !isContract(devprAddr) && !isContract(admAddr));
