...
contract TRC20Basic is ITRC20,Pausable {
	...
	function burn(uint256 _value) public whenNotPaused{
	 ...
	 function mint(uint256 _value) public onlyOwner whenNotPaused{
...
contract SUNNY is TRC20Basic {
    string public constant name = "SUNNY";
    string public constant symbol = "SUNNY";
    uint8 public constant decimals = 8;
    uint256 public constant INITIAL_SUPPLY = 100000000000000 * 10**8;
