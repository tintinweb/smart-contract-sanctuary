...
//SourceUnit: DasSupertalentToken.sol
...
contract DasSupertalentToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function DasSupertalentToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
