...
contract DollarBalanceBond is  ERC20Detailed,Operator {
    using SafeMath for uint256;

    constructor () public ERC20Detailed("DollarBalanceBond", "DBB", 6) {}
