...
contract MetaShark is ITRC20, TRC20Detailed, Ownable {
    constructor(address _owner) public TRC20Detailed("Meta Shark", "MTS", 8) Ownable(_owner) {
        require(_owner != address(0), "invalid owner");
        _mint(_owner, 500000000 * uint256(10 ** 8));
    }
