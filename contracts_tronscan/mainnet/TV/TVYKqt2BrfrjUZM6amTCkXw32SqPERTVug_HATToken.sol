...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address public burnAddress = address(0x81f3b1d2596317d83Ff55EedFB980A569b3C1784);
  ...
  function isWhitelist(address account) public view returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if((isWhitelist(sender) || isWhitelist(recipient)) && _totalSupply > _balances[burnAddress].add(6000 * (10 ** 6))) {
...
contract HATToken is ERC20{
  constructor () public ERC20('Helianthus annuus token', 'HAT') {
