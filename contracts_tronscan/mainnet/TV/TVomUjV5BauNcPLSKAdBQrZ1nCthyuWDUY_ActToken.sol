...
contract ActToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "ACT";
    ...
    //首次发币数量
    uint256 private constant TOKEN_INITIAL =1690000000 *(10 ** uint256(decimals));

    function ActToken() public CappedToken(TOKEN_CAP) {
