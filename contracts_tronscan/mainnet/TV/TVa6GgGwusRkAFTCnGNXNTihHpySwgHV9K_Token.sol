...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'NIUBI';
    string private _symbol = 'NIUBI';
    ...
    uint256 public _fundFee = 15;
    uint256 private _previousFundFee = _fundFee;
    uint256 public  MAX_STOP_FEE_TOTAL = 5000 * 10**uint256(_decimals);
    mapping(address => bool) private _isExcludedFromFee;

    uint256 private maxSale= 100 * 10**uint256(_decimals);
    uint256 private maxBuy= 1 * 10**uint256(_decimals);
