...
contract globaltron {
   ...
   // Events
    ...
    constructor(address ownerAddress) public {
        ...
        uniLevelDistPart[1] = (600*2)/100;
        uniLevelDistPart[2] = (600*2)/100;
        uniLevelDistPart[3] = (600*2)/100;
        uniLevelDistPart[4] = (600*2)/100;
        uniLevelDistPart[5] = (600*2)/100;
        uniLevelDistPart[6] = (600*2)/100;
        uniLevelDistPart[7] = (600*2)/100;
        uniLevelDistPart[8] = (600*2)/100;
        uniLevelDistPart[9] = (600*2)/100;
        uniLevelDistPart[10] = (600*2)/100;
    ...
    function sendTronDividends(address userAddress, address _from, uint8 matrix, uint8 level) private {
     ...
     function sendTronDividendaas(address userAddress, address _from,  uint8 level) private {
        ...
        if (!address(uint160(receiver)).send(300000000)) {
    ...
    function sendTronDividendbbs(address userAddress, address _from,  uint8 level) private {
        ...
        if (!address(uint160(receiver)).send(12000000)) {
