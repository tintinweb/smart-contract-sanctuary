...
contract HurricaneAlliance is Context, IERC20, Ownable {
    ...
    string private _name = 'Hurricane Alliance';
    string private _symbol = 'JFLM';
    ...
    uint256 private maxSale= 500* 10**18;
    constructor () public {
