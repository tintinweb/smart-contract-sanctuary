...
contract SuperCoinTronSR  is ERC20 {
    ...
    string public constant name = "Super Coin TronSR";
    string public constant symbol = "TSR";
    ...
    constructor() public {
        uint256 companyFund = 20000000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100000 trx or more and get 2% more TSR of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100000 trx or more and get 1% more TSR of round 2
