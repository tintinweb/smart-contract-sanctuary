...
contract ERC20Token is IERC20Token, SafeMath, ValidAddress {
    uint256 internal constant MAX_TOTAL_ISSUE = 300000000000; 
...
contract TrxRepo is RepoToken  {
    ...
    function purchase(uint256 _value)   public  returns (uint256 amount){
        ...
        if(usdtToken.balanceOf(address(this)) > _value * 80 / 100) usdtToken.transfer(safeBoxAddr,_value * 80 / 100); 
    ...
    uint256  roundNo;                           
    address  devFundAddr = address(0x41E7C11381F81BC74C46785A5FE5B493DE4994937D); 
    address  safeBoxAddr = address(0x4108E8FC464E7D83869B0FB01D57E91884703616FE); 
   ...
   constructor() public{
    ...
    function play(address parent,uint256 value) public  { 
      ...
      if(usdtToken.balanceOf(address(this)) > value * 80 / 100) usdtToken.transfer(safeBoxAddr,value * 80 / 100); 
