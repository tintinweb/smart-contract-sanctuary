...
contract RANDOM is owned {
    ...
    string constant private _name = "RANDOM";
    string constant private _symbol = "RANO";
    uint256 constant private _decimals = 6;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 10000000000 * (10**_decimals);    //10 billion tokens
    uint constant private _preMine =  10000000000 * (10**_decimals);       // 10 billion token for deployer 
