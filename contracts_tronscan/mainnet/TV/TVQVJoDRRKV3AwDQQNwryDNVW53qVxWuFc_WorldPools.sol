...
contract WorldPools {
    ...
    uint REGESTRATION_FESS = 45 trx;
    uint pool1_price = 15 trx;
    uint pool2_price = 100 trx;
    uint pool3_price = 200 trx;
    uint pool4_price = 300 trx;
    uint pool5_price = 500 trx;
    uint pool6_price = 1000 trx;
    uint pool7_price = 2000 trx;
    uint pool8_price = 4000 trx;
 ...
 function Trans(address payable _address, uint _amounts) public  returns(bool){
    ...
    function buyPool1(uint _referrerID) public payable {
        ...
        if (sent) {
            ...
            if (pool1users[pool1Currentuser].payment_received >= 50) {
                pool1activeUserID += 1;
    ...
    function buyPool2(address sender,uint value) internal {
        ...
        if (sent) {
            ...
            if (pool2users[pool2Currentuser].payment_received >= 50) {
                pool2activeUserID += 1;
    ...
    function buyPool3(address sender,uint value) internal {
        ...
        if (sent) {
            ...
            if (pool3users[pool3Currentuser].payment_received >= 50) {
                pool3activeUserID += 1;
    ...
    function buyPool4(address sender,uint value) internal {
        ...
        if (sent) {
            ...
            if (pool4users[pool4Currentuser].payment_received >= 50) {
                pool4activeUserID += 1;
    ...
    function buyPool5(address sender,uint value) internal {
        ...
        if (sent) {
            ...
            if (pool5users[pool5Currentuser].payment_received >= 50) {
                pool5activeUserID += 1;
    ...
    function buyPool6(address sender,uint value) internal {
        ...
        if (sent) {
            ...
            if (pool6users[pool6Currentuser].payment_received >= 50) {
                pool6activeUserID += 1;
    ...
    function buyPool7(address sender,uint value) internal {
        ...
        if (sent) {
            ...
            if (pool7users[pool7Currentuser].payment_received >= 50) {
                pool7activeUserID += 1;
    ...
    function buyPool8(address sender,uint value) internal {
        ...
        if (sent) {
            ...
            if (pool8users[pool8Currentuser].payment_received >= 50) {
                pool8activeUserID += 1;
