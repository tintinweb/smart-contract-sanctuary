...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'MKL';
    string private _symbol = 'MKL';
    uint8 private _decimals = 18;

    address private _burnPool = 0x000000000000000000000000000000000000dEaD;


    address private fundAddress = address(0x410980E00529C595EF3402B00FB95E84C58FA4E66C);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 1888 * 10**uint256(_decimals);

    uint256 private maxBuy= 10 * 10**18;
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(Address.isContract(sender)&&!_isExcludedFromFee[sender]){
          ...
          require((balanceOf(recipient)+amount) <= 30 *10**18);
        }
