...
contract ERC20 is IERC20 {
    ...
    uint256 private _sayNo = 21000000 * 1000000000000000000 ;  
 ...
 * `ERC20` functions.
 */
contract HSBH is ERC20, ERC20Detailed {
    
    
     uint256 private total = 190000000;

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Heshi coin I", "HSBH", 18) {
            _mint(msg.sender, total.mul(1000000000000000000) );
    }
