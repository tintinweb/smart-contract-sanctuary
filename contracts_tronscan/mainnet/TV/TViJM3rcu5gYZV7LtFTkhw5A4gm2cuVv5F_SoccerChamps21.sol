...
contract SoccerChamps21 is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 100;

    constructor() public ERC721Full("SoccerChamps21", "SFASoc21") {
    _setBaseURI("https://thefanblock.com/wp-content/uploads/2021/10/21WACSoccerChamps.json");
    }
