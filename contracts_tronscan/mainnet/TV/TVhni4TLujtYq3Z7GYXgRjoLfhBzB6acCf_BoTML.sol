...
contract BoTML {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(10, 150)); // 15%
        tarifs.push(Tarif(8, 136)); // 17%
        tarifs.push(Tarif(6, 114)); // 19%
        tarifs.push(Tarif(4, 84)); // 21%
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= 10000000, "min amount 10trx");
