...
// File: contracts/token/BegoToken.sol
...
/// @title BegoToken Contract

contract BegoToken is Governance, ERC20Detailed{
    ...
    constructor () public ERC20Detailed("bego.finance", "BEGO", 18) {
         _maxSupply = 5000000 * (10**18);
    }
