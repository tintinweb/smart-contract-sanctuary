...
contract Consts {
    ...
    string public constant TOKEN_NAME = "WATER COIN";
    string public constant TOKEN_SYMBOL = "WRC";
    bool public constant PAUSED = false;
    address public constant TARGET_USER =
        0x76447A68c0F76BEA5674948DEE35C35E3c819e97;
    bool public constant CONTINUE_MINTING = true;
}

contract WRC_COIN is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
