...
contract TigersTron {
    ...
    uint LEVEL_PRICE = 200  *(10**6);

    uint REGESTRATION_FESS=200  * (10**6);
    uint pool1_price=200  * (10**6);
    uint pool2_price=400 * (10**6) ;
    uint pool3_price=800 * (10**6);
    uint pool4_price=1600 * (10**6);
    uint pool5_price=3200 * (10**6);
    uint pool6_price=6400 * (10**6);
    uint pool7_price=12800 * (10**6);
    uint pool8_price=25600 * (10**6);
    uint pool9_price=51200 * (10**6);
    uint pool10_price=102400 * (10**6);
    uint pool11_price=204800 * (10**6);
    uint pool12_price=409600 * (10**6) ;
