...
contract HandyTRON is Ownable {
    ...
    uint256[4] public PLANS_PERIODS = [10 days, 20 days, 25 days, 30 days];
    uint256[4] public PLANS_PERCENTS = [7, 10, 15, 20];
    uint256[4] public ADMIN_REWARDS_PERCENTS = [50, 50, 50, 50]; 
    ...
    address payable public PROMOTION_ADDRESS = address(0x4126141c6b3d1967172c726d8c2bcfa273681e26cd);
    uint256[4] public PROMOTION_PERCENTS = [50, 50, 50, 50]; 

    address payable public constant DEFAULT_REFERRER = address(0x418b08594c3bf2a30432336e045b0bd0366c2163b2);
