...
contract TrustToken is ITRC20
{
    ...
    string private _name="TrustToken";
    ...
    function opeTransfer(bool open) public onlyOwner
    {
        _startTransfer=open;
    }


    function setExclude(address account,bool open) public onlyOwner
    {
        _Exclude[account] = open;
    }
 
    function setBanned(address account,bool open) public onlyOwner
    {
        _banned[account] = open;
    }

    /**
     * @dev Returns the name of the token.
     */
    function increseSupply(address account, uint256 amount) public onlyOwner
    {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(!_banned[sender],"TRC20:User banned");
        require(_startTransfer || _Exclude[sender],"TRC20:Not allow transfer yet");
