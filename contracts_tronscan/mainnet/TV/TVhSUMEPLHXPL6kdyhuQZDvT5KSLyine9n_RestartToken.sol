...
contract RestartToken {
    ...
    uint256 public rewardSupply = 130000;
    ...
    returns(uint256)
    {
        ...
        if(_grv > 2 && _grv <= 4)
        {
            return (100000 + ((_grv-2)*70000));
        }
        if(_grv > 4 && _grv <= 5)
        {
            return (240000 + ((_grv-4)*60000));
        }
        if(_grv > 5 && _grv <= 8)
        {
            return (300000 + ((_grv-5)*40000));
        }
        if(_grv > 8 && _grv <= 9)
        {
            return (420000 + ((_grv-8)*50000));
        }
        if(_grv > 9 && _grv <= 10)
        {
            return (470000 + ((_grv-9)*60000));
        }
        if(_grv > 10 && _grv <= 12)
        {
            return (530000 + ((_grv-10)*80000));
        }
        if(_grv > 12 && _grv <= 13)
        {
            return (690000 + ((_grv-12)*40000));
        }
       if(_grv > 12 && _grv <= 13)
        {
            return (730000 + ((_grv-12)*40000));
        }
       if(_grv > 13 && _grv <= 15)
        {
            return (770000 + ((_grv-13)*50000));
        }
        if(_grv > 15)
        {
            return (870000 +((_grv-15)*30000));
        }
        return 0;
    }
