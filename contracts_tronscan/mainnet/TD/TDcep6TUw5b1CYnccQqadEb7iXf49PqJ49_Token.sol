...
contract TRC20 is ITRC20 {
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(totalSupply().add(amount) <= 10000000 * (10 ** uint256(6)), "TRC20: the current token does not allow an increase in circulation");
    ...
    function _burn(address account, uint256 value) internal {
        revert("TRC20: the current token does not support destruction");
    }
...
/**
 * @title Token
 * @dev Very TRC20 Token example, where all tokens are pre-assigned to the creator.
...
contract Token is TRC20, TRC20Detailed {
     ...
     */
    constructor () public TRC20Detailed("DFG", "DFG", 6) {
