...
contract LEX is TRC20Interface {
    ...
    string public constant NAME = "LightningExchangeToken";
    string public constant SYMBOL = "LEX";
	uint256 public decimals = 6;	

	uint256 public maximumTokens = 1e14; //100M TOKENS
	uint256 private constant preSellPrice = 4; //1 TOKEN = 4 TRX
	uint256 private constant preSellTime1 = 1576022400; //50% discont from 12/11/2019 @ 12:00am (UTC)
	uint256 private constant preSellTime2 = 1578700800; //37% discont from 01/11/2020 @ 12:00am (UTC)
	uint256 private constant preSellTime3 = 1581379200; //16% discont from 02/11/2020 @ 12:00am (UTC)
	...
	uint256 private unfreezeDate = 1584748800; //03/21/2020 @ 12:00am (UTC)
