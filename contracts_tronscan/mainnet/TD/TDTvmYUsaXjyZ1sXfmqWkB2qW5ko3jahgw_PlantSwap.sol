...
contract PlantSwap is Context, IERC20, Ownable {
    ...
    string private _name = 'PlantSwap Token';
    string private _symbol = 'PL';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 19587 * 10**uint256(_decimals);
