                                                        ...
                                                        if(players[_referral].global_per_level[5]==3) {
                                                            ...
                                                            if(players[_referral].global_per_level[6]<=3){
                                                                ...
                                                                if(players[_referral].global_per_level[6]==3) {
                                                                    ...
                                                                    _referral = players[_referral].global;
                                                                    players[_referral].global_per_level[7]++;
                                                                    if(players[_referral].global_per_level[7]<=3){
                                                                        if(_referral != address(0)){
                                                                            _referral.transfer(11520 trx);
                                                                            admin.transfer(1280 trx);
                                                                            
                                                                        }
                                                                    }else if(players[_referral].global_per_level[7]>=4){
                                                                        if(players[_referral].direct != address(0)){
                                                                            ...
                                                                            if(player.direct_per_level[0]>=2){
                                                                                players[_referral].direct.transfer(11520 trx);
                                                                                admin.transfer(1280 trx);
                                                                            }
                                                                        }
                                                                    }
