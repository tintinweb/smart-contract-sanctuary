...
contract LSBosser is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 10;

    constructor() public ERC721Full("LSBosser", "LSBoss") {
    _setBaseURI("https://thefanblock.com/wp-content/uploads/2021/12/LSHBosser.json");
    }
