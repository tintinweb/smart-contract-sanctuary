...
contract IQTron is Ownable {
    using SafeMath for uint256;
    uint256 public constant REFERENCE_LEVEL1_RATE = 150;    
    uint256 public constant REFERENCE_LEVEL2_RATE = 100;     
    ...
    uint256 public constant PLAN_TERM =120 days;            
    ...
    function _invest(address _addr, uint256 _referrerCode, uint256 _amount) private returns (bool) {
        ...
        matches.push([_referrerCode,uid,_amount]);
    ...
    function withdraw() public {
        ...
        if(withdrawalAmount>0){
            ...
            uint256 reinvestAmount = withdrawalAmount.mul(25).div(100);
