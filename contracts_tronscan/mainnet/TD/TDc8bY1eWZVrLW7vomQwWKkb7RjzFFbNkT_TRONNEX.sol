...
contract TRONNEX is owned {
    ...
    string constant public name = "Tronnex";
    string constant public symbol = "TRNX";
    uint256 constant public decimals = 6;
    uint256 public totalSupply = 51000000 * (10**decimals);   //2Bn
