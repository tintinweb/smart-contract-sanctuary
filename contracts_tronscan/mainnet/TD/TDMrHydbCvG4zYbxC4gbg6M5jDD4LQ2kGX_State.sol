...
contract State is ITRC20, TRC20Detailed {
    ...
    constructor() public TRC20Detailed("STATE TOKEN", "STT", 8){
       
        _mint(msg.sender, 100000000000 * 10 ** 8); //100 Billion Tokens
    }
