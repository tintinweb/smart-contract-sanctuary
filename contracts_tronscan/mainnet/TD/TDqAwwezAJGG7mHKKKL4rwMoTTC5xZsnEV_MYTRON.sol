//SourceUnit: mytron1.sol

pragma solidity ^0.5.4;

/*****
******
Developers Signature(MD5 Hash) : d6b0hdc679a33d9fb19562f135ce6ee
website : mytron.cash
******
*****/
...
contract MYTRON is Pausable{
    ...
    function _registration(address addr, address ref) internal {
        require(investors[ref].initiated , "Inviter address does not exist in the MyTroncash network!");
    ...
    function getWhithdrableStat() public view returns (uint256){
        ...
        require(investors[addr].initiated, "Reinvester address does not exist in the MyTroncash!");
