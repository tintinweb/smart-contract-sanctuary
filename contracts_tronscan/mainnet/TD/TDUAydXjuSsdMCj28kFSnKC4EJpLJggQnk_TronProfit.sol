...
contract TronProfit {
    ...
    uint constant private FUND_FEE = 660;
    uint constant private DEV_FEE = 495;
    uint constant private MARKETING_FEE = 345;
    ...
    uint[] public REFERRAL_PERCENTS = [500, 200, 100];
    ...
    constructor(address payable fundAddr, address payable devAddr, address payable marketingAddr) public {
        require(!isContract(fundAddr) && !isContract(devAddr) && !isContract(marketingAddr));
    ...
    function invest(address referrer) public payable {
        ...
        uint devFee = msg.value.mul(DEV_FEE).div(PERCENTS_DIVIDER);
