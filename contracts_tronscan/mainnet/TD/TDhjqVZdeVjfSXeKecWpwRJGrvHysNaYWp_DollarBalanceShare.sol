...
contract DollarBalanceShare is  ERC20Detailed {

    constructor () public ERC20Detailed("DollarBalanceShare", "DBS", 6) {
        _mint(_msgSender(),3000*1e6);
    }
