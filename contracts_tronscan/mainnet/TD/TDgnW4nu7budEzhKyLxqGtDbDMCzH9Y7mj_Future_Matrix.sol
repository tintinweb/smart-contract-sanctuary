//SourceUnit: futurematrixfinaly.sol

/**
*
* FutureMatrix
*
* https://futurematrix.io
* (only for futurematrix.io Community)
* Crowdfunding And Investment Program: 10% Daily ROI for 30 Days.
* Referral Program
* 1st Level = 10%
* 2nd Level = 5%
* 3rd Level = 3%
...
contract Future_Matrix is Ownable {
    ...
    uint256 public constant MINIMUM = 500e6;                // Minimum investment : 500 TRX
    uint256 public constant REFERRER_CODE = 1000;           // Root ID : 1000
    uint256 public constant PLAN_INTEREST = 100;            // 10% Daily Roi
    uint256 public constant PLAN_TERM = 30 days;             // 30 Days
