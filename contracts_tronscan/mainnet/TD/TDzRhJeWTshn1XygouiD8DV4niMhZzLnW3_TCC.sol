...
contract TCC is ERC20, ERC20Detailed {
    ...
    constructor() public ERC20Detailed("Timeless Computing Power Coin", "TCC", 8) {
        _owner = msg.sender;
        _lastTime = 1627660800;
    ...
    function issue() public onlyOwner returns (bool) {
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        require(amount >= minimum, "TCC: burn amount should be greater than or equal to 100000000");
        require(amount.mod(minimum) == 0, "TCC: burn amount must be a multiple of 100000000");
        _burn(msg.sender, amount);
