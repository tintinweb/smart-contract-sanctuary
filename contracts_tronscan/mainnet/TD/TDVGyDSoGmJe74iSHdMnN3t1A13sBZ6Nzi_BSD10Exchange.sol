...
contract BSD10Exchange is Ownable {

    using SafeMath for uint256;
    
    IERC20 private _BSD20;
    trcToken BSD10id = 1004120;
    ...
    function exchange10to20() payable public returns (bool)  {
        require(msg.tokenid == BSD10id, "Only BSD10 is allowed");
        require(msg.tokenvalue > 0, "Invalid amount");
        return _BSD20.transfer(msg.sender, msg.tokenvalue);
    }

    function exchange20to10(uint256 amount) public returns (bool)  {
        _BSD20.transferFrom(msg.sender, address(this), amount);
        msg.sender.transferToken(amount, BSD10id);
        return true;
    }
