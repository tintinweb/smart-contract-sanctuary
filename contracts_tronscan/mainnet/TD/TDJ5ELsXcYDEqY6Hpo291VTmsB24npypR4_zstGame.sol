...
contract zstGame{
    ...
    // game info
    uint256 public totalInvestedAmount; // total inversted trx  ��Ͷ��rx
    ...
    constructor(IERC20 airdropAddr,address checkAddr) public{
        ...
        team1 = address(0x36486F22fd7E44c75f4FAAE26fd10153Ca866E11); //1.5
        team4 = address(0x4542F4bb569Dd451415223663f931eAbC51fE3aF);//1.5
        team2 = address(0xBba9Ac83F8f64DEadDD580EB2A4D0bA384c35Fc8); //4%
        team3 = address(0xc13E6Ef7EeafEce638530a20FdF89362d42c291d);//5%
        
		setPriceMan = address(0x043b171F8B5f197D2fDD8B5FC9Ab4cbDbC825F09);
