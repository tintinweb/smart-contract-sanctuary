...
//AAC => AACB
contract AACSwapAACB is Ownable{

    using SafeMath for uint256;
    address public AACBToken;
    address public AACToken;
    ...
    constructor(address AACB_token_address, address AAC_token_address) public{
        owner = msg.sender;
        AACBToken = AACB_token_address;
        ERC20AACInterface = IERC20(AACBToken);
        AACToken = AAC_token_address;
        ERC20Interface = IERC20(AACToken);
        SwapTokenAmountIn = 1000000;
    ...
    function Swap(
        ...
        ERC20AACInterface.mint(from_, token_received_amount);
        return true;
    }
