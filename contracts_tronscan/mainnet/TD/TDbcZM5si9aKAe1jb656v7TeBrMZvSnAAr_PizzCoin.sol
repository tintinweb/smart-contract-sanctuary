...
library SafeTRC20 {
    ...
    function safeTransfer(TRC20Basic token, address to, uint256 value) internal {
...
/**
 * @title TRC20 Mintable
 * @dev TRC20 minting logic
 */
contract TRC20Mintable is BasicToken, Ownable {
    /**
...
contract PizzCoin is StandardToken, BurnableToken, TRC20Mintable {
