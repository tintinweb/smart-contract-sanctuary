...
contract EUROTRX {
    ...
    constructor(address payable owneraddress, address payable _overRide, address payable _company, address payable _otherOverRide, address payable _pool1, address payable _pool2)
        public
    {
        owner = owneraddress;
        overRide = _overRide;
    ...
    function poolClosing() public onlyDeployer {
        trxPoolAmount = 0;
        euroTrxPoolAmount = 0;
