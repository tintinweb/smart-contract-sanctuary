...
contract MSGDemoNFT is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 10;

    constructor() public ERC721Full("MSGDemoNFT", "MSGDemo") {
    _setBaseURI("http://thefanblock.com/wp-content/uploads/2021/04/Pines1779Demo.json");
    }
