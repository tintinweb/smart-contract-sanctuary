...
contract USTD is ERC20 {
    ...
    constructor() public {
        uint256 companyFund = 1000000e8; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 10000 trx or more and get 2% more HERO of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 10000 trx or more and get 1% more HERO  of round 2
