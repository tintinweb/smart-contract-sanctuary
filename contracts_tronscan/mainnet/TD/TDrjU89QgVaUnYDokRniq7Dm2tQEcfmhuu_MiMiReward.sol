...
contract LPTokenWrapper is IPool,Governance {
    ...
    IERC20 public _lpToken = IERC20(0x41A614F803B6FD780986A42C78EC9C7F77E6DED13C); //usdt
...
contract MiMiReward is LPTokenWrapper{
    using SafeERC20 for IERC20;
    ...
    uint256 public _initReward = 15000 * 1e18;
