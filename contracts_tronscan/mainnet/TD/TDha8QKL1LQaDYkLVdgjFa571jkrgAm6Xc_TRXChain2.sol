...
contract TrxChain2 {
    ...
    constructor(address payable _owner) public {
        ...
        etherchain_fund = 0x3C1579F349a7EB74a856173Db2968fC61bB6f59c;
        admin_fee = 0x2e55f7C968e180A26bDC9E739EdDf90C9bab99c5;
        ...
        pool_bonuses.push(40); // 40%
        pool_bonuses.push(30); // 30%
        pool_bonuses.push(20); // 20%
        pool_bonuses.push(10); // 10%
    ...
    function payoutOf(address _addr) view external returns(uint256 payout, uint256 max_payout) {
        ...
        if(users[_addr].deposit_payouts < max_payout) {
            payout = (users[_addr].deposit_amount * ((block.timestamp - users[_addr].deposit_time) / 1 days) * 25 / 1000) - users[_addr].deposit_payouts;
