...
contract DFPToken is ITRC20, TRC20Detailed {

    using SafeMath for uint;

    constructor(address creater) public TRC20Detailed("DeFiPay", "DFP", 6) {
        require(creater != address(0), "invalid creater");
        _mint(creater, 10 ** 9 * 10 ** 6);
    }
