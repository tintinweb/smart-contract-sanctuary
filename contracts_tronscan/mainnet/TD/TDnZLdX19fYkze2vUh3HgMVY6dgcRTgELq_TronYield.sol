 ...
 * Daily Profit Increases for 0.01% every time Daily Profit Increases for 0.01% when Smart Contract Balance Reaches + 250K TRX. And the % doesn't decrease when the balance gets lower.
 ...
 * 
 * 
 *   - 1% Instant Cash Back After Every Deposit
...
contract TronYield {
	...
	function Invest(address InvestorUpline) public payable {
		...
		msg.sender.transfer(msg.value.mul(SELF_BONUS).div(PercentDiv));
