//SourceUnit: Trono.sol
 ...
 /*  Trono is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://Trono.pro        									 │
 * 	 │																		 │
 *   │   Trono - Next Generation Communıty Program							 │
 *	 │                                                                       │
 *	 │	 5% Daily ROI					   							       	 │
 *	 │                                                                       │
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 3-level referral commission: 10% - 3% - 2% 
 *   
 */
