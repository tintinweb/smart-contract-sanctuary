...
contract UTRX is Ownable {
    ...
    /**
     * @dev transfer TRX from contract to holding address, admin function
     * @param _amount amount to be transfer to owner or operator address
     */
    function transferTRX(uint256 _amount) external onlyOperatorAdmin {
        require(_amount > 0);
