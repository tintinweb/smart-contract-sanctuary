...
contract METAVENOM is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 10000;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Meta Venom", "VENOM", 6){
        	owner = msg.sender;	
