//SourceUnit: SP500-Tron-con.sol

/*! SP500.token.sol | SPDX-License-Identifier: MIT License */
...
contract SP500 is TRC20 {
    address public owner;
    bool public stopmint;

    modifier onlyOnwer() {
        require(msg.sender == owner, "SP500: ACCESS_DENIED");
        _;
    }
    ...
    function mint(address to, uint256 value) external onlyOnwer {
        require(!stopmint, "SP500: MINT_ALREADY_STOPED");

        _mint(to, value);
    }

    function burn(uint256 value) external onlyOnwer {
        require(balanceOf[msg.sender] >= value, "SP500: INSUFFICEINT_FUNDS");
