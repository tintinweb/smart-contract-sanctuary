//SourceUnit: TronLike7.sol

/**
*
* TronLike - The best Investment plateform based on TRON trx contract
*
* https://tronlike.co
* (only for tronlike.co Community)
* Crowdfunding And Investment Program: 10% Daily ROI.
* Referral Program
*
* Always use https://tronlike.co
* 10% Daily Income
* TronLike also has referral program check the website for more details
*
* 
* TronLike - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
*
*   ┌───────────────────────────────────────────────────────────────────────┐  
*   │   Website: https://www.tronlike.co                                    │
*   └───────────────────────────────────────────────────────────────────────┘ 
*
*   [USAGE INSTRUCTION]
*
...
contract TronLike7 {
	...
	uint256 constant public  INTENVAL = 1 minutes;
	...
	function withdraw() public {
		...
		require( block.timestamp > user.updateTime.add(INTENVAL),'Try again in 24 hours');
