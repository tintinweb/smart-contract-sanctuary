...
contract TronHistory is Ownable {
    using SafeMath for uint256;
    uint256 private constant INTEREST_CYCLE = 1 days;
    uint256 private constant DEVELOPER_ENTRY_RATE = 250; //per thousand
    uint256 private constant ADMIN_ENTRY_RATE = 250;
