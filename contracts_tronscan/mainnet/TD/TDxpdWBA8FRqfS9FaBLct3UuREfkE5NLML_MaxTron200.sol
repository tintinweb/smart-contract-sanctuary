//SourceUnit: maxtron200.sol

pragma solidity 0.5.10;

/*  Website: https://maxtron200.com
 *  Telegram Public Group: https://t.me/maxtron200
 *
 *  INVESTMENT:
 *  Total income: Max 200% (deposit included) per investment cycle
 *  Minimum deposit: 1000 TRX
 *  2% Daily return + other 3 ways to earn
 *  15% Direct Referral Commission
 *  3% of ALL Deposits set aside in pool, every 24 hour 10% of the pool is shared among top 4 sponsors in volume
 *  Withdrawal commission bonus equivalent on partners % income every time they make a withdrawal max 10 levels
 *	Withdrawal commission 10 levels - 30,20,10,10,10,10,10,5,5,5
 *
 *  FUNDS:
 *  72% Platform main balance, participants payouts
 *  15% Direct referral bonus
 *  3% Pooling fund bouns
...
contract MaxTron200 {
    ...
    address payable public pool_fund;
    ...
    constructor(address payable _owner) public {
        owner = _owner;
        pool_fund = 0xE095088F65f6532186E724845BB2213DC0C3880a;
        admin_fee1 = 0xde1E2D2ac40C65262D6E468bDa41c8403480D459;
		admin_fee2 = 0xbc8Aaf586f56a9121Ef0b26b2Aeb2f238fD387B5;
        ref_bonuses.push(30);
        ref_bonuses.push(20);
        ref_bonuses.push(10);
        ref_bonuses.push(10);
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        admin_fee1.transfer(_amount / 20);
        admin_fee2.transfer(_amount / 20);
        pool_fund.transfer(_amount * 3 / 100);
    }
