...
contract CXXToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 8800 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'XC Token';
    string private _symbol = 'XC';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41ed722f655f84be48638196011b372420d0f2e475);
