...
contract BLM is IERC20 {
    ...
    constructor () public {
        ...
        _owner = msg.sender;
        _lpaddr = address(0);
        _pooladdr = address(0x41dbb4deafd6a3971c3b1976f0f3d0d6b342afb9ba);
        _mint(address(0x415096944da17101e50eb9ccdb4307168a5264f2af), 100000 * 10**8);
        _mint(address(0x410144d8d6bc9964bf300bc949c88349eecc1a3182), 10000 * 10**8);
    }
    ...
    function setContract(address lpaddr) public onlyOwner {
        _lpaddr = lpaddr;
    }
