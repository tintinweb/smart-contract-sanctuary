...
contract football is Context, ITRC20, Ownable {
    ...
    uint256 private _totalSupply = 500 * 10**uint256(_decimals);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient]) {
            require(amount <= MAX_STOP_FEE_TOTAL, "transfer amount exceeds balance1");
        }
