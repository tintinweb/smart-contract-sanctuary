 ...
 * 
 *   - Basic interest rate: +3% every 24 hours +0.4166%% hourly)
...
contract Tronbit {
	...
	function withdraw() public {
		...
		uint256 withdrawl_fees = totalAmount.mul(MARKETING_FEE).div(PERCENTS_DIVIDER);
		totalAmount  =  totalAmount.sub(withdrawl_fees);
		marketingAddress.transfer(withdrawl_fees);
