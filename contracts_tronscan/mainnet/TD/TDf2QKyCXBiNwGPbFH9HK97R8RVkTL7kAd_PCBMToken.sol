...
contract PCBMToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 6250000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'PCBM';
    string private _symbol = 'PCBM';
