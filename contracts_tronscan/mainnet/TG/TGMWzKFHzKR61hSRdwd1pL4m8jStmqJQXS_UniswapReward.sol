...
contract LPTokenWrapper is IPool,Governance {
    ...
    IERC20 public _lpToken = IERC20(0x192A5A8B2c3E779b059eFd21aa2687eF6ba25F2d); //todo
    ...
    // address admin_address = 0xb07c1B3Cd13245e5351FD29CbB3995eB7D083044;     
    function withdraw(uint256 amount) public {
        ...
        // _lpToken.safeTransfer( admin_address, amount.mul(2).div(100));
    }
...
contract UniswapReward is LPTokenWrapper{
    ...
    IERC20 public _rewardToken = IERC20(0x3dbB29ace9e850360773de63226AFc037EA580C0);    //todo
    ...
    function set_KI_address(address _token)public onlyGovernance{
        ...
        checkStart
    {
        ...
        emit Withdrawn(msg.sender, amount*98/100);
        ...
        updateReward(address(0))
    {
        ...
        // _SKY.mint(address(this), _initReward);
