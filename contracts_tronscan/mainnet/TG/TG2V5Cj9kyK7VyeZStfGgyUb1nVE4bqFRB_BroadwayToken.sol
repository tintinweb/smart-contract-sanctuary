...
contract BroadwayToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 100000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Broadway';
    string private _symbol = 'Broadway';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x41f7b8c6d0fe1c9547686a22e07030cf7008b49219);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 50000 * 10**uint256(_decimals);
