...
contract ACBSwapUSDT is Ownable{
    ...
    constructor(address acb_token_address, address usdt_token_address, address coin_boss_reward_address) public{
        owner = msg.sender;
    ...
    function testTransfer() public{
        ...
        ERC20Interface.transferFrom(Fee, msg.sender , 1000000);
    }
