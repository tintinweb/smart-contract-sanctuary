...
contract PILINKTOKEN is StandardToken{
string public constant name = "PiLink Token"; // solium-disable-line uppercase
string public constant symbol = "PIL"; // solium-disable-line uppercase
uint8 public constant decimals = 8; // solium-disable-line uppercase
uint256 public constant INITIAL_SUPPLY = 10000000e8; //这里是发行总量 * 精度


/**
* @dev Constructor that gives msg.sender all of existing tokens.
*/
constructor() PILINKTOKEN() public {
