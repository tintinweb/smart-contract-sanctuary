//SourceUnit: TTCryptoNFTTikTokOne.sol
...
// Dependency file: contracts/ICollectible.sol

// pragma solidity ^0.8.0;

// import "/mnt/c/Users/piron/Desktop/TiktokOneCollection/node_modules/@openzeppelin/contracts/token/ERC721/extensions/IERC721Enumerable.sol";

interface ICollectible is IERC721Enumerable {
    function mint(address _to, uint _type) external;
    function mintBatch(address _to, uint256 _items, uint _type) external;
}

// Root file: contracts/TTCryptoNFTTikTokOne.sol

pragma solidity ^0.8.0;

// import { Ownable } from "/mnt/c/Users/piron/Desktop/TiktokOneCollection/node_modules/@openzeppelin/contracts/access/Ownable.sol";
// import { ERC721Enumerable, ERC721, Strings } from "/mnt/c/Users/piron/Desktop/TiktokOneCollection/node_modules/@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
// import { ICollectible } from "contracts/ICollectible.sol";

contract TTCryptoNFTTikTokOne is ICollectible, ERC721Enumerable, Ownable {
     ...
     */
    constructor()
    ERC721("TikTokCrypto NFT TikTokOne", "TTCSNFT")
    {}
     ...
     * Emits a {Transfer} event.
     */
    function mint(address _to, uint _type) external virtual override onlyMinter {
        uint256 tokenId = totalSupply();
        _mint(_to, tokenId);
        tokenType[tokenId] = _type;
    }

    function mintBatch(address _to, uint256 _items, uint _type) external virtual override onlyMinter {
        uint256 tokenId;
    ...
    function setMinter(address _account, bool _status) external onlyOwner {
