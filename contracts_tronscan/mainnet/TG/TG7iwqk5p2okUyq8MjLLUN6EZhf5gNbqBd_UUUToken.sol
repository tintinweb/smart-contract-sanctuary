...
contract UUUToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 19900 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'UUU Token';
    string private _symbol = 'UUU';
    uint8 private _decimals = 8;

    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    address private fundAddress = address(0x41E0EA497BF408A1ABCACF2CAE4FC2995DFA1329C2);
    ...
    uint256 public MAX_STOP_FEE_TOTAL = 5100 * 10**uint256(_decimals);
