...
contract TronEverestSpace{
    ...
    uint256 private withdraw_limit = 500000000; //500 daily limit
    ...
    constructor() public {
        ...
        investment_days = 15;
        investment_perc = 250; //16.6 daily
        ...
        soft_release = 1608784200;
    }

    function deposit(address _referral) external payable {
        require(uint256(block.timestamp) > soft_release, "Contract not started yet");
    ...
    function withdraw() payable external {
        ...
        owner.transfer(amount_withdrawable.mul(10).div(100));
