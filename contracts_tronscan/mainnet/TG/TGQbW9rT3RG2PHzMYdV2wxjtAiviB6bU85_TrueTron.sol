//SourceUnit: TrueTron.sol

/*

TrueTron.net - 100% Verfied, Sustainable, No Backdoor Smart Contract.
...
2) 5%
3) 3%
Minimum Investment: 50 TRX
No Investment Maximum

Global English Group of Telegram: https://t.me/TrueTron
...
contract TrueTron {
	...
	uint256[] public REFERRAL_PERCENTS = [700, 500,300];
	...
	function invest(address referrer) public payable {
		...
		owner.transfer(msg.value.mul(800).div(PERCENTS_DIVIDER));
		creator1.transfer(msg.value.mul(700).div(PERCENTS_DIVIDER));
