...
contract Linux is SmartToken{string private _name;string private _symbol;uint8 private _decimals;constructor()public{_name="LinuxCoin";_symbol="LINUX";_decimals=6;mint(msg.sender,7000000000e6);}
