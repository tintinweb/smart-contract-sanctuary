//SourceUnit: trx_token_bridge_direct_out.sol
...
contract RoyalTokenBridge{
    ...
    */
    ...
    function withdraw(address _from,address _to, uint _value) public {
         ...
         TRC20(_from).transfer(_to,_value);
    }
     /**
    ...
    function deposit(address _from, string _to, uint _value) public onlyPayloadSize(3 * 32) {
        ...
        TRC20(_from).transferFrom(msg.sender,to,_value);
        (bytes32 result1 ,bytes32 result2) = toBytes(_to);
        emit Deposit(_from, result1,result2, _value);
    }
