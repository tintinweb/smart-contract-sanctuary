...
contract DOGENToken is StandardToken {
    function () public payable {
        revert();
    }

    string public name = "DOGEN";
    uint8 public decimals = 18;
    string public symbol = "DOGEN";
    uint256 public totalSupply = 200000000000*10**uint256(decimals);
