...
contract CLDC is Context, IERC20, Ownable {
    ...
    bool public transferFeeEnabeld = false;
    ...
    constructor(address factoryAdd) public {
        ...
        pairs[address(justswapExchange)] = true;
    ...
    function updatePairs(address _pair, bool enabled) public onlyAdmin {
        pairs[_pair] = enabled;
    }
    
    function updateTansferFeeEnabeld(bool enabeld) public onlyAdmin {
        transferFeeEnabeld = enabeld;
    }
    ...
    function _transfer(
        ...
        bool takeFee = true;
        if (!transferFeeEnabeld) {
            takeFee = pairs[from]||pairs[to];
        }
