...
contract NTQE is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 11000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Tauren pass card';
    string private _symbol = 'NTQE';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x4114f17d06c140e10eee89ec79d9c9c06a3a7fbf70);
