...
contract PoolOneReward is LPTokenWrapper {
    ...
    IMembers members = IMembers(0x418C082D8DDF958F5362AC50F7F8AE7EF6D916A6DE);
    MotherPool motherPool = MotherPool(0x41C2D57BB92606F4C9493EF36F31DA090D59020131);
    ...
    uint256[9] private refBonus = [50, 10, 10, 5, 5, 5, 5, 5, 5] ;
...
pragma solidity ^0.5.5;
contract PoolTwoReward is LPTokenWrapper {
    ...
    uint256 timelong = 30 * 24 * 3600 ;
    uint256 totalRate = 30 ;
