...
contract TokenWrapper {
    ...
    IERC20 public y = IERC20(0xBc835Ba531AE54e8393aA715aCc7E0AD8CFe138A); 
    //IERC20 public y = IERC20(0x48cf2A3971b9028d3375459b240B97C80f28344B); // test
...
contract PIIPoolReward is TokenWrapper, IRewardDistributionRecipient {
    ...
    uint256 public totalReward = 250000*1e18;
    ...
    function earnedInfo(address account) public view returns(uint256 ,uint256){
        ...
        uint256 time = periodFinish;
        if(now < periodFinish){
            time = now;
        }
        uint256 timelen = time.sub(plyGetRewardTime[account]);
        uint256 fiveAmount;
        if(timelen >TIEM5*2){
