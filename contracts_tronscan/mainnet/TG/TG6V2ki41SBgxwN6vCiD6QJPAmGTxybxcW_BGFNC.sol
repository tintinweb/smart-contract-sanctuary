//SourceUnit: BGFNC.sol

pragma solidity ^0.5.8;

import "./ITokenDeposit.sol";

contract BGFNC is ITokenDeposit {
    string public name = "Wrapped GrafenoCoin BSC";
    string public symbol = "BGFNC";
    uint8  public decimals = 6;
    trcToken  public gfncTokenId = trcToken(1002992);
    ...
    function deposit() public payable {
        require(msg.tokenid == gfncTokenId, "deposit tokenId not GFNC[1002992]");
    ...
    function withdraw(uint256 sad) public {
        require(balanceOf_[msg.sender] >= sad, "not enough BGFNC balance");
        require(totalSupply_ >= sad, "not enough BGFNC totalSupply");
        balanceOf_[msg.sender] -= sad;
        totalSupply_ -= sad;
        msg.sender.transferToken(sad, gfncTokenId);
