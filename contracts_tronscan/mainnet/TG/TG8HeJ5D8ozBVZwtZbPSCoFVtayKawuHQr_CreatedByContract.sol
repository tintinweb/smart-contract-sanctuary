//SourceUnit: socialswap.core.sol

/*! socialswap.core.sol | SPDX-License-Identifier: MIT License */
...
contract TRC20 is ITRC20 {
    ...
    string public constant name = 'SocialSwap V1';
    string public constant symbol = 'SSTV1';
