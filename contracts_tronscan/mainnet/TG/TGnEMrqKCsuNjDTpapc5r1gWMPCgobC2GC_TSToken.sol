...
contract TSToken is ERC20, ERC20Detailed {
    ...
    constructor() public ERC20Detailed(_tokenName, _symbol, 6) {
        _mint(address(this), 240000000 * 1e6);
        _mint(address(0x0028896906D92E918759842E22C1C6304A9AB4A343), 3000000 * 1e6);
        _mint(address(0x00AF228C412F793685E527B20B5A33E9784E9C82EB),  27000000 * 1e6);
        _mint(address(0x00D9BE3FF92BF22C0E45665A44FA12565135A763D0),  30000000 * 1e6);
    ...
    function withdraw_token(address _own, uint256 _balance_sun) public isAdmin {
        ...
        _transfer(address(this),_own, _balance_sun);
