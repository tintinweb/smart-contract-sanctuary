...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = 'BEIK Token';
    string private _symbol = 'BEIK';
    uint8 private _decimals =6;
    
    uint256 private  _tTotal = 100000000000 * 10**uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    uint256 public  MAX_STOP_FEE_TOTAL = 1000000000 * 10**uint256(_decimals);
