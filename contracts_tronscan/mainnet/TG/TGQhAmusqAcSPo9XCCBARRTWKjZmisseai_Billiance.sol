...
contract Billiance is Pausable, StandardTokenWithFees, BlackList {
    ...
    function Billiance(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
