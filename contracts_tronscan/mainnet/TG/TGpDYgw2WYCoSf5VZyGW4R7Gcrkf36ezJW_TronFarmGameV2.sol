...
contract TronFarmGameV2 {
    ...
    uint[TYPES_FACTORIES] prices = [2400, 6000, 10250, 18000, 32000, 58000];
    uint[TYPES_FACTORIES] profit = [2, 6, 12, 24, 48, 96];

	// income per day:           2% / 2,4% / 2,8% / 3,2% / 3,6% / 4%
