...
contract PGT is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 6666 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'YMG token';
    string private _symbol = 'YMG';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x4111B05CB7D44E3CAA31333E90571E791A731B569F);
