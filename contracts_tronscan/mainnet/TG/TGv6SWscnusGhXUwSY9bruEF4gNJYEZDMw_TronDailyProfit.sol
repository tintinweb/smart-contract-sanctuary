 ...
 *
 *       Telegram 24/7 Support: https://t.me/trondailyprofit_Support
 *
 *       Telegram Public Group: https://t.me/trondailyprofit_EN
 *
...
//****************************************************************************
    ...
    constructor() public {
        ...
        setPortion(3, 100);
        setPlan(0, 50e6);
        setPlanStep(0, 0, 675, 20, 1000);
        setPlan(1, 50e6);
        setPlanStep(1, 0, 550, 30, 1500);
        setPlan(2, 50e6);
        setPlanStep(2, 0, 500, 40, 2000);
        setPlan(3, 50e6);
        setPlanStep(3, 0, 460, 50, 2500);
        setPlan(4, 50e6);
        setPlanStep(4, 0, 433, 60, 3000);
        setPlan(5, 50e6);
        setPlanStep(5, 0, 428, 70, 4000);
