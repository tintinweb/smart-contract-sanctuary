...
contract SPLToken is Context, ITRC20, Ownable {
    ...
    uint256 private _totalSupply = 168000000 * 10**uint256(_decimals);

    address private _burnPool = address(0);
    address private _fundAddress1;
    address private _fundAddress2;
    address private _fundAddress3;
    address private _fundAddress4;
    address private _fundAddress5;
     ...
     * construction.
     */
    constructor (address fundAddress1, address fundAddress2, address fundAddress3, address fundAddress4, address fundAddress5) public {
        _fundAddress1 = fundAddress1;
        _fundAddress2 = fundAddress2;
        _fundAddress3 = fundAddress3;
        _fundAddress4 = fundAddress4;
        _fundAddress5 = fundAddress5;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(
            ...
            uint256 tFundAvg = tFund / 5;
            
            if (tFundAvg == 0) {
                _balances[_fundAddress1] = _balances[_fundAddress1].add(tFund);
            } else {
                _balances[_fundAddress1] = _balances[_fundAddress1].add(tFundAvg);
                _balances[_fundAddress2] = _balances[_fundAddress2].add(tFundAvg);
                _balances[_fundAddress3] = _balances[_fundAddress3].add(tFundAvg);
                _balances[_fundAddress4] = _balances[_fundAddress4].add(tFundAvg);
                _balances[_fundAddress5] = _balances[_fundAddress5].add(tFundAvg);
            }
