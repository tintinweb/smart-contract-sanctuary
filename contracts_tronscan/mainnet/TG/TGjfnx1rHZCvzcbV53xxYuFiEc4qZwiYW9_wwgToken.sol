...
contract wwgToken is Ownable,TRC20,TRC20Detailed,TRC20Burnable,TRC20Pausable {
    using SafeMath for uint256;

    //9910000
    constructor(uint256 totalSupply) TRC20Detailed("WWG Token", "WWG", 6) public {
        _mint(msg.sender, totalSupply.mul(uint256(2100)));
    }
