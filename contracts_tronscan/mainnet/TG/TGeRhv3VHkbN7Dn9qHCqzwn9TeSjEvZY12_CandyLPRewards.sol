...
contract LPTokenWrapper {
    ...
    Member member = Member(0xA704A884562440F974E59F66f4cd1d47D7a6f646);
    uint256[3] refPercent = [3, 1, 1];
    IERC20 public token;
...
contract CandyLPRewards is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public cherry;
    ...
    constructor(address _cherry, address _token) public {
        cherry = IERC20(_cherry);
        token = IERC20(_token);
    }
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            cherry.mintTo(msg.sender, reward);
