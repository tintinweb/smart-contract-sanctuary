//SourceUnit: TronWorldXpress.sol
...
contract TronWorldXpress {
    ...
    bool public updateActivation = true;
    ...
    function getProfit(address _addr) public view returns (uint) {
      ...
      if (secPassed > 0) {
          if(info[msg.sender].joining_time>0 && info[msg.sender].joining_time<=180 days){
          ...
          else if(info[msg.sender].joining_time>180 days && info[msg.sender].joining_time<=360 days){
          ...
          else if(info[msg.sender].joining_time>360 days){
    ...
    function userUpdateActivation(bool activate) public onlyOwner returns(bool){
        updateActivation = activate; // Activate or Deactivate by giving true false
    }
    function updateUserPlayer(
        ...
        uint interestProfit_ref
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b1){
    ...
    function updateUserInfo(
        ...
        uint256 Level_reached
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b2){
                ...
                info[userAddress].joining_time = 1602054827; //1602054827 default
    ...
    function updateUserPreferral(
        ...
        uint256 aff10sum
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b3){
    ...
    function updateUserIndividualLevelIncomes(
        ...
        uint256 L10_income
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b4){
    ...
    function updateUserCashback(
        ...
        bool deposited
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b5){
    ...
    function updateUserCashbackIncome(
        ...
        bool r6_claimed
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b6){
    ...
    function updateUserReward(
        ...
        bool r6
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b7){
    ...
    function updateHighBusiness(
        ...
        uint256 r10_business
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b8){
    ...
    function updateHighBusinessAdd(
        ...
        address r10_business_add
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b9){
    ...
    function updateRewardIncome(
        ...
        uint256 r6_income
            ...
            if(updateActivation==true && !updatebuttons[userAddress].b10) {
    ...
    function updateUserInfoAd(
        ...
        uint affRewardsReinvestment
            ...
            info[userAddress].cashback_cum = cashback_cum;
            info[userAddress].Level_timestamp_player = Level_timestamp_player;
            info[userAddress].joining_time = joining_time; //1602054827 default
    ...
    function updateBusinessSeld(
        ...
        function totalPlayers(uint256 _total) public onlyOwner returns(bool) {
            totalPlayers = _total;
            return true;
        }
