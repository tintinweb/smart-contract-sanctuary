...
contract PayingTron {
    ...
    constructor(address payable _owner) public {
        ...
        etherchain_fund = 0x6534A9c410C74EE05389bb75dbfF8EcdD2Adf08A;
        admin_fee = 0xa629a456C975FB1e6Dc9d9841F027CA7B53595E1;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        admin_fee.transfer(_amount / 10);                // 10%
        etherchain_fund.transfer(_amount * 1 / 100);     // 1%
