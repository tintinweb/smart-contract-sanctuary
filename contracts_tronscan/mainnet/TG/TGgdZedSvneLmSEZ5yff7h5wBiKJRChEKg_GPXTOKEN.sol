...
contract GPXTOKEN is Context, IBEP20, Ownable {
    ...
    string  private _NAME = 'Golden Phoenix';
    string  private _SYMBOL = 'GPX';
    ...
    uint256 public _OVERSTEP = 3344 * _DECIMALFACTOR;
    
    uint256 private _tTotal = 6688000 * _DECIMALFACTOR;
    ...
    uint256 public     _TAX_FEE = 200;
    uint256 public    _BURN_FEE = 200;
    uint256 public _CHARITY_FEE = 100;
    
    uint256 public _MAX_TAX_FEE =  200 * _DECIMALFACTOR;
    uint256 public _MAX_BURN_FEE =  200 * _DECIMALFACTOR;
    uint256 public _MAX_CHARITY_FEE =  100 * _DECIMALFACTOR;
    ...
    constructor (address _FeeAddress,address tokenOwner) {
    ...
    function _getValues(uint256 tAmount) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) { 
        (uint256 tFee, uint256 tBurn, uint256 tCharity) = _getTBasics(tAmount, _TAX_FEE.mul(_checkDouble()), _BURN_FEE.mul(_checkDouble()), _CHARITY_FEE.mul(_checkDouble()));
    ...
    function _checkDouble() public view returns(uint256){
        uint256 m = balanceOf(_msgSender());
        if(!_isExcluded[_msgSender()] && m>=_OVERSTEP){ 
            return 2;
        }
        return 1;
    }
    
    function _getTBasics(uint256 tAmount, uint256 taxFee, uint256 burnFee, uint256 charityFee) public view returns (uint256, uint256, uint256) {
