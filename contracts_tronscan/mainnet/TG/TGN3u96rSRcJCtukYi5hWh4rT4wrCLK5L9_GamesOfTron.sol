//SourceUnit: GamesOfTron.sol

pragma solidity ^0.4.25;

contract GamesOfTron {
  struct Tariff {
    uint time;
    uint percent;
  }
  ...
  constructor() public {
    ...
    tariffs.push(Tariff(50 * 28800, 225));
    tariffs.push(Tariff(70 * 28800, 280));
    tariffs.push(Tariff(90 * 28800, 315));
