...
contract SCY is Context, IERC20, Ownable {
    ...
    string private _name = "SCY Token";
    string private _symbol = "SCY";
    ...
    uint256 public _maxWalletToken = 8888 * 10**18;
    uint256 public _maxBurnAmount = 6000 * 10**18;
    ...
    constructor (address marketingAndDev,address factoryAddress) public {
        _rOwned[_msgSender()] = _rTotal;
        _marketingAndDev = marketingAndDev;
        justswapExchange=IJustswapExchange(
          IJustswapFactory(factoryAddress).createExchange(address(this))
        );
