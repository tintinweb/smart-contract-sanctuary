...
contract jingletron {
	...
	uint256[] public REFERRAL_PERCENTS = [100, 100, 50];
	...
	function isContract(address addr) internal view returns (bool) {
		...
		function withdrawCapital() public returns(bool){
	        ...
	        require(getUserTotalDeposits(msg.sender).mul(1000).div(100)>getUserTotalWithdrawn(msg.sender).add(getUserDividends(msg.sender)),
	        "above earning");
	        uint256 withdrawAmount=getUserDividends(msg.sender);
	        msg.sender.transfer(withdrawAmount);
	        uint256 capital=getUserTotalDeposits(msg.sender);
	        msg.sender.transfer(capital.mul(1000).div(100));
