//SourceUnit: ICLOUDX.sol

/*
 *
 *   ICLOUDX TOKEN | ICLOUD X MINING
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://trx-mining.io                                      │
 *   │                                                                       │
 *   │   Contract Address: TGk3JKZzUqSkieVrhQoXyVHAqukkmUXLBG                │
 *   |   E-mail: contact@trx-mining.io                                       |
 *   └───────────────────────────────────────────────────────────────────────┘
 */
...
contract ICLOUD_X_MINING is StandardToken {
    string public name = "ICLOUD X MINING";
    string public symbol = "ICLOUDX";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 800000000000 * 10 ** uint256(decimals);
