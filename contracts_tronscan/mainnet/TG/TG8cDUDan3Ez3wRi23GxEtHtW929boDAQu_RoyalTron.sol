...
contract RoyalTron {
    ...
    function getReferalBonous() external view returns (uint8[] memory){
      return referral_bonuses;
    }
    ...
    function deposit(address _referral) external payable {
        require(msg.value >= 5e7, "You don't have enough amount");
        ...
        // Number of investors will increase if address is 0x0;
        ...
        // 10 % of the Investment will be sent to the Owner Address
    ...
    //  _setReferral function Set the Refferal address 
