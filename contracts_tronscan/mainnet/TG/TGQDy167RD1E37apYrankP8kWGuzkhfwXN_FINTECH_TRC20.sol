...
contract FINTECH_TRC20 { 
    // Public variables of the token 
    string public name; 
    string public symbol; 
    uint8 public decimals = 18; 
    uint256 precision = 2100000; 
    ...
    */ 
    uint256 initialSupply = 2100000; string tokenName = '3A TOKEN'; 
    string tokenSymbol = '3A'; 
    constructor() public { 
    ...
    modifier isOwner() {
        require(msg.sender == ownerAddr); _; 
        
    } 
    modifier isAdmin() { 
        require(msg.sender == adminAddr); _; 
    ...
    function _transfer(address _from, address _to, uint _value) internal { 
        ...
        require(_to != address(0)); // Check if the sender has enough 
    ...
    function transfer(address _to, uint256 _value) external returns (bool success) { 
        ...
        * * @param _from The address of the sender * @param _to The address of the recipient * @param _value the amount to send 
        */ 
        ...
        * * @param _spender The address authorized to spend * @param _value the max amount they can spend 
        */ 
        ...
        */ 
        function burn(uint256 _value) public returns (bool success) { 
            ...
            * * @param _from the address of the sender * @param _value the amount of money to burn 
            */ 
