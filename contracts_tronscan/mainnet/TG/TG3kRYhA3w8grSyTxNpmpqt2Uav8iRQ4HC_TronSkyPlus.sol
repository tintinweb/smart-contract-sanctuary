...
From 30% to 45% Daily ROI
8% Referral Commission in 3 Levels

******  4 INVESTMENT PLANS  *******

plan 1 to 3 days 45% daily, total return 135%
plan 2 to 5 days 40% daily, total return 200%
plan 3 to 8 days 32% daily, total return 256%
plan 4 to 10 days 30% daily, total return 300%
...
contract TronSkyPlus {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(3, 135));
        tarifs.push(Tarif(5, 200));
        tarifs.push(Tarif(8, 256));
