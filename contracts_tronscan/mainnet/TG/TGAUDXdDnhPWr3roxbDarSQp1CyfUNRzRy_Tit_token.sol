 ...
 * `TRC20` functions.
 */
contract Tit_token is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("TIT", "TIT", 8) {
        _mint(msg.sender, 22200000 * (10 ** uint256(decimals())));
    }
}