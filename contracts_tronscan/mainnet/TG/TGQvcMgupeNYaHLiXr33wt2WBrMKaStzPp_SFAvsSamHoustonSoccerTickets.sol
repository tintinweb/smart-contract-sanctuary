...
//SourceUnit: SFAvsSamHoustonTickets.sol
...
contract SFAvsSamHoustonSoccerTickets is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 1;

    constructor() public ERC721Full("SFAvsSamHoustonSoccerTickets", "SFAvsSHSUSoccer") {
    _setBaseURI("https://thefanblock.com/sfa-vs-sam-houston-2-adult-ga-tickets");
    }
