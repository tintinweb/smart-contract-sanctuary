...
contract Yosan is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 10;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("Yosan Token", "YO", 18){
        	owner = msg.sender;	
