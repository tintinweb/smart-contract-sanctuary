...
contract  MKS is ITRC20 {
    ...
    function burn(uint256 amounts) public  returns(bool){
        require(amounts <= _balances[msg.sender],'error');
        require(msg.sender == initiator,'error');
