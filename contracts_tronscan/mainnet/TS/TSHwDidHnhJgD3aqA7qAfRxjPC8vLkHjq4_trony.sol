 ...
 *    ────────────────────────────────────────────────────────────────────────────────────────────
 *
 *   Trony - Powering TRON for the new equity community
 *   
 *   Website: https://www.trony.io/                                         
 *           
 *   [USAGE INSTRUCTION]
 *
 ...
 *   5) Maximum number of deposits per address can be done : 100
 *   
 *   [INVESTMENT CONDITIONS]
 * 
 *   - Basic interest rate: +1.5% every 24 hours (+0.0625% hourly)
 *   - Personal hold-bonus: +0.2% for every 24 hours without withdraw 
 *   - Platform bonus: +0.1% for every 1,000,000 TRX on platform address balance 
 * 
 ...
 *   - 7 level referral commission: 10%, 5% - 2% - 0.5% - 0.3% - 0.2% - 0.1%
 *
 *   [FUNDS DISTRIBUTION]
 *
 *   - 71.9% Platform main balance, participants payouts
 *   - 3% System fund
 *   - 5% Advertising and promotion expenses
 *   - 18.1% Referral program bonuses
