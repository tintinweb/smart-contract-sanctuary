...
contract CordycepsToken is  ERC20Detailed {
    ...
    constructor () public ERC20Detailed("CordycepsToken", "Cordyceps", 18) {
        builder = msg.sender;
        _mint(builder,30000*1e18);
    }
