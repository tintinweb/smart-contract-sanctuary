//SourceUnit: tronbnb.sol

 /*   TronBnb - investment platform based on TRX blockchain smart-contract technology. Safe, Secure and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://www.TronBnb.com/                                  │
 *   │                                                                       │
 *   │   Telegram Public Group: @tronbinance                                |
 *   |                                                                       |
 *   |   E-mail: admin@TronBnb.com                                          |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   - Minimum deposit: 50 TRX, no maximum limit
...
contract TronBnb {
	...
	uint256[] public REFERRAL_PERCENTS = [30, 25, 5];
	...
	constructor(address payable wallet, uint256 startDate,address payable _marketingWallet) public {
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		uint256 adminFee = msg.value.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);
		commissionWallet.transfer(adminFee);
		emit FeePayed(msg.sender, adminFee);
