...
uint totCurrnt;
    ...
    //registration(msg.sender, referrerAddress);
        ...
        if( users[msg.sender].xAMatrix[1].status>0)
        {
            ...
            if(users[msg.sender].xAMatrix[1].totCurrnt>0 trx)
            {
               ...
               // users[msg.sender].xAMatrix[1].totwith=users[msg.sender].xAMatrix[1].totwith+users[msg.sender].xAMatrix[1].totCurrnt;
   ...
   // emit ChekFinalBro(ref,users[ref].xAMatrix[1].totreceve,users[ref].xAMatrix[1].totwith,paynow,sumtot1,totchk);
    if(users[ref].xAMatrix[1].status==1)
    {
       ...
       //emit Cheknew1new(ref1, ref1,ref1, users[ref1].xAMatrix[1].status, referrerAddress].x8Matrix[1].secondLevelReferrals.length);
