...
contract USDT2Token is Pausable, StandardTokenWithFees, BlackList {
    ...
    function USDT2Token(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
