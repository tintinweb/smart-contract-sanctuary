...
contract TronPTest is Ownable, Destructible, Pausable {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
    ...
    uint256 public total_received;                  //total deposite
    ...
    constructor() public {
        ...
        cycles.push(10000 trx);
        cycles.push(30000 trx);
        cycles.push(50000 trx);
        cycles.push(100000 trx);
    }
    ...
    _owner.transfer((_amount*8) / 100);
    creator1.transfer((_amount*3) / 100);
...
contract TronPool is TronPTest {
