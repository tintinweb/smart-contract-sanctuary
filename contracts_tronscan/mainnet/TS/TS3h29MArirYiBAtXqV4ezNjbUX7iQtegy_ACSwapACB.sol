...
//AC => ACB
contract ACSwapACB is Ownable{

    using SafeMath for uint256;
    address public ACBToken;
    address public ACToken;
    ...
    constructor(address acb_token_address, address ac_token_address, uint token_swap_amount_in, uint trade_token_decimal) public{
        owner = msg.sender;
        ACBToken = acb_token_address;
        ERC20ACInterface = IERC20(ACBToken);
        ACToken = ac_token_address;
        ERC20Interface = IERC20(ACToken);
    ...
    function Swap(
        ...
        ERC20ACInterface.mint(from_, token_received_amount);
        return true;
    }
    ...
    function Emergency() external onlyOwner{
        ERC20ACInterface.transfer(msg.sender, ERC20ACInterface.balanceOf(address(this)));
    }
