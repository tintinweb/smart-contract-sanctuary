...
contract TrxBSPool is Ownable {
    IERC20 public rewardToken;   // BS的token地址
    ...
    uint256 public constant DURATION = 40 days;   // 挖矿周期
    uint256 public rewardsPerCycle = 3000 * 1e6;   // 一个周期奖励的FX数量（注意精度）
