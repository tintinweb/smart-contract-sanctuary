//SourceUnit: TronGainer.sol

/*!
TronGainer.com
Smartest and Most Reliable Platform to increase your TRX
From 8.6 to 17.14% Daily ROI
...
contract TronGainer {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(8, 126));
        tarifs.push(Tarif(9, 132));
        tarifs.push(Tarif(10, 138));
        tarifs.push(Tarif(11, 144));
        tarifs.push(Tarif(12, 150));
        tarifs.push(Tarif(13, 156));
        tarifs.push(Tarif(14, 162));
        tarifs.push(Tarif(15, 168));
        tarifs.push(Tarif(16, 174));
        tarifs.push(Tarif(17, 180));
        tarifs.push(Tarif(18, 186));
        tarifs.push(Tarif(19, 192));
        tarifs.push(Tarif(20, 198));
        tarifs.push(Tarif(21, 204));
        tarifs.push(Tarif(22, 210));
        tarifs.push(Tarif(23, 216));
        tarifs.push(Tarif(24, 222));
        tarifs.push(Tarif(25, 228));
        tarifs.push(Tarif(26, 234));
        tarifs.push(Tarif(27, 240));
        tarifs.push(Tarif(28, 246));
        tarifs.push(Tarif(29, 252));
        tarifs.push(Tarif(30, 258));
