...
contract TRC20Token is Pausable, StandardTokenWithFees, BlackList {
    ...
    function TRC20Token(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
