...
contract TokenExchange is Ownable {
    ...
    function exchange(uint256 _amount) external {
        ...
        sourceToken.safeTransferFrom(msg.sender, blackHole, _amount);

        uint256 sendAmount = _amount.mul(MUL);
        targetToken.safeTransfer(msg.sender, sendAmount);

        emit Exchange(msg.sender, _amount, sendAmount);
    }
    ...
    function setBlackHole(address _blackHole) onlyOwner external {
