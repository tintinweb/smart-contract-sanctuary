...
contract RoseGold is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("Rose Gold", "RGT", 6){
        require(gr != address(0), "invalid gr");
        _mint(gr, 250000000 * 10 ** 6);
    }
}
