...
contract PiLinkToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function PiLinkToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
