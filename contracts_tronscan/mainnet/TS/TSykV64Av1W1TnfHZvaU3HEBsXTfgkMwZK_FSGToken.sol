...
contract FSGToken is TRC20, TRC20Detailed {
    uint256 public burned;

    string private constant NAME = "Forsage";
    string private constant SYMBOL = "FSG";
    uint8 private constant DECIMALS = 18;
    uint256 private constant INITIAL_SUPPLY = 10**29;

    constructor () public TRC20Detailed(NAME, SYMBOL, DECIMALS) {
