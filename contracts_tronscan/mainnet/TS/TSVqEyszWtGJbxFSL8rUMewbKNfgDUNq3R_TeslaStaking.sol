...
contract TeslaStaking is ownable {
    ...
    ITRC20 TeslaToken;
    uint256 releaseTime = 1632529800; // 09-20-2022 00:00:00 GMT
    ...
    function release() public {
        ...
        require(amount > 0,"You don't have staked Tesla token.");
        require(now >= releaseTime,"Release time is not reached.");
        staked[msg.sender] = 0;
        TeslaToken.transfer(msg.sender, amount);
    }
