...
ITRC20 public rewardsToken;
    ...
    uint256 public periodFinish = 1635421092;
    uint256 public rewardRate = 0;
    uint256 public totalstakeuser = 0;
    uint256 public rewardsDuration = 11 days;
    uint256 public fee = 1;
    uint256 public rewardpercentage = 2;
    ...
    function getReward() public nonReentrant updateReward(msg.sender) {
        ...
        if (reward > 0 && stakeInfos[msg.sender].rewardlock==false) {
            ...
            uint rewardamt = reward.mul(rewardpercentage);
