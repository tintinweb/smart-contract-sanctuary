...
contract CNYToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function CNYToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
