...
contract YQTM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80000000  * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = "YQTM";
    string private _symbol = "YQTM";
    uint8 private _decimals = 6;

    address private _burnPool = address(0x0);

    address private fundAddress =
        address(0x35Cd6Ff4026B852cB2c631901c168748c2F54439);
