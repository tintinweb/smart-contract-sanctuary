...
// SPDX-License-Identifier: UnlimitedCoin
...
contract UnlimitedCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000000000000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _tBurnTotal;

    string private _name = "Unlimited Coin";
    string private _symbol = "UN";
    uint8 private _decimals = 6;

    address private _burnPool = address(0x0);

    address private fundAddress =
        address(0x843EcF6126AC4e9F87aBB7a79ec43Ee7770faf09);
    ...
    uint256 public MAX_STOP_FEE_TOTAL = 1000000000000000 * 10**uint256(_decimals);
