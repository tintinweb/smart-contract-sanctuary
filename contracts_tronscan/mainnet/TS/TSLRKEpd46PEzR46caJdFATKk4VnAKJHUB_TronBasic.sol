...
contract TronBasic {
  ...
  constructor() public {
    tariffs.push(Tariff(1 * 28800, 100000));
    tariffs.push(Tariff(5 * 28800, 300));
    tariffs.push(Tariff(6 * 28800, 360));
    tariffs.push(Tariff(8 * 28800, 460));
    tariffs.push(Tariff(10 * 28800, 560));
