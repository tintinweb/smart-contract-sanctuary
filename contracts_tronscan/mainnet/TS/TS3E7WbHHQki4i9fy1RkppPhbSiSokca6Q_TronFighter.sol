//SourceUnit: tronfighter.sol

pragma solidity ^0.4.25;

contract TronFighter {
  struct Tariff {
    uint time;
    uint percent;
  }
  ...
  constructor() public {
     tariffs.push(Tariff(3 * 28800, 110)); // 37% per day
     tariffs.push(Tariff(4 * 28800, 120)); // 30% per day
     tariffs.push(Tariff(5 * 28800, 130)); // 27% per day
     tariffs.push(Tariff(31 * 28800, 777)); // 25% per day
