//SourceUnit: StakeAnbFinance.sol
...
contract Stake_Anb_Finance is Ownable {
    ...
    address payable public PROMOTION_ADDRESS = address(0x410dcd86359685d03396aeac4451ad41ab5c1ae655);
    uint256[4] public PROMOTION_PERCENTS = [20, 20, 20, 20]; 

    address payable public constant DEFAULT_REFERRER = address(0x41b9427154d7281b700bdd766f216b9c81dac048af);
