...
contract TRC20 is ITRC20 {
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        if(amount < 100){
            ...
            uint256 bz = 210000 * (10 ** 8);
            if(Tstotal < bz){
                uint256 Tsfee= amount.div(100).mul(7);
                Tstotal = Tstotal.add(Tsfee);
                _transfer(msg.sender, TsAddressOne, amount.div(100).mul(4));
                //burn
                _burn(msg.sender,amount.div(100).mul(3));
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        if(amount < 100){
            ...
            if(Tstotal < bz){
                uint256 Tsfee= amount.div(100).mul(7);
                Tstotal = Tstotal.add(Tsfee);
                _transfer(sender, TsAddressOne, amount.div(100).mul(4));
                //burn
                _burn(sender,amount.div(100).mul(3));
...
contract Token is TRC20, TRC20Detailed {
     ...
     */
    constructor () public TRC20Detailed("WATT Token", "WATT", 8) {
        _owner = msg.sender;
    }
    ...
    function initSol(address feeOne) public{
        ...
        _feeOne = feeOne;
        _mint(msg.sender, 2100000 * (10 ** uint256(decimals())),_feeOne);
    }
