//SourceUnit: SedimentTRC20.sol

pragma solidity ^0.4.25;

contract GrindAndCallFallBack {
...
contract Sediment
{
    ...
    string public name = "SEDIment";
    string public symbol = "SEDI";
    ...
    function approveAndCall(address _spender, uint _value, bytes _extraData) external returns (bool success) {
        allowed[msg.sender][_spender] = _value;
        emit Approval(msg.sender, _spender, _value);
        GrindAndCallFallBack(_spender).receiveApproval(msg.sender, _value, this, _extraData);
        return true;
    }
}