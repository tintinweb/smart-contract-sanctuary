...
contract Tron_Candy {
    ...
    address payable public dev1 = address(0x41DF06685D722699C5F87973B7C845DB24C4189755); //TWJTN3sVHK7hBbxQnnHWFFZswac9A8n19u
    address payable public dev2 = address(0x41C655C945DAC37197625A8B566E8CE669FB9B2251); //TU3uZaAb6TrvDwpkjVcwwBGfEUW8N4zWxQ
    address payable public dev3 = address(0x410A0F96D149292173BCE1648FFC34B0E51D253287); //TAtQS8SaihfCDL5vm1B6ssM68tkZBmuPQB
    address payable public grandPrice = address(0x41F4C67F057BCE0416FB36AE4133F2DDBF97ACC8D3); //TUt2YiHNZ51UhtBeQQESXdxMXZELfeD1QP
