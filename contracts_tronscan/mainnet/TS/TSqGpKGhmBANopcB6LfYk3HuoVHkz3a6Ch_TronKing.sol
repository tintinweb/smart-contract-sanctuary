...
contract TronKing {
    ...
    uint256 public startTime = 1603252800;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        uint256 _devFee = _amount / 5;
        devFee = devFee + _devFee;
    ...
    function viewDevFee() view external returns(uint256 _devFee) {
      require(msg.sender == owner, 'unauthorized call');
      return devFee;
    }

    function withdrawDevFee(address beneficiary, uint256 amount) external returns(bool){
      require(msg.sender == owner, 'unauthorized call');
      require(amount <= devFee, "invalid amount");
      uint256 fee = amount;
