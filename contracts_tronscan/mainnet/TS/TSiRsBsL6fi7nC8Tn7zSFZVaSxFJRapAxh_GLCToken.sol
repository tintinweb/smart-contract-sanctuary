...
contract GLCToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function GLCToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
