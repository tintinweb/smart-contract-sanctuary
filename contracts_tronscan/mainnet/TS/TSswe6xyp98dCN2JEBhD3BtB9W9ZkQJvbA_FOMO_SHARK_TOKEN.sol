//SourceUnit: sharkfomo.sol

/*
 * 
 *  SHARK TOKEN | SHARK FOMO 
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://sharkfomo.net                                      │
 *   │                                                                       │   
 *   │   Contract Address: TSswe6xyp98dCN2JEBhD3BtB9W9ZkQJvbA                │
 *   |   E-mail: support@sharkfomo.net                                       |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 */
...
contract FOMO_SHARK_TOKEN is StandardToken {
    string public name = "SHARK TOKEN";
    string public symbol = "STO";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 99000000 * 10 ** uint256(decimals);
