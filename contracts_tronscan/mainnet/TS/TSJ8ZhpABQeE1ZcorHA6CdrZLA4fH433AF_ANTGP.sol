...
contract ANTGP is Context, IERC20, Ownable {
    ...
    string private _name = 'ANTGP';
    string private _symbol = 'ANTGP';
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 100000 * 10**18;
