...
/*
    ...
    pppp                                                                                                              tttttt      tttt                                
    pppp                                                                                                                tttt                                          
  pppppppp      pppppppppp    pppppppp    pppppppppp    pppppppppp      pppppp        tttttttttt    tttttttttt      tttttttt    tttttt        tttttttttt      tttttt  
    pppp          pppppp    pppp    pppp    pppp  pppp    pppp  pppp  pppp  pppp        tttttt      tttt          tttt  tttt      tttt        tttt          tttt  tttt
    pppp          pppp      pppp    pppp    pppp  pppp    pppp  pppp    pppppppp        tttt          tttttt      tttt  tttt      tttt          tttttt      tttttttttt
    pppp          pppp      pppp    pppp    pppp  pppp    pppp  pppp  pppp  pppp        tttt              tttt    tttt  tttt      tttt              tttt    tttt      
      pppp      pppppppp      pppppppp    pppppppppppppp  pppppppp      pppppppppp    tttttttt      tttttttttt      tttttttttt  tttttttt      tttttttttt      tttttttt
                                                        pppppppp                                                                                                      

                               
    5% Per Day  upto 30 Days                                               
    ...
    // Website: https://tronparadisev2.club
...
contract tronparadisev2 {
    ...
    uint256 private minuteRate = 578703;
    ...
    function collect(address _addr) internal {
        ...
        if (secPassed > 2592000 && player.time > 0) {
            secPassed = 2592000; // 30 days
