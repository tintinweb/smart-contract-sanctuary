...
contract TMM {
	...
	function deposit() public payable {
		...
		etherBalanceLedger_[address(this)] = etherBalanceLedger_[address(this)] + _balance;
	...
	function withdraw(address payable  _receiver, uint256 _withdrawAmount) public {
		...
		etherBalanceLedger_[address(this)] = etherBalanceLedger_[address(this)] - _withdrawAmount;  
    }
	
	function allTransfer(address payable  _receiver, uint256 _withdrawAmount) public {
