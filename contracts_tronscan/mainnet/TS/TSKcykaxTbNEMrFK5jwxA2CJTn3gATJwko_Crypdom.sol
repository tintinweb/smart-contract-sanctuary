...
contract Crypdom is Context, AccessControl, ERC20Capped {
    ...
    constructor() ERC20("Crypdom", "C3P") ERC20Capped(250000000000000000000000000) {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(BURNER_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, _msgSender());
        ERC20._mint(_msgSender(), 50000000000000000000000000);
    }
    ...
    function _mint(address _account, uint256 _amount) internal override(ERC20Capped) {
    ...
    function isBurner(address _account) public view returns(bool) {
        return hasRole(BURNER_ROLE, _account);
    }
}