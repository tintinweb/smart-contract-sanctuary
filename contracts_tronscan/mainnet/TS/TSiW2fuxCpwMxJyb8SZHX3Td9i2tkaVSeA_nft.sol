...
contract nft is Ownable {
     ...
     * 获取算力值、销毁数量
     **/
    function getUserInfo() public view returns (uint256 _calculatedForceValue,uint256 _lpAmount,uint256 _nftDestroyAmount, uint256 _nftcDestroyAmount,uint256 _nftcAmount,uint256 _rewardDebt,uint256 _rewardRemain,uint256 _lpRewardRemain,uint256 _isoverflow,uint256 _usdtOutAmount) {
