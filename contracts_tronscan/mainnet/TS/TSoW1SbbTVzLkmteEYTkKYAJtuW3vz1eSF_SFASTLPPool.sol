...
contract SFASTLPPool is LPTokenWrapper, IRewardDistributionRecipient {
    // fastToken
    ITRC20 public fastToken;
    uint256 public constant DURATION = 12096000; // 140 days

    uint256 public starttime = 1600268400; // 2020/9/16 23:0:0 (UTC UTC +08:00)
    //10.16 23:00:00 30days = 1600268400 + 30*60*60*24
    ...
    constructor(address _staketrc20, uint256 _starttime, address _fasttoken) public{
        tokenAddr = ITRC20(_staketrc20);
        rewardDistribution = _msgSender();
        starttime = _starttime;

        fastToken = ITRC20(_fasttoken);
    }
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (trueReward > 0) {
            ...
            fastToken.safeTransfer(msg.sender, trueReward);
    ...
    */
    ...
    onlyOwner
    {
        require(to_ != address(0), "must not 0");
        require(amount_ > 0, "must gt 0");
        require(token_ != fastToken, "must not fastToken");
