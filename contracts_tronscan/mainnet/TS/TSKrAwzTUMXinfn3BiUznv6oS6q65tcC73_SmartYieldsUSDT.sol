...
contract SmartYieldsUSDT {
	...
	uint256 public INVEST_MIN_AMOUNT = 50e6;
	uint256 public BONUS_MIN_AMOUNT = 50e6;
	...
	constructor(address token, address payable ceoAddr,uint256 start) public {
