...
contract _Maxpine_Coin is TRC20, TRC20Detailed, TRC20Burnable {
    constructor() TRC20Detailed('Maxpine Coin', 'MPC', 18) public {
...
contract Maxpine_Coin is Ownable,_Maxpine_Coin{
      using SafeMath for uint256;
