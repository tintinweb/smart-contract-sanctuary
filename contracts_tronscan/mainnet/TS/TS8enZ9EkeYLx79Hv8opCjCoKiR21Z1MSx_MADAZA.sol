...
contract MADAZA is StandardToken {
    string public name = "MADAZA COIN";
    string public symbol = "MADAZA";
    uint8 public decimals = 6;
    uint256 public INITIAL_SUPPLY = 38000000 * 10 ** uint256(decimals);
