...
contract LFCToken is EIP20Interface {
    ...
    address rewardAddress = 0xFf64987b2780BCAD767343fb67248d8FF201eBf9;//TZFbpUwjytPHkXvxa9ztgwCxvHUejwm7rM
    address protectAddress = 0x00c6b6E8cA8842b0c894EB39918150c8F1e5B7D2;//TA3K3z1ik1KV19Sv6VZAEJUwKhqpVD2nXd
    address totalAddress = 0x2224Ac1d58273c14a98e82f1A91549E12c71B5E0;//TD5jucrCM3Z779PpRHbiqr2M8mp1JruLzd
    
    //LFC - TRX LP contract address
    ...
    function _transfer(address _from, address _to, uint256 _value) private {
        ...
        if(stopFlag){
            ...
            //deduction fee
            uint256 _fee = _value.div(100).mul(10);
    ...
    function setBurnSwitch(bool _switch) public returns (bool success) {
        require(msg.sender == owner,"LFC:FORBIDDEN");
        burnSwitch = _switch;
        return true;
    }
