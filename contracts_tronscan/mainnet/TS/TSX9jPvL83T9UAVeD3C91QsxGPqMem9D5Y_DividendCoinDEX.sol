...
------------------------------------------------------------------------------------------------------
 Copyright (c) 2019 Onwards DIVIDEND COIN DEX Inc. ( https://dex.cryptocurrency789.com )
...
contract DividendCoinDEX is owned {
  using SafeMath for uint256;
  bool public safeGuard; // To hault all non owner functions in case of imergency - by default false
  address public feeAccount; //the account that will receive fees
  uint32 public tradingFeeTradeMaker = 200; // 200 = 0.2%
  uint32 public tradingFeeTradeTaker = 200; // 200 = 0.2%
  
  //referrals
  uint256 public refPercent = 0;  // percent to calculate referal bonous - by default 0% of trading fee
