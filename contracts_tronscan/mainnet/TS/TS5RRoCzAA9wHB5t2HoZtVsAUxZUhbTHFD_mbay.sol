...
contract mbay is Context, IERC20, Ownable {
    ...
    string private _name = 'moonbay';
    string private _symbol = 'mbay';
    uint8 private _decimals = 18;

    address private _burnPool = 0x000000000000000000000000000000000000dEaD;

    //�����ѵ�ַ
    address private fundAddress = address(0x41A313A6252DF04C174CEED1503792029530A56ABD);
