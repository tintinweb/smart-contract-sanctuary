...
contract IDO is ReentrancyGuard, Ownable {
    ...
    event create(IERC20 _feeToken, IERC20 _idoToken, uint256 _IdoPrice, uint256 _idoMaxNum, address _feeTo);
    ...
    constructor (IERC20 _feeToken, IERC20 _idoToken, uint256 _IdoPrice, uint256 _idoMaxNum)  {
        ...
        feeTo = msg.sender;
        emit create(_feeToken, _idoToken, _IdoPrice, _idoMaxNum, feeTo);
    }
