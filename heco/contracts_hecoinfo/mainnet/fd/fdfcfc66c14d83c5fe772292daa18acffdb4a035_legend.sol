...
contract legend is IERC20, Ownable {
    ...
    address _marktAddress = address(0x82a2eAD303254fd977562f9ac6e3A0B681F43305);
    address public uniswapV2Pair;
    uint256 public startTime;
    
    uint256 public _marketRate = 3;
    ...
    function changeMarketRate(uint256 marketRate) public onlyOwner {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _takeTransfer(
                sender,
                _marktAddress,
                tAmount.div(100).mul(_marketRate),
                currentRate
            );
            rate = _marketRate;
        }
