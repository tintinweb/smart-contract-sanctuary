...
/**
 *Submitted for verification at hecoinfo.com on 2022-04-15
*/

/**
 *Submitted for verification at hecoinfo.com on 2022-04-08
*/
...
contract EagleKing is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    string  public name_ = "EagleKing";
    string  public symbol_ = "EagleKing";
    uint256 public swapTokensAtAmount;

    uint256 private buyTokenRewardsFee;
    uint256 public _buyTokenRewardsFee = 10;
    uint256 private sellTokenRewardsFee;
    uint256 public _sellTokenRewardsFee = 10;
    ...
    constructor() payable ERC20(name_, symbol_)  {
        ...
        _marketingWalletAddress = 0x5F57964d7952187aFaB137453633Fc1Cf70a51E5;
        ...
        excludeFromFees(0x9a4aA883215dE4aCd31f43Fd6C10200D345B8442, true);

        
        _creation(0x9a4aA883215dE4aCd31f43Fd6C10200D345B8442, totalSupply);
    }
    ...
    function _transfer(
        ...
        require(!_isBlacklist[from] , 'Enemy address');
