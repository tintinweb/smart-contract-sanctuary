...
contract ASwapHelp is Ownable {
  using SafeMath for uint256;
    ...
    address public token = 0x9E6a5C1811F05ffb0B55A5ee2D31A09F149A8CC2;
    ...
    function buySwap() public {
        ...
        if (!inSwapAndLiquify) {
            swapAndLiquify(tokenContract.balanceOf(address(this)));
        }
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        ...
        swapTokensForToken(half, address(this)); 
    ...
    function swapTokensForToken(uint256 tokenAmount, address receiveAddress) public {
