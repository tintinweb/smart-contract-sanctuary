...
contract SupreHT is Context, IERC20, Ownable {
    ...
    string private _name = "Super HT";
    string private _symbol = "SuperHT";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receiveBuy = payable(address(0x000000000000000000000000000000000000dEaD));
	address payable _receiveSell = payable(address(0x000000000000000000000000000000000000dEaD));
    address _tokenOwner;
    address[] buyUser;
