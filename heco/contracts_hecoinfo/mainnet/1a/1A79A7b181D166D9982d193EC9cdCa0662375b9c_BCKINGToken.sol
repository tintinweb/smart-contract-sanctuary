...
contract BCKINGToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    string  public name_ = "ByteKingToken";
    string  public symbol_ = "ByteKing";
    ...
    constructor() payable ERC20(name_, symbol_)  {
        ...
        _marketingWalletAddress = 0x94142b17C906DA15A1337760F80c44c8EF9778Ec;

        buyTokenRewardsFee = 1;
        buyLiquidityFee = 1;
        buyMarketingFee = 5;
        buyDeadFee = 0;

        sellTokenRewardsFee = 4;
        sellLiquidityFee = 1;
        sellMarketingFee = 2;
        sellDeadFee = 0;
        ...
        excludeFromFees(0x147102fc359759047347a0b64780be011C4acBcc, true);

        
        _creation(0x147102fc359759047347a0b64780be011C4acBcc, totalSupply);
    }
