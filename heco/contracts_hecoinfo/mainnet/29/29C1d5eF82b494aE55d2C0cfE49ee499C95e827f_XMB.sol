...
contract XMB is Context, IERC20, Ownable {
    ...
    string private _name = "XMB";
    string private _symbol = "XMB";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receiveBuy = payable(address(0x1D30ADeccaEb0442189609eb489B864f71c27c7a));
	address payable _receiveSell = payable(address(0x226940fD20DC4AbE1FF5d969275f9313577529a8));
    address _tokenOwner;
    address[] buyUser;
