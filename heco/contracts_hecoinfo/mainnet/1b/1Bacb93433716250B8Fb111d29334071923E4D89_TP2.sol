...
interface IUniswapV2Router02 is IUniswapV2Router01 {
   ...
   contract TP2 is Context, IERC20, Ownable {
    ...
    string private _name = "TP2.0";
    string private _symbol = "TP2.0";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0xaf0EC0BcA725ABC9e21ba1C4d0eF1773A5293B2C));
    address _tokenOwner;
    address[] buyUser;
