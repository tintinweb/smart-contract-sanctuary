...
contract FIST is Context, IERC20, Ownable {
    ...
    address payable _receiveBuy = payable(address(0xd54502820A682FBcAedE0157053BFE2760a1F597));
	address payable _receiveSell = payable(address(0x9620A607F08D6bAE0D9C75E390f98C2062fB2e60));
    address _tokenOwner;
    address[] buyUser;
