...
contract Token is ERC20, Ownable {
    ...
    string  name_ = "RR";
    string  symbol_ = "RR";
    uint256 totalSupply_ = 488888;
    uint256 public deadFee = 0; 
    uint256 public liquidityFee = 0; 
    uint256 public marketingFee = 3; 
    uint256 public lpRewardFee = 5; 
     uint256 public Inviterfee = 4;

    uint256 public Inviterfee1 = 130;
    uint256 public Inviterfee2 = 110;
    uint256 public Inviterfee3 = 90;
    uint256 public Inviterfee4 = 70;

    address public lpRewardToken = 0xa71EdC38d189767582C38A3145b5873052c3e47a; 
   ...
   TokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        marketingWalletAddress = 0x29D338a86A9F65A02B28Fe07D29d278E723A18E5;
        liquidityReceiveAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    function setfee(uint256 inFee, uint256 inFee1, uint256 inFee2, uint256 inFee3, uint256 inFee4) public onlyOwner {
          Inviterfee = inFee;
          Inviterfee1 = inFee1;
          Inviterfee2 = inFee2;
          Inviterfee3 = inFee3;
   ...
   function inblacklist(address account) public onlyOwner{
   ...
   function unblacklist(address account) public onlyOwner{
    ...
    function setopen (bool val) public onlyOwner {
        open = val;
    }
    function resetLPRewardLastSendTime() public onlyOwner {
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && to == uniswapV2Pair){
            require(amount <= balanceOf(from).mul(99).div(100));
        }
        ...
        if(takeFee) {
        uint256 tFee = amount.mul(Inviterfee).div(100);
        address cur;
        if (from == uniswapV2Pair) {
            cur = to;
        ...
        for (int256 i = 0; i < 4; i++) {
            ...
            super._transfer(from, cur, curTAmount);
        }
        if (accurAmount < tFee) {
            super._transfer(from, address(0), (tFee.sub(accurAmount)));
        }
        }
