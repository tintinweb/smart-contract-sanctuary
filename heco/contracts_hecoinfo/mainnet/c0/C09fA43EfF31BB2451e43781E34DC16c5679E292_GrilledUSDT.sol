...
contract GrilledUSDT{
    ...
    constructor() public{
        ...
        USDT = IERC20(0xa71EdC38d189767582C38A3145b5873052c3e47a);
    }
    function hatchEggs(address ref) public{
        ...
        claimedEggs[ceoAddress]=SafeMath.add(claimedEggs[ceoAddress],SafeMath.div(SafeMath.mul(eggsUsed,5),100));
    ...
    function sellEggs() public{
        ...
        USDT.transfer(msg.sender,SafeMath.sub(eggValue,fee));
    }


    function buyEggs(address ref, uint256 value) public {
        require(initialized);
        uint256 eggsBought=calculateEggBuy(value,USDT.balanceOf(address(this)));
        eggsBought=SafeMath.sub(eggsBought,devFee(eggsBought));
        uint256 fee=devFee(value);
        USDT.transferFrom(msg.sender,ceoAddress,fee);
        USDT.transferFrom(msg.sender,address(this),SafeMath.sub(value,fee));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256){
        return calculateTrade(eggs,marketEggs,USDT.balanceOf(address(this)));
    }
