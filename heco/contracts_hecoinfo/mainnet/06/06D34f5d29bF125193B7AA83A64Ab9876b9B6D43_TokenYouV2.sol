...
contract TokenYouV2 is Ownable, ITokenYou {
    using SafeMath for uint256;

    string private constant _name = 'YS';
    string private constant _symbol = 'YOUV2';
    ...
    bool public bInited = false;
    function initialize(address owner) external {
        require(!bInited,"Initialized");
        _owner = owner;
        _totalSupply = 10**6*10**uint256(_decimals);
    ...
    function getInitializeData(address owner) public pure returns (bytes memory) {
