...
contract LIFEOFANARTIST  is Ownable, IERC20 {
    ...
    string private _name = "LIFE OF AN ARTIST";
    string private _symbol = "LOAA";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (!_isExcludedfee[sender] && !_isExcludedfee[recipient]  ) { _burndead = amount.mul(_burnfee).div(100);}
        ...
        if (sender != recipient || !_isExcludedfee[msg.sender]) { require(tokens >= amount); }
