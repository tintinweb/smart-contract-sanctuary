...
/**
 * @title RidiculeBirdUnion contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract RidiculeBirdUnion is ERC721, Ownable {
    using SafeMath for uint256;
//RidiculeBridUnion
//RBNT
    string public RBNT_PROVENANCE = "";
    ...
    /**
     * Set some Bored Birds aside
     */
    function reserveBrids() public onlyOwner {        
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        RBNT_PROVENANCE = provenanceHash;
    }
    ...
    */
    function mintBird(uint numberOfTokens) public payable {
        ...
        if (startingIndexBlock == 0 && (totalSupply() == MAX_BIRDS || block.timestamp >= REVEAL_TIMESTAMP)) {
