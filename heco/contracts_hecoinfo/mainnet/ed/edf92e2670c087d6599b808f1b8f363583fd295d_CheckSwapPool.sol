...
contract CheckSwapPool is s {
    ...
    function get(SwapPool _swap,address _user,uint256 _tokenId) external view returns (bool canswap,claimList[] memory claimListAll,IERC721Enumerable SwapNFT,uint256 swapPrice,uint256 claimTimes,tokenInfo memory swapTokenInfo) {
