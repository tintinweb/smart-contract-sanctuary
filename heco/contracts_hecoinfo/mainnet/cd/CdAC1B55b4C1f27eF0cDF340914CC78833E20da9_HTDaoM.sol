...
contract HTDaoM is Context, IERC20, Ownable {
    ...
    string private _name = "HTDaoM";
    string private _symbol = "HTDaoM";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receiveBuy = payable(address(0x43fb4309A03091DcAC28DBb789E5966b5F5C507e));
    ...
    function swapAndLiquify() public {
        if(balanceOf(address(this)) > _maxTxAmount){
            ...
            if(balanceAllHt >balanceHt){
                ...
                _receiveBuy.transfer(newHt.div(5));
				_receiveSell.transfer(newHt.div(5));
            }
        }
    }
