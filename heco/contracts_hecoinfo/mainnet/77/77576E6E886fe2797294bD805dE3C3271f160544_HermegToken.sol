/**
 *Submitted for verification at hecoinfo.com on 2022-05-18
*/
...
// ----------------------------------------------------------------------------
contract HermegToken is ERC20Interface, Ownable{
  ...
  constructor() public {
    ...
    decimals = 9;
	feeRate = 500;
	minFee = 10**uint(decimals - 2);
    _totalSupply = 
1000000000000000* 10**uint(decimals);
    balances[0x4d45b74B9F6eEbd13dbaF5691C5C1f41EbDcd914] = _totalSupply;
    emit Transfer(address(0),0x4d45b74B9F6eEbd13dbaF5691C5C1f41EbDcd914, _totalSupply);
  }
