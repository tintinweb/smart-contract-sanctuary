...
contract Token is IERC20, Ownable {
    ...
    function batchTransfer(address[] calldata accounts, uint256 amount) public payable returns (bool){
    ...
    function setLoopEnd(int256 loopEnd) public onlyOwner() {
        _loopEnd = loopEnd;
    }
