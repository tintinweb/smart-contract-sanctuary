...
// File: contracts\interfaces\IMdexRouter02.sol

interface IMdexRouter02 is IMdexRouter01 {
...
library MdexLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6d4bedc7bee8d0f520ba0e7f8a57c18e56a2934c14fdaf84db134f3a98af6d19' // init code hash
            ))));
    }
...
contract token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0x1b0B8E9D8bE9CE5a38331153C68307a2E9B10e03);
    address public devAddress = address(0x1b0B8E9D8bE9CE5a38331153C68307a2E9B10e03);
    ...
    IMdexRouter02 public immutable uniswapV2Router;
    ...
    constructor () public {
        ...
        IMdexRouter02 _uniswapV2Router = IMdexRouter02(0xED7d5F38C79115ca12fe6C0041abb22F0A06C300);
