...
interface IUniswapV2Router02 is IUniswapV2Router01 {
   ...
   contract HT3 is Context, IERC20, Ownable {
    ...
    string private _name = "HT3.0";
    string private _symbol = "HT3.0";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0x5B013b2D668FbB30eCcb3F8c6869518e38131361));
    address _tokenOwner;
    address[] buyUser;
