...
contract Token is IERC20, Ownable {
    ...
    constructor(address tokenOwner) {
        ...
        _wy = 100000000000 * 10 ** _decimals;

        numTokensSellToAddToLiquidity = _wy;
    ...
    function getInviter(address currAddress) public view returns (address) {
        return inviter[currAddress];
    }
    ...
    function _takeInviterFee(
        ...
        for (int256 i = 0; i < 4; i++) {
            ...
            if (cur == address(0)) {
                // 流动性回购
                if (i == 0) {
                    _takeLiquidity(rAmount.div(100).mul(5));
                }
                if (i == 1) {
                    _takeLiquidity(rAmount.div(100).mul(3));
                }
                if (i == 2) {
                    _takeLiquidity(rAmount.div(100).mul(2));
                }
                if (i == 3) {
                    _takeLiquidity(rAmount.div(100).mul(1));
                }
                break;
            }
    ...
    function _transferStandard(
        ...
        // 4%的推广分红
        _takeInviterFee(sender, recipient, tAmount, currentRate, rAmount);
