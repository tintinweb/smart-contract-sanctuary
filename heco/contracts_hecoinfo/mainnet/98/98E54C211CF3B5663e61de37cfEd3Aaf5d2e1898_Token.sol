...
contract Token is IERC20, Ownable {
    ...
    function _takeDestroyFee(
        ...
        if (rDestroyFee == 0) return;

        _rOwned[_destroyAddress] = _rOwned[_destroyAddress].add(rDestroyFee);
        emit Transfer(sender, _destroyAddress, rDestroyFee);
    }
    ...
    function _transferStandard(
        ...
        _takeDestroyFee(sender, tAmount.div(1000).mul(_destroyFee));

        _takeLiquidity(sender, tAmount.div(1000).mul(_liquidityFee));
