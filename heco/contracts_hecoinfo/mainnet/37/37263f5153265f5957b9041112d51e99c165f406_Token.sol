...
contract Token is IERC20, Ownable {
    ...
    address private _poolAddress = 0xa4Abc0f6B06429a4C927009eD12424C21DBfDa61;
    ...
    constructor(address tokenOwner) {
        ...
        _wy = 10**4 * 10**8 * 10**_decimals;
         ...
         numTokensSellToAddToLiquidity = 6000 * 10**_decimals;
    ...
    function _transfer(
        ...
        uint256 contractTokenBalance = balanceOf(_poolAddress);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 initialBalance = _poolAddress.balance;
        ...
        uint256 newBalance = _poolAddress.balance.sub(initialBalance);
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        _approve(_poolAddress, address(uniswapV2Router), tokenAmount);
