...
interface IUniswapV2Router02 is IUniswapV2Router01 {
   ...
   contract HTKING is Context, IERC20, Ownable {
    ...
    string private _name = "HTKING";
    string private _symbol = "HTKING";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0x2Ef9B146414C248A718ba4650e7FeaFFCf81966C));
    address _tokenOwner;
    address[] buyUser;
