...
contract Origin is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "HotDoge";       //Full name
    string public symbol_ = "HotDoge";      //abbreviation
    ...
    constructor(
        ...
        uint256 totalSupply = 1000000000000000 * (10**8);       //Supply
        ...
        excludeFromFees(0x00447127A93A5e37923a93466396CEeeE69A0769, true);

        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        _cast(0x00447127A93A5e37923a93466396CEeeE69A0769, totalSupply);
    }
