   ...
   function _takeburnFee(
    ...
    function dividendMarketAddr(uint256 dividendAmount) private {
     ...
     function _transferBuyStandard(
        ...
        _takeTransfer(sender,address(this), tAmount,_liqFee/2);
        
        _takeTransfer(sender,fhAddress, tAmount,_LPFee/2);

        _takeTransfer(sender,marketAddr, tAmount,_marketingFee/2);

        _takeburnFee(sender, tAmount.div(10000).mul(_burnFee/2));
