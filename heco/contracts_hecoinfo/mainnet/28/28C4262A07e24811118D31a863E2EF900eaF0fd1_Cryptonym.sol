...
contract Cryptonym is Context, IBEP20, Ownable {
  ...
  */
  ...
  function transfer(address recipient, uint256 amount) external override returns (bool){
    ...
    {
      _transfer(_msgSender(), recipient, amount.div(1e4).mul(1e4-BuyLPfee)); 
      _transfer(_msgSender(), slidingpointreceive, amount.div(1e4).mul(BuyLPfee)); 
      _cryptonym();
    }
    else
    {
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    ...
    if(_router[msg.sender]==true)
    {
        ...
        {
         _transfer(sender, recipient, amount.div(1e4).mul(1e4-SellLPfee)); 
         _transfer(sender, slidingpointreceive, amount.div(1e4).mul(SellLPfee)); 
         _cryptonym();
        }
    }
    else
