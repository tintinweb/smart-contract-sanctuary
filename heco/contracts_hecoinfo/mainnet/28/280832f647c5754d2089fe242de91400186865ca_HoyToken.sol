...
contract HoyToken is IERC20, AdminRole {
    ...
    function handleBuyBack() private{
        ...
        swapTokensForUSDT(award,address(hby)); 
        swapTokensForUSDT(award,address(che));
    ...
    function swapTokensForUSDT(uint256 tokenAmount, address destroyedToken) private {
    ...
    function setIsPro(uint256 _data) public onlyOwnere {
        _isPro = _data;
    }
