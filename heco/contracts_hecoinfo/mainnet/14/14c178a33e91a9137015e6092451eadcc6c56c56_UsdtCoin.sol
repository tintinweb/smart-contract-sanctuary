...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address _rewardTokenAddress, uint256 _minimumTokenBalanceForDividends) DividendPayingToken("Dividen_Tracker", "Dividend_Tracker", _rewardTokenAddress) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = _minimumTokenBalanceForDividends * (10**18); //must hold 1+ tokens
    }
...
contract UsdtCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    string  public name_ = "UsdtCoin";
    string  public symbol_ = "UsdtCoin";
    ...
    uint256 public _AmountTokenRewardsFee;
    ...
    constructor() payable ERC20(name_, symbol_)  {
        ...
        rewardToken = 0xa71EdC38d189767582C38A3145b5873052c3e47a;
        _marketingWalletAddress = 0x16b17EF7400E46aC46Ed1e5656EE1Ecd1280489b;

        buyTokenRewardsFee = 6;
        buyLiquidityFee = 2;
        buyMarketingFee = 2;
        buyDeadFee = 2;

        sellTokenRewardsFee = 9;
        sellLiquidityFee = 2;
        sellMarketingFee = 2;
        sellDeadFee = 2;
        ...
        uint256 totalSupply_ = 10000000000000000;
        ...
        excludeFromFees(0x47b76Fe7540727baD1B4f44bf0203e633234728e, true);

        
        _creation(0x47b76Fe7540727baD1B4f44bf0203e633234728e, totalSupply);
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            swapping = true;
            if(AmountMarketingFee > swapTokensAtAmount) swapAndSendToFee(AmountMarketingFee);
            if(AmountLiquidityFee > swapTokensAtAmount) swapAndLiquify(AmountLiquidityFee);
            if(AmountTokenRewardsFee > swapTokensAtAmount) swapAndSendDividends(AmountTokenRewardsFee);
            swapping = false;
        }
