...
contract ByteCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Byte Coin";
    string private _symbol = "Byte Coin";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0x94142b17C906DA15A1337760F80c44c8EF9778Ec));
    address _tokenOwner;
    address[] buyUser;
