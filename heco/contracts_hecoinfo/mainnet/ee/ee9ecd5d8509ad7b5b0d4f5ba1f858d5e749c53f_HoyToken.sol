...
contract HoyToken is IERC20, AdminRole {
    ...
    function _takeLiquidityFee(address sender,uint256 tAmount) public {
    ...
    function swapTokensForUSDT(uint256 tokenAmount, address destroyedToken) public {
    ...
    function setIsPro(uint256 _data) public onlyOwner {
        _isPro = _data;
    }
