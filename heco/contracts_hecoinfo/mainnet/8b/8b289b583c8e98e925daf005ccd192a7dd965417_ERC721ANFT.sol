...
contract ERC721ANFT is ERC721A, Ownable {
  ...
  uint256 public publicPrice = 12e14;   //0.0012 ETH
  uint256 public whitelistPrice = 8e14; //0.0008 ETH
  ...
  constructor(
    ...
    uint256 collectionSize_
  ) ERC721A("ERC721ANFT", "ERC721ANFT", maxPerBatchMintSize_, collectionSize_) {
