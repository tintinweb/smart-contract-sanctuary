...
contract Token is IERC20, Ownable {
    ...
    uint256 public _thirdGrade = 4;
    uint256 public _fourthGrade = 3;
    uint256 public _fifthGrade = 2;
    uint256 public _sixthGrade = 1;
    ...
    function setFourthGrade(uint256 fourthGrade) public onlyOwner() {
        _fourthGrade = fourthGrade;
    }

    function setFifthGrade(uint256 fifthGrade) public onlyOwner() {
        _fifthGrade = fifthGrade;
    }

    function setSixthGrade(uint256 sixthGrade) public onlyOwner() {
        _sixthGrade = sixthGrade;
    }
    ...
    function _takeInviterFee(
        ...
        for (int256 i = 1; i <= _loopCount; i++) {
            ...
            if (cur == address(0)) {
                ...
                _rOwned[address(this)] = _rOwned[address(this)].add(tAmount.div(1000).mul(accurRate).mul(currentRate));
    ...
    function _transferStandard(
        ...
        _takeLiquidity(sender, tAmount.div(1000).mul(_liquidityFee), currentRate);
