...
contract WDAOT is IERC20, Ownable {
    ...
    address _default = address(0xE1E570ED74F6525bAE7bAd9C48CD7026A4F21cF3);//no parent
    address _fundAddress = address(0xAE7Bf1472A647EB864b4F5876F0d175094d3159d);

    constructor(address tokenOwner,address root) {
        _name = "WDAOT";
        _symbol = "WDAOT";
        _decimals = 18;
        _tTotal = 5 * 10**7 * 10**_decimals;
