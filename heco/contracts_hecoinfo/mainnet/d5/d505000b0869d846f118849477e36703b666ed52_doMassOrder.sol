...
contract doMassOrder is Ownable, ReentrancyGuard,structK {
    ...
    function doAction(uint256[] memory orderIdList) external view returns (uint256,IERC721Enumerable,uint256,address,uint256) {
        ...
        for (uint256 i =0;i<orderIdList.length;i++) {
            ...
            return (orderid,nftToken,tokenId,erc20Token,price);
