...
/**
 *Submitted for verification at hecoinfo.com on 2022-04-18
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
   ...
   contract PM is Context, IERC20, Ownable {
    ...
    string private _name = "Pachira Macrocarpa";
    string private _symbol = "PM";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0x6649E743939A19fd323494c45Ad8c2A81df93F58));
    address _tokenOwner;
    address[] buyUser;
    ...
    constructor (address tokenOwner){
        ...
        _maxTxAmount = _tTotal.div(100000);
