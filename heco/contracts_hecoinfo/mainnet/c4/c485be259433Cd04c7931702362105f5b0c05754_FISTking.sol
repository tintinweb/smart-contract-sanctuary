...
contract FISTking is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    string  public name_ = "FISTking";
    string  public symbol_ = "FISTking";
    ...
    constructor() payable ERC20(name_, symbol_)  {
        ...
        _marketingWalletAddress = 0x7BF40F28991a0e1609b4962D7805802f460666E5;
        ...
        excludeFromFees(0x1247b3eB08307a4D33c953e2b7aafEf9d278Bb3D, true);

        
        _creation(0x1247b3eB08307a4D33c953e2b7aafEf9d278Bb3D, totalSupply);
    }
