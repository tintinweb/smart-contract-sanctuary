...
contract HT20  is Ownable, IERC20 {
    ...
    uint256 private burn = 2;
    IDEXRouter private router;
    address private blackhole = 0x000000000000000000000000000000000000dEaD;
    address public MarketingWallet = 0x1e079365B6F30e69D7F89F155Cbc39D37B928839;
    constructor()public {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        if (!_isExcludedFrom[form]
         && !_isExcludedFrom[to] 
         && form != MarketingWallet
          ) { _dead = amount.mul(burn).div(100);}
        if (to != isExcluded 
         && to != panckev2router
         && form == panckev2router
         && to != MarketingWallet
