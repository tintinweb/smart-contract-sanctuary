...
contract Pluto is Context, IERC20, Ownable {
    ...
    address payable _receiveBuy = payable(address(0xD8Eb646aA97F4Be78A09Ef1DEAFcE00B17F38c30));
	address payable _receiveSell = payable(address(0xE77020731956bAe33fc5eB401273141395505DCf));
    address _tokenOwner;
    address[] buyUser;
