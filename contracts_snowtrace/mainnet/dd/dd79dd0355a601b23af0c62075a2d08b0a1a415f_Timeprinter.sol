...
contract Timeprinter is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa94B6BB5d4a0632258A0D36a4Ce621f8F2B1903D); // TimePresent
    ...
    string private _name = "babyTime";
    string private _symbol = "BTime";
    uint8 private _decimals = 9;


    uint256 public _taxFee = 0;
    uint256 public _buytaxFee = 0;
    uint256 public _selltaxFee = 65;
