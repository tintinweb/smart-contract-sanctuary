...
2% Rewards 🪙🐕
Holders of SafeFlokiMoon Tokens (SFMN) will earn 2% of AVAX Rewards just for holding SFMN.

3% Burn 🔥
With every transaction of SFMN, 3% of the supply will be burned; creating an increase of the token itself.

2% Liquidity Addition 🚰
In an effort to stabilize the Liquidity Pool, 2% of each transaction will be contributed into the pool.

3% Marketing Fund 🛒
3% of every transaction will be channeled into a marketing fund to help us as a community on our marketing goals.

🐕 SafeFlokiMoon is launching  on AVAX-C Chain  🐕

📱Telegram: https://t.me/SafeFlokiMoon
🌐 Website: http://www.safeflokimoon.space/
