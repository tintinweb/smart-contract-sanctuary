...
WEB: https://stellaravax.com/
TG: https://t.me/StellarAVAX
TW: https://twitter.com/StellarAVAX
...
contract Interstellar is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("Interstellar", "STELLAR") PaymentSplitter(payees, shares) {
