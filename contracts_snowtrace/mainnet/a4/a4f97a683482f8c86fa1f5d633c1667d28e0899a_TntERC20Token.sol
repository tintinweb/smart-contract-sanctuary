...
contract VaultOwned is Ownable {
  ...
  // Set to owner to mint 3k tokens for liquidity pool creation and immediately switch to treasury
  // Treasury ownership passed to MultiSig after environment set up
...
contract TntERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("TNT", "TNT", 9) {
    }
