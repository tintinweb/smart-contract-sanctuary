...
//  Discord: https://discord.gg/mDDKVHyd
//  Twitter : @Polar_DAO
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); // reward address USDC
...
contract Polar_DAO is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; // reward USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Polar_DAO";
    string constant _symbol = "PLAR";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 1%
    uint256 public _maxWallet = _totalSupply.div(40); // 2%
    ...
    address public autoLiquidityReceiver=0x0AFef8AeFB6ce3adEb2f71F5d1c2b5B7aCb1B070; //liq address
    address public marketingFeeReceiver=0x0AFef8AeFB6ce3adEb2f71F5d1c2b5B7aCb1B070; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 800; // 2%
    bool inSwap;
