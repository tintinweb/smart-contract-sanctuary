...
/** 
    Rugged by SnowDog? Make it all back in one trade, with SnowDogV2
    The meme currency you deserve.

   _____                     _____           __      _____  
  / ____|                   |  __ \          \ \    / /__ \ 
 | (___  _ __   _____      _| |  | | ___   __ \ \  / /   ) |
  \___ \| '_ \ / _ \ \ /\ / / |  | |/ _ \ / _` \ \/ /   / / 
  ____) | | | | (_) \ V  V /| |__| | (_) | (_| |\  /   / /_ 
 |_____/|_| |_|\___/ \_/\_/ |_____/ \___/ \__, | \/   |____|
                                           __/ |            
                                          |___/             
...
contract SnowDogV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "SnowDogV2";
    string private constant _symbol = "SDOGV2";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x9b6D17Db1dAD46938a1C1eAa861e0Bbf63BCd530);
        _feeAddrWallet2 = payable(0x9b6D17Db1dAD46938a1C1eAa861e0Bbf63BCd530);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x39BFAb0921c61Fd9570660075ACd6732B7088392), _msgSender(), _tTotal);
    }
