...
contract CurvePeggedTokenPSMBridge is ReentrancyGuard, DelayedActionGuard
{
	...
	constructor (address _peggedToken, uint256 _i, address _psm) public
	{
		require(_i < 3, "invalid index");
		(address _reserveToken,, address _liquidityPool,, address _treasury,,) = CurvePeggedToken(_peggedToken).state();
