...
Avax Kitty ($AVAKITTY) is a hyper deflationary rewards token that pays in $AVAX.

t.me/AvaxKitty
https://twitter.com/AvaxKitty
...
contract AvaxKitty is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Avax Kitty";
    string constant _symbol = "AVAKITTY";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 20000000000/_totalSupply; // 
    uint256 public _maxWallet = 20000000000/_totalSupply; // 
    ...
    address public autoLiquidityReceiver=0x71E428F7DF03B1d1b71B6193B243cccf5A66F3C4;
    address public marketingFeeReceiver=0x71E428F7DF03B1d1b71B6193B243cccf5A66F3C4;
