...
// The purpose of this contract is to test code deployments, 
// to conduct various tests. Some tests cannot be performed on the Testnet, 
// such as the Swap. DO NOT PURCHASE THIS TOKEN.

// Liquidity will be added to allow PRIVATE Swaps, do not buy this token, 
// this liquidity can be withdrawn to carry out other tests, on other contracts. 
// DO NOT BUY, in any way.
...
contract MEMEERC20 is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("MEME", "MEME", 9) {
    }
