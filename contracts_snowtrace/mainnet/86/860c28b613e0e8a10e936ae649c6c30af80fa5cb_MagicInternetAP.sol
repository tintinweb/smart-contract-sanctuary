...
contract MagicInternetAP is Context, IBEP20, Ownable {
    ...
    string private _name = 'MagicInternetAP';
    string private _symbol = 'MIMAP';
    ...
    function _setNodeManagment(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <= 20, 'taxFee should be in 0 - 10');
        _taxFee = taxFee;
    }
    
    function _setNodeEmission(uint256 burnFee) external onlyOwner() {
