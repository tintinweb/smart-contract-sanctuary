...
contract AShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 ASHARE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Athena Shares", "ASHARE") {
        _mint(msg.sender, 1 ether); // mint 1 ATHENA Share for initial pools deployment
