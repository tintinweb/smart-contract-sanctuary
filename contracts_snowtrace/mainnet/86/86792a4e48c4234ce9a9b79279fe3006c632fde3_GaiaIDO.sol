...
contract GaiaIDO is Ownable {
    ...
    function updateCoreAddresses(address _treasury, address _gaia, address _lp) external onlyOwner {
        treasury = _treasury;
        GAIA = _gaia;
        gaia_usdc_lp = _lp;
    }
    ...
    function finalize() external onlyOwner {
        ...
        uint256 gaiaMinted = ITreasury(treasury).deposit(usdc_treasury, USDC, gaiaTreasuryValuation.sub(gaiaNeeded));
