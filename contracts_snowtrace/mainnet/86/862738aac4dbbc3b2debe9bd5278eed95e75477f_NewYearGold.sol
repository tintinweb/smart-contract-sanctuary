...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xd1c3f94DE7e5B45fa4eDBBA472491a9f4B166FC4); // reward address time
...
contract NewYearGold is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xd1c3f94DE7e5B45fa4eDBBA472491a9f4B166FC4; // reward TIME
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NewYearGold";
    ...
    address public autoLiquidityReceiver=0x32a8a6139ca88967018cF3396a108679397C83a1; //liq address
    address public marketingFeeReceiver=0x32a8a6139ca88967018cF3396a108679397C83a1; // marketing address
