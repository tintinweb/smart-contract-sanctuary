...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 dai = IBEP20(0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79);
...
contract BabyThor is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address dai = 0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79; // dai
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyThor";
    string constant _symbol = "BabyThor";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 1.1%
    ...
    address public autoLiquidityReceiver=0x7c1841c420AD46937F6d0733Ff9dE0ed69F4b21d;
    address public marketingFeeReceiver=0x7c1841c420AD46937F6d0733Ff9dE0ed69F4b21d;
