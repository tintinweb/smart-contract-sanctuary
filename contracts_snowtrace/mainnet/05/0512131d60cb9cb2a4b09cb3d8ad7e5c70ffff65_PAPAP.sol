...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x70b33ebC5544C12691d055b49762D0F8365d99Fe);
...
contract PAPAP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x70b33ebC5544C12691d055b49762D0F8365d99Fe; // EP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PAPAP";
    string constant _symbol = "PAPAP";
    ...
    address public autoLiquidityReceiver=0x5E1351e5c600EbF517B6e5dA2DE9252FC18E6979;
    address public marketingFeeReceiver=0x5E1351e5c600EbF517B6e5dA2DE9252FC18E6979;
