...
contract NewYearWaifu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NewYearWaifu";
    string constant _symbol = "NYW";
    ...
    address public autoLiquidityReceiver=0x938a687aFFed8C3A5B652122728AbB4f5E763d7B;
