...
contract DividendDistributor is IDividendDistributor {
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            (bool success,) = shareholder.call{value: amount, gas: 3000}("");
            if(!success) {
                return;
            }
...
contract AvaSquid is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AvaSquid";
    string constant _symbol = "AvaSquid";
    ...
    address public autoLiquidityReceiver = 0xBeF785D551c586cFA6F36f6ACf6a8144451a7F78;
    address public marketingFeeReceiver = 0xB037325589B47390D57FeD74286Cd114A3694363;
