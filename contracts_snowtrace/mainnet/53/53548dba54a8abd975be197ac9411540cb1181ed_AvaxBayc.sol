...
contract AvaxBayc is Ownable, ReentrancyGuard, IERC721, IERC165, IERC721Metadata, IERC721Enumerable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;
    // using EnumerableSetMarket for EnumerableSetMarket.MarketLotSet;

    string internal _name = "AvaxBayc";
    string internal _symbol = "ABAYC";
    ...
    uint256 public mintingPrice = 1.5 ether;
    ...
    // devs
    address private dev1 = 0x5213b7Cb2c631C0764024351DB0a1434a5880b85;
    ...
    function _claimAVAX(uint256 amount) external onlyOwner {
    ...
    event Mint(uint indexed tokenId, address indexed mintedBy, address indexed mintedTo);
     // AVAX is deposited into the contract.
    event Deposit(address indexed account, uint amount);
    //AVAx is withdrawn from the contract.
