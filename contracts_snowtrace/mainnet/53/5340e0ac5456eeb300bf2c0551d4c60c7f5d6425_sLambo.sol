...
contract sLambo is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Lambo", "LAMBO", 9) ERC20Permit() {
    ...
    /**
        @notice increases Lambo supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Lambo
