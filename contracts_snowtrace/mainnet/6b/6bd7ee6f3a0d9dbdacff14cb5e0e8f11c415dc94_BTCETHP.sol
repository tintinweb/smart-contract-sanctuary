...
TG: Private for the few members who waited for me to finish. 
TG goes public in 10-20 minutes. 
Start searching relevant names on Telegram

THIS IS THE ONLY CONTRACT. IT WILL BE POSTED IN OUR TELEGRAM GROUP BIO
...
contract BTCETHP is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = _totalSupply.div(40); //2.5% of total supply
    uint256 public maxWalletToken = _totalSupply.div(40); // 2.5% of total supply
