...
Avax MultiChain Capital: $AMC
$AMC is a pooled investment fund that trades in liquid assets and is able to make extensive use of more complex portfolio-construction and risk management to improve performance

Tokenomics:
- Buy Tax / Sell Tax: 14%
    - 5% of each buy goes to AVAX reflections
    - 4% of each sell to treasury wallet
    - 5% to the liquidity pool.

Website:
http://avaxmultichain.capital

Earning Dashboard:
https://avaxmultichain.capital

Telegram:
https://t.me/avaxmultichaincapital

Twitter:
https://twitter.com/AvaxMCapital

Medium:
https://medium.com/@avaxmultichaincapita
...
contract AvaxMultiChainCapitalDividendTracker is IDividendDistributor {
...
contract AvaxMultiChainCapital is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    string _name = "Avax MultiChain Capital";
    string _symbol = "$AMC";
    ...
    address treasuryWallet = address(0x7813Db0695114F761Da3ff77edA9008d015a4B9d); 
    address liquidityWallet;

    ITraderJoeRouter public router; //trader joe
    address pair; 

    AvaxMultiChainCapitalDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new AvaxMultiChainCapitalDividendTracker();
