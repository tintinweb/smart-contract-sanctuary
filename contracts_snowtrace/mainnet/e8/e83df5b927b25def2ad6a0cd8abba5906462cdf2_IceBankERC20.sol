...
contract IceBankERC20 is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("IceBank", "IceB", 9) {
      address teamWallet = 0x7c432F4161708260416D398cc4f81C7a02A6ed5f;
      _mint(teamWallet, 10000e9);
    }
