...
contract AVAdakedavra is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AVAdakedavra";
    string constant _symbol = "AVAda";
    ...
    address public autoLiquidityReceiver=0xde9B1BfDc164EF89f5983667a7D835D68b4f0Fc4;
    address public marketingFeeReceiver=0xde9B1BfDc164EF89f5983667a7D835D68b4f0Fc4;
    ...
    function SetFeeDivider(bool divider) external onlyOwner {
        feeDivider = divider;
    }
