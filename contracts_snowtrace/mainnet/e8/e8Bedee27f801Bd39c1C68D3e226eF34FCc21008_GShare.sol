...
contract GShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 50,000 GSHARE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Gomb Shares", "GSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 GOMB Share for initial pools deployment
