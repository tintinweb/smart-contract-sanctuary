...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x130966628846BFd36ff31a822705796e8cb8C18D); // BNB
...
contract ATTF is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x130966628846BFd36ff31a822705796e8cb8C18D; // BNB
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAX to the FUTURE";
    string constant _symbol = "ATTF";
    ...
    address public autoLiquidityReceiver=0xeA5873f4092313D1DbdCA7E6a5F618fa3eb3eF8d;
    address public marketingFeeReceiver=0xeA5873f4092313D1DbdCA7E6a5F618fa3eb3eF8d;
