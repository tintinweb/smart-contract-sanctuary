...
/**
CarbonAvaxide (Co2X) is a token based on the avax C network with low transaction fees
and high speed transactions, reflecting holders with tokens in each transaction.
using a fresh contract and minimal taxes.

https://t.me/CarbonAvaxide
*/
...
contract CarbonAvaxide is Context, DeployerBSC, Ownable {
    ...
    string private _name = 'Carbon Avaxide';
    string private _symbol = 'Co2X';
