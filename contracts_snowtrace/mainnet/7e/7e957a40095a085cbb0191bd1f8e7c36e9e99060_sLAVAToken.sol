...
contract sLAVAToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked LAVA", "sLAVA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sLAVA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sLAVA
