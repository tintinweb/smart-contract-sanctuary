...
contract SSCustomBondDepository is Ownable {
    ...
    address public immutable treasury; // mints SnowShiba when receives principle
    ...
    struct Bond {
        uint payout; // SnowShiba remaining to be paid
    ...
    function deposit( 
        ...
        require( payout >= 10000000, "Bond too small" ); // must be > 0.01 PD ( underflow protection )
    ...
    /**
     *  @notice calculate current ratio of debt to PD supply
    ...
    /**
     *  @notice calculate amount of PD available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or PD) to the DAO
     *  @return bool
     */
