...
contract ROM is ERC20Permit, Ownable {
    ...
    constructor() ERC20("ROM", "ROM", 9) ERC20Permit() {
    ...
    function initialize( address stakingContract_ ) external returns ( bool ) {
        require( msg.sender == initializer, "Not approved" );
        require( stakingContract_ != address(0), "Invalid address" );
    ...
    /**
        @notice increases ROM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess ROM
