...
contract TestCake is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x025B86DFaB71A4D451471C6cEA1a0B45F0Ab8559);
    ...
    constructor () {
        Idexrouter02 _dexrouter = Idexrouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        uniswapV2Pair = IUniswapV2Factory(_dexrouter.factory())
