...
/**
    ...
    https://t.me/Love_AVAX

    Passive Income and Low Tax
    What is Love AVAX?
    Love AVAX is a token that is designed to generate high-yield rewards for you.
    In order to generate a $LOVE passive you just need holding.

    4% redistribution in $LOVE
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x2D8Cd13e9C6C4d8D67B67A2D4185ded6489b24b5;
...
contract LoveAvax is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x2D8Cd13e9C6C4d8D67B67A2D4185ded6489b24b5;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LoveAVAX";
