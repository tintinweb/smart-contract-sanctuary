...
/**
  Hodl Baby ETH Printer give free ETH : Low Fees and take lamboo

  look me on : t.me/BabyETH_AVAX
*/  
...
contract BabyETHprinterERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("BabyETHprinter", "BEP", 9) {
    }
