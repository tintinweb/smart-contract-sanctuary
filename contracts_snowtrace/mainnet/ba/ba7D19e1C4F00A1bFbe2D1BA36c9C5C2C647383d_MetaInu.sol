...
/**
  ...
  LOCATED IN THE SUNNY STATE OF THE METAVERSE.
  A COMMUNITY-OWNED TOKEN PORTED TO THE AVALANCHE BLOCKCHAIN. THE META INU WILL INCLUDE A METAVERSE IN VR, MARKETPLACE & GAMES
  
   Social:

  telegram:https://t.me/MetaInuAVAX
...
contract MetaInu is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("MetaInu ", "MetaInu ", 9) {
    }
