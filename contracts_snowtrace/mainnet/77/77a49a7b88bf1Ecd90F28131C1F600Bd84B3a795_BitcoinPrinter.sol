...
// No frills, no bs Bitcoin printer token.
// Liq will be locked using dxlock immediately after launch.
...
// Dependency file: contracts/baby/BitcoinPrinterDividendTracker.sol
...
contract BitcoinPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BitcoinPrinter contract."
        );
    }
...
// Root file: contracts/baby/BitcoinPrinter.sol
...
// import "contracts/interfaces/IJoeFactory.sol";
// import "contracts/interfaces/IJoeRouter02.sol";
// import "contracts/baby/BitcoinPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract BitcoinPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    BitcoinPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = BitcoinPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "BitcoinPrinter: The dividend tracker already has that address"
        );

        BitcoinPrinterDividendTracker newDividendTracker = BitcoinPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "BitcoinPrinter: The new dividend tracker must be owned by the BitcoinPrinter token contract"
        );
    ...
    function updateJoeRouter(address newAddress) public onlyOwner {
        require(
            ...
            "BitcoinPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BitcoinPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != JoePair,
            "BitcoinPrinter: The Pancakeswap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "BitcoinPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "BitcoinPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "BitcoinPrinter: Cannot update gasForProcessing to same value"
        );
