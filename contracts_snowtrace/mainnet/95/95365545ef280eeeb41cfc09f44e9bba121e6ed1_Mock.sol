...
contract Mock is ERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        _balances[sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance");
        _balances[recipient] = _balances[recipient].add(amount);
        emit Transfer(sender, recipient, fromUnderlying(amount));
    }
    ...
    function _mint(address account, uint256 amount) internal override {
        ...
        _totalSupply = _totalSupply.add(amount);
        _balances[account] = _balances[account].add(amount);
        emit Transfer(address(0), account, fromUnderlying(amount));
    }
    ...
    function _burn(address account, uint256 amount) internal override {
        ...
        _balances[account] = _balances[account].sub(amount, "ERC20: burn amount exceeds balance");
        _totalSupply = _totalSupply.sub(amount);
        emit Transfer(account, address(0), fromUnderlying(amount));
    }
    ...
    function _approve(address owner, address spender, uint256 amount) internal override {
        ...
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, fromUnderlying(amount));
    }
}