...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x4f60a160D8C2DDdaAfe16FCC57566dB84D674BD6); // reward address JEWEL
...
contract GEMS is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x4f60a160D8C2DDdaAfe16FCC57566dB84D674BD6; // reward jewel
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GEMS";
    ...
    address public autoLiquidityReceiver=0x5d00637c03B704F48D742E1a95D19bFD02b0dD97; //liq address
    address public marketingFeeReceiver=0x5d00637c03B704F48D742E1a95D19bFD02b0dD97; // marketing address
