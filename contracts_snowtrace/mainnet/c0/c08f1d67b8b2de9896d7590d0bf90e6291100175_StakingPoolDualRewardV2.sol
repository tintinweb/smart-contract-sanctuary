...
// File contracts/StakingPoolDualRewardV2.sol
...
contract StakingPoolDualRewardV2 is Ownable, Initializable {
    using SafeERC20 for IERC20;
    ...
    uint256 public reward0PerDay;
    // Reward tokens created per day.
    uint256 public reward1PerDay;
    ...
    event LogUpdatePool(
        ...
        uint256 reward0PerDay,
        uint256 reward1PerDay
    );
    ...
    function initialize(
        ...
        uint256 _reward0PerDay,
        uint256 _reward1PerDay,
        ...
        reward0PerDay = _reward0PerDay;
        reward1PerDay = _reward1PerDay;
    ...
    function setEndTimestamp(uint256 _endTimestamp) external onlyOwner {
        ...
        endTimestamp = _endTimestamp;
        emit LogUpdatePool(endTimestamp, reward0PerDay, reward1PerDay);
    }
        ...
        returns (uint256, uint256)
    {
        ...
        if (block.timestamp > lastRewardTimestamp && totalStaked != 0) {
            ...
            uint256 tokenReward0 = (multiplier * reward0PerDay) / 86400;
            _accRewardToken0PerShare =
                accRewardToken0PerShare +
                ((tokenReward0 * 1e30) / totalStaked);

            uint256 tokenReward1 = (multiplier * reward1PerDay) / 86400;
    ...
    /// @param _reward0PerDay The amount of reward 0 tokens to be given per day
    /// @param _reward1PerDay The amount of reward 1 tokens to be given per day
    function setRewardPerDay(
        ...
        reward0PerDay = _reward0PerDay;
        reward1PerDay = _reward1PerDay;
        emit LogUpdatePool(endTimestamp, _reward0PerDay, _reward1PerDay);
    }
