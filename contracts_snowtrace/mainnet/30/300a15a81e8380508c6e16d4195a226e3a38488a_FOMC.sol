...
contract FOMC is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4AeAa3F586175a00AFaD16440Ce1C17650d9D86C);
        _feeAddrWallet2 = payable(0x4AeAa3F586175a00AFaD16440Ce1C17650d9D86C);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xD3512a6e1aB76890c1F3FDAA8f06831949EF6fE9), _msgSender(), _tTotal);
    }
