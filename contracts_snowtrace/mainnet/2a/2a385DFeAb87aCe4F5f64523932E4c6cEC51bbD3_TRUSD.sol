...
contract TRUSD is Context, IERC20, IERC20Metadata {
    ...
    address private admin = 0x31B2904Ae00D7B2cf7e5dcA3BD762b9b4901dC0E;
     ...
     */
    constructor() {
        _name = "TRUSD Stable Dollar";
        _symbol = "TRUSD";
        _mint(admin, 8000000 * 1e18 );
    }
