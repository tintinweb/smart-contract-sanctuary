...
contract zBlock is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 200000000000 * 10**9;
    ...
    constructor() ERC20("zBLOCKS", "zBLOCKS", 9) ERC20Permit() {
    ...
    /**
        @notice increases zBlock supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess zBlock
