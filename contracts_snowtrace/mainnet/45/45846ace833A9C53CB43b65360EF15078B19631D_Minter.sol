...
contract Minter is AbstractERC1155Factory  {
    ...
    function purchase(
        ...
        require (fundsAllowance >= NFTs[index].mintPrice * amount, "not enough funds approved");
        uint256 _price = NFTs[index].mintPrice;
        NFTs[index].paymentToken.transferFrom(msg.sender, DAO, _price*amount);
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        require(NFTs[_id].windowOpens != 0, "That NFT does not exist");
