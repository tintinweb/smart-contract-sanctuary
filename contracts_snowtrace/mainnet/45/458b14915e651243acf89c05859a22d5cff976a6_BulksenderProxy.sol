...
/**
 * @title The most trusted crypto airdrop bulksending tool, supports Avalanche, Ethereum, Ether, Erc20 token, BSC, BNB, BEP20 tokens, HT, HRC20 tokens, MATIC (Polygon),  OKEx Chain, Arbitrumx One, Famtom FTM, xDai, XinFin Network, Harmony, TRX, trc20 tokens, trc10 tokens and NFTs
