...
/**
    Stealth Launch
  TG : https://t.me/Gold_Pangoline_Avax
  Gold Exchange make free gold token
*/  
...
contract GoldprinterPangolineERC20 is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("Gold", "Gold", 9) {
    }
