...
// File contracts/strategies/pangolin-minichef/StrategyPngAVAXHCT.sol

pragma solidity ^0.6.7;
contract StrategyPngAVAXHCTMiniLp is StrategyPngMiniChefFarmBase {
    uint256 public _poolId = 33;

    // Token addresses
    address public Png_AVAX_HCT_lp = 0x0B1efd689eBA7E610955d0FaBd9Ab713a04c3895;
    address public token1 = 0x45C13620B55C35A5f539d26E88247011Eb10fDbd;
  ...
  function harvest() public override onlyBenevolent {
    ...
    function getName() external pure override returns (string memory) {
        return "StrategyPngAVAXHCTMiniLp";
    }
}