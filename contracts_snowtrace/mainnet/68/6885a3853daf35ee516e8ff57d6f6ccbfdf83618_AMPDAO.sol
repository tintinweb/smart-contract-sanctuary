 ...
 * For a generic mechanism see {AMPDAO}.
 *
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/ERC20/presets/AMPDAO.sol


// OpenZeppelin Contracts v4.4.0 (token/ERC20/presets/AMPDAO.sol)
 ...
 */
contract AMPDAO is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "AMPDAO: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "AMPDAO: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "AMPDAO: must have pauser role to unpause");
        _unpause();
    }
...
// File: gist-8a9b3214586e72172f44a81b99d617da/catalyst.sol
