...
contract TravelCoin is IERC20Extended, Auth, BaseToken {
    ...
    constructor() payable Auth(msg.sender) {
        ...
        rewardToken = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118;
        router = ITraderJoeRouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        ...
        feeSettings = [uint256(500), 100, 400, 500, 10000];
        _initializeFees(feeSettings);
        _initializeLiquidityBuyBack();

        distributorGas = 500000;
        swapEnabled = true;
        swapThreshold = _totalSupply / 100; // 0.005%
