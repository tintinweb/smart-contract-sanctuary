...
contract AvaShib is ERC20, Ownable {
    ...
    constructor() ERC20("AvaShib", "AvaShib") {
        ...
        marketingWallet = address(0x87a2Dee8fD8f58ec8D4A53Cf14eBCf8Ed338D181); // set as marketing wallet
        buyBackWallet = address(0xffFa941FcecA56743e85a124404a1D3e4D4BddFB); // set as buyback wallet
