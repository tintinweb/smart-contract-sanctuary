...
contract Fundraiser is Ownable {
    ...
    address public constant TRUSTED_DEPOSIT_TOKEN_ADDRESS = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118;
    ...
    // Uniswap v2 Router
    IUniswapV2Router public constant uniswapV2Router = IUniswapV2Router(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106); 
    ...
    function deposit(uint amountToDeposit, address depositToken, uint _amountOutMin, uint _deadline, uint contributionLimit, bytes calldata signature) external noContractsAllowed whenSaleOpen {
        ...
        if (depositToken != TRUSTED_DEPOSIT_TOKEN_ADDRESS) {
            ...
            if (depositToken == uniswapV2Router.WAVAX() || 
                TRUSTED_DEPOSIT_TOKEN_ADDRESS == uniswapV2Router.WAVAX()) {
                path = new address[](2);
                path[0] = depositToken;
