...
// File: contracts/Novax/Planet.sol
...
contract Planet is ERC721{
    ...
    string private buri = "https://u9xw2azhpf.execute-api.eu-central-1.amazonaws.com/default/NovaXPlanetMetadata/";
    
    function setBuri(string memory value) onlyOwner public{
        buri = value;
    }
    ...
    function setParam1(uint planetId, string memory key, uint256 value) onlyNovax public{
        params1[planetId][key] = value;
    }
   
    function setParam2(uint planetId, string memory key, string memory value) onlyNovax public{
    ...
    function MAX_PLANETS() public view returns(uint) {
        return 8888;
    }
    
    function createItem(address  _to) onlyNovaxGame payable public returns (uint){
