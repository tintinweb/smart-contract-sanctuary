...
// File: LeafPublicPresale.sol


pragma solidity ^0.8.0;


contract LeafPublicPresale {

    uint constant MIM_units = 10 ** 18;
    uint constant LEAF_units = 10 ** 18;

    uint public constant PRESALE_MAX_TOKEN = 36883 * LEAF_units ;
    uint public constant DEFAULT_LEAF_PRICE = 10 * MIM_units / LEAF_units ;
    uint public constant MIN_PER_ACCOUNT = 5 * LEAF_units;
    uint public constant MAX_PER_ACCOUNT = 95 * LEAF_units;
