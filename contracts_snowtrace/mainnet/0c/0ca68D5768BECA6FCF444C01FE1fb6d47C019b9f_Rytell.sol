...
/// @title Rytell
contract Rytell is ERC721Metadata {
    ...
    function claimReward(uint256 tokenID_)
        ...
        require(
            ...
            "Rytell: Only owner or approved can claim rewards");

        require(
            _giveaways[tokenID_] == address(0),
            "Rytell: Can't claim for giveaways");
