...
contract MetaVaxx is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaVaxx";
    string private constant _symbol = "MVAX";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x7632605065be1C33B3D7a24612b8f52Be6639C4E);
        _feeAddrWallet2 = payable(0x7632605065be1C33B3D7a24612b8f52Be6639C4E);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xB84CD1165c9388384c007EB4e2db959C6f195150), _msgSender(), _tTotal);
    }
