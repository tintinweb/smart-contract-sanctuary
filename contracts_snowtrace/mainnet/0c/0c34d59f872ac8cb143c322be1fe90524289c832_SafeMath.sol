...
/**
 ...
 SATAVAXTION
//  Blockchain Wars/No jeets allowed lets show the other chains AVAX is here to stay! 
//  https://t.me/satavaxtiontoken
//  Initial Liquidity of around 20 AVAX
// 15-16% Slippage should work, this is to pay for $AVAX rewards, LP fee and Marketing for moon!
// Will be LOCKED after I test everythings working after launch, remember no jeeting :)
// Community can decide what callers, promoters they want and I WILL fund with marketing fee! 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // AVAX
...
contract SATAVAXTION is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // AVAX
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SATAVAXTION";
    string constant _symbol = "SATAVAX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(125); // 0.8%
    ...
    address public autoLiquidityReceiver=0x25BD76c3094bF8119Ec0DB9f75828aF33D14A18b;
    address public marketingFeeReceiver=0x27b09D3a5DD758f0510692bdf1Ba4ED8D0308b70;
