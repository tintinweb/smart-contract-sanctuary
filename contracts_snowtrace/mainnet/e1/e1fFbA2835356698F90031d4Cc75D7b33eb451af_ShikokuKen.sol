...
/**
 *Shikoku Ken, we aim to be the biggest dog token on AVAX chain, things will begin from now.
 *TG: shikokukenavax
*/
...
contract Ownable is Context {
    ...
    address private _OwnerAddress = 0xde89DABDfE51a6b3870963903eFFc7e2DE202a66;
...
contract ShikokuKen is Context, IERC20, Ownable {
    ...
    string private _name = "Shikoku Ken";
    string private _symbol = "Shikoku Ken";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0xde89DABDfE51a6b3870963903eFFc7e2DE202a66;
