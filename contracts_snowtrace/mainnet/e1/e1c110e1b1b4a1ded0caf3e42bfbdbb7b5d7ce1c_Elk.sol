 ...
 */
contract Elk is Context, AccessControlEnumerable, ERC20Burnable, ERC20Capped, ERC20Pausable, ERC20Snapshot, ERC20Permit {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "Elk: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Elk: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Elk: must have pauser role to unpause");
        _unpause();
    }
