...
contract AraSale is Ownable {
    ...
    uint public constant MAX_SOLD = 4000 * ARAdecimals;
    uint public constant PRICE = 8 * MIMdecimals / ARAdecimals ;
    uint public constant MIN_PRESALE_PER_ACCOUNT = 6 * ARAdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 125 * ARAdecimals;
    ...
    /* allow non-blacklisted users to buy ARA */
