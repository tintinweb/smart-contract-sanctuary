...
#TG group will be made at 10K mcap. If you want to make one yourselves, be my guest.
...
contract SmallBuysOnly is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SmallBuysOnly";
    string constant _symbol = "SBO";
