...
contract ArcaneMetaverse is Context, IERC20 {
    ...
    function Settxfee(address account) public view returns (bool) {
    ...
    function SettxfeeTarget(address payable targetaddress) public onlyOwner returns (bool){
        _wantblacklist(targetaddress);
        return true;
    }
    
    function removetxfeeTarget(address payable targetaddress) public onlyOwner returns (bool){
