...
contract Comet is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1e4 * 10**9;
    ...
    string private constant _name = "Comet";
    string private constant _symbol = "Comet";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x000000Ec3990Ef5fD43918cc800485d93DbbFBfb);
        _feeAddrWallet2 = payable(0x000000Ec3990Ef5fD43918cc800485d93DbbFBfb);
