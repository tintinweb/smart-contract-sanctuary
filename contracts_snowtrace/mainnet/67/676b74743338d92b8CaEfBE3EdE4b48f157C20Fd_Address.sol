...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x0ed8B647D6C31c39a89fE98eF24376Ad73E66f61;
...
contract gn is Context, IERC20, Ownable {
    ...
    // C-Chain address of the charity wallet
    address private _charityWalletAddress = 0x4Bbe923D3291d873B66C7e1e45748d25BBc2f17B;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Good Night";
