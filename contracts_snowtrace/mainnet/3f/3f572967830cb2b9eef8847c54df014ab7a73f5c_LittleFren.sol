...
Little Fren - Burn + Burn + Burn = MOON
PUT $50 here and come back after one week !!!!

Inspired by other recent Little coins, I present to you Little Fren
Anti dump / whale function, there is a fixed max buy/sell.
I hate rugs so not happening.

- 100% LP LOCK 
- Contract Renounce right away after launch
...
contract LittleFren is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Little Fren";
    string private _symbol = "LFren";
