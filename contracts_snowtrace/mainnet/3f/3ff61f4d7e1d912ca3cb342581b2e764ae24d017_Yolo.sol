    ...
    ReentrancyGuardUpgradeable
{
        ...
        returns (bytes32 orderId, bytes memory orderData)
    {
        ...
        IWAVAX(inputToken).deposit{value: inputAmount}();
    ...
    /**
     * @notice Update buffer percent of tokens
     */
    ...
    function _transferFee(
        ...
        if (_executor != address(0) && _executionFee > 0) {
            IERC20(_token).safeTransfer(_executor, _executionFee);
        }
    }
