...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x86afF7c1F7ebfC62f28ABeeFE5187673fccaa2Ef);
    address WAVAX = 0x86afF7c1F7ebfC62f28ABeeFE5187673fccaa2Ef;
    IDEXRouter router;
...
contract TESTPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x86afF7c1F7ebfC62f28ABeeFE5187673fccaa2Ef; // EP
    address public WAVAX = 0x86afF7c1F7ebfC62f28ABeeFE5187673fccaa2Ef;
    ...
    address public autoLiquidityReceiver=0xE14EE18c160101756aEaE203FB92F67716B3Cf15;
    address public marketingFeeReceiver=0xE14EE18c160101756aEaE203FB92F67716B3Cf15;
