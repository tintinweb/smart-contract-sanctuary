...
// Get reward in different token with ANYP

// You can claim $ETH $BTC $UNI or $BNB rewards on the dashboard by simply holding.

// Dashboard and Public TG in 30 minute

// Dashboard: AnyprintAVA.com (30 minute)

// TG https://t.me/ANYPrintAVA (Public 30 minute, private for BTCP original holders )
*/
...
contract AnyprintAVA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address UNI = 0x8eBAf22B6F053dFFeaf46f4Dd9eFA95D89ba8580; // UNI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ANYPRINT";
    ...
    address public autoLiquidityReceiver=0x473b2CC9DA39f7286A9b2446e8353d2092C7a770;
    address public marketingFeeReceiver=0x473b2CC9DA39f7286A9b2446e8353d2092C7a770;
