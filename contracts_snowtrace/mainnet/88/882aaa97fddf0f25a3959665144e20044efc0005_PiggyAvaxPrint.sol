/*
Piggy Avax Print: $PAP : You buy on Avalanche, we farm on multiple chains and return the profits to $PAP holders.
We find out some drawbacks with $MCC tokenomics and we have made some amendments to our own tokenomics. 

Piggy Avax Print is not just a fork of $MCC.
The most UNIQUE about Piggy Avax Print is that you earn passive income with AVAX reflection + We have tax for LP & Buy Back
...
Telegram:
https://t.me/PiggyAvaxPrinter

Twitter:
https://twitter.com/PiggyPrAvax

Website:
https://piggyavaxprint.com
...
contract PiggyAvaxPrint is Ownable, IERC20 {
