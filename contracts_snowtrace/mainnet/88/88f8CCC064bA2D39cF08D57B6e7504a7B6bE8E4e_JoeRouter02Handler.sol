...
} from "../../functions/traderjoe/FTraderJoe.sol";

/// @notice UniswapV2 Handler used to execute an order via UniswapV2Router02
/// @dev This does NOT implement the standard IHANDLER
contract JoeRouter02Handler is IHandler {
    using TokenUtils for address;

    // solhint-disable var-name-mixedcase
    IJoeRouter02 public UNI_ROUTER;
    address public immutable WAVAX;

    // solhint-enable var-name-mixedcase

    constructor(IJoeRouter02 _uniRouter, address _wavax) {
