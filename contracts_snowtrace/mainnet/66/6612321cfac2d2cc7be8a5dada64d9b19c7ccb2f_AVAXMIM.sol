...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 AVAX = IBEP20(0x130966628846BFd36ff31a822705796e8cb8C18D); //MIM
...
contract AVAXMIM is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address AVAX = 0x130966628846BFd36ff31a822705796e8cb8C18D; // MIM
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x0B9e5ef7087866dB1c27E84f3419D5f3Aa47e853;
    address public marketingFeeReceiver=0x0B9e5ef7087866dB1c27E84f3419D5f3Aa47e853;

    string constant _name = "AVAXMIM";
    string constant _symbol = "AVAXMIM";
