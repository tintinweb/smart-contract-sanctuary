...
- Stealth launch
- No team tokens
- 100% of supply goes to initial liquidity
...
contract SenpaiDAO is Context, IERC20, Ownable {
    ...
    string private _name = 'SenpaiDAO';
    ...
    address payable public _PCCWalletAddress;
    ...
    constructor(address payable PCCWalletAddress, address payable marketingWalletAddress) {
        _PCCWalletAddress = PCCWalletAddress;
    ...
    function sendAVAXToTeam(uint256 amount) private {
        _PCCWalletAddress.transfer(amount.div(2));
    ...
    function setPCCWallet(address payable PCCWalletAddress) external onlyOwner() {
        _PCCWalletAddress = PCCWalletAddress;
    }
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 10000000000 * 10 ** 9, 'maxTxAmount should be greater than 1% of total supply');
