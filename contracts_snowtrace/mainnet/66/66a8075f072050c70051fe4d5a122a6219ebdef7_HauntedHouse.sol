...
contract HauntedHouse is Ownable {
    ...
    //whether the onlyApprovedContractOrEOA is turned on or off. on by default
    bool public onlyApprovedContractOrEOAStatus = true;
    ...
    function setOnlyApprovedContractOrEOAStatus(bool newStatus) external onlyRole(4) {
