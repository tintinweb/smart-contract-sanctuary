...
contract Ice is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 ICE-WAVAX LP -> ICE pool
    ...
    */
    ...
    //ICE MINT FUNCTION CODE HAS BEEN REMOVED TO ENSURE SAFETY OF USER FUNDS
    ...
    */
    ...
    function distributeReward(
        ...
        address _iceRewardPool
    ) external onlyOperator {
        require(!rewardPoolDistributed, "only can distribute once");
        require(_genesisPool != address(0), "!_genesisPool");
        require(_iceRewardPool != address(0), "!_iceRewardPool");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_iceRewardPool, INITIAL_ICE_POOL_DISTRIBUTION);
    }
