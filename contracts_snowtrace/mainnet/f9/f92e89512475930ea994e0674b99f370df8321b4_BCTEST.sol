...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 mong = IBEP20(0xD74CCA216F7c8Fe33f0911da8698E2B3eFc98835);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = mong.balanceOf(address(this));
        ...
        uint256 amount = mong.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            mong.transfer(shareholder, amount);
...
contract BCTEST is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address mong = 0xD74CCA216F7c8Fe33f0911da8698E2B3eFc98835; // mong
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BCTEST";
    string constant _symbol = "BCTEST";
