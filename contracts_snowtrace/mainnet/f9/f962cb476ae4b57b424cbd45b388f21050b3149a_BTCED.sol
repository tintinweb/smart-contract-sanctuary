...
BTCED is forked of the RING and BTCP project, 
$BTCNODE uses a simple mechanism to redistribute the yield while supporting the growth of the token.

You can create a node with 100 BTCNODE tokens. 
Once your node is created, it can’t be undone and it generates lifetime returns in BTC for you.
...
contract BTCED is IBEP20, Auth {
    ...
    string constant _name = "BTCED";
    string constant _symbol = "BTCNODE";
    ...
    address public autoLiquidityReceiver=0x9943CAF546A225E30A05DC1802442f750A850A73;
    address public marketingFeeReceiver=0x9943CAF546A225E30A05DC1802442f750A850A73;
