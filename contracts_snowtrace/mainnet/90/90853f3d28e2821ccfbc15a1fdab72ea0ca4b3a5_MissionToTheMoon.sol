...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // reward address ETH
...
contract MissionToTheMoon is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB; // reward ETH
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Mission To The Moon";
    string constant _symbol = "MTTM";
    ...
    address public autoLiquidityReceiver=0x80652ddcD143Bc267c8b916509D814982D6b5a8D; //liq address
    address public marketingFeeReceiver=0x80652ddcD143Bc267c8b916509D814982D6b5a8D; // marketing address
