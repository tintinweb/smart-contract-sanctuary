...
contract TOMB is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Tomb", "TOMB", 9) ERC20Permit() {
    ...
    /**
        @notice increases tomb supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess tomb
