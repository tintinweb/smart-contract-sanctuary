...
contract ETHPSwap is Ownable {
  IERC20Decimals private ethpV1;
  IERC20Decimals private ethpV2;

  mapping(address => bool) public swapped;

  constructor(address _v1, address _v2) {
    ethpV1 = IERC20Decimals(_v1);
    ethpV2 = IERC20Decimals(_v2);
  }
  ...
  function swap() external {
    ...
    ethpV2.transfer(
      msg.sender,
      (_v2Amount * 10**ethpV2.decimals()) / 10**ethpV1.decimals()
    );
  }
