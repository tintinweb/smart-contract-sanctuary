  ...
  IPangolinCallee
{
  ...
  /// @dev Continues the action (trader joe)
  function joeCall(
    address sender,
    uint,
    uint,
    ...
    require(sender == address(this), 'joeCall/bad-sender');
    _pairCallback(data);
  }

  /// @dev Continues the action (pangolin)
  function pangolinCall(
    ...
    require(sender == address(this), 'pangolinCall/bad-sender');
    _pairCallback(data);
  }

  /// @dev Continues the action (uniswap / sushiswap / pancakeswap / trader joe / pangolin)
