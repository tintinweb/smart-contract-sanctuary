...
/**
  ...
  Moonalisa features:
   ...
   4% fee added for marketing
   1% fee added for maintenance and NFT  
...
library SafeMath {
  ...
  function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
    // Solidity only automatically asserts when dividing by 
...
contract Moonalisa is Context, IERC20, Ownable {
  ...
  address payable wallet1 = 0x57FBf982f7Fb9F1549Fc4e6b39c29F69888aE5cB;
  address payable wallet2 = 0x64d3bd5fD7498BE9Cc3ED73d87deb35Ed1073355;
  ...
  string private constant _name = "Moonalisa";
  string private constant _symbol = "MLSA";
  uint8 private constant _decimals = 9;
  
  uint256 public _taxFee = 5;
  uint256 private _previousTaxFee = _taxFee;

  uint256 public _devFee = 5; // marketing,  NFT and maintenance
  ...
  constructor () public {
      ...
      IJoeRouter02 _uniswapV2Router = IJoeRouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);// JouterRouter02 0x60aE616a2155Ee3d9A68541Ba4544862310933d4
  ...
  */
  ...
  function _takeDev(uint256 tDev) private {
      uint256 currentRate =  _getRate();
      uint256 tDev1 = tDev.mul(75).div(100);
      uint256 tDev2 = tDev.sub(tDev1);
      uint256 rDev1 = tDev1.mul(currentRate);
      uint256 rDev2 = tDev2.mul(currentRate);

      _rOwned[wallet1] = _rOwned[wallet1].add(rDev1);
      _rOwned[wallet2] = _rOwned[wallet2].add(rDev2);

      if(_isExcluded[wallet1])
          _tOwned[wallet1] = _tOwned[wallet1].add(tDev1);
          _tOwned[wallet2] = _tOwned[wallet2].add(tDev2);
  }
  ...
  function buyMVAXWithLeftoverWAVAX(uint256 amount) external onlyOwner() {
      ...
      uniswapV2Router.swapExactAVAXForTokensSupportingFeeOnTransferTokens(
        amount,
        path,
        address(this),
        block.timestamp
  ...
  function setRouterAddress(address newRouter) external onlyOwner() {
      IJoeRouter02 _uniswapV2newRouter = IJoeRouter02(newRouter);//v2 router --> 0x10ED43C718714eb63d5aA57B78B54704E256024E
      // Create a pancakeswap pair for this new token 
      uniswapV2Pair = IUniswapV2Factory(_uniswapV2newRouter.factory())
            .createPair(address(this), _uniswapV2newRouter.WAVAX());
