...
//15% DAI Rewards for this bearish market! :)

// TELEGRAM-https://t.me/daimaker
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xd586E7F844cEa2F87f50152665BCbc2C279D8d70); // reward address (DAI) 
...
contract DaiMaker is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70; // DAI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DAIMaker";
    string constant _symbol = "DAIMAKER";
    ...
    address public autoLiquidityReceiver=0x6C92d8d29027aC3B19C125Ea2a49B92598791779; //liq address
    address public marketingFeeReceiver=0x6C92d8d29027aC3B19C125Ea2a49B92598791779; // marketing address
