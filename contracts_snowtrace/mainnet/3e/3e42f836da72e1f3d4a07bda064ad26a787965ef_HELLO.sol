...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); //reflection token
    address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // PAIR
    IDEXRouter router;
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); // Router DEX
        _token = msg.sender;
    }
...
contract HELLO is IBEP20, Auth {
    ...
    address EP = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; // USDC (reflection token)
    ...
    uint256 public _maxWallet = _totalSupply.div(25); // 3%
    ...
    address public autoLiquidityReceiver=0x1e164777F3305A1dD079823f455B8b9F29E985d3;
    address public marketingFeeReceiver=0x1e164777F3305A1dD079823f455B8b9F29E985d3;
    ...
    uint256 private gasPriceLimit = 45000000000; // 45 nAvax / gWei -> Default 25
    ...
    uint256 public swapThreshold = _totalSupply / 1000; // 0.1% //minimum amount for holder to receive reflections
    bool inSwap;
