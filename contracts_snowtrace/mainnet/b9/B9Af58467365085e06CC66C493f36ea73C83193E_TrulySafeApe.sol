...
/** This really is something you can safely ape into. Liquidity won't be pulled until it hits the floor honestly. We just can't lock it or anything and hate to burn it.
...
contract TrulySafeApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "TrulySafeApe";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xe49e4f067C47e7289fc9952E6fb965b70153Fd34);
        _feeAddrWallet2 = payable(0xe49e4f067C47e7289fc9952E6fb965b70153Fd34);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xe49e4f067C47e7289fc9952E6fb965b70153Fd34), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityAVAX{value: address(this).balance}(address(this),balanceOf(address(this)),0,0,owner(),block.timestamp);
        swapEnabled = true;
