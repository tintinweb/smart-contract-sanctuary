...
contract TyyStaking is Ownable {
    ...
    /**
        @notice stake TYY to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sTYY from warmup
    ...
    /**
        @notice forfeit sTYY in warmup and retrieve TYY
     */
    ...
    /**
        @notice returns the sTYY index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract TYY holdings, including bonuses provided
        @return uint
     */
    ...
    /**
        @notice recover wrong tokens in staking contract
