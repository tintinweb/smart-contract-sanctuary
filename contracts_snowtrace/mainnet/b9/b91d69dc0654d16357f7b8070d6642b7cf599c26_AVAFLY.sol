...
// GET REWARDS IN SPELL with ASPELL
// TG https://t.me/avaspell
// Site https://avaspell.xyz/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SPELL = IBEP20(0xCE1bFFBD5374Dac86a2893119683F4911a2F7814);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SPELL.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WAVAX;
        path[1] = address(SPELL);
        ...
        uint256 amount = SPELL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SPELL.transfer(shareholder, amount);
...
contract AVAFLY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SPELL = 0xCE1bFFBD5374Dac86a2893119683F4911a2F7814; // SPELL
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVA  FLY";
    string constant _symbol = "AVAF";
    ...
    address public autoLiquidityReceiver=0x465318b3B86B2E640a97e7849bCc114D5D7199C3;
    address public marketingFeeReceiver=0x465318b3B86B2E640a97e7849bCc114D5D7199C3;
