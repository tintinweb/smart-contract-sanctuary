...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 dai = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
...
contract EarnAVAX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address dai = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // dai
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "EarnAVAX";
    string constant _symbol = "EARNX";
    ...
    address public autoLiquidityReceiver=0x85EA0c2FbD9d4E05DAC823203f9a6510628fE409;
    address public marketingFeeReceiver=0x85EA0c2FbD9d4E05DAC823203f9a6510628fE409;
