...
contract EEVEE is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xe646B9A3C56C4912c9D01d690696231B4884c5e6);
        _feeAddrWallet2 = payable(0xe646B9A3C56C4912c9D01d690696231B4884c5e6);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xe646B9A3C56C4912c9D01d690696231B4884c5e6), _msgSender(), _tTotal);
    }
