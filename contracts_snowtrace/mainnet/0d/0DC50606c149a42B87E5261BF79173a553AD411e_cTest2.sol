...
contract cTest2 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x8a9c04eF43F82113AAe56C8880F5e7E733941aA9;
    ...
    string private _name = "cTest2";
    string private _symbol = "cTest2";
    ...
    function setStakingContract(address account) external onlyOwner(){
        _stakingContractAddress = account;
    }
    ...
    function _transfer(
        ...
        if( (from == _charityWalletAddress) || (to == _charityWalletAddress ) || (from == _stakingContractAddress) || (to == _stakingContractAddress) ){
            takeFee = false;
        }
