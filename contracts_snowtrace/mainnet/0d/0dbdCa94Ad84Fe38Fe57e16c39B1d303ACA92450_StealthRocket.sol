...
/**
    StealthRocket fairlaunch on ava network
    Initial liquidity will be 30 avax
    Launch at traderjoe

    https://t.me/StealthRocket
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x67c8712FEFD905910681dA64AE0f0C84bfbD58bF;
...
contract StealthRocket is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x67c8712FEFD905910681dA64AE0f0C84bfbD58bF;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "StealthRocket";
