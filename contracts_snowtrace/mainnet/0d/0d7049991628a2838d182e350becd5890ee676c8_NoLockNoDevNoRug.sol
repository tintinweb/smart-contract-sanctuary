...
/**
No lp lock, no tg group, no rug

Token will be online for 24hrs, if we mooon in the meantime, i'll make myself public.
...
contract NoLockNoDevNoRug is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NoLockNoDevNoRug";
    string constant _symbol = "NLNDR";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 3 / 100; // 2%
    uint256 public _maxWallet = _totalSupply * 3 / 100; // 2%
