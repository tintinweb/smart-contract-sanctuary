...
// File contracts/ERC20WithVoting.sol
...
// File contracts/ERC20WithVotingAndPermit.sol
...
// File contracts/ZombieBOOFI.sol
...
contract TEST_ZombieBOOFI is ERC20WithVotingAndPermit("ZTEST", "zTEST"), Ownable {
    ...
    function expectedBOOFI(uint256 amountZBoofi) public view returns(uint256) {
        return ((amountZBoofi * currentExchangeRate()) * (MAX_BIPS - withdrawalFee())) / (MAX_BIPS * 1e18);
    }
    ...
    function withdrawalFee() public view returns(uint256) {
        if (!withdrawalFeeEnabled) {
            ...
            uint256 withdrawalFeeValue = IzBOOFI_WithdrawalFeeCalculator(withdrawalFeeCalculator).withdrawalFee();
