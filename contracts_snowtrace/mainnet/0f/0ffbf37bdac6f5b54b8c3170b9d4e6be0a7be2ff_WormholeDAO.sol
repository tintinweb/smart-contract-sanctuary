...
Stealth launch Wormhole DAO, the spoon of Olympus DAO. 
Wormhole is missioned to build a community-owned protocol for decentralized reserve currency on Avalanche while feeding back to the Olympus DAO mothership. 
No presale, everyone has a fair chance. 

https://wormholedao.com
...
contract WormholeDAO is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("WormholeDAO", "WORM", 9) {
    }
