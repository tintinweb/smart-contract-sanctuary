...
hi, i created this for my final project for University.

I will be live presenting this project in class tomorrow(links provided)

Rewards are in $UNI (properly fitting for University ha..)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 UNI = IBEP20(0x8eBAf22B6F053dFFeaf46f4Dd9eFA95D89ba8580);
...
contract UNIPRINT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UNIPRINT";
