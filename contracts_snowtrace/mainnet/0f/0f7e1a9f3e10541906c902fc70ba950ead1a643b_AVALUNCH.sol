...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Comet = IBEP20(0x2923E182A6e68C0fE4006736a33B32f805703683);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = Comet.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Comet.transfer(shareholder, amount);
...
contract AVALUNCH is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address Comet = 0x2923E182A6e68C0fE4006736a33B32f805703683; // Comet
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVALUNCH";
    string constant _symbol = "AVALUNCH";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 1.25%
