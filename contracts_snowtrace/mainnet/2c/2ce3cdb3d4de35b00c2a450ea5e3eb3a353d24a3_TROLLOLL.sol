...
interface IJoeFactory {
    ...
    contract TROLLOLL is Context, IERC20, Ownable {
        ...
        address payable public _TRLWalletAddress;
        ...
        constructor (address payable TRLWalletAddress, address payable marketingWalletAddress) {
            _TRLWalletAddress = TRLWalletAddress;
        ...
        function sendAVAXToTeam(uint256 amount) private {
            _TRLWalletAddress.transfer(amount.div(2));
        ...
        function _setTRLWallet(address payable TRLWalletAddress) external onlyOwner() {
            _TRLWalletAddress = TRLWalletAddress;
        }
