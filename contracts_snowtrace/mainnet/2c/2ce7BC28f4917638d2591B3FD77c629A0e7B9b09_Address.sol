...
contract test is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 800; // All taxes are divided by 100 for more accuracy.
    ...
    address payable private _marketingWallet = payable(0x22C5B48C1cb0077513005B6C8860256F0bdB31B1);
    ...
    constructor (uint256 _snipeBlockAmt) payable {
        ...
        _isSniper[0x86C70C4a3BC775FB4030448c9fdb73Dc09dd8444] = false;
        _isSniper[0xa4A25AdcFCA938aa030191C297321323C57148Bd] = false;
        _isSniper[0x20C00AFf15Bb04cC631DB07ee9ce361ae91D12f8] = false;
        _isSniper[0x0538856b6d0383cde1709c6531B9a0437185462b] = false;
