...
contract AverageJoe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Average Joe";
    string constant _symbol = "Average Joe";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(30).div(100); 
	uint256 public _maxWallet = _totalSupply.mul(30).div(100); 
