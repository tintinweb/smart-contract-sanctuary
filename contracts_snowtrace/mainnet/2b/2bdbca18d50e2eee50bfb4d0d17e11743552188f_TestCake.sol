...
contract TestCake is Context, IERC20, Ownable {
    ...
    string private _name = "TestCake";
    string private _symbol = "TEST";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x320B3193680b4c33F23A0d6f17930c9eFA02c9c7);
    ...
    uint256 private constant _maxFees = 13;
