...
//  Stealth Launch
//  Telegram: https://t.me/univprinter
//  Website: http://www.univprinter.org/
//  Twitter: https://twitter.com/UnivPrinter
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x959b88966fC5B261dF8359961357d34F4ee27b4a); // reward address UNIV
...
contract UNIVPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x959b88966fC5B261dF8359961357d34F4ee27b4a; // reward UNIV
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Universe Printer";
    string constant _symbol = "UNIVP";
    ...
    address public autoLiquidityReceiver=0x6dE04dF8F09197C47EBEd4c6070d7BB0A65d2896; //liq address
    address public marketingFeeReceiver=0x6dE04dF8F09197C47EBEd4c6070d7BB0A65d2896; // marketing address
