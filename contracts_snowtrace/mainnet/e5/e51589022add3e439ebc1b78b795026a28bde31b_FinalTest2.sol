...
contract FinalTest2 is IERC20 {
    ...
    string constant _name = "FinalTest";
    string constant _symbol = "FTEST2";
    ...
    uint256 constant public maxLiquidityFee = 1000;
    ...
    address payable private _marketingWallet = payable(0x89c218D93D8642008d0F43d4DC48E061684c1D21);
    ...
    constructor (uint _snipeBlockAmt, address cInitializer, uint256 _gasPriceLimit) payable {
        ...
        _isFeeExcluded[0x89c218D93D8642008d0F43d4DC48E061684c1D21] = true;
        _isDividendExcluded[0x89c218D93D8642008d0F43d4DC48E061684c1D21] = true;
...
//===============================================================================================================
    ...
    function swapBack(uint256 numTokensToSwap) internal swapping {
        ...
        if (amountToLiquify > 0) {
            dexRouter.addLiquidityAVAX{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
    ...
    function addInitialTokens() external onlyOwner{
        addTokenToList(0x60aE616a2155Ee3d9A68541Ba4544862310933d4, 0x130966628846BFd36ff31a822705796e8cb8C18D); // MIM
        addTokenToList(0x60aE616a2155Ee3d9A68541Ba4544862310933d4, 0x50b7545627a5162F82A992c33b87aDc75187B218); // BTC
        addTokenToList(0x60aE616a2155Ee3d9A68541Ba4544862310933d4, 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // ETH
        addTokenToList(0x60aE616a2155Ee3d9A68541Ba4544862310933d4, 0xb54f16fB19478766A268F172C9480f8da1a7c9C3); // TIME
        addTokenToList(0x60aE616a2155Ee3d9A68541Ba4544862310933d4, 0x264c1383EA520f73dd837F915ef3a732e204a493); // BNB
    }
}