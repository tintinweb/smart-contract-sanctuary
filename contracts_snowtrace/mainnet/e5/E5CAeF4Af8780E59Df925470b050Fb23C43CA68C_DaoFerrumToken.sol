...
import "./DaoMintableLockableErc20.sol";

contract DaoFerrumToken is DaoMintableLockableErc20 {
    constructor() {
        _name = "Ferrum Network Token";
        _symbol = "FRM";
    }
}
...
import "./DaoMintableErc20.sol";

contract DaoMintableLockableErc20 is DaoMintableErc20, ILockerUser {
...
import "../common/signature/IDaoCallable.sol";
