...
contract ERC20Pistachio2 is IERC20 {
 ...
 */
contract ERC20Burnable is ERC20Pistachio2 {
 ...
 */
contract ERC20Mintable is ERC20Pistachio2, MinterRole {
 ...
 *
 */
contract ERC20Chocolate2 is ERC20Pistachio2, ERC20Burnable, ERC20Mintable, Pausable {
    ...
    constructor (
        ...
        ERC20Pistachio2(initialAccount, _tokenSymbol, _tokenName, initialBalance) {
...
contract Crowdsale is ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for ERC20Chocolate2;

    // The token being sold
    ERC20Chocolate2 private _token;
     ...
     */
    constructor (uint256 rate, address payable wallet, ERC20Chocolate2 token) public {
...
contract CrowdsaleRaspberry is MintedCrowdsale, PausableCrowdsale {
    constructor (uint256 rate, address payable wallet, ERC20Chocolate2 token, bool _isPausable) public
