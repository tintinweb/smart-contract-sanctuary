...
/**
 *
Transparency is our top priority at SuperUniverseCapital $SUC 

Let me tell you about the happenings "behind the scenes" today:

The SuperUniverseCapital project has made it its goal to last in the Avalaunch in the long term. For this reason, we are already working TODAY on TOMORROW benefits for you, as our valuable community.
Besides the visible marketing steps, there is a lot going on in the background:

- our SuperUniverseCapital will become even more multifaceted - original artists are working on this at the moment

- so that you can enjoy the individual SuperUniverseCapital at home, we are also working on an exclusive Waifu collection.

- one of our top priorities is to make SuperUniverseCapital accessible to EVERYONE, step by step. Unlike most tokens, we don't want the success curve of our SuperUniverseCapital project to flatten out after the important CMC & CG listings. 
That is why we are already working on securing contacts to important interfaces/platforms in the Avax. 

*  Tokenomics? *
 Total Supply: 1,000,000,000 $SUC
- Add Liquidity :       70%
- Burn token:            25%
- Marketing:               3%
- Team & Advisors:     2%
...
One thing I can already tell you, SuperUniverseCapital is going to be GREAT, my friends of the endless ocean

Twitter: https://twitter.com/superuniverseca
Telegram: https://t.me/superuniversecapital
Website: TBA
