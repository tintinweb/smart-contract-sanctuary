...
/**
DΣFΣΛƬ ƬΉΣ JΣΣƬS
After a good launch on the bsc a few months ago now we are now launching the same project on AVAX.
Stealth launch, don't rush me , let me do my job.

EARN BUSD WHILE DEFEATING THE CURRY HANDS


Website - https://defeatthejeets.xyz
Our socials can be found on our website.
...
BUSD CA : 0x19860ccb0a68fd4213ab9d8266f7bbf05a8dde98

1 DAY LIQUIDITY LOCK EXTENDED IF NEEDED

DON'T BE A JEET AND HOLD IT MORE THAN 10MINUTES
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98); // BUSD
...
contract DefeatTheJeets is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98; // BUSD
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DefeatTheJeets.xyz";
    string constant _symbol = "JEETS";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // TODO : SET MAX TX TO 20000000000000 2%
    uint256 public _maxWallet = _totalSupply.div(40); //  TODO : SET MAXWALLET TO 40000000000000 4%
    ...
    //uint256 totalFee2 = 3000;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0x1C5fb5646d6BD17C13500Bc46544fa43863d39c8; //liq address
    address public marketingFeeReceiver=0x1C5fb5646d6BD17C13500Bc46544fa43863d39c8; // marketing address
    ...
    bool public autoBuybackEnabled = false; //buyback enabled
...
//        emit Transfer(sender, recipient, amount);
    ...
    // t . me / dai printer (without spaces) , see you soon.
