...
// File: contracts/utilities/LakeOfHaku.sol
...
// LakeOfHaku is MasterChef's left hand and kinda a wizard. Trading fee LP is converted into HAKU using this contract.
...
contract LakeOfHaku is Ownable {
    ...
    function setBridge(address token, address bridge) external onlyOwner {
        // Checks
        require(
            token != haku && token != wavax && token != bridge,
    ...
    // F6: There is an exploit to add lots of BOO to the xhaku, run convert, then remove the BOO again.
    //     As the size of the Booxhaku has grown, this requires large amounts of funds and isn't super profitable anymore
