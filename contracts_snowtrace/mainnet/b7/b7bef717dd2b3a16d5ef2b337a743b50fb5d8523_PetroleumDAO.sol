...
contract PetroleumDAO  is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function mintGiveaway(uint256 numTokens) public onlyOwner {
    require(countMintedGiveawayTokens.add(numTokens) <= MAX_GIVEAWAY_TOKENS, "224 tokens max");
    for (uint256 i = 0; i < numTokens; i++) {
