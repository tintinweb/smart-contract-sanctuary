...
/**
 *Submitted for verification at FtmScan.com on 2021-07-10
*/
...
contract PlateauFinance is   Ownable{
    using SafeMath for uint256;
    ...
    uint256 public MAX_SUPPLY = 1000000000 * 10 ** decimals();
    ...
    constructor (address _lpReceiverAddress) {
        _name = "PlateauFinance";
        _symbol = "PLT";
        _mint(msg.sender,MAX_SUPPLY);
        lpReceiverAddress = _lpReceiverAddress;


        IJoeRouter02 _router = IJoeRouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);

        
        _pair = IJoeFactory(_router.factory())
