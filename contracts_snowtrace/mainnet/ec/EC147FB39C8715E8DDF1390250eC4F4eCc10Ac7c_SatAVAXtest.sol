...
contract SatAVAXtest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SatAVAXtest";
    string constant _symbol = "SatAVAXtest";
    ...
    address public autoLiquidityReceiver=0x64da3e9C84698772A0383bB72bb0019db581265c; //liq address
    address public marketingFeeReceiver=0x64da3e9C84698772A0383bB72bb0019db581265c; // marketing address
