...
// File: @openzeppelin/contracts/utils/introspection/IERC165.sol
    ...
    */
    ...
    // File: contracts/RandomizedSimpleRoyalties.sol
...
/*╚═╝  ╚═╝  ╚═══╝  ╚═╝  ╚═╝╚═╝  ╚═╝    ╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝*/
    ...
    contract random_samurai is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
        using Strings for uint256;
        ...
        uint256 public constant ROYALTY_VALUE = 1000;
        ...
        constructor(
            ...
            address owner  // the user that will get the avax of the minting, open the claim time
        ...
        function mintRandom(address receiver, uint256 nextTokenIndex) internal {
        ...
        function claim(uint256 n) public payable {
            ...
            for (uint256 i = 0; i < n; i++) {
                minted += 1;
                mintRandom(_msgSender(), minted);
                _setTokenRoyalty(minted, msg.sender, ROYALTY_VALUE);
                emit Claim(minted);
            }
