...
１００％ ＬＰ ＬＯＣＫ ＦＯＲＥＶＥＲ 
 ...
 SMALL OSO (OSO)
 MAx Buy    - 100000/Trc.
 Max Wallet - 300000/wallet.
 Lock Liq and SAFU Contract.
 I created a black hole so #SOSO token will deflate itself in supply with every transaction.

 BEFORE BUYING ANY AVAX TOKEN.
...
contract osoDAO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x85B14E9Bc72e1Ed153A2A40397339E777Ac808e1); // Marketing Address
