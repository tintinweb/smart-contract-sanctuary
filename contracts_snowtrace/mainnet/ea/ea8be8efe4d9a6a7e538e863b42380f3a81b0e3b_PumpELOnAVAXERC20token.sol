...
✅ 1% LP
✅ TOTAL 11000000 Tokens Limited supply!
✅ Max Limit Buy: 100000 
✅ Max wallet: 300000 
🔒 Verification Contract(SAFU)
🔒 100% Locked LP & 100% Rugproof / Botproof
*/
...
contract PumpELOnAVAXERC20token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0F125Aaf246Ac3045Cf10CBFDFE8fE8b611101F3); // Marketing Address
    ...
    uint256 private _tTotal = 11000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PUMP ELON";
  ...
  //  uint256 private _previousLiquidityFee = _liquidityFee;
    ...
    uint256 public maxWalletToken = 300000 * (10**9);
