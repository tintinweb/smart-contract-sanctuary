...
contract StrategyWonderland is IStrategyAlpaca, ReentrancyGuard, Ownable, CoreRef {
    ...
    // temporary method
    function setTimeMaxPrice(uint256 _maxPrice) public onlyTimelock {
        maxPrice = _maxPrice;
    }

    function setDexRouter(address _dexRouterAddress) public onlyTimelock {
        dexRouterAddress = _dexRouterAddress;
    }
    ...
    function withdraw() public override onlyMultistrategy nonReentrant {
        ...
        ITraderJoeRouter(dexRouterAddress).swapExactTokensForTokens(
            withdrawAmt,
            1, // minReturnWant
            earnedToWantPath,
            address(this),
