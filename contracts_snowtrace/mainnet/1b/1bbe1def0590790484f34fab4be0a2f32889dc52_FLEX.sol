...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218);
...
contract FLEX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x50b7545627a5162F82A992c33b87aDc75187B218; // WBTC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "REFLEXOR";
    string constant _symbol = "FLEX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 666_000_000_000_000 * (10 ** _decimals);
    ...
    address public autoLiquidityReceiver=0x7B4A8E05307a8fFf3387F10A73239F995aAB0032;
    address public marketingFeeReceiver=0xfAAB35560220608d674cf4199A03C711A3d406ad;
