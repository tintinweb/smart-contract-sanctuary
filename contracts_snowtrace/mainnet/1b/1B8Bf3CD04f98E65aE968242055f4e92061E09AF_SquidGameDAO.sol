...
/**
  SquidGameDAO fairlaunch

  Join us on telegram for more info!
  https://t.me/AVASquidGameDAO

  Deflationary protocol on avalanche network
  Liquidity locked
 */
...
contract SquidGameDAO  is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("SquidGameDAO", "SquidGame", 9) {
    }
