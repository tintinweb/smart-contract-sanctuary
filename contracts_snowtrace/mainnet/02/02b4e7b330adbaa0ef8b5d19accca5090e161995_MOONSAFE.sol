...
contract MOONSAFE is Context, IERC20, Ownable {
    ...
    uint256 public _reflectFee = 1000; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousReflectFee = _reflectFee;
    uint256 private maxReflectFee = 2000;
    
    uint256 public _liquidityFee = 1000; // All taxes are divided by 100 for more accuracy.
    ...
    uint256 private maxMarketingFee = 300;
    ...
    address payable private _marketingWallet = payable(0x993BF63bceC05813378873a4abDce0c3df4A7e6c);
