...
contract VOID is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1_000_000_000e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = 'https://twitter.com/AvalancheVoid';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256) {
        uint256 tFee = tAmount.mul(666).div(10000);
