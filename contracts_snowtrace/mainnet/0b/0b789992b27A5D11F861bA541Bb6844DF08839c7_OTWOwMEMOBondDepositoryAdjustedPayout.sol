...
contract OTWOwMEMOBondDepositoryAdjustedPayout is Ownable {
    ...
    address public immutable treasury; // mints OTWO when receives principle
    ...
    struct Bond {
        uint payout; // OTWO remaining to be paid
    ...
    /**
     *  @notice calculate current ratio of debt to OTWO supply
    ...
    /**
     *  @notice calculate amount of OTWO available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or OTWO) to the DAO
     *  @return bool
     */
