...
contract TravelCoin is IERC20Extended, Auth, BaseToken {
    using SafeMath for uint256;
    ...
    string private _symbol = "TVL";
    uint256 private _totalSupply;

    address public rewardToken = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118;
    IJoeRouter02 public router;
    address public pair;
    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    uint256 public liquidityFee = 500; // default: 200
    uint256 public buybackFee = 100; // default: 300
    uint256 public reflectionFee = 400; // default: 800
    uint256 public marketingFee = 500; // default: 100
    uint256 public totalFee;
    uint256 public feeDenominator = 10000; // default: 10000
    ...
    uint256 public _maxHoldingAmount;
    ...
    constructor(
        ...
        _maxSellAmount = 15555555555555 * 10**9;
        _maxHoldingAmount = 38888888888888 * 10**9;
        _maxBuyAmount = 38888888888888 * 10**9;
        ...
        distributor = new DividendDistributor(rewardToken, routerAddress);
    ...
    function _transferFrom(
        ...
        if (antiBotActive) {
            ...
            if (shouldTakeFee(sender)) {
                require(amount <= _maxSellAmount, "TX Limit Exceeded");
            }
        }
    ...
    function startAntiBot() public authorized {
        antiBotActive = true;
    }

    function stopAntiBot() public authorized {
        antiBotActive = false;
    }
    ...
    function setMaxBuyLimit(uint256 maxTransactionLimit) public authorized {
        _maxBuyAmount = maxTransactionLimit;
    }

    function setMaxSellLimit(uint256 maxTransactionLimit) public authorized {
        _maxSellAmount = maxTransactionLimit;
    }

    function setMaxHolidingLimit(uint256 maxHoldingLimit) public authorized {
        _maxHoldingAmount = maxHoldingLimit;
    }
