...
contract PBCustomBondDepository is Ownable {
    ...
    address public immutable treasury; // mints PiggyBank when receives principle
    ...
    struct Bond {
        uint payout; // PiggyBank remaining to be paid
