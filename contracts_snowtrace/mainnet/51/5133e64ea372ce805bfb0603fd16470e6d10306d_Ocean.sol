...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xA32608e873F9DdEF944B24798db69d80Bbb4d1ed);
...
contract Ocean is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xA32608e873F9DdEF944B24798db69d80Bbb4d1ed;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Ocean";
    string constant _symbol = "Ocean";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); // 0.55%
	uint256 public _maxWallet = _totalSupply.div(99); // 6%
    ...
    address public marketingFeeReceiver=0x4E55a2a12aC6aAc39f92056B6e2C04Df6CEfD3D7;
