...
10% rewards in SHIB just for holding!
Everyday lottery!
Ads on Reddit are on its way!                                                       
...
contract SHIBAX is Context, IERC20, Ownable {
    ...
    uint256 public _SHIBAFee = 300; // 100 = 1%
    uint256 public _BurnFee = 400; // 100 = 1%
    uint256 public _marketingFee = 200; // 100 = 1%
    //variables
    uint256 public _SHIBAFeeTotal;
    uint256 public _BurnFeeTotal;
    uint256 public _taxFeeTotal;
    uint256 public _marketingFeeTotal;
    //addresses
    address public SHIBAAddress = 0x5361d8351e8984D68a7d7B0Dc661E4C417e5a1a7; // SHIBA Rewards Address
    address public marketingAddress = 0xA76bFafA9a47638dD4DE24319aE09520322494F0; // Owner main wallet
 ...
 /**
    ...
    */
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        uint256 SHIBAFee = amount.mul(_SHIBAFee).div(10000);
        ...
        //@dev
        if(SHIBAFee > 0){
            transferAmount = transferAmount.sub(SHIBAFee);
            _reflectionBalance[SHIBAAddress] = _reflectionBalance[SHIBAAddress].add(SHIBAFee.mul(rate));
            _SHIBAFeeTotal = _SHIBAFeeTotal.add(SHIBAFee);
            emit Transfer(account,SHIBAAddress,SHIBAFee);
        }
        //@dev
        if(BurnFee > 0){
    ...
    */
    ...
    function setSHIBAFee(uint256 fee) public onlyOwner {
        _SHIBAFee = fee;
    }
    ...
    function setSHIBAAddress(address _Address) public onlyOwner {
        require(_Address != SHIBAAddress);
        
        SHIBAAddress = _Address;
    }
