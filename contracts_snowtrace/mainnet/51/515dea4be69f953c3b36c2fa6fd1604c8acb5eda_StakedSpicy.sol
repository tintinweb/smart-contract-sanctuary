...
contract StakedSpicy is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 90000 * 10**9;
    ...
    constructor() ERC20("SPICY", "SPICY", 9) ERC20Permit() {
    ...
    /**
        @notice increases SPICY supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SPICY
