...
contract YeetToken is Context, IERC20, Ownable {
    ...
    address public devAddress = 0x6cc073CBEB521dd1f53dA117E5a196eDA3C297eF;

    string private constant _name = "YEET Token";
    ...
    Taxes public taxes = Taxes(3,3,3,0);
