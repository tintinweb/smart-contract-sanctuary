...
contract Avant123 is Context, IERC20, Ownable {
    ...
    string private _name = "AVANT1234";
    string private _symbol = "AVANT1234";
    ...
    function setSniper(address account,bool status) public onlyOwner {
        _isSniper[account] = status;
