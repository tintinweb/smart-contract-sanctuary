...
Idle Golem is a gaming token which is on the Avax blockchain. 
Each Golem is unique and programmatically generated from over 200 possible traits .

👨‍👦‍👦 Join us :                                            
🌎 Website : https://idlegolem.vercel.app
📍 TG: t.me/IdleGolemOfficial
🥳 Open Voicechat TG
✅ No presale Fairlaunched

Launched today at 4:00 p.m. UTC (Let's celebrate the new year with new investments ,don't miss) 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x36964D01d9842b535213178019c45Af58a676eeb); // IdleGolem Reflection
...
contract IGOnewgamecreation is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x36964D01d9842b535213178019c45Af58a676eeb; // IdleGolem reflection
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "IdleGolem";
    ...
    address public autoLiquidityReceiver=0xBc384557b670a25D3D0970Cd439a7b6AbcB06996; //liq address
    address public marketingFeeReceiver=0x36964D01d9842b535213178019c45Af58a676eeb; // marketing address
