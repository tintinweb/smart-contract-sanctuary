...
contract Fetus is ERC20Permit, Ownable {
    ...
    /**
        @notice increases Fetus supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Fetus
