...
//  Stealth Launch                 liq will be locked for a month!!
//  Telegram: https://t.me/ETHWORLDprinter
//  Reward: $ETH
...
contract ETHWORLDprinter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ETHWORLDprinter";
    string constant _symbol = "EWP";
