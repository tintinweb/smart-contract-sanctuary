...
// File: contractsOLD/StrategyCurveAaveAvax.sol
...
contract StrategyCurveAaveAvax{
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = 0x1337BedC9D22ecbe766dF105c9623922A27963EC; //Curve.fi avDAI/avUSDC/avUSDT (av3CRV)

    address public constant CRV = 0x249848BeCA43aC405b8102Ec90Dd5F22CA513c06; //CRV
    ...
    address public reward = WAVAX; //WAAVAX

    // We add liquidity here
    address public constant CURVE_POOL = 0x7f90122BF0700F9E7e1F688fe926940E8839F353; //DEPOSIT ADDR
    address public GAUGE = 0x5B5CFE992AdAC0C9D48E05854B2d91C73a003858; //GAUGE CONTROLLER

    // Swap here
    address public constant SUSHISWAP_ROUTER = 0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106; //https://app.pangolin.exchange/#/swap
