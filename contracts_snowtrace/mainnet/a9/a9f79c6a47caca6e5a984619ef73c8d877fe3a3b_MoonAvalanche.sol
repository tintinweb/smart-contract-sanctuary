...
contract MoonAvalanche is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MoonAvalanche";
    string constant _symbol = "MAV";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // 10%
    uint256 public _maxWallet = _totalSupply.div(1); // 20%
    ...
    address public autoLiquidityReceiver=0x88F0eA18ad7dd87904Bdd47176bBD5c4547368CB;
    address public marketingFeeReceiver=0x938a687aFFed8C3A5B652122728AbB4f5E763d7B;
