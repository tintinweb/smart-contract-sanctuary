...
contract MountainAvax is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public lpBurnFrequency = 13600 seconds;
    ...
    constructor() ERC20("MountainAvax", "Mountain") {
        ...
        maxWallet = totalSupply * 8 / 1000; // .8% maxWallet
