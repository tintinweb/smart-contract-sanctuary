...
interface IJoeFactory {
    ...
    contract TESSST is Context, IERC20, Ownable {
        ...
        string private _name = 'TESST Capital';
        string private _symbol = 'TESST';
        ...
        address payable public _TESSSTWalletAddress;
        ...
        constructor (address payable TESSSTWalletAddress, address payable marketingWalletAddress) {
            _TESSSTWalletAddress = TESSSTWalletAddress;
            ...
            walletLimitDuration = block.timestamp;
        ...
        function sendAVAXToTeam(uint256 amount) private {
            _TESSSTWalletAddress.transfer(amount.div(2));
        ...
        function _setTESSSTWallet(address payable TESSSTWalletAddress) external onlyOwner() {
            _TESSSTWalletAddress = TESSSTWalletAddress;
        }
