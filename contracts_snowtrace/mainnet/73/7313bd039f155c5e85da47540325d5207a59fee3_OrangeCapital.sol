...
contract OrangeCapital is Context, IERC20, Ownable {
    ...
    string private constant _name = "Orange Capital";
    string private constant _symbol = "Orange";

    uint256 private maxTransactionAmount = 1000 * 10**9;
    uint256 private maxWalletAmount = 5000 * 10**9;
