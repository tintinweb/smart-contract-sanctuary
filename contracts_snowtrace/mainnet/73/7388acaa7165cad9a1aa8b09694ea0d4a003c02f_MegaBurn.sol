...
/*
   99.9% Burned + #Auto Liquidity + #Reflection = MegaBurnToken	
   
   #MegaBurnToken features:	
   ...
   - 99.9% Supply is burned
   	...
   	Twitter: https://twitter.com/MegaBurnAVAX
 */
...
contract MegaBurn is Context, IERC20, Ownable {
    ...
    string private _name = "https://twitter.com/MegaBurnAVAX";
    string private _symbol = "MegaBurn";
    ...
    IJoeRouter02 public immutable TraderJoeRouter;
    ...
    constructor () public {
        ...
        IJoeRouter02 _traderJoeRouter = IJoeRouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
         // Create a traderJOE pair for this new token
        TraderJoePair = IJoeFactory(_traderJoeRouter.factory())
            .createPair(address(this), _traderJoeRouter.WAVAX());
    ...
    function swapTokensForAVAX(uint256 tokenAmount) private {
        // generate the traderJoe pair path of token -> AVAX
