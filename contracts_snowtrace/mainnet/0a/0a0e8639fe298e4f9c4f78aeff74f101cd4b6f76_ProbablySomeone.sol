...
/** Stealth launch? Probably Someone...
...
contract ProbablySomeone is Context, IERC20, Ownable {
    ...
    string private constant _name = "ProbablySomeone";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x6D9Ad6a47Aa06c9B4891f1598d7f2661D281476C);
        _feeAddrWallet2 = payable(0x6D9Ad6a47Aa06c9B4891f1598d7f2661D281476C);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xb54f16fB19478766A268F172C9480f8da1a7c9C3), _msgSender(), _tTotal);
    }
