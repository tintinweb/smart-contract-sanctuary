...
contract sZeroShift is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked ZeroShift", "sZRST", 9) ERC20Permit() {
    ...
    /**
        @notice increases sZRST supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sZRST
