...
contract sROCKETToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 100000000 * 10**9;
    ...
    constructor() ERC20("Staked ROCKET", "sROCKET", 9) ERC20Permit() {
    ...
    /**
        @notice increases sROCKET supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sROCKET
