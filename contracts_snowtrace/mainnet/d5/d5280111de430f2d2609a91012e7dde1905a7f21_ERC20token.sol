...
contract ERC20token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Joseph Capital";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x192E9A07B63b506fC674dce9e2F9617E2759Fce1);
        _feeAddrWallet2 = payable(0x192E9A07B63b506fC674dce9e2F9617E2759Fce1);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x7589992E5046E9EADa44b1D192029a60C32cB95c), _msgSender(), _tTotal);
    }
