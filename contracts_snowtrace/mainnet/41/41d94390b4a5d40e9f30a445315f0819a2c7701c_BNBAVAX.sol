...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 AVAX = IBEP20(0x264c1383EA520f73dd837F915ef3a732e204a493); //BNB
...
contract BNBAVAX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address AVAX = 0x264c1383EA520f73dd837F915ef3a732e204a493; // BNB
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x1824bc4F3c51BDd5Bf897c798b0C86d4816f5844;
    address public marketingFeeReceiver=0x1824bc4F3c51BDd5Bf897c798b0C86d4816f5844;

    string constant _name = "t.me/bnbavax";
    string constant _symbol = "BNBAVAX";
