...
// Dependency file: contracts/baby/pBoofiTokenDividendTracker.sol
...
contract pBoofiTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main pBoofiToken contract."
        );
    }
...
// Root file: contracts/baby/pBoofiToken.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/pBoofiTokenDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract pBoofiToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    pBoofiTokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = pBoofiTokenDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "pBoofiToken: The dividend tracker already has that address"
        );

        pBoofiTokenDividendTracker newDividendTracker = pBoofiTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "pBoofiToken: The new dividend tracker must be owned by the pBoofiToken token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "pBoofiToken: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "pBoofiToken: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "pBoofiToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "pBoofiToken: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "pBoofiToken: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "pBoofiToken: Cannot update gasForProcessing to same value"
        );
