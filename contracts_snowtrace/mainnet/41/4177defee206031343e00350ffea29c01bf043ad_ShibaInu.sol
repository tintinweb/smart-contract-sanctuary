...
🌐 Website: https://shibainuavax.com/
🐦 Twitter: https://twitter.com/shibainu_avax
💬 Telegram: https://t.me/ShibaInuAvaxOfficial
🚀 Medium: https://medium.com/@shibainuavax

ShibaInu Avax Tokenomics: 
• 8% Reflections   
• 5% Higher Liq per tx  
• 5% Marketing 
• 2% for LP
...
contract ShibaInu is IBEP20, Auth {
    ...
    string constant _name = "ShibaInu Avax";
    string constant _symbol = "$SIA";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // max
    uint256 public _maxWallet = _totalSupply.div(40); // max
    ...
    address public autoLiquidityReceiver=0xeaDDED267Cc9A7606b809Ae22E1d338d9a700643; //liq address
    address public marketingFeeReceiver=0xeaDDED267Cc9A7606b809Ae22E1d338d9a700643; // marketing address
  ...
  function SetBlacklist(bool divider) external onlyOwner {
        Blacklist = divider;
    }
