...
contract MIMiverse is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x959b88966fC5B261dF8359961357d34F4ee27b4a; // Universe
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x65FE76dEC027A61379d314f4049579fF4B6DeB21;
    address public marketingFeeReceiver=0x65FE76dEC027A61379d314f4049579fF4B6DeB21;

    string constant _name = "MIMivese";
    string constant _symbol = "MIMiverse";
