...
contract StakeMe is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 1000 *10**16; // 1000M total supply
    ...
    //addresses
    address public RewardsAddress = 0x8eFBa830c6f539C65f52FcB4fC41B9443C37908b; // Rewards Address
    address public marketingAddress = 0xA037e72affCEf29A1D73540Ba1B9d4a9Fb2c154f; // Owner main wallet
