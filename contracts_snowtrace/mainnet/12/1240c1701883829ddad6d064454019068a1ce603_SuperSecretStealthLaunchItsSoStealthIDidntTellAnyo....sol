...
contract SuperSecretStealthLaunchItsSoStealthIDidntTellAnyone is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; 
    ...
    string constant _name = "SuperSecretStealthLaunchItsSoStealthIDidntTellAnyone";
    string constant _symbol = "SSSLISSIDTA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 40 ) / 1000;
    uint256 public _maxWallet = ( _totalSupply * 40 ) / 1000;
