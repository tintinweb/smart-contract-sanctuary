...
interface IJoeFactory {
    ...
    contract MicrochainFinance is Context, IERC20, Ownable {
        ...
        string private _name = 'Microchain Finance';
        ...
        address payable public _MCFWalletAddress;
        ...
        constructor (address payable MCFWalletAddress, address payable marketingWalletAddress) {
            _MCFWalletAddress = MCFWalletAddress;
        ...
        function sendAVAXToTeam(uint256 amount) private {
            _MCFWalletAddress.transfer(amount.div(2));
        ...
        function _setMCFWallet(address payable MCFWalletAddress) external onlyOwner() {
            _MCFWalletAddress = MCFWalletAddress;
        }
