...
contract ASS is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        uint256 dex = blackHole.mul(2).div(10);
       ...
       uint256 rate = getRate();
        ...
        _reserveTokenBalance[treasuryWallet] = team.mul(rate);
        ...
        _reserveTokenBalance[dev4] = devs.mul(rate);
        _reserveTokenBalance[dev5] = devs.mul(rate);
    ...
    function setDaoAddress(address _daoContractAddress) public onlyOwner {
        treasuryWallet = _daoContractAddress;
    }
