 ...
 *  
*/  
// SPDX-License-Identifier: AGPL-3.0-or-later  telegram : https://t.me/AMPDAO
...
contract AMPDAOERC20Token is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("AMPDAO", "AMPD", 9) {
    }
