...
contract DiamondbankStaking is Ownable {
    ...
    /**
        @notice stake DB to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sDB from warmup
    ...
    /**
        @notice forfeit sDB in warmup and retrieve DB
     */
    ...
    /**
        @notice returns the sDB index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract DB holdings, including bonuses provided
        @return uint
     */
