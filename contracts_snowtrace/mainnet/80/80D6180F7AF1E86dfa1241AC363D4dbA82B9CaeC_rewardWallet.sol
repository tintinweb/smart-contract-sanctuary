...
// File contracts/rewardWallet.sol
...
contract rewardWallet is Ownable {
    ...
    function requestReward(uint256 _amount) public onlyOwner {
        rewardToken.transfer(msg.sender, _amount);
    }

    function updateRewardToken(address _rewardToken) public {
        require(msg.sender == admin, "you dont have access to change the rewardToken"); 
        rewardToken = IERC20(_rewardToken);
    }
    ...
    /// @dev incase accidently anything is sent
