...
contract BINGUS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bingus Degen Gang";
   ...
   function setMaxWalletpercent (uint8 maxWalletPercent) external onlyOwner() {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (liquidityPools[from] && to != address(DEXRouter)) {
    ...
    function setRouterAddress(address newRouter) public onlyOwner() {
        IDEXRouter02 _pancakeswapV2Router =  IDEXRouter02(newRouter);
        DEXRouter = _pancakeswapV2Router;
