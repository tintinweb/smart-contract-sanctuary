...
/.-./.--.|.--.\          /.--.|.--.\.-.|
   ____              ____             
  / __/______  ___ _/ __/__ __  _____ 
 / _// __/ _ \/ _ `/\ \/ _ `/ |/ / -_)
...
contract FrogSave is Context, IERC20, Ownable {
    ...
    string private _name = "Frog Save";
    string private _symbol = "FSAVE";
    ...
    // fees
    uint256 public _taxFee = 500; // 100 = 1%
    uint256 public _charityFee = 300; // 100 = 1%
    uint256 public _BurnFee = 400; // 100 = 1%
    uint256 public _marketingFee = 200; // 100 = 1%
    //variables
    ...
    //addresses
    address public charityAddress = 0x5d73586E93EFeaC6053DC6e9Db0A11a7CB834957; // Charity Address
    address public marketingAddress = 0xEf1bE167b217cEED5230776fE234B101E7732371; // Owner main wallet
