...
// Telegram: t.me/sergeysbigmacfund
// Get rewarded in LINK token.
...
contract LINKIES is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sergey's BigMac Fund";
    string constant _symbol = "LINKIES";
    ...
    address public autoLiquidityReceiver = 0x686ED7349dA71CcACf5Edb6574fA0Edf87d3D9a4; //liq address
    address public marketingFeeReceiver = 0x686ED7349dA71CcACf5Edb6574fA0Edf87d3D9a4; // marketing address
