...
contract TimeBondDepository is Ownable {
    ...
    enum PARAMETER { VESTING, PAYOUT, FEE, DEBT, MINPRICE, PRICINGTYPE }
    /**
    ...
    function setBondTerms ( PARAMETER _parameter, uint _input ) external onlyPolicy() {
        ...
        } else if ( _parameter == PARAMETER.PRICINGTYPE ) { // 4
    ...
    function bondPrice() public view returns ( uint price_ ) {        
        ...
        if ( price_ < terms.minimumPrice && terms.pricingType != 2) 
    ...
    function _bondPrice() internal returns ( uint price_ ) {
        if(terms.pricingType == 2)
            ...
            if ( price_ < terms.minimumPrice ) {
                price_ = terms.minimumPrice;        
            } else if ( terms.minimumPrice != 0 && terms.pricingType == 0) {
