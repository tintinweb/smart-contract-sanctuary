...
contract M3TAPHYSICAL is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5947BB275c521040051D82396192181b413227A3; // wbtc
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "M3TAPHYISCAL";
    string constant _symbol = "M3TAPHYSICAL";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 666_666 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 2,5%
    ...
    address public autoLiquidityReceiver=0x5023a3eaED9f9e5369cab762b70ABfADb2bC65Cc;
    address public marketingFeeReceiver=0x5023a3eaED9f9e5369cab762b70ABfADb2bC65Cc;
