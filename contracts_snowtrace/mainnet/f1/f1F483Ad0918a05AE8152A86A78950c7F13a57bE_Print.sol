...
contract Print is IBEP20, Auth {
    ...
    string constant _name = "SleighDAO";
    string constant _symbol = "SDAO";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 0,5%
    uint256 public _maxWallet = _totalSupply.div(40); // 1,0%
    ...
    address public autoLiquidityReceiver=0x2e47B3bCac5764cFeeB72b54970BD4d4Cb46051C;
    address public marketingFeeReceiver=0x2e47B3bCac5764cFeeB72b54970BD4d4Cb46051C;
