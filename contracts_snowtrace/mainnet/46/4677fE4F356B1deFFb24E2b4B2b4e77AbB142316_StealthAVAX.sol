...
*/
/**
*     StealthAVAX - Stealth Launching Soon
*     Initial LP: 10 AVA
*     Telegram @stealthavax
*/
...
/* Token contract */
contract StealthAVAX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xEfbEE60D26C59CbE5Cc1DD0931869456f6f679F1;
    ...
    // Name and symbol
    string constant _name = "StealthAVAX";
    string constant _symbol = "SOON";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 2000 / 10000; 
