...
contract HocusStaking is Ownable {
    ...
    /**
        @notice stake Hocus to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sHocus from warmup
    ...
    /**
        @notice forfeit sHocus in warmup and retrieve Hocus
     */
    ...
    /**
        @notice redeem sHocus for Hocus
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns the sHocus index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract Hocus holdings, including bonuses provided
        @return uint
     */
