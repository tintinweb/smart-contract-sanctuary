...
/** 200 holders > reveal twitter
/** 400 holders > reveal dev
*/
...
contract GM is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x86f59511BFf29ea0D525C9ec5B305dA9c885153d);
        _feeAddrWallet2 = payable(0x86f59511BFf29ea0D525C9ec5B305dA9c885153d);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xd6070ae98b8069de6B494332d1A1a81B6179D960), _msgSender(), _tTotal);
    }
