...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x2923E182A6e68C0fE4006736a33B32f805703683);
...
contract AstroComet is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x2923E182A6e68C0fE4006736a33B32f805703683; // MIM
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x2479f053EF2a1E02CF297fC90fA7548EDCa5d6fF;
    address public marketingFeeReceiver=0xd9CDbA53EfF0c9afa7BD8D61c6f62C796eA2d11A;

    string constant _name = "AstroComet";
    string constant _symbol = "AstroComet";
