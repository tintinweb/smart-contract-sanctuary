...
contract MIMBANK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x34247C42C76EbED9F9Db3213800b7a273C2C37d5;
    address public marketingFeeReceiver=0x34247C42C76EbED9F9Db3213800b7a273C2C37d5;

    string constant _name = "MIMBANK";
    string constant _symbol = "MIMb";
