...
contract MynosStaking is Ownable {
    ...
    /**
        @notice stake MYNOS to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sMYNOS from warmup
    ...
    /**
        @notice forfeit sMYNOS in warmup and retrieve MYNOS
     */
    ...
    /**
        @notice redeem sMYNOS for MYNOS
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns the sMYNOS index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract MYNOS holdings, including bonuses provided
        @return uint
     */
