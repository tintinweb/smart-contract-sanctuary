...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardsWavax = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RewardsWavax.balanceOf(address(this));
        ...
        uint256 amount = RewardsWavax.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RewardsWavax.transfer(shareholder, amount);
...
contract AVATEST is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address RewardsWavax = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVATEST";
    string constant _symbol = "AVTEST";
