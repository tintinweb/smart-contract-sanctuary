...
// GET REWARDS IN JEWEL WITH AVJEWEL
// https://avajewel.xyz
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 JEWEL = IBEP20(0x4f60a160D8C2DDdaAfe16FCC57566dB84D674BD6);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = JEWEL.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WAVAX;
        path[1] = address(JEWEL);
        ...
        uint256 amount = JEWEL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            JEWEL.transfer(shareholder, amount);
...
contract AVAJEWEL is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address JEWEL = 0x4f60a160D8C2DDdaAfe16FCC57566dB84D674BD6; // JEWEL
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAJEWEL";
    string constant _symbol = "AVJEWEL";
    ...
    address public autoLiquidityReceiver=0x34EF4A323d1fc9c9A084Aa863ec97960D347A308;
    address public marketingFeeReceiver=0x34EF4A323d1fc9c9A084Aa863ec97960D347A308;
