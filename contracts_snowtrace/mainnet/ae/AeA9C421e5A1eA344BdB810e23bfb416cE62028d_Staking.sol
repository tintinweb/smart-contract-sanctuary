...
contract Staking is Ownable {
    ...
    /**
        @notice stake ROCKET to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sROCKET from warmup
    ...
    /**
        @notice forfeit sROCKET in warmup and retrieve ROCKET
     */
    ...
    /**
        @notice redeem sROCKET for ROCKET
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns the sROCKET index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract ROCKET holdings, including bonuses provided
        @return uint
     */
