...
contract sCROPToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked CROP", "sCROP", 9) ERC20Permit() {
    ...
    /**
        @notice increases sCROP supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sCROP
