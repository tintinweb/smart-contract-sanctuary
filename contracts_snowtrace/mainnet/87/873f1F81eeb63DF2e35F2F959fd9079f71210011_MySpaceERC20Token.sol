...
contract MySpaceERC20Token is ERC20, VaultOwned {

    using SafeMath for uint256;

    uint256 totalFee      = 17; // 12% Tax on all transactions
    uint256 reflectionFee = 13;  //  8% reflects AVAX back to holders
    ...
    constructor(address _router, address _pair_currency, address _team_wallet) ERC20("mySpace", "MSpace") payable {
