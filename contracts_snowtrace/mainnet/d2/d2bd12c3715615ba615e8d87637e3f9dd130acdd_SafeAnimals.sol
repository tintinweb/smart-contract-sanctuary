...
/**
SafeAnimals - Save them all!   

 __        __        _         _                 _     
/ _\ __ _ / _| ___  /_\  _ __ (_)_ __ ___   __ _| |___ 
\ \ / _` | |_ / _ \//_\\| '_ \| | '_ ` _ \ / _` | / __|
_\ \ (_| |  _|  __/  _  \ | | | | | | | | | (_| | \__ \
\__/\__,_|_|  \___\_/ \_/_| |_|_|_| |_| |_|\__,_|_|___/
...
contract SafeAnimals is Context, IERC20, Ownable {
    ...
    string private _name = "SafeAnimals";
    string private _symbol = "SafeANI";
    ...
    uint256 internal _tokenTotal = 1000 *10**16; // 1B total supply
    ...
    uint256 public _AnimalFee = 300; // 100 = 1%
    uint256 public _BurnFee = 400; // 100 = 1%
    uint256 public _marketingFee = 200; // 100 = 1%
    //variables
    uint256 public _AnimalFeeTotal;
    uint256 public _BurnFeeTotal;
    uint256 public _taxFeeTotal;
    uint256 public _marketingFeeTotal;
    //addresses
    address public AnimalFeeAddress = 0x2F85bF5FfBF7f9eBa9758Ba2187418979594da94; // AnimalFee Rewards Address
    address public marketingAddress = 0xa20Cc336584ca7E9E36C20f5cAE8cEfBA27574A6; // Owner main wallet
 ...
 /**
    ...
    */
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        uint256 AnimalFee = amount.mul(_AnimalFee).div(10000);
        ...
        //@dev
        if(AnimalFee > 0){
            transferAmount = transferAmount.sub(AnimalFee);
            _reflectionBalance[AnimalFeeAddress] = _reflectionBalance[AnimalFeeAddress].add(AnimalFee.mul(rate));
            _AnimalFeeTotal = _AnimalFeeTotal.add(AnimalFee);
            emit Transfer(account,AnimalFeeAddress,AnimalFee);
        }
        //@dev
        if(BurnFee > 0){
    ...
    */
    ...
    function setAnimalFee(uint256 fee) public onlyOwner {
        _AnimalFee = fee;
    }
    ...
    function setAnimalFeeAddress(address _Address) public onlyOwner {
        require(_Address != AnimalFeeAddress);
        
        AnimalFeeAddress = _Address;
    }
