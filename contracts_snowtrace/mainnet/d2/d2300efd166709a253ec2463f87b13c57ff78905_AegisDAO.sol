...
/**
  AegisDAOv1 fairlaunch

  Join us on telegram for more info!
  https://t.me/AegisDAO

  website: https://aegistoken.org/

  Initial liquidity 60 avax
  Liquidity lock one month
  No tax
  We aim to create a dao with our v2 aegis token.
 */
...
abstract contract ERC20 is IERC20 {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function _launch(address account_, uint256 amount_) internal virtual {
...
contract AegisDAO  is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("AegisDAO", "AegisDAO", 9) {
    }

    function launch(address account_, uint256 amount_) external onlyVault() {
        _launch(account_, amount_);
    }
