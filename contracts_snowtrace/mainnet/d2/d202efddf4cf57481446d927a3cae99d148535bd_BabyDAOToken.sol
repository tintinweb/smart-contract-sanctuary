...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6e71edae12b1b97f4d1f60370fef10105fa2faae0126114a169c64845d6126c9' // init code hash
            ))));
    }
}
...
abstract contract LiquidityActivityTrap is KnowingLiquidityAddedBlock, ERC20Permit, VaultOwned {
    using ExtraMath for *;
    using SafeMath for *;
...
abstract contract LiquidityTrap is KnowingLiquidityAddedBlock, ERC20Permit, VaultOwned {
    using ExtraMath for *;
    using SafeMath for *;
...
contract BabyDAOToken is LiquidityTrap, LiquidityActivityTrap {

    using SafeMath for uint256;

    constructor()
      ERC20("BabyDAO", "BBDAO", 9) 
      LiquidityProtectedBase(0x9Ad6C38BE94206cA50bb0d90783181662f0Cfa10, 0x130966628846BFd36ff31a822705796e8cb8C18D)
      LiquidityTrap(100)
    {}
