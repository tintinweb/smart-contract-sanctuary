 ...
 *  
*/  
// SPDX-License-Identifier: AGPL-3.0-or-later  telegram : https://t.me/babybtcprinter
...
contract BabyBTCPrinterERC20Token is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("BabyBTCprinter", "BBPRINT", 9) {
    }
