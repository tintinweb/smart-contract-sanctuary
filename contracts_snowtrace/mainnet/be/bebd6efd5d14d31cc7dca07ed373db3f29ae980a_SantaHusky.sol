...
🎅 FAIR LAUNCH ON 25 DECEMBER 🎅

Almost Christmas and this good boy is going to celebrate with us! Lovely safe degen play right around the corner of Chrismas.
Let's get this good boy mooning!

✅ AVAX PLAY
✅ CA verified + LP locked
✅ Safe play
✅ Former BSC dev with a call channel
✅ Next moonshot
...
🎄 Telegram = https://t.me/SantaHusky

🎄 Website = https://santahusky.live

🎄 Twitter = https://twitter.com/SantaHusky

🎄 Call channel =  https://t.me/avaxplayground
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664); // reward address usdc
...
contract SantaHusky is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // reward usdc
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SantaHusky";
    string constant _symbol = "SantaH";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; // 2%
    uint256 public _maxWallet = _totalSupply * 2 / 100; // 2%
    ...
    address public autoLiquidityReceiver=0x8680e2918ac720e0c22474E1c01B3014CC9D14FA; //liq address
    address public marketingFeeReceiver=0x8680e2918ac720e0c22474E1c01B3014CC9D14FA; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 250; // 0.4%
    bool inSwap;
