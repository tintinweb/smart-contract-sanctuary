...
contract MechagnomesNFT is ERC721Pausable, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable protocolReserveCount = 333;
    ...
    modifier canMint(uint256 amount) {
        ...
        require(amount <= maxMintPerTx, "validation_error:canMint:exceeds_maxMintPerTx");
        require(balanceOf(msg.sender).add(amount) <= maxMintPerWallet, "validation_error:canMint:exceeds_maxMintPerWallet_limit");
        if(isWhitelistSale()) {
