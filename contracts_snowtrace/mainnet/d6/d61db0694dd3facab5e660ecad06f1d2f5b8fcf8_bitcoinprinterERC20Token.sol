...
// SPDX-License-Identifier: AGPL-3.0-or-later  TG : https://t.me/bitcoinprinter
...
contract bitcoinprinterERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("bitcoinprinter", "BCP", 9) {
    }
