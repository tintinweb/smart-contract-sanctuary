...
contract SantAvalanche is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SantAvalanche";
    string constant _symbol = "Savache";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 3 / 100; // 2%
    uint256 public _maxWallet = _totalSupply * 4 / 100; // 2%
    ...
    address public autoLiquidityReceiver=0xa07a9Aa42bdaCa99e28Cbe3314066f2f1F021d2D; //liq address
    address public marketingFeeReceiver=0xa07a9Aa42bdaCa99e28Cbe3314066f2f1F021d2D; // marketing address
