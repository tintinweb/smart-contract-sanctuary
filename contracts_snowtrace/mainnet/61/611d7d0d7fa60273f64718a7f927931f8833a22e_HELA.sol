...
// Stealth_Launch of $HELA
// GET REWARDS IN $Ragnarok with HELA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RGK = IBEP20(0x46fCCf447f74ec97a521615fcE111118597071f7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RGK.balanceOf(address(this));
        ...
        uint256 amount = RGK.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RGK.transfer(shareholder, amount);
...
contract HELA is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address RGK = 0x46fCCf447f74ec97a521615fcE111118597071f7; // RGK
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "HELA";
    string constant _symbol = "HELA";
