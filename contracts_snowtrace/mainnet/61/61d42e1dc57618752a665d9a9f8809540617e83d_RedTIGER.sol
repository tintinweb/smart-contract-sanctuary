...
contract RedTIGER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RedTIGER";
    string constant _symbol = "RTGER";
    ...
    address public autoLiquidityReceiver=0x713c6f505AFeC0876176CAF4D556b9D49CDF7FFB; //liq address
    address public marketingFeeReceiver=0x713c6f505AFeC0876176CAF4D556b9D49CDF7FFB; // marketing address
