...
/**
 *
 *  https://t.me/ultra_nodes
 *  https://ultrafinance.org/
 *
 */
...
contract NODERewardManagement {
    ...
    modifier onlySentry() {
        require(msg.sender == token || msg.sender == nodeSale || msg.sender == gateKeeper, "Nope");
        _;
    }
    ...
    function setnodeSale (address nodeSale_) external onlySentry {
        nodeSale = nodeSale_;
    }
...
contract ULTRANODES is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address uniV2Router,
        uint256 snipeBlkAmt
    ) ERC20("UltraNodes", "ULTRA") PaymentSplitter(payees, shares) {
    ...
    function createNodeWithTokens(string memory name, uint256  _initValue) public {
        ...
        require(sender != futurUsePool && sender != distributionPool && sender != devPool,"NODE CREATION: futur, dev and rewardsPool cannot create node");
    ...
    function manualSwap(uint256 weiAmount) external onlyOwner{
