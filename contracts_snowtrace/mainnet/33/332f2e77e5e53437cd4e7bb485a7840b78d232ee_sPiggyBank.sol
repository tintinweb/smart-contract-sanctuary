...
contract sPiggyBank is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sPiggyBank", "sPB", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPB supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPB
