...
/**
Welcome to Tegridy Farms Capital! 
We will farm tokens on your behalf and buy back TEGRIDY with the profits.

TEGRIDY deflationary token on $Avalanche! We will invest in high yield farms and return profits to $TEGRIDY holders

Coming Soon!

Tokenomics:
5% of each buy back goes to existing holders
5% of each sell will go into the treasury to farm and buy back TEGRIDY

Website:
Coming Soon!

Twitter:
https://twitter.com/TegridyFarmsCap

Telegram:
https://t.me/tegridyfarmscapital
...
contract TegridyFarmsCapital is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tegridy Farms Capital";
    string private constant _symbol = unicode"TEGRIDY";
    ...
    modifier lockTheSwap {
        ...
        constructor (address payable treasuryWalletAddress , address payable TEGRIDYWALLETADDRESS) {
        w1 = treasuryWalletAddress;
        w2 = TEGRIDYWALLETADDRESS;
    ...
    function setTEGRIDYWallet(address payable _w2) external {
