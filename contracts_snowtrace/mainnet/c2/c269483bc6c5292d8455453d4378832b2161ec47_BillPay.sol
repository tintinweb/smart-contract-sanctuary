...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x5947BB275c521040051D82396192181b413227A3);
...
contract BillPay is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5947BB275c521040051D82396192181b413227A3; // EP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BillPay";
    string constant _symbol = "BPAY";
    ...
    address public autoLiquidityReceiver=0x9DbeBd505385fdCcd8fF3D8AB3D679AA7bf0b411;
    address public marketingFeeReceiver=0x9DbeBd505385fdCcd8fF3D8AB3D679AA7bf0b411;
