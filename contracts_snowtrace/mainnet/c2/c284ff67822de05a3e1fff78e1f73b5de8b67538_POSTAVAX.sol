...
/**
 *POSTAVAX $POSTA are a brand new NFT on the Avalaunch blockchain that offer a combined experience of fun, cute collectibles.
POSTAVAX are procedurally generated (and random) POSTAVAXxel Buddies that contain a large number of different attributes and traits that make each Voxie unique and fun to collect.
