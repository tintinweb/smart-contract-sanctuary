...
contract BridgeToken is ERC20Burnable {
    ...
    // string private constant TOKEN_NAME = "ETH Token";
    // string private constant TOKEN_SYMBOL = "ETH.k";
    ...
    constructor(string memory TOKEN_NAME, string memory TOKEN_SYMBOL) ERC20(TOKEN_NAME, TOKEN_SYMBOL) {
