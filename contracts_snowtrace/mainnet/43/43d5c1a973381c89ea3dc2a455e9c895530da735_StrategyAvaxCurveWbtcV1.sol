...
contract StrategyAvaxCurveWbtcV1 is StrategyAvaxCurveFarmBase {
    address public constant wbtc = 0x50b7545627a5162F82A992c33b87aDc75187B218; //want token
    ...
    // staking constants
    address public constant curveGauge = 0x0f9cb53Ebe405d49A0bbdBD291A65Ff571bC83e1;
    address public constant curvePool = 0x16a7DA911A4DD1d83F3fF066fE28F3C792C50d90;
    address public constant curveLpToken = 0xC2b1DF84112619D190193E48148000e3990Bf627;
    ...
    constructor(
        ...
        public StrategyAvaxCurveFarmBase(wbtc, curveLpToken, curveGauge, _governance, _strategist, _controller, _timelock)
    {		        
        IERC20(wbtc).safeApprove(curvePool, uint256(-1));
    ...
    function _withdrawSome(uint256 _amount) internal override returns (uint256) {
        ...
        if (_lpAmt > 0){
            ...
            ICurveFi_2(curvePool).remove_liquidity_one_coin(requiredLpAmt, 0, maxSlippage, true);
        }
    ...
    function harvest() public override onlyBenignCallers {
        ...
        if (_wavax > 0) {
            ...
            path[0] = WAVAX;
            path[1] = want;
            _swapUniswapWithDetailConfig(WAVAX, want, _wavax, 1, path, sushiRouter);
    ...
    function getName() external override pure returns (string memory) {
        return "StrategyAvaxCurveWbtcV1";
    }
}