...
KingAvax.Money - First Avax Reflection on Avalanche
Total Tax: 15%
+ 10% Avax reflection 
+ 5% Auto Liquidity 
...
contract KingAvax is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KingAvax.Money";
    string constant _symbol = "KingAvax";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(1).div(100); // 1%
	uint256 public _maxWallet = _totalSupply.mul(2).div(100); // 2%
