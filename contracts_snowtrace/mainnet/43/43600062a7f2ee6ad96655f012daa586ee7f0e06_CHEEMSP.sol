...
Cheems Printer // Get AAVE rewards // 2% max transaction & wallet, will be lifted later // 10% slippage

TELEGRAM: CheemsPrintsAAVE
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 UNI = IBEP20(0x63a72806098Bd3D9520cC43356dD78afe5D386D9);
...
contract CHEEMSP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address AAVE = 0x63a72806098Bd3D9520cC43356dD78afe5D386D9; // UNI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "CheemsPrintsAAVE";
