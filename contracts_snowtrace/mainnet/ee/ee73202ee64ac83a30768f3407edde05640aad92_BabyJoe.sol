...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 JOE = IBEP20(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = JOE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            JOE.transfer(shareholder, amount);
...
contract BabyJoe is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address JOE = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyJoe";
    string constant _symbol = "bJOE";
    ...
    address public marketingFeeReceiver=0x221926dE6B7C2b9d24cB23eb4A2797fB8DaEC1dd;
