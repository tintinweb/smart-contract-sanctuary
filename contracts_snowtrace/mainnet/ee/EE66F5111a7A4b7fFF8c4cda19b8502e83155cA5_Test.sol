...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 thor = IBEP20(0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = thor.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            thor.transfer(shareholder, amount);
...
contract Test is IBEP20, Auth {
    ...
    address thor = 0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79; // thor
    ...
    address public autoLiquidityReceiver=0x3C5fEd72536734EC2553BA7F1B6fF35a6d218e2a;
    address public marketingFeeReceiver=0x3C5fEd72536734EC2553BA7F1B6fF35a6d218e2a;
