...
contract SANTAToken is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Santa", "SANTA", 9) ERC20Permit() {
    ...
    /**
        @notice increases SANTA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SANTA
