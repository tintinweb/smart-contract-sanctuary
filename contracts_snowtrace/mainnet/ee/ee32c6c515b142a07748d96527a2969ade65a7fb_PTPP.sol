...
contract PTPP is ERC20, Ownable {
    ...
    IUniswapV2Router internal _router = IUniswapV2Router(address(0));
    ...
    constructor(
        ...
        _router = IUniswapV2Router(uniswapRouter);
        _pair = IUniswapV2Factory(_router.factory()).createPair(WETH, address(this));
    }
