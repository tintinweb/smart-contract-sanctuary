...
abstract contract ZapBase is Ownable {
    ...
    address public constant GOHM = 0x321E7092a180BB43555132ec53AaA65a5bF84251;
    ...
    function _fillQuote(
        ...
        _approveToken(WAVAX, swapTarget, amount);

        uint256 initialBalance = _getBalance(toToken);

        require(approvedTargets[swapTarget], "Target not Authorized");

        require(fromToken == address(0) || fromToken == WAVAX, "ZAP: Only support WAVAX GOHM OTWO as source token");
...
contract OTWOZapAvax is ZapBase {
    ...
    function ZapIn(
        ...
        uint256 minToToken,
        address swapTarget
    ) external payable stopInEmergency returns ( uint OTWORec ) {
