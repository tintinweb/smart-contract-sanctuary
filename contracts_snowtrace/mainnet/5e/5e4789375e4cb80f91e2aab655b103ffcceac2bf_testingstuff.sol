...
contract testingstuff is ERC20, Ownable {
    ...
    uint256 public maxWalletAmount = 1500000000 * (10**18);

    constructor() ERC20("Dont buy its a test", "TEST") {
        joeV2Router = IJoeRouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
    ...
    function _beforeTokenTransfer(
        ...
        if (
            ...
            uint256 balanceRecepient = balanceOf(to) + amount;
            require(balanceRecepient <= maxWalletAmount, "Exceeds maxWalletAmount.");
        }
    }
