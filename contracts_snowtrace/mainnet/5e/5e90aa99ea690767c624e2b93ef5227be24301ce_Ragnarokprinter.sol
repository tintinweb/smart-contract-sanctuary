...
//  Stealth Launch RGKprinter
//  Max Buy: 24,000,000,000,000
//  Max Wallet: 24,000,000,000,000
//  Slippage 15-20%
//  Reward: RGK
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x46fCCf447f74ec97a521615fcE111118597071f7); // reward address avax
...
contract Ragnarokprinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x46fCCf447f74ec97a521615fcE111118597071f7; // reward avax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "RagnarokPrinter";
    string constant _symbol = "RGKp";
    ...
    address public autoLiquidityReceiver=0x60A733Af366AA0954B96890e9c06229Ae858B32F; //liq address
    address public marketingFeeReceiver=0x60A733Af366AA0954B96890e9c06229Ae858B32F; // marketing address
