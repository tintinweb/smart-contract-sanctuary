...
contract sGnome is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Gnome", "sGnome", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGNM supply to increase staking balances relative to profit_
