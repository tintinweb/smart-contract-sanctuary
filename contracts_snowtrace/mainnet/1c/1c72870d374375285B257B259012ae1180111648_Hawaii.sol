...
contract Hawaii is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hawaii";
    string private constant _symbol = "Hawaii";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xFeFc261546EB2813606054Db98fDD6f493f487B6);
        _feeAddrWallet2 = payable(0xFeFc261546EB2813606054Db98fDD6f493f487B6);
    ...
    function LiqLock() public onlyOwner {
