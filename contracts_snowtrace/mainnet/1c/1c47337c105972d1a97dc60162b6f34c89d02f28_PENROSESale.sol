...
contract PENROSESale is Ownable {

    using SafeERC20 for ERC20;
    using Address for address;

    uint constant MIMdecimals = 10 ** 18;
    uint constant PENROSEdecimals = 10 ** 9;
    uint public constant MAX_SOLD = 63158 * PENROSEdecimals;
    uint public constant PRICE = 475 * MIMdecimals / (PENROSEdecimals*(10**2));
    uint public constant MAX_SALE_PER_ACCOUNT = 100 * PENROSEdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 250 * PENROSEdecimals;

    uint public sold;
    uint owed;
    address public PENROSE;
    ...
    function buyPENROSE(uint256 amount) public onlyEOA {
    ...
    function claimPENROSE() public onlyEOA {
      ERC20(PENROSE).transfer(msg.sender, invested[msg.sender]);
      owed -= invested[msg.sender];
      invested[msg.sender] = 0;

    }
    function setClaimingActive(address penrose) public {
