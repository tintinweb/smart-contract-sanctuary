 ...
 *  
*/  
// SPDX-License-Identifier: AGPL-3.0-or-later  telegram : https://t.me/EthereumPrinter
...
contract EthereumPrinterERC20Token is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("EthereumPrinter", "ETHP", 9) {
    }
