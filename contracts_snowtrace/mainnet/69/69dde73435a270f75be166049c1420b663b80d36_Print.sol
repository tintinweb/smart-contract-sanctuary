...
// Denegerate Dev present PRINT

// Get reward in BTC token with PRINT

// Telegram: https://t.me/PRINTAVAX

// Twitter: https://twitter.com/PRINTAVAX
...
contract Print is IBEP20, Auth {
    ...
    string constant _name = "PRNT";
    string constant _symbol = "PRNT";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 0,5%
    uint256 public _maxWallet = _totalSupply.div(40); // 1,5%
    ...
    address public autoLiquidityReceiver=0x44cd38ec5B73B77d5C79F6545E1269454643FA67;
    address public marketingFeeReceiver=0x44cd38ec5B73B77d5C79F6545E1269454643FA67;
