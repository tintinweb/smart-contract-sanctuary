...
contract MyFinance is Ownable {
    ...
    function _withdraw(uint256 _depositedPlusInterests, address _token, address _charity, uint256 _percentage) internal {
        uint256 recovered = lendingPool.withdraw(_token, _depositedPlusInterests, address(this));
        uint256 interests = recovered - _depositedPlusInterests;
