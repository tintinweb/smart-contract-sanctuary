...
/**
 *Twitter: https://twitter.com/VikingsFinance
 *Website: https://vikings.finance/
 *Presale: https://vikings.finance/#/presale
 *Medium: https://vikingsfinance.medium.com/
  Bonding will be live shortly after launch.
*/
...
contract VikingsFinance is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 60000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'VikingsFinance';
    string private _symbol = 'VAL';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 0;
    uint256 private _burnFee = 10;
    uint256 private _maxTxAmount = 60000 * 10**18;
