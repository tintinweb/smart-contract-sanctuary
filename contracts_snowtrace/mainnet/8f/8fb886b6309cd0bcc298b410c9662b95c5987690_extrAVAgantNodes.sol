...
Enjoy lifetime APY with our extrAVAgant Nodes. Inspired by $RING, $STRONG and $THOR.

To create a node you will need 200 $extrAVA.
The distribution is as follows: 140 $extrAVA to the reward pool, 40 $extrAVA to the liquidity pool, 10 $extrAV to be BURN and 10 $extrAVA to the team.
There will be no limit to the number of nodes you can create per wallet, you can create infinite nodes!

More information regards project

Telegram: https://t.me/extrAVAgantNODES
Website: https://extrAVA.io
...
contract extrAVAgantNodes is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "extrAVAgant";
    string constant _symbol = "extrAVAgant";
    ...
    address public autoLiquidityReceiver=0x2A009c1cDFde6c6Ce5DDB26Ef9670e319B86DE54;
    address public marketingFeeReceiver=0x2A009c1cDFde6c6Ce5DDB26Ef9670e319B86DE54;
