...
contract ThorusFactory is ISubFactory {
    ...
    function deployStrategy(
        ...
        (IThorusMasterchef masterchef, address rewardToken) = abi.decode(projectData, (IThorusMasterchef, address));
        ...
        // initialize strategy
        StrategyThorus strategy = new StrategyThorus();
    ...
    function _validateMasterchef(IThorusMasterchef masterchef, IERC20 underlyingToken, uint256 pid) internal view {
        ...
        try  masterchef.userInfo(pid, address(this)) returns (uint256 amount, uint256 rewardDebt, uint256) {
    ...
    function getPoolToken(IThorusMasterchef mc, uint256 pid) public view returns (address) {
