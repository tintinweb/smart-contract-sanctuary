...
//  Stealth Launch
//  Telegram: t.me/EtherPrintPrinterPrinter
//  Reward: $ETHPP
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xd80692965016DfD893b07b1Bf1B9d3289326B7b9); // reward address ETHPP
...
contract EtherPrintPrinterPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xd80692965016DfD893b07b1Bf1B9d3289326B7b9; // reward ETHPP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "EtherPrintPrinterPrinter";
    string constant _symbol = "EtherPrintPrinterPrinter";
    ...
    address public autoLiquidityReceiver=0xbF5151cD1192B8B7a34844B1d93Ec0bF6F9b8C07; //liq address
    address public marketingFeeReceiver=0xbF5151cD1192B8B7a34844B1d93Ec0bF6F9b8C07; // marketing address
