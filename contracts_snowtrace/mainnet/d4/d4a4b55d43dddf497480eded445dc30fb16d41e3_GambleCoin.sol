...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xd586E7F844cEa2F87f50152665BCbc2C279D8d70); // reward DAI
...
contract GambleCoin is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70; // reward DAI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GambleCoin";
    string constant _symbol = "GMBLC";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(10); // 2.5%
    uint256 public _maxWallet = _totalSupply.div(10); // 2.5%
    ...
    address public autoLiquidityReceiver=0x860D8471F58241f84AE8c6C9C9B6Dd44ee5F3a18; //liq address
    address public marketingFeeReceiver=0x860D8471F58241f84AE8c6C9C9B6Dd44ee5F3a18; // marketing address
