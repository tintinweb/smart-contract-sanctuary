...
contract PolarPUBsale is Crowdsale, TimedCrowdsale
{
    ...
    constructor(uint allocationCap_, uint hardCap_, uint numerator_, uint denominator_, address subject_, address token_, address polarNFT_, address MultisigWallet_, uint openingTime, uint closingTime, address distribPool)
...
// onlyWhileOpen
    ...
    {
        require(polarnft.getTokenIds(msg.sender).length == 0, "You need to buy with the Whitelist Sale");
