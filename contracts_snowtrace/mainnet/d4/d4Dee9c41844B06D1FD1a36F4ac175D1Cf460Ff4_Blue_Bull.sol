 ...
 * @dev Interface of the ERC20 standard as defined in the EIP.
    ...
    Telegram: https://t.me/AVABlueBull
  
  Tokenomics:
  4% of transactions to burn wallet (BUYBACK BLUEBULL AND BURN)
...
contract Blue_Bull is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x3bB5F19263636709aA56f7b2F1e0357885937eF2;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Blue Bull";
    string private _symbol = "BlueBull";
