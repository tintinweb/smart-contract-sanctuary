...
IMPORTANT: Due to high taxes, you might have trouble selling on Pangolin.
If you are having trouble, try setting slippage to 49%
...
contract BtcEthPrint is IERC20, Ownable {
    using SafeMath for uint256;
