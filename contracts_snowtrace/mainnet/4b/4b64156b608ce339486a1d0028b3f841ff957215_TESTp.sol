...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x0755FA2F4AA6311E1D7C19990416c86F17D16F86); // update
...
contract TESTp is IBEP20, Auth { // update
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x0755FA2F4AA6311E1D7C19990416c86F17D16F86; // update
    ...
    bool gasLimit = true;
    uint256 private gasPriceLimit = 70000000000; // 70 nAvax update
    uint256 private gasPriceMin = 50000000000; // 60 nAvax update

    string constant _name = "TESTp"; // update
    string constant _symbol = "TESTp"; // update
    ...
    uint256 liquidityFee = 200; // update
    uint256 buybackFee = 0; // update
    uint256 reflectionFee = 700; // update
    uint256 marketingFee = 600; // update
    uint256 totalFee = 1500; // update
    uint256 feeDenominator = 10000; // update

    address public autoLiquidityReceiver=0xE14EE18c160101756aEaE203FB92F67716B3Cf15; // liq address update
    address public marketingFeeReceiver=0xE14EE18c160101756aEaE203FB92F67716B3Cf15; // marketing address update
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!isSell && gasLimit) {
            ...
            require(tx.gasprice >= gasPriceMin, "Gas price is too low.");
        }
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setGasPriceMin(uint Argument) external onlyOwner {
        gasPriceMin = Argument;
    }
