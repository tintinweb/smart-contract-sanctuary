...
// Dependency file: contracts/baby/ShibaPrinterDividendTracker.sol
...
contract ShibaPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ShibaPrinter contract."
        );
    }
...
// Root file: contracts/baby/ShibaPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/ShibaPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract ShibaPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    ShibaPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = ShibaPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "ShibaPrinter: The dividend tracker already has that address"
        );

        ShibaPrinterDividendTracker newDividendTracker = ShibaPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "ShibaPrinter: The new dividend tracker must be owned by the ShibaPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "ShibaPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "ShibaPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "ShibaPrinter: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "ShibaPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "ShibaPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "ShibaPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialSHIBABalance = IERC20(rewardToken).balanceOf(
            address(this)
        );
