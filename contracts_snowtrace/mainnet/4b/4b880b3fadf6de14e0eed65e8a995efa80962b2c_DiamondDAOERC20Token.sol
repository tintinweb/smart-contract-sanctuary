...
DiamondDAO the OHM FORK only for diamondhands website is ready we wil be big!!! join us in our journey letst get diamonds


Telegram: https://t.me/DiamondDAO

twitter : https://twitter.com/DiamondDAO2

website : diamonddao.live
...
contract DiamondDAOERC20Token  is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("DiamonDAO", "DMD", 9) {
    }
