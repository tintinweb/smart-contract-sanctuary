...
contract POST is IERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize () external initializer {
        string memory name_ = "POST" ;                             
        string memory symbol_ = "POST";
        uint256 totalSupply_ = 1000000000000* 10**9;                                // 1000000000000 -> 1 trillion
        address owner_ = 0x296E736571c18cC71C6b74fC0B7a806Ba9d985B7;                // Owner address.
        address router_ = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4;              // Uniswap Router
        address charityAddress_ = 0x7b9FD1110d1dF1bF9EF650744C0E35845C4C0d76;       // Charity wallet addresss.
        address marketingAddress_ = 0x7b9FD1110d1dF1bF9EF650744C0E35845C4C0d76;     // Marketing wallet address.
        uint16 taxFeeBps_ = 100;                                                    // Tax fee.
        uint16 liquidityFeeBps_ = 400;                                              // Liquidity fee.
        uint16 charityFeeBps_ = 500;                                                // Development fee.
        uint16 marketingFeeBps_ = 500;                                              // Mrketing fee.
