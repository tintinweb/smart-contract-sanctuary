...
/**
    ...
    https://t.me/squidgamenodes

    Cream finance protocol

    Passive Income and Low Tax

    What is Cream Finance?
    Cream finance is a token that is designed to generate high-yield rewards for you.
    In order to generate a $Cream passive you just need holding.

    4% redistribution in $Cream
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x1056fd4480bCD007466489D411c5a7e3eb94552a;
...
contract CreamFinance is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x1056fd4480bCD007466489D411c5a7e3eb94552a;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CreamFinance";
