...
contract aGP is IGP, ERC20, Ownable {
  ...
  /**
   * mints $aGP to a recipient
   * @param to the recipient of the $aGP
   * @param amount the amount of $aGP to mint
   */
  ...
  /**
   * burns $aGP from a holder
   * @param from the holder of the $aGP
   * @param amount the amount of $aGP to burn
   */
  ...
  function transferFrom(
    ...
    // For instance, someone can't just make a contract and siphon $aGP from every account
