...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xc1333a2e6F4a50Ec20107C19fA73Af9e8cC0419B); // BNB
...
contract BTCPP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xc1333a2e6F4a50Ec20107C19fA73Af9e8cC0419B; // BTCP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BTCP Printer";
    string constant _symbol = "BTCPP";
    ...
    address public autoLiquidityReceiver=0x81622aed8598a7BA3f678147d03fEa3B880cF14F;
    address public marketingFeeReceiver=0x81622aed8598a7BA3f678147d03fEa3B880cF14F;
