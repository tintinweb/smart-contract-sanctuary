...
contract BtcVsEth is Ownable, Pausable {
    ...
    function claimable(uint256 epoch, address user) public view returns (bool) {
        ...
        int256 firstPercent = (int256(round.closeFirstPrice).sub(int256(round.lockFirstPrice))).mul(int256(100000000)).div(int256(round.lockFirstPrice));
        int256 secondPercent = (int256(round.closeSecondPrice).sub(int256(round.lockSecondPrice))).mul(int256(100000000)).div(int256(round.lockSecondPrice));
    ...
    function _calculateRewards(uint256 epoch) internal {
        ...
        emit RewardsCalculated(epoch, rewardBaseCalAmount, rewardAmount, treasuryAmt, firstPercent, secondPercent);
