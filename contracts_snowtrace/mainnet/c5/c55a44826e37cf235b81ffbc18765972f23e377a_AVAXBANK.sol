...
// Get reward in AVAX token with AVAXBANK
// TAX: 8% to HOLDERS 8% LIQUIDITY 2% MARKETING 
// 
//New TG group =>(https://t.me/avaxbank_original)
//TG https://t.me/AVAXBANK_AVAX(group got deleted along with account) 
...
contract AVAXBANK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x90a4DA16d7d681e8B35379B4cF5bBc7f1A5e0ff2;
    address public marketingFeeReceiver=0x90a4DA16d7d681e8B35379B4cF5bBc7f1A5e0ff2;

    string constant _name = "AVAXBANK";
    string constant _symbol = "AVAXBANK";
