...
/**
    ...
    Tokenomics:
    10% of each buy goes to multi-chain farming projects to redirect yield into buy backs of CAT.
    10% of each sell goes for marketing, growth and promotion of CAT.
      

    Website:
    https://www.catpital.io/

    Telegram:
    https://t.me/aggregatorcatcoin
...
interface IJoeFactory {
    ...
    contract TokenSS is Context, IERC20, Ownable {
        ...
        address payable public _TRWalletAddress;
        ...
        constructor (address payable trWalletAddress, address payable marketingWalletAddress) {
            _TRWalletAddress = trWalletAddress;
            ...
            {    
                ...
                if(sender == joeV2Pair && recipient != address(joeV2Router) && !_isExcludedFromFee[recipient]) {             
                    if (walletLimitDuration > block.timestamp) {
                        ...
                        require(amount.add(walletBalance) <= _tTotal.mul(2).div(1));
                    }
                }
        ...
        function sendAVAXToTeam(uint256 amount) private {
            _TRWalletAddress.transfer(amount.div(2));
        ...
        function _setTRWallet(address payable trWalletAddress) external onlyOwner() {
            _TRWalletAddress = trWalletAddress;
        }
