...
contract RipBodganoff is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 72 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'RipBodganoff';
    string private _symbol = 'RIPBOG';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 0;
    uint256 private _burnFee = 0;
    uint256 private _maxTxAmount = 72 * 10**6 * 10**18;
    ...
    function _setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <= 20, 'taxFee should be in 0 - 10');
        _taxFee = taxFee;
    }
    
    function _setBurnFee(uint256 burnFee) external onlyOwner() {
        require(burnFee >= 0 && burnFee <= 20, 'burnFee should be in 0 - 10');
        _burnFee = burnFee;
    }
