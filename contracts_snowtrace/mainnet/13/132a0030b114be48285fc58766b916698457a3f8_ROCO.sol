...
// File contracts/Roco.sol

pragma solidity 0.8.4;

contract ROCO is IERC20, Context, Ownable {
    ...
    string  private constant _name   = 'Avatar finance';
    string  private constant _symbol = 'AVTR';
    ...
    /*
    * @notice - Roco Fee's (will never be used!)
    * Maximum Roco Fee Value (always 0%) cannot be changed
    */
    uint256 private constant _MaxRocoFee = 0;       
