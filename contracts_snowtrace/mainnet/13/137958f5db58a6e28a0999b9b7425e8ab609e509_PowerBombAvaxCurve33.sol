...
contract PowerBombAvaxCurve is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function swap2(address tokenIn, address tokenOut, uint amount) internal returns (uint) {
    ...
    function swap3(address tokenIn, address tokenOut, uint amount) internal returns (uint) {
