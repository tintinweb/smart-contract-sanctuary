...
contract HolyShitBearsAreFucked is ERC20Capped, Ownable {
  address public WAVAX;
  address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
  address public constant ZERO = 0x0000000000000000000000000000000000000000;

  uint256 public constant MAX_SUPPLY = 1_000_000_000_000_000 * (10**18);
  uint256 public _maxTxAmount = MAX_SUPPLY / 200; // 0.5%
  uint256 public _maxWallet = MAX_SUPPLY / 40; // 2,5%
  ...
  uint256 private targetLiquidity = 10;
  ...
  constructor(address _dexRouter, address _marketingAddress)
    ERC20("HSBAF", "Holy Shit Bears Are Fucked")
    ERC20Capped(MAX_SUPPLY)
  {
    ...
    approve(_dexRouter, totalSupply());
  ...
  function _beforeTokenTransfer(
    ...
    bool isSell = to == pair || to == address(router);
    ...
    if (!isSell) {
      require(
        (_balances[to] + amount) < _maxWallet,
        "Max wallet has been triggered"
      );
    }
    console.log("1.3 Here");
  ...
  function _transfer(
    ...
    console.log("1.0 Here");
    _beforeTokenTransfer(sender, recipient, amount);
    console.log("2.0 Here");
  ...
  function checkTxLimit(address sender, uint256 amount) internal view {
    require(amount <= _maxTxAmount || isExempt[sender], "TX Limit Exceeded");
  }

  function shouldTakeFee(address sender) internal view returns (bool) {
    return !isExempt[sender];
  }
  ...
  function swapBack() internal swapping {
    // Aiming for liquidity / mkt cap to be 10%
    ...
    uint256 amountAVAXLiquidity = (amountAVAX * dynamicLiquidityFee) /
      totalAVAXFee /
      2;
  ...
  function setFees(
    ...
    require(totalFee < feeDenominator / 7); // No greater than 14.29% fees
  }
