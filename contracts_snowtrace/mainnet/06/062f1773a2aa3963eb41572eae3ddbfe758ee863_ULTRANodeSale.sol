...
contract ULTRANodeSale is Ownable {
    ...
    function buyNODE(uint256 _initValue, string memory nodeName) external {
        ...
        require(MIM.transferFrom(msg.sender, address(this), nodePrice * (10 ** MIM.decimals())) == true, "TX Failed");
        MGMT.createNode(msg.sender, nodeName, _initValue * 10 ** 18);
