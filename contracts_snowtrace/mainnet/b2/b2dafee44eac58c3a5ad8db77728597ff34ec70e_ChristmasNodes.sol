...
/**
  ...
  Telegram: https://t.me/ChristmasNodes

  New node protocol as gift to the avax community!
...
contract ChristmasNodes is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("ChristmasNodes", "XmasNodes") PaymentSplitter(payees, shares) {
