...
Well here's your chance to get in and earn both WBTC & WETH
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x5947BB275c521040051D82396192181b413227A3); // BTC
    IBEP20 EPTWO = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // ETH
    ...
    uint256 public totalDividendsTwo;
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = EP.balanceOf(address(this)); //BTC
        uint256 balanceBeforeTwo = EPTWO.balanceOf(address(this)); //ETH

        address[] memory path = new address[](3);
        path[0] = WAVAX;
        path[1] = address(EP); //btc
        path[2] = address(EPTWO); //eth
        ...
        uint256 amountTwo = EPTWO.balanceOf(address(this)).sub(balanceBeforeTwo);

        totalDividends = totalDividends.add(amount);
        totalDividendsTwo = totalDividendsTwo.add(amountTwo);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            EPTWO.transfer(shareholder, amount);
...
contract BTCETHP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5947BB275c521040051D82396192181b413227A3; // BTC
    address EPTWO = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB; // ETH
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BTCETHPrint";
    string constant _symbol = "BTCETHP";
    ...
    address public autoLiquidityReceiver=0xb8a9ac208080638BEbfDC52b06B51216BfD39c6e;
    address public marketingFeeReceiver=0xb8a9ac208080638BEbfDC52b06B51216BfD39c6e;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        uint256 balanceBeforeTwo = address(this).balance;
        ...
        uint256 amountAVAXTWO = address(this).balance.sub(balanceBeforeTwo);
        ...
        uint256 amountAVAXReflectionTwo = amountAVAXTWO.mul(reflectionFee).div(totalAVAXFee);

        try distributor.deposit{value: amountAVAXReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountAVAXMarketing);
            
        try distributor.deposit{value: amountAVAXReflectionTwo} () {} catch {}
        payable(marketingFeeReceiver).transfer(amountAVAXMarketing);
