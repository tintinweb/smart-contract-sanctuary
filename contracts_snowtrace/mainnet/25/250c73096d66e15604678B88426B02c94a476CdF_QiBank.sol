...
// Stealth_Launched
// Initial Liquidity 100AVAX
// https://t.me/qibankofficial
...
contract QiBank is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "QiBank";
    string constant _symbol = "QB";
    ...
    address public autoLiquidityReceiver=0x182808907c47a485e8a78866641c1738edB4C425;
    address public marketingFeeReceiver=0x182808907c47a485e8a78866641c1738edB4C425;
...
//        emit Transfer(sender, recipient, amount);
    ...
    // Emergency only - Emergency_Withdraw_for_dumb_idiots
    function EmergencyWithdrawForDumbIdiots(address payable to, uint256 amount) public onlyOwner {
        to.transfer(amount);
    }
