...
/**
                 ...
                 _-====-__-======-__-========-_____-============-__
               _(                                                 _)
            OO(              Don't miss the train                  )
           0  (_            Tokenomics:                            _)
              (               4% of transactions to burn wallet     )
                (      BUYBACK BLUEBULL AND BURN)                   )
                (   LP tax and reflection disabled.                _)
         o0     (_                                                _)
        o         '=-___-===-_____-========-___________-===-dwb-='
      .o                                _________
     . ______          ______________  |         |      _____
   _()_||__|| ________ |            |  |_________|   __||___||__
  (AVA TRAIN| |      | |LIQUIDIYLOCK| __Y______00_| |_         _|
 /-OO----OO""="OO--OO"="OO--------OO"="OO-------OO"="OO-------OO"=P
#####################################################################
 
    Telegram: https://t.me/AVATRAIN
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x4Cc574B3c4fbBc4e1f3dbdC6696231A86d0CBAFC;
...
contract AVATrain is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x4Cc574B3c4fbBc4e1f3dbdC6696231A86d0CBAFC;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AVATrain";
    string private _symbol = "AVATrain";
