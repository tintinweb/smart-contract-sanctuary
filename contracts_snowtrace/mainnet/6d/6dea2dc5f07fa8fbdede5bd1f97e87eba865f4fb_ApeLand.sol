...
/**
  ...
  The thing we believe makes crypto so exciting is the constancy of change. The endless need to either innovate or get out of the way. 
  If you aren’t changing, you aren’t trying. 
  Constant trying, and significant failure, are what lead you to that ultimate success. You either win, or you…
...
V  \
 \  \_
  ...
  telegram:https://t.me/avaxapeland
...
contract ApeLand is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("ApeLand ", "ApeLand ", 9) {
    }
