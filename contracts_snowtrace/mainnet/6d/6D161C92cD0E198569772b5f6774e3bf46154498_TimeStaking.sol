...
contract TimeStaking is Ownable {
    ...
    function rebase() public {
        ...
        console.log("Blcok timestamp: ", uint32(block.timestamp));
        if( epoch.endTime <= uint32(block.timestamp) ) {
            console.log("rebase distribute", epoch.distribute);
            console.log("rebase number", epoch.number);
