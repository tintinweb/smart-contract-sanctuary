...
contract AvaxReflect is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // JEWEL
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xcE3c1e90Ed7A8705bc70D749eB113A7ce7874962;
    address public marketingFeeReceiver=0xcE3c1e90Ed7A8705bc70D749eB113A7ce7874962;

    string constant _name = "Avax Reflect";
    string constant _symbol = "aREFLECT";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xcE3c1e90Ed7A8705bc70D749eB113A7ce7874962;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function Sweep(address _tokenContract, uint256 _amount) external onlyOwner {
