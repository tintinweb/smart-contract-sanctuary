...
/**
 *
Transparency is our top priority at WhaleGirls $WG ✨

Let me tell you about the happenings "behind the scenes" today:

The WhaleGirls project has made it its goal to last in the Avalaunch in the long term. For this reason, we are already working TODAY on TOMORROW benefits for you, as our valuable community.
Besides the visible marketing steps, there is a lot going on in the background:

- our WhaleGirls will become even more multifaceted - original artists are working on this at the moment

- so that you can enjoy the individual WhaleGirls at home, we are also working on an exclusive Waifu collection.

- one of our top priorities is to make WhaleGirls accessible to EVERYONE, step by step. Unlike most tokens, we don't want the success curve of our WhaleGirls project to flatten out after the important CMC & CG listings. 
That is why we are already working on securing contacts to important interfaces/platforms in the Avax. 

*  Tokenomics? *
 Total Supply: 1,000,000,000 $WG
- Add Liquidity :       70%
- Burn token:            25%
- Marketing:               3%
- Team & Advisors:     2%

- 8% total tax for buying/selling:
-4% goes into marketing
-2% goes into liquidity 
-2% goes into team wallet

One thing I can already tell you, WhaleGirls is going to be GREAT, my friends of the endless ocean

Twitter: https://twitter.com/WhaleGirlAvax
Telegram: https://t.me/WhaleGirl_Avax
Website: TBA
*/
...
contract  WhaleGirls is Context, IERC20 {
