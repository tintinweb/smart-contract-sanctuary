...
/**
     _______..___________. _______  __       __           ___      .______         .__   __.   ______    _______   _______      _______.
    /       ||           ||   ____||  |     |  |         /   \     |   _  \        |  \ |  |  /  __  \  |       \ |   ____|    /       |
   |   (----``---|  |----`|  |__   |  |     |  |        /  ^  \    |  |_)  |       |   \|  | |  |  |  | |  .--.  ||  |__      |   (----`
    \   \        |  |     |   __|  |  |     |  |       /  /_\  \   |      /        |  . `  | |  |  |  | |  |  |  ||   __|      \   \    
.----)   |       |  |     |  |____ |  `----.|  `----. /  _____  \  |  |\  \----.   |  |\   | |  `--'  | |  '--'  ||  |____ .----)   |   
|_______/        |__|     |_______||_______||_______|/__/     \__\ | _| `._____|   |__| \__|  \______/  |_______/ |_______||_______/   



    $SN is a next-generation node protocol, decentralized token, trustless masternode 
    ultra-economics and launched on avax network, the most active chain  (traderJoe).

    The $SN token will be evolved along the time.
    We will announce more details on the specifics at a later date! SN to the #MOON!

    Socials:
    Discord: https://discord.gg/DG45k8W4YK
    Medium: https://medium.com/@StellarNodes
    Twitter: https://twitter.com/StellarNodesAva
    Telegram: https://t.me/stellarNodes
    Website https://stellarnodes.org/

    #STELLARNODES #SPACE #SN
...
contract StellarNodes is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("StellarNodes", "SN") PaymentSplitter(payees, shares) {
