...
contract AVAXSafeDump is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdB3BCA3faf0439D3267f2859f0333638a0Cfe0BE);
    ...
    string private _name = "AVAXSafeDump";
