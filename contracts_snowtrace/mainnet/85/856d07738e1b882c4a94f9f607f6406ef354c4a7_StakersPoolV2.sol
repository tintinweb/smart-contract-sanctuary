...
contract StakersPoolV2 is IStakersPoolV2, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function rebalancePools(
        ...
        require(_checkSignature(address(this), _rewardPerBlock, _lpTokens, _weightList, _nounce, v, r, s), "RBLNPL:4");

        require(!nonceFlagMap[_nounce], "RBLNPL:5");
        nonceFlagMap[_nounce] = true;
    ...
    function _checkSignature(
        ...
        bytes32 msgHash = keccak256(abi.encodePacked(_scAddress, _rewardPerBlock, _lpTokens, _weightList, _nounce));
