...
contract knivesRoyalties {
    ...
    function balanceDe(address _user) public view returns(uint256){
        IERC721Enumerable contrat = IERC721Enumerable(_contract);
        return contrat.balanceOf(_user);
    }
    function offreTotale() public view returns(uint256){
        IERC721Enumerable contrat = IERC721Enumerable(_contract);
        return contrat.totalSupply();
    }
