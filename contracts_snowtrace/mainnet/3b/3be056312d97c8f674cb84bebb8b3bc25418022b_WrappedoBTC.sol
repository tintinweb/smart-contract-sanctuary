...
// File: contracts/token/ERC20/WrappedoBTC.sol
...
/**
 * @title WrappedoBTC
 * @dev Implementation of the WrappedoBTC
 */
contract WrappedoBTC is ERC20Mintable, ERC20Burnable, Ownable {

    constructor (
        )

        ERC20("Wrapped Optical Bitcoin", "woBTC")
        payable
    {
        _setupDecimals(18);
        _mint(_msgSender(), 0);
