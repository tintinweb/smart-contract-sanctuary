...
/**
BABY AVAX Reward listed on #TraderJoe!

$BABYAVAXReward Token holders get rewarded with $AVAX!

-AntiDump system :
 Max Buy 20000000000000
 Max Wallet 50000000000000
- 5% AVAX Rewards
- 3% LP
- 3% Buybacks & Burn Forever

TG = https://t.me/BABYAVAXREWARD
...
contract BABYAVAXRewardtoken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABYAVAX";
    string constant _symbol = "BabyAvax";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; // 2%
    uint256 public _maxWallet = _totalSupply * 5 / 100; // 5%
    ...
    address public autoLiquidityReceiver=0xd10E37272f7a99c5aBe81f5796faA39d30d76B12; //liq address
    address public marketingFeeReceiver=0xd10E37272f7a99c5aBe81f5796faA39d30d76B12; // marketing address
