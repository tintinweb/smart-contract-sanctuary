...
contract CoupToken is ERC20('COUP', 'COUP') {

    constructor() {
        _mint(_msgSender(), uint256(170000000000000000000)); // 10 tokens for initial liquidity
        _mint(address(0x758F16Ea1F90DB3c058334c9B91EbBa0A73702E2), uint256(30000000000000000000)); // 10 tokens to treasury
    }
