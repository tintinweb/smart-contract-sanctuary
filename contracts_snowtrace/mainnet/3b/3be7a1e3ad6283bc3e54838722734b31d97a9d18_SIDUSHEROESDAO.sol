...
/**
TG: t.me/sidusheroes_dao

++ STEALTH LAUNCH ++

Tokenomics :
🤖 Total Supply: 1000,000,000 $SIDUSHEROSDAO

What is the buy and sell tax? :
🤖 18 % total tax for buying/selling:
👾 2 % goes into marketing
👾 8 % goes into liquidity 
👾 8 % goes reflection
👉Maxbuy 2% total supply per each TX.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 AVAX = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); //AVAX
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AVAX.balanceOf(address(this));
        ...
        uint256 amount = AVAX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            AVAX.transfer(shareholder, amount);
...
contract SIDUSHEROESDAO is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address AVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // AVAX
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xc41C66A29F133254BDf2c5bb6d5f5858fb76333c;
    address public marketingFeeReceiver=0xc41C66A29F133254BDf2c5bb6d5f5858fb76333c;

    string constant _name = "SIDUSHEROESDAO";
    string constant _symbol = "SIDUSHEROESDAO";
