...
contract Rocket is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 ROCKET-WETH LP -> ROCKET pool
    uint256 public constant INITIAL_ROCKET_POOL_DISTRIBUTION = 21600 ether;
     ...
     */
    constructor() public ERC20("Rocket Finance", "ROCKET") {
    ...
    function setRocketOracle(address _rocketOracle) public onlyOperator {
    ...
    function distributeReward(
        ...
        require(_rocketPool != address(0), "!_rocketPool");
        require(_airdropWallet != address(0), "!_airdropWallet");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_rocketPool, INITIAL_ROCKET_POOL_DISTRIBUTION);
