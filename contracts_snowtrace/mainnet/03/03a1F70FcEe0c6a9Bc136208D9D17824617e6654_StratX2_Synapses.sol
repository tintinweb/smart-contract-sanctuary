...
interface ISynapse {
    function deposit(address _pair, uint256 _amount, address to) external;

    function withdraw(address _pair, uint256 _amount, address to) external;
}
contract StratX2_Synapses is StratX2_mod {
    constructor(
        ...
        govAddress = _addresses[0];//0xABd19D3b06b8850479034776f7877Cb350C6B2cf
        autoFarmAddress = _addresses[1];//0xa93260656359F1c3cB16f1A54fd830d7E46aCFa2
        ...
        controllerFee = _controllerFee; 
        rewardsAddress = _addresses[7];//fees address  0xABd19D3b06b8850479034776f7877Cb350C6B2cf
        //buyBackRate = _buyBackRate;
    ...
    function _farm() internal override {
        ...
        ISynapse(farmContractAddress).deposit(wantAddress, wantAmt,address(this));
    }

    function _unfarm(uint256 _wantAmt) internal override {
        ISynapse(farmContractAddress).withdraw(wantAddress, _wantAmt,address(this));
    }
}