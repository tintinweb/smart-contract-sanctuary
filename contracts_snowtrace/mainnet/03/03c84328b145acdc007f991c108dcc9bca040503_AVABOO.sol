...
//  Stealth Launch
//  Telegram: https://t.me/avaxboo
//  Initial Liquidity of  45 AVAX
//  15-25% Slippage
//  Reward: $BOOFI
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB00F1ad977a949a3CCc389Ca1D1282A2946963b0); // reward address boo
...
contract AVABOO is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB00F1ad977a949a3CCc389Ca1D1282A2946963b0; // reward Boo
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVABOO";
    string constant _symbol = "AVABOO";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(20); // 2.5%
    ...
    address public autoLiquidityReceiver=0xf646810d59a83DB1eF61Cdbb046bb31C4d98FE8f; //liq address
    address public marketingFeeReceiver=0xf646810d59a83DB1eF61Cdbb046bb31C4d98FE8f; // marketing address
