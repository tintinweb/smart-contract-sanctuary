...
/* Get rewarded in LINK token with LINKP

 TG https://t.me/LINKPrint
...
contract LINKP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5947BB275c521040051D82396192181b413227A3; // Chainlink
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ChainlinkPrint";
    string constant _symbol = "LINKP";
    ...
    address public autoLiquidityReceiver=0xD7B09e6252FD746CAfC5Ac27F03dC88aeF572f06;
    address public marketingFeeReceiver=0xD7B09e6252FD746CAfC5Ac27F03dC88aeF572f06;
