...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); 
  address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    ...
    event Deposit(uint256 amountAVAX, uint256 amountRWRD);
...
contract TESTSAT is IERC20, Auth {
    using SafeMath for uint256;
     address RWRD = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;  
     address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "TESTSAT";
    string constant _symbol = "TESTSAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        isMaxWalletExempt[0x42304505095808c26127387b950D8661D4150068] = true;
    ...
    function swapBack() internal swapping {
        if(liquidityFeeAccumulator >= swapThreshold && autoLiquifyEnabled){
            ...
            uint256 amountAVAX = address(this).balance.sub(balanceBefore);
            uint256 amountAVAXReflection = amountAVAX.mul(reflectionFee).div(totalFee);
            uint256 amountAVAXMarketing = amountAVAX.mul(marketingFee).div(totalFee);
            uint256 amountAVAXDev = amountAVAX.mul(devFee).div(totalFee);
            try distributor.deposit{value: amountAVAXReflection}() {} catch {}
            (bool success, ) = payable(marketingFeeReceiver).call{value: amountAVAXMarketing, gas: 30000}("");
            if(success){ marketingFees = marketingFees.add(amountAVAXMarketing); }
            (success, ) = payable(devFeeReceiver).call{value: amountAVAXDev, gas: 30000}("");
            if(success){ devFees = devFees.add(amountAVAXDev); }
