...
contract DividendDistributor is IDividendDistributor, Auth {
    ...
    IBEP20 BASE = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
...
contract AnyPrinter is IBEP20, Auth {
    ...
    address BASE = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // BASE
    ...
    uint256 public minAmountToTriggerSwap = 0; // _totalSupply.div(1000); // 0.1%
