...
Tokenomics:
- Buy Tax / Sell Tax: 15%
    - 8% of each buy goes to AVAX reflections
    - 5% of each sell to treasury wallet
    - 2% to the liquidity pool.

Website:
https://shibainuavax.com/

Telegram:
https://t.me/ShibaInuAvaxOfficial

Twitter:
https://twitter.com/shibainu_avax

Medium:
https://medium.com/@shibainuavax
...
contract ShibaInuAvaxDividendTracker is IDividendDistributor {
...
contract ShibaInuAvax is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    address treasuryWallet = address(0xfB4049256FB8Be14705bE367db931Cc943d22230); 
    address liquidityWallet;

    ITraderJoeRouter public router; //trader joe
    address pair; 

    ShibaInuAvaxDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new ShibaInuAvaxDividendTracker();
