...
// File contracts/StakingRewardsILPV2.sol
...
contract StakingRewardsILPV2 is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public periodFinish = 1624219200;
    ...
    mapping(address => uint256) private _coverages;
    ...
    function getCoverage() public nonReentrant {
        uint256 coverageAmount = _coverages[msg.sender];
        if (coverageAmount > 0) {
            _coverages[msg.sender] = 0;
