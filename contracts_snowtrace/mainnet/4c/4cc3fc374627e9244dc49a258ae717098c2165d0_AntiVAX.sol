...
contract AntiVAX is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal =  271 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'AntiVAX';
    string private _symbol = 'AVAX';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 2;
    uint256 private _burnFee = 2;
    uint256 private _maxTxAmount = 271 * 10**7 * 10**18;
