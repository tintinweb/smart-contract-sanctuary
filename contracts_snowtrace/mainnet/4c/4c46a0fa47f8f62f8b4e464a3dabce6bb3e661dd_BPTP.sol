...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x22d4002028f537599bE9f666d1c4Fa138522f9c8); // reward address PTP
...
contract BPTP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x22d4002028f537599bE9f666d1c4Fa138522f9c8; // reward PTP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Baby Platypus";
    string constant _symbol = "BPTP";
    ...
    address public autoLiquidityReceiver=0x576683e8F9648186FEb61Fc0c973fdfacCc77260; //liq address
    address public marketingFeeReceiver=0x576683e8F9648186FEb61Fc0c973fdfacCc77260; // marketing address
