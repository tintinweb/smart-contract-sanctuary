...
/**
    ...
    * As Safe As It Gets ASAIG  is a community based token forked off of the Original Safemoon Contract. 
    * 
    ...
    * NO TEAM WALLET
    * 
    * Dev will buy small supply $25 USD
    * 
    * 100% LP LOCKED TO TRADER JOE 
    * 
...
contract SafeNET is Context, IERC20, Ownable {
    ...
    string private _name = "AS SAFE AS IT GETS";
    string private _symbol = "ASAIG";
