...
/**
    ...
    https://t.me/sexynodesavax

    💋 SexyNodes

The new era of Proof-of-Stake is here. Get instant access to PoS rewards, 
DeFi yield, and multichain governance. All through a network of Trusted Nodes.

How it Works

Stake native assets to PoS nodes. Restake liquid tokens to the vaults. 
Join multichain governance through the DAO. Enjoy your double rewards and voting power.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x439322fF7389B5fB02773667eF2478d5652Bddb6;
...
contract SexyNodes is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x439322fF7389B5fB02773667eF2478d5652Bddb6;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SexyNodes";
    string private _symbol = "SexyNodes";
