...
interface ITaxable {
    ...
    function setHermesOracle(address _bombOracle) external;

    function setTaxOffice(address _taxOffice) external;
}

// File: contracts/TaxOfficeV3.sol
...
contract TaxOfficeV2 is Operator {
    ...
    address public hermes = address(0xB15f02F9Da8CD1f99E9dd375F21dc96D25ddd82C);
    address public weth = address(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    address public uniRouter = address(0xC58cC1a0f29f1993D089681e4fA03c7f65dF1325);
