...
The AvaxChainCapital managed investment fund.
Unleashing the untapped potential of the DAO and immutable blockchain.

Avax Chain Capital DAO works like an investment fund where profits are shared 
among holders. Funds from the treasury are allocated in a basket of investments 
(defi protocols, tokens, NFTs). Token Holders are shareholders who have a direct 
impact on the profits by having decisional power over the treasury. Revenues 
from the investments are swapped to ETH and DIRECTLY DISTRIBUTED to holders 
according to their share! (10% of All Transactions !!!)

Medium: www.medium.com/avaxchaincapital
Reddit: www.steemit.com/avaxchaincapital
Discord: discord.app/invite/as34hgvxoL
Twitter: www.twitter.com/avaxchaincapital
...
contract AvaxChainCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AvaxChainCapital";
    string constant _symbol = "AvaxChainCapital";
    ...
    address public marketingFeeReceiver=0xfbF886fCd2B2e212ECB29B7C4B227caAA3d177fE;
