...
contract BagOJewel is ERC20, Ownable {
    ...
    function createPairToken(address _pairToken) public onlyOwner {
    ...
    function setManualLPAddress(address _pairToken, address _lpToken) public onlyOwner {
        pairToken = _pairToken;
        pairAddress = _lpToken;
        setDividendExempt(pairAddress, true);
        setWalletSizeExempt(pairAddress, true);
