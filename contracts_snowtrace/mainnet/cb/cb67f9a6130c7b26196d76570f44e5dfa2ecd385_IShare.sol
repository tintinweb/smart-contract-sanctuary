...
contract IShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 iSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("ISHARE", "ISHARE") {
        _mint(msg.sender, 1 ether); // mint 1 IShare for initial pools deployment
