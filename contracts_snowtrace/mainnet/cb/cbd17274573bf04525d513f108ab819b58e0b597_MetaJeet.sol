...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xC2Fb79F128Ad0f49EafF372528B2659fe05782b3); // reward address usdc
...
contract MetaJeet is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xC2Fb79F128Ad0f49EafF372528B2659fe05782b3; // reward usdc
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MetaJeet";
    string constant _symbol = "MetaJeet";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 100; // 2%
    uint256 public _maxWallet = _totalSupply * 5 / 100; // 2%
    ...
    address public autoLiquidityReceiver=0xf171F1197474bE94ef89D8FF725c81d36D40554C; //liq address
    address public marketingFeeReceiver=0xf171F1197474bE94ef89D8FF725c81d36D40554C; // marketing address
