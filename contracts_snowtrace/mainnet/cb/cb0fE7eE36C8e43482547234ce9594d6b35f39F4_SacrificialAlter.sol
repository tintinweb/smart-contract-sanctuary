    ...
    */
        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(abi.encodePacked(
            '{"name": "',
            img.name,
            '", "description": "Mysterious items spawned from the Sacrificial Alter of the Avax Wizards & Dragons Tower. Fabled to hold magical properties, only Act 1 tower guardians will know the truth in the following acts. All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just the Avalanche C-chain.", "image": "data:image/svg+xml;base64,',
