...
contract Isthisit is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = " Is This It";
    string private constant _symbol = " IsthisIt ";
