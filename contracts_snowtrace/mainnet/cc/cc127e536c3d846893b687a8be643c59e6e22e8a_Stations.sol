...
// 0xdF94fCA483faf1bf1f1f484df3e0F1B5fF216bAe,Den of understanding,den-of-understanding,0,false
...
contract Stations {
   ...
   enum Broadcast_Types{ GENERIC, HTML, PHOTO }
    ...
    function _add_broadcast_advanced(string memory content,
        ...
        Broadcast memory tmp = Broadcast(who, station[who].username, content,
                                         time_broadcast, Broadcast_Types.HTML);
