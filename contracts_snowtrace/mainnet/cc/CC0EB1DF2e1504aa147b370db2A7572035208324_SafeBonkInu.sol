...
/** Big dicks only buy if your small stay away. Funds are SAFU here apes
...
contract SafeBonkInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeBonkInu";
    string private constant _symbol = "SABI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xD76e75DeC47ca1Bec366c923F924c5fB7165469f);
        _feeAddrWallet2 = payable(0xD76e75DeC47ca1Bec366c923F924c5fB7165469f);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xA855EeC9E9a8EF11e4acebad3E19C1743fBe90E8), _msgSender(), _tTotal);
    }
