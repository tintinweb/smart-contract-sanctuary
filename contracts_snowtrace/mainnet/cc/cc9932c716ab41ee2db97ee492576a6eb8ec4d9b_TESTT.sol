...
interface IJoeFactory {
    ...
    contract TESTT is Context, IERC20, Ownable {
        ...
        address payable public _TESTTWalletAddress;
        ...
        constructor (address payable TESTTWalletAddress, address payable marketingWalletAddress) {
            _TESTTWalletAddress = TESTTWalletAddress;
        ...
        function sendAVAXToTeam(uint256 amount) private {
            _TESTTWalletAddress.transfer(amount.div(2));
        ...
        function _setTESTTWallet(address payable TESTTWalletAddress) external onlyOwner() {
            _TESTTWalletAddress = TESTTWalletAddress;
        }
