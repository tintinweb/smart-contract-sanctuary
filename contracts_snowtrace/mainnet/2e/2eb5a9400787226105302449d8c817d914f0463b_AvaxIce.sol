...
// SPDX-License-Identifier: MIT t.me/AvaxIce
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xe0Ce60AF0850bF54072635e66E79Df17082A1109); // ICE
...
contract AvaxIce is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xe0Ce60AF0850bF54072635e66E79Df17082A1109; // ICE
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AvaxIce";
    string constant _symbol = "VAXICE";
    ...
    address public autoLiquidityReceiver=0x9F6e87bD378513E5D24161497F8B9C917a2Cf5BB; //liq address
    address public marketingFeeReceiver=0x9F6e87bD378513E5D24161497F8B9C917a2Cf5BB; // marketing address
