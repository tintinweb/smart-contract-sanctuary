...
contract BootcampToken is ERC20, Ownable {
     ...
     * @param amount Amount to be minted (with 18 decimals)
     *
     * Requirements:
     *
     ...
     * @param recipients Address array of recipients
     * @param amounts uint array of amounts
     */
    function transferMulti(address[] memory recipients, uint256[] memory amounts) public {
        require(recipients.length == amounts.length, "Inputs must have same size!");
