...
contract TheBahamas is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Bahamas";
    string private constant _symbol = "Aloha";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xD88c6AC3d2bd09D3A8F02eCdC3e2dA2ad256ad4d);
        _feeAddrWallet2 = payable(0xD88c6AC3d2bd09D3A8F02eCdC3e2dA2ad256ad4d);
    ...
    function liquiditylock() public onlyOwner {
