...
contract EverTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8F1E750b9F098b82127c6a6f27a17A614Eb62AC9); // Marketing Address
    ...
    string private _name = "EverTest";
    string private _symbol = "EverTest";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressAVAX(marketingAddress, transferredBalance.div(_liquidityFee).mul(marketingDivisor));
    ...
    function swapAVAXForTokens(uint256 amount) private {
      ...
      // make the swap
        uniswapV2Router.swapExactAVAXForTokensSupportingFeeOnTransferTokens{value: amount}(
