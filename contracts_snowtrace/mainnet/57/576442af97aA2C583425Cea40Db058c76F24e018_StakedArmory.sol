...
contract StakedArmory is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Armory", "sAMMO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sAMMO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sAMMO
