...
contract Presale is Ownable {
    ...
    string public name = "Magnus DAO Presale";

    /**
    * @notice The address of the staking token contract instance.
    */
    address private stakingTokenAddr;

    /**
    * @notice The constructor for the Presale.
    */
    ...
    /**
    * @notice A method for swapping tokens.
    */
    function swap()
        external
        payable
    {
        ...
        require(amount <= IStakingToken(stakingTokenAddr).balanceOf(address(this)));
        
        IStakingToken(stakingTokenAddr).transfer(msg.sender, amount);
    }
