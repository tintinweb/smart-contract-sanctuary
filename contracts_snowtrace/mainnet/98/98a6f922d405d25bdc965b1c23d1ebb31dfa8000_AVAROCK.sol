...
Shhhh....stealth launch, get in first before it's too late.

https://t.me/avarock

https://twitter.com/avaxrock
...
contract AVAROCK is Context, IERC20, Ownable {
    ...
    string private constant _name = "AVA ROCK";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x868Fb1eF170785eF027e69bA5ca872232b33ecCF);
        _feeAddrWallet2 = payable(0x868Fb1eF170785eF027e69bA5ca872232b33ecCF);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xC7fEd59cc4986c6a7a579F9AC33c48f76d35dFDa), _msgSender(), _tTotal);
    }
