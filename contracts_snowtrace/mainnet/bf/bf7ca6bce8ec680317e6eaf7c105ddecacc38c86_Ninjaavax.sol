...
/**
 *Ninjaavax  are a brand new NFT on the Avalaunch blockchain that offer a combined experience of fun, cute collectibles.
Ninjaavax are procedurally generated (and random) MARSINU Buddies that contain a large number of different attributes and traits that make each Voxie unique and fun to collect.

Tokenomics :
 Total Supply: 1000,000,000 $Ninja
 Add Liquidity :       75%
 burnburn        : 25%
 Marketing:               4%
 Team & Advisors:  1%
...
contract Ninjaavax is Context, IERC20 {
