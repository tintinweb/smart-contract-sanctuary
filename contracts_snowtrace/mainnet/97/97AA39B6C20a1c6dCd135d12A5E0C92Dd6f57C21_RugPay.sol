...
// GET REWARDS IN RUG with RugPay. We R just being Generous
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RUG = IBEP20(0xb8EF3a190b68175000B74B4160d325FD5024760e);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RUG.balanceOf(address(this));
        ...
        uint256 amount = RUG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RUG.transfer(shareholder, amount);
...
contract RugPay is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address RUG = 0xb8EF3a190b68175000B74B4160d325FD5024760e; // RUG
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "RugPay";
    string constant _symbol = "RugPay";
    ...
    address public autoLiquidityReceiver=0xBA05B407dc3EdF7255fa25f481D9882771703c4C;
    address public marketingFeeReceiver=0xBA05B407dc3EdF7255fa25f481D9882771703c4C;
