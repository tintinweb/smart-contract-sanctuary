...
/**
    $hodl is a new deflationary protocol to celebrate Christmas.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x66Af45b2AdC467155DDC2Fc8DE27BC8AB4389895;
...
contract HoHoHodl is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x66Af45b2AdC467155DDC2Fc8DE27BC8AB4389895;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HoHoHodl";
