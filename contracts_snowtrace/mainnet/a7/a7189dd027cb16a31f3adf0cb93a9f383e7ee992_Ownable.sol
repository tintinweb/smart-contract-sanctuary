...
Kapital Finance: $KAPF

Tokenomics:
Total supply : 1500000000000
10% of each buy goes to existing holders.
10% of each sell goes into cross-chain farming/investing to add to the treasury and buy back KAPF tokens. With community vote, funds will be used for marketing or buy backs

Twitter:
https://twitter.com/Kapital_finance

Discord:
https://discord.gg/RAX4NDH2Q2
*/
...
contract Kapital is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kapital Finance";
    string private constant _symbol = unicode"KAPF";
