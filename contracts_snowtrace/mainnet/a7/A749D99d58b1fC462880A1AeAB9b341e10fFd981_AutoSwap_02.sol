...
contract AutoSwap_02 is Ownable, ReentrancyGuard, Pausable, Whitelist {
    ...
    address payable public constant WETH = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    ...
    function swapToLP(
        ...
        if (inToken.isETH()) {
          ...
          IWETH9(WETH).deposit{ value: inToken.universalBalanceOf(address(this)) }();
        }
...
interface IPancakeRouter01 {
    function WAVAX() external pure returns (address payable);
