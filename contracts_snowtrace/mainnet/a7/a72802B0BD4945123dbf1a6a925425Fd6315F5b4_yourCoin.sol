...
contract yourCoin is Context, IERC20, Ownable, ReentrancyGuard{
    using SafeMath for uint256;
    ...
    address public usd = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; 
    ...
    address avaxRouterAddress = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; //TraderJoe

    address routerAddress = avaxRouterAddress;

    uint256 public rewardDailyMax = 10 ether;
    uint256 public rewardClaimFrequency = .5 days; // twice a day
    ...
    uint256 public claimDatePushRate = 25; // 25 percent
    ...
    function changeRewardDailyMax(uint256 newMax) external onlyOwner {
        rewardDailyMax = newMax;
    }
    ...
    function _transfer(
        ...
        // Buyback triggered on a sell when tokens added back to LP and AVAX extracted by paperhanded bitches.
    ...
    function calculateReward(address account) public view returns (uint256) {
        ...
        return Rewards.calculateReward(
    ...
    function claimReward() isHuman nonReentrant public {
        ...
        if (reward >= rewardDailyMax) {
           reward = rewardDailyMax;
        }
