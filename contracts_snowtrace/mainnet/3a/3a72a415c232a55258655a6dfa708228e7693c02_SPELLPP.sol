...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xCE1bFFBD5374Dac86a2893119683F4911a2F7814); // SPELL
...
contract SPELLPP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xCE1bFFBD5374Dac86a2893119683F4911a2F7814; // SPELL
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SPELLPP";
    string constant _symbol = "SPELLPP";
    ...
    address public autoLiquidityReceiver=0x0bb1Fec4624D66a04070E9be7C5A33208a5fbDa9; //liq address
    address public marketingFeeReceiver=0x0bb1Fec4624D66a04070E9be7C5A33208a5fbDa9; // marketing address
