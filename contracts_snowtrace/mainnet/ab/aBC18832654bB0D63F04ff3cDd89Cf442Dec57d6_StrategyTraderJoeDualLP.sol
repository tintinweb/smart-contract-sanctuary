...
contract StratManager is Ownable, Pausable {
    ...
    address public pltFeeRecipient;
    ...
    /**
     * @dev Updates plt fee recipient.
     * @param _pltFeeRecipient new plt fee recipient address.
     */
...
abstract contract FeeManager is StratManager {
    ...
    uint public pltFee = MAX_FEE - STRATEGIST_FEE - callFee;
...
// File: contracts/BIFI/strategies/TraderJoe/StrategyTraderJoeDualLP.sol
...
contract StrategyTraderJoeDualLP is StratManager, FeeManager {
    ...
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _pltFeeRecipient) public {
        want = _want;
        poolId = _poolId;
        chef = _chef;
    ...
    function chargeFees( ) internal returns (uint256) {
        ...
        uint256 nativeBal = IERC20(native).balanceOf(address(this)).mul(40).div(1000);
        IERC20(native).safeTransfer(pltFeeRecipient, nativeBal);
    }
