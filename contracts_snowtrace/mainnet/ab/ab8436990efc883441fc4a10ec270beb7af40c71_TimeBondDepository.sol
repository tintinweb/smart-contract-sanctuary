...
contract TimeBondDepository is Ownable {
    ...
    function deposit( 
        ...
        uint balanceBefore = RUG.balanceOf(address(this));
        /**
            principle is transferred in
            approved and
            deposited into the treasury, returning (_amount - profit) RUG
         */
        ...
        if ( fee != 0 ) { // fee is transferred to dao 
            RUG.safeTransfer( DAO, fee ); 
        }
        require(balanceBefore.add(profit) == RUG.balanceOf(address(this)), "Not enough RUG to cover profit");
