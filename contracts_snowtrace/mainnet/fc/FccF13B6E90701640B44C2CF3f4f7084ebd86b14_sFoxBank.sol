...
library SafeMath {
     ...
     * overflow (when the result is nåçegative).
     *
     * Counterpart to Solidity's `-` operator.
     *
     * Requirements:
...
contract sFoxBank is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sFoxBank", "sFOX", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFOX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFOX
