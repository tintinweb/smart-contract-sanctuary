...
contract SnowNeko is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SnowNeko';
    string private constant _symbol = 'NEKO';
    
    uint256 private _taxFee = 200;
    uint256 private _burnFee = 200;
    uint private _max_tx_size = 20000000000 * 10 ** uint256(_decimals);
