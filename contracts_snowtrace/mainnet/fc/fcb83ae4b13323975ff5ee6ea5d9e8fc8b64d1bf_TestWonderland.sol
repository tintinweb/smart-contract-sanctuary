...
contract TestWonderland is Ownable {
    ...
    function stakeTime() public  {
        // IERC20(memoAddress).safeApprove(timeStakingAddress, ITimeBondDepository(timeBondDepositoryAddress).pendingPayoutFor(address(this)));
    ...
    function _deposit(uint256 _wantAmt, uint256 _maxPrice) internal {
        ...
        ITimeBondDepository(timeBondDepositoryAddress).deposit(_wantAmt, _maxPrice, address(this));
    ...
    function withdraw(uint256 _minReturnWant, bool _trigger) public onlyOwner {
        ...
        ITimeStaking(timeStakingAddress).unstake(withdrawAmt, _trigger); // should we set _trigger as true?
