...
//  Stealth Launch
//  Telegram: https://t.me/timetotimeavax
//  Initial Liquidity of  10 AVAX
//  15-25% Slippage
//  Reward: $TIME
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xb54f16fB19478766A268F172C9480f8da1a7c9C3); // reward address time
...
contract TimetoTime is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xb54f16fB19478766A268F172C9480f8da1a7c9C3; // reward TIME
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Time to Time";
    ...
    address public autoLiquidityReceiver=0x808193f847997e56fC26baC4676dfA39ce516165; //liq address
    address public marketingFeeReceiver=0x808193f847997e56fC26baC4676dfA39ce516165; // marketing address
