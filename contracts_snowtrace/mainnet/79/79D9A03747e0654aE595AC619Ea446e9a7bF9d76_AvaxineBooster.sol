...
library Counters {
    struct Counter {
        ...
        // this feature: see https://github.com/AVAXereum/solidity/issues/4637
...
contract AvaxineBooster is ERC20, Ownable {
    ...
    address private constant devAddress = address(0x42648Cc0AD55B529992AC0b4519b537dfC840fAb);
    ...
    constructor() ERC20("Avaxine Booster", "VAXBOOST") {
        ...
        excludeFromFees(address(0x42648Cc0AD55B529992AC0b4519b537dfC840fAb), true);
        ...
        excludeFromMaxTransaction(address(0x42648Cc0AD55B529992AC0b4519b537dfC840fAb), true);

        _isExcludedFromContractBuyingLimit[address(this)] = true;
        _isExcludedFromContractBuyingLimit[0x60aE616a2155Ee3d9A68541Ba4544862310933d4] = true;
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x42648Cc0AD55B529992AC0b4519b537dfC840fAb) &&
                !swapping
            ){
                if(!tradingActive){
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        // generate the uniswap pair path of wAVAX -> AVAX
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WAVAX();
        path[1] = address(this);

        // make the swap
        uniswapV2Router.swapExactAVAXForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            0, // accept any amount of AVAXereum
            path,
            address(0x42648Cc0AD55B529992AC0b4519b537dfC840fAb),
            block.timestamp
        );
