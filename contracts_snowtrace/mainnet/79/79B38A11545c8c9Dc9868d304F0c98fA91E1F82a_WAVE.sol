...
contract WAVE is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Wave", "WAVE", 9) ERC20Permit() {
    ...
    /**
        @notice increases wave supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess wave
