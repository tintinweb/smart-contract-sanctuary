...
contract SPRE is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 50000000 * 10**9;
    ...
    constructor() ERC20("Staking RouteEmpire", "sPRE", 9) ERC20Permit() {
    ...
    /**
        @notice increases SPRE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SPRE
