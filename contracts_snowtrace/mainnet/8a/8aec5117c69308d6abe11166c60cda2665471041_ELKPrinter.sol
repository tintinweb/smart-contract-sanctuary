...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C);
...
contract ELKPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C; // ELK
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xd12df14E1368209c5F2870e0D1f5b267f0552E76;
    address public marketingFeeReceiver=0xd12df14E1368209c5F2870e0D1f5b267f0552E76;

    string constant _name = "ELK Printer";
    string constant _symbol = "ELKp";
