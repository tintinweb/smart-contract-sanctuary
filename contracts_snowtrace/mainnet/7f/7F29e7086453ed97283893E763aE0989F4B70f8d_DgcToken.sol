...
contract DgcToken is ERC20("DGC Token", "DGC"), Ownable {
    ...
    external
    {
        ...
        emit TransferDGCFromLayer2(msg.sender, _nonce, _amount);
    }
    ...
    public
    {
        ...
        emit TransferDGCToLayer2(msg.sender, _amount);
    }
    ...
    event TransferDGCFromLayer2(address indexed to, uint256 nonce, uint256 amount);
    event TransferDGCToLayer2(address indexed to, uint256 amount);
}