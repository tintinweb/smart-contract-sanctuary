...
contract MythicStaking is Ownable {
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        if ((depositEpoch[msg.sender].add(taxedPeriod) > epoch.number) && (msg.sender != treasury)) { // take fees if the number of staked epochs is smaller than the minimum number of epochs required to avoid fees
