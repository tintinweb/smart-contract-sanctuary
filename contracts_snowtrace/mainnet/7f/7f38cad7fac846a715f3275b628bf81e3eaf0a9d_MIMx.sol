...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x130966628846BFd36ff31a822705796e8cb8C18D); // reward address MIM
...
contract MIMx is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x130966628846BFd36ff31a822705796e8cb8C18D; // reward usdc
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MIMx";
    string constant _symbol = "MIMX";
    ...
    address public autoLiquidityReceiver=0xAB38bf268B384Bdc95AD1531674df5456882C124; //liq address
    address public marketingFeeReceiver=0xAB38bf268B384Bdc95AD1531674df5456882C124; // marketing address
