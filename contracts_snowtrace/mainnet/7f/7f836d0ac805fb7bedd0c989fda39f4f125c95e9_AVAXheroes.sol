...
/**
Stealth launching Today on  6:00 pm UTC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // reward address usdc
...
contract AVAXheroes is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118; // reward USDTe
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAXheroes";
    string constant _symbol = "AVAXheroes";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 100; // 5%
    uint256 public _maxWallet = _totalSupply * 15 / 100; // 15%
    ...
    address public autoLiquidityReceiver=0xE8373387c0528Ab84815cd90D380667b68f3bffD; //liq address
    address public marketingFeeReceiver=0xE8373387c0528Ab84815cd90D380667b68f3bffD; // marketing address
