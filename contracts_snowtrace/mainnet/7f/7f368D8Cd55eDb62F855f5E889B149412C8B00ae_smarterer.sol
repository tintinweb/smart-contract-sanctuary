...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SUN = IBEP20(0x6D923f688C7FF287dc3A5943CAeefc994F97b290);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SUN.balanceOf(address(this));
        ...
        uint256 amount = SUN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SUN.transfer(shareholder, amount);
...
contract smarterer is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SUN = 0x6D923f688C7FF287dc3A5943CAeefc994F97b290; // SUN
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Smarterer";
    string constant _symbol = "SMRTrr";
    ...
    address public autoLiquidityReceiver=0x4AFEEe429Be7D16430760cBE07922E132872bf08;
    address public marketingFeeReceiver=0x4AFEEe429Be7D16430760cBE07922E132872bf08;
