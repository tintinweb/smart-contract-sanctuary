...
/**
    $SafePrint is a new deflationary protocol with mim rewards

    Fairlaunch on Avalanche network
    TraderJoe dex

    Low tax community driven token!


    twitter: https://twitter.com/SafePrintAvax
    telegram: https://t.me/SAFEPRINT
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xF3Dd26F8aD897E77b0275656dAfCda52245F9148;
...
contract SafePrint is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xF3Dd26F8aD897E77b0275656dAfCda52245F9148;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SafePrint";
    string private _symbol = "SafePrint";
