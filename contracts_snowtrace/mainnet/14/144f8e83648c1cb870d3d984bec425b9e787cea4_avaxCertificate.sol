...
contract avaxCertificate is ERC721, Ownable {
    ...
    IJoeRouter02 private  _pancakeRouter = IJoeRouter02(PancakeRouter);
    ...
    function mintWithNative(string memory _uri, uint256 _carbonAmount) external payable returns(uint256) {
        ...
        path[0] = _pancakeRouter.WAVAX();
        path[1] = address(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
      
        _pancakeRouter.swapExactAVAXForTokensSupportingFeeOnTransferTokens{value: msg.value}(
