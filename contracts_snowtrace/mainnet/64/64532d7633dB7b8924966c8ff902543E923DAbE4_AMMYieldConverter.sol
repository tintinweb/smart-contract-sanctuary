    ...
    ReentrancyGuard
{
    ...
    function harvest(
        ...
        console.log(amountsOut[amountsOut.length - 1]);
        ...
        if (endToken != address(stable)) {
            ...
            IERC20(endToken).safeIncreaseAllowance(address(curveZap), amountsOut[amountsOut.length - 1]);
        ...
        console.log("resultant stable balance");
        console.log(balance);
