...
contract sPOS is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked POS", "sPOS", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPOS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPOS
