...
5% goes to reflection (BTC)
2% for marketing
12% total tax for buys and sells
t.me/btcprintavax
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218); // reward BTC.e
...
contract BTCPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x50b7545627a5162F82A992c33b87aDc75187B218; // reward BTC.e
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BTCPrinter";
    string constant _symbol = "BTCeP";
    ...
    address public autoLiquidityReceiver=0xF665F9182f319be8D4a35c3044c02E86FeCE75C3; //liq address
    address public marketingFeeReceiver=0xF665F9182f319be8D4a35c3044c02E86FeCE75C3; // marketing address
