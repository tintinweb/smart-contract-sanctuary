...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initializeAddresses(address _dollar, address _oracle, address _pool) public {
        ...
        // Market maker
        incentivize(Constants.getMarketMaker(), 7_500_000e18);
    }
    ...
    function initialize() initializer public {
        ...
        // Tues, 07 Dec 2021 00:00:00 GMT
        _state.epoch.start = 1638835200; // (block.timestamp / epochPeriod + 1) * epochPeriod; // Round to the next UTC-0
