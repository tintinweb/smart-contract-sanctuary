...
/**
    ...
    What is SquidGame Nodes?
    SQUID GAME NODES is a token that is designed to generate high-yield rewards for you.
    In order to stake or generate a SQN Node you need 10 $SQN tokens.


    Buying a Node
    By creating a node,
    you will lose your 10 SQN tokens but your node will be permanent,
    making you passive income forever.


    Staking
    Staking locks up your SQN tokens for a period of time, 
    and provides you with a node in return. 
    You can unstake your tokens after the lockup period is over,
    but doing so will get rid of your node.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x8cf5c81093A92f0b1DEd67983946cfD7D7d9d9b8;
...
contract SquidGame is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x8cf5c81093A92f0b1DEd67983946cfD7D7d9d9b8;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SquidGameNodes";
