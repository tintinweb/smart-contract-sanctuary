...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
     ...
     */
     ...
     uint totalMark2Mutations;
     uint totalMegaMutations;
    ...
    function _mintBatch(
        ...
        for (uint256 i = 0; i < len; i++) {
            if (ids[i] == 1) {
                totalMark2Mutations += amounts[i];
                require(totalMark2Mutations <= 2500, "mark 2 supply exceeded");
            } else if (ids[i] == 69) {
                totalMegaMutations += amounts[i];
                require(totalMegaMutations <= 8, "mega supply exceeded");
            }
