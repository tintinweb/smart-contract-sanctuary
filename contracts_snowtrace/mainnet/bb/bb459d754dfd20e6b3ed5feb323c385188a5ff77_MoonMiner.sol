...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x264c1383EA520f73dd837F915ef3a732e204a493); // BNB
...
contract MoonMiner is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x264c1383EA520f73dd837F915ef3a732e204a493; // BNB
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Moon Miner";
    string constant _symbol = "MoonMiner";
    ...
    address public autoLiquidityReceiver=0x9996C2E828a91318c68d945DFD6c036E17ca5fd5;
    address public marketingFeeReceiver=0x9996C2E828a91318c68d945DFD6c036E17ca5fd5;
