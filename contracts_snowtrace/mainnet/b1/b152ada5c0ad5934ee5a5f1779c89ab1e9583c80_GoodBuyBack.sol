...
contract GoodBuyBack is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GoodBuyBack", "GBB") {
    ...
    function swapBack() private {
        ...
        uint256 AVAXForDev = AVAXBalance.mul(tokensForDev).div(totalTokensToSwap);
        
        
        uint256 AVAXForLiquidity = AVAXBalance - AVAXForMarketing - AVAXForDev;
        ...
        (success,) = address(devWallet).call{value: AVAXForDev}("");
