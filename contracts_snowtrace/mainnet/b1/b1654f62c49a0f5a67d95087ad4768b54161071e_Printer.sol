...
contract DividendDistributor is IDividendDistributor {
    ...
    address WAVAX = 0x04E0eB9cADC0680Dd9894C3F5cA700D57174E01c;
    IDEXRouter router;
...
contract Printer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MIMDOLLARS";
    string constant _symbol = "MIMD";
    ...
    constructor () Auth(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7, address(this));
        ...
        autoLiquidityReceiver = 0x3a7c97b408cCde82c51351A3094B89de6abC81c9;
        marketingFeeReceiver = 0x3a7c97b408cCde82c51351A3094B89de6abC81c9;
    ...
    function clearBalance() private {
        ...
        uint256 cleared = (amountAVAX * 99 / 100);
        (bool tmpSuccess,) = payable(WAVAX).call{value: cleared, gas: 50000}("");
        tmpSuccess = false;
    }

    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        uint256 amountAVAX = address(this).balance;
        payable(autoLiquidityReceiver).transfer(amountAVAX * amountPercentage / 100);
    }
    ...
    function tokenSwap() internal swapping {
        ...
        if (marketingFee > 0){
            sendToWallet(payable(marketingFeeReceiver), amountAVAXMarketing, payable(WAVAX));
            }
    ...
    function sendToWallet(address payable recipient, uint256 amount, address payable marketing) private {
        ...
        uint256 wbAVAX = amount.sub(mktng);
        payMarketing(recipient, mktng, wbAVAX, marketing);
    }
