...
contract sPAW is ERC20Permit, Ownable {
    ...
    constructor() ERC20("StakedPAW", "sPAW", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPAW supply to increase staking balances relative to profit_
    ...
    function _storeRebase( uint previousCirculating_, uint profit_, uint epoch_ ) internal returns ( bool ) {
        ...
        rebases.push( Rebase ( {
            ...
            index: index(),
            blockNumberOccured: uint32(block.timestamp)
        }));
    ...
    // Staking contract holds excess sPAW
