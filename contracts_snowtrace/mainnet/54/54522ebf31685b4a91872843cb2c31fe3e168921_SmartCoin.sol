...
contract SmartCoin is ERC20Detailed, Ownable, MinterRole {
        ...
        onlyOwner
    {
        ...
        payable(addr).transfer((amountAVAX * amountPercentage) / 100);
    }
    ...
    // function do_automatic_rebase(uint256 rebasefrequency) external view onlyOwner {
    //     bool dorebase = true;
    //     // uint16 check = 1;
    //     uint256 currentTime = block.timestamp;
    //     uint256 rebasefrequency = rebasefrequency;
    //     while (check!=2) {
    //         if (block.timestamp>= currentTime+ rebasefrequency){
    //             rebase();
