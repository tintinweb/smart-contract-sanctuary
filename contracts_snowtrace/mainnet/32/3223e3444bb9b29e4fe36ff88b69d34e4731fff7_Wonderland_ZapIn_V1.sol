...
contract Wonderland_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    mapping (address => address) public actualPairs;
    ...
    IUniswapV2Router02 private vikRouter =
        IUniswapV2Router02(0x0Be0bE07E6aFB4C2903EFd643F6c1Ee0f3be314a);
    ...
    constructor(address _DAO)
    {
        ...
        //allowedPairs
        allowedPairs[ITimeBondDepository(0xfbBf03864310444535f7E0f92D1F2d78222fC3b9)] = 0x781655d802670bbA3c89aeBaaEa59D3182fD755D;// JOE WAVAX MIM
        actualPairs[0x781655d802670bbA3c89aeBaaEa59D3182fD755D] = 0x8f053552B5bFC63AddF948d699A3c2Ec518cD2B5;
    ...
    function setMetaRouter(address _router) external onlyOwner{
        vikRouter = IUniswapV2Router02(_router);
    }

    function addPairAddress(address bondDepository, address pair, address actualPair) external onlyOwner {
        require(bondDepository != address(0), "BNA");
        require(pair != address(0), "BNA");
        allowedPairs[ITimeBondDepository(bondDepository)] = pair;
        actualPairs[pair] = actualPair;
        emit AddPairAddress(bondDepository, pair);
    }

    function removePairAddress(address bondDepository) external onlyOwner {
        require(bondDepository != address(0), "BNA");
        actualPairs[allowedPairs[ITimeBondDepository(bondDepository)]] = address(0);
    ...
    function ZapInLp(
        ...
        _approveToken(actualPairs[allowedPairs[_bondDepository]], address(_bondDepository), LPBought);
    ...
    function _uniDeposit(
        ...
        _approveToken(_ToUnipoolToken0, address(vikRouter), token0Bought);
        _approveToken(_ToUnipoolToken1, address(vikRouter), token1Bought);

        (uint256 amountA, uint256 amountB, uint256 LP) =
            vikRouter.addLiquidity(
                _ToUnipoolToken0,
                _ToUnipoolToken1,
                token0Bought,
                token1Bought,
