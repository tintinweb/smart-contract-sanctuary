...
contract AvaxPUMP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1451Cf788772e7Ea706E953a595eF7b9132B7A5D); // Marketing Address
    ...
    string private _name = "AVAX USDT";
