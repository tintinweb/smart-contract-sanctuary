...
The idea behind Infinity Nodes is to enable noders to invest in multiple DeFi high-yield protocols. 
Without having to find the best ones all by themselves. 
Without having to pay for the network fees, do the manual swapping, bridging, staking, bonding, etc.

This protocol will be governed by noders who will vote towards which protocol to allocate which % of the funds. 

Discord: https://discord.gg/aTRRzsPc
...
contract InfinityNodes is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "InfinityNodes";
    string constant _symbol = "InfinityNodes";
    ...
    address public autoLiquidityReceiver=0xeb2B5919354Fb71c3732798497B4859f335F5883;
    address public marketingFeeReceiver=0x0425976ed5D4bF6869BeD4dA695f59C692c35E1c;
