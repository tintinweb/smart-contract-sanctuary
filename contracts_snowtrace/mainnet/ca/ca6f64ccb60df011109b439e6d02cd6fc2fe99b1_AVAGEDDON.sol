...
contract AVAGEDDON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x7E9B6B20C6790c981bFee977323C9B4C3FF44682;
    address public marketingFeeReceiver=0x7E9B6B20C6790c981bFee977323C9B4C3FF44682;

    string constant _name = "AVAGEDDON";
    string constant _symbol = "AVGDN";
