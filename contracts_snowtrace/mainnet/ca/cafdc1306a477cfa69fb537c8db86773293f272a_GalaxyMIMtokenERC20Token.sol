 ...
 *  
*/  
// SPDX-License-Identifier: AGPL-3.0-or-later  GalaxyMIMtoken
...
contract GalaxyMIMtokenERC20Token is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("GalaxyMIMtoken", "GMT", 9) {
    }
