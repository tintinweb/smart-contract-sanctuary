...
Ape lord is calling, we gonna print some money.

BTC & ETH

12% Slippage

TG: https://t.me/apeprint
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BTC = IERC20(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc); // BTC
...
contract Dividend2Distributor is IDividendDistributor {
    ...
    IERC20 ETH = IERC20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // ETH
    address AVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    IDEXRouter router;
...
contract APEPrinter is IERC20, Ownable {
    using SafeMath for uint256;

    address BTC = 0x50b7545627a5162F82A992c33b87aDc75187B218;
    address ETH = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB;
    address AVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "APEPrinter";
    string constant _symbol = "APEPrinter";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
                           
    uint256 public _maxTxAmount = 10000000000000000000/_totalSupply; // 1% of total supply
    uint256 public maxWalletToken = 20000000000000000000/_totalSupply; // 2% of total supply
    ...
    uint256 BTCReflectionFee = 400;
    uint256 ETHReflectionFee = 400;
    ...
    constructor () {
        ...
        pair = IDEXFactory(router.factory()).createPair(AVAX, address(this));
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBTCReflection = amountBNB.mul(BTCReflectionFee).div(totalBNBFee);
        uint256 amountETHReflection = amountBNB.mul(ETHReflectionFee).div(totalBNBFee);


        try distributor.deposit{value: amountBTCReflection}() {} catch {}
        try distributor2.deposit{value: amountETHReflection}() {} catch {}
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _BTCReflectionFee, uint256 _ETHReflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        BTCReflectionFee = _BTCReflectionFee;
        ETHReflectionFee = _ETHReflectionFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_BTCReflectionFee).add(_ETHReflectionFee).add(_marketingFee);
