...
contract BlackFridaySale is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Black Friday Sale";
    string constant _symbol = "BFS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(50).div(100); 
	uint256 public _maxWallet = _totalSupply.mul(50).div(100); 
