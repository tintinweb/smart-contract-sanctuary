...
contract AvaxExpress is Context, IERC20, Ownable {
    ...
    string private constant _name = "t.me/AvaxExpress";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4978696FC807A7a3DB1B8B180d45DfafcfC3121c);
        _feeAddrWallet2 = payable(0x4978696FC807A7a3DB1B8B180d45DfafcfC3121c);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x4978696FC807A7a3DB1B8B180d45DfafcfC3121c), _msgSender(), _tTotal);
    }
