...
contract sFrozen is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("staked Frozen", "sFrozen", 9) ERC20Permit() {
    ...
    /**
        @notice increases sFrozen supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sFrozen
