...
contract locker is ERC20("Locked and Staked Pefi", "liPEFI"), Ownable {
    using SafeMath for uint256;
    IERC20 public sushi;
    ...
    function lock() public onlyOwner {
        uint256 _amount = sushi.balanceOf(address(msg.sender));
    ...
    function redeem() public onlyOwner {
        ...
        require(block.timestamp > initialBlock.add(period), "no");
