...
contract StakedBounty is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10000 * 10**9;
    ...
    constructor() ERC20("Staked Bounty", "SBOUNTY", 9) ERC20Permit() {
    ...
    /**
        @notice increases SBOUNTY supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SBOUNTY
