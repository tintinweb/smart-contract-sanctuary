 ...
 *  
*/  
// SPDX-License-Identifier: AGPL-3.0-or-later  ThousandXcoinAvax
...
contract ThousandXCoinAvaxERC20Token is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("ThousandXcoinAvax", "GMI", 9) {
    }
