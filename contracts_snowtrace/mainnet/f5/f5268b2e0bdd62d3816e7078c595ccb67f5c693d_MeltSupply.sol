...
// File: contracts/meltSupply/IERC20.sol
...
// File: contracts/meltSupply/MeltSupply.sol
...
contract MeltSupply is Halt {
        ...
        returns (uint256)
    {
        ...
        uint256 tSupply = IERC20(tokenAddress).totalSupply();
        uint256 decimal = getPriceTokenDecimal(tokenAddress);
        return  tSupply.sub(fixedTotal).div(decimal);
    }
