...
contract Traits2 is Ownable, ITraits {
   ...
   */
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory svgString = string(abi.encodePacked(
                ...
                drawTrait(traitData[0 + shift][s.uniform % traitCountForType[s.uniform]]),
                drawTrait(traitData[1 + shift][s.hair % traitCountForType[s.hair]]),
                drawTrait(traitData[2 + shift][s.facialHair % traitCountForType[s.facialHair]]),
                drawTrait(traitData[3 + shift][s.eyes % traitCountForType[s.eyes]]),
                drawTrait(traitData[4 + shift][s.accessory % traitCountForType[s.accessory]]),
                s.isThief ? drawTrait(traitData[5 + shift][s.headgear % traitCountForType[s.headgear]]) : drawTrait(traitData[5 + shift][s.alphaIndex]),
                !s.isThief ? drawTrait(traitData[6 + shift][s.neckGear % traitCountForType[s.neckGear]]) : ''
            ));
    ...
    function compileAttributes(uint256 tokenId) public view returns (string memory) {
        ...
        if (s.isThief) {
            traits = string(abi.encodePacked(
                    attributeForTypeAndValue(_traitTypes[1], traitData[0][s.uniform % traitCountForType[s.uniform]].name), ',',
                    attributeForTypeAndValue(_traitTypes[2], traitData[1][s.hair % traitCountForType[s.hair]].name), ',',
                    attributeForTypeAndValue(_traitTypes[3], traitData[2][s.facialHair % traitCountForType[s.facialHair]].name), ',',
                    attributeForTypeAndValue(_traitTypes[4], traitData[3][s.eyes % traitCountForType[s.eyes]].name), ',',
                    attributeForTypeAndValue(_traitTypes[6], traitData[4][s.accessory % traitCountForType[s.accessory]].name), ',',
                    attributeForTypeAndValue(_traitTypes[5], traitData[5][s.headgear % traitCountForType[s.headgear]].name), ','
                ));
        } else {
            traits = string(abi.encodePacked(
                    attributeForTypeAndValue(_traitTypes[0], traitData[10][s.uniform % traitCountForType[s.uniform]].name), ',',
                    attributeForTypeAndValue(_traitTypes[2], traitData[11][s.hair % traitCountForType[s.hair]].name), ',',
                    attributeForTypeAndValue(_traitTypes[3], traitData[12][s.facialHair % traitCountForType[s.facialHair]].name), ',',
                    attributeForTypeAndValue(_traitTypes[4], traitData[13][s.eyes % traitCountForType[s.eyes]].name), ',',
                    attributeForTypeAndValue(_traitTypes[6], traitData[14][s.accessory % traitCountForType[s.accessory]].name), ',',
                    attributeForTypeAndValue(_traitTypes[5], traitData[15][s.alphaIndex % traitCountForType[s.alphaIndex]].name), ',',
                    attributeForTypeAndValue(_traitTypes[7], traitData[16][s.neckGear % traitCountForType[s.neckGear]].name), ',',
