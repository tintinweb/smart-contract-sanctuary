...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xC6D893f2a83F7545BF8145D00464bdC3C77fF722); 
...
contract IndoBersatu is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xC6D893f2a83F7545BF8145D00464bdC3C77fF722;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SAFEINDO";
    string constant _symbol = "INDO";
    ...
    uint256 marketingFee = 1600;
    uint256 totalFee = 2800;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0xf8D684ce21e9f1c019Ff59a0e848ac83B9f0Cd78; //liq address
    address public marketingFeeReceiver=0xC6D893f2a83F7545BF8145D00464bdC3C77fF722; // marketing address
