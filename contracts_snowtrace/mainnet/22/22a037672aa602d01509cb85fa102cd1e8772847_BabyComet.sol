...
Hold BabyComet and earn 7% Comet ( New avax node token ) from buy/sell transaction.
...
7% Rewards in Comet
3% Development
Locking liquidity at launch for 3 weeks, extending lock at 100k MC from 3 weeks to 6 weeks.

Telegram - https://t.me/BabyCometAvax
...
contract BabyComet is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x2923E182A6e68C0fE4006736a33B32f805703683; // USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyComet";
    string constant _symbol = "BabyComey";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(30); // 0.55%
	uint256 public _maxWallet = _totalSupply.div(30); // 2,5%
    ...
    address public autoLiquidityReceiver=0xD77d4bDb46637371b8A4d8104f901ce5474b76e1;
    address public marketingFeeReceiver=0xD77d4bDb46637371b8A4d8104f901ce5474b76e1;
