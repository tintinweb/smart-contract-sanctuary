...
/**
WELCOME TO MARCH HARE, FINALLY ON AVALANCHE !!!
...
Join Us: https://t.me/marchhare      

March Hare is a character most famous for appearing in the tea party scene in Lewis Carroll's 1865 book Alice's Adventures in Wonderland.

Hold MarchHare $MHR and earn the highest rewards on Avalanche Blockchain!!! 12% Goes to $TIME Rewards!!

12% OF ALL TRANSACTIONS ARE $TIME Based Rewards Directly to your decentralized crypto wallet!

2% STATE OF THE ART LIQUIDITY AUGMENTATION PROTOCOOL (Cushion for dumpers)

2% DIRECTLY TOWARDS MARKETING

Stake Your Marchhare and EARN $Wonder on our Avalanche DEX/Launchpad & Farming Protocol! (Coming Soon!)

Medium: www.medium.com/marchhareavax
Steemit: www.steemit.com/Marchhareavax
Twitter: www.twitter.com/Marchhareavax


**ULTRA STEALTH LAUNCH TO DETER BOTS**
...
contract Marchhare is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MARCH HARE";
    string constant _symbol = "MRCHHARE";
    ...
    address public marketingFeeReceiver=0x5ead5111A66fE1Efebf2166Dd3918c80961D57D0;
