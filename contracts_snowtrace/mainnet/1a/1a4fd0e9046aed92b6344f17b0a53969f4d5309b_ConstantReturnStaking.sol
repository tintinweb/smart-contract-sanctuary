...
contract ConstantReturnStaking is Ownable {
    ...
    // Uniswap v2 Router
    IUniswapV2Router public uniswapV2Router = IUniswapV2Router(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
    ...
    function doSwap(address fromToken, address toToken, uint fromTokenAmount, uint amountOutMin, uint deadline) 
        ...
        if (fromToken == uniswapV2Router.WAVAX() || toToken == uniswapV2Router.WAVAX()) {
            path = new address[](2);
            path[0] = fromToken;
            path[1] = toToken;
        } else {
