...
contract ChristmasMiracle is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ChristmasMiracle";
    string constant _symbol = "MIRACLE";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(400); // 1%
    uint256 public _maxWallet = _totalSupply.div(200); // 2%
    ...
    address public autoLiquidityReceiver=0xf8ae5393AB0805Db10856bd67531C2b240613ED5;
    address public marketingFeeReceiver=0x89A6B21cFC7262b61Cc8Df6A08ff0ca33c8F156a;
