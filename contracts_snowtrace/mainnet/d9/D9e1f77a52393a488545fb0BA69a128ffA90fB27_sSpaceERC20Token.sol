...
contract sSpaceERC20Token is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 250000000 * 10**9;
    ...
    constructor() ERC20("Staked SPACE", "sSPACE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSPACE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSPACE
