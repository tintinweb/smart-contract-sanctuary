...
contract TravelCoin is IERC20Extended, Auth, BaseToken {
    ...
    string private _name = "Test Don't Buy";
    ...
    constructor(
        ...
        distributor = new DividendDistributor(rewardToken, 0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        // if sender is exempted it means its a buy transaction
        // because the pair is exempted
        if (!shouldTakeFee(sender)) {
            require(amount <= _maxBuyAmount, "TX Limit Exceeded");
        } else {
