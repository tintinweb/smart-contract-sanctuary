...
contract Avaxxinated is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Avaxxinated";
    string constant _symbol = "AVAXX";
    ...
    address public autoLiquidityReceiver=0x8252721814d45638d0a2fe7cFcc9EF0A69FABc7D;
    address public marketingFeeReceiver=0x8252721814d45638d0a2fe7cFcc9EF0A69FABc7D;
