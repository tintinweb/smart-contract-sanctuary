...
Shiba Guard
   ...
   Shiba Guard designed.
    
    I make this #Shiba Guard to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/ShibaGuardAVAX

   Two token features:
   2% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders

   I will Lock liquidity LPs at 3 days the pool and I will extend Lock liquidity LPs if the M.C flies to the moon
   No DEV WALLET
   SAFE CONTRACT

   Tip: Increase the number of slippage in the sale/buy in case of failure.

   
   Initial Liquidity of 2 AVAX
   Can you make #Shiba Guard 100000X? 

   1,000,000,000,000,000 total supply
   10,000,000,000,000 Shiba Guard max limit for per trade ( MAX BUY OF 1% = 0.02 AVAX-It will continue to rise.)
   ...
   it's the best part of the #Shiba Guard idea, increasing the liquidity pool automatically, 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x9E460485De4891D5A37bEB9260f3D8f3FFeD0a4F); // holder will get a valuable reward
...
contract ShibaGuard is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x9E460485De4891D5A37bEB9260f3D8f3FFeD0a4F; // holder get a valuable reward
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Shiba Guard";
    string constant _symbol = "ShibaGuard";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 1%
    uint256 public _maxWallet = _totalSupply.div(1); // NO LIMIT
    ...
    address public autoLiquidityReceiver=0x9E460485De4891D5A37bEB9260f3D8f3FFeD0a4F; //liq address
    address public marketingFeeReceiver=0x9E460485De4891D5A37bEB9260f3D8f3FFeD0a4F; // marketing address
