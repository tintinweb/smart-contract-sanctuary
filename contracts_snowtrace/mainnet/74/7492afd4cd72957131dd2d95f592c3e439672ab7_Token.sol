...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Garfield Mao";
    string private _symbol = "GAO";
    ...
    function _transfer(
        ...
        if(
            ...
            swapAVAXForTokens(buybackLimit.div(10));
        }
    ...
    function swapAVAXForTokens(uint256 amount) private lockTheSwap {
        // generate the uniswap pair path of token -> wavax
        address[] memory path = new address[](2);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 avaxAmount) private lockTheSwap {
