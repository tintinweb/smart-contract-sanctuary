...
contract PangolinSingleProxy is Ownable, ReentrancyGuard {
    ...
    PangolinSinglePool public immutable targetPool;
    ...
    constructor(
        ...
        IERC20 _controller,
        AvaOne _avaone,
        PangolinSinglePool _targetPool,
        ...
        require(address(_depositToken) == address(_rewardToken), "constructor: depositToken needs to be equal as rewardsToken");
    ...
    function deposit() external controllerOnly nonReentrant {
        ...
        uint256 balance = depositToken.balanceOf(address(this)).sub(buybackBalance);
