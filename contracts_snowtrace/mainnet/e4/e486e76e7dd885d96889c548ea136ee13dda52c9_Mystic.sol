...
/*
    ...
    Earn passive income with Mystic nodes.

    Website: https://mystic.financial
    Discord: https://discord.gg/kZwbc4CFbF
    Twitter: https://twitter.com/MysticFinancial
...
contract Mystic is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    ) ERC20("Mystic", "MYSTIC") PaymentSplitter(payees, shares) {
