...
/**
 * @title Juggernaut Token Contract
 * @author 
 *
 * @dev 
 */
contract Juggernaut is ERC20Detailed, ERC20Capped, ERC20Burnable, ERC20Pausable {
    ...
    uint256 public constant CAP_SUPPLY = 45000000 * (10 ** uint256(DECIMALS));

    constructor()  public
        ERC20Detailed(TOKEN_NAME,TOKEN_SYMBOL,DECIMALS)
        ERC20Capped(CAP_SUPPLY)
    {
