...
contract Treasury is Ownable {
    ...
    /**
        @notice allow approved address to deposit an asset for CDAO
        @param _amount uint
    ...
    /**
        @notice allow approved address to burn CDAO for reserves
        @param _amount uint
        @param _token address
     */
    ...
    /**
        @notice allow approved address to repay borrowed reserves with CDAO
        @param _amount uint
     */
    ...
    /**
        @notice returns CDAO valuation of asset
        @param _token address
        @param _amount uint
        @return value_ uint
     */
