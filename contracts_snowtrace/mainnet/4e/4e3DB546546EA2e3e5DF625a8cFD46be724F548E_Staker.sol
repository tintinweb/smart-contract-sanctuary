...
contract Staker is IStaker, AccessControlledAndUpgradeable {
  ...
  bool public constant HAS_LEGACY_DATA = false;
  bool public constant HAS_FLT_ISSUANCE_MULTIPLIER = false;
  bool public constant NFT_DISCOUNTS_ENABLED = false;
  ...
  */
  function _getKValue(uint32 marketIndex) internal view virtual returns (uint256) {
    if (HAS_FLT_ISSUANCE_MULTIPLIER) {
      ...
      // Note: the upgrade function should set this value for each of the markets on upgrade.
