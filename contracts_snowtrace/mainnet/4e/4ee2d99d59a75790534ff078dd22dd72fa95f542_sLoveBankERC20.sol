...
contract sLoveBankERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sLoveBank", "sLOVE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sLove supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sLove
