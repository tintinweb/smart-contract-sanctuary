...
contract DividendDistributor is IDividendDistributor {
    ...
    IARC20 BETH = IARC20(0xb54f16fB19478766A268F172C9480f8da1a7c9C3);
...
contract RedPup is IARC20, Auth {
    using SafeMath for uint256;

    address BETH = 0xb54f16fB19478766A268F172C9480f8da1a7c9C3;
    address WBNB = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Red Pitbull";
    string constant _symbol = "REDPUP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 15000000000 * 3**11 * (10 ** _decimals);
