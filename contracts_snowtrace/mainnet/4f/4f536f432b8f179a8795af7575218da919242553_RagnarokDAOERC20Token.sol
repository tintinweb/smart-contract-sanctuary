 ...
 *  
*/  
// SPDX-License-Identifier: AGPL-3.0-or-later   https://t.me/RagnarokDAO    Dapps and website coming within the hour
...
contract RagnarokDAOERC20Token is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("RagnarokDAO", "RAGD", 9) {
    }
