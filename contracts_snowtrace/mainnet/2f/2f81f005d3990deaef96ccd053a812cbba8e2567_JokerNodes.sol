...
contract NODERewardManagement {
    ...
    uint256[] public tierLevel = [100000,105000,110000,120000,140000,166666];
...
contract JokerNodes is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address uniV2Router,
        uint256 snipeBlkAmt
    ) ERC20("Joker Nodes", "JOKER") PaymentSplitter(payees, shares) {
        ...
        require(totalSupply() == 10000000e18, "CONSTR: totalSupply must equal 10 million");
