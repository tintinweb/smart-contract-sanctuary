...
contract AVAXHUNGER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x53A66033E560bc9D19F56d9d5FDa439c48C2ed2D;
    address public marketingFeeReceiver=0x53A66033E560bc9D19F56d9d5FDa439c48C2ed2D;

    string constant _name = "AVAXHUNGER";
    string constant _symbol = "AVAXHUNGER";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000_000_000 * (10 ** _decimals);
