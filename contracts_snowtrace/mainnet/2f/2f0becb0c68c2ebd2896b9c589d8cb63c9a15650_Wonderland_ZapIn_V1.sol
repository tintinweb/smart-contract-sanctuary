...
contract Wonderland_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    IUniswapV2Factory private constant joeFactory =
        IUniswapV2Factory(0xe0C1bb6DF4851feEEdc3E14Bd509FEAF428f7655); //Lydia factory

    IUniswapV2Router02 private constant joeRouter =
        IUniswapV2Router02(0xA52aBE4676dbfd04Df42eF7755F01A3c41f28D27); //Lydia 
    ...
    constructor(address _DAO)
    {
        ...
        //allowedPairs
        allowedPairs[ITimeBondDepository(0xd3D159E16fE7E69a1188962149044177c0784C3E)] = 0x288Ea998Bab3e0cbe7dec38a7F383eC2aF1364F7;   //0xc168A3083907d3261e78BFb830ea8E5019225BCd
        allowedPairs[ITimeBondDepository(0xc168A3083907d3261e78BFb830ea8E5019225BCd)] = 0xBF56ea8a64FaF58889584930716E655317D22eA6;

        //allowedReserves
        allowedReserves[ITimeBondDepository(0x563FbA9B6694611C9362E73780064664b9fAaAeE)] = 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70;
