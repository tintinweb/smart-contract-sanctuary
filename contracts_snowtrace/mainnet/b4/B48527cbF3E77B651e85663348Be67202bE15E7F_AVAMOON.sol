...
contract AVAMOON is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAMOON";
    string constant _symbol = "AVAMOON";
    ...
    address public autoLiquidityReceiver=0x8F58d6538daC5A2D6FDE6BB4163B855D1037c720;
    address public marketingFeeReceiver=0x3A4815E6928bcB2A3b187FeD69321654Baa7889a;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		isBuy=sender== pair|| sender == routerAddress;
