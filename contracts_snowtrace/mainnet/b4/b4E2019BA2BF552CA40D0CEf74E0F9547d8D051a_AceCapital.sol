...
/**
Welcome to Ace Capital! We are a fork of MCC without the outrageous fees!
*/
...
interface IJoeFactory {
    ...
    contract AceCapital is Context, IERC20, Ownable {
        ...
        string private _name = 'Ace Capital';
        ...
        address payable public _ACEWalletAddress;
        ...
        constructor (address payable ACEWalletAddress, address payable marketingWalletAddress) {
            _ACEWalletAddress = ACEWalletAddress;
        ...
        function sendAVAXToTeam(uint256 amount) private {
            _ACEWalletAddress.transfer(amount.div(2));
        ...
        function _setACEWallet(address payable ACEWalletAddress) external onlyOwner() {
            _ACEWalletAddress = ACEWalletAddress;
        }
