...
// File contracts/BanksyAirdrop.sol
...
contract BanksyAirDrop is Ownable, ReentrancyGuard, IERC721Receiver, ERC721Holder {
    ...
    // NFT
    IERC721Enumerable public banksyNFT = IERC721Enumerable(0x942d791ab07e33Fe4B780Fc0b3874a24Ac3da433); 
    ...
    function claimBanksyAirdrop() external nonReentrant {
        ...
        banksyNFT.safeTransferFrom(address(this), _msgSender(), lastNFTAssigned);
    ...
    function withdrawNFTByIndex(uint256 _index) external onlyOwner {
        balanceOfNFT = banksyNFT.balanceOf(address(this));
        banksyNFT.safeTransferFrom(address(this), _msgSender(), _index);
