...
// v2 with the updated token address
...
//eSTNKe Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract eSTNKe is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'eSTNK.e';
    string private constant _symbol = 'eSTNK.e';
    ...
    //Sellers get locked for MaxSellLockTime so they can't dump repeatedly (we decided to have no Selllock)
    ...
    //The Team Wallet
    address public constant TeamWallet=0xD499FEa6615f9AA16e4041259f929C7983bE8b2c;
    //TODO: Change to Mainnet
    //TestNet
    //address private constant PancakeRouter=;0x2D99ABD9008Dc933ff5c0CD271B88309593aB921    // Pango TESTROUTER
    //MainNet (PANGO router)
    address private constant PancakeRouter=0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106; //  Pangolin Router
    ...
    //Team doesn't have access to critical Functions that could turn this into a Rugpull(Exept liquidity unlocks) LIQ should be burned to make this as safe as possible 
    ...
    constructor () {
       ...
       //Sets sellLockTime to be max by default
        ...
        // TRANFSER TAX TO 0 FOR THE MIGRARTION
        ...
        //10% gets burned
        _burnTax=10;
        //a big percentage gets added to the Contract token to be
        //be converted to LP and MarketingAVAX
        _liquidityTax=50;
        _stakingTax=40;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimeSTNKe(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
        ...
        //Swapping AutoLP and MarketingAVAX is only possible if sender is not pancake pair, 
    ...
    //marketing share starts at 20% the biggest part of the tax should go to liq
    ...
    event OnWithdraweSTNKe(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimeSTNKe(address addr) private{
        ...
        path[0] = _pancakeRouter.WAVAX(); //AVAX
        path[1] = 0x5947BB275c521040051D82396192181b413227A3;  // LINK.e token
        ...
        emit OnWithdraweSTNKe(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function _addLiquidity(uint256 tokenamount, uint256 AVAXamount) private {
        ...
        _pancakeRouter.addLiquidityAVAX{value: AVAXamount}(
            address(this),
            tokenamount,
            0,
            0,
    ...
    function eSTNKeWithdraw() public{
        claimeSTNKe(msg.sender);
    }
    ...
    function TeamWithdrawMarketingAVAX(uint256 amount) public onlyTeam{
    ...
    function TeamCreateLPandAVAX() public onlyTeam{
    _swapContractToken();
    }
    ...
    function TeamRemoveRemainingAVAX() public onlyTeam{
