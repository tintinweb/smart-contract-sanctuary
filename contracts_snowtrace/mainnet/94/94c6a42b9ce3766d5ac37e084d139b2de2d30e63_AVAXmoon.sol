...
/**
 ...
 $AVAXm Stealth Launch 
 TG = http://t.me/MoonAvax12
...
contract  AVAXmoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8AFeBeE746790f1dE6d0096b574d3A3E376bf84d); // Marketing Address
    ...
    string private _name = "Moon AVAX";
    string private _symbol = "mAVAX";
  ...
  //  uint256 private _previousLiquidityFee = _liquidityFee;
    ...
    uint256 public maxWalletToken = 15000000000 * (10**9);

    IJoeRouter02 public immutable joeV2Router;
    address public immutable joeV2Pair;
    ...
    constructor () {
        ...
        IJoeRouter02 _joeV2Router = IJoeRouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
       address lpPair =  IJoeFactory(_joeV2Router.factory())
    ...
    function AntiWhale(address pair, bool value) external onlyOwner {
        lpPairs[pair] = value;
    }
    
    function updateBuyTax(uint256 buytaxfee, uint256 buyliquidityFee) external onlyOwner {  
     _buytaxFee = buytaxfee;
     _buyliquidityFee = buyliquidityFee; 
    }

     function updateSellTax( uint256 selltaxfee, uint256 sellliquidityFee) external onlyOwner {
     _selltaxFee = selltaxfee;
     _sellliquidityFee = sellliquidityFee;
    }
    
    function updateTransferTax(uint256 transfertaxFee, uint256 transferliquidityFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == joeV2Pair) {
    ...
    function swapETHForTokens(uint256 amount) private {
      ...
      // make the swap
        joeV2Router.swapExactAVAXForTokensSupportingFeeOnTransferTokens{value: amount}(
  ...
  /*  function removeAllFee() private {
    ...
    function SetTxLimit(bool _enabled) public onlyOwner {
