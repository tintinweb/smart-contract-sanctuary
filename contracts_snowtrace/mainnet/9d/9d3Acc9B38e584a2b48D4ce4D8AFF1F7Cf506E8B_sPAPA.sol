...
contract sPAPA is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sPAPA", "sPAPA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPAPA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPAPA
