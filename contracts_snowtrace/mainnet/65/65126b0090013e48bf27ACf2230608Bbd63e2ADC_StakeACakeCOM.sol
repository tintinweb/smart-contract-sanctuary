...
contract StakeACakeCOM is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("StakeACake", "StakeACakeDotCom", 9) {
      address teamWallet = 0xE330E49C64C09B7e4239b8F828da85E670B9b269;
      _mint(teamWallet, 50000e9);
    }
