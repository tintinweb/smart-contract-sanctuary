...
contract GameIncentives is Ownable {
    using SafeERC20 for IERC20;

    IERC20 public token;

    uint256 public constant totalAllocation = 190e6 * 1e18;
    uint256 public remainingAmount = 190e6 * 1e18;
    ...
    function unlock() external onlyOwner {
        require(nextTimeRelease == 0, "Already unlocked");
        nextTimeRelease = block.timestamp;
        lastTimeRelease = block.timestamp + (10*30 days);
    }
