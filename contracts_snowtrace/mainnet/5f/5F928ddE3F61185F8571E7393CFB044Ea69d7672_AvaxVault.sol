...
contract AvaxVault is Context, IERC20, Ownable {
    ...
    string private constant _name = "t.me/AvaxVault";
    string private constant _symbol = "AVLT";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xa4e4c05EED9843461288A95A45645325Cb40ade5);
        _feeAddrWallet2 = payable(0xa4e4c05EED9843461288A95A45645325Cb40ade5);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xa4e4c05EED9843461288A95A45645325Cb40ade5), _msgSender(), _tTotal);
    }
