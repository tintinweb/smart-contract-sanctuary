...
contract Slot is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 SLOTs
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("Snowtomb Lot", "SLOT") {
