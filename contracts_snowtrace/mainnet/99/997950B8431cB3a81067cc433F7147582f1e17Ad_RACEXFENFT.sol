...
// File: contracts/ERC2981RaceXFERoyalties.sol
...
abstract contract ERC2981RaceXFERoyalties is ERC165, IERC2981Royalties {
...
contract RACEXFENFT is ERC721Enumerable, ERC2981RaceXFERoyalties, IRACEXFENFT, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxDevSupply = 3000;
  ...
  function tokenMinter(uint256 tokenId) public view returns(address){
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721Enumerable, ERC2981RaceXFERoyalties)
        returns (bool)
    {
        return
            ERC721.supportsInterface(interfaceId) ||
            ERC2981RaceXFERoyalties.supportsInterface(interfaceId);
    }
