...
contract StratManager is Ownable, Pausable {
    ...
    address public unirouter = address(0xA52aBE4676dbfd04Df42eF7755F01A3c41f28D27);
...
contract PLTStrategyMasterChefLP is StratManager {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    address public wrapped = address(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    address public output = address(0x4C9B4E1AC6F24CdE3660D5E4Ef1eBF77C710C084);
    address public want;
    ...
    address public masterchef = address(0xFb26525B14048B7BB1F3794F6129176195Db7766);
    ...
    constructor(
        ...
        PLTVault _vault = new PLTVault(IStrategy(address(this)),name);
