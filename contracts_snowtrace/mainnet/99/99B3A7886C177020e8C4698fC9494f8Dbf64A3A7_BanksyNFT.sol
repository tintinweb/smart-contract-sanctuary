...
// File @openzeppelin/contracts/token/ERC721/ERC72[email protected]
...
contract BanksyNFT is ERC721Presets {
    ...
    function setExperience(uint256 tokenId, uint256 _newExperience) onlyRole(OPERATOR_ROLE) external {
        artWorks[tokenId].experience = _newExperience;
    }

    function setPower(uint256 tokenId, uint256 _power) onlyRole(OPERATOR_ROLE) external {
        artWorks[tokenId].power = _power;
    }
