...
// PonziTether rewards holders with 15% reflections in Tether ( $USDT.e )
// Tether Address : 0xde3A24028580884448a5397872046a019649b084
// ----------------------------------------------------------
// Join our Telegram : https://t.me/ponzitetheravax
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 tether = IBEP20(0xde3A24028580884448a5397872046a019649b084);
...
contract PonziTether is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address tether = 0xde3A24028580884448a5397872046a019649b084; // tether address on avax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PonziTether";
    ...
    uint256 marketingAndDevFee = 500; 
    uint256 totalFee = 2000;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0xcF1c7C161Ed54FD410bC43Fa63F379A807796740;
    address public marketingAndDevReceiver=0x3B3C06439902194E310c3f70A89815D4627CBd93;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountAVAXMarketingAndDev = amountAVAX.mul(marketingAndDevFee).div(totalAVAXFee);

        try distributor.deposit{value: amountAVAXReflection}() {} catch {}
        payable(marketingAndDevReceiver).transfer(amountAVAXMarketingAndDev);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingAndDevFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        marketingAndDevFee = _marketingAndDevFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_marketingAndDevFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/4);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingAndDevFeeReceiver) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingAndDevReceiver = _marketingAndDevFeeReceiver;
    }
