...
contract CryptoInvestCapital is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Crypto Invest Capital";
    string private constant _symbol = "CIC";
    ...
    address payable public _nfcAddress = payable(0x569310751CD52736AfB9312fce5Ab93F187d7519); //Investment wallet
    address payable public _mktgAddress = payable(0xCf6A1781d6f244A135B7534E585253C05bE73a73); //Marketing wallet
