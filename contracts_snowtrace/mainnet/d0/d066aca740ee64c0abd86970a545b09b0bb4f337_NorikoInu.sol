...
contract NorikoInu is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Noriko Inu", "DARKNESS") ERC20Permit("Noriko Inu") {
        _mint(msg.sender, 666000 * 10 ** decimals());
    }
