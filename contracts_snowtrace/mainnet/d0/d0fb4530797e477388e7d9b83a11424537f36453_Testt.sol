...
contract Testt is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver=0x4666E1E7Ed8e2C3B6DdaCC1DaB4AD98cB00aF55a;
    address public marketingFeeReceiver=0x3150FaabE0E2b7a576F44d488347a2fEC37187cD;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = tokensToSell.mul(dynamicLiquidityFee).div(totalFee).div(2);
    ...
    function setSwapBackSettings(bool _enabled, uint256 _percentage_min_base1000, uint256 _percentage_max_base1000) external authorized {
        swapEnabled = _enabled;
        swapThreshold = _totalSupply / (1000) * (_percentage_min_base1000);
        maxSwapSize = _totalSupply / (1000) * (_percentage_max_base1000);
    }
