...
/**
 *MARSINU  are a brand new NFT on the Avalaunch blockchain that offer a combined experience of fun, cute collectibles.
MARSINU are procedurally generated (and random) MARSINU Buddies that contain a large number of different attributes and traits that make each Voxie unique and fun to collect.

Tokenomics :
 Total Supply: 1000,000,000 $POSTA
 Add Liquidity :       95%
 Marketing:               4%
 Team & Advisors:  1%

What is the buy and sell tax? :
 6 % total tax for buying/selling:
 3 % goes into marketing
 1 % goes into liquidity 
 2 % goes into team wallet
...
contract MARSINU is Context, IERC20 {
