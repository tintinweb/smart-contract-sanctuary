...
contract sTYY is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10000000000 * 10**9; // 10b initial supply
    ...
    constructor() ERC20("Staked Treasury Coin", "sTYY", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTYY supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTYY
