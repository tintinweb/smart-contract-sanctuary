...
contract LittleCheems is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x639E724eb017f0c920f1D6816e578B2a535CD92d; // Cheems
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x72710580541B7A3B4e5a5Ea89444234dEF9289eE;
    address public marketingFeeReceiver=0x72710580541B7A3B4e5a5Ea89444234dEF9289eE;

    string constant _name = "LittleCheems";
