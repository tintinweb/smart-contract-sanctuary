...
contract DARK is ERC20Permit, Ownable {
    ...
    constructor() ERC20("DARK", "DARK", 9) ERC20Permit() {
    ...
    /**
        @notice increases DARK supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess DARK
