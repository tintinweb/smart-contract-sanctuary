...
contract BUSDxAVA is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98; // BUSD.e
    ...
    string constant _name = "BUSDxAVA";
    string constant _symbol = "BxA";
