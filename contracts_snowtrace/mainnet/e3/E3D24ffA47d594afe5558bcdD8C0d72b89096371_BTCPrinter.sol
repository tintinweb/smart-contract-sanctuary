...
// Dependency file: contracts/baby/BTCPRINTERDividendTracker.sol
...
contract BTCPRINTERDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BTCPRINTER contract."
        );
    }
...
// Root file: contracts/baby/BTCPRINTER.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/BTCPRINTERDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract BTCPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    BTCPRINTERDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = BTCPRINTERDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "BTCPRINTER: The dividend tracker already has that address"
        );

        BTCPRINTERDividendTracker newDividendTracker = BTCPRINTERDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "BTCPRINTER: The new dividend tracker must be owned by the BTCPRINTER token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "BTCPRINTER: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BTCPRINTER: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "BTCPRINTER: The PanBTCSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "BTCPRINTER: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "BTCPRINTER: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "BTCPRINTER: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialBTCBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );
