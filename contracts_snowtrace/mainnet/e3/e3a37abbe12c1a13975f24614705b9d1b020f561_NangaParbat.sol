...
contract NangaParbat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nanga Parbat";
    string private constant _symbol = "Nanga";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x6A07B9b2f3B403A76F9B40480267750030034567);
        _feeAddrWallet2 = payable(0x6A07B9b2f3B403A76F9B40480267750030034567);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xc3Ca116ac88309Dd6235dAafDA6EFD2A0033F87F), _msgSender(), _tTotal);
    }
