...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // reward address WAVAX
...
contract BabyAvax is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // reward WAVAX
    address public MIM = 0x130966628846BFd36ff31a822705796e8cb8C18D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Baby Avax";
    string constant _symbol = "BAVAX";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_500_000_000 * (10 ** _decimals);
    ...
    address public autoLiquidityReceiver=0xE5Df347c73037f25b368bC87BB0A62b8DB10a6cF; //liq address
    address public marketingFeeReceiver=0xE5Df347c73037f25b368bC87BB0A62b8DB10a6cF; // marketing address
    ...
    constructor () Auth(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(MIM, address(this));
