...
contract Safe is Context, IERC20, Ownable {
    ...
    string private _name = "99";
    string private _symbol = "99";
    
    uint256 public _reflectFee = 500; // All taxes are divided by 100 for more accuracy.
    ...
    uint256 private maxLiquidityFee = 200;

    uint256 public _marketingFee = 900; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private maxMarketingFee = 1800;
    ...
    address payable private _marketingWallet = payable(0xbEC8699b193258a010C26DD230959a6C203B0e09);
    ...
    uint256 private maxTxDivisor = 10;
