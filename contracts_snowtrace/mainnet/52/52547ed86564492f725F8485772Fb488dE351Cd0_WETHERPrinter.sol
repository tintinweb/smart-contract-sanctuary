...
// Dependency file: contracts/baby/WETHERPrinterDividendTracker.sol
...
contract WETHERPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
// Root file: contracts/baby/WETHERPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/WETHERPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract WETHERPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    WETHERPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = WETHERPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        WETHERPrinterDividendTracker newDividendTracker = WETHERPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "WETHERPrinter: The new dividend tracker must be owned by the WETHERPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "WETHERPrinter: The router already has that address"
        );
