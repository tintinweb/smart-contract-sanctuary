 ...
 */
contract FractBankerJoeUSDCStrategyTestV2 is FractStrategyV2 {
    ...
    function _deposit(address account, uint256 amount) private onlyAllowedDeposits {
        require(DEPOSITS_ENABLED == true, "FractJoeLendingStrategyV1::_deposit");
        ...
        require(
            ...
            "FractJoeLendingStrategyV1::transfer failed"
        );
    ...
    function withdraw(uint256 amount) external override {
        ...
        require(depositTokenAmount >= minMinting, "FractJoeLendingStrategyV1:: below minimum withdraw");
    ...
    function _withdrawDepositTokens(uint256 amount) private {
        ...
        require(
            ...
            "FractJoeLendingStrategyV1::redeem failed"
        );
        uint256 balance = tokenDelegator.balanceOfUnderlying(address(this));
        uint256 borrow = tokenDelegator.borrowBalanceCurrent(address(this));
        if (balance > 0) {
    ...
    function reinvest() external override onlyEOA {
        ...
        require(
            ...
            "FractJoeLendingStrategyV1::reinvest"
        );
        _reinvest(joeRewards, avaxBalance, amountToReinvest);
        claimAVAXRewards();
    }
    ...
    receive() external payable {
        require(
            ...
            "FractJoeLendingStrategyV1::payments not allowed"
        );
    }
    ...
    function _rollupDebt(uint256 principal, uint256 borrowed) internal {
        ...
        while (supplied < lendTarget) {
            ...
            require(
                ...
                "FractJoeLendingStrategyV1::borrowing failed"
            );
            require(
                tokenDelegator.mint(toBorrowAmount) == 0,
                "FractJoeLendingStrategyV1::lending failed"
            );
    ...
    function _unrollDebt(uint256 amountToFreeUp) internal {
        ...
        while (toRepay > 0) {
            ...
            require(
                ...
                "FractJoeLendingStrategyV1::failed to redeem"
            );
            require(
                tokenDelegator.repayBorrow(unrollAmount) == 0,
                "FractJoeLendingStrategyV1::failed to repay borrow"
            );
    ...
    function _stakeDepositTokens(uint256 amount) private {
        require(amount > 0, "FractJoeLendingStrategyV1::_stakeDepositTokens");
        require(
            tokenDelegator.mint(amount) == 0,
            "FractJoeLendingStrategyV1::Deposit failed"
        );
        uint256 borrowed = tokenDelegator.borrowBalanceCurrent(address(this));
    ...
    function _safeTransfer(
        ...
        require(
            ...
            "FractJoeLendingStrategyV1::TRANSFER_FROM_FAILED"
        );
    }
        ...
        onlyOwner
    {
        ...
        require(
            ...
            "FractJoeLendingStrategyV1::rescueDeployedFunds"
        );
        emit Reinvest(totalDeposits(), totalSupply);
