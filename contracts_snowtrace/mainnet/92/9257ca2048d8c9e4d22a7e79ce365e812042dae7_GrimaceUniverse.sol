...
/**
 *  telegram : https://t.me/GrimaceUniverse
*/  

// SPDX-License-Identifier: MIT   website : after launch big influencers are joining soon!!
...
contract GrimaceUniverse is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x0755FA2F4AA6311E1D7C19990416c86F17D16F86; // $DIGIUNI/$UNI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GrimaceUniverse";
    string constant _symbol = "GRIME";
