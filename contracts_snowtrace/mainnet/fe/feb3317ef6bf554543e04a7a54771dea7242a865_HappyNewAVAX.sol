...
/**
    ...
    https://t.me/happynewyearavax
    Celebrate New Year with AVAX!
    3% redistribution in $HAPPY
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa634f4B6d00FF4D1C3DD24a24C9f24000B143B71;
...
contract HappyNewAVAX is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xa634f4B6d00FF4D1C3DD24a24C9f24000B143B71;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HappyNewAVAX";
