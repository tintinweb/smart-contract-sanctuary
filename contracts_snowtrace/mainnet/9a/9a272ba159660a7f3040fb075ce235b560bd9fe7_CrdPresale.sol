...
contract CrdPresale is Owned {
    ...
    uint256 public totalMIMLimit = 320000000000000000000000;
    ...
    mapping(address => uint256) public _paidTotal;
    ...
    function buy(uint256 paidAmount) public {
        ...
        uint tokenAmount = paidAmount.mul(10**tokenPriceDecimal).mul(10**9).div(10**18).div(tokenPrice);
