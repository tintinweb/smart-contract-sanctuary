...
Cross investement: $CI
-You buy on Avalanche, we farm on multiple chains and return the profits to $CCC holders. A Dashboard will be provided to track the progress of the investments and profits
...
contract CrossInvestement is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CrossInvestement";
    string private constant _symbol = unicode"CI";
