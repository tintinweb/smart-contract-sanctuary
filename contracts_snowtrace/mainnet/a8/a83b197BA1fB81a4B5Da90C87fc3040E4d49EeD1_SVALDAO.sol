...
contract SVALDAO is ERC20Permit, Ownable {
    ...
    constructor() ERC20("SVALDAO", "sVALDO", 9) ERC20Permit() {
    ...
    /**
        @notice increases SVALDAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SVALDAO
