...
contract TEST is IBEP20, Ownable {
    ...
    // Fee Receiver
    address private marketingFeeReceiver = 0x6582faA48a903D7DDDA28b10B799612034280354;
    address private teamFeeReceiver = 0x0a44f6E43Cce4e5ABc95793bC1121b2B3910898f;
    address private donationFeeReceiver = 0xE3581D1502e311EccC1CD805fE8bf954dEc2A6Bc;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (recipient != pair &&
            recipient != owner) {
            require(amount <= _maxTX, "Transfer amount exceeds the bag size.");
        }
    ...
    function checkTXLimit() private {
        ...
        if (time_since_launch > 1 hours) { _maxTX = 50000;}
    }
