...
contract SafeAloneAVAX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe46575C94a0a443B088983c57247F4cEd1095F8e);
    ...
    string private _name = "SafeAloneAVAX";
