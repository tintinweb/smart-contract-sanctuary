...
contract TESTp is IBEP20, Auth { // update
    ...
    bool gasLimit = false;
    uint256 private gasPriceLimit = 10000000000; // 10 nAvax update
    ...
    uint256 liquidityFee = 700; // update
    uint256 buybackFee = 0; // update
    uint256 reflectionFee = 800; // update
    uint256 marketingFee = 300; // update
    uint256 totalFee = 1800; // update
