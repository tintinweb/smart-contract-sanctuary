...
// SPDX-License-Identifier: MIT   TG : https://t.me/DigitalUNIVERSE5

// DigitalUNIVERSE will be live soon!! DigitalUNIVERSE is a project   
// about making the whole world digital not everyone has a computer or a phone or other 
// digital stuff  we want to change that on top of that this token gives 10% reflections every hour
...
contract DigitalUNIVERSE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DigitalUNIVERSE";
    string constant _symbol = "DIGIUNI";
