...
/**
 *  
MIM is big now did you miss MIM ? no problem earn MIM by holding this coin !! stealthlaunching soon!!  
TG : https://t.me/TIMEMIMPRINTER
*/
...
contract TIMEMIMPrinterERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("TIMEMIMPrinter", "TMP", 9) {
    }
