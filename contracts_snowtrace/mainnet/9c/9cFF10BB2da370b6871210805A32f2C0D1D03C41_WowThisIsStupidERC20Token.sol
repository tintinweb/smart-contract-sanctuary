...
contract WowThisIsStupidERC20Token is ERC20Permit, VaultOwned {
    // Creating a fake token to withdraw out of the treasury. Why create stupid limits if you can just bypass them.
    using SafeMath for uint256;

    constructor() ERC20("wts", "WTS", 9) {
    }
