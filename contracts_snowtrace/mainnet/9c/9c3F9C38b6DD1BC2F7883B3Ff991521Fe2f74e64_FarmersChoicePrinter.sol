...
// Dependency file: contracts/baby/FarmersChoicePrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeFarmTokenDividends(uint256 amount) public onlyOwner {
...
contract FarmersChoicePrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FarmersChoicePrinter contract."
        );
    }
...
// Root file: contracts/baby/FarmersChoicePrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/FarmersChoicePrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract FarmersChoicePrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    FarmersChoicePrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = FarmersChoicePrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "FarmersChoicePrinter: The dividend tracker already has that address"
        );

        FarmersChoicePrinterDividendTracker newDividendTracker = FarmersChoicePrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "FarmersChoicePrinter: The new dividend tracker must be owned by the FarmersChoicePrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "FarmersChoicePrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "FarmersChoicePrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "FarmersChoicePrinter: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "FarmersChoicePrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "FarmersChoicePrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "FarmersChoicePrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialFarmTokenBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForFarmToken(tokens);
        uint256 newBalance = (IERC20(rewardToken).balanceOf(address(this))).sub(
            initialFarmTokenBalance
        );
    ...
    function swapTokensForFarmToken(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeFarmTokenDividends(dividends);
