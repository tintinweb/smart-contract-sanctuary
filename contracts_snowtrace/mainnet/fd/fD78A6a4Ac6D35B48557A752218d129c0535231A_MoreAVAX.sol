...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TIME = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TIME.balanceOf(address(this));
        ...
        uint256 amount = TIME.balanceOf(address(this)).sub(balanceBefore);
...
contract MoreAVAX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address TIME = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // TIME
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MoreAVAX";
    string constant _symbol = "MAVAX";
    ...
    address public autoLiquidityReceiver=0xea1D9B8A4dDB269cbe448016dDDc05b994FF273F;
    address public marketingFeeReceiver=0xea1D9B8A4dDB269cbe448016dDDc05b994FF273F;
