...
contract fTEST is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FTESTING";
    string constant _symbol = "fTEST";
    ...
    address public marketingFeeReceiver=0x384C3A4774ccb5047ef44d62F86A94a3807f61e5;
    address royaltyFeeReceiver=0x08471b634945C64AD07f6de5fC671b970441f579;
    ...
    constructor (
        address _dexRouter, address _marketingAddress, address _wAVAX, address _distributor
    ) Auth(msg.sender) {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountAVAXRoyalty = amountAVAX.mul(royaltyFee).div(totalAVAXFee);

        try distributor.deposit{value: amountAVAXReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountAVAXMarketing);
        payable(royaltyFeeReceiver).transfer(amountAVAXRoyalty);
