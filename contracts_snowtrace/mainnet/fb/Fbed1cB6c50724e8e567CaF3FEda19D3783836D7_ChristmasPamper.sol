...
contract ChristmasPamper is Context, IERC20, Ownable {
    ...
    string private constant _name = "ChristmasPamper";
    string private constant _symbol = "CPAMP";
    ...
    constructor () {
        ...
        emit Transfer(address(0x60aE616a2155Ee3d9A68541Ba4544862310933d4), _msgSender(), _tTotal);
    }
