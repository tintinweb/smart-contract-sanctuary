...
//  Stealth Launched
//  https://t.me/AbominableAvaxOfficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // WAVAX
...
contract Abominable is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Abominable";
    string constant _symbol = "ABOM";
    ...
    address public autoLiquidityReceiver=0xD6B61b8C2cf2866CD36155f354070D7b16bdEbf1;
    address public marketingFeeReceiver=0xD6B61b8C2cf2866CD36155f354070D7b16bdEbf1;
