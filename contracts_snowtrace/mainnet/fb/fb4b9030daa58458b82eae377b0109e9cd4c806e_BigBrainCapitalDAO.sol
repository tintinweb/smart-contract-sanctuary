...
contract BigBrainCapitalDAO is IBEP20, Auth {
    ...
    address payable public marketingWallet = payable(0x669ff81c6b2067F86A15AD63C4a11D2B0E839FB9);
    address payable public treasury = payable(0x669ff81c6b2067F86A15AD63C4a11D2B0E839FB9);
    ...
    function manualSend() external onlyOwner {
        uint256 contractWAVAXBalance = address(this).balance;
        payable(marketingWallet).transfer(contractWAVAXBalance);
    }
