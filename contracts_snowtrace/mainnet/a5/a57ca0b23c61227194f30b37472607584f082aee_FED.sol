...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x130966628846BFd36ff31a822705796e8cb8C18D); // MIM
...
contract FED is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x130966628846BFd36ff31a822705796e8cb8C18D; // MIM
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Fed Avax";
    string constant _symbol = "FED";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(250); // 0.4%
    ...
    address public autoLiquidityReceiver=0xd0457Ec610AE9481B6512BB87125A6D1369921B3;
    address public marketingFeeReceiver=0xd0457Ec610AE9481B6512BB87125A6D1369921B3;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Already launched Son");
