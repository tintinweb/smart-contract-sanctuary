...
// Get reward in USDC token with USDCPRINT

// TG https://t.me/USDCPrint
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xd1c3f94DE7e5B45fa4eDBBA472491a9f4B166FC4);
...
contract USDCPrint is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // MIM
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x10260b28a6E0871B1B5E500b1438aBbC70e0c77c;
    address public marketingFeeReceiver=0xc1FCBc4533f3C5982Aff1F4C751271797922673C;

    string constant _name = "USDCPrint";
    string constant _symbol = "USDCP";
