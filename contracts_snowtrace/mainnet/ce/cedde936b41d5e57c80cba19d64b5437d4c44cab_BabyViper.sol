...
// DividendDistributor separate contract
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
...
// coin contract
contract BabyViper is IBEP20, Auth {
    using SafeMath for uint256;

    // uint256 public constant MASK = type(uint128).max;
     address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address public constFeeReceiver=0x57204EccAe49fe0FA3afD1d13Cfa293de10bE537;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    // address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public constRouter = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4;

    string constant _name = "T34U";
    string constant _symbol = "T34U";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10**6 * 10**9 * 10 ** _decimals;
    ...
    uint256 public reflectionFee = 500;  //5 %
    uint256 public marketingFee = 500;   //5%
    uint256 totalFee = liquidityFee+ reflectionFee + marketingFee;  // 1200;  // 12%
    uint256 feeDenominator = 10000;


    address public autoLiquidityReceiver;
    address public marketingFeeReceiver=constFeeReceiver;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = constRouter;      // 0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
