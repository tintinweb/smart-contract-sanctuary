...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc16A1b60175d16be6F2ED0bA506ca0e6EfBA8e08);
...
contract PXNodes is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc16A1b60175d16be6F2ED0bA506ca0e6EfBA8e08; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PXNodes";
    string constant _symbol = "PXT";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // 2,5%
    ...
    address public autoLiquidityReceiver=0x863541834767407A30f85e368daD46146ebD9dB2;
    address public marketingFeeReceiver=0x863541834767407A30f85e368daD46146ebD9dB2;
