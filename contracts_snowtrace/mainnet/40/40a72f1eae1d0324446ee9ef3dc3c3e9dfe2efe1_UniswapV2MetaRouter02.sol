...
contract UniswapV2MetaRouter02 is Ownable {
    ...
    function addLiquidity(
        ...
        amountA = withdrawFromBank(tokenA, bankTokenA);
        amountB = withdrawFromBank(tokenB, bankTokenB);
    ...
    function swapExactTokensForTokens(
        ...
        amounts = IUniswapV2Router02(router).swapExactTokensForTokens(amountIn, amountOutMin, newPath, address(this), deadline);
