...
// StableCoins are pegged to either physical or virtual assets.
// Our StableCoin code is based on the PAXOS StableCoin Standard.
// To know more about our StableCoin's underlying assets/ treasury/ governance mechanism/ etc. visit our website/ blog/ social media channels.
...
contract ST_Stable_Coin is Ownable, IST20, TokenGenerator {
    ...
    constructor (string memory name, string memory symbol, uint256 decimals, uint256 supply, address payable feeReceiver) TokenGenerator(feeReceiver, "ST_Stable_Coin") payable public {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
        _totalSupply = supply;
