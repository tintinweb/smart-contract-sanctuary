...
contract LootFish is ERC721Enumerable, ReentrancyGuard, Ownable {
    //insert stuff here
    ...
    uint public chestLoot = 5000000000000000000 wei; //5 AVAX
    uint public claimPrice = 1000000000000000000 wei;

    address public LFSToken = address(0);
    ...
    string base_uri = "https://www.lootfish.co/fish/";
    ...
    function burn(uint256 tokenId) public virtual {
        ...
        if (tokenId % 50==0){
            ...
            MyToken(LFSToken).mint(_msgSender(), 5000000000000000000);
        }
    }
   ...
   function getBalance() external view returns(uint){
    ...
    constructor() ERC721("LootFish", "LOOTFISH") Ownable() {}
}
