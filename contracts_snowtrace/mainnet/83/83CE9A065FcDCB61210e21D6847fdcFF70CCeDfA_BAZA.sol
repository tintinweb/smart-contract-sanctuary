...
contract BAZA is Context, IERC20, Ownable {
    ...
    string private _name = "BAZA";
    string private _symbol = "BAZA";
    ...
    uint256 private _maxTxAmount = 1_0000_000_000_000_000_000_00 * 10**6;
    ...
    function _setBuyBackWallet(address payable buyBackWallet)
        external
        onlyOwner
    {
        _buyBackWallet = buyBackWallet;
