...
contract BuybackBabyToken is IERC20Extended, Auth, BaseToken {
    ...
    constructor() payable Auth(msg.sender) {
        ...
        _symbol = "DNI";
        _totalSupply = 777777777777777 * 10**9;
    ...
    function _transferFrom(
        ...
        if (shouldTakeFee(recipient) || shouldTakeFee(sender)) {
            require(balanceOf(recipient) + amount <= maxWalletSize, "Max holding cap breached.");
            require(amount <= maxTxSize, "Max transaction limit reached.");
        }
