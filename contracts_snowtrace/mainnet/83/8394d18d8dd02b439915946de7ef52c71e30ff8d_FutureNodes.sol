...
/**
    Create your own nodes and earn passive income forever

    Stealth Launch at traderjoe

    Join telegram: https://t.me/FutureNodes
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x66D8D6DbF95Fc831a1701Cd84036123a9A505D67;
...
contract FutureNodes is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x66D8D6DbF95Fc831a1701Cd84036123a9A505D67;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FutureNodes";
    string private _symbol = "FutureNodes";
    ...
    function createNodes(address account) public onlyOwner() {
    ...
    function createNodesWithTokens(address account) external onlyOwner() {
