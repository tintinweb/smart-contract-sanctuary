...
interface ITreasury {
    ...
    function getCitrusPrice() external view returns (uint256);
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getCitrusPrice() external view returns (uint256) {
        return treasury.getCitrusPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            citrus.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        citrus.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(citrus), "citrus");
