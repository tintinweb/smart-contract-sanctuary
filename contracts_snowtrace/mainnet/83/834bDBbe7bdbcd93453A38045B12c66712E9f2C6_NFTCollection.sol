...
contract NFTCollection is ERC721, Ownable {
    ...
    uint public constant price = 0.5 ether; //0.5 avax
    bool public hasSaleStarted = false;
    
    string public NFT_HASH = "";
   ...
   function claimNFT(uint256 amount) public payable {
        require(totalSupply() < MAX_SUPPLY, "Sale has already ended");
        require(amount > 0 && amount <= 20, "You can claim minimum 1, maximum 20 NFTs");
        require(totalSupply().add(amount) <= MAX_SUPPLY, "Exceeds MAX_SUPPLY");
        require(msg.value >= calculatePrice().mul(amount), "Ether value sent is below the price");
    ...
    function setNFTHash(string memory _hash) public onlyOwner {
        NFT_HASH = _hash;
    }
