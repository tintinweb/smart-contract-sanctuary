...
10% goes to reflection (BTC)
0% for marketing
12% total tax for buys and sells
Want to join our Telegram? Fine ! You just need to read the contract, the telegram is somewhere...
*/
...
contract ETHPrinterv1 is IBEP20, Auth {
    using SafeMath for uint256;
