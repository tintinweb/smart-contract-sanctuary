...
// $LOSERCOIN (Coins are just a fantasy,I'm not sure they can be money)
//Is it true that coins can make you rich?
// Explain To me : @losercoindontreal
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xFB9f0F5Ebb1A03E2081B427e33CB78B6bd36015D); // holder will get a valuable reward
...
contract LOSERCOIN is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xFB9f0F5Ebb1A03E2081B427e33CB78B6bd36015D; // holder get a valuable reward
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Loser Coin";
    string constant _symbol = "LoserCoin";
    ...
    address public autoLiquidityReceiver=0xFB9f0F5Ebb1A03E2081B427e33CB78B6bd36015D; //liq address
    address public marketingFeeReceiver=0xFB9f0F5Ebb1A03E2081B427e33CB78B6bd36015D; // marketing address
