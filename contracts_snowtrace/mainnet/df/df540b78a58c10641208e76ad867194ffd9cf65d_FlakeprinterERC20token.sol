...
contract FlakeprinterERC20token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("FlakePrinter", "FP", 9) {
    }

    function sweep(address account_, uint256 amount_) external onlyVault() {
