...
/**
    SnowBull fairlaunch with 20 avax initial liquidity

    0% tax

    Stealth Launch at traderjoe

    Join telegram: https://t.me/SnowBullAva

    Marketing at twitter, 4Chan and reddit.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x69725cd38F9A5031bC7Af77620c20648E8E5a297;
...
contract SnowBull is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x69725cd38F9A5031bC7Af77620c20648E8E5a297;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SnowBull";
    string private _symbol = "SnowBull";
