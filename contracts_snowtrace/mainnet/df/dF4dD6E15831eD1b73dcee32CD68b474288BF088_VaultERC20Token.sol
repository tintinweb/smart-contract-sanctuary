...
abstract contract ERC20 is IERC20 {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    uint256 amount1 = amount/100;
    uint256 amountSend = amount1*(96);
    uint256 amountBurn = amount1*(4);
    _transfer(msg.sender, recipient, amountSend);
    _transfer(msg.sender, 0x0000000000000000000000000000000000000000, amountBurn);
    return true;
  }
...
contract VaultERC20Token is ERC20Permit, VaultOwned {

    using LowGasSafeMath for uint256;

    constructor() ERC20("VaultDao", "VDAO", 9) {
    }
