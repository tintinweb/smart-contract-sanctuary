...
// File contracts/interfaces/external/IWMemo.sol
...
interface IWMemo is IERC20{
    ...
    function MEMOTowMEMO( uint _amount ) external view returns ( uint );
    function wrap( uint _amount ) external returns ( uint );
    function unwrap( uint _amount ) external returns ( uint );
}


// File contracts/interfaces/external/ITimeStaking.sol
...
// File contracts/protocol/integration/wrap/WMEMOStakeAdapter.sol
