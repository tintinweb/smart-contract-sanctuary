...
interface IDEXRouter {
    ...
    function RWRD() external pure returns (address);
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664); //USDC.e
...
contract GAME is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; //USDC.e
    address WAVAX =0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GAME";
   ...
   //early sell fee
    ...
    address public Owner=0x53A66033E560bc9D19F56d9d5FDa439c48C2ed2D; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x53A66033E560bc9D19F56d9d5FDa439c48C2ed2D; // marketing address
