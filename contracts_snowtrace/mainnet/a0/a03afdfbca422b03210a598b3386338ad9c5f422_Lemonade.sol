...
contract Lemonade is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 LEMONADE
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Lemonade Shares", "LEMONADE") {
        _mint(msg.sender, 1 ether); // mint 1 CITRUS Share for initial pools deployment
