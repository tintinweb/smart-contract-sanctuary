...
Ape Printer without print for technical issues

no redistribution in another token, just in this token
  
liquidity reduced to 100 avax due to popular demand
...
contract APEprintV2 is Context, IERC20, Ownable {
    ...
    string private _name = "APEprintV2";
    string private _symbol = "APEprintV2";
