 ...
 *  
*/  
// SPDX-License-Identifier: AGPL-3.0-or-later  https://t.me/chemistdogeavax
...
contract  CHEMISTDOGEERC20Token is ERC20Permit, VaultOwned {
  
    using SafeMath for uint256;

    constructor() ERC20("CHEMISTDOGE", "TRIX", 9) {
    }
