...
contract sMbagsToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1000000 * 10**9;
    ...
    constructor() ERC20("Staked Mbags", "sMbags", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMbags supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMbags
