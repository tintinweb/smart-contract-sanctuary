...
/**
 *👑 Welcome SpaceX Life Avax $SXL community 👑
SpaceXLife’s objective is to become one of the biggest decentralized meme projects in this Space. With SpaceXLife, launching makes perfect sense. We have all the requirements to create the greatest Moonshot of all time, by far. Weekly and Innovative Buy-Back/Burn system, Metaverse, NFTs are just the beginning. Our experienced team has been participating in well-known projects and we know exactly what it takes to bring a crew to the Moon.
Token Economics
⚡️ Total Supply:         1,000,000,000 $SXL
⚡️Add liquidity :         95%
⚡️ Marketing:              4%
⚡️ Team & Advisors: 1%
...
Max Wallet: No limit
Initial Liquidity: 70 AVAX + 95% $SXL

✈️ 3D Metaverse where you can create your own NFT metashop,
✈️ Buy your own land, create your avatar and much more
🔥Weekly BuyBack/Burn
🚀 Utility NFT's 
...
🔥When Launch ? 
👉 We will Stealth launch: 14:00 - 16:00 UTC on 15th December, 2021
🤝 Liquidity will be locked for 6 months immediately after we launch.

 Twitter : https://twitter.com/SpaceXLifeAvax

 Telegram :https://t.me/SpaceXLife_Avax

 Website : https://spacexlife.net
*/
...
contract SpaceXLifeAvax is Context, IERC20, Ownable {
    ...
    string private _name = 'SpaceXLifeAvax';
