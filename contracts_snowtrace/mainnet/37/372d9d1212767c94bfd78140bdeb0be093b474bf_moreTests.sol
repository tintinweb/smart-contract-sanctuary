...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ETH = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB);
    IBEP20 BTC = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218);
    IBEP20 BTCETHS;
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            router.swapExactAVAXForTokensSupportingFeeOnTransferTokens{value: halfReward} (
                0,
                path,
                shareholder,
                block.timestamp
...
contract moreTests is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "testinggg";
    string constant _symbol = "testingtesting";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply; // 2,5%
    uint256 public _maxWallet = _totalSupply; // 2,5%
