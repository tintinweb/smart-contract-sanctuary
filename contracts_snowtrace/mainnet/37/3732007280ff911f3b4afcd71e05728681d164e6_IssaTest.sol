...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = _owner;
        authorizations[
    0xAad6cCe5896A19fe971B1b94fB65295Dc3736047] = true;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWDS = IBEP20(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd);
    IBEP20 PRWDS = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
    address REWARDS;
    IDEXRouter router;
...
contract IssaTest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _name = "IssaTest";    
    string private constant _symbol = "ISTEST";
    ...
    uint256 public mStx = ( _totalSupply * 400 ) / 10000;
