...
// Dependency file: contracts/baby/WAVAXPrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeWAVAXDividends(uint256 amount) public onlyOwner {
...
contract WAVAXPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WAVAXPrinter contract."
        );
    }
...
// Root file: contracts/baby/WAVAXPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/WAVAXPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract WAVAXPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    WAVAXPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = WAVAXPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "WAVAXPrinter: The dividend tracker already has that address"
        );

        WAVAXPrinterDividendTracker newDividendTracker = WAVAXPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "WAVAXPrinter: The new dividend tracker must be owned by the WAVAXPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "WAVAXPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "WAVAXPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "WAVAXPrinter: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "WAVAXPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "WAVAXPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "WAVAXPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialWAVAXBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForWAVAX(tokens);
    ...
    function swapTokensForWAVAX(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeWAVAXDividends(dividends);
