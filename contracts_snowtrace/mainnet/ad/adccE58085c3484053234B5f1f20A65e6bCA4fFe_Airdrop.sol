...
contract Airdrop is Ownable {
    ...
    address public addy = 0x834bDBbe7bdbcd93453A38045B12c66712E9f2C6;
    AddyInterface cont = AddyInterface(addy);
    ...
    function dropTokens(address[] memory _recipients, uint256 startID) public onlyOwner returns (bool) {
        ...
        for (uint i = startID; i <= _recipients.length; i++) {
            ...
            cont.safeTransferFrom(address(this),_recipients[i], i);
        }
