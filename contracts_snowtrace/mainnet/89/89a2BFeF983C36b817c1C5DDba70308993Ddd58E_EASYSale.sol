...
//Change values
    ...
    uint public MAX_SOLD = 40000 * EASYdecimals;
    uint public MIN_PRESALE_PER_ACCOUNT = 1 * EASYdecimals;
    uint public MAX_PRESALE_PER_ACCOUNT = 500 * EASYdecimals;
    ...
    bool privateSale;
    // Multisig purposes
    address[] devAddr = [0x1C657EBfA3110bA1d9fc0c22AB5ad2bD363FAFb0, 0x713d7d6dd4099b20B455c85c319746E55da9CE22, 0x996FbB500CfF16163e3E97C971f0f7cc7B072908];
    ...
    function claimEASY() public onlyEOA {
        ...
        if (dailyClaimed[msg.sender] == 0) {
            ...
            amountPerClaim[msg.sender] = (invested[msg.sender] / EASYdecimals);
        }
    ...
    // Sending MIM pair to EASY treasury
    function zallocateEasyTreasury(address _token) public {
        require(msg.sender == owners, "not owners");
        uint b = IERC20(_token).balanceOf(address(this));
        // transfer contract ownership to EASY contract before transactions
    ...
    function setMinBuy(uint _min) public {
        require(msg.sender == owners, "not owners");
        MIN_PRESALE_PER_ACCOUNT = _min;
    }

    function setMaxBuy(uint _max) public {
        require(msg.sender == owners, "not owners");
        MAX_PRESALE_PER_ACCOUNT = _max;
    }

    function setMaxSold(uint _maxSold) public {
        require(msg.sender == owners, "not owners");
        MAX_SOLD = _maxSold;
    }

    function setNewOwnerManual(address newOwner) public {
        require(msg.sender == owners, "not owners");
        owners = newOwner;
    }
