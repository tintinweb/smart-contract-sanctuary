...
contract AVARICE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB529e98A626107335c634B4a905e8317d2250756); // Marketing Address
    ...
    string private _symbol = "AVARICE";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xB529e98A626107335c634B4a905e8317d2250756);
    }
    ...
    function _removeSniper(address account) external onlyOwner() {
        require(account != 0x60aE616a2155Ee3d9A68541Ba4544862310933d4, 'We can not blacklist Uniswap');
