...
contract AVAXIFY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9Df038D3750127Dde4B5AE0f9aCA73132A46d0e1); // Marketing Address
    ...
    string private _name = "AVAXIFY";
    string private _symbol = "AVAXIFY";
    ...
    uint256 public _bMaxTxAmount = 50000000 * 10**6 * 10**9;
    uint256 public _sMaxTxAmount = 50000000 * 10**6 * 10**9;
    ...
    function setMBTXL(uint256 amount) external onlyOwner {
        _bMaxTxAmount = amount * 10**6 * 10**9;
    }
    
    function setMSBTXL(uint256 amount) external onlyOwner {
        _sMaxTxAmount = amount * 10**6 * 10**9;
    }
