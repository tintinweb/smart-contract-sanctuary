/*
Multi Bank Capital: $MBC : You buy on Avalanche, we farm on multiple chains and return the profits to $MBC holders.
We find out some drawbacks with $MCC tokenomics and we have made some amendments to our own tokenomics. 

Multi Bank Capital is not just a fork of $MCC.
The most UNIQUE about Multi Bank Capital is that you earn passive income with AVAX reflection + We have tax for LP & Buy Back
...
Telegram:
https://t.me/MultiBankCapital

Twitter:
https://twitter.com/MultibankCC

Website:
https://MultiBank.capital
...
contract MultiBank is Ownable, IERC20 {
    ...
    string _name = "Multi Bank Capital";
    string _symbol = "MBC";
    ...
    address marketing = address(0xa7723DC55bb8455909FbCe09B9Ed705f6f133b55);
    address liquidity = address(0x82fdB832284B93Fdf27A86E35D1ABa1E1CcC4480);

    ITraderJoeRouter public router;
    address pair;

    PiggyAvaxPrintDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new PiggyAvaxPrintDividendTracker();
...
contract PiggyAvaxPrintDividendTracker is DividendPayingTokenInterface {
    using SafeMath for uint256;
