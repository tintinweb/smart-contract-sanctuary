...
contract AvaxRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDCf3d4921Fe2f820B8338AaC8A5cA8Bae733A0d0); // Marketing Address
    ...
    string private _name = "AVAX-Rocket";
    string private _symbol = "AVAXROCKET";
