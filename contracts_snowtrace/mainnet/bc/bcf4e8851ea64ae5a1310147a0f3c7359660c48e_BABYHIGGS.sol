...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 AVAX = IBEP20(0xce0052745A182fff07aCB9dd834041E5F29319b2); //HIGGS
...
contract BABYHIGGS is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address AVAX = 0xce0052745A182fff07aCB9dd834041E5F29319b2; // HIGGS
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xdae2e596a10443465D8d7A2A4Fd9BB6256f6F3E6;
    address public marketingFeeReceiver=0xdae2e596a10443465D8d7A2A4Fd9BB6256f6F3E6;

    string constant _name = "BABYHIGGS";
    string constant _symbol = "BABYHIGGS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1210000 * (10 ** _decimals);
