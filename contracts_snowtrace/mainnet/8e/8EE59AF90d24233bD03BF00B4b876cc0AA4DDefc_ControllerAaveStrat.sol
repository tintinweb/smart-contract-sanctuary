...
contract ControllerAaveStrat is Pausable, ReentrancyGuard, Swappable {
    ...
    address public constant wNative = address(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // test
    ...
    address public constant DATA_PROVIDER = address(0x65285E9dfab318f57051ab2b139ccCf232945451);
    address public constant INCENTIVES = address(0x01D83Fe6A10D2f2B7AF17034343746188272cAc9);
    address public constant POOL = address(0x4F01AeD16D97E3aB5ab2B501154DC9bb0F1A5A2C);
