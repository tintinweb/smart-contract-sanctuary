...
contract BarnHoldings is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Barn Holdings";
    string private constant _symbol = unicode"BARN";
    ...
    modifier lockTheSwap {
        ...
        constructor (address payable treasuryWalletAddress , address payable BARNWalletAddress) {
        w1 = treasuryWalletAddress;
        w2 = BARNWalletAddress;
    ...
    function sendAVAXToTeam(uint256 amount) private {
    ...
    function setBARNWallet(address payable _w2) external {
    ...
    function manualsend() external {
        require(_msgSender() == w1);
        uint256 contractETHBalance = address(this).balance;
        sendAVAXToTeam(contractETHBalance);
    }
