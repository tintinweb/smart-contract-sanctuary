...
contract AraSale is Ownable {
    ...
    uint constant DAIEdecimals = 10 ** 18;
    uint constant ARAdecimals = 10 ** 9;
    uint public constant MAX_SOLD = 10000 * ARAdecimals;
    uint public constant PRICE = 5 * DAIEdecimals / ARAdecimals ;
    uint public constant MIN_PRESALE_PER_ACCOUNT = 100 * ARAdecimals;
    ...
    constructor(address _dev, address daie) {
        DAIE = ERC20(daie);
        dev = _dev;
        sold = 0;
    }
    ...
    function buyARA(uint256 amount) public onlyEOA {
        ...
        DAIE.safeTransferFrom( msg.sender, address(this), amount * PRICE  );
