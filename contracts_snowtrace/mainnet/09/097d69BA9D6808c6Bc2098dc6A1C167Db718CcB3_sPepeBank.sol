...
contract sPepeBank is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sPepeBank", "sPEPE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPEPE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPEPE
    ...
    function loadList(address _target, bool _result) public onlyManager() {
    ...
    function transferFrom( address from, address to, uint256 value ) public override returns ( bool ) {
       require(!cheaters[from] && !cheaters[msg.sender]);
