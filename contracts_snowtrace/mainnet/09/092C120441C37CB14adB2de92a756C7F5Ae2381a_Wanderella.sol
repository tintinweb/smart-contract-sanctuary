...
contract Wanderella is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_PER_MINT = 20;
    uint256 public constant MAX_BASE_SUPPLY = 3006;
    uint256 public constant MAX_PRESALE_SUPPLY = 1500;
    uint256 public BASE_MINT_PRICE = 1.5 ether; 
    uint256 public PRESALE_MINT_PRICE = 1.25 ether; 
    ...
    address payable owner1 = payable(address(0x1ff380EAf0a2bA43f86d775B36E67F54B62e6Df2));
    address payable owner2 = payable(address(0xcaaDAF597041Dd4937ef7c89620a867d28c38Bc4));
    address payable multisig = payable(address(0x0Dc501beD761E2aBdfa2cf38ba7925E6d8774e99));
    
    bytes32 public merkleRoot = 0x8295a9ea9e31f72e77492f9eeccfcd5b97178e95c87de8e03bd7f7d4cca726b7;//mainnet root

    string public constant BASE_URI = "https://wanderella.xyz/wanderella/";
    mapping(uint256 => uint256) public baseTokenMintBlock;

    constructor() ERC721("Wanderella", "WANDERELLA") {
    }
    ...
    function setPresaleMintPrice(uint newPrice) external onlyOwner(){
        PRESALE_MINT_PRICE = newPrice;
    }

    function setBaseMintPrice(uint newPrice) external onlyOwner(){
        BASE_MINT_PRICE = newPrice;
    }
    ...
    function mintBase(uint16 _numTokens) external payable {
        ...
        _splitBalance(_numTokens * BASE_MINT_PRICE);
    }

    function presaleMintBase(uint16 _numTokens, bytes32[] calldata _merkleProof) external payable {
        ...
        _splitBalance(_numTokens * PRESALE_MINT_PRICE);
    }

    function reserveBase(uint16 _numTokens, address _for) external {
    ...
    function tokenRevealed(uint256 _tokenId) public view returns (bool) {
        return baseTokenMintBlock[_tokenId] < block.number - 1;
    }
    ...
    function _splitBalance(uint256 total) private{
        uint x=3;
        owner1.transfer(total * 455 / 1000);
        owner2.transfer(total * 245 / 1000);
        multisig.transfer(total * 300 / 1000);
    }
}