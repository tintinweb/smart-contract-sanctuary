...
contract TimeStakingAndBondingManager is Ownable, Managed {
    ...
    constructor(IIglooMaster _iglooMaster){
    ...
    function setTimeStrategyHelper(address newTimeStrategyHelper) external onlyManager {
        require(newTimeStrategyHelper != address(0));
        timeStrategyHelper = newTimeStrategyHelper;
    }
