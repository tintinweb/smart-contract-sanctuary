...
// Stealth_Launched
// Discord: https://discord.gg/ErPRx9Vxkd
// Twitter: https://twitter.com/EarnBrig
// GET REWARDS IN $BRIG with AvaBrig
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 brig = IBEP20(0xF2CfC11093edB5A2DC7F49e70A3a3a9cd4F4FeE4);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = brig.balanceOf(address(this));
        ...
        uint256 amount = brig.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            brig.transfer(shareholder, amount);
...
contract Avabrig is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address brig = 0xF2CfC11093edB5A2DC7F49e70A3a3a9cd4F4FeE4; // brig
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AvaBrig";
    string constant _symbol = "AvaBrig";
