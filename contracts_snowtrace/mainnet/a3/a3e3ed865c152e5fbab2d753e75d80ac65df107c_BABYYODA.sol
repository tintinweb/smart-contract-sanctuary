...
/**
Welcome to Baby Yoda! This token will serve as a Reflection token. 
Just hold $BBYODA to earn $MIM

Tokenomics:
6% of each transactions will reward holders with $MIM
6% for marketing
1% to auto liquidity

Website:
https://babyyodadao.xyz/

Twitter:
https://twitter.com/BabyYodaDAO

Telegram:
https://t.me/BabyYodaDAO
...
contract BABYYODA is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver=0xd50142088feEE05d4DB631ef906b929979dDb270;
    address public marketingFeeReceiver=0xd50142088feEE05d4DB631ef906b929979dDb270;

    string constant _name = "BABYYODA";
    string constant _symbol = "BBYODA";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xd50142088feEE05d4DB631ef906b929979dDb270;
