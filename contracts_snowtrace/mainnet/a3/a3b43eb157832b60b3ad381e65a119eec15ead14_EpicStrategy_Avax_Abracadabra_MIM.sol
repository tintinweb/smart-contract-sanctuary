...
// File: contracts/EpicStrategy_Avax_Abracadabra_MIM.sol
...
contract EpicStrategy_Avax_Abracadabra_MIM{
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    //tokens needed
    address public constant SPELL = 0xCE1bFFBD5374Dac86a2893119683F4911a2F7814;
    ...
    address public constant CURVE_LP_TOKEN = 0xAEA2E71b631fA93683BCF256A8689dFa0e094fcD; //Curve.fi avDAI/avUSDC/avUSDT (av3CRV)
    ...
    address public constant CURVE_POOL = 0xAEA2E71b631fA93683BCF256A8689dFa0e094fcD;
    address public CHEF = 0x06408571E0aD5e8F52eAd01450Bde74E5074dC74; //ACBRACADABRA CHEF

    address public SWAP = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
    ...
    function getName() external pure returns (string memory) {
        return "EpicStrategy_Avax_Abracadabra_MIM";
    }
    ...
    function balanceOfPool() public view returns (uint256) {
        ...
        if (amountCRVLP > 0) {
            ...
            uint256 amountUSDC = ICurveStableSwapMIM(CURVE_POOL).calc_withdraw_one_coin(amountCRVLP, 2);
    ...
    function deposit() public {
        ...
        ICurveStableSwapMIM(CURVE_POOL).add_liquidity(
            [0, 0, IERC20(USDC).balanceOf(address(this))],
            0
        );
    ...
    function _withdrawSome(uint256 _amount) internal returns (uint256) {
        ...
        uint256 _amountNeededCRVLP = ICurveStableSwapMIM(CURVE_POOL).calc_token_amount([0, 0, _amount], false);
        ...
        //WD from CURVE_POOL
        ICurveStableSwapMIM(CURVE_POOL).remove_liquidity_one_coin(
