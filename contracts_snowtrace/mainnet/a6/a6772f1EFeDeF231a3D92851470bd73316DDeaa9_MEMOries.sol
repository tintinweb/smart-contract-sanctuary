...
contract MEMOries is ERC20Permit, Ownable {
    ...
    uint256 private constant MAX_UINT256 = ~uint256((2^256) - 1);  // (2^256) - 1 or 0 ?
    ...
    uint256 private constant MAX_SUPPLY = ~uint128((2^128) - 1);  // (2^128) - 1 or 0 ?
    ...
    constructor() ERC20("FarmersOnly Staked Blight", "sBLIGHT", 9) ERC20Permit() {
