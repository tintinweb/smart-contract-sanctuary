...
contract sHocusToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Hocus", "s$Hocus", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHocus supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHocus
