...
contract EpicStrategy_Avax_TraderJoe_USDCUSDT{
    ...
    function calcUSDCperJLP() public view returns (uint256) {
        ...
        uint256 oneJLP = reserveUSDC.mul(1e18).mul(2).div(totalSupplyJLP);
    ...
    function balanceOfPool() public view returns (uint256) {
        ...
        if (amountJLP > 0) {
            uint256 amountUSDC = amountJLP.mul(calcUSDCperJLP()).div(1e18);
            return amountUSDC;
        } else {
            return 0;
        }
    ...
    function _withdrawSome(uint256 _amount) internal returns (uint256) {
        ...
        uint256 _amountNeededJLP = calcUSDCperJLP().mul(_amount).div(1e18);
