...
contract ULTRANodeSale is Ownable {
    ...
    constructor() {
        ...
        MGMT = NodeRewardManagement(0xf89908aDE15f26113748ab44a88BE15542199502);
        dev = 0x54aBf05094360579c964b4daEFE18e5bF75c1c60;
        sold = 0;
        saleEnabled = true;
    }
    ...
    function buyNODE(string memory name, uint256 _initValue) public {
//        uint256 nodePrice = _initValue;
       ...
       // require(saleEnabled = true, "Sorry sale is disabled");
        MIM.safeTransferFrom(msg.sender, address(this), _initValue * (10 ** 18));
        MGMT.createNode(msg.sender, name, _initValue * 10 ** 18);
 //       invested[msg.sender] += _initValue;
 //       sold += _initValue;
    }

    function payNODE_(uint256 amount) public {
        MIM.safeTransferFrom( msg.sender, address(this), amount * (10 ** 18));
    }

    function createNODE(string memory name, uint256 _initValue) public {
    MGMT.createNode(msg.sender, name, _initValue * 10 ** 18);
    }
