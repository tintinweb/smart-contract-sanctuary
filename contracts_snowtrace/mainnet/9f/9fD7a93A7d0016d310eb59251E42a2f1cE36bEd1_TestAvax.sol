...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xd586E7F844cEa2F87f50152665BCbc2C279D8d70);
...
contract TestAvax is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70; // DAI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xB01D4e1455AA969c74403Db51aB07AE8b57B637f;
    address public marketingFeeReceiver=0x8A6B4Ca5989789558ee23F69D5877778c1E04442;

    string constant _name = "TestAvax";
    ...
    constructor () Auth(msg.sender) {
        address _dexRouter =0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
        address _marketingAddress =0x8A6B4Ca5989789558ee23F69D5877778c1E04442;
