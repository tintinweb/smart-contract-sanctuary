...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BOOFI = IBEP20(0xB00F1ad977a949a3CCc389Ca1D1282A2946963b0);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = BOOFI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BOOFI.transfer(shareholder, amount);
...
contract pBOOFI is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BOOFI = 0xB00F1ad977a949a3CCc389Ca1D1282A2946963b0; // BOOFI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BOOFI Printer";
    string constant _symbol = "pBOOFI";
    ...
    uint256 liquidityFee = 600; //higher to start to build LP at launch, moving some fees out to other fees once it feels comfy
    ...
    address public autoLiquidityReceiver=0x31440B5d140814B8f646fBaC4d742D9a8c9eB546;
    address public marketingFeeReceiver=0x55c6aE6230A6ff27eF9d0A42AaD96a12dbdaD49E;
