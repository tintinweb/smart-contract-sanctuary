...
// GET REWARDS IN JOE with AVAJOE
...
contract AVAJOE is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address JOE = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd; // USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAJOE";
    string constant _symbol = "AVAJOE";
    ...
    address public autoLiquidityReceiver=0xE80Cce78030EcA9fDaFf894031849ad6F4c9c94b;
