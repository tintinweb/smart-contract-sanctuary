...
contract VillagerFinance is ERC20Permit, VaultOwned {
    ...
    function setIronScytheManagment(uint256 _maxBuyAmount) external onlyOwner() {
      maxBuyAmount = _maxBuyAmount;
    }

    function setGoldScytheManagment(uint256 _maxBuyAmount) external onlyOwner() {
      maxBuyAmount = _maxBuyAmount;
    }

    function setDiamondScytheManagment(uint256 _maxBuyAmount) external onlyOwner() {
      maxBuyAmount = _maxBuyAmount;
    }
