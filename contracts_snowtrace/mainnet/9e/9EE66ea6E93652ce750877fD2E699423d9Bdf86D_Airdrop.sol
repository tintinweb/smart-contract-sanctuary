...
contract Airdrop is Ownable{
    ...
    mapping(uint256 => uint256) public accumulateAirdropAmount; // airdrop iteration => airdrop enddate
    ...
    mapping(address => mapping(uint256 => bool)) public processedAirdrops;   //user address => airdrop iteration => claim status
