...
// File contracts/AlgorToken.sol

pragma solidity >=0.6.0 <0.8.0;


contract SolarEnergy is ERC20, Ownable {
    address private manager;


    constructor(uint256 _totalSupply) public ERC20("NovaXSolarEnergy", "XSLR") {
        manager = msg.sender;
    ...
    function mint(address account, uint256 amount) public payable onlyNovaxGame returns(bool) {
         _mint(account, amount);
         return true;
    }
    
    function burn(address account, uint256 amount) public payable onlyNovaxGame returns(bool) {
