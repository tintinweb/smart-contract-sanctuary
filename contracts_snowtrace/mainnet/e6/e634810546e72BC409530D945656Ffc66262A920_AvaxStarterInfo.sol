...
// File: contracts/interfaces/IPangolinSwap.sol

pragma solidity ^0.6.12;

interface IPangolinSwapV2Pair {
    event Approval(
...
interface IPangolinSwapV2Factory {
    event PairCreated(
...
interface IPangolinSwapV2Router01 {
...
interface IPangolinSwapV2Router02 is IPangolinSwapV2Router01 {
...
// File: contracts/avalanche/AvaxStarterFarming.sol
...
contract AvaxStarterFarming is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeERC20 for IERC20;

    event Staked(address indexed from, uint256 amountAVAX, uint256 amountLP);
    event Withdrawn(address indexed to, uint256 amountAVAX, uint256 amountLP);
    event Claimed(address indexed to, uint256 amount);
    event Halving(uint256 amount);
    event Received(address indexed from, uint256 amount);

    STARToken public startToken;
    IPangolinSwapV2Factory public factory;
    IPangolinSwapV2Router02 public router;
    address public weth;
    ...
    constructor(address _startToken) public {
        ...
        router = IPangolinSwapV2Router02(
            0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106
        );
        factory = IPangolinSwapV2Factory(router.factory());
        weth = router.WAVAX();
    ...
    function stake() external payable nonReentrant {
        ...
        // Add liquidity
        uint256 amountAVAXDesired = msg.value.sub(msg.value.div(2));
        IERC20(startToken).approve(address(router), boughtStart);
        (, , uint256 liquidity) = router.addLiquidityAVAX{
            value: amountAVAXDesired
        }(
            address(startToken),
            boughtStart,
            1,
    ...
    function withdraw() external nonReentrant {
        ...
        IWAVAX(weth).withdraw(bnbAmount);
    ...
    function setRewardRate(uint256 _rewardRate) external onlyBscsDev {
...
// File: contracts/avalanche/AvaxStarterInfo.sol
...
interface IAvaxExternalStaking {
    function balanceOf(address) external view returns (uint256);
}

contract AvaxStarterInfo is Ownable {
    using SafeMath for uint256;
    ...
    bytes32 private starterSwapICH =
        0xb7ef6b069ca45fcdc25021f298625f8a79befad4321217e6118556651aba9f4c; // StarterSwap InitCodeHash

    uint256 private starterSwapLPPercent = 0; // Liquidity will go StarterSwap

    address private weth = address(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    address private png = address(0x60781C2586D68229fde47564546784ab3fACA982);
    address private usdc = address(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
    ...
    IAvaxStarterStaking public starterStakingPool;
    AvaxStarterFarming public starterLPFarm;
    IAvaxExternalStaking public starterExternalStaking;
    ...
    constructor(
        ...
        starterStakingPool = IAvaxStarterStaking(_starterStakingPool);
        starterLPFarm = AvaxStarterFarming(_starterLPFarm);
        starterExternalStaking = IAvaxExternalStaking(_starterExternalStaking);
        ...
        initCodeHash[
            address(0xefa94DE7a4656D787667C749f7E1223D71E9FD88)
        ] = 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545; //Uniswap V2 INIT_CODE_HASH

        lpAddresses[weth] = address(0x6ee822d3D465b0368bBfa9CD3C3AC0f0F140ee0B); // WETH -> PNG+START LP Addresses
        lpAddresses[png] = address(0x6ee822d3D465b0368bBfa9CD3C3AC0f0F140ee0B); // PNG -> PNG+START LP Address
        lpAddresses[usdc] = address(0x6ee822d3D465b0368bBfa9CD3C3AC0f0F140ee0B);
        ...
        // PNG
        minCreatorStakedBalance[png] = 3.5 * 1e18;

        minYesVotesThreshold[png] = 1000 * 1e18;

        minInvestorBSCSBalance[png] = 3.5 * 1e18;

        minInvestorGuaranteedBalance[png] = 35 * 1e18;

        investmentLimit[png] = 1000 * 1e18;

        minCreatorStakedBalance[png] = 3.5 * 1e18;

        // USDC
        minCreatorStakedBalance[usdc] = 3.5 * 1e18;

        minYesVotesThreshold[usdc] = 1000 * 1e18;

        minInvestorBSCSBalance[usdc] = 3.5 * 1e18;

        minInvestorGuaranteedBalance[usdc] = 35 * 1e18;

        investmentLimit[usdc] = 1000 * 1e06;
        ...
        returns (uint256)
    {
        ...
        if (
            address(starterExternalStaking) !=
            address(0x0000000000000000000000000000000000000000)
        ) {
            externalBalance = starterExternalStaking.balanceOf(address(sender));
        }
