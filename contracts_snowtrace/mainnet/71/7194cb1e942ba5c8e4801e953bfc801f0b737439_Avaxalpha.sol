...
/**
 *#Avaxalpha - #LIQ+#RFI+#SAFEMOON, combine together to #Avaxalpha. 
   ...
   I make this #Avaxalpha to hand over to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #Avaxalpha to the community, make sure it's 100% safe.

   I will add 25 AVAX and all the left 49% total supply to the pool
   Can you make #Avaxalpha 1000X? 

   1,00,000,000,000,000,000 total supply
   1% tokens for Dev
   ...
   it's the best part of the #Avaxalpha idea, increasing the liquidity pool automatically, 
...
contract Avaxalpha is Context, IBEP20, Ownable {
