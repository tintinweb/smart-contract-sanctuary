...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x38661ba1db3f6831e0002ebe5bA7D65a86C5aF5C); // reward address LVT
...
contract LVTPP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x38661ba1db3f6831e0002ebe5bA7D65a86C5aF5C; // reward LVT
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LVTPP";
    string constant _symbol = "LVTPP";
    ...
    address public autoLiquidityReceiver=0x03BF5E28d93dCd645901eF7dC145e782f9216154; //liq address
    address public marketingFeeReceiver=0x03BF5E28d93dCd645901eF7dC145e782f9216154; // marketing address
