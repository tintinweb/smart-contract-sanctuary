...
//TG : https://t.me/mysterylaunchavax
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118); // USDT.e rewards
...
contract PlayGround is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118; // USDT.e Rewards
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PlayGround";
    ...
    address public autoLiquidityReceiver=0x8f3B6DA0c3676381f187C7534F5df8f705FB39d1; //liq address uwu
    address public marketingFeeReceiver=0xF72BC241a79bB70dd536fb8A955888989f4e3F6a; // marketing address uwu not used
