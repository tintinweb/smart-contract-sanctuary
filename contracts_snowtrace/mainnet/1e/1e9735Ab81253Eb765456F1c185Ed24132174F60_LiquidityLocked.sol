...
/** Check the pair on Team.Finance to see liquidity lock and check transactions for lock as well.
...
contract LiquidityLocked is Context, IERC20, Ownable {
    ...
    string private constant _name = "LiquidityLocked";
    string private constant _symbol = "LIQL";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5Ec625cA163F9A94c4F40a56CD639F04f2149D5B);
        _feeAddrWallet2 = payable(0x5Ec625cA163F9A94c4F40a56CD639F04f2149D5B);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x5Ec625cA163F9A94c4F40a56CD639F04f2149D5B), _msgSender(), _tTotal);
    }
