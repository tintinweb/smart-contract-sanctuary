...
- No team, no project, contracts burned, liquidity locked 1 year, 
- 2% of each transaction distributed to the holders, nothing but the void, only on Avalanche. $VOID
- 12% of each transaction burned to increase $VOID value
...
contract AvalancheVoidV2 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "AvalancheVoid V2";
    string private _symbol = "VOIDv2";
    uint8 private _decimals = 9;

    uint256 bigDumpFactor = 25;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); // binance PANCAKE V2
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) 
            require(amount <= _maxTxAmount || _isExcludedFromFee[from] || _isExcludedFromFee[to], "Transfer amount exceeds the maxTxAmount.");
