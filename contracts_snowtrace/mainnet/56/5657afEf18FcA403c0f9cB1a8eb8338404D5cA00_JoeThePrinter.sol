/*
https://t.me/JoeThePrinter
https://twitter.com/JoeThePrinter3
https://joetheprinter.app
...
contract JoeThePrinter is Ownable, IERC20 {
    ...
    address marketing = address(0x26cC382937013200eecB8CA8c6e9aCA2b1a62b58);
    address liquidity = address(0xCB19067F9eCd8bf08B59bfC6C1012f8e03908a8c);

    ITraderJoeRouter public router;
    address pair;

    JoeThePrinterDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        // router = ITraderJoeRouter(0x5db0735cf88F85E78ed742215090c465979B5006); //testet
        WVAX = router.WAVAX();
		pair = ITraderJoeFactory(router.factory()).createPair(WVAX, address(this));
        _allowances[address(this)][address(router)] = ~uint256(0);

        dividendTracker = new JoeThePrinterDividendTracker();
...
contract JoeThePrinterDividendTracker is DividendPayingTokenInterface {
    using SafeMath for uint256;
    ...
    ITraderJoeRouter public router;
    address WAVAX;
    IERC20 JoeToken = IERC20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    function deposit() external payable onlyToken {
        uint256 balanceBefore = JoeToken.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WAVAX;
        path[1] = address(JoeToken);
        ...
        uint256 amount = JoeToken.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            JoeToken.transfer(shareholder,amount);
