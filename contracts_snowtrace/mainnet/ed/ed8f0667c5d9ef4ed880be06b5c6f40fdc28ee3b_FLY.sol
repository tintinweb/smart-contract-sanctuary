...
pragma solidity ^0.6.12;
    ...
    contract FLY is Context, IERC20, Ownable {
        ...
        uint256 private _maxTxAmount = 69420000000e9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeForCharity = 1 * 10**3 * 10**3;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if (!inSwap && swapEnabled && overMinTokenBalance && sender != uniswapV2Pair) {
                ...
                if(contractAVAXBalance > 0) {
                    sendAVAXToCharity(address(this).balance);
                }
            }
        ...
        function sendAVAXToCharity(uint256 amount) private {
        ...
        function manualSend() external onlyOwner() {
            uint256 contractAVAXBalance = address(this).balance;
            sendAVAXToCharity(contractAVAXBalance);
        }
        ...
        function _getAVAXBalance() public view returns(uint256 balance) {
