...
Introducing NeroSwap

NeroSwap (NSwap) aims to build a Full-Stack DEFI with NFT Auction on the Avalanche chain.
It will become the economic infrastructure for Defi and NFT powered by Avalanche Chain.
The Infrastructure for Defi & NFT Powered by AVAX.
NeroSwwap operates on top of existing blockchains Avalanche Chain that is designed to offer maximum value to consumers and institutions.
Avalanche Chain has solved the problem of infrastructure in the context of NeroSwap product, and that NSwap represents the ideal use case to leverage the technologies offered by its platform.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Comet = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
...
contract NeroSwap is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address Comet = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // Nero
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NeroSwap";
    string constant _symbol = "NeroSwap";
    ...
    address public autoLiquidityReceiver=0xE90aCCb05eFcFAe261c421b94aF840518b5BCCe5;
    address public marketingFeeReceiver=0xE90aCCb05eFcFAe261c421b94aF840518b5BCCe5;
