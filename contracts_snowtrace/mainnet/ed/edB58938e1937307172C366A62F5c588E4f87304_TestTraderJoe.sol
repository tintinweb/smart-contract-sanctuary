...
contract TestTraderJoe is Ownable {
    ...
    function _deposit(uint256 _wantAmt) internal {
        ...
        IJCollateralCapErc20Delegate(jCollateralCapErc20DelegateAddress).mint(_wantAmt);
    }
    ...
    function withdraw(uint256 _minReturnWant) public onlyOwner {
        ...
        IJCollateralCapErc20Delegate(jCollateralCapErc20DelegateAddress).redeem(withdrawAmt);
