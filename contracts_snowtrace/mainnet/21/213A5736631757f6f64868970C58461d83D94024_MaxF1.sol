...
contract MaxF1 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118; // USDT
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x15F9B8A993c5305A727D60183Bb96b672dB5BC69;
    address public marketingFeeReceiver=0x15F9B8A993c5305A727D60183Bb96b672dB5BC69;

    string constant _name = "Max F1";
    string constant _symbol = "MAXF1";
