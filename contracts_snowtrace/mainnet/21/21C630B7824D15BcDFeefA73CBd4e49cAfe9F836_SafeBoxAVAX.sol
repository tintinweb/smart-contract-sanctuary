...
// File: SafeBoxAVAX.sol

contract SafeBoxAVAX is Governable, ERC20, ReentrancyGuard {
  event Claim(address user, uint amount);

  ICErc20 public immutable cToken;
  IWETH public immutable weth; // WAVAX address
  ...
  receive() external payable {
    require(msg.sender == address(weth), '!wavax');
  }
}