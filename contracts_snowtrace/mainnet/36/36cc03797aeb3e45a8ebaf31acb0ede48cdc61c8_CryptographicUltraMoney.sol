...
/**
    CUM fairlaunch with 30 avax initial liquidity

    0% tax

    Stealth Launch at traderjoe

    Join telegram: https://t.me/AVAXCryptographicultramoney
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x50E4bB50D25333A21aDdeB8C75EE70DAc8c24786;
...
contract CryptographicUltraMoney is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x50E4bB50D25333A21aDdeB8C75EE70DAc8c24786;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CryptographicUltraMoney";
