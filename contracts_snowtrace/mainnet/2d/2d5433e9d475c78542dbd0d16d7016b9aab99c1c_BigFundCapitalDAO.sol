...
contract BigFundCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Big Fund Capital DAO";
    ...
    address payable public marketingWallet = payable(0x3BC6C0825de5b51C893bF0aC2E24aC5d08aB50ec);
    address payable public treasury = payable(0xA2b064AA58cf84e630c70A1Dd3E50C6f34f04Dad);

    JOERouter public router;
    address public pair;
    ...
    constructor (
        ...
        router = JOERouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
            
        WAVAX = router.WAVAX();
        
        pair = JOEFactory(router.factory()).createPair(WAVAX, address(this));
    ...
    function manualSend() external onlyOwner {
        uint256 contractAVAXBalance = address(this).balance;
        payable(marketingWallet).transfer(contractAVAXBalance);
    }
