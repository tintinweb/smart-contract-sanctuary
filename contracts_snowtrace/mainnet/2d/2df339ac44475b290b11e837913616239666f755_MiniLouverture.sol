...
contract MiniLouverture is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x8117E10561ebA951d2520Ec1BB4024574d3C07E7;
    address public marketingFeeReceiver=0x8117E10561ebA951d2520Ec1BB4024574d3C07E7;

    string constant _name = "Mini Louverture";
    string constant _symbol = "MLV";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100 * 1;
    uint256 public _maxWallet = _totalSupply / 100 * 2; 
