...
/**
 *#Avaxbucks - #LIQ+#RFI+#SAFEMOON, combine together to #Avaxbucks. 
   ...
   I make this #Avaxbucks to hand over to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #Avaxbucks to the community, make sure it's 100% safe.

   I will add 25 AVAX and all the left 49% total supply to the pool
   Can you make #Avaxbucks 1000X? 
   ...
   it's the best part of the #Avaxbucks idea, increasing the liquidity pool automatically, 
...
contract Avaxbucks is Context, IBEP20, Ownable {
