...
//  Stealth Launch
//  Telegram: t.me/printingtimeavax
//  Reward: $TIME
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x136Acd46C134E8269052c62A67042D6bDeDde3C9); // reward address TIME
...
contract PrintingTime is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x136Acd46C134E8269052c62A67042D6bDeDde3C9; // reward TIME
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PrintingTime";
    string constant _symbol = "PrintingTime";
    ...
    uint256 marketingFee = 1100;
    uint256 totalFee = 2000;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0x400c91D5b82EF7cb0D0C1AB78fCf3F7037503F60; //liq address
    address public marketingFeeReceiver=0x400c91D5b82EF7cb0D0C1AB78fCf3F7037503F60; // marketing address
