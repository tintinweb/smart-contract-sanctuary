...
//  stealth launched 
//  https://t.me/newyeartimeavax
//  Initial Liquidity of 40AVAX
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xb54f16fB19478766A268F172C9480f8da1a7c9C3); //TIME
...
contract NewYearTime is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xb54f16fB19478766A268F172C9480f8da1a7c9C3; // TIME
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NEWYEARTIME";
    string constant _symbol = "NYTIME";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); // 0.8%
	uint256 public _maxWallet = _totalSupply.div(80); // 1.25%
    ...
    address public autoLiquidityReceiver=0x808905919591251146e95645Db6A23C6284Dcb5a;
    address public marketingFeeReceiver=0x808905919591251146e95645Db6A23C6284Dcb5a;
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // 0.001%
    bool inSwap;
