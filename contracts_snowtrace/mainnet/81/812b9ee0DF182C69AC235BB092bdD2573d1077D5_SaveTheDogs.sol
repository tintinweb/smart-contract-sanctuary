...
contract SaveTheDogs is Context, IERC20, Ownable {
    ...
    string private _name = "SaveTheDogs";
    string private _symbol = "SAVETHEDOGS";
    ...
    // fees
    uint256 public _taxFee = 200; // 100 = 1%
    uint256 public _charityFee = 200; // 100 = 1%
    uint256 public _BurnFee = 200; // 100 = 1%
    ...
    //addresses
    address public charityAddress = 0xf0BdB329B337412010EAA4012712cf6B49430eCC; // Charity Address
    address public marketingAddress = 0xE3C7719A259aa1c4E2a4D3c3b27FbBc5783A958D; // Owner main wallet
