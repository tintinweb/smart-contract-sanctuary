...
contract STORM is ERC20('WAVE Token', 'wave') {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    uint256 public StormPerBlock = 2.2 ether;
    
    uint256 constant MAX_STORM_PERBLOCK= 10 ether;
    ...
    uint256 public startBlock;
     ...
     // Tresaury address
    address public constant TRESAURY = 0xB0f31846e53DcBD3011B875A014d7F9befe46DDC;  
    ...
    function updatePool(uint256 _pid) public {
        ...
        Storm.mint(TRESAURY, StormReward.mul(20).div(1000));
