...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        // 20% to ecosystem address
        // 10% is reserved for future usecase(NFT, metaverse, game, etc)

        cake.mintFor(devaddr, cakeReward.div(5));
        cake.mintFor(reserveaddr, cakeReward.div(10));
