...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x440aBbf18c54b2782A4917b80a1746d3A2c2Cce1);
...
contract aVaxxinatedSHIB is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x440aBbf18c54b2782A4917b80a1746d3A2c2Cce1; // DAI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xE7d7D36A4752092a79A9a739E905886136f2e9FA;
    address public marketingFeeReceiver=0xE7d7D36A4752092a79A9a739E905886136f2e9FA;

    string constant _name = "aVaxxinatedSHIB";
    string constant _symbol = "aVSHIB";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _marketingAddress =0xE7d7D36A4752092a79A9a739E905886136f2e9FA;
