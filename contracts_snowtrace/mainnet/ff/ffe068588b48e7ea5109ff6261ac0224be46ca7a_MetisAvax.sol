...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 lvt = IBEP20(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd);
...
contract MetisAvax is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address lvt = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd; // Rewards token
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MetisAvax";
    string constant _symbol = "MetisAvax";
    ...
    address public autoLiquidityReceiver=0xe1BD3b2983E62506237bcAF8745b81C429693Ab3;
    address public marketingFeeReceiver=0xe1BD3b2983E62506237bcAF8745b81C429693Ab3;
