...
library Counters {
    ...
    function increment(Counter storage counter) internal {
        // The {SafeMath} overflow check can be dbpped here, see the comment at the top
        counter._value += 1;
    }
...
contract sDiamondbank is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sDiamondbank", "sDB", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDiamondbank supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDiamondbank
