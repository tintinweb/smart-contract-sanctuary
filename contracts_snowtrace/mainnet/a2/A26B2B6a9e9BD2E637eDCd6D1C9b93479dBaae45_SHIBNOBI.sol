...
contract SHIBNOBI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBNOBI";
    string constant _symbol = "Shinja";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(500); // 1%
    uint256 public _maxWallet = _totalSupply.div(250); // 2%
    ...
    address public autoLiquidityReceiver=0x129e0B43e5cBd78cAD87C2bCCcd48bfed7057aea;
    address public marketingFeeReceiver=0xc2b61EC96AA3b06226CFCbb4C7018b6708e0956c;
