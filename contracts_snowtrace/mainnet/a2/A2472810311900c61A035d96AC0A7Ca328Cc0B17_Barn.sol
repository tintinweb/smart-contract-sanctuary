...
/*
SHEEP GAME 2: twice the fun, half the price
https://sheepgamexyz2.com
https://twitter.com/sheepusfarmer
https://discord.gg/eGr5HFvQd8
*/
...
contract WOOL is ERC20, Ownable {
  ...
  constructor() ERC20("AWOOL2", "aWOOL2") { }
...
contract Woolf is IWoolf, ERC721Enumerable, Ownable, Pausable {
    ...
    // 1 AVAX
    uint256 public constant MINT_PRICE = 1000000000000000000;
...
contract Barn is Ownable, IERC721Receiver, Pausable {
    ...
    // tracks whether a wolf has been staked
    mapping(uint256 => bool) public wolfStaked;
    ...
    function isWolfStaked(uint256 tokenId) public view returns (bool) {
        return wolfStaked[tokenId];
    }

    function isRevealed(uint256 tokenId) public view returns (bool) {
        return woolf.totalSupply() >= tokenId + woolf.MAX_PER_MINT();
    }
