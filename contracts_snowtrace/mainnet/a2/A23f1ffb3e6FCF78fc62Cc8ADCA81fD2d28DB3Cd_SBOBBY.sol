...
contract SBOBBY is ERC20Permit, Ownable {
    ...
    constructor() ERC20("SBOBBY", "SBOB", 9) ERC20Permit() {
    ...
    /**
        @notice increases SBOBBY supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SBOBBY
