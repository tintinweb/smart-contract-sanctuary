...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    address public immutable IUniSwapPair;
    ...
    constructor (address tokenOwner,string memory name, string memory symbol,uint8 decimal, uint256 amountOfTokenWei,uint8 setTaxFee, uint8 setLiqFee, uint256 _maxLiqFee, uint256 _minMxTxPer, address _router, address _basePair) public {
        _name = name;
        _symbol = symbol;
        _decimals = decimal;
        ...
        IUniSwapPair = UniSwapFactory(_uniswapV2Router.factory())
