...
contract PapaAva is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PapaAva", "PapaAva") {
        ...
        marketingWallet = address(0xd1D96183efdC67EE6B21Fb862f6782CE234CB763); // set as marketing wallet
        buyBackWallet = address(0x410e0c74fC877a80cB3B8B8e89E5b426618C8D21); // set as buyback wallet
