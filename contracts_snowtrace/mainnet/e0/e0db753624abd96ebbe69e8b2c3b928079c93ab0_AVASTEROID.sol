...
// Stealth_Launch of Comet Printer
// GET REWARDS IN $Comet with Comet Printer
...
contract AVASTEROID is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AVASTEROID";
    string constant _symbol = "AVASROID";
