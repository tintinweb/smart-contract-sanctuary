...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98); // Set To Flokinomics
...
contract AvaxMiner is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98; // Doge Rewards
    address WBNB = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Avax Miner";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "AVM";
