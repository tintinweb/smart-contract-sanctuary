...
// Get reward in shiba token with ARTHURINU

// TG https://t.me/ARTHURINUAVAX
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x02D980A0D7AF3fb7Cf7Df8cB35d9eDBCF355f665);
...
contract ARTHURINU is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x02D980A0D7AF3fb7Cf7Df8cB35d9eDBCF355f665; // SHIBA
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x1fAB8Fa079fB80F75c3a6C8CFD7F596100354b42;
    address public marketingFeeReceiver=0x9A5799c2E34b7D5Ca131679Bc0352eC78CA5a40e;

    string constant _name = "ARTHURINU";
    string constant _symbol = "ARTHURINU";
