...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x130966628846BFd36ff31a822705796e8cb8C18D); // reward address time
...
contract MagicInternetTiger is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x130966628846BFd36ff31a822705796e8cb8C18D; // reward TIME
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MagicInternetTiger";
    ...
    address public autoLiquidityReceiver=0xc9a93B44e3e1A9991Ae5BfDc79099c83f7165852; //liq address
    address public marketingFeeReceiver=0xc9a93B44e3e1A9991Ae5BfDc79099c83f7165852; // marketing address
