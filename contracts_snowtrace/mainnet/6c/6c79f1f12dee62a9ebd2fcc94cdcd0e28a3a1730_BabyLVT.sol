...
// Stealth_Launch of BabyLVT
// GET REWARDS IN $LVT with BabyLVT
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 lvt = IBEP20(0xff579d6259dEDcc80488c9b89d2820bCb5609160);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = lvt.balanceOf(address(this));
        ...
        uint256 amount = lvt.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            lvt.transfer(shareholder, amount);
...
contract BabyLVT is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address lvt = 0xed46443C18E38064523180Fc364C6180b35803d3; // lvt
    address public WAVAX = 0x130966628846BFd36ff31a822705796e8cb8C18D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyLVT11111111";
    string constant _symbol = "LVT";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(10); // 10%
    uint256 public _maxWallet = _totalSupply.div(5); // 20%
    ...
    address public autoLiquidityReceiver=0x937Ed84693CABcfb2E418C3385Abd13F6C997Ed3;
    address public marketingFeeReceiver=0x937Ed84693CABcfb2E418C3385Abd13F6C997Ed3;
