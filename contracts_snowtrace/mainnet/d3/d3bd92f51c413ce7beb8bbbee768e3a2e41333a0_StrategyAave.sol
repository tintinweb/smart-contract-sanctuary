...
interface IIncentivesController {
    ...
    function claimableReward(address[] calldata assets, address user) external view returns (uint256);
}
...
contract StrategyAave is StratManager, FeeManager {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 pltFeeFeeAmount = nativeFeeBal.mul(beefyFee).div(MAX_FEE);
        IERC20(native).safeTransfer(pltFeeRecipient, pltFeeFeeAmount);
    ...
    function rewardsAvailable() public view returns (uint256) {
        ...
        assets[0] = aToken;
        assets[1] = varDebtToken;
        return IIncentivesController(incentivesController).claimableReward(assets, address(this));
    }
