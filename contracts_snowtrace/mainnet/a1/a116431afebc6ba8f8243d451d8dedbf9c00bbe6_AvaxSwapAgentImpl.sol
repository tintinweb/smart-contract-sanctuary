...
// File: openzeppelin-solidity/contracts/token/ERC0/SafeERC20.sol
...
// File: contracts/AvaxSwapAgentImpl.sol

pragma solidity 0.6.4;

contract AvaxSwapAgentImpl is Context {
    ...
    function fillOPC2AVAXSwap(bytes32 opcTxHash, address erc20Addr, address toAddress, uint256 amount) onlyOwner external returns (bool) {
    ...
    function swapAVAX2OPC(address erc20Addr, uint256 amount) payable external notContract returns (bool) {
        require(registeredERC20[erc20Addr], "not registered token");
