...
PumpAvax is a fully decentralized cryptocurrency on the Avalanche blockchain, 
contract has an automated buyback mechanism while maintaining HIGH APY on 
every swap made on our PUMPAVAX Protocol, with autoliquidity Generation
we have a rising price floor with frictionless yield generation. 
Enjoy your 875,000,000% APY just by holding our Native Token with
multiple utilities, NFT Based P2E Games (Token Requirement, Arcade Based Function) 
Get Paid in NFT's or our Native Tokens, Then stake your NFT's to mint AI generative Art NFT's !!!
...
contract PUMPAVAX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PUMPAVAX";
    string constant _symbol = "PUMPAVAX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // 0.55%
	uint256 public _maxWallet = _totalSupply.div(1); // 1%
    ...
    address public marketingFeeReceiver=0x2Fc235432087b857D089CB876224328cFbF9EB68;
