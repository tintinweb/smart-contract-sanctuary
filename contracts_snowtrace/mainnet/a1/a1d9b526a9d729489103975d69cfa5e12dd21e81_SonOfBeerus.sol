...
contract SonOfBeerus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SonOfBeerus";
    string constant _symbol = "SOB";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 0.5%
    uint256 public _maxWallet = _totalSupply.div(50); // 1%
    ...
    address public autoLiquidityReceiver=0xaA557cA81596a5e626F4290D47530C39C0D41AB8;
    address public marketingFeeReceiver=0xaA557cA81596a5e626F4290D47530C39C0D41AB8;
