...
// Stealth_Launch of COLAPRINT
// GET REWARDS IN $cat with COLAPRINT
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 cat = IBEP20(0x094BFaC9894d2A2A35771D0BD6d2447689190F32);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = cat.balanceOf(address(this));
        ...
        uint256 amount = cat.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            cat.transfer(shareholder, amount);
...
contract ColaPrint is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address cat = 0x094BFaC9894d2A2A35771D0BD6d2447689190F32; // lvt
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ColaPrint";
    string constant _symbol = "ColaPrint";
    ...
    address public autoLiquidityReceiver=0x6078D33B973aDF946346CB639bed5FfffFbAdf6D;
    address public marketingFeeReceiver=0x6078D33B973aDF946346CB639bed5FfffFbAdf6D;
