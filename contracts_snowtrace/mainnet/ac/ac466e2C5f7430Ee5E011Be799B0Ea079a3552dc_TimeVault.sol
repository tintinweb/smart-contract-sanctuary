...
contract TimeVault  {
  ...
  constructor() {
    ...
    function createVault(IERC20 token, string memory name, string memory securityword, uint256 duration, uint256 amount) public returns(uint256 vaultId) {
        ...
        vault.securityword = securityword;
    ...
    function withdraw(uint256 vaultId, string memory securityword) public {
        ...
        string memory word = vaults[vaultId].securityword;
        require(compareStrings(word, securityword));
