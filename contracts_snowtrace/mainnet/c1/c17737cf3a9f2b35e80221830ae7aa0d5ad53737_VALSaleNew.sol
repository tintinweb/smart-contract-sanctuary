...
contract VALSaleNew is Ownable {
    ...
    uint public constant MAX_SOLD = 40000 * VALdecimals;
    uint public constant PRICE = 10 * MIMdecimals / VALdecimals ;
    uint public constant MIN_PRESALE_PER_ACCOUNT = 1 * VALdecimals;
    uint public constant DEFAULT_MAX_PRESALE_PER_ACCOUNT = 100 * VALdecimals;
    ...
    /* allow non-blacklisted users to buy VAL */
