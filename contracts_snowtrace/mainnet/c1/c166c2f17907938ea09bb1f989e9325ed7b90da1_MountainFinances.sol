...
/**
    ...
    Stealth node protocol on avalanche network

    MOUNTAIN FINANCES

    Discord: https://discord.gg/WuMzuMezaB
...
contract MountainFinances is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("MountainFinances", "MF") PaymentSplitter(payees, shares) {
