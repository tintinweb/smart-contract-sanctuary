...
📍 Max wallet = 4%
📍 Max = 3%
📍 Slippage = 14-17% (you can also use auto slippage)

📲 TG = https://t.me/BlackShibaDoge
...
contract BlackShibaDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Black Shiba Doge";
    string constant _symbol = "Black Shiba";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 3 / 100; // 2%
    uint256 public _maxWallet = _totalSupply * 4 / 100; // 3%
