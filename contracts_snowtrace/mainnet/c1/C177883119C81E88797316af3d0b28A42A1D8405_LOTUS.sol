...
contract LOTUS is ERC721, Ownable {
    using Strings for uint256;

    address public verifiedSigner = 0xEA6b302f43eB26aC689e2A19F3BbEA126bB17fa7;
    address private memberOne = 0x42e5D81f296bb0df77d765C1863169624663635D;
    address private memberTwo = 0xD4aC020aa75Ab8251376984A100B44eb327B88D8;

    uint256 public NFT_MAX = 1500;
    uint256 public NFT_PRICE = 1 ether;
    uint256 public constant NFTS_PER_MINT = 10;
    string private _contractURI =
        "https://flowernft.mypinata.cloud/ipfs/QmVNEQ6UqnhPGAhaZNby2kFF5yQ6dhqfYm1MxRgBYv8cjx/";
    ...
    constructor() ERC721("LOTUS NETWORK", "LOTUS") {}
    ...
    function withdraw() external {
        ...
        payable(memberOne).transfer((currentBalance * 85) / 100);
        payable(memberTwo).transfer((currentBalance * 15) / 100);
    }
