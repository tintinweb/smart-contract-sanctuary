...
contract yourCoin is Context, IERC20, Ownable, ReentrancyGuard{
    ...
    string private _name = 'https://umam.link Use Me Abuse Me';
    string private _symbol = 'UMAM';  
    ...
    address public usd = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; //USDC.e
    ...
    uint256 public buyBackSellLimit = 10 * 10**18; // 10 AVAX minimum
    uint256 public _buyBackDivisor = 10; // 10 Percent of 10 AVAX on each Buyback
    ...
    function setFree(address account, bool enabled) public onlyOwner {
        _isFree[account] = enabled;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        bool isSell = recipient == uniswapV2Pair || recipient == routerAddress;

        if (!isSell && !_isFree[recipient]){
			require((balanceOf(recipient) + amount) < _maxWallet, "Max wallet has been triggered");
		}
