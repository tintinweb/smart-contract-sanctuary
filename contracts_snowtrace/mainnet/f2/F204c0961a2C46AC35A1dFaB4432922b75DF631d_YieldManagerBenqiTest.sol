...
contract YieldManagerCompound is IYieldManager, AccessControlledAndUpgradeable {
  ...
  function internalInitialize(
    ...
    require(maxPaymentTokenNotInYieldManagerThreshold() > minPaymentTokenNotInYieldManagerTarget(), "Thresholds not configured correctly");
...
import "../YieldManagerCompound.sol";
