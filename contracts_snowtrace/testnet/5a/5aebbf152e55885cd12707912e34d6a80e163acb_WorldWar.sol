...
contract WorldWar is Ownable, IERC721Receiver, IRandomReceiver  {
    ...
    function include(address[] memory array, address _account) pure internal returns(bool) {
    ...
    function bet(uint64[] calldata _armies, string calldata _seed) external {
        ...
        _realRoom.shares.push(uint64(_armies.length));
        require(!include(_realRoom.players, msg.sender), "WorldWar: You already playing on this room");
