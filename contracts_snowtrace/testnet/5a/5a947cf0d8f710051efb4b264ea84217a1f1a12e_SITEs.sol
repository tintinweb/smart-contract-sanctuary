...
contract SITEs is ERC20Permit, Ownable {
    ...
    constructor() ERC20("SITEs", "SITE", 9) ERC20Permit() {
    ...
    /**
        @notice increases SITEs supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SITEs
