 ...
 * @title JewelToken
 */
contract SolariToken is ERC20, Ownable, Authorizable {
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal virtual override antiWhale(sender, recipient, amount) onlyProfile(sender, recipient) {
    ...
    function delegateBySig(
        ...
        require(signatory != address(0), "JewelToken::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "JewelToken::delegateBySig: invalid nonce");
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "JewelToken::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(block.number, "JewelToken::_writeCheckpoint: block number exceeds 32 bits");
