...
contract SNFT is ERC1155, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    constructor() 
        ...
        GRBtoken = IERC20(0x1CCB525431A008827dF62fAf70E32894551F86Ba);
        staker = IStaker(0x5bD2d1fB1DDD86AEfB720cAd6B2D31301B6a145a);
    ...
    modifier updateRefineryData {
        ...
        refinery.waitingToClaim += mineralSpenditure * refinery.productionPerSecond / (10**18);
        _;
    }
    ...
    function calculateRefinery() external view returns(uint, uint) {
        ...
        return (mineralSpenditure, mineralSpenditure * refinery.productionPerSecond / (10**18));
    }
    ...
    function buyGRB(uint256 _amountGRB) external payable nonReentrant {
        require(msg.value >= _amountGRB / priceGRBfromAVAX, 'you need to send correct pack value');
