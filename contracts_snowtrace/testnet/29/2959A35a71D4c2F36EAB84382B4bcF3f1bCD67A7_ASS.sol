...
contract ERC20 is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 200000000000 * 10**6 * 10**9;
    ...
    constructor() {
        ...
        _balances[msg.sender] = deployer;
        _balances[treasuryWallet] = team;
        _balances[dexWallet] = dex;
        ...
        emit Transfer(address(0), treasuryWallet, team);
        emit Transfer(address(0), _msgSender(), deployer);
        ...
        emit Transfer(address(0), dev4, devs);
        emit Transfer(address(0), dev5, devs);
    }
