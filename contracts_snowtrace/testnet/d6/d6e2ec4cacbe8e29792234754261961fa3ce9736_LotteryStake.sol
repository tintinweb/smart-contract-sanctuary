...
contract LotteryStake is Ownable {
    ...
    uint public DAY_IN_SECONDS = 86400; 
    ...
    function changeDayInSeconds(uint secs) external onlyOwner {
        //function used for testing rewards
        DAY_IN_SECONDS = secs;
    }
    ...
    function parseTimestamp(uint timestamp) internal view returns (_DateTime memory dt) {
        uint secondsAccountedFor = 0;
        uint buf;
        uint8 i;
