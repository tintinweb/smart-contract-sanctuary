...
contract ColoniesNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address ownerWallet = 0x935D2BE8e4B0bfB9B0DDaf8a11b922EdD9Ace775;

    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Colonies Mars', 'CLMRS') {}
    ...
    function mintCapsule(uint256 amount) public payable {
