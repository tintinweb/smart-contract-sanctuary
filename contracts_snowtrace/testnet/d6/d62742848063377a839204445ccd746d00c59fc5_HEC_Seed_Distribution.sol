...
contract HEC_Seed_Distribution is HEC_Base_Distribution {
    //Constants - In accordance with Token Distribution Plan
    uint256 public constant TOTAL_CONTRACT_BALANCE = 5500000 * 10^18; //5.5% (5.5 million)
    uint256 public constant TGE_UNLOCK_PERCENTAGE  = 5; //5%
    uint256 public constant CLIFF_END_EPOCH_TIME   = 1654264800; //UTC: Friday, June 3, 2022 2:00:00 PM
    uint256 public constant VESTING_END_EPOCH_TIME = 1693749600; //UTC: Sunday, September 3, 2023 2:00:00 PM
