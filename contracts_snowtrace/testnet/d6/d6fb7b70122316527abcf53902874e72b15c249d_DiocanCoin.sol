...
contract DiocanCoin is ERC20, ERC20Burnable, Ownable, ERC20FlashMint {
    constructor() ERC20("DiocanCoin", "DIOCAN") {
        _mint(msg.sender, 666666 * 1000000000000000000);
    }
