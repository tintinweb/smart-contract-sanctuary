...
contract sLucky is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sLUCKY", "sLUCKY", 9) ERC20Permit() {
    ...
    /**
        @notice increases sLucky supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sLucky
