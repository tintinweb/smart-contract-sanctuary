...
contract Staking is Ownable {
    ...
    uint256 private minimumDays = 5 minutes;
    uint256 private lockTime = 5 minutes;
    ...
    function stake(uint256 tokens) public {
        ...
        user.stakerecord[user.stakecount].lastWithdrawTime = block.timestamp + lockTime;
    ...
    function unstake(uint256 _stakeCount) public {
        User storage user = users[msg.sender];   
        require(block.timestamp >= user.stakerecord[_stakeCount].lastWithdrawTime + lockTime, "Stake: Tokens not unlocked yet.");
