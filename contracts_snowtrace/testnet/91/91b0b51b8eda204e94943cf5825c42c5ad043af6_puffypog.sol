...
// File contracts/puffypog.sol


pragma solidity ^0.8.2;
contract puffypog is ERC721, ERC2981PerTokenRoyalties, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint256 private tokenPrice = 2000000000000000000; // 2 Avax
    ...
    constructor() ERC721("puffypog", "PP") {
        _tokenIdCounter.increment();
    }

    function approveArr(address to, uint256[] memory tokenId) public {
        for (uint i = 0; i < tokenId.length; i++) {
            ERC721.approve(to, tokenId[i]);
        }
    }
    ...
    function safeMint(uint256 amountToMint) public payable {
        ...
        for(uint256 i = 0; i < amountToMint; i++){
            ...
            _setTokenRoyalty(_tokenIdCounter.current(), 0x70333B5dd77dEFE502817644c7beFF00D618C7Ee, 400);
    ...
    function customBurn(uint256 tokenId) public {
	    require(ownerOf(tokenId) == msg.sender, "You don't have this puffys");
