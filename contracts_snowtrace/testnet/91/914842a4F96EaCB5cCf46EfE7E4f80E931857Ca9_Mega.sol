...
contract Mega is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Mega", "MGA", 9) ERC20Permit() {
    ...
    /**
        @notice increases mega supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess mega
