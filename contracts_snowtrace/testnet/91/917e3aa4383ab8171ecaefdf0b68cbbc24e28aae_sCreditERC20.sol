...
contract sCreditERC20 is ERC20Permit, Ownable {
    using LowGasSafeMath for uint256;
    ...
    constructor() ERC20("Staked Credit", "sCRDT", 9) ERC20Permit() {
    ...
    /**
        @notice increases Staked Credit supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Staked Credit
