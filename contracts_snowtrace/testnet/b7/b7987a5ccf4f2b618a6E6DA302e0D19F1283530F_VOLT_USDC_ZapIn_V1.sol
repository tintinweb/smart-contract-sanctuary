...
contract VOLT_USDC_ZapIn_V1 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    IUniswapV2Factory public joeFactory = IUniswapV2Factory(0xE4A575550C2b460d2307b82dCd7aFe84AD1484dd);

    IUniswapV2Router02 public joeRouter = IUniswapV2Router02(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);

    address public wavaxTokenAddress = address(0x97FD6Cf8991b205d7b9A082A666ae90E0b6184Ab);

    function setTokenAddress(address token_) public onlyOwner() {
        wavaxTokenAddress = token_;
    }

    function setFactory( address factory_ ) public onlyOwner() {
        joeFactory = IUniswapV2Factory(factory_);
    }

    function setRouter( address router_ ) public onlyOwner() {
        joeRouter = IUniswapV2Router02(router_);
    }
