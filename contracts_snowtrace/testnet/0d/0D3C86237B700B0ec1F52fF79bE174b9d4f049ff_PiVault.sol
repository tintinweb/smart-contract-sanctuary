...
contract UniZap is PiAdmin, ReentrancyGuard {
    ...
    address public constant WNative = address(0xd00ae08403B9bbb9124bB305C09058E32C39A48c);
    address public constant WETH = address(0x9668f5f55f2712Dd2dfa316256609b516292D554);

    IUniswapRouter public exchange = IUniswapRouter(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
...
contract FeeManager is Swappable, ReentrancyGuard {
    ...
    // Tokens used
    address public constant wNative = address(0xd00ae08403B9bbb9124bB305C09058E32C39A48c); // test
    address public constant piToken = address(0x65881118D84006E0a7c5AAd9498C3949a2019e8E); // Test
...
contract TestPiToken is PiAdmin, ERC20 {
    ...
    constructor() ERC20('Test-B-2Pi', 'Test-B-2Pi') {
...
contract Tanga {
    ...
    function tanga() public {
        console.log("1e50", 1e50);
        console.log("2 ** 256", type(uint).max);
        console.log("1.234e80", 1.234e76);
    }
}
...
contract PoolMock {
    address public constant dataProvider = address(0x0668EDE013c1c475724523409b8B6bE633469585);
...
contract CurveRewardsGaugeMock {
    ...
    IERC20 WMATIC = IERC20(0xd00ae08403B9bbb9124bB305C09058E32C39A48c);
...
contract ControllerCurveStrat is Swappable, Pausable, ReentrancyGuard {
    ...
    address constant public ETH = address(0x9668f5f55f2712Dd2dfa316256609b516292D554); // same than wNative
...
contract ControllerAaveStrat is Pausable, ReentrancyGuard, Swappable {
    ...
    address public constant DATA_PROVIDER = address(0x0668EDE013c1c475724523409b8B6bE633469585);
    address public constant INCENTIVES = address(0xa1EF206fb9a8D8186157FC817fCddcC47727ED55);
    address public constant POOL = address(0x76cc67FF2CC77821A70ED14321111Ce381C2594D);
