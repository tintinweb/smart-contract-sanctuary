...
contract PresaleSplitter is Ownable {
    ...
    uint256 public claimValueByDay = 100;
    ...
    function getClaimInterval() public view returns (uint256 time) {
        return block.timestamp + claimInterval;
    }

    function getClaimableValueByAddress(address wallet)
        public
        returns (uint256 claimableValue)
    {}
