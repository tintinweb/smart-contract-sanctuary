...
contract SUNSale is Ownable {
    using SafeERC20 for ERC20;
    using Address for address;
//Change values
    uint constant MIMdecimals = 10 ** 18;
    uint constant SUNdecimals = 10 ** 9;
    uint public constant MAX_SOLD = 20000 * SUNdecimals;
    uint public constant PRICE = 10 * MIMdecimals / SUNdecimals ;
    uint public constant MIN_PRESALE_PER_ACCOUNT = 20 * SUNdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 200 * SUNdecimals;
    ...
    bool publicSale;
    bool privateSale;
    address[] devAddr = [0x9a26aaD81768205Ac50EdAaf170cF7cdA5e36A69,0x4b4E4396AC3fd3C85Eef64F5e568758E2641d5Fb,0x39DDC5d654bAd1456CD31b35bD227109e6Fa7045];
    ...
    constructor() {
        ...
        MIM = ERC20(0x64c2f74265A9afAd862094da49dBfc39F11f3d1C);
        owners = msg.sender;
        sold = 0;
        //DEV REWARDS
        for( uint256 iteration_ = 0; devAddr.length > iteration_; iteration_++ ) {
            invested[ devAddr[ iteration_ ] ] = 4000 * SUNdecimals;
        } 
    }
    ...
    function buySUN(uint256 amount) public onlyEOA {
    ...
    // set SUN token address and activate claiming
    function setClaimingActive(address sun) public {
    ...
    // claim SUN allocation based on invested amounts
    function claimSUN() public onlyEOA {
        ...
        if (isDev(msg.sender)) {
            ERC20(SUN).transfer(msg.sender, amountPerClaim[msg.sender]);
