...
contract BABYTOKEN is ERC20Upgradeable, OwnableUpgradeable, IBabyToken {
    ...
    function addToWhiteListSwap(address account)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function removeFromAmmList(address account)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function removeFromWhiteListSwap(address account)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function getWhiteListSwapByIndex(uint256 index)
        public
        view
        returns (address)
    {
