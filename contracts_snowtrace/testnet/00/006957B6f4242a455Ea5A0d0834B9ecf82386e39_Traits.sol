...
contract Bank is Ownable, IERC721Receiver, Pausable {
    ...
    address private SheriffWallet = 0x70867141d70b948420b2cB380b36424a235875Bc;
    ...
    uint256 public DAILY_gold_RATE = 2500 ether;
...
contract Bonus is ERC721Enumerable, Ownable {
  ...
  uint256 public costBonus1 = 2 ether;
  uint256 public costBonus2 = 4 ether;
  uint256 public costBonus3 = 4 ether;
  uint256 public immutable MAX_TOKENSBonus1 = 50000;
  uint256 public immutable MAX_TOKENSBonus2 = 50000;
  uint256 public immutable MAX_TOKENSBonus3 = 50000;
  ...
  function mintBonus2(uint256 _mintAmount) public payable {
    require(!paused, "the contract is paused");
    uint256 supply = totalSupply();
    require(mintedBonus2 + _mintAmount <= MAX_TOKENSBonus1, "All tokens minted");
    require(_mintAmount > 0, "need to mint at least 1 NFT");
  ...
  function mintBonus3(uint256 _mintAmount) public payable {
    require(!paused, "the contract is paused");
    uint256 supply = totalSupply();
    require(mintedBonus3 + _mintAmount <= MAX_TOKENSBonus1, "All tokens minted");
    require(_mintAmount > 0, "need to mint at least 1 NFT");
...
contract Traits is Ownable, ITraits {
    ...
    IFarWestGames public chadAndScammer;
    ...
    function setGame(address _chadAndScammer) external onlyOwner {
        chadAndScammer = IFarWestGames(_chadAndScammer);
    }
    ...
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        IFarWestGames.FarWestGamesTraits memory s = chadAndScammer
        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                s.isChad ? "Chad #" : "Scammer #",
                tokenId.toString(),
                '", "description": "Chad & Scammer Game is a new generation play-to-earn NFT game on AVAX that incorporates probability-based derivatives alongside NFTs. Through a vast array of choices and decision-making possibilities, Chad & Scammer Game promises to instil excitement and curiosity amongst the community as every individual adopts different strategies to do better than one another and to come out on top. The real question is, are you #TeamChad or #TeamScammer? Choose wisely or watch the other get rich!", "image": "data:image/svg+xml;base64,',
