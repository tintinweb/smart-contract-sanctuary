...
contract PresaleSplitter is Ownable {
    ...
    function calcCanClaim(uint256 lastTime) internal returns (bool canClaim) {
        require((lastTime - getClaimInterval()) > 0, "TOO EARLY TO CLAIM");
        return true;
    }
    ...
    function claim() external {
        ...
        require(calcCanClaim(lastTimeClaim[msg.sender]), "TOO EARLY TO CLAIM");
        require(
