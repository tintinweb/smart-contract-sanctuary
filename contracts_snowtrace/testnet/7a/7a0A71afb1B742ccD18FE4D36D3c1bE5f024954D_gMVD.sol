...
contract gMVD is IgMVD, ERC20Permit {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "Only approved");
        _;
    }
    ...
    function setApproved(address _staking) public onlyOwner {
    ...
    /**
     * @notice pull index from sMVD token
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gMVD::getPriorVotes: not yet determined");
