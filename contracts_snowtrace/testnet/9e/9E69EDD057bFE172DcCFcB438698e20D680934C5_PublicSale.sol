...
contract PublicSale is Ownable {
    ...
    uint256 public constant totalAllocation = 35e6 * 1e18;
    uint256 public remainingAmount = 245e5 * 1e18;
    ...
    uint256 public lastTimeRelease = block.timestamp + 30 days + (5*30 days);
