...
Play Node Game and earn an average of 3% Daily APR on your Magic Internet Money.

Some will earn much more than their initial deposit, some will earn less. This game is a marathon, not a sprint. Choose your actions wisely and climb the leaderboard.

How you play the game determines your fate. Are you ready to play?

Website: https://nodegame.xyz
Discord: https://discord.com/invite/ZENErGfSbU
Twitter: https://twitter.com/nodegameAVAX
...
contract NodeGame is ReentrancyGuard {
    ...
    function buyNodes(address ref, uint256 amount) public nonReentrant{
        require(initialized, "Game has not begun.");
        uint256 balance = nodeToken.balanceOf(address(this));
        nodeToken.transferFrom(msg.sender, address(this), amount);
        uint256 powerBought = calculatePowerUp(amount, balance);
