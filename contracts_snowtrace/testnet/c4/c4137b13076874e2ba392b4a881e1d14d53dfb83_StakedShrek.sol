...
contract StakedShrek is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Shrek", "sSHK", 9) ERC20Permit() {
    ...
    /**
        @notice increases StakedShrek supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Shrek
