...
contract Traits is Ownable, ITraits {
    ...
    function setWoolf(address _policeAndThief) external onlyOwner {
   ...
   */
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory svgString = string(abi.encodePacked(
                s.isThief ? drawTrait(traitData[0 + shift][s.clothes]) : drawTrait(traitData[0 + shift][s.uniform]),
                drawTrait(traitData[1 + shift][s.hair]),
                drawTrait(traitData[2 + shift][s.facialHair]),
                drawTrait(traitData[3 + shift][s.eyes]),
                s.isThief ? drawTrait(traitData[4 + shift][s.headgear]) : drawTrait(traitData[4 + shift][s.alphaIndex]),
                drawTrait(traitData[5 + shift][s.accessory]),
                s.isThief ? drawTrait(traitData[6 + shift][s.neck]) : ''
            ));
    ...
    function compileAttributes(uint256 tokenId) public view returns (string memory) {
        ...
        if (s.isThief) {
            traits = string(abi.encodePacked(
                    attributeForTypeAndValue(_traitTypes[1], traitData[0][s.clothes].name), ',',
                    ...
                    attributeForTypeAndValue(_traitTypes[5], traitData[4][s.headgear].name), ',',
                    attributeForTypeAndValue(_traitTypes[6], traitData[5][s.accessory].name), ',',
                    attributeForTypeAndValue(_traitTypes[7], traitData[6][s.neck].name), ','
                ));
        } else {
            traits = string(abi.encodePacked(
                    attributeForTypeAndValue(_traitTypes[0], traitData[7][s.uniform].name), ',',
                    attributeForTypeAndValue(_traitTypes[2], traitData[8][s.hair].name), ',',
                    attributeForTypeAndValue(_traitTypes[3], traitData[9][s.facialHair].name), ',',
                    attributeForTypeAndValue(_traitTypes[4], traitData[10][s.eyes].name), ',',
                    attributeForTypeAndValue(_traitTypes[5], traitData[11][s.alphaIndex].name), ',',
                    attributeForTypeAndValue(_traitTypes[6], traitData[12][s.accessory].name), ',',
