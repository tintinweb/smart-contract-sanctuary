...
contract Axe is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address nodeManager,
        address uniV2Router
    ) ERC20("Axe", "AXE") PaymentSplitter(payees, shares) {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair,"TKN: The Swap pair cannot be modified");
