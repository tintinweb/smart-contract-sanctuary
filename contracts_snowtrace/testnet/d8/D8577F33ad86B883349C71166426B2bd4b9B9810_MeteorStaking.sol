...
contract MeteorStaking is Ownable {
    ...
    /**
        @notice stake MTR to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sMTR from warmup
    ...
    /**
        @notice forfeit sMTR in warmup and retrieve MTR
     */
    ...
    /**
        @notice returns the sMTR index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract MTR holdings, including bonuses provided
        @return uint
     */
