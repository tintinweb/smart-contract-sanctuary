...
contract gCESTA is ERC20Upgradeable {


    IsCESTA public sCESTA;
    ...
    function initialize(string memory name_, string memory symbol_, IsCESTA sCESTA_, address staking_) external initializer {
    ...
    /**
        @notice converts gCESTA amount to CESTA
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts CESTA amount to gCESTA
        @param _amount uint
        @return uint
     */
