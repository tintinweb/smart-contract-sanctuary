...
contract MustafaAkademi is ERC20Interface{
    string public name = "Mustafa Akademi";
    string public symbol = "MAK";
...
contract MustafaAkademiICO is MustafaAkademi{
   ...
   receive () payable external{
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success){
        ...
        MustafaAkademi.transferFrom(from, to, tokens);  // same as super.transferFrom(to, tokens);
        return true;
