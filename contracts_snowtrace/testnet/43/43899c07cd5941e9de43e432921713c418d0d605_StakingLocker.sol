...
contract StakingLocker is ArableAccessControl, IStakingLocker {
    ...
    function lockToken(
        ...
        require(startTime < unlockTime, "Invalid unlockTime");
        ...
        emit TokenLocked(address(token), msg.sender, beneficiary, amount, startTime, unlockTime, lockSize);
    ...
    function releaseLockTo(address beneficiary, uint256 lockId) external {
