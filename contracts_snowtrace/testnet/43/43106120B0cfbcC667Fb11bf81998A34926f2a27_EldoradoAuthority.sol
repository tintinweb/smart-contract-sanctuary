...
contract EldoradoAuthority is IEldoradoAuthority, EldoradoAccessControlled {
    /* ========== STATE VARIABLES ========== */
    ...
    constructor(
        ...
        address _policy,
        address _vault
    ) EldoradoAccessControlled(IEldoradoAuthority(address(this))) {
        governor = _governor;
