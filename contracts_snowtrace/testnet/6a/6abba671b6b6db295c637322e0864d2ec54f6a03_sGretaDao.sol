...
contract sGretaDao is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 150000 * 10 ** 2;
    ...
    constructor() ERC20("Staked Greta", "sGRT", 2) ERC20Permit() {
    ...
    /**
        @notice increases sGRT supply to increase staking balances relative to profit_
    ...
    function _storeRebase( uint previousCirculating_, uint profit_, uint epoch_ ) internal returns ( bool ) {
        uint rebasePercent = profit_.mul( 1e2 ).div( previousCirculating_ );
