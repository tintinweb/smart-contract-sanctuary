...
contract sSkadi is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Skadi", "sSKI", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSKI supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSKI
