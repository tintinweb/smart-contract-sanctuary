...
contract CryptoMandala is ERC721, Ownable {
    using SafeMath for uint256;
    uint public constant MAX_MANDALAS = 11111;
    bool public isActive = false;
    address public feeAddress1 = 0x7B9c08898B60345671BaC9091F438382A1Fc4799;
    address public feeAddress2 = 0xb78038483f6777e393DF27B83991C7297a2AB877;
    address public feeAddress3 = 0x671E2f0A9cD309FDa61a433923d5E7fc149AbD56;
    ...
    constructor() ERC721("CryptoMandala","CryptoMandala")  {
        setBaseURI("");
        feeReceiver = payable(feeAddress1);
        feeReceiver2 = payable(feeAddress2);
        feeReceiver3 = payable(feeAddress3);

        TeamMints[feeAddress1] = 140;
        TeamMints[feeAddress2] = 100;
        TeamMints[feeAddress3] = 100;
    }

    function mintForTeam(uint count) public
    {
        require(msg.sender == feeAddress1 || msg.sender == feeAddress2 || msg.sender == feeAddress3, "Only for the team");
    ...
    function getMandalas(uint256 count) public payable {
        require(isActive, "Sales is not started yet");
        require(totalSupply() < MAX_MANDALAS, "Sale has already ended");
        require(count > 0 && count < 50, "You can generate minimum 1 Mandala and maximum of 50 Mandalas");
        require(totalSupply().add(count) <= MAX_MANDALAS, "Exceeds MAX_MANDALAS");
        require(msg.value >= (1.51 ether * count), "Avax value sent is below the price");
    ...
    function withdrawTokens(address tokenAddress) public onlyOwner
    {
        ...
        token.transferFrom(address(this), feeAddress3, amount3);
    }
