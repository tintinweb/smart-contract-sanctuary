    ...
    ERC2981PerTokenRoyalties
{
  ...
  */
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "Sorry Fren, you have reached your Frog Frens limit."
        );
        require(!paused, "Contract paused. Please check https://t.me/FrogFrens.");
        require(
            _mintAmount <= maxMintForTx,
            "Sorry Fren, you have breached the max number of mints per transaction."
        );
        require(
            supply + _mintAmount <= maxSupply,
            "Sorry Fren, all our Frog Frens are now minted!"
        );
  ...
  */
    // Removing to make NFT's immutable
