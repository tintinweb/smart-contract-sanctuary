...
contract Multisig is Ownable {
    ...
    function isSignedTx() public view returns (bool) {
    ...
    ERC2981PerTokenRoyalties
{
    ...
    uint256 public lotteryIntervalDays = 0;
    uint256 private epochDay = 86400;
    uint256 public cost = 1 ether;
    uint256 public maxSupply = 20;
    uint256 public maxMintForTx = 30;
  ...
  */
    ...
    */
    function selectAWinner(
        ...
        if ((it < 5) && alreadyWon) {
            uint256 newIt = it + 1;
            return selectAWinner(newIt, epochNow, sender, lotteryDate);
        } else {
