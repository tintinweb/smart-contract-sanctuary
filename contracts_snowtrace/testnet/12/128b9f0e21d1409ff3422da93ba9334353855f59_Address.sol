...
contract CHILL is ERC20Permit, Ownable {
    ...
    constructor() ERC20("CHILL", "CHIL", 9) ERC20Permit() {
    ...
    /**
        @notice increases CHILL supply to increase staking balances relative to profit_
