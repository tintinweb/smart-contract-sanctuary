...
// File @yetiswap/exchange-contracts/contracts/yetiswap-core/interfaces/[email protected]

pragma solidity >=0.5.0;

interface IYetiSwapERC20 {
...
contract StakingRewards is ReentrancyGuard, Ownable {
    ...
    function stakeWithPermit(uint256 amount, uint deadline, uint8 v, bytes32 r, bytes32 s) external nonReentrant updateReward(msg.sender) {
        ...
        // permit
        IYetiSwapERC20(address(stakingToken)).permit(msg.sender, address(this), amount, deadline, v, r, s);
...
// File contracts/YTSNewLiqPoolManager.sol
