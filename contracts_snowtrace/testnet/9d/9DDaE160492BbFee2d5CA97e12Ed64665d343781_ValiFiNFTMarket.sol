...
contract ValiFiNFTMarket is ERC721URIStorage {
    uint256 tokenId = 1;
    ...
    constructor() ERC721("ValiFi NFT Market", "VF") {
    ...
    function createNFT(string memory _tokenURI, uint256 _price) public payable {
        ...
        nfts[tokenId] = NFT(tokenId, _price, payable(msg.sender), false, false);
    ...
    function markNFTForAuction(uint256 _tokenId, uint256 _price) public {
        require(_exists(_tokenId), "NFT does not exist");
        require(
            nfts[_tokenId].owner == msg.sender,
            "You can not mark others NFT for auction.!"
        );
        nfts[_tokenId].price = _price;
        nfts[_tokenId].isForAuction = true;
    }

    function setNFTForAuction(uint256 _tokenId, uint256 _price) public {
        require(_exists(_tokenId), "NFT does not exist");
        nfts[_tokenId].price = _price;
    }
