...
contract TimeFrogs is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  */
  ...
  /*
    @function reveal()
    @description - Allows the nfts to be viewed
  */
  ...
  */
  ...
  /*
    @function setNotRevealedURI(_notRevealedURI)
    @description - Sets the metadata URI
    @param <string> _notRevealedURI - The new URL for metadata
  */
  ...
  */
  function stakeToTime() public payable onlyOwner {
  ...
  */
  ...
  /*
    @function lotterIsActive()
    @description - Checks if lottery is active
    @returns <bool> - True/False lotter is active.
  */
  ...
  */
  function removeFeesForAddress(address addr) public onlyOwner {
  ...
  */
  function airDrop(address to) public onlyOwner {
      require(airDropActive, 'ERROR: Air drop not active');
  ...
  */
  ...
  function togglePollVoting(bool value) public onlyOwner {
      pollOpen = value;
  }
