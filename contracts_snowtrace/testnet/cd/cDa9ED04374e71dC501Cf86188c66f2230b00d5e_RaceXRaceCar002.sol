...
contract RaceXRaceCar002 is ERC721Enumerable, ERC2981RaceXNFCarRoyalties, Ownable {
  using Strings for uint256;
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(msg.value >= (cost*_mintAmount) - ((cost / 4) * _mintAmount), "Please ensure the correct price is sent");
    ...
    (bool sent, ) = payable(royaltyContractAddress).call{value: (reflectAmount/7)*4}("");
    require(sent);
