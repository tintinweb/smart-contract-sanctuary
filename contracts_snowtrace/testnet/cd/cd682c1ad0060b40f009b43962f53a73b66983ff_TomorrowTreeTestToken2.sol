...
/*
----------------------------------------------------------------------------------------------------
Tomorrow Tree Test Token version 2 - Test 1
----------------------------------------------------------------------------------------------------

----------------------------------------------------------------------------------------------------
The OpenZeppelin ERC20Snapshot contract was inspired by Jordi Baylina's MiniMeToken to record historical balances:
...
contract TomorrowTreeTestToken2 is Context, Ownable, ERC20Burnable, ERC20Pausable {
    
    constructor() ERC20("Tomorrow Tree Test Token 2", "TTTT2") {
    }
...
/*----------------------------------------------------------------------------------------------------
                                       OpenZeppelin's ERC20Snapshot contract
----------------------------------------------------------------------------------------------------*/
...
function takeSnapshot() onlyOwner external returns(uint256) {
        return _snapshot();
    }

    function getCurrentSnapshotId() onlyOwner external view returns (uint256) {
        return _getCurrentSnapshotId();
    }

    function balanceOfAt(address account, uint256 snapshotId) onlyOwner external view returns (uint256) {
        return _balanceOfAt(account, snapshotId);
    }

    function totalSupplyAt(uint256 snapshotId) onlyOwner external view returns (uint256) {
