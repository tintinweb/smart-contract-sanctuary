...
contract ProjectX is ERC20, Ownable, PaymentSplitter {
    ...
    function _transfer(
        ...
        if (automatedMarketMakerPairs[recipient] && sellFeeEnabled) {
            uint256 smoothingTokens = (amount * sellFee) / 100;
            super._transfer(sender, smoothingReserveAddress, smoothingTokens);
            //if (smoothingTokens < amount) {
                amount -= smoothingTokens;
            //}
        }
