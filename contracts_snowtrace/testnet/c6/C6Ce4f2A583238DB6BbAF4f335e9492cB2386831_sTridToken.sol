...
contract sTridToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Trid", "sTRID", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTRID supply to increase staking balances relative to profit_
