...
contract Noonercoin is ERC20{
   ...
   int private count = 0; 
   uint256 previousCyclesTotalTokens = 9993504;
   uint256 previousCyclesTotalWei = 260947850902122627;
   uint256 indexs = 1;
   uint256[] randomVariableArray = [225];
   uint256[] previousCyclesBalance = [9993504];
   uint256[] previousCyclesWeiBalance = [260947850902122627];
   
   constructor(uint256 totalSupply_, string memory tokenName_, string memory tokenSymbol_,uint256 decimal_, uint256 mintingRateNoonerCoin_,uint256 mintingRateNoonerWei_, uint256 frequency_, uint256 fundersAmount_) public ERC20("XDC","XDC"){
       _totalSupply = totalSupply_;
       _name = tokenName_;
       _symbol = tokenSymbol_;
       _decimal = decimal_;
       mintingRateNoonerCoin = mintingRateNoonerCoin_;
       mintingRateNoonerWei = mintingRateNoonerWei_;
    ...
    //    mintingRateNoonerWei = 0;
       ...
       noonercoin[adminAddress] = 9993504;
       noonerwei[adminAddress] = 260947850902122627;
   }
  ...
  function getLastMintingTimeAndStartTimeDifference() public view returns (uint256) {
    ...
    function getLastMintingWeiRate() public view returns(uint256) {
