...
// support AVAX and multi tokens on a single contract
contract HunnyPokerV2 is PausableUpgradeable, WhitelistUpgradeable {
    ...
    function withdraw(
        ...
        if (token == address(0)) {
            ...
            IERC20Upgradeable(token).safeTransfer(reception, amount);
