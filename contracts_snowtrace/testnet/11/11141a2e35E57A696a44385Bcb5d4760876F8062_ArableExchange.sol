...
contract ArableExchange is Ownable {
    ...
    function swapSynths(address inToken, uint256 inAmount, address outToken) external {
        ...
        uint256 inTokenPrice = oracleContract.price(inToken);
        uint256 outTokenPrice = oracleContract.price(outToken);
        ...
        uint256 outAmount = inTokenPrice * inAmount / outTokenPrice;
...
interface IArableOracle {
    ...
    function dailyRewardRate(uint256 farmId, address rewardToken) external view returns (uint256);
}
