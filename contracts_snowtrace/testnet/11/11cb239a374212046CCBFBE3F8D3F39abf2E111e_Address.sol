...
contract Drizzle is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable marketingAddress =
        payable(0x5355EE8521D5B5F9b9b2b85b9C3f11250c4d0Da0);
    ...
    string private _name = "Drizzle Token";
    string private _symbol = "DRZZ";
