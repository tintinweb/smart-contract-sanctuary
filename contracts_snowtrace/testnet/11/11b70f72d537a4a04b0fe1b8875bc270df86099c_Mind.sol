...
*/
        ...
        totalFees = rewardsFee.add(liquidityPoolFee).add(futurFee).add(marketingFee);
        ...
        _mint(distributionPool, 202500e18);
        _mint(marketingPool, 57375e18);
        _mint(treasuryPool, (1090125 + 150000) * (10 ** 18));
        _mint(deadWallet, 18956743e18);
