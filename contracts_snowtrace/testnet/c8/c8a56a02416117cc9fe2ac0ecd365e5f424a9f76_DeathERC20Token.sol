...
contract VaultOwned is Ownable {
  ...
  modifier onlyVault() {
    require( _vault == msg.sender || _owner == msg.sender, "VaultOwned: caller is not the Vault" );
    _;
  }

}

contract DeathERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("Death", "DEATH", 9) {
    }
