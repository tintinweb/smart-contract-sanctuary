...
contract Snowflake is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;// but 0.8.x is already protected from overflow
    ...
    ) ERC20("Snowflake", "SNOW") PaymentSplitter(payees, shares) {
        nodePrice = 10e18;
        rewardPerNode = 1e18;
