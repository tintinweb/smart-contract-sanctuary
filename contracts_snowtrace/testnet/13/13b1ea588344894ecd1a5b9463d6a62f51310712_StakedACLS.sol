...
contract StakedACLS is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked AchillesDAO", "sACLS", 9) ERC20Permit() {
    ...
    /**
        @notice increases StakedACLS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess StakedACLS
