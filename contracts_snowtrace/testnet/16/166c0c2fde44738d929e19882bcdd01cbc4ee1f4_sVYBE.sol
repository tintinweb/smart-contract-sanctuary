...
contract sVYBE is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sVYBE", "sVYBE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sVYBE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess CHILL
