...
contract PresaleMigration is Ownable {
  ...
  function migrate() external onlyInitialized {
    ...
    require(block.timestamp < endTimestamp, "swapping of aTOKEN has ended");
  ...
  function reclaim() external {
    require(senderInfo[msg.sender] > 0, "user has no aTOKEN to withdraw");
    require(block.timestamp > endTimestamp, "aTOKEN swap is still ongoing");
  ...
  function withdraw() external onlyOwner {
    require(block.timestamp > endTimestamp, "swapping of aTOKEN has not ended");
