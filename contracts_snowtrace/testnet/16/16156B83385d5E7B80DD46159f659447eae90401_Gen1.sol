...
contract Gen1 is  ERC721URIStorage, ERC721Enumerable, Ownable { 
    ...
    function data_m1 () internal pure returns (string memory _data_m1) {
        _data_m1 = string(abi.encodePacked('<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 500" enable-background="new 0 0 500 500" xml:space="preserve" style="background-color:black">','\n'));
    }
    ...
    function data_m6 (string memory _data_m5) internal pure returns (string memory _data_m6) {
         _data_m6 = string(abi.encodePacked('<path class="svg1" filter="url(#f1)" style="fill: none; stroke: white; stroke-width: 0.9; stroke-linecap: round; stroke-linejoin:  miter; stroke-miterlimit: 1;" d="')); 
    ...
    function setGen_v (uint256 _gen_v) public onlyOwner {
        gen_v = _gen_v;
    }
