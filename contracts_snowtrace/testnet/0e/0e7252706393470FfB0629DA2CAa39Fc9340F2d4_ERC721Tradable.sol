...
contract ERC721Tradable is ERC721Enumerable, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    * @dev Mints a token to an address with a tokenURI.
     ...
     */
    function mintTo(address to_, string memory ipfsHash_) public onlyOwner {
        uint256 currentTokenId = _nextTokenId.current();
        _nextTokenId.increment();
        _safeMint(to_, currentTokenId);
        _tokenURIs[currentTokenId] = ipfsHash_;
    }
