...
contract Distributor is Ownable {
    ...
    constructor( address _treasury, address _credit, uint32 _epochLength, uint32 _nextEpochTime ) {        
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return CRDT.totalSupply().mul( _rate ).div( 1000000 );
    }
