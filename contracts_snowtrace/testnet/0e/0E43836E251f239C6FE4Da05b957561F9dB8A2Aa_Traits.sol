    ...
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory svgString = string(
            abi.encodePacked(
                ...
                drawTrait(
                    traitData[3 + shift][s.hat % traitCountForType[3 + shift]]
                ),
                s.isChad
                    ? drawTrait(
                        traitData[4 + shift][
                            s.accessories % traitCountForType[4 + shift]
                        ]
                    )
                    : drawTrait(
                        traitData[4 + shift][
                            s.backpack % traitCountForType[4 + shift]
                        ]
                    ),
                s.isChad
                    ? ""
                    : drawTrait(
                        traitData[5 + shift][
                            s.facialHair % traitCountForType[5 + shift]
                        ]
                    ),
                s.isChad
                    ? ""
                    : drawTrait(
                        traitData[6 + shift][
                            s.weapon % traitCountForType[6 + shift]
                        ]
                    )
            )
        );
        ...
        if (s.isChad) {
            ...
            traits = string(
                abi.encodePacked(
                    ...
                    attributeForTypeAndValue(
                        _traitTypes[3],
                        traitData[13][s.hat % traitCountForType[13]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[4],
    ...
    Pausable
{
        ...
        returns (BasicApesTokenTraits memory t)
    {
        ...
        seed >>= 16;
        t.hat = selectTrait(uint16(seed & 0xFFFF), 3 + shift);
