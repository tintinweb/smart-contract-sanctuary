...
contract MintFactory is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public _maxSupply = 4999;
    ...
    constructor() ERC721("Leveraged Leopards", "LEOPARD") {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmfCmgoXYp5fFxrPycaqxwJKduJXQ7bvepM7AvkhmkhHRL");
        _owner = msg.sender;
