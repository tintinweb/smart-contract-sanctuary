...
contract AvalancheFriendsCollectible is ERC721, Ownable {
    ...
    IERC20 ausd = IERC20(address(0xFb8FA9f5F0bD47591bA6f7C75FE519E3E8FDe429)); // testnet USDC
    ...
    uint public constant MAX_MINTS_PER_ADDRESS = 10;
    uint public _tokenEach = 1000000000000000000; // 1000 EMBR
    uint public _price = 500000000000000000; // 500 AUSD
    ...
    function mint(address to, uint _amount) public {
        ...
        require(ausd.balanceOf(to) >= _amount, "User balance not high enough");

        if (_amount > 0) {
            ausd.transferFrom(to, _feeReceiver, _amount);   
        }   
    ...
    function claimTokens(uint256[] memory tokenIds) public payable { // claiming EMBR rewards for all the NFTs they own
        ...
        _claimToken.transferFrom(address(this), msg.sender, amount);
	}
