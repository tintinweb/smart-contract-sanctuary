...
// File contracts/strategy/BlizzardStrategyV2.sol
...
// File contracts/strategy/BlizzardStrategyV2Payable.sol
...
// File contracts/interface/IAaveIncentivesController.sol
...
// File contracts/lib/DexLibrary.sol
...
// File contracts/strategy/strategies/AaveStrategyAvaxV1.sol
...
contract AaveStrategyAvaxV1 is BlizzardStrategyV2Payable, ReentrancyGuard {
    ...
    constructor(
        string memory _name
        // // address _rewardController,      // 0
        // // address _tokenDelegator,        // 1
        // // address _avToken,               // 2
        // // address _avDebtToken,           // 3
        // // address _timelock,              // 4
        // address[5] memory addressesArray,
        // // uint256 _leverageLevel,         // 0
        // // uint256 _safetyFactor,          // 1    
        // // uint256 _leverageBips,          // 2
        // // uint256 _minMinting,            // 3
        // // uint256 _minTokensToReinvest,   // 4
        // uint256[5] memory uintArray,
        // uint256[3] memory _fees, // fees[0] performanceFee , fees[1] adminFee , fees[2] devFees
        // uint256 _reinvestRewardBips 
    ) {
        name = _name;
        // rewardController = IAaveIncentivesController(addressesArray[0]);
        // tokenDelegator = ILendingPool(addressesArray[1]);
        // _updateLeverage(
        //     uintArray[0],        // _leverageLevel,
        //     uintArray[1],        // _safetyFactor,
        //     uintArray[3],        // _minMinting,
        //     uintArray[2]        // _leverageBips
        // );

        devAddr = 0xb686a81F32D9c22e29315075dF64a390ba3Fe83C;
        adminAddr = 0x6587D861B7cEa89E0E78AE4897a1A757bB40Cee5;

        // avToken = addressesArray[2]; //_avToken;
        // avDebtToken = addressesArray[3]; //_avDebtToken;

        // setAllowances();
        // updateMinTokensToReinvest(uintArray[4]); //updateMinTokensToReinvest(_minTokensToReinvest);
        // updatePerformanceFee(_fees[0]);
        // updateAdminFee(_fees[1]);
        // updateDevFee(_fees[2]);
        // updateReinvestReward(_reinvestRewardBips);
        // updateDepositsEnabled(true);
        // transferOwnership(addressesArray[4]);
