...
contract StripStaking is Ownable {

    using SafeMath for uint256;
    using SafeMath for uint32;
    using SafeERC20 for IERC20;

    address public immutable Strip;
    ...
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        IERC20( Strip ).safeTransferFrom( msg.sender, address(this), _amount );
    ...
    function forfeit() external {
        ...
        IERC20( Strip ).safeTransfer( msg.sender, info.deposit );
    }
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        IERC20( Strip ).safeTransfer( msg.sender, _amount );
    }
    ...
    function contractBalance() public view returns ( uint ) {
        return IERC20( Strip ).balanceOf( address(this) ).add( totalBonus );
    }
