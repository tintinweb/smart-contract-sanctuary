...
contract RetroVisionToken is IERC20, Context, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        setInternalWalletAddress(WALLET_RESOURCE_LIQUIDITY, _resourceLiquidityWallet);
        ...
        _accounts[address(this)].balance = _remainingSeed;
        ...
        setAccountExcluded(
            address(this),
            true,
            "Constructor: Contract address exclusion"
        );
