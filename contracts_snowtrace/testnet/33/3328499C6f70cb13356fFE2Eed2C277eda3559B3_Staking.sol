...
contract Staking is Ownable {
    ...
    /**
        @notice stake MAXI to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sMAXI from warmup
    ...
    /**
        @notice forfeit sMAXI in warmup and retrieve MAXI
     */
    ...
    /**
        @notice returns the sMAXI index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract MAXI holdings, including bonuses provided
        @return uint
     */
