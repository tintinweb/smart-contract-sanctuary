...
contract TestReflect is Ownable {		
	string public name = "The RaceX Reflection Utility";
  ...
  function claimKeyReflection() public {
    payable(msg.sender).transfer(_keyReflectionBalance[msg.sender]);
  }

  function claimCarReflection() public {
    payable(msg.sender).transfer(_carReflectionBalance[msg.sender]);
  }
