...
contract gEldaERC20Token is IgELDA, ERC20, ERC20Permit, ERC20Votes {
    ...
    constructor(address _sELDA) 
    ERC20("Governance ELDA", "gELDA") 
    ERC20Permit("Governance ELDA") 
    {
     ...
     * @param _sELDA address
  
    function migrate(address _staking, address _sELDA) external override onlyApproved {
        ...
        require(_sELDA != address(0), "Zero address found");
        sELDA = IsELDA(_sELDA);
    }
    */
    ...
    /**
     * @notice pull index from sELDA token
     */
    ...
    /**
        @notice converts gELDA amount to ELDA
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts ELDA amount to gELDA
        @param _amount uint
        @return uint
     */
