...
contract EmrbProtocolFeeDistrubutor is Ownable { 
    using SafeERC20 for IERC20;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function add(
        ...
        require(
            !feeTokenAddresses.contains(address(_feeToken)),
        ...
        feeTokenAddresses.add(address(_feeToken));
    ...
    // Deposit EMBR tokens to EmrbProtocolFeeDistrubutor.
    function deposit(
        uint256 _amount,
        address _to
    ) public {
