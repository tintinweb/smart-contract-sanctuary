...
/** 
    @title AtpadPresale CROSS this is the version for crossChain
    @notice This is a Natspec commented contract by AtomPad Development Team
    @notice Version v1.1.8 date: jan 19, 2022
    
    v1.1.8
        - routine swap()
            remove claimDisabled()
            added swapEnabled 
        ...
        - routine DepositTokens()
            remove whenNotStarted from routine DepositTokens;

        - routine swapClaim()
            deduct tokenSupply with _amount before claim

        - routine returnWantTokens()
            deduct tokenSupply with totalAmount
    ...
    v1.1.7
        - added setAllocPercentage()
        - now admin can fill this contract with users and allocpercentage
        - removed stakePool from constructor
