...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc16A1b60175d16be6F2ED0bA506ca0e6EfBA8e08); // reward address
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
        _token = msg.sender;
    }
...
contract DUMPJAY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc16A1b60175d16be6F2ED0bA506ca0e6EfBA8e08; // chad
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DUMPJAY";
    string constant _symbol = "DUMPJAY";
    ...
    address public autoLiquidityReceiver=0xe5eB1fa046d96093623C7099921e1812a82f00F1; //liq address
    address public marketingFeeReceiver=0xe5eB1fa046d96093623C7099921e1812a82f00F1; // marketing address
    ...
    constructor () Auth(msg.sender) {
        address _router = 0x2D99ABD9008Dc933ff5c0CD271B88309593aB921;
