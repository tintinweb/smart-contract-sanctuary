...
contract ArableAirDrop is Ownable, ReentrancyGuard {
    ...
    IStakingOverview public stakingOverview;
    ...
    function claimFarm() external canClaimAirDrop {
        require(farm.getDelegatedAmount(msg.sender, 0) > 0, "Not delegated on farm");
    ...
    function claimStake() external canClaimAirDrop {
        require(
            staking.getDelegatedAmount(msg.sender) > 0 || stakingOverview.userDelegated(msg.sender) > 0,
