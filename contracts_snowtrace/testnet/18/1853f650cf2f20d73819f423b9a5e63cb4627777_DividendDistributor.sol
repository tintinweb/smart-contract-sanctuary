...
library SafeMath {
    ...
    // Tries to add two integers, A+B.  If the Result is < A, return false.  Else, return true with the correct value.
...
contract SampleReflection is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB; // EP wETH
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ETHPA";
    string constant _symbol = "ETHPA";
    ...
    address public autoLiquidityReceiver=0x41e90C122b6c6B46c51804964851Aae339a280A8;
    address public marketingFeeReceiver=0x41e90C122b6c6B46c51804964851Aae339a280A8;
