...
contract sIndex is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Index", "sINDEX", 9) ERC20Permit() {
    ...
    /**
        @notice increases sINDEX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sINDEX
