...
// https://vorlex.co Contract For Vorlex NFT Marketplace for SMART DIGITAL ASSETS
// Vorlex Contract written by Kaptain Ti 
// Vorlex Platform Owned by Franklin Ndekwe and Kaptain Ti(née Caleb Thompson)
...
contract Vorlex  is ERC1155, ERC1155Holder,  AccessControl  {
    ...
    */
    ...
    event Bidded(bytes32 indexed sale_id, address indexed previous_bidder, uint256 indexed previous_worth);
    ...
    */
    ...
    function placeBid(bytes32 sale_id) external payable {
        ...
        require (sales[sale_id].expiry == 0 ? 
                 msg.value  >= sales[sale_id].worth : 
                 (msg.value - sales[sale_id].worth) >= (sales[sale_id].worth /20), 
                 "LOW_BID_AMOUNT" ); 
        ...
        emit Bidded(sale_id, sales[sale_id].highest_bidder, sales[sale_id].worth);
