   ...
   */
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory svgString = string(abi.encodePacked(
                ...
                drawTrait(traitData[5 + shift][s.headgear % traitCountForType[5 + shift]]),
                drawTrait(traitData[6 + shift][s.neckGear % traitCountForType[6 + shift]])
            ));
    ...
    function compileAttributes(uint256 tokenId) public view returns (string memory) {
        ...
        if (s.isChad) {
            traits = string(abi.encodePacked(
                    attributeForTypeAndValue(_traitTypes[0], traitData[0 + shift][s.uniform % traitCountForType[0 + shift]].name), ',',
                    attributeForTypeAndValue(_traitTypes[1], traitData[1 + shift][s.hair % traitCountForType[1 + shift]].name), ',',
                    attributeForTypeAndValue(_traitTypes[2], traitData[2 + shift][s.facialHair % traitCountForType[2 + shift]].name), ',',
                    attributeForTypeAndValue(_traitTypes[3], traitData[3 + shift][s.eyes % traitCountForType[3 + shift]].name), ',',
                    attributeForTypeAndValue(_traitTypes[4], traitData[4 + shift][s.accessory % traitCountForType[4 + shift]].name), ',',
                    attributeForTypeAndValue(_traitTypes[5], traitData[5 + shift][s.headgear % traitCountForType[5 + shift]].name), ',',
                    attributeForTypeAndValue(_traitTypes[6], traitData[6 + shift][s.neckGear % traitCountForType[6 + shift]].name), ','
                ));
        } else {
            traits = string(abi.encodePacked(
                    attributeForTypeAndValue(_traitTypes[0], traitData[0 + shift][s.uniform % traitCountForType[0 + shift]].name), ',',
