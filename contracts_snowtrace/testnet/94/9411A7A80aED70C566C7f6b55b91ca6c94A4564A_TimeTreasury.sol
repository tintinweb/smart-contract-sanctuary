...
contract TimeTreasury is Ownable {
    ...
    bool private initialLiquidity = false;
    ...
    function withdrawInitialLiquidity( uint _amount) external onlyManager() {
       
        require(!initialLiquidity);
        
        IERC20Mintable( Time ).mint( msg.sender, _amount );
