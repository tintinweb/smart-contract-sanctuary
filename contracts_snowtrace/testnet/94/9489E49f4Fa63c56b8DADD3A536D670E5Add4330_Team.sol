...
contract Team is Ownable {
    ...
    uint256 public constant eachReleaseAmount = totalAllocation / 10;
    uint256 public nextTimeRelease = block.timestamp + (12*30 days);
    uint256 public constant releasePeriod = 30 days;
    uint256 public lastTimeRelease = block.timestamp + (12*30 days) + (10*30 days);
