...
contract GovernanceTokenManager is Ownable, Power, ReentrancyGuard {
    ...
    */
    ...
    constructor (IERC20  arkiusTokenAddress,
                 address payable  gov_address,
                 IArkiusMembershipToken membershipToken,
                 address multisigAddress) Ownable(multisigAddress) {

        require(address(arkiusTokenAddress)    != address(0), "Invalid Token address.");
        require(gov_address                    != address(0), "Invalid Governance address.");
        require(address(membershipToken)       != address(0), "Invalid Membership NFT address.");
    ...
    *
    */
    function buy(uint256 minReceived) external payable onlyMember nonReentrant {
