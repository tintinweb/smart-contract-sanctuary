...
contract ProjectX is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000000000000000; // 1m
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 avaxForMarketing = avaxBalance.mul(_marketingTokensToSwap).div(totalTokensToSwap);
        uint256 avaxForDev = avaxBalance.mul(_devTokensToSwap).div(totalTokensToSwap);
        ...
        (success,) = address(devAddress).call{value: avaxForDev}("");
