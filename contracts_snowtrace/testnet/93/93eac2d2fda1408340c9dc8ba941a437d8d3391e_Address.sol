...
contract Eyeohsa is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25 * 10**15 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Eyeohsa";
    string private _symbol = "EYEOHSA";
    ...
    uint256 public numTokensSellToAddToLiquidity = 25 * 10**12 * 10**9;
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd); //Mainnet AVAX TraderJoe
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2BfA92882d25f46f5350BbB64479f31075a98A5c); //Testnet AVAX TraderJoe
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 25000000, "Max Tx Amount cannot be less than 25 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 25000000, "Swap Threshold Amount cannot be less than 25 Million");
