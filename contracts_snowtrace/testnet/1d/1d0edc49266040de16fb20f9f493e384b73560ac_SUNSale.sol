...
//Change values
    ...
    uint public constant MAX_SOLD = 50000 * SUNdecimals;
    uint public constant PRICE = 10 * MIMdecimals / SUNdecimals ;
    uint public constant MIN_PRESALE_PER_ACCOUNT = 50 * SUNdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 500 * SUNdecimals;
    ...
    bool publicSale;
    bool privateSale;
    address[] devAddr = [0x75e57890FAd206c590161B264747eC8f76c9a963];
    ...
    constructor() {
        ...
        MIM = ERC20(0x6da7F02D84bBC54b472bCa0E33Ed3A5fc2078603);
        owners = msg.sender;
        sold = 0;
        //DEV REWARDS
