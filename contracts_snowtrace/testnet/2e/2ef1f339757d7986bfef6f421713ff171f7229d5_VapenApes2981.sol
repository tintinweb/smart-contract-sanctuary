...
// File: vapenapes-contract-main-avax/src/contracts/mocks/IERC20.sol
...
// File: vapenapes-contract-main-avax/src/contracts/impl/Ownable.sol
...
// File: vapenapes-contract-main-avax/src/contracts/impl/ERC721.sol
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
	...
	// Base URI, used for provenance and metadata
...
// File: vapenapes-contract-main-avax/src/contracts/impl/HookPausable.sol
...
// File: vapenapes-contract-main-avax/src/contracts/impl/Enumerable.sol
...
// File: vapenapes-contract-main-avax/src/contracts/Apes2981.sol
...
contract VapenApes2981 is ERC721Enumerable, HookPausable {
	...
	uint256 public constant APE_SALEPRICE = 2.5 ether; //2.5 AVAX
	uint256 public constant APE_PRESALE_PRICE = 2.0 ether; //2.0 AVAX
	...
	constructor() ERC721("VapenApes", "VAPE") {
		...
		_team.push(Team(payable(0x3358294509A59A8fF942fD61e7F1429a418d015C), 46)); /* d */
		_team.push(Team(payable(0xb45FA3C125AB4dBe6ec5434E6462D7682382a1b4), 46)); /* J */
		/* $SEEDZ dev & marketing */
		_team.push(Team(payable(0x7369BAce49A85D89253634b15aC40597ae7a7Be6), 8));
	}
