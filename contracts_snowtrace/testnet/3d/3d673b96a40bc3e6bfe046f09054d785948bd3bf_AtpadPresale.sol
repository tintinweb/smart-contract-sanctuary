...
contract AtpadPresale is ReentrancyGuard, Ownable, Pausable {
    ...
    */
    ...
    uint public rate = 100; // this is 0.1 * (10**3) --> 0.1 wantToken for 1 investToken
...
//    }
    ...
    ///  Epoch timestamps START and END vesting 
    uint startVest = 1641664800; //Date and time (GMT):  Saturday 8 January 2022 18:00:00
    uint endVest  = 1641679200;  // Date and time (GMT):  Saturday 8 January 2022 22:00:00
...
//                uint _allocate = (hardCap * _perc) ; // FOR TESTING PURPOSE !
    ...
    function swap(uint _amount)  external  payable nonReentrant   { // 
        /// do some checks 
     ...
     */
    function swapClaim() external payable nonReentrant  {   //
