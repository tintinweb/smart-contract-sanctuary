...
contract RaceXRaceCar001 is ERC721Enumerable, ERC2981RaceXNFCarRoyalties, Ownable {
  using Strings for uint256;
...
//only owner
 ...
 function setPayments(address _payments) public onlyOwner {
  ...
  function splitBalance(uint256 amount) public onlyOwner{
