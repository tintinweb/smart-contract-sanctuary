...
contract NFT_Minter is Ownable {
    ...
    address public devAddress = 0xCA9f427Fa7616BD21A9B6659d14e116dBf49784c; // SOULD BE SET TO DEPLOYER ADDRESS !!!
     ...
     */
    uint16 public presale = 20;

    /**
     * @dev Max mint amount in presale.
     */
    uint8 public maxPresaleMintAmount = 2;
    ...
    function freeMint() public {
        ...
        require(nextId + reserve <= maxSupply, "Sold out"); // sanity check
        ...
        nextId++;
        freemints++; // otherwise calculation for presale price is mint fails.
    }
