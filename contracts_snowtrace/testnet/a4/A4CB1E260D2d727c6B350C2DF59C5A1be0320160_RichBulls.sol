...
contract RichBulls is ERC721Enumerable, Ownable {
    ...
    function presaleMint(uint256 _mintAmount, bytes32[] memory proof) public payable {
        ...
        bool isUserVip = isVip(msg.sender, proof);
    ...
    function isVip(address user, bytes32[] memory proof) public view returns (bool) {
        return MerkleProof.verify(proof, vipRoot, keccak256(abi.encodePacked(user)));
    }
