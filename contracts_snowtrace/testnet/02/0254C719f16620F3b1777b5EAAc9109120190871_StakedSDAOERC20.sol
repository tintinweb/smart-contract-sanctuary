...
contract StakedSDAOERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Sdao", "sSDAO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSDAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSDAO
