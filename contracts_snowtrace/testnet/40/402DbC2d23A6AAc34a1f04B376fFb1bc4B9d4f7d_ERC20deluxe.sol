...
contract Deluxe is ERC20, IERC20Metadata, ERC20Burnable, ERC20PresetMinterPauser {
    constructor(
        string name,
        string symbol,
        uint8 decimals,
        ...
        address feeReceiver
    ) public payable IERC20Metadata(name, symbol, decimals) {
...
contract ERC20deluxe is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, ERC20FlashMintUpgradeable {
    ...
    function initialize(string calldata name, string calldata symbol, uint8 decimals, uint256 initialSupply) initializer public {
        __ERC20_init(name, symbol);
        __ERC20Burnable_init();
        __ERC20Snapshot_init();
        __AccessControl_init();
        __Pausable_init();
        __ERC20Permit_init("ERC20deluxe");
