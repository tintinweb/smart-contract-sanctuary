...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xf6d46849DB378AE01D93732585BEc2C4480D1fD5); //FORT
...
contract Peach is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xf6d46849DB378AE01D93732585BEc2C4480D1fD5; // FORT
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x78eAe4eD2F6A1a7D3E5e87d242497912acDcAb60;
    address public marketingFeeReceiver=0x78eAe4eD2F6A1a7D3E5e87d242497912acDcAb60;

    string constant _name = "Princess Peach";
    string constant _symbol = "PEACH";
