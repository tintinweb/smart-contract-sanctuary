...
contract Marketing is Ownable {
    ...
    uint256 public constant totalAllocation = 85e6 * 1e18;
    uint256 public remainingAmount = 85e6 * 1e18;
    ...
    uint256 public lastTimeRelease = block.timestamp + 7 days + (17*30 days);
    ...
    function release() external onlyOwner {
        ...
        if(isFirstRelease) {
            ...
            eachReleaseAmount = (totalAllocation * 5) / 100;
        }
    }
}
