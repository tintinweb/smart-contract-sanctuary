...
// File contracts/LiquidityPoolManagerV3.sol




pragma solidity ^0.7.6;
contract LiquidityPoolManagerV3 is Ownable, ReentrancyGuard {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function addWhitelistedPool(address tokenA, address tokenB, address stakeContract, uint _rewardWeight) public onlyOwner {
    ...
    function addWhitelistedStakePool(address token, address stakeContract, uint _rewardWeight) public onlyOwner {
        ...
        require(_rewardWeight > 0, 'LiquidityPoolManager::addWhitelistedStakePool: rewardWeight cannot be zero');
