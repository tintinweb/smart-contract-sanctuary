...
//Change values
    ...
    uint public constant MAX_PRESALE_PER_ACCOUNT = 100 * SUNdecimals;
    ...
    bool publicSale;
    bool privateSale;
    address[] devAddr = [0x9a26aaD81768205Ac50EdAaf170cF7cdA5e36A69];
    ...
    constructor() {
        ...
        for( uint256 iteration_ = 0; devAddr.length > iteration_; iteration_++ ) {
            invested[ devAddr[ iteration_ ] ] = 1067 * SUNdecimals;
        } 
    }
