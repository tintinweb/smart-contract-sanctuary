...
contract CrdPresale is Owned {
    ...
    address public mainTokenAddress = 0x130966628846BFd36ff31a822705796e8cb8C18D;//is address mainToken, MIM
    ...
    function setMainTokenAddress(address _mainTokenAddress) external onlyOwner {
    ...
    function buy(uint256 paidAmount) public {
        ...
        IERC20 token = IERC20(mainTokenAddress);
