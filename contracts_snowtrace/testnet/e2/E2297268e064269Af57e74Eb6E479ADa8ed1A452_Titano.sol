...
contract Titano is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Titano", "TITANO", uint8(DECIMALS)) {
        router = IDEXRouter(0x273e21935224D98544C949bDFaC410D0CafCDe22); //Sushi 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 // Cake 0x10ED43C718714eb63d5aA57B78B54704E256024E
            //PancakeRouter

            //Create Contract Router forthis.
        ...
        autoLiquidityReceiver = 0x73964F6F211D5a8428322EDFbDfEc72FF76D9fCd;
        TreasuryReceiver = 0x73964F6F211D5a8428322EDFbDfEc72FF76D9fCd;
        RiskFreeValueReceiver = 0x73964F6F211D5a8428322EDFbDfEc72FF76D9fCd;

        //Need to Create 3 Metamask Addresses for the above address
