    ...
    Ownable
{
    ...
    uint256 public constant INITIAL_CLAIM_PRICE = 0.25 ether;
    uint256 public constant POST_38_PRICE = 0.2 ether;
        ...
        returns (uint256 reward)
    {
        ...
        return getFirstRewardComponent(index) + post38Extra;
    }
    ...
    function getPrice(uint256 index) public pure returns (uint256 price) {
        if (index >= 38) return POST_38_PRICE;
