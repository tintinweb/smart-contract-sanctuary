...
contract JoeRouter02 is IJoeRouter02 {
    ...
    bool public hasLiquidity = false;
    uint public uintHolder;
    ...
    // Custom Reimplementation of addLiquidty
    ...
    {
        addressHolder = tokenA;
        addressHolder = tokenB;

        uintHolder = amountAMin;
    ...
    )
    {
        ...
        amountAVAX = amountAVAXMin;
        liquidity = amountTokenMin;
    }

    // Original Renamed addLiquidty

    function addLiquidityBg(
        address tokenA,
        address tokenB,
        uint256 amountADesired,
        uint256 amountBDesired,
