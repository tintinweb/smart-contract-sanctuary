...
/// Todo: Add Avoid Whale Trans
/// @custom:security-contact [email protected]
contract BoonToken is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    ...
    constructor() ERC20("BoonTokenR10", "BOON") ERC20Permit("BoonToken") {
    ...
    function isWhaleTransaction(
        ...
        if (amount >= (balanceOf(from) * percentAmountWhale) / 100)
            return true;
        return false;
    }
}
