    ...
    PlanetsManagerImplementationPointer
{
        ...
        returns (bool)
    {
        ...
        if (
            ...
            !liquidityPoolManager.isLiquidityWithdrawal()
        ) {
            isBuy = true;
        ...
        if (
            (isSellOrLiquidityAdd || isTransfer) &&
            !isExcludedFromObserver(from)
        ) {
...
interface ILiquidityPoolManager {
    ...
    function isLiquidityWithdrawal() external view returns (bool);
