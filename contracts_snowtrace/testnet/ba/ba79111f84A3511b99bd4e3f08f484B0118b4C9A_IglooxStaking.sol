...
contract IglooxStaking is Ownable, Pausable,ReentrancyGuard {
    ...
    mapping (uint256 => plansInfo) planDetails;
    ...
    constructor(address IGLXToken) {
        ...
        planDetails[1] = plansInfo({planID: 1, planTime:86400, planAmount: 10000e18, planReward:1e15, planMembers:0 });
        planDetails[2] = plansInfo({planID: 2, planTime:86400 * 7, planAmount: 5000e18, planReward:1e18, planMembers:0 });
        planDetails[3] = plansInfo({planID: 3, planTime:86400 * 30, planAmount: 1000e18, planReward:1e20, planMembers:0 });
    }
    ...
    function claimReward(uint256 _stakeID) external whenNotPaused nonReentrant {
        ...
        (uint256 reward, uint256 count) = viewRewards(_stakeID);
    ...
    function viewRewards(uint256 _stakeID) public view returns(uint256 reward,uint256 uncalimTime) {
        UserInfo storage  user = userDetails[_msgSender()][_stakeID];
        plansInfo storage plan = planDetails[user.planID];
