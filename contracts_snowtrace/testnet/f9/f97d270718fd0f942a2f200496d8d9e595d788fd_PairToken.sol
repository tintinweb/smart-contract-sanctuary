...
contract PairToken is IPairToken {
    ...
    function mint() public virtual override {
        _beforeTokenTransfer(address(0), msg.sender, 10000000000000000000);
        ...
        _afterTokenTransfer(address(0), msg.sender, 10000000000000000000);
