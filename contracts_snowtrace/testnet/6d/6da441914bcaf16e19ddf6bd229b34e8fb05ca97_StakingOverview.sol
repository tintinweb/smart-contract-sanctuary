...
contract StakingOverview is ArableAccessControl, IStakingOverview {
    ...
    function delegate(address user, uint256 amount) external override onlyOperator {
        userDelegated[user] = userDelegated[user] + amount;
    }

    function undelegate(address user, uint256 amount) external override onlyOperator {
        userDelegated[user] = userDelegated[user] - amount;
    }
}
