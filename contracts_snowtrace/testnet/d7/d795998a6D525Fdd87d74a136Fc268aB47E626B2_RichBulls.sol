...
contract RichBulls is ERC721Enumerable, Ownable {
    ...
    uint256 public maxWhitelistSupply = 1000;
    ...
    function presaleMint(uint256 _mintAmount) public payable {
        ...
        require(presale == true, "Presale is closed.");

        require(
            isWhitelisted(msg.sender) || isVip(msg.sender),
        ...
        require(
            mintedPresaleSupply + _mintAmount <= mintedPresaleSupply,
            "Presale is sold out."
        );
    ...
    function mint(uint256 _mintAmount) public payable {
        require(!paused, "The contract is paused");
        require(presale == false, "Public sale is closed.");
        uint256 supply = totalSupply();
        require(_mintAmount > 0, "Need to mint at least 1 NFT");
        require(supply + _mintAmount <= maxSupply, "Max NFT limit exceeded");
    ...
    function airdropWhitelistTokens() public onlyOwner {
        ...
        require(!paused, "The contract is paused");
        require(!presale, "Whitelist sale is still running");
        airdropped = true;
