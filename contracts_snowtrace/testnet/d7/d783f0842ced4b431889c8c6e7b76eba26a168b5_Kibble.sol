...
contract Kibble {
    ...
    // Dispenses new FETCH.
    address public immutable kibbleDispenser;
    ...
    constructor(
        ...
        totalAlloc = 100;
        require(_dispenser != address(0));
        kibbleDispenser = _dispenser;
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 fetchReward = (block.timestamp - pool.lastRewardTime) * fetchPerSecond * pool.allocPoint / totalAlloc;
        fetch.safeTransferFrom(kibbleDispenser, address(this), fetchReward);
