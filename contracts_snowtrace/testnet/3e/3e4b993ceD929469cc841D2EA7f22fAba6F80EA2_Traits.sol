    ...
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        ...
        string memory svgString = string(
            abi.encodePacked(
                ...
                // Pants
                drawTrait(
                    traitData[2 + shift][s.pants % traitCountForType[1 + shift]]
                ),
                // Hats
                drawTrait(
                ...
                s.isChad // Monkey
                    ? drawTrait(
                        traitData[6 + shift][
                            s.accessories % traitCountForType[5 + shift]
                        ]
                    )
                    : drawTrait(
                    traitData[4 + shift][s.facialHair % traitCountForType[3 + shift]]
                  ),
                s.isChad
                    ? ""
                    : drawTrait(
                    traitData[5 + shift][s.weapon % traitCountForType[3 + shift]]
                ),
                s.isChad
                    ? ""
