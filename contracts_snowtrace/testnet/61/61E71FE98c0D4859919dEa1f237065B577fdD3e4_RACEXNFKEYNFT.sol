...
abstract contract ERC2981RaceXNFKeyRoyalties is ERC165, IERC2981Royalties {
    ...
    {
        uint256 royalty = ((value * 10**18) * _royaltiesValue) / 10000;
...
contract RACEXNFKEYNFT is ERC721Enumerable, ERC2981RaceXNFKeyRoyalties, IRACEXNFKEYNFT, Ownable {
  using Strings for uint256;
  ...
  address private royaltyContractAddress = 0x8a6a4205F1e5caf27e74f89A30733d01D80b2231;
