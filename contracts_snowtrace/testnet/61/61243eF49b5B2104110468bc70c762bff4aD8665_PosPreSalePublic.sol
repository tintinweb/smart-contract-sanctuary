...
// File: POSPreSalePublicFinalTest.sol
...
contract PosPreSalePublic is Ownable {

    using SafeERC20 for ERC20;
    using Address for address;

    uint constant MIMdecimals = 10 ** 9;
    uint constant POSdecimals = 10 ** 9;
    uint public constant MAX_SOLD = 100000 * POSdecimals;
    uint public constant PRICE = 10 * MIMdecimals / POSdecimals ;
    uint public constant MAX_SALE_PER_ACCOUNT = 150 * POSdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 200 * POSdecimals;
    ...
    function buyPOS(uint256 amount) public onlyEOA {
    ...
    function claimPOS() public onlyEOA {
      ERC20(POS).transfer(msg.sender, invested[msg.sender]);
      owed -= invested[msg.sender];
      invested[msg.sender] = 0;

    }
    function setClaimingActive(address pos) public {
