...
{
    using Strings for uint256;
    uint256 public constant ROYALTY_VALUE = 400; // 4% using 2 decimals - 10000 = 100, 0 = 0
    uint256 public constant MAX_MINTABLE = 10000;
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant INITIAL_CLAIM_PRICE = 3 ether;
    uint256 public constant POST_5000_PRICE = 2.5 ether;
