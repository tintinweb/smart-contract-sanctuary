 ...
 */
contract AVAXGMTest is Context, AccessControlEnumerable, ERC20Burnable {
    
    // Max supply ten trillion 
    uint256 MAX_SUPPLY = 10**13 * 10**18;
     ...
     */
    constructor() ERC20("AVAX GM (test2)", "GMT2") {
