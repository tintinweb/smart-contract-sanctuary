...
contract COMPOSITIONFORASMARTCONTRACTANDINSTRUMENTS is Ownable {
    ...
    mapping (uint => Param) params;


    constructor() {
        
        params[0] = Param(0, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[1] = Param(1, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[2] = Param(2, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[3] = Param(3, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[4] = Param(4, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[5] = Param(5, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[6] = Param(6, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[7] = Param(7, "/param", 0 , 1000 , true, address(0), 0, 0);
        params[8] = Param(8, "/section", 0 , 10 , false, address(0), 0, 0);
        params[9] = Param(9, "/timepassed", 0 , 0 , false, address(0), 0, 0);
    ...
    function getAllParamNames() public view returns(string[] memory) {
        string[] memory _params = new string[](10);

        for (uint i = 0; i < 10; i++) {
            _params[i] = params[i].name;
        }
        return _params;
        
    }

    function getAllParamValues() public view returns(uint[] memory) {
        uint[] memory _params = new uint[](10);
    ...
    function musicTimePassed() public view returns(uint256) {
