...
contract CreditStaking is Ownable {
    ...
    /**
        @notice stake Credit to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice forfeit MEMO in warmup and retrieve Credit
     */
    ...
    /**
        @notice returns contract Credit holdings, including bonuses provided
        @return uint
     */
