...
contract Liquidity is Ownable {
    ...
    uint256 public eachReleaseAmount = totalAllocation / 10;
    bool public isFirstRelease = true;
    uint256 public nextTimeRelease = block.timestamp;
    uint256 public constant releasePeriod = 60 days;
    uint256 public lastTimeRelease = block.timestamp + (5*60 days);
    ...
    function release() external onlyOwner {
        ...
        if(isFirstRelease) {
            ...
            eachReleaseAmount = (totalAllocation * 2) / 10;
        }
    }
}
