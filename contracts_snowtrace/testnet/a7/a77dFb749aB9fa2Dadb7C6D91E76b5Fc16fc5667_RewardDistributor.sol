...
contract RewardDistributor is Ownable, ReentrancyGuard
{
	...
	uint256 public lastAlloc_;
	uint256 public rewardBalance_;
	mapping(uint256 => uint256) public rewardPerPeriod_;

	uint256 public immutable firstPeriod_;
	mapping(address => uint256) public lastPeriod_;
