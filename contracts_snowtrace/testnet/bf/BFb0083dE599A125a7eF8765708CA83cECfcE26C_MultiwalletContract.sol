...
contract MultiwalletContract is Ownable {
    ...
    /**
     * @dev Constructor to initialize GovernanceTokenAddress and owner address
     *
     * @param govToken Address of the GovernanceToken Contract
     */
    constructor(IERC20 govToken, address multisigAddress) Ownable(multisigAddress) {
        require(address(govToken) != address(0), "Invalid Token address.");
        require(multisigAddress != address(0), "Invalid mulisig address.");
        _arkiusGovernanceToken = govToken;
    }
