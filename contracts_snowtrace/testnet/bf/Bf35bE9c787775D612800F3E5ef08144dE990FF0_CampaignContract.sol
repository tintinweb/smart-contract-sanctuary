...
contract CampaignContract is Ownable, ReentrancyGuard {
     ...
     *
     * @param attentionSeekerNFTAddress Address of Attention Seeker Contract.
     *
     */
    constructor(IArkiusAttentionSeekerToken attentionSeekerNFTAddress,
        ...
        require(address(attentionSeekerNFTAddress)  != address(0), "Invalid Seeker Address");
        ...
        require(address(governanceTokenAddress)     != address(0), "Invalid Token Address");
        require(multisigAddress                     != address(0), "Invalid Multisig Address");

        attentionSeekerToken  = attentionSeekerNFTAddress;
        arkiusGovernanceToken = governanceTokenAddress;
    ...
    function editCampaign(uint id,
        ...
        if (amountPerAd                  != 0)   campaigns[id].amountPerAd    = amountPerAd;
