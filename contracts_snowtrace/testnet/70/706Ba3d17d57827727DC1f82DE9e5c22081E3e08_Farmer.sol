...
contract AlligatorToken is ERC20("Alligator", "GTR"), Ownable {
    ...
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (Farmer).
...
// The Farmer manages the distribution of reward tokens to holders of staked LP tokens.
...
contract Farmer is Ownable, ReentrancyGuard {
    ...
    // Deposit LP tokens to Farmer for GTR allocation.
