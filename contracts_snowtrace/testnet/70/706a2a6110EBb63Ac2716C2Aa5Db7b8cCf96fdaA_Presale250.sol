...
contract Presale250 is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public purchaseUSDTAmount; // This is 250 USDT
    uint256 public allocatedaPOSPerUser; //  This is hardcoded to be 25 aPOS
    ...
    function initialize(
        ...
        allocatedaPOSPerUser = _allocatedaPOSPerUser;
    ...
    function purchaseaPOSWithwsOHM() external returns (bool) {
        ...
        IERC20(aPOS).safeTransfer(msg.sender, allocatedaPOSPerUser);

        return true;
    }

    function purchaseaPOSWithUSDT() external returns (bool) {
        require(saleStarted() == true, "Not started");
        require(whiteListed[msg.sender] == true, "Not whitelisted");
        require(boughtPOS[msg.sender] == false, "Already participated");
        require(block.timestamp < endOfSale, "Sale over");
    ...
    /**
     *  @notice Burn the remaining aPOS
     *  @return true if it works
    */
    function burnRemainingaPOS()
        external
        onlyOwner()
        returns (bool)
    {
        ...
        IERC20Burnable(aPOS).burn(IERC20(aPOS).balanceOf(address(this)));
