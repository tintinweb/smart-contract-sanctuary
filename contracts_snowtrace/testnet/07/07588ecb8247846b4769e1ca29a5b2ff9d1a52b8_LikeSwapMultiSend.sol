...
contract LikeSwapMultiSend {
  ...
  /// @param _amount The amount of tokens to send (without decimals)
  function LikeSwapMultiSendTokenEqual_71p(address _token, address[] calldata _addresses, uint256 _amount) public {
