...
contract StakingRewards is Ownable {
    ...
    bool private flagForStaking = true;
    ...
    function writeOffBonus(uint _amount) external updateBalance(msg.sender) {
        require(flagForStaking == true, "The service is stopped.");
        require(userInfo[msg.sender].bonusEarned >= _amount, "Not enough amount of reward");

        userInfo[msg.sender].bonusEarned -= _amount;
    }
