...
contract TraderJoe_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    IUniswapV2Factory private constant joeFactory =
        IUniswapV2Factory(0xF8c12964C79ca929b704BD256927dF80d28B3831);

    IUniswapV2Router02 private constant joeRouter =
        IUniswapV2Router02(0x0a6F1c537f4Fb8eA35242874871413F07D1589ff);

    address private constant wavaxTokenAddress =
        address(0x55C687bdB927C2827CC150667442C3CceA653e31);
    ...
    {
        // 0x exchange
        approvedTargets[0xA61199E43Be02742E9a089fA61110ba681aca029] = true;
    }
