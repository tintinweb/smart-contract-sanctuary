...
// File contracts/avaxminter.sol


pragma solidity ^0.8.2;
contract avaxminter is ERC721, ERC2981PerTokenRoyalties, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint256 hardCap = 10000;
    uint256 private tokenPrice = 200000000000000000; // 0.2 Avax
    ...
    constructor() ERC721("Avax Minter", "AM") {
    ...
    function safeMint(uint256 amountToMint) public payable {
        ...
        for(uint256 i = 0; i < amountToMint; i++){
            ...
            _setTokenRoyalty(_tokenIdCounter.current(), 0x16f03d3Ba6E7b2205aF2FCc4744c2fcc088FeC9A, 500);
