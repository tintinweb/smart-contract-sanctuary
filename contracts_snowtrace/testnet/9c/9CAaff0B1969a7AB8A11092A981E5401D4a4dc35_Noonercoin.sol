...
contract Noonercoin is ERC20{
   ...
   function mintToken(address add) public returns (bool) {  //admin only
    ...
    function burnToken() internal returns(bool){
        ...
        uint256 totalMintedTokens =  (noonercoin[adminAddress]-_fundersAmount)*10**18 + noonerwei[adminAddress]; //before adding totalWeiBurned.
  ...
  function getPreviousCyclesBalance() public view returns(uint256) {//deleted after testing
