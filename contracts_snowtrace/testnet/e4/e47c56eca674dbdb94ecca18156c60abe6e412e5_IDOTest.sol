...
contract IDOTest is Ownable {
    ...
    uint256 public tokenPriceAvax = 10000000000000000;
    ...
    event AvaxDeposited(address indexed beneficiary, uint amount);
    ...
    /* This Function Will Airdrop AVAX to Multiple Users */
    ...
    /* This will deposit AVAX to Contract */
    ...
    /* This function will accept avax directly sent to the address */
    receive() payable external {
        ExchangeAVAXforToken(msg.sender, msg.value);
    }

    /* This Function will exchange AVAX to Token */
    function ExchangeAVAXforToken(address _addr, uint256 _amount) private {
        ...
        require(totalHardCap < hardCap, "AVAX Hardcap Reached");
        ...
        tokenExchanged[userAdd] += avaxAmount;

        emit AvaxDeposited(msg.sender,msg.value);
    }


    /* This Function will exchange AVAX to Token in Mannual Call */
