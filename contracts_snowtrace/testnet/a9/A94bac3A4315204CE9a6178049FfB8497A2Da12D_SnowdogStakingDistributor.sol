...
contract SnowdogStakingDistributor is Ownable {
    ...
    constructor( address _treasury, address _sdao, uint _epochLength, uint _nextEpochTime ) {
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return IERC20( SDAO ).totalSupply().mul( _rate ).div( 1000000 );
    }
