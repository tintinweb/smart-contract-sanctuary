...
contract Noonercoin is ERC20{
   ...
   function mintToken(address add) public returns (bool) {  //admin only
    ...
    function getIntegerValue(uint256 a, uint256 b, uint256 expoHundred) public pure returns (uint256 q){
    ...
    function getDecimalValue(uint256 a, uint256 b, uint256 expoHundred) public pure returns (uint256 p){
       //b is already multiplied by 100
