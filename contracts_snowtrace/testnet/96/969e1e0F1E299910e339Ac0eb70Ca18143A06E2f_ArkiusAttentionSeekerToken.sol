...
import './NFTs/AttentionSeekerToken.sol';
...
contract ArkiusAttentionSeekerToken is AttentionSeekerToken {
    ...
    string public name = "Arkius Attention Seeker Token";
    ...
    constructor(string memory contractURI,
            ...
            ) AttentionSeekerToken(contractURI, tokenURIPrefix, multisigAddress) {
...
import './ERC1155BaseAttentionSeeker.sol';
...
import './ERC1155AttentionSeeker.sol';
