...
contract SPLIFF is ERC20Permit, Ownable {
    ...
    constructor() ERC20("SPLIFF", "SPLF", 9) ERC20Permit() {
    ...
    /**
        @notice increases SPLIFF supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SPLIF
