...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xcDA49Dc90c9eD018A526a19B93fA666D25bb8778);
        _token = msg.sender;
    }
...
contract vcxxxx is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "bgvcfff";
    string constant _symbol = "Ghobcxs";
    ...
    constructor () {
        router = IDEXRouter(0xcDA49Dc90c9eD018A526a19B93fA666D25bb8778);
