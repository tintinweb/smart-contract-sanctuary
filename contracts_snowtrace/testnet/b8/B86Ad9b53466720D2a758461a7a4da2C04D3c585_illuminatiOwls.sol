...
contract illuminatiOwls is ERC721, Ownable {
    ...
    uint256 public _mintNftFee = 1.25 ether;
    ...
    address public _owlAdminWallet = 0x90a778623B91a7517CbA8bE714cfe7Df14E9906A;

    constructor() ERC721("illuminati Owls", "ILL") {      
        _baseUriExtended = "http://xoids.apim.us/temp/";
        _totalSupply   = 3333 ;
        _preSaleStartTime    = 1641552805 ; 
        _preSaleEndTime      = 1641553500 ; 
        _publicSaleStartTime = 1641553500 ; 
    }
