...
//   ____    _    ____  _____   _   _ _____ _____
//  | __ )  / \  / ___|| ____| | \ | |  ___|_   _|
//  |  _ \ / _ \ \___ \|  _|   |  \| | |_    | |
//  | |_) / ___ \ ___) | |___  | |\  |  _|   | |
...
contract BaseNft is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_GIVEAWAY_TOKENS = 10;

  uint256 public constant TOKEN_PRICE = 10000000000000000; //0.01ETH
