...
// File: contracts/DGNSCrowdsale.sol

pragma solidity ^0.8.0;



contract DGNSCrowdsale is Ownable {
    ...
    function redeem() external onlyWhitelisted {
        ...
        require(address(dgns) != address(0), "DGNS not set");
        require(deposited[msg.sender], "Not deposited");
        require(!claimed[msg.sender], "Already claimed");

        claimed[msg.sender] = true;
        dgns.safeTransfer(msg.sender, REDEEM_AMOUNT);
    }
    ...
    function setDGNS(IERC20 _DGNS) external onlyOwner {
        dgns = _DGNS;
    }
