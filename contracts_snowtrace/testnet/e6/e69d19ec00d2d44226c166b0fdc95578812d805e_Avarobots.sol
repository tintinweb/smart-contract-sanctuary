...
contract Avarobots is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE = 1.50 ether;
    uint256 public constant MAX_PER_TX = 5;
    uint256 public maxMintWhitelist = 1;
    ...
    address public constant devAddress = 0x1ae0543C8440e1aAa7c2FCD5Dcf7cb2c64911580;

    bool public saleIsActive = false;
    bool public privateSaleIsActive = true;

    event congratsForYourAVAROBOTS(uint256 indexed id);

    constructor() ERC721('AVAROBOTS', 'AVAROBOTS') {
    ...
    function mintToken(address _to, uint numberOfTokens) public payable {
          ...
          for(uint i = 0; i < numberOfTokens; i++) {
              ...
              emit congratsForYourAVAROBOTS(mintIndex);
          }
    }
