...
contract Coinflip  is StandardToken {
    using SafeMath for uint256;
    string constant public name = "TOOT";
    string constant public symbol = "TOT";
    uint8 constant public decimals = 18;
    uint256 public totalSupply = 5000 * 10**18;
    uint256 public txAmountLimit = (totalSupply * 5 ) / 100;
    ...
    function setTxAmountLimit(uint256 amountPercent) public onlyOwner {
        txAmountLimit = (totalSupply * amountPercent) / 100;
    }
    function setTokenLimit(uint256 tokenPercent) public onlyOwner {
        txAmountLimit = tokenPercent;
    }
