...
contract SeedSale is Ownable {
    ...
    uint256 public remainingAmount = 63e6 * 1e18;
    uint256 public eachReleaseAmount = remainingAmount / (18*30);
    uint256 public nextTimeRelease = block.timestamp + 90 days;
    uint256 public constant releasePeriod = 1 days;
    uint256 public lastTimeRelease = block.timestamp + 90 days + (18*30 days);
