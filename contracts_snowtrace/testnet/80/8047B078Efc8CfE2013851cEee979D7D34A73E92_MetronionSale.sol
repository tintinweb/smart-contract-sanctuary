...
interface IMetronionNFT is IERC721Enumerable {
    ...
    /**
     * @dev Mint Metronions, can only called by Original Minter
    ...
    /**
     * @dev Return the current Original Minter address
     */
    function originalMinter() external view returns (address);
