...
contract testam is Context, IERC20, Ownable {
    ...
    string private _name = "testam";
    string private _symbol = "tam";
    
    uint256 public _reflectFee = 3; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousReflectFee = _reflectFee;
    uint256 private maxReflectFee = 4;
    
    uint256 public _liquidityFee = 2; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private maxLiquidityFee = 4;
    ...
    address payable private _marketingWallet = payable(0x30b7388CeE603f76AfE4CF908dE4418e4c928345);
