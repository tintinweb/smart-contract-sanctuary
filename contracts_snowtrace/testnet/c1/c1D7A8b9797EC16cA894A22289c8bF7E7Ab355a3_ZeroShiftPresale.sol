...
contract ZeroShiftPresale is Ownable {
    ...
    mapping(address => uint256) public zrstClaimable; // amount of rome claimable by address
     ...
     *  @param _amount: amount of dZRST to deposit to sale (9 decimals)
     */
    ...
    function claimDZeroShift() external checkIfPaused {
        require(claimAlpha, "dZRST is not yet claimable");
