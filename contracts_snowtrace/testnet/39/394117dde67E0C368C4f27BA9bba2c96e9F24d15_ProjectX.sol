...
contract ProjectX is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        totalFees = rewardsPoolFee.add(liquidityPoolFee).add(operationPoolFee);
    ...
    function createNodeWithTokens(uint numberOfNodes) public {
        for (uint256 i = 0; i < numberOfNodes; i++) {
            ...
            if (
                ...
                require(
                    swapAndSendToFee(smoothingReserveAddress, smoothingTokens.div(2)),
                ...
                //require(super._transfer(address(this), smoothingReserveAddress, smoothingTokens.div(2)),"NODE CREATION:  ERROR SWAPING AND SENDING SMOOTHING TOKENS");

                // swapAndLiquify
                uint256 swapTokens = nodePrice.mul(liquidityPoolFee).div(100);
                require(
                    swapAndLiquify(swapTokens),
                    "NODE CREATION:  ERROR SWAPING AND SENDING SMOOTHING TOKENS");
                ...
                //require(super._transfer(address(this), rewardsPoolAddress, rewardsPoolTokens), "NODE CREATION:  ERROR SENDING REWARD POOL TOKENS");
