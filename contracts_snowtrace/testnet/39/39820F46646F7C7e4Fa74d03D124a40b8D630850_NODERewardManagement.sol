...
contract NODERewardManagement {
    ...
    function createNode(address account, string memory nodeName) external onlyManager {
        require(
    ...
    // todo implement
    function burn(uint256 index) external onlyManager {
    ...
    function _changeAutoDistri(bool newMode) external onlyManager {
        autoDistri = newMode;
    }
