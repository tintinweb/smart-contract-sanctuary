...
contract ThortlesNFT is ERC721Enumerable, Ownable {
  ...
  */
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "Max ThortlesNFT per address exceeded");
        }
  ...
  /*
    ...
    @description - Returns a True/False if owners address is whitelisted
  */
  ...
  */
  ...
  /*
    ...
    @description - Adding White listed user addresses for priority minting
  */
