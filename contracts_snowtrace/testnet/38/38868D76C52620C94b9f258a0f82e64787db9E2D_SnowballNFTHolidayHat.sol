    ...
    */
    ...
    contract SnowballNFTHolidayHat is ERC721, Ownable{
        ...
        function saleLive() public view returns (bool) {
            bool sale = _sale_start_time != 0 
                     && _sale_start_time <= block.timestamp 
                     && _sale_start_time + SALE_DURATION >= block.timestamp;
        ...
        function mint(address to) public payable{
            require(_sale_start_time > 0 && _sale_start_time <= block.timestamp, "sale has not yet begun!");
