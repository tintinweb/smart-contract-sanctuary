...
contract AlphaENIGMMigration is Ownable {
  ...
  function available(address _user, uint256 _fakeTimestamp, uint256 _fakeBalance) public view returns (uint256) {
    ...
    uint256 originalBalance = _fakeBalance / (100 - claimed) * 100;
