 ...
 */
contract MeerkatVaultNative is ERC20, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Alternative helper function to withdraw all funds in native AVAX form.
     */
    ...
    function withdrawWithAmount(uint256 amount) public {
        ...
        native.safeTransfer(babyMeerkatContract, amount);
    }
