...
contract Minter is Ownable, ERC20 {
    ...
    function mint(uint256 amount) public payable {
        ...
        require(amount <= maxMint, "You can only mint 10 tokens at a time");
        require(totalSupply().add(amount) <= MAX_TOKENS, "Minting would exceed max. supply");
        require(mintPrice.mul(amount) <= msg.value, "Not enough Ether sent.");
