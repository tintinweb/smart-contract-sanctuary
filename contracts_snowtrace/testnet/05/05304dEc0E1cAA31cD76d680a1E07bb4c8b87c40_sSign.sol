...
contract sSign is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Sign", "sSIGN", 18) ERC20Permit() {
    ...
    /**
        @notice increases sSign supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSIGN
