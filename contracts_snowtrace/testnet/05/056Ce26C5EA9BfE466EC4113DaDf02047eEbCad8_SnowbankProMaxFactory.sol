...
contract CustomBond is Ownable {
    ...
    function deposit(
        ...
        uint256 fee = payout.mul(currentOlympusFee()).div(1e6);
...
contract SnowbankProMaxFactory is Ownable {
    ...
    address public olympusTreasury = 0x72cbf71E19eCBa2F591fEAF0497134046EbbDae9;
    address public olympusProFactoryStorage =
        0x58ABc3E2a3643a99931cF66672e648D3b5DaDD68;
    address public olumpusProSubsidyRouter =
        0x9D4Ecd41f9334D4BD5f4aE225d2F5789CE2E30F2;
    address public olympusDAO = 0x72cbf71E19eCBa2F591fEAF0497134046EbbDae9;

    /* ======== CONSTRUCTION ======== */

    // constructor() {
    //     // require(_olympusTreasury != address(0));
    //     olympusTreasury = 0x72cbf71E19eCBa2F591fEAF0497134046EbbDae9;
    ...
    //     // require(_olympusDAO != address(0));
    //     olympusDAO = 0x72cbf71E19eCBa2F591fEAF0497134046EbbDae9;
    // }
    ...
    function createBondAndTreasury(
        ...
        return
            IOlympusProFactoryStorage(olympusProFactoryStorage).pushBond(
                _payoutToken,
                _principleToken,
                address(treasury),
                address(bond),
