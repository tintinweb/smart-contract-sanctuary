    ...
    Ownable
{
    ...
    function buy(uint256 _mintAmount) public payable {
        require(
            _mintAmount <= maxTokens,
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _safeMint(msg.sender, _mintAmount + i);
        }
    }
    ...
    function getMessageHash(
        ...
        return keccak256(abi.encode(_account, _tokenId, _price));
    }
    ...
    function mint(
        ...
        require(msg.value >= _mintAmount * cost, "see cost");
        bytes32 dataHash = getMessageHash(msg.sender, tokenId, price);
