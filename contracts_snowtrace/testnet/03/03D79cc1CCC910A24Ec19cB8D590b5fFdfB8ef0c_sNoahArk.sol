...
contract sNoahArk is ERC20Permit, Ownable {
    ...
    event rebaseEvent( uint256 profit_, uint epoch_ );

    constructor() ERC20("Staked NoahArk", "sNRK", 9) ERC20Permit() {
    ...
    /**
        @notice increases sNRK supply to increase staking balances relative to profit_
    ...
    function rebase( uint256 profit_, uint epoch_ ) public onlyStakingContract() returns ( uint256 ) {
        ...
        emit rebaseEvent(profit_, epoch_);
        return _totalSupply;
    }
    ...
    // Staking contract holds excess sNRK
