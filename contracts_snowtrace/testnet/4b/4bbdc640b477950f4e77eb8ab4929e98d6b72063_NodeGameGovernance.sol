...
Hello players. This token is the Governance Token for the Node Game.

The Node Game allows you to earn an average of 3% Daily (1095% APR) on your MIM tokens with no risk of impermanent loss. Compete with other players in the game to earn more.

This token pays a dividend in MIM, is used for voting in Node Game proposals, and fuels the Node Game itself.

Website: https://nodegamexyz.com
Discord: https://discord.gg/cUxbdKdhne
Twitter: https://twitter.com/nodegameavax

Tokenomics:

Total Supply: 1000 Trillion Tokens (1 Quadrillion)
Dividend: Magic Internet Money (MIM)

Fee Structure: (Use 15% or more Slippage)

Liquidity: 8%
MIM Dividend: 3%
Node Game Player Distribution: 3%
Team Fee: 1%
...
contract NodeGameGovernance is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address MIM = 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Node Game";
    ...
    address public gameFeeReceiver=0x02EC628F447e36708638edD2D5b6AdB4198433Ca;
    address devFeeReceiver=0xc0c88FAF5F7b1045a75f6a88C5b98A47038098f8;
    ...
    constructor (
        address _dexRouter, address _wAVAX, address _distributor
    ) Auth(msg.sender) {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountAVAXGame = amountAVAX.mul(gameFee).div(totalAVAXFee);
        uint256 amountAVAXDev= amountAVAX.mul(devFee).div(totalAVAXFee);

        try distributor.deposit{value: amountAVAXReflection}() {} catch {}
        payable(gameFeeReceiver).transfer(amountAVAXGame);
        payable(devFeeReceiver).transfer(amountAVAXDev);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _gameFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        gameFee = _gameFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_gameFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/4);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _gameFeeReceiver) external authorized {
