...
contract ASS is Context, IERC20, Ownable {
    ...
    address public _daoContractAddress = 0x174EEee814d632B793Dec30Dd3Df0E7e59efddF7;
  ...
  constructor() {
    ...
    // 10% to the DAO
    uint256 dao = blackHole.mul(23).div(100);

    // 1% royalty
    uint256 royalty = blackHole.mul(24).div(1000);
    ...
    // constructor(address _daoContractAddress, address _treasury) {
    //     daoContractAddress = _daoContractAddress;
    ...
    //     // 30% of remaining tokens for presale.
    //     uint256 presale = bunghole.mul(20).div(100);
    ...
    //       bunghole
    //     );
    //     emit Transfer(address(0), _treasury, presale);
    //     emit Transfer(address(0), _msgSender(), lp);
    //     emit Transfer(address(0), _daoContractAddress, dao);
    //     emit Transfer(
    //       address(0),
    //       assBurnAddress,
    //       assBurn
    ...
    //     _noFees[_daoContractAddress] = true;
    //     _noFees[_treasury] = true;
    // }
...
////    0x0a32675056Ba07A8cE9B0a53F2D690a2Aa16dd2C
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
