...
/**
 * @title Thermo's SBNB Contract
 * @notice SToken which wraps BNB
 * @author Venus (Modified by Source)
 */
contract SBNB is SToken {
    /**
     * @notice Construct a new SBNB money market
    ...
    /**
     * @notice Send BNB to SBNB to mint
     */
