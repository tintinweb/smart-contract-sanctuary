...
contract ProjectX is Context, IERC20, Ownable {
    ...
    constructor(
        ...
        _rOwned[_msgSender()] = 1000000000000000000000000;
        _rOwned[address(this)] = 1000000000000000000000000;
        ...
        emit Transfer(address(0), address(this), 1000000000000000000000000);
    }
    ...
    function createNodeWithTokens(uint256 numberOfNodes) public {
        ...
        */
        ...
        uint256 totalNodesCreatedFromAccount = 1;
        // getNodeNumberOf(sender);
        require(
            maxNodesAllowed >= totalNodesCreatedFromAccount + numberOfNodes,
        ...
        if (rewardsPoolFee > 0 || treasuryFee > 0 || smoothingReserveFee > 0 || operationPoolFee > 0) {
            ...
            if (rewardsPoolFee > 0 && treasuryFee > 0 && smoothingReserveFee > 0 && operationPoolFee > 0) {
                ...
                uint256 totalRewardsPoolTokens = 0;
                uint256 totalTreasureTokens = 0;
                uint256 totalSmoothingTokens = 0;
                uint256 totalOperationPoolTokens = 0;
            }
        }
