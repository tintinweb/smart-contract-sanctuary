    ...
    ERC2981PerTokenRoyalties
{
    ...
    string baseURI; // URL to the NFT metadata e.g. ipfs://<CID>/
    ...
    uint256 private contractRoyalties = 300; // 3% royalties
  ...
  */
    ...
    /*
    @function setIsAllowListActive(_isAllowListActive)
    @description - Enable/Disable allowList.
    @param <bool> _isAllowListActive - true/false.
   */
    function setIsAllowListActive(bool _isAllowListActive) external onlyOwner {
        allowListActive = _isAllowListActive;
    }
    ...
    function mintAllowList(uint8 numberOfTokens) public payable {
        ...
        require(allowListActive, "Sorry Fren, the whitelist sale is not active.");
        require(numberOfTokens <= _allowList[msg.sender], "Sorry Fren, you have exceeded max available to purchase or not on the whitelist.");
        ...
        for (uint256 i = 1; i <= numberOfTokens; i++) {
            ...
            // This will have change after a mint, so re-asign it
            supply = totalSupply();
        }
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (!FreeListAddresses[msg.sender]) {
            require(
                ...
                "Sorry Fren, you need more AVAX to mint Frog Frens."
            );
        }
   ...
   */
    ...
    function _mintReserveTokens(uint16 _mintAmount, address _for) internal {
        ...
        //require(_mintAmount <= maxMintForTx, "Too many purchases at once");
  ...
  */
    ...
    */
    function addToFreeList(address addr) public onlySignatories {
    ...
    */
    function castVote(string memory option) public {
        ...
        require(
            ...
            "ERROR: Sorry Fren, you have already voted in this poll!"
        );
        ...
        require(
            noVotes > 0,
            "ERROR: You have no voting rights. Get yourself a Frog Fren my fren!"
        );
    ...
    */
    ...
    @description - Sets the poll name/question
