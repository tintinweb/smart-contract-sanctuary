...
contract knivesRoyalties {
    ...
    function rewardsOf(address _user) public view returns(uint256){
        ERC721Enumerable contrat = ERC721Enumerable(_contract);
        uint256 share = contrat.balanceOf(_user)/contrat.totalSupply();
        uint reward;
    ...
    function claim() public {
        payable(msg.sender).transfer(rewardsOf(msg.sender));
