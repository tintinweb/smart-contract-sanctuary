...
contract DividendDistributor is IDividendDistributor {
    ...
    //IBEP20 EP = IBEP20(0xCE1bFFBD5374Dac86a2893119683F4911a2F7814); // SPELL Token - MAINNET
    //address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX Token - MAINNET
    
    IBEP20 EP = IBEP20(0x66bCC0017D98787e46333F11cE6CD92D276133Eb); // SPELL Token - TESTNET
    address WAVAX = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c; // WAVAX Token - TESTNET
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        //: IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); // TraderJoe Router - MAINNET
        : IDEXRouter(0x5db0735cf88F85E78ed742215090c465979B5006); // TraderJoe Router - TESTNET
        _token = msg.sender;
    }
...
contract Spellcaster is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    
    // address EP = 0xCE1bFFBD5374Dac86a2893119683F4911a2F7814; // SPELL Token - MAINNET    
    //address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX Token - MAINNET
    address EP = 0x66bCC0017D98787e46333F11cE6CD92D276133Eb; // SPELL Token - TESTNET
    address public WAVAX = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c; // WAVAX Token - TESTNET

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Spellcaster.money";
    string constant _symbol = "SPELLCASTER";
    ...
    address public autoLiquidityReceiver=0x3C363f43c736BbC0Ed028e0EC09C1b7FFD15Ec55;
    address public marketingFeeReceiver=0x3C363f43c736BbC0Ed028e0EC09C1b7FFD15Ec55;
    ...
    constructor () Auth(msg.sender) {
        //address _router = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // TraderJoe Router - MAINNET
        address _router = 0x5db0735cf88F85E78ed742215090c465979B5006; // TraderJoe Router - TESTNET
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        //address routerAddress = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // TraderJoe Router - MAINNET
        address routerAddress = 0x5db0735cf88F85E78ed742215090c465979B5006; // TraderJoe Router - TESTNET
