...
contract DAOCapPresale is Ownable {
    ...
    constructor(address _token)  {
        ...
        tokenPricePerUsd = tokenPricePerUsd.mul(10 ** priceFeed.decimals());
    }
    ...
    function usdToAvax(uint256 value) public view returns (uint256) {
        return (value * (10**priceFeed.decimals())) / (getLatestPrice());
    }
    ...
    function usdToTokens(uint256 usd_amount)view public returns(uint256) {
        return (usd_amount
                    .mul(10**priceFeed.decimals())
                    .mul(1e18))
                    .div(tokenPricePerUsd);
    }
