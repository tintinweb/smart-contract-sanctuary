...
contract AVAXGMPublicMint is Ownable {
    ...
    */
    ...
    // approve avax
    function approveAVAX() external {
        IERC20(AVAX).approve(_msgSender(), mintPrice * MintQuota);
    }
    ...
    function publicMint(uint256 amount) external {
        ...
        require(IERC20(AVAX).balanceOf(_msgSender()) >= mintPrice * amount);
        _usedQuota[_msgSender()] = _usedQuota[_msgSender()] + amount;
        IERC20(AVAX).transferFrom(_msgSender() ,address(this), mintPrice * amount);
