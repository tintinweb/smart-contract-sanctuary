...
contract Vaccines is Ownable, Pausable, Presale, EIP712, ERC721Enumerable {
    ...
    bool private _isPresale = true;
    string private constant SIGNING_DOMAIN = "VaccinesNFT";
    ...
    */
        ...
        onlyPublicSale
    {
        ...
        for (uint256 i = 0; i < tokenCount; i++) {
            mintNext(msg.sender);
            _splitBalance(msg.value / tokenCount);
        }
    }

    function presaleMint(NFTVoucher calldata voucher, uint256 tokenCount)
        public
        payable
        onlyPresale
        whenNotPaused
    {
        ...
        require(
            msg.sender == voucher.reciever,
            "Voucher reciever and msg.sender are not the same"
        );
        require(
