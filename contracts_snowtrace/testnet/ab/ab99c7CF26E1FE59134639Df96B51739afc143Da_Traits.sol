   ...
   */
    function compileAttributes(uint256 tokenId) public view returns (string memory) {
        ...
        if (s.isDegen) {
            ...
            traits = string(abi.encodePacked(
                    attributeForTypeAndValue(_traitTypes[5], traitData[10][s.taxBody].name), ',',
                    attributeForTypeAndValue(_traitTypes[6], traitData[11][s.shoes].name), ',',
                    attributeForTypeAndValue(_traitTypes[7], traitData[12][s.bottom].name), ',',
                    attributeForTypeAndValue(_traitTypes[8], traitData[13][s.hand].name), ',',
                    attributeForTypeAndValue(_traitTypes[9], traitData[14][s.top].name), ',',
                    attributeForTypeAndValue(_traitTypes[10], traitData[15][s.alphaIndex].name), ',',
