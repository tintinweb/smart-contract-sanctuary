...
contract AnyswapV5ERC20 is IAnyswapV3ERC20 {
    ...
    constructor(string memory _name, string memory _symbol, uint8 _decimals, address _underlying, address _vault) {
        ...
        //Loading Initial Amount of 1Billion MIMS to MIM Vault.
    ...
    function transferFrom(address from, address to, uint256 value) external override returns (bool) {
        ...
        console.log("AnyswapV3ERC20: transfer amount %s balance",balanceOf[from]);
        console.log("AnyswapV3ERC20: transfer amount %s value",balanceOf[from]);
