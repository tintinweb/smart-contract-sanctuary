...
contract GnosisSafeProxyFactory {
    ...
    function allProxysLength() external view returns (uint256) {
        return allProxys.length;
    }
    function getProxys(uint i) external view returns(address){
        return allProxys[i];
    }
