...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address public treasuryWallet = 0xeB2B7dbf1D37B1495f855aCb2d251Fa68e1202ce;
    address public dexWallet = 0xeB2B7dbf1D37B1495f855aCb2d251Fa68e1202ce;
     ...
     */
    function allowance(address _owners, address _spender)
        public
        view
        override
        returns (uint256)
    {
        return _allowances[_owners][_spender];
    }
...
require(tradingActive, "TRADING NOT ACTIVE FOOL");
    ...
    function _approve(
        ...
        require(lowner != address(0), "ERC20: approve from the zero address");
        require(spender != address(0), "ERC20: approve to the zero address");

        _allowances[lowner][spender] = amount;
        emit Approval(lowner, spender, amount);
    }
...
contract FAST is ERC20 {
    using SafeMath for uint256;
    using Address for address;

    uint256 private constant _totalSupply = 200000000000 * 10**6 * 10**9;

    address dev1 = 0x91E97BCe7037DB52A5eABf6DA7a9EdFF587BB224;
    address dev2 = 0x7eB43798074E8f539a44ffFAd7053E726178B315;
    address dev3 = 0xCe464AeD1E557Ac1C6CDdB97C37026b4605203Ea;
    address dev4 = 0x4afb426245Cf9CE083F8E56f2617Ad9FEDe51607;
