...
contract Cryptonauts is ERC721Enumerable, Ownable {
    ...
    address founder = 0xe4F8cF935766e4CEFdc40ACa2CcBBde5eD1dF84A; // FO
    address member01 = 0xe4F8cF935766e4CEFdc40ACa2CcBBde5eD1dF84A; // KT
    address member02 = 0xe4F8cF935766e4CEFdc40ACa2CcBBde5eD1dF84A; // SA
    address member03 = 0xe4F8cF935766e4CEFdc40ACa2CcBBde5eD1dF84A; // OB
    address member04 = 0xe4F8cF935766e4CEFdc40ACa2CcBBde5eD1dF84A; // ID
    address member05 = 0xe4F8cF935766e4CEFdc40ACa2CcBBde5eD1dF84A; // ST
    
    constructor (
        ) ERC721("TestContract3", "TSTCNTRCT") {

            royaltyReceiver = payable(msg.sender);
            setBaseURI("https://api.avaxbricks.com/");
            mint(0x9b9F4980698487f2b77e4d5BfACea830aAf63ae5, 20);
        ...
        function mint(address _to, uint256 _mintAmount) public payable {
            ...
            if (totalSupply() >= 20) {
                require(msg.value == cost * _mintAmount, "Wrong cost input!");
            }
        ...
        // _withdraw(founder, (balance * 350) / 1000); // 35%
        // _withdraw(member01, (balance * 200) / 1000); // 20%
        // _withdraw(member02, (balance * 200) / 1000); // 20%
        // _withdraw(member03, (balance * 100) / 1000); // 10%
        // _withdraw(member04, (balance * 100) / 1000); // 10%
        // _withdraw(member05, (balance * 50) / 1000); // 5%
