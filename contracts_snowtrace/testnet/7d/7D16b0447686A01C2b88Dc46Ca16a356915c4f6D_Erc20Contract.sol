...
contract Erc20Contract is ERC20, ERC20Pausable, ERC20Capped, Ownable {

  /**
    * @dev Initializes the contract by setting `initialSupply` to ERC20Capped extension, `name` and `symbol` to the token.
    */
  constructor(string memory name_, string memory symbol_, uint256 initialSupply_) ERC20Capped(initialSupply_) ERC20(name_, symbol_) {
