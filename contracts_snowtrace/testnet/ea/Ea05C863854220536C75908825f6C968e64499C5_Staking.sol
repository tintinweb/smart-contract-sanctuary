...
contract Staking is Ownable {
    ...
    uint256 public minimumDays = 6 minutes;
    uint256 public lockTime = 4 minutes;
    ...
    function unstake(uint256 _stakeCount) public {
        ...
        user.totalStakedTokens -= user.stakerecord[_stakeCount].amount;
        _totalStakedTokens -= user.stakerecord[_stakeCount].amount;
        emit Unstake(
            msg.sender,
        ...
        )
    {
        ...
        totalAmount = user.totalStakedTokens;
    }
        ...
        )
    {
        ...
        return (
            ...
            user.stakerecord[_stakeCount].unstaked
        );
    }
}
