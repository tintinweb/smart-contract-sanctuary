...
contract AlphaENIGMMigration is Ownable {
  ...
  function migrate() external {
    uint256 availableTokens = available(msg.sender, block.timestamp, aENIGM.balanceOf(msg.sender), lastMigration[msg.sender]);
  ...
  function withdrawAll() external onlyOwner {
    require(block.timestamp > steps[steps.length - 1], "Migration of aENIGM has not ended");
