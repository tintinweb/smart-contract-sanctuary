...
/*
----------------------------------------------------------------------------------------------------
Tomorrow Tree Test Token version 2 - Test 3
----------------------------------------------------------------------------------------------------
*/
...
contract TomorrowTreeTestToken2 is ERC20, ERC20Burnable, ERC20Snapshot, Pausable {
    
    address TomorrowTree; //owner and admin
    address Minter; //transferred to ProjectVoting Smart Contract
    ...
    constructor() ERC20("TTTT2v3", "TT2v3") {
