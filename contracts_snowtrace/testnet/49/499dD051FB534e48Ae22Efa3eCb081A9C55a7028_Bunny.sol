...
contract Bunny is ERC721Metadata {
    ...
    uint256 public constant MAX_NFT_SUPPLY = 3232;
    ...
    uint256[3233] private _pendingIDs;
    ...
    function _splitBalance(uint256 amount_)
        ...
        uint256 devAllocation = subAmount.mul(75).div(100);
        payable(_devAllocationAddress).transfer(devAllocation);

        uint256 partyBuyerAllocation = subAmount.sub(devAllocation);
