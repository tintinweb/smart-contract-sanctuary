...
contract BullAndBear is ERC721Enumerable, Ownable, Pauseable {
    ...
    // reference to the Market for choosing random Police thieves
   ...
   */
    function selectRecipient(uint256 seed) internal view returns (address) {
        ...
        address thief = market.randomPoliceOwner(seed >> 144);
   ...
   */
    function selectTraits(uint256 seed) internal view returns (Trait memory) {
        ...
        if (t.isBear) {
            uint[] memory _traits = new uint[](traits.bearTraitsNumber());
            ...
            uint[] memory _traits = new uint[](traits.bullTraitsNumber());
