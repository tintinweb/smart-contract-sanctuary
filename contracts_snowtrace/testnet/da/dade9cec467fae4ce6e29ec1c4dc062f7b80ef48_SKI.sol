...
contract SKI is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Ski", "SKI", 9) ERC20Permit() {
    ...
    /**
        @notice increases ski supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess ski
