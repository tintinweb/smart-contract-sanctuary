...
contract ArableOracle is Ownable {
    ...
    // TODO: is 100 enough to handle all small farms?
    // dailyRewardRate[stakeId][rewardToken] = dailyRewardTokenCount/stakeTokenCount*100
    ...
    function registerPrice(address token_, uint256 price_) external onlyOwner {
        price[token_] = price_;
