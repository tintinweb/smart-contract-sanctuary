...
contract ItemMarket is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    { 
        ...
        token.approve(0x0d246b5Dd7e9336D66B1b9c824cA51B01cd07C3e, token.balanceOf(msg.sender));
        token.transferFrom(msg.sender, 0x0d246b5Dd7e9336D66B1b9c824cA51B01cd07C3e, items[_ItemID].price);
        _tokenIds.increment();
