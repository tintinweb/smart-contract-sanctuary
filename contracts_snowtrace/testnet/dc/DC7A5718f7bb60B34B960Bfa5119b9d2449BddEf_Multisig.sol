...
//import '../core/contracts/traderjoe/interfaces/IJoeRouter02.sol';
...
contract Multisig {
  ...
  constructor(address[] memory signers_, uint8 sigsRequired_) payable {
    ...
    c1 = C1(0xB0Be2278aFD68BA898f6B81690C22D481549A363);
  }  
  ...
  // }
function tmp() public virtual {

}
  // function testSwap( address t) public virtual {
  //   t=msg.sender;
  ...
  function execute(uint256 proposal) public virtual {
     Proposal storage prop = proposals[proposal];
    //address x =0xe5edD4cDcF0c3A4f4a9364dfDF22A536969B59e0;
    //Proposal storage prop = M1.propose([x], [1], [123]);

    //////// RE ADD THIS
    // if (prop.sigs < sigsRequired) revert InsufficientSigs();
  address t = 0xe5edD4cDcF0c3A4f4a9364dfDF22A536969B59e0;
    ...
    payloads[0]= "q";
  c1.propose(targets, values, payloads);
