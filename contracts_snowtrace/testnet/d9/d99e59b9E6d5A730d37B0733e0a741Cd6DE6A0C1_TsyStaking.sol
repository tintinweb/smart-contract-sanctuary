...
contract TsyStaking is Ownable {
    ...
    /**
        @notice stake TSY to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sTSY from warmup
    ...
    /**
        @notice forfeit sTSY in warmup and retrieve TSY
     */
    ...
    /**
        @notice returns the sTSY index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract TSY holdings, including bonuses provided
        @return uint
     */
