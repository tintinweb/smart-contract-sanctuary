...
contract STDAO is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public RiskFreeValue = 2;
    ...
    constructor() ERC20Detailed("STDAO", "STDAO", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x26DF8BB063be83c9dFF70fC32aA4b776b9dC0Be5;
        TreasuryReceiver = 0x2959A44FeA735C13018146b784e9D4564F55C1A3;
        RiskFreeValueReceiver = 0xd04b828B2C022b28845044Eb84aaC6C285be4547;
