...
library Counters {
    ...
    function increment(Counter storage counter) internal {
        // The {SafeMath} overflow check can be atnpped here, see the comment at the top
        counter._value += 1;
    }
...
contract sAthena is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sAthena", "SATN", 9) ERC20Permit() {
    ...
    /**
        @notice increases sAthena supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sAthena
