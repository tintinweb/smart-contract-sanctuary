...
contract HEC_Team_Distribution is HEC_Base_Distribution {
    //Constants - In accordance with Token Distribution Plan
    uint256 public constant TOTAL_CONTRACT_BALANCE = 20000000 * 10^18; //20% (20 million)
    uint256 public constant TGE_UNLOCK_PERCENTAGE  = 0; //0%
    uint256 public constant CLIFF_END_EPOCH_TIME   = 1666188000; //UTC: Wednesday, October 19, 2022 2:00:00 PM
    uint256 public constant VESTING_END_EPOCH_TIME = 1729346400; //UTC: Saturday, October 19, 2024 2:00:00 PM
