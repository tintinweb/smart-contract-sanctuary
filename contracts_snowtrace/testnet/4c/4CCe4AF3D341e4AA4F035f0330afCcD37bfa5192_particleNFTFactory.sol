...
contract particleNFTFactory is AccessControl, Ownable, IERC721Receiver, ReentrancyGuard {
  ...
  function makeERC2981(
    ...
    _nfts[msg.sender].transferRole(DEFAULT_ADMIN_ROLE, msg.sender);
    _nfts[msg.sender].transferRole(MINTER_ROLE, msg.sender);
  }
