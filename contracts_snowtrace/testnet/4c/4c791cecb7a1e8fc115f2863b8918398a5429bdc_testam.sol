...
contract testam is Context, IERC20, Ownable {
    ...
    uint256 private startingSupply = 1_000_000_000; //1 Billion, underscores aid readability
    ...
    address payable private _marketingWallet =
        payable(0x30b7388CeE603f76AfE4CF908dE4418e4c928345);
    ...
    {
        return
            _amount.mul(_liquidityFee.add(_marketingFee)).div(masterTaxDivisor);
    }
