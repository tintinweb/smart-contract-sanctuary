...
contract ASS is Context, IERC20, Ownable {
    ...
    address public assBurnAddress = 0xdBD0a681A43233Ce4882Dd2115A2C963e1834AcD;
    address public dev1 =  0xd26A81990AD4F13ac9F614325f7bc8Ab90Ba7A33;
    address public dev2 =   0xDD942EF7c4a8F9764f111D754989200b5919faff;
    address public dev3 =   0xD7467bD9ddb8B0C56a7bBA2D2717a0cc06F0590E;
    address public dev4 =   0x47E78C56ed2002EEa757450f7b32b3477b7E2aD4;
    address public dev5 =   0x031d1DD177697f302f93732f781B1e4931e68c38;
    address public daoContractAddress = 0x174EEee814d632B793Dec30Dd3Df0E7e59efddF7;
    address public _treasury = 0xdBD0a681A43233Ce4882Dd2115A2C963e1834AcD;
    ...
    string private _name = "Arctic Snow Seal";
    ...
    struct ReserveValues {
        ...
        uint256 reserveTransferAmountbungassBurn;
    }
  ...
  constructor() {
    ...
    uint256 bunghole = _totalSupply.div(2);
    uint256 presale = bunghole.mul(2).div(10);
    uint256 lp = bunghole.mul(45).div(100);
    uint256 dao = bunghole.mul(23).div(100);
    uint256 royalty = bunghole.mul(24).div(1000);
        
    uint256 rate = getRate();
    
    _reserveTokenBalance[burn] = bunghole.mul(rate);
    _reserveTokenBalance[_treasury] = presale.mul(rate);
    _reserveTokenBalance[_msgSender()] = lp.mul(rate);
    _reserveTokenBalance[daoContractAddress] = dao.mul(rate);
    _reserveTokenBalance[assBurnAddress] = royalty.mul(rate);
    ...
    function isAstraightG(address account) public view returns (bool) {
        return _noFees[account];
    }
    ...
    function emmitGangsta(address account) external onlyOwner {
        _noFees[account] = true;
        _nofee.push(account);
    }
    ...
    function applyExternalTransactionTax(
        ...
        _reserveTokenBalance[daoContractAddress] = _reserveTokenBalance[
            daoContractAddress
        ].add(reserveValues.reserveTransferAmountDao);
        emit Transfer(sender, daoContractAddress, transactionValues.daoTax);
        _reserveTokenBalance[assBurnAddress] = _reserveTokenBalance[
            assBurnAddress
        ].add(reserveValues.reserveTransferAmountbungassBurn);
        emit Transfer(sender, assBurnAddress, transactionValues.bungassBurn);
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _getXalues(uint256 transferAmount)
        private
        view
        returns (
            TransactionValues memory,
        ...
        )
    {
        ...
        uint256 currentRate = getRate();
        ReserveValues memory reserveValues = _getNValues(
            transferAmount,
            transactionValues,
            currentRate
        );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        returns (TransactionValues memory)
    {
        ...
        transactionValues.transactionFee = 0;

        transactionValues.daoTax = transferAmount.mul(7).div(100);

        transactionValues.bungassBurn = transferAmount.mul(30).div(1000);
        // Net transfer amount to recipient
        transactionValues.netTransferAmount = transferAmount
            // .sub(transactionValues.transactionFee)
            .sub(transactionValues.daoTax)
            .sub(transactionValues.bungassBurn);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
   function _getNValues(
        ...
        reserveValues.reserveFee = transactionValues.transactionFee.mul(
            currentRate
        );
        reserveValues.reserveTransferAmountDao = transactionValues.daoTax.mul(
            currentRate
        );
        reserveValues.reserveTransferAmountbungassBurn = transactionValues
            .bungassBurn
            .mul(currentRate);
        reserveValues.reserveTransferAmount = reserveValues
            .reserveAmount;
            // .sub(reserveValues.reserveFee);
            // .sub(reserveValues.reserveTransferAmountDao)
            // .sub(reserveValues.reserveTransferAmountbungassBurn);
