...
contract AthenaStaking is Ownable {
    ...
    /**
        @notice stake ATN to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sATN from warmup
    ...
    /**
        @notice forfeit sATN in warmup and retrieve ATN
     */
    ...
    /**
        @notice returns the sATN index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract ATN holdings, including bonuses provided
        @return uint
     */
