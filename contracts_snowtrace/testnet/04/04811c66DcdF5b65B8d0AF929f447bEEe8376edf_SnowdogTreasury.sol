...
contract SnowdogTreasury is Ownable {
    ...
    constructor (
        ...
        isLiquidityToken[ _SDAOMIM ] = true;
        liquidityTokens.push( _SDAOMIM );
        bondCalculator[_SDAOMIM] = _bondCalculator;
    ...
    function withdraw( uint _amount, address _token ) external {
        ...
        uint value = valueOfToken( _token, _amount );
        ISDAOERC20( SDAO ).burnFrom( msg.sender, value );
    ...
    function repayDebtWithSDAO( uint _amount ) external {
        ...
        ISDAOERC20( SDAO ).burnFrom( msg.sender, _amount );
