...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/token/ERC20/ERC20.sol
...
contract MIM is ERC20 {
    ...
    constructor() public ERC20("MIM", "MIM") {
        uint256 fixedSupply = 1e20 * 10**18; // Since 18 is the number of decimals
    ...
    function buyNewToken(uint256 amount) public {
        _mint(msg.sender, amount);(msg.sender, amount);
    }
