...
contract PreSale is ERC20 {
    ...
    uint256 public MAX_SUPPLY = 500*1000*10**18;

    uint256 public SALE_START = 1639322400;
    uint256 public PRESALE_START = SALE_START + 6 * 60;

    mapping(address => bool) public _whitelists;

    constructor() ERC20("Token DAO Presale Token", "TOKENDAO", 18) {
        MIM = IERC20Metadata(0x4A138A6F17B733C1C0aCD9b9E63dbFA78eFc33Be);
    }
