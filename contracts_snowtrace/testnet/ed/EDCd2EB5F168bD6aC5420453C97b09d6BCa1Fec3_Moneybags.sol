...
// File: contracts/Moneybags.sol

pragma solidity 0.6.12;

// The Moneybags contract accumulates a portion of Alligator's trading fees and rewards staked GTR holders.
// It handles swapping between GTR and xGTR (Alligator's staking token).
contract Moneybags is ERC20("Moneybags", "xGTR") {
    using SafeMath for uint256;
    IERC20 public gtr;
