...
contract PreSeedDistribution is Ownable, ReentrancyGuard {
    ...
    /**
        @notice send epoch reward to staking recipient
     */
    function claim() external nonReentrant {
        ...
        //calculate the number of vesting units passed since the most recent claim time (or TGE time initially)
        //for instance, if this is a daily vesting; this calculations gives the number of days passed since last claim (or TGE time)
        //we use the number of seconds passed and divide it by number of seconds in a vesting time unit (i.e. daily vesting = 24 * 60 * 60 = 86,400 secs)
    ...
    /**
        @notice Send unlocked balance to caller
     */
    ...
    /**
        ...
        @param _releaseAmountPerVestingTimeUnit uint256
     */
