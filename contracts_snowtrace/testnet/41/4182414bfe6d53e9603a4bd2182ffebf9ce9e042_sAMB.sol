...
contract sAMB is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Ambrosia", "sAMB", 9) ERC20Permit() {
    ...
    /**
        @notice increases sAMB supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sAMB
