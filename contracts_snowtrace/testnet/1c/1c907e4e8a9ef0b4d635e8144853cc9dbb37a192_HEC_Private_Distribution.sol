...
abstract contract HEC_Base_Distribution is Ownable, ReentrancyGuard {
    ...
    /**
        ...
        @param _recipient address
     */
    function _removeRecipient( uint256 _index, address _recipient ) private {
    ...
    */
    function addRecipients(address[] memory _recipients, uint256[] memory _tokenAmounts) external nonReentrant onlyOwner {
    ...
    /**
        ...
        @param _recipients address[]
    */
    function removeRecipients( uint256[] memory _indices, address[] memory _recipients) external nonReentrant onlyOwner {
    ...
    */
    function suspendOperations() external nonReentrant onlyOwner {
        STOPPED = true;
    }
    ...
    */
    function resumeOperations() external nonReentrant onlyOwner {
        STOPPED = false;
    }

    /**
        @notice get remaining balances of all recipients
    */
...
contract HEC_Private_Distribution is HEC_Base_Distribution {
    ...
    */
    function setContractProperties( uint256 _InitialContractBalance, uint256 _TGEEpochTime, uint256 _TGEUnlockPercentage, uint256 _CliffEndEpochTime, uint256 _VestingEndEpochTime ) external onlyOwner returns (bool) {
        ...
        require(IERC20( HeC ).balanceOf( address(this) ) == 0, "Contract already has tokens. Cannot change dates at this moment.");
