...
contract IndexStaking is Ownable {
    ...
    /**
        @notice stake INDEX to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sINDEX from warmup
    ...
    /**
        @notice forfeit sINDEX in warmup and retrieve INDEX
     */
    ...
    /**
        @notice redeem sINDEX for INDEX
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns the sINDEX index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract INDEX holdings, including bonuses provided
        @return uint
     */
