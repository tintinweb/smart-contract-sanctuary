...
contract Traits is Ownable, ITraits {
        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(
            abi.encodePacked(
                '{"name": "',
                s.isSheep ? "Fast Food Sheep #" : "Fast Food Wolf #",
                tokenId.toString(),
                '", "description": "Thousands of Sheep and Wolves compete on-chain by farming in the Fast Food Metaverse to earn $FFWOOL, with high stakes. All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just Polygon.", "image": "data:image/svg+xml;base64,',
