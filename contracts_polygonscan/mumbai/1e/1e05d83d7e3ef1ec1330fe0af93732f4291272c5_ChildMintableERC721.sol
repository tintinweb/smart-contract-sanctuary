    ...
    ContextMixin
{
    ...
    //address childChainManager = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa; //Polygon Mainnet
    address childChainManager = 0xb5505a6d998549090530911180f38aC5130101c6; //Polygon Mumbai
...
//   }
  ...
  //only owner
  function setCost(uint256 _newCost) public only(DEFAULT_ADMIN_ROLE) { //public onlyOwner
    cost = _newCost;
  }

  function setmaxMintAmount(uint256 _newmaxMintAmount) public only(DEFAULT_ADMIN_ROLE) {
...
//   }
  ...
  function pause(bool _state) public only(DEFAULT_ADMIN_ROLE) {
    paused = _state;
  }

  function withdrawFunds() public payable only(DEFAULT_ADMIN_ROLE) {
    require(payable(_msgSender()).send(address(this).balance));
  }
  
//   function reserveNFT(uint256 _amount) public only(DEFAULT_ADMIN_ROLE) {        
