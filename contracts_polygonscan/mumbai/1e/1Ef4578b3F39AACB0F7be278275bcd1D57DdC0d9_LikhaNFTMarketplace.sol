...
contract LikhaNFTMarketplace is ReentrancyGuard {
    ...
    function listItem(
        ...
        emit MarketplaceEvent(
            _eventId.current(),
            msg.sender,
            string(abi.encodePacked("A Token was listed for sale \n Id : ", tokenId))
        );
    }
        ...
        nonReentrant
    {
        ...
        uint256 commission = msg.value * (commissionRate / 100); // gets commission
        ...
        emit MarketplaceEvent(
            _eventId.current(),
            msg.sender,
            string(abi.encodePacked("An item was sold. \n Id : ", tokenId, " commission : ", commission, " to seller : ", (msg.value - commission)))
        );
    }
