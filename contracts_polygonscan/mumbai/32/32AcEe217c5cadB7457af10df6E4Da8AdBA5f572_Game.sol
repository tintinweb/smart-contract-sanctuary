...
contract Game is ReentrancyGuard {
    ...
    constructor(
        ...
        workerInstance = WorkerNFT(workerAddress);
    ...
    function myTokenInContract() external view returns (uint256 tokenAmount) {
        return playerTokenInContract[msg.sender];
    }

    function withdrawToken(uint256 withdrawAmount) external nonReentrant {
