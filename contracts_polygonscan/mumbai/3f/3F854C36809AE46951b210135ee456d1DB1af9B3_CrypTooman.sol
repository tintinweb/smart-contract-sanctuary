...
contract CrypTooman is ERC20, Ownable {
    ...
    // aToken addresses (https://docs.aave.com/developers/deployed-contracts/matic-polygon-market)
    address public constant ADDRESS_AAVE_USDT = 0xF8744C0bD8C7adeA522d6DDE2298b17284A79D1b;
    address public constant ADDRESS_AAVE_USDC = 0x2271e3Fef9e15046d09E1d78a8FF038c691E9Cf9;
    address public constant ADDRESS_AAVE_DAI = 0x639cB7b21ee2161DF9c882483C9D55c90c20Ca3e;

    // lending pool address provider
    address public constant ADDRESS_LENDING_POOL_ADDR_PROVIDER = 0x178113104fEcbcD7fF8669a0150721e231F0FD4B;
