...
contract Auction is
    ...
    */
    ...
    function executeLazyAuction(
        ...
        // leftOrderFill.add(newFill.leftValue)

        uint256 auctioneerTake = (value.mul(auctioneerFee)).div(100);
        uint256 minterTake = (value.mul( _tokenData.minter.value)).div(100);
        uint256 platformTake = (value.mul(platformFee)).div(100);
        ...
        value = value.sub(auctioneerTake);
        value = value.sub(minterTake);
        value = value.sub(platformTake);
