...
contract XFUNPayMaster is BasePaymaster {
    /// @notice The target contract we are willing to pay for...
    address public target;

    /// @notice Allow the owner to set Target
    ...
    function preRelayedCall(
        ...
        require(relayRequest.request.to == target);
