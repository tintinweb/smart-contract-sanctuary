...
// File: contracts/upgradeable/KlimaBondDepositoryUpgradeable.sol
...
contract KlimaBondDepositoryUpgradeable is OwnableUpgradeable {
    ...
    address public KLIMA; // token given as payment for bond
    address public principle; // token used to create bond
    address public treasury; // mints KLIMA when receives principle
    ...
    /**
     * Initializer function for Upgradeable bonds
     */
    function initialize(
        address _KLIMA,
        address _principle,
        ...
        __Ownable_init();
        __KlimaBondDepositoryUpgradeable_init( _KLIMA,  _principle, _treasury,  _DAO, _bondCalculator);
    }

    function __KlimaBondDepositoryUpgradeable_init(
        address _KLIMA,
        address _principle,
        address _treasury,
        address _DAO,
        ...
        require( _KLIMA != address(0), "Klima Address cannot be 0" );
        require( _principle != address(0), "Principle Address cannot be 0" );
