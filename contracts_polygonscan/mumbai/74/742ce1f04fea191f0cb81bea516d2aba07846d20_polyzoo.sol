...
contract polyzoo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xcC657F0483921cf3EeC823d00E21907e69C59B52); // Marketing Address
    ...
    string private _name = "Polyzoo";
    string private _symbol = "PLZ";
