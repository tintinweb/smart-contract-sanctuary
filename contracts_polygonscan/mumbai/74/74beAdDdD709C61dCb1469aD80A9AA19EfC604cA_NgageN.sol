...
contract NgageN is AccessControlUpgradeable, ERC1155Upgradeable {
    ...
    mapping(address => mapping(address => mapping(uint256 => bool)))
        private _operatorTokenApprovals;
    ...
    modifier onlyAdmin() {
        require(
            ...
            "NgageN: Caller must be contract admin"
        );
        _;
    }
    ...
    modifier onlyOperator() {
        require(
            ...
            "NgageN: Caller must be a whitelisted account"
        );
        _;
    }
    ...
    function setURI(string memory newuri) public onlyAdmin {
        require(bytes(newuri).length > 0, "NgageN: Base URI cannot be null");
        _setURI(newuri);
    }
        ...
        onlyOperator
    {
        require(
            ...
            "NgageN: Token URI cannot be null"
        );
    ...
    function setContractURI(string memory _contractUri) public onlyAdmin {
        require(
            ...
            "NgageN: Contract URI cannot be null"
        );
        contract_uri = _contractUri;
    }
    ...
    function mintNFT(
        ...
        require(
            ...
            "NgageN: Only Orginal creator can mint more token balance"
        );
        require(
            bytes(_tokenUri).length > 0,
            "NgageN: Token URI cannot be null"
    ...
    function mintNFTBatch(
        ...
        require(
            ...
            "NgageN: Token IDs and Token URIs length mismatch"
        );
    ...
    function safeTransferFrom(
        ...
        require(
            ...
            "NgageN: caller is not approved for tranfer"
        );
    ...
    function isApprovedForTokens(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            if (_operatorTokenApprovals[account][operator][ids[i]] == false) {
                return false;
            }
        }
        return true;
    ...
    function isApprovedForToken(
        ...
        return _operatorTokenApprovals[account][operator][id];
    }
    ...
    function setApprovalForToken(
        ...
        require(
            ...
            "NgageN: Only operator or token holder can call this function."
        );
        _operatorTokenApprovals[account][operator][id] = approved;
    ...
    function setApprovalForTokens(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            _operatorTokenApprovals[account][operator][ids[i]] = approved;
        }
