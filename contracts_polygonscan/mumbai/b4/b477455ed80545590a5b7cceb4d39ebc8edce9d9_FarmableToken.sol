...
contract FarmableToken is ERC20("FarmedSWAM", "FSWAM"), Ownable {
...
// MasterChef is the master of Farmed SWAM.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once Farmed SWAM is sufficiently
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of FSWAM
    ...
    // View function to see pending F on frontend.
    ...
    // Safe fish transfer function, just in case if rounding error causes pool to not have enough Fs.
