...
// File contracts/ChainlinkVRF.sol
...
contract ChainlinkVRF is Ownable, VRFConsumerBase {
    ...
    */     
     ...
     */
    function getRandomNumber(uint8 elevation, uint256 roundNumber) public view returns (uint256) {
        return uint256(keccak256(abi.encode(elevation, roundNumber, randomResult))) % 100;
    }
    ...
    /**
     * @dev Update seedRoundEndTimestamp // not needed in VRF
     * @param _seedRoundEndTimestamp amount of seedRoundEndTimestamp
     */

    function setSeedRoundEndTimestamp(uint256 _seedRoundEndTimestamp) external onlyElevationHelper {
