...
// File: contracts/LickStakingDistributor.sol
...
contract LickStakingDistributor is Ownable {
    ...
    constructor( address _treasury, address _lick, uint _epochLength, uint _nextEpochTime ) {
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return IERC20( LICK ).totalSupply().mul( _rate ).div( 1000000 );
    }
