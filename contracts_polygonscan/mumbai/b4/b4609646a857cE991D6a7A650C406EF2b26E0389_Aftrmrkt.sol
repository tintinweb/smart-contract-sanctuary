...
contract Aftrmrkt is ERC1155, Ownable, VRFConsumerBase{
    ...
    function buyPresalePremiumPack() external payable {
        require(preSale, "Contract::preCheck: Sale is not active");
        require(PremiumPack > 0, "Contract::buyPremiumPack: PremiumPacks are sold out.");
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK - fill contract with faucet");
        require(IERC20(WETH).allowance(_msgSender(), address(this)) <= PresalePremiumPackFee, "Contract::buyPremiumPack: Insufficient amount.");
    ...
    function buyPresaleFreshPack() external payable {
        require(preSale, "Contract::preCheck: Sale is not active");
        require(FreshPack > 0, "Contract::buyFreshPack: FreshPacks are sold out.");
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK - fill contract with faucet");
        require(IERC20(WETH).allowance(_msgSender(), address(this)) <= PresaleFreshPackFee, "Contract::buyPremiumPack: Insufficient amount.");
    ...
    function buyPresaleBasePack() external payable {
        require(preSale, "Contract::preCheck: Sale is not active");
        require(BasePack > 0, "Contract::buyFreshPack: FreshPacks are sold out.");
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK - fill contract with faucet");
        require(IERC20(WETH).allowance(_msgSender(), address(this)) <= PresaleBasePackFee, "Contract::buyPremiumPack: Insufficient amount.");
    ...
    function buyPremiumPack() external payable {
        require(mainSale, "Contract::preCheck: Sale is not active");
        require(PremiumPack > 0, "Contract::buyPremiumPack: PremiumPacks are sold out.");
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK - fill contract with faucet");
        require(IERC20(WETH).allowance(_msgSender(), address(this)) <= PremiumPackFee, "Contract::buyPremiumPack: Insufficient amount.");
    ...
    function buyFreshPack() external payable {
        require(mainSale, "Contract::preCheck: Sale is not active");
        require(FreshPack > 0, "Contract::buyFreshPack: FreshPacks are sold out.");
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK - fill contract with faucet");
        require(IERC20(WETH).allowance(_msgSender(), address(this)) <= FreshPackFee, "Contract::buyPremiumPack: Insufficient amount.");
    ...
    function buyBasePack() external payable {
        require(mainSale, "Contract::preCheck: Sale is not active");
        require(BasePack > 0, "Contract::buyFreshPack: FreshPacks are sold out.");
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK - fill contract with faucet");
        require(IERC20(WETH).allowance(_msgSender(), address(this)) <= BasePackFee, "Contract::buyPremiumPack: Insufficient amount.");
