...
contract CloudoxHippe is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) ERC1155Tradable("HippeTest v21", "HTV21", "http://opensea-creatures-api.herokuapp.com/api/creature/{id}", _proxyRegistryAddress) {}
...
contract ERC1155Tradable is ContextMixin, ERC1155, NativeMetaTransaction, Ownable {
  ...
  function freeMint(uint256 _id) public {
    ...
    // require(
    //     _checkOnERC721Received(address(0), _msgSender(), _id, ""),
