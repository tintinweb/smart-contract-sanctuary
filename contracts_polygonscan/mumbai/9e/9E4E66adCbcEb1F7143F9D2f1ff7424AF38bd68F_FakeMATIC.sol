...
contract FakeMATIC is ERC20PresetFixedSupply, ERC165, ERC20Permit {
    constructor(address _mintTo)
        ERC20PresetFixedSupply("FakeMATIC", "FMATIC", 100000000000 * 10 ** 18, _mintTo)
        ERC20Permit("FakeMATIC") {
    }
