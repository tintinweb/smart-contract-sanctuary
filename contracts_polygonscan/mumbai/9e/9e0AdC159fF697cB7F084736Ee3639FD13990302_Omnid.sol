...
contract Omnid is ERC721, ChainlinkClient {
    ...
    function createIdDev(address _for, uint256 _score, string memory _etching) external payable {
    ...
    function createId(address _for, string memory _etching) external payable {
    ...
    function refreshScore(uint256 _tokenId) external payable {
