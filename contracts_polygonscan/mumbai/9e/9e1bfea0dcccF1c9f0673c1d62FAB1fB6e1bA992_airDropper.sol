...
contract airDropper is Ownable, ERC1155Holder {
    ...
    function arrayAddressTesting(address [] memory _amount) public pure returns (address[] memory){
        return _amount;
    }

    function arrayUintTesting(uint [] memory _amount) public pure returns (uint[] memory){
        return _amount;
    }
