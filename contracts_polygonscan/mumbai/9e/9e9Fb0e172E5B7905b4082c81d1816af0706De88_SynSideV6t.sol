...
contract SynSideV6t {
  ...
  mapping(IERC20 => mapping(uint256 => IERC20)) private toChainToken;
  ...
  function setToChainToken(
    ...
    external
  {
    toChainToken[_token][_toChainId] = _toChainToken;
  }
    ...
    returns (bool success, bytes memory result)
  {
    ...
    userTokenBalance[_user][_receiveToken] += _amount;
  ...
  {
    return toChainToken[_token][_toChainId];
  }
}
