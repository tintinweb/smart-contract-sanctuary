    ...
    RandomNumberConsumer
{
    ...
    mapping(address => uint8) private transactionTypes;
    ...
    function buyTokensOnPresale() public {
        ...
        getRandomNumber();
        transactionTypes[msg.sender] = 1;
    }

    /**
     * @notice Invokes `buyTokens` with the quantity requested.
     */
    function buyTokensOnSale(uint8 quantity) public {
        require(
            block.timestamp > (presaleStartDate + presaleDuration),
        ...
        getRandomNumber();
        transactionTypes[msg.sender] = quantity;
    }

    /**
     * @notice Requests random number from Chainlink VRF.
     */
    function activatePurchase() public {}
    ...
    function saveRandomNumber(uint256 n) internal override {
        ...
        if (transactionTypes[msg.sender] == 1) {
            buyTokens(1);
            whitelisted[msg.sender] = false;
        } else {
            buyTokens(transactionTypes[msg.sender]);
        }
    }
