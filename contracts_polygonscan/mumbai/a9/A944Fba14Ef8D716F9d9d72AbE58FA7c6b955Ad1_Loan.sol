...
/** @title Loaning NFT. */
contract Loan is AccessProtected, ReentrancyGuard, BaseRelayRecipient, IERC721Receiver, EIP712Base {
    ...
    function updateNFTRewardsClaimer(uint256 _loanId, bool _isLoanerNFTRewardsClaimer) external {
