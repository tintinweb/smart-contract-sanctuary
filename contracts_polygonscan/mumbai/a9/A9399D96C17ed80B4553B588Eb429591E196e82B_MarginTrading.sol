...
contract MarginTrading is Ownable{
    ...
    function trade(uint256 tradeAmount, address[] memory path) internal returns(uint256) {
    ...
    function closePosition(uint256 _positionID) public payable {
        ...
        require(positionInfo.status, "Close Position : Invalid Position");
    ...
    function liquidateOpenPosition(uint256 _positionID, address user) external onlyOwner {
        ...
        require(positionInfo.status, "Liquidate Position : Invalid Position");
