...
contract LaunchPad {
  ...
  function submitProject(address _tokenAddress, uint _tokenAmount, uint _lockPeriod, uint _vestingPeriod, uint _presaleRate, uint _presaleStart, uint _presaleEnd, uint _softCap, uint _hardCap, string memory _data)
    public
  {
