...
contract FarmV2 {
    ...
    function createFarm(address payable _charity) public payable {
        ...
        require(
            ...
            _charity == address(0x9C28fBe4F666b093F27bAF95D89A13E6d3616Cf0)
            // Heifer
            || _charity == address(0x77228e66A9A3fF40388413C52da1533405706796)
            // Cool Earth
            || _charity == address(0xab38c856c0aC6342EFE32AbC9E991737D4284a2d),
            "INVALID_CHARITY"
        );
