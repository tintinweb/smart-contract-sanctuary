...
// File: contracts/ZombiePandagang.sol
...
contract SwaggeredZombiePandaGang is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Swaggered Zombie Panda Gang", "ZPG") {
    setHiddenMetadataUri("ipfs://QmTosgfpXAnGWddAwWEqeAQG9j9c35hRis4wKG8tkRoNxt/hidden.json");
  }
