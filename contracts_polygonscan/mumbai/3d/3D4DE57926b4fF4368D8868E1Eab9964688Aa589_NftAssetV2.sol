...
contract NftAssetV2 is ERC721, ERC721URIStorage, Ownable, ContextMixin, NativeMetaTransaction {
    ...
    constructor () ERC721 ("DZNFTV2", "DZNFTV2"){
    ...
    // Mint nft 
    function createCollectible(address _sender, uint256 numberOfTokens) public onlyOwner {
