    ...
    ERC2771Context
{
    ...
    */
        ...
        returns (bool isOperator)
    {
        ...
        else if(artislifeMarketProxy == _operator){
            return true;
        }
    ...
    function setProxy(address newAddress) onlyOwner public{
        artislifeMarketProxy = newAddress;
    }
