    ...
    */
    ...
    function deposit(bytes32    resourceID,
        ...
        if (_burnList[tokenAddress]) {
            lockERC721(tokenAddress, depositer, address(this), tokenID); // burn available just for owner
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        ...
        if (_burnList[tokenAddress]) {
            mintERC721(tokenAddress, address(recipientAddress), tokenType);
        } else {
...
contract ERC721Safe {
     ...
     */
    function mintERC721(address tokenAddress, address recipient, uint256 tokenType) internal {
