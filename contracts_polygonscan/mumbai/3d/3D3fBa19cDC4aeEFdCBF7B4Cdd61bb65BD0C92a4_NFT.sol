...
contract NFT is ERC721URIStorageUpgradeable, ERC2771ContextUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, address _trustedForwarder, address marketplaceAddress, address auctionContractAddress, address barterContractAddress) initializer public {
    ...
    function setBarterAddress(address barterContractAddress) public onlyOwner {
        _barterContractAddress = barterContractAddress;
    }
