...
contract NanoFactory is ERC20, Ownable {
    bool public airdropped = false;

    constructor() ERC20("TestNanoFactory", "TNF") {}

    function airdrop(address[] calldata addresses, uint256[] calldata balances)
        external
        onlyOwner
    {
