...
contract LadyClownClub is ERC721Enumerable, Ownable {
    ...
    function LadyClownFreeMint(uint256 num) external {
        ...
        require( supply + num < 6501,                "Exceeds maximum supply." );
        require( balanceOf(msg.sender) <= 15,        "You can only hold 15 mints.");
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        uint256 supply = totalSupply(); 
        require( supply + _amount < 6501,            "Exceeds maximum supply" );
