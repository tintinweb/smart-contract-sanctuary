...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // Initial emission rate: 50 DOVE per block.
    uint256 public constant INITIAL_EMISSION_RATE = 50 ether;
    // Target emission rate: 5 DOVE per block.
    ...
    uint256 public dovePerBlock = INITIAL_EMISSION_RATE;
    ...
    function updateEmissionRate() public {
        ...
        require(dovePerBlock > FINAL_EMISSION_RATE, "updateEmissionRate: Emission rate has reached FINAL_EMISSION_RATE already");
        ...
        uint256 newEmissionRate = dovePerBlock;
        ...
        require(newEmissionRate < dovePerBlock, "updateEmissionRate: New emission rate must be less than current emission rate.");

        massUpdatePools();
        lastReductionPeriodIndex = currentIndex;
        dovePerBlock = newEmissionRate;
