...
contract DPSGameSettings is Ownable {
    ...
    /**
     * @notice max points a sail can have per power: strength, luck, navigation.
    ...
    constructor() {
        ...
        voyageConfigPerType[VOYAGE_TYPE.EASY].gapBetweenInteractions = 300;
        ...
        voyageConfigPerType[VOYAGE_TYPE.MEDIUM].gapBetweenInteractions = 300;
        ...
        voyageConfigPerType[VOYAGE_TYPE.HARD].gapBetweenInteractions = 300;
        ...
        voyageConfigPerType[VOYAGE_TYPE.LEGENDARY].gapBetweenInteractions = 300;
