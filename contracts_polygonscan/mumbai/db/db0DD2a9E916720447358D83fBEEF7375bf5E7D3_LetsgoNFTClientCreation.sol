...
contract LetsgoNFTClientCreation is ERC721URIStorage, Ownable, LetsgoNFTBase {
    ...
    constructor(string memory name, string memory symbol, string memory contractURI) ERC721(name, symbol) {
        _contractURI = contractURI;
    }

    function mint(uint256 royalty, string memory tokenURI) public onlyOwner returns(uint256) {
        require(
            royalty <= mantissa / 2,
