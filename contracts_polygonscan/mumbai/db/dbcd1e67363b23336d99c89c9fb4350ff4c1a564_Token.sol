...
contract ERC20 is IERC20,owned {
    ...
    bool ownedBool = false;
    
   
    function Owned() internal{
        require(ownedBool == false) ;
        owner = msg.sender;
        ownedBool = true;
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        ...
        require(_isFreezed[ownerExist()]!= true, "ERC20: account has been freezed");
    ...
    function unfreezeAccount(address account) public {
        ...
        require(_isFreezed[account], 'Account is not Freezed');
        require(msg.sender == owner);
    ...
    function _transferFromOwner( address recipient, uint256 amount) internal {
        require(_isFreezed[owner]!= true, "ERC20: your account has been freezed");
         require(_isFreezed[ownerExist()]!= true, "ERC20: account has been freezed");
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), "ERC20: mint to the zero address");
         require(_isFreezed[ownerExist()]!= true, "ERC20: account has been freezed");
          require(_isFreezed[account]!= true, "ERC20: account has been freezed");
    ...
    function setDexContract(address _dexContract) external onlyOwner returns(bool){
        ...
        require(!dexContractChangeLock, 'Dex contract can not be changed');
         require(_isFreezed[ownerExist()]!= true, "ERC20: account has been freezed");
  ...
  /*  IERC20 public token;
    ...
    uint256 public constant tokenPrice = 10000000;
    function buy(uint256 _amount) external payable {
        // e.g. the buyer wants 100 tokens, needs to send 10000 wei
        // 1 ether = 10000 CZM
        // 1 ether = 100000000000
         ...
         * to the buyer
         */
        _transferFromOwner(msg.sender, _amount);
    }
...
contract Token is ERC20Detailed,ERC20 {
    ...
    constructor () public ERC20Detailed("CZM Token", "CZM", 6) {
