...
contract BatchedBancorMarketMaker is AccessControl, ReentrancyGuard {
    ...
    */
    ...
    function getCollateralPricePPM(address _collateral) public view returns (uint256) {
        return getStaticPricePPM(curveSupply, ERC20(_collateral).balanceOf(address(this)), collaterals[_collateral].reserveRatio);
    }
    ...
    function _updatePricing(Batch storage batch, uint256 _batchId, address _collateral) internal {
        ...
        // console.log("Updating price.. batch supply %s", batch.supply);
        // console.log("Updating price.. batch balance %s", batch.balance);
        // console.log("Updating price.. batch Reserve Ratio PPM %s", batch.reserveRatio);
        uint256 staticPricePPM = _staticPricePPM(batch.supply, batch.balance, batch.reserveRatio);
        // console.log("Updating price.. static price PPM %s",staticPricePPM);
