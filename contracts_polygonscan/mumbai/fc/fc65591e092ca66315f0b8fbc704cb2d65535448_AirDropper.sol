...
contract AirDropper is ERC20, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("AirDropper", "AIRD") ERC20Permit("AirDropper") {
        _mint(msg.sender, 105263158 * 10 ** decimals());
    }
