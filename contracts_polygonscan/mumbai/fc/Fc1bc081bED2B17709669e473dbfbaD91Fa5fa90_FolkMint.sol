...
contract FolkMint is ERC721Enumerable, ReentrancyGuard, Ownable {
...
//        }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 13px; }</style><rect width="100%" height="100%" fill="black" />';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "FolkMint:', toString(tokenId), '", "description": "Folk generates random people you might meet on an adventure", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
...
//    }
    ...
    constructor() ERC721("FolkMint", "FOLKMINT") Ownable() {}
}
