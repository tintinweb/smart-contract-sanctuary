...
contract MiddleMist is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable,EIP712MetaTransaction {
    ...
    function initialize(string memory _name) initializer public {
       ...
       __EIP712MetaTransaction_init("NFT","1");
         minter = _msgSender();
    ...
    function mintToCaller(address to, string memory uri) public virtual  {
    ...
    function mint(address to, string memory uri) public virtual whenNotPaused {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
