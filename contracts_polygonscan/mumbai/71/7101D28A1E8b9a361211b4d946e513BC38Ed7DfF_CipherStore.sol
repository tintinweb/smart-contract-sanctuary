    ...
    ICharacter
{
    ...
    uint256 private totalMiniFeaturesFee;
        ...
        isCharacterOwner(characterId)
    {
        ...
        TAG.transferFrom(msg.sender, address(this), amount);
    }
    ...
    function setOperatorName(uint256 characterId, string memory firstN, string memory lastN) 
        ...
        isCharacterOwner(characterId)
    {
        require(keccak256(abi.encodePacked(firstN)) != keccak256(abi.encodePacked("")) , "first Name could not be empty");
        require(keccak256(abi.encodePacked(lastN)) != keccak256(abi.encodePacked("")), "family Name could not be empty");
...
contract Characters is Initializable, ERC721Upgradeable, AccessControlUpgradeable, ITransferCooldownable, ICharacter {
    ...
    */
    ...
    event customisedCharacter(address indexed user, uint256 characterId, uint8 customType);
    event updatedCharacterName(address indexed user, uint256 characterId);
    ...
    function customizeCharacter(uint256 id, uint8 customType, uint256 seed) public restricted {
        ...
        emit customisedCharacter(ownerOf(id), id, customType);
    }
