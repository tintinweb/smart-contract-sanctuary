    ...
    function generateSVGFromHash(bytes32 _hash) public virtual view returns (string memory) {
        ...
        */
        string memory svg = string(abi.encodePacked(
            "<svg id='Layer_1' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 311 292'>",
                "<defs>",
                    "<linearGradient id='linear-gradient' x1='179.37427' y1='218.89569' x2='215.29126' y2='309.10608' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse' >",
                        "<stop offset='0' stop-color='#fff' />",
                        "<stop offset='1' stop-opacity='0' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-2' x1='74.41259' y1='283.44191' x2='32.50259' y2='199.97549' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,0)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-3' x1='132.21412' y1='218.89576' x2='96.29812' y2='309.10615' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,1)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-4' x1='240.77869' y1='165.82745' x2='106.39849' y2='77.18267' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,2)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-5' x1='42.88268' y1='212.15112' x2='182.59368' y2='21.48611' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,3)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-6' x1='237.17634' y1='283.44203' x2='279.08633' y2='199.97561' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,4)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-7' x1='268.70619' y1='212.1512' x2='128.99518' y2='21.4862' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,5)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-8' x1='71.02834' y1='166.25047' x2='205.69732' y2='76.92467' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,6)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                    "<linearGradient id='linear-gradient-9' x1='158.15217' y1='292.43367' x2='155.7255' y2='213.69974' gradientTransform='matrix(1, 0, 0, -1, 0, 294)' gradientUnits='userSpaceOnUse'>",
                        string(abi.encodePacked("<stop offset='0' stop-color=",palette[toUint8(bhash,7)/51]," />")),
                        "<stop offset='1' stop-color='#26a1d9' />",
                    "</linearGradient>",
                "</defs>",
                "<path d='M256.298,2,230.292,77.0729,156.779,2Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient); '/>",
                "<path d='M1.55324,77.006,54.4335,2.582,80.2967,77.4956Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-2); '/>",
                "<path d='M55.2912,2,81.2966,77.0729,154.81,2Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-3); '/>",
                "<path d='M156.494,78.5h73.303L156.494,289.043Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-4); '/>",
                "<path d='M80.6446,78.4978,2.48079,78.0062,154.384,288.901Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-5); '/>",
                "<path d='M310.036,77.006,257.155,2.582,231.292,77.4956Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-6); '/>",
                "<path d='M230.944,78.4978l78.164-.4916L157.205,288.901Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-7); '/>",
                "<path d='M155.5,78.5H81.7874L155.5,289.059Z'style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-8); '/>",
                "<path d='M81.0928,78H230.5L156,1.5Z' style=' stroke: #000; stroke-opacity: 0.10000000149011612; fill: url(#linear-gradient-9); '/>"
            "</svg>"
        ));
        return svg;
    }    
