...
// File contracts/FlyTrap.sol

pragma solidity ^0.8.4;



contract FlyTrap is ERC1155, Ownable {
    ...
    function claim(address account, uint256[] memory ids, uint256[] memory amounts) external onlyOwner {
    ...
    /**
     * @dev Add address to list of contracts that can burn FlyTrap items
     */
    ...
    /**
     * @dev Burn FlyTrap items for holder address
     */
    function burnForAddress(address burnTokenAddress, uint256 typeId, uint256 amount) external {
