...
import "./PlayersArtIDO.sol";

/** @title IDOController
 * @notice This contract creates IDOs and handle configuration
 */

contract PlayersArtIDOFactory is Ownable, IPlayersArtIDOFactory {
    ...
    modifier isAdminOrOwner() {
        require(root.isAdmin(msg.sender) || owner() == msg.sender, "Not admin or owner");
    ...
    function createIDO(
        ...
        uint256 fcfsAmount,
        string memory meta
    ) external isAdminOrOwner returns (address) {
        PlayersArtIDO ido = new PlayersArtIDO(this, saleTarget, fundToken, fundTarget);
