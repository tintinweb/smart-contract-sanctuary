...
contract ThePurge is ERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    uint256 public burnFee = 10;
    uint256 public liqFee = 10;
    uint256 private minTokensToAddLiquidity = SafeMath.mul(500000, uint256(decimals()));
    uint256 public maxTxAmount = SafeMath.mul(5000000, uint256(decimals()));
    ...
    constructor() ERC20("The Purge", "PURGE") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xbdd4e5660839a088573191A9889A262c0Efc0983); //quickswap router address
