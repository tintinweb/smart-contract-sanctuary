...
contract BareChatter is ERC721Enumerable, Ownable {
  using Strings for uint256;
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    // PAY 50% TO THIS COMMUNITY WALLET
    (bool hs, ) = payable(0x59aC47334982656De74755FF07ed43eAB0E14D36).call{value: address(this).balance * 50 / 100}("");
    require(hs);
