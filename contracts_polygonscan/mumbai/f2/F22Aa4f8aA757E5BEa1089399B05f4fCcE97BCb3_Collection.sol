...
contract Collection is Ownable, ReentrancyGuard {
    ...
    IERC20 mUSDC = IERC20(address(0x2058A9D7613eEE744279e3856Ef0eAda5FCbaA7e));
    Dropper dropper;
    ...
    function withdrawToken(address _tokenContract) external onlyOwner{
        ...
        uint256 cCut = (balance * 70) / 100;
        uint256 dCut = (balance * 30) / 100;
...
contract Dropper is ERC1155, ERC1155Burnable, Ownable, ContextMixin {
    ...
    string ipfsGateway = "https://dropper.mypinata.cloud/ipfs/";
