    ...
    ContextMixin
{
    ...
    // Max total supply
    uint256 public constant MAX_TOTAL_SUPPLY = uint256(1500);
    // Max token IDs
    uint256 public constant MAX_TOKEN_ID = uint256(10000);
    ...
    constructor(
      ...
      address minterRole
        ...
        ERC1155(uri_)
    {
        _setupContractId("ChildNFTERC1155");
        ...
        name = name_;
        symbol = symbol_;
        CONTRACT_URI = "https://wrtuqnrkqwci.usemoralis.com/omni.json";
    }
    ...
    */
    ...
    function restTotalSupply(uint256 _id, uint256 _amount) public view returns (uint256) {
      ...
      require(( subtotal <= maxSupply(_id)), "ChildNFTERC1155: EXCEED MAX_AMOUNT");
      return _amount;
    }
        ...
        only(DEPOSITOR_ROLE)
    {
        ...
        require(
            user != address(0),
            "ChildNFTERC1155: INVALID_DEPOSIT_USER"
        );
    ...
    function mint(
        ...
        require( ((id > uint(0))), "ChildNFTERC1155: INVALID_TOKEN_ID");
        require(((amount > uint(0)) && (amount == restTotalSupply(id, amount))) , "ChildNFTERC1155: INVALID_TOKEN_AMOUNT");
    ...
    function mintBatch(
        ...
        for (uint i = 0; i < ids.length; i++) {
            require((ids[i] > uint(0)) , "ChildNFTERC1155: INVALID_TOKEN_ID");
            require(((amounts[i] > uint(0)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) , "ChildNFTERC1155: INVALID_TOKEN_AMOUNT");
        }
