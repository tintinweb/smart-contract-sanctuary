...
contract PBAMBOOv1 is ERC721, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;

    uint256 public constant MAX_PRESALE_TOKENS = 2000;
    uint256 public constant MAX_TOKENS = 10000;
    uint256 public constant MAX_PURCHASES = 100;
    ...
    function presaleMint(uint256 quantity, bytes32[] calldata PresaleMerkleProof) external payable nonReentrant {
        ...
        require(totalSupply() + quantity <= MAX_PRESALE_TOKENS, "minting this many would exceed supply");
    ...
    function mint(uint256 quantity) external payable nonReentrant {
        require(preSale, "public sale is not live");
