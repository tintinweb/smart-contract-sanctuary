...
//NUG$ is owned by NFToker (Stoners)
//each stoner received at the date of the airdrop 1000 NUG$, hence the maximum supply
//for NUG$ is 1000*10000*10^18
//there aint' no ICO, presale, % allocated to some nonexistent team or fancy stuff
contract NUGS is Context, ERC20Permit, ERC20Burnable, Ownable {
	constructor() ERC20Permit("NUGS") ERC20("NUG$", "NUG$") {
		_mint(msg.sender, 1000 * 10000 * 10**18); //airdroped!
	}
