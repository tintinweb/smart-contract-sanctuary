...
// File: verified-sources/0xe44b29fa0bee9bda7e36efb000b61d0e17466e75/sources/contracts/NtfBulkMinter.sol
...
contract NFT is ERC1155{
    ...
    string public name = "Randcats ascending";
    ...
    constructor() ERC1155("ipfs://Qmea7Prk78TxwjvFMHCyS9pP6m4RW8ubAdoovoB54sRs3Y/metadata/{id}.json"){
    ...
    function mint250Nft() public onlyOwner{
        
        require((currentSupply + 250) <= totalSupply);
        
        uint endFor = (currentSupply + 250);
        
        
        for (uint256 i = currentSupply; i < endFor; i++) { 
            _mint(msg.sender, i, 1, "");   
            }
            
        currentSupply = endFor;
