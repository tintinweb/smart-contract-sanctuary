...
ContextMixin
{
	...
	function calcPrice(uint256 _totalSupply, uint8 _amount) public pure returns (uint256) {
		return ceil(_totalSupply.mul(10000).div(5000), 10000).div(10000).mul(200000000000000000).mul(_amount);
	}
	...
	function buyTokens(address _toAddress, uint8 _amount, uint256 _value) public {
		...
		for (uint256 i = 0; i < _amount; i++) {
			...
			WETHContract.transfer(address(0x4B191bF8b1046219b8b2c6951EF221575d8cf4E9), price);
