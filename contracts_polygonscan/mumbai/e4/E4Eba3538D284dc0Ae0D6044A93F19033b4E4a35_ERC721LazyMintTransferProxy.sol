...
import "@orderinbox/interfaces/contracts/ITransferProxy.sol";
...
contract ERC721LazyMintTransferProxy is OperatorRole, ITransferProxy {
    function transfer(LibAsset.Asset memory asset, address from, address to) override onlyOperator external {
        ...
        (address token, LibERC721Mint.Mint721Data memory data) = abi.decode(asset.assetType.data, (address, LibERC721Mint.Mint721Data));
        IERC721Mint(token).transferFromOrMint(data, from, to);
    }
}
