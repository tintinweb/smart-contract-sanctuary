...
contract MintNft is ERC721, Ownable, ReentrancyGuard{
    ...
    address public blockticketsAdmin = 0x7d22e6144931687AF80b38d2C9b7F9F3f7a43291;
   ...
   event TicketBought(uint256[] ids);
    ...
    // blocktickets
    function buyTicket(string[] memory _uri, uint256[] memory _royalty) external payable nonReentrant {
