...
// File: contracts/NFTDexV5Polygon.sol
...
contract NFTDexV6Polygon is ERC721Full, ERC721MetadataMintable, Ownable {
  IERC20 ALIA;
...
//   event SetValue(address indexed from, uint256 main, uint256 _author, uint256 _platform);
  ...
  // // ALIA.transferFrom(msg.sender, platform, 10000000000000000000 );
  //   admin = 0x9b6D7b08460e3c2a1f4DFF3B2881a854b4f3b859;
  //   revenueShare = IERC20(0x773E9CF672c7c4B50C39856A057f5E6581418e3D);
  //    ALIA = IERC20(0x6275BD7102b14810C7Cfe69507C3916c7885911A);
  //   isInitialized = true;
  //   platform = 0xF0d2D73d09A04036F7587C16518f67cE622129Fd;
  //   authorVault = 0xF0d2D73d09A04036F7587C16518f67cE622129Fd;
  ...
  function claimAuction(uint256 _tokenId, bool awardType, string memory ownerId, address from) public {
    auctionSell storage temp = _auctionTokens[_tokenId];
    require(temp.endTime < now,"103");
    require((!awardType && msg.sender==temp.bidder) ||  from == temp.bidder,"107");
