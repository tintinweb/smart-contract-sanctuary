...
import 'fuzzyswap/contracts/libraries/FixedPoint128.sol';
    ...
    SelfPermit
{
        ...
        )
    {
        ...
        emit IncreaseLiquidity(tokenId, liquidity, amount0, amount1, address(pool));
    }
        ...
        )
    {
        ...
        emit IncreaseLiquidity(params.tokenId, liquidity, amount0, amount1, address(pool));
    }
...
library PoolAddress {
    ...
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x5b1abdf2516e08ce4be3e358238e52279e663657f247952a85ee963e508d08b1;
...
import 'fuzzyswap/contracts/libraries/FullMath.sol';
import 'fuzzyswap/contracts/libraries/FixedPoint96.sol';
