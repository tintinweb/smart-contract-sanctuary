...
contract FPMMDeterministicFactory is ERC1155Receiver {
    ...
    constructor(FixedProductMarketMaker _impl) public {
    ...
    returns (address)
    {
        address fixedProductMarketMaker = Clones.clone(address(implementationMaster));
        ...
        if (initialFunds > 0) {
            ...
            IERC20(fixedProductMarketMaker).transfer(msg.sender, IERC20(fixedProductMarketMaker).balanceOf(address(this)));
...
interface IFixedProductMarketMaker {
    ...
    function initialize(ConditionalTokens _conditionalTokens, IERC20 _collateralToken, bytes32[] memory _conditionIds, uint _fee) external;
}
