...
// File contracts/GMSUPPERCLUB.sol
...
*  / ____|  \/  |  / ____|                              / ____| |     | |    
* | |  __| \  / | | (___  _   _ _ __  _ __   ___ _ __  | |    | |_   _| |__  
* | | |_ | |\/| |  \___ \| | | | '_ \| '_ \ / _ \ '__| | |    | | | | | '_ \ 
* | |__| | |  | |  ____) | |_| | |_) | |_) |  __/ |    | |____| | |_| | |_) |
*  \_____|_|  |_| |_____/ \__,_| .__/| .__/ \___|_|     \_____|_|\__,_|_.__/ 
*                              | |   | |                                     
*                              |_|   |_|                                     
*/

contract GMSUPPERCLUB is IERC2981, ERC721 {
    ...
    constructor(address _owner, uint24 _defaultBips, uint256 _cap, string memory _baseURI) ERC721("GM Supper Club", "GMSC", "") {
    ...
    function mint(address _to) public onlyOwner {
        require(mintCount < cap, "cap reached");
        safeMint(mintCount, _to);
        _royalties[mintCount] = RoyaltyInfo(_to, 250);
        mintCount += 1;
    }
        ...
        return string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"gm supper club", "description": "',
                                "NFT recognizing attendance to the first ever gm supper club.",
                                '", "image": "ipfs://', baseURI, '"}'
                            )
                        )
                    )
