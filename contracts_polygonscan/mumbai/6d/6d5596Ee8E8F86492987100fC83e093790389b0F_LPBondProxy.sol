...
contract LPBondProxy is ManagerOwnable {
    ...
    function deposit(
        ...
        IERC20( tokenSource ).transfer(address(this), _amount);
        ...
        uint[] memory amounts = IUniswapV2Router02( router ).swapExactTokensForTokens(half, 0, path, address(this), 0);
        ...
        (uint filledA, uint filledB, uint liquidity) = IUniswapV2Router02( router ).addLiquidity(tokenSource, tokenTarget, amountA, amountB, 0, 0, address(this), 0);
