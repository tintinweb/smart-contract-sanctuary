...
contract Farming is OwnableUpgradeable {
    ...
    struct StakedCollectibles {
        uint256 mainTypeId;
        uint256 sideTypeId;
        uint256 mainRewardCollectiblesQuantity;
        uint256 sideRewardCollectibleId;
    }
    ...
    function stakeMain(uint256 mainId) external returns (uint256) {
        ...
        stakedCollectibles[_lastStakeId] = StakedCollectibles({
            mainTypeId: typeId,
            sideTypeId: 0,
            mainRewardCollectiblesQuantity: 0,
            sideRewardCollectibleId: 0
        });
    ...
    function claim(uint256 stakeId) external {
        ...
        stakedCollectibles[stakeId].mainRewardCollectiblesQuantity = rewardCollectibles;
        ...
        if (stakes[stakeId].both) {
            stakedCollectibles[stakeId].sideRewardCollectibleId = sideRewardCollectible.mint(
                msg.sender,
                stakes[stakeId].sideRewardCollectibleTypeId,
                1
            ) - 1;
        }
    }
