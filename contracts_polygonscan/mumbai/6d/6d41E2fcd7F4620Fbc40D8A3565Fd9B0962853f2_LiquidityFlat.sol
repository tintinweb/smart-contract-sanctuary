...
contract LiquidityTest is Context, ERC20 {
  address private _bridge;

  constructor() ERC20("KiBridge V1 Liquidity", "KiB-V1-LIQ") {
    _bridge = _msgSender();
  }
...
contract LiquidityFlat {

  mapping(address => address) public getLiquidity;
  ...
  function createLiquidity(
    ...
    public 
  {
    LiquidityTest liquidity = new LiquidityTest{salt: keccak256(abi.encode(_token))}();
    getLiquidity[_token] = address(liquidity);
  }
