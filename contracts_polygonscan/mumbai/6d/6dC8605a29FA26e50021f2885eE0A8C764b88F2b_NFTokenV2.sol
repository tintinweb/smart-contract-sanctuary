...
contract NFToken is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable,MinimalForwarderUpgradeable {
    ...
    function minToCaller(address to, string memory uri) public virtual onlyOwner {
...
function setListingPrice(uint256 _listingPrice)public virtual onlyOwner whenNotPaused    {
  ...
  function getListingPrice() public virtual view returns (uint256) {
    return listingPrice;
  }
