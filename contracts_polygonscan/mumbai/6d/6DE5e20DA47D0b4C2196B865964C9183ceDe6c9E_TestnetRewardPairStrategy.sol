...
contract TestnetRewardPairStrategy is BaseStrategyStakingRewards {

    uint256 public constant keepMax = 10000;

    address public otherToken;
    address public WMATIC = 0xFac5C7819fdE19d006244E462Db02ed7Fe346E71;
    address private constant router = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; //Quickswap router
    ...
    constructor(
        ...
        BaseStrategyStakingRewards(
            _rewards,
            _want,
            0x06e22CE5BA2ADD01636Bd04B9d7D3003D16D122A,
            WMATIC,
            router
        )
    {
        ...
        reward_other_path[0] = WMATIC;
        reward_other_path[1] = otherToken;

        //Given: want isn't _harvestedToken or _otherToken, because want is a LP token
        IERC20(WMATIC).safeApprove(router, uint256(-1));
        IERC20(_otherToken).safeApprove(router, uint256(-1));
    }
