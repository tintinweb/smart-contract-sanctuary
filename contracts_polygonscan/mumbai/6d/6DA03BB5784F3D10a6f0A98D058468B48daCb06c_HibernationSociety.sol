...
contract HibernationSociety is ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE = 80 * 10**15; // 80 Matic
    uint256 public constant PRESALE_PRICE = 65 * 10**15;
    ...
    function testSaleOpen() external onlyOwner {
        LAUNCH_TIMESTAMP = block.timestamp + 30;
    }
}
