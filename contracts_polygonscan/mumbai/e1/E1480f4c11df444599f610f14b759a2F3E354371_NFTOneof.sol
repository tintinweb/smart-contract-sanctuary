...
contract NFTOneof is NFTOneofExtention {
    ...
    mapping(uint256 => mapping(uint256 => PowerMintValue)) private _power_mints;
        ...
        whenNotPaused
    {
        for (uint256 i = 0; i < requests.length; i++) {
            ...
            require(power_mint.owner == _msgSender(), "Select: not owner");
...
abstract contract NFTOneofExtention is ERC1155, Pausable, Destroyable, Ownable {
    ...
    function typeExists(uint256 id) public view virtual returns (bool) {
    ...
    function _beforeTokenTransfer(
        ...
        require(
            !destroyed(),
            "ERC1155Pausable: token transfer while destroyed"
        );
    ...
    function pause(bool pause_) public virtual whenNotDestroyed {
        if (pause_) {
            _pause();
        } else {
            _unpause();
    ...
    function destroy() public virtual whenNotPaused {
        _destroy();
    }
}
