...
contract FeeSplitter is TokensRecoverable
{
    ...
    function depositRoyalties(address _token, uint256 _amount) public onlyRoyaltyCollector(){
        require (IERC20(_token).balanceOf(msg.sender) >= _amount, "Not enough balance");
        IERC20(_token).transferFrom(msg.sender, address(this), _amount);
        totalRoyaltiesCollected[_token] = totalRoyaltiesCollected[_token] + _amount;
    }
