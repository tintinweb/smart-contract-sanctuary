...
contract Token is ERC20 {
    ...
    constructor () ERC20("TrollGoblin Mite","MITE") {
    ...
    function mineMite(uint256 mineAmount) public onlyMinter {
        if (mineAmount > maxMine) {
            revert("Cannot mine this much.");
        }
        super._mint(owner, mineAmount);
    }
