...
// File: github/maximebrugel/OlympusDAO/contracts/libraries/FullMath.sol
...
// File: github/maximebrugel/OlympusDAO/contracts/libraries/FixedPoint.sol
...
// File: github/maximebrugel/OlympusDAO/contracts/interfaces/IOxygen.sol
...
// File: github/maximebrugel/OlympusDAO/contracts/interfaces/ITreasury.sol
...
// File: github/maximebrugel/OlympusDAO/contracts/interfaces/IStaking.sol
...
// File: github/maximebrugel/OlympusDAO/contracts/interfaces/IBondCalculator.sol
...
// File: github/maximebrugel/OlympusDAO/contracts/interfaces/IStakingHelper.sol
...
// File: github/maximebrugel/OlympusDAO/contracts/BondDepository.sol
...
contract BondDepository is Policy {
    ...
    address public immutable Oxygen; // token given as payment for bond
    address public immutable principle; // token used to create bond
    address public immutable treasury; // mints Oxygen when receives principle
    ...
    struct Bond {
        uint256 payout; // Oxygen remaining to be paid
    ...
    function deposit(
        ...
        require(payout >= 10000000, "Bond too small"); // must be > 0.01 OXYGEN ( underflow protection )
        ...
        /**
            ...
            approved and
            deposited into the treasury, returning (_amount - profit) Oxygen
         */
        ...
        if (fee != 0) {
            ...
            IERC20(Oxygen).safeTransfer(DAO, fee);
        }
    ...
    function stakeOrSend(
        ...
        if (!_stake) {
            ...
            IERC20(Oxygen).transfer(_recipient, _amount); // send payout
        } else {
            // if user wants to stake
            if (useHelper) {
                // use if staking warmup is 0
                IERC20(Oxygen).approve(stakingHelper, _amount);
    ...
    function maxPayout() public view returns (uint256) {
        return IERC20(Oxygen).totalSupply().mul(terms.maxPayout).div(100000);
    }
    ...
    function bondPriceInUSD() public view returns (uint256 price_) {
        if (isLiquidityBond) {
            ...
            price_ = bondPrice().mul(10**IOxygen(principle).decimals()).div(100);
        }
    }

    /**
     *  @notice calculate current ratio of debt to Oxygen supply
     *  @return debtRatio_ uint
     */
    function debtRatio() public view returns (uint256 debtRatio_) {
        uint256 supply = IERC20(Oxygen).totalSupply();
    ...
    /**
     *  @notice calculate amount of Oxygen available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or Oxygen) to the DAO
     *  @return bool
     */
    function recoverLostToken(address _token) external returns (bool) {
        require(_token != Oxygen);
