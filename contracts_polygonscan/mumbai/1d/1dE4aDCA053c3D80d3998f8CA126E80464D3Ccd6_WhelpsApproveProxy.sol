...
// File: FPOLY_WhelpsApproveProxy.sol
...
contract WhelpsApproveProxy is Ownable {
    ...
    bool public _whelpsNFTContractLocked = false;

    function setWhelpsNFTContract(address _contract) external onlyOwner {
        require(!_whelpsNFTContractLocked, "Locked");
        _whelpsNFTContract = _contract;
    }
    
    function lockWhelpsNFTContract() external onlyOwner {
        _whelpsNFTContractLocked = true;
    }
