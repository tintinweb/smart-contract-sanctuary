...
contract MaticMikeData{
    ...
    */
        ...
        returns (string memory)
    {
        ...
        svgString = string(
            abi.encodePacked(
                bodyMap[MaticMikeLibrary.parseInt(MaticMikeLibrary.substring(_hash, 8, 9))][0],
                bodyMap[MaticMikeLibrary.parseInt(MaticMikeLibrary.substring(_hash, 8, 9))][1],
                bodyMap[MaticMikeLibrary.parseInt(MaticMikeLibrary.substring(_hash, 8, 9))][2],
                bodyMap[MaticMikeLibrary.parseInt(MaticMikeLibrary.substring(_hash, 8, 9))][3]
            )
        );
        for (uint8 i = 0; i < 8; i++) {
            uint8 thisTraitIndex = MaticMikeLibrary.parseInt(
    ...
    **********************************/
    ...
    function populateSVG(uint256 thisTraitIndex) public onlyOwner
    {
        ...
        bodyMap[thisTraitIndex][3] = svgString;
    }
