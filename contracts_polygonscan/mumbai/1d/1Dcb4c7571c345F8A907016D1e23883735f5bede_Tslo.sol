...
contract Tslo {
    ...
    //    )
    {
        ...
        reels[0] = ['H7', 'EM', 'OR', 'EM', 'B7', 'EM', '3B', 'EM', 'GR', 'EM', 'B7', 'EM', '2B', 'EM', 'CH', 'EM', '3B', 'EM', 'OR', 'EM', 'OR', 'EM', 'WM', 'EM', 'GR', 'EM', '2B', 'EM', 'LE', 'EM', 'OR', 'EM', '1B', 'EM', 'WM', 'EM', 'CH', 'EM', 'GR', 'EM', 'WM', 'EM', 'OR', 'EM', 'LE', 'EM', 'CH', 'EM', 'WM', 'EM', 'GR', 'EM', 'LE', 'EM', 'OR', 'EM', 'WM', 'EM', 'CH', 'EM', 'GR', 'EM', 'LE', 'EM', 'OR', 'EM', 'WM', 'EM', '1B', 'EM', 'GR', 'EM', 'LE', 'EM', 'CH', 'EM', 'OR', 'EM', 'DM', 'EM', 'LE', 'EM', 'WM', 'EM'];
        reels[1] = ['LE', 'EM', 'WM', 'EM', 'GR', 'EM', 'OR', 'EM', 'CH', 'EM', 'B7', 'EM', 'WM', 'EM', 'OR', 'EM', 'LE', 'EM', '2B', 'EM', 'WM', 'EM', 'GR', 'EM', 'CH', 'EM', 'OR', 'EM', 'WM', 'EM', 'DM', 'EM', 'GR', 'EM', 'OR', 'EM', '2B', 'EM', 'CH', 'EM', 'H7', 'EM', 'LE', 'EM', '3B', 'EM', 'GR', 'EM', 'OR', 'EM', 'CH', 'EM', 'LE', 'EM', 'WM', 'EM', '1B', 'EM', 'OR', 'EM', 'LE', 'EM', 'GR', 'EM', 'CH', 'EM', 'WM', 'EM', 'LE', 'EM', 'OR', 'EM', 'WM', 'EM', '1B', 'EM', 'LE', 'EM', 'CH', 'EM', 'GR', 'EM', '3B', 'EM'];
        reels[2] = ['WM', 'EM', '1B', 'EM', 'CH', 'EM', 'LE', 'EM', 'H7', 'EM', 'GR', 'EM', '2B', 'EM', 'WM', 'EM', 'CH', 'EM', 'OR', 'EM', 'LE', 'EM', 'OR', 'EM', 'GR', 'EM', 'B7', 'EM', 'LE', 'EM', 'CH', 'EM', 'OR', 'EM', 'LE', 'EM', 'WM', 'EM', '1B', 'EM', 'OR', 'EM', 'GR', 'EM', 'CH', 'EM', 'LE', 'EM', 'GR', 'EM', '2B', 'EM', 'WM', 'EM', 'CH', 'EM', 'LE', 'EM', 'WM', 'EM', 'WM', 'EM', 'GR', 'EM', 'DM', 'EM', '1B', 'EM', 'WM', 'EM', 'GR', 'EM', 'OR', 'EM', '3B', 'EM', 'CH', 'EM', 'OR', 'EM', 'LE', 'EM', 'WM', 'EM'];


    }

    function getSymbolFromPosition(uint256 reelPostion, uint256 reelNumber) private view returns(string memory symbol) {
    ...
    function getSymbolsFromPosition(uint256 pos, uint256 reelNumber) private view returns(string[3] memory reelSymbols) {
    ...
    event ReelsValues(string[3][3] values);
}