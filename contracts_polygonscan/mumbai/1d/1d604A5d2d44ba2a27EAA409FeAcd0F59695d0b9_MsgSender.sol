    ...
    PausableUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        emit ForwardCall(msg.sender, id, _chainId, _destinationContract, _feeToken, _methodData);
    }
        ...
        whenNotPaused
    {
        ...
        emit ForwardSaveNFT(msg.sender, id, _chainId, _feeToken, _receiver, _nftContract, _nftId);
    }
    ...
    function _generateId() private returns (bytes32) {
        nonce = nonce + 1;
        return keccak256(abi.encodePacked(getChainID(), block.number, address(this), nonce));
    }
