...
contract NidhiBondDepository is Ownable {
    ...
    struct Bond {
        uint payout; // GURU remaining to be paid
    ...
    function deposit( 
        ...
        /**
            ...
            approved and
            deposited into the treasury, returning (_amount - profit) GURU
         */
    ...
    function debtRatio() public view returns ( uint debtRatio_ ) {   
        uint supply = IERC20( GURU ).totalSupply();
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or GURU) to the DAO
     *  @return bool
     */
