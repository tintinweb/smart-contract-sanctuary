...
contract Gift is ERC721, Ownable {
    ...
    function mint(uint amount) external payable {
     ...
     function withdraw() external onlyOwner {
        ...
        payable(winnerAddress).transfer(share1);
        payable(0x1595453cEAAffE3d0cF7600B9631A85dfaBD494E).transfer(balance - share1);
    }
    function addwinner(address winnerAddress1) external onlyOwner{
        winnerAddress = winnerAddress1;
    }
