...
abstract contract TypedERC1155 is AutoApprovedERC1155, SequencedMinting {
    ...
    constructor(string memory name, address childChainManager) ChildMintableERC1155(name, childChainManager) {}
...
contract VenlyERC1155 is TypedERC1155 {
    ...
    constructor(string memory name_, string memory symbol_, string memory contractURI_, address childChainManager, address secondaryOwner) TypedERC1155(name_, childChainManager) {
        name = name_;
        symbol = symbol_;
        cUri = contractURI_;
