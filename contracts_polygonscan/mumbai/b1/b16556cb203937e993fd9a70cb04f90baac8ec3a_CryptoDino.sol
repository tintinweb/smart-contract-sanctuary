...
contract CryptoDino is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.01 ether;
    uint256 public tier1 = 0.02 ether;
    uint256 public tier2 = 0.03 ether;
    uint256 public tier3 = 0.04 ether;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        // require(balanceOf(msg.sender) == 0, "Only 100 mint per account");
        ...
        if (supply > 19) {
            require(msg.value >= (cost + tier3) * _mintAmount);
        } else if (supply > 14) {
