...
// Physalis TestNet-polygon: Zombitest
...
contract Zombit is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 private _reserved = 100;
    uint256 private _price = 0.88 ether;
    ...
    constructor(string memory baseURI) ERC721("Zombit", "ZZZ")  {
        setBaseURI(baseURI);
    ...
    function adopt(uint256 num) public payable {
        ...
        require( num < 21,                              "You can adopt a maximum of 20 Zombie" );
        require( supply + num < 10000 - _reserved,      "Exceeds maximum Zombie supply" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved Zombie supply" );
