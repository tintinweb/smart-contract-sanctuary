...
interface IChildToken {
	 ...
	 *  @dev return name of token as symbol, symbol wasnt created since
	 *  	we are exceed contract bytecode size. We need this function
	 * 		for enable tracking on Etherscan and Opensea.
	 *  @return token symbol
	 */
