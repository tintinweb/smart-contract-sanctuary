...
contract LEXISKULLS is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
//   address[] public whitelistedAddresses;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    //     // search for user's address in whitelistedAddresses and get index
    //     //   index = whitelistedAddresses[i] == msg.sender ? i : null;
    //     if ( whitelistedAddresses[i] == msg.sender) {
    //         removeUserFromWhiteList(i);
    //     }
    // }
  }
...
//         whitelistedAddresses[index] = whitelistedAddresses[whitelistedAddresses.length - 1];
