...
// File contracts/ApeliensCrewMember.sol

pragma solidity ^0.8.0;
contract ApeliensCrewMember is ERC721PresetMinterPauserAutoId {

    constructor() ERC721PresetMinterPauserAutoId("Apeliens Crew Member", "CREW", "") {
        _pause();
    }
