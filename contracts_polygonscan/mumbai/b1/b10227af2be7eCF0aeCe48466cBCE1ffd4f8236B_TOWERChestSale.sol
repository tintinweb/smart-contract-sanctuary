...
// File contracts/sale/metatx/EIP712Base.sol
...
// File contracts/sale/metatx/EIP712MetaTransaction.sol
pragma solidity >=0.7.6;
...
// File contracts/sale/TowerChestSale.sol
 ...
 * Chest tokens.
 */
contract TOWERChestSale is FixedPricesSale, Recoverable, EIP712MetaTransaction {
    ...
    constructor(
        ...
        uint256 skusCapacity,
        uint256 tokensPerSkuCapacity
    ) FixedPricesSale(payoutWallet, skusCapacity, tokensPerSkuCapacity) EIP712MetaTransaction("TOWERChestSale", "1.0") {
    ...
    function _delivery(PurchaseData memory purchase) internal override {
        ...
        ITOWERChestsSale chest = ITOWERChestsSale(skuTokens[purchase.sku]);
