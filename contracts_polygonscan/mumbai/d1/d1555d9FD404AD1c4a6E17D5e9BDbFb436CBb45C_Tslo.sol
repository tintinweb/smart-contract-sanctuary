...
contract Tslo is BaseRelayRecipient,VRFConsumerBase {
    ...
    address internal _blblToken = 0x8bB8662e9192a3Cc68f2BBb9915E048a7250eeaD;
...
//    }
    ...
    function tokenFallback(address _from, uint256 _value)  external payable {
        require(_blblToken==_msgSender(),"Token not verified");
        _credits[ _from] += _value;
        emit TokenReceived(_from,_value,_msgSender());
    }
