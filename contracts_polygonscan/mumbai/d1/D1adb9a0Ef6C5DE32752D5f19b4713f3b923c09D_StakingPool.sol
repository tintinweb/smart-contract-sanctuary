...
contract StakingPool is Context {
    ...
    /// @notice default strategy to invest
    string public defaultProd;

    /// @notice invest threshold
    ...
    constructor(
        ...
        string memory _defaultProd,
        uint256 _investThreshold
    ) public {
        token = _token;
        globalConfig = _globalConfig;
        defaultProd = _defaultProd;
    ...
    function stake(uint256 _amount) external {
        ...
        if (totalStaked > investThreshold) {
            _invest(defaultProd);
        }
    ...
    function getInvestStrategy(string memory prod)
        internal
        returns (IStrategy)
    {
