...
//   event SetValue(address indexed from, uint256 main, uint256 _author, uint256 _platform);
  ...
  function claimAuction(uint256 _tokenId, bool awardType, string memory ownerId, address from) public {
    ...
    //   _nonCryptoWallet[_nonCryptoOwners[_tokenId]] += (price / 1000) * mainPerecentage;
      ...
      revenueShare.transferAlia(price, tokenId, [mainPerecentage, platformPerecentage,authorPercentage], [msg.sender, temp.seller, _tokenAuthors[tokenId],platform, nonCryptoNFTVault], _nonCryptoOwners[_tokenId]);
  ...
  function buyNFT(address nft_a,uint256 tokenId, string memory ownerId) public{
        ...
        revenueShare.transferAlia(price, tokenId, [mainPerecentage, platformPerecentage,authorPercentage], [msg.sender, temp.seller, _tokenAuthors[tokenId],platform, nonCryptoNFTVault], _nonCryptoOwners[tokenId]);
