...
abstract contract BaseStrategy is Ownable {
    ...
    // Dex
    address public constant currentRouter = 0x1D4Ae238eD425aC9C80a1d8213B6Cb876c3f6770; //Quickswap router
...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        // Collects YELD tokens
        _getReward();

        //Swap 1/2 YELD for MATIC
...
contract StrategyBase is StrategyFarmBase {
    ...
    constructor(address _masterchef,address _lp, string memory _pairName,uint256 _underlyingPoolId,address _token1,address _token2)
        public
        StrategyFarmBase(
            _masterchef,
            _lp,
