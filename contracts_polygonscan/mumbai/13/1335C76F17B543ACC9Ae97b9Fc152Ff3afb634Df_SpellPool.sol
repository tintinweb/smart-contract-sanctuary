...
abstract contract CardPool is Ownable, Pausable {
    ...
    function getCard(uint256 _id) public view returns (string memory, bytes16, bytes1, uint256, uint256, string memory) {
        ...
        return (getCardName(_id), _card.cardType, _card.rarity, _card.rank, _card.level, string(abi.encodePacked(uri, _id)));
    }
...
// File contracts/pool/SpellPool.sol
...
contract SpellPool is CardPool {
    ...
    string private constant NAME = "CRAZY DEFENCE HEROES SPELL POOL";
