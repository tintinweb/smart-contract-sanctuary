...
contract PhToken is ERC20, ERC20Burnable, Pausable, Ownable {
    mapping(address => bool) public lockedOf;
    constructor() ERC20("PhToken", "PTKE") {}
  ...
  function isUnLockedOf(address account) public view returns (bool) {
  ...
  function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(isUnLockedOf(_msgSender()), "This account is locked");
  ...
  function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(isUnLockedOf(sender), "sender is locked");
