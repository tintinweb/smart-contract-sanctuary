...
// File contracts/SlavSquad.sol

//Contract based on [https://docs.openzeppelin.com/contracts/3.x/erc721](https://docs.openzeppelin.com/contracts/3.x/erc721)

pragma solidity ^0.8.0;
contract SlavSquad2 is ERC721, Ownable {
   
    uint public mintPrice = 0.025 ether;
    uint public giveawayMaxItems = 1;
    uint public preMintMaxItems = 2;
    uint public maxItems = 10;
    uint public giveawayCount = 0;
    uint public preMintCount = 0;
    uint public totalSupply = 0;
    uint public maxItemsPerPreMint = 2; // Mutable by owner
    uint public maxItemsPerTx = 2; // Mutable by owner
    ...
    constructor() ERC721("SlavSquad69", "GOPNIK69") {}
...
// File contracts/SlavSquadFlattened.sol