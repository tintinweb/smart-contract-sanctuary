...
contract Staking is AccessControl, ERC20 {
    ...
    constructor(
        ...
        withdrawBufferTime = _withdrawBufferTime;
    }
    ...
    function claimPlasma(address _to) public {
        ...
        uint256 possiblePlasmaPosssible = possiblePlasmaPointsCurrentMonth();
        uint256 plasmaToGenerate = (possiblePlasmaPosssible.sub(plasmaClaimedTillNow)).mul(_currentBalance).div(totalSupply());
        require(possiblePlasmaPosssible >= plasmaClaimedTillNow.add(plasmaToGenerate), "Can't mint more than current month permits");
