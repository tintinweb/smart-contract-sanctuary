...
contract FRTNFT is ERC1155URIStorage, Ownable, Pausable  {
    ...
    mapping(uint256 => address) private publishers;

    constructor() ERC1155("https://ipfs.io/ipfs/") {}

    
    modifier minterAllowed(){
        require( minters[msg.sender] || (msg.sender == owner()), "FRTNFT: Not allowed to mint!"); 
        _;
    }
    ...
    function mint(address account, string memory uri, uint256 amount)
        public
        minterAllowed
    ...
    function burn(
        ...
        require(
            ...
            "FRTNFT: caller is not owner nor approved"
        );
    ...
    function publisherOf(uint256 tokenId) public view returns (address){
        return publishers[tokenId];
    }
    ...
    function removeMinter(address addr) public {
        delete minters[addr];
    }
}
