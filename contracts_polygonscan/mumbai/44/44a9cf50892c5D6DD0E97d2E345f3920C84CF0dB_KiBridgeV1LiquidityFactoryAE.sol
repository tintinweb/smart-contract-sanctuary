...
import "./KiBridgeV1LiquidityA.sol";
...
contract KiBridgeV1LiquidityFactoryAE {
    ...
    returns (address liquidity)
  {
    ...
    liquidity = address(new KiBridgeV1LiquidityA{salt: keccak256(abi.encode(_token))}());
    ...
    external
  {
    ...
    KiBridgeV1LiquidityA(getLiquidity[_token]).mint(msg.sender, _amount);
  }
}
