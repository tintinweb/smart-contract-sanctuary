    ...
    ERC20SafeUpgradeable
{
    ...
    // depositor => tokenAddress => amount staked
    mapping(address => mapping(address => uint256)) private _stakedRecords;
    ...
    function _setLiquidityPool(
        ...
        if (lpAddress == address(0)) {
            ...
            RouterERC20Upgradable newLPAddr = new RouterERC20Upgradable();
