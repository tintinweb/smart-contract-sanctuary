...
contract FRTMarketplace is Ownable{
    ...
    function _approveNFT(uint256 _tokenId) private {
        ...
        } // TODO: not sending reward to last approver
    ...
    function downloadNFTForTesting(uint256 _tokenId) public view returns(string memory){
        require(testingAllowed[_tokenId][msg.sender] && NFTQueue[_tokenId] , "FRTMarketplace: Unauthorised!");
        return baseNFT.uri(_tokenId);
    }
