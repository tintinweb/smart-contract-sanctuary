...
contract OpenHogz is ERC721, ERC721URIStorage, Ownable, ContextMixin, RandomlyAssigned, WithSaleStart {
    ...
    constructor(IERC20 token, uint256 nftPrice) ERC721("Crypto Hogs", "HOG") RandomlyAssigned(4096, 1) WithSaleStart(0) {
        _token = token;
        _nftPrice = nftPrice*(10**18);
    }

    function safeMint(uint256 amount) public payable afterSaleStart onlyOwner ensureAvailability() {
        uint price = _nftPrice*amount;

        require(_token.allowance(msg.sender, address(this))>=price, "You didn't approve to use your DAI, or you have approved less DAI than needed");
    ...
    function _baseURI() internal view virtual override(ERC721) returns (string memory) {
        return "ipfs://QmYPwWC1VXzjSHVszvY7zVFY4DTk7Q78YqDwT38wS2H4ra/";
    }
