...
contract RealmToken is ERC20Burnable, Pausable , AccessControlEnumerable {
    ...
    constructor() ERC20("REALM", "REALM") {
        ...
        owner = msg.sender;
        _mint(msg.sender,STARTING_SUPPLY * (10**decimals()));
    }
    ...
    //Method That Transfer 1 Million Realm Token To RewardContract
    // function sendRealm(address _rewardContract)external onlyOwner zeroAddress{
    //     transfer(_rewardContract,1*10**6*10**18);
