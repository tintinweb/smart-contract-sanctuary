...
//contract TommyPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
contract TommyPunks is ERC721, ERC721Enumerable {
    ...
    constructor(uint256 _maxSupply) ERC721("TommyPunks", "TMPNKZ") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No TommyPunks left :(");
