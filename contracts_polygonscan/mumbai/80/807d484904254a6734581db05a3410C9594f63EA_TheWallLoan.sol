...
contract TheWallLoan is Context, IERC721Receiver
{
    ...
    function createOffer(uint256 refundWei, uint256 blocksDuration, int256 x1, int256 y1, int256 x2, int256 y2) payable public returns(uint256 offerId)
    {
        ...
        require(blocksDuration <= 3650 days / 2, "TheWallLoan: Invalid duration");
        Offer memory offer;
        offer.lender = _msgSender();
        offer.loanWei = msg.value;
