...
contract Water is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Water", "H20", 9) ERC20Permit() {
    ...
    /**
        @notice increases WATER supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess WATER
