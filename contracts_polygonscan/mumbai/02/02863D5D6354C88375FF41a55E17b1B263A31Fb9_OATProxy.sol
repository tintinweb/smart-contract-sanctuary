...
// OATProxy SMART CONTRACT
contract OATProxy is UpgradeableProxy, Ownable {
    /**
     * OATProxy Constructor
     *
     * @param _logic - Implementation/Logic Contract Address
     */
    constructor(address _logic, address _trustedForwarder)
        public
        UpgradeableProxy(
            _logic,
            abi.encodeWithSignature("initialize(address)", _trustedForwarder)
        )
    {}
