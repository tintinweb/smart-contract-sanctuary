...
contract CloudoxHippe is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) ERC1155Tradable("MTEST Apes.2", "SA", 'https://makechia.com/copy_space_apes/Api/metadata?token={id}', _proxyRegistryAddress) {}
    ...
    function contractURI() public pure returns (string memory) {
        ...
        return 'http://q01.cloudox.net/copy_space_apes/metadata/contract';
    }   
}
