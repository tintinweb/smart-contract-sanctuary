...
struct FileListing {
    string textElements;
    string[100] boringSoftwares;
    string[100] specialSoftwares;
}
...
library SVGBuilder {
    ...
    function generateSVGofToken(
        colorSet memory tokenColors,
        FileListing memory files,
        uint8 wackyPattern
        ...
        svg = string(abi.encodePacked(svg, files.textElements, "</svg>"));
        return svg;
    }
}
