...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Token name
    string private _name = "Shoot.to Content NFT";
...
contract ShootToContentNFT is ERC721Enumerable, AccessControl {
  ...
  //  event Mint(address indexed sender, uint256 startWith, uint256 times);
    ...
    function mint(uint256 tokenId, string memory tokenURI, address mintTo) public {
        ...
        if(mintTo!=address(0)){
            _safeTransfer(_msgSender(), mintTo, tokenId, "");
        }
