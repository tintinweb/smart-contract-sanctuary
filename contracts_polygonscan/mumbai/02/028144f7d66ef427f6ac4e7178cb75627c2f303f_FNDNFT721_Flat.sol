 ...
 */
abstract contract FoundationOperatorRole  {
...
abstract contract NFT721Metadata is NFT721Creator {
  ...
  function _updateBaseURI(string memory _baseURI) public {
 ...
 */
abstract contract NFT721Mint is ERC721Upgradeable, NFT721Creator, NFT721Metadata {
  using AddressLibrary for address;
