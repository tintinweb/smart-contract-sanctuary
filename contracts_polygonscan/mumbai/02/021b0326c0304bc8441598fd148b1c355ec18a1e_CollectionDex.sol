 ...
 */
 ...
 function mintWithCollection(address collection, address to, string memory tokenURI, uint256 royalty, string memory ownerId ) isValid(collection) public returns(uint256) {
