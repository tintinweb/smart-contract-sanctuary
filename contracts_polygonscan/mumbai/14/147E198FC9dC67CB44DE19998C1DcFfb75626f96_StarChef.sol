...
//import "./SiriusToken.sol";
abstract contract SiriusToken is ERC20 {
    function mint(address _to, uint256 _amount) public virtual;
}

// StarChef is the master of Sirius. He can make Siris and he is fair.
//
...
contract StarChef is Ownable, ReentrancyGuard {
    ...
    // The SIRIUS TOKEN!
    address public siriusAddress=0x803AdC4128D1AbB52184b7989b5255e14a92C9fe;
    ...
    uint256 public siriusPerBlock = 1 ether;
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        if (_amount > 0) {
            ...
            if (pool.depositFeeBP > 0) {
                ...
                pool.lpToken.safeTransfer(feeAddress, depositFee.div(4));
                pool.lpToken.safeTransfer(vaultAddress, depositFee.mul(3).div(4));
