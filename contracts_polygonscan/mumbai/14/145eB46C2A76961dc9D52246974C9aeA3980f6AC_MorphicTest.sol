...
contract MorphicTest is ERC1155, Ownable, Pausable {
    ...
    uint256 public MAX_PRESALE_ELEMENTS = 444;
    ...
    function contractURI() public pure returns (string memory) {
        return "https://bafkreibbtali4peqxueja4bvyt6l6b5d7la3bjfrlhck2wnbswqszvh3py.ipfs.dweb.link/";
    }  
    ...
    function mint(uint256 amount) public payable saleIsOpen { 
        ...
        require(amountof(msg.sender, _tokenId) + amount <= MAX_PER_ADDRESS, "Exceeds balance");        
    ...
    function amountof(address _owner, uint256 _mintSupply) public view returns (uint256) {  
