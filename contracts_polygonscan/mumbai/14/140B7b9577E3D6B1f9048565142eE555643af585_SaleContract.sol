...
contract SaleContract is ERC721Holder, Ownable, Pausable {
  ...
  function buyToken(uint256 _tokenId) payable public whenNotPaused {
      ...
      require(price == msg.value, 'Under/Over Priced!');
      nft.safeTransferFrom(address(this), msg.sender, _tokenId);
      uint256 commission = msg.value * 5 / 100;
      address payable _tokenSeller = payable(_tokenSellers[_tokenId]);
      _tokenSeller.transfer(msg.value - commission);
