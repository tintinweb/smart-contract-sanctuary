...
contract Snowcone is ERC721URIStorage, Ownable, RoyaltiesV2Impl {
    ...
    constructor() ERC721("Snowlycone", "SNWC"){}
    ...
    event PermanentURI(string tokenURI, uint256 indexed newItemId);
}
