...
contract TestNFTChild is ERC721Burnable, ERC721Pausable, RandomlyAssigned, WithSaleStart, WithContractMetaData, WithIPFSMetaData,
        IChildToken, AccessControlMixin, NativeMetaTransaction {
    ...
    constructor(string memory name_, string memory symbol_, uint256 maxElements, uint256 publicSaleStartTime, string memory contractUri, string memory cid, address childChainManager)
