...
contract SkylinesEnd is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public MINT_PUBLIC_FEE = 0.00001 ether;
    bool private CONTRACT_STARTED = false;
	address payable private VAULT;  // Vault
    ...
    constructor(string memory finalBaseURI, address payable finalVault) ERC721("Heading For Skyline's End", "SKYLINES_END") {
    ...
    function mintAndRefundExcess(uint256 numberOfNfts) external payable nonReentrant {
        ...
        uint256 totalPrice = numberOfNfts * price;
        require(msg.value >= totalPrice, "Ether value sent is insufficient");
