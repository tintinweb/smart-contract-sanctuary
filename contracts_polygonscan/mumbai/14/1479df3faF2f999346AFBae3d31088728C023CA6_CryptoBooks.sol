...
contract CryptoBooks is Initializable, ERC721URIStorageUpgradeable, VRFConsumerBaseUpgradeable {
    ...
    function initialize(address _VRFCoordinator, address _linkToken, bytes32 _keyHash, uint256 _chainlinkFee) public initializer {
