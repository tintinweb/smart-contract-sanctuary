...
*/
    ...
    //uint256
    uint256 UPGRADE_CHANCE = 9499;
    uint256 UPGRADE_COST = 1000000000000000000; // set low for testing
    ...
    */
    ...
    function currentHghCost() public view returns (uint256) {
        if (_tokenIds.current() >= 2000 && _tokenIds.current() <= 4000)
    ...
    function mintMike() public {
        ...
        if (_tokenIds.current() < 2000) return mintInternal();
