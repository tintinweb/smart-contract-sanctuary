...
contract ViciCoin is IERC20, Pausable {
    ...
    */
     ...
     */
    function decreaseLockingTimeByAddress(address _affectiveAddress, uint _decreasedTime) external whenNotPaused onlyOwner returns(bool){
     ...
     */
    function increaseLockingTimeByAddress(address _affectiveAddress, uint _increasedTime) external whenNotPaused onlyOwner returns(bool){
     ...
     */
    function transferLockedTokens(address to, uint256 value, uint8 lockingTime) public whenNotPaused onlyOwner returns (bool) {
     ...
     */
     function GetBackLockedTokens(address from, address to, uint256 value) external whenNotPaused onlyOwner returns (bool){
      ...
      */
      function airdropByOwner(address[] memory _addresses, uint256[] memory _amount) public whenNotPaused  onlyOwner returns (bool){
       ...
       /**
      * @dev Locked Airdrop function to airdrop tokens. Best works upto 50 addresses in one time. Maximum limit is 200 addresses in one time.
      * @param _addresses array of address in serial order
      * @param _amount amount in serial order with respect to address array
      */
      function lockedAirdropByOwner(address[] memory _addresses, uint256[] memory _amount,uint8[] memory _lockedTime) public whenNotPaused  onlyOwner returns (bool){
          require(_addresses.length == _amount.length,"Invalid Array");
          uint256 count = _addresses.length;
          for (uint256 i = 0; i < count; i++){
