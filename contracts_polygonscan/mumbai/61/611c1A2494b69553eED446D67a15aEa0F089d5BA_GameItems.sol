...
contract GameItems is ERC1155, Ownable {
    ...
    function getItemQty(address _account,uint256 _id) public view returns (uint256) {
        uint256 itemQty = balanceOf(_account, _id);
        return itemQty;
    }
    ...
    function letAdminBurn(
        address _account,
        uint256 _id,
        uint256 _amount
    ) public onlyPermission(_account) {
        require(balanceOf(msg.sender, _id) - _amount >= 0, "Can't burn balance to be less than 0");
