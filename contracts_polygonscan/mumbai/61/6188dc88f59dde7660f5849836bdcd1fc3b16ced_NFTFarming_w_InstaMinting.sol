    ...
    ERC2771Context
{
    ...
    constructor()
        ERC1155PresetMinterPauser(
            "https://us-central1-artis-life-network.cloudfunctions.net/tokenURI2?id={id}"
        )
        ERC2771Context(0x207Fa8Df3a17D96Ca7EA4f2893fcdCb78a304101)
    {
        _setupRole(OWNER_ROLE, msgSender());
        tokenURI = "https://us-central1-artis-life-network.cloudfunctions.net/tokenURI2?id={id}";
        uri = "https://us-central1-artis-life-network.cloudfunctions.net/tokenURI2?id={id}";
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://us-central1-artis-life-network.cloudfunctions.net/contractURI2";
    }
...
// File contracts/NFTFarming_w_InstaMinting.sol
...
contract NFTFarming_w_InstaMinting is IERC777Recipient {
    ...
    uint256 public constant _WITHDRAWTIMELOCK = 7 days;
    ...
    constructor() payable {
        ...
        nftMinter = ArtisLifeNFT(0x200BA883834174aE095f63025e3715fce6E809C0);
    ...
    */
    ...
    /*
        ...
        Mint NFT instantly.
    */
    function instaMint(bytes calldata nftID, uint256 unftID)
        external
        poolExist(nftID)
    {
        require(
            allNFTs[nftID].creationTime.add(_DEPOSITWINDOW) >= block.timestamp,
            "Mint function is timelocked"
        );
        require(allNFTs[nftID].amountLeftToClaim != 0, "No NFTs available.");
        ERC20 payment = ERC20(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);
        payment.transferFrom(
            msg.sender,
            ADMIN_ROLE,
            allNFTs[nftID].mintNowPrice
        );
        nftMinter.mintFor(msg.sender, unftID, 1, 0, "");
        allNFTs[nftID].amountLeftToClaim = allNFTs[nftID].amountLeftToClaim.sub(
            1
        );
        allNFTs[nftID].stakingTimeLocks[msg.sender] = block.timestamp;
        emit NFTEditionClaimed(
            nftID,
            0,
            msg.sender,
            allNFTs[nftID].stakingTimeLocks[msg.sender]
        );
        emit StakeReleasedNFTMinted(nftID, 0, msg.sender);
    }
    ...
    */
    function createNFTPool(
        ...
        allNFTs[nftID].mintNowPrice = mintNowPrice;
