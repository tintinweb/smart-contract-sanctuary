...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0x55d398326f99059fF775485246999027B3197955); // USDC
    address WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; // WMATIC
    IDEXRouter router;
...
/* Token contract */
contract Potatotest is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0x55d398326f99059fF775485246999027B3197955; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x0000000000000000000000000000000000000000; // Development here
    address MARKETING = 0x0000000000000000000000000000000000000000; // Marketing here                                                                                                                                   
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0000000000000000000000000000000000000000; // Update.
