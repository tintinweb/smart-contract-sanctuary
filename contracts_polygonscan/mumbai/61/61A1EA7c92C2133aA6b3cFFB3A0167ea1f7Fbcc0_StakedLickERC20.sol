...
// File: contracts/StakedLickERC20.sol
...
contract StakedLickERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Lick", "sLick", 9) ERC20Permit() {
    ...
    /**
        @notice increases sLICK supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sLICK
