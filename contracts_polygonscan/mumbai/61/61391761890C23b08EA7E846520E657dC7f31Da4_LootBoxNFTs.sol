...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */
    ...
    function _mint(address from, uint256 tokenId, uint256 _supply, string memory _uri, uint256 _fee) internal {
        ...
        emit TransferSingle(creator, address(0x0), creator, tokenId, _supply);
...
contract LootBoxNFTs is ERC1155 {
    ...
    function mint(string memory uri, uint256 supply, uint256 fee)  public {
        ...
        require(tokenCount <= 25, "ERC721: Minting is not allowed!");
        uint256 tokenId = tokenCount;
        _mint(creator, tokenId, supply, uri, fee);
        tokenCount += 1;
    }
