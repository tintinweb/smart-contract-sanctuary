...
interface IERC721Metadata is IERC721 {
     ...
     */
    function xtokenURI(uint256 tokenId) external view returns (string memory);
}
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function xtokenURI(uint256 tokenId) public view virtual override returns (string memory) {
...
contract ShootToContentNFT is ERC721Enumerable, AccessControl {
    ...
    function mint(uint256 tokenId, string memory itokenURI) public {
        require(hasRole(MINTER_ROLE, msg.sender), "Caller is not a minter");
        require(started, "not started");
        _safeMint(_msgSender(), tokenId);
        setTokenURI(tokenId, itokenURI);
        
    }

     function mintTo(uint256 tokenId, string memory itokenURI, address mintToAddress) public {
        require(hasRole(MINTER_ROLE, msg.sender), "Caller is not a minter");
        require(started, "not started");
