...
contract L2VaultConfig is VaultConfigBase, IL2VaultConfig {
    ...
    */
    ...
    {
        require(_remoteNetworkID > 0, "Invalid network ID");
        require(remoteTokenAddress[_remoteNetworkID][_tokenAddress] != address(0), "Token not supported in that network");
    ...
    modifier onlySupportedRemoteTokens(
        ...
        require(whitelistedTokens[tokenAddress].underlyingReceiptAddress != address(0), "Token not whitelisted");
        require(
