...
contract Polypunks is IERC721 {
    ...
    string internal nftName = "Polypunks";
    string internal nftSymbol = "Polypunks";
    ...
    function mint(uint256 numberOfNfts) external payable reentrancyGuard {
        ...
        require(price.mul(numberOfNfts) == msg.value, "eth value sent is not correct");
