...
/// @title EquipmentPool Contract
/// @notice Pool for equipment card items for CDH
...
contract EquipmentPool is CardPool {
    ...
    /// @return statically defined bytes1 value representing identifier of pool
    ...
    /// @notice Creates all cards on deployment
