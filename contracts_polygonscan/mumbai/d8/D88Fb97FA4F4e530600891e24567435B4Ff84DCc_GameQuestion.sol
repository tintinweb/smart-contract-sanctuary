    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        uint8 _rewardRate;
        uint8 _treasuryRate;
        (_rewardRate, _treasuryRate, _adminAddress, _operatorAddress, _gameToken, _questionID) = abi.decode(
            data,
            (uint8, uint8, address, address, address, bytes32)
        );
    ...
    function seeAmount(address user) public view returns (uint256 amount) {
