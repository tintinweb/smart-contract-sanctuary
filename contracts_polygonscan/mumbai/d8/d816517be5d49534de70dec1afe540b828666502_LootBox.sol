...
contract LootBox is Ownable, Pausable, ReentrancyGuard, VRFConsumerBase {
  ...
  function setTierSettings(
    ...
    require(_discountPercent < PERCENT_BASIS_POINT, "LootBox#setTierSettings: WRONG_DISCOUNT_PERCENT");
  ...
  function estimateCost(
    ...
    if (discountWhitelistMap[tierDiscountSettings][_toAddress] > 0) {
      ...
      cost = cost * (PERCENT_BASIS_POINT - discountWhitelistMap[tierDiscountSettings][_toAddress]) / PERCENT_BASIS_POINT;
    } else  if (discountWhitelistMap[globalDiscountsettings][_toAddress] > 0) {
      // global whitelist discount
      cost = cost * (PERCENT_BASIS_POINT - discountWhitelistMap[globalDiscountsettings][_toAddress]) / PERCENT_BASIS_POINT;
    }
