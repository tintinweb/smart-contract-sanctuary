...
contract ArtisFarm is IERC777Recipient {
    ...
    uint256 public rate; //rate of interest
    ...
    */
    function tokensReceived(
        ...
        if (stakers[from].isStaking == true) {
            ...
            stakers[from].artisBalance = stakers[from].artisBalance.add(toTransfer);
    ...
    function compoundYield(address staker) private {
        require(
            stakers[staker].isStaking = true && stakers[staker].artisBalance > 0,
            "Nothing to unstake"
        );
    ...
    function unstake(uint256 amount) public {
        require(
            stakers[msg.sender].isStaking = true && stakers[msg.sender].artisBalance >= amount,
            "Nothing to unstake"
        );
        ...
        stakers[msg.sender].artisBalance = stakers[msg.sender].artisBalance.sub(amount);
    ...
    function calculateYieldTotal(address user) public view returns (uint256) {
        ...
        uint256 rawYield = (stakers[user].artisBalance.mul(timeRate).div(10**18));
