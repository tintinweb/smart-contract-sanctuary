...
contract MintableTypedNFT is ERC721, Ownable, ITypedNFT {
    ...
    function mint(address _to, uint256 _type, uint256 _amount) override external onlyOwner returns (uint256) {
        uint256 lastTokenId;
    ...
    function getTypeInfo(uint256 _typeId) override public view returns (
