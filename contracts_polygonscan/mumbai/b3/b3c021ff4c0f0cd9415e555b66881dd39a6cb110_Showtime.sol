...
contract Showtime is Ownable, ERC721Enumerable, ReentrancyGuard {
  using Strings for uint256;

  uint256 public maxNFT = 9500;
  ...
  constructor() ERC721("Showtime", "SHWT") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmT7WHNqxbFwoV9qpYaYAMpjSAfYQxMA4vmb642xQ7svrV';
