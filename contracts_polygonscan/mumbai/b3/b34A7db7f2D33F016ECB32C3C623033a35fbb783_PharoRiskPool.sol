...
// Reserve Pool Interface
interface ReservePool {
    function depositToReserve (uint256 poolId, uint256 pharoId, address asset, uint256 amount, bytes32 metadata) external;
}
...
contract PharoRiskPool is AccessControl, ReentrancyGuard, Ownable {
    ...
    constructor (address _reservePoolAddr)
        public
        ReentrancyGuard()
    {
        reservePool = ReservePool(_reservePoolAddr);
    }

    // function pools() public returns(uint256) {
