...
abstract contract WithLimitedSupply {
    ...
    function availableTokenCount() public view returns (uint256) {
        return totalSupply1() - tokenCount();
    }
...
abstract contract RandomlyAssigned is WithLimitedSupply {
    ...
    function nextToken() internal override ensureAvailability returns (uint256) {
        uint256 maxIndex = totalSupply1() - tokenCount();
...
contract ManInADress is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 100 ether;
  uint256 public maxSupply = 1290;
  ...
  constructor(
    ...
    RandomlyAssigned(1290,1) // Max. 1290 NFTs available; Start counting from 1 (instead of 0)
    {
