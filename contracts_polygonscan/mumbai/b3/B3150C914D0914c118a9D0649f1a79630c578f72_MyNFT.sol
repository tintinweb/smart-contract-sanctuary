...
// File: contracts/NFTwithblind.sol
...
contract MyNFT is ERC721, Ownable, AccessControl{
  using Counters for Counters.Counter;
  using Strings for uint256;
  bool private _blindBoxOpened = false;
  string private _blindTokenURI =
      "ipfs://Qmb6KJG4WA7kHVVffYXj67FNEbNdEEj7ub6xquCVX6YGsv";
  Counters.Counter private _tokenIds;
  mapping (uint256 => string) private _tokenURIs;
  
  constructor() ERC721("MyNFTBlind", "MNFTB") {}
