    ...
    // IGame
{
    ...
    function createRoom(
        ...
        uint8 waitingPlayerCount;
        if (game.maxPlayer >0){
            require(_maxPlayer>game.maxPlayer,"287");
            delete game.deck;
            for (uint8 pIndex; pIndex < _maxPlayer * 2; pIndex++) {
    ...
    function joinGame(
        ...
        //player didn't join in time so they are forced to join the next game.
            ...
            emit JoinGame(
                game.gId+1, //gameId is the next game. this is still wrong , will change later
                _rId,//same roomId
                msg.sender,
                _position,
                _betAmount,
