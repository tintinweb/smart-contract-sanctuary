...
contract Exchange {
    ...
    event Token2ExchangedAt(address indexed, uint256 price);
    
    event Token1ExchangedAt(address indexed, uint256 price);
    ...
    function executeOrder(
        ...
        emit Token1ExchangedAt(tokenOneAddress, tokenOneAmount);
        ...
        emit Token2ExchangedAt(tokenTwoAddress, tokenTwoAmount);
    }
}
