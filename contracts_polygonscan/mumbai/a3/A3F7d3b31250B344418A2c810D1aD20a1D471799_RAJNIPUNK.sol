...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable,VRFConsumerBase {
  ...
  // mapping for token creator
    ...
    constructor (string memory name_, string memory symbol_) VRFConsumerBase( 0x8C7382F9D8f56b33781fE506E897a4F1e2d17255, 0x326C977E6efc84E512bB9C30f76E30c160eD06FB ) {
        _name = name_;
        _symbol = symbol_;
