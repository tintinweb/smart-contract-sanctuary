...
contract FearBridge is Ownable, Pausable {
    ...
    uint8 public ETH_APP_ID = 5; // muon's eth app id
    ...
    function claim(
        ...
        require(
            currentBlockNo - txBlockNo >= confirmationBlocks[fromChain],
            "Bridge: confirmationBlock is not finished yet"
        );
    ...
    function setConfirmationBlock(uint256 chainId, uint256 confirmationBlock)
        external
        onlyOwner
    {
