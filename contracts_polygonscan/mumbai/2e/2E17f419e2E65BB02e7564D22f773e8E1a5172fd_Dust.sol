...
contract Dust is ERC20, Ownable, ExternalActor {
  ...
  function updateChildChainManager(address newChildChainManagerProxy) external onlyOwner {
    require(newChildChainManagerProxy != address(0), "BAD_ADDRESS");
    childChainManagerProxy = newChildChainManagerProxy;
  }

  function deposit(address user, bytes calldata depositData) external {
    require(msg.sender == childChainManagerProxy, "NOT_ALLOWED");
  ...
  function withdraw(uint256 amount) external {
    // require(msg.sender == childChainManagerProxy, "NOT_ALLOWED");  // FIXME: No Security ????
