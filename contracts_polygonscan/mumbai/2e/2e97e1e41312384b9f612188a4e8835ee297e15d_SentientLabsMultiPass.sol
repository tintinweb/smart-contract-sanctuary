...
contract SentientLabsMultiPass is ERC1155, Ownable, Pausable, ERC1155Supply {

    mapping (uint256 => string) private _uris;

    constructor() ERC1155("https://sentientlabs.app/tokens/{id}") {}
