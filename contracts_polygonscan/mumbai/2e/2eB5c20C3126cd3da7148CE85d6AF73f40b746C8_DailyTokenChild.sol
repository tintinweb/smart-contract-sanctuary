...
// File contracts/polygon/DailyTokenChild.sol

pragma solidity 0.8.4;

contract DailyTokenChild is ERC20, IChildToken, AccessControl {
    // Roles
    bytes32 private constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 private constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

    constructor(address childChainManager) ERC20("DailyToken", "DLY") {
     ...
     * `amount` and it should have the burner role.
     */
