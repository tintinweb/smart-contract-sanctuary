...
contract Converter is Ownable, ReentrancyGuard {
    ...
    function setAllocation(
        ...
        require(
            _farmAllocation + _stakersAllocation + _platformFeesAllocation + _treasuryAllocation ==
                1000,
            "invalid allocations"
        );
    ...
    */
    function _allocateYGN() internal {
        ...
        _safeTransfer(address(ygn), yugenFarm, totalYGNAccumulated.mul(farmAllocation).div(1000));
        _safeTransfer(
            address(ygn),
            ygnStaker,
