...
contract TokenSale is ERC20, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor (address ownerAddress,
        ...
        adoptionPhaseDuration  = adoptionPhaseLength * 24 * 60 * 60; //2 months
...
contract StakingXWife is TokenSale, xWifeDistributionManager {
    ...
    uint128 public emissionPerSecondInitial;
    ...
    function getPenalty(uint256 amount, uint256 startTimestamp, uint256 endTimestamp) private view returns (uint256)
    {
        uint256 currentTimestamp = block.timestamp;
    ...
    function withdraw(uint256 amount) external inInflationPhase nonReentrant {
        ...
        uint earlyOrLatePenalty = getPenalty(amount,
