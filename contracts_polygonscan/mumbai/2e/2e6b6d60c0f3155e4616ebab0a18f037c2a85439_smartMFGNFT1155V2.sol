...
contract smartMFGNFT1155V2 is ERC1155 {
    ...
    function mint(address creator, string memory uri, uint256 supply, uint256 fee)  public {
        require(msg.sender == transferProxy,"Operator: caller is not Operator");
        _mint(creator, tokenCounter, supply, uri, fee);
