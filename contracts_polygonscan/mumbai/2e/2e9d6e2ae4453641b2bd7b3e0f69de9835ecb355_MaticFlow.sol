...
// File: contracts/MaticFlow.sol


pragma solidity 0.8.11;

contract MaticFlow is ReentrancyGuard {
    ...
    uint256 private constant MIN_WITHDRAW = 2 ether;
    uint256 private constant MIN_INVESTMENT = 5 ether;
    ...
    function _invest(
        ...
        require(msg.value >= MIN_INVESTMENT, "Minimum investment is 5 Matic");
    ...
    function withdraw() public nonReentrant {
        ...
        require(
            ...
            "Cannot withdraw less than 2 Matic"
        );
