...
contract sSundae is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Sundae", "sSUN", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSundae supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSundae
