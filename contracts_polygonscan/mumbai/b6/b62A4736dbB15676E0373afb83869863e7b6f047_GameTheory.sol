...
//    Counters.Counter private _tokenIdCounter;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        uint256[3] memory randomValues = [random1, random2, random3];

        // Use the getAttributesRarity function to retrieve the new rarities for each attribute.
        uint256[][] memory rarities;
        //TODO Retrieve these values from getAttributesRarity
        //uint256[][] rarities = getAttributesRarity();

        // Send the randomValues and rarities to getAttributesArray to retrieve the attributes for the new mint.
        uint256[] memory attributesOfDude = getAttributesArray(randomValues, rarities);
