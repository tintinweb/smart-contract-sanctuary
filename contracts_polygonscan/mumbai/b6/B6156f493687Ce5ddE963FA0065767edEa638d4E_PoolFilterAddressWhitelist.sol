...
// Accepts ANY non-blacklisted CO2KEN contract
...
contract PoolFilterAddressWhitelist is Ownable, IPoolFilter {
    ...
    // Mapping to whitelist external non-CO2KEN contracts by address
    mapping(address => bool) public externalWhiteList;

    // Mapping to exclude certain CO2KEN contracts by address
    ...
    // Whitelist selected external non-CO2KEN contracts by address
    ...
    // Blacklist (Reject) certain CO2KEN contracts by address
