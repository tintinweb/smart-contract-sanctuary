...
contract ClubVirtual is NFTokenMetadata {
 ...
 uint256 _tokenId;
  ...
  function transferamount(address creator,address admin,uint256 amount,uint256 adminpersent) public payable
  {   address payable _creator = payable(creator);
      address payable _admin = payable(admin);
      // uint256 adn=adminpersent/10000000000;
      uint256 creatorpercent=(1000000000000-adminpersent);
      uint256 creatoramount = (amount * creatorpercent)/1000000000000;
