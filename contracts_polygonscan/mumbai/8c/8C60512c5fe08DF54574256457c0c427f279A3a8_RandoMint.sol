...
pragma solidity ^0.8.0;
// Test Rando-mint ERC721 

// Calling mint mints a random  NFT until 23 have been minted
// Mint costs 0.01 Matci
// 3 retained by artist and developer

// WeMint.Cash 

contract RandoMint is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
    uint256 public currentSupply = 0;
    uint256 public maxMintAmount = 5;
    string public baseURI = "https://ipfs.io/ipfs/QmYLpHvtzSftngAR2LXurt6cWiZCpTEy4P5EQvz4qc87PE/1/";
  ...
  constructor() 
    ERC721("RandoMint", "RM")
    RandomlyAssigned(23,1) // Max. 23 NFTs available; Count from 1 (instead of 0)
    {
  ...
  function mint ()
      ...
      payable
  {
      require( tokenCount() + 1 <= totalSupply(), "Cannot mint more than the max supply");
      require( availableTokenCount() - 1 >= 0, "Cannot mint more than the mavailable token count"); 
      require( tx.origin == msg.sender, "Cannot mint via custom contractT");
