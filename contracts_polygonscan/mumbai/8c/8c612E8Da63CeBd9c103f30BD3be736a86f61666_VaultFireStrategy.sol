...
contract VaultFireStrategy is BaseStrategyLP {
    ...
    // call enter to CNTStaker...xCNT mila
    // call UniversalSingleSideLiquidity contract by passing xCNT...provides liquidity for xCNT-WMATIC LP
    // put to farm....get rewards
    ...
    function _vaultDeposit(uint _amount) internal override {
        ...
        farmAddress.deposit(farmPId, totalLPTokenStaked);
