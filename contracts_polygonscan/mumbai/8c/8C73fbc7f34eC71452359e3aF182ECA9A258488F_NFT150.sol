...
//    onlyWhitelistAdmin
    ...
    function create(
        ...
        for (uint32 i = 1; i <= _initialSupply; i++) {
            bytes32 _key = keccak256(abi.encodePacked(_id, i));
            nftVersion[_key] = msg.sender;
        }
...
//    mapping(uint256 => mapping(uint256 => address)) public nftVersion;
    mapping(bytes32 => address) public nftVersion;
  ...
  |__________________________________*/
    ...
    function safeTransferFrom(
        ...
        bytes32 _key = keccak256(abi.encodePacked(_id, _version));
