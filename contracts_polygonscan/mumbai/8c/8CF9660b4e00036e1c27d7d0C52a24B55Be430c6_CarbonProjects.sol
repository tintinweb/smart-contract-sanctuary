...
// The CarbonProjects represents offsetting projects as ERC721 tokens
    ...
    UUPSUpgradeable
{
    ...
    ) external virtual override onlyOwner whenNotPaused returns (uint256) {
    ...
    function removeProject(uint256 tokenId)
        external
        virtual
        onlyOwner
        whenNotPaused
