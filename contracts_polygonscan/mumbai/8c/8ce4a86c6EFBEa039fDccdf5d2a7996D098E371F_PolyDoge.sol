...
import "../polygon/DogewoodPoly.sol";
...
contract PolyDoge is DogewoodPoly {
    ...
    function updateDoge(uint256 id, uint8 head, uint8 breed, uint8 color, uint8 class, uint8 armor, uint8 offhand, uint8 mainhand, uint16 level) external {
        doges[id].head = head;
    ...
    // function getDoge(uint256 tokenId) external view returns (Doge memory){ 
