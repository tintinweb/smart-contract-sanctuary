...
contract BlackList is Ownable, Polygon{
...
contract PolygonDetailed is Polygon, BlackList {
...
contract MealAwayToken is PolygonDetailed {
  ...
  string constant tokenName = "MealAway Token";
  ...
  constructor() public payable PolygonDetailed(tokenName, tokenSymbol, tokenDecimals) {
   ...
   function migrate() external {
        ...
        uint value = _balances[msg.sender];
