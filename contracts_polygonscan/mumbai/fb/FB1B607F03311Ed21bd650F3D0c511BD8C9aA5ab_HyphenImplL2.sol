...
interface HyphenLiquidityPoolManager {
    function depositErc20( address tokenAddress, address receiver, uint256 amount, uint256 toChainId ) external;
}
...
contract HyphenImplL2 is ImplBase {
    ...
    constructor(HyphenLiquidityPoolManager _liquidityPoolManager, address _registry)
        ImplBase(_registry)
    {
