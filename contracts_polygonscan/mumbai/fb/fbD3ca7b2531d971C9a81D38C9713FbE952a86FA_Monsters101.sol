...
contract Monsters101 is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;

    //sale settings
    uint256 constant private MAX_SUPPLY = 5555;
    uint256 constant private MAX_PRESALE_MINT = 5555;
    uint256 private TEAM_RESERVE_AVAILABLE_MINTS = 0;
