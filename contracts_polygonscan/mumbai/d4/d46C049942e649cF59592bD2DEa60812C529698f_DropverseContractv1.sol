...
contract DropverseContractv1 is ERC1155Creator {
    ...
    function safeTransfer(address to, uint256 id, uint256 amount, bytes memory data) public {
        safeTransferFrom(_msgSender(), to, id, amount, data);
    }

    function safeBatchTransfer(address to, uint256[] memory tokenIds, uint256[] memory amounts) public {
        safeBatchTransferFrom(_msgSender(), to, tokenIds, amounts, "");
    }
}
