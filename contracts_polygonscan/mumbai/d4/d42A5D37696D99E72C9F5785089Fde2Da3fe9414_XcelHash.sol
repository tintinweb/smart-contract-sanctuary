...
/**
* @title XcelHash STO Smart Contract
...
*/
contract XcelHash is Proxiable, ERC20Detailed, ERC1404, OwnerRole, Whitelistable, Blacklistable, RevocableToAddress, Mintable, Burnable, Revocable, Pausable {
    ...
    */
    ...
    /**
    * @notice Used to check reason when the transfer is restricted
    * @dev This function allows a wallet or other client to get a human readable string to show
