...
// File: contracts/token/ERC1155721/GBots/GBots.sol
    ...
    ERC1155721InventoryMetadata
{
    constructor(IForwarderRegistry forwarderRegistry, address universalForwarder, address metadataRepository)
        ERC1155721Inventory("GBots Inventory", "GBOT")
        Roles(msg.sender)
        Pausable(false)
    ...
    event GBotCreated(address indexed _to, uint256 indexed _tokenId, uint256 metadata);
    ...
    /**
     * Creates a Gbot and sets its metadata
     * @dev See {IERC1155721InventoryMintable-safeMint(address,uint256,bytes)}.
     */
    function createGBot(
        address to,
        ...
        emit GBotCreated(to, nftId, metadata);
    }
