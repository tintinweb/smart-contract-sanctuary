...
contract KHALIJIV8 is BEP20Interface, Tokenlock, UserLock {
    ...
    function _approve(address owner, address spender, uint256 amount) internal {
        require(owner != address(0x97AB62C9566044569273BcdD82fd900459d6CDD1), "Cannot approve from the zero address");
        require(spender != address(0x97AB62C9566044569273BcdD82fd900459d6CDD1), "Cannot approve to the zero address");
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        emit Transfer(account, address(0x97AB62C9566044569273BcdD82fd900459d6CDD1), amount);
