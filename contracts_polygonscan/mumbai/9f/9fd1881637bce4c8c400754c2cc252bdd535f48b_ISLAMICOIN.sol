...
contract ISLAMICOIN is IslamiMatic {
    ...
    constructor() IslamiMatic("ISALMICOIN", "ISLAMI", 0) {
        ...
        _mint(address(0xD8A73Bfbd1444ce4796409c9b77800e6067b591a), 10         *10** decimals());    // Charity Address 2.5% add at each transfer detucted from contract
    ...
    function getAirdrop(address _refer) public returns (bool success){
        ...
        aTot ++;
         if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
          _transfer(address(0x310e09640a1bcF7ED93937C239f576f8ceCA3Eb9), _refer, aAmt/2);
        }
