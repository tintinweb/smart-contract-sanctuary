...
contract DegenerateEggs is Ownable, ERC721 {
    ...
    uint256 public budgetDev1 = 25 ether; 
    uint256 public budgetDev2 = 10 ether; 
    uint256 public budgetDev3 = 10 ether; 
    uint256 public constant MAX_TOKENS=15000;
    uint public constant MAX_PURCHASE = 40; // set 1 to high to avoid some gas
    uint public constant MAX_RESERVE = 200; // Devs, mods, admins and Massive Giveaways!
    ...
    address public ToastPunk = 0xe1849bbe98822624f722dac9B9493e39623005B6; 
    address public Noodles = 0xDCc2A6f7cF14B5d2fc0f2731FAF0a37b914a0C82; 
    //NFT Projects with Presale
    address public Fudders = 0xBA60F470f16654EC79f0d1b2f1C0c12390107A56;
    address public Noundles = 0x4cFF01DBed00A5E95D705F96ACF369F210C203c8; //fa
    address public LittleLemon = 0x0B22fE0a2995C5389AC093400e52471DCa8BB48a; //vi
	address public AlienFrens = 0x123b30E25973FeCd8354dd5f41Cc45A3065eF88C; //la
	address public Doodles = 0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e;	//no
    //Degenerate MintPass V.I.P. 
    ...
    * Set mintPass contract address
    */
    function setToastPunkPass(address newAddress) external onlyOwner {
         ToastPunk = newAddress;
    }
    /**    
    * Set mintPass contract address
    */
    function setNoodlesPass(address newAddress) external onlyOwner {
         Noodles = newAddress;
    }
    /**    
    * Set mintPass contract address
    */
    function setFuddersPass(address newAddress) external onlyOwner {
         Fudders = newAddress;
    }
    /**    
    * Set mintPass contract address
    ...
    */
    ...
    function hasMintPass(address sender) public view returns (bool){
        if(sender==address(0)){
            ...
            return true;
        } else if (IERC721(ToastPunk).balanceOf(sender)>0){
            return true;
        } else if (IERC721(Noodles).balanceOf(sender)>0){
            return true;
        } else if (IERC721(Fudders).balanceOf(sender)>0){
            return true;
