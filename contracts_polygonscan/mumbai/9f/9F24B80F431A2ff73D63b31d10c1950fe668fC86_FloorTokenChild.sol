...
contract FloorTokenChild is ERC721, Ownable, FxBaseChildTunnel {
    ...
    constructor(
        ...
        ERC721('FLOOR', 'FLOOR')
        FxBaseChildTunnel(0xCf73231F28B7331BBe3124B907840A94851f9f11)
    {
    ...
    function _processMessageFromRoot(
        ...
        (uint256 floorId, uint8 size) = abi.decode(data, (uint256, uint8));
        sizes[floorId] = size;
    }
