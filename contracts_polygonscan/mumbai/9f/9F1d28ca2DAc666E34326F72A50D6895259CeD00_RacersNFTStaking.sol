...
contract RacersNFTStaking is Pausable, AccessControl, ERC721Holder {    
    IERC721 public RACE;
    IERC20 public EOC;
    ...
    */
    ...
    constructor(address _RACE, address _EOC){
        RACE = IERC721(_RACE);
        EOC = IERC20(_EOC);
    ...
    */
    function unstake(address _user, uint256 _tokenId) public onlyOwner(_tokenId) {
        Staker storage staker = stakers[_user];
