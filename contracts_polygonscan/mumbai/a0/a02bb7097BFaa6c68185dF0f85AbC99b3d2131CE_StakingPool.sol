...
contract StakingPool is IStakingPool, Ownable {
    ...
    uint public BASE_APY = 0;
    uint public constant MIN_APY = 6;
    uint private constant ONE_YEAR_IN_SECONDS = 31536000;
    uint private constant THREE_MONTHS_IN_SECONDS = 7889238;
    uint public constant maxExp = 31421994;
    ...
    function getMaxLevelToUp(
        ...
        if (currentStar == 1 && maxLevel >= 10){
            maxLevel = 10;
            heroEarnedExp[heroId] = totalExp - expValue[0] * 1e18;
            heroCurrentExp[heroId] = expValue[0] * 1e18;
        } else if (currentStar == 2 && maxLevel >= 20){
            maxLevel = 20;
            heroEarnedExp[heroId] = totalExp - expValue[1] * 1e18;
            heroCurrentExp[heroId] = expValue[1] * 1e18;
        } else if (currentStar == 3 && maxLevel >= 30){
            maxLevel = 30;
            heroEarnedExp[heroId] = totalExp - expValue[2] * 1e18;
            heroCurrentExp[heroId] = expValue[2] * 1e18;
        } else if (currentStar == 4 && maxLevel >= 40){
            maxLevel = 40;
            heroEarnedExp[heroId] = totalExp - expValue[3] * 1e18;
            heroCurrentExp[heroId] = expValue[3] * 1e18;
        } else if (currentStar == 5 && maxLevel >= 50){
            maxLevel = 50;
            heroEarnedExp[heroId] = totalExp - expValue[4] * 1e18;
            heroCurrentExp[heroId] = expValue[4] * 1e18;
        } else if (currentStar == 6 && maxLevel >= 60){
            maxLevel = 60;
            heroEarnedExp[heroId] = totalExp - expValue[5] * 1e18;
            heroCurrentExp[heroId] = expValue[5] * 1e18;
        } else if (currentStar == 7 && maxLevel >= 70){
            maxLevel = 70;
            heroEarnedExp[heroId] = totalExp - expValue[6] * 1e18;
            heroCurrentExp[heroId] = expValue[6] * 1e18;
        } else if (currentStar == 8 && maxLevel >= 80){
            maxLevel = 80;
            heroEarnedExp[heroId] = totalExp - expValue[7] * 1e18;
            heroCurrentExp[heroId] = expValue[7] * 1e18;
        } else if (currentStar == 9 && maxLevel >= 90){
            maxLevel = 90;
            heroEarnedExp[heroId] = totalExp - expValue[8] * 1e18;
            heroCurrentExp[heroId] = expValue[8] * 1e18;
        } 
        return maxLevel;
    }
