...
contract PETFINFT is ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    uint256 public MINT_PRICE = 80 ether; // 80 matic equals to 0.05 ETH
    uint256 public MAX_BY_MINT = 2;
    uint256 public MAX_PER_ADDRESS = 2;
    string public baseTokenURI; // IPFS

    address public adminAddress = 0xf339657467583dEF777560a8548fc8D92c4387bc;
    string public baseExtension = ".json";
    bool public revealed = false;
    string public notRevealedUri;
    event CreatePetFiMetaverse(uint256 indexed id);

    constructor() ERC721("PetFi NFT Test", "$PFT") {
        setBaseURI("https://ipfs.io/ipfs/QmYvDfykbRGwXYDYwKJN7ad2nnHBrqGwumZ8HeZ9JJBiKN");
        pause(true);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(adminAddress, balance);
    }
