    ...
    ReentrancyGuardUpgradeable
{
    ...
    event ProposalEvent(uint8 originChainID, uint64 depositNonce, VoterUpgradeable.ProposalStatus status, bytes32 dataHash);
    event ProposalVote(uint8 originChainID, uint64 depositNonce, VoterUpgradeable.ProposalStatus status, bytes32 dataHash);
