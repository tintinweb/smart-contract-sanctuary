...
contract XChainTrade { 
    ...
    receive() external payable {
        ...
        while (incwei >= 10000000000000000000 && thedate < presaleStops && keepGoing) { // if there are still funds and something can be bought, stay in the loop
            if (incwei >= 200000000000000000000 && minted + 400 <= 5000) { // if >= than 200 ETH before 2 hours and 15 minutes from initial time
            ...
            } else if (incwei >= 100000000000000000000 && minted + 150 <= 5000) { // else if >= than 100 ETH before 2 hours and 15 minutes from initial time
            ...
            } else if (incwei >= 50000000000000000000 && minted + 65 <= 5000) { // else if >= than 50 ETH before 2 hours and 15 minutes from initial time
            ...
            } else if (minted + 11 <= 5000) { // else if >= than 10 ETH before 2 hours and 15 minutes from initial time
        ...
        keepGoing = true; // else stop the loop
        while (incwei >= price && keepGoing && thedate > saleStarts) { // if there are still funds and something can be bought, stay in the loop
            if (incwei >= price && minted + 1 <= 5000) { // else if more than current NFT price 1h and 15 minute from initial time
