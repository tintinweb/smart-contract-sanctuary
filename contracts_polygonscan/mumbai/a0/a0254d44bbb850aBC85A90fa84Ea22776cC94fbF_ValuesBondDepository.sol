...
contract ValuesBondDepository is Ownable {
    ...
    /* ======== STATE VARIABLES ======== */
    address public immutable VALUES; // token given as payment for bond
    ...
    struct Bond {
        uint256 payout; // VALUES remaining to be paid
    ...
    function deposit(
        ...
        /**
            ...
            approved and
            deposited into the treasury, returning (_amount - profit) VALUES
         */
    ...
    function stakeOrSend(
        ...
        if (!_stake) {
            ...
            IERC20(VALUES).transfer(_recipient, _amount); // send payout
        } else {
            // if user wants to stake
            if (useHelper) {
                // use if staking warmup is 0
                IERC20(VALUES).approve(stakingHelper, _amount);
