...
contract MATICX2_Token is Ownable{
	...
	uint256 public INVEST_MIN_AMOUNT = 10 * (10 ** 18);
	uint256 public INVEST_MIN_AMOUNT2 = 10 * (10 ** DECIMALS);
	...
	constructor(address payable marketingAddr, address payable projectAddr, address payable fundAddr, uint256 startDate, uint256 setDECIMALS, IBEP20 tokenAddr) public {
