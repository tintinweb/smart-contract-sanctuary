...
// File: contracts\Flag_Crowdsale.sol

pragma solidity ^0.5.5;

 /**
  * @title Flag_Crowdsale
  */
 contract Flag_Crowdsale is Crowdsale, Ownable {
    
    mapping (address => uint32) public whitelist;
    mapping(address => uint256) private contributions;
    
    // Hard Cap en weiAmount
	uint256 private constant HARDCAP = 100000000000000000;
	// Start ICO
	// uint256 private constant START_ICO = 1633824000; // Date and time (GMT): Sunday, 10 October 2021 г., 0:00:00

    constructor(
        IERC20 token
    ) public Crowdsale(10000, 0x6Daa6909CA7dCFA4697c1CBdC77318905504d50F, token) {
        transferOwnership(0x6Daa6909CA7dCFA4697c1CBdC77318905504d50F);
    }
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(contributions[beneficiary].add(weiAmount) <= HARDCAP, "Crowdsale: beneficiary s cap exceeded");
        super._preValidatePurchase(beneficiary, weiAmount);
    }
