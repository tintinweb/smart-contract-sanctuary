...
//     }
    ...
    */
    function emergencyWithdrawAllFuel() external onlyAdmin {
        ...
        require(_transferGET(CONFIGURATION.feeCollectorAddress(), FUELTOKEN.balanceOf(address(this))), "GET_SWIPE_TRANSFER_FAILED");

    }

    function _transferGET(address _toAddress, uint256 _amountGET)
        internal
        returns (bool)
    {   
    ...
    function _updateMintFactor(
        ...
        if (_getprice == 0) { // relayer silo has no GET price yet
