...
contract Tslo is BaseRelayRecipient,VRFConsumerBase {
    ...
    address internal _gsnForwarder =  0x4d4581c01A457925410cd3877d17b2fd4553b2C5;
...
//    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        if(randomResult<=3)
            _credits[requestAddress] -= 1 * 10 ** 18;
        else if(randomResult==4)
            _credits[requestAddress] += 2 * 10 ** 18;
        else if(randomResult==5)
            _credits[requestAddress] += 3 * 10 ** 18;
    }
