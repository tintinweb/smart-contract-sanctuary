...
// File contracts/standards/ERC20Pausable.sol
...
// File contracts/Summoner.sol


pragma solidity 0.8.11;


contract Summoner is ERC20Pausable, AccessController {

  mapping(address => bool) public transferLocked;

  bytes32 private MINTER_ROLE = "MINTER_ROLE";
  bytes32 private BURNER_ROLE = "BURNER_ROLE";
  bytes32 private LOCKER_ROLE = "LOCKER_ROLE";
  bytes32 private DEPOSITOR_ROLE = "DEPOSITOR_ROLE";
