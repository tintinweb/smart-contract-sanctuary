...
contract Samarag is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xee69E72B0A1524329e6dD66D8c7e974D939e7690); // Marketing Address
    ...
    string private _name = "SAMARAG";
    string private _symbol = "SMGT";
    ...
    uint256 public _liquidationThreshold = 90000 * 10**18;
    uint256 public _maxTxAmount = 1000000 * 10**18;
    uint256 public _maxWalletLimit = 250 * 10**6 * 10**18;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff //Sushiswap Router address
        );
    ...
    function _transfer(
        ...
        if(from != owner() || to != owner()){
            require(amount <= _maxTxAmount, "Transaction amount exceeds the limit allowed per transaction");
            require((balanceOf(address(this)) + amount) <= _maxWalletLimit, "Exceeds maximum tokens allowed per wallet" );
        }
        // buy
        if (
            from == uniswapV2Pair &&
    ...
    function _removeSniper(address account) external onlyOwner {
        require(
            ...
            "We can not blacklist sushiswap"
        );
