...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8E974456657427fEF9347eCafdE54F74aa9D5dAa;
...
contract Zeros is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFc96Ca835851B85246eD835FEb4824CdC0304e16;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000000000000000 * 10 ;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "33Zeros";
    string private _symbol = "33Zeros";
    ...
    uint256 public _maxTxAmount =  1000000000000000000000000000000001 * 10 ;
    uint256 private numTokensSellToAddToLiquidity = 100000000000000000000000 * 10;
