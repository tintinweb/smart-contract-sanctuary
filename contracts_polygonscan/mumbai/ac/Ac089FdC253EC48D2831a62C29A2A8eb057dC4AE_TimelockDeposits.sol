...
contract TimelockDeposits {
   ...
   */
  function executeWithdrawal(uint256 _ID, address transferTo) external onlyOwner {
    ...
    else IERC20(transactions[_ID].token).transfer(transferTo, transactions[_ID].value);
