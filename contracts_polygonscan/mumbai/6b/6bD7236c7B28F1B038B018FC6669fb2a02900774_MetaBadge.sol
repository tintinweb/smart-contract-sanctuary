...
contract MetaBadge is ERC721Namable, Ownable, RandomlyAssigned {
    ...
    uint256 constant PRICEWHITELIST = 5 ether / 10;
    uint256 private PRICETIER1 = 2 ether;
    uint256 private PRICETIER2 = 1 ether;
   ...
   mapping(address => bool) whiteListTier2;
    ...
    function walletIsInWhiteListTier1(address wallet) internal view returns(bool){
        return whiteListTier1[wallet];
    }

    //Check contains of wallet in WhiteListTier2
    function walletIsInWhiteListTier2(address wallet) internal view returns(bool){
...
abstract contract WithLimitedSupply {
    ...
    constructor () {
        _totalSupply = 10000;
        _totalSupplyTier1 = 1499;
        _totalSupplyTier2 = 8501;
    }
