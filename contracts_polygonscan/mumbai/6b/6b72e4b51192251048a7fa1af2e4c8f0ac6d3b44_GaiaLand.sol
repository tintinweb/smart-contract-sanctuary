...
contract GaiaLand is ERC721, Ownable {
    ...
    uint256 public gaiaLandPrice = 75000000000000000; // 0.075 ETH
    ...
    function mintGaiaLand(uint256 numberOfTokens) public payable {
        ...
        require(
            msg.value >= gaiaLandPrice.mul(numberOfTokens),
