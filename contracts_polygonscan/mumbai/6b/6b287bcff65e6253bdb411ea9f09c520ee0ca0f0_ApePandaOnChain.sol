...
contract ApePandaOnChain is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 500 500"><rect x="0" y="0" width="500" height="500" style="fill:#',
    '"/><rect width="300" height="120" x="99" y="400" rx="15" style="fill:#', '"/><circle cx="190" cy="470" r="5" style="fill:#', '"/><circle cx="310" cy="470" r="5" style="fill:#',
    '"/><circle cx="100" cy="150" r="70" style="fill:#', '"/><circle cx="100" cy="150" r="30" style="fill:#', '"/><circle cx="400" cy="150" r="70" style="fill:#',
    '"/><circle cx="400" cy="150" r="30" style="fill:#', '"/><circle cx="250" cy="250" r="150" style="fill:#', '"/><circle cx="250" cy="250" r="120" style="fill:#',
