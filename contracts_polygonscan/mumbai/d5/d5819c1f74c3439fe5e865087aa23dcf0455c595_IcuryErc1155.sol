...
contract IcuryErc1155 is ERC1155, Ownable {
    ...
    //     // require(tokenId == amounts.length, "ERC1155: ids and amounts length mismatch");
    //     // mapping(uint => bool) isTokenExist;
    //     require(! isTokenExist[tokenId], "token already exist") ;
    //     _uris[tokenId] = newuri;
    //     isTokenExist[tokenId] = true;
    //     } 
