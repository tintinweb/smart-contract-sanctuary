...
/*
Each time this is deployed ensure that this line (around 242) is updated to the URI of the Collection
...
//    function mintItem(address player, string memory tokenURI)
    function mintItem(address player, string memory tokenURI, uint256 tokenNumber)
        public
        onlyOwner
        returns (uint256)
    {
