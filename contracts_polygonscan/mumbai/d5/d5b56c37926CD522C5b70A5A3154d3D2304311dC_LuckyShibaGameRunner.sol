...
contract LuckyShibaGameRunner is Ownable { 
    ...
    function addPeopleToRandomizeFigureList(string memory period, address[] memory toList) public onlyOwner {
        ...
        _3peopleToRandomizeFigureMapping[period] = ThreePeopleToRandomizeFigureModel(address(0x0), 0, address(0x0), 0, address(0x0), 0);
    }
    ...
    function generateRandomFigure(string memory period /*, uint256 number*/) public returns (uint256) {
        bool _found = false; 
