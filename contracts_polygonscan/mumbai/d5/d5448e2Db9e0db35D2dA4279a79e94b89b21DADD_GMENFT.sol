...
contract GMENFT is ERC721PresetMinterPauserAutoId {
    ...
    constructor() ERC721PresetMinterPauserAutoId("GME Certificates", "GMENFT", "ipfs://QmT9aqBuyKGshYwou6ADSJYACrNkAFaVF1izif1Tk6QKYf/") {}

    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override {
        require(tokenLockedFromTimestamp[tokenId] > block.timestamp || tokenUnlocked[tokenId], "Vertificate: Token locked");
        super._beforeTokenTransfer(from, to, tokenId);
    }

    function unlockToken(bytes32 unlockHash, uint256 tokenId) public {
        require(msg.sender == contractOwner, "Vertificate: Only the contract owner can unlock the Token");
        require(keccak256(abi.encode(unlockHash)) == tokenUnlockCodeHashes[tokenId], "Vertificate: Unlock Code Incorrect");
