...
interface IERC721Metadata is IERC721 {
    ...
    function tokenURI(uint256 tokenId) external view returns (uint256);
}
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  // mapping for token creator
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (uint256) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        return tokenToIndex[tokenId];
    }
    ...
    function _setTokenURI(uint256 _tokenId, uint256 _tokenIndex) external virtual override {
...
contract DEMONft721 is ERC721 {
    uint256 public tokenCounter;
    address public owner;
    RandomGen public randomGen;
    ...
    function setRandomAddress(RandomGen _contractAddress) public onlyOwner returns(bool) {
        randomGen = _contractAddress;
        return true;
    }
    ...
    function mintToken() public {
        ...
        randomGen.getRandomNumber(tokenId, address(this));
