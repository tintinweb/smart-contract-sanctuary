...
contract DelightMadness is Ownable, ReentrancyGuard, IERC721Receiver, ERC721Holder {
    ...
    uint256 minDelightForSwapNFT = 1 * (10 ** 18);

    uint256 public lastNFTAssigned;

    // NFT
    IERC721Enumerable public theEndlessNFTAddress = IERC721Enumerable(0x3dC94Abe36E36FCb85F324d0f95285F7B0d10AFF); 
    ...
    function swapDelightForDelirium() external nonReentrant {
        ...
        if (balanceOfNFT > 0) {
            if (swapAmount >= minDelightForSwapNFT) {
                if (theEndlessNFTAddress.balanceOf(msg.sender) == 0) {
...
contract DelightToken is ERC20('DELIGHT PRESALE', 'DELIGHT'), ReentrancyGuard, Ownable {
    ...
    address public constant PRESALE_ADDRESS = 0x6D9518bd44fce1ee2EF8d7E3090fBA60304A4ceA;
    address public constant BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor(uint256 _startBlock, uint256 _endBlock) {
        ...
        _mint(address(0x6D9518bd44fce1ee2EF8d7E3090fBA60304A4ceA), 100 * (10 ** 18));
