...
contract DelightVipAccessPresale is Ownable, ReentrancyGuard {
    ...
    address public constant FEE_ADDRESS = 0xFbd37BfD354611b809054CBA049AAa7CC5fD364b;
    ...
    //SETUP
    uint256 public delightVipPresaleSize = 48 * (10 ** 3) * (10 ** 18); // 48,000 delight for l1
