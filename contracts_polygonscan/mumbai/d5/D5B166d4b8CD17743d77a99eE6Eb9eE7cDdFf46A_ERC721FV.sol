...
contract ERC721FV is ERC721Tradable {
    ...
    */
    ...
    bool public isProxyRegistryAddressSettled;
    bool public checkLocalProxy;
    ...
    * @dev Change it until it works properly
    * @dev Then set to immutable
    */
    function setProxyRegistryAddress(address _newAddr) external onlyOwner {
        require(!isProxyRegistryAddressSettled, "proxyAddress cannot be modified anymore");
        proxyRegistryAddress = _newAddr;
    }

    function setCheckLocalProxy(bool _newVal) external onlyOwner {
        require(!isProxyRegistryAddressSettled, "checkLocalProxy cannot be modified anymore");
        checkLocalProxy = _newVal;
    }

    function settleProxyRegistryAddress() external onlyOwner {
        isProxyRegistryAddressSettled = true;
    }    
    ...
    */
    ...
    function isApprovedForAll(address _owner, address _operator)
        ...
        returns (bool)
    {
        if (checkLocalProxy && _operator == proxyRegistryAddress) {
