...
contract FirstBuy is Ownable, ReentrancyGuard {
    ...
    function firstBuy(
        ...
        //Buy YGN with amount allocated and with any residue left.

        uint256 totalSecondaryTokenAmount = secondaryToken.balanceOf(address(this)).add(
            _secondaryTokenAmountToBuyYGN
        );
