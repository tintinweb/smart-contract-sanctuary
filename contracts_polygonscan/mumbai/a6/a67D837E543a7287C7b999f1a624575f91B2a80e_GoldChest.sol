...
/// @title GoldChest Operator
/// @notice This Operator handles opening and creating of cards for Gold Chest Token.
contract GoldChest is Chest {

    /// @notice Gold Chest Operator has multiple parameters while deployment
    /// @dev
    /// @param _name Name of chest operator
    /// @param _version Version of the operator
    /// @param _goldChestToken Contract Address of the Gold Chest Token mapped in the network
