 ...
 */
 ...
 contract CS is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("CryptoShopping", "CS") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x76ea19a935E0005ADce27F9907CC4786AD14A9D5); 
          _setupRole(MINTER_ROLE, 0x76ea19a935E0005ADce27F9907CC4786AD14A9D5); 
          _setupRole(MINTER_ADMIN_ROLE, 0x76ea19a935E0005ADce27F9907CC4786AD14A9D5); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x76ea19a935E0005ADce27F9907CC4786AD14A9D5);  
     }
     ...
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "CS/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
