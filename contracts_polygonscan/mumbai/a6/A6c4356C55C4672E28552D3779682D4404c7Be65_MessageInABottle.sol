...
contract MessageInABottle is Ownable, ERC721URIStorage, FxBaseChildTunnel {
    ...
    constructor(address _fxChild, string memory _initURIPrefix)
    ERC721("Messages In A Bottle", "MIAB")
    Ownable()
    ...
    function _processMessageFromRoot(
        ...
        bytes memory uri = data.slice(20, data.length-20);
        string memory uri2 = string(uri);
        console.log("uri: ", uri2);
        
        _mint(to, nextTokenId);
        _setTokenURI(nextTokenId, uri2);
        _incrementTokenId();
    }
