...
// File: contracts/polygon/contract.sol




contract ClownTrades is ERC721Enumerable, ReentrancyGuard, Ownable {

    uint256 public _currentTokenId = 1;
    uint256 public costToMint = 100000000000000000;
    uint256 public supply = 1001;

    function tokenURI(uint256 tokenId) override public pure returns (string memory) {
        return string(abi.encodePacked("https://clowntrades01.s3.us-east-2.amazonaws.com/meta/", Strings.toString((tokenId)), '.json'));
    }
    ...
    constructor() ERC721("ClownTrades", "ClownTrades") Ownable() {
