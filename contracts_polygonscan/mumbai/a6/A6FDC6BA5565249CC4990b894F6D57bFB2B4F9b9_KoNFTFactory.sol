...
// File: Ko-blockchain/KoNFTFactory.sol


pragma solidity 0.8.4;


contract KoNFTFactory is ContextMixin, NativeMetaTransaction {
  ...
  function deployERC721(string memory _token, string memory _trigram) external returns (ChildMintableERC721) {
    ChildMintableERC721 childMintableERC721 = new ChildMintableERC721(_token, _trigram, CHILD_CHAIN_MANAGER_PROXY_POLYGON);
    // childMintableERC721.grantRole(childMintableERC721.DEFAULT_ADMIN_ROLE(), ContextMixin.msgSender());

    return childMintableERC721;
   }
}