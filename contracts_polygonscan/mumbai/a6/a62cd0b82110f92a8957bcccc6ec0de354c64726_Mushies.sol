...
contract Mushies is ERC721Enumerable, Ownable, ContextMixin, NativeMetaTransaction {
  ...
  {
    return gaslessTransactions ? ContextMixin.msgSender() : msg.sender;
  }

  function isApprovedForAll(address _owner, address _operator) public override view returns (bool isOperator) {
    // if OpenSea's ERC721 Proxy Address is detected, auto-return true
    //0x58807baD0B376efc12F5AD86aAc70E78ed67deaE
    if (gaslessTransactions && _operator == address(0xff7Ca10aF37178BdD056628eF42fD7F799fAc77c)) {
        return true;
    }
  ...
  function toggleGaslessTransactions() public onlyOwner {
