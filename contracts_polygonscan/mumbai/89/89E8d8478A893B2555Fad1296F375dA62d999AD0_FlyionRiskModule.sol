...
contract FlyionRiskModule is RiskModule, ChainlinkClientUpgradeable {
  ...
  event ChainlinkFulfilled(uint256 indexed policyId, bytes32 queryId, int256 actualArrivalDate);
    ...
    recordChainlinkFulfillment(queryId)
  {
    ...
    emit ChainlinkFulfilled(policy.policyId, queryId, actualArrivalDate);
