...
contract PENT is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        require(vault != address(0) && rewardsPool != address(0), "FUTUR & REWARD ADDRESS CANNOT BE ZERO");
    ...
    function _createNodeWithTokens(string memory name, uint256 _type, bool isFusion) private {
		...
		require(sender != vault && sender != rewardsPool, "NODE CREATION: futur and rewardsPool cannot create node");
