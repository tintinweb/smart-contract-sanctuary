...
contract TDR is ERC721, ERC721Enumerable, Ownable {
    ...
    address public current_owner;
    bytes32 public merkleRoot = 0xace10a69caaa81e17766c1113be992a546b8762d90c866a270be5b1453ae2386;
    constructor() ERC721("The Donuts Republic", "TDR") {
        current_owner = msg.sender;
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmSXKWrvTwfnkwn5vnKGFRfVDvv64rAPHW6ge1P3AF7JQN/";
    }
    ...
    function mint( uint256 _mintAmount) public payable {
        ...
        require(msg.value >= cost * _mintAmount, "Amount of Ether sent too small");
    ...
    function presaleMint( uint256 _mintAmount,bytes32[] memory _proof) public payable {
        uint256 supply = totalSupply();
        require(!paused);
        require(_mintAmount > 0);
        require(_mintAmount <= maxMintAmount);
    ...
    function transferContractOwnership (address newOwner) public onlyOwner {
        require(current_owner == msg.sender,"You are not allowed!");
   ...
   function withdrawAllMoney(address payable _to) public {
        require(current_owner == msg.sender, "You cannot withdraw.");
