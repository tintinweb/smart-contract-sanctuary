...
contract ProofOfX is AccessControl, ERC2771Context {
    ...
    modifier onlyPoXAdmin() {
        require(
            ...
            "ProofOfX: Only PoX admin can call this function"
        );
        _;
    }
    ...
    modifier onlyTrustedForwarder() {
        require(
            ...
            "ProofOfX: Only relayer can call this function"
        );
        _;
    }
    ...
    function setNFTAddress(address _nftAddress) public onlyPoXAdmin {
        require(
            ...
            "ProofOfX: NFT address should be a valid address"
        );
     ...
     * Reverts if the caller is not an PoXAdmin
    ...
    function mintNFT(
        ...
        require(
            ...
            "ProofOfX: Only CREATOR can call this function with valid signature"
        );
    ...
    function transferNFT(
        ...
        require(
            ...
            "ProofOfX: Only OPERATOR can call this function with valid signature"
        );
    ...
    function setApprovalForToken(
        ...
        require(
            hasRole(CREATOR, account) && (account == _msgSender()),
            "ProofOfX: Only CREATOR can call this function with valid signature"
        );
