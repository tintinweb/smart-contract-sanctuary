...
contract PolyLord is ERC1155PresetMinterPauser {
    ...
    function addPlotID(uint32 _amount) public virtual payable {
        
        // Prevent 32 bit overflow, limit land plots to 2147483646
        
        require(msg.value >= 10**18 * _amount, "Not enough ETH sent; check price!"); 
        
        if (plotIDCounter + _amount <= 2147483646){
