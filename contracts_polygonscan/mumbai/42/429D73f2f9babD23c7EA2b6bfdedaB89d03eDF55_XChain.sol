...
/**
 * This is the ERC1155 for XChain.Tech NFTs (ID:0) and future uses
...
contract XChain is ERC1155 {
    ...
    constructor() ERC1155("https://xchain.tech/NFT/XChain.json") {}
...
//        require(_msgSender() == 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, "XChain: Only the foundation can unlock an address.");
...
//        require(_msgSender() == 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4 || isApprovedForAll(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, _msgSender()), "XChain: Only approved accounts can mint new tokens.");
