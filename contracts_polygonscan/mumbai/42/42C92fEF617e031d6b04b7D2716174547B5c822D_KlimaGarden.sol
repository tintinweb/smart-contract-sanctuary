...
contract KlimaGarden is ERC721URIStorage, VRFConsumerBase {
    ...
    function numCreatedByPlotType() public view returns (uint16, uint16, uint16, uint16) {
        return (
            _numCreatedByPlotType[PLOT_TYPE_COMMON],
            _numCreatedByPlotType[PLOT_TYPE_RARE],
            _numCreatedByPlotType[PLOT_TYPE_ULTRA_RARE],
            _numCreatedByPlotType[PLOT_TYPE_ONE_OF_A_KIND]
        );
    }
