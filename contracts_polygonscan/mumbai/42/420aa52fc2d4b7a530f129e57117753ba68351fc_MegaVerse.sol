...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18e788556F74a3eF7E062a1Fa343779c127E4630;
...
contract MegaVerse is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x18e788556F74a3eF7E062a1Fa343779c127E4630;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MegaVerse";
    string private _symbol = "MEGAV";
