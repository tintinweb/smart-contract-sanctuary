...
contract BoleroNFT is ERC721Enumerable, RoyaltiesWrapper {
    ...
    event NewCollection(uint256 collectionID, address artist, string name, uint256 royalties);
	...
	*******************************************************************************/
    function newCollection(address artistAddress, address collectionPaymentAddress, string memory collectionName, uint256 artistRoyalty) public {
        ...
        emit NewCollection(newCollectionIds, artistAddress, collectionName, artistRoyalty);
    }
