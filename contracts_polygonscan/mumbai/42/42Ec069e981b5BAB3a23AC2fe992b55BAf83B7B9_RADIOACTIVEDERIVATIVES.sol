...
These punks survived to make derivative art!
...
contract RADIOACTIVEDERIVATIVES is ERC1155PresetMinterPauser, ERC2981, Ownable, ContextMixin {
   ...
   */
  function airdrop (
    address[] memory receivers, string memory metadataURL, uint256 tokenId
  ) external onlyOwner {
 ...
 function uri(uint256 id) public view virtual override returns (string memory) {
   ...
   *      Allows for gassless transfers, etc.
   */
