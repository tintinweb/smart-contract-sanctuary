...
contract PrivateSaleVesting is ReentrancyGuard,Ownable {
    ...
    uint256 public unlockPeriod = 15;
    ...
    function _availableClaimableAmount(address _beneficiary) internal view returns (uint256 _amount) {
        ...
        // Vesting completed 
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(10)).div(100);
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(20)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(30)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(40)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(50)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(60)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(70)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(80)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(90)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
