    ...
    ContextMixin
{
    ...
    constructor()    
    public ERC20("memoryOS", "MIND") {
        _setupContractId("memoryOSChildMintableERC20");
        //_setupDecimals(decimals_);
        _setupDecimals(18);
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        //_setupRole(DEPOSITOR_ROLE, childChainManager);
        _setupRole(DEPOSITOR_ROLE, 0x0994b73C68ABcE09638514CEBC8977117bAa37eb);
        //_initializeEIP712(name_);
        _initializeEIP712("memoryOS");
    }
