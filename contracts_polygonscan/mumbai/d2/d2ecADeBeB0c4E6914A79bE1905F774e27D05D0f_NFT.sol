...
contract NFT is Ownable, ERC721, ERC721URIStorage, ContextMixin, NativeMetaTransaction {
    ...
    string public ipfs = 'https://ipfs.io/ipfs/bafkreif6apugeeo2ymnrspwnb75sbjejxzb5qnqtnegkcfgvoh7sr7ggzy';
    string public ercName = "DZV2D7";
    string public ercSymbol = "DZV2D7";
    ...
    function mint(address to, uint256 numberOfTokens) external onlyOwner {
        uint256 tempItem = tokenCounter.add(numberOfTokens);

        require(to != address(0), "Mint to the zero address");
        require(tempItem <= totalSupply, 'Exceeds max supply');
