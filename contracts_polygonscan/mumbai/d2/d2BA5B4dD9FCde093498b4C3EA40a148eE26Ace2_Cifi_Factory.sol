...
contract Cifi_Factory is Governance {
    using SafeMath for uint256;
    mapping(address => bool) public _minters;
    Cifi_Token _cifi = Cifi_Token(0);

    constructor(address cifi) {
        _cifi = Cifi_Token(cifi);
    }

    modifier onlyMinter() {
        require(_minters[msg.sender], "Cifi_Factory: !minter");
        _;
    }
