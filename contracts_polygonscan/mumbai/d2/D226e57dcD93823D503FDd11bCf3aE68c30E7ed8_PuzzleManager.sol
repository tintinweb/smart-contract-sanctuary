...
contract PuzzleManager is VRFConsumerBase, Pausable, Ownable {
    ...
    constructor(
        ...
        packContents[PackTier.GOLD] = 50;

        packPrices[PackTier.BRONZE] = 1 ether; // this will actually be used in DAI so 1 ether = 1 DAI
        packPrices[PackTier.SILVER] = 1.5 ether;
        packPrices[PackTier.GOLD] = 2.9 ether;
