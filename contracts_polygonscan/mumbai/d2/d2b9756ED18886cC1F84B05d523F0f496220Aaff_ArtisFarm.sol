...
contract ArtisFarm is IERC777Recipient {
    ...
    */
    ...
    function calculateYieldTotal(address user) public view returns(uint256) {
        ...
        uint256 rate = 600; //24 hour release all rewards
        uint256 timeRate = time / rate;
        uint256 poolShare = (totalLPTokensLocked * 10 ** 18 ) / ( stakingBalance[user] * 10 ** 18 );
        uint256 rawYield = ((totalARTISRewards * timeRate) / 10 ** 18) / poolShare;
        return rawYield;
    } 
    ...
    function withdrawYield() public {
        ...
        startTime[msg.sender] = block.timestamp;
        artisToken.send(msg.sender, toTransfer, "");
