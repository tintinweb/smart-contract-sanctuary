...
contract TamiGAWDtchi is TrustedForwarderRecipient {
    ...
    uint16 private constant _BLOCKS_PER_TICK = 432; // ~GAWDS die after 1 day of non-interaction: ((60 seconds / 2 blocks per second) * 60 * 24) / 100
    ...
    function worship(uint16 gawd) public isTrueGawd(gawd) {
        ...
        addPrayer(msg.sender, 1, "worship");
    }
    ...
    function sacrifice(uint16 gawd) public isTrueGawd(gawd) {
        ...
        // require(getSacrifice() > 0, "i dont wanna play");
        ...
        addPrayer(msg.sender, 1, "sacrifice");
    }
