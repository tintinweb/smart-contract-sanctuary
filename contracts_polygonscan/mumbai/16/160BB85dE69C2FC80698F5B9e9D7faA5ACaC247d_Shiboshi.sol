 ...
 */
contract Shiboshi is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("Shiboshi", "SHIBOSHI") {
        MAX_DOGE_SUPPLY = 10000;
        REVEAL_TIMESTAMP = block.timestamp + (86400 * 7);
        mintPrice = 69000000000000000; // 0.069 ETH
        maxToMint = 10000;
        saleIsActive = false;
        wallet1 = 0xd30c23d19187B2f24b6bC7dD41AB2d6C8bC3Db56;
        wallet2 = 0x626103C5333673da4f7F4289bEbbA9cF9993d7f6;
    }
