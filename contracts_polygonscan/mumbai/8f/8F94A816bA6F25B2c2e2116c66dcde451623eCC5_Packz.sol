...
contract ERC20PaymentSplitter is Context {
     ...
     */
    constructor(address erc20Address, address[] memory payees, uint256[] memory shares_) {
    ...
    function release(address payable account) public virtual {
        ...
        uint256 totalReceived = _erc20.balanceOf(address(this)) + _totalReleased;
...
contract Packz is ERC721, ERC721Enumerable, Ownable, ERC20PaymentSplitter, ContextMixin {
  ...
  constructor(
    ...
    ERC20PaymentSplitter(wethAddress, payees, shares)
  ...
  function mint(uint256 amount) public {
    ...
    require(
      _weth.allowance(_msgSender(), address(this)) >= MINT_PRICE * amount,
      "Not enough WETH allowance"
    );

    _mintAmount(amount, _msgSender());

    _weth.transferFrom(_msgSender(), address(this), MINT_PRICE * amount);
  }
  ...
  function open(uint256 tokenId) public {
    ...
    _traitz.mint(TRAITZ_PER_PACK, _msgSender());
    _burn(tokenId);
  }
  ...
  function openMultiple(uint256[] calldata tokenIds) public {
    ...
    _traitz.mint(TRAITZ_PER_PACK * tokenIds.length, _msgSender());
