...
contract PetPack is ERC721Enumerable, Ownable {
    ...
    constructor(    string memory _name,
        ...
        developers["SCLLC"]    = address(0xdddab3c6F82219b59Ed0e774EC3C308acBc08C13);
        developers["SAM"]       = address(0xE78E1ee4142632DB2053E1e9991f7FbB2C77B495);
        developers["ALLISON"]   = address(0x3d7FFeD4CA39EDC6198D45ceC1F27759264cF6e7);
    }
    ...
    function withdraw() public payable onlyOwner {
        ...
        require(payable(developers["SCLLC"]).send(_20));
        require(payable(developers["SAM"]).send(_30));
        require(payable(developers["ALLISON"]).send(_50));
    ...
    function reveal(bool status) public onlyOwner { revealed = status; }
