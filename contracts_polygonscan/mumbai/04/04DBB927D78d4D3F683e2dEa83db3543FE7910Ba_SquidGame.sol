    ...
    KeeperCompatibleInterface
{
    ...
    function attackBoss(uint256 tokenId) private {
        ...
        )
    {
        ...
        bytes32 requestIdX = requestRandomness(keyHash, chainlinkFee);
        requestIdToTokenId[requestIdX] = tokenId;
    }
        ...
        override
    {
        ...
        uint256 attackDamageToBoss = (randomness % player.attackDamage) + 1;
