...
contract BlackSpringNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721 ("Black Spring Test", "TEST") {
        console.log("This is my NFT contract. Whoa!");
    }

    function recordMartyr(string memory arhash) onlyOwner public {
        uint256 newItemId = _tokenIds.current();

        //string memory finalTokenUri = _prepareTokenURI(name, description, arhash, attributes);
        string memory finalTokenUri = string(abi.encodePacked("ar://",arhash));
