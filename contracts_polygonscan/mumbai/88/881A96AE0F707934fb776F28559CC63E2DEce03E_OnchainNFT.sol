...
contract OnchainNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function onchainMint(address mintTo) public nonReentrant returns(uint tokenId) {
    ...
    constructor() ERC721("OnchainNFT", "ONCHAINNFT") Ownable() {}
}
