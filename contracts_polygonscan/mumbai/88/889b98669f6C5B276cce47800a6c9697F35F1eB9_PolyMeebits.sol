...
contract PolyMeebits is IERC721 {
    ...
    uint public nftPrice = 10000000000000000;
    ...
    function mint() external payable reentrancyGuard returns (uint) {
        ...
        uint developerA1Trx = (ownerTrx*nftPrice) *40 / 100 ;
        uint firstTrx = (ownerTrx * nftPrice) *60 / 100 ;
        ...
        developerA1.transfer(developerA1Trx);
        firstOwner.transfer(firstTrx);
        checkNftPrice();
