...
contract StakingPool is IStakingPool, PermissionGroup {
    ...
    uint[10] public expValue = [0, 2080, 15474, 83592, 330918, 965034, 2334044, 5289635, 10577966, 18405989];
    uint[10] public earnExpToUps = [100, 516, 3194, 14093, 43772, 94502, 204022, 440470, 652003, 965124];
    uint[10] public expFactor = [120, 120, 116, 112, 108, 108, 108, 104, 104, 104];
    ...
    /**
     * @dev Owner set expValue value
     */
    function setExpValues(uint[10] memory expValues) external onlyOwner {
        expValue = expValues;
    }
    
    /**
     * @dev Owner set earnExpToUps value
     */
    function setExpEarnToUp(uint[10] memory expEarnToUp) external onlyOwner {
        earnExpToUps = expEarnToUp;
    }
