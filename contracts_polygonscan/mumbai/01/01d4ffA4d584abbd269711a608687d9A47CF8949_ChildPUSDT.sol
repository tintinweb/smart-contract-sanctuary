...
import {ChildMintableERC20} from "@maticnetwork/pos-portal/contracts/child/ChildToken/ChildMintableERC20.sol";

contract ChildPUSDT is ChildMintableERC20 {
    constructor(address childChainManager) public ChildMintableERC20('ChildPUSDT', 'pUSDT', 18, childChainManager) {}
}
