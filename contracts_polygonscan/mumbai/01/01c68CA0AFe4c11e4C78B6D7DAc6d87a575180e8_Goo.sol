...
contract Goo is Ownable, Pausable, IGoo, ERC721Holder {
    ...
    function mint(uint256 buddy, uint256 amount) external override onlyBuddyCore whenNotPaused {
        require(
    ...
    function burn(uint256 buddy, uint256 amount) external override onlyBuddyCore whenNotPaused {
