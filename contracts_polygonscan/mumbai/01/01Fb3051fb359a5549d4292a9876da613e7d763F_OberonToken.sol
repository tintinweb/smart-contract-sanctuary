...
contract OberonToken is Context, ERC20, Ownable {
    ...
    // Address that include in oberon LP list
    mapping(address => bool) private _includeInOberonLpList;
    ...
    string private _name = "Oberon";
    string private _symbol = "OBERON";
    ...
    // Minimum OBERON sell order to trigger buyback
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xcb9531Cd8e7Df67f56D9591205Fbc61193D367C5);
        ...
        _includeInOberonLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInOberonLpList(address _address) public view returns (bool) {
        return _includeInOberonLpList[_address];
    }

    function setIncludeInOberonLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInOberonLpList[_address] = _isIncludedOrNot;
    }
    ...
    function _transfer(
        ...
        && from != owner()
            ...
            if (isIncludedInOberonLpList(to)) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= MIN_TX_AMOUNT_HARD_CAP, "maxTxAmount have to be greater than 1 oberon");
