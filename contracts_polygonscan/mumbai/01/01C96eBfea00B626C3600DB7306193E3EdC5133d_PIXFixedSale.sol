...
contract PIXFixedSale is PIXBaseSale, EIP712Upgradeable {
    ...
    bytes32 private constant BID_MESSAGE =
        keccak256("BidMessage(address bidder,address nftToken,uint256 tokenId,uint256 nonce)");
    ...
    function sellNFTWithSignature(
        ...
        bytes32 structHash = keccak256(abi.encode(BID_MESSAGE, buyer, nftToken, tokenId, nonce));
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.0-rc.1 (token/ERC20/extensions/ERC20Burnable.sol)
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.0-rc.1 (token/ERC20/utils/SafeERC20.sol)
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.0-rc.1 (utils/cryptography/draft-EIP712.sol)
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.0-rc.1 (utils/cryptography/ECDSA.sol)
