...
contract NFT is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function _hash(address _address, string memory id, bytes32 salt) internal view returns (bytes32) {
