...
contract Naffiti1155Market is ERC1155Holder {
    ...
    modifier isAuctionNotStartedByOwner(
        ...
        if (
            ...
            _resetAuction(_nftContractAddress, _tokenId, _listId);
        }
        _;
    }
    ...
    function createSale(
        ...
        _createNewNftAuctionSetting(
            ...
            _tokenId,
            _quantity,
            999999999, // hard-coded, useless
            10000 // hard-coded, useless
        );
        _setupSale(
            _nftContractAddress,
            _tokenId,
    ...
    function withdrawAuction(
        ...
        _resetAuction(_nftContractAddress, _tokenId, _selectId);
    ...
    function withdrawBid(
        ...
        uint256 _tokenId,
        uint256 _selectId
    ) external minimumBidNotMade(_nftContractAddress, _tokenId, _selectId) {
        address nftHighestBidder = nftContractAuctions[_nftContractAddress][
            _tokenId
        ][_selectId].nftHighestBidder;
        require(msg.sender == nftHighestBidder, "Cannot withdraw funds");

        uint128 nftHighestBid = nftContractAuctions[_nftContractAddress][
            _tokenId
        ][_selectId].nftHighestBid;
        _resetBids(_nftContractAddress, _tokenId);
