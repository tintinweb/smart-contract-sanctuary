...
contract EmojiDAO is Context, Ownable, ERC20 {
    ...
    */
    ...
    constructor() Ownable() ERC20("Emoji", "EMOJI") {
    ...
    function daoMint(uint256 amountDisplayValue) external onlyOwner {
        require(amountDisplayValue <= cap, "EmojiDAO cap will be exceeded.");
        require(totalSupply() + amountDisplayValue <= cap, "EmojiDAO cap will be exceeded.");
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, EmojiPerTokenId);
    }
    ...
    function daoSetEmojiPerTokenId(uint256 emojiDisplayValue)
        public
        onlyOwner
    {
        EmojiPerTokenId = emojiDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndEmojiPerTokenID(
        uint256 season_,
        uint256 emojiDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetEmojiPerTokenId(emojiDisplayValue);
    }
}