...
contract Consts {
    ...
    string public constant TOKEN_NAME = "LLOMATIC";
    string public constant TOKEN_SYMBOL = "LLO";
    ...
    
{
    ...
    function init() private {
        ...
        address[1] memory addresses = [address(0x186915891222add6e2108061a554a1f400a25cbd)];
