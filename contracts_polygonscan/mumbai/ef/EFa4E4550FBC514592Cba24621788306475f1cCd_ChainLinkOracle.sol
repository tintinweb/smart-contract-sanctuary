...
contract ChainLinkOracle is ChainlinkClient {
     ...
     */
    function requestValueData() public returns (bytes32 requestId) 
    {
        Chainlink.Request memory request = buildChainlinkRequest(jobId, address(this), this.fulfill.selector);
        
        // Set the URL to perform the GET request on
        request.add("get", "https://alphacorpnft.s3.eu-west-3.amazonaws.com/metadata/1.json");
        ...
        //   }
        //  }
        request.add("path", "attributes.0.value");
