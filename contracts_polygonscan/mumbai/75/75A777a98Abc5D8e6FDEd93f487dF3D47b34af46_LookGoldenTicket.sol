...
/**
 * @title Look Golden Ticket
 * @dev Issues ERC-721 tokens as well as being able to hold child 1155 tokens
 */
contract LookGoldenTicket is DigitalaxERC721("LOOK Golden Ticket", "LGT"), ERC1155Receiver, IERC998ERC1155TopDown, BaseChildTunnel, BaseRelayRecipient, Initializable {
