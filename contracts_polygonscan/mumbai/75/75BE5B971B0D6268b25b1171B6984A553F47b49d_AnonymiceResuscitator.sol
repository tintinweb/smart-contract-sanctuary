...
//    address anonymiceContract = 0xbad6186E92002E312078b5a1dAfd5ddf63d3f731;
    address anonymiceContract = 0x527Cb637B80329B544842e59EF43b9Ed509E538d;
...
*/
    ...
    returns (string memory)
    {
        ...
        for (uint8 i = 0; i < 9; i++) {
            ...
            OriginalAnonymiceInterface.Trait memory trait = originalMiceCollection.traitTypes(i, thisTraitIndex);
            if (i == 0) {
                    ...
                    bytes(
                        string(
                            abi.encodePacked(
                                ...
                                '", "description": "Anonymice Burned is a collection of 6,450 burned mices from the Anonymice collection. As the original collection, metadata and images are generated and stored 100% on-chain. No IPFS, no API. Just the Ethereum blockchain. An a group of resuscitated mices", "image": "data:image/svg+xml;base64,',
                                AnonymiceLibrary.encode(
...
|     | \      / |  |  ||     ||  .  \    |  |   |     ||  |  \     | |  |   |  ||     ||  |  |\    |
 \___/   \_/\_/  |__|__||_____||__|\_|    |__|    \__,_||__|__|\____| |__|  |____|\___/ |__|__| \___|
    ...
    */
    ...
    function loadMoreOriginalMices(uint256 _howMany) public onlyOwner {
...
interface OriginalAnonymiceInterface {
    ...
    function traitTypes(uint a, uint b) external view returns (Trait memory);
}
