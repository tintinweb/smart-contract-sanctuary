...
contract HeroBorn is ERC721HeroCallerBase, ERC20TokenCallerBase, Ownable {

    using Integers for uint256;

    uint256 private _baseDNA = 111011127434030112131410101010203041122334402020203040514263646060603040506;
    uint256 private _bornTokenPrice;

    constructor() {
        _bornTokenPrice = 0.01 ether;
    }

    function bornHero() public payable heroReady token20Ready {
        _bornHeroTo(msg.sender);
    }

    function bornHeroTo(address to) public payable heroReady token20Ready {
        _bornHeroTo(to);
    }

    function _bornHeroTo(address to) internal heroReady token20Ready {
