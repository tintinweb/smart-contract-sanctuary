...
* @dev This is the Axia Protocol Development contract, 
...
//======================================ACTION CALLS=========================================//	
    ...
    function scaledToken (uint amountToEmit) external onlyAxiaToken returns(bool){
        ...
        amountToEmitAdmin = amountToEmit;
        
    }
    
    function distribute(uint amount) public onlyCreator returns(bool){
        
      require(IERC20(Axiatoken).transfer(admin, amount), "Transaction failed");
