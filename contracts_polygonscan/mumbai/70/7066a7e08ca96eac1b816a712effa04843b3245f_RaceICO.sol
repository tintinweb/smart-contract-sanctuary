...
contract RaceICO is Ownable {
    ...
    //seedAddr
      ...
      //public sale
      IERC20(RACEADDR).transferFrom(address(this),_msgSender(),10000000e18);
    //marketingAddr
      marketingStartRewardTime=(block.timestamp);
      //developmentAddr
      developmentStartRewardTime=(block.timestamp);
      IERC20(RACEADDR).transferFrom(address(this),developmentAddr,180000e18);
    ...
    function BuyRace() payable public {
        ...
        IERC20(RACEADDR).transferFrom(address(this),_msgSender(),saletoken);
    ...
    function safeGuard(address _token,uint256 amount) public onlyOwner() 
    {
        ...
        {
             IERC20(RACEADDR).transferFrom(address(this),owner(),amount);
        }
    }
