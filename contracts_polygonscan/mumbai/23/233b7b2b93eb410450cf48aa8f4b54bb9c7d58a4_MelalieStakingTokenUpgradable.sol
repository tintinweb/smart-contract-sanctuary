...
pragma solidity ^0.8.0;
// import "./MelalieStakingTokenUpgradable.sol";
// import "hardhat/console.sol";

contract MelalieDistributionPool  {

    receive() payable external {}
    // MelalieStakingTokenUpgradable public token;
    // address deployer;
    // address public withdrawRole;
    

    // constructor() {
    //     // token = new MelalieStakingTokenUpgradable();
    // }    

    // function setMelalieStakingTokenAddress(address ourAddress) public {
    ...
    // function updateWithdrawRole(address _withdrawRole) external {
    //     require(_withdrawRole != address(0), "Bad WithdrawRole address");
    //     require(msg.sender == deployer, "You're not allowed");
    //     withdrawRole = _withdrawRole;
    // }

    // function withdrawReward() public {  
    //     // console.log("amount", amount);
    //     console.log("msg.sender", msg.sender);
    //     console.log('token.rewardOf(msg.sender)',token.rewardOf(msg.sender));
    //     // console.log("address(this)",address(this));
    //     // console.log('_token.balanceOf(address(this))', _token.balanceOf(address(this)));
    //     // _token.balanceOf(address(this));
    //     // _token.transfer(recipient, amount);
    //     // _token.transferFrom(sender,recipient, amount); //(recipient,token.rewardOf(msg.sender));
     
    //     token.transfer(msg.sender, token.rewardOf(msg.sender));
    //     token.withdrawReward();
    // }
...
contract MelalieDistributionPool is Initializable {
    // IERC20Upgradeable public token;
    MelalieStakingTokenUpgradable private melToken;

    function initialize(MelalieStakingTokenUpgradable _melToken) initializer public {
        melToken = _melToken;
    }

    function withdrawReward(address recipient, uint256 _reward) public {  
        // console.log("amount", amount);
        ...
        melToken.transfer(recipient, _reward);
        // token.withdrawReward();
    }
    ...
    */
    ...
    function withdrawReward() public whenNotPaused
    {
        uint256 reward = rewards[msg.sender];
         console.log("withdrawReward", reward);
