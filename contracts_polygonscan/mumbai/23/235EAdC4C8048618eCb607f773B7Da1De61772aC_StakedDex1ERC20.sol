...
contract StakedDex1ERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20('Staked DEX1', 'sDEX1', 9) ERC20Permit() {
    ...
    /**
        @notice increases sDEX1 supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDEX1
