...
/**
 * @title DGM1 | Decentralized
 * @author Stobox Technologies Inc.
 * @dev DGM1 ERC20 Token | This contract is opt for digital securities management.
 */
 
contract DGM1Token is IERC20, Roles {
    ...
    modifier onlyWithUnfrozenFunds(address _account) {
        require(
            ...
            "DGM1: funds are frozen."
        );
        _;
    }

    /**
     * @notice DGM1Token simply implements a ERC20 token.
     */
    constructor() public Roles(msg.sender) {
        _name = "Decentralized Security Token";
        _symbol = "DGM1";
        _decimals = 0;
        _kDecimals = 18;
        _k = 10**_kDecimals;
     ...
     * @param _value DGM1g that enables or disables the whitelist.
     */
     ...
     * @param _value DGM1g that enables or disables the transactions limit.
     */
    ...
    function burn(address _account, uint256 _amount) external onlySuperAdmin {
        require(balanceOf(_account) >= _amount, "DGM1: balance too low");
    ...
    function transferFunds(
        ...
        require(balanceOf(_from) >= _amount, "DGM1: not enough tokens");
    ...
    function splitOrMerge(uint256 _x, uint256 _y) external onlySuperAdmin {
        require(_x != _y, "DGM1: _x must not be equal to _y");
        require(_x > 0, "DGM1: _x must be greater than 0");
        require(_y > 0, "DGM1: _y must be greater than 0");
    ...
    */
        ...
        returns (bool)
    {
        ...
        _approve(
            ...
            _allowances[_sender][msg.sender].sub(
                ...
                "DGM1: transfer amount exceeds allowance"
            )
        );
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[msg.sender][_spender].sub(
                ...
                "DGM1: decreased allowance below zero"
            )
        );
    ...
    function _transfer(
        ...
        require(_sender != address(0), "DGM1: transfer from the zero address");
        require(_recipient != address(0), "DGM1: transfer to the zero address");

        _beforeTokenTransfer(_sender, _recipient, _amount);

        _balances[_sender] = _balances[_sender].sub(
            _amount,
            "DGM1: transfer amount exceeds balance"
        );
    ...
    function _mint(address _account, uint256 _amount) internal virtual {
        require(_account != address(0), "DGM1: mint to the zero address");
    ...
    function _burn(address _account, uint256 _amount) internal virtual {
        require(_account != address(0), "DGM1: burn from the zero address");

        _beforeTokenTransfer(_account, address(0), _amount);

        _balances[_account] = _balances[_account].sub(
            _amount,
            "DGM1: burn amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(_owner != address(0), "DGM1: approve from the zero address");
        require(_spender != address(0), "DGM1: approve to the zero address");
    ...
    function _updateTransferLimit(address _account, uint256 _amount) private {
        ...
        _transferLimits[_account].allowedToTransfer = _transferLimits[_account]
            .allowedToTransfer
            .sub(_amount, "DGM1: transfer exceeds your transfer limit");
    }
    ...
    function _updateTransactionCountLimit(address _account) private {
        if (_isEnabledTransactionCount) {
            ...
            _transactionCountLimits[_account]
                ...
                .sub(1, "DGM1: transfer exceeds your transaction count limit");
        }
    }
}