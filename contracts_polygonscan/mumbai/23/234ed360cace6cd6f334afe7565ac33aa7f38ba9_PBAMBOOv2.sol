...
contract PBAMBOOv2 is ERC721, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;

    uint256 public MAX_TEAM_RESERVES = 100;
    uint256 public constant MAX_PRESALE_TOKENS_PER_ADDRESS = 5;
    uint256 public constant MAX_TOKENS = 10000;
    uint256 public constant MAX_MINTS_PER_TX = 100;
    uint256 public constant PRESALE_TOKEN_PRICE = 0.007 ether;
    ...
    function _checkPreMintRequirements(uint256 quantity) internal {
        ...
        require(presaleNumMinted[msg.sender] <= MAX_PRESALE_TOKENS_PER_ADDRESS, "Cannot mint more than 5 per address in this phase");
    }
