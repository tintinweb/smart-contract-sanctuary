...
library Address {
     ...
     *
     * https://eips.BTCereum.org/EIPS/eip-1884[EIP1884] increases the gas cost
...
abstract contract AccessControl is Context {
     ...
     * togBTCer with {getRoleMember} to enumerate all bearers of a role.
     */
...
contract EIP712Base is Initializable {
     ...
     * https://eips.BTCereum.org/EIPS/eip-712
...
// File: contracts/child/ChildToken/BTC.sol



contract BTC is ChildERC20 {
    constructor(address childChainManager) public ChildERC20("BTC", "BTC", 8, childChainManager) {}
}