...
contract EKKO_ACADEMY is ERC721Enumerable, Ownable {
  ...
  // public 
  function relaunchDistributeNew(address[] memory _address) public payable onlyOwner {
  ...
  // public
  function relaunchDistributeOld(address[] memory _address, uint256[] memory _tokenID) public payable onlyOwner {
