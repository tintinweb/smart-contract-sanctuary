...
contract MglobeGameERC1155 is ReentrancyGuard, Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    constructor(
        ...
        //采集器 - Harvester NFT,
        create(_msgSender(), 5, 10000, _uri, "");

        //载具 - Vehicle NFT
        create(_msgSender(), 6, 10000, _uri, "");

        //空间稳定器 - Space stabilizer NFT
        create(_msgSender(), 7, 10000, _uri, "");

        //聚能环- Shaped Ring NFT
        create(_msgSender(), 8, 10000, _uri, "");

        //防御塔 - Defense Tower NFT
        create(_msgSender(), 9, 10000, _uri, "");
    ...
    function setURI(string memory _newURI) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "MglobeGameNFTs: must have admin role to setURI");
...
/**
	 * @dev mint a Harvester NFT, set metadata json， amount must be 1
	 * emits Minted event
     * metadata: const METADATA_JSON = '{"name":"My NFT Name","description":"My NFT Name","image":"ipfs://QmWpUHUKjcYbhqGtxHnH39F5tLepfztGQAcYtsnHtWfgjD","external_url":"extURI","attributes":[{"type":"AttrT1","value":"AttrV1","display":""},{"type":"AttrT2","value":"AttrV2","display":""}],"properties":{"has_locked":true,"creator":"0x9e1bd73820a607b06086b5b5173765a61ceee7dc","royalties":0,"type":2}}'
	 */
	function mintHarvester(address to, bytes memory data, string memory externalURI, string memory metadata)
        external
        payable
        nonReentrant
    {
