...
contract BuddyCore is IBuddyCore, ERC721Full, ERC721Holder {
    ...
    function setLogicContract(address _logicContractAddr) external onlyOwner {
        ...
        _buddyRandomness.setBuddyLogicAddr(_logicContractAddr);
    }
    ...
    // TODO: Remove this at launch time
    function mint(uint256 buddy, uint256 amount) external onlyOwner {
        _goo.mint(buddy, amount);
    }

    function createGen0(address receiver, uint256 amount)
        external
        onlyOwner
        whenNotPaused
    {
    ...
    {
        BuddyLib.Buddy storage base = _data[_tokenId];
        uint256 ggpd = (_buddyLogic.calcGGPD(base, false, false)) *
            (base.special == 0 ? 90 : 1);
        return ggpd * 1e18;
    }
