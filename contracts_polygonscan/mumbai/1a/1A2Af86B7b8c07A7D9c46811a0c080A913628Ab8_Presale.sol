...
contract Presale is Ownable {
    ...
    function deposit(uint256 _amount) public {
        ...
        uint256 toClaim = _amount * tokenPrice / (10**tokenTheir.decimals());
        require(totalToClaim + toClaim <= getRemainableTokens(), "deposit: Not enough tokens in this contract");        
        ...
        totalToClaim += _amount * tokenPrice / (10**tokenOur.decimals());
    ...
    function getRemainableTokens() public view returns (uint256) {
        return getRemainingTokens() - totalToClaim;
    }
