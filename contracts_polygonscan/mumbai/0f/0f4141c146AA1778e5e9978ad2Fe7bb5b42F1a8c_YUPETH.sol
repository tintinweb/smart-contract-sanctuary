...
contract YUPETH is Initializable, ERC20PresetMinterPauserUpgradeable {
    bytes32 public constant CHILD_CHAIN_PROXY_MANAGER = keccak256("CHILD_CHAIN_PROXY_MANAGER");

    function setup (address childChainProxyManager)  public initializer {
        ERC20PresetMinterPauserUpgradeable.initialize("YUPETH", "YUPETH");
        _setupRole(CHILD_CHAIN_PROXY_MANAGER, childChainProxyManager);
    }

    function deposit(address user, bytes calldata depositData) external onlyRole(CHILD_CHAIN_PROXY_MANAGER) {
