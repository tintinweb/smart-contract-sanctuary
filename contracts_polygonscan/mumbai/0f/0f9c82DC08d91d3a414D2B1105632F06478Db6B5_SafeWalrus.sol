...
contract SafeWalrus is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Safe Walrus';
    string  private constant _SYMBOL = 'SWALRUS';
