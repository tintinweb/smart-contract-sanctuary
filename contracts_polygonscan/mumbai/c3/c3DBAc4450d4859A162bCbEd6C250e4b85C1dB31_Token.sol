...
contract Token is TokenERC20, Control, ReentrancyGuard {
	 ...
	 */
	function initializeContract(uint256 _startTime, uint256 _initialPrice, address _pair) external onlyRole(DEFAULT_ADMIN_ROLE) {
	...
	function writeData(
		...
		require(_timestamp <= block.timestamp, "Not valid timestamp");
