...
import "../interface/IKnowForwarderAddress.sol";
 ...
 */
contract Token is TokenReceivable, BaseRelayRecipient, IKnowForwarderAddress {
    /**
    ...
    /// @notice deployer: Address of deployer - used for gsn
    ...
    /**
     * @notice Return the trusted forwarder
     */
     ...
     * @param _forwarder address which would be to upgrade
     * @dev Only deployer can upgrade trusted forwarder
     */
