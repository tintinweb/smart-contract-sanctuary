...
contract Fishify is ERC721, VRFConsumerBase, Ownable {
    ...
    function setTokenExperience(uint256 tokenId, uint256 _experience) public {
        require(
            _isApprovedOrOwner(_msgSender(), tokenId),
            "ERC721: transfer caller is not owner nor approved"
        );
        ...
        characters[tokenId].experience = _experience;
