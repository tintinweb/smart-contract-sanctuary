        ...
        returns (uint256 availablePercentage)
    {
        ...
        if (currentTimeStamp > _initialTimestamp) {
            if (allocationType == AllocationType.PRIVATE) {
                ...
                uint256 initialReleasePercentage = uint256(51296296296296296).mul(1e18).div(1000000000000000);
                uint256 remainingDistroPercentage = uint256(48703703703703703).div(1000000000000000);
