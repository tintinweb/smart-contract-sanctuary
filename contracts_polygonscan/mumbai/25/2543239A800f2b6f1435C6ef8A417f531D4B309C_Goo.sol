...
contract Goo is Pausable, IGoo, ERC721Holder {
    ...
    function setBuddyCoreAddr(address buddyCoreAddr) public {
    ...
    function mint(uint256 buddy, uint256 amount) external override onlyOwner {
        require(
    ...
    function burn(uint256 buddy, uint256 amount) external override onlyOwner {
    ...
    function transferFrom(
        ...
        uint256 spenderAllowance = allowances[from][executor];
        require(
