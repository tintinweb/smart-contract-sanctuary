...
contract Goo is Ownable, Pausable, IGoo, ERC721Holder {
        ...
        whenNotPaused
    {
        ...
        require(_isApprovedOrOwner(buddy), "Need approval for burn");
    ...
    function approve(
        ...
        require(_isApprovedOrOwner(from), "Need approval to approve");
    ...
    function transfer(
        ...
        require(_isApprovedOrOwner(from), "Need approval to transfer");
    ...
    function transferFrom(
        ...
        require(_isApprovedOrOwner(executor), "Need approval to transfer");
        ...
        returns (bool)
    {
        ...
        for (uint256 i = 0; i < from.length; i++) {
            ...
            require(_isApprovedOrOwner(buddy), "Need approval to transfer");
