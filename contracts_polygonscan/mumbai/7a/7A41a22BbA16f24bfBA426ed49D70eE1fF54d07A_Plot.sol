...
contract Plot is ERC721, ERC721Enumerable, AccessControl {

    uint256 public constant MAX_SUPPLY = 256;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC721("MapGamePlot", "MGPLOT") {
    ...
    function mint(uint numberOfTokens) public onlyRole(MINTER_ROLE) {
