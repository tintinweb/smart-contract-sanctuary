...
contract PolyMeebits is IERC721 {
 ...
 function _calculateShares(uint value) internal  returns ( uint _feeBOneShare, uint _feeBTwoShare) {
      ...
      function _fraction(uint devidend, uint divisor, uint value) internal  returns(uint) {
