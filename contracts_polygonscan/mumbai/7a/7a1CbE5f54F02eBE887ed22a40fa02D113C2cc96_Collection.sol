...
contract Collection is Ownable, ReentrancyGuard {
    ...
    function buyPacksMeta(uint256 _packId, uint256 _quantity, address userAddress, bytes32 r, bytes32 s, uint8 v) external mintLock {
        require (packsInCollection[_packId], "Pack not in collection");
        ...
        */
        packsMinted += _quantity;
        nonces[userAddress]++;
        dropper.mint(userAddress, _packId, _quantity, "");
    }
