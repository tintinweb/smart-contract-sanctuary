...
contract NomoPlayersDropMechanic is Ownable, ReentrancyGuard {
    ...
    //////////////////////////////////////////////////////////
    function buyTokensOnSaleMock(uint256 quantity) public returns(uint256 res) {
        res = buyTokensMock(quantity);
    }
    function buyTokensMock(uint256 quantity) private returns(uint256) {
        uint256 tokenId;
