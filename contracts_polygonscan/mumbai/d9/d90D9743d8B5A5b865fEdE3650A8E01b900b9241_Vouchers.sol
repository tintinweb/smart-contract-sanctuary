...
contract Vouchers is ERC721Enumerable, Ownable, Pausable {
    ...
    string private externalUrl = 'http://app.metasoccer.com/club';
        ...
        returns (string memory)
    {
        ...
        string memory imageUrl = imageURLs[voucherType];
        string memory animationUrl = animationURLs[voucherType];
