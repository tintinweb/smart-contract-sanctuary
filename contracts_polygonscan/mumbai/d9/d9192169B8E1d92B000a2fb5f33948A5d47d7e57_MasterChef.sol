...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        console.log("deliriumReleaseGradient", deliriumReleaseGradient);
        console.log("useBlocknumber", useBlock);
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        console.log("==========updatePOOL() 3");

        uint256 lpSupply = pool.totalLocked;

        console.log("total", lpSupply);
        if (lpSupply == 0 || pool.allocPoint == 0) {
            pool.lastRewardBlock = block.number;
            return;
        }

        console.log("==========updatePOOL() 4");
        uint256 farmingLimitedBlock = block.number <= gradient3EndBlock ? block.number : gradient3EndBlock;

        console.log("isIncreasingGradient", isIncreasingGradient);
        console.log("deliriumReleaseGradient", deliriumReleaseGradient);
        console.log("pool.lastRewardBlock", pool.lastRewardBlock);
        console.log("endDeliriumGradientBlock", endDeliriumGradientBlock);
        console.log("endGoalDeliriumEmission", endGoalDeliriumEmission);
        console.log("farmingLimitedBlock", farmingLimitedBlock);
        ...
        console.log("farmingLimitedBlock", farmingLimitedBlock);
        console.log("deliriumRelease", deliriumRelease);
        console.log("deliriumReward", deliriumReward);

        // the end of gradient 3 is the end of delirium release
        if (deliriumReward > 0)
            console.log("MINTTTTTTTTTTTTTTTTT", deliriumReward);
    ...
    function deposit(uint256 _pid, uint256 _amount) external nonReentrant {
        ...
        console.log("===============HERE2", pool.totalLocked);
