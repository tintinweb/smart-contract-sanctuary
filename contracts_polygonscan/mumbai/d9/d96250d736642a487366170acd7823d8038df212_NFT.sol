...
contract NFT is ERC721, Ownable {
    ...
    function mintBatch(string memory _tokenURI, address _toAddress, uint _price, uint numberOfNfts)  public returns (bool) {
        require(numberOfNfts > 0, "numberOfNfts cannot be 0");
        require(numberOfNfts <= 10000, "numberOfNfts cannot be bigger");
