    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev minting for the reserved num of tokens.
     * @param _count number of tokens to be minted
     */
    function reservedMinting(address _toAddress, uint8 _count)
        external
    ...
    /**
     * @dev minting for the public num of tokens.
     * @param _count number of tokens to be minted
     */
    function publicMinting(address _toAddress, uint8 _count)
        external
        mintingValidation(_count)
        onlyRole(MINTER_ROLE)
    {
        ...
        for (uint8 i = 0; i < _count; i++) {
            _mintAnElement(address(_toAddress), address(msg.sender));
        }
    }
