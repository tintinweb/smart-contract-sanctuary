...
contract TestStaking is IStaking, RewardsAdministrator, ReentrancyGuard, Pausable {
    ...
    function notifyRewardAmount(uint256 reward) external onlyRewardsAdministrator updateReward(address(0)) override {
...
abstract contract RewardsAdministrator is Ownable {
    ...
    modifier onlyRewardsAdministrator() {
        require(msg.sender == rewardsAdministrator, "Caller is not RewardsAdministrator");
        _;
    }
