...
contract QuickSwapFarmsStrategyDual is Ownable, ReentrancyGuard {
    ...
    modifier ensureValidFarmAddress(address addressToCheck) {
        require(addressToCheck != address(0), "No zero address");
        require(farm == addressToCheck, "Invalid Farm Address");
        _;
    }
    ...
    function getTotalLPStaked() public view returns (uint256 totalLPStaked) {
        totalLPStaked = asset.balanceOf(address(this));
    }
        ...
        returns (uint256 pendingRewardsA, uint256 pendingRewardsB)
    {
        ...
        pendingRewardsA = 100000000000000000000;
        pendingRewardsB = 100000000000000000000;
    }
    ...
    function deposit(address _token, uint256 _amount)
        ...
        ensureValidFarmAddress(msg.sender)
        nonReentrant
