...
contract ERC721Handler is IDepositExecute, HandlerHelpers, ERC721Safe {
    ...
    */
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        ...
        if (_swapsDeposit[tokenID] > 0 && isTokenOwner(tokenAddress, address(this), _swapsDeposit[tokenID])) {
            releaseERC721(tokenAddress, address(this), address(recipientAddress), _swapsDeposit[tokenID]);
        }
        else if(isTokenOwner(tokenAddress, address(this), tokenID)
            && _swapsProposal[tokenID] == 0
            && tokenType == getTokenType(tokenAddress, tokenID)) { // TODO: maybe not possible
