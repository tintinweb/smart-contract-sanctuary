...
contract Dawgs2 is ERC20Burnable, Ownable {
    ...
    constructor(address _dawgsV1, uint256 _startTime) ERC20(__name, __symbol) {
...
contract Rocket is ERC20Burnable {
    uint8 private constant __decimals = 9;
    uint256 private constant __totalSupply = 200000 * 1e9; // two hundred thousand, 9 decimals
    ...
    constructor() ERC20(__name, __symbol) {
        ...
        emit Deployed(_msgSender(), __totalSupply);
    }
