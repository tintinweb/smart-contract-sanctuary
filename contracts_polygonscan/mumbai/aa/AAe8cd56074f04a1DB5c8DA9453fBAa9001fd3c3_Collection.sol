...
contract Collection is Ownable, ReentrancyGuard {
    ...
    function buyPacks(uint256 _packId, uint256 _quantity) external payable mintLock {
        ...
        if (msg.value == 0){
            ...
            if (_packId == 1) cost = 26 ether * _quantity;
            else if (_packId == 2) cost = 50 ether * _quantity;
            else if (_packId == 3) cost = 100 ether * _quantity;
            require (msg.value >= cost, "Insufficient Matic/Eth");
        }*/
        packsMinted += 1;
