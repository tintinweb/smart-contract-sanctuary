...
contract KiBridgeV10m {
  ...
  external
  {
    ...
    if(liquidityRequest.fulfilled >= liquidityRequest.amount) {
      liquidityInfo[liquidityRequest.token].fulfilledLiquidityFromChain[liquidityRequest.toChainId] += liquidityRequest.amount;
    } else {
      liquidityInfo[liquidityRequest.token].fulfilledLiquidityFromChain[liquidityRequest.toChainId] += liquidityRequest.fulfilled;
      liquidityInfo[liquidityRequest.token].peningLiquidityToChain[liquidityRequest.toChainId] = 
      liquidityInfo[liquidityRequest.token].peningLiquidityToChain[liquidityRequest.toChainId] -
      liquidityRequest.amount + liquidityRequest.fulfilled;
    }
