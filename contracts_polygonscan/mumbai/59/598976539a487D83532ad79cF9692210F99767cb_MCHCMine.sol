...
contract MCHCMine is AccessOperatable {
    ...
    function claim(Balance memory _balance, uint _chainId, uint8 v, bytes32 r, bytes32 s) external whenNotPaused {
        require(ecrecover(toEthSignedMessageHash(prepareMessage(_balance, _chainId)), v, r, s) == validator, "Mine: invalid claim signature");
    ...
    function prepareMessage(Balance memory _balance, uint _chainId) internal pure returns (bytes32) {
