...
contract ReservedPool is Ownable, ReentrancyGuard {
  ...
  uint256 public frStart = 17378750;
  ...
  constructor(IERC20 _dataGen, address _companyWallet, uint256 _deployedBlock) {
    ...
    srStart = deployedBlock.add(2555 * 12 * 3600);
  }
  ...
  function releaseDataGen() public nonReentrant {
    ...
    //   uint256 epochs = block.timestamp.sub(srStart).div(12 * 3600).add(1);
  ...
  function withdrawETH() public onlyOwner {
    require(block.number> deployedBlock.add(5555 * 12 * 3600), "Pool is still locked.");
