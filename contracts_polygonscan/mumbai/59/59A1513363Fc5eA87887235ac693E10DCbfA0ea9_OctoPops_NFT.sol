...
contract OctoPops_NFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 100 ether;
    uint256 public presaleCost = 80 ether;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount > 0, "Please enter mintAmount > 0");
        require(_mintAmount <= maxMintAmount, "You cannot mint more than 50 OctoPops");
