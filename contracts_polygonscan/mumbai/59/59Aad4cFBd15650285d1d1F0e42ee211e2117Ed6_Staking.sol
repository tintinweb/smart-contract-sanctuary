...
contract Staking is ReentrancyGuard, Context, IStaking {
    ...
    //uint256[3] public TIME_DURATIONS = [2592000, 7776000, 31104000];
    uint256[3] public TIME_DURATIONS = [300, 600, 900];
    ...
    function _withdrawTokenToBnb(
        ...
        if (token != goodToken) {
            ...
            if (isValid3 == true) {
                ...
                (uint256 amountToken2, uint256 amountETH2, uint256 liquidity) = AssetLib2.addLiquidityETH(dexRouter, goodToken, amountToken);
            ...
            path[0] = token;
            path[1] = weth;
            return AssetLib2.swapTokensDex(
                dexRouter,
                path,
                amount
            );
