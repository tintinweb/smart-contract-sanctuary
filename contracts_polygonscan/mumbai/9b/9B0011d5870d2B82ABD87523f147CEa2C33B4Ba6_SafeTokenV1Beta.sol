...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "RobeVesting.Protocol";
    ...
    ReentrancyGuard
{
    ...
    uint256 public vestingDurationInMinutes = 1 * oneMinute; // make it now
    ...
    function createVestingSchedule(
        ...
        uint256 released = 0;
        bool revoced = false;
        _isExcludedFromRewards[_beneficiary] = true;
        _isExcludedFromVesting[_beneficiary] = true;
