...
//Using the ERC721 URI Storage to fetch the data 
    ...
    return  ERC721URIStorage(nftContract).tokenURI(tokenId);
...
//Returning the data by marketoken id 
        ...
        )
    {
        ...
        return (tokenMarketData.itemId, tokenMarketData.nftContract, tokenMarketData.seller, tokenMarketData.price, tokenMarketData.sold);
    }
}
