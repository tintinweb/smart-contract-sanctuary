...
// FenixToken
contract FenixToken is ERC20('FENIX', 'FENIX'), ReentrancyGuard {

    address public constant feeAddress = 0x54Cf7E6036B70FCfF9135043f68deF7f3A94F057;

    uint256 public salePriceE35 = (16) * (10 ** 34);

    uint256 public constant fenixMaximumSupply = 200 * (10 ** 3) * (10 ** 18);

    // We use a counter to defend against people sending Fenix back
    uint256 public fenixRemaining = fenixMaximumSupply;

    uint256 public constant maxFenixPurchase = 4000 * (10 ** 18);
    ...
    function buyFenix() external payable nonReentrant {
