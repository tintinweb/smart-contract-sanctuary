...
contract BananaBar is ERC20, Ownable {
    ...
    uint256 public constant MIGRATION_REWARAD = 30 ether;
    ...
    function claimReward() external {
        ...
        uint256 _cloneRewards = cloneRewards[msg.sender];

        // Get the rewards.
        uint256 pendingOGRewards = getPendingOGReward(msg.sender);
        uint256 pendingCloneRewards = getPendingCloneRewards(msg.sender);

        // Reset the rewards.
        rewards[msg.sender] = 0;
        cloneRewards[msg.sender] = 0;

        // Reset the block.
        lastUpdate[msg.sender] = block.timestamp;
        lastUpdateClone[msg.sender] = block.timestamp;
        ...
        uint256 totalRewards = (percent * (100 - stealPercentage)) +
            monsterRewards[msg.sender];

        // Reset monster rewards.
        monsterRewards[msg.sender] = 0;
