...
contract RarioPolygonToken is RarioChildTokenV1 {

    function initialize(string memory name, string memory symbol, string memory baseURI_, address trustedForwarder, address predicateProxy) external initializer {
        ...
        __RarioChildTokenV1_init(name, symbol, baseURI_, trustedForwarder, predicateProxy);
    }
...
contract RarioChildTokenV1 is RarioNFTV1, IChildToken {
    ...
    function __RarioChildTokenV1_init(string memory name,string memory symbol, string memory baseURI_, address trustedForwarder, address predicateProxy) internal {
        __RarioNFTV1_init(name, symbol, baseURI_,trustedForwarder);
 ...
 */
abstract contract RarioNFTV1 is
    RarioUpgradeableV1,
    ...
    ERC721BurnableUpgradeable
{
    ...
    function __RarioNFTV1_init(
        ...
        __RarioNFTV1_init_unchained(name, symbol, baseTokenURI);
    }

    function __RarioNFTV1_init_unchained(
        string memory name,
        string memory,
        string memory baseTokenURI
    ) internal initializer {
    ...
    ERC2771ContextUpgradeable
{
    ...
    function __RarioUpgradeableV1_init(address trustedForwarder) internal initializer {
