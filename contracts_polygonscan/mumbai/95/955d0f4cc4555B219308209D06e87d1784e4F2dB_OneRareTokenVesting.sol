...
contract VestingDetails {
  ...
  */
    ...
    uint256 internal constant _PRIVATE1_CLIFF_PERIOD = 25 minutes;
    ...
    uint256 internal constant _PRIVATE1_NO_OF_VESTINGS = 45 minutes;
  ...
  */
    ...
    uint256 internal constant _PRIVATE2_CLIFF_PERIOD = 20 minutes;
    uint256 internal constant _PRIVATE2_VESTING_PERIOD = 1;
    // uint256 internal constant _PRIVATE2_NO_OF_VESTINGS = 270 days + 90 hours;
    uint256 internal constant _PRIVATE2_NO_OF_VESTINGS = 30 minutes;
  ...
  */
    ...
    uint256 internal constant _PUBLIC_CLIFF_PERIOD = 30 minutes;
  ...
  */
    ...
    uint256 internal constant _TEAM_CLIFF_PERIOD = 20 minutes;
    // uint256 internal constant _TEAM_VESTING_PERIOD = 30 days + 10 hours;
    uint256 internal constant _TEAM_VESTING_PERIOD = 10 minutes;
    // uint256 internal constant _TEAM_NO_OF_VESTINGS = 18;
    uint256 internal constant _TEAM_NO_OF_VESTINGS = 3;
  ...
  */
    ...
    uint256 internal constant _ECOSYSTEM_CLIFF_PERIOD = 30 minutes;
    ...
    uint256 internal constant _ECOSYSTEM_NO_OF_VESTINGS = 50 minutes;
  ...
  */
    ...
    uint256 internal constant _RESERVES_CLIFF_PERIOD = 30 minutes;
    ...
    uint256 internal constant _RESERVES_NO_OF_VESTINGS = 50 minutes;
}