...
contract BnomialNFT is ERC721, Ownable {
    ...
    function renderSVG(uint256 tokenId) public view returns (string memory svg) {
        ...
        svg = string(
            abi.encodePacked(
                'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 100 100">'
            )
        );
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        jsonData = string(abi.encodePacked(jsonData, '"image":\''));
        jsonData = string(abi.encodePacked(jsonData, renderSVG(tokenId)));
