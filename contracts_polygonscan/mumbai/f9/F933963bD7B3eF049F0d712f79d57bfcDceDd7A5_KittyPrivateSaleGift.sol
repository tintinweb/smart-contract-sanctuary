...
contract KittyPrivateSaleGift is ERC721 {
    ...
    constructor() ERC721("KittyPrivateSaleGift", "KittyPSGNFT") {}
    ...
    modifier onlyCreator() {
        require(msg.sender == invokeContractAddress,"This function can only be called by special contract"); // If it is incorrect here, it reverts.
