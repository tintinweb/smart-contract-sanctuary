...
contract CollectionChildMintableERC1155 is ERC1155, AccessControl {
    event Minted(
    ...
    /* 
    ChildMintableERC1155 requires `deposit`, `withdraw` and `mint`
    mint already exists. I'm adding deposit and withdraw    
    */
