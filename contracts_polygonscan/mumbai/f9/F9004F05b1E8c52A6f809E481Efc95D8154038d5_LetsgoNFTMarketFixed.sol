...
contract LetsgoNFTMarketFixed is ReentrancyGuard, Ownable, LetsgoNFTBase {
    ...
    function listForSale(
        ...
        if (isLetsgoNftContract == true) {
            ...
            AddreessWithPercent[] memory affiliates = LetsgoNFT(nftContract).getAffiliates(tokenId);
            this.validateCoCreatorsAffiliates(coCreators, affiliates);
        }
        ...
        nonReentrant
    {
        ...
        if (isLetsgoNftContract == true) {
            ...
            affiliates = LetsgoNFT(nftContract).getAffiliates(tokenId);
            this.validateCoCreatorsAffiliates(coCreators, affiliates);
        }
...
contract LetsgoNFT is ERC721URIStorage, Ownable, LetsgoNFTBase {
    ...
    function mintExtended(
        ...
        for (uint256 i = 0; i < affiliates.length; i++) {
            _affiliates[tokenId].push(affiliates[i]);
        }
    ...
    function getAffiliates(uint256 tokenId) external view returns (AddreessWithPercent[] memory) {
        return _affiliates[tokenId];
    }
...
contract LetsgoNFTBase {
    ...
    function validateCoCreatorsAffiliates(AddreessWithPercent[] memory coCreators, AddreessWithPercent[] memory affiliates) external view{
         require(
            coCreators.length <= 10,
            "validateCoCreatorsAffiliates: coCreators length should be less or equal to 10"
        );
        require(
            affiliates.length <= 10,
            "validateCoCreatorsAffiliates: affiliates length should be less or equal to 10"
        );
        ...
        for (uint256 i = 0; i < coCreators.length; i++) {
            require(
                ...
                "validateCoCreatorsAffiliates: coCreator address address can't be empty"
            );
            require(
                coCreators[i].value > 0,
                "validateCoCreatorsAffiliates: coCreator value must be higher than 0"
            );
        ...
        require(
            ...
            "validateCoCreatorsAffiliates: coCreators sum should be less or equal to 100%"
        );
        ...
        for (uint256 i = 0; i < affiliates.length; i++) {
            require(
                ...
                "validateCoCreatorsAffiliates: affiliate address address can't be empty"
            );
            require(
                affiliates[i].value > 0,
                "validateCoCreatorsAffiliates: affiliate value must be higher than 0"
            );
        ...
        require(
            ...
            "validateCoCreatorsAffiliates: affiliates sum should be less or equal to 100%"
        );
    }
}
