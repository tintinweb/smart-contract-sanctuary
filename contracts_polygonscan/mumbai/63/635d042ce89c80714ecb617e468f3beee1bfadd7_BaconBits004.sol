...
/**
    Bacon Strats MEME Coin Dev Contract
    https://BaconStras.com
    https://twitter.com/BaconStrats
    Created by: https://twitter.com/Oxtkcle
    
    Goal : Create a deflationary coin for people to create a community
	and to create something cool
            
    Requirements :
        * Anti-whale (Launch set at 0.5%)
        * Growth through holding
        * Burn the supply
    
    Transaction fee: 6%
        * 2% Burn
        * 2% Hodl'r distribution
        * 2% Community Growth
...
contract BaconBits004 is Context, IERC20, Ownable {
    ...
    string private _name = "Bacon Bits 004";
    string private _symbol = "BBTS004";
