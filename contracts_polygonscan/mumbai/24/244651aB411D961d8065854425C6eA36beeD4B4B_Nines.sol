...
contract Nines is AccessControlEnumerable, IERC1155Receiver {
    ...
    function create(uint256 chainId, address contractAddress, uint256 tokenId, string calldata name) public {
        ...
        //NFT[] memory nfts = new NFT[](9);
        //nfts[0] = NFT(chainId, contractAddress, tokenId);
        //NFT[] memory nfts;
        //nfts[0] = NFT(chainId, contractAddress, tokenId);
        //_nines[id].ninths[_nines[id].ninths.length] = ( NFT(chainId, contractAddress, tokenId) );
        ninesIds.push(id);
...
contract NineToken is ERC1155, Ownable {
    constructor() ERC1155("https://api.nines.wtf/metadata/{id}.json") {}
