...
contract ERC721WithRoyalties is ERC721, RoyaltiesV2Rarible {
    uint256 nextTokenId;
    ...
    function mint(address to, LibPart.Part[] memory _royalties) external {
    ...
    {
        return
            _interfaceId == type(RoyaltiesV2Rarible).interfaceId ||
