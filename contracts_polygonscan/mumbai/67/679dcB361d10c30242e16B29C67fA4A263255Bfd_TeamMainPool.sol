...
contract TeamMainPool is Ownable, ReentrancyGuard {
  ...
  uint256 public lockTime1 = 1641307500;
  /* 1st Lock time 1st of May 2023 GMT Timezone */
  uint256 public lockTime2 = 1641314700;
  /* 1st Lock time 31st of December 2023 GMT Timezone */
  uint256 public lockTime3 = 1641321900;
  ...
  function releaseSalary() external nonReentrant {
    ...
    if(block.timestamp < lockTime1) {
      ...
      uint256 epochs = block.timestamp.sub(lockTime1).div(600).add(2);
      ...
      require(leftSalary[msg.sender] > leftSalaryAmount, "Already released.1");
      ...
      require(leftSalary[msg.sender] > leftSalaryAmount, "Already released.2");			//BUG
      uint256 transferAmount = leftSalary[msg.sender].sub(leftSalaryAmount);
      ...
      require(leftSalary[msg.sender] > leftSalaryAmount, "Already released.3");
      uint256 transferAmount = leftSalary[msg.sender].sub(leftSalaryAmount);
