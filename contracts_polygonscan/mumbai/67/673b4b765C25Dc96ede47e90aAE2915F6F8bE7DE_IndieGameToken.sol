...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0x234201E48499b104321CB482BeB5A7ae5F3d9627);
    address WETH = 0x462C98Cae5AffEED576c98A55dAA922604e2D875;
    IDEXRouter router;
...
contract IndieGameToken is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0x234201E48499b104321CB482BeB5A7ae5F3d9627;
    address public WETH = 0x462C98Cae5AffEED576c98A55dAA922604e2D875;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Indie Game Token";
...
//    uint256 public _maxTxAmount = _totalSupply.div(400); // 0.25%
    ...
    uint256 public _maxTxAmount = 100; // 0.25%
