...
contract NFTSellingERC1155 is ERC1155Holder {
    ...
    function onERC1155BatchReceived(
        ...
        require(false, "Please send one at a time.");
    }
        ...
        saleIsNotCanceled(saleId)
    {
        ...
        nftObject.safeTransferFrom(address(this), msg.sender, nftID, 1, "0x3");
    ...
    {
        uint256 nftID = nftsForSale[saleId].nftID;
        nftObject.safeTransferFrom(address(this), msg.sender, nftID, 1, "0x4");
