...
contract Cybermon is ERC721Enumerable, Ownable{
    using Address for address;
    using Strings for uint256;
    ...
    uint256[4] public totalSupplies = [0, 0, 0, 0];
    uint256[4] public totalBurned = [0, 0, 0, 0];
    uint256[4] public blockEnds = [9999, 14999, 17499, 17509];
    uint256[4] public genderRarity = [2, 3, 4, 5];
    
    uint256 public constant NFT_PRICE = 0.01 ether;//80000000000000000; // 0.08 ETH
    ...
    constructor() ERC721("Cybermon","CYBRMN"){
    }
    ...
    function mint(uint256 numberOfTokens) public payable {
        uint256 totalSupply = totalSupply();
        require(salePhase, "Cant mint at the moment");
