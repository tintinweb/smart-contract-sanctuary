...
contract LiquidityPoolV3_02 is ReentrancyGuardUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20Upgradeable {
  ...
  bytes32 constant public PAUSER_ROLE = keccak256("PAUSER_ROLE");
	...
	uint256 constant public N_TOKENS = 7; 
		...
		initializer 
	{
		...
		TOKENS = [
			IERC20Upgradeable(0x01963E50950774F8039027E294EEc01EFbc38A2a), // sUSD
			IERC20Upgradeable(0x0A729fd2c64c72682C8b8D3598B22DA87992A2d3), // GUSD
			...
			IERC20Upgradeable(0x8F1Eed3EE8B6f070205E58Ff4728521C159E93D0),  // TUSD
			IERC20Upgradeable(0x774D2E3A77d9fDba12ca46d383CF000e8Cb98f90),	// USDT
			IERC20Upgradeable(0xAEE157d623B02CCC2f352a387F041014155061e5)	// miMatic
		];
		TOKENS_MUL = [
			uint256(1),
			uint256(1e16),
