...
contract SoSouthNFTTestContract is ERC721, ContextMixin, NativeMetaTransaction, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function batchMint(address to, uint256 amountToMint, string memory uri) public onlyOwner {
