...
// File: contracts/comicsContract.sol
...
contract comicsContract is ERC721{
    ...
    mapping (address => uint256[]) public Owner_NFT_list; // map of magazine struct
    ...
    * @param _tokenURI  -- URI of NFT
    */
	function mintComic (string memory _tokenURI) public returns (uint256) {
        ...
        comicList[NFT_ID].crateID = 0;
        comicList[NFT_ID].tokenURI = _tokenURI;  
        comicList[NFT_ID].owner = msg.sender;  

        NFT_inCrate[0].push(NFT_ID);



	    _safeMint(msg.sender, NFT_ID, bytes(_tokenURI));

        Owner_NFT_list[msg.sender].push(NFT_ID);
    ...
    */
    ...
    function transferNFT(address _from, address _to, uint256 _NFT_ID, string memory _tokenURI) public  {
