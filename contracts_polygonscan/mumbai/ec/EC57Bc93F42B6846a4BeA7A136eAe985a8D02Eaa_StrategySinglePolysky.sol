...
abstract contract StrategyFeesBase is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant wmaticAddress = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;

    address public wantAddress;
    address public earnedAddress;
    
    address public uniRouterAddress;// = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    address public constant usdcAddress = 0xBD2094e633296909DDc7954Cf2f29e2f508112a2;
    address public constant rewardAddress = 0x91e5637d00014cB2cb75584B8386FA0a26C744E1;//StrategySirius address
    ...
    address[] public wmaticToSiriusPath;//TODO set the path here
    address[] public wmaticToUsdcPath;//TODO same as above
...
abstract contract StrategyBase is StrategyFeesBase {
    ...
    address public constant referralAddress = 0x4ffE0Ee3A74CABA807E58040426431EE6d71b32D;
    ...
    function _earn() internal {
        ...
        if (earnedAmt > 0) {
            ...
            require(false, 'before fees distributeFees');
            distributeFees(earnedAddress);
            require(false, 'before distributeRewards');
            distributeRewards(earnedAddress);
            require(false, 'before buyBack');
            buyBack(earnedAddress);
            require(false, 'before earnedToWant');
        ...
        require(false, 'before _farm');
        _farm(wantAmt);
        require(false, 'after farm');
    }
...
contract StrategySinglePolysky is StrategySingleBase {
    ...
    //polysky finance masterchef address
    address public polyskyAddress;
    uint256 pid;

    constructor(
        address _vaultChefAddress,
        address _polyskyAddress,
        address _wantAddress,
        address _earnedAddress,
        address _uniRouterAddress,
        uint256 _pid
        ...
        /*Fill these in*/
        earnedToWmaticPath = [0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4, 0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4];        
        earnedToUsdcPath = [0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4,0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4];
        earnedToSiriusPath = [0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4];
        earnedToWantPath= [0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4];
        wantToEarnedPath = [0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4];
        polyskyAddress = _polyskyAddress;
        pid = _pid;
   ...
   //     StrategySingleBase._resetAllowances();
    ...
    function _resetAllowances() internal virtual override {
        IERC20(wantAddress).safeApprove(polyskyAddress, uint256(0));
