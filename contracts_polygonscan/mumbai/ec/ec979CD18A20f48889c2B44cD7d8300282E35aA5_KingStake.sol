...
contract KingStake is Ownable{
    ...
    function calculateReward(address _account,uint256 _stakingID)public view returns(uint256){
        ...
        return userDetails[_account][_stakingID].amount.mul(userDetails[_account][_stakingID].planPercenrtage).div(100);
        ...
        return userDetails[_account][_stakingID].amount.mul(stakingTime).mul(stakingPercentage).div(1e12).div(100);
        }
    }
