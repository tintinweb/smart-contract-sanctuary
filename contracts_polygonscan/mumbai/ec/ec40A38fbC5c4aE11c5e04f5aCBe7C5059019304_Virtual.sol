...
// File: contracts/virtual real property.sol
...
contract Virtual is ERC20Burnable, Ownable {
    constructor() ERC20("Virtual Real Property", "VRP") Ownable() {
        _mint(msg.sender, 137000000000000 * 10**18);
    }
}