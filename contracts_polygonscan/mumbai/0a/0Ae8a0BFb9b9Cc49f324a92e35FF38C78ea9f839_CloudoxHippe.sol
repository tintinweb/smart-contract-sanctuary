...
contract CloudoxHippe is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) ERC1155Tradable("HippeTest v23", "HTV23", "http://opensea-creatures-api.herokuapp.com/api/creature/{id}", _proxyRegistryAddress) {}
...
contract ERC1155Tradable is ContextMixin, ERC1155, NativeMetaTransaction, Ownable {
  ...
  function payMint(uint256 _id) public payable {
    ...
    uint256 preSalePrice = uint256(10) / uint256(100);

    require(msg.value >= preSalePrice, "insufficient ether");
