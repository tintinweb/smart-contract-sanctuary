...
contract LaunchpadFactory is Ownable {
    ...
    function launchCrowdsale(
        ...
        if (isFeeManagerEnabled) {
            (_launchVars.feeAmount, _launchVars.feeToken) = feeManager
                .getFactoryFeeInfo(address(this));
            if (_launchVars.feeToken != address(0)) {
                TransferHelper.safeTransferFrom(
                    _launchVars.feeToken,
                    msg.sender,
                    address(this),
                    _launchVars.feeAmount
                );
                ...
                require(
                    msg.value == _launchVars.feeAmount,
