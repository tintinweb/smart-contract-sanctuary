...
contract PlayersArtRoot is Ownable, IPlayersArtRoot {
    ...
    constructor(address _feeRecipient, uint256 _feePercent) {
        _setFeeInfo(_feeRecipient, _feePercent);
    ...
    function _setFeeInfo(address _feeRecipient, uint256 _feePercent) internal {
