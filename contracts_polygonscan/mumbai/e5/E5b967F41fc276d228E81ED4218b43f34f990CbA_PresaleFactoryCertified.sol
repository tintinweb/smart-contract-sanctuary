...
contract PresaleFactoryCertified is ReentrancyGuard {
    ...
    function createPresaleCertified(
        ...
        if (_addition.whitelist.length == 0) {
            require(block.timestamp + safeLibrary.getRegistrationTime() + 60*3 <= _info.openTime, "3"); //PROD: change 60*3 (approval time)
        } else {
            require(block.timestamp + 60*3 <= _info.openTime, "4"); //PROD: change 60*3 (approval time)
        }
        require(
...

{
  ...
  "libraries": {
    "/Users/rita/Documents/less-contracts/contracts/libraries/Calculations.sol": {
      "Calculations": "0x0dc90D06F7f47D92F08cdd494253279B1E7C3fD9"
    },
    "/Users/rita/Documents/less-contracts/contracts/libraries/Calculation1.sol": {
      "Calculation1": "0xd854fF05776FD65c90E4e041f8fA38d79F1117a8"
    }
  },
  "outputSelection": {
    "*": {
