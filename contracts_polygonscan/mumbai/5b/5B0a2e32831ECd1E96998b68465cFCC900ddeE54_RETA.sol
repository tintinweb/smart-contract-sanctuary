...
contract RETA is ERC20, AccessControl {
    ...
    modifier onlyValidAddress(address wallet) {
        ...
        require(
            wallet != communityAddress,
            "The address cannot be the community"
        );
        require(
    ...
    function setCommunityFee(uint256 fee, uint256 feeDecimals)
        public
        onlyAdmin
    {
    ...
    // Sets the fee percentage for the platformDev wallet
    function setTokenFarmFee(uint256 fee, uint256 feeDecimals)
        public
        onlyAdmin
    {
