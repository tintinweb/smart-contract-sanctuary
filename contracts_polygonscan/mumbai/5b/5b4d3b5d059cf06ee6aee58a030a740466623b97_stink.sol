...
contract stink is Context, IERC20, Ownable {
    ...
    address deployer;
    string private constant _name = "stink";
    ...
    constructor(address payable addr1, address payable addr2, address _childChainManagerProxy) {
        _teamAddress = addr1;
        _lottery = addr2;
