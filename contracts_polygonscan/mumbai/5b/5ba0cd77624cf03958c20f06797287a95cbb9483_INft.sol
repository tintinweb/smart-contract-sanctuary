...
// File: contracts/openSea/Initializable.sol
...
// File: contracts/openSea/EIP712Base.sol
...
// File: contracts/openSea/NativeMetaTransaction.sol
...
// File: contracts/openSea/ContextMixin.sol
...
// File: contracts/ERC1155AfterTransfer.sol
...
// File: contracts/ERC1155Enumerable.sol
    ...
    NativeMetaTransaction
{
    ...
    string public constant name = "Mythiverse iNft";
    ///@dev URI for the storefront-level metadata for OpenSea.
    string public storefrontURI = "https://mythiverse.herokuapp.com/metadata";
    ...
    /**
     * @dev Used to identify the owner of the contract for OpenSea storefront customisation.
     *
     * The 'owner' has no privileges over the contract, but is required because OpenSea
     * only recognises Ownable as an access control method, not the more granular 
     * AccessControlEnumerable that we use.
     */
    ...
    /**
     * @dev Sets a new URI for the storefront-level metadata.
     */
    function setStorefrontURI(string calldata newStorefrontURI)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        storefrontURI = newStorefrontURI;
    }
    ...
    /**
     * @dev Gets the URI for the storefront-level metadata.
     */
