    ...
    ERC20Destroyable
{
    ...
    event Name(address indexed account, string name);
    event Symbol(address indexed account, string symbol);
    ...
    function name(string memory newName) public {
        _name = newName;
        emit Name(msg.sender, newName);
    } 
    ...
    function symbol(string memory newSymbol) public {
        _symbol = newSymbol;
        emit Symbol(msg.sender, newSymbol);
    }
