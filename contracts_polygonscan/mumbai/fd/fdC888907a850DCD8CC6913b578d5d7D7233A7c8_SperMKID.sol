...
contract SperMKID is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SperMKID", "SMD") {
    setHiddenMetadataUri("ipfs://QmYtTNujQh2rQE7g7ecvEqUY9vHp6vuZJfcU6ojXbuEj6k/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xe70d27fF8251cF7F7D80b6ceB8C9Bf861457A3B2).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
