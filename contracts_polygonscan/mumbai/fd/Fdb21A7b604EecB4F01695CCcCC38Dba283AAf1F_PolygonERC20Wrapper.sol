...
contract PolygonERC20Wrapper is OwnerPausableUpgradeable, ERC20Upgradeable, IChildToken {
     ...
     */
    function withdrawTo(uint256 amount, address recipient) whenNotPaused external {
        SafeERC20Upgradeable.safeTransferFrom(
            underlying,
            _msgSender(),
            address(this),
