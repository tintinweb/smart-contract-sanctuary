...
*/
  ...
  function withdrawAllTokens() public {
    ...
    require (ERC20Interface(input_token).transferFrom(this, msg.sender, input_balance));
    require (ERC20Interface(output_token).transferFrom(this, msg.sender, output_balance));
  }
