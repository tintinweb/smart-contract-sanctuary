...
contract RandomNumberConsumer is VRFConsumerBase {
    ...
    function getRandomNumber() public payable returns (bytes32 requestId) {
        ...
        bytes32 _requestId =requestRandomness(keyHash, fee,usersAddress,userValue);
        return _requestId;
    }
     ...
     */
    function fulfillRandomness(bytes32 requestId, uint256 randomness,address usersAddress,uint userValue) internal override {
    uint256 d20Value = randomness % 37 +1;
    randomResult=d20Value;
    address payable wallet = payable(usersAddress);
    wallet.transfer(userValue);
...
abstract contract VRFConsumerBase is VRFRequestIDBase {
  address usersAddress=0x318a41870C948AFb035f7b75f532c5a617564E36;
  uint userValue=0;
    ...
    external
  {
    ...
    fulfillRandomness(requestId, randomness,usersAddress,userValue);
  }
}