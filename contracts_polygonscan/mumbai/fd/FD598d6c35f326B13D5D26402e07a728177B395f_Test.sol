...
contract Test is ERC165 {
    ...
    function buyNow(
        ...
        require(_order.saleStart <= block.timestamp, "Order not started yet");
        require(
            _editionNumber > 0 &&
        ...
        if (_order.paymentToken == address(0)) {
            ...
            require(
                buyNowPayment(_order, _editionNumber, _tokenAmount),
    ...
    function buyNowPayment(
        ...
        if (_order.paymentToken == address(0)) {
            ...
            require(msg.value == 0, "Sending incorrect funds");
    ...
    function placeSecondHandOrder(
        ...
        require(_saleType == 2, "Wrong sale type");
        require(
    ...
    function transfer(
        ...
        require(secondHand[id][editionNumber], "Edition not in second market");
