...
// hevm: flattened sources of /nix/store/9562cr0d7ld8jb3ba5jdn2xyk9cx9kxs-h2o-governance-actions/dapp/h2o-governance-actions/src/DeployCollateralAuctionThottler.sol
...
////// /nix/store/irf6p6ny7fdsxbc9i9p4bz4vzfbccq9b-geb-treasury-reimbursement/dapp/geb-treasury-reimbursement/src/reimbursement/IncreasingTreasuryReimbursement.sol
/* pragma solidity 0.6.7; */

/* import "../math/GebMath.sol"; */

abstract contract StabilityFeeTreasuryLike_10 {
...
contract IncreasingTreasuryReimbursement is GebMath {
    ...
    **/
    ...
    // SF treasury
    StabilityFeeTreasuryLike_10  public treasury;
    ...
    constructor(
      ...
      uint256 perSecondCallerRewardIncrease_
        ...
        if (address(treasury_) != address(0)) {
          require(StabilityFeeTreasuryLike_10(treasury_).systemCoin() != address(0), "IncreasingTreasuryReimbursement/treasury-coin-not-set");
        }
        ...
        treasury                        = StabilityFeeTreasuryLike_10(treasury_);
...
////// /nix/store/f8z1z10s634mg3pg0brjk3x40lq17kmz-geb-collateral-auction-throttler/dapp/geb-collateral-auction-throttler/src/CollateralAuctionThrottler.sol
/* pragma solidity 0.6.7; */

/* import "geb-treasury-reimbursement/reimbursement/IncreasingTreasuryReimbursement.sol"; */

abstract contract LiquidationEngineLike_7 {
    function currentOnAuctionSystemCoins() virtual public view returns (uint256);
    function modifyParameters(bytes32, uint256) virtual external;
}
abstract contract SAFEEngineLike_14 {
...
contract CollateralAuctionThrottler is IncreasingTreasuryReimbursement {
    ...
    LiquidationEngineLike_7    public liquidationEngine;
    SAFEEngineLike_14           public safeEngine;
    ...
    constructor(
      ...
      address[] memory surplusHolders_
        ...
        safeEngine             = SAFEEngineLike_14(safeEngine_);
        liquidationEngine      = LiquidationEngineLike_7(liquidationEngine_);
    ...
    */
    function modifyParameters(bytes32 parameter, address addr) external isAuthorized {
        ...
        if (parameter == "treasury") {
          require(StabilityFeeTreasuryLike_10(addr).systemCoin() != address(0), "CollateralAuctionThrottler/treasury-coin-not-set");
      	  treasury = StabilityFeeTreasuryLike_10(addr);
        }
        else if (parameter == "liquidationEngine") {
          liquidationEngine = LiquidationEngineLike_7(addr);
        }
        else revert("CollateralAuctionThrottler/modify-unrecognized-param");
...
////// /nix/store/9562cr0d7ld8jb3ba5jdn2xyk9cx9kxs-h2o-governance-actions/dapp/h2o-governance-actions/src/DeployCollateralAuctionThottler.sol
/* pragma solidity 0.6.7; */
...
contract DeployCollateralAuctionThottler {
    ...
    event CollateralAuctionThrottlerDeployed(address indexed auctionThrottler);
    ...
    function execute(
        ...
        StabilityFeeTreasuryLike_2(_treasury).setPerBlockAllowance(address(throttler), maxUpdateCallerReward * RAY);
        StabilityFeeTreasuryLike_2(_treasury).setTotalAllowance(address(throttler), uint(-1));

        // auth throttler in LiquidationEngine
        LiquidationEngineLike_3(_liquidationEngine).addAuthorization(address(throttler));

        emit CollateralAuctionThrottlerDeployed(address(throttler));
