 ...
 * @author Daniel Lee
 * @notice This contract is for distribution of 10k eggs to users
 * @dev All function calls are currently implemented without side effects
 */
contract EggsCollection is Initializable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, AccessControlEnumerableUpgradeable {
    ...
    function mint(address to) public virtual onlyMinter {
        // Set new token id to `totalSupply` + 1.
