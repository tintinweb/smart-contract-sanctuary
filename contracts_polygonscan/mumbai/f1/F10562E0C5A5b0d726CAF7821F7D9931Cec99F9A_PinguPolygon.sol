    ...
    ContextMixin
{
    ...
    constructor(address childChainManager) public ERC20("Pingu", "PIN") {
        _setupContractId("Pingu");
        _setupDecimals(18);
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, _msgSender());
        _setupRole(BURNER_ROLE, _msgSender());
        _setupRole(DEPOSITOR_ROLE, childChainManager);
        _initializeEIP712("Pingu");
        _mint(_msgSender(), 1 * (10**27));
    }
