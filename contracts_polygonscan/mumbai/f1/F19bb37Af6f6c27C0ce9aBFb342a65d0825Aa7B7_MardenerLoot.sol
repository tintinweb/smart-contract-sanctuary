...
library MardenerEyes { 
    ...
    function thugEye() public pure returns(string memory) {
        ...
        parts[0] = '<g id="ciggar" transform="translate(0,8)"><use xlink:href="#pixel" x="6" y="0" fill="brown" /><use xlink:href="#pixel" x="2" y="0" fill="#f2f2f2" /><use xlink:href="#pixel" x="5" y="1" fill="wheat" /><use xlink:href="#pixel" x="1" y="1" fill="lightgray" /><use xlink:href="#pixel" x="4" y="2" fill="wheat" /><use xlink:href="#pixel" x="2" y="2" fill="gray" /><use xlink:href="#pixel" x="3" y="3" fill="orangered" /></g>';
...
contract MardenerLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns(string memory) {
        ...
        parts[0] = '<svg class="container" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="336px" height="336px" preserveAspectRatio="xMinYMin meet" viewBox="0, 0 16, 16" fill="red">';
        ...
        // string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Monster No #', toString(tokenId), '", "description": "Loot Monster is the cloning project of LOOT, for random monster generated and stored on chain. plus drop 1 item from loot bag!. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Loot Monster in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function claim(uint256 tokenId) public nonReentrant {
        require(tokenId > 0 && tokenId < 5001, "Token ID invalid");
        _safeMint(_msgSender(), tokenId);
    }

    function ownerClaim(uint tokenId) public nonReentrant onlyOwner {
        require(tokenId > 5001 && tokenId < 6000 , "Token Id invalid");
        _safeMint(_msgSender(), tokenId);
    }
    ...
    constructor() ERC721("Mardener 16 bit", "MADLOOT") Ownable() {
    }
