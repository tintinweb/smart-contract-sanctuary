...
contract FYGNClaimableBurner {
    ...
    constructor(ERC20Burnable _fYGN, IERC20 _ygnToken, YGNStaker _ygnStaker) {
        fYGNToken = _fYGN;
        ygnToken = _ygnToken;
    ...
    function burnAndStake(uint256 _fYGNShare) external {
        leave(_fYGNShare);
        uint fygnBalance = ygnToken.balanceOf(address(this));
        ygnStaker.enterFor(msg.sender, fygnBalance);
    }
    ...
    function leave(uint256 _fYGNShare) public {
        ...
        ygnToken.transfer(msg.sender, ygnAmount);
...
contract YGNStaker is ERC20("YGNStaker", "xYGN"), ContextMixin, NativeMetaTransaction {
    using SafeMath for uint256;
    IERC20 public ygn;
