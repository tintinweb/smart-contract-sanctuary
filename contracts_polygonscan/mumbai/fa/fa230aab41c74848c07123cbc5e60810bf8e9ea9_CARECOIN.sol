...
contract CARECOIN is ERC20  {
  ...
  uint256 internal devAmount;
  uint256 internal communityAmount;
    ...
    event birthOfCPN(address indexed from, address indexed tokenOwner, uint256 communityAmount, address indexed devFund, uint256 devAmount);
    ...
    constructor(address tokenOwner , address routerAddress) {
       ...
       devAmount = (totalSupply.mul(2)).div(10**2);
       balances[devFund] = devAmount;
         
        //Total Supply transferred  to Owner.
        communityAmount = totalSupply.sub(devAmount);
        balances[tokenOwner] = communityAmount;
...
//ICO Sale will end on (Unix Time Stamp)
       ...
       //exclude Liquidity Router and Factory from fee
        ...
        emit birthOfCPN(address(0), tokenOwner,  communityAmount, devFund, devAmount);
