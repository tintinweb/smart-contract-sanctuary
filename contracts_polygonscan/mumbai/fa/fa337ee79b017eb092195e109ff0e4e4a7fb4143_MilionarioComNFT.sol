...
contract MilionarioComNFT is ERC721Enumerable, Whitelisted {
    ...
    // uint256 public constant NFT_PRICE = 55 ether;
    uint256 public constant NFT_PRICE = 0.0055 ether;

    address wallet1 = 0x3106B9112E18bcB0eBacaE0F9f69aa3A2F1fc9Bd;
    address wallet2 = 0x3106B9112E18bcB0eBacaE0F9f69aa3A2F1fc9Bd;
    address wallet3 = 0xcb19e1cD67A268b31ae5a7AFEaeA891509147601;
    ...
    modifier valueIsCorrect(uint256 amount) {
        require(
            msg.value >= NFT_PRICE.mul(amount),
