...
contract MNF5 is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable{
  ...
  function setBaseURI(string memory baseURI) external onlyOwner {
    //require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "MNF3: must have admin role to change base URI");
    _baseTokenURI = baseURI;
  }

  function setTokenURI(uint256 tokenId, string memory _tokenURI) external onlyOwner {
    //require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "MNF3: must have admin role to change token URI");
    _setTokenURI(tokenId, _tokenURI);
  }

  function setPrice(uint mintPrice) external onlyOwner {
    //require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "MNF3: must have admin role to change price");
    _price = mintPrice;
  }
  ...
  function mintingEnabled(bool state) public onlyOwner {
	mintable = state;
  }
  ...
  function ghostCreator(uint256 tokenId) public view returns(address){
