...
contract DbiliaToken is ERC721URIStorageEnumerable, AccessControl, ReentrancyGuard {
  ...
  event ClaimTokenBoughtOnOtherPlace(
    address indexed _to,
    uint256 _tokenNums
  );
...
/**
  ...
  {    
    ...
    require(_minter != address(0x0), "minter address is empty");
    require(
      weth.allowance(_minter, address(this)) >= _validateAmount, 
  ...
  /**
    ...
    *  @param _tokenId token id
    */
  function getRoyaltyReceiver(uint256 _tokenId) public view returns (address, uint16) {
...
/**
  ...
  */
  ...
  /**
    ...
    */
  function setBeneficiary(address _beneficiaryAddress) external onlyDbilia {
    require(_beneficiaryAddress != address(0), "invalid _beneficiaryAddress");
    beneficiary = _beneficiaryAddress;
  }
