...
contract GZRewardsUpgradeable is OwnableUpgradeable, EIP712MetaTxUpgradeable {
    ...
    mapping (address => uint256) public claimedZoneReward;
    mapping (address => uint256) public claimedZoneExtraReward;
    ...
    function initialize(
        ...
        __EIP712MetaTx_init_unchained("GZRewards", "1");
