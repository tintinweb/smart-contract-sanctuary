...
contract BconAdmin is Ownable {
    ...
    event BconContractContractCreated(string indexed bconContractId, address bconContractAddr);
...
contract BconContract is IBconContract {
    ...
    */
    ...
    event BillingUnitCreated(IBillingUnits.BillingUnit billingUnit);
    ...
    */
    ...
    function throwBillingUnitCreated(IBillingUnits.BillingUnit memory billingUnit) public override {
        ...
        emit BillingUnitCreated(billingUnit);
    }
