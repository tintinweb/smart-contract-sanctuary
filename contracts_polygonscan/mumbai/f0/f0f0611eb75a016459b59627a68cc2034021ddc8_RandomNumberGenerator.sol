...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public polyBetaLottery;
     ...
     * @param _seed: seed provided by the PolyBeta lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == polyBetaLottery, "Only PolyBetaLottery");
    ...
    /**
     * @notice Set the address for the PolyBetaLottery
     * @param _polyBetaLottery: address of the PolyBeta lottery
     */
    function setLotteryAddress(address _polyBetaLottery) external onlyOwner {
        polyBetaLottery = _polyBetaLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPolyBetaLottery(polyBetaLottery).viewCurrentLotteryId();
    }
}