...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0x0000000000000000000000000000000000001010;
    IDEXRouter router;
...
contract BabySweden is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabySweden";
    string constant _symbol = "BabySwe";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**10 * (10 **9);
