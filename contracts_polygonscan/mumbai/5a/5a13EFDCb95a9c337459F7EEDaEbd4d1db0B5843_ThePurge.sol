...
contract ThePurge is ERC20, Ownable {
    ...
    uint256 public liqFee = 20;
    uint256 public numTransactions = 0;
    uint256 private flipFee = 3; //how much % fee change from liqfee to burnfee every $numTxsToChangeFees transactions
    uint256 private numTxsToChangeFees = 10;
    uint256 private numTxsToFixFees = 50;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override{
        ...
        if(numTransactions.mod(numTxsToChangeFees) == 0 && numTransactions <= numTxsToFixFees){
