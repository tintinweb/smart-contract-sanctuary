...
contract Polymon is ERC1155, Ownable {


	uint private nftTypes = 8;
	uint private nftSupplyEach = 111;
	
	string public name = "Polymon";
	string public symbol = "Polymon";
	...
	uint public CURR_MINT_COST = 10000000000000000;
	...
	uint private maxMintAmount = 100;
	uint private nftPerAddressLimit = 150;
    ...
    constructor() ERC1155("https://abcoathup.github.io/SampleERC1155/api/token/{id}.json") {
        ...
        _mint(msg.sender, GOLD, 1, "");
        _mint(address(0xd16d5021516ae4c4F8d89e18edD0171536F4d935), GOLD, 1, "");
	...
	function tokenRange(uint id) private pure returns (uint)
	{
		if(id <= 111)
			return 1;
		else if(id <= 222)
