...
import "./Interface/IStakingPoolMinimalProxy.sol";
...
contract StakingPoolFactory is Ownable, CloneBase {
    ...
    function updateExtraData(bytes memory _extraData) external {
    ...
    function launchStakingPool(
        ...
        address stakingPool = createClone(_stakingPoolLibrary);
        ...
        if (isFeeManagerEnabled) {
            ...
            if (_localVars.feeToken != address(0)) {
                ...
                require(
                    msg.value == _localVars.feeAmount,
        ...
        IStakingPoolMinimalProxy(stakingPool).init(
            _rewardToken,
            _amount,
            _inputToken,
            _blockReward,
        ...
        // IStakingPoolMinimalProxy(stakingPool).transferOwnerShip(address(this));
...
interface IStakingPoolMinimalProxy {
    function init(
        IERC20 _rewardToken,
        uint256 _amount,
        IERC20 _inputToken,
