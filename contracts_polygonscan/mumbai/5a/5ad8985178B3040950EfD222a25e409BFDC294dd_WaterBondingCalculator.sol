...
import './interfaces/IWaterBondingCalculator.sol';
...
contract WaterBondingCalculator is IWaterBondingCalculator {
    ...
    function markdown(address _pair) external view override returns (uint256) {
        ...
        return
            reserve.mul(2 * (10**IERC20(Oxygen).decimals())).div(
                getTotalValue(_pair)
            );
    }
}
...
interface IWaterBondingCalculator {
