...
contract LUSDTokenChild is CheckContract, ILUSDToken {
    ...
    address public chainManagerProxyproxySetter;
    ...
    {  
        ...
        chainManagerProxyproxySetter = msg.sender;
    ...
    function setChildChainManager(address newChildChainManagerProxy) external {
        require(newChildChainManagerProxy != address(0), "Bad ChildChainManagerProxy address");
        require(msg.sender == chainManagerProxyproxySetter, "You're not allowed");

        childChainManagerProxy = newChildChainManagerProxy;
        chainManagerProxyproxySetter = address(0); //renounce
    }
