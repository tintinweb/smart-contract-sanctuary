...
abstract contract Risk {
    ...
    function insertRiskItem(string memory rating, uint256 interestRate, uint256 advanceRate) public onlyOwner {
    ...
    function getAdvanceRiskRate(string memory rating) external view returns (uint256) {
