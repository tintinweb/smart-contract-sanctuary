...
contract Shards is ERC1155, Ownable {
    ...
    constructor() ERC1155("ipfs://QmTp1paK54biU5fvj2X5mWPjjXGsrcAb83WDuLBBV6MYqH") {}
    ...
    function mint(uint256 numNfts) external payable whenPublicSaleActive {
        require(tokenCount + numNfts <= MAX_SUPPLY, "Minting would exceed max supply");
        require(numNfts > 9, "Must mint at least ten Shards");
        require(numNfts < 10001, "Must mint less than 10000 Shards");
        require(mintPrice * numNfts <= msg.value, "MATIC value sent is not correct");

        _mint(msg.sender, 0, numNfts, "");
        tokenCount += numNfts;
    ...
    function endSale() external onlyOwner whenPublicSaleActive {
