...
contract DexilonTest_v5_1 {
    ...
    */
        ...
        ) 
    {
        ...
        priceBTC = usersAssetsPrices[user]['BTC'];
        balanceETH = usersAssetsBalances[user]['ETH'];
        priceETH = usersAssetsPrices[user]['ETH'];
        balanceXRP = usersAssetsBalances[user]['XRP'];
        priceXRP = usersAssetsPrices[user]['XRP'];
        balanceSOL = usersAssetsBalances[user]['SOL'];
        priceSOL = usersAssetsPrices[user]['SOL'];
