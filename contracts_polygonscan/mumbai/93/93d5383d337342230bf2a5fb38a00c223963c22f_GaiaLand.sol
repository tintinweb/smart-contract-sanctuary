...
contract GaiaLand is ERC721, Ownable {
  ...
  address public immutable WMATICAddress = 0xfe4F5145f6e09952a5ba9e956ED0C25e3Fa4c7F1; // 0x723B17718289A91AF252D616DE2C77944962d122; // Gaia Token Contract Address on Polygon Main Net.
  ...
  function withdraw() external onlyOwner {
    ...
    IERC20(WMATICAddress).transferFrom(address(this), ownerAddress, gaiaBalance);
  }
