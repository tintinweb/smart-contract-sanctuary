...
contract gSOLID is IgSOLID, ERC20 {
    ...
    constructor(address _sSOLID)
        ERC20("Governance SOLID", "gSOLID", 18)
    {
    ...
    /**
     * @notice pull index from sSOLID token
     */
    ...
    /**
        @notice converts gSOLID amount to SOLID
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts SOLID amount to gSOLID
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gSOLID::getPriorVotes: not yet determined");
