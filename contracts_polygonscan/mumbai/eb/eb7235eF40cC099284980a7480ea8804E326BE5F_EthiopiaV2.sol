...
contract EthiopiaV2 {
    ...
    // create posts
    IERC721 NFT=IERC721(0x727DDEaA405a9946e0571e305A08e560eDe6B8e5);
    constructor() {
        admin=msg.sender;
    }
    function createPost (string memory _contents, string memory uri) public payable {
        ...
        postCount += 1;
        //add post
        posts[postCount] = Post(postCount, _contents, uri, 0, msg.sender);
        //emits
        emit postCreated(postCount, _contents, uri, 0, msg.sender);
