...
contract Erc721Bank is AccessControl, Pausable, IERC721Receiver {
    ...
    {
        return (_stakeTokens, address(_rewardToken), _startBlock, _rewardPerBlock / PRECISE_UNIT);
    }
        ...
        )
    {
        ...
        return (
            userInfo.stakeAmount, // stakeAmount
            newSharePrice / PRECISE_UNIT, // sharePrice
            (userInfo.stakeAmount * (newSharePrice - userInfo.sharePrice) + userInfo.rewardAmount) / PRECISE_UNIT, // rewardAmount
            userInfo.tokens, // tokens
            userInfo.tokenIds // tokenIds
        );
    }
