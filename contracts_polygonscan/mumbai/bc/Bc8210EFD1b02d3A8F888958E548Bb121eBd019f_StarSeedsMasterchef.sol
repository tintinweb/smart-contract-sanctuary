...
contract StarSeedsMasterchef is Ownable, ReentrancyGuard {
    ...
    // The STAR TOKEN!
    address public star = 0x7Ba798157147e37Dc4c54bDFa2aF013BAf3C02c2;//0xC6e2e8395A671eE3f6f55177F8Fe5984D5dA7741;
...
//0xFbfe7C5c437eFFD9730913804e4CD8B890D62A9c),
        ...
        //0xC6e2e8395A671eE3f6f55177F8Fe5984D5dA7741
        poolInfo.push(PoolInfo({
        lpToken : IERC20(0x7Ba798157147e37Dc4c54bDFa2aF013BAf3C02c2),
        allocPoint : 5500,
        lastRewardBlock : startBlock,
        accStarPerShare : 0,
        depositFeeBP : 0,
...
//////////// User functions //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function compound(uint256 _pid)public {
        ...
        uint256 pending = pendingStar(_pid,msg.sender);//user.amount.mul(pool.accStarPerShare).div(1e12).sub(user.rewardDebt);
        if (canHarvest(_pid, msg.sender)) {
...
/////////////////// Internal functions //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function payOrLockupPendingStar(uint256 _pid,address _to) internal {
        ...
        uint256 pending = pendingStar(_pid,_to);//user.amount.mul(pool.accStarPerShare).div(1e12).sub(user.rewardDebt);
