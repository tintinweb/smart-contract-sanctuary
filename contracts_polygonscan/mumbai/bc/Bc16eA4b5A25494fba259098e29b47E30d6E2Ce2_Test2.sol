...
// File: contracts/New sample contract.sol
...
contract Test2 is ERC721Enumerable, Ownable {
  uint256 private basePrice = .0001 ether;
  //uint256 private basePrice = 500000000000000000; //50 Matic

  uint256 private reserveAtATime = 3;
  uint256 private reservedCount = 0;
  uint256 private maxReserveCount = 9;
  address private MPAddress = 0x316356CAD47F7ffC2245eF655CC336975715F868;
  address private CMAddress = 0xe7eFB4F8A27160f5d1Cd74Cb22D2329920642b48;
  address private ProjectAddress = 0xb75E3AAcD370ef127c2Afa6ed4905E34c05cEd2B;
  ...
  uint256 public constant MAX_MINTSUPPLY = 25;
  ...
  function setnotRevealedURI(string memory notRevealedURI) public onlyAuthorized {
  ...
  function ogFreeMint() public payable saleIsOpen {
    require(isFreeListActive, 'Not active');
  ...
  function withdraw() external onlyAuthorized {
    ...
    payable(MPAddress).transfer(balance* 1500 / 3333);
    payable(CMAddress).transfer(balance * 1500 / 3333);
    payable(ProjectAddress).transfer(balance * 300 / 3333);
