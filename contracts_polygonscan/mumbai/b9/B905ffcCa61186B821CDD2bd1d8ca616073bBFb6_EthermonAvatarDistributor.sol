...
contract EthermonAvatarDistributor is AccessControl {
    ...
    //     require(!whiteList[msg.sender], "Cannot add duplicate address");

    //     // User need to hold EMON to add themselves to whitelist
    //     uint256 emonBalance = emonToken.balanceOf(msg.sender);
    //     require( emonBalance >= minTokenBalanceRequired, "Insufficient EMON balance to add to whitelist" );
