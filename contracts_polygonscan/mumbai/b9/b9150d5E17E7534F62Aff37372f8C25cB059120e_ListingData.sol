...
contract ListingData is IListingData, UUPSUpgradeable {
    ...
    string public upgradeDummy;
    string public upgradeDummy2;
     ...
     */
    function setRequestIdToRefundPremium(uint256 requestId)
        external
        override
        onlyInternal
    {
     ...
     */
    function setDepositOfOfferTakenBack(uint256 offerId)
        external
        override
        onlyInternal
    {
     ...
     */
    function setIsDepositTakenBack(uint256 coverId)
        external
        override
        onlyInternal
    {
