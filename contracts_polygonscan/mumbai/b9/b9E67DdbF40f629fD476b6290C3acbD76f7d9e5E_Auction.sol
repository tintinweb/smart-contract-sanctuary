...
contract Auction is ContextUpgradeable, IERC721ReceiverUpgradeable, SignatureChecker {
    ...
    */
    function createTokenAuction(
        ...
        ERC721Upgradeable(_nft).safeTransferFrom(owner, address(this), _tokenId);
    ...
    function testMinting(
        ...
        // IERC721LazyMint(_nft).testMint(msg.sender, _tokenId);
        ERC721Upgradeable(_nft).safeTransferFrom(_transferFrom, _transferTo, _tokenId);
    }
    ...
    */
    function executeSale(address _nft, uint256 _tokenId, address bidder, uint256 amount, bytes memory sig) external {
        ...
        ERC721Upgradeable(_nft).safeTransferFrom(
                address(this),
                bidder,
                _tokenId
            );
    ...
    function cancelAuction(address _nft, uint256 _tokenId, address[] memory _bidders) external {
        ...
        ERC721Upgradeable(_nft).safeTransferFrom(address(this), auction.seller, _tokenId);
    }
...
contract SignatureChecker is OwnableUpgradeable {
    ...
    // function __SignatureChecker_init(bool newFlag) internal initializer {
    //     checkSignatureFlag = newFlag;
    // }
