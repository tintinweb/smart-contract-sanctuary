...
contract CollectionRegistry is ICollectionRegistry {
    ...
    * @return A list of bytes32 with collection Ids.
    */
    function listCollections(address userAddress_) external view returns(bytes32[] memory) {
        return userCollections[userAddress_].values();
    }
