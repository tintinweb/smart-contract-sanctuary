...
contract SPLDailyActionV1 is Ownable {
    ...
    function setValidater(address _varidator) public onlyOwner {
    ...
    function action(
        ...
        require(
            validateSig(msg.sender, _time, _signature),
            "invalid signature"
        );
        int64 day = _time / 86400;
    ...
    function validateSig(
        ...
        address signer =
            recover(
                ethSignedMessageHash(encodeData(_from, _time)),
                _signature
            );
    ...
    function encodeData(
        ...
        return keccak256(abi.encode(_from, _time));
    }
