...
contract ERC721Orderinbox is ERC721Base {
    ...
    function __ERC721Orderinbox_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) external initializer {
        _setBaseURI(baseURI);
...
abstract contract ERC721Mint is IERC721Mint, ERC721URIStorageUpgradeable, Mint721Validator, RoyaltiesUpgradeable, RoyaltiesImpl {
    ...
    function __ERC721Mint_init_unchained() internal initializer {
...
abstract contract ERC721Core is OwnableUpgradeable, ERC721BurnableUpgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721Mint, HasContractURI  {
...
abstract contract RoyaltiesUpgradeable is ERC165StorageUpgradeable, Royalties {
