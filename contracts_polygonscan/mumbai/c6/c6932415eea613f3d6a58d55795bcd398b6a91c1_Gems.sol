...
contract Gems is ERC1155, Ownable {
  ...
  uint256 public mintCap = 1000;
  uint256 public mintPrice = 1 ether;

  // Crafting state
  bool public isCraftingLocked = false;
  bool public craftingIsActive = true;
  ...
  function mintMany(uint256 amount) public payable {
    ...
    require(amount <= MAX_MINT_PER_TX, 'Can not mint so many at a time.');
  ...
  function changeColor(uint256 tokenId) public {
    require(craftingIsActive, 'Crafting disabled.');
    require(_gemDetails[tokenId].color != 9, 'Cannot change the ultimate color.');
  ...
  function combineAllColors(
    ...
    require(
      _gemDetails[_ids[1]].level == refLevel && _gemDetails[_ids[2]].level == refLevel && _gemDetails[_ids[3]].level == refLevel && _gemDetails[_ids[4]].level == refLevel && _gemDetails[_ids[5]].level == refLevel && _gemDetails[_ids[6]].level == refLevel && _gemDetails[_ids[7]].level == refLevel,
      'Level mismatch'
    );

    require(
      _gemDetails[_ids[1]].color != refColor && _gemDetails[_ids[2]].color != refColor && _gemDetails[_ids[3]].color != refColor && _gemDetails[_ids[4]].color != refColor && _gemDetails[_ids[5]].color != refColor && _gemDetails[_ids[6]].color != refColor && _gemDetails[_ids[7]].color != refColor,
