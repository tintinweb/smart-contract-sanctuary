    ...
    ERC2771Context
{
    ...
    constructor()
        ERC1155PresetMinterPauser(
            "https://us-central1-artis-life-network.cloudfunctions.net/tokenURIv2?contractId=3&id={id}"
        )
        ERC2771Context(0x207Fa8Df3a17D96Ca7EA4f2893fcdCb78a304101)
    {
        _setupRole(OWNER_ROLE, msgSender());
        tokenURI = "https://us-central1-artis-life-network.cloudfunctions.net/tokenURIv2?contractId=3&id={id}";
        uri = "https://us-central1-artis-life-network.cloudfunctions.net/tokenURIv2?contractId=3&id={id}";
        name = "The LEOs";
        symbol = "LEOs";
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://us-central1-artis-life-network.cloudfunctions.net/contractURIv3?contractId=3";
    }
