...
contract IterativeVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
     ...
     *
     * @param _rewards - arrayu of [userAddress, userAmount]
     *
        ...
        nonReentrant
    {
        ...
        amountEarned = (
            ...
            ) * (totalUserRewards[address(msg.sender)] / nVestingPortions) //the multiplication is by the rewardPerPortion, but is performed again, so that multiply is before division to avoid loss of precision
        );
