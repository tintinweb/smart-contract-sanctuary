...
// --- @dev Contract Name: ERC721ArtGrail
// --- @dev Compiler Version v0.7.6+commit.7338295f
// --- @dev Optimization Enabled: Yes with 200 runs
// --- @dev Other Settings: default evmVersion
// ----------------------------------------------------------------------------

import "./ERC721Base.sol";

contract ERC721StarGrail is ERC721Base {
    function __ERC721StarGrail_init(
        string memory _name,
