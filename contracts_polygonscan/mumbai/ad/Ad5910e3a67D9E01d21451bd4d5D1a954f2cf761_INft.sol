...
library INftCodec {
    ...
    */
    ...
    /**
        @notice Is source chain of `token_` Polygon?
        @param token_ Token
    ...
    */
    ...
    /**
        @notice All core data for `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the id bits of `token_`
        @param token_ Token
        @param id_ Id to set
    ...
    */
    ...
    /**
        @notice Set the chain bits of `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the chain bits of `token_` to be Polygon
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the fungibility bits of `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the fungibility bits of `token_` to be fungible
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the fungibility bits of `token_` to be non-fungible
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the type bits of `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the type bits of `token_` to be egg
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the type bits of `token_` to be dragon
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the version bits of `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the version bits of `token_` to be version 1
        @param token_ Token
...
contract INft is ERC1155PresetMinterPauser, ERC1155Enumerable {
    using INftCodec for uint256;

    uint256 public nextTokenId;

    string private constant NO_NFT_AMOUNTS = "NFTs cannot have amounts";
    ...
    function mint(
        ...
        require(id.isFungible() || SINGLE_NFT == amount, NO_NFT_AMOUNTS);
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < ids.length; ++i) {
            require(ids[i].isFungible() || 1 == amounts[i], NO_NFT_AMOUNTS);
