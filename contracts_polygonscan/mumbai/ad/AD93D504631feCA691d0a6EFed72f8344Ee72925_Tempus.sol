...
contract Tempus is ERC20, Ownable {
    ...
    uint256 private rateInterest = 15 * (10 ** _decimals) / (100 * 100); // 0.25%
    uint256 private rateBonus = 1000 * (10 ** _decimals) / (100 * 100); // 10%
    uint256 public Can_Reward_Max_Days = 365;
    
    address public interestRewardPaymentAddress = 0x1E96Fa186ab7AC702a9211aC2328B1698b94B06a;
    ...
    function processStopHODL(address inAddress) private {
        ...
        if(interestReward > 0) {
            this.transferFrom(interestRewardPaymentAddress, inAddress, totalReward);
            // this.transfer(inAddress, totalReward);
        }
    ...
    function getInterestReward(address inAddress) private view returns(uint256) {
        ...
        require(info.isValid, "ERC20: Invalid HODL.");
