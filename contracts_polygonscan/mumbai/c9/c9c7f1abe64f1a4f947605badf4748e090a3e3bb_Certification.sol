...
contract Certification {
    ...
    function withdrawToken(address payable _to,uint _amount) external payable returns (bool) {
    ...
    function generateCertificate(string memory _id, string memory _name, string memory _issuer, string memory _data, uint256 _issuetime, uint256 _validation, address payable _toA) external payable {
