...
contract LamboSaleNew is Ownable {
    ...
    uint public constant MIN_PRESALE_PER_ACCOUNT = 200 * LAMBOdecimals;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 200 * LAMBOdecimals;
    address public constant OLD_CONTRACT_ADDRESS = 0x14F62a8277351573cE6948B31a86B0EfE98E2EE8;

    address public dao;
    ERC20 DAI;
    LAMBOPresale oldContract;
    ...
    constructor() {
        DAI = ERC20(0x99fCa43C08436C7aaD94Dd719b25e25b840F0F0A);
        oldContract = LAMBOPresale(OLD_CONTRACT_ADDRESS);
        dao = 0x57401Bd54957A0aB9d1D5b803Fe82110f31Ce2f6;
    ...
    /* allow non-blacklisted users to buy LAMBO */
    ...
    // set LAMBO token address and activate claiming
    ...
    // claim LAMBO allocation based on old + new invested amounts
    function claimLAMBO() public onlyEOA {
        ...
        if ( invested[msg.sender] > 0 ) {
            ...
            ERC20(LAMBO).transfer(msg.sender, oldContract.invested(msg.sender));
        }
        claimed[msg.sender] = true;
    }

    // token withdrawal by dao
