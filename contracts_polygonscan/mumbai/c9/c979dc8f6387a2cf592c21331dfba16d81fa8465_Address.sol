...
/**
   ...
   I created a black hole so #SafePoly token will deflate itself in supply with every transaction
...
contract SafePoly is Context, IERC20, Ownable {
    ...
    string private _name = "SafePoly";
    string private _symbol = "SafePoly";
