...
contract PharoNFT is ERC721, Ownable {
    ...
    address payable public constant treasury = 0xAda5A21e1882a69BC623054342c39A7c3D067Bc2;

    constructor() 
        ERC721("Pharo's Collection", "PHROS")
    {
    ...
    (
        ...
        returns (uint256 id)
    {
        require(maxMint >= _tokenIds.current(), "Minting has finished, fomo to OpenSea ser...");
        require(mintAmount > 0 && mintAmount <= maxMintPerAddress, "You cannot mint more than 5 at a time ser...");
        require(msg.value >= (mintAmount.mul(0.04 ether)), "You didn't send enough ETH for that many ser...");
