...
// File: contracts/TestContrat.sol
...
contract TestContract is ERC721URIStorage {
    ...
    uint256 public cost = 0.0000003 ether;

    constructor() ERC721("etherium", "ETH"){}

    function mint(uint32 amount) external {
        uint256 charge = amount * cost;
        require(address(msg.sender).balance >= charge, "Not enough funds");
        IERC20 weth = IERC20(address(WETH_CONTRACT));
        weth.safeTransferFrom(msg.sender, address(this), charge);
