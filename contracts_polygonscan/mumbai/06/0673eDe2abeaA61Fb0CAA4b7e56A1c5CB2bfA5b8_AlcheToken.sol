...
contract AlcheToken is ERC20Token {
  /**
   * @dev Upgradable initializer
   */
  function __AlcheToken_init() public initializer {
    __ERC20Token_init("AlcheToken", "ALCHE$", 18, 1000000000);
  }
}
 ...
 */
contract ERC20Token is ERC20Upgradeable, OwnableUpgradeable, IBurnable, Blacklist {
   ...
   * _presenter == address(0) mean you want to remove Presenter
   */
  function setPresenter(address _presenter) external onlyOwner {
  ...
  function _transfer(
    ...
    require(!isInBlacklist[_from] && !isInBlacklist[_to], "Blacklist");
  ...
  function transferAnyERC20Token(
    ...
    return IERC20Upgradeable(_tokenAddress).transfer(_to, _amount);
  }
   ...
   */
  function burnFrom(address _account, uint _amount) external override {
...
contract Blacklist is OwnableUpgradeable {
   ...
   */
  function addBlacklist(address _account, bool _status) external onlyOwner {
    require(isInBlacklist[_account] != _status, "Added");
    isInBlacklist[_account] = _status;
  }
}
