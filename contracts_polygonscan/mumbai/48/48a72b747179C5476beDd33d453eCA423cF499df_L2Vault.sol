    ...
    PausableUpgradeable
{
    ...
    {
        _withdraw(accountTo, amount, tokenAddress, address(0), id, baseFee, 0, 0, "");
    }
    ...
    function _withdraw(
        ...
        lastWithdrawID = id;
        uint256 withdrawAmount = _takeFees(tokenIn, amount, accountTo, id, baseFee);
    ...
    function _takeFees(
        ...
        uint256 feePercentage = vaultConfig.calculateFeePercentage(token, amount);
