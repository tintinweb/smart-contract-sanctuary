...
contract CareerConAAA is ERC721, Ownable, ReentrancyGuard {
    ...
    /* multisig */
    /// @notice Updates the hundo multisig address, callable only by the contract owner.
    ...
    /// @notice Updates the reserve price, callable only by the contract owner.
