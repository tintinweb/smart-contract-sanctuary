...
contract MaticMikeData{
    ...
    **********************************/
    ...
    function populateSVG(uint256 thisTraitIndex, string memory bodysvg) public onlyOwner
    {
        ...
        for (
                ...
                if(j > 0 && j % 100 == 0){
                    bodyMap[thisTraitIndex][index] = svgString;
                    svgString = "";
                    index++;
                }
                string memory thisPixel = MaticMikeLibrary.substring(
            ...
            */
        bodyMap[thisTraitIndex] = bodysvg;
    }
