...
contract KiBridgeV16 is KiBridgeV1Factory {
  ...
  function getUserPendingLiquidityRequestId(
    address _user, 
    uint256 _toChainId
  )
    external 
  ...
  {
    return userInfo[_user].pendingToChainLiquidityRequest[_toChainId].requestId;
  }
