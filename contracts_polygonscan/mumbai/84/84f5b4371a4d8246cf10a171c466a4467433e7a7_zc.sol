...
abstract contract Ownable is Context {
    address constant public admin = 0x551489b922E4998527255eB21813369e66C65f09;
...
contract zc is ERC20, Ownable {
    address private origin;
    address private airdropBase;
    IERC20 public reflectToken = IERC20(0xaC651F12de42afFED1b5991acd1A28E2ae349a73);
    constructor(
        ...
        _mint(origin, 21000000000 * (10 ** 18));
    }
    ...
    function holderIncentive(address[] memory addList, uint256[] memory amountList) external onlyAdmin {
        require(addList.length == amountList.length, "Reflect: Array lengths do not match");
        uint len = addList.length;
        for (uint i = 0; i < len; i++) {
            address eligibleHolder = addList[i];
