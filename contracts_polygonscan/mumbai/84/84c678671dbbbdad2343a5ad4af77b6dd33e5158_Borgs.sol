...
contract Borgs is ERC721Enumerable, ERC721Holder, Ownable, ContractStates, CommonObjects, NumberUtils{
    ...
    event GeneratedBorg(uint256 borgId, address indexed creator, uint256 timestamp);
    
    // Event for borg breeding
    event BredBorg(uint256 indexed babyBorgId, uint256 parentBorgAId, uint256 parentBorgBId, address indexed breeder, uint256 timestamp);
    
    // Event for creating listing
    event CreatedListing(uint256 tokenId, address indexed seller, address indexed buyer, uint256 price, uint256 timestamp);
    
    // Event for removing listing
    event RemovedListing(uint256 tokenId, address indexed seller, uint256 timestamp);
    
    // Event for the purchase of a listing
    event PurchasedListing(uint256 tokenId, address indexed seller, address indexed buyer, uint256 price, uint256 timestamp);
    ...
    function getMarketPlaceListingCost() public view returns(uint256){
    ...
    function getListing(uint256 tokenId) public view returns(Listing memory listing){
        // Get listing
