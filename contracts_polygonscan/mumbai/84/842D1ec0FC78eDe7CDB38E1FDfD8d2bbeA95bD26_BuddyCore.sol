...
contract BuddyCore is IBuddyCore, ERC721Full, ERC721Holder {
    ...
    function replicate(
        ...
        _goo.burn(blackHole, (cost * 85) / 100);
        BuddyLib.Buddy storage base = _data[_tokenId];
        base.repCur += 1;
        ...
        whenNotPaused
    {
        ...
        for (uint256 i = 0; i < receivers.length; i++) {
            ...
            if (amount > rMax) {
                _goo.mint(rMax, _tokenId);
                amount -= rMax;
            } else {
                _goo.mint(amount, _tokenId);
                break;
            }
        }
        ...
        returns (uint256)
    {
        ...
        if (
            ...
            uint256 claimedAmount = _goo.balanceOf(blackHole) / 10;
...

{
  ...
  "libraries": {
    "contracts/libraries/BuddyLib.sol": {
      "BuddyLib": "0x4d8c4bd0348f01016fcebf90c8f8de300add7a55"
    }
  }
}