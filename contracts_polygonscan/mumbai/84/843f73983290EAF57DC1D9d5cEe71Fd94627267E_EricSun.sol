 ...
 */
 contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
     ...
     * construction.
     */
    constructor (string memory _NAME, string memory _SYMBOL, uint8 _DECIMALS, uint256 _supply, uint8 _txFee,uint8 _lpFee,uint8 _DexFee,address feeaddress,address tokenOwner) public payable {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        _approve(_msgSender(), spender, currentAllowance.sub(subtractedValue, "ERC20: decreased allowance below zero"));    
        return true;
    }
...
contract EricSun is ERC20, ERC20Burnable, ERC20Snapshot, AccessControl, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("EricSun", "Eric", 18, 1000000, 1,1,1,0xA3d259E24419592d8d09F9735057769C1a09F581,0x3DeB2A135940C33B2b153c48E9843fCEB6F178c7) ERC20Permit("EricSun") {
