...
contract LotteryContract {
  ...
  bool isLotteryLive;
  uint maxEntries;
  uint maxEntriesPerPlayer;
  uint ethToParticipate; // need to set entry fee to a stable coin
  uint revealTime; // will be set auto set to 1 hour after final entry
  ...
  function participate() public payable {
    ...
    require(msg.value == ethToParticipate * 1 ether, "Invalid entry amount");
