...
contract CoolDogs is ERC721Enumerable, Ownable {
    uint256 public constant MAX_COOLDOGS = 10000;
    using Strings for uint256;
    ...
    // withdraw addresses
    address D = 0x527460bd0F8DAB1159F621c79d8d4B0625dB3901;
    address Z = 0x6462fbdAaBCD5e0ad216BCa40aaA7D30151c9bCd;
    address G = 0x4FE1F8aBEE4d0a7A622F586fAa0Bc2D6cdCFE71B;
    address L = 0xE612f91a893c7753Dd9767Ba62D26ACdD4E3fCbD;
 
    // 10000 CoolDogs in total
    ...
    function _price() public view returns (uint256){
        ...
        if (totalnow >= 9900) {
            return 640000000000000000;         // 9900-10000: 0.64 ETH
        } else if (totalnow >= 9500) {
            return 320000000000000000;         // 9500-9900:  0.32 ETH
        } else if (totalnow >= 8000) {
            return 160000000000000000;         // 8000-9500:  0.16 ETH
        } else if (totalnow >= 4000) {
            return 80000000000000000;          // 5000-8000:  0.08 ETH
        } else if (totalnow >= 2000) {
            return 40000000000000000;          // 3000-5000:  0.04 ETH 
        } else if (totalnow >= 1000) {
            return 20000000000000000;          // 2000-3000:   0.02 ETH 
        } else if (totalnow >= 1000) {
            return 10000000000000000;          // 1000-2000:   0.01 ETH 
        } else {
            return 0;                          // 0 - 1000     0 ETH
        }
    }
