...
contract NFTSellingERC1155 is ERC1155Holder {
    ...
    constructor() {
        //Rinkeby address
        nftObject = ArtisLifeNFT(0xc0389233A5027dfc6C12E4976ec07887EA1a7176);
    ...
    function onERC1155Received(
        ...
        nftsForSale[saleID] = nftInfo(false, id, 0, from, 0);
    ...
    function buy(uint256 saleId) external saleIsActive(saleId) {
        ...
        nftsForSale[saleId].created = false;
        emit NFTBought(saleID, msg.sender, salePrice, fee);
    }

    function cancel(uint256 saleId) external onlySaleOwner(saleId) saleIsActive(saleId) {
        nftObject.safeTransferFrom(
            address(this),
            msg.sender,
            nftsForSale[saleId].nftID,
    ...
    function updatePrice(uint256 saleId, uint256 price)
        external
        onlySaleOwner(saleId) saleIsActive(saleId)
    {
        nftsForSale[saleId].created = true;
