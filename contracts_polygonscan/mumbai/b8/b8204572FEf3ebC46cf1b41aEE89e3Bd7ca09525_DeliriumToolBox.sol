...
contract DeliriumToolBox {

    uint256 public immutable startBlock;
    uint256 public emission1;
    uint256 public emission2;
    uint256 public emission3;
    uint256 public emission4;
    ...
    function getDeliriumRelease(bool isIncreasingGradient, uint256 releaseGradient, uint256 gradientEndBlock, uint256 endEmission, uint256 _from, uint256 _to) external  view returns (uint256) {
        ...
        if (!isFlatEmission(gradientEndBlock, _to)) {
            ...
            console.log("baseEmission", baseEmission);
            console.log("totalWidth", totalWidth);
            console.log("heightDelta", heightDelta);
            console.log("baseEmission", baseEmission / 1e18);
            console.log("isIncreasingGradient", isIncreasingGradient);
            console.log("math", (((totalWidth * heightDelta) / 2) / 1e24));
            // emission1 = baseEmission;
            // emission2 = totalWidth * baseEmission;
            // emission3 = (((totalWidth * heightDelta) / 2) / 1e24);
            // emission4 = (((totalWidth * heightDelta) / 2) / 1e24);
