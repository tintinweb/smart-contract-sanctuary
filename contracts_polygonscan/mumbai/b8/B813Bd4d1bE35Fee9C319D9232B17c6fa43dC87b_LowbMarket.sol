...
contract LowbMarket {
    ...
    function buyItem(address nftAddress, uint itemId, uint amount) public {
        ...
        IERC721LOWB nft = IERC721LOWB(nftAddress);
        require(nft.ownerOf(itemId) == msg.sender && nft.holderOf(itemId) == msg.sender, "Seller no longer owner of this item.");

        require(wallet.isApprovededAddress(msg.sender, address(this)), "You should approve the market to use your wallet.");
