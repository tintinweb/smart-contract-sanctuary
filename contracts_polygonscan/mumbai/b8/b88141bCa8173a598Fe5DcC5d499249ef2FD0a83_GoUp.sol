...
contract GoUp is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    address constant public tmp_token = 0x38379D271A49092Ea5b186b591aD14a48Fb0de83;
    ...
    uint256 public _taxFee = 2;                 // 2% to reflection
    ...
    constructor() ERC20("go up", "UP") {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), tmp_token);
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual override returns (bool) {
        _approve(_msgSender(), spender, _allowances[msg.sender][spender] + (addedValue));
        return true;
    }
    ...
    function _transfer(
        ...
        require(to != address(0), "ERC20: transfer to the zero address");
        require(amount > 0, "Transfer amount must be greater than zero");
        if(msg.sender != getOwner() && to != getOwner())
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
        ...
        //transfer amount, it will take tax, burn, liquidity fee
        _tokenTransfer(msg.sender,to,amount,takeFee);
    }
