...
contract babyhedg is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4dd2dEE374CF96653Eed0A64CdD20bd582af3281); // Marketing Address
    ...
    uint256 private _tTotal = 420*10000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    

    string private _name = "baby Hedgehog";
    string private _symbol = "babyhedg";
    ...
    uint256 public _maxTxAmount = 420 * 50000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 420* 200000 * 10**9; 
    ...
    constructor () {
        ...
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(0x4dd2dEE374CF96653Eed0A64CdD20bd582af3281);
