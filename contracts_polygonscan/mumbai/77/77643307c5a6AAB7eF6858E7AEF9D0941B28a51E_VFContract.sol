    ...
    ContextMixin
{
    ...
    uint256 public _tokenId; //last token minted
    ...
    function mint(
        ...
        require(
            !withdrawnTokens[_tokenIdTracker.current()],
            "VFContract: TOKEN_EXISTS_ON_ROOT_CHAIN"
        );
        _setAssetStateOnMint(_tokenIdTracker.current(), newAsset);
