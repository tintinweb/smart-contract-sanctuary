...
contract PledgeUpgradeable is ContextUpgradeable,AccessControlEnumerableUpgradeable,OwnableUpgradeable{
    ...
    function initialize(address _rewardCardAddress) public initializer {
        init();
        __Ownable_init();
        __Context_init();
    ...
    function openAward(uint256 _tokenId) public virtual {
        ...
        require(licensingRounds[_tokenId] == 0,"No need to open it again");
    ...
    function claimAward(uint256[] memory _tokenIds) public virtual {
        for(uint256 i = 0; i < _tokenIds.length ; i++){
            ...
            require(licensingRounds[_tokenId] > 0,"Please perform openAward");
            require(_msgSender() == IRewardCard(rewardCardAddress).ownerOf(_tokenId), "This NFT doesn't belong to this address");
