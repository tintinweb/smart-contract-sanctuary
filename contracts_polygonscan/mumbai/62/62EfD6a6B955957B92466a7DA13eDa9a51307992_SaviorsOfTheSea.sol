...
contract SaviorsOfTheSea is ERC721, ERC721URIStorage, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public constant MAX_SS_AT_MINT = 7;

    uint256 public mintPrice = 77.77 ether; // ~0.04 ETH

    address WITHDRAW_ADDR = 0x1B4691F27B3E0A3eB202a9deffd17d4D26Ee984B;
    ...
    */
    ...
    /*
    * Mint Saviors of the Sea
    */
    function createSavior() public payable {
        require(saleIsActive, "Sale must be active to buy a Savior.");
        require(balanceOf(msg.sender).add(1) <= MAX_SS_AT_MINT, "While minting, you can only hold 7 Saviors at a time.");
        require(totalSupply().add(1) <= maxTokenSupply, "Purchase would exceed max available Saviors.");
        require(mintPrice <= msg.value, "MATIC value sent is not correct");
