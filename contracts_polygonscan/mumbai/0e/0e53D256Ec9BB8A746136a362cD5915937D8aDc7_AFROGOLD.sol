...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xbdd4e5660839a088573191A9889A262c0Efc0983); //QUICKSWAP TESTNET
        _token = msg.sender;
    }
...
contract AFROGOLD is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AFROGOLD";
    string constant _symbol = "AFROGOLD";
    ...
    constructor() Auth(msg.sender) {
        router = IDEXRouter(0xbdd4e5660839a088573191A9889A262c0Efc0983); //QUICKSWAP TESTNET
        ...
        marketingFeeReceiver = 0x0138122bA272405f9cD7aeD354321910923888Ae; // marketing
        devFeeReceiver = 0x988A5c13b521F5Cb0486a3FE2Bed597247c44F07; // buybacks and giveways
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountMATICMarketing = amountMATIC.mul(marketingFee).div(
            totalMATICFee
        );
