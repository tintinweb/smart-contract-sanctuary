...
contract TradeRacer is Initializable, AccessControlUpgradeable, PausableUpgradeable  {
    IERC721 public RACE;
    IERC20 public KRL;
    ...
    function listRacer(uint _tokenId, uint _price) public onlyOwner(_tokenId) {
        ...
        trades[_tokenId].seller = RACE.ownerOf(_tokenId);
    ...
    function cancelRacer(uint _tokenId) public onlyOwner(_tokenId) {
