...
contract Cyber9Token is Initializable, ERC20Upgradeable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable{
  ...
  modifier validCaller virtual{
    require(
      ...
      msg.sender == cyber9_items, "Invalid caller");
    _;
  }
  ...
  function setCyber9Dependencies(address _collectionAddress, address _itemsAddress) external onlyOwner{
    cyber9Contract = _collectionAddress;
    cyber9_items = _itemsAddress;
  }
