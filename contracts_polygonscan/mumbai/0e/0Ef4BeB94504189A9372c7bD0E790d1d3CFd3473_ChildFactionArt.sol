    ...
    ContextMixin
{
    ...
    */
    ...
    function mint(
        ...
        require(((id <= MAX_TOKEN_ID) && (id > uint(0))), "ChildFactionArt: INVALID_TOKEN_ID");
        require(((amount > uint(0)) && (amount == restTotalSupply(id, amount))) , "ChildFactionArt: INVALID_TOKEN_AMOUNT");
    ...
    function mintBatch(
        ...
        for (uint i = 0; i < ids.length; i++) {
            require(((ids[i] <= MAX_TOKEN_ID) && (ids[i] > uint(0))), "ChildFactionArt: INVALID_TOKEN_ID");
            require(((amounts[i] > uint(0)) && (amounts[i] == restTotalSupply(ids[i], amounts[i]))) , "ChildFactionArt: INVALID_TOKEN_AMOUNT");
        }
    ...
    function restTotalSupply(uint256 _id, uint256 _amount) private view returns (uint256) {
      ...
      require(( subtotal <= maxSupply(_id)), "ChildFactionArt: EXCEED MAX_AMOUNT");
      return _amount;
    }
