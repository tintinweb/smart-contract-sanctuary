...
// Root file: contracts/TestSeedSale.sol
...
/// @title Seed Sale
contract TestSeedSale is ReentrancyGuard, Ownable {
    ...
    function sell(uint256 _amount) external nonReentrant {
        ...
        _deliverTokens(saleToken, _msgSender(), tokensSold);
