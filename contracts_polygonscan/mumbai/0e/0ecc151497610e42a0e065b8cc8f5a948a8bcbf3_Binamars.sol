...
contract Binamars is ERC721, Ownable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;
    ...
    modifier onlySpawner() {
        require(spawners[_msgSender()], "only Spawner.");
        _;
    }

    modifier onlyMigration() {
        require(migrator == _msgSender(), "only Migrator.");
        _;
    }
    ...
    function migrate(
        ...
        emit Migration(nextTokenId, to, _level, _exp, _bornAt);
    }
    ...
    function setMarket(address _market, bool _bool) public onlyOwner {
        markets[_market] = _bool;
    }

    function setSpawner(address _spawner, bool _bool) public onlyOwner {
        spawners[_spawner] = _bool;
    }
