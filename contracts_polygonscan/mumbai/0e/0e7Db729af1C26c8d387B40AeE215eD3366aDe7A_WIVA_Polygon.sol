...
contract WIVA_Polygon is ERC20, ERC20Burnable, ERC20Snapshot, ERC20Capped, Ownable {
    // keeping it for checking, whether deposit being called by valid address or not
    address public childChainManagerProxy;

    constructor(address _childChainManagerProxy) ERC20("WIVA", "WIVA") ERC20Capped(200000000 * (10 ** 18)) {
