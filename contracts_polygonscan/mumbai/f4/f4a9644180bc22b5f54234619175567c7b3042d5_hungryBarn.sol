...
contract hungryBarn is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    {
        require(!mintPaused);
        require(amount + totalSupply(id) <= 6000);
    ...
    function batchMint(address _to,uint256[] memory _ids, uint256[] memory _amounts, bytes memory _data) 
        ...
        {
            require(_amounts[i] + totalSupply(_ids[i]) <= 6000);
        }
