...
contract AccessNFT is ERC1155PresetMinterPauser, IERC1155Receiver, ERC2771Context, IERC2981 {
    ...
    function supportsInterface(bytes4 interfaceId) public pure override(ERC1155PresetMinterPauser, IERC165) returns (bool) {
        return interfaceId == type(IERC1155Receiver).interfaceId || interfaceId == type(IERC1155).interfaceId || interfaceId == type(IERC2981).interfaceId;
    }
