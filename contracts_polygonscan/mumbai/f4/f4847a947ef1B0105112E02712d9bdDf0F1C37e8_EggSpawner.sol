...
// File contracts/nft/codecs/EggCodec.sol
...
library EggCodec {
    ...
    */
    ...
    /**
        @notice Is card of `token_` 0 (rare)?
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Is card of `token_` 1 (uncommon)?
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Wallet of minter of `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Get the address of the sender shifted to fit in the allocated space in the token
    ...
    */
    ...
    /**
        @notice Is sender minter of `token_`?
        @param token_ Token
    ...
    */
    ...
    /**
        @notice All egg data for `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the card bits of `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the card bits of `token_` to be card 0 (rare)
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the card bits of `token_` to be card 1 (uncommon)
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the magic bits of `token_`
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the magic bits of `token_` to be 5
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the magic bits of `token_` to be 10
        @param token_ Token
    ...
    */
    ...
    /**
        @notice Set the card and magic bits of `token_` for a rare egg
        @param token_ Token
    ...
    */
        ...
        returns (uint256 tokenWithCardAndMagic_)
    {
     ...
     /**
        @notice Set the wallet bits of `token_` to the shifted address of sender
        @param token_ Token
...
// File contracts/nft/EggSpawner.sol
...
contract EggSpawner is Ownable {
    ...
    function spawnEgg() external duringSale {
        if (0 < rate) {
            usdc.safeTransferFrom(msg.sender, teamWallet, rate);
        }
        ...
        if (Phase.RARE == phase) {
            ...
            require(
                0 == uncommonEggs[msg.sender],
                "Already have Uncommon egg"
            );
