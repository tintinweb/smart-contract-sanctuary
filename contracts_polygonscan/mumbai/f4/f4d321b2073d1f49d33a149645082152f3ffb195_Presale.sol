...
contract Presale is ReentrancyGuard {
    ...
    address public Dev_ADDRESS = tx.origin;
    ...
    uint256 public endingPresaleTimestamp;
    uint256 public startingClaimTimestamp;

    uint256 public totaltokenSold = 0;
    uint256 public totalUSDcollected = 0;

    uint256 public USDPerTokenPresale;
    uint256 public USDPerTokenLaunch;

    uint256 public TOKEN_HARDCAP;
    uint256 public USD_HARDCAP;

    uint256 public timePerPercent;

    uint256 public USDLpPercent;
    uint256 public USDMarketingPercent;
    uint256 public USDDevPercent;

    uint256 public TOKENDevPercent;
    uint256 public TOKENContributorPercent;
    ...
    constructor(
        ...
        require(_USDDistribution[2]>=5, "USDDevPercent needs to be greater than 0.5");
    }
