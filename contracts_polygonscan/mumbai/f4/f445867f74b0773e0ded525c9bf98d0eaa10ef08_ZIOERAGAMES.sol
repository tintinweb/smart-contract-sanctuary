...
contract ZIOERAGAMES is Ownable, ERC721Enumerable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721("ZIOERAGAMES", "ZIOEG") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmQkBBSVHthwEu9c9gYg9EFfq87nXMYAzi34v3F5sDpz9m';
