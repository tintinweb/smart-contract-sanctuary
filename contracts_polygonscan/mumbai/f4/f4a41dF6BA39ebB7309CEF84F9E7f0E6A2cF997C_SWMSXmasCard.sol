...
contract SWMSXmasCard is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    constructor() ERC721("SWMS NFT Collection 2021","FSTCC") {
        _tokenIds.increment();
        _owner = msg.sender;
    }
        ...
        returns (string memory)
    {
        string memory json = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Cristmas Card 2021 #',
                        Strings.toString(_tokenId),
                        "/",
                        Strings.toString(nftHolderAttributes[_tokenId].countCards),
                        
                        '", "description": "This is our first Christmas Card NFT. Next year you will be able to claim ...", "image": "',
