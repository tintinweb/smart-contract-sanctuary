...
// File contracts/sale/GBotsSale.sol


pragma solidity >=0.7.6 <0.8.0;
contract GBotsSale is FixedPricesSale {
    ...
    constructor(
        ...
        require(inventory_ != address(0), "GBotsSale: zero address inventory");
        // solhint-disable-next-line reason-string
        require(tokenHolder_ != address(0), "GBotsSale: zero address token holder");
    ...
    function createSku(
        ...
        require(tokenId != 0, "GBotsSale: zero token ID");
