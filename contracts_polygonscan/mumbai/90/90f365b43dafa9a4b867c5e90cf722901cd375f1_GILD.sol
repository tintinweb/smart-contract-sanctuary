...
contract GILD is IERC20, Context, Ownable{
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GILD";
    string private _symbol = "$GILD";
    ...
    uint256 public _totalSupply = 50000000000 * 10**18;
    ...
    function burnToken(uint256 amount) external onlyOwner {
        require(_totalSupply - amount >= _runningSupply, "ERC20: Cannot burn more than the total supply!");
        _totalSupply -= amount;
