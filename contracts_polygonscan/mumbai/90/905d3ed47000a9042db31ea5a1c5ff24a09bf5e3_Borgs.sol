...
contract Borgs is ERC721Enumerable, ERC721Holder, CommonObjects, NumberUtils{
    ...
    function addLayerItems(CreateLayerItems[] memory createLayerItems) external onlyOwner editable{
    ...
    function createBorgAttribute(string memory borgAttributeName, string[] memory colors, uint32[][] memory positions) external onlyOwner editable{
