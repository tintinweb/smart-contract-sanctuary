...
contract PolygonSandClaim is Ownable {
    ...
    constructor(IPolygonSand polygonSand, IPolygonSand fakePolygonSand) {
        _polygonSand = polygonSand;
        _fakePolygonSand = fakePolygonSand;
        endOfClaimPeriod = block.timestamp + 730 days; // two years
    }
    ...
    function claim(uint256 amount) external {
        ...
        bool success = _fakePolygonSand.transferFrom(msg.sender, self, amount);
        if (success) {
