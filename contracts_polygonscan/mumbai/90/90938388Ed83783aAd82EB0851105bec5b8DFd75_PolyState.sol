 ...
 */
contract PolyState is FxBaseChildTunnel, Ownable {
    ...
    function _processMessageFromRoot(
        ...
        (address nftAddress, uint256 tokenId, string memory _tokenURI) = abi
            .decode(data, (address, uint256, string));
        tokenURI[nftAddress][tokenId] = _tokenURI;
        isDeposited[nftAddress][tokenId] = true;
    }

    function withdraw(address nft, uint256 tokenId) public onlyOwner {
        _sendMessageToRoot(abi.encodePacked(nft, tokenId));
    }
}
