...
contract AftrMrkt is ERC1155, Ownable, VRFConsumerBase {
    ...
    string public baseURI =
        "https://gateway.pinata.cloud/ipfs/QmdnRRLGUAJDzgcKHTd4HPFT8gH9wPzR6gRxCSEQgBKy6q";
    ...
    function setBaseURI(string memory _baseURI) public onlyOwner {
        require(
            ...
            "ERC1155NFT::setBaseURI: Invalid base URI."
        );
        baseURI = _baseURI;
    }
    ...
    function buyPremiumPack() external payable preCheck {
        require(
            PremiumPack > 0,
            "Contract::buyPremiumPack: PremiumPacks are sold out."
        );
        require(
        ...
        require(
            msg.value <= PremiumPackFee,
            "Contract::buyPremiumPack: Insufficient amount."
        );
    ...
    function buyFreshPack() external payable preCheck {
        require(
            FreshPack > 0,
            "Contract::buyFreshPack: FreshPacks are sold out."
        );
        require(
            LINK.balanceOf(address(this)) >= fee,
            "Not enough LINK - fill contract with faucet"
        ...
        require(
            msg.value <= FreshPackFee,
            "Contract::buyFreshPack: Insufficient amount."
        );
        bytes32 requestId = requestRandomness(keyHash, fee);
    ...
    function buyBasePack() external payable preCheck {
        ...
        require(
            msg.value <= BasePackFee,
            "Contract::buyBasePack: Insufficient amount."
        );
        bytes32 requestId = requestRandomness(keyHash, fee);
    ...
    function givePremiumPack(uint256 _randomNumner, bytes32 _requestId)
        internal
    {
    ...
    function giveCommonCard(uint256 _randomNumner, bytes32 _requestId)
        internal
    {
    ...
    function withdraw() external onlyOwner {
        require(
            ...
            "Contract::withdraw: Not enough ETH."
        );
