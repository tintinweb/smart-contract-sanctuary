...
contract NFTapirCurations is ERC721, Pausable, AccessControl, ERC721Burnable, ERC2981PerTokenRoyalties {
    ...
    constructor() ERC721("NFTapir Curations", "TAPIRS") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://dev.nftapir.com/token/";
    }
    ...
    function safeMint(address to, uint256 royaltyValue) public onlyRole(MINTER_ROLE) {
        _safeMint(to, _tokenIdCounter.current());
        if (royaltyValue > 0) {
            _setTokenRoyalty(_tokenIdCounter.current(), to, royaltyValue);
        }
