...
contract PixelSale is Ownable, Pausable {
...
* @param _tokenId uint256 token ID (nft number)
*/
function purchaseToken(uint256 _tokenId) public payable whenNotPaused {
require(msg.sender != address(0) && msg.sender != address(this));
require(msg.value >= currentPrice);
address payable tokenSeller = payable(nftAddress.ownerOf(_tokenId));
...
emit Sent(tokenSeller, msg.value, address(this).balance);
}
