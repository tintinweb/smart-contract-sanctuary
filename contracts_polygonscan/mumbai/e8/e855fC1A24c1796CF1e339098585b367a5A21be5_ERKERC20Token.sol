...
*/
contract ERKERC20Token is SafeMath {
    uint8 public constant decimals = 8; // it's recommended to set decimals to 8 in Eureka

    string public constant name = 'EUREKA';
    string public constant symbol = 'ERK';
