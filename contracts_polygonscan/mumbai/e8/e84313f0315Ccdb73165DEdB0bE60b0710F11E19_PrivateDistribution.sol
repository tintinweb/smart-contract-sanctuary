...
contract PrivateDistribution is Ownable {
        ...
        returns (uint256 availablePercentage)
    {
        ...
        uint256 vestingDuration = _initialTimestamp + 525 days;
        ...
        if (currentTimeStamp > _initialTimestamp) {
            if (allocationType == AllocationType.PRIVATE) {
                ...
                uint256 initialReleasePercentage = uint256(5129629629).mul(1e18).div(100000000);
                uint256 remainingDistroPercentage = uint256(4870370371).div(100000000);
