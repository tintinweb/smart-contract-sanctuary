...
// File contracts/openzepplin-contracts/security/ReentrancyGuard.sol
...
// File contracts/openzepplin-contracts/token/ERC20/IERC20.sol
...
// File contracts/openzepplin-contracts/utils/introspection/IERC165.sol
...
// File contracts/openzepplin-contracts/token/ERC721/IERC721.sol
...
// File contracts/streak/IERC721Streak.sol
...
// File contracts/streak/DropMinting.sol
...
contract DropMinting is ReentrancyGuard, Ownable {
    ...
    */
     ...
     */
    function dropMint(string[] memory _tokenUri) external nonReentrant returns(uint256[] memory) {
        ...
        uint256[] memory _tokenIds = new uint256[](_tokenUri.length);
        for (uint256 i = 0; i < _tokenUri.length; i++) {
            uint256 tokenId = token.mintItem(msg.sender, _tokenUri[i]);
            ...
            emit DropMintingFinished(msg.sender, tokenId, price, _tokenUri[i]);
        }
      return _tokenIds;
    }
