...
contract BuddyCore is IBuddyCore, ERC721Full, ERC721Holder {
    ...
    function buyGen0() external whenNotPaused {
        ...
        require(
            getTokenId() > 11 || msg.sender == owner(),
    ...
    function replicatePreview(
        ...
        uint256 grossGPD = calcGGPD(_tokenId, false, true);
        ...
        returns (uint256)
    {
        ...
        uint256 grossGPD = calcGGPD(_tokenId, false, false);
    ...
    {
        BuddyLib.Buddy storage base = _data[_tokenId];
        uint256 ggpd = (_buddyLogic.calcGGPD(base, false, false)) * 90;
        return ggpd * 1e18;
    }
...
interface IBuddyLogic {
    ...
    function calcGGPD(BuddyLib.Buddy calldata base, bool GPD, bool recessiveBonus)
        external
        pure
        returns (uint256);
...

{
  ...
  "libraries": {
    "contracts/libraries/BuddyLib.sol": {
      "BuddyLib": "0x648b314de23c4c793c5d5305fb21af1f8037a1a7"
    }
  }
}