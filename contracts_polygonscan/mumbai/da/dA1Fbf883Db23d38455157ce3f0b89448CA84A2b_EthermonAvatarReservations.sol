...
contract EthermonAvatarReservations is AccessControl {
    ...
    uint256 public tokenPrice = uint256( 35 * 10**15 ); // 0.035 eth 
    ...
    uint256 public mintingCap = 3; // 2000 mints on eth mainnet
    ...
    uint256 public tokenPriceEMON = uint256(2500 * 10**18); // = 2500 EMON paid to mint
    ...
    function togglePauseMintUsingEMON(bool _pause) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Caller is not admin");
