...
contract ChatterNft is ERC721Enumerable, AccessControl {
    using Strings for uint256;
  //  event Mint(address indexed sender, uint256 startWith, uint256 times);
    ...
    constructor(string memory name_, string memory symbol_,  
        ...
        _setupRole(MINTER_ROLE, address(0x59aC47334982656De74755FF07ed43eAB0E14D36));
        _setupRole(MINTER_ROLE, address(0xC51D4526feD1B9C643851BEa7B0d3Db169e5EB09));
        _setupRole(MINTER_ROLE, address(0xCC8DB8a5AF2a31EA50929718BA0E265B8AaCC9B5));
    }
    mapping (uint256 => string) private _tokenURIs;
