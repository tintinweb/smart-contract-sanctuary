...
// File: @maticnetwork/pos-portal/flat/ChildMintableERC20.sol
...
contract PolygonToken is ChildMintableERC20 {
    constructor(address childChainManager) public ChildMintableERC20("Foo Token (POS)", "FT(POS)", 18, childChainManager) {
