...
contract IdleHero is IIdleHero, ERC721URIStorage, ERC721Enumerable
{
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    // Mapping from token ID to hero dna
    mapping(uint256 => uint256) private _heroDNAs;
    ...
    function safeMintHero(address to, uint256 dna) public override returns (uint256) {
        _tokenIds.increment();
    ...
    function _setHeroDNA(uint256 tokenId, uint256 dna) internal {
        _heroDNAs[tokenId] = dna;
    }
