 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Ownable, ERC165, IERC721 {
    ...
    */
    function setNameAndSymbol(string memory name_) public onlyOwner {
        _name = name_;
    }
...
contract Borgs is ERC721Enumerable, ERC721Holder, ContractStates, CommonObjects, NumberUtils{
