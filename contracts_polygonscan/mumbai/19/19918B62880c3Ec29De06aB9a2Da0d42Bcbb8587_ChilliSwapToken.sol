...
contract ChilliSwapToken is Ownable , IERC20 {
    ...
    event blackListUsers(address indexed user);
    ...
    constructor () public{
        ...
        _symbol = "ChilliSwapToken";
        _balances[msg.sender] = 3000000*(10**uint256(_decimals)); // total supply 300 million
    ...
    function addUserToBlackList(address _user) external onlyOwner returns(bool){
         blackList[_user] = true;
         emit blackListUsers(_user);
         return true;
    }

    function removeUserFromBlackList(address _user) external onlyOwner returns(bool){
