...
contract PFToken is IERC20, Ownable {
    ...
    string constant _name = "PFT";
    string constant _symbol = "PetFi";
    ...
    // bool private _marketingFeeEnabled;  
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _balances[sender], "ERC20 transfer: insufficient balance");        
        ...
        _balances[recipient] = _balances[recipient] + (amount - marketingFeeAmount - LiquidityFeeAmount);
