...
contract Simba is ERC20 {
    ...
    function Set_Stage1_Burn(uint _Stage1_Burn) public {
        if(msg.sender == owner) {
            Stage1_Burn = _Stage1_Burn;
        }
    }
    function Set_Stage1_Tax(uint _Stage1_Tax) public {
        if(msg.sender == owner) {
            Stage1_Tax = _Stage1_Tax;
        }
    }
    function Set_Stage2_Burn(uint _Stage2_Burn) public {
        if(msg.sender == owner) {
            Stage2_Burn = _Stage2_Burn;
        }
    }
    function Set_Stage2_Tax(uint _Stage2_Tax) public {
        if(msg.sender == owner) {
            Stage2_Tax = _Stage2_Tax;
        }
    }
    function Set_Stage3_Burn(uint _Stage3_Burn) public {
        if(msg.sender == owner) {
            Stage3_Burn = _Stage3_Burn;
        }
    }
    function Set_Stage3_Tax(uint _Stage3_Tax) public {
        if(msg.sender == owner) {
            Stage3_Tax = _Stage3_Tax;
        }
    }
    function Set_Stage4_Burn(uint _Stage4_Burn) public {
        if(msg.sender == owner) {
            Stage4_Burn = _Stage4_Burn;
        }
    }
    function Set_Stage4_Tax(uint _Stage4_Tax) public {
        if(msg.sender == owner) {
            Stage4_Tax = _Stage4_Tax;
        }
    }
    function Set_Stage5_Burn(uint _Stage5_Burn) public {
        if(msg.sender == owner) {
            Stage5_Burn = _Stage5_Burn;
        }
    }
    function Set_Stage5_Tax(uint _Stage5_Tax) public {
        if(msg.sender == owner) {
            Stage5_Tax = _Stage5_Tax;
        }
    }
    function Set_Stage6_Burn(uint _Stage6_Burn) public {
        if(msg.sender == owner) {
            Stage6_Burn = _Stage6_Burn;
        }
    }
    function Set_Stage6_Tax(uint _Stage6_Tax) public {
        if(msg.sender == owner) {
            Stage6_Tax = _Stage6_Tax;
        }
    }
    function Set_Stage7_Burn(uint _Stage7_Burn) public {
        if(msg.sender == owner) {
            Stage7_Burn = _Stage7_Burn;
        }
    }
    function Set_Stage7_Tax(uint _Stage7_Tax) public {
        if(msg.sender == owner) {
            Stage7_Tax = _Stage7_Tax;
        }
    }
    function Set_Stage8_Burn(uint _Stage8_Burn) public {
        if(msg.sender == owner) {
            Stage8_Burn = _Stage8_Burn;
        }
    }
    function Set_Stage8_Tax(uint _Stage8_Tax) public {
        if(msg.sender == owner) {
            Stage8_Tax = _Stage8_Tax;
        }
    }
    function Set_Stage9_Burn(uint _Stage9_Burn) public {
        if(msg.sender == owner) {
            Stage9_Burn = _Stage9_Burn;
        }
    }
    function Set_Stage9_Tax(uint _Stage9_Tax) public {
        if(msg.sender == owner) {
            Stage9_Tax = _Stage9_Tax;
        }
    }
    function Set_Stage10_Burn(uint _Stage10_Burn) public {
        if(msg.sender == owner) {
            Stage10_Burn = _Stage10_Burn;
        }
    }
    function Set_Stage10_Tax(uint _Stage10_Tax) public {
        if(msg.sender == owner) {
            Stage10_Tax = _Stage10_Tax;
        }
    }
    function Set_Stage11_Burn(uint _Stage11_Burn) public {
        if(msg.sender == owner) {
            Stage11_Burn = _Stage11_Burn;
        }
    }
    function Set_Stage11_Tax(uint _Stage11_Tax) public {
        if(msg.sender == owner) {
            Stage11_Tax = _Stage11_Tax;
        }
    }
    function Set_Stage12_Burn(uint _Stage12_Burn) public {
        if(msg.sender == owner) {
            Stage12_Burn = _Stage12_Burn;
        }
    }
    function Set_Stage12_Tax(uint _Stage12_Tax) public {
        if(msg.sender == owner) {
            Stage12_Tax = _Stage12_Tax;
        }
    }
