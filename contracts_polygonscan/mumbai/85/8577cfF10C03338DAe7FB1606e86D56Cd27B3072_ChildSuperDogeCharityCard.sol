...
import "./common/ChildMintableERC1155.sol";

contract ChildSuperDogeCharityCard is ERC1155, ChildMintableERC1155
{
    ...
    constructor(string memory uri)
        ChildMintableERC1155(uri) {
        _initRoles();
    }

    /**
     * @dev Initializes access roles.
     */
    ...
    function _msgSender() internal view override(Context, ChildMintableERC1155) virtual returns(address) {
        return super._msgSender();
    }

    function supportsInterface(bytes4 interfaceId) public view override(ERC1155, ChildMintableERC1155) returns(bool) {
...

{
    ...
    function supportsInterface(bytes4 interfaceId) public view override(AccessControlMixin, ERC1155) virtual returns(bool) {
        return super.supportsInterface(interfaceId);
    }
}
