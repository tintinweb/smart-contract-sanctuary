...
contract KeokiGames is Ownable, ERC721Enumerable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721("Keoki Games", "KGAMES") {manager = payable(msg.sender);}
  ...
  string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmZj7p1G7JioKWXJb4Evbd5VL6awxhJ411xndX3vdWX4AG';
