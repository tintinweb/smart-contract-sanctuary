...
contract GenesisNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public _price = .044 ether;
    uint256 public _maxSupply = 444;
    uint256 public _maxMintAmount = 4;
    uint256 public _reserved = 1;
    bool public _saleIsActive = false;

    // creator
    address a1 = 0xc087B27653274aaF6da8e10d8EFf6D6bB9D27E13;

    constructor(string memory baseURI) ERC721("Genesis Dots", "GENDOTS") {
        setBaseURI(baseURI);
    ...
    function mint(uint256 mintCount) public payable {
        ...
        require(mintCount > 0,                                  "Mint count must be greater than zero");
        require(mintCount <= _maxMintAmount,                    "Exceeds max mint count");
        require(supply + mintCount <= _maxSupply - _reserved,   "Exceeds max supply");
        require(msg.value >= _price * mintCount,                "Insufficient payment amount");
