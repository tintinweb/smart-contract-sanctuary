...
contract Bling_Collection is
  ...
  NFT721Mint
{
    address private bling_master;
    
    constructor(address payable treasury,string memory name, string memory symbol, uint256 supply) {
        bling_master = msg.sender;
        initialize(treasury,name,symbol,supply);
  ...
  /*function initialize(
   ...
   function initialize(
    ...
    require(msg.sender == bling_master);  
    FoundationTreasuryNode._initializeFoundationTreasuryNode(treasury);
