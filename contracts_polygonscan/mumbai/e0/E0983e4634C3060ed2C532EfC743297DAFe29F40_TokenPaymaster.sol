...
import "../uniswap/ISwapHelper.sol";
...
contract TokenPaymaster is BasePaymaster {
    ...
    constructor(
        ...
        matic = IERC20(WMATIC);
        weth9 = IERC20(WETH9);
        swapHelper = ISwapHelper(uniswap);
        quoter = IQuoter(_quoter);
        //gasUsedByPost = 50000000;
        // uniswaps = _uniswaps;
    ...
    {
        // marketplace call
        uint256 postCallLimit = 610000; // POST_RELAYED_CALL_GAS_LIMIT
        return
        ...
        returns (bytes memory context, bool revertOnRecipientRevert)
    {
        ...
        // (IERC20 token, IUniswap uniswap) = _getToken(
        ...
        //matic.transferFrom(payer, address(this), tokenPrecharge);
        return (
            abi.encode(payer, tokenPrecharge, matic, swapHelper, quoter),
            false
        );
    }
    ...
    function postRelayedCall(
        ...
        (
            ...
            IQuoter quoter
                ...
                context,
                (address, uint256, IERC20, ISwapHelper, IQuoter)
            );
    ...
    function _postRelayedCallInternal(
        ...
        //  factory.getPool(address(matic), address(weth9), 3000)
        // );
        // uint256 tokenRefund = tokenPrecharge.sub(tokenActualCharge);
        // _refundPayer(payer, token, tokenRefund);

        // How many weth is needed for specified amount of matics
        uint256 maticToWeth = quoter.quoteExactInputSingle(
            address(matic),
            address(weth9),
            3000,
            ethActualCharge,
        ...
        //uint256 tokenActualCharge = wethToMatic * ethActualCharge;
        _depositProceedsToHub(ethActualCharge, maticToWeth, uniswap);
    ...
    function _depositProceedsToHub(
        ...
        uniswap.swapExactOutputSingle(ethActualCharge, tokenActualCharge);
        // gas fee (matic) -> (weth)
...
contract TestToken is ERC20("Wrapped Ethereum", "WETH") {
