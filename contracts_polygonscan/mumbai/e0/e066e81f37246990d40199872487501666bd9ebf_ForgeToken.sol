...
contract ForgeToken is ERC20("Forge", "FRG"), Ownable {
    ...
    /// @dev A checkpoint for marking number of votes from a forgen block
    struct Checkpoint {
        uint32 fromBlock;
        uint256 votes;
    }
    ...
    */
     ...
     * @return The number of votes the account had as of the forgen block
     */
