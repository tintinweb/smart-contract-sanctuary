...
contract WBANLPRewards is ERC1155PresetMinterPauserUpgradeable, OwnableUpgradeable, ContextMixin {
    ...
    uint256 public constant SHRIMP = 0;
    uint256 public constant SHARK = 1;
    uint256 public constant WHALE = 2;

    // address constant openSeaProxyRegistryAddress = 0x207Fa8Df3a17D96Ca7EA4f2893fcdCb78a304101;
    address openSeaProxyRegistryAddress;

    /*
    function initialize(string memory uri) public virtual initializer override {
        __ERC1155PresetMinterPauser_init(uri);
        __Ownable_init();
        name = "wBAN LP Rewards";
        _mint(_msgSender(), 0, 10, "");
    }
    */

    function do_initialize(string memory uri, address _openSeaProxyRegistryAddress) public virtual initializer {
        __ERC1155PresetMinterPauser_init(uri);
        __Ownable_init();
    ...
    function contractURI() public view returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/Qma1nxTZGTXHjMg6tcNGcNiHJVLpzKesnZJT8gYwG93X1a";
    }
    */
