...
*/
contract SOTERC20Token is SafeMath {
    uint8 public constant decimals = 18; // it's recommended to set decimals to 8 in Eureka

    string public constant name = 'Social Token';
    string public constant symbol = 'SOT';
    //Default assumes totalSupply can't be over max (2^256 - 1).
    //you need multiply 10^decimals by your real total supply.
    uint256 public totalSupply = 550000000 * 10**uint256(decimals);
