...
contract KiBridgeV1Factory is IKiBridgeV1Factory, KiBridgeV1LiquidityDeployer {
    ...
    returns (address liquidity)
  {
    ...
    liquidity = deploy(address(this), _token);
...
interface IKiBridgeV1Factory {
  ...
  event LiquidityCreated(address indexed token, address indexed liquidity, uint);

  function createLiquidity(address _token) external returns (address liquidity);
