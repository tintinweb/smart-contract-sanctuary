...
// hevm: flattened sources of /nix/store/9562cr0d7ld8jb3ba5jdn2xyk9cx9kxs-h2o-governance-actions/dapp/h2o-governance-actions/src/DeployOSMandWrapper.sol
...
////// /nix/store/n9q4i4x8k6az7jv4dl3rkjmdw2kjdr20-geb-fsm/dapp/geb-fsm/src/OSM.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/9562cr0d7ld8jb3ba5jdn2xyk9cx9kxs-h2o-governance-actions/dapp/h2o-governance-actions/src/DeployOSMandWrapper.sol
/* pragma solidity 0.6.7; */

/* import {ExternallyFundedOSM} from "geb-fsm/OSM.sol"; */
/* import {FSMWrapper} from "geb-fsm/FSMWrapper.sol"; */

abstract contract LiquidationEngineLike_6 {
    function addAuthorization(address) external virtual;
}

abstract contract StabilityFeeTreasuryLike_6 {
...
abstract contract FsmGovernanceInterfaceLike_2 {
    function setFsm(bytes32, address) external virtual;
}

abstract contract OracleRelayerLike_4 {
...
contract DeployOSMandWrapper {
    // --- Variables ---
    uint256 public constant RAY = 10**27;
    event OsmAndWrapperDeployed(address indexed osm, address indexed wrapper);
    function execute(address _treasury, address ethMedianizer, address fsmGovernanceInterface) public returns (address) {
        return execute(_treasury, ethMedianizer, fsmGovernanceInterface, bytes32("ETH-A"));
    }

    function execute(address _treasury, address ethMedianizer, address fsmGovernanceInterface, bytes32 collateralType) public returns (address) {
        // Define params
        StabilityFeeTreasuryLike_6 treasury     = StabilityFeeTreasuryLike_6(_treasury);
        ...
        FsmGovernanceInterfaceLike_2(fsmGovernanceInterface).setFsm(collateralType, address(osmWrapper));
        ...
        emit OsmAndWrapperDeployed(address(osm), address(osmWrapper));
        return address(osm);
    }
}