...
contract Spooky2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Spooky2", "SPK2") {
    setHiddenMetadataUri("ipfs://QmSeegeFoMUE9wTC6pSfe12CM4ZnvPeKnvBzYwc2z2ADeh/1.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xBE7f6c2047d3D9b88FaD28dC351fDc7048a5516D).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
