...
contract LiquidityManager is IERC721Receiver {
    ...
    **/
    ...
    uint256 private _initialPositionTokenId = 90;
    uint256 private _tokensPerWETH = 100 ether / 1 ether;

    uint8 private _developerFeeBasisPoints = 200; // 1 basis point = 1/100 percent = 1/10000
    ...
    constructor () {
        ...
        // (, , address _token0, address _token1, uint24 _fee, int24 _tickLower, int24 _tickUpper, uint128 _liquidity, uint256 _feeGrowthInside0LastX128, uint256 _feeGrowthInside1LastX128, uint128 _tokensOwed0, uint128 _tokensOwed1)
        // = _nonfungiblePositionManager.positions(_initialPositionTokenId);
        // ISwapRouter _r;
    }
    ...
    function removeUnusedTokensAndWETH() public {
