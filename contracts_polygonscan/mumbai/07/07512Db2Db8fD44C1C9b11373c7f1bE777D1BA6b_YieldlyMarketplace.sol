...
contract YieldlyMarketplace is ReentrancyGuard, Ownable {
    ...
    function buy(uint _id, address _creator, uint256 _price, bool _isNew, uint _royalty, string memory _tokenUri) external payable {
        ...
        if (_isNew) {
            ...
            transferMATICOrWMATIC(payable(_creator), _sellerValue);
