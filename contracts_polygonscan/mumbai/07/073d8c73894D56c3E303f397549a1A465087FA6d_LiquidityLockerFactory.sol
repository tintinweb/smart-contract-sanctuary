...
contract LiquidityLockerFactory {
    ...
    event VestingLaunched(LiquidityLocker _vestingContract); 

    LiquidityLocker[] public liquidityLockerVestings;
    ...
    function launchVesting(
        ...
        LiquidityLocker linearVesting = new LiquidityLocker(address(this), _exchangeIdentifier);
        ...
        _erc20Token.approve(address(linearVesting), _amount);
        linearVesting.createVestingSchedule(_beneficiary, _amount);
        
        liquidityLockerVestings.push(linearVesting);
