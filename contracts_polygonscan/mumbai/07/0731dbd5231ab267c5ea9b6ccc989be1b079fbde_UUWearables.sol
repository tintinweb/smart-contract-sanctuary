...
// File contracts/UUWearables.sol

//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

contract UUWearables is
    Context,
    AccessControlEnumerable,
    ERC721Enumerable,
    ERC721Burnable,
    ...
    Ownable
{
    ...
    constructor(string memory _baseTokenURI, address owner)
        ERC721("UUWearables", "UUW")
    {
    ...
    function awardItem(address _to, string memory _tokenURI)
        public
        onlyAdmin
        returns (uint256)
    {
