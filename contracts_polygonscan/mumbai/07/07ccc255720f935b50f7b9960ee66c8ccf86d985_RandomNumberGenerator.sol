...
// File: contracts/interfaces/IPolyAlphaLottery.sol

pragma solidity ^0.8.4;

interface IPolyAlphaLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in ALPHA per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in ALPHA token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInCake: price of a ticket in ALPHA
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public polyAlphaLottery;
     ...
     * @param _seed: seed provided by the PolyAlpha lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == polyAlphaLottery, "Only PolyAlphaLottery");
    ...
    /**
     * @notice Set the address for the PolyAlphaLottery
     * @param _polyAlphaLottery: address of the PolyAlpha lottery
     */
    function setLotteryAddress(address _polyAlphaLottery) external onlyOwner {
        polyAlphaLottery = _polyAlphaLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPolyAlphaLottery(polyAlphaLottery).viewCurrentLotteryId();
    }
}