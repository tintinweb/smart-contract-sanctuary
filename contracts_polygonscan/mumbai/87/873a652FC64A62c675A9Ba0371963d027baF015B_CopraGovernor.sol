...
{
  uint256 public votingDelayNumBlocks;
  uint256 public votingPeriodNumBlocks;
  uint256 public proposalThresholdNum;

  constructor(
    ERC20Votes _token,
    TimelockController _timelock,
    uint256 _votingDelayNumBlocks,
    uint256 _votingPeriodNumBlocks,
    uint256 _proposalThresholdNum
  ) Governor("CopraGovernor") GovernorVotes(_token) GovernorVotesQuorumFraction(4) GovernorTimelockControl(_timelock) {
    votingDelayNumBlocks = _votingDelayNumBlocks;
    votingPeriodNumBlocks = _votingPeriodNumBlocks;
    proposalThresholdNum = _proposalThresholdNum;
  }

  function votingDelay() public view override returns (uint256) {
    return votingDelayNumBlocks;
  }

  function votingPeriod() public view override returns (uint256) {
    return votingPeriodNumBlocks;
  }
