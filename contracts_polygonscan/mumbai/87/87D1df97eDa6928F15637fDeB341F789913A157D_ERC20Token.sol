...
contract ERC20Token is ERC20, Ownable {
    ...
    uint256 public maxSupply = 50000000000 * (10 ** uint256(18));
    ...
    function mint(address account, uint256 amount) external onlyOwner {
        require(totalSupply().add(amount) <= maxSupply, "totalSupply must be <= maxSupply");
    ...
    function transferFromWithMemo(address sender, address recipient, uint256 amount, string calldata memo) external returns (bool) {
