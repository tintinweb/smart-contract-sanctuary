...
contract GLAToken is ERC20Capped, ERC20Burnable, Ownable {
    ...
    address factoryAddress = 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73; // PancakeSwap Factory V2
    address pairToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB
    ...
    function setExcludeFee(address[] memory _addresses, bool _exclude)
        external
        onlyOwner
    {
    ...
    function multiBlacklist(address[] memory addresses) external onlyOwner {
        ...
        for (uint256 i = 0; i < addresses.length; i++) {
            require(!lpAddresses[addresses[i]], "Can't blacklist pair address");
