...
contract LaunchpadFactory {
    ...
    returns (address)
    {
        ...
        newCrowdsale.init(_tokenAddress, _inputToken, _tokenDecimal, _amountAllocation,_rate,_crowdsaleStartTime,_crowdsaleEndTime, _vestingStartTime,_vestingEndTime, _cliffDurationInSecs);
...
contract Crowdsale is ReentrancyGuard  {
    ...
    */
    ...
    function purchaseToken(IERC20 _inputToken, uint256 _inputTokenAmount) external {   
        ...
        uint256 tokenPurchased = _inputTokenAmount.mul(rate);
