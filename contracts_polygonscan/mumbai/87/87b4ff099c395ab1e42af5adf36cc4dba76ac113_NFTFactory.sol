...
contract NFTFactory is NativeMetaTransaction {
  address public constant PROXY_POLYGON = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa;
  
  function deployERC721(string memory _token, string memory _trigram) external returns (ChildMintableERC721) {
	ChildMintableERC721 erc721 = new ChildMintableERC721(_token, _trigram, PROXY_POLYGON);
