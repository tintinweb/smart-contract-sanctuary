 ...
 */
        ...
        for (index = 0; index < ancestors.length; index++) {
          ...
          if (
                temp > 0 &&
                temp != requestAncestors[0] && temp != (requestAncestors[0] + 1000) &&
                temp != requestAncestors[1] && temp != (requestAncestors[1] + 1000) &&
                temp != requestAncestors[2] && temp != (requestAncestors[2] + 1000)
            ) return false;
        }
