...
contract PredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    //奖励递减周期
    uint256 public decrementPeriod = 40320;
    //当前每0.01挖取PT的数量
    uint256 public averageMining = 1 * 10 ** 9;
    //0.01ETH = ?wei
    uint256 public assetUnit = 10000000000000000;
    //递减 1000
    uint256 public decreasingRatio = 50;
    //挖矿开始区块
    ...
    */
    ...
    constructor(
        ...
        symbolOracle['ETH'] = 0x0715A7794a1dc8e42615F059dD6e406A6594651A;
        symbolOracle['DAI'] = 0x0FCAa9c899EC5A91eBc3D5Dd869De833b06fB046;
        symbolOracle['MATIC'] = 0xd0D5e3DB44DE05E9F294BB0a3bEEaF030DE24Ada;
        symbolSwitch['ETH'] = 1;
        symbolSwitch['DAI'] = 1;
        symbolSwitch['MATIC'] = 1;
        intervalSeconds['ETH'] =3600;
        intervalSeconds['DAI'] =3600;
        intervalSeconds['MATIC'] =3600;
        bufferSeconds['BNB'] =300;
        bufferSeconds['DAI'] =300;
        bufferSeconds['MATIC'] =300;
        symbols.push('ETH');
        symbols.push('DAI');
        symbols.push('MATIC');
    ...
    function mining(string memory _symbol,uint256[] calldata epochs) external nonReentrant notContract {
        ...
        for (uint256 i = 0; i < epochs.length; i++) {
            ...
            if (rounds[_symbol][epochs[i]].oracleCalled) {
                ...
                addedReward = numberOfInputs*averageMining/assetUnit;
            }
