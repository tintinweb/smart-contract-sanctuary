...
contract Goat is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;
    using Strings for string;
    
    uint price = 0.34 ether;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/Qmd5kYhST25bvEpptSkYSys7beiZxsWQRQ1K79agfE2Qsf/";
    }
    ...
    function mintToken(address to) public payable {
        require(msg.value == price, "Function Mint Token : wrong amount of ether sended" );
        _tokenIdCounter.increment();
         uint256 tokenId = _tokenIdCounter.current();
        _safeMint(to, tokenId);
        _setTokenURI(tokenId,string(abi.encodePacked(Strings.toString(tokenId),".json")));
