...
contract MaticPool {
   ...
   uint REGESTRATION_FESS=0.02 ether;
   uint pool1_price=0.02 ether;
   ...
   uint pool15_price=16384 ether;
    ...
    UserStruct[] public requests;
      ...
      constructor(address payable _creator1) public {
        ...
        LEVEL_PRICE[1] = 0.0044 ether;
        LEVEL_PRICE[2] = 0.0024 ether;
        LEVEL_PRICE[3] = 0.0001 ether;
        LEVEL_PRICE[4] = 0.00001 ether;
      unlimited_level_price=0.00001 ether;
