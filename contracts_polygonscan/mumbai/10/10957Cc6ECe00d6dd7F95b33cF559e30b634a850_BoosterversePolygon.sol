...
contract BoosterversePolygon is ERC721Tradable, ReentrancyGuard, Factory {
    ...
    constructor(
        ...
        address _payments
    ) ERC721Tradable("BoosterVerse test NFT", "BoostTEST", _proxyRegistryAddress) {
    ...
    function getTokenIdsForClass(
        uint256 _option, uint256 _classId
    ) public view onlyOwner returns (uint256){
        return state.classToTokenIds[_option][_classId];
    }
    ...
    function setStateOption(
        ...
        require(_option < state.numOptions, "_option out of range");
        ...
        LootBoxRandomness.OptionSettings memory settings = LootBoxRandomness.OptionSettings({
        ...
        state.optionToSettings[uint256(_option)] = settings;
    }
