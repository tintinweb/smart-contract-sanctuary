...
contract Staking is Ownable {
    ...
    event LogForfeit(address indexed recipient, uint256 memoAmount, uint256 OxygenAmount);
    ...
    constructor ( ) {
        address _oxygen = 0xA24D063d73e5E5463fe4e98Cf567cb7A8d487779;
        address _water = 0x80f5e5FE4AF8Bc8d401383f296B9B298345291dD;
    ...
    function forfeit() external {
        ...
        uint memoBalance = Water.balanceForGons( info.gons );
