...
contract ChildOpenSea is ERC721Tradable,AccessControlMixin { 
    using SafeMath for uint256;
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");
    uint256 private _currentTokenId = 0;

    constructor(address _proxyRegistryAddress)
    ERC721Tradable("OpenSearCreature", "OSC", _proxyRegistryAddress)
    {
        /**
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Enumerable, AccessControl) returns (bool) {
        return interfaceId == type(ERC721Tradable).interfaceId || super.supportsInterface(interfaceId);
    }
