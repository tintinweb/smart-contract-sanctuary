...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    uint public maxPurchase = 380000000000000000000;
    uint public hardCap;
    uint public softCap;
    uint public availableTokensICO = 1000000000000000000000;
    uint256 public _rewardTokenCount = 20 ether; // 440 tokens per MATIC
    ...
    function buyTokens(address beneficiary) public nonReentrant icoActive payable {
        ...
        uint256 reward = _rewardTokenCount.div(1e18); 
        ...
        distributed[beneficiary].amount += purchasedReward;
        availableTokensICO = availableTokensICO - purchasedReward; 
