...
contract XChainTrade { 
    ...
    function currentPrice() public view returns(uint256) {
        ...
        uint timeNow = 1641568262; // in epoch, put the current time (use https://www.epochconverter.com to find the current time)
        ...
        if (thedate < saleStarts) {price = 1 ether;} // if before start of sale period: Friday, January 7, 2022 4:00:00 PM (GMT)
        else if (thedate > increaseStop) {price = 49.56144107 ether;} // if after end of sale period: Saturday, January 8, 2022 4:00:00 PM (GMT)
        else { 
    ...
    // price by "else if" concatenated may save gas. To be put reverse to ahve more work at the beginning.
    ...
    // function purchase() public payable {
        ...
        if (incwei >= 200000000000000000000 && minted + 400 <= 5000 && thedate < presaleStops) { // if someone sends more than 200 ETH and the date is before: Friday, January 7, 2022 3:00:00 PM (GMT)
        ...
        } else if (incwei >= 100000000000000000000 && minted + 150 <= 5000 && thedate < presaleStops) { // else if someone sends more than 100 ETH and the date is before: Friday, January 7, 2022 3:00:00 PM (GMT)
        ...
        } else if (incwei >= 50000000000000000000 && minted + 65 <= 5000 && thedate < presaleStops) { // else if someone sends more than 50 ETH and the date is before: Friday, January 7, 2022 3:00:00 PM (GMT)
        ...
        } else if (incwei >= 10000000000000000000 && minted + 11 <= 5000 && thedate < presaleStops) { // else if someone sends more than 10 ETH and the date is before: Friday, January 7, 2022 3:00:00 PM (GMT)
        ...
        } else if (incwei >= price && minted + 1 <= 5000 && thedate > saleStarts) { // else if someone sends more than current NFT price and the date is after: Friday, January 7, 2022 4:00:00 PM (GMT)
            ...
            if (lockUntil < presaleStarts) {lockUntil = presaleStarts;} // if account lock time is before Friday, January 7, 2022 3:30:00 PM (GMT), set it at Friday, January 7, 2022 3:30:00 PM (GMT)
        }
