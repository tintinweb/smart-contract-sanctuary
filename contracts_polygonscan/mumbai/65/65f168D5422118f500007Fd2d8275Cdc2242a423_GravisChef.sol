...
contract GravisChef is Ownable {
    ...
    constructor(
        ...
        poolInfo.push(PoolInfo({ lpToken: _token, allocPoint: 1000, lastRewardBlock: startBlock, accTokenPerShare: 0 }));
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({ lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: lastRewardBlock, accTokenPerShare: 0 }));
     ...
     * must be length of 5
     */
    function setFeeStage(uint256[] memory _feeStage) public onlyOwner {
     ...
     * must be length of 5
     */
    function setBlockDeltaFeeStage(uint256[] memory _blockDeltas) public onlyOwner {
