...
contract ByteNextChildRouter is Ownable{
    ...
    function deposit(uint256 amount) public returns(bool){
        ...
        require(depositBalances[_msgSender()] == 0, "Only one transaction per time");
        
        bnuToken.transferFrom(_msgSender(), address(this), amount);
        
        bnuToken.burn(address(this), amount);
        depositBalances[_msgSender()] = amount;
     ...
     */ 
    function processDeposit(address account, uint256 amount) public onlyOwner returns(bool){
    ...
    function withdraw() public returns(bool){
        ...
        bnuToken.mint(address(this), withdrawalAmount);
