  string[] private mean = ["100million","abbreviation","absolute","abuse","acid","admit","advance","again","age","agriculture","ahead","aim","algae","alone","always","ambition","angle","answer","apologize","appear","arm","army","arrest","arrive","arrow","art","ash","assets","assignment","astringent","attack","attack","avoid","awakening","award","axis","back","bad","bag","bake","ball","ball","bamboo","ban","base","basket","battle","bay","bead","bean",
"bear","beast","beauty","bee","beginning","bell","bell","belly","benefit","beside","bet","bird","birth","bitter","black","blade","blessing","block","blood","bloom","blow","blue","boar","board","board","boat","body","body","body","boil","bone","book","border","borrow","bosom","bottle","bottom","bow","bowl","box","brain","branch","break","breath","breeding","bride","bridge","brush","bubble","bud",
"buddha","build","build","bullet","burn","business","butt","butterfly","buy","calendar","call","calm","calm","can","cannon","capital","captive","car","carving","casting","castle","cat","cedar","celebration","chain","change","character","charcoal","charm","cheek","chest","chicken","child","chin","chopstick","chrysanthemum","circle","circle","city","city","class","claw","clear","clear","cliff","close","cloth","clothes","clothing","cloud",
...
"dance","danxe","dark","dark","darkness","daughter","death","decapitate","decision","decoration","decrease","deep red","deer","defense","degree","demon","dense","dent","deposit","depression","depth","deputy","desk","despise","details","dew","die","die","differ","different","difficulty","dig","dirty","disaster","disease","dislike","dive","dog","door","dormitory","double","doubt","dragon","drama","draw","dream","dress","drift","drink","drop"];
  string[] private mean1 = ["drowning","drum","drunk","dry","ear","ear","earn","earth","east","easy","echo","edge","edge","egg","eight","electric","elegant","element","elephant","emissary","emotion","emperor","enclosure","end","enemies","enlightenment","envy","epidemic","erase","europe","evening","everyone","evil","excellent","explosion","eye","eye","face","face","face","fake","fall","fall","fan","fang","far","fast","fat","father","favour",
"fear","feast","feed","feel","female","fence","fence","fervent","festival","few","field","fight","figure","figure","film","finger","fire","firefly","firewood","first time","fish","fishing","fishing","fist","five","flag","flame","flat","float","flock","floor","floor","flow","flower","flower","fly","fog","fold","follow","food","food","foot","foothills","forehead","forest","forest","forget","forgive","form","formula",
...
"harbor","hard","hard","harm","harvest","hatred","he","head","healing","hearing","heart","heat","heaven","heavy","height","help","hide","high","hill","hit","hit","hole","holy","hometown","honey","hope","horse","hot","hot water","house","hundred","hunger","hunger","hunt","hunting","husband","i","ice","idea","illuminate","improper","incense","include","increase","indignant","inflate","inhale","inheritance","ink","inn",
"insects","intestine","intuition","invite","iron","island","japanese harp","job","journey","joy","judgment","jump","karma","katana","kettle","key","kick","kill","kiln","kind","king","knee","knight","lack","lacquer","lady","lake","land","large","laugh","law","layer","lead","leaf","leak","learn","learn","leather","leather","leave","left","leg","lend","lid","life","light","light","light","like","line"];
  string[] private mean2 = ["lips","liquid","liquor","listen","liver","load","lock","long","longing","loss","loss","love","love","lovery","luck","lumber","lung","lyrics","magazine","main","male","man","man","manipulation","mansion","mark","mark","mass","master","master","master","mat","me","me","me","meat","medicine","medium","meet","melt","memorize","milk","minus","minute","mirror","mix","moat","moisture","moment","momentum",
...
"rest","return","return","reverse","reward","rhyme","rice","rice","rice cake","ride","right","ring","ring","ring","ripen","rise","rising","river","road","roar","rob","rock","roll","root","rope","rope","rot","rough","rough","rub","rule","run","sadness","sakura","saliva","salt","samurai","sand","save","say","scar","scary","scatter","sea","search","season","seat","seat","second","secret"];
  string[] private mean3 = ["seed","selection","self","sell","send","sentence","seven","sew","sex","shadow","shake","shame","shape","sharp","shaving","sheep","shell","shellfish","shield","shine","ship","shoes","shoot","shooting","shop","shore","short","shoulder","shout","shrink","sickle","silence","silk","silver","similar","sin","sincerity","six","skeleton","skin","sky","slant","sleep","sleep","sleep","slip","slope","slow","small","smell",
"smell","smoke","snake","snow","soft","soldier","solution","song","song","son-in-law","sophisticated","soul","sound","soup","south","space","spicy","spilit","spirit","spread","spring","spring","spring","squeeze","squeeze","stab","stack","staff","stagnant","star","state","statery","station","statue","stay","steal","steam","steel","stick","stiffness","stock","stomach","stone","stop","storage","store","storm","story","strong","structure",
...
"wat","water","waterfall","wave","way","weak","wealth","wealth","weave","week","welcome","west","whale","what","wheat","whistle","white","who","width","wife","win","wind","window","wing","wings","winter","wisdom","wise","wish","wisteria","wither","woman","wood","word","work","work out","world","worries","worship","wound","write","wrong","year","yellow","you","young","younger brother","younger sister","zen","zero"];
  ...
  function randomOne(uint256 tokenId) internal view returns (Kanji memory) {
    ...
    kanji.cha = uint8(tokenId - 1);
    kanji.mean = kanji.cha;
  ...
  function getTraits(Kanji memory kanji) internal view returns (string memory) {
    string memory o=string(abi.encodePacked(tr1,uint256(kanji.bg).toString(),tr2,uint256(kanji.ccol).toString()));
  ...
  function genSVG(Kanji memory kanji,string memory chara,string memory meanx) internal view returns (string memory) {
    ...
    output = string(abi.encodePacked(output,genBg(kanji.bg)));
    output = string(abi.encodePacked(output,zb[0],chara,zb[1],meanx,zb[2]));
    return string(abi.encodePacked(output,bg[kanji.bg],zb[3],zb[4],b,zb[5]));
  }
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    ...
    if(kanji.cha<49){
        chara=cha[kanji.cha];
        meanx=mean[kanji.cha];}
    if(kanji.cha>749){
        cn=uint8(kanji.cha-750);
        chara=cha3[cn];
        meanx=mean3[cn];}
    if(kanji.cha>499){
        cn=uint8(kanji.cha-500);
        chara=cha2[cn];
        meanx=mean2[cn];}
    if(kanji.cha>249){
        cn=uint8(kanji.cha-250);
        chara=cha1[cn];
        meanx=mean1[cn];}
    string memory title = string(abi.encodePacked(tokenId.toString()," ",meanx));
    return string(abi.encodePacked(rl4,Base64.encode(bytes(string(abi.encodePacked(rl1,title,getTraits(kanji),Base64.encode(bytes(genSVG(kanji,chara,meanx))),rl3))))));
  }


  function claim() public nonReentrant {
    require(numClaimed >= 0 && numClaimed < 100, "invalid claim");
    _safeMint(_msgSender(), numClaimed + 1);
    numClaimed += 1;
  }
    
  function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
    require(tokenId > 100 && tokenId < 1001, "invalid claim");
...
//gasless
  ...
  constructor() ERC721("FullyOnChain_Test", "TST") Ownable() {ownerMint();}
}