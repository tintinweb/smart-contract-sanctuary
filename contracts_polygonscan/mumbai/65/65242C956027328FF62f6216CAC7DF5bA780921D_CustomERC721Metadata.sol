...
contract GenArt721Core is CustomERC721Metadata {
    ...
    address public nftgardenAddress;
    uint256 public nftgardenPercentage = 10;
    ...
    function updatenftgardenAddress(address _nftgardenAddress) public onlyAdmin {
        nftgardenAddress = _nftgardenAddress;
    }

    function updatenftgardenPercentage(uint256 _nftgardenPercentage) public onlyAdmin {
        require(_nftgardenPercentage <= 15, "Max of 15%");
        nftgardenPercentage = _nftgardenPercentage;
    }
