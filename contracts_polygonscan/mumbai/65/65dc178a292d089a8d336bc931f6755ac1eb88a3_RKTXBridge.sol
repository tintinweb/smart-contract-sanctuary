...
contract RKTXBridge{
    ...
    event _transferRKTX(address account, uint256 amount);
    
    event _transferToUser(address account, uint256 amount);
    
    event _changeRKTXAddress(ERC20 erc20);
    ...
    function transferRKTX(uint256 amount) payable public {
        ...
        emit _transferRKTX(msg.sender, amount);
    }
    ...
    function changeRKTXAddress(ERC20 _erc20) public onlyOwner {
        erc20 = _erc20;
        emit _changeRKTXAddress(_erc20);
    }  
