...
contract ERC1155LuxyFactory is Ownable{
    ...
    event Create1155LuxyProxy(address proxy);
    event Create1155LuxyUserProxy(address proxy);
      ...
      function createToken(string memory _name, string memory _symbol, string memory baseURI, uint salt) external {        
        ...
        ERC1155Luxy token = ERC1155Luxy(beaconProxy);
        token.transferOwnership(_msgSender());
        emit Create1155LuxyProxy(beaconProxy);
    }
