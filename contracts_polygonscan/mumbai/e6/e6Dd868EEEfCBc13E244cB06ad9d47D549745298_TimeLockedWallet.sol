...
contract TimeLockedWallet is Initializable {
    ...
    function initialize(address owner, address tokenContract, uint amount,
        ...
        _validateInitialize(owner, tokenContract, amount, numberOfPeriods, firstUnlockTime, periodDuration);
        _owner = owner;
    ...
    function _validateInitialize(address owner, address tokenContract, uint amount,
        ...
        require(token.totalSupply() >= 0, "Token contract should be ERC20 contract");
        require(token.balanceOf(address(this)) == amount, "Amount of tokens should already be transferred to this locked contract");
