    ...
    IGame
{
    ...
    event SetMaxBet(uint128 amount);
    ...
    function initialize(
        ...
        require(
            minBet < _maxBet,
            "CoinFlip.sol:Initialize, _maxBet has to be more than minBet"
        );
    ...
    function setMaxBet(uint128 _maxBet) external whenPaused onlyOwner {
        require(
            _maxBet > minBet,
            "CoinFlip.sol: Max Bets has to be more than minBet."
        );
        maxBet = _maxBet;
        emit SetMaxBet(maxBet);
    }
