...
contract Naffiti1155Collection is ERC1155, Ownable, Pausable {
    ...
    mapping(uint256 => address) public txFeeToken;
    mapping(uint256 => uint256) public royaltyPercentage;

    // For marketplace & Auction
    ...
    // Third parties to create
    address public firstItemOwner;
    ...
    modifier creatorOnly(uint256 _id) {
        require(
            ...
            "NAFF-ERC1155#creatorOnly: ONLY_CREATOR_ALLOWED"
        );
        _;
    }
    ...
    modifier ownersOnly(uint256 _id) {
        require(
            ...
            "NAFF-ERC1155#ownersOnly: ONLY_OWNERS_ALLOWED"
        );
        _;
    }
    ...
    constructor(
        ...
        firstItemOwner = _firstItemOwner;

        // Create the 1st token for Contract
        _mint(_firstItemOwner, 0, 1, "");
    }
     ...
     * @return The newly created token ID
     */
    function create1155TokenFirstOwner(
        ...
        tokenSupply[_id] = _initialSupply;
        txFeeToken[_id] = _txFeeToken;
        royaltyPercentage[_id] = _royaltyPercentage;
     ...
     * @return The newly created token ID
     */
    function create1155TokenNextOwner(
        address _initialOwner,
        address _nextOwner,
        address _txFeeToken,
        uint256 _royaltyPercentage,
        uint256 _initialSupply,
        uint256 _transferSupply,
        string calldata _uri,
        bytes calldata _data
    ) external returns (uint256) {
        uint256 _id = _getNextTokenID();
