...
contract TestDogs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Dogs", "TDGS") {
    setHiddenMetadataUri("ipfs://QmdGZi524WaZGxQpFTSRbezjrjgkbrKpES82vsHmTFJmU2/hidden1.json");
  }
