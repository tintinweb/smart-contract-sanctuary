...
contract Pool is PoolStorage {
    ...
    constructor(
        ...
        ERC20 assetInst = ERC20(stableCoin);
    ...
    function deposit(uint256 amount) external override returns (bool success) {
        ...
        ERC20 assetInt = ERC20(stableCoin);
        require(assetInt.balanceOf(_msgSender()) >= amount, "ERC20: Insufficient funds");
        require(assetInt.transferFrom(_msgSender(), address(this), amount), "ERC20: Transfer failed");
    ...
    function withdraw(uint256 _tokenAmount) external override returns (bool success) {
        ...
        ERC20 assetInt = ERC20(stableCoin);
        require(assetInt.balanceOf(address(this)) >= _tokenAmount, "ERC20: Insufficient funds");
        require(assetInt.transfer(_msgSender(), _tokenAmount), "ERC20: Transfer failed");
