...
// File: contracts/StakedHemetaHemeERC20V2.sol
...
contract StakedHemetaHEMEERC20V2 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked HEME", "sHEME2", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHEME supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHEME
