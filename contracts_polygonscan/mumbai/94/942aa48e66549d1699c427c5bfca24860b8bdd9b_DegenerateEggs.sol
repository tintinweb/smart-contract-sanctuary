...
contract DegenerateEggs is Ownable, ERC721 {
    ...
    uint256 public budgetDev1 = 50 ether; 
    uint256 public budgetDev2 = 25 ether; 
    uint256 public budgetDev3 = 25 ether; 
    ...
    constructor() ERC721("DegenerateEggs", "DEGG") {
        _baseTokenURI = ""; 
    ...
    */
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 witdrawAmount = calculateWithdraw(budgetDev1,(balance * 20) / 100);
        if (witdrawAmount>0){
            budgetDev1 -= witdrawAmount;
            _withdraw(Dev1, witdrawAmount);
        }
        witdrawAmount = calculateWithdraw(budgetDev2,(balance * 6) / 100);
        if (witdrawAmount>0){
            budgetDev2 -= witdrawAmount;
            _withdraw(Dev2, witdrawAmount);
        }
        if (totalSupply()>3555 && notIncreased){
            notIncreased=false;
            budgetDev3 += 2 ether;
        }
        witdrawAmount = calculateWithdraw(budgetDev3,(balance * 70) / 100);
        if (witdrawAmount>0){
            budgetDev3 -= witdrawAmount;
            _withdraw(Dev3, witdrawAmount);
        }
