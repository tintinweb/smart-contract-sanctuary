...
contract CiviPortToken is SecureContract, ERC20
{
    ...
    constructor(string memory name, string memory ticker, uint8 tokenDecimals) SecureContract() ERC20(name, ticker)
    {
    ...
    {
        require(hasRole(_MINTTO, msg.sender), "TestToken: mintTo - Permission denied");
        _mint(user, amount);
    ...
    {
        require(hasRole(_BURNFROM, msg.sender), "TestToken: burnFrom - Permission denied");
        _burn(user, amount);
