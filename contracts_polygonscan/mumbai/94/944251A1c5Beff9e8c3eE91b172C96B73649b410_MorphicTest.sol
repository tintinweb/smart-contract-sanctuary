...
contract MorphicTest is ERC1155, Ownable, Pausable {
    ...
    mapping(address => bool) public teamwhitelisted;
    ...
    function mint(uint256 amount) public payable saleIsOpen {
        ...
        require(total + amount <= MAX_ELEMENTS, "Mint: over Max limit");
        require(total + amount <= MAX_PRESALE_ELEMENTS, "Mint: over Max Presale limit");
    ...
    function teamPresale() public saleIsOpen {
    ...
    function presale(uint256 amount) public saleIsOpen {
        require(userwhitelisted[msg.sender] == true, "Not presale member");
        mint(amount);
    }
    ...
    // add team's address to whitelist
    function whitelistTeam(address _user) public onlyOwner {
        require(teamwhitelisted[_user] == false, "already set");
        teamwhitelisted[_user] = true;
    }

    // remove team's address to whitelist
    function removeWhitelistTeam(address _user) public onlyOwner {
        require(teamwhitelisted[_user] == true, "not exist");
        teamwhitelisted[_user] = false;
    }

    // add user's address to whitelist
    function whitelistUser(address _user) public onlyOwner {
        require(userwhitelisted[_user] == false, "already set");
        userwhitelisted[_user] = true;
    }

    // remove user's address to whitelist
    function removeWhitelistUser(address _user) public onlyOwner {
        require(userwhitelisted[_user] == true, "not exist");
