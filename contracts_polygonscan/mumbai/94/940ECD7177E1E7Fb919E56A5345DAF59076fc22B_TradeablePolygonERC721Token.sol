...
contract TradeablePolygonERC721Token is TradeableERC721Token, ContextMixin, NativeMetaTransaction {
    ...
    constructor(string memory  _name, string memory  _symbol, address _owner, string memory _contractUri) TradeableERC721Token(_name, _symbol, _owner, _contractUri) {
...
contract TradeableERC721Token is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, AccessControl {
    ...
    constructor(string memory  _name, string memory  _symbol, address _owner, string memory _contractUri) ERC721(_name, _symbol) {
