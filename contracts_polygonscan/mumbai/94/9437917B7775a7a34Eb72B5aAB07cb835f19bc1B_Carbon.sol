...
contract Carbon is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;

    CountersUpgradeable.Counter private _tokenIdCounter;
    uint private _max_supply = 10;
    uint private _mintingFee = 100;

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() initializer public {
        __ERC721_init("Carbon", "CBN");
        __Pausable_init();
        __Ownable_init();
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory _tokenURI = "ipfs://QmSqwEi4EfYy3ssX9sGvWZmPt1wiPT2i19Vpx1dUhFib4N";
        return _tokenURI;
    }
}
