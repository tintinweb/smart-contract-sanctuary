...
contract DeluxeDucks is ERC721Enumerable, Ownable {
    ...
    uint256 public constant CLAYS_GIFT = 33;
    uint256 public constant CLAYS_PRIVATE = 333;
    uint256 public constant CLAYS_PUBLIC = 2967;
    uint256 public constant CLAYS_MAX = CLAYS_GIFT + CLAYS_PRIVATE + CLAYS_PUBLIC;
    uint256 public constant CLAYS_PRICE = 0.01 ether;
    uint256 public constant CLAYS_PER_MINT = 3;
    mapping(address => bool) public presalerList;
    mapping(address => uint256) public presalerListPurchases;
    string private _contractURI = "ipfs://QmPbRNXviKuSGf4CWeDk5fwZqxQZu7PJf8xVHfsqZ5iwEU/";
    string private _tokenBaseURI = "hipfs://QmStRENEm17qrXuecXhYwUaGW9JobjEdJVQNAJYqWk1XMa/";
    address private member1 = 0x1C79F97d8995CfA761C1483885266685996b5CFB; // M1
    address private member2 = 0x1C79F97d8995CfA761C1483885266685996b5CFB; // ROBBIE
    address private member3 = 0x1C79F97d8995CfA761C1483885266685996b5CFB; // BALD
    address private member4 = 0x1C79F97d8995CfA761C1483885266685996b5CFB; // DEVKO
    address private member5 = 0x1C79F97d8995CfA761C1483885266685996b5CFB; // ANON
    ...
    constructor() ERC721("Deluxe Ducks", "DUCK") { 
