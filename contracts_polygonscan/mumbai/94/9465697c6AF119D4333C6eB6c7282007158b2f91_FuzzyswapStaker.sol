...
contract FuzzyswapStaker is IFuzzyswapStaker, Multicall {
    ...
    function getRewardInfo(IncentiveKey memory key, uint256 tokenId)
        ...
        view
        override
        returns (uint256 reward, uint160 secondsPerLiquidityInsideX128)
    {
        bytes32 incentiveId = IncentiveId.compute(key);
        ...
        secondsPerLiquidityInsideX128 = IFuzzyswapVirtualPool(incentive.virtualPoolAddress).getInnerSecondsPerLiquidity(deposit.tickLower, deposit.tickUpper);
