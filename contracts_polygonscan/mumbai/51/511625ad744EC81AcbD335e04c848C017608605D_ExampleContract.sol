...
contract ExampleContract is ERC721Enumerable, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    uint256 public claimPrice = 100000000000000000 wei; // 0.1 ether (it is 0.1 matic because we are on polygon)
    ...
    constructor () ERC721("ExampleContract", "EXMPL") {
