...
contract KiBridgeV1LiquidityAm is Context, ERC20 {
...
import "./KiBridgeV1LiquidityAm.sol";
...
contract KiBridgeV1LiquidityFactoryAm {
    ...
    returns (address liquidity)
  {
    ...
    liquidity = address(new KiBridgeV1LiquidityAm{salt: keccak256(abi.encode(_token))}());
    ...
    external
  {
    ...
    KiBridgeV1LiquidityAm(getLiquidity[_token]).mint(msg.sender, _amount);
  }
}
