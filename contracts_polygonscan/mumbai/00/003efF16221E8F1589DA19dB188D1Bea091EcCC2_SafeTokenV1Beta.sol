    ...
    ReentrancyGuard
{
    ...
    function _createVestingSchedule(
        ...
        uint256 _vestingDurationInSeconds = vestingDuration * 1 seconds;
    ...
    function createVestingSchedule(
        ...
        if(vestingCountByBeneficiary == 0){
            ...
            bytes32 VestingScheduleID = _createVestingSchedule(_beneficiary, _msgSender, 0, vestingDuration, _tokenId, _trackRewardsRate, vestingAmount);
            //token2value[nftTokenAddress][_tokenId] = token2value[nftTokenAddress][_tokenId] - vestingAmount;
            return VestingScheduleID;
        }else{
            ...
            if(getCurrentTime() > vestingSchedule.start + vestingSchedule.duration){
                ...
                bytes32 newVestingScheduleID = _createVestingSchedule(_beneficiary, _msgSender, 0, vestingDuration, _tokenId, _trackRewardsRate, vestingAmount);
        ...
        returns (uint256)
    {
        ...
        if (vestingSchedule.end == 0) {
            if(currentTime > vestingSchedule.start + vestingSchedule.duration){
                ...
                uint256 reward = vestingSchedule.amountTotal.mul(vestingSchedule.duration);
                return reward;
            } else {
