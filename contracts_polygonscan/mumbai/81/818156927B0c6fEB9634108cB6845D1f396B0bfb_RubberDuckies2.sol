...
contract RubberDuckies2 is ERC721 {
    uint256 public tokenCounter;
    uint256 public constant MAX_DUCKS = 2500;
    ...
    function mintDuckie(string memory tokenURI) public returns (uint256) {
        ...
        require(newItemId > 0 && tokenCounter < MAX_DUCKS);
        require(tokenCounter + newItemId < MAX_DUCKS);
