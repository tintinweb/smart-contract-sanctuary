...
contract YieldlyMarketplace is ReentrancyGuard, Ownable {
    ...
    function mint(string memory _tokenURI, uint256 _price, bool _isListOnMarketplace, uint256 _royalty, uint256 startDate, uint256 auctionLength) public payable {
        _tokenIds.increment();
        ...
        if (_isListOnMarketplace) this.createAuction(newTokenId, startDate, auctionLength, _price, msg.sender);
