...
contract SplitterContract is OwnableUpgradeable {
    ...
    function setDistribution(
        ...
        require(_getArraySum(primary_shares) <= 100, "wrong primary share distribution");
        require(_getArraySum(secondary_shares) <= 10, "wrong secondary share distribution");
