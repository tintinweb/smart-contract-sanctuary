...
contract BlockchainCutiesCore /*is ERC721, CutieCoreInterface*/
{
    ...
    BreedingMarketInterface public breedingMarket;
    ...
    function transfer(address _to, uint256 _cutieId) public whenNotPaused canBeStoredIn40Bits(_cutieId)
    {
        ...
        require(_isOwner(msg.sender, uint40(_cutieId)), "Wrong cutie owner");
        ...
        external whenNotPaused canBeStoredIn40Bits(_tokenId)
    {
        ...
        require(_to != address(saleMarket), "Wrong cutie destination");
        require(_to != address(breedingMarket), "Wrong cutie destination");

        // Check for approval and valid ownership
        require(_approvedFor(msg.sender, uint40(_tokenId)) || _isApprovedForAll(_from, msg.sender), "No allowance");
...
*/
    ...
    {
        require(gen0CutieCreatedCount < gen0Limit, "Gen0 limit");
    ...
    {
        breedingMarket = BreedingMarketInterface(_breedingAddress);
    }
