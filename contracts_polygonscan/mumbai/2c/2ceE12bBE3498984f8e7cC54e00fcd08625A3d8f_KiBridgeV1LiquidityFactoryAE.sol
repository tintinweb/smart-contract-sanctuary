...
contract KiBridgeV1LiquidityFactoryAE {
    ...
    returns (address liquidity)
  {
    ...
    liquidity = address(new KiBridgeV1Liquidity{salt: keccak256(abi.encode(_token))}());
    ...
    external
  {
    ...
    KiBridgeV1Liquidity(getLiquidity[_token]).mint(msg.sender, _amount);
  }
}
