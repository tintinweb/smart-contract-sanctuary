    ...
    ContextMixin
{
    ...
    uint256 public racerMintQty;
    bool public racerMintComplete;
    ...
    // mint tokens to racer once contract address is set
    function mintRacerTokens(address racerAddress)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(!racerMintComplete, "Racer Mint already completed");
        _mint(racerAddress, racerMintQty);
        racerMintComplete = true;
    }
}
