...
import "./interfaces/IPlayboy1155.sol";
    ...
    IERC1155MetadataURI
{
  ...
  */
    ...
    //   /**
    //     A modifier which allows only the Playboy-administrative owner or addresses
  ...
  */
        ...
        hasValidPermit(UNIVERSAL, SET_URI)
    {
        require(
            !uriLocked,
            "Playboy1155: the collection URI has been permanently locked"
        );
  ...
  */
        ...
        hasValidPermit(UNIVERSAL, SET_URI)
    {
        require(
            !contractUriLocked,
            "Playboy1155: the contract URI has been permanently locked"
        );
  ...
  */
    function configureGroup(
        ...
        require(_groupId != 0, "Playboy1155: group ID 0 is invalid");
        require(
            _hasItemRight(_groupId, CONFIGURE_GROUP),
            "Playboy1155: you don't have rights to configure group"
        );
        ...
        if (!itemGroups[_groupId].initialized) {
            require(
                !locked,
                "Playboy1155: the collection is locked so groups cannot be created"
            );
            ...
            if (
                ...
                require(
                    ...
                    "Playboy1155: you may not uncap a capped supply type"
                );
                require(
                    _data.supplyData <= itemGroups[_groupId].supplyData,
                    "Playboy1155: you may not increase the supply of a capped type"
                );
            ...
            require(
                ...
                "Playboy1155: you may not decrease supply below the circulating amount"
            );
            ...
            if (
                ...
                require(
                    ...
                    "Playboy1155: you may not alter nonfungible items"
                );
                ...
                if (_data.itemType == DFStorage.ItemType.Nonfungible) {
                    require(
                        ...
                        "Playboy1155: the fungible item is not unique enough to change"
                    );
  ...
  */
        ...
        returns (uint256)
    {
        ...
        require(
            ...
            "Playboy1155: you cannot mint a non-existent item group"
        );
        ...
        if (itemGroups[groupId].supplyType != DFStorage.SupplyType.Uncapped) {
            require(
                ...
                "Playboy1155: you cannot mint a group beyond its cap"
            );
        }
        ...
        if (itemGroups[groupId].itemType == DFStorage.ItemType.Nonfungible) {
            require(
                ...
                "Playboy1155: you cannot mint more than a single nonfungible item"
            );
            ...
            require(
                ...
                "Playboy1155: you cannot mint more than the alloted semifungible items"
            );
        }
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            require(
                ...
                "Playboy1155: you do not have the right to mint that item"
            );
  ...
  */
        ...
        returns (uint256)
    {
        ...
        require(
            itemGroups[groupId].initialized,
            "Playboy1155: you cannot burn a non-existent item group"
        );

        // If the item group is non-burnable, then revert.
        if (itemGroups[groupId].burnType == DFStorage.BurnType.None) {
            revert("Playboy1155: you cannot burn a non-burnable item group");
        }
        ...
        if (itemGroups[groupId].burnType == DFStorage.BurnType.Burnable) {
            require(
                ...
                "Playboy1155: you may not exceed the burn limit on this item group"
            );
        }
    ...
    function burnBatch(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            require(
                ...
                "Playboy1155: you do not have the right to burn that item"
            );
  ...
  */
    function burn(
        ...
        require(
            ...
            "Playboy1155: you don't have rights to burn"
        );
  ...
  */
    function setMetadata(uint256 _id, string memory _metadata) external {
        require(
            ...
            "Playboy1155: you don't have rights to setMetadata"
        );
        uint256 groupId = _id >> 128;
        require(
            !uriLocked && !metadataFrozen[_id] && !metadataFrozen[groupId],
            "Playboy1155: you cannot edit this metadata because it is frozen"
        );
  ...
  */
    function lockURI(string calldata _uri, uint256 _id) external {
        require(
            ...
            "Playboy1155: you don't have rights to lock URI"
        );
  ...
  */
    function lockGroupURI(string calldata _uri, uint256 groupId) external {
        require(
            ...
            "Playboy1155: you don't have rights to lock group URI"
        );
...
/**
  ...
  The owner of this contract is always a fully-permissioned Playboy-administrator.
...
abstract contract PermitControl is Ownable {
  ...
  */
  ...
  /**
    ...
    only be set by the Playboy-administrative contract owner or an address holding
...
/**
  @title An interface for the `Playboy1155` ERC-1155 item collection contract.
  @author 0xthrpw
  @author Tim Clancy

  August 12th, 2021.
*/
interface IPlayboy1155 {
