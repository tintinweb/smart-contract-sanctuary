...
contract NFTAuction is Ownable, ReentrancyGuard {
    ...
    {   
        ...
        if(_isERC20Auction(erc20Token)){    // if sale is ERC20
            ...
            uint royaltyAmount= totalAmount.mul(_royaltyPercentage).div(100);
            uint256 ownerAmount= totalAmount.mul(_ownerPercentage).div(100);
...
/*
        ...
        onlyNftSeller(_nftContractAddress, _tokenId)
    {
        ...
        require(nftSeller== msg.sender, "You don't own this nft");
        // reset sale
        _resetSale(_nftContractAddress, _tokenId);
