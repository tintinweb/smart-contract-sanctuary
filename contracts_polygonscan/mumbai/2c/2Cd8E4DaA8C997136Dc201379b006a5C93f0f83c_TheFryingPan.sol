...
contract TheFryingPan is Ownable, IERC721Receiver, ReentrancyGuard {
	...
	function delete3933Me() internal pure {} //polyscan trick
...
contract Bacon is IBacon, ERC721Enumerable, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	address private oracle = 0x46340b20830761efd32832A74d7169B29FEB9758; //TODO: testgas!
	...
	function mint(uint256 qty, uint256 _seed) external payable nonReentrant {
		...
		for (uint256 i = 0; i < qty; i++) {
			seed = random(1, 2**256 - 1, totalSupply() + block.number + _seed);
