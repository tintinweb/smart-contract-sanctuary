...
contract SushiswapAdapter is IComposableExchange, OwnableUpgradeable {
	...
	function getPoolAddress(address tokenA, address tokenB) external override returns (address) {
		ISushiswapFactory factory = ISushiswapFactory(swapRouter.factory());
...
interface IComposableExchange {
    ...
    function getPoolAddress(address tokenA, address tokenB) external returns(address);
}
