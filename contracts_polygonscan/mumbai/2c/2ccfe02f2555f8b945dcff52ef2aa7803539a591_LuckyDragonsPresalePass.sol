...
// File: contracts/LuckyDragonsPresaleNFT.sol

pragma solidity >=0.7.0 <0.9.0;



contract LuckyDragonsPresalePass is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor(
    ...
    string memory _initPresaleUri
  ) ERC721(_name, _symbol) {
    setPresaleURI(_initPresaleUri);
  }
  ...
  function airdrop(address[] calldata _recipients) external onlyOwner {
        require(
            ...
            "Airdrop will exceed maximum supply of PresalePasses"
        );
  ...
  function setPresaleURI(string memory _presaleURI) public onlyOwner {
