...
contract Shopverse is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public whitelistStartTime = block.timestamp; //update to correct 1638633600
	uint256 public jrnyStartTime = block.timestamp; //update to correct 1638720000
	uint256 public publicSaleStartTime = block.timestamp; //update to correct 1638806400
