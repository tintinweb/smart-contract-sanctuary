...
contract CondomonsArmy is ERC721, ERC721Enumerable, Ownable {


    using SafeMath for uint256;
    using Strings for uint256;

    bytes32 public merkleRoot = 0x6cfd6b3ca3413a3f4BC93642C0B600823dAfbbB9432674327843264237642378;
    ...
    string public uriNotRevealed = "ipfs://QmbKDBAV5bThbdjG494NMVFGxNLmF3oLP1QtpfLr3Tr3gU";
    ...
    address FOUNDER = 0x6cfd6b3ca3413a3f4BC93642C0B600823dAfbbB9;
    address DEV = 0x6cfd6b3ca3413a3f4BC93642C0B600823dAfbbB9;
    ...
    constructor() ERC721("Condomon's Army", "SEXC") {
    ...
    function mint(uint256 qty) external payable{
        ...
        require(qty <= 3, "Sorry, max 3 mints per transaction");
        require(msg.value >= price * qty, "Sorry, not enough amount sent!"); 
        require(useWhitelist == false, "Sale not started yet");
        
        for (uint i=supply; i < supply + qty; i++) {
    ...
    function flipUseWhitelist(string memory _URI) external onlyOwner {
        baseURI = _URI;
    ...
    function withdraw() external onlyOwner{
        ...
        payable(FOUNDER).transfer((balance * 80) / 100);
        payable(DEV).transfer((balance * 20) / 100);
