...
using SafeMath for uint256;
   ...
   * to the airdrop list with the default of 1250000000 Kretek
   */
   ...
   * Ex: 1250000000 opposed to 1250000000 * (10e9)
   */
  ...
  internal
  {
      ...
      contrib.tokenAmount = _tokenAward.mul(10e9);
   ...
   * airdrop list with the default of 1250000000 Kretek
   */
  ...
  internal
  {
      ...
      require(!isAddressInAirdropList(_addressToAdd));
      Contribution storage contrib = contributions[_addressToAdd];
      contrib.tokenAmount = 1250000000 * 10e9;
      contrib.wasClaimed = false;
      contrib.isValid = true;
  }
...
contract KretekAirDrop is AirDropWinners {
  using SafeMath for uint256;

  address initTokenContractAddress;
