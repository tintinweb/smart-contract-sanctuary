...
contract HibernationSociety is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        require(balanceOf(_msgSender())+ _count <= MAX_WALLET, "Exceeds NFT's allowed per wallet");
    ...
    function airdropNFT(address[] memory winners) public onlyOwner{
        require(winners.length > 0 , "Please provide the list of wallets for the airdrop");
    ...
    //test methods
    function setTestLaunchTime() external onlyOwner {
