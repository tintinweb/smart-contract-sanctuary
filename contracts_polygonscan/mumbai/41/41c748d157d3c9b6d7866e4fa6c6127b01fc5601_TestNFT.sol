...
contract TestNFT is IERC721, IERC165, IERC721Metadata, IERC721Enumerable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;
    // using EnumerableSetMarket for EnumerableSetMarket.MarketLotSet;

    string internal _name = "ETCBayc";
    string internal _symbol = "ETCBAYC";

    uint256 internal totalMinted = 0;

    uint256 public constant MINTING_LIMIT = 10000;

    uint256 public mintingPrice = 100000 gwei;
    ...
    function tokenURI(uint256 _tokenId) external view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmUW3zfpxVTL3ffjFfYb6ZaHZiXXsAh4B4o1hGyrWydEVv/", Utils.uintToString(_tokenId), '.json'));
    }
