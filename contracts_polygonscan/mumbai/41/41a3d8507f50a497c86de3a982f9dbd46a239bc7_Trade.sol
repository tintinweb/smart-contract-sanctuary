...
contract Trade{
    ...
    */
    ...
    function sellToken(address _token, uint _price, uint _amount) public{
        ...
        require(ethRequired >= _amount, "Your's balance don't have enough to make this transaction");
        require(ethRequired >= _price, "Your's balance don't have enough to make this transaction");
        require(tokenBalance[msg.sender][_token] >= _amount, "Your's balance don't have enough to make this transaction" );
        require(tokenBalance[msg.sender][_token] - _amount >= 0, "Your's balance don't have enough to make this transaction");
