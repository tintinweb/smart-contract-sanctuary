...
contract Payable is Ownable {
  ...
  function addPaymentToken(
    ...
    _paymentTokens[tokenAdress] = PaymentToken(mintPrice, true, decimals, IERC20(tokenAdress));
  }
  ...
  function payWithToken(uint256 amount, address tokenAddress) internal {
    ...
    uint256 price = amount *
      _paymentTokens[tokenAddress].mintPrice *
      10**_paymentTokens[tokenAddress].decimals;
