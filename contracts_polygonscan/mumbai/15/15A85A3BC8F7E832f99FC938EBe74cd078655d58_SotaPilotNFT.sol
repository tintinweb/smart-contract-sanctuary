...
contract SotaPilotNFT is ERC721Enumerable, Ownable, AccessControl, SotaInvestors, RoyaltiesV2Impl {
    ...
    uint256 public constant PRICE = 2.0 ether;
    ...
    uint256 private maxTokensPerMint = 1;
    ...
    function mintNFT(uint256 numberOfTokens) public payable {
        ...
        require(msg.value >= PRICE.mul(numberOfTokens), "Not enough ether to purchase NFT.");
    ...
    function generateStartingIndex() private {
        ...
        startingIndex = uint(blockhash(block.number)) % MAX_SUPPLY;
