...
contract Comp is Operator {
    /// @notice EIP-20 token name for this token
    string public constant name = "Niki Finance";
    ...
    /// @notice Total number of tokens in circulation
    uint public totalSupply = 500000e18;
    ...
    function uintadd(uint a, uint b, string memory errorMessage) internal pure returns (uint256) {
        uint c = a + b;
        require(c >= a, errorMessage);
        return c;
    }
    
    uint256 public constant MAXSUPPLY = 20000000e18;
...
contract ComptrollerG7 is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getCompAddress() public view returns (address) {
        return 0xB8A3ed9723d22660B736D4636D16D4deC0C8befA;
    }
}