...
interface IERC1155 is IERC165 {
  ...
  contract DNXILotteryTest is VRFConsumerBase, Ownable {
      ...
      function pickWinners() public onlyOwner {
          ...
          for (uint256 i = 0; i < randomCounts; i++) {
              ...
              for (uint256 j = 0; j < totalNumberOfEntries; j++) {
                  ...
                  if (countedIndex >= winningTicketIndex) {
                      winner = lotteryEntryReversed[countedIndex+1];
                      break;
                  }
              }
              winners[i] = winner;
      ...
      function getWiiner(uint256 winnerId) public view returns (address) {
