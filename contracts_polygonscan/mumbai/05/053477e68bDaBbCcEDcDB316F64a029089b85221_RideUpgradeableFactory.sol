...
contract RideUpgradeableFactory is Ownable {
    ...
    event NewRide (address indexed ride,
        ...
        uint256 _price, bool _nameChangeable, bool _colorChangeable, bytes4[] _defaultColor);

    constructor(address _ownerAddress, address _proxyAdminAddress, address _rideTemplate,
        address _zoneToken, address _slpZoneEth
     ...
     * @param _capacity Capacity of token
     ...
     * @param _defaultColor Default color
     */
    function createRide(
        string memory _name,
        ...
        rides.push(ride);
        emit NewRide(address(ride), _name, _symbol, _rideUri, _capacity, _price, _nameChangeable, _colorChangeable, _defaultColor);
    }
...
abstract contract IRideUpgradeable {
