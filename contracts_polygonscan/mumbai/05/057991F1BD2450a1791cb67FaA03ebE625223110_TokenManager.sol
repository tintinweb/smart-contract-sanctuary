...
contract LaborXContract is Ownable {
    ...
    event ContractCreated(bytes32 indexed contractId, uint256 customerFee, address token, uint256 amount, address disputer, uint256 deadline);
    ...
    function createContract(
        ...
        require(_percentToBaseConvert == 0 || (_percentToBaseConvert > 0 && _percentToBaseConvert <= 1000), "Percent to base convert goes beyond the limits from 0 to 1000");
        ...
        jobContract.customerFee = customerFee;
        jobContract.deadline = _deadline;
        jobContract.percentToBaseConvert = _percentToBaseConvert;
        emit ContractCreated(_contractId, customerFee, _token, _amount, _disputer, _deadline);
    }
