...
pragma solidity ^0.8.2;
    ...
    contract enma is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
        ...
        constructor() ERC721("EnmaTest", "NMT") {}
        ...
        function mintKaos(address _to, uint256[] memory _tokenIds, string[] memory tokenURI_) external onlyOwner(){
            for (uint256 i=0; i< _tokenIds.length; i++) {
                _mint(_to, _tokenIds[i]);
                _setTokenURI(_tokenIds[i], tokenURI_[i]);
            }
        }
