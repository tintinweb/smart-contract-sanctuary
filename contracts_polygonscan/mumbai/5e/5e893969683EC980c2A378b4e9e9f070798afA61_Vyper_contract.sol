...
def updateInterest():
    ...
    if current_atoken_balance == 0 or self.totalContractBalance == 0:
        return
...
def fxsell(withdraw: uint256) -> bool:
    ...
    assert self.user_interest[msg.sender] >= interest_on_amount, "interest error"
    self.user_interest[msg.sender] -= interest_on_amount
