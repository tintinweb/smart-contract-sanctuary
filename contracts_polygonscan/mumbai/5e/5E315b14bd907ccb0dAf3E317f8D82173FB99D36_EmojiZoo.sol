...
contract EmojiZoo is ERC721Enumerable, ReentrancyGuard, Ownable {
    
    using SafeMath for uint256;
 
    uint256 private tier1ETH = 1000000000000000; 
    uint256 private tier2ETH = 10000000000000000;
    uint256 private tier3ETH = 100000000000000000;
    uint256 public constant MAX_NFT_SUPPLY = 10000;
    uint256 public constant SALE_START_TIMESTAMP = 1634247000;
    address public lootAddress = 0xd30c23d19187B2f24b6bC7dD41AB2d6C8bC3Db56;
...
//        parts[19] = getMount(tokenId);
    ...
    function getNFTPriceForETH(uint numberOfNfts) public view returns (uint) {
...
//    function claim(uint256 numberOfNfts) public nonReentrant payable {
        require(numberOfNfts > 0 && numberOfNfts < 10001, "Token ID invalid");
//        require(getNFTPriceForETH(numberOfNfts) <= msg.value, "ETH value sent is not correct");
        require(getNFTPriceForETH(numberOfNfts) <= msg.value, "Ether value sent is not correct");
        require(lootContract.ownerOf(numberOfNfts) == msg.sender, "Not the owner of this loot");
        _safeMint(_msgSender(), numberOfNfts);
//        _safeMint(_msgSender(), numberOfNfts);
    }
