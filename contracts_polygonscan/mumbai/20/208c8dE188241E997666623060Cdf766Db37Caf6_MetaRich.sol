...
contract MetaRich is Ownable, ERC721, ERC721URIStorage, RandomlyAssigned {
    using SafeMath for uint256;

    uint256 constant PRICEPHASE1 = 113 ether;
    uint256 constant PRICEPHASE2 = 130 ether;
    uint256 constant PRICEPHASE3 = 150 ether;
    ...
    function walletIsInWhite(address wallet) internal view returns(bool){
    ...
    function mintCollection(uint256 count) public onlyOwner{
...
abstract contract WithLimitedSupply {
    ...
    uint256 private _totalSupply = 12000;
