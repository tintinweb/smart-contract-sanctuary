...
contract DomNFT is ERC721Enumerable, Ownable {
    ...
    function isWhitelisted() public view returns(bool) {
        return whitelist.isWhitelisted(msg.sender);
    }

    function viewAPY() public view returns(uint256) {
        return apyPercent;
    }
    ...
    function setAPY(uint256 _apyPercent) public onlyOwner {
        apyPercent = _apyPercent;
    }

    function setROIDate(uint256 _roiRate) public onlyOwner {
        roiRate = _roiRate;
    }
