...
contract WBANLPRewards is ERC1155PresetMinterPauserUpgradeable, OwnableUpgradeable, ContextMixin {
    ...
    */
    ...
    function do_initialize(string memory uri, address _openSeaProxyRegistryAddress) public virtual initializer {
        ...
        name = "wBAN LP Rewards";
        _mint(_msgSender(), 0, 3, "");
        _mint(_msgSender(), 1, 2, "");
        _mint(_msgSender(), 2, 1, "");
    }

    function mergeShrimpAndShartToWhale() external {
        // ensure that user has enough NFT
        require(balanceOf(_msgSender(), SHRIMP) > 0, "Not enough shrimp");
        require(balanceOf(_msgSender(), SHARK) > 0, "Not enough shark");
        // burn nft1 and nft2
        _burn(_msgSender(), SHRIMP, 1);
        _burn(_msgSender(), SHARK, 1);
        // mint nft3
        _mint(_msgSender(), WHALE, 1, "");
    }

    function contractURI() public view returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmXaDgQxsDg3YvvDChv9JUvMwwMsktPPwQbkDfYaJZmhkh/nfts/lp-rewards/contract.json";
    }
