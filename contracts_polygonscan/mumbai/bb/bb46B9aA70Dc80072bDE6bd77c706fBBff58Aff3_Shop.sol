...
contract Shop is Ownable, AccessControlEnumerable, Pausable ,ReentrancyGuard {
    ...
    function pause() external onlyRole(DEFAULT_ADMIN_ROLE) whenShopNotPaused {
        _paused = true;
        emit ShopPaused();
    }

    function unpause() external onlyRole(DEFAULT_ADMIN_ROLE) whenShopPaused {
        _paused = false;
        emit ShopUnpaused();
    }
