...
contract DailyPrize is Ownable, VRFConsumerBase {
    ...
    event TicketsAdded(uint256 indexed day, uint256 tickets);
    event PrizeAdded(uint256 indexed day, uint256 amount);
    ...
    function addTickets(
        ...
        emit TicketsAdded(day, _tickets);
    }
        ...
        override
    {
        ...
        for (i = 0; i < dailyWinners[day].length; i++) {
            dailyPrize[dailyWinners[day][i]] =
                (info.prize * dailyPrize[dailyWinners[day][i]]) /
                100;
        }
