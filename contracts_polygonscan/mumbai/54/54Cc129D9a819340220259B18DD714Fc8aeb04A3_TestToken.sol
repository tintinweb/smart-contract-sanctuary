...
/**
 * Test token to verify token contract behaviour.
 */
contract TestToken is ERC20PresetMinterPauserUpgradeable {

    function initializeTestToken() public initializer {
        ERC20PresetMinterPauserUpgradeable.__ERC20PresetMinterPauser_init("Test", "T");
    }

    function mint(address to, uint256 value) public override whenNotPaused {
        _mint(to, value);
    }
}