...
contract TradingNFT {
        ...
        returns (bool)
    {
        ...
        require(msg.value >= seller.price, "Transaction fail");
        payable(seller.sellerAddress).transfer(seller.price);
    ...
    function cancelNFTCoin(uint256 tokenId) public returns (bool) {
        ...
        require(
            sellerCoin.sellerAddress == msg.sender,
            "your address is not authorized cancel it"
        );
    ...
    function cancelNFTToken(uint256 tokenId) public returns (bool) {
        ...
        require(
            sellerToken.sellerAddress == msg.sender,
            "your address is not authorized cancel it"
        );
