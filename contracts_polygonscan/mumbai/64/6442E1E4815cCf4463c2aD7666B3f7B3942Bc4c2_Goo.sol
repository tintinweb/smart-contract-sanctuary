...
contract Goo is Ownable, Pausable, IGoo, ERC721Holder {
    ...
    function pause() public onlyBuddyCore {
        _pause();
    }

    function unpause() public onlyBuddyCore {
        _unpause();
    }
    ...
    function mint(uint256 buddy, uint256 amount) external override onlyBuddyCore {
        require(
    ...
    function burn(uint256 buddy, uint256 amount) external override onlyBuddyCore {
