...
contract Encode is Master {
    ...
    function addPayloadParamBytes(bytes calldata _input)
        public
        pure
    ...
    function encodeEIP2612Permit(EIP2612Permit memory _data)
        public
        pure
        returns (bytes memory)
    {
    ...
    function decodeEIP2612Permit(bytes calldata _data)
        public
        pure
        returns (EIP2612Permit memory)
    {
        return abi.decode(_data, (EIP2612Permit));
    }

    function encodeDAIPermit(DAIPermit memory _data)
        public
        pure
        returns (bytes memory)
    {
    ...
    function decodeDAIPermit(bytes calldata _data)
        public
        pure
        returns (DAIPermit memory)
    {
        return abi.decode(_data, (DAIPermit));
    }
}
