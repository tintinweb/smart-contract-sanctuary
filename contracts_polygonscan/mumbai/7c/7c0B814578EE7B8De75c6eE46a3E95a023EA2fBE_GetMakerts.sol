...
contract GetMakerts is Ownable {
    ...
    address public COMPTROLLER=0x43f214f589a2C46D33F0784C6dc92f9c7B6c5cD1;
    address public ORACLE=0x183Fc9B132d81F7C66121a4A72eBDf6c681c2Af8;
    ...
    function getUnderlyingTokenAddress(address _pToken) public view returns (address){
        if (_pToken == 0xF39d724Bfb76e44F6C2A2ceAEC605d39C693b2E6) {
            return address(0);
        }else{
