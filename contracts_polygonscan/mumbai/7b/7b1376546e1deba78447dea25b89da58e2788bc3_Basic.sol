...
contract Basic is ERC721, Ownable{
  ...
  using Strings for uint256;
    ...
    * @notice number of minting nft must be greater than zero
    */
    function mint(address adresss, uint256 numberOfNfts) public payable {
        require(numberOfNfts > 0, "numberOfNfts cannot be 0");

        for (uint i = 0; i < numberOfNfts; i++) {
            _tokenIdTracker.increment();
            _safeMint(adresss, _tokenIdTracker.current());
        }
    }
