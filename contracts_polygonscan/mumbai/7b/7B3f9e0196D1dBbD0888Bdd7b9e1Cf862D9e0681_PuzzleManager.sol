...
contract PuzzleManager is VRFConsumerBase, Pausable {
    // Enums
    enum PackTier {
        BRONZE,
        SILVER,
    ...
    modifier onlyOwner() {
        require(
            whitelistedAddress[msg.sender] || msg.sender == owner,
    ...
    function _endPuzzle(
        ...
        uint8 index
    ) private onlyOwner whenNotPaused {
    ...
    function whitelistAddress(address whitelist) public onlyOwner {
    ...
    function removeWhitelistedAddress(address whitelist) public onlyOwner {
    ...
    ERC721Pausable
{
    ...
    modifier onlyAdmin() {
        require(
            msg.sender == managerContract || msg.sender == owner,
