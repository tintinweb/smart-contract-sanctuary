...
abstract contract BEP20Operable is BEP20, IBEP20Operable, ERC165 {
    ...
    function _checkAndCallTransfer(
        ...
        bytes4 retval = IBEP20OperableReceiver(recipient).onTransferReceived(_msgSender(), sender, amount, data);
    ...
    function _checkAndCallApprove(
        ...
        bytes4 retval = IBEP20OperableSpender(spender).onApprovalReceived(_msgSender(), amount, data);
 ...
 */
contract AmazingBEP20 is BEP20Mintable, BEP20Burnable, BEP20Operable, TokenRecover {
    constructor(
        string memory name_,
