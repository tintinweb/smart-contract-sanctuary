...
// File contracts/KyomafToken.sol
...
contract KyomafToken is ERC721Mintable, ERC721Permit("Kyomaf:Token") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("Kyomaf:Token", "KMF") {
        setDefaultURI("https://nft-studio/api/kyomaf/metadata/");
    }
