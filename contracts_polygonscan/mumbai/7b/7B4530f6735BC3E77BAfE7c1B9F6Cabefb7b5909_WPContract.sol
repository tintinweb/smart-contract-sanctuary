...
contract WPContract is ERC721 {
    ...
    constructor () public ERC721 ("Color Circle Shapes2", "SSEP"){
        tokenCounter = 0;
    }
    ...
    function createCollectible(string memory tokenURI) public returns (uint256) {
        ...
        require(newItemId < MAX_TOKENS + 1, "Exceeds maximum tokens available for purchase");
        // require(msg.value >= price.mul(newItemId), "Ether value sent is not correct");
