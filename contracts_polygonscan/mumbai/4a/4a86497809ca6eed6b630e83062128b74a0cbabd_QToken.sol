...
contract QToken is Context, IERC20, Ownable {
    ...
    string private _name = "QToken";
    string private _symbol = "QTO";
    ...
    constructor ()  {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x636A95E3c204B5017764C1E19bEcC667B4b8665D); // pancake swap router address
