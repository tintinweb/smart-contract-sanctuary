...
contract ArtisLifeNFT is ERC1155PresetMinterPauser {
    ...
    */
    function createNewNFT(
        ...
        nftData[nftCount].name = name;
        nftData[nftCount].symbol = symbol;
        nftData[nftCount].TOTAL_SUPPLY = totalNFTSupply;
        nftData[nftCount].creator = creator;
        nftData[nftCount].royalty = royalty;
        emit NFTCreated(nftCount);
    ...
    */
    ...
    function burnEdition(address account, uint256 id, uint256 edition) public {
        address operator = _msgSender();
        uint256 accountBalance = nftData[id].balanceOf[account];
        require(accountBalance >= 1, "ERC1155: burn amount exceeds balance");
       nftData[id].balanceOf[account] = accountBalance.sub(1);
