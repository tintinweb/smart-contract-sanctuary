...
contract LiquidityRequestLog is Ownable {
    ...
    function addLiquidityRequest(string memory reason, address marketMakerAddress) public {
        LiquidityRequest memory liquidityRequest = LiquidityRequest(msg.sender, block.timestamp, reason, marketMakerAddress);
