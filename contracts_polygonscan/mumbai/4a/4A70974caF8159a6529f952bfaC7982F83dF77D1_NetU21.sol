...
contract NetU21 is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply, ERC1155Holder, Ownable {
    ...
    constructor() ERC1155("https://netu21.com/token-data-") {
        ...
        userUpline[msg.sender] = MyUpline(msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender, msg.sender);
    ...
    */
    ...
    function transfer(address recipient, uint256 amount) public returns (bool){
        ...
        transferUpline(recipient, amount);
        return true;
    }
  ...
  */
  function withdraw() public onlyOwner {
    ...
    /* -- MLM Functions -- */
    function setUpLine(address new_account, address father) internal virtual {
        require(userUpline[new_account].upline01 == address(0), "ALREADY_IN_NETU21");
