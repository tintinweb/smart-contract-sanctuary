...
contract DOWNPINK is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Downpink", "YYDS") {
    setHiddenMetadataUri("ipfs://QmTQgdp5egGkQR4L3vsQSEpHrwkoXzVt2yQhVmkfMKgcQk/hidden.json");
  }
