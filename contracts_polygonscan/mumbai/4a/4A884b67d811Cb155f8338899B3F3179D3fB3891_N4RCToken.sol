...
contract N4RCToken is ERC721Enumerable, ERC2981Collection, ERC165Storage, Ownable {
  ...
  constructor(
    ...
    // TODO: https://github.com/MaxflowO2/ERC2981/blob/master/contracts/ERC721v2ETHCollection.sol#L59
  ...
  function supportsInterface(bytes4 interfaceId) public view override(ERC721Enumerable, ERC165Storage, IERC165) returns (bool) {
  ...
  // function royaltyInfo(uint256 _tokenId, int256 _salePrice) public virtual {
  ...
  //   console.log("Sender: %s, Contract: %s", msg.sender, this.owner());

  //   //payable(msg.sender).transfer(2000000000000000000000);
  //   payable(this.owner()).transfer(2000000000000000000000);
