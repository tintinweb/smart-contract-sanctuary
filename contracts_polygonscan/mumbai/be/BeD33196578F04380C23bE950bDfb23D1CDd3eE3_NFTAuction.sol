 ...
 address public nftContract;
  ...
  function endAuction(uint256 auctionId) public {
      require(msg.sender == idToAuction[auctionId].seller || msg.sender == address(this),"Caller has no rights");
       IERC721(nftContract).transferFrom(address(this),idToAuction[auctionId].bidder, idToAuction[auctionId].tokenId);
       idToAuction[auctionId].isActive= false;
       transferFundsToSeller(auctionId);
       if(idToAuction[auctionId].amount==0)
       {
  ...
  function transferFundsToSeller(uint256 auctionId) public payable {
        require(msg.sender == address(this));
       payable( idToAuction[auctionId].seller).transfer(idToAuction[auctionId].amount);
    }
  
   function transferFundsToLastBidder(uint256 auctionId) public payable {
         require(msg.sender == address(this));
