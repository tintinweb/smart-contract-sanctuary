...
contract TalkToTheHandTestnet is ERC721Enumerable, Ownable {
    ...
    function getAllowance() public view returns(uint256){
        return wethContract.allowance(msg.sender, address(this));
    }

    function wethApprove(address spender, uint256 amount) public returns(bool){
        return wethContract.approve(spender,amount);
    }
