 ...
 * The 'Chain Future is Coming' is the initial line of NFT art prepared by BlockAI.art in our 'modifai' technique (more on the BlockAI homepage - that is www.BlockAI.in).
 ...
 * 
 8 Practically any income from initially selling the NFT (not on secondary market) is used for improving liquidity of our BAIme token (more about it on www.BlockAI.site, soon).
