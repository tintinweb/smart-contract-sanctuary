...
contract Minty is ERC721, ERC721Enumerable, Ownable {
    ...
    function mint(address recipient, string memory cid)
        public
        returns (uint256)
    {
...
// like ERC721URIStorage but for IPFS CIDs
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721) returns (string memory) {
        require(_exists(tokenId), "Minty: URI query for nonexistent token");
    ...
    function _setTokenCID(uint256 tokenId, string memory _tokenCID) internal virtual {
        require(_exists(tokenId), "Minty: CID set of nonexistent token");
