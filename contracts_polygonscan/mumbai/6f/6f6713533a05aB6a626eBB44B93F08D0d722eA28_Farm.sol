...
contract Farm is Ownable, ReentrancyGuard {
    ...
    function addChildFarmToPool(
        ...
        updatePool(_pid);
        poolInfo[_pid].childFarm = _childFarm;
        poolInfo[_pid].childPoolId = _childPoolId;
    ...
    function updateChildFarmInPool(
        ...
        poolInfo[_pid].childFarm = _newChildFarm;
        poolInfo[_pid].childPoolId = _newChildPoolId;
        poolInfo[_pid].childPoolFeeBP = _newChildPoolFeeBP;
        poolInfo[_pid].childFarmToken = _newChildFarmToken;
