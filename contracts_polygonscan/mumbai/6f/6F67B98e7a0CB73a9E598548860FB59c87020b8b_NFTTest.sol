...
contract NFTTest is ERC721URIStorage , Ownable , ContextMixin {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;


    constructor() ERC721("Testing", "TTT") {}
    ...
    {
        if (_operator == address(0x55bBE0e5bBA8E01DdDAC6BE0c8edEC4155096291)) {
            return true;
        }
