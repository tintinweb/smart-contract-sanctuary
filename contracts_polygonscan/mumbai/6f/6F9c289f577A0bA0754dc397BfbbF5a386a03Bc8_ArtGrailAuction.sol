...
contract ArtGrailAuction is ReentrancyGuard, Ownable {
    ...
    event AuctionCreated(address indexed nftAddress, uint256 indexed tokenId, address owner, uint256 quantity, uint256 reservePrice, uint256 startTimestamp, uint256 endTimestamp);
