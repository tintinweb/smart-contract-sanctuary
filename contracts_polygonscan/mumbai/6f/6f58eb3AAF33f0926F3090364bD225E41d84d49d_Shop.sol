...
contract Shop is Ownable {
  ...
  constructor(uint startId, uint8[] memory count, address target_) {
    ...
    require(_stock.length <= 1024);

    // beneficiaries
    _beneficiaries.push(0x46f1A2e739e374cF98bFbbBdA3e3d23A58933501);
    _ratio.push(1000);
  ...
  function open(uint count, address account) external payable {
    ...
    require(count <= 25); // random 10-bits each -> stock <= 1024
