    ...
    Common
{
    ...
    */
    ...
    /**
        This function is to fix few if there was some problem in confirmation (example wrong quantity)
    **/
...
interface IContractProject {
    ...
    function isBannedVintageProject(string memory _projectKey, uint128 _vintage) external view returns(bool);
...
interface IContractProjectFactory {
    ...
    function symbolFactory(string memory _registry, string memory _project, uint128 _vintage) external pure returns (string memory);
    function projectHasToken(string memory _registry, string memory _project, uint128 _vintage) external view returns (bool);
    function getProjectVintageAddress(string memory _registry, string memory _project, uint128 _vintage) external view returns (address);
...
struct VCUSData {
    ...
    uint128 vintage; // the vintage of retirement
