...
contract Trade{
    ...
    */
    ...
    function buyToken(address _token, uint _price, uint _amount) public returns(uint){
    ...
    function sellToken(address _token, uint _price, uint _amount) public returns(uint){
        TokenType storage loadedToken = tokenList[_token];
        uint ethRequired = _price * _amount / 1000000000000000000;
