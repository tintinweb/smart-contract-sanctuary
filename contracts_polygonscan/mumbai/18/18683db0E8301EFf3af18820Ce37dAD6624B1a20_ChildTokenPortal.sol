...
contract ChildTokenPortal is IChildTokenPortal, ERC20 {
    ...
    /**
     * @notice called when underlying is redeemted on root chain
     * @dev Should be callable only on root chain
     * @param amount redeem amount
     */
    function redeemIOU(uint256 amount) external {
        require(block.chainid == 1, 'Only Rootchain');
        ...
        external
    {
        ...
        _mint(user, amount);(underlying, user, amount);
    }
    ...
    function withdrawTo(uint256 amount, address receiver) external override {
