...
contract RebornPiecesTestV2_4 is ERC721, ReentrancyGuard, Ownable {
    ...
    function addWhitelistMul(address[] calldata _addrs) public onlyOwner {
        require((whiteListNum + _addrs.length) <= 2, "only 100");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://www.shardsrespawn.com/api/nft/";
    }
