...
contract UserData is DAOCall{
     ...
     */
    event SetData(address indexed userAddr, bytes32 tag, bool data);
    event SetData(address indexed userAddr, bytes32 tag, uint data);
    event SetData(address indexed userAddr, bytes32 tag, int data);
    event SetData(address indexed userAddr, bytes32 tag, address data);
    event SetData(address indexed userAddr, bytes32 tag, string data);
    event SetData(address indexed userAddr, bytes32 tag, bytes data);
     ...
     * (only Register roll can call this function).
     */
    function setData(address userAddr, bytes32 tag, bool data) external onlyRoll("Register") {
        boolData[userAddr][tag] = data;
        emit SetData(userAddr, tag, data);
    }
    function setData(address userAddr, bytes32 tag, uint data) external onlyRoll("Register") {
        uintData[userAddr][tag] = data;
        emit SetData(userAddr, tag, data);
    }
    function setData(address userAddr, bytes32 tag, int data) external onlyRoll("Register") {
        intData[userAddr][tag] = data;
        emit SetData(userAddr, tag, data);
    }
    function setData(address userAddr, bytes32 tag, address data) external onlyRoll("Register") {
        addressData[userAddr][tag] = data;
        emit SetData(userAddr, tag, data);
    }
    function setData(address userAddr, bytes32 tag, string memory data) external onlyRoll("Register") {
        stringData[userAddr][tag] = data;
        emit SetData(userAddr, tag, data);
    }
    function setData(address userAddr, bytes32 tag, bytes memory data) external onlyRoll("Register") {
