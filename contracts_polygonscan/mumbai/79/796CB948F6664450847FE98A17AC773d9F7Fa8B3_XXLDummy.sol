...
contract XXLDummy is ERC721Enumerable{
    struct Traits {
        string traitName;
        string traitType;
        string pixels;
    ...
    constructor()
        ERC721("Matic Mike XXL", "XXL")
    {
        _owner = msg.sender;

        traitList.push(Traits(
            "dollar bill",
            "tips",
            "aa00ab00ac00ad00",
            4,
    ...
    */
        ...
        returns (string memory)
    {
        ...
        return "https://maticmike.club/api/alpha/get/";
    }
