...
contract Farm is ERC20, Ownable {
    ...
    // TODO: Understand how to correctly compute the value of endBlock. As of now it's 
    //          possible to have no rewards to distribute
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        require(allowance(msg.sender, address(this)) >= _amount, "withdraw: insufficient allowance for IBZF");
