...
// File: contracts/common/IERC2612Permit.sol
...
// File: contracts/common/Counters.sol
...
// File: contracts/common/ERC20Permit.sol
...
// File: contracts/sQuasarERC20.sol
...
contract sQuasarERC20Token is ERC20Permit, ManagerOwnable {
    ...
    constructor() ERC20("Staked Quasar", "sQUAS", 9) ERC20Permit() {
    ...
    function _storeRebase( uint previousCirculating_, uint profit_, uint epoch_ ) internal returns ( bool ) {
        ...
        rebases.push( Rebase ( {
            ...
            index: index(),
            timeOccured: uint(block.timestamp)
        }));
