...
contract BuddyCore is IBuddyCore, ERC721Full, ERC721Holder {
    ...
    function replicate(
        ...
        // Start a new random roll
        _buddyLogic.initRandom();
        child.dna = dna;
    ...
    {
        BuddyLib.Buddy storage base = _data[_tokenId];
        return (_buddyLogic.calcGGPD(base, false) * 1e18) * 90;
    }
...

{
  ...
  "libraries": {
    "contracts/libraries/BuddyLib.sol": {
      "BuddyLib": "0xd46080115e77d57bb57146189ad61eda5f333252"
    }
  }
}