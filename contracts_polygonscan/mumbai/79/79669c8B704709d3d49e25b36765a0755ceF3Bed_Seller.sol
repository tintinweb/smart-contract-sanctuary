...
contract Seller is ERC721, ERC2771Context {
    ...
    //todo check to call this function with different forwarder. Maybe we need to check isTrustedForwarder from the context
