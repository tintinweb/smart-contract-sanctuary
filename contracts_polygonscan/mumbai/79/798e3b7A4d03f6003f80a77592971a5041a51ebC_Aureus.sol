...
// File: libs/yield-farming/contracts/v1/Aureus.sol
...
contract Aureus is ERC20Capped, Ownable {
  ...
  function startProgram(uint256 poolShare, address poolCreator, address distributor) public onlyOwner {
    uint256 rewards = cap().sub(poolShare);
    _mint(poolCreator, poolShare);
    _mint(distributor, rewards);
  }
}