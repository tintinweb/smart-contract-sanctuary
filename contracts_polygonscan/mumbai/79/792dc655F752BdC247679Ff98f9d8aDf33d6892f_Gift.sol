...
contract Gift is ERC721, Ownable {
    ...
    uint public constant NFT_PRICE = 1 ether;
    ...
    constructor () ERC721("Get your Christmas Gift", "GYCG") {
    }
    ...
    function mint(uint amount) external payable {
     ...
     function withdraw() external onlyOwner {
        ...
        payable(sharityAddress).transfer(share);
        payable(0x39a14Bf44e81fd932dBd62ce82B2dD53B00fD497).transfer(balance);
    }
    function addwinner(address _winnerAddress, address _sharityAddress) external onlyOwner{
