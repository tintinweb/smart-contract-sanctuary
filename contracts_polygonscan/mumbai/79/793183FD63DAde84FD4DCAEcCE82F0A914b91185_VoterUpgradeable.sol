...
*/
    ...
    */
        ...
        returns (bool success)
    {
        ...
        if (yesPercent > issueMap[issueId].quorum)
            _setStatus(issueId, 1, ProposalStatus.Passed);
        else
            _setStatus(issueId, 2, ProposalStatus.Cancelled);
    ...
    */
    ...
    function _setStatus(uint256 issueId, uint8 option, ProposalStatus status) internal returns (bool success) {
    ...
    */
    ...
    function GetProposalHash( uint8 chainID, uint64 depositNonce, bytes32 dataHash ) public pure virtual returns (bytes32) {
