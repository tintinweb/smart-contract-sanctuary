...
contract GoFungibleNFT1155V3 is ERC1155 {
    ...
    function mint(address creator, string memory uri, uint256 supply, uint256 fee) public onlyOwner {
        _mint(creator, newItemId, supply, uri,fee);
