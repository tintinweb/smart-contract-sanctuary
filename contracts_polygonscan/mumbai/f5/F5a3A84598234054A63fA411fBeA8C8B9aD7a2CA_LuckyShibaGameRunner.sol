...
contract LuckyShibaGameRunner is Ownable { 
    ...
    event GenerateRandomFigureEvent(string period, uint256 number, address to);
    ...
    function generateRandomFigure(string memory period, uint256 number) public {
        bool _found = false; 
        ...
        emit GenerateRandomFigureEvent(period, currentNumber, _msgSender());
    }
