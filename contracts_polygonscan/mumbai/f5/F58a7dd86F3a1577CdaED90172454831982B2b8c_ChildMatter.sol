...
contract ChildMatter is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _childChainManagerProxy) initializer public {
        __ERC20_init("Matter", unicode"⚛️");
        __Pausable_init();
