...
contract Presale is Ownable {
    ...
    function deposit(uint256 _amount) public {
        ...
        require(tokenTheir.transferFrom(msg.sender, address(devAddress), _amount / (1 / devFeePercent) * 100)); // 50% of tokenTheir deposited here goes to devAddress, the rest stays in this contract
