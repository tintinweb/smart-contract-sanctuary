...
contract JAZZPharaos is ERC721, ERC721Enumerable, VRFConsumerBase {
    ...
    {
        base = base_;
        unitPrice = priceInMatic * 1 ether;
        keyHash = key;
        admin = msg.sender;

        // base = "ipfs://QmXtWvmyr9Qs7ZEhZvTL3Cg64A2wuLVrP4RBZV7nqLeNRY/pyramid";
    }
    // modifiers
