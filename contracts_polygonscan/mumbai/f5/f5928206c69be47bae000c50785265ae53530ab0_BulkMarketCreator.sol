...
contract BulkMarketCreator {
    function createMulipleMarkets(uint32[] memory _currencyIndexes, uint32[] memory _marketTypes, address _marketCreatorContract) public{
