...
// File: contracts/javi-prueba-token.sol
 ...
 */
 ...
 contract JaviToken is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Javi-Token", "JPT") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x9392Da57125f3D36e58A1358A10fD11C3b6Dd58a);
          _setupRole(MINTER_ROLE, 0x9392Da57125f3D36e58A1358A10fD11C3b6Dd58a);
          _setupRole(MINTER_ADMIN_ROLE, 0x9392Da57125f3D36e58A1358A10fD11C3b6Dd58a);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
         transferOwnership(0x9392Da57125f3D36e58A1358A10fD11C3b6Dd58a);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "JaviToken/minter-role-required");
         _mint(to, tokenId);
