...
contract AWST_ERC1155 is ERC1155, IERC1155MetadataURI, Ownable {
    ...
    function setURI(uint256 _tokenId, string memory _uri) public virtual onlyOwner {
        _tokenURIs[_tokenId] = _uri;
    }

    function setBatchURI(uint256[] memory ids, string memory baseURI)
        public
        virtual
        onlyOwner
    {
