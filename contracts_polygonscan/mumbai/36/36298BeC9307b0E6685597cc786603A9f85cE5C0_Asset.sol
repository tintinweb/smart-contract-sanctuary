...
contract Asset is IAsset, Ownable {
    ...
    /// @param oracle oracle of collateral,if 鈥?x0鈥? it's a stable coin
    ...
    function registerCollateral(address cAssetToken, address oracle, uint16 multiplier) external onlyOwner {
        ...
        _cAssetsMap[cAssetToken] = CAssetConfig(IERC20Extented(cAssetToken), IChainlinkAggregator(oracle), multiplier, true);
    }
