...
contract NftCollection is ERC721Namable, Ownable{
   ...
   mapping(address => bool) whiteList;
    ...
    function getTier1Price() public view returns(uint){
        return PRICETIER1;
    }

    function getTier2Price() public view returns(uint){
        return PRICETIER2;
    }
    ...
    function mint(uint256 _id, uint256 tier) public payable {
        ...
        if(walletIsInWhiteList(msg.sender)){
