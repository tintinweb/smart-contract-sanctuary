...
contract DPSShipyard is Ownable, ReentrancyGuard {
  ...
  mapping(uint256 => bool) private mintedFlagships;
  ...
  function claimFlagship(uint16 _dpsId) external nonReentrant {
    ...
    require(!mintedFlagships[_dpsId], "Flagship already minted");
    mintedFlagships[_dpsId] = true;
    flagship.mint(msg.sender, _dpsId);
    emit FlagshipMinted(msg.sender, _dpsId);
  }

  function repairFlagship(uint256 _flagshipId) external nonReentrant {
