    ...
    IStateReceiver
{
    ...
    */
    ...
    function onStateReceive(uint256 _tokenId, bytes calldata _data) external override {
        (string memory multihash) = abi.decode(_data, (string ));
        _setTokenURI(_tokenId, multihash);
    }
}