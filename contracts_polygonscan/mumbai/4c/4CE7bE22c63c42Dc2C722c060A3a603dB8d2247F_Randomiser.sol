...
contract Randomiser is Ownable, ReentrancyGuard, VRFConsumerBase {
    address private linkTokenAddress;
    uint256 public vrfFee = 0.0001 * 10**18;
    bytes32 public vrfKeyHash =
        keccak256(abi.encode("DM Danny and tell him how handsome he is"));
    ...
    /**
     * Request a random number from Chainlink VRF Coordinator.
     */
    function getRandomness(address callbackContract)
        public
        onlyAuthorised
