...
contract ERC721Rarible is ERC721Base {
    ...
    constructor (string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address exchangeProxy) public {
        __ERC721Rarible_init( _name, _symbol, baseURI, contractURI, exchangeProxy);
    }

    // address transferProxy, address lazyTransferProxy
    function __ERC721Rarible_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address exchangeProxy) public initializer {
