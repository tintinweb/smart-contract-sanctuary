...
contract NPT_PCCGame2 is VRFConsumerBase, Pausable, Ownable {
    enum PackTier {
        GOLD
    }
    ...
    constructor(
        ...
        slowMode = true;
        slowModeTime = 120; // 2 minute intervals between pack purchases
        ...
        prizeFactory = PrizeFactory(0xe3Ba0DCe12DAF625132d43Dd628B4D3C04B0c833);
        pieceFactory = PieceFactory(0x237A7F591b251E94e83dC7Ab4dAdDdDA8f9D3659);
