...
abstract contract Whitelist is Ownable {
    ...
    function viewWhitelistAddreses() public view returns(address[] memory) {
        return whitelistAddresses;
    }

    // function viewWhitelist() public view returns(address[] memory) {
    //     address[] memory userList = new address[](idIterator);
    //     for(uint i=0; i<idIterator; i++) {
    //         return whitelistUser[i];
    //     }
    // }
}
