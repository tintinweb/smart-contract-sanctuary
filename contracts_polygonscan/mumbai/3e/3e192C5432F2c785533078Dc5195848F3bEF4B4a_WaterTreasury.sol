...
contract WaterTreasury is Ownable, IWaterTreasury {
    ...
    address public sOxygen;
    uint256 public sOxygenQueue; // Delays change to sOxygen address
    ...
    constructor(
        ...
        isLiquidityToken[_OxygenDAI] = true;
        liquidityTokens.push(_OxygenDAI);
        bondCalculator[_OxygenDAI] = _bondCalculator;
    ...
    function deposit(
        ...
        IERC20Mintable(Oxygen).mint(msg.sender, send_);
    ...
    function withdraw(uint256 _amount, address _token) external override {
        ...
        uint256 value = valueOfToken(_token, _amount);
        IOxygenERC20(Oxygen).burnFrom(msg.sender, value);
    ...
    function incurDebt(uint256 _amount, address _token) external {
        ...
        uint256 maximumDebt = IERC20(sOxygen).balanceOf(msg.sender); // Can only borrow against sOxygen held
    ...
    /**
        ...
        @param _amount uint
     */
    function repayDebtWithOxygen(uint256 _amount) external {
        require(isDebtor[msg.sender], 'Not approved');

        IOxygenERC20(Oxygen).burnFrom(msg.sender, _amount);
        ...
        override
    {
        ...
        IERC20Mintable(Oxygen).mint(_recipient, _amount);
        ...
        returns (uint256 value_)
    {
        if (isReserveToken[_token]) {
            ...
            value_ = _amount.mul(10**IERC20(Oxygen).decimals()).div(
        ...
        returns (bool)
    {
        ...
        } else if (_managing == MANAGING.SOxygen) {
            // 9
            sOxygenQueue = block.number.add(blocksNeededForQueue);
        } else return false;
