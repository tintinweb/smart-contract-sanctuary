    ...
    ERC2981ContractWideRoyalties
{
    ...
    modifier existingSeason(uint256 seasonLootId) {
        require(
            ...
            "There is no existing SeasonLoot on given ID."
        );
        _;
    }
        ...
        nonReentrant
    {
        ...
        _claimantToSeasonLootIdToClaimStatus[msg.sender][seasonLootId] = true;
        ...
        existingSeason(seasonLootId)
    {
        ...
        for (uint256 index = 0; index < recipients.length; index++) {
            ...
            // Set the mint status to true, indicates as claimed for a {SeasonLoot}
            _claimantToSeasonLootIdToClaimStatus[recipient][
                seasonLootId
            ] = true;
     ...
     */
    function createSeasonLoot(string calldata _tokenURI)
        external
        onlyAdmin
        returns (uint256)
    {
