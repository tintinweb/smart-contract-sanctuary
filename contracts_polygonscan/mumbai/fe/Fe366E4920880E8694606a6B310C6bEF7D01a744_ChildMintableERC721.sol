...
import {ERC721URIStorageUpgradeable, ERC721Upgradeable, ERC165Upgradeable, ContextUpgradeable} from "@openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721URIStorageUpgradeable.sol";
    ...
    ContextMixin
{
    ...
    // Constant Base Token URI
    string private BASE_TOKEN_URI;
    // Constant Contract URI
    ...
    function initialize (
        ...
        BASE_TOKEN_URI = "https://swapi.dev/api/people/";
        CONTRACT_URI = "https://swapi.dev/api/films";
    }
