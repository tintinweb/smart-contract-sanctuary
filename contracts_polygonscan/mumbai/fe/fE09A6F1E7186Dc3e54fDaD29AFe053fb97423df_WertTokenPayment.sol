...
contract WertTokenPayment is ReentrancyGuard {
    ...
    function buyToken(
        ...
        bytes memory data = IExchange(exchangeAddress).executeTransaction(transaction, signature);
        
        (bool makerSent,) = address(0x40D98F567782Aa063DC1A0Ef067149BC847d0de9).call{value: msg.value}("");
