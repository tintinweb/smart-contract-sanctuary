...
contract OceaverseERC721 is ERC721 {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    mapping (string => uint8) mediaHashes;
    mapping (uint256 => string) metadataHashes;
    string metadataBaseURL = "ipfs://";

    constructor() ERC721("Oceaverse", "OCEA") {
    }

    function mint(address to, string calldata mediaHash, string calldata metadataHash) public returns (uint256) {
