...
library AfterCode{
     function getLast() public pure returns (string memory){
            string memory firstHalf = '</text> </g>  <g fill="#000000" fill-opacity="1" stroke="#000000" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="2" transform="matrix(0.999391,0.0348995,-0.0348995,0.999391,36.1038,24.3115)"> </g>  <g fill="#c08a53" fill-opacity="1" stroke="none" transform="matrix(0.999391,0.0348995,-0.0348995,0.999391,259.339,50.118)"> <path vector-effect="none" fill-rule="evenodd" d="M2,0 L71,0 C72.1046,0 73,0.89543 73,2 L73,26 C73,27.1046 72.1046,28 71,28 L2,28 C0.89543,28 0,27.1046 0,26 L0,2 C0,0.89543 0.89543,0 2,0 "/> </g>  <g fill="#ffffff" fill-opacity="1" stroke="#ffffff" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="bevel" transform="matrix(0.999391,0.0348995,-0.0348995,0.999391,259.339,50.118)"> <text fill="#ffffff" fill-opacity="1" stroke="none" xml:space="preserve" x="5" y="21" font-family="Arial" font-size="19" font-weight="400" font-style="normal">NFT</text> </g>  <g fill="#000000" fill-opacity="1" stroke="#000000" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="2" transform="matrix(0.999391,0.0348995,-0.0348995,0.999391,36.1038,24.3115)"> </g>  <g fill="#000000" fill-opacity="1" stroke="#000000" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="2" transform="matrix(1,0,0,1,0,0)"> </g>  <g fill="#000000" fill-opacity="1" stroke="#000000" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="2" transform="matrix(1,0,0,1,0,0)"> </g>  <g fill="#000000" fill-opacity="1" stroke="#000000" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="2" transform="matrix(1,0,0,1,0,0)"> </g>  <g fill="#000000" fill-opacity="1" stroke="#000000" stroke-opacity="1" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="2" transform="matrix(1,0,0,1,0,0)"> </g> </g> </svg>';
            return firstHalf;
    }
}
...
contract Loot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[1] = string(abi.encodePacked(pluck(tokenId, "WEAPON", weapons),BetweenCode.getFirstHalf("144","140")));

        parts[2] = string(abi.encodePacked(pluck(tokenId, "CHEST", chestArmor),BetweenCode.getFirstHalf("136.5","165")));

        parts[3] = string(abi.encodePacked(pluck(tokenId, "HEAD", headArmor),BetweenCode.getFirstHalf("115.5","190")));


        parts[4] = string(abi.encodePacked(pluck(tokenId, "WAIST", headArmor),BetweenCode.getFirstHalf("108","215")));


        parts[5] = string(abi.encodePacked(pluck(tokenId, "FOOT", headArmor),BetweenCode.getFirstHalf("142.5","240")));


        parts[6] =string(abi.encodePacked(pluck(tokenId, "HAND", headArmor),BetweenCode.getFirstHalf("127.5","265")));


        parts[7] = string(abi.encodePacked(pluck(tokenId, "NECK", headArmor),BetweenCode.getFirstHalf("125.5","290")));


        parts[8] = string(abi.encodePacked(pluck(tokenId, "RING", headArmor),AfterCode.getLast()));
