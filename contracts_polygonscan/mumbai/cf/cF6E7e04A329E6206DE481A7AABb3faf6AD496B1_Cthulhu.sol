...
contract Cthulhu is ERC721Enumerable, Ownable {
    using Strings for uint256;
  ...
  // internal
    ...
    function mintCthulu(uint8 mintQty) public payable { _iterateMint(0, mintQty); }
  ...
  // public
    ...
    function _updateAutoFloorPrice() internal {
        ...
        if(_totalSupply > 2498) { _setPrice(2 ether ); }
        else if(_totalSupply > 2497) { _setPrice(3 ether); }
        else if(_totalSupply > 2496) { _setPrice(4 ether ); }
    }
    ...
    function distributePayment() internal {
        ...
        Address.sendValue(payable(0x416C3569673aD98D7946B490c5010D71a096030c), splitA);
        Address.sendValue(payable(0x416C3569673aD98D7946B490c5010D71a096030c), splitB);
        Address.sendValue(payable(0x416C3569673aD98D7946B490c5010D71a096030c), splitC);
        Address.sendValue(payable(0x416C3569673aD98D7946B490c5010D71a096030c), splitD);
        Address.sendValue(payable(0x416C3569673aD98D7946B490c5010D71a096030c), splitE);
        Address.sendValue(payable(0x416C3569673aD98D7946B490c5010D71a096030c), splitF);
    }
