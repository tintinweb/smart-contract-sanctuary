...
// File contracts/lib/ERC1155Upgradeable.sol
...
// File contracts/child/ChildMintableERC1155.sol
	...
	ContextMixin
{
	...
	modifier only(bytes32 role) {
		require(hasRole(role, _msgSender()), "ChildMintableERC1155: access denied");
		_;
	}
	 ...
	 * @param _uri basic URI for collection
	 * @param _owner the owner of collection which have DEFAULT_ADMIN_ROLE
	 * @param _childChainManager abi encoded ids array and amounts array
	 */
	function initialize(
		string memory _name,
	...
	function burn(
		...
		require(
			...
			"ChildMintableERC1155: caller is not approved"
		);
