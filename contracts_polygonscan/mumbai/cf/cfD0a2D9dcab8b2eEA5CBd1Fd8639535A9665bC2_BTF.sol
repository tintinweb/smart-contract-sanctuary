...
contract BTF is ERC721Enumerable {
    constructor()
        ERC721("BobTheFish","BTF")
    {}
    ...
    string constant private CONTRACT_URI        = 'http://the-test-nft.s3-website-us-east-1.amazonaws.com/contract.json';
    string constant private PLACEHOLDER_URI     = 'http://the-test-nft.s3-website-us-east-1.amazonaws.com/';
    string private metadataURI                  = '';
    bool private metadataSet                    = false;

    address payable private constant CONTROLLER = payable(0x80cc43aD8500644d4fa5648E8A849C2ccfc176E5);
