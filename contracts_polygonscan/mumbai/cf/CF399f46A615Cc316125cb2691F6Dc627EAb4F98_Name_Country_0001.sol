...
contract Name_Country_0001 is VRFConsumerBase, AccessControl, Pausable,
...
LotteryDistribution {
    ...
    /*constructor(address yachtOwner_,address broker_, address agency_, address surveyor_,
            uint8 winnerCount_, uint256 yachtPrice_,uint256 _1YearYachtExpenses_, uint256 ticketPrice_) */
    constructor()
    VRFConsumerBase(_vrfCoordinatorAddres, _vrfLinkToken){
        ...
        */
        ...
        _yachtOwner = address(0x1990CA1e3D6527678c17aC014B282e6F051A0e2e);
        _broker = address(0xd4D325419f9933D24Ce3C417E5b38eEDE00913a6);
        _agency = address(0xdB67AB2aD91bD6Ca76365863A3e60FCb66dbaf8F);
        _surveyor = address(0xdB67AB2aD91bD6Ca76365863A3e60FCb66dbaf8F);
        _winnerCount = 3;
    ...
    function activateNextWinnerForSale() public onlyRole(ADMIN_ROLE) {
    ...
    function generateTicket(uint256 randomness, address buyerAddress) private {
        ...
        if(_yachtPrice.add(_1YearYachtExpenses).mul(2)<getBalance()){
            _lottery_state = LOTTERY_STATE.LOTTERY_TIME;
        }
    }

    function generateWinners(uint256 randomness) private {
        uint256 winningTicket = _ticketsArray[randomness % _ticketsArray.length];
