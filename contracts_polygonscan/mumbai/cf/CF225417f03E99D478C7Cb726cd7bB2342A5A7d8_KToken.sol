...
contract KToken is ERC20 {
    ...
    uint _strike = 3405.0; // This has 8 decimals and represents the value in USD
    uint _maturity = 30;
    uint _expiresOn = 1628678373;
    bool _isPut = true;
    
    address public minter = 0x6e9969C43b1D08aE4f7aBdE98Af8310509a71cEb; //This is the Octopus smart contract
