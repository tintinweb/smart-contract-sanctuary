...
contract PublicCollection is Ownable, ERC721, ICollection {
    ...
    // 定数
    //--------------------------------------
    string constant private TOKEN_NAME = "Lead Edge Market Public Collection";
    string constant private TOKEN_SYMBOL = "LEMPC";
    ...
    //------------------------------------------------------------------------------
    function createToken( string calldata metaHash, string calldata signature ) external override {
        // 署名確認（公開コレクション）
    ...
    //------------------------------------------------------------------------------
    function updateMetaHash( uint256 tokenId, string calldata metaHash, string calldata signature ) external override {
        require( _exists( tokenId ), "nonexistent token" );
    ...
    //-------------------------------------------------------------------
    function createTokenWithAdmin( address creator, string calldata metaHash ) external override onlyOwner {
        uint256 tokenId = _meta_hashes.length + TOKEN_ID_OFFSET;
    ...
    //-------------------------------------------------------------------
    function updateMetaHashWithAdmin( uint256 tokenId, address creator, string calldata metaHash ) external override onlyOwner {
        require( _exists( tokenId ), "nonexistent token" );
