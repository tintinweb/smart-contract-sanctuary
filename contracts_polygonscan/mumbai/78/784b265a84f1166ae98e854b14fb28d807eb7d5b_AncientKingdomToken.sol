...
contract AncientKingdomToken is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    string public constant name = "Ancient Kingdom";
    ...
    function retrieveERC20Token(address tokenAddress, uint256 tokens) external onlyOwner returns (bool success) {
