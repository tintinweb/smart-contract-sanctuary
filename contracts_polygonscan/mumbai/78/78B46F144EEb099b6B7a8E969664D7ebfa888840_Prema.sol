...
contract Prema is ERC20, Ownable, AccessControl, Pausable {
  mapping(address => bool) public blackList;

  bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

  constructor() ERC20("Prema Coin", "PREMA") {
    _setupRole(MINTER_ROLE, 0x65C2f3acceC21fA5bd5869572273dA7b7296AdEA);
  }
