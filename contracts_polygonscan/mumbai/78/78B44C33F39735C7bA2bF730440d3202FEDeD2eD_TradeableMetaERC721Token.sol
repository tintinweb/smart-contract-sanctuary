...
contract TradeableMetaERC721Token is TradeableERC721Token, ContextMixin, NativeMetaTransaction {
    ...
    constructor(string memory  _name, string memory  _symbol, address _owner, address _proxyAddress, string memory _contractUri) TradeableERC721Token(_name, _symbol, _owner, _contractUri) {
