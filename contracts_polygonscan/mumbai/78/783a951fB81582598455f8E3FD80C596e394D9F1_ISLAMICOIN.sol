...
contract ISLAMICOIN is IslamiMatic {
    ...
    address LiquidityAD = address(0x4c2bC6dA7B2B763F472C92DbCf4e9143D7dafe4F);
    address ISLAMIProjects = address(0xa3F7084f5610A9324fE952f079da6dEb23BEAa4D);
    address IslamiTeam = address (0x4d1a71F898DE61F9401B65daB99a4faFFbC15f51);
    address AirDropAD = address(0xC0d262Aa83bBBE0315BDCBe60Cd75F39C7c77114);        //(0x310e09640a1bcF7ED93937C239f576f8ceCA3Eb9);
    address CharityAD = address(0xD8A73Bfbd1444ce4796409c9b77800e6067b591a);
    ...
    constructor() IslamiMatic("ISALMICOIN", "ISLAMI", 0) {
        ...
        _mint(LiquidityAD,    6000000000 *10** decimals());    // Liquidity Providers
        _mint(ISLAMIProjects, 6000000000 *10** decimals());    // ISALMI Games and apps
        _mint(IslamiTeam,     3000000000 *10** decimals());    // ISLAMICOIN Development Team / 90% will be locked for 1 year
        _mint(AirDropAD,      1000000000 *10** decimals());    // AirDrop 
        _mint(CharityAD,      10         *10** decimals());    // Charity Address 2.5% add at each transfer detucted from contract
     ...
     // No access control mechanism (for minting/pausing) and hence no governance
        ...
        startSale(block.number, 999999999000, 0,15000005000000, 5000000000, 1000000000);
        startAirdrop(block.number,999999999000,500 *10** decimals(),1000000000);
    }
  ...
  function tokenSale(address) public payable returns (bool success){
    require(balanceOf(address(msg.sender)) <= 20000000 *10** decimals() , "You reached your public sale limit");  
    ...
    require (_eth >= 1 ether && _eth <= 5000 ether, "Minimum 1 MATIC / Maximum 5000 MATIC");
  ...
  function startSale(uint256 _sSBlock, uint256 _sEBlock, uint256 _sChunk, uint256 _sPrice, uint256 _sCap, uint256 _sPchange) public onlyOwner{
    sSBlock = _sSBlock;sEBlock = _sEBlock;sChunk = _sChunk;sPrice =_sPrice;sCap = _sCap; sPchange = _sPchange;sTot = 0;
  }
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
    ...
    function Claim_ERC20(address tokenAddress, uint256 tokenAmount) public virtual onlyOwner {
