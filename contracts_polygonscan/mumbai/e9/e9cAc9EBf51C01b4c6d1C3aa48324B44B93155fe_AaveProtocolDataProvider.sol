...
interface ILendingPoolAddressesProvider {
  ...
  event DistributorUpdated(address indexed newAddress);
  ...
  function setDisributor(address distributor) external;
}

// File: contracts\protocol\libraries\types\DataTypes.sol
