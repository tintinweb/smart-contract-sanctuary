...
contract Consts {
    ...
    string public constant TOKEN_NAME = "SuperTestCrodwdsale";
    string public constant TOKEN_SYMBOL = "STC";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0xBE2d1FAa875c983c7e8f836b554AAb125522BC6F; //Détenteur du contrat token
    
    uint public constant START_TIME = 1612134000;
    ...
    
{
    ...
    function init() private {
        ...
        address[4] memory addresses = [address(0x78AfF3b8b1de9242cC2dc8f19930C83454F1FF82),address(0xC19cC37dC1593B6B67c305C31F4F64edbc730062),address(0x473998a6eFeB8C676D369E105afB6cc73a0FaDBC),address(0xABEfc6Afc055387076056eB9f9cC7e25Bc7756Ea)];
    ...
    //Livrer le contrat Token
    //Mettre le token en pause
    //Livrer le contrat Crowdsale
    //Donner ownership token au contrat crowdsale
