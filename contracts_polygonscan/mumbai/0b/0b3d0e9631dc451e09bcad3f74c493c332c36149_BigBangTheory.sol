...
/// if you win you will get twice the  amount of token required to play at once😁🙀🙈
contract BigBangTheory is ERC721URIStorage, VRFConsumerBase {
    ...
    function requestRandomAttributes(uint256 _iq,uint _amount) public returns (bytes32) {
        require(_iq >= 100 && _iq <= 200, "IQ range should lies in 100-200");
        require(LINK.balanceOf(address(this)) >= fee, "Not enough LINK ");
        characterIQ = _iq;
        require(token.allowance(msg.sender,address(this)) > _amount, "Please allow fund first");

        uint256 tokensToPlay = 1 ether / bbtTokensPerEth;
        require(_amount >= tokensToPlay, "Not enough Token ");
    ...
    //verifiable randomly generated IQ, you receive twice the  amount of token required to play at once
