...
contract tokenNFT is ChildMintableERC721 {
  ...
  constructor() ChildMintableERC721("tokenNFT", "NFT", 0xb5505a6d998549090530911180f38aC5130101c6) {}

  function mintable(address recipient, string memory uri) public virtual returns (uint256) {
    _tokenIds.increment();
  ...
  function getHash() public view returns (string memory x, address currentOwner) {
    currentOwner = owner;
    x = ipfsHash;
  }
