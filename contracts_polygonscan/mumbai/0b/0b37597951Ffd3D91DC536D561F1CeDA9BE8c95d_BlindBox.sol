    ...
    */
    function buyBox(uint256 seriesId, bool isGenerative, uint256 currencyType, address collection, string memory ownerId) public {
        if(isGenerative){
            ...
            buyNonGenBox(seriesId, currencyType, collection, ownerId);
        }
    }
...
/** 
    ...
    @notice given series should not be ended or its max boxes already minted.
    */
    function buyNonGenBox(uint256 seriesId, uint256 currencyType, address collection, string memory ownerId) validateCurrencyType(seriesId,currencyType, false) internal {
