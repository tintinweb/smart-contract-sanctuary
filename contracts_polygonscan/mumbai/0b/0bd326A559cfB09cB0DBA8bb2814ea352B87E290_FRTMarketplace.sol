...
contract FRTMarketplace is Ownable{
    ...
    function checkAlowance(address operator) internal view returns (uint256){
        return baseToken.allowance(operator, address(this));
    }
    ...
    function buyNFT(uint256 tokenId) public {
        ...
        require(checkAlowance(msg.sender) >= baseNFTPrice, "FRTMarketplace: transfer amount exceeds allowance");
