...
contract Mayhem is ERC721X, Ownable {
    ...
    event SalePhaseUpdate(uint256 phase);
    ...
    uint256 public constant WHITELIST_PURCHASE_LIMIT_1 = 5;
    uint256 public constant WHITELIST_PURCHASE_LIMIT_2 = 3;
    uint256 public constant WHITELIST_PURCHASE_LIMIT_3 = 1;
    ...
    constructor() ERC721X('Mayhem', 'MAYHEM') {}
    ...
    function whitelistMint(
        ...
        uint256 purchaseLimit = (
            tier == 1 ? WHITELIST_PURCHASE_LIMIT_1 : tier == 2 ? WHITELIST_PURCHASE_LIMIT_2 : WHITELIST_PURCHASE_LIMIT_3
        );
