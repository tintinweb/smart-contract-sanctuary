...
// File contracts/GeishaTeehouse.sol
...
contract GeishaTeehouse is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public preSaleStartDate = 1635710400;
    ...
    function setPreSaleEndDate(uint256 _preSaleEndDate) public onlyOwner {
        require(_preSaleEndDate <= preSaleStartDate, "wrong date assignment");
