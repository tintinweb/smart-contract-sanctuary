...
contract NewNft is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 0.8123 ether;
  ...
  function changeNftExtension(string memory _newBaseExtension) public onlyOwner {
  ...
  function withdrawToBoss(uint amount) public onlyOwner {
