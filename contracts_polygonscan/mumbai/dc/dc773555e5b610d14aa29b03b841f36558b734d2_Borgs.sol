...
contract Borgs is ERC721Enumerable, Ownable, ContractStates, CommonObjects, NumberUtils{
    ...
    function getBorg(uint256 borgId) public view returns(Borg memory borg){
    ...
    function addListing(uint256 tokenId, uint256 price, address buyer) public{
        ...
        // Set listing
        Listing memory listing = Listing(true,price,msg.sender,buyer);
    ...
    function removeListing(uint256 tokenId) public{
        ...
        this.transferFrom(address(this), listing.owner, tokenId);
    }
    ...
    function _createBorg(string[] memory borgAttributeNames, uint256[] memory layerItemPositions, uint256 parentAId, uint256 parentBId) internal returns(uint256){
        ...
        borg.image = _combineBorgAttributes(borgAttributeNames);
