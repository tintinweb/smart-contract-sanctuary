...
// File libs/BaseRelayRecipient.sol
...
// File contracts/moneyPrinter/MoneyPrinterVaultTestnet.sol
...
interface IStrategy{
    ...
    function withdrawTestnet(uint _amount, IERC20 _token) external;
}
...
/*         DAI.safeApprove(address(QuickSwapRouter), type(uint).max);
    ...
    function withdraw(uint256 _shares, IERC20 _token) external {
        ...
        if(isEmergency) {
            ...
            strategy.withdrawTestnet(amount, _token);
