...
contract FRTMarketplace is Ownable{
    ...
    function buyNFT(uint256 _tokenId) public {
        // require(downloadAllowed[msg.sender][_tokenId] != true, "FRTMarketplace: Already purchased");
    ...
    function downloadNFT(uint256 _tokenId) public view returns(string memory){
        //require(downloadAllowed[msg.sender][_tokenId] == true, "FRTMarketplace: Unauthorised!");
