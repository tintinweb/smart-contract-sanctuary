...
contract GMICO is ReentrancyGuard, Context, Ownable{
    using SafeMath for uint256;
    
    mapping(address => bool) private Claimed;
    mapping(address => bool) private _isWhitelist;
    mapping(address => uint256) private _valDrop;
    uint256 public PerClaim = 10000000 * (10**9);
...
//    event WhitelistSetted(address[] recipient, uint256[] amount);
     ...
     //Start Airdrop
    function startICO(IERC20 tokenAddress) public onlyOwner{
...
*/
    ...
    function claim() public payable nonReentrant {
        ...
        require(msg.value >= 1, "Must more than 1 polygon !");
//        require(Claimed[msg.sender] == false, 'Airdrop already claimed!');
        if(_token.balanceOf(address(this)) == 0) { airdropLive = false; return;}
        Claimed[msg.sender] = true;
//        uint256 amount = _valDrop[msg.sender].mul(10**18);
        _token.transfer(msg.sender, PerClaim);
