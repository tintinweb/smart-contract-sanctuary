...
contract TimeLockedWalletFactory is Ownable {
    ...
    function newTimeLockedWallet(address owner, uint amount, uint unlockTime) public returns (address wallet) {
        ...
        wallet = Clones.clone(0x4299a2BEE74dAd68a7EF354847ae781950683181);
        TimeLockedWallet(wallet).initialize(owner, tokenContract, amount, unlockTime);
...
contract TimeLockedWallet is Ownable, Initializable {
    ...
    function initialize(address _owner, address _tokenContract, uint _amount, uint _unlockTime) public initializer {
