...
contract RacerChild is Racer, IChildToken, NativeMetaTransaction, ContextMixin {
    ...
    ) public Racer(_name, _symbol, _baseTokenURI, _meltTokenAddress) {
        _setupContractId("RacerChild");
        _setupRole(DEFAULT_ADMIN_ROLE, __msgSender());
    ...
    modifier only(bytes32 role) {
        require(hasRole(role, __msgSender()), _revertMsg);
        _;
    }
    ...
    function withdrawBatch(uint256[] calldata tokenIds) external {
        ...
        emit WithdrawnBatch(__msgSender(), tokenIds);
    }
        ...
        only(DEFAULT_ADMIN_ROLE)
    {
        require(
            ...
            "RacerChild: TOKEN_EXISTS_ON_ROOT_CHAIN"
        );
        //TODO: Call factory mint method here
        _mint(user, tokenId);
    }
}
...

{
  ...
  "libraries": {
    "/contracts/Utilities.sol": {
      "Utilities": "0xC52573a37a26BF51EF0B3644518BBF61f4464026"
    }
  },
  "outputSelection": {
    "*": {
