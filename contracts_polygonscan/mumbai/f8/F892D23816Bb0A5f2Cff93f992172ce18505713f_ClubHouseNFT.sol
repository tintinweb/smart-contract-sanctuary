...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract ClubHouseNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(supply + _mintAmount <= maxSupply, "Exceeded mint supply.");
        // Updated cost validation
