...
contract NFTsAgainstHumanity is ERC721, ERC721URIStorage, Ownable {
    ...
    function mintWhiteCard(string memory textOnCard)
        external
        returns (uint256)
    {
    ...
    function mintBlackCard(string memory textOnCard)
        external
        returns (uint256)
    {
