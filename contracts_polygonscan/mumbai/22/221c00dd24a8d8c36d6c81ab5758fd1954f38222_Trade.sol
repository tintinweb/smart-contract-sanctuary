...
contract Trade{
    ...
    */
    function depositToken(address _token, uint256 _amount) public payable{
        ...
        require(tokenLoaded.allowance(msg.sender, address(this)) >= _amount, "Check the token allowance");
    ...
    */
    ...
    function sellToken(address _token, uint _price, uint _amount) public{
        ...
        require(ethRequired >= _amount, "ethRequired must >= amount");
        require(ethRequired >= _price, "ethRequired must >= price");
        require(tokenBalance[msg.sender][_token] >= _amount, "tokenBalance[msg.sender][_token] must >= _amount");
