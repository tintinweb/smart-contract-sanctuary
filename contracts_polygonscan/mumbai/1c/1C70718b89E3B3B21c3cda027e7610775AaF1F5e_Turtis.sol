...
contract Turtis is ERC721, ChainlinkClient {
  ...
  constructor() public ERC721("TurtleCharacter", "TRTL") {
    ...
    oracle = 0x0bDDCD124709aCBf9BB3F824EbC61C87019888bb; // Address of the chainlink oracle
    jobId = "c6a006e4f4844754a6524445acde84a0"; // This Job gets data from an API in the form of a bytes32 variable
