...
contract mytoken is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_TOKENS_ID = 20;
    uint256 public MAX_TOKENS_MINT = 20;
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= MAX_TOKENS_MINT);
        require(supply + _mintAmount < MAX_TOKENS_ID);
    ...
    function setMAX_TOKENS_MINT(uint256 _newMAX_TOKENS_MINT) public onlyOwner {
        MAX_TOKENS_MINT = _newMAX_TOKENS_MINT;
    }
