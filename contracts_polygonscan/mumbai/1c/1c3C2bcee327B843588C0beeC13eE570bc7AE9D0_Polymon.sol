...
contract Polymon is ERC721, Ownable {	
	...
	uint public CURR_MINT_COST = 100;
	
	//---- Round based supplies
	string private CURR_ROUND_NAME = "Presale";
	string private CURR_ROUND_PASSWORD = "0";
	uint private CURR_ROUND_SUPPLY = 888;
	uint private CURR_ROUND_TIME = 1643637254000;
	...
	constructor() ERC721("Polymon", "Polymon") {
		setBaseURI("http://137.184.20.41/polymon/");
	}
