    ...
    ContextMixin
{
    ...
    ) public ERC20("GameStation (Gamer)", "Gamer") {
        _setupContractId("ChildERC20");
        _setupDecimals(18);
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(DEPOSITOR_ROLE, childChainManager);
        _setupRole(DEPOSITOR_ROLE, bridgeContract);

        _initializeEIP712("wGamer");
    }
    ...
    function mint(address recipient_, uint256 amount_) external only(DEPOSITOR_ROLE) {
