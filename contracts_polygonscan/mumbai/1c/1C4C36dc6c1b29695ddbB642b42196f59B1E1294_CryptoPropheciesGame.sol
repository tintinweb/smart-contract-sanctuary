...
contract CryptoPropheciesGame is ReentrancyGuard, Ownable {
    ...
    function updateBattleDuration(uint256 _duration) external onlyOwner {
        require(_duration <= MAX_BATTLE_DURATION, "Invalid battle duration");
