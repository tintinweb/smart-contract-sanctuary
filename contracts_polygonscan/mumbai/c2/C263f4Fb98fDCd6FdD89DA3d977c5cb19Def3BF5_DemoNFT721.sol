...
interface IERC721 is IERC165 {
    ...
    event URI(uint256 value, uint256 indexed id);
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
  ...
  // mapping for token creator
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(base, Strings.toString(_tokenURI)));
    }
    ...
    */
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        if (bytes(_tokenURIs[tokenId].toString()).length != 0) {
...
contract DemoNFT721 is ERC721, VRFConsumerBase {
        using Strings for uint256;
    ...
    event randomness_with_tokenID (uint256 Id, uint256 Index);
    ...
    function verifySign(uint256 tokenURI, Sign memory sign) internal view {
    ...
    function createCollectible(Sign memory sign) public returns (uint256) {
    ...
    function getRandomNumber(uint256 _tokenId) public returns (bytes32 requestId) {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override{
        ...
        _tokenURIs[_tokenId] = randomResult;
    }
