...
contract NPT_AnimetasGame1 is VRFConsumerBase, Pausable, Ownable {
    ...
    constructor(
        ...
        prizeFactory = new PrizeFactory("NPT X Animetas - Prizes", "NPTXAnimetasPrizes");
        prizeFactory.transferOwnership(owner());

        pieceFactory = new PieceFactory("NPT X Animetas - Pieces", "NPTXAnimetasPieces");
