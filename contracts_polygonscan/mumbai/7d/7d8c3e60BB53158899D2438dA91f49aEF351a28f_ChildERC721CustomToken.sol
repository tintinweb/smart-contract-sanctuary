...
// File: contracts/child/ChildERC721CustomToken.sol
 ...
 */
contract ChildERC721CustomToken is BaseRelayRecipient, Context, EIP712Base, AccessControlMixin, IERC721, ERC721Burnable, ERC721Pausable, IChildToken {
    ...
    function setTrustedForwarder(address forwarder) public {
        require(hasRole(MAINTAINER_ROLE, _msgSender()), "ERC721CustomToken: must have the maintainer role to update dependencies");
    ...
    function versionRecipient() override external virtual view returns (string memory) {
        return _versionRecipient;
    }
    
    string private _versionRecipient;

    int private maxSupply;
    ...
    function getMaxSupply() public view returns (int) {
        return maxSupply;
    }
    ...
    function mint(address to, uint256 tokenId) public {
        require(int(tokenId) < maxSupply || maxSupply < 0, "ERC721CustomToken: The token is at maximum supply");
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721CustomToken: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721CustomToken: must have pauser role to unpause");
        _unpause();
    }
