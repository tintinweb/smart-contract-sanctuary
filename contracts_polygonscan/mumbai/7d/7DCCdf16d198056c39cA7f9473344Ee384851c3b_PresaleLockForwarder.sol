...
contract PresaleLockForwarder is Ownable {
    ...
    constructor() {
        PRESALE_FACTORY = IPresaleFactory(0x9cafE0268154C2D151F57891ddBb79534299631f);
        CASHSWAP_LOCKER = ICashswapLocker(0xFD31D1E2a0b9Bd373FF08B28f5fa19EDEc67ebaf);
        CASHSWAP_FACTORY = ICashswapFactory(0xE3420DF87C128191B4c6e9d00F0bf1029f856ED2);
    }
    ...
    */
    ...
    function lockLiquidity (IERC20 _baseToken, IERC20 _saleToken, uint256 _baseAmount, uint256 _saleAmount, uint256 _unlock_date, address payable _withdrawer) external {
        ...
        CASHSWAP_LOCKER.lockLPToken(pair, totalLPTokensMinted, unlock_date, payable(address(0)), true, _withdrawer);
    }
