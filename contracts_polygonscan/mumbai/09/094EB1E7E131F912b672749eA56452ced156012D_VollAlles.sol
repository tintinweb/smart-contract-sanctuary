...
contract VollAlles is ERC20, ERC20Burnable, ERC20Snapshot, AccessControl, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    ...
    function burnerRole(address owner, uint amount) private onlyRole(BURNER_ROLE){
        _burn(owner, amount);
    }
