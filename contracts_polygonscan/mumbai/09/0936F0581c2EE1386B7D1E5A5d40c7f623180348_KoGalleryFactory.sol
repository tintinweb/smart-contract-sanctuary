...
contract KoGalleryFactory is NativeMetaTransaction, Ownable{

    address public chainProxyManager;

    // Proxy Testnet
    address public constant CHAIN_MANAGER_PROXY = 0xb5505a6d998549090530911180f38aC5130101c6;
    // Proxy Mainnet
    //address public constant CHAIN_MANAGER_PROXY = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa;
    ...
    function setChainProxyManager(address _chainProxyManager) external onlyOwner{
        chainProxyManager = _chainProxyManager;
    }
    ...
    function internalDeployERC721(string memory _token, string memory _trigram, address _userAddress) internal  returns (address){
        KoChildMintableERC721 galleryContract = new KoChildMintableERC721(_token, _trigram, CHAIN_MANAGER_PROXY);
