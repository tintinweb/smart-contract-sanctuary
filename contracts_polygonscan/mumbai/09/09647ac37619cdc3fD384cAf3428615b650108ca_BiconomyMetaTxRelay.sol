...
import "../lib/eip712/EIP712MetaTx.sol";
import "../lib/eip712/IEIP712MetaTx.sol";

contract BiconomyMetaTxRelay is Ownable, AccessControl, EIP712MetaTx("BiconomyMetaTxRelay","1"), BaseRelayRecipient {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    /// @notice The address of the GridZone token
    IERC20 public immutable zoneToken;
    ...
    constructor(address _ownerAddress, address _zoneToken, uint256 _gasPriceInZone, address _biconomyForwarder) Ownable(_ownerAddress) public {
