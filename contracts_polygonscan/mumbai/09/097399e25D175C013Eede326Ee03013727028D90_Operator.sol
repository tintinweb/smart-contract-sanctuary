...
contract Order {
    ...
    constructor(uint _orderType, string memory _itemName, uint _amount, string memory _contactMe) public payable {
        require(
            msg.value == _amount*2, 
...
contract Operator {
    ...
    function buyOrder(string memory itemName, uint amount, string memory contactMe) public payable {
        Order order = (new Order).value(msg.value)(1, itemName, amount, contactMe);
