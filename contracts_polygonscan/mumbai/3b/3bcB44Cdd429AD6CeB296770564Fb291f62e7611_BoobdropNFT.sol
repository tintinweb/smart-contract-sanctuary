...
contract BoobdropNFT is ERC721URIStorage, Ownable, AccessControl, IChildToken {
  ...
  /**
   * Allow admin to withdraw contract balance
   */
  function withdrawContractBalance() external onlyRole(DEFAULT_ADMIN_ROLE) {
  ...
  function mint(address user) public payable {
    ...
    require(msg.value >= 0.15 ether, "Not enough MATIC sent; mint price is 0.15 MATIC");
