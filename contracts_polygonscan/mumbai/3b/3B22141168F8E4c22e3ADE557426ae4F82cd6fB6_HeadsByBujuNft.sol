...
contract HeadsByBujuNft is ERC721Enumerable, Ownable, ReentrancyGuard{
...
function setCost(uint256 _newCost) public onlyOwner {
 ...
 function claimReserved(uint256 _number, address _receiver) external onlyOwner virtual {
  ...
  function withdraw() public payable onlyOwner {
    // This will pay specified address 5% of the initial sale.    
    // =============================================================================
    // (bool hs, ) = payable(0xd1a52E56af82E45c8346ef234CC5F091b008942c).call{value: address(this).balance * 5 / 100}("");
    // require(hs);
    // =============================================================================
   ...
   function DEVELOPER() public pure returns (string memory _url) {
        _url = "https://headsbybuju.com";
    }

    function DEVELOPER_ADDRESS() public pure returns (address payable _dev) {
        _dev = payable(0xd1a52E56af82E45c8346ef234CC5F091b008942c);
    }
}
