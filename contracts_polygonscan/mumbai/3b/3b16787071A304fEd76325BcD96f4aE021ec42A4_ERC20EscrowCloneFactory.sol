...
contract ERC20EscrowCloneFactory {
    ...
    constructor() public {
        proxyImplementation = address(new ERC20EscrowCounter());
    }

    function createERC20EscrowCounter() public {
        address cloned = ClonesUpgradeable.clone(proxyImplementation);
        ERC20EscrowCounter(cloned).initialize();
        emit CloneCreated(cloned, proxyImplementation);
    }
}
