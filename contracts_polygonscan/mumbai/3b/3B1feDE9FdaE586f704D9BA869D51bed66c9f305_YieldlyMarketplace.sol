...
contract YieldlyMarketplace is ReentrancyGuard, Ownable {
    ...
    function buy(uint _id, uint256 _price) external payable {
        ...
        transferMATICOrWMATIC(payable(creatorMap[_id]), _royaltyValue);
        transferMATICOrWMATIC(payable(adminRecoveryAddress), _commissionValue);
        Yieldly(nftContract).transferFrom(address(this), _newOwner, _id);
    ...
    function createAuction(
        ...
        require(startDate >= block.timestamp, "Can't create past auction!");
