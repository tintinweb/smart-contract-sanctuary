 ...
 **/
contract EDCoinICO is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 100; // Number of tokens per Ether
  uint256 public constant CAP = 1000; // Cap in Ether
  uint256 public constant START = 1645512848; // Mar 26, 2018 @ 12:00 EST
  uint256 public constant DAYS = 60; // 45 Day
   ...
   **/
  function EDCionICO(address _tokenAddr) public {
