...
contract Ballot is Ownable {
    ...
    function hasVoted(uint256 topicId, uint256 tokenId) public view returns(bool){
        return _votingHistory[topicId][tokenId];
    }
    
    function getVoteCount(uint256 topicId) public view returns(uint256){
        uint256[] memory voteCount = _votes[topicId];
