 ...
 */
abstract contract PermitTest0 is ERC20, IERC20Permit, EIP712 {
...
import "./interfaces/IPermitToken.sol";
import "./PermitTest0.sol";

contract PermitToken is IPermitToken, PermitTest0 {
  ...
  constructor() PermitTest0("KiBridge V1 Liquidity", "KiB-V1-LIQ") {
