...
abstract contract GAME_GameData is GAME_GameAdmin {
  ...
  event CollectibleDataUpdated(uint indexed set, uint indexed card, bool isForSale, uint fixedXp);
    ...
    operatorOrMinion(game_)
  {
    ...
    emit CollectibleDataUpdated(game_, cardId, isForSale_, fixedXp_);
  }
    ...
    operatorOrMinion(game_)
  {
    ...
    emit CollectibleDataUpdated(game_, card_, isForSale_, collectibleFixedXp[game_][card_]);
  }
