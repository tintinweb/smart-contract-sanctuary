...
contract Raindeers is ERC721Enumerable, Ownable {
    ...
    string public _contractBaseURI = "https://api.radreindeer.com/metadata/";
    ...
    constructor() ERC721("Rad Reindeers", "RADRN") {
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 devFee = _calcPercentage(totalBalance, 100); //1%
    ...
    function reclaimERC1155(IERC1155 erc1155Token, uint256 id)
        external
        onlyOwner
    {
