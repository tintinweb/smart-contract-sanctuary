...
contract ChatterNft is ERC721Enumerable, AccessControlMixin {
    using Strings for uint256;
  //  event Mint(address indexed sender, uint256 startWith, uint256 times);
    ...
    //bool _exist;
    //constructor args
    constructor(string memory name_, string memory symbol_, address childChainManager, 
    ...
    function setBaseURI(string memory _newURI) public only(DEFAULT_ADMIN_ROLE) {
        baseURI = _newURI;
    }
    ...
    function setStart(bool _start) public only(DEFAULT_ADMIN_ROLE) {
        started = _start;
    }
    ...
    function mint(uint256 tokenId, string memory tokenURI) public only(DEFAULT_ADMIN_ROLE){
        require(started, "not started");
        require(!withdrawnTokens[tokenId], "ChatterNFT: TOKEN_EXISTS_ON_ROOT_CHAIN");
    ...
    function withdrawWithMetadata(uint256 tokenId) external {
        ...
        require(_msgSender() == ownerOf(tokenId), "ChatterNFT: INVALID_TOKEN_OWNER");
        withdrawnTokens[tokenId] = true;
