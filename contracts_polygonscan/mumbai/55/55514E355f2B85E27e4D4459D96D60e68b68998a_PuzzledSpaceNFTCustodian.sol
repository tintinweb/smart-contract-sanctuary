    ...
    NFTTransfer 
{
    ...
    //user -> contractAddress -> token -> seq
    mapping(address => mapping(address => mapping(uint256 => uint256))) public UserTokenSeqMap;
    ...
    function withdrawal(
        ...
        require(
            UserTokenSeqMap[msg.sender][contractAddress][tokenId] == seq,
            "withdrawal: wrong seq"
        );
        require(
        ...
        UserTokenSeqMap[msg.sender][contractAddress][tokenId]++;
