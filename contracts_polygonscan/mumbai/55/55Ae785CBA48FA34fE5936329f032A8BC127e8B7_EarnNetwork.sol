...
contract EarnNetwork is ERC721 {
    ...
    function createCollectible(string memory _uri, address _recepient) public  returns (uint256) {
    ...
    function updateTokenUri(uint256 tokenId, string memory token_uri)
        ...
        require(ownerOf(tokenId) == msg.sender, "only token owner of token can change  uri");
