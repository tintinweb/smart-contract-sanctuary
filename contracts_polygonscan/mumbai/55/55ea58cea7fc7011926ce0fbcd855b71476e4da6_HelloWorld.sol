...
contract HelloWorld is Ownable, Initializable, ERC20Burnable {
    ...
    constructor(string memory name, string memory symbol, string memory initMessage) ERC20(name, symbol) {
        message = initMessage;
    }
    ...
    function updateOwner(string memory newOwnerMessage) external onlyOwner {
