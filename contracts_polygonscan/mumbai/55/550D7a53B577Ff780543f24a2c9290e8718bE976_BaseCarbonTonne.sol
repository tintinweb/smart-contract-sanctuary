    ...
    BaseCarbonTonneStorage
{
    ...
    function initialize(bool externalFilter) public initializer {
        __Context_init_unchained();
        __Ownable_init_unchained();
        __Pausable_init_unchained();
        __ERC20_init_unchained('Base Carbon Pool', 'BCT');
    ...
    /// @dev deposit function for BCT pool that accepts TCTs and mints BCT 1:1
