    ...
    IChildToken
{
    ...
    function __ChildERC20Gasless_init(
        ...
        __ChildERC20Gasless_init_unchained(childChainManager_);
    }

    // solhint-disable-next-line func-name-mixedcase, no-empty-blocks
    function __ChildERC20Gasless_init_unchained(address childChainManager_)
        internal
        initializer
    {
        _setupRole(DEPOSITOR_ROLE, childChainManager_);

        // Note: Disable minting of new tokens via mint().
        _finishMinting();
    }
    ...
    ERC165Upgradeable
{
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __ERC1363_init(string memory name_, string memory symbol_)
        internal
        initializer
    {
        __ERC20_init_unchained(name_, symbol_);
...
abstract contract ERC20MintableUpgradeable is Initializable, ERC20Upgradeable {
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __ERC20Mintable_init(string memory name_, string memory symbol_)
        internal
        initializer
    {
        __Context_init_unchained();
 ...
 */
contract PowerfulERC20Upgradeable is
    Initializable,
    ...
    RolesUpgradeable
{
    ...
    function __PowerfulERC20_init(
        ...
        __PowerfulERC20_init_unchained(initialBalance_);
    }

    // solhint-disable-next-line func-name-mixedcase, no-empty-blocks
    function __PowerfulERC20_init_unchained(uint256 initialBalance_)
        internal
        initializer
    {
     ...
     */
    function _finishMinting() internal virtual override onlyOwner {
 ...
 */
contract SafeTokenRecoverUpgradeable is Initializable, OwnableUpgradeable {
    ...
    UUPSUpgradeable
{
    function initialize(
        ...
        __PowerfulERC20_init_unchained(0);
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(PowerfulERC20Upgradeable, ERC20Upgradeable) {
        super._beforeTokenTransfer(from, to, amount);
    }
    ...
    function _finishMinting()
        internal
        virtual
        override(PowerfulERC20Upgradeable, ERC20MintableUpgradeable)
    // onlyOwner
    {
        super._finishMinting();
    }
    ...
    function _mint(address account, uint256 amount)
        internal
        virtual
        override(PowerfulERC20Upgradeable, ChildERC20GaslessUpgradeable)
    // onlyRole(DEPOSITOR_ROLE)
    {
    ...
    function _msgSender()
        ...
        view
        virtual
        override(ContextUpgradeable, ChildERC20GaslessUpgradeable)
        returns (address sender)
    {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(PowerfulERC20Upgradeable, AccessControlUpgradeable)
        returns (bool)
    {
        return super.supportsInterface(interfaceId);
    }
