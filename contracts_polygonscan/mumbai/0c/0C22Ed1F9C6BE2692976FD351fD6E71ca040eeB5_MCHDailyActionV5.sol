...
// File contracts2/roles/AccessOperatable.sol
...
// File contracts2/MCHDailyActionV5.sol

pragma solidity 0.8.3;


contract MCHDailyActionV5 is AccessOperatable {
    ...
    function setValidater(address _varidator) public onlyRole(OPERATOR) {
    ...
    function action(
        ...
        require(isApplicable(msg.sender, _time), "already transacted");
        require(
            validateSig(msg.sender, _time, _support, _signature),
            "invalid signature"
        );
        int64 day = _time / 86400;
    ...
    function validateSig(
        ...
        address signer =
            recover(
                ethSignedMessageHash(encodeData(_from, _time, _support)),
                _signature
            );
    ...
    function encodeData(
        ...
        return keccak256(abi.encode(_from, _time, _support));
    }
    ...
    function recover(bytes32 _data, bytes memory _signature)
        public
        pure
        returns (address)
    {
