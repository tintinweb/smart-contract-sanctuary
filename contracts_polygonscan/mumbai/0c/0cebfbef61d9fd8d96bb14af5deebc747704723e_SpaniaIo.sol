...
contract SpaniaIo is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() public ERC721("SpaniaIo", "NFT") {}
    ...
    function batchMintNFT(address recipient, string memory tokenURI,uint256 amount,uint256 startIdx)
        public onlyOwner
        returns (uint256)
    {
