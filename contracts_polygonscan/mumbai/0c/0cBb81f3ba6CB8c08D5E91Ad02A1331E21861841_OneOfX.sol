...
contract OneOfX is IERC721Metadata, IERC721Enumerable, EIP712 {
    ...
    string private constant ERR_BAD_SIG = "e3";
    ...
    function createProject(uint256 id, uint256 maxInvocations) public payable {
        require(
        ...
        payable
    {
        ...
        require(
            redeemer != address(0) &&
                ...
                projects[voucher.projectId].maxInvocations &&
