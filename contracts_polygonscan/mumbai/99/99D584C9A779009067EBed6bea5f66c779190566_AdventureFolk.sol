...
//https://mumbai.polygonscan.com/address/0xbef49a25e4aed94d04a6ffa631f158c05a376b85
...
contract AdventureFolk is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Adventure Folk:', toString(tokenId), '", "description": "Adventure Folk are the random people you might meet on an adventure. Use them any way you like.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
...
//    }
    ...
    function mint(uint256 num) public payable {
        ...
        require( num < 11,                     "You can mint a maximum of 10 Folk" );
        require( supply + num < 10001,         "Exceeds maximum supply" );
        require( msg.value >= 1.0 ether * num, "Money sent is not correct" );
    ...
    constructor() ERC721("Adventure Folk", "ADVENTUREFOLK") Ownable() {}
}
