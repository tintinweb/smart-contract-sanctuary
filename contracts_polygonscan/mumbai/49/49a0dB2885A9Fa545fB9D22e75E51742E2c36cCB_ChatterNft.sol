...
contract ChatterNft is ERC721Enumerable, Ownable {
    using Strings for uint256;
  //  event Mint(address indexed sender, uint256 startWith, uint256 times);
    ...
    //constructor args
    constructor(string memory name_, string memory symbol_,  
        uint256 _royaltyFee) ERC721(name_, symbol_) {
    ...
    bool _exist = false;
    function tokenIdExists(uint256 tokenId) public view returns (bool _exist) {
