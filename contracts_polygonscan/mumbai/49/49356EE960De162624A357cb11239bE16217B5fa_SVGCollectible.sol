...
contract SVGCollectible is ERC721URIStorage, Ownable {
    ...
    event requestedSVG_NFT(uint256 indexed tokenId);
    mapping(uint256 => address) public tokenIdToOwner;
    string[] public paths;

    constructor() ERC721("SVG_NFT", "F") {
        tokenCounter = 0;
        maxTokens = 16;
    }
    ...
    function finishMint(uint256 tokenId) public {
        ...
        emit CreatedSVG_NFT(tokenId, svg);
    }
        ...
        returns (string memory finalSvg)
    {
        ...
        finalSvg = string(
            abi.encodePacked(
                finalSvg,
                '<path fill="#3b5998" d="m0,0 v400 h400 v-400 " /><path fill="#fff" d="m59,154,-12,-0.1 c-15,-0.1,-21,7.2,-21,20 v9.4 h-9.6 v15 h9.6 v46 h19 " /></svg>'
            )
        );
