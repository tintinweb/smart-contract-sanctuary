...
contract Stake {
    ...
    uint256 private time = 5 minutes;
...
contract stakingFactory is Ownable{
    ...
    function createStack( address _depositTokens,address _rewardToken,uint256 _rewardRate,uint256 _rewardInterval, address _operator) public onlyOwner returns(address){
        Stake stake =  new Stake( _depositTokens, _rewardToken, _rewardRate, _rewardInterval, _operator);
