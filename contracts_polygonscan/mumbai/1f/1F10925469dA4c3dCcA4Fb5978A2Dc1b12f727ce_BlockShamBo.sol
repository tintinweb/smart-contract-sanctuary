...
contract BlockShamBo is ERC721Enumerable, Ownable, ReentrancyGuard{
    uint256 public mintPrice = 1000000000000000000; //1 MATIC
    ...
    constructor (string memory baseUri) public ERC721("BlockShamBo", "BSB"){
        BaseURI = baseUri;
    }
