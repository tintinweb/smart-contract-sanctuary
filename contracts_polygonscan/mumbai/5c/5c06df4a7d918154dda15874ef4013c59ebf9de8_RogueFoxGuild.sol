...
// File: contracts/RogueFoxGuild.sol
...
contract RogueFoxGuild is ERC721Enumerable, Ownable, ContextMixin {
    ...
    bool public paused = true; // Nobody can mint while paused
    bool public minting = false; // Only whitelisted addresses can mint when minting is false
    string public baseTokenURI;
    address[] public whitelist; // Only whitelisted addresses can mint when minting is false

    constructor(string memory baseURI) ERC721("Rogue FGTest", "RFGT") {
        setBaseURI(baseURI);
    }
    ...
    function mintForOwner(uint256 _mintAmount) public onlyOwner {
        ...
        require(
            totalMinted.add(_mintAmount) < max_supply,
