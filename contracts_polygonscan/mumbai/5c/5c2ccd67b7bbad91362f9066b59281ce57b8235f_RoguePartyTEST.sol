...
// File: contracts/RoguePartyTEST.sol
...
contract RoguePartyTEST is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant MAX_ITEMS = 250;
    uint256 public constant MAX_PRESALE_ITEMS = 30;
    uint256 public constant PRICE = 0.0001 ether; // 150 MATIC
    ...
    constructor(string memory baseURI) ERC721("RogueTEST", "ROGUETEST") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
