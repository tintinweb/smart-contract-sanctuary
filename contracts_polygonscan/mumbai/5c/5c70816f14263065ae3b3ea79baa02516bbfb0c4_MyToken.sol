...
contract MyToken is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    uint256 public constant FT = 0;
    uint256 public constant RYAN = 10;
    uint256 public constant BRANDON = 1337;

    constructor() ERC1155("https://ipfs.io/ipfs/QmctMDM9yG86sjcEbQrxHja1iTSPa764kGk1YheftbhX8V/{id}.json") {
        _mint(msg.sender, FT, 10**18, "");
        _mint(msg.sender, BRANDON, 1, "");
    }
