...
contract MZKZ_ASCENSION_BASE is ERC1155Supply, Ownable, BaseOpenSea {
    ...
    function mintTo(address recipient, uint256 tokenId, uint256 amount, bytes calldata data) external onlyMinter {
        _mint(recipient, tokenId, amount, data);
    }

    function mintBatchTo(address recipient, uint256[] calldata tokenIds, uint256[] calldata amounts, bytes calldata data) external onlyMinter {
