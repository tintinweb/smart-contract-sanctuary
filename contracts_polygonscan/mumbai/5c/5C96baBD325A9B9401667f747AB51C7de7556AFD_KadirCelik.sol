...
// File: KadirCelik.sol
    ...
    contract KadirCelik is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 10000000000000; // 0.1 ETH 
      ...
      event KadirCelikMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("KadirCelik", "KC") {}
      ...
      function mintKadirCelik(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit KadirCelikMinted(id, msg.sender);
          }
        }
      }
    
      function presaleKadirCelik(uint256 numberOfTokens) external payable {
