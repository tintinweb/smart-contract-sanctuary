...
contract StakeHolder is Initializable, IERC721ReceiverUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function _claimSingleFromHolder(uint256 tokenId) internal returns (uint256 owed) {
        ...
        require(!(block.timestamp - stake.value < MINIMUM_TO_EXIT), "NOT STAKED LONG ENOUGH TO RETURN TO OWNERS WALLET");
    ...
    // In seconds
    function setMinimumToExit(uint256 newMinimum) external onlyOwner {
        MINIMUM_TO_EXIT = newMinimum;
    }
