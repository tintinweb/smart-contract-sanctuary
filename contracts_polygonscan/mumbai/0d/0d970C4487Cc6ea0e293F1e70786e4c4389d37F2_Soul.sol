...
contract Soul is ERC721Enumerable, Mintable, Pausable {
    ...
    event AddressesSet(address rays, address durabilityReducer);
    ...
    function restoreDurability(uint256 tokenId) external {
        ...
        rays.burnFrom(msg.sender, raysAmount);
    ...
    function setAddresses(address _rays, address _durabilityReducer) external onlyOwner {
        rays = IERC20Burnable(_rays);
        durabilityReducer = _durabilityReducer;

        emit AddressesSet(_rays, _durabilityReducer);
    }
