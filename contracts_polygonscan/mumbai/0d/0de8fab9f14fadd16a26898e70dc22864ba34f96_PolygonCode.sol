...
// File: browser/polygon/contracts_common/utils/Context.sol
...
// File: browser/polygon/contracts_common/Assess/Ownable.sol
...
contract Code is ERC20ExecuteExtension, ERC20BasicApproveExtension, ERC20BaseToken {
    ...
    constructor(address codeAdmin, address executionAdmin, address beneficiary, uint256 amount) public {
        _admin = codeAdmin;
...
// File: browser/polygon/Code/PolygonCode.sol

pragma solidity 0.8.2;



contract PolygonCode is Code,Ownable {
    ...
    ) Code(codeAdmin, executionAdmin, address(0), 0) {
