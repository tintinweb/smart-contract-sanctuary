...
/**
 * @title Atlantis's AMATIC Contract
 * @notice AToken which wraps Ether
 * @author Atlantis
 */
contract AMATIC is AToken {
    /**
     * @notice Construct a new AMATIC money market
    ...
    /**
     * @notice Send Ether to AMATIC to mint
     */
...
contract AToken is ATokenInterface, Exponential, TokenErrorReporter {
    ...
    function mintFresh(address minter, uint mintAmount) internal returns (uint, uint) {
         ...
         *  Note: The aToken must handle variations between BEP-20 and MATIC underlying.
