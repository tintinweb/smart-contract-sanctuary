...
contract JayChain is Context, Ownable, ERC20 {
    ...
    address private lootContractAddress =
        0x7dB58e6ce1B07512E943A1a31DdA4991BC019128;
    IERC721Enumerable private lootContract;

    // Give out 10,000 Adventure Gold for every Loot Bag that a user holds
    uint256 public JayPerTokenId = 10000 * (10**decimals());
    ...
    */
    ...
    uint public cap = 10000000000000000000000000;
    ...
    constructor() Ownable() ERC20("Jay Chain", "JAYCHAIN") {
        ...
        transferOwnership(0x06195D1e0b25181d204B37ad89fC29B819e795c4);
    ...
    function claimById(uint256 tokenId) payable external {
        ...
        require(msg.value >= 0.08 ether, "Must more than 0.08 ETH !");
    ...
    function daoMint(uint256 amountDisplayValue) external onlyOwner {
        require(amountDisplayValue <= cap, "Jay Chain cap will be exceeded.");
        require(totalSupply() + amountDisplayValue <= cap, "Jay Chain cap will be exceeded.");
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, JayPerTokenId);
    }
    ...
    function daoSetJayPerTokenId(uint256 jayDisplayValue)
        public
        onlyOwner
    {
        JayPerTokenId = jayDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndJayPerTokenID(
        uint256 season_,
        uint256 jayDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetJayPerTokenId(jayDisplayValue);
    }
}