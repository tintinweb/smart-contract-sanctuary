...
abstract contract BlackList is Ownable, BasicToken {
    ...
    /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded Jhinga) ///////
...
contract JhingaToken is Pausable, StandardToken, BlackList {
