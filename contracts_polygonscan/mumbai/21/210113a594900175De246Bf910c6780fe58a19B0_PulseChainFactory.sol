...
contract PulseChainPair is PulseChainERC20 {
    ...
    uint256 public nDev = 4;
    uint256 public dDev = 4;
    uint32 public swapFee = 29; // uses 0.21% default
    uint32 public devFee = 25; // uses 0.04% default from swap fee
    ...
    function mint(address to) external lock returns (uint256 liquidity,uint amount0,uint amount1) {
