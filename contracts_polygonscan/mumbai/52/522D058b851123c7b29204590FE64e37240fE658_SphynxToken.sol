...
contract SphynxToken is BEP20, Manageable {
	...
	address payable public marketingWallet = payable(0xB4dDc9b0aa117554af9F6204D09be793C980db5c);
	address payable public developmentWallet = payable(0xC58903eF87b8bdEb6fF27B80595d0EDD2F68afe6);
	...
	constructor() public BEP20('Sphynx Token', 'SPHYNX') {
		...
		ISphynxRouter02 _sphynxSwapRouter = ISphynxRouter02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // mainnet
