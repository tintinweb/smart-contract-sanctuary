...
contract LotteryContract is VRFConsumerBase, ReentrancyGuard, Ownable {
    ...
    function getWinningAmount() public view returns (uint256) {
        uint256 expectedTotalLotteryPool = lotteryConfig.playersLimit.mul(lotteryConfig.registrationAmount) ;
        uint256 adminFees = (
            (expectedTotalLotteryPool.mul(lotteryConfig.adminFeePercentage)).div(100)
        );
