...
library EurekaV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'ba4c13e6628fd4cd0972511870d83bd4b22cfbdf1bfd606ceeb5ad261ea2e8b4' // init code hash
            ))));
    }
...
contract EurekaV2Router02 is IEurekaV2Router02 {
   ...
   function takeAddLiquidityFee(address _token0, address _token1, uint256 _amount0, uint256 _amount1, bool isEth) internal returns(uint256, uint256){
        ...
        IFarm(farm[0]).addReward(address(this), _token0, _token1, farmFee0[0], farmFee1[0]);
        IFarm(farm[1]).addReward(address(this), _token0, _token1, farmFee0[1], farmFee1[1]);
        IFarm(farm[2]).addReward(address(this), _token0, _token1, farmFee0[2], farmFee1[2]);
