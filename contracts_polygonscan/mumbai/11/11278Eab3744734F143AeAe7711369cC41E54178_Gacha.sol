 ...
 */
interface IMelXNFT {
    function safeMintWithSignature(address to, string calldata cid, bytes calldata data) external returns (uint256 nftTokenId);
}
...
contract MelXNFTV1 is IMelXNFT, MelXNFTPayment, MelXNFTBasic {
    ...
    bytes32 public constant OFF_CHAIN_MINTER_ROLE = keccak256("OFF_CHAIN_MINTER");        
    ...
    * @param to is the accounts that request Minting Signature Data to API , and need to approve fee to this contract
     */
    function safeMintWithSignature(address to, string calldata cid, bytes calldata data) public override onlyRole(OFF_CHAIN_MINTER_ROLE) returns (uint256 nftTokenId) {
