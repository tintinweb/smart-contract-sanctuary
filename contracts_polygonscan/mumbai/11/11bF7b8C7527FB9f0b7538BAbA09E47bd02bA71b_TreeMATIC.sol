...
contract TreeMATIC is ERC721Upgradeable, IChildToken {
    ...
    modifier onlyDepositor() {
        accessRestriction.ifDepositor(msg.sender);
        _;
    }
    ...
    function safeMint(address _to, uint256 _tokenId) external onlyAdmin {
