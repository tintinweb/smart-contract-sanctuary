...
// File: contracts/DigiSimpleStake.sol
...
contract DigiSimpleStake is Ownable, ReentrancyGuard {
    ...
    */
    function distribute() public returns (bool) {
        ...
        uint256 currentBalance = IERC20(rewardToken).balanceOf(address(this)).sub(tokenTotalStaked);
    ...
    */
    function withdraw() external payable nonReentrant returns (bool){
        ...
        uint256 fee = 1000000000000000; // 0.001
        require(msg.value == fee, "You need to send 0.001");
