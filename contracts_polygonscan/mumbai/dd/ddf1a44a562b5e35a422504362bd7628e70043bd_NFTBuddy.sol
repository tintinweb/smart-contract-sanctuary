...
contract NFTBuddy is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant MAX_ITEMS = 306;
    uint256 public constant MAX_PRESALE_ITEMS = 30;
    uint256 public constant MAX_RESERVE = 6;
    uint256 public constant PRICE = 0.001 ether; // 0.001 MATIC
    uint256 public constant MAX_MINT = 25;
    uint256 public constant MAX_MINT_PRESALE = 2;
    address public constant creatorAddress = 0x194E52cF58AaC7A24E05213dEdAE2f7c0d4E0727;
    string public baseTokenURI;

    constructor(string memory baseURI) ERC721("NFTBuddy02", "NFTBDY02") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
