...
contract Fakhama is IERC20
{
    ...
    function getUserInfo(uint memberId) public view 
        returns(User memory UserInfo, string memory CurrentRankName, 
                string memory NextRankName, uint RequiredBusinessForNextRank, uint CoinRate)
    {
        ...
        return (_userInfo, _currentRankName, _nextRankName, _requiredBusinessForNextRank, _coinRate);
    }
}