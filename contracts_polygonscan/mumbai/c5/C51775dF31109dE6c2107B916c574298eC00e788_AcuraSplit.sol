...
contract AcuraSplit is AcuraSplitBaseWrap, AcuraSplitWeth {
    ...
    function _swapOnCurveAave(
        ...
        fromToken.universalApprove(address(curveAave), amount);
        curveAave.exchange_underlying(i - 1, j - 1, amount, 0);
    }

    function _swapOnCurveAtriCrypto(
        IERC20 fromToken,
        IERC20 destToken,
        uint256 amount,
        uint256 /*flags*/
        ...
        fromToken.universalApprove(address(curveAtriCrypto), amount);
        curveAtriCrypto.exchange_underlying(i - 1, j - 1, amount, 0);
    }
