...
contract Collection is ERC1155, AccessControl {
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amount_) external onlyRole(DEFAULT_ADMIN_ROLE) {
...
contract FarmV2 is AccessControl{
    ...
    function setTokenAddress(ERC20 token_) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _token = token_;
    }
