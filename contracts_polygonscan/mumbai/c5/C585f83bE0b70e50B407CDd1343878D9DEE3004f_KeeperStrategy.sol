...
contract KeeperStrategy is BaseStrategy {
    ...
    function initialize(
        ...
        super.initialize(_want, _clustersLock, address(0), _adapter);
    }
    ...
    /// @notice Returns token to withdraw.
    ...
    function mockAddRewards(uint256 _amount) external {
    ...
    function rewardsInEth() external view override returns (uint256) {
        return _rewardsInEth(want.balanceOf(address(this)));
    }
