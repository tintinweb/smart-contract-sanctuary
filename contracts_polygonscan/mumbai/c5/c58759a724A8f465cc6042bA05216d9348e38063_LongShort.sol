...
contract LongShort is ILongShort, AccessControlledAndUpgradeable {
  ...
  function isAdmin(address someAddress) external virtual {
    _checkRole(ADMIN_ROLE, someAddress);
  }

  function isDefaultAdmin(address someAddress) external virtual {
    _checkRole(DEFAULT_ADMIN_ROLE, someAddress);
  }
