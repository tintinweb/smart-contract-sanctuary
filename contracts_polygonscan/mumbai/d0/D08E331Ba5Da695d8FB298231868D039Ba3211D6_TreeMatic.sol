...
contract TreeMatic is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  function plant() public {
    bool worked = ERC20(wEthAddress).transferFrom(
      msg.sender,
      address(this),
      price
    );
    require(worked == true, 'wETH token transfer failed');

    treeCount += 1;
    _safeMint(msg.sender, treeCount);
  }

  function gift(address friend) public {
  ...
  function withdrawToken(address addr, uint256 tokens) public onlyOwner {
    ERC20(addr).transfer(msg.sender, tokens);
  }
  ...
  string[][] colors = [
    ['f90d98', 'd20cde', 'af18f5', '620bde', '2c0cfa'],
    ['d92b6b', '410759', '248c82', 'f29e38', 'f25c04'],
    ['d91a96', '05a578', 'b5d931', 'f28606', 'd93814'],
    ['073359', '03658c', '0096a6', 'f26e22', 'f2a86e'],
    ['00968d', 'a5d5d8', 'eda738', 'e24f6d', 'f2a291'],
    ['1493e7', '15ace1', '78d91a', 'c0f551', '40eefc'],
    ['130868', 'ea3765', 'f6d6ed', '9ed5fb', '4174f6'],
    ['f5bf45', 'e9602c', 'ea346f', '7844e3', '4a87f6']
  ];
    ...
    returns (string memory)
  {
    ...
    output = string(
      abi.encodePacked(
        "<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='1000' height='1000'><rect width='1000' height='1000' style='fill:black'></rect><defs><g id='stem'></g><g id='bubbles'><circle cx='0' cy='-0.5' r='0.1'></circle><circle cx='0' cy='0' r='0.1'></circle></g>",
        output,
