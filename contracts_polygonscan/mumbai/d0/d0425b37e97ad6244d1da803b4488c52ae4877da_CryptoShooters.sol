...
contract Characters is Initializable, ERC721Upgradeable, AccessControlUpgradeable, ITransferCooldownable, ICharacter {
    ...
    /*
        ...
        class: 0-4 [0(Sentry) 1(Spy) 2(Commando) 3(Hunter) 4(Vanguard)]
    */
    ...
    function mint(address minter, uint256 seed, CharacterType ctype, uint256 eliteId) public restricted {
        ...
        uint8 class = uint8(RandomUtil.randomSeededMinMax(0,1,seed));
        uint8 element = uint8(RandomUtil.randomSeededMinMax(0,3,seed));
        ...
        tokens.push(Character(ctype, xp, accuracy, level, element, class, pp, eliteId, holographicRoll == 11 ));
...
// File: contracts/interfaces/ICipherCore.sol
// SPDX-License-Identifier: MIT
...
// File: contracts/cryptoshooter.sol
contract CryptoShooters is Initializable, AccessControlUpgradeable, ICharacter {
    ...
    function getTokenGainForFight(uint24 monsterPower) internal view returns (uint256) {
        ...
        int128 half = ABDKMath64x64.div(one, 2);
