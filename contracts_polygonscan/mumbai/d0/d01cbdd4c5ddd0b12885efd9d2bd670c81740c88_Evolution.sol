...
contract Evolution is Initializable, ERC721HolderUpgradeable, AccessControlUpgradeable, PausableUpgradeable  {
    ...
    function initialize(address _EOC, address _RACE, address _TRACE) public initializer {
        ...
        newLevelDiff = 100000;
        levelOnePrice = 18000000;
        levelTwoPrice = 30000000;
    ...
    function setDaysForWithdraw(uint _daysForWithdraw) public validate {
        daysForWithdraw = _daysForWithdraw * 1 days;
    }
    ...
    function deposit(uint256 _tokenId) public {
        ...
        uint _levelPrice;
        if (_tokenId < newLevelDiff) {
            _levelPrice = levelOnePrice;
        } else {
            _levelPrice = levelTwoPrice;
        }
        require(EOC.balanceOf(msg.sender) >= _levelPrice, "Insufficient funds");
    ...
    function withdraw(uint256 _tokenId) public {
        ...
        require(block.timestamp >= deposits[_tokenId].timestamp + daysForWithdraw, "Tracer can not be withdrawn currently");
