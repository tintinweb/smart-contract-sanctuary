...
contract Look is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>@import url("https://fonts.googleapis.com/css?family=Inknut+Antiqua:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic"); .base { fill: white; font-family: Inknut Antiqua; font-size: 9px; }</style><rect width="100%" height="100%" fill="#';

        parts[1] = getBackgroundColour(tokenId);

        parts[2] = '" /><text x="230" y="20" class="base"> LookBook #';
...
//    function addSuffixCategory(uint256 suffixCategory, string[] memory values) external onlyOwner {
//        indexToSuffixCategory[suffixCategory] = values;
//    }
