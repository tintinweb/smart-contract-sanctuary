...
contract Metaverse is Context, Ownable, ERC20 {
    ...
    */
    ...
    constructor() Ownable() ERC20("Metaverse", "METAVERSE") {
    ...
    function claimById(uint256 tokenId) payable external {
        ...
        require(msg.value >= 0.02 ether, "Must more than 1 polygon !");
        require(
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, MetaversePerTokenId);
    }
    ...
    function daoSetMetaversePerTokenId(uint256 metaverseDisplayValue)
        public
        onlyOwner
    {
        MetaversePerTokenId = metaverseDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndMetaversePerTokenID(
        uint256 season_,
        uint256 metaverseDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetMetaversePerTokenId(metaverseDisplayValue);
    }
}