...
contract RawCipherToken {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 1000000e18; // 1M
	uint256 constant private STAKE_FEE = 2; // 2% per tx
	uint256 constant private MIN_STAKE_AMOUNT = 1e18; // 1

	string constant public name = "RawCiper Token";
	string constant public symbol = "RCT";
