...
contract NFTSellingERC1155 is ERC1155Holder {
    ...
    function onERC1155Received(
        ...
        nftsForSale[saleID] = nftInfo(true, false, false, false, id, 0, from, 0);
    ...
    function updatePrice(uint256 saleId, uint256 price)
        external
        onlySaleOwner(saleId) saleExists(saleId) saleIsNotCompleted(saleId) saleIsNotCanceled(saleId)
    {
