...
contract FundamentaWrappedToken is SecureContract, ERC20
{
    ...
    constructor(address backingTokenContract, string memory name, string memory ticker, 
        uint8 tokenDecimals, uint heldAmtReq, address fmtaAddress) ERC20(name, ticker)
    {
    ...
    function setHeldAmountReq (uint newAmt) public isAdmin
    {
        heldAmtReq_ = newAmt;
    }
    ...
    function queryHeldAmountRequired() public view returns (uint256)
    {
        return heldAmtReq_;
    }
