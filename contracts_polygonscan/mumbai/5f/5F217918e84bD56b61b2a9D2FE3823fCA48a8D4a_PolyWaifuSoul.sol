...
contract PolyWaifuSoul is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    address private _router; //pancake router
    ...
    function initialize() initializer public {
        __ERC20_init("PolyWaifuSoul", "PWS");
        __Pausable_init();
        __Ownable_init();
    ...
    function getAddressesData() external view returns(
        ...
        return (_feeReceiveAddress, _pancakeLPAddress);
    }
    ...
    function transferFrom(
     ...
     function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        if (isAddressLP(_msgSender()) || isAddressLP(recipient)) {
            // BUY
            uint256 _fee = 0;
            if (recipient != _lpCreatorAddress && recipient != _router) {
    ...
    function getAntibotData() external view returns(address lpCreator) {
        return _lpCreatorAddress;
    }
