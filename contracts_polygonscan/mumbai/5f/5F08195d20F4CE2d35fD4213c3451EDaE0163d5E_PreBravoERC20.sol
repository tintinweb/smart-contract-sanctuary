...
contract PreBravoERC20 is Divine {
  ...
  constructor() Divine( "Pre-Bravo", "pBRAVO", 18 ) {
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer pBRAVO." );
  }
