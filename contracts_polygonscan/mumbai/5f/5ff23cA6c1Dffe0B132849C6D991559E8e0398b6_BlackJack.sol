    ...
    // IGame
{
    ...
    function createRoom(
        ...
        if (game.waitingPlayerCount >0){
            require(game.maxPlayer < _maxPlayer,"288");
            for (uint8 pIndex; pIndex < prevGameRecord.maxPlayer * 2; pIndex++) {
                if (prevGameRecord.playerState[pIndex] == PlayerState.WaitingPlayer) {
                    ...
                    game.players[pIndex] = prevGameRecord.players[pIndex];
                    game.bets[pIndex] = prevGameRecord.bets[pIndex];
                    game.playerState[pIndex] = PlayerState.NotBusted;
                    //waitingPlayerCount +=1;
                    emit JoinGame(
                        game.gId, //gameId is the next game. this is still wrong , will change later
                        _rId,//same roomId
                        game.players[pIndex],
                        pIndex,
                        game.bets[pIndex],
        ...
        delete game.waitingPlayerCount;
