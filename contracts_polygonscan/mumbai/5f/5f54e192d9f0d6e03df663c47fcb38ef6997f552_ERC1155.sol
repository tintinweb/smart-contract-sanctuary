    ...
    Pausable
{
     ...
     */
    function _beforeMint(uint256 _id, uint256 _amount) internal virtual {}
    ...
    function mint(
        ...
        require(_amount + totalSupply(_id) < supplyCap);
    ...
    function batchMint(
        ...
        {
            require(_amounts[i] + totalSupply(_ids[i]) < supplyCap);
        }
    ...
    function _burn(
        ...
        require(account != address(0), "ERC1155 Burn: Cannot Burn from Zero Address");
        require(amount > 0, "ERC1155 Burn: Must burn at least 1 token");
 ...
 */
contract AssetContractShared is AssetContract {
