...
contract EntropyManager is VRFConsumerBase, AccessControl {
  ...
  event EntropyReceived(address indexed targetAddress, uint256 indexed tokenId, uint256 indexed index);
  ...
  */
  function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
    ...
    emit EntropyReceived(request.targetAddress, request.tokenId, request.index);
  }
