    ...
    ContextMixin
{
    ...
    constructor(
        ...
        _setupRole(GAME_ROLE,gameManager);
     ...
     */
    function mintToken(address user, uint256 amount) public only(GAME_ROLE) {
        _mint(user, amount);
    }
     function burnToken(address user, uint256 amount) public only(GAME_ROLE) {
        _burn(user, amount);
    }
}