...
contract blockfaces is ERC721, Ownable {
    ...
    IERC20 weth = IERC20(WETHContractAddress);
    ...
    function adopt(uint256 numfaces) public {
        uint256 supply = totalSupply();
        require(hasSaleStarted,                         "sale is paused");
        require(numfaces < 21,                          "only up to 20 blockfaces at once");
        require(supply + numfaces < 5001,               "exceeds max faces");
        
        // Computes the price 
        uint256 totalPrice = _price * numfaces; 
