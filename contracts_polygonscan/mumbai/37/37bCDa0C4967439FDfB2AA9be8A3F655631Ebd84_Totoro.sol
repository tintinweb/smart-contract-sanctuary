...
contract Totoro is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Totoro", "TOTO") {
    setHiddenMetadataUri("ipfs://QmahVJt6vwB3Y4Zq63EwBWfW5A4F8uSc2RU18ydiZfXYuW/hidden.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(ownerTokenCount < nftPerAddressLimit, "Address has minted NFT limit");
