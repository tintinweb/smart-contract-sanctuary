...
contract LiquidityManager is IERC721Receiver {
    ...
    **/
    ...
    // PoolHolder[] private _poolHolders;
    ...
    function acceptETHAndCreatePool() public payable returns (bool) {
        
        // Wrap ETH sent by user to WETH 
        IWETH9(WETH9).deposit{value: msg.value}();
        
        // Approve WETH 
        TransferHelper.safeApprove(WETH9, address(_nonfungiblePositionManager), msg.value);
        TransferHelper.safeApprove(TOKEN, address(_nonfungiblePositionManager), msg.value);
        ...
        //     TransferHelper.safeTransfer(WETH9, msg.sender, refund0);
        // }
