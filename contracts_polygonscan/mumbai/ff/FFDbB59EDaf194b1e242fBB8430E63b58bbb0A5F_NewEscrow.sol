...
contract NewEscrow is ERC165 {
    ...
    function cancelSaleOrder(uint256 _orderNonce, uint256 _editionNumber)
        ...
        returns (bool)
    {
        //Cancels second hand sales order - placeholder
        return true;
    }
    ...
    function placeSecondHandOrder(
        ...
        //Secondary market code goes here
        return true;
    }
    ...
    function claimBack(uint256 _orderNonce, uint256 _editionNumber)
        ...
        returns (bool)
    {
        //To claim the not accepted auction offer after certain time
        return true;
    }
