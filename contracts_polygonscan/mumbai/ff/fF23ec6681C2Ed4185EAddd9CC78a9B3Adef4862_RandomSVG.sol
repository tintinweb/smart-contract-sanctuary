...
library SVGShapes {
    ...
    function generateShape(uint256 _randomNumber) internal pure returns(string memory pathSvg) {
        ...
        if (_randomNumber % 2 == 0) {
            ...
            pathSvg = string(abi.encodePacked(pathSvg, "<circle cx='", string(Strings.toString(circleVars[0] % 500)), "' cy='", string(Strings.toString(circleVars[1] % 500)), "' r='", string(Strings.toString(circleVars[2] % 250)), "' stroke=rgb(", string(Strings.toString(circleVars[3] % 255)),",", string(Strings.toString(circleVars[4] % 255)),",", string(Strings.toString(circleVars[5] % 255)), ") stroke-width='", string(Strings.toString(circleVars[6] % 100)), " />"));
            } else {
            //draw a square
