...
// NikiToken with Governance.
contract NikiToken is BEP20 ('Niki Token', 'NIKI'), MinterRole {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying NIKIs (not scaled);
