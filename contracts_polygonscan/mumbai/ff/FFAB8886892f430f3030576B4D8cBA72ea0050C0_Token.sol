...
contract Token is TokenERC20, Control, ReentrancyGuard {
	 ...
	 * @param amountTokenMin min Token amount going to user
	...
	/**
	 * @notice Remove liquidity
	 * @dev Public function for removing liquidity from TKN-<TOKEN> pair without 6% fee
	 * @param token1 another token address
	 * @param liquidity LP-token amount
	 * @param amount0Min min Token amount going to user
	 * @param amount1Min min <TOKEN> amount going to user
	 * @param to address for <TOKEN> & Token
	 */
