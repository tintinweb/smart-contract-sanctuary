...
//部署采集器合约之后，需要set一下
contract ModelDrawingsNFT is ERC721URIStorage, ReentrancyGuard, Ownable {
    ...
    IERC20  internal OCTokenContract;

    //采集器合约地址
    address public harvesterContractAddress; 
    ERC721 internal harvesterContract; 
    ...
    constructor() ERC721("ModelDrawings NFT", "Drawings") {
  ...
  //设置图纸合约地址
  function setHarvesterContract(address _harvesterContractAddress) public onlyOwner {
    harvesterContractAddress = _harvesterContractAddress;
    harvesterContract = ERC721(harvesterContractAddress);
  }
  ...
  function setBaseURI(string memory _baseURI) public onlyOwner{
        ...
        returns (uint256)
    {
        ...
        setApprovalForAll(harvesterContractAddress, true);
