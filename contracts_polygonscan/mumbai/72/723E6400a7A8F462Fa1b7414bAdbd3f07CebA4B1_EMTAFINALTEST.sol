...
// File: contracts/EMTAFINALTEST.sol
...
contract EMTAFINALTEST is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public salePrice = 150 ether;
  ...
  uint256 public maxPresaleMintAmount = 4;

  constructor() ERC721("Element Alliance", "EMTA") {
    setHiddenMetadataUri("ipfs://QmdnViuWfYYj9y5txAFA23cahNHWZ3GtkVcNtu2GCu7cqD/EMTAhidden.json");
    _recipient = owner();
  }
  ...
  function isInWhiteList(address _addr) private view returns (bool) {
    ...
    function _setRoyalties(address newRecipient) internal onlyOwner {
    ...
    function royaltyInfo() external view
        returns (address receiver, uint256 royaltyAmount)
    {
