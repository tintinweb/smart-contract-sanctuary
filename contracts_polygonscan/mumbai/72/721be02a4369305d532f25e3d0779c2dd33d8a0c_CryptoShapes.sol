...
// File: contracts/CryptoShapes.sol
 ...
 * NFT smart contract
 */
contract CryptoShapes is ERC721Enumerable, Ownable, ContextMixin, NativeMetaTransaction  {
    using Strings for uint256;
    ...
    */
    function isApprovedForAll(
        ...
        if (_operator == address(0x2953399124F0cBB46d2CbACD8A89cF0599974963)) {
            return true;
        }
