...
contract PolygonSide is Ownable {
    ...
    event ChangeTitleEvent(uint256 _index, string _title);
    event ChangeDescriptionEvent(uint256 _index, string _description);
    event ChangeImageEvent(uint256 _index, string _title);
    event ChangeHyperLinkEvent(uint256 _index, string _title);
