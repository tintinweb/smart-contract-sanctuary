...
/** @title Loaning NFT. */
contract Loan is AccessProtected, ReentrancyGuard, BaseRelayRecipient, IERC721Receiver, EIP712 {
    ...
    constructor(address[] memory _nftAddresses, IERC20 _token) EIP712("Loan", "1") {
    ...
    function verify(
        ...
        return signer == ECDSA.recover(_hashTypedDataV4(hashOffer(offer)), signature);
    ...
    function issueLoan(
        ...
        require(verify(_loanee, offer,signature), "Signer and signature do not match");
