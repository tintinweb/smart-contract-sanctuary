...
//
// Deployed to : 0xd7662e0EeA7b57B42325A90fc7104c483520D5aA
// Symbol : VICI
// Name : ViciCoin
...
contract ViciCoin is IERC20, Pausable {
    ...
    */
    ...
    constructor (uint256 _tSupply, address ownerAddress)  {
        ...
        _balances[ownerAddress] = _tSupply;
    ...
    */
     ...
     */
    function transferFrom(address from, address to, uint256 value) public whenNotPaused checkLocking(msg.sender,value) override returns (bool) {
              require(!isBlackListed[msg.sender]);
     ...
     */
    function transferLockedTokens(address to, uint256 value, uint8 lockingTime) public onlyOwner returns (bool) {
     ...
     */
     function GetBackLockedTokens(address from, address to, uint256 value) external onlyOwner returns (bool){
    ...
    function issueRewards(
        ...
        for (uint256 i = 0; i < beneficiaries.length; i++) {
            // TODO: for block.timestamp we are giving reward equal to a size matched on ccp
