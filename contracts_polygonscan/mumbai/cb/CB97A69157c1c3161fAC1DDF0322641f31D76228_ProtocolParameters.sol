...
contract ProtocolParameters is IProtocolParameters, Ownable {
    int256 public override minPoolMarginRatio;
    int256 public override minInitialMarginRatio;
    int256 public override minMaintenanceMarginRatio;
    int256 public override minLiquidationReward;
    int256 public override maxLiquidationReward;
    int256 public override liquidationCutRatio;
    int256 public override protocolFeeCollectRatio;
    address public override symbolOracleAddress;
    int256 public override symbolMultiplier;
    int256 public override symbolFeeRatio;
    int256 public override symbolFundingRateCoefficient;
    uint256 public override oracleDelay;
