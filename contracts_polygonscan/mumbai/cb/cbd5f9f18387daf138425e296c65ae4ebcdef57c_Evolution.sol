...
contract Evolution is Initializable, ERC721HolderUpgradeable, AccessControlUpgradeable, PausableUpgradeable  {
    ...
    function initialize(address _EOC, address _RACE, address _TRACE) public initializer {
        ...
        newLevelDiff = 100000;
        minEOCBalance = 22500000; // 5% - 1125000, 95% - 21375000
    }
    modifier validate() {
        require(
    ...
    function deposit(uint256 _tokenId) public {
        ...
        EOC.transferFrom(msg.sender, _safe, fivePercent);
        EOC.burn(msg.sender, minEOCBalance - fivePercent);

        RACE.safeTransferFrom(msg.sender, address(this), _tokenId);
        ownerOfRace[_tokenId] = msg.sender;
        TRACE.safeMint(msg.sender, _tokenId);

        emit RacerDepositEvent(msg.sender, _tokenId, block.timestamp);
    }
    ...
    function withdraw(uint256 _tokenId) public {
        ...
        RACE.safeTransferFrom(address(this), ownerOfRace[_tokenId], _tokenId); 
