...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC3Eaee0126A980300303e8e65Ef37Cb5Bd909907;
...
contract Kunda is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb7B2da54DED5C0a47969088a9518c56d0FE8E7a3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kunda";
    string private _symbol = "KND";
