...
contract Test is ERC721Enumerable, Ownable {
    ...
    uint256 private price = 0.1 ether; // 0.1 MATIC
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= max_purchase, "You can mint a maximum of 10 token");
	    require(supply + _mintAmount < max_supply - reserved, "Exceeds maximum supply");
        require(msg.value >= price * _mintAmount, "Ether sent is not correct");
