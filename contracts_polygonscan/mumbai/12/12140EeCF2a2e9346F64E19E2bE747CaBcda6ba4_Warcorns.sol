 ...
 */
contract Warcorns is MegaTokens, IERC1155ChildMintable {
  bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

  constructor(string memory uri, string memory contractUri, address royaltyFeeRecipient,
        uint8 royaltyFee, address childChainManager) MegaTokens(uri, contractUri, royaltyFeeRecipient, royaltyFee) {
...
*  /// 
 */
contract MegaTokens is Ownable, AccessControlEnumerable, ERC1155Burnable, IERC2981 {
  bytes32 public constant CAT_ROLE = keccak256("CAT_ROLE");
  string public constant name = "Warcorns at NYCC 2021"; // fallback name used for collection on OpenSea if contractURI does not exist
  ...
  /**
   * Overriding isApprovedForAll to auto-approve OpenSea's ERC1155 proxy contract
   */
