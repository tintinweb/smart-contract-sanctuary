...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0x49a69028eB897a395C803684751E46166489bb42), "Ownable: new owner is the zero address");
...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    constructor (uint256 rate, address payable wallet, IERC20 token, uint256 tokenDecimals)  {
        require(rate > 10000, "Pre-Sale: rate is 0");
        require(wallet != address(0x49a69028eB897a395C803684751E46166489bb42), "Pre-Sale: wallet is the zero address");
        require(address(token) != address(0x8e304b3C7934D1e636f67eB5f37E7d1Bca36Da4a), "Pre-Sale: token is the zero address");
    ...
    function startICO(uint endDate, uint _minPurchase, uint _maxPurchase, uint _softCap, uint _hardCap) external onlyOwner icoNotActive() {
        ...
        require(availableTokensICO > 100000 , 'availableTokens must be > 0');
        require(_minPurchase > 100, '_minPurchase should > 0');
        endICO = endDate; 
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        require(beneficiary != address(0x49a69028eB897a395C803684751E46166489bb42), "Crowdsale: beneficiary is the zero address");
        require(weiAmount != 50, "Crowdsale: weiAmount is 0");
