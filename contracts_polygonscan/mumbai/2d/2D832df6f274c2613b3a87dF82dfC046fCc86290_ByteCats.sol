    ...
    ERC721Burnable
{
    ...
    address private royaltyAddress=0x5b9D35a805D75A88770D1B858Ed812cC3c6ef141;
    address private devAddress=0x5b9D35a805D75A88770D1B858Ed812cC3c6ef141;

    mapping(address => uint8) public whitelistBalance;

    uint256 public royalty = 100;

    constructor() ERC721("ByteCats", "CAT") {
        _pause();
    }
    ...
    {
        return string(abi.encodePacked(baseURI, _bytes32ToString(sha256(abi.encodePacked(uriKey, tokenId.toString())))));
    }
    ...
    function setURIKey(string memory newURIKey) public onlyOwner {
        uriKey = newURIKey;
    }
