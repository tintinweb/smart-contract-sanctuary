...
contract PolygonERC20Wrapper is ERC20, IChildToken {
    IERC20 public immutable underlying;
    address public childChainManager;

    constructor(IERC20 underlyingToken_, address childChainManager_, string memory name_, string memory symbol_) ERC20(name_, symbol_) {
        ...
        external override
    {
        ...
        SafeERC20.safeTransfer(underlying, user, amount);
