...
import "./interfaces/ISpiritOrbPetsv0.sol";
...
contract SpiritOrbPetsv1 is ERC721Enumerable, Ownable {
    ...
    uint8 public constant MAX_PET_LEVEL = 30; // approx 1 month per pet of natural play
    ...
    // Separated to decrease gas price on mint
    ...
    * @dev of front-end display. Try using getTrueLevel() from a PetCare contract.
    */
    ...
    */
    ...
    /**
    * @dev Withdraw ETH to the owner's wallet
    */
    ...
    /**
    * @dev Reserves the first 50 pets for giveaways and for those who helped the project
    */
