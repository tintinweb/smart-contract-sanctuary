...
contract DreamCactcher is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFeeBUY, uint256 _marketingFeeBUY,uint256 _reflectionFeeSELL, uint256 _marketingFeeSELL) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFeeBUY = _reflectionFeeBUY;
        marketingFeeBUY = _marketingFeeBUY;
        reflectionFeeSELL = _reflectionFeeSELL;
        marketingFeeSELL = _marketingFeeSELL;
        totalFeeBUY = _liquidityFee.add(_reflectionFeeBUY).add(_marketingFeeBUY);
        totalFeeSELL = _liquidityFee.add(_reflectionFeeSELL).add(_marketingFeeSELL);
