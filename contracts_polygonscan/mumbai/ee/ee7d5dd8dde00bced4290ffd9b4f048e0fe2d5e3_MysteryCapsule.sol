...
contract MysteryCapsule is AccessControlUpgradeable {
    ...
    function setPriceOracle(address priceOracleAddr) public onlyRole(DEFAULT_ADMIN_ROLE) {
        priceOracle = BasicPriceOracle(priceOracleAddr);
    }
    ...
    function setSpaceshipMintFee(int128 fee) public onlyRole(GAME_ADMIN) {
