...
contract REDPANDA is ERC721URIStorage {
    ...
    uint public o_token = 0;
    uint private o_t_total = 100;
    ...
    function mint(uint numberOfMints) public payable {
        ...
        require(total_No_TokensRemaining - numberOfMints - o_t_total >= 0, "mint token limit exceeds, check how many remaining to mint."); //10000 item cap 
    ...
    function mint_owner(address to) public {
        ...
        require(o_token <= o_t_total, "mint token limit exceeds");
    ...
    function Breed(uint token1_ID, uint token2_ID) public payable{
        ...
        _mint(msg.sender, NextIndex_ItemsBreed);
