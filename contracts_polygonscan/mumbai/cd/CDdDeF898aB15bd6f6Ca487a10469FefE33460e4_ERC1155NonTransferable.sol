    ...
    MetaTransactionReceiver
{
     ...
     */
    constructor(string memory _uri) ERC1155(_uri) Ownable() MetaTransactionReceiver("Boson ERC1155") {}
...
contract MetaTransactionReceiver is Ownable {
    ...
    function executeMetaTransaction(
        ...
        bytes32 dataHash = toTypedMessageHash(hashMetaTransaction(metaTx));
