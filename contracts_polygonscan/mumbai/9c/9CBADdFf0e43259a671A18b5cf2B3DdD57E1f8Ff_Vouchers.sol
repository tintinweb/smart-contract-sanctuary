...
contract Vouchers is ERC721Enumerable, Ownable, Pausable {
    ...
    constructor() ERC721("MetaSoccer Vouchers", "MSV") {}
    ...
    function _mintForDrop(
        ...
        for (uint256 i = 0; i < _qty; ++i) {
            voucherTypes[totalSupply()] = _type;
    ...
    function getAllVouchers() public view returns (string[] memory) {
    ...
    function getAllOwned(address owner) public view returns (string[] memory) {
