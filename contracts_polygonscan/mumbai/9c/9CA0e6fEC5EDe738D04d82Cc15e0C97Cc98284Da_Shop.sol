...
contract Shop is ERC1155, Ownable {
    ...
    event BuyItem(address indexed userAddress,uint256 timeStamp, uint256 gasUsed, uint256 itemId, uint256 itemAmount, uint256 nakaAmount);
    event TotalItem(address indexed userAddress, uint256 totalItem);
    ...
    function buyItems(address _userAddress, uint256 _itemId, uint256 _itemAmount,uint256 _nakaAmount) external {
        ...
        emit BuyItem(msg.sender, timeStamp, gasUsed, _itemId, _itemAmount,_nakaAmount);
    }
}
