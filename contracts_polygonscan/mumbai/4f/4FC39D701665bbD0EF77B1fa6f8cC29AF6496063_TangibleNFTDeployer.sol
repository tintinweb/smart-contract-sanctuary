...
contract TangibleNFTDeployer is ITangibleNFTDeployer, AdminAndTangibleAccess {
    ...
    function setFactory(address _factory) external onlyAdmin() {
        require( (_factory != address(0x0)) && (_factory != address(factory)), "Wrong factory");
...
contract TangibleNFT is AdminAccess, ERC721, ERC721Enumerable, ERC721Pausable, ITangibleNFT {
    ...
    modifier onlyFactoryAdmin(){
        require(IFactory(factory).isFactoryAdmin(msg.sender));
        _;
    }
    ...
    constructor(
        ...
        storagePercentagePricePerYear = 250; //0.5 percent
    }
    ...
    /// @inheritdoc ITangibleNFT
    function destroyTNFTs(uint256[] calldata tokenIds, address burningFrom) external override onlyFactoryOrAdmin() {
    ...
    function payForStorage(
        ...
        IFactory(factory).USDC().safeTransferFrom(from, IFactory(factory).feeStorageAddress(), amount);
