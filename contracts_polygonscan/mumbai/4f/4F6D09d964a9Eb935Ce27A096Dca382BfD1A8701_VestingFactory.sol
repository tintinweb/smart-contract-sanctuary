...
import "./Interface/ILinearVestingMinimalProxy.sol";
...
contract VestingFactory is Ownable, CloneBase {
    ...
    function launchVesting(
        ...
        ILinearVestingMinimalProxy(linearVesting).init(
            _erc20Token,
            _start,
            _end,
...
interface ILinearVestingMinimalProxy {
    function init(
        IERC20 _token,
        uint256 _start,
        uint256 _end,
