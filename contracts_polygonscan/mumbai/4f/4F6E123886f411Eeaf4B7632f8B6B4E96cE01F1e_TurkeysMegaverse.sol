...
contract TurkeysMegaverse is ERC721A, Ownable {
    ...
    uint constant public MAX_SUPPLY = 77;
    ...
    uint public maxMintsPerWallet = 30;
    uint public mintingStartTimestamp = 1642768200;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xd9d6732ca652E6cAB21C5454eF05fB90d612dbD1).transfer(balance * 75 / 100);
    }
