...
/// @title BronzeChest Operator
/// @notice This Operator handles opening and creating of cards for Bronze Chest Token.
contract BronzeChest is Chest {

    /// @notice Bronze Chest Operator has multiple parameters while deployment
    /// @dev
    /// @param _name Name of chest operator
    /// @param _version Version of the operator
    /// @param _bronzeChestToken Contract Address of the Bronze Chest Token mapped in the network
