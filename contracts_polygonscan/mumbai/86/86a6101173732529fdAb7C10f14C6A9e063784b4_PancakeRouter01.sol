...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                //hex'b8de1f67ec84eedb4273ca955d6f6d9b0c4e3f16a358cab15253e91e8123d283' // init code hash for polygon contract
                hex'b8de1f67ec84eedb4273ca955d6f6d9b0c4e3f16a358cab15253e91e8123d283'   // Change to INIT_CODE_PAIR_HASH of Polygon Factory
            ))));
    }
