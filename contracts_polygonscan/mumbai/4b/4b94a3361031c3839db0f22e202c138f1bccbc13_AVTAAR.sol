    ...
    ERC721BurnableUpgradeable
{
    ...
    event CreateAvtaar(uint256 indexed id);
    ...
    function mintTo(address _to) public onlyOwner {
        ...
        _mint(_to, newItemId);
        emit CreateAvtaar(newItemId);
    }

    function prefixTokenURI() public view returns (string memory) {
        return "metadata.json";
    }

    function suffixTokenURI() public view returns (string memory) {
        return "https://dev-nft-nft-s3.s3.eu-west-1.amazonaws.com/assets/";
    }
