...
contract TestPolygonFarmVaultChef is Ownable, ReentrancyGuard, Operators {
    using SafeMath for uint256;
     ...
     */
    function addPool(address _strat, uint256 _depositFee, uint256 _withdrawFee) external onlyOwner nonReentrant {
