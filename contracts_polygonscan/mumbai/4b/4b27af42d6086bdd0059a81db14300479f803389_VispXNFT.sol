...
contract VispXNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public constant NFT_PRICE = 0; //50000000000000; // 0.005 ETH 5000000000000000
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_NFT_PURCHASE,"Can only mint up to 1000 per purchase");
