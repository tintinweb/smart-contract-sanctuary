...
contract SpaceShibes is ERC721 {
    ...
    string public __baseTokenURI = "https://gateway.pinata.cloud/ipfs/IPFS LINK ID HERE/" ; 

    constructor() ERC721("SpaceShibes", "SHIBE") {
        owner = msg.sender ; 
    }
    ...
    function burn_NFT(uint[] memory tokenIDs) public {
