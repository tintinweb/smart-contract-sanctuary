...
// hevm: flattened sources of /nix/store/y3yxgwxmwghp1q4lx3bw4svfmhjgw9xw-geb-safe-manager/dapp/geb-safe-manager/src/GetSafes.sol

pragma solidity =0.6.7;

////// /nix/store/y3yxgwxmwghp1q4lx3bw4svfmhjgw9xw-geb-safe-manager/dapp/geb-safe-manager/src/GebSafeManager.sol
...
abstract contract SAFEEngineLike_13 {
...
contract SAFEHandler {
    constructor(address safeEngine) public {
        SAFEEngineLike_13(safeEngine).approveSAFEModification(msg.sender);
    }
}
...
contract GebSafeManager {
    ...
    function modifySAFECollateralization(
        ...
        SAFEEngineLike_13(safeEngine).modifySAFECollateralization(
    ...
    function transferCollateral(
        ...
        SAFEEngineLike_13(safeEngine).transferCollateral(collateralTypes[safe], safes[safe], dst, wad);
    ...
    function transferCollateral(
        ...
        SAFEEngineLike_13(safeEngine).transferCollateral(collateralType, safes[safe], dst, wad);
        emit TransferCollateral(
            msg.sender,
            collateralType,
            safe,
    ...
    function transferInternalCoins(
        ...
        SAFEEngineLike_13(safeEngine).transferInternalCoins(safes[safe], dst, rad);
    ...
    function quitSystem(
        ...
        (uint lockedCollateral, uint generatedDebt) = SAFEEngineLike_13(safeEngine).safes(collateralTypes[safe], safes[safe]);
        int deltaCollateral = toInt(lockedCollateral);
        int deltaDebt = toInt(generatedDebt);
        SAFEEngineLike_13(safeEngine).transferSAFECollateralAndDebt(
            collateralTypes[safe],
            safes[safe],
            dst,
            deltaCollateral,
    ...
    function enterSystem(
        ...
        (uint lockedCollateral, uint generatedDebt) = SAFEEngineLike_13(safeEngine).safes(collateralTypes[safe], src);
        int deltaCollateral = toInt(lockedCollateral);
        int deltaDebt = toInt(generatedDebt);
        SAFEEngineLike_13(safeEngine).transferSAFECollateralAndDebt(
            collateralTypes[safe],
    ...
    function moveSAFE(
        ...
        (uint lockedCollateral, uint generatedDebt) = SAFEEngineLike_13(safeEngine).safes(collateralTypes[safeSrc], safes[safeSrc]);
        int deltaCollateral = toInt(lockedCollateral);
        int deltaDebt = toInt(generatedDebt);
        SAFEEngineLike_13(safeEngine).transferSAFECollateralAndDebt(
...
////// /nix/store/y3yxgwxmwghp1q4lx3bw4svfmhjgw9xw-geb-safe-manager/dapp/geb-safe-manager/src/GetSafes.sol
// Copyright (C) 2018-2020 Maker Ecosystem Growth Holdings, INC.
