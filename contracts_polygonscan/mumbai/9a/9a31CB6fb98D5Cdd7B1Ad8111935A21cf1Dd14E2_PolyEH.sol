...
contract PolyEH is Ownable, ERC721Enumerable, recovery{

    uint256 public cost;  
    uint256 public cost50;
    uint256 public cost90;
    string private _baseTokenURI;    
    string public B_PROVENANCE = "d9df370a6f4ce906e17dbf85e66df87ea9eb909ecefff9d4b7c172f7ac7609d5"; 
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(_mintAmount > 0, "You cannot buy ZERO Banner");
        ...
        if (msg.sender != owner()) {            
            ...
            require(msg.value >= cost * _mintAmount, "Matic value sent is not correct");             
        }        
