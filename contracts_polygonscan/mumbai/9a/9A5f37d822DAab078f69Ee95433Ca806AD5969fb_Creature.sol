...
contract Creature is ERC721Tradable {
    ...
    /**
     * @dev the constructor sets the proxyRegistryAddress and the contract URI of the contract.
     ...
     */
    constructor(address _proxyRegistryAddress, string memory contractURI_)
        ERC721Tradable("Creature", "CSF", _proxyRegistryAddress)
    {
    ...
    Ownable
{
    ...
    /**
     *  We track the CID for every tokenId
     */
    ...
    /**
     * @dev Sets the URI for the token
     * @param tokenId new token to receive the URI
        ...
        virtual
    {
        ...
        _metadataCIDs[tokenId] = _tokenURI;
    }

    /**
     * @dev Returns the URI for the token. If the token does not exists, the base URL will be returned with the tokenID concatenated.
     * @param tokenId new token to receive the URI
     */
        ...
        returns (string memory)
    {
        ...
        string memory _tokenURI = _metadataCIDs[tokenId];
    ...
    /**
     * @dev Returns the CDI of the tokenId if it exists
     * @param tokenId new token to receive the URI
     */
    function getCDI(uint256 tokenId) public view returns (string memory) {
        require(
            _exists(tokenId),
            "ERC721Metadata: URI query for nonexistent token"
        );
