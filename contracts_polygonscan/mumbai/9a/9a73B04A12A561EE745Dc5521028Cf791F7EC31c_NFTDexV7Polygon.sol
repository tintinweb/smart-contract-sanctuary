  ...
  function claimAuction(uint256 _tokenId, bool awardType, string memory ownerId, address from) public {
    ...
    if(awardType) {
     ...
     if(revenueShare.checkTokenAuthorIsArtist(_tokenId) ){
          ALIA.transfer(aliaHolder, (price  / 1000) * authorPercentage);
          revenueShare.transferAliaArtist(aliaHolder, (price  / 1000) * authorPercentage, nonCryptoNFTVault, _tokenId, platform,platformPerecentage);
