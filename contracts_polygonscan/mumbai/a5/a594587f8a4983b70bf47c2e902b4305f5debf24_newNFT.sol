...
// ERC-721 interface for accepting safe transfers: https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md
...
// A standard for detecting smart contract interfaces: https://eips.ethereum.org/EIPS/eip-165
interface ERC165 {
  /**
...
contract SupportsInterface is ERC165 {
  // Mapping of supported intefraces. You must not set element 0xffffffff to true
...
// Based on: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/Address.sol
// Requires EIP-1052; utility library of inline functions on addresses
...
contract NFToken is ERC721, SupportsInterface {
  ...
  // Magic value of a smart contract that can receive NFT.
  ...
  // _tokenId: ID of the NFT to validate
...
interface ERC721Metadata {
  ...
  // Returns a distinct Uniform Resource Identifier (URI) for a given asset. It Throws if `_tokenId` is not a valid NFT.
  // URIs are defined in RFC3986. The URI may point to a JSON file that conforms to the "ERC721 Metadata JSON Schema".
  // _tokenId: URI of _tokenId.
...
contract NFTokenMetadata is NFToken, ERC721Metadata {
  ...
  // When implementing this contract don't forget to set nftName and nftSymbol
  constructor() {
  ...
  // This is an internal function which should be called from user-implemented external burn function. Its purpose is to show and properly
  // initialize data structures when using this implementation. Also, note that this burn implementation allows the minter to re-mint a burned NFT
  // Burns a NFT
  ...
  // This is an internal function which should be called from user-implemented external function
  // Its purpose is to show and properly initialize data structures when using this implementation
...
// The contract has an owner address, and provides basic authorization control whitch
...
contract Ownable {
  ...
  // An event which is triggered when the owner is changed
