    ...
    ERC2771ContextUpgradeable
{
    ...
    function adminInitialDeposit(uint256 _amount) public {
    ...
    function swapRewards() internal {
        ...
        IUniswapV2Router02(ROUTER).swapExactTokensForTokens(nativeBal, nativeBal.mul(997).div(1000), nativeToWantRoute, address(this), block.timestamp);
    }
    ...
    function deposit(uint256 _amount) public whenNotPaused {
        want().transferFrom(_msgSender(), address(this), _amount);
