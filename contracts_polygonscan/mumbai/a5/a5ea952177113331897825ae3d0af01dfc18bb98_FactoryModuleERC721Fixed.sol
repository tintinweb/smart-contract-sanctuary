...
/**
 * @title Factory module for dStorage ERC721 fixed
 *
 * @notice this implements a factory module to create a new instance of the
 * dStorage ERC721 fixed price contract
 */
contract FactoryModuleERC721Fixed is IFactoryModule {
    /**
    ...
    function createToken(
        ...
        DStorageERC721Fixed token = new DStorageERC721Fixed(name, symbol, uri);
...
contract DStorageERC721 is ERC721, IERC2981, Ownable, ReentrancyGuard {
     ...
     * @param amount number of tokens to mint
     */
    function mintOwner(uint256 amount) external onlyOwner nonReentrant {
        require(
     ...
     */
    function setMax(uint256 max_) external onlyOwner {
