...
contract PolyPenguinGovernance {
    ...
    function setupFarm(address farm, uint256 rewards, uint256 exposure) external {
        ...
        require(rewards > 0 && rewards <= (100000 * (10 ** 18)), "PolyPenguinGovernance :: setupFarm : invalid reward amount"); 
        require(exposure > 0 && exposure <= (250000 * (10 ** 18)), "PolyPenguinGovernance :: setupFarm : Invalid exposure"); 
