...
// File: contracts/BurguerPoly.sol
...
contract BurguerPoly is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Polygon Burger V2", "PB") {
    setHiddenMetadataUri("ipfs://QmeTbfw4ujDKpebcve37DTGNsv11uxbbDacP6fzQPtB7aR/hidden.json");
  }
