...
contract BnomialNFT is ERC721, Ownable {
    ...
    function renderSVG2(uint256 tokenId) public view returns (string memory svg) {
        ...
        // SVG header
        svg = string(
            abi.encodePacked('<svg xmlns="http://www.w3.org/2000/svg" version="1.2"   viewBox="0 0 100 100">')
        );
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        jsonData = string(
            abi.encodePacked(
                jsonData,
                'PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZlcnNpb249IjEuMiIgICB2aWV3Qm94PSIwIDAgMTAwIDEwMCI+PHJlY3QgeD0iMCIgeT0iMCIgd2lkdGg9IjEwMCIgaGVpZ2h0PSIxMDAiIGZpbGw9IiMwMDAwZmYiLz48L3N2Zz4="}'
            )
        );
