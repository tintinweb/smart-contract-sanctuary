...
using SafeMath for uint256;
   ...
   * to the airdrop list with the default of 300 Circle Token
   */
   ...
   * airdrop list with the default of 300 Circle Token
   */
...
contract CircleAirDrop is AirDropWinners {
  using SafeMath for uint256;
