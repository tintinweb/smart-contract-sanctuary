...
// File contracts/sale/PurchaseLifeCycles.sol
...
// File contracts/sale/GBotPacksSale.sol


pragma solidity >=0.7.6 <0.8.0;


contract GBotsPacksSale is FixedPricesSale {
    IGBotPacksTransferable public immutable inventory;
    ...
    constructor(
        ...
        require(inventory_ != address(0), "GBotPacksSale: zero address inventory");
        // solhint-disable-next-line reason-string
        require(tokenHolder_ != address(0), "GBotPacksSale: zero address token holder");
        inventory = IGBotPacksTransferable(inventory_);
    ...
    function createSku(
        ...
        require(tokenId != 0, "GBotPacksSale: zero token ID");
 ...
 */
interface IGBotPacksTransferable {
    /**
