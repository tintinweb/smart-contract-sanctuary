...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    function closeLottery(uint256 _lotteryId, uint256 externalNumber) external override onlyOperator nonReentrant {
        ...
        finalNumber += uint32(_randomNumber);
        ...
        finalNumber += uint32(_randomNumber) * 10;
        // 3
         _structHash = keccak256(
            abi.encode(
                _blockhash,
        ...
        finalNumber += uint32(_randomNumber) * 100;
        ...
        finalNumber += uint32(_randomNumber) * 1000;
        ...
        finalNumber += uint32(_randomNumber) * 10000;
        ...
        finalNumber += uint32(_randomNumber) * 100000;
