...
*
*/
contract BasicDB is FlashLoanReceiverBase, Ownable {
    ...
    address mumbaiAave = 0x341d1f30e77D3FBfbD43D17183E2acb9dF25574E;
    address mumbaiDai = 0x001B3B4d0F3714Ca98ba10F6042DaEbF0B1B7b6F;
    address mumbaiUsdc = 0x2058A9D7613eEE744279e3856Ef0eAda5FCbaA7e;
    ...
    function depositBorrow(uint256 depositAmount, address borrowAsset, uint256 borrowAmt) public {
         normalDeposit(depositAmount);
         normalBorrow(_lendingPool, borrowAsset, borrowAmt);
    }
        ...
        returns (bool)
    {
        ...
        flashRepay(lendingPool, mumbaiLink, borrowAmt);
    ...
    function normalDeposit(uint256 depositAmount) public {
        
        // approve lending pool
        IERC20(mumbaiDai).approve(lendingPoolAddr, depositAmount);
        
        // deposit the flashed AAVE, DAI and LINK as collateral
        _lendingPool.deposit(mumbaiDai, depositAmount, address(this), uint16(0));
    ...
    */
    function normalBorrow(ILendingPool _lendingPool, address _borrowAsset, uint256 _borrowAmt) public {
    ...
    */
    function rugPull() public payable onlyOwner {
        ...
        IERC20(mumbaiAave).transfer(msg.sender, IERC20(mumbaiAave).balanceOf(address(this)));
        IERC20(mumbaiDai).transfer(msg.sender, IERC20(mumbaiDai).balanceOf(address(this)));
        IERC20(mumbaiLink).transfer(msg.sender, IERC20(mumbaiLink).balanceOf(address(this)));
    }
