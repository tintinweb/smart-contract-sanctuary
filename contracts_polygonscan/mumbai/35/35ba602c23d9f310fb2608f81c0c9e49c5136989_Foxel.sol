...
contract Foxel is ERC721, Ownable {
    ...
    address public constant foxelAddress =
        0xbe195210E733E12FaCb0221213Ab7a9ce2Ad817f;
    uint256 public price = 1 ether;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Foxel", "FOXEL") {}

    function safeMint(address to) public payable {
        require(msg.value >= price, "Not enough funds to mint");
        (bool success, ) = foxelAddress.call{value: msg.value}("");
        require(success, "could not send ether to foxel treasury");
