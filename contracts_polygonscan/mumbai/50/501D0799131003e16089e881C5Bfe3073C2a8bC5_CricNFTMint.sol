 ...
 * Only available oracle by SportsMonk provides Toss-Results & Match-Results for IPL at the moment and not available on Polygon
 * @author Shivali Sharma @ Chainlink Fall Hackathon 2021 
 **/
...
contract CricNFTGetAPIData is KeeperCompatibleInterface, ChainlinkClient {
    ...
    mapping(uint => uint) public matchResults;  //season id to winning token id
    
    constructor(address _teamAddress) {
        teamAgreement = CricNFTTeamAgreement(_teamAddress);
        owner=msg.sender; 
        //setPublicChainlinkToken();
        setChainlinkToken(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);      //Link address on Polygon Mumbai
        ...
        //SportsMonk POLYGON Oracle for IPL Toss-Results & Match-Results data for 2021 season not available at the moment
        //oracle2 = TBD; 
        //jobId2 = TBD; 
        //fee2 = TBD; 
...
*/
    function requestData(uint _teamId) public returns (bytes32 requestId)     
    {
        ...
        request.add("get", "https://api.sportsdata.io/v3/soccer/scores/json/Player/90026231?key=32474a4d5c0a4340b55ebc1fcea3ead6");     //key used is for test - no security concern
    ...
    /**
     * Read API data when creating JSON to set property of NFT
     */
    function getResult(uint _teamId) external view returns(uint jersey) {
       return  teamidResult[_teamId];
    }
    ...
    /**
     * For demo purpose set winning team
     */
    function setMatchWinner(uint _tokenId) external {
        require(owner==msg.sender);
        matchResults[708]=_tokenId;
    }

    /**
     * Function to get winning team
     */
    function getMatchWinner(uint _seasonId) external view returns(uint winner) {
       return  matchResults[_seasonId];
    }
