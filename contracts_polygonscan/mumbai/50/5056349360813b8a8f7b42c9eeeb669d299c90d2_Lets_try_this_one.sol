...
contract Lets_try_this_one is ERC721Enumerable, ERC721URIStorage, Ownable {
  using Strings for uint256;
  ...
  uint256 public reservedRemaining = 666;
  uint256 public maxMintAmount = 2000;
  uint256 public nftPerAddressLimit = 2000;
  bool public saleStatus = true; //i guess this is right?
  bool public preSaleStatus = true; //and this one?
  
  mapping (address => uint256) public presaleWhitelist;

  constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol) {
    setBaseURI("ipfs://QmYD61waaq242ypu38vCutLmHLqrBw4edpTb46VKHJgbeR/");
  }
 ...
 //   }
  ...
  function setBaseURI(string memory _newBaseURI) public onlyOwner {
   ...
   /*
    * Mint 666 reserved NFTs for giveaways, devs, etc.
   */
