...
contract PandasMatrix {
    ...
    constructor(address ownerAddress) {
        ...
        matrixLevelPrice[1][1] = 6 ether;
        matrixLevelPrice[1][2] = 12 ether;
        matrixLevelPrice[1][3] = 20 ether;
        matrixLevelPrice[1][4] = 40 ether;
        matrixLevelPrice[1][5] = 50 ether;
        matrixLevelPrice[1][6] = 70 ether;
        matrixLevelPrice[1][7] = 100 ether;
        matrixLevelPrice[1][8] = 150 ether;
        matrixLevelPrice[1][9] = 200 ether;
        matrixLevelPrice[1][10] = 300 ether;
        matrixLevelPrice[1][11] = 400 ether;
        matrixLevelPrice[1][12] = 700 ether;
        matrixLevelPrice[1][13] = 800 ether;
        matrixLevelPrice[1][14] = 1000 ether;
        matrixLevelPrice[1][14] = 1200 ether;

        matrixLevelPrice[2][1] = 5 ether;
        matrixLevelPrice[2][2] = 8 ether;
        matrixLevelPrice[2][3] = 10 ether;
        matrixLevelPrice[2][4] = 20 ether;
        matrixLevelPrice[2][5] = 30 ether;
        matrixLevelPrice[2][6] = 50 ether;
        matrixLevelPrice[2][7] = 80 ether;
        matrixLevelPrice[2][8] = 100 ether;
        matrixLevelPrice[2][9] = 150 ether;
        matrixLevelPrice[2][10] = 200 ether;
        matrixLevelPrice[2][11] = 300 ether;
        matrixLevelPrice[2][12] = 500 ether;
        matrixLevelPrice[2][13] = 600 ether;
        matrixLevelPrice[2][14] = 800 ether;
        matrixLevelPrice[2][15] = 1000 ether;
