...
contract XChainTrade { 
    ...
    function currentPrice() public view returns(uint256) {
        ...
        uint256 price;
        if (thedate > 1641656400) {price = 49.5614410668426 ether;} else if (thedate > 1641656280) {price = 47.201372444612 ether;} else if (thedate > 1641656160) {price = 44.9536880424876 ether;} else if (thedate > 1641656040) {price = 42.8130362309406 ether;} else if (thedate > 1641655920) {price = 40.7743202199434 ether;} else if (thedate > 1641655800) {price = 38.8326859237556 ether;} else if (thedate > 1641655680) {price = 36.9835104035768 ether;} else if (thedate > 1641655560) {price = 35.2223908605493 ether;} else if (thedate > 1641655440) {price = 33.5451341529041 ether;} else if (thedate > 1641655320) {price = 31.9477468122896 ether;} else if (thedate > 1641655200) {price = 30.4264255355139 ether;} else if (thedate > 1641655080) {price = 28.9775481290609 ether;} else if (thedate > 1641654960) {price = 27.5976648848199 ether;} else if (thedate > 1641654840) {price = 26.2834903664951 ether;} else if (thedate > 1641654720) {price = 25.0318955871382 ether;} else if (thedate > 1641654600) {price = 23.8399005591793 ether;} else if (thedate > 1641654480) {price = 22.7046671992183 ether;} else if (thedate > 1641654360) {price = 21.6234925706841 ether;} else if (thedate > 1641654240) {price = 20.5938024482706 ether;} else if (thedate > 1641654120) {price = 19.6131451888291 ether;} else if (thedate > 1641654000) {price = 18.679185894123 ether;} else if (thedate > 1641653880) {price = 17.7897008515457 ether;} else if (thedate > 1641653760) {price = 16.9425722395673 ether;} else if (thedate > 1641653640) {price = 16.1357830853022 ether;} else if (thedate > 1641653520) {price = 15.3674124621926 ether;} else if (thedate > 1641653400) {price = 14.6356309163739 ether;} else if (thedate > 1641653280) {price = 13.9386961108323 ether;} else if (thedate > 1641653160) {price = 13.2749486769831 ether;} else if (thedate > 1641653040) {price = 12.6428082637935 ether;} else if (thedate > 1641652920) {price = 12.0407697750414 ether;} else if (thedate > 1641652800) {price = 11.4673997857537 ether;} else if (thedate > 1641652680) {price = 10.9213331292892 ether;} else if (thedate > 1641652560) {price = 10.4012696469421 ether;} else if (thedate > 1641652440) {price = 9.90597109232584 ether;} else if (thedate > 1641652320) {price = 9.43425818316747 ether;} else if (thedate > 1641652200) {price = 8.98500779349283 ether;} else if (thedate > 1641652080) {price = 8.55715027951698 ether;} else if (thedate > 1641651960) {price = 8.14966693287331 ether;} else if (thedate > 1641651840) {price = 7.76158755511744 ether;} else if (thedate > 1641651720) {price = 7.39198814773089 ether;} else if (thedate > 1641651600) {price = 7.03998871212466 ether;} else if (thedate > 1641651480) {price = 6.70475115440444 ether;} else if (thedate > 1641651360) {price = 6.38547728990899 ether;} else if (thedate > 1641651240) {price = 6.08140694277047 ether;} else if (thedate > 1641651120) {price = 5.79181613597187 ether;} else if (thedate > 1641651000) {price = 5.51601536759226 ether;} else if (thedate > 1641650880) {price = 5.25334796913548 ether;} else if (thedate > 1641650760) {price = 5.00318854203379 ether;} else if (thedate > 1641650640) {price = 4.76494146860361 ether;} else if (thedate > 1641650520) {price = 4.5380394939082 ether;} else if (thedate > 1641650400) {price = 4.32194237515067 ether;} else if (thedate > 1641650280) {price = 4.11613559538159 ether;} else if (thedate > 1641650160) {price = 3.92012913845866 ether;} else if (thedate > 1641650040) {price = 3.73345632234158 ether;} else if (thedate > 1641649920) {price = 3.55567268794436 ether;} else if (thedate > 1641649800) {price = 3.38635494089939 ether;} else if (thedate > 1641649680) {price = 3.2250999437137 ether;} else if (thedate > 1641649560) {price = 3.07152375591781 ether;} else if (thedate > 1641649440) {price = 2.92526071992173 ether;} else if (thedate > 1641649320) {price = 2.78596259040164 ether;} else if (thedate > 1641649200) {price = 2.65329770514442 ether;} else if (thedate > 1641649080) {price = 2.52695019537564 ether;} else if (thedate > 1641648960) {price = 2.40661923369109 ether;} else if (thedate > 1641648840) {price = 2.29201831780103 ether;} else if (thedate > 1641648720) {price = 2.18287458838194 ether;} else if (thedate > 1641648600) {price = 2.07892817941137 ether;} else if (thedate > 1641648480) {price = 1.9799315994394 ether;} else if (thedate > 1641648360) {price = 1.88564914232324 ether;} else if (thedate > 1641648240) {price = 1.79585632602213 ether;} else if (thedate > 1641648120) {price = 1.71033935811631 ether;} else if (thedate > 1641648000) {price = 1.62889462677744 ether;} else if (thedate > 1641647880) {price = 1.55132821597852 ether;} else if (thedate > 1641647760) {price = 1.47745544378906 ether;} else if (thedate > 1641647640) {price = 1.40710042265625 ether;} else if (thedate > 1641647520) {price = 1.340095640625 ether;} else if (thedate > 1641647400) {price = 1.2762815625 ether;} else if (thedate > 1641647280) {price = 1.21550625 ether;} else if (thedate > 1641647160) {price = 1.157625 ether;} else if (thedate > 1641647040) {price = 1.1025 ether;} else if (thedate >= 1641646920) {price = 1.05 ether;} else if (thedate < 1641646920) {price = 1 ether;}
        return price;
    }
