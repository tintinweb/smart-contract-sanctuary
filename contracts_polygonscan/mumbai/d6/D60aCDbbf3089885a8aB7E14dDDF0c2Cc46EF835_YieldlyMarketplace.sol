...
contract YieldlyMarketplace is ReentrancyGuard, Ownable {
    ...
    function mint(string memory _tokenURI, address _sender, uint256 _price, bool _isListOnMarketplace, uint256 _royalty, uint256 startDate, uint256 auctionLength) public payable {
        _tokenIds.increment();
