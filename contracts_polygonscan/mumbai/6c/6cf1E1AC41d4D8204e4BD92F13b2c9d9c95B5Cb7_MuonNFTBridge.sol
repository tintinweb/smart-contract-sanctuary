...
contract MuonNFTBridge is Ownable, IERC721Receiver {
  ...
  function claim(
    ...
    // require(block.timestamp - txParams[4]  < acceptableMuonDelay, 'expired');
		require(txParams[4] - block.timestamp >= confirmationTimes[txParams[0]], "Bridge: confirmationTime is not finished yet");
  ...
  function ownerSetConfirmationTime(uint256 chainID, uint256 confirmationTime) public onlyOwner {
