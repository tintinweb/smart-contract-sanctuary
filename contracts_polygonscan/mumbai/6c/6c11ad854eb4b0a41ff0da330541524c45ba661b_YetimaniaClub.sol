...
contract YetimaniaClub is ERC721, Ownable, RandomlyAssigned{
    using Strings for uint256;
    ...
    function mint (uint8 _amount) public payable
    {
      ...
      for(uint256 i = 1; i <= _amount; i++){
        ...
        if(currentSupply==300 || currentSupply==600 || currentSupply==999){
          cost+=0.01 ether;
        }
        currentSupply++;
      }
