    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        if(pending > 0) {
            ...
            if (Referral.hasReferrer(msg.sender)){
                ...
                cake.mint(Referral.getReferrer(msg.sender), refReward);
                parentClaimed[Referral.getReferrer(msg.sender)] += refReward;
                emit ReferralClaimed(Referral.getReferrer(msg.sender), refReward);
            }
        }
        if(_amount > 0) {
