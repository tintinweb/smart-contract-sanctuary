...
contract TrippyShroomTravelAgency is ERC721, Ownable {
    ...
    uint256 public whitelistPrice = 0 ether; // 33 MATIC
    uint256 public tokenPrice = 33 ether; // 33 MATIC
    uint256 public constant maxTokenPurchase = 333;
    ...
    constructor() ERC721("Trippy Shroom Travel Agency", "TSTA") { 
