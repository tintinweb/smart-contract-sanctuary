...
contract MaticWETH is ChildERC20 {
    constructor(address childChainManager ,string memory name) ChildERC20("Wrapped Ether", name, childChainManager) {}
}

contract BMToken is ERC20 {
    //string constant name = "Basic Milk Token";
    //string constant symbol = "BMT";
