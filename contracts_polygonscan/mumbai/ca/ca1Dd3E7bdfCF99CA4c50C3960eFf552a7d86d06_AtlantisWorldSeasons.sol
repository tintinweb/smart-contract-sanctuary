    ...
    AccessControlEnumerable
{
        ...
        nonReentrant
    {
        ...
        _setTokenURI(currentTokenId, season.metadataURI);
     ...
     * @param metadataURI The base64 ecnoded JSON metadata for a {Season}
     * @return The current `seasonId` for the recently created {Season}
     */
    function createSeason(string calldata metadataURI)
        external
        onlyAdmin
        returns (uint256)
    {
