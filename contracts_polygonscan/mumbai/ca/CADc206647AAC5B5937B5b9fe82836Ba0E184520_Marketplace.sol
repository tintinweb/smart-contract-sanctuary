...
contract Marketplace is PriceConsumerV3, EIP712MetaTransaction {
    ...
    /**
        ...
        - then Mocha triggers setForSaleWithFiat for them
  ...
  /**
    ...
    */
    function setForSaleWithFiat(uint256 _tokenId, uint256 _priceFiat, bool _auction) public isActive onlyMocha {
  ...
  /**
    ...
    */
    function removeSetForSaleFiat(uint256 _tokenId) public isActive onlyMocha {
        require(_tokenId > 0, "token id is zero or lower");
