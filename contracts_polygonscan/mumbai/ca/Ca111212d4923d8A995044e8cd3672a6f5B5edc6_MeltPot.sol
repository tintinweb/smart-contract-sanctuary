...
// File: contracts/Farm/MeltPot.sol
...
contract MeltPot is Ownable {
    ...
    constructor(IERC20 _staking, address _owner) public {
    ...
    function addReward(IERC20 rewardToken0, IERC20 rewardToken1, uint256 amount0, uint256 amount1) public {
        ...
        if (lpSupply == 0) {
            rewardToken0.transferFrom(msg.sender, owner(), amount0);
            rewardToken1.transferFrom(msg.sender, owner(), amount1);
            return;
        }
