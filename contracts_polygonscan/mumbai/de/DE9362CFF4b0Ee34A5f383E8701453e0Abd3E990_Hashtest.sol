...
contract Hashtest is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("hashtest", "HASH") { }
    ...
    function matchAddresSigner(bytes32 hash, bytes memory signature) public view returns(bool) {
       ...
       function recoverAdd(bytes32 hash, bytes memory signature) public pure returns(address) {
        address signeradd = hash.recover(signature);
        return signeradd;
    }
