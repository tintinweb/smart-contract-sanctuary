...
contract MyTestNFT22 is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    require(currentSupply + _mintAmount <= maxSupply, "YOU CAN'T MINT MORE THAN MAXIMUM SUPPLY");
