...
contract CryptoNijigenGirlsUpgradeableV6 is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function mint(address user, uint256 tokenId) external {
        require(msg.sender == owner(), 'CNGE001');
        require(tokenId>10000 && tokenId < 17778, "CNGE010");
