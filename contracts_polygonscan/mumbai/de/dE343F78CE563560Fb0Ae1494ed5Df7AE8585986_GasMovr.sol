...
contract GasMovr is Ownable, Pausable {
    ...
    */
    ...
    function sendNativeToken(
        ...
        _sendNativeToken(receiver, amount, srcChainTxHash);
    }
    ...
    function _sendNativeToken(
        ...
        require(processedHashes[srcChainTxHash] == false, "Already processed");
        ...
        require(
            amount >= minAndMaxForChains[chainId].minAmount,
            "Amount less than min"
        );
        require(
            amount <= minAndMaxForChains[chainId].maxAmount,
            "Amount more than max"
        );

        emit Send(receiver, amount, srcChainTxHash);

        (bool success, ) = receiver.call{value: amount, gas: 5000}("");
        require(success, "Failed to send Ether");
    }
