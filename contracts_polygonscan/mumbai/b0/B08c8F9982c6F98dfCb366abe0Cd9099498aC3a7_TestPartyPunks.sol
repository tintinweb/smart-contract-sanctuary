...
contract TestPartyPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test PHCP", "TPHP") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x641A72c0Dcb55fcc0ffdD3e5D8eBb7134ffCFB07).call{value: address(this).balance * 19 / 100}("");
    require(hs);
    // =============================================================================
