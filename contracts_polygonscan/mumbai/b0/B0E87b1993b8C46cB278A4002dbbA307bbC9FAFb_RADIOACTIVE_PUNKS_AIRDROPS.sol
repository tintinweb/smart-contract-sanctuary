...
@dev    Extends the ERC1155 Token Standard to allow for pausing, burning,
        and royalties via ERC2981 + Rarible V1 standards. The metadata and
...
contract RADIOACTIVE_PUNKS_AIRDROPS is ERC1155PresetMinterPauser, ERC2981, HasSecondarySaleFees, Ownable, ContextMixin {
  ...
  // Mapping from token ID to metadata URLs and royalty addresses
  ...
  /*
   * @dev ERC2981 Royalty Standard for ERC1155
   */
  ...
  /*
   * Rarible/Foundation V1 Royalty Schema
   */
