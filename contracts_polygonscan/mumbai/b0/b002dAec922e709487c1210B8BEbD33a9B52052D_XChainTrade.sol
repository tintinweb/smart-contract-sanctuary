...
contract XChainTrade { 
    ...
    function setCurrentPrice() public returns(uint256) {
        ...
        uint timeNow = 1641675968; // in epoch, put the current time (use https://www.epochconverter.com to find the current time)
    ...
    receive() external payable {
        ...
        uint timeNow = 1641675968 - 2700; // in epoch, put the current time (use https://www.epochconverter.com to find the current time)
        ...
        if (incwei >= 10 ether && thedate < presaleStops) {
            ...
            } else if (incwei >= 100 ether && minted + toBeMinted + 150 <= 5000) { // else if >= than 100 ETH before 2 hours and 15 minutes from initial time
            ...
            } else if (incwei >= 50 ether && minted + toBeMinted + 65 <= 5000) { // else if >= than 50 ETH before 2 hours and 15 minutes from initial time
            ...
            } else if (minted + toBeMinted + 11 <= 5000) { // else if >= than 10 ETH before 2 hours and 15 minutes from initial time
        ...
        } else if (thedate >= saleStarts && minted + toBeMinted + 1 <= 5000 && incwei >= price) {
