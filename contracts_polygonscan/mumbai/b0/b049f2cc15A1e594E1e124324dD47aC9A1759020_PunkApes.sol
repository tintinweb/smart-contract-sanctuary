...
contract PunkApes is ERC721Enumerable, Ownable, RandomlyAssigned {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost1 = 10000000000000000;
    uint256 public cost2 = 20000000000000000;
    uint256 public initialSaleTokens = 500;
    ...
    function setinitalSaleTokens(uint256 _newInitalSaleTokens) public onlyOwner {
        initialSaleTokens = _newInitalSaleTokens;
    }
    ...
    function public_pause(bool _state) public onlyOwner {
        public_paused = _state;
    }
