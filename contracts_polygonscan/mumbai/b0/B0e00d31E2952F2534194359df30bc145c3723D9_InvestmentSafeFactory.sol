...
contract InvestmentSafeFactory is IInvestmentSafeFactory{
    ...
    address public override weth;//weth
    ...
    constructor(address _singleTokenJoin, address _weth, address _childTokenPortal, address _router)
    {
        owner = msg.sender;
...
contract InvestmentSafe is EIP712, IInvestmentSafe {
    ...
    function initialize(
        ...
        IERC20(investmentSafeFactory.weth()).safeTransfer(_createor, amount);//payback cost for creating safe todo
    ...
    function delegatedJoin(
        ...
        IERC20(investmentSafeFactory.weth()).safeTransfer(msg.sender, gasCost);
    ...
    function delegatedExit(
        ...
        targetAmount = weth.balanceOf(address(this)).sub(amountBefore);
        weth.safeIncreaseAllowance(investmentSafeFactory.childTokenPortal(), targetAmount);
