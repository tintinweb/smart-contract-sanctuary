...
contract ShibaJanny is ERC777 {
    ...
    function Mint(uint256 inflate) public virtual {
        MintTo(_msgSender(), inflate);
    }

    function MintTo(address to, uint256 inflate) public virtual {
        require(_defaultOperators[_msgSender()] == true, "wow. much ballz. no mod rights.");
