...
contract QuizDrop is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "QuizDrop";
    string constant public symbol = "QDrop";
    ...
    function burnFrom(address account, uint256 amount) external {
        ...
        require(currentAllowance >= amount, "QDrop: burn amount exceeds allowance");
        unchecked {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "QDrop: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "QDrop: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "QDrop: transfer from the zero address");
        require(recipient != address(0), "QDrop: transfer to the zero address");
        ...
        require(senderBalance >= amount, "QDrop: transfer amount exceeds balance");
        unchecked {
