...
contract DegenerateEggs is Ownable, ERC721 {
    ...
    uint256 public budgetDev1 = 0.01 ether; 
    uint256 public budgetDev2 = 0.01 ether; 
    uint256 public budgetDev3 = 0.01 ether; 
    uint256 public constant MAX_TOKENS=15000;
    uint public constant MAX_PURCHASE = 40; // set 1 to high to avoid some gas
    uint public constant MAX_RESERVE = 200; // set 1 to high to avoid some gas
    ...
    address public Noundles = 0xA467B5D2Fa1b9F5df3a43DE20E5bD3574C7beF88; //fa
    address public LittleLemon = 0x188b94ED031CA15dC73E95D766Cd441F82B680f2; //vi
	address public AlienFrens = 0xAF7688CB6Ad6648CF4940A428067aa5955f47751; //la
	address public Doodles = 0xe69c09d09BD39BF022E2a27398fc0257Efa3a306;	//no
    address public mintpass = 0x831f1dcAf0DB70a59eB22BF2b29c3A0357546759; 
    address public proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    address private constant Dev1 = 0xb96766BE58Df259F071c7d704142D3403c7545C1;
    address private constant Dev2 = 0xc5E1e8c0f56e3484D3c032F731de05048ee05D70;
    address private constant Dev3 = 0xc831267B231f678c65B7872b7A3587307ABC1cD0; 
    address private constant VAULT = 0xDef03275C570BC584d88E666493Fa0aA46aDf0d3; 
    
    event priceChange(address _by, uint256 price);
    event PaymentReleased(address to, uint256 amount);
    
    constructor() ERC721("Degenerate Eggs", "DEGG") {
        _baseTokenURI = ""; 
    ...
    */
    function setLittleLemonPass(address newAddress) external onlyOwner {
         LittleLemon = newAddress;
    }
	/**    
    * Set mintPass contract address
    */
    function setAlienFrensPass(address newAddress) external onlyOwner {
         AlienFrens = newAddress;
    }
    /**
    * Set mintPass contract address
    */
    function setDoodlesPass(address newAddress) external onlyOwner {
         Doodles = newAddress;
    }
    ...
    * Set mintPass contract address
    */
    function setNoundlesPass(address newAddress) external onlyOwner {
         Noundles = newAddress;
    }
    /**     
    * Set price 
    */
    ...
    function hasMintPass(address sender) public view returns (bool){
        if(sender==address(0)){
            ...
            return true;
        } else if (IERC721(Noundles).balanceOf(sender)>0){
            return true;
		} else if (IERC721(AlienFrens).balanceOf(sender)>0){
            return true;
		} else if (IERC721(Doodles).balanceOf(sender)>0){
            return true;
        } else if (IERC721(LittleLemon).balanceOf(sender)>0){
            return true;
        }
        return false;
    }
