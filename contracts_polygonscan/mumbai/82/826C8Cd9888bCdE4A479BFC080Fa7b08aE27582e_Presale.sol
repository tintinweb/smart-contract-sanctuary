...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    uint256 public endICO = 1657278355;
    // uint public minPurchase = 1000000000000000000000;
    // uint public maxPurchase = 5000000000000000000000;
    uint public minPurchase = 1000000000000000000;
    uint public maxPurchase = 1400000000000000000;
    uint public hardCap;
    uint public softCap;
    uint public availableTokensICO = 175000000000000000000000;
    uint256 public _rewardTokenCount = 3.31 ether; // 3.31 tokens per MATIC
    ...
    constructor (address payable wallet, IERC20 token, uint256 tokenDecimals) public {
    ...
    function buyTokens(address beneficiary) public nonReentrant icoActive payable {
        ...
        // uint256 reward = _rewardTokenCount.mul(1e18); 
        // uint256 purchasedReward = msg.value.mul(reward);
        // uint256 purchasedReward = tokens.mul(_rewardTokenCount);
    ...
    function getDistrubutedWallets(address beneficiary) public view returns(uint256 amount) {
