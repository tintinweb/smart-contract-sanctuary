...
contract NFTPlayToEarnGame is EIP712MetaTransaction {
    ...
    constructor(string memory name, string memory version, address _weth, address _liquidityPoolManager, address _nftAddress) EIP712MetaTransaction(name, version) {
        WETH = _weth;
    ...
    function endGame(uint256 _gameId, address _winner, bool onEthereum) public onlyAdmin {
        ...
        if (onEthereum) {
            ...
            IERC20(WETH).transfer(games[_gameId].creator, ownerMoney);
