...
contract Tslo is VRFConsumerBase {
    ...
    mapping(bytes32 => Bet) public requestIdToBet;
     ...
     * Requests randomness
     */
    function getRandomNumber(address _from,uint256 _bet) public returns (bytes32 requestId) {
        address userAddress;
        ...
        requestIdToBet[requestId] = Bet(userAddress,_bet);
        return requestId;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        emit RandomReceived(requestId,randomness,number);
        Bet memory _bet = requestIdToBet[requestId];
...
//    }
    ...
    event RandomReceived( bytes32 requestId, uint256 randomness, uint256 number );
