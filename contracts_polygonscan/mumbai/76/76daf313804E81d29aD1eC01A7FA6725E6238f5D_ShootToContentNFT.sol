...
contract ShootToContentNFT is ERC721Enumerable, AccessControl {
    ...
    //string
    string private _contractURI = "https://shoot.to/cm/";
    ...
    function mint(uint256 tokenId, string memory _tokenURI) public {
     ...
     function mintTo(uint256 tokenId, string memory _tokenURI, address mintToAddress) public {
        require(hasRole(MINTER_ROLE, msg.sender), "Caller is not a minter");
        require(started, "not started");
