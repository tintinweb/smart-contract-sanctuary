...
def fxbuy(withdraw: uint256) -> bool:
    ...
    self.user_interest_claimed[msg.sender] = ERC20(self).balanceOf(msg.sender) * self.accumulatedRewardPerShare
    log Bugger(self.accumulatedRewardPerShare, 'rewardPerShare')
...
def fxsell(withdraw: uint256) -> bool:
    ...
    usd_amount_plus_interest: uint256 = usd_amount + (interest_on_amount / 10**12)
