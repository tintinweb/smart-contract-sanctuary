...
contract Borgs is ERC721Enumerable, Ownable, ContractStates, CommonObjects, NumberUtils{
    ...
    // A whitelist for generation/breeding fee
    mapping (address => bool) private _costExemptWhitlist;
    ...
    uint256 public BREED_COST = 5000000000000000000;
    uint256 public GENERATION_COST = 10000000000000000000;
    ...
    function updateWhitelist(address whiteListAddress, bool whitelistState) public onlyOwner{
        _costExemptWhitlist[whiteListAddress] = whitelistState;
    }
    
    function isAddressWhitelisted(address addressToCheck) public view onlyOwner returns(bool){
        return _costExemptWhitlist[addressToCheck];
    }
    ...
    function generateBorg() external payable usable returns(uint256){
        ...
        require(msg.value == GENERATION_COST || _costExemptWhitlist[msg.sender], "Value needs to equal generation cost");
    ...
    function breedBorgs(uint256 borgId1, uint256 borgId2) external payable usable returns(uint256){
        ...
        require(msg.value == BREED_COST || _costExemptWhitlist[msg.sender], "Value needs to equal breeding cost");
