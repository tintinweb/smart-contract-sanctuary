...
contract Artifact is ERC721Enumerable, Ownable{
    ...
    function mint(uint256 _amount)public payable maxNftPerAddress(_amount){
        ...
        require(amountMinted + _amount <= maxSupply, "Exceeded max supply");
        ...
        for(uint256 i=1; i<= _amount;i++){
            ...
            freeMintsPerArtifact[id] = 1;
            artifactURI[id] = baseURI;
    ...
    function burnArtifact(uint256 tokenId, address _senderAddress) external{
