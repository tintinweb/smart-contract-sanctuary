...
// File: gogo-contracts/contracts/staking/orionmoney/ISaver.sol
...
// File: gogo-contracts/contracts/staking/orionmoney/StakeOrion.sol
...
contract StakeOrion {
	...
	function _interest() internal view returns (uint256) {
		...
		uint256 pow = decimals - 6;

		return (interest / 10**pow) * 10**pow;
	}
...
// File: gogo-contracts/contracts/staking/orionmoney/StakeOrionManager.sol
	...
	RewardsDistributionRecipient
{
	...
	constructor(
		address _stakingToken,
		uint256 _decimals, // only assets with 3,6,9,12,15,18 decimals
