...
contract NEW is Context, IBEP20, Ownable {
    ...
    constructor() {
        ...
        dev1 = payable(0xc8eF939e866d0686fA4ba6711f7c0cCB3CBbcc78);
        dev2 = payable(0xC2CA36b800DE71dBc246b07039a42ed3E75D2605);
        dev3 = payable(0x6C327db008899FE169988439a0ABfe70b72B80fA);
        game1Reward = payable(0x03387130BAdaCCB4f4664fcf886b7a9d70E804B0);
        game2Reward = payable(0xe8527846778Bc603956b087AAA164CD36fcbeB9F);
        marketWallet = payable(0x60ACbca99dbb2Cc4A07bF3eE59B62Fd9888dF0DB);
        communityReward = payable(0xa3968Fba9D45D52b6b978f575934364ac2d5774c);
        tokenFundWallet = payable(0x5F05Bd1007189C328D2C52281Ea622d81CB50A33);

        // Polygon router
        IDexRouter _dexRouter = IDexRouter(0x8954AfA98594b838bda56FE4C12a09D7739D179b);
