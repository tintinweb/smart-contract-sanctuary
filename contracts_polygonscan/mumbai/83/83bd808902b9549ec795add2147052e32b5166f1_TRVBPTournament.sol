...
contract TRVBPTournament is TRVBPWarrior, AdminControl, ReentrancyGuard {
  ...
  function joinTournament(
    ...
    TRVBPWarrior.updateJoinedStatistic(_tournamentId, _warriorId, CLASSES(class) == CLASSES.BLOODING);
  ...
  function setWinner(
    ...
    uint256 totalPrize = tournamentInfo.prize_pool;

    uint256 bestPrize = (totalPrize * 700) / 1000;
    ...
    platformShare += (tournamentInfo.prize_pool - bestPrize - secondPrize);
  ...
  // verified
  function getTournaments(uint256 _start, uint256 _end) public view returns (TournamentInfo[] memory, uint256[] memory, uint256[] memory, uint256[] memory) {
  ...
  function getTournamentConfigs(uint256 _start, uint256 _end) public view returns (uint256[] memory, uint256[] memory, uint256[] memory) {
    uint256 size = _end - _start + 1;
    uint256[] memory sizeList = new uint256[](size);
    uint256[] memory feeList = new uint256[](size);
    uint256[] memory classList = new uint256[](size);
...
contract TRVBPWarrior {
  ...
  function (uint256, uint256, uint256, uint256, uint256) internal pure returns (bool)[5] classGuards = [
    Guard.blooding,
    Guard.class3,
    Guard.class2,
    Guard.class1,
  ...
  function updateJoinedStatistic(uint256 _tournamentId, uint256 _warriorId, bool _isBloodingClass) internal {
    warriorRecords[_warriorId].records.addValue(_tournamentId);
    warriorRecords[_warriorId].fightingCount++; // increase fighting count
    if (_isBloodingClass) {
      warriorRecords[_warriorId].bloodingCount++;
    }
  }
...
library Guard {
  function blooding(uint256, uint256, uint256, uint256, uint256 _wins) internal pure returns (bool) {
    return _wins == 0;
  }

  function class3(uint256 _foughtCount, uint256 _points, uint256, uint256 _bloodingWins, uint256) internal pure returns (bool) {
    return (_foughtCount >= 5 || _bloodingWins >= 1) && (_points < 80);
  }

  function class2(uint256 _foughtCount, uint256 _points, uint256, uint256 _bloodingWins, uint256) internal pure returns (bool) {
    return (_foughtCount >= 5 || _bloodingWins >= 1) && (_points >= 80 && _points <= 100);
  }

  function class1(uint256 _foughtCount, uint256 _points, uint256, uint256 _bloodingWins, uint256) internal pure returns (bool) {
    return (_foughtCount >= 5 || _bloodingWins >= 1) && (_points > 100);
  }

  function bloodbath(uint256, uint256, uint256 _bloodingCount, uint256 _bloodingWins, uint256) internal pure returns (bool) {
