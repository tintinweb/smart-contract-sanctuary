...
contract SwapRouter is ISwapRouter {
    ...
    function _addLiquidity(
        ...
        if (ISwapPool(factory).getPair(tokenA, tokenB) == address(0)) {
            ISwapPool(factory).createPair(tokenA, tokenB);
        }
...
//            ISwapPair pair = ISwapPair(UniswapV2Library.pairFor(factory, input, output));
//            uint amountInput;
//            uint amountOutput;
