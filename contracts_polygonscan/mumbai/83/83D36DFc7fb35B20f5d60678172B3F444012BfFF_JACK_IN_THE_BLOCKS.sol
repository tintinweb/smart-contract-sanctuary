...
contract JACK_IN_THE_BLOCKS is ERC721, ERC721Enumerable, Ownable {
  ...
  address PUNK_EVOLVE_ADDRESS = 0xB2c12636a1601B3320190dde46CFb23BC46A25EF;//0xD28c830DED2C84304Fd576F91AE3a78fDc981d27;
  ...
  function mint(uint8 amount) external payable {
    ...
    require(
      msg.value * amount == getDiscountPrice(msg.sender),
