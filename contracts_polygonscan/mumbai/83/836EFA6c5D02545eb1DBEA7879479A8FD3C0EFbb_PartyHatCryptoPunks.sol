...
contract PartyHatCryptoPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Party Hat Crypto Punks", "PHCP") {
    setHiddenMetadataUri("ipfs://QmURQNRtjMzGWYbiu1n5q4iv98K9GrhvkZ69nuEQKWBy2n/Hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x641A72c0Dcb55fcc0ffdD3e5D8eBb7134ffCFB07).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
