...
contract ScaleCapacity is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable {
    ...
    function setupMinterRole() public onlyRole(DEFAULT_ADMIN_ROLE){
        _setupRole(MINTER_ROLE, msg.sender);
    }

    function setupAdminRole() public onlyRole(DEFAULT_ADMIN_ROLE){
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }
    ...
    function mint(address account, uint256 amount, uint256 tokenId)
        public
        onlyRole(MINTER_ROLE)
    {
        _mint(account, tokenId, amount, "");
    ...
    function mintBatch(address to, uint256[] memory amounts, bytes[] memory uri)
        public
        onlyRole(MINTER_ROLE)
    {
