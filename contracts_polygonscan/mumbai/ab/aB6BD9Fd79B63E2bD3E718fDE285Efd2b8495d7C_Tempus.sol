...
contract Tempus is ERC20, Ownable {
    ...
    function aa_startHODLWithAffiliate(bool useAffiliateCode, address affiliateAddress) public returns(bool) {
    ...
    function a_stopHODL() public returns(bool) {
    ...
    function processStopHODL(address inAddress) private {
        ...
        if(interestReward > 0) {
            this.transferFrom(interestRewardPaymentAddress, address(this), totalReward);
            this.transfer(inAddress, totalReward);
        }
