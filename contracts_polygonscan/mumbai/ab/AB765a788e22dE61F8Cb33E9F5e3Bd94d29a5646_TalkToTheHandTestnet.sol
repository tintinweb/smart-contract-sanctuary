...
contract TalkToTheHandTestnet is ERC721Enumerable, Ownable {
    ...
    function getAllowance2() public view returns(uint256){
        return wethContract.allowance(address(this),msg.sender);
    }
    ...
    function mint(uint256 _mintAmount) public {
        ...
        require(wethContract.allowance(address(this),msg.sender) >= price, "Incorrect allowance");
