...
import "./KiBridgeV1LiquidityA2.sol";

contract KiBridgeV1LiquidityFactoryAm {
  using SafeERC20 for IERC20;

  struct LiquidityInfoA {
  ...
  mapping(IERC20 => LiquidityInfoA) private liquidityInfo;
    ...
    returns (address liquidity)
  {
    ...
    liquidity = address(new KiBridgeV1LiquidityA2{salt: keccak256(abi.encode(_token))}());
    ...
    external
  {
    ...
    KiBridgeV1LiquidityA2(getLiquidity[_token]).mint(msg.sender, _amount);
  }
}
