...
contract FearPlayToEarn is AccessControl, Pausable, ReentrancyGuard, EmergencyWithdrawer, ERC1155Holder {
    ...
    */
    ...
    function setStakeLockPeriodInMinutes(uint16 _minutes) external onlyRole(DEFAULT_ADMIN_ROLE) {
        stakeLockPeriod = _minutes * (1 minutes);
        emit StakeLockPeriodChanged(_minutes / 1440);
    }
