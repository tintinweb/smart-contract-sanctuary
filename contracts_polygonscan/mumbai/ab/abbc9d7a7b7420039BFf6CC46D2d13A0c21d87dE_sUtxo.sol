...
// TODO: une Klima DAO manager/owner model
interface IOwnable {
...
contract sUtxo is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked UTXO", "sUTXO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sUTXO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sUTXO
