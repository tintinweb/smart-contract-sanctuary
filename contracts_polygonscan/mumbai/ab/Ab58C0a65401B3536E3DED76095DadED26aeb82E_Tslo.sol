...
contract Tslo {
    ...
    function getRandomNumber(address _from, uint256 _bet, string memory _serverSeed, string memory _clientSeed) public {
        ...
        _credits[userAddress] -= _bet * 10 ** 18;
        ...
        uint256 win = checkWinOrLost(reelsValues);
        fulfillRandomness(_clientSeed, win);
        //return requestId;
    }


    function checkWinOrLost(uint256[3][3] memory reelsSymbols) private pure returns(uint256){

        uint256 win = 0;
        if(reelsSymbols[0][0]==68 && reelsSymbols[1][0]==68 && reelsSymbols[2][0]==68) { win += 5000; }
        else if((reelsSymbols[0][0]==72 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==72 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==72 || reelsSymbols[2][0]==68)) { win += 700; }
        else if((reelsSymbols[0][0]==66 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==66 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==66 || reelsSymbols[2][0]==68)) { win += 600; }
        else if((reelsSymbols[0][0]==51 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==51 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==51 || reelsSymbols[2][0]==68)) { win += 500; }
        else if((reelsSymbols[0][0]==50 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==50 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==50 || reelsSymbols[2][0]==68)) { win += 400; }
        else if((reelsSymbols[0][0]==49 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==49 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==49 || reelsSymbols[2][0]==68)) { win += 300; }
        else if((reelsSymbols[0][0]==67 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==67 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==67 || reelsSymbols[2][0]==68)) { win += 100; }
        else if((reelsSymbols[0][0]==71 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==71 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==71 || reelsSymbols[2][0]==68)) { win += 80; }
        else if((reelsSymbols[0][0]==76 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==76 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==76 || reelsSymbols[2][0]==68)) { win += 70; }
        else if((reelsSymbols[0][0]==79 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==79 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==79 || reelsSymbols[2][0]==68)) { win += 60; }
        else if((reelsSymbols[0][0]==87 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==87 || reelsSymbols[1][0]==68) && (reelsSymbols[2][0]==87 || reelsSymbols[2][0]==68)) { win += 50; }

        else if((reelsSymbols[0][0]==67 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==67 || reelsSymbols[1][0]==68)) { win += 16; }
        else if((reelsSymbols[0][0]==71 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==71 || reelsSymbols[1][0]==68)) { win += 14; }
        else if((reelsSymbols[0][0]==76 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==76 || reelsSymbols[1][0]==68)) { win += 12; }
        else if((reelsSymbols[0][0]==79 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==79 || reelsSymbols[1][0]==68)) { win += 8; }
        else if((reelsSymbols[0][0]==87 || reelsSymbols[0][0]==68) && (reelsSymbols[1][0]==87 || reelsSymbols[1][0]==68)) { win += 10; }
     ...
     */
    function fulfillRandomness(string memory _clientSeed, uint256 win) internal {
        //uint256 number = (randomness % 5) + 1;
        emit RandomReceived(_clientSeed, win);
        ...
        _credits[_bet._wallet] += win * _bet._betAmount * 10 ** 18;
    }
