...
contract drop1 {
    ...
    function aBirth1() external returns(uint256){
        return _setAxie();
    }
    
    function aBirth3() external returns(uint256,uint256,uint256){
        uint256 axie1 = _setAxie();
        uint256 axie2 = _setAxie();
        uint256 axie3 = _setAxie();
        return(axie1,axie2,axie3);
    }
    
    function aBirth5() external returns(uint256,uint256,uint256,uint256,uint256){
        uint256 axie1 = _setAxie();
        uint256 axie2 = _setAxie();
        uint256 axie3 = _setAxie();
        uint256 axie4 = _setAxie();
        uint256 axie5 = _setAxie();
        return(axie1,axie2,axie3,axie4,axie5);
    }
    
    function ABirth10() external{
    ...
    function _setAxie() public returns (uint256) {
        ...
        for(uint256 helix=0; helix<=42; helix++){
            ...
            if(helix >= 24 && helix <=42){               // Class (D,R1,R2) - 6 elements
