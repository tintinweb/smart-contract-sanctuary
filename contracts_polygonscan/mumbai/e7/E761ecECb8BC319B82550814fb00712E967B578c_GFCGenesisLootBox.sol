...
contract GFCMysteryItem is ERC1155Pausable, Ownable, Whitelist {
    ...
    constructor(string memory path) ERC1155(path){
      ...
      //25% chance to get the battle pass
      //75% chance to get the cosmetic item
      PROBs = [25, 75];
    }
...
contract GFCGenesisWeapon is ERC1155Burnable, Ownable, Whitelist {
    ...
    constructor(string memory path) ERC1155(path){
      ...
      meleeWeaponCount =    [0, 3, 1, 2, 2, 1];
      rangedWeaponCount =   [0, 2, 4, 9, 5, 6];
    }
...
contract GFCGenesisLootBox is Ownable, Whitelist, VRFConsumerBase{
        ...
        ) 
    {
        ...
        genesisKey = GFCGenesisKeyPoly(address(0x87A3D7c4730b77cBe59084c39710046Ee3b22B2a));
        genesisWeapon = GFCGenesisWeapon(address(0x3a430cef1e2c292FE718146512508e88bC9E3930));
        byoPill = BYOPillGFC(address(0x4A7058a0611f166150028C1D2D2F26F64322a42c));
        mysteryItem = GFCMysteryItem(address(0x4Bd15b4562DE910B3bCf536A74A17558e2Aa32Ae));
