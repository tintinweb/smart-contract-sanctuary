 ...
 */
contract MUNE is ERC20Permit, Pausable, SimpleGovernance {
    ...
    /**
     * @notice Initializes MUNE token with specified governance address and recipients. For vesting
    ...
    ) public ERC20("Mune DAO", "MUNE") ERC20Permit("Mune DAO") {
        require(governance_ != address(0), "MUNE: governance cannot be empty");
        require(
            vestingContractTarget_ != address(0),
            "MUNE: vesting contract target cannot be empty"
        );
        require(
            pausePeriod_ > 0 && pausePeriod_ <= 52 weeks,
            "MUNE: pausePeriod must be in between 0 and 52 weeks"
        );
        ...
        returns (address)
    {
        require(
            ...
            "MUNE: duration for vesting cannot be 0"
        );
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused() || allowedTransferee[from], "MUNE: paused");
        require(to != address(this), "MUNE: invalid recipient");
    }
    ...
    function rescueTokens(
        ...
        require(to != address(0), "MUNE: invalid recipient");
        ...
        if (token == IERC20(address(0))) {
            ...
            require(balance > 0, "MUNE: trying to send 0 ETH");
            // slither-disable-next-line arbitrary-send
            (bool success, ) = to.call{value: balance}("");
            require(success, "MUNE: ETH transfer failed");
        } else {
            // any other erc20
            ...
            balance = balance == 0
                ? totalBalance
                : Math.min(totalBalance, balance);
            require(balance > 0, "MUNE: trying to send 0 balance");
