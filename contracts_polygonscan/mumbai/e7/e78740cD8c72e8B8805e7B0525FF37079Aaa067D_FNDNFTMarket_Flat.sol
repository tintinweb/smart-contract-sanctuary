    ...
    NFTMarketAuction
{
    ...
    function createReserveAuction(
        ...
        require(stateDate > block.timestamp && endDate > stateDate + EXTENSION_DURATION, "NFTMarketReserveAuction: endDate must be > stateDate + 24 hours ");
    ...
    function placeBid(uint256 auctionId) public payable nonReentrant {
        ...
        // if (auction.startTime + auction.extensionDuration  - block.timestamp < auction.extensionDuration) {
        //     auction.endTime = auction.endTime + auction.extensionDuration;
        // }
