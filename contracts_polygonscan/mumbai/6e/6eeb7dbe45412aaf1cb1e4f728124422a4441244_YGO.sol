...
contract YGO is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    uint256 public constant MAX_NFT = 85;
    ...
    event CreateYgo(uint256 indexed id);
	
    constructor(string memory baseURI, address payable creator) ERC721("YuGiOhTazonft", "ygo") {
        setBaseURI(baseURI);
