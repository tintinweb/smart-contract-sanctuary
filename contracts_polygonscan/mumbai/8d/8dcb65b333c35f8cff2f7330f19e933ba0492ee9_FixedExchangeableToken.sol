...
contract FixedExchangeableToken is Context, IERC20, Ownable {
  ...
  address public desired_token = 0xfe4F5145f6e09952a5ba9e956ED0C25e3Fa4c7F1;
  ...
  constructor() {
    _name = "Bulgarian lev Token test2";
    _symbol = "BGNTt2";
    _decimals = 18;
  ...
  {
      IERC20(desired_token).transferFrom(msg.sender, address(this), _amount);
      _mint(msg.sender, _amount * rate / 10000);
  }
  
  function withdrawBaseToken(uint256 _amount) external
  {
      _burn(msg.sender, _amount * rate / 10000);
      IERC20(desired_token).transfer(msg.sender, _amount);
  }
