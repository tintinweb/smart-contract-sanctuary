...
/**
 * @title CloudoxHippe
 * CloudoxHippe - a contract for Creature Accessory semi-fungible tokens.
 */
contract CloudoxHippe is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) ERC1155Tradable("MTEST Apes.4", "SA", "https://makechia.com/copy_space_apes/Api/metadata/{id}", _proxyRegistryAddress) {}

    // "http://opensea-creatures-api.herokuapp.com/api/creature/{id}"
    ...
    function contractURI() public pure returns (string memory) {
        ...
        // "http://opensea-creatures-api.herokuapp.com/api/creature/{id}"
        // https://makechia.com/copy_space_apes/Api/metadata?token=contract
        // http://q01.cloudox.net/copy_space_apes/metadata/contract
...
contract ERC1155Tradable is ContextMixin, ERC1155, NativeMetaTransaction, Ownable {
  ...
  // function freeMint(uint256 _id) public {
  ...
  // function payMint(uint256 _id) public payable {
  //   require(!_exists(_id), "token _id already exists");
