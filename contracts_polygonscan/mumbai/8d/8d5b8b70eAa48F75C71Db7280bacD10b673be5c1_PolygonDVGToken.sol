...
// File: contracts/PolygonDVGToken.sol
...
contract PolygonDVGToken is BaseERC20("DVGToken", "DVG") {
    using Address for address;
    using SafeMath for uint256;
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        bool isSuccess = _transfer(_to, _value);
    ...
    function transferFrom(
        ...
        bool isSuccess = _transferFrom(_from, _to, _value);
