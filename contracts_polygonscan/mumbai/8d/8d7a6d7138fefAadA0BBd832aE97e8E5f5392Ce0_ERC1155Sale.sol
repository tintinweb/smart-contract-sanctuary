...
contract ERC1155Sale is AccessProtected, Pausable, ERC1155Receiver {
    ...
    constructor(IERC1155 _nft) public {
    ...
    function buy(uint256 _saleId) external payable saleExists(_saleId) isActive(_saleId) whenNotPaused {
        Sale memory sale = sales[_saleId];
        require(msg.value == sale.price, "msg.value != sale price");
        sales[_saleId].isActive = false;
    ...
    function withdrawNFT(uint256 _tokenId, uint256 _amount) external onlyOwner {
        nft.safeTransferFrom(address(this), owner(), _tokenId, _amount, "");
    }
