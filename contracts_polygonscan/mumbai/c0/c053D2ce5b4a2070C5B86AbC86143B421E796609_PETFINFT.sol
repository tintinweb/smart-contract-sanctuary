...
contract PETFINFT is ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    uint256 public MINT_PRICE = 750 ether; // 750 matic equals to 0.05 ETH
    ...
    address public adminAddress = 0x144F8264c7415108855290524f67a55073DE3Be8;
    string public baseExtension = ".json";
    bool public revealed = false;
    string public notRevealedUri;
    event CreatePetFiMetaverse(uint256 indexed id);

    constructor(string memory BaseURL) ERC721("PetFi NFT Test", "$PFT") {
        setBaseURI(BaseURL);
        pause(true);
    }
