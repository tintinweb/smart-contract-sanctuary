...
contract PuzzleCard is ERC1155, Ownable, ContextMixin, NativeMetaTransaction {
    ...
    constructor(address proxyRegistryAddress) ERC1155("") {
        ...
        CONTRACT_METADATA_URI = "https://ad2b-2a02-6b6c-a0-0-e482-244-229b-d91d.ngrok.io/public/metadata_api/contract.json";

        _setURI("https://ad2b-2a02-6b6c-a0-0-e482-244-229b-d91d.ngrok.io/public/metadata_api/{id}.json");
