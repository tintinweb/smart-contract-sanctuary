...
WithLimitedSupply
{
    ...
    mapping(address => uint8) private mintCount;
    uint256 private salePrice = 0.2 ether;

    constructor()
    ERC721("My Test Token", "MYNFT")
    WithContractMetaData("")
    WithLimitedSupply(1337)
    {}
    ...
    whenNotPaused
    {
        ...
        require(
            _mintAmount + mintCount[msg.sender] <= mintMax,
            string(abi.encodePacked("Cannot mint more than ", Strings.toString(mintMax)))
        );
        require(
