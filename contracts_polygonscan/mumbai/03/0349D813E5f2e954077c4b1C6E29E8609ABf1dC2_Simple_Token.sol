...
/**
*ُ NextGreatFact- NGF - verification applied 2021
*/
...
contract Simple_Token {
    ...
    uint256 public unitsOneEthCanBuy = 1177700;     // How many units of your coin can be bought by 1 ETH?
...
contract Advanced_Token is owned, Simple_Token {
    ...
    /* Initializes contract with initial supply tokens to the creator of the contract */
    function Advanced_Token(
        uint256 initialSupply,
        string tokenName,
        string tokenSymbol
    ) Simple_Token (initialSupply, tokenName, tokenSymbol) public {}
