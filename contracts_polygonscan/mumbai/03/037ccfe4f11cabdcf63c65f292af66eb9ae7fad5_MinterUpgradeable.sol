...
contract MinterUpgradeable is ERC1271, OwnableUpgradeable, ERC165Upgradeable, IMinterUpgradeable {
    ...
    function __MinterUpgradable_init (address _minter, uint96 _fee) public initializer {
        ...
        setData(_minter, _fee);
    } 

    function setData(address _minter, uint96 _fee) public override onlyOwner {
        minter = _minter;
        fee = _fee;
    }
...
interface IMinterUpgradeable {
    function setData(address _minter, uint96 _fee) external;
