    ...
    ReentrancyGuardUpgradeable
{
    ...
    struct BridgePair {
        ...
        uint256 _suspendedBlock; // 0 - Not Suspended, anynumber - Suspended
    ...
    event BridgePairUpdated(
        address oldHomeERC20,
        address newHomeERC20,
        address oldForeignERC20,
        address newForeignERC20,
        uint256 updatedAt,
        address updatedBy
    );
        ...
        nonReentrant
    {
        ...
        if (
            ...
            if (bridgePairs[_homeERC20]._suspendedBlock != 0) {
                revert("CreateBridgePair:: Bridge Pair suspended");
            } else {
                revert("CreateBridgePair:: Duplicate Bridge Pair");
            }
        }
    ...
    function updateBridgePair(address _homeERC20, address _foreignERC20)
        external
        onlyGovernance
    {
        address oldHomeERC20 = bridgePairs[_homeERC20]._homeERC20;
        address oldForeignERC20 = bridgePairs[_homeERC20]._foreignERC20;
        address newHomeERC20 = _homeERC20;
        address newForeignERC20 = _foreignERC20;
        bridgePairs[_homeERC20]._homeERC20 = _homeERC20;
        bridgePairs[_homeERC20]._foreignERC20 = _foreignERC20;
        emit BridgePairUpdated(
            oldHomeERC20,
            newHomeERC20,
            oldForeignERC20,
            newForeignERC20,
...
contract BridgeTreasury is Context, AccessControl {
    ...
    function withdraw(
        ...
        require(
            ...
            "Treasury:: Unauthorized Access, Only Bridge allowed to withdraw"
        );
