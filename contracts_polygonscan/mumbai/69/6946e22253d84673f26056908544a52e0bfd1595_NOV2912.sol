...
contract NOV2912 is Ownable, ERC721Enumerable, ReentrancyGuard {
  using Counters for Counters.Counter;
  using Strings for uint256;

  bool public saleIsActive = false;
  uint256 private _price = 1 ether;
  uint256 public maxNFT = 10;

  constructor() ERC721("NOV2912", "NOV2912") {}


    function mintordie() public payable nonReentrant() {

        uint256 totalSupply = totalSupply();
        require(totalSupply + 1 <= maxNFT, "There aren't this many punks left.");
