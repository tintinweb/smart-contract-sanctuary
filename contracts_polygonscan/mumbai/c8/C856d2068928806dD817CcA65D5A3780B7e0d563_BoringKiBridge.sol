...
contract BoringKiBridge {
  ...
  function test(address _add) public returns(bool bb, bytes memory tt) {
    (bb, tt) = address(0x965786eEc0deE10042fAa92a06A57D5543ccF023).call(
      abi.encodeWithSelector(
      this.userInfo.selector,
      _add));
  }
