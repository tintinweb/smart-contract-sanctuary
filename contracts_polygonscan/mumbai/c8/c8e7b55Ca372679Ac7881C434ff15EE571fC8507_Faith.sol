...
contract Faith is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Faith", "FAITH", 9) ERC20Permit() {
    ...
    /**
        @notice increases Faith supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Faith
