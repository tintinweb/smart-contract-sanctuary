...
contract MessageInABottle is FxBaseChildTunnel, Ownable, ERC721URIStorage {
    ...
    constructor(address _beginUilityTokenAddress, address _daoAddress, uint256 _initialPrice, string memory _initURIPrefix, address _fxChild)
    ...
    function _processMessageFromRoot(
        ...
        string memory uri = string(data.slice(20, data.length-20));
    ...
    function sendMessage2(
        ...
        bytes memory data)
    external {
        _processMessageFromRoot(blah, sender, data);
    }
