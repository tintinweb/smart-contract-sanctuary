...
contract NFTMarket is ReentrancyGuard, Ownable {
    ...
    modifier notListed(
        ...
        require(listing.pricePerItem == 0, "already listed"); //todo: need to check pricePerItem
        _;
    }
    ...
    modifier isListed(
        ...
        Listing memory listing = listings[_nftAddress][_tokenId][_owner];
        require(listing.pricePerItem > 0, "not listed item");
        _;
    }
    ...
    {
        Listing memory listedItem = listings[_nftAddress][_tokenId][_owner];
        _buyItem(_nftAddress, _tokenId, _owner, msg.value);
    }
    ...
    function _buyItem(
        ...
        uint256 price = listedItem.pricePerItem;
        require(_amount == price, "wrong price");
        ...
        (bool sent, ) = payable(_owner).call{value: price}("");
