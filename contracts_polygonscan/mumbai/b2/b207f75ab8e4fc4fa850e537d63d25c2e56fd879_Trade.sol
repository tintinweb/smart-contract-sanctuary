...
contract Trade {
    ...
    constructor (uint8 _buyerFee, uint8 _sellerFee, uint8 _buyerFeeForWETH, uint8 _sellerFeeForWETH, TransferProxy _transferProxy, IERC20 _WETH, IERC20 _MFGtoken) {
