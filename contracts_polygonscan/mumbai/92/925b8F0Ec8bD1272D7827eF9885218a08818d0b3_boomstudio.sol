...
contract boomstudio is Context, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    address payable internal devteam = payable(0x2E6CcCa0926328bAFC3a09F958A3392274931bEE); 
    address payable internal seaneen = payable(0x34Be3fF2b771A20B7f74D4Fd08797591ed230d66);
    address payable internal markos = payable(0xc4c746E4783E2eCd4610dC798874a8a765a724C0);
    address payable internal leeroy = payable(0xe7EF791C3a83883b6Fe8162732C802bbd174Df97);
    ...
    /**
    * Can only be called twice. Gives 64 total Tokens to devs for giveaways, marketing purposes and team members.
    ...
    */
    ...
    function withdrawFunds() external virtual {
        ...
        seaneen.transfer(thirdOfHalfBalance);
        markos.transfer(thirdOfHalfBalance);
        leeroy.transfer(thirdOfHalfBalance);
    }
