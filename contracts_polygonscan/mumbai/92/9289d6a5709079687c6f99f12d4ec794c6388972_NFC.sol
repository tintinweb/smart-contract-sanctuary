...
contract NFC is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
	...
	uint256 public PRESALE_PRICE = 780 * 10**18;
	uint256 public SALE_PRICE = 780 * 10**18;
    ...
    constructor(string memory baseURI) ERC721("Neom Collection", "NFC") {
		setBaseURI(baseURI);
        pause(true);
    }
