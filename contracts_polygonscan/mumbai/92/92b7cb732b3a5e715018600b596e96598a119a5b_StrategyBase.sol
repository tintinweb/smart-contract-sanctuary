...
abstract contract BaseStrategy is Ownable {
    ...
    // Dex
    address public constant currentRouter = 0x6592F1e04B5729A2593d0Eb060E271355d25EbA8; //ApeSwap router
...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant alpha = 0x5e77d17e9D1C487deC7512943Fc249b30c484E67;
    address public constant usdc = 0xCE3Be04552C7Fa67F1dDAea00e9e5765804632B8;
    address public multiHarvest = 0x0000000000000000000000000000000000000000;

    // Other constants
    uint16 public constant underlyingPoolId = 4;
    ...
    // Uniswap swap paths
    address[] public alpha_usdc_path;
    ...
    {
        alpha_usdc_path = new address[](2);
        alpha_usdc_path[0] = alpha;
        alpha_usdc_path[1] = usdc;
    }
    ...
    function set_harvestCutoff(uint256 newCutoff) external onlyOwner() {
        require(newCutoff <= 10**18, "New cutoff must be less than 1 Alpha");
    ...
    function harvest() public override {
        ...
        // Collects ALPHA tokens
        _getReward();

        // //Swap 1/2 ALPHA for USDC
        // uint256 _alphaBalance = IERC20(alpha).balanceOf(address(this));
        // if (_alphaBalance > harvestCutoff){
        //     if (_alphaBalance > 0) {
        //         _swapUniswapWithPath(alpha_usdc_path, _alphaBalance.div(2));
        //     }

        //     // Add liquidity for ALPHA/USDC
        //     uint256 _usdc = IERC20(usdc).balanceOf(address(this));
        //     uint256 _alpha = IERC20(alpha).balanceOf(address(this));
        //     if (_usdc > 0 && _alpha > 0) {
        //         IERC20(usdc).safeApprove(currentRouter, 0);
        //         IERC20(usdc).safeApprove(currentRouter, _usdc);
        //         IERC20(alpha).safeApprove(currentRouter, 0);
        //         IERC20(alpha).safeApprove(currentRouter, _alpha);
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public ALPHA_MASTER_CHEF = 0xa579E939D4FDb1Cce74937B98402BB3ebf8d93cC;
    address public ALPHA_USDC_LP = 0xef0B3E62DCA346E10c8bcc6C2657D5BC64B0f60C;
