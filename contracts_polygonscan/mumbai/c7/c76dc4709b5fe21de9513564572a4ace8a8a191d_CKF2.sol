...
contract CKF2 is ERC721, ERC721Enumerable, Ownable {
	using Strings for uint256;
	...
	constructor(string memory _initBaseURI, address weth_) ERC721("Chicken Franks 2", "CKF2") {
    ...
    function mint(uint256 numberOfTokens) public payable {
		...
		require(balance >= PRICE_PER_TOKEN * numberOfTokens, "Not enough wETH");
		weth.safeTransferFrom(msg.sender, contractAddress, PRICE_PER_TOKEN * numberOfTokens);
