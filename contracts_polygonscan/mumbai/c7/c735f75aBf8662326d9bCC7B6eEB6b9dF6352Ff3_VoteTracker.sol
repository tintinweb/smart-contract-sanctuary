...
contract VoteTracker is EventReceiver, IVoteTracker, Ownable {
    ...
    bytes32 public constant EVENT_BALANCE_CHANGE = "BalanceChange";
    bytes32 public constant EVENT_CYCLE_ROLLOVER = "CycleRollover";
    ...
    function _onEventReceive(address, bytes32 eventType, bytes calldata data) internal override virtual  {
        require(eventType == EVENT_CYCLE_ROLLOVER || eventType == EVENT_BALANCE_CHANGE, "INVALID_EVENT_TYPE");

        if (eventType == EVENT_CYCLE_ROLLOVER) {
        ...
        } else if (eventType == EVENT_BALANCE_CHANGE) {
