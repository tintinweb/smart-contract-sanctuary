...
contract QuizChest is Ownable, Events {
    ...
    function initMemebership() public onlyOwner payable {
    ...
    function setMembership(uint256 level, uint256 Fee, uint256 Multipler) public onlyOwner {
        require(level <= memebershipUnit, "Memebership level exceeds 5");
        require(Fee > 0 && Multipler > 0, "Fee & Multipler should bigger than zero");
    ...
    function lock(address _from, uint256 _level) public returns(bool){
