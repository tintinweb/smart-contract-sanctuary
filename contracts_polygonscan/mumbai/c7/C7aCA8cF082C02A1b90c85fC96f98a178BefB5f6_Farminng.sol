...
contract Farminng is Ownable {
    ...
    // Block number when bonus Binamars period ends.
    ...
    function configFarming(
        ...
        binaTokenPerBlock = _binaTokenPerBlock;
    ...
    // Deposit LP tokens to MasterChef for Binamars allocation.
    ...
    function safeBinaTokenTransfer(address _to, uint256 _amount) internal {
        ...
        if (_amount > binaTokenBal) {
            binaToken.transfer(_to, binaTokenBal);
        } else {
            binaToken.transfer(_to, _amount);
        }
    }
...
contract Binamars is BinamarsManager, ERC721 {
    ...
    function cancelOrder(uint256 _tokenId) public {
        ...
        sellerTokens[_msgSender()].remove(_tokenId);
