...
contract CharacterForIsekai is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public price = 1000000000 gwei; 
    ...
    function getJump(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "jump", jump);
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[13] = getPersonality(tokenId);

        parts[14] = '</text><text x="10" y="160" class="base">';
        
        parts[15] = getTitle(tokenId);
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Character', toString(tokenId), '", "description": "CharacterForIsekai is randomized adventurer character generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to explore Isekai using your Character in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function claim(uint256 tokenId) public payable nonReentrant {
        ...
        require(tokenId > 0 && tokenId < 99888, "Token ID invalid");
        require(balanceOf(_msgSender()) <= 20, "MaxMintPerAddressIs5.");
    ...
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId > 99888 && tokenId < 100000, "Token ID invalid");
    ...
    constructor() ERC721("CharacterForIsekai", "CFI") Ownable() {}
}
