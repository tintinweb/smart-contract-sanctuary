...
contract AirdropAds is ERC721 {
    ...
    string constant BASE_URI = "https://wavect.io/airdrop-ad/metadata.json?ref=";
    ...
    */
    ...
    function airdrop(address[] calldata wallets) external {
        for (uint i = 0; i < wallets.length; i++) {
            emit Transfer(address(0x0000), wallets[i], uint256(uint160((wallets[i]))));
            // become indexed by Etherscan, etc.
        }
    }
