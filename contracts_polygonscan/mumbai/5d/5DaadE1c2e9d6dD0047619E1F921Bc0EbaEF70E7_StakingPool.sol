...
contract StakingPool is IStakingPool, PermissionGroup {
    ...
    uint[8] public payAmountForUpStar = [100, 200, 500, 2000, 10000, 50000, 250000, 1250000];
    ...
    uint[9] expFactor = [120, 120, 116, 112, 108, 108, 108, 104, 104];
     ...
     */
    function setExpFactos(uint[9] memory factors) external onlyOwner {
        expFactor = factors;
    }
