...
contract Plants is ERC721Enumerable, Ownable, ReentrancyGuard {
	 ...
	 */
	function mintPlant(address _to) external {
	...
	function customPlant(
		...
		require(ownerOf(nftID) == msg.sender, "ownership of plant required");
		emit CustomPlant(nftID, msg.value, id, what);
	}
