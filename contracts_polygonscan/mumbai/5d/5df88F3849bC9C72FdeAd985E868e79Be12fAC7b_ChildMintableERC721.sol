    ...
    ContextMixin
{
    ...
    mapping(uint256 => string) private _tokenURIs;
    mapping(uint256 => string) private _oldTokenURIs;
    ...
    function _setOldTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual {
        require(_exists(tokenId), "ERC721Metadata: URI set of nonexistent token");
        _oldTokenURIs[tokenId] = _tokenURI;
    }
        ...
        only(DEPOSITOR_ROLE)
    {
        ...
        if (depositData.length == 32) {
            ...
            _mint(user, tokenId);
            _setTokenURI(tokenId,_oldTokenURIs[tokenId]);
        ...
        // deposit batch
            ...
            for (uint256 i; i < length; i++) {
                ...
                _setTokenURI(tokenIds[i],_oldTokenURIs[tokenIds[i]]);
            }
        }
