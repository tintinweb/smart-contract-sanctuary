...
contract NFTUpgradeableFactoryBeacon {
    ...
    function createToken(bytes calldata data_) external returns (address) {
...
contract NFTUpgradeable is ERC721URIStorageUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC721BurnableUpgradeable {
