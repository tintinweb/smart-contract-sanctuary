...
contract PrizePoolManager is Ownable, IERC1155Receiver {
  ...
  function registerNft(address _collection, uint _id, uint _amount) private {
    ...
    require(StateManager(address(this)).isLocked(), "You need to lock the gachapon before you can add more NFTs");
  ...
  function onERC1155Received(
    ...
    require(_from == owner() && _operator == owner(), "Only the owner can add nfts");
