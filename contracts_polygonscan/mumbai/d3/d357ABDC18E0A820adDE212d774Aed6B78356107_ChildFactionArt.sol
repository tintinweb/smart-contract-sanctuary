    ...
    ContextMixin
{
    ...
    uint256 public constant maxTotalSupply = 12;
    ...
    */
    ...
    function mint(
        ...
        require((id <= maxTotalSupply) && (id > uint(0)), "ChildFactionArt: INVALID_TOKEN_ID");
        require(((amount > uint(0))), "ChildFactionArt: INVALID_AMOUNT");
    ...
    function mintBatch(
        ...
        for (uint i = 0; i < ids.length; i++) {
            require((ids[i] <= maxTotalSupply) && (ids[i] > uint(0)), "ChildFactionArt: INVALID_TOKEN_ID");
            require(((amounts[i] > uint(0))), "ChildFactionArt: INVALID_AMOUNT");
        }
