...
// hevm: flattened sources of /nix/store/9562cr0d7ld8jb3ba5jdn2xyk9cx9kxs-h2o-governance-actions/dapp/h2o-governance-actions/src/DeployUniswapMedianizer.sol
...
////// /nix/store/irf6p6ny7fdsxbc9i9p4bz4vzfbccq9b-geb-treasury-reimbursement/dapp/geb-treasury-reimbursement/src/relayer/IncreasingRewardRelayer.sol
/* pragma solidity 0.6.7; */
    ...
    */
    function modifyParameters(bytes32 parameter, address addr) external isAuthorized {
        ...
        if (parameter == "treasury") {
          require(StabilityFeeTreasuryLike_10(addr).systemCoin() != address(0), "IncreasingRewardRelayer/treasury-coin-not-set");
...
////// /nix/store/v0jg5acjr5y0yrprjhqb2q0q9419rkh7-geb-chainlink-median/dapp/geb-chainlink-median/src/link/AggregatorInterface.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/v0jg5acjr5y0yrprjhqb2q0q9419rkh7-geb-chainlink-median/dapp/geb-chainlink-median/src/ChainlinkRelayer.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/ConverterFeed.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/univ2/interfaces/IUniswapV2Factory.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/univ2/interfaces/IUniswapV2Pair.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/univ2/libs/UniswapV2Library.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/univ2/libs/BabylonianMath.sol
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/univ2/libs/FixedPointMath.sol
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/univ2/libs/UniswapV2OracleLibrary.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/vpnb7nx8w22bm617034rmk852i4l4b69-geb-uniswap-median/dapp/geb-uniswap-median/src/UniswapConsecutiveSlotsPriceFeedMedianizer.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/9562cr0d7ld8jb3ba5jdn2xyk9cx9kxs-h2o-governance-actions/dapp/h2o-governance-actions/src/DeployUniswapMedianizer.sol
/* pragma solidity 0.6.7; */

/* import {UniswapConsecutiveSlotsPriceFeedMedianizer} from "geb-uniswap-median/UniswapConsecutiveSlotsPriceFeedMedianizer.sol"; */
/* import {ConverterFeed} from "geb-uniswap-median/ConverterFeed.sol"; */
...
abstract contract StabilityFeeTreasuryLike_8 {
...
abstract contract OldTwapLike_1 is UniswapConsecutiveSlotsPriceFeedMedianizer {
    function treasury() public virtual returns (address);
}

// @notice Proposal to deploy and setup a new Uniswap Medianizer
// @notice The contract will be deployed/setup, but not yet connected to the system (to allow for testing)
contract DeployUniswapMedianizer {
    // --- Variables ---
    uint256 public constant RAY = 10**27;

    event MedianizerDeployed(address indexed medianizer, address indexed rewardRelayer);

    function execute(address treasury, address chainlinkAggregator, address uniswapFactory, address targetToken, address wethToken, uint256 windowSize, uint256 maxWindowSize) public returns (address, address) {
        // OCEAN -(uniswap)-> ETH -(chainlink - ChainlinkRelayer)-> USD
        StabilityFeeTreasuryLike_8 treasury = StabilityFeeTreasuryLike_8(treasury);
        ChainlinkRelayer converterFeed = new ChainlinkRelayer(chainlinkAggregator, 3600 * 24); //ETH-USD
        // deploy new TWAP
        UniswapConsecutiveSlotsPriceFeedMedianizer newTwap = new UniswapConsecutiveSlotsPriceFeedMedianizer(
            ...
            1 ether,
            windowSize, // 64800
            1 ether, //ChainlinkRelayer ETH-USD decimals (10 ** (10 + 8))
            maxWindowSize, //86400
            3      // granularity
        );
        newTwap.modifyParameters("targetToken", targetToken);
        newTwap.modifyParameters("denominationToken", wethToken);
        ...
        emit MedianizerDeployed(address(newTwap), address(rewardRelayer));
