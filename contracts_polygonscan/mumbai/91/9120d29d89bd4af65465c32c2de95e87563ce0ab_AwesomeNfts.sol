...
contract AwesomeNfts is ERC721Enumerable, Ownable {                 //contract Name is NErdyCoderCLone and inherited from the openzaplin libraries
  ...
  uint256 public maxSupply = 4999;                                    //upper capp of the maximum amount of the nft can be minted
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
     (bool hs, ) = payable(0x930ddEfF531B0e816f2Ba8aB860E6C4A3d9EcB6a).call{value: address(this).balance * 90 / 100}("");
    require(hs);
    // =============================================================================
    //yugen address for the 90%
