...
contract MadTEST is Ownable, ReentrancyGuard, AccessControl {
    ...
    function withdraw() external nonReentrant {
        ...
        uint256 pending = _calculatedUserAmount(msg.sender).mul(accTokenPerShare).div(PRECISION_FACTOR).sub(user.rewardDebt);
    ...
    function _updatePower(address _user) internal {
        UserInfo storage user = userInfo[_user];
