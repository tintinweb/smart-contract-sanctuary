...
contract RealmNFT is ERC1155Tradable, VRFConsumerBase {
    ...
    constructor() VRFConsumerBase(
        VRF_COORDINATOR,
        LINK_TOKEN
    ) ERC1155Tradable("RealmNFT", "REALMNFT", "https://ipfs.io/ipfs/QmcjTbJasPiwXXSe6VHFwFbVuCDQ7qAm1AdQbHwKmo4jAR?filename=attributes.json") {
    ...
    function mintRandomized(uint256 id) public onlyOwner returns(bytes32) {
        uint256 seed = 5; // TODO determine good seed
        bytes32 requestId = getRandomNumber(seed);
        requests[requestId] = RequestData(_msgSender(), id, 1);
        return requestId;
    }
