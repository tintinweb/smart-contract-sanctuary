...
contract StrategySirius is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant wantAddress = 0x0425713643AE9A63e1d7d3B117Ce2fCe2e6cf2D4;//SIRIUS token address
    ...
    event CompoundCycleChanged(uint256 _oldCycle, address _newCycle);
    ...
    function setGov(address _govAddress) external onlyGov {
	 ...
	 //To allow optmised earn to be called
