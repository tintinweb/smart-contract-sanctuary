    ...
    VRFConsumerBaseUpgradeable
{
    ...
    event mintWithGacha(string rarityName, uint256 basePoint);
    ...
    function addRarity(
        ...
        for (uint256 i = 0; i < rarityNameList.length; i++) {
            ...
            cumulativeWeight.push(rarityNameToRarity[rarityNameList[i]].rate +
                previousValue);
        }
...
contract MelXNFT is MelXNFTPayment, MelXNFTBasic {
    ...
    /**
     * @dev Mint function that can be call publicly, caller will automatically to be the owner of asset
     */
    ...
    /**
     * @dev Mint function that can be call publicly, given "to" address will be the owner of asset
     */
    ...
    /**
     * @dev Safe Mint function that can be call publicly, given "to" address will be the owner of asset
     * empty data parameter will set as default
     * recomended if "to" parameter is a Contract
     */
    ...
    /**
     * @dev Safe Mint function that can be call publicly, given "to" address will be the owner of asset
     * will need data parameter, data parameter later will be passed to onERC721Received function of "to" address
     * recomended if "to" parameter is a Contract
     */
    ...
    Initializable
{
    ...
    function __VRFConsumerBase_init_unchained(address _vrfCoordinator, address _link)
        internal
        initializer
    {
        vrfCoordinator = _vrfCoordinator;
