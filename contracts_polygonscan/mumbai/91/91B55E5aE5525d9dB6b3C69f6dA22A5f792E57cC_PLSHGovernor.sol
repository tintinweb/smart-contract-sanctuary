...
contract PLSHGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    constructor(ERC20Votes _token)
        Governor("PLSHGovernor")
        GovernorSettings(1 /* 1 block */, 273 /* 1 hour */, 1000e18)
