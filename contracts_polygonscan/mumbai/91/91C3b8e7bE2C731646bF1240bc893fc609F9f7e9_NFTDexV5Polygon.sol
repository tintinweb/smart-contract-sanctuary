...
// File: contracts/LiveNFTAwardPolygon.sol
...
contract NFTDexV5Polygon is ERC721Full, ERC721MetadataMintable, Ownable {
  IERC20 ALIA;
...
//   event SetValue(address indexed from, uint256 main, uint256 _author, uint256 _platform);
  ...
  function init5() public{
    ...
    award=0xf7BB4699d8D2A4776aDa515fA819220Be762C755;
  }
  ...
  function claimAuction(uint256 _tokenId, bool awardType, string memory ownerId, address from) public {
    ...
    if(awardType) {
      ...
      ALIA.transfer( _tokenAuthors[_tokenId], (price / 1000) * authorPercentage);
  ...
  require(msg.sender == 0x7d502C7D0DB1722453B841A118fb4204dCF0B036,"Not Authorized");
  _;
  }
