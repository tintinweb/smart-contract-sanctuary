...
contract PlushCoinWallets is Ownable {
    ...
    constructor(address _plushAddress, address _plushAppsAddress)
    {
    ...
    function withdrawToUser(uint256 _amount) external
    {
        ...
        plush.transferFrom(address(this), msg.sender, _amount);
    }

    function increaseWalletAmount(address _wallet, uint256 _amount) public
    {
...
contract PlushApps is Ownable {
    ...
    function addNewApp(string memory _name, address _appAddress) external onlyOwner
    {
