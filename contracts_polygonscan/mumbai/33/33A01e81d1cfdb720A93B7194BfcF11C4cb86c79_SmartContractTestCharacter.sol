...
contract SmartContractTestCharacter is ERC721, Ownable {
    using SafeMath for uint256;
    using Strings for string;

    uint public counter = 1000;

    constructor() public ERC721("SmartContractTestCharacter", "SCTNFT") {
    }

    function createCharacter(string memory _tokenURI) public
    {
        counter++;
        uint newId = counter;
