...
contract TheDogePound is ERC721, Ownable {
     ...
     */
    function setMaxToMint(uint256 _maxValue) public onlyOwner {
        maxToMint = _maxValue;
    }
     ...
     * Mint Doges by owner
     */
    function reserveDoges(address _to, uint256 _numberOfTokens) public onlyOwner {
    ...
    * Mints tokens
    */
    function mintDoges(uint256 numberOfTokens) public payable {
