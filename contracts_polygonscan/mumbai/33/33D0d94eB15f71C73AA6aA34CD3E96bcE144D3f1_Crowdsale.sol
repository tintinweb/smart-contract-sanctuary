...
// File: @openzeppelin/[email protected]/utils/EnumerableSetUpgradeable.sol
...
// File: contracts/WhitelistVault.sol
...
// File: contracts/ERC20Whitelisted.sol
...
// File: @openzeppelin/[email protected]/token/ERC20/ERC20CappedUpgradeable.sol
...
// File: @openzeppelin/[email protected]/token/ERC20/ERC20PausableUpgradeable.sol
...
contract Crowdsale is OwnableUpgradeable, PausableUpgradeable {
  ...
  function contribution(string memory tokenName) public payable whenNotPaused returns (uint256) {
    ...
    require(tokens > 1 * uint256(10**uint256(_decimals)), "Must buy from 1");
