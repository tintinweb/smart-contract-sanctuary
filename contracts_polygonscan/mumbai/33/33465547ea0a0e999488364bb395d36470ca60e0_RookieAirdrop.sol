...
contract RookieAirdrop is Ownable, ERC1155 {
    

    string baseURI = "https://gateway.pinata.cloud/ipfs/QmSR4NKhYqgtKaPNekGV5ZCBNuDUJxTuLTyYyWGuhZeF8q/";
    string [9]  planetName = ["EARTH", "JUPITER", "MARS", "MERCURY", "NEPTUNE", "PLUTO", "SATURN", "URANUS", "VENUS"];
    constructor() ERC1155(baseURI) {
        
    }

    function airdropPlanets(address rookieOwner, uint amount) public {
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        string memory pName = planetName[tokenId];
        return string(abi.encodePacked(baseURI, pName, ".jpg"));
    }
