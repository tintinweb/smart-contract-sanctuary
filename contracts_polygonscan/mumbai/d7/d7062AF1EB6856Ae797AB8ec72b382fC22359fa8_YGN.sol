...
contract YGN is ERC20Burnable, Ownable, NativeMetaTransaction {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "YGN::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "YGN::delegateBySig: invalid nonce"
        );
        require(
            block.timestamp <= expiry,
            "YGN::delegateBySig: signature expired"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "YGN::getPriorVotes: not yet determined"
        );
