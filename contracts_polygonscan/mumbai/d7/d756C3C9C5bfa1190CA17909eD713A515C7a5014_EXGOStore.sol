...
contract EXGOStore is Ownable, SignerRole, StoreBase {
    string public name;
    ...
    function mintWithuri(address _from , address _to, uint256 _id, uint256 _supply, string memory _uri) external isOperator returns (bool){
        _mint(_from, _to, _id, _supply, _uri);
        return true;
    }
