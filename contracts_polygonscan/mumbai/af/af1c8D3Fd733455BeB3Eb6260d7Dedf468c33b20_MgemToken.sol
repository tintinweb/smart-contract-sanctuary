...
contract MgemToken is ERC20Token, AccessControlUpgradeable, EIP712Upgradeable, IMintable {
   ...
   */
  function __MgemToken_init(address _minter) public initializer {
    __AccessControl_init();
    __EIP712_init("MgemToken", "1.0.0");
    __ERC20Token_init("MgemToken", "Mgem", 18, 1000000000);
