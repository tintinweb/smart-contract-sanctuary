...
contract IronToken is ERC20Token, AccessControlUpgradeable, EIP712Upgradeable, IMintable {
   ...
   */
  function __IronToken_init(address _minter) public initializer {
    __AccessControl_init();
    __EIP712_init("IronToken", "1.0.0");
    __ERC20Token_init("IronToken", "Iron", 18, 1000000000);
    _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    _setupRole(MINTER_ROLE, _minter);
  }

  function mint(address _account, uint _amount) external override onlyRole(MINTER_ROLE) {
