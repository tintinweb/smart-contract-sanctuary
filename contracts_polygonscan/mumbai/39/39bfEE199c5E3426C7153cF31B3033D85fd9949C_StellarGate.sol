...
contract StellarGate is ERC1155, Ownable {
    
    address proxyRegistryAddress;
    string metadata_uri;
    mapping(address => bool) private _minters;

    constructor(address _proxyRegistryAddress) ERC1155("https://nft.stellargate.io/{id}.json") {
        proxyRegistryAddress = _proxyRegistryAddress;
        metadata_uri = "https://nft.stellargate.io/{id}.json";
    }
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        public
    {
        require(isMinter(msg.sender), "StellarGate: Only minters can mint");
