...
// File: contracts/DogeToken.sol

pragma solidity 0.7.0;

/**
 * @title DogeToken contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract DogeToken is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public tokenPrice = 50000000000000; // 0.00005 MATIC
    ...
    constructor() ERC721("DOGE Token", "DT") { }
    ...
    function paidMintTokens(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale is not active");
        require(numberOfTokens <= maxTokenPurchase, "Exceeds max number of Tokens in one transaction");
    ...
    function mintTokens(uint numberOfTokens) public {
        uint i;
        uint mintIndex;
        for (i; i < numberOfTokens; i++) {
            mintIndex = totalSupply();
