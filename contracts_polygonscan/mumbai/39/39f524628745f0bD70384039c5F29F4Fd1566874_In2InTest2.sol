...
contract In2InTest2 is ERC721URIStorage, Ownable {
    
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    uint256 private price = 25000000000000; // 0.000025 Ether
    ...
    constructor() ERC721("In2InTest", "I2IT") {
    }
        ...
        returns (uint256)
    {
        ...
        require(msg.value == price, "Need to send 0.02 ether");
