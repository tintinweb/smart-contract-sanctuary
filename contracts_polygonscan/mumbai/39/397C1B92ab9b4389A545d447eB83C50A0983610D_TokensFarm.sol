...
contract TokensFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public totalCurrentRewards;
    ...
    */
    ...
    external
    {
        ...
        totalRewards = totalRewards.add(fundAmount);
    ...
    internal
    {
        ...
        totalCurrentRewards = totalCurrentRewards.add(_amount);
    }
    ...
    validateStakeByStakeId(msg.sender, stakeId)
    {
        ...
        if (pendingAmount > 0) {
            if (
                ...
                // Update totalRewards
                totalCurrentRewards = totalCurrentRewards.sub(pendingAmount);
            } else if (
