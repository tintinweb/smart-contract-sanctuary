...
contract PenkyGovernance is ERC20("PenkyGOVERNANCE", "PENKYGOVERNANCE"), Ownable, Pausable {
    ...
    mapping (address => uint256) public penkyBalance;
    ...
    function swapPenkyToGovernance(uint256 amount) public whenNotPaused {
        ...
        _mint(user,amount);
        penkyBalance[user] = penkyBalance[user] + amount;
    }
