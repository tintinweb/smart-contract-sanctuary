...
contract Shop is ReentrancyGuard, Ownable {
    ...
    // Mapping for Purchase Limitation
    ...
    function purchase(
        ...
        require(
            userLimits[_msgSender()] < userPurchaseLimit,
        ...
        require(_count <= item.limit, "purchase: Item limit exceeded");
        ...
        userLimits[_msgSender()] = userLimits[_msgSender()] + 1;
    }
    ...
    function updateUserPurchaseLimit(uint256 _limit) external onlyOwner {
        require(_limit != 0, "invalid limit number");

        userPurchaseLimit = _limit;
    }
