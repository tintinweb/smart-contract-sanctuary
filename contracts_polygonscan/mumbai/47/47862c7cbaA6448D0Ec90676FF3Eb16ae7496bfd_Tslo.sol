...
contract Tslo is ERC20, AccessControl, Pausable {
     ...
     */
    function getRandomNumber(address _from, uint256 _bet, uint256 _lines, string memory _serverSeed, string memory _clientSeed) public onlyRole(RELAYER_ROLE){
        address userAddress;
