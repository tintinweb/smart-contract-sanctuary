...
// File contracts/tokens/Erc721GCR.sol
    ...
    EIP712MetaTransaction("ERC721Token", "1")
{
    ...
    constructor() ERC721("GCR 6 Month Anniversary", "GCRxBIRTHDAY") {
        _setBaseURI("https://ipfs.io/ipfs");
    }

    modifier onlyOnePerUser(address user) {
        require(this.balanceOf(user) == 0, "ERC721GCR__ONLY_1_PER_USER");
        _;
    }
    ...
    function mint(string memory _tokenId) public onlyOnePerUser(msgSender()) {
        bytes memory tempTokenId = bytes(_tokenId);
        require(tempTokenId.length > 0, "ERR__INVALID_TOKENID");
