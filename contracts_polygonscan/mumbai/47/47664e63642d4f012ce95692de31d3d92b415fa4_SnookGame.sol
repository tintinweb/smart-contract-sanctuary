...
interface ISnookGame is IDescriptorUser {
  ...
  event Death(address indexed to, uint tokenId, uint killerTokenId);
...
contract SnookGame is ISnookGame, AccessControlEnumerableUpgradeable, PausableUpgradeable {
    ...
    function _mint2() internal 
    {
        ...
        _spc += 1;
        uint amountToBurn = price * MINT_BURN_PERCENTAGE / 100;
        _skill.burn(address(this), amountToBurn);
        
        uint amountToTreasury = price * MINT_TREASURY_PERCENTAGE / 100;
        ...
        uint amountToEcosystem = price - amountToBurn - amountToTreasury;
