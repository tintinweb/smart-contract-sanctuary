...
// File: https://github.com/maticnetwork/pos-portal/blob/dabb08ec28e236c2d2409663c82003fa3f431c9d/flat/ChildMintableERC20.sol
...
// File: contracts/6_CookieTokenL2.sol
...
contract CookieTokenL2 is ERC20, IChildToken, AccessControlMixin, NativeMetaTransaction, ContextMixin {
    
    bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");
    
    string constant NAME = "Cookie";
    string constant SYMBOL = "CKI";
    string constant CONTRACT_ID = "CookieTokenL2";
    uint8 constant DECIMALS = 18;
    address constant CHILD_CHAIN_MANAGER = 0xb5505a6d998549090530911180f38aC5130101c6; // 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa // Mainnet
    ...
    /**
     * @notice Function to handle minting tokens on matic chain
     * @param user user for whom tokens are being minted
     * @param amount amount of token to mint
     */
    function mint(address user, uint256 amount) public only(DEFAULT_ADMIN_ROLE) {
