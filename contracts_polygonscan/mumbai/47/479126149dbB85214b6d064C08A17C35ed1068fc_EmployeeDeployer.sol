...
contract EmployeeDeployer is Initializable, AccessControl {
    ...
    uint256 public employeePrice = 5000000000000000000000 wei;
    ...
    function addToWhitelist(address customer) public onlyRole(MAIN_OWNER) {
        whiteList[customer] = true;
    }

    function addManyToWhitelist(address[] calldata customers)
        public
        onlyRole(MAIN_OWNER)
    {
        for (uint256 i = 0; i < customers.length; i++) {
            whiteList[customers[i]] = true;
        }
    }
