...
// File contracts/MDTest.sol

pragma solidity ^0.8.7;
contract MDTest is ERC721Enumerable, Ownable{
    ...
    constructor(string memory baseURI) ERC721("MDTest", "MDT"){
        setBaseURI(baseURI);
    }
    ...
    function mintAll() public onlyOwner{
        for(uint i=_tokenIds.current(); i<MAX_SUPPLY; i++){
            _tokenIds.increment();
