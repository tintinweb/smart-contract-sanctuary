...
contract VolatilityOracle is DSMath, OwnableUpgradeable {
    ...
    //require(accumulators[underlyingToken][priceToken] , "This Token Pair Should exist");
      ...
      Accumulator memory newAccumulator = Accumulator({currentObservationIndex:currentObservationIndex, lastTimestamp:lastTimestamp,mean:mean,dsq:dsq });
      accumulators[underlyingToken][priceToken] = newAccumulator;

      emit AccumulatorSet(underlyingToken, priceToken, currentObservationIndex, lastTimestamp, mean, dsq);
    }
