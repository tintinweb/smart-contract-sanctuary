...
contract HamperBlock {
    ...
    constructor(){
        ...
        _tokenTransfer(address(this),msg.sender,_totalSupply*3/100,false); //3% to devs
        _tokenTransfer(address(this),msg.sender,_totalSupply*7/100,false); //7% to marketing
        _tokenTransfer(address(this),msg.sender,_totalSupply*4/100,false); //4% to airdrops
        _tokenTransfer(address(this),msg.sender,_totalSupply*1/100,false); //1% to SDG
        //_tokenTransfer(address(this),msg.sender,_totalSupply*15/100,false); //15% to reward pool
        //_tokenTransfer(address(this),msg.sender,_totalSupply*35/100,false); //35% to presale
        //_tokenTransfer(address(this),msg.sender,_totalSupply*35/100,false); //35% to liquidity
    }
