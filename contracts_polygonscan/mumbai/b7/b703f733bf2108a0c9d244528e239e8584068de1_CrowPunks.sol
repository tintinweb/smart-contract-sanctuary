...
interface ERC721BatchMint /* is ERC721 */ {
  ...
  */
    event TransferBatch(uint256 indexed fromTokenId, uint256 toTokenId, address indexed fromAddress, address indexed toAddress);
}

contract CrowPunks is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, ContextMixin, ERC721BatchMint {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("CrowPunks Token", "CPT") {}
    ...
    function safeMint(uint amount) public onlyOwner {
        ...
        emit TransferBatch(fromTokenId, lastTokenId, address(0), msg.sender);
    }
