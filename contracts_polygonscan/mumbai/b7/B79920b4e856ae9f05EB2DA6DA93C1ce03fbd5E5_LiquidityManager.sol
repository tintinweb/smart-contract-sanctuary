...
contract LiquidityManager is IERC721Receiver {
    ...
    **/
    ...
    function acceptETHAndCreatePool() public payable returns (bool) {
        ...
        // TransferHelper.safeApprove(TokenA, address(_nonfungiblePositionManager), msg.value);
        ...
        // _deposits.push( Deposit(address(0x0), address(0x0), tokenId) );
        return true;
    }
    ...
    function onERC721Received(
        ...
        _deposits.push( Deposit(operator, from, tokenId) );
        data;
