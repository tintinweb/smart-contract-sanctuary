...
contract PBAMBOOv3 is ERC721, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;

    uint256 public MAX_TEAM_RESERVES_PRESALE = 10;
    uint256 public MAX_TEAM_RESERVES_POSTSALE = 90;
    //allows for 90 tokens to remain for team reserved to be minted after public sale
    uint256 public constant MAX_TOKENS = 9910;
    uint256 public constant MAX_TOKENS_TOTAL_SUPPLY = 10000;
    uint256 public constant MAX_PRESALE_TOKENS_PER_ADDRESS = 5;
    uint256 public constant PRESALE_TOKEN_PRICE = 0.0007 ether;
    uint256 public MAX_MINTS_PER_TX = 1000;
    uint256 public constant TOKEN_PRICE = 0.0008 ether;
