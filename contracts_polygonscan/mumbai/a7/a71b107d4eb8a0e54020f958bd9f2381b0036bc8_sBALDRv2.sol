...
contract sBALDRv2 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked BALDR", "sBALDR", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBALDR supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBALDR
