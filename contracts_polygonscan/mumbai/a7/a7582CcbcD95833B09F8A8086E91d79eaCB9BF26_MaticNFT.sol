    ...
    ContextMixin
{
    ...
    function mintWithURI(address user, uint256 tokenId, string memory tokenURI) public only(DEFAULT_ADMIN_ROLE){
        require(!withdrawnTokens[tokenId], "ChildMintableERC721: TOKEN_EXISTS_ON_ROOT_CHAIN");
        _mint(user, tokenId);
