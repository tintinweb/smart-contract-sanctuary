...
contract FuzzyswapVirtualPool is IFuzzyswapVirtualPool{
    ...
    function cross(
        ...
        if (ticks[nextTick].initialized){
            ...
            liquidityState = LiquidityMath.addDelta(liquidityState, liquidityDelta);
        }
...
library PoolAddress {
    ...
    bytes32 internal constant POOL_INIT_CODE_HASH = 0xdaef9bc8ccc5a32cf3ae5bec9b189a1e04a369c19ce0f538d01a60f3bafd17e2;
