...
/**
 * @title BB1155V1 
 * BB1155V1 (modified ERC1155PresetMinterPauser) - See OpenZeppelin
 * /// bytes4(keccak256("royaltyInfo(uint256,uint256)")) == 0x2a55205a
*  /// 
 */
contract BB1155V1 is Ownable, AccessControlEnumerable, ERC1155Burnable, IERC2981, IMintableERC1155 {
...
/**
 * @title ChildBB1155V1 
 * BB1155V1 (ERC1155PresetMinterPauser) - See OpenZeppelin
 */
contract ChildBB1155V1 is BB1155V1, IERC1155ChildMintable {
  bytes32 public constant DEPOSITOR_ROLE = keccak256("DEPOSITOR_ROLE");

  constructor(string memory uri, string memory contractUri, address royaltyFeeRecipient,
        uint8 royaltyFee, address childChainManager) BB1155V1(uri, contractUri, royaltyFeeRecipient, royaltyFee) {
