...
contract GaiaLand is ERC721, Ownable {
    ...
    uint256 public gaiaGoodLandPrice = 7500000000000000; // 0.075 ETH

    uint256 public gaiaRegularLandPrice = 2500000000000000; // 0.075 ETH
    ...
    function mintGaiaLand(uint256 numberOfTokens) public payable {
        ...
        require(
            msg.value >= gaiaRegularLandPrice.mul(numberOfTokens),
