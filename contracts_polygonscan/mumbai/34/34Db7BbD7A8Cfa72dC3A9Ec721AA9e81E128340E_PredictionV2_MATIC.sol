 ...
 * @title PredictionV2
 */
contract PredictionV2_MATIC is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    function _calculateRewards(string memory _symbol, uint256 epoch) internal {
        ...
        if (treasuryAmt > 0) {
            thePledgeToInject = thePledgeToInject * rewardCardProportion / rewardCardAllProportion;
