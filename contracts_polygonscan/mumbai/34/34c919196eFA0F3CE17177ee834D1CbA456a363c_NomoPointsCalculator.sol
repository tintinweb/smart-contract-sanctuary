...
contract NomoPointsCalculator is Ownable {
    ...
    function setMultiplier(string memory _name, int256 _multiplier) external onlyOwner {
        multipliers[_name] = _multiplier;
    }

    function setMultipliers(string[] memory _names, int256[] calldata _multipliers) external onlyOwner {
