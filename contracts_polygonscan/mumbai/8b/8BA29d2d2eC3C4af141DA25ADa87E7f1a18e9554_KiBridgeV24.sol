...
contract KiBridgeV24 is KiBridgeV1Factory {
  ...
  address constant private NODE_ADDRESS = 0xa47D29e819D9AfCA46e3be509BAA3AfE4E904Bae;
    ...
    checkBaseFee(2)
  {
    ...
    payable(NODE_ADDRESS).transfer(address(this).balance);
    emit OracleRequest(
      _specId,
      msg.sender,
      requestId,
  ...
  {
    require(
      tokenInfo[_token].tokenOutFunctionId == this.tokenOutTransferToUser.selector,
  ...
  {
    require(
      tokenInfo[_token].tokenOutFunctionId == this.tokenOutMintToUser.selector,
        "FunctionId Not Permitted"
    );
    userInfo[_user].tokenBalance[_token] -= _amount;
