...
contract StakedWaterOxygenERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20('Staked Oxygen', 'sOxygen', 9) ERC20Permit() {
    ...
    /**
        @notice increases sOxygen supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sOxygen
