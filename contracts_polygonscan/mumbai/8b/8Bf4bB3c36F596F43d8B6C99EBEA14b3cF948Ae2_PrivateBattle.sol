...
contract PrivateBattle is VRFConsumerBase, Ownable {
    ...
    uint256 public minFoundationFee;
    ...
    constructor(
        ...
        // minium pool foundation
        minFoundationFee = 10 * (10**18);
    }
    ...
    function setMinFoundationFee(uint256 _fee) public onlyOwner {
        require(_fee > 0, "");

        minFoundationFee = _fee;
    }
    ...
    modifier canCreateBattle(
        ...
        require(_fee >= minFoundationFee, "PrivateBattle: Fee is not enough");
        require(
            _entryLimit > 1,
