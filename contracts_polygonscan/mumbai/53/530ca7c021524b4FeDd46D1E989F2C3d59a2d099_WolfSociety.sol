...
// File: contracts/wolf_society.sol


/**
 __      __      .__   _____    _________             .__        __          
/  \    /  \____ |  |_/ ____\  /   _____/ ____   ____ |__| _____/  |_ ___.__.
\   \/\/   /  _ \|  |\   __\   \_____  \ /  _ \_/ ___\|  |/ __ \   __<   |  |
 \        (  <_> )  |_|  |     /        (  <_> )  \___|  \  ___/|  |  \___  |
  \__/\  / \____/|____/__|    /_______  /\____/ \___  >__|\___  >__|  / ____|
       \/                             \/            \/        \/      \/      
*/
...
//SPDX-License-Identifier: MIT
    ...
    contract WolfSociety is ERC721, Ownable, ERC721Enumerable {
      ...
      uint256 public devReserve = 250; // reserve to team
    
      event WolfMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("Non-Fungible WolfSociety", "WS") {}
      ...
      function setMaxTokenPurchase(uint256 _newMaxTokenPurchase) public onlyOwner {
      ...
      function mintWolf(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit WolfMinted(id, msg.sender);
          }
        }
      }
    
      function presaleWolf(uint256 numberOfTokens) external payable {
        ...
        require(
          msg.value >= presaleCost.mul(numberOfTokens),
          "Matic value sent is not correct"
        );
