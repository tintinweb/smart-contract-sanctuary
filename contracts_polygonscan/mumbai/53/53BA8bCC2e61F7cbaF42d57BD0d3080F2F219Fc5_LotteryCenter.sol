...
contract LotteryCenter is Ownable, Initializable, Testable {
    ...
    function callbackWinningAward(
        ...
        string memory firstNumber = numbers.substring(
            0,
            uint256(indexOfComma).sub(1)
        );
    ...
    function batchBuyLottoTicket(
        ...
        emit InfoBatchMintTranferSuccess(lotteryId, chosenNumbersForEachTicket);
        ...
        for (
            ...
            string memory secondNumber = chosenNumbersForEachTicket[index]
                .substring(4, 5);
            _countSecondWinningNumber[lotteryId][secondNumber] += 1;
        }
