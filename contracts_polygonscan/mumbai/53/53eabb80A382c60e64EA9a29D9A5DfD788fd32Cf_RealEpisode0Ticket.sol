...
contract RealEpisode0Ticket is
  ERC721,
  ERC721Enumerable,
  ERC721Burnable,
  Ownable
{
  ...
  string uri = "QmV1Uo9UmPdoj2xR3d121nSD13NfF88eXCirzNPaZEefWx";
  mapping(address => bool) public wallets;

  constructor() ERC721("Real dARG Episode 0 Ticket", "RE0T") {}
  ...
  function mint() public payable returns (uint256) {
    ...
    require(
      ...
      "Sorry we're outta tickets."
    );

    require(
      wallets[msg.sender] == false,
      "You've already purchased a real ticket."
    );
