...
using SafeMath for uint;
    ...
    function createTeam(address _teamOwner) public {
        
        Team memory t = Team(teamId++,_teamOwner);
        teams.push(t);
        teamId++;
    }
    ...
    function joinTournament(uint _teamId, uint _tournamentId, uint _amount) public {
        require(owners[msg.sender]==1 || msg.sender==tournaments[_tournamentId].ownerAddress || msg.sender==teams[_teamId].teamOwner ,"Permission denied"); 
