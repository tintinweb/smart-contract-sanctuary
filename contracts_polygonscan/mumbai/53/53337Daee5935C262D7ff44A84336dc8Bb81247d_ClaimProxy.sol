...
contract ClaimProxy {
    ...
    mapping(uint256 => mapping(address => bool)) public _data;

    CanvasManager public immutable _manager;

    // ========== Constructor function ==========

    constructor(CanvasManager canvas) {
        _manager = canvas;
    }

    // ========== External functions ==========

    function getAmount(uint256 nftId, address contributor) external view returns (bool) {
