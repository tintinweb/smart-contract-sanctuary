...
contract PerpetualPoolLite is IPerpetualPoolLite, Migratable {
    ...
    int256 private immutable _minPoolMarginRatio;
    int256 private immutable _minInitialMarginRatio;
    int256 private immutable _minMaintenanceMarginRatio;
    int256 private immutable _minLiquidationReward;
    int256 private immutable _maxLiquidationReward;
    int256 private immutable _liquidationCutRatio;
    int256 private immutable _protocolFeeCollectRatio;
