...
// File: tests/SPSC-Test_Contract.sol
pragma solidity ^0.8.0;

// SPSC - edition 0n1 - ERC721

// Calling mint mints a random SPSC id until 10,000 have been minted
// 50 Kept for artist, developer & giveaways

// https://www.spacepiratessecretclub.com

contract SPSCTestV1 is ERC721, Ownable, RandomlyAssigned {
    using Strings for uint256;

    string public baseURI =
        "https://bretllawicom.ipage.com/ftp_images/SimpleHoomansTest/";
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            require(msg.value >= nftCost * _mintAmount, "You must enter the correct Cost.");
            require(_mintAmount <= maxMintAmount, "You're trying to mint more than allowed.");

            //require(balanceOf(msg.sender) < _mintAmount, "You already have the max NFT holding allowance.");
            require(balanceOf(msg.sender) + _mintAmount <= maxNftPerAddress, "You already have the max NFT holding allowance.");
