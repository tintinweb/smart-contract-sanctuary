...
contract POLY20Token is Context, IPOLY20, Ownable {
  ...
  uint256 public sSDateTime; 
  uint256 public sEDateTime; 
  uint256 public sCap; 
  uint256 public sTot; 
  ...
  */
   ...
   * @dev Transfer tron to the owner.
   */
  function WithdrawalMatic() public onlyOwner returns (bool) {
  ...
  function startSale(uint  _sDateTime, uint  _sEDateTime, uint256 _sChunk, uint256 _sPrice, uint256 _sCap) public onlyOwner() {
    sSDateTime = _sDateTime;
    sEDateTime = _sEDateTime;
    sChunk = _sChunk;
    sPrice =_sPrice;
    sCap = _sCap;
    sTot = 0;
   ...
   */
   ...
   function viewSale() public view returns(uint256 StartDateTime, uint256 EndDateTime, uint256 SaleCap, uint256 SaleCount, uint256 ChunkSize, uint256 SalePrice){
     return(sSDateTime, sEDateTime, sCap, sTot, sChunk, sPrice);
   }
