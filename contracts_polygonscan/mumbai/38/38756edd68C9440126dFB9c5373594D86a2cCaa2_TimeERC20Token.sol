...
abstract contract ERC20TIME is IERC20 {
...
abstract contract ERC20PermitTIME is ERC20TIME, IERC2612Permit {
...
contract TimeERC20Token is ERC20PermitTIME, VaultOwned {

    using LowGasSafeMath for uint256;

    constructor() ERC20TIME("Time", "TIME", 9) {
    }
