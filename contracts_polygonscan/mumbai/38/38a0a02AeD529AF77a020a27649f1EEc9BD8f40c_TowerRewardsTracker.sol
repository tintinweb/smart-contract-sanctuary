...
// File: DailyRewards/TowerRewards.sol
...
contract TowerRewardsTracker is  Ownable, Pausable, EIP712MetaTransaction {
    ...
    function checkDailyRewardsValidity() public view returns(bool){
        uint256 lastTimestamp = _dailyTrackerTimestamp[_msgSender()];
        
        if(lastTimestamp + 24 hours >= block.timestamp){
            return true;
        }
        return false;
    }
