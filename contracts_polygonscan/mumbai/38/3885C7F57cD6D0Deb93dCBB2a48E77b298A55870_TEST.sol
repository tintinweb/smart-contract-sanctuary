...
contract TEST is ERC1155, AccessProtected, ERC1155Burnable {
    uint256 public constant FAL = 100;
    using Counters for Counters.Counter;
    mapping(address=>uint256) artist;
    ...
    function mint(address account, bytes memory data)
        ...
        onlyAdmin
    {   artist[account]++;
        uint256 newTokenId = artist[account];
        _mint(msg.sender, newTokenId, FAL, data);
    }
}
