...
// functions
    ...
    function mint(string memory _URI) public virtual {
        ...
        _createdNFTs[_msgSender()].push(_tokenIdTracker.current());
    }
    ...
    function setPausePermission(address _dao) public onlyOwner {
        ...
        /**
     * @dev return all token ids owned by an address
     **/
    function nftCreatedByUser(address _owner) public view returns (uint256[] memory) {
