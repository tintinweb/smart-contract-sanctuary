...
//		uint256 _retailFee,
		...
		require(_quantity > 0 && _toVersion.sub(_fromVersion) == _quantity, 'Invalid-quantity');
...
//		emit OrderCreated(_orderId, _tokenAddress, _tokenId, _quantity, _price, _paymentToken, _fromVersion, _toVersion);
