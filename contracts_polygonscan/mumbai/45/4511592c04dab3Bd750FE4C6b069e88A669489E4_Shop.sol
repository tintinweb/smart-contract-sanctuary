...
contract Shop is Ownable, AccessControlEnumerable, ReentrancyGuard {
    ...
    */ 
     ...
     * _vaultBalanceAddress - Address of VaultBalance contract
     * _vaultItemAddress - Address of VaultItemAddress contract
     */
    ...
    function buyItems(address _userAddress, uint256 _itemId, uint256 _itemAmount,uint256 _nakaAmount) external whenShopNotPaused nonReentrant onlyVaultAdmin{
