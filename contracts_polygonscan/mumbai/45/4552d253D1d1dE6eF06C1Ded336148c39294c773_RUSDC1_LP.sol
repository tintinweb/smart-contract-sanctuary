...
contract RUSDC1_LP is IRUSDC_LP, ERC20, Ownable {
    event TokenMinted(address indexed to, uint256 amount, uint256 blockNum, uint256 timeStamp);
    event TokenBurnt(address indexed from, uint256 amount, uint256 blockNum, uint256 timeStamp);
    ...
    constructor() ERC20("RUSDC1_LP", "RUSDC1_LP") {
    ...
    */
    function mint(address to, uint256 amount) external override {
        ...
        emit TokenMinted(to, amount, block.number, block.timestamp);
    }
    ...
    */
    function burn(address from, uint256 amount) external override {
        ...
        emit TokenBurnt(from, amount, block.number, block.timestamp);
    }
    ...
    */
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public virtual override(ERC20, IRUSDC_LP) disallowIfStateIsChanging returns (bool) {
    ...
    function balanceOf(address account) public view virtual override(ERC20, IRUSDC_LP) disallowIfStateIsChanging returns (uint256) {
    ...
    function transfer(address recipient, uint256 amount) public virtual override(ERC20, IRUSDC_LP) disallowIfStateIsChanging returns (bool) {
        // NICE TRY MOUSE DRAGON
    ...
    function totalSupply() public view virtual override(ERC20, IRUSDC_LP) disallowIfStateIsChanging returns (uint256) {
        // Y U checking on this address in the same block it's being modified... hmmmm
