...
contract Mint is Ownable, Pausable {
    ...
    uint256 _landsSoldCounter = 20000;
    ...
    function buyToken(uint256 tokenId) public whenNotPaused {
        ...
        uint256 tokenPrice = getTokensPrice(_landsSoldCounter)[0];
    ...
    function buyTokens(uint tokensNumber) public whenNotPaused {
        ...
        uint256[] memory tokenPrices = getTokensPrice(tokensNumber);
    ...
    function getTokensPrice(uint tokensNumber) public view returns (uint256[] memory) {
