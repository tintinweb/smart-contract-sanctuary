...
contract gQuasarERC20Token is IgQUAS, ERC20 {
    ...
    constructor(address _migrator, address _sQUAS)
        ERC20("Governance QUAS", "gQUAS", 18)
    {
     ...
     * @param _sQUAS address
     */
    function migrate(address _staking, address _sQUAS) external override onlyApproved {
        ...
        require(_sQUAS != address(0), "Zero address found");
        sQUAS = IsQUAS(_sQUAS);
    }
    ...
    /**
     * @notice pull index from sQUAS token
     */
    ...
    /**
        @notice converts gQUAS amount to QUAS
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts QUAS amount to gQUAS
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gQUAS::getPriorVotes: not yet determined");
