...
contract sVSQ is ERC20Permit, BoringOwnable {
    ...
    constructor() ERC20("Staked VSQ", "sVSQ", 9) ERC20Permit() {
    ...
    /**
        @notice increases sVSQ supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sVSQ
