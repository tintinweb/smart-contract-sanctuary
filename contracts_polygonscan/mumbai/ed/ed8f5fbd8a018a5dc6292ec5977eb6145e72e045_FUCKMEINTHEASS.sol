...
contract FUCKMEINTHEASS is ERC721Enumerable, Ownable {
    using Strings for uint256;
    // To test this, input 1 ETH "value" in Remix.
    // uint256 public constant PRICE = .08 ether;
    uint256 public PRICE = 0 ether;
    
    uint256 public MAX_SOULS = 0;
    uint256 public MAX_PER_MINT = 0;
    uint256 public PRESALE_MAX_MINT = 0;
    uint256 public MAX_SOULS_MINT = 0;
    uint256 public PHASE_OF_SALE = 0;
    address public constant walletA = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletB = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletC = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletD = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletE = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletF = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletG = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletH = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletI = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletJ = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletK = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletL = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant walletM = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant devAddress = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    address public constant commAddress = 0x72cA0a003804446aABB63926d4b5bA1DaBf5Eb86;
    uint256 public reservedClaimed;
    uint256 public numSoulsMinted;
    uint256 public presaleBal;
    uint256 public publicBal;

        // Need to change the baseTokenURI prior to launch
    string public baseTokenURI = "http://cityroots.s3-website.us-east-2.amazonaws.com/eldertreesouls/meta/";

    bool public publicSaleStarted;
    bool public presaleStarted;
      //  require(PHASE_OF_SALE < 4, "Execution would cause contract errors.");
    ...
    function changePhase(uint256 phase_of_sale) external onlyOwner {
        ...
        if (PHASE_OF_SALE == 3){
            presaleBal = address(this).balance;
        }
    }
    
    
    constructor() ERC721("FUCKMEINTHEASS", "FUCKMEINTHEASS") {}
    ...
    function mintPresale(uint256 amountOfSouls) external payable whenPresaleStarted {
        require(_presaleEligible[msg.sender], "You are not eligible for the presale!");
        require(totalSupply() < MAX_SOULS, "All presale tokens have been minted!");
        require(amountOfSouls <= PRESALE_MAX_MINT, "Cannot purchase this many during this stage of the presale");
        ...
        emit PresaleMint(msg.sender, amountOfSouls);
    }

    function mint(uint256 amountOfSouls) external payable whenPublicSaleStarted {
        if (PHASE_OF_SALE == 3) {
           require(!_presaleEligible[msg.sender], "You are not eligible for the for public sale at this time");
        }
        if(totalSupply() < MAX_SOULS || PHASE_OF_SALE == 5){
            publicBal = address(this).balance;
            publicBal = publicBal - presaleBal;
        }
    ...
    // Need additional work in here to seperate funds between all the different funding wallets
    function withdrawPresale() public onlyOwner {
        require(presaleBal > 0, "Insufficent balance");
        ...
        // I know this percent is off. But it leaves ETH in wallet for gas
        _widthdraw(devAddress, ((presaleBal * 1250) / 10000));
    }
    function withdrawPublic() public onlyOwner {
        require(publicBal > 0, "Insufficent balance");
        uint256 devBal = ((publicBal * 80) / 100);
        uint256 commBal = ((publicBal * 20) / 100);
        ...
        // I know this percent is off. But it leaves ETH in wallet for gas
        _widthdraw(devAddress, ((devBal * 1200) / 10000));
