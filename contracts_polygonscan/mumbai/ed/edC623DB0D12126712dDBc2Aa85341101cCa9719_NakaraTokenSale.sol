...
contract NakaraToken is ERC20 {

	uint256 public initialSupply = 10000000 ether;

    constructor() ERC20("NakaraToken", "NT") {
        _mint(msg.sender, initialSupply);
    }
}

// File: NakaraTokenSale.sol

contract NakaraTokenSale {
    struct Sale {
        address investor;
        uint256 quantity;
    }
    ...
    NakaraToken public tokenContract;
    ...
    constructor(NakaraToken _tokenContract) {
    ...
    function release()
        ...
        icoEnded()
        tokensNotReleased() {
        NakaraToken tokenInstance = tokenContract;
