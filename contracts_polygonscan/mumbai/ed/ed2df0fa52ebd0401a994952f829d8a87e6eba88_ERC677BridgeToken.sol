...
contract MintableToken is StandardToken, Ownable {
   ...
   */
  function finishMinting() public onlyOwner canMint virtual returns (bool) {
...
abstract contract LegacyERC20 {
    ...
    function transferFrom(address _owner, address _spender, uint256 _value) public virtual; // returns (bool);
}
...
contract ERC677BridgeToken is IBurnableMintableERC677Token, DetailedERC20, BurnableToken, MintableToken, Claimable {
    ...
    constructor(string memory _name, string memory _symbol, uint8 _decimals, address _childChainManagerProxy) public DetailedERC20(_name, _symbol, _decimals) {
    ...
    function burn(uint256 _value) public override(BurnableToken, IBurnableMintableERC677Token) {
        _burn(msg.sender, _value);
    }
    ...
    function transferAndCall(address _to, uint256 _value, bytes calldata _data) external override validRecipient(_to) returns (bool) {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override(ERC20, StandardToken) returns (bool) {
        require(
     ...
     * @param _to address of the tokens/coins receiver.
     */
    function claimTokens(address _token, address payable _to) external override onlyOwner {
