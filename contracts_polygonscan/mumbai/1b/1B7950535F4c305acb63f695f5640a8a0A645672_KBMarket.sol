...
// security for transactions gfor multiple requests
...
contract KBMarket is ReentrancyGuard {
    ...
    // we are deploying to matic poligon, the API is the same, so you can use ether the same way
    // they both have 18 decimals
    // but matic costs so much less
    ...
    // function to conduct transactions and marker sales
    ...
    function fetchMarketTokens() public view returns(MarketToken[] memory) {
        ...
        // looping over the number of items created (if number has not been sold to populate)
