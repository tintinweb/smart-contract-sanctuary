...
// FURBallz Series 1 Furban Edition ERC721.
// Pre-sale for whitelistUsers.
// Revealed will be on launch day.
...
contract FURBallzNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FURBallz NFT", "FURB") {
    setHiddenMetadataUri("ipfs://QmRyjJZ5xdDep1CEEiMP6yLbbDS63P4AZGbg6KaRWSEpiq/hidden.json");
  }
