...
contract TRUSTMECOIN is ERC20, Pausable, ERC20Detailed {
	...
	address teamWallet = 0x9683b8314e66c310ce74c0b59A57090d5A09b9Fd;
    address serviceWallet = 0x1169c93e4e9D81445AC7dE3f1C378959119CA92C;
    address partnerWallet = 0x18C3Df5aFF9a8b8c7B671Fb79A5f766771A43Ee9;
    address airdropWallet = 0x0063Fd067E65Fb725f82A9767CCBd4D9365d99c4;
	...
	constructor() public ERC20Detailed("TRUSTMECOIN", "TMC", 9) {  
        ...
        ERC20.transfer(teamWallet, 4500000 * 10 ** uint256(decimals()));  
        ERC20.transfer(partnerWallet, 3000000 * 10 ** uint256(decimals()));
        ERC20.transfer(serviceWallet, 7500000 * 10 ** uint256(decimals()));
