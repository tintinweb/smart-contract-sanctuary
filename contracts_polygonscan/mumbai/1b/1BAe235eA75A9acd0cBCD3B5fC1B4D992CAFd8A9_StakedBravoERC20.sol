...
contract StakedBravoERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Bravo", "sBRAVO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBRAVO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBRAVO
