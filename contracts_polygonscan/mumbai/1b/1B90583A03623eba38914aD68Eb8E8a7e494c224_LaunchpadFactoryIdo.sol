...
contract StakingLaunchpad is ReentrancyGuard {
    ...
    returns (bool)
  {
    ...
    if (_stakeAmount >= minLeashStakePerUser && _stakeAmount < 100e18) {
      ...
      usersUsdLimit[msg.sender] = usersUsdLimit[msg.sender].add(1000e18);
      ...
      LeashToken.safeTransferFrom(msg.sender, address(this), _stakeAmount);
      user.amountLocked = user.amountLocked.add(_stakeAmount);
      usersUsdLimit[msg.sender] = usersUsdLimit[msg.sender].add(2500e18);
      user.isParticipating = true;
      user.unlockTokenTime = idoStartTime.add(lockTime);
      Pools[1] = Pools[1].add(1);
      return true;
      ...
      LeashToken.safeTransferFrom(msg.sender, address(this), _stakeAmount);
      user.amountLocked = user.amountLocked.add(_stakeAmount);
      usersUsdLimit[msg.sender] = usersUsdLimit[msg.sender].add(4000e18);
      user.isParticipating = true;
      user.unlockTokenTime = idoStartTime.add(lockTime);
      Pools[2] = Pools[2].add(1);
      return true;
    }
  }
