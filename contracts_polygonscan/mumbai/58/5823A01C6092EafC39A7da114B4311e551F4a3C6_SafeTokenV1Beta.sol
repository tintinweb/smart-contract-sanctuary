...
interface IERC721 {
    ...
    /**
     * @dev returns the owner of contract 
     * 
     */
...
// tracks contract
 /**
 * @title PaybeatsTracks for NFTs
 */
 abstract contract RewardTracks {
    ...
    ReentrancyGuard
{
    ...
    /** address => nft tokens count => beats amount */
        //mapping(address => SummarizedAddressInfo) internal summarizedNftTable;
    /** nft contract address => nft token id => beats amount */
        //mapping(address => mapping(uint256[] => nftTokenInit)) internal detailedNftTable;
    /** user address => list of nft contract addresses */
        //mapping(address => address[]) internal userNftContracts;
    ...
    function mintNftContract (
        ...
        'Error: empty token Id list');

        require(IERC721(_nftContract).owner() == _msgSender(),
        ...
        summarizedNftTable[_nftContract].tokensCount = summarizedNftTable[_nftContract].tokensCount + tokenIds.length;
    }
    ...
    function _createVestingSchedule(
        ...
        token2value[nftTokenAddress][_tokenId] = token2value[nftTokenAddress][_tokenId].sub(vestingAmount);
