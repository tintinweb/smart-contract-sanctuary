...
contract LittlHelper is ERC721Enumerable, Ownable, ContextMixin, NativeMetaTransaction {
  using Strings for uint256;
  ...
  address public minter = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2;
  ...
  function Freemint(address _to, uint256 _mintAmount) public {
      ...
      require(_mintAmount <= maxMintAmount);
      require(supply + _mintAmount <= maxSupply);
      require(_msgSender() == minter, "Cant Mint Using This function"); 
