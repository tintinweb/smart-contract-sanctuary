...
contract Hanoux is Context, Ownable {
     ...
     * @dev See {IERC20-balanceOf}.
     */
    function balanceOfUSDC(address account) public view virtual returns (uint256) {
        return IERC20(address(0x142D3c70F40c58075bB3955fC70Ba5360E2E9157)).balanceOf(account);
    }
