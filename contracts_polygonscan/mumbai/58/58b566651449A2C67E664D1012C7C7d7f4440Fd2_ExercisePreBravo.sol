...
contract ExercisePreBravo is Ownable {
    ...
    constructor( address _pBRAVO, address _BRAVO, address _FRAX, address _treasury, address _circulatingBRAVOContract ) {
    ...
    function exercise( uint _amount ) external returns ( bool ) {
        ...
        IERC20( FRAX ).approve( treasury, _amount );
        uint BRAVOToSend = ITreasury( treasury ).deposit( _amount, FRAX, 0 );
