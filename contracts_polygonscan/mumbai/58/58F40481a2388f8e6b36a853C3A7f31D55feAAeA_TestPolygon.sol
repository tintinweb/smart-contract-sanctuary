...
contract TestPolygon is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    uint256 public _saleStartTime = 1634659200;
    ...
    address t1 = 0x97EF605Ff1A1527b9239Bb009D7D1B004a5Ef384;

    address[] addressList = [t1];
    uint256[] shareList = [100];

    constructor()
    ERC721("TestPolygon", "TPG")
    ...
    function mint(uint256 _count) public payable {
        ...
        require( block.timestamp >= _saleStartTime,                           "Sale has not started yet" );
        require( _count <= MAX_TOKENS_PER_TRANSACTION,          "You can mint a maximum of 20 Tokens at once" );
        require( supply + _count <= MAX_SUPPLY,                                  "Exceeds max token supply" );
    ...
    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        TEST_PROVENANCE = _provenanceHash;
    }
    ...
    function setSaleStartTime(uint256 _newStartTime) public onlyOwner {
        _saleStartTime = _newStartTime;
    }
}
