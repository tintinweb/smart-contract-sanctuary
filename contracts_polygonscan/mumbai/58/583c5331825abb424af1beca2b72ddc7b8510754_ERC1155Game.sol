    ...
    ReentrancyGuardUpgradeable
{
    ...
    event CookedDish(uint256 tokenId, address owner, uint[] ingredientIds, uint[] ingredientQty);
    ...
    function cookDish(
        ...
        emit CookedDish(id, owner, tokenType[id].burnTokenIdRequired, newBurnTokenQtyReqd);
        return true;
    }
