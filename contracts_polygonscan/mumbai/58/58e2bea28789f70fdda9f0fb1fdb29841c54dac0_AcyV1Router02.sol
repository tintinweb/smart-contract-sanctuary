...
contract AcyV1Router02 is IAcyV1Router02 {
    ...
    address[3] public middleTokenList = [
        0x632fa2CbF6ff637999736fE5d05210c3e0617BfD, // Token X
        0xe4F3d94D0bF7dAe710dABea760cD9510382D0E95, // Token Y
        0x0EA3eFDa74e00745eC8402Ce3206a902313cAcc0  // Token Z
    ];
...
library AcyV1Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'0a1b5e745fb51a2019fed149e1c438ef55531a9802756996d09beb89facdb1ee' // init code hash
            ))));
    }
