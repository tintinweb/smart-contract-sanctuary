...
contract Certification {
    ...
    function generateCertificate(string memory _id, string memory _name, string memory _issuer, string memory _data, uint256 _issuetime, uint256 _validation) external {
        ...
        tokenContract.transfer(msg.sender, 200);
