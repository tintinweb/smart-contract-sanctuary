...
//1 replace IERC20 with ERC20 (we use the contract from now on)
//2 use increase increaseAllowance instead of approve here IERC20(erc20Address).approve(strategyContractAddress, strategyAmount);
//3 remove want.safeTransferFrom(msg.sender, address(this), totalPrice); this in the strategy contract
//4 implement a test function in the strategy in order to transfer erc20 tokens from nomoDrop to anyone just to ensure our balance is decreasing
//5 fix tests
