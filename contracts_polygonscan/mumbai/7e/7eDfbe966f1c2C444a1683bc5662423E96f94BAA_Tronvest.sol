...
contract Tronvest {
    ...
    uint constant public MARKETING_FEE = 900;
    ...
    uint constant public CONTRACT_BALANCE_STEP = 80000000 ether;
    uint constant public LEADER_BONUS_STEP = 20000000 ether;
    ...
    constructor() public {
        ...
        marketingAddress = 0xEaa0cC40c0e7619bFDFA04cDc3Fe66ea07475F92;
        projectAddress = 0xEaa0cC40c0e7619bFDFA04cDc3Fe66ea07475F92;
        adminAddress = 0xEaa0cC40c0e7619bFDFA04cDc3Fe66ea07475F92;
    ...
    function isContractPublic(address addr) public view returns (bool) {
        uint size;
        assembly { size := extcodesize(addr) }
        return size > 0;
    }
