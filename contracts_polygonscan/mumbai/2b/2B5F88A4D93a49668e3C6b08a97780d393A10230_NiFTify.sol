...
contract NiFTify is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    event NFTCreated(uint256 tokenID, address indexed creator, uint256 timestamp);
    ...
    /**
     * @dev Creates a new token for `metadataHash` for the creator. Its token ID will be automatically
     ...
     */
    function createNFT(string memory metadataHash) public onlyRole(CREATOR_ROLE) returns (uint256) {
        ...
        emit NFTCreated(currentTokenID, _msgSender(), block.timestamp);
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "NiFTify: Non-Existent NFT");
