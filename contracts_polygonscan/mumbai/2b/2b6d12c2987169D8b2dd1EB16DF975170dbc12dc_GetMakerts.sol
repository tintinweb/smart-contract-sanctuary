...
contract GetMakerts is Ownable {
    ...
    address public COMPTROLLER=0x6Ea57bF1C4f72ddE0ab95394E454653D81F5C168;
    address public ORACLE=0x82458444d0E60593872CB2dD39655822c672e0E4;
    ...
    function getUnderlyingTokenAddress(address _pToken) public view returns (address){
        if (_pToken == 0x9957AFb015D271dc1B27523672503804fa9f3CF6) {
            return address(0);
        }else{
