...
contract VaultFireStrategy is BaseStrategyLP {
    ...
    function _vaultDeposit(uint _amount) internal override {
    ...
    function earn() external override {
        ...
        // conversion  to xCNT
        // xCNT-wmatic using one sided liquidiy
        // 
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public wantAddress = 0x766F03e47674608cCcF7414f6c4DDF3d963Ae394;
    ...
    address public vaultChefAddress = 0xBb88eCB321BA848cf5114Ae5a70c15dB8a654E01;
