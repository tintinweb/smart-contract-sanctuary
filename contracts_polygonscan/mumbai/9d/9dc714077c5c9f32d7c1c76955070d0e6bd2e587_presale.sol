...
contract presale {
 ...
 address payable private _wallet = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2); //Replace your wallet address here
 
 address private admin;
 
 mapping(address => uint256) public balance;
 uint256 public constant mincap = 1 * 250 * 100000; // 100 Matic Min contribution
