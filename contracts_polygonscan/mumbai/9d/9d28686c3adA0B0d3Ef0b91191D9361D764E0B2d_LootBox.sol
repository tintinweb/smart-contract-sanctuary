...
contract LootBox is Ownable, Pausable, ReentrancyGuard, VRFConsumerBase {
   ...
   * @param _minQuantityPerOpen Minimum number of items to mint per open.
  ...
  function setTierSettings(
    ...
    require(_minQuantityPerOpen <= _maxQuantityPerOpen, "LootBox#setTierSettings: WRONG_QUANTITY_RANGE");

    TierSettings memory settings = TierSettings({
      minQuantityPerOpen: _minQuantityPerOpen,
