...
contract Memes is ERC1155, Ownable, Royalties {
    ...
    function sendRoyalty(
        ...
        uint256 royaltyCreator = percentRoyalty.mul(totalAmount.div(100));
        uint256 amountSeller = totalAmount.sub(royaltyCreator);
   ...
   function getPercentRoyalty(
        uint256 _id,
        address _creator
    ) public view returns (uint256 percentRoyalty)  {
...
abstract contract Royalties {
  ...
  */
  ...
  event RecievedRoyalties (address indexed creator, address indexed buyer, uint256 indexed amount);
    ...
    constructor (uint256 _amount, address _creator) public {
