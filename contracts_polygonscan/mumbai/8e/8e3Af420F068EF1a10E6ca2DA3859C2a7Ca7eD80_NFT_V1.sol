...
contract NFT_V1 is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, IRoyalty {
   ...
   function initialize() initializer public {
    ...
    function setTokenRoyaltyPercentage(uint8 _creatorRoyaltyPercentage) public returns (uint8) {
         require(
    ...
    function createToken(string memory _tokenURI) public returns (uint) {
        ...
        setTokenCreator(newItemId, payable(msg.sender)); 
        emit TokenCreator(tokenCreators[newItemId], creatorRoyaltyPercentage);
        return newItemId;
    }
