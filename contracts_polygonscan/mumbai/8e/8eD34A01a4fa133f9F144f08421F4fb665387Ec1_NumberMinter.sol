...
contract NumberMinter is ERC721Enumerable, AccessControl, PriceConsumerV3 {
  ...
  function batchMintWithoutTokenURI(uint256 num) external payable isActive {
    ...
    require(
      msg.value >= getTokenPriceInWeth(),
      "NumberMinter: Sent ETH is not enough"
    );

    // transfer WETH to the beneficiary
