...
// Info of each user that stakes ERC20 tokens.
    ...
    event Deposit(address indexed user,uint256 indexed stakeId,uint256 indexed amount);
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        stake.rewardDebt = user.amount.mul(accTokenPerShare).div(PRECISION_FACTOR);
