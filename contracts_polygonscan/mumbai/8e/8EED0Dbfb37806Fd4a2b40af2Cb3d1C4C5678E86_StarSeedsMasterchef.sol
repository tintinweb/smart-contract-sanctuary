...
//0xFbfe7C5c437eFFD9730913804e4CD8B890D62A9c),
        poolInfo.push(PoolInfo({
        lpToken : IERC20(0xe78d052Ac5De5e838c48E9F591546f5bb0F05928),
        allocPoint : 700,
...
///////////////// Only Owner Functions //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function collectFees(uint _pid) external onlyOwner{
        ...
        (bool success) = poolInfo[_pid].lpToken.transfer(msg.sender,fees);
        require(success,"Trasnfer Failed");
        poolInfo[_pid].depositFees -= fees;
    }
...
//////////// onlyOperator functions //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function fundMasterChef(uint _amount) external onlyOperator{
        ...
        bool success;
        Star.approve(address(this), _amount);
...
//////////// User functions //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        PoolInfo storage pool = poolInfo[_pid];
        require(pool.lpToken.balanceOf(msg.sender)>=_amount,"LP token balance is less then deposit amount");
        require (_amount > pool.depositFeeBP,"Deposit needs to be greater then deposit fee.");
        UserInfo storage user = userInfo[_pid][msg.sender];
        updatePool(_pid);
        payOrLockupPendingStar(_pid);

        IERC20 token = IERC20(0xe78d052Ac5De5e838c48E9F591546f5bb0F05928);

        token.approve(address(this), _amount);
            
        token.transferFrom(address(msg.sender), address(this), _amount); //transfer the lp from the user to the contract

        if (pool.depositFeeBP > 0) {
            uint256 depositFee = _amount.mul(pool.depositFeeBP).div(100); //calcualte the fee
            pool.depositFees += depositFee; //add collected fee amoutn to fee tracker            
