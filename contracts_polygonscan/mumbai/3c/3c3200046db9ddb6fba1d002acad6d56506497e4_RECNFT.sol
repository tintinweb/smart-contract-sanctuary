    ...
    OwnableUpgradeable
{
    ...
    function safeMint(
        address to,
        string memory import_source,
        string memory serial_number_base,
        string memory serial_number_start,
        string memory serial_number_end,
        uint256 quantity,
        string memory certificate_type,
        string memory vintage_date,
        ...
        nftList[tokenId].import_source = import_source;
        nftList[tokenId].serial_number_base = serial_number_base;
        nftList[tokenId].serial_number_start = serial_number_start;
        nftList[tokenId].serial_number_end = serial_number_end;
        nftList[tokenId].quantity = quantity;
        nftList[tokenId].certificate_type = certificate_type;
        nftList[tokenId].vintage_date = vintage_date;
        nftList[tokenId].created_at = created_at;
        nftList[tokenId].updated_at = updated_at;
    }
