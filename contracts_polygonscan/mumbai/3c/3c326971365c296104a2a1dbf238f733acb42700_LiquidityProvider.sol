...
contract LiquidityProvider is AccessControl, ReentrancyGuard {
    ...
    event FundTransferred(address indexed token, address indexed to, uint256 amount);
    ...
    function transferFunds (
        ...
        emit FundTransferred(_tokenAddress, _to, _amount);
    }
