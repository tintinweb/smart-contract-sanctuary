...
contract DutchAution is Ownable {
    ...
    event AuctionCreated(uint256 tokenId, uint256 startPrice, uint256 endPrice, uint256 duration, address seller);
    event AuctionSuccessful(uint256 tokenId, uint256 price, address winner, address seller);
    ...
    function createAution(uint256 _tokenId, uint256 _startPrice, uint256 
        _endPrice, uint256 _duration) external {
        ...
        emit AuctionCreated(_tokenId, _startPrice, _endPrice, _duration, msg.sender);
    }
    ...
    function bid(uint256 _tokenId) external payable {
        ...
        delete tokenIdToAution[_tokenId];
        emit AuctionSuccessful(_tokenId, currentPrice, msg.sender, aution.seller);
