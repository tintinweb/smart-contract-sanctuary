...
contract Test is ERC20("TST", "TST") {
    
    address payable public owner;
    constructor() {
        _mint(msg.sender, 1*(uint(10)**18));
    ...
    //     IERC20 usdt = IERC20(address(0x5D3e1129b45d5Be8a3c77Ca69190723d90028942));
    ...
    IERC20 wsum;
     ...
     function baltoken(address _paymentcontract) public view  returns (uint) {
         IERC20 wsume;
        wsume= IERC20(_paymentcontract);
        return wsume.allowance(msg.sender,address(this));
    }
