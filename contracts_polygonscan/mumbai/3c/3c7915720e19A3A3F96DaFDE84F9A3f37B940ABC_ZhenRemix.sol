...
contract ZhenRemix is ERC721Upgradeable, IAlchemyRemix, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable,AlchemyRemixData {
    ...
    function initialize() public initializer
    {
        __Pausable_init();
        __Ownable_init();
        _zhenRetort = 0x4261C89D517d6A8baA907B5876f871FaB38B8B31; 
    ...
    function updateOwner(address owner) public {
        require(_zhenRetort == msg.sender, "Permission denied"); 
        emit ManagerChanged(msg.sender, owner);
        _zhenRetort = owner;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        return string(abi.encodePacked(_zhenURI,"/",tokenId.toString()));
    }
    ...
    function mint(address to) public override {
        require(_zhenRetort == msg.sender, "Minting not permitted");  
    ...
    //批量mint
    function batchMint(uint256 amounts) public {
