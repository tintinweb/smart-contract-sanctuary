...
// contract RubberDuckies is ERC721 {
//     uint256 public tokenCounter;
//     constructor () public ERC721 ("Rubber Duckies", "RDUCKS"){
//         tokenCounter = 0;
//     }

//     function mintDuckie(string memory tokenURI) public returns (uint256) {
...
// }
contract RubberDuckies is ERC721, Ownable {
    
    using SafeMath for uint256;

    string public RubberDuckiesPROVENANCE = "";
    ...
    constructor() public 
    ERC721("Rubber Duckies", "RDUCKS") {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        RubberDuckiesPROVENANCE = _provenanceHash;
    }
    ...
    function mintDUCKIES(uint256 _count) public payable {
