    ...
    CarbonOffsetBatchesStorage
{
    ...
    event SerialAndQuantityUpdated(
        uint256 tokenId,
        string serialNumber,
        uint256 quantity
    );
    ...
    function unsetSerialNumber(uint256 tokenId) public onlyVerifier {
        serialNumberExist[nftList[tokenId].serialNumber] = false;
    }
    ...
    function setSerialandQuantity(
        ...
        emit SerialAndQuantityUpdated(tokenId, newSerialNumber, newQuantity);
    }
