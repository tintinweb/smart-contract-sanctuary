...
// File: contracts/TestNFT721_00.sol
...
contract TestNFT721_00 is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() initializer public {
        __ERC721_init("TestNFT721_00", "JG_00");
        __ERC721URIStorage_init();
        __Ownable_init();
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmdNTRo4w1QNGRYdQ6xzCDVEA5cgGeDUMHpAFrrXVRPGzk";
    }
