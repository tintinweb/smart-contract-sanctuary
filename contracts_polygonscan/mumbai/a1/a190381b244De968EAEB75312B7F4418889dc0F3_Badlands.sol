...
contract Badlands is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "http://localhost:8888/metadata/";
	string private _contractURI = "ipfs://xxxxxxx";
	...
	address private _signerAddress = 0x30633a4356F35abeD59CA44BD9Bc3Bd7269DE7B9; //Backend Signer
	...
	constructor() ERC721("Badlands", "BAD") {}
	...
	function presaleBuy(
		...
		require(totalSupply() + qty < maxSupply, "out of stock");
		require(presaleCounter + qty < maxPresale, "presale - out of stock");
		require(pricePerToken * qty == msg.value, "exact amount needed");
		require(qty <= 20, "no more than 20 at once");
