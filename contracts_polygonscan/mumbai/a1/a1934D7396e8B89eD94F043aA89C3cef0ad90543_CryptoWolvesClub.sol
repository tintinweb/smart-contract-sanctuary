...
contract CryptoWolvesClub is ERC721Enumerable, PaymentSplitter, Ownable {
    ...
    uint256 public constant PRESALE_PRICE = 0.0007 ether;
    uint256 public constant TEAM_RESERVE = 25; //Might change

    uint256 private publicSalePrice= 0.15 ether;

    //Placeholder
    address private presaleAddress = 0xA3E67c48024433Dbb80cE7b41D7221fA80799e26;
    address private giftAddress = 0xA3E67c48024433Dbb80cE7b41D7221fA80799e26;
        ...
        PaymentSplitter(team_, teamShares_)
    {
        ...
        setBaseURI("ipfs://QmY1nTUt5hSRS8efwm3XMogNdCvMFjMi9xNSYBKSvPHHJw/");
        setNotRevealedURI("ipfs://QmWBpnaFKVoJ6SKE6DDTo4XgSA6Rwcon5wCXSYFmkx2x72");
