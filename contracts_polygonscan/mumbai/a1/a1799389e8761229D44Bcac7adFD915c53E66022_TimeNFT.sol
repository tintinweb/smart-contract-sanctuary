...
contract TimeNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public pure returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Time",','"description": "The most valuable thing in the entire world", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function claim() public nonReentrant {
        require(tickTock.current() >= 0 && tickTock.current() < 1440, "Token ID invalid");
    ...
    constructor() ERC721("Day ZERO", "TIME") Ownable() {}
}
