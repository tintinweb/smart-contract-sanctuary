    ...
    ICharacter
{
    ...
    mapping(uint8 => uint256) bundleTokensCount;
    ...
    function setPreMintStartTime() external onlyOwner {
        ...
        buyTAGChecks(characterId,bundleType)
    {
        ...
        tagSoldInPercentage = TAG.balanceOf(address(this)).mul(100).div(totalTags);
        ...
        if(seed.mod(overflowChance) == 0) {
            CORE.transfer(msg.sender, overflowCore);
