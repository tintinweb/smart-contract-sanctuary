...
contract PreSaleNFTPool is Ownable, Pausable {
    ...
    modifier onlyAdmin() {
        require(admins[msg.sender] = true, "Admin: invalid permission");
        _;
    }
    ...
    function registerPool(
        ...
        address _wallet,
        address _signer
    ) external whenPaused onlyAdmin returns (address pool) {
     ...
     */
    function setOfferedCurrencyRateAndDecimals(address _token, uint256 _rate, uint256 _decimals) external onlyAdmin
    {
     ...
     */
    function setOfferedCurrencyRate(address _token, uint256 _rate) external onlyAdmin {
     ...
     */
    function setNewSigner(address _newSigner) external onlyAdmin {
     ...
     */
    function setOfferedCurrencyDecimals(address _token, uint256 _decimals) external onlyAdmin {
     ...
     */
    function setCloseTime(uint256 _closeTime) external onlyAdmin {
     ...
     */
    function setOpenTime(uint256 _openTime) external onlyAdmin {
        openTime = _openTime;
        emit PoolStatsChanged();
    }
    ...
    function changeSaleToken(address _token) external onlyAdmin {
