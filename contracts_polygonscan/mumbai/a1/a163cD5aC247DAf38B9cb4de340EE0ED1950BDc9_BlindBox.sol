    ...
    function StartSeries(
       ...
       uint256[] memory allowedCurrencies,
        bool isGenerative,  address bankAddress, uint256 royalty ) onlyOwner public {
            Series1 memory series = Series1( stringsData[0], stringsData[1], stringsData[2], stringsData[3], integerData[0], integerData[1],stringsData[3]);
        if(isGenerative){
            // start generative series
            // generativeSeriesId.increment();
            generativeSeries(stringsData[3],  stringsData[0], stringsData[1], stringsData[2], stringsData[3], integerData[0], integerData[1], royalty);
            ...
            nonGenerativeSeries(stringsData[3], stringsData[0], stringsData[1], stringsData[2], stringsData[3], integerData[0], integerData[1], royalty);
...
/** 
    ...
    */
    ...
    function _openNonGenBoxOffchain(uint256 boxId, address collection) private {
        ...
        emit NonGenNFTsMinted(boxesNonGen[boxId].series, boxId, from, to, rand, boxesNonGen[boxId].countNFTs);
    }
