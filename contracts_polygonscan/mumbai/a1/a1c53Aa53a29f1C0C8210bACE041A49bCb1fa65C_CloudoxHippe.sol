...
contract CloudoxHippe is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) ERC1155Tradable("HippeTest v31", "HTV31", "http://opensea-creatures-api.herokuapp.com/api/creature/{id}", _proxyRegistryAddress) {}
