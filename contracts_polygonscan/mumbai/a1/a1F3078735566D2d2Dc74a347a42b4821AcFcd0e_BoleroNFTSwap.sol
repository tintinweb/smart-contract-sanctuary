...
contract BoleroNFTSwap is Controller {
	...
	event CreateSellOffer(uint256 sellCounter, address from, address nftAddress, address wantAddress, uint256 nftTokenID, uint256 wantAmount, string status);
	event CancelSellOffer(uint256 sellCounter, address from, address nftAddress, uint256 nftTokenID, string status);
	event ExecuteSellOffer(uint256 sellCounter, address from, address to, address nftAddress, address wantAddress, uint256 nftTokenID, uint256 wantAmount, string status);

	event CreateBuyOffer(uint256 buyCounter, address from, address nftAddress, address wantAddress, uint256 nftTokenID, uint256 wantAmount, string status);
	event CancelBuyOffer(uint256 buyCounter, address from, address nftAddress, uint256 nftTokenID, string status);
	event ExecuteBuyOffer(uint256 buyCounter, address from, address to, address nftAddress, address wantAddress, uint256 nftTokenID, uint256 wantAmount, string status);

	event OpenBid(uint256 bidCounter, address from, address nftAddress, address wantAddress, uint256 nftTokenID, uint256 startOffer, uint256 startTime, uint256 endTime, string status);
	event PerformBid(uint256 bidCounter, address from, address to, address nftAddress, address wantAddress, uint256 nftTokenID, uint256 startOffer);
	event CancelBid(uint256 bidCounter, address from, address nftAddress, uint256 nftTokenID, string status);
	event ExecuteBid(uint256 bidCounter, address from, address to, address nftAddress, address wantAddress, uint256 nftTokenID, uint256 wantAmount, string status);
