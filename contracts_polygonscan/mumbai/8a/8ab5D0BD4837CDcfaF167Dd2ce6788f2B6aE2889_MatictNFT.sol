...
contract MatictNFT is ERC721, AccessControl {
  ...
  constructor(address _ChildChainManagerProxy) ERC721("CNFT", "CNFT") {
  ...
  function withdraw(uint256 tokenId) external {
    require(msg.sender == ownerOf(tokenId), "INVALID_TOKEN_OWNER");
    _burn(tokenId);
  }
