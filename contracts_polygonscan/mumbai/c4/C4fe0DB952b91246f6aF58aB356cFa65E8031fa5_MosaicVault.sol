    ...
    PausableUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        if (_tokenOut == _tokenIn) {
            require(vaultConfig.getCurrentTokenLiquidity(_tokenIn) >= _amount, "ERR: VAULT BAL");
        }
        hasBeenWithdrawn[_id] = true;
        lastWithdrawID = _id;
...
interface IMosaicVault {
    ...
    event TransferFundsUnlocked(address indexed tokenAddress, uint256 amount, bytes32 uniqueId);
