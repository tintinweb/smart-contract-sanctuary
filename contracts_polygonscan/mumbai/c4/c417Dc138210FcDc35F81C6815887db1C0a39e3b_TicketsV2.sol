...
contract TicketsV2 is ERC721Enumerable, TokenWithdraw, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address _mintingToken, address _beneficiary) ERC721("MetaSoccer Youth Scout Tickets", "MSYST") {
    ...
    function mintForGiveaway(uint256 _num_to_mint, string memory _type) external onlyRole(DEFAULT_ADMIN_ROLE) {
