...
contract GameMaster is Initializable, AccessControlUpgradeable, PausableUpgradeable, ICharacter {
        ...
        oncePerBlock(msg.sender)  
    {
        ...
        if(ctype == CharacterType.Elite) {
            require(totalMinted < totalEliteToBeMinted, "No more elites left to mint");
            ...
            // totalMinted.div(100).add(1) calculates the same for elites
            characters.mint(msg.sender, seed, CharacterType.Elite, totalMinted.div(100).add(1));

        } if(ctype == CharacterType.Trainee) {
            require(totalMinted < totalTraineeToBeMinted, "No more trainees left to mint");
            ...
            // totalMinted.div(5) calculates the same for trainees
            characters.mint(
                msg.sender,
                seed,
