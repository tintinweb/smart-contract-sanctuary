...
contract AtlantisLens {
    ...
    function aTokenMetadata(AToken aToken) public returns (ATokenMetadata memory) {
        ...
        if (compareStrings(aToken.symbol(), "aEther")) {
...
contract GovernorAlpha {
    ...
    function quorumVotes() public pure returns (uint) { return 65000e18; } // 65,000 = 1% of Atlantis

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 35000e18; } // 35,000 = 0.55% of Atlantis

    /// @notice The maximum number of actions that can be included in a proposal
    function proposalMaxOperations() public pure returns (uint) { return 30; } // 30 actions

    /// @notice The delay before voting on a proposal may take place, once proposed
    function votingDelay() public pure returns (uint) { return 10; } // 10 block
