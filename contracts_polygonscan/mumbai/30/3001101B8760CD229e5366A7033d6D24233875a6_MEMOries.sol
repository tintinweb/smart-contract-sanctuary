...
abstract contract ERC20MEMO is IERC20{
...
abstract contract ERC20PermitMEMO is ERC20MEMO, IERC2612Permit {
...
contract OwnableMEMO is OwnableData {
...
contract MEMOries is ERC20PermitMEMO, OwnableMEMO {
    ...
    constructor() ERC20MEMO("MEMOries", "MEMO", 9) ERC20PermitMEMO() {
