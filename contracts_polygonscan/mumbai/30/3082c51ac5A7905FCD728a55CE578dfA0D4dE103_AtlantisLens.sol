...
/**
 * @title Atlantis's AErc20 Contract
...
contract AToken is ATokenInterface, Exponential, TokenErrorReporter {
    ...
    function mintFresh(address minter, uint mintAmount) internal returns (uint, uint) {
         ...
         *  Note: The aToken must handle variations between ERC-20 and MATIC underlying.
...
contract GovernorAlpha {
    ...
    function quorumVotes() public pure returns (uint) { return 260000e18; } // 400,000 = 4% of Atlantis

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 65000e18; } // 100,000 = 1% of Atlantis
    ...
    function votingPeriod() public pure returns (uint) { return 100; } // ~3 days in blocks (assuming 2s blocks)
