...
// File: contracts/SpiritGreenGhost.sol


pragma solidity 0.6.12;


// SpiritGreenGhost with Governance.
contract SpiritGreenGhost is BEP20('SpiritGreenGhost', 'SGG') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            uint256 burnAmount = burnActive ? amount.mul(1).div(100) : 0;
            // 99% of transfer sent to recipient
            uint256 sendAmount = amount.sub(burnAmount);
            require(amount == sendAmount + burnAmount, "TESTSGG::transfer: Burn value invalid");
    ...
    function setBurnActive(bool _active) public onlyOwner {
        burnActive = _active;
    }
