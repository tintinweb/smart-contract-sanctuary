...
contract MglobeGameERC1155 is ReentrancyGuard, Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
	...
	event Minted(address toAddress, uint256 tokenId, uint256[] characters, string metadata);
  ...
  function fetchNFTAddresses() public view returns(address[] memory) {
   ...
   fallback() external payable {}
    ...
    /**
      ...
      * @param imageUri Image url for this NFT
      * @param factoryContractAddress contract address to generate characters metadata
      * @return true
      */     
	function mintErc1155(        
        ...
        external
        isOperator
        isNFTAllow(factoryContractAddress)
        nonReentrant returns(bool)
    {
		...
		emit Minted(to, tokenId, characters, metadata);
		return true;
	}
