...
contract APIConsumer is ChainlinkClient {
    ...
    uint256 bidPrice = 1000000000000;//0.0001 Eth
    ...
    function getUserPrediction(address addr) public view returns(string memory prediction){
        return bytes32ToString(mapPrediction[addr]);
    }

    function declareWinner() onlyOwner external payable {
