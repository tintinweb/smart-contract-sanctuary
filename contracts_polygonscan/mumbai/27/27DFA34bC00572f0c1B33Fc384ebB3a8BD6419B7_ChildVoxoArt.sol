    ...
    ContextMixin
{
        ...
        public initializer
    {
        ...
        name = name_;
        symbol = symbol_;
        CONTRACT_URI = "https://api.cypherverse.io/os/collections/voxoart";
    }
    ...
    */
        ...
        only(DEPOSITOR_ROLE)
    {
        ...
        require(
            user != address(0),
            "ChildVoxoArt: INVALID_DEPOSIT_USER"
        );
    ...
    function mint(
        ...
        require((id > uint(0)), "ChildVoxoArt: INVALID_TOKEN_ID");
        require(((amount > uint(0))), "ChildVoxoArt: INVALID_AMOUNT");
    ...
    function mintBatch(
        ...
        for (uint i = 0; i < ids.length; i++) {
            require( (ids[i] > uint(0)) , "ChildVoxoArt: INVALID_TOKEN_ID");
            require(((amounts[i] > uint(0))), "ChildVoxoArt: INVALID_AMOUNT");
        }
    ...
    function burn(
        ...
        require(
            ...
            "ChildVoxoArt: caller is not owner nor approved"
        );
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "ChildVoxoArt: token transfer while paused");
