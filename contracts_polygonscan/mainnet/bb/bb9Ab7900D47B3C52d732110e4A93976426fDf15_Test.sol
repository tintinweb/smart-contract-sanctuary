...
function _calculatePercentage1000PriceImpact(uint256 _amountPerMille, uint256 _amount) pure returns(uint256)
{
    int i = 100000 - (int(_amount) * 100 * 1000 / (int(_amountPerMille) * 1000));
