...
contract WeirdCubes is ERC721Enumerable, Ownable {
    ...
    uint public constant maxPurchaseSize = 3000;
    ...
    constructor(string memory theBaseURI, address theOwner1, address theOwner2, uint numToken, bool debug) ERC721("WeirdCubes", "WEIRDCUBE")  {
    ...
    function contractURI() public pure returns (string memory) {
        return "https://weirdcubes.vercel.app/contract-info.json";
    }
