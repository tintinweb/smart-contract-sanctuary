...
contract Polypad is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 90000000 * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Polypad";
    ...
    uint256 public _maxTxAmount = 90000 * 10**10;
    uint256 private numTokensSellToAddToLiquidity = 10000000 * 10**10;
    ...
    function _takeCharity(uint256 tBurn) private {
        uint256 currentRate =  _getRate();
        uint256 rBurn = tBurn.mul(currentRate);
