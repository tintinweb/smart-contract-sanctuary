...
contract CryptoKnightKingdom is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  ) ERC721("CryptoKnightKingdom", "CKK") {
  ...
  function mint() public payable {
    ...
    if(supply > 0){
        ...
        giftValue = supply + 1 == maxSupply ? address (this).balance * giftPercentage / 100 : msg.value * giftPercentage / 100;
    }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool d, ) = payable(0xA9D819709d2262869a3b529FC6ec2C8f74853B57).call{value: address(this).balance * 10 / 100}("");
    require(d);
