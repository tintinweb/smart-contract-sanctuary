...
contract VaultFactory is IVaultFactory, Moderable, ReentrancyGuard {
    ...
    address public treasuryAddress = 0xE51975d48158A697A3AdB7aE5F67CC06B92cfc2b;
    ...
    ReentrancyGuard
{
    ...
    /**
     * @dev One token to eToken
     * @return The current staked token ratio.
     */
    ...
    /**
     * @dev FlashLoanProvider can transfer funds from sender to Vault.
     * @param sender Address from where the funds are sent to Vault.
