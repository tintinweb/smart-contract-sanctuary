...
// File contracts/ArtArmySeller.sol
...

{
    ...
    address constant _burnWallet = 0x0000000000000000000000000000000000000000;
    ...
    */
    ...
    function updateSale(uint256 price, uint256 tokenId) external returns (bool){
        require(_sale[tokenId].onSale, "Art Army Sale: The NFT is not in sale");
        require(_sale[tokenId].sellerWallet == payable(_msgSender()), "Art Army Sale: The NFT is not on sale by the wallet sender");

        _sale[tokenId].price = price;

        emit priceUpdated(tokenId);
    ...
    */
    ...
    function sendViaCall(address payable _to, uint256 amount) private{
        ...
        require(sent, "Art Army Sale: Failed to send currency");
    }
