...
contract MushroomsOfTheMetaSouk is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmWgReCJsMJ97fMxsPpniTxxS7u9YxdUbL9p2M9y83ewio/";

  constructor() 
    ERC721("Mushrooms of the MetaSouk", "MMS")
