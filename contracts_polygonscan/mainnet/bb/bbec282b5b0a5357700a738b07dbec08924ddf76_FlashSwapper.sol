...
abstract contract UniswapFlashSwapper {
    ...
    function startSwap(
        ...
        if (tokenBorrow == tokenPay) {
            emit Log("Starting Simple Flash Loan");
