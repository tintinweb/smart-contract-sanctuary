...
contract SalsaBunniesFarm is Ownable {
    ...
    IERC20 public immutable salsaToken;
    ...
    event WhitelistAddresses(address[] users);
    event WithdrawSalsa(address sender, uint256 _amount);
    event ChangeOwnershipNFTContract(address newOwner);
    ...
    function mintNFT(uint8 _bunnyId) external {
        ...
        // Stop minting at the end block
        require(block.number < endBlockNumber, "Minting has ended.");
    ...
    function withdrawSalsa(uint256 _amount) external onlyOwner {
        ...
        emit WithdrawSalsa(msg.sender, _amount);
    }
    ...
    function changeOwnershipNFTContract(address _newOwner) external onlyOwner {
        ...
        emit ChangeOwnershipNFTContract(_newOwner);
    }
}
