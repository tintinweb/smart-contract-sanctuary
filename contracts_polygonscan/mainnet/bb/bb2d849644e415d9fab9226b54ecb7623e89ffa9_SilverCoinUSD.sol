...
contract SilverCoinUSD is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("Silver Coin USD", "SCUSD") {
        uint256 _initialAmount = 10000 * 10 ** decimals();
    ...
    function TransferleriKilitle() public onlyOwner {
        _pause();
    }

    function TransferKilidiAc() public onlyOwner {
        _unpause();
    }
    ...
    function ToplamTokenSayisi() public view returns(uint256) {
        uint256 _currentSupply = totalSupply() / (10 ** decimals());
        return _currentSupply;
    }

    function ArzDusur(address account, uint256 amount) public onlyOwner{
        uint256 _calcAmount = amount * 10 ** decimals();
        _burn(account, _calcAmount);
    }
}