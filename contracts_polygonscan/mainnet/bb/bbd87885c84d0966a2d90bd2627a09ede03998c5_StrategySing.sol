...
interface IMasterChef {
    ...
    function poolInfo(uint256 _pid) external view returns (address, uint256, uint256, uint256, uint256, uint256, bool, uint256, uint256, uint256, uint256);
}
...
contract StrategySing is StratManager, FeeManager {
    ...
    function rewardsAvailable() public view returns (uint256) {
        return IMasterChef(chef).pendingSing(poolId, address(this));
    }
