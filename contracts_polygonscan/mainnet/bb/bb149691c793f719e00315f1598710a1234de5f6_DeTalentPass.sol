...
// File: contracts/teat_contract.sol
...
// import "@openzeppelin/contracts/utils/introspection/[email protected]";

// import "@openzeppelin/contracts/token/ERC721/[email protected]";
// import "@openzeppelin/contracts/token/ERC721/[email protected]";

// import "@openzeppelin/contracts/token/ERC721/extensions/[email protected]";
...
contract DeTalentPass is ERC721, ERC721Enumerable, Ownable {
  using Address for address;
  ...
  string private _baseTokenURI = "https://nft.koding.school/pass_test/";
  ...
  constructor(uint256 maxSupply_) ERC721("DeTalent DAO pass (Testing)", "DTD") {
