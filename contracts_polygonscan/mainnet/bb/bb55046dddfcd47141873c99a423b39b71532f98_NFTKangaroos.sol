...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        require(success, "Address: unable to send value, recipent may have reverted");
    }
...
// File: contracts/KillerTeddiez.sol
pragma solidity ^0.8.0;

contract NFTKangaroos is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;
  ...
  constructor(
    ...
    mint(msg.sender, 69); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
