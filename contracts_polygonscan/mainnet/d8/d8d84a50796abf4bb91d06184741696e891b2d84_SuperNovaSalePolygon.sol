...
contract SuperNovaSalePolygon is ReentrancyGuard {
    ...
    // Price of sale SPN, 5 USDC
    uint256 USDCPerToken = 5;
    // Amount of USDC received in sale
    ...
    constructor (address _SPN, address _USDC, uint256 _startingTimestamp) public {
        SPN = IBEP20(_SPN);
        USDC = IBEP20(_USDC);
        isSaleActive = true;
        owner = msg.sender;
    ...
    function buy (uint256 _amount, address beneficiary) public nonReentrant {
        ...
        require (usdcReceived +  _amount <= 30000 ether, "sale hardcap reached");
