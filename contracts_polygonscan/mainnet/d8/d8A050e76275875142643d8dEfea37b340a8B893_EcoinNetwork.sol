...
// File: contracts/EcoinNetworkToken.sol
...
contract EcoinNetwork is BEP20('Ecoin Network', 'ECN') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTECn::transfer: Burn value invalid");
