...
contract PumpkinPass is Ownable, ERC1155 {
  ...
  event UsePumpkinPass(address user);

  constructor() ERC1155("ipfs://QmRE3MAxF861wLg7shypfsKDhiswYkLyKm7XF4HuaUsJy7") {
  ...
  function purchase(uint256[] memory scrapIds, uint256[] memory scrapAmounts) public {
    ...
    require(spendScraps(burnRate, scrapIds, scrapAmounts) >= cost);
  ...
  function burn() public {
    ...
    emit UsePumpkinPass(msg.sender);
  }
