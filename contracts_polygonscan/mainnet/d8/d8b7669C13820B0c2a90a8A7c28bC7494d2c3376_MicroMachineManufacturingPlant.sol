...
contract MicroMachineManufacturingPlant is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
 ...
 function emergencyWithdrawAnyToken( address _address) public OnlyEmergency {
    ...
    */
    ...
    mapping  ( uint256 => bool ) splitFactories;

    function deployMyFactory( uint256 _plant ) public {
        require  (ManufacturingPlants[_plant]._owner == msg.sender ,"Not the owner" );
        require  (splitFactories[_plant]  ,"Not the owner" );
        splitFactories[_plant] = false;
        ManufacturingPlantCount++;
        migratePlant (  ManufacturingPlantCount, msg.sender ,  1 , ManufacturingPlants[_plant]._timeofexpiration ,ManufacturingPlants[_plant]._timeunitslocked, ManufacturingPlants[_plant]._timeinitiated, ManufacturingPlants[_plant]._lastmanufacture, 0, 12, ManufacturingPlants[_plant]._periodsmanufactured, ManufacturingPlants[_plant]._status  ) ;
    }
