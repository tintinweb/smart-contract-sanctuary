...
pragma solidity ^0.6.12;
    ...
    contract Bscam is Context, IERC20, Ownable {
        ...
        string private _name = 'BINANCE SCAM CHAIN';
        string private _symbol = 'FUCKBSC';
        ...
        function _setMarketingPoolFee(uint256 MarketingPoolFee) external onlyOwner() {
            require(MarketingPoolFee >= 0 && MarketingPoolFee <= 10, 'MarketingPoolFee should be in 0 - 10');
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 1000 , 'maxTxAmount should be greater than 1000000');
