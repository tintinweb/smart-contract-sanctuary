...
contract FarmFactory is ReentrancyGuard {
    event Build(address token, address masterChef, address referral);
        ...
        nonReentrant
    {
        ...
        masterChef.add(3000, IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270), _depositFee);
        masterChef.add(3000, IERC20(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6), _depositFee);
        masterChef.add(3000, IERC20(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), _depositFee);
        masterChef.add(3000, IERC20(0x831753DD7087CaC61aB5644b308642cc1c33Dc13), _depositFee);
        masterChef.add(2000, IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F), _depositFee);
        masterChef.add(2000, IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174), _depositFee);
        masterChef.add(2000, IERC20(0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39), _depositFee);
        masterChef.add(2000, IERC20(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063), _depositFee);
        ...
        emit Build(address(farmToken), address(masterChef), address(referral));
    }
}