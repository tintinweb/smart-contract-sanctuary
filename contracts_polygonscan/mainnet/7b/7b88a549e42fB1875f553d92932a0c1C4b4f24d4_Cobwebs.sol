 ...
 */
contract Cobwebs is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "Cobwebs: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Cobwebs: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "Cobwebs: must have pauser role to unpause");
        _unpause();
    }
