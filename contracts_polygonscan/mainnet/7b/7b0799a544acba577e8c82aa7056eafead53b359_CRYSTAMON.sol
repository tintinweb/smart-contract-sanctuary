...
//compiled for CRYSTAMON project
//SPDX-License-Identifier: Unlicensed
pragma solidity 0.5.16 ;
interface ICRYSTAMON20 {
...
contract CrsytamonTransferable is Crystamontext {
...
contract CRYSTAMON is Crystamontext, ICRYSTAMON20,  CrsytamonTransferable {
  using SafeLogic for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowances;
  string private _name = "Crystamon Token";
