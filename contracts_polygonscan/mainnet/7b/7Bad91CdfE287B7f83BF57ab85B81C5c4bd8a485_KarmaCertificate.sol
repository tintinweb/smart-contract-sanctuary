...
// File: node_modules\@openzeppelin\contracts-upgradeable\token\ERC721\extensions\IERC721EnumerableUpgradeable.sol
...
contract KarmaCertificate is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant PAYED_MINTER_ROLE = keccak256("PAYED_MINTER_ROLE");
    ...
    function initialize() initializer public {
        ...
        //_setupRole(PAYED_MINTER_ROLE, msg.sender);
    }
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://kmc.karmacertificate.com/";
    }
