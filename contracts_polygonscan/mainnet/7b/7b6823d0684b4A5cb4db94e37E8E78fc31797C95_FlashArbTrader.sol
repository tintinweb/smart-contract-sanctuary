...
// File: aave/IFlashLoanReceiver.sol
...
// File: aave/ILendingPoolAddressesProvider.sol
...
// File: aave/FlashLoanReceiverBase.sol
...
contract FlashArbTrader is FlashLoanReceiverBase {
        ...
        override
    {
        ...
        try this.executeArbitrage(_params) {
     ...
     */
    function executeArbitrage(bytes calldata data) public {
        
        // decode data which include swap router addresses at 0 and 1
        ...
        uniswapV2Router = IUniswapV2Router02(address(addresses[0]));
        sushiswapV1Router = IUniswapV2Router02(address(addresses[1]));
    ...
    function bytesToAddress(bytes calldata data) private returns (address addr) {
    bytes memory b = data;
    assembly {
        addr := mload(add(b, 20))
    } 
