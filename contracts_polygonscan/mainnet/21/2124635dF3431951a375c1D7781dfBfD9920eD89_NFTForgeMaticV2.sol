...
contract NFTForgeMaticV2 is ERC1155PresetMinterPauser {
    ...
    function setContractURI(string memory) external onlyAdmin {
        _contractURI = "http://zuzprotocol.com/forge-meta.json";
    }
