...
contract InvestmentSafeFactory is Ownable, IInvestmentSafeFactory {
    ...
    uint256 public immutable override EXIT_GAS = 900460;
    uint256 public immutable override JOIN_GAS = 1327778;
    uint256 public immutable override GAS_CREATE_SAFE = 2829803; //this is the gas used on for safe create
    ...
    function _createSafe(string memory safeName, address safeOwner)
        internal
    ...
    function createSafeFor(string memory safeName, address safeOwner)
        ...
        returns (address payable safe)
    {
        return _createSafe(safeName, safeOwner);
    }
    ...
    function createSafe(string memory safeName)
        ...
        returns (address payable safe)
    {
        return _createSafe(safeName, msg.sender);
    }
    ...
    {
        wethUsedForSafe =
            (tx.gasprice * gas * maticToEthConversionRate) /
            1 ether;
    }
}
