...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RWRD = IERC20(0x3BA4c387f786bFEE076A58914F5Bd38d668B42c3);
    ...
    function deposit() external payable override onlyToken {
        ...
        router.swapExactMATICForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            0,
            path,
            address(this),
            block.timestamp
...
contract Polyn is IERC20, Auth {
    ...
    function swapBack() internal swapping {
        ...
        router.swapExactTokensForMATICSupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
            address(this),
        ...
        if(amountToLiquify > 0){
            router.addLiquidityMATIC{value: amountMATICLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
