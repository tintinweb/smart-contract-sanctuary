...
contract DinoX is ERC721, ERC721Enumerable, Ownable, IERC721Receiver {
    ...
    function mintDNX(uint16 gid, uint256 tokenId, address to) public {
        require(msg.sender == _minter, "E01");
        _safeMint(to, tokenId);
        _gs[tokenId] = gid;
    }
    
    function getGeneration(uint256 tokenId) public view returns (uint16) {
        return _gs[tokenId];
    }
    ...
    function setTokenG(uint16 gid, uint256 tokenId) public onlyOwner {
        _gs[tokenId] = gid;
    }
