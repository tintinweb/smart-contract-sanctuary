...
contract Mage is Ownable, ERC721Holder {
    ...
    function buyPotion(uint index) public {
        gen.transferFrom(msg.sender, address(0), prices[index] * 1e18);
        arenaNft.createToken(msg.sender, index);
    }
