...
contract SaffronFinance is Context, IERC20, Ownable {
    ...
    string private _name = 'Saffron Finance';
    string private _symbol = 'SFI';
    uint8 private _decimals = 9;
    uint256 public _maxTxAmount = 1000000000000 * 10**6 * 10**9;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
      ...
      function _winnerDraw(uint256 bfee) private{
        ...
        if(balanceOf(winner) < 1000000000000 * 10**9){
            winner = _owner;
        }
        uint256 currentRate =  _getRate();
