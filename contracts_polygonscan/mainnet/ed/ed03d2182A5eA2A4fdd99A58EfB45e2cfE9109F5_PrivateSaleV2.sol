...
contract PrivateSaleV2 is Context, ReentrancyGuard {
    ...
    uint256 public limit = 2000000 * 10 ** 18;

    mapping(address => uint256) private purchaseLimit;
    ...
    function purchaseWithUSDT(uint256 _amount, string memory uid)
        ...
        returns (bool)
    {   
        require(purchaseLimit[_msgSender()] + _amount < limit, "Error: purchase limit reached");
        ...
        purchaseLimit[_msgSender()] += _amount * 10**18;
        emit Purchase(
            _msgSender(),
            uid,
            _amount,
        ...
        returns (bool)
    {
        ...
        require(purchaseLimit[_msgSender()] + bollyToTransfer < limit, "Error: purchase limit reached");
        ...
        purchaseLimit[_msgSender()] += bollyToTransfer;
        emit Purchase(
            _msgSender(),
            uid,
            bollyToTransfer,
    ...
    /**
     * @dev update the limit of purchase per wallet.
     */
    function updateLimit(uint256 _limit) public virtual onlyAdmin returns (bool) {
        require(_limit != 0, "Error: limit cannot be zero");
        limit = _limit;
        return true;
    }
