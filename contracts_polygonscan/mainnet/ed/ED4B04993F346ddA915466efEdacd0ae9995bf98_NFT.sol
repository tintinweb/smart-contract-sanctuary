...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public costPresale = 0.032 ether;
  uint256 public costPublic = 0.042 ether;
  ...
  function mintPresale(address _to, uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= 420);
    require(startPresaleTime+14400>block.timestamp);
 ...
 function whitelistUser(address[] memory users) public onlyOwner {
