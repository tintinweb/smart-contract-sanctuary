...
contract BlockheadBuddy is Context, Ownable, ERC1155Burnable {
  ...
  string public constant name = 'Auth0rzd BlockHead Buddy';
  string public constant symbol = 'BLOCKHEADBUDDY';
