...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    MintableToken public farmToken;
    address public tokenTransferOwner;
    ...
    constructor() public {
        farmToken = MintableToken(0x82C7A74f459968a1836d330311f93d51EC30535B);
        
        startBlock = 20373061;

        rewardLocker = IRewardLocker(0xe870070b79cC767526c5B3Cf9411f29ab21B7e9E);
        devAddress = 0x4A2319ba25A82FADB6D7bdc1Fe90373C02aDEC9f;
        tokenTransferOwner = 0x4A2319ba25A82FADB6D7bdc1Fe90373C02aDEC9f;
    ...
    */
    ...
    function setStarTransferOwner(address _tokenTransferOwner) external {
