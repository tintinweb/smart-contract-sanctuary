...
contract MasterChefv2 is Ownable, ReentrancyGuard {
    ...
    // The STAR TOKEN!
    StarToken public star = StarToken(0x1E0f334468226640b0ea76e8dEf87a70012eCcA4);
    address public starTransferOwner = address(0xF60De76791c2F09995df52Aa1c6e2E7DcF1E75d7);
    address public devAddress = address(0xF60De76791c2F09995df52Aa1c6e2E7DcF1E75d7);

    // Contract for locking reward
    IRewardLocker public rewardLocker = IRewardLocker(0xf6d838fDfEcC7153313e080Fb764570302015010);

    // STAR tokens created per block.
    uint256 public starPerBlock = 1000000000000000;
    ...
    uint256 public startBlock = 20111111;
    ...
    constructor() public {
        IERC20(star).safeApprove(address(rewardLocker), uint256(0));
        IERC20(star).safeIncreaseAllowance(
