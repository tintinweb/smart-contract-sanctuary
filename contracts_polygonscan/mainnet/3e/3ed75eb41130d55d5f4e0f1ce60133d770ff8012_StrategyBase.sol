...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Firebird router
    address public constant firebirdRouter = 0xF6fa9Ea1f64f1BBfA8d71f7f43fAF6D45520bfac;
    ...
    function harvest() public override {
        ...
        if (_iceBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(ice_eth_path, _iceBalance.div(2));
            ...
            if (_ice > 0 && _eth > 0) {
                IERC20(ice).safeApprove(firebirdRouter, 0);
                IERC20(ice).safeApprove(firebirdRouter, _ice);
                IERC20(eth).safeApprove(firebirdRouter, 0);
                IERC20(eth).safeApprove(firebirdRouter, _eth);

                IFirebirdRouter(firebirdRouter).addLiquidity(
                    want,
                    ice,
                    eth,
                    _ice,
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public iceETH_LP = 0xf1EE78544a1118F2efb87f7EaCd9f1E6e80e1ea5;
