...
contract UpDown is IERC721Locker,OwnableUpgradeable, ReentrancyGuard {
    ...
    uint256[3] public bonusReward;// [0, 5 , 4 , 3]
    ...
    function initialize(address _meeb, address _nft, uint256[3] memory _bonusReward) external initializer {
        meeb = IERC20(_meeb);
        nft = _nft;
    ...
    function calculateWinAmount(
        ...
        return
        amount * (1000 - HOUSE_EDGE) / 10 / calculateWinChance(number, isOver);
    }
    ...
    */
    ...
    function settleBet(
        ...
        winAmount = winAmount + winAmount * bonusReward[indexBoosted];
