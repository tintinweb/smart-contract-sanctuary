...
contract sSCOOF is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Olympus", "sSCF", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSCF supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSCF
