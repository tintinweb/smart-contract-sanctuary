...
contract EmperorFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"Emperor.Finance";
    string private constant _symbol = "EFIN";
    ...
    address payable private _platformFunds;
    ...
    constructor(address payable addr1, address payable addr2, address payable addr3) {
        ...
        _platformFunds = addr3;
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_teamAddress] = true;
        _isExcludedFromFee[_marketingFunds] = true;
        _isExcludedFromFee[_platformFunds] = true;
    ...
    function addLiquidity() external onlyOwner() {
        ...
        liquidityAdded = true;
        _maxTxAmount = 400000000000 * 10**9;
