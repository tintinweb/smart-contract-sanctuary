...
/// @dev Compare price denominated in quote token between two pools
    ...
    function checkOverflow(int256 a, int256 c, uint256 d, int256 d_AccuracyReduction, int256 a1,int256 a2, int256 b1, int256 b2) internal pure {
        require(a > 0 || c == 0, append12("a < 0 => d: ", uint2str(d)," d_AccuracyReduction:", uint2str(uint256(d_AccuracyReduction)), " a1: ", uint2str(uint256(a1)), " a2: ", uint2str(uint256(a2)), " b1: ", uint2str(uint256(b1)), " b2: ", uint2str(uint256(b2)))); 
    }
    ...
    function calcBorrowAmount(OrderedReserves memory reserves) internal pure returns (uint256 amount) {
        ...
        checkOverflow(a,c,d,d_AccuracyReduction, a1, a2, b1, b2);
