...
// Helpers
import './base/ERC20Internal.sol';
import './helpers/Ownable.sol';
import './helpers/SafeMath.sol';

contract sWarp is ERC20Internal, Ownable {
    ...
    constructor(string memory _name, string memory _symbol) ERC20Internal(_name, _symbol, 9) {
    ...
    /**
        @notice increases sWARP supply to increase staking balances relative to profit_
    ...
    function _storeRebase(
        ...
        rebases.push(
            Rebase({
                ...
                index: index(),
                blockTimeOccured: block.timestamp
            })
        );
    ...
    // Staking contract holds excess sWARP
...
abstract contract ERC20Internal is IERC20Internals {
    using SafeMath for uint256;
