...
interface IPolyStrategyApeswap {
...
contract PolyStrategyApeswap is Ownable, ReentrancyGuard, Pausable, IStrategy {
    ...
    function _farm() internal {
        ...
        IPolyStrategyApeswap(farmContractAddress).deposit(pid, wantAmt, address(this));
    ...
    function withdraw(uint256 _wantAmt) override public onlyOwner nonReentrant returns (uint256) {
        ...
        IPolyStrategyApeswap(farmContractAddress).withdraw(pid, _wantAmt, address(this));
    ...
    function earn() public override whenNotPaused {
        ...
        // Harvest farm tokens
        IPolyStrategyApeswap(farmContractAddress).harvest(pid, address(this));
        ...
        if (earnedAmt2>0)
        {
            IERC20(earnedAddress2).safeTransfer(operator, earnedAmt2);
        }
    ...
    function pendingHarvest() public view returns (uint256) {
        ...
        return IPolyStrategyApeswap(farmContractAddress).pendingBanana(pid, address(this)).add(_earnedBal);
    }
