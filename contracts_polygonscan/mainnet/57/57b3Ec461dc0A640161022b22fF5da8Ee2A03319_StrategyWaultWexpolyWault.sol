...
// File: Vault\StrategyWaultWexpolyWault.sol

// openzeppelin v3.1.0

contract StrategyWaultWexpolyWault is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        wantToEarnedPath = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
    }
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 amount, , ) = IWault(masterChef).userInfo(pid, address(this));
        return amount;
    }
}