...
contract StrongNode is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x7Be32190698Fc4878E1E31a77ae99EaAE64747D6); // Marketing Address
    ...
    string private _name = "StrongNode Edge";
    ...
    uint256 private _buylpPajek = 4;
    
    uint256 private _botNeedsPrevention = 1;
    uint256 private _whaleNeedsPrevention = 4;
