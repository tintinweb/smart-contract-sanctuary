...
interface IMasterChef {
    function deposit(uint256 _pid, uint256 _amount, address strategist) external;
...
contract StrategyKavianWmaticLP is StratManager, FeeManager {
    ...
    constructor() public {
        ...
        want = 0xca2CfC8bF76d9D8eB08E824eE6278F7b885c3b70; // KAVIAN L2-WMATICpair
        output = 0x9A33BAC266b02fAfF8fa566C8Cb5da08820E28ba; //KAVIAN L2
        ...
        masterchef = 0xB664c98548CEbf7024F899e32E467dff00311918; // KAVIAN L2 Masterchef
        poolId = 1;
    ...
    function getHarvestable() external view returns (uint256){
        return IMasterChef(masterchef).pendingKavianL2(poolId, address(this));
    }
}