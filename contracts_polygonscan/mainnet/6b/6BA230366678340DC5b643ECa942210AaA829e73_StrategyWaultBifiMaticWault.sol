...
// File: Vault\StrategyWaultBifiMaticWault.sol

// openzeppelin v3.1.0

contract StrategyWaultBifiMaticWault is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00fbdd194376de19a88118e84e279b977f165d01b8)];
        ...
        token1ToEarnedPath = [address(0x00fbdd194376de19a88118e84e279b977f165d01b8), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00fbdd194376de19a88118e84e279b977f165d01b8)];
    }
