...
// File contracts/OrderProtocolToken.sol

pragma solidity >=0.6.0 <0.8.0;


contract OrderProtocolToken is ERC20, Ownable {
    constructor(uint256 _totalSupply) public ERC20("OrderProtocolToken", "ORDP") {
