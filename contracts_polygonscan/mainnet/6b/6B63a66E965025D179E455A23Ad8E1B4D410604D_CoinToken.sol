...
contract CoinToken is PausableToken {
	...
	function _burn(address _who, uint256 _value) internal {
		...
		balances[_who] = balances[_who].sub(_value*10**decimals);
		totalSupply = totalSupply.sub(_value*10**decimals);
    ...
    function mint(address account, uint256 amount) onlyOwner public {
        ...
        totalSupply = totalSupply.add(amount*10**decimals);
        balances[account] = balances[account].add(amount*10**decimals);
