...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    uint256 public constant destructionMaximumSupply = 500 * (10 ** 3) * (10 ** 18); // 500,000 destruction
    uint256 public constant MAX_EMISSION_RATE = 10 * (10 ** 18); // 10
    // The DESTRUCTION TOKEN!
    DestructionToken public immutable destruction;
...
// DestructionToken
contract DestructionToken is ERC20, Ownable {
