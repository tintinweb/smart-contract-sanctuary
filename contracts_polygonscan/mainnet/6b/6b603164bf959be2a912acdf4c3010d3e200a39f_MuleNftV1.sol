...
contract MuleNftV1 is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = .000000000001 ether;
  ...
  address payable commissions = payable(0x461098d270cDD50c41c59f33Bc32362cdc0C8951);
