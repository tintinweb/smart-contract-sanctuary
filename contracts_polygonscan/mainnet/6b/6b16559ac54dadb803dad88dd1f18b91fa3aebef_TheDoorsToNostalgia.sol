...
contract TheDoorsToNostalgia is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmUNLLsPACCz1vLxQVkXqqLX5R1X345qqfHbsf67hvA3Nn/";
  ...
  constructor() ERC721("The Doors To Nostalgia", "DTN") {
    setHiddenMetadataUri("ipfs://QmeSLmkewSKrmAitC9wHxyYZcaT21LvV13xmiRztZoAgLU/hidden_image.json");
  }
