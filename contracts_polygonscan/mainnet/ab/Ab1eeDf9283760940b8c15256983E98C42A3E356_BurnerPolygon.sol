...
// File: contracts/BurnerPolygon.sol

//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;


contract BurnerPolygon {

    event BurnWithMessage(uint256 amount, string message);
    IERC20 public immutable cndlToken;

    constructor(address _cndlAddress) {
        cndlToken = IERC20(_cndlAddress);
    }

    function burnWithMessage(uint256 _amount, string memory _message) public {
        cndlToken.transferFrom(msg.sender, address(0), _amount);
