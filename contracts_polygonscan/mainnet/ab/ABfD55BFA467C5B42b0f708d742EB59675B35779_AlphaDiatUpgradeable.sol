...
contract AlphaDiatUpgradeable is ERC20PresetMinterPauserUpgradeable {
  modifier onlyOwner() {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "must have admin role");
    _;
  }

  function init(address _minter) public initializer {
    _setupRole(MINTER_ROLE, _minter);
    __ERC20PresetMinterPauser_init("AlphaDiat", "aDiat");
  }
  ...
  function _beforeTokenTransfer(
    ...
    require(hasRole(MINTER_ROLE, _msgSender()), "only minter can transfer");
  }
}
