...
// File: @openzeppelin/contracts-upgradeable/token/ERC20/ERC20SnapshotUpgradeable.sol
...
// File: contracts/polygon/PolygonDAOventuresTokenImplementation.sol
...
contract PolygonDAOventuresTokenImplementation is Initializable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, address _childChainManagerProxy) external initializer {
        require(
