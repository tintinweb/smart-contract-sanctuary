...
contract DinoCompound{
 ...
 function swapDinoToDINOUSDC(uint256 _amount) public {
        dino.transferFrom(msg.sender,address(this),_amount);
        address[] memory path = new address[](2);
            path[0] = dinoAddress;
            path[1] = usdcAddress;
        //sell half of Dino for USDC at sushiswap
        sushiSwap.swapExactTokensForTokens(dino.balanceOf(address(this))/2,0,path,address(this),2626531562);
        
        //LP our DINO and USDC
        sushiSwap.addLiquidity(dinoAddress,usdcAddress,dino.balanceOf(address(this)),usdc.balanceOf(address(this)),0,0,address(this),2626531812);

        //return USDC-Dino LP and any leftover funds to user        
    ...
    function swapAllDinoToDINOUSDC() public {
    ...
    function setApprovals() public onlyAdmin{
        ...
        usdc.approve(sushiAddress,MAX_INT);
