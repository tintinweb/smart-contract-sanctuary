...
// File: Vault\StrategyPolygonfarmSpadeSushiswap.sol

// openzeppelin v3.1.0

contract StrategyPolygonfarmSpadeSushiswap is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
        wantToEarnedPath = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
    }
