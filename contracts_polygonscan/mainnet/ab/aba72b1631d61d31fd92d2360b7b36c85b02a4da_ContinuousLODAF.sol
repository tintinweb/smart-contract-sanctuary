...
contract ContinuousLODAF is Ownable { 
    ...
    */
	...
	function blankSwapAsset(uint _signal) public onlyOwner {
        ...
        uint poolAssetPercentShare = assetValo_tetherbits*100 / (assetValo_tetherbits + oldTetherBalance);
        ...
        if (poolAssetPercentShare > _signal){
            ...
            uint deltaToSwapInTether = (percentageDeltaToSwap * (assetValo_tetherbits + oldTetherBalance)) / 100;
