...
contract BunnyFactoryV2 is Ownable {
    ...
    function setBunnyJson(
        string memory _bunnyId5Json,
        string memory _bunnyId6Json,
        string memory _bunnyId7Json,
        string memory _bunnyId8Json,
        string memory _bunnyId9Json
    ) external onlyOwner {
        bunnyIdURIs[5] = _bunnyId5Json;
        bunnyIdURIs[6] = _bunnyId6Json;
        bunnyIdURIs[7] = _bunnyId7Json;
        bunnyIdURIs[8] = _bunnyId8Json;
        bunnyIdURIs[9] = _bunnyId9Json;
    }
