...
contract TacoBunniesFarm is Ownable {
    ...
    constructor(
        ...
        bunnyIdURIs[0] = string(abi.encodePacked(baseURI, _ipfsHash, "/tacomargarita.json"));
        bunnyIdURIs[1] = string(abi.encodePacked(baseURI, _ipfsHash, "/tacocat.json"));
        bunnyIdURIs[2] = string(abi.encodePacked(baseURI, _ipfsHash, "/tacosupreme.json"));
