...
contract LPNFTWrapper is IWrappedERC20Events, OwnableUpgradeable, TokensRecoverableUpg
{
    ...
    function initialize(IWrappedERC20 _wrappedToken)//, address _vaultContract) 
        public initializer {
    ...
    function initNFT(address _erc1155, string calldata _Uri, bytes calldata _data) external onlyOwner{
    ...
    function setNFTId(address _erc1155, uint _nftid) external onlyOwner{
        erc1155 = IERC1155(_erc1155);
        nftId = _nftid;
    }
