...
// File contracts/interface/IWRAP.sol
...
contract DEXAggregator is Ownable {
    ...
    function swap(
        ...
        if (isNativeToken(inputToken) && msg.value > 0) {
            ...
            IWRAP(wrappedToken).deposit{value: msg.value.sub(_swapData.feeAmount)}();
        ...
        uint256 pendingDust = _swapData.actualSwapAmount.sub(_swapData.totalAmountIn);
