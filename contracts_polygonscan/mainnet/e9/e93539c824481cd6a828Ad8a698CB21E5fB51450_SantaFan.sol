...
contract ERC721MetaTransactionMatic is
    ERC721,
    ContextMixin,
...
contract SantaFan is
    ERC721MetaTransactionMatic,
    ERC721Enumerable,
    Pausable,
    Ownable
{
    ...
    constructor() ERC721MetaTransactionMatic("Santa Fan", "SNTA") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmTsinU4HA6g7mPzwgJ1ZNHd4bZq3urnYcyAGrxq7wBQs2/";
    }
    ...
    function _msgSender()
        internal
        view
        override(ERC721MetaTransactionMatic, Context)
        returns (address sender)
    {
        return ContextMixin.msgSender();
    }
    ...
    function isApprovedForAll(address _owner, address _operator)
        public
        view
        override(ERC721MetaTransactionMatic, ERC721)
        returns (bool isOperator)
    {
        return ERC721MetaTransactionMatic.isApprovedForAll(_owner, _operator);
    }
