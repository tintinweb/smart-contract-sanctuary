...
// File: Vault\libs\IMasterchefv2.sol
...
// File: Vault\StrategyIronfinanceIceWethFirebird.sol

// openzeppelin v3.1.0

contract StrategyIronfinanceIceWethFirebird is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef),address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef)];
        earnedToToken1Path = [address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        token0ToEarnedPath = [address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef)];
        token1ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x004a81f8796e0c6ad4877a51c86693b0de8093f2ef)];
    ...
    function stake(uint256 _wantAmount) internal virtual override{
        IMasterchefv2(masterChef).deposit(pid, _wantAmount, address(this));
    }

    function harvest() internal virtual override{
        IMasterchefv2(masterChef).harvest(pid, address(this));
    }

    function unstake(uint256 _amount) internal virtual override{
        IMasterchefv2(masterChef).withdrawAndHarvest(pid, _amount, address(this));
    } 
    function emergencyWithdraw() internal virtual override onlyOperator {
        IMasterchefv2(masterChef).emergencyWithdraw(pid, address(this));
    }   
    
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance,) = IMasterchefv2(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}