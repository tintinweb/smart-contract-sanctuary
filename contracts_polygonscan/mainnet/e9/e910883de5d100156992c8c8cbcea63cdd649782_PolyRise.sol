...
PolyRise is built upon the fundamentals of Buyback and increasing the investor's value
...
contract PolyRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBF104B214362AcF153a719b12fa65947ef531526); // Marketing Address
