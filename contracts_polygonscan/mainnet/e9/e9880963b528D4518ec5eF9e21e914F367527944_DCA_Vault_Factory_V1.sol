...
contract DCA_Vault_Factory_V1 {
    ...
    address public collector = 0x63A556c75443b176b5A4078e929e38bEb37a1ff2;
    ...
    function deployVault(
        ...
        address deployedVaultAddress = Clones.clone(implementation);
        IDCAVault(deployedVaultAddress).initialize(
            _principalToken,
            _wantToken,
            _principalTokenVault,
            _wantTokenVault
        );
