...
contract Swapper is ISwapper, Ownable {
     ...
     */ 
    ITokenLibrary internal tokenLibrary;
    ...
    function getTokenLibrary() external view override returns(ITokenLibrary) {
        return tokenLibrary;
    }
...
interface ISwapper {
    function getTokenLibrary() external returns(ITokenLibrary);
    function priceTo(
        string memory from, 
        string memory to, 
        uint256 amountIn
