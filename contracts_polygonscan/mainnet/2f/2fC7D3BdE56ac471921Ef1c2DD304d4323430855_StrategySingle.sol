...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address[] public fish_titan_path;
    ...
    uint256 public constant keepFXSmax = 0;
    ...
    {
        fish_titan_path = new address[](3);
        fish_titan_path[0] = fish;
        fish_titan_path[1] = iron;
        fish_titan_path[2] = titan;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            if (rewardToken != want) {
                _swapUniswapWithPath(fish_titan_path, _harvestBalance);
            }
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public Fish_MASTER_CHEF = 0xb03f95E649724dF6bA575C2c6eF062766a7fDb51;
