...
contract PepemonHelper{
    PepemonFactory constant pepemon = PepemonFactory(0xA02e589D5a8E3C0F540ebb931FDA0b91D742A79E);
    ...
    function setIPFSSupport(uint id, string memory ipfs )onlyAdmin public{
        ...
        bool isOffense,
        bool isNormal,
        bool isStackable,string memory name,string memory description,,string memory rarity)=pepemon.supportCardStats(id);
        pepemon.setSupportCardStats(id, PepemonStats.SupportCardStats(currentRoundChanges, nextRoundChanges, specialCode, modifierNumberOfNextTurns, isOffense, isNormal, isStackable, name, description, ipfs, rarity));
    }
}