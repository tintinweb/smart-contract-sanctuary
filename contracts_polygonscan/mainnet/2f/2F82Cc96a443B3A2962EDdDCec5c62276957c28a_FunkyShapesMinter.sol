...
// File: contracts/FunkyShapesMinter.sol
...
contract FunkyShapesMinter is ERC721, Ownable {
    uint256 public tokenCounter;

    uint256 private _presalePrice = 0; //.00 ETH
    uint256 private _salePrice = 20000000000000000000; // 5 ETH

    uint256 private _maxPerTx = 101; // Set to one higher than actual, to save gas on <= checks.

    uint256 public _presaleSupply = 100;
    uint256 public _totalSupply = 330000; 
    ...
    constructor () ERC721 ("Funky Shapes","SHAPES")  {
        tokenCounter = 0;
        _saleState = 0;
    }
