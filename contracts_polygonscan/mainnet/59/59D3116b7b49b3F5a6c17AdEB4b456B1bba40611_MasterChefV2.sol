...
// MasterChef is the master of Rabbit. He can make Rabbit and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once RABBIT is sufficiently
...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    function updateEmissionRate(uint256 _rabbitPerBlock) public onlyOwner {
        massUpdatePools();
        rabbitPerBlock = _rabbitPerBlock;
        emit UpdateEmissionRate(msg.sender, _rabbitPerBlock);
    }
}
