...
contract TimelockController is AccessControl {
    ...
    uint256 public minDelay = 21600; // seconds - to be increased in production
    uint256 public minDelayReduced = 10800; // seconds - to be increased in production

    address payable public devWalletAddress =  0xAfafCAdf84BfA610c084Bd009E518c4a3D53fe53;
    ...
    function add(
        ...
        IAutoFarm(_autofarmAddress).add(_allocPoint, _want, _withUpdate); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
