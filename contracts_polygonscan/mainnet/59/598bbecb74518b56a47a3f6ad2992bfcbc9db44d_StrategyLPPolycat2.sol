...
// File: Vault\libs\IPolycat2.sol

// For interacting with PolycatFinance masterchef
interface IPolycat2 {
    // Transfer want tokens vault -> polycat masterchef
    function deposit(uint256 pid, uint256 _amount, bool harvest) external;
    
    // Transfer want tokens polycat masterchef -> vault
    function withdraw(uint256 pid, uint256 _amount, bool harvest) external;
...
// File: Vault\StrategyLPPolycat2.sol

contract StrategyLPPolycat2 is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(    
        ...
        earnedToWmaticPath = [address(0x006971aca589bbd367516d70c3d210e4906b090c96), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x006971aca589bbd367516d70c3d210e4906b090c96), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x006971aca589bbd367516d70c3d210e4906b090c96), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), 0xB1289f48E8d8Ad1532e83A8961f6E8b5a134661D];
        earnedToToken0Path= [address(0x006971aca589bbd367516d70c3d210e4906b090c96), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToToken1Path= [address(0x006971aca589bbd367516d70c3d210e4906b090c96), address(0x003a3df212b7aa91aa0402b9035b098891d276572b)];
        token0ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x006971aca589bbd367516d70c3d210e4906b090c96)];
        token1ToEarnedPath = [address(0x003a3df212b7aa91aa0402b9035b098891d276572b), address(0x006971aca589bbd367516d70c3d210e4906b090c96)];
        ...
        wmaticToToken1Path =  [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x003a3df212b7aa91aa0402b9035b098891d276572b)];
