...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_quickBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(quick_eth_path, _quickBalance);
            ...
            _swapUniswapWithPath(eth_qi_path, _ethBalancePost.div(2));
            ...
            if (_eth > 0 && _qi > 0) {
                ...
                IERC20(qi).safeApprove(currentRouter, 0);
                IERC20(qi).safeApprove(currentRouter, _qi);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public Quick_Rewards = 0xb47f7120a57381c217e4d6F3a79F066bfAAe6C93;
    address public Qi_ETH_LP = 0x8C1b40Ea78081B70F661C3286c74E71b4602C9C0;
