...
contract StrategyMaximizer_WMATIC_WETH is GravityMaximizer {

    address wmatic_weth_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0xCFaf1e3fabF1fAE980258Fc643fBA9Fe1fB44655);
        address wmatic_weth_lp = address(0x0Dfbf1A50bdcB570Bd0fF7Bb307313B553a02598);
