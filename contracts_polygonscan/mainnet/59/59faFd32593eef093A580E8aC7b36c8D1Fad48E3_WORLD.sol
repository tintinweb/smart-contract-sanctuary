...
contract WORLD is NFTbase, ReentrancyGuard {
    ...
    function getBuyPrice(uint256 tokenId) public view returns (uint256) {
        ...
        uint256 minimumPrice = getMinimumPrice(tokenId);
        return printPrice > minimumPrice ? printPrice : minimumPrice;
    }
    ...
    function updateTokenData(
        ...
        require(onSaleDate > block.timestamp, "sale date must be 7 or more days from now");
