...
// File: Vault\StrategyKogefarmKogecoinQuickswap.sol

// openzeppelin v3.1.0

contract StrategyKogefarmKogecoinQuickswap is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToSiriusPath = [address(0x0013748d548d95d78a3c83fe3f32604b4796cffa23), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToWantPath= [address(0x0013748d548d95d78a3c83fe3f32604b4796cffa23)];
        wantToEarnedPath = [address(0x0013748d548d95d78a3c83fe3f32604b4796cffa23)];
    }
