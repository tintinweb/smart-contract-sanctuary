...
contract sMINO is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked MINO", "sMINO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMINO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMINO
