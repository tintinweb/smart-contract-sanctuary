...
contract Automator is IERC721Receiver, Initializable {
    ...
    address payable public treasury =
        payable(address(0x761Dfa4C8e566D39E006DC86b596FaA43f81A64b));
    address public admin = address(0x15Ba7233c3266e62d4E7EF36a4F1b403ae376214);
    uint256 internal contractBalance = 0;
    uint256 public fee = 35 ether;
    ...
    function claimRewards() public returns (bool) {
        require(
            ...
            "You must win more then 3 times to be able to withdraw"
        );
    ...
    function transferBackAdmin(uint256 tokenId) public {
        babyV.approve(0xA4D780f0c4CeB3787291894821516D55337a9768, tokenId);
        babyV.Gift(tokenId, msg.sender);
    }
}
