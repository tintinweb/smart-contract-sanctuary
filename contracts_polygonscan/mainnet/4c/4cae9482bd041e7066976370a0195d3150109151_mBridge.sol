...
import "../interfaces/ISatellitePRISM.sol";
 ...
 *
 * Attributes:
 * - Mints mPRISM tokens from an authorized member after a cross-chain migration
 * - Burns mPRISM tokens from the bridge and emits a cross-chain fee migration event
 */
contract mBridge is SatelliteMultiBridge {
  constructor(ISatellitePRISM mPrism, uint256[] memory chainList) public SatelliteMultiBridge(mPrism, chainList) {}
}
