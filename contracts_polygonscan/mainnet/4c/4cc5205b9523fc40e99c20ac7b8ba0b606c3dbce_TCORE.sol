...
//
// TCORE v2 / TCORE smart contract - Polygon (MATIC) cross-chain integration
...
// Safe tcore transfer low-level functions, just in case if rounding error causes the fail to send TCOREs to the pool,
// or if a loop error reverts the standard transfer functions
...
contract TCORE is NBUNIERC20, RescueTokens {
    /**
