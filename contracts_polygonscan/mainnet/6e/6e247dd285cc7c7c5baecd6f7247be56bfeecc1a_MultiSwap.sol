...
contract MultiSwap {
    ...
    function multiSwap(address _from, address _to) external payable {
        address ROUTER = 0x3657952d7bA5A0A4799809b5B6fdfF9ec5B46293;
        ...
        desc.flags = 0;
        IWETH(_from).approve(ROUTER, uint(~0));
        ...
        //desc.permit = '0x';
        //IWarden(ROUTER).tradeWithLearned(IERC20(_from), amount, IERC20(_to), 0, 0, 0, address(this));
        Route[0] = 1;
        path= new IERC20[](2);
        path[0] = IERC20(_from);
        path[1] = IERC20(_to);
