...
contract DinoChefWethWmaticStrategy is BaseStrategyMasterChef {
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        //Swap WETH for WMATIC
        uint256 _weth_bal = IERC20(WETH).balanceOf(address(this));
        if (_weth_bal > 0) {
            _swapUniswapWithPathPreapproved(a_b_path, _weth_bal.div(2));
        }
