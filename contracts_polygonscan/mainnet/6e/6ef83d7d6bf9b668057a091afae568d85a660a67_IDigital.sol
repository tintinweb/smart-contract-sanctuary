 ...
 */
 ...
 contract IDigital is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("iDigital TS", "iDTS") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xeE1BAE659fFD1C042bdA7cd7DEf4A1eB61843A3b); 
          _setupRole(MINTER_ROLE, 0xeE1BAE659fFD1C042bdA7cd7DEf4A1eB61843A3b); 
          _setupRole(PAUSER_ROLE, 0xeE1BAE659fFD1C042bdA7cd7DEf4A1eB61843A3b);  
          _setupRole(MINTER_ADMIN_ROLE, 0xeE1BAE659fFD1C042bdA7cd7DEf4A1eB61843A3b); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xeE1BAE659fFD1C042bdA7cd7DEf4A1eB61843A3b);  
     }
     ...
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "iDigital/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
