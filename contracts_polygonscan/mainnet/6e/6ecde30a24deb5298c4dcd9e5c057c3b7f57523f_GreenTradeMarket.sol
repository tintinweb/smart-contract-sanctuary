...
/** 
 *  SourceUnit: d:\GitWork\GreenTradeNFT\contracts\contracts\GreenTradeMarket.sol
*/
...
contract GreenTradeNFT is ERC721 {
...
////import "./GreenTradeNFT.sol";


interface IGreenTradeNFT {
...
contract GreenTradeMarket is Ownable, ERC721Holder {
    using SafeMath for uint256;
	using EnumerableSet for EnumerableSet.AddressSet;
	...
	IGreenTradeNFT public nftCollection;
	...
	uint256 public totalEarning; /* Total GreenTrade Token */
	...
	constructor (address _governanceToken, 
		...
		nftCollection = IGreenTradeNFT(_nftCollection);	
	}
    ...
    function buy(uint256 _id) external ItemExists(_id) {
		...
		// transfer GreenTrade token to adminAddress
		...
		// transfer GreenTrade token to owner
