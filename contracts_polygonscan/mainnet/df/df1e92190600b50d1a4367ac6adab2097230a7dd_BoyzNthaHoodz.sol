...
// SPDX-License-Identifier: GPL-3.pragma solidity ^0.8.0;
interface IERC165 {
...
contract BoyzNthaHoodz is ERC721Enumerable, Ownable {
    using Strings for uint256;
     ...
     uint256 public constant MAX_Hoodz_MINT = 50;
     uint256 public constant RESERVED_HOODZ = 150;
     address public constant artistAddress = 0x85893Cc28F86C3138e1e3F888B16466E8acCaFC6;
     address public constant founderAddress = 0x83Bd4e54882919bAD2D103cA28cC1612386c6e0F;
     address public constant devAddress = 0x93cF9F15E4462756cD86504eA5dc51675AD451cf;
     uint256 public reservedClaimed;
     uint256 public numHoodZminted;
     bool public publicsalestarted;
     bool public presalestarted;
     bool public paused = false;
     mapping(address => bool) private _presaleEligiable;
    ...
    returns (string memory)
  {
    ...
    function claimReserved(address recipient, uint256 amount) external onlyOwner {
        require(reservedClaimed != RESERVED_HOODZ, "Already have claimed all reserved HOODZ");
        ...
        uint256 _nextTokenId = numHoodZminted;
    ...
    function addtoPresale(address[] calldata addresses) external onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
            ...
            _presaleEligiable[addresses[i]] = true;
    ...
    function mintPresale(uint256 amountOfHoodz) external payable whenPreSaleStarted {
        require(_presaleEligiable[msg.sender], "You are not eligable for presale");
        require(totalSupply() < MAX_HOODZ, "All tokens have been minted");
        require(amountOfHoodz <= PRESALE_MAX_MINT, "Cannot purchase this many tokens during presale");
        ...
        require(PRICE * amountOfHoodz == msg.value, "ETH amount is incorrect");
    ...
    function mint(uint256 amountOfHoodz) external payable whenPublicsaleStarted {
        ...
        require(totalSupply() + amountOfHoodz <= MAX_Hoodz_MINT, "Minting would exceed max supply");
        require(_totalClaimed[msg.sender] + amountOfHoodz <= MAX_Hoodz_MINT, "Purchase exceeds max allowed per address");
        require(amountOfHoodz > 0, "Must mint at least one HoodZ");
        require(PRICE * amountOfHoodz == msg.value, "ETH amount is incorrect");
        for (uint256 i = 0; i < amountOfHoodz; i++) {
            uint256 tokenId = numHoodZminted + 1;
