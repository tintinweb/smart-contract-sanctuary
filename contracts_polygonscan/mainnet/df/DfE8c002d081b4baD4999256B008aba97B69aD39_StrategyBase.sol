...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant alpha = 0x0B048D6e01a6b9002C291060bF2179938fd8264c;
    address public constant spade = 0xf5EA626334037a2cf0155D49eA6462fDdC6Eff19;
    ...
    // Uniswap swap paths
    address[] public alpha_spade_path;
    ...
    {
        alpha_spade_path = new address[](3);
        alpha_spade_path[0] = alpha;
        alpha_spade_path[1] = usdc;
        alpha_spade_path[2] = spade;
    }
    ...
    function harvest() public override {
        ...
        //Swap 1/2 reward for other
        uint256 _alphaBalance = IERC20(alpha).balanceOf(address(this));
        if (_alphaBalance > harvestCutoff){

            //Send performance fee to strategist
            uint256 performanceFee = _alphaBalance.mul(keepFXS).div(keepFXSmax);
            if (performanceFee>0) {
                IERC20(alpha).safeTransfer(
                    strategist,
                    performanceFee
                );
            }
            ...
            // Swap
            uint256 _alphaBalancePost = IERC20(alpha).balanceOf(address(this));
            _swapUniswapWithPath(alpha_spade_path, _alphaBalancePost);
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public ALPHA_MASTER_CHEF = 0x0B14C435DC29f2e3F53E203a18077F4A41914870;
    address public SPADE_LP = 0xf5EA626334037a2cf0155D49eA6462fDdC6Eff19;
