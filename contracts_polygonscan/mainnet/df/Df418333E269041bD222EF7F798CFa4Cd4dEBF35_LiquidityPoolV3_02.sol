...
contract LiquidityPoolV3_02 is ReentrancyGuardUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20Upgradeable {
  ...
  bytes32 constant public PAUSER_ROLE = keccak256("PAUSER_ROLE");
		...
		initializer
	{
		...
		TOKENS = [
			IERC20Upgradeable(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174), // USDC
			IERC20Upgradeable(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063), // DAI
			IERC20Upgradeable(0xc2132D05D31c914a87C6611C10748AEb04B58e8F)  // USDT
		];
		TOKENS_MUL = [
			uint256(1e12),
			uint256(1),
