...
contract Meland is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meland.ai";
    string private constant _symbol = "MLAND";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x4AbacaA9B77910054902813D962b52E3fEB199eB); // Marketing Address
        
        devAddress = payable(0x74b18b82ef397e91A9f88B6B2A0905B5e8227F2A); // Dev Address
