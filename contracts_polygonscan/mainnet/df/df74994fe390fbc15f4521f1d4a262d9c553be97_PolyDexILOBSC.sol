...
contract PolyDexILOBSC is ReentrancyGuard, OwnableUpgradeable {
    ...
    event Buy(address indexed user, address indexed referrer, uint256 amount);
    ...
    function setTotalRaisingInBUSD(uint256 _totalReceivingAmountInBUSD) public onlyAdmin {
        totalReceivingAmountInBUSD = _totalReceivingAmountInBUSD;
    }
    ...
    function buyWithRef(uint256 _amount, address _referrer) public onlyActive nonReentrant {
        ...
        emit Buy(msg.sender, _referrer, finalDepositAmount);
    }
    ...
    function getUserSellingTokenAmount(address user) public view returns (uint256) {
        ...
        return userInfo[user].amount * sellingRate / receivingRate;
    }

    function getMaxReceivingTokenToPurchase() public view returns (uint256) {
        return receivingCap - totalReceivingAmountInUSDC * 1e12 - totalReceivingAmountInBUSD;
    }
    ...
    function finalWithdraw(uint256 _receivingTokenAmount) external onlyOwner {
