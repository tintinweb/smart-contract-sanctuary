...
contract TokenPrice {
    ...
    function _getPrice(IUniswapV2Router02 _router, uint _amountIn, address[] memory _path) private view returns (uint[] memory _price)
    {
        _price = _router.getAmountsOut(_amountIn, _path);
    }
}