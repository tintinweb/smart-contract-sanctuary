...
import "../../contracts/governance/Gov.sol";

contract XGov is Gov {
    constructor() {}

    function x_cancel(address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,bytes32 descriptionHash) external returns (uint256) {
        return super._cancel(targets,values,calldatas,descriptionHash);
    }

    function x_execute(uint256 proposalId,address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,bytes32 descriptionHash) external {
        return super._execute(proposalId,targets,values,calldatas,descriptionHash);
    }

    function x_executor() external view returns (address) {
        return super._executor();
    }
    ...
    function x__GovernorTimelockControl_init(TimelockControllerUpgradeable timelockAddress) external {
        return super.__GovernorTimelockControl_init(timelockAddress);
    }

    function x__GovernorTimelockControl_init_unchained(TimelockControllerUpgradeable timelockAddress) external {
        return super.__GovernorTimelockControl_init_unchained(timelockAddress);
    }

    function x__GovernorVotesQuorumFraction_init(uint256 quorumNumeratorValue) external {
        return super.__GovernorVotesQuorumFraction_init(quorumNumeratorValue);
    }

    function x__GovernorVotesQuorumFraction_init_unchained(uint256 quorumNumeratorValue) external {
        return super.__GovernorVotesQuorumFraction_init_unchained(quorumNumeratorValue);
    }

    function x_updateQuorumNumerator(uint256 newQuorumNumerator) external {
        return super._updateQuorumNumerator(newQuorumNumerator);
    }

    function x__GovernorVotes_init(ERC20VotesUpgradeable tokenAddress) external {
        return super.__GovernorVotes_init(tokenAddress);
    }

    function x__GovernorVotes_init_unchained(ERC20VotesUpgradeable tokenAddress) external {
        return super.__GovernorVotes_init_unchained(tokenAddress);
    }

    function x__GovernorCountingSimple_init() external {
        return super.__GovernorCountingSimple_init();
    }

    function x__GovernorCountingSimple_init_unchained() external {
        return super.__GovernorCountingSimple_init_unchained();
    }

    function x_quorumReached(uint256 proposalId) external view returns (bool) {
        return super._quorumReached(proposalId);
    }

    function x_voteSucceeded(uint256 proposalId) external view returns (bool) {
        return super._voteSucceeded(proposalId);
    }

    function x_countVote(uint256 proposalId,address account,uint8 support,uint256 weight) external {
        return super._countVote(proposalId,account,support,weight);
    }

    function x__GovernorSettings_init(uint256 initialVotingDelay,uint256 initialVotingPeriod,uint256 initialProposalThreshold) external {
        return super.__GovernorSettings_init(initialVotingDelay,initialVotingPeriod,initialProposalThreshold);
    }

    function x__GovernorSettings_init_unchained(uint256 initialVotingDelay,uint256 initialVotingPeriod,uint256 initialProposalThreshold) external {
        return super.__GovernorSettings_init_unchained(initialVotingDelay,initialVotingPeriod,initialProposalThreshold);
    }

    function x_setVotingDelay(uint256 newVotingDelay) external {
        return super._setVotingDelay(newVotingDelay);
    }

    function x_setVotingPeriod(uint256 newVotingPeriod) external {
        return super._setVotingPeriod(newVotingPeriod);
    }

    function x_setProposalThreshold(uint256 newProposalThreshold) external {
        return super._setProposalThreshold(newProposalThreshold);
    }

    function x__Governor_init(string calldata name_) external {
        return super.__Governor_init(name_);
    }

    function x__Governor_init_unchained(string calldata name_) external {
        return super.__Governor_init_unchained(name_);
    }

    function x_castVote(uint256 proposalId,address account,uint8 support,string calldata reason) external returns (uint256) {
        return super._castVote(proposalId,account,support,reason);
    }

    function x__IGovernorTimelock_init() external {
        return super.__IGovernorTimelock_init();
    }

    function x__IGovernorTimelock_init_unchained() external {
        return super.__IGovernorTimelock_init_unchained();
    }

    function x__IGovernor_init() external {
        return super.__IGovernor_init();
    }

    function x__IGovernor_init_unchained() external {
        return super.__IGovernor_init_unchained();
    }
