...
contract MintPassToCyberSisterz is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 10000;
    uint public  basePrice = 2*10**18; 
    ...
    constructor(string memory baseURI) ERC721("MintPass to CyberSisterz", "CSMpass")  {
        setBaseURI(baseURI);
    }
    ...
    function GiveDiscount(address[] memory _addresses) public onlyOwner {
