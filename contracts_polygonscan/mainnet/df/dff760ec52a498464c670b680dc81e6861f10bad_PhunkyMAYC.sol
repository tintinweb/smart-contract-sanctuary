...
contract PhunkyMAYC is ERC721Enumerable, Ownable {

    uint256 public maycPrice = 20000000000000000;
    uint public constant maxMaycPurchase = 10000;
    uint public maycSupply = 10000;
    bool public drop_is_active = false;
    string public baseURI = "";
    uint256 public tokensMinted = 0;
    uint256 public freeMints = 60000;

    mapping(address => uint) addressesThatMinted;

    constructor() ERC721("PhunkyMAYC", "PMAYC"){
    ...
    function freeMintPMAYC(uint numberOfTokens) public {
        ...
        require(addressesThatMinted[msg.sender] + numberOfTokens <= 10000, "You have already minted 10!");
    ...
    function mintPMAYC(uint numberOfTokens) public payable {
        ...
        require(addressesThatMinted[msg.sender] + numberOfTokens <= 10000, "You have already minted 10000!");
