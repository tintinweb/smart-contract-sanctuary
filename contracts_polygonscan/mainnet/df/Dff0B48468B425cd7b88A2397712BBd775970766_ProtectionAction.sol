...
contract ProtectionAction is FlashLoanReceiverBase, IProtectionAction, Ownable {
        ...
        returns (bool)
    {
        ...
        _swap(
            ...
            paramsData.amounOfDebtToRepay
        );

        /// @notice Payback debt.

        uint256 debtRepaid =
            IERC20(paramsData.debtToken).balanceOf(address(this));
        ...
        uint256 fees =
            (_flashloanData.amounts[0] * protectionFeeBps) / TEN_THOUSAND_BPS;

        uint256 amtOfColToWithdraw =
            _flashloanData.amounts[0] + fees + _flashloanData.premiums[0];
...
function _getProtectionPayload(
    ...
    (
        ...
        protectionPayload.amounOfDebtToRepay,
    ...
    _lendingPool.flashLoan(
        ...
        abi.encode(
            FlashLoanParamsData(
                ...
                _protectionPayload.amounOfDebtToRepay,
