...
contract XVMCtimeDeposit is Ownable, Pausable {
    ...
    address public oldPool = 0x9e24A3Fcc61f24b899be12bBdB4cB1063f3AA387; //old pool we can migrate from
    ...
    address public distributionAddress = 0x39D2C5da81308A8dDB07Bb00f89D531954446e31;
     ...
     * pool 7 in case we create a longer lockup period
     */
    function setTrustedPools(address _pool7) external adminOrOwner {
        trustedPool7 = _pool7;
        //trustedPool5 = _pool5;
        //trustedPool4 = _pool4;
        //trustedPool3 = _pool3;
    ...
    function hopDeposit(uint256 _amount, address _recipientAddress, uint256 previousLastDepositedTime) external whenNotPaused {
        require(msg.sender == trustedSender1 || msg.sender == trustedSender2 || msg.sender == trustedSender3
                || msg.sender == trustedSender4 || msg.sender == trustedSender5 || msg.sender == oldPool,
