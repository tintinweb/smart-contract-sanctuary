...
contract Utils{
    ...
    IPancakeLPToken lpToken = IPancakeLPToken(address(0xCb36D0B4907DDa1743EA45B1912E9b6F975dEf7a));
    IPancakeLPToken lpTokenFinal = IPancakeLPToken(address(0x83af3eC743869D72d6D334d95d188Ca5D82DA1f3));
    IKingDeFiFarm kingDeFiFarm = IKingDeFiFarm(address(0xF97Ab83E3FE30414C7Dc54Dc657BB62c2397AdE4));
    ...
    function prezzoKrown() view public returns(uint256){
        ...
        uint256 prezzoTokenFinal = router.quote(1000000000000000000, reserveLP11, reserveLP01);
        return prezzoToken * prezzoTokenFinal;
    }
