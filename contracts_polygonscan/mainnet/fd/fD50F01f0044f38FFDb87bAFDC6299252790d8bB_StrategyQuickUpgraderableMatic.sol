...
// File: contracts/matic/StrategyQuickUpgraderableMatic.sol
...
contract StrategyQuickUpgraderableMatic is ReentrancyGuardUpgradeSafe, OwnableUpgradeable , Pausable {
    // Maximises yields in pancakeswap

    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    
    bool public isGrandComp;
    ...
    address public constant buyBackAddress = 0xec11AC6dd9aFcBfAE623641692b7132A7FC123Dc;
    ...
    function _farm() internal {
        ...
        IStakingRewards(farmContractAddress).stake(wantAmt); // Just for CAKE staking, we dont use deposit()
    ...
    function earn() public whenNotPaused {
        ...
        // Harvest farm tokens
        IStakingRewards(farmContractAddress).getReward(); // Just for CAKE staking, we dont use withdraw()
