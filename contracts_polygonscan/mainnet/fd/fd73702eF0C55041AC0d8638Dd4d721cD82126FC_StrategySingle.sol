...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address[] public gfi_token1_path;
    address[] public gfi_token2_path;
    ...
    {
        gfi_token1_path = new address[](2);
        gfi_token1_path[0] = gfi;
        gfi_token1_path[1] = token1;

        gfi_token2_path = new address[](3);
        gfi_token2_path[0] = gfi;
        gfi_token2_path[1] = token1;
        gfi_token2_path[2] = token2;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            // Swap 1/2 GFI to token1
            uint256 _harvestBalancePost = IERC20(rewardToken).balanceOf(address(this));
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_token1_path, _harvestBalancePost.div(2));

            // Swap 1/2 GFI to token2
            uint256 _harvestBalancePost2 = IERC20(rewardToken).balanceOf(address(this));
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_token2_path, _harvestBalancePost2);
            
            // Add liquidity to Gravity
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0x7C870fE594cF31775bE218263242382F94d28535;
    address public Want_Token = 0x45EA5ce4e764Ae027b64c8DF8F457e168964e026;
