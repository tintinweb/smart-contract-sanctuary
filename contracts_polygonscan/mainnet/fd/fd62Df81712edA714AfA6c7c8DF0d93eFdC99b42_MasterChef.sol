...
// PolyHomerToken with Governance.
contract PolyHomerToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    constructor(
        PolyHomerToken _homer,
        uint256 _startBlock,
        uint256 _homerPerBlock
    ) public {
        panther = _homer;
        startBlock = _startBlock;
        pantherPerBlock = _homerPerBlock;
    ...
    function updateEmissionRate(uint256 _homerPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _homerPerBlock);
        pantherPerBlock = _homerPerBlock;
    }
