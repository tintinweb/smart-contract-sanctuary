...
// File: @cremepie/core/contracts/interfaces/IUniswapV2Factory.sol
...
// File: @cremepie/lib/contracts/libraries/TransferHelper.sol
...
// File: @cremepie/core/contracts/interfaces/IUniswapV2Pair.sol
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'5142e62e2c2e054cba9dadfeb45d4695192228a3c14b6be662027ff9825f40a9' // init code hash
            ))));
    }
...
// File: contracts/CremepieLiquidity.sol
...
contract CremepieLiquidity is IUniswapV2Router02 {
    using SafeMath for uint;
    ...
    function removeLiquidity(
        ...
        if(address(this) != to) TransferHelper.safeTransfer(tokenA, to, amountA);
        if(address(this) != to) TransferHelper.safeTransfer(tokenB, to, amountB);
    }
    function removeLiquidityETH(
        address token,
        uint liquidity,
