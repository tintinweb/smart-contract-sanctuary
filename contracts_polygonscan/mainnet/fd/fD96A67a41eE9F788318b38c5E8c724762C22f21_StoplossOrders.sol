...
contract StoplossOrders is IModule, Order, ReentrancyGuard {
    /// @notice receive ETH
    ...
    function execute(
        ...
        (IERC20 outputToken, uint256 _stoploss, uint256 _minReturn) = abi
            .decode(_data, (IERC20, uint256, uint256));
        ...
        require(
            ...
            "StopLossOrders#execute: OUTSIDE_MIN_RETURN"
        );
    ...
    function canExecute(
        ...
        bytes memory encodedData = abi.encode(_auxData, _minReturn);
        return
            handler.canHandle(
                _inputToken,
                outputToken,
