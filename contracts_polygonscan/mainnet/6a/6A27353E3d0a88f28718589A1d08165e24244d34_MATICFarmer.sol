...
contract MATICFarmer {
	...
	address payable public boosterWallet;
	...
	constructor() public {
        ...
        ceo2Wallet=0xa5327581b7388E82aC68F899A229cDDE4835F73B;             // AB
        ceo3Wallet=0x94B9A05A3Ce2441c733555E8b046eCd62DF671BC;             // R
        ceo4Wallet=0xF8D428CacfA41db56Db81b25c690a017356Cd5B5;             // C
        boosterWallet = 0x276b6a1dE673ADd3A89545a6325Bd93F1f7Bb898;        // Booster wallet
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		ceo1Wallet.transfer(fee4);
		ceo2Wallet.transfer(fee2);
		ceo3Wallet.transfer(fee2);
		ceo4Wallet.transfer(fee2);
		boosterWallet.transfer(fee2);
		
		emit FeePayed(msg.sender, fee*12);
