  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xE28cE56047EC67A7D71A91A73342C798663f9BA1);
        ...
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, 'Cannot mint over supply cap of 7000');
    ...
    // File: contracts/cocoonCritterzContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CocoonCritterzContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Cocoon Critterz", "CC", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmXLtRrsKbsMQ6AepSnpjC1HJxAccznQuLMcRuPb9JvP8h/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/3umxHumeXxuqCnoN4mwy/contract-metadata";
        }
    }