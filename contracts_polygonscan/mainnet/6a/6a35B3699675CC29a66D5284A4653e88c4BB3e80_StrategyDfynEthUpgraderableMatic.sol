...
contract StrategyDfynEthUpgraderableMatic is ReentrancyGuardUpgradeSafe, OwnableUpgradeable , Pausable {
    ...
    function earn() public whenNotPaused {
      ...
      function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        address[] memory earnToMaticPath = new address[](3);
        (earnToMaticPath[0], earnToMaticPath[1],earnToMaticPath[2]) = (earnedAddress,ethAddress,maticAddress);
        ...
        address[] memory maticToGrandPath = new address[](2);
        (maticToGrandPath[0], maticToGrandPath[1]) = (maticAddress,GrandAddress);
