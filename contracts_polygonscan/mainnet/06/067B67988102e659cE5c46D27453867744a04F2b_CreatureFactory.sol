...
contract Creature is ERC721Tradable {
	...
	ERC721Tradable("Ethereum Milestones Surprise", "EGS", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://api.eggscollection.club/collections/ethereum-milestones/surprise/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://api.eggscollection.club/collections/ethereum-milestones";
    }
}
...
contract CreatureLootBox is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress, address _factoryAddress)
        ERC721Tradable("Ethereum Milestones CryptoEgg", "EGS", _proxyRegistryAddress)
    {
        factoryAddress = _factoryAddress;
    }

    // Insert custom logic for configuring the item here.
    function _afterTokenTransfer(address from, address to, uint256 _tokenId) internal  virtual override {

        for (uint256 i = 0; i < NUM_CREATURES_PER_BOX; i++) {
            // Mint the ERC721 item(s).
            FactoryERC721 factory = FactoryERC721(factoryAddress);
            factory.mint(OPTION_ID, to);
        }
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "https://api.eggscollection.club/collections/ethereum-milestones/cryptoegg/";
    }
...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://api.eggscollection.club/collections/ethereum-milestones/factory/";
    ...
    uint256 NUM_CREATURES_IN_MULTIPLE_CREATURE_OPTION = 3;
    ...
    function name() override external pure returns (string memory) {
        return "Ethereum Milestones Workshop";
    }
