...
// File: contracts/BoleroArtistICO.sol
...
// File: contracts/BoleroERC20.sol
...
// File: contracts/BoleroArtistToken.sol
...
contract BoleroDeployer {
	...
	*******************************************************************************/
	...
	/*******************************************************************************
	**	@notice Create a new erc20 token for an artist. This may only be called
    **          by Management
    **  @param artistAddress The address of the artist
    **  @param want The token we want to use for the ICO
    **  @param releaseTime When this will swtich from primary to secondary market
    **  @param initialPricePerShare The initial price per share
    **  @param distribution array with [0] totalSupply, [1] supply for artist
    **  @param shares array with shares % [0] for bolero, [1] for artist
	*******************************************************************************/
    function newArtistToken(
        ...
        require(artists[artistAddress] != address(0), 'Artist not deployed');

        address artistContract = artists[artistAddress];
        address artistTokenContract = address(new BoleroArtistToken(
            address(this),
            artistContract,
            want,
            liquidityPool,
        ...
        artistTokens[artistAddress] = artistTokenContract;
    }
