...
pragma solidity ^0.8.0;
contract SUMO is ERC721, ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    constructor() ERC721("RITEST", "STEST") {}
  ...
  function royaltyInfo(uint256 _tokenId, uint256 _salePrice) external view returns (address reciver, uint256 royaltyAmount ) {
