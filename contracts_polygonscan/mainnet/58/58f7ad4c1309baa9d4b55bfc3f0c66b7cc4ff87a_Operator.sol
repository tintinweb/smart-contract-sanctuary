...
contract Operator {
    ...
    function safeTransfer1155(address nftAddress, address from, address receiver, uint256 tokenId, uint256 amount) public onlyMinters isPaused returns(bool) {
        IBaseNFT1155(nftAddress).safeTransferFrom(from, receiver, tokenId, amount, "");
        return true;
    }

    function safeTransfer721(address nftAddress, address from, address to, uint256 tokenId) public onlyMinters isPaused returns(bool) {
