...
contract SimpleDiceroll {
        ...
        function roll(uint256 ammount , uint8 chosennumber , IERC20 token_IERC , uint8 token_decimal) public returns(address , uint8 , uint8){
		    ...
		    //eef
		    address payable roller = payable(msg.sender);
		    uint256 _ethinWei = 1*10**15;
		    roller.transfer(_ethinWei);
