...
interface ICompetition{
    ...
    **/
    ...
    /**
    * @dev Called only by authorized admin to update the challenge and tournament scores for a challenge.
    * @dev Note that the size of the array parameters passed in to this function is limited by the block gas limit.
    ...
    * @return success True if operation completes successfully.
    **/
    function updateChallengeAndTournamentScores(address[] calldata participants, uint256[] calldata challengeScores, uint256[] calldata tournamentScores) external returns (bool success);
