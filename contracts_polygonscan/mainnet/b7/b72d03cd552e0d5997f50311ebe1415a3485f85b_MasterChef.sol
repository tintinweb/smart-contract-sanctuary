...
// PolyRainbowToken with Governance.
contract PolyRainbowToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // The PolyRainbowToken!
    PolyRainbowToken public panther;
    // Dev address.
    ...
    constructor(
        PolyRainbowToken _rnbw,
        uint256 _startBlock,
        uint256 _rnbwPerBlock
    ) public {
        panther = _rnbw;
    ...
    function updateEmissionRate(uint256 _rnbwPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _rnbwPerBlock);
        pantherPerBlock = _rnbwPerBlock;
    }
