...
contract Game is Ownable, ReentrancyGuard {
    ...
    event GameEvent(address indexed user,uint256 _inputAmt);
    ...
    function playGame(uint256 _inputAmt) public {
        ...
        uint256 tokenBal = IERC20(payToken).balanceOf(address(this));
        ...
        IERC20(payToken).safeTransfer(msg.sender, winAmount);
        
        }
        
        emit GameEvent(msg.sender, _inputAmt);
    }
}