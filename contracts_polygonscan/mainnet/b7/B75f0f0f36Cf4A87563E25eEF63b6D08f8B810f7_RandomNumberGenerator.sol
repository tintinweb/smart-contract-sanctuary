...
// File: contracts/interfaces/IDinoSwapLottery.sol

pragma solidity ^0.8.4;

interface IDinoSwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in DINO per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in DINO token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInDino: price of a ticket in DINO
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public dinoSwapLottery;
     ...
     * @param _seed: seed provided by the DinoSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == dinoSwapLottery, "Only DinoSwapLottery");
    ...
    /**
     * @notice Set the address for the DinoSwapLottery
     * @param _dinoSwapLottery: address of the DinoSwap lottery
     */
    function setLotteryAddress(address _dinoSwapLottery) external onlyOwner {
        dinoSwapLottery = _dinoSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IDinoSwapLottery(dinoSwapLottery).viewCurrentLotteryId();
    }
}