...
//
//About Token:  MetaWon is an AI-powered Meta Universe Bsed Gaming Token in which anyone can earn rewards such as tokens and NFTs through competent gameplay and contributions to the MetaWon ecosystem.
//
//Website, Metaverse Gaming Platform, and Whitepaper will be released in Janaury 2022. 
// 
//
...
contract MetaWon is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaWon";
