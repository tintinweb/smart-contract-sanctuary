...
contract NationalCryptoPunks is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0xb543D3eA6f667e6D2CBDd7705252c912f6afeF14).call{value: address(this).balance * 5 / 100}("");
    require(hs);
