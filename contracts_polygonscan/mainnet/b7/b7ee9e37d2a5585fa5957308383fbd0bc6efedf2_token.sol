...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "PolyDefi";
    string private _symbol = "DEFI68";
    ...
    address public ownerAddres = address(0xdA785C2D80197F998E4Da2f99Bc9A63915118022);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xdA785C2D80197F998E4Da2f99Bc9A63915118022, 'We can not exclude Uniswap router.');
