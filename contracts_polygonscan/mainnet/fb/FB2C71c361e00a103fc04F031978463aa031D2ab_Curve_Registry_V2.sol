...
// File contracts/Polygon/Curve/Curve_Polygon_Registry_V2.sol
...
///@author Zapper
///@notice Registry for Curve Polygon Pools with Utility functions.
...
contract Curve_Registry_V2 is Ownable {
    ...
    */
    ...
    /**
        ...
        @param swapAddress Curve swap address for the pool
        @return poolTokens returns 4 element array containing the addresses of the pool tokens 
                (0 address if pool contains < 4 tokens)
    */
