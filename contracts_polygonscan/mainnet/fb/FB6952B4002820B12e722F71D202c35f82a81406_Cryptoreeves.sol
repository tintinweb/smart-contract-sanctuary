...
contract Cryptoreeves is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 35 ether;
  uint256 public maxSupply = 1302;
  uint256 public maxMintAmount = 25;
  uint256 public whitelistCost = 25 ether;
  ...
  constructor(
    ...
    //give the team some nfts
    for (uint256 i = 1; i <= 18; i++) {
        if (i <= 10) {
            _safeMint(0x13f82A8f9e2D9c4334066B9c4D0A612eE939B45c, i);
        }   
        if (i > 10 && i <= 15) {
          _safeMint(0xbCbb32C0caC8833061D6281e934B20bb93004255, i);
        }   
        if (i > 15) {
          _safeMint(0xf3a3d5aAccC7A84308Ac27E5E210BA5886EC9eb3, i);
        } 
    }
  }
  ...
  function pauseFlip() public onlyOwner {
    paused = !paused;
  }
  ...
  function withdraw() public payable onlyOwner {
      ...
      require(payable(0xbCbb32C0caC8833061D6281e934B20bb93004255).send(_each));
      require(payable(0x13f82A8f9e2D9c4334066B9c4D0A612eE939B45c).send(address(this).balance));      
