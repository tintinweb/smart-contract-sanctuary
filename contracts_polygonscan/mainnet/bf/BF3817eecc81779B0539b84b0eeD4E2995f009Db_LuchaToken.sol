...
contract LuchaToken is BEP20('LuchaToken', 'LUCHA') {
...
contract xLucha is Ownable {
    ...
    constructor(
        LuchaToken _rewardtoken
    ) public {
        rewardtoken = _rewardtoken;
        devaddr = address(0xC76C6B83d0FFe8a32efFC5B5E2781488B29de65F);
        feeAddress = address(0xC76C6B83d0FFe8a32efFC5B5E2781488B29de65F);
        rewardtokenPerBlock = 1 * 10 ** 18;
