...
contract securafinance is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[recipient], "BOTS: Play Fair");
...
contract secura is securafinance , NativeMetaTransaction, ContextMixin {
    constructor() securafinance () {
