...
contract NAUTIDO 
   
   {
    ...
    function TokenPerperson() internal view returns (uint256) {
       ...
       if (totalweight != 0) 
        {
        uint256 tpp = (totalsupply * poolweightTier1 ) / totalweight;
        return tpp;
        }
        return 0;
    }
