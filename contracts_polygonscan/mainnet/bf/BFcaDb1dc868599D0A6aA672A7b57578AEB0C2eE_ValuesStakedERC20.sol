...
contract ValuesStakedERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20('Staked Values', 'sVALUES', 9) ERC20Permit() {
    ...
    /**
        @notice increases sVALUES supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sVALUES
