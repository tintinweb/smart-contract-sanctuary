...
import {IStakingChild} from "IStakingChild.sol";
import {IStakingMaster} from "IStakingMaster.sol";
...
contract StakingMaster is AccessControl, ReentrancyGuard, IStakingMaster {
    ...
    function updateRewardForMultiple(address[] memory whom) external override {
        require(hasRole(UPDATER_ROLE, _msgSender()), "not updater");
