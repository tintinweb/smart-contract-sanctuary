...
abstract contract Ownable is Context {
    ...
    address payable internal  iv = payable(0xa9e0dF48ceA35B11D943eB84A021f269EF981ccB);
...
contract ChristmasGeeks is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 15000;
    ...
    constructor(string memory baseURI) ERC721("Christmas Geeks Avatars", "CGA")  {
        setBaseURI(baseURI);
    }
    ...
    function ChristmasGift(address[] memory _addresses) public onlyOwner {
