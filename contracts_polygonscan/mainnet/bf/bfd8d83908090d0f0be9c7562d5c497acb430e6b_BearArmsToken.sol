...
contract BearArmsToken is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2 * 10**6 * (10**9); //2 million tokens
    uint256 public maxBuyAmount = 50 * 10**7 * 10**9; //0.2% of the supply per transaction
    uint256 public maxSellAmount = 50 * 10**7 * 10**9; // 0.2% of the supply per transaction
    uint256 public maxWalletAmount = 50 * 10**8 * 10**9; // 2% of the supply
  

    address public marketingWallet = address(0xd471259Fdaa310C3AbC015C1aeE23B2e553fA961); //marketing wallet
    
    address public charityWallet = address(0xFb3649c3e74A24EA043Cb9b83586d8c24D035253); //charity wallet

    uint8 public rewardsFee = 30; // 3% rewards to holders
    uint8 public liquidityFee = 25; //2.5% liquidity fee
    uint8 public marketingFee = 25; // 2.5% mrketing fee
