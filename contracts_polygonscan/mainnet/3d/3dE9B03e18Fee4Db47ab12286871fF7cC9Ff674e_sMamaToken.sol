...
contract sMamaToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Mama", "sMAMA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMAMA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMAMA
