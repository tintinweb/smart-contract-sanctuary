...
contract VentFinance is Context, IERC20, Ownable {
...
contract Vent is VentFinance, NativeMetaTransaction, ContextMixin {
    constructor() VentFinance() {
