...
contract PBlogger is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * 10**12;       //tong cung 1 nghin ty
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PBlogger";                  //ten token
    string private _symbol = "PBR";                   //ky hieu token
