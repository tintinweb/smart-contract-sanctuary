...
/**
We are pleased to announce the creation of the first safety-providing listing application. A platform that can host all of the new tokens. For each token to be hosted, its owner must first pass a small KYC.
Brace yourselves. The explosion of crypto has created the need for a solution of monitoring the new-coming tokens as well as providing different ways to work with original projects. Our goal is to create a new platform that will host recently listing cryptocurrencies.
Due to the anonymity in that area, there is a flood of scam projects, so it has become our primary objective to make a leap forward in the direction of safety, in order to make the market more secure for both crypto enthusiasts and investors.
Our platform will help this cause by making a light KYC for the creators and developers of each and every project, without their details considered mandatory to be published, at least not if they do not wish so.
Whitepaper: https://impossible-bracket-9c5.notion.site/STORM-BRINGER-8d2784f19edb4ac4924fc76848648898

PRESALE (DXSALE) at 19/11/2021
- 5% burned and added to liquidity
- 5% distributed to holders
- 1% of every transaction will be burnt
- Liquidity locked for 2 years
- Lp tokens burned for ever

Full-Audit from TechRate ( you can find it at our Whitepaper)
AMA from Satoshi Club: (recap soon)
AMA from Cryptotitans: https://cryptotitans.org/storm-bringer-ama/ 
*/
...
contract BEM is Context, IERC20, Ownable {
