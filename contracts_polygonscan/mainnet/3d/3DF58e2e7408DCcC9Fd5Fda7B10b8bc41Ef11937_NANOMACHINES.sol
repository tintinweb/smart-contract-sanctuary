...
contract NANOMACHINES is IBEP20, Ownable
{
    using Address for address;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    uint256 public tokenToSwapAmount = 100000;
    
    address public xrptoken = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    ...
    //Token Info
    string private constant _name = 'NANOMACHINES';
    string private constant _symbol = 'NMAC';
    uint8 private constant _decimals = 18;
    uint256 public constant InitialSupply= 100000000 * 10**_decimals;//equals 100M tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0x242bF9b7238c09853e440DCE270EeDFaE94A467A);
    address public walletTwo=payable(0xF04e9542121C7b2b7D534Ef5291b44d2a8986520);
    //TestNet
    ...
    function setXRPToken ( address _xrptoken ) public onlyOwner {
    ...
    function claimXRP(address addr) private{
        ...
        path[1] = xrptoken;  //Binance-Peg XRP Token
    ...
    function setTokenToSwapAmount ( uint256 _amount ) public onlyOwner {
        tokenToSwapAmount = _amount;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = tokenToSwapAmount * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer((amount*80) / 100);
        payable(walletTwo).transfer((amount*20) / 100);
    } 
