...
/**
    ...
    Unlike Sushi's MasterChef, rewards from this contract end once the exchange is launched.
    Further rewards are handled by other contracts. Be sure to withdraw your LP tokens!
...
contract MasterVampire is Ownable {
    ...
    /// @notice Add another exchange's LP tokens to the pool
    /// @dev Can only be called by the owner before migration begins.
    function add(
        uint256 _allocPoint,
    ...
    /// @notice One-time function to set the vampire factory
...
contract MasterVampireDev is MasterVampire {
    ...
    function devSetTimes(
        ...
        require(_bonusEndTime < exchangeOpenTime, "bad open time");
