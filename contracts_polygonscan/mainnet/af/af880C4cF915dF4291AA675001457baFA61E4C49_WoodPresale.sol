...
contract WoodPresale is ReentrancyGuard {
    ...
    // Price of presale WOOD: 0.2 USDC
    uint256 private constant USDCPerWood = 20;

    // Time per percent
    uint256 private constant timePerPercent = 600;

    //address constant USDC_ADDRESS = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    ...
    function buy(uint256 _amount, address _buyer) public nonReentrant {
        ...
        uint256 tokens = _amount.div(USDCPerWood).mul(100).mul(10**12);
