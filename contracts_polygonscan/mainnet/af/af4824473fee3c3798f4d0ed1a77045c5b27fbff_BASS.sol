 ...
 */
 ...
 contract BASS is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("BLOODS and CRIPS", "BASS") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x79aeCAbF35AD80D1a9f981715da37AA64FCa486E);
          _setupRole(MINTER_ROLE, 0x79aeCAbF35AD80D1a9f981715da37AA64FCa486E);
          _setupRole(PAUSER_ROLE, 0x79aeCAbF35AD80D1a9f981715da37AA64FCa486E);
          _setupRole(MINTER_ADMIN_ROLE, 0x79aeCAbF35AD80D1a9f981715da37AA64FCa486E);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x79aeCAbF35AD80D1a9f981715da37AA64FCa486E);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "BLOODS and CRIPS/minter-role-required");
         _mint(to, tokenId);
