...
contract PolyDexILO is ReentrancyGuard, OwnableUpgradeable {
    ...
    uint256 public totalReceivingAmountInBSC;
    ...
    function setTotalReceivingAmountInBSC(uint256 _totalReceivingAmountInBSC) external onlyAdmin {
        require(_totalReceivingAmountInBSC > totalReceivingAmountInBSC, "must larger");
        totalReceivingAmountInBSC = _totalReceivingAmountInBSC;
    }
    ...
    function getUserSellingTokenAmount(address user) public view returns (uint256) {
        ...
        return userInfo[user].amount * rate * 1e12;
    }
