...
contract PolygonPunks is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    uint256 public MAX_NFT = 10000;
    uint256 public MAX_BY_MINT = 50;
	
	//Inital Minting price 10 Matic /mint
    ...
    constructor(string memory baseURI, address payable creator,uint256 _count) ERC721("PolygonPunks V2", "P") {
        setBaseURI(baseURI);
