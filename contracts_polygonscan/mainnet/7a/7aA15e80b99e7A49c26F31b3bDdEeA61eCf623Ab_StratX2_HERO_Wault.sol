...
abstract contract StratX2Wault is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function _farm() internal virtual {
        ...
        if (isCAKEStaking) {
            ...
            IPancakeswapFarm(farmContractAddress).deposit(pid, wantAmt, true);
        }
    ...
    function _unfarm(uint256 _wantAmt) internal virtual {
        if (isCAKEStaking) {
            ...
            IPancakeswapFarm(farmContractAddress).withdraw(pid, _wantAmt, true);
        }
    }
...
contract StratX2_HERO_Wault is StratX2Wault {
    function initialize(
