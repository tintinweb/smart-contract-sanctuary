...
contract token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0xa146Cb252A6002FFC835B28Fd285912FA8939307);
    uint256 private _previousBurnFee = _burnFee;


    uint256 public _maxTxAmount = 0.1*10**18;
    uint256 public _maxSellTransactionAmount = 0.1*10**18; // can't sell more than this
    uint256 public _maxWalletToken = 0.5*10**18; // can't buy or accumulate more than this
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xa146Cb252A6002FFC835B28Fd285912FA8939307, 'We can not exclude Uniswap router.');
