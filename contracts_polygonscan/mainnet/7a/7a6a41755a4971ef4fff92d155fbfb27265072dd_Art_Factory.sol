...
import './MOIAVERSE.sol';

contract Art_Factory is Initializable, OwnableUpgradeable {
  address public METAVERSE_ADDRESS;

  /* Inits Contract */
  function initialize(address _erc20TokenAddress) public initializer {
    __Ownable_init();
    setMETAVERSE_ADDRESS(_erc20TokenAddress);
  }

  function setMETAVERSE_ADDRESS(address _tokenAddress) public onlyOwner {
    METAVERSE_ADDRESS = _tokenAddress;
  }
  ...
  function Mint(
    ...
    require(royalties_percentage <= 100, 'EXCEEDS Max Royalties');
    MOIAVERSE(METAVERSE_ADDRESS).push(
      msg.sender,
      supply,
