...
// File: contracts/4_GFT.sol

pragma solidity ^0.8.0;
//SPDX-License-Identifier: MIT


contract GhostFactoryClub is ERC721, Ownable, RandomlyAssigned {
    using Strings for uint256;
    ...
    string public baseURI = "ipfs://QmfDZvzscxg2ndznBjiGyATGY1gCZtsSGDCkwgPinivRaY/";

    constructor()
    ERC721("Ghost Factory Club", "GFC")
    ...
    payable
    {
        ...
        if (msg.sender != owner()) {
            require((balanceOf(msg.sender) + _mintAmount) < 10, "You cannot own more than 10 ghosts via minting. Please lower the amount");
