...
contract VestingSeedV2 is IVesting, EIP712Upgradeable, OwnableUpgradeable {
    ...
    // for fix incorrect address, 09_11
    function applyToChange() external onlyOwner {
        require(!changesApplied, "Allowed only once");
        changesApplied = true;
        deposited[0x294bE96f85C4a0FDC1A8039d2F323af161e65b07] = deposited[
            0x8047353dE642384630eB0bD396A6f7fCa5BEcD5E
        ];
        deposited[0x2CD1E87eC805bf15a6cb1CeE2A4aB8b431B1f9CE] = deposited[
            0x5D5A2eB0af94e13640F62b2B403bAE32aaf1EBE9
        ];
        deposited[0x71b7BF65bc513a7132cd967951265FEe4A990644] = deposited[
            0x3DEAdf00D9A85794DdA2923D92EdA3944a2a8087
        ];
        deposited[0x9b3F8DD5BD63689b323e0eDf5fA4079bb055b8D9] = deposited[
            0xA63D821D325f0D13880b0C69dD1ca5CA60aCb98A
        ];
        delete deposited[0x8047353dE642384630eB0bD396A6f7fCa5BEcD5E];
        delete deposited[0x5D5A2eB0af94e13640F62b2B403bAE32aaf1EBE9];
        delete deposited[0x3DEAdf00D9A85794DdA2923D92EdA3944a2a8087];
        delete deposited[0xA63D821D325f0D13880b0C69dD1ca5CA60aCb98A];
    }
