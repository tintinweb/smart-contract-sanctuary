...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address[] public matic_dfyn_path;
    ...
    constructor(
        ...
        matic_dfyn_path = new address[](2);
        matic_dfyn_path[0] = matic;
        matic_dfyn_path[1] = dfyn;
    }
    ...
    function harvest() public override {
        ...
        if (_dfynBalance > harvestCutoff) {
            ...
            // swap half MATIC to USDC
            uint256 _maticBalancePost = IERC20(matic).balanceOf(address(this));
            _swapUniswapWithPath(matic_usdc_path, _maticBalancePost.div(2));
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public Dfyn_Rewards = 0xE03dD6ac19Cad8aD420B6C8F3A6C334293bDD446;
    address public USDC_WMATIC_LP = 0x4f5dF10B9991482bCD2DB19DAE1FD0e0184397c2;

    constructor()
        public
        StrategyFarmTwoAssets(Dfyn_Rewards, USDC_WMATIC_LP, msg.sender)
    {}
