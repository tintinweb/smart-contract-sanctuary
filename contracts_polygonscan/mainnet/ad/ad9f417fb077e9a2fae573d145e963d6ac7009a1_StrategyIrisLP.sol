...
contract StrategyIrisLP is StratManager, FeeManager {
    ...
    constructor() public {
        ...
        want = 0x86ad6271809f350522085F95F5A67d46ff7ed3AB;
        poolId = 8;
    ...
    function addLiquidity() internal {
        ...
        IUniswapRouterETH(unirouter).addLiquidity(lpToken0, lpToken1, lp0Bal, lp1Bal, 0, 0, address(this), block.timestamp);
    }
