...
contract Saturn is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x79e45CF6bc0BC156C2Cc6F22A63c8209136379E9;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, 'We can not exclude Quick router.');
    ...
    function setSaturnCharityWallet(address newWallet) external onlyOwner() {
