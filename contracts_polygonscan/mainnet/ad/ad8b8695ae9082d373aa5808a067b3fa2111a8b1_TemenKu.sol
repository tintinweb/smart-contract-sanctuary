...
contract TemenKu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TemenKuDividendTracker public dividendTracker;
   ...
   //// uint256 public numberOfFixedSaleBuys;
    ...
    constructor() public ERC20("Temenku Token", "TMNKU") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        TemenKuDividendTracker newDividendTracker = TemenKuDividendTracker(payable(newAddress));
...
contract TemenKuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("TemenKu_Dividend_Tracker", "TemenKu_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "TemenKu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "TemenKu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TemenKu contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "TemenKu_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TemenKu_Dividend_Tracker: Cannot update claimWait to same value");
