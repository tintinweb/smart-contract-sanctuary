...
contract StakeUpgrader is Manageable {
    /** Structs / Vars ------------------------------------------------------------------- */
    struct Settings {
    ...
    /** @dev Max Share Upgrade
        ...
        Modifier: Pausable
    */
    function maxShareUpgrade(uint256 sessionId) external {
        require(
    ...
    */
    function maxShareUpgradeInternal(uint256 stakingDays) internal view {
        require(settings.maxShareEventActive, 'STAKING: Max Share event is not active');
        require(
