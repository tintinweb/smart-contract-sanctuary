...
library DexSwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
            ...
            // hex'5502cb210d91d4da624396928b178634c0b968b32da675f3f8921c2bd36f00d7' // init code hash// mumbai
            hex'8d5cb477d33ed6bd41c4f92a58f79b1e620735c5408981f4f6aeb73fa189b571' // init code hash//matic mainnet
        ))));
    }
