...
contract BaseZone is ZoneInterface, ERC721Enumerable, ERC721Burnable, EIP712MetaTransaction {
  ...
  function setRecord(
    ...
    records[key] = Record(rrt, ttl, data);
  ...
  function getRecord(
    bytes32 resource,
    string calldata label
  ) public view virtual override returns (uint16 rrt, uint32 ttl, bytes32 data) {
...
contract HMNZone is StandardZone {
    constructor() StandardZone(
      msg.sender,
      hex"ae952e20a9ba218b538ede3bbb09afd295ef950474948726cb9b3b50ff029800",
      ".hmn",
      "HMN",
