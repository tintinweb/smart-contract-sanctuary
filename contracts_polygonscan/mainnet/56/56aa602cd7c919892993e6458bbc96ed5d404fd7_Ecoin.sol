...
* @dev 
*/
contract Ecoin is Ownable, Pausable, ERC20 {

  constructor(uint256 _totalSupply, string memory _tokenName, string memory _tokenSymbol) ERC20(_tokenName, _tokenSymbol)
  {
