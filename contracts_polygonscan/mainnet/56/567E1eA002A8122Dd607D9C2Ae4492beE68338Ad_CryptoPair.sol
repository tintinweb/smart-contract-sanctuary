...
contract CryptoPair is Initializable, Ownable, ReentrancyGuard {
    ...
    function remove_liquidity(uint256 amount, uint256[N_COINS] memory minAmounts) external nonReentrant {
    ...
    function apply_new_parameters() external onlyOperator {
        ...
        emit NewParameters(
            swapStorage.fees.admin_fee,
            swapStorage.fees.mid_fee,
            swapStorage.fees.out_fee,
            swapStorage.fees.fee_gamma,
            swapStorage.allowed_extra_profit,
            swapStorage.adjustment_step,
