...
// File: contracts\interfaces\IUSTSwap.sol
...
// File: contracts\interfaces\USTSwapRouter.sol
...
contract MultiRouterSwap is Ownable, ReentrancyGuard {
    ...
    event Swap(address user, uint256 UST_Amount, uint256 APOLLO_Amount);

    constructor() public {
        APOLLO = IERC20(0x577aa684B89578628941D648f1Fbd6dDE338F059);
        UST = IERC20(0x692597b009d13C4049a947CAB2239b7d6517875F);
    ...
    function buy(uint256 UST_Amount) nonReentrant external {
        UST.safeTransferFrom(msg.sender, address(this), UST_Amount);
        uint256 APOLLO_Amount = _safeSwapUniswap(UST_Amount, address(UST), address(APOLLO));
        emit Swap(msg.sender, UST_Amount, APOLLO_Amount);
