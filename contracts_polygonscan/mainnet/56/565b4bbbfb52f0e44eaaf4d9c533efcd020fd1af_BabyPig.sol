...
contract BabyPig is PIGDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private PIGTeam;
    address private CharityPIG;
    ...
    string public override name = "BabyPig";
    string public override symbol = "PIG";
    ...
    constructor(uint totalSupplyValue, address PIGTeamAddress, address CharityPIGAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        PIGTeam = PIGTeamAddress;
        CharityPIG = CharityPIGAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PIGTeam] =  totalSupply * 10 / 100;
        balances[CharityPIG] = totalSupply * 20 / 100;
    ...
    // Get the address of the token's PIGTeam pot
