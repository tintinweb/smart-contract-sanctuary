...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        pswamp_usdc_path = new address[](2);
        pswamp_usdc_path[0] = pswamp;
        pswamp_usdc_path[1] = usdc;
    ...
    function set_fee(uint256 NewFee) external onlyOwner() {
        require(NewFee <= 100, "Cannot be more than 1000 bps");
        keepFXS = NewFee;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            if (performanceFee>0) {
                _swapUniswapWithPath(pswamp_usdc_path, performanceFee);
