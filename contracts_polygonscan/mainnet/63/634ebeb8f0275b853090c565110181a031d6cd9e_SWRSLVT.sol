...
/**
 *Testcontract-If purchased you will be reimbursed.
*/
...
contract SWRSLVT is Context, iERC20, Ownable {
  ...
  constructor() public {
    ...
    _totalSupply = 1000000 * 10**6 * 10**6;
    ...
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**3 * 10**3;
