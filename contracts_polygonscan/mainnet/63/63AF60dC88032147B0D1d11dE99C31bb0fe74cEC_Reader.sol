...
contract Reader {
    ...
    function _1ReadFirst10Pages(uint256 BookNumber) public view returns (string memory) {
    ...
    function _2ReadSecond10Pages(uint256 BookNumber) public view returns (string memory) {
    ...
    function _3ReadThird10Pages(uint256 BookNumber) public view returns (string memory) {
    ...
    function _4ReadFourth10Pages(uint256 BookNumber) public view returns (string memory) {
   ...
   function _5ReadFifth10Pages(uint256 BookNumber) public view returns (string memory) {
