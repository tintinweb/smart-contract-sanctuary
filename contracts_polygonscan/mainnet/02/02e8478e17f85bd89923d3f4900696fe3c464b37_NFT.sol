...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxMintAmount = 1; //5
  uint256 public nftPerAddressLimit = 1; //3
  uint256 public wave2MaxMintAmt = 1; //1
...
//   address payable public payments;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool simon_ariel, ) = payable(msg.sender).call{value: address(this).balance }("");  //Le Rest
    require(simon_ariel);
