...
contract ChildWsbswapV2ERC20Etherscan {
    ...
    uint public totalSupply = 0; // for CHILD we set this to zero since we will deposit
    ...
    /**
     * @notice Mint new tokens -- we don't do this on polygon
