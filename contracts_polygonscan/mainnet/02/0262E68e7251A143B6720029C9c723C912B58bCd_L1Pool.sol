...
contract L1Pool is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    modifier notRedeemPaused() {
        require(!redeemPaused, "Redemption is paused");
        _;
    }
     ...
     */
    function mint(uint256 collateralAmount, bool bHolder) public nonReentrant notMintPaused {
     ...
     */
    function redeem(uint256 l1Amount) public nonReentrant notRedeemPaused {
        require(l1Amount != 0, "invalidInput");
        
        uint256 collateralAmount = l1Amount.div(missingDecimals).mul(ratioPrecision).div(ratio);
    ...
    function changeL1Token(IL1 newL1) private onlyOwner {
        l1 = newL1;
    }

    function changeLiquidAlpha(ERC20 newLiquidAlpha) private onlyOwner {
        liquidAlpha = newLiquidAlpha;
    }

    function changeMaxSupply(uint256 _newMaxSupply) public onlyOwner {
        MAX_L1_SUPPLY = _newMaxSupply;
    }
