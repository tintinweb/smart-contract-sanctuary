 ...
 */
 ...
 contract Artbox is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken{
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Artbox", "ATBX") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xe54eD3E97f4D5E3A84D5e0b614b6C044eDa56a23);
          _setupRole(MINTER_ROLE, 0xe54eD3E97f4D5E3A84D5e0b614b6C044eDa56a23);
          _setupRole(PAUSER_ROLE, 0xe54eD3E97f4D5E3A84D5e0b614b6C044eDa56a23);
          _setupRole(MINTER_ADMIN_ROLE, 0xe54eD3E97f4D5E3A84D5e0b614b6C044eDa56a23);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xe54eD3E97f4D5E3A84D5e0b614b6C044eDa56a23);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "ATBX/minter-role-required");
         _mint(to, tokenId);
