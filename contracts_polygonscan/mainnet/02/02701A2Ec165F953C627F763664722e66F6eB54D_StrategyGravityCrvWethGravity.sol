...
// File: Vault\StrategyGravityCrvWethGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityCrvWethGravity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00172370d5cd63279efa6d502dab29171933a610af)];
        ...
        token0ToEarnedPath = [address(0x00172370d5cd63279efa6d502dab29171933a610af), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
