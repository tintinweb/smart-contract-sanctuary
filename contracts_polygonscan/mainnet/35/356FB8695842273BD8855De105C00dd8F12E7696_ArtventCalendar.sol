...
contract ArtventCalendar is OwnableUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC2771ContextUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    using StringsUpgradeable for uint256;
    CountersUpgradeable.Counter private _tokenIds;

    uint256 public constant MAX_SUPLLY = 5000;
    uint256 public constant MAX_FREE_MINTS = 2000;
    uint256 public price;
    bool public sale = false;
    string public baseURI = "";

    // Mapping for proxy address for things like opensea.
    mapping(address => bool) private proxyAddresses;

    function initialize(address trustedForwarder) public initializer {
        __Ownable_init();
        __ERC721_init("ArtventCalendar", "AVC");
    ...
    function mintFree() public {
        ...
        require(totalSupply() < MAX_FREE_MINTS, "Free mints are gone.");
        require(balanceOf(_msgSender()) == 0, 'Each address may only mint one calendar.');
