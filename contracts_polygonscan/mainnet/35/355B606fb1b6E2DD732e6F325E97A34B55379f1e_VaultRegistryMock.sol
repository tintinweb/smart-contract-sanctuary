...
contract VaultRegistryMock is IVaultRegistry, Ownable {
    ...
    function addVault(address tokenAddr, address vaultAddr) external onlyOwner {
        _vaults[tokenAddr].add(vaultAddr);
    }

    function clearVaults(address tokenAddr) external onlyOwner {
