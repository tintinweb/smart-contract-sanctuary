...
contract XVMCgovernor {
    ...
    address public immutable acPool1 = 0xd5a68EC0e1Cd72d414FC0B0BF7Aa29e1cb207705;
    ...
    address public immutable token1 = 0x798919F81FB61cA5B7362f908d1AfA29CF049b20;
    ...
    uint256 public immutable acPool1ID = 38;
    ...
    uint256 costToVote = 1000 * 1e18;  //all proposals are valid unless rejected. This is a minimum to prevent spam
    ...
    constructor(
        ...
        rollBonus[0xd5a68EC0e1Cd72d414FC0B0BF7Aa29e1cb207705].bonusPoints = 50;
        ...
        // Infinite approve
        IERC20(_token).safeApprove(address(0xd5a68EC0e1Cd72d414FC0B0BF7Aa29e1cb207705), type(uint256).max); //vaults
    ...
    */
    ...
    /**
     * Timelock-equivalent (require delay of roughly 12hours before transferring ownership of masterchef)
     */
    function afterDelayOwnership() external onlyTrustee {
        require(changeGovernorActivated2, "grace transfer not requested");
        if(block.timestamp > 1638914828) {
			require(newGovernorRequestBlock2 + 20000 < block.number, "Pending timelock");
		} //12hour timelock
