...
contract CreatureFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "http://3b3a-2600-1700-ba0-1040-2129-d01d-5d26-2906.ngrok.io/factory/";
    ...
    function mint(uint256 _optionId, address _toAddress) override public {
        ...
        IERC721Custom emblemVault = IERC721Custom(nftAddress);
        if (_optionId == SINGLE_CREATURE_OPTION) {
            //emblemVault.mint(_toAddress);
