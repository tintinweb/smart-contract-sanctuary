...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 75*10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "HAMMY TOKEN";
    string private _symbol = "HAMMY";
    ...
    address public ownerAddres = address(0x8c7B7EAB469eD5ca0e26B8C55c95B2aA5F090ba2);
