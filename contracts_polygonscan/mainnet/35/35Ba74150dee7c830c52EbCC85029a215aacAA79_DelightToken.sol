...
contract DelightToken is ERC20('DelightToken', 'DELIGHT'), ReentrancyGuard, Ownable {
    ...
    uint256 public salePriceE35 = 10 * (10 ** 33);

    uint256 public maxHardCap = 750 * (10 ** 3) * (10 ** 6);
    ...
    function buyDelight(uint256 _usdcSpent) external nonReentrant {
        ...
        require(userDelightTotally[msg.sender] <= delightPerAccountMaxTotal, "user has already purchased too much delight");
