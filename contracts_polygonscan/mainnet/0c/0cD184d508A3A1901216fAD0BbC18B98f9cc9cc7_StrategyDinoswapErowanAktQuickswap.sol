...
// File: Vault\StrategyDinoswapErowanAktQuickswap.sol

// openzeppelin v3.1.0

contract StrategyDinoswapErowanAktQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
