...
// Developer WhatsApp:: +923318082007
...
contract TheAfrosphere is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "The Afrosphere";
    string constant _symbol = "AFRO";
    ...
    address public Owner=0x9970f90C858E08DE5698d4dC10185F4028b25413; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x149188714c92AE236aA36Be515b8090678b043d2;
