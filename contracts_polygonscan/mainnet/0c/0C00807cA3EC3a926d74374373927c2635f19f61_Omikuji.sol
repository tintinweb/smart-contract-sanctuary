...
contract Omikuji is ERC721, ERC721Enumerable, ERC721URIStorage, HasSecondarySaleFees, ContextMixin, Ownable {
    using Strings for uint256;

    string public constant svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 941.66 954.2"><defs><style>.a{font-size:57.53px;}.a,.b{fill:#231815;font-family:KozGoPr6N-Regular-90ms-RKSJ-H, Kozuka Gothic Pr6N;}.b{font-size:417.52px;}</style></defs><text class="a" transform="translate(0 50.63)">\u3042\u306A\u305F\u306E\u904B\u52E2\u306F</text><text class="b"  x="500" y="600" text-anchor="middle">';
    string public constant svg2 = '</text><text class="a" transform="translate(596.48 934.7)">\u306A\u3093\u3058\u3083\u306D\uFF1F</text></svg>';
    string[] public jsonArray = ['{"name": "', '","description": "', '","image": "', '"}'];
    string[] public kujiname = ["\u5927\u51F6", " \u51F6 ", "\u672B\u5409", "\u5C0F\u5409", "\u4E2D\u5409", " \u5409 ", "\u5927\u5409"];
    ...
    function mint() public payable {
        require(msg.value == 1 ether, "Need to send 1 MATIC");
        uint256 tokenId = totalSupply() + 1;
        string memory mintData = string(abi.encodePacked("data:image/svg+xml;base64,", Base64.encode(abi.encodePacked(svg, kujiname[rnd(tokenId)], svg2))));
        _safeMint(_msgSender(), tokenId);
        _setTokenURI(tokenId, mintData);
    }
    ...
    {
        return string(abi.encodePacked("data:application/json;base64,", Base64.encode(abi.encodePacked(jsonArray[0], 'Omikuji #', tokenId.toString(), jsonArray[1], 'Fully onchain Omikuji.', jsonArray[2], super.tokenURI(tokenId), jsonArray[3]))));
    }
    ...
    function showMATIC() public view returns(uint256) {
