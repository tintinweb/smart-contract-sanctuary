...
ERC20 token type et IERC20 interface
TBT Virer payement en LYPTUS et fonction associée
Logo pearzap
Whitelist uniquement
Fonction pour voir si on est sur la Whitelist 
TBT Renommer IPO en IPO
...
contract IPO 

   {
    ...
    function initializeIPO(address _inputtoken, address _outputtoken, uint256 _startTime, uint256 _inTokenClaimTime, uint256 _endtime, uint256 _outTokenPerInToken, uint256 _maxinvestment, uint256 _minInvestment) public onlyOwner {
        ...
        require (IPOTarget > maxInvestment, "Incorrect maxinvestment value");
...
//whiteList.push(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);
