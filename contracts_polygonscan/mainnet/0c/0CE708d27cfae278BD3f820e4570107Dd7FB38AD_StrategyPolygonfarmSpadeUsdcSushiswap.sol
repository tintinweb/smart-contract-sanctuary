...
// File: Vault\StrategyPolygonfarmSpadeUsdcSushiswap.sol

// openzeppelin v3.1.0

contract StrategyPolygonfarmSpadeUsdcSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToToken1Path = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
        token0ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
