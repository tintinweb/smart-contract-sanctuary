...
// File: contracts/gooseFinance/libs/SafeBEP20.sol
...
// File: contracts/gooseFinance/MasterChef.sol
...
contract MasterChef is Ownable {
    ...
    function pendingEgg(uint256 _pid, address _user) external view returns (uint256) {
        ...
        if (block.number > pool.lastRewardBlock && lpSupply != 0) {
            ...
            accEggPerShare += ((eggReward * 1e12) / lpSupply);
        }
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 eggReward = (multiplier * eggPerBlock * pool.allocPoint) / totalAllocPoint;
        egg.mint(devaddr, (eggReward / 10));
        egg.mint(address(this), eggReward);
        pool.accEggPerShare += ((eggReward * 1e12) / lpSupply);
        pool.lastRewardBlock = block.number;
    }
...
// File: contracts/IComplyDeFi.sol
...
// File: contracts/gooseComply/GooseComply.sol
