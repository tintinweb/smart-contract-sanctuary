...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 13000*10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Mumuswap";
    ...
    address public ownerAddres = address(0xDCa35Ab8Ca7ec9b5961135fB97618D9C5fef4e1A);
    uint256 private _previousBurnFee = _burnFee;


    uint256 public _maxTxAmount = 13000 * 10 **18;
