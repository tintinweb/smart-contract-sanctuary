...
interface IMasterChef {
    ...
    function pedningReward(address _user) external view returns (uint256);
}
...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getHarvestable() external override view returns (uint256) {
        return IMasterChef(rewards).pedningReward(address(this));
    }
...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant matic = rewardToken;
        ...
        )
    {
        ...
        matic_roll_path[0] = matic;
        matic_roll_path[1] = roll;
    }
    ...
    function set_harvestCutoff(uint256 newCutoff) external onlyOwner() {
        require(newCutoff <= 10**18, "New cutoff must be less than 1 gaj");
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(matic_roll_path, _maticBalancePost);
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public ROLL_MASTER_CHEF = 0xa3541eA15556AD3272b9BDe36241F61cCbb60aE8;
    address public Want_Token = 0xC68e83a305b0FaD69E264A1769a0A070F190D2d6;
