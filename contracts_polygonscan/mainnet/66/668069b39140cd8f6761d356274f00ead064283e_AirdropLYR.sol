...
contract LayerToken is BEP20("LYR", "LYR")  {
}

contract AirdropLYR is Ownable {
  using SafeMath for uint256;
  ...
  LayerToken public LYRT;
  address public devaddr;
  UserInfo[] public userInfo;
  mapping (address => UserInfo) addressesMap;
...
function dropTokens(address[] memory _recipients, uint256 _amount) public onlyOwner {
    ...
    for (uint256 pid = 0; pid < length; ++pid) {
      LYRT.transferFrom(address(msg.sender), address(_recipients[pid]), _amount);
    }
