...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getHarvestable() external override view returns (uint256) {
        return IMasterChef(rewards).pendingEgg(poolId, address(this));
    }
...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant vert = 0x72572CCf5208b59f4BcC14e6653d8c31Cd1fC5a0;
    ...
    // Uniswap swap paths
    address[] public vert_usdc_path;
    address[] public vert_matic_path;
    ...
    {
        vert_usdc_path = new address[](2);
        vert_usdc_path[0] = vert;
        vert_usdc_path[1] = usdc;

        vert_matic_path = new address[](2);
        vert_matic_path[0] = vert;
        vert_matic_path[1] = matic;
    }
    ...
    function harvest() public override {
        ...
        // Compound and collect fee
        uint256 _vertBalance = IERC20(vert).balanceOf(address(this));
        if (_vertBalance > harvestCutoff){

            //Send performance fee to strategist
            uint256 performanceFee = _vertBalance.mul(keepFXS).div(keepFXSmax);
            if (performanceFee>0) {
                _swapUniswapWithPath(vert_matic_path, performanceFee);
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public VERT_MASTER_CHEF = 0x8bE82Ab9B6179bE6EB88431E3E4E0fd93b9E607C;
    address public Want_Token = 0x72572CCf5208b59f4BcC14e6653d8c31Cd1fC5a0;
