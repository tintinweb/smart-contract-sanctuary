...
abstract contract JugLike is Jug {}
...
abstract contract VowLike is Vow {}
...
abstract contract CatLike is Cat {}
...
abstract contract DogLike is Dog {}
...
abstract contract FlapLike is Flapper {}
...
abstract contract FlopLike is Flopper {}
...
abstract contract FlipLike is Flipper {}
...
abstract contract ClipLike is Clipper {}
abstract contract ClipperLike is Clipper {}
...
contract ESM {
    ...
    function fire() external {
        ...
        if (proxy != address(0)) {
            DenyLike(address(end.vat())).deny(proxy);
        }
        end.cage();
...
abstract contract PotLike is Pot {}
...
abstract contract SpotLike is Spotter {}
abstract contract SpotterLike is Spotter {}
