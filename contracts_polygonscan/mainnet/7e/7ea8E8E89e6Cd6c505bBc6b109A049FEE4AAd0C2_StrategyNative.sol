...
contract StrategyNative is BaseStrategySingle {
  ...
  function deposit(address _userAddress, uint256 _wantAmt) external override onlyOperator nonReentrant whenNotPaused returns (uint256) {
