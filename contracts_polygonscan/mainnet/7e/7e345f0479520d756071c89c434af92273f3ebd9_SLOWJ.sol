...
contract SLOWJ is ERC20, Ownable {
    using SafeMath for uint256;

    uint256 public burnFee = 1;
    uint256 public marketingFee = 5;
    uint256 totalFees = burnFee.add(marketingFee);
    address public  deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public  marketingWallet = 0xE8fb6DeeBC8F5f4c508306174B9De93EfB1F50b7;
    ...
    function setFee(uint256 _burnFee, uint256 _marketingFee) public onlyOwner {
        burnFee = _burnFee;
    ...
    constructor() ERC20("Slowjams", "SLOWJ") {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SLOWJ: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
        	...
        	uint256 marketingTokens = fees.sub(burnTokens);
