...
contract KanjiNFT_10th is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] public cha = ["\u864e","\u6642","\u75b2","\u5893","\u820c","\u4e0a","\u89e6","\u5854","\u753a","\u8de1","\u7df4","\u8e0f","\u5b9d","\u6a39","\u8a66","\u771f","\u7ba1","\u7b52","\u63b2","\u816b","\u829d","\u8ee2","\u4e80","\u4e8c","\u919c","\u5098","\u4e0b","\u5c3f","\u4f7f","\u865a","\u8c37","\u5024","\u83dc","\u7e26","\u5668","\u6751","\u9162","\u5fb3","\u8996","\u58f0","\u6e26","\u8170","\u5f85","\u6b69","\u58c1","\u8535","\u6e29","\u6696","\u8266","\u6d17",
"\u6e21","\u6c34","\u6edd","\u6ce2","\u9053","\u5f31","\u5bcc","\u8c4a","\u7e54","\u9031","\u8fce","\u897f","\u9be8","\u4f55","\u9ea6","\u7b1b","\u767d","\u8ab0","\u5e45","\u59bb","\u52dd","\u98a8","\u7a93","\u7fbd","\u7ffc","\u51ac","\u77e5","\u8ce2","\u9858","\u85e4","\u840e","\u5973","\u6728","\u8a9e","\u50cd","\u935b","\u4e16","\u60a9","\u6155","\u50b7","\u66f8","\u8aa4","\u5e74","\u9ec4","\u541b","\u82e5","\u5f1f","\u59b9","\u7985","\u96f6"];
  string[] public meanx = ["tiger","time","tired","tomb","tongue","top","touch","tower","town","trace","training","tread","treasure","tree","trial","true","tube","tube","tuck up","tumor","turf","turn","turtle","two","ugliness","umbrella","under","urine","use","vain","valley","value","vegetables","vertical","vessel","village","vinegar","virtue","vision","voice","vortex","waist","wait","walk","wall","warehouse","warm","warm","warship","wash",
"wat","water","waterfall","wave","way","weak","wealth","wealth","weave","week","welcome","west","whale","what","wheat","whistle","white","who","width","wife","win","wind","window","wing","wings","winter","wisdom","wise","wish","wisteria","wither","woman","wood","word","work","work out","world","worries","worship","wound","write","wrong","year","yellow","you","young","younger brother","younger sister","zen","zero"];
  ...
  string private rl1='{"name": "KanjiNFT_10th #';
  string private rl3='"}';
...
//}
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    Kanji memory kanji = randomOne(tokenId);
    string memory id=(tokenId+900).toString();
...
//gasless
  ...
  constructor() ERC721("KanjiNFT_10th", "KNJ10") Ownable() {}
}