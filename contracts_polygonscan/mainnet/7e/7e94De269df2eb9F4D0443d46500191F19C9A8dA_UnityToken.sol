...
contract Locker is ReentrancyGuard {
    ...
    function initClaimTime() external view returns (uint256) {
        return _initialClaimTime;
    }

    function userValues(address account) external view returns (uint256, uint256, uint256, uint256) {
