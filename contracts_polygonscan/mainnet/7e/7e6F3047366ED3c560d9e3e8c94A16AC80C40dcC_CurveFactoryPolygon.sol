...
import "./CurvePolygon.sol";

contract CurveFactoryPolygon is OwnableUpgradeable {
    ...
    constructor(
        ...
        CURVE_IMPL = address(new CurvePolygon());
    ...
    function createCurve(
        ...
        CurvePolygon(clone).initialize(infos, addrs, parms);
