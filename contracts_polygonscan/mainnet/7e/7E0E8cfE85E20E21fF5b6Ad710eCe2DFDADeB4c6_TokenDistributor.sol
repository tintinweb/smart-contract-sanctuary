...
contract TokenDistributor {
    ...
    address payable public wrappedNativeToken;
    ...
    constructor(address payable _wrappedNativeToken)
        public
    {
    ...
    function wrapNativeToken() external {
        uint _balance = address(this).balance;
        wrappedNativeToken.transfer(_balance);
    }
