...
contract GrowRegisterStorage {
    ...
    address public constant GrowTestPilotAddress = 0xDe1B5b518E63Ef0cDf55B1802b120870b12bFE04;
...
contract GrowRewarder is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function depositRewardAddReward(address userAddress, uint256 amountInNativeToken) external onlyActiveStrategy {
    ...
    function getRewards(address userAddress) external onlyActiveStrategy onlyNotVault {
