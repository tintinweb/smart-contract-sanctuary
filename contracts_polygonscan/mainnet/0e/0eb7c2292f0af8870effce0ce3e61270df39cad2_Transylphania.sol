...
contract Transylphania is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Transylphania", "NYMPH") {
    setHiddenMetadataUri("ipfs://QmdhBAeXabGeHMBcN3GmVrZSNKe7oZgrWeB59qQYiAnbAP/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    // This will pay Account1 5% of the initial sale.
    // You can remove this if you want, or keep it in to support HashLips and his channel.
    // =============================================================================
    (bool hs, ) = payable(0xfa844AD0bcE71A944f24d775Ac1Fd436F5d5Be9B).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
