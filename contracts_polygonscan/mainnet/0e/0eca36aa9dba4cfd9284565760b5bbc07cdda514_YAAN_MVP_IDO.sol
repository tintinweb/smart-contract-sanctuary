...
contract YAAN_MVP_IDO {
    ...
    uint public totalAllocation = 4687500 * 10**18;
    uint public tier1Alloc =  703125 * 10**18;
    uint public tier2Alloc =  1171875 * 10**18;
    uint public tier3Alloc =  1171875 * 10**18;
    uint public tier4Alloc =  1171875 * 10**18;
   ...
   // add same claim to multiple addresses
    ...
    // Set Sub-Owner address 
    function setSubownerAddress(address to) public {
        require( (msg.sender == owner || msg.sender == subOwner ), "Only owner");
        subOwner = to;
    }
    ...
    function viewSubowner() public view returns (address) {
        return subOwner;
    }
