...
import "./MaticMetaTransaction.sol";

contract WashingtonV2 is ERC721MetaTransactionMaticSample {
    ...
    constructor()
        ERC721MetaTransactionMaticSample("Washington", "WST")
    {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "https://assets.mita.network/nft/00_washington/",
