...
contract Arena is Ownable, ERC721Holder {
    ...
    uint public preparingTime = 10 * 25;//mins
    uint public fightingTime = 10 * 25;//mins
    uint public cycleTime = 30 * 25;//mins
    ...
    function leave(uint cycleIndex) public {
        ...
        bool isDead = !nft.isAlive(id0) && !nft.isAlive(id1) && !nft.isAlive(id2);
        
        require(cycleIndex < getCycleIndex() || isDead, "Battle not finished");
