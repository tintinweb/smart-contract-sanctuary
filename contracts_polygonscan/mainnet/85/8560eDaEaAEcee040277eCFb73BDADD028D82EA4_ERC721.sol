...
// Mother Contract 0x1600207440E5B01e7cf7210Cc27dE8Dc768C4e3C
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function mint(address to, string memory uri_) public {
        require(msg.sender == I721(_maker).ownerOf(I721(_maker).tokenIdOf(address(this))),"Caller is not the owner");
        _tokenId++;
        _uris[_tokenId] = uri_;
    ...
    function changeUri(uint256 tokenId, string memory uri_) public {
