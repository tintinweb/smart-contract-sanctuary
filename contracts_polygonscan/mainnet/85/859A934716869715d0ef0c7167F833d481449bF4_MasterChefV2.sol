...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    uint256 public constant destructionMaximumSupply = 5000 * (10 ** 18); // 5000 destruction
...
contract DestructionTokenV3 is ERC20, Ownable {
    ...
    function updateOperatorsFromAntiBot(address _operatorAddress, bool _status) external onlyOperator {
    ...
    ///@dev Update operator address status
    function updateHoldersFromAntiBot(address _holderAddress, bool _status) external onlyOperator {
    ...
    function updateMaxUserHoldAmountRate(uint16 _maxUserHoldAmountRate) external onlyOperator {
    ...
    function updateStatusAntiBotWorking(bool _status) external onlyOperator {
