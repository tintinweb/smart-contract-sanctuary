...
//File: contracts/RoastCaffeRef.sol


pragma solidity ^0.8.0;

contract RoastCaffe is ERC20, Ownable {
...
*/    
    ...
    uint256 private sPrice = 500*10**decimals();
    
    bool private _swAirdrop = true;
    bool private _swSale = true;
    uint256 private _referTok =     0; // 0 %
    uint256 private _referEth =     0; // 0 %
    uint256 private _airdropEth =   500000000000000;    //0.002 = 5000000000000
    ...
    uint256 private salePrice = 500; // 0.01 eth = 50;
    
    constructor() ERC20("Roast Caffe", "Caffe") {
        _owner = msg.sender;
        _auth = _owner;
        ...
        //startSale(block.number, 1000000000, 0,500*10**decimals(), 500000000000);
        //startAirdrop(block.number,1000000000,1*10**decimals(),50000000000);
    }
...
*/  
  ...
  //mapping(address => bool) claimed;
   ...
   //mapping(address => bool) claimstaked;
    ...
    uint countBy = 50000000; // 5000 ~ 1BNB = 0.25  // 500.00000 = 500
