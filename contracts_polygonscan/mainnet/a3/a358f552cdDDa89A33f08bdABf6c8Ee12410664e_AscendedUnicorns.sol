...
// File contracts/AscendedUnicorns.sol

//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

contract AscendedUnicorns is
    Context,
    AccessControlEnumerable,
    ERC721Enumerable,
    ERC721Burnable,
    ...
    Ownable
{
    ...
    // Public Variables
    mapping(address => bool) public ascended;
    ...
    bool public fossilized = true;

    // Modifiers
    modifier onlyAdmin() {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "AscendedUnicorns: OnlyAdmin"
        );
        _;
    }

    modifier notFossil() {
        require(fossilized == false, "AscendedUnicorns: I am in a fossil");
        _;
    }
        ...
        whenNotPaused
    {
        require(
            ...
            "AscendedUnicorns: Quantity must be lesser than MAX_SUPPLY = 800"
        );

        require(
            ascended[_to] == false,
            "AscendedUnicorns: User is already ascended"
        );
    ...
    function toggleFossil() public onlyAdmin {
