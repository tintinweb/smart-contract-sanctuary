...
contract BlackDiamondContract is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY_LIMIT = 8192;
    uint256 public NFT_PRICE = 10000000000000000; // 0.01 ETH
    uint public MAX_NFT_PURCHASE = 5;
    uint256 public MAX_SUPPLY = 4096;
    ...
    constructor() ERC721("Black Diamonds Secret Market","BDSM"){
        _baseURIExtended = "https://ipfs.io/ipfs/QmXnCcnJeuQYKnHW2ac5NsiADkfzjuXi1Dqtn74p3Kqp7E/";
    }
    ...
    function setNFTSalePrice(uint256 newNFTPrice) public onlyOwner {
    ...
    function updateMaxNFT(uint16 _maxNFT) public onlyOwner {
