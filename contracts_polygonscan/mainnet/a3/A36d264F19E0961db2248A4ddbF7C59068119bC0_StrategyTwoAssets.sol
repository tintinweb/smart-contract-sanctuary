...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant token2 = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    ...
    // Uniswap swap paths
    address[] public pwings_token1_path;
    address[] public pwings_token2_path;
    ...
    {
        pwings_token1_path = new address[](3);
        pwings_token1_path[0] = pwings;
        pwings_token1_path[1] = matic;
        pwings_token1_path[2] = token1;

        pwings_token2_path = new address[](4);
        pwings_token2_path[0] = pwings;
        pwings_token2_path[1] = matic;
        pwings_token2_path[2] = token1;
        pwings_token2_path[3] = token2;
    }
    ...
    function harvest() public override {
        ...
        if (_pwingsBalance > harvestCutoff){
            ...
            uint256 performanceFee = _pwingsBalance.mul(keepFXS).div(keepFXSmax);
            if (performanceFee>0) {
            ...
            _swapUniswapWithPath(pwings_token1_path, _pwingsBalancePost.div(2));
            uint256 _pwingsBalancePost2 = IERC20(pwings).balanceOf(address(this));
            _swapUniswapWithPath(pwings_token2_path, _pwingsBalancePost2);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public ETH_USDC_LP = 0xFEFF91C350bB564cA5Dc7D6F7DcD12ac092F94FF;
