...
contract IronAnchorSwap is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function swapFrom(uint256 collateralAmount) public nonReentrant {
        ...
        uint256 feeAmount = collateralAmount.mul(swapFee).div(PRECISION);
    ...
    function swapFromToExact(uint256 ironAmount) public nonReentrant {
        ...
        uint256 collateralAmountWithFee = collateralAmount.mul(PRECISION).div(PRECISION.sub(swapFee));
    ...
    function withdrawFee(address to) external onlyOwner {
        ...
        feeBalance = 0;
        collateral.safeTransfer(to, feeBalance);
