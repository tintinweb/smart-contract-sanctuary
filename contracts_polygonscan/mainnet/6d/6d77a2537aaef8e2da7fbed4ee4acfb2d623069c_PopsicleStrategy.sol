...
contract MasterChefStrategy is BaseStrategyMasterChef {
    ...
    function getPerformanceFee() public view returns (uint256) {
        //Fee is capped at 30%
        return Math.min(fee, IERCFund(strategist).getFee());
    }
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        if (amountHarvested > 0) {
            uint256 feeAmount = amountHarvested.mul(getPerformanceFee()).div(keepMax);
...
contract PopsicleStrategy is MasterChefStrategy {
    ...
    constructor(
        ...
        public
        MasterChefStrategy(
            0xbf513aCe2AbDc69D38eE847EFFDaa1901808c31c, //Chef
            _want,
            _tokenA,
            _tokenB,
            _betweenToken,
            0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619, //swap path = [ICE, WETH, WMATIC]
            _poolId,
            _strategist,
            0x4e1581f01046eFDd7a1a2CDB0F82cdd7F71F2E59, //ICE
