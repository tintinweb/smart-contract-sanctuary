...
contract AstroLoot is ERC721 {
    ...
    constructor () public ERC721 ("AstroLoot", "ALOOT"){
        tokenCounter = 1;
        _setBaseURI("ipfs://QmPCrXNuHW7hpAux9BFqufDmMYpqg5wUgdUgxzkV2poHWQ/");
        _setOwner(wallet);
    }

    function mintAstroloot() public {
        require(saleStatus);
    ...
    function ownermintAstroloot() public {
