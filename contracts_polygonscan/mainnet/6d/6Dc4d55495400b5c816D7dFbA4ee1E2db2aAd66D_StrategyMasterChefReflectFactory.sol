...
contract StrategyMasterChefReflect is StrategyMasterChef {
    using SafeMath for uint256;
...
import "../StrategyMasterChefReflect.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract StrategyMasterChefReflectFactory is Ownable {
  ...
  function deployDefaultMasterChefStrategy(
    ...
    deployMasterChefStrategy([defaultVaultChef, _configAddresses[0], defaultRouter, _configAddresses[1], _configAddresses[2], defaultUsdAddress, defaultBananaAddress, defaultGov], _pid, _earnedToWnativePath, _earnedToUsdPath, _earnedToBananaPath, _earnedToToken0Path, _earnedToToken1Path, _token0ToEarnedPath, _token1ToEarnedPath);
  }
  ...
  function deployMasterChefStrategy(
      ...
      StrategyMasterChefReflect strategy = new StrategyMasterChefReflect();
