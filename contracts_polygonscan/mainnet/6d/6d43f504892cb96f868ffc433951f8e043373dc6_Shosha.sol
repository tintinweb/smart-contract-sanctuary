...
contract Ownable is Context {
    ...
    constructor() internal {
        _owner = 0x5ED3984f063A09842aa18922e5Afd1ab3B9DCe26;
...
contract Shosha is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 88_888_888*(10**decimals());
    ...
    uint256 public _developmentFee = 200; // means 2% it menas burn 0%
    uint256 public _marketingFee = 200; //200 means 2% will send to marketing
    
    
    address marketingAddress = 0x9b0Cb410bb599eBa064583acE9Ce4a46Fd042D0f ; //
    address developmentAddress=0x36C05E093C6ED717c7f48ed40d20E163a7b45b96;
    ...
    constructor() public {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // for MAtic Quick swap v2
