...
// File: contracts/BIFI/strategies/Iron/StrategyIronDfynLP.sol
pragma solidity ^0.6.0;

contract StrategyWiseUsdcLP is StratManager, FeeManager {
    ...
    constructor() public {
        ...
        want = 0x2F9209Ef6fA6C002bf6fC99124336e24F88B62D0; // WiseWUSDCpair
        output = 0x4c19DdeebAF84cA3A255730295AD9d824D4Ff51f; // Wise
        ...
        masterchef = 0x62BA727e2449EE3BE0573b4b102D7090c5977BFB; // Wise Masterchef
        poolId = 1;
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (tx.origin == owner() || paused()) {
            ...
            // removed uint256 withdrawalFeeAmount = wantBal.mul(withdrawalFee).div(WITHDRAWAL_MAX)
            IERC20(want).safeTransfer(vault, wantBal); // changed it to wantBal
        }
    }
    ...
    function getHarvestable() external view returns (uint256){
        return IMasterChef(masterchef).pendingWise(poolId, address(this));
    }
}