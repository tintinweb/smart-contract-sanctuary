...
contract ChampionshipRingsHOK is Ownable, ERC721 {
    ...
    constructor() payable ERC721("FCG Championship Ring", "FCGHOK2") {
    }

    function mintMany(address[] memory recipients, uint[] memory amounts) external onlyOwner {
