...
contract NFZGameMechanicsV2 is
    Initializable,
    VRFConsumerBase,
    OwnableUpgradeable
{
    ...
    function setZombiePass() public onlyOwner {
        zombiePass = !zombiePass;
    }
    function _setLocation(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            require(_currentLocation == 0 || zombiePass == true, "Zombie already at location"); //temporary revert
