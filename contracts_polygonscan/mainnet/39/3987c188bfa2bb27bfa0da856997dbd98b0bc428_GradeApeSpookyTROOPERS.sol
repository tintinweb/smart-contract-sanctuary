...
contract GradeApeSpookyTROOPERS is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 666;
    uint256 public price = 15000000000000000000;
    bool public saleOpen = false;
    bool public presaleOpen = false;
    string public baseURI;

    address princeWallet = 0x26bee008E428dc97aE411123B13B99d0876eDb6C;
    address shWallet = 0x26bee008E428dc97aE411123B13B99d0876eDb6C;
    address devWallet = 0x26bee008E428dc97aE411123B13B99d0876eDb6C;
    address rkWallet = 0x26bee008E428dc97aE411123B13B99d0876eDb6C;

    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Grade ape Spooky', 'GAS') {}
