...
// > erc20.6
abstract contract ERC206 is Context, IERC20, IERC20Metadata, Ownable {
    mapping(address => uint256) private _balances;
...
abstract contract Token6 is ERC206('usdc', 'usdc'){
    function mint(address _to, uint256 _amount) external onlyOwner {
        _mint(_to, _amount);
    }
}

abstract contract Token is ERC20('qWIND', 'qWIND'){
    function mint(address _to, uint256 _amount) external onlyOwner {
        _mint(_to, _amount);
    }
}
...
contract PreSale is ReentrancyGuard, Ownable {
    ...
    ERC20 tmpToken;
    ERC20 iris; // 0x58043d412ef9fbdc4f87d5662142d047ed06cc60;
    ERC20 usdc; // 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    ERC20 finalToken;
    address public feeAddress = 0xc2057C9eaa6C5c3a18aB594023C5C067fFb40812;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public pAPOLLOPrice;
    uint256 public IRISPrice;

    uint256 public maxTokenPurchase = 10000 ether;
    ...
    function quoteAmountInPAPOLLO(uint256 amount) public view returns(uint256){
        return amount.div(pAPOLLOPrice).div(1e12);
    }
    ...
    function quoteAmountInIRIS(uint256 amount) public view returns(uint256){
        ...
        return amountInUsdcInIRIS.mul(1e12).div(IRISPrice).mul(1e12);
    }
    ...
    returns(uint256 pAppoloInUSD, uint256 inUsdc, uint256 amountIRIS, uint256 limit, uint256 tokenPurchaseAmount){
        ...
        inUsdc = quoteAmountInUSDC(tokenPurchaseAmount).mul(1e6);
    ...
    function buy( uint256 amount ) external payable nonReentrant {
        ...
        require(amountIRIS > 0, "user cannot pay 0 WAVE");
        ...
        require(amountIRIS <= userIrisBalance, "WAVE balance is too low");
