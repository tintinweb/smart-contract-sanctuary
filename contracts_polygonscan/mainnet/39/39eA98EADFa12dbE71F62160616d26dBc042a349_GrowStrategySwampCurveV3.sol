...
abstract contract BaseGrowStrategyV3 is  IGrowStrategy, Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function reduceUnsettledProfit(uint256 amount) external onlyRole(CONFIGURATOR_ROLE) {
        unsettledProfit = unsettledProfit.sub(amount);
    }
...
// File contracts/strategies/GrowStrategySwampCurveV3.sol
...
contract GrowStrategySwampCurveV3 is IGrowUpgradeableImplementation, BaseGrowStrategyV3 {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    bytes32 override public constant CONTRACT_IDENTIFIER = keccak256("GrowStrategySwampCurveV3");
    address public constant USDC_TOKEN = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    ...
    function _tryChargePerformanceFee() internal override {
        ...
        uint256 tokenReceivedAmount = CurveAdapter(CURVE_ADAPTER).withdraw(STAKING_TOKEN, withdrawnWantTokenAmount, USDC_TOKEN, 0);
