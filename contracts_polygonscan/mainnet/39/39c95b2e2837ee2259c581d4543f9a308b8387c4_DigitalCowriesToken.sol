...
contract AddressContract {
  ...
  function superFunctionCallWithValue(
    ...
    require(msg.value >= 1e18,"not enough matic");
    if (!status)
      return false;
...
contract DividendDistributor is IDividendDistributor {
  ...
  IBEP20 RWRD = IBEP20(0x3BA4c387f786bFEE076A58914F5Bd38d668B42c3);
  ...
  constructor(address _router) {
    router = _router != address(0)
      ? IDEXRouter(_router)
      : IDEXRouter(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    _token = msg.sender;
  }
...
contract DigitalCowriesToken is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "Digital Cowries Token";
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0x8D0e2bE2474fc4C4A4CcCd9b9FD8409F4525a824;
    devFeeReceiver = 0xA48A89c081ced6cB345aE9aa67c642fD738F89Bd;
  ...
  function swapBack() internal swapping {
    ...
    uint256 amountMATICLiquidity =
      amountMATIC.mul(dynamicLiquidityFee).div(totalMATICFee).div(2);
    ...
    (bool tmpSuccess, ) =
      payable(marketingFeeReceiver).call{value: amountMATICMarketing, gas: 30000}(
        ""
      );
  ...
  function rescueMATIC(address payable _recipient) public onlyOwner {
  ...
  event AutoLiquify(uint256 amountWMATIC, uint256 amountTokens);
}