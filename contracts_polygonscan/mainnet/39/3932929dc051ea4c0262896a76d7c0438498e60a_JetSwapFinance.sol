...
contract JetSwapFinance is Context, IERC20, Ownable {
...
contract JetSwap is JetSwapFinance, NativeMetaTransaction, ContextMixin {
    constructor() JetSwapFinance() {
