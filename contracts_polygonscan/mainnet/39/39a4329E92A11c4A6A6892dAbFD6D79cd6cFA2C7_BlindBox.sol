...
contract Utils is Ownable, BlindboxStorage{
    ...
    function init() public {
        MATIC = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270); //for eth chain wrapped ethereum 
        USD = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
        platform = 0x9c427ea9cE5fd3101a273815Ff8530f2AC75Db37;
        nft = INFT(0x2c3479B526394d9a5e18E2E454B9f8b1282930AC);
        dex = IDEX(0x93D7B0C1d4aFaB3d71A7c68AaA3C405a9A9245fc);
        ALIA = IERC20(0xe1a4af407A124777A4dB6bB461b6F256c1f8E341);
        ETH = IERC20(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619);
        LPAlia=LPInterface(0x8c77B810EaC25502EE7de2e447ffb80b316c4E6E);
        LPWETH=LPInterface(0x853Ee4b2A13f8a742d64C8F088bE7bA2131f670d);
        LPMATIC=LPInterface(0x604229c960e5CACF2aaEAc8Be68Ac07BA9dF81c3);
       _setOwner(_msgSender());
