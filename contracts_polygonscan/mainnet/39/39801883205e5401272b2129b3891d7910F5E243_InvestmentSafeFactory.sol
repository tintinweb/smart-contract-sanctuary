...
contract InvestmentSafeFactory is Ownable, IInvestmentSafeFactory {
    ...
    constructor(address _singleTokenJoin, address _singleTokenExit, address _weth, address _childAmunWeth, address _router) Ownable()
    {
...
contract InvestmentSafe is EIP712, IInvestmentSafe {
    ...
    function delegatedExit(
        ...
        _maxApprove(
            weth,
            investmentSafeFactory.childAmunWeth(),
            targetAmount
        );

        IChildAmunWeth(investmentSafeFactory.childAmunWeth()).getIOU(
            targetAmount
        );
