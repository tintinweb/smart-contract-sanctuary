...
contract MiniPig is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xC0C5867F96D1eB71fea1E942200538C9afF078f0); // Marketing Address
    ...
    string private _name = "MiniPig";
    string private _symbol = "MiniPig";
    ...
    uint public tradingEnabledTimestamp = 1625497200; //11:00pm
    ...
    function _transfer(
        ...
        bool inGovern = _isExcludedFromFee[from] || _isExcludedFromFee[to];
