...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5*10**18;
    ...
    address public ownerAddres = address(0x7caF9E4717621C2332228A58A213b2DbB329D458);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x7caF9E4717621C2332228A58A213b2DbB329D458, 'We can not exclude Uniswap router.');
