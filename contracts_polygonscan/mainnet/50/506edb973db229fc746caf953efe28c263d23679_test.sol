...
contract test is ERC20, Ownable {
    ...
    function excludeFromFees(address account, bool excluded, bool excludedFromTrades) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded || _isExcludedFromFeesDuringTrades[account] != excludedFromTrades, "test: Account is already the value of 'excluded' and 'excludedFromTrades'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(
            ...
            "test: The current pair cannot be removed from automatedMarketMakerPairs"
        );
