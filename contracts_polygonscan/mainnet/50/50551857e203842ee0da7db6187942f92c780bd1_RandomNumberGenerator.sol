...
// File: contracts/interfaces/IMonsterLottery.sol

pragma solidity ^0.8.4;

interface IMonsterLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in MONSTER per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in MONSTER token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInMonster: price of a ticket in MONSTER
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Monster lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == monsterLottery, "Only MonsterLottery");
    ...
    /**
     * @notice Set the address for the MonsterLottery
     * @param _monsterLottery: address of the Monster lottery
     */
    function setLotteryAddress(address _monsterLottery) external onlyOwner {
        monsterLottery = _monsterLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IMonsterLottery(monsterLottery).viewCurrentLotteryId();
    }
}