...
contract StrategyMasterchefNative is BaseStrategySingle {
    ...
    /**
        ...
        _configAddress[6]  _sandmanAddress
    ...
    */
    constructor(
        ...
        address[] memory _earnedToSandmanPath,
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public rewardAddress = 0xA75e383b467f092667Fe9e107429C0DAF82C0277;
    address public withdrawFeeAddress = 0xA75e383b467f092667Fe9e107429C0DAF82C0277;
    ...
    address[] public earnedToSandmanPath;
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            if (fee > 0) {
                ...
                if (earnedAddress == sandmanAddress) {
                    // Earn token is SANDMAN - don't sell
