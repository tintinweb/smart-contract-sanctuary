...
// File: Vault\StrategyPolygonfarmSpadeMaticQuickswap.sol

// openzeppelin v3.1.0

contract StrategyPolygonfarmSpadeMaticQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
        token1ToEarnedPath = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
    }
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance,) = IPolygonFarm(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}