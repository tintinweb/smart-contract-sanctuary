...
contract TigerSwap is ERC20("TigerSwap", "TIGER"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "TIGER::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "TIGER::delegateBySig: invalid nonce");
        require(now <= expiry, "TIGER::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "TIGER::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "TIGER::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn TIGER on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
