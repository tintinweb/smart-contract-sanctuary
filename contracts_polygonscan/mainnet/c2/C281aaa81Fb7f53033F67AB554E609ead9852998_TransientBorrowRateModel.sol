...
contract TransientBorrowRateModel is InterestRateModel {
    ...
    /**
     * @notice The min number of blocks per year that is assumed by the interest rate model (2.0 seconds/block)
     */
    uint256 public constant blocksPerYearMax = 15768000;

    /**
     * @notice The max number of blocks per year that is assumed by the interest rate model (2.5 seconds/block)
     */
    uint256 public constant blocksPerYearMin = 12614400;

    /**
     * @notice The approximate number of blocks per year that is assumed by the interest rate model
     */
    uint256 public blocksPerYear = 14016000;
