...
abstract contract ZapInBaseV3 is ZapBaseV2 {
    ...
    function _pullTokens(
        ...
        IERC20(token).safeTransferFrom(msg.sender, address(this), amount); // approve this contract to spend tokens
...
contract TestComethSwap_ZapIn_V2 is ZapInBaseV3 {
    ...
    function _uniDeposit(
        ...
        (uint256 amountA, uint256 amountB, uint256 LP) = comethSwapRouter
            .addLiquidity(
                _ToUnipoolToken0,
                _ToUnipoolToken1,
                token0Bought,
	...
	*/
    function _token2Token(
        ...
        address pair = comethSwapFactory.getPair(
            _FromTokenContractAddress,
