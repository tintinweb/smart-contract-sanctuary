...
contract DeliriumAirDrop is Ownable, ReentrancyGuard, IERC721Receiver, ERC721Holder {
    ...
    // NFT
    IERC721Enumerable public theEndlessNFTAddress = IERC721Enumerable(0x2487DF8D510cC0A9ec99fcE1F1d43adb3F6C731d); 
    ...
    function claimDeliriumAirdrop() external nonReentrant {
        ...
        if (balanceOfNFT > 0) {
            ...
            theEndlessNFTAddress.safeTransferFrom(address(this), msg.sender, lastNFTAssigned);
        }
    ...
    function setEndBlock(uint256 _newEndBlock) external onlyOwner {
        require(block.number < endBlock, "E1");
        require(block.number < _newEndBlock, "E1");
    ...
    function canClaim(address _userAddress) external view returns (bool) {
        return recipients[_userAddress];
    }
