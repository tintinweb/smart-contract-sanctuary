...
contract MecenasV2 is ERC20m, ReentrancyGuard {
    ...
    constructor(address _owner, address _marketcream, address _underlying, address _developer, address _seeker, uint _mindeposit, uint _agedeposit, uint _agelottery)
    ERC20m("crMECENASPOOLS", "crMEC") {
    ...
    function calculatedata() external view returns (uint [] memory) {
        ...
        uint[] memory datafront = new uint[](21);
