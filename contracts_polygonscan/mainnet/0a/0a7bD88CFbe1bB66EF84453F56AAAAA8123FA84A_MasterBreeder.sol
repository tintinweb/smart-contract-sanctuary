...
contract MasterBreeder is Ownable, Authorizable, ReentrancyGuard {
    ...
    constructor(
        ...
        address _devaddr = 0xf6484a675bdAb511fefDb5CbC82Af2cb8e4Cc560;
        address _liquidityaddr = 0xf098DEE65bd2785601c276758b2Ab02c62f13cf4;
        address _comfundaddr = 0xf098DEE65bd2785601c276758b2Ab02c62f13cf4;
        address _founderaddr = 0xf6484a675bdAb511fefDb5CbC82Af2cb8e4Cc560;
        uint256 _rewardPerBlock = 1;
        uint256 _startBlock = 16980870;
        uint256 _halvingAfterBlock = 17980870;
        uint256 _userDepFee = 1;
        uint256 _devDepFee = 1;
        uint256[] memory _rewardMultiplier = new uint256[](10);
        uint256[] memory _blockDeltaStartStage= new uint256[](10);
        uint256[] memory _blockDeltaEndStage= new uint256[](10);
        uint256[] memory _userFeeStage= new uint256[](10);
        uint256[] memory _devFeeStage = new uint256[](10);
        govToken = _govToken;
        devaddr = _devaddr;
