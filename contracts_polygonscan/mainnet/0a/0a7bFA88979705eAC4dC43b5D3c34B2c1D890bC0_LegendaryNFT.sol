...
contract LegendaryNFT is LOCAccess, ERC721Enumerable {
    string private _uri = "https://metadata-nftswappable.s3.eu-central-1.amazonaws.com/";

    event BaseURISet(string indexed baseURI);

    constructor(address admin, address minter)
        LOCAccess(admin, minter)
        ERC721("LOC Legendary NFT", "LNFT")
    {}
