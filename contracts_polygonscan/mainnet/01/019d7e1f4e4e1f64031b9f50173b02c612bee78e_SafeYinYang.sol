...
contract SafeYinYang is ERC20, Ownable {
   ...
   DividendTracker public dividendTracker;
    ...
    uint256 public _maxWalletToken = 40000000 * (10**18); // 1.5% of total supply
    ...
    // timestamp for when the token can be traded freely on quickswap
    uint256 public immutable tradingEnabledTimestamp = 1630888835;
