...
contract StakeMinter is IStakeMinter, Manageable, ExternallyCallable {
    ...
    /** @dev Manager Stake
        Description: Staking function to initialize auction bids from Etheruem
        @param amount {uint256} - AXN amount to be staked
        @param stakingDays {uint256} - number of days to be staked
        @param account {address} - address of user to restore.
    */
    function managerStake(
        ...
        stakeInternal(amount, stakingDays, account); // to call internal function 0 gas
    }
