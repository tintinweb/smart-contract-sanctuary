...
contract Goo is Ownable, Pausable, IGoo, ERC721Holder {
        ...
        whenNotPaused
    {
        ...
        require(_isApprovedOrOwner(buddy), "ERC20: Need approval for burn");
    ...
    function transferFrom(
        ...
        require(_isApprovedOrOwner(executor), "ERC20: Need approval to transfer");
        ...
        returns (bool)
    {
        ...
        for (uint256 i = 0; i < from.length; i++) {
            ...
            require(_isApprovedOrOwner(buddy), "ERC20: Need approval to transfer");
