...
contract bnSafe_Test01 is Token {
    ...
    uint private constant USER_AIRDROP       = 500 ether;
    ...
    function stakeBNB(address referrer) public payable {
        ...
        require(msg.value >= MIN_STAKE, "Minimum to stake is 0.02");
    ...
    function buyToken(uint tokenAmount) public payable {
        require(msg.value == tokenAmount.mul(getTokenPrice().mul(2)).div(PRICE_DIVIDER), "Wrong Amount");
