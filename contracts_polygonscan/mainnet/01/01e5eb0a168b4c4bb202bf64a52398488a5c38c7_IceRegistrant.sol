...
contract IceRegistrant is AccessController, TransferHelper, EIP712MetaTransaction, Events {
        ...
        EIP712Base('IceRegistrant', 'v1.1')
    {
        ...
        targets[_accessoriesContract] = true;
    ...
    function changeAccessoriesDG(
        address _newAccessoriesContract
    )
        external
        onlyCEO
    {
        accessoriesContract = _newAccessoriesContract;
    }
        ...
        returns (uint256)
    {
        ...
        ) = DGAccessories(accessoriesContract).items(_itemId);
