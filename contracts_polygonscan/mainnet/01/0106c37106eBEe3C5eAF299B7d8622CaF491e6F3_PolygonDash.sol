...
// File: contracts/PolygonDash.sol
...
contract PolygonDash is BEP20('PolygonDash', 'PolyDash') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "PolyDash::transfer: Burn value invalid");
