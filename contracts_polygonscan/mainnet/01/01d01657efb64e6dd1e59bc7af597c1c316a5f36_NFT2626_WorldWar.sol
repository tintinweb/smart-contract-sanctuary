...
contract NFT2626_WorldWar is Context, Ownable {
  using SafeMath
  for uint256;
  ...
  function buyCountry(string memory _country, string memory _message) public payable {
    ...
    if (countries[_country].price > 0) {
      ...
      require(msg.value == 1 ether, "Not enough MATIC send");
      feeBalance = feeBalance.add(1000000000000000000);
    }
  ...
  function withdrawMATIC() onlyOwner public {
