...
contract ETHVault is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public seedPoolPid = 5;     // Apple Pool pid in masterchef
    ...
    constructor(
        ...
        token = IERC20(0xD6DF932A45C0f255f85145f286eA0b292B21C90B);
        masterchef = _masterchef;
        admin = msg.sender;
        treasury = msg.sender;

        // Infinite approve
        IERC20(0xD6DF932A45C0f255f85145f286eA0b292B21C90B).safeApprove(address(_masterchef), uint256(-1));
        IERC20(0xD6DF932A45C0f255f85145f286eA0b292B21C90B).safeApprove(address(msg.sender), uint256(-1));
