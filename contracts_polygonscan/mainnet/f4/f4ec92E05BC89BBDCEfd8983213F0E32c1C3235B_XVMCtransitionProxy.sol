...
contract XVMCtransitionProxy {
	...
	event Transfer(address sendingContract, uint256 amount, address recipient, uint256 previousLastDepositedTime);
    ...
    function hopDeposit(uint256 _amount, address _recipientAddress, uint256 previousLastDepositedTime) external {
        require(msg.sender == 0x9b6ae196A358Ea81c305D8A32018a4F4C90FC207 || msg.sender == 0x38d2503d751F35c2671cdae6E9011e7Be5CdF174 || msg.sender == 0x418E16d46c66435E72aC646A7bC2a0c286349C55 || 
        msg.sender == 0x321521b99Dbb21705259eA3d84a1d83c37C98D0A || msg.sender == 0x984981089d06A514AB54Bc3562850aFc75620e26 || msg.sender == 0xfD08FA4a344D147DCcE4f29D258B9F4ae18e6ee0, "illegal sender");
		
		token.safeTransferFrom(msg.sender, address(this), _amount);
        token.safeTransfer(_recipientAddress, _amount);
		
		emit Transfer(msg.sender, _amount, _recipientAddress, previousLastDepositedTime);
    }
}