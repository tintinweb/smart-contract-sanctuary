...
contract BLIZZ is Context, IERC20, Ownable {
    ...
    address public developmentWallet = 0xbA1DEF1E5C2B1C3B453F9F0AD45A1b9E61a74ce8;
    ...
    function setAllFee(uint256 newDevelopmentFee, uint256 newburnFee,uint256 newLiquidityFee, uint256 newTaxFee)public onlyOwner{
        _taxFee = newTaxFee;
