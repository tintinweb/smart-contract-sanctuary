...
contract AstroWorld is ERC721{
 ...
 function contractURI() public pure returns (string memory) {
    ...
    function PassValue() public view returns (uint256, uint256, uint256) {
        ...
        Rate = 3000000000000000000000000000000000;
        pricex = uint256(price); 
        pricex = pricex * 0.00000001 ether;
        
        uint256 PassxAmount = (Rate / pricex) * 0.000000000001 ether;

        return(PassxAmount, Rate, pricex);


    }

 function AstroTestPass() public payable returns (uint256, int) {
     
             
        uint256 Rate;
        uint256 balsend;
        address payable ownerx = 0x2c9bE6e47F3D64ba468632AADC6E1F3f31394aDc;
