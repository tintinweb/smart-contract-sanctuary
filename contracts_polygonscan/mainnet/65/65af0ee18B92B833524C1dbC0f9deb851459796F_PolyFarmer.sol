...
contract PolyFarmer {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 0.1 ether; // 0.1 MATIC 
    ...
    constructor() public {
        ...
        ceoAddress2=0x42242c834c5CE6b89b4c989935653ebCEE5cCa20;      
        ceoAddress3=0xe1647a5e0F539eFC8Ff9E9E0BA51b5b1b9B8185c;          
        ceoAddress4=0x5E2b3D94d2CA6CDdBa6dd7C856271160DD865A41;           
        
        plans.push(Plan(10000, 25));
        plans.push(Plan(40, 60));
        plans.push(Plan(60, 55));
        plans.push(Plan(90, 50));
    }
