...
// File contracts/IMakiLottery.sol
...
// File contracts/MakiLottery.sol
...
contract MakiLottery is ReentrancyGuard, IMakiLottery, Ownable {
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        uint256 amountToShareToWinners = (
            ((_lotteries[_lotteryId].amountCollectedInSOY) *
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId]
            .amountCollectedInSOY - amountToShareToWinners);
    ...
    function startLottery(
        ...
        require(
            (_priceTicketInSOY >= minPriceTicketInSOY) &&
                (_priceTicketInSOY <= maxPriceTicketInSOY),
            "Outside of limits"
        );
    ...
    function setMinAndMaxTicketPriceInSOY(
        uint256 _minPriceTicketInSOY,
        uint256 _maxPriceTicketInSOY
    ) external onlyOwner {
        require(
            _minPriceTicketInSOY <= _maxPriceTicketInSOY,
