...
// File: Vault\StrategyCrystlAzukiMaticApeswap.sol

// openzeppelin v3.1.0

contract StrategyCrystlAzukiMaticApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x0076bf0c28e604cc3fe9967c83b3c3f31c213cfe64), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007cdc0421469398e0f3aa8890693d86c840ac8931)];
        ...
        token1ToEarnedPath = [address(0x007cdc0421469398e0f3aa8890693d86c840ac8931), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0076bf0c28e604cc3fe9967c83b3c3f31c213cfe64)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007cdc0421469398e0f3aa8890693d86c840ac8931)];
    }
