...
contract XVMCbasics is Ownable {
    ...
    */
    function initiateSetMinDeposit(uint256 depositingTokens, uint256 newMinDeposit) external {
    ...
    function vetoSetMinDeposit(uint256 proposalID) external {
    ...
    function executeSetMinDeposit(uint256 proposalID) external {
    	require(
    ...
    */
    function initiateDelayBeforeEnforceProposal(uint256 depositingTokens, uint256 newDelay) external { 
    ...
    function vetoDelayBeforeEnforceProposal(uint256 proposalID) external {
    ...
    function executeDelayBeforeEnforceProposal(uint256 proposalID) external {
    	require(
  ...
  /**
    ...
    */
    function initiateProposalRolloverBonus(uint256 depositingTokens, address _forPoolAddress, uint256 _newBonus) external { 
    	require(depositingTokens <= IXVMCgovernor(owner()).maximumVoteTokens(), "No tyranny");
    	require(depositingTokens >= IXVMCgovernor(owner()).costToVote(), "minimum cost to vote");
    ...
    function vetoProposalRolloverBonus(uint256 proposalID) external {
    ...
    function executeProposalRolloverBonus(uint256 proposalID) external {
    	require(
     ...
     */
    function initiateSetCallFee(uint256 depositingTokens, uint256 newCallFee, uint256 newCallFeeWithBonus) external { 
    ...
    function vetoSetCallFee(uint256 proposalID) external {
    ...
    function executeSetCallFee(uint256 proposalID) external {
    	require(
    ...
    //governor is the owner of masterchef
