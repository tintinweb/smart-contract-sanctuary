...
// File: contracts/EpicStrategy_Polygon_Pickle_AM3CRV.sol
...
contract EpicStrategy_Polygon_Pickle_AM3CRV{
    ...
    address public constant want = CURVE_LP_TOKEN; //Curve USD-BTC-ETH (crvUSDBTC...)
    ...
    function getName() external pure returns (string memory) {
        return "EpicStrategy_Polygon_Pickle_AM3CRV";
    }
    ...
    function balanceOfPool() public view returns (uint256) {
        ...
        return amount.mul(pps).div(1e18);
    }
