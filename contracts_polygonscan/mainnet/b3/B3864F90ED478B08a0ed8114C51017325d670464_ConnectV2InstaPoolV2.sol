...
contract LiquidityResolver is DSMath, Stores, Variables, Events {
    ...
    */
     ...
     * @param tokens_ Token Address.
     * @param amts_ Token Amount.
     * @param getIds Get token amount at this ID from `InstaMemory` Contract.
     * @param setIds Set token amount at this ID in `InstaMemory` Contract.
    */
...
contract ConnectV2InstaPoolV2 is LiquidityResolver {
    constructor(
        address _instaPool
    ) public LiquidityResolver(_instaPool) {}
