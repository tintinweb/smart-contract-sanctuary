...
contract Bark is ERC1155Supply, ERC1155Burnable, ContractURI, Royalty {
    string public name = "Bark";
    string public symbol = "BARK";
    ...
    constructor()
        ERC1155("https://merrymodz.io/api/bark/token/{id}.json")
        ContractURI("https://merrymodz.io/api/bark/contract.json")
        Royalty(0xdAD835097E934A3B7D0b8528Cc6a29D58BA1D308, 500) // MerryModz owner recieves 5.00%
    {
        withdrawalAddress = 0xdAD835097E934A3B7D0b8528Cc6a29D58BA1D308; // MerryModz Owner
        minter = 0xBaf3c9ef1b1e9566ccb514d28189C34a2983F3d1; // MerryModz Minter
    }
    ...
    function setContractURI(string memory _contractURI) public onlyOwner {
        ContractURI._setContractURI(_contractURI);
    }
    ...
    function mint(address _to, uint256 _tokenId) public onlyMinter {
        require(!minted[_tokenId], "There can be only one");
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC1155, ContractURI, Royalty)
        returns (bool)
    {
        return
...
abstract contract ContractURI is ERC165 {
