...
// File: contracts/CutepugInu.sol

contract CutepugInu is AccessControl, ERC20Capped, ERC20Fallback, Ownable {
    ...
    constructor (
        ...
        ERC20Fallback()
    {
        require(initialAccount != address(0), "CutepugInu: initialAccount is a zero address");
        _decimals = decimals_;
