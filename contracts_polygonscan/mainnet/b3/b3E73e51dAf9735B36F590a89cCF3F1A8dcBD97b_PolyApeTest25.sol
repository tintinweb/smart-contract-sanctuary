...
contract PolyApeTest25 is IERC721 {
    ...
    uint public constant TOKEN_LIMIT = 25;
    ...
    string internal nftName = "PolyApeTest25";
    string internal nftSymbol = "PolyApeTest25";
    ...
    uint private mintPrice = 0 ether;
    ...
    function tokenURI(uint256 _tokenId) external view validNFToken(_tokenId) returns (string memory) {
        return string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmSHLhoudpX3BwCz1h5pengM5hBnRTr3BbuJ9YCf8Laxey/", toString(_tokenId)));
    }
    ...
    modifier onlyTokenOwner (uint256 _tokenId) {
        require(_tokenId < 25, "punk number is wrong");
    ...
    function buyPunk(uint punkIndex) public payable reentrancyGuard{
        require(marketPaused == false, 'Market Paused');
        require(punkIndex < 25, "punk number is wrong");
