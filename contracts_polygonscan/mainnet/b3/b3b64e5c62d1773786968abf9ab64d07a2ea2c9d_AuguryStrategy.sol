...
abstract contract BaseStrategyAugury is BaseStrategyMasterChef {
...
contract AuguryStrategy is BaseStrategyAugury {

    constructor(address lp, address tokenA, uint256 _poolId, address strategist)
        public
        BaseStrategyAugury(
            lp,
            tokenA,
