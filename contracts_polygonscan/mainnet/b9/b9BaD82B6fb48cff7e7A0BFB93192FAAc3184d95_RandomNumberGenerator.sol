...
interface ITinyFusion {
    //-------------------------------------------------------------------------
    // STATE MODIFYING FUNCTIONS
    //-------------------------------------------------------------------------

    function updateLuckNum(
        uint256 _luckyNum
    ) external;
...
contract RandomNumberGenerator is VRFConsumerBase, Ownable {
    ...
    modifier onlyFusion() {
        require(msg.sender == fusion, "Only Fusion can call function");
        _;
    }
     ...
     */
    function getRandomNumber() public onlyFusion returns (bytes32 requestId) {
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ITinyFusion(requester).updateLuckNum(randomness);
