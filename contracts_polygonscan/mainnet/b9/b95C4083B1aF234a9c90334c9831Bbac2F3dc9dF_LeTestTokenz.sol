...
/**
 * LeTestTokenz V2
 * Native Blockchain Gaming & Non-Inflationary Yield Farming/Staking Token.
 * https://LeTestTokenz.net
 */
...
contract LeTestTokenz is Context, IERC20, Ownable {
    ...
    string private _name = "LeTestTokenz";
    string private _symbol = "LeTestTokenz";
    ...
    uint256 private numTokensSwap = 500000 * 10**9;
    ...
    function excludeInFee(address _address) external onlyOwner {
        for(uint i = 0; i < _includedInFees.length; i++) {
            if(_includedInFees[i] == _address) {
    ...
    function setSwapEnabled(bool _enabled) external onlyOwner {
        ...
        emit SwapTokensEnabledUpdated(_enabled);
    }

    function setGlobalTradingEnabled(bool _enabled) external onlyOwner {
        globalTradingEnabled = _enabled;
    }
    ...
    function _takeLiquidity(uint256 tFee) private {
    ...
    function _transfer(
        ...
        //if any account belongs to _isIncludedInFees account then remove the fee
