...
contract NerdHeadClub is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  string public _initNotRevealedUri = "https://nerdhead.tk/default.json";
  string public _initBaseURI = "ipfs://QmeBM8zmwC9jxAQVeP93Ku1GhooLxxARb5sdNp8cT6d3qu/";

  constructor(
  ) ERC721("Nerd Head Club", "NHC") {
