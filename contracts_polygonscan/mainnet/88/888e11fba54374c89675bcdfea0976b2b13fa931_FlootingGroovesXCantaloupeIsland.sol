...
// File: src/backEnd/contracts/CantaloupeIsland.sol
...
contract FlootingGroovesXCantaloupeIsland is ERC721PresetMinterPauserAutoId {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

  constructor() ERC721PresetMinterPauserAutoId("Flooting Grooves X Cantaloupe Island", "FLOOTINGGROOVES", "https://ipfs.io/ipfs/") {
  
  }
  
  function mintWithIPFSHash(string memory _tokenURI, address _address)  public virtual returns (bool) {
   require(hasRole(MINTER_ROLE, _msgSender()), "CantaloupeIsland: must have minter role to mint for sale");
      _tokenIdTracker.increment();
      _mint(_address, _tokenIdTracker.current());
