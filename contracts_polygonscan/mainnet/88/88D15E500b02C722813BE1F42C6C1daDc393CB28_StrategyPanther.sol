...
contract StrategyPanther is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public depositFeeFactor = 10000;
    ...
    uint256 public exitFeeFactor = 10000; // < 0.1% exit fee - goes to pool
        ...
        returns (uint256)
    {
        ...
        counterCompound = counterCompound.add(1);

        if(counterCompound >= 3 && isAutoComp && wantLockedTotal > 0){
            _earn();
        }
    ...
    function _farm() internal {
        ...
        IXswapFarm(farmContractAddress).deposit(pid, wantAmt, govAddress);
    }
