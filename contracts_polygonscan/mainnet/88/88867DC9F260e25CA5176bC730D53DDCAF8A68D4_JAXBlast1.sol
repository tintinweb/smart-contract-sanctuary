...
*/
contract JAXBlast1 is Album {

    using SafeMath for uint256;

    /**
        @notice Registers the Pool name as “JAXBLAST1 - TAWANDA”,
    ...
    */
    ...
    Album(1026, "Tawanda CrypoJazz Festival",// solhint-disable-line func-visibility
    ...
    */
    function rewardRate(uint256 epoch) public pure override returns (uint256) {
        ...
        if (epoch >= 1026) {
            ...
            } else if (epoch >= 1068 && epoch <= 1109) {
                seriesRewards = 25000;// 25,000
            } else if (epoch >= 1110 && epoch <= 1151) {
                seriesRewards = 15000;// 15,000
            } else if (epoch >= 1152 && epoch <= 1193) {
    ...
    */
    function rewardRate2(uint256 epoch) public pure override returns (uint256) {
        require(epoch >= 1026, "epoch cannot be below 1026");
        if (epoch > 1277) {
            return 0;
        } else {
