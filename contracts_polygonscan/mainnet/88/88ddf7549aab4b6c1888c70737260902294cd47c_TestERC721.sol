...
contract TestERC721 is ERC721EnumerableUpgradeable, OwnableUpgradeable {
     ...
     */
    function mint(address staker, uint256 id) external onlyOwner {
    ...
    /** @dev Get STake IDS of
        ...
        @return {uint256[]}
     */
    function getTokenIdsOf(address account) external view returns (uint256[] memory) {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        StakeUri memory stake = stakeManager.getStakeUri(tokenId);
    ...
    function initialize(
        ...
        __Ownable_init();
        baseUri = 'https://generate-art.s3.amazonaws.com/';
...
abstract contract Pausable is Manageable {
    ...
    modifier whenNotPaused() {
        require(
            paused == false || hasRole(MANAGER_ROLE, msg.sender) || _whitelist[msg.sender],
            'Function is paused'
        );
        _;
    }
