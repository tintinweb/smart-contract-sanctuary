...
// PolyMountainToken with Governance.
contract PolyMountainToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // The PolyMountainToken!
    PolyMountainToken public panther;
    // Dev address.
    ...
    constructor(
        PolyMountainToken _pmt,
        uint256 _startBlock,
        uint256 _pmtPerBlock
    ) public {
        panther = _pmt;
        startBlock = _startBlock;
        pantherPerBlock = _pmtPerBlock;
    ...
    function updateEmissionRate(uint256 _pmtPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _pmtPerBlock);
        pantherPerBlock = _pmtPerBlock;
    }
