...
contract GDAOMEMETESTMINTER is ERC721Enumerable, Ownable {
    ...
    constructor(uint256 mintingStart, string memory _uri, address poeToken) ERC721("GDAO HIDDEN MEME COLLECTION", "NFGDAO") {
        mintingActive = false;
