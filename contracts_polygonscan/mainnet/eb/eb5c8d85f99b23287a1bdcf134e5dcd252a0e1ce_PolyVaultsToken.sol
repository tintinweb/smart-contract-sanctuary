...
contract PolyVaultsToken is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ERC20Upgradeable.__ERC20_init("PolyVaults.fi", "PVI");
        OwnableUpgradeable.__Ownable_init();
        cap = 1000000 ether; // Max Supply: 1 million PVI
        _mint(_msgSender(), (cap * 20) / 100); // IDO + Reserve Fund + Init Operation Fund: 20%
    }
