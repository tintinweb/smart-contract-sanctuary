...
contract PetEconomicToken is Context, IERC20, Ownable {
    ...
    string private _name = "Pet Economic Token";
    ...
    constructor () {
        ...
        // setUniswapV2RouterAddress(_uniswapV2RouterAddress); ?
    ...
    function setUniswapV2RouterAddress(address _uniswapV2RouterAddress) external onlyOwner() {
    ...
    function decreaseAllAllowance(address spender) public virtual returns (bool) {
