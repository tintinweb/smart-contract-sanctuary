...
contract ElysianFields is Ownable {
  ...
  using SafeERC20 for Sestertius;
  ...
  constructor(
    ...
    deploySestertius(_name, _symbol, _cap, _amountForPool, _rewardReceiver);
  }

  // The Reward token
  Sestertius public rwdToken;
  // Info of each pool.
  ...
  function deploySestertius(
    ...
    rwdToken = new Sestertius(_name, _symbol, _cap);
...
contract Sestertius is ERC20Capped {
