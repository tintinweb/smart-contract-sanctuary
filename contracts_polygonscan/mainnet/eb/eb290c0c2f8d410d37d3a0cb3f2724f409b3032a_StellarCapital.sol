...
contract StellarCapital is ERC721, ERC721Enumerable, ERC721URIStorage, ContextMixin, HasSecondarySaleFees, Ownable {
    ...
    HasSecondarySaleFees(new address payable[](0), new uint256[](0))
    {
        ...
        string memory json = Base64.encode(abi.encodePacked('{"name": "Test", "description": "', _Discription, '", "external_url": "https://twitter.com/pote_pote_salad", "animation_url": "', ipfs, 'v.html#', myAddr, '+', currentNumber.toString(), '", "image": "', ipfs, 'main.png"}'));
        _setTokenURI(currentNumber, string(abi.encodePacked('data:application/json;base64,', json)));
        ...
        internal
    {
        ...
        string memory json = Base64.encode(abi.encodePacked('{"name": "', title, '", "description": "', _Discription, '", "external_url": "https://twitter.com/pote_pote_salad", "animation_url": "', ipfs, 'v.html#', strBlock, '+', myAddr, '+', tokenId.toString(), '", "image": "', image_ipfs, '"}'));
