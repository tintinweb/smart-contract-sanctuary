...
contract JavaToken is BEP20('JavaSwap Token', 'JAVA') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "JAVA::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "JAVA::delegateBySig: invalid nonce");
        require(now <= expiry, "JAVA::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "JAVA::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying JAVAs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "JAVA::_writeCheckpoint: block number exceeds 32 bits");
