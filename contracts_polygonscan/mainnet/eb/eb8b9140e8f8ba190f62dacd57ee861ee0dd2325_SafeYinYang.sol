...
contract SafeYinYang is ERC20, Ownable {
   ...
   DividendTracker public dividendTracker;
    ...
    address public marketingWallet1 = 0x7D4ABaea6e0Fd76Bbc25e29AFc2b6185356E0b3e;
    address public bankAddress;



    uint256 public maxBuyTranscationAmount = 300000 * (10**18);
    uint256 public maxSellTransactionAmount = 150000 * (10**18);
    uint256 public swapTokensAtAmount = 30000 * (10**18);
    uint256 public _maxWalletToken = 400000 * (10**18); // 1.5% of total supply
    ...
    uint256 private constant DefaultLiquidityLockTime=133 days;

    // timestamp for when the token can be traded freely on PanackeSwap
    uint256 public immutable tradingEnabledTimestamp = 1629618645;
    ...
    event UpdateUniswapRouterV2(address indexed newAddress, address indexed oldAddress);
    ...
    constructor() public ERC20 ( "SafeYinYang","SYY" ) {
    	...
    	IUniswapRouterV2 _UniswapRouterV2 = IUniswapRouterV2(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
         // Create a uniswap pair for this new token
        address _uniswapV2Pair = IUniswapFactory(_UniswapRouterV2.factory())
            .createPair(address(this), _UniswapRouterV2.WETH());
        ...
        dividendTracker.excludeFromDividends(address(_UniswapRouterV2));
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        newDividendTracker.excludeFromDividends(address(UniswapRouterV2));
    ...
    function updateUniswapRouterV2(address newAddress) public onlyOwner {
        require(newAddress != address(UniswapRouterV2), "BabyEthereum: The router already has that address");
        emit UpdateUniswapRouterV2(newAddress, address(UniswapRouterV2));
        UniswapRouterV2 = IUniswapRouterV2(newAddress);
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyEthereum: The Uniswap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function setMarketingWallet(address _marketingWallet1, address _marketingWallet2, address _marketingWallet3) public onlyOwner {
    ...
    function _transfer(
        ...
        if(
        	...
        	from != address(UniswapRouterV2) && //router -> pair is removing liquidity which shouldn't have max
    ...
    function swapETHForTokens(uint256 amount) private {
      ...
      // make the swap
        UniswapRouterV2.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
    ...
    function withdrawRemainingERC20Token(address erc20, address account) public onlyOwner {
