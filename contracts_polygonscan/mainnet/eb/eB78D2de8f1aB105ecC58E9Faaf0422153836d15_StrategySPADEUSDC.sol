...
contract StratManager is Ownable, Pausable {
     ...
     * @param _paprFeeRecipient address where to send Beefy's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
     ...
     */
    function setBeefyFeeRecipient(address _paprFeeRecipient) external onlyOwner {
        paprFeeRecipient = _paprFeeRecipient;
    }
...
contract StrategySPADEUSDC is StratManager, FeeManager {
    ...
    address constant public output = address(0xf5EA626334037a2cf0155D49eA6462fDdC6Eff19);
    address constant public _referrer = address(0x000000000000000000000000000000000000dEaD);
    address public want;
    address public lpToken0;
    address public lpToken1;

    // Third party contracts
    address constant public masterchef = address(0x9A2C85eFBbE4DD93cc9a9c925Cea4A2b59c0db78);
    ...
    function harvest() external whenNotPaused onlyEOA {
        IMasterChef(masterchef).deposit(poolId, 0, _referrer);
    ...
    function chargeFees() internal {
        uint256 toWmatic = IERC20(output).balanceOf(address(this)).mul(44).div(1000);
