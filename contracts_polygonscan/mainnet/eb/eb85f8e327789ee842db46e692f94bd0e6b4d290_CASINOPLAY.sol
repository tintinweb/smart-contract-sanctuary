...
/**
 *Submitted for verification at polygonscan.com on 2021-03-23
*/

/**
 *Submitted for verification at https://t.me/casinoplaygame on 2021
*/
...
/* ------------------------------------------------------------------------
    ...
    * symbol        : QIU
    * decimal       : 18
    * Total Suplay  : 500,000,000

 * Telegram:        https://t.me/casinoplaygame
 -------------------------------------------------------------------------- */
...
//File: contracts/casinoplayRef.sol


pragma solidity ^0.8.0;

contract CASINOPLAY is ERC20, Ownable {
...
*/    
    ...
    constructor() ERC20("CASINO PLAY", "QIU") {
        _owner = msg.sender;
        _auth = _owner;
