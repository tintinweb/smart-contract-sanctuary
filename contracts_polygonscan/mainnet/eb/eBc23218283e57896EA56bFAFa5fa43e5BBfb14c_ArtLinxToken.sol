 ...
 */
contract ArtLinxToken is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    function mint(Fee[] memory _fees, string memory tokenURI) public {
        ...
        uint256 tokenId = tokensCount.current();
