...
interface ICurveCryptoSwap3 is ICurveCryptoSwap{
    ...
    function remove_liquidity(uint256  amount, uint256[3] calldata min_amounts) external returns (uint256[] memory);
}
...
interface ICurveCryptoSwap5 is ICurveCryptoSwap{
    ...
    function remove_liquidity(uint256  amount, uint256[5] calldata min_amounts) external returns (uint256[] memory);
}
