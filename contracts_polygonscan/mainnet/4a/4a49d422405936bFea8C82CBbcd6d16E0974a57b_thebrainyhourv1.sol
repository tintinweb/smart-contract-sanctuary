...
//ENTER THE BRAINY HOUR

//Pre-whitelist game for Zombiebits holders

//visit https://theundeadinc.io for the full experience 

//created by Zombiebits @ZombieBitsNFT
...
contract thebrainyhourv1 is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
for(uint i = 0; i < quantity; i++) {
            uint mintIndex = uint(keccak256(abi.encodePacked(block.timestamp, block.difficulty, msg.sender))) % 150;
