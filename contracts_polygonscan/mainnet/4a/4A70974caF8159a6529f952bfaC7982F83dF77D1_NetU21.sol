...
contract NetU21 is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply, ERC1155Holder, Ownable {
    ...
    function poolMint() public {
        ...
        require(totalSupplyYear[currentYear]<210000000000000, "POOL_END");
    ...
    function burnNFT(uint256 _Id, uint256 _n) public onlyRole(DEFAULT_ADMIN_ROLE) {
        _NFT[_Id].NFTStatus[_n] = "Burnt";
        _NFT[_Id].RentValue[_n] = 0;
        _NFT[_Id].SellValue[_n] = 0;
        _NFT[_Id].idToOwner[_n] = address(0);
