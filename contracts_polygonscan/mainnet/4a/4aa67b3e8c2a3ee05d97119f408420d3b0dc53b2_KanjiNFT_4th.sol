...
contract KanjiNFT_4th is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] public cha = ["\u6050","\u5bb4","\u990c","\u611f","\u96cc","\u67f5","\u5840","\u6fc0","\u796d","\u5c11","\u7551","\u95d8","\u59ff","\u56f3","\u819c","\u6307","\u706b","\u86cd","\u85aa","\u521d","\u9b5a","\u6f01","\u91e3","\u62f3","\u4e94","\u65d7","\u708e","\u5e73","\u6d6e","\u7fa4","\u968e","\u5e8a","\u6d41","\u82b1","\u83ef","\u98db","\u9727","\u6298","\u5f93","\u98df","\u98ef","\u8db3","\u9e93","\u984d","\u68ee","\u6797","\u5fd8","\u8a31","\u5f62","\u5f0f",
"\u798f","\u5360","\u790e","\u56db","\u85ab","\u67a0","\u6687","\u9bae","\u53cb","\u524d","\u971c","\u51cd","\u5b9f","\u6e80","\u83cc","\u5f97","\u9699","\u5712","\u5ead","\u9580","\u98fd","\u8d77","\u6163","\u8d08","\u4e0e","\u7523","\u8276","\u8ff7","\u8d8a","\u795e","\u91d1","\u5584","\u54c1","\u5b98","\u6f54","\u7a40","\u7c92","\u5b6b","\u8349","\u6b32","\u7dd1","\u6e9d","\u5c0e","\u9283","\u7656","\u9aea","\u6bdb","\u534a","\u624b","\u5e78"];
  string[] public meanx = ["fear","feast","feed","feel","female","fence","fence","fervent","festival","few","field","fight","figure","figure","film","finger","fire","firefly","firewood","first time","fish","fishing","fishing","fist","five","flag","flame","flat","float","flock","floor","floor","flow","flower","flower","fly","fog","fold","follow","food","food","foot","foothills","forehead","forest","forest","forget","forgive","form","formula",
"fortune","fortune-telling","foundation","four","fragrance","frame","free time","fresh","friend","front","frost","frozen","fruit","full","fungus","gain","gap","garden","garden","gate","get bored","get up","get used to","gift","give","give birth","gloss","go astray","go over","god","gold","good","goods","government","gracious","grain","grain","grandchild","grass","greed","green","groove","guidance","gun","habit","hair","hair","half","hand","happy"];
  ...
  string private rl1='{"name": "KanjiNFT_4th #';
  string private rl3='"}';
...
//}
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    Kanji memory kanji = randomOne(tokenId);
    string memory id=(tokenId+300).toString();
...
//gasless
  ...
  constructor() ERC721("KanjiNFT_4th", "KNJ4") Ownable() {}
}