...
// File: Vault\StrategyDinoswapSxWethSushiswap.sol

// openzeppelin v3.1.0

contract StrategyDinoswapSxWethSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00840195888db4d6a99ed9f73fcd3b225bb3cb1a79)];
        ...
        token1ToEarnedPath = [address(0x00840195888db4d6a99ed9f73fcd3b225bb3cb1a79), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00840195888db4d6a99ed9f73fcd3b225bb3cb1a79)];
    }
