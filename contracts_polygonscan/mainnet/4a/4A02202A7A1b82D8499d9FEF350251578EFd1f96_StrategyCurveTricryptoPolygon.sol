...
// File: contracts/StrategyCurveTricryptoPolygon.sol
...
contract StrategyCurveTricryptoPolygon{
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = 0xdAD97F7713Ae9437fa9249920eC8507e5FbB23d3; //Curve USD-BTC-ETH (crvUSDBTC...)

    address public constant CRV = 0x172370d5Cd63279eFa6d502DAB29171933a610AF;
    address public reward = CRV;

    // We add liquidity here
    address public constant CURVE_POOL = 0x1d8b86e3D88cDb2d34688e87E72F388Cb541B7C8;
    address public GAUGE = 0x3B6B158A76fd8ccc297538F454ce7B4787778c7C;

    // Swap here
    address public constant SUSHISWAP_ROUTER = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    // Used to swap from CRV to USDC so we can provide liquidity
    ...
    function getName() external pure returns (string memory) {
        return "StrategyCurveTricryptoPolygon";
    }
    ...
    function harvest() public {
        ...
        // Swap CRV to USDC and then LP into the pool
        ...
        uint256 wmaticBalance = IERC20(USDC).balanceOf(address(this));
        if (wmaticBalance > 0) {
            // Swap WMATIC to USDC and then LP into the pool
        ...
        // Add liquidity for triCrypto pool by depositing USDC
        ICurveStableSwapTricrypto5(CURVE_POOL).add_liquidity(
            [0, IERC20(USDC).balanceOf(address(this)), 0, 0, 0],
            0
        );
