...
contract TokenSale is Ownable {
    ...
    function acceptSwapUSDC(uint256 amountJAVA) public validateOperationTime notContract entrancyGuard{
    ...
    function acceptSwapMATIC(uint256 amountJAVA) public payable validateOperationTime notContract entrancyGuard{
    ...
    function setBeginTokenId(uint256 _beginTokenId) external onlyOwner{
