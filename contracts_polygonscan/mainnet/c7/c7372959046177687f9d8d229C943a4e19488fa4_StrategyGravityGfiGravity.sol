...
// File: Vault\StrategyGravityGfiGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityGfiGravity is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        wantToEarnedPath = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
    }
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 amount, ) = IGravity(masterChef).userInfo(address(this));
        return amount;
    }
}