...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_ballBalance > harvestCutoff){
            ...
            if (performanceFee>0) {
                _swapUniswapWithPath(ball_usdc_path, performanceFee);
            ...
            _swapUniswapWithPath(ball_usdc_path, _ballBalancePost.div(2));
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public BALL_USDC_LP = 0x0097692463fD591aEf388851FE2d756505f498AC;
