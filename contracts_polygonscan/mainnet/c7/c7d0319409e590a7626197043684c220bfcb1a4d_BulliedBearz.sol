...
// File contracts/BulliedBearz.sol
pragma solidity >0.6.1 <0.7.0;
contract BulliedBearz is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() public ERC721("BulliedBearz", "BBZNFT") {
        isActive = true;
        maxSupply = 11111;
        bearPrice = 110 ether;
    ...
    function mint(uint256 qty) public payable nonReentrant {
        ...
        require((totalSupply() + qty) <= (maxSupply), "qty>supply");
    ...
    */
    ...
    function NFTgiveaway(address[] memory _to) external onlyOwner {
        require((totalSupply() +  _to.length) <= maxSupply, "qty>supply");
