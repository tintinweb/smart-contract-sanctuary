...
// File: Vault\StrategyWaultWexpolyWbtcWault.sol

// openzeppelin v3.1.0

contract StrategyWaultWexpolyWbtcWault is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
        earnedToToken1Path = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        token0ToEarnedPath = [address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        token1ToEarnedPath = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
