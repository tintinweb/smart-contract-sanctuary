 ...
 *
 */
contract MOXTokenB is Context, IERC20Metadata, Ownable { 
    ...
    uint256 public TOKENS_PER_DAY = 100000000000000000;
    ...
    function tokensToClaim(uint256 tokenIndex) internal view returns (uint256) {
        ...
        uint256 totalAccumulated = (block.timestamp).sub(lastClaimed).mul(TOKENS_PER_DAY).div(SECONDS_PER_DAY);
