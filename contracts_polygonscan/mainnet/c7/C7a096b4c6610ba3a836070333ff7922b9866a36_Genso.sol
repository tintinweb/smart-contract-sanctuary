...
contract Genso is ERC721Mintable, ERC721Permit("GensoKishiOnline") , Ownable, ERC721URIStorage{
    string public _defaultURI;
    event UpdateDefaultURI(string defaultURI);

    constructor() ERC721("GensoKishiOnline", "Genso_NFT") {
