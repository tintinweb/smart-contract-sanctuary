...
contract Mice is ERC20 {
 ...
 string public constant name = "Mice inu";
 ...
 uint256 public totalSupply = 5000000000000000e8;
 uint256 public totalDistributed;
 uint256 public constant requestMinimum = 1 ether / 10; // 0.1 Ether
 uint256 public tokensPerEth = 20000000000e8;

 uint public target0drop = 0;
 uint public progress0drop = 0;
 
 //here u will write your ether address
 address multisig = 0x131E0dA6Bc8A412C2Ac8F56BB8AEd75Db68fa5a6;
 ...
 constructor() public {
 uint256 teamFund = 4000000000000000e8;
 owner = msg.sender;
