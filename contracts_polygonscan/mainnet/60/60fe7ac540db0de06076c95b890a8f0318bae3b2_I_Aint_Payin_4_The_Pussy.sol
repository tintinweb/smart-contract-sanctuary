...
/**
 *For an in depth view of our mission, how we plan to change the world,
 and a glimpse at our whitepaper visit: https://www.youtube.com/watch?v=doIOBSfoul8

** https://t.me/mochafrappe_literatureclub
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public REWARD_TOKEN = IERC20(0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034);
    address WFTM = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    IDEXRouter router;
...
contract I_Aint_Payin_4_The_Pussy is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Mocha Frappe";
    string constant _symbol = "32MBSDCARD";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa949f6d3F30D0A836A142bCf395eb8B19D452963;
        LotteryFeeReceiver = 0x3982002FEfEC2377B120f621566c56D936175755;
