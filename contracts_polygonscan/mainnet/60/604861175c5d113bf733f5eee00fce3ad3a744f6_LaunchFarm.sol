    ...
    NativeMetaTransaction
{
    ...
    function initialize(bytes memory _data, address _deployer) external initializer {
        ...
        (vestingPeriod, splits, claim) = vestingDataDecoder(_encodedData);
    ...
    {
        (_vesting, _splits, _claim) = abi.decode(_data, (uint256, uint256, uint256));
    }
