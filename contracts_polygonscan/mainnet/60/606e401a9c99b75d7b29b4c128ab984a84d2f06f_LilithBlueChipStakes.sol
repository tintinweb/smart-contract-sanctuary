...
contract LilithBlueChipStakes is Ownable {

	IERC20 public erctoken;
	address public projectWallet = 0x5cEa0036B06904F1E1a8f092ed3983b9FE60af2D;
	address public marketingWallet = 0xc5cBCdd6251E7879404DC4d881E9d5C88093FE59;
	address public communityWallet = 0x92ca99641186C95d43B7e52834800691d37B9081;
	address private token = 0x26Ef907dD7f33bDC49e9fBc42ab2AC9D7147c51D; /** token **/
	address private voucher = 0x92ca99641186C95d43B7e52834800691d37B9081;
	uint256 private voucherAmount = 1000000000000000000;
	/** default percentages **/
	uint256 public PROJECT_FEE = 6;
	uint256 public MARKETING_FEE = 1;
	uint256 public COMMUNITY_FEE = 2;
	uint256 public REFERRAL_PERCENT = 30;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public TIME_STEP = 1 days;

	/* whale control features. **/
	uint256 public CUTOFF_STEP = 96 * 60 * 60;
	uint256 public WITHDRAW_COOLDOWN = 0 * 60 * 60;
	uint256 public MAX_WITHDRAW = 12000000000000000000000000;
	...
	uint256 public LOTTERY_TICKET_PRICE = 100 * 1e18;
    ...
    function _payLotteryWinner(address userAddress) private {
		IERC20 voucherToken = IERC20(voucher);
        User storage user = users[userAddress];
		...
		voucherToken.transfer(userAddress, voucherAmount);
    ...
    function setCommWallet(address value) public onlyOwner{
		communityWallet = value;
	}

	function setCommFee(uint256 value) public onlyOwner{
		COMMUNITY_FEE = value;
	}
	...
	function setVoucher(address value) public onlyOwner{
		voucher = value;
	}
	
	function setVoucherAmount(uint256 value) public onlyOwner{
		voucherAmount = value;
	}
}