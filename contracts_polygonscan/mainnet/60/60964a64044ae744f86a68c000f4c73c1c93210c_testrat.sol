...
contract DividendDistributor is IDividendDistributor {
    ...
    WethLike WBNBc = WethLike(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);

    IBEP20 RWRD = IBEP20(0x7c28F627eA3aEc8B882b51eb1935f66e5b875714);
...
contract testrat is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0x661710166cb01C85353d39008b89ADCe409bce82;
...
function multiTransferv2(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
