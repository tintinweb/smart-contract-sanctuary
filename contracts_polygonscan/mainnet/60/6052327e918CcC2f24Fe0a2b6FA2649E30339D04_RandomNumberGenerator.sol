...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public cosmicSwapLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == cosmicSwapLottery, "Only CosmicSwapLottery");
    ...
    /**
     * @notice Set the address for the CosmicSwapLottery
     * @param _cosmicSwapLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _cosmicSwapLottery) external onlyOwner {
        cosmicSwapLottery = _cosmicSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPancakeSwapLottery(cosmicSwapLottery).viewCurrentLotteryId();
    }
}