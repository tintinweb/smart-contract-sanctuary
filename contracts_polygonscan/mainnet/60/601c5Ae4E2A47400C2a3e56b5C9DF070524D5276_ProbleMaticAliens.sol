...
contract ProbleMaticAliens is ERC721Enumerable, ReentrancyGuard, Ownable {
    using Counters for Counters.Counter;

    constructor(string memory customBaseURI_)
        ERC721("ProbleMaticAliens", "PMA")
    {
    ...
    uint256 public constant MAX_SUPPLY = 5245;
    ...
    function mint(uint256 count) public payable nonReentrant {
        ...
        require(
            ...
            "Insufficient payment, 15 MATIC per item"
        );
