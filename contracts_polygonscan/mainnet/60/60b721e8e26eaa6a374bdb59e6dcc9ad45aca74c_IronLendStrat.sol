 ...
 */
contract IronLendStrat is Ownable, Pausable {
    ...
    constructor(address _lpToken, address _vaultAddress) public {
        lpPair = _lpToken;
        vault = _vaultAddress;
    }
    ...
    function approve(address _token, address _spender) external onlyOwner{
        require(_token != lpPair, "no rugs zir kk");
        IERC20(_token).approve(_spender, uint(-1));
    }
