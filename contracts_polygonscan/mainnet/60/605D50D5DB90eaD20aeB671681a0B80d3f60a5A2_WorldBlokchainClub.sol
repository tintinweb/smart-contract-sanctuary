...
contract WorldBlokchainClub is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20FlashMint {
    constructor()
        ERC20("World Blokchain Club", "WBC")
        ERC20Permit("World Blokchain Club")
    {
        _mint(msg.sender, 241000000 * 10 ** decimals());
    }
