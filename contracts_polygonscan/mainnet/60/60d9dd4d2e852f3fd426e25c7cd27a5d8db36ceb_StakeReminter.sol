...
contract StakeReminter is Initializable, Manageable {
    /** Structs / Vars ------------------------------------------------------------------- */
    struct Contracts {
        IToken token;
    ...
    function remintStakeInternal(
        ...
        contracts.token.burn(msg.sender, payout); // Burn the payout amount before restaking
        contracts.stakeMinter.externalStake(payout, stakingDays, msg.sender);
    }
