...
// File: polygon_contracts/Curve3CryptoMiner.sol
...
interface ICurvePool {
    ...
    function remove_liquidity(uint256 _amount, uint256[5] memory _min_amounts)
        external;
...
contract CurveMiner is Ownable, XChangerUser, CurveUtils {
    ...
    ICurvePool internal constant CURVE = ICurvePool(CURVE_3CRYPTO);
    ...
    function addLiquidity(uint256 amount, address token) internal {
        ...
        CURVE.add_liquidity(_amounts, 0);
    }
    ...
    function removeLiquidity(uint256 amount) public onlyValueHolder {
        ...
        uint256[5] memory _amounts;
        CURVE.remove_liquidity(amount, _amounts);
    }
    ...
    */
    ...
    function compoundHarvest() public returns (uint256 returnTokens) {
        ...
        if (token_balance > 0) {
            ...
            // IS IT BEST TO GO WITH ONLY ENTERTOKEN? Go WITH ETH!
            returnTokens = swap(PAUTO, ETH, token_balance, false);
        }
    }
}