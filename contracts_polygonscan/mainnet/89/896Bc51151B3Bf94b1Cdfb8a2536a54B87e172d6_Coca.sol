...
contract Coca is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the COCA ERC-20 contract.
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("COCA", "COCA") {
    ...
    function _getTombPrice() internal view returns (uint256 _tombPrice) {
        try IOracle(tombOracle).consult(address(this), 1e18) returns (uint144 _price) {
            ...
            revert("Coca: failed to fetch COCA price from Oracle");
        }
    }
    ...
    /**
     * @notice Operator mints COCA to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of COCA to mint to
