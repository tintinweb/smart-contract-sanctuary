...
// File: Vault\StrategyQuickswapShibMaticQuickswap.sol

contract StrategyQuickswapShibMaticQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x006f8a06447ff6fcf75d803135a7de15ce88c1d4ec)];
        ...
        token1ToEarnedPath = [address(0x006f8a06447ff6fcf75d803135a7de15ce88c1d4ec), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x006f8a06447ff6fcf75d803135a7de15ce88c1d4ec)];
    }
