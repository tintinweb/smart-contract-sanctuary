...
// File: contracts/StakedCaesiumCaesERC20.sol
...
contract StakedCaesiumCaesERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Caes", "sCAES", 9) ERC20Permit() {
    ...
    /**
        @notice increases sCAES supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sCAES
