...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant token2 = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
        ...
        )
    {
        ...
        pbrew_token2_path = new address[](2);
        pbrew_token2_path[0] = pbrew;
        pbrew_token2_path[1] = token2;
    }
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public USDC_Matic_LP = 0xBB0dbC0e2B6fBeF902BC046ECFC2D664658BaafC;
