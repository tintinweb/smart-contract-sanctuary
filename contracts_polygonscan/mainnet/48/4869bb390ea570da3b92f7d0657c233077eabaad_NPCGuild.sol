...
contract NPCGuild is ERC721Enumerable, ReentrancyGuard, Ownable {
    ERC721 loot = ERC721(0x9c878D447910741dBb768d6d130d30b407ec824d);
    ...
    function getTops(uint256 tokenId) public view returns (string memory) {
    ...
    private
  {
    ...
    constructor() ERC721("NPCGuild", "NPC") Ownable() {}
}
