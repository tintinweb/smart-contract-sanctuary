...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    uint256 public deliriumMaximumSupply = 100 * (10 ** 3) * (10 ** 18);
    ...
    function setDeliriumMaximumSupply(uint256 _newMaxSupply) external onlyOwner {
        require(block.number  < startBlock, "cannot change start block if sale has already commenced");
        require(_newMaxSupply > 0, "cannot set max supply 0");
        deliriumMaximumSupply = _newMaxSupply;

        emit SetDeliriumMaximumSupply(_newMaxSupply);
    }
}
