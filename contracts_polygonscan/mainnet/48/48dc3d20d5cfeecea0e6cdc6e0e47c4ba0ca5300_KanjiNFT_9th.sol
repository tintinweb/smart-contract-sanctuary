...
contract KanjiNFT_9th is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] public cha = ["\u81ed","\u7159","\u86c7","\u96ea","\u67d4","\u5175","\u89e3","\u5504","\u6b4c","\u5a7f","\u7c8b","\u9b42","\u97f3","\u6c41","\u5357","\u9593","\u8f9b","\u7cbe","\u970a","\u62e1","\u6625","\u6cc9","\u6e67","\u7d5e","\u643e","\u523a","\u7a4d","\u8b5c","\u6ede","\u661f","\u5dde","\u53b3","\u99c5","\u50cf","\u99d0","\u76d7","\u84b8","\u92fc","\u68d2","\u51dd","\u682a","\u80c3","\u77f3","\u6b62","\u8caf","\u84c4","\u5d50","\u8a71","\u5f37","\u69cb",
"\u9811","\u611a","\u4e9c","\u7cd6","\u590f","\u65e5","\u967d","\u6674","\u8d85","\u9a5a","\u6cbc","\u6c57","\u7518","\u6cf3","\u5263","\u672d","\u5d07","\u64ae","\u8131","\u624d","\u8da3","\u7a0e","\u8336","\u6559","\u6d99","\u6280","\u6b6f","\u5bfa","\u5341","\u4e07","\u9818","\u592a","\u8cca","\u7d30","\u75e9","\u8584","\u7269","\u6e07","\u601d","\u60f3","\u5343","\u7cf8","\u8105","\u4e09","\u6368","\u96f7","\u5238","\u6f6e","\u7d50","\u7e1b"];
  string[] public meanx = ["smell","smoke","snake","snow","soft","soldier","solution","song","song","son-in-law","sophisticated","soul","sound","soup","south","space","spicy","spilit","spirit","spread","spring","spring","spring","squeeze","squeeze","stab","stack","staff","stagnant","star","state","statery","station","statue","stay","steal","steam","steel","stick","stiffness","stock","stomach","stone","stop","storage","store","storm","story","strong","structure",
"stubborn","stupid","sub","sugar","summer","sun","sunlight","sunny","super","surprise","swamp","sweat","sweet","swim","sword","tag","takashi","take a picture","take off","talent","taste","tax","tea","teach","tears","technique","teeth","temple","ten","ten thousand","territory","thick","thief","thin","thin","thin","thing","thirsty","thought","thought","thousand","thread","threaten","three","throw away","thunder","ticket","tide","tie","tie"];
  ...
  string private rl1='{"name": "KanjiNFT_9th #';
  string private rl3='"}';
...
//}
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    Kanji memory kanji = randomOne(tokenId);
    string memory id=(tokenId+800).toString();
...
//gasless
  ...
  constructor() ERC721("KanjiNFT_9th", "KNJ9") Ownable() {}
}