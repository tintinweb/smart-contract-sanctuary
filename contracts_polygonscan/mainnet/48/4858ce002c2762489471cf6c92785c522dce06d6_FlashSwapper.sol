...
abstract contract UniswapFlashSwapper {
    ...
    function simpleFlashLoanExecute(
        ...
        emit Log("Simple Flash Loan Execute");
    ...
    function simpleFlashSwapExecute(
        ...
        // unwrap WETH if necessary
        emit Log("Simple Flash Swap Execute");
        if (_isBorrowingEth) {
            IWETH(WETH).withdraw(_amount);
        }
        permissionedPairAddress = _pairAddress;
    ...
    function traingularFlashSwap(
        ...
        emit Log("Triangular Flash Swap");
    ...
    function traingularFlashSwapHelper(
        ...
        emit Log("Triangular Flash Swap Helper");
    ...
    function traingularFlashSwapExecute(
        ...
        emit Log("Triangular Flash Swap Execute");
   ...
   // JUST FOR TESTING - ITS OKAY TO REMOVE ALL OF THESE VARS
    ...
    function flashSwap(
      ...
      try this._flashSwap(
        ...
        emit Log("Flash swap successful");
        didFlash = true;
      } catch {
    ...
    function multiFlashSwap (bytes memory _flashData) external {
      emit Log("Multi Flash Swap");
      (
        bytes[] memory _data
      ) = abi.decode(_flashData, (bytes[]));
      uint i;
      bool didFlash;
