...
contract ScaleCapacity is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable {
    ...
    function setupMinterRole(address to) public onlyRole(DEFAULT_ADMIN_ROLE){
        _setupRole(MINTER_ROLE, to);
    }

    function setupAdminRole(address to) public onlyRole(DEFAULT_ADMIN_ROLE){
    ...
    function mintBatch(address to, uint256[] memory amounts, string[] memory uri)
        public
        onlyRole(MINTER_ROLE)
    {
