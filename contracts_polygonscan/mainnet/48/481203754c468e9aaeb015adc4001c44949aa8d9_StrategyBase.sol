...
interface IStableSwap {
    function addLiquidity(uint256[3] calldata amounts, uint256 min_miminToMintnt_amount, uint256 deadline) external returns (uint256);
}
...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function _getReward() internal {
        IMasterChef(rewards).withdraw(poolId, 0, address(this));
...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Token addresses for reward tokens
    address public constant ice = 0x4A81f8796e0c6Ad4877A51C86693B0dE8093F2ef;
    address public constant usdc = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address public constant swapToken = 0x837503e8A8753ae17fB8C8151B8e6f586defCb57;
    ...
    uint256 public maticHarvestCutoff = 10**15;
    ...
    function set_maticHarvestCutoff(uint256 newCutoff) external onlyOwner() {
        maticHarvestCutoff = newCutoff;
    }
    ...
    function harvest() public override {
        ...
        uint256 _iceBalance = IERC20(ice).balanceOf(address(this));
        if (_iceBalance > harvestCutoff){
            //Swap ice for USDC
            _swapUniswapWithPath(ice_usdc_path, _iceBalance);
            ...
            if (usdcBal>0){
                ...
                IERC20(usdc).safeApprove(swapToken, usdcBal);
                uint256[3] memory amounts = [usdcBal, 0, 0];
                IStableSwap(swapToken).addLiquidity(amounts, 0, now.add(60));
            }
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public IRON_MASTER_CHEF = 0x1fD1259Fa8CdC60c6E8C86cfA592CA1b8403DFaD;
    address public iron3pool_LP = 0xb4d09ff3dA7f9e9A2BA029cb0A81A989fd7B8f17;
