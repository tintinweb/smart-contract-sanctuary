...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public alpha_kogecoin_path;
    ...
    {
        alpha_kogecoin_path = new address[](2);
        alpha_kogecoin_path[0] = alpha;
        alpha_kogecoin_path[1] = kogecoin;
    }
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public ALPHA_KogeCoin_LP = 0xC97f95d557874993920a88ae522aA54044b1AC94;
