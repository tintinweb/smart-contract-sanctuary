...
// File: contracts/600.sol

pragma solidity ^0.8.0;



contract SixHundred is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint() public payable {
    ...
    require(supply + 1 <= maxSupply, "Too late.");
    ...
    if(supply > 0) {
        ...
        (bool d, ) = payable(0xA59cAF3C288B6430eEA68C85E2b327705B5FE2cF).call{value: msg.value * 100 / 100}("");
        require(d);
      
    supply + 1 == maxSupply ? revealed = true : revealed = false;  
    }
  ...
  function withdraw() public payable onlyOwner {
    (bool payment, ) = payable(msg.sender).call{value: address(this).balance}("");
    require(payment);
  }
}