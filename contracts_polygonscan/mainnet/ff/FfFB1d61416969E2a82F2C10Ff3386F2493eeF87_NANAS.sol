...
contract NANAS is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("NANAS", "NANAS") AccessControl(){
        _mint(owner, 480000 * 10 ** 18);
        ...
        coinAmountPerRewardUnit = 10 * 10 ** 18; // 10 NANAS coins per rewardUnit
    ...
    function stake(uint256 tokenId) public {
        ...
        require(IERC721(collectionAddress).ownerOf(tokenId) == address(this),
            "NANAS: Error while transferring token");
    ...
    function setCollectionAddress(address newAddress) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddress != address(0), "NANAS: update to zero address not possible");
