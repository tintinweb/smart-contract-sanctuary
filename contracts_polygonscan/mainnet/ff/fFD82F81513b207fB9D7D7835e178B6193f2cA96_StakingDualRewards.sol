...
contract StakingDualRewards is IStakingDualRewards, DualRewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    function deposit(uint256 amount, uint256 duration) public override nonReentrant notPaused updateReward(msg.sender) {
        ...
        emit Staked(msg.sender, amount, userUnlockTime[msg.sender]);
    }
