...
// File: Vault\libs\IMasterchef.sol
...
// File: Vault\StrategyJetswapBtcEthJetswap.sol

// openzeppelin v3.1.0

contract StrategyJetswapBtcEthJetswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25),  address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
        earnedToToken1Path = [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        token0ToEarnedPath = [address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25)];
        token1ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
