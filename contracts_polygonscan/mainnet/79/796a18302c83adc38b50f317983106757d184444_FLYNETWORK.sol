...
/**
 *Submitted for verification https://javacrypt.tech
*/

/*
 * FLY NETWORK 
 * Web:             https://flynetworktecnology.com
 * App:             https://app.flynetworktecnology.com
 * Telegram:        https://t.me/FlyNetworkOfficial
 */
...
contract FLYNETWORK is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x000a8595033759293c7170BF3A9B0D1c9692e123); // Marketing Address
    ...
    uint256 private _tTotal = 350000 * 10**6 * 10**6;
    ...
    uint256 public _maxTxAmount = 3000000000000000000000000000000000000000000000000000 * 10**6 * 10**6;
