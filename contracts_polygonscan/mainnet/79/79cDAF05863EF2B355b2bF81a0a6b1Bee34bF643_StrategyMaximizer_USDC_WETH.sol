...
contract StrategyMaximizer_USDC_WETH is GravityMaximizer {

    address usdc_weth_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0xbc3205826d5924AcB809FD0D3e7B14A1de504744);
        address usdc_weth_lp = address(0xEeFe518d89A49328580480fA3d90073Bda074d32);
