...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    {
        pwings_usdc_path = new address[](2);
        pwings_usdc_path[0] = pwings;
        pwings_usdc_path[1] = usdc;
    ...
    function harvest() public override {
        ...
        //Swap 1/2 TITAN for IRON
        uint256 _pwingsBalance = IERC20(pwings).balanceOf(address(this));
        if (_pwingsBalance > harvestCutoff){
            _swapUniswapWithPath(pwings_usdc_path, _pwingsBalance.div(2));
            uint256 _pwingsBalancePost = IERC20(pwings).balanceOf(address(this));
            _swapUniswapWithPath(pwings_matic_path, _pwingsBalancePost);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public MATIC_USDC_LP = 0x5E58e0CeD3a272CAeb8bA00F4A4C2805Df6BE495;
