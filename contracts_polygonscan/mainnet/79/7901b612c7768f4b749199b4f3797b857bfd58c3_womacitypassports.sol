...
contract womacitypassports is ERC721 {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory description = "Onchain woma city passport.The passport holder is a woma city founder and has priority to benefit to all opportunities of the city.";
    ...
    function generateSkyscrapers(bytes memory hash, uint256 pIndex) internal view returns (string memory) {
        ...
        require(msg.value >= 15 ether, 'MORE MATIC NEEDED'); 
