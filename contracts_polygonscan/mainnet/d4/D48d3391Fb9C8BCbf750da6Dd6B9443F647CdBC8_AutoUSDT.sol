...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 33 minutes;
...
contract AutoUSDT is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AutoUSDT";
    string constant _symbol = "AutoUSDT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 10; // 10000
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x7Ec34d7a4A5Bc273d99577496C1b7f7a2B764835;
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalWMATICFee = totalFee.sub(dynamicLiquidityFee.div(2));
        uint256 amountWMATICLiquidity = amountWMATIC.mul(dynamicLiquidityFee).div(totalWMATICFee).div(2);
        ...
        (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountWMATICMarketing, gas: 30000}("");
