...
contract MorpheusToken is ERC20('MorpheusToken', 'MORPHEUS'), ReentrancyGuard, Ownable {
    ...
    address public constant presaleAddress = 0xbD94916E33F3602c349eB488EED23F2bcd5843F5;
    ...
    uint256 public maxHardCap = 150000000000; // 150k

    uint256 public constant maxMorpheusPurchase = 600 * (10 ** 18);
    ...
    function buyMorpheus(uint256 _usdcSpent) external nonReentrant {
        ...
        morpheusToken.transfer(msg.sender, morpheusPurchaseAmount);
        // send usdc to admin
    	USDC.transferFrom(msg.sender, address(presaleAddress), _usdcSpent);
