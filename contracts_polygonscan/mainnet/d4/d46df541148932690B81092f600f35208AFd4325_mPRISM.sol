...
import "../dependencies/SatellitePRISM.sol";

/**
 * mPRISM ERC20 Token
 *
 * Attributes:
 * - Supports minting by the mBridge
 * - Supports burning by the mBridge
 * - Contains a 0.25% transaction fee automatically sent to the mBridge
 */
contract mPRISM is SatellitePRISM {
    constructor() SatellitePRISM("Polygon Prism Network Token", "pPRISM") public {
    }
}