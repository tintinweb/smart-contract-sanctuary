...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    {
        ball_link_path = new address[](4);
        ball_link_path[0] = ball;
        ball_link_path[1] = matic;
        ball_link_path[2] = eth;
        ball_link_path[3] = link;
    }
    ...
    function harvest() public override {
        ...
        if (_ballBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(ball_link_path, _ballBalance);
            
            // Collect fee
            uint256 _linkBalance = IERC20(link).balanceOf(address(this));
            uint256 performanceFee = _linkBalance.mul(keepFXS).div(keepFXSmax);
            if (performanceFee>0) {
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public Link_LP = 0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39;
