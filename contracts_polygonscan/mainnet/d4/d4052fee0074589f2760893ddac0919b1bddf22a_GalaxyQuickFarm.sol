...
contract GalaxyQuickFarm is Ownable, ReentrancyGuard, Pausable { 
    ...
    address public constant earnedAddress= 0x831753DD7087CaC61aB5644b308642cc1c33Dc13;  
    ...
    address public masterChefAddress     = 0xaBC74A62F6cC74410E70e891e9EB6C7F367D2eaA;      
    address public govAddress;          

    uint256 public lastEarnBlock = block.number;
    uint256 public sharesTotal = 0;

    uint256 public controllerFee = 400;
    uint256 public rewardRate = 1000;
    uint256 public buyBackRate = 400;
    uint256 public constant feeMaxTotal = 2000;
    ...
    address[] public earnedToGalaxyPath = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0x336D8B78AdFA1c415CC3586585FC0F54B66AaD60];
    address[] public wmaticToQuickPath  = [0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0x831753DD7087CaC61aB5644b308642cc1c33Dc13];
    address[] public galaxyToQuickPath  = [0x336D8B78AdFA1c415CC3586585FC0F54B66AaD60,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0x831753DD7087CaC61aB5644b308642cc1c33Dc13];

    constructor() public {
        govAddress = msg.sender;
        wantAddress       = 0x019ba0325f1988213D448b3472fA1cf8D07618d7; 
        quickSwapAddress  = 0x7Ca29F0DB5Db8b88B332Aa1d67a2e89DfeC85E7E; 
