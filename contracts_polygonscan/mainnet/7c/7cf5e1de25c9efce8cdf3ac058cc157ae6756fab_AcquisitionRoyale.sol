    ...
    ERC721EnumerableUpgradeable
{
    ...
    function _publicFoundingCheck() private view {
        require(_foundingParameters.startPrice != 0, "start price not set");
        require(_foundingParameters.endPrice != 0, "end price not set");
        require(_foundingParameters.startTime != 0, "start time not set");
        require(_foundingParameters.endTime != 0, "end time not set");
        require(
            block.timestamp >= _foundingParameters.startTime,
