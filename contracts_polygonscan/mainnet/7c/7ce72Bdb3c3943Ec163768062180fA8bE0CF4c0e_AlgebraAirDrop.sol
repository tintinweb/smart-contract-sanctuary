...
contract AlgebraAirDrop {
        ...
        onlyOwner
    {
        ...
        for (uint256 i; i < accounts.length; i++) {
            ...
            ALGBToken.freezeTo(accounts[i], onePart, months3);
        ...
        onlyOwner
    {
        ...
        for (uint256 i; i < 5; i++) {
            ...
            ALGBToken.freezeTo(accounts[i], 1500000 * (10**18), months18);
            ALGBToken.freezeTo(accounts[i], 1500000 * (10**18), months24);
            ALGBToken.freezeTo(accounts[i], 1500000 * (10**18), months30);
        }
    }
}