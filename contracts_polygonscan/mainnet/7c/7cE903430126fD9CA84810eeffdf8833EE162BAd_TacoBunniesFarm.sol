...
contract TacoBunniesFarm is Ownable {
    ...
    constructor(
        ...
        bunnyIdURIs[0] = string(abi.encodePacked("https://tacoparty.finance/nft/launch/tacomargarita.json"));
        bunnyIdURIs[1] = string(abi.encodePacked("https://tacoparty.finance/nft/launch/tacocat.json"));
        bunnyIdURIs[2] = string(abi.encodePacked("https://tacoparty.finance/nft/launch/tacosupreme.json"));
