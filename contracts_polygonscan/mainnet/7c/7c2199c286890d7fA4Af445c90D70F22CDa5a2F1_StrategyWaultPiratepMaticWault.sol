...
// File: Vault\StrategyWaultPiratepMaticWault.sol

// openzeppelin v3.1.0

contract StrategyWaultPiratepMaticWault is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x003750144acd56cc1d3e8dafd8a187ad10d174d462)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        token1ToEarnedPath = [address(0x003750144acd56cc1d3e8dafd8a187ad10d174d462), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x003750144acd56cc1d3e8dafd8a187ad10d174d462)];
    }
    
    function stake(uint256 _wantAmount) internal virtual override{
        IWault(masterChef).deposit(pid, _wantAmount, true);
    }

    function harvest() internal virtual override{
        IWault(masterChef).deposit(pid, 0, true);
    }

    function unstake(uint256 _amount) internal virtual override{
        IWault(masterChef).withdraw(pid, _amount, true);
    } 
    function emergencyWithdraw() internal virtual override onlyOperator {
        IWault(masterChef).emergencyWithdraw(pid);
    }   
    
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance, , ) = IWault(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}