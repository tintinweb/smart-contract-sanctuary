...
contract TesterQuickSwap is Ownable, ReentrancyGuard, Pausable { 
    ...
    function deposit(uint256 _wantAmt) external onlyGov nonReentrant whenNotPaused returns (uint256) {
    ...
    function withdraw(uint256 _wantAmt) external onlyGov nonReentrant returns (uint256) {
