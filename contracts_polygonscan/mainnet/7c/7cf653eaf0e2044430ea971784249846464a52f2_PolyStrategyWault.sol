...
contract PolyStrategyWault is Ownable, ReentrancyGuard, Pausable, IStrategy {
    ...
    function earn() public override whenNotPaused {
        ...
        // Harvest farm tokens
        IWaultFarm(farmContractAddress).claim(pid);
    ...
    function pendingHarvest() public view returns (uint256) {
        ...
        return IWaultFarm(farmContractAddress).pendingWex(pid, address(this)).add(_earnedBal);
    }
