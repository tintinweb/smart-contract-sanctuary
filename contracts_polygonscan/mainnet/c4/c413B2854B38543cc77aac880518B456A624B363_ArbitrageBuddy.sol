...
/// @dev Compare price denominated in quote token between two pools
    ...
    function calcBorrowAmount(OrderedReserves memory reserves) internal pure returns (uint256 amount) {
        ...
        require(a > 0, append12("a < 0 => d: ", uint2str(d)," d_AccuracyReduction:", uint2str(uint256(d_AccuracyReduction)), " a1: ", uint2str(uint256(a1)), " a2: ", uint2str(uint256(a2)), " b1: ", uint2str(uint256(b1)), " b2: ", uint2str(uint256(b2)))); 
