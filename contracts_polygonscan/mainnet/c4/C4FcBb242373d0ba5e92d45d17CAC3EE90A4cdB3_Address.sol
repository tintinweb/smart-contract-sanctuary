    ...
    ControlledAccess
{
    ...
    function mintPresale(string memory nonce) external payable{
        emit    test_value(uint256(keccak256(abi.encodePacked(nonce))));
       // require(keccak256(abi.encodePacked(nonce))==0xaa702b26282202d94fdeed1f28a97fb2c483de3040efa3c8e1164e5e2f09dbf5,"Please mint from cryptoheroesclub.com");
