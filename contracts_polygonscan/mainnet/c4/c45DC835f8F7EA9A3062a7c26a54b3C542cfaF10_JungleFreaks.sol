...
contract JungleFreaks is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    //string public baseU1 ="ipfs://QmWNCG3qD8Hep9Tv";
    //string public baseU2 ="1Ax4Jar3XWK8uBnP73unGr4nKkBWde";
    ...
    constructor() ERC721('ET.GIRLS', 'ET.NFT') {}
    ...
    function safeMint(address to,uint256 amount) public onlyOwner {
      ...
      require(amount <= 10000, 'only 3 per transaction allowed');
