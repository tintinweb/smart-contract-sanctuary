...
contract POGFinance is Context, IERC20, Ownable {
...
contract POGFi is POGFinance , NativeMetaTransaction, ContextMixin {
    constructor() POGFinance () {
