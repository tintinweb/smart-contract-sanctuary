...
/*
 Website: https://shibgenerate.io/
 twitter: https://t.me/Shib_Generate
*/
...
contract ShibGenerate is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function setStartTime(uint256 _time) public onlyOwner {
        ...
        require(totalSupply() == _initialMint);
        startTime = _time;
    }
