...
contract Sunmorace is ERC721 {
  uint public nextTokenId;
  address public admin;
  string private link;
  uint public totalSupply;
  mapping(address => bool) public _minters;
  constructor() ERC721('Sunmorace NFT', 'Sunmorace') {
    admin = msg.sender;
    _minters[msg.sender] = true;
  }
  modifier onlyAdmin {
    require(msg.sender == admin, "ERC721: Not Admin");
    _;
  }
...
function mint(address to) external {
    require(_minters[msg.sender], "ERC721: Not Minter");
    _safeMint(to, nextTokenId);
    nextTokenId++;
    totalSupply++;
  }
  function setTokenUri(string calldata _uri) external onlyAdmin {
    link = _uri;
  }
