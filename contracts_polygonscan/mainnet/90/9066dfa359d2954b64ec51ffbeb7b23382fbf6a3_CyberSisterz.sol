...
contract CyberSisterz  is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 10000;
    uint public  basePrice = 20*10**18; // 
    uint public  basePriceBZC = 12*10**18; // 
    mapping (uint256 => bool) public _whitelistBZC;

	string _baseTokenURI;
	bool public saleEnable = false;

	CyberSisterz  internal BZC = CyberSisterz (0xDFc1b69853d36d2Ccb16c430E0E75cF93AfC9999);  // 0xDFc1b69853d36d2Ccb16c430E0E75cF93AfC9999
    ...
    constructor(string memory baseURI) ERC721("CyberSisterz", "CS")  {
        setBaseURI(baseURI);
    }
