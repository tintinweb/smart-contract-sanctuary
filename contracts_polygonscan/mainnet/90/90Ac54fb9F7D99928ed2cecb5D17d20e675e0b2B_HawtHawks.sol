...
contract HawtHawks is ERC721Enumerable, Ownable, ContextMixin {
  using SafeMath for uint256;
  using Strings for uint256;

  uint256 public constant MAX_HAWKS = 2827;
  string public HAWK_PROVENANCE;
  ...
  ) ERC721("HawtHawks", "HAWK") {
    HAWK_PROVENANCE = provenanceHash;
    baseURI = bURI;
  ...
  function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
    HAWK_PROVENANCE = _provenanceHash;
  }
