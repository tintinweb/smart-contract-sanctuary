...
contract MATICVERSE is ERC20, Ownable {
    ...
    address payable _marketingWalletAddress = 0xa7DB599afFE56F4A8eb65Ec397a51769D1915576;
    address payable _devWalletAddress = 0x0e07F17bedf97Df7bACC16ccE456b032d13fB691;
    ...
    function _transfer(
     ...
     function swapAndSendToFee(uint256 tokens) private {
        ...
        uint256 feeSplit = newBalance.div(3);
         _marketingWalletAddress.transfer(feeSplit); 
         _marketingWalletAddress.transfer(feeSplit); 
         _devWalletAddress.transfer(feeSplit);
    }
