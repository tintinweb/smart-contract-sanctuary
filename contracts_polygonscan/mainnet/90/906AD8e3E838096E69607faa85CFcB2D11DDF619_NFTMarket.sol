...
contract NFTMarket is ReentrancyGuard {
    ...
    uint256 public saleFeePercentage = 0; // Percentage fee paid to team for each sale
  ...
  // returns all itemsby seller and NFT contract
    function getMarketItemsBySellerAndNFTContract(address seller, address nftContract) public view returns (MarketItem[] memory) {
        uint256 totalItemCount = _itemIds.current();
        uint256 itemCount = 0;
        uint256 currentIndex = 0;
