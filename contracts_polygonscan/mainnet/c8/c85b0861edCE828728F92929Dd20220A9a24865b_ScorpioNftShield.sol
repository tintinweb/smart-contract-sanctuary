...
// SCORPIOshield token. Hold this shield to protect your Scorpio NFT
contract ScorpioNftShield is BEP20("Scorpio Nft Shield", "SCORPIOshield") {
    //Required amount of SCORPIO tokens to purchase the shield
    ...
    constructor(uint256 _shieldPrice, address _purchaseToken) public {
        shieldPrice = _shieldPrice;
        purchaseToken = IBEP20(_purchaseToken);
        admin = msg.sender;
    }

    // Purchases the NFT Shield with the amount of purchaseTokens equal to the shieldPrice
    ...
    function withdrawPurchaseTokens() internal {
        uint256 purchaseTokenBalance = purchaseToken.balanceOf(address(this));
        if (purchaseTokenBalance > 0) {
    ...
    function burnPurchaseTokens(uint256 amount) internal {
        uint256 purchaseTokenBalance = purchaseToken.balanceOf(address(this));
        if (purchaseTokenBalance > 0) {
