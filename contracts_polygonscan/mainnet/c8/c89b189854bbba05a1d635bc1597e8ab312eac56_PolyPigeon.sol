...
contract PolyPigeon is BEP20 {
    constructor(uint256 _initialMintAmount) BEP20('PolyPigeon Token', 'Pigeon') public {
        mint(address(msg.sender), _initialMintAmount * 1e18);
    }
