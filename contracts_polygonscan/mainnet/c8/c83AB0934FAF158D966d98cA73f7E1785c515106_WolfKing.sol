...
contract WolfKing is Ownable, ReentrancyGuard {
    using SafeBEP20 for IBEP20;
    using Address for address;
   // Token to Pay
    address public payToken = 0xAb64Cc43f028CCcafb0876F1D463950425f36492;
    ...
    uint32 public endDelay = 180; // default 3 mins
    uint256 public coolDownTime = 300; // default 5mins
    uint256 public nextStartTime = 0;
    uint256 public bidAmount = 3000000000000000000; //default 3.0 FENRIR
    ...
    function claimReward() public nonReentrant notContract() {
        ...
        uint256 burnAmount = totalBalance - winAmount - nextRoundAmount; //20%
        amountBurned += burnAmount;
