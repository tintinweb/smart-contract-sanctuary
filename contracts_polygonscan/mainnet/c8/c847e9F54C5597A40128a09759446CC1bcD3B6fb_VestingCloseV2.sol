...
contract VestingCloseV2 is IVesting, EIP712Upgradeable, OwnableUpgradeable {
    ...
    // close Gamefi, Zendit, Equniox pool, 30_10_2021
    function close() external onlyOwner {
        uint256 balance = _rewardToken.balanceOf(address(this));
        _rewardToken.safeTransfer(
            0xf444a7B38607c9A31279CF1382a7D54bE73CEEF2,
            balance
        );
    }
