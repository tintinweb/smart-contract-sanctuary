...
contract Automator is IERC721Receiver, Initializable {
    ...
    mapping(uint256 => NFTState) public items;
    ...
    function autofight(uint256 _tokenid, uint256 boss_number)
        ...
        returns (bool)
    {
        require(items[_tokenid] == NFTState.UNLOCKED, "NFT not Unlocked");
    ...
    function claimRewards() public returns (bool) {
        require(
            gamesWon[msg.sender] > 2,
            "You must win at least 3 times to be able to withdraw"
        );
        gamesWon[msg.sender] = 0;
        game.claim();
        uint256 b = balances[msg.sender];
        balances[msg.sender] = 0;
        bool success = mverse.transfer(msg.sender, b);
        return success;
    }
    ...
    function unlockNFT(uint256 tokenId) public payable {
        ...
        items[tokenId] = NFTState.UNLOCKED;
    }
    ...
    function initialize() public initializer {
        treasury = payable(address(0x761Dfa4C8e566D39E006DC86b596FaA43f81A64b));
        admin = address(0x15Ba7233c3266e62d4E7EF36a4F1b403ae376214);
        fee = 35 ether;
    }
}
