...
// File contracts2/IApprovalProxy.sol
...
// File contracts2/MCHApprovalProxyV1.sol
...
contract MCHApprovalProxyV1 is IApprovalProxy, AccessOperatable {
    using Address for address;
    using EnumerableSet for EnumerableSet.AddressSet;

    EnumerableSet.AddressSet private approvableContracts;
    EnumerableSet.AddressSet private preapprovedContracts;
    ...
    function setApprovalForAll(address _owner, address _spender, bool _approved) override public onlyContract(_spender) {
    ...
    // OpenSea
    function setOpenSeaProxyRegistry(address _openSeaProxyRegistry) public onlyRole(OPERATOR) {
    ...
    // Approvable list
    function setApprovableContracts(address _spender, bool _approvable) public onlyRole(OPERATOR) onlyContract(_spender) {
    ...
    function isApprovableContract(address _spender) public view returns (bool) {
        return approvableContracts.contains(_spender);
    }

    function setPreapprovedContracts(address _spender, bool _approval) public onlyRole(OPERATOR) onlyContract(_spender) {
    ...
    function isPreapprovedContract(address _spender) public view returns (bool) {
        return preapprovedContracts.contains(_spender);
    }
