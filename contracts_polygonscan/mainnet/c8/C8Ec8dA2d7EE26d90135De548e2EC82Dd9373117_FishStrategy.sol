...
contract FishStrategy is BaseStrategy {
    ...
    /// @notice Deposits token to Polycat VaultChef.
    ...
    function _swapRewards(uint256 _rewardAmount) internal returns (uint256) {
        ...
        return
            IUniswapV2Router01(router).swapExactTokensForTokens(_rewardAmount, 0, swapRewardRoute, address(this), block.timestamp + 100)[
