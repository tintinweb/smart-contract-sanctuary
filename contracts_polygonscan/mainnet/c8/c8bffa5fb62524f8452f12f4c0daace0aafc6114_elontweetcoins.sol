...
contract elontweetcoins is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "elontweetcoins";
    string private _symbol = "elontweetcoins";
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // binance PANCAKE V2
