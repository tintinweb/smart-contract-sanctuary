...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    {
        ball_btc_path = new address[](3);
        ball_btc_path[0] = ball;
        ball_btc_path[1] = usdc;
        ball_btc_path[2] = btc;
    }
    ...
    function harvest() public override {
        ...
        if (_ballBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(ball_btc_path, _ballBalance);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public Btc_LP = 0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6;
