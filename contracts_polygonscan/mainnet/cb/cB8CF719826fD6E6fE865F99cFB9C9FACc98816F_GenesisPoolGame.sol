...
contract GenesisPoolGame is TokenWrapper, Ownable {
    ...
    uint public constant TOKENS_PER_DAY = 1000 * 1e4;
    ...
    function getPlots() public view returns (Plot[] memory) {
        uint256 length = plots.length;
        Plot[] memory plot = new Plot[] (length);
    ...
    function redeem(uint256 _xPoint, uint256 _yPoint) public {
        // require(gameStartTime != 0,  "Not started yet");
