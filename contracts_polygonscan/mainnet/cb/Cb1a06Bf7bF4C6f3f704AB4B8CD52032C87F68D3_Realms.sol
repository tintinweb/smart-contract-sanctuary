 ...
 */
contract Realms is ERC721, ReentrancyGuard, Ownable {
    using SafeMath for uint256;

    string public PROVENANCE = "";
    uint256 public lootersPrice = 2000000000000000000; //0.03 ETH
    uint256 public publicPrice = 20000000000000000000; //0.15 ETH
    bool public saleIsActive = true;
    bool public privateSale = true;

    //Loot Contract
    address public lootAddress = 0x6b2f05bE8d381dd75d4Ad70d08fe5279721B0A9E;
    LootInterface lootContract = LootInterface(lootAddress);

    constructor() ERC721("Realms", "REALMS") {
    }
