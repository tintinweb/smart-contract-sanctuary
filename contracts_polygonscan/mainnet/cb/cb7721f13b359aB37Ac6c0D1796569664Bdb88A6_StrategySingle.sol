...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(gfi_eth_path, _harvestBalancePost2);
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0xbc3205826d5924AcB809FD0D3e7B14A1de504744;
    address public Want_Token = 0xEeFe518d89A49328580480fA3d90073Bda074d32;
