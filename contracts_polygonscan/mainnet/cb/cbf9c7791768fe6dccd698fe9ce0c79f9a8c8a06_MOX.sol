...
contract MOX is Ownable, ERC721, ERC721Enumerable {
     ...
     * 
     */ 
    constructor(string memory name, string memory symbol, string memory baseTokenURI, address tokenAContractAddress, address tokenBContractAddress) ERC721(name, symbol) {
        _baseTokenURI = baseTokenURI;
		_owner = _msgSender();
		indexType = 0;
		tokenA = IERC20(tokenAContractAddress);
		tokenB = IERC20(tokenBContractAddress);
