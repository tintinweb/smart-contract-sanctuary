...
contract FlufOnPoly is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPlY = 10000;
    uint256 public PRESALE_SUPPLY = 10000;
    uint256 public MAX_ALLOWED = 500;
    uint256 public MAX_PRESALE_ALLOWED = 200;
    uint256 public price = 0; //0.1 ETH
    ...
    constructor(string memory baseURI) ERC721("Galaxy-Eggs", "GalaxyEggs") {
        setBaseURI(baseURI);
    }
