...
// File: contracts/StakedHemetaHetaERC20.sol
...
contract StakedHemetaHetaERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Heta", "sHETA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHETA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHETA
