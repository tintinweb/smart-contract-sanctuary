...
contract PolyGoonFinance is Context, IERC20, Ownable {
...
contract PolyGoon is PolyGoonFinance, NativeMetaTransaction, ContextMixin {
    constructor() PolyGoonFinance() {
