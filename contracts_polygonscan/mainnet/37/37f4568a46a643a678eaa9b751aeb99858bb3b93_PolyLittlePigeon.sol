...
Inspired by other recent Little coins, I present to you PolyLittlePigeon
...
contract PolyLittlePigeon is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "PolyLittlePigeon";
    string private _symbol = "PLPigeon";
