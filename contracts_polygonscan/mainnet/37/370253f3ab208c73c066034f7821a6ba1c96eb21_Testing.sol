...
contract Testing is ERC20, Ownable {
   ...
   ViralDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Testing", "Test1") {
...
contract ViralDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("VIRAL_Dividend_Tracker", "VIRAL_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "VIRAL: claimWait must be updated to between 1 and 24 hours");
