...
//    }
    ...
    function buy(uint256 _amount,string memory refId) public nonReentrant {
        ...
        require(IERC20(usdcToken).allowance(msg.sender,address(this))>0,"insufficient allowance of USDC tokens");
        ...
        if(keccak256(abi.encodePacked(refId))!=keccak256(abi.encodePacked(""))&&tokenTracker!=address(0)){
