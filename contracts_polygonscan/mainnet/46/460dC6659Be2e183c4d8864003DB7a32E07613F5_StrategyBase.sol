...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 9;
    ...
    // Uniswap swap paths
    address[] public shield_matic_path;
    ...
    {
        shield_matic_path = new address[](2);
        shield_matic_path[0] = shield;
        shield_matic_path[1] = matic;
    }
    ...
    function harvest() public override {
        ...
        if (_shieldBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(shield_matic_path, _shieldBalancePost.div(2));

            // Add liquidity for Shield/MATIC
            uint256 _shield = IERC20(shield).balanceOf(address(this));
            uint256 _matic = IERC20(matic).balanceOf(address(this));
            if (_shield > 0 && _matic > 0) {
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public SHIELD_MATIC_LP = 0x982c1F90381e31e7b7dbbA8708126532B7cb7dF6;
