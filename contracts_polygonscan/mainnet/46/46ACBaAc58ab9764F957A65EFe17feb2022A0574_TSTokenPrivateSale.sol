...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        uint256 convertTo = weiAmount.mul(1000000000000);
    ...
    Ownable
{
    ...
    uint256 __totalSaleCap = 1100000000000000000000;
    uint256 __individualPurchaseCap = 400000000000000000000;
    uint256 __openingTime  = 1638435600;
    ...
    uint256 __startCliffAfterFirstWithdrawTime = 20 minutes;
    constructor()
