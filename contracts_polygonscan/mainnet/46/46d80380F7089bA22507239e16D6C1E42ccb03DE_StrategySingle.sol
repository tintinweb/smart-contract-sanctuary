...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    {
        gfi_link_path = new address[](3);
        gfi_link_path[0] = gfi;
        gfi_link_path[1] = eth;
        gfi_link_path[2] = link;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            if (rewardToken != want) {
                _swapUniswapWithPath(gfi_link_path, _harvestBalance);
            }
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0x2b1966652Aa0c09a2f34cE3FbeB19d945dEB8FA3;
    address public Want_Token = 0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39;
