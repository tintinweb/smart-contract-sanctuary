 ...
 * manner, since0.6. when dealing with GSN meta-transactions the account sending and
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
     ...
     * implement alternative mechsms to perform token transfer, such as signature-based.
     *
     * Requirements:
     *
     * - `from` cannot be the zero address.
...
contract WanLoot is ERC721("Wan Loot", "Wan LOOT"), ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: black; font-family: serif; font-size: 30px; }</style><rect width="100%" height="100%" fill="#ee28fe" /><text x="10" y="40" class="base">';
