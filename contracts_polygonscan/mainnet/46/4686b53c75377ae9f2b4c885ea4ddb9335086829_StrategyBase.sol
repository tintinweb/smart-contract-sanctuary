...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public spade_usdc_path;
    ...
    {
        spade_usdc_path = new address[](2);
        spade_usdc_path[0] = spade;
        spade_usdc_path[1] = usdc;
    }
    ...
    function harvest() public override {
        ...
        //Swap 1/2 SPADE for USDC
        uint256 _spadeBalance = IERC20(spade).balanceOf(address(this));
        if (_spadeBalance > harvestCutoff){
            if (_spadeBalance > 0) {
                _swapUniswapWithPath(spade_usdc_path, _spadeBalance.div(2));
            }

            // Add liquidity for SPADE/USDC
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public SPADE_MASTER_CHEF = 0x9A2C85eFBbE4DD93cc9a9c925Cea4A2b59c0db78;
    address public SPADE_USDC_LP = 0x6Fd8aAe9f85A7Db14c45453daAB81aa3085E4bA3;
