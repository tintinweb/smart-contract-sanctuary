...
contract POPE is Context, IERC20, Ownable {
    ...
    address public _charityWalletAddress = msg.sender;
    ...
    string private _name = "POPE";
    string private _symbol = "POPE";
    ...
    function ChangeCharityAdd(address NewAdd) public onlyOwner {
        _charityWalletAddress = NewAdd;
