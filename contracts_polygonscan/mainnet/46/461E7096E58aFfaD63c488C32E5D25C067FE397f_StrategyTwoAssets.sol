...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    // Dragon's lair
    address public constant dragonslair =
    ...
    constructor(
        ...
        public
        BaseStrategyMasterChef(_rewards, _want, _strategist, rewardTokenAddr)
    {
        require(
            _want != feeTokenAddr,
        ...
        rewardToFarmTokenPath1 = new address[](4);
        rewardToFarmTokenPath1[0] = rewardTokenAddr;
        rewardToFarmTokenPath1[1] = feeTokenAddr;
        rewardToFarmTokenPath1[2] = farmToken0Addr;
        rewardToFarmTokenPath1[3] = farmToken1Addr;
    }
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public FARM_MASTER_CHEF =
        0x0A1Fddba82A78aEE9652971D12eE91b41D8C3dEB;
    address public LP_TOKEN = 0x1581802317f32A2665005109444233ca6E3e2D68;
