...
// File: Vault\StrategyGravityDaiWethGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityDaiWethGravity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        earnedToToken1Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x008f3cf7ad23cd3cadbd9735aff958023239c6a063)];
        token0ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        token1ToEarnedPath = [address(0x008f3cf7ad23cd3cadbd9735aff958023239c6a063), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x008f3cf7ad23cd3cadbd9735aff958023239c6a063)];
    }
