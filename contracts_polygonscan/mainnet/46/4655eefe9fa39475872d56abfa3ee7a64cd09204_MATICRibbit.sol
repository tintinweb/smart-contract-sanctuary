...
contract MATICRibbit is Context, IERC20, Ownable {
	...
	uint256 private _minLottoBalance = 1 * 10**8 * 10**9;
    
    string private _name = "MATICRibbit";
    string private _symbol = "MATICRibbit";
    ...
    uint256 private _minFoMoBalance = 1 * 10**8 * 10**9;
    ...
    uint256 private numTokensSellToAddToLiquidity = 500 * 10**8 * 10**9;
