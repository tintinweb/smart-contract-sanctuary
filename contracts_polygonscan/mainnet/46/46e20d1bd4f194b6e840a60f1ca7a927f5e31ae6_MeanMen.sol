...
contract MeanMen is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    uint256 public constant MAX_NFT = 11111;
    uint256 public constant MAX_BY_MINT = 50;
	
	//Inital Minting price 2 Matic /mint
    ...
    constructor(string memory baseURI, address payable creator,uint256 _count) ERC721("Mean Men", "MM") {
        setBaseURI(baseURI);
