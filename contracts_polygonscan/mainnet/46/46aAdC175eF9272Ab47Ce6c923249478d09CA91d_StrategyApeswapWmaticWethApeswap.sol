...
// File: Vault\StrategyApeswapWmaticWethApeswap.sol

// openzeppelin v3.1.0

contract StrategyApeswapWmaticWethApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x005d47baba0d66083c52009271faf3f50dcc01023c), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        ...
        token1ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x005d47baba0d66083c52009271faf3f50dcc01023c)];
