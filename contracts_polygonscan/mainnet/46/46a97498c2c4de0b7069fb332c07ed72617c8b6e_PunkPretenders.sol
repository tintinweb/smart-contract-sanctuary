...
// File contracts/PunkPretenders.sol
...
contract PunkPretenders is ERC721Enumerable, Ownable, INFT, INFTMetadata, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("Punk Pretenders on Polygon", "PPP") {
        publicSupply = 9500;
        giftSupply = 500;
        maxSupply = giftSupply + publicSupply;
        _tokenBaseURI = "ipfs://QmTNcmZVrcPdu8dXQtoreZpsVNYzqqdFnmPDpu1u8aWz3p/";
        _tokenRevealedBaseURI = _tokenBaseURI;
    }
