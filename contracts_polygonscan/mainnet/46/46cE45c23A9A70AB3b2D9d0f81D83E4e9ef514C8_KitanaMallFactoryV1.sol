...
// File contracts/interfaces/IKitanaMallFactoryV1.sol

/**
 * @dev Interface of the KitanaMallFactoryV1.
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 *
 * Note: Deployer will be the {owner} and {wallet}
 */
interface IKitanaMallFactoryV1 {
    /**
     ...
     * - caller must execute {IKitanaMallV1-destructShop} for shop destruction.
     *
...
// File contracts/interfaces/IFundManager.sol
...
interface IFundManager {
    ...
    /**
     * @dev Returns the address of KitanaMallFactory contract.
     */
...
contract FundManager is IFundManager, ReentrancyGuard {
     ...
     */
    constructor(address _wallet, address _factory) {
        wallet = _wallet;
        factory = _factory;
    }
    ...
    receive() external payable {
        _transferFunds(msg.sender, wallet, msg.value, address(0));
    }
    ...
    function _distributeFunds(
        ...
        _transferFunds(_from, wallet, _fee, _ftAddr);
    }
    ...
    function _transferFunds(
        ...
        if (_ftAddr != address(0)) {
            IERC20(_ftAddr).safeTransferFrom(_from, address(this), _amount);
            IERC20(_ftAddr).safeTransfer(_to, _amount);
        } else {
...
// File contracts/FungibleToken.sol
...
// File contracts/interfaces/IKitanaMallV1.sol

/**
 * @dev Interface of the KitanaMallV1.
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 */
interface IKitanaMallV1 {
    /**
     ...
     *
     * - caller must be {wallet}.
     * - caller must execute {IKitanaMallFactoryV1-deleteShop} for shop deletion.
     *
...
// File contracts/KitanaMallV1.sol

/**
 * @dev Implementation of the {IKitanaMallV1} interface.
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 */
contract KitanaMallV1 is IKitanaMallV1, ERC721URIStorage, FundManager {
    ...
    /**
     * @dev See {IKitanaMallV1-ftAddr}.
     */
    address public override ftAddr;

    /**
     * @dev See {IKitanaMallV1-shopOwner}.
     */
    address public override shopOwner;

    /**
     * @dev See {IKitanaMallV1-allowed}.
     */
    bool public override allowed = true;

    /**
     * @dev See {IKitanaMallV1-tokenPrices}.
     *
     * nft id -> price
     */
    ...
    /**
     * @dev See {IKitanaMallV1-nftsOnSale}.
     *
     * nft -> bool
     */
    ...
    ) ERC721(name, symbol) FundManager(_wallet, msg.sender) {
        shopOwner = _shopOwner;
        ftAddr = _ftAddr;
    }

    /**
     * @dev See {IKitanaMallV1-totalNFTs}.
     */
    ...
    /**
     * @dev See {IKitanaMallV1-buyNFTWithToken}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {IKitanaMallV1-createNFT}.
     *
    ...
    /**
     * @dev See {IKitanaMallV1-toggleShop}.
     *
    ...
    /**
     * @dev See {IKitanaMallV1-destructShop}.
     *
...
// File contracts/KitanaMallFactoryV1.sol

/**
 * @dev Implementation of the {IKitanaMallFactoryV1} interface.
 * @author Ahmed Ali Bhatti <github.com/ahmedali8>
 *
 * Note: Deployer will be the {owner} and {wallet}
 */
contract KitanaMallFactoryV1 is IKitanaMallFactoryV1, Ownable, FundManager {
    using Counters for Counters.Counter;
    using Address for address;
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-totalShops}.
     */
    uint256 public override totalShops;

    /**
     * @dev See {IKitanaMallFactoryV1-shopFee}.
     */
    uint256 public override shopFee;

    /**
     * @dev See {IKitanaMallFactoryV1-shops}.
     *
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-ownerShops}.
     *
     ...
     */
    constructor(uint256 _shopFee) FundManager(msg.sender, address(this)) {
        shopFee = _shopFee;
    }

    /**
     * @dev See {IKitanaMallFactoryV1-shopExists}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-shopOwner}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-shopAddress}.
     *
     * Requirements:
     *
     * - shop with `_id` must exist.
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-shopURI}.
     *
     * Requirements:
     *
     * - shop with `_id` must exist.
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-ownerShopExists}.
     */
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-createSimpleShop}.
     */
    function createSimpleShop(
        string calldata _shopName,
        string calldata _shopSymbol,
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-createShopWithToken}.
     *
     * Requirements:
     *
    ...
    function createShopWithToken(
        ...
        FungibleToken _ft = FungibleToken(_ftAddr);
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-createShopAndToken}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-deleteShop}.
     *
    ...
    /**
     * @dev See {IKitanaMallFactoryV1-setShopFee}.
     *
    ...
    function _createShop(
        ...
        // transfer fees
        _transferFunds(address(this), wallet, _fee, address(0));
    ...
    /**
     * @dev Deploys KitanaMallV1 contract.
     */
    function _deployShop(
        ...
        bytes memory _bytecode = type(KitanaMallV1).creationCode;
        _bytecode = abi.encodePacked(
            _bytecode,
            abi.encode(_ftAddr, wallet, _caller, _shopName, _shopSymbol)
        );
