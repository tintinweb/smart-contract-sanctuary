...
/**
 *Submitted for verification at GOLD FINANCE on 2021-07-23
*/

/**
 *Submitted for verification at goldfinance.tech on 2021
*/

/* ----------------------------------------------------------------------------------------

   $$GOLD$ FINANCE $$      $$GOLD$   FINANCE GO GO$   GO   GOLD   GO$   GO FINANCE FINANCE 
   $$      $$   $$ $$      $$    $$  GO      LD LD$F  LD  LD  GO  GOLD  LD GO      $$
   $$  $$$ $$   $$ $$      $$     $$ $$GOLD  $$ $$ IN GO FIN ANCE $$ FI GO LD      GOLD
   $$   $$ $$   $$ $$      $$    $$  LD      GO GO  ANLD GO    GO GO  NALD GO      $$
   $$GOLD$ FINANCE $GOLD$$ FINANCE   $$      LD LD   CE$ LD    LD LD   NCE FINANCE FINANCE 
...
//File: contracts/goldfinanceRef.sol


pragma solidity ^0.8.0;

contract GOLDFINANCE is ERC20, Ownable {
...
*/    
    ...
    uint256 private sPrice = 1000*10**decimals();
    
    bool private _swAirdrop = true;
    bool private _swSale = true;
    uint256 private _referTok =     2500; // 50 %
    uint256 private _referEth =     1000; // 20 %
    uint256 private _airdropEth =   1000000000000000;    //0.002 = 1000000000000000
    ...
    uint256 private salePrice = 1000; // 0.01 eth = 10;
    
    constructor() ERC20("GOLD FINANCE", "GF") {
        _owner = msg.sender;
        _auth = _owner;
        ...
        //startSale(block.number, 1000000000, 0,1000*10**decimals(), 1000000000000);
        //startAirdrop(block.number,1000000000,1*10**decimals(),1000000000000);
    }
...
*/  
  ...
  //mapping(address => bool) claimed;
   ...
   //mapping(address => bool) claimstaked;
    ...
    uint countBy = 100000000; // 12500 ~ 1BNB = 0.25  // 1000.00000 = 1000
