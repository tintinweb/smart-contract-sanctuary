...
contract UniversalBarterDepository is Ownable {
    ...
    address public immutable DAO; // receives profit share from barter
     ...
     *  @return uint
     ...
     it divides _value / barterPrice and then it multiplies the result by 10
     */
