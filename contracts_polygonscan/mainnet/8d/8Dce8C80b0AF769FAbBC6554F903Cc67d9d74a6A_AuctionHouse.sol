...
contract AuctionHouse is IAuctionHouseV2, ReentrancyGuard {
    ...
    address immutable _otherMarket;
     ...
     * Constructor
     */
    constructor(address _zora, address _weth, address bidDb, address otherMarket, uint256 startAuctionId) public {
        require(
        ...
        _otherMarket = otherMarket;
        _bidDb = IBidDbV2(bidDb);
    }

    // ========== External functions ==========

    // support function isApprovedForAll(address owner, address operator) in contract ERC721Tradable
