...
contract ERC721 is ERC165, IERC721, IERC721Metadata {
    ...
    string private uriLink = "https://vinyl.red/numbers/";
    ...
    function totalSupply() external view override returns(uint256){return 100;}
    ...
    function multipleMint(address to, uint256 amount) external payable returns(uint256[] memory IDs) {
        require(_minting, "Minting disabeled");
        require(amount <= 10);
        require(msg.value == 0*amount, "Insufficient Eth");
        _owner.transfer(address(this).balance);
        require(to != address(0), "ERC721: mint to the zero address");
