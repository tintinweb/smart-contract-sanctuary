...
contract QUOXKA is ERC721, ERC721Enumerable, ERC721URIStorage, ContextMixin, HasSecondarySaleFees, Ownable {
    using Strings for uint256;
    ...
    address private constant ROYALTY_RECIPIENTS_3 = 0xae11fC8e6395474CffcEE77A713bD8DF1799FBE7;
    ...
    function _safeMint(uint256 tokenId, string memory CID) public onlyOwner {
        _safeMint(_msgSender(), tokenId);
        _setTokenURI(tokenId, string(abi.encodePacked('ipfs://', CID, '/', tokenId.toString(), ".json")));
    }
    ...
    function withdrawETH() external {
        ...
        Address.sendValue(payable(ROYALTY_RECIPIENTS_3), royalty);
    }
    ...
    function viewTokenItem(uint256 tokenId) private pure returns (string memory){
        uint256 seed1 = bigValue(tokenId, 0xab);
        uint256 seed2 = bigValue(tokenId, 0xb8);
        uint256 seed3 = bigValue(tokenId, 0xfc);
