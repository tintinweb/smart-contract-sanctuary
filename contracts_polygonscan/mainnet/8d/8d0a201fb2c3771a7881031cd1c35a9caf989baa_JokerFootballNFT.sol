...
// File: contracts/JokerFootballNFT.sol
...
/**
 * @title JokerFootballNFT contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract JokerFootballNFT is ERC721, Ownable {
    using SafeMath for uint256;

    string public JKFNFT_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant apePrice = 10000000000;
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        JKFNFT_PROVENANCE = provenanceHash;
    }
    ...
    * Mints Bored Apes
    */
    function mintApe(address _to, uint numberOfTokens) public payable {
