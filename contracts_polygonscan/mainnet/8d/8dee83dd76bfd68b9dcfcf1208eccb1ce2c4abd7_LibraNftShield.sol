...
// LIBRAshield token. Hold this shield to protect your Libra NFT
contract LibraNftShield is BEP20("Libra Nft Shield", "LIBRAshield") {
    //Required amount of LIBRA tokens to purchase the shield
    ...
    function burnLibraTokens(uint256 amount) internal {
        uint256 purchaseTokenBalance = purchaseToken.balanceOf(address(this));
        if (purchaseTokenBalance > 0) {
