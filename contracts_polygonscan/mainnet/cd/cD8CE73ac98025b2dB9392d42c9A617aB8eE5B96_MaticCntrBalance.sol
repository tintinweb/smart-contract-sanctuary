...
// File contracts/MaticWheyFarm.sol
...
// File contracts/helpers/MaticCntrBalance.sol



pragma solidity 0.6.12;
contract MaticCntrBalance {
    using SafeMath for uint;
    using SafeERC20 for IERC20;
    
    MaticWheyFarm public constant wheyFarm = MaticWheyFarm(0x8bEe394FbAf97013293af92eD9Fc4A70542f25C0);
    IERC20 public constant CNTR = IERC20(0xdae89dA41a96956e9e70320Ac9c0dd077070D3a5);
    IERC20 public constant CNTR_MATIC_LP = IERC20(0x06482d55A7Fa6ac765ca5c53CCA34D9d2970f9d5);
    ...
    function balanceOf(address _address) external view returns (uint) {
        ...
        lpBalance = lpBalance.add(CNTR_MATIC_LP.balanceOf(_address));
        
        // Amount of CNTR in LP tokens
        balance = balance.add(lpBalance.mul(CNTR.balanceOf(address(CNTR_MATIC_LP))).div(CNTR_MATIC_LP.totalSupply()));
