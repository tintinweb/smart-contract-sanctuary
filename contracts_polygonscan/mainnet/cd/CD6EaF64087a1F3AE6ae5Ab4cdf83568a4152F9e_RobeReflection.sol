...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "ROBe2.Protocol";
    string internal constant SYMBOL = "ROBe2";
    ...
    address internal greenDAOAddress = 0x14eB110907966Be23aca8D329Be0C607B9258233;
    address internal REAAddress = 0x0dcA40950a5939419199e58B330b37DC807938c7;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.GreenAlliance, 30, REAAddress);
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function _burnTokens(
        ...
        if (_isExcludedFromRewards[burnAddress]) _balances[burnAddress] = _balances[burnAddress].add(tBurn);
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    address private _testnetRouterAddress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add tahe liquidity
        (uint256 tokenAmountSent, uint256 ethAmountSent, uint256 liquidity) = _router.addLiquidityETH{
            value: ethAmount
        }(
            address(this),
            tokenAmount,
...
abstract contract SafeToken is BaseRfiToken, Liquifier, Antiwhale {
    ...
    function _takeFee(
        ...
        if (_isExcludedFromRewards[recipient]) _balances[recipient] = _balances[recipient].add(tAmount);
...
contract RobeReflection is SafeToken {
