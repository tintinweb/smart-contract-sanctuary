...
/** 
 * @title Flares Collection
 * @author Daniel Lee
 * @notice This contract is for distribution of 10k flares to users
 * @dev All function calls are currently implemented without side effects
 */
contract Flares is Initializable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
     ...
     */
    function batchMint(address to, uint256[] memory tokenIds) public virtual onlyOwner {
