...
contract TDR is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public maxSupply = 50; //change it after the airdrop
    uint256 public maxMintAmount = 50;
    bool public paused = false;
    bool public salePaused = true;
    address public current_owner;
    bytes32 public merkleRoot = 0x00ec723fe14d7204f2bda7bb36d5c1d2ace9a3713f78f59b43ccb3bdb6349a1d;
    constructor() ERC721("Donuts Republic", "TDR") {
