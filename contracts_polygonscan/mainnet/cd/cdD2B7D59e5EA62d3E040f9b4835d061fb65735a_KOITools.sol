...
function GenderStatsByAddress(address _address) external view returns (uint256[] memory) {
    uint256 _totalSupply = KOIContract.totalSupply();
    uint256 _Gender;
  ...
  function LevelStatsByAddress(address _address) external view returns (uint256[] memory) {
    uint256 _totalSupply = KOIContract.totalSupply();
    uint256 _Level;
