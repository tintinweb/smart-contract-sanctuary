...
// hevm: flattened sources of src/CliptoExchange.sol
// SPDX-License-Identifier: MIT AND AGPL-3.0-only AND None
pragma solidity =0.8.10 >=0.7.0 >=0.8.0 <0.9.0 >=0.8.10 <0.9.0;
