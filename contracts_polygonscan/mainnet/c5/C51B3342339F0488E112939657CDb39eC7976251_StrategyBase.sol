...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant token1 = 0xBC5b59EA1b6f8Da8258615EE38D40e999EC5D74F;
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 15;
    ...
    {
        pbrew_token1_path = new address[](2);
        pbrew_token1_path[0] = pbrew;
        pbrew_token1_path[1] = token1;

        pbrew_eth_path = new address[](2);
        pbrew_eth_path[0] = pbrew;
        pbrew_eth_path[1] = eth;
    }
    ...
    function harvest() public override {
        ...
        if (_pbrewBalance > harvestCutoff){
            ...
            if (performanceFee>0) {
                _swapUniswapWithPath(pbrew_eth_path, performanceFee);
            ...
            // Add liquidity
            uint256 _pbrew = IERC20(pbrew).balanceOf(address(this));
            uint256 _token1 = IERC20(token1).balanceOf(address(this));
            if (_pbrew > 0 && _token1 > 0) {
                IERC20(pbrew).safeApprove(currentRouter, 0);
                IERC20(pbrew).safeApprove(currentRouter, _pbrew);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public pbrew_Paw_LP = 0xE439b2eE0F4C9b61AE89c57423cabDb35895Ff45;
