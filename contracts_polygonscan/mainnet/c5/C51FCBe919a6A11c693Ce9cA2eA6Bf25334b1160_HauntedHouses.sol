...
contract HauntedHouses is OwnableUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC2771ContextUpgradeable {
    ...
    function initialize(address trustedForwarder) public initializer {
        __Ownable_init();
        __ERC721_init("HauntedHouses", "HHouses");
    ...
    function mint() public {
        ...
        require(balanceOf(msg.sender) == 0, 'Each address may only mint one house.');
