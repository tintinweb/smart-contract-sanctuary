...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xcFa9a4fCdA37333192e5bcEF86606Ae1EFD11e68;
...
contract DOGEMATIC is Context, IERC20, Ownable {
    ...
    string private _name = "DOGE MATIC";
    ...
    uint256 public charityFee = 500; //500 means 5% will send to charity
    
    
    address charityAddress = 0x07B998b5C4a7F1De332Bb1b1516620B9073C86B6; //
    ...
    constructor() public {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // for BSC Quick swap v2
    ...
    uint256 roundValue = value.ceil(charityFee);
    uint256 onePercent = roundValue.mul(charityFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        if(isFeeActive && !isTaxless[_msgSender()] && !isTaxless[recipient] && !inSwapAndLiquify){
            ...
            //Marketing fee
            _reflectionBalance[charityAddress] = _reflectionBalance[charityAddress].add(tokensToBurn.mul(rate));
        
            emit Transfer(sender, charityAddress, tokensToBurn);
        }
