...
abstract contract StrategyFeesBase is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant rewardAddress = 0xb65844859af01f9Be157aBB5aaEB8C487F669C81;
    ...
    uint256 public rewardRate = 200; // 2%
...
// File: Vault\StrategyLPBCharity.sol

contract StrategyLPSushiSwap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(    
        ...
        earnedToWmaticPath = [0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a, address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a, address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToGivePath = [0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a, address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), 0x9Bbcda2606e616659b118399A2823E8a392f55DA];
        earnedToToken0Path= [0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a, address(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174), 0x50B728D8D964fd00C2d0AAD81718b71311feF68a];
        earnedToToken1Path= [0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a, address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619)];
        token0ToEarnedPath = [0x50B728D8D964fd00C2d0AAD81718b71311feF68a, address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), 0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a];
        token1ToEarnedPath = [address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), 0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), 0x50B728D8D964fd00C2d0AAD81718b71311feF68a];
        wmaticToToken1Path =  [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619];
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 amount, ) = ISushiStake(masterChef).userInfo(pid, address(this));
        return amount;
    }
