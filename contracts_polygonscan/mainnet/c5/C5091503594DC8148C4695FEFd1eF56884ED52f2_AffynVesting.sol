...
contract AffynVesting is Ownable {
    
    mapping(address => TokenVesting) private _vault;
    address _token = address(0xF1612621Fa28F2c65fc9c6AF73973FC19d44696D);

    /**
     * @dev Withdraw tokens only after crowdsale ends.
    */
    function withdrawTokens() public {
        require(address(_vault[_msgSender()]) != address(0), "AffynVesting: Has no address within vault");
