...
contract Test is Ownable, QuickSwapTrader {
    ...
    {
        this._swapToken(kPolygonToken.matic, kPolygonToken.usdc, _amount);
    }
...
contract QuickSwapTrader {
    ...
    function _swapToken(kPolygonToken _inToken, kPolygonToken _outToken, uint256 _amount) external
    {
