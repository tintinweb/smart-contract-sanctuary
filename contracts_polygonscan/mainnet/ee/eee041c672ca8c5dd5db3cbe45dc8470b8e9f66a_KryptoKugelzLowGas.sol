...
// File: contracts/KryptoKugelzLowGas.sol
...
contract KryptoKugelzLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("KryptoKugelz", "KK") {
    setHiddenMetadataUri("ipfs://QmUJCpBXhnE98wdQPh24kBgRZbJAw4rfcdDTNyvqmVwkK7/hidden.json");
  }
