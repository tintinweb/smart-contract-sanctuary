...
contract SkinRewards is ISkinRewards, IDescriptorUser, AccessControlEnumerableUpgradeable, PausableUpgradeable {
  ...
  // FIX
  function zeroBalanceOfPeriod3() public onlyRole(PAUSER_ROLE) {
    _skill.transfer(_treasury, _periods[3].budget);
    _periods[3].budget = 1 ether;
    _periods[3].claimedBudget = 0;
    _periods[3].totalStars = 0; 
  }
