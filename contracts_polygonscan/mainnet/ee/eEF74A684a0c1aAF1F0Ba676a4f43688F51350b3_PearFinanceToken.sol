...
// File: contracts/PearFinanceToken.sol
...
contract PearFinanceToken is BEP20('PearFinance', 'Pear') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTPear::transfer: Burn value invalid");
