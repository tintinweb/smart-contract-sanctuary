...
//https://gateway.pinata.cloud/ipfs/QmconLVgCVdHwCWNQG9mQbeVnPYTAHzksDYkBecpeGkj4D/
contract NFT is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 0.003 ether; // Your NFT price 
  uint256 public maxSupply = 2222; 
  uint256 public maxMintAmount = 5; // one user can mint only 20 nfts at once 
  bool public paused = false;
  mapping(address => bool) public whitelisted;
//https://gateway.pinata.cloud/ipfs/QmconLVgCVdHwCWNQG9mQbeVnPYTAHzksDYkBecpeGkj4D/
//0xF3E74013F22B710C2252108e2ACB02564329E49A
//0xd9145CCE52D386f254917e481eB44e9943F39138
  constructor(
    string memory _name, //Name of your token
    string memory _symbol, //Symbol of your token 
    string memory _initBaseURI // NFTs Hosted URL 
  ) ERC721(_name, _symbol) {
    setBaseURI(_initBaseURI);
    mint(msg.sender, 2); // msg.sender means you (the deployer ), You will get 2 NFTs when you deploy this contract  
  }
