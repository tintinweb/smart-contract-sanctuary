...
// File: https://github.com/AppsusUK/NFT-Collection-Deploy-Guide/blob/main/contracts/common/meta-transactions/Initializable.sol
...
// File: https://github.com/AppsusUK/NFT-Collection-Deploy-Guide/blob/main/contracts/common/meta-transactions/EIP712Base.sol
...
// File: https://github.com/AppsusUK/NFT-Collection-Deploy-Guide/blob/main/contracts/common/meta-transactions/NativeMetaTransaction.sol
...
// File: https://github.com/AppsusUK/NFT-Collection-Deploy-Guide/blob/main/contracts/common/meta-transactions/ContentMixin.sol
...
// File: https://github.com/AppsusUK/NFT-Collection-Deploy-Guide/blob/main/contracts/ERC721Tradable.sol
...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    function mintMultipleTo(address _to, uint256 _amount) public onlyOwner {
        require(_amount > 0, "Must mint 1 or more tokens!");
        require(_currentTokenId + _amount <= maxSupply, "Hold up! That's too many!");
...
contract TetraKubeSeasonOne is ERC721Tradable {
    constructor(
        string memory _name,
        string memory _symbol,
        uint256 _maxSupply,
    ...
    function baseTokenURI() override public pure returns (string memory) {
        return "ipfs://QmS5LhXe1jUqpZ9pjCCNcJJTeoSkeFVmhCzQZ1qz6UL7gr/";
    }
