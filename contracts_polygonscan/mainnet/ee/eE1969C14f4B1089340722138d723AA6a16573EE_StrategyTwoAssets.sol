...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant orbs = 0x614389EaAE0A6821DC49062D56BDA3d9d45Fa2ff;
    address public multiHarvest = 0x0000000000000000000000000000000000000000;

    // Other constants
    uint16 public constant underlyingPoolId = 19;
        ...
        )
    {
        ...
        usdc_orbs_path = new address[](2);
        usdc_orbs_path[0] = usdc;
        usdc_orbs_path[1] = orbs;
    }
    ...
    function harvest() public override {
        ...
        if (_dinoBalance > harvestCutoff){
            ...
            _swapUniswapWithPathQuick(usdc_orbs_path, _usdcBalancePost.div(2));
            ...
            if (_usdc > 0 && _orbs > 0) {
                ...
                IERC20(orbs).safeApprove(quickRouter, 0);
                IERC20(orbs).safeApprove(quickRouter, _orbs);
                ...
                IERC20(orbs).safeTransfer(
                    strategist,
                    IERC20(orbs).balanceOf(address(this))
                );
            }
        }
        // Stake the LP tokens
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public ORBS_USDC_LP = 0xB2b6D423e535b57aaD06E9866803B95fB66152EA;
