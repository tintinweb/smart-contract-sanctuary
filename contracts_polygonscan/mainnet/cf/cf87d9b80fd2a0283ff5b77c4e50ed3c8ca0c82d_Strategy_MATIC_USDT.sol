...
contract Strategy_MATIC_USDT is Ownable {
    // This strategy is for BSC network. MATIC - USDT pair. RewardToken = "dQUICK, wMATIC"
    ...
    address public constant YELtoken = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    ...
    function _addLiquidityFromETH(uint256 _amountETH) internal {
        _swapExactETHForTokens(routerLP, token1, _amountETH);
    ...
    function _swapTokenToWMATIC(address _token) internal {
        ...
        if(_balance > 0) {
            address _router = _token == token1 ? routerMain : routerLP;
