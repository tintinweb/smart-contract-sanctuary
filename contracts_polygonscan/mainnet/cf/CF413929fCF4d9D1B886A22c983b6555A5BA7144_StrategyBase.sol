...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    {
        iris_koge_path = new address[](2);
        iris_koge_path[0] = iris;
        iris_koge_path[1] = koge;
    }
    ...
    function harvest() public override {
        ...
        if (_irisBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(iris_koge_path, _irisBalancePost.div(2));
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public IRIS_KOGE_LP = 0x302f7E9bB5b5AC673Ac537F464a1B7A36bbbaBfA;
