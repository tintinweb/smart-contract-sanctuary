...
contract HackMe is Ownable {
    bytes32 constant NULL = "";

    IERC721Mintable q1NFT;
    IERC721Mintable q2NFT;
    IERC721Mintable q3NFT;

    mapping(address => bool) q1Minted;
    mapping(address => bool) q2Minted;
    mapping(address => bool) q3Minted;

    bytes32 public q2Hint = "no plan inc. has a plan.";
    uint256 public q2MintCount = 0;
    ...
    constructor(IERC721Mintable _q1NFT, IERC721Mintable _q2NFT, IERC721Mintable _q3NFT) {
        q1NFT = _q1NFT;
        q2NFT = _q2NFT;
        q3NFT = _q3NFT;
    }
