...
// File: Vault\StrategySingularfarmSingMaticApeswap.sol

// openzeppelin v3.1.0

contract StrategySingularfarmSingMaticApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
        token1ToEarnedPath = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance, , ) = ISingular(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}