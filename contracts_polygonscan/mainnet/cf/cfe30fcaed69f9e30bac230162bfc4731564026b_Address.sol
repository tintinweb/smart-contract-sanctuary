...
contract VaultChef is Ownable, ReentrancyGuard, Operators {
    ...
    struct PoolInfo {
        string name;// To allow easy identification on polygonscan.com
    ...
    event AddPool(address strat, string name);
     ...
     */
    function addPool(address _strat, string memory _name) external onlyOwner nonReentrant {
