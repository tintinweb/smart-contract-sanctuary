...
// File: Vault\StrategyFirebirdUsdcTitanFirebird.sol

// openzeppelin v3.1.0

contract StrategyFirebirdUsdcTitanFirebird is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToToken1Path = [address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00aaa5b9e6c589642f98a1cda99b9d024b8407285a)];
        token0ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660)];
        token1ToEarnedPath = [address(0x00aaa5b9e6c589642f98a1cda99b9d024b8407285a), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00aaa5b9e6c589642f98a1cda99b9d024b8407285a)];
    }
    
    function stake(uint256 _wantAmount) internal virtual override{
        IFirebird(masterChef).depositWithRef(pid, _wantAmount, referralAddress);
    }

    function harvest() internal virtual override{
        IFirebird(masterChef).depositWithRef(pid, 0, referralAddress);
    }

    function unstake(uint256 _amount) internal virtual override{
        IFirebird(masterChef).withdraw(pid, _amount);
    } 
    function emergencyWithdraw() internal virtual override onlyOperator {
        IFirebird(masterChef).emergencyWithdraw(pid);
    }   
    
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance,) = IFirebird(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}