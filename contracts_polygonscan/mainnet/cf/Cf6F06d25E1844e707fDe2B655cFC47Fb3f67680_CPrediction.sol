...
contract CPredictionFactory is Ownable {
    ...
    address public operatorLiqAddress;
    ...
    constructor(
        ...
        address _operatorLiqAddress,
        address _referralSystemAddress
    ) {
        adminAddress = _adminAddress;
        operatorAddress = _operatorAddress;
        operatorLiqAddress = _operatorLiqAddress;
        referralSystem = IReferralC(_referralSystemAddress);
    }
    ...
    modifier onlyAdminOrOperatorLiq() {
        require(msg.sender == adminAddress || msg.sender == operatorLiqAddress, "adm|opl");
        _;
    }
    ...
    function setOperatorLiquidity(address _operatorLiqAddress) external onlyAdmin {
        require(_operatorLiqAddress != address(0));
        operatorLiqAddress = _operatorLiqAddress;
    }
    ...
    function provideLiquidity(uint256 _index, uint256 epoch, uint256 bullAmount, uint256 bearAmount) external onlyAdminOrOperatorLiq {
         predictions[_index].provideLiquidity(epoch, bullAmount, bearAmount);
    }
