...
contract Rebalancer is InstaFlashReceiver {
    ...
    function onERC721Received(
        ...
        (simulate, tokenId, owner, _amount, _tokens, _callData, params) = abi
            .decode(
                data,
                (
                    bool,
    ...
    function basicRebalancer(
        ...
        // Take Flash loan
        // InstaFlashReceiver flashloan = new InstaFlashReceiver(proxy);
        // route = 1, using aave
        this.flashBorrow(_tokens, _amount, 1, callData);
    }
}
