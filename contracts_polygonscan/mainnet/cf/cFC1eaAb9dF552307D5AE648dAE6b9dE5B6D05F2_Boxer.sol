...
contract Boxer is Context, IERC20, Ownable {
    ...
    string private _name = "Boxer";
    string private _symbol = "BOXER";
    ...
    address public charityWallet = 0xE81251Aa4CdeEB2a4e7044f421f2a75A7177cE82;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, 'We can not exclude Pancake router.');
