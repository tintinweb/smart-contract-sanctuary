 ...
 */
contract BankElevenGrowthVault is ERC20, Ownable {
     ...
     */
    constructor () public ERC20("Unused USDC funds", "unused USDC") {
     ...
     */
    function deposit(uint _amount) public onlyBank{
     ...
     */
    function withdraw(uint256 _shares) public onlyBank{
