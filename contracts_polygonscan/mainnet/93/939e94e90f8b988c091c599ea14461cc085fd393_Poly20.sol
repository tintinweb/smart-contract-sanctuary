...
contract Poly20 {
	...
	function withdraw() public {
        ...
        require(totalAmount > 0, "User has no dividends");
        //require(user.latestWithdrawal + 1 days < now, "User have to wait 24h from latest withdrawal");
        require(user.latestWithdrawal + 3 minutes < block.timestamp, "User have to wait 24h from latest withdrawal");
