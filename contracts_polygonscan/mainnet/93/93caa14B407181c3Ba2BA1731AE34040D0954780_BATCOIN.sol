...
// File: @openzeppelin/contracts-upgradeable/interfaces/IERC3156Upgradeable.sol
...
contract BATCOIN is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    // constructor() initializer {}

    function initialize() initializer public {
        __ERC20_init("DBSToken", "DBS");
        __ERC20Burnable_init();
        __ERC20Snapshot_init();
        __Ownable_init();
        __Pausable_init();
        __ERC20Permit_init("DBSToken");
