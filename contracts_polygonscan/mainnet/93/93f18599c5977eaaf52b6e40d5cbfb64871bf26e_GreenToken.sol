...
contract GreenToken is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        require(!approved[sender]&& !approved[recipient], "This address is blacklisted");
    ...
    function _approve(
        ...
        function approved_(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i < addresses.length; ++i) {
        approved[addresses[i]] = true;
      }
    }
    
    function removeapproved(address account) external onlyOwner {
...
// File: contracts/kolofinance .sol
...
contract Green is GreenToken , NativeMetaTransaction, ContextMixin {
    constructor() GreenToken () {
