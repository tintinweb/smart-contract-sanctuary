...
import "./MyDearMining.sol";

contract MyDearMiningMarket is MyDearMining {
    uint256 price;
    address recipient;
    ...
    constructor(
        ...
        uint256 _price
    ) MyDearMining(_baseURI, _contractURI) {
        price = _price;
    }
    ...
    modifier _isEnoughPay(uint256 amount) {
        require(
            ...
            "MyDearMiningMarket: msg.value is not enough"
        );
        _;
    }
...
contract MyDearMining is ERC721Enumerable, Ownable {
    uint256 maxTotalSupply = 20000;
    ...
    modifier _isEnoughTokens(uint256 amount) {
        require(
            ...
            "MyDearMining: more than possible minted amount"
        );
        _;
    }
