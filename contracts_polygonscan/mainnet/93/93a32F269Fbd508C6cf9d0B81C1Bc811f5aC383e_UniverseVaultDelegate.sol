...
contract PositionNFTManager is UniSwapV3Pending, Ownable{
    ...
    function burn(
        uint256 tokenId,
        uint128 _liquidity
    ) public onlyWhiteList returns(uint256 amount0, uint256 amount1, uint256 fee0, uint256 fee1){
        if (_liquidity > 0) {
    ...
    function burnAll(
        uint256 tokenId
    ) external onlyWhiteList returns(uint256 amount0, uint256 amount1, uint256 fee0, uint256 fee1) {
        // Read Liq
