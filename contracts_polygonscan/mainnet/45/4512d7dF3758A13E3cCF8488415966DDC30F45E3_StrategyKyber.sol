...
// File @openzeppelin/contracts/utils/[email protected]3.4.2
...
contract StrategyKyber is StratManager, FeeManager {
    ...
    function getSplit() internal view returns (uint256) {
        ...
        uint256 ratio = ampReserve1.mul(ampVReserve1).mul(1e6).div(ampReserve0).div(ampVReserve0);

        return ratio.div(ratio.add(1e6));
    }
