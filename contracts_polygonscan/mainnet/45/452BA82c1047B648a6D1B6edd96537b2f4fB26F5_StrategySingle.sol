...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getHarvestable() external override view returns (uint256) {
        return IMasterChef(rewards).pendingShield(poolId, address(this));
    }
...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0xF239E69ce434c7Fb408b05a0Da416b14917d934e;
    ...
    address public constant shield = rewardToken;
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public SHIELD_MASTERCHEF = 0x0Ec74989E6f0014D269132267cd7c5B901303306;
    address public Want_Token = 0xF239E69ce434c7Fb408b05a0Da416b14917d934e;
