...
// File: Vault\StrategySingularfarmSingUsdcApeswap.sol

// openzeppelin v3.1.0

contract StrategySingularfarmSingUsdcApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToToken1Path = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
        token0ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
