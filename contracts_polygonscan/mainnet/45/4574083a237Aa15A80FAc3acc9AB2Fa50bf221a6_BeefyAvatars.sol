...
contract BeefyAvatars is ERC721Pausable, Ownable, ReentrancyGuard, VRFConsumerBase {
    using Counters
    ...
    VRFConsumerBase(_coordinator, _linkToken) {
        ...
        keyHash = _keyHash;
        mintPrice = _mintPrice * 10 ** 14;

        wnativeToLinkRoute = new address[](2);
        wnativeToLinkRoute[0] = unirouter.WETH();
        wnativeToLinkRoute[1] = linkToken;

        art.background[0] = Item("moon", "QmPMPYM8dbHbmhz1HhMxjqhyYjFoyL4AV9vGiuBSMWfng6");
        art.background[1] = Item("pasture", "QmXpXcApioATCg1htTKhHWvWDUTsSVRfEpACF796HaipjR");
        art.background[2] = Item("snow", "Qmcr57vWi2hxMRtgCbAGodyQosK4phbpKsUb34aL6cdgjo");
        art.background[3] = Item("beach", "QmamWxMQ85YQHhohNQonRdhN7jaYyj1L644Ug8Kq2SLvea");

        art.body[0] = Item("astronaut", "QmVdvTDozaBDwYXJySN2PL7G1mcjJzqfDAfUg1WdMe95kJ");
        art.body[1] = Item("cyborg", "Qmea6EhpLT2RXtiDhgab2Mzyf3gQeFSLwZ3QCBQ8TBTpTn");
        art.body[2] = Item("avax", "QmYy9HN3kQ5oqQ61mopQuw7bRvMmUxDrfsCrPRVVk3B9Yy");
        art.body[3] = Item("eth", "QmP5dDA1VjprmbhEBvG6snTZknmDDLDLwTWkS2MsWxnLfM");

        art.hair[0] = Item("rasta_hair", "QmZ8Sjf4qaR3gSLiSUkAu67edNhZvba2xh8yXz626qP2BJ");
        art.hair[1] = Item("short_hair", "QmQ4vQw72w3yRzwFWft9icnVtkujJNAWCRCkSeQByxVBM3");
        art.hair[2] = Item("cow_wig", "QmNuMUfiTYNnJ3oD9h7FWJNr9mpZeoP8mV7tU6s3G1myXV");

        art.eyes[0] = Item("plead_face", "QmUBfyUNipDg8wij5xSDbctueQB3CpzQGWw1oH8kw2sg7v");
        art.eyes[1] = Item("normal_eyes", "QmQ8y27FUUS4PjtyMWpLwFq3YRJougLV7LFXsZNdWah2Fa");
        art.eyes[2] = Item("anime_eyes", "QmXqDs8yYTr8Lpg4shJrJH8hFjjX7kVVT3jGpE1V6q22Hm");
        art.eyes[3] = Item("tired_eyes", "QmTJHVcYCbMYTNzKsiQyNfx6uCKB3GgtFocNTxwvVpJjxG");

        art.accsBody[0] = Item("moo_necklace", "QmSRHG5wq8rTnfAaWHui9A5Qyb8tXmZ6aGoA32DjCAmAr7");
        art.accsBody[1] = Item("vault_key", "QmNp9ZR3jVjPvKhkw3zSCzdTDSHgRBMzoaVquC34X65SVb");
        art.accsBody[2] = Item("farmer_pitch", "QmTCiRjQNYHF4x7zsELEKV51RZfx8SJyGtFr7dVDFTDGUu");

        art.accsFace[0] = Item("laser_eyes", "QmcsXcVuJCp5JRw7eragpuw5WrzTbySpUVZvaJxfQd6GhD");
        art.accsFace[1] = Item("cigare", "QmZ9GfYw1coDtaDViTUXZDZb836RrGH2mnLrGexFi2vnHN");
        art.accsFace[2] = Item("monocle", "QmYpFgDKQet4ewLEq7n6PGzUH8ZH4VFb8nE2bYj3rbyBai");

        art.hat[0] = Item("hat_eth", "QmUmFHS5VRqXTDfvtVgY75eXnJnZ3tjQ2MeWDLgb4GzHoa");
        art.hat[1] = Item("hat_avax", "QmcDKCFaouGNEqLauRM9srnT8Gjn9A4ShAGcbm51cSDPiR");
        art.hat[2] = Item("hat_fantom", "QmXekuoSn9j2F5Kxv8jXn3k1p6XBmWQXgFmfrDqzkPtnJd");
        art.hat[3] = Item("hat_polygon", "QmdvNp7yfmAbFZ67TtF6pk5ykFu9kyTCy1xuTuMR1Mi9Qv");
    }
