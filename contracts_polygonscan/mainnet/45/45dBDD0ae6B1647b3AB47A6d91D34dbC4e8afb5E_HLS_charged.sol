...
// ----------- cream manipulative function ------------
    ...
    function _borrowCream(HLSConfig memory self, Position memory _position) private returns(Position memory) {
        ...
        uint256 amt = _position.supply_amount.mul(10).div(100); // only borrow 75% worth of supplied token's value
        ...
        // uint256[8] memory result = [amt, norm_amt, token_price, norm_desired_total_value, value_a_desired, value_b_desired, token_a_borrow_amount, token_b_borrow_amount];
