...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    {
        gfi_usdc_path = new address[](2);
        gfi_usdc_path[0] = gfi;
        gfi_usdc_path[1] = usdc;
    ...
    function harvest() public override {
        ...
        if (_gfiBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(gfi_usdc_path, _gfiBalance.div(2));
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public GFI_MASTER_CHEF = 0xE6584E2432ef0b82A39C383e895E7e031655F2Bf;
    address public GFI_USDC_LP = 0xb1f3555A7c3753AB4E6DF1d66CFDB25477a36Ce7;
