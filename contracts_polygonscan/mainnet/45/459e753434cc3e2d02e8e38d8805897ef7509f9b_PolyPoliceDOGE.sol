...
contract PolyPoliceDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0eA4F716F892C11a8fF2de472617fC9F4B8dd9e2); // Marketing Address
    ...
    string private _name = "PolyPoliceDOGE";
    string private _symbol = "PolyPoliceDOGE";
