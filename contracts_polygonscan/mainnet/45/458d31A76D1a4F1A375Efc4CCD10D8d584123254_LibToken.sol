...
contract LibToken is BEP20("Libre", "LIBRE") {
    uint256 public _byFarSupply;   // include burned tokens
    uint256 public _maximumSupply;
    constructor() public{
        // AVAX 13000000
        // POLY 5500000
        _maximumSupply = 5500000*10**18;
        uint256 inital_supply = 0;
        _byFarSupply = _byFarSupply.add(inital_supply);
    ...
    function mint(address _to, uint256 _amount) public onlyChef {
        require(_byFarSupply.add(_amount) <= _maximumSupply, "Libre: reward period end");
        _mint(_to,_amount);
