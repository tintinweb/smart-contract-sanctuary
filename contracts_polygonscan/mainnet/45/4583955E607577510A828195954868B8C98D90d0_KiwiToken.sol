...
// 0.625
  constructor () ERC20("KIWI", "KIWI") ERC20Permit("KIWI") {
    _mint(initialLiquidityProvider, 625000000000000000);
  ...
  function swapOldKiwi (uint256 swapAmount) external nonReentrant {
    require(block.timestamp < launchTime + 14 days, "Swaptime expired");
