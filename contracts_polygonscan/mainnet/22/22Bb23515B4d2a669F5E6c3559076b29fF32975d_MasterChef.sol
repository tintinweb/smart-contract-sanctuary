...
contract MasterChef is Ownable, ReentrancyGuard {
  ...
  bool public autoUpdateBlockHarvest = true;
    ...
    function compound(address _referrer) public nonReentrant {
      uint256 _pid = 0;
      ...
      updateHarvestFee();
        ...
        uint256 transferTax = harvestRewards.mul(crow.transferTaxRate()).div(10000);
        harvestRewards = harvestRewards.sub(transferTax);


        deposit(0, harvestRewards, _referrer);
    }
