...
contract DiamondHand is ERC721Enumerable, Ownable{
    ...
    uint256 public constant NFT_MINT_PRICE = 0.09e18;
    ...
    function mintToken() public payable{
        require(saleActivated, "mintToken: Mint process is pause");
        require(totalSupply() <= TOTAL_SUPPLY, "mintToken: Can not mint more tokens");
        require(msg.value == NFT_MINT_PRICE, "mintToken: Invalid Amount");
