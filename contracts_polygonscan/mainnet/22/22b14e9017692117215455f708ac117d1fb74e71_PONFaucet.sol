...
contract PONFaucet {
    ...
    constructor (address _PONAddress, address _ownerAddress) {
        token = IERC20(_PONAddress);
        owner = _ownerAddress;
    }   
    ...
    function send() external {
        ...
        // Next request from the address can be made only after 2 minutes         
        nextRequestAt[msg.sender] = block.timestamp + (2 minutes); 
