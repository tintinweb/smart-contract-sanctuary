...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public lithium_usdc_path;
    ...
    {
        lithium_usdc_path = new address[](2);
        lithium_usdc_path[0] = lithium;
        lithium_usdc_path[1] = usdc;
    ...
    function harvest() public override {
        ...
        if (_lithiumBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(lithium_usdc_path, _lithiumBalance.div(2));

            // Add liquidity
            uint256 _lithium = IERC20(lithium).balanceOf(address(this));
            uint256 _usdc = IERC20(usdc).balanceOf(address(this));
            if (_lithium > 0 && _usdc > 0) {
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public Lithium_USDC_LP = 0x1b9c6d8b372C410426CF803fd20a815aA7B454c2;
