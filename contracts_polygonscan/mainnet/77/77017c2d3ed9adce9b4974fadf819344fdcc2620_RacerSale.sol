...
contract RacerSale is Pausable, AccessControl{
    ...
    constructor(address _ROE) {
        ...
        minInvestment = 2 * 1e18;
        maxInvestment = 10 * 1e18;
    }
    ...
    function InvestInRETH() public payable{
        ...
        RETH.mint(sender, value * tokenRate);
        RETHSold += value * tokenRate;
