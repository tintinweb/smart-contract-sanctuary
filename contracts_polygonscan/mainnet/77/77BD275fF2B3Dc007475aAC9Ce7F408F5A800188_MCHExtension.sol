...
// File contracts2/token/ERC721Mintable.sol
...
// File contracts2/token/ERC721ApprovalProxy.sol
...
// File contracts2/MCHExtension.sol

pragma solidity 0.8.3;



contract MCHExtension is ERC721Mintable, ERC721ApprovalProxy, Ownable {

    string public baseURI;

    constructor(address _approvalProxy) ERC721ApprovalProxy(_approvalProxy) ERC721("MyCryptoHeroes:Extension", "MCHE") {
        super.setApprovalProxy(_approvalProxy);
        setBaseURI("https://www.mycryptoheroes.net/metadata/extension/");
    }
    ...
    // override 
    function setApprovalForAll(address _spender, bool _approved) override(ERC721ApprovalProxy, ERC721) public {
        super.setApprovalForAll(_spender, _approved);
    }

    function isApprovedForAll(address _owner, address _spender) override(ERC721ApprovalProxy, ERC721) public view returns (bool) {
