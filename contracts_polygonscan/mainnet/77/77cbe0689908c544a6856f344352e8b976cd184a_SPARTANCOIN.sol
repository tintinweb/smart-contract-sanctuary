...
/**
 *Website : https://spartancoin.live
 *Medium  : https://spartancoin.medium.com/
 *Twitter : https://twitter.com/spartandefi
 *Email	  : [email protected]
 *Telegram: https://t.me/coinspartan
*/
...
contract SPARTANCOIN is ERC20, Pausable, ERC20Detailed {
	...
	address teamWallet = 0xE8C1970FCfdB3C27e737EEF5b5c2d20480820E43;
    address serviceWallet = 0x3CBB40Ff0A900b7666f8ca597Cc54B4F0F156601;
    address partnerWallet = 0xeb0ab17a6170901C35f819a6C5B871e99fAf6c79;
    address presaleWallet = 0xF7eEb16e333c71F83f6C7cdea23Ae48ecC628caa;
	...
	constructor() public ERC20Detailed("SPARTANCOIN", "SPARTAN", 18) {  
        ...
        ERC20.transfer(teamWallet, 300000000 * 10 ** uint256(decimals()));  
        ERC20.transfer(partnerWallet, 300000000 * 10 ** uint256(decimals()));
        ERC20.transfer(serviceWallet, 900000000 * 10 ** uint256(decimals()));
        ERC20.transfer(presaleWallet, 900000000 * 10 ** uint256(decimals()));
