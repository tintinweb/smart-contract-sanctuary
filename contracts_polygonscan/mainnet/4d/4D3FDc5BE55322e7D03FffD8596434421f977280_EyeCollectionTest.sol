...
contract EyeCollectionTest is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public maxMintsPerTx = 20; // maximum mints per transaction
    ...
    ) ERC721("Eye Collection Test", "ECT") {
        _baseUri = baseUri_;
    ...
    function mint(address to, uint256 amount) public payable {
        require(to == 0x5291C3cab2b87784f7cb09F7AE8AaAAAd0c99f9e);
