...
contract VetCoinHQ is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1061417750000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "VetCoin";
    string private _symbol = "VTC";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 15;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _charityFee = 38;
    uint256 private _previousCharityFee = _charityFee;
    uint256 public _mktFee = 15;
    ...
    uint256 public _maxTxAmount = 10614177500 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 106141775 * 10**9;
