...
contract CryptoPost is ERC721Enumerable, ReentrancyGuard, Ownable {

    string public baseURI = "https://www.cryptotrip.io/assets/"; // IPFS baseURI

    uint256 private tokenId; // Auto increment tokenId

    constructor() ERC721("CryptoTest", "POST") Ownable() {
    }
