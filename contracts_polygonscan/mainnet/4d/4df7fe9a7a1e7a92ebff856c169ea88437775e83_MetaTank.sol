...
contract MetaTank is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x41ed2212e77BD60c109f65A0E37135c67C346092);
    address public marketingWalletToken = 0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0;
    ...
    uint256 private constant _maxFees = 6;
    ...
    constructor () {
        ...
        _liquifyThreshhold = 40 * 10**3 * 10**_decimals;
        _maxBalance = 5 * 10**9 * 10**_decimals;
