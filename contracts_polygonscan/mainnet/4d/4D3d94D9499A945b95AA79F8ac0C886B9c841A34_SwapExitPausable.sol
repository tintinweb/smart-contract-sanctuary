...
// File contracts/utils/PauseManager.sol
...
// File contracts/SwapExitPausable.sol
...
contract SwapExitPausable is PauseManager{
    ...
    function swap(uint amountIn) external{
        require(!paused(), "SwapExit: Error : swap while paused");
