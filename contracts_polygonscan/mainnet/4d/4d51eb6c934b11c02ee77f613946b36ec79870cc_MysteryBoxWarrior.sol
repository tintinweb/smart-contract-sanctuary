...
contract MysteryBoxWarrior is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    string public _baseURI = "https://raw.githubusercontent.com/moeagame/NFT/main/nftdata/";
    uint public maxTokensPerTransaction = 10;
    uint256 public tokenPrice = 1000000000000000000; //1 MysteryTicket
    uint256 public nftsNumber = 1005;
    uint256 public nftsPublicNumber = 1000;
    IERC20 public token;
    ...
    constructor() public {
        ...
        // token = IERC20(_token);
        token = IERC20( address(0xBf2D327e1D216a46b758Cae6C44ad57cF0B60050) );
    ...
    function buy(uint tokensNumber) whenNotPaused public payable {
        ...
        uint256 amount = quote(tokensNumber);
        uint256 balance = token.balanceOf(msg.sender);
        require(amount <= balance, "MysteryTicket balance is too low");
    ...
    function quote(uint tokensNumber) public view returns (uint256){
        return tokenPrice.mul(tokensNumber);
    }
