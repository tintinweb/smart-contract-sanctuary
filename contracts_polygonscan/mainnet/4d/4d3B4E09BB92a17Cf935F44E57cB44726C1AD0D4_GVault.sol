...
contract GVault is Ownable {
    ...
    address private devg = 0xFECe4FC28BdEE14e72dF795222798701ADb02acC;
    address private devh = 0xFECe4FC28BdEE14e72dF795222798701ADb02acC;
    ...
    constructor() {
        ...
        IERC20 _GFarmToken = IERC20(0xE5417Af564e4bFDA1c483642db72007871397896); // Replaced GFARM with GNS
        IERC20 _DAIToken = IERC20(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063);
        IUniswapV2Pair _LPToken = IUniswapV2Pair(0x6E53cB6942e518376E9e763554dB1A45DDCd25c4); // Replaced with new GNS/DAI LP
        GFarmPool _gfarmPool = GFarmPool(0x151757c2E830C467B28Fe6C09c3174b6c76aA0c5); // Replaced with new v5 pool
        // REMOVED NFTs
        ...
        LPToken.approve(0x151757c2E830C467B28Fe6C09c3174b6c76aA0c5, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    ...
    // ============================================================================================================================================
    // NFT functions below
    // REMVOED NFTS - DEPOSIT
    // REMOVED NFTS - WITHDRAW
    // REMOVED NFTS - EMERGENCY NFT WITHDRAW
    ...
    function withdrawAnyToken(address _tokenContract, uint256 _amount) external onlyOwner {
