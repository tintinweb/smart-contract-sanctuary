...
// File: Vault\StrategyGravityGfiUsdcGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityGfiUsdcGravity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToToken1Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        token0ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
