...
// File: Vault\StrategyJetswapPforceMaticJetswap.sol

// openzeppelin v3.1.0

contract StrategyJetswapPforceMaticJetswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x000de624ed2882e7480d97b2bbee57675c4fa26e33)];
        ...
        token1ToEarnedPath = [address(0x000de624ed2882e7480d97b2bbee57675c4fa26e33), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x000de624ed2882e7480d97b2bbee57675c4fa26e33)];
    }
