...
contract FatherDoge is Context, IERC20, Ownable {
    ...
    function setMaxTxNum(uint256 maxTxNum) external onlyOwner() {
    ...
    function _transfer(
        ...
        require(_frozenAccount[from]);                         // Check if sender is frozen
