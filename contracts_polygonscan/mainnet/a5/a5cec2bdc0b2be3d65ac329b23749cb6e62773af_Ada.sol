...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x7CeA63B4c6559149De90705AE11CCE7AA3F3c2b9;
...
contract Ada is ERC20, Ownable {
    ...
    address public toBurnBoxAddress = 0xF9edDCd14eCE9fD128E17c8E429b3f3c67fabDbB;
    uint256 public toBurnBoxFee = 2;
    ...
    constructor() ERC20("ADA.app", "ADA") {
        ...
        a80DividendToken = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F;
        b20DividendToken = 0xcFC1eaAb9dF552307D5AE648dAE6b9dE5B6D05F2;
    ...
    function updateBurnBoxAddress(address _newAddress) external onlyOwner {
        toBurnBoxAddress = _newAddress;
    }
    ...
    function setToBurnBoxFee(uint256 newFee) external onlyOwner {
    ...
    function _updateTotalFee() internal {
        totalFees = buyBackAndLiquidityFee.add(marketingFee).add(a80DividendRewardsFee).add(b20DividendRewardsFee).add(toBurnBoxFee);
    }
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by Ada");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by Ada");
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && contractTokenBalance >= swapTokensAtAmount) {
                ...
                if(marketingEnabled && buyBackAndLiquifyEnabled && toBurnBoxFee > 0 && buyBackMode){

                    uint256 total3Fees = marketingFee.add(buyBackAndLiquidityFee).add(toBurnBoxFee);
                    ...
                    if(increaseAmount > 0){
                        ...
                        uint256 maticToBurnBox = increaseAmount.mul(toBurnBoxFee).div(total3Fees);
                        useMaticToBurnBox(maticToBurnBox);
                    }
                }else{
                    if (marketingEnabled) {
                    ...
                    if(toBurnBoxFee > 0){
                        uint256 swapTokensToBurnBox = contractTokenBalance.mul(toBurnBoxFee).div(totalFees);
                        buyBackBoxAndBurn(swapTokensToBurnBox);
                    }
                }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private {
        ...
        // add the liquidity
        uniswapV2Router.addLiquidityMATIC{value: bnbAmount}(
            address(this),
            tokenAmount,
    ...
    function useMaticToBurnBox(uint256 amount) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = toBurnBoxAddress;

        // make the swap
        uniswapV2Router.swapExactMATICForTokensSupportingFeeOnTransferTokens{value: amount}(
    ...
    function buyBackBoxAndBurn(uint256 amount) private {
        address[] memory path = new address[](3);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = toBurnBoxAddress;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADA20_Dividend_Tracker", "ADA20_Dividend_Tracker", 0x580dE58c1BD593A43DaDcF0A739d504621817c05) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
