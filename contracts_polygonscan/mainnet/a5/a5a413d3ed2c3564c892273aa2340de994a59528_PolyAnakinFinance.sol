...
contract PolyAnakinFinance is Context, IERC20, Ownable {
...
contract POLYANAKIN is PolyAnakinFinance, NativeMetaTransaction, ContextMixin {
    constructor() PolyAnakinFinance() {
