...
/** 
 * @title FireStarter Metaverse Hiros Collection
 * @author Daniel Lee
 * @notice This contract is for distribution of 10k flares to users
 * @dev All function calls are currently implemented without side effects
 */
contract Hiros is Initializable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, AccessControlEnumerableUpgradeable {
