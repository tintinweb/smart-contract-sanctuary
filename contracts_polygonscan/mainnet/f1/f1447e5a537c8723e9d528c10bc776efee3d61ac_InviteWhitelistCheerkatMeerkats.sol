...
// JOIN OUR DISCORD AND WAIT TO BE WHITELISTED - https://discord.com/invite/fvhWujXNNz

/* Website: 

https://cheerkatmeerkatsclub.com

WELCOME TO THE CHEERKATS MEERKATS CLUB
CMC is a collection of 10,000 Cheerkat Meerkats NFTs—unique digital collectibles living on the Ethereum blockchain. Your Cheerkat Meerkat doubles grants access to members-only benefits. All important decisions will be made by the community democratic voting.

By obtaining this token you have been chosen to become part of the new community. This project is GAME CHANGE FOR YOU!
...
abstract contract Ownable is Context {
    ...
    address payable internal  dev = payable(0x5c032EAa60265b4012EC2662B2901D07B9841a6c);
...
contract InviteWhitelistCheerkatMeerkats is ERC721Enumerable, Ownable {

    string _baseTokenURI;

    constructor() ERC721("Invite Whitelist Cheerkat Meerkats", "IWCM")  {
