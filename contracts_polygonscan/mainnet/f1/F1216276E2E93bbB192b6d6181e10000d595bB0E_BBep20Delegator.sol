...
// File: contracts\BBep20Delegator.sol

pragma solidity ^0.5.16;


/**
 * @title Bai's BBep20Delegator Contract
 * @notice BTokens which wrap an EIP-20 underlying and delegate to an implementation
 * @author Bai
 */
contract BBep20Delegator is BTokenInterface, BBep20Interface, BDelegatorInterface {
    /**
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "BBep20Delegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"BBep20Delegator:fallback: cannot send value to fallback");
