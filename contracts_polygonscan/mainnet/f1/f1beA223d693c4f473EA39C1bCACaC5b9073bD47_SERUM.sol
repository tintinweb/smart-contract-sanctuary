...
contract SERUM is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("SERUM", "SERUM") AccessControl(){
        _mint(owner, 960000 * 10 ** 18);
        ...
        coinAmountPerRewardUnit = 10 * 10 ** 18; // 10 SERUM coins per rewardUnit
    ...
    function stake(uint256 tokenId) public {
        ...
        require(IERC721(collectionAddress).ownerOf(tokenId) == address(this),
            "SERUM: Error while transferring token");
    ...
    function setCollectionAddress(address newAddress) external onlyRole(CONTRACT_ADMIN_ROLE){
        require (newAddress != address(0), "SERUM: update to zero address not possible");
