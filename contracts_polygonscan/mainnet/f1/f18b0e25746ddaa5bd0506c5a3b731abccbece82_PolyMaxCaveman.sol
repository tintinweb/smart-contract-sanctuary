...
contract PolyMaxCaveman is Context, IERC20, Ownable {
...
contract PolyMax is PolyMaxCaveman, NativeMetaTransaction, ContextMixin {
    constructor() PolyMaxCaveman() {
