...
contract GoldmaToken is BEP20, MinterRole {
    ...
    uint256 public minSwapAmount = 100000000000;   //10 GMA tokens
    // Trading bool
    ...
    // USDT address
    address public constant USDT = address(0xc2132D05D31c914a87C6611C10748AEb04B58e8F); //decimals 6
    address public constant V2ROUTER = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
    ...
    /**z
     * @notice Constructs the GMA token contract.
     */
    constructor(address _feeWallet) public BEP20("GoldmaToken$", "GMA") {
        operator = _msgSender();
    ...
    /// @dev overrides transfer function to meet tokenomics of GMA
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "GMA::transferOperator: new operator is the zero address");
