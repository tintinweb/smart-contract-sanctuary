...
contract POLYPEPE_NFT_GEN_3 is ERC721URIStorage {
    
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    constructor(address _frogToken, string memory _metadata, string memory _firstEditionMetadata, uint256 _cost, uint256 _maxMintable) ERC721("Official PolyPepe NFTs","GEN3") {
