...
contract Warzone is ERC721Enumerable, ReentrancyGuard, Ownable {
...
string[] private weapons = [
    ...
    string[] private secondaryWeapon = [
        "Desert Eagle",
        "Makarov",
        ".357 Magnum",
        "RPG-7",
    ...
    function getsecondaryWeapon(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "SECONDARY WEAPON", secondaryWeapon);
    }
    
    function getPerks(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "PERK", perks);
    }
