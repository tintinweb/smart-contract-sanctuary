...
contract FOCI is ERC721, ERC721Enumerable, ERC721URIStorage, HasSecondarySaleFees, ContextMixin, Ownable {
    using Strings for uint256;

    string private constant _d1 = '{"name": "FOCI - ';
    string private constant _d2 = '","description": "FOCI","image": "';
    string private constant _d3 = '"}';

    constructor()
    ERC721("FullyOnChainImg", "FOCI")
    ...
    function mint(uint256 tokenId, string memory img) public onlyOwner {
        _safeMint(_msgSender(), tokenId);
        _setTokenURI(tokenId,img);
    }
        ...
        returns (string memory)
    {
        ...
        string memory imgstr = string(abi.encodePacked("data:image/gif;base64,", super.tokenURI(tokenId)));
        string memory json = Base64.encode(abi.encodePacked(_d1, tokenId.toString(), _d2, imgstr, _d3));
    ...
    function withdrawETH() external {
        ...
        Address.sendValue(payable(address(0x2fa56A56aB5f3447752fF8D0FcbC88bf2e58B3B6)), royalty);
    }
