...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant pforce = 0x0DE624ED2882E7480d97b2bBee57675C4FA26e33;
    ...
    // Uniswap swap paths
    address[] public pwings_pforce_path;
    ...
    {
        pwings_pforce_path = new address[](3);
        pwings_pforce_path[0] = pwings;
        pwings_pforce_path[1] = matic;
        pwings_pforce_path[2] = pforce;
    ...
    function harvest() public override {
        ...
        if (_pwingsBalance > harvestCutoff){
            ...
            _swapUniswapWithPathForFeeOnTransferTokens(pwings_pforce_path, _pwingsBalancePost);

            // Add liquidity for TITAN/MATIC
            uint256 _pforce = IERC20(pforce).balanceOf(address(this));
            uint256 _matic = IERC20(matic).balanceOf(address(this));
            if (_pforce > 0 && _matic > 0) {
                IERC20(pforce).safeApprove(currentRouter, 0);
                IERC20(pforce).safeApprove(currentRouter, _pforce);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public pFORCE_MATIC_LP = 0x4461677151ec95b2B4121122Cd07fECcde6b8A28;
