...
contract MadnessKingDomNFT is Ownable, ReentrancyGuard {
    ...
    function withdraw() external nonReentrant {
        ...
        if (user.hasNFT) {
            ...
            theEndlessFactoryNFT.setExperience(user.nftID, lastExperience.add(100).add(powerStaking));
        }
    ...
    function _updatePower(address _user) internal {
        ...
        uint256 powerStaking = (user.amount * user.powerStaking).div(factor);
        
        user.powerAmount = user.amount + powerStaking;
