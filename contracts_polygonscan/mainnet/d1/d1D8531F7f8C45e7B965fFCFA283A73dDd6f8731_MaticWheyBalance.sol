...
import "../MaticWheyFarm.sol";

contract MaticWheyBalance {
    using SafeMath for uint;
    using SafeERC20 for IERC20;
    
    MaticWheyFarm public constant wheyFarm = MaticWheyFarm(0x8bEe394FbAf97013293af92eD9Fc4A70542f25C0);
    IERC20 public constant WHEY = IERC20(0x0cfbBb89Fd58F6B49B7bF5665397ddc84003d47c);
    IERC20 public constant WHEY_MATIC_LP = IERC20(0x1b18c67c3b596351ed23F9dD0E63013370C8183F);
    ...
    function balanceOf(address _address) external view returns (uint) {
        ...
        lpBalance = lpBalance.add(WHEY_MATIC_LP.balanceOf(_address));
        
        // Amount of WHEY in LP tokens
        balance = balance.add(lpBalance.mul(WHEY.balanceOf(address(WHEY_MATIC_LP))).div(WHEY_MATIC_LP.totalSupply()));
