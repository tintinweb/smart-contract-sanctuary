...
contract maticBridge is Multiownable {
    ...
    function recieveTokens(uint256[] memory commissions) public payable {
        if (tokensRecievedButNotSent[msg.sender] != 0) {
            ...
            require(msg.value >= sum, "Not enough MATIC (The amount of MATIC is less than the amount of commissions.)");
            require(msg.value >= owners.length * 150000 * 10**9, "Not enough MATIC (The amount of MATIC is less than the internal commission.)");
