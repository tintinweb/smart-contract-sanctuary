...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable, MinterRole, WhitelistAdminRole {
    ...
    mapping(uint => string) internal ipfsList;
    // Contract name
    string public name;
    // Contract symbol
    ...
    function setURI(uint _id, string memory str) public onlyWhitelistAdmin{
        ipfsList[_id]=str;
    }
     ...
     * @param ipfsHash Hash of IPFS link to uri
    ...
    function create(
        ...
        if (bytes(ipfsHash).length > 0) {
            ipfsList[_id]=ipfsHash;
            emit URI(ipfsHash, _id);
        }
...
contract PepemonFactory is ERC1155Tradable {
    ...
    constructor() public ERC1155Tradable("SupportFactory", "SUPPORT") {
