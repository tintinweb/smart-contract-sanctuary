...
contract Test is Ownable, PolygonArbitrageBot {
    ...
    function hitMe(uint256 _amount) external
    {
...
contract PolygonArbitrageBot is PolygonTradingHub {
    ...
    function _polygonArbitrageBotPerformSwapIfValuable(kPolygonToken _tokenA, kPolygonToken _tokenB, uint256 _amount) internal returns(bool)
    {
