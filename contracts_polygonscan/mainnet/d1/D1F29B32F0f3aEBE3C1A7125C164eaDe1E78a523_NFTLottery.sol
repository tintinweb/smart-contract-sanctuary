...
contract NFTLottery is VRFConsumerBase, IERC777Recipient {
    ...
    uint256 public constant MAX_WINNING_NUMBER = 9999;
    ...
    mapping(uint256 => bytes) public lotteryGameIDs;
    ...
    event TicketPurchased(address purchaser);
        ...
        )
    {
        ...
        nftMinter = ArtisLifeNFT(0xa79dF500990cBEf47c4b0b7B8c70666bd2fe389b);
    }
    ...
    */
    function tokensReceived(
        ...
        totalTicketsPurchased = totalTicketsPurchased.add(1);
        emit TicketPurchased(from);
    }

    function buyTickets(uint256 amount) external {
        uint256 totalARTIS = ticketFee.mul(amount);
        require(artisToken.balanceOf(msg.sender) > totalARTIS, "Not enough ARTIS.");
        for(uint256 i = 0; i < amount; i++){
            artisToken.operatorSend(msg.sender, address(this), ticketFee, "", "");
        }
    }
    ...
    function createNewLotteryGame(
        ...
        lotteryGameIDs[nftId] = lotteryGameID;
    ...
    /**
     * Callback function used by VRF Coordinator 0 to 9999
     */
    ...
    function redeemTicket(bytes calldata lotteryGameID, uint256 number)
        ...
        lotteryExists(lotteryGameID)
    {
        require(lotteryGames[lotteryGameID].ticketEntries[number] == address(0), "Ticket numbers have already been bought.");
        require(lotteryGames[lotteryGameID].newEntryAllowed == true, "No new entries allowed.");
        require(
