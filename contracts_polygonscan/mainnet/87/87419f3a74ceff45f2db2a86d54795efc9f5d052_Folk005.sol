...
contract Folk005 is ERC721Enumerable, ReentrancyGuard, Ownable {
...
//                output = string(abi.encodePacked('"', name[0], ' ', name[1], '" ', output, " +1"));
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Folk005:', toString(tokenId), '", "description": "Folk generates random people you might meet on an adventure", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("Folk005", "FOLK005") Ownable() {}
}
