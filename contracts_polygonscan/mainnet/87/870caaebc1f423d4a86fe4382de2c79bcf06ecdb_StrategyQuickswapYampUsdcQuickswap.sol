...
// File: Vault\StrategyQuickswapYampUsdcQuickswap.sol

contract StrategyQuickswapYampUsdcQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x0087f654c4b347230c60cad8d7ea9cf0d7238bcc79)];
        ...
        token1ToEarnedPath = [address(0x0087f654c4b347230c60cad8d7ea9cf0d7238bcc79), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0087f654c4b347230c60cad8d7ea9cf0d7238bcc79)];
    }
