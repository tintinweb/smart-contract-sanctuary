...
// File: Vault\StrategyBarbershopSingMaticApeswap.sol

// openzeppelin v3.1.0

contract StrategyBarbershopSingMaticApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
        token1ToEarnedPath = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
    }
