...
contract Emus is Ownable, ERC721, ERC721URIStorage, ERC721Burnable, AccessControl
{
	using Counters for Counters.Counter;
	bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
	Counters.Counter private _tokenIdCounter;

	constructor() ERC721("Emus", "EMUS")
	{
	...
	function safeMint(address to, uint256 tokenId, string memory _tokenURI) public
	{
		...
		require(tokenId <= _tokenIdCounter.current(), "TokenId Error: Not Found");
