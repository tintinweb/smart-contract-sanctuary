...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MAKER = IBEP20(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x74728398CB4BF9e797219573dBb0aDdF7509679A);
        _token = msg.sender;
    }
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amountUSDC = USDC.balanceOf(address(this)).sub(balanceBeforeUSDC);

        totalDividends = totalDividends.add(amountUSDC);
        dividendsPerShare = dividendsPerShare.add(dividendsPerShareAccuracyFactor.mul(amountUSDC).div(totalShares));
...
contract BigMonkey is IBEP20, Auth {
    using SafeMath for uint256;

    address MAKER = 0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063;
    address MATIC = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
	address USDC = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BigMonkey";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x74728398CB4BF9e797219573dBb0aDdF7509679A);
