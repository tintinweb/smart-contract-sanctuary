...
contract ShogunPool 
{
    ...
    address private _maiTokenAddress = 0xa3Fa99A148fA48D14Ed51d610c367C61876997F1;
    ...
    constructor()
    {
        ...
        _maiToken        = MaiToken(_maiTokenAddress);
        ...
        _maticMaiPair   = [_maticTokenAddress, _maiTokenAddress];
    }
    ...
    {
        return _maiToken.balanceOf(address(this));
    }
    ...
    function updateRewardsFund() private
    {
        ...
        if (elapsedBlocks > _updateCooldownBlocks)
        {
            ...
            address[] memory maticMaiPairMemory = _maticMaiPair;
            ...
            if (amount > 0)
            {
                ...
                _quickSwapRouter.swapExactTokensForTokens(amount, 0, maticMaiPairMemory, address(this), block.timestamp + _swapWaitingSeconds);
            }
    ...
    function harvest() public 
    {
        ...
        _maiToken.transfer(msg.sender, userReward);
    }
