...
contract CommunityMasterChef is Ownable, ReentrancyGuard {
    ...
    function deposit(
        ...
        if (_amount > 0) {
            ...
            if (address(pool.lpToken) == address(ws)) {
                uint256 transferTax =
                    _amount.mul(ws.transferTaxRate()).div(10000);
