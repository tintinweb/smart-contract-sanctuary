...
contract TeamToken is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TeamToken", "TeamTN") {
        MATICRewardsFee = 0;
        liquidityFee = 2;
        extraFeeOnSell = 0; // extra fee on sell
        TreasuryFee = 3;
        TreasuryWallet = payable(0xD109fc566401ca57445810b9A3C187876cf44544);
