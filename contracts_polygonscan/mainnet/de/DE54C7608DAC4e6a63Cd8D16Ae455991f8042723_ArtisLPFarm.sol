...
contract ArtisLPFarm is IERC777Recipient {
    ...
    constructor() {
        lpToken = IERC20(0x043bE24BC5b206941Ff7DD770C8d3DFB6f7045C6);
    ...
    */
    ...
    function tokensReceived(
        ...
        require(amount > 0, "You cannot add zero tokens");
    ...
    function collectYield(address staker) public {
        require(
            stakers[staker].isStaking =
                true &&
                stakers[staker].artisBalance > 0,
        ...
        uint256 yield = calculateYieldTotal(staker);
        stakers[staker].startTime = block.timestamp;
        artisToken.send(staker, yield, "Yield Collected.");
        totalARTISRewards = totalARTISRewards.sub(yield);
    }
