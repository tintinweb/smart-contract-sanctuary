...
contract Shards is ERC1155, Ownable {
    ...
    constructor() ERC1155("ipfs://QmP2ARYVB5ZDhNSXLkcLq1gdYzsr8Pg9hGwfekhbLobgHV") {}
    ...
    function mint(uint256 numNfts) external payable whenPublicSaleActive {
        ...
        require(numNfts > 9 && numNfts < 1001, "Must mint at least ten Shards and less than 1000 Shards per transaction");
