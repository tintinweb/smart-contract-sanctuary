...
contract PearAutoCompoundSolo is Ownable, Pausable {
    ...
    uint256 internal masterchefPID = 0; //TODO PID = 2 for Polygon PEAR Masterchef
    address internal referrer = 0xa44A89fA2b31eb689036b0180295DF8b478Ae83f; //TODO tester si déjà un referrer en place...
    ...
    function deposit(uint256 _amount) external whenNotPaused notContract {
        ...
        //TODO add the pear tax into the calculation
    ...
    function harvest() external notContract whenNotPaused {
        //IMasterChef(masterchef).withdraw(2, 0); //TODO clean up
        //Call the deposit harvest tokens to this contract
        IMasterChef(masterchef).deposit(masterchefPID, 0, referrer); //TODO need test
     ...
     * @dev It includes tokens held by the contract and held in MasterChef
     */
    function pendingPerUser(address _userAddress) public view returns (uint256) {
