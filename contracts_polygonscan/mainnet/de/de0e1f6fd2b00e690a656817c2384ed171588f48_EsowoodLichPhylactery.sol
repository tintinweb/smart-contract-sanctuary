...
contract EsowoodLichPhylactery is ERC20, ERC20Burnable, Ownable, ERC20FlashMint {
    constructor() ERC20("Esowood Lich Phylactery ", "ELP") {
        _mint(msg.sender, 18900 * 10 ** decimals());
    }
