...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 4000e18;
    ...
    function initialSetup() internal {
        ...
        uniswapRouterV2 = IUniswapV2Router02(address(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff));
        uniswapFactory = IUniswapV2Factory(address(0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32));
        ...
        returns (uint256)
    {
        ...
        console.log("0.02 days since start is", contractStartTimestamp.add(0.02 days), "Time now is", block.timestamp);
        return contractStartTimestamp.add(0.02 days).sub(block.timestamp);
    }
    ...
    {
        console.log("0.02 days since start is", contractStartTimestamp.add(0.02 days), "Time now is", block.timestamp);
        console.log("liquidity generation ongoing", contractStartTimestamp.add(0.02 days) < block.timestamp);
        return contractStartTimestamp.add(0.02 days) > block.timestamp;
    }
    ...
    function addLiquidityToUniswapTESTxWETHPair() public {
        require(liquidityGenerationOngoing() == false, "TEST LGE ongoing");
        require(LPGenerationCompleted == false, "TEST LGE already finished");
    ...
    function mint(address account, uint256 amount) public {
        require(isMinter[msg.sender], "not a minter TEST");
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                ITestVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
contract TEST is NBUNIERC20 {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying TEST tokens (not scaled);
