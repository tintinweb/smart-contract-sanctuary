...
contract Game is Ownable, ReentrancyGuard {
    ...
    // Dev address.
    address public feeaddr = 0x31fB16419e710603D45DfB8aCAFdF651d8aa71Bd;
    ...
    event GameEvent(address indexed user,uint256 _inputAmt, uint256 winNumber);
    ...
    function playGame(uint256 _inputAmt) public {
        require(multiplier > 0, "sellYourToken: No more Selling");
        
        uint256 tokenBal = IERC20(receiveToken).balanceOf(address(this));
        
        uint256 winAmount = tokenBal.mul(100).div(80);
        
        uint256 winNumber = 0;
        
        require(tokenBal >= winAmount, "sellYourToken: Not enough Token left to buy");
        ...
        emit GameEvent(msg.sender, _inputAmt, winNumber);
    }
}