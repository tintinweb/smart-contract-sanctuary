...
contract Lisserts is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmXM9ATg8qpCQJHYsVxZpzzqSJgq9nrdSexXUcehwhLYP7/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 2.8 ether;
  uint256 public maxSupply = 2288;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = false;
  bool public revealed = true;

  constructor() ERC721("Lisserts", "LST") {
    setHiddenMetadataUri("ipfs://Qma5yb55cwGnEndpDQ2LkwzC8zm8Dee7QxUz9k7oz5cSWy/hidden.json");
  }
