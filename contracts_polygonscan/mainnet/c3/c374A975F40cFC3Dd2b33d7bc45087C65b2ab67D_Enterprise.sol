...
// File: contracts/token/BEP20/Enterprise.sol
...
/**
 * @title Enterprise
 * @dev Implementation of the Enterprise
 */
contract Enterprise is BEP20Mintable, BEP20Burnable, ServicePayer {
    ...
    constructor (
      ...
      BEP20(name, symbol)
      ServicePayer(feeReceiver, "Enterprise")
      payable
    {
