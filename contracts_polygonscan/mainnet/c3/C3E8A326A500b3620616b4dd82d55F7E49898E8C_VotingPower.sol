...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant rewardAddress = 0x44A49b6586318cE0611FE8B6b72Ad1Ab02Ad5CB7;
    ...
    function deposit(address _userAddress, uint256 _wantAmt) external onlyOwner nonReentrant whenNotPaused returns (uint256) {
        ...
        uint256 wantAdded = wantLockedTotal().sub(wantLockedBefore);
        
         uint256 depositFee = wantAdded
...
contract VotingPower is Ownable, Operators{
    address public constant usdcAddress = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address public constant vertexAddress = 0x72572CCf5208b59f4BcC14e6653d8c31Cd1fC5a0;
    address public constant vertexUsdcLPAddress = 0x668269d6E5D2c2dE31D132Ac218044211643622B;
    address public constant vaultChefAddress = 0xFA9aA5d14319ac678E2B3fa65FBBbc4b27690D37;
    ...
    function setLPVotingPowerModifier(uint16 _mod) public onlyOperator{
        lpVotingPowerModifier = _mod;
    }
    
    
    function setUseUSDC(bool _use) public onlyOperator{
         useUSDCForVotingPower = _use;
    }
    
     
    function setVertLPs(address[] calldata _vertLPs) public onlyOperator{
         vertLPs = _vertLPs;
    }
