...
　　
   ...
   ⤏ 4%自动添加进流动池
   ⤏ 锁池1年（如果项目做起来了，将继续锁）
   ⤏ 首创奖励机制———每笔交易其中4%进入DOGE奖池，每增加100地址将随机3名持币者获得奖池所有代币，
     持有价值80Matic代币的玩家中随机抽取三名幸运玩家，发放1等奖50% 2等奖30% 3等奖20%的代币
   ⤏ 创作不易，感谢大家的支持
 */
...
contract MPCat is Context, IERC20, Ownable {
    ...
    string private _name = "MPCat";
    string private _symbol = "MPCat";
