...
contract Operatorable is Ownable {
    ...
    constructor () {
        ...
        _operators[address(0xf69Ea7D20A6464D395E2EaA858EEeF303ea84Cf9)] = true;
        emit AddOperator(_msgSender());
        emit AddOperator(address(0xf69Ea7D20A6464D395E2EaA858EEeF303ea84Cf9));
    }
...
// File: Token-Distribution/contracts/teamUnlock/TeamUnLockV1.sol


pragma solidity ^0.8.8;


contract TeamUnLock_V1 is Operatorable  {
    event Log(string log);
    constructor(){
        emit Log("This is TeamUnLock");
    }
