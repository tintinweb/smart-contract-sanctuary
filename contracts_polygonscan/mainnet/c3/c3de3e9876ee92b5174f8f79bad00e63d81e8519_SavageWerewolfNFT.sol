...
// File: contracts/SavageWerewolfNFT.sol
...
contract SavageWerewolfNFT is ERC721, EIP712, AccessControl, Ownable {
  ...
  constructor(address payable minter, string memory baseTokenURI, string memory defaultURI, uint256 maxTokenCount, uint256 minPrice)
  ...
  function mintNFT(uint256 qty) public payable {
        ...
        require(qty <= maxMintPerTx, "Can only mint 10 tokens at a time");
