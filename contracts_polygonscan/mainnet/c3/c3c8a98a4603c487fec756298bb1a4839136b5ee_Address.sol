...
// File contracts/mdex/IMdexFactory.sol
...
// File contracts/mdex/IMdexPair.sol
...
// File contracts/mdex/IMdexRouter.sol
...
// File contracts/BirdToken.sol

pragma solidity ^0.6.0;



contract babycattleToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80000000 * 10 ** 10 * 10 ** 18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "babycattle";
    string private _symbol = "babycattle";
    ...
    uint256 public _managementFee = 4;
    ...
    uint256 public _maxTxAmount = 80000000 * 10 ** 10 * 10 ** 18;
    uint256 private numTokensSellToAddToLiquidity = 80000000 * 10 ** 10 * 10 ** 18;
