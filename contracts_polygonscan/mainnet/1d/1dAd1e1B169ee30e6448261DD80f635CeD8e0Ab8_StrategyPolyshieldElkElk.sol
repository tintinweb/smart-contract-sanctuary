...
// File: Vault\StrategyPolyshieldElkElk.sol

// openzeppelin v3.1.0

contract StrategyPolyshieldElkElk is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00e1c110e1b1b4a1ded0caf3e42bfbdbb7b5d7ce1c)];
        wantToEarnedPath = [address(0x00e1c110e1b1b4a1ded0caf3e42bfbdbb7b5d7ce1c), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00f239e69ce434c7fb408b05a0da416b14917d934e)];
    }
