...
/// @notice Brief interface for Mochi/Moloch DAO v2. 
interface IMochiMolMinimal { 
...
contract SuChef is ReentrancyGuard {
    ...
    IMochiMolMinimal public mochiMol; // parent 
    ...
    function init(address _depositToken, IMochiMolMinimal _mochiMol) external {
