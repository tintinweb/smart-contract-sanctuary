...
contract SOFIProxy is Ownable {
    ...
    /**
     * Trade for token By send exact ETH (msg.value)
     * @return The amount of output tokens
     */
    ...
    /**
     * Trade for ETH By send exact Token
     * @return The amount of output ETH
     */
    ...
    /**
     * Trade for tokenOut By send exact tokenIn
     * @return The amount of output tokenOut
     */
    ...
    /**
     * Trade for exact tokenOut By send Max tokenIn
     * @return The spent amount of tokenIn
     */
    ...
    /**
     * Returns the pair address for router on uni style DEX.
     *
     * @param _router   The uni v2 router
