...
//   - all 10,000 ApePanda On Chain are unique
...
// Bring on the ApePanda On Chain!
contract ApePandaOnChain is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] private z = ['<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 500 500"><rect x="0" y="0" width="500" height="500" style="fill:#',
    '"/><rect width="300" height="120" x="99" y="400" rx="15" style="filter:drop-shadow(3px 4px 4px rgb(0 0 0 / 0.3));fill:#', '"/><circle cx="190" cy="470" r="5" style="fill:#', '"/><circle cx="310" cy="470" r="5" style="fill:#',
    '"/><circle cx="100" cy="150" r="75" style="filter:drop-shadow(3px 4px 4px rgb(0 0 0 / 0.3));fill:#', '"/><circle cx="100" cy="150" r="40" style="fill:#', '"/><circle cx="400" cy="150" r="75" style="filter:drop-shadow(3px 4px 4px rgb(0 0 0 / 0.3));fill:#',
    '"/><circle cx="400" cy="150" r="40" style="fill:#', '"/><circle cx="250" cy="250" r="150" style="fill:#', '"/><circle cx="250" cy="250" r="120" style="fill:#',
    '"/><circle cx="200" cy="215" r="35" style="fill:#000"/><circle cx="305" cy="222" r="31" style="fill:#000"/><circle cx="200" cy="220" r="20" style="fill:#',
    '"/><circle cx="300" cy="220" r="20" style="fill:#', '"/><circle cx="200" cy="220" r="7" style="fill:#000"/><circle cx="300" cy="220" r="7" style="fill:#000"/>',
    '<ellipse cx="250" cy="315" rx="94" ry="64" style="fill:#',
    ...
    '</svg>'];
  string private cross='<rect x="95" y="195" width="10" height="40" style="fill:#872"/><rect x="85" y="205" width="30" height="10" style="fill:#872"/>';
  string private clo1='<rect width="300" height="120" x="99" y="400" rx="15" style="fill:#';
  string private clo2='"/><rect width="50" height="55" x="280" y="430" style="fill:#';
  string private hh1='<rect width="200" height="99" x="150" y="40" rx="40" style="fill:#';
  ...
  string private zz='"/>';
  string private ea1='<circle cx="100" cy="220" r="14" style="fill:#';
  string private ea2='fe7';
  string private ea3='999';
  string private ea4='"/><circle cx="100" cy="220" r="4" style="fill:#000"/>';
  string private ea5='<circle cx="100" cy="220" r="12" style="fill:#';
  ...
  string private co1=', ';
  string private rl1='{"name": "ApePanda On Chain #';
  string private rl3='"}';
  string private rl4='data:application/json;base64,';

  struct Ape { // a nod to BAYC, "ape" was shorter to type than ApePanda
    uint8 bg;
    uint8 fur;
    uint8 eyes;
    uint8 mouth;
  ...
  constructor() ERC721("ApePandaOnChain", "APOC") Ownable() {}
}