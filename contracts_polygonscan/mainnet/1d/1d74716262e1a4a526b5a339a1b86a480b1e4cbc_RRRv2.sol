...
contract RRRv2 is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    string public PROVENANCE;
    uint256 public MAX_TOKENS = 2333;

    string private _baseURIextended;

    constructor(

    ) ERC721("Rogue_Rabbits_Rarrible_V2", "RRRv2") {
    ...
    function reserveTokens() public onlyOwner {
        ...
        uint i;
        for (i = 0; i < 10; i++) {
            _safeMint(msg.sender, supply + i + 1000);
        }
    }
    ...
    function mintToken(uint numberOfTokens) public payable {
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                _safeMint(msg.sender, mintIndex + 1000);
            }
        }
    }
