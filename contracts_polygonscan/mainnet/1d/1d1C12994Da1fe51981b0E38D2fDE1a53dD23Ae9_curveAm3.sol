  ...
  constructor(uint256 total) {  
    ...
    external returns (bool) {
     ...
     function BountyCompound(address hunter, uint256 minAmount1, uint256 minAmount2, uint256 minLP1) external returns (bool){
         ...
         Balances2 =[0,0,0];
      IcurveReserves(crvSwapperReserves).remove_liquidity(IERC20(originalCurveLP).balanceOf(address(this)),Balances2,true);
    ...
    external returns (bool) {
        ...
        IcurveGauge(RELEVANTLP).withdraw(LPtoWithdraw,true);
