...
//SVG Traits Code, Inserted Into SVG Code During Assembly
    ...
    function assembleShark01(uint256 tokenId) internal view returns(string memory) {
    ...
    function assembleShark02(uint256 tokenId) internal view returns(string memory) {
       uint256[10] memory finalDNA = coordinatorContract.getFinalDNA(tokenId);
       require(finalDNA[0] < 99);
