...
// File: contracts/HueComboes.sol

pragma solidity ^0.8.0;



contract HueComboes is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public headStart = block.timestamp + 22 days;
  ...
  function mint() public payable {
    ...
    if(supply > 0) {
        ...
        giftValue = supply + 1 == maxSupply ? address(this).balance * 20 / 100 : msg.value * 80 / 100;
    }
