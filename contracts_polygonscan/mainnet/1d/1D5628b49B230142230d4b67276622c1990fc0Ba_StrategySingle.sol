...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address[] public gfi_renbtc_path;
        ...
        )
    {
        ...
        gfi_renbtc_path = new address[](4);
        gfi_renbtc_path[0] = gfi;
        gfi_renbtc_path[1] = eth;
        gfi_renbtc_path[2] = btc;
        gfi_renbtc_path[3] = renbtc;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_btc_path, _harvestBalancePost.div(2));

            // Swap 1/2 GFI to renbtc
            uint256 _harvestBalancePost2 = IERC20(rewardToken).balanceOf(address(this));
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_renbtc_path, _harvestBalancePost2);
            ...
            if (_btc > 0 && _renbtc > 0) {
                ...
                IERC20(renbtc).safeApprove(currentRouter, 0);
                IERC20(renbtc).safeApprove(currentRouter, _renbtc);
                ...
                IERC20(renbtc).safeTransfer(
                    strategist,
                    IERC20(renbtc).balanceOf(address(this))
                );
            }
        }
        // Stake the LP tokens
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0x1d89d5d13B182b21f8AA883E4d2C8Fa059ab6CAE;
    address public Want_Token = 0xCDd1aD14b4c156aFF8D833dE1793F67d75237909;
