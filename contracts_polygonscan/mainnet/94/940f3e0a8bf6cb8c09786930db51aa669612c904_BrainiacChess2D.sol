...
contract BrainiacChess2D is ERC721Enumerable, Ownable, ContextMixin, NativeMetaTransaction {
  using Strings for uint256;
  ...
  uint256 public cost = 120 ether;
  uint256 public maxSupply = 3000;
  uint256 public maxMintAmount = 10;
  bool public paused = false;
  address public payments = _msgSender();
  //royalty details
   uint256 public constant ROYALTY_FEE_DENOMINATOR = 100000;
   uint256 public royaltyFee;
   address public royaltyWallet = _msgSender();
