...
// File: contracts\Oracle\IDigitalaxMonaOracle.sol
...
// File: contracts\Oracle\DigitalaxMonaOracle.sol
...
/**
 * @title Digitalax W3F Oracle
 *
 * @notice Provides a value onchain that's aggregated from a whitelisted set of
 *         providers.
 */
contract DigitalaxW3FOracle is IDigitalaxMonaOracle, Context {
    using SafeMath for uint256;
    ...
    */
    constructor(uint256 reportExpirationTimeSec_,
        ...
        public
    {
        require(reportExpirationTimeSec_ <= MAX_REPORT_EXPIRATION_TIME, "DigitalaxW3FOracle: Invalid report exipiration time");
        require(minimumProviders_ > 0, "DigitalaxW3FOracle: Minimum providers count might be greater than zero");
        require(address(accessControls_) != address(0x0), "DigitalaxW3FOracle: AccessControls is invalid");
    ...
    function setReportExpirationTimeSec(uint256 reportExpirationTimeSec_) external
    {
        require(
            ...
            "DigitalaxW3FOracle.setReportExpirationTimeSec: Sender must be admin"
        );
        require(reportExpirationTimeSec_ <= MAX_REPORT_EXPIRATION_TIME, "DigitalaxW3FOracle.setReportExpirationTimeSec: Invalid expiration time");
        reportExpirationTimeSec = reportExpirationTimeSec_;
    }
    ...
    */
    function setReportDelaySec(uint256 reportDelaySec_) external
    {
        require(
            accessControls.hasAdminRole(_msgSender()),
            "DigitalaxW3FOracle.setReportDelaySec: Sender must be admin"
        );
        reportDelaySec = reportDelaySec_;
    }
    ...
    */
    function setMinimumProviders(uint256 minimumProviders_) external
    {
        require(
            accessControls.hasAdminRole(_msgSender()),
            "DigitalaxW3FOracle.setMinimumProviders: Sender must be admin"
        );
    ...
    */
    ...
    function addProvider(address provider) external
    {
        require(
            accessControls.hasAdminRole(_msgSender()),
            "DigitalaxW3FOracle.addProvider: Sender must be admin"
        );
    ...
    function removeProvider(address provider) external
    {
        require(
            accessControls.hasAdminRole(_msgSender()),
            "DigitalaxW3FOracle.removeProvider: Sender must be admin"
        );
