...
contract NoselessEmojis is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Noseless Emojis", "Noseless") {
    setBaseURI("ipfs://QmWz1NcJh1uTxZBXX5NxoCXnDzGwc2sT2fo2nzoMQiB9pi");
