...
contract StratManager is Ownable, Pausable {
    ...
    /**
     * @dev Updates krillFee fee recipient.
...
contract StrategyAaveAave is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        ...
        uint256 krillFeeAmount = wmaticFeeBal.mul(krillFee).div(MAX_FEE);
        IERC20(wmatic).safeTransfer(krillFeeRecipient, krillFeeAmount);
