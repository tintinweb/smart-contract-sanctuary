...
contract TShare is ERC20Burnable, Operator {
    ...
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 600000 ether; //600k nshares
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 100000 ether; //100k nshares
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 300000 ether; //300k nshares
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("NSHARE", "NSHARE") {
        ...
        communityFundRewardRate = COMMUNITY_FUND_POOL_ALLOCATION.div(VESTING_DURATION); //tshares/second
