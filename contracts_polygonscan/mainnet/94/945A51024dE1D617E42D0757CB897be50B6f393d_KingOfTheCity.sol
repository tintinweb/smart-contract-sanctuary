...
contract KingOfTheCity is Ownable, ReentrancyGuard {
    ...
    function participate(uint256 amount) public nonReentrant notContract() {
        ...
        if (currentBidAmount < bidAmount) {
            ...
            require(amount >= (currentBidAmount * 110) / 100, 'amount must be at least 10 porcent more than bidAmount');
            currentBidAmount = (currentBidAmount * 110) / 100;
        }
    ...
    function setCoolDownTime(uint256 _coolDownTime) public onlyOwner {
        require(_coolDownTime >= 0, 'Should be valid');
    ...
    function setNextStartTime(uint256 _nextStartTime) public onlyOwner {
        require(_nextStartTime >= 0, 'Should be valid');
