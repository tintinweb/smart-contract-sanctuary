    ...
    EIP712BaseUpgradeable
{
    ...
    function __EIP712MetaTransaction_init(
        ...
        __EIP712Base_init(_name, _version, _chainId);
    }
    ...
    EIP712MetaTransactionUpgradeable
{
    ...
    function initialize(
        ...
        __ERC721_init("Schroot", "SCH");
        __ERC721Enumerable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        __EIP712MetaTransaction_init("SchrootLoot", "1", 137);
    ...
    function ownerMint(uint256 _count) external onlyOwner {
        ...
        _mintToken(treasury, _count);
    }

    /**
     * @dev User mint
     */
    function userMint(uint256 _count) external {
        require(
        ...
        require(
            ...
            "Can not mint more than alloted"
        );
