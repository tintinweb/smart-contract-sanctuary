...
contract Test is Ownable {
  ...
  function deployAureus(
    ...
    rwdToken = new TestToken(_name, _symbol, _cap);
...
contract AerariumSanctius is Ownable {
  ...
  TestToken public immutable rwdToken;
...
import './v1/AerariumSanctius.sol';
import './v1/TestToken.sol';
import './v1/Test.sol';