...
contract BorpaDAO is Ownable, ERC721Borp, ReentrancyGuard {
    ...
    uint256 public constant amountForFree = 501;
    uint256 public constant priceAfterFree = .035 ether;
    ...
    ) ERC721Borp("BDAO", "BDAO", collectionSize_, maxBatchSize_ ) {
        amountForSale = collectionSize_ - 1;
