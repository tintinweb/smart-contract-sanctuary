...
contract EmployeeDeployer is Initializable, AccessControl {
    ...
    uint8 public constant NFT_STAKE_FEE = 5;
    uint8 public constant PLAY_TO_EARN_FEE = 89;
    uint8 public constant EMPLOYEE_POOL_FEE = 1;

    uint256 public employeePrice = 10000000000000000000000 wei;
    uint16 public deployments = 0;
    ...
    function setMaxDeployments(uint16 max) public onlyRole(MAIN_OWNER) {
        maxDeployments = max;
    }
    ...
    function mintEmployee(uint8 employeeType) public {
        require(deployments <= maxDeployments, INVALID_DEPLOYMENT);
