...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 THEEND = IBEP20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = THEEND.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(THEEND);

        router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(0,path,address(this),block.timestamp);

        uint256 amount = THEEND.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            THEEND.transfer(shareholder, amount);
...
contract miniTHEEND is IBEP20, Auth {
    using SafeMath for uint256;

    address THEEND   = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address WBNB     = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address DEAD     = 0x000000000000000000000000000000000000dEaD;
    address ZERO     = 0x0000000000000000000000000000000000000000;

    string constant _name = "miniTHEEND";
    string constant _symbol = "MINI";
    uint8 constant _decimals = 9;
    uint public sellPerSecond = 30;
    uint public buyPerSecond = 30;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 50; // 2000
    ...
    constructor () Auth(msg.sender) {
        ...
        address _development = 0x966B5094Dfc94c4102F6db5639ac7243524D238e;
        isFeeExempt[_development] = true;
        isTxLimitExempt[_development] = true;
        ...
        _balances[_development] = _totalSupply;
        emit Transfer(address(0), _development, _totalSupply);
    }
