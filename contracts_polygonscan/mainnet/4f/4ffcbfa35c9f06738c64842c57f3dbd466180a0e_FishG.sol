...
contract FishG is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;

    uint256 public constant MAX_TOKENS = 10102;
    
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 10;

    uint256 public price = 4000000000000000000; // 4 MATIC
    
    bool public isSaleActive = true;
 
    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Fish Gs NFT", "FISH") {}
