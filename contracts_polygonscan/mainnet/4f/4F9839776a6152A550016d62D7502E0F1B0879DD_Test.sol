...
contract QuickSwapTrader {
    ...
    function _approveSpending(address _tokenAddress) private
    {
        ...
        address quickswapV2Router02Address = address(quickswapV2Router02);

        bool succeeded = token.approve(quickswapV2Router02Address, MAX_INT);

        tokens[_tokenAddress].token = token;
