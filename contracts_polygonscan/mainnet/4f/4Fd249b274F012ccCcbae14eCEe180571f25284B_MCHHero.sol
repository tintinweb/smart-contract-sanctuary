...
// File contracts2/MCHHero.sol

pragma solidity 0.8.3;



contract MCHHero is ERC721Mintable, ERC721ApprovalProxy, Ownable {

    string public baseURI;

    constructor(address _approvalProxy) ERC721ApprovalProxy(_approvalProxy) ERC721("MyCryptoHeroes:Hero", "MCHH") {
        super.setApprovalProxy(_approvalProxy);
        setBaseURI("https://www.mycryptoheroes.net/metadata/hero/");
    }
