...
// File: Vault\StrategyPearzapPearWault.sol

// openzeppelin v3.1.0

contract StrategyPearzapPearWault is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
        wantToEarnedPath = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
    }
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 amount, , , , ) = IPearzap(masterChef).userInfo(pid, address(this));
        return amount;
    }
}