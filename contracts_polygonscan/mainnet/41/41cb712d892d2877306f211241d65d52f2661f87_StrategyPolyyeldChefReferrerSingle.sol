...
// File contracts/BIFI/interfaces/polyyeld/IxYeldMasterChef.sol
...
contract StratManager is Ownable, Pausable {
    ...
    // checks that caller is strategist.
...
// File contracts/BIFI/strategies/Polyyeld/StrategyPolyyeldChefReferrerSingle.sol
...
contract StrategyPolyyeldChefReferrerSingle is StratManager, FeeManager {
    ...
    // Not passing through constructor or will get `Variable headStart is 1 slot(s) too deep inside the stack.`
    function setReferrer(address _referrer) external onlyStrategist {
        referrer = _referrer;
    }
}