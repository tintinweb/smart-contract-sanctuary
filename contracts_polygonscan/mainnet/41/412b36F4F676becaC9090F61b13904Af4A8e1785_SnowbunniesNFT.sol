...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tokenId.toString(), "%29.json")) : "";
    }
...
contract SnowbunniesNFT is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 public limit = 5372;
    ...
    constructor(string memory baseURI, address _fundWallet) ERC721("SnowbunniesNFT", "SB") {
        setBaseURI(baseURI);
    ...
    function withdraw() public payable onlyOwner {
        ...
        payable(fundWallet).transfer(_p1);
    }
}