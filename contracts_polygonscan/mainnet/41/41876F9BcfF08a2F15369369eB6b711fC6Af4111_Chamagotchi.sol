...
contract Chamagotchi is IERC721, Functional, Proxy {
    ...
    constructor() {
        _name = "Chamagotchis";
        _symbol = "CGV";
        _baseURI = "http://chameleoncollective.io:8080/metadata2/";
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Chamagotchi.onERC721Received.selector;
    }
    ...
    function airDrop(address[] memory _to) external proxyAccess {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory){
        ...
        //http://chameleoncollective.io:8080/metadata2/54/54.json
        tokenuri = string(abi.encodePacked(_baseURI, toString(tokenId), "/", toString(tokenId), ".json"));
