...
// hevm: flattened sources of src/Layer3USDC.sol
...
contract Layer3USDC is ERC20, Ownable {
    uint256 private faucetMaxAmount;
    mapping(address => bool) isMinted;

    constructor() ERC20("Layer3 USDC Faucet", "USDC") {
        faucetMaxAmount = 100000 * 1e6; // 100K USDC per user
    }
