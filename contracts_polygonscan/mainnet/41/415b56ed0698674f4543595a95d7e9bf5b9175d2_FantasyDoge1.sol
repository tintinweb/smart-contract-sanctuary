...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
...
contract FantasyDoge1 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address Factory = 0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "1Fantasy Doge";
    string constant _symbol = "1FTD";
    ...
    constructor () Auth(msg.sender) {
        ...
        pair = IDEXFactory(Factory).createPair(WBNB, address(this));
        ...
        marketingFeeReceiver = 0x930ab18E8e65779bcB4b250A764c624DA1F02216;
        teamFeeReceiver = 0xB68A60BA690a9dBf09DA86Bd313b84A5FAc3902f;
