...
contract ifToken is ERC20, ERC20Detailed {
    ...
    function addPool(address _LP, uint8 _points) public onlyTreasury() {
    ...
    function updatePool(uint8 _pool, uint8 _points) public onlyOperator() {
        points[_pool] = _points;
        emit UpdatePool(_pool, _points);
    }

    function updateDrag(uint8 _drag) public onlyTreasury() {
        require(_drag>1, "updateDrag: invalid value.");
        drag=_drag;
    }

    function updatePush(uint8 _push) public onlyTreasury() {
