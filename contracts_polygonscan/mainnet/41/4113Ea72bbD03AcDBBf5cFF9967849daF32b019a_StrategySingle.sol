...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function balanceOfPool() public override view returns (uint256) {
        return IMasterChef(rewards).stakedWantTokens(poolId, address(this));
        //return IMasterChef(rewards).balanceOf(poolId, address(this));
    }

    function getHarvestable() public override view returns (uint256) {
        return IMasterChef(rewards).pendingNATIVE(poolId, address(this));
    }
...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0x5f1657896B38c4761dbc5484473c7A7C845910b6;
    ...
    address public constant pswamp = rewardToken;
    address public constant matic = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;

    address[] public pswamp_matic_path;
    ...
    {
        pswamp_matic_path = new address[](2);
        pswamp_matic_path[0] = pswamp;
        pswamp_matic_path[1] = matic;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            if (performanceFee>0) {
                _swapUniswapWithPath(pswamp_matic_path, performanceFee);
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public PSWAMP_MASTER_CHEF = 0x4F04e540A51013aFb6761ee73D71d2fB1F29af80;
    address public Want_Token = 0x5f1657896B38c4761dbc5484473c7A7C845910b6;
