...
contract XVMCtimeDeposit is Ownable, Pausable {
    ...
    uint256 public immutable withdrawFeePeriod = 180 days; // roughly 6 months
    ...
    address public oldPool = 0xA54c234d231DDa3a907B22A18b494a5652B6D4f7; //old pool we can migrate from
    ...
    address public distributionAddress = 0xeF9c9E9F94c3BBf5AAaD591E99111ab6F2668F42;
    ...
    function hopDeposit(uint256 _amount, address _recipientAddress, uint256 previousLastDepositedTime) external whenNotPaused {
        require(msg.sender == trustedSender1
                || msg.sender == trustedSender2 || msg.sender == oldPool,
