...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address[] public matic_banana_path;
        ...
        )
    {
        ...
        matic_banana_path = new address[](2);
        matic_banana_path[0] = matic;
        matic_banana_path[1] = banana;
    }
    ...
    function harvest() public override {
        ...
        if (_maticBalance > harvestCutoffMatic){
            ...
            _swapUniswapWithPath(matic_banana_path, _maticBalancePost.div(2));

            // Add liquidity for Banana/Matic
            uint256 _banana = IERC20(banana).balanceOf(address(this));
            uint256 _matic = IERC20(matic).balanceOf(address(this));
            if (_banana > 0 && _matic > 0) {
                IERC20(banana).safeApprove(currentRouter, 0);
                IERC20(banana).safeApprove(currentRouter, _banana);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public Banana_Matic_LP = 0x034293F21F1cCE5908BC605CE5850dF2b1059aC0;
