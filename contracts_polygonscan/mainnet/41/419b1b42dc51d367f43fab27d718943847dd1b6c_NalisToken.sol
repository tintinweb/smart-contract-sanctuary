...
contract NalisToken is BEP20 {
     ...
     */
    constructor() public BEP20("FAKE Nalis Token", "FAKENALIS") {
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onlyOperator {
		...
		require(_maxTransferAmountRate >= 1, "NALIS::updateMaxTransferAmountRate: Max transfer amount rate must not be less than 0.01 percents.");
