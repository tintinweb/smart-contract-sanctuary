...
// File: contracts/MasionFinanceToken.sol
...
contract MasionFinance is BEP20('MasionFinance', 'Mafia') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTMafia::transfer: Burn value invalid");
