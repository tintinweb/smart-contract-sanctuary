...
contract Virtual is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**9;       //Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Virtual";                  //Name
    string private _symbol = "VR";                   //Symbol
