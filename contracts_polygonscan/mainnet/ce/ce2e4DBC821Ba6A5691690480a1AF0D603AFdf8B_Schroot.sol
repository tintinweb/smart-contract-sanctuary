...
contract EIP712BaseUpgradeable is Initializable {
    ...
    function __EIP712Base_init(string memory _name, string memory _version)
        internal
        initializer
    {
    ...
    function _setDomainSeperator(string memory _name, string memory _version)
        internal
    {
    ...
    EIP712BaseUpgradeable
{
    ...
    function __EIP712MetaTransaction_init(
        ...
        __EIP712Base_init(_name, _version);
    }
    ...
    EIP712MetaTransactionUpgradeable
{
    ...
    function initialize(string memory _uri) public initializer {
        ...
        __EIP712MetaTransaction_init("Schroot", "1");
        __Ownable_init();
        __ERC721_init("Schroot", "SCHROOT");
    ...
    function _msgSender()
        ...
        returns (address)
    {
        return EIP712MetaTransactionUpgradeable._msgSender();
    }
