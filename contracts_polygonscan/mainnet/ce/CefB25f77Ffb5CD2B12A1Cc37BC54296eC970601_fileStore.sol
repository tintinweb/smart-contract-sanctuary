...
contract fileStore is ERC721URIStorageUpgradeable, owned {
   ...
   constructor()public {
    ...
    /*Add file*/
    function uploadCert(string memory _id, string memory _fileHash, string memory _ownerId, string memory _issuerName, string memory tokenURI) public onlyOwner(){
        _tokenIds.increment();
         uint256 newItemId = _tokenIds.current();
        userFiles[_id].issuerName = _issuerName;
        userFiles[_id].ownerId = _ownerId;
        userFiles[_id].fileHash = _fileHash;
        userFiles[_id].tokenURI = tokenURI;
