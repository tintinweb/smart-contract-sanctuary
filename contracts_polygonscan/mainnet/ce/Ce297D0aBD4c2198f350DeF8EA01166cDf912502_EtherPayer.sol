...
import "../../contracts/payer/DividendPayer.sol";

contract XDividendPayer is DividendPayer {
    constructor() {}

    function x__DividendPayer_init(DividendToken sharesToken_,ERC20Upgradeable paymentToken_) external {
        return super.__DividendPayer_init(sharesToken_,paymentToken_);
    }
    ...
    function x__ReentrancyGuard_init() external {
        return super.__ReentrancyGuard_init();
    }

    function x__ReentrancyGuard_init_unchained() external {
...
import "../../contracts/payer/EtherPayer.sol";

contract XEtherPayer is EtherPayer {
    constructor() {}
