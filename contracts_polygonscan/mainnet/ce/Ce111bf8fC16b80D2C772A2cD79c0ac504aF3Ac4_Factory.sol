    ...
    NativeMetaTransaction
{
    ...
    function deployFarm(
        ...
        uint _startTime;
        uint _endTime;
        (_rewardTokens,_rewardAmount,_startTime,_endTime)=dataDecoder(data);
        ...
        deployedFarmDetails memory details= deployedFarmDetails(strategyClone,_endTime);
    ...
    function dataDecoder(bytes memory data) internal  returns(address [] memory ,uint [] memory,uint,uint){
    ...
    return(_rewardTokens,_rewardAmount,_startTime,_endTime);
    }
