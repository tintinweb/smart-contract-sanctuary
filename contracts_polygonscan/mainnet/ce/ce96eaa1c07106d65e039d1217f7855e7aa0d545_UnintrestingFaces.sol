...
contract UnintrestingFaces is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Unintresting Face", "UF") {
    setHiddenMetadataUri("ipfs://QmWCcee1MrfSjo6wz59maQ48K5TsWFrem6ptUFs6zsTAG7/hidden.json");
  }
