...
contract WorldOfElon is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("World of Elon", "WELON") ERC20Permit("World of Elon") {
        _mint(msg.sender, 131000000000 * 10 ** decimals());
    }
