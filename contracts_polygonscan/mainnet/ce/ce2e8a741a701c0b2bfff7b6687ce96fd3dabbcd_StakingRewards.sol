...
/**
 * https://www.loveboat.exchange
 * LOVE-WETH rewards contract.
*/
...
contract StakingRewardsFactory is Ownable {
    ...
    // LOVE LP token, LOVE LP token's respective rewards contract address
    event RewardsCreated(address stakingToken, address rewardsContract);
    ...
    function deploy(
        ...
        emit RewardsCreated(stakingToken, info.stakingRewards);
    }
