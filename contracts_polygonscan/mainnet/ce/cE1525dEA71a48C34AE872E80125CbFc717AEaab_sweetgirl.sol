...
////];
////
////  string[] private necklaces = ["雾蓝框眼镜","透明框眼镜","隐形眼镜"];
////
...
////    return pluck(tokenId, "WEAPON", necklace);
////  }
////
...
//import "./library/Base64.sol";
//
//contract sweetgirl is ERC721Enumerable, ReentrancyGuard, Ownable {
//
//  string[] private necklace = [
//    " yao suo xiang lian " ,
//    " shi jian xiang lian " ,
//    " ya ke li xiang lian " ,
//    " hu die xiang lian " ,
//    " ding dang xiang lian " ,
//    " bei ke xiang lian " ,
//    " cao mei xiang lian " ,
//    " lou kong li fang xiang lian " ,
//    " yin shi zi xiang lian " ,
//    " pi zhi jing dai " ,
//    " xiao chu ju xiang lian " ,
//    " si dai xiang lian " ,
//    " hai sha xiang lian " ,
//    " xin yuan shi " ,
//    " xiao sui zuan xiang lian " ,
//    " si ye cao diao zhui " ,
//    " xiao ping guo xiang lian " ,
//    " hua cao xiang lian " ,
//    " shui jing diao zhui "
//   ];
//
//  string[] private appendage = [
//    " ai xin qi qiu ",
//    " bei bao ",
//    " xiong xiong wan ou ",
//    " chong wu bei bao ",
...
//];
//
//  string[] private glasses = [" wu lan kuang yan jing " , " tou ming kuang yan jing " , " yin xing yan jing " ];
//
//  string[] private handcatenary = [
//    " hong sheng " ,
//    " si ye cao shou lian " ,
//    " tang guo shou lian " ,
//    " niu you guo shou lian " ,
//    " san duo xiao hua "
//];
//
//
...
//  // Derivatives will call this function to read individual information for each item that
//  // a loot bag has
//  function getAppendage(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "Appendage", appendage);
//  }
//
...
//  }
//
//  function getHandcatenary(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "Handcatenary", handcatenary);
//  }
...
//      } else {
//        output = string(
//          abi.encodePacked('"', name[0], '" ', output, " +1")
//        );
//      }
//    }
//    return output;
...
//    // Then we call the getWeapon function. So the randomization and getting the weapon actually happens
//    // in the read function, not when the NFT is minted
//    parts[1] = getNecklace(tokenId);
//
//    parts[2] = '</text><text x="10" y="40" class="base">';
//
//    parts[3] = getAppendage(tokenId);
//
//    parts[4] = '</text><text x="10" y="60" class="base">';
//
...
//    parts[6] = '</text><text x="10" y="80" class="base">';
//
//    parts[7] = getShoes(tokenId);
//
//    parts[8] = '</text><text x="10" y="100" class="base">';
//
//    parts[9] = getEarring(tokenId);
//
//    parts[10] = '</text><text x="10" y="120" class="base">';
//
...
//    parts[14] = '</text><text x="10" y="160" class="base">';
//
//    parts[15] = getHandcatenary(tokenId);
//
//      parts[16] = '</text><text x="10" y="180" class="base">';
//
//      parts[17] = getStyle(tokenId);
//
//    parts[18] = "</text></svg>";
//
//    // We do it for all and then we combine them.
...
//  }
//
//  constructor() ERC721("sweetgirl", "swgirl") Ownable() {}
//}
//
...
//      // of strings with maximum length of 2
//      string[2] memory name;
//      name[0] = style[rand % style.length];
//      name[1] = nameSuffixes[rand % nameSuffixes.length];
//
//      // Then we give it a name and if greatness is greater than 19, we give it a +1
//      if (greatness == 19) {
...
//      string[] memory _appendage,
//      string[] memory _clothes,
//      string[] memory _shoes,
//      string[] memory _earrings,
//      string[] memory _hat,
//      string[] memory _glasses,
//      string[] memory _handcatenary,
//      string[] memory _style,
//      string[] memory _nameSuffixes
//    ) ERC721("sweetgirl", "swgirl") Ownable() {
//    necklace=_necklace;
...
contract sweetgirl is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    returns (string memory)
  {
    ...
    parts[3] = getGlasses(tokenId);

    parts[4] = '</text><text x="10" y="60" class="base">';

    parts[5] = getEarring(tokenId);
    ...
    parts[9] = getClothes(tokenId);

    parts[10] = '</text><text x="10" y="120" class="base">';

    parts[11] = getHandcatenary(tokenId);

    parts[12] = '</text><text x="10" y="140" class="base">';

    parts[13] = getAppendage(tokenId);

    parts[14] = '</text><text x="10" y="160" class="base">';

    parts[15] = getShoes(tokenId);
...
//      parts[19]
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "Bag #',
            toString(tokenId),
            '", "description": "you can claim to sweetgirl for free if you use chinese to present the image of sweetgirl!!!", "image": "data:image/svg+xml;base64,',
            Base64.encode(bytes(output)),
            '"}'
          )
        )
  ...
  function init(
    ...
    require(set_once>0,"just can set one time!!!");
    necklace=_necklace;
    appendage=_appendage;
    clothes=_clothes;
    shoes=_shoes;
