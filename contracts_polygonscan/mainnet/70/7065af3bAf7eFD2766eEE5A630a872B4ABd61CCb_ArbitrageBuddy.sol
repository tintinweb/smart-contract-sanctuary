...
/// @dev Compare price denominated in quote token between two pools
    ...
    function calcBorrowAmount(OrderedReserves memory reserves) internal pure returns (uint256 amount) {
        ...
        */
        ...
        {
            require(1 < 0, append("maxBitsNeeded >= 256 => maxBitsNeeded: ", uint2str(maxBitsNeeded))); 
        ...
        {
            require(1 < 0, append("bitInfo.bitsNeeded_m >= 256 => bitInfo.bitsNeeded_m: ", uint2str(bitInfo.bitsNeeded_m))); 
