...
// File: StakingRewardsDev.sol

/// @title Development-only version of StakingRewards
contract StakingRewardsDev is StakingRewards, Ownable {
    constructor(address _stakingToken, uint256 _startTime)
        public
        StakingRewards(_stakingToken, _startTime)
        Ownable(msg.sender)
    {}

    /// @notice Development-only function to override timestamps
    /// @dev this will be shifted to the start of this epoch week
