...
contract OTGCentaurs is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public tokenPrice = 0.08 ether;
    address public WETHAddress = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
    uint256 public totalTokensLeft = 15000;
    uint256 public maxTokensPerMint = 5;
    uint256 public maxTokensPerWhitelistedAddress = 30;

    string public tokenBaseURI = "http://www.otgcentaur.com/wp-content/uploads/metadata-v2/";
    ...
    constructor() ERC721("OTG Centaurs", "OTGC") {
