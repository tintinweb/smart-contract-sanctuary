...
contract CPrediction is Ownable, Pausable, ReentrancyGuard {
    ...
    function injectAmount() external payable {}
...
contract CPredictionFactory is Ownable {
    ...
    function provideLiquidity(uint256 _index, uint256 epoch, uint256 bullAmount, uint256 bearAmount) external onlyAdminOrOperator {
