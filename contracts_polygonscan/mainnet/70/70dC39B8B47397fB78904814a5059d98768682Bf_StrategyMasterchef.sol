...
import "./libs/IStrategySandMan.sol";
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant sandManAddress = 0x8566bfe2Fab5a2d1C0Fd59084470f32a24E709A0;
    address public constant rewardAddress = 0x8176cE4CC2fd098c6832beB7a2479B1428201472;
    address public constant withdrawFeeAddress = 0x6D9518bd44fce1ee2EF8d7E3090fBA60304A4ceA;
    address public constant feeAddress = 0xAe35FC2a202678df277B12C2CF6f0DBF46baFa67;
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            // IStrategySandMan(rewardAddress).depositReward(usdcAfter);
