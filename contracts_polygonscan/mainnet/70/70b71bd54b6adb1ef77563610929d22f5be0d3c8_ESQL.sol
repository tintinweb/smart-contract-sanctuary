...
contract ESQL is IERC20, BaseRelayRecipient{
    ...
    */
    ...
    function setTrustedForwarder(address _trustedForwarder) external  {
        require(
            ...
            "ESQL.setTrustedForwarder: Sender must be admin"
        );
    ...
    function setCap(uint _cap, bool _freezeCap) external  {
        require(
            accessControls.hasAdminRole(_msgSender()),
            "ESQL.setCap: Sender must be admin"
        );
    ...
    function setDepositEnabled(bool _depositEnabled) external  {
        require(
            accessControls.hasAdminRole(_msgSender()),
            "ESQL.setDepositEnabled: Sender must be admin"
        );
