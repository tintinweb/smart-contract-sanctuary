...
contract CFOCC is ERC721, ERC721Enumerable, ERC721URIStorage, HasSecondarySaleFees, ContextMixin, Ownable {
    using Strings for uint256;

    string private constant file_type = "data:application/json;base64,";
    string[] private jsonArray = ['{"name": "', '","description": "', '","image": "', '"}'];
    string private constant meta_title = "CryptoNinja Full-On-Chain Catalog #";
    string private constant meta_desc = "Technical fanart of Crypto Ninja NFT.  \\n  \\nOriginal NFT:  \\nhttps://opensea.io/collection/crypto-ninja-nft";

    constructor()
    ERC721("CryptoNinja Full-On-Chain Catalog", "CFOCC")
    ...
    {
        return string(abi.encodePacked(file_type, Base64.encode(abi.encodePacked(jsonArray[0], meta_title, tokenId.toString(), jsonArray[1], meta_desc, jsonArray[2], super.tokenURI(tokenId), jsonArray[3]))));
    }
