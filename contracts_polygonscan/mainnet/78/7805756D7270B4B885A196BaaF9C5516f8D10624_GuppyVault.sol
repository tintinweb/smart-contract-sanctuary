 ...
 */
contract GuppyVault is ERC20, Ownable, ReentrancyGuard {
    ...
    address public depositFeeAddress = address(0xDba2013b7008402007755118925aEB54225FC1ee);
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        want().safeTransfer(
            depositFeeAddress,
            _amount.mul(depositFee).div(1000)
        );
        earn();
    ...
    function withdraw(uint256 _shares) public {
        ...
        if (b < r) {
            ...
            strategy.withdraw(
                _withdraw,
                lastDeposited[msg.sender] + lock > block.timestamp
            );
    ...
    /**
     * @dev Set withdraw lock time
     * @param _lock the new lock time.
     */
    ...
    /**
     * @dev Set deposit fee address
     * @param _depositFeeAddress the new deposit fee address.
     */
    function setDepositFee(address _depositFeeAddress) external onlyOwner {
        depositFeeAddress = _depositFeeAddress;
    }
}
