...
contract PolyLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
        uint256 public mintPriceInWei = 2*10**19;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bag #', toString(tokenId), '", "description": "PolyLoot is randomized adventurer gear generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use PolyLoot in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function claim(uint256 tokenId) public payable nonReentrant {
        ...
        require(msg.value >= mintPriceInWei, "Insufficient ETH balance to mint");
    ...
    constructor() ERC721("PolyLoot", "PLOOT") Ownable() {}
}
