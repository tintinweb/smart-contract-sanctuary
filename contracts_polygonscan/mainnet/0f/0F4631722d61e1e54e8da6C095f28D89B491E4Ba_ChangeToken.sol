...
contract ChangeToken is Ownable, ReentrancyGuard {
    ...
    event SellYourToken(address indexed user,uint256 _inputAmt, uint256 winAmount);
    ...
    function sellYourToken(uint256 _inputAmt) public {
        ...
        uint256 winNumber = (block.timestamp + block.number).mod(6);
        ...
        emit SellYourToken(msg.sender, _inputAmt, winAmount);
    }
}