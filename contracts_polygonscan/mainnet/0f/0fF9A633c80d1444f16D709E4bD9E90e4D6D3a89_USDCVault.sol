...
contract USDCVault is Ownable, Pausable, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    uint256 public seedPoolPid = 9;     // Apple Pool pid in masterchef
    ...
    constructor(
        ...
        // Infinite approve
        IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174).safeApprove(address(_masterchef), uint256(-1));
        IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174).safeApprove(address(msg.sender), uint256(-1));
