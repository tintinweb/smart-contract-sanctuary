...
// File: SpaceSprites.sol

contract SpaceSprites is ERC721 {

    uint256 public count = 0;

    constructor() public ERC721("SpaceSprites", "SPT"){
    }

    function createSpaceSprite() public returns (uint256){
        _safeMint(msg.sender, count);
        _setTokenURI(count, "https://ipfs.io/ipfs/Qmd9MCGtdVz2miNumBHDbvj8bigSgTwnr4SbyH6DNnpWdt?filename=0-PUG.json");
        count++;
        return count-1;
    }
}