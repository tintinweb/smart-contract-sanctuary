...
contract Shop is Ownable, AccessControl, ReentrancyGuard {
    ...
    */ 
     ...
     * @param _vaultItemAddress - Contract address of ItemVault smart contract.
    ...
    */
    ...
    /**
     * @dev Execute when user buys item.
     * Decrease naka from user Balance Vault and increase item amount by its item ID.
     * @param _userAddress - Address of user to buy item.
     * @param _itemId - ID of item user want to buy.
     * @param _itemAmount - Amount of item user want to buy.
     * @param _nakaAmount - Amount of Naka to buy item.
     */
    function buyItems(address _userAddress, uint256 _itemId, uint256 _itemAmount, uint256 _nakaAmount) external whenShopNotPaused nonReentrant onlyRole(VAULT_ADMIN){
