...
//
// TCORE Vault v2 / TCORE FeeApprover smart contract - Polygon (MATIC) cross-chain integration
...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        tokenUniswapPair = IUniswapV2Factory(address(0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32)).getPair(WETHAddress,tcoreTokenAddress);
    ...
    function calculateAmountsAfterFee(
        address sender,
        address recipient, // unusued, maybe used in future
        uint256 amount
    )
        public
        returns (
