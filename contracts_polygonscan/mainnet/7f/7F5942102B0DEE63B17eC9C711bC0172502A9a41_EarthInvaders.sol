...
// File: contracts/LowGas_Invader_Contract.sol
...
contract EarthInvaders is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Earth Invaders", "EI") {
    setHiddenMetadataUri("ipfs://QmPPTyFPQM83LaRCdXKkQLFAC4b58XCJwsA34waggPBZLk/Hidden_json.json");
  }
