...
// File: Vault\StrategyMaiWmaticQiQuickswap.sol

// openzeppelin v3.1.0

contract StrategyMaiWmaticQiQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToUsdcPath = [address(0x00580a84c73811e1839f75d86d75d88cca0c241ff4), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        ...
        earnedToToken0Path = [address(0x00580a84c73811e1839f75d86d75d88cca0c241ff4), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x00580a84c73811e1839f75d86d75d88cca0c241ff4)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00580a84c73811e1839f75d86d75d88cca0c241ff4)];
        token1ToEarnedPath = [address(0x00580a84c73811e1839f75d86d75d88cca0c241ff4)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00580a84c73811e1839f75d86d75d88cca0c241ff4)];
    }
