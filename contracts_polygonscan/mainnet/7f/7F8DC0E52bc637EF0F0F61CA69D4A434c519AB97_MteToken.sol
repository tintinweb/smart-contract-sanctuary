...
contract MteToken is ERC20, Ownable {

    function initialize() public initializer {
        Ownable.__Ownable_init();
        ERC20.__ERC20_init("Meteorite", "MTE");

        _mint(msg.sender, 700000 * 1e18);
    }
    ...
    */
    ...
    bool private mintAll = false;
    function mintToFarm(address _addr) external onlyOwner {
        require(!mintAll, "only mint once");
        require(_addr != address(0), "!_addr");
        mintAll = true;
        _mint(_addr, 2100000 * 1e18);
    }
}