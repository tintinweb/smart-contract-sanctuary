...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function readBooks(uint256 bookindexnr_, uint256 page_) public view returns (string memory) {
    ...
    function readMessage(uint256 messageIdNr) public view returns(string memory) {
