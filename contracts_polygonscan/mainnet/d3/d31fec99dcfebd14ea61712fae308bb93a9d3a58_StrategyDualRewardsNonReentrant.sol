...
//For Reward/Other token pairs i.e. Quick/Frax where two tokens are rewarded
contract StrategyDualRewardsNonReentrant is BaseStrategy {
    ...
    constructor(
        ...
        BaseStrategy(
            _want,
            0x43c085B5aba4E83a7dd1A478B7458D1d472FF6b4, //fee dist fund
            _harvestedToken,
        ...
        )
    {
        ...
        reward2_reward1_path = new address[](2);
        reward2_reward1_path[0] = _harvestedToken2;
        reward2_reward1_path[1] = _harvestedToken;
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        //Transfer WMATIC and any of the 2nd harvested token that may already be in the contract to the fee dist fund
        IERC20(WMATIC).safeTransfer(strategist, IERC20(WMATIC).balanceOf(address(this)));
        IERC20(harvestedToken2).safeTransfer(strategist, IERC20(harvestedToken2).balanceOf(address(this)));
