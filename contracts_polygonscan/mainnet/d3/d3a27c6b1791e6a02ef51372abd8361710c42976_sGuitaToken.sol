...
contract sGuitaToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Guita", "sGUITA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGUITA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sGUITA
