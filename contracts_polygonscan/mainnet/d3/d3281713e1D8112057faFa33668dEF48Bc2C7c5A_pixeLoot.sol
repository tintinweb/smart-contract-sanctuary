...
contract pixeLoot is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
        ...
        returns (bytes memory)
    {
        ...
        bytes memory image = abi.encodePacked(
            '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewPort="0 0 0 0"> <rect width="5" height="5" x="calc(50% - 2.5px)" y="calc(50% - 2.5px)" style="fill: #',
            colorString,
            '"/></svg>'
        );
