...
library REXTokenHelper {
    ...
    function downgrade(REXTokenStorage.SLPx storage self, address account, uint256 amount) public  {
      ...
      _updateSubscription(self, 1, account, units - uint128(amount), self.maticx);
