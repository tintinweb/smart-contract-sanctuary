...
contract StrategyMasterchef is BaseStrategyLPSingle {
    ...
    constructor(
        ...
        address[] memory _earnedToDeliriumPath,
        ...
        earnedToDeliriumPath = _earnedToDeliriumPath;
...
import "./libs/IStrategyDelirium.sol";
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant deliriumAddress = 0x95ea373B44a6dEFEA15E4714979F85Ed07867545;
    address public constant rewardAddress = 0x23Cd9649C0e98e4a8494eD13DA52a54CA63809C2;
    address public constant withdrawFeeAddress = 0x6D9518bd44fce1ee2EF8d7E3090fBA60304A4ceA; //change to prod
    address public constant feeAddress = 0xAe35FC2a202678df277B12C2CF6f0DBF46baFa67; // change wallet operator to prod
    ...
    address[] public earnedToDeliriumPath;
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            IStrategyDelirium(rewardAddress).depositReward(usdcAfter);
