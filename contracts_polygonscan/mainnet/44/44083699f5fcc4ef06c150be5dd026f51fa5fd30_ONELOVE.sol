...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034);
    ...
    uint256 public dividendsPerShareAccuracyFactor = 20 ** 36;
...
contract ONELOVE is IBEP20, Auth {
    ...
    address BUSD = 0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034;
    address WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Flip Phone";
    string constant _symbol = "NOKIA";
    ...
    uint256 public swapThreshold = _totalSupply / 100; // 0.005%
    bool inSwap;
