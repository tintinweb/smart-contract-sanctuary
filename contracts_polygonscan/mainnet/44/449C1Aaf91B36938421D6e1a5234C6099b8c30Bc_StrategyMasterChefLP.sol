...
abstract contract BaseStrategyLP is BaseStrategy {
    ...
    function convertDustToEarned() external nonReentrant whenNotPaused onlyOwner {
...
import "./libs/IStrategyDestruction.sol";
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public rewardAddress = 0x6D9518bd44fce1ee2EF8d7E3090fBA60304A4ceA;
    address public withdrawFeeAddress = 0x6D9518bd44fce1ee2EF8d7E3090fBA60304A4ceA;
...
interface IStrategyDestruction {
