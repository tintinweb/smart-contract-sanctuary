...
// File: contracts/blootgoddess.sol

pragma solidity ^0.8.0;

contract BlootGoddess is ReentrancyGuard, AdminControl, ERC1155 {

    uint256 constant public MAX_SUPPLY = 1200;
    uint256 constant private _tokenId = 0;
    uint256 public totalSupply = 0;
    address private raffertyETH = 0x77DaD28f302EBD245f15480Be38037197cC4135d;
    
    constructor() ERC1155("https://ipfs.io/ipfs/QmU2xVqVQ6pVta7CuMfkZfcmsKBz98UxgKS7ANF6EQiA6J") {}
    ...
    function withdrawFunds() public adminRequired {
        uint balance = address(this).balance;
        payable(raffertyETH).transfer(balance);
    }
