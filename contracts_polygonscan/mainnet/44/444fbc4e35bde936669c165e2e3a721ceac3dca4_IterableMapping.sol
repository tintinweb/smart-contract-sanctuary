...
contract COINTIKI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("TIKI", "TIKI") {
        ...
        address _bounceFixedSaleWallet = 0x5352182B4ba054AdF3bF153A074A66994F69BA8F;
...
contract FSHIBDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "TIKI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
