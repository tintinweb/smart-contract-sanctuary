...
contract kolofinance is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        require(!WhiteList[sender]&& !WhiteList[recipient], "This address is blacklisted");
    ...
    function WhiteList_(address[] calldata addresses) external onlyOwner {
...
contract kolo is kolofinance , NativeMetaTransaction, ContextMixin {
    constructor() kolofinance () {
