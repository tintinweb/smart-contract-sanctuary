...
// File: contracts/oracles/onchainSubIds/chainlink/MaticUsdMaticOracleSubId.sol
...
contract MaticUsdMaticOracleSubId {
  using SafeMath for uint256;

  function getResult() public view returns (uint256) {
    // Instance of Chainlink ETH/USD price feed
    uint256 maticUsdPrice = uint256(IShortAggregatorInterface(0xAB594600376Ec9fD91F8e885dADF0CE036862dE0).latestAnswer());

    // Data are provided with 8 decimals, adjust to 18 decimals
    uint256 result = maticUsdPrice.mul(1e10);

    return result;
  }
}

// File: contracts/oracles/chainlink/MaticUsdMaticChainlinkOracleId.sol
...
contract MaticUsdMaticChainlinkOracleId is MaticUsdMaticOracleSubId, IOracleId {
  ...
  constructor(IOracleAggregator _oracleAggregator, uint256 _emergencyPeriod) public {
    ...
    {
      "author": "Opium.Team",
      "description": "MATIC/USD Oracle ID",
      "asset": "MATIC/USD",
      "type": "onchain",
      "source": "chainlink",
      "logic": "none",
    ...
    */
    emit MetadataSet("{\"author\":\"Opium.Team\",\"description\":\"MATIC/USD Oracle ID\",\"asset\":\"MATIC/USD\",\"type\":\"onchain\",\"source\":\"chainlink\",\"logic\":\"none\",\"path\":\"latestAnswer()\"}");
  }
