...
contract DWAPstaking70Days is Ownable {
    ...
    address public constant tokenAddress = 0xAe07E7bF1FF10Da713AB5371A1B73869C8aA7A29;

    // reward rate 25.0% per 70 days
    uint256 public constant rewardRate = 2500;
    uint256 public constant rewardInterval = 70 days;
    ...
    // Admin cannot transfer out DWAP from this smart contract
    function transferAnyERC20Tokens(
        address _tokenAddr,
        address _to,
        uint256 _amount
    ) public onlyOwner {
        require(_tokenAddr != tokenAddress, "Cannot Transfer Out DWAP!");
