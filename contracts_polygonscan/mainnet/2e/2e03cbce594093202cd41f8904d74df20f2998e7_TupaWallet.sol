...
contract TupaWallet {
    ...
    function getBalance(address _assetAddress) public view returns (uint256) {
        TupaAsset tupa2 = TupaAsset(_assetAddress);
    ...
    function transfer(
        ...
        TupaAsset tupa = TupaAsset(_assetAddress);
        require(
...
/**
 * @title TupaManager is a contract that generates tokens that represents a investment fund units and manages them
 */
contract TupaManager {
...
/**
 * @title CaciqueBoard is the smart contract that will control all funds
 * */
contract CaciqueBoard {
