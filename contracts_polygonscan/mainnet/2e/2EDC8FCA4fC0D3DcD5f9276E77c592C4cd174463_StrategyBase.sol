...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public tamago_matic_path;
    ...
    {
        tamago_matic_path = new address[](2);
        tamago_matic_path[0] = tamago;
        tamago_matic_path[1] = matic;
    }
    ...
    function harvest() public override {
        ...
        if (_tamagoBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(tamago_matic_path, _tamagoBalancePost.div(2));
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public TMGO_MATIC_LP = 0x48233A33f840F584Dc690C4FCb2E757f02eBf4F8;
