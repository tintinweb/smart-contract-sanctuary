...
contract FarmFactory is ReentrancyGuard, Ownable {
    event Build(address owner, address token, address masterChef, address referral);
        ...
        nonReentrant
    {
        ...
        FarmToken farmToken = new FarmToken(_tokenName, _tokenSymbol);
        ...
        emit Build(msg.sender, address(farmToken), address(masterChef), address(referral));
    }
}