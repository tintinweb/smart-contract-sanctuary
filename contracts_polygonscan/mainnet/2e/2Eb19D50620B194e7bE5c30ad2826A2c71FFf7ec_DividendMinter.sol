...
abstract contract XIERC20Mintable is IERC20Mintable {
    constructor() {}
}
...
abstract contract XIPool is IPool {
    constructor() {}
}
...
import "../../contracts/pool/DividendMinter.sol";

contract XDividendMinter is DividendMinter {
    constructor() {}

    function x__MintingPool_init(IERC20Upgradeable _stakeToken,IERC20Mintable _rewardToken,uint256 _rewardTokensPerBlock,uint256 _startBlock) external {
        return super.__MintingPool_init(_stakeToken,_rewardToken,_rewardTokensPerBlock,_startBlock);
    }
    ...
    function x__Ownable_init() external {
        return super.__Ownable_init();
    }

    function x__Ownable_init_unchained() external {
...
import "../../contracts/pool/MintingPool.sol";

contract XMintingPool is MintingPool {
    constructor() {}
