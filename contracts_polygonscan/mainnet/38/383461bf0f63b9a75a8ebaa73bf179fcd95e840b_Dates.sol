...
abstract contract ERC721Tradable is ContextMixin, ERC721Enumerable, NativeMetaTransaction, Ownable {
    ...
    function mintTo(address _to) public onlyOwner {
        ...
        require(newTokenId <= maxTokens, "All tokens minted");
...
contract Dates is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("D4T3S", "DTS", _proxyRegistryAddress, 376)
    {
        for (int i = 0; i < 10; i++) {
            mintTo(owner());
        }
    ...
    function mintAndPay(uint count) public payable {
        require(count <= 10, "Can't mint more than 10");
        require(msg.value == count * price, "Wrong amount sent");
    ...
    function setBaseURI(string calldata newBaseURI) public onlyOwner notLocked {
        baseURI = newBaseURI;
    }
