...
contract XVMCtimeDeposit is Ownable, Pausable {
    ...
    uint256 public immutable withdrawFeePeriod = 90 days; // roughly 3 months
    ...
    address public oldPool = 0x4d13bAD6F93E7bC48884940E66171C0987Ea8362; //old pool we can migrate from
    ...
    address public distributionAddress = 0x000c5f4781f44F9B3A2919D556d656d3604923f2;
    ...
    function hopDeposit(uint256 _amount, address _recipientAddress, uint256 previousLastDepositedTime) external whenNotPaused {
        require(msg.sender == trustedSender1 || msg.sender == oldPool, "only trusted senders(other pools)");
