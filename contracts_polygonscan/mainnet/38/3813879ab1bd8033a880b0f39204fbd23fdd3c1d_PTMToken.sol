...
contract PTMToken is Context, ERC20PresetMinterPauser {
    ...
    string constant  _name = "Pentonium";
    string  constant _symbol = "PTM";
    uint256 constant _initialSupply = 0; // 0
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'PTM::permit:  invalid signature');
        _approve(owner, spender, value);
    }

    /**
     * @dev Moves tokens `amount` from `sender` to `recipient`.
     * @dev overriden to add _moveDelegates 
     *
     * This is internal function is equivalent to {transfer}, and can be used to
     * e.g. implement automatic token fees, slashing mechanisms, etc.
     *
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) public {
        ...
        require(signatory != address(0), "PTM::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "PTM::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "PTM::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber) public view returns (uint256) {
        ...
        require(blockNumber < block.number, "PTM::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
      ...
      uint32 blockNumber = safe32(block.number, "PTM::_writeCheckpoint: block number exceeds 32 bits");
