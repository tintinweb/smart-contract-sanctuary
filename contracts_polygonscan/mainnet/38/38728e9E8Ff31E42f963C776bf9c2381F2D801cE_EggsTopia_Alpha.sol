...
contract EggsTopia_Alpha is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 21.33 ether;
  ...
  constructor() ERC721("EggsTopia", "EGGST") {
    setHiddenMetadataUri("ipfs://QmZQqBfrZMjyDaCXn3DbfykEHx6iSRM3pQ6ipCiNfX4woZ/hidden.json");
  }
