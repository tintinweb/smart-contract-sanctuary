...
contract womacitypassports is ERC721 {
    ...
    address public owner = 0x29AFFf23F3b33F794B4bc3167d68e0101bA9dE00; // for OpenSea storefront integration. no effect on contract.
    ...
    // 16 palettes
    string[4][16] palette = [
        ["#CEFDFF", "#BBD5ED", "#A288E3", "#CCFFCB"],
        ["#C287E8", "#E6ADEC", "#EECFD4", "#EFB9CB"],
        ["#CFD4C5", "#EECFD4", "#E6ADEC", "#C287E8"],
        ["#DAB6FC", "#C5FFFD", "#8587FF", "#BBADFF"],
        ["#17C3B2", "#FFCB77", "#FBE2B1", "#FE6D73"],
        ["#FFA69E", "#B8F2E6", "#AED9E0", "#FAF3DD"],
        ["#C4FFF9", "#9CEAEF", "#68D8D6", "#3DCCC7"],
        ["#B7CE63", "#BED883", "#C1C6BE", "#C7D59F"],
        ["#FFBC1F", "#FA9338", "#FAFF81", "#AEA2E2"],
        ["#A3A3A3", "#92DCE5", "#52DEE5", "#EEE5E9"],
        ["#F9B9B7", "#F5D491", "#F06C9B", "#96C9DC"],
        ["#FF858D", "#FFD4D4", "#FF9FE5", "#8DA5E2"],
        ["#CE9F78", "#E79588", "#EED2CC", "#FBF7F4"], 
        ["#F2BAC9", "#BAD7F2", "#65E2A7", "#BAF2D8"],
        ["#F49097", "#F2F5FF", "#F5E960", "#DFB2F4"],
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory description = "Onchain woma city passport.To details https://woma.city";
    ...
    function generateSkyscrapers(bytes memory hash, uint256 pIndex) internal view returns (string memory) {
        ...
        if(msg.value >= 0.003 ether) { //~$120
            ...
            require(premiumPassportsSupply <= 3, "MAX_DX_REACHED_100");
