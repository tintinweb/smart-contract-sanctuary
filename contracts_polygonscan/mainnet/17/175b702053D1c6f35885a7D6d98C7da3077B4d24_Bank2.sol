...
contract Bank2 is Ownable, ReentrancyGuard {
    ...
    IBEP20 public APOLLO = IBEP20(0xaF194B227EB928fa37cDee9fB650Ad8ED8B786e9);
    IBEP20 public IRON = IBEP20(0x692597b009d13C4049a947CAB2239b7d6517875F); // IRON
...
*/
    ...
    function addRepo(uint _amount) public {
        require(msg.sender == address(APOLLO) || msg.sender == owner() || msg.sender == devaddr || msg.sender == address(this), "not authorized to repo");
