...
contract KanjiNFT_6th is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] public cha = ["\u5507","\u6db2","\u9152","\u8074","\u809d","\u8377","\u9320","\u9577","\u61a7","\u5931","\u640d","\u611b","\u604b","\u9e97","\u904b","\u6750","\u80ba","\u8a5e","\u8a8c","\u4e3b","\u96c4","\u6f22","\u7537","\u64cd","\u9928","\u5370","\u6a19","\u584a","\u6975","\u5e2b","\u5e25","\u7573","\u79c1","\u50d5","\u4ffa","\u8089","\u85ac","\u4e2d","\u4f1a","\u6eb6","\u899a","\u4e73","\u8ca0","\u5206","\u93e1","\u6df7","\u5800","\u6f64","\u77ac","\u52e2",
"\u92ad","\u733f","\u7891","\u6708","\u671d","\u868a","\u6700","\u6bcd","\u5c71","\u5606","\u53e3","\u52d5","\u6ce5","\u6fc1","\u8907","\u7b4b","\u8b0e","\u8fd1","\u88f8","\u540d","\u7d3a","\u9996","\u91dd","\u5de3","\u7db2","\u65b0","\u6b21","\u96a3","\u591c","\u4e5d","\u9a12","\u9eba","\u9f3b","\u7121","\u4eca","\u6838","\u6570","\u8a93","\u5ec3","\u7372","\u61f8","\u9b3c","\u6cb9","\u53e4","\u6614","\u5a46","\u5144","\u59c9","\u4e00","\u58f1"];
  string[] public meanx = ["lips","liquid","liquor","listen","liver","load","lock","long","longing","loss","loss","love","love","lovery","luck","lumber","lung","lyrics","magazine","main","male","man","man","manipulation","mansion","mark","mark","mass","master","master","master","mat","me","me","me","meat","medicine","medium","meet","melt","memorize","milk","minus","minute","mirror","mix","moat","moisture","moment","momentum",
"money","monkey","monument","moon","morning","mosquito","most","mother","mountain","mourn","mouth","move","mud","muddy","multiple","muscle","mystery","naer","naked","name","navy blue","neck","needle","nest","net","new","next","next","night","nine","noise","noodles","nose","nothing","now","nucleus","number","oath","obsolete","obtain","offer","ogre","oil","old","old","old woman","older brother","older sister","one","one"];
  ...
  string private rl1='{"name": "KanjiNFT_6th #';
  string private rl3='"}';
...
//}
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    Kanji memory kanji = randomOne(tokenId);
    string memory id=(tokenId+500).toString();
...
//gasless
  ...
  constructor() ERC721("KanjiNFT_6th", "KNJ6") Ownable() {}
}