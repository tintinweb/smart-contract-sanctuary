...
contract aNFT {
    ...
    address[] public DAI_TO_USDC_PATH = [address(DAI), address(USDC)];
    address[] public USDC_TO_DAI_PATH = [address(USDC), address(DAI)];
    ...
    function daiToUsdc() external {
        ...
        require(amounts[amounts.length-1] > amounts[0], "aNFT: output less than input");
