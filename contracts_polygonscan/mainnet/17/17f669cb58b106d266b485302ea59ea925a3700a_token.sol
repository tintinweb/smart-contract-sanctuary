...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50*10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Pisces Token";
    string private _symbol = "PISCES";
    ...
    address public ownerAddres = address(0x880CC271fd77F0206e51107a2250526e39EddD26);
    uint256 private _previousBurnFee = _burnFee;


    uint256 public _maxTxAmount = 0.1* 10 **18;
