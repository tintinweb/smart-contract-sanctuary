...
contract PoolFund is Ownable, Initializable {
    ...
    function transferTo(
        ...
        if (_amount > 0) {
            reward.safeTransfer(_receiver, _amount.div(10**missingDecimals));
        }
    }
    ...
    // request more fund
    function requestFund(uint256 _amount) external onlyOwner {
        reward.mint(address(this), _amount);
        emit FundRequested(_amount);
    }
