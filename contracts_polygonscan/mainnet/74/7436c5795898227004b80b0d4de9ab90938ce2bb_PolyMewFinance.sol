...
contract PolyMewFinance is Context, IERC20, Ownable {
...
contract PolyMew is PolyMewFinance, NativeMetaTransaction, ContextMixin {
    constructor() PolyMewFinance() {
