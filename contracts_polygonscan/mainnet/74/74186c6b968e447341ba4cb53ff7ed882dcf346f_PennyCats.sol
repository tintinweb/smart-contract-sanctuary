...
// File: Contracts/PennyCatsNot.sol
...
contract PennyCats is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PennyCats", "PYC") {
    setHiddenMetadataUri("ipfs://QmUMqSXSsqct8cePZXCSPgEqZrUcbVj3Fq8nYr84QLptLZ/hidden.json");
  }
