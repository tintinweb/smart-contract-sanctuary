...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x354A7ec7D2C8b1Cbe63E64c0C161ACf2d1EA4aE4;
...
contract PolyCatsToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2B18E66Bb3AF95a20ACbAEbB244CB23683485aEb;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Poly Cats";
    ...
    uint256 private numTokensSellToAddToLiquidity = 3500000 * 10**18;
