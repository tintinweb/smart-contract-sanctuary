...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant pswamp = 0x5f1657896B38c4761dbc5484473c7A7C845910b6;
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 26;
    ...
    // Uniswap swap paths
    address[] public pswamp_eth_path;
    address[] public pswamp_usdc_path;
    ...
    {
        pswamp_usdc_path = new address[](3);
        pswamp_usdc_path[0] = pswamp;
        pswamp_usdc_path[1] = matic;
        pswamp_usdc_path[2] = usdc;

        pswamp_eth_path = new address[](3);
        pswamp_eth_path[0] = pswamp;
        pswamp_eth_path[1] = matic;
        pswamp_eth_path[2] = eth;
    }
    ...
    function harvest() public override {
        ...
        //Swap 
        uint256 _pswampBalance = IERC20(pswamp).balanceOf(address(this));
        if (_pswampBalance > harvestCutoff){

            _swapUniswapWithPath(pswamp_usdc_path, _pswampBalance.div(2));
            uint256 _pswampBalancePost = IERC20(pswamp).balanceOf(address(this));
            _swapUniswapWithPath(pswamp_eth_path, _pswampBalancePost);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public USDC_ETH_LP = 0x853Ee4b2A13f8a742d64C8F088bE7bA2131f670d;
