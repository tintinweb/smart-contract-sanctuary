...
contract NFTizeFactory is Initializable, IERC721Receiver, OwnableUpgradeable, UUPSUpgradeable {
    ...
    bool permissionlessPoolCreation;
    ...
    function initialize(
        ...
        permissionlessPoolCreation = false;
    ...
    function createPool(
        ...
        uint256 theosAmount = 1_300_000 ether;
        ...
        emit NftizePoolCreated(address(nftizePoolContract), address(nftizePoolContract.poolToken()));
    ...
    function togglePermissionlessPoolCreation() public {
...
contract NftizePool is IERC721Receiver, AccessControl, Ownable {
    ...
    uint256 public immutable socialCauseFee; //500 is 5.0% in basis points
    uint256 public immutable basePrice;
    uint256 public immutable poolSlots;
    uint256 public poolNftsCount;
    uint256 public immutable poolMaxValueI; //in basis points too
    ...
    function claimTheosLiquidity() public {
        INftizePoolLpManager lpManager = INftizePoolLpManager(lpProvider.lpManagerAddress);
        IERC20(lpProvider.lpTokenAddress).approve(
            address(lpManager),
            IERC20(lpProvider.lpTokenAddress).balanceOf(address(this))
        );
        lpManager.claimTheosLiquidity(address(poolToken), lpProvider);
    }
...
/**
 * @dev Interface of the ERC20 standard as defined in the EIP plus burn and mint functions.
 */
interface IERC20B {
    /**
     * @dev Returns the amount of tokens in existence.
