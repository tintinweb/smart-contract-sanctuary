...
contract DreamStrategy is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        require(msg.sender == DREAM_KINGDOM_FACTORY, "Not factory");
    ...
    function deposit(uint256 _amount) external nonReentrant {
        require(block.number <= endBlock, "Dream has finished");
    ...
    function withdraw() external nonReentrant {
        require(block.number > endBlock, "Withdraw is locked until dream finish");
