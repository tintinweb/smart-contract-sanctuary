...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // The PolyGladiatorToken!
    PolyGladiatorToken public panther;
    // Dev address.
    ...
    constructor(
        ...
        uint256 _startBlock,
        uint256 _gladPerBlock
    ) public {
        panther = _glad;
        startBlock = _startBlock;
        pantherPerBlock = _gladPerBlock;
    ...
    function updateEmissionRate(uint256 _gladPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _gladPerBlock);
        pantherPerBlock = _gladPerBlock;
    }
