...
// PolyLionToken with Governance.
contract PolyLionToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    constructor(
        PolyLionToken _poll,
        uint256 _startBlock,
        uint256 _pollPerBlock
    ) public {
        panther = _poll;
        startBlock = _startBlock;
        pantherPerBlock = _pollPerBlock;
    ...
    function updateEmissionRate(uint256 _pollPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _pollPerBlock);
        pantherPerBlock = _pollPerBlock;
    }
