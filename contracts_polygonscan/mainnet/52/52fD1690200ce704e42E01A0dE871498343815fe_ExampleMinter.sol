...
contract ExampleMinter is AccessControl
{
    ...
    function setMintingContract(address mintingContract_) public {
    ...
    function mint(uint amount) public payable {
       ...
       function release(address payable _recv, uint _amount) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()));
