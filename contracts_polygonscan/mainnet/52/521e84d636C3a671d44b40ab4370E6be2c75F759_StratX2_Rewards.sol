...
contract StratX2_Rewards is StratX2_PCS {
    ...
    function deposit(address _userAddress, uint256 _wantAmt)
        ...
        returns (uint256)
    {
        uint256 sharesChanged = super.deposit(_userAddress, _wantAmt);
        _harvestReward(_userAddress, sharesChanged, false);
    ...
    function withdraw(address _userAddress, uint256 _wantAmt)
        ...
        returns (uint256)
    {
        uint256 sharesChanged = super.withdraw(_userAddress, _wantAmt);
        _harvestReward(_userAddress, sharesChanged, true);
        return sharesChanged;
    }
