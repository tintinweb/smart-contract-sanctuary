 ...
 */
contract CybToken is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
...
// File contracts/CNFTG.sol



pragma solidity ^0.8.0;

contract CNFTG is CybToken {
    constructor() CybToken("CNFT Global","CNFTG") {
        _mint(msg.sender, 100000000000 * (10 ** uint256(decimals())));
    }
}


// File contracts/cnftg.flatten.sol