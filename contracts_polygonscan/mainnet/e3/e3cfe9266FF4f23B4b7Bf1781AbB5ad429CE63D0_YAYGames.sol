...
// File: contracts/YAYGames.sol


pragma solidity 0.6.12;


// YAY Games with Governance.
contract YAYGames is BEP20('YAY Games', 'YAY') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTYAY::transfer: Burn value invalid");
