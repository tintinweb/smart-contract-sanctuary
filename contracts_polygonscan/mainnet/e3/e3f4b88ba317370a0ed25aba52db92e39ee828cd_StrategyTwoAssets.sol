...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 16;
    ...
    address[] public pwings_dai_path;
        ...
        )
    {
        ...
        pwings_dai_path = new address[](3);
        pwings_dai_path[0] = pwings;
        pwings_dai_path[1] = usdc;
        pwings_dai_path[2] = dai;
    }
    ...
    function harvest() public override {
        ...
        if (_pwingsBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(pwings_dai_path, _pwingsBalancePost);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public USDC_DAI_LP = 0x4A53119dd905fD39ccC532C68e69505dfB47fc2C;
