...
contract Blob is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    string baseURI =
        "https://gateway.pinata.cloud/ipfs/QmXCCrBpfbqhhCsYYTQJtBJquaUEyNHGMEXa1bqKhuEyNS/";

    using Counters for Counters.Counter;

    Counters.Counter private _nextTokenId;

    constructor() ERC721("theBlobs", "BLOB") {
        _initializeEIP712("theBlobs");
    }
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmVodoC7Hxn5Cv3NiCCk1hw3RnYZ1wJ2jfFT3pWUmgf2mu?preview=1";
    }
