...
//TODO add ability for GFI fee to be burned OR sent to a holding address
//TODO add buyback option. So GFI and other fees wont be burned or sent to the fee manager, instead they are sent to a buyback address
contract CompounderFactory is Ownable{
    ...
    **/
    ...
    event SharedVariablesUpdated(address _dustPan, address _feeManager, address _swapFactory, address _router, uint _slippage);
    ...
    function updateSharedVariables(address _dustPan, address _feeManager, address _swapFactory, address _router, uint _slippage) external onlyOwner{
        ...
        router = _router;
        slippage = _slippage;
        emit SharedVariablesUpdated(_dustPan, _feeManager, _swapFactory, _router, _slippage);
    }
