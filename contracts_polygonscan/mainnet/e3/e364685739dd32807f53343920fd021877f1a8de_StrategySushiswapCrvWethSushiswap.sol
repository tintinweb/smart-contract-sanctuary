...
// File: Vault\StrategySushiswapCrvWethSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapCrvWethSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00172370d5cd63279efa6d502dab29171933a610af)];
        ...
        token0ToEarnedPath = [address(0x00172370d5cd63279efa6d502dab29171933a610af), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        ...
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00172370d5cd63279efa6d502dab29171933a610af)];
