...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    {
        dino_matic_path = new address[](4);
        dino_matic_path[0] = dino;
        dino_matic_path[1] = usdc;
        dino_matic_path[2] = eth;
        dino_matic_path[3] = matic;
    ...
    function harvest() public override {
        ...
        if (_dinoBalance > harvestCutoff){
            _swapUniswapWithPath(dino_matic_path, _dinoBalance.div(2));
            ...
            if (_eth > 0 && _matic > 0) {
                ...
                IERC20(matic).safeApprove(rewardRouter, 0);
                IERC20(matic).safeApprove(rewardRouter, _matic);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public Matic_Weth_LP = 0xadbF1854e5883eB8aa7BAf50705338739e558E5b;
