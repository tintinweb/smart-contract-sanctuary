...
/**
 *Submitted for verification at https://t.me/GoldFinanceOfficialgroup
*/

// SPDX-License-Identifier: MIT

/**
 *Submitted for verification at https:goldfinance.tech
*/
...
contract GOLDFINANCE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2fA14923cF22820DeB8e000C8062C7C551bd8406); // Marketing Address
    ...
    uint256 private _tTotal = 250000 * 10**6 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GOLD FINANCE";
    ...
    uint256 public _maxTxAmount = 3000000 * 10**6 * 10**6;
    uint256 private minimumTokensBeforeSwap = 2000 * 10**6 * 10**6;
