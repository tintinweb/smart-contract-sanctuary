...
// File: Vault\StrategyApeswapWmaticWbtcApeswap.sol

// openzeppelin v3.1.0

contract StrategyApeswapWmaticWbtcApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x005d47baba0d66083c52009271faf3f50dcc01023c), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
        ...
        token1ToEarnedPath = [address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x005d47baba0d66083c52009271faf3f50dcc01023c)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
    }
