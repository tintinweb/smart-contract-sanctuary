...
contract TesterQuickSwap is Ownable, ReentrancyGuard, Pausable { 
    ...
    address public constant galaxyAddress= 0xddF560c597991659a9C3e9fB0dA50cDaD67e3088;   
    ...
    address[] public earnedToGalaxyPath = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0xddF560c597991659a9C3e9fB0dA50cDaD67e3088]; 
    ...
    constructor() public {
        ...
        masterChefAddress = 0x6455738564c426a34d582F8A45d62D66eF0A4828;

        wantAddress = 0x6e7a5FAFcec6BB1e78bAE2A1F0B612012BF14827;
        token0Address = IUniPair(wantAddress).token0();
        token1Address = IUniPair(wantAddress).token1();

        quickSwapAddress = 0x8FF56b5325446aAe6EfBf006a4C1D88e4935a914;
