...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_dinoBalance > harvestCutoff){
            ...
            if (performanceFee>0) {
                _swapUniswapWithPath(dino_eth_path, performanceFee);
            ...
            _swapUniswapWithPath(dino_eth_path, _dinoBalance.div(2));
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public DINO_ETH_LP = 0x9f03309A588e33A239Bf49ed8D68b2D45C7A1F11;
