...
contract PhotonReferral is IPhotonReferral, Ownable {
    ...
    // Get the amount of referrals that a user has obtained
    function getTotalReferralCommissions(address user) public override view returns (uint256) {
        return totalReferralCommissions[user];
    }

    // Get the amount of referrals that a user has obtained
    function getReferralCount(address user) public override view returns (uint256) {
