...
contract InnToken is ERC20, ERC20Burnable, AccessControl , Wallet {
    ...
    constructor(address RESEVERD , address COMMISION ) ERC20("InnToken", "INN") Wallet(RESEVERD , COMMISION) {
  ...
  function _firstInitializeWallet() private onlyRole(DEFAULT_ADMIN_ROLE){
        ...
        mint(address(0x2d60f692E17Cf5d0B68C131A0D4f0fFa50D5B9EB) , 10619.3* 10**7 );   
        ...
        mint(address(0x51BDE05b0fd2d3980E3D859DCC3E285F114Faf68) , 20000  * 10**7 );     
        ...
        mint(address(0x5fEd6D7c6d4b78bC94c531aacf10e32572d30522) , 7337.7 * 10**7 );       
        ...
        mint(address(0xa68d544CEa02D5f78C8B4ca2B9C962510ec44a49) , 2948990* 10**7 );      
        ...
        mint(address(0xD2b3501E9D11a05CCD0d72F4a633F8Fd44E49b37) , 88490  * 10**7 );  
        ...
        mint(address(0xaB9f782067f143E358382d7a4EE12517219363FB) , 20000  * 10**7 );
        mint(address(0x5ff9e95946663d2f27833fbF98E96f33C69876DF) , 20000  * 10**7 );
