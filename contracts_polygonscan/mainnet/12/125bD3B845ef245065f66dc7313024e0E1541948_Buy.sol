...
contract Buy is Ownable, ReentrancyGuard {
    ...
    constructor(address _signer,address _underWriting,address _surplus,address _product,address _wmatic,address _treasury) public {
   ...
   function setRate(uint256 _underWritingRate, uint256 _surplusRate, uint256 _treasuryRate) external onlyOwner {
        ...
        ) external payable nonReentrant
    {
        ...
        if(divCurrencies[currency] == WMatic) {
            //eth =>weth
