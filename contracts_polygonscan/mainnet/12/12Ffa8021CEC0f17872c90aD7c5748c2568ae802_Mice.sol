...
contract Mice is ERC721Burnable {
    ...
    address private wallet = 0x8F859d32FD84bc0Da197c722d0C2e86Dcf95d950;
    // address private wallet = 0xCf203C89B09367FD47eD83fF3315f057523b7E63;

    // constructor() ERC721("The Mice House", "TMH") {
    constructor() ERC721("XTMN", "XTMN") {
        MAX_MICE_SUPPLY = 10000;
        mintPrice = 45000000000000000; // 0.045 WETH
        maxMintAmount = 25;
        saleIsActive = false;
    }
    ...
    */
    ...
    function reserveMices(address _to, uint256 _numberOfTokens) external onlyOwner {
        ...
        require(totalSupply().add(_numberOfTokens) <= MAX_MICE_SUPPLY, "Reserve would exceed max supply");
    ...
    * Mints tokens
    */
    function mintMices(uint256 numberOfTokens, uint256 wethAmount) external {
        ...
        require(mintPrice.mul(numberOfTokens) <= wethAmount, "Ether value sent is not correct");
        require(isLaunch || whitelist[_msgSender()], "You have not permission to mint");
        
        IERC20(weth).transferFrom(_msgSender(), address(this), wethAmount);
    ...
    function withdraw() external onlyOwner {
        ...
        IERC20(weth).transfer(wallet, wethBalance);
    }
}
