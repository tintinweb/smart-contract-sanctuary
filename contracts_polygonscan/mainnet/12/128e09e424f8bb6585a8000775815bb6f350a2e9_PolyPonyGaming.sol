...
contract PolyPonyGaming is Context, IERC20, Ownable {
...
contract PolyPony is PolyPonyGaming, NativeMetaTransaction, ContextMixin {
    constructor() PolyPonyGaming() {
