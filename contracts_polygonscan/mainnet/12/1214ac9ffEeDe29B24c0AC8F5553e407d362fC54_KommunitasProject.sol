...
contract KommunitasProject{
    ...
    function getUserStakedInfo(StakingChoice _choice, address _target) internal view returns(uint userStaked, uint totalStaked){
        if(_choice == StakingChoice.V1){
            ...
            uint v2StakedNow = ERC20(0xC004e2318722EA2b15499D6375905d75Ee5390B8).balanceOf(0x8d37b12DB32E07d6ddF10979c7e3cDECCac3dC13);
    ...
    function setV2Staked() public {
        ...
        v2Staked = ERC20(0xC004e2318722EA2b15499D6375905d75Ee5390B8).balanceOf(0x8d37b12DB32E07d6ddF10979c7e3cDECCac3dC13);
    } 
