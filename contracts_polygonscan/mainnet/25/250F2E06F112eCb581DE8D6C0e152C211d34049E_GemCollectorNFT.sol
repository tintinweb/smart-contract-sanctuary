...
// File: node_modules/@openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721PausableUpgradeable.sol
...
// File: node_modules/@openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721BurnableUpgradeable.sol
...
// File: node_modules/@openzeppelin/contracts-upgradeable/token/ERC721/presets/ERC721PresetMinterPauserAutoIdUpgradeable.sol
...
// File: contracts/GemCollectorNFT.sol
...
contract GemCollectorNFT is ERC721PresetMinterPauserAutoIdUpgradeable, UUPSUpgradeable {
  ...
  function updateTokens() external {
    require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "user doesnt have admin control");
    tokenIDtoLevelID[0] = 1;
    tokenIDtoLevelID[1] = 2;
    levelIdToTokenData[3] = levelIdToTokenData[2];
    levelIdToTokenData[2] = levelIdToTokenData[1];
    levelIdToTokenData[1] = levelIdToTokenData[0];
  }
