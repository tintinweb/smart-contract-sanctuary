...
////// /home/brock/git_pkgs/dp-protocol-core/contracts/openzeppelin/contracts/token/ERC20/IERC20.sol
...
////// /home/brock/git_pkgs/dp-protocol-core/contracts/uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.sol
...
////// /home/brock/git_pkgs/dp-protocol-core/contracts/uniswap/v2-periphery/contracts/interfaces/IUniswapV2Router01.sol
...
////// /home/brock/git_pkgs/dp-protocol-core/contracts/uniswap/v2-periphery/contracts/interfaces/IUniswapV2Router02.sol
/* pragma solidity >=0.6.2; */
...
/* import "/home/brock/git_pkgs/dp-protocol-core/contracts/uniswap/v2-periphery/contracts/interfaces/IUniswapV2Router02.sol"; */
/* import "/home/brock/git_pkgs/dp-protocol-core/contracts/uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.sol"; */
/* import "/home/brock/git_pkgs/dp-protocol-core/contracts/openzeppelin/contracts/token/ERC20/IERC20.sol"; */
...
interface IUniRef {
    ...
    external
    view
    returns (Decimal.D256 memory, uint256 dpReserves, uint256 tokenReserves);
...
/* import "/home/brock/git_pkgs/dp-protocol-core/contracts/openzeppelin/contracts/math/SignedSafeMath.sol"; */
/* import "/home/brock/git_pkgs/dp-protocol-core/contracts/openzeppelin/contracts/utils/SafeCast.sol"; */
/* import "/home/brock/git_pkgs/dp-protocol-core/contracts/uniswap/lib/contracts/libraries/Babylonian.sol"; */
...
/// @dev the uniswap pair should be dp and another asset
contract UniSwapPriceOracle is IUniRef, UniSwapPriceOracleInterface {
    ...
    // @notice UniRef 构造函数
    // @param _core dp Core to reference
     ...
     * @dev dp代币地址
     */
    function dp() public view returns (address) {
        return _dp;
    }
    ...
    // @notice 成对储备，首先列出 dp
    // @dev 使用 dp 余额和 dp 储备的最大值。减轻操纵货币对平衡的攻击向量
    function getReserves()
    public
    view
    override
    returns (Decimal.D256 memory, uint256 dpReserves, uint256 tokenReserves)
    {
        ...
        (dpReserves, tokenReserves) = address(_dp) == token0
        ? (reserve0, reserve1)
        : (reserve1, reserve0);
        return (Decimal.ratio(dpReserves, tokenReserves), dpReserves, tokenReserves);
    }
    ...
    // @return price reported as dp per X
    // @return reserveDp dp reserves
    // @return reserveOther non-dp reserves
    function getUniSwapPrice(address token) external override(UniSwapPriceOracleInterface)
    view
    returns (uint){
        require(_dp == token, "token underlying address With UniSwap Price Oracle Does not match");
        address token0 = pair.token0();
        (uint256 reserve0, uint256 reserve1, ) = pair.getReserves();
        (uint256 dpReserves, uint256 tokenReserves) = address(_dp) == token0
        ? (reserve0, reserve1)
        : (reserve1, reserve0);
        uint price = tokenReserves.mul(10**18).div(dpReserves);
        return price.mul(10**2);
    }
