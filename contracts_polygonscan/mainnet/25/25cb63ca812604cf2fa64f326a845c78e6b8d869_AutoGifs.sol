...
contract AutoGifs {
    ...
    uint public constant TOKEN_LIMIT = 256; // 8 for testing, 256 or 512 for prod;
    uint public constant ARTIST_PRINTS = 32; // 2 for testing, 64 for prod;

    uint public constant PRICE = 20 finney;

    
    address public constant BENEFICIARY = 0xC5d8e0045618F211C5eDB190A00D059BF0E08F01;
