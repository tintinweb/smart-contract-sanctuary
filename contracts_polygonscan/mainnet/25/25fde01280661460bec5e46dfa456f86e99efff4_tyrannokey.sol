...
contract tyrannokey is  ERC721URIStorage , ERC721Enumerable {

    address public owner;

    uint256 public nftid = 1;

    string currentURI = "https://arweave.net/Bu5lRK4pFkJpVdMy_U6HwhThP67fznhEwLhcwl6-LGA";
    ...
    constructor() ERC721("tyrannokey" , "TYRANNO" ) {
        owner = _msgSender();
    } 
