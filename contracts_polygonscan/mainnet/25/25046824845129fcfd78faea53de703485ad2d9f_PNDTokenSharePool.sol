...
// File: contracts\token\LPTokenWrapper.sol
...
contract LPTokenWrapper {
    ...
    function stake(uint256 amount) public virtual {
        require(_balances[msg.sender].add(amount) <= maxLimit, 'lp amount exceed max limit');
...
interface InviteController {
    ...
    function registInviter(address account) external;
	
	function rewardInviter(uint256 claimAmount) external;

}

// File: contracts\distribution\PNDTokenSharePool.sol

pragma solidity ^0.6.0;


contract PNDTokenSharePool is
    LPTokenWrapper, Ownable
{
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'PNDTokenSharePool: Cannot stake 0');
        super.stake(amount);
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(amount > 0, 'PNDTokenSharePool: Cannot withdraw 0');
    ...
    function EmergencyWithraw() public {
        lpt.safeTransfer(msg.sender, balanceOf(msg.sender));
    }
}