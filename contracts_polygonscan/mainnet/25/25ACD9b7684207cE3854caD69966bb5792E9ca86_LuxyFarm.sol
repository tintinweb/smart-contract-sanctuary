...
contract LuxyFarm is Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant rewardsDuration = 90 days;
     ...
     * @param _lpToken Address of the LUXY-USDC LP token
     */
    constructor(address _luxyToken, address _lpToken) {
    ...
    {
        require(amount > 0, "LuxyFarm::CANNOT_STAKE_ZERO");
        _totalSupply += amount;
    ...
    function withdraw(uint256 amount)
        ...
        updateReward(_msgSender())
    {
        require(amount > 0, "LuxyFarm::CANNOT_WITHDRAW_ZERO");
        require(
            _balances[_msgSender()] >= amount,
            "LuxyFarm::INSUFFICIENT_TOKEN_AMOUNT"
        );
        _totalSupply -= amount;
        _balances[_msgSender()] -= amount;
        ...
        updateReward(address(0))
    {
        ...
        */
        uint256 balance = luxyToken.balanceOf(address(this));
        require(
            rewardRate <= balance / rewardsDuration,
            "LuxyFarm::PROVIDED_REWARD_TOO_HIGH"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "LuxyFarm::CANNOT_WITHDRAW_STAKING_TOKEN"
        );
