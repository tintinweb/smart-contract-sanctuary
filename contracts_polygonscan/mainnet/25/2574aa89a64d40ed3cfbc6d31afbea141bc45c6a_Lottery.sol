...
// File: contracts/libs/IRandomNumberGenerator.sol
...
// File: contracts/libs/EnumerableMap.sol
...
// File: contracts/Lottery/LotteryNFT.sol
...
contract Lottery is Initializable, Referral {
    ...
    function claimReward(uint256 _tokenId) external {
        ...
        if(reward>0) {
            ...
            uint256 referralCut = reward * referralCutPercentage / 10000;
            uint256 winnings = reward - referralCut;
        ...
        returns(uint8[4] memory) 
    {
        ...
        for(uint i = 0; i < 4; i++){
            ...
            numbersDrawnToWin[i] = uint8(numberRepresentation.mod(maxNumber));
        }
