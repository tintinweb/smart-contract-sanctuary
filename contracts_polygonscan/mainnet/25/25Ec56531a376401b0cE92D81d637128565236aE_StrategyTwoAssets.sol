...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        dai_usdc_path = new address[](2);
        dai_usdc_path[0] = dai;
        dai_usdc_path[1] = usdc;
    }
    ...
    function harvest() public override {
        ...
        if (_maticBalance > harvestCutoffMatic){
            ...
            _swapUniswapWithPath(matic_dai_path, _maticBalancePost);
            
            // Swap Dai for USDC
            uint256 _daiBalancePost = IERC20(dai).balanceOf(address(this));
            _swapUniswapWithPath(dai_usdc_path, _daiBalancePost.div(2));


            // Add liquidity for Dai/USDC
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public USDC_Dai_LP = 0x5b13B583D4317aB15186Ed660A1E4C65C10da659;
