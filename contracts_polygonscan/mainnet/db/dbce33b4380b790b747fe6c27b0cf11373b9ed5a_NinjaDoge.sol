...
contract NinjaDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ninja Doge";
    string private _symbol = "$NINJADOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf0F771c8713B38e7B4Aeb2AD08b8871e5FF33ad1); // Marketing Address
    address payable public rewardWalletAddress = payable(0xf0F771c8713B38e7B4Aeb2AD08b8871e5FF33ad1); // reward Address
