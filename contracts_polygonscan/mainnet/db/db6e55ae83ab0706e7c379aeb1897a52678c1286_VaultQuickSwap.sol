...
contract VaultQuickSwap is Ownable, ReentrancyGuard, Pausable { 
    ...
    address public constant vaultChefAddress= 0xf1B91F8CB26e207368D356fd7bdea4518158b8DD;      
    ...
    address[] public earnedToWmaticPath = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270]; // QUICK,WMATIC 
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            IGalaxyVaultCash(rewardAddress).depositReward(usdcAfter);
