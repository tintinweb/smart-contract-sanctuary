...
/*
    ...
    E7: Can't change once started
    E8: New start block must be greater than old start block
    E9: Can't withdraw nft until sale start
*/
...
contract SaleNFT is ReentrancyGuard, Ownable, IERC721Receiver, ERC721Holder {
    ...
    event SendUnclaimedNftCard(uint256 amountNftCardBurned);
    ...
    function buyNftCard(uint256 _amountNFT) external nonReentrant {
        ...
        if (_balanceOfNFT > 0) {
              ...
              USDC.safeTransferFrom(msg.sender, ADMIN_ADDRESS, _usdcSpend);
        }
    ...
    function setStartBlock(uint256 _newStartBlock) external onlyOwner {
        require(block.number < startBlock, "E7");
        require(block.number < _newStartBlock, "E7");
