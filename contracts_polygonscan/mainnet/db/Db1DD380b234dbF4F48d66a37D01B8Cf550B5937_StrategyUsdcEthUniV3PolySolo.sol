...
import "../strategy-univ3-rebalance-solo.sol";

contract StrategyUsdcEthUniV3PolySolo is StrategyRebalanceUniV3Solo {
    ...
    constructor(
        ...
        public
        StrategyRebalanceUniV3Solo(usdc_eth_pool, _tickRangeMultiplier, _owner){ }

    function getName() external pure override returns (string memory) {
        return "StrategyUsdcEthUniV3PolySolo";
    }
...
abstract contract StrategyRebalanceUniV3Solo {
    ...
    function setManipulationResistance(int24 _maxDeviation, uint24 _twapTime) external {
      require (msg.sender == owner, "!owner");
    ...
    function deposit() public checkDeviation {
        ...
        external checkDeviation
    {
      ...
      (uint256 _liqAmt0, uint256 _liqAmt1) = nftManager.decreaseLiquidity(
        ...
        token0.safeTransfer(owner, a0);
        token1.safeTransfer(owner, a1);
    }
