...
contract StrategyMasterHealerForKoala is BaseStrategyLPSingle {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    address public masterchefAddress;
    uint256 public pid;
    address public constant _referrer = 0x000000000000000000000000000000000000dEaD;
    bool public constant _lyptusFee = false;
    ...
    function _vaultDeposit(uint256 _amount) internal override {
        IKoalaFarm(masterchefAddress).deposit(pid, _amount, _referrer, _lyptusFee);
    }
    ...
    function _vaultHarvest() internal override {
        IKoalaFarm(masterchefAddress).withdraw(pid, 0);
    }
