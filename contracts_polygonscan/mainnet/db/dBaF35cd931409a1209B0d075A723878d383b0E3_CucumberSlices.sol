...
contract CucumberSlices is ERC20 {
    ...
    constructor(address _token, address _governance, address _timelock, address _controller)
        public
        ERC20(
            string(abi.encodePacked("cucumber ", ERC20(_token).name())),
            string(abi.encodePacked("qcum", ERC20(_token).symbol()))
        )
    {
