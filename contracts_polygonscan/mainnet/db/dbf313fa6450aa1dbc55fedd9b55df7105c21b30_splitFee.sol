...
contract splitFee is Ownable, ReentrancyGuard {
  ...
  uint16 public insurancePercentage = 20; // In basis points
  uint16 public treasuryPercentage = 40; // In basis points
  ...
  function withdraw() public nonReentrant {
    ...
    uint256 insuranceFee = profit.mul(insurancePercentage).div(100);
