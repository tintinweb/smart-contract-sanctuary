...
contract LiquidityPool is ILiquidityPool, ERC20Upgradeable, AbstractDependant {
    ...
    function addLiquidity(address _userAddr, uint256 _liquidityAmount)
        ...
        onlyDefiCore
    {
        uint256 _assetAmount = _liquidityAmount.convertFrom18(getUnderlyingDecimals());

        require(_assetAmount > 0, "LiquidityPool: Incorrect asset amount to transfer.");
        ...
        onlyDefiCore
    {
        ...
        IERC20(assetAddr).transfer(
            _userAddr,
            _liquidityAmount.convertFrom18(getUnderlyingDecimals())
        );
    ...
    function borrow(address _userAddr, uint256 _amountToBorrow) external override onlyDefiCore {
        ...
        IERC20(assetAddr).transfer(
            _userAddr,
            _amountToBorrow.convertFrom18(getUnderlyingDecimals())
        );
    }
    ...
    function closeBorrow(
        ...
        return _closeBorrow(_userAddr, _closureAddr, _closeAmount);
    }
    ...
    function withdrawReservedFunds(
        ...
        IERC20(assetAddr).transfer(
            _recipientAddr,
            _amountToWithdraw.convertFrom18(getUnderlyingDecimals())
        );
    ...
    function _closeBorrow(
        ...
        IERC20(assetAddr).transferFrom(
            _closureAddr,
            address(this),
            _closeAmount.convertFrom18(getUnderlyingDecimals())
        );
