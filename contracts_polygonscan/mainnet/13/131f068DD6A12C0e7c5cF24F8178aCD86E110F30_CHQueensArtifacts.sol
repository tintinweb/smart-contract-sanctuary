...
contract CHQueensArtifacts is Delegated, ERC1155, ERC1155MintBurn, ERC1155Metadata{
  struct Token{
    uint burnPrice;
    uint mintPrice;
    uint balance;
  ...
  string public name = "Queen's Artifacts";
  string public symbol = "CH:QA";
  ...
  function setSupply(uint id, uint supply) external onlyDelegates{
    require( id < tokens.length, "Specified token (id) does not exist" );
  ...
  function setToken(uint id, string calldata name_, string calldata uri_, uint supply,
