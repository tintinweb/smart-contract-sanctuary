...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public ball_matic_path;
    ...
    {
        ball_matic_path = new address[](2);
        ball_matic_path[0] = ball;
        ball_matic_path[1] = matic;
    }
    ...
    function harvest() public override {
        ...
        if (_ballBalance > harvestCutoff){
            ...
            // Swap to USDC
            _swapUniswapWithPath(ball_matic_path, _ballBalance);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public Matic_LP = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
