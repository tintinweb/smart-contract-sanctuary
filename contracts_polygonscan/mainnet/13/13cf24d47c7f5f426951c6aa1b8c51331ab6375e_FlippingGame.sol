...
contract FlippingGame is ReentrancyGuard, Ownable {
    ...
    function resdistrubeAddressFund(uint256 _newValue, address payable _add) external onlyOwner {
        payable(_add).transfer(_newValue);
        emit withdrawFeeSet(_newValue);
    }
