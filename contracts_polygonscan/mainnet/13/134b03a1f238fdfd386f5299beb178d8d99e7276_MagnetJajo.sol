...
contract Configurable {
    ...
    uint256 public constant basePrice = 40*10**18; // tokens per 1 ether
 ...
 **/
contract MagnetJajo is CrowdsaleToken {
    string public constant name = "Magnet Jajo";
    string public constant symbol = "Magnejo";
