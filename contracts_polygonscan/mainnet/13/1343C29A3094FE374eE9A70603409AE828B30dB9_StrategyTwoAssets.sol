...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getHarvestable() external view override returns (uint256) {
        return IMasterChef(rewards).pendingSpirit(poolId, address(this));
    }
...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    // Other constants
    uint256 public constant underlyingPoolId = 26;
        ...
        )
    {
        ...
        rewardToFarmTokenPath0 = new address[](4);
        rewardToFarmTokenPath0[0] = rewardTokenAddr;
        rewardToFarmTokenPath0[1] = eth;
        rewardToFarmTokenPath0[2] = quick;
        rewardToFarmTokenPath0[3] = farmToken0Addr;

        rewardToFarmTokenPath1 = new address[](5);
        rewardToFarmTokenPath1[0] = rewardTokenAddr;
        rewardToFarmTokenPath1[1] = eth;
        rewardToFarmTokenPath1[2] = quick;
        rewardToFarmTokenPath1[3] = farmToken0Addr;
        rewardToFarmTokenPath1[4] = farmToken1Addr;
    }
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public LP_TOKEN = 0x66c37a00E426A613B188180198AAC12B0b4aE4D4;
