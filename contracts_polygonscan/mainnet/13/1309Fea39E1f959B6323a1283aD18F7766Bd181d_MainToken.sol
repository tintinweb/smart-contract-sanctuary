...
contract Consts {
    ...
    uint64 public constant months3 = 1635258000; // 1/28/2022
    uint64 public constant months6 = 1635259200; // 4/28/2022
    uint64 public constant months9 = 1635259800; // 7/28/2022
    uint64 public constant months12 = 1635260400; // 10/28/2022
    uint64 public constant months18 = 1635258000; // 4/28/2023
    uint64 public constant months24 = 1635259200; // 10/28/2023
    uint64 public constant months30 = 1635259800; // 4/28/2024
}
...
contract MainToken is Consts, FreezableMintableToken, BurnableToken, Ownable {
    ...
    constructor(
        ...
        mintAndFreeze(team, 12500000 * TOKEN_DECIMAL_MULTIPLIER, months3);
        mintAndFreeze(team, 12500000 * TOKEN_DECIMAL_MULTIPLIER, months6);
        mintAndFreeze(team, 12500000 * TOKEN_DECIMAL_MULTIPLIER, months9);
