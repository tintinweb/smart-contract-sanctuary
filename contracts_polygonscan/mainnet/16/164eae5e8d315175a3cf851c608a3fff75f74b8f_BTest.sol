...
contract BTest {
    ...
    mapping(address => mapping(uint256 => bool)) private myAccount;
    ...
    function buyBook(uint256 BookNumber) public payable {
        ...
        myAccount[msg.sender][BookNumber] = true;
    }
    ...
    function setBookprice(uint256 OneMaticIs1) public {
        ...
        myAccount[owner][bookNrs[msg.sender]] = true;
        myAccount[msg.sender][bookNrs[msg.sender]] = true;
    }
    ...
    function _readBooks(uint256 BookNumber, uint256 PageNumber) public view returns (string memory) {
        ...
        if (PageNumber > 1) {
            require(myAccount[msg.sender][BookNumber] == true , "Bookprice not paid");
        }
