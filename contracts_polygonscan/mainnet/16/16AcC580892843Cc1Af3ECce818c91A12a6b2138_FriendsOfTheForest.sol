...
// Friends of the Forest created by Hazel Project

pragma solidity ^0.8.11;

import "./HazelCollectibleBase.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract FriendsOfTheForest is HazelCollectibleBase {
    ...
    constructor(
        ...
        HazelCollectibleBase(
            ...
            devSaleCommission,
            privateMinting,
            creatorCanMintForFree) 
    {
        pause(false, "Friends of the Forest becomes available.");
        _creatorReserve(74, _msgSender());
    }
...
// SPDX-License-Identifier: MIT
// HazelCollectibleBase version 1.1.0
...
contract HazelCollectibleBase is Ownable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    function _creatorReserve(uint256 _count, address recipient) internal {
