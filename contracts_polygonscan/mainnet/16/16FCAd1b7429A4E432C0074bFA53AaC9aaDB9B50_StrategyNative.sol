...
contract StrategyNative is Ownable, ReentrancyGuard, Pausable {
    ...
    address public farmContractAddress = 0x0000000000000000000000000000000000000000; // not used, funds stay on strategy address
    ...
    address public uniRouterAddress = 0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607; // not used, no buyback

    address public constant wmaticAddress = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; // not used
