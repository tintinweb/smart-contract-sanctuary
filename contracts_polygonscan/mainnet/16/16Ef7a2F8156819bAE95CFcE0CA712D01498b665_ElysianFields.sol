...
contract ElysianFields is Ownable {
  ...
  constructor(
    ...
    deployQuinarius(_name, _symbol, _cap, _amountForPool, _rewardReceiver);
  }

  // The Reward token
  Quinarius public rwdToken;
  // Info of each pool.
  ...
  function deployQuinarius(
    ...
    rwdToken = new Quinarius(_name, _symbol, _cap);
