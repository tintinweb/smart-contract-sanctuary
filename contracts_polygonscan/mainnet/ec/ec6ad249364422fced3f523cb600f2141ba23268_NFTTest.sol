...
contract NFTTest is ERC721Enumerable, Ownable {
    ...
    event Minted(address to, uint256 nftId, uint8 nftType, uint256 coinReward);
    ...
    function mnt() public returns (uint256) {
        _nftIds.increment();

        _mint(tx.origin, _nftIds.current()); // Mint NFT.
