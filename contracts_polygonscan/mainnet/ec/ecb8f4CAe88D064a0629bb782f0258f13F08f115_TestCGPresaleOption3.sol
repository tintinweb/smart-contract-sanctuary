...
contract TestCGPresaleOption3 is ReentrancyGuard {
    ...
    // Price of presale TESTCG: 0.11 USDC
    uint256 private constant USDCPerCGS = 11;

    // Time per percent
    uint256 private constant timePerPercent = 3600;

    // Max Buy Per User
    uint256 public maxBuyPerUser = 55000*(1e6); // decimal 6

    uint256 public firstHarvestTimestamp;

    address payable owner;

    uint256 public constant TESTCG_HARDCAP = 500000*(1e6);
