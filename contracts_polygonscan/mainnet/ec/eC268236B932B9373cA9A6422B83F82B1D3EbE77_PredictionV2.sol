...
contract PredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    //最小回购金额
    uint256 minimumRepurchaseAmount = 500000000000000000000;
    //token 合约地址
    ...
    */
    ...
    constructor(
        ...
        symbolOracle['ETH'] = 0xF9680D99D6C9589e2a93a78A04A279e509205945;
        symbolOracle['MATIC'] = 0xAB594600376Ec9fD91F8e885dADF0CE036862dE0;
        symbolOracle['BTC'] = 0xc907E116054Ad103354f2D350FD2514433D57F6f;
        symbolSwitch['ETH'] = 1;
        symbolSwitch['MATIC'] = 1;
        symbolSwitch['BTC'] = 1;
        intervalSeconds['BNB'] =300;
        intervalSeconds['MATIC'] =300;
        intervalSeconds['ETH'] =300;
        bufferSeconds['BNB'] =15;
        bufferSeconds['MATIC'] =15;
        bufferSeconds['ETH'] =15;
        symbols.push('ETH');
        symbols.push('MATIC');
        symbols.push('BTC');
