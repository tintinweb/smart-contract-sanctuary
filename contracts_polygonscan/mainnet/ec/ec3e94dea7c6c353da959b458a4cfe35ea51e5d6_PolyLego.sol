...
contract PolyLego is Context, ERC20, Ownable {
    ...
    // Address that include in PolyLego LP list
    mapping(address => bool) private _includeInPolyLegoLpList;
    ...
    // Minimum PolyLego sell order to trigger buyback
    ...
    constructor() public {
        ...
        _includeInPolyLegoLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInPolyLegoLpList(address _address)
        public
        view
        returns (bool)
    {
        return _includeInPolyLegoLpList[_address];
    }

    function setIncludeInPolyLegoLpList(address _address, bool _isIncludedOrNot)
        public
        onlyOwner
    {
        ...
        _includeInPolyLegoLpList[_address] = _isIncludedOrNot;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            !isIncludedInPolyLegoLpList(from) &&
            from != owner()
        ) {
            ...
            if (isIncludedInPolyLegoLpList(to)) {
