...
contract PolyPonyMeme is Context, IERC20, Ownable {
...
contract PolyPony is PolyPonyMeme, NativeMetaTransaction, ContextMixin {
    constructor() PolyPonyMeme() {
