...
//    }
   ...
   /* 
    function setPlantFutures ( uint256 _plant, address _owner , uint256 _periods) public onlyEngine {
        ...
        if ( maxPeriodMinting )    require ( _periods < ManufacturingPlants[_plant]._timeunitslocked - ManufacturingPlants[_plant]._periodsmanufactured, "Not Enough remaining Periods ");
    ...
    */
       ...
       // if ( futures[_plant] > 0 ) futures[_plant]--;
        ...
        //    warbotLocationOrigin[newTokenId] = ManufacturingPlants[ _plant]._location;
          //  warbotMadeIn[ newTokenId ] = _plant;
            ...
            WarbotManufactureCertificates[newTokenId]._warbotposition = i+1;
        }
    ...
    function unstakeMicroMachines ( uint256 _plant ) public  {
        ...
        if ( coolDownPeriod )  require ( isExpired (ManufacturingPlants[ _plant]._lastmanufacture + manufacturingPeriod) == true ,    "cooldown period not complete" );
