...
// File: Vault\StrategyBarbershopHairUsdcApeswap.sol

// openzeppelin v3.1.0

contract StrategyBarbershopHairUsdcApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
        earnedToToken1Path = [address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        token0ToEarnedPath = [address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
        token1ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x008f3cf7ad23cd3cadbd9735aff958023239c6a063), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
    }
