 ...
 */
contract ERC1155PresetMinterPauserOpensea is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable, Ownable  {
     ...
     */
    constructor(string memory _nftURI, string memory _contractUri) ERC1155(_nftURI) {
