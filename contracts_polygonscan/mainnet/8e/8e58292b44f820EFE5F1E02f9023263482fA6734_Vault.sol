...
contract Vault is IVault, ERC20UpgradeSafe, ReentrancyGuardUpgradeSafe, OwnableUpgradeSafe {
  ...
  function _deposit(uint256 amountToken) internal {
    ...
    require(totalSupply() > 1e17, "Vault::deposit:: total supply too low");
  }
  ...
  function withdraw(uint256 share) external override accrue(0) nonReentrant {
    ...
    require(totalSupply() > 1e17 || totalSupply() == 0, "Vault::withdraw:: total supply too low");
  }
  ...
  function work(
    ...
    ( OPEN_PRICE, LIQ_PRICE, STOP_LOSS, TAKE_PROFIT, , ) = abi.decode(data, (uint256, uint256, uint256, uint256, address, bytes));
