...
// File contracts/libs/IStrategyCosmic.sol
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant cosmicAddress =
        0xa5Eb60CA85898f8b26e18fF7c7E43623ccbA772C;
    address public constant rewardAddress =
        0x791E535D45023140E51B41696cA2F397a6d2516e;
    address public constant withdrawFeeAddress =
        0x68Fc93Fc7a1faCb7aBEa4DC3CE7ee24DD109715E;
    ...
    function buyBack(uint256 _earnedAmt) internal virtual returns (uint256) {
        if (buyBackRate > 0) {
            ...
            _safeSwap(buyBackAmt, earnedToCosmicPath, buyBackAddress);
...
// File contracts/StrategyQuickSwap.sol

pragma solidity 0.6.12;

contract StrategyQuickSwapDAIUSDC is BaseStrategyLPSingle {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function wantLockedTotal() public view override returns (uint256) {
        return
            IERC20(wantAddress).balanceOf(address(this)).add(
                IStakingRewards(quickSwapAddress).balanceOf(address(this))
            );
    }
