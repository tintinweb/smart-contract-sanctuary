 ...
 */
 ...
 contract PLANK is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken, ERC2981ContractWideRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Plank Owner Series", "PLANK") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x8DbD98021b4883688aa24E7EFDd0C4EF17d5d41d);
          _setupRole(MINTER_ROLE, 0x8DbD98021b4883688aa24E7EFDd0C4EF17d5d41d);
          _setupRole(PAUSER_ROLE, 0x8DbD98021b4883688aa24E7EFDd0C4EF17d5d41d);
          _setupRole(MINTER_ADMIN_ROLE, 0x8DbD98021b4883688aa24E7EFDd0C4EF17d5d41d);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x8DbD98021b4883688aa24E7EFDd0C4EF17d5d41d);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "PLANK/minter-role-required");
         _mint(to, tokenId);
