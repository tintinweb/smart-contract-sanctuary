...
interface IMasterChef {
    ...
    function pendingBluebry(uint256 _pid, address _user) external view returns (uint256);
...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getHarvestable() public override view returns (uint256) {
        return IMasterChef(rewards).pendingBluebry(poolId, address(this));
    }
...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0x5e79C733Aa35Fdbb3d6A4C4F84ae7954bacb0978; //Blueberry address
    ...
    address public constant blueberry = rewardToken;
    address public constant usdc = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;

    address[] public blueberry_usdc_path;
    ...
    {
        blueberry_usdc_path = new address[](2);
        blueberry_usdc_path[0] = blueberry;
        blueberry_usdc_path[1] = usdc;
    }
    ...
    function harvest() public override {
        ...
        _swapUniswapWithPath(blueberry_usdc_path, _harvestBalance);

        //Collect performance fee, if applicable and swap all to USDC
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public BERRY_MASTER_CHEF = 0x11184e3102F142Ed12Aa05E03C8Ee71C6B125220;
    address public Want_Token = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; //USDC
