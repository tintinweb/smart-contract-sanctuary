...
contract ScaleDAOTest {
  using SafeMath for uint256;
  function name() public pure returns(string memory) { return "ScaleDAOTest"; }
  function symbol() public pure returns(string memory) { return "SCADT"; }
