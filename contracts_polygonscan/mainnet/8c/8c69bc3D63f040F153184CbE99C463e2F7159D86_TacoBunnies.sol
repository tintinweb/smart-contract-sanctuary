...
contract TacoBunnies is ERC721URIStorage, ContextMixin, Ownable {
    ...
    constructor() ERC721("Taco Party NFT", "TPNFT") {
    }
    ...
    * @dev Return the contract storefront URI for the token
    ...
    function contractURI() public pure returns (string memory) {
        return "https://tacoparty.finance/nft/launch/storefront.json";
    }
    ...
    * @dev Return the base directory of the NFT
    ...
    return "https://tacoparty.finance/nft/launch/";
    }
