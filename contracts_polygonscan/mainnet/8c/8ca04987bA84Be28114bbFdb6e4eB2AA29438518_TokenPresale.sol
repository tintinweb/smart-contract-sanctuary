...
contract TokenPresale is Ownable {
    ...
    function initialize(
        ...
        startTime = _dates[0]; //In timestamp format, start date of the presale. Ex. 1628902800
        endTime = _dates[1]; //In timestamp format, end date of the presale. Ex. 1628902800
        claimTime = _dates[2]; //In timestamp format, date when the bought tokens can be claimed. Ex. 1628902800
        whitelistStartTime = _dates[3]; //In timestamp format, date the whitelisted addresses can buy the tokens ahead of time. Ex. 1628902800
        liquidityLockTime = _dates[4]; //In timestamp format, when the owner can withdraw the liquidity deposited by presale contract. Ex. 1628902800
        useBlocks = _features[0]; //In bool, if the dates will be in block number format or not. Ex. true
        burnUnsold = _features[1]; //In bool, if the unsold tokens in presale will be burnt. Ex. true
        autoAddLiquidity = _features[2]; //In bool, if the MATICs will be auto added for liquidity. Ex. true
        softCap = _caps[0]; //Minimum amount of tokens to sell for presale to proceed. Ex. 1000000000000000000 or 1 token
        hardCap = _caps[1]; //Total number of tokens up for sale. Ex. 1000000000000000000 or 1 token
        hardCapEth = _caps[2]; //How many ETH are you willing to raise? Ex. 1000000000000000000 or 1 token
        minTokens = _tokenLimits[0]; //Minimum number of tokens a wallet should buy. Ex. 1000000000000000000 or 1 token
        maxTokens = _tokenLimits[1]; //Minimum number of tokens a wallet can hold. Ex. 1000000000000000000 or 1 token
        liquidityPct = _settings[0]; //How many percent of the MATIC and tokens will be put into liquidity? Ex. 10000 or 100%
        feeBP = _settings[1]; //Ex. 10000 or 100%
        listingType = _settings[2]; //Ex. 10000 or 100%
