...
contract Bequant is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor()
        ERC1155("https://bafybeibp7vvnr2bilvhto5k4kiixccps663mp5hnz63l5s7kvevn6macfe.ipfs.dweb.link/{id}")
    {
        name = "Bequant Winter NFTs";
        symbol = "BWNFT";
    }
    ...
    function uri(uint256 _tokenId) override public view returns (string memory) {
        return string(
            abi.encodePacked(
                "https://bafybeibp7vvnr2bilvhto5k4kiixccps663mp5hnz63l5s7kvevn6macfe.ipfs.dweb.link/",
