...
interface IERC20 {
    ...
    function sendTransferFromToSale(address recipient, uint256 amount) external returns (bool);
...
contract SECICO {
    ...
    function endICO(uint256 _allocToken) onlyOwner external returns (bool){
        ...
        sector.sendTransferFromToSale(address(this), _allocToken);
