...
contract Plankton is ERC20 {
     ...
     */
    constructor() public ERC20("Plankton", "PKN") {
    ...
    function updatePlanktonPair(address _PlanktonPair) public onlyOperator {
        PlanktonPair = _PlanktonPair;
        require(PlanktonPair != address(0), "Token::updateQuickswapRouter: Invalid pair address.");
    }
