...
interface IMasterChef {
    ...
    struct PoolInfo {
        ...
        uint256 accRewardPerShare; // Accumulated SUSHI per share, times 1e12. See below.
    }
...
import "../interfaces/IPoolFund.sol";
...
contract MiniChefV2 is Ownable {
    ...
    constructor(IERC20 _reward, IPoolFund _fund) {
        reward = _reward;
        fund = _fund;
    }
    ...
    function harvest(uint256 pid, address to) public {
        ...
        // Interactions
        fund.transferTo(to, _pendingReward);
    ...
    function setFund(IPoolFund _fund) public onlyOwner {
        fund = _fund;
