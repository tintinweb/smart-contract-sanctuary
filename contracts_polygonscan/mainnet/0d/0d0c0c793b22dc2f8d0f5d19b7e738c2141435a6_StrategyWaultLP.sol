...
import "../../interfaces/IUniswapV2Router.sol";
import "../../interfaces/IWBNB.sol";
import "./IWexPolyMasterChef.sol";
import "../StrategyLibrary.sol";
import "../StrategyBase.sol";

// Strategy main contract
contract StrategyWaultLP is StrategyBase {
    using SafeERC20 for IERC20;

    uint256 public override wantLockedTotal;
    IWexPolyMasterChef public masterChef;
    ...
    constructor(
        address vaultMaster,
        address _swapRouter,
        IWexPolyMasterChef _masterChef,
        uint256 _poolId
    ) StrategyBase() {
        owner = vaultMaster;
    ...
    function pendingReward() external view override returns (uint256) {
        return masterChef.pendingWex(poolId, address(this));
    }
    ...
    function _farm() internal {
        ...
        masterChef.deposit(poolId, IERC20(wantAddress).balanceOf(address(this)), false);
    }

    function _unfarm(uint256 _wantAmt) internal virtual {
        masterChef.withdraw(poolId, _wantAmt, true);
    }
}