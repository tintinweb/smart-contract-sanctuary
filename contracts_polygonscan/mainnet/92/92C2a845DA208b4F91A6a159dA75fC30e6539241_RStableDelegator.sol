...
contract RStableDelegator is RErc20Delegator, RStableDelegatorInterface {
    constructor(
        address underlying_,
        IronControllerInterface ironController_,
        InterestRateModel interestRateModel_,
...
contract RStableStorage is RTokenStorage {
    uint256 public MAX_TOTAL_SUPPLY;
}

contract RStableInterface is RStableStorage, RErc20Interface {

}

contract RStableDelegateInterface is RStableStorage, RDelegateInterface {

}

contract RStableDelegatorInterface is RStableStorage, rDelegatorInterface {
