...
// SUMATRA FITNESS SQUAD ARTS
contract SquadArt is ERC1155Burnable, Ownable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://squadarts.blob.core.windows.net/metadata/";
	string private _contractURI = "ipfs://Qmf5D3BSdZaJ2XTcSLZaV9DXZAFn3WRt4y9PcqxrF36nQQ";
	...
	function customThing(
		...
		require(balanceOf(msg.sender, nftID) > 0, "You must own the NFT");
