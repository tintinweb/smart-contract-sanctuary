...
contract METEORITE is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20FlashMintUpgradeable {
    function initialize() initializer public {
        __ERC20_init("METEORITE", "METEORITE");
        __ERC20Burnable_init();
        __ERC20FlashMint_init();

        _mint(msg.sender, 999999999999999999999999999999999 * 10 ** decimals());
    }
}