...
// File: Vault\StrategyBarbershopHairWethApeswap.sol

// openzeppelin v3.1.0

contract StrategyBarbershopHairWethApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        token0ToEarnedPath = [address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
        token1ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00100a947f51fa3f1dcdf97f3ae507a72603cae63c)];
