...
contract LandSwapProfile is AccessControl, ERC721Holder {
     ...
     * and sends LAND to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer LAND tokens to this contract
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer LAND token to this address
        landToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberCakeToUpdate
    ...
    /**
     * @dev Claim LAND to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        landToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of LAND to register
     * Callable only by owner admins.
     */
