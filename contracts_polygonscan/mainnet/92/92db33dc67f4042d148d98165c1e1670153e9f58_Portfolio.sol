...
contract Portfolio is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Portfolio';
    ...
    uint256 private _tTotal = 775000000000000 * _DECIMALFACTOR;
    ...
    uint256 private _CHARITY_FEE = 500;
    uint256 private constant _MAX_TX_SIZE = 775000000000000 * _DECIMALFACTOR;
