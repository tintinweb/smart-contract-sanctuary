...
contract CardsWithWordsWinterHolidays is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 2.5 ether;
  uint256 public maxSupply = 536;
  uint256 public maxMintAmount = 50;
  uint256 public maxCharLimit = 250;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    Card memory newCard = Card("I Wish You a Merry Christmas and a Happy, Healthy & Peaceful Year...I hope 2022 brings you the best of all things. Thank you for being a friend. Your Friend, AFAC");
