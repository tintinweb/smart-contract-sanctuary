...
contract KingDomNFT is Ownable, ReentrancyGuard, Gamificable, ERC721Holder {
    ...
    function withdraw() external nonReentrant {
        ...
        if (_amount > 0) {
            ...
            if (user.hasNFT) {
                ...
                //return nft to user
                theEndlessFactoryNFT.safeTransferFrom(address(this), msg.sender, user.nftID); 
            }
    ...
    function _initializeNFT(uint256 _nftID, address _userAddress) internal  {
        ...
        if (!nftIDs[_nftID]) {
            if (theEndlessFactoryNFT.ownerOf(_nftID) == _userAddress) {
                ...
                theEndlessFactoryNFT.safeTransferFrom(msg.sender, address(this), _nftID);
