...
contract AutoglyphsonPolygon {
    ...
    uint public constant PRICE = 25000 finney;

    
    address public constant BENEFICIARY = 0xeB58c625A1b8608447909A7157D1714C5CcddbF9;
    ...
    string internal nftName = "Autoglyphs on Polygon";
    string internal nftSymbol = "M☵";
