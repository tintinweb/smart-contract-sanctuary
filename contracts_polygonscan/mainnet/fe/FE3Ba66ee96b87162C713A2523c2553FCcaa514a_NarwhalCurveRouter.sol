...
// File: contracts/interfaces/ICurveRouter.sol
...
// File: contracts/interfaces/ICurveRouterV2.sol
...
interface ICurveRouterV2 {
      ...
      // function get_dy(int128 i, int128 j, uint256 dx) external view returns (uint256 dy);
      // def get_dy_underlying(i: int128, j: int128, dx: uint256) -> uint256:
      function get_dy_underlying(uint256 i, uint256 j, uint256 dx) external view returns (uint256 dy);
...
// File: contracts/routes/NarwhalCurveRouter.sol
...
contract NarwhalCurveRouter is INarwhalTradingRoute, WhitelistedRole, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    ICurveRouterV2 public constant curvePool = ICurveRouterV2(0x3FCD5De6A9fC8A99995c406c77DDa3eD7E406f81);
    IERC20 public constant dai = IERC20(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063); // 0
    IERC20 public constant usdc = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174); // 1
    IERC20 public constant usdt = IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F); // 2
    IERC20 public constant wbtc = IERC20(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6); // 3
    IERC20 public constant weth = IERC20(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619); // 4
        ...
        returns(uint256 _destAmount)
    {
        ...
        curvePool.exchange_underlying(i, j, _srcAmount, 0, address(this));
