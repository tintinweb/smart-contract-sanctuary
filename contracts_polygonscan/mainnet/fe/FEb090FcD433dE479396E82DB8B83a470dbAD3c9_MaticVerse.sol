...
contract MaticVerse is ERC20, Ownable {
    ...
    bool public taxPause = false;
    bool public BuyTax = true;
    bool public SellTax = true;
    ...
    constructor() public ERC20("MaticVerse", "Mverse") {
        ...
        _marketingWallet = 0xa7DB599afFE56F4A8eb65Ec397a51769D1915576;
        _devWallet = 0x0e07F17bedf97Df7bACC16ccE456b032d13fB691;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 1000000, "MaticVerse: gasForProcessing must be between 200,000 and 500,000");
    ...
    function TurnOn_Trading() external onlyOwner{
        swapEnabled = true;
    }
    
    function TurnOff_Trading() external onlyOwner{
        swapEnabled = false;
    }
    
    function TurnOn_BuyTax() external onlyOwner{
        BuyTax = true;

    }
    
    function TurnOff_BuyTax() external onlyOwner{
        BuyTax = false;

    }

    function TurnOn_SellTax() external onlyOwner{
        SellTax = true;

    }   
    
    function TurnOff_SellTax() external onlyOwner{
        SellTax = false;
...
contract MaticVerseDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("MATICVERSE_Dividend_Tracker", "MVERSE_Dividend_Tracker") {
        claimWait = 3600;
