...
*  \ \________\ \      / / /       / / /    \/_/  / / /   / / /   / / /    / / /    / / /  
*   \/________/\ \    / / /  _    / / /          / / /   / / /   / / /    / / /    / / /   
*             \ \ \  / / /_/\_\  / / /________  / / /___/ / /___/ / /__  / / /    / / /    
*              \ \_\/ /_____/ / / / /_________\/ / /____\/ //\__\/_/___\/ / /    / / /     
*               \/_/\________/  \/____________/\/_________/ \/_________/\/_/     \/_/          
*/
...
// File: contracts/FortyTwoCoin.sol
...
// FORTYTWO
contract FortyTwo is Ownable, ERC20('42', 'FORTYTWO') {
    ...
    constructor(
        ...
        require(_burnPercent <= 10e18 && _burnPercent>=1e18 || _burnPercent == 0, 'burn: 42');
        lpaddr = _lpaddr;
    ...
    function setBurnPercent(uint256 _burnPercent) public {
        require(msg.sender == lpaddr, "dev: 42");
        require(_burnPercent <= 10e18 && _burnPercent>=1e18 || _burnPercent == 0, 'burn: 42');
        burnPercent = _burnPercent;
    }
