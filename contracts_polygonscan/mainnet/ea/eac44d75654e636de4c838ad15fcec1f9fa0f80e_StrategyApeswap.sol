...
abstract contract StrategyLPBase is StrategyBase {
    ...
    function convertDustToEarned() external virtual override nonReentrant whenNotPaused {
        ...
        if (token0Amt > 0 && token0Address != earnedAddress) {
            IERC20(token0Address).safeTransfer(referralAddress, token0Amt);
        ...
        if (token1Amt > 0 && token1Address != earnedAddress) {
            // Swap all dust tokens to earned tokens
            IERC20(token1Address).safeTransfer(referralAddress, token1Amt);
           /* _safeSwap(
                token1Amt,
                token1ToEarnedPath,
                address(this)
...
// File: Vault\StrategyApeswapMATICBNB.sol
...
contract StrategyApeswap is StrategyLPBase {
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x005d47bAbA0d66083C52009271faF3F50DCc01023C), address(0x000d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270), address(0x00a649325aa7c5093d12d6f98eb4378deae68ce23f)];
        ...
        token1ToEarnedPath = [address(0x00a649325aa7c5093d12d6f98eb4378deae68ce23f), address(0x000d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270), address(0x5d47bAbA0d66083C52009271faF3F50DCc01023C)];
        wmaticToToken0Path = [address(0x000d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270)];
        wmaticToToken1Path = [address(0x000d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270), address(0x00a649325aa7c5093d12d6f98eb4378deae68ce23f)];
