...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0xFCd581Ec5e175889Aa3C8A798Ce27Df964934ba6; //contract wallet
...
contract BabyBonfire is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Bonfire", "FIRE") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        contractWallet = 0xFCd581Ec5e175889Aa3C8A798Ce27Df964934ba6;
        marketingWallet = 0x4E084C256a24e42744BF7F33DEd4314382D8ef07;
        a80DividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB
        b20DividendToken = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; //ETH

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); //BSC mainnet
        ...
        */
        _mint(deadAddress, 8 * (10**14) * (10**18));
        _mint(contractWallet, 2 * (10**14) * (10**18));
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted(from), "Baby Bonfire: sender blacklisted");
        require(!isBlacklisted(to), "Baby Bonfire: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "Baby Bonfire: sender blacklisted");
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "Baby Bonfire: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "Baby Bonfire: Account is not blacklisted");
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("A80_Dividend_Tracker", "A80_Dividend_Tracker", 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("B20_Dividend_Tracker", "B20_Dividend_Tracker", 0x3BA4c387f786bFEE076A58914F5Bd38d668B42c3) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
