...
// Root file: contracts/polygon/ChicCBTokenV2.sol
...
contract ChicCBTokenV2 is ERC20("Chic Cow & Bulls Token", "MILK"), OperatorAccess {
    ...
    function mintBatch(address[] memory _tos, uint256[] memory _amounts) external onlyOperator {
        uint len = _tos.length;

        require(len == _amounts.length, "Wrong length");
