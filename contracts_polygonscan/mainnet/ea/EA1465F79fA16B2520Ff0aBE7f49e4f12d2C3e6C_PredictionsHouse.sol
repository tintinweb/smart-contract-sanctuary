 ...
 * @title CWJPrediction
 */
contract PredictionsHouse is Ownable, Pausable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    uint constant public EV_CLAIM=1; 
    uint constant public EV_BEAR=4; 
    uint constant public EV_BULL=5;  
    ...
    */        
    ...
    function claim(uint256[] calldata epochs) external nonReentrant notContract {
        ...
        for (uint256 i = 0; i < epochs.length; i++) {
            ...
            reward += addedReward;
            //console.log("addedReward: %i",addedReward);
    ...
    */
    ...
    function claimTreasury() external nonReentrant onlyAdmin {
        ...
        treasuryAmount = 0;
        IRouter(routerContract).treasuryTransfer(tokenAddress,currentTreasuryAmount);  
