...
// File: Vault\StrategyWaultGenxWexpolyWault.sol

// openzeppelin v3.1.0

contract StrategyWaultGenxWexpolyWault is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x003ecdeb8fc5023839b92b0c293d049d61069e02b1)];
        earnedToToken1Path = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        token0ToEarnedPath = [address(0x003ecdeb8fc5023839b92b0c293d049d61069e02b1), address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        token1ToEarnedPath = [address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x004c4bf319237d98a30a929a96112effa8da3510eb), address(0x003ecdeb8fc5023839b92b0c293d049d61069e02b1)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x004c4bf319237d98a30a929a96112effa8da3510eb)];
    }
