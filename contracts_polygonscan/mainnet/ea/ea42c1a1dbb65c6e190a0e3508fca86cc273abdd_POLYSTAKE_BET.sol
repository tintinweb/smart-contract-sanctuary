...
contract POLYSTAKE_BET{
    ...
    function updateBetSettings(uint maxPLayers, uint endTime, uint minAmount, bool enabled, string calldata title, string calldata name1, string calldata name2, string calldata name3) external onlyOwner {
