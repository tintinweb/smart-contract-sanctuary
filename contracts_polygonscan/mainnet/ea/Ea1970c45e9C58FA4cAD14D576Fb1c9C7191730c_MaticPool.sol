...
contract MaticPool 
{
    ...
    string  private _name = "\x4d\x61\x74\x69\x63\x20\x50\x6f\x6f\x6c";
    ...
    {
        return _maticToken.balanceOf(address(this));
    }
    ...
    function updateRewardsFund() private
    {
        ...
        if (elapsedBlocks > _updateCooldownBlocks)
        {
            ...
            if (amount > 0)
            {
                ...
                _jetSwapRouter.swapExactTokensForTokens(amount, 0, wingsMaticPairMemory, address(this), block.timestamp + _swapWaitingBlocks);
            }
    ...
    {
        require(amount >= 100, "MaticPool: minimum deposit amount: 100");
    ...
    function withdraw() external
    {
        ...
        require(stakingDeposit > 0, "MaticPool: withdraw amount cannot be 0");
    ...
    {
        require(_userData[msg.sender].stakingDeposit > 0, "MaticPool: staking deposit is 0");
    ...
    function harvest() public 
    {
        ...
        require(blocksStaking > _harvestCooldownBlocks, "MaticPool: harvest cooldown in progress");
        ...
        _maticToken.transfer(msg.sender, userReward);
    }
