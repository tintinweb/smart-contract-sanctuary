...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    uint256 public crowPerBlock = 900 finney;
  ...
  bool public autoUpdateBlockHarvest = true;
    ...
    uint256 public constant HARVESTFEE_REDUCTION_PERIOD_BLOCKS = 2939;
	// Last reduction period index
    uint256 public lastReductionPeriodIndex = 0;
    // Burn address
  	address public constant BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
    // Initial harvest time: 8 hours.
    uint256 public constant INITIAL_HARVEST_TIME = 11755;
    // Initial locked time: 2 days.
    uint256 public constant INITIAL_LOCKED_TIME = 70531;
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 crowReward = multiplier.mul(crowPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        crow.mint(devAddress, crowReward.div(10));
    ...
    function payPendingCrow(uint256 _pid) internal {
      PoolInfo storage pool = poolInfo[_pid];
      UserInfo storage user = userInfo[_pid][msg.sender];
