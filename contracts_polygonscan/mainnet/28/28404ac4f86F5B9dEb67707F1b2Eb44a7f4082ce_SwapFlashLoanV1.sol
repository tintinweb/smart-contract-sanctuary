...
contract SwapFlashLoanV1 is SwapV1 {
    ...
    function initialize(
        ...
        flashLoanFeeBPS = 7; // 8 bps
        protocolFeeShareBPS = 2; // 0 bps
    }
 ...
 * @notice Interface for the Invader fee IFlashLoanReceiver. Modified from Aave's IFlashLoanReceiver interface.
