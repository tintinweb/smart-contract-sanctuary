...
import "../GravityLPStrategy.sol";

contract StrategyGravity_GFI_WETH is GravityLPStrategy {

    address gfi_weth_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0x73933555527Ad78e1d2B318334c843D13BbDA9F8);
        address gfi_weth_lp = address(0x2AaBdA501253b3AEeB4bEe0Bf7B0d5Fd87B038EB);
...
/// @title Gravity LP Strategy
/// @author Chainvisions
/// @notice Strategy for Gravity Finance LPs.

contract GravityLPStrategy is BaseUpgradeableStrategy {
