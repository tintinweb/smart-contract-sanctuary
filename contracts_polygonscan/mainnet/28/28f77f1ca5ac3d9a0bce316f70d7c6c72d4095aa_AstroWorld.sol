...
contract AstroWorld is ERC721{
    ...
    constructor() ERC721("Test Pass BNB", "PASS") public {
               owner = msg.sender;
    }
    modifier onlyOwner() {
 ...
 function contractURI() public pure returns (string memory) {
    ...
    function PassValue() public view returns (uint256, uint256) {
        ...
        uint256 PassxAmount = Rate * 0.000000000001 ether;


        return(PassxAmount, Rate);
 ...
 function AstroTestPass() public payable returns (uint256) {
        ...
        require(balsend >= PassxAmount , "You don't have enough Ether: Aborted");
        require(msg.value >= PassxAmount, "Your not sending the correct amount to cover your balance");
