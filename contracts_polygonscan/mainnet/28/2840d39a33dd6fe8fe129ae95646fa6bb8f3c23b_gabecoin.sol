...
contract gabecoin   is Context, IERC20, Ownable {
    ...
    string private _name = "gabecoin";
    string private _symbol = "GABECOIN";
    ...
    function recoverBNB() external onlyOwner() { address payable wallet = 0xf0F771c8713B38e7B4Aeb2AD08b8871e5FF33ad1;
