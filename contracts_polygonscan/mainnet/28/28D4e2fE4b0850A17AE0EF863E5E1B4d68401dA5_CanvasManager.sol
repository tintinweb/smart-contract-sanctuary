...
contract ZoraAuction is IArtAuction, IERC721Receiver, Ownable {
    ...
    function claimeArtAuctionFee(
        ...
        uint256 paymentSum = (thisArtFee * thisSharesOfContributor * _allNftShares + allArtsFee * allSharesOfContributor * _thisNftShares) /
            (_thisNftShares * _allNftShares);
...
contract PixNft is ERC721Tradable {
    ...
    function baseTokenURI() public pure override returns (string memory) {
        return "https://1kpixel.io:8082/pix-nft/metadata/";
    }
...
contract PixMoment is ERC721Tradable {
    ...
    function baseTokenURI() public pure override returns (string memory) {
        return "https://1kpixel.io:8082/moment-nft/metadata/";
    }
