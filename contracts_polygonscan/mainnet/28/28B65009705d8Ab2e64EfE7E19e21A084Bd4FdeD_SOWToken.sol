...
contract SOWToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked DeFarm", "SOW", 9) ERC20Permit() {
    ...
    /**
        @notice increases DeFarm supply to increase staking balances relative to profit_
