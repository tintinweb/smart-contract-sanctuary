...
// File: contracts/farms/olive/OliveBurner.sol
...
contract OliveBurner is Ownable {
    ...
    function burn() public onlyOwner {
        uint256 bal = olive.balanceOf(address(this));
        olive.safeTransfer(dead, bal);
    }
    ...
    function recoverToken(address _token, uint256 _amount, address _to) public onlyOwner {
        require(_token != address(olive), "!olive");
