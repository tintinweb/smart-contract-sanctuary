...
contract StrategyQuickSwap is Ownable, ReentrancyGuard, Pausable {
    ...
    address public quickSwapAddress; //StakingRewards Contract
    address public wantAddress;  //Token que se deposita
    address public token0Address; // sandman
    address public token1Address; // matic
    address public earnedAddress; // sandman
    
    address public uniRouterAddress = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // router
    address public constant usdcAddress = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; // token
    address public constant fishAddress = 0x3a3Df212b7AA91Aa0402B9035b098891d276572B; // sandman token
    address public constant rewardAddress = 0x917FB15E8aAA12264DCBdC15AFef7cD3cE76BA39; // strategysandman
    address public constant vaultAddress = 0x4879712c5D1A98C0B88Fb700daFF5c65d12Fd729; // vaultchef
    address public constant feeAddress = 0xe4D4efdF9D4A4F77864eDCc35b8c1524ed80E012; // wallet
    address public constant withdrawFeeAddress = 0xe4D4efdF9D4A4F77864eDCc35b8c1524ed80E012; // wallet
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            IStrategySand(rewardAddress).depositReward(usdcAfter);
