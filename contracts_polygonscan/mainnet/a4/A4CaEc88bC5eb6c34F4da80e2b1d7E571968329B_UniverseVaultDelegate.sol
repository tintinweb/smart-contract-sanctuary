...
contract UniverseVaultDelegate is Ownable, UpgradeableProxy, UniverseVaultBaseStorage{
...
library PositionNFTUtil {
    ...
    function nftStakeAll(IUniverseVaultConfig config, address poolAddress, uint256 tokenId) internal{
    ...
    function nftStake(IUniverseVaultConfig config, IUniswapV3Staker.IncentiveKey memory key, uint256 tokenId) internal{
        ...
        if(owner == address(this)){
            ...
            nftStakeAll(config, address(key.pool), tokenId);
        }
    }
