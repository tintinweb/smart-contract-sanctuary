...
/**
 *Submitted for verification at https://houseprofit.center/ on 2021-07-19
*/
/*
 *
 *   [USAGE INSTRUCTION]
 ...
 *   2) Choose one of the tariff plans, enter the MATIC amount (5 MATIC minimum) using our website "Stake MATIC" button
 *   3) Wait for your earnings
 *   4) Withdraw earnings any time using our website "Withdraw" button
 *
 *   [INVESTMENT CONDITIONS]
 *
 *   - Basic interest rate: + 0.4% every 24 hours (~0.0166% hourly) - only for new deposits
 *   - Minimal deposit: 5 MATIC, no maximal limit
 *   - Total income: based on your tarrif plan (from 5% to 8.5% daily!!!) + Basic interest rate !!!
...
contract HouseProfitMatic {
	...
	function invest(address referrer, uint8 plan) public payable {
        ...
        dev.transfer(msg.value.mul(7).div(100));
        pro.transfer(msg.value.mul(7).div(100));
