...
// File: Vault\StrategyQuickswapUcoEthQuickswap.sol

contract StrategyQuickswapUcoEthQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x003c720206bfacb2d16fa3ac0ed87d2048dbc401fc)];
        ...
        token0ToEarnedPath = [address(0x003c720206bfacb2d16fa3ac0ed87d2048dbc401fc), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        ...
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x003c720206bfacb2d16fa3ac0ed87d2048dbc401fc)];
