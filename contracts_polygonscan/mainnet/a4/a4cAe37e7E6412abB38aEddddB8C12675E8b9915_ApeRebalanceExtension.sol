...
// hevm: flattened sources of src/ape-together/ApeRebalanceExtension.sol
// SPDX-License-Identifier: Apache License AND MIT
pragma solidity =0.6.10 >=0.6.0 <0.8.0 >=0.6.2 <0.8.0;
...
////// lib/index-coop-smart-contracts/contracts/interfaces/ISetToken.sol
 ...
 */
interface ISetToken_1 is IERC20 {
...
////// lib/index-coop-smart-contracts/contracts/interfaces/IBaseManager.sol
/*
...
interface IBaseManager {
    function setToken() external returns(ISetToken_1);
...
////// lib/index-coop-smart-contracts/contracts/interfaces/IGeneralIndexModule.sol
/*
...
interface IGeneralIndexModule {
    ...
    function raiseAssetTargets(ISetToken_1 _setToken) external;
    ...
    function setRaiseTargetPercentage(ISetToken_1 _setToken, uint256 _raiseTargetPercentage) external;
    ...
    function setAnyoneTrade(ISetToken_1 _setToken, bool _status) external;
    function initialize(ISetToken_1 _setToken) external;
}

////// lib/index-coop-smart-contracts/contracts/lib/AddressArrayUtils.sol
/*
    Copyright 2020 Set Labs Inc.
...
////// lib/index-coop-smart-contracts/contracts/lib/BaseExtension.sol
/*
    Copyright 2021 Set Labs Inc.
...
abstract contract BaseExtension {
    using AddressArrayUtils_1 for address[];
...
////// lib/index-coop-smart-contracts/contracts/adapters/GIMExtension.sol
/*
...
////// lib/index-coop-smart-contracts/contracts/lib/PreciseUnitMath.sol
/*
    Copyright 2020 Set Labs Inc.
...
////// lib/openzeppelin-contracts/contracts/utils/SafeCast.sol
...
////// lib/set-protocol-v2/contracts/interfaces/external/IUniswapV2Factory.sol
/* pragma solidity 0.6.10; */
...
////// lib/set-protocol-v2/contracts/interfaces/external/IUniswapV2Router.sol
/*
    Copyright 2020 Set Labs Inc.
...
////// src/ape-together/ApeRebalanceExtension.sol
/* pragma solidity 0.6.10; */
/* pragma experimental ABIEncoderV2; */
...
contract ApeRebalanceExtension is GIMExtension {
    using PreciseUnitMath_1 for uint256;
