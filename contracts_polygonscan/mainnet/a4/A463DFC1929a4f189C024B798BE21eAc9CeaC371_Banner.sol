...
contract Banner is ERC721Enumerable, Ownable {
    ...
    uint256 public preSaleMaxSupply = 25;
    uint256 public maxMintAmountPresale = 3;
    uint256 public maxMintAmount = 5;
    uint256 public nftPerAddressLimitPresale = 3;
    uint256 public nftPerAddressLimit = 10;
    uint256 public preSaleDate = 1637355600;
    uint256 public preSaleEndDate = 1637442000;
    uint256 public publicSaleDate = 1637460000;
  ...
  function presaleValidations (uint256 _ownerMintedCount, uint256 _mintAmount, uint256 _supply)
internal {
            uint256 actualCost;
            ...
            require (block.timestamp < preSaleEndDate,"Presale has ended, please wait for public sale");
    }
...
internal {
    ...
    returns (string memory)
  {
    ...
    function reserveNFTs() public onlyOwner {
        ...
        require(
        supply +(10) < maxSupply, "Not enough NFTs to reserve"
     );
     for (uint i = 0; i < 10; i++) {
