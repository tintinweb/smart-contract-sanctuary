...
// File: Vault\libs\IQuickswap.sol
...
// File: Vault\libs\IDragonLair.sol
...
// File: Vault\StrategyQuickswapIrisErowanQuickswap.sol

contract StrategyQuickswapIrisErowanQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
	
	address public dQuickAddress = 0xf28164A485B0B2C90639E47b0f377b4a438a16B1;
    ...
    constructor(
        ...
        earnedToSiriusPath = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x00a7051c5a22d963b81d71c2ba64d46a877fbc1821), address(0x003dc6052a693e4a2fc28eb2ea12fe0cfd3bd221d1)];
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x00a7051c5a22d963b81d71c2ba64d46a877fbc1821)];
        token0ToEarnedPath = [address(0x003dc6052a693e4a2fc28eb2ea12fe0cfd3bd221d1), address(0x00a7051c5a22d963b81d71c2ba64d46a877fbc1821), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token1ToEarnedPath = [address(0x00a7051c5a22d963b81d71c2ba64d46a877fbc1821), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x00a7051c5a22d963b81d71c2ba64d46a877fbc1821), address(0x003dc6052a693e4a2fc28eb2ea12fe0cfd3bd221d1)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x00a7051c5a22d963b81d71c2ba64d46a877fbc1821)];
    }
	...
	// Harvest dQuick not quick
        IQuickswap(masterChef).getReward();
    // Convert dQuick to Quick
	   uint256 balance = IERC20(dQuickAddress).balanceOf(address(this));
	   IDragonLair(dQuickAddress).leave(balance);// we now have quick
    }
