...
abstract contract BaseStrategy is Ownable {
    ...
    address public constant sushiRouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //Dfyn router
...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        eth_sushi_path = new address[](2);
        eth_sushi_path[0] = eth;
        eth_sushi_path[1] = sushi;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            _swapUniswapWithPath(gfi_eth_path, _harvestBalance);
            ...
            _swapUniswapWithPathSushi(eth_sushi_path, _ethBalancePost);
        }
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0x0Dbe8999Cde32164340411897a7DD73654F82571;
    address public Want_Token = 0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a;
