...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    modifier onlyTradableTexugo (address from, uint256 tokenId) {
        require(tokenId < 11, "Out of tokenId");
...
contract ContractNft is ERC721, Ownable {
    ...
    uint256 public texugosRemainingToAssign = 11;

    uint256 public constant MAX_RESERVE = 2;
    ...
    function withdrawAll() external {
        ...
        require(msg.sender.send((payable(address(this))).balance));
    }
    ...
    function mintNFT(uint256 amount) public payable {
        ...
        for (uint i = 0; i < amount; i++) {
            randIndex = _random() % texugosRemainingToAssign;
