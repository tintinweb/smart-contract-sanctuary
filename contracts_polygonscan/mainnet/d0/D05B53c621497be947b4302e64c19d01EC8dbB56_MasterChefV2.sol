...
// will be transferred to a governance smart contract once QUOKK is sufficiently
...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of QUOKKs
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. QUOKKs to distribute per block.
        uint256 lastRewardBlock;  // Last block number that QUOKKs distribution occurs.
        uint256 accQuokkaPerShare;   // Accumulated QUOKKs per share, times 1e12. See below.
    ...
    // QUOKK tokens created per block.
    ...
    // The block number when QUOKK mining starts.
    ...
    // Update the given pool's QUOKK allocation point and deposit fee. Can only be called by the owner.
    ...
    // View function to see pending QUOKKs on frontend.
    ...
    // View function to see if user can harvest QUOKKs.
    ...
    function updatePool(uint256 _pid) public {
        ...
        // Automatically mint some QUOKK for the lottery pot
    ...
    // Deposit LP tokens to MasterChef for QUOKK allocation.
    ...
    // Safe quokka transfer function, just in case if rounding error causes pool to not have enough QUOKKs.
