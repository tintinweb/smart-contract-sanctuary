...
// File: contracts/HairToken.sol

/* Grow some $HAIR at Barbershop.Finance!
...
contract HairToken is ERC20('Hair Token', 'HAIR'), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "HAIR::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "HAIR::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "HAIR::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "HAIR::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying HAIRs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "HAIR::_writeCheckpoint: block number exceeds 32 bits");
