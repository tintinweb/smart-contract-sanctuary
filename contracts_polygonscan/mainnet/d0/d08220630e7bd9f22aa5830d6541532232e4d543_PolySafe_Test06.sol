...
contract PolySafe_Test06 is Token {
    ...
    uint private constant MIN_MATIC_STAKE   = 1 ether; // 10 ether;
    uint private constant ADV_FEE           = 40;
    uint private constant LIMIT_AIRDROP     = 200 ether; // 10000 ether;
    ...
    uint private constant SELL_LIMIT        = 1000 ether; // 10000 ether; 
    ...
    function getCurrentDay() public view returns (uint) {
        return minZero(now, startTime) / TIME_STEP;
    }	
