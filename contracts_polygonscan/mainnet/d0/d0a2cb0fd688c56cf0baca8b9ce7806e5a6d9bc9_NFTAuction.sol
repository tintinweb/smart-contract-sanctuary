...
contract NFTAuction is Ownable, ReentrancyGuard {
    ...
    uint256 public royaltyPercentage= 200; 
    uint256 public ownerPercentage= 0;
    uint256 public settlePenalty= 1;    
    ...
    */
    ...
    {   
        ...
        if(_isERC20Auction(erc20Token)){    // if sale is ERC20
            ...
            uint royaltyAmount= totalAmount.mul(royaltyPercentage).div(10000);
            uint256 ownerAmount= totalAmount.mul(ownerPercentage).div(10000);
