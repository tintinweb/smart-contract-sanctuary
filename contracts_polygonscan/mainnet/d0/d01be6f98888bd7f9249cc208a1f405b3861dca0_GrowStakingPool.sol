...
contract GrowStakingPool is IGrowUpgradeableImplementation, IGrowStakingPool, Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    bytes32 override public constant CONTRACT_IDENTIFIER = keccak256("GrowStakingPool");
    ...
    function depositTo(uint256 amount, address userAddress) override external onlyRole(CONTROLLER_ROLE) {
