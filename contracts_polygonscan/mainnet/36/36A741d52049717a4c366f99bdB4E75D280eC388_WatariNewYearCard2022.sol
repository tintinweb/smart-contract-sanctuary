...
contract WatariNewYearCard2022 is  ERC721URIStorage  {

    address public owner;
    uint nftid = 1;
    
    string currentURI = "https://arweave.net/Noq_v9zaE_KBlybUW-O-q6XOfc9AzSQlTGno4gJGf2A";
    ...
    constructor() ERC721("WatariNewYearCard" , "2022" ) {
        owner = _msgSender();        
        }
