/**
 *
 * NFG (Non-Fungible Generatives) is an entity which at least contains one NFT and non-fungible data
 * generated by an algorithm which often refers to generative artificial intelligence.
 *
 *
...
/**
 * Each NFG is generated with random weight of smart dust (information substance)
 * 63% has 0.005 mg, 15%-0.006 mg, 10%-0.009 mg, 4%-0.011 mg
 * the seeds range from 0 to 2^32 -1 but only 1024 seeds could be used to generate NFG
 * the seed could be reused to mint new NFG and the owner of this seed just pay gas fee
 * otherwise need to pay 10 MATIC
 */
contract TANENMOSSAI is ERC721URIStorage {
    uint256[] dust_scale = [63, 15, 10, 8, 4];

    string[] private dusts = [
        "0.005mg",
        "0.006mg",
        "0.008mg",
        "0.009mg",
    ...
    address platformWallet = 0x19aa5b4bB6Ca72515845D6Faf1A69c1e06ff20C0;

    uint256 mintPrice = 10000000000000000000;

    uint256 private _seedUseNum = 0;

    constructor() ERC721("Tanen MOSSAI NFG", "TM") {}
    ...
    function mint(
        ...
        if (tokenId == 0) {
            ...
            _seedUseNum++;
            require(_seedUseNum <= 1000, "Reached the upper limit of the coin");
        } else {
