...
contract PixelMan is ERC721, Ownable {
    
    using SafeMath for uint256;

    string public PMAN_PROVENANCE = "";

    uint256 public constant MAX_TOKENS = 1000;
    
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 20;

    uint256 private price = 100000000000000000; // 0.025 Ether

    bool public isSaleActive = true;

    constructor() ERC721("Pixel Man", "PMAN") {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        PMAN_PROVENANCE = _provenanceHash;
    }
