...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://supercharger.origintrail.io/tracies/";
    }
...
//    }
    ...
    function _mint(address to) public onlyOwner {
        ...
        require(_lastTokenId<_totalSupply, "ERC721: total number of minted tokens exceeded total supply");
