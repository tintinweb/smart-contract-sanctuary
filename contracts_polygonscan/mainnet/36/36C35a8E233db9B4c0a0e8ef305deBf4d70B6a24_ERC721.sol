...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    modifier onlyOwner() {
         require(_msgSender() == _owner, "ERC721: caller is not the owner");
        _;
    }
    ...
    /**
     * @dev Contract can send ERC20 tokens
     */
    ...
    /**
     * Create new token and add URI (to must be a wallet).
     */
    ...
    /**
     * @dev Returns the URI from the corresponding token ID
     */
