...
// File: contracts/common/StructuredLinkedList.sol
...
library StructuredLinkedList {
     ...
     */
    function getSortedSpot(List storage self, address _structure, uint256 _value, bool _bGt) internal view returns (uint256) {
        if (sizeOf(self) == 0) {
            return 0;
        }
...
// File: contracts/common/BasicStruct.sol
