...
contract sNUDESToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked NUDES", "sNUDES", 9) ERC20Permit() {
    ...
    /**
        @notice increases sNUDES supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sNUDES
