...
contract PolycloudYield is Context, IERC20, Ownable {
...
contract Polycloud is PolycloudYield, NativeMetaTransaction, ContextMixin {
    constructor() PolycloudYield() {
