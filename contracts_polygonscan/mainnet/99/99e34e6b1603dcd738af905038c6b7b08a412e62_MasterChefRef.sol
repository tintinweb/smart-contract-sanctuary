...
contract TokenTaxLP is BEP20 {
    ...
    uint256 public taxSwitchCheckpoint;
    ...
    constructor(string memory name, string memory symbol) public BEP20(name,symbol) {
        ...
        taxSwitchCheckpoint = block.number + 10800; //6 hours
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override{
        ...
        require(amount < maxAmt || sender == owner() || sender == address(this) || sender == _operator || recipient == BURN_ADDRESS, "Antiwhale");
        require(lastTransferBlock[sender] < block.number || sender == owner() || sender == address(this), "Antibot - 1 txn per block");
