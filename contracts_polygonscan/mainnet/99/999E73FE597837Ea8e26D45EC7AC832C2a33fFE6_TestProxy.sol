...
contract Internals {
     ...
     * @dev Stores a new address in the EIP1967 admin slot.
     */
    function _setDummyImplementation(address newDummyImplementation) internal {
        require(newDummyImplementation != address(0), "ERC1967: new newDummyImplementation is the zero address");
        getAddressSlot(_DUMMY_IMPLEMENTATION_SLOT).value = newDummyImplementation;
    }
...
contract AdminStuff is Internals {
    ...
    /**
     * @dev sets new dummy-implemenation.
     */
    function setDummyImplemenation(address newDummyImplementation) onlyAdmin external {
        _setDummyImplementation(newDummyImplementation);
    }
...
abstract contract Proxy is AdminStuff {
    ...
    /**
     * @dev returns dummy-implemenations's address.
     */
