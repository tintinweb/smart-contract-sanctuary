 ...
 * a PRNTR/BUSD or PAPR/BUSD liquidity pair. And breaks a liquidity pair to single assets
 *
 */
...
contract Zapper is Ownable, IZapper {
    ...
    address public trustedRewardTokenAddress = 0x016c8dA9D916905a00eF26a2e7dC2EE67B6020cF; 
    ...
    constructor (address _pcsV1Router, address _WBNB, address _PAPR, address _PRNTR, address _BUSD, address _PAPRBUSD, address _PRNTRBUSD) public {
