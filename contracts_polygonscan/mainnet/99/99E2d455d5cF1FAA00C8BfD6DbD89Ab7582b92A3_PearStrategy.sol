...
contract PearStrategy is BaseStrategy {
    ...
    address private constant PEAR = 0xc8bcb58caEf1bE972C0B638B1dD8B0748Fdc8A44;
    address public otherToken;

    //Other contracts
    address private constant WAULT_ROUTER = 0x3a1D87f206D12415f5b0A33E786967680AAb4f6d;
    address private constant MASTER_CHEF = 0xb12FeFC21b12dF492609942172412d4b75CbC709;
    ...
    function balanceOfPool() public override view returns (uint256) {
        (uint256 amount,,,,) = IPearChef(rewards).userInfo(poolId, address(this));
        return amount;
    }
    ...
    function deposit() public override {
        uint256 _want = IERC20(want).balanceOf(address(this));
        if (_want > 0) {
            IMasterChef(rewards).deposit(poolId, _want, 0x8AcBb9cBc2E3A8286e2A0f5610470cf81F541764);
        }
    }
