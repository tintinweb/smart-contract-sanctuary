...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        usdc_pusd_path = new address[](2);
        usdc_pusd_path[0] = usdc;
        usdc_pusd_path[1] = pusd;
    }
    ...
    function harvest() public override {
        ...
        if (_pyqBalance > harvestCutoff){
            ...
            //Swap all PYQ for USDC
            _swapUniswapWithPathForFeeOnTransferTokens(pyq_usdc_path, _pyqBalance);
            ...
            //Swap 1/2 USDC to PUSD
            uint256 _usdcbalance = IERC20(usdc).balanceOf(address(this));
            _swapUniswapWithPath(usdc_pusd_path, _usdcbalance.div(2));
