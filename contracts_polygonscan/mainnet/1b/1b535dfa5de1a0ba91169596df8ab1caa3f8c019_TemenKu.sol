...
/*
The Contract is Owned By: https://www.TemenKu.com
*/
...
contract TemenKu is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "TemenKu";
    string public constant symbol   = "TMENK";
    ...
    // When TemenKu becomes an utility token with 0% tax, withdrawToken function will allow us to remove the remaining token inside the contract address.
