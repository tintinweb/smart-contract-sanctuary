...
contract Seed is Ownable{
    ...
    uint256 internal nextRoundTime=0;
    uint256[] internal validClaimTime;
    ...
    **/
    ...
    function claim() public returns (bool){
        require(isStarted, "Owner must be start first");
        require(block.timestamp >= validClaimTime[1], "Too early");
    ...
    function getRatioAfterRound() public view returns (uint8[] memory){
        return ratioAfterRound;
    }
