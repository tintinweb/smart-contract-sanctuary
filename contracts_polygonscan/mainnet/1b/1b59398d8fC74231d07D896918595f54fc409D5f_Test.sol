...
contract Test is Ownable, PolygonArbitrageBot {
    ...
    function _createOptionString(PolygonArbitrageOption memory option) view internal returns(string memory)
    {
        ...
        string memory row1 = string(abi.encodePacked("Exchange: \t\t", PolygonExchanges.getExchangeName(option.aToB.exchange), " / ", PolygonExchanges.getExchangeName(option.bToA.exchange), "\n"));
...
contract PolygonTradingHub is LibraryContract, QuickSwapTrader, CafeSwapTrader, JetSwapTrader, SushiSwapTrader {
    ...
    {
        uint256 amountIn = _quickSwapGetAmountIn(_tokenIn, _tokenOut, _amount);
        ...
        amountIn = _quickSwapGetAmountInUsingPath(path, _amount);
    ...
    {
        return _quickSwapGetAmountOut(_tokenIn, _tokenOut, _amount);
    }

    function _polygonTradingHubSwapToken(kPolygonExchange _exchange, address _tokenIn, address _tokenOut, uint256 _amount) internal returns(bool)
    {
    ...
    function _polygonTradingHubGetForcast(kPolygonExchange _exchange, address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(PolygonTradeForecast memory)
    {
...
contract QuickSwapTrader is UniSwapV2Trader {
    ...
    function _quickSwapSwapToken(address _tokenIn, address _tokenOut, uint256 _amount) internal returns(bool)
    {
        return _uniSwapV2RouterSwapToken(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _quickSwapGetAmountOut(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountOut(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _quickSwapGetAmountIn(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountIn(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _quickSwapGetAmountInUsingPath(address[] memory _path, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountInByPath(tradingRouter, _path, _amount);
    }
...
contract CafeSwapTrader is UniSwapV2Trader {
    ...
    function _cafeSwapSwapToken(address _tokenIn, address _tokenOut, uint256 _amount) internal returns(bool)
    {
        return _uniSwapV2RouterSwapToken(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _cafeSwapGetAmountOut(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountOut(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _cafeSwapGetAmountIn(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountIn(tradingRouter, _tokenIn, _tokenOut, _amount);
    }
...
contract JetSwapTrader is UniSwapV2Trader {
    ...
    function _jetSwapSwapToken(address _tokenIn, address _tokenOut, uint256 _amount) internal returns(bool)
    {
        return _uniSwapV2RouterSwapToken(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _jetSwapGetAmountOut(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountOut(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _jetSwapGetAmountIn(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountIn(tradingRouter, _tokenIn, _tokenOut, _amount);
    }
...
contract SushiSwapTrader is UniSwapV2Trader {
    ...
    function _sushiSwapSwapToken(address _tokenIn, address _tokenOut, uint256 _amount) internal returns(bool)
    {
        return _uniSwapV2RouterSwapToken(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _sushiSwapGetAmountOut(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountOut(tradingRouter, _tokenIn, _tokenOut, _amount);
    }

    function _sushiSwapGetAmountIn(address _tokenIn, address _tokenOut, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountIn(tradingRouter, _tokenIn, _tokenOut, _amount);
    }
...
contract UniSwapV2Trader {
    ...
    function _uniSwapV2RouterGetAmountOut(IUniSwapV2Router02 _router, address _tokenInAddress, address _tokenOutAddress, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountOutByPath(_router, _createAddressPath(_tokenInAddress, _tokenOutAddress), _amount);
    }

    function _uniSwapV2RouterGetAmountIn(IUniSwapV2Router02 _router, address _tokenInAddress, address _tokenOutAddress, uint256 _amount) internal view returns(uint256)
    {
        return _uniSwapV2RouterGetAmountInByPath(_router, _createAddressPath(_tokenInAddress, _tokenOutAddress), _amount);
    }

    function _uniSwapV2RouterGetAmountOutByPath(IUniSwapV2Router02 _router, address[] memory _path, uint256 _amount) internal view returns(uint256)
    {
    ...
    function _uniSwapV2RouterGetAmountInByPath(IUniSwapV2Router02 _router, address[] memory _path, uint256 _amount) internal view returns(uint256)
    {
    ...
    function _uniSwapV2RouterSwapToken(IUniSwapV2Router02 _router, address _tokenInAddress, address _tokenOutAddress, uint256 _amount) internal returns(bool)
    {
        if (_amount == 0)
        {
            return false;
