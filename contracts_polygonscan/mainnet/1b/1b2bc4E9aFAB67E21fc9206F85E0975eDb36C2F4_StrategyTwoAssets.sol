...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getHarvestable() external override view returns (uint256) {
        return IMasterChef(rewards).pendingBeta(poolId, address(this));
    }
...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant rewardTokenAddr = 0xaC3090B7042FCA2cDBF233022e4a9823a032600c;
    // One or more farm tokens
    address public constant farmToken0Addr = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address public constant farmToken1Addr = 0xaC3090B7042FCA2cDBF233022e4a9823a032600c;
    // Fee token
    ...
    address public constant farmTokenRouterAddr = 0x5C6EC38fb0e2609672BDf628B1fD605A523E5923; // JetSwap router
    address public constant swapRouter0Addr = 0x5C6EC38fb0e2609672BDf628B1fD605A523E5923; // JetSwap router
    address public constant swapRouter1Addr = 0x5C6EC38fb0e2609672BDf628B1fD605A523E5923; // JetSwap router

    address public multiHarvest = 0x0000000000000000000000000000000000000000;

    // Other constants
    uint256 public constant underlyingPoolId = 15;
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public FARM_MASTER_CHEF = 0x9581EA83B4BCd5F2c5f1705382FBd80a11E57DcD;
    address public LP_TOKEN = 0xeB4EDB0a3802FFb6Fa7F0a9635a112dcB1774B03;
    constructor()
        public
