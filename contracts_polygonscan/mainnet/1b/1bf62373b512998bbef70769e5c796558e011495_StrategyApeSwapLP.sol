...
/* Stop by for a shave at Barbershop.Finance!
...
// File contracts/vaults/interfaces/ape/IMiniChefV2.sol
...
// File contracts/vaults/strategies/StrategyApeSwapLP.sol
...
contract StrategyApeSwapLP is StratManager, FeeManager {
    ...
    constructor(
        ...
        require(_outputToLp0Route[_outputToLp0Route.length - 1] == lpToken0, "outputToLp0Route[last] != lpToken");
