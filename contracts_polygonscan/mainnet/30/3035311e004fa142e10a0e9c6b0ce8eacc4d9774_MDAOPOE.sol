...
contract MDAOPOE is ERC721Enumerable, Ownable {
    ...
    constructor(uint256 mintingStart, string memory _uri, address poeToken) ERC721("MDAO POE", "MPOE") {
        mintingActive = false;
    ...
    */
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0
            ? string(abi.encodePacked(baseURI, Strings.toString(tokenId % 5), ".json")) //5 distinct nfts, modulo to choose which one
            : "";
    }
