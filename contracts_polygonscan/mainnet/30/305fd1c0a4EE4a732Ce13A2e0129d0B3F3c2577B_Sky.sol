...
contract Roller is Ownable,  VRFConsumerBase {
    ...
    constructor(address pTaker_, address refer_, address sky_) VRFConsumerBase(VRF_COORDINATOR, address(LINK_TOKEN)){
        pTaker = pTaker_;
        refer = refer_;
...
contract Cloud is Roller {
    ...
    constructor(address pTaker_,
                address refer_,
                address sky_) Roller(pTaker_, refer_, sky_){
...
contract Charge is Roller {
    ...
    constructor(
                ...
                address refer_,
                address sky_
                ) Roller(pTaker_, refer_, sky_){

    }

    function getBetInfo(uint256) internal pure override returns(uint256, uint256){
        return (98, 100);
    }
