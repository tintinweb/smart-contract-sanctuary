...
// File: TricksAndTreats.sol

contract TricksAndTreats is ERC721 {
    address private _owner;
    uint256 public tokenCounter;
    bool public saleStatus = false;
    bool public metaLOCK = true; //if true, metadata is still changable
    address payable wallet = 0x0f2AB8200DF18244ce81D44Bf619f4aB0671d3a6;
    constructor () public ERC721 ("Tricks And Treats!", "BOO"){
        tokenCounter = 1;
        _setBaseURI("ipfs://QmPyGNgHYZqcZqdiSXRvBo2QwwQPDfPQya3fQrLnLgKjHB/");
        _setOwner(wallet);
    }

    function mintTricksAndTreats() public {
        require(saleStatus);
        require(tokenCounter<1001);
        _safeMint(msg.sender, tokenCounter);
        tokenCounter = tokenCounter + 1;
    }

    function ownermintTricksAndTreats() public {
