...
contract StrategyPolyquity_PYD_USDC is PolyquityLPStrategy {

    address pyd_usdc_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0x9D726c2A884D3D21aB65A33B224B316192993EAb);
        address pyd_usdc_lp = address(0x77BCD2B9d087f4D4A33AE299Fcb8e47C701299d9);
        address pyd = address(0x0527c8C43250279D6Eb74dA1078193f5316fc9a0);
