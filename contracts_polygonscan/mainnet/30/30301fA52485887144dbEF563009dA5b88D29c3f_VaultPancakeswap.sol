...
abstract contract Vault is Ownable, ReentrancyGuard, Pausable, ERC20 {
    ...
    uint256 public controllerFee = 3500; // 35%
    uint256 public constant controllerFeeMax = 10000; // 100 = 1%
    uint256 public constant controllerFeeUL = 3500; // 35%

    uint256 public buyBackRate = 1500; // 15%
    uint256 public constant buyBackRateMax = 10000; // 100 = 1%
    uint256 public constant buyBackRateUL = 1500; // 15%

    uint256 public earnToBeliRate = 3000; // 30%
    ...
    uint256 public constant withdrawFeeFactorLL = 7000; // 30%
