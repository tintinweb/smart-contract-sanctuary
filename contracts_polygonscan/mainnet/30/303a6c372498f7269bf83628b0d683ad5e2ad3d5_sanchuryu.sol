...
contract sanchuryu is  ERC721URIStorage , ERC721Enumerable {

    address public owner;

    uint256 public nftid = 1;

    string currentURI = "https://www.arweave.net/BWZVdxgNhufxTj4G7Gg3eWFdeMdHhoJ9dCjNXXN28Tc";
    ...
    constructor() ERC721("sanchuryu" , "SANCHURYU" ) {
        owner = _msgSender();
    } 
