...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function setGalaxyNFTSetting(uint256 _burnNFTRate, uint8 _maxNFTBurn) external onlyOperator {
        require(_burnNFTRate <= 500, "ERROR::setGalaxyNFTSetting: invalid _burnNFTRate");
        require(_maxNFTBurn <= 50, "ERROR::setGalaxyNFTSetting: invalid _maxNFTBurn");
