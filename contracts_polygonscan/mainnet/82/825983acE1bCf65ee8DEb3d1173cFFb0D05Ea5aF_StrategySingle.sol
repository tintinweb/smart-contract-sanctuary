...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        gfi_matic_path = new address[](3);
        gfi_matic_path[0] = gfi;
        gfi_matic_path[1] = eth;
        gfi_matic_path[2] = matic;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_matic_path, _harvestBalancePost2);
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0xCFaf1e3fabF1fAE980258Fc643fBA9Fe1fB44655;
    address public Want_Token = 0x0Dfbf1A50bdcB570Bd0fF7Bb307313B553a02598;
