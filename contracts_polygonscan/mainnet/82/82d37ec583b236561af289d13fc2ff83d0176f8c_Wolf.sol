...
contract Wolf is Context, IERC20, Ownable {
    ...
    string private _name = 'wolfTest.io';
    string private _symbol = 'WOLFTest';
    ...
    constructor () {
     ...
     //TODO fix this for the 99 i used or remove completely. Possibly add the r minted total if it can ever hit 0
