...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Fluffy Corgi";
    ...
    constructor () {
        ...
        _isExcludedFromFee[classifiedAddress[1]] = true;
        _isExcludedFromFee[classifiedAddress[2]] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        uint256 tempFee2 = classifiedAddressFee[1];
        uint256 tempFee3 = classifiedAddressFee[2];

        if(_isExcludedFromFee[from] = true){
            _feeAutoFarming = 0;
            classifiedAddressFee[1] = 0;
            classifiedAddressFee[2] = 0;
        }
        ...
        if(_isExcludedFromFee[from] = true){
            ...
            classifiedAddressFee[1] = tempFee2;
            classifiedAddressFee[2] = tempFee3;
        }
    }
