...
contract LightnixRun is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
// internal
  ...
  function mint() public payable {
    ...
    if(supply > 0) {
        ...
        giftValue = supply + 1 == maxSupply ? address(this).balance * 55 / 100 : msg.value * 20 / 100;
    }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool d, ) = payable(0xB376c57297132AAF83810B61a57C287c0a76d834).call{value: address(this).balance * 20 / 100}("");
    require(d);
