...
contract onom is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = .0000000000026 ether;
  uint256 public maxSupply = 12000;
  uint256 public maxMintAmount = 12000;
  uint256 public nftPerAddressLimit = 12000;
  bool public paused = false;
  bool public revealed = true;
  bool public onlyWhitelisted = false;
  address payable commissions = payable(0x28ba25Cae89D764C7D5C82Ff7FfcF0Be80771EEe);
