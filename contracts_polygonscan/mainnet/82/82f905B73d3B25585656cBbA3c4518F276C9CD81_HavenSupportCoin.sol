...
abstract contract ERC20PermitUpgradeable is Initializable, ERC20Upgradeable, IERC20PermitUpgradeable, EIP712Upgradeable {
     ...
     */
    function __ERC20Permit_init(string memory) internal initializer {
        __Context_init_unchained();
        __EIP712_init_unchained("HavenCoin", "1");
        __ERC20Permit_init_unchained("HavenCoin");
    }
...
contract HavenSupportCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable{
    ...
    function initialize() initializer public {
        __ERC20_init("Haven Support Coin", "HVN");
        __ERC20Burnable_init();
        __ERC20Snapshot_init();
        __AccessControl_init();
        __Pausable_init();
        __ERC20Permit_init("Haven Support Coin");
    ...
    function recoverHavenSupportCoin(address tokenAddress, uint256 tokenAmount) public virtual {
