...
contract JustGuitars is ERC721, ERC721Enumerable, Ownable, Pausable {
  ...
  uint256 public MAX_MINTABLE = 2690;
  ...
  constructor(string memory _initBaseURI, address weth_)
    ERC721("Just Guitars", "Just_Guitars")
  {
  ...
  * we surpass MAX_MINTABLE, the mintTokens is
  * no longer available.
  */
  ...
  modifier doesNotExceedMaxPurchaseCount(uint256 numberOfTokens) {
    require(
      ...
      "Cannot mint more than 2 tokens at a time"
    );
    _;
  }
