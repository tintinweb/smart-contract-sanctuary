...
interface IFactoryILO {
    function isILO(address _iloAddress) external view returns (bool);
}

contract LiquidityLocker is ReentrancyGuard, Pausable, Ownable {
    //---------- Libraries ----------//
    ...
    constructor() {
        DEX_FACTORY = IJamonFactory(0x56CfC115e04dFCdA3ad47eAE1db86f70C1F8D8A5);
        DEX_ROUTER = IJamonRouter(0xdBe30E8742fBc44499EB31A19814429CECeFFaA0);
        treasury = _msgSender();
        treasuryFee = 300; // 3% Fee
    }
    ...
    ) external payable nonReentrant onlyILOS {
