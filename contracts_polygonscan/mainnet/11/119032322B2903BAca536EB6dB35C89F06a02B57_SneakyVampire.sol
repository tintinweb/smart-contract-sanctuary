...
contract SneakyVampire is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPlY = 5000;
    uint256 public PRESALE_SUPPLY = 2500;
    uint256 public MAX_ALLOWED = 100;
    uint256 public MAX_PRESALE_ALLOWED = 20;
    uint256 public price = 10000000000000000000000; //0.02 ETH
    ...
    constructor(string memory baseURI) ERC721("Sneaky Vampire Syndicate", "SVS") {
        setBaseURI(baseURI);
    }
