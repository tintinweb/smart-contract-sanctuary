...
contract FrensPass is ERC721 {
    ...
    */
        ...
        onlyWhitelisted
    {
        ...
        require(
            maxTokensPerWallet[msg.sender] < maxMintValue,
        ...
        addTraitType(_tokenIds.current());
        _safeMint(msg.sender, _tokenIds.current());
        _tokenIds.increment();
    }

    /**
    * @dev function to airdrop the Frens NFT
    */
    function airdropNFF(address[] memory _addresses)
        external
        onlyAllowedAddress
    {
        //validation before minting
        ...
        for (uint8 i = 0; i < _addresses.length; i++) {
            ...
            maxTokensPerWallet[_addresses[i]] += 1;
            addTraitType(_tokenIds.current());
                    ...
                    bytes(
                        string(
                            abi.encodePacked(
                                ...
                                '","description": "The Frens Pass permits access to the Frens Discord restricted channels. Each holder is entitled to a vote in the governance of the Non Fungible Frens DAO.", "image":"',
                                imageURI,
                                '","animation_url":"',
                                animationURI,
                                '","attributes":',
        ...
        for (uint8 i = 0; i < 3; i++) {
            ...
            metadataString = string(
                abi.encodePacked(
                    metadataString,
                    '{"trait_type":"',
                    traitTypes[_tokenId][i].traitName,
                    '","max_value":',
                    FrensLib.toString(maxValueProp),
                    ',"value":',
                    FrensLib.toString(traitTypes[_tokenId][i].traitValue),
                    '}'
                )
            );
 ...
 |____/ \___|\__|\__\___|_|  |___/
    ...
    */ //["0xb90a29244c0818C30c4263ac773e367D7Ea99689", "0x19FD6DE3976753c851Ff7e457333961b3eEBD638", "0x736342514E6f5016aE663c1facdBA454fa1595E3"]
    ...
    */
    function addTraitType(uint256 _tokenId)
        internal
    {
        traitTypes[_tokenId].push(
            Traits(
                "Friendship",
                1
            )
    ...
    */
    ...
    /**
    * @dev update the lvl value
    */
    function updateTraitValue(uint _tokenId, uint8 _newValue, uint8 _position)
        public
        onlyAllowedAddress
    {
        traitTypes[_tokenId][_position].traitValue = _newValue;
    }

     /**
    * @dev update the name value
    */
    function updateTraitName(uint _tokenId, string memory _newValue, uint8 _position)
        public
        onlyAllowedAddress
    {
        traitTypes[_tokenId][_position].traitName = _newValue;
    }

     /**
    * @dev set the max mint value
    */
    function setMaxMintValue(uint _value)
        public
        onlyOwner
        {
            maxMintValue = _value;
 ...
 | |_| |  __/ |_| ||  __/ |  \__ \
  \____|\___|\__|\__\___|_|  |___/
    ...
    */
    function getTraitValue(uint _tokenId, uint _position)
        public
        view
        returns(uint8)
    {
        return traitTypes[_tokenId][_position].traitValue;
    }

    /**
    * @dev set the update the lvl value
    */
    function getTraitName(uint _tokenId, uint _position)
        public
        view
        returns(string memory)
    {
        return traitTypes[_tokenId][_position].traitName;
    }

    function getMaxMintValue()
        public
        view
        returns(uint)
        {
 ...
 | |_| |\ V  V /| | | |  __/ |    |  _|| |_| | | | | (__| |_| | (_) | | | \__ \
  \___/  \_/\_/ |_| |_|\___|_|    |_|   \__,_|_| |_|\___|\__|_|\___/|_| |_|___/
   ...
   constructor (string memory _imageURI, string memory _animationURI) ERC721 ("FrensPass", "FrensPass")
    {
        owner = msg.sender;
        imageURI = _imageURI;
        animationURI = _animationURI;
