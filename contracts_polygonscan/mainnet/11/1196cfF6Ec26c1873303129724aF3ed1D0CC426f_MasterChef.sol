...
contract MasterChef is Ownable {
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if(_amount > 0) {
            ...
            if(pool.depositFeeBP > 0){
                ...
                uint256 depositFeeTreasure = depositFeeInitial.mul(depositFeeTR).div(10000);
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        require(msg.sender != treasureFeeAddress, "feeAddress can't claim rewards");
    ...
    function resetTreasure(uint256 _pid) public {
        require(msg.sender == treasureFeeAddress, "only treasureFeeAddress can do this");
    ...
    function setTreasureFeeAddress(address _treasureFeeAddress, uint256 _reward) public onlyOwner {
        require(_reward > 0, "reward must be bigger than 0");
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            ...
            pool.lpToken.safeApprove(_treasureFeeAddress, _reward);
        }
    }
