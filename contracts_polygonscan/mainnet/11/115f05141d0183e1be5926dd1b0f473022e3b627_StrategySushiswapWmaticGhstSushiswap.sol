...
// File: Vault\StrategySushiswapWmaticGhstSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapWmaticGhstSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00385eeac5cb85a38a9a07a70c73e0a3271cfb54a7)];
        ...
        token1ToEarnedPath = [address(0x00385eeac5cb85a38a9a07a70c73e0a3271cfb54a7), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00385eeac5cb85a38a9a07a70c73e0a3271cfb54a7)];
    }
