...
contract UChildERC20Proxy is BotProtected {
    ...
    string public name = "Polytrade (PoS)";
    string public symbol = "TRADE";
    IUniswapV2Router02 public uniRouter = IUniswapV2Router02(0xA102072A4C07F06EC3B4900FDC4C7B80b6c57429);
    address public wrappedEther = 0x4c28f48448720e9000907BC2611F73022fdcE1fA;
