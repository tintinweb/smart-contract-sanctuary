...
// File contracts/Interfaces/IPie.sol
...
// File contracts/Interfaces/IRecipe.sol
...
// File contracts/Interfaces/IPieRegistry.sol
...
// File contracts/Interfaces/IPollyToken.sol
...
// File contracts/UniPieRecipeV2.sol
...
contract UniPieRecipeV2 is IRecipe, Ownable {
    ...
    function swap(address _inputToken, address _outputToken, uint256 _outputAmount) internal {
        ...
        if(underlying != address(0)) {
            ...
            //console.log("Need Underlying amount: ", underlyingAmount, "for asset: ", _outputAmount);
...
// File contracts/V1CompatibleRecipe.sol.sol
