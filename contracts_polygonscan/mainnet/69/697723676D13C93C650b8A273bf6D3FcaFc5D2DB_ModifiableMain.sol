...
contract ModifiableMain is Ownable, ERC721Custom {
     ...
     */
    constructor (string memory name_, string memory symbol_, uint256 saleStartTS, address wETH) 
    ...
    /**
     * @dev  Store traits. Ordered according to original hashed sequence pertaining to the Pieces provenance
     */
    ...
    /**
     * @dev For early supporters and giveaways promos
     */
    function mintGiveaways(uint256 quantity) external onlyOwner {
        require(block.timestamp >= SALE_START_TIMESTAMP, "Sale has not started");
        require(quantity>= 1 && quantity<= 40, "Amount of minted pieces at once should be in [1,40] interval");
