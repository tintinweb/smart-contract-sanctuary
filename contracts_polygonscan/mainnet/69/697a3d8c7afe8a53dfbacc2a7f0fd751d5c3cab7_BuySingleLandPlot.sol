...
// File: contracts/BuySingleLandPlot.sol
...
contract BuySingleLandPlot is ERC1155PresetMinterPauser {
    ...
    constructor(address payable _wallet) ERC1155PresetMinterPauser("Land Plot - ") {
        wallet = _wallet;
        price = 10**18;        
    }
    
    function addPlotID() public virtual payable {
    ...
    function getPlotIDs(address account) public view returns (uint256[] memory){
        uint256 numTokens = 0;
        for (uint i = 0; i <= plotIDCounter; i++) {
