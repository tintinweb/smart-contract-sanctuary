...
contract GFarmPoolV4{
    ...
    constructor() public{
        nft[0] = NftInterfacePoolV4(0xB9FAaacFe6b5c585adD6F308AD30b490828B0eeA);
        nft[1] = NftInterfacePoolV4(0xB9FAaacFe6b5c585adD6F308AD30b490828B0eeA);
        nft[2] = NftInterfacePoolV4(0xB9FAaacFe6b5c585adD6F308AD30b490828B0eeA);
        nft[3] = NftInterfacePoolV4(0x0911B1477ac13f73144e9E06DDEdBE16bc7E4698);
        nft[4] = NftInterfacePoolV4(0x35441A45C2913D36CAc940aEb8f529dC15769B01);
    }

    // GOV => UPDATE VARIABLES & MANAGE PAIRS

    function setMaxNftsStaked(uint _maxNftsStaked) external {
