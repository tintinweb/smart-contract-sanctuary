...
// File: Vault\StrategyPolypupCollarUsdcSushiswap.sol

// openzeppelin v3.1.0

contract StrategyPolypupCollarUsdcSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x008df26a1bd9bd98e2ec506fc9d8009954716a05dc), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToToken1Path = [address(0x008df26a1bd9bd98e2ec506fc9d8009954716a05dc)];
        token0ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x008df26a1bd9bd98e2ec506fc9d8009954716a05dc)];
