...
contract MainDex is Ownable, DexStorage {
  ...
  function init() public {
    ...
    XNFT = INFT(0x2c3479B526394d9a5e18E2E454B9f8b1282930AC); 
    OldNFTDex = IERC20(0xfE1a571eb3458d3aCf7d71bF0A78aC62DA537124);
    ...
    nonCryptoNFTVault = 0xaC940124F5f3B56B0c298Cca8e9E098C2cccAe2e;
    platform = 0x9c427ea9cE5fd3101a273815Ff8530f2AC75Db37;
    authorVault = 0x25098494af0d4aAB3eAD88773A6864F10655b3Ea;
    platformPerecentage = 25;
    countCopy = 3;
    ownerInit();
   factory = IFactory(0xFeBEf56Fd87c1ad1E1a0f54b5a85eaF70ef6E026);
   ETH = IERC20(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619);
   LPWMATIC = LPInterface(0x604229c960e5CACF2aaEAc8Be68Ac07BA9dF81c3);
   _supportNft[0x2c3479B526394d9a5e18E2E454B9f8b1282930AC] = true;
   emit CollectionsConfigured(0x2c3479B526394d9a5e18E2E454B9f8b1282930AC, 0xFeBEf56Fd87c1ad1E1a0f54b5a85eaF70ef6E026);
    BUSD = IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    BNB= IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
