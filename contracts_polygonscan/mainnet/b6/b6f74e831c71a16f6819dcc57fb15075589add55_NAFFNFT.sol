 ...
 */
 ...
 contract NAFFNFT is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("NAFF NFT", "NAFF") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xc40Dc52283D1a5FA57F559F1a8B09374EbCc9e3b);
          _setupRole(MINTER_ROLE, 0xc40Dc52283D1a5FA57F559F1a8B09374EbCc9e3b);
          _setupRole(PAUSER_ROLE, 0xc40Dc52283D1a5FA57F559F1a8B09374EbCc9e3b);
          _setupRole(MINTER_ADMIN_ROLE, 0xc40Dc52283D1a5FA57F559F1a8B09374EbCc9e3b);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xc40Dc52283D1a5FA57F559F1a8B09374EbCc9e3b);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "NAFF NFT/minter-role-required");
         _mint(to, tokenId);
