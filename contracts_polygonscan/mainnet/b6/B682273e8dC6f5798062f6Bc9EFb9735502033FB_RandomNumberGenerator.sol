...
interface ILottery {
    ...
    /**
     * @notice Draw the final number, calculate reward in farm per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in farm token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInFarm: price of a ticket in farm
