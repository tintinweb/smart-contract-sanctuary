...
contract MATICFINANCE is Context, IERC20, Ownable {
    ...
    string private _name = "MaticFinance";
    string private _symbol = "MaticFinance";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x1bE97Ca497acD83909E2c3B31dD36627B9bd6bE3, 'We can not exclude Uniswap router.');
