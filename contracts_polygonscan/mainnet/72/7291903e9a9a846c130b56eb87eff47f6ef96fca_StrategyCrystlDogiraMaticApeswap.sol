...
// File: Vault\StrategyCrystlDogiraMaticApeswap.sol

// openzeppelin v3.1.0

contract StrategyCrystlDogiraMaticApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x0076bf0c28e604cc3fe9967c83b3c3f31c213cfe64), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00dda40cdfe4a0090f42ff49f264a831402adb801a)];
        ...
        token1ToEarnedPath = [address(0x00dda40cdfe4a0090f42ff49f264a831402adb801a), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0076bf0c28e604cc3fe9967c83b3c3f31c213cfe64)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00dda40cdfe4a0090f42ff49f264a831402adb801a)];
    }
