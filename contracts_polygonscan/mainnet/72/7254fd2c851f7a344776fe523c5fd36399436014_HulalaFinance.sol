...
contract HulalaFinance is Context, IERC20, Ownable {
...
contract Hulala is HulalaFinance , NativeMetaTransaction, ContextMixin {
    constructor() HulalaFinance () {
