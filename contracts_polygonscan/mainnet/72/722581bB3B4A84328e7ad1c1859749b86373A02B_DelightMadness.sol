...
contract DelightMadness is Ownable, ReentrancyGuard, IERC721Receiver, ERC721Holder {
    ...
    uint public assignNft;

    // NFT
    IERC721Enumerable public theEndlessNFTAddress = IERC721Enumerable(0xBfeD3a7FACa9f079Fd3e1D76efE2A61c8Fb2Be4D); 
    ...
    function swapDelightForDelirium() external nonReentrant {
        ...
        assignNft = theEndlessNFTAddress.balanceOf(address(this));
        ...
        if (assignNft > 1)
            theEndlessNFTAddress.safeTransferFrom(address(this), msg.sender, assignNft - 1 );
