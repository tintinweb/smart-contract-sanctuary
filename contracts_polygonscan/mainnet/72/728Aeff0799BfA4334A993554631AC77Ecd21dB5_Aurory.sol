...
contract Aurory is Context, Ownable, ERC20 {
    ...
    uint256 public AuroryPerTokenId = 10000 * (10**decimals());
    ...
    */
    ...
    constructor() Ownable() ERC20("Aurory", "AURY") {
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, AuroryPerTokenId);
    }
    ...
    function daoSetAuroryPerTokenId(uint256 auroryDisplayValue)
        public
        onlyOwner
    {
        AuroryPerTokenId = auroryDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndAuroryPerTokenID(
        uint256 season_,
        uint256 auroryDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetAuroryPerTokenId(auroryDisplayValue);
    }
}