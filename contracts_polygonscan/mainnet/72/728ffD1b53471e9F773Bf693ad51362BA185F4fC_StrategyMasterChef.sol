...
interface IMasterchef {
    ...
    function pendingDestruction(uint256 _pid, address _to) external view returns (uint256);
}
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public controllerFee = 0; // 0.25%
    uint256 public rewardRate = 0; // 0.75%
    uint256 public buyBackRate = 0; // 3%
