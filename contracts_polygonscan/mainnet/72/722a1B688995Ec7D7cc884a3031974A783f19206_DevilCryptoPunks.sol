...
contract DevilCryptoPunks is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://Qmbdvu8JCrHMJyWdADxm6k7VHYGW6xU2cbbGHk6H6xZHAF/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.003 ether;
  uint256 public maxSupply = 9966;
  uint256 public maxMintAmountPerTx = 9966;

  bool public paused = true;
  bool public revealed = true;

  constructor() ERC721("Devil Crypto Punks", "DCP") {
