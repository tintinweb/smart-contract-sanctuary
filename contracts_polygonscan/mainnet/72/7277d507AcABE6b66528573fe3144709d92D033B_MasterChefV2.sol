...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    uint256 public constant destructionMaximumSupply = 4500 * (10 ** 18); // 4500 destruction
...
contract DestructionTokenV3 is ERC20, Ownable {
    ...
    ///@dev Check if the address is excluded from antibot system.
    function isExcludedFromAntiBot(address _userAddress) external view returns(bool) {
        return(_excludedOperatorsFromAntiBot[_userAddress]);
    }
}
