...
/**
 *RocketMatic - Buy some Rocket - Get rewarded in Matic
*/
...
contract EarnMatic is Context, IERC20, Ownable {
    ...
    string private constant _name = "EarnMatic";
    string private constant _symbol = "EarnMatic";
