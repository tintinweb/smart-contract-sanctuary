 ...
 */
contract Ethchievements is ERC721, Ownable {
    using Strings for uint256;
    ...
    mapping(uint256 => uint256) tokenToAchievemntId;

    /**
     * Sets the state variables
     *
     * @param _startingBaseURI  the base url of the NFT
     */
    constructor(string memory _startingBaseURI) ERC721("Ethchievements", "EMNT") {
        baseURI = _startingBaseURI;
    }

    /**
     * ONLY OWNER: Updates the base uri
     *
    ...
    function mint(address _to, uint256 _achievementId, bytes memory _sig) external {
        ...
        tokenToAchievemntId[currentId] = _achievementId;
        _mint(_to, currentId);
    ...
    /**
     * Gets token URI. Is equal to baseUrl/achievementId/tokenId
     *
     * @param _tokenId  token id to fetch base URI for
     */
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        return string(abi.encodePacked(baseURI, "/", tokenToAchievemntId[_tokenId].toString(), "/", _tokenId.toString()));
    }
