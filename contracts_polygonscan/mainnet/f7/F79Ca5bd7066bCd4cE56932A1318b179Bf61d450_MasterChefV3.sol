...
contract MasterChefV3 is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        uint256 usdRewardDebt;     // Reward debt. See explanation below.
        //
    ...
    function deposit(uint256 _pid, uint256 _amount) external nonReentrant {
        ...
        _payPendingUSDCReward(_pid, msg.sender);
        ...
        if (_amount > 0) {
            ...
            if (pool.depositFeeBP > 0) {
                ...
                uint256 depositFee = (_amount * (pool.depositFeeBP - 100)) / 10000; //3% for treasury
