...
// File contracts/strategies/gravity/interfaces/IGFIFarm.sol
...
// File contracts/strategies/gravity/GravityLPStrategy.sol

pragma solidity 0.5.16;
/// @title Gravity LP Strategy
/// @author Chainvisions
/// @notice Strategy for Gravity Finance LP token staking.

contract GravityLPStrategy is IStrategy, BaseUpgradeableStrategy {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    */
    ...
    function investAllUnderlying() internal onlyNotPausedInvesting {
        if(IERC20(underlying()).balanceOf(address(this)) > 0) {
            ...
            IGFIFarm(rewardPool()).deposit(IERC20(underlying()).balanceOf(address(this)));
        }
    }
...
// File contracts/strategies/gravity/mainnet/StrategyMaximizer_USDC_WETH.sol

pragma solidity 0.5.16;
contract StrategyMaxmizer_WETH_USDC is GravityLPStrategy {

    address weth_usdc_diff;
    ...
    function initializeStrategy(
        ...
        address weth_usdc_lp = address(0x2AaBdA501253b3AEeB4bEe0Bf7B0d5Fd87B038EB);
        ...
        GravityLPStrategy.initializeStrategy(
            _store,
            weth_usdc_lp,
            _vault,
            farmContract,
