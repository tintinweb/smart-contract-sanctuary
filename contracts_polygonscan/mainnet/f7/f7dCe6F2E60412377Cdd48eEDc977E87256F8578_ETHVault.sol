...
contract ETHVault is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public seedPoolPid = 1;     // Apple Pool pid in masterchef
    ...
    constructor(
        ...
        // Infinite approve
        IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270).safeApprove(address(_masterchef), uint256(-1));
        IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270).safeApprove(address(msg.sender), uint256(-1));
