...
contract Flares is Initializable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    // Smart Contract that ignites flares
    address public ignitor;
    ...
    /**
     * @dev Sets the ignitor address
     */
    function setIgnitor(address newIgnitor) public onlyOwner {
        ignitor = newIgnitor;
    }
    ...
    function burn(uint256 tokenId) public virtual {
        require(
            _isApprovedOrOwner(_msgSender(), tokenId) || _isIgnitor(_msgSender(), tokenId),
    ...
    function _isIgnitor(address spender, uint256 tokenId) internal view returns (bool) {
        require(_exists(tokenId), "ERC721: operator query for nonexistent token");
        return spender == ignitor;
    }
