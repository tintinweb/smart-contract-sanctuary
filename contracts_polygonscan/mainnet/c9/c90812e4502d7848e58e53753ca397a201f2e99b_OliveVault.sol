...
// File: contracts/farms/olive/OliveVault.sol
...
contract OliveVault is Ownable, Pausable {
    ...
    IERC20 public immutable token; // Olive token
    ...
    /**
     * @notice Constructor
     * @param _token: Olive token contract
    ...
    /**
     * @notice Deposits funds into the Olive Vault
