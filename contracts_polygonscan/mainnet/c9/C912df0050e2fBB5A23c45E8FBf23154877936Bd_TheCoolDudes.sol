...
contract TheCoolDudes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TheCoolDudes", "CDC") {
    setHiddenMetadataUri("ipfs://QmPWAvE2bjiestAEg3f63BYhj92dRg1y47BvSkFEinU1Qe/hidden.json");
  }
