...
contract NFT is ERC721Enumerable, Ownable{
    ...
    constructor(string memory _tokenName, string memory _tokenSymbol, string memory _uri, uint _maxTokenToMint)
        ERC721(_tokenName, _tokenSymbol)
    {
        setBaseURI(_uri);
        MAX_TOKENS = _maxTokenToMint;
    ...
    function mintToken() public payable{
        require(_tokenId < MAX_TOKENS, "Can not mint more tokens");
    ...
    function bulkMint(uint256 _amount) public payable {
        require(msg.value == _amount*tokenPrice, "Invalid Amount");
        _forwardFunds();
