...
library NFTSVGGET{
    ...
    function generateSvgHead(
        ...
        nftIndex,
            '</tspan></a><animate attributeName="x" values="300;-200" dur="10s" repeatCount="indefinite"/></text><text x="300" y="90" class="st1 st2 st3" mask="url(#mask-marquee)"><animate attributeName="x" values="300;-200" dur="10s" begin="4s" repeatCount="indefinite"/></text>',
        ...
        '<text transform="matrix(1 0 0 1 40 50)" class="st3 st6">',
        nftType,
        '</text>',
    ...
    function svgAssetsInfo(
        ...
        return string(abi.encodePacked(
            '<text transform="matrix(1 0 0 1 35 248)"><tspan x="0" y="0" class="st1 st2">TicketFuel:</tspan><a href="https://polygonscan.com/address/',
            loanAssetContract,
            ...
            '<text transform="matrix(1 0 0 1 35 330)"><tspan x="0" y="0" class="st1 st2">Owner:</tspan><a href="https://polygonscan.com/address/',
            collateralId,
            '" target="_blank"><tspan x="76" y="0" class="st4 st1 st2">', 
            collateralId,
            '</tspan></a></text>'
    ...
    function amountsSvg(string memory loanAmount, string memory interestAccrued, string memory loanAssetSymbol, string memory endBlock) private pure returns (string memory) {
        return string(
            abi.encodePacked(
                '<text transform="matrix(1 0 0 1 35 371)"><tspan x="0" y="0" class="st1 st2">Backpack GET:</tspan></text>',
