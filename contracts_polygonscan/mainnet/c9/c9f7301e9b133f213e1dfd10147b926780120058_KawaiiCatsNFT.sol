 ...
 *  
 *  Description: 10,000 unique felines, 10 different breeds, editable names, descriptions, background color, unique items, PvP fights and more.
 * 
 */
...
contract KawaiiCatsNFT is Ownable, ERC721, ERC721Enumerable {
    ...
    uint256 public NFT_PRICE = 80000000000000000000; //80 MATIC
