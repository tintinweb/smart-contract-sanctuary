...
contract Box is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForMatic(half); // <- this breaks the MATIC -> HATE swap when swap+liquify is triggered
    ...
    function swapTokensForMatic(uint256 tokenAmount) private {
        ...
        // make the swap
        uniswapV2Router.swapExactTokensForMATICSupportingFeeOnTransferTokens(
            tokenAmount,
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        uniswapV2Router.addLiquidityMATIC{value: ethAmount}(
            address(this),
            tokenAmount,
