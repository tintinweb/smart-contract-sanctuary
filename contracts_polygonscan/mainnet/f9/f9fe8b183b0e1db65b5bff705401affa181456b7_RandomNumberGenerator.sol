...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public polyswapLottery;
     ...
     * @param _seed: seed provided by the Polyswap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == polyswapLottery, "Only PolyswapLottery");
    ...
    /**
     * @notice Set the address for the PolyswapLottery
     * @param _polyswapLottery: address of the Polyswap lottery
     */
    function setLotteryAddress(address _polyswapLottery) external onlyOwner {
        polyswapLottery = _polyswapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPolyswapLottery(polyswapLottery).viewCurrentLotteryId();
    }
}