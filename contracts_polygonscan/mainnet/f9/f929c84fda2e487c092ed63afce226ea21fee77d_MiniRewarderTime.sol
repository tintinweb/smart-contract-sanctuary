...
import "./MasterApeV2Auxiliary.sol";
...
contract MiniRewarderTime is IRewarder,  BoringOwnable, Initializable{
    ...
    event LogInit(IERC20 rewardToken, uint256 rewardPerSecond, address MINI_APE_V2);

    function initialize (IERC20 _rewardToken, uint256 _rewardPerSecond, address _MINI_APE_V2)  external initializer {
        rewardToken = _rewardToken;
        rewardPerSecond = _rewardPerSecond;
        MINIAPE_V2 = _MINI_APE_V2;
        emit LogInit(_rewardToken, _rewardPerSecond, _MINI_APE_V2);
    }
