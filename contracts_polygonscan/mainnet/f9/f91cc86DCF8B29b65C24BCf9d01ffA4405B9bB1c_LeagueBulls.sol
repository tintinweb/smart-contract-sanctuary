...
contract LeagueBulls is ERC721URIStorage, Ownable {

  using Counters for Counters.Counter;
  Counters.Counter private _tokenIds;
  uint256 public constant MAX_NFT_SUPPLY = 7777;
  uint256 public constant MAX_NUM_MINT = 100;
  string public baseUri = "ipfs://QmQyigQ9aKgdruKpAdqta3RhrCho3o1fzWU4Q2TF7GuVAH/";
  
  constructor() ERC721("League Bulls", "LB") {}

  function mintToOwner(uint amount) external {
