...
// File: Vault\StrategyGravityRenbtcWbtcGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityRenbtcWbtcGravity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x00dbf31df14b66535af65aac99c32e9ea844e14501)];
        ...
        token1ToEarnedPath = [address(0x00dbf31df14b66535af65aac99c32e9ea844e14501), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x00dbf31df14b66535af65aac99c32e9ea844e14501)];
    }
