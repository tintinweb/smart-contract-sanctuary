...
/**
   ...
   I created a black hole so #POLYSTAR token will deflate itself in supply with every transaction
...
contract PolyStar is Context, IERC20, Ownable {
    ...
    string private _name = "PolyStar";
    string private _symbol = "PolyStar";
