...
contract GovernorAlpha {
    ...
    function quorumVotes() public pure returns (uint) { return 4000000e18; } // 400,000 = 4% of Comp

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 50000e18; } // 100,000 = 1% of Comp
    ...
    function votingPeriod() public pure returns (uint) { return 117818; } // ~3 days on Matic
...
contract gFRY is Comp 
{
        ...
        public 
    {
        ...
        _moveDelegates(delegates[address(0x0)], delegates[_to], _amount); // Review this was originally _moveDelegates(address(0x0), to, amount);
    }
...
contract GovernanceDeployer {
    ...
    // governorAlpha: constructor(address timelock_, address comp_, address guardian_)
    // timelock:      constructor(address admin_, uint delay_)
    // forwarder:     constructor(address _owner)
    // governator:    constructor(IERC20 _FRY) 
    ...
    constructor(address _guardian, IERC20 _FRY) 
        public 
    {
    // Launch governance contracts
		...
		GovernorAlpha governorAlpha = new GovernorAlpha(address(timelock), address(gFry), _guardian);
        
        // emit events with all new contract addresses
     ...
     // Execute the __acceptAdmin function in governorAlpha from the guardian address.
