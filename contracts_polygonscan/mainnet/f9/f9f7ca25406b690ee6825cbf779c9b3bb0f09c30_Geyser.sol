...
contract Geyser is IGeyser, ReentrancyGuard {
    ...
    address public TREASURY_ADDR = 0x55eFb4C3829Be4408Eb5DEc0Da38dE4082C19Db8 ;  //default is master Dev Address 
        ...
        returns (uint256)
    {
        ...
        //Withdrawal Fees   
        uint256 fee = amount.mul(withdrawalFeeInBips).div(10000); //to-do add fee parameter - done
        uint256 amountAfterFees = amount.sub(fee); 


        // transactions 
        _stakingPool.transfer(msg.sender, amountAfterFees); //to-do add the fee here - done
    ...
    function updateFee(uint256 feeInBips) external onlyOwner {  //to-do  - done
