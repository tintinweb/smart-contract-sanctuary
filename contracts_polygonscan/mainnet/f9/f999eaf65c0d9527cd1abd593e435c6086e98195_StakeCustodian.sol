...
contract StakeCustodian is IStakeCustodian, Migrateable, ExternallyCallable {
    ...
    function isOwnerOf(address account, uint256 stakeId) external view override returns (bool) {
    ...
    function setupRole(bytes32 role, address account) external onlyMigrator {
