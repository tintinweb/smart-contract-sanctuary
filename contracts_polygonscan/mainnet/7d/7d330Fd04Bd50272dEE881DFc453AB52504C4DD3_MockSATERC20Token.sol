...
contract VaultOwned is Ownable {
    ...
    function vault(address account_) public view returns (bool) {
        return _vault[account_];
    }
...
contract MockSATERC20Token is ERC20, VaultOwned, Pausable {
    ...
    function __SATERC20Token_initialize() external initializer {
        __ERC20_init_unchained("Test Synassets Token", "TestSAT", 18);
