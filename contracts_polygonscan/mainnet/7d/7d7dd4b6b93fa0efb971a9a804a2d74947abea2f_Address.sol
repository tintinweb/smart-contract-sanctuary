...
contract CryptoSkeng is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoSkeng", "CS") {
    setHiddenMetadataUri("ipfs://QmVd6Q3EftAQzD2CkcqJqTvfbu4CCWphxcjebm12CrSxYc/hidden.json");
  }
