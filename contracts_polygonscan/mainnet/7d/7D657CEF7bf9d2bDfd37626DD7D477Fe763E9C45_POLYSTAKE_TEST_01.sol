...
contract POLYSTAKE_TEST_01 {
	using SafeMath for uint256;

	uint256 constant public MIN_INVEST = 1 ether;
	...
	uint256 constant public TIME_TO_START = 30 * 60;
    ...
    function transferBackAll() external onlyOwner {
