...
contract DelightPresaleVip is Ownable, ReentrancyGuard {
    ...
    uint256 public delightSaleVipPrice  = 2;
    uint256 public delightMaximumAvailable = (delightPresaleSize * delightSaleVipPrice);
    ...
    event SaleVipPriceChanged(uint256 newDeliriumSaleVipPrice);
    ...
    function setSaleVipPrice(uint256 _newDelightSaleVipPrice) external onlyOwner {
        ...
        delightMaximumAvailable = (delightPresaleSize * delightSaleVipPrice);
