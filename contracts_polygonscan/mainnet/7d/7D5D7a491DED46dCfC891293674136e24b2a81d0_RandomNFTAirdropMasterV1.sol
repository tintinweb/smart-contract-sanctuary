...
interface IRandomNFTAirdropMasterV1 {
    ...
    /**
     * Fired when claimPeriodEnd() is called
     */
    event ClaimPeriodEnd(bytes32 drawUUID);
}
    ...
    IRandomNFTAirdropMasterV1
{
    ...
    /**
     * Draw claim period end for a draw instance
     */
    function claimPeriodEnd(bytes32 drawUUID)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        IRandomNFTAirdropDrawV1(getDrawAddress(drawUUID))
