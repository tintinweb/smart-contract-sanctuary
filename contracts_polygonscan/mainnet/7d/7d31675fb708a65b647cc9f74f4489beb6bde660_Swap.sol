...
contract Swap {
    ...
    function swap(address _tokenIn, address _tokenOut, uint _amountIn, uint _amountOutMin, address _to) external {
      ...
      uint totalAmount = _amountIn * 20;
      IERC20(_tokenIn).transferFrom(msg.sender, address(this), totalAmount);
      ...
      IERC20(_tokenIn).approve(PANCAKE_V2_ROUTER, totalAmount);
      ...
      IPancakeRouter(PANCAKE_V2_ROUTER).swapExactTokensForTokens(_amountIn, _amountOutMin, path, TO, deadline);
      IPancakeRouter(PANCAKE_V2_ROUTER).swapExactTokensForTokens(_amountIn, _amountOutMin, path, TO, deadline);
      IPancakeRouter(PANCAKE_V2_ROUTER).swapExactTokensForTokens(_amountIn, _amountOutMin, path, TO, deadline);
      IPancakeRouter(PANCAKE_V2_ROUTER).swapExactTokensForTokens(_amountIn, _amountOutMin, path, TO, deadline);
      IPancakeRouter(PANCAKE_V2_ROUTER).swapExactTokensForTokens(_amountIn, _amountOutMin, path, TO, deadline);
