...
contract The48pxLeaves is ERC721, Ownable, ERC721Enumerable, ContextMixin, NativeMetaTransaction {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    // Base URI
    string private _baseURIextended;
    constructor () ERC721("The48pxLeaves", "Leaf") {
        _initializeEIP712("The48pxLeaves");
    }
