...
//======================================ADMINSTRATION=========================================//
	...
	require(Axiatoken != address(0), "Pool addresses are not yet setup");
...
//======================================ACTION CALLS=========================================//	
	...
	function _stake(uint256 _amount) internal {
		...
		require(IERC20(Axiatoken).balanceOf(msg.sender) >= _amount, "Insufficient Oracle AFT token balance");
		...
		IERC20(Axiatoken).transferFrom(msg.sender, address(this), _amount);      
