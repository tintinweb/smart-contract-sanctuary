...
*/
/**
Matic Play, the new NFT gaming platform
...
contract MaticPlay is Context, IERC20, Ownable {
    ...
    string private constant _name = "MaticPlay";
    string private constant _symbol = "MaticPlay";
