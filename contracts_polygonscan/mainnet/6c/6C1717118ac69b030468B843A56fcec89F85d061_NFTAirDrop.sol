...
contract NFTAirDrop is Ownable, ReentrancyGuard, ERC721Holder {
    ...
    // NFT
    IERC721Enumerable public sandManNFT = IERC721Enumerable(0x743F554f6AcCd4E452AF6C96c48B78E849d87316); 
    ...
    function claimSandManAirdrop() external nonReentrant {
        require(block.timestamp > startTime, "E1");
        require(recipients[_msgSender()], "E2");
        
        balanceOfNFT = sandManNFT.balanceOf(address(this));

        require(balanceOfNFT > 0, "E3");

        recipients[_msgSender()] = false;
        lastNFTAssigned = sandManNFT.tokenOfOwnerByIndex(address(this), 0);
        sandManNFT.safeTransferFrom(address(this), _msgSender(), lastNFTAssigned);
    ...
    function withdrawNFTByIndex(uint256 _index) external onlyOwner {
        balanceOfNFT = sandManNFT.balanceOf(address(this));
        sandManNFT.safeTransferFrom(address(this), _msgSender(), _index);
