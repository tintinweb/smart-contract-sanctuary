...
contract BaseLuckyCatz     is  ERC721Enumerable 
{
    using Address for address;
    using Strings for uint256;
...
contract   LuckCatz    is BaseLuckyCatz
{
    ////////////////////////////////////////////////////////////////////////
    function    AAA_0__reserveSomeTokens(uint256 amount)  external onlyOwner 
    {
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_0__batchMint(uint256 quantity) external payable callerIsUser
    {
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_0__mint() external payable callerIsUser 
    {
        require(block.timestamp              >= salesDate,          "Sales did not start yet");
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_1__reserveSomeTokens_PAYABLE(uint256 amount)  payable external onlyOwner 
    {
        require(amount         <= 200,                              "Reserve is limited to 200 per call at max");
        require(leftTokenCount >= amount, 		                    "Not enough tokens left to reserve anymore");
        require((totalReserved+amount) <= maxReservableTokenCount,  "Too many to reserve. Reduce the amount");
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_1__batchMint(uint256 quantity) external payable /*callerIsUser*/
    {
        require(block.timestamp                         >= salesDate,               "Sales did not start yet");
        require(msg.value                               == salesPrice * quantity,   "Send exact Amount to claim your Nfts");
        require(walletMintCounts[msg.sender] + quantity <= maxMintPerWallet,        "You cannot claim that much tokens");
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_1_mint() external payable /*callerIsUser*/ 
    {
        require(block.timestamp              >= salesDate,          "Sales did not start yet");
        require(msg.value                    >= salesPrice,         "Send exact Amount to claim your Nft");
        require(walletMintCounts[msg.sender] <= maxMintPerWallet,   "You cannot claim more tokens");
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_2_batchMint(uint256 quantity) external payable /*callerIsUser*/
    {
        //require(block.timestamp                         >= salesDate,               "Sales did not start yet");
        require(msg.value                               == salesPrice * quantity,   "Send exact Amount to claim your Nfts");
        require(walletMintCounts[msg.sender] + quantity <= maxMintPerWallet,        "You cannot claim that much tokens");
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_2__mint() external payable /*callerIsUser*/ 
    {
        //require(block.timestamp              >= salesDate,          "Sales did not start yet");
        require(msg.value                    >= salesPrice,         "Send exact Amount to claim your Nft");
        require(walletMintCounts[msg.sender] <= maxMintPerWallet,   "You cannot claim more tokens");
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_3__batchMint(uint256 quantity) external payable callerIsUser
    {
        //require(block.timestamp                         >= salesDate,               "Sales did not start yet");
        require(msg.value                               == salesPrice * quantity,   "Send exact Amount to claim your Nfts");
        require(walletMintCounts[msg.sender] + quantity <= maxMintPerWallet,        "You cannot claim that much tokens");
    ...
    ////////////////////////////////////////////////////////////////////////
    function    AAA_3__mint() external payable callerIsUser
    {
        //require(block.timestamp              >= salesDate,          "Sales did not start yet");
        require(msg.value                    >= salesPrice,         "Send exact Amount to claim your Nft");
        require(walletMintCounts[msg.sender] <= maxMintPerWallet,   "You cannot claim more tokens");
