...
contract BAMC48H is ERC721("BAMC48H", "BAMC48H"), ERC721Enumerable, Ownable {
    // reserve some for future
    uint256 public constant MAX_SUPPLY = 10000;
    string public baseURI =
        "https://bafybeigyqoekncug4bhb3qwoh26vwsksro7sejeitn547glthbmfdna6pm.ipfs.dweb.link/";
    ...
    function mint(uint256 amount) external {
        require(mintStarted, "BAMC48H: mint has not started yet");

        uint256 _nextTokenId = nextTokenId;
        require(_nextTokenId + 1 <= MAX_SUPPLY, "BAMC48H: max supply exceeded");
        require(
            minted[_msgSender()] + amount <= allowList[_msgSender()],
            "BAMC48H: you cant mint this many"
        );
