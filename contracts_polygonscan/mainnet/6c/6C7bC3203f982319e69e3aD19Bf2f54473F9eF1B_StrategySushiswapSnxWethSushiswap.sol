...
// File: Vault\StrategySushiswapSnxWethSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapSnxWethSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x0050b728d8d964fd00c2d0aad81718b71311fef68a)];
        ...
        token0ToEarnedPath = [address(0x0050b728d8d964fd00c2d0aad81718b71311fef68a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
