...
contract ISLAMICOIN is IslamiMatic {
    ...
    address AirDropAD = address(0x6218152DDdC6577A1b2e62a538C29d4e2cBC83a7);   // AirDrop contract    
    address CharityAD = address(0x8D95fbB700991Dd298b91CE8F987AC4638AC9294); // "Bayt Al-Mal / بيت المال" contract for charity
