...
contract StarLink is Context, Ownable, ERC20 {
    ...
    uint256 public StarlinkPerTokenId = 10000 * (10**decimals());
    ...
    */
    ...
    constructor() Ownable() ERC20("Star Link", "STARLINK") {
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, StarlinkPerTokenId);
    }
    ...
    function daoSetStarlinkPerTokenId(uint256 starlinkDisplayValue)
        public
        onlyOwner
    {
        StarlinkPerTokenId = starlinkDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndStarlinkPerTokenID(
        uint256 season_,
        uint256 starlinkDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetStarlinkPerTokenId(starlinkDisplayValue);
    }
}