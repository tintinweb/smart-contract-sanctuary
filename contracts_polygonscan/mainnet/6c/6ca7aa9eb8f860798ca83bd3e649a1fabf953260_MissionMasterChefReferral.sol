...
// File contracts/interfaces/IMasterChefReferral.sol

// SPDX-License-Identifier: MIT

pragma solidity 0.6.12;

interface IMasterChefReferral {
...
// File contracts/missions/BaseMission.sol
...
// File contracts/missions/BaseMissionLP.sol
...
// File contracts/missions/BaseMissionLPSingle.sol
...
// File contracts/missions/MissionMasterChefReferral.sol



pragma solidity 0.6.12;
contract MissionMasterChefReferral is BaseMissionLPSingle {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function _vaultDeposit(uint256 _amount) internal override {
        IMasterChefReferral(masterchefAddress).deposit(pid, _amount, withdrawFeeAddress);
    }
    
    function _vaultWithdraw(uint256 _amount) internal override {
        IMasterChefReferral(masterchefAddress).withdraw(pid, _amount);
    }
    
    function _vaultHarvest() internal override {
        IMasterChefReferral(masterchefAddress).withdraw(pid, 0);
    }
    
    function vaultSharesTotal() public override view returns (uint256) {
        (uint256 amount,) = IMasterChefReferral(masterchefAddress).userInfo(pid, address(this));
        return amount;
    }
    ...
    function _emergencyVaultWithdraw() internal override {
        IMasterChefReferral(masterchefAddress).emergencyWithdraw(pid);
    }
}