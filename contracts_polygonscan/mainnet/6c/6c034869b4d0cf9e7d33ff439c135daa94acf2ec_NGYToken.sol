...
contract NGYTokenBase is ERC20, DSMath {
    uint256                                            _supply;
    mapping (address => uint256)                       _balances;
    mapping (address => mapping (address => uint256))  _approvals;

    uint256  public  airdropBSupply = 50*10**9*10**9; // airdrop total supply = 50 Billion
    uint256  public  currentAirdropAmount = 0;
    uint256  airdropNum  =  10*10**6*10**9;                // 10 Million XLUM each time for airdrop
...
contract NGYToken is NGYTokenBase(500*10**9*10**9), ContractLock(1527782400) {

    string  public  symbol;
    uint256  public  decimals = 9; // standard token precision. override to customize
    ...
    // Optional token name
    string   public  name = "NAGAYA TECH";
