...
contract XVMCtimeDeposit is Ownable, Pausable {
    ...
    uint256 public immutable withdrawFeePeriod = 365 days; // roughly 1 year
    ...
    function withdraw(uint256 _shares) public notContract {
        ...
        if (block.timestamp < user.lastDepositedTime.add(withdrawFeePeriod)) {
            uint256 withdrawFee = uint256(50).sub(((block.timestamp - user.lastDepositedTime).div(86400)).mul(1337).div(10000));
