...
contract PolyToken is BEP20('DABUNG Token', 'DABUNG') {
...
contract PolyMess {
    ...
    function sendChatWithFee(string memory chatMessage) public {
        addToArray(chatMessage);
        feeToken.transfer(feeAddress, chatFee);
    }
