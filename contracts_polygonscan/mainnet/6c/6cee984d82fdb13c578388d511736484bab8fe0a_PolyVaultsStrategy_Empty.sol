...
contract PolyVaultsStrategy_Empty is IStrategy, ReentrancyGuard {
    ...
    constructor(address _controller, address _wantAddress) {
    ...
    function deposit(address, uint256 _wantAmt) external override onlyController nonReentrant returns (uint256) {
    ...
    function inCaseTokensGetStuck(address _token, uint256 _amount) external override onlyController {
