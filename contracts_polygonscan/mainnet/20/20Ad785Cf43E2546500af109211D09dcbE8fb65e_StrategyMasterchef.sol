...
contract StrategyMasterchef is BaseStrategyLPSingle {
    ...
    constructor(
        address[5] memory _configAddress, //vaultchef, masterchef, unirouter, want, earned
        uint256 _pid,
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address[] public earnedToDestructionPath = [earnedAddress, destructionAddress];
    ...
    function _farm_native(uint256 wantAmt) internal returns (uint256) {
        if (wantAmt == 0) return 0;
