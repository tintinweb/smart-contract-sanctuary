...
contract VoronoiToken {
    string public constant name     = "Boobies Coin";  					// -> Unique compared to other CryptoDevTech tokens
    string public constant symbol   = "BOOBIES";					// -> Unique compared to other CryptoDevTech tokens
    ...
    uint256 private totalSupply_ = 1000000000000000;					 // -> Unique compared to other CryptoDevTech tokens
