    ...
    Ownable
{
    ...
    uint256 public maxSupply = 1000; // max supply, contract will stop minting after this amount is reach in your opensea colection
    ...
    // owner minting to owner/others address
