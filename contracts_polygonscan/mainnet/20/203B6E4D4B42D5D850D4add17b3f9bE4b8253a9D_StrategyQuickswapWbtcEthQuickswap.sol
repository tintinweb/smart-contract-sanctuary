...
// File: Vault\StrategyQuickswapWbtcEthQuickswap.sol

contract StrategyQuickswapWbtcEthQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        token0ToEarnedPath = [address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token1ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
    ...
    // Convert dQuick to Quick
	   ...
	   approve(dQuickAddress, zeroAddress, balance);
