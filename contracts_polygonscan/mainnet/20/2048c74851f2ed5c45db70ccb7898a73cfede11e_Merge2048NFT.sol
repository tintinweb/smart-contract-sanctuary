...
contract Merge2048NFT is ERC1155 {
    ...
    constructor() ERC1155("") {
        ...
        genesisTimestamp = 1642002022; // Wed Jan 12 2022 15:40:22 GMT+0000
    }
        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            '{"description":"Merge2048 is the on-chain game. Get your tiles and merge your tiles. Happy Merge!","image":"data:image/svg+xml;base64,',
                            image,
                            '","name":"Tile ',
                            Strings.toString(tiles(tokenId)),
