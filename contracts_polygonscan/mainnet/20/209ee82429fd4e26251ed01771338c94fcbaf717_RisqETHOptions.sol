...
/**
 * @author macemclain
 * @title Risq ETH (Wrapped ETH) Bidirectional (Call and Put) Options
...
contract RisqETHOptions is Ownable, IRisqOptions {
    ...
    address[] public maticToEthSwapPath;
    IERC20 public eth;
     ...
     * @param token The address of ETH ERC20 token contract
     */
    constructor(
        ...
        maticToEthSwapPath = new address[](2);
        maticToEthSwapPath[0] = quickswapRouter.WETH();
        maticToEthSwapPath[1] = address(eth);
        ...
        returns (uint256 optionID)
    {
        ...
        uint amountIn = swapToETH(totalMATIC, total);
        ...
        )
    {
        ...
        totalMATIC = quickswapRouter.getAmountsIn(total, maticToEthSwapPath)[0];
    }
    ...
    /**
     * @notice Swap MATIC to ETH via quickswapswap router
