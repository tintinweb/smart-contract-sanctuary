...
// СloudSwapToken with Governance.
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function updateEmissionRate(uint256 _cstPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _cstPerBlock);
        pantherPerBlock = _cstPerBlock;
    }
