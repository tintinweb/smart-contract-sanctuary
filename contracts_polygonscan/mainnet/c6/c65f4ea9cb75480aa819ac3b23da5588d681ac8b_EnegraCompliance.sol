...
// File: contracts/features/ExchangeMonthlyLimits.sol
...
abstract contract ExchangeMonthlyLimits is BasicCompliance {
    ...
    mapping(address => ExchangeTransferCounter) exchangeCounters;

    /// Mapping for wallets tagged as exchange wallets
    mapping(address => bool) exchangeWallets;
    ...
    */
    function whitelistExchangeWallet(address _wallet, address _onchainid, uint16 _country) external {
        require(isOwner() || isAgent(msg.sender), "need to be owner or agent to perform this action");
...
// File: contracts/features/DayMonthLimits.sol
...
// File: contracts/compliance/custom_contracts/EnegraCompliance.sol
...
contract EnegraCompliance is ExchangeMonthlyLimits, CountryRestrictions, DayMonthLimits {
    /**
    ...
    */
    ...
    function canTransfer(address _from, address _to, uint256 _value) external view override returns (bool) {
        if (!complianceCheckOnExchangeMonthlyLimits(_from, _to, _value)
            ||
            !complianceCheckOnDayMonthLimits(_from, _to, _value)
            ||
