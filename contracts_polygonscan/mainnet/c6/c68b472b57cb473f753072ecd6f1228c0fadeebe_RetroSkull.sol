...
contract RetroSkull is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("RetroSkull", "RS") {
    setHiddenMetadataUri("ipfs://QmThLqFZQe8ZZcFZxWVUtbB2PxqPmErNroJVkaMyBUNUNt/hidden.json");
  }
