...
contract Trippie is ERC721URIStorage, Ownable, ERC721Enumerable {
    using Strings for uint256;
    ...
    string public baseURI =
        "ipfs://QmU2e7jMreTQ3CmsevvNMZy3iLXQ7hAmsDq1g4nE6t6p4e/";
    string public baseExtension = ".json";

    constructor(address _newOwner) ERC721("Trippy Hippies", "TH") {
        transferOwnership(_newOwner);
    }

    // PUBLIC FUNCTIONS:

    function mint(address _caller, uint256 _mintAmount) public {
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _setTokenURI((supply + i), (supply + i).toString());
        }
    }
