...
/**
 *Submitted for verification at https://t.me/DollyToken
*/
...
/**
 *Submitted for verification at DOLLY TOKEN
*/
...
contract DOLLYTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x77235C42621ec0db539Ab5A10EEBabe34363f247); // Marketing Address
    ...
    uint256 private _tTotal = 500000 * 10**6 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DOLLY TOKEN";
    ...
    uint256 public _maxTxAmount = 30000000000000 * 10**6 * 10**6;
