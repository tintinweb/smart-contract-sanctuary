...
contract TokenVault is Ownable, Pausable {
    ...
    function deposit(uint256 _amount) external whenNotPaused  {
        ...
        user.tokenAtLastUserAction = user.shares.mul(balanceOf()).div(totalShares);
    ...
    /**
     * @notice Reinvests TOKEN tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Token Vault
     */
     ...
     * @return Expected reward to collect in TOKEN
     */
