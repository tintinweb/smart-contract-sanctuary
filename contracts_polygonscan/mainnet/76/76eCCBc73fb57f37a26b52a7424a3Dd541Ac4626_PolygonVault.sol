...
contract PolygonVault is IVault, ERC20UpgradeSafe, ReentrancyGuardUpgradeSafe, OwnableUpgradeSafe {
  /// @notice Libraries
  ...
  function _deposit(uint256 amountToken) internal {
    ...
    require(totalSupply() > 1e5, "Vault::deposit:: total supply too low");
  }
  ...
  function withdraw(uint256 share) external override accrue(0) nonReentrant {
    ...
    require(totalSupply() > 1e5 || totalSupply() == 0, "Vault::withdraw:: total supply too low");
  }
