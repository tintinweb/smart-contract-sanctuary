...
// File contracts/Polygon/Curve/Curve_Polygon_ZapIn_General_V4.sol
...
///@author Zapper
///@notice This contract adds liquidity to Curve pools on Polygon with Matic or ERC20 tokens.
...
contract Curve_Polygon_ZapIn_General_V4 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;
    ...
    */
    ...
    function _fillQuote(
        ...
        if (swapTarget == wmaticTokenAddress) {
            IWETH(wmaticTokenAddress).deposit{value: amount}();
            return amount;
        }
