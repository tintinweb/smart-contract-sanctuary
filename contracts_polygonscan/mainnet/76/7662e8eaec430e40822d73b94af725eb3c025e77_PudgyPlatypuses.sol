...
contract PudgyPlatypuses is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Pudgy Platypuses", "PPNFT") {
    setHiddenMetadataUri("ipfs://QmVkENsT5j8W55FHFkK5q4V2HtTenWQHXBJyeGaKRvYRQS/hidden.json");
  }
