...
contract BigFatCatEvents is ERC1155, ERC1155Burnable, ERC1155Pausable, Ownable {
    ...
    constructor(address minter, string memory name_, string memory symbol_) ERC1155("") {
