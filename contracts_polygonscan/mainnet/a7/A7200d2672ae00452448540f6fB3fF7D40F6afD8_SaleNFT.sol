...
contract SaleNFT is ReentrancyGuard, Ownable, IERC721Receiver, ERC721Holder {
    ...
    address public constant SALE_ADDRESS = 0x6Ce07B7Ee17c3231987a5BF377487FF801608F63;
    ...
    function sendUnclaimedNftCardToAdminAddressByIndex(uint256 _index) external onlyOwner {
        ...
        if (_balanceOfNFT > 0)
            theEndlessNFTAddress.safeTransferFrom(address(this), ADMIN_ADDRESS, _index);
