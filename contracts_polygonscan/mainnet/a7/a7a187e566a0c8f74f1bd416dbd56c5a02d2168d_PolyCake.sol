...
contract PolyCake is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**9;       //tong cung 1 ty
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PolyCake";                  //ten token
    string private _symbol = "PLC";                   //ky hieu token
