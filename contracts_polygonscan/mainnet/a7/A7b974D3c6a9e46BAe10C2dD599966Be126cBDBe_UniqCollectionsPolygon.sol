...
contract UniqCollectionsPolygon is ERC721ClaimableV2 {
    ...
    constructor(
        ...
        ERC721ClaimableV2(_name, _symbol, _ttokenUri, _royaltyFee)
    {
    }
    ...
    // ----- OWNERS METHODS ----- //
    function mintNextToken(address _receiver) external onlyOwner{
        _safeMint(_receiver, _tokenNum);
        _tokenNum++;
    }
