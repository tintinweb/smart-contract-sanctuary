...
// File: Vault\StrategySingularfarmSingApeswap.sol

// openzeppelin v3.1.0

contract StrategySingularfarmSingApeswap is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToWantPath= [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
        wantToEarnedPath = [address(0x00cb898b0efb084df14dd8e018da37b4d0f06ab26d)];
    }

    function stake(uint256 _wantAmount)  internal override virtual{
        ISingular(masterChef).deposit(pid, _wantAmount);
    }
