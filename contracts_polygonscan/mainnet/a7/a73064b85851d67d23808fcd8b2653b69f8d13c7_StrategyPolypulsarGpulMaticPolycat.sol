...
// File: Vault\StrategyPolypulsarGpulMaticPolycat.sol

// openzeppelin v3.1.0

contract StrategyPolypulsarGpulMaticPolycat is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
        ...
        token1ToEarnedPath = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
    }
