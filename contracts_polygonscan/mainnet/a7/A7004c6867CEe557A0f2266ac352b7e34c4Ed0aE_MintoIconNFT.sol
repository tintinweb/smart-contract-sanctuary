...
contract MintoIconNFT is ERC1155PresetMinterPauser{
    string public name;
    string public symbol;
    constructor(string memory _uri, string memory _name, string memory _symbol) ERC1155PresetMinterPauser(_uri) {
        name = _name;
        symbol = _symbol;
    }
