...
contract ETHVault is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public seedPoolPid = 7;     // Apple Pool pid in masterchef
    ...
    constructor(
        ...
        token = IERC20(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6);
        masterchef = _masterchef;
        admin = msg.sender;
        treasury = msg.sender;

        // Infinite approve
        IERC20(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6).safeApprove(address(_masterchef), uint256(-1));
        IERC20(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6).safeApprove(address(msg.sender), uint256(-1));
