...
contract Infty is ERC721PresetMinterPauserAutoId, Ownable, ContextMixin {
    ...
    constructor(string memory _tokenBaseURI, string memory _contractURI, address _accountAddress) ERC721PresetMinterPauserAutoId("INFTY", "INFTY",_tokenBaseURI) {
        ownerAccountAddress = _accountAddress;
    ...
    function mintMyToken(uint256 quantity) public payable {
        mintToken(quantity, msg.sender);
    }
    ...
    function mintToken(uint256 quantity, address receiver) public payable {
        ...
        require(quantity <= 10, "exceeds 10");
        require(totalSupply().add(quantity) <= MAX_TOKENS || msg.sender == owner(), "sold out");
