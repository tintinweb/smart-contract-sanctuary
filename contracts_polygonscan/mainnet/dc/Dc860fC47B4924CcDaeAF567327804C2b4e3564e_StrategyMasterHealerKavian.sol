...
import "./BaseStrategySlip10.sol";

abstract contract BaseStrategyLP is BaseStrategySlip10 {
...
abstract contract BaseStrategySlip10 is Ownable, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    uint256 public slippageFactor = 900; // 10% slippage
...
contract StrategyMasterHealerKavian is BaseStrategyLPSingle {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function _vaultDeposit(uint256 _amount) internal override {
        IMasterchef(masterchefAddress).deposit(pid, _amount, address(0));
    }
