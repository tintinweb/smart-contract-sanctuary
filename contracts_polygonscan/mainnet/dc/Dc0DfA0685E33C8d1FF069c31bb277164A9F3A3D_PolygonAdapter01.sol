...
/**
* @dev This contract will route call to QuickSwap, UniswapV2Forks (other than QuickSwap), Curve, CurveV2, WETH, AAVEE2, MStable, DODOV2 and CurveV1ForkAdapter  exchanges
* 1- AAVEE2
* 2- Wmatic
* 3- Curve
* 4- UniswapV2Forks
...
*/
contract PolygonAdapter01 is IAdapter, NewUniswapV2, Curve, Aavee2, WethExchange, CurveV2, MStable, CurveV1ForkAdapter, DODOV2 {
    using SafeMath for uint256;
