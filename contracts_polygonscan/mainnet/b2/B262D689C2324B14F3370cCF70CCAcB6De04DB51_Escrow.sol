...
contract Escrow is Pausable, Ownable {
     ...
     */
    function contractsOf(address _address) public view returns (uint256[] memory) {
     ...
     * Cancel contract
     */
    function cancel(uint256 _id) public onlyPending(_id) onlyCreator(_id) returns (bool) {
        Contract storage _contract = contracts[_id];
