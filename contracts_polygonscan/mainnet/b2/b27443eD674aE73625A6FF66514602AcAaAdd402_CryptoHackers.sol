...
contract CryptoHackers is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("CryptoHackers NFT", "HACKERZ") {
        _tokenIds.increment();
    }
    ...
    uint256 private maxCap = 4444; // (4444)
    string public baseUri = "https://ipfs.io/ipfs/Qmf1vkuHAZeJg7X4ZSPKZX4prRCN2StJFeWaiuh7UFvDYc/";
