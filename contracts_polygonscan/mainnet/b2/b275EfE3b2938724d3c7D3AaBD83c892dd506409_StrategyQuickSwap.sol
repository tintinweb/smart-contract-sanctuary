...
contract StrategyQuickSwap is BaseStrategyLP {
    ...
    constructor(
        ...
        address[] memory _earnedToCosmicPath,
        ...
        earnedToCosmicPath = _earnedToCosmicPath;
    ...
    function earn() external override nonReentrant whenNotPaused onlyGov {
        address dQuickAddress = 0xf28164A485B0B2C90639E47b0f377b4a438a16B1;

        // Harvest farm tokens
        _vaultHarvest();

        // converts dQUICK tokens into QUICK tokens
        uint256 earnedDQuickAmt = IERC20(dQuickAddress).balanceOf(address(this));
        if(earnedDQuickAmt > 0) {
            IDragonLair(dQuickAddress).leave(earnedDQuickAmt);
        }
...
import "./libs/IStrategyCosmic.sol";
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant cosmicAddress = 0xa5Eb60CA85898f8b26e18fF7c7E43623ccbA772C;
    address public constant rewardAddress = 0xE97d4a9CA8c66Fcd9FC0Dd10197DE805F493772D;
    address public constant withdrawFeeAddress = 0x68Fc93Fc7a1faCb7aBEa4DC3CE7ee24DD109715E;
    address public constant feeAddress = 0x68Fc93Fc7a1faCb7aBEa4DC3CE7ee24DD109715E;
    ...
    address[] public earnedToCosmicPath;
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            IStrategyCosmic(rewardAddress).depositReward(usdcAfter);
