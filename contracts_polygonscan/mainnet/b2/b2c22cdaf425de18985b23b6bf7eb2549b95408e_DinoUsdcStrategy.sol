...
contract DinoUsdcStrategy is BaseStrategyMasterChef {
    ...
    address DINO = 0xAa9654BECca45B5BDFA5ac646c939C62b527D394;
    address DINO_USDC_LP = 0x3324af8417844e70b81555A6D1568d78f4D4Bf1f;

    address public SUSHI_ROUTER = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;

    address ERC_FUND = 0x01fE07ce760DA7a025e4Cf3f950aE236F8e62120;
    address MASTER_CHEF = 0x1948abC5400Aa1d72223882958Da3bec643fb4E5;
        ...
        )
    {
        ...
        reward_other_path[0] = DINO;
        reward_other_path[1] = USDC;

        reward_matic_path = new address[](3);
        reward_matic_path[0] = DINO;
        reward_matic_path[1] = USDC;
        reward_matic_path[2] = WMATIC;

        IERC20(DINO_USDC_LP).safeApprove(MASTER_CHEF, uint256(-1));
        IERC20(tokenA).safeApprove(SUSHI_ROUTER, uint256(-1));
        IERC20(tokenB).safeApprove(SUSHI_ROUTER, uint256(-1));
    }
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        //Swap 1/2 of remaining DINO for USDC
