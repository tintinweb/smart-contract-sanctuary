...
// File: contracts/BIFI/interfaces/iron/IIronSwapLP.sol
...
// File: contracts/BIFI/interfaces/iron/IIronSwap.sol
...
contract StrategyICEUSDC is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        uint256 toNative = IERC20(output).balanceOf(address(this)).mul(44).div(1000);
        ...
        uint256 paprFeeAmount = nativeBal.mul(paprFee).div(MAX_FEE);
        IERC20(native).safeTransfer(paprFeeRecipient, paprFeeAmount);
