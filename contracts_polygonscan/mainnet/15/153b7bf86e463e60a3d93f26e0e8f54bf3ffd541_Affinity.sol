...
contract Affinity {
    ...
    function voteUp(bytes32 _postId, uint8 _reputationAdded) external {
        ...
        require (validateReputationChange(_voter,_category,_reputationAdded)==true, "This address cannot add this amount of Affinity points");
    ...
    function voteDown(bytes32 _postId, uint8 _reputationTaken) external {
        ...
        address _contributor = postRegistry[_postId].postOwner;
        require (voteRegistry[_voter][_postId] == false, "Sender already voted in this post");
        require (validateReputationChange(_voter,_category,_reputationTaken)==true, "This address cannot take this amount of Affinity points");
