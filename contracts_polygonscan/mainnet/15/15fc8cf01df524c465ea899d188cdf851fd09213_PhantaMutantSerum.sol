...
contract PhantaMutantSerum is OptimizedERC721Enumerable, Ownable {
    using SafeMath for uint256;

    string public baseURI;

    constructor(string memory name, string memory symbol) OptimizedERC721Enumerable(name, symbol) {}
