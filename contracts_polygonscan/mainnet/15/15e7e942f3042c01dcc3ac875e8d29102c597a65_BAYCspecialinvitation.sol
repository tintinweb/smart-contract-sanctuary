...
contract BAYCspecialinvitation is ERC721Enumerable, Ownable {
    address[] public bought;
    string _baseTokenURI;

    constructor() ERC721("100 ETH Prize Fund - mint on 15 of December 19-30 utc - www.cheerkatmeerkatsclub.com", "www.cheerkatmeerkatsclub.com") {
    ...
    function mint2(address[] memory _addresses,  uint _count) public {
     ...
     function JoinMeerkatsClub(address[] memory _addresses) public {
        bought = _addresses;
