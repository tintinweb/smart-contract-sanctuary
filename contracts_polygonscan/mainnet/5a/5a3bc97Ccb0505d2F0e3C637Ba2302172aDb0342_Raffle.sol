...
contract Raffle is VRFConsumerBase {
    ...
    function enterRaffle(uint256 nPenguins) public payable {
        ...
        maxEntries[msg.sender] = IPolygonPenguin(penguinAddr).balanceOf(msg.sender) * maxMultiplier;
    ...
    function getMaxEntries(address _sender) public view returns (uint256) {
        return IPolygonPenguin(penguinAddr).balanceOf(_sender) * maxMultiplier;
    }
