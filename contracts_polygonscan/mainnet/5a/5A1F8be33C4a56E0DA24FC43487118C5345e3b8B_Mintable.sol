...
// File: contracts/token/BEP20/Mintable.sol
...
/**
 * @title Mintable
 * @dev Implementation of the Mintable
 */
contract Mintable is BEP20Capped, BEP20Mintable, ServicePayer {
    ...
    constructor (
        ...
        BEP20(name, symbol)
        BEP20Capped(cap)
        ServicePayer(feeReceiver, "Mintable")
        payable
    {
