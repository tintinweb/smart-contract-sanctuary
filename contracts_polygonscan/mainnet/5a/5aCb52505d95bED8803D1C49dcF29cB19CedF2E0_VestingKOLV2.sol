...
contract VestingKOLV2 is IVesting, EIP712Upgradeable, OwnableUpgradeable {
    ...
    bool public initialPercentageChanged;
    ...
    // for fix initialPercentage, 28_10
    function applyToChange() external onlyOwner {
        require(!initialPercentageChanged, "Changed before");
        initialPercentageChanged = true;
        _initialPercentage = 20e18;
        rewardsPaid[0x0df4214cBC6B1AA91d564A9af5aFd289e1526e00] += 60000e18;
        _rewardToken.safeTransfer(
            0x97F35c61DeF78D51b63Dbbb8737D5A87Df50325c,
            60000e18
        );
    }
