...
contract MOXmarket {
    ...
    */
    ...
    function acceptLastBid(uint _auctionId) public {
        ...
        //remove auction from auctionOwner array
        ...
        emit AuctionCompleted(msg.sender, _auctionId);
    }
    
    /**
    * @dev  Auction owner cancels auction
    *       Last bidder receives bid
    *       Auction owner receives NFT
    * 
    */
    ...
    /**
    * @dev  remove auction from auctionOwner array
    *       
    */
    function removeNoOrder(uint index) internal {
        auctionOwner[msg.sender][index] = auctionOwner[msg.sender][auctionOwner[msg.sender].length -1];
        auctionOwner[msg.sender].pop();
    }
