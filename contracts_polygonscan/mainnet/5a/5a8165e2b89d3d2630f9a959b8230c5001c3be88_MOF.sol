...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable{
    ...
    constructor(
        ...
        string memory baseTokenURIAfterparty_,
        string memory baseTokenURIVip_
    ) {
        _name = name_;
        _symbol = symbol_;
...
contract MOF is ERC721 {
    constructor() ERC721(
        "MOF Tickets", "MOF",
        "https://gateway.pinata.cloud/ipfs/QmNoErB2wX6RSUfXjkPEL3Ts2NyakUySg7nQ9GW6FS2gPK", // standard
        "https://gateway.pinata.cloud/ipfs/QmRKMzSEEKdgpKDJPmAMaFDJhUZB3QhLf6qCkQRXy4Au4a", // afterparty
        "https://gateway.pinata.cloud/ipfs/QmZ35vtqsxgMuZRHQ89sYihjkxn99H7CHWdfeYS3oVkyaY" // vip
    ){
