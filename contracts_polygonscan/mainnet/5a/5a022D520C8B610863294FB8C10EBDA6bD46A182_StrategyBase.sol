...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 6;
    ...
    address[] public pswamp_dai_path;
        ...
        )
    {
        ...
        pswamp_dai_path = new address[](4);
        pswamp_dai_path[0] = pswamp;
        pswamp_dai_path[1] = matic;
        pswamp_dai_path[2] = usdc;
        pswamp_dai_path[3] = dai;
    }
    ...
    function harvest() public override {
        ...
        if (_pswampBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(pswamp_dai_path, _pswampBalancePost);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public DAI_USDC_LP = 0xf04adBF75cDFc5eD26eeA4bbbb991DB002036Bdd;
