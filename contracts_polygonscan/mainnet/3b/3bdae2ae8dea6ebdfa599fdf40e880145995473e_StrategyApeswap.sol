...
abstract contract StrategyFeesBase is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public  minWMaticAmountToCompound = 1e18;
    ...
    function setDeadline(uint256 _deadline) external onlyGov{
        require(_deadline > 100, 'setDeadline: too small');
...
contract StrategyApeswap is StrategyLPBase {
    ...
    function harvest() internal virtual override{
        ...
        //apeswap gives both wmatic and earned. Convert the wmatic to token0 & token1. This will be converted to LP by earnedToWant() function
