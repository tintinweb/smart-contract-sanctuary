...
contract ZSC {
    ...
    uint256 constant MAX = 4000000000; // *10**18 for deposit-withdraw
    ...
    function fund(Utils.G1Point memory y, uint256 bTransfer) public {
        ...
        require(coin.transferFrom(msg.sender, address(this), bTransfer * 10 ** 18), "Transfer from sender failed.");
        require(coin.balanceOf(address(this)) <= MAX * 10 ** 18, "Fund pushes contract past maximum value.");
    }
    ...
    function burn(Utils.G1Point memory y, uint256 bTransfer, Utils.G1Point memory u, bytes memory proof) public {
        ...
        require(coin.transfer(msg.sender, bTransfer * 10 * 18), "This shouldn't fail... Something went severely wrong.");
    }
}
