...
contract VIETNAM84 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 96000000 * 10**9;       //tong cung 96 trieu
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "VIETNAM84";                  //ten token
    string private _symbol = "V84";                   //ky hieu token
