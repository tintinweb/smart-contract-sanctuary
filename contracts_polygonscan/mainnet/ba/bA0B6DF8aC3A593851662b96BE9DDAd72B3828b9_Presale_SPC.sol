...
contract Presale_SPC is Owned {
    ...
    uint256 public priceDecimal = 18;
    ...
    //    require(tokenAmount >= 1, "It was over maxMiaLimit");
        uint tokenAmount = paidAmount.div(10**mTokenDecimal).div(tokenPrice).mul(10**priceDecimal).mul(10**pTokenDecimal);
