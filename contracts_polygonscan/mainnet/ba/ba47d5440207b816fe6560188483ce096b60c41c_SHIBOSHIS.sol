...
contract SHIBOSHIS is ERC721, Ownable {
    ...
    uint256 public constant ALLOW_ETH_TIMESTAMP = SALE_START_TIMESTAMP;
    ...
    uint256 private tier1Leash = 0;
    uint256 private tier2Leash = 0;
    uint256 private tier3Leash = 0;

    uint256 private tier1ETH = 0; 
    uint256 private tier2ETH = 0;
    uint256 private tier3ETH = 0;
