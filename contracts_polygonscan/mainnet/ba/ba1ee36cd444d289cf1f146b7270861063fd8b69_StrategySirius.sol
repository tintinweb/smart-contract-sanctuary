...
// File: Vault\StrategySirius.sol

contract StrategySirius is Ownable, ReentrancyGuard, Pausable {
    ...
    event GovChanged(address indexed oldGovAddress, address indexed newGovAddress);
