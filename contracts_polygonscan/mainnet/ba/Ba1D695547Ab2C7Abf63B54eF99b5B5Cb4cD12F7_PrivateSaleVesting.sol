...
contract PrivateSaleVesting is ReentrancyGuard,Ownable {
    ...
    function _availableClaimableAmount(address _beneficiary) internal view returns (uint256 _amount) {
        ...
        // Vesting completed 
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(1)).div(100);
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(825)).div(10000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(165)).div(1000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(2475)).div(10000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(33)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(4125)).div(10000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(495)).div(1000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(5775)).div(10000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(66)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(7425)).div(10000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(825)).div(1000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(9075)).div(10000);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
            ...
            uint256 maxClaimable = (vestedAmount[_beneficiary].mul(99)).div(100);
            uint256 userTotalClaimed = totalClaimed[_beneficiary];
            if(userTotalClaimed < maxClaimable) {
                _amount = maxClaimable.sub(userTotalClaimed);
            }
