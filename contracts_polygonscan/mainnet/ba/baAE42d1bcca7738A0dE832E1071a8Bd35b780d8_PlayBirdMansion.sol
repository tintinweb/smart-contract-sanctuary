...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
  ...
  contract PlayBirdMansion is ERC721Enumerable, ContextMixin, Ownable {
    ...
    address[] private referredAddresses;
    ...
    constructor (address payable _artist, address payable _developer, address payable _marketer) ERC721("Plain Biscuit Money", "PBM") {
        artist = _artist;
