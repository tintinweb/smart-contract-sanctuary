...
/**
 * @notice The BaseStrategy implements reusable logic for all Violin strategies that earn a variety of rewardAssets at once.
 ...
 */
abstract contract BaseStrategyMulti is IStrategy {
    ...
    /// @dev The tokens the underlying protocol gives as a reward.
    ...
    function inCaseTokensGetStuck(
        ...
        for (uint256 i = 0; i < rewardTokens.length; i++) {
            require(token != rewardTokens[i], "invalid token");
        }
