...
contract SuChefSummoner is CloneFactory {
    ...
    event SummonSuChef(address indexed suChef, IMolMinimal indexed mochiMol, string details);
    
    constructor(address payable _template) public {
        template = _template;
    }
    
    function summonSuChef(address depositToken, IMolMinimal mochiMol, string calldata details) external returns (SuChef suChef) {
