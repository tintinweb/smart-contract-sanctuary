...
// File: contracts/PolkaFinanceToken.sol
...
contract PolkaFinance is BEP20('PolkaFinance', 'Polfi') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTPolfi::transfer: Burn value invalid");
