...
import "./BaseStrategyReflect10.sol";

abstract contract BaseStrategyLP is BaseStrategyReflect10 {
...
abstract contract BaseStrategyReflect10 is Ownable, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
