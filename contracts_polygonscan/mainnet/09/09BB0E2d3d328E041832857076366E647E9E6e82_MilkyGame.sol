...
contract MilkyGame is Ownable, ReentrancyGuard, VRFConsumerBase{
    using SafeMathChainlink for uint256;
    ...
    */
    ...
    function isFinished() public view gameInitiated notEmergency returns(bool){
