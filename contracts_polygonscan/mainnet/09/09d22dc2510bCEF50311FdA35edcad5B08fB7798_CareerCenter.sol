...
contract CareerCenter is Ownable, Pausable {
    ...
    /**
     * @notice Deposits funds into the Career Center
     ...
     */
    function harvest(address to) public notContract whenNotPaused {
        update();
        //Give Fry
        UserInfo storage user = userInfo[msg.sender];
    ...
    /**
     * @notice Withdraws from MasterChef to Career Center without caring about rewards.
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Career Center
     */
    ...
    /**
     * @notice Withdraws from funds from the Career Center
    ...
    function withdraw(uint256 _shares) public notContract {
     ...
     /**
     * @notice Withdraws and harvest from funds from the Career Center
     * @param _shares: Number of shares to withdraw
     * @param to: address to send rewards to
     */
    function withdrawAndHarvest(uint256 _shares, address to) public notContract {
        harvest(to);
        withdraw(_shares);
    }
    /**
