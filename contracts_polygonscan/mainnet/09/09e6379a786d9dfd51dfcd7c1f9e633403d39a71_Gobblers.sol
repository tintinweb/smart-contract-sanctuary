...
contract Gobblers is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant PRESALE_MAX_MINT = 69;
    uint256 public constant FREESALE_MAX_MINT = 1;
    uint256 public constant MAX_NFTS_MINT = 69;
    uint256 public constant RESERVED_NFTS = 69;
    address public constant artist1Address = 0x073097D33BeAdA266ED1Ab09c65118B4C123999B;
    address public constant artist2Address = 0x1Be8C47dCd346a5dcF2934EC1F1a54e43de8Bc42;
    address public constant artist3Address = 0x6b174Ea3B46233A882F525FC2e8cA47b6e27E5b9;
    ...
    constructor(string memory baseURI) ERC721("Gobblers", "GOBBLERS") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(artist1Address, ((balance * 25) / 100));
        _widthdraw(artist2Address, ((balance * 25) / 100));
        _widthdraw(artist3Address, ((balance * 25) / 100));
