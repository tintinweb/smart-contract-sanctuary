...
contract PolyWaifuSoul is ERC20, Pausable, Ownable {
   ...
   constructor() ERC20("PolyWaifu Soul", "PWS") {
        // Buy/Sell fee
        ...
        _routers[0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff] = true; //QuickSwap
        _routers[0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607] = true; //ApeSwap
    ...
    function transferFrom(
     ...
     function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        if (isAddressLP(_msgSender()) || isAddressLP(recipient)) {
            ...
            uint256 _fee = 0;
            if (recipient != _lpCreatorAddress && !_routers[recipient]) {
    ...
    function setRouterddress(address _addr, bool enable) external onlyOwner {
        _routers[_addr] = enable;
    }

    function isAddressRouter(address _addr) public view returns(bool) {
        return _routers[_addr];
    }
