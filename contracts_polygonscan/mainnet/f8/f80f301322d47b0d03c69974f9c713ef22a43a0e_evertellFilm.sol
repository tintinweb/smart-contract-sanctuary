...
contract evertellFilm is ERC1155 {
    uint256 public constant IMPERMANENCE = 1;
    uint256 public constant KINGPIN = 2;
    uint256 public constant APACHE = 3;
    uint256 public constant WOLVES = 4;
    uint256 public constant WITCH = 5;
   
    address public admin;
    
    string public name = "EVERTELL FILMS";
    string public symbol = "EVFLM";
    
    /** @dev Use ERC-1155 metadata standard for your JSON file & use hexadecimal of your token ID in _file_name.json */

    constructor()
        public
        ERC1155("https://evertell.s3.amazonaws.com/api/filmNFT/{id}.json")
        
/** @dev If you want tokens to be non-fungible, value must be 1 */        
    {
        _mint(msg.sender, IMPERMANENCE, 1000000, "");
        _mint(msg.sender, KINGPIN, 1000000, "");
        _mint(msg.sender, APACHE, 1000000, "");
        _mint(msg.sender, WOLVES, 1000000, "");
        _mint(msg.sender, WITCH, 1000000, "");
        admin = msg.sender;
    }
