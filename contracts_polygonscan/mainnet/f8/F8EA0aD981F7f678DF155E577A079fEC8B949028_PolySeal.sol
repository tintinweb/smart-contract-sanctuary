...
// File: contracts/PolysealToken.sol


pragma solidity 0.6.12;


// Polyseal with Governance.
contract PolySeal is BEP20('PolySeal', 'Seal') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTSeal::transfer: Burn value invalid");
