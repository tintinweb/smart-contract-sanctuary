...
// Part: ParaswapResolver

abstract contract ParaswapResolver {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    address internal constant paraswap = 0x90249ed4d69D70E709fFCd8beE2c5A566f65dADE;
    GST2 gst2 = GST2(0x000000000000CB2D80A37898be43579C7b616844);
    /**
     * @dev Sell ERC20_Token using ParaSwap.
     * @param buyAddr The address of the token to buy.
     * @param min_return_amt The amount of buyAmt/sellAmt with slippage.
     * @param callData from paraswap API.
    */
    function swap(
        address buyAddr,
        uint256 min_return_amt,
        bytes memory callData
    ) external payable  {
        uint initialGas = gasleft();
        IERC20 token = IERC20(buyAddr);
