...
// File: Vault\StrategyQuickswapRelayQuickQuickswap.sol

contract StrategyQuickswapRelayQuickQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x00904371845bc56dcbbcf0225ef84a669b2fd6bd0d)];
        token0ToEarnedPath = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token1ToEarnedPath = [address(0x00904371845bc56dcbbcf0225ef84a669b2fd6bd0d), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x00904371845bc56dcbbcf0225ef84a669b2fd6bd0d)];
    }
