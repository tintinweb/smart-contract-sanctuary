...
contract Accelerator is Initializable, Migrateable, Manageable {
    ...
    function axionBuyAndStakeWithDivs(
        ...
        require(_amount <= IVentureCapital(ventureCapital).getTokenInterestEarned(msg.sender, _token), 'AUTOSTAKER: amount is higher than wBTC divs balance'); //ensure the user is not trying to bid with more than the amount of wBTC divs he has
        ...
        IVentureCapital(ventureCapital).withdrawDivTokensToAccelerator(msg.sender, _token, payable(address(this)));
