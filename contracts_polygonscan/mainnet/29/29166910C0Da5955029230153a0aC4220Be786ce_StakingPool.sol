...
contract StakingPool is ERC20, ReentrancyGuard, TwoStageOwnable, Initializable {
    using SafeMath for uint256;
    ...
    uint256 private _claimingFeePercent;
    uint256 private _perBlockReward;
    uint256 private _startBlockNumber;
    uint256 private _duration;
    uint256 private _unstakingTime;
    uint256 private _defaultPriceMantisas;

    IERC20 private _stakingToken;
    string private _syntheticTokenName;
    string private _syntheticTokenSymbol;
    ...
    function initialize(
        string memory syntheticTokenName_,
        string memory syntheticTokenSymbol_,
        IERC20 stakingToken_,
        address owner_,
        uint256 claimingFeePercent_,
        uint256 perBlockReward_,
        ...
        _syntheticTokenName = syntheticTokenName_;
        _syntheticTokenSymbol = syntheticTokenSymbol_;
        _stakingToken = stakingToken_;
        _owner = owner_;
        _claimingFeePercent = claimingFeePercent_;
        _perBlockReward = perBlockReward_;
        _startBlockNumber = startBlockNumber_;
        _duration = duration_;
        _unstakingTime = unstakingTime_;
        _defaultPriceMantisas = defaultPriceMantissa;
    }
