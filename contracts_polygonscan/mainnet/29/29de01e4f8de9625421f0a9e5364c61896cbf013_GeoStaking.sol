...
/*
 ...
 | |_| || |___| |_| | ___) |                       
  \____||_____|\___/ |____/                        
       ...
       ____  _____   _     _  __ ___  _   _   ____ 
      / ___||_   _| / \   | |/ /|_ _|| \ | | / ___|
      \___ \  | |  / _ \  | ' /  | | |  \| || |  _ 
       ___) | | | / ___ \ | . \  | | | |\  || |_| |
...
contract GeoStaking is Roles{
	...
	function withdrawExcess(address token) external onlyOwner{
		uint256 _balance = GEOS20(token).balanceOf(address(this));
		uint256 _left = _balance - _Nexcess;
		require(GEOS20(token).transfer(msg.sender, _left));
	}
