...
// File: original_contracts/adapters/polygon/PolygonAdapter.sol
...
* 2- WETH
* 3- Curve
* 4- UniswapV2Forks(COMETH, SUSHI)
* The above are the indexes
*/
contract PolygonAdapter is IAdapter, UniswapV2, Curve, Aavee2, WethExchange {
    using SafeMath for uint256;
