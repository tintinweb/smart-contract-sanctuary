...
interface IERC20 {
  ...
  // function placeBid(uint256 _tokenId, uint256 _amount, bool awardType) external;
   function placeBid(address seller,uint256 _tokenId, uint256 _amount, bool awardType, string calldata ownerId, address ownerAddress) external;
  function getBidAmount(uint256 _tokenId, address ownerAddress) external view returns(uint256, string memory);
  function updateBidder(uint256 _tokenId, string calldata ownerId) external; 
...
// File: contracts\awardNFTDexpolygon.sol
