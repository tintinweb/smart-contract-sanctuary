...
contract StrategyKyber is StratManager, FeeManager {
    ...
    function addLiquidity() internal {
        ...
        uint256 vReserve0 = reserve0.mul(10**lp1Decimals);
        uint256 vReserve1 = reserve1.mul(10**lp0Decimals);
        uint256 combinedReserves = vReserve0.add(vReserve1);

        uint256 split = vReserve0.mul(1e6).div(combinedReserves);
