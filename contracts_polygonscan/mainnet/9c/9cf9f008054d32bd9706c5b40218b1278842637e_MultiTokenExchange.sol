...
contract MultiTokenExchange is Ownable {
    ...
    constructor () {
        ...
        exchangeToken = address(0x64a43a3E9F08629499CeD15BdF3e0dB26fba5550);
        
        // the wallet for withdraw money
        walletAddress = msg.sender;

        // initialise quick swap bite-eth-usdt path
        path.push(0x280724409b288dE06C6D66c05965D3d456e2283a);
        path.push(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619);
        path.push(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
        
        // enable BITE token for exchangeForToken
        baseTokens[address(0x280724409b288dE06C6D66c05965D3d456e2283a)] = true;
        tokenAddresses.push(address(0x280724409b288dE06C6D66c05965D3d456e2283a));
    }
    ...
    function getBITEPrice() private view returns (uint256) {
      // use quick swap price feed for BITE
      uint[] memory amountsOut = UniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff).getAmountsOut(
        1000000000000000000, // assuming the number of BITE is 1
        path
      );
      return amountsOut[2];
    }
    ...
    function getExchangeRateInfo(address baseToken) public view returns (uint256, int256) {
        ...
        if (baseToken == address(0x280724409b288dE06C6D66c05965D3d456e2283a)) {
           eInfo.exchangeRate = getBITEPrice();
           eInfo.decimalsPair = 6;
        } else {
