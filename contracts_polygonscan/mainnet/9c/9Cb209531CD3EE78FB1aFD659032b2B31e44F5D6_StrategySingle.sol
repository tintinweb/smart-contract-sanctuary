...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_dai_path, _harvestBalancePost2);
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0x253b345A9fa785C929867E6Db9e4b3C72e1c85c8;
    address public Want_Token = 0x73A7b621090b8d7584cc40D1B1F016fB831949A3;
