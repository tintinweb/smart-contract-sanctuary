...
contract PokiCredit is ERC20Capped, ReentrancyGuard {

  address constant public POKI = 0x649277F4c36bF9b25cA2CD059Ff58A40Dfe757f4;
  address constant public BRIDGE = 0xC14769721Abf735f26Cc94949ACCDf9c263a9854;
  
  constructor() ERC20("PokiCredit", "POKICR") ERC20Capped(80000 ether) {
  }

  function deposit(uint256 _amount) public nonReentrant {
    PokiToken(POKI).burnFrom(msg.sender, _amount);
