...
// File contracts/CharityNftCollection.sol
...
contract CharityNftCollection is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(string memory baseURI_, address payable charityAddress_) ERC721("Testol", "TEST") {
        baseURI = baseURI_;
