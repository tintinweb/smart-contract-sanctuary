...
contract PolygonLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function ownerBulkMint(uint256 startTokenId, uint256 endTokenId) public nonReentrant onlyOwner {
        require(startTokenId > 0 && endTokenId < 8001, "Token ID invalid");
    ...
    constructor() ERC721("PolygonLoot", "PLOOT") Ownable() {}
}
