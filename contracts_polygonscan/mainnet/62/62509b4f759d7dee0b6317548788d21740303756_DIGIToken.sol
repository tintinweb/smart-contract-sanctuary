...
contract DIGIToken is Ownable, ERC20 {
    ...
    constructor() ERC20("DIGI", "DIGI") {
        _locked = false;
        _mint(_msgSender(), 500000000 * 10**18);
    }
