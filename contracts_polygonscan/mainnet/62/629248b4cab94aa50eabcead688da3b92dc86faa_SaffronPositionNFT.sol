...
// File contracts/SaffronPositionNFT.sol
...
contract SaffronPositionNFT is ERC721Enumerable{
  ...
  function mint(address _to, uint256 _amount, uint256 _principal, uint256 _tranche) public returns (uint256) {
  ...
  function begin_unfreeze(address user, uint256 token_id) public {
  ...
  function tokenURI(uint256 tokenId) public pure override returns (string memory) {
    return "ipfs://QmRRvYbM39cCtLe7eNbo6RHg5oJqgewW4rGtnFySCEtRzH/";
  }
}