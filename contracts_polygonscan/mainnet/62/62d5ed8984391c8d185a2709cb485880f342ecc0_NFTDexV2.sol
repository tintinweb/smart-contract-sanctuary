...
// File: contracts/MainnetBlindDex.sol
...
contract NFTDexV2 is ERC721Full, ERC721MetadataMintable, Ownable {
  IERC20 ALIA;
...
//   event SetValue(address indexed from, uint256 main, uint256 _author, uint256 _platform);
  ...
  function sellNFT(address nft_a,uint256 tokenId, address seller, uint256 price, uint256 priceDollar) public returns (bool) {
    require(msg.sender == 0xcfd872E3E8FB719EBEce7e872eD5DC287BB1E329 || (msg.sender == seller && ownerOf(tokenId) == seller), "101");
    ...
    msg.sender == 0xcfd872E3E8FB719EBEce7e872eD5DC287BB1E329 ? transferFromAdmin(seller, tokenId) :  transferFrom(seller, address(this), tokenId) ;
    ...
    function MintAndSellNFT(address to, string memory tokenURI,uint256 quantity, bool flag, uint256 price, string memory ownerId, uint256 royality, uint256 priceDollar) public returns (bool) { 
      ...
      if(msg.sender == 0xcfd872E3E8FB719EBEce7e872eD5DC287BB1E329){
        adminOwner[to] = true;
      }
  ...
  function buyNFT(address nft_a,uint256 tokenId, address buyer) public returns (bool) {
        ...
        uint256 price;
        if(_tokenAuthors[tokenId] == 0xcfd872E3E8FB719EBEce7e872eD5DC287BB1E329 && adminOwner[temp.seller] && adminDiscount > 0 && msg.sender != nonCryptoNFTVault){
  ...
  function buyNftNonCrypto(address  nft_a, uint256 tokenId, string memory ownerId) public returns(bool) {
    fixedSell storage temp = _saleTokens[tokenId];
    uint256 tempPrice;
     if(_tokenAuthors[tokenId] == 0xcfd872E3E8FB719EBEce7e872eD5DC287BB1E329 && adminOwner[temp.seller] && adminDiscount > 0){
      temp.price = temp.price - ((temp.price * adminDiscount) / 1000);
      _dollarPrice[tokenId] = _dollarPrice[tokenId] - ((_dollarPrice[tokenId]  * adminDiscount) / 1000);
     }
     if(temp.price > 0){
  ...
  function updateTokenURI(uint256 tokenIdT, string memory uriT) public{
        require(_tokenAuthors[tokenIdT] == 0xcfd872E3E8FB719EBEce7e872eD5DC287BB1E329,"102");
