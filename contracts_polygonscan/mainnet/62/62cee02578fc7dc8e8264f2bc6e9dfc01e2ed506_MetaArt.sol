...
contract MetaArt is Context, IERC20, Ownable {
    ...
    string private _name = "MetaArt";
    string private _symbol = "MTA";
    uint8 private _decimals = 8;
    uint256 private _totalSupply = 5 * 10**8 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xF591585768e07EA482f481709B5E9c49f56Ef75F);
