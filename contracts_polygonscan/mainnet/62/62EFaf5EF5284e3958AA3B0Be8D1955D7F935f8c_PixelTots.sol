...
contract PixelTots is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	//presale settings
	uint256 public presaleDate = 1639922400;
	uint256 public publicDate = 1640023200;
	...
	publicDate = _newPublicDate;
	}
	function setPresaleDate(uint256 _newPresaleDate) public onlyOwner {
	presaleDate = _newPresaleDate;
	}
