...
interface IMasterChef {
    ...
    function stakedWantTokens(uint256 _pid, address _user) external view returns (uint256, uint256);
...
contract StrategyCommonChefSingle is StratManager, FeeManager {
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) = IMasterChef(chef).stakedWantTokens(poolId, address(this));
        return _amount;
    }
