...
contract Hashgrid is ERC20, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Hashgrid", "HD") ERC20Permit("Hashgrid") {
        _mint(msg.sender, 307695000000 * 10 ** decimals());
    }
