...
contract TheBonyBastards is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    constructor(string memory baseURI, address payable creator,uint256 _count) ERC721("The Bony Bastards", "TBB") {
        setBaseURI(baseURI);
