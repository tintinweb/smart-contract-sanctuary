...
contract HarmonyDEX   is Context, IERC20, Ownable {
...
contract Harmony is HarmonyDEX   , NativeMetaTransaction, ContextMixin {
    constructor() HarmonyDEX   () {
