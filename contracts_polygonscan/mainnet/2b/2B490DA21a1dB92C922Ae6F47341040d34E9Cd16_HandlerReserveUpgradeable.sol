    ...
    ERC20SafeUpgradeable
{
    ...
    function swap(
        ...
        returnAmount = oneSplitWrap.swap(fromToken, destToken, amount, minReturn, distribution, flags, true);
        return returnAmount;
    }
    ...
    function swapMulti(
        ...
        IOneSplitWrap oneSplitWrap = IOneSplitWrap(oneSplitAddress);
        returnAmount = oneSplitWrap.swapMulti(tokens, amount, minReturn, distribution, flags, true);
        return returnAmount;
    }
