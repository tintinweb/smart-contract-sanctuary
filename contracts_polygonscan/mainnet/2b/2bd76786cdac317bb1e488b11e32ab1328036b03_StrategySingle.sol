...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0x80244C2441779361F35803b8C711C6c8fC6054a3;
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            if (rewardToken != want) {
                _swapUniswapWithPath(bone_usdc_path, _harvestBalance);
            }
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public BONE_MASTER_CHEF = 0x0d17C30aFBD4d29EEF3639c7B1F009Fd6C9f1F72;
