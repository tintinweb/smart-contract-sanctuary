...
contract CutToken is ERC20("Cutter Token", "CUT"), Ownable {
    ...
    /// @dev A checkpoint for marking number of votes from a cutn block
    struct Checkpoint {
        uint32 fromBlock;
        uint256 votes;
    }
    ...
    */
     ...
     * @return The number of votes the account had as of the cutn block
     */
