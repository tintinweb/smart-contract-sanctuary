...
contract TokenV2 is ERC20, ERC20Burnable {
  ...
  constructor() payable ERC20("Your Farm", "YRF") {
    owner = msg.sender;
  }
...
contract FarmV2 {
    ...
    function createFarm(address payable _charity) public payable {
        ...
        require(
            // Donation must be at least $0.20 to play
            msg.value >= 2 * 10**(decimals - 1),
            "INSUFFICIENT_DONATION"
        );

        require(
            // The Water Project - double check
            _charity == address(0x17EBBBf7D7310dd379F91E5F9a021a36EA21D0de),
            "INVALID_CHARITY"
        );
