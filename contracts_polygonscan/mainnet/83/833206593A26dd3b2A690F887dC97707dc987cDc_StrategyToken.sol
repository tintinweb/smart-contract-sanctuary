...
import "./BaseStrategyToken.sol";

contract StrategyToken is BaseStrategyToken {
    ...
    constructor(
        ...
        address[] memory _earnedToWantedPath
    ) {
        ...
        earnedToWantedPath = _earnedToWantedPath;
...
abstract contract BaseStrategyToken is BaseStrategy {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public destructionAddress = 0xcFf9d84D2F8E9aa6A9E0AFE268A87CB1d3aB6F21;
    ...
    uint256 public controllerFee = 0;//50; // 0.50%
    uint256 public rewardRate = 0;//50; // 0.50%
    uint256 public buyBackRate = 0;// 400; // 4%
    ...
    address[] public earnedToWantedPath;
    ...
    function _safeSwap(
        ...
        // if (_path[_path.length.sub(1)] == destructionAddress && _to == buyBackAddress) {
