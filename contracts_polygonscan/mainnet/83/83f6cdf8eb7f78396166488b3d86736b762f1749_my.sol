...
contract my is Owned{
    ...
    function SwapEthToUsdcByQuick(uint amountOutMin,address[] memory path) public payable{
        quickSwapContract_.swapExactETHForTokens(amountOutMin, path, msg.sender,3279146672);
    }
