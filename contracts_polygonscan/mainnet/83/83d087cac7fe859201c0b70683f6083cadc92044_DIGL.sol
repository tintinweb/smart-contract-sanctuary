...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "DIGILABS";
    string internal constant SYMBOL = "DIGL";
    ...
    uint256 internal constant TOTAL_SUPPLY = 99 * 10 ** 6 * ZEROES;
    uint256 internal _reflectedSupply = (MAX - (MAX % TOTAL_SUPPLY));
    
    uint internal TIME_LIMIT_TRANSACTION = 20 seconds;
    ...
    uint256 internal maxWalletBalance = maxTransactionAmount * 3; // 10 * maxTransactionAmount
     ...
     uint256 internal capWhaleWalletBalance = (50 * maxWalletBalance) / 100; // 50% of the maxWalletBalance
     ...
     */
    address internal tipToTheDev = 0x9804111F8D8B843C5260cdBB00bB4E9Bf175afee;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Rfi, 50, address(this) ); // 5% Redistribute to holders
        _addFee(FeeType.Burn, 10, burnAddress ); // 1% Burn
        _addFee(FeeType.Liquidity, 50, address(this) ); // 5% added to liquidity
