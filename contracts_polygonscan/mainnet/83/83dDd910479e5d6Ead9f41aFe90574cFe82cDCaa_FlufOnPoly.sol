...
contract FlufOnPoly is ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_ALLOWED = 50;
    uint256 public MAX_PRESALE_ALLOWED = 25;
    uint256 public price = 10000000000000000; //0.1 ETH
    ...
    constructor(string memory baseURI) ERC721("Winter Penguins", "WinterPenguins") {
        setBaseURI(baseURI);
    }
