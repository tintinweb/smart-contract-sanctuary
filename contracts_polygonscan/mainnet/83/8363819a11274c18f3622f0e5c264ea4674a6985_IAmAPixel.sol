...
contract IAmAPixel is Ownable, ERC721Enumerable {
    ...
    string public PERSON_PROVENANCE = "";
    ...
    ) ERC721("I Am A Pixel", "Pixel Person") {
        setBaseURI(_initBaseURI);
    }

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        PERSON_PROVENANCE = _provenanceHash;
    }
