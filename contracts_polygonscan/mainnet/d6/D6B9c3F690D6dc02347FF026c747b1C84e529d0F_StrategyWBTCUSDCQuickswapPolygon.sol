...
// File: interfaces/quickswap/IStakingRewards.sol
...
// File: contracts/StrategyWBTCUSDCQuickswapPolygon.sol
...
contract StrategyWBTCUSDCQuickswapPolygon{
    ...
    //QUICK
    address public reward = 0x831753DD7087CaC61aB5644b308642cc1c33Dc13; // Token we farm and swap to want / lpComponent

    //WBTC/USDC Uniswap V2 LP token
    address public want;
    ...
    function getName() external pure returns (string memory) {
        return "StrategyWBTCUSDCQuickswapPolygon";
    }
    ...
    function harvest() public {
        ...
        require(_reward > 0, "No Rewards to Harvest");
        ...
        uint256 earned = IERC20(want).balanceOf(address(this)).sub(_before);
