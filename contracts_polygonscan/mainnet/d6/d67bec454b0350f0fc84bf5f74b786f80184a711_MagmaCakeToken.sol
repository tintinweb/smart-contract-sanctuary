...
contract MagmaCakeToken is Context, IERC20, Ownable {
...
contract MagmaCake is MagmaCakeToken, NativeMetaTransaction, ContextMixin {
    constructor() MagmaCakeToken() {
