 ...
 *
 */
contract MOXToken is Context, IERC20Metadata, Ownable { 
    ...
    address private _supportTokenContractAddress;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if ((msg.sender != _nftContractAddress) && (msg.sender != _supportTokenContractAddress) && (msg.sender != _additionalContract)) {
     ...
     */
    function setSupportTokenContractAddress(address supportTokenAddress) public onlyOwner{
       _supportTokenContractAddress = supportTokenAddress;
    }
     ...
     */
    function tokensArrayToHarvest(uint256[] memory tokenIds) public view returns (uint256) {
        uint256 totalSum;
        for (uint i = 0; i < tokenIds.length; i++)
