...
// Dragon Token with Governance.
contract DragonToken is BEP20('Dragon Token', 'DRA') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DRA (not scaled);
