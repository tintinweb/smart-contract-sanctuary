...
// File: Vault\StrategyApeswapWmaticBnbApeswap.sol

// openzeppelin v3.1.0

contract StrategyApeswapWmaticBnbApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        token1ToEarnedPath = [address(0x00a649325aa7c5093d12d6f98eb4378deae68ce23f), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x005d47baba0d66083c52009271faf3f50dcc01023c)];
