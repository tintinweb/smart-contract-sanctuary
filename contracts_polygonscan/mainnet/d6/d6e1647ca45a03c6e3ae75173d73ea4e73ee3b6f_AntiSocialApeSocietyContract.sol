  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x5E4d90b5A496E0b2aA641b30B2CA7C8a666fCBeD);
    ...
    // File: contracts/antiSocialApeSocietyContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract AntiSocialApeSocietyContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Anti Social Ape Society", "ASAS", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmWvCapJeiFJ5dGg2UUpyL99UtZ6eQV2oVfRwCfsbi5eba/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/F0RtgMPEEl4fuQotQtrk/contract-metadata";
        }
    }