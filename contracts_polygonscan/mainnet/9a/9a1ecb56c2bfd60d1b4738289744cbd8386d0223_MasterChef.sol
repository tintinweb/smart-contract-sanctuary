...
contract PolyToken is ERC20('TESTE Token', 'TESTE') {
...
// MasterChef is the master of Token. He can make tokens and he is a fair guy.
//
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of Token's
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. Token's to distribute per block.
        uint256 lastRewardBlock;  // Last block number that Token's distribution occurs.
        uint256 accTokenPerShare;   // Accumulated Token's per share, times 1e18. See below.
    ...
    uint256 public TokenPerBlock = 0.015 ether;
