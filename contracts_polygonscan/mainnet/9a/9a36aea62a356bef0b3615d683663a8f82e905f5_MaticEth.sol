...
/**
 *Buy MaticEth and get rewarded in ETH
*/
...
contract MaticEth is Context, IERC20, Ownable {
    ...
    string private constant _name = "MaticEth";
    string private constant _symbol = "MaticEth";
