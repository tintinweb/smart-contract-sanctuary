...
contract DreamStrategy is Ownable, ReentrancyGuard {
    ...
    // The address of the kingdom dream factory
    address public KINGDOM_DREAM_FACTORY;
    ...
    constructor() {
        KINGDOM_DREAM_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == KINGDOM_DREAM_FACTORY, "Not factory");
    ...
    function deposit() external nonReentrant {
        require(block.number <= bonusEndBlock, "Dream has finished");

        UserInfo storage user = userInfo[msg.sender];

        uint256 _amount = stakedToken.balanceOf(msg.sender);

        require(_amount > 0, "Your out of morpheus for on this dream kingdom");
    ...
    function withdraw() external nonReentrant {
        ...
        require(block.number > bonusEndBlock, "Withdrawal is locked until pool finish");
