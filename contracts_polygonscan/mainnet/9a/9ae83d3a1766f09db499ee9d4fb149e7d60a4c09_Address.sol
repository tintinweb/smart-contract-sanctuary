...
/*
    Simple Time Locker by SpookFinance
...
//A simple contract where I can send tokens and then withdraw them in 180 days
contract TimeLocker is Ownable {
    ...
    function salvage(address _token, uint256 _amount) public onlyOwner {
        require(unlockTime < now, "Can't withdraw yet");
