...
contract IrisToken is ERC20("WAVE", "WAVE"), Ownable {
...
// MasterChef is the master of WAVE. He can make WAVE and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once Wave is sufficiently
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    uint256 constant max_iris_supply = 10500000 ether;

    // IRIS tokens created per block.
    uint256 public irisPerBlock = 0.2 ether;
