...
contract Agrotoken is IERC20 {
    ...
    * @param _newAmount new fee value (consider feeDecimals: if feeDecimals equals 8, then a 2% fee should be passed as 200000000 at _newAmount field)
