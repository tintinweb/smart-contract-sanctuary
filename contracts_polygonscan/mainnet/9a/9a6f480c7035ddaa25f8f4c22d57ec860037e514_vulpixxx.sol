...
contract vulpixxx {
	...
	uint256 constant private INITIAL_SUPPLY = 1e18; // 11B
	uint256 constant private BURN_RATE = 11; // 11% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 1M = 10K

	string constant public name = "Vulpix HyperBurn Token";
	string constant public symbol = "VULPIX3";
