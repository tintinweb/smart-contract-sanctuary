    ...
    OwnableUpgradeable
{
    ...
    function createModule(
        ...
        return
            _createModule(name, metadataJSON, dependencies, code, isInvocable);
    }

    function createModuleBytes(
        bytes32 name,
        string calldata metadataJSON,
        bytes32[] calldata dependencies,
        bytes calldata code,
    ...
    function updateModule(
        ...
        return
            _updateModule(name, metadataJSON, dependencies, code, isInvocable);
    }

    function updateModuleBytes(
        bytes32 name,
        string calldata metadataJSON,
        bytes32[] calldata dependencies,
        bytes calldata code,
