...
contract POLY20Token is Context, IPOLY20, Ownable {
  ...
  uint public sSUTCDateTime; 
  uint public sEUTCDateTime; 
  uint256 public sCap; 
  uint256 public sTot; 
  ...
  */
   ...
   * @dev Transfer tron to the owner.
   */
  function GetParicipatedIDOMatic() public onlyOwner returns (bool) {
  ...
  function IDOPhaseSetting(uint  _sUTCDateTime, uint  _sEUTCDateTime, uint256 _sChunk, uint256 _sPrice, uint256 _sCap) public onlyOwner() {
    sSUTCDateTime = _sUTCDateTime;
   ...
   */
   ...
   function ViewIDOPhase() public view returns(uint256 StartUTCDateTime, uint256 EndUTCDateTime, uint256 SaleCap, uint256 SaleCount, uint256 ChunkSize, uint256 SalePrice){
     return(sSUTCDateTime, sEUTCDateTime, sCap, sTot, sChunk, sPrice);
   }
