...
contract StrategyMaximizer_renBTC_WBTC is GravityMaximizer {

    address renbtc_wbtc_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0x1d89d5d13B182b21f8AA883E4d2C8Fa059ab6CAE);
        address renbtc_wbtc_lp = address(0xCDd1aD14b4c156aFF8D833dE1793F67d75237909);
