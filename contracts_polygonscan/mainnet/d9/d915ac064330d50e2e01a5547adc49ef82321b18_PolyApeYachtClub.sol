...
// File: contracts/PolyApeYachtClub.sol
...
/**
 * @title PolyApeYachtClub contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract PolyApeYachtClub is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant apePrice = 0; //FREE
    ...
    */
    function mintApe(uint numberOfTokens) public payable {
        ...
        require(apePrice.mul(numberOfTokens) <= msg.value, "MATIC value sent is not correct");
