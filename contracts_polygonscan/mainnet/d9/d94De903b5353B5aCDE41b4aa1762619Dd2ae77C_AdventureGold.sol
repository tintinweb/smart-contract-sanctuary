...
contract AdventureGold is Context, Ownable, ERC20 {
    ...
    */
    ...
    constructor(address loot, uint256 maxTokens, address transferOwner) Ownable() ERC20("AD", "GOLD") {
        ...
        lootContract = IERC721Enumerable(loot);
    }
    ...
    onlyOwner
    {
        lootContract = IERC721Enumerable(lootContractAddress_);
    }
