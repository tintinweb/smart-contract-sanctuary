...
contract PreGuruToken is Divine {
  ...
  constructor() Divine( "PreGuru", "pGURU", 18 ) {
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal view override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer pGURU." );
  }
