...
contract StrongNode is ERC20, Ownable {
    uint256 public nTrades = 0;
    uint256 public maxTrades = 200;
    uint256 public maximumTradeAmount = 1000000000 * (10**uint256(decimals()));

    constructor(address providerAddr) public ERC20("StrongNode", "SD") {
        _mint(providerAddr, 10000000000 * (10**uint256(decimals())));
    }
