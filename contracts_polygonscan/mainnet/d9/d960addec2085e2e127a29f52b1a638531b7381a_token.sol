...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 600*10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Poly Treasuru";
    string private _symbol = "TRZ";
    ...
    address public ownerAddres = address(0xEdbf84919Fe63Cc53384A232ea6a99eF084081fF);
    uint256 private _previousBurnFee = _burnFee;


    uint256 public _maxTxAmount = 600 * 10 **18;
