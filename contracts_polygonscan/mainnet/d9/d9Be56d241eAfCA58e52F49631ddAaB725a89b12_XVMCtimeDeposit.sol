...
contract XVMCtimeDeposit {
    ...
    //address public oldPool = 0xfD08FA4a344D147DCcE4f29D258B9F4ae18e6ee0; //old pool we can migrate from
     ...
     */
    function setTrustedSenders(address _sender1, address _sender2, address _sender3, address _sender4, address _sender5) external adminOrOwner {
