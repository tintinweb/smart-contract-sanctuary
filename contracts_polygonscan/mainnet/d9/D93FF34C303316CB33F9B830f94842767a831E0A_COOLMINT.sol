...
// COOLMINT with Governance.
contract COOLMINT is BEP20("Cool Mint Token", "COOLMINT", 30000000000000000000000) {
...
contract MasterChef is Ownable, ReentrancyGuard {
        ...
        returns (uint256)
    {
        ...
        if (block.number > pool.lastRewardBlock && lpSupply != 0) {
            ...
            accMINTPerShare = accMINTPerShare.add(
                MINTReward.mul(1e12).div(lpSupply)
            );
        }
    ...
    function updatePool(uint256 _pid) public {
        ...
        .mul(pool.allocPoint)
        .div(totalAllocPoint);
        MINT.mint(devaddr, MINTReward.div(20));
