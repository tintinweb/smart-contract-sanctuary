...
// Flower Girl Special Editions (FlowerGirlsSpecials.sol)

/*
 *   Flower Girl Special Editions is an ERC-1155 Smart Contract
 *   Deployed on the Polygon Layer-2 Ethereum network
 *   It was created for The Flower Girls NFT project by Ryan Meyers (@sreyeMnayR)
 *   Web: https://flowergirlsnft.com  Twitter: @FlowerGirlsNFT
 *   
 */
...
// Flower Girl Specials (FlowerGirlsSpecials.sol)

pragma solidity ^0.8.2;


contract FlowerGirlsSpecials is ERC1155, ERC2981, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant ROYALTY_ROLE = keccak256("ROYALTY_ROLE");

    constructor() ERC1155("https://moshpit.mypinata.cloud/ipfs/QmUnLQUxKJKwFFbTbNQJN3kqLckQbwprNpTgS1vQJqyp3d/{id}.json") {
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, 0x3D2198fC3907e9D095c2D973D7EC3f42B7C62Dfc);
        _grantRole(URI_SETTER_ROLE, 0x3D2198fC3907e9D095c2D973D7EC3f42B7C62Dfc);
        _grantRole(PAUSER_ROLE, 0x3D2198fC3907e9D095c2D973D7EC3f42B7C62Dfc);
        _grantRole(MINTER_ROLE, 0x3D2198fC3907e9D095c2D973D7EC3f42B7C62Dfc);
        _grantRole(ROYALTY_ROLE, 0x3D2198fC3907e9D095c2D973D7EC3f42B7C62Dfc);

        _grantRole(DEFAULT_ADMIN_ROLE, 0x58136e0909b71981F1a37F1f87859c562ed3657a);
        _grantRole(URI_SETTER_ROLE, 0x58136e0909b71981F1a37F1f87859c562ed3657a);
        ...
        _grantRole(ROYALTY_ROLE, 0x58136e0909b71981F1a37F1f87859c562ed3657a);

        _setDefaultRoyalty(0x58136e0909b71981F1a37F1f87859c562ed3657a, 1000);
    }
