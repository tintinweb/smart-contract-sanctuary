...
contract Milk is BEP20 {
    ...
    constructor() BEP20('MILK', 'MILK', 18) public {
    }
    ...
    external
    {
        ...
        require(signatory != address(0), "MilkToken::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MilkToken::delegateBySig: invalid nonce");
        require(now <= expiry, "MilkToken::delegateBySig: signature expired");
    ...
    returns (uint256)
    {
        require(blockNumber < block.number, "MilkToken::getPriorVotes: not yet determined");
    ...
    internal
    {
        uint32 blockNumber = safe32(block.number, "MilkToken::_writeCheckpoint: block number exceeds 32 bits");
