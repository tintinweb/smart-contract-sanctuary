...
contract GameContract is Ownable, ReentrancyGuard {
    ...
    // Fee address.
    address public feeaddr = 0x000000000000000000000000000000000000dEaD;
    ...
    function game(uint256 _inputAmt) public {
        ...
        uint256 playAmount = _inputAmt.sub(burnAmount);
        ...
        IERC20(payToken).safeTransferFrom(address(msg.sender), feeaddr, burnAmount);
