...
contract StrategyGravity_GFI_USDC is GravityLPStrategy {

    address gfi_usdc_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0xddEFF79d2355999d5807C143b0987Cdb6fd31edD);
        address gfi_usdc_lp = address(0x96d6F7afFF161E7152Bec4272B51Cc007E4417AE);
