...
contract PrivateInvestorSpyrit {
    
 IERC20 token;
 bool public open = true;
 address payable private _wallet = payable(0x38A261accc409c541Eca7991ef03f464Df328A55); //Replace your wallet address here
 
 address private admin;
 
 mapping(address => uint256) public balance;
 uint256 public constant mincap = 1 * 200 * 100000; // 1 Matic Min contribution
 uint256 public constant maxcap = 10000000 * 200 * 100000; // 10,000,000 Matic max contribution
 uint256 private constant hardcap = 10000000 * 10**18;
