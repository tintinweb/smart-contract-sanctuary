...
contract OneSplit is Initializable, IOneSplit, OneSplitRoot, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function _swapOnDfynInternal(
        ...
        if (destToken.isETH()) {
            ...
            _ethHandler.withdraw(address(wmatic), wmatic.balanceOf(address(this)));
        }
    }
    ...
    function __swapOnPancakeSwapInternal(
        ...
        if (destToken.isETH()) {
            ...
            _ethHandler.withdraw(address(wbnb), wbnb.balanceOf(address(this)));
        }
    }
    ...
    function _swapOnUniswapV2Internal(
        ...
        if (destToken.isETH()) {
            ...
            _ethHandler.withdraw(address(weth), weth.balanceOf(address(this)));
        }
    }
