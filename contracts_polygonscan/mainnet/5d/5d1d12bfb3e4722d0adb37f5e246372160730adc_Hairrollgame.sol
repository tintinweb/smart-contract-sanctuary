...
// File: contracts/Hairrollgame.sol
...
*/
contract Hairrollgame is VRFConsumerBase, Ownable, ReentrancyGuard {
    ...
    uint public minBetAmount = .001 ether;
    ...
    address constant HAIR_TOKEN = 0xC68e83a305b0FaD69E264A1769a0A070F190D2d6;
    ...
    function updateRollMaticRatio() internal {
        ...
        if (block.timestamp - rollMaticBlockTimestampLast >= 1800) {
            ...
            uint newRollMaticRatio = IERC20(HAIR_TOKEN).balanceOf(rollMaticLP) * SAFETY_FACTOR / IERC20(MATIC_TOKEN).balanceOf(rollMaticLP);
    ...
    // In case you find yourself in a situation like this, just contact Hairrollgame support.
