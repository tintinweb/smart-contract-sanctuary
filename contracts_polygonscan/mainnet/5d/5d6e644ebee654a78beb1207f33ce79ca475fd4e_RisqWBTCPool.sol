...
contract RisqWBTCOptions is Ownable, IRisqOptions {
    ...
    address[] public maticToWbtcSwapPath;
    IERC20 public wbtc;
    ...
    constructor(
        ...
        maticToWbtcSwapPath = new address[](2);
        maticToWbtcSwapPath[0] = quickswapRouter.WETH();
        maticToWbtcSwapPath[1] = address(wbtc);
        ...
        returns (uint256 optionID)
    {
        ...
        uint amountIn = swapToWBTC(totalMATIC, total);
        ...
        )
    {
        ...
        totalMATIC = quickswapRouter.getAmountsIn(total, maticToWbtcSwapPath)[0];
    }
    ...
    /**
     * @notice Swap MATIC to WBTC via quickswapswap router
