...
contract Controllers {
    ...
    /**
     * @dev Sets contract indestructable, this can not be undone.
     */
    function setIndestructable() external onlyOwner {
        destructable = false;
    }

    /**
     * @dev Destruct, only if destructable is true.
     */
    function destruct() external onlyOwner {
        require(destructable, "no can do!");
 ...
 */
contract TestVestingCentral is Controllers {
