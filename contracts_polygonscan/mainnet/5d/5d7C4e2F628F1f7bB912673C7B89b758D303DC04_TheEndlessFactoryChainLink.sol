...
contract TheEndlessFactoryChainLink is VRFConsumerBase, Ownable, ERC721URIStorage {
    ...
    //     uint256 linkAmount = IERC20(LinkToken).balanceOf(address(this));
    //     IERC20(LinkToken).transfer(msg.sender, linkAmount);
    // }
