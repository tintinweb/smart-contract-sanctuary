...
contract MochiMol is ReentrancyGuard {
    ...
    ***************/
    ...
    IBentoBoxMinimal constant bento = IBentoBoxMinimal(0x0319000133d3AdA02600f0875d2cf03D442C3367); // BentoBox vault for guild treasury - this needs to be updated! 
    ISuChefSummoner constant suChefSummoner = ISuChefSummoner(0x42743564f7366bbb6b7054d40c5852b9c471FDf4); // SuChef deployer - this needs to be updated! 
    address constant wETH = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; // wrapped ether for a given chain - this needs to be updated! 
