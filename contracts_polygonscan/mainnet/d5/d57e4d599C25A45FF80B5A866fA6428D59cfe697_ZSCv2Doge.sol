...
contract ZSCv2Doge {
   ...
   // ZSC zsc;
    ...
    ZmaticVerifierFee zmaticVerifierFee;
    ...
    constructor(address _zmatic, address _zmaticfee, address _burn) { // visibiility won't be needed in 7.0
        ...
        zmaticVerifierFee = ZmaticVerifierFee(_zmaticfee);
    ...
    function fund(Utils.G1Point memory y, uint256 bTransfer) public {
       ...
       function ftransfer(Utils.G1Point[] memory C, Utils.G1Point memory D, Utils.G1Point[] memory y, Utils.G1Point memory u, bytes memory proof, Utils.G1Point memory beneficiary) public {
        ...
        require(zmaticVerifierFee.verifyTransfer(CLn, CRn, C, D, y, lastGlobalUpdate, u, proof), "Transfer proof verification failed!");
...
contract ZmaticVerifierFee {
    ...
    uint256 public constant fee = 1; // set this to be the "transaction fee". can be any integer under MAX.
