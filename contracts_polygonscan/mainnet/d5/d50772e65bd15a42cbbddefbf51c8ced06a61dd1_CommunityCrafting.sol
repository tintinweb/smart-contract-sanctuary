...
contract CommunityCrafting {
    ...
    function payOut(uint sff, address owner) public payable {
        ...
        // WETH
        path[1] = 0x944Ca1F2ea178159cD1FC4aEDDbDa7ea6bac3F30;

        uint[] memory values = uniswapV2Router.getAmountsIn(
            sff, 
            path
        );
        ...
        ERC20(0x944Ca1F2ea178159cD1FC4aEDDbDa7ea6bac3F30).transferFrom(msg.sender, address(this), values[1]);
        // Approve the router just in case
        ERC20(0x944Ca1F2ea178159cD1FC4aEDDbDa7ea6bac3F30).approve(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff, values[1]);

        (uint amountToken, uint amountETH, uint liquidity) = uniswapV2Router.addLiquidityETH{ value: values[0] }(
            0x944Ca1F2ea178159cD1FC4aEDDbDa7ea6bac3F30,
