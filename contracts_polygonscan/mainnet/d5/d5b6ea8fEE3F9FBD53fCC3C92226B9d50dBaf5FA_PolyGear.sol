...
contract PolyGear is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family:Verdana ; font-size: 15px; }</style><rect width="100%" height="100%" fill="#2E00FD" /><text x="10" y="20" class="base">';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "PolyGear #', toString(tokenId), '", "description": "PolyGear is randomized cypherpunk trappings generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use PolyGear in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("PolyGear", "PolyGear") Ownable() {}
}
