...
// File: contracts/PizzaFinanceToken.sol
...
contract PizzaFinanceToken is BEP20('Pizza Finance', 'Pizza') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTPizza::transfer: Burn value invalid");
