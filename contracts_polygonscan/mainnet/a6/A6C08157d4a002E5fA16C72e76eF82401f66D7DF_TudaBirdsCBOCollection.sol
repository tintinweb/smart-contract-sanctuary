 ...
 */
contract TudaBirdsCBOCollection is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("tudaBirds CBO NFT", "TDBCBO") {
        maxNftSupply = 1000;
        mintPrice = (1 ether);
        mintPrice = mintPrice.div(2);
        maxToMint = 30;
        saleIsActive = false;

        wallet = 0x2e298683fa7d821186739b6E735751f53f9d38F4;
    }
     ...
     * Mint by owner
     */
    function reserveNFT(address _to, uint256 _numberOfTokens) external onlyOwner {
    ...
    */
    function mintNFT(uint256 numberOfTokens) external payable {
        ...
        require(totalSupply().add(numberOfTokens) <= maxNftSupply, "Purchase would exceed max supply");
        require(mintPrice.mul(numberOfTokens) <= msg.value, "Ether value is insufficient");
    ...
    */
    function updateSaleState() external onlyOwner {
