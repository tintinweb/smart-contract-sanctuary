...
// PolyEagleToken with Governance.
contract PolyEagleToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        pantherPerBlock = _eaglePerBlock;
    ...
    function updateEmissionRate(uint256 _eaglePerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _eaglePerBlock);
        pantherPerBlock = _eaglePerBlock;
    }
