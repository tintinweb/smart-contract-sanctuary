...
contract TestBank is OwnableUpgradeSafe, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    address public shield = address(0xAB72EE159Ff70b64beEcBbB0FbBE58b372391C54); // SHIELDv2
    ...
    //   > Dev/Mkt:     160,000,000 (16%)
    //   > Treasury:       100,000,000 (10%)
    //   > Insurance Fund:       50,000,000  (5%)
