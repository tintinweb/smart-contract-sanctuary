...
//-----------------------------------------------------------------------------
contract BabyDoge is BEP20("BabyDoge", "BabyDoge", 10000000000000000000000) {
...
contract MasterChef is Ownable, NonReentrant {
  ...
  constructor(BabyDoge _flower, address _feeAddress, uint256 _startBlock) public {
    flower = _flower;
