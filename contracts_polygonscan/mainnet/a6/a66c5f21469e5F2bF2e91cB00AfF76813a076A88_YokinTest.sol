...
contract ERC20 is Context, IERC20, Ownable {
    ...
    IBonus public BonusContract = IBonus(bonusAddr); 
    IInterest public InterestContract = IInterest(interestAddr);
    /**
    ...
    */
    ...
    function updateInterestAddress(address _interestAddr) public onlyOwner {
        interestAddr = _interestAddr;
    }

    function updateBonusAddress(address _bonusAddr) public onlyOwner {
...
// YokinToken
contract YokinTest is ERC20('YokinTest_v10', 'YK_v10', 8), MinterRole {
