...
The NFT's in this specific contract might be used to reward NFT Sprites owners in future.
  ...
  SupportsInterface
{
  ...
  string internal nftName = "NFTSprites.com";
  string internal nftSymbol = "A NFT Sprites";
  ...
  function _mint(address _to, uint256 _tokenId) external {
    require(msg.sender == 0xaADd4adFAf324300bBAfF7fcCC51E96BBfcCa620);
    _addNFToken(_to, _tokenId);
    emit Transfer(address(0), _to, _tokenId);
  }
  
  function _massMint(address[] calldata _addresses, uint256[] calldata _tokenIds) external {
    require(msg.sender == 0xaADd4adFAf324300bBAfF7fcCC51E96BBfcCa620);
    require(_addresses.length == _tokenIds.length);
    for (uint i = 0; i < _addresses.length; i += 1) {
      _addNFToken(_addresses[i], _tokenIds[i]);
