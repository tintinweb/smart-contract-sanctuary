    ...
    NativeMetaTransaction
{
    ...
    function deployFarm(
        ...
        uint _startTime;
        uint _endTime;
        (_stakingToken,_rewardTokens,_rewardAmount,_startTime,_endTime)=dataDecoder(data);
        ...
        deployedFarmDetails memory details= deployedFarmDetails(strategyClone,_stakingToken,_startTime,_endTime,_rewardTokens,_rewardAmount);
    ...
    function dataDecoder(bytes memory data) internal  returns(address,address [] memory ,uint [] memory,uint,uint){
    ...
    return( _stakingToken,_rewardTokens,_rewardAmount,_startTime,_endTime);
    }
