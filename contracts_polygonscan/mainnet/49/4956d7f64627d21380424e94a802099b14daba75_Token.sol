...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "SCCMatic";
    string private _symbol = "SCCMatic";
    ...
    uint256 public _maxTxAmount = 1 * 10**11 *  10**18;  //100 * 10**8 * 10**18; 
    uint256 public _maxTxAmount2 = 1 * 10**3 *  10**18;  //100 * 10**8 * 10**18;     
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**11 *  10**18; //10 * 10**8 * 10**18;
    uint256 public _onedaySeconds = 24 * 3600;
    uint256 public _maxSwapAmount = 2 * 10**11 *  10**18; //250 * 10**8 * 10**6;
    uint256 public LUCKY_THREDHOLD = 1 * 10**11 *  10**18;//10**16;
    uint256 public _TransferTimeLimit = 3;
