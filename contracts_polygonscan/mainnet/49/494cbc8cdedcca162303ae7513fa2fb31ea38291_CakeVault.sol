...
interface IMasterChef {
    ...
    function pendingRadioshack(uint256 _pid, address _user) external view returns (uint256);
...
contract CakeVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingRadioshack(0, address(this));
