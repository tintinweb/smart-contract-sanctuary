...
contract GiftCardNFT is ERC721URIStorage,Ownable {
    ...
    constructor() ERC721("GiftCart NFT", "GiftCart NFT") {}

    function mint(address[] memory recipients) public onlyOwner {
        require(_tokenIds.current() < totalSupply, "ERC721: edition max supply is 2000");
    ...
    function _baseURI() internal pure override(ERC721) returns (string memory) {
        return "https://coinhublab.github.io/GiftCard/";
    }
}
