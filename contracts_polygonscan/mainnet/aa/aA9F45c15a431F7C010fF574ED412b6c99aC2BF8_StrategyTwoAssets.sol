...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant token2 = 0xA1c57f48F0Deb89f569dFbE6E2B7f46D33606fD4;

    address public multiHarvest = 0x0000000000000000000000000000000000000000;

    // Other constants
    uint16 public constant underlyingPoolId = 34;
        ...
        )
    {
        ...
        matic_token1_path = new address[](2);
        matic_token1_path[0] = matic;
        matic_token1_path[1] = token1;

        matic_token2_path = new address[](3);
        matic_token2_path[0] = matic;
        matic_token2_path[1] = token1;
        matic_token2_path[2] = token2;
    }
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public mana_WETH_LP = 0xc48AE82ca34C63887b975F20ABA91a38f2a900B8;
