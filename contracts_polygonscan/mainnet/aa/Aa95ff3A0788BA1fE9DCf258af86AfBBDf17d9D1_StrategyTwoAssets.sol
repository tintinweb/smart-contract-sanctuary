...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    // Other constants
    uint256 public constant underlyingPoolId = 49;
    ...
    uint256 public wmaticCutoffBps = 10**17;
        ...
        )
    {
        ...
        rewardToFeeTokenPath = new address[](3);
        rewardToFeeTokenPath[0] = wmatic;
        rewardToFeeTokenPath[1] = weth;
        rewardToFeeTokenPath[2] = rewardTokenAddr;

        rewardToFarmTokenPath0 = new address[](5);
        rewardToFarmTokenPath0[0] = rewardTokenAddr;
        rewardToFarmTokenPath0[1] = wmatic;
        rewardToFarmTokenPath0[2] = weth;
        rewardToFarmTokenPath0[3] = usdc;
        rewardToFarmTokenPath0[4] = farmToken0Addr;

        rewardToFarmTokenPath1 = new address[](6);
        rewardToFarmTokenPath1[0] = rewardTokenAddr;
        rewardToFarmTokenPath1[1] = wmatic;
        rewardToFarmTokenPath1[2] = weth;
        rewardToFarmTokenPath1[3] = usdc;
        rewardToFarmTokenPath1[4] = farmToken0Addr;
        rewardToFarmTokenPath1[5] = farmToken1Addr;
    }
    ...
    function harvest() public override nonReentrant {
        ...
        swapAmount = calculateSwapAmount(wmatic, 10000);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public LP_TOKEN = 0x9803c7aE526049210a1725F7487AF26fE2c24614;
