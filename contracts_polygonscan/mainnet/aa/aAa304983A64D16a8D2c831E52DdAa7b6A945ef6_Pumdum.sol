...
contract Pumdum is IBEP20, Ownable
{
    ...
    string private constant _name = ' Pumdum ';
    string private constant _symbol = ' PDM ';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;                // 69 Sextillion
    ...
    address public Auto_Liquiditty_Pool = 0x0000000000000000000000000000000000000000;
    //address public constant TeamWallet=0x000000000000000000000000000000000000dEaD;
    address private constant TeamWallet = 0xbcBd0D33A88c493E95d91c382F1d1394438BD3d7;
    //address private constant PancakeRouter=0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    address private constant PancakeRouter = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    

    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = InitialSupply / 50 ;                                   // = 2 %
    uint256 public  sellLimit = InitialSupply / 100 ;                                     // = 1 %
    uint256 public  buyLimit = InitialSupply / 50 ;                                       // = 2 %
    uint256 public  swapthreshold = sellLimit / 5;                                        // = 1 %
