...
// File: contracts/AmazingNebulas.sol
...
contract AmazingNebulas is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public cost = 130 ether;    // Cost per NFT
    uint256 public maxSupply = 1111;
    uint256 public maxMintAmount = 10;  // Maximum number of tokens can be minted in single transaction
    bool public paused = true;
    bool public isSaleActive = false;
    bool public revealed = false;
    bool public allowOnlyWhitelisted = true;
    address[] public whitelistedAddresses;

    constructor(
        string memory _initBaseURI,
        string memory _initNotRevealedUri
    ) ERC721("AmazingNebulas", "NEB") {
        setBaseURI(_initBaseURI);
        setNotRevealedURI(_initNotRevealedUri);

        // Initialise max cap for sale stages
        maxCapByStage[uint(SaleStage.sale1)] = 480;
        maxCapByStage[uint(SaleStage.sale2)] = 550;
    }
