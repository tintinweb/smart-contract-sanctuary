...
contract AaveStrategy01 is Funding {
    ...
    function aave_stat_global() public view returns (
        ...
        /*
             reserve_availableLiquidity = availableLiquidity;
             reserve_totalStableDebt = totalStableDebt;
             reserve_totalVariableDebt = totalVariableDebt;
             reserve_liquidityRate = liquidityRate;
             reserve_variableBorrowRate = variableBorrowRate;
             reserve_stableBorrowRate = stableBorrowRate;
             reserve_averageStableBorrowRate = averageStableBorrowRate;
             reserve_liquidityIndex = liquidityIndex;
             reserve_variableBorrowIndex = variableBorrowIndex;
             reserve_lastUpdateTimestamp = lastUpdateTimestamp;
             */
             /*
             reserve_availableLiquidity = 0;
             reserve_totalStableDebt = 0;
             reserve_totalVariableDebt = 0;
             reserve_liquidityRate = 0;
             reserve_variableBorrowRate = 0;
             reserve_stableBorrowRate = 0;
             reserve_averageStableBorrowRate = 0;
             reserve_liquidityIndex = 0;
             reserve_variableBorrowIndex = 0;
             reserve_lastUpdateTimestamp = 0;
             */
