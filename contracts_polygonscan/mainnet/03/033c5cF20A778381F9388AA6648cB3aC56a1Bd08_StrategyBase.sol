...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 5;
        ...
        )
    {
        ...
        pbrew_token2_path = new address[](3);
        pbrew_token2_path[0] = pbrew;
        pbrew_token2_path[1] = token1;
        pbrew_token2_path[2] = token2;
    }
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public USDC_Dai_LP = 0x815c2D1894Daf25935fa909bE35Ee1Fed67b2B97;
