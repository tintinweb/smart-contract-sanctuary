...
contract GoldenEggGiveaway is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint() public payable {
    ...
    if(supply > 0) {
        ...
        giftValue = supply + 1 == maxSupply ? address(this).balance * 80 / 100 : msg.value * 1 / 100;
    }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool d, ) = payable(0xf2e3F85F93dEacBD85403Da8622e5f7f05316ebE).call{value: address(this).balance * 20 / 100}("");
    require(d);
