...
contract Moon is Context, Ownable, ERC20 {
    ...
    uint256 public MoonPerTokenId = 10000 * (10**decimals());
    ...
    */
    ...
    constructor() Ownable() ERC20("Moon", "MOON") {
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, MoonPerTokenId);
    }
    ...
    function daoSetMoonPerTokenId(uint256 moonDisplayValue)
        public
        onlyOwner
    {
        MoonPerTokenId = moonDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndMoonPerTokenID(
        uint256 season_,
        uint256 moonDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetMoonPerTokenId(moonDisplayValue);
    }
}