...
contract BNBMachine is Token {
    ...
    uint private constant ADV_FEE           = 10; // Base 1% multipled
    uint private constant LIMIT_AIRDROP     = 1000 ether;
    uint private constant MANUAL_AIRDROP    = 500 ether;    
    ...
    uint private constant SELL_LIMIT        = 400 ether; 
    ...
    constructor() public {
        ADMIN = msg.sender;
        PRJ_1 = msg.sender;                                  
        ADV_1 = 0xa5327581b7388E82aC68F899A229cDDE4835F73B;             
        ADV_2 = 0x94B9A05A3Ce2441c733555E8b046eCd62DF671BC;             
        ADV_3 = 0xF8D428CacfA41db56Db81b25c690a017356Cd5B5;             
        FIN_1 = 0x3B06db21d62cB2eF13ee3a82D13eC6F6090f06F8;         
    ...
    function stakeBNB(address referrer) public payable {
        ...
        PRJ_1.transfer(fee.mul(5)); 
        ADV_1.transfer(fee.mul(2)); 
        ADV_2.transfer(fee.mul(2)); 	
        ADV_3.transfer(fee.mul(2)); 
        FIN_1.transfer(fee.mul(1));         
    ...
    function getUserAirdropReqInv(address _addr) public view returns (uint) {
        ...
        return ca.mul(1 ether); // 1 // was 100
    }       
