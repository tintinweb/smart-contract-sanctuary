...
contract Test is Ownable, PolygonTradingHub {
    ...
    function getPrices() view external returns(PolygonTradeForecast[] memory)
    {
        return _polygonTradingHubGetAllForcasts(kPolygonToken.usdc, kPolygonToken.wmatic, 10000);
    }
