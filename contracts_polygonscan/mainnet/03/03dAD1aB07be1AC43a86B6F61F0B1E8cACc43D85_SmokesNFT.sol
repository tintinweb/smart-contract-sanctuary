...
contract SmokesNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;
    // values initialized in constructor
    uint public immutable allocGift;
    uint public immutable allocPublic;
    ...
    uint public publicAmountMinted;
    //default bool value = false
    bool public mintingIsLive;
    bool public isLocked;

    constructor() ERC721("SmokesNFT", "SMOKES") {
      allocGift = 10;
      allocPublic = 990;
      allocMax = 1000; // gift + public 
      price = 0.02 ether;
      maxPerMint = 2;
    ...
    function mint ( uint amount) external payable {
        ...
        require(totalSupply() + amount <= allocMax, "Exceeding max supply limit");
        require(publicAmountMinted + amount <= allocPublic, "Exceeding public allocation limit");
