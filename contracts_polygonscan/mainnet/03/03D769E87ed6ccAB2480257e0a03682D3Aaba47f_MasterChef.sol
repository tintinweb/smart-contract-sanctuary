...
// PolarBearToken with Governance.
contract PolarBearToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    constructor(
        PolarBearToken _pbt,
        uint256 _startBlock,
        uint256 _pbtPerBlock
    ) public {
        panther = _pbt;
        startBlock = _startBlock;
        pantherPerBlock = _pbtPerBlock;
    ...
    function updateEmissionRate(uint256 _pbtPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _pbtPerBlock);
        pantherPerBlock = _pbtPerBlock;
    }
