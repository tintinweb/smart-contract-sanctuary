...
VRFConsumerBase //#VBVB extend from VRFConsumer
{
    ...
    uint constant public EV_CLAIM_BONUS=1; 
    ...
    */
    ...
    function claim(uint256[] calldata epochs) external nonReentrant notContract {
        ...
        for (uint256 i = 0; i < epochs.length; i++) {
            ...
            // Round invalid, refund bet amount
                ...
                // console.log("CONTRACT - TOSS addedReward:    %i",(addedReward));
                // console.log("CONTRACT - TOSS treasuryAmount: %i",(_treasuryAmount));
                // console.log("CONTRACT - TOSS amount     :    %i",(ledger[epochs[i]][msg.sender].amount));
                // console.log("CONTRACT - TOSS fee           : %i",(treasuryFee));
    ...
    function claimBonusRewards(uint256[] calldata epochs) external nonReentrant notContract {
        ...
        for (uint256 i = 0; i < epochs.length; i++) {
            ...
            if (rounds[epochs[i]].oracleCalled) {
                ...
                // console.log((bonusClaimable(epochs[i], msg.sender)));
    ...
    function bonusClaimable(uint256 epoch, address user) public view returns (bool) {
        ...
        return
            ...
            // &&
            // ((round.tossResult == 0 && betInfo.position == Position.Heads && (round.tailsAmount != 0)) ||
            //  (round.tossResult == 1 && betInfo.position == Position.Tails &&  (round.headsAmount != 0))
            // );
            // User stories stated it can be paid when Win and when Lose.
    }
