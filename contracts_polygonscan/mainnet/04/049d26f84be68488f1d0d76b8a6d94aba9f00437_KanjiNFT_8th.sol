...
contract KanjiNFT_8th is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
  ...
  string[] public cha = ["\u4f11","\u9084","\u8fd4","\u9006","\u8912","\u97fb","\u7a32","\u7c73","\u9905","\u4e57","\u53f3","\u74b0","\u9cf4","\u8f2a","\u719f","\u6607","\u9a30","\u5ddd","\u8def","\u8f5f","\u596a","\u5ca9","\u5dfb","\u6839","\u7db1","\u7e04","\u8150","\u8352","\u96d1","\u64e6","\u7d71","\u8d70","\u60b2","\u685c","\u553e","\u5869","\u4f8d","\u7802","\u6551","\u8a00","\u75d5","\u6016","\u6563","\u6d77","\u63a2","\u65ec","\u5ea7","\u5e2d","\u79d2","\u79d8",
"\u7a2e","\u9078","\u5df1","\u58f2","\u9001","\u6587","\u4e03","\u7e2b","\u6027","\u5f71","\u9707","\u6065","\u578b","\u92ed","\u524a","\u7f8a","\u6bbb","\u8c9d","\u76fe","\u8f1d","\u8239","\u9774","\u6483","\u5c04","\u5e97","\u5cb8","\u77ed","\u80a9","\u53eb","\u7e2e","\u938c","\u9ed9","\u7d79","\u9280","\u4f3c","\u7f6a","\u8aa0","\u516d","\u9ab8","\u808c","\u7a7a","\u659c","\u5bdd","\u7761","\u7720","\u6ed1","\u50be","\u9045","\u5c0f","\u55c5"];
  string[] public meanx = ["rest","return","return","reverse","reward","rhyme","rice","rice","rice cake","ride","right","ring","ring","ring","ripen","rise","rising","river","road","roar","rob","rock","roll","root","rope","rope","rot","rough","rough","rub","rule","run","sadness","sakura","saliva","salt","samurai","sand","save","say","scar","scary","scatter","sea","search","season","seat","seat","second","secret",
"seed","selection","self","sell","send","sentence","seven","sew","sex","shadow","shake","shame","shape","sharp","shaving","sheep","shell","shellfish","shield","shine","ship","shoes","shoot","shooting","shop","shore","short","shoulder","shout","shrink","sickle","silence","silk","silver","similar","sin","sincerity","six","skeleton","skin","sky","slant","sleep","sleep","sleep","slip","slope","slow","small","smell"];
  ...
  string private rl1='{"name": "KanjiNFT_8th #';
  string private rl3='"}';
...
//}
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    Kanji memory kanji = randomOne(tokenId);
    string memory id=(tokenId+700).toString();
...
//gasless
  ...
  constructor() ERC721("KanjiNFT_8th", "KNJ8") Ownable() {}
}