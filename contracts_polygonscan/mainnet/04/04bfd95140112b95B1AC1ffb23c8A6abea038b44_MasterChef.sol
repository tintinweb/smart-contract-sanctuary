...
contract ApolloToken is ERC20("Apollo", "Apollo"), Ownable {
    ...
    uint256 public minAmountToLiquify = 10000;
    ...
    function swapTokensForUSDC(uint256 tokenAmount) private {
        ...
        // make the swap
        apolloSwapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0,
            path,
            address(bank),
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function isNftHolder(address _address) public view returns (bool) {
        return nft.balanceOf(_address) > 0;
    }
