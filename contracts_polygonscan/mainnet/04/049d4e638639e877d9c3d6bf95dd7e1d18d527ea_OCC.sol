...
contract OCC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x281324127deEe31a28cfDDb4668AFDc9CE995A1D); // Marketing Address
    ...
    uint256 private _tTotal = 175204546 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "One Cloud";
