...
contract sGuru is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Guru", "sGURU", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGURU supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sGURU
