...
import "../GravityStakingStrategy.sol";

contract StrategyGravity_GFI is GravityStakingStrategy {
    ...
    function initializeStrategy(
        ...
        address farmContract = address(0x8105662cf0F7c1A9d4066E7F2C81049049bC184d);
...
/// @title Gravity Staking Strategy
/// @author Chainvisions
/// @notice Strategy for Gravity GFI SAS.

contract GravityStakingStrategy is BaseUpgradeableStrategy {
    ...
    */
    function doHardWork() external onlyNotPausedInvesting restricted {
        ...
        _liquidateReward((balanceAfter - balanceBefore));
    ...
    */
    function _liquidateReward(uint256 _rewardAmount) internal {
        if(!sell() || _rewardAmount < sellFloor()) {
            emit ProfitsNotCollected(sell(), _rewardAmount < sellFloor());
            return;
        }
        notifyProfitInRewardToken(_rewardAmount);
    }
