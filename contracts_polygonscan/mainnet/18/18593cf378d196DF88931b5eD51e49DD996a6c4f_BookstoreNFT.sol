...
// File: contracts/BookstoreNFT.sol
...
Ownable
{
  ...
  uint256 public PRICE = 16000000000000000000;

  uint256 public constant OWNER_MINT_LIMIT = 600;
  ...
  function mint(uint256[] calldata ids) public payable nonReentrant {
    ...
    require((totalSupply() + count) < MAX_SUPPLY, "Exceeds max actual supply");
    ...
    if (msg.sender != owner()) {
      ...
      // Check if the sender value is enough
