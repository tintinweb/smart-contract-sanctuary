...
// File contracts/missions/MissionMasterChefSingle.sol



pragma solidity 0.6.12;
contract MissionMasterChefSingle is BaseMissionLPSingle {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        token0Address = _wantAddress;
        token1Address = _wantAddress;
