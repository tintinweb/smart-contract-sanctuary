...
contract NUGGETS_404 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public finalgiftpercentage = 10;
  ...
  function mint() public payable {
    ...
    if(supply > 0){
        ...
        giftValue = supply + 1 ==maxSupply ? address(this).balance * finalgiftpercentage / 100 : msg.value * giftpercentage / 100;
    }
  ...
  function setFinalGiftPercentage(uint256 _newfinalPercentage) public onlyOwner() {
     finalgiftpercentage = _newfinalPercentage;
  }
