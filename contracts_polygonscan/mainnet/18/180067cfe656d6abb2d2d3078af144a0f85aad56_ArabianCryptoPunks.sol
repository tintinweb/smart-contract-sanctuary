...
// Contract: ArabianCryptoPunks
// TokenID: ArabianCryptoPunks
// Token Symbol: ACB
// ---- CONTRACT BEGINS HERE ----

pragma solidity ^0.8.0;

contract ArabianCryptoPunks is ERC721Enumerable, Ownable {
  using Strings for uint256;
    ...
    returns (string memory)
  {
    require(
      _exists(tokenId),
      "ERC721Metadata: URI query for nonexistent ACP"
    );
