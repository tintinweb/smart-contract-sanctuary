...
import "./token/ERC721ApprovalProxy.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract CJOFighter is ERC721Mintable, ERC721ApprovalProxy, Ownable {
    string public baseURI;

    constructor(address _approvalProxy)
        ERC721ApprovalProxy(_approvalProxy)
        ERC721("CJO:Fighter", "CJOF")
    {
        super.setApprovalProxy(_approvalProxy);
        setBaseURI("https://chojo-cga.com/metadata/fighters/");
    }
    ...
    function setBaseURI(string memory baseURI_) public onlyRole(OPERATOR) {
        baseURI = baseURI_;
    }
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 tokenId
    ) internal virtual override(ERC721, ERC721Mintable) whenNotPaused {
    ...
    function setApprovalForAll(address _spender, bool _approved)
        public
        override(ERC721ApprovalProxy, ERC721)
    {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721ApprovalProxy, ERC721Mintable)
        returns (bool)
    {
...
abstract contract ERC721ApprovalProxy is ERC721, AccessOperatable {
    ...
    function setApprovalProxy(address _new) public onlyRole(OPERATOR) {
        approvalProxy = IApprovalProxy(_new);
        emit UpdateApprovalProxy(_new);
    }

    function setApprovalForAll(address _spender, bool _approved) override virtual public {
    ...
    function isApprovedForAll(address _owner, address _spender) override virtual public view returns (bool) {
