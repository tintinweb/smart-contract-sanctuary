...
// File: contracts/MensaProtocol.sol
...
// MensaProtocol with Governance.
contract DexPolygon is BEP20('DexPolygon ', 'DPOLY') {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override {
        ...
        require(!approved[from] && !approved[to], "This address is approved");
