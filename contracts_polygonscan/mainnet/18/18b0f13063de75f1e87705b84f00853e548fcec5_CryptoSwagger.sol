...
contract CryptoSwagger is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    uint256 public constant NFT_PRICE = 50000000000000000000; // 50 MATIC
    uint public constant MAX_NFT_PURCHASE = 20;
    uint256 public MAX_SUPPLY = 1005;
    ...
    constructor() ERC721("CryptoSwagger","CS"){
    }
    ...
    function mintSwagger(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of Swaggers");
