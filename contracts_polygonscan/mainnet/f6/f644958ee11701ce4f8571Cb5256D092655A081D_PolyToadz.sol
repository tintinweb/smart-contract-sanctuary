...
/**
 * @title CrypToadz by GREMPLIN x Polygon contract
...
MMMMMMMMMMMMMMMMMMMMMMMMMMX;  ,::::::::::::n0lan:::::::::::::kWMMMMMMO. ;XMMMMMMMMMMMMMMMMMMMMMMMMMM
...
MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
*/
contract PolyToadz is ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint256 public constant toadPrice = 0.69 ether; //69.69 MATIC

    uint public constant maxToadPurchase = 20;
    ...
    string public baseURI = "ipfs://QmWEFSMku6yGLQ9TQr66HjSd9kay8ZDYKbBEfjNi4pLtrr/";
    
    uint internal nonce = 0;
    uint[maxSupply] private indices;

    constructor() ERC721("CrypToadz by GREMPLIN x Polygon", "TOADZPOLY") {
    ...
    function mint(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Toadz");
        require(numberOfTokens <= maxToadPurchase, "Can only mint 20 tokens at a time");
    ...
    function getRandomId() internal returns(uint256){
        ...
        uint256 index = uint256(keccak256(abi.encodePacked(nonce, "ourSaltAndPepper", blockhash(block.number), msg.sender, block.difficulty, block.timestamp, gasleft()))) % totalSize;
