...
contract LiquidityPreSaleSPYRIT {
 ...
 uint256 public constant mincap = 1 * 200 * 100000; // 1 Matic Min contribution
 uint256 public constant maxcap = 10000 * 200 * 100000; // 10000 Matic max contribution
