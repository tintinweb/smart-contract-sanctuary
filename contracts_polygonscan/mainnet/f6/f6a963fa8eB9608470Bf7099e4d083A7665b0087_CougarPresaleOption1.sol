...
contract CougarPresaleOption1 is ReentrancyGuard {
    ...
    // Price of presale COUGAR: 0.07 USDC
    uint256 private constant USDCPerCGS = 7;

    // Time per percent
    uint256 private constant timePerPercent = 3600*3;

    // Max Buy Per User
    uint256 public maxBuyPerUser = 29000*(1e6); // decimal 6
