...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    {
        ball_eth_path = new address[](3);
        ball_eth_path[0] = ball;
        ball_eth_path[1] = matic;
        ball_eth_path[2] = eth;
    }
    ...
    function harvest() public override {
        ...
        if (_ballBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(ball_eth_path, _ballBalance);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public Eth_LP = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619;
