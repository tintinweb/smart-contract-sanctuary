...
contract MATICBridge is Ownable{
   ...
   event BridgedMatictoBSC ( uint256 _request, address indexed _user, uint256 _amount, uint256 _blocknumber );
    ...
    constructor () {
       ...
       MMACADDRESS = 0x4c75C91A37C115D2e4A727fe88Cd8f544cC4D2bc;
    ...
    function BridgeMMAC ( uint256 _mmac ) public  payable  {
       ...
       emit BridgedMatictoBSC ( PolytoBSCBridgeRequestCount, msg.sender, _mmac, block.number );
    ...
    function transferBridgedMMAC ( uint256 bridgeRequest, address _address, uint256 _amount ) public onlyBridge {
        ...
        deposits -= _amount;
        emit BridgedBSCtoMatic ( BSCtoPolyBridgeRequestCount, _address, _amount, block.number );
    }
