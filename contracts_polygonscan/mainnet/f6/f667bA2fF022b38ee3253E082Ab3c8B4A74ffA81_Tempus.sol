...
contract Tempus is ERC20("Tempus", "TMP"), Ownable {
    ...
    uint256 private rateInterest = 15 * (10 ** decimals()) / (100 * 100); // 0.25%
    uint256 private rateBonus = 1000 * (10 ** decimals()) / (100 * 100); // 10%
