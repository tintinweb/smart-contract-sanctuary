...
/// @dev This is a contract used to add ERC2981 support to ERC721
...
//SPDX-License-Identifier: Unfold Innovates
pragma solidity ^0.8.0;
...
contract UNI is ERC721URIStorage, ERC721Enumerable, ERC2981PerTokenRoyalties {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("Meraki", "MERA") {}

    function mintNFT(address payable mintToAddress, string memory newTokenURI)
        public
        returns (uint256)
    {
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        _safeMint(mintToAddress, newItemId);
