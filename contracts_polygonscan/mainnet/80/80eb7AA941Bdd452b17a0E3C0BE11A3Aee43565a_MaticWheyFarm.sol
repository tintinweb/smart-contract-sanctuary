...
import "./MaticWheyToken.sol";

contract MaticWheyFarm is Ownable {
    ...
    constructor(
        ...
        // Deploy WHEY
        whey = new MaticWheyToken(msg.sender);
        // LP Mint
        whey.mint(_devaddr, 5000000 ether);
...
contract MaticWheyToken is ERC20("WheyToken", "WHEY"), Ownable, AccessControl {
	...
	modifier only(bytes32 role) {
        require(hasRole(role, _msgSender()), "WheyToken: INSUFFICIENT_PERMISSIONS");
        _;
    }

	constructor(address _maintainer) public {
		_setupRole(DEFAULT_ADMIN_ROLE, _maintainer);
