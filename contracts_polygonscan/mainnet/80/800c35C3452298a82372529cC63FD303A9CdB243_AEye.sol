...
contract AEye is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("A-Eye", "AEYE") {
        setBaseURI(baseURI);
    ...
    function mintNFTs(uint _count) public {
        ...
        uint tPRICE = PRICE*_count;

        require(balanceWETH() >= tPRICE, "Not enough ether to purchase NFTs.");
    ...
    function withdraw() public payable onlyOwner {
        ...
        require(balance > 0, "No WETH left to withdraw");

        WETHContract.transferFrom(msg.sender,address(this),balance);
