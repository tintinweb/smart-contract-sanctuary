...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    {
        beta_usdc_path = new address[](2);
        beta_usdc_path[0] = beta;
        beta_usdc_path[1] = usdc;
    }
    ...
    function harvest() public override {
        ...
        if (_betaBalance > harvestCutoff){
            if (_betaBalance > 0) {
                _swapUniswapWithPath(beta_usdc_path, _betaBalance.div(2));
            }

            // Add liquidity for BETA/USDC
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public BETA_USDC_LP = 0xa305A860BC0B2255dC10340E98190a6E8992b967;
