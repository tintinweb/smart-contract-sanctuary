...
contract TenguBlessingInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the tengu blessing factory
    address public TENGU_BLESSING_FACTORY;
    ...
    // The block number when TENGU mining ends.
    ...
    constructor() public {
        TENGU_BLESSING_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == TENGU_BLESSING_FACTORY, "Not factory");
