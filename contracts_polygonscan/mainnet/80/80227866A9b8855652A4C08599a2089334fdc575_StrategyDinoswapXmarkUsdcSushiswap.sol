...
// File: Vault\StrategyDinoswapXmarkUsdcSushiswap.sol

// openzeppelin v3.1.0

contract StrategyDinoswapXmarkUsdcSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00f153eff70dc0bf3b085134928daeea248d9b30d0)];
        ...
        token1ToEarnedPath = [address(0x00f153eff70dc0bf3b085134928daeea248d9b30d0), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00f153eff70dc0bf3b085134928daeea248d9b30d0)];
    }
