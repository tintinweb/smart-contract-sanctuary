...
contract POLYBANANA is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    uint256 public constant MAX_NFT = 1200;
    uint256 public constant MAX_BY_MINT = 1200;
	
	uint256 public PRICE = 0 * 10**18;
    address public creatorAddress;
    string public baseTokenURI;
	
    event CreatePunks(uint256 indexed id);
	
    constructor(string memory baseURI, address payable creator) ERC721("Polygon Cute Banana", "POLYCBN") {
        setBaseURI(baseURI);
