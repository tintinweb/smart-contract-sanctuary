...
// File contracts/ChilliSwapToken.sol
...
contract BurnAqr is Ownable {
    ...
    function lockToken(uint256 amount) external {
      IERC20(0xaE204EE82E60829A5850FE291C10bF657AF1CF02).transferFrom(msg.sender,address(this),amount);
