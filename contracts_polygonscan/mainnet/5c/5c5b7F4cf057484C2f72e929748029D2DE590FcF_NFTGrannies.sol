...
contract NFTGrannies is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public basePrice = 5 ether; // = 5 MATIC on Polygon
    ...
    function mint(uint256 _amount) public payable {
        ...
        require(msg.value >= price, "Error: Not enough tokens sent");
    ...
    // Path to API with contract meta
    function contractURI() public pure returns (string memory) {
        return "https://api.nftgrannies.com/contract/meta";
    }
    ...
    function setBaseURI(string memory _newBaseURI) public onlyOwner {
        require(!isMetaDataFrozen, "Error: Meta data can't be changed anymore");
        baseURI = _newBaseURI;
    }
    ...
    // Send 500 MATIC to owner of token with specific id
    function cashOut(uint256 _tokenId) public onlyOwner {
        
        // Check if enough MATIC available
        require(address(this).balance > 500 ether, "Error: Not enough MATIC available");
        ...
        // Send 1 MATIC to token owner
        payable(tokenOwner).transfer(500 ether);
