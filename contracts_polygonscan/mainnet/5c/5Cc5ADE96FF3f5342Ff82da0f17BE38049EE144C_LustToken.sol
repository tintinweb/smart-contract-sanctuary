...
contract LustToken is ERC20('LUST PRESALE', 'LUST'), ReentrancyGuard, Ownable {
    ...
    address constant presaleAddress = 0x6Ce07B7Ee17c3231987a5BF377487FF801608F63;
    ...
    uint256 public constant lustMaximumSupply = 15 * (10 ** 3) * (10 ** 18); //15,000k presale public

    uint256 public lustRemaining = lustMaximumSupply;
    ...
    constructor(uint256 _startBlock, uint256 _endBlock) {
        ...
        endBlock    = _endBlock;
        _mint(address(this), lustMaximumSupply);
    }
