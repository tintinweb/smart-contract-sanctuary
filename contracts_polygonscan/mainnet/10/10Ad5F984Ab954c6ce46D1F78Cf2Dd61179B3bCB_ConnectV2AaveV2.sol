...
abstract contract AaveResolver {
    ...
    function getCollateralBalance(address token) internal view returns (uint bal) {
        AaveDataProviderInterface aaveData = AaveDataProviderInterface(0x057835Ad21a177dbdd3090bB1CAE03EaCF78Fc6d);
    ...
    */
    function deposit(
        ...
        AaveLendingPoolProviderInterface aaveProvider = AaveLendingPoolProviderInterface(0xd05e3E715d945B59290df0ae8eF85c1BdB684744);
