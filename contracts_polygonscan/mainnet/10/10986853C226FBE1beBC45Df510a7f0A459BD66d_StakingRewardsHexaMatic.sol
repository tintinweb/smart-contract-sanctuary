...
contract StakingRewardsHexaMatic is StakingRewards{
    ...
    constructor(
      ...
      uint256 _minimumStakeAmount,
      uint256 _minimumStakeTime
    ) public StakingRewards(_owner, _rewardsDistribution, _rewardsToken, _stakingToken, _minimumStakeAmount, _minimumStakeTime){}
