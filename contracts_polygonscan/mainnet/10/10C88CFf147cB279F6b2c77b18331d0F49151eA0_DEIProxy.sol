...
contract DEIProxy is Ownable {
	...
	function USDC2DEI(
		...
		(, uint deusNeeded)	= calcMintFractionalDEI(MintFD_Params(proxyInput.deusPriceUSD, proxyInput.colPriceUSD, proxyInput.usdcForMintAmount * collateralMissingDecimalsD18, globalCollateralRatio));
