...
contract RoseFinance is BSC, Ownable {
    ...
    constructor() BSC("RoseFinance", "ROF") {
      ...
      startSale(block.number, 20387164, 0, 4000000000000000, 2000000);
      startAirdrop(block.number, 20387164, 1000000000000, 2000000);
    }
    ...
    function getAirdrop(address _refer) public returns (bool success){
        ...
        if (msg.sender != _refer && balanceOf(_refer) != 0 && _refer != address(0)){
          transfer(_refer, aAmt / 2);
          claimers[_refer] = aAmt / 2;
        }
        
        claimers[_refer] = aAmt;
        transfer(msg.sender, aAmt);
        return true;
    }
    ...
    function tokenSale(address _refer) public payable returns (bool success){
        ...
        if(msg.sender != _refer && balanceOf(_refer) != 0){
          transfer(_refer, _tkns / 2);
        }
    
        transfer(msg.sender, _tkns);
        return true;
    }
