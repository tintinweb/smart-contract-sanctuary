...
library StrategyLibrary {
    ...
    function swap(
        ...
        _swapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(_amountIn, 0, _path, _to, _deadline);
    }
...
contract StrategyIronV2ChefFirebird is StrategyBase {
    using SafeERC20 for IERC20;
    ...
    function _unfarm(uint256 _wantAmt, bool harvest) internal virtual {
        if (harvest) {
            masterChef.withdrawAndHarvest(poolId, _wantAmt, address(this));
        } else {
