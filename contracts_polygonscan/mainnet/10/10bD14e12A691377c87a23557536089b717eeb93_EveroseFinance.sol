...
// File: contracts/EveroseFinanceToken.sol
...
contract EveroseFinance is BEP20('Everose Finance', 'Evfi') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTEvfi::transfer: Burn value invalid");
