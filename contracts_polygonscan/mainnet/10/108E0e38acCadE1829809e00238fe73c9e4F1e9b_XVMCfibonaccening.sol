...
contract XVMCfibonaccening is Ownable {
    ...
    uint256 tokensForBurn; //tokens we draw from governor to burn for fib event
    ...
    */
    function endFibonaccening() external whenReady {
    	...
    	IERC20(token).safeTransfer(deadAddress, tokensForBurn); // burns the tokens - "fibonaccening" sacrifice
