...
contract StrategyMaximizer_DAI_WETH is GravityMaximizer {

    address dai_weth_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0x253b345A9fa785C929867E6Db9e4b3C72e1c85c8);
        address dai_weth_lp = address(0x73A7b621090b8d7584cc40D1B1F016fB831949A3);
