...
contract FarmQuickSwap is Ownable, ReentrancyGuard, Pausable { 
    ...
    address public constant landAddress     = 0x4738F5ADFd53566BD538ac3cc45e076C6f122085;   
    address public constant devAddress      = 0xAF0292444bC26a1236aF81b1aE166C1D7D3359C0;   
    address public constant burnAddress     = 0x000000000000000000000000000000000000dEaD;   
    address public constant feeAddress      = 0xAF0292444bC26a1236aF81b1aE166C1D7D3359C0;   
    address public rewardAddress;
    address public constant masterChef      = 0x6e71C79d8C7E60AADF4FBE749DC7B7eFb24813a5;      
    ...
    address[] public earnedToLandPath   = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0x4738F5ADFd53566BD538ac3cc45e076C6f122085];
    address[] public wmaticToQuickPath  = [0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0x831753DD7087CaC61aB5644b308642cc1c33Dc13];
    address[] public landToQuickPath    = [0x4738F5ADFd53566BD538ac3cc45e076C6f122085,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0x831753DD7087CaC61aB5644b308642cc1c33Dc13];
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            uint256 balanceBefore = IERC20(wmaticAddress).balanceOf(address(this));
            ...
            uint256 balanceAfter = IERC20(wmaticAddress).balanceOf(address(this)).sub(balanceBefore);
