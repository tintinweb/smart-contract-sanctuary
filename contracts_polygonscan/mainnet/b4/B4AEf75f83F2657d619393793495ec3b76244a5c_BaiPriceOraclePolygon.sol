...
/**
  * @title Bai's InterestRateModel Interface
  * @author Bai
  */
...
contract TokenErrorReporter {
    ...
    enum FailureInfo {
        ...
        BAI_MINT_NEW_ACCOUNT_BALANCE_CALCULATION_FAILED
    }
...
// File: contracts\BaiPriceOraclePolygon.sol
...
contract BaiPriceOraclePolygon is PriceOracle {
    ...
    constructor() public {
        admin = msg.sender;
        maticPriceFeed = AggregatorV3Interface(0xAB594600376Ec9fD91F8e885dADF0CE036862dE0); // MATIC-USD aggregator
    }
    ...
    function getUnderlyingPrice(BToken bToken) public view returns (uint) {
        if (compareStrings(bToken.symbol(), "vMATIC")) {
            return getETHPrice();
