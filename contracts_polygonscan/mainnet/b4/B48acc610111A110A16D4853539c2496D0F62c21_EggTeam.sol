...
contract EggTeam is ERC721, Ownable, ERC721Enumerable {
    ...
    function mintEgg(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                ...
                emit EggMinted(id, msg.sender);
            }
        }
    }

    function presaleEgg(uint256 numberOfTokens) external payable {
