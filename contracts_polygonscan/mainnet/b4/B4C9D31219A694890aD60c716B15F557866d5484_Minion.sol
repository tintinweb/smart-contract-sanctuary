...
contract Minion is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoMinions", "CRM") {
    setHiddenMetadataUri("ipfs://QmdbmvF9voHxeiK7TEM48SwkoPUKAeQSr6b8ohaJacQKoc/metadata/{id}.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x95B4aaa7b0526c4AA8D7E72D416812D1ab84CbA9).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
