...
contract InteropBetaImplementation is Variables, Initializable, Helpers, Events {
    ...
    function revertAction(
        ...
        // TODO: Logic will change to support only internal team for reverting
        address sourceDsaAddrCheck = actionDsaAddress[key];
        require(sourceDsaAddrCheck != address(0), "not-same-dsa");
        // require(
        ...
        onlyOwner
    {
        ...
        if (revertSpells) {
            ...
            // TODO @thrilok209: use enum instead of bool
            executeMapping[s.key] = true;
        }
    }
