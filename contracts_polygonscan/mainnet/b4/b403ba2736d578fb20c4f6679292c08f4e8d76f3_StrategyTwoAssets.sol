...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function getHarvestable() external override view returns (uint256) {
        return IStakingRewards(rewards).earned(address(this), 0xC168E40227E4ebD8C1caE80F7a55a4F0e6D66C97);
    }
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public Dfyn_Rewards = 0xa0d35c593235bA61151F0BAD89A4fB70AA5dad9f;
