...
contract BadgerTreeV2 is Initializable, AccessControlUpgradeable, ICumulativeMultiTokenMerkleDistributor, PausableUpgradeable {
    ...
    function reinitialize() public {
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, 0xDA25ee226E534d868f0Dd8a459536b03fEE9079b); // The admin can edit all role permissions
        _setupRole(DEFAULT_ADMIN_ROLE, 0x4977110Ed3CD5eC5598e88c8965951a47dd4e738); // The admin can edit all role permissions
        _setupRole(ROOT_PROPOSER_ROLE, 0x68de9E2b015904530593426d934CE608e117Fa7A); // The admin can edit all role permissions
        _setupRole(ROOT_VALIDATOR_ROLE, 0x626F69162Ea1556A75Dd4443D87D2fe38dd25901); // The admin can edit all role permissions
        
        grantRole(ROOT_PROPOSER_ROLE, 0xba5EDb751Ccf93770796E273D8bCe83e1e81E2d4);
        grantRole(ROOT_VALIDATOR_ROLE, 0xba5EDb751Ccf93770796E273D8bCe83e1e81E2d4);
    }
}