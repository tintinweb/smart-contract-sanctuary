...
contract ChristmasDoge is Context, IERC20, Ownable {
    ...
    string private _name = "ChristmasDoge";
    string private _symbol = "DMAS";
    ...
    address public MarketingWallet = 0x07b7c0D9aE729D7665338b99D2cd934e792EED29;
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**14;
    uint256 private numTokensSellToAddToLiquidity = 5000000 * 10**14;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);  // PCS V2
