...
/** 
 *  SourceUnit: /Users/dan/HAI/Contracts-Monorepo/contracts/tge/DAOTokenVesting.sol
*/
...
contract DAOTokenVesting is TokenVestingBase {
    constructor(
        address token_,
        address multisig,
        VestingBaseInput[] memory founders,
        uint256 ecosystemFundVestingAmount
    ) public TokenVestingBase(token_, multisig) {
        for (uint256 i = 0; i < founders.length; i++) {
            VestingBaseInput memory founderData = founders[i];
            _createVestingSchedule(
                founderData.user,
                block.timestamp,
                0,
                ...
                1 seconds,
                true,
                // enter in 15% of their amount. the other 85% will be locked via team.finance
                founderData.amount
            );
        }
        ...
        _createVestingSchedule(
            ...
            4 weeks,
            false,
            // enter in 98% of their amount. the other 2% we'll mint directly at TGE
            ecosystemFundVestingAmount
        );
    }
}