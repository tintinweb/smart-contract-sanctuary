...
pragma solidity ^0.8.0;
contract VIETNAMSNFT is ERC20, Ownable {
    ...
    constructor() ERC20("VIETNAMSNFT", "VNF") {
        _mint(msg.sender, 100000000000*10**decimals());
        _mint(address(this), 900000000000*10**decimals());
        startSale(block.number, 999999999, 0,250000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,500*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
