...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public pwings_eth_path;
    ...
    {
        pwings_eth_path = new address[](2);
        pwings_eth_path[0] = pwings;
        pwings_eth_path[1] = eth;
    ...
    function harvest() public override {
        ...
        if (_pwingsBalance > harvestCutoff){
            _swapUniswapWithPath(pwings_eth_path, _pwingsBalance.div(2));
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public ETH_MATIC_LP = 0x951E38875a93df95bbd24fe31f409b7933B35BED;
