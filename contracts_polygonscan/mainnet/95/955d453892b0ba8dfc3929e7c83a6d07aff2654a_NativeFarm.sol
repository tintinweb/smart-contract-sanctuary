...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public NATIVE = 0x40038C83E459937A988b669f1159cC78d8fdad68; //TOKEN
    ...
    // Natives per block: (0.289351851851852000 - owner 10%)
    uint256 public NATIVEPerBlock = 289351851851852000; // NATIVE tokens created per block
    // Approx start 19/9/2021 4:00AM GMT-4

    uint256 public startBlock = 19266792; // https://polygonscan.com/block/countdown/19266792
