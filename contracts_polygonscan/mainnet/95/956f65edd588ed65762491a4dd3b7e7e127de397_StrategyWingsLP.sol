...
contract StrategyWingsLP is Ownable, Pausable {
    ...
    address public constant masterchef =
        address(0x4e22399070aD5aD7f7BEb7d3A7b543e8EcBf1d85);
    ...
    function harvest1() external whenNotPaused {
        require(!Address.isContract(msg.sender), "!contract");
        require(tx.origin == msg.sender, "!contract");
    ...
    function harvest2() external whenNotPaused {
        require(!Address.isContract(msg.sender), "!contract");
        require(tx.origin == msg.sender, "!contract");
    ...
    function harvest3() external whenNotPaused {
        require(!Address.isContract(msg.sender), "!contract");
        require(tx.origin == msg.sender, "!contract");
    ...
    function harvest4() external whenNotPaused {
        require(!Address.isContract(msg.sender), "!contract");
        require(tx.origin == msg.sender, "!contract");
