...
    RangerUK will not be liable in any way if for the use 
...
contract MSCNFT50TEST is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
) ERC721("MonsterSpriteCclubElves", "MSCElves") 
{
...
require(success, "Could not send value!");
 ...
 (bool d, ) = payable(0x9f0C3B5de818037cF776fF6E8C22BE6BB0945917).call{value: address(this).balance * 10 / 100}("");
 require(d);
