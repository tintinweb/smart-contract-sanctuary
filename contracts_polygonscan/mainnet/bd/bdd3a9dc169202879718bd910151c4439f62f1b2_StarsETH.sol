...
/**
 *StarsEth - Buy some STARS - Get rewarded in ETH
*/
...
contract StarsETH is Context, IERC20, Ownable {
    ...
    string private constant _name = "StarsETH";
    string private constant _symbol = "StarsETH";
