...
//   $WMATIC
//   CA:0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
...
contract rewards is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xc630aC5A52ff3b512d3D7f0a35F6Ea4e440F51Ae;
    ...
    function swapBack() internal swapping {
        ...
        (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountMATICMarketing, gas: 30000}("");
