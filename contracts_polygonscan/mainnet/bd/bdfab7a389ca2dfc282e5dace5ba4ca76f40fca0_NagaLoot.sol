...
contract NagaLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    mapping(uint256 => bool) public buyGenesis;
    ...
    function updateBuyGenesis(uint256 tokenId) public onlyOwner {
        require(buyGenesis[tokenId] == false);
        buyGenesis[tokenId] = true;
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bag #', toString(tokenId), '", "description": "NagaLoot is randomized adventurer part generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use NagaLoot in any way you want. And please waiting for big surprise", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("Naga Loot", "NLOOT") Ownable() {}
}
