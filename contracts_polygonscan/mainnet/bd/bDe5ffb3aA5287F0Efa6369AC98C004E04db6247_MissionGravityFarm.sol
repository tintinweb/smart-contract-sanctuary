...
// File contracts/interfaces/IGravityFarm.sol

// SPDX-License-Identifier: MIT

pragma solidity 0.6.12;

interface IGravityFarm {
...
// File contracts/missions/MissionGravityFarm.sol



pragma solidity 0.6.12;
contract MissionGravityFarm is BaseMissionLPSingle {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function _vaultDeposit(uint256 _amount) internal override {
        IGravityFarm(masterchefAddress).deposit(_amount);
    }
    
    function _vaultWithdraw(uint256 _amount) internal override {
        IGravityFarm(masterchefAddress).withdraw(_amount);
    }
    
    function _vaultHarvest() internal override {
        IGravityFarm(masterchefAddress).withdraw(0);
    }
    
    function vaultSharesTotal() public override view returns (uint256) {
        (uint256 amount,) = IGravityFarm(masterchefAddress).userInfo(address(this));
        return amount;
    }
    ...
    function _emergencyVaultWithdraw() internal override {
        IGravityFarm(masterchefAddress).emergencyWithdraw();
    }
}