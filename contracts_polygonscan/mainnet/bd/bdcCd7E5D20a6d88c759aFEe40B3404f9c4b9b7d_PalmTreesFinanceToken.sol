...
// File: contracts/PalmTreesFinanceToken.sol
...
contract PalmTreesFinanceToken is BEP20('PalmTrees Finance', 'Palm') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTPalm::transfer: Burn value invalid");
