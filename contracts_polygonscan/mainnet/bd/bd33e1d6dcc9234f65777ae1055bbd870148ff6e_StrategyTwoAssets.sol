...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        quick_btc_path = new address[](3);
        quick_btc_path[0] = quick;
        quick_btc_path[1] = eth;
        quick_btc_path[2] = btc;
    }
    ...
    function harvest() public override {
        ...
        if (_quickBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(quick_btc_path, _quickBalancePost);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public Quick_Rewards = 0x070D182EB7E9C3972664C959CE58C5fC6219A7ad;
    address public BTH_ETH_LP = 0xdC9232E2Df177d7a12FdFf6EcBAb114E2231198D;
