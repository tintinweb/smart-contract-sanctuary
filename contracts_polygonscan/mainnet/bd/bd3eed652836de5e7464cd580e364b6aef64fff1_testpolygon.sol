...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xdAb529f40E671A1D4bF91361c21bf9f0C9712ab7);
...
contract testpolygon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "testpolygon";
    string constant _symbol = "SHIBRB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd5BA730964217bc453620CC0e15dd5e162269F14;
    ...
    function manage_DC(address[] calldata addresses, bool status) public onlyOwner {
