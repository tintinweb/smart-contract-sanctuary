...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0xaD38b2c28F3a61B58875acE9614a7F7DCdC5c86a; //contract wallet
...
contract DoubleRef is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DoubleRef", "DREF") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        contractWallet = 0xaD38b2c28F3a61B58875acE9614a7F7DCdC5c86a;
        marketingWallet = 0xd45b21ddFe055eF997D41a025461AacB8e774830;
        a80DividendToken = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; //WMATIC
        b20DividendToken = 0x3BA4c387f786bFEE076A58914F5Bd38d668B42c3; //BNB
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by DoubleRef");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by DoubleRef");
    ...
    function _transfer(
        ...
        require(!isBlacklisted(from), "DoubleRef: sender blacklisted");
        require(!isBlacklisted(to), "DoubleRef: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "DoubleRef: sender blacklisted");
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "DoubleRef: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "DoubleRef: Account is not blacklisted");
