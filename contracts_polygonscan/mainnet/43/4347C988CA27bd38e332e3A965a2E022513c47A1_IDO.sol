...
contract IDO is Context, Ownable{
    ...
    */ 
    function preAlloc(uint _amount) external isready isFunded isSaleOpen{
        ...
        uint cost = _amount/10**12 * price / 10000; // cost for this amount of tokens, please notify users, USDT with 6 decimals!!!
    ...
    */
    function R2purchase(uint _amount) isready external{
        ...
        IERC20(U).safeTransferFrom(_msgSender(), address(this), _amount/10**12 * price2/10000);
