...
contract Lottery is VRFConsumerBase, Ownable{
    ...
    constructor(address _vrfCoordinator, address _link, bytes32 _keyHash) 
        ...
        KeyHash = _keyHash;
        asset = ERC20(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063); // DAI
        addressOfAsset = address(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063); // DAI
    ...
    function enter() public {
        ...
        asset.transferFrom(address(msg.sender), address(this), 10000000000000000000); // 10 DAI
        depositToAAVE();
    ...
    function depositToAAVE() internal {
        IERC20(addressOfAsset).approve(address(lendingPool),10000000000000000000); // Approves Token
        ILendingPool(lendingPool).deposit(addressOfAsset, 10000000000000000000, address(this), 0); // Deposits to AAVE Pool
        totalDepositedInAAVE = totalDepositedInAAVE + 10000000000000000000;
    }

    function withdrawFromAAVE() internal {
        ILendingPool(lendingPool).withdraw(addressOfAsset, totalDepositedInAAVE, address(this));
        totalDepositedInAAVE = 0;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override{
        ...
        withdrawFromAAVE();
        asset.transfer(players[index], asset.balanceOf(address(this)));
