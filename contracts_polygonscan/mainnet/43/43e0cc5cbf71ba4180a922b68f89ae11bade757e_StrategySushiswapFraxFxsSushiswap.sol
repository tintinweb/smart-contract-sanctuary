...
// File: Vault\StrategySushiswapFraxFxsSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapFraxFxsSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00104592a158490a9228070e0a8e5343b499e125d0), address(0x003e121107f6f22da4911079845a470757af4e1a1b)];
        ...
        token1ToEarnedPath = [address(0x003e121107f6f22da4911079845a470757af4e1a1b), address(0x00104592a158490a9228070e0a8e5343b499e125d0), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00104592a158490a9228070e0a8e5343b499e125d0), address(0x003e121107f6f22da4911079845a470757af4e1a1b)];
    }
