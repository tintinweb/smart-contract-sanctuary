...
contract TimelockController is AccessControl, ReentrancyGuard {
    ...
    event SetStrategySettingsScheduled(
        bytes32 indexed id,
        address indexed stratAddress,
    ...
    function scheduleSetStrategySettings(
        ...
        _timestamps[id] = SafeMath.add(block.timestamp, minDelayReduced);
        emit SetStrategySettingsScheduled(
            id,
            _stratAddress,
            _entranceFeeFactor,
            _withdrawFeeFactor,
    ...
    function executeSetStrategySettings(
        address _stratAddress,
        uint256 _entranceFeeFactor,
        uint256 _withdrawFeeFactor,
        uint256 _controllerFee,
