...
contract SaleNFT is ReentrancyGuard, Ownable, ERC721Holder {
    ...
    address public constant ADMIN_ADDRESS = 0xC3c206540e37a410B78b1219E623D7929a3f8f13;
    
    address public constant SALE_ADDRESS = 0x50133E76608d90eB5C43385Ef025dA78843c9FD5;
    ...
    uint256 public salePrice = 15 * (10 ** 6); // 15 usd
    ...
    function buyNftCard(uint256 _amountNFT) external nonReentrant {
        ...
        uint256 _balanceOfNFT = sandManNFT.balanceOf(address(this));
        ...
        require(_usdSpend <= USD.balanceOf(_msgSender()), "E6");
        ...
        if (_balanceOfNFT > 0) {
              ...
              USD.safeTransferFrom(_msgSender(), SALE_ADDRESS, _usdSpend);
        }
        
        emit BuyNftCard(_msgSender(), _amountNFT, _usdSpend);
    ...
    function sendUnclaimedNftCardToAdminAddressAll() external onlyOwner {
        ...
        if (_balanceOfNFT > 0){
            ...
            for(uint256 i=0; i < _balanceOfNFT; i++ ){
                _lastNFTAssigned = sandManNFT.tokenOfOwnerByIndex(address(this), 0);
                sandManNFT.safeTransferFrom(address(this), ADMIN_ADDRESS, _lastNFTAssigned);
            }
        }
    ...
    function sendUnclaimedNftCardToAdminAddressByIndex(uint256 _index) external onlyOwner {
        ...
        if (_balanceOfNFT > 0)
            sandManNFT.safeTransferFrom(address(this), ADMIN_ADDRESS, _index);
