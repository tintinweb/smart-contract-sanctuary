...
// File contracts/AirdropDistribution.sol
...
contract AirdropDistribution {
     ...
     * Owner methods
     */
    function initialize(IERC20 _airdropToken, address[] memory _recipient, uint256[] memory _airdropAmounts, uint256 _snapshotTime) external onlyGovernance {
