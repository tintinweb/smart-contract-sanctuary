...
contract MagicKitty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MagicKitty";
    string private _symbol = "MagicKitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93833cA0b359C5c645E373f4C332d5822eE9800d); // Marketing Address
    address payable public teamWalletAddress = payable(0x859F46bfd6a982bed82c4686C4c923B8027dee99); // Team Address
