...
contract ScamJPG is Ownable, ERC721 {
    uint256 public constant supplyLimit = 3;
    uint256 public totalSupply;
    bool public publicSaleActive = true;
    string public baseURI;
    uint256 public maxPerTransaction = 10; //Max per transaction
    ...
    function freeMint(uint256 numberOfTokens) public {
        require(totalSupply <= 2, "free supply reached");
