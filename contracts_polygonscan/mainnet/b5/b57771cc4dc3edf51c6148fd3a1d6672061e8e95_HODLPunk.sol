...
/**
 * @title HODLPunk contract (PolyBabyDoge)
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract HODLPunk is ERC721, Ownable {
    using SafeMath for uint256;

    string public HODLPunk_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant apePrice = 5000000000000000000; // 5 Matic
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        HODLPunk_PROVENANCE = provenanceHash;
    }
    ...
    */
    function mintApe(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_APES, "Purchase would exceed max supply of Punks");
