...
contract RouletherGame is VRFConsumerBase, Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    // ChainLink VRF: Oracle on Polygon (Matic) Mainnet
    address public constant VFRC_address = 0x3d2341ADb2D31f1c5530cDC622016af293177AE0; // VRF Coordinator
    address public constant LINK_address = 0xb0897686c545045aFc77CF20eC7A532E3120E0F1; // LINK token
    bytes32 public constant CL_KEY =
        0xf86195cf7690c55907b2b611ebb7343a6f649bff128701cc542f0569e2c549da; // ChainLink key hash
    
    // // ChainLink VRF: Oracle on Polygon (Matic) Mumbai
    // address public constant VFRC_address = 0x8C7382F9D8f56b33781fE506E897a4F1e2d17255; // VRF Coordinator
    // address public constant LINK_address = 0x326C977E6efc84E512bB9C30f76E30c160eD06FB; // LINK token
    // bytes32 public constant CL_KEY =
    //     0x6e75b569a01ef56d18cab6a8e71e6600d6ce853834d4a5748b720d06f878b3a4; // ChainLink key hash
    uint public chainlinkFee = 100000000000000; // ChainLink Fee (0.0001 LINK)
    ...
    function placeBet(uint betMask, uint modulo) external payable nonReentrant {
        ...
        bytes32 requestId = requestRandomness(CL_KEY, chainlinkFee);
    ...
    function fulfillRandomness(bytes32 requestId, uint randomness) internal override onlyVFRC {
    ...
    function withdrawETH(uint withdrawAmount) external onlyOwner {
    ...
    function withdrawLINK(uint withdrawAmount) external onlyOwner {
        require(LINK.transfer(msg.sender, withdrawAmount), "Error, unable to transfer");
    }

    // Withdraw other ERC20 tokens
    function withdrawOtherToken(address token_address) external onlyOwner {
        require(token_address == LINK_address, "Not the correct method to withdraw LINK");
