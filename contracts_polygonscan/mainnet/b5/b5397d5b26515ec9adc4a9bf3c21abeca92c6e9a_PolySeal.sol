...
contract PolySeal   is Context, IERC20, Ownable {
...
contract Seal is PolySeal   , NativeMetaTransaction, ContextMixin {
    constructor() PolySeal   () {
