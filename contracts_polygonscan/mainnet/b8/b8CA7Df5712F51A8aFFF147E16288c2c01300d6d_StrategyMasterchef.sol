...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant destructionAddress = 0xbba87cbf2d33C4A4AD20E21F823B8b9f5f8e50fc;
    address public constant rewardAddress = 0x6519b3F4556bE9f8ecf6F171018c4Ebc9D64C22C;
    address public constant withdrawFeeAddress = 0x6D9518bd44fce1ee2EF8d7E3090fBA60304A4ceA;
    ...
    uint256 public withdrawFeeFactor = 9900; // 1% withdraw fee
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            IStrategyDestruction(rewardAddress).depositReward(usdcAfter);
