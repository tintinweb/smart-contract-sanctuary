...
contract PartyPumpkinsAirdrops is ERC1155, Ownable {
    event PermanentURI(string _value, uint256 indexed _id);
    string public name = "Party Pumpkins Airdrops";
    string public symbol = "PPAIRDROP";
    ...
    function addToken(string memory newURI)
    public
    onlyOwner
  {
    totalTokens += 1;
