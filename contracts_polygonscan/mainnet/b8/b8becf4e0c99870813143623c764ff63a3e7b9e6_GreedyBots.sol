    ...
    */
    ...
    function mint(address _to) external payable {
        ...
        if( block.number < preSaleEnd ){
            ...
            require(isWhitelist(),"Must be white listed");
            yourPrice = cost/4*3;
    ...
    function isWhitelist() internal view returns(bool isWhiteListed) {
    ...
    function tokenURI(uint256 _id) public view virtual override returns (string memory) {
        return string(abi.encodePacked('https://ipfs.io/ipfs/', unRevealedURI,'/',_id));
    }
