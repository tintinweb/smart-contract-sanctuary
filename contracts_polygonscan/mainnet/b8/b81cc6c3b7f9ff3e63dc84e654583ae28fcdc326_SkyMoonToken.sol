...
// File contracts/token/ERC20/SkyMoon.sol
...
contract SkyMoonToken is Recoverable, UsingUniversalForwarding, ChildERC20 {
    using ERC20Wrapper for IWrappedERC20;
    ...
    ) ChildERC20("SkyMoonDeFi Token", "SKYMOON", 18, "", childChainManager) UsingUniversalForwarding(forwarderRegistry, universalForwarder) Ownable(msg.sender) {
