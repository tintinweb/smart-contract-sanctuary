...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        gfi_token2_path = new address[](2);
        gfi_token2_path[0] = gfi;
        gfi_token2_path[1] = token2;
    }
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0xfe187f250Acd76319c0f825007e34533723DD5eC;
    address public Want_Token = 0xe0ce1D5380681d0d944b91C5A56D2B56e3cc93Dc;
