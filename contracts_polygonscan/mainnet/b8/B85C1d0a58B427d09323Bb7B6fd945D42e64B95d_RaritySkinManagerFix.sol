...
contract RaritySkinManagerFix is Ownable {
    ...
    function claimByAdventurer(uint256 tokenId) private {
        ...
        IERC20(token).safeTransfer(msg.sender, earnedAmount - rogueAmount);
        
        emit Claim(msg.sender, tokenId, earnedAmount - rogueAmount, false);
    }
    ...
    function claimByRogue(uint256 tokenId) private {
        ...
        emit Claim(msg.sender, tokenId, amount, true);
    }
}
