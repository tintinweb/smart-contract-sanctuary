...
contract StarbuckApplication is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmc9K1VUiCqjMF9YDBaAwzkrpWCpE84wZ2h23VydC4mRuo";
    ...
    constructor(
    ) ERC721A("StarbuckApplication", "SBJOB", 100, maxSupply) {
    }
