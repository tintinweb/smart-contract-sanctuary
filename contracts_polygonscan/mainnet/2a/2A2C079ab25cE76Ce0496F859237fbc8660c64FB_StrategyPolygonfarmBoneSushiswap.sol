...
// File: Vault\libs\IPolygonFarm.sol

// For interacting with masterchef
interface IPolygonFarm {
...
// File: Vault\StrategyPolygonfarmBoneSushiswap.sol

// openzeppelin v3.1.0

contract StrategyPolygonfarmBoneSushiswap is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToWantPath= [address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x006bb45ceac714c52342ef73ec663479da35934bf7)];
        wantToEarnedPath = [address(0x006bb45ceac714c52342ef73ec663479da35934bf7), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00f5ea626334037a2cf0155d49ea6462fddc6eff19)];
    }

    function stake(uint256 _wantAmount)  internal override virtual{
        IPolygonFarm(masterChef).deposit(pid, _wantAmount, referralAddress);
    }
    ...
    function harvest() internal virtual override{
        ...
        IPolygonFarm(masterChef).deposit(pid, 0, referralAddress);
    }

    function unstake(uint256 _amount) internal virtual override{
        IPolygonFarm(masterChef).withdraw(pid, _amount);
    }    

    function emergencyWithdraw() internal virtual override onlyOperator {
        IPolygonFarm(masterChef).emergencyWithdraw(pid);
    }
    
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 amount, ) = IPolygonFarm(masterChef).userInfo(pid, address(this));
        return amount;
    }
}