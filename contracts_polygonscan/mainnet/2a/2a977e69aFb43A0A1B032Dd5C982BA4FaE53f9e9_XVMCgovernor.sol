...
contract XVMCgovernor {
    ...
    address public immutable raContract = 0x45C30d0Cd42F94edA94E48aE557DC844e55D0641;
    ...
    uint256 public costToVote = 4269 * 1e18;  //all proposals are valid unless rejected. This is a minimum to prevent spam
    ...
    */
    ...
    function afterDelayOwnership() external onlyTrustee {
        ...
        if(block.timestamp > 1640171471) {
            ...
            require(newGovernorRequestBlock2 + 6260 < block.number, "Pending timelock");
        }
