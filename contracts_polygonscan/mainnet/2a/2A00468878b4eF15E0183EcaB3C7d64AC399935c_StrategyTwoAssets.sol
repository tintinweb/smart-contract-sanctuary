...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address[] public quick_aave_path;
        ...
        )
    {
        ...
        quick_aave_path = new address[](3);
        quick_aave_path[0] = quick;
        quick_aave_path[1] = eth;
        quick_aave_path[2] = aave;
    }
    ...
    function harvest() public override {
        ...
        if (_quickBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(quick_aave_path, _quickBalancePost);
            ...
            if (_eth > 0 && _aave > 0) {
                ...
                IERC20(aave).safeApprove(currentRouter, 0);
                IERC20(aave).safeApprove(currentRouter, _aave);
                ...
                IERC20(aave).safeTransfer(
                    strategist,
                    IERC20(aave).balanceOf(address(this))
                );
            }
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public Quick_Rewards = 0x573bb5CCC26222d8108EdaCFcC7F7cb9e388Af10;
    address public AAVE_WETH_LP = 0x90bc3E68Ba8393a3Bf2D79309365089975341a43;
