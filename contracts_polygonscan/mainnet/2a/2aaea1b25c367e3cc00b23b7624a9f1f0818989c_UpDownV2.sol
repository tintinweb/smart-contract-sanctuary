...
interface IRandomNumberGenerator {
    function info() external view returns (address feeToken, uint256 feeAmount, bytes32 KEY_HASH);
...
contract UpDownV2 is IERC721Locker,OwnableUpgradeable, ReentrancyGuard {
    ...
    */
    ...
    function _getRandomNumber(uint256 _hash) internal returns (uint256) {
        ...
        IERC20(feeToken).safeApprove(address(randomNumberGenerator), feeAmount);
    ...
    function _settleBet(
        ...
        if (referralContract != address(0x0)) {
            ...
            if (ref != address(0x0)) {
                ...
                meeb.safeTransfer(referralContract, commission);
