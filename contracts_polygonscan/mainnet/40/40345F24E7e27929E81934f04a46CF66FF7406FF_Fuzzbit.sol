...
contract Fuzzbit is ERC20PresetMinterPauser, ERC20Capped {
    uint256 public fuzzbitSupplyCap = 555000000 * 10 ** 18;

    constructor () ERC20Capped(fuzzbitSupplyCap) ERC20PresetMinterPauser("FuZZBiT", "FZBT") { }
    ...
    function grantMinterRole(address minter) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Admin role required to grant minter role");
