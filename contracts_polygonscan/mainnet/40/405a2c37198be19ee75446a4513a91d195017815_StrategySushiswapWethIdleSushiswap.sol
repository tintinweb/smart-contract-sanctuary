...
// File: Vault\StrategySushiswapWethIdleSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapWethIdleSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00c25351811983818c9fe6d8c580531819c8ade90f)];
        ...
        token1ToEarnedPath = [address(0x00c25351811983818c9fe6d8c580531819c8ade90f), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00c25351811983818c9fe6d8c580531819c8ade90f)];
    }
