...
//
// TCORE Vault v2 / TCORE Vault smart contract - Polygon (MATIC) cross-chain integration
...
// Safe tcore transfer low-level functions, just in case if rounding error causes the pool to do not have enough TCOREs,
...
contract TcoreVaultV2 is OwnableUpgradeSafe, RescueTokens {
    using SafeMath for uint256;
