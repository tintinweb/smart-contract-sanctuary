...
// Flux - Next generation of decentralized computing power
// https://runonflux.io
...
contract BalanceChecker {
  /* Fallback function, don't accept any ERC */
  ...
  */
  ...
  /*
    ...
    Pass 0x0 as a "token" address to get ERC balance.
    ...
    for(uint i = 0; i < users.length; i++) {
      for (uint j = 0; j < tokens.length; j++) {
        ...
        if (tokens[j] != address(0x0)) { 
          ...
          addrBalances[addrIdx] = users[i].balance; // ERC balance    
        }
      }  
    }
