...
contract MafiaMadDogs is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 10000;
    uint public  basePrice = 25*10**18; // MATIC
    uint public  basePriceMGG = 15*10**18; // MATIC
    uint public  basePriceBZC = 20*10**18; // MATIC
    ...
    MafiaMadDogs internal MGG = MafiaMadDogs(0x700320a1C1E7DCcF410CA5597d4C1Ad3bC623e2a);  // 0x700320a1C1E7DCcF410CA5597d4C1Ad3bC623e2a
	MafiaMadDogs internal BZC = MafiaMadDogs(0x4bca2C2ecE9402b5D4dd031b49d48166C40B7957);  //  0x4bca2c2ece9402b5d4dd031b49d48166c40b7957
    ...
    constructor(string memory baseURI) ERC721("MafiaMadDogs", "MDD")  {
        setBaseURI(baseURI);
    }
