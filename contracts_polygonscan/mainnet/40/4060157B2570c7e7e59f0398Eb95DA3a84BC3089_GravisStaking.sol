...
contract GravisStaking is Ownable {
    ...
    uint256 public metalPerGrvxPerSecond;
    ...
    constructor(
        ...
        metalPerGrvxPerSecond = metalPerGrvxPerYear_ / (365 days);
    }
    ...
    function claimReward() external {
        ...
        metal.mint(msg.sender, reward);
    }

    // RESTRICTED FUNCTIONS

    function setMetalPerGrvxPerYear(uint256 metalPerGrvxPerYear_)
        external
        onlyOwner
    {
        _distributeRewards();
