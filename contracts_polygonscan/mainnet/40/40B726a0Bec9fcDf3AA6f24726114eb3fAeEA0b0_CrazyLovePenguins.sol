...
/**
 * @title ERC721Base
 * ERC721Base - ERC721 contract that access control, and is pausable
 */
abstract contract ERC721Base is ERC721, Pausable, Ownable, AccessControl {
...
// File: contracts/CrazyLovePenguins.sol
...
/**
 * @title CrazyLovePenguins
 * CrazyLovePenguins - a contract for the CrazyLovePenguins
 */
contract CrazyLovePenguins is ERC721Base {
    ...
    // sale features
    uint256  public  maxSupply = 1000;  // current release limit - can change to allow second mint
    bool public changeSupplyLocked = false; // fix the max supply for good
    bool public publicSaleActive = false;
    uint256 public basePriceEth = 10000000000000000; //0.010 ETH
    uint256 public basePriceMatic = 20000000000000000000; // 20 MATIC
    uint constant maxTokenPurchase = 10;
    ...
    constructor()
        ERC721Base("CrazyLovePenguins", "CLP")
    {
    }
    ...
    function updateETHPrice(uint newPrice) public onlyOwner{
        basePriceEth =  newPrice;
    }
    
    function updateMaticPrice(uint newPrice) public onlyOwner{
        basePriceMatic =  newPrice;
    }
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount * basePriceMatic <= msg.value, "WRONG_ETH_AMOUNT");
    ...
    // mint in WETH
    function mintWeth(uint256 amount) external {
        require(amount != 0, "INVALID_AMOUNT");
        require(publicSaleActive, "SALE_CLOSED");
        require(amount <= maxTokenPurchase, "AMOUNT_EXCEEDS_MAX_PER_CALL");
        ...
        require(weth.transferFrom(msg.sender, address(this),amount * basePriceEth));
