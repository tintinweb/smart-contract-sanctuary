...
contract pQBERT is ERC20, Ownable {
   ...
   QBERTDividendTracker public dividendTracker;
    ...
    constructor() ERC20("pQBERT", "pQBERT") {

        _marketingWallet = payable(0xec55f33e0B07ac51Ab4803cdeeFfD22976EedE39);
        _devWallet = payable(0xec55f33e0B07ac51Ab4803cdeeFfD22976EedE39);
...
contract QBERTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("QBERT_Dividend_Tracker", "QBERT_Dividend_Tracker") {
        claimWait = 3600;
...
/*pQBERT is the result of a time travel, if the address is 0x40038c83e459937a988b669f1159cc78d8fdad68*/