...
contract MiniChefV2 is BoringOwnable, BoringBatchable {
    ...
    constructor(IERC20 _sushi, address _treasuryAddr) public {
        SUSHI = _sushi;
    ...
    function set(uint256 _pid, uint256 _allocPoint, IRewarder _rewarder, bool overwrite) public onlyOwner {
        // call updatePool to accrue rewards until now
        // https://draculaprotocol.medium.com/sushiswap-smart-contract-bug-and-quality-of-audits-in-community-f50ee0545bc6
        updatePool(_pid);
    ...
    function setSushiPerSecond(uint256 _sushiPerSecond, uint256[] calldata _pids) public onlyOwner {
        // call massUpdatePools to accrue rewards until now
        // https://draculaprotocol.medium.com/sushiswap-smart-contract-bug-and-quality-of-audits-in-community-f50ee0545bc6
    ...
    function harvest(uint256 pid, address to) public {
        ...
        // Interactions
        if (_pendingSushi != 0) {
            SUSHI.safeTransfer(treasuryAddr, _pendingSushi.div(10));
