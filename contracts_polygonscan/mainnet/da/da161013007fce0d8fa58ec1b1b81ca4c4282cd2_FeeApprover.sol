...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        address _testVaultAddress
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        testTokenAddress = _TESTAddress;
        WETHAddress = _WETHAddress;
        tokenUniswapPair = IUniswapV2Factory(address(0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32)).getPair(WETHAddress,testTokenAddress);
        testVaultAddress = _testVaultAddress;
        feePercentX100 = 70;
    ...
    function setTestVaultAddress(address _testVaultAddress) public onlyOwner {
        testVaultAddress = _testVaultAddress;
    }
        ...
        )
    {
        ...
        // Dont have a fee when testVault is sending, or infinite loop
        // And when pair is sending ( buys are happening, do not tax on it)
        if(sender == testVaultAddress || sender == tokenUniswapPair ) {
