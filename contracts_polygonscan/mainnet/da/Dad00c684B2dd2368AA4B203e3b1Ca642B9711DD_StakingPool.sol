...
contract StakingPool is Ownable {
    ...
    function add(uint256 _allocPoint, address _lpToken, bool _withUpdate, bool _isNFT) public {
    ...
    function setSchedule(address _schedule) public {
        require(msg.sender == owner() || msg.sender == devaddr, "!dev addr");
        schedule = _schedule;
    }
    ...
    function mint(address to, uint256 rewardAmount) internal {
        ...
        ISchedMint(schedule).mint(to, rewardAmount);
