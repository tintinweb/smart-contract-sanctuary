...
interface IBeebStats {
    ...
    /**
     * @dev Returns Beeb stats from the token ID
     */
    ...
    /**
     * @dev Returns Beeb card details from the token ID
     */
...
interface IBeebFactory {
    ...
    function mintToken(
        address receiver,
        uint256 tokenId,
        IBeebStats.MeebInfo[] memory info,
        IBeebStats.MeebPurity memory purity,
        IBeebStats.MeebBody memory body
    ) external;
...
contract BeebSale is IERC721Receiver, OwnableUpgradeable, ReentrancyGuard {
