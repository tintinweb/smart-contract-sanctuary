...
// File contracts/MasterChefFund.sol

contract MasterChefFund is Ownable, ReentrancyGuard {
    ...
    function balance() public view returns (uint256) {
        return MESO.balanceOf(address(this));
    }

    /* ========== RESTRICTED FUNCTIONS ========== */

    function transferTo(address _receiver, uint256 _amount) public nonReentrant onlyPools {
        require(_receiver != address(0), "Invalid address");
        IERC20(MESO).safeTransfer(_receiver, _amount);
    }
