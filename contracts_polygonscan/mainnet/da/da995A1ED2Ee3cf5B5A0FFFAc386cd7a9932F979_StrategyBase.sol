...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public iris_matic_path;
    ...
    {
        iris_matic_path = new address[](2);
        iris_matic_path[0] = iris;
        iris_matic_path[1] = matic;
    }
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public HERMES_MASTER_CHEF = 0x4aA8DeF481d19564596754CD2108086Cf0bDc71B;
    address public IRIS = 0xdaB35042e63E93Cc8556c9bAE482E5415B5Ac4B1;
