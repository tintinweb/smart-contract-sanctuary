    ...
    PausableUpgradeable
{
    ...
    /**
     * @dev function: After pool close, allow to buy all left
     */
    function takeAllRemaining(uint16 _poolId)
        external
        nonReentrant
        whenNotPaused
    {
        ...
        require(pool.totalItems > poolStats[_poolId].totalBidItem, "All boxes sold");
        ...
        uint256 _quantity = pool.totalItems - poolStats[_poolId].totalBidItem;
        // Check balance BUSD
        uint256 totalAmount = pool.startPrice.mul(_quantity);
        IERC20Upgradeable payableToken = IERC20Upgradeable(pool.addressPayable);
