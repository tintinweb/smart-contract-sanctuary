...
interface Argu {
    ...
    function getNumTokensSellToAddToLiquidityOrBurn() external view returns (uint256);
...
contract CarbonCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address private _usdt = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F; //pos-usdt
    //address private _usdt = 0xfe4F5145f6e09952a5ba9e956ED0C25e3Fa4c7F1; //temp
...
//--------------------------------
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        bool overMinTokenBalance = contractTokenBalance >= argu.getNumTokensSellToAddToLiquidityOrBurn();
        ...
        if (
            ...
            contractTokenBalance = argu.getNumTokensSellToAddToLiquidityOrBurn();
            //add liquidity
