...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        matic_dai_path = new address[](2);
        matic_dai_path[0] = matic;
        matic_dai_path[1] = dai;
    }
    ...
    function harvest() public override {
        ...
        if (_maticBalance > harvestCutoffMatic){
            ...
            _swapUniswapWithPath(matic_dai_path, _maticBalancePost.div(2));
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public Matic_Dai_LP = 0xd32f3139A214034A0f9777c87eE0a064c1FF6AE2;
