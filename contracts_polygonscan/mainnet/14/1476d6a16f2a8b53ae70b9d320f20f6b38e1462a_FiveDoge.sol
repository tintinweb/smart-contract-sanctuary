...
contract FiveDoge is Context, IERC20, Ownable 
{
    ...
    uint256 private _tTotal = 5555500000000000000 * 10**9;
    ...
    uint256 public _taxFee = 5; //holders share
    ...
    address public marketingWallet =  0x55555feC8F27697df532204e540aC643D902FC5b;  
    ...
    uint256 public _maxTxAmount = 5555550000000000 * 10**9; //
    uint256 private numTokensSellToAddToLiquidity = 7555550000000 * 10**9;
