...
contract PolySealDefi is Context, IERC20, Ownable {
...
contract PolySeal is PolySealDefi, NativeMetaTransaction, ContextMixin {
    constructor() PolySealDefi() {
