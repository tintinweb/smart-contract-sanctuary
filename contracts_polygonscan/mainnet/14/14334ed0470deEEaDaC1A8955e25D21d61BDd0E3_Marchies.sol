...
contract Marchies is ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    // PROVENANCE
    string public MARCHIE_PROVENANCE = "";
    ...
    uint256 private reserveAmount = 1000;
    bool public isSaleActive = true;
    
    constructor() ERC721("Marchies", "MARCHIE") {}

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        MARCHIE_PROVENANCE = _provenanceHash;
    }

    function reserveTokens(address _to)
        public
        onlyOwner
    {
