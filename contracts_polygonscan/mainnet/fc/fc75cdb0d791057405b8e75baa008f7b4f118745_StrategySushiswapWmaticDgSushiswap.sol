...
// File: Vault\StrategySushiswapWmaticDgSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapWmaticDgSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002a93172c8dccbfbc60a39d56183b7279a2f647b4)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        token1ToEarnedPath = [address(0x002a93172c8dccbfbc60a39d56183b7279a2f647b4), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002a93172c8dccbfbc60a39d56183b7279a2f647b4)];
    }
