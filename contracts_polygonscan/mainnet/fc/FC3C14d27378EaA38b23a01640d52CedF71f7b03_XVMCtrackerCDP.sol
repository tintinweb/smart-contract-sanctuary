...
contract XVMCtrackerCDP is ERC20, ERC20Burnable, Ownable {
    address immutable masterchef = 0x9BD741F077241b594EBdD745945B577d59C8768e;
    bool public allowOwnerTransfer = true;

    constructor() ERC20("Time Deposit", "3 YEAR XVMC") {}
    ...
    function updateOwnerToGovernor() external {
        ...
        transferOwnership(IMasterChef(masterchef).owner());
    }
