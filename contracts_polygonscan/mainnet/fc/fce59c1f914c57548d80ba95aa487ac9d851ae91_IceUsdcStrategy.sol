...
contract IceUsdcStrategy is BaseStrategyIron {

    address public constant ICE_USDC_LP = 0x34832D9AC4127a232C1919d840f7aaE0fcb7315B;

    constructor() public BaseStrategyIron(ICE_USDC_LP, DFYN_ROUTER, 2) {
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        uint256 otherBalance = IERC20(USDC).balanceOf(address(this));
        if (harvestedTokenBalance > 0 && otherBalance > 0) {
            ...
            IERC20(USDC).safeApprove(currentRouter, otherBalance);
