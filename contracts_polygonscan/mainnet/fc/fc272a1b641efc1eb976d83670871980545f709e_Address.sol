...
/**
 *Submitted for verification at https://simba-play.org
*/
...
contract SIMBAPLAY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDb101807Ae6D4aA63d85acfbfA2d97700f9Ee178); // Marketing Address
    ...
    string private _name = "SIMBA PLAY";
    ...
    uint256 public _buyBackTimeInterval = 240 minutes;
    uint256 public _buyBackMaxTimeForHistories = 240 * 60 minutes;
