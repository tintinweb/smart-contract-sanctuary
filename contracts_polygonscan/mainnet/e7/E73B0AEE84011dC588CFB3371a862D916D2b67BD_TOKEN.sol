...
contract Ownable {
    ...
    modifier onlyPartner() {
        require(_partners[msg.sender]>0, "Ownable: caller is not partner");
        _;
    }
}
...
contract TOKEN is IERC20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint _total) public {
        _totalSupply = _total*10**18;
        name = _name;
        symbol = _symbol;
        decimals = 18;
        _balances[msg.sender] = _total*10**18;
    }
    ...
    function burn(uint256 value) public onlyPartner {
