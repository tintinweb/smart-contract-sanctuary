...
contract GS50 is IERC20, Context{
    ...
    INFTRewardPool public nftStaking;
    ...
    */
    constructor() {
        ...
        magnitude = 2**64;
        nftStaking =  INFTRewardPool(0x9b1dcC9AaE6150b7B6C4588760d8281CEd10C36f);
        dev1 = address(0xA37b77E5670e70aCc62aBe86b6b02c450e9eEff7);
        dev2 = address(0x7cF196415CDD1eF08ca2358a8282D33Ba089B9f3);
        currentId = 0;
        day = block.timestamp;
        owner = _msgSender();
        
        tokenBalanceLedger_[_msgSender()] = 1;
        tokenSupply_ = 1;
        ...
        public
    {
       ...
       //updates dividends tracker
        ...
        nftStaking.receiveEth{value: _ethereum.mul(1).div(100)}();
    ...
    function changeNftAddress(address newAdd) onlyOwner public {
        nftStaking =  INFTRewardPool(newAdd);
    }
