...
contract MyTestNft is ERC721Tradable {
    constructor(address _proxyRegistryAddress) ERC721Tradable("MyTestNft2", "MTN", _proxyRegistryAddress) {}

    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        if (_tokenId == 1) {
            return "https://1kpixel.io/moment-nft/metadata/1";
        } else {
            return "https://1kpixel.io/pix-nft/metadata/1";
        }
    }
