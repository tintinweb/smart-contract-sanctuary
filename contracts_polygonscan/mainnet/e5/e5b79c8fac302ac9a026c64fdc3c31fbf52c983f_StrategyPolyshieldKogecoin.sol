...
// File: Vault\StrategyPolyshieldKogecoin.sol

// openzeppelin v3.1.0

contract StrategyPolyshieldKogecoin is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e), address(0x0013748d548d95d78a3c83fe3f32604b4796cffa23)];
        earnedToToken1Path = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e)];
        token0ToEarnedPath = [address(0x0013748d548d95d78a3c83fe3f32604b4796cffa23), address(0x00f239e69ce434c7fb408b05a0da416b14917d934e)];
        token1ToEarnedPath = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0013748d548d95d78a3c83fe3f32604b4796cffa23)]; 
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00f239e69ce434c7fb408b05a0da416b14917d934e)];
