...
// File: Vault\StrategyGravityGfiWbtcGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityGfiWbtcGravity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
        earnedToToken1Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        token0ToEarnedPath = [address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        token1ToEarnedPath = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
    }
