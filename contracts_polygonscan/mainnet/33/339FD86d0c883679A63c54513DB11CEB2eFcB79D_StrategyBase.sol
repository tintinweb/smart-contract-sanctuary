...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address[] public shield_wmatic_path;
        ...
        )
    {
        ...
        shield_wmatic_path = new address[](2);
        shield_wmatic_path[0] = shield;
        shield_wmatic_path[1] = wmatic;
    ...
    function harvest() public override {
        ...
        if (_shieldBalance > harvestCutoff){
            ...
            if (_shield > 0 && _wmatic > 0) {
                ...
                IERC20(_wmatic).safeTransfer(
                    strategist,
                    IERC20(_wmatic).balanceOf(address(this))
                );
            }
        }
        // Stake the LP token
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public SHIELD_WMATIC_LP = 0x982c1F90381e31e7b7dbbA8708126532B7cb7dF6;
