...
import "./extensions/PolygonBurnable.sol";
...
contract OneMlnNfts is Context, ERC721Enumerable {
    ...
    constructor(PolygonBurnable _mil) ERC721('OneMlnNFTs', 'MIL') {
    ...
    function payForInfoAndColors(uint256 totalPrice) public {
        ...
        if (totalPrice > 0) {
            ...
            mil.burn(address(this), mil.balanceOf(address(this)));
        }
    ...
    function buyTile(uint256 tileId, uint256 totalPrice,
        ...
        if (totalPrice > 0) {
            ...
            mil.burn(address(tx.origin), totalPrice / 2);
        }
...
abstract contract PolygonBurnable is Context, ERC20Burnable {
    /**
