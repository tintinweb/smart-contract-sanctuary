...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034);
    //dont change that (:
...
contract Senzu_Beans is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034;
    ...
    string constant _name = "Senzu Beans";
    //change the token symbol
    string constant _symbol = "SENZUBEAN";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x6442eFe7887B3FAd44519BCe6693FE94B65c7e42;
