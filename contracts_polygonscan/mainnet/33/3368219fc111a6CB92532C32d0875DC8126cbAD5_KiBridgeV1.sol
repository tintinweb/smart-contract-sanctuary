...
contract KiBridgeV1 is KiBridgeV1Factory, Ownable, ReentrancyGuard {
  ...
  mapping(uint256 => mapping(IERC20 => IERC20)) private fromChainTokenReceiveToken;
  ...
  function getFromChainTokenInfo(
    uint256 _fromChainId,
    IERC20 _fromToken
  )
    external 
    view 
    returns (IERC20 receiveToken)
  {
    return fromChainTokenReceiveToken[_fromChainId][_fromToken];
  }
