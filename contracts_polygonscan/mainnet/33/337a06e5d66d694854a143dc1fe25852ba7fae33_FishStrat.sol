 ...
 */
contract FishStrat is Ownable, Pausable {
     ...
     * {roll} - Token generated by staking our funds. In this case it's the ROLLs token.
     ...
     */
    address constant public roll = address(0xC68e83a305b0FaD69E264A1769a0A070F190D2d6);

    address constant public kk = address(0x2981bb8f2883a462C5c413DE604C3B3e36884800);
    ...
    address constant public masterchef = address(0x3C58EA8D37f4fc6882F678f822E383Df39260937);
    uint constant public pid = 1;
    ...
    constructor() public {
        lpPair = roll;
        vault = 0x1E5fEacbc24D7658e01814a45C94cE293367dF6d;
    ...
    function deposit() public {
        ...
        if (pairBal > 0) {
            IMasterChef(masterchef).deposit(pid,pairBal, kk);
        }
        chargeFees();
    }
    ...
    function chargeFees() internal {
        if(buybackstrat!=address(0)){
            uint toSell = IERC20(roll).balanceOf(address(this)).mul(getBPSFee()).div(10000);
            IERC20(roll).transfer(buybackstrat, toSell);
        }
    }
