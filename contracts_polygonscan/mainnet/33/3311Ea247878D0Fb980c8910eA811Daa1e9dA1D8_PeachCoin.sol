...
contract PeachCoin is ERC20, AccessControl, ERC721Holder {
    ...
    constructor(address owner, address _collectionAddress) ERC20("Peach Coin", "PCHI") AccessControl(){
