 ...
 */
contract Flares is Initializable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, AccessControlEnumerableUpgradeable {
     ...
     * @dev Sets `_tokenURI` as the tokenURI of `tokenId`.
     */
    function setBatchTokenURIs(uint256[] memory tokenIds, string[] memory _tokenURIs) public onlyMinter {
     ...
     */
    function batchMint(address to, uint256[] memory tokenIds) public virtual onlyMinter {
