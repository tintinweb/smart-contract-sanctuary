...
contract Apple is Context, Ownable, ERC20 {
    ...
    uint256 public ApplePerTokenId = 10000 * (10**decimals());
    ...
    */
    ...
    constructor() Ownable() ERC20("Apple", "A") {
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, ApplePerTokenId);
    }
    ...
    function daoSetApplePerTokenId(uint256 appleDisplayValue)
        public
        onlyOwner
    {
        ApplePerTokenId = appleDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndApplePerTokenID(
        uint256 season_,
        uint256 appleDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetApplePerTokenId(appleDisplayValue);
    }
}