...
/**
   ...
   / ____/_  __/ / /_  __   ____  ____     _____/ /_  ____ _(_)___     /  _/___ ___  ____ _____ ____  
  / /_  / / / / / / / / /  / __ \/ __ \   / ___/ __ \/ __ `/ / __ \    / // __ `__ \/ __ `/ __ `/ _ \ 
 / __/ / /_/ / / / /_/ /  / /_/ / / / /  / /__/ / / / /_/ / / / / /  _/ // / / / / / /_/ / /_/ /  __/ 
/_/    \__,_/_/_/\__, /   \____/_/ /_/   \___/_/ /_/\__,_/_/_/ /_/  /___/_/ /_/ /_/\__,_/\__, /\___(_)
                /____/                                                                  /____/        
**/
...
contract FOCIv4 is ERC721, HasSecondarySaleFees, ContextMixin, Ownable {
    using Strings for uint256;
    ...
    string[] public MINT_NAME = new string[](1000);
    string[] public MINT_DISC = new string[](1000);
    string[] public MINT_DATA = new string[](1000);

    constructor()
    ERC721("FullyOnChainImgV4", "FOCIv4")
    ...
    function mint(uint256 tokenId, string memory name, string memory disc, string memory data) public onlyOwner {
        ...
        MINT_NAME[tokenId] = name;
        MINT_DISC[tokenId] = disc;
        MINT_DATA[tokenId] = data;
    }
    ...
    {
        return string(abi.encodePacked("data:application/json;base64,", Base64.encode(abi.encodePacked(_d1, MINT_NAME[tokenId], _d2, MINT_DISC[tokenId], _d3, MINT_DATA[tokenId], _d4))));
    }
