...
contract AmazingSlutGirlClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Amazing Slut Girl Club", "ASGC") {
    setHiddenMetadataUri("ipfs://QmfFagH3ivKH4eTTLpifg9CmV1HUV4kgakitSZLZkGDtSH/hidden.json");
  }
