...
// File: Vault\StrategyQuickswapOmQuickQuickswap.sol

contract StrategyQuickswapOmQuickQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x00c3ec80343d2bae2f8e680fdadde7c17e71e114ea)];
        token0ToEarnedPath = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token1ToEarnedPath = [address(0x00c3ec80343d2bae2f8e680fdadde7c17e71e114ea), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00c3ec80343d2bae2f8e680fdadde7c17e71e114ea)];
    }
