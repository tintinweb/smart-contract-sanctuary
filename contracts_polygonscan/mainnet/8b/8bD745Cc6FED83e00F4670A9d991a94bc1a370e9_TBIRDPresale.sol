...
contract TBIRDPresale is Ownable {
    ...
    uint256 public privPresaleCap = 50_000_000e9; //10% of total supply
    uint256 public pubPresaleCap = 50_000_000e9; //10% of total supply
    ...
    constructor() {
        priceFeedETH = AggregatorV3Interface(
            0xAB594600376Ec9fD91F8e885dADF0CE036862dE0 //matic mainnet
        );
    }
    ...
    function buyPrivTBIRD(address polygonWalletAddress) external payable {
        ...
        uint256 withdrawAmount = tbirdAmount.mul(25).div(100); //send 25% immediately
