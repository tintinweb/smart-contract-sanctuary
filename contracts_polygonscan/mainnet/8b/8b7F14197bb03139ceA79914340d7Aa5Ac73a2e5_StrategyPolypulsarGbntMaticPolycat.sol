...
// File: Vault\libs\IPolypulsar.sol

// For interacting with masterchef
interface IPolypulsar {
...
// File: Vault\StrategyPolypulsarGbntMaticPolycat.sol

// openzeppelin v3.1.0

contract StrategyPolypulsarGbntMaticPolycat is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x008c9aaca6e712e2193acccbac1a024e09fb226e51)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
        token1ToEarnedPath = [address(0x008c9aaca6e712e2193acccbac1a024e09fb226e51), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x008c9aaca6e712e2193acccbac1a024e09fb226e51)];
    }
    
    function stake(uint256 _wantAmount) internal virtual override{
        IPolypulsar(masterChef).deposit(pid, _wantAmount);
    }

    function harvest() internal virtual override{
        IPolypulsar(masterChef).deposit(pid, 0);
    }

    function unstake(uint256 _amount) internal virtual override{
        IPolypulsar(masterChef).withdraw(pid, _amount);
    } 
    function emergencyWithdraw() internal virtual override onlyOperator {
        IPolypulsar(masterChef).emergencyWithdraw(pid);
    }   
    
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance, , , ) = IPolypulsar(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}