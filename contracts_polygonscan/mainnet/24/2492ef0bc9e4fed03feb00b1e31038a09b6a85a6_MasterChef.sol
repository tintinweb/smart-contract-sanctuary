...
contract BoneToken is ERC20('Token', 'TOKEN') {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    uint256 constant MAX_BONE_SUPPLY = 42000 ether;

    address public devAddress;
    address public feeAddress;

    // Bone tokens created per block. 0.04 BONE / Block
    uint256 public BONE_PER_BLOCK = 0.04 ether;
