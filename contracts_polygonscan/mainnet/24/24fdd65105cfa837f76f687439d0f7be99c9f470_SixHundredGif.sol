...
// File: contracts/SixHundredGif.sol

pragma solidity ^0.8.0;



contract SixHundredGif is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint() public payable {
    ...
    if(supply > 0) {
        ...
        giftValue = supply + 1 == maxSupply ? address(this).balance * 10 / 100 : msg.value * 80 / 100;
    }
