...
pragma solidity ^0.6.12;
    ...
    contract Clean is Context, IERC20, Ownable {
        ...
        uint256 private _numOfTokensToExchangeForMarketingPool = 1 * 10**2 * 10**9;
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 100 , 'maxTxAmount should be greater than 1000000');
