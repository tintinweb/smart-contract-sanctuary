...
contract KanjiNFT_5th is ERC721Enumerable, ReentrancyGuard, Ownable {
  using Strings for uint256;
...
"insects","intestine","intuition","invite","iron","island","japanese harp","job","journey","joy","judgment","jump","karma","katana","kettle","key","kick","kill","kiln","kind","king","knee","knight","lack","lacquer","lady","lake","land","large","laugh","law","layer","lead","leaf","leak","learn","learn","leather","leather","leave","left","leg","lend","lid","life","light","light","light","like","line"];
  ...
  string private rl1='{"name": "KanjiNFT_5th #';
  string private rl3='"}';
...
//}
  ...
  function tokenURI(uint256 tokenId) override public view returns (string memory) {
    Kanji memory kanji = randomOne(tokenId);
    string memory id=(tokenId+400).toString();
...
//gasless
  ...
  constructor() ERC721("KanjiNFT_5th", "KNJ5") Ownable() {}
}