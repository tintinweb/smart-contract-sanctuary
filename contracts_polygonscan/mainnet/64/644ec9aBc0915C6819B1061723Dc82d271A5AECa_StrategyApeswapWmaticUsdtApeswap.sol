...
// File: Vault\StrategyApeswapWmaticUsdtApeswap.sol

// openzeppelin v3.1.0

contract StrategyApeswapWmaticUsdtApeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x005d47baba0d66083c52009271faf3f50dcc01023c), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00c2132d05d31c914a87c6611c10748aeb04b58e8f)];
        ...
        token1ToEarnedPath = [address(0x00c2132d05d31c914a87c6611c10748aeb04b58e8f), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x005d47baba0d66083c52009271faf3f50dcc01023c)];
