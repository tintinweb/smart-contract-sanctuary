...
contract WearablesStorage is ERC721Holder, AccessControlEnumerable {
    ...
    function setCollectionName(string memory _collectionName) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "WearablesStorage: Sender should be admin");
    ...
    function sendNFT(address _contract, address to) public {
        ...
        uint256 tokenId = collectionContract.tokenOfOwnerByIndex(my_address, 0);

        console.log("tokenID to send: ", tokenId);
        console.log("from: ", my_address);
        console.log("to: ", to);

        collectionContract.safeTransferFrom(my_address, to, tokenId);
    }
}
...
contract WSDeployer is AccessControlEnumerable {
    ...
    function deployWearablesStorage(string memory _collectionName) public returns (address) {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "WSDeployer: Sender should be admin");

        WearablesStorage newc = new WearablesStorage(_collectionName, msg.sender);
