...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 300*10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SpacePort Defi";
    ...
    address public ownerAddres = address(0x94d525b99F0C4C1978AF25ec6f301eEdD291aee9);
    uint256 private _previousBurnFee = _burnFee;


    uint256 public _maxTxAmount = 300 * 10 **18;
