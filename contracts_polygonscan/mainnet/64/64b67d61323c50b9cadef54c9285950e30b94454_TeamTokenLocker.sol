...
contract TeamTokenLocker is ILocker {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    address public octagon;
    ...
    function lock(address _account, uint256 _amount) external override {
        ...
        IBEP20(octagon).safeTransferFrom(msg.sender, address(this), _amount);
    ...
    function unlock() external override {
        ...
        IBEP20(octagon).safeTransfer(msg.sender, _amount);
