	...
	ERC721URIStorageUpgradeable
{
	...
	function initialize(address _proxyRegistryAddress) public initializer {
		__ERC721Tradable_init('NFT Faucet', 'FAKEY', _proxyRegistryAddress);
		...
		_contractURI = '{"name": "NFT Faucet","description": "Grab some NFTs for testing","image": "https://meem-assets.s3.amazonaws.com/meem.jpg","external_link": "https://meem.wtf","seller_fee_basis_points": 1000, "fee_recipient": "0x40c6BeE45d94063c5B05144489cd8A9879899592"}';
	}
	...
	function bulkMint(address to, uint256 num) public {
	...
	function baseURI(uint256 tokenId) public pure returns (string memory) {
		string[8] memory baseURIs = [
			'ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/',
			'ipfs://QmWEFSMku6yGLQ9TQr66HjSd9kay8ZDYKbBEfjNi4pLtrr/',
			'ipfs://QmeREDznqCuYGELWkX3RHPktZiQqpTxdNVx94QrywRcVZf/',
			'https://boredapeyachtclub.com/api/mutants/',
			'https://hashmap.azurewebsites.net/getMask/',
			'ipfs://bafybeic26wp7ck2bsjhjm5pcdigxqebnthqrmugsygxj5fov2r2qwhxyqu/',
			'https://api.fluf.world/api/token/',
			'https://www.winterbearsnft.com/api/'
		];

		return baseURIs[tokenId % 8];
	}
