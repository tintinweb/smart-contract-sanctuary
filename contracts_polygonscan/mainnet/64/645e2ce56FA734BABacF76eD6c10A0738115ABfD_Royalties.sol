...
contract Royalties {
    ...
    uint256 private banners = 70;
    uint256 private ghost = 10;
    uint256 private jax = 10;
    uint256 private fahim = 10;
    ...
    function _receiveAndSplit(
        ...
        if (token != address(0)) {
            ...
            ghostAddy.call{value: amountForGhost}("");
            jaxAddy.call{value: amountForJax}("");
            fahimAddy.call{value: amountForFahim}("");
            bannersWarChestAddy.call{value: amountForBanners}("");
        }
    }
