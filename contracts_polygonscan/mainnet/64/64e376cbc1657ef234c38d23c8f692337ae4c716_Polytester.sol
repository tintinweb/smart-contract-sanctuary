...
contract Polytester is ERC20 {
    ...
    uint256 public minAmountToVaultCash = 10 * 10**18;
    ...
    constructor() public {
        ...
        launchedAt = block.timestamp + 1000*43200;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (recipient == BURN || transferGalaxyTax == 0) {
            ...
            require(taxAmount == burnAmount + liquidityAmount, "GALAXY::transfer: Burn value invalid");
    ...
    function transferOperator(address newOperator) external onlyOperator {
        require(newOperator != address(0), "GALAXY::transferOperator: new operator is the zero address");
