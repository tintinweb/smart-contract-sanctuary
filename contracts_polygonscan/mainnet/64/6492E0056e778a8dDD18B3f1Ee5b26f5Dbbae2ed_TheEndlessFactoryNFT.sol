...
contract TheEndlessFactoryNFT is VRFConsumerBase, Ownable, ERC721URIStorage {
    ...
    function setExperience(uint256 tokenId, uint256 _newExperience) public {
        require(
            _isApprovedOrOwner(_msgSender(), tokenId),
            "ERC721: transfer caller is not owner nor approved"
        );
    ...
    function setGeneration(uint256 _newGeneration) public onlyOwner {
