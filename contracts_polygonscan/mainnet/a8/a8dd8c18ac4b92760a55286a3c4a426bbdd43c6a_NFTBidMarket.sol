...
contract NFTBidMarket is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    using Address for address;
    Counters.Counter private _itemIds;
    Counters.Counter private _itemsAccepted;
    ...
    event MarketBidItemAccepted(address indexed acceptor, uint256 indexed itemId, uint256 amount, State state);
    ...
    function createMarketAccept(uint256 itemId, address erc20Address, uint256 amount) public payable nonReentrant {
        ...
        MarketBidItem memory item = idToMarketBidItem[itemId];
        require(item.state == State.INITIATED, "MarketBidItem is in wrong state");
