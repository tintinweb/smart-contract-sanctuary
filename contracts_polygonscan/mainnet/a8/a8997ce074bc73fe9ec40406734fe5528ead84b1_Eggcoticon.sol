...
contract Eggcoticon is Ownable, ERC165, ERC721 {
    // Libraries
    ...
    function mint(uint256 quantity) public payable {
        ...
        // Ensure enough Polygon
        require(msg.value >= price, "Not enough Polygon sent");
    ...
    function withdraw() external {
        require(msg.sender == 0xB4C3c78b4059EBFd5c913B9819455389DfCe40fd);
        (bool success, ) = payable(0xB4C3c78b4059EBFd5c913B9819455389DfCe40fd)
