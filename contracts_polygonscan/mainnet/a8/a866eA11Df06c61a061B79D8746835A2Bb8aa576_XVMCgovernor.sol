...
contract XVMCgovernor {
    ...
    address public immutable acPool1 = 0xf7DE9CA2113c5C2445c3303768Ed0B3f73134425;
    address public immutable acPool2 = 0xac54171be3d948E983FfE0CCD6E98306aDb0e47A;
    address public immutable acPool3 = 0xb3f95C47294E9eba55E222A34a65aAaA99204CBA;
    address public immutable acPool4 = 0xE7d9637813bfC3eA27D540d6504524ff552e9456;
    address public immutable acPool5 = 0xAAE8006184E05Be3E901F6C06d8b4E294baC549a;
    address public immutable acPool6 = 0x164D80b365C697FF99EE1a408DF016Eaac9Ba685;
        
    //pool ID in the masterchef for respective Pool address and dummy token
    uint256 public immutable acPool1ID = 51;
    uint256 public immutable acPool2ID = 46;
    uint256 public immutable acPool3ID = 47;
    uint256 public immutable acPool4ID = 48;
    uint256 public immutable acPool5ID = 49;
    uint256 public immutable acPool6ID = 50;
    ...
    constructor(
        ...
        rollBonus[0xf7DE9CA2113c5C2445c3303768Ed0B3f73134425].bonusPoints = 50;
        rollBonus[0xac54171be3d948E983FfE0CCD6E98306aDb0e47A].bonusPoints = 69;
        rollBonus[0xb3f95C47294E9eba55E222A34a65aAaA99204CBA].bonusPoints = 82;
        rollBonus[0xE7d9637813bfC3eA27D540d6504524ff552e9456].bonusPoints = 130;
        rollBonus[0xAAE8006184E05Be3E901F6C06d8b4E294baC549a].bonusPoints = 150;
        rollBonus[0x164D80b365C697FF99EE1a408DF016Eaac9Ba685].bonusPoints = 200;
        // Infinite approve
        IERC20(_token).safeApprove(address(0xf7DE9CA2113c5C2445c3303768Ed0B3f73134425), type(uint256).max); //vaults
        IERC20(_token).safeApprove(address(0xac54171be3d948E983FfE0CCD6E98306aDb0e47A), type(uint256).max);
        IERC20(_token).safeApprove(address(0xb3f95C47294E9eba55E222A34a65aAaA99204CBA), type(uint256).max);
        IERC20(_token).safeApprove(address(0xE7d9637813bfC3eA27D540d6504524ff552e9456), type(uint256).max);
        IERC20(_token).safeApprove(address(0xAAE8006184E05Be3E901F6C06d8b4E294baC549a), type(uint256).max);
        IERC20(_token).safeApprove(address(0x164D80b365C697FF99EE1a408DF016Eaac9Ba685), type(uint256).max);
	...
	*/
    ...
    function afterDelayOwnership() external onlyTrustee {
        ...
        require(newGovernorRequestBlock2 + 6942 < block.number, "Pending timelock");
