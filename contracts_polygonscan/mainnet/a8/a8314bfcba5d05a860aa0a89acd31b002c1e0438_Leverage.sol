...
contract Leverage is AccessControl, Initializable {
  ...
  function initialize(IAddressProvider _a, IGovernanceAddressProvider _ga, ILendingPool _lendingPool, address _owner) external initializer {
  ...
  function releaseMIMO(address minerAddress) external onlyOwner {
