...
contract HeroFarmV3 is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function setRates(uint256 _teamRate, uint256 _communityRate, uint256 _ecosystemRate, 
        uint256 _reservedNFTFarmingRate,uint256 _erc20PoolRate, uint256 _erc721PoolRate) external onlyOwner {
        require(_teamRate + _communityRate + _ecosystemRate + _reservedNFTFarmingRate + _erc20PoolRate + _erc721PoolRate == 1000, "invalid param");
        teamRate = _teamRate;
        communityRate = _communityRate;
        ecosystemRate = _ecosystemRate;
        reservedNFTFarmingRate = _reservedNFTFarmingRate;
        erc20PoolRate = _erc20PoolRate;
        erc721PoolRate = _erc721PoolRate;
    }
