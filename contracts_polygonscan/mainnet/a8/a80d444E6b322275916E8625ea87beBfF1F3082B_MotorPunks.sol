...
contract MotorPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Motor Punks", "MP") {
    setHiddenMetadataUri("ipfs://QmQFaufz1wUz8xo93CELm4eC42CCbhoHDKzGggvhTiLjfW/hidden.json");
  }
