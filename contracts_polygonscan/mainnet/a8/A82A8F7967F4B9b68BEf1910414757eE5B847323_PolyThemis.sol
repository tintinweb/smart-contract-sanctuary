...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
...
contract PolyThemis is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PolyThemis";
    string constant _symbol = "PThemis";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + teamFee + buybackFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7313286cBDECA5893947E5479f66e1BCD8c4762E;
        teamFeeReceiver = 0x7313286cBDECA5893947E5479f66e1BCD8c4762E;
        buybackFeeReceiver = 0x7313286cBDECA5893947E5479f66e1BCD8c4762E;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != teamFeeReceiver  && recipient != autoLiquidityReceiver && recipient != buybackFeeReceiver){
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _buybackFee, uint256 _feeDenominator) external authorized {
        ...
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_teamFee).add(_buybackFee);
