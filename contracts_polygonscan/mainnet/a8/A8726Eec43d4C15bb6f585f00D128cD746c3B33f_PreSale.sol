...
contract PreSale is ERC20, Ownable, ERC1967Upgrade {


    uint32 private rr = 500000;
    uint32 private rg = 510000;

    mapping(address => uint256) public balances;
    IBancorFormula public bancorFormula = IBancorFormula(0x4D6B638411371875c1481E15CD82b33EBBc9A791);
    ...
    returns (uint256)
    {
        ...
        uint256 amountToken = bancorFormula.calculatePurchaseReturn(
            totalSupply(),
            collateral,
            rr,
            amount
    ...
    returns (uint256)
    {
        ...
        uint256 amountCollateral = bancorFormula.calculateSaleReturn(
            totalSupply(),
            collateral,
            rg,
            amount
