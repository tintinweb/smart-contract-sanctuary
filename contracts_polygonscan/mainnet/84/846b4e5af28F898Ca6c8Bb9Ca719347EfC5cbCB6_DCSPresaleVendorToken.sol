...
contract DCSPresaleVendorToken is Ownable, Pausable
{
    //========================
    // LIBS
    //========================
    ...
    uint256 public constant WHITELIST_PRESALE_DURATION = 0 hours; //1 days;
    ...
    IERC20 public wrappedBNB; //address of wrapped BNB
    ...
    constructor(
        IERC20 _wrappedBNB,
        address payable _receiver, //0xeadb9b5f12bbd6d15e367454dcf2ff17ecfb9f68
        uint256 _pricePerUnit, //699900000000000000
        uint256 _forSale
    )
    {
        ...
        //Cronos:   0xfA9343C3897324496A05fC75abeD6bAC29f8A40f
        //Polygon:  0xA649325Aa7C5093d12D6F98EB4378deAe68CE23F
        //Fantom:   0xD67de0e0a0Fd7b15dC8348Bb9BE742F3c5850454
        //Harmony:
    ...
    {
        return (wrappedBNB.allowance(_user, address(this)) != 0);
    }
    ...
    function buy(uint256 _amount) external whenNotPaused
    {
        //check amount & time
        ...
        //transfer       
        wrappedBNB.safeTransferFrom(msg.sender, receiver, getPriceForAmount(_amount)); 
