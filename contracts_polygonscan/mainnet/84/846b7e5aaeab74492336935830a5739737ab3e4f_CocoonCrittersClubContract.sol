  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableFees.push(uint256(90));
    
            payableAddresses.push(0xAa46dE2e9289435Fa68F6F5A4BE5e74ece649551);
            payableFees.push(uint256(5));
    ...
    // File: contracts/cocoonCrittersClubContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CocoonCrittersClubContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Cocoon Critters Club", "CCC", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmcuWijCF1MqNEuUnAtFikw8A7U51tg6m7qPMfzo81bv3j/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/GkIyHoIEQfRnXOKjyEvX/contract-metadata";
        }
    }