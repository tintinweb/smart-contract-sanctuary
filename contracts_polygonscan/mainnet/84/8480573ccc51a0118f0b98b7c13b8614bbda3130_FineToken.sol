 ...
 * manner, since when dealing with GSN meta-transactions account sending and
...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 constant MAXCAPSUPPLY = 5700 * (10 ** 18);
...
// FineToken.
contract FineToken is BEP20('PolyFine', 'FINE') {
