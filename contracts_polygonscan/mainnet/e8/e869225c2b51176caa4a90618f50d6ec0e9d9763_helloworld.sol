...
contract helloworld is Owned{
    ...
    function EthQuickToSushi(address[] memory path1,address[] memory path2)public payable onlyOwner{
        ...
        SwapEthToUsdcByQuick(min,path1);
        // path[0] = usdc;
        // path[1] = weth;
        min = amountOUT.mul(7).div(10);
        SwapUsdcToEthBySushi(amountOUT,min,path2);
    }
