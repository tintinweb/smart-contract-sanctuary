...
contract Door is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Door To Nostalgia", "DOOR") {
    setHiddenMetadataUri("ipfs://QmeSLmkewSKrmAitC9wHxyYZcaT21LvV13xmiRztZoAgLU/hidden.json");
  }
