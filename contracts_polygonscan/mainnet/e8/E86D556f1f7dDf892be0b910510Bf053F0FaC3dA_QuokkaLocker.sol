...
contract QuokkaLocker is ILocker {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    address public quokka;
    ...
    function lock(address _account, uint256 _amount) external override {
        ...
        IBEP20(quokka).safeTransferFrom(msg.sender, address(this), _amount);
    ...
    function unlock() external override {
        ...
        IBEP20(quokka).safeTransfer(msg.sender, _amount);
