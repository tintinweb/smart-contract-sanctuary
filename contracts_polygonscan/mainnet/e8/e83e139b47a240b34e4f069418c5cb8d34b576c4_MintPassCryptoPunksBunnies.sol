...
contract MintPassCryptoPunksBunnies is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("MintPass to CryptoPunksBunnies", "MintPassCPB")  {
        setBaseURI(baseURI);
    }
    ...
    function MintPass(address[] memory _addresses) public onlyOwner {
