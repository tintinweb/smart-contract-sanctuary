...
pragma solidity ^0.6.12;
    ...
    contract FootieV2 is Context, IERC20, Ownable {
        ...
        string private _name = 'FOOTIE+V2';
        string private _symbol = 'FOOTIEV2';
        uint8 private _decimals = 9;

        uint256 private _taxFee = 7;
        uint256 private _MarketingPoolFee = 3;
        ...
        uint256 private _numOfTokensToExchangeForMarketingPool = 1 * 10**5 * 10**9;
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 0 && taxFee <= 6, 'taxFee should be in 0 - 8');
            _taxFee = taxFee;
        }

        function _setMarketingPoolFee(uint256 MarketingPoolFee) external onlyOwner() {
            require(MarketingPoolFee >= 0 && MarketingPoolFee <= 4, 'MarketingPoolFee should be in 0 - 4');
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 1000000 , 'maxTxAmount should be greater than 1000000');
