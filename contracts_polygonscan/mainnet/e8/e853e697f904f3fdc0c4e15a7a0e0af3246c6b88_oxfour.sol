...
* 
* 0x4 Instant staking and burn on each transaction
* 4% tax (2% burn, 2% auto distributed to holders)
* 
*/
...
contract oxfour is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 40000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = '0x4';
    string private constant _symbol = '0x4';

    uint256 private _taxFee = 200;
    uint256 private _burnFee = 200;
    uint public max_tx_size = 40000 ether;
