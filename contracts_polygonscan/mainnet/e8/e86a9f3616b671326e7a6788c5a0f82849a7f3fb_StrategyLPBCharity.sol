...
// File: Vault\libs\IBCharity.sol


// For interacting with PolycatFinance masterchef
interface IBCharity {
    // Transfer want tokens vault -> bcharity masterchef
...
contract StrategyLPBCharity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(    
        ...
        earnedToSiriusPath = [0x9Bbcda2606e616659b118399A2823E8a392f55DA, address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), 0xB1289f48E8d8Ad1532e83A8961f6E8b5a134661D];
        earnedToToken0Path= [0x9Bbcda2606e616659b118399A2823E8a392f55DA, address(0x831753DD7087CaC61aB5644b308642cc1c33Dc13)];
        earnedToToken1Path= [0x9Bbcda2606e616659b118399A2823E8a392f55DA];
        token0ToEarnedPath = [address(0x831753DD7087CaC61aB5644b308642cc1c33Dc13), 0x9Bbcda2606e616659b118399A2823E8a392f55DA];
        token1ToEarnedPath = [0x9Bbcda2606e616659b118399A2823E8a392f55DA];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x831753DD7087CaC61aB5644b308642cc1c33Dc13)];
        wmaticToToken1Path =  [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), 0x9Bbcda2606e616659b118399A2823E8a392f55DA];
    ...
    function harvest() internal virtual override{
        //Polycat has no harvest function but harvest if you withdraw 0
