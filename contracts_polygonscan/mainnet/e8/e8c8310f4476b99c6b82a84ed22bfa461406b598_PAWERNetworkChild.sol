...
// File: contracts/PAWERNetworkChild.sol
...
contract PAWERNetworkChild is Initializable, ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address owner, address childChainManager) initializer public {
