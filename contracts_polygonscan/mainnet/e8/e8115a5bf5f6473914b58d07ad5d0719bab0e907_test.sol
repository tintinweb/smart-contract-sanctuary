...
library Address {
     ...
     * of certain opcodes, possibly making contracts go over the 2800 gas limit
...
contract test is Context, IERC20, Ownable {
    ...
    string private _name = "tzz";
    string private _symbol = "tz";
    ...
    address public ownerAddres = address(0x6700eA057fb69f13f060937D24E97cAa5a157945);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x682f6852F7dD1c07A9A5B7AdaD2bE6485f9DC666, 'We can not exclude Uniswap router.');
