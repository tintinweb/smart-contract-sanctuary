...
// FenixToken
contract FenixToken is ERC20('SURF', 'SURF'), ReentrancyGuard, Ownable {

    address public constant feeAddress = 0xc2057C9eaa6C5c3a18aB594023C5C067fFb40812;
    ...
    uint256 public constant maxFenixPurchase = 10000 * (10 ** 18);
    ...
    function buyFenix() external payable nonReentrant {
        ...
        require(fenixRemaining > 0, "No more SURF remaining! Come back next time!");
        require(IERC20(address(this)).balanceOf(address(this)) > 0, "No more SURF left! Come back next time!");
        require(msg.value > 0, "not enough matic provided");
        require(msg.value <= 3e22, "too much matic provided");
        require(userFenixTally[msg.sender] < maxFenixPurchase, "user has already purchased too much SURF");
