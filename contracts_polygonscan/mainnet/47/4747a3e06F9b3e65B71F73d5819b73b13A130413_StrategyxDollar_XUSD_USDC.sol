...
import "../xDollarLPStrategy.sol";

contract StrategyxDollar_XUSD_USDC is xDollarLPStrategy {
    ...
    function initializeStrategy(
        ...
        address xusd = address(0x3A3e7650f8B9f667dA98F236010fBf44Ee4B2975);
...
/// @title xDollar LP Strategy 
/// @author Chainvisions + modification by jlontele
/// @notice Strategy for xDollar xusd-usdc LPs on Polycrystal Farm.

contract xDollarLPStrategy is BaseUpgradeableStrategy {
    ...
    public initializer {
        ...
        require(lpaddress == underlying(), "xDollarLPStrategy: Pool does not match with underlying");
        _setPoolId(_pid);
