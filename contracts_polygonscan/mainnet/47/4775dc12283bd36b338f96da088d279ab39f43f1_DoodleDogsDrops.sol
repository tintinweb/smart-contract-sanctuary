...
/*
 *   Doodle Dogs Drops is an ERC-1155 Smart Contract
 *   Deployed on the Polygon Layer-2 Ethereum network
 *   It was created for the Doodle Dogs project by Ryan Meyers (@sreyeMnayR)
...
// File: DoodleDogDrops.sol


// Doodle Dogs Drops (DoodleDogDrops.sol)
...
contract DoodleDogsDrops is ERC1155, ERC2981, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("ipfs://{id}.json") {
        ...
        _setDefaultRoyalty(0xF8769bCd58099aFa41E58Ff060BCD2cA664387F5, 1000);
    }
