...
abstract contract BaseStrategyCurve is BaseStrategy {
    address public pool;
...
//Strategy for Curve pools that harvest WMATIC and sell it for more underlying
abstract contract BaseStrategyCurveWmatic is BaseStrategyCurve {
        ...
        )
    {
        ...
        IERC20(USDC).safeApprove(_pool, uint256(-1));
    ...
    function harvest() public override onlyHumanOrWhitelisted nonReentrant {
        ...
        //Deposit USDC in pool to get am3CRV
        ...
        if (_usdcBalance > 0) {
            ...
            ICurvePool(pool).add_liquidity([0, _usdcBalance, 0], 0, true); //deposit amount too low to exploit with flash loans
        }
    ...
    //Not sure if this function needs to be called to claim CRV with new gauge
    function getRewardCRV() external onlyHumanOrWhitelisted {
        ICurveGauge(rewards).claimable_reward_write(address(this), CRV);
    }

    //Performance fee isn't deducted from earned CRV
    function crvToWant() public onlyHumanOrWhitelisted {
        ...
        if (_usdcBalance > 0) {
            //IERC20(USDC).safeApprove(pool, 0);
            //IERC20(USDC).safeApprove(pool, _usdcBalance);
            ICurvePool(pool).add_liquidity([0, _usdcBalance, 0], 0, true);
        }
    }
...
contract CurveStrategy is BaseStrategyCurveWmatic {

    //0x19793B454D3AfC7b454F206Ffe95aDE26cA6912c Curve.fi am3CRV-gauge 2
    //0x445FE580eF8d70FF569aB36e80c647af338db351 mintr contract
    //0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171 Curve.fi am3CRV
    //0x01fE07ce760DA7a025e4Cf3f950aE236F8e62120 Fee Dist Fund
    constructor()
        public
        BaseStrategyCurveWmatic(
            0x19793B454D3AfC7b454F206Ffe95aDE26cA6912c,
            0x445FE580eF8d70FF569aB36e80c647af338db351,
            0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171,
            0x01fE07ce760DA7a025e4Cf3f950aE236F8e62120
        )
    {
