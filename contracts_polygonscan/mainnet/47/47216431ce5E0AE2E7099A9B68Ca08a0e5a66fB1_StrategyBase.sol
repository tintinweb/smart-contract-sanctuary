...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 27;
    ...
    // Uniswap swap paths
    address[] public pswamp_usdt_path;
        ...
        )
    {
        ...
        pswamp_usdt_path = new address[](4);
        pswamp_usdt_path[0] = pswamp;
        pswamp_usdt_path[1] = matic;
        pswamp_usdt_path[2] = usdc;
        pswamp_usdt_path[3] = usdt;
    }
    ...
    function harvest() public override {
        ...
        if (_pswampBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(pswamp_usdt_path, _pswampBalancePost);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public USDT_USDC_LP = 0x2cF7252e74036d1Da831d11089D326296e64a728;
