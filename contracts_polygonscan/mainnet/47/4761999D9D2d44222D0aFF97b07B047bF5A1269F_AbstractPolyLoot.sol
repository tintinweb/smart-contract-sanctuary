 ...
 */
contract AbstractPolyLoot is ERC721, ReentrancyGuard, Ownable {
    using SafeMath for uint256;

    string public PROVENANCE = "";
    uint256 public lootersPrice = 20000000000000000000; //0.10 ETH
    uint256 public publicPrice = 200000000000000000000; //0.1 ETH
    bool public saleIsActive = true;
    bool public privateSale = true;

    //Loot Contract
    address public lootAddress = 0xdf1AC9A9e4Cba4F20633970b3950C5230a8B048d;
    LootInterface lootContract = LootInterface(lootAddress);

    constructor() ERC721("AbstractPolyLoot", "APL") {
    }
