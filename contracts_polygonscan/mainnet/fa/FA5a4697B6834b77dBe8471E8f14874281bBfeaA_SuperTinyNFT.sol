...
contract SuperTinyNFT is BNFT, ISuperTinyNFT, ReentrancyGuard {
    using Address for address;
    ...
    constructor() BNFT(_msgSender(), "https://api.tinyhero.io/static/nft/SuperHero", "SuperTiny NFT", "SuperTiny") {
    }
