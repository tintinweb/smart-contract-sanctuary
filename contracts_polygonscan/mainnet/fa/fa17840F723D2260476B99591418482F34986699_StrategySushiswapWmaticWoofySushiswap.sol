...
// File: Vault\StrategySushiswapWmaticWoofySushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapWmaticWoofySushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00d0660cd418a64a1d44e9214ad8e459324d8157f1)];
        ...
        token1ToEarnedPath = [address(0x00d0660cd418a64a1d44e9214ad8e459324d8157f1), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00d0660cd418a64a1d44e9214ad8e459324d8157f1)];
    }
