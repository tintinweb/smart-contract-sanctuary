...
// File: Vault\StrategyPolypulsarGbntPolycat.sol

// openzeppelin v3.1.0

contract StrategyPolypulsarGbntPolycat is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x008c9aaca6e712e2193acccbac1a024e09fb226e51)];
        wantToEarnedPath = [address(0x008c9aaca6e712e2193acccbac1a024e09fb226e51), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
    }
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 amount, , , ) = IPolypulsar(masterChef).userInfo(pid, address(this));
        return amount;
    }
}