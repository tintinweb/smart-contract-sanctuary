...
// File: contracts/MaticMetasaurs.sol
...
contract MaticMetasaurs is ERC721, Ownable {
    // public mint price
    ...
    // MaticMetasaurs max items
    uint public maxItems = 8888;

    // MaticMetasaurs max mint pass items
    uint public mintPassMaxItems = 500;

    // MaticMetasaurs max mint pass items per anddress
    ...
    string public _baseTokenURI = "https://api.metasaurs.com/metadata/";
    ...
    constructor() ERC721("MaticMetasaurs", "MMTS") {}
