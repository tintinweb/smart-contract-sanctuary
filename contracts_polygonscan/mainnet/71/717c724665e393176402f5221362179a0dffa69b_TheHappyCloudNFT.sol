    ...
    ContextMixin
{
    ...
    constructor() public ERC721("TheHappyCloud", "THC") {
        _setBaseURI("https://ipfs.io/ipfs/QmR8P3y8CoX4CCCGMcE9QzjL68K6bCg2GF6xHZ2YyZtXEa/");
        _setupContractId("TheHappyCloud");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
        _initializeEIP712("TheHappyCloud");
        mintBatch(100);
    }

    function mintBatch(uint256 tokens) public only(DEFAULT_ADMIN_ROLE) {
        uint256 i = 1 + totalSupply();
        require(tokens <= 250, "TheHappyCloud: EXCEEDS_MAX_MINT");
        require(tokens <= 10000, "TheHappyCloud: EXCEEDS_TOTAL_SUPPLY");
        while (i <= tokens) {
         mint(msgSender(), i);
         i++;
        }
