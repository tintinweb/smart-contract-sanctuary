...
// File: Vault\StrategyQuickswapPolydogeQuickQuickswap.sol

contract StrategyQuickswapPolydogeQuickQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x008a953cfe442c5e8855cc6c61b1293fa648bae472)];
        token0ToEarnedPath = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token1ToEarnedPath = [address(0x008a953cfe442c5e8855cc6c61b1293fa648bae472), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
