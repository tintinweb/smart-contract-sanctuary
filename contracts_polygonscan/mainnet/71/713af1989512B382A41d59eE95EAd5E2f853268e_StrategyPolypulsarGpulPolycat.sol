...
// File: Vault\StrategyPolypulsarGpulPolycat.sol

// openzeppelin v3.1.0

contract StrategyPolypulsarGpulPolycat is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
        wantToEarnedPath = [address(0x0040ed0565ecfb14ebcdfe972624ff2364933a8ce3)];
    }
