...
contract ETHVault is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        token = IERC20(0x7c76B6B3FE14831A39C0fec908DA5f17180df677);
        masterchef = _masterchef;
        admin = msg.sender;
        treasury = msg.sender;

        // Infinite approve
        IERC20(0x7c76B6B3FE14831A39C0fec908DA5f17180df677).safeApprove(address(_masterchef), uint256(-1));
        IERC20(0x7c76B6B3FE14831A39C0fec908DA5f17180df677).safeApprove(address(msg.sender), uint256(-1));
