...
contract IPO 

   {
    ...
    function claimTokens() public {
        ...
        uint256 redeemtokens = userInvested[msg.sender] * outTokenPerInToken;
    ...
    function remainingClaim(address _address) public view returns (uint256) {
        ...
        uint256 redeemtokens = userInvested[_address] * outTokenPerInToken;
    ...
    function initializeIPO(address _inputtoken, address _outputtoken, uint256 _startTime, uint256 _inTokenClaimTime, uint256 _endtime, uint256 _outTokenPerInToken, uint256 _maxinvestment, uint256 _minInvestment) public onlyOwner {
