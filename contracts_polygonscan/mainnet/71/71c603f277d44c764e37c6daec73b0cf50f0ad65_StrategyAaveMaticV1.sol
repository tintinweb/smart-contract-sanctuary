...
abstract contract StrategyBase {
    ...
    function figureOutPath(address _from, address _to, uint256 _amount) public view returns (bool useSushi, address[] memory swapPath){
        ...
        if (_to == mmToken && buybackEnabled == true) {
            ...
            if (_from == weth || _to == weth || _from == WMATIC || _to == WMATIC) {
                path = new address[](2);
                path[0] = _from;
                path[1] = _to;
            }else{
...
contract StrategyAaveMaticV1 is StrategyBase, Exponential {
    ...
    public StrategyBase(WMATIC, _governance, _strategist, _controller, _timelock)
    {
        ...
        univ2Router2 = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; //quick swap
        sushiRouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;//sushi swap
        mmToken = 0x2E220744f9aC1BF3045B0588D339F5fD3bB8623A;
    }
    ...
    // 2. Supply <X> MATIC
    function leverageUntil(uint256 _supplyAmount) public onlyBenignCallers {
        ...
        while (supplied < _supplyAmount) {
            ...
            IWETHGateway(gateWay).borrowETH(lendingPool, _borrowAndSupply, 2, 0);
    ...
    function deleverageUntil(uint256 _supplyAmount) public onlyBenignCallers {
        ...
        do {
            ...
            IWETHGateway(gateWay).repayETH{value: _redeemAndRepay}(lendingPool, _redeemAndRepay, 2, address(this));
