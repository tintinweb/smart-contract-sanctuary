...
// File: contracts/InstadappToken.sol
...
contract InstadappToken is BEP20('Instadapp', 'INST') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTINST::transfer: Burn value invalid");
