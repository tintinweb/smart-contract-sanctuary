...
contract StrategyUsdcDaiSushiLP is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        ...
        if (toOutput > 0) {
            IUniswapV2Router02(unirouter).swapExactTokensForTokens(toOutput, 0, nativeToOutputRoute, address(this), now);
        }
        
        uint256 toNative = IERC20(output).balanceOf(address(this)).mul(45).div(1000);
        IUniswapV2Router02(unirouter).swapExactTokensForTokens(toNative, 0, outputToNativeRoute, address(this), now);
