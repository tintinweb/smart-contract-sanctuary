	...
	Ownable
{
	...
	// Contract name
	string public constant name = "PolkaPets Base Set";
	// Contract symbol
	string public constant symbol = "PPBS";
    string private constant _uri = "https://api.ppw.digital/api/polygon-item/";

	constructor() public ERC1155(_uri) {
		_setupContractId("PolkaPets Base Set");
		_setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
		_setupRole(PREDICATE_ROLE, _msgSender());
		_initializeEIP712("PolkaPets Base Set");
	}
