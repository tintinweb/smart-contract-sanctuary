...
contract ParkPics is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function _setURIbase(string memory newUriBase) internal {
        _uriBase = newUriBase;
    }
    ...
    // Optional: Maintain flexiblity to expand collection.
    /** function updateTokenSupply(uint256 newTokenSupply) external onlyOwner {
        _tokenSupply = newTokenSupply;
    }*/

    function uri(uint256 tokenId) override public view returns (string memory) {
        require(tokenId >= 1 && tokenId <= _tokenSupply, "ERC1155Metadata: URI query for nonexistent token");
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // Signals frozen metadata to OpenSea; emitted in mint functions
    ...
    constructor(string memory uri_) {
        _setURI(uri_);
        // Set metadata pin for uri override
        _uriBase = "ipfs://bafybeicvbipj7n6zkphi7u5tu4gmu7oubi7nt5s2fjvkzxn7ggr4fjv2jy/";
    }
