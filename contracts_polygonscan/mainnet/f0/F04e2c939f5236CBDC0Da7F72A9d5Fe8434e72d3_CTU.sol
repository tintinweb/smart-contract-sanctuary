...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "CRYPTO TRADER UNITED";
    string internal constant SYMBOL = "CTU";
    ...
    uint256 internal constant TOTAL_SUPPLY = 99999999 * 10 ** 7 * ZEROES;
