...
contract BasegenesisStrategyLP is StratManager, FeeManager {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address public input = 0x2cF7252e74036d1Da831d11089D326296e64a728; //USDC-USDT LP
    ...
    address constant public wbtc = 0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6; //WBTC

    address public lpToken0;
    address public lpToken1;

    // Third party contracts
    address constant public masterchef = 0x2972175e1a35C403B5596354D6459C34Ae6A1070; // Quickswap Staking Contract
    ...
    constructor(
        ...
        outputToLp0Route = new address[](3);
        outputToLp0Route[0]= output;
        outputToLp0Route[1]= wmatic;
        outputToLp0Route[2]= lpToken0;
        ...
        lpToken0DustToUsdcRoute[1] = wmatic;
