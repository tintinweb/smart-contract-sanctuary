...
contract KommunitasProject{
    ...
    function initialize(
        ...
        booster[0].start = 1636707600;
        booster[0].end = 1636722000;
        booster[0].price = _price[0].mul(10**payment.decimals()).div(1e6);
        booster[0].achieve = 586986434857142857142751;
        
        booster[1].start = 1636725600;
        booster[1].end = booster[1].start.add(43200);
        booster[1].price = _price[1].mul(10**payment.decimals()).div(1e6);
        booster[1].achieve = 0;
        
        booster[2].start = booster[1].end.add(1);
        booster[2].end = booster[2].start.add(28800);
        booster[2].price = _price[2].mul(10**payment.decimals()).div(1e6);
        booster[2].achieve = 0;
        
        require(_tge > booster[2].end, "Token Generation Event must be started after public round ended");
        
        sold = 586986434857142857142751;
        tge = _tge;
        fee = _fee;
