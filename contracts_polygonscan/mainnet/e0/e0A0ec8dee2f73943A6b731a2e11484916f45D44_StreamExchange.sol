...
library StreamExchangeHelper {
  ...
  function _emergencyDrain(StreamExchangeStorage.StreamExchange storage self) public {
    ...
    require(self.inputToken.transfer(self.owner, self.outputToken.balanceOf(address(this))), "!inputDraining");
  }
...

{
  ...
  "libraries": {
    "contracts/StreamExchangeHelper.sol": {
      "StreamExchangeHelper": "0xac3eff137e65610808701102aed0ec9bbfc96cc4"
    }
  }
}