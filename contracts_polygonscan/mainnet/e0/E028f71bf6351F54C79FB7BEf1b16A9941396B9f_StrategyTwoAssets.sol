...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    address public constant token2 = 0xc2132D05D31c914a87C6611C10748AEb04B58e8F;
    ...
    {
        pwings_token1_path = new address[](2);
        pwings_token1_path[0] = pwings;
        pwings_token1_path[1] = token1;

        pwings_token2_path = new address[](3);
        pwings_token2_path[0] = pwings;
        pwings_token2_path[1] = token1;
        pwings_token2_path[2] = token2;
    }
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public MATIC_USDT_LP = 0x101640e107C4a72DeC79826768C239F1eB48cc85;
