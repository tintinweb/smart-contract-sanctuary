...
// File: contracts/EnvimarsFinanceTokenToken.sol
...
contract EnvimarsFinance is BEP20('EnvimarsFinance', 'Emi') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTEmi::transfer: Burn value invalid");
