...
/**
 * @title PoS
 * PoS - Smart contract for https://proofofstory.io characters.
 */
contract PoS is ERC721, Ownable {

    mapping(uint256 => string) private _nftRoles;
    ...
    string public notrevealed_nft = "https://api.proofofstory.io/nfts/hidden.json";
    string public contract_base_uri = "https://api.proofofstory.io/nfts/";
    ...
    */
    ...
    function returnRoleByTokenId(uint256 tokenId) public view returns (string memory) {
        return _nftRoles[tokenId];
    }
    ...
    */
    function proxyMintNFT(address _to)
        public
    {
        require(isMinter(msg.sender), "PoS: Only minters can mint");
        uint256 reached = _tokenIdCounter.current() + 1;
        require(reached <= HARD_CAP, "PoS: Hard cap reached");
    ...
    */
    function revealNFT(uint256 _tokenId) public returns (bool) {
        require(ownerOf(_tokenId) == msg.sender || isMinter(msg.sender), "PoS: You must own the NFT");
    ...
    function setRole(uint256 tokenId, string memory _role) public {
        require(isMinter(msg.sender), "PoS: Only minters can set role");
        _nftRoles[tokenId] = _role;
    }
