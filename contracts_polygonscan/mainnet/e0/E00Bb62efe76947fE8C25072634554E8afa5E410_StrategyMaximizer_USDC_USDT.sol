...
contract StrategyMaximizer_USDC_USDT is GravityMaximizer {

    address usdc_usdt_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0xe3bC11531D78Ce351Db9D2f0eC270B863FaC1C07);
        address usdc_usdt_lp = address(0x42286296C3edE3f6a0ec4e687939b017408Cf321);
