...
// File: @openzeppelin/contracts-upgradeable/utils/TimersUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable/governance/IGovernorUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable/governance/extensions/GovernorVotesUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable/governance/extensions/GovernorVotesQuorumFractionUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable/governance/extensions/GovernorCountingSimpleUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable/governance/extensions/GovernorProposalThresholdUpgradeable.sol
...
contract HavenXVoteManager is Initializable, GovernorUpgradeable, GovernorProposalThresholdUpgradeable, GovernorCountingSimpleUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize(ERC20VotesUpgradeable _token) initializer public {
        __Governor_init("HavenXVoteManager");
    ...
    function propose(address[] memory targets, uint256[] memory values, bytes[] memory calldatas, string memory description)
        public
        override(GovernorUpgradeable, GovernorProposalThresholdUpgradeable)
        returns (uint256)
    {
        return super.propose(targets, values, calldatas, description);
    }
