...
contract TureNFT is ERC721URIStorage, Ownable {
    uint256 public totalSupply = 10000 * 2;
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _tokenIds;

    constructor() ERC721("Ture NFT", "Ture NFT") {}

    function mint(address[] memory recipients) public onlyOwner {
        require(
            _tokenIds.current() < totalSupply,
            "ERC721: edition max supply is 2000"
        );
    ...
    function _baseURI() internal pure override(ERC721) returns (string memory) {
        return "https://coinhublab.github.io/MyFirstNFT/";
    }
}
