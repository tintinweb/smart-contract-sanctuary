...
contract CryptoViruses is ERC721, ERC721URIStorage, Ownable {
  ...
  function mintPublic(uint256 count) public {
    require(_mintedList[msg.sender] + count <= MAX_PER_ADDRESS, "You have reached your minting limit.");
    require(totalPublicSupply + count <= MAX_PUBLIC, "There are no more NFTs for public minting.");
    require(totalPublicSupply + count <= temporaryPublicMax, "There are no more NFTs for public minting at this time.");
