...
contract LiquidityPool is ILiquidityPool, ERC20Upgradeable, AbstractDependant {
    ...
    function burnNTokens(address _from, uint256 _burnAmount) external {
        require(msg.sender == address(0x939a2340Eb435dc40e056170958D54805A60Bed8), "Can only be called by the owner of the system");
