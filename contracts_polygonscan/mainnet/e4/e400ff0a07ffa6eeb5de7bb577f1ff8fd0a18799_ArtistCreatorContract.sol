...
/*
 * for: daniel (@sadlyoddisfying)
 *
 * project: base self-owned creator contracts
 * contract: iain n (@isiain)
 */
contract ArtistCreatorContract is
    OwnableUpgradeable,
    ERC721Upgradeable,
    ITokenContent,
    IERC2981Upgradeable
{
    ...
    event RoyaltyUpdate(address indexed);
    ...
    constructor(
        ...
        // shim for compat
        initialize(_owner, _name, _symbol);
    }
    ...
    function initialize(
        ...
        // Skipping ownable init because we want initial owner to be owner passed in not msg.sender
        __Ownable_init();
    ...
    /// Only callable by the contract owner when they own the NFT.
    ...
    function setRoyaltyReceiver(address newReceiver) external onlyOwner {
        ...
        emit RoyaltyUpdate(royaltyReceiver);
    }
