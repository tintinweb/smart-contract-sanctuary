...
contract test {
    ...
    uint public constant TOKEN_LIMIT = 100; // 8 for testing, 256 or 512 for prod;
    uint public constant ARTIST_PRINTS = 2; // 2 for testing, 64 for prod;

    uint public constant PRICE = 1000 finney;

    address public constant BENEFICIARY = 0xA752C059d99dE10F36E05cceA86f7DeBE177e490;
