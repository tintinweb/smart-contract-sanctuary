...
contract NFT is ERC721URIStorage, IERC721Enumerable, Governance {
    ...
    constructor(address marketplaceAddress, address minterAddress, string memory name, string memory symbol) ERC721(name, symbol) {
    ...
    function updateMarketAddress(address marketplaceAddress) public onlyGovernance {
        contractAddress = marketplaceAddress;
    }
