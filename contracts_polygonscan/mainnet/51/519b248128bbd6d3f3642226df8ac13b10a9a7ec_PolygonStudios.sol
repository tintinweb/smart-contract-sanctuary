...
// File: contracts/PolygonStudiosToken.sol
...
contract PolygonStudios is BEP20('Polygon Studios', 'PolyStudios') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTPolyStudios::transfer: Burn value invalid");
