...
// File: contracts/SNFT.sol

pragma solidity >=0.4.22 <0.9.0;

contract Simba is ERC721Enumerable, Ownable {
  string BASE_URI;
  ...
  function buyNFT(uint256 amount) public payable {
    require(openToPublic, "SNFT: Not open to public yet");
    require(globalId < 10000, "SNFT: All minted");
    require(msg.value == amount * regularPrice, "SNFT: Incorrect value sent");
    require(globalId + amount <= 10000, "SNFT: Cannot mint amount");
    require(amount > 0 && amount <= 20, "SNFT: Max 20 per transaction");
  ...
  function mintNFT(uint256 amount, address to) public onlyOwner {
    require(teamMintCount < 100, "SNFT: Team mint max 100");
    require(
      teamMintCount + amount <= 100,
      "SNFT: Amount + team mint count invalid"
    );
