...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address[] public gfi_usdt_path;

    // Other constants
    uint256 public keepFXS = 100;
    uint256 public harvestCutoff = 10**17;
        ...
        )
    {
        ...
        gfi_usdt_path = new address[](3);
        gfi_usdt_path[0] = gfi;
        gfi_usdt_path[1] = usdc;
        gfi_usdt_path[2] = usdt;
    }
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            // Swap 1/2 GFI to USDC
            uint256 _harvestBalancePost = IERC20(rewardToken).balanceOf(address(this));
            _swapUniswapWithPath(gfi_usdc_path, _harvestBalancePost.div(2));

            // Swap 1/2 GFI to USDT
            uint256 _harvestBalancePost2 = IERC20(rewardToken).balanceOf(address(this));
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_usdt_path, _harvestBalancePost2);
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0xe3bC11531D78Ce351Db9D2f0eC270B863FaC1C07;
    address public Want_Token = 0x42286296C3edE3f6a0ec4e687939b017408Cf321;
