...
// File: contracts/BinamarsToken.sol
...
contract BinamarsToken is BEP20('PolygonBinamars', 'PolyBMARS') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTPolyBMARS::transfer: Burn value invalid");
