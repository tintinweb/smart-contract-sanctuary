...
contract FireFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x77357D9a57265EFc59E3aC6865Fa23241624af61); // Marketing Address
    ...
    uint256 private _tTotal = 25000 * 10**6 * 10**6;
    ...
    uint256 public _maxTxAmount = 3000 * 10**6 * 10**6;
