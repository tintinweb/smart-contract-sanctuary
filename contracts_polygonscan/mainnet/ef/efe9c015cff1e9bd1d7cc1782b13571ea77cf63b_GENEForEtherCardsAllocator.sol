...
contract GENEForEtherCardsAllocator is Ownable {
    ...
    IERC721                     public erc721;   // EtherCards
    IERC20                      public erc20;    // GENE Token
    bool                        public locked;
    uint256                     public unlockTime;
    address                     public donationAddress; // genomesdonation.eth
    ...
    constructor(address _erc721, address _erc20) {
        ...
        erc20 = IERC20(_erc20);
        donationAddress = 0xd715203915A1aABEF497c04b80Ed8622726A036f;

        // set card type values
        cardTypeAmounts[1] = 36000 ether;   // OG
        cardTypeAmounts[2] = 12000 ether;   // Alpha
        cardTypeAmounts[3] = 4000 ether;    // Founder

        // Fri Jan 21 2020 14:00:00 GMT+0000
        unlockTime = 1642773600;
    }

    function redeem(uint16[] calldata _tokenIds) public {
        claimTokens(_tokenIds, msg.sender);
    }

    function donate(uint16[] calldata _tokenIds) public {
        address _receiver = donationAddress; 
        claimTokens(_tokenIds, _receiver);
    }

    function claimTokens(uint16[] memory _tokenIds, address _receiver) internal {
        ...
        erc20.transfer(_receiver, totalAmount);
    }
    ...
    function update721Address(address _newAddress) external onlyOwner {
        erc721 = IERC721(_newAddress);
    }

    function updateDonationAddress(address _newAddress) external onlyOwner {
