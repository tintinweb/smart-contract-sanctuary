...
contract pTJCSwapAndBurn {
  ...
  receive() payable external {
    ...
    uint256 amountOut = getAmountOut(fullBalance.mul(7).div(10),resB,resA);
    ...
    uint256 amountDesired = getAmountOut(fullBalance.sub(swapedAmounts[0]),resB.add(swapedAmounts[0]),resA.sub(swapedAmounts[1]));
  ...
  function getAmountOut(uint256 value,uint256 resA,uint256 resB) public view returns(uint256){
    return(router.getAmountOut(value,resA,resB,0));
  }
