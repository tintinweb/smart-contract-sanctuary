...
contract Sniper is owned {
    
    address private constant UNISWAP_V2_ROUTER = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff;
    address private constant UNISWAP_V2_FACTORY = 0x5757371414417b8C6CAad45bAeF941aBc7d3Ab32;
    ...
    function swap(address _tokenOut, address _tokenIn, uint _amountIn) external {
        ...
        uint256 amountOutMins = IUniswapV2Router(UNISWAP_V2_ROUTER).getAmountsOut(_amountIn, sellPath)[sellPath.length - 1];
