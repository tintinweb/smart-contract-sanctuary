...
// File: Vault\StrategyQuickswapGenesisQuickQuickswap.sol

contract StrategyQuickswapGenesisQuickQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
	
	address public dQuickAddress = 0xf28164A485B0B2C90639E47b0f377b4a438a16B1;
	
	address public genesisAddress = 0x51869836681BcE74a514625c856aFb697a013797;	
	address[] public genesisToQuickPath =[address(0x0051869836681BcE74a514625c856aFb697a013797), address(0x00831753DD7087CaC61aB5644b308642cc1c33Dc13)];
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x0051869836681BcE74a514625c856aFb697a013797)];
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token0ToEarnedPath = [address(0x0051869836681BcE74a514625c856aFb697a013797), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token1ToEarnedPath = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x0051869836681BcE74a514625c856aFb697a013797)];
    ...
    // Convert dQuick to Quick
	   ...
	   IDragonLair(dQuickAddress).leave(balance);
	   
	// Convert Genesis to Quick
	   balance = IERC20(genesisAddress).balanceOf(address(this));
	   _safeSwap(balance, genesisToQuickPath, address(this));
    }
