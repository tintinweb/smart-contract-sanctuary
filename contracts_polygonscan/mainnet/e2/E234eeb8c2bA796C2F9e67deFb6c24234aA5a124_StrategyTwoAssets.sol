...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        eth_route_path = new address[](2);
        eth_route_path[0] = eth;
        eth_route_path[1] = route;
    }
    ...
    function harvest() public override {
        ...
        if (_dinoBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(eth_route_path, _ethBalancePost.div(2));
            ...
            if (_eth > 0 && _route > 0) {
                ...
                IERC20(route).safeTransfer(
                    strategist,
                    IERC20(route).balanceOf(address(this))
                );
            }
        }
        // Stake the LP tokens
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public Eth_Route_LP = 0xeBC4f9B1cE66258AC3A48578FFEEba1330dDB68B;
