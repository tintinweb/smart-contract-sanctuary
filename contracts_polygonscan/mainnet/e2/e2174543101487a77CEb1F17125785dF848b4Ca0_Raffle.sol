...
contract Raffle is VRFConsumerBase {
    ...
    function enterRaffle(uint256 nPenguins) public payable {
        ...
        currentEntries[msg.sender] = currentEntries[msg.sender] + nPenguins;
        ...
        playerPower[msg.sender] = playerPower[msg.sender] + nPenguins;
