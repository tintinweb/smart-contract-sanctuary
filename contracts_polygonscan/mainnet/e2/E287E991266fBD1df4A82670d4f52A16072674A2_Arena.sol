...
contract Arena is Ownable, ERC721Holder {
    ...
    struct Cycle {
        ...
        mapping (address => mapping (uint => uint16)) actions;
        //1 - attack
    }
    ...
    uint16 public actionTime = 25 * 2; // 2 min for action
    ...
    function fight(address enemy) public {
        ...
        require(cycle.actions[msg.sender][actionIndex] == 0, "Already made action");
        ...
        cycle.actions[msg.sender][actionIndex] = 1;// attack Action
        ...
        for (uint8 i=0;i<3;i++) {
            ...
            if (getActionIndex() > 0 && cycle.actions[enemy][getActionIndex()] == 0) {
