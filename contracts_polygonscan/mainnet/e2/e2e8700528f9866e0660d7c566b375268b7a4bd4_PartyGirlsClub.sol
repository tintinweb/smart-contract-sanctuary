...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata{
    ...
    // metadata api
    string baseUri = "ipfs://QmQ83sU1RYVKvUXWGKyvxdoEHaDinGGJWM6zMRmptQgyxS/"; 
 ...
 contract PartyGirlsClub is ERC721, Ownable{
     
    uint256 public totalSupply = 0; // Total Supply
    uint256 private constant totalSale = 3000; // for user minting
    uint256 private constant reserved = 20;  // for admin
    uint256 public mintPrice = 10 * 10 ** 18;  // minting price 10 MATIC
    ...
    constructor() ERC721("PartyGirlsClub", "PGC"){}
