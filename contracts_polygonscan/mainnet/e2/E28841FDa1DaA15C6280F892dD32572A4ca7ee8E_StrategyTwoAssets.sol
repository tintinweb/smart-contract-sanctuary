...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        matic_bnb_path = new address[](2);
        matic_bnb_path[0] = matic;
        matic_bnb_path[1] = bnb;
    }
    ...
    function harvest() public override {
        ...
        if (_maticBalance > harvestCutoffMatic){
            ...
            _swapUniswapWithPath(matic_bnb_path, _maticBalancePost.div(2));

            // Add liquidity 
            uint256 _bnb = IERC20(bnb).balanceOf(address(this));
            uint256 _matic = IERC20(matic).balanceOf(address(this));
            if (_bnb > 0 && _matic > 0) {
                IERC20(bnb).safeApprove(currentRouter, 0);
                IERC20(bnb).safeApprove(currentRouter, _bnb);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public Matic_BNB_LP = 0x0359001070cF696D5993E0697335157a6f7dB289;
