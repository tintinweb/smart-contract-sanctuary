...
contract MOXbucks is Context, IERC20Metadata, Ownable { 
    ...
    function transferFromMarket(address sender, address recipient, uint256 amount, address firstOwner) external returns (bool) {
        _specialTransferMarket(sender, recipient, amount);
        ...
        //distribute reward for first owner
     ...
     */
    function _specialTransferMarket(address sender, address recipient, uint256 amount) internal virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
        ...
        emit Transfer(sender, recipient, amount.mul(100-DIST_PERC-FIRSTOWNER_PERC).div(100));
    }
     ...
     *
     */ 
    function changeFirstOwnerPerc(uint256 newPerc) public onlyOwner {
