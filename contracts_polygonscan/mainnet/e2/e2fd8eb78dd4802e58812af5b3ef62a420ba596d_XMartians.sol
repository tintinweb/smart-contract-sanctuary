...
contract XMartians is ERC721Enumerable, Ownable {
    ...
    /*
        1st mint cost payment split:
               ...
               5 .5% to 0xEFa7D0E06F13b135efB98Aa655F63CAC5D5f05Ab Preston;
               6 .5% to 0x416C3569673aD98D7946B490c5010D71a096030c Tiarnan;

        Transfer fee split for resales:
            .5% Preston 0xEFa7D0E06F13b135efB98Aa655F63CAC5D5f05Ab
            50% xMoony 0xd00f26915108dF339BF9B63Bd34a305052EefffB
            50% to 0xa1Dc531aA00F24665d06Ee7d3614C502c08DD964
            .5% Tiarnan 0x416C3569673aD98D7946B490c5010D71a096030c
    */
    ...
    function mintHyperRare(uint8 mintQty) public payable { _iterateMint(3, mintQty); }
     function mintCustom(uint8 mintQty) public payable { _iterateMint(4, mintQty); }
    ...
    function distributePayment() internal {
        ...
        uint256 splitF = address(this).balance*1/200;
        uint256 splitG = address(this).balance*1/200;
        ...
        Address.sendValue(payable(0xEFa7D0E06F13b135efB98Aa655F63CAC5D5f05Ab), splitF);
        Address.sendValue(payable(0x416C3569673aD98D7946B490c5010D71a096030c), splitG);

    }

    function sendResalePayments() internal {
        uint256 splitA = address(this).balance*5/1000;
        uint256 splitB = address(this).balance*495/1000;
        uint256 splitC = address(this).balance*495/1000;
        uint256 splitD = address(this).balance*5/1000;


        Address.sendValue(payable(0xEFa7D0E06F13b135efB98Aa655F63CAC5D5f05Ab), splitA);
