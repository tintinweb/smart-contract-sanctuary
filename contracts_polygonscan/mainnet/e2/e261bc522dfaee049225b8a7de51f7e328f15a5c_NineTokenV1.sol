...
// File: contracts/NIneTokenV1.sol
...
contract NineTokenV1 is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    address private royaltiesReceipient = 0xC7597030dC9d6C2E7325FF2674e3ca02F12aba36;

    constructor() ERC721("NineTokenV1", "NV1") {}

    
    // public
    function mint(address _to, uint256 _mintAmount, string memory _tokenUri) public payable {
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            setRoyalties(_tokenIdTracker.current(),payable(royaltiesReceipient),2500);
        ...
        returns (string memory)
    {
        ...
        return string(abi.encodePacked(tokenUrls[tokenId]));
    }
    ...
    function setTokenURI(uint256 _id, string memory _url) public onlyOwner {
        tokenUrls[_id] = _url;
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Enumerable) returns (bool) {
     ...
     function contractURI() public pure returns (string memory) {
        return "https://nft-opensea-sellerfee-json.photovideo2046.workers.dev/";
    }
