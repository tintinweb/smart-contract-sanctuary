...
contract StrategyLeveragedAAVE_DAI is BaseStrategy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;
    ...
    uint256 public minRebalanceAmount = 10000000000000000000; // 10$, should be changed based on decimals (dai has 18)
    ...
    function name() external view override returns (string memory) {
        ...
        return "Strategy-Levered-AAVE-DAI";
    }
