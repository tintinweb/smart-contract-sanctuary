...
// File contracts/TEXOOrchestrator.sol
...
contract TEXOOrchestrator is Ownable, ReentrancyGuard {
    ...
    uint256 public constant INITIAL_EMISSION_RATE = 0.35 ether; // 500 finney for bsc, 350 finney for polygon

    // Minimum emission rate: 0.1 tEXO per block.
    uint256 public constant MINIMUM_EMISSION_RATE = 0.07 ether; // 100 finney for bsc, 70 finney for polygon

    // Reduce emission every 28,800 blocks ~ 24 hours.
    uint256 public constant EMISSION_REDUCTION_PERIOD_BLOCKS = 43200; // 28800 block for bsc, 43200 block for polygon
