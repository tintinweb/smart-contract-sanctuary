...
/**
   #Freedom Coin $FRCO 
   2% fee auto added to liquidity(LIQUIDITY FEE)
   5% fee auto distributed to all hodlers(TAX)
   3% fee auto distributed to the charity wallet address
   2% fee auto sent to the dead wallet(BURN)
...
contract Freedom_Coin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 111111111111111111 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Freedom Coin";
    string private _symbol = "$FRCO";
    ...
    address public charityWallet = 0x35547c2E3E869a4BDc2400874d0fa589b19ACd06;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 0, "transaction amount should be greater than zero!");
