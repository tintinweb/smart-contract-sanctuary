...
contract BujiCrawler is ERC1155Supply, Ownable  {
    bool public saleIsActive = false;
    uint constant TOKEN_ID = 1;
    uint public constant MAX_TOKENS = 100;
    uint public constant TOKEN_PRICE = 125 ether;
    ...
    function whitelistFreeClaim() public {
        require(totalSupply(TOKEN_ID) + 1 <= MAX_TOKENS, "Purchase would exceed max supply of tokens");
        uint256 who = Whitelist[msg.sender];
        require(who > 0, 'This address is not whitelisted for free claim');
        Whitelist[msg.sender] = who - 1;
        _mint(msg.sender, TOKEN_ID, 1, "");
    }
