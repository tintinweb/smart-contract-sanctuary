...
// File contracts/ArtArmyDistributor.sol


pragma solidity ^0.8.0;


contract ArtArmyDistributor is Ownable  {
    ...
    event DistributorEvent(uint256 amount);
    ...
    */
     ...
     */
    function getDistribution(address account) public view virtual returns (uint256) {
        return _distribution[account];
    }
    ...
    */
    ...
    function distribute(uint256 amount, address wallet) external returns (bool){
        ...
        //It is necessary that the amount to be distributed does not exceed the balance of contract
        ...
        _token.transfer(address(wallet), amount);

        _distribution[wallet] = amount;
