...
contract NPT_PCCGame2 is VRFConsumerBase, Pausable, Ownable {
    ...
    constructor(
        ...
        slowMode = true;
        slowModeTime = 15 * 60; // 15 minute intervals between pack purchases

        packContents[PackTier.GOLD] = 7; // 7 Pieces per pack
        ...
        prizeFactory = new PrizeFactory(
            "NPT x PCC - Game 2 - Prizes",
            "NPTxPCCPrizes"
        );
        prizeFactory.transferOwnership(owner());

        pieceFactory = new PieceFactory(
            "NPT x PCC - Game 2 - Pieces",
            "NPTxPCCPieces"
        );
