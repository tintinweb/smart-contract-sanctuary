    ...
    function autoCompound() public {
        ...
        for (uint256 i; i < names.length; i++) {
            ...
            if (_amount > 0) {
                ...
                IERC20(WETH).safeApprove(strategyObj.liquidityRouter, 0);
                IERC20(WETH).safeApprove(strategyObj.liquidityRouter, type(uint256).max);
                IERC20(USDT).safeApprove(strategyObj.liquidityRouter, 0);
                IERC20(USDT).safeApprove(strategyObj.liquidityRouter, type(uint256).max);
