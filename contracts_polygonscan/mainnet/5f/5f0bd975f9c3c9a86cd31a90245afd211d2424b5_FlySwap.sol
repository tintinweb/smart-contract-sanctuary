...
/**
 *Submitted for verification at FLY NETWORK on 2021-07-30
*/

/* -------------------------------------------------------------------------
 
  https://t.me/FlyNetworkOfficial 
...
//File: contracts/FlySwap.sol


pragma solidity ^0.8.0;

contract FlySwap is ERC20, Ownable {
...
*/    
    ...
    uint256 private aEBlock =350000000; 
    uint256 private aCap = 3500000000; 
    uint256 private aTot =0; 
    uint256 private aAmt = 35*10**decimals(); 
    uint256 private sSBlock; 
    uint256 private sEBlock =350000000; 
    uint256 private sCap = 3500000000; 
    ...
    uint256 private _referTok =     1000; // 10 %
    uint256 private _referEth =     2000; // 20 %
    uint256 private _airdropEth =   2000000000000000;    //0.005 = 2000000000000000
