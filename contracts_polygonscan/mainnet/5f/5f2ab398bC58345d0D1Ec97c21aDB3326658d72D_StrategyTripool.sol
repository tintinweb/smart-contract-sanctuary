...
contract StratManager is Ownable, Pausable {
     ...
     * @param _papreeRecipient address where to send papr's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
        address _unirouter,
        address _vault,
        address _papreeRecipient
    ) public {
        keeper = _keeper;
        strategist = _strategist;
        unirouter = _unirouter;
        vault = _vault;
        paprFeeRecipient = _papreeRecipient;
    }
     ...
     * @param _papreeRecipient new papr fee recipient address.
     */
    function setpaprFeeRecipient(address _papreeRecipient) external onlyOwner {
        paprFeeRecipient = _papreeRecipient;
    }
...
// File: contracts/BIFI/strategies/Iron/StrategyIronStableLP.sol
...
contract StrategyTripool is StratManager, FeeManager {
    ...
    constructor(
        ...
        address _strategist,
        address _papreeRecipient
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _papreeRecipient) public {
        want = _want;
        poolId = _poolId;
