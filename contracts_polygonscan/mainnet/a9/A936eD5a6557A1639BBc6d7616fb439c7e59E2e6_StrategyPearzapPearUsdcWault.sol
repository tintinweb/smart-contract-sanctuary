...
// File: Vault\StrategyPearzapPearUsdcWault.sol

// openzeppelin v3.1.0

contract StrategyPearzapPearUsdcWault is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToToken1Path = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
        token0ToEarnedPath = [address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
