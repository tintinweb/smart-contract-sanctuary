...
contract FishToken is ERC20PresetMinterPauser {
     ...
     constructor(string memory name, string memory symbol, uint256 amount, address _initWallet) ERC20PresetMinterPauser(name, symbol) {
        // Mint 100 tokens to msg.sender
        // Similar to how
        // 1 dollar = 100 cents
        // 1 token = 1 * (10 ** decimals)
        _mint(_initWallet, amount * 10**uint(decimals()));
    }
}