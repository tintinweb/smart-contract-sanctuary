...
contract RewardsDistributionRecipient {
	...
	function notifyRewardAmount(uint256 reward, uint256 endTime) external;
...
contract VaultDistributionRewards is
	IStakingRewards,
	...
	ReentrancyGuard
{
	...
	function notifyRewardAmount(uint256 reward, uint256 endTime)
		external
		onlyRewardsDistribution
		updateReward(address(0))
	{
		rewardsDuration = endTime.sub(block.timestamp);
