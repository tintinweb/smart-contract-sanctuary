...
The NFT Sprites token that this contract manages might be used in future to reward NFT Sprites owners.
...
contract NFTSpritesToken is ERC20PresetFixedSupply {
    constructor() ERC20PresetFixedSupply("A NFTSprites.com", "NFT Sprites", 1000000 * 10 ** 18, msg.sender) {
    }
}