...
/**
 *Submitted for verification at simba-play.org on
*/

/* -------------------------------------------------------------------------
    SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA
    $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA
    $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA PLAY SIMBA
...
//File: contracts/SimbaPlayRef.sol


pragma solidity ^0.8.0;

contract SIMBAPLAY is ERC20, Ownable {
...
*/    
    ...
    constructor() ERC20("SIMBA PLAY", "SIMBA") {
        _owner = msg.sender;
        _auth = _owner;
