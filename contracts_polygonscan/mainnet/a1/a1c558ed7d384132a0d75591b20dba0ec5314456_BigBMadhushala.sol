...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function updateTokenURI(uint256 tokenId, string memory metaData) external virtual override returns(bool) {
        require(msg.sender == operator,"ERC721 : caller is doesn't have operator role");
...
contract BigBMadhushala is ERC721 {
