...
contract Cthulhu is ERC721Enumerable, Ownable {
  ...
  // public
    ...
    function _updateAutoFloorPrice() internal {
        ...
        if(_totalSupply > 249) { _setPrice(52 ether ); }
        else if(_totalSupply > 499) { _setPrice(57 ether); }
        else if(_totalSupply > 749) { _setPrice(63 ether ); }
        else if(_totalSupply > 999) { _setPrice(69 ether ); }
        else if(_totalSupply > 1249) { _setPrice(76 ether ); }
        else if(_totalSupply > 1499) { _setPrice(84 ether ); }
        else if(_totalSupply > 1749) { _setPrice(92 ether ); }
        else if(_totalSupply > 1999) { _setPrice(101 ether ); }
        else if(_totalSupply > 2249) { _setPrice(112 ether ); }
