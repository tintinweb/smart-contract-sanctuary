...
contract StrategyDfynRouterLP is StratManager, FeeManager {
    ...
    constructor() public {
        ...
        want = 0xB0dc320ea9eea823a150763AbB4A7bA8286Cd08B; // dfyn double pair
        ...
        masterchef = 0xf997c8e2e7e7387C8fd9120280ad9B3db31A5381; // dfyn Masterchef
    ...
    function chargeFees() internal {
        uint256 toOutput = IERC20(route).balanceOf(address(this));
        if (toOutput > 0) {
    ...
    function _giveAllowances() internal {
        ...
        IERC20(route).safeApprove(unirouter, uint256(-1));
    ...
    function _removeAllowances() internal {
        ...
        IERC20(route).safeApprove(unirouter, 0);
