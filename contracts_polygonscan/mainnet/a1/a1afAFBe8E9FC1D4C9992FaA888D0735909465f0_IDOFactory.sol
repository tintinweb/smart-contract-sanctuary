...
contract IDOFactory is Ownable {
    ...
    function updateSharedVariables(address _swapFactory, address _swapRouter, address _feeManager, address _governance, address _priceOracle, uint _slippage, address _farmFactory, address _compounderFactory) external onlyOwner{
