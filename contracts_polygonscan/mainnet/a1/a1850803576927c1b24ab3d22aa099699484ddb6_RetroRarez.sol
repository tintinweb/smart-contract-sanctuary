 ...
 */
 ...
 contract RetroRarez is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("RetroRarez", "Retro") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xFD40d622bAF3c7acB79495389822aAC3bE1bE7Bd);
          _setupRole(MINTER_ROLE, 0xFD40d622bAF3c7acB79495389822aAC3bE1bE7Bd);
          _setupRole(PAUSER_ROLE, 0xFD40d622bAF3c7acB79495389822aAC3bE1bE7Bd);
          _setupRole(MINTER_ADMIN_ROLE, 0xFD40d622bAF3c7acB79495389822aAC3bE1bE7Bd);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xFD40d622bAF3c7acB79495389822aAC3bE1bE7Bd);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "RetroRarez/minter-role-required");
         _mint(to, tokenId);
     ...
     {
        require(hasRole(DEPOSITOR_ROLE, _msgSender()));
        // deposit single
