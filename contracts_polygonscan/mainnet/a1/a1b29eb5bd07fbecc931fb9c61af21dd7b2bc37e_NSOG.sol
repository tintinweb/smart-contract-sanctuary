 ...
 */
 ...
 contract NSOG is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken, ERC2981ContractWideRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Noise Origin", "NSOG") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x0ca5296b8355747422ed212ddfB9447C60642078);
          _setupRole(MINTER_ROLE, 0x0ca5296b8355747422ed212ddfB9447C60642078);
          _setupRole(PAUSER_ROLE, 0x0ca5296b8355747422ed212ddfB9447C60642078);
          _setupRole(MINTER_ADMIN_ROLE, 0x0ca5296b8355747422ed212ddfB9447C60642078);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x0ca5296b8355747422ed212ddfB9447C60642078);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "NSOG/minter-role-required");
         _mint(to, tokenId);
