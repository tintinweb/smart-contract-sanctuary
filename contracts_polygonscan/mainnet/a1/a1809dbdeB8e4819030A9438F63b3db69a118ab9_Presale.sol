...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    uint256 public endICO = 1658850371; // Ends Tue Jul 26 2022 15:46:11 GMT+0000 (26/07/2022 15:46:11)
    // uint public minPurchase = 1000000000000000000000; // 1000
    uint public minPurchase = 1000000000000000000; // 1
    uint public maxPurchase = 15000000000000000000000; // 15000;
    uint public hardCap;
    uint public softCap;
    uint public availableTokensICO = 175000000000000000000000;
    uint256 public _rewardTokenCount = 3200000000000000000; // 3.2 tokens per MATIC
