...
// File: Vault\StrategyGravitySushiSushiswap.sol

// openzeppelin v3.1.0

contract StrategyGravitySushiSushiswap is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
	
	address public gfiAddress = address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381);
	address public gravityRouterAddress = 0x57dE98135e8287F163c59cA4fF45f1341b680248;
	address[] public gfiToWETHAddress = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToWantPath= [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        wantToEarnedPath = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
    }
    ...
    function harvest() internal virtual override{
		...
		uint256 balance = IERC20(gfiAddress).balanceOf(address(this));
		_safeSwapGFI(balance, gfiToWETHAddress, address(this));
    }
	
	function _safeSwapGFI(
        uint256 _amountIn,
        address[] memory _path,
        address _to
    ) internal {

        approve(_path[0], gravityRouterAddress, _amountIn);

        uint256[] memory amounts = IUniRouter02(gravityRouterAddress).getAmountsOut(_amountIn, _path);
        uint256 amountOut = amounts[amounts.length.sub(1)];

        IUniRouter02(gravityRouterAddress).swapExactTokensForTokens(
            _amountIn,
            amountOut.mul(slippageFactor).div(1000),
            _path,
            _to,
