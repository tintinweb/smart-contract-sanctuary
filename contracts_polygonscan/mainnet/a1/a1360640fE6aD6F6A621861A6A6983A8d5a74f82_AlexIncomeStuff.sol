...
abstract contract Ownable is Context {
  ...
  constructor () {
    address msgSender = 0xE3F42bADA1b887dd933e76CD409945bFD798E97A;
    _owner = msgSender;
...
contract AlexIncomeStuff is Context, Ownable, IERC20 {
  ...
  constructor() {
    ...
    _name = "Alex Income Stuff";
    _symbol = "AIS";
    _decimals = 18;
    _totalSupply = 100 * fractions;
