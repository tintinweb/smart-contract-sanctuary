...
contract DPolyPay is PMGPermission {
    ...
    function dealSettle(
        ...
        require(amount > 0, "Err-dealSettle-AmountZero");
        ...
        require(merchantTotalBalance - amount >= 0, "Err-dealSettle-InsufficientBalance-1");
        uint256 total = (amount * (100 - feeRate)) / 100;
        require(total > 0, "Err-dealSettle-InsufficientBalance-2");
        ...
        _merchantRecord[merchant][symbol].total -= total; 
    }
