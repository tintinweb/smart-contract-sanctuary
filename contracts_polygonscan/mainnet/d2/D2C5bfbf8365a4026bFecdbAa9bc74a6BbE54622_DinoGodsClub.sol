...
contract DinoGodsClub is ERC721Enumerable, Ownable {
  using Strings for uint256;
    ...
    returns (string memory)
  {
    ...
    if (!isRevealed) {
        return string(abi.encodePacked(preRevealURI, baseExtension));
    }
  ...
  function setIsReveal(bool _newIsReveal) public onlyOwner {
    isRevealed = _newIsReveal;
  }
