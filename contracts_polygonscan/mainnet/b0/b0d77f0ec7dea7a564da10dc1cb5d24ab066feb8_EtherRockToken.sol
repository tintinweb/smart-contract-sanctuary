...
The Ether Rock token that this contract manages may be used in future to reward rock owners.
...
contract EtherRockToken is ERC20PresetFixedSupply {
    constructor() ERC20PresetFixedSupply("A Ether Rock", "ETHERROCK", 1000000 * 10 ** 18, msg.sender) {
    }
}