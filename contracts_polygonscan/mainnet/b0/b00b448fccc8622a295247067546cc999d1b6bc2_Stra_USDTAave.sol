...
contract Stra_USDTAave is Ownable, Initializable, ReentrancyGuard {
    ...
    function claimIncetiveRewards(address _receiveFee) external onlyTreasury {
        _claimIncetiveRewards(_receiveFee); 
    }
    ...
    function _claimIncetiveRewards(address _receiveFee) private {
        uint256 unclaimedRewards = getUnclaimedIncentiveRewardsBalance();
        address[] memory _tokens = new address[](1);
        _tokens[0] = address(aToken);
        AaveIncentivesController.claimRewards(_tokens, unclaimedRewards, _receiveFee); 
    }
