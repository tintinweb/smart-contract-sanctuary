...
/** 
 *  SourceUnit: /home/whirlmaster/Desktop/PolyWhirl Private Sale/contracts/PrivateSale.sol
*/
...
contract PrivateSale is Ownable {
    ...
    modifier raiseIncomplete() {
        require(raised_funds.div(1e6) < 200000); // Total USD funds raised from sale
        _;
    }
    ...
    function purchaseInfluencer() external raiseIncomplete {
        ...
        stable_coin.approve(address(this), stable_coin_amount);
        stable_coin.transferFrom(msg.sender, address(this), stable_coin_amount);
    ...
    function redeemTokens() external onlyPurchased raiseComplete {
        ...
        require(
            sale_token.transfer(
                purchase.purchaser,
                purchase.token_amount.mul(TGE_unlock).div(100) // convert to percent
            ),
    ...
    function withdrawUnsoldTokens() external onlyOwner raiseIncomplete {
