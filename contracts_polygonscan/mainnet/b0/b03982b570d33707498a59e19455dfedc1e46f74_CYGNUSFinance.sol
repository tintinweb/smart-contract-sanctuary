...
contract CYGNUSFinance is Context, IERC20, Ownable {
...
contract CYGNUS is CYGNUSFinance , NativeMetaTransaction, ContextMixin {
    constructor() CYGNUSFinance () {
