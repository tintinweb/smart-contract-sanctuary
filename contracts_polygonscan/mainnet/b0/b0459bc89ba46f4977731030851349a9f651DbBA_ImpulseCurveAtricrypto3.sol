...
interface ICurvePool {
    ...
    function add_liquidity(uint256 [5] calldata amounts, uint256 min_mint_amount, address _receiver) external;

    function remove_liquidity(uint256 _amount, uint256 [5] calldata min_amounts) external;

    function remove_liquidity(uint256 _amount, uint256 [5] calldata min_mint_amount, address _receiver) external;
