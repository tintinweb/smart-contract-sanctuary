...
// File: contracts/QuikNodeCoin.sol


pragma solidity ^0.8.0;


contract QuikNodeCoin is Context, IERC20, Ownable {
...
contract QKC is QuikNodeCoin , NativeMetaTransaction, ContextMixin {
    constructor() QuikNodeCoin () {
