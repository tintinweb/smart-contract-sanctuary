...
contract NFTBridge is Context, AccessControl {
    event ExecuteRequest(NFTBridgeLibrary.Request);
    event ReleaseRequest(NFTBridgeLibrary.Request);
    event ToBeReleasedRequest(NFTBridgeLibrary.Request);
    event FinishRequest(NFTBridgeLibrary.Request);
    ...
    function createRequestWithMany(
        ...
        emit ExecuteRequest(requests[counter]);
    ...
    function createToBeReleasedRequest(
        ...
        emit ToBeReleasedRequest(unReleased[unreleasedCounter]);
        ...
        onlyRole(ROLE_VALIDATOR)
    {
        ...
        emit FinishRequest(requests[id]);
    }
        ...
        onlyRole(ROLE_VALIDATOR)
    {
        ...
        emit ReleaseRequest(unReleased[id]);
    }
