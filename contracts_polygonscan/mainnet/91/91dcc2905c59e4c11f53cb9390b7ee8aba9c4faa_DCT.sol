...
/**
 * @title DCT ERC20 token
 * @dev
 *      Based on the Ampleforth & Safemoon protocol.
 */
contract DCT is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**10 * 10**DECIMALS;
    ...
    constructor (address router, address payable _deadBurn, address payable _marketingAddress)
        ERC20Detailed("Digital Cowries Token", "DCT", uint8(DECIMALS))
        payable
        public
    {
        deadBurn = _deadBurn;
