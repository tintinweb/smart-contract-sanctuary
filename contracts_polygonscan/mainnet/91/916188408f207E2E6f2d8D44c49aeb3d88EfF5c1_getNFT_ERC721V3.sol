...
// File contracts/ERC721UpgradeableGETV2.sol
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721UpgradeableGETV2 is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, IERC721EnumerableUpgradeable {
...
// File contracts/getNFT_ERC721V3.sol
...
contract getNFT_ERC721V3 is Initializable, ERC721UpgradeableGETV2 {
    ...
    */
    function relayerTransferFrom(
        address originAddress, 
        address destinationAddress, 
        uint256 nftIndex) external onlyFactory {
    ...
    function _beforeTokenTransfer(
        ...
        address to, 
        uint256 tokenId
        ) internal virtual override(ERC721UpgradeableGETV2) {
