...
// File: .deps/github/Loesil/VaultChef/contracts/DeFi Projects/PolyYeld/IPolyYeldMasterChef.sol

interface IPolyYeldMasterChef
{
...
// File: .deps/github/Loesil/VaultChef/contracts/DeFi Projects/PolyYeld/VaultPolyYeldMaster.sol

contract VaultPolyYeldMaster is Vault
{
    ...
    address public constant REWARD_TOKEN = 0xd0f3121A190d85dE0AB6131f2bCEcdbfcfB38891;
    
    address public constant CHEF = 0x2DC11B394BD0f1CC6AC0a269cfe3CC0b333601B4;
    ...
    {
        //tokens
        (depositToken, , , ,) = IPolyYeldMasterChef(CHEF).poolInfo(_poolID);
    ...
    function getTotalPending() public override view returns (uint256)
    {
        ...
        uint256 pending = IPolyYeldMasterChef(chef).pendingYeld(poolID, address(this));
    ...
    {
        (, uint256 allocPoints, , ,) = IPolyYeldMasterChef(CHEF).poolInfo(poolID);
        return allocPoints;
    }
    ...
    {
        (, , , , uint16 poolDepositFee) = IPolyYeldMasterChef(chef).poolInfo(poolID);
    ...
    function poolDeposit(uint256 _amount) internal override returns(uint256 _received, uint256 _lostRate)
    {
        ...
        IPolyYeldMasterChef(chef).deposit(poolID, _amount, treasury);
    ...
    function poolWithdraw(uint256 _amount) internal override returns(uint256 _received, uint256 _lostRate)
    {
        ...
        IPolyYeldMasterChef(chef).withdraw(poolID, _amount);
