...
contract MaticPool {
   ...
   uint pool2_price=3 ether ;
   uint pool3_price=4 ether;
   uint pool4_price=8 ether;
   uint pool5_price=16 ether;
   uint pool6_price=32 ether;
   uint pool7_price=64 ether ;
   uint pool8_price=128 ether;
   uint pool9_price=256 ether;
   uint pool10_price=512 ether;
   uint pool11_price=1024 ether;
   uint pool12_price=2048 ether;
   uint pool13_price=4096 ether;
   uint pool14_price=8192 ether;
   uint pool15_price=16384 ether;
    ...
    UserStruct[] public requests;
      ...
      constructor(address payable _creator1) public {
        ...
        LEVEL_PRICE[1] = 0.44 ether;
        LEVEL_PRICE[2] = 0.24 ether;
        LEVEL_PRICE[3] = 0.1 ether;
        LEVEL_PRICE[4] = 0.012 ether;
      unlimited_level_price=0.01 ether;
    ...
    pool12activeUserID=pool12currUserID;
       ...
       pool12userList[pool10currUserID]=msg.sender;
  ...
  UserStruct memory userStruct1;
       ...
       pool13users[creator1] = pooluserStruct1;
       pool13userList[pool13currUserID]=creator1;
...
pool14currUserID++;
       ...
       pool14users[creator1] = pooluserStruct1;
       pool14userList[pool14currUserID]=creator1;
      ...
      pool15users[creator1] = pooluserStruct1;
       pool15userList[pool15currUserID]=creator1;
