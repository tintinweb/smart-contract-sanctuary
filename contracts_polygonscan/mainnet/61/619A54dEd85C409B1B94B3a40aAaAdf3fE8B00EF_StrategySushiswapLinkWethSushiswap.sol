...
// File: Vault\libs\ISushiStake.sol
...
// File: Vault\StrategySushiswapLinkWethSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapLinkWethSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x0053e0bca35ec356bd5dddfebbd1fc0fd03fabad39)];
        earnedToToken1Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        token0ToEarnedPath = [address(0x0053e0bca35ec356bd5dddfebbd1fc0fd03fabad39), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        token1ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x0053e0bca35ec356bd5dddfebbd1fc0fd03fabad39)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
    }
    
    function stake(uint256 _wantAmount) internal virtual override{
        ISushiStake(masterChef).deposit(pid, _wantAmount, address(this));
    }

    function harvest() internal virtual override{
        ISushiStake(masterChef).harvest(pid, address(this));
    }

    function unstake(uint256 _amount) internal virtual override{
        ISushiStake(masterChef).withdraw(pid, _amount, address(this));
    } 
    function emergencyWithdraw() internal virtual override onlyOperator {
        ISushiStake(masterChef).emergencyWithdraw(pid, address(this));
    }   
    
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance,) = ISushiStake(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}