...
contract Mecenas is ERC20m, ReentrancyGuard {
    ...
    constructor(address _owner, address _marketcream, address _underlying) ERC20m("crMECENASPOOLS", "crMEC") {
        
        marketcream = CreamYield(_marketcream);
        underlying = ERC20(_underlying);
        lockdeposits = 0;
        owner = _owner;
        developer = 0x34EEd477bf8287e79659711799A1E3057ec1a03f;
        seeker = 0x34EEd477bf8287e79659711799A1E3057ec1a03f;
        spinning = false;
