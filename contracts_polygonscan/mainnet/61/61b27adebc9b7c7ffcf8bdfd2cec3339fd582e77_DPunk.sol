...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b)
        ...
        returns (bool, uint256)
    {
        // Gas optimization: this is chepunkr than requiring 'a' not being zero, but the
...
// File: contracts/DPunk.sol

pragma solidity ^0.7.0;

/**
 * @title DPunk contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract DPunk is ERC721, Ownable {
    using SafeMath for uint256;

    string public DPUNK_PROVENANCE = "";
    ...
    uint256 public constant maxPunkPurchase = 20;
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        DPUNK_PROVENANCE = provenanceHash;
    }
    ...
    function mintPunk(uint256 numberOfTokens) public payable {
        ...
        require(
            numberOfTokens <= maxPunkPurchase,
        ...
        require(
            punkPrice.mul(numberOfTokens) <= msg.value,
        ...
        if (
            ...
            (totalSupply() == MAX_PUNKS || block.timestamp >= REVEAL_TIMESTAMP)
        ) {
