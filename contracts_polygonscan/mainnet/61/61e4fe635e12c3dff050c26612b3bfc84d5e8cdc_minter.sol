...
contract minter is AccessControl {
    ...
    nftInterface private fmtaogbull;
    ...
    function mint () public returns (uint256) {
        ...
        require(hasMinted[msg.sender] == false, "minter: FMTAOGBULL can only be minted once per account");
        require(isWhitelisted[msg.sender] = true);
        uint256 newItemId = fmtaogbull.mint1YR(msg.sender, uri);
        hasMinted[msg.sender] = true;
        return newItemId;
    }
    
    function setFMTAOGBULL (nftInterface _fmtaogbull) public {
        require(hasRole(_ADMIN, msg.sender), "minter: Must have ADMIN");
        fmtaogbull = _fmtaogbull;
    }
    ...
    function getFMTAOGBULL() public view returns (nftInterface) {
        return fmtaogbull;
    }
}