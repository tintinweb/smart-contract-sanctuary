...
contract AbleBarz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("AbleBarz", "Barz") {
    setHiddenMetadataUri("ipfs://QmRdZcZrJaRRV5XkrYuP9Tw8YTMiU71LW1meEkGm2MUhWf/hidden.json");
  }
