...
/*
    ...
    E5: USDC amount must be greater than 0 
    E6: There is not enough USDC
    
*/

contract SaleNFT is ReentrancyGuard, Ownable, IERC721Receiver, ERC721Holder {
    using SafeERC20 for IERC20;

    address public constant ADMIN_ADDRESS = 0x574d19a6E7621C188d91B0F39d597C34fb89940d;
    
    address public constant SALE_ADDRESS = 0x85f1f5898CE03b01cD845BaB80bEf3118D5BE4c3;
    ...
    uint256 public nftCardPerAccountMaxTotal = 5; // 5 cards
    
    uint256 public salePrice = 10 * (10 ** 6); // 10 usdc
    ...
    event BuyNftCard(address sender, uint256 usdcSpent, uint256 nftCardReceived);
    ...
    constructor(uint256 _startBlock) {
        require(block.number < _startBlock, "E0");
    ...
    function buyNftCard(uint256 _amountNFT) external nonReentrant {
        ...
        uint256 _usdcSpend = (_amountNFT * salePrice);

        require(_usdcSpend > 0, "E5");
        require(_usdcSpend <= USDC.balanceOf(msg.sender), "E6");
        ...
        if (_balanceOfNFT > 0) {
              ...
              // send usdc to sale address
              USDC.safeTransferFrom(msg.sender, SALE_ADDRESS, _usdcSpend);
        }
        
        emit BuyNftCard(msg.sender, _amountNFT, _usdcSpend);
