...
contract ThePlanetOfHares is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFT_PURCHASE_PRESALE = 30;
    ...
    constructor(address payable _multiSigWallet) ERC721("Test","TEST"){
    ...
    function mintHare(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens >= 1, "Number of tokens can not be less than 1");
        require(numberOfTokens <= MAX_NFT_PURCHASE,"Number of tokens can not be more than 15");
