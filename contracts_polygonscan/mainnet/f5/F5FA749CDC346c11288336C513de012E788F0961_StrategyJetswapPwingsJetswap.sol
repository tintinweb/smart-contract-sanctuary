...
// File: Vault\libs\IJetswap.sol

// For interacting with masterchef for pid == 0
interface IJetswap {
...
// File: Vault\StrategyJetswapPwingsJetswap.sol

// openzeppelin v3.1.0

contract StrategyJetswapPwingsJetswap is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25)];
        wantToEarnedPath = [address(0x00845e76a8691423fbc4ecb8dd77556cb61c09ee25)];
    }

    function stake(uint256 _wantAmount)  internal override virtual{
        IJetswap(masterChef).enterStaking(_wantAmount);
    }
