...
contract StrategyGBNTMATICLP is StratManager, FeeManager {
    ...
    constructor() public {
        ...
        want = 0xD883C361D1E8a7e1f77D38E0a6e45D897006B798; // GBNTMATICpair
        output = 0x8c9aAcA6e712e2193acCCbAC1a024e09Fb226E51; // GBNT
        usdc = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; // USDC
        wmatic = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270; // WMATIC
        unirouter = 0x94930a328162957FF1dd48900aF67B5439336cBD; //Polycat
        masterchef = 0xA375495919205251a05f3B259B4D3cc30a4d3ED5; // GBNT Masterchef
        poolId = 1;
    ...
    function getHarvestable() external view returns (uint256){
        return IMasterChef(masterchef).pendingGammaPulsar(poolId, address(this));
    }
}