...
// File: Vault\StrategyQuickswapWoneMaticQuickswap.sol

contract StrategyQuickswapWoneMaticQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0080c0cbdb8d0b190238795d376f0bd57fd40525f2)];
        ...
        token1ToEarnedPath = [address(0x0080c0cbdb8d0b190238795d376f0bd57fd40525f2), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x0080c0cbdb8d0b190238795d376f0bd57fd40525f2)];
    }
