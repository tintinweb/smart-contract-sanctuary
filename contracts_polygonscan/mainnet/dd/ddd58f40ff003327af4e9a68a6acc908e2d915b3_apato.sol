...
contract apato is  ERC721URIStorage , ERC721Enumerable {

    address public owner;

    uint256 public nftid = 1;

    string currentURI = "https://www.arweave.net/knZfdTM0fIEA6QpamYL4-ydkP7fzEL3Fd5h-7G-fzyE";
    ...
    constructor() ERC721("apato" , "APATO" ) {
        owner = _msgSender();
    } 
