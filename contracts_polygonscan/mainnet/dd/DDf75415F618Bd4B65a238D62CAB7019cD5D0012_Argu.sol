...
contract Argu is Ownable {
    ...
    uint256 private _numTokensSellToAddToLiquidityOrBurn = 2 * 10**5 * 10**6 * 10**18;
...
//-------------------------------------
    ...
    function getNumTokensSellToAddToLiquidityOrBurn() public view returns(uint256){
        return _numTokensSellToAddToLiquidityOrBurn;
    }
    function setNumTokensSellToAddToLiquidityOrBurn(uint256 amount) public onlyOwner{
        _numTokensSellToAddToLiquidityOrBurn = amount;
    }
