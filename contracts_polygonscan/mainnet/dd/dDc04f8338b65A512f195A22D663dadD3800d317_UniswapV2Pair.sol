...
contract UniswapV2ERC20 is IUniswapV2ERC20 {
    ...
    string public constant name = 'DomiSwap LP Token';
    string public constant symbol = 'DMLP';
...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    function computeAmountOut(uint priceCumulativeStart, uint priceCumulativeEnd, uint timeElapsed, uint amountIn) internal pure returns (uint amountOut) {
        ...
        amountOut = FixedPoint.decode144(FixedPoint.mul(priceAverage, amountIn));
    }
    ...
    function setCycle(uint _cycle) external {
        require(msg.sender == IUniswapV2Factory(factory).feeToSetter(), "UniswapV2: permit feeToSetter");
