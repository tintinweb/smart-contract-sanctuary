...
contract BeefyLaunchpoolReceiver is Ownable {
    ...
    function createLaunchpool(address _stakedToken, uint8 durationDays) external onlyManager {
        uint256 duration = 3600 * 24 * durationDays;
        launchpool = address(new BeefyLaunchpool(_stakedToken, token, duration));
