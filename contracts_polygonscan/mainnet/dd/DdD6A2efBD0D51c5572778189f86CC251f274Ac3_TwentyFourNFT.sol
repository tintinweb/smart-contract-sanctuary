...
// File: contracts/TwentyFourNFT.sol
 ...
 */
contract TwentyFourNFT is ERC721URIStorage, Pausable {
    ...
    event newStakeProtocol(address oldProtocol,address newProtocol);
    event newAuctionProtocol(address oldProtocol,address newProtocol);
    ...
    function setStakingAddress(address _staking) external onlyGov(){
        address old = stakingAddress;
        stakingAddress = _staking;
        emit newStakeProtocol(old,stakingAddress);
    }
    function setAuctionAddress(address _auction) external onlyGov(){
        address old = auctionAddress;
        auctionAddress = _auction;
        emit newAuctionProtocol(old,auctionAddress);
    }
