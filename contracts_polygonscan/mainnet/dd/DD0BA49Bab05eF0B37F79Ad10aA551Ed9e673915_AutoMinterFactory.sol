...
// File: contracts/AutoMinter_Factory.sol
...
contract AutoMinterFactory is Ownable
{
    constructor() Ownable() payable {}
    
    struct CollectionInfo{
        ERC721AutoMinter collection;
        address owner;
        string appId;
    }
    ...
    mapping(string => uint256) public appIdLookup;
    address public customOfferSigner;
        ...
        bool mintRandomEnabled_) payable public
    {
        ...
        require(appIdLookup[appId_] == 0 || collections.length == 0, 'a contract for this id already exists');
        
        
        ERC721AutoMinter collection = new ERC721AutoMinter(name_,
            symbol_,
            baseURI_,
            owner(),
            msg.sender,
        ...
        appIdLookup[appId_] = collections.length - 1;
    }
