...
contract MicroMachineManufacturingPlant is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    string public _tokenURI = '{"attributes": [{"trait_type": "Type", "value": "Tractor" }  ,  {"trait_type": "Level", "value": "2" } , {"trait_type": "Hitpoints","value": "10" } ],"name": "MMWarbot","description": "Micromachine WarBot NFT","image": "https://cloudflare-ipfs.com/ipfs/QmUGZ9KtChpvGRqvS3P8N5RqFBASP3qZmqpG1FVVp1uDS6"}';
    ...
    constructor() ERC721("MicroMachineWarBots", "MMWarBot") {
       ...
       // MicroMachineAddress = 0xcc116e59Dd51DF5460E8B11Ff615E3E706a9202A;
        MicroMachineAddress = 0xA3b92852FB5A85fEa1eeC98508c76183a78C6ea3; // matic
    ...
    function emergencyWithdraw() public onlyEngine {
    ...
    function manufacture( uint256 _plant ) public payable {
        ...
        //require ( block.timestamp < (ManufacturingPlants[ _plant]._timeofexpiration.add(manufacturingPeriod)) );
    ...
    function manufactureUnits( uint256  _timeunitslocked, uint256 _micromachinesstaked ) public pure returns(uint256){
        return _timeunitslocked * _micromachinesstaked.div(10**9);
    }
    ...
    function unstakeMicroMachines ( uint256 _plant ) public  {
        ...
        globalwarbotproduction = globalwarbotproduction.sub(ManufacturingPlants[ManufacturingPlantCount]._periodproductionrate);
        globalwarbotmanufacturingplants--;
         ERC20 _token = ERC20(MicroMachineAddress);
