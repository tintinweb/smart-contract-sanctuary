...
contract LightArt is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    function setTotalQuantity(uint32 _total_quantity) external onlyOwner {
        total_quantity = _total_quantity;
    }
    ...
    function setPrice(uint8 _payment_token_index, uint256 _price) external onlyOwner {
        require(_payment_token_index < payment_list.length, "invalid payment token");
        payment_list[_payment_token_index].price = _price;
    }
