...
// File contracts/strategies/dinoswap/mainnet/StrategyDino_XMARK_USDC.sol

pragma solidity 0.5.16;
contract StrategyDino_XMARK_USDC is DinoswapLPStrategy {

    address xmark_usdc_diff;
    ...
    function initializeStrategy(
        ...
        address xmark_usdc_lp = address(0x97A95deb56d689802F02f50c25EBCda5d0A49591);
        address xmark = address(0xf153EfF70DC0bf3b085134928daeEA248d9B30d0);
