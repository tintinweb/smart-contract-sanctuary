...
contract Manager is Ownable, ReentrancyGuard {
    ...
    function claimPrice(uint256 _pid) public nonReentrant {
        ...
        poolCollection[_pid].prizeToken.safeTransfer(poolCollection[_pid].currentWinner, reward);
        poolCollection[_pid].prizeToken.safeTransfer(buyBackAddress, buyBackFee);
