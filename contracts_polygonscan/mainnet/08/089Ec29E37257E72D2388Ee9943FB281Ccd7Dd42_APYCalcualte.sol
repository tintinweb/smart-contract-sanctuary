...
contract APYCalcualte{
   ...
   function USDToToken0(address _token0)public view returns(uint256){
    ...
    function tokenToUSD(address token)public view returns(uint256){
        ...
        IBEP20 usd = tokenUSDPair.token0() == USD ?IBEP20(tokenUSDPair.token0()) :IBEP20(tokenUSDPair.token1());
        IBEP20 token0 = tokenUSDPair.token0() == USD ?IBEP20(tokenUSDPair.token1()) :IBEP20(tokenUSDPair.token0());
