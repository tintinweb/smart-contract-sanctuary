...
// File contracts/BIFI/interfaces/kyber/IDMMPool.sol
...
// File contracts/BIFI/interfaces/kyber/IKyberFairLaunch.sol
...
// File contracts/BIFI/interfaces/kyber/IRewardsLocker.sol
...
// File contracts/BIFI/strategies/Kyber/StrategyKyber.sol
...
contract StrategyKyber is StratManager, FeeManager {
    ...
    function addLiquidity() internal {
        ...
        (uint256 reserve0, uint256 reserve1) = IDMMPool(want).getReserves();
        uint256 lp0Decimals = ERC20(lpToken0).decimals();
        uint256 lp1Decimals = ERC20(lpToken1).decimals();

        uint256 split = reserve0.mul(10**lp1Decimals).div(reserve1);
        uint256 outputBal0 = outputBal.mul(split).div(10**lp0Decimals);
        ...
        IDMMRouter(unirouter).addLiquidity(
            IERC20(lpToken0),
            IERC20(lpToken1),
            want,
            lp0Bal,
