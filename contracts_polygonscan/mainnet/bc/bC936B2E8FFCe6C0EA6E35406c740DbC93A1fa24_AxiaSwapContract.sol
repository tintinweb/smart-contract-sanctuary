...
//======================================ACTION CALLS=========================================//	
	...
	function _swapIn(uint256 _amount) internal {
		...
		require(IERC20(AxiatokenC).balanceOf(address(this)) >= _amount, "Pool is deficient of tokens to execute the swap");
	...
	function _swapOut(uint256 _amount) internal {
		...
		require(IERC20(AxiatokenB).balanceOf(address(this)) >= _amount, "Pool is deficient of tokens to execute the swap");
