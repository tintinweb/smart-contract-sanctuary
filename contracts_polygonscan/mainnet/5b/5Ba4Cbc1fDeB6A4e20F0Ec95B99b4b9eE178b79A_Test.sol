...
contract Test is Ownable, QuickSwapTrader {
    ...
    {
        _swapToken(kPolygonToken.matic, kPolygonToken.usdc, _amount);
    }
...
contract QuickSwapTrader {
    ...
    function _approveSpending(address _tokenAddress) private
    {
        ...
        bool succeeded = tokens[_tokenAddress].token.approve(address(quickswapV2Router02), 4000000);
