...
contract EggToken is ERC20("LoserchickEgg", "EGG"), OwnableContract{
    ...
    constructor(address _chickAddr) public {
        ...
        ceggSwapEggProportion[0] = 10; // special case : if  addUpSwapCchickCountPerUser[userAddr] <=10 , the max EGG count is 5 
        
        //  maxEggAmount = chickCount.mul(ceggSwapEggProportion[index]).div(100);
        ceggSwapEggProportion[1] = 90; 
        ceggSwapEggProportion[2] = 90;
        ceggSwapEggProportion[3] = 90;
    }
