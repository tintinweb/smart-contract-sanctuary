...
contract BABY is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xd45b21ddFe055eF997D41a025461AacB8e774830); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0xE81251Aa4CdeEB2a4e7044f421f2a75A7177cE82); // xrp Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); //Prod
