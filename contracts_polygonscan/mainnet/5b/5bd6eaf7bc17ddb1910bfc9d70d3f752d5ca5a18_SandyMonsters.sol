...
contract SandyMonsters is IERC721 {
    ...
    string internal nftName = "SandyMonsters";
    string internal nftSymbol = "SMDH";
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "http://meta.sandymonsters.com/monster/",
                    toString(_tokenId)
                )
            );
    }
    ...
    modifier onlyTokenOwner(uint256 _tokenId) {
        require(_tokenId < 8888, "monster number is wrong");
