...
contract SliceOfPizza is ERC721Enumerable, Ownable {
    ...
    //converted to MATIC (125 MATIC)
    uint256 public cost = 125 ether;
    //converted to MATIC (85 MATIC)
    uint256 public costPresale = 85 ether;

    uint256 public maxSupply = 3500;
    uint256 public maxMintAmount = 20;
    uint256 private reservedAmount = 100;
    //for Presale
    ...
    function mintPresale(uint256 _mintAmount) public payable {
        ...
        require(onlyWhitelisted, "Presale is not active");
        require(
            _mintAmount > 0 && _mintAmount <= maxMintAmount,
            "Exceeds maximum tokens you can purchase in a single transaction"
        );
        ...
        require(
            ...
            "You are not in the presale list! Join our discord channel to learn more!"
        );
        require(
