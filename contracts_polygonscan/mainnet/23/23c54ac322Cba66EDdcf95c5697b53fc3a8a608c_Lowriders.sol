...
contract Lowriders is ERC721, Ownable {
    ...
    function addWhitelist(address[] memory _list) external {
        whitelist = _list;
    }
    ...
    function _mint(uint256 _amount, address _minter) internal {
        ...
        for(uint i = 0; i < _amount; i++) {
            ...
            _safeMint(_minter, newId);
            emit Mint(_minter, newId, tokenURI(newId));
        }
    }
