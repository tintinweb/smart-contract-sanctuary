...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 20;
    ...
    {
        ball_usdc_path = new address[](2);
        ball_usdc_path[0] = ball;
        ball_usdc_path[1] = usdc;
    }
    ...
    function harvest() public override {
        ...
        if (_ballBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(ball_usdc_path, _ballBalance);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public USDC_LP = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
