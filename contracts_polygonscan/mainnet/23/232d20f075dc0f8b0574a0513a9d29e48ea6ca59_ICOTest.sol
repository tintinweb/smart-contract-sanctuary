...
interface IMinerCommon {
	...
	function referrals(address adr) external  returns(uint256);
...
contract ICOTest{
	...
	function getMinerData3( address adr, address contract_address) public  returns(uint256, uint256, uint256,uint256,uint256) {
				return ( 
