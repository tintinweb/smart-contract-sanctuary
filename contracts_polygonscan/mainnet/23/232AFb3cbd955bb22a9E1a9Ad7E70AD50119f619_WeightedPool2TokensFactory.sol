...
abstract contract BasePool is IBasePool, BasePoolAuthorization, BalancerPoolToken, TemporarilyPausable {
     ...
     * Pool.
     */
    function _scalingFactor(IERC20 token) internal view returns (uint256 r) {
        // prettier-ignore
...
contract WeightedPool is BaseMinimalSwapInfoPool, WeightedMath {
    ...
    function _normalizedWeight(IERC20 token) internal view virtual returns (uint256 r) {
        // prettier-ignore
    ...
    function _doJoin(
        ...
        uint256[] memory normalizedWeights,
        bytes memory userData
    ) private view returns (uint256 r, uint256[] memory m) {
    ...
    WeightedOracleMath
{
    ...
    function _doJoin(
        ...
        uint256[] memory normalizedWeights,
        bytes memory userData
    ) private view returns (uint256 r, uint256[] memory b) {
        WeightedPool.JoinKind kind = userData.joinKind();
