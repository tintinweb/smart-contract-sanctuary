...
contract InfinityFactory is Ownable, ERC721Enumerable, ERC165Storage, IERC2981 {
  ...
  constructor() ERC721('ZuckSucks', 'ZUKSUK') {
  ...
  /**
        ...
        @param amount num mints
    */
  function mint(string calldata variationName, uint256 amount) public payable {
    require(isMinting[variationName], 'variation not minting');
    require(variations[variationName] != address(0), 'variation not found');
    require(_mintCounter[variationName].current().add(amount) < maxMints[variationName], 'all minted');
    require(msg.value == mintFee[variationName].mul(amount), 'incorrect mint fees');
    ...
    returns (address receiver, uint256 royaltyAmount)
  {
    ...
    royaltyAmount = (_salePrice * 50) / 100;
  }
  ...
  function teamMint(
    ...
    require(_mintCounter[variationName].current().add(amount) < maxMints[variationName], 'all minted');
    require(
      _teamMintCounter[variationName].current().add(amount) < maxTeamMints[variationName],
