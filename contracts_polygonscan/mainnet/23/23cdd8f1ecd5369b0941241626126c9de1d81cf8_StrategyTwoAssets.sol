...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    {
        quick_eth_path = new address[](2);
        quick_eth_path[0] = quick;
        quick_eth_path[1] = eth;
    ...
    function harvest() public override {
        ...
        if (_quickBalance > harvestCutoff){
            _swapUniswapWithPath(quick_eth_path, _quickBalance.div(2));
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    // Token addresses
    address public Quick_Rewards = 0x8FF56b5325446aAe6EfBf006a4C1D88e4935a914;
