...
contract LumiWallet   is Context, IERC20, Ownable {
...
contract Lumi is LumiWallet   , NativeMetaTransaction, ContextMixin {
    constructor() LumiWallet   () {
