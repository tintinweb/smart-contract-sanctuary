...
contract PHXVestingPool is PHXVestingPoolData{
    ...
    function update() external versionUpdate {
        minePoolList.push(address(0));
        minePoolList.push(0x3ECeF65b8A577535AbFb6108cc665fC3305EA1a7);
        minePoolList.push(0xF448dAaBa8F576297318EDDb938736F75d4a19e5);
        minePoolList.push(0x4Bc300D4d2C272bB767b09CBdb284DC482Eb2d33);
        minePoolList.push(0x744afAc83c13a74a604dCbc58E6836b586F93c7D);
        minePoolList.push(0x2817fd78E0c459D9041094e5512FF66Ad5c41939);
        minePoolList.push(0xb07E4456E3e3a0B28e2a325c2C2fF2BE8e6E9F58);
    }
    ...
    modifier versionUpdate(){
        require(implementationVersion() > version() && msg.sender == txOrigin(),"New version implementation is already updated!");
        _;
    }
