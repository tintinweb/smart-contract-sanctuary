...
abstract contract JarBase is ERC20, Ownable {
    ...
    function deposit(uint256 _amount) public {
        ...
        (, , , , address swampStrat) = underlyingMC.poolInfo(underlyingPoolId);
        uint256 _depositFeeFactor = ISwampStrategy(swampStrat).depositFeeFactor();
    ...
    function withdraw(uint256 _shares) public {
        ...
        MasterChef underlyingMC = MasterChef(masterChefAddr);
        (, , , , address swampStrat) = underlyingMC.poolInfo(underlyingPoolId);
        uint256 _withdrawFeeFactor = ISwampStrategy(swampStrat).withdrawFeeFactor();
