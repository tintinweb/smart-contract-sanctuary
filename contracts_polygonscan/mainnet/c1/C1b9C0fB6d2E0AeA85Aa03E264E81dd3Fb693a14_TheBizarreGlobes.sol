...
// File: contracts/TheBizarreGlobes.sol



// Amended by TheBizarreGlobes

pragma solidity >=0.7.0 <0.9.0;



contract TheBizarreGlobes is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 70 ether;
  uint256 public maxSupply = 3555;
