...
contract AqarIdoTest {
    ...
    function buyToken() public payable returns(bool) {
        ...
        uint tokens = (msg.value * priceOfMATIC / 100000) / buyPrice;
    ...
    function getTokens(uint maticAmt) public view returns(uint tokens) {
        ...
        tokens = (maticAmt * priceOfMATIC / 100000) / buyPrice;
        return tokens;
    }
    ...
    function usdPrice(uint amount) external view returns(uint) {
     ...
     /// Show USD Price of 1 Matic with decimal
    function usdPriceDecimal(uint amount) external view returns(uint) {
        uint maticAmt = amount * priceOfMATIC;
        return maticAmt/100000;
    }
