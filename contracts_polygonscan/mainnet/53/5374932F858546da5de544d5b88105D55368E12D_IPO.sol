...
contract IPO 

   {
    ...
    function initializeIPO(address _inputtoken, address _outputtoken, uint256 _startTime, uint256 _inTokenClaimTime, uint256 _endtime, uint256 _outTokenPerInToken, uint256 _maxinvestment, uint256 _minInvestment, bool _inputToken6Decimal) public onlyOwner {
