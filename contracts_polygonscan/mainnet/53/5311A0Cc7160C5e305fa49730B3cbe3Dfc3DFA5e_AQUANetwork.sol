...
// File: contracts/AQUANetworkToken.sol
...
contract AQUANetwork is BEP20('AQUA Network', 'AQUA') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTAQUA::transfer: Burn value invalid");
