...
contract VaultQuickSwap is Ownable, ReentrancyGuard, Pausable { 
    ...
    address public constant burningVault    = 0xAF0292444bC26a1236aF81b1aE166C1D7D3359C0;  
    address public vaultChefAddress         = 0x3A48811f917b04B9374561E66e8800C2bf091653;
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            ILandVaultCash(rewardAddress).depositReward(balanceAfter);
    ...
    function setSettings(
        ...
        require(_vaultChef != address(0), "_vaultChef is not zero address");
