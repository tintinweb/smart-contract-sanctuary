...
contract rechargeToken is Ownable{
    ...
    ERC20Burnable public Blok;

    uint256 public BusinessFee = 10;
    uint256 public SupportFee = 990;
    address public BusinessWallet = 0x8f3A076C1222103D0cCAC5b989F25CEcf6ED932F;
    address public SupportWallet = 0xf1472b555b82De93412a6e71064Da17171F4Ab1A;

    event BlokDeposti(address indexed user, uint256 depositAmount);
    ...
    constructor(ERC20Burnable _Blok){
        Blok = _Blok;
    }
    ...
    function exchange(uint256 _amount)external {
        ...
        Blok.transferFrom(msg.sender, BusinessWallet, _amount.sub(tokens));
        Blok.transferFrom(msg.sender, SupportWallet, tokens);
        emit BlokDeposti(msg.sender, _amount);
    }
