...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, AccessControl, Ownable {
  ...
  // Mapping from token ID to number of cards
  ...
  /**
   * @dev Return the number of cards contained in tokenId (pack).
   */
  function numberOfCardsContained(uint256 tokenId) public view virtual returns (uint256) {
   ...
   * @dev Mint function
   */
  function mint(address to, uint256 cards) public virtual returns (uint256) {
...
contract NafstarsPacksNFT is ERC721("Nafstars Packs NFT", "NPACKS") {}