 ...
 */
 ...
 contract Enhanced is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, IChildToken, ERC2981ContractWideRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Enhanced", "Enhanced") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x2E12BbA4Cf0D8c099880f6ce1Ea2fD875a5Ef819);
          _setupRole(MINTER_ROLE, 0x2E12BbA4Cf0D8c099880f6ce1Ea2fD875a5Ef819);
          _setupRole(PAUSER_ROLE, 0x2E12BbA4Cf0D8c099880f6ce1Ea2fD875a5Ef819);
          _setupRole(MINTER_ADMIN_ROLE, 0x2E12BbA4Cf0D8c099880f6ce1Ea2fD875a5Ef819);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
		  _setupRole(DEPOSITOR_ROLE, 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
          transferOwnership(0x2E12BbA4Cf0D8c099880f6ce1Ea2fD875a5Ef819);
		  _setRoyalties(0x2E12BbA4Cf0D8c099880f6ce1Ea2fD875a5Ef819, 250); 
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "Enhanced/minter-role-required");
         _mint(to, tokenId);
