...
contract CustomTokenOracle is Ownable, IOracle {
    ...
    constructor(
        ...
        CUSTOM_TOKEN_DECIMALS = 10 ** uint256(oracleCustomTokenCollateral.tokenDecimals(customToken));
    }
    ...
    function consult() external view override returns (uint256) {
        ...
        return (priceCollateralUsd() * _priceCustomTokenCollateral) / CUSTOM_TOKEN_DECIMALS;
    }
    ...
    function setOracleCustomTokenCollateral( IPairOracle _oracleCustomTokenCollateral) public onlyOwner {
        ...
        CUSTOM_TOKEN_DECIMALS = 10 ** oracleCustomTokenCollateral.tokenDecimals(customToken);
