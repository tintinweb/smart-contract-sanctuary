...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x0000000000000000000000000000000000001010);
...
contract THETEST is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0x0000000000000000000000000000000000001010;
    address WBNB = 0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "THETEST";
    string constant _symbol = "MINUMINU";
