...
contract PoolFund is Ownable, Initializable {
    ...
    // return maximum allocation for this address
    function maxAllocation() external view returns (uint256) {
        return reward.minters(address(this));
    }
...
interface IRewardToken is IERC20 {
    ...
    function minters(address _minter) external view returns (uint256);
}