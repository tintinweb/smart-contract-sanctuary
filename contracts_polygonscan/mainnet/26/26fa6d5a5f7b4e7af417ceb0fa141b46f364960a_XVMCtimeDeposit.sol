...
contract XVMCtimeDeposit {
    ...
    uint256 public callFeeWithBonus = 15; // bonus for rebalancing pools in governance contract
    ...
    function hopStakeToAnotherPool(uint256 _shares, uint256 _stakeID, address _recipient, address _poolAddress) public {
        ...
        uint256 _userLastDepositTime = user.lastDepositedTime;
        uint256 _userMandatoryTime = user.mandatoryTimeToServe;
        ...
        IacPool(_poolAddress).hopDeposit(currentAmount, _recipient, _userLastDepositTime, _userMandatoryTime);
