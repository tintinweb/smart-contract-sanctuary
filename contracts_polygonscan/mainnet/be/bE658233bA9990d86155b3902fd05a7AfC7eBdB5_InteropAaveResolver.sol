...
abstract contract Helpers is DSMath, Variables {
    ...
    function checkSupplyToken(address userAddress, AaveData memory data) public view returns (
        uint256 totalSupply,
    ...
    function checkLiquidityToken(address user, address[] memory tokens) public view returns (
        uint256 totalSupply,
        uint256 totalBorrow,
        uint256 totalMaxBorrow,
        uint256 totalMaxLiquidation
    ...
    function checkBorrowToken(address userAddress, AaveData memory data) public view returns (
        uint256 totalBorrow,
        bool isNotOk
    ) {
    ...
    */
    function _checkRatio(
        ...
        (positionData.totalSupply, totalMaxBorrow, totalMaxLiquidation, isSupplyNotOk) = 
            checkSupplyToken(userAddress, data);
        (positionData.totalBorrow, isBorrowNotOk) =
            checkBorrowToken(userAddress, data);
