...
contract TheAceClub is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 150; // max allowed to mint at one time N.O.T.E must be => than line 1241 - mint(msg.sender, 10);
