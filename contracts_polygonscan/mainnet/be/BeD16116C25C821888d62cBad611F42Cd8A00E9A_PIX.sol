...
contract PIX is IPIX, ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    mapping(uint256 => DropInfo) dropInfos;
    mapping(uint256 => uint256[]) relatedDrops;
    mapping(uint256 => mapping(uint256 => bool)) relatedDropsStatus;
    mapping(uint256 => mapping(uint256 => uint256)) packsPurchased;
    mapping(address => PackRequest) packRequests;
