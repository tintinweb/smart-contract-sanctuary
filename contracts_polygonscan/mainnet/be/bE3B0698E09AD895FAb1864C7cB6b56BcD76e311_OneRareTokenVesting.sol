...
contract OneRareTokenVesting is ITokenVesting, Ownable, VestingConfig {
    ...
    function getClaimableTokens(Round roundType_, address account_) public view returns (uint256) {
        RoundInfo memory round = roundInfo[roundType_];
    ...
    function getAllRoundInfo() external view returns (RoundInfo[7] memory roundInfos) {
        for (uint256 i = 0; i < 7; i++) {
            roundInfos[i] = roundInfo[Round(i)];
        }
    }

    function getInvestorInfoForAllRounds(address investor_) external view returns (Investor[7] memory investorInfos) {
        for (uint256 i = 0; i < 7; i++) {
            investorInfos[i] = investorInfo[Round(i)][investor_];
        }
    }

    function getClaimableTokensForAllRound(address investor_)
        external
        view
        returns (uint256[7] memory claimableTokens)
    {
        for (uint256 i = 0; i < 7; i++) {
            claimableTokens[i] = getClaimableTokens(Round(i), investor_);
        }
    }
...
interface ITokenVesting {
    ...
    function getAllRoundInfo() external view returns (VestingConfig.RoundInfo[7] memory roundInfos);

    function getInvestorInfoForAllRounds(address investor_)
        external
        view
        returns (VestingConfig.Investor[7] memory investorInfos);

    function getClaimableTokensForAllRound(address investor_) external view returns (uint256[7] memory claimableTokens);
...
contract VestingDetails {
  ...
  */
    ...
    uint256 internal constant _SEED_CLIFF_PERIOD = 30 days;
    uint256 internal constant _SEED_VESTING_PERIOD = 1;
    uint256 internal constant _SEED_NO_OF_VESTINGS = 450 days;
  ...
  */
    ...
    uint256 internal constant _PRIVATE1_CLIFF_PERIOD = 30 days;
    uint256 internal constant _PRIVATE1_VESTING_PERIOD = 1;
    uint256 internal constant _PRIVATE1_NO_OF_VESTINGS = 360 days;
  ...
  */
    ...
    uint256 internal constant _PRIVATE2_CLIFF_PERIOD = 30 days;
    uint256 internal constant _PRIVATE2_VESTING_PERIOD = 1;
    uint256 internal constant _PRIVATE2_NO_OF_VESTINGS = 270 days;
    ...
    no of vestings : 1
  */
    uint256 internal constant _PUBLIC_SUPPLY_PERCENT = 125;
    uint256 internal constant _PUBLIC_INITIAL_RELEASE_PERCENT = 5000;
    uint256 internal constant _PUBLIC_CLIFF_PERIOD = 30 days;
    ...
    single vesting period : 1 (single vesting period is of 1 sec)
    no of vestings : sec in 18 months  (as for each sec tokens will be released)
  */
    uint256 internal constant _TEAM_SUPPLY_PERCENT = 2000;
    uint256 internal constant _TEAM_INITIAL_RELEASE_PERCENT = 0;
    uint256 internal constant _TEAM_CLIFF_PERIOD = 180 days;
    uint256 internal constant _TEAM_VESTING_PERIOD = 1;
    uint256 internal constant _TEAM_NO_OF_VESTINGS = 540 days;
  ...
  */
    ...
    uint256 internal constant _ECOSYSTEM_CLIFF_PERIOD = 30 days;
    uint256 internal constant _ECOSYSTEM_VESTING_PERIOD = 1;
    uint256 internal constant _ECOSYSTEM_NO_OF_VESTINGS = 630 days;
    ...
    no of vestings : sec in 21 months  (as for each sec tokens will be released)
  */
    uint256 internal constant _RESERVES_SUPPLY_PERCENT = 2375;
    uint256 internal constant _RESERVES_INITIAL_RELEASE_PERCENT = 2000;
    uint256 internal constant _RESERVES_CLIFF_PERIOD = 30 days;
    uint256 internal constant _RESERVES_VESTING_PERIOD = 1;
    uint256 internal constant _RESERVES_NO_OF_VESTINGS = 630 days;
}