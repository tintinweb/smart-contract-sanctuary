...
// File: Vault\StrategyCafeswapPbrewWethCafeswap.sol

// openzeppelin v3.1.0

contract StrategyCafeswapPbrewWethCafeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        earnedToToken1Path = [address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09)];
        token0ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09)];
