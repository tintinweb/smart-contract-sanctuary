...
// File: Vault\StrategyGravityLinkWethGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityLinkWethGravity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x0053e0bca35ec356bd5dddfebbd1fc0fd03fabad39)];
        earnedToToken1Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        token0ToEarnedPath = [address(0x0053e0bca35ec356bd5dddfebbd1fc0fd03fabad39), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        token1ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
