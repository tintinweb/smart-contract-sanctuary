...
contract StrategyMasterchefDouble is BaseStrategyLP {
    ...
    address[] public wmaticToSandManPath;
    ...
    constructor(
        ...
        address[] memory _wmaticToSandManPath,
        ...
        vaultChefAddress = 0x53A4eD129bA4a78557AC6410a4fCF00f9367B8F9; // Stack too deep
        ...
        wmaticToSandManPath = _wmaticToSandManPath;
    ...
    function buyBack(uint256 _earnedAmt, address _earnedAddress) internal returns (uint256) {
        if (buyBackRate > 0) {
            ...
            _safeSwap(
                buyBackAmt,
                _earnedAddress == wmaticAddress ? wmaticToSandManPath : earnedToSandManPath,
                buyBackAddress
            );
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant sandManAddress = 0xbA8a888b39946b4A576bA64c63b3e73c6C081062;
    address public constant rewardAddress = 0xB11D23506099aCfb2e0a88134eCAF8FC58a3040d;
