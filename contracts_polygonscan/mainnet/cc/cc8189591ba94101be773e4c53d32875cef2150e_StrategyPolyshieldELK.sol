...
// File: Vault\StrategyPolyshieldELK.sol

// openzeppelin v3.1.0

contract StrategyPolyshieldELK is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e), address(0x00e1c110e1b1b4a1ded0caf3e42bfbdbb7b5d7ce1c)];
        earnedToToken1Path = [address(0x00f239e69ce434c7fb408b05a0da416b14917d934e)];
        token0ToEarnedPath = [address(0x00e1c110e1b1b4a1ded0caf3e42bfbdbb7b5d7ce1c), address(0x00f239e69ce434c7fb408b05a0da416b14917d934e)];
