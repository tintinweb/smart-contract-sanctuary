...
//Answer is divided into four strings(without apostrophes🤣🤣🤣🤣🤣) in the format
/**
x
x
x
...
//1: all things have a beginning, in which second was the web3bridge website found(remember to convert to unix timestamps)⌛
//Tool: https://www.whois.com/

//2: The first web3bridge(Blokeducare) designer🖌️..use twitter username without @
//Tool: Twitter

//3: One of the first web3bridge mentors(a female)👩🏿‍💻...use twitter username without @
//Tool: Twitter
...
constructor() {
emit Start(unicode"Game Deployed💣💣💣💣💣💣💣💣💣💣");
}
