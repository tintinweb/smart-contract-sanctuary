...
contract BreedFee is Privileged {
    event BreedEth(address indexed breedee, uint256 indexed price, uint256 indexed breedeeFee);
    event BreedSeed(address indexed breedee, uint256 indexed price, uint256 indexed breedeeFee);
    ...
    function breedEth(address _breedee, uint256 _itemId, bytes _varData) external payable {
        ...
        emit BreedEth(_breedee, ethPrice, breedeeFeeEth);
    }
    ...
    function breedSeed(address _breedee, uint256 _itemId, bytes _varData) external {
        ...
        emit BreedSeed(_breedee, seedPrice, breedeeFeeSeed);
    }
