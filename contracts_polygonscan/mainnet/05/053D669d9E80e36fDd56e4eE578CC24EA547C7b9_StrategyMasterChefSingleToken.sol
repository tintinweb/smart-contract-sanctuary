...
/**
 *Submitted for verification at FtmScan.com on 2021-05-14
*/
...
contract StrategyMasterChefSingleToken is StratManager, FeeManager {
    ...
    function chargeFees() internal {
        uint256 toWrapped = IERC20(want).balanceOf(address(this)).mul(profitFee).div(MAX_FEE);
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(toWrapped, 0, wantToWrappedRoute, address(this), now);
