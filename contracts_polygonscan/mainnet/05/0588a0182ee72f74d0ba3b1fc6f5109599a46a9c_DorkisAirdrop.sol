...
// File: contracts/DorkisAirdrop.sol
...
/**
 * @title Dorkis Airdrop automater
 * @dev Extends ERC1155 
 */

contract DorkisAirdrop is ERC1155, ERC1155Burnable, ERC1155Pausable, Ownable {
    using Strings for uint256;
    mapping(uint256 => uint256) private _totalSupply;
    string private _contractURI;
    address public minterAddress;

    constructor() ERC1155("ipfs://Qmc6wH1RoWAGjGjkbEFb9PmFV2yTtw3g5G5pzKzgVPSpmL/") {
        minterAddress=owner();
    }
    ...
    modifier onlyMinter {
	    require(minterAddress == msg.sender || owner() == msg.sender, "You must have the Minter or Owner role");
	    _;
    }
