...
contract TesterQuickSwap is Ownable, ReentrancyGuard, Pausable { 
    ...
    address public constant galaxyAddress= 0xb3faD2Bc5E32F096b66B24F15c0df5a683e1908b;   
    address public constant vaultAddress = 0x8CA19cE76fB2d55E6A9AfDbb38e05A647663a7eE;   
    address public constant burnAddress  = 0x000000000000000000000000000000000000dEaD;   
    address public constant feeAddress   = 0x8CA19cE76fB2d55E6A9AfDbb38e05A647663a7eE;   
    address public constant rewardAddress= 0x7a247D6278a699c90cf09ddC6596FDdDaF545B36;
    ...
    address[] public earnedToUsdcPath   = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174];   
    address[] public earnedToGalaxyPath = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0xb3faD2Bc5E32F096b66B24F15c0df5a683e1908b]; 
    address[] public earnedToToken0Path = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270]; 
    address[] public earnedToToken1Path = [0x831753DD7087CaC61aB5644b308642cc1c33Dc13,0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174]; 
    address[] public token0ToEarnedPath = [0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270,0x831753DD7087CaC61aB5644b308642cc1c33Dc13]; 
    address[] public token1ToEarnedPath = [0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174,0x831753DD7087CaC61aB5644b308642cc1c33Dc13]; 

    constructor() public {
        govAddress = msg.sender;
        masterChefAddress = 0x309C47F09f128d22c3C8b7168999A7545201BA92;
    ...
    function withdraw(uint256 _wantAmt) external onlyOwner nonReentrant returns (uint256) {
        ...
        if(withdrawFee > 0) { IERC20(wantAddress).safeTransfer(vaultAddress, withdrawFee); }    
