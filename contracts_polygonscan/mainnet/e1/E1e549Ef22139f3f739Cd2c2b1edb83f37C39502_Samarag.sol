...
contract Samarag is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xba91bAd90F0F499A799D7aF640C52B315c38a233); // Marketing Address
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
           { 
               ...
               require((balanceOf(address(to)) + amount) <= _maxWalletLimit, "Exceeds maximum tokens allowed per wallet" );
               }
        // buy
        if (
            from == uniswapV2Pair &&
