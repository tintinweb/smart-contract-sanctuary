...
contract Test is Ownable, PolygonArbitrageBot {
    ...
    function getUSDCpBREW() view external returns(PolygonArbitrageOptionABICompatible memory)
    {
        PolygonArbitrageOption memory option = _polygonArbitrageBotFindOption(kPolygonToken.usdc, kPolygonToken.pbrew, 10000);
