...
contract GovStakingStorage is Ownable {
	...
	/*function resetInactiveMultipliers(address[] calldata users) external isAllowed {
		for (uint i = 0; i < users.length; i++) {
			removeRewardMultiplier(users[i]);
		}
	}*/
	...
	// views
	function getTotalLockedGogo() public view returns (uint256) {
