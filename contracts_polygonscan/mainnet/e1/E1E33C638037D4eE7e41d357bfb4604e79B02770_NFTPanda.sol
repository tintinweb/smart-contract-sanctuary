...
contract NFTPanda is Ownable, ERC721, ERC721URIStorage, ContextMixin, NativeMetaTransaction, ReentrancyGuard {
    ...
    string private ercName = "DZV2D17";
    string private ercSymbol = "DZV2D17";
    ...
    function withdraw(address payable  _withdrawAddress, uint256 total ) external onlyOwner {
        _withdrawAddress.transfer(total);
    }
