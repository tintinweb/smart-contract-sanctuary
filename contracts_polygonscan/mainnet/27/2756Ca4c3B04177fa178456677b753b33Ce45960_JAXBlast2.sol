...
contract JAXBlast2 is Album {
    ...
    /**
        @notice Registers the Pool name as Arturo Rhythm & Soul”,
    ...
    */
    ...
    Album(1070, "Arturo Rhythm & Soul",// solhint-disable-line func-visibility
    ...
    */
    function rewardRate(uint256 epoch) public pure override returns (uint256) {
        ...
        if (epoch >= 1070) {
            ...
            } else if (epoch >= 1112 && epoch <= 1153) {
                seriesRewards = 25000;// 25,000
            } else if (epoch >= 1154 && epoch <= 1195) {
                seriesRewards = 15000;// 15,000
            } else if (epoch >= 1196 && epoch <= 1237) {
    ...
    */
    function rewardRate2(uint256 epoch) public pure override returns (uint256) {
        require(epoch >= 1070, "epoch cannot be below 1070");
        if (epoch > 1321) {
            return 0;
        } else {
