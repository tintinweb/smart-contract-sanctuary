...
contract FantasyDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FantasyDoge";
    string constant _symbol = "FTD";
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack(bool sell) internal swapping {

        uint256 totalFee = sell ? totalSellFee : totalBuyFee;
        uint256 liquidityFee = sell ? liquiditySellFee : liquidityBuyFee;
        uint256 reflectionFee = sell ? reflectionSellFee : reflectionBuyFee;
        uint256 marketingFee = sell ? marketingSellFee : marketingBuyFee;
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
