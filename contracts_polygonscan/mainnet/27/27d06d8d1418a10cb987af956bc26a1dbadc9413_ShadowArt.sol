...
/**
 *
 * This file is part of ShadowArt project.
 * by Jagat Token (jagatoken.com)
 *
 *
 */
...
contract ShadowArt is ERC721Enumerable, HasRoot, HasAdmin, SigVerifier {
    ...
    function mint(address to, uint32 count, uint64 nonce, Sig memory sig) external payable returns (bool) {
        uint256 amount = msg.value;
        require(count > 0, "Count must be greater than 0");
        // require(amount >= mintPrice, "Not enough balance to pay");
