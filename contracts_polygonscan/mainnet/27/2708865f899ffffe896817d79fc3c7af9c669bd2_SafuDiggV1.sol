...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SAFUDV2";
    string internal constant SYMBOL = "SAFUDV2";
    ...
    //uint256 public constant TOTAL_SUPPLY = 80000000 * ZEROES;
    uint256 internal _reflectedSupply = (MAX - (MAX % TOTAL_SUPPLY));
    //uint256 public pub_TotalSupply = TOTAL_SUPPLY;
    ...
    uint256 public maxWalletBalance = TOTAL_SUPPLY / 100; // 1% of the total supply
    ...
    uint256 public numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 50000; // 0.1% of the total supply
    /////////////// FOR TEST - USING 50,000 instead of 1000, most likely use 2500 for the final live
    ...
    /* these addresses should be editable so we can use automated distribution contracts in the future*/
    ...
    address public marketingAddress = 0x2eA5ae76d1b6061f1f63Ecd08b4B33AFC705b7e6;
    address public vipAddress = 0x9730daF5DaBb2a2093B2b6E7780240dbd1BB46a8;
    address public thrillAddress = 0x5e41e9918CDC4d660d15d85A9018939e6930C0cc;
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    */
    ...
    /*
    * @dev added the ability to modify these params because depending on trading volume,
    * having a lower amount swapped, may be benficial and improve price stability.
    * 
    */
    function update_maxTransactionAmount(uint256 _newAmount) external onlyOwner {
       uint256 newAmount = _newAmount;
        require(newAmount <= 80000000000000 / 100, "The max can never be > 1%");
            maxTransactionAmount = newAmount;
    }
    
    /*
    function update_maxWalletBalance(uint256 newAmount) external onlyManager() {
            //require (msg.sender == address(owner), "Only the owner can execute this");
            require(newAmount <= 80000000000000 / 100, "The max can never be > 1%");
                maxWalletBalance = newAmount;
    }
    */
    
    function update_numberOfTokensToSwapToLiquidity(uint256 newAmount) external onlyOwner {
            require(newAmount <= (80000000000000 / 1000), "The max can never be > 0.1%");
                numberOfTokensToSwapToLiquidity = newAmount;
    }


// ENABLE UPDATE OF ADDRESSES TO ENABLE AUTO DISTRIBUTION IN THE FUTURE
    function update_marketingAddress(address _myAddress)  public onlyOwner{
            marketingAddress = _myAddress;
    }
    function update_vipAddress(address _myAddress)  public onlyOwner{
            vipAddress = _myAddress;
    }
    function update_thrillAddress(address _myAddress)  public onlyOwner{
            thrillAddress = _myAddress;
    }
