...
contract StarToken is ERC20("StarSeed Token", "STAR"), ERC20Burnable, Ownable {
    ...
    uint256 public transferFee = 333;
    
    address public feeAddress = address(0);
    
    mapping(address => bool) whitelisted;
    
    function setWhitelisted(address _address, bool _enabled) external onlyOwner {
        whitelisted[_address] = _enabled;
    }
    ...
    function transfer(address to, uint256 amount) public override returns (bool) {
        if (whitelisted[to] == true) {
            ...
            return super.transfer(to, _transferFee(amount, msg.sender));
        }
    }
    ...
    function transferFrom(address from, address to, uint256 amount) public override returns (bool) {
        if (whitelisted[to] == true) {
            ...
            return super.transferFrom(from, to, _transferFee(amount, from));   
        }
    }

    function _transferFee(uint256 amount, address from) internal returns (uint256) {
