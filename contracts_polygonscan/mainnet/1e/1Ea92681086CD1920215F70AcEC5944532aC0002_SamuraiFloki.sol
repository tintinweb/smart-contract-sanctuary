...
contract SamuraiFloki is Context, Ownable, ERC20 {
    ...
    uint256 public SamuraiflokiPerTokenId = 10000 * (10**decimals());
    ...
    */
    ...
    constructor() Ownable() ERC20("Samurai Floki", "SAMURAIFLOKI") {
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, SamuraiflokiPerTokenId);
    }
    ...
    function daoSetSamuraiflokiPerTokenId(uint256 samuraiflokiDisplayValue)
        public
        onlyOwner
    {
        SamuraiflokiPerTokenId = samuraiflokiDisplayValue * (10**decimals());
    }

    function daoSetSeasonAndSamuraiflokiPerTokenID(
        uint256 season_,
        uint256 samuraiflokiDisplayValue
    ) external onlyOwner {
        daoSetSeason(season_);
        daoSetSamuraiflokiPerTokenId(samuraiflokiDisplayValue);
    }
}