...
contract OneMlnNfts is Context, ERC721Enumerable {
    ...
    constructor(ERC20Burnable _mil) ERC721('OneMlnNFTs', 'MIL') {
    ...
    function baseTokenURI() public pure returns (string memory) {
        return "https://polygon.1mlnnfts.com/api/nft/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://polygon.1mlnnfts.com/api/project-info";
    }
    ...
    function payForInfoAndColors(uint256 totalPrice) public {
        ...
        if (totalPrice > 0) {
            mil.transferFrom(address(tx.origin), deadwallet, totalPrice / 2);
    ...
    function setInfo(uint256 id, string memory title, string memory ownerURL) public {
        ...
        if (msg.sender != free) {
            mil.transferFrom(address(tx.origin), deadwallet, 500000000000000000);
    ...
    function setInfoAndColors(uint256 id, string memory title, string memory ownerURL, uint256[100] memory colors) public {
        ...
        if (msg.sender != free) {
            mil.transferFrom(address(tx.origin), deadwallet, 1000000000000000000);
