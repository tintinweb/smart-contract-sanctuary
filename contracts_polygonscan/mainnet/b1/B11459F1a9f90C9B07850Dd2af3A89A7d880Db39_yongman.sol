...
//
//contract yongman is ERC721Enumerable, ReentrancyGuard, Ownable {
//  // Phrases of Weapons
...
//  string[] private exploiters ;
//
//  string[] private sleepPlace ;
//
...
//  function getexploiters(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "exploiters", exploiters);
//  }
//
...
//  // a loot bag has
//  function getsleepPlace(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "sleepPlace", sleepPlace);
//  }
//
...
//  }
//
//  function getFoods(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "foods", foods);
//  }
//
//  function getdaily(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "daily", daily);
//  }
//
//  function getwork(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "work", work);
//  }
//
...
//  }
//
//  function getcause(uint256 tokenId) public view returns (string memory) {
//    return pluck(tokenId, "cause", cause);
//  }
//
...
//    parts[1] = getexploiters(tokenId);
//
//    parts[2] = '</text><text x="10" y="40" class="base">';
//
//    parts[3] = getsleepPlace(tokenId);
//
//    parts[4] = '</text><text x="10" y="60" class="base">';
//
//    parts[5] = getclothes(tokenId);
//
//    parts[6] = '</text><text x="10" y="80" class="base">';
//
//    parts[7] = getFoods(tokenId);
//
//    parts[8] = '</text><text x="10" y="100" class="base">';
//
//    parts[9] = getdaily(tokenId);
//
//    parts[10] = '</text><text x="10" y="120" class="base">';
//
//    parts[11] = getwork(tokenId);
//
//    parts[12] = '</text><text x="10" y="140" class="base">';
//
//    parts[13] = getspirit(tokenId);
//
//    parts[14] = '</text><text x="10" y="160" class="base">';
//
//    parts[15] = getcause(tokenId);
//
//    parts[16] = "</text></svg>";
//
...
//    require(tokenId > 2999 && tokenId < 3500, "Token ID invalid");
...
//
//  constructor(
//    string[] memory _exploiters,
//    string[] memory _sleepPlace,
//    string[] memory _clothes,
//    string[] memory _foods,
//    string[] memory _daily,
//    string[] memory _work,
//    string[] memory _spirit,
//    string[] memory _cause
//  ) ERC721("yongman", "YMZH") Ownable() {
//    exploiters=_exploiters;
//    sleepPlace=_sleepPlace;
//    clothes=_clothes;
//    foods=_foods;
//    daily=_daily;
//    work=_work;
...
contract yongman is ERC721Enumerable, ReentrancyGuard, Ownable {
 ...
 uint32 public set_left_times=1;
 ...
 function init(
    ...
    string[] memory _cause
     ...
     require(set_left_times>0,"set times run out!!!");
     exploiters=_exploiters;
    sleepPlace=_sleepPlace;
    clothes=_clothes;
    foods=_foods;
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "Bag #',
            toString(tokenId),
            '", "description": "yongman is a description of the Chinese beat generation of young people text NFT, can be free to receive.", "image": "data:image/svg+xml;base64,',
            Base64.encode(bytes(output)),
            '"}'
          )
        )
