...
contract ERC721Child is Initializable, ContextMixin, ERC721Upgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, ERC721URIStorageUpgradeable, NativeMetaTransaction {
    ...
    modifier onlyChainManager() {
        require(chainManagerAddress == _msgSender(), "Ownable: caller is not the chainManagerAddress");
        _;
    }

    function initialize(string memory _name, string memory _symbol, address _proxyRegistryAddress, address _chainManagerAddress) initializer public {
    ...
    function setChainManager(address _chainManagerAddress) public onlyOwner {
        chainManagerAddress = _chainManagerAddress;
    }
    ...
    function setTokenMetaURI(string memory _tokenMetaURI) public onlyOwner {
        tokenMetaURI = _tokenMetaURI;
    }

    function setContractMetaURI(string memory _contractMetaURI) public onlyOwner {
