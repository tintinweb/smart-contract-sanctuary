...
// File: Vault\StrategyDinoswapDinoWethQuickswap.sol

// openzeppelin v3.1.0

contract StrategyDinoswapDinoWethQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619)];
        earnedToToken1Path = [address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394)];
        token0ToEarnedPath = [address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394)];
        token1ToEarnedPath = [address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00aa9654becca45b5bdfa5ac646c939c62b527d394)];
    }
