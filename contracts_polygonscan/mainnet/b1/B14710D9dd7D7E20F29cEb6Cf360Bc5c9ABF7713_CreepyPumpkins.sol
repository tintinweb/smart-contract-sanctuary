...
contract CreepyPumpkins is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint public availableToken = 1530;
    uint256 public constant price = 40 ether;
    uint public constant maxPurchaseSize = 5;
    ...
    constructor(string memory theBaseURI, address theOwner1, address theOwner2, uint numToken, bool debug) ERC721("CreepyPumpkins", "CREEPYPUMPKIN")  {
    ...
    function mintPumpkins(uint _count) public payable saleIsOpen notPaused notRevealed {
        require(_count > 0, "You can't mint 0 CreepyPumpkins");
    ...
    function contractURI() public pure returns (string memory) {
        return "https://creepypumpkinsnft.com/contract-info.json";
    }
