...
contract Private is Ownable{
    ...
    uint8[] internal ratioAfterRound;
    ...
    **/
    ...
    constructor(address _token) {
        ...
        validClaimTime.push(0); // 0
        validClaimTime.push(TGE); // TGE
        validClaimTime.push(TGE + 6*3600); // 24th hour
        validClaimTime.push(TGE + 12*3600); // 30th hour
        validClaimTime.push(TGE + 18*3600); // 36th hour
