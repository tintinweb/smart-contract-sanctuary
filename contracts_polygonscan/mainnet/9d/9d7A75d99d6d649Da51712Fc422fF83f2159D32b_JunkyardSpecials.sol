...
contract JunkyardSpecials is ERC1155, Whitelist, JunkyardDroppable1155 {
    using Strings for string;
    string internal cURI = "https://api.junkyarddogs.io/contract/";
    mapping(uint256=>string) public specials;
    constructor() ERC1155("") {
      specials[1] = "ipfs://Qma1qwX2pnk6W4HXb5wDXsarhtsx7XMbofQhrGKhA5V95K";
    }

    function mint(address holder, uint256 tokenId, uint256 amount) public override isWhitelisted {
      _mint(holder, tokenId, amount, "");
    }

    function uri(uint256 tokenId) public view override returns (string memory) {
      return specials[tokenId];
    }
    ...
    function setSpecialToken(uint256 tokenId, string memory newURI) public onlyOwner {
      specials[tokenId] = newURI;
    }
