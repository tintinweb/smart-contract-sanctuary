...
contract rugyourmom is Reflectable {
    string private constant _name = "PLZDUMPSER";
    string private constant _symbol = "PLZDUMPSER";
    ...
    uint256 private constant _redistributionPercent = 1;
