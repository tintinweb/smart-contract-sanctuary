...
contract PolyLoki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1C4f1a9E1A0D6D58DceB8Bf3e44686342d5F0f3C); // Marketing Address
    ...
    string private _name = "PolyLoki";
    string private _symbol = "PolyLoki";
