...
contract BaseAprOracle is Ownable, IAprOracle, CoreUtility {
    string public name;
    uint256 public timestamp;
    uint256 public currentDailyRate;
    uint256 public futureDailyRate;

    constructor(string memory name_, uint256 baseDailyRate_) public {
        name = name_;
        timestamp = block.timestamp;
        futureDailyRate = baseDailyRate_;
        currentDailyRate = baseDailyRate_;
    }

    function updateDailyRate(uint256 newDailyRate) public onlyOwner {
        futureDailyRate = newDailyRate;
    }
