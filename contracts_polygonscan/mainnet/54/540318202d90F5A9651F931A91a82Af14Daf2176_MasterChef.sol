...
TBT online --- Need to be able to upgrade lytpus address in the future and start with dead address
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function deposit(uint256 _pid, uint256 _amount, address _referrer, bool _lyptusFee) public nonReentrant {
        ...
        if (address(lyptus) == 0x000000000000000000000000000000000000dEaD) { // TODO need test
            _lyptusFee=false;
        }
