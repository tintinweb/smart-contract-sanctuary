...
contract District is ERC721Upgradeable, OwnableUpgradeable, IDistrict, NativeMetaTransaction{
    ...
    mapping(uint256=>bytes1[]) public districtNameOf;
    ...
    function setDistrictName(uint256 district_id, bytes1[] memory districtName) external {
        ...
        for(uint256 i = 0; i < districtName.length; i++){
            require(districtName[i] < 0x40, "invalid character");
