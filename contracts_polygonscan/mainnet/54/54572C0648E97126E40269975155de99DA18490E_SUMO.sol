...
contract SUMO is ERC721, ERC721Enumerable, Ownable, ERC2981ContractWideRoyalties {
  ...
  using Strings for uint256;
    ...
    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;//mintable royalty interface
    ...
    function setTokenURI(uint mintIndex) internal {
        ...
        _tokenUri[mintIndex] = bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI, ( mintIndex + 1 ).toString(), baseExtension))
            : "";
    }
