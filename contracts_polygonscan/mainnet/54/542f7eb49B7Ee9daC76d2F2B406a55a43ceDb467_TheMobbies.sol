...
contract TheMobbies is ERC721Enumerable, Ownable {
    
    using Strings for uint256;
    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.035 ether;
    uint256 public constant maxSupply = 9306;
    //private
    uint256 private _numAvailableTokens = 9306;
    uint256[9306] private _availableTokens;
   ...
   constructor(
    ...
    function mint(uint256 _mintAmount) public payable minimumMintAmount(_mintAmount) {
        ...
        require(_mintAmount <= maxMintAmount, "You can not mint more than 50 Mobbies!");
        require(msg.value >= cost * _mintAmount, "insufficient fund!");
        require(balanceOf(msg.sender) + _mintAmount <= maxMintAmount, "You can mint max 50 NFT!");
