...
contract BaseStrategyRewardPairNonReentrant is BaseStrategyStakingRewards {
...
contract StrategyElkPair is BaseStrategyRewardPairNonReentrant {

    address public constant ELK_TOKEN = 0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C;
    address public constant ELK_ROUTER = 0xf38a7A7Ac2D745E2204c13F824c00139DF831FFf;

    constructor(address rewards, address lp, address otherToken, address strategist)
        public
        BaseStrategyRewardPairNonReentrant(
            rewards,
            lp,
            otherToken,
            ELK_TOKEN,
