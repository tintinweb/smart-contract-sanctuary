    ...
    function accruePerformanceFee() public {
        ...
        if(performanceFee>0) {
            ...
            */
            ...
            console.log("start of perffee");

            // total gains = deposit minus withdrawal;
            console.log("totalTokenLocked %s, totalDeposit %s, totalWithdraw %s",totalTokenLocked, totalDeposit, totalWithdraw );
            uint256 totalGain = totalTokenLocked.add(totalWithdraw).sub(totalDeposit);

            if(totalGain>0){
                console.log("part 1 total gain: %s, performanceFee: %s, ", totalGain, performanceFee);
