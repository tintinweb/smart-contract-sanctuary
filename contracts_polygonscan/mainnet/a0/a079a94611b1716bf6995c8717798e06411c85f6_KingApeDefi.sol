...
// File: contracts/KingApeDefi.sol


pragma solidity ^0.8.0;


contract KingApeDefi is Context, IERC20, Ownable {
...
contract KingApe is KingApeDefi , NativeMetaTransaction, ContextMixin {
    constructor() KingApeDefi () {
