...
interface IPearzap {
    ...
    function userInfo(uint256 _pid, address _address) external view returns (uint256, uint256, uint256, uint256, uint256);
...
// File: Vault\StrategyPearzapPearWmaticWault.sol

// openzeppelin v3.1.0

contract StrategyPearzapPearWmaticWault is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWmaticPath = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];        
        earnedToUsdcPath = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174)];
        earnedToSiriusPath = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        earnedToToken0Path = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
        token1ToEarnedPath = [address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00c8bcb58caef1be972c0b638b1dd8b0748fdc8a44)];
    }
    
    function stake(uint256 _wantAmount) internal virtual override{
        IPearzap(masterChef).deposit(pid, _wantAmount, referralAddress);
    }

    function harvest() internal virtual override{
        IPearzap(masterChef).deposit(pid, 0, referralAddress);
    }

    function unstake(uint256 _amount) internal virtual override{
        IPearzap(masterChef).withdraw(pid, _amount);
    } 
    function emergencyWithdraw() internal virtual override onlyOperator {
        IPearzap(masterChef).emergencyWithdraw(pid);
    }   
    
    function vaultSharesTotal() public virtual override view returns (uint256) {
        (uint256 balance, , , , ) = IPearzap(masterChef).userInfo(pid, address(this));
        return balance;
    } 
}