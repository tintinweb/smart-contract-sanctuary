...
/**
 * Сheerkat meerkats mint pass - 40% discount
...
contract MintPassToMeerkatsClub is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("MintPass to Meerkats Club", "MintPassCMC")  {
        setBaseURI(baseURI);
    }
