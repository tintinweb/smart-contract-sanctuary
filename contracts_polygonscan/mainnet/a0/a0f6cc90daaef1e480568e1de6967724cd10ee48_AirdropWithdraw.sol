...
contract AirdropWithdraw is TransferOwnable {   
    ...
    address public withdrawAddress = 0x8dbac5D14a395a7D0341C1d3b44182d066cf2Bbb;
    ...
    uint public blocknumberLength = 0;
    mapping(uint => uint256) public blocknumberInfo;
    ...
    function withdraw(uint256 _timestamp, uint256 _amount, uint256 _dateline, uint256 _r,uint256 _s, uint256 _v) external { 
        ...
        */
        ...
        if(ec_recover == withdrawPublicKey){ 
            ...
            blocknumberInfo[blocknumberLength++]=block.number;
        }  
