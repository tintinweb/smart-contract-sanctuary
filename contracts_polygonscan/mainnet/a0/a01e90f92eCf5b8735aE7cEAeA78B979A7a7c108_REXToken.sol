    ...
    ISuperToken
{
    ...
    function _move(
        ...
        private
    {
        RicochetToken._move(from, to, amount.toInt256());
        ...
        internal
    {
        ...
        RicochetToken._mint(account, amount);
        ...
        internal
    {
        ...
        RicochetToken._burn(from, amount);
 ...
 * @author Superfluid
 */
abstract contract RicochetToken is Ownable, ISuperfluidToken // Add ownable/role based
{
        ...
        external override
    {
        ...
        require(isLocked == false || (subId == 0 && units == 0 && publisher == owner()), "!unlocked");
