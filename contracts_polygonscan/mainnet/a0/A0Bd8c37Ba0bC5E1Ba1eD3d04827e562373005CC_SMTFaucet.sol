...
contract SMTFaucet {
    ...
    function send() external {
        ...
        // Next request from the address can be made only after 21600 minutes         
        nextRequestAt[msg.sender] = block.timestamp + (21600 minutes); 
        
        token.transfer(msg.sender,faucetDripAmount * 18**token.decimals());
    }  
