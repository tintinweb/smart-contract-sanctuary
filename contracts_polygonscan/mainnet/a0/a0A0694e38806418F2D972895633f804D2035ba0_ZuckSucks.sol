...
contract ZuckSucks is ERC20Vault {}
...
contract ERC20Vault is IVault, IERC20Vault, EIP712('Vault', '1.0.0'), ERC1271, OwnableByERC721, Initializable {
  ...
  /**
     ...
     */
  function initialize(uint256 tokenId) external override initializer {
