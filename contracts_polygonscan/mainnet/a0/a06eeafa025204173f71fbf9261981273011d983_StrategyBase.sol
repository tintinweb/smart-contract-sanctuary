...
abstract contract BaseStrategy is Ownable {
    ...
    // Dex
    address public constant currentRouter = 0xf38a7A7Ac2D745E2204c13F824c00139DF831FFf; //Elk router
...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant elk = 0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C;
    ...
    // Uniswap swap paths
    address[] public shield_elk_path;
    ...
    {
        shield_elk_path = new address[](2);
        shield_elk_path[0] = shield;
        shield_elk_path[1] = elk;
    }
    ...
    function harvest() public override {
        ...
        if (_shieldBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(shield_elk_path, _shieldBalancePost.div(2));

            // Add liquidity for Shield/Elk
            uint256 _shield = IERC20(shield).balanceOf(address(this));
            uint256 _elk = IERC20(elk).balanceOf(address(this));
            if (_shield > 0 && _elk > 0) {
                IERC20(elk).safeApprove(currentRouter, 0);
                IERC20(elk).safeApprove(currentRouter, _elk);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public SHIELD_Elk_LP = 0x4C7C0A328b75C990491edd68fF49D307212fe037;
