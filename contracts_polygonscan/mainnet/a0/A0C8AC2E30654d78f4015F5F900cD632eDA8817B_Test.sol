...
contract Test is Ownable, PolygonArbitrageBot {
    ...
    function smashIt(address _topLevelToken, uint256 _amount) external
    {
        _polygonArbitrageBotSmashIt(_topLevelToken, _amount);
    }
...
contract PolygonArbitrageBot is PolygonTradingHub {
    ...
    function _polygonArbitrageBotSmashIt(address _topLevelToken, uint256 _amount) internal returns(bool)
    {
        PolygonArbitrageOption memory bestOption = _polygonArbitrageBotGetBestOption(_topLevelToken, _amount);
