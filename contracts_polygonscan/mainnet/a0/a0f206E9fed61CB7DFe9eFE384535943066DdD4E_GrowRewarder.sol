...
contract GrowRewarder is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setGrowReward(address _GROW_STAKING_POOL) external onlyRole(CONFIGURATOR_ROLE) {
    ...
    function getRewardsFromPools(address[] memory poolAddresses) external {
        ...
        IGrowStakingPool(GROW_STAKING_POOL).depositToUser(reward, msg.sender);
    }
