...
import "../ProfitshareReward.sol";

contract StrategyBeluga_WBTC_WETH is ProfitshareRewardStrategy {
    ...
    function initializeStrategy(
        ...
        address farmContract = address(0xf5E5e15dA3763d52E6D8b7e003645069F36EFE2c);
        address beluga = address(0x47536F17F4fF30e64A96a7555826b8f9e66ec468);
        ...
        address bwbtc_weth_lp = address(0xb8861BB56af421CA85c4Be34b24d9A44128B60D8);
        __Strategy_init(
            _store,
            beluga,
            _vault,
...
/// @title Profitshare Reward Strategy
/// @author Chainvisions
/// @notice Strategy to handle preparing profitshare rewards for stakers.

contract ProfitshareRewardStrategy is BaseUpgradeableStrategy {
    ...
    */
    function withdrawAllToVault() public restricted {
        if(rewardPool() != address(0)) {
            // Check needed to prevent reversion (if we've pulled an emergency exit and need to withdraw all).
            if(_rewardPoolStake() > 0) {
    ...
    */
    function withdrawToVault(uint256 amount) public restricted {
        ...
        if(amount > IERC20(underlying()).balanceOf(address(this))){
            ...
            IRewardPool(rewardPool()).withdraw(Math.min(_rewardPoolStake(), needToWithdraw));
        }
