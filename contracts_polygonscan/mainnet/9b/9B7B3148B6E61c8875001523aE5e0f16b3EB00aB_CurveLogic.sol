...
contract CurveLogic is Helpers {
	 ...
	 * @param setValue set dest tokens received to memory contract
	 */
	function swap(
		ICurvePool pool,
		address src,
	 ...
	 * @param getValue read value from memory contract
	 * @param setValue set LP tokens received to memory contract
	 */
	function addLiquidity(
		ICurvePool pool,
		IERC20 token, // CHANGE THIS! read token from inside the function
		uint256 amount,
	 ...
	 * @param tokenId id of the token to remove liq. Should be 0, 1 or 2
	 * @param getValue read value of amount from memory contract
	 * @param setValue set value of tokens received in memory contract
	 */
