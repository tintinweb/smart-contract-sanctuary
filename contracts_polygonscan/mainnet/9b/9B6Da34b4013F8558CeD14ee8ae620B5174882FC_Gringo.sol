...
contract Gringo is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 GRINGO
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("GRINGO", "GRINGO") {
        _mint(msg.sender, 1 ether); // mint 1 GRINGO Share for initial pools deployment
