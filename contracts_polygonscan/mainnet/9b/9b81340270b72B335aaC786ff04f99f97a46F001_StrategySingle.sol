...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_harvestBalance > harvestCutoff){
            ...
            _swapUniswapWithPathForFeeOnTransferTokens(gfi_ust_path, _harvestBalancePost2);
            ...
            if (_usdc > 0 && _ust > 0) {
                ...
                IERC20(ust).safeApprove(currentRouter, 0);
                IERC20(ust).safeApprove(currentRouter, _ust);
...
contract StrategySingle is StrategyFarmSingle {
    // Token addresses
    address public GFI_MASTER_CHEF = 0xFa51C6CBe06E1Ec6eb9D1E72bd315067fC977dFF;
    address public Want_Token = 0xE507A93b99120d916229ee6d4aDB4204bbb04Edc;
