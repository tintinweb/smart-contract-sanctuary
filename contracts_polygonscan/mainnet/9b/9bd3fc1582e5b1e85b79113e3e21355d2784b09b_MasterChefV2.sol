...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    struct PoolInfo {
        ...
        uint256 accMOONPerShare;   // Accumulated SWANs per share, times 1e12. See below.
    ...
    event UpdateEmissionRate(address indexed user, uint256 NabiPerBlock);
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 MOONReward = multiplier.mul(MOONPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        MOON.mint(devaddr, MOONReward.div(10));
