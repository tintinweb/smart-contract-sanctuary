...
contract DelightVipAccessPresale is Ownable, ReentrancyGuard {
    ...
    event SetDelightVipPresaleSize(uint256 newDelightVipPresaleSize);
    ...
    function setDelightVipPresaleSize(uint256 _newDelightVipPresaleSize) external onlyOwner {
        require(block.number < startBlock, "E23");
        require(_newDelightVipPresaleSize > 0, "E24");
        
        delightVipPresaleSize = _newDelightVipPresaleSize;
        delightRemaining      = delightVipPresaleSize;
        
        emit SetDelightVipPresaleSize(_newDelightVipPresaleSize);
    }
