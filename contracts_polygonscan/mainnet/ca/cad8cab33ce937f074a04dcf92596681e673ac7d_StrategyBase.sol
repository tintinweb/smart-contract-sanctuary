...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    uint256 public harvestCutoff = 100000000000000000;

    uint256 public constant keepFXSmax = 10000;

    // Uniswap swap paths
    address[] public pswamp_eth_path;
    address[] public pswamp_btc_path;
        ...
        )
    {
        ...
        pswamp_btc_path = new address[](4);
        pswamp_btc_path[0] = pswamp;
        pswamp_btc_path[1] = matic;
        pswamp_btc_path[2] = eth;
        pswamp_btc_path[3] = btc;
    }
    ...
    function harvest() public override {
        ...
        if (_pswampBalance > harvestCutoff){
            ...
            _swapUniswapWithPath(pswamp_btc_path, _pswampBalance.div(2));
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public BTC_ETH_LP = 0xdC9232E2Df177d7a12FdFf6EcBAb114E2231198D;
