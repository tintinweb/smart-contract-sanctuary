...
contract UnicornPresale{
    ...
    IERC20 public token;
    IERC20 public usdcToken =IERC20(address(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174));

    uint256 public _price = 1500000;

    uint256 public presaleTimeEnds;
    uint256 public totalTokenSold;
    uint256 public presaleStarts;

    uint256 public MAX_BUY_LIMIT = 500*1e18;
    ...
    constructor(address _token , uint256 endTime,uint256 _presaleStarts) public{
        owner = msg.sender;
        token = IERC20(_token);
    ...
    function buyToken(uint256 amount) public {
        ...
        require(noOfTokens.add(preBalance)<= MAX_BUY_LIMIT,"You can't have more than 500 tokens");
        require(noOfTokens<= MAX_BUY_LIMIT,"You can't buy more than 500 tokens");
