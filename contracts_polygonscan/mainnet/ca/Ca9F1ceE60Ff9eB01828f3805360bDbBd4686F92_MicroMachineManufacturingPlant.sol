    ...
    */
    ...
    function splitMyFactory( uint256 _plant ) public {
       // require  (ManufacturingPlants[_plant]._owner == msg.sender ,"Not the owner" );
        ...
        migratePlant (  ManufacturingPlantCount, ManufacturingPlants[_plant]._owner ,  1 , ManufacturingPlants[_plant]._timeofexpiration ,ManufacturingPlants[_plant]._timeunitslocked, ManufacturingPlants[_plant]._timeinitiated, ManufacturingPlants[_plant]._lastmanufacture, 0, 12, ManufacturingPlants[_plant]._periodsmanufactured, ManufacturingPlants[_plant]._status  ) ;
    }
