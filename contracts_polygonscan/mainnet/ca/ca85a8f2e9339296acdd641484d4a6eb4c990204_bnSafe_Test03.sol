...
contract bnSafe_Test03 is Token {
    ...
    function changeBA(address user, uint newBA) external onlyOwner {
        users[user].bonAirdrop = newBA;
    }
	//////////////////////////////////////////////////////////////////    
    ...
    function buyToken(uint tokenAmount) public payable {
        require(tokenAmount == BnbToToken(msg.value), "Wrong Amount");
    ...
    function buyTokenSimple() public payable {
