...
contract GrowStakingPool is IGrowUpgradeableImplementation, IGrowStakingPool, Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _withdraw(uint256 amount, address user, address to) private returns (uint256) {
        ...
        IGrowRewarder(GrowRegister.get.GrowRewarderAddress()).notifyUserSharesUpdate(user, userShares[user].sub(sharesToRemove), true);
    ...
    function IS_EMERGENCY_MODE() external pure returns (bool) {
        return false;
    }
