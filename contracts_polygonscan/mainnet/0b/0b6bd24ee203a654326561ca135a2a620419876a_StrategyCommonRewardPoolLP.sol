...
contract StratManager is Ownable, Pausable {
    ...
    // verifies that the caller is the multiHarvester.
    ...
    /**
     * @dev Updates address of the multiHarvester.
     * @param _multiHarvester new multiHarvester address.
     */
    function setMultiHarvester(address _multiHarvester) external onlyManager {
        multiHarvester = _multiHarvester;
    }
...
contract StrategyCommonRewardPoolLP is StratManager, FeeManager {
    ...
    function multiHarvest() external onlyMultiHarvester {
        _harvest();
    }
