...
contract Metaperson is ERC721Enumerable, ReentrancyGuard, Ownable {
  ...
  string[] private height = [
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Metaperson #', toString(tokenId), '", "description": "Metaperson are randomized people generated and stored on chain. Images, and other functionality are intentionally omitted for others to interpret. Feel free to use Metaperson in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function claim(uint256 tokenId) public payable nonReentrant {
        require(tokenId > 1000 && tokenId < 8001, "Token ID invalid");
    ...
    constructor() ERC721("Metaperson", "Metaperson") Ownable() {}
}
