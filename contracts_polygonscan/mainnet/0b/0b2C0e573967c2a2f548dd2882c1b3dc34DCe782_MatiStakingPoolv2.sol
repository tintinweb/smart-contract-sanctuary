...
// File contracts/v2/AutoStakingPoolv2.sol

pragma experimental ABIEncoderV2;
contract MatiStakingPoolv2 is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    function vest(address user, uint256 amount) external updateReward(user) {
        totalSupply = totalSupply.add(amount);
        Balances storage bal = balances[user];
        bal.total = bal.total.add(amount);
