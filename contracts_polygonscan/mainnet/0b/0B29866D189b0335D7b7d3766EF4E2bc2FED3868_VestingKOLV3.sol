...
contract VestingKOLV3 is IVesting, EIP712Upgradeable, OwnableUpgradeable {
    ...
    bool public allocationMove_09_12;
    ...
    // for move allocation, 09_12
    function applyToChange_V3() external onlyOwner {
        require(!allocationMove_09_12, "Changed before");
        allocationMove_09_12 = true;
        deposited[0x0E4CF6937B009FfA84C364398B0809DCc88e41e3] = deposited[
            0xf43a008a8948c9C611375f555E60eD71b172A0A3
        ];
        delete deposited[0xf43a008a8948c9C611375f555E60eD71b172A0A3];
    }
