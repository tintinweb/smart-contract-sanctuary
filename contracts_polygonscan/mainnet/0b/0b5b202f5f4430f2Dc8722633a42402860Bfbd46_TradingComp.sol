...
contract TradingComp is Ownable {
    ...
    function register() external {
        ...
        require(currentStatus == CompetitionStatus.Registration ||
		 currentStatus == CompetitionStatus.Open, "NOT_IN_REGISTRATION or OPEN");
        require(currentStatus != CompetitionStatus.Close, "COMPETITION_CLOSED");
        require(currentStatus != CompetitionStatus.Claiming, "COMPETITION_CLOSED");
        require(currentStatus != CompetitionStatus.Over, "COMPETITION_CLOSED");
        ...
        emit UserRegister(senderAddress);
    }
