 ...
 *
 * @title Little Lemon Events Airdrop for Polygon
 * @notice Extends ERC1155 
 */

contract LittleLemonEvents is ERC1155, ERC1155Supply, ERC1155Burnable, Ownable {
    string private _contractURI;
    address public minterAddress;
    string _name = "Lemondrop";
    string _symbol = "LEMDRP";
    ...
    */
    function mint(uint256 id, uint256 amount) public onlyMinter {
