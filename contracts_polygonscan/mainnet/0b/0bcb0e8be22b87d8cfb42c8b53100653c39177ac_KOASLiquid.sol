...
contract KOASLiquid is Context, IERC20, Ownable {
...
contract KLiquid is KOASLiquid , NativeMetaTransaction, ContextMixin {
    constructor() KOASLiquid () {
