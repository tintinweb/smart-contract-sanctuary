...
contract Vesting {
    ...
    constructor(
     ...
     address[] memory beneficiariesAlreadyReleased,
     uint256[] memory amountsAlreadyReleased 
        ...
        adjustAwards(beneficiariesAlreadyReleased, amountsAlreadyReleased);
    }

    function adjustAwards(address[] memory beneficiariesAlreadyReleased, uint256[] memory amountsAlreadyReleased) internal {
      require(beneficiariesAlreadyReleased.length == amountsAlreadyReleased.length, "invalid alreadyReleased params");
    ...
    function initAwards(address[] memory  beneficiaries, TokenAward[] memory _awards, uint256 totalAwards) internal{
        require(beneficiaries.length == _awards.length, 'invalid initAwards params');
