...
contract PolyTiki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingWallet = 0x63169dfC1b9B61Be5B7593AF53141E9F76872c96;
   ...
   //// uint256 public numberOfFixedSaleBuys;
    ...
    constructor() public ERC20("PolyTiki", "PTI") {
...
contract TIKIDividendTracker is DividendPayingToken, Ownable {
    ...
    function changeLimit(uint256 minTokens) external onlyOwner{
