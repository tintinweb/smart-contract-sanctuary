...
// File: @openzeppelin/[email protected]/token/ERC1155/extensions/ERC1155Pausable.sol
...
// File: contracts/unitedocean.sol
 ...
 *  - ability for OpenSea to pull json data
 ...
 */
contract UnitedOcean is Context, Ownable , AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    using Strings for string;
    string public name = "United-Oceans";
    ...
    function uri(uint256 _tokenId) override public view returns (string memory){
        return string(
            abi.encodePacked(
                "https://ipfs.io/ipfs/Qmf1VVaMtuaRST2TqDkc9TYRX9ujh5QPrQV5HkGzEZUciV?filename=",
