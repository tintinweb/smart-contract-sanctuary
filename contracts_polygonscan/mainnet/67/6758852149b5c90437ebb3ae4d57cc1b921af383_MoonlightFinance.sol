...
// File: contracts/MoonlightFinance.sol
...
// MoonlightFinance with Governance.
contract MoonlightFinance is BEP20('Moonlight Finance', 'Moonlight') {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override {
        ...
        if (to == BURN_ADDRESS) {
            ...
            // 4% of every transfer burnt
            uint256 burnAmount = amount.mul(4).div(100);
            // 96% of transfer sent to recipient
            uint256 sendAmount = amount.sub(burnAmount);
            require(amount == sendAmount + burnAmount, "Taco::transfer: Burn value invalid");
