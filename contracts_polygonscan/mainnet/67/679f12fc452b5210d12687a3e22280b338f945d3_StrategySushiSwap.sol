...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant rewardAddress = 0x53cEDe3E5217805041E3e10054c2D06194737AcB;
    address public constant withdrawFeeAddress = 0x7dd58109aa1e14529b623BE485fe356439858587;
    address public constant feeAddress = 0x20180196B3dcc8c764931580266B70A68d42119A;
    address public vaultChefAddress = 0xf59f580502Be6aFd8fdB8fF01050260bf15eEF7b;
    ...
    uint256 public buyBackRate = 250;
...
// File: Vault\StrategySushiSwap.sol
...
contract StrategySushiSwap is BaseStrategyLP {
    ...
    uint256 public compoundCycle = 300; 
    ...
    event MinCompoundAmountChanged(uint256 indexed oldMinEarned, uint256 indexed newMinEarned);
    ...
    function changeMinCompoundAmount(uint256 _minEarnedAmountToCompound) external onlyGov{
        emit MinCompoundAmountChanged(minEarnedAmountToCompound, _minEarnedAmountToCompound);
        minEarnedAmountToCompound = _minEarnedAmountToCompound;
    //    minWMaticAmountToCompound = _minWMaticAmountToCompound;
    }
    ...
    //         //The second check to avoid paying fees, rewards and buyback on wmatic
    ...
    function earn() external nonReentrant whenNotPaused onlyGov override {
        _earn();
    }
    ...
    //    uint256 wmaticAmt = IERC20(wmaticAddress).balanceOf(address(this));
        ...
        if (earnedAmt > minEarnedAmountToCompound) {
            //distribute fees and buy back
            distributeFees(earnedAmt, earnedAddress);
            distributeRewards(earnedAmt, earnedAddress);
            buyBack(earnedAmt, earnedAddress);
