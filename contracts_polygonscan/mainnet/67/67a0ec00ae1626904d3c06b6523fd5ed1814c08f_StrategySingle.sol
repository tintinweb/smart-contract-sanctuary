...
abstract contract BaseStrategyMasterChef is BaseStrategy {
    ...
    function deposit() public override {
        ...
        if (_want > 0) {
            ...
            IMasterChef(rewards).enterStaking(_want);
        }
    }
    ...
    function _withdrawSome(uint256 _amount)
        ...
        returns (uint256)
    {
        IMasterChef(rewards).leaveStaking(_amount);
        return _amount;
    }
    ...
    function _getReward() internal {
        IMasterChef(rewards).leaveStaking(0);
...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address public constant rewardToken = 0x845E76A8691423fbc4ECb8Dd77556Cb61c09eE25;
...
contract StrategySingle is StrategyFarmSingle {
    ...
    address public Want_Token = 0x845E76A8691423fbc4ECb8Dd77556Cb61c09eE25;
