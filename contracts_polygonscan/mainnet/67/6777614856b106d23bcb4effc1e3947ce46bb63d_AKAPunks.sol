...
contract AKAPunks is ERC721Enumerable, Ownable, INFT, INFTMetadata, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("AKAPunks", "AKA") {
        publicSupply = 500;
        giftSupply = 0;
        maxSupply = 500;
        _tokenBaseURI = "ipfs://QmX4LQTuk3citZ6bm3gR4TJA6t5PAGhK8RcAHRRDHZ5mzn/";
        _tokenRevealedBaseURI = "ipfs://QmX4LQTuk3citZ6bm3gR4TJA6t5PAGhK8RcAHRRDHZ5mzn/";
    }

    function mintToOwner(uint numberOfTokens, address to) external onlyOwner {
        for (uint256 i = 1; i <= numberOfTokens; i++) {
            require(totalSupply() < maxSupply);
            require(totalPublicSupply < publicSupply);
