...
contract MintmadeU is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        priceRange = [100, 120, 160, 200];
        maxSupply = 70;
        __ERC1155_init("https://mintmade.damhost.ru/v0.2/item/{id}.json");
        __Ownable_init();
        __Pausable_init();
