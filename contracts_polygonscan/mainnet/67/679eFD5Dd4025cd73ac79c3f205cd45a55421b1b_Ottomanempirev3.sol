...
contract Ottomanempirev3 is ERC721Enumerable, ReentrancyGuard, Ownable {
      ...
      string[] private Padisahliste = [
       "Osman Gazi",                     // 1
        ...
        "I.Mehmed",                     // 5
        "II.Murad",                     // 6
        "Fatih SultanMehmed",           // 7
        "II.Bayezid",                   // 8
        "Yavuz SultanSelim",            // 9
        "Kanuni SultanSuleyman",        // 10
        "II.Selim",                     // 11
        "III.Murad",                    // 12
        "III.Mehmed",                   // 13
        "I.Ahmed",                      // 14
...
string[] private EkonomikListe = [
        ...
        "EconomicalPower:8",         // 7
        "EconomicalPower:9",         // 8
        "EconomicalPower:10",        // 9
        "EconomicalPower:11",        // 10
        "EconomicalPower:12",        // 11
        "EconomicalPower:13",        // 12
        "EconomicalPower:14",        // 13
        "EconomicalPower:15",        // 14
        "EconomicalPower:16",        // 15
        "EconomicalPower:99",        // 16
        "EconomicalPower:100"        // 17
    ];
   ...
   string[] private PolitikListesi = [
        ...
        "PoliticalPower:9",          // 8
        "PoliticalPower:10",         // 9
        "PoliticalPower:11",         // 10
        "PoliticalPower:12",         // 11
        "PoliticalPower:13",         // 12
        "PoliticalPower:14",         // 13
        "PoliticalPower:15",         // 14
        "PoliticalPower:16",         // 15
        "PoliticalPower:99",         // 16
        "PoliticalPower:100"         // 17
    ];
