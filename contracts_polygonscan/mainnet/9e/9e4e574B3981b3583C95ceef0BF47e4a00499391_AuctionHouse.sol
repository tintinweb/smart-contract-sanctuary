...
contract BidDb is Ownable {
    ...
    function getBidStatus(uint256 auctionId) external view returns (Status memory) {
    ...
    function getBidRecord(uint256 auctionId, uint256 start, uint256 end) external view returns (Bid[] memory) {
    ...
    function setAuctionApproval(uint256 auctionId, bool approved) external onlyOwner {
    ...
    function setAuctionReservePrice(uint256 auctionId, uint256 reservePrice) external onlyOwner {
    ...
    function createBid(uint256 auctionId, uint256 amount, uint256 firstBidTime, uint256 duration, address payable bidder) external onlyOwner {
    ...
    function endAuction(uint256 auctionId, uint256 curatorFee, uint256 tokenOwnerProfit, address winner) external onlyOwner {
