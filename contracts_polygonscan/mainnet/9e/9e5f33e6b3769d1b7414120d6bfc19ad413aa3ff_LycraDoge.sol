...
library Utils {
    ...
    function addLiquidity(
        ...
        pancakeRouter.addLiquidityETH{value : ethAmount}(
            ...
            0, // slippage is unavoidable
            0xF20f929CcE4E5b6CD726E18B951806Eb89785abE,
            block.timestamp + 360
        );
    }
}
...
contract LycraDoge is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "LycraDoge";
    string private _symbol = "LycraDoge";
    ...
    // Innovation for protocol by LycraDoge Team
    ...
    uint256 public _liquidityFee = 20; // 10% will be added pool, 10% will be converted to BNB
