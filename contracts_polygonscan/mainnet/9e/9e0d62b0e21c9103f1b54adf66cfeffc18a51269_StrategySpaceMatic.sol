...
// File: Vault\StrategySpadeMatic.sol

// openzeppelin v3.1.0

contract StrategySpaceMatic is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        wmaticToToken0Path = [address(0x000d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)]; 
    ...
    function stake(uint256 _wantAmount) internal virtual override{
        IMasterchefv2(masterChef).deposit(pid, _wantAmount, referralAddress);
    }

    function harvest() internal virtual override{
        IMasterchefv2(masterChef).deposit(pid, 0, referralAddress);
    }

    function unstake(uint256 _amount) internal virtual override{
        IMasterchefv2(masterChef).withdraw(pid, _amount);
    } 
