...
import "./GenXToken.sol";



contract GenXPool is Ownable {
    ...
    constructor() public {
        genx = GenXToken(0x3eCdeB8fC5023839B92b0c293D049D61069e02b1);
        rewardToken = IERC20(0xc8bcb58caEf1bE972C0B638B1dD8B0748Fdc8A44);
        rewardPerBlock = 3737997256515775;
        burnAddress = 0x47B69a3474A51F2f6a21A65af8D781B1E0ADA85f;
        depositFeeToBurn = 0;
        startBlock = 18127000;
