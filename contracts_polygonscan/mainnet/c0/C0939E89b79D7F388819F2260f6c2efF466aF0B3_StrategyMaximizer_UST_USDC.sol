...
contract StrategyMaximizer_UST_USDC is GravityMaximizer {

    address ust_usdc_diff;

    function initializeStrategy(
        address _store,
        address _vault
    ) public initializer {
        address farmContract = address(0xFa51C6CBe06E1Ec6eb9D1E72bd315067fC977dFF);
        address ust_usdc_lp = address(0xE507A93b99120d916229ee6d4aDB4204bbb04Edc);
