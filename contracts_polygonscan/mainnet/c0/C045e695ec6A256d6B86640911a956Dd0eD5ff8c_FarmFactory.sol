...
contract FarmFactory is ReentrancyGuard, Ownable {
    ...
    function build(
        ...
        nonReentrant
    {
        require(msg.value == buildFee, "Build fee is incorrect.");
        FarmToken farmToken = new FarmToken(_tokenName, _tokenSymbol, _tokenMaxCapSupply);
        ...
        farmToken.mint(_devAddress, _mintTokenAmount);
        farmToken.transferOwnership(address(masterChef));

        address newPair = uniswap.createPair(address(farmToken), address(usdc));

        masterChef.add(4000, IERC20(address(farmToken)), 0);
        masterChef.add(4000, IERC20(newPair), 0);
        masterChef.add(3000, IERC20(0x6b140057F140e082B2501399915D9629751b011e), 0);
        masterChef.add(2500, IERC20(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), _depositFee);
        masterChef.add(2500, IERC20(0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6), _depositFee);
        masterChef.add(2500, IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270), _depositFee);
        masterChef.add(1500, IERC20(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063), _depositFee);
        masterChef.add(1500, IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F), _depositFee);
        masterChef.add(1500, IERC20(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174), _depositFee);

        Referral referral = new Referral();
        referral.transferOwnership(msg.sender);
        masterChef.setReferralAddress(IReferral(referral));
        masterChef.updateEmissionRate(_tokenPerBlock);
        masterChef.setReferralCommissionRate(_referralCommissionRate);
