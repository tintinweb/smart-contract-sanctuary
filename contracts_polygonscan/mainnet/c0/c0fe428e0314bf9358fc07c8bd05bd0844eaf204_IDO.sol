...
contract IDO 

   {
    ...
    function initializeIDO(address _inputtoken, address _outputtoken, uint256 _startTime, uint256 _inTokenClaimTime, uint256 _endtime, uint16 _inTokenBurnFeeBP, uint256 _outTokenPriceInDollar, uint256 _maxinvestment, uint256 _minInvestment, bool _inputToken6Decimal, uint256 _forceTotalSupply) public onlyOwner {
        ...
        require (IDOTarget > maxInvestment, "Incorrect maxinvestment value");
