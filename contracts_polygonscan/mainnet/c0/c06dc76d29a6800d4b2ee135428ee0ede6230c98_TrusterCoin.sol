...
TrusterCoin  will be a platform for business tokenization at a time when entrepreneurs face one of the greatest 
challenges in history. The platform will enable the creation of digital currencies from small to large businesses
...
contract TrusterCoin is Context, Ownable, IERC20 {
