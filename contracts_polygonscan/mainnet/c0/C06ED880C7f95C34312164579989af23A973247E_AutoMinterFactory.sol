...
contract AutoMinterFactory is Initializable, OwnableUpgradeable
{
        ...
        bool mintRandomEnabled_) payable public
    {
        ...
        addExistingCollection(clone, msg.sender, appId_);
    }
    ...
    function addExistingCollection(address collectionAddress, address owner, string memory appId) onlyOwner() public{
        ...
        require(appIdLookup[appId] == 0 || collections.length == 0, 'a contract for this id already exists');
        appIdLookup[appId] = collections.length - 1;
    }
}
