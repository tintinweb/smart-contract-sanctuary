...
// File: Vault\StrategyGravityUstUsdcGravity.sol

// openzeppelin v3.1.0

contract StrategyGravityUstUsdcGravity is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken1Path = [address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00692597b009d13c4049a947cab2239b7d6517875f)];
        ...
        token1ToEarnedPath = [address(0x00692597b009d13c4049a947cab2239b7d6517875f), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00874e178a2f3f3f9d34db862453cd756e7eab0381)];
        ...
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x002791bca1f2de4661ed88a30c99a7a9449aa84174), address(0x00692597b009d13c4049a947cab2239b7d6517875f)];
    }
