...
import "../items/ERC1155Tradable.sol";

/**
 * @title MuleSpaceships
 * MuleSpaceships
 */
contract MuleSpaceships is ERC1155Tradable {
    constructor()
        ERC1155Tradable(
            "MuleSpaceships",
            "MULE",
            "https://nft.service.cometh.io/{id}"
        )
    {}
}
 ...
 */
contract ERC1155Tradable is ERC1155PresetMinterPauser, Ownable {
