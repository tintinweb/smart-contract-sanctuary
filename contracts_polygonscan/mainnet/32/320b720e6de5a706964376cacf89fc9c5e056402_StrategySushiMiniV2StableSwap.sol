...
contract StrategySushiMiniV2StableSwap is StrategyBase {
    ...
    uint256 public baseCompoundIndex; //index to add lp
    uint256 public baseLength = 3;
    ...
    function initialize(
        ...
        address _basePoolSwap,
        uint256 _baseCompoundIndex,
        address _controller
    ...
    function setStableLpInfo(address _basePoolSwap, uint256 _baseCompoundIndex) external onlyStrategist {
        basePoolSwap = _basePoolSwap;
        baseCompoundIndex = _baseCompoundIndex;
    }

    function setStableLength(uint256 _baseLength) external onlyStrategist {
