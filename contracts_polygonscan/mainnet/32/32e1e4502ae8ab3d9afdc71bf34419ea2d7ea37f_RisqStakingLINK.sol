...
// File: quickswap-periphery/contracts/interfaces/IUniswapV2Router01
...
interface IMATICLiquidityPool is ILiquidityPool {
...
interface IRisqStakingMATIC is IRisqStaking {
...
// File: contracts/Staking/RisqStakingLINK.sol
...
contract RisqStakingLINK is RisqStaking, IRisqStakingERC20 {
    using SafeERC20 for IERC20;
    using SafeMath for uint;

    IERC20 public immutable LINK;

    constructor(ERC20 _token, ERC20 link) public
        RisqStaking(_token, "RISQ LINK Staking lot", "rLINK") {
        LINK = link;
    }
    ...
    function sendProfit(uint amount) external override {
        ...
        if (_totalSupply > 0) {
            ...
            LINK.safeTransferFrom(msg.sender, FALLBACK_RECIPIENT, amount);
        }
    }
