...
contract PolyApe is IERC721 {
    ...
    string internal nftName = "PolyApeNFT";
    string internal nftSymbol = "PolyApeNFT";
    ...
    function mint(uint256 numberOfNfts) external payable reentrancyGuard {
        ...
        require(numberOfNfts <= 9, "You can not buy more than 9 NFTs at once");
    ...
    function tokenURI(uint256 _tokenId) external view validNFToken(_tokenId) returns (string memory) {
        return string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmTwRKuPs29f4kULQxDiLx8nev41gXK2WKdwXFvfQyFWQZ/", toString(_tokenId)));
    }
    ...
    modifier onlyTokenOwner (uint256 _tokenId) {
        require(_tokenId < 1000, "punk number is wrong");
    ...
    function buyPunk(uint punkIndex) public payable reentrancyGuard{
        require(marketPaused == false, 'Market Paused');
        require(punkIndex < 1000, "punk number is wrong");
