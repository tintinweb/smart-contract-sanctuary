...
contract Not_Special_Faces is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Not Special Faces", "NSF") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xDAD7374c957d7c962766C972CE00Fb6b4ae7974f).call{value: address(this).balance * 95 / 100}("");
    require(hs);
    // =============================================================================
