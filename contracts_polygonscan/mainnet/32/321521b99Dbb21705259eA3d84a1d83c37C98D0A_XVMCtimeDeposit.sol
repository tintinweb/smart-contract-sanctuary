...
contract XVMCtimeDeposit is Ownable, Pausable {
    ...
    uint256 public immutable withdrawFeePeriod = 365 days; // roughly 6 months
    ...
    address public oldPool = 0x6ce6D8015BcefcF80FFb04E21965dd011FFd392c; //old pool we can migrate from
    ...
    address public distributionAddress = 0xF6Fb69d2c0C6cF79b0EA4f34d19745929b97EE48;
     ...
     */
    function setTrustedPools(address _pool6, address _pool5) external adminOrOwner {
        trustedPool6 = _pool6;
        trustedPool5 = _pool5;
        //trustedPool4 = _pool4;
        //trustedPool3 = _pool3;
     ...
     */
    function setTrustedSenders(address _sender1, address _sender2, address _sender3) external adminOrOwner {
    ...
    function hopDeposit(uint256 _amount, address _recipientAddress, uint256 previousLastDepositedTime) external whenNotPaused {
        require(msg.sender == trustedSender1 || msg.sender == trustedSender2
                || msg.sender == trustedSender3 || msg.sender == oldPool,
