...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1285525A79Bf2C21202AbfD19a47C336783441dD;
...
contract DeshiCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2D2d6bAcd0f0333D746510f04903A99DF272f86C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 200000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Deshi Coin";
    string private _symbol = "DESHI";
