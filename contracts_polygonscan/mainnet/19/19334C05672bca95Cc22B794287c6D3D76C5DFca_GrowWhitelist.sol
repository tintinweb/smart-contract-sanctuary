...
// File contracts/grow/GrowWhitelist.sol

// License: MIT
pragma solidity 0.8.6;

contract GrowWhitelist is IGrowWhitelist, Ownable {
    ...
    function isWhitelist(address userAddress) override external view returns (bool) {
