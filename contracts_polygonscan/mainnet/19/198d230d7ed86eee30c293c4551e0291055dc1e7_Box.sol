...
contract Box is ERC20, Initializable{
   IERC20 _gallon;
   ...
   function SetAddress(IERC20 gallon_) initializer public{
       _gallon = gallon_;
   }
   
   function mint(address recipient, uint256 amount) onlyBy(address(_gallon)) public virtual returns (bool){
   ...
   function transferFrom(
        ...
        revert("Function transferFrom has been disabled!");
        //return false;
    }
}