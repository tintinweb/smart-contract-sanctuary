...
// File: contracts/flat_bunnies_final.sol
...
contract SmartContract is ERC721Enumerable, Ownable {
    ...
    uint256 public cost2 = 80 ether;
    uint256 public cost3 = 66 ether;
    uint256 public maxSupply = 3000;
    uint256 public maxMintAmount = 5;
    uint256 public maxMintAmountOwner = 45;
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (msg.sender == owner()) {
            require(_mintAmount <= maxMintAmountOwner);
        }
        else {
    ...
    returns (string memory)
    {
        ...
        return bytes(currentBaseURI).length > 0 
            ? string(abi.encodePacked(baseURI, (1000 + tokenId).toString(), baseExtension))
            : "";
    }
