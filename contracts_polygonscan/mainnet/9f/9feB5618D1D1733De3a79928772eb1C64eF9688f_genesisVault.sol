 ...
 */
contract genesisVault is ERC20, Ownable, ReentrancyGuard {
    ...
    address constant public devAddress = 0x548D885c0C5302227cE9A11e5F2B2F9ad77D97D6;

    // The deposit and withdrawal fee of the vaults, modifiable but with a capped value
    uint256 public depositFeeBP = 450;

    // The capped values of the deposit and withdrawal fee
    uint256 public constant maxDepositFee = 700;
