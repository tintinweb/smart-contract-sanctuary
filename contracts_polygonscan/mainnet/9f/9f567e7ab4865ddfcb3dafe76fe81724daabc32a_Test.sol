...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 2500; // 2.5%
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 7500; // 7.5%
    uint256 private _previousLiquidityFee = _liquidityFee;

    IBdexRouter public immutable bdexRouter;
    address public bdexPair;

    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 500000000 ether;
    ...
    constructor () public {
        ...
        IBdexRouter _bdexRouter = IBdexRouter(0xF6fa9Ea1f64f1BBfA8d71f7f43fAF6D45520bfac);
        // Create a uniswap pair for this new token
       // bdexPair = IBdexFactory(_bdexRouter.factory())
        //.createPair(address(this), _bdexRouter.WETH(), 50, 30);
    ...
    function setBdexPair(address _bdexPair) public onlyOwner {
        bdexPair = _bdexPair;
    }
    ...
    //to recieve ETH from bdexRouter when swaping
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        _approve(address(this), address(bdexRouter), tokenAmount);

        // make the swap
        bdexRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            address(this),
            tokenAmount,
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        bdexRouter.addLiquidityETH{value: ethAmount}(
            bdexPair,
            address(this),
            tokenAmount,
