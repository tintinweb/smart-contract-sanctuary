...
contract AutoCompoundPool is Ownable, Pausable {
    ...
    /**
     * @notice Deposits funds into the auto compound pool
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the auto compound pool
     */
    ...
    function calculateHarvestTokenRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterChef).pendingTokenReward(0, address(this));
    ...
    /**
     * @notice Withdraws from funds from the auto compound pool
