...
contract PolygonArbitrageBot is PolygonTradingHub {
    ...
    function _polygonArbitrageBotFindOption(kPolygonToken _tokenA, kPolygonToken _tokenB, uint256 _usdcValue) internal view returns(PolygonArbitrageOption memory)
    {
        ...
        console.log("PolygonArbitrageBot - percentageGain: %d", option.tokenAmountDifferencePercentage1000);
...
library PolygonTokens {
    ...
    address constant chsb = 0x67Ce67ec4fCd4aCa0Fcb738dD080b2a21ff69D75;
    address constant rndr = 0x61299774020dA444Af134c82fa83E3810b309991;
    address constant uma = 0x3066818837c5e6eD6601bd5a91B0762877A6B731;
    address constant ocean = 0x282d8efCe846A88B159800bd4130ad77443Fa1A1;
    address constant srm = 0x6Bf2eb299E51Fc5DF30Dec81D9445dDe70e3F185;
    address constant xiv = 0xde799636aF0d8D65a17AAa83b66cBBE9B185EB01;
    address constant cnt = 0xD1e6354fb05bF72A8909266203dAb80947dcEccF;
    address constant wfil = 0xEde1B77C0Ccc45BFa949636757cd2cA7eF30137F;
    address constant wolf = 0x8f18dC399594b451EdA8c5da02d0563c0b2d0f16;
    address constant wspp = 0x46D502Fac9aEA7c5bC7B13C8Ec9D02378C33D36F;
    ...
    function getTokenAddress(kPolygonToken token) internal pure returns(address)
    {
        ...
        if (token == kPolygonToken.chsb)
        {
            return chsb;
        }
        if (token == kPolygonToken.rndr)
        {
            return rndr;
        }
        if (token == kPolygonToken.uma)
        {
            return uma;
        }
        if (token == kPolygonToken.ocean)
        {
            return ocean;
        }
        if (token == kPolygonToken.srm)
        {
            return srm;
        }
        if (token == kPolygonToken.xiv)
        {
            return xiv;
        }
        if (token == kPolygonToken.cnt)
        {
            return cnt;
        }
        if (token == kPolygonToken.wfil)
        {
            return wfil;
        }
        if (token == kPolygonToken.wolf)
        {
            return wolf;
        }
        if (token == kPolygonToken.wspp)
        {
            return wspp;
        }
    ...
    function getTokenName(kPolygonToken token) internal pure returns(string memory)
    {
        ...
        if (token == kPolygonToken.cnt)
        {
            return "Cryption Network Token";
        }
        if (token == kPolygonToken.wfil)
        {
            return "Wrapped Filecoin";
        }
        if (token == kPolygonToken.wolf)
        {
            return "moonwolf.io";
