...
abstract contract StrategyFarmSingle is BaseStrategyMasterChef {
    ...
    address[] public usdc_myFriends_path;
        ...
        )
    {
        ...
        usdc_myFriends_path = new address[](2);
        usdc_myFriends_path[0] = usdc;
        usdc_myFriends_path[1] = myFriends;
    }
    ...
    function harvest() public override {
        ...
        if (_usdcBalance > harvestCutoffUSDC){
            ...
            _swapUniswapWithPath(usdc_myFriends_path, _usdcBalancePost);
        }
        // Stake the LP tokens
...
contract StrategySingle is StrategyFarmSingle {
    ...
    address public Want_Token = 0xa509Da749745Ac07E9Ae47E7a092eAd2648B47f2;
