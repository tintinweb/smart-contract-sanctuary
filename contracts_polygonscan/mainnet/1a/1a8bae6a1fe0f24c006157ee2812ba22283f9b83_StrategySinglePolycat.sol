...
abstract contract StrategyFeesBase is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant vaultAddress = 0xCe0A0563823a390D586f2CaA435fd7355210060A;
    address public constant feeAddress = 0xF67A795d7302Ad5f0c28F00872D0B44b634E8FE1;
...
contract StrategySinglePolycat is StrategySingleBase {
    ...
    function vaultSharesTotal() public virtual override view returns (uint256) {
        uint256 amount = 0;
        (amount, ) = IPolycat(polycatMasterChefAddress).userInfo(pid, address(this));
        return amount;
    }
