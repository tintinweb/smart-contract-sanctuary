...
// File: ManekiRewards.sol


// Lucky Maneki Rewards (LuckyManekiRewards.sol)
...
contract LuckyManekiReward is ERC1155, ERC2981, AccessControl, Pausable, ERC1155Burnable, ERC1155Supply {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant ROYALTY_ROLE = keccak256("ROYALTY_ROLE");

    constructor() ERC1155("https://lucky-maneki-challenges.s3.us-east-2.amazonaws.com/meta/rewards/{id}.json") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(URI_SETTER_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _grantRole(ROYALTY_ROLE, msg.sender);
        _setDefaultRoyalty(0x5cDA14972f2585562655646A417361DA97e99324, 500);
    }
