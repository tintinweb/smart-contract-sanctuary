...
contract GenXPool is Ownable {
    ...
    constructor() public {
        ...
        // genx = GenXToken(0x9AA18A4E73E1016918fA360Eed950D9580C9551d);//Bsc
        genx = GenXToken(0x3eCdeB8fC5023839B92b0c293D049D61069e02b1);//Polygon
        rewardToken = IERC20(0x9085B4d52c3e0B8B6F9AF6213E85A433c7D76f19);
        startBlock = 20243200;
        uint length = 30 * 30000; // ~30 days
        uint totalReward = 1250000 * 1e18;
        rewardPerBlock = totalReward / length;
