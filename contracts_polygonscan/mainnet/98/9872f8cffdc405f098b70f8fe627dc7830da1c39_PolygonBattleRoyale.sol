...
contract PolygonBattleRoyale is Context, IERC20, Ownable {
    ...
    string private constant _name = "PolygonBattleRoyale";
    string private constant _symbol = "PolygonBattleRoyale";
