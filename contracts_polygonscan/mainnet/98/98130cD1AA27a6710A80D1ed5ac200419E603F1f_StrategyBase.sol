...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant token2 = 0x6bb45cEAC714c52342Ef73ec663479da35934bf7;
    ...
    function harvest() public override {
        ...
        if (_collarBalance > harvestCutoff){
            ...
            // Swap collar to token 1
            _swapUniswapWithPath(collar_token1_path, _collarBalance);

            //Send performance fee in token 1
            uint256 _token1Balance = IERC20(token1).balanceOf(address(this));
            uint256 performanceFee = _token1Balance.mul(keepFXS).div(keepFXSmax);
            if (performanceFee>0) {
            ...
            uint256 _token1BalancePost = IERC20(token1).balanceOf(address(this));
            _swapUniswapWithPath(token1_token2_path, _token1BalancePost.div(2));
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public BONE_USDC_LP = 0x2CC05c660f35E8692CA99dB95922CB744d44ef20;
