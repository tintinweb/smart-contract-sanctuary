...
contract BoostHandler is Ownable, IBoostHandler {
    ...
    address public calculator = 0x5622Fb5a6a0C86fe42514B9De566CD33bdEa1941;
    ...
    //address[] public stablecoinVaults;
    ...
    /*function getTotalStablecoinValue(address _user) public view returns (uint256 totalValue) {
    ...
    //need to add checks to make sure this is a stablecoin vault
    /*function addStablecoinVault(address vaultAddress) public onlyOwner {
        stablecoinVaults.push(vaultAddress);
    }*/
}