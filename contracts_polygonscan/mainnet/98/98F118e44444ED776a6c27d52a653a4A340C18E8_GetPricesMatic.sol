...
contract GetPricesMatic  {

    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    // WBNB token address
    IERC20 private constant WBNB = IERC20(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    // BUSD token address
    IERC20 private constant BUSD = IERC20(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);    
    // Lp BNB_BUSD_POOL token address
    address private constant BNB_BUSD_POOL = 0x604229c960e5CACF2aaEAc8Be68Ac07BA9dF81c3;
    ...
    function tokenPriceInBNB(address _token, IFactory factory) public view returns(uint) {
        ...
        uint _balanceETHER = WBNB.balanceOf(pair);
        uint _balanceTOKEN = IERC20(_token).balanceOf(pair);
        if(_balanceETHER > 0 && _balanceTOKEN > 0){
