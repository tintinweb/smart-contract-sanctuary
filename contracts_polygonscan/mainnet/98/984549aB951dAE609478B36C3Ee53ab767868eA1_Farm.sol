...
contract Farm is Ownable, ReentrancyGuard {
    ...
    function depositFor(
        ...
        uint256 _amount,
        address _user
    ) external validatePoolByPid(_pid) nonReentrant ensureNonZeroAddress(_user) {
    ...
    function _deposit(
        ...
        updatePool(_pid);
        _payOrLockupPendingFYGN(_pid, _user, _user);
    ...
    function _withdraw(
        ...
        updatePool(_pid);
        _payOrLockupPendingFYGN(_pid, _user, _withdrawer);
