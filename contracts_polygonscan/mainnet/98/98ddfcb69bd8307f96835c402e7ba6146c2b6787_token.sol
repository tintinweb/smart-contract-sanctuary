...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6300*10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "LOL Champion";
    string private _symbol = "YASUO";
    ...
    address public ownerAddres = address(0x484ee9b0ae77a443fB7C6D46CBc8B94566f38efD);
