...
contract XVMCtimeDeposit is Ownable, Pausable {
    ...
    uint256 public immutable withdrawFeePeriod = 1095 days; // roughly 6 months
    ...
    address public oldPool = 0xf79b7cc3c36C150FBF6327be5Df3eE358453d749; //old pool we can migrate from
    ...
    address public distributionAddress = 0x859E884E0d241c8691a2Ad4bC273DeABd8299CDE;
    ...
    function hopDeposit(uint256 _amount, address _recipientAddress, uint256 previousLastDepositedTime) external whenNotPaused {
        require(msg.sender == trustedSender1 || msg.sender == trustedSender2
                || msg.sender == trustedSender3 || msg.sender == trustedSender4 || msg.sender == oldPool,
