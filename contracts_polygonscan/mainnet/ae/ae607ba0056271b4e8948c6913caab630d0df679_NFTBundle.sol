...
contract NFTBundle is INFTBundle, ERC721, Ownable, AccessControl {
     ...
     */
    function viewURI(uint256 _tokenId) public view override onlyExistingTokens(_tokenId) returns (string memory uri) {
     ...
     */
    function mediaURI(uint256 _tokenId) public view override onlyExistingTokens(_tokenId) returns (string memory uri) {
    ...
    function hasUnlockableContentUri(uint256 bundleId) external view override returns (bool) {
        Bundle memory _bundle = bundles[bundleId];
    ...
    function exists(uint256 bundleId) external view override returns (bool) {
