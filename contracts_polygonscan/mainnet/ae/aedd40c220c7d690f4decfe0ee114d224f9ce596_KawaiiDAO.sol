...
contract KawaiiDAO is Ownable, ERC721 {
    ...
    uint256 public tokenPrice = .001 ether; //5 MATIC Presale //20 MATIC Public
    ...
    address private constant DEV = 0x48A5322F83ac3A225816F8f2D8209C1FC9d2c2A5;
    ...
    constructor() ERC721("Kawaii DAO NFT", "KawaiiDAONFT") {
        _baseTokenURI = ""; 
    ...
    */
    ...
    function hasMintPass(address sender) public view returns (bool){
        if(sender==address(0)){
            return false;
        } else if (IERC721(FATBOIS).balanceOf(sender)>0){
            return true;
