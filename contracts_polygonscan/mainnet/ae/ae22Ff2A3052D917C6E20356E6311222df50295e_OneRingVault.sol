...
contract OneRingVault is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function depositFor(
        ...
        _deposit(_amount, _token, msg.sender, _holder);
    }
    ...
    function _deposit(
        ...
        require(_beneficiary != address(0), "holder must be defined");
        require(
        ...
        _mint(_beneficiary, _toMint);

        emit Deposit(_beneficiary, _amount, _underlying);
    }
        ...
        returns (uint256)
    {
        ...
        if (_toWithdraw <= _underlyingBal) {
            ...
            emit Withdraw(msg.sender, _realWithdraw, _underlying);
        ...
        IERC20(_underlying).safeTransfer(msg.sender, _realWithdraw);
        emit Withdraw(msg.sender, _realWithdraw, _underlying);
        return _realWithdraw;
    }
