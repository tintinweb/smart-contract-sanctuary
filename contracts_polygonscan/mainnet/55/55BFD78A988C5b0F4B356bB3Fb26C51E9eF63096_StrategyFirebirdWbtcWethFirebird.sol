...
// File: Vault\StrategyFirebirdWbtcWethFirebird.sol

// openzeppelin v3.1.0

contract StrategyFirebirdWbtcWethFirebird is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6)];
        ...
        token0ToEarnedPath = [address(0x001bfd67037b42cf73acf2047067bd4f2c47d9bfd6), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x00d78c475133731cd54dadcb430f7aae4f03c1e660)];
