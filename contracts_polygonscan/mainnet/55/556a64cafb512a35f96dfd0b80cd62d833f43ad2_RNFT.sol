...
contract RNFT is IERC721, Ownable, Functional {
     ...
     */
    constructor() {
        _name = "Dice Roller NFT";
        _symbol = "RNFT";
        _baseURI = "https://triple7dice.club/gamedata/rollernft/metadata/";
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == RNFT.onERC721Received.selector;
    }
    ...
    function mint(address _to, uint256 qty) external payable reentryLock {
        ...
        require(msg.value == qty * price, "Mint: Wrong Value");
