...
contract DeFarmToken is ERC20Permit, VaultOwned {

    using SafeMath for uint256;
    address public feeAddress = 0xBff5A77059231B99C385978fA98d2E64e26FC463;
    uint16 public feeRate = 2;
    constructor() ERC20("DeFarm", "DeFarm", 9) {
    }
    ...
    function transfer(address to, uint256 amount) public virtual override returns(bool) {
        ...
        super.transfer(to, amount.div(feeAmount));
        return true;
    }

    function setFeeRate(uint16 _value) public onlyVault(){
        require(feeRate <= 100, "DeFarm: Invalid value");
        feeRate = _value;
    }

    function setFeeAddress(address _address) public onlyVault()
    {
        require(_address != address(0), "DeFarm: Invalid address");
        feeAddress = _address;
    }
