...
contract StrategyLiquidate is Ownable, ReentrancyGuard, Strategy {
  ...
  function execute(
    ...
    IUniswapV2Pair lpToken = IUniswapV2Pair(factory.getPair(fToken, usdc));
    ...
    router.removeLiquidity(fToken, usdc, lpToken.balanceOf(address(this)), 0, 0, address(this), now);
