...
contract YodaNFT is Initializable, OwnableUpgradeable, ERC1155SupplyUpgradeable {
    ...
    /// @param _newUri new uri which contains the metadata for winner and runnerUp also
    function setWinners(uint256 _idWinner, uint256 _idRunnerUp, string calldata _newUri) external onlyOwner {
