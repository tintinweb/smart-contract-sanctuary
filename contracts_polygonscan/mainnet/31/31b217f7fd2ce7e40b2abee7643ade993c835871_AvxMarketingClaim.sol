...
contract AvxMarketingClaim {
    ...
    constructor() {
        ...
        time = 1638457200; //Thursday, December 2, 2021 8:30:00 PM GMT+05:30

        uint tokens = 3150000 * (10**18);
        uint claimAmount = tokens * 100 / 100;
    ...
    function withdrawToken(address tokenAddress, address to, uint amount) public returns(bool) {
        ...
        require(block.timestamp > time , "Time limit Found");
