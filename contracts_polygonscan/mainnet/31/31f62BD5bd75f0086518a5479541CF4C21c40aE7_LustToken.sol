...
contract LustToken is ERC20('LUST PRESALE', 'LUST'), ReentrancyGuard, Ownable {
    ...
    IERC20 public USDC = IERC20(0xdb25d2253d9e3Ef54F7F640866F7F7B78D748AFD);
    
    IERC20 lustToken = IERC20(address(this));

    uint256 public constant lustPerAccountMaxTotal = 15 * (10 ** 3) * (10 ** 18); //15,000k presale public
