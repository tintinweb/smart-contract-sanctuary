...
// File: Vault\StrategyCafeswapPbrewWmaticCafeswap.sol

// openzeppelin v3.1.0

contract StrategyCafeswapPbrewWmaticCafeswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09), address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        earnedToToken1Path = [address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09)];
        token0ToEarnedPath = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09)];
        token1ToEarnedPath = [address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270)];
        wmaticToToken1Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00b5106a3277718ecad2f20ab6b86ce0fee7a21f09)];
    }
