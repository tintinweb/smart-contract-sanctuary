...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public pwings_btc_path;
    address[] public pwings_usdt_path;
    ...
    {
        pwings_btc_path = new address[](2);
        pwings_btc_path[0] = pwings;
        pwings_btc_path[1] = btc;

        pwings_usdt_path = new address[](2);
        pwings_usdt_path[0] = pwings;
        pwings_usdt_path[1] = usdt;
    ...
    function harvest() public override {
        ...
        if (_pwingsBalance > harvestCutoff){
            ...
            if (performanceFee>0) {
                _swapUniswapWithPath(pwings_matic_path, performanceFee);
            ...
            // Swap
            _pwingsBalance = IERC20(pwings).balanceOf(address(this));
            _swapUniswapWithPath(pwings_btc_path, _pwingsBalance.div(2));
            uint256 _pwingsBalancePost = IERC20(pwings).balanceOf(address(this));
            _swapUniswapWithPath(pwings_usdt_path, _pwingsBalancePost);
