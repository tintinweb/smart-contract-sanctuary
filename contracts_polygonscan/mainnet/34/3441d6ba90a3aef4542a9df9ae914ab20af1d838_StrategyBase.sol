...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Uniswap swap paths
    address[] public beta_matic_path;
    ...
    {
        beta_matic_path = new address[](2);
        beta_matic_path[0] = beta;
        beta_matic_path[1] = matic;
    }
    ...
    function harvest() public override {
        ...
        // Swap 1/2 BETA for USDC
        uint256 _betaBalance = IERC20(beta).balanceOf(address(this));
        if (_betaBalance > harvestCutoff){
            if (_betaBalance > 0) {
                _swapUniswapWithPath(beta_matic_path, _betaBalance.div(2));
            }

            // Add liquidity for BETA/MATIC
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public BETA_MATIC_LP = 0x2F2C4A52616663D15E3fACe26Db6305AFe549EDc;
