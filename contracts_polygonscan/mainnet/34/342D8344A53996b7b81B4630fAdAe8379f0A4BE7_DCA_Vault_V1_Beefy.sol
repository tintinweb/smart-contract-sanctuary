...
contract DCA_Vault_V1_Beefy is Initializable, ERC20Upgradeable, ERC2222 {
    ...
    function harvest(
        ...
        uint256 initialPrincipalBalance = IERC20(principalToken).balanceOf(address(this));
        principalTokenVault.withdraw(sharesToBurn);
        uint256 principalReceived = IERC20(principalToken).balanceOf(address(this)) - initialPrincipalBalance;
