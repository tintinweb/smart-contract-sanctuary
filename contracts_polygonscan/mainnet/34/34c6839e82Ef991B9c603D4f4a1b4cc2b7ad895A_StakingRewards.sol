...
contract StakingRewards is IStakingDualRewards, DualRewardsDistributionRecipient, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
...
contract StakingRewardsFactory is Owned {
    ...
    function notifyRewardAmount(address stakingToken) public {
        ...
        if (info.rewardAmountA > 0 && info.rewardAmountB > 0 && info.duration > 0) {
            ...
            StakingRewards(info.stakingRewards).notifyRewardAmount(rewardAmountA, rewardAmountB, duration);
        }
    }
