...
MM88MMM ,adPPYYba,  ,adPPYba,  ,adPPYba,   
  88    ""     `Y8 a8"     "" a8"     "8a  
  88    ,adPPPPP88 8b         8b       d8  MASTERCHEF STRATEGY  
...
contract StrategyMasterchef is BaseStrategyLPSingle {
    ...
    //    address _uniRouterAddress,
        uint256 _pid,
        address[] memory _addressListing,
        // address _wantAddress,  // must be an LP
        // address _earnedAddress,
        // address _rewardAddress, // when the Rewards are sent (Dividends)
        address[] memory _earnedToWmaticPath,
        address[] memory _earnedToUsdcPath,
        address[] memory _earnedToTacoPath,
    ...
    //    uniRouterAddress = _uniRouterAddress;
        ...
        wantAddress = _addressListing[0];
        token0Address = IUniPair(wantAddress).token0();
        token1Address = IUniPair(wantAddress).token1();

        pid = _pid;
        // earnedAddress = _earnedAddress;
        earnedAddress = _addressListing[1];
        // rewardAddress = _rewardAddress;
        rewardAddress = _addressListing[2];

        earnedToWmaticPath = _earnedToWmaticPath;
        earnedToUsdcPath = _earnedToUsdcPath;
        earnedToTacoPath = _earnedToTacoPath;
...
MM88MMM ,adPPYYba,  ,adPPYba,  ,adPPYba,   
  88    ""     `Y8 a8"     "" a8"     "8a  
  88    ,adPPPPP88 8b         8b       d8  BASESTRATEGY LPSINGLE  
  88,   88,    ,88 "8a,   ,aa "8a,   ,a8"  
  "Y888 `"8bbdP"Y8  `"Ybbd8"'  `"YbbdP"'   
...
MM88MMM ,adPPYYba,  ,adPPYba,  ,adPPYba,   
  88    ""     `Y8 a8"     "" a8"     "8a  
  88    ,adPPPPP88 8b         8b       d8  BASESTRATEGY LP  
  88,   88,    ,88 "8a,   ,aa "8a,   ,a8"  
  "Y888 `"8bbdP"Y8  `"Ybbd8"'  `"YbbdP"'   
...
MM88MMM ,adPPYYba,  ,adPPYba,  ,adPPYba,   
  88    ""     `Y8 a8"     "" a8"     "8a  
  88    ,adPPPPP88 8b         8b       d8  BASESTRATEGY  
  88,   88,    ,88 "8a,   ,aa "8a,   ,a8"  
  "Y888 `"8bbdP"Y8  `"Ybbd8"'  `"YbbdP"'   
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant uniRouterAddress = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // QuickSwap
    address public constant usdcAddress = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;
    address public constant tacoAddress = 0x4EB033a22ee1D173EFcd808d5ea6152792814ecd;
    address public rewardAddress; // StrategyDividends
    address public constant withdrawFeeAddress = 0xCf7Db495dFb74302870fFE4aC8D8d19550d97fA8;
    address public constant feeAddress = 0xCf7Db495dFb74302870fFE4aC8D8d19550d97fA8;
    ...
    address[] public earnedToTacoPath;
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            IStrategyTaco(rewardAddress).depositReward(usdcAfter);
