...
contract BadgerTreeV2 is Initializable, AccessControlUpgradeable, ICumulativeMultiTokenMerkleDistributor, PausableUpgradeable {
    ...
    function reinitialize() public {
        ...
        revokeRole(DEFAULT_ADMIN_ROLE, 0xa949027aDe80946f514C0E8E878E87c69609FA63); // The admin can edit all role permissions
        revokeRole(ROOT_PROPOSER_ROLE, 0xa949027aDe80946f514C0E8E878E87c69609FA63); // The admin can edit all role permissions
        revokeRole(ROOT_VALIDATOR_ROLE, 0xa949027aDe80946f514C0E8E878E87c69609FA63); // The admin can edit all role permissions
        
        renounceRole(DEFAULT_ADMIN_ROLE, 0xDA25ee226E534d868f0Dd8a459536b03fEE9079b);
    }
}