...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x09Daa34abf5Fd9F0bc12d7Dd4A87C92570d2f587;
...
contract Polysafemoon is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 2; // 0 means 0% add liquidity
    uint256 public _burnFee = 1; // means 2 it menas burn 2%
    ...
    constructor() public {
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // for Quickswap
