    ...
    IERC1155MetadataURIUpgradeable
{
    ...
    uint256 private _individualTokenIdAmount;
    bytes _mockData;

    /**
     * @dev See {_setURI}.
     */
    function __ERC1155_init(string memory uri_, uint256 tokenAmount) internal initializer {
        __Context_init_unchained();
        __ERC165_init_unchained();
        __ERC1155_init_unchained(uri_, tokenAmount);
    }

    function __ERC1155_init_unchained(string memory uri_, uint256 tokenAmount)
        internal
        initializer
    {
        _setURI(uri_);
        _individualTokenIdAmount = tokenAmount;
        _amounts.push(1);
    }
    ...
    function _getMintBatch(
        ...
        emit TransferBatch(operator, address(0), to, idRange, _amounts);

        _doSafeBatchTransferAcceptanceCheck(operator, address(0), to, idRange, _amounts, _mockData);
    }
}
...
contract GETERC1155 is Initializable, ERC1155Upgradeable {
    ...
    function __GETERC1155_init_unchainded() internal initializer {
    }
