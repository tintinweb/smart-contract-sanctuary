...
contract StratX2_CURVE_atricrypto2 is StratX2_PCS {
    address[] public rewarders;
    address[] public CRVToUSDCPath;
    
    address public curvePoolAddress = 0x3Fa8ebd5d16445b42e0b6A54678718C94eA99aBC;
...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public constant controllerFeeUL = 800; // 300; updated 2021-07-22
