...
contract BABYBULLCLUBNFT is ERC721Enumerable {
using Strings for uint256;

    address private admin;

    uint256 public maxSupply = 4444 ;
    uint256 private mintCost = 90*10**18;
    ...
    constructor(string memory _base, address _admin) ERC721("BABY BULL CLUB", "BBC")  {
        admin = _admin;
        __baseURI = _base;
        // ipfs://CID/
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= 20, "Per traction only 20 you can mint");
  ...
  function changeAdmiin(address _new) public onlyAdmin {
    admin = _new;
  }
