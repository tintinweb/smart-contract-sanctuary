...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    function harvest() public override {
        ...
        if (_alphaBalance > harvestCutoff){
            ...
            uint256 _alphaBalancePost2 = IERC20(alpha).balanceOf(address(this));
            _swapUniswapWithPath(alpha_spade_path, _alphaBalancePost2);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public SPADE_USDC_LP = 0x8f2172568Ad3b2024b8CB29b03279E4b3d4849c8;
