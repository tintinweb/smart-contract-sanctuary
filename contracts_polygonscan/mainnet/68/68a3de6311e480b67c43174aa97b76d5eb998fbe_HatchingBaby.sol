 ...
 */
 ...
 contract HatchingBaby is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Hatching Baby", "HTB") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xFe73170242D985b5d951Fe970974de1a249D3386); 
          _setupRole(MINTER_ROLE, 0xFe73170242D985b5d951Fe970974de1a249D3386); 
          _setupRole(MINTER_ADMIN_ROLE, 0xFe73170242D985b5d951Fe970974de1a249D3386); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xFe73170242D985b5d951Fe970974de1a249D3386);  
     }
     ...
     /**
      * @dev Creates a new token for `to` with a `tokenId`. Its token ID will be automatically
      ...
      */
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "HTB/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
      ...
      * - the caller must have the `MINTER_ROLE`.
      */      
     function mint_by_id_ipfs(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "HTB/minter-role-required");
         _mint(to, tokenId);
     ...
     /**
      * @dev Creates a new token for `to` with a massive `tokenId`. Its token ID will be automatically
      * assigned (and available on the emitted {IERC721-Transfer} event), and the token
      * URI autogenerated based on the base URI passed at construction.
      *
      * See {ERC721-_mint}.
      ...
      * - the caller must have the `MINTER_ROLE`.
      */
     function bulk_mint(address[] memory to, uint256[] memory tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "HTB/minter-role-required");
      ...
      * - the caller must have the `MINTER_ROLE`.
      */
     function bulk_mint_ipfs(address[] memory to, uint256[] memory tokenId, string[] memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "HTB/minter-role-required");
