...
// File contracts/Misc_AMOs/__CROSSCHAIN/Polygon/SushiSwapLiquidityAMO.sol
...
contract SushiSwapLiquidityAMO is Owned {
    ...
    // SushiSwap
    IUniswapV2Router02 public sushi_router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
    ...
    function swapTokens(
        ...
        // Approval
        ERC20(from_token_address).approve(address(sushi_router), from_in);
        ...
        // Swap
        amounts = sushi_router.swapExactTokensForTokens(
            from_in, 
            to_token_out_min, 
            the_path, 
            address(this), 
    ...
    function addLiquidity(
        ...
        // Approvals
        ERC20(tokenA_address).approve(address(sushi_router), tokenA_amt);
        ERC20(tokenB_address).approve(address(sushi_router), tokenB_amt);

        // Add liquidity
        (amountA, amountB, liquidity) = sushi_router.addLiquidity(
            tokenA_address, 
            tokenB_address, 
            tokenA_amt, 
            tokenB_amt, 
    ...
    function removeLiquidity(
        ...
        // Approvals
        ERC20(lp_token_address).approve(address(sushi_router), lp_token_in);
        ...
        // Remove liquidity
        (amountA, amountB) = sushi_router.removeLiquidity(
            tokenA, 
            tokenB, 
            lp_token_in, 
            0, 
