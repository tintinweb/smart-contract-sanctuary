...
contract YorkDog is ERC721Enumerable, Ownable {
    ...
    uint256 public availableForPublic = 16;
    uint256 public maxMintAmount = 5;
    bool public paused = false;
    bool public revealed = false;


    constructor() ERC721("YorkDog", "YKD") {
    }
    ...
    function mint(uint256 _mintAmount) external payable {
        ...
        require(supply + _mintAmount < 17, "Mint amount exceeds the max supply available for public");
    ...
    function devMint(uint256 _mintAmount) external onlyOwner {
        uint256 supply = totalSupply();
        require(supply + _mintAmount <= maxSupply, "Mint amount exceeds the max supply");
