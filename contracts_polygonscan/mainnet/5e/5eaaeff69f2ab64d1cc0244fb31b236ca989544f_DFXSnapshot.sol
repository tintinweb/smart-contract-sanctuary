...
// File: contracts/DFXSnapshot.sol
...
contract DFXSnapshot {
    IERC20 public constant DFX_ETH_SUSHI_LP = IERC20(0x9AD5cDC89001A2eB0cc7713c788f843de881d803);
    IERC20 public constant DFX = IERC20(0xE7804D91dfCDE7F776c90043E03eAa6Df87E6395);
    ...
    function balanceOf(address _voter) public view returns (uint256) {
        ...
        uint256 votePower = getAmountFromSLP(slpAmount) + bareAmount;
