...
contract FenixToken is ERC20('FENIX', 'FENIX'), ReentrancyGuard {
    ...
    address public constant feeAddress = 0x80956dCf2a4302176B0cE0c0b4fCE71081b1d6A7;

    uint256 public salePriceE35 = (20) * (10 ** 34);
    ...
    function setSalePriceE35(uint256 _newSalePriceE35) external onlyOwner {
        ...
        require(_newSalePriceE35 >= 5 * (10 ** 34), "new price can't be below 2.5 matic");
        require(_newSalePriceE35 <= 80 * (10 ** 34), "new price can't be above 10 matic");
