...
// File: contracts/BrokeBoizV2.sol
...
contract BrokeBoizV2 is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmTv9XYdryGZL2p2ix9sXr3M2hTS5waeNvp1jnVhUfgFgy/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.000001 ether;
  uint256 public maxSupply = 2111;
  uint256 public maxMintAmountPerTx = 2111;

  bool public paused = false;
  bool public revealed = true;

  constructor() ERC721("BrokeBoizV2", "BBV2") {
    setHiddenMetadataUri("ipfs://QmTv9XYdryGZL2p2ix9sXr3M2hTS5waeNvp1jnVhUfgFgy/");
  }
