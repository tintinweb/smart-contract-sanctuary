...
contract TenguPresale is Ownable {
    ...
    function buyTengu(uint256 busdAmount) external {
        ...
        if (soldBUSDAmount.add(busdAmount) > presaleBUSDHardcap) {
            busdAmount = presaleBUSDHardcap.sub(soldBUSDAmount);
        }
        ...
        busdToken.safeTransferFrom(msg.sender, collector, busdAmount);
        emit BuyTengu(msg.sender, busdAmount, tenguAmountToBuy);
    }
