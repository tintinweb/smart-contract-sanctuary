...
// File: contracts/CUR_Opensea.sol
...
contract STRIPES is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ContextMixin, ERC721Burnable, ERC2981ContractWideRoyalties {
    constructor() ERC721("SATURN RINGS", "STRIPES") {}

    string _baseURL = "https://metalab.su/nftdata/stripes/";
    string _contractURL = "https://metalab.su/nftdata/stripes/contract";
