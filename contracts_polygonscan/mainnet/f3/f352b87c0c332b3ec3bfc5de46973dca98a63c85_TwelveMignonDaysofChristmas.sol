...
contract TwelveMignonDaysofChristmas is ERC1155, Ownable {
   ...
   // address[] public to = [0x78b69454c4989afFe7321A36995ea173C383F1Fe, 0xdC0bB7E2aC5FF6851554Dc6E842F6aA171E72521, 0x17704da7540B9Bd2316a277453193e19Fb5B5c0c];
   // uint256[] public ids = [8347577685385400261322091794045719090038428855826751926891627216311448240428];
   ...
   // function multiTransfer(address from, address to, uint256[] calldata ids, uint256[] calldata amount) public onlyOwner{
        //  for (uint i=0; i<to.length; i++) {
            //  address addr = to[i];
        
          //  _safeBatchTransferFrom(0x12748fC0f091e1469767cFB4288cF68a4E9C7a4b, addr, ids[], amount[], "");
       // }
