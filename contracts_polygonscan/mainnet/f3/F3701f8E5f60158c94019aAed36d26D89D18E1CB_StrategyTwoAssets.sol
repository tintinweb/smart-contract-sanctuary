...
abstract contract StrategyFarmTwoAssets is BaseStrategyMasterChef {
        ...
        )
    {
        ...
        matic_usdt_path = new address[](2);
        matic_usdt_path[0] = matic;
        matic_usdt_path[1] = usdt;
    }
    ...
    function harvest() public override {
        ...
        if (_maticBalance > harvestCutoffMatic){
            ...
            _swapUniswapWithPath(matic_usdt_path, _maticBalancePost.div(2));

            // Add liquidity
            uint256 _usdt = IERC20(usdt).balanceOf(address(this));
            uint256 _matic = IERC20(matic).balanceOf(address(this));
            if (_usdt > 0 && _matic > 0) {
                IERC20(usdt).safeApprove(currentRouter, 0);
                IERC20(usdt).safeApprove(currentRouter, _usdt);
...
contract StrategyTwoAssets is StrategyFarmTwoAssets {
    ...
    address public Matic_USDT_LP = 0x65D43B64E3B31965Cd5EA367D4c2b94c03084797;
