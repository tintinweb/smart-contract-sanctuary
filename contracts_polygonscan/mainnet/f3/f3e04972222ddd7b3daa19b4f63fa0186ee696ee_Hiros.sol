...
contract Hiros is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    constructor(string memory baseURI, address payable creator) ERC721("Hiros", "HIRO") {
        setBaseURI(baseURI);
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, "/hiro_", tokenId.toString(), ".json")) : "";
    }
