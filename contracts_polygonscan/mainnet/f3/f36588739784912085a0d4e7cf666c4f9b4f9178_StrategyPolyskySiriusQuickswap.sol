...
// File: Vault\StrategyPolyskySiriusQuickswap.sol

// openzeppelin v3.1.0

contract StrategyPolyskySiriusQuickswap is StrategySingleBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToWantPath= [address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
        wantToEarnedPath = [address(0x00b1289f48e8d8ad1532e83a8961f6e8b5a134661d)];
    }
