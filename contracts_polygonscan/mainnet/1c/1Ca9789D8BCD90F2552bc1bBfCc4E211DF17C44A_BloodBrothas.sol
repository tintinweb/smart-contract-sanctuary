...
contract BloodBrothas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Blood Brothas", "BBNFT") {
    setHiddenMetadataUri("ipfs://QmPQyTKRW1UJKv7np3pv9Cc79q4fiurFKKTVPvsg16dEZu/hidden.json");
  }
