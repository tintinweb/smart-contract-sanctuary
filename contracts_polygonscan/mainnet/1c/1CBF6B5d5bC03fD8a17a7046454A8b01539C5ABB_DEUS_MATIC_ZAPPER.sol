...
contract DEUS_MATIC_ZAPPER is Ownable {
    ...
    function getSwapAmountERC20(ZapperInput memory input)
        public
        view
        returns (uint256, uint256)
    {
        ...
        input.amountIn = input.amountIn * 10**(18 - decimals);
        ...
        for (uint256 i = 0; i < input.iterations; i++) {
            ...
            while (neededCoinForBuyMatic + x > input.amountIn) {
                x = input.amountIn - neededCoinForBuyMatic;
            ...
            input.amountIn = input.amountIn - neededCoinForBuyMatic - x;
    ...
    function getSwapAmountMatic(ZapperInput memory input)
        public
        view
        returns (uint256, uint256)
    {
