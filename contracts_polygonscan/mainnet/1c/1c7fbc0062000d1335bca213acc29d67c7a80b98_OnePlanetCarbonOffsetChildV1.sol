...
// token transfers
// ----------------------------------------------------------------------------
contract OnePlanetCarbonOffsetChildV1 is ERC20Interface, OwnableUpgradeable, UUPSUpgradeable {
...
function initialize() public initializer {
		...
		oracleAddress = payable(0xAB594600376Ec9fD91F8e885dADF0CE036862dE0);
		retireAddress = 0x0000000000000000000000000000000000000000;
		daiAddress = payable(0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063);
        tetherAddress = payable(0xc2132D05D31c914a87C6611C10748AEb04B58e8F);
        usdcAddress = payable(0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174);
    ...
    //-------------------------------------------------------------------------------------------
    // Enables dApps to perform carbon offsetting applications with MATIC.
