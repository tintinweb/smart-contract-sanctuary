...
contract CozyOwlsClub is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount <= maxMintAmount , "Cant mint more then max mint per transaction" );
    require(supply + _mintAmount <= 2980, "Cant go over supply");
  ...
  function mintFREE(uint256 _mintAmount) public payable {
    ...
    require(!paused);
    require(ownerMintedCount + _mintAmount <= FREEnftPerAddressLimit, "max NFT per address exceeded");
    require(_mintAmount > 0, "Cant mint 0");
