...
contract Pepper is ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("XOXOXOXOXOXO", "PEPPER") {
    ...
    function mintPeppers(uint256 numTokens) public payable saleHasNotEnded {
        ...
        require(
            SafeMath.add(totalSupply(), numTokens) <= MAX_PEPPERS,
     ...
     * @dev Mint by token ID
     */
    function directMint(address to, uint256 tokenId) public onlyMinters {
        // require(tokenId > nftPublicNumbers, "Tokens number must not exist.");
