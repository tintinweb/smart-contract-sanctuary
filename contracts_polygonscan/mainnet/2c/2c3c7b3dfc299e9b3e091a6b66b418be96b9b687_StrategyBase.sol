...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant swapToken = 0x445FE580eF8d70FF569aB36e80c647af338db351;
        ...
        )
    {
        ...
        matic_usdc_path = new address[](3);
        matic_usdc_path[0] = matic;
        matic_usdc_path[1] = eth;
        matic_usdc_path[2] = usdc;
    }
    ...
    function harvest() public override {
        ...
        if (_maticBalance > maticHarvestCutoff){
            _swapUniswapWithPath(matic_usdc_path, _maticBalance);
        }
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public CURVE_MASTER_CHEF = 0x19793B454D3AfC7b454F206Ffe95aDE26cA6912c;
    address public am3CRV_LP = 0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171;
