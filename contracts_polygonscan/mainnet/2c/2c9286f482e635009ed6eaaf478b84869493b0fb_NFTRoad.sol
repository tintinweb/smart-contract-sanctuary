...
contract NFTRoad is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    function createRecord(uint256 maxSupply, uint256 price) public returns (uint256 tokenId) {
        recordsCount += 1;
    ...
    function updateRecord(uint256 id, uint256 maxSupply, uint256 price) public {
        Record memory record = records[id];
        require(record.owner == msg.sender, "not an owner");
