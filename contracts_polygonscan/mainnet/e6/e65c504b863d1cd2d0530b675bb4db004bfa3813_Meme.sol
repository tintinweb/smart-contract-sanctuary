...
contract Meme is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 250; // 2.5%
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 750; // (5% liquid 2.5% lotto)
    uint256 private _previousLiquidityFee = _liquidityFee;

    IBdexRouter public bdexRouter;
    address public bdexPair;
    address public lottoFund;
    ...
    function initialize(address _lottoFund, address _bdexPair) public notInitialized {
        ...
        _isExcludedFromFee[_lottoFund] = true;
        _isExcludedFromFee[address(this)] = true;

        emit Transfer(address(0), _msgSender(), _tTotal);
        _initialized = true;

        lottoFund = _lottoFund;
        bdexPair = _bdexPair;
    }
    ...
    function setLottoFund(address _lottoFund) public onlyOwner {
        lottoFund = _lottoFund;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            _tokenTransfer(address(this), lottoFund, totalLottoFund, false);
            emit SendToLottoFund(lottoFund, totalLottoFund);
