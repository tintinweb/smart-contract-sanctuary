...
// File: contracts/HoneyFinanceToken.sol
...
contract HoneyFinance is BEP20('Honeyfinance', 'Honeybee') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTHoneybee::transfer: Burn value invalid");
