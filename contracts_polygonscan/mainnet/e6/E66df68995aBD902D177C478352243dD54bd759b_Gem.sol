...
contract GemMetadata is Ownable, IGemMetadata {
    ...
    function drawGem(uint256 id) public view returns (string memory) {
        string
            memory svgAccumulator = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" preserveAspectRatio="xMinYMin meet" viewBox="0 0 420 440" xml:space="preserve"><style type="text/css"> .st0{fill:#000000;} .st1{fill:#FF4000; font-family: monospace; font-size: 10px;}</style><g transform="scale(1 1)">';
        svgAccumulator = strConcat(svgAccumulator, '<rect class="st0" width="100%" height="100%"/><text x="10" y="10" class="st1">');
        ...
        svgAccumulator = strConcat(svgAccumulator, '</text></g></svg>');
