...
interface IMasterChef {
    function add(uint _allocPoint, IERC20 _lpToken, uint16 _depositFeeBP, bool _withUpdate) external;
    function set(uint _pid, uint _allocPoint, uint16 _depositFeeBP, bool _withUpdate) external;
    function updateEmissionRate(uint _shPerBlock) external;
}

contract MasterChefWrapper is Ownable {
