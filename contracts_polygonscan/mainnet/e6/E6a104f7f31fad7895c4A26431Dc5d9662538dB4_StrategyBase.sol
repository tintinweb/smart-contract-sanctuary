...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    // Other constants
    uint16 public constant underlyingPoolId = 29;
    ...
    address[] public eth_dino_path;
    address[] public eth_usdc_path;
        ...
        )
    {
        ...
        eth_dino_path = new address[](2);
        eth_dino_path[0] = eth;
        eth_dino_path[1] = dino;

        eth_usdc_path = new address[](2);
        eth_usdc_path[0] = eth;
        eth_usdc_path[1] = usdc;
    }
    ...
    function harvest() public override {
        ...
        if (_pswampBalance > harvestCutoff){
            // Swap to ETH
            _swapUniswapWithPath(pswamp_eth_path, _pswampBalance);
            ...
            // Swap 1/2 of rest to Dino
            uint256 _ethBalancePost = IERC20(eth).balanceOf(address(this));
            _swapUniswapWithPath(eth_dino_path, _ethBalancePost.div(2));

            // Swap 1/2 of rest to USDC
            uint256 _ethBalanceRemain = IERC20(eth).balanceOf(address(this));
            _swapUniswapWithPath(eth_usdc_path, _ethBalanceRemain);
            ...
            if (_usdc > 0 && _dino > 0) {
                ...
                IERC20(dino).safeApprove(sushiRouter, _dino);
