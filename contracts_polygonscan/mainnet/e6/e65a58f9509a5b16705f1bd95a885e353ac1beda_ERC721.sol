...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, AccessControl {
    ...
    // Token name
    string private _name = "Dojo NFT";

    // Token symbol
    string private _symbol = "MYNFT";
    ...
    function changeBadgeType(string memory ipfsHash, uint16 index) public onlyOwner {
    ...
    function mintToken(
        ...
        BadgeTypes[totalSupply] = badgeType;
