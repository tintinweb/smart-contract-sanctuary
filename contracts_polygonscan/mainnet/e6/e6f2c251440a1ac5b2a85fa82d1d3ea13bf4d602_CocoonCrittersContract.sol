  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xe2FCD6EF0176D419A456DF3aDa97F6b225132F0C);
    ...
    // File: contracts/cocoonCrittersContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CocoonCrittersContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Cocoon Critters", "CC", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/KusvMXWf3OUHRSpO3US4/contract-metadata";
        }
    }