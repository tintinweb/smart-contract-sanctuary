...
contract DelightToken is ERC20('DelightToken', 'DELIGHT'), ReentrancyGuard, Ownable {
    ...
    uint256 public salePriceE35 = 10 * (10 ** 35);

    uint256 public usdcMaximumAvailable = (delightMaximumSupply * salePriceE35) / 1e35;
    ...
    function buyDelight(uint256 _usdcSpent) external nonReentrant {
        ...
        require(_usdcSpent <= usdcMaximumAvailable, "Delight Presale hardcap reached");
        require(userDelightTotally[msg.sender] < (usdcPerAccountMaxBuy / salePriceE35), "user has already purchased too much delight");
