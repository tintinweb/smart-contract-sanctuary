...
library MetadataGenerator {
  ...
  function tokenURI(address owner, uint256 tokenId, bytes3 color, uint256 chubbiness) internal pure returns (string memory) {
      ...
      string memory name = string(abi.encodePacked('Buddy #',tokenId.toString()));
      string memory description = string(abi.encodePacked('This Buddy is the color #',color.toColor(),' with a chubbiness of ',uint2str(chubbiness),'!!!'));
...
contract YourCollectible is ERC721, Ownable {
  ...
  constructor() public ERC721("Buddies", "BUD") {
    // RELEASE THE LOOGIES!
  }
