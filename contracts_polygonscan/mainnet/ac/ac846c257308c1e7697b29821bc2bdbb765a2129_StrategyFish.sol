...
contract StratManager is Ownable, Pausable {
     ...
     * {operator} - Address where it auto calls the harvest().
     */
     ...
     * @param _insurance address where to send insurance fees.
     * @param _operator address where it auto calls the harvest().
     */
    constructor(
        address _strategist,
        address _unirouter,
    ...
    /**
     * @dev Updates insurance fee recipient.
     * @param _insurance new insurance  recipient address.
     */
...
contract StrategyFish is StratManager, FeeManager {
    ...
    ) StratManager(_strategist, _unirouter, _vault, _insurance, _operator) public {
        _giveAllowances();
    }
 ...
 function harvest() public whenNotPaused {
        require(tx.origin == msg.sender || msg.sender == vault || msg.sender == operator, "!contract");
