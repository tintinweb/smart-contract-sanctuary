...
contract CapitalStake is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address _signer, address _nsure,address _nsureMint, uint256 _startBlock) public {
        nsure       = INsure(_nsure);
        nsureMint   = INsureMint(_nsureMint);
    ...
    function updatePool(uint256 _pid) public {
        ...
        bool mintRet = nsureMint.mint(address(this), nsureReward);
        if(mintRet) {
