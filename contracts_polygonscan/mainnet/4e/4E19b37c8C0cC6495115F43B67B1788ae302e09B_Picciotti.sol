...
contract Picciotti is ERC721, ERC721Enumerable, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://picciotti.com/uris/";
    }
    ...
    function safeMint(uint256 _count) public payable {
        ...
        require(_tokenIdCounter.current() + _count - 1 <= MAX_TOKENS, "Exceeds maximum tokens available for purchase");
