...
contract PrivateSaleV2 is Context, ReentrancyGuard {
     ...
     */
    function purchaseWithMATIC(string memory uid)
        public
        payable
        virtual
        nonReentrant
        returns (bool)
    {
        ...
        uint256 bollyToTransfer = msg.value * maticCmp / bollycoinPrice;
        ...
        IERC20(_bollycoin).transfer(_msgSender(), bollyToTransfer);
        emit Purchase(
            _msgSender(),
            uid,
            bollyToTransfer,
