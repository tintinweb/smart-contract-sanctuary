...
contract StrategyGFIUSDC is StratManager, FeeManager {
    ...
    address constant public output = address(0x874e178A2f3f3F9d34db862453Cd756E7eAb0381);
    ...
    address constant public masterchef = address(0xE6584E2432ef0b82A39C383e895E7e031655F2Bf);

    // Routes
    address[] public outputToWmaticRoute = [output, weth, wmatic];
