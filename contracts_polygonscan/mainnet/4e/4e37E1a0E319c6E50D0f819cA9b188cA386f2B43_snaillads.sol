...
contract snaillads is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 36000000000000000000; 
  uint256 public maxSupply = 5001; 
  uint256 public freeMints = 2501;
  bool public drop_is_active = false;


  uint256 public maxFreePurchase = 5; 
 ...
 function freemint(uint256 numberOfTokens)public  {
     ...
     require(drop_is_active, "Please wait until the drop is active to mint");
        ...
        require(addressesThatMintedFree[msg.sender] + numberOfTokens <= 5, "You have already minted 5 free");
