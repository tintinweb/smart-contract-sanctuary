 ...
 */
contract Marshmallow is ERC1155Tradable, ContextMixin, NativeMetaTransaction {
	constructor() ERC1155Tradable("Marshmallow", "MALLOW", "Marshmallow") {
    _initializeEIP712("Marshmallow");  // uri_合约名
	}
