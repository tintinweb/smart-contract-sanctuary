...
contract PolyBeeFinance is Context, IERC20, Ownable {
...
contract PolyBee is PolyBeeFinance, NativeMetaTransaction, ContextMixin {
    constructor() PolyBeeFinance() {
