...
contract AutoMinterFactory is Ownable
{
    struct CollectionInfo{
        AutoMinterERC721 collection;
        address owner;
        string appId;
    }

    address immutable erc721Implementation;
    uint256 public fee;
        ...
        bool mintRandomEnabled_) payable public
    {
        ...
        addExistingCollection(address(clone), msg.sender, appId_);
    }
    ...
    function addExistingCollection(address collectionAddress, address owner, string memory appId) onlyOwner() public{
        collections.push(CollectionInfo({
                collection: AutoMinterERC721(collectionAddress),
                owner: owner,
                appId: appId
            }));
