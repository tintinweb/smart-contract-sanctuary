...
contract pixeLoot is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
        ...
        returns (bytes memory)
    {
        ...
        bytes3 colorBytes = bytes3(abi.encodePacked(uint32(color) << 8));
        ...
        returns (string memory)
    {
        ...
        // Pack and cast hex to a string (cast to bytes) so we can pick out the characters for the hex code to put in a string.
        // Otherwise, we get a long 32bit string.
        bytes memory colorBytes = bytes(color.toHexString());
        bytes memory colorString = bytes(
            abi.encodePacked(
                colorBytes[2],
                colorBytes[3],
                colorBytes[4],
        ...
        bytes memory URI1 = '{"name":"pxL #';
        bytes memory URI2 = '","image":"';
        bytes memory URI3 = '"}';
