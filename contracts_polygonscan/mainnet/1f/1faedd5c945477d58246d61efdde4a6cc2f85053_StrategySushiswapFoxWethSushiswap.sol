...
// File: Vault\StrategySushiswapFoxWethSushiswap.sol

// openzeppelin v3.1.0

contract StrategySushiswapFoxWethSushiswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x0065a05db8322701724c197af82c9cae41195b0aa8)];
        ...
        token0ToEarnedPath = [address(0x0065a05db8322701724c197af82c9cae41195b0aa8), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x000b3f868e0be5597d5db7feb59e1cadbb0fdda50a)];
        ...
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x007ceb23fd6bc0add59e62ac25578270cff1b9f619), address(0x0065a05db8322701724c197af82c9cae41195b0aa8)];
