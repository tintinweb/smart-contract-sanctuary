...
// File: contracts/CuriousAddyItems.sol
...
contract CuriousAddyItems is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155SupplyUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}
    ...
    /**
     * Allows minting tokens up to the maximum specified mintsAllowed
     */
    function mint(uint256 tokenId, uint256 numberOfTokens) public {
        require(mintActive[tokenId], "MINT_NOT_ACTIVE");
        require(addressMintsPerTokenId[msg.sender][tokenId] <= mintsAllowed[tokenId], "MAXIMUM_ALREADY_MINTED");
