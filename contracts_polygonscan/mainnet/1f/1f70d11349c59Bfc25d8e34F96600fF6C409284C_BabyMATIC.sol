...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RWRD = IERC20(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
...
contract BabyMATIC is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMATIC";
    string constant _symbol = "BabyMATIC";
    ...
    // Anti-Bot v2
    uint256 public maxBotFee = 8000000000;
    ...
    event BotEntry(address bot, uint256 feePaid);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc1Ab63200581C5a32C065C4D9e40E4B15Ba6ee4E;
    ...
    // plz ser, dont snipe with a bot
        if(antiSniperMode){
            require(!isBot[sender],"Bots cant sell");
            if(tx.gasprice > maxBotFee && sender == pair){
                isBot[recipient] = true;
                emit BotEntry(recipient, tx.gasprice);
            }
        }
    ...
    // Bot manager
    function enable_anti_SniperMode(bool _status) public onlyOwner {
        antiSniperMode = _status;
    }

    function set_max_botfee(uint256 _botfee_withoutdecimal) public onlyOwner {
        maxBotFee = _botfee_withoutdecimal * 10**9;
    }

    function manage_bots(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountMATICDev, gas: 30000}("");
