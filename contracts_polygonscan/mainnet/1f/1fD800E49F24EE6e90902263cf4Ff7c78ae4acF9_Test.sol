 ...
 * @title Spatter.Art
 * @author Proof
 * @notice This contract allows n-project holders to mint a Spatter
 */
contract Test is NPassCore {
    using Strings for uint256;
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmVC8GGNyfLDWcYsrz9BtUXwhB5fe6rMxg4wZ5DXW9j9kA/";
    }
}