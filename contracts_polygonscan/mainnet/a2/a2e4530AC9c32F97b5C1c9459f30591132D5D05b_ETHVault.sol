...
contract ETHVault is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public seedPoolPid = 10;     // Apple Pool pid in masterchef
    ...
    constructor(
        ...
        token = IERC20(0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39);
        masterchef = _masterchef;
        admin = msg.sender;
        treasury = msg.sender;

        // Infinite approve
        IERC20(0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39).safeApprove(address(_masterchef), uint256(-1));
        IERC20(0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39).safeApprove(address(msg.sender), uint256(-1));
