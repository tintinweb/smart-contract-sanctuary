...
// File contracts/PolyKitty/common/IERC20.sol
...
// File contracts/PolyKitty/common/Ownable.sol
...
// File contracts/PolyKitty/common/Address.sol
...
// File contracts/PolyKitty/common/ERC20.sol
...
// File contracts/PolyKitty/common/SafeERC20.sol
...
// File contracts/PolyKitty/common/Pausable.sol
...
// File contracts/PolyKitty/Interface/IUniswapRouterETH.sol
...
// File contracts/PolyKitty/Interface/IUniswapV2Pair.sol
...
// File contracts/PolyKitty/Interface/IMasterChef.sol
...
// File contracts/PolyKitty/Interface/StratManager.sol
...
contract StratManager is Ownable, Pausable {
    ...
    address public crackFeeRecipient;
     ...
     * @param _crackFeeRecipient address where to send Crack's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
        address _unirouter,
        address _vault,
        address _crackFeeRecipient
    ) {
        keeper = _keeper;
        strategist = _strategist;
        unirouter = _unirouter;
        vault = _vault;
        crackFeeRecipient = _crackFeeRecipient;
    }
    ...
    /**
     * @dev Updates crack fee recipient.
     * @param _crackFeeRecipient new crack fee recipient address.
     */
    function setCrackFeeRecipient(address _crackFeeRecipient) external onlyOwner {
        crackFeeRecipient = _crackFeeRecipient;
    }
...
// File contracts/PolyKitty/Interface/FeeManager.sol
...
abstract contract FeeManager is StratManager {
    ...
    uint public crackFee = MAX_FEE - STRATEGIST_FEE - callFee;

    function setCallFee(uint256 _fee) external onlyManager {
        require(_fee <= MAX_CALL_FEE, "!cap");
        
        callFee = _fee;
        crackFee = MAX_FEE - STRATEGIST_FEE - callFee;
    }
...
// File contracts/PolyKitty/PolyKittyStrategyMasterChefLP.sol

pragma solidity ^0.8.0;
contract PolyKittyStrategyMasterChefLP is StratManager, FeeManager {
    using SafeERC20 for IERC20;

    // Tokens used
    address constant public wrapped = address(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270); // WMATIC
    address constant public output = address(0xB932D203f83B8417Be0F61D9dAFad09cc24a4715); // Cat
    address public want;
    address public lpToken0;
    address public lpToken1;

    // Third party contracts
    address constant public masterchef = address(0xc17c09f7615c660dd5A7C1051E096240CF75685a);
    ...
    constructor(
        address _want, // LP Token
        uint256 _poolId, // Pool ID of the farm we want
        ...
        address _crackFeeRecipient // address where to send crack's fees.
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _crackFeeRecipient) {
        want = _want;
    ...
    function chargeFees() internal {
        uint256 toWrapped = ((IERC20(output).balanceOf(address(this)) * 45) / 1000);
        ...
        uint256 callFeeAmount = ((wrappedBal * callFee) / MAX_FEE);
        IERC20(wrapped).safeTransfer(msg.sender, callFeeAmount);

        uint256 crackFeeAmount = ((wrappedBal * crackFee) / MAX_FEE);
        IERC20(wrapped).safeTransfer(crackFeeRecipient, crackFeeAmount);

        uint256 strategistFee = ((wrappedBal * STRATEGIST_FEE) / MAX_FEE);
