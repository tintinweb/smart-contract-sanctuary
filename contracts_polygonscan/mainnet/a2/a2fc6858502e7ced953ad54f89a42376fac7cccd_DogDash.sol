...
contract DogDash is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    constructor(string memory baseURI, address payable creator,uint256 _count) ERC721("DOG DASH", "DOGDASH") {
        setBaseURI(baseURI);
