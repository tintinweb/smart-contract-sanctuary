...
contract Token is ERC20Upgradeable, Pausable {
    ...
    function init(address[] calldata instances) external onlyManager {
    ...
    */
    function getTax(
        ...
        if (pairs[recipient] == true && _isExcludedFromFee[sender]) {
            // Sell
