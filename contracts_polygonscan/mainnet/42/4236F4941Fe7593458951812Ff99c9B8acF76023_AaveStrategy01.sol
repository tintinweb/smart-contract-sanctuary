...
contract AaveStrategy01 is Strategy {
    ...
    function aave_loop_deposit_001(string memory Coin) public onlyOwner() returns(uint256) {
        AavePair storage AAVE = AavePairOf[Coin];
        IERC20 SToken = IERC20(AAVE.basic);
    ...
    function aave_loop_deposit_002(string memory Coin, uint256 tokenAmt) private onlyOwner() returns(uint256) {
        AavePair storage AAVE = AavePairOf[Coin];
        IERC20 SToken = IERC20(AAVE.basic);
