...
contract NFBPresale is Ownable {
    ...
    uint256 public mintPrice = 253e18; // 0.1 ether
    uint256 public mintLimit = 3; //x NFT, bonus 1
    uint256 public presaleMinLimitPrice = 759e18; //mintPrice * mintLimit
    ...
    function setMintPrice(uint256 price) public onlyOwner {
        mintPrice = price;
        presaleMinLimitPrice = price.mul(mintLimit);
    }
