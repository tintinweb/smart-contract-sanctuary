...
// File: Vault\StrategyQuickswapDhvQuickQuickswap.sol

contract StrategyQuickswapDhvQuickQuickswap is StrategyLPBase {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    constructor(
        ...
        earnedToToken0Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x005fcb9de282af6122ce3518cde28b7089c9f97b26)];
        earnedToToken1Path = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token0ToEarnedPath = [address(0x005fcb9de282af6122ce3518cde28b7089c9f97b26), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        token1ToEarnedPath = [address(0x00831753dd7087cac61ab5644b308642cc1c33dc13)];
        wmaticToToken0Path = [address(0x000d500b1d8e8ef31e21c99d1db9a6444d3adf1270), address(0x00831753dd7087cac61ab5644b308642cc1c33dc13), address(0x005fcb9de282af6122ce3518cde28b7089c9f97b26)];
