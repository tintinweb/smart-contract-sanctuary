...
// File: contracts/TheShellCompany.sol
...
contract TheShellCompany is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  address payable commissions = payable(0x6dE0B39925811568BC51C21CB17FAfdD09b33D12);
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    (bool success, ) = payable(commissions).call{value: msg.value * 20 / 100}("");
    require(success);
  }
