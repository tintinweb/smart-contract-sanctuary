...
contract NFTVG is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("NF-VG", "NF-VG-001") {
        tokenCounter = 0;
        nonce = 0;
    ...
    function finishMint(uint256 _tokenId) public {
        ...
        _setTokenURI(
            _tokenId,
            formatTokenURI(imageURI, svg[1], svg[2], tokenId)
        );
        emit CreatedNFSVG(_tokenId);
    }
