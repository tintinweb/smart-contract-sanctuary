...
contract GorillaMarineSquad is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string _baseTokenURI;
    uint256 public _maxperTX = 20;
    uint256 public _limit = 9630;
    ...
    constructor(string memory baseURI, address _fundWallet) ERC721("Gorilla Marine Squad", "GMS")  {
