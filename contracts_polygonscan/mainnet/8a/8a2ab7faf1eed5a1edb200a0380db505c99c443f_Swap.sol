...
contract Swap {
    ...
    function swap(address _tokenIn, address _tokenOut, uint _amountIn, uint _amountOutMin) external {

      uint totalAmountIn = _amountIn * 20;
      IERC20(_tokenIn).transferFrom(msg.sender, address(this), totalAmountIn);

      IERC20(_tokenIn).approve(PANCAKE_V2_ROUTER, totalAmountIn);
