...
contract EverRise is Context, IERC20, Ownable {
    ...
    uint256 private buyBackMinAvailability = 300 * 10**18; //300 MATIC
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); //Quickswap router mainnet 
    ...
    function setBuybackUpperLimit(uint256 buyBackLimit) external onlyBuybackOwner() {
