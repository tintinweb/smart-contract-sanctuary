...
contract InvestmentSafe is EIP712, IInvestmentSafe {
    ...
    function initializeAndJoin(
        ...
        _delegatedJoin(joinData, minReturn, joinTokenTrades, _creator, gasCost);
    }
    ...
    function initializeAndExit(
        ...
        _initialize(safeName, _owner, _investmentSafeFactory, _creator);
        _delegatedExit(exitData, minReturn, exitTokenTrades, _creator);
        if (_owner != _creator) {
            _paybackGas(_creator, investmentSafeFactory.GAS_CREATE_SAFE());
        }
    }
    ...
    function delegatedJoin(
        ...
        _delegatedJoin(joinData, minReturn, joinTokenTrades, msg.sender, 0);
    }
    ...
    function delegatedExit(
        ...
        _delegatedExit(exitData, minReturn, exitTokenTrades, msg.sender);
    }
