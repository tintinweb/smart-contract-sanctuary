...
// File: contracts/ChipnoMunksTest.sol
...
contract ChipnoPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ChipnoPunks", "CHP") {
    setHiddenMetadataUri("ipfs://QmY7FFd2kZk8e9EeUaLikLtBTifAYSqHJ5C4Fby7HXHo67/hidden.json");
  }
