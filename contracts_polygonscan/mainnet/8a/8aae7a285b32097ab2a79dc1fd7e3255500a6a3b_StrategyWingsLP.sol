...
contract StrategyWingsLP is Ownable, Pausable {
    ...
    address public constant wings =
        address(0x898F53e0365b3e8114227Df4E811766afCA960b8);
    ...
    address public constant masterchef =
        address(0x5128D5C33fFd0c66e5C696cc66168C8D39604645);
    ...
    address public constant rewards =
        address(0xdF68A114Da2949ADDC4246941af9f535b40c16CE);
     ...
     *
     * {REWARDS_FEE} - 4% goes to pWINGS reward pool.
    ...
    constructor(
        ...
        lpPair = _lpPair;
        lpToken0 = IJetswapPair(lpPair).token1();
        lpToken1 = IJetswapPair(lpPair).token0();
        poolId = _poolId;
        vault = _vault;
