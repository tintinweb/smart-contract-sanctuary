...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant swapToken = 0xC2d95EEF97Ec6C17551d45e77B590dc1F9117C67;
        ...
        )
    {
        ...
        matic_btc_path = new address[](3);
        matic_btc_path[0] = matic;
        matic_btc_path[1] = eth;
        matic_btc_path[1] = btc;
    }
    ...
    function harvest() public override {
        ...
        // Swap matic for bitcoin
        uint256 _maticBalance = IERC20(matic).balanceOf(address(this));
        if (_maticBalance > maticHarvestCutoff){
            _swapUniswapWithPath(matic_btc_path, _maticBalance);
        }
        
        // Take performance fee
        uint256 _btcBalance = IERC20(btc).balanceOf(address(this));
        if (_btcBalance > 0) {
            uint256 performanceFee = _btcBalance.mul(keepFXS).div(keepFXSmax);
            if (performanceFee>0) {
        ...
        if (btcBal>0){
            ...
            IERC20(btc).safeApprove(swapToken, btcBal);
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public CURVE_MASTER_CHEF = 0xffbACcE0CC7C19d46132f1258FC16CF6871D153c;
    address public btcrenbtc_LP = 0xf8a57c1d3b9629b77b6726a042ca48990A84Fb49;
