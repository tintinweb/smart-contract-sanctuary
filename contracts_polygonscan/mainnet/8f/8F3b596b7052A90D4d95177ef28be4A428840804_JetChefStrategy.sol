...
contract JetChefStrategy is BaseStrategyMasterChef {
    ...
    address constant PWING = 0x845E76A8691423fbc4ECb8Dd77556Cb61c09eE25;

    address constant ERC_FUND = 0x01fE07ce760DA7a025e4Cf3f950aE236F8e62120;
    address constant MASTER_CHEF = 0x4e22399070aD5aD7f7BEb7d3A7b543e8EcBf1d85;
    address constant JET_ROUTER = 0x5C6EC38fb0e2609672BDf628B1fD605A523E5923;
        ...
        )
    {
        ...
        if(tokenA == WMATIC) {
            ...
            reward_a_path[0] = PWING;
            reward_a_path[1] = WMATIC;
        }
        else {
            //token A must be ETH, USDT, or USDC, since WMATIC pairs exist for those tokens
            reward_a_path = new address[](3);
            reward_a_path[0] = PWING;
            reward_a_path[1] = WMATIC;
            reward_a_path[2] = _tokenA;
        }
        ...
        IERC20(PWING).safeApprove(JET_ROUTER, uint256(-1));
        if(PWING != _tokenA) IERC20(_tokenA).safeApprove(JET_ROUTER, uint256(-1));
        IERC20(_tokenB).safeApprove(JET_ROUTER, uint256(-1));
    }
