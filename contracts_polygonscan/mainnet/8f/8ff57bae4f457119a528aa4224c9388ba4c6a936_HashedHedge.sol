...
contract HashedHedge is ERC721Enumerable, Ownable { // contract name to yours
  ...
  uint256 public maxMintAmount = 26; // max allowed to mint at one time N.O.T.E must be => than line 1241 - mint(msg.sender, 10);
  ...
  constructor(
    ...
    mint(msg.sender, 26); // Must be lower than line 1231 | This is how many is minted FREE to owner upon deployment
  }
