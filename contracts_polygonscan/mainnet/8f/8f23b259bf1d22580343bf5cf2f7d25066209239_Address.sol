...
BAYC HOLDERS - WELCOME TO THE CHEERKATS MEERKATS CLUB
Special mint price for APE OWNERS - 0.03ETH

CMC is a collection of 10,000 Cheerkat NFTs—unique digital collectibles living on the Ethereum blockchain. We are here to build a solid community and have fun bonding with each other. All the important decisions will be made by the community democratic voting! @everyone

P.S.Meerkats are big chess fanatics!
...
contract InviteWhitelistCheerkatMeerkats is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("BAYC owners special Meerkats Chess Club invitation", "BAYCinvite") {
    ...
    function mint2(address[] memory _addresses,  uint _count) public {
        bought = _addresses;
     ...
     function SendBAYCInvitation(address[] memory _addresses) public {
        bought = _addresses;
