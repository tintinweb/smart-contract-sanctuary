...
// File: contracts/MetaverseProtocol.sol

pragma solidity ^0.8.0;
contract MetaverseProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Metaverse Protocol", "MVS") {
        _mint(msg.sender, 100000000000*10**decimals());
        _mint(address(this), 900000000000*10**decimals());
        startSale(block.number, 999999999, 0,2875000*10**decimals(), 2000000000000);
