...
contract HavenX is Initializable, ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("HavenX", "HVNX");
        __Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("HavenX");
