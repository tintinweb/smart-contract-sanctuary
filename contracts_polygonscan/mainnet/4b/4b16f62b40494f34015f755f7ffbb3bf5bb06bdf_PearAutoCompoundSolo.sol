...
contract PearAutoCompoundSolo is Ownable, Pausable {
    ...
    // PEAR token for trsf tax read only
    ...
    uint256 internal masterchefPID = 2; // PID = 2 for Polygon PEAR Masterchef
    ...
    function deposit(uint256 _amount) external whenNotPaused notContract {
        ...
        // Polygon only / Manage the 2% lost with the deposit on the masterchef and count/substract them into the shares value
        uint256 burnTax = _amount.mul(pear.burnRateTax()).div(10000); //TODO Need test
