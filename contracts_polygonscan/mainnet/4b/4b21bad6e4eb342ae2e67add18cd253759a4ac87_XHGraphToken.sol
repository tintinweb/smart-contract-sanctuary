...
// File: contracts/token/XHGraphToken.sol
...
/**
 * @title XHGraphToken contract
 * @dev This is the implementation of the ERC20 HyperGraph OrgNode Token.
 ...
 *
 */
contract XHGraphToken is Governed, ERC20, ERC20Burnable {
    using SafeMath for uint256;
    ...
    bytes32 private constant DOMAIN_NAME_HASH = keccak256("HyperGraph OrgNode Token");
    ...
    uint256 public _totalSupply = 5* (10 ** 8) * (10 ** 18); // total supply is 10 billion
    uint256 public initialSupply = 5 * (10 ** 5) * (10 ** 18);
    ...
    /**
     * @dev HyperGraph OrgNode Token Contract Constructor.
     */
    constructor() ERC20("HyperGraph OrgNode Token", "XHGT") {
    ...
    function permit(
        ...
        require(_owner == recoveredAddress, "XHGT: invalid permit");
        require(_deadline == 0 || block.timestamp <= _deadline, "XHGT: expired permit");
    ...
    function mint(address _to, uint256 _amount) external onlyMinter {
        require(_amount.add(totalSupply()) <= _totalSupply, "Exceed totalSupply");
        _mint(_to, _amount);
    }

    function mintInvestAndTeam() external onlyMinter{
