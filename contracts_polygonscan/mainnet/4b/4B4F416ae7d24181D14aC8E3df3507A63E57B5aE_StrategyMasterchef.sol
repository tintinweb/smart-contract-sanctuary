...
contract StrategyMasterchef is BaseStrategyLPSingle {
    ...
    constructor(
        ...
        address[] memory _earnedToDespairPath,
        ...
        earnedToDespairPath = _earnedToDespairPath;
...
import "./libs/IStrategyDespair.sol";
...
abstract contract BaseStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant despairAddress = 0xc85Cd51369eD43689e51F0137910E59985cBD6C2;
    address public constant rewardAddress = 0xd4fA01c14b2eA7F3E9A3E575d9C9Ab240AD57b47;
    address public constant withdrawFeeAddress = 0xB1Dc03bDE699B2EC40c6cbe89c5Db955d4D8d6Ed;
    ...
    address[] public earnedToDespairPath;
    ...
    function distributeRewards(uint256 _earnedAmt) internal returns (uint256) {
        if (rewardRate > 0) {
            ...
            IStrategyDespair(rewardAddress).depositReward(usdcAfter);
    ...
    function buyBack(uint256 _earnedAmt) internal virtual returns (uint256) {
        if (buyBackRate > 0) {
            ...
            if (earnedAddress == despairAddress){
