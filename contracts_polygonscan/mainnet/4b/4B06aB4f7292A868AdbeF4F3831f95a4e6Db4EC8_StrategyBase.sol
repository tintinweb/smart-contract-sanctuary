...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address[] public usdc_arcadium_path;
        ...
        )
    {
        ...
        usdc_arcadium_path = new address[](2);
        usdc_arcadium_path[0] = usdc;
        usdc_arcadium_path[1] = arcadium;
    }
    ...
    function harvest() public override {
        ...
        if (_usdcBalance > harvestCutoffUSDC){
            ...
            _swapUniswapWithPath(usdc_arcadium_path, _usdcBalancePost.div(2));
            
            // Add liquidity
            uint256 _usdc = IERC20(usdc).balanceOf(address(this));
            uint256 _arcadium = IERC20(arcadium).balanceOf(address(this));
            if (_usdc > 0 && _arcadium > 0) {
                IERC20(usdc).safeApprove(arcadiumLiquidityRouter, 0);
                IERC20(usdc).safeApprove(arcadiumLiquidityRouter, _usdc);
...
contract StrategyBase is StrategyFarmBase {
    ...
    address public Want_Token = 0xB5DB659c561Dc84ec9D42d4277a5e01F3B69537b;
