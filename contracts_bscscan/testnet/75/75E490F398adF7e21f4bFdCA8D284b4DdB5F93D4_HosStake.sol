...
contract HosStake is Ownable {
    ...
    address public liquidityAddress = address(0xf6cB007930e823412A991786C0fa1D32Ef02B7D4);

    address public tribeAddress = address(0xA57CCAAB5f233Cea91Fc77dc0d675b11683945fa);

    uint256 public redeemRate = 1;
    
    address public redeemAddress = address(0xcd90CA38217274E96cC8Ca39e7D407164125e759);
    ...
    constructor(
        ...
        address(0x7Ce97F7a792e300DA00a19486536dDAD02449A5d)
        ];
    ...
    function getUserHos() public view returns (uint256, uint256){
        require(address(msg.sender) == address(tx.origin), "no contract");     
        return (powerMap[msg.sender].originalPower,powerMap[msg.sender].receivedProfit);
    }
