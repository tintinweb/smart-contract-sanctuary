...
// PianoToken with Governance.
contract PianoToken is BEP20 ('Piano Token', 'PIANO'), MinterRole {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "PIANO::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "PIANO::delegateBySig: invalid nonce");
        require(now <= expiry, "PIANO::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "PIANO::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying PIANOs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "PIANO::_writeCheckpoint: block number exceeds 32 bits");
