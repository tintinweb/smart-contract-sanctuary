...
/**
   #doehetkankerflikker(doehetkankerflikker)
...
interface IBEP20 {
    ...
    event Approval(address indexed owner, address indexed spender, uint256 avalue);
}
...
contract doehetkankerflikker is Context, IBEP20, Ownable {
    ...
    string private _name = "doehetkankerflikker";
    string private _symbol = "doehetkankerflikker";
