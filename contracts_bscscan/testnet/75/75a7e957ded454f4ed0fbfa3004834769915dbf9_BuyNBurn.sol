...
contract BuyNBurn is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1_000_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "BuyNBurn";
    string private _symbol = "BUYNBURN";
    ...
    uint256 public _liquidityFee = 50; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _boostedLiquidityFee = 50;

    uint256 public _marketingFee = 500; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _boostedMarketingFee = 700;

    uint256 public _buyBackFee = 1200;
    uint256 private _previousBuyBackFee = _buyBackFee;
    uint256 public _boostedBuyBackFee = 1500;

    uint256 public _devFee = 100;   
    uint256 private _previousDevFee = _devFee;
    uint256 public _boostedDevFee = 500;
    ...
    address payable private _marketingWallet = payable(0xE0718f32bdc9C980B307B3892DA39635176B04f2);
    address payable private _devWallet = payable(0xE0718f32bdc9C980B307B3892DA39635176B04f2);
    ...
    uint256 public _maxWalletToken = ( startingSupply * 1 ) / 100;  
    ...
    function includeInReward(address account) external onlyOwner() {
     ...
     function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
        _maxWalletToken = (startingSupply * maxWallPercent ) / 100;
    }   
...
,        address to,
        ...
        // max wallet code
        if (to != address(this)  && to != address(burnAddress) && to != lpPair && to != _marketingWallet){
