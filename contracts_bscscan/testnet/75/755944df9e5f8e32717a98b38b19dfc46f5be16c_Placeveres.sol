    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev function add condition when transfer, check transferer is in blacklist
     ...
     */
    function changeClaimDuration(uint256 _second) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function claim(address _to, uint256 amount)
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(_to != address(0), "Claimer is a zero address.");
        ...
        require(transfer(_to, amount), "Fail to transfer token.");
