...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = _TokenAddress.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            _TokenAddress.transfer(shareholder, amount);
...
contract EarnBabyDoge is IERC20, Ownable {
    ...
    function setTokenRewardAddress(address TokenAddress) external onlyOwner{
        _TokenAddress = TokenAddress;
    }
