...
contract BingoBsc is ReentrancyGuard, Ownable {
    ...
    function addOrder(uint orderId, address payable account, address coin, bytes32 planName, uint interest, uint depositTime, uint totalSettleTimes, uint settledTimes, bool isAir) public onlyOwner {
        collateralInfo storage info = orderInfo[orderId];
