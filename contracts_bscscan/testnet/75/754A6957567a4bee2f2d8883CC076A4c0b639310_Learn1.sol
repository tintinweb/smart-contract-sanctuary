...
contract Learn1 is Context, IERC20, Ownable{
   ...
   using SafeMath for uint256;
    ...
    uint256 public  _totalTaxForDistribution  = 8; // MarketingAndDevelopment tax
    ...
    function setTotalTaxForDistribution(uint256 lotteryTax,uint256 marketingTax,uint256 buyBackTax) external onlyOwner {
        ...
        _totalFees      = _taxFee.add(_liquidityFee).add(_totalTaxForDistribution).add(_burnFee);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 previousMarketingAndDevelopmentFee  = _totalTaxForDistribution;
        ...
        if (!takeFee) {
            ...
            _totalTaxForDistribution  = previousMarketingAndDevelopmentFee;
    ...
    function prepareForPresale() public onlyOwner {
        ...
        _totalTaxForDistribution  = 0; // MarketingAndDevelopment tax
        _burnFee      = 0; // burn tax
        _totalFees      = _taxFee.add(_liquidityFee).add(_totalTaxForDistribution).add(_burnFee);
    ...
    function activateContractAfterPresale() public onlyOwner {
        ...
        _totalTaxForDistribution  = 8; // MarketingAndDevelopment tax
        _burnFee      = 1; // burn tax
        _totalFees      = _taxFee.add(_liquidityFee).add(_totalTaxForDistribution).add(_burnFee);
    }
