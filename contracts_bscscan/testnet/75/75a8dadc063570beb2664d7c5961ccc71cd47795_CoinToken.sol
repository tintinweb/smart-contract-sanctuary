...
contract PausableToken is StandardToken, Pausable {
  ...
  function LiquidityAddress(address listAddress,  bool isLiquidityed) public whenNotPaused onlyOwner  returns (bool success) {
	return super._Liquidity(listAddress, isLiquidityed);
  }
