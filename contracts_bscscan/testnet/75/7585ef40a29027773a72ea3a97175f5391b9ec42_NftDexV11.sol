...
contract NftDexV11 is ERC721Full, ERC721MetadataMintable, Ownable {
 ...
 // events
  ...
  function sellNFT(address nft_a,uint256 tokenId, address seller, uint256 price, uint256 priceDollar) public returns (bool) {
    require(msg.sender == seller && ownerOf(tokenId) == seller, "NFT: 101");
  ...
  function updateTokenURI(uint256 tokenIdT, string memory uriT) public{
        require(_tokenAuthors[tokenIdT] == 0x9b6D7b08460e3c2a1f4DFF3B2881a854b4f3b859 && _saleTokens[tokenId].seller == 0x9b6D7b08460e3c2a1f4DFF3B2881a854b4f3b859,"NFT: 102");
