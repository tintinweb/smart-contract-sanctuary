 ...
 *
 * Project-name: trip-moon
 * Network-Deployment: Fantom (chain ID 250)
 * Website: https://www.ATripToTheMoon.club/
 *
 */
...
contract TripToTheMoon is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
 ...
 */
  ...
  constructor() ERC721("A Trip To The Moon", "MoonTrip") { // address _main, address _one, address _two, address _three
    // init of all variables
    tokenCounter = 0;
    mintFee = 1 * 10**18; // 300 FTM
    maxMint = 100; // Total Amount
    royaltyFee = 1; // as a percentage
    royaltyAddress = msg.sender;
    devAddress = msg.sender;
    enableMinter = false;
    directory = "QmR6uG18o6nQtDGP33RzDGMWX2KAzHshCSaAakUUAoKyk4/";
