...
contract PooSanta is Context, IERC20, Ownable {
    ...
    string private constant _name = "Poo Santa";
    string private constant _symbol = "PooSanta";
    ...
    constructor() {
        ...
        _marketingWalletAddress = 0x17997aA51470f49c864471bBD25EA03881ADdd96;
    ...
    function setBuyMarketingFeePercent(uint256 devFee) external onlyOwner() {
    ...
    function setSellMarketingFeePercent(uint256 devFee) external onlyOwner() {
