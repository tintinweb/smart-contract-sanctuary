...
contract IDO is VestedClaim, Whitelisted {
    ...
    uint256 public startTime; // Only for test purposes not marked as immutable. We accept the increased gas cost
    uint256 public endTime; // Only for test purposes not marked as immutable. We accept the increased gas cost
