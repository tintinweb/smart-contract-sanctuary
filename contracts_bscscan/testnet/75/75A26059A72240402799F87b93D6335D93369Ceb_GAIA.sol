...
contract GAIA is IRewardDistributionRecipient, ReentrancyGuard {
    ...
    address public devAddy = 0xdC3745944B6B619b2eE48F1FD35556bF7d86E0C6; //collects pool use fee
    uint256 public devtxfee = 1; //Fee for pool use, sent to Gaia farming pool
