...
contract MiniDogeCola is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingAddress = payable(0x84D4e534ABdD447Ef2Cc8ABD1593a7a7d514F088); // Marketing Address
    ...
    string private _name = "MiniDogeCola";
