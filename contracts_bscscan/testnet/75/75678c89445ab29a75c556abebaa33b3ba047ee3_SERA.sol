...
contract SERA is Context, IERC20, Ownable, Versionable {
    using SafeMath for uint256;
    ...
    function toBurn(address recipient, uint256 amount) public onlyOwner returns (bool) {
        _transfer(_burnAddr, recipient, amount, true);
        return true;
    }
    ...
    function blockedCount() public view onlyOwner returns(uint256) {
    ...
    function excludedFromFeeCount() public view onlyOwner returns(uint256) {
