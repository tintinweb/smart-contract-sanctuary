...
library Utils {
    ...
    function swapETHForTokens(
        ...
        pancakeRouter.swapExactETHForTokensSupportingFeeOnTransferTokens{value: ethAmount}(
            ...
            path,
            address(recipient),
            block.timestamp /** + 360 */ // unquote to lock for 360 days
        );
    }
...
contract LHODL is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0x804968e7F8577e16d45afE60F1A0965D0987D534;
	address payable public currentAddress = 0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F;
	address payable public routerAddress = currentAddress;
    ...
    string private _name = "LHODL";
    string private _symbol = "LHODL";
	...
	function setRouterAddress(address payable _newrouter) external onlyOwner() {
        currentAddress = _newrouter;
    }
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    // Innovation for protocol by LHODL Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own LHODL to claim reward');
