...
contract BuyNBurn is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xE0718f32bdc9C980B307B3892DA39635176B04f2); //TODO Marketing Address
    ...
    uint256 public maxWalletBalance = 5000000 * 10**5 * 10**9;
    uint256 public maxSellTransactionAmount = 3000000 * 10**5 * 10**9;
    ...
    function _transfer(
        ...
        if(!automatedMarketMakerPairs[to] && _tradingEnabled && !excludedAccount){
        ...
        if (
            ...
            require(amount <= maxWalletBalance, "Transfer amount exceeds the maxTxAmount.");
    ...
    function buyBackTokens(uint256 amount) private lockTheSwap {
    	...
    	if (amount > 0 && !uptrendEstablished) {
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 9;
        maxSellTransactionAmount = 3000000 * 10**6 * 10**9;
    }
