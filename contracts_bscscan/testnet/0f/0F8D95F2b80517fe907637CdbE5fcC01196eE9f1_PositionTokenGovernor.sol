...
contract PositionTokenGovernor is Governor, GovernorCompatibilityBravo, GovernorTimelockControl {
    using SafeMath for uint256;
    IERC20 posi = IERC20(0xb228359B5D83974F47655Ee41f17F3822A1fD0DD);
    uint256 private _delay = 100; // 5min //4800; // 4 hours
    uint256 private _period = 100; // 10min //28800; // ~ 1 day
    uint256 private _threshold = 0;
    uint256 private _quorum = 1 * 10 ** 18; //100000*10**18;
