...
contract AppData is IAppData, Ownable {
    ...
    uint256 public minTotalHashrate = 10000;
    uint256 public maxTotalHashrate = 13000;
    ...
    constructor() {
        ...
        // scale 
        scaleMultipleMap[1] = 100;
        scaleMultipleMap[2] = 120;
        scaleMultipleMap[3] = 150;
        scaleMultipleMap[4] = 200;
    ...
    function setLPMultiple(uint8 _multiple) public onlyOwner {
