...
contract Dividends is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'NoNameTest';
    string private constant _symbol = 'NNT';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10000000000 * 10**_decimals;//equals 10000 token
    ...
    uint16 public constant MaxSellLockTime= 3600;
    ...
    uint16 public constant MaxBuyLockTime= 3600;
    ...
    //DevWallets
    address public TeamWallet=payable(0x7A8362fD28cB52501E04a353A7CD5E83feD10155);
    address public walletTwo=payable(0x8754e93Bac852BDa88Bca1431E6B8eddA20a060e);
    //TestNet
	...
	uint256 private antiWhale = 5 * 10**_decimals;
    ...
    //marketing share starts at 75% to push initial marketing, after start
...
function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer((amount*2)/5);
        payable(walletTwo).transfer((amount*3)/5);
    } 
