...
contract ESNAPIISAMPLETOKEN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Samplebnbreflection";
    string constant _symbol = "MYSAMPLE";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 100 *10**18 * 10**_decimals;
