...
contract OzComCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 777777777 * 10 ** 9; //Total Supply
    ...
    address payable public marketingAddress = 0x000000000000000000000000000000000000dEaD;  //Marketing Wallet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) public lockTheSwap {
        uint256 totalFee = _marketingFee.add(_liquidityFee);
        uint256 totalFeeWithoutLiquidityTokens = _marketingFee.add(_liquidityFee.div(2));
        ...
        uint256 marketingContribution = currentBalance.div(totalFeeWithoutLiquidityTokens).mul(_marketingFee);

        TransferMarketingETH(marketingAddress, marketingContribution);
    ...
    function calculateliquidityFee(uint256 _amount) private view returns (uint256) {
        uint256 fee = _marketingFee.add(_liquidityFee);
