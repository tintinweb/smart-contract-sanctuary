...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.3.0/contracts/security/Pausable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.3.0/contracts/token/ERC20/extensions/ERC20Pausable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.3.0/contracts/token/ERC20/extensions/ERC20Capped.sol
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract Safedex is ERC20, Ownable ,  ERC20Pausable{
    ...
    constructor(uint256 initialSupply,address platform)   ERC20("SAFEDEX","SDX") Ownable() {
    require(initialSupply<=100000000000000000,"Initial supply greater than market cap");
       _mint(msg.sender, initialSupply);
       _rOwned[msg.sender] = _rTotal;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6CE54ad32e2d63c2e32F7A8A7b67E03Afa708a2a);
    ...
    function _mint(address account, uint256 amount) internal virtual override(ERC20) whenNotPaused{
        require(totalSupply() + amount <= 100000000000000000, "ERC20Capped: cap exceeded");
        require(account != address(0), "ERC20: mint to the zero address");
        ...
        if (_isExcluded[account]){
            ...
            _rOwned[account]+=reflectionFromToken(amount,false);
        }
    ...
    function removeUserFromBlacklist(address user) public onlyOwner {
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        _maxTxAmount = totalSupply()*maxTxPercent/10**2;
    }
    ...
    function pauseAllTransaction() public onlyOwner {
        _pause();
    }
    
    function unpauseAllTransactions() public onlyOwner {
        _unpause();
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            uint256 opFee = amount*_operationFee/100;
            _tokenTransfer(from,platformAddress,opFee,false);
            amount = amount-opFee;
        }
