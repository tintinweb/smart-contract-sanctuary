...
abstract contract Liquifier is Ownable, Manageable {
    ...
    */
    ...
    /**
     * @dev From the first start the liquidity pool may show another address, before pooling it in the pancakeswap, update the new address here.
     *
     */
    function _updatePoolToken(
        address poolAddress
    ) public onlyOwner() {
        ...
        emit PoolTokenUpdated(poolAddress);
    }
