...
contract JBSTOLETHIS is Context, IERC20, Ownable {
    ...
    string private  _name               = "JB Stole This";
    string private  _symbol             = "STOLEN";
    ...
    address payable private _wallet_charity = payable(0xE807Cef4b19C336BD0499dD484391C184c5Ab4E4);
    ...
    address payable private _wallet_team = payable(0x72be9113D98A7c9d7EEC14fb7ec2eBb936cC0E05);

    // Dev wallet
    address payable private _wallet_dev = payable(0x90BBD47628F2f6C4c3E3440fBE0C6f281ad6C899);
    
    // Auto LP
    uint256 public _fee_liquidity = 600;
    ...
    address PCSRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
