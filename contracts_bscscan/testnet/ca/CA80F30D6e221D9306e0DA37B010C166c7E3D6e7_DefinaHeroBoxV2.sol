...
VRFConsumerBase
{
     ...
     */
    constructor() ERC721("Defina Hero Box", "HEROBOXV2")
// BSC mainnet
//        VRFConsumerBase(0x747973a5A2a4Ae1D3a8fDF5479f1514F65Db9C31,
//                        0x404460C6A5EdE2D891e8297795264fDe62ADBB75) {
        VRFConsumerBase(0xa555fC018435bef5A13C6c6870a9d4C11DEC329C,
...
//        fee = 0.2 * 10 ** 18; // 0.2 LINK for BSC
        keyHash = 0xcaf3c3727e033261d383b315559476f48034c13b18f8cafed4d871abe5049186;
        fee = 0.1 * 10 ** 18; // 0.2 LINK for BSC
    }
    ...
    function setCardsQuota(uint[] calldata cardIds_, uint[] calldata cardsNum_) onlyRole(ADMIN_ROLE) whenPaused external {
        require(cardIds_.length != 0, "BlindBox: No cardIds was provided.");
        require(cardIds_.length == cardsNum_.length, "BlindBox: Number of card ids not match card quota");
    ...
    function open(uint tokenId) whenNotPaused onlyEOA external {
        ...
        uint index = _randModulus(allCandidateCards.length);
