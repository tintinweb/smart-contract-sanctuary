...
contract Employees is Context, AccessControl, ERC721Enumerable {
    ...
    mapping(uint256 => BBLibrary.EmployeeNFT) private employees;
    ...
    function getEmployee(uint256 id)
        ...
        view
        virtual
        returns (BBLibrary.EmployeeNFTData memory)
    {
        return BBLibrary.EmployeeNFTData(employees[id], tokenURI(id));
    }
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        string memory union = string(
            abi.encodePacked(
                ...
                ";multiplier:",
                Strings.toString(employees[id].multiplier)
            )
        );
    ...
    function mint(
        ...
        employees[_count] = BBLibrary.EmployeeNFT(
            head,
            body,
            legs,
            hands,
    ...
    function getMultiplier(uint256 id) public view virtual returns (uint256) {
        return employees[id].multiplier;
    }
