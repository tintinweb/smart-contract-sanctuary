...
contract MemeCoinFactoryToken is Context,IERC20, Ownable{
    ...
    string constant name = "Meme Coin Factory";
    string constant symbol = "FACTORY";
    ...
    uint256 constant private _totalSupply = 50000 * 10**6 * 10**9; //50B supply
    ...
    function _decimals()external pure returns(uint256){
        return decimals;
    }
