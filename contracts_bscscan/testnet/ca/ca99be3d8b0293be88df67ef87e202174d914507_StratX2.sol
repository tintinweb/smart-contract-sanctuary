...
contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp = true; // this vault is purely for staking. eg. WBNB-AUTO staking vault.
    ...
    function earn() internal virtual nonReentrant whenNotPaused {
        require(isAutoComp, "!isAutoComp");
        // if (onlyGov) {
        //     require(msg.sender == govAddress, "!gov");
        // }
