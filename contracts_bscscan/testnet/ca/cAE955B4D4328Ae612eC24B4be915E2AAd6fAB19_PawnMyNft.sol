...
contract PawnMyNft is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AstronautGame";
    string private _symbol = "Ast";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0f51649Bec976492452e0781Ce7dD14B7CED54a1); // Marketing Address
    address payable public teamWalletAddress = payable(0xeB10B43622997ECEDE0cd460126C34CDe5676ea7); // Team Address
