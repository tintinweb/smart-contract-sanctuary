...
contract ZONIX1 is Context, IERC20, Ownable {
    ...
    string private _name = "Zonix test";
    string private _symbol = "ZONIXTest";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 129; // 1.29 %
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 870; // 8.7%
