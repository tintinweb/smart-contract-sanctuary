...
contract M5 is Context, IERC20, Ownable {
    ...
    uint256 public bnbMaxUntilCharityCut = 1000000000000000000;     // maximum 1 BNB        
    uint256 public percentOfCharityCut = 30;


    uint256 public tokenHoldingMinForBNBrewards = 1 * 10**14 * 10**18;       // hold at least 0.1% of the token to get BNB rewards

    uint256 public maxNumOfTransfersToDoForReward = 5;

    uint256 public minimumAmountToHoldForRewards = 100000000000 * 10**18;      // 0.01% - must hold at least  0.01% of the token to get rewards
    ...
    address public charityWallet = 0xf3583B9FE98291eB8C4cAb244cF755cf0B22Ac50;
    ...
    uint256 public constant numTokensSellToAddToLiquidity = 300000000000 * 10**9;      // 0.03% - safemoon's is 0.5%
