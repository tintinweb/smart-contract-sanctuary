...
contract WoCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x7a4E30faba4829425e2f2Be8178490aeeC181454); // Marketing Address
    address payable public featurePaymentAddress =
        payable(0x7a4E30faba4829425e2f2Be8178490aeeC181454); // Address for paying for product features.
    address payable public constant airDropAddress =
        payable(0x7a4E30faba4829425e2f2Be8178490aeeC181454); // AirDrop Address
    ...
    string private constant _name = "WoCat";
