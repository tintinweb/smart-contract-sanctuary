...
contract SafeRug is IBEP20, Ownership {
    ...
    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // QUADRILLION
    uint256 public _maxTxAmount = _totalSupply * 10 / 1000; // 1%
    uint256 public _walletMax = _totalSupply * 20 / 1000; // 2%

    string constant _name = "SafeRug";
    string constant _symbol = "SAFERUG";
    ...
    constructor() Ownership(msg.sender) {
        router = PancakeRouter(routerAddress);
        pair = PancakeFactory(router.factory()).createPair(router.WETH(), address(this));
        ...
        marketingWallet = 0x0d5f5554CDffe73dB5ab3398888a4e02F328B035;
    ...
    function changeFees(uint256 newLiqFee, uint256 newMarketingFee) external authorized {
