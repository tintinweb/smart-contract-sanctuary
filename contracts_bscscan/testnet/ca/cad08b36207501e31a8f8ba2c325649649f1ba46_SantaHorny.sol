...
/**
 ...
 ;;;;;;;;;:::;;;;;;::;oO%vvnnnn>>n.  `nnnnnnnnnnnn>>nn.   `nnnvv' 
...
[email protected]@@@@@@@@OOo`;;;;;;:;[email protected]@@@@@@@@@@@@@@@"    HORNY       "@@@@@@@@@@@@@@[email protected]@@, 
...
contract SantaHorny is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SantaHorny.com";
    string constant _symbol = "kurwaHorny";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 1 / 2 ) / 100;
    ...
    //by -A-L-I-A-K-C-Z-A- settting the maximum permitted wallet holding (percent of total supply)
