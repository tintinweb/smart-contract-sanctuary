...
//  👥TG: https://t.me/BabyBurningMoonBSC

/**
 * TOKENOMICS
 * 5% Rewards in Burning MOON
 * 4% to LP 
...
//    $BURNINGMOON
//   CA:0x97c6825e6911578A515B11e25B552Ecd5fE58dbA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BURNINGMOON = IBEP20(0x97c6825e6911578A515B11e25B552Ecd5fE58dbA);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BURNINGMOON.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BURNINGMOON);
        ...
        uint256 amount = BURNINGMOON.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BURNINGMOON.transfer(shareholder, amount);
...
contract BabyTestnet is IBEP20, Auth {
    using SafeMath for uint256;

    address BURNINGMOON = 0x97c6825e6911578A515B11e25B552Ecd5fE58dbA;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY TEST NET";
    string constant _symbol = "TESTNET";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8c622A92Ba120D31F56CBa3fB13f9454121e9c0b;
