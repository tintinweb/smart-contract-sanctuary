...
contract DragonEggReward is Ownable, ReentrancyGuard, IDragonEggReward {
    ...
    constructor(address _signer, address _beneficiaryAddress, address _acceptTokenAddress) {
        signer = _signer;
        beneficiaryAddress = _beneficiaryAddress;
        acceptTokenAddress = _acceptTokenAddress;
    }
    ...
    function claim(uint salt, address eggToken, uint price, Sig calldata sig) override public nonReentrant {
        ...
        usedSalts[salt] = true;
        IERC20(acceptTokenAddress).safeTransferFrom(msg.sender, beneficiaryAddress, price);
