...
contract BakedBeans {
    ...
    uint256 private BEANS_IN_1_CAN = 1728000;//for final version should be seconds in a day
    ...
    function reBakeBeans(address ref) public{
        ...
        uint256 newBeans = SafeMath.div(beansBaked,BEANS_IN_1_CAN);
        beanCan[msg.sender] = SafeMath.add(beanCan[msg.sender],newBeans);
        ...
        //boost market to nerf beans hoarding
