...
contract SGOLD is owned, SmartGold {
    ...
    ) SmartGold(initialSupply, tokenName, tokenSymbol) public {}
    ...
    function freezGPXS(uint _value, uint _unlockTime) public {
        require(ids[msg.sender]);
