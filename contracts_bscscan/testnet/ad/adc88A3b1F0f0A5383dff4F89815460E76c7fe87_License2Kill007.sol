...
Created by the Narrowcastingscreen Deployer
...
contract License2Kill007 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xcb43B63BAC1eb805F166AE9A4F07F9c02D427755); // Marketing Address
    address payable public charityAddress = payable(0x0b69064AeaFe61518C69F3289f057eC5f138869D); // Charity/Dev Address
    ...
    uint256 private _tTotal = 7777777; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "007 License 2 Kill";
    string private _symbol = "007LTK";
    ...
    uint256 public marketingDivisor = 2; //Marketing Fee
    
    uint256 public charityDivisor = 7; //Charity/Dev Fee
