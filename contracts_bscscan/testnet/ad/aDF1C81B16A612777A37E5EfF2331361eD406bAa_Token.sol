...
contract Token {
    ...
    string public name = "SDOAS";
    string public symbol = "SSDOA";
    ...
    address public burnWallet = 0x2222222222222222222222222222222222222222; // Carteira de queima
    address public foundersWallet = 0x2222222222222222222222222222222222222222; // Carteira de fundadores
