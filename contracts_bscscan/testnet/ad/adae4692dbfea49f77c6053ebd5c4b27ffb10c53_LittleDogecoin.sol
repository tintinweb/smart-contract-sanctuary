...
contract LittleDogecoin is BEP20{
    ...
    */
    ...
    function beforePay(address merchant, address customer, uint256 amount) external override onlyAuthorizedContract returns(uint256 merchantBalance, uint256 customerBalance){
    ...
    function afterPay(address merchant, address customer, uint256 amount) external override onlyAuthorizedContract{
        require(merchant.isContract() == false,"LilDOGE:: merchant must be wallet address");
        require(customer.isContract() == false,"LilDOGE:: customer must be wallet address");
        require(amount > 0,"");
