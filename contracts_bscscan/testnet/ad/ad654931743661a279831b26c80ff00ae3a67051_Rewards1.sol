...
A PLACE FOR SOCIAL MEDIA LINKS
...
abstract contract Auth {
    ...
    /**
     * Renounce ownership with 1 click
     */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //the reward token you want distributed 
...
contract Rewards1 is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Rewards1";
    string constant _symbol = "REWARDS";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals); // by default its 1,000,000,000,000
    uint256 public _maxTxAmount = 1 * 10**12 * (10 ** _decimals); // by default its 1,000,000,000,000

    //max wallet holding of TOTAL SUPPLY BY DEFAULT
    uint256 public _maxWalletToken = 1 * 10**12 * (10 ** _decimals);   // by default its 1,000,000,000,000
