...
contract Dexther is ERC721Holder, ERC1155Holder{
  enum Status { Available, Swapped, Canceled }

bytes4 constant ERC165ID = 0x01ffc9a7;
bytes4 constant ERC1155ID = 0xd9b67a26; // todo 实现这个就是1155
  ...
  function updateOffer(
    ...
    address[] memory _offerTokensAddresses,
    uint256[] memory _offerTokensIds,
    ...
    offers[offerId].offerTokensAddresses = _offerTokensAddresses;
    offers[offerId].offerTokensIds = _offerTokensIds;
  ...
  function swap(uint256 offerId) external payable {
    ...
    if(offers[offerId].estimateTokenAddress == address(0x0)) {
      ...
      TransferHelper.safeTransferETH(offers[offerId].creator, estimateAmountMinusFee);
    } else {
      TransferHelper.safeTransferFrom(offers[offerId].estimateTokenAddress, msg.sender, feeTo, fee);
      TransferHelper.safeTransferFrom(offers[offerId].estimateTokenAddress, msg.sender, offers[offerId].creator, estimateAmountMinusFee);
    }
