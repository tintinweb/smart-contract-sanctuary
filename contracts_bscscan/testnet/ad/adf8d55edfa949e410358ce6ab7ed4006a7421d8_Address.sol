...
contract MiniGas is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2e98bB57a49C1b4fb3E67179B8Cf20f3Ecc2d1cF); // Marketing Address
    ...
    string private _name = "MiniGas";
    string private _symbol = "MiniGas";
