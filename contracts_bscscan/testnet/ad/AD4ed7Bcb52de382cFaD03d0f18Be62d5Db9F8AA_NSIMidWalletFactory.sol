...
contract NSIMidWallet is AccessControl {
    ...
    function trade(uint256 amountOutMin, address[] memory path, address to) payable public {
      uint256 bnbBalance = address(this).balance;

      require(bnbBalance >= msg.value, 'Insufficient BNB Balance!');
      require(path[0] == uniswapV2Router.WETH(), 'Invalid Path!');
