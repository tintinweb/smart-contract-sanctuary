...
contract GameBox is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x19e3f2DfE5F6668e96a7a88EdbD2c8bfD8F03603);
    address payable public devAddress = payable(0x2D47746532bc7cdde653Ac768b1242Ff45Ec4EAf);
    ...
    string private _name = "GameBox";
    string private _symbol = "GameBox";
    ...
    uint256 public numTokensSellToAddToLiquidity = 2500000 * 10**6 * 10**9;
...
//              IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function setMarketingDivisor(uint256 _marketingDivisor) public onlyOwner {
    ...
    function removeAllFeeOwner() public onlyOwner {
    ...
    function restoreAllFeeOwner() public onlyOwner {
