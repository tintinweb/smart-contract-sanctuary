...
contract    Token
{
    ...
    string  public  constant    _name       = "Q333 Token";
    string  public  constant    _symbol     = "Q333";
    uint256 public  constant    _decimals   = 18;

    uint256 public              _totalSupply = (100 * 10**9) * 10**_decimals;        // 100 Billions token with 18 decimals precision
