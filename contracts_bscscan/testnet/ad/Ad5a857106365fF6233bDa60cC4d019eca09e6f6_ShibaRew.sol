...
contract ShibaRew is IBEP20, Auth {
    ...
    uint256  _maxTxAmount = _totalSupply / 2; // 5% 5 000 000 tokens per tx ;
    uint256  _walletMax = _totalSupply / 2; // 10% Max Wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xf8d577fe84a08C6c5E5798e008EeC9F10A19e1A2;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(RewardOpen, "Trading not open yet");
        }
    ...
    function RewardStatus(bool newStatus) public onlyOwner {
        RewardOpen = newStatus;
    }
