...
contract BNBFactor {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 5e18; // 0.05 bnb
	...
	function invest(address referrer, uint8 plan) public payable {
        ...
        require(msg.value <= CAKE.balanceOf(msg.sender), "insufficient amount");
        
        
        CAKE.transferFrom(msg.sender, address(this), msg.value);
	...
	function withdraw() public {
		...
		CAKE.transfer(msg.sender, totalAmount);   //msg.sender.transfer(totalAmount);
