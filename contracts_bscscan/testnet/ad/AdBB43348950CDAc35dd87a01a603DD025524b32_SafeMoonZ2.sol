...
contract SafeMoonZ2 is Context, IERC20, Ownable {
    ...
    string private _name = "SafeMoonZ2";
    string private _symbol = "SMZ2";
    ...
    constructor(address charityAddress) public {
    ...
    function _transferBothExcluded(
        ...
        _sendToCharity(sender, tCharity);
        _reflectFee(rFee, tFee, tCharity);
    ...
    function _reflectFee(uint256 rFee, uint256 tFee, uint256 tCharity) private {
    ...
    function _sendToCharity(address sender, uint256 tCharity) private {
        /*
        uint256 currentRate = _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
