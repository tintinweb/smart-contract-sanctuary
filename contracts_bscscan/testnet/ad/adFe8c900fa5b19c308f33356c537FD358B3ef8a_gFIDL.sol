...
contract gFIDL is IgOHM, ERC20 {
    ...
    constructor(address _sFIDL)
        ERC20("Governance OHM", "gOHM", 18)
    {
        require(_sFIDL != address(0), "Zero address: sOHM");
        sFIDL = IsOHM(_sFIDL);
    }
     ...
     */
    function migrate(address _staking, address _migrator) external override {
