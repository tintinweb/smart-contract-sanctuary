...
contract MATTreasuryClaim is Ownable, ReentrancyGuard {
    ...
    uint256 public VESTING_DURATION = 600; //10 min for testing
    ...
    constructor(IBEP20 _mat, address _treasuryAddress) {
        MAT = IBEP20(_mat);
    ...
    function updateAddress(address _treasuryAddress) public onlyOwner {
        require(_treasuryAddress != address(0), "Address invalid");
        treasuryAddress = _treasuryAddress;
    }
    ...
    function claim() external nonReentrant {
        ...
        require(_msgSender() == treasuryAddress, "Address invalid");
