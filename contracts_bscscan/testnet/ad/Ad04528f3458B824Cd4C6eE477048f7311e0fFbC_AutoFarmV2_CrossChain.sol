...
contract AutoFarmV2_CrossChain is Ownable, ReentrancyGuard {
    ...
    event Add(uint256 _allocPoint, IERC20 _want, bool _withUpdate, address _strat);
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({want: _want, allocPoint: _allocPoint, lastRewardBlock: 0, accAUTOPerShare: 0, strat: _strat}));
