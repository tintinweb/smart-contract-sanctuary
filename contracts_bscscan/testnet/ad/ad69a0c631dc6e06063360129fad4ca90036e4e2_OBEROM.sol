...
Token Symbol: OBM
Token Decimals: 9
Token Total Supply: 1,000,000,000,000,000 (1 Quadrilion)
Owner Address: 0xf167c5a190fa0c12af3d6F0F5c14C772B3892a88
Business Plan Address: 0xE2D9811ABe09bC10418645aA35C12Da065A78f92

Fee of 10% for all transactions; this fee is redistributed automatically in each transaction as follows:
3% to Holders Earn
2% Liquidity Pool
1% Burn
4% Business Plan this in BNB
 */ 
contract OBEROM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "OBEROM";
    string private _symbol = "OBM";
    ...
    uint256 internal _tokenTotal = 1000000000000000e9;
    ...
    uint256 public BusinessPlanFee=400; //400 means 4% will send to BusinessPlan
    
    
    address BusinessPlanAddress=0xE2D9811ABe09bC10418645aA35C12Da065A78f92; //
    ...
    uint256 public minTokensBeforeSwap = 1_000_000_000e9;
    ...
    uint256 roundValue = value.ceil(BusinessPlanFee);
    uint256 onePercent = roundValue.mul(BusinessPlanFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        //Owner fee
        _reflectionBalance[BusinessPlanAddress] = _reflectionBalance[BusinessPlanAddress].add(tokensToBurn.mul(rate));
        ...
        emit Transfer(sender, BusinessPlanAddress, tokensToBurn);
    }
    ...
    function setBusinessPlanFee(uint256 amount) external onlyOwner {
        BusinessPlanFee= amount;
    }
