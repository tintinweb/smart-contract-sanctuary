...
contract ForFriend is ERC20, Ownable {
    ...
    uint256 public maxWallet = 15 * TOTAL_SUPPLY / 1000 * (DECIMALS);          // 2.0%  of total supply, 20  B tokens  
    ...
    function modifyTaxPortions(uint256 _marketingPortion, uint256 _liquidityPortion, uint256 _buybackPortion, uint256 _rewardPortion) public onlyOwner{
        ...
        buybackPortion = _buybackPortion; 
        rewardPortion = _rewardPortion; 
        totalFees = _liquidityPortion + _marketingPortion + _buybackPortion;        
    ...
    function shouldSwap(address to) private view returns (bool){
        ...
        isPair[to] && tradingIsEnabled && !antiBotActive;
    }    
    ...
    function doMarketingPush(uint256 _minutes, uint256 _marketingFeeIncrease, uint256 _marketingPortionIncrease) external onlyAuthorized{
        ...
        require(_marketingFeeIncrease <= 10, "Only an additional tax of 15% allocated to marketing is permitted.");
