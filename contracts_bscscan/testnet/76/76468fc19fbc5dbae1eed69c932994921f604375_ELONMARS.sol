...
/**
   ...
   3% distribute to a holders wallet 
   3% Distribute to Marketing wallet
   ttl supply = 100000000000000
   decimals 9
*/
...
contract ELONMARS is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x390fA3b63dF7a6Af261968a313Ff7Ca2EE79c453;
    ...
    uint256 public maxWalletToken = 1000000000 * (10**9);
    uint256 public maxBuyTranscationAmount = 1000000000 * (10**9);
    ...
    function setMaxBuyTransaction(uint256 _maxTxn) external onlyOwner {
  	    maxBuyTranscationAmount = _maxTxn;
  	}
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        require(automatedMarketMakerPairs[pair] != value, "HotCake: Automated market maker pair is already set to that value");
       ...
       if (
        ...
        if (
            ...
            require(
                ...
                "Transfer amount exceeds the maxBuyTransactionAmount."
            );
