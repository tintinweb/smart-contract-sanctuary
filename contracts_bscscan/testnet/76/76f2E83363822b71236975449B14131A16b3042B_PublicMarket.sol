...
contract PublicMarket is Ownable, Lockable {
    ...
    notWithdrawBlacklist(msg.sender)
    {
        ...
        require( _amount <= senderInfo[msg.sender], "user have not enough pToken to withdraw");
    ...
    function applyable(address _usr) public view returns (uint256, bool) {
        ...
        ok = ok && publiclist.isOnPubliclist(_usr) && withdrawable();
