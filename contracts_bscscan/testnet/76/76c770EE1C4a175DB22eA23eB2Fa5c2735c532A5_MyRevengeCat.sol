...
contract MyRevengeCat is Ownable, ReentrancyGuard {
    ...
    bool _birthed;
    uint256 public constant interactPrice = 0.02 ether;
    ...
    function revive() public onlyOwner {
    ...
    function testState() public { //Just for testing
            boredom = 30;
            hunger = 50;
            sleepiness = 35;
            uncleanliness = 25;
...
contract Love is ERC20("LoveToken", "LOVE"), Ownable { //This contract is pretty simple. The owner can mint. We will transfer the owner to be the pet.
