...
contract GymFarming is Ownable, ReentrancyGuard {
    ...
    uint256 rewardPerBlockChangesCount =  35;
    ...
    function setRewardPerBlock() external onlyOwner {
        massUpdatePools();
        if(block.number - lastChangeBlock > 200 && rewardPerBlockChangesCount > 0){
            rewardPerBlock = rewardPerBlock * 972222222200 * 1e12 / 1e12 ;
