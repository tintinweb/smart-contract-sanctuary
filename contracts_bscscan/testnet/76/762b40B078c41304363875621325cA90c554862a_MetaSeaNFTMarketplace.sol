...
contract MetaSeaNFTMarketplace is AccessControlEnumerable {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    constructor(
        ...
        require(
            ...
            "MetaSeaNFTMarketplace: nftAddress_ is zero address"
        );
        require(
            feeRecipient_ != address(0),
            "MetaSeaNFTMarketplace: feeRecipient_ is zero address"
        );
    ...
    modifier onlySupportedPaymentToken(address paymentToken_) {
        require(
            ...
            "MetaSeaNFTMarketplace: unsupport payment token"
        );
        _;
    }
    ...
    modifier onlyOnSaleOrder(uint256 orderId_) {
        require(
            ...
            "MetaSeaNFTMarketplace: order is not on sale"
        );
        _;
    }
    ...
    modifier canMatch(
        ...
        require(
            ...
            "MetaSeaNFTMarketplace: buyer must be different from seller"
        );
        require(
            price_ == orders[orderId_].price,
            "MetaSeaNFTMarketplace: price has been changed"
        );
        _;
    }
    ...
    function _updateFeeRate(uint256 feeDecimal_, uint256 feeRate_) internal {
        require(
            ...
            "MetaSeaNFTMarketplace: bad fee rate"
        );
        ...
        onlyRole(MAINTAINER_ROLE)
    {
        ...
        require(
            ...
            "MetaSeaNFTMarketplace: already supported"
        );
    }
    ...
    function addOrder(
        ...
        require(
            ...
            "MetaSeaNFTMarketplace: sender is not owner of token"
        );
        require(
            nftCore.getApproved(tokenId_) == address(this) ||
                nftCore.isApprovedForAll(_msgSender(), address(this)),
            "MetaSeaNFTMarketplace: The contract is unauthorized to manage this token"
        );
        require(
            price_ > 0,
            "MetaSeaNFTMarketplace: price must be greater than 0"
        );
