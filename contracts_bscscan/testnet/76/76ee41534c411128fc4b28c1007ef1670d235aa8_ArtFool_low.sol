...
contract ArtFool_low is IBEP20, Ownable
{
    ...
    uint256 public HardCap=0.25*10**18;
    uint256 public BNBInLiquidity=0.15*10**18;
    uint256 public MinContribution=10**14;
    uint256 public MaxContribution=2*10**17;
