...
contract MATAToken is ERC20, Ownable {
    ...
    function claimMATA(
        ...
        require(_nonce <= _now && _now <= _nonce + 1 minutes, "Claim request expired"); // TODO
        require(_now >= lastClaims[_user] + 2 minutes, "The gap between 2 claims is 2 minutes"); // TODO
