...
contract TESTCODE is Context, IERC20, Ownable {
    ...
    string private _name = "TESTCODE2";
    string private _symbol = "TSC2";
    ...
    uint256 public _maxTxAmount = 10000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
