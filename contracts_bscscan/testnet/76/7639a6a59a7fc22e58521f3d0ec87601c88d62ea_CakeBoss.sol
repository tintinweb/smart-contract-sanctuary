...
contract CakeBoss is ERC20, Ownable {
    ...
    //TODO CHANGE TO MARKETING
    address public _marketingWalletAddress = address(0x03753A014147a2496E0C9CFa8e9ac7e3De5D7fDb); // marketing wallet
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amount) external onlyOwner() {
        ...
        require(airdropWallets.length < 40, "CUPCAKE: airdropToWallets:: Cannot airdrop more than 40 wallets due to gas limit restrictions");
...
contract CakeBossDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
