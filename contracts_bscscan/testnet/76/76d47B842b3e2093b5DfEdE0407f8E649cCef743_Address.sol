...
// 
// Test token (TESTT) clone of RainbowToken.  7 protocols plus WhaleTax and double sales tax.
// 
// 1%: Burn
// 1%: Buyback
// 1%: Reflected
...
/**
 * @dev The official TestToken (TESTT) smart contract
 */
contract TestToken is Context, IERC20, Ownable {
    ...
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for TESTT/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xB22cbc83a0cf642713fcF940Ec59b6E53b5c1DdA); // Marketing address used to pay for marketing
    ...
    // Anti-Whale Settings 
    uint256 public _whaleSellThreshold = 100 * 10**6 * 10**9; // 100 million
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion TESTT will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-TESTT tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts TESTT balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns TESTT tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of TESTT tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from TESTT)
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        // Generate the Pancakeswap pair for TESTT/WBNB
