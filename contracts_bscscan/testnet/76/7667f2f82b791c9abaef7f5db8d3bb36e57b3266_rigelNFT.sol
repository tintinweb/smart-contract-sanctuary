...
contract rigelNFT is ERC1155, Ownable {
    ...
    // uint256 public constant SHIELD = 4; // "https://game.example/api/item/{id}.json"
    ...
    function mint(address _to, uint256 _tokenId, uint _price, string memory uri_) public onlyOwner returns (bool) {
        price[_tokenId] = _price;
        _mint(_to,_tokenId, _price, " ");
        _setURI(uri_);
  ...
  function buy(uint _id) external payable {
    ...
    _trade(_id, msg.value); //swap nft for eth
