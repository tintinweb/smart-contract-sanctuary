...
contract Trade4meBot is BEP20 {
    ...
    string public constant name = "Trade4me Bot";
    string public constant symbol = "TRBOT";
    uint public constant decimals = 18;
    uint public deadline = now + 30 * 1 days;
    uint public round2 = now + 15 * 1 days;
    uint public round1 = now + 8 * 1 days;
    
    uint256 public totalSupply = 75000e18;
    uint256 public totalDistributed;
    uint256 public constant requestMinimum = 1 ether / 20; // 0.05 BSC(BNB)
    uint256 public tokensPerBsc = 15e18;
