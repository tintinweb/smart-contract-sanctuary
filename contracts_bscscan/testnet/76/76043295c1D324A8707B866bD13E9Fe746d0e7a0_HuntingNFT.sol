    ...
    OwnableUpgradeable
{
        ...
        returns (bool)
    {
        ...
        require(wolfPackLife[_wolfPackId] >= initialLife, "You cannot a wolf to this wolfpack, life is less than initial");
    ...
    function destroyWolfPack(uint256 _wolfPackId) external returns (bool) {
        ...
        uint256 initialLife = calculateInitialWolfPackLife(_wolfPackId);
        require(wolfPackLife[_wolfPackId] >= initialLife, "You cannot destroy this wolfpack, life is less than initial");
    ...
    OwnableUpgradeable
{
    ...
    function burnMultipleMaterials(uint256[] memory _materialsId) public returns (bool) {
