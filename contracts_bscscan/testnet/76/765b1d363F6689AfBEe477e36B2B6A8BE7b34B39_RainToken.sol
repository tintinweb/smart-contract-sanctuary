...
contract RainToken is Context, IERC20, Ownable {
    ...
    string private _name = "Rain Token";
    string private _symbol = "Rain";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1; // 5% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 10; // 1% added to liquidity 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _burnFee = 1; // 5% burn fee
