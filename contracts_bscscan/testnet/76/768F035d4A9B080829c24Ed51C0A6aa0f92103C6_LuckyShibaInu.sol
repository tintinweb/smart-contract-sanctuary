...
contract LuckyShibaInu is Context, IERC20, Ownable {
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x7e5E42ad14096F81d1Dd3B79B585a680E3175695); // Marketing address used to pay for marketing
    ...
    // Token Tax Settings
    uint256 public  _taxFee           = 9;  // 7% tax 
    uint256 public  _sellTaxFee       = 16; // 14% tax 
    uint256 public  _whaleSellTaxFee  = 23; // 21% tax 
    ...
    uint256 private _totalLotteryAllocated     = 0;  // Total Lottery Allocated
    ...
    function getTotalLotteryWon() public view returns (uint256) {
        return tokenFromReflection(_totalLotteryAllocated.sub(_lotteryPool));
    }
    
    function getLotteryPortionMultiply() external view returns (uint256) {
        return _lotteryPortionMultiply;
    }
    ...
    function _takeTokens(uint256 tTakeAmount, uint256 tLottery) private {
        ...
        _totalLotteryAllocated = _totalLotteryAllocated.add(rLottery);
    }
