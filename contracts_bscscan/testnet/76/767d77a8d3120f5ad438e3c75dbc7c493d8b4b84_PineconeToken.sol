...
contract PineconeToken is Context, IERC20, MinterRole {
    ...
    mapping(address => bool) private _presaleUsers;
    ...
    {
        require(msg.sender == _presaleAddress, "!presale contract");
        _;
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (_presaleUsers[from] || _presaleUsers[to]) {
