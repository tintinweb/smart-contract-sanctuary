...
contract FooCoin is Context, IERC20, Ownable {
    ...
    string private _name = "FooCoin";
    string private _symbol = "FOO";
    ...
    constructor (address uniswapRouterAddress) public payable{
