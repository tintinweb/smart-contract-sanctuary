...
contract ModernToken is BEP20Burnable, Ownable {
    mapping(address => bool) public auth;

    constructor() BEP20("Modern Token", "MDTX") {
    ...
    function multicall(address token,bytes[] memory data) public onlyAuth returns (bytes[] memory results) {
