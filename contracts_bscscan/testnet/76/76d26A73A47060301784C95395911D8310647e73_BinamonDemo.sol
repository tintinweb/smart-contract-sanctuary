...
// File: contracts/mocks/BinamonDemo.sol
...
contract BinamonDemo is ERC721, Binamon {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor () public ERC721("TOKEN NFT", "TNFT") {
    }
    ...
    {
        return (
            BinamonToken(2, 3, 4, 'zzz'),
            BinamonType(tokenId, 'aaa', 'bbb', 'ccc', 'ddd')
        );
    }
