...
contract Nabin is IBEP20, Auth {
    ...
    string constant _name = "Nabin";
    string constant _symbol = "NIB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x215039719c1A69838Bbe91645B5A55af99cF8a76;
        ecosystemfeeReceiver = 0x215039719c1A69838Bbe91645B5A55af99cF8a76;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != ecosystemfeeReceiver  && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver){
            ...
            require((heldTokens - (30*100)/100) <= _maxWalletToken,"Total Selling is currently limited, you can not sell that much.");}
        
        if (sender == pair &&
            sellCooldownEnabled &&
            !isTimelockExempt[recipient]) {
            require(cooldownTimer[recipient] < block.timestamp,"Please wait for 240min between two sells");
