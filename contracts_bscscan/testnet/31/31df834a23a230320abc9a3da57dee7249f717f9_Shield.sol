...
contract Shield is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0x32149A908D09117BDe5A280b86D874FC4920A963;
    ...
    constructor () public {
        ...
        _isExcludedFromMaxTx[address(0x0000000000000000000000000000000000000000)] = true;
    ...
    uint256 public _liquidityFee = 14; // 6% will be added pool, 8% will be converted to BNB for a reward
