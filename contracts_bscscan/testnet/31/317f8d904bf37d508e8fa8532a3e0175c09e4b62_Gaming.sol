...
contract Gaming is BEP20 {
    ...
    */
    ...
    function buy(uint256 amount) public payable{
        require(amount >= gameSettings.minimumBNBAmount,"Less than min amount");
        require(msg.value  == amount, "Invaild BNB amount");
        ...
        bool isEligible = buyer != address(uniswapV2Router) &&
               amount >= gameSettings.minimumBNBAmount;
