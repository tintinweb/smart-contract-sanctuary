...
contract Presale is Ownable, ReentrancyGuard {
    ...
    function buyTokens() public payable nonReentrant returns (bool) {
        ...
        uint256 tokenAmount = msg.value * tokensPerBnb;

        bool result = token.transfer(_msgSender(), tokenAmount);
