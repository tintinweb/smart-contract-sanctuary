...
address feeAddress;
address mgr;
uint256 waitingForBetsTime = 1 minutes; // CHANGE TO 5
uint256 predictionIntervalTime = 1 minutes; // CHANGE TO 15
...
function GetAll(uint i) public view returns(uint256, uint256, uint256, uint256){
    uint256 upBets;
    uint256 upAmount;
    uint256 downBets;
    uint256 downAmount;
