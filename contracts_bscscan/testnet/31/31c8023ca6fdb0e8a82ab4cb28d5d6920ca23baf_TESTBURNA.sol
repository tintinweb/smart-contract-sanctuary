...
contract TESTBURNA is Context, IERC20, Ownable {
    ...
    string private _name = "TESTBURNA";
    ...
    address public MarketingWallet = 0xad761ddC60f206F203516838eb3B4baeED6dDBe3;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6EF53411545BeC56998AeE35F39406472ec2FeD0);  // PCS V2
    ...
    function setMiniGameMarketingWallet(address newWallet) external onlyOwner() {
