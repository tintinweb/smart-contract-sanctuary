...
// File: CacaLendMarket/Minter.sol
...
contract Minter is Ownable {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "TomCat: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "TomCat: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "TomCat: index out of bounds");
...
// File: CacaLendMarket/MetamonR.sol
...
contract MetamonN is ERC721Enumerable {

    //uint256 public tokenId = 0;

    string public baseURI = "https://racawebsource.s3.us-east-2.amazonaws.com/metamon/metadata/normal/metamon_";
    constructor() ERC721("RadioCaca Metamon", "MetamonN") {
