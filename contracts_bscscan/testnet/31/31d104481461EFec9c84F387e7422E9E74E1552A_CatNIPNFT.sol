...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    function MintCatNIPNFT(string memory tokenURIstring, uint256 costOfNFT, uint256 codeForCatMechanism, uint256 codeForStats, string memory codeKEK, uint256 codeANow, string memory codeBNow, uint256 codeCNow) public returns (uint256) {
        ...
        address codeContractAddress = ICatNIPCode(catNIPCodeAddress).JJJADJFKLSDNLKfdDASGASUJKLSDJFLAK(); 

        uint256 currentCode = ICatNIPCode(codeContractAddress).ADJFKaaDLSDNLKDASGAUJKLSDJFLAK(codeBNow, codeANow, GetCurrentBlockTime().add(2));
    ...
    function SetCatNIPNFTMetaData(uint256 itemId, string memory newTokenURIstring, uint256 costOfChange, uint256 codeForCatMechanism, uint256 codeForStats, string memory codeKEK,  uint256 codeANow, string memory codeBNow, uint256 codeCNow) external {
