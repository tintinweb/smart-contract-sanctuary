...
interface IDividendDistributor {
    ...
    function getDividendInfo(address shareholder) external view returns(uint256, uint256, uint256);
}
...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendInfo(address shareholder) public view returns (uint256, uint256, uint256) {
        ...
        return (shareholderShare, shareholderTotalDividends, unpaidDividend);
    }    
...
//        emit Transfer(sender, recipient, amount);
    ...
    function getDividendInfo(address shareholder) public view returns (uint256 shareholderShares, uint256 shareholderDividend, uint256 shareholderUnpaidDividend) {
        return distributor.getDividendInfo(shareholder); 
    }   
