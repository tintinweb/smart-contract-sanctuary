...
contract SANTAWAR is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        gamewallet = 0x0212F50cE54302bAc31390544D14D6B3875bB68e;

        _balances[msg.sender] = 7 * 10 ** 8 * (10 ** _decimals);
        _balances[gamewallet] = 3 * 10 ** 8 * (10 ** _decimals);
        emit Transfer(address(0), msg.sender, _totalSupply);
        emit Transfer(address(0), gamewallet, _totalSupply);
    }
