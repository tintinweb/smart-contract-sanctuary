...
/**
   ...
   #Treetest features:
   6% fee auto add to the liquidity pool to locked forever
...
contract Treetest is Context, IERC20, Ownable {
    ...
    string private _name = "Treetest";      
    string private _symbol = "Treetest";    
