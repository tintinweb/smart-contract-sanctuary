...
contract MadDogeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBd6DDEc16a95A77a3D65cB8EF2BFDa7Be5aa9F11); // Marketing Address
    ...
    string private _name = "MadDogeToken";
