...
contract LuckyBonnieLotteryBNB is AccessControl, Ownable, ReentrancyGuard  {
    ...
    function startRound(uint256 _endTime) external onlyRole(BONNIE_ROLE)  {
        ...
        _rounds[currentRoundId] = Round({
            ...
            endTime: _endTime,
            priceTicket: pricePerTicket,
            rewardMatchRate: rewardMatchRate,
            rewardsPerMatching: [uint256(0), uint256(0), uint256(0), uint256(0), uint256(0), uint256(0)],
            countWinnersPerMatching: [uint256(0), uint256(0), uint256(0), uint256(0), uint256(0), uint256(0)],
            totalAmount: _injectFromPreviousRound,
            houseRate: houseRate,
            roundRate: roundRate,
            discountRate: _discountRate,
            ticketInit: currentTicket,
            ticketInitNextRound: 0,
            finalNumber: 0,
            random: "",
            signature: ""
        });
