...
contract CoinSeven is Context , IERC20, Ownable {
    ...
    string private _name = "CoinSeven";
    string private _symbol = "CSV";
    ...
    address private devWallet = devWallet;
    ...
    uint256 public _maxTxAmount = 1 * 10**14 * 10**9; //100% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2500 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 3 * 10**12 * 10**9; //3% of total supply
