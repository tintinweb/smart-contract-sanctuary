...
contract AAA_FLATIE is Context, IERC20, Ownable {
    ...
    address payable private _wallet_charity = payable(0xeFa74Fa9d00d8A7a2f652696BAa9433093d257b3);

    // for burn
    uint256 public _fee_burn = 100;
    uint256 private _fee_burn_old = _fee_burn;
    address payable private _wallet_burn = payable(0xeFa74Fa9d00d8A7a2f652696BAa9433093d257b3);

    // for team
    uint256 public _fee_team = 200;
    uint256 private _fee_team_old = _fee_team;
    address payable private _wallet_team = payable(0x496953Fa4A577bC77670b245ba6bed6DB725ee26);

    // Dev wallet
    address payable private _wallet_dev = payable(0x496953Fa4A577bC77670b245ba6bed6DB725ee26);
