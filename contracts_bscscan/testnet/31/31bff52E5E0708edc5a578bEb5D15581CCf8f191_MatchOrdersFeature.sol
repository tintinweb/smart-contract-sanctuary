    ...
    NativeOrdersInfo
{
    ...
    //     uint8[] calldata sellType,
    //     uint8[] calldata buyType
    // )
    //     external
    //     onlyOwner
    //     override
    ...
    //         sellOrder.length == sellSignature.length &&
    //         sellOrder.length == buySignature.length &&
    //         sellOrder.length == price.length &&
    //         sellOrder.length == sellType.length &&
    //         sellOrder.length == buyType.length,
    //         'MatchOrderFeature::batchMatchOrders/MISMATCHED_ARRAY_LENGTHS'
    //     );

    //     // for (uint256 i = 0; i < sellOrder.length; i++) {
    //     //     matchedFillResults[i] = _matchOrders(
    //     //         sellOrder[i],
    //     //         buyOrder[i],
    //     //         sellSignature[i],
    //     //         buySignature[i],
