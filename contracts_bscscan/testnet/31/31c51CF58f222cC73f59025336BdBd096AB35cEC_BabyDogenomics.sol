...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // 
...
contract BabyDogenomics is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; // Doge Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyDogenomics";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "BDGN";
    ...
    uint256 liquidityFee    = 33; //fees. change them to whatever you like. make sure to adjust the totalFee in line 456 to equal total sum of the values in 453,454 and 455.
    uint256 reflectionFee   = 33;
    uint256 marketingFee    = 33;
