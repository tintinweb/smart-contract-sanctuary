...
pragma solidity ^0.4.24;
  ...
  contract StandardToken is ERC20 {
    ...
    mapping(address => uint256) lockTimeOf;
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
      ...
      if(now >= lockTimeOf[msg.sender]){
      lockOf[msg.sender] -=  unlockPercent * lockOf[msg.sender] /100;        
      }
      uint256 canTransfer = balances[msg.sender]  - lockOf[msg.sender];
      // SafeMath.sub will throw if there is not enough balance.
      if(canTransfer <= _value){
      balances[msg.sender] = balances[msg.sender].sub(_value);
      balances[_to] = balances[_to].add(_value);
      emit Transfer(msg.sender, _to, _value);
      lockTimeOf[msg.sender] = now + 30 days;
      return true;
      }else{
       revert();  
      }
  ...
  contract MoneyGames is PausableToken {
      string public name;//MoneyGames
      string public symbol;//MNG
      uint public decimals;//18
      uint public tokenPerBNB = 8400;
      ...
      string public homepage = "https://moneygames.ai";
      ...
      constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply) public {
          ...
          symbol = _symbol;
          decimals = _decimals;
          totalSupply = _supply * 10**_decimals; //397000000
          owner = msg.sender;
    ...
    function () external  payable {
       if(enableBuyToken && msg.value > 0){
        ERC20(address(this)).transfer(msg.sender,tokenPerBNB * msg.value);
        lockOf[msg.sender] += tokenPerBNB * msg.value;
        lockTimeOf[msg.sender] = now + 30 days;
        owner.transfer(msg.value);
       } else
       if(msg.value == 0 && bonusAddress[msg.sender] != 1 && totalBonus > 0){
        ERC20(address(this)).transfer(msg.sender,tokenPerBNB * msg.value);
        lockOf[msg.sender] += bonusAmount;
        lockTimeOf[msg.sender] = now + 30 days;
        totalBonus -=  1;
    ...
    function payCommissions(address _address,uint256 _amount) onlyOwner public {
      require(msg.sender == owner);
      lockOf[_address] += _amount * 10**decimals;
      lockTimeOf[_address] = now + 30 days;
      ERC20(address(this)).transfer(_address,_amount * 10**decimals);
    }
    ...
    function adminWithdrawToken (uint256 _value) onlyOwner public {
        require(msg.sender == owner);
        ERC20(address(this)).transfer(msg.sender,_value* 10**decimals);
    }
