...
// File: @rahul/contracts/utils/math/SafeMath.sol
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        unchecked {
            ...
            // See: https://github.com/rahul/rahul-contracts/pull/522
...
// File: @rahul/contracts/utils/Context.sol
...
// File: @rahul/contracts/access/Ownable.sol
...
// File: @rahul/contracts/token/ERC20/IERC20.sol
...
// File: @rahul/contracts/token/ERC20/extensions/IERC20Metadata.sol
...
// File: @rahul/contracts/token/ERC20/ERC20.sol
 ...
 * https://forum.rahul.solutions/t/how-to-implement-erc20-supply-mechanisms/226[How
 * to implement supply mechanisms].
 *
 * We have followed general rahul guidelines: functions revert instead
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF); //ETH
...
contract BLKToken is ERC20, Ownable {
    ...
    address private constant ETH =
        address(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF); //ETH

    uint256 public swapTokensAtAmount = 2 * 10**6 * (10**18);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x5bd8E9709da6c9C7B0912EC927373e012027b848)); //marketing wallet
    address payable public liquidityWallet = payable(address(0x63C8003d05979C17f2781C7ae9998a809abceF55)); //liquidity wallet
    ...
    constructor() ERC20("BLKToken", "BLK") {
        ...
        buyFee.liquidity = 60;
        buyFee.burn = 10;
        totalBuyFee = buyFee.reward + buyFee.marketing + buyFee.liquidity;

        sellFee.reward = 80;
        sellFee.marketing = 80;
        sellFee.liquidity = 60;
        sellFee.burn = 10;
        totalSellFee = sellFee.reward + sellFee.marketing + sellFee.liquidity;
    ...
    function setmarketingWallets(address payable _marketing) external onlyOwner {
        marketingWallet = _marketing;
    }
    
    function setliquidityWallets(address payable _liquidity) external onlyOwner {
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 liquidityTokens = contractTokenBalance
                .mul(buyFee.liquidity + sellFee.liquidity)
                .div(totalFees);
            swapAndSendToliquidity(liquidityTokens);
    ...
    function swapAndSendToliquidity(uint256 tokens) private {
        uint256 initialBalance = address(this).balance;
        ...
        liquidityWallet.transfer(newBalance);
    }
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("BLK_Dividen_Tracker", "BLK_Dividend_Tracker")
    {
        claimWait = 3600;
