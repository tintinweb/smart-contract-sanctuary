...
// File: contracts/trading/OneBitTradingPoolShare.sol
...
// Onebit Venture with Governance.
contract OneBitTradingPoolShare is Context, ERC20("OneBit Trading Pool Share", "OBTPS"), Ownable, Authorizable {
    ...
    uint256 public manualMintLimit = 3000000e18;
    uint256 public manualMinted = 0;
    uint256 private _cap = 3000000e18;
    ...
    constructor(uint256 _lockFromBlock, uint256 _lockToBlock) public {
        ...
        emit Transfer(address(0), _msgSender(), _cap);
    }
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "OBT::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "OBT::delegateBySig: invalid nonce");
        require(now <= expiry, "OBT::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "OBT::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "OBT::_writeCheckpoint: block number exceeds 32 bits");
