...
contract WraithDust is BEP20Capped {
    uint8 public constant DECIMALS = 18;
    uint256 public constant MAXIMUM_SUPPLY = 1000000 * (10**uint256(DECIMALS));
    uint256 public constant INITIAL_SUPPLY = 100000 * (10**uint256(DECIMALS));

    constructor() BEP20("Wraith Dust", "WUST") BEP20Capped(MAXIMUM_SUPPLY) {
        BEP20._mint(msg.sender, INITIAL_SUPPLY);
    }
