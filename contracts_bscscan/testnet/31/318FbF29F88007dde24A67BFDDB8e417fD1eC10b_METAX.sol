...
/*
   ...
   #METAX - MetaxPad - Welcome to the future of launchpad:
   3.5% fee is taken to fund for the development of METAXPAD APP
   3.5% fee is held in trust, and will be used for long term stability
...
contract METAX is Context, IERC20, Ownable {
    ...
    address public _appWallet;
    address public _stabilityWallet;
    ...
    constructor () {
        ...
        _appWallet = msg.sender;
        _stabilityWallet = msg.sender;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(_appWallet).transfer(newBalance);
        ...
        _rOwned[_stabilityWallet] = _rOwned[_stabilityWallet].add(rTransferAmount);
        emit Transfer(address(this), _stabilityWallet, tTransferAmount);
        restoreAllFee();
    ...
    function setappWallet(address _address) public onlyOwner() {
        _appWallet = _address;
    }

    function setstabilityWallet(address _address) public onlyOwner() {
        _stabilityWallet = _address;
    }
