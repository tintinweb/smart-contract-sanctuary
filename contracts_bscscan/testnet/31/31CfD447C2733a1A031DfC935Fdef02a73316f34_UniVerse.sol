...
contract UniVerse is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable, RewardSystem {
    ...
    function mint(address _to) public onlyWhitedListMemeber {
        ...
        UniverseToken.transferFrom(msg.sender, address(this), 500);
       // _mintAnElement(_to);
    }
    
    function getUniverseToken() public view returns(uint256){ return UniverseToken.totalSupply(); }
    ...
    function upgradToken(uint256 _id) public onlyOwner {  //TODO: update furture;
        require(tokenRate[_id] <= 8, "maximum upgrade");
        _burn(_id);
        _mint(ownerOf(_id), _id.add(MAX_ELEMENTS));
    }

    function distribute(uint256 _amount) public isEnableDistribute {
    ...
    function rewardWithdraw() public returns (bool) {
