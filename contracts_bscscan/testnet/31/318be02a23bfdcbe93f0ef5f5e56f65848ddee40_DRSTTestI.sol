...
contract DRSTTestI is ERC20, Ownable, Charitable, Marketable {
    ...
    constructor() public ERC20("DRSTTestI", "DRSTTestI") {
    ...
    function _transfer(
        ...
        address addrCharityWallet = charityWalletAddress();
        address addrMarketingWallet = marketingWalletAddress();
        ...
        if(
            ...
            to != liquidityWallet &&
            from != addrCharityWallet &&
            to != addrCharityWallet &&
            from != addrMarketingWallet &&
            to != addrMarketingWallet
        ) {
            swapping = true;
            ...
            super._transfer(from, addrCharityWallet, charityTokens);
            //sendToCharityWallet(from, charityTokens);

            uint256 marketingTokens = contractTokenBalance.mul(marketingFee).div(totalFees);
            super._transfer(from, addrMarketingWallet, marketingTokens);
            //sendToMarketingWallet(from, marketingTokens);
