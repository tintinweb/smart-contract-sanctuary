...
/**
     TOEM  é um token digital uma criptomoeda de reserva financeira criado no blockchain o objetivo é "simplificar o mais possível as transações financeiras de compra e venda de Ouro, Joias e Pedras Preciosas tais como Esmeralda, Diamante, entre outros e Prata entre outros para todas as pessoas do mundo, onde quer que vivam, tenham ou não uma conta bancária podendo investir incialmente pouco e já participar desse mercado exclusivo além de adquirir peças e artigos de luxo.
                                                                                                                                                                                       História
...
A escolha do nome Token Emerald sigla “TOEM” foi porque sabemos que a Esmeralda é um símbolo de Riqueza de força e sua vibração e energia atrai mais riquezas fora que ela é usada em tratamentos terapêuticos, limpeza e energização de ambiente, proteção contra energias negativas, fortalecimento do poder pessoal e ajuda a aumentar o seu brilho pessoal transmitindo mais luz pessoal quando usada como joia.
                                                                                                                                                                                   Características
A TOEM esta lastreada por uma canga de esmeralda extraído em Carnaíba/Pindobaçu – BA  - BRASIL e pesa 50KG e mede 41 centímetro, esse lastro vai ajudar ao ativo não sofrer tanta oscilação e no passar dos anos o Lastro valoriza e com isso a TOEM automaticamente valoriza junto além da valorização de mercado do próprio ativo.
Entenda mais sobre lastro. 
A TOEM Propõe resolver os seguintes problemas:
...
contract TOKENEMERALD is IBEP20, Auth {
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Contrato WBNB
    address DEAD = 0xCef879b7C8B9f75E7ab00b234dd1AEb427C29373; // Endereço de queima
    address ZERO = 0xCef879b7C8B9f75E7ab00b234dd1AEb427C29373; // Endereço de queima
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // substitua pelo router desejado
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;

        distributor = new DividendDistributor(address(router));
        
        address _presaler = 0xCef879b7C8B9f75E7ab00b234dd1AEb427C29373; // carteira de pré venda (coloque uma sua mesmo se não tiver pré venda)
