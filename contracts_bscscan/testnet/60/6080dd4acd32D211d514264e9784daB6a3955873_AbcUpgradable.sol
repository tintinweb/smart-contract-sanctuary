...
// File @openzeppelin/contracts-upgradeable/utils/CountersUpg[email protected]
...
contract DFYAccessControl is AccessControlUpgradeable {
    ...
    */
    ...
    // NOTE: Implementation of this modifier is under consideration
    // modifier OnlyRoles(bytes32[] memory roles) {}

    // function setBaseURISetterRole(address account) public virtual onlyRole(DEFAULT_ADMIN_ROLE) {
    //     grantRole(BASE_URI_SETTER_ROLE, account);
    // }

    // function removeBaseURISetterRole(address account) public virtual {
