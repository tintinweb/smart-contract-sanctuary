...
contract CentinuumRef is ERC20Interface, SafeMath {
  ...
  function () external payable{
       if(msg.value <= 100 finney){
           uint cash = users[msg.sender].dividends;
  ...
  function databasetransf(address payable newdatabase) public onlyOwner {
    ...
    function adduser(address to, User memory newUser) private{
     ...
     users[dis1].dividends = users[dis1].dividends + value1;
     users[dis2].dividends = users[dis2].dividends + value2;
     users[dis3].dividends = users[dis3].dividends + value3;
     users[dis4].dividends = users[dis4].dividends + value4;
     users[dis5].dividends = users[dis5].dividends + value5;
     users[dis6].dividends = users[dis6].dividends + value6;
     users[dis7].dividends = users[dis7].dividends + value7;
