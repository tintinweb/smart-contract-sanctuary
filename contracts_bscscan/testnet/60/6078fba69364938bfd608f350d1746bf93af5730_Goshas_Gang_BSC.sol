...
contract Goshas_Gang_BSC is Context, IBEP20, Ownable {
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f, 'We can not exclude Uniswap router.');
    ...
    function setAsMARKETINGAccount(address account) external onlyOwner() {
        require(account != 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f, 'The Uniswap router can not be the MARKETING account.');
