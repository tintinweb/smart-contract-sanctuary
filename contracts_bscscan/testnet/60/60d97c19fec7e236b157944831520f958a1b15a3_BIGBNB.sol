...
contract BIGBNB is ERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    ...
    function setSellFee(uint256 _sellBnbRewardFee, uint256 _SellLiquidityFee, uint256 _SellMarketingFee, uint256 _SellBuybackFee) 
    public onlyOwner 
    {
    ...
    constructor() ERC20("BIGBNB", "BIGBNB") 
    {
        ...
        marketingWallet = payable(0x20AdE41EFda15f0A9dEB04023B6e412771E15240);
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 dividends = deltaBalance.mul(sellBNBRewardsFee).div(sellTotalFees);
    ...
    function SetBuyBackUpperLimitAmount(uint256 _newLimit, uint256 _decimal) public {
        buyBackUpperLimit = _newLimit * (10**_decimal);
    }
