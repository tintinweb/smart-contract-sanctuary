...
abstract contract Manageable is Context {
        ...
        onlyManager
    {
        require(
            ...
            "New Manager address should not be zero"
        );
...
abstract contract Tokenomics {
    ...
    function _addFees() private {
        ...
        _addFee(
            FeeType.MarketingAndOperating,
            100,
            marketingAndOperatingWallet
        );
    ...
    function _takeSellersTax(
        ...
        if (sumOfFees > 0 && !isInPresale) {
            ...
            if (sellerBalance < 8000 * ZEROES) {
                ...
                sellerBalance >= 15000 * ZEROES &&
                sellerBalance < 20000 * ZEROES
            ) {
                sellerTaxRate = 20;
            } else {
                sellerTaxRate = 0;
            ...
            uint256 tAmount = amount.sub(
                amount.mul(sellerTaxRate).div(FEES_DIVISOR)
            );
