...
contract PartyGirls is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyAmount = 3000000000 * 10**9;
    uint256 public maxSellAmount = 3000000000 * 10**9; 
    uint256 public maxWalletAmount = 3000000000 * 10**9;
    ...
    address public  _marketingWallet = payable(address(0xca9023B5A7f3b18B57e4A9C15Ab2C2a59BB2C9c3)); //change youyr marketing wallet
    address public _buybackWallet = payable(address(0xca9023B5A7f3b18B57e4A9C15Ab2C2a59BB2C9c3)); //change your buyback
    ...
    constructor() ERC20("Party Girls", "PTG") {
        buyFee.rewardFee = 50;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "PartyGirls: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "PartyGirls: The new dividend tracker must be owned by the PartyGirls token contract"
        );
    ...
    require(newAddress != address(uniswapV2Router), "PartyGirls: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "PartyGirls: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "PartyGirls: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "PartyGirls: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "PartyGirls: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "PartyGirls: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        require(from != address(0), "PartyGirls: transfer from the zero address");
        require(to != address(0), "PartyGirls: transfer to the zero address");
        require(
    ...
    function swapAndSendToMarketing(uint256 tokens) private lockTheSwap {
      swapTokensForTokens(tokens, USDT, address(this));
        uint256 marketingTokens = IERC20(USDT).balanceOf(address(this));
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("PartyGirls_Dividend_Tracker", "PartyGirls_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "PartyGirls_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PartyGirls_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PartyGirls contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "PartyGirls_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "PartyGirls_Dividend_Tracker: Cannot update claimWait to same value"
        );
