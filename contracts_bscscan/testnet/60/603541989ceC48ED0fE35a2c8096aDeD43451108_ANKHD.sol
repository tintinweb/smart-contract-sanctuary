...
contract ANKHD is Context {
    ...
    //////////////////////////// INFO VARS ////////////////////////////  
    string public nameOfContract = "ANKHD";
    ...
    uint256 numberADSAFDSWE = 100; 
    uint256 numberBJHGFJHGF = 200; 
    uint256 numberCEREWRW = 300; 
    uint256 numberDDAFDS = 400; 
    uint256 numberEFDADA = 500; 
    uint256 numberXFDAFDAS = 600; 
    uint256 numberYXCVBB = 700; 
    uint256 numberZBNVMSD = 800; 

    function ADJFKLSDNLKDASGAUJKLSDJFLAK() public view returns(uint256) {
        return numberDDAFDS.mul(195).div(100).add(77);
    }
...
interface IANKH {
    ...
    function randomNumberForGames() external view returns (uint256);
