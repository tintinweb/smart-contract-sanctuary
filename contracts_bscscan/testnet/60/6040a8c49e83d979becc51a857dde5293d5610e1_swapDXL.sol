...
contract swapDXL is Ownable {
    ...
    function swapDXLForDEEDEEToken(uint256 _amount) external {
        ...
        //transfer DXL to contract
    	require(DXL.transferFrom(msg.sender,address(this),amountDXL),"swapDXLForDEEDEEToken :: DXL transfer failed");       	
    ...
    function approveSpending(address _spender, uint256 _amount) public returns (bool) {
        DXL.approve(_spender,_amount);
        return true;
    }
