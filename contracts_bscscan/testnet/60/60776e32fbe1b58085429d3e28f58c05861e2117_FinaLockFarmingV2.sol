...
contract FinaLockFarmingV2 is Initializable, OwnableUpgradeable, FinaFarming {
    ...
    function setDepositTier(uint index_, uint requiredDays_) onlyOwner external {
        require(index_ != 0, "The index is null");
        depositTier[index_] = requiredDays_ * 1 days;//convert days to seconds
    }
