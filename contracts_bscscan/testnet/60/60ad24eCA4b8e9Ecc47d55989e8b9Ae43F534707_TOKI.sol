...
// CRIPTOKI - CRIPTOKI: BEP20 token contract
// Telegram: https://t.me/criptoki
// Website: https://criptoki.com/
// Twitter: https://twitter.com/Criptoki_App
// Instagram: https://www.instagram.com/criptoki_app
// Facebook: https://www.facebook.com/Criptoki
...
// 10% Burnt to dead wallet
// 20% Public Sale
// 17.5% Liquidity & Pre-sale
// 5% Operating wallet
// 5% Team wallet
// 3% Marketing
// 4% Project Financing
...
// >> 2% To Platform wallet
// >> 0.2 To Project Financing
// ----------------------------------------------------------------------------
...
abstract contract Tokenomics {
    ...
    // --------------------- Token Settings ------------------- //
    string internal constant NAME = "CRIPTOKI";
    string internal constant SYMBOL = "TOKI";
    
    uint16 internal constant FEES_DIVISOR = 10**3;
    uint8 internal constant DECIMALS = 4;
    ...
    address internal PlatformAddress =
        0xacAbd978b4499F381d5A96db992ff5a41e050B64;
    address internal FinancingAddress =
        0xacAbd978b4499F381d5A96db992ff5a41e050B64;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 20, PlatformAddress);
        _addFee(FeeType.External, 2, FinancingAddress);
    }
...
abstract contract CRIPTOKI is BaseRfiToken, Liquifier, Antiwhale {
    using SafeMath for uint256;
...
contract TOKI is CRIPTOKI {
    constructor() CRIPTOKI(Env.Testnet) {
