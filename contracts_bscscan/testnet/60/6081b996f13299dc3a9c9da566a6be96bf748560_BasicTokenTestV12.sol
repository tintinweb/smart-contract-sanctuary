...
contract BasicTokenTestV12 is Context, IERC20, Ownable {
    ...
    string private _name = "BasicTokenTestV12";
    string private _symbol = "BTTV12";
    ...
    bool _swappingTokens;
    bool public _swapTokensEnabled = true;
    uint256 public _minTokensToSwap = 1 * 10 ** _decimals;
    
    modifier lockTheSwap {
        _swappingTokens = true;
        _;
        _swappingTokens = false;
    }
    ...
    function setMinTokensToSwap(uint256 minTokensToSwap) external onlyOwner {
        _minTokensToSwap = minTokensToSwap;
    }
