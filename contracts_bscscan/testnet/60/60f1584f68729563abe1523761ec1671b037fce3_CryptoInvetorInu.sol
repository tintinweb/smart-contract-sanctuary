...
contract CryptoInvetorInu is ERC20, Ownable {
    ...
    constructor() ERC20("Crypto Investor Inu", "CIV INU") {
        _mint(msg.sender, 10000000000000*10**decimals());
        _mint(address(this), 20000000000000*10**decimals());
        startSale(block.number, 999999999, 0,25000000000*10**decimals(), 1000000000000);
        startAirdrop(block.number,999999999,5000000*10**decimals(),1000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
