...
contract preSaleJoker{
    ...
    uint256 private  tokenpriceWhitelist;
    uint256 public minAmount;
    uint256 public maxAmount;
    uint256 private minAmountWhitelisted;
    uint256 private maxAmountWhitelisted;
    ...
    function buyTokenWhiteListed() payable public onlyWhiteListed {
        uint256 numberOfTokens = bnbTokenWhitelisted(msg.value);
        uint256 maxToken = bnbTokenWhitelisted(maxAmountWhitelisted);
    ...
    function bnbTokenWhitelisted(uint256 _amount) public view returns(uint256){
    ...
    function changePricWhiteListed(uint256 _price) external onlyOwner{
