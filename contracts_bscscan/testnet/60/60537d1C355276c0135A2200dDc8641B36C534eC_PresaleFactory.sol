...
contract Presale is Ownable {
  ...
  */
  ...
  function onlyParentCompanyFunction_setAmountTokenToHold(uint256 amountTokenToHold_)
    external
    onlyParent
  {
    //Effects
...
contract PresaleFactory is Ownable {
  ...
  uint256 public bnbPerPresale = 1e18; // 1 BNB
  ...
  constructor(
    address owner_,
    IERC20 tokenToHold_,
    address payable paymentRecipient_
  ) {
  ...
  function onlyOwner_editTokenToHoldSettings(IERC20 _tokenToHold, uint256 _amountTokenToHold)
    external
    onlyOwner
  {
  ...
  function onlyOwner_setBNBPerPresaleSettings(address paymentRecipient_, uint256 bnbPerPresale_)
    external
    onlyOwner
  {
