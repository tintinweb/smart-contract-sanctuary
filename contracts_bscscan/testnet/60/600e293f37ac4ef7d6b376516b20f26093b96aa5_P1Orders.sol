    ...
    P1TraderConstants
{
    ...
    /**
     * @notice Allows an account to take an order by a different account.
        ...
        returns (P1Types.TradeResult memory)
    {
        ...
        bool taker_isBuy = !tradeData.maker_is_buy;
        emit LogOrder(
            maker,
            taker,
            tradeData.amount,
        ...
        uint256 margin_change = tradeData.amount.baseMul(tradeData.fill_price);
        return P1Types.TradeResult({
            fee_maker: tradeData.fee_maker,
            fee_taker: tradeData.fee_taker,
            funding_maker: tradeData.funding_maker,
            funding_taker: tradeData.funding_taker,
            positionAmount: tradeData.amount,
            margin_change: margin_change,
            is_neg_fee: tradeData.isNegativeFee,
            isBuy: taker_isBuy,
