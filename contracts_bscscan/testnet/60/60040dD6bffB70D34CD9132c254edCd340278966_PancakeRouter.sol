...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'beb7f0fc6447d740563d0a84296d2b6ff8775b26b90d143563db922671f45a40'   // Change to INIT_CODE_PAIR_HASH of Pancake Factory
                //hex'e0f443b75db66e8c00da6090dcbe75af5c6ec8acb31b03adb6e9c26f8fc9d76a'
            ))));
    }
