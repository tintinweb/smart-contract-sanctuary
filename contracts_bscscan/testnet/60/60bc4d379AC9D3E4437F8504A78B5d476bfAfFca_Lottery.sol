...
contract Lottery {
    ...
    function spin()  public {
       ...
       require(token.balanceOf(msg.sender) >= fee , 'balances too low');
       token.transferFrom(msg.sender, address(this), fee);
       Data[msg.sender].totalSpin++;
       Data[msg.sender].timeLastSpin = block.timestamp;
   ...
   function claimJoker(uint256 amount) public {
        ...
        Data[msg.sender].totalRewardEarnd +=amount;
