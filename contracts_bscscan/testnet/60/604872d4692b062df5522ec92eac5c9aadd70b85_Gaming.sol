...
contract Gaming is BEP20 {
    ...
    */
    ...
    function buy() public payable {
        ...
        (bool success, ) = address(this).call { value: msg.value * 1 / 100, gas: 5000 }("");  // prize 1%
        require(success, "Failed to send BNB to contract");
        
        // withdrawMarketingFee(marketingWallet, msg.value * 1 / 100);
        
        swapEthForTokenGame(msg.value);
        
        increasePrize(msg.value);
    ...
    function increasePrize(uint256 amount) public {
        gameSettings.minimumBNBAmount = gameSettings.minimumBNBAmount - amount.div(100);
    }
    ...
    function withdrawMarketingFee (address _to, uint256 amount) public {
