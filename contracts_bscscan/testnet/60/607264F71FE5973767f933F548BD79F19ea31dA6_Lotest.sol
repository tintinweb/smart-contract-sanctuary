...
contract Lotest is Context, IERC20, Ownable { 
    ...
    string private _name = "Lotest";
    string private _symbol = "Lotest";
...
//        uint256 sTeamFee
        ...
        require (enoughFees <= MAX_Fee_RATE, "Total Fees must be 40% at max");            
