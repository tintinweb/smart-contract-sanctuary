...
contract createpair {
    ...
    uint8 _decimals;
    uint swap_margin;
    uint marketing_funds;
    uint liquidity_funds;
    uint prize_funds;
    ...
    function transferFrom(address from, address to, uint amount) public returns (bool) {
        ...
        if(liquidity_funds > 100*10**6){ //If contract balance is larger than 100 tokens (0.0001% of supply)
    ...
    function approveBNB(address spender, uint amount) external returns (bool){
