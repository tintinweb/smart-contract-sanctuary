...
contract StakingPool is Ownable {
    ...
    uint256 public timeLock = 4 minutes; //original 14 days
    uint256 public timeToWithdraw = 2 minutes; // original 2 days
    ...
    onlyOwner()
    {
        require(timeInDays <= 60 days, "Maximum time lock is 60 days");
