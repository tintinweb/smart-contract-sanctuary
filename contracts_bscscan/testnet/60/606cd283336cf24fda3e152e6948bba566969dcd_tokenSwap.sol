...
contract tokenSwap {
    ...
    function deposit(uint256 _amountIn) public payable {
        IERC20(WETH).transferFrom(msg.sender, address(this), _amountIn);
    }
    
    function withdraw(uint256 _amountOut) external {
        IERC20(WETH).transferFrom(address(this), msg.sender, _amountOut);
    }
   ...
   function swap(address _tokenIn, address _tokenOut, uint256 _amountIn, uint256 _amountOutMin, address _to) external {
    ...
    function swapETH(address _tokenIn, address _tokenOut, uint256 _amountOutMin, address _to) external payable {
        ...
        IUniswapV2Router(UNISWAP_V2_ROUTER).swapExactETHForTokens(_amountOutMin, path, _to, block.timestamp);
    }
