...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); //RIPR
...
contract BABYRISE is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Baby Rise";
    string constant _symbol = "BBRI";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address RewardToken = 0xa40bfcCB879F26648D5c16Ce6205425068c10BC7;  //RIPR

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 800;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x57E158589892BeD544a154355974b09F692AF2B4;
        marketingWallet = 0x77DD3B104915E22F31B6AbAed8337A18023e1463;  // marketingwallet
