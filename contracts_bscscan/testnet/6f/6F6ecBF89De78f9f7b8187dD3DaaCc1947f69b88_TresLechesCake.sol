...
contract DividendDistributor is IDividendDistributor {
      ...
      // SETMEUP
    // REWARD MAINNET: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    // REWARD TESTNET: 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
        IBEP20 CAKE = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //Cake Router for Rewards
		
	// BNB MAINNET: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    // BNB TESTNET: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
        address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //WBNB Router
        IDEXRouter router;
...
contract TresLechesCake is IBEP20, Auth {
        ...
        string constant _name = "Tres Leches Cake Slice";
        string constant _symbol = "3LCS";
        uint8 constant _decimals = 18;
    
        uint256 _totalSupply = 1 * 10**15 * (10 ** _decimals); //Total Supply, 1 Quad.
    ...
    //Definitions of Fees
        ...
        uint256 totalFee = 1300; // Total Fees
        ...
        uint256 swapThreshold = _totalSupply / 400; // 0.025%
