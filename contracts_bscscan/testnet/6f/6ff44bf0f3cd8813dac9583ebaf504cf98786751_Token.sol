...
contract Token is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x5829a351C57A26E1bb8897149be30451a1953382);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    string private _name    = "MMTZ2";
    string private _symbol  = "MTZ2";
    ...
    function swapAndLiquify(uint256 tokenBalance) private lockTheSwap {
        ...
        if(_externalFee > 0)
        {
            ...
            swapTokensForEth(externalAmount);
