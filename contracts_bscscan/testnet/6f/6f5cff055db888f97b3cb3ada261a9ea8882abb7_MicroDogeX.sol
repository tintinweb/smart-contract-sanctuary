...
/**
 *Submitted for verification at BscScan.com on 2021-09-0
*/
...
contract MicroDogeX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string public constant _name = "MicroDogeX";
    string public constant _symbol = "MicroDogeX";
    ...
    address payable constant private _marketingAddress = payable(0x45Ea30b205F81f0914d2747d94Df9b7EF4Cf354a);
    address payable constant private _buybackAddress = payable(0x634041245bd6Fd2544feec0E5DB20E5f100DEdf2);
    address payable constant private _projectMaintainence = payable(0x5fD1661707c12B5603986fDc5564840dE996c8F8);
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//MicroDogeX
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//MicroDogeX
