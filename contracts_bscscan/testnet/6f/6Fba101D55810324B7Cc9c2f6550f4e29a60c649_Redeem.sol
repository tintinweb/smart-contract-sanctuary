...
contract Redeem is AccessControl {
    ...
    function redeemPackage(uint256 _tokenIdPackage, uint256[] memory _tokenId, uint256[] memory _numberHero, string[] memory _tier) public payable{
        require(msg.value == feeBnb, 'System fee');
        receiveFee.transfer(feeBnb);
        packageNFT.burn(msg.sender, _tokenIdPackage);
