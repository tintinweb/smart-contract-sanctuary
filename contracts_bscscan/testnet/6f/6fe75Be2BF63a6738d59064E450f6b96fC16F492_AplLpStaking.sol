...
contract AplLpStaking is Pausable, Ownable {
    ...
    uint256 ONE_MONTH_IN_SECONDS = 1800;
    ...
    function setCpTokenAddress(address _address) public onlyOwner {
        require(_address!=address(0), "Invalid address");
    ...
    function setMaxScore(uint256 _maxScore) public onlyOwner {
    ...
    function setClaimPerBlock(uint256 _num) public onlyOwner {
