...
// File: contracts/SHIBBY DividendPayingToken.sol
...
contract SHIBBY  is ERC20, Ownable {
    ...
    uint256 public tradingEnabledTimestamp = 1630555628;
...
contract SHIBBYDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("SHIBBY _Dividend_Tracker", "SHIBBY _Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "SHIBBY _Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "SHIBBY _Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SHIBBY  contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SHIBBY _Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SHIBBY _Dividend_Tracker: Cannot update claimWait to same value");
