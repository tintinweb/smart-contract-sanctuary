...
contract JaxPlanet is Initializable, IJaxPlanet{
  ...
  modifier onlyAdmin() {
    require(jaxAdmin.userIsAdmin(msg.sender), "Not_Admin"); //Only Admin can perform this operation.
    _;
  }
