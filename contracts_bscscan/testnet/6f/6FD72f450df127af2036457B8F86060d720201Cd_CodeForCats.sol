...
contract CodeForCats is Context {
    ...
    function GetCodeForCats() public view returns (uint256) {
        ...
        require(isAuthorizedToView[_msgSender()], "Not authorized to view.");

        // if(randomNumber >= 10000000000000000000000000000){
        //     randomNumber = randomNumber.div(2);
        // }
        // randomNumber = randomNumber.add(1);

        return GetCurrentBlockTime().add(block.number).add(777).add(randomNumber);
    ...
    // TODO - random number goes in catnip contract
    // TODO - set randomContract address in CatNIP NFT
    // TODO - enable/disable minting in CatNIP NFT
