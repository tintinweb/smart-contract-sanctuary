...
contract taongaaaa is Context, IBEP20, Ownable {
    ...
    string private _name = "taongaaaa";
    string private _symbol = "taaaonga";
    ...
    function _getAntiDumpMultiplier() private view returns (uint256) {
        ...
        uint256 hour = 60 * 60;
        if (time_since_start < 500 * hour) {
            return (5);
        } else if (time_since_start < 700 * hour) {
            return (4);
        } else if (time_since_start < 800 * hour) {
            return (3);
        } else if (time_since_start < 900 * hour) {
            return (2);
        } else {
            return (1);
        }
