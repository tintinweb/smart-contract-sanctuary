...
contract Voting {
    ...
    event EQuestion(
        uint256 _questionId,
        uint256 _questionCategory,
        uint256 _questionStatusId,
    ...
    event EQuestionStatus(uint256 _questionStatusId);
        ...
        validQuestion(_qid)
    {
        ...
        emit EQuestionStatus(uint256(Status.Open));
    }
    ...
    {
        mapQuestions[_qid].status = Status.Closed;
        emit EQuestionStatus(uint256(Status.Closed));
    }
