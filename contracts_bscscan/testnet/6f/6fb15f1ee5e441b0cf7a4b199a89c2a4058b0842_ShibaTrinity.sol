...
contract ShibaTrinity is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 2000000000 * 10 **5;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Shiba Trinity";
    string private _symbol = "SHBT";
    ...
    address public _lockParnerAddress = address(0x9c4fAEFd86e6dbA1E438e65601064EB94642592E);
    ...
    uint256 private numTokensSellToAddToLiquidity = 80000 * 10**5;
    ...
    constructor () {
        ...
        _rOwned[_lockParnerAddress] = _rTotal / 2;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x05eD084B383C1a8324ec09F365c86b51ecDd311F, 'We can not exclude Pancake router.');
