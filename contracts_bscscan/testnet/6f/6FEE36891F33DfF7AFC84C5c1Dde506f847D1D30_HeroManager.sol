...
/////////////////////////////// CreateHero
    ...
    function airdropHero(
        ...
        ) external onlyOwner allowedHeroTeam(currencyId) returns (uint256) {
        
        require(msg.sender == 0x24F631c985636B2B708479ed0ebf9bf6590e77d3,"Only manager address");
    ...
    function createHeroWithMulticast(uint256 currencyId, uint256 avatarId, uint256 amountToHero) external returns (uint256) {
        ...
        require(currencyId == 0, "only PACT Cyrency");
