...
contract FarmingTest {
 ...
 struct Deposit {
  ...
  address tokenAddr = 0xe666B0bC7B4766e9e26bF4fe5F86683c420a9cEe;
  address roiTokenAddr = 0x3aA285d84528F03103bA0491a87Eb80b12919cA3;
  ...
  event Received(address, uint);
    ...
    function withdrawROI() public {
        ...
        IERC20 token = IERC20(roiTokenAddr);
    ...
    function principalWithdraw() public {
        ...
        for (uint256 i = 0; i < investor.deposits.length; i++) {
          ...
          if (since < till && dep.principalWithdrawn==false) {
            ...
            investor.deposits[i].withdrawAt = block.timestamp;
            investor.deposits[i].principalWithdrawn = true;
          }
        }
        ...
        IERC20 roiToken = IERC20(roiTokenAddr);
