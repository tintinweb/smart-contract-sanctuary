...
import "./base/DVDBEP20.sol";
import "./base/SafeBEP20.sol";
import "@openzeppelin/contracts/utils/math/SafeMath.sol";


contract xdvi is DVDBEP20("DVI Devidend Bearing Token", "xDVI") {

    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    IBEP20 public immutable dvdToken ;
    uint256 public manualMintLimit = 10000000e18;
    uint256 public manualMinted = 0;

// initial token
    constructor(IBEP20 _dvdToken) {
        dvdToken = _dvdToken;
    }
...
function collect() external {
  ...
  function distribute(uint256 _amount) external onlyOwner {
    require(dvdToken.balanceOf(msg.sender) >= _amount, "xDVI::depositDevidend: Insufficient balance");
    dvdToken.safeTransferFrom(msg.sender, address(this), _amount);
    _distributeDividends(_amount);
  }

  function distribute() public payable {
    require(msg.value > 0, "xDVI::depositDevidend: Insufficient balance");
...
contract DVDBEP20 is BaseDividends, BaseBEP20 {
  constructor(string memory name, string memory symbol)
    BaseBEP20(name, symbol)
