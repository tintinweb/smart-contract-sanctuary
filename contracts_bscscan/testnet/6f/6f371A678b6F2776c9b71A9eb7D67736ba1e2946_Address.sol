...
4% fee added to development and team wallet
2% fee added to marketing wallet
4% fee added to wallet for buyback $NUTSG in dip
*/
...
contract NUTSGaming is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "NUTS clone";                                          // name
    string private _symbol = "clone";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x573DEd1e3F9429389098E35D32F8d244D0592E82),                             // Dev+Team wallet
        payable(0x573DEd1e3F9429389098E35D32F8d244D0592E82),                             // Marketing wallet
        payable(0x573DEd1e3F9429389098E35D32F8d244D0592E82)                              // Buyback wallet
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "NUTSG is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "NUTSG is not live yet");
