...
abstract contract Merchant is MerchantInt{
    ...
    function getClaimable(address reseller, address memberAddress) public view returns(uint256 unclaimed){
        ...
        uint span = _hashRates[reseller][msg.sender].expiry > block.timestamp? block.timestamp - _hashRates[msg.sender][reseller].startDate : _hashRates[msg.sender][reseller].expiry - _hashRates[msg.sender][reseller].startDate;
