...
50% of the fees are added to the PancakeSwap Liquidity Pool, ensuring a
steadily rising floor price and price stability.

50% of the fees are distributed automatically to Charity WLLET.
 **/
...
contract $DSC is Context, IERC20, Ownable {
    ...
    string private _name = "Dstarlights Coin";
    ...
    address public charityWallet = 0x4E3Baa979df51Be9118fD84572B7F03bD09fE672; // A/C 7
 ...
 uint256 public _maxTxAmount = 1000000000 * 10**18;
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
     ...
     function calculateProgressiveFee(uint256 amount) private {
        uint256 currentSupply = _tTotal.sub(balanceOf(address(0x0ED7b772Fcf423e772E1C7030F2dB90374D77ee5)));
