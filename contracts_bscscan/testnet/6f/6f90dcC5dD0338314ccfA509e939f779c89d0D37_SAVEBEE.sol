...
contract SAVEBEE is Context, IERC20, Ownable {
    ...
    uint256 public _maxAmountBuy = 10000 * 10**_decimals; //10k - Initial max buy
    uint256 public _maxAmountSell = 20000 * 10**_decimals; //20k - Initial max buy
    ...
    string private constant _name = "SVB2 Token";
    string private constant _symbol = "SVB2";
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0x80bF01bE1aE01C0496Ee9e4b115431D2159813dc);
    ...
    function setMaxAmountSell(uint256 maxValueSell) public onlyOwner {
        _maxAmountSell = maxValueSell;
    }

    function setMaxAmountBuy(uint256 maxValueBuy) public onlyOwner {
        _maxAmountBuy = maxValueBuy;
    }


    function setMaxWallet(uint256 maxValueWallet) public onlyOwner {
        _maxWallet = maxValueWallet;
    }
