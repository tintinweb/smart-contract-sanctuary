...
/*
    ...
    2% of every transacion is converted to BNB and donated to Random verifiable Charities
    2% is sent to the marketing wallet and
    1% to the team wallet.
    
    1% of every transaction is redistributed between holders of the coin
    1% of every transacion is burned
    
    Telegram: https://t.me/azikainu
    Twitter: https://twitter.com/azikainu
    Website: https://azikainun.com


    
    Deployer wallet:         0x8cD5fb20652d687c237298d66eE221147d04955b
    Charity Wallet:          0xb60437c7C63118A7EB76A056f20f1B2B65b85c6E
    Team wallet:             0xD037f612C72d6802A33008CFe9465DE85FB2b3F4
    Marketing wallet:        0x27be455e593ebBEb463693b18680132fCc5bdffB
...
contract AzikaInu is Context, IERC20, Ownable {
    ...
    string private _name = "AzikaInu";
    string private _symbol = "AZIKA";
    ...
    uint256 public _donationFee = 5; //5% is split to 2% donation + 2% marketing + 1% team
    uint256 private _previousDonationFee = _donationFee;
    
    uint256 public _maxTxAmount = 10**15 * 10**9;
    uint256 private minimumTokensBeforeSwap = 10**12 * 10**9; 
    
    address payable public charityAddress = 0xb60437c7C63118A7EB76A056f20f1B2B65b85c6E;     // Charity
    address payable public marketingAddress = 0x27be455e593ebBEb463693b18680132fCc5bdffB;   // Marketing
    address payable public teamAddress = 0xD037f612C72d6802A33008CFe9465DE85FB2b3F4;        // Team
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 BNBTransfer = (address(this).balance).div(5);
        uint256 charityTransfer = 2*BNBTransfer;
       
        TransferCharityBNB(charityAddress, charityTransfer); 
        uint256 afterTransferBalance = address(this).balance;
        
        uint256 marketingTransfer = 2*BNBTransfer;
        
        TransferCharityBNB(marketingAddress, marketingTransfer);
