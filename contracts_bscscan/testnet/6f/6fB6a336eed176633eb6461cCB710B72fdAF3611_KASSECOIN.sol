...
contract KASSECOIN  {
   ...
   mapping(address => uint256) public boughtOf;
    ...
    constructor(address ownerAddress, IBEP20 _kassetoken,address _feeWallet) public 
    {
        owner = ownerAddress;
    ...
    function buyToken(uint256 _value,address referrer) public payable
	{
		 ...
		 emit TokenDistribution(address(this), msg.sender, amount,msg.value);					
	 }
    ...
    function fee_setting(uint fee) public payable
    {
           require(msg.sender==owner,"Only Owner");
              airdropFee = fee;
    }
    ...
    {
         require(msg.sender==owner,"Only Owner");
         KasseToken.transfer(msg.sender,tokenQnt);
    }
