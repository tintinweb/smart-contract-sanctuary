...
abstract contract CoordinatedWithdrawal is ReentrancyGuard {
    ...
    */
    ...
    /**
    * @dev Ensures that no more than 10% can be withdrawn over a 24h hour period
    *
    * Requirements:
    *
...
contract BEP20Token is Context, IBEP20, Ownable, CoordinatedWithdrawal {
    ...
    string private constant _name = "AntiTest8";
    string private constant _symbol = "ANT";
    uint8 private constant _decimals = 18;
    uint256 private _totalSupply = 1 * 10**12 * 10**_decimals;      // 1 Trillion tokens
    ...
    // fees. This decreases the transaction fees and increases the transfer speed. 
    ...
    constructor() {
        ...
        IUniswapV2Router02 _pscV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
 ...
 /**
  ...
  /**
    ...
    */
    function _transferMarketingTokens(address recipient, uint256 amount) internal onlyOwner {
    ...
    */
    function _transferDeveloperTokens(address recipient, uint256 amount) internal onlyOwner {
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(sender != owner() && sender != address(pcsV2Router))
        {
