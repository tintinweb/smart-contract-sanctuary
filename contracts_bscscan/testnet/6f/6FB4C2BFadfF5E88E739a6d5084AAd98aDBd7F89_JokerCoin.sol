...
contract JokerCoin is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    function setBuybackUpperLimit(uint256 _amount) public onlyOwner {
        buyBackUpperLimit = _amount;
    }
    
    function setBuybackLowerLimit(uint256 _amount) public onlyOwner {
        buyBackLowerLimit = _amount;
    }

    function setBuybackEnabled(bool _state) public onlyOwner {
    ...
    function checkLottery(address user, uint256 amount) private {
        pool1Count++;
        pool2Count++;
        pool3Count++;
        pool4Count++;
    ...
    function distributeLottery(address user, uint256 amount) private {
