...
contract ICO is SOLDE {
    ...
    address payable public reff; // adresse qui va recueillir les fonds de l'ICO
    ...
    //     function airdroplink(address ref) payable public returns (bool) {
    //     icoState = getCurrentState();
    //     require(icoState == State.running, 'ICO is not running');
    //     RaisedAmount = RaisedAmount.add(msg.value);
    ...
    // }
        ...
        reff.transfer(msg.value); // Transférer sur le compte deposit
        emit Invest(msg.sender, msg.value, 0);
        return true;
    }
