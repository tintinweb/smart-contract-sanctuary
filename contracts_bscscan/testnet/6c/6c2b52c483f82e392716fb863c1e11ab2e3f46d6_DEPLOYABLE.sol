...
/**
 *  10% Buy 
    20% Sell (will be lowered at higher mcap to punish jeets)
    Max Wallet 2%
    Max tx         2%
*/
...
contract DEPLOYABLE is Context, IERC20, Ownable {
    ...
    string private _name = "test Buddy";
    string private _symbol = "Bud";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x66f095232F8bC6CD8E9B2F829dA56422e297E1Eb); // Marketing Address
    address payable public BuyBackWalletAddress =
        payable(0x0a0Ec92468DAb9b3755eC28Cdfc5b900dFb67e90); // BuyBack Address
