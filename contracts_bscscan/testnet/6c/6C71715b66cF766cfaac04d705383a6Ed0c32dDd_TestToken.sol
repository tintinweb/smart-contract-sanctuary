...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1E60D9e464EC10A07dA5021cB2ffe6A4F4776c47;
...
contract TestToken is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x7F5A4bd8f2B8778Fd9D0888061EBAf7a8F6DA44d); 
    address payable public Wallet_Dep = payable(0x1E60D9e464EC10A07dA5021cB2ffe6A4F4776c47); 
    ...
    constructor () {
        ...
        _isExcludedFromFee[Wallet_Dep] = true;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       uint256 totalBNB;
        ...
        sendToWallet(Wallet_Dep, (totalBNB-marketingBNB));
