...
contract UniVerse is ERC721("UniVerse", "UNIV"), ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable, RewardSystem {
    ...
    constructor(string memory baseURI, IERC20 _token) {
    ...
    function mint(address _to) public onlyWhitedListMemeber {
        ...
        UniverseToken.safeTransferFrom(msg.sender, address(this), 500);
       _mintAnElement(_to);
    }
    
    function getUniverseToken() public { 
        UniverseToken.safeTransferFrom(address(msg.sender), address(this), 500); 
    }

    function getUniverseTokenSupply() public view returns (uint256){ return UniverseToken.totalSupply(); }
    ...
    function distribute(uint256 _amount) public isEnableDistribute {
        ...
        uint256 basicRate = 5;
        UniverseToken.safeTransferFrom(marketingAddress, address(this), markertingAmount);
    ...
    function rewardWithdraw() public returns (bool) {
        ...
        UniverseToken.safeTransferFrom(address(this), msg.sender, reward);
...
contract Token is ERC20("UniverseToken", "UNIV"), Ownable {
    constructor() {
        _mint(owner(), 5*10**26);
    }
}
