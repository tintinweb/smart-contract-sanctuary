...
contract DragonCastle is Ownable, ReentrancyGuard, ERC20("Dragon Castle","gDRAGON"){
    ...
    function initialize(
        ...
        require(_stakingBlocks[0] < _stakingBlocks[1], "Staking block exceeds end staking block");
    ...
    function collectFee(uint256 _amount, UserInfo memory user) internal returns(uint256){
