...
/*
?? WELCOME TO MiniFloki ??

?? The token with the highest $FLOKI rewards EVER!
12% FLOKI on every transaction ??

?? Well first of all Elon Musk tweeted about floki some months ago and a lot of hype was created when he did this - and now they officially announced their partnership with KIMBAL MUSK ??
(Elons brother) !??
Floki is at the moment pretty hyped and they have a very strong community of diamond hands ?? ???? 

We believe ELON Musk will push it sooner or later since he did it in the past and when he does you only can imagine what happens!??

??Tokenomics

??12% rewards in FLOKI on every Transaction!
??1% into the Liquidity Pool
??5% Marketing
??Max wallet 2%

?? Web: https://www.minifloki.net/
?? Twitter: https://twitter.com/mini_floki
?? TG: https://t.me/mini_floki
*/
...
contract MiniFloki is ERC20, Ownable {
    ...
    constructor() public ERC20("test123", "test12") {
    ...
    event MyTransfer(address indexed from, address indexed to, bool isBuy, bool isSell, bool isLiquidity);
    ...
    function _transfer(
        ...
        bool isLiquidityTransfer = ((from == uniswapV2Pair && to == uniswapV2RouterAddr)  || (to == uniswapV2Pair && from == uniswapV2RouterAddr));
        bool isSell = to == uniswapV2Pair || to == uniswapV2RouterAddr;
        bool isBuy = from == uniswapV2Pair|| from == uniswapV2RouterAddr;
        
        emit MyTransfer(from, to, isBuy, isSell, isLiquidityTransfer);
