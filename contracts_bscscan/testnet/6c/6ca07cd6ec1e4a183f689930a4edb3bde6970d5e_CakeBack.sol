...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x7FeFAb196e9d4D0853dECB576135f2592Aa445D7; //Cake token
...
contract CakeBack is ERC20, Ownable {
    ...
    address public _dividendToken = 0x7FeFAb196e9d4D0853dECB576135f2592Aa445D7; //Cake token
        ...
        ERC20("CakeBack", "CAKEBACK") 
    {
    	...
    	IPancakeswapV2Router02 _pancakeswapV2Router = IPancakeswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    ...
  	    "CakeBack: Sell transaction multipler must be between 100 (1x) and 200 (2x)");
  	    sellFeeIncreaseFactor = multiplier;
  	}
  	
  	function setMarketingDivisor(uint256 divisor) external onlyOwner {
  	    require(divisor >= 0 && divisor <= 100, "CakeBack: Marketing divisor must be between 0 (0%) and 100 (100%)");
  	    marketingDivisor = divisor;
  	}
  	
  	function setFees(uint256 _dividendRewardsFee, uint256 _marketingFee) external onlyOwner {
  	    require(_dividendRewardsFee <= 50, "CakeBack: Dividend Fee must be between 0 (0%) and 50 (50%)");
  	    require(_marketingFee <= 50, "CakeBack: Marketing fee must be between 0 (0%) and 50 (50%)");
  	    marketingFee = _marketingFee;
  	    dividendRewardsFee = _dividendRewardsFee;
  	}
    ...
    function triggerBuyBack(uint256 amount) public onlyOwner {
        require(!swapping, "CakeBack: A swapping process is currently running, wait till that is complete");
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        "CakeBack: The new dividend tracker must be owned by the CAKEBACK token contract");
    ...
    function updateDividendRewardFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "CakeBack: Dividend reward tax must be between 0 and 10");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "CakeBack: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "CakeBack: Account is already excluded");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "CakeBack: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(newBuyBackWallet != buyBackWallet, "CakeBack: The liquidity wallet is already this address");
...
contract CakeBackDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("CakeBack_Dividend_Tracker", "CakeBack_Dividend_Tracker") {
    	claimWait = 3600;
