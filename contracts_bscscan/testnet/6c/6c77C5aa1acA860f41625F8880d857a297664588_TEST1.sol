...
contract TEST1 is ERC20, Ownable {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "TEST1: The new dividend tracker must be owned by the BABYCAKE token contract");
    ...
    function _transfer(
        ...
        lockTime[msg.sender] = block.timestamp.add(timeForLock);
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    function withdrawDividend() public override {
        require(false, "TEST1_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BABYCAKE contract.");
    }
