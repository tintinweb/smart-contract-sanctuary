 ...
 * https://easyflytoken.com/
 * 5% das taxa dos trade vai para a pool de liquidez
 * 5% das taxa dos trade vai para os holders
 * 5% das taxa dos trade vai para carteira plataforma de apostas
*/ 
...
contract EasyFlyToken is Context, IERC20, Ownable {
    ...
    // Carteira do Sistema
    address public _charityWalletAddress = 0x646D358631Eb5d9213947b092eC16dfA3a23E455;
    ...
    string private constant _name = "EasyFlyToken";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 700000000 * 10 ** 9;
...
//        address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //NEW V2 mainnet
        address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // TesteNet
