...
contract TEST is ERC20, Ownable {
    ...
    constructor() public ERC20("TEST", "TEST") {
        uint256 _BNBRewardsFee = 1;
        uint256 _liquidityFee = 44;  // PCS and Marketing
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "TEST: The new dividend tracker must be owned by the POKEDOGE token contract");
