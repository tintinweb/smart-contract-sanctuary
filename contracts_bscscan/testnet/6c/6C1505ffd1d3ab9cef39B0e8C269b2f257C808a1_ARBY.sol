...
contract ARBY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 18 * 10**6 * 10**18;  // Total Supply 1,000,000,000
    uint256 private _rTotal;
    uint256 private _tFeeTotal;

    string private _name = "ARBY";
    ...
    uint256 public _maxTxAmount = 450000 * 10**18; // Limit transfer amount for block big whales
    ...
    constructor () {
        ...
        _isExcluded[uniswapV2Pair] = true;  // exclude pancakepair from rewards
        _excluded.push(uniswapV2Pair);

        _tTotal = _tTotal.div(2);
        ...
        emit Transfer(_msgSender(), deadAddress, _tTotal.div(2));
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _maxTxAmount = 18 * 10**6 * 10**18;
    }
    
    function afterPreSale() external onlyOwner {
        setOpenTrading(true);
        _taxFee = _defaultTaxFee = 2;
        _maxTxAmount = 450000 * 10**18;
    }
