...
/**
 * @title Lake721Tradable
 * Lake721Tradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract Lake721Tradable is ERC721, Ownable {
    ...
    function mint(address _to, string calldata _tokenUri) external {
        lake.safeTransferFrom(_msgSender(), treasury, platformFee);
    ...
    */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Lake auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Lake contracts to enable gas-less listings.
     */
