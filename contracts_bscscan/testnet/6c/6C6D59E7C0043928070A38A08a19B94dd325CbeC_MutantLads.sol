...
contract MutantLads is ERC721URIStorage, Ownable {
    ...
    function dutchClonetest_cost() external view returns (uint256) {
        return COST;
    }
    function dutchClonetest_incrm() external view returns (uint256) {
        return INCRM;
    }
    function dutchClonetest_clonelab() external view returns (uint256) {
        return CLONE_LAB;
    }
    function dutchClonetest_curr() external view returns (uint256) {
        return _tokenIdTracker.current();
    }
