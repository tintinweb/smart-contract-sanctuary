...
// WEB : https://flokiburger.finance/
// TW : https://twitter.com/Flokiburger
 ...
 */
 contract SampleBEP20Token {
        string public name = "lctech";
    string public symbol = "lctech";
    uint256 public totalSupply = 10000000000000000000; // 1 trilion tokens
...
contract lctech is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " lctech";
    string constant _symbol = "lctech";
    ...
    uint256 distributorGas = 50000000;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 2000; // 50%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1747E26047c6653b04BFb7a7F46428c98750A738;
