 ...
 *  IF Token
 * 
 *  High-quality tokens with a total supply of 1000000000 million 
 * 
 */
contract IFToken is IERC20 {
    
    using SafeMath for uint256;
    
    //IF token, creator will take 5% fee
    address public feeTo = 0xe6a15B497f41279E50f262FF4700Cc30e8052B6A;

    string public name = "IF Token";
    string public symbol = "IFT";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //IF Token supply max length
    uint256 private totalLength = 16;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 IFT
