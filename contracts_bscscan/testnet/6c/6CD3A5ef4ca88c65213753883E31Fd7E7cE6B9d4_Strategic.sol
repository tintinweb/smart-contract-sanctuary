...
contract Strategic is AccessControl {
    ...
    uint256 public lockAmount = 150000000000000000000000000; // 150,000,000 IMBA
    ...
    function getBalanceToken(address _address) public view returns( uint256 ) {
        ...
        if(block.timestamp > lockTime){
            ...
            uint256 remainCurrent = remainAmount90Percent.mul(claimPeriod).div(vestingPeriod) + remainAmount[address(_address)].div(10);
