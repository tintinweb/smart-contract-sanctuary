...
contract StakeContract is Ownable {
    ...
    uint256 public startBlock = 15243025 ; // set start block
    uint256 public minimum_deposit = 4000*10**18; //minimum deposit
    uint256 public endBlock =   15245025 ;  // set end block
    ...
    uint256 public lastRewardBlock = 15243025;  // should be same as start block at the beginning
