...
interface ISO20022ForPaymentV1 {
    ...
    event OrderConfirmed(address indexed stationAddress, address payeeAddress, string indexed transactionId, uint256 amountDue);
    /**
...
abstract contract MerchantObject is ISO20022ForPaymentV1{
    ...
    function confirmOrder(address stationAddress, string calldata transactionId, uint256 amountDue)public {
        require(_merchants[getParentAccount(stationAddress)].expiry > block.timestamp,'E57');
        require(_mBalanceOf(msg.sender) >= amountDue,'E58');
        emit OrderConfirmed(stationAddress, msg.sender, transactionId, amountDue);
    }
