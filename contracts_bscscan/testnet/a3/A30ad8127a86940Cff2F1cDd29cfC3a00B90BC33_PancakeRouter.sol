...
/**
 *Submitted for verification at BscScan.com on 2020-09-26
*/

// Dependency file: @uniswap/v2-core/contracts/interfaces/IPancakePair.sol
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6d571bc226a20c8b930739d78a980691623b4bc539617079da669bcb495b3589' // init code hash
            ))));
    }
...
// Dependency file: @uniswap/v2-core/contracts/interfaces/IPancakeFactory.sol
