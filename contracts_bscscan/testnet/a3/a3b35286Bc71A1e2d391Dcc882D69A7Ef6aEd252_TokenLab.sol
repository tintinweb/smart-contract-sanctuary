...
contract TokenLab is OwnableContext {
    ...
    constructor() {
        ...
        address _liquidityToken = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; //testnet wBNB address

        _testToken = new CarriedToken("Test Token", "TsT", 100000000, 9);
        
        _tokenCarrier = new TokenCarrier(address(_testToken), _liquidityToken);
