...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //ETH
...
contract ChronoSol is ERC20, Ownable {
    ...
    address private constant ETH =
        address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //ETH
    ...
    constructor() ERC20("ChronoSol", "ChronoSol") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("ChronoSol_Dividen_Tracker", "ChronoSol_Dividend_Tracker")
    {
        claimWait = 3600;
