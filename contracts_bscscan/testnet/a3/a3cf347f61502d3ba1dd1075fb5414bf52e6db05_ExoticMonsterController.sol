...
contract ExoticMonster20 is ERC20 {
    ...
    constructor() ERC20("Exotic Monster", "EMSC") {
        ...
        transfer(address(0x385D80C57E047332076408431027Ffa659562F0b),1500000 * 10 ** 18);
...
contract ExoticMonsterController is Ownable {
    ...
    constructor() {
        ...
        monsters[1] = Monster(1,72,6215,321,15,6,1,1);
        monsters[2] = Monster(2,52,6411,374,18,7,3,1);
        monsters[3] = Monster(3,43,6633,486,23,8,5,2);
        monsters[4] = Monster(4,25,6933,721,28,11,8,3);
        monsters[5] = Monster(5,11,7705,1176,35,13,12,5);  
    ...
    function selectBox(uint256 boxId) public {
        ...
        if(1 == boxId && box1MaxTimes > 0){
            require(EMC20.balanceOf(msg.sender) >= 5000 * 10 **18,"This user dont hava enough EMSC ");

            require(allowance >= 5000 * 10 **18 , "Check the token allowance");
        
            EMC20.transferFrom(msg.sender,address(this),1800 * 10 **18);
            EMC20.burn(5000 * 10 **18);
            ...
            emit SelectBox(msg.sender,boxId,5000,1);
        ...
        if(2 == boxId && box2MaxTimes > 0){
            ...
            require(EMC20.balanceOf(msg.sender)  > 14400 * 10 **18,"This user dont hava enough EMSC ");

            require(allowance >= 14400 * 10 **18 , "Check the token allowance");
            
            EMC20.transferFrom(msg.sender,address(this),14400 * 10 **18);
            EMC20.burn(14400 * 10 **18);
            ...
            emit SelectBox(msg.sender,boxId,14400,3);
            
            box2MaxTimes -= 3;
        }
        if(3 == boxId && box3MaxTimes > 0){

            require(EMC20.balanceOf(msg.sender)  > 22500 * 10 **18,"This user dont hava enough EMSC ");
            
            require(allowance >= 22500 * 10 **18 , "Check the token allowance");
            
            EMC20.transferFrom(msg.sender,address(this),8100 * 10 **18);
            EMC20.burn(22500 * 10 **18);
            ...
            emit SelectBox(msg.sender,boxId,22500,5);
