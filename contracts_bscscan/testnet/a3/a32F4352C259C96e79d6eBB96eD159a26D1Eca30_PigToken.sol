...
contract PigToken is Context, IERC20, Ownable {
    ...
    function _dealFIBAction(uint256 tFIBAddition) private {
        (uint256 _tFound, uint256 _tInvitor, uint256 _tBurn) = calculateFIB(tFIBAddition); 
    }
    
    function calculateFIB(uint256 tFIBAddition) private returns (uint256, uint256, uint256) {
