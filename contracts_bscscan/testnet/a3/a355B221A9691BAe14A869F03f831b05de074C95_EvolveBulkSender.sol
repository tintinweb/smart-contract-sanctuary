...
contract EvolveBulkSender is Context, Ownable{
    ...
    /* -------------------------------------------------------------------------- */
    /*                                 factory funcs                              */
    function factoryAddress() public view virtual returns (address) {
        return _factoryAddress;
    }
    
    function updateFactoryAddress(address _newFactoryAddress) public onlyOwner() returns(bool){
    ...
    function bulkReceive(uint256 _amount, address[] memory _payers, address _ERCTokenAddress) public factoryOrOwner()  returns (bool) {
    ...
    function bulkWithdraw(uint256 _amount, address[] memory _receivers, address _ERC20Address) public  factoryOrOwner() returns(bool) {
