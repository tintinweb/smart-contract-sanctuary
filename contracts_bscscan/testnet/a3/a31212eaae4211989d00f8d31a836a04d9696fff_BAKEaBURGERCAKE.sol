...
// The official BAKEaBURGERCAKE smart contract
contract BAKEaBURGERCAKE is IERC20, Context, Ownable {
    ...
    function setAllowTransferToMarketing(bool _canSendToMarketing, address _marketingFeeReceiver) external payable onlyOwner {
