...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x3ae65f0c7ccdec87c4c70c2977500e9584b30954003df8f9eb0896756b84ddb4 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x3ae65f0c7ccdec87c4c70c2977500e9584b30954003df8f9eb0896756b84ddb4;
...
contract TOKENQ1 is Context, IERC20, Ownable {
    ...
    string private _name = "TOKEN Quase1";
    string private _symbol = "TTQ1";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**_decimals;
	
	address payable public marketingAddress = payable(0xf65a04AA99475F4E1eD379112c4196d7a6E13FCc);
    address public marketingWalletToken = 0xf65a04AA99475F4E1eD379112c4196d7a6E13FCc;
    address public constant deadAddress = 0xf65a04AA99475F4E1eD379112c4196d7a6E13FCc;
