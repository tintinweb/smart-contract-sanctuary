...
contract BurgToken is Initializable, ERC20CappedUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        _mint(msg.sender, 50 * 1e6 * 1e18); // Play to earn 50M // TODO: Enviar 10M al bridge y 40 a otra billetera ?
        _mint(msg.sender, 30 * 1e6 * 1e18); // Team (12M), Advisors (7M), Marketing (5M), Platform Development (5M), Airdrop (1M) - Total 30M
        _mint(msg.sender, 20 * 1e6 * 1e18); // DxSsale Public sale (12M), Liquidity (8M) // TODO:  Incluir otros fees.  Hacer simulación.
        isInitialized = true;
