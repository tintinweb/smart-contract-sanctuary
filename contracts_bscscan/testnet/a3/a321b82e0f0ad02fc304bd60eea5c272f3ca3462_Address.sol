...
contract GhostDex is ERC721Pausable, Ownable {
    ...
    constructor() public ERC721("GhostWhale", "Whale") {
        _maxTotalSupply = 5;
    }
    ...
    function mint(address player) external onlyMinter returns (uint256) {
        require(totalSupply() < _maxTotalSupply, "GhostDex: total supply is error");
