// 0xE7360B15d4868e9099CbEe5d65e29421a6796905
...
contract EggFlipper is Ownable {
  ...
  function getListingsByCaller() external view returns (Listing[] memory) {
    uint256 tookCount = 0;
  ...
  function getAnmlOwnedByCaller() external view returns (OwnAnml[] memory) {
    uint256 anmlCount = anmlToken.balanceOf(_msgSender());
