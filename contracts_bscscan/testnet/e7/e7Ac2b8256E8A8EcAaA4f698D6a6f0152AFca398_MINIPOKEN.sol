...
contract MINIPOKEN is ERC20, Ownable {
    ...
    address private RewardToken =
        address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); //BNB Testnet RewardToken

    uint256 public swapTokensAtAmount = 1 * 10**7 * (10**18); // 10 000 000
    uint256 public maxBuyAmount = 5 * 10**5 * 10**18; // 500 000
    uint256 public maxSellAmount = 5 * 10**6 * 10**18; // 5 000 000
    uint256 public maxWalletAmount = 5 * 10**7 * 10**18; // 50 000 000
    ...
    constructor() ERC20("MiniPoken", "MINIPOKEN") {
