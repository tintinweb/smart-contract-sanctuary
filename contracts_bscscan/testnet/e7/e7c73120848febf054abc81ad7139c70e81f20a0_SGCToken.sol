...
contract SGCToken is Ownable, IBEP20 
{
    ...
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // Ruta de https://pancake.kiemtienonline360.com/#/swap
//    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Ruta para pruebas en testnet con pancakeswap ! ya no funciona!!
    ...
    constructor() 
    {
        ...
        // excluye las cuentas que se especifiquen
        sinfee(owner(), true);
    ...
    function Quema_de_token_FEE(uint256 quemando) public virtual
    {
    ...
    function FEE_90(uint256 variable) public virtual
    {
        Fee90dias = variable;
    }
    ...
    function setMaxSellAmount(uint256 amount) public virtual
    {
    ...
    function setMaxBuyAmount(uint256 amount) public virtual
    {
    ...
    function sinfee(address cuenta, bool excluida) public virtual 
    {
