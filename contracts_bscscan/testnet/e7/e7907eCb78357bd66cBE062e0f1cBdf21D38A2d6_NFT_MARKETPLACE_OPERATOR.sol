...
import "./NFT_Marketplace_Agency.sol";
...
contract NFT_MARKETPLACE_OPERATOR is Ownable, IERC721Receiver {
    ...
    */
    ...
    {
        $nft_marketplace_agency = nft_marketplace_agency;
        NFT_Marketplace_Agency = NFT_MARKETPLACE_AGENCY(nft_marketplace_agency);
    }
    ...
    */
    ...
    // Send NFT from a message sender to the registry for holding
        ...
        NFT_MARKETPLACE_AGENCY(agencySelector(agency_address)).depositERC721(erc721_address, serial_no, msg.sender, note);
        ...
        public
    {
        ...
        NFT_MARKETPLACE_AGENCY(agencySelector(agency_address)).withdrawERC721(erc721_address, serial_no, note);
    }
