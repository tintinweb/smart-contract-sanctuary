...
/**      
 * --- Testing ---
 * TODO: Should check price action when tokens are burned
 * --- Features ---
 * TODO: Decreasing fees after certain amount of time (algo?)
 * TODO: Increasing TX limit after certain amount of time (alog?)
 * --- Hard mode ---
 * TODO: Change mxTx and maxWallet to percentages with a denominator, so we could use 10 as 0.1%
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    // NOTE: BUSD(TESTNET) 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
    // NOTE: WBNB(TESTNET) 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    // NOTE: BUSD 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    // NOTE: WBNB 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    IBEP20 BETH = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract FUCK is IBEP20, Auth {
    ...
    // NOTE: BUSD 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    // NOTE: WBNB 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address BETH = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // <- earn token (BETH)
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    // Name and symbol
    string constant _name = "FUCK";
    string constant _symbol = "SYMBOLS";
    ...
    function checkMaxWallet(address sender, address recipient, uint256 amount) internal view {
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver && recipient != DEV){
