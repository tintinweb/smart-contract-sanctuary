...
contract DMCCharacter is ERC721, VRFConsumerBase, Ownable {
    ...
    // binance testnet: 0xa555fC018435bef5A13C6c6870a9d4C11DEC329C
    address public LinkToken;
    // binance testnet: 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06
    ...
    function getOwnCharacters()
    public
    view
    returns (Character[] memory
    )
    {
        Character[] memory ownCharacters = new Character[](characters.length);

        for (uint i = 0; i < characters.length; i++) {
            if (ownerOf(i) == msg.sender) {
                ownCharacters[i] = characters[i];
            }
        }
