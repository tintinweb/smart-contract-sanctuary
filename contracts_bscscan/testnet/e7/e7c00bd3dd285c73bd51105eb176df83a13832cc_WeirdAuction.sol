...
// Dependency file: contracts/interfaces/IManageableAuction.sol
...
// Dependency file: contracts/ManageableAuction.sol


// pragma solidity ^0.8.0;

// import "@openzeppelin/contracts/access/Ownable.sol";
// import "contracts/interfaces/IManageableAuction.sol";
...
// Dependency file: contracts/SendValueWithFallbackWithdraw.sol
...
// Dependency file: contracts/TokenAcceptanceCheck.sol
...
// Root file: contracts/WeirdAuction.sol
...
// import "contracts/ManageableAuction.sol";
// import "contracts/SendValueWithFallbackWithdraw.sol";
// import "contracts/interfaces/ISecondaryFeeCollection.sol";
// import "contracts/TokenAcceptanceCheck.sol";
// import "@openzeppelin/contracts/utils/math/SafeMath.sol";

/**
 * @title WeirdAuction main contract.
 */
contract WeirdAuction is
    ManageableAuction,
    ERC721Holder,
    ERC1155Holder,
    SendValueWithFallbackWithdraw
{
    ...
    function cancel(uint256 _auctionId) external nonReentrant {
        require(getStatus(_auctionId) <= Status.INITIATED, "Auction: cancel impossible");

        Auction storage a = auctions[_auctionId];

        require(_msgSender() == a.seller, "Auction: not seller");

        a.status.canceled = true;
