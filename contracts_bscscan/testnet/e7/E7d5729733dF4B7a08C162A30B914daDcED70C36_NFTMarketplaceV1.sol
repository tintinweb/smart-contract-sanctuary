...
contract NFTMarketplaceV1 is Ownable, ReentrancyGuard, Pausable {
  ...
  uint256 public _tipsFeeRate; // ~4.68 = 468
  ...
  event CancelSalesEvent(uint256 indexed id, uint256 tokenId);
  ...
  constructor(address _tipsFeeWallet) {
    ...
    nonReentrant
  {
    ...
    emit CancelSalesEvent(index, obj.tokenId);
  }
  ...
  function startSales(
    ...
    require(_supportNft[nft] == true, "This NFT not support");
    ...
    whenNotPaused
  {
    ...
    if (_isCalcTipsFee) {
      tipsFee = (price * _tipsFeeRate) / _baseRate;
