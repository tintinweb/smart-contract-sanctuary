...
contract TokenSale is Ownable {
    ...
    constructor() {
        token = IERC20(0xD119983939AbcB3570D671763fE2c9192ee32aCd);
        contributionAddress = 0x32A2747E473DFb2f94290287C361A31290A1A9E4;
        minimumPurchase = 0.01 ether;
        maximumPurchase = 5 ether;
        tokenDecimal = 1e18;
        tokenPerEther = tokenDecimal.mul(27000);
    }
    ...
    function buyTokens() public payable {
        ...
        if (onlyWhitelist) {
            require(whitelist[investor], "Only whitelist");
        }
