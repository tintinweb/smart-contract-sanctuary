...
contract RiseAndShine is Context, IERC20, Ownable {
    ...
    string private _name = "Rise and Shine v 7";
    string private _symbol = "RNSv7";
    uint8 private _decimals = 12;
    uint256 private _totalSupply = 100000000000 * 10 ** _decimals;
    
    address payable public marketingAddress = payable(0x9623FA92441637E61134f7297fD6Cbc48D6c8a55);  //Marketing Wallet
    address public marketingWalletToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // Peg BUSD Contract Wallet
    ...
    constructor () {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //PCS Address
