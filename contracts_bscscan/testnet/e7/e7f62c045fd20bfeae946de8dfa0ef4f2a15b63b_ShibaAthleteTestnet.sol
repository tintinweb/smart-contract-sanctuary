...
contract ShibaAthleteTestnet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x9b824dd868E5D0938b3bd15B475d83EB2bBD521B); // Marketing Address
    ...
    string private _name = "Shiba Athlete_TESTNET";
    string private _symbol = "$hibATH";
    ...
    function setDivisor(uint256 divisor) public onlyOwner {
        _divisor = divisor;
    }
