...
contract LaunchPadTierAllocatePool is Ownable, Initializable {
    // Contract libs
    ...
    uint256 public tierRequiredLockedAmount; // 200,000
    ...
    function takeSnapshot() public onlyOwner {
        uint256 snapshotUsers = lockPool.getSnapshotTierUsers(tierName);
        require(
            snapshotUsers > 0,
