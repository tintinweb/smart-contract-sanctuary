...
import "./SparksVesting.sol";

contract SeedVesting is SparksVesting {
    ...
    constructor(SparksToken _sparksToken)
        SparksVesting(
            _sparksToken,
            TOTAL_AMOUNT,
            WITHDRAW_INTERVAL,
...
import "../SparksToken.sol";

contract SparksVesting is Context, Ownable {
    ...
    SparksToken public sparksToken;
    ...
    function withdraw() public {
        ...
        if (_withdrawable > 0) {
            require(sparksToken.transfer(_msgSender(), _withdrawable));
...
contract SparksToken is ILockerUser, Context, ERC20, Ownable {
    ...
    string public constant NAME = "Sparks Token";
    string public constant SYMBOL = "SPKS";
