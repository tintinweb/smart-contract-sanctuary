...
contract Powermade is Ownable {
    ...
    constructor(address busdToken) public {
        ...
        users[msg.sender].levelplan[1].referredUsers=0;
        users[msg.sender].levelplan[2].referredUsers=0;
        users[msg.sender].levelplan[3].referredUsers=0;
        users[msg.sender].levelplan[4].referredUsers=0;

        users[msg.sender].levelplan[1].referrerID = currUserID;
        users[msg.sender].levelplan[2].referrerID = currUserID;
        users[msg.sender].levelplan[3].referrerID = currUserID;
        users[msg.sender].levelplan[4].referrerID = currUserID;

        users[msg.sender].levelplan[1].virtualID = currUserID;
        users[msg.sender].levelplan[2].virtualID = currUserID;
        users[msg.sender].levelplan[3].virtualID = currUserID;
        users[msg.sender].levelplan[4].virtualID = currUserID;

        users[msg.sender].levelplan[1].referral = emptyAddressList;
        users[msg.sender].levelplan[2].referral  = emptyAddressList;
        users[msg.sender].levelplan[3].referral = emptyAddressList;
        users[msg.sender].levelplan[4].referral = emptyAddressList;
    ...
    function ActivatePlan(
        ...
        require(amount == POOL_PRICE[_level], "Incorrect Value");
        ...
        if (_level == 1) {
            ...
            users[userList[_referrerID]].referredUsers = users[userList[_referrerID]].referredUsers + 1;
        ...
        users[userList[virtualID]].levelplan[_level].referredUsers = users[userList[virtualID]].levelplan[_level].referredUsers + 1;
        ...
        returns (address[] memory)
    {
      ...
      function getReferredUsersCount(address useraddress)
        public
        view
        returns (uint256)
    {
        ...
        return users[useraddress].referredUsers;
    }
}