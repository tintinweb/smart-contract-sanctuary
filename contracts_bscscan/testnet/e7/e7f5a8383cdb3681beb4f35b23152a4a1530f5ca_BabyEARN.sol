...
contract BabyEARN is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyEARN';
    string private constant _symbol = '$BABYEARN';
    ...
    //DevWallets
    address public TeamWallet=payable(0x65AA76CEba5dC86B4749d9F82Ae826214f8C14eb);
    address public walletTwo=payable(0x26FfEA3eb78bC618b493b3c25d0Af78E49cFB9D3);
   ...
   // address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimTWT(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function claimTWT(address addr) private{
