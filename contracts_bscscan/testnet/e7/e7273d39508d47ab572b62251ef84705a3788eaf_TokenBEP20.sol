...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  function approveAndCall(address spender, uint tokens, bytes memory data) public returns (bool success) {
    ...
    //adding people to the BitSoul Community approved list - these people are the only ones that will be able to buy at launch! 
...
contract BitSoul is TokenBEP20 {
