    ...
    ReentrancyGuard
{
    ...
    address public wbnbAddress = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    ...
    event AUTOStakingRewardsFactorChange(
        uint256 oldAUTOStakingRewardsFactor,
        uint256 newAUTOStakingRewardsFactor
    );
    ...
    function setAUTOStakingRewardsFactor(uint256 newAUTOStakingRewardsFactor)
        external
        virtual
    {
        require(
        ...
        require(
            newAUTOStakingRewardsFactor <= 1000,
            "newAUTOStakingRewardsFactor > 1000"
        );
        emit AUTOStakingRewardsFactorChange(
            AUTOStakingRewardsFactor,
            newAUTOStakingRewardsFactor
        );
        ...
        returns (uint256)
    {
        ...
        if (AUTOStakingRewardsFactor > 0) {
            uint256 AUTOStakingRewards =
                rewardsAmt.mul(AUTOStakingRewardsFactor).div(1000);
