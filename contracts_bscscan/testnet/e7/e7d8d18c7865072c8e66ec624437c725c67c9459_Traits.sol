...
contract Traits is Ownable, ITraits {
  ...
  function tokenURI(uint256 tokenId) public view  override returns (string memory) {  
    ...
    string memory metadata = string(abi.encodePacked(
      ...
      s.isTortoise ? 'Tortoise #' : 'Goat #',
      tokenId.toString(),
      '", "description": "Thousands of Tortoises and Goats compete on a isle in the metaverse. A tempting prize of $EGGS awaits, with deadly high stakes. All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just the Ethereum blockchain.", "image": "data:image/svg+xml;base64,',
