...
contract Pancakeswap_ZapIn_V3_1 is ZapInBaseV3 {
    ...
    IUniswapV2Factory private immutable pancakeswapFactoryAddress;

    IUniswapV2Router02 private immutable pancakeswapRouter;

    address private immutable wbnbTokenAddress;
        ...
        ZapBaseV2(0, 0)
    {
        ...
        pancakeswapFactoryAddress = IUniswapV2Factory(_pancakeFactory);
        pancakeswapRouter = IUniswapV2Router02(_pancakeRouter);
        wbnbTokenAddress = _wbnb;
    }
