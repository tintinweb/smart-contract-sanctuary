...
contract JAVACOIN is Context, IERC20, Ownable {
    ...
    address public devWallet = 0xD775E66936D80b4A849B2E1B4330AA5155Fb92DB;
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 burnFee, uint256 devFee) external onlyOwner() {
        _taxFee = taxFee;
