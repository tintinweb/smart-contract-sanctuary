...
contract RedFOXLootBox is VRFConsumerBase, Ownable {
        ...
        )
    {
        ...
        uint16[NUM_CLASSES] memory basicPackClassProbabilities = [0, 0, 5000, 3500, 1400, 100];
        uint16[NUM_CLASSES] memory basicPackGuarantees = [uint16(5), 4, 1, 0, 0, 0];
        setPackSetting(Pack.Basic, basicPackPrice, 12, basicPackClassProbabilities, basicPackGuarantees);
    }
