...
contract XSPToken is ERC20("Total.Exchange", "XSP"), Ownable {
    uint256 private _cap = 13000000000e18;
    uint256 private _initial_supply = 5000000000e18;
    ...
    */
    ...
    // In some circumstance, we should not burn XSP on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
    ...
    constructor() public {
        ...
        _mint(msg.sender, _initial_supply); // Mint 650000000 XSP for bounty program
