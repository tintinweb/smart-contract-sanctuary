...
contract TAONGAFARmM is Context, IBEP20, Ownable {
    ...
    function _getAntiDumpMultiplier() private view returns (uint256) {
        ...
        uint256 hour = 60 * 60;
        if (time_since_start < 168 * hour) {
            return (5);
        } else if (time_since_start < 180 * hour) {
            return (4);
        } else if (time_since_start < 200 * hour) {
            return (3);
        } else if (time_since_start < 220 * hour) {
            return (2);
        } else {
            return (1);
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // If you copy this line of  you're a shit dev who doesn't check over code
