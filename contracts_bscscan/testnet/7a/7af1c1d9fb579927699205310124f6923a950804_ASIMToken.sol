...
/// ASIM V2 token
contract ASIMToken is ERC20("ASIM TOKEN", "ASIM"), Ownable {
    ...
    /// We need mint some ASIM in advance
    ...
    /// @notice We need mint some ASIMs in advance
    constructor() public {
        treasuryWalletAddr = _msgSender();
        racaInAdvance = 2000000 * 10**18;
