...
contract BabyHoge is Context, IERC20, Ownable {
    ...
    string private _name = "BabyHoge";
    string private _symbol = "BabyHoge";
    ...
    address payable public marketingWallet = payable(0x222641EB51d18F56d8Ba4034b8a54A2E5A21b6C5);
