...
contract NFTPredictionPoolFactory is PoolCreator{
    ...
    event PoolCreated(
        ...
        string[2] poolTypePriceCurrency,
        address nftContract,
        // uint256 launchDate,
    ...
    function createPoolProxy(
        string[2] memory _poolTypePriceCurrency,
        address nftToken,
        // uint256 launchDate,
        // uint256 maturityTime,
        // uint256 lockTime,
    ...
    function upgradeIDOPool(
        NFTPredictionPoolProxy _idoPoolProxy, 
...
contract NFTPredictionPoolProxy is NFTPredictionPoolStorageStructure {
    ...
    ) public initializer onlyPoolCreator
    {
        ...
        require(
            _variables[8] == erc721 || _variables[8] == erc1155,
            "0302 only 721 and 1155 ERCs"
        );

        
        poolType = _poolTypePriceCurrency[0];
        priceCurrency = _poolTypePriceCurrency[1];
