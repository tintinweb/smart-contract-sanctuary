...
abstract contract MetaDogeBase is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	...
	string private constant SYMBOL = "qwert";
	...
	function transfer(address recipient, uint256 amount) public override returns (bool) {
		_pancakeswapV2Pair = IPancakeFactory(_pancakeswapV2Router.factory()).getPair(address(this), address(wbnb));
	...
	function setPancakeSwapRouter(address routerAddress) public onlyOwner {
		...
		_pancakeswapV2Pair = IPancakeFactory(_pancakeswapV2Router.factory()).createPair(address(this), address(wbnb));
