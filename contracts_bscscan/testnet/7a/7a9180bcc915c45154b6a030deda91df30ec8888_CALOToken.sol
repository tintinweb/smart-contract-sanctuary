...
contract CALOToken is ERC20Capped, ERC20Burnable, AccessControl {
    using SafeMath for uint256;

    address constant PANCAKE_FACTORY_ADDRESS =
        0x8cd198cFa0293fe7A0CDa00431C4Da9Dc794925d; //mainnet: 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73.
    address constant USDT_ADDRESS = 0xBc2d6a522eC5247abda6d09DE13B854Db00F6dA0; //mainnet: 0x55d398326f99059fF775485246999027B3197955.
    ...
    uint256 public constant MAX_FEE_RATE = 100; // 10%: MAX_FEE_RATE / FULL_RANGE
    uint256 constant FULL_RANGE = 1000;

    uint256 MAX_SUPPLY = 400 * 10**6 * 10**18;
    ...
    constructor(uint256 amountPremint)
        ERC20Capped(MAX_SUPPLY)
        ERC20("CALO Token", "CALO")
    {
        //setup msgSender as  admin, minter and address team wallet
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, _msgSender());
        teamWallet = _msgSender();
        //mint amount premint
        ERC20._mint(_msgSender(), amountPremint);
