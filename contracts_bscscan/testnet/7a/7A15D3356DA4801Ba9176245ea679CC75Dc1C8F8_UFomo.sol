...
contract UFomo is Context, IERC20, Ownable {
    ...
    function getMinimumBuyForPotEligibility(uint256 buyIdx) public pure returns(uint256) {
        return 50 * (buyIdx) - 10000000000 / (12000 + 15 * buyIdx) + 1110000;
    }
    ...
    function gameStats()
        ...
        currentMinBuyForPotEligibility = getMinimumBuyForPotEligibility(_buyIdx);
