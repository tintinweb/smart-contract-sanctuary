...
interface IUniswapV2Pair {
    ...
    function permit(address owner, address spender, uint value, uint Marketingline, uint8 v, bytes32 r, bytes32 s) external;
...
interface IUniswapV2Router01 {
    ...
    function swapExactETHForTokens(uint amountOutMin, address[] calldata path, address to, uint Marketingline)
        external
        payable
        returns (uint[] memory amounts);
    function swapTokensForExactETH(uint amountOut, uint amountInMax, address[] calldata path, address to, uint Marketingline)
        external
        returns (uint[] memory amounts);
    function swapExactTokensForETH(uint amountIn, uint amountOutMin, address[] calldata path, address to, uint Marketingline)
        external
        returns (uint[] memory amounts);
    function swapETHForExactTokens(uint amountOut, address[] calldata path, address to, uint Marketingline)
        external
        payable
        returns (uint[] memory amounts);
...
contract DiamondPipe is Context, IERC20, Ownable {
    ...
    address public MarketingWallet = 0x35A3892cc4A48d77aE014C1f77033b8C71d49EbB;
