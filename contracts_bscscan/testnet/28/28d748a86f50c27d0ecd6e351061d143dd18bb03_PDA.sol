...
contract PDA is SafeMath{
    ...
    constructor () public{
        ...
        name = 'Public Display of affection';                                 // Set the name for display purposes
        symbol = 'PDA';                                   // Set the symbol for display purposes
        decimals = 6;                                      // Amount of decimals for display purposes
        owner = msg.sender;
        emit Transfer(0x0000000000000000000000000000000000000000, msg.sender, 100000000000000000);
    }
