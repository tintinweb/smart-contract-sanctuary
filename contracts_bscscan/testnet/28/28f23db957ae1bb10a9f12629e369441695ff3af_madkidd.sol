...
contract madkidd is Context, IBEP20, Ownable {
    ...
    constructor ( )  {
		...
		_TAX_FEE = 1 * 100; 
        _BURN_FEE = 0 * 100;
		_Marketing_FEE = 10 * 100;
		ORIG_TAX_FEE = _TAX_FEE;
		ORIG_BURN_FEE = _BURN_FEE;
		ORIG_Marketing_FEE = _Marketing_FEE;
		FeeAddress = 0x6aF7Ea6c1A46c79278Ca5D742b22d06bbA56f8F8;
		_owner = 0x78246f81dcBE5305a95470bF1d7f3D263be058f9;
