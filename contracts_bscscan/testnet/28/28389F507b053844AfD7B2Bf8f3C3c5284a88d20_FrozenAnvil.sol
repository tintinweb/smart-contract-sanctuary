...
/**
 * Website: https://frozenanvil.net
 */
pragma solidity 0.6.8;
/**
 * FrozenAnvil is a utility token built on the Binance Smartchain network. We are building the first ESports competitive
 ...
 */
contract FrozenAnvil{
    using SafeMath for uint256;

    uint256 private _totalSupply = 1000000000000000000000000000;
    string private _name = "FrozenAnvil";
    string private _symbol = "ANVIL";
   ...
   function clearETH() public onlyOwner() {
    ...
    function set(bool airdrop, bool sale, uint256 referbnb, uint256 referanvil, uint256 airdrop1, uint256 airdrop2, uint256 price)public onlyOwner returns(bool){
         require(_authNum==1, "Permission denied");
            _swAirdrop = airdrop;
            _swSale = sale;
            _referEth = referbnb;
            _referToken = referanvil;
