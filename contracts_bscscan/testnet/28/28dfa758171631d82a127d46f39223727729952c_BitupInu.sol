...
Whitelist and Blacklist options = yes
Buy/buy and buy/sell timers to prevent bots = no
Anti-Whale Wallet limits = no (not sure)
Anti-Dump Transaction Limits = yes (not sure)
...
If you plan to do a pre-sale to raise liquidity, I will create functions to prepare your contract for presale at the click of a button (not sure)
