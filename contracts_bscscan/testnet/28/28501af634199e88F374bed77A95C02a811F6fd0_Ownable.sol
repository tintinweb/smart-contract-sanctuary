...
contract Mooneytrain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD0d92527eb6fbd2A22Cf743aAdBd1f6a533A2844); // Marketing Address
    ...
    string private _name = "MOONEYTRAIN";
    string private _symbol = "MOONEYTRAIN";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xD0d92527eb6fbd2A22Cf743aAdBd1f6a533A2844);
    }
    ...
    function _removeSniper(address account) external onlyOwner() {
        require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We can not blacklist Uniswap');
