...
abstract contract FarmageddonLottoKeeper is KeeperCompatibleInterface, Ownable {
    ...
    address public flotteryAddress;
    uint256 public fcurrentLotteryId;
    uint256 public fburnDivisor;
        
    FarmageddonLottery f = FarmageddonLottery(flotteryAddress);
    ...
    function setLotteryAddressAndCurrentLotteryId(address _fLotteryAddress, uint256 _fCurrentLotteryId) external onlyOwner {
        flotteryAddress = _fLotteryAddress;
