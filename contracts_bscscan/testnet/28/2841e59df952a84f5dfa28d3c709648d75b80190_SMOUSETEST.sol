...
SAFE MOUSE
 ...
 #SMOUSE Tokenomics
   3% fee add to the liquidity pool (locked)
   3% fee distribute to all holders
   3% fee moved to Charity & Marketing wallet
   3% Burn 
...
abstract contract Context {
    function _msgSender() internal virtual pure returns (address payable) {
        //return msg.sender; 
        return 0xa29DD943739674cB017ae1d5D07fD36edc836210; 
    }
...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = _msgSender(); // NFT Owner Address
...
contract SMOUSETEST is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SAFE MOUSE TEST";
    string private _symbol = "SMOUSETEST";
    ...
    address charityAddress=0xf830f481E644276ECaB32C793a9B3f37603d8755; // Charity Wallet
    ...
    constructor() public {
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // for BSC Test net 
