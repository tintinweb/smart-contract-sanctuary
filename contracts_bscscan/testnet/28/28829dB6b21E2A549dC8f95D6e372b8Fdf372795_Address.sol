...
contract ToddlerAstronaut is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0xf693d8eed013992Ddf1D4A77c2fcD1c72BDF52eB; //@todo change the address
    ...
    string private _name = "Toddler Astronaut";
    string private _symbol = "TAstro";
    ...
    // Max Tx amount to be 1 trillion #1000000000000
    uint256 public _maxTxAmount = 10000000000 * 10 ** 9;

    // Liquify when 25 billion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 25000000000 * 10 ** 9;
