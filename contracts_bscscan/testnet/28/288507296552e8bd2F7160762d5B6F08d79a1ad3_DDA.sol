...
contract DDA is IERC20 ,Ownable{
    ...
    event TransferPledge(address indexed from, uint256 usdtAmount, uint256 value);
    ...
    IERC20 USDT = IERC20(0x9C78aF2604Eda77CA236880946E3144a78042817);
    ...
    function pledge(uint256 amount,uint256 rate) public{
        ...
        emit TransferPledge(msg.sender,amount,ddaAmount);
    }
