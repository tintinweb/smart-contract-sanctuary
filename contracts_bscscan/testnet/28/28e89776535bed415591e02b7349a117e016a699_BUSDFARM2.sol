...
contract BUSDFARM2 {
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x844d9fc04cb1db5e4523392826bd88ec1d49ccb4);
    }
    ...
    function sellEggs() public {
        ...
        ERC20(busd).transfer(ceoAddress1, fee1);
        ERC20(busd).transfer(ceoAddress2, fee1);
    ...
    function buyEggs(address ref, uint256 amount) public {
		...
		uint256 refp=refFee(amount);
        uint256 fee1=fee/2;
        ERC20(busd).transfer(ceoAddress1, fee1);
        ERC20(busd).transfer(ceoAddress2, fee1);
        claimedEggs[msg.sender]=SafeMath.add(claimedEggs[msg.sender],eggsBought);
        ERC20(busd).transfer(ref, refp);
    }
	...
	function refFee(uint256 amount) public pure returns(uint256){
