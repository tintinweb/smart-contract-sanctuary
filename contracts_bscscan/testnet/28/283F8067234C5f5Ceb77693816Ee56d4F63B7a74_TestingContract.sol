...
contract TestingContract is Context, IERC20, Ownable {
    ...
    string private _name = "TestingContract";
    string private _symbol = "TestingContract";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000 * 10**9 * 10**_decimals;

    address payable public marketingAddress = payable(0x152593cD7A5959211C8041aCA20C972f03071367);
    address public marketingWalletToken = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    constructor () {
        ...
        _maxBalanceWallet = 10000 * 10**9 * 10**_decimals;
