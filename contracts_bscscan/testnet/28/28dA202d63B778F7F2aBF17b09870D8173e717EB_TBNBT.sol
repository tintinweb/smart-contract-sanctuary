...
contract StakeableToken is GlobalsAndUtility {
    ...
    function stakeEnd(uint256 stakeIndex, uint40 stakeIdParam) external {
        ...
        if (g._currentDay >= st._lockedDay) {
            if (prevUnlocked) {
                ...
                if (servedDays > st._stakedDays) {
                    ...
                    if (servedDays < MIN_AUTO_STAKE_DAYS) {
                        require(
                            !st._isAutoStake,
                            _getMessage(": Auto-stake still locked")
                        );
                    }
                }
            }
            ...
            /* Deny early-unstake before an auto-stake minimum has been served */
            require(!st._isAutoStake, _getMessage(": Auto-stake still locked"));
    ...
    function _stakeStart(
        ...
        require(
            newStakeShares != 0,
            _getMessage(": newStakedHearts must be at least minimum shareRate")
        );
...
contract UTXOClaimValidation is StakeableToken {
    ...
    function btcAddressIsClaimable(
        ...
        require(
            ...
            _getMessage(": Claim phase has not yet started")
        );
        require(
            day < CLAIM_PHASE_END_DAY,
            _getMessage(": Claim phase has ended")
        );
    ...
    function claimMessageMatchesSignature(
        ...
        require(v >= 27 && v <= 30, _getMessage(": v invalid"));
    ...
    function pubKeyToBtcAddress(
        ...
        */
        ...
        if (compressed) {
            ...
            require(!(nested && bech32), _getMessage(": claimFlags invalid"));
...
contract UTXORedeemableToken is UTXOClaimValidation {
    ...
    function btcAddressClaim(
        ...
        /* Ensure signature matches the claim message containing the Eth address and claimParamHash */
        {
            ...
            require(
                ...
                _getMessage(": Signature mismatch")
            );
        }
        ...
        require(
            ...
            _getMessage(": BTC address balance already claimed")
        );

        /* Ensure BTC address is part of the Merkle tree */
        require(
            _btcAddressIsValid(btcAddr, rawSatoshis, proof),
            _getMessage(": BTC address or balance unknown")
        );
    ...
    function _satoshisClaim(
        ...
        require(
            ...
            _getMessage(": CHK: _claimedBtcAddrCount")
        );
        ...
        )
    {
        ...
        require(
            ...
            _getMessage(": CHK: _claimedSatoshisTotal")
        );
...
contract TransformableToken is UTXORedeemableToken {
    ...
    function xfLobbyEnter(address referrerAddr) external payable {
        ...
        require(
            enterDay < CLAIM_PHASE_END_DAY,
            _getMessage(": Lobbies have ended")
        );
    ...
    function xfLobbyExit(uint256 enterDay, uint256 count) external {
        require(
            enterDay < _currentDay(),
            _getMessage(": Round is not complete")
        );
