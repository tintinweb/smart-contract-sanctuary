...
contract LevelDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("Level_Dividend_Tracker", "Level_Dividend_Tracker", 9) {
    	claimWait = 14400;
...
contract Level is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0xaF1aB5168a0ab365526b78BD3D5347DbE10A0407;
    ...
    constructor() public BEP20("Level", "LVL", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "Level: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "Level: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
