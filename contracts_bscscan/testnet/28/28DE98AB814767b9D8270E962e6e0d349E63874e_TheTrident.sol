...
contract TheTrident is Ownable, Pausable {
    ...
    modifier onlyOperator() {
        require(msg.sender == operatorAddress, "operator only");
        _;
    }
     ...
     * callable by admin
     */
    function claimReserve(uint256 value) external onlyAdmin 
    {
     ...
     * callable by admin
     */
    function rewardUser(address user, uint256 value) external onlyAdmin 
    {
