...
abstract contract ERC20
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _totalSupply = _totalSupply.sub(amount, "SafeMath-sToken:_burn: totalSupply > burn amount");
...
contract sToken is ERC20Permit, Ownable {
    ...
    function transfer( address to, uint256 value ) public override returns (bool) {
        ...
        _gonBalances[ msg.sender ] = _gonBalances[ msg.sender ].sub( gonValue, "SafeMath-sToken:transfer: _gonBalances[ msg.sender ] < value.mul( _gonsPerFragment )");
    ...
    function transferFrom( address from, address to, uint256 value ) public override returns ( bool ) {
       _allowedValue[ from ][ msg.sender ] = _allowedValue[ from ][ msg.sender ].sub( value, "SafeMath-sToken:transferFrom: _allowedValue[ from ][ msg.sender ] < value");
       emit Approval( from, msg.sender,  _allowedValue[ from ][ msg.sender ] );

        uint256 gonValue = gonsForBalance( value );
        _gonBalances[ from ] = _gonBalances[from].sub( gonValue, "SafeMath-sToken:transferFrom: _gonBalances[from] < gonsForBalance( value )");
        _gonBalances[ to ] = _gonBalances[to].add( gonValue );
