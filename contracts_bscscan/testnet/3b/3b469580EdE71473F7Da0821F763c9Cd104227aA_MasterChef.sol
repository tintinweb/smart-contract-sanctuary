...
contract MasterChef is Auth, ReentrancyGuard {
    ...
    address public devAddress = 0xE2a108a22eE861163018eF2644690Fa9A187e801;
    address public feeAddress = 0xE2a108a22eE861163018eF2644690Fa9A187e801;
    ...
    uint256 public totalEpicHeroInPools = 0;
    ...
    function deposit(uint256 _pid, uint256 _amount, address _referrer) public nonReentrant {
        ...
        if (_amount > 0) {
            ...
            if (pool.depositFeeBP > 0) {
                ...
                if (address(pool.lpToken) == address(epicHero)) {
                    totalEpicHeroInPools = totalEpicHeroInPools.add(_amount).sub(depositFee);
                }
            } else {
                ...
                if (address(pool.lpToken) == address(epicHero)) {
                    totalEpicHeroInPools = totalEpicHeroInPools.add(_amount);
                }
            }
        }
    ...
    function withdraw(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        if (_amount > 0) {
            ...
            if (address(pool.lpToken) == address(epicHero)) {
                totalEpicHeroInPools = totalEpicHeroInPools.sub(_amount);
            }
    ...
    function emergencyWithdraw(uint256 _pid) public nonReentrant {
        ...
        if (address(pool.lpToken) == address(epicHero)) {
            totalEpicHeroInPools = totalEpicHeroInPools.sub(amount);
        }
    ...
    function setReferralRate(uint16 _referralRate) public onlyOwner {
        require(_referralRate <= MAXIMUM_FEE_RATE, "Invalid referralRate");
