...
contract BASEToken is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 99000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 99 * 10**5 * 10**9; 
    
    address payable public communityAddress = 0x0D6A519dF6f6D1f036967B12d6541E48EEC3447A; // Community Address
