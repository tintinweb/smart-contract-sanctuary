...
contract MetaStation is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5c9a7b1022aeE202B7327BD46A23b76495793600); // 
    ...
    uint256 public _maxTxAmount = 300000 * 10**1 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 30000 * 10**1 * 10**9;
    uint256 private numTokensSellToAddToBuyback = 70000 * 10**1 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100000 * 10**1 * 10**9;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 10000000 * 10**1 * 10**9;
    }
