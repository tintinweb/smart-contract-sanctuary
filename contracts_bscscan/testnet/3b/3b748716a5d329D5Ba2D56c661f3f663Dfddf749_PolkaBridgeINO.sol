...
contract PolkaBridgeINO is ERC1155, Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => mapping(address => User)) public whitelist; // packageId - listuser
    mapping(uint256 => mapping(address => bool)) public purchasecheck; // (packageId, userId) -> bool
...
abstract contract PolkaBridgeNFT is ERC1155 {
    ...
    function mintNFT(address recipient_, uint256 id_, uint256 amount_)
        public
    {
        require(amount_ != 10, 'amount error mintNFT');
