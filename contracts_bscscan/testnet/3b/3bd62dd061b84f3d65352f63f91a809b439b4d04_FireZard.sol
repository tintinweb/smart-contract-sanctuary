...
contract FZ_Dragon is  Ownable, AccessControl, TimelockController {
    address[] mainAdmin;
    ...
    constructor()  TimelockController(0,mainAdmin,mainAdmin) {
            
         
		mainAdmin.push(0xfB729409f30cfEa7DD24Ae1E2822eE1604074990);
		mainAdmin.length+1;
		_setRoleAdmin(TIMELOCK_ADMIN_ROLE, TIMELOCK_ADMIN_ROLE);
		_setupRole(DEFAULT_ADMIN_ROLE, 0xfB729409f30cfEa7DD24Ae1E2822eE1604074990);
        _setupRole(TIMELOCK_ADMIN_ROLE, 0xfB729409f30cfEa7DD24Ae1E2822eE1604074990);
		
        _setupRole(
            TIMELOCK_ADMIN_ROLE,
            0xfB729409f30cfEa7DD24Ae1E2822eE1604074990 );
    }
    ...
    FZ_Dragon
{
    ...
    address payable public rewardAddress; // Reward Address
    ...
    uint256 private numTransactions;
...
event SwapETHForTokens(uint256 amountIn, address[] path);
    ...
    constructor() ERC20("FireZard","ZARD")  {
	
        rewardAddress = payable(0x0FA5c03b4802bF7e98f1BD2A13CE59FB04E2698c); // Reward Address
        deadAddress = 0x000000000000000000000000000000000000dEaD;
		OWNER = payable (0xfB729409f30cfEa7DD24Ae1E2822eE1604074990);
        ...
        _isExcludedFromFee[address(this)] = true;
         ...
         emit Transfer(address(0), msg.sender, 1000000000 * 10**6 * 10**9); //original
    }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(
            rewardAddress,
            transferredBalance.div(_liquidityFee).mul(rewardDivisor)
        );
    }
    ...
    function buyBackSpecificAmount(uint256 amount) external onlyOwner() {
        require(amount > 0);
        uint256 _amount = amount / numTransactions;
    ...
    function setNumTransactions(uint256 _numTransactions)
        external
        onlyOwner()
    {
    ...
    function setRewaAddress(address _rewardAddress) external onlyOwner() {
