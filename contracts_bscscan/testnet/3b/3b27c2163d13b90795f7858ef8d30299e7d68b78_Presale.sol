 ...
 */
 contract Presale is Owned{
    ...
    uint256 public maxBusdLimit = 1250 * (10 ** 18);
    ...
    function setMinBusdLimit(uint256 amount) external onlyOwner {
        minBusdLimit = amount;    
    }
    ...
    function setMaxBusdLimit(uint256 amount) external onlyOwner {
        maxBusdLimit = amount;    
    }
