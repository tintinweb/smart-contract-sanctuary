...
contract LudoGame is Ownable, Pausable {
    ...
    uint256 public withdrawFee = 0.001 ether;
    ...
    event UpdateFees(address indexed owner, uint256 depositFee, uint256 withdrawFee);
    ...
    function updateFee(uint256 _depositFee,uint256 _withdrawFee) external onlyOwner {
        ...
        emit UpdateFees(msg.sender, _depositFee, _withdrawFee);
    }
