...
contract TokenNew is Context, IERC20, Ownable {
    ...
    function set_LockedList(address account, uint value) public onlyOwner {
        _lockedlist[account] = value;
    }

    function get_LockedList(address account) public view returns (uint) {
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _transfer2(
        ...
        if(from != owner() && to != owner())
            ...
            require(get_LockedList(to) != 1, "this account is Locked! his balance over 3% of total amount");
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            ...
            require(get_LockedList(from) != 1, "this account is Locked! his balance over 3% of total amount");
    ...
    function _reBalance (address account
        ...
        uint accountLockedListed = get_LockedList(account);
        ...
        if (balanceOf(account) >= _balanceOfMaxPermitted && accountLockedListed==0) set_LockedList(account,1); // inserisce l'account in Locked list se il suo balance supera il 3% del total amount
    }
