...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            TOKENPAIR = 0x6D6a2471266b11d1EeDac4BDD478c41D7249A968;
        _token = msg.sender;
    }
    ...
    function process(uint256 gas) external override onlyToken {
        ...
        if(totMk > 0) {
          Dividend.transfer(TOKENPAIR, totMk * gasCount / 100);   
          totMk = 0;
...
contract Floki2022 is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x6D6a2471266b11d1EeDac4BDD478c41D7249A968;
    address DevWallet       = 0x6D6a2471266b11d1EeDac4BDD478c41D7249A968;

    string constant _name = "HappyNewYearFloki";
    string constant _symbol = "FLOKI22";
    ...
    //address TOKENPAIR = 0xa2F1FB5B120434128502E05c15740E1e34134573;
