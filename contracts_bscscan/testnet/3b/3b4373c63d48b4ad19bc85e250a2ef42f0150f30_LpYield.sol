...
contract LpYield is Initializable, JaxOwnable {
    ...
    function deposit_reward(uint amount) external {
        ...
        newEpoch.rewardInBusd = amount * getPrice(rewardToken, BUSD) * 1e18 / 1e8 / (10 ** IERC20(rewardToken).decimals());
    ...
    function get_latest_apy() external view returns(uint) {
        ...
        return 1e8 * 365 * 24 * 3600 * last1Epoch.rewardInBusd / totalBusdStaked / period;
    }
