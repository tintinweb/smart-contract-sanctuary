...
contract theFeniks is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,address tokenOwner,address _AwardsAddress, address _PlatformAddress, address _LiqiuditeAddress, address _SaleAddress) {
		_NAME = _name;
		_SYMBOL = _symbol;
		_DECIMALS = _decimals;
