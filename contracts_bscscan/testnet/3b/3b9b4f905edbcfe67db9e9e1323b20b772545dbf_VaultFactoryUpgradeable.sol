    ...
    IVaultFactory
{
    ...
    function __VaultFactory_init(address _vaultImpl, address _feeDistributor) public override initializer {
        ...
        setFactoryFees(5 ether, 0 ether, 5 ether);
    }
    ...
    function createVault(
        ...
        onlyOwnerIfPaused(0);
        require(feeDistributor != address(0), "Fee receiver unset");
        require(childImplementation() != address(0), "Vault implementation unset");
    ...
    function setFactoryFees(
        ...
        require(mintFee <= uint64(10 ether), "Cannot > 10 ether");
        require(randomRedeemFee <= uint64(10 ether), "Cannot > 10 ether");
        require(targetRedeemFee <= uint64(10 ether), "Cannot > 10 ether");
    ...
    function disableVaultFees(uint256 vaultId) public virtual override {
        if (msg.sender != owner()) {
            IVault vaultAddr = IVault(vault[vaultId]);
    ...
    function deployVault(
        ...
        VaultUpgradeable(clone).__Vault_init(name, symbol, _assetAddress, is1155, allowAllItems);
        // Manager for configuration.
        VaultUpgradeable(clone).setManager(msg.sender);
        // Owner for administrative functions.
        VaultUpgradeable(clone).transferOwnership(owner());
        return clone;
    }
}
