...
contract Testtoken is ERC20, Ownable {
    ...
    constructor() ERC20("TestToken", "TT")  {
        uniswapV2RouterAddr = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

        address _uniswapV2Router = uniswapV2RouterAddr;

        address _uniswapV2Pair = IUniswapV2Factory(address(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc)).createPair(address(this), address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd));
