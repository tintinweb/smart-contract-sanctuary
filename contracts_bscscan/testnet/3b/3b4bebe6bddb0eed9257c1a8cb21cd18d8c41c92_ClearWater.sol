...
Clear Water 
ticker is $CLEAR
Total supply: 500,000,000,000 which is 500B
The taxes will be the same for buys and sells. 
2% to developers (1% in each of the 2 wallets), 
2% to the charity wallet, 
2% redistribution to holders and 
4% to the LP
...
*/
    constructor() ERC20("Clear Water", "$CLEAR") {
        ...
        CharityRewardWallet = payable(0x5Cea5Cc09E749f1f52eBA56d5F666B7CD770DD4A);
        DeveloperRewardWallet = payable(0xc9802dDfD5039EcEAF6482ACC5339644a9040C28);
