...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        : IDEXRouter(0x98eE2C9C23c5E30F320d5E46e52420056845ed5e); //tesnet
        _token = msg.sender;
    }
...
contract FlokiBeans is IBEP20, Auth {
    ...
    uint256 liquidityFee = 500; // Added to PCS Liquidity
    uint256 buybackFee = 100; // Buyback and Burn
    uint256 reflectionFee = 500; // Goes towards buying reward token and sending to holders
