...
contract PEXOToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    constructor(uint256 initTotalSupply) ERC20("PEXO TOKEN", "PEXO")  {
        tokens = initTotalSupply * (10 ** uint256(decimals()));
        _mint(owner(), tokens);
    }
    ...
    function faucet() public {
        uint256 amount = 1000 * 10 ** uint(decimals());
