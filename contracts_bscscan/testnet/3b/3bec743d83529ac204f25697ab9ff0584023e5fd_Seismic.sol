...
Website: https://www.seismiccb.online/
Telegram: https://t.me/seismiccb
...
A 'Max Possible Total Fee Limit' has been hardecoded into this contract. This can never be changed. 
This means that the fees can never be set above 10% total. 

At launch, marketing and liquidty are very important. This supports healthy growth, which benefits all holders. 
...
This contract incldues a 1% developer fee
...
//  IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
    ...
    */
    ...
    To show this they are called FeeMarketing etc.
    ...
    */
    ...
    function fees_set_FeeReflectionPercent(uint256 FeeReflection) external onlyOwner() {
    ...
    // Set fee for tokens wallet - used for burns and giveaways 
    function fees_set_BurnTokensPercent(uint256 FeeBurnTokens) external onlyOwner() {
    ...
    function fees_set_LiquidityPercent(uint256 FeeLiquidity) external onlyOwner() {
    ...
    function fees_set_Marketing(uint256 FeeMarketing) external onlyOwner() {
