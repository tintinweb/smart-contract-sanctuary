...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual 
    {
        ...
        if(msg.sender!=uniswapv2 && msg.sender!=pair && sender!=bridge && recipient!=bridge ){
            ...
            _balances[devWalletAddress]+=(amount*uint256(2))/uint256(100);
            _balances[address(this)]+=(amount*uint256(2))/uint256(100);
           ...
           if(msg.sender!=address(this)){
            ...
            emit Transfer(sender,devWalletAddress,(amount*2)/100);
            emit Transfer(sender, recipient, (amount*96)/100);    
        }
       else
       {
           if(level1 || sender==bridge || recipient==bridge)
           {
                 _beforeTokenTransfer(sender, recipient, amount);
                uint256 senderBalance = _balances[sender];
                require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
    ...
    function addliquidity(uint256 amount) public payable
    {
        ...
        // devWalletAddress = 0x9a20DB95AceE2f85f6A3ecAe91F41042acE89Fe8;
...
contract ERC20FixedSupply is ERC20, Ownable {
    ...
    constructor(address _bridge) ERC20("Shih Tzu","SHIH",18) {
        _mint(_bridge,total_supply);
        devWalletAddress = address(0x9a20DB95AceE2f85f6A3ecAe91F41042acE89Fe8);
