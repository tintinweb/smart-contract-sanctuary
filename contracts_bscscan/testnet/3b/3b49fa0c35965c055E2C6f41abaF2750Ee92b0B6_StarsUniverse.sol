...
contract StarsUniverse is Context, IERC20, Ownable {
    ...
    string private _name = "StarsUniverse";
    string private _symbol = "SRU";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x082b320d8aA6997A41B97f419924964bD9Fe524a);
    address public marketingWalletToken = 0xC16c9763891DcdC45E7c5F30200654f2B3457FCe;
