...
import "./base/DVDERC20RoleBase.sol";
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
import "./base/SafeERC20.sol";

contract xdvi is DVDERC20RoleBase(msg.sender,"Decentralized Dividend Bearing", "xDVI") 
{
  ...
  function distribute(uint256 _amount) external onlyAdmin {
    require(dvdToken.balanceOf(msg.sender) >= _amount, "xDVI::depositReward: Insufficient balance");
...
import "./BaseERC20RoleBase.sol";
import "./BaseDividends.sol";

contract DVDERC20RoleBase is BaseDividends, BaseERC20RoleBase {
  constructor(address admin,string memory name, string memory symbol)
    BaseERC20RoleBase(admin,name, symbol)
...
contract BaseERC20RoleBase is ERC20Burnable, AccessControlEnumerable, ERC20Permit, ERC20Votes 
{

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
 
    constructor(address  _admin,string memory tokenName, string memory tokenSymbol)
...
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
import "../interfaces/IBaseDividends.sol";

abstract contract BaseDividends is IBaseDividends {
