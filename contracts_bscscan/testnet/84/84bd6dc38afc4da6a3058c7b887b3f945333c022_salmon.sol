...
contract salmon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd63B6c65767ae6a370058016e90923f69e038CEB); // Marketing Address
    ...
    string private _name = "salmon";
    string private _symbol = "SAL";
