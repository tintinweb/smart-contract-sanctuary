...
// fixed supply
// ----------------------------------------------------------------------------
contract PEXOToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    constructor() ERC20("Plant Exodus Token", "PEXO")  {
        tokens = 10 ** 9 * 10 ** uint256(decimals()); // 1B
        _mint(owner(), tokens);
    }
    ...
    function getTotalBurnedAmount() external view returns (uint256 _amount) {
