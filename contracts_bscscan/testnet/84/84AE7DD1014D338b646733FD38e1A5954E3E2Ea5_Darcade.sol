...
contract Darcade is ReentrancyGuard, Ownable {
    ...
    */
     ...
     */
    event GameSession(address wallet, uint256 amount, string session);
    ...
    */
     ...
     */
    function resetUserGameSession(string memory gameSessionId) public {
        require(userGameSession[gameSessionId] == _msgSender(), "You must be the owner of this session");
        delete userGameSession[gameSessionId];
        emit SessionComplete(gameSessionId);
    }
