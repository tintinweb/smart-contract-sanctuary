...
contract LuckTomorrow is Context, IERC20, Ownable 
{
    ...
    string private _name = "Luck Tomorrow Coin";
    string private _symbol = "LuckTomorrow";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 6; //holders share
    ...
    address public marketingWallet =  0x5a5821CCFB25E8146d5E9ea4143EAF1bb2E8cc03;  
    ...
    uint256 public _maxTxAmount = 5000000000000000000000 * 10**9; //
    uint256 private numTokensSellToAddToLiquidity = 2500000000000000000 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        if(amtWalletS>0)
        {
           _transferStandard(sender, marketingWallet, amtWalletS);    
        }
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        ...
        _maxTxAmount = _tTotal.mul(maxTxPercent).div(1**2);
    }
