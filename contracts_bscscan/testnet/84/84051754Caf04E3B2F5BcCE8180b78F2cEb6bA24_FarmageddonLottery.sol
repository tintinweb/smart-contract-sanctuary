...
abstract contract FarmageddonLottoKeeper is KeeperCompatibleInterface, Ownable {
    ...
    FarmageddonLottery f = FarmageddonLottery(address(this));
    ...
    function StartKeeper(uint256 _fCurrentLotteryId, uint256 _upKeepTime) external onlyOwner {
        fcurrentLotteryId = _fCurrentLotteryId;
        upKeepTime = _upKeepTime;
        step = 1;
    }
    
    function StopKeeper() external onlyOwner {
        fcurrentLotteryId = 0;
        upKeepTime = 0;
        step = 0;
    }
 ...
 */
contract FarmageddonLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable, FarmageddonLottoKeeper {
