...
contract TEST14 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"TEST1408";
    ...
    constructor(address payable team, address payable marketing) {
        _teamAddress = team;
        _marketingFunds = marketing;
