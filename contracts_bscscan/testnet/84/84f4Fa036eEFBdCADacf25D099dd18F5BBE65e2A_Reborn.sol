...
contract Reborn is Ownable, ReentrancyGuard{
    ...
    event StartLife(uint256 min_poolAmount, uint256 max_poolAmount, uint256 ticketAmount, uint256 feeRate);
    event EndLife(uint256 min_poolAmount, uint256 max_poolAmount, uint256 lifeLevel, uint256 feeRate, address userAddress, uint256 tmpAmount);
    ...
    function startLife(uint256 min_poolAmount, uint256 max_poolAmount, uint256 ticketAmount, uint256 feeRate) public nonReentrant {
        ...
        emit StartLife(min_poolAmount, max_poolAmount, ticketAmount, feeRate);
    }


    function endLife(uint256 min_poolAmount, uint256 max_poolAmount, uint256 lifeLevel, uint256 feeRate, address userAddress) public nonReentrant {
        ...
        emit EndLife(min_poolAmount, max_poolAmount, lifeLevel, feeRate, userAddress, tmpAmount);
    }
