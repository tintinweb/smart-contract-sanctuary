...
*/
contract DeHubRewardsV3 is DeHubRewardsUpgradeable {
	...
	*/
	function hasAlreadyClaimed(address holderAddr) public view returns(bool) {
		...
		bool didClaim = lastClaim >= lastCycleResetTimestamp && lastCycleResetTimestamp != 0;
	...
	*/
	function upgradeToV3() public {
		require(version < 3, "DeHubRewards: Already upgraded to version 3");
		version = 3;
