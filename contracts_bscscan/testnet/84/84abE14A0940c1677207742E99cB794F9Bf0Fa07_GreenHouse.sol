...
contract GreenHouse is Ownable {
    ...
    uint256 constant internal _monthlyPoolTimer = 600; // 30 days
    ...
    uint256 constant internal _bonusPoolNewStakeholderTimerAddition = 10;   // 15 minutes
    uint256 constant internal _bonusPoolTimerInitial = 60; // 6 hours
