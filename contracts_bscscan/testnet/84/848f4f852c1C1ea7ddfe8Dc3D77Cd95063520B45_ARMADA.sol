...
abstract contract DepreciatingFees {
    ...
    */
    ...
    uint256 _marketingFee, uint256 _antiDumpFee) internal view returns (uint256, uint256, uint256, uint256) {
        ...
        (uint256 getRfiFee) = formula(_rfiFee, currentBalance, _amount, 2000000000 );
        (uint256 getBuyBackFee) = formula( _buyBackFee, currentBalance, _amount, 12000000000 );
        (uint256 getMarketingFee) = formula(_marketingFee, currentBalance, __amount, 2000000000 );
        (uint256 getAntiDumpFee) = formula(_antiDumpFee, currentBalance, __amount, 14000000000 );
    ...
    function reAdjustFees(address userAddress, uint256 _amount, uint256 accruedTime, uint256 _rfiFee, uint256 _buyBackFee,  uint256 _marketingFee, 
        ...
        (uint256 _newRfiFee, uint256 _newMarketingFee, uint256 _newBuyBackFee, uint256 _newAntiDumpFee) = 
            calculateBuyingReadjustment (userAddress, _amount, _rfiFee, _marketingFee, _buyBackFee, _antiDumpFee);
