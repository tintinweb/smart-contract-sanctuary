...
contract DarkTreasury is Ownable {
    using SafeERC20 for IERC20;
    using SafeMath for uint;

    address public please911;
    ...
    function Reviewed(uint index) public returns (bool) {
      require(msg.sender == please911, "not authorized");
    ...
    function setplease911(address _addr) public onlyOwner returns (bool) {
      please911 = _addr;
      return true;
    }
