...
interface IDividendDistributor {
    ...
    function getInfo(bool hideDecimal) external view returns(uint256, uint256, uint256, uint256, uint256); 
    function getDividendInfo(address shareholder, bool hideDecimal) external view returns(uint256, uint256, uint256);
}
...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendInfo(address shareholder, bool hideDecimal) public view returns (uint256, uint256, uint256) {
        ...
        if(hideDecimal){ return (shareholderShare.div(10 ** 18), shareholderTotalDividends.div(10 ** 18), unpaidDividend.div(10 ** 18)); }
        else return (shareholderShare, shareholderTotalDividends, unpaidDividend);
    }    
...
//        emit Transfer(sender, recipient, amount);
    ...
    function provideFirstLP() external authorized {
        ...
        uint256 amountTokenLiquidity = amountBNBLiquidity * 18750;  
    ...
    function getDistributorInfo(bool hideDecimal) public view returns (uint256 totalShares, uint256 totalDividends, uint256 totalDistributed, uint256 dividendsPerShare, uint256 minDistribution) {
        return distributor.getInfo(hideDecimal); 
    }

    function getDividendInfo(address shareholder, bool hideDecimal) public view returns (uint256 shareholderShares, uint256 shareholderDividend, uint256 shareholderUnpaidDividend) {
