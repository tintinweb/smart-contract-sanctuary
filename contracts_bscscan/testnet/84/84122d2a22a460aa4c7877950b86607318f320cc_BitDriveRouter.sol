            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"46f071d880b97a238fa6f233d5fa99b3399beada1b84e5e224a03bffe73de3cd" // init code hash
                    )
                )
            )
        );
...
contract BitDriveRouter is IUniswapV2Router02 {
    ...
    constructor(
        ...
        bnbPair.push(_medaxToken);
        bnbPair.push(_busdAddress);

        busdPair.push(_medaxToken);
        busdPair.push(_bnbAddress);
    }
