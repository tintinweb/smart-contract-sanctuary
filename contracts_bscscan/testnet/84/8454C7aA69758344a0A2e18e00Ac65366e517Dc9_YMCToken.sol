...
contract YMCToken is Context, IERC20, Ownable {
    ...
    string private _name = "CaroLine_TestFree";
    ...
    constructor() {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x97cD6BE415C95F8faCf9FC383fA1E8eeE75334e2);
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        require(to != address(0), "ERC20: transfer to the zero address");
            ...
            if (swapSwitsh && !swapping && canSwap) {
                swapping = true;
