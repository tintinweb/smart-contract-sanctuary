...
contract Flashswap {
    ...
    function _getAmountOutByPair(
        ...
        uint256 amountOut = UniswapV2Library.getAmountOut(
            _amountWBNB,
            token0isWbnb ? token0Reserves : token1Reserves, // reserveIn -> wbnb
    ...
    function check(
        address _token, // example: BUSD
        uint256 _amountWBNBPay, // example: BNB => 10 * 1e18
        address _WBNB, // example: BNB
