...
contract ALMASCoin is Context, IERC20, Ownable, Versionable {
    using SafeMath for uint256;
    ...
    uint256 private _tTotal = 10 * 10**9 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ALMAS COIN";
    string private _symbol = "ALMAS";
