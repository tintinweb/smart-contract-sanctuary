...
contract Mintable {
    ...
    address private _MINECONTRACT;
    address payable owner;
    
   
    
    modifier onlyStaker() {
        require(msg.sender == _FARMCONTRACT || msg.sender == _STAKECONTRACT || msg.sender == _MINECONTRACT, "Caller does not have the permission");
        _;
    }
...
contract TKR is Context, IBEP20, Mintable {
    ...
    constructor (address payable _Owner) {
        ...
        _mint(deployer, 10000000e8); //Initial supply 
     }
