...
//KMD LIQUIDITY 
contract DarkMatterLaunchpadPresale is Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        rewardTokenCount = tokenTarget.div(weiTarget);
    }
    ...
    function claimableAmount(address user) external view returns (uint256) {
        return claimable[user].mul(rewardTokenCount);
    }
    ...
    function claim() external {
        ...
        uint256 amount = claimable[msg.sender].mul(rewardTokenCount);
    ...
    function buy() public payable {
        ...
        rewardTokenCount = 0.0363636 ether; // 27.5 tokens per BNB
        
        uint256 amount = msg.value.mul(rewardTokenCount);
