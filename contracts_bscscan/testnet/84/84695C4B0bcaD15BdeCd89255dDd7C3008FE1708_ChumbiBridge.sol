...
interface IChumbiToken {
    /**
     * @dev Deposits the CHMB Tokens to the user adrress.
     */
    function deposit(address user, bytes calldata depositData) external;
}

// Chumbi Bridge
contract ChumbiBridge is ReentrancyGuard, NativeMetaTransaction {
    IChumbiToken public immutable token;

    constructor(IChumbiToken _token) {
        _initializeEIP712("ChumbiBridge", "1");
        token = _token;
    }
