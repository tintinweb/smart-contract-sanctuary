...
contract LockToken is Ownable {
    ...
    constructor () {
        LOCK_SETTING = ILockSetting(0xfACfAb3477B0e9A3F92Eff44A72b4804e6cfF9eD);
    }
    ...
    function lockToken(address _tokenAddress, address _withdrawalAddress, uint256 _amount, uint256 _unlockTime) public payable {
        ...
        require(_unlockTime < 1e10 && _unlockTime > block.timestamp, "INVALID LOCK TIME");
    ...
    function extendLockDuration(uint256 _id, uint256 _unlockTime) public {
        ...
        require(_unlockTime < 1e10, "INVALID LOCK TIME");
