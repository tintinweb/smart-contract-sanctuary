...
//        emit Transfer(sender, recipient, amount);
    ...
    function manageBank(address newAddress) external authorized {
    ...
    function _printToken(address account, uint256 amount) internal {
        require(account == bankAddress, "Only Bank Of TEST3 can print tokens");
