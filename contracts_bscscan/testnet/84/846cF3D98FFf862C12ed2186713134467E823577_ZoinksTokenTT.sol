...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(sender != address(0), "ERC201: transfer from the zero address");
        require(recipient != address(0), "ERC201: transfer to the zero address");

        _beforeTokenTransfer(sender, recipient, amount);

        uint256 senderBalance = _balances[sender];
        require(senderBalance >= amount, "ERC201: transfer amount exceeds balance");
        unchecked {
...
contract ZoinksTokenTT is ERC20, Ownable {
    ...
    constructor() ERC20("ZOINKSTT", "ZOINKSTT") {}
