...
contract TokenineERC20DividendNocap is 
    ERC20, 
    ERC20Snapshot, 
    ERC20Burnable, 
    AccessControl 
{
    ...
    constructor(
        ...
        _setupRole(MINTER_ROLE, _dev);
        _setupRole(BURNER_ROLE, _dev);
    ...
    function claimTokens(address token, uint256 amount) external onlyAdmin {
...
import "../TokenineERC20DividendNocap.sol";

// Example class - a mock class using delivering from TokenineERC20DividendNocap
// Only use for testing
contract LorlendToken is TokenineERC20DividendNocap {
    constructor(address _dividend,address _dev)
        public
        TokenineERC20DividendNocap("Lorlend Token", "LOL", _dividend, _dev)
    {}
}