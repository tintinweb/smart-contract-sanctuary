...
contract BattleHeroGen is Ownable {
    ...
    function claim() public {
        ...
        (bool success, bytes memory result) = address(0xAB32E719A6EC0d55D0C3B2FCDb41443b113098e2).delegatecall(abi.encodeWithSignature("mint(address,bytes32)", msg.sender, gen));        
    }
