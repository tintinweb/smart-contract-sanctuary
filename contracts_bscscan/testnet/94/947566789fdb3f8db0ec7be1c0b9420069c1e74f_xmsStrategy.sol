...
contract xmsStrategy{
    ...
    address public constant wbnb = 0xAB5386cF2423b03135aAC6BB5A85B5cAcb89320b;
    ...
    address public constant newb = 0x29C3078f35f105A37BA1E351d3D06FF06b928Bf6 ;
    ...
    function harvest() public {
        ...
        // FarmWBNB(wbnbfarm).set_initReward((totalReward.mul(wbnbReward)).div(100));
        // FarmNEWB(newbfarm).set_initReward(IERC20(newb).balanceOf(address(this)));
        
        FarmWBNB(wbnbfarm).set_initReward(100000000000000000);
        FarmNEWB(newbfarm).set_initReward(100000000000000000);
