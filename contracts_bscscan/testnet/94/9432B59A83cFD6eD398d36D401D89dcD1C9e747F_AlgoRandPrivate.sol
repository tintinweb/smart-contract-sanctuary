...
contract AlgoRandPrivate is Owned {
    using SafeMath for uint256;
    
    bool public isPrivateSaleOpen;
    
    address public tokenAddress = 0xfbef60dfFf8555a6D6BEDD47EeF28D109D72D820;
    uint256 public tokenDecimals = 18;
    
    uint256 public tokenRatePerEth = 31800000000000000000000;
    uint256 public rateDecimals = 0;
    
    uint256 public minEthLimit = 1e17; // 0.1 BNB
    uint256 public maxEthLimit = 4e17; // 0.4 BNB
    ...
    function startPrivateSale(uint256 numberOfdays) external onlyOwner {
        require(!isPrivateSaleOpen, "PrivateSale is open");
    ...
    function closePrivateSale() external onlyOwner {
        require(isPrivateSaleOpen, "PrivateSale is not open yet or ended.");
    ...
    receive() external payable{
        ...
        require(isPrivateSaleOpen, "Private is not open.");
        require(
