...
contract Admin is Initializable, Governance, WJXN_VRP, WJAX_JUSD, JUSD_JINR {
    ...
    function get_pair_address() public view returns(address) {
        address factory = 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73;
        address token0 = 0x208B7F070763E6F3D98EdbA377dfE59B3e580Ff3; // change me!
        address token1 = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // change me!
...
contract WJXN_VRP is Governance{
    ...
    function withdraw_wjxn(uint _amount) public onlyGovernor isActive {
    ...
    function exchange_vrp_wjxn(uint vrp_amount) public isActive {
        ...
        uint vrp_wjxn_ratio = wjxn.balanceOf(address(this)) / vrp.totalSupply();
        if( vrp_wjxn_ratio == 0 ){
            vrp_wjxn_ratio = 1;
        }
        uint wjxn_to_be_withdrawn = vrp_amount * vrp_wjxn_ratio;
...
contract Governance {
    ...
    function validate_wjxn_withdrawal() public view onlyAdmin returns (bool) {
        return true;
    }

    function validate_wjax_withdrawal() public view onlyAdmin returns (bool) {
        return true;
    }

    function validate_conversion_rates() public view onlyAdmin returns (bool) {
        return true;
    }
