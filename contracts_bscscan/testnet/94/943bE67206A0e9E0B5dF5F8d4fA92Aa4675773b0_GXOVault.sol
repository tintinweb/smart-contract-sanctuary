...
contract GXOVault is Ownable, Pausable {
    ...
    IERC20 public immutable receiptToken; // PIE token
    ...
    /**
     * @notice Constructor
     * @param _gxoToken: Cake token contract
     * @param _pieToken: Syrup token contract
    ...
    /**
     * @notice Reinvests CAKE tokens into MasterCat
     * @dev Only possible when contract not paused.
     */
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterCat(masterCat).pendingCake(0, address(this));
