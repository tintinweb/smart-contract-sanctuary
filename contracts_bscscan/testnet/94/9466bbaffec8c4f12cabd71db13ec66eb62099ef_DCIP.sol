...
contract DCIP is Context, IBEP20, Ownable {
    ...
    address public burnAddress = 0x06B0E46A80393E45F40F7b0bA9c9799235335845;
    ...
    function setMaxTransferAmount( uint256 _limit) public onlyOwner(){
        _maxTxAmount=_limit;
    }
        ...
        returns (uint256)
    {
        if (_heldLessThan24Hours) {
            return _amount.mul(_taxFee + 2).div(10**2);
        } else {
