...
contract KAKACard721 is RandomGenerator, Ownable, ERC721Enumerable, ERC721URIStorage{
    ...
    function setTokenURI(uint tokenId_, string memory tokenURI_) public onlyOwner returns (bool) {
    ...
    function mint(address player_, uint cardId_, bool uriInTokenId_) public returns (uint256) {
        ...
        if (uriInTokenId_) {
            _setTokenURI(tokenId, tokenId.toHexString());
        }
    ...
    function mintWithId (address player_, uint id_, uint tokenId_, bool uriInTokenId_) public returns (bool) {
        ...
        if (uriInTokenId_) {
            _setTokenURI(tokenId_, tokenId_.toHexString());
        }
