    ...
    function withdrawTokenToOwner(address tokenAddress, uint256 amount) external onlyOwner {
        ...
        if (tokenAddress == address(this)) {
            ...
            if (remainingTokens < tokensToSwap) {
                ...
                _liquidityTokensToSwap = remainingTokens.mul(liquidityRate);
                _marketingTokensToSwap = remainingTokens.mul(marketingRate);
                _charityTokensToSwap = remainingTokens.mul(charityRate);
            }
        }
