...
contract Mundo is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0x31592185dd6aFEb79C91bbf3Ff33691CE13b18E0); // Dev Wallet Address
    address payable public marketingAddress = payable(0xc7a7cCa73A12B604753d306cd3908D4eC06A49bd); // Marketing Wallet Address
    address payable public p2eAddress = payable(0xCBF0F042595612764c2a719546cF7a62808a2CA3); // p2e Wallet Address
    ...
    string private _name = "Mundo";
    string private _symbol = "MUNDO";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 3; // reflections for holders
    uint256 private _defaultTaxFee = _taxFee;
    uint256 public _liquidityFee = 7; // total fee = liquidity fee + dev fee + marketing fee + p2e fee
    uint256 private _defaultLiquidityFee = _liquidityFee;
    
    uint256 public teamDivisor = 4; //dev fee + marketing fee + p2e fee
    
    uint256 public _maxSellCount = 5;
    uint256 public _maxTxAmount = 2000000 * 10**9; // Limit transfer amount for block big whales
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Send to P2E address
        transferToAddressETH(p2eAddress, teamBNB.div(2));  // 2% to p2e address
        // Send to Marketing address
        transferToAddressETH(marketingAddress, teamBNB.div(4));  // 1% to Marketing
        // Send to Game Dev address
    ...
    function setP2EAddress(address _p2eAddress) external onlyOwner() {
        p2eAddress = payable(_p2eAddress);
    }
