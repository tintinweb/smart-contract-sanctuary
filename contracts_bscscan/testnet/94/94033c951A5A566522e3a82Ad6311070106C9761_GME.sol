...
contract GME is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    constructor (address payable charityWalletAddress, address router) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       // sendBNBToMarketing(portionForFees.div(3));
        ...
        emit SwapAndLiquify(halfOfLiquify, 0, otherHalfOfLiquify);
    }
