...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
   ...
   */
    ...
    function updatetokenURI () internal {
    _tokenURI = TokenURI;
    }
    /**
...
contract IronDoge1 is ERC721, Ownable {
   ...
   constructor(string memory URI) public ERC721("Iron Doge Vol.1","IRONDOGE1") {
        setURI(URI);
    ...
    event CreateMint(uint256 indexed id);
    ...
    function buy(uint _id) external payable {
        ...
        _trade(_id);
        emit Purchase(_previousOwner, _newOwner, PRICE, _id);
    }
    ...
    function _trade(uint _id) internal {
        ...
        // 2.5% commission cut
        uint _commissionValue = PRICE / 40 ;
        uint _sellerValue = PRICE - _commissionValue;
