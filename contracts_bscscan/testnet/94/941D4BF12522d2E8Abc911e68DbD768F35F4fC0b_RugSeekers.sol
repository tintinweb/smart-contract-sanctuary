...
contract RugSeekers is IERC20, Context, Ownable {
    ...
    uint256 totalFeeBuys = 1600;
    uint256 feeDenominator = 10000;
    // receiving addresses
    address public autoLiquidityReceiver;
    // to be replaced with Gnosis V2 BSC MultiSignature Wallet
    address public ScamSeekersFeeReceiver = 0xE920e4ef59db8ab780B9972C2e5b635272DFdb84 ;
    // to be replaced with Gnosis V2 BSC MultiSignature Wallet
    address public marketingFeeReceiver = 0x6199B759e278A51C514F8c57Fd54eb114ff3fe73 ;
    ...
    uint256 autoBuybackAmount = 1 * 10**9;
    ...
    /**
     *  Swaps DyorVault for BNB if threshold is reached and the swap is enabled
    ...
    function swapBack() internal swapping {
        ...
        // how much bnb is sent to liquidity, reflections, and marketing and ScamSeekers
    ...
    function transferToDistributorAndMarketing(uint256 distributorBNB, uint256 marketingBNB, uint256 ScamSeekersBNB ) internal {
        ...
        if (allowTransferToMarketing) {
            ...
            if (successful) {
                totalBNBMarketing = totalBNBMarketing.add(marketingBNB).add(ScamSeekersBNB);
            }
        }
    }
    ...
    /** Sets Various Fees */
    function setFees(uint256 _ScamSeekersFee, uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        ScamSeekersFee = _ScamSeekersFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFeeSells = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee).add(ScamSeekersFee);
     ...
     */ 
    function triggerSeekBuyback(uint256 amount) public onlyOwner {
