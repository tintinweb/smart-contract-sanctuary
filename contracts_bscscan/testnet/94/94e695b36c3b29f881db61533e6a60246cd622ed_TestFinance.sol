...
contract TestFinance is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = 0xC80D209aaa0505Be768fA9c5eE77147ce961aee3;
    address payable public lotteryAddress1 = 0x3f3ab8b9cC2E30F050De4ff75b8a7E91734A1332;
    address payable public lotteryAddress2 = 0x1ab4C5d8CdFC61591370eD2796f2f0eA3cE8636d;
    ...
    function totalBNB() public view returns (uint256) {
        return _tLotteryTotal;  // 18 decimals!
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 lotteryTransfer = (address(this).balance).div(3);
        
        TransferLotteryBNB(marketingAddress, lotteryTransfer); 
        TransferLotteryBNB(lotteryAddress1, lotteryTransfer);
        TransferLotteryBNB(lotteryAddress2, lotteryTransfer);
        
        uint256 afterTransferBalance = address(this).balance;
        _tLotteryTotal = _tLotteryTotal.add(beforeTransferBalance.sub(afterTransferBalance));
    ...
    function _setLotteryFeePercent(uint256 LotteryFee) external onlyOwner() {
    ...
    function setLotteryAddress1(address payable lottery1) external onlyOwner() {
        lotteryAddress1 = lottery1;
    }
    
    function setLotteryAddress2(address payable lottery2) external onlyOwner() {
        lotteryAddress2 = lottery2;
    }
    ...
    function TransferLotteryBNB(address payable recipient, uint256 amount) private {
