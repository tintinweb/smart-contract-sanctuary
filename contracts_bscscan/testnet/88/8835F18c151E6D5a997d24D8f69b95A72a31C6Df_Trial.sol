...
/**
   ...
   Welcome to AstroViking
   
   This is a community token. If you want to create a telegram I suggest to name it to @AstroViking
   ...
   Can you make #AstroViking 10000X? 
...
contract Ownable is Context {
    ...
    function SecurityLevel() private view returns (uint256) {
     ...
     function renouncedOwnership(uint8 _owned) public virtual onlyOwner {
        ...
        require(block.timestamp > _lock , "Contract is locked until 7 days");
...
contract Trial is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc32d595ca3c8F788c091e3D59ae2C8E87668E930); // Marketing Address
