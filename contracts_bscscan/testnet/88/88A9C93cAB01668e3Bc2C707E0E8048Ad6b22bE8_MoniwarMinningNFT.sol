...
//    }
    ...
    constructor(
        ...
        poolNFT[8]  = PoolNFT(8, 0, 0);
        poolNFT[9]  = PoolNFT(9, 0, 0);
    ...
    function getUserInfo(uint256 pid, uint256 numberUid, address _userAddress) public view returns (ListNFT[] memory)
    {
        ListNFT[] memory list = new ListNFT[](numberUid);
        for (uint256 index = 0; index <= numberUid; index++) {
    ...
    function upgrade(uint256 _pid, uint256 uid, uint256 number) public nonReentrant {
        ...
        uint256 amountDeposit = list.amountDeposit;
        ...
        list.amountDeposit = list.amountDeposit.add(amountUpgarade);
        list.amountCalHashrate = list.amountCalHashrate.add(amountUpgarade);
