...
contract TRYING is Context, IERC20, Ownable {
    ...
    function setTaxreflectionspercent(uint256 reflection) external onlyOwner() {
    ...
    //this method is responsible or taking all fee, if takeFee is true
