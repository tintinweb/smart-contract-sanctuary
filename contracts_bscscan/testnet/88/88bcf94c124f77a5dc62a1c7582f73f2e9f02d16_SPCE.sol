...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // Shiba
...
contract SPCE is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // Shiba
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SPACELON INU";
    string constant _symbol = "SPCE";
    ...
    uint256 public totalFee = 9; //Total Fee
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // max wallet code
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != SpaceWallet && recipient != autoLiquidityReceiver){
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(SpaceWallet).transfer(amountBNB * amountPercentage / 100);
    }
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(SpaceWallet).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _SpaceWallet) external authorized {
