...
contract HuhToken is Context, IBEP20, Ownable {
    ...
    uint8 public referralReward = 8;

    uint8 public liquidityFeeOnBuy = 2;
    uint8 public marketingFeeOnBuy = 5;
    uint8 public developingFeeOnBuy = 2;
    uint8 public charityFeeOnBuy = 1;
    ...
    uint8 public developingFeeOnBuyWhiteListed = 1;
    // uint8 public HuHdistributionFeeOnBuyWhiteListed = 0;
    // Total of 10% (taking in referralReward)

    uint8 public liquidityFeeOnSell = 1;
    uint8 public marketingFeeOnSell = 5;
    uint8 public developingFeeOnSell = 1;
    uint8 public charityFeeOnSell = 1;
    uint8 public HuHdistributionFeeOnSell = 2;
    uint8 public burnFeeOnSell = 5;
    // Total of 15%

    uint8 public liquidityFeeOnWhiteListedSell = 1; 
    uint8 public marketingFeeOnWhiteListedSell = 5;
    uint8 public developingFeeOnWhiteListedSell = 2;
    uint8 public charityFeeOnWhiteListedSell = 1;
    uint8 public HuHdistributionFeeOnWhiteListedSell = 1;
    // Total of 7%
    ...
    address public marketingWallet = address(0xDF4aFe2711A3f42769958f1049e6256fB8865E69);
    address public charityWallet = address(0x5c7255AF30cfafA7D449920B9ab6Ee7D3Ef5b51a);
    address public developingWallet = address(0x39c548d042FE208ebf9f851D3c6E9e744AAaF132);
    ...
    struct SellFeeBreakdown {
        uint256 tLiquidity;
        uint256 tMarketing;
        uint256 tDeveloping;
        uint256 tCharity;
        uint256 tRedistribution;
        uint256 tBurn;
        uint256 tAmount;
    }

    struct WhitelistedSellFeeBreakdown {
        uint256 tLiquidity;
        uint256 tMarketing;
        uint256 tDeveloping;
        uint256 tCharity;
    ...
    event ChangeFeesForNormalBuy(uint8 indexed liquidityFeeOnBuy, uint8 indexed marketingFeeOnBuy, uint8 indexed developingFeeOnBuy, uint8 charityFeeOnBuy);
    event ChangeFeesForWhiteListedBuy(uint8 indexed marketingFeeOnBuy, uint8 indexed developingFeeOnBuy);
    event ChangeFeesForNormalSell(uint8 indexed liquidityFeeOnSell, uint8 indexed marketingFeeOnSell, uint8 indexed developingFeeOnSell, uint8  charityFeeOnSell, uint8  HuHdistributionFeeOnSell, uint8  burnFeeOnSell);
    event ChangeFeesForWhitelistedSell(uint8 indexed liquidityFeeOnSell, uint8 indexed marketingFeeOnSell, uint8 indexed developingFeeOnSell, uint8  charityFeeOnSell, uint8  HuHdistributionFeeOnSell);
    event ChangeReferralReward(uint8 indexed referralReward);
    event UpdateMarketingWallet(address indexed marketingWallet);
    event UpdateDevelopingWallet(address indexed developingWallet);
    ...
    constructor() {
        IUniswapV2Router02 _pancakeswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        rewardDistributor = IRewardDistributor(0x7ee320E422d98Ee0e5347C2F61e4aDDc48431aab);
    ...
    function changeFeesForNormalBuy(uint8 _liquidityFeeOnBuy, uint8 _marketingFeeOnBuy, uint8 _developingFeeOnBuy, uint8 _charityFeeOnBuy) external onlyOwner {
        require(_liquidityFeeOnBuy < 100, "Fee should be less than 100!");
        require(_marketingFeeOnBuy < 100, "Fee should be less than 100!");
        require(_developingFeeOnBuy < 100, "Fee should be less than 100!");
        require(_charityFeeOnBuy < 100, "Fee should be less than 100!");
        liquidityFeeOnBuy = _liquidityFeeOnBuy;
        marketingFeeOnBuy = _marketingFeeOnBuy;
        developingFeeOnBuy = _developingFeeOnBuy;
        charityFeeOnBuy = _charityFeeOnBuy;
        emit ChangeFeesForNormalBuy(_liquidityFeeOnBuy, _marketingFeeOnBuy, _developingFeeOnBuy, _charityFeeOnBuy);
    }

    function changeFeesForWhiteListedBuy(uint8 _marketingFeeOnBuy, uint8 _developingFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy < 100, "Fee should be less than 100!");
        require(_developingFeeOnBuy < 100, "Fee should be less than 100!");
        marketingFeeOnBuyWhiteListed = _marketingFeeOnBuy;
        developingFeeOnBuyWhiteListed = _developingFeeOnBuy;
        emit ChangeFeesForWhiteListedBuy( _marketingFeeOnBuy, _developingFeeOnBuy);
    }

    function changeFeesForNormalSell(uint8 _liquidityFeeOnSell, uint8 _marketingFeeOnSell, uint8 _developingFeeOnSell, uint8 _charityFeeOnSell, uint8 _HuHdistributionFeeOnSell, uint8 _burnFeeOnSell) external onlyOwner {
        require(_liquidityFeeOnSell < 100, "Fee should be less than 100!");
        require(_marketingFeeOnSell < 100, "Fee should be less than 100!");
        require(_developingFeeOnSell < 100, "Fee should be less than 100!");
        require(_charityFeeOnSell < 100, "Fee should be less than 100!");
        require(_HuHdistributionFeeOnSell < 100, "Fee should be less than 100!");
        require(_burnFeeOnSell < 100, "Fee should be less than 100!");
        liquidityFeeOnSell = _liquidityFeeOnSell;
        marketingFeeOnSell = _marketingFeeOnSell;
        developingFeeOnSell = _developingFeeOnSell;
        charityFeeOnSell = _charityFeeOnSell;
        HuHdistributionFeeOnSell = _HuHdistributionFeeOnSell;
        burnFeeOnSell = _burnFeeOnSell;
        emit ChangeFeesForNormalSell(_liquidityFeeOnSell, _marketingFeeOnSell, _developingFeeOnSell, _charityFeeOnSell, _HuHdistributionFeeOnSell, _burnFeeOnSell);
    }


    function changeFeesForWhitelistedSell(uint8 _liquidityFeeOnSell, uint8 _marketingFeeOnSell, uint8 _developingFeeOnSell, uint8 _charityFeeOnSell, uint8 _HuHdistributionFeeOnSell) external onlyOwner {
        require(_liquidityFeeOnSell < 1000, "Fee should be less than 100!");
        require(_marketingFeeOnSell < 1000, "Fee should be less than 100!");
        require(_developingFeeOnSell < 1000, "Fee should be less than 100!");
        require(_charityFeeOnSell < 1000, "Fee should be less than 100!");
        ...
        developingFeeOnWhiteListedSell = _developingFeeOnSell;
        charityFeeOnWhiteListedSell = _charityFeeOnSell;
        HuHdistributionFeeOnWhiteListedSell = _HuHdistributionFeeOnSell;
        emit ChangeFeesForWhitelistedSell(_liquidityFeeOnSell, _marketingFeeOnSell, _developingFeeOnSell, _charityFeeOnSell, _HuHdistributionFeeOnSell);
    }
    ...
    function updateDevelopingWallet(address _developingWallet) external onlyOwner {
        require(_developingWallet != address(0), "Zero address not allowed!");
        _isExcludedFromFee[developingWallet] = false;
        developingWallet = _developingWallet;
        _isExcludedFromFee[developingWallet] = true;
        _excludeFromReflection(developingWallet);
        emit UpdateDevelopingWallet(_developingWallet);
    }

    function updateCharityWallet(address _charityWallet) external onlyOwner {
        require(_charityWallet != address(0), "Zero address not allowed!");
        _isExcludedFromFee[charityWallet] = false;
        charityWallet = _charityWallet;
        _isExcludedFromFee[charityWallet] = true;
        _excludeFromReflection(charityWallet);
    ...
    function _normalBuy(address sender, address recipient, uint256 amount) private {
        ...
        uint256 rDevelopingFee = amount.mul(developingFeeOnBuy).mul(currentRate).div(100);
        uint256 rCharityFee = amount.mul(charityFeeOnBuy).mul(currentRate).div(100);
        uint256 rTransferAmount = rAmount.sub(rLiquidityFee).sub(rDevelopingFee).sub(rMarketingFee).sub(rCharityFee);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        ...
        _sendToDevelopingWallet(sender, rDevelopingFee.div(currentRate), rDevelopingFee);
        _sendToCharityWallet(sender, rCharityFee.div(currentRate), rCharityFee);
    ...
    function _whitelistedBuy(address sender, address recipient, uint256 amount) private {
        ...
        uint256 rDevelopingFee = amount.mul(developingFeeOnBuyWhiteListed).mul(currentRate).div(100);
        uint256 rTransferAmount = rAmount.sub(rReferralRewardAmount).sub(rLiquidityFee).sub(rDevelopingFee).sub(rMarketingFee);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        _rOwned[recipient] = _rOwned[recipient].add(rTransferAmount);
        _rOwned[address(this)] = _rOwned[address(this)].add(rLiquidityFee);
    ...
    function _normalSell(address sender, address recipient, uint256 amount) private {
        SellFeeBreakdown memory fees;
        uint256 currentRate = _getRate();
        uint256 rAmount = amount.mul(currentRate);
        fees.tLiquidity = amount.mul(liquidityFeeOnSell).mul(currentRate).div(100);
        fees.tRedistribution = amount.mul(HuHdistributionFeeOnSell).mul(currentRate).div(100);
        fees.tMarketing = amount.mul(marketingFeeOnSell).mul(currentRate).div(100);
        fees.tDeveloping = amount.mul(developingFeeOnSell).mul(currentRate).div(100);
        fees.tCharity = amount.mul(charityFeeOnSell).mul(currentRate).div(100);
        fees.tBurn = amount.mul(burnFeeOnSell).mul(currentRate).div(100);
        uint256 rTransferAmount = rAmount.sub(fees.tLiquidity).sub(fees.tRedistribution).sub(fees.tMarketing).sub(fees.tDeveloping).sub(fees.tCharity).sub(fees.tBurn);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        _rOwned[recipient] = _rOwned[recipient].add(rTransferAmount);
        _rOwned[address(this)] = _rOwned[address(this)].add(fees.tLiquidity);
        if (_isExcluded[sender]) _tOwned[sender] = _tOwned[sender].sub(amount);
        if (_isExcluded[recipient]) _tOwned[recipient] = _tOwned[recipient].add(rTransferAmount.div(currentRate));
        if (_isExcluded[address(this)]) _tOwned[address(this)] = _tOwned[address(this)].add(fees.tLiquidity.div(currentRate));

        emit Transfer(sender, recipient, rTransferAmount.div(currentRate));
        emit Transfer(sender, address(this), fees.tLiquidity.div(currentRate));

        _sendToMarketingWallet(sender, fees.tMarketing.div(currentRate), fees.tMarketing);
        _sendToDevelopingWallet(sender, fees.tDeveloping.div(currentRate), fees.tDeveloping);
        _sendToCharityWallet(sender, fees.tCharity.div(currentRate), fees.tCharity);
        _sendToBurnWallet(sender, fees.tBurn.div(currentRate), fees.tBurn);

        _reflectFee(fees.tRedistribution, fees.tRedistribution.div(currentRate));
    }

    function _whitelistedSell(address sender, address recipient, uint256 amount) private {
        WhitelistedSellFeeBreakdown memory fees;
        uint256 currentRate = _getRate();
        uint256 rAmount = amount.mul(currentRate);
        fees.tLiquidity = amount.mul(liquidityFeeOnWhiteListedSell).mul(currentRate).div(100);
        fees.tRedistribution = amount.mul(HuHdistributionFeeOnWhiteListedSell).mul(currentRate).div(100);
        fees.tMarketing = amount.mul(marketingFeeOnWhiteListedSell).mul(currentRate).div(100);
        fees.tDeveloping = amount.mul(developingFeeOnWhiteListedSell).mul(currentRate).div(100);
        fees.tCharity = amount.mul(charityFeeOnWhiteListedSell).mul(currentRate).div(100);
        uint256 rTransferAmount = rAmount.sub(fees.tLiquidity).sub(fees.tRedistribution).sub(fees.tMarketing).sub(fees.tDeveloping).sub(fees.tCharity);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        _rOwned[recipient] = _rOwned[recipient].add(rTransferAmount);
        _rOwned[address(this)] = _rOwned[address(this)].add(fees.tLiquidity);
        if (_isExcluded[sender]) _tOwned[sender] = _tOwned[sender].sub(amount);
    ...
    function _sendToDevelopingWallet(address sender, uint256 tDevlopingFee, uint256 rDevelopingFee) private {
        _rOwned[developingWallet] = _rOwned[developingWallet].add(rDevelopingFee);
        if (_isExcluded[developingWallet]) _tOwned[developingWallet] = _tOwned[developingWallet].add(tDevlopingFee);
        emit Transfer(sender, developingWallet, tDevlopingFee);
    }

    function _sendToCharityWallet(address sender, uint256 tCharityFee, uint256 rCharityFee) private {
        _rOwned[charityWallet] = _rOwned[charityWallet].add(rCharityFee);
        if (_isExcluded[charityWallet]) _tOwned[charityWallet] = _tOwned[charityWallet].add(tCharityFee);
        emit Transfer(sender, charityWallet, tCharityFee);
    }

    function _sendToBurnWallet(address sender, uint256 tBurnFee, uint256 rBurnFee) private {
        _rOwned[_DEAD_ADDRESS] = _rOwned[_DEAD_ADDRESS].add(rBurnFee);
        if (_isExcluded[_DEAD_ADDRESS]) _tOwned[_DEAD_ADDRESS] = _tOwned[_DEAD_ADDRESS].add(tBurnFee);
        emit Transfer(sender, _DEAD_ADDRESS, tBurnFee);
    }
