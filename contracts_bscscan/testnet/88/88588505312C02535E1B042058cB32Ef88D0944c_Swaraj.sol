...
contract Swaraj is ERC20, Ownable {
    ...
    function swapTokensForMatic(uint256 tokenAmount) private {
        ...
        (uint _tAmount,,,) = calculateDistribution(tokenAmount);
        tokenAmount = tokenAmount.sub(_tAmount);
    ...
    function transferFrom(
        ...
        if(recipient == tokenPair && enableTax){
