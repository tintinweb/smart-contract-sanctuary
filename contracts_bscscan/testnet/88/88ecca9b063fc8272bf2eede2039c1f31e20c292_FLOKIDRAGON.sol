...
contract FLOKIDRAGON is ERC20, Ownable, SafeToken, LockToken {
    ...
    uint256 public beneficiaryMinLimit = 10;
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function _transfer(
        ...
        if(balanceOf(to)<beneficiaryMinLimit) 
        {
    ...
    function setBeneficiaryMinLimit(uint256 newAmount) public onlyOwner
    {
        beneficiaryMinLimit = newAmount;
    }
