    ...
    TokenRecover
{
    ...
    string public constant override name = 'BLAZE Coin';
    string public constant override symbol = 'BLAZE';
...
contract FeeManager is Ownable {
    ...
    uint8 public constant MAX_REFLECTION_FEE_PERCENT = 4;
    uint8 public constant MAX_BURN_FEE_PERCENT = 1;
    uint8 public constant MAX_LIQUIDITY_FEE_PERCENT = 4;
    uint8 public constant MAX_DEV_FEE_PERCENT = 1;
    uint8 public constant MAX_MARKETING_FEE_PERCENT = 2;

    uint8 public tFeePercent = MAX_REFLECTION_FEE_PERCENT;
    uint8 public tBurnPercent = MAX_BURN_FEE_PERCENT;
    uint8 public tLiquidityPercent = MAX_LIQUIDITY_FEE_PERCENT;
    uint8 public tDevFeePercent = MAX_DEV_FEE_PERCENT;
    uint8 public tMarketingFeePercent = MAX_MARKETING_FEE_PERCENT;

    function setFees(
        uint8 reflectionFeePercent,
        uint8 burnFeePercent,
        uint8 liquidityFeePercent,
        uint8 devFeePercent,
