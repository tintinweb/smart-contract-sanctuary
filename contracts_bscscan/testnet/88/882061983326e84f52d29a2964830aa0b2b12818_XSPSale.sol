...
contract XSPSale is Owned {
    using SafeMath for uint256;
    
    XSwapProtocol public token;
    ...
    uint256 public startSale = 1632528601; //Thu SEP 25 2021 09:00:00 GMT+0000
    uint256 public endSale = 1632615001; //Sun SEP 26 2021 09:00:00 GMT+0000
    uint256 public maxBNB = 2 ether; // It's not ETH, it's BNB - the limit per wallet is 2 BNB
    ...
    constructor(address xspToken) {
        token = XSwapProtocol(xspToken);
...
contract XSwapProtocol is ERC20Interface, Owned {
    using SafeMath for uint256;

    string public symbol = "XSP";
    string public  name = "XSwapProtocol";
    uint8 public decimals = 8;
    uint256 DEC = 10 ** uint256(decimals);
    uint256 public _totalSupply = 1300000000000000000;
