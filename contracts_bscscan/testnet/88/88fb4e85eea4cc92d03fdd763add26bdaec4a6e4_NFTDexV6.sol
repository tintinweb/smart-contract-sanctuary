...
//   address aliaHolder;
  ...
  // revenueShare = IERC20(0x9b6D7b08460e3c2a1f4DFF3B2881a854b4f3b859);
  }
...
//     admin = 0x9b6D7b08460e3c2a1f4DFF3B2881a854b4f3b859;
//     revenueShare = IERC20(0x0160b796792D38B98cd19f718F8dF6c143E5c529);
//     aliaHolder=0xE8359F6a22Dc34632d18D1424a3ff6B85C4228f4;
...
function setOnAuction(address _contract,uint256 _tokenId, uint256 _minPrice, uint256 _endTime) public {
 ...
 function MintAndAuctionNFT(address to, string memory tokenURI,uint256 quantity, bool flag, address _contract, uint256 _minPrice, uint256 _endTime, uint256 royality) public {
    uint256 _tokenId;
      for(uint256 i = 0; i<quantity; i++)
      {
  ...
  function placeBid(uint256 _tokenId, uint256 _amount) public{
  ...
  function claimAuction(uint256 _tokenId, bool awardType) public {
    auctionSell storage temp = _auctionTokens[_tokenId];
    require(temp.endTime < now,"103");
