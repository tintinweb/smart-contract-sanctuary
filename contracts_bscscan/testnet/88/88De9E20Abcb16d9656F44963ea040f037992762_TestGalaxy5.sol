...
contract TestGalaxy5 is Context, IERC20, Ownable {
    ...
    /* Payable fee wallets */
    address payable private _devMarketingAddress = payable(0x39250A02c2460f8870b76c2A2910C56f27b19CdE);
    ...
    constructor() {
        ...
        _isExcludedFromFee[_devMarketingAddress] = true;
    ...
    function removeAllFee() private {
        if (_liquidityFee == 0 && _taxFee == 0 && _devFee == 0) return;
    ...
    function sendETHToFee(uint256 amount) private {
        _devMarketingAddress.transfer(amount);
    }
    ...
    function manualswap() external {
        require(_msgSender() == _devMarketingAddress);
    ...
    function _takedev(uint256 tdev) private {
        ...
        _rOwned[_devMarketingAddress] = _rOwned[_devMarketingAddress].add(rdev);
        if(_isExcludedFromReward[_devMarketingAddress])
            _tOwned[_devMarketingAddress] = _tOwned[_devMarketingAddress].add(tdev);
    }
