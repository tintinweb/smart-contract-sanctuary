...
contract Hearties is PausableToken {
    ...
    uint256 tokenPresalePrice) public {
        ...
        emit Transfer(address(0), tokenOwner, totalSupply/10);
    }
    ...
    function buyTokens() payable public {
        ...
        //uint256 presalePrice = 1200000000000000;
        uint256 tokensBoughtNow = msg.value / presalePrice;
        emit Transfer(address(0), msg.sender, tokensBoughtNow * 10**18);
