...
contract NFT is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) public ERC1155Tradable("NFTname", "NFTsymbol", _proxyRegistryAddress) {
        _setBaseMetadataURI("https://designprogress.in/nftimage/");
    }
