...
contract JBLNFT is ERC721{
    ...
    uint256 public NFT_APY = 1*10**18;
    uint256 public PRICE = 5; //單位3個JBL-Token

    Card[] public cards; // First Item has Index 0
    address public owner;
    mapping (uint256 => string) private _tokenURIs;
    uint256 public maxSupply = 70;
    uint256 public constant START = 1635486272;
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        //string memory tokenURI = "https://jbl.i-recu.com/nft/halloween/ha1.png";
    ...
    function mintBatch(address account, uint256 num) public {
        for(uint tempColorCounter = 0; tempColorCounter < num; tempColorCounter++) 
        {
            mintCard(account);
        }
    } 
