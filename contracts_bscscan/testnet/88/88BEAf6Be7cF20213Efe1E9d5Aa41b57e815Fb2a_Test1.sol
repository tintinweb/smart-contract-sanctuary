...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Shiba: 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D
...
contract Test1 is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = _totalSupply / (100) * (2); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (3); // 3%

    // Cooldown
    bool public BuyCooldownEnabled = true;
    bool public SellCooldownEnabled = true;
    uint8 public BuyCooldownInterval = 5;
    uint8 public SellCooldownInterval = 10;
    ...
    constructor () Auth(msg.sender) {
        ...
        canAddLiquidityBeforeLaunch[pair] = true;
        ...
        autoLiquidityReceiver = 0x8683aeb9325b2E007Fe8d8D6251411Ed38928CaA ;
        marketingFeeReceiver = 0x1dd6477fd4f026104289eB212f8b2e17BfbfFe94 ;
        devFeeReceiver = 0x652d6c58367765f621F953A79C724FC036d105f8 ;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == pair &&
            ...
            require(BuyCooldownTimer[recipient] < block.timestamp);
            BuyCooldownTimer[recipient] = block.timestamp + BuyCooldownInterval;
        }

        if (recipient == pair &&
            SellCooldownEnabled &&
            !isTimelockExempt[sender]) {
            require(SellCooldownTimer[pair] < block.timestamp);
            SellCooldownTimer[pair] = block.timestamp + SellCooldownInterval;
        }
