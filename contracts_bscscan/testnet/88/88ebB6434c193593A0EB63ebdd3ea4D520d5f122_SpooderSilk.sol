...
contract SpooderSilk {
    ...
    function unstake(uint value) public returns(bool) {
        require(balanceOf(msg.sender) >= value, 'Insuficient Balance');
        // approveUnstake(msg.sender, value);
    ...
    function approveUnstake(address spender, uint value) public returns (bool) {
        allowance[stakeWallet][spender] = value;
        emit Approval(stakeWallet, spender, value);
        return true;   
    }
}