...
contract BeyorchDigital is Context, IERC20, Ownable {
    ...
    uint256 public _previousWalletLimit;
    ...
    constructor(string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee, uint256 _lpFee, uint256 _MarketingFee, uint256 maxWalletSize, address routerAddress, address marketingWallet, address tokenOwner) payable {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
        ...
        _previousWalletLimit = _walletLimit;
        ...
        _isMaxWalletExcluded[tokenOwner] = true;
        _isMaxWalletExcluded[address(this)] = true;
        _isMaxWalletExcluded[uniswapV2Pair] = true;
    ...
    function updateUniswapV2Router (address newAddress) external onlyOwner() {
        require(newAddress != address(uniswapV2Router), "BDIG: The router already has that address");
    ...
    function setMaxWalletSize(uint256 walletLimit) external onlyOwner() {
        _walletLimit = walletLimit;
    }
    
    function excludeFromMaxLimit(address account) public onlyOwner() {
        _isMaxWalletExcluded[account] = true;
    }
