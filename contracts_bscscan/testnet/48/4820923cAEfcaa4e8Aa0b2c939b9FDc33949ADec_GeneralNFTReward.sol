...
contract GeneralNFTReward is IPool,Governance {
    ...
    address public _teamWallet = 0x0349296Fa0249fCbd8c193323120F0e2D0220367; // posi-todo: update teamWallet
    address public _rewardPool = 0x51Ee65F9E65AeE1750835947D1608C276fA956fA; // posi-todo: update rewardPool 

    uint256 public constant DURATION = 7 days;
    uint256 public _startTime =  block.timestamp + 365 days;  // todo: set correct time
