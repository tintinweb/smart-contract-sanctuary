...
contract Verify {
   ...
   function isValidData(uint256 _gAmount, string memory _walletAddress, bool _hasFee, bytes memory sig) public view returns(bool){
       bytes32 message = keccak256(abi.encodePacked(_gAmount, _walletAddress, _hasFee));
