...
*
* - Buy Tax: 10% 
* - Sell Tax: 40% for the first 2 hours then declining 10% per hour until reaching 10% after 4 hours
*
* Tax Distribution Breakdown
*
* 40% to Liquidity Pool
* 30% to Moonarch for BabyMoonArch
* 15% to Marketing
* 15% for Buybacks
*
* 
...
contract BabyMOON is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyMoonArch';
    ...
    //DevWallets
    address public TeamWallet=payable(0xfD41c1D0313985795f11827D4161B921Df88785D);
    address public walletTwo=payable(0x4CE471ddf977c5b037099862fACd16d493DE7869);
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimMoonarch(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function claimMoonarch(address addr) private{
        ...
        path[1] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;  // MoonArch
    ...
    function MoonarchWithdraw() public{
        claimMoonarch(msg.sender);
    }
