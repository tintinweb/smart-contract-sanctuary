...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "DumpsterFire";
    string internal constant SYMBOL = "DFIRE";
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 200 ; // 0.5% Max Transaction Fee
     ...
     * See: `Liquifier`
     */
    uint256 internal constant numberOfTokensToSwapToLiquidity = TOTAL_SUPPLY / 400 ; //Liquify is set to 1%
    ...
    address public marketingAddress = 0xf8e51a9D87B04F7A052d23687fd8c8b22fe0546C;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 60, marketingAddress );
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    function _swapAndLiquify(uint256 amount) private lockTheSwap {
        ...
        address marketingAddress = 0xf8e51a9D87B04F7A052d23687fd8c8b22fe0546C;
...
contract DumpsterFire is SafeToken{
