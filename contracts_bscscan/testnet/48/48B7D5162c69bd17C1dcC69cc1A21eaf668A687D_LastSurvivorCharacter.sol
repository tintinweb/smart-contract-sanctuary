...
contract LastSurvivorCharacter is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable {
    ...
    struct CharacterInfo {
        ...
        uint256 characterID;
        uint256 typeID; // 1: Normal, 2 Epic, 3 Lengend
    }
    ...
    function safeMint(address to, uint256 _charId, uint256 _typeID) public onlyWhitelistMinter {
    ...
    function getTokenOwners(address _owner) public view returns (CharacterInfo[] memory) {
