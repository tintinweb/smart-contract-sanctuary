...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 1_000_000_000 * 10**9; // must hold 1 billion tokens which equates to 0.0001% of the total KobeDogeCoin supply
  }
...
// File: contracts/IKobeDogeCoin.sol
...
interface IKobeDogeCoin is IERC20, IERC20Metadata {
...
// File: contracts/KobeDogeCoin.sol
  ...
  ReentrancyGuard
{
  ...
  bool private _sniperProtection = false;
  ...
  constructor(
    ...
    _numTokensSellToAddToLiquidity = (_totalSupply * 95) / 10000;

    _dividendRewardToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    _marketingWallet = 0x14bA8cb960028f3b94Ab5556c23B9F79DA07Ec8D;
    _liquidityWallet = 0x14bA8cb960028f3b94Ab5556c23B9F79DA07Ec8D;
    ...
    setMaxTxPercent(3);
    setMaxWalletPercent(3);
    changeFees(3, 5, 9);

    _setupPancakeswap(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    _setupExclusions();
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'KobeDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'KobeDoge: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'KobeDogeCoin: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      'KobeDogeCoin: The new dividend tracker must be owned by the token contract'
    );
