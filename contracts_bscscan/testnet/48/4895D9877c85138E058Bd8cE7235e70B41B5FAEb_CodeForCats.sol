...
contract CodeForCats is Context {
    ...
    address public catNIPnftAddress = _msgSender(); // CHANGEIT - get the real CatNIP NFT Address
    //////////////////////////// ACCESS CONTROL VARS ////////////////////////////
    ...
    constructor() {
        ...
        isAuthorizedToView[address(this)] = true;       // CHANGEIT - set contract address of CatNIP NFT here
    ...
    function GetCodeForCats() public view returns (uint256) {
        ...
        return GetCurrentBlockTime().add(block.number).add(777).add( ICatNIPNFT(catNIPnftAddress).randomNumber() );
