...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xC7D43F2B51F44f09fBB8a691a0451E8FFCF36c0a) ; //SHIB
...
contract Dogecms is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Dogecms";
    string constant _symbol = "Dodecms";
    ...
    //0x10ED43C718714eb63d5aA57B78B54704E256024E); // MAINNET
    // 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //Tesnet
    address RewardToken = 0xC7D43F2B51F44f09fBB8a691a0451E8FFCF36c0a; //SHIB

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20; // 5 000 000 tokens per tx ;
    uint256 public _walletMax = _totalSupply / 10; // 10% Max Wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x529C0C05dd19b80BCd1bac6EfE3b354eBF34639A;
        marketingWallet = 0xf8d577fe84a08C6c5E5798e008EeC9F10A19e1A2;  // 4 marketingwallet 1 EVEROWN and 1 TEAM
