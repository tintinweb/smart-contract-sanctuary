...
contract TestInu is IBEP20, Ownable
{
    ...
    uint256 public constant InitialSupply= 100000000000000000 * 10**_decimals;//equals 500B tokens
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    //Testnet
    address public TeamWallet=payable(0x8Dc9D7CEEABd1dA2491f652aF06A571D4eCA7630);
    
    //Mainnet - EDIT
    //address public walletTwo=payable(0x653b82418a8Af3D701C9576d889048f3cbe5e0E9);
    //Testnet
    address public walletTwo=payable(0x2b3Cd4e0D95A477f98C369CFD0E639102d82A901);
	...
	uint256 private antiWhale = 10000000000000000 * 10**_decimals;
