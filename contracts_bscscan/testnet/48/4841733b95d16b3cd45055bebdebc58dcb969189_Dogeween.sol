...
contract Dogeween is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x991F895A81f9A30631970629F110547DA7aeD9AF); // Marketing Address
        
    address payable public teamAddress =
        payable(0x5798182A0C0a538194575d78bD2e8B8E91cBa80d); // Team Address
    ...
    string private constant _name = "Dogeween";
    string private constant _symbol = "DGW";
