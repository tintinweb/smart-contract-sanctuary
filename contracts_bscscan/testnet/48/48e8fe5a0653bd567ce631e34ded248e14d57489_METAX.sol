...
contract METAX  is ERC20, Ownable {
    ...
    constructor() ERC20("METAX", "MTX") {
        _mint(msg.sender, 900000000*10**decimals());
        _mint(address(this), 100000000*10**decimals());
        startSale(block.number, 999999999,0 , 100000*10**decimals(), 80000000);
        startAirdrop(block.number,999999999,10000*10**decimals(),15000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
