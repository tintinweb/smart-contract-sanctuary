...
contract TestingOut is Context, IERC20 {
    ...
    string private _name = "TestingOut";
    ...
    uint256 private _buyEcosystemFee = 100;

    uint256 private _sellLiquidityFee = 200;
    uint256 private _sellMarketingFee = 200;
    uint256 private _sellBuyBackFee = 100;
    uint256 private _sellEcosystemFee = 100;
   ...
   // address private _routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    address public burnAddress = 0x368dCcB3b7AFed67e0971E037e9714A28CD82bFE;
    address payable private _marketingWallet = payable(0x9A3d443A17E1eA0bB79cA7327F0541Fd90B1814e);
    address payable private _ecosystemWallet = payable(0x3556c1b084c434a873368349f09aE1651e86f410);
    ...
    function setWallets(address payable newMarketingWallet, address payable newEcosystemWallet) external onlyOwner {
