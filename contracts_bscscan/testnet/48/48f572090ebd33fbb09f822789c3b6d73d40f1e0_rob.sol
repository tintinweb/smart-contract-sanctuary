...
contract rob is ERC20, Ownable {
    ...
    uint256 public totalFees = tokenRewardsFee.add(liquidityFee).add(wallet1Fee).add(wallet2Fee).add(wallet3Fee);
    ...
    constructor() public ERC20("rob", "robb") {
    ...
    function updateFees(uint256 _tokenRewardsFee, uint256 _liquidityFee, uint256 _wallet1Fee, uint256 _wallet2Fee, uint256 _wallet3Fee) external onlyOwner {
        ...
        totalFees = tokenRewardsFee.add(liquidityFee).add(wallet1Fee).add(wallet2Fee);
    }
    //
