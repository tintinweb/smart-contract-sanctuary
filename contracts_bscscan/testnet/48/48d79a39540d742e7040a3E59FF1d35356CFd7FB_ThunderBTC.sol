...
/*
                   WORLD 1ST Reward Reflection Token using the Power of Reward Automatic. 

                                 Just hold ThunderBTC to earn 14% BTC.

                             Each transaction, automatically every 60 minutes.


                                     https://harvest-btc-token.live/
                                    
                TELEGRAM: https://t.me/BTCREWARDTOKEN
                TWITTER: https://twitter.com/reward_btc
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
           ...
           //       0x10ED43C718714eb63d5aA57B78B54704E256024E; MINET
...
contract ThunderBTC is IBEP20, Auth {
    ...
    string constant _name = "PruebaBTC";
    string constant _symbol = "PBTC";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//Mainet
        ...
        address _presaler = 0x6cbd3B2b43E90c569D6ed12d0bce72294Bc625E9;
