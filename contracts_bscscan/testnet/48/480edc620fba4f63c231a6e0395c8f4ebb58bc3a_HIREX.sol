...
contract HIREX is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 2000000 * 10**9; // should be 0.2% percent per transaction
    uint256 public maxWalletToken = 10000000 * 10**9; // 1% max
    uint256 private numTokensSellToAddToLiquidity = 10000 * 10**9; // 0.001% max tx amount will trigger swap and add liquidity
