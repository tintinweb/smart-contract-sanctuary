...
contract UFGrainToken is BEP20 {
    ...
    uint16 public transferTaxRate = 800; // INMUTABLE

    // Treasury rate % of transfer tax. (default 8% x 75% = 6% of total amount).
    uint16 public liquifyRate = 75; // INMUTABLE
    ...
    function openTrading() public onlyOperator {
        ...
        require(tradingOpen != true, "GRAIN: Trading not yet open.");
        tradingOpen = true;
    }
