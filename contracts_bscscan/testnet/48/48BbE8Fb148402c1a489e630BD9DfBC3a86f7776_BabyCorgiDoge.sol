...
contract BabyCorgiDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 940000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Corgi Doge Coin";
    string private _symbol = "BBcorgidoge";
