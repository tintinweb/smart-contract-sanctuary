...
contract minibaseball is Context, IERC20, Ownable {
    ...
    uint256 public _taxmarketingfee = 5;
    address public marketing = 0x4AACF9B6Db942939Ed6ca8b5410cd3bDFD2392d6;
    uint256 private _previoustaxmarketingfee = _taxmarketingfee;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 marketingAmt = amount.mul(_taxmarketingfee).div(100);
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _taxmarketingfee = 5;
        _previoustaxmarketingfee = _taxmarketingfee;
        inSwapAndLiquify = true;
