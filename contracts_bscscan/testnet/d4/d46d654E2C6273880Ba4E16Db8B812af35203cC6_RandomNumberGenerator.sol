...
interface IWagashiSwapLottery {
     ...
     * @param _priceTicketInWagashi: price of a ticket in CAKE
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public wagashiSwapLottery;
     ...
     * @param _seed: seed provided by the WagashiSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == wagashiSwapLottery, "Only WagashiSwapLottery");
    ...
    /**
     * @notice Set the address for the WagashiSwapLottery
     * @param _wagashiSwapLottery: address of the WagashiSwap lottery
     */
    function setLotteryAddress(address _wagashiSwapLottery) external onlyOwner {
        wagashiSwapLottery = _wagashiSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IWagashiSwapLottery(wagashiSwapLottery).viewCurrentLotteryId();
    }
}