...
contract SecuredMoonRat is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "CUTE TIGER TOKEN";
    string private _symbol = "CUTE";
	...
	function setChairtyFeePercent(uint256 marketingFee) external onlyOwner() {
        require(marketingFee < 33);
    ...
    uint256 public rewardCycleBlock = 14 days;
    uint256 public easyRewardCycleBlock = 2 days;
    ...
    function activateContract() public onlyOwner {
        ...
        rewardCycleBlock = 14 days;
        easyRewardCycleBlock = 2 days;
