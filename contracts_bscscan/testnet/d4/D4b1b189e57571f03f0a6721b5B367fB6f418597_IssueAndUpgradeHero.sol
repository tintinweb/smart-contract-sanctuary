...
interface IERC721 is IERC165 {
    ...
    function heroesNumber(uint256 _tokenId) external view returns (HeroesInfo memory);
...
contract IssueAndUpgradeHero is AccessControl {
    ...
    function getTierTest(uint256 _tokenId) public view returns(string memory) {
       return heroesNFT.heroesNumber(_tokenId).tier;
    }
