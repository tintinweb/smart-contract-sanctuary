...
library SafeMath {
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subtraction overflow on presale");
    }
...
contract PresaleBEP20 is Ownable {
    ...
    constructor(
        ...
        catmusk = _catmusk;
        presale = 0x95F38fF1aA62e627dEA8021FD8134D73cF00b2bA;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(1 hours);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.000000000005 ether; // 200,000,000,000 tokens per BNB

        uint256 tokenAmount = msg.value.mul(1e9).div(rewardTokenCount);
        catmusk.transfer(msg.sender, tokenAmount);
