...
contract MCXICO is Initializable, ContextUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    IERC20UpgradeableLockToken public ERC20LockToken;
    ...
    function initialize(
        ...
        address _lockTokenContractAddress,
        ...
        require(
            _lockTokenContractAddress != address(0),
        ...
        ERC20LockToken = IERC20UpgradeableLockToken(_lockTokenContractAddress);
    ...
    function buyICOByBUSD(uint256 amount) external payable {
        ...
        ERC20LockToken.transferLockToken(sender, buyAmountToken);
    }

    event Debug(
        uint256 msgValue,
        int256 busdBNBPrice,
        uint256 totalBUSDConverted,
        uint256 buyAmount
    );
    ...
    function buyICO() external payable {
        ...
        emit Debug(msg.value, busdBNBPrice, totalAmountPerBUSD, buyAmountToken);
    ...
    function claimToken() external onlyAdmin {
        address sender = _msgSender();
        uint256 remainAmountToken = ERC20LockToken.balanceOf(address(this));
        ERC20LockToken.safeTransfer(sender, remainAmountToken);
    }

    function setContractToken(address contractToken) external onlyOwner {
        ERC20LockToken = IERC20UpgradeableLockToken(contractToken);
    }
