...
contract TokenVestingLock is AccessControl  {
    ...
    /**W
    * @dev Add the new amount  of token vesting to address
    */
    function addVesting(address user, uint64 amount) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(unlockTime !=0, "Unlock time has not been set!");
        totalTokenVesting[user]+=amount;
        lastClaimedTime[user]=unlockTime;
    }
    /**
