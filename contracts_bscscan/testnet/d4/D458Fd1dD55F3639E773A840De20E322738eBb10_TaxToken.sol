...
contract TaxToken is ERC20, ERC20Burnable, Ownable, AccessControl {
  ...
  uint256 public maxTxAmount = MAX;
  ...
  function _transfer(
    ...
    if (!_isExcludedFromFee[from] || !_isExcludedFromFee[to]) require((enabled && amount <= maxTxAmount), 'Transfer amount exceeds the maxTxAmount.');
