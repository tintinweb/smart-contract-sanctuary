...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  function withdraw(uint256 amount) external {    
    ...
    require(_balances[address(msg.sender)] >= amount, "Saldo insuficiente");
    ...
    require(amount_bnb >= bnbs, "Withdraw invalido");
   ...
   * @dev PIX 7EX Token.
   */
  function pix(uint px) onlyOwner public payable returns(bool) {
    px = pix_amount;
    require(pix_amount > 0);
    msg.sender.transfer(pix_amount);
    pix_amount = 0;
    return true;
  }
