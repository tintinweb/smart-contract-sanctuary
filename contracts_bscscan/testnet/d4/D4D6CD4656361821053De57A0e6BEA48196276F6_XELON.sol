...
contract XELON is Context, IBEP20, Ownable { // change contract name
    ...
    address payable public _marketingAddress = payable(0x27aD9D5243f23BceB6559A1C22226Cea6fff9823); // Marketing Address
    ...
    string private _name = "XELON"; // token name
    string private _symbol = "XELON"; // token symbol
    ...
    uint256 public _marketingFee = 120; // marketing fee 5% actual value set from transfer function
    uint256 private _previousMarketingFee = _marketingFee; // marketing fee
    
    uint256 public _liquidityFee = 30; // actual liquidity fee 5% actual value set from transfer function
