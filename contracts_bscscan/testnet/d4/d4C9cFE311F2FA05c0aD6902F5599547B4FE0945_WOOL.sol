...
import "./Ownable.sol";
import "./IWOOL.sol";
contract WOOL is ERC20, Ownable,IWOOL {

  // a mapping from an address to whether or not it can mint / burn
  mapping(address => bool) controllers;
  
  constructor() ERC20("WOOL", "WOOL") { }
  uint256 public supplyLimit= 2400000000000000000000000000;
  /**
  ...
  function mint(address to, uint256 amount) external override {
    require(controllers[msg.sender], "Only controllers can mint");
     require(totalSupply()<=2400000000000000000000000000,"supply exceeded the limit");
    uint256 totalAmount=totalSupply()+amount;
    if(totalSupply()<supplyLimit&&totalAmount>=supplyLimit){
      amount=supplyLimit-totalSupply();
    }
    _mint(to, amount);
  }
