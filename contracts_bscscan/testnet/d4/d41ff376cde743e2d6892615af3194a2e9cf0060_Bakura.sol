...
contract Bakura is Context,IBEP20,Ownable {
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, burn, liquidity
        _tokenTransfer(from,to,amount,takeFee);
        _relockLiquidity();
    }

    function burnTokensFromBurnWallet(uint256 amount) external  {
        require(_msgSender() == _burnWallet,"BKR: Only burn wallet can burn the tokens ");
        uint256 currentRate = _getRate();
