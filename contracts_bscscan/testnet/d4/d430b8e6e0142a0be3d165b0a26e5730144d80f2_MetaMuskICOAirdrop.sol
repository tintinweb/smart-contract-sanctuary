...
import "./SafeERC20UpgradeableMetaMusk.sol";

contract MetaMuskICOAirdrop is
    Initializable,
    ContextUpgradeable,
    OwnableUpgradeable
{
    ...
    function buyICOByBUSD(uint256 amount) external payable {
        ...
        tokenMetaMusk.transferLockToken(address(this), sender, buyAmountToken);
    }
    ...
    function claimToken() external onlyOwner {
        ...
        tokenMetaMusk.transfer(sender, remainAmountToken);
    }
    ...
    function _transferAirdrop(address toAddress, uint256 amount) internal {
        ...
        tokenMetaMusk.transferLockToken(address(this), toAddress, amount);
    }
    ...
    function safeTransferLockToken(
        ...
        _callOptionalReturn(
            ...
            abi.encodeWithSelector(
                token.transferLockToken.selector,
                from,
                to,
                value
            )
