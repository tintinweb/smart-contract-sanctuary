...
contract GlitterBug is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9037D532C5bFCAEec8BEf9C56f51FAFa8C1A2123); // Marketing Address
    ...
    string private _name = "GlitterBug";
    string private _symbol = "GLBUG";
