...
contract LotteryPrize is PausableUpgradeable, OwnableUpgradeable {
    ...
    modifier onlyLottery() {
        require(_msgSender() == lottery, "LotteryPrize: No permission");
        _;
    }

    modifier onlyManager() {
        require(_msgSender() == owner() || _msgSender() == lottery, "LotteryPrize: No permission");
        _;
    }

    function initialize(address _lottery, IERC20 _erc20, IERC20 _ALI, IYieldSource _yieldSource) public initializer {
        lottery = _lottery;
        erc20 = _erc20;
        ALI = _ALI;
    ...
    function setTokenPrize(IERC20 _erc20) public onlyLottery {
        _erc20.approve(address(lottery), UINT256_MAX);
    ...
    function _giveAllowances() internal {
        ...
        ALI.approve(lottery, UINT256_MAX);
    }

    function _removeAllowances() internal {
        erc20.approve(address(yieldSource), 0);
        ALI.approve(lottery, 0);
    }
}
