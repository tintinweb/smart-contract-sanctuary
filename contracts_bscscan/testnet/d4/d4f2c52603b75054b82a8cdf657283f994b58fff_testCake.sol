...
//TakeCake Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
 contract testCake is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'testCake';
    string private constant _symbol = 'testCAKE';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100 * 10**6 * 10**_decimals; //equals 100.000 token
    ...
    address public constant TeamWallet=0x3A3ef933BD1e15e3C2667bb9AdB7Bc6975914AC2;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimDOT(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function claimDOT(address addr) private{
        ...
        //path[1] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;  //Binance-Peg CAKE Token
        path[1] = 0x8ED39e59dAF86CD1B598Ac5CC363da896660B35d;  //test
    ...
    function TeamRemoveRemainingBNB() public onlyTeam{
        require(block.timestamp >= _liquidityUnlockTime+1 days, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
