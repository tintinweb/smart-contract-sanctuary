...
contract OlympusBondDepository is Ownable {
    ...
    function initializeBondTerms( 
        ...
        require(!isNativeWrapper || currentDebt() == 0, "Debt must be 0 for initialization" );
        require(isNativeWrapper || terms.controlVariable == 0, "Bonds must be initialized from 0" );
        terms = Terms ({
