...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        _token = msg.sender;
    }
...
contract Shaggy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xC6D71163eD35863f847C3BCC742Db1157BaCD8c4;

    address routerv2 = 0x3f458DCff66c4003f5051D7DE43dEC013c9455E9;

    string constant _name = "Shaggy";
    string constant _symbol = "Shaggy";
