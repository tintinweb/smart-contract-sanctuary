...
contract BusdPump is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSDPUMP";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x47A53921F604B9aAcC33C0A59F5177F62905fB3a;
