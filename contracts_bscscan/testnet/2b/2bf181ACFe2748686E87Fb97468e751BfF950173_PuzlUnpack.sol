...
contract PuzlUnpack is ERC1155, Ownable {
    ...
    function makePunk(uint256[] calldata _ids, string calldata tokenURI) public payable returns(bool){
    ...
    function uri(uint256 _tokenId) override public view returns (string memory) {
     ...
     function tokenURI(uint256 _tokenId) public view returns (string memory) {
        ...
        parts[0] = 'https://gateway.pinata.cloud/ipfs/QmbSBavv5EBWDNCh7Me4P5S23xkM6Q2qL6U3xuRWqHT1mJ/';
...
contract PuzlPunk is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Puzl Punks", "PUZLPUNKS") Ownable() {}
}