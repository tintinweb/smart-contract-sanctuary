...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private _name = "BloodMoon";
    ...
    function SetCharityAddress(address payable  _charityAddress) onlyOwner private {
        charityAddress = _charityAddress;
    }
    
    function SetCharityPercent(uint256 _charityPercent) onlyOwner private {
        charityPercent = _charityPercent;
    }
    
    function SetBurnPercent(uint256 _burnPercent) onlyOwner private {
