...
contract Bank is ReentrancyGuardUpgradeSafe, Governable,IBTokenFactory {
      /// @notice Libraries
  ...
  using SafeMath for uint;
    ...
    constructor(IBankConfig _bankConfig) public {
		config = _bankConfig;
        currentPid = 1;
        currentPos = 1;
    }
    ...
    function updateConfig(IBankConfig _config) external onlyGov {
        config = _config;
    }
