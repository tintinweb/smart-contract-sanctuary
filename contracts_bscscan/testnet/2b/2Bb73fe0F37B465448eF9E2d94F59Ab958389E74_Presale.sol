...
contract Presale is Ownable {
    ...
    function buyToken() public payable {
        ...
        if (totalBNBAmount < rStep[0] * (10**18)){
            ...
            createTokenLockedWallets(rLockinPeriod[1],tokenAmount,_msgSender());
    ...
    function createTokenLockedWallets(uint256 duration,uint256 tokenAmount, address _userAddress) private returns(bool status){
