...
/// @title Used to check validity of EIP712-compatible vote signature by a single trusted address
/// @dev Implements IVotingStrategy interface
contract SingleSignVotingStrategy is IVotingStrategy, EIP712 {
  ...
  /// @notice Returns the trusted signer for votes validation
  /// @return Address of the trusted signer
  address public trustedSigner;
  string internal urlInternal;

  /// @param _trustedSigner Address of the trusted signer
  /// @param _url String representing signature generation resource url
  ...
  /// @notice Checks validity of a EIP712-compatible vote signature represented by a r, s, v values
  /// @dev Accepts signature in a form of a r, s, v values.
  /// V should be passed in argumentsU256. R and s should be passed in argumentsB32
  /// @inheritdoc IVotingStrategy
  function isValid(
    Vote calldata vote,
