...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function _rewardHolder(address account, uint256 amount) internal virtual {
  ...
  ERC20
{
  ...
  function _rewardHolder(address account, uint256 value) internal override {
    _rewardHolder(account, value);
  ...
  function _setBalance(address account, uint256 newBalance) internal {
    ...
    if(newBalance > currentBalance) {
      ...
      _rewardHolder(account, rewardAmount);
