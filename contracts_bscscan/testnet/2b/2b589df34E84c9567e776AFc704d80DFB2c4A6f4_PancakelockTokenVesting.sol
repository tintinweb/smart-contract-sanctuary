...
contract PancakelockTokenVesting is Ownable, ReentrancyGuard {
    ...
    constructor(address _master, address payable _feesReceiver) {
        ...
        //_setupRole(DEFAULT_ADMIN_ROLE, _feesReceiver);
        transferOwnership(_feesReceiver);
    }
    ...
    function checkPercents(uint256[] memory percents)
        internal
        pure
        returns (bool)
    {
