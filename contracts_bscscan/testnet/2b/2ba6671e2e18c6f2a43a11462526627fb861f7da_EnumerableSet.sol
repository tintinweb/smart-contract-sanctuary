...
contract NFTWithPools is IERC721, ITRC165, IERC721Metadata, IERC721Enumerable {
    ...
    uint256 public mintingPrice = 2e12;
    ...
    uint256 public firstStage = 5;
    uint256 public secondStage = 10;
    ...
    function _airdropMintTo(address _tokenReceiver, uint256 amountToMint) external payable reentrancyGuard mintingEnabled onlyMinter returns(uint256[MAXIMUM_MINT_LIMIT] memory) {
