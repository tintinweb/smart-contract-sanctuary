...
//        );
    ...
    function swapToken(uint256 _amountInToken) external roundUnlocked {
        ...
        DaoVcGov(tempGovAddress).burn(msg.sender, _amountInToken);
    ...
    function claim() external nonReentrant claimUnlockedModifier {
        ...
        DAOVCGovToken(govTokenAddress).transfer(
            msg.sender,
            availableAmount
        );
        ...
        )
    {
        ...
        available_ = (user.amount.mul(locks[newLock].percent).div(100)).sub(
            user.claimed
        );
