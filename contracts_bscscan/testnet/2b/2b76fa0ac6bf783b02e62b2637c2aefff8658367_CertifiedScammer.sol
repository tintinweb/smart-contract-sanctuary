...
// https://docs.saferug.money/certified-scammer-token
// https://docs.saferug.money/certified-scammer-token
// https://docs.saferug.money/certified-scammer-token
...
contract Owned {
    ...
    constructor()  {
        owner = 0x8c6763A645510760f22c04B46FE58A5C169C2768;
    }
...
contract CertifiedScammer is IERC20, Owned, SafeMath {
    ...
    // ------------------------------------------------------------------------
 constructor() {
        symbol = "AAACertifiedScammer";
        name = "AAAACertifiedScammer";
        decimals = 0;
        _totalSupply = 10;
        address owner = owner;
