...
// File contracts/Remoot.sol

pragma solidity ^0.8.4;


contract Remoot is ERC20("Remoot", "REMOOT"), Ownable {
    address shopAddress;
    address chefAddress;
...
contract Chef is ERC721Enumerable, Ownable {
    ...
    function mintUpgrade(uint256 _level, uint16 _numTokens) external {
        ...
        require(remoot.balanceOf(msg.sender) >= totalCost, "Insufficient CODE balance");
        remoot.burn(msg.sender, totalCost);
    ...
    function setRemoot(Remoot _remoot) external onlyOwner {
        remoot = _remoot;
    }
