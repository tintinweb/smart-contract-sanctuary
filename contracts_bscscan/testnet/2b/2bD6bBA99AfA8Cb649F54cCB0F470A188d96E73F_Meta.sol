...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Cloth";
    string private _symbol = "Meta Cloth";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x594cd7A274BAaB01b8ae10B6C3d603e1FD00EE1a);
    address payable public teamWalletAddress = payable(0x594cd7A274BAaB01b8ae10B6C3d603e1FD00EE1a);
