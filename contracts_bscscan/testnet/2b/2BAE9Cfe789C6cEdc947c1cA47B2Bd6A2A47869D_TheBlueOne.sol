...
/**
 ...
 Skeletone is a decentralized halloween themed token on BSC that will surely bring you to the moon! 
 You can earn $ONE directly into your wallet by holding every 60 minutes.
 
 Telegram https://t.me/skeletonetoken 
 Twitter https://twitter.com/SkeletoneBSC 
...
contract DividendDistributor is IDividendDistributor {
    ...
    // IERC20 BTCB = IERC20(0x03fF0ff224f904be3118461335064bB48Df47938); // REAL REWARDS (Harmony)
    IERC20 BTCB = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // TESTNET BUSD 
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Now on testnet. REAL- 0x10ED43C718714eb63d5aA57B78B54704E256024E
        _token = msg.sender;
    }
...
// CHANGE
contract TheBlueOne is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address BTCB = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // TESTNET NOW
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TheBlueOne";
    string constant _symbol = "theblueONE";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 30,000,000,000
    ...
    uint256 devFee = 600; // 6%
    uint256 totalFee = 1200; // Reflection + liquidityFee + devFee for marketing and development
    uint256 feeDenominator = 10000;
    uint256 public _sellMultiplier = 1; //
    // Total Tax: 12% for buys and sells
    ...
    constructor () {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // change ROUTERS
        ...
        devFeeReceiver = address(0x327d62F90fdb1D8Edc14ab5d9aBaEc1f7848B27D);
