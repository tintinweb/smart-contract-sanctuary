...
contract Dogs is Context, IBEP20, Ownable {
    ...
    uint256 private _maxTxn = 980 * 10**9 * 10**8; // 3BNB
    uint256 private _maxWallet = 50 * 10**6 * 10**8; // 1% of 1bil
