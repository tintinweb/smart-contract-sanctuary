...
contract ERC20contract is ERC20, Ownable {
    ...
    uint256 constant initialSupply = 1 * 10**9 * (uint256(10)**18);
    ...
    uint256 public minimumTokensBeforeSwap = 1 * 10**3 * (10**18);
    ...
    constructor() ERC20("EuroShiba", "EuroShiba") {
        ...
        marketingWallet = payable(0x63841FFdDfB1e275a9eC163e0332962E27fD5AAb);
        developerkWallet = payable(0x63841FFdDfB1e275a9eC163e0332962E27fD5AAb);
    ...
    function activateTrading(bool _status) public onlyOwner {
    ...
    function updateFee(uint256 amount)
        internal
    ...
    function setLiquidityWallet(address payable newAddress)
        public
        payable
        onlyOwner
    {
    ...
    function _transfer(
        ...
        if (takeFee) {
            (uint256 returnAmount, uint256 fee) = updateFee(amount);
            amount = returnAmount;
