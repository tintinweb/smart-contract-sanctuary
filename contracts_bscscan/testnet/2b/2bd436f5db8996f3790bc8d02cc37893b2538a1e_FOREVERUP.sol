...
contract DividendDistributor is IDividendDistributor {
    ...
    WethLike WBNBc = WethLike(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
...
contract FOREVERUP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FOREVERUP";
    string constant _symbol = "FU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4aFAdd1E9B0a47E90A803A10A730CDD097447f5f;
        devFeeReceiver = 0x97dC0294CbD53798C74fC67272Ffb0F4aEa81C77;
...
// ~by monkey < Permission for Forking!