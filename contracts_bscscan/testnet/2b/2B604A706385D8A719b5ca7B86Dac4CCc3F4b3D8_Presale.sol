...
contract Token is Context, IERC20, IERC20Metadata { //собственно сам контракт токена
    ...
    string public _name = "syk"; //Полное имя токена
    
    string public _symbol= "syk";//краткое имя токена
    
    bool public allowanceEnabled = true; // переменная блокирующая трансфер токенов между кошельками
    
    address payable public marketingAddress = payable(0x7eC0a1A3F64D53D85b1Dc047704dBcA9E50e8B61); // Marketing Address
