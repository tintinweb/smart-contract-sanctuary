...
contract    Token
{
    ...
    string  private  constant    _name       = "Q99a Token";    //qsdc
    string  private  constant    _symbol     = "Q99a";
    ...
    //--------------------------------------------------------------------------
    function mint(uint256 amountToAddInWei) public onlyAdmin  returns(uint)
    {
        require(msg.sender==owner, "Only owner can add tokens");

        uint256     newOwnerBalance = balances[owner] + amountToAddInWei;
        uint256     newTotalSupply  = _totalSupply    + amountToAddInWei;
        ...
        _totalSupply = _totalSupply + amountToAddInWei;
