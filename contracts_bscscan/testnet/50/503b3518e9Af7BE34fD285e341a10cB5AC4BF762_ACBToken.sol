...
contract ACBToken is Pausable, StandardTokenWithFees, BlackList, MinterRole{
    ...
    function mint(uint amount) onlyMinter public{
        _mint(msg.sender, amount);
        
        emit MintToAddress(msg.sender, amount);
    }
    
    function burn(uint amount) onlyMinter public{
        _burn(msg.sender, amount);
        
        emit BurnFromAddress(msg.sender,amount);
    }
    ...
    event MintToAddress(address minter, uint amount);
    event BurnFromAddress(address minter, uint amount);
}