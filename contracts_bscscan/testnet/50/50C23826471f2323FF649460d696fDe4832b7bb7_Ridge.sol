...
contract Ridge is IERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize () external initializer {
        address owner_ = 0x4863a08D2b2d9881c52c2B4cAf723e1E9718B2FB;                // Owner address.
        string memory name_ = "Ridge_test" ;                             
        string memory symbol_ = "RIDGE_test";
        uint256 totalSupply_ = 1000000000000* 10**9;                                      // 1 000 000 // 1 000 000 000 000* 10**9; -> ten trillions
        address router_ = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;               // Pancakeswap router.
        address charityAddress_ = 0xc23ab662575c578542789Cf75642C4A06e416d27;       // Charity wallet addresss.
        address marketingAddress_ = 0x82cd0bc64f4337F70aA3d372E8caC273A8b24D9F;     // Marketing wallet address.
        uint16 taxFeeBps_ = 300;                                                    // Tax fee.
        uint16 liquidityFeeBps_ = 300;                                              // Liquidity fee.
        uint16 charityFeeBps_ = 400;                                                // Charity fee.
        uint16 marketingFeeBps_ = 100;                                              // Mrketing fee.
        uint16 maxTxBps_ = 1100;                                                    // Max transaction.
