...
contract Mazdarati is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1e6442EfAacB8a50A9Ff90AbB8000b5D081599aF); // Marketing Address
    ...
    string private _name = "Mazdarati";
    string private _symbol = "Mazdarati";
