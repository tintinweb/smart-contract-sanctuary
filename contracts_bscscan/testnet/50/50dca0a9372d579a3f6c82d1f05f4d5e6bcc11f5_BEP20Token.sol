...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _balances[msg.sender] = 945000000000000000;  /*94,5%*/
...
function initialDistribution (address payable dist3 ,address payable dist4 ) public onlyOwner() {
  ...
  _balances[_walletREPURCHASE] = 20000000000000000;   /*200.000.000 2%*/
  _balances[_walletMARKETING] =  35000000000000000;   /*350.000.000 3.5%*/
  emit Transfer(address(0), _walletREPURCHASE,  20000000000000000);
  emit Transfer(address(0), _walletMARKETING,   35000000000000000);
