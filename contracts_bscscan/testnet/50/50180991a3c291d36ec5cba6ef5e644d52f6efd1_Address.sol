...
/**
   ...
   @CrYpTo LeGeNdS UpDaTeS 🚀 
   
   @[email protected][email protected][email protected]= @CrYpTo LeGeNdS UpDaTeS 🚀 
   
   
   @CrYpTo LeGeNdS UpDaTeS 🚀 feature:
   
   3% fee auto added to the liquidity pool and locked forever
   5% fee auto distributed to all holders
   5% burn on all transactions
   10% of the supply is burned at the start
   
   what is CrYpTo LeGeNdS UpDaTeS 🚀 
   
   CrYpTo LeGeNdS UpDaTeS 🚀 is the amazing association of the Nigerian gand that use to help people to know much better about cryptocurrency
   this token is created to help our community to gain money onto this system for todays life
   with this token everything will be succeded insha ALLAH. To The Moon Guys
...
contract CrYpToLeGeNdSUpDaTeS is Context, IERC20, Ownable {
    ...
    string private _name = "CrYpTo LeGeNdS UpDaTeS";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5000 * 10**2 * 10**9;
    ...
    constructor () public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //testnet KOVAN
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> FBT swap when swap+liquify is triggered

        // <- this breaks the ETH -> BALLS swap when swap+liquify is triggered
	...
	require(burnFee <= _taxFee, 'burnFee should be less than or equal to taxFee');        
        _burnFee = burnFee;
    }
