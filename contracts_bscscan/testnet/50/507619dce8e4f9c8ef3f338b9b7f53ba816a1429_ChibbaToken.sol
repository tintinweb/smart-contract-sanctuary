...
contract ChibbaToken is Context, IERC20, Ownable {
    ...
    uint256 communityLockFromTime  = 1635465600;
    uint256 communityLockToTime    = 1635724800;
    uint256 communityUnLockTime    = 1643673600;
    ...
    uint256 dxsaleLockFromTime   = 1634688000;
    uint256 dxsaleLockToTime     = 1634860800;
    uint256  dxsaleLockTokenAmount= 0;
    uint256 dxsaleUnLockTime     = 1637712000;
    ...
    constructor () {
        ...
        mintpara[0].fromTime      = 1634155990;
        mintpara[0].toTime        = 1634242330;
        ...
        mintpara[1].fromTime      = 1634774400;
        mintpara[1].toTime        = 1637366400;
        ...
        mintpara[2].fromTime      = 1637452800;
        mintpara[2].toTime        = 1639958400;
        ...
        mintpara[3].fromTime      = 1640044800;
        mintpara[3].toTime        = 1642636800;
        ...
        mintpara[4].fromTime      = 1642723200;
        mintpara[4].toTime        = 1645315200;
        ...
        PancakePair = IPancakeFactory(_PancakeRouter.factory()).createPair(address(this), 0x6725F303b657a9451d8BA641348b6761A6CC7a17);
