...
// File: contracts/interfaces/ISMOONLottery.sol

pragma solidity ^0.8.0;

interface ISMOONLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in SMOON per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in SMOON token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInSMOON: price of a ticket in SMOON
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the SMOON lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == SMOONLottery, "Only SMOONLottery");
    ...
    /**
     * @notice Set the address for the SMOONLottery
     * @param _SMOONLottery: address of the SMOON lottery
     */
    function setLotteryAddress(address _SMOONLottery) external onlyOwner {
        SMOONLottery = _SMOONLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ISMOONLottery(SMOONLottery).viewCurrentLotteryId();
    }
}