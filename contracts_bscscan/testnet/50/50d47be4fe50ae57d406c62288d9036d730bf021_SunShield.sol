...
abstract contract SunShieldBase is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	...
	string private constant NAME = "Suntest";
	string private constant SYMBOL = "TEST223";
	...
	uint256 private _tokenSwapThreshold = _totalTokens / 10000; //There should be at least 0.001% of the total supply in the contract before triggering a swap
	...
	constructor (address routerAddress) {
		...
		// 2% liquidity fee, 12% reward fee, 2% buyback fee, 2% marketing fee, 1% moonshield fee, 6% additional sell fee
		setFees(2, 12, 2, 2, 1, 6);
