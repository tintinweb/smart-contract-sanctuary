...
contract DividendDistributor is IDividendDistributor {
    ...
    address[] public shareholders; // todo, remove public in mainnet
    mapping (address => uint256) public shareholderIndexes; // todo, remove public in mainnet
    mapping (address => uint256) public shareholderClaims; // todo, remove public in mainnet

    mapping (address => Share) public shares; // todo, remove public in mainnet
    ...
    uint256 currentIndex; // todo, remove public in mainnet
...
contract Burner is IBurner {
    ...
    // todo
    event BurnAmount(uint256 burnMark, uint256 burnAmount, uint256 amount);
    event BurnEnabled(uint256 burnMark, bool shouldBurn, uint256 burnAmount);
    ...
    function deposit(uint256 amount) external override onlyToken {
        ...
        emit BurnAmount(200, burnAmount, amount);
    }

    function burn() external override onlyToken {
        // todo
        emit BurnEnabled(100, shouldBurn(), burnAmount);
        if (shouldBurn() && burnAmount > 0) {
...
contract MarsDoge is Context, IBEP20, Ownable {
    ...
    // every 1 hour, burn
    Burner public burner; // todo, remove public in mainnet
