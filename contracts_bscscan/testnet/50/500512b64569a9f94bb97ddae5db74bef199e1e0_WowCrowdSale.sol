...
contract WowCrowdSale{
    ...
    function getLatestPriceBinance() public view returns (uint256) {
        return uint256(usdRate);
    }
    ...
    function bnbToToken(uint256 _amount) public view returns(uint256){
        ...
        uint256 bnbToUsd = _amount.mul(getLatestPriceBinance());
    ...
    function setLatestPriceBnb(uint256 _usd) external onlyOwner{
        usdRate = _usd;
    }
