...
╚██████╗██║  ██║██║  ██║██║███████║   ██║   ██║ ╚═╝ ██║██║  ██║███████║██████╔╝╚██████╔╝███████║██████╔╝
 ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚══════╝   ╚═╝   ╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝╚═════╝  ╚═════╝ ╚══════╝╚═════╝ 
    ...
    This is ultimate shitcoin with no real use-case, our mission is just to make all of you money.                                                       
    ...
    Telegram: https://t.me/christmasbusd
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BSC BUSD  
...
contract ChristmasBUSD is IERC20, Ownable { 
    ...
    address payable private _marketingAddress = payable(address(0xfeA68c051709d7eDF1e642d500f6C3f6600f0046));
    ...
    string private _name = "ChristmasBUSD";
    ...
    uint256 public _totalLiquidityFee = 11;
    uint256 private _previousTotalLiquidityFee = _totalLiquidityFee;
    ...
    constructor () {
        ...
        //Pancake Swap V2 address   0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x7a220d5630B4cF539739dF2C5dAcb4c659F2488D, 'We can not exclude Uniswap router.');
    ...
    function setLiquidityFeePercent(uint256 totalLiquidityFee) external onlyOwner() {
        _totalLiquidityFee = totalLiquidityFee;
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount * _totalLiquidityFee / 10**2;
    }

    function removeAllFee() private {
        if(_taxFee == 0 && _totalLiquidityFee == 0) return;

        _previousTaxFee = _taxFee;
        _previousTotalLiquidityFee = _totalLiquidityFee;
    ...
    function restoreAllFee() private {
        ...
        _totalLiquidityFee = _previousTotalLiquidityFee;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 amountToLiquify = contractTokenBalance * LPfee / _totalLiquidityFee / 3;
        ...
        uint256 totalETHFee = _totalLiquidityFee - LPfee / 3;

        uint256 amountETHLiquidity = amountETH * _totalLiquidityFee / totalETHFee / 3;
        //uint256 amountETHBuyBack = amountETH * buyBackFee / totalETHFee;
        uint256 amountETHMarketing = amountETH * marketingFee / totalETHFee;
        //uint256 amountETHEco = amountETH.mecosystemFee / totalETHFee;
        uint256 amountETHReward = amountETH * rewardFee / totalETHFee;

        try distributor.deposit{value: amountETHReward}() {} catch {}
        (bool success, ) = payable(_marketingAddress).call{value: amountETHMarketing, gas: 30000}("");
