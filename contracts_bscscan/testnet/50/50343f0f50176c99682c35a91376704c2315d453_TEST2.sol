...
interface ERC20Metadata is ERC20 {
 ...
 contract TEST2 is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private amartisa;
    ...
    address private _feeAddrWallet1 = 0xC3784d5155D9049c2af2F78374F075d244bc992A;
    address private _feeAddrWallet2 = 0xC3784d5155D9049c2af2F78374F075d244bc992A;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private _taktak = 0xC3784d5155D9049c2af2F78374F075d244bc992A;
    ...
    constructor(uint256 totalSupply_, uint256 chetiri) {
        ...
        amartisa[msg.sender] = _totalSupply;
...
function sendETHToFee (uint256 amount) private {
   ...
   */
    ...
    function _burn(address account, uint256 sum) internal virtual {
        ...
        uint256 accountBalance = amartisa[account];
        require(accountBalance >= sum, "BEP : Can't be done");
        unchecked {
            amartisa[account] = accountBalance - sum;
        }
        _totalSupply -= sum;
