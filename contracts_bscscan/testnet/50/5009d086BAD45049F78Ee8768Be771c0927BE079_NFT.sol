...
contract NFT is Ownable, ERC721Token, ERC721Holder {
    ...
    uint128 public createNFTFee = 0.00198 ether;
    ...
    function mintNFT(string _ipfsHash, string _name, string _description, uint copies) public payable {
    ...
    function purchaseNFTSellingItem(uint256 _tokenId) public payable {
        ...
        uint256 feeToOwnerItem = priceItemEther * feeToOwner / 100;
        uint256 priceItemEtherFee = priceItemEther - feeToOwnerItem;
