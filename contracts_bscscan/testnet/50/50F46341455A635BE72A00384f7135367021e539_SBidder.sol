...
contract SBidder is ERC20Permit, Ownable {
    ...
    modifier onlyStakingContract() {
        require( msg.sender == stakingContract, "Sender must Staking" );
        _;
    }
    ...
    constructor() ERC20("SBidder", "SBID", 18) ERC20Permit() {
    ...
    function rebase( uint256 profit_, uint epoch_ ) public onlyStakingContract() returns ( uint256 ) {
        ...
        if ( profit_ == 0 ) {
            ...
            console.log('rebaseAmount1', rebaseAmount);
        } else {
            rebaseAmount = profit_;
            console.log('rebaseAmount2', rebaseAmount);
        }
