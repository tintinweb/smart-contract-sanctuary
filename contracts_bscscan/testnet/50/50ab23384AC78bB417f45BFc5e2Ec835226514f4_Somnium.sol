 ...
 * 
 * 
 *  _______  _______  __   __  __    _  ___   __   __  __   __ 
 * |       ||       ||  |_|  ||  |  | ||   | |  | |  ||  |_|  |
 * |  _____||   _   ||       ||   |_| ||   | |  | |  ||       |
 * | |_____ |  | |  ||       ||       ||   | |  |_|  ||       |
 * |_____  ||  |_|  ||       ||  _    ||   | |       ||       |
 *  _____| ||       || ||_|| || | |   ||   | |       || ||_|| |
 * |_______||_______||_|   |_||_|  |__||___| |_______||_|   |_|
 *
 * A static rewards token to power Somnium DApps
 * www.somniumcrypto.com
 */
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SOMNIUM";
    string internal constant SYMBOL = "SOM";
    ...
    enum FeeType {  Liquidity, Rfi, External, ExternalToETH }
    struct Fee {
        FeeType name;
        uint256 value;
        address recipient;
...
abstract contract STokenBase is BaseRfiToken, Liquifier {
...
contract Somnium is STokenBase{

    constructor() STokenBase(Env.Testnet){
