...
contract MasterChef is Ownable {
    ...
    // Setup Appleder Token Reward Release
    function setAppleRewardLock(uint256 lock) public onlyOwner {
        apple.setRewardLock(lock);
    }

    function setAppleTotalBlockRelease(uint256 totalBlockRelease) public onlyOwner {
        apple.setTotalBlockRelease(totalBlockRelease);
    }
}
