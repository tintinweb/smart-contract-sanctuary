...
string constant _name = "RETINA";
string constant _symbol = "RTN";
uint256 constant _maxTokens = 1000000; // unit = ether
uint256 constant _maxSupply = _maxTokens * 10 ** 18; // unit = wei

/**
 * @dev {Retina} token, including:
 *
 *  - Mint a fixed supply of 1000000 tokens on creation (deflationary mechanism)
 ...
 *  - 
 */
contract Retina is ERC20Burnable {
    /**
