...
/**
 Telegram : https://t.me/harvestmoonbsc
 Slippage : 14% or more.
 Hold HMOON, Earn $ALICE
*/
...
contract HarvestMoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HarvestMoon", "HMOON") {
    	firstDividendTracker = new FIRSTDividendTracker();
 
    	marketingWallet = 0x4A4E9B5882f575F79f138af73153707c2789B492; // Marketing Wallet
    	firstDividendToken = 0xAC51066d7bEC65Dc4589368da368b212745d63E8; // $Alice Token Address
 
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //TestNet: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 MainNet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    receive() external payable {
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "HarvestMoon: The marketing wallet is already this address");
    ...
    function updatefirstDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(firstDividendTracker), "HarvestMoon: The dividend tracker already has that address");
 
        FIRSTDividendTracker newfirstDividendTracker = FIRSTDividendTracker(payable(newAddress));
 
        require(newfirstDividendTracker.owner() == address(this), "HarvestMoon: The new dividend tracker must be owned by the HarvestMoon token contract");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "HarvestMoon: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }
 
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(isExcludedFromFees[account] != excluded, "HarvestMoon: Account is already exluded from fees");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "HarvestMoon: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
 
        _setAutomatedMarketMakerPair(pair, value);
    }
 
    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        require(automatedMarketMakerPairs[pair] != value, "HarvestMoon: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue != gasForProcessing, "HarvestMoon: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "HarvestMoon: Trading has not started yet");
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("HarvestMoon_Dividend_Tracker", "HarvestMoon_Dividend_Tracker", 0xAC51066d7bEC65Dc4589368da368b212745d63E8) {
    	claimWait = 14400;
        minimumTokenBalanceForDividends = 100000 * (10**18); //must hold 100,000+ tokens
    }
 
    function _transfer(address, address, uint256) pure internal override {
        require(false, "HarvestMoon_Dividend_Tracker: No transfers allowed");
    }
 
    function withdrawDividend() pure public override {
        require(false, "HarvestMoon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HarvestMoon contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "HarvestMoon_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "HarvestMoon_Dividend_Tracker: Cannot update claimWait to same value");
