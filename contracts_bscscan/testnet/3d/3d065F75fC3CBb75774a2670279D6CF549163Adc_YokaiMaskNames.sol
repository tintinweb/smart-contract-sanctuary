...
contract YokaiMaskNames is Ownable, ReentrancyGuard {
    ...
    uint256 public nameChangePrice = 10000 * (10 ** 18);
    ...
    // RYO token address
    address public ryoAddress = 0xE55DBD26165924a1855BD754a207e603e7100D3A;

    // Yokai Masks contract address
    address public masksAddress = 0x1757Bdf9Bb7cC63bE2A8bF2Cb9C8CFB8357be504;
    ...
    function changeName(uint256 _tokenId, string memory _newName) public nonReentrant {
        ...
        // If already named, transfer RYO and remove old name reservation
        if (bytes(maskName[_tokenId]).length > 0) {
            IERC20(ryoAddress).transferFrom(msg.sender, devAddr, nameChangePrice);
     ...
     */
    function setRyoAddress(address _token) external onlyOwner {
        ryoAddress = _token;
    }
