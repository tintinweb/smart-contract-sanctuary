...
using SafeMath for uint256;
  ...
  string public constant name = "UNICAS TOKEN";
  string public constant symbol = "UNICAS";
  uint8 public constant decimals = 9;
  uint256 public constant decimalValue = 10 ** uint256(decimals);
  
  //sending out tokens
  //uint256 public _value = 100000000000000000000000;
  ...
  function transferFromContract(address _to, uint256 _value) public returns (bool) {
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    emit Approval(account, msg.sender, allowed[account][msg.sender].sub(amount));
  }
}