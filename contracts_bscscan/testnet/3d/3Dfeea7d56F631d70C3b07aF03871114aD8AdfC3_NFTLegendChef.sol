...
// Lucky Token with Governance.
contract LuckyToken is BEP20("Lucky", "LUCKY"), Ownable {
...
contract NFTLegendChef is Ownable {
    ...
    uint256 public constant perDayBlocks = 28800; // no bonus
    ...
    function changeLuckyPerBlock(uint256 _luckyPerBlock) public onlyOwner {
        luckyPerBlock = _luckyPerBlock;
    }

    function changeNflPerBlock(uint256 _nflPerBlock) public onlyOwner {
        nflPerBlock = _nflPerBlock;
    }
    ...
    function getRewardPerBlock(uint blockNumber) public view returns (uint256) {
        if (blockNumber >= startBlock){
            ...
            // if(blockDaysPassed <= 7){
            //      return luckyPerBlock
            // }
            // else if(blockDaysPassed > 7 && blockDaysPassed <= 30){
            //      return luckyPerBlock.div(2);
            // }
            // else if(blockDaysPassed > 30 && blockDaysPassed <= 90){
            //      return luckyPerBlock.div(4);
            // }
            // else {
            //     return luckyPerBlock.div(5);
            // }
    ...
    function getRewardNflPerBlock(uint blockNumber) public view returns (uint256) {
        if (blockNumber >= startBlock){
            ...
            // }
            // else if(blockDaysPassed > 7 && blockDaysPassed <= 30){
            //      return nflPerBlock.div(2);
            // }
            // else if(blockDaysPassed > 30 && blockDaysPassed <= 90){
            //      return nflPerBlock.div(4);
            // }
            // else {
            //     return nflPerBlock.div(5);
            // }
    ...
    function pendingToken(uint256 _pid, address _user) external view returns (uint256 rewardLucky, uint256 rewardNft) {
        ...
        // return user.amount.mul(accLuckyPerShare).div(1e18).sub(user.rewardDebt), user.amount.mul(accNflPerShare).div(1e18).sub(user.rewardNfl);
    }
