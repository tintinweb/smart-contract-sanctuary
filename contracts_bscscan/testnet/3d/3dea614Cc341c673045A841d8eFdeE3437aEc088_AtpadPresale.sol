...
/** 
    ...
    @notice Version v1.1.2  date: jan 07, 2022

last changes;
    v1.1.2
    - restore payable since v1.1.0 did not work
    - depositTokens after claim
...
contract AtpadPresale is ReentrancyGuard, Ownable, Pausable {
    ...
    */
    ...
    ///  Epoch timestamps START and END vesting 
    uint startVest = 1643716800;  //  Epoch timestamp:  Date and time (GMT): Tuesday 1 February 2022 12:00:00
    uint endVest  = 1669896000;  // Epoch timestamp:  Date and time (GMT): Thursday 1 December 2022 12:00:00
...
//                uint _allocate = (hardCap * _perc) ; // FOR TESTING PURPOSE !
     ...
     */
    function swapClaim() external payable whenFinished {   //
