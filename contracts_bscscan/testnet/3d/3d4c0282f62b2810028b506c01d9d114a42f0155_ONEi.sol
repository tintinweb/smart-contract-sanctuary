...
contract ONEi is Context, IERC20, Ownable {
    ...
    function setMarketingAndTeamFeePercent(uint256 marketingFee, uint256 teamDivisor) external onlyOwner() {
        require(teamDivisor < marketingFee || teamDivisor == 0);
        _marketingFee = marketingFee;
        islandDivisor = teamDivisor;
    }
