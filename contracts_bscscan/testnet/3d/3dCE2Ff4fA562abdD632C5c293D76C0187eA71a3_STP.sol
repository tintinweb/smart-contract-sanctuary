...
contract STP is Context, IERC20, AccessControl {
    ...
    mapping (address => bool) private _isExcludedFromTimeStrict;

    uint256 public periodLimitation = 1 hours;
    ...
    uint256 public maxHoldAmount = _tTotal / 1 ether / 100;
    ...
    function _transfer(
        ...
        require(balanceOf(to) <= maxHoldAmount, 'Holding Limit');

        uint256 oneHourLater = block.timestamp + periodLimitation;
        require(lastTransfer[from] > oneHourLater, 'Time Limit');
