...
contract MadDogeTokeno is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7E9DFf15DD9F6934Cc71DEA7B582A00501028ACD); // Marketing Address
    ...
    string private _name = "MadDogeTokeno";
