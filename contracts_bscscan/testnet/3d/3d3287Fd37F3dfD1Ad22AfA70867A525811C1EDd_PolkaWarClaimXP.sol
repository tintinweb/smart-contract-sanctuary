...
contract CorgibStaking is Ownable {
    string public name = "Corgi Of PolkaBridge: Staking";
    ...
    constructor(uint256 _startBlock) public {
        ...
        MinimumStakeAmount = 100000000 * 1e18;
    }

    function changeMinimumStakeAmount(uint256 _amount) public onlyOwner {
