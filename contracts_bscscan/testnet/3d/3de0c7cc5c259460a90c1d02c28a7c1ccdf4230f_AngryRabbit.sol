...
Angry Rabbit is a Tokenomic created for people who want to see the moon !
Strong Team and Big Marketing !

A token by KOKO'S Team
...
https://angryrabbit.online
https://t.me/AngryRabbitBsc
...
contract AngryRabbit is Context, IERC20, Ownable {
    ...
    address payable public _marketingWallet = payable(0xB83CF0D9F9f375A1a4E936927ce4E657623C7e47);
    address payable public _DevelopmentWallet = payable(0xEdaf0298db71E3D65276e874Dab319Cd573EA0Bc);
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       /**
        uint256 _totalFeesForBNB = _liquidityFee.add(_marketingFee);
       ...
       **/
        ...
        /**
         if( marketingAndDevelopmentPart2 > 0)
        {
            initialBalance = address(this).balance;
            swapTokensForBnb(marketingAndDevelopmentPart2);
            newBalance = address(this).balance.sub(initialBalance);
            transferToAddressBNB(_DevelopmentWallet,newBalance);
        }
        else{}
        **/
    ...
    function swapbro(uint256 contractTokenBalance) private  {
        
        
         uint256 lpPart = contractTokenBalance.mul(1).div(1);
        
         if( lpPart > 0)
        {
            uint256 initialBalance = address(this).balance;
            swapTokensForBnb(lpPart);
            uint256 newBalance = address(this).balance.sub(initialBalance);
            transferToAddressBNB(_marketingWallet,newBalance);
