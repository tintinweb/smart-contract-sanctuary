...
contract TORII is BEP20, Pausable { 
	...
	constructor(){
		...
		//pancakeSwapV2Router = IPancakeSwapV2Router02(0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B);
		...
		maxTaxFreeTransferAmount = 5 * 1e18;
		maxTransferAmount = 100 * 1e18;	
		taxPercent = 1000; // 10%	
        
		taxExcludedList[address(this)] = true; 
		
		_owner = 0x1d3354FB678086Aa367FBb2BD30c05FADf558c9c;
		...
		_mint(0xf7a6799E164685Ef752e7121eC6CBf47D6B67dD5, 1000 * 1e18);
		_approve(0xf7a6799E164685Ef752e7121eC6CBf47D6B67dD5, address(pancakeSwapV2Router), MAX_INT);
		operatorsList[0xf7a6799E164685Ef752e7121eC6CBf47D6B67dD5] = true;
		taxExcludedList[0xf7a6799E164685Ef752e7121eC6CBf47D6B67dD5] = true;
   	}
