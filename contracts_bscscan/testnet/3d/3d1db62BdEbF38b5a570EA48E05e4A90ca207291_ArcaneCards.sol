...
abstract contract Tokenomics {
    ...
    uint256 internal  maxWalletBalance = TOTAL_SUPPLY / 200; // 0.5% of the total supply
     ...
     */
    address public constant marketingAddress = 0xed0143157EF642866faF917C586d585CA8efA022;
    address public constant buybackAddress = 0xed0143157EF642866faF917C586d585CA8efA022;
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function burn(uint256 amount) external {
     ...
     function setmaxWalletBalance(uint256 value) external onlyOwner {
		require(value >= 0 && value <= 10000, "Value out of range: values between 0 and 10000");
        ...
        if ( isInPresale ){ takeFee = false; }
            ...
            */
            ...
            if ( amount > maxTransactionAmount && !_isUnlimitedSender(sender) && !_isUnlimitedRecipient(recipient) ){
                revert("Transfer amount exceeds the maxTransactionAmount.");
            } 
