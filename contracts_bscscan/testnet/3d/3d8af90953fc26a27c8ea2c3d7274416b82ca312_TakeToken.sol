...
pragma solidity ^0.8.0;
contract TakeToken is ERC20, Ownable {
    ...
    constructor() ERC20("TakeToken", "TakeToken") {
        _mint(msg.sender, 250000000000000*10**decimals());
        _mint(address(this), 750000000000000*10**decimals());
        startSale(block.number, 500000000, 0,6000000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,500000000,1000000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
