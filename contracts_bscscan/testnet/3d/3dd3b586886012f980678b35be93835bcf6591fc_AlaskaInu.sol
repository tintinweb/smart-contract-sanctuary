...
contract AlaskaInu is ERC20, Ownable {
    ...
    AlaskaInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Alaska Inu", "ALASKA") {

    	dividendTracker = new AlaskaInuDividendTracker();

    	IRouter _router = IRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //  //main 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    /// @notice Withdraw tokens sent by mistake. Impossible to withdraw AlaskaInu tokens
    /// @param tokenAddress The address of the token to withdraw
    function rescueBEP20Tokens(address tokenAddress) external onlyOwner{
        require(tokenAddress != address(this), "Impossible to withdraw AlaskaInu tokens");
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "AlaskaInu: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "AlaskaInu: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "AlaskaInu: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "AlaskaInu: Cannot update gasForProcessing to same value");
...
contract AlaskaInuDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()  DividendPayingToken("AlaskaInu_Dividen_Tracker", "AlaskaInu_Dividend_Tracker") {
    	claimWait = 3600;
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "AlaskaInu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "AlaskaInu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AlaskaInu contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "AlaskaInu_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "AlaskaInu_Dividend_Tracker: Cannot update claimWait to same value");
