...
contract MOVX is Context, IBEP20, Ownable {
    ...
    uint256 public _sellMaxTxAmount   =  100000 * 10**9; // 0.2% percent of total supply per sell transaction
    uint256 private _otherMaxTxAmount = 2000000 * 10**9;
    uint256 public _maxWalletAmount   = 5000000 * 10**9; // 0.5% of total supply  
    uint256 private numTokensSellToAddToLiquidity = 20000 * 10**9; // 0.002% max tx amount will trigger swap and add liquidity
    ...
    function setBuyFeePercent(uint256 BuyTaxfee, uint256 BuyBuybackFee, uint256 BuyLiquidityFee, uint256 BuyMarketingFee, uint256 BuyResearchFee) external onlyOwner() {
