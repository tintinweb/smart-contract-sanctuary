...
contract CODRADO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**12 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CODRADO";
    string private _symbol = "[email protected]";
    ...
    uint256 public _maxTxAmount = 100 * 10**12 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 10**4 * 10**8;
