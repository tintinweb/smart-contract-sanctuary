...
contract RealboxVault is Ownable, ERC721Holder, ReentrancyGuard {
     ...
     * @param _swapRouter: address of PancakeRouter
     * @param _unitPrice: price per vault token (in base token)
     * @param _supply: the amount of vault token in existence
     */
    function initialize(
        IERC721 _realx,
        IERC20 _baseToken,
    ...
    /**
     * @notice Buy vault token using base token
    ...
    /**
     * @notice Buy vault token using other token than base token
     * @param _amount: amount of vault token to buy
     * @param _amountInMax: max amount of token to paid
     * @param _path: swap path, last address must be base token
     * @param _deadline: expired timestamp
     * @dev Caller must have allowance for this contract of at least `_amountInMax`.
     */
    ...
    /**
     * @notice Withdraw base token from vault
...
contract RealboxVaultFactory is AccessControlEnumerable {
    ...
    function deployVault(
        ...
        require(hasRole(CREATOR_ROLE, _msgSender()), 'RealboxVaultFactory: m ust have creator role to deploy new vault');
...
contract RealboxVaultToken is Ownable, ERC20Snapshot, ERC20Permit {
    ...
    /**
     * @notice Initialize the contract
     * @param _supply: total supply of vault token
     */
