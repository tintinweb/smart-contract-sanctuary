...
contract CriptoCarsEscrow is Ownable {
   ...
   function getState(uint _orderId) public view returns (EscrowStatus){
    ...
    function releaseEscrow(uint _orderId) external onlyBuyer(_orderId){            
        ...
        // 1) Descontar el fee del comprador para dejarlo en el contrato 
        // _tmpBuyer = value - (feebuyer*100)/value
        // 2) Descontar el fee del vendedor que va quedar en el contrato
        // _tmpSeller = _tmp - (feeSeller*100)/_tmp
