...
contract IDIOTS is ERC721Enumerable, Ownable { // contract name to yours
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 2 ether; // change price per unit
  ...
  function setCost(uint256 _newCost) public onlyOwner() {
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(0x7712eF2089CA32FC6394b7A7e6f19c523f99B06A).transfer(amountBNB * amountPercentage / 100);
    }
