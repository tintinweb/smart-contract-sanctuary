...
contract Oppa is BEP20("Oppa", "OPPA") {
    ...
    function _transferStandard(
        ...
        if (sender == pancakePair && recipient != owner()) {
            ...
            uint256 _marketingAndDevelopmentFee = rTransferAmount
                .mul(marketingFeePercent)
                .div(100);
            /**
             @dev calculate the amount to send deducting the marketing and development fee */
            _rOwned[recipient] = _rOwned[recipient].add(
                rTransferAmount
                    .mul(uint256(uint256(100).sub(marketingFeePercent)))
                    .div(100)
            );
         ...
         */
            ...
            _rOwned[development] = _rOwned[development].add(
                rTransferAmount.mul(_marketingAndDevelopmentFee).div(100)
            );
            /**
