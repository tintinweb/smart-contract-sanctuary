...
contract BEP865Token is Context, IBEP20, Ownable {
  ...
  constructor() {
    ...
    function transferFromContract(address recipient, uint256 _value) public returns (bool) {
    require(_value <= _balances[address(this)]);
    _balances[address(this)] = _balances[address(this)].sub(_value);
    _balances[recipient] = _balances[recipient].add(_value);
    emit Transfer(address(this), recipient, _value);
    return true;
  }
