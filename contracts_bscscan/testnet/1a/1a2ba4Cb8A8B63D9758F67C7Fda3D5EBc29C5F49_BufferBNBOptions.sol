    ...
    ReentrancyGuard
{
    ...
    function setTradingPermission(PermittedTradingType permissionType) external onlyOwner {
    ...
    function create(
        ...
        if (optionType == OptionType.Call) {
            require(
                permittedTradingType == PermittedTradingType.All || permittedTradingType == PermittedTradingType.OnlyCall,
                "Owner has disabled option trading for call options"
            );
        } else if (optionType == OptionType.Put) {
            require(
                permittedTradingType == PermittedTradingType.All || permittedTradingType == PermittedTradingType.OnlyPut,
...
interface IBufferOptions {
    ...
    enum PermittedTradingType {All, OnlyPut, OnlyCall, None}
