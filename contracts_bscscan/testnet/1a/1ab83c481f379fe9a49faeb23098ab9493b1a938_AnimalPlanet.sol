...
contract AnimalPlanet is Context, IERC20, Ownable {
    ...
    string private _name = "Animal Planet";
    string private _symbol = "ANPL";
    uint8 private _decimals = 18;
    
    address public immutable BUSD = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public charityWallet = 0x748f4DCf7FFb14069384F0Aa9984923E2CCc7936;
    address public teamWallet = 0x748f4DCf7FFb14069384F0Aa9984923E2CCc7936;
    ...
    uint256 public _saleCharityFee = 2;
    uint256 public _saleTeamFee = 1;
    ...
    uint256 public minimumTokensBeforeSwap = 50000000 * 10**18;
    ...
    function _transfer(address from, address to, uint256 amount) private 
    {
        ...
        if (
            ...
            //add liquidity and send busd to marketing and team wallet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // combine the Liquidity, marketing and team fees
        uint256 combineFees = _liquidityFee.add(_charityFee).add(_teamFee); // charityFee + teamFee + liquidity fees
        ...
        swapAndSendToFee(tokensForWallets);
    ...
    function swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        path[2] = BUSD; // BUSD cotract address
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 charityShare = newBalance.mul(_charityFee).div(_charityFee.add(_teamFee));
        uint256 teamShare = newBalance.sub(charityShare);
        
        IERC20(BUSD).transfer(charityWallet, charityShare);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        {
            setAllFees(_saleTaxFee, _saleLiquidityFee, _saleCharityFee, _saleTeamFee, _saleBurnFee);
        }
    ...
    function setAllFees(uint256 taxFee, uint256 liquidityFee, uint256 charityFee, uint256 teamFee, uint256 burnFee) private {
        _taxFee = taxFee;
    ...
    function setFees(uint256 taxFee, uint256 liquidityFee, uint256 charityFee, uint256 teamFee, uint256 burnFee) 
    external onlyOwner() {
        setAllFees(taxFee, liquidityFee, charityFee, teamFee, burnFee);
        _previousTaxFee = taxFee;
        _previousLiquidityFee = liquidityFee;
        _previousBurnFee = burnFee;
        _previousCharityFee = charityFee;
        _previousTeamFee = teamFee;
    }
    
    
    function setSaleFees(uint256 taxFee, uint256 liquidityFee, uint256 charityFee, uint256 teamFee, uint256 burnFee) 
    external onlyOwner() {
        _saleTaxFee = taxFee;
        _saleLiquidityFee = liquidityFee;
        _saleTeamFee = teamFee;
