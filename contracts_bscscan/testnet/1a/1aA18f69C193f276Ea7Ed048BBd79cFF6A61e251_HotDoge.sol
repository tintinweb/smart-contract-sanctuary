...
3. 1.50% Vip Programs
4. 3.00% HOTDOGE Reflection (auto)
5. 3.00% Astro Buyback
6. 1.50% Treats Bot
7. 2.00% Marketing
8. 2.50% Liquidity
...
contract HotDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HotDoge v2";
    ...
    constructor() {
        ...
        _volunteerWallet = payable(0xa200060E2C05E3b0a6Cd260Ac17eB90379339938);
        _diamondHandWallet = payable(0xcDAA088E30155406579eF70981BCD25D5efA82D6);
        _vipWallet = payable(0xb48C444DED32cAFED898BCC03e2E0588088b3d74);
        _marketingWallet = payable(0x0973b22e50C007FdEEc47Ddf1AFb5196049427c7);
        _liquidityWallet = payable(0x05306784BFD31e115a98B16ec0a59966D428d28e);
        _buybackWallet = payable(0xaE10892BE276fC67637Ee3B48036F57515e50392);
