...
//    $$ |$$\ $$ |      $$  $$<  $$ |  $$ |$$  __$$ |$$ |      $$  _$$<  
//    \$$$$  |$$ |     $$  /\$$\ $$$$$$$  |\$$$$$$$ |\$$$$$$$\ $$ | \$$\ 
//     \____/ \__|     \__/  \__|\_______/  \_______| \_______|\__|  \__|
//                                                                       
//    7% TRX Rewards                                                                    
//    4% Marketing Fee  
//	  3% Auto LP                                                              
//    https://t.me/TRXBackBSC  Join our community if you want ~                                                           
// 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGE = IBEP20(0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //testnet0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 //mainnet0x10ED43C718714eb63d5aA57B78B54704E256024E
        _token = msg.sender;
    }
...
contract DOGEClassic is IBEP20, Auth {
    using SafeMath for uint256;

    address DOGE = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x5200c68E597bbb88DF8B8041B6d706E6A4035581;
