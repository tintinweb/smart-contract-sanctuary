...
contract Ownable is Context {
    ...
    constructor () {
        _owner = (0x8E7Ac0f416cF9AA8b91EA1B7878c8F39214318a6);
...
contract BullBNB is Context, IBEP20, Ownable {
 ...
 // uint256 public _taxFee;
  ...
  constructor(address payable _wallet) {
    ...
    _symbol = "BullBNB";
    _decimals = 12;
    _totalSupply = 100000000e12;  // total Supply: 1B
 
    _liquidityFee =7;

    _minTokensToAddToLiquidity = 1000 * (10 ** 12);    
  ...
  function swapTokensForEth(uint256 tokenAmount) private {
    ...
    function ChangeTaxFeeWallet(address payable newWallet) external onlyOwner {
    _Wallet = newWallet;
  }
