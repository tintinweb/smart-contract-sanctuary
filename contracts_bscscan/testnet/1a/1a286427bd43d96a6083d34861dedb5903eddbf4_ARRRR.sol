 ...
 */
contract ARRRR is ERC20Detailed, Ownable {
    ...
    uint256 public maxTxAmountDivisor = 100;
    ...
    ) public payable ERC20Detailed("TESTAA", "ARRRR", uint8(DECIMALS)) {
    ...
    function _transfer(
        ...
        uint256 _maxTxAmount = _totalSupply.div(maxTxAmountDivisor);
        ...
        if (
            ...
            from != uniswapV2PairAddress && overMinimumTokenBalance
        ) {
            ...
            uint256 remainingHalfETH = balance.div(2);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        if(swapTokensForEth(swapAmount)){       
    ...
    function setMaxTxAmountDivisor( uint256 _maxTxAmountDivisor) public onlyOwner {
        maxTxAmountDivisor=_maxTxAmountDivisor;
    ...
    function updateTax(uint256 transactionTax_) public onlyOwner {
