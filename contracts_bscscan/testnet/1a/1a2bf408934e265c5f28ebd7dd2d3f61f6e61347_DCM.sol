...
contract DCM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DCM";
    string private _symbol = "DCM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x028FB1F3D1C9b0c8B11A178e67174c1ac7d13DAe); // Marketing Address
    ...
    uint256 private _totalSupply = 2000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 200 * 10**6 * 10**9; //10%
    uint256 public _walletMax = 200 * 10**6 * 10**9; // 10%
