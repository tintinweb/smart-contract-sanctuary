...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BONKBONK";
    string internal constant SYMBOL = "BONK";
    ...
    address internal marketingAddress =
        0xc0d7A6197F383Bf3280185AA30516a74110f6F7f;
...
abstract contract Bonk is Tokenomics {
    using SafeMath for uint256;
...
abstract contract SafeToken is BaseRfiToken, Liquifier, Bonk {
    using SafeMath for uint256;
