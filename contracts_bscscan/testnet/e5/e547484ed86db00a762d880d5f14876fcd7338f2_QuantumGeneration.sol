...
contract QuantumGeneration is Context, IERC20, IERC20Metadata,Ownable,Pausable {
     ...
     */
    constructor () {
        _name = "Quantum Generation";
        _symbol = "QG";
        _decimals = 18;
        
        _mint(_msgSender(),10000000000 * 10 ** _decimals);
    }
