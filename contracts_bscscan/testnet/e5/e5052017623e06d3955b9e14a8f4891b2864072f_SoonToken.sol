...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public fundPercent = 40; // 0.040 = 4%
    uint256 public autoLP_Percent = 10; // 0.010 = 1%
    ...
    function editAutoLP_Percent(uint _newpercent) public onlyOwner {autoLP_Percent = _newpercent;}
    ...
    */
    ...
    //function getWhitelisted() public view returns (struct Whitelist) {
    //    return Whitelist;
    //}
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        // deducs the full amount from the sender
        ...
        else { // auto_lp and tax applies

        uint256 lpAmount = ((amount * autoLP_Percent) / 10**21) * 10**18; // tricky when 0.5% 
        uint256 fundAmount = ((amount * fundPercent) / 10**21) * 10**18; // tricky when 0.5% 
        uint256 remainderAmount = amount - lpAmount - fundAmount;

        // auto-lp routine only if > 0 // having autoLP_Percent = 0 means amount = 0
        if (lpAmount > 0) {
            /// AUTO-LP here
...
contract SoonToken is Ownable, ERC20PresetFixedSupply, ERC20Pausable {
    ...
    address private constant OWNER = 0x1e1A2d7E4b783F1C1A7fA673AF85A7D5C7F85bf8; // 0x1e1A2d7E4b783F1C1A7fA673AF85A7D5C7F85bf8;
    
	IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	
    constructor()
    ERC20PresetFixedSupply('Dogematic', 'SOON', 1000_000_000 ether, OWNER) {
