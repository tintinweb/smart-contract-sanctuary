...
contract EarnUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Earn USD";
    string constant _symbol = "EARNUSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
    uint256 public maxWalletTokens =  100000 * (10**9); // Anti-Whale
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x446b20B72619149F789536586F327322995C1FbC ;
