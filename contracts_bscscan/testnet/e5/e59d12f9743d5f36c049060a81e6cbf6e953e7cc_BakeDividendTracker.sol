...
contract BakeDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Bake_Dividend_Tracker", "Bake_Dividend_Tracker", 0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5) {
        claimWait = 3600;
