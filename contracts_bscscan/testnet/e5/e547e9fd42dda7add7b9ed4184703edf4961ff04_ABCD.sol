...
contract ABCD is Context, IERC20, Ownable {
    ...
    //// ERC-20 init
    string private constant _name = "v166";
    string private constant _symbol = "v166";  //TODO
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 500000000 * 10**9;  //TODO
    ...
    uint256 public _maxTxAmount = 210000 * 10**9; //TODO
    ...
    constructor () {
        ...
        launchReleaseTime = block.timestamp + 60 * 60 * 24 * 3;  //TODO

        contractInitializeDeadline = block.timestamp + 60 * 60; //TODO: shoule be <= launchDate
        launchDate = block.timestamp + 60;// * 60 * 24;  //TODO
    ...
    function calculateTaxFee(uint256 _amount, address to) private view returns (uint256) {
        ...
        uint256 startRate = 28;
        if (dayCount < 7) {
            uint256 _newTaxFee = startRate.sub(dayCount.mul(3));
