...
contract FeesProcessor is ReentrancyGuard {
    ...
    function buybackAndBurn() public {
        ...
        if( block.number < lastBuybackBlock && lastBuybackBlock != 0){
            ...
            // Each Buyback call can only be 1% of the Total BUSD available for Buyback
            uint256 buybackAmount = contractBUSD.div(100);
    ...
    function updatePancakeSwapRouter(address _router) public onlyOperator {
        require(_router == pcsRouter, "BYIELD::updatePancakeSwapRouter: Not PCS Router.");
