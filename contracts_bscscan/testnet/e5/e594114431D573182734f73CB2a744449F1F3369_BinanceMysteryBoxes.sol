...
contract BinanceMysteryBoxes is Ownable {
    ...
    event SetBNFT(address indexed _bnft);
    event SetBNFTReceiver(address indexed _bnftReceiver);
    ...
    function setBNFTReceiver(address _bnftReceiver) external onlyOwner {
        ...
        emit SetBNFTReceiver(_bnftReceiver);
    }
    ...
    function claim(
        ...
        emit Claim(orderId, bnftTokenId, tokenId, star, nftType);
    }
