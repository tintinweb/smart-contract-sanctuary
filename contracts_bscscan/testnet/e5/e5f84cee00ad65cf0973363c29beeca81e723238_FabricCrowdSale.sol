...
contract FabricCrowdSale{
    ...
    uint256 internal tokenAllocation = 4000000;
    ...
    constructor(address _tokenContract) public{
        ...
        //weiTokenPrice = 476190470000000; // Price 0.2usdt, BNB @ $420 using bnb to wei conversion...production
        tokenContract =  Fabric(_tokenContract);
       
       // tokenContract =  new Fabric(0);
        
        //deployedContract = Fabric(_deployedContract);
        isFinalized = false;
        tokenSold = 0;
    }
