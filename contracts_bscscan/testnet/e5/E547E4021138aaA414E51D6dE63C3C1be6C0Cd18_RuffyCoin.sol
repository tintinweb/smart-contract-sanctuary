...
abstract contract RuffyCoinBase is Context, IERC20Metadata, Ownable, ReentrancyGuard {
  ...
  uint8 private _developerFee; //% of each transaction that will be used for developer
	...
	address private _developerWallet = 0xF565aaf0b8EB813a1c8C956D2C59F1ce27FD2366;
	...
	constructor (address routerAddress, address pinkAntiBot_) {
		...
		// 3% liquidity fee, 3% reward fee, 1% buyback fee, 3% marketing fee, 3% developer fee, 2% additional sell fee
		setFees(3, 3, 1, 3, 3, 2);
