...
contract DEX {
    ...
    uint256 constant public minBUSD = 1;
    uint256 constant public maxBUSD = 5;
    ...
    IERC20 constant public BUSD = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
    ...
    function investBUSD(uint256 amount) public {
        ...
        require(amount >= minBUSD,"Min amount 100 BUSD");
    ...
    function getToken() public payable{
        ...
        require(allowance >= getUserAvailableTokens(msg.sender), "Check the token allowance");
        uint256 amount;
