...
contract AirBn3 is Context, IBEP20, Ownable {
    ...
    string private _name = "AirBn3";
    string private _symbol = "ABT";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 1; // Redistribute fee
    ...
    address public CharityWallet = 0x17A5e2F40aD2498fb92d9e466cd7fc68F2A53331; // Charity Wallet address Here ....
    ...
    uint256 private numTokensSellToAddToLiquidity = 250 *10**6 * 10**18;
