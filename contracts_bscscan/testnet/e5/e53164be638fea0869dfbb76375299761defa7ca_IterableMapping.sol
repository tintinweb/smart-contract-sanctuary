...
// File: contracts/buyBackDivUserSetWithBurnDividendPayingToken.sol
...
// File: contracts/buyBackDivUserSetWithBurn.sol
...
contract buyBackDivUserSetWithBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    buyBackDivUserSetWithBurnDividendTracker public dividendTracker;
    ...
    uint256 public buyTokenRewardsFee = 12;
    ...
    uint256 public sellTokenRewardsFee = 8;
    ...
    constructor() public ERC20("DiviPlan", "DVPL") {
        ...
        dividendTracker = new buyBackDivUserSetWithBurnDividendTracker();
...
/*
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(dividendTracker), "buyBackDivUserSetWithBurn: The dividend tracker already has that address");

        buyBackDivUserSetWithBurnDividendTracker newDividendTracker = buyBackDivUserSetWithBurnDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "buyBackDivUserSetWithBurn: The new dividend tracker must be owned by the buyBackDivUserSetWithBurn token contract");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "buyBackDivUserSetWithBurn: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        //require(_isExcludedFromFees[account] != excluded, "buyBackDivUserSetWithBurn: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "buyBackDivUserSetWithBurn: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "buyBackDivUserSetWithBurn: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "buyBackDivUserSetWithBurn: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "buyBackDivUserSetWithBurn: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            revert("buyBackDivUserSetWithBurn: This account cannot send tokens until trading is enabled");
        }
...
contract buyBackDivUserSetWithBurnDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("buyBackDivUserSetWithBurn_Dividend_Tracker", "buyBackDivUserSetWithBurn_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "buyBackDivUserSetWithBurn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "buyBackDivUserSetWithBurn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main buyBackDivUserSetWithBurn contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "buyBackDivUserSetWithBurn_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "buyBackDivUserSetWithBurn_Dividend_Tracker: Cannot update claimWait to same value");
