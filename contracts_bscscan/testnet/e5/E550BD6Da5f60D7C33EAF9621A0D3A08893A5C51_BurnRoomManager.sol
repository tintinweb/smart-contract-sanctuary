...
contract BurnRoomManager is SafeOwnable, Random {
    ...
    function beginLoop(uint _rid) public {
        ...
        uint lastLoop = room.currentLoop;
        if (roomReward[_rid][lastLoop] > 0 && winerNum[_rid][lastLoop] == 0) {
            roomReward[_rid][lastLoop + 1] = roomReward[_rid][lastLoop]; 
            roomReward[_rid][lastLoop] = 0;
        }
