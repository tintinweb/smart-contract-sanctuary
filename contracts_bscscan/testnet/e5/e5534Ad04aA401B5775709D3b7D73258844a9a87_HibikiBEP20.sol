...
contract HibikiBEP20 is IBEP20 {
    ...
    constructor (address creator, string memory name, string memory symbol, uint8 decimals, uint256 tokenSupply) {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
		_owner = creator;
        ...
        _initialMint(creator, tokenSupply);
    }
