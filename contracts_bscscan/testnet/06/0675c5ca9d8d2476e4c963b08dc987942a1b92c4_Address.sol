...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract WISELY is Context , IERC20, Ownable {
    ...
    string private _name = "WISELY TOKEN";
    string private _symbol = "WSLY";
    ...
    address public MarketingWallet = 0x421F17a999150bECbbe33bd76ca5F4Ef5C9607EF; //5% for marketing 
    ...
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9; //1% of total supply   //ANTIDUMP
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 30000 * 10**6 * 10**9;
