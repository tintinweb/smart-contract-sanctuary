...
contract LuckyBlock is Context, IERC20, Ownable {
    ...
    string private _symbol = "LuckyBlock";
    ...
    uint256 public maxTxAmountPercentage = 0;
    ...
    function _transfer(
        ...
        if (
            ...
            if (listedAt + 30 seconds >= block.timestamp)
                // don't allow sell for 30 seconds afer launch
                require(
    ...
    function distributeToTokenHolders(uint256 amount) public {
        uint256 rate = _getReflectionRate();
       if (taxFee != 0) {
    ...
    function setMaxTransferAmount(uint256 maxAmount)
        external
        onlyOwnerAndAdmin
    {
