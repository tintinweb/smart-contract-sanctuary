...
contract NFT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1500000 * 10**18;
    ...
    address public marketingWallet = 0xFa654D9C66a2200DfB4856474a84745d474100BC;
    ...
    uint256 public _maxTxAmount = 15000 * 10**18;	
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //don't take burnFee
        if(balanceOf(address(0)) < 1500000 * 10**18){
