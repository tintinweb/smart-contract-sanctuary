...
abstract contract Gas_Refundable is ReentrancyGuard, I_Gas_Refundable{
 ...
 */
interface I_Windmill_Fund is I_Payable, IAccessControlEnumerable, I_With_DAORole, I_With_PWRToken,
...
contract Windmill_DAO is Math, Adressable, Payable, Gas_Refundable, AccessControlEnumerable, With_DAORole,
    ...
    function setRoyaltydAddress(I_Windmill_Royalty _royalty) external onlyRole(DAO_ROLE){
        royalty = _royalty;
    }
    ...
    function updateOneRoyaltyCycle() external onlyGovernor{
        require(updateRoyaltyCycleNeeded(), "Windmill_DAO: A Royalty cycle update is not required.");
    ...
    function updateOneStackingCycle() external onlyGovernor{
        require(updateStackingCycleNeeded(), "Windmill_DAO: A Stacking cycle update is not required.");
    ...
    function updateOneDAOCycle() external onlyGovernor{
        require(updateDAOCycleNeeded(), "Windmill_DAO: A DAO cycle update is not required.");
        _updateOneDAOCycle();
    }
