...
contract TwinciReferralToken is ERC20Pausable, OperatorRole, Ownable{

    bool public mintStopped = false;

    event MintStopped();

    constructor() ERC20("Foxci", "FOXCI") {
        _addOperator(msg.sender);
    }
    function mint(address account, uint256 amount) external onlyOperator returns (bool) {
...
//    bytes32 public constant ROLE_OPERATOR = bytes32('OPERATOR');
...
//        require(hasRole(ROLE_OPERATOR, msg.sender), "Restricted to members.");
//        _;
//    }
//    modifier onlyAdmin() {
...
//    {
//        return hasRole(ROLE_OPERATOR, account);
//    }
//
