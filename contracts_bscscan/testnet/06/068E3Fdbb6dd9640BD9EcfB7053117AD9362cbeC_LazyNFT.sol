...
contract LazyNFT is AccessControl, ERC721URIStorage {
    ...
    constructor(address _market) ERC721("LazyNFT2022", "LNFT22") {
    ...
    function redeem(
        ...
        //This line (_transfer)must be activated if you want the NFT mint to first reach the account of the person running
        //the mint function, and then send it to the user who won or bought the NFT.
        //_transfer(msg.sender, _redeem, _tokenid);
        return _tokenid;
    }
