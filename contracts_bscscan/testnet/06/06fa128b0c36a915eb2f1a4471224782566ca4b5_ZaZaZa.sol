 ...
 * the actual name of the contract `Zeken the very bottom **and** the `environment` into which
 * you are deploying the contract `Zeken `Zekenc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Sinar Dunia";
    string internal constant SYMBOL = "SIDU";
    ...
    address internal charityAddress = 0xD70C4491494134152eF93Ab0Eb3fE34139d2A13f;
