...
contract preSaleBusd is ReentrancyGuard {
    ...
    constructor() {
        ...
        stake = IHodlStake(0xf51b1166F7c39e067832D5a64e5C11BF39138419);
        adminFeePercent = 2;
    }
    ...
    function buyToken(uint256 _amountBusd) public allowed isHuman{
        ...
        busdBalance[msg.sender] = busdBalance[msg.sender].add(_amountBusd);
    ...
    function claim() public allowed isHuman{
        ...
        if(amountRaised < softCap){
            uint256 numberOfTokens = busdBalance[msg.sender];
            require(numberOfTokens > 0,"HODL: Zero balance");
        
            busd.transfer(msg.sender, numberOfTokens);
            busdBalance[msg.sender] = 0;
    ...
    function withdrawAndInitializePool() public onlyTokenOwner allowed isHuman{
        ...
        if(amountRaised > softCap){
            ...
            busd.approve(address(routerAddress), busdAmountForLiquidity);
