...
contract BuildingNFTSale is IMidoTokenSale, Whitelist {
    ...
    function buy(uint64 amount) external payable {
        ...
        buildingNFT.mintNFT(amount, buyer);
    }
    ...
    function newSale(
        ...
        buildingNFT.updateTotalSupplyWithNewSale(_maxSupply);
    }
