...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //token to reflect (bsc testnet BUSD in this case)
    address WAVAX = 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C; // gas token to swap with (WBNB in this case)
    IDEXRouter router;
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81); //router contract, should be set for whatever DEX you want to use (bsc testnet pancakeswap in this case)
        _token = msg.sender;
    }
...
contract BUSDREF is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
    address public WAVAX = 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BUSDREF";
    string constant _symbol = "BUSDREF";
    ...
    address public marketingFeeReceiver=0xe7aeb6Db737fb1c6174a91E0A8a22a5e9e21BCdD;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		// Max  tx check
		address routerAddress = 0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81;
