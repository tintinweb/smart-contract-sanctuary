...
contract JioCoin is Context, IBEP20, Ownable {
...
string private constant _name = 'JIO COIN';
string private constant _symbol = 'JIOCOIN';
...
function _setTaxFee(uint256 taxFee) external onlyOwner() {
    require(taxFee <=10000 ); //limit taxFee to 4%
    _taxFee = taxFee;
}
