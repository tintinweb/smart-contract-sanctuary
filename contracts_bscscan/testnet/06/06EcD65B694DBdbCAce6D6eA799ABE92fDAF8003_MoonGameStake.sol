...
contract MoonGameStake is IReflectionPool, Auth, Pausable {
    ...
    uint256 public moonGamePerBlock;
    ...
    function setMoonGamePerBlock(uint _amount) external onlyOwner{
        moonGamePerBlock = _amount;
    }
