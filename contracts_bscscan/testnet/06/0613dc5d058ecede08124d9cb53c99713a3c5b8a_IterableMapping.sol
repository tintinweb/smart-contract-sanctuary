...
/**
    ...
    */
    ...
    contract Coin24 is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        uint256 public maxSellTransactionAmount = 1000000000 * 10**18; // In place to avoid whales drumping
        uint256 public minSellTransactionAmount = 0; 
        uint256 public maxBuyTranscationAmount = 10000000000 * 10**18; //1% of Total Supply + 0
        uint256 public maxWalletBalance = 10000000000 * 10**18; //1% of Total Supply + 0
    ...
    contract FIRSTDividendTracker is DividendPayingToken {
        ...
        constructor() DividendPayingToken("Coin_Dividend_Tracker", "Coin_Dividend_Tracker", 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7) {
          claimWait = 3600;
            minimumTokenBalanceForDividends = 20000000000000000 * (10**18); //must hold 2000000+ tokens
            limitMinimumTokenBalanceForDividends = 25000000000000000; //limit max 2500000+ tokens
        }
        ...
        function withdrawDividend() pure public override {
            require(false, "Coin_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ADACatto contract.");
        }
