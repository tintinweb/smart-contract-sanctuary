...
contract Grimdoge is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 200_000_000 * 10**9; //0.02%
    uint256 public maxBuyLimit = 10_000_000_000 * 10**9; //1%
    uint256 public maxWalletLimit = 20_000_000_000 * 10**9; //2%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x4Aae3D8f72c3ce57C5e9CC597B0Ffbfc5556c10F;
    address public devWallet = 0x4Aae3D8f72c3ce57C5e9CC597B0Ffbfc5556c10F;
    address public autoLiquidityReceiver = address(0);

    string private constant _name = "Grimdoge.com";
    string private constant _symbol = "Grim Doge";
    ...
    Taxes public taxes = Taxes(2, 5, 5, 1);
    Taxes public sellTaxes = Taxes(2, 5, 5, 1);
    ...
    function updateMaxTxLimit(uint256 maxBuy) external onlyOwner{
