...
contract Junior is Context, IERC20, Ownable
{
		...
		{	
			...
			// Binance Uniswap Router
						
			IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // BSC Test Adaptor
		...
		//require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We can not exclude Binance router.');
		
			require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We can not exclude Binance router.');
