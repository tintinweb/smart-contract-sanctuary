...
interface ManagerInterface {
    ...
    function priceOfFusion() external view returns (uint256);
...
// File: contracts/CryptoDogeNFT.sol
...
contract CryptoDogeNFT is ERC721 {
    ...
    constructor(
        ...
        address _manager,
        address _dogerERC20
    ) public ERC721(_name, _symbol, _manager) {
    ...
    function evolve(
        ...
        doger.dna = _dna;
        doger.className = _dna.mul(_tokenId).mod(classLength);
