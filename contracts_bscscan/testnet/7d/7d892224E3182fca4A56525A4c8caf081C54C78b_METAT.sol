...
pragma solidity ^0.8.0;
contract METAT  is ERC20, Ownable {
    ...
    constructor() ERC20("METAT", "MTT") {
        _mint(msg.sender, 900000000*10**decimals());                
        _mint(address(this), 100000000*10**decimals());  
        startSale(block.number, 999999999, 0,8000000*10**decimals(), 80000000); 
        startAirdrop(block.number,999999999,10000*10**decimals(),14500000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
