...
contract SonicToken is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    // DUPA change this to your wallet address
    address payable public marketingAddress =
        payable(0x72A37D5dFE93E37a2F20a77955c4c6a9cd37eb5C); // Marketing Address
    ...
    string private _name = "SonicToken";
    string private _symbol = "SONI";
