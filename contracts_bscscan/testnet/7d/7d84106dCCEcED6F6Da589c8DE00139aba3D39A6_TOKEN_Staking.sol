...
contract TOKEN_Staking is Ownable {
	...
	address public constant TOKEN = 0x42dd67e74e2A057a3aa693E2772DD8A7Ab6Dda2A; //token to stake
	...
	uint256 public rewardRate = 15; //15% linear return per staking period
	uint256 public totalStaked; //sum of all user stakes
	uint256 public maxTotalStaked = 100000e18; //5.8 million tokens
	uint256 public minStaked = 10e18; //1000 tokens. min staked per user
