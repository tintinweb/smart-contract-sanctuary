...
contract GymVaultsStrategyAlpaca is Ownable, ReentrancyGuard, Pausable {
    ...
    address public uniRouterAddress =
        address(0x367633909278A3C91f4cB130D8e56382F00D1071); // PancakeSwap: Router
    ...
    uint256 public entranceFeeFactor =
        10000; // 0% entrance fee (goes to pool + prevents front-running)
    uint256 public constant entranceFeeFactorMax =
        10000; // 100 = 1%
    uint256 public constant entranceFeeFactorLL =
        9950; // 0.5% is the max entrance fee settable. LL = lowerlimit
