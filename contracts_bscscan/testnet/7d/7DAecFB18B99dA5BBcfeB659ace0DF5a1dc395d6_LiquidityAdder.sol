...
contract LiquidityAdder is Auth {
	...
	function removeLiquidity(uint256 bnb) external {
		router.removeLiquidityETHSupportingFeeOnTransferTokens(token, bnb, 0, bnb * 90 / 100, msg.sender, block.timestamp + 300);
	}
