...
contract DangoToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public constant TEAM_ADDRESS =
        0xc11A85BffE9D6C1c27Fa53b79508b397fD73A5b1;
    ...
    string private _name = "DangoToken";
    string private _symbol = "DNG";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "AFI::transfer: Mkt value invalid"
            );
