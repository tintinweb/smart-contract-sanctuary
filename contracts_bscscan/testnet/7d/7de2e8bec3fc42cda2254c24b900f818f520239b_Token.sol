...
contract Token {
    ...
    string public name = "DoaCoin";
    string public symbol = "DOA";
    
    uint256 public numeroDeMoedas = 365000000;
    uint256 public casasDecimais = 9;
    
    uint256 public lockTime = 365;
    ...
    function transferFrom(address from, address to, uint256 value) public returns(bool) {
        ...
        if(from == foundersWallet) {require(block.timestamp > lockTime , "Wallet is locked until 365 days");}
        balances[to] += value;
        balances[from] -= value;
