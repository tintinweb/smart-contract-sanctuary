...
import "./interfaces/rUMBBSC.sol";

contract rUMB1BSC is rUMBBSC {
     constructor (
        address _owner,
        string memory _name,
        string memory _symbol
    )
     rUMBBSC(_owner, _name, _symbol) {
    }
}
...
/// @title   Umbrella Rewards contract for BSC
/// @author  umb.network
/// @notice  This is reward UMB token (rUMB) for BSC
/// @dev     Rewards tokens are used for farming and other rewards distributions.
abstract contract rUMBBSC is ERC20Mintable, Owned {
    // ========== STATE VARIABLES ========== //
