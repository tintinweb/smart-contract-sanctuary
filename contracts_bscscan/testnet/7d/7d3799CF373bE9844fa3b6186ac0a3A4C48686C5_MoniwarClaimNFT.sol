...
contract MoniwarClaimNFT is Ownable, ReentrancyGuard {
    ...
    uint256 startTime = 1636124400;
    uint256 endTime = 1636556400;
    ...
    constructor(
        ...
        whiteList[address(0xB2FF54E8589cD3584A5b587f85FcC574094485e3)] = true;
        whiteList[address(0xB2FF54E8589cD3584A5b587f85FcC574094485e3)] = true;
        whiteList[address(0xAba7B729B97De8ec8aaBF20D9d33Bb96E9d00A27)] = true;
        whiteList[address(0xCcED347AFa31f021C9ceE16a080b08a1AC36e51a)] = true;
    ...
    function setStartClaim(uint256 _startTime) external onlyOwner {
        startTime = _startTime;
    }
    function setEndClaim(uint256 _endTime) external onlyOwner {
        endTime = _endTime;
    }
    ...
    function claimNFT() public payable nonReentrant {
        ...
        require(block.timestamp >= startTime, "claim not start");
