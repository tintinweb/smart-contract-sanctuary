...
contract sTrapezaV2 is ERC20Permit, Ownable {
    ...
    function setTotalSupply(uint totalSupply_, uint gonsPerFragment_, uint totalBalance_) external onlyManager() returns ( bool ) {
        _totalSupply = totalSupply_;
        _gonsPerFragment = gonsPerFragment_;
        _gonBalances[ initializer ] = totalBalance_.mul(_gonsPerFragment);
        return true;
    }
