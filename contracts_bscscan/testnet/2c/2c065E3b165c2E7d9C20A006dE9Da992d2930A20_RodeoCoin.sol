...
//
contract RodeoCoin is BEP20, Manageable {
    using SafeMath for uint256;
    ...
    constructor() public BEP20("Rodeo Coin", "RODEOCOIN") {
        ...
        address _pancakeSwapPair = IPancakeFactory(_pancakeSwapRouter.factory())
    ...
    function mint(address to, uint256 amount) public {
        require(
            msg.sender == owner() || msg.sender == _masterChef,
            "permission-denied"
        );
        _mint(to, amount);
    }
    ...
    function updatePancakeSwapRouter(address newAddress) public onlyManager {
        require(
            newAddress != address(pancakeSwapRouter),
        ...
        address _pancakeSwapPair = IPancakeFactory(pancakeSwapRouter.factory())
    ...
    function updateMasterChef(address newAddress) public onlyManager {
        require(
            newAddress != _masterChef,
            "RODEOCOIN: The masterChef already has that address"
        );
        ...
        onlyManager
    {
        require(
            ...
            "RODEOCOIN: The marketing wallet is already this address"
        );
        ...
        onlyManager
    {
        require(
            ...
            "RODEOCOIN: The development wallet is already this address"
        );
        ...
        onlyManager
    {
        require(
            ...
            "RODEOCOIN: The lottery wallet is already this address"
        );
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 developmentTokens = contractTokenBalance.sub(
                marketingTokens
            );
    ...
    function swapTokenToETH(uint256 tokenAmount, address to) external {
        ...
        require(
            ...
            "request balance is over than contract balance"
        );
