...
contract GlobalMoney{
    ...
    string private _name = "Global Money"; // Nama token boleh pake spasi
    string private _symbol = "GLOBALMONEY"; // Symbol tidak ada spasi
    uint8 private _decimals = 18;

    address private _owner;

    address private _devAddress = 0x634c421174B18fc49Fc896F2aCe3021cE7f4DD49;    // dev address
    address private _marketingAddress = 0x14C6957de541D9B054B89c2F081105d2152c764A; // marketing address

    uint256 private _cap   =  0;

    // Private sale misal ada
    ...
    // Ketika awal deploy yang di jalankan program di bawah ini
    constructor() public {

        _owner = msg.sender;

        // Dev Address
        _mint(_devAddress, 2000000*10**18);

        // Marketing Address
        _mint(_marketingAddress,100000*10**18);
    }
...
//         payable(_devAddress).transfer(_msgValue); // pembeli dapet token, kita dapet bnb
//         return true;
//     }
