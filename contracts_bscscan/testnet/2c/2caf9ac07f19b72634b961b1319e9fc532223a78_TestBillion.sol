...
contract TestBillion is Context, IERC20, Ownable {
    ...
    address public _devWallet = 0x51944482997eB509aB8fcad001E3E8B437aC9F74;
    ...
    string private _name = "Test Billion";
    string private _symbol = "TBILL";
    ...
    uint256 public _maxSellPerDay = 1 * 10**6 * 10**9; // Max number of tokens that can be sold per day
    uint256 private transferTime = 10 * 60; // 10 min
    uint256 lastBuy;
