...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x64525db83d42eD463cEDd310d64cfe12208A6fdC;
...
contract HAX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA3c87B95bBa55CD18833691821e812E649EF3Cb4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 5500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Alpha BX";
    string private _symbol = "HAX";
    ...
    uint256 public _maxTxAmount = 5500000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 3500000000 * 10**18;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xA3c87B95bBa55CD18833691821e812E649EF3Cb4);
