...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 0.01 * (10 ** 18);    //minimum distribution set at 0.01bnb
...
contract ETDoge is IBEP20, Auth {
    ...
    address public marketingWalletAddress  = 0x853ded7A72F12EBdEF27F065201c223529a941bf;
    ...
    function setFees(
        ...
        emit FeesUpdated(_enabled, _buybackFee, _reflectionFee, _marketingFee, _feeDenominator);
    }
    ...
    event FeesUpdated(bool enabled, uint256 buybackFee, uint256 reflectionFee, uint256 marketingFee, uint256 feeDenominator);
