...
contract Holder is Context, IBEP20, Ownable {
    ...
    address payable public HolderpoolAddress = 0x98c11ee2346f1Ab63185B92BC83B022feaF4552d; // Holder Pool Address
    ...
    function totalHolderBNB() public view returns (uint256) {
        // BNB has  18 decimals!
        return _tHolderTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tHolderTotal = _tHolderTotal.add(address(this).balance);
        TransferHolderBNB(HolderpoolAddress, address(this).balance);
    }
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _HolderFee == 0) return;
    ...
    function TransferHolderBNB(address payable recipient, uint256 amount) private {
