...
contract Presales is Ownable {
    ...
    //maximum number of BUSD per account.
    ...
    //setPresaleTime is function for setup pre-sale's timestamp. 
    ...
    //setBUSDTokenAddress is function for setup smart contract of token ERC20 that use to buy ECIO Token.
   ...
   //the number of tokens available for buying.
    ...
    //balances is function to show Token balance in smart contract. 
    function balances(address _contractAddress) public view onlyOwner returns(uint)  {
