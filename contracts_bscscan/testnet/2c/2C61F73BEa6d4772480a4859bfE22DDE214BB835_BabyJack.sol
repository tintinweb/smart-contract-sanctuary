...
contract BabyJack is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyJack";
    string constant _symbol = "BJCK";
    ...
    constructor (     
        ...
        address _IDEXRoute=0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
        router = IDEXRouter(_IDEXRoute);
        ...
        approve(_IDEXRoute, _totalSupply);
