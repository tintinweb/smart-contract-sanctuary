...
contract GENIVesting is Ownable {
    ...
    uint private constant SECONDS_PER_MONTH = 400;
    ...
    function distribute() external {
        ...
        bool remainVesting = amountForSeedSale == 0 &&amountForPrivateSale == 0 && amountForPublicSale == 0 && amountForAdvisorsAndPartners == 0 && amountForTeamAndOperations == 0 && amountForMktAndCommunity == 0 && amountForGameTreasury == 0 && amountForFarmingAndStaking == 0;
    ...
    function getAmountForTeamAndOperations(uint month) internal view returns (uint amount) {
        uint maxAmount = 18000000 * 10 ** ERC20(address(geni)).decimals();
        uint publicSaleAmount = 1800000 * 10 ** ERC20(address(geni)).decimals();
