...
contract FirstGovernanceTokenSale {
    ...
    function getCCCC(uint256 _amount) external view returns(uint256) {
        return tokenSaleCost.div(1e18);
    }

    function getDDDDD(uint256 _amount) external view returns(uint256) {
        return tokenSaleCost.div(1e18);
    }
