...
contract NewTOXICgameNFT is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "New TOXICgameNFT";
    string constant _symbol = "NTXC";
    ...
    uint256 pushChartReflectionFee = 2;
    ...
    bool public buyBackEnable = false;
    ...
    uint256 public swapThreshold = _totalSupply ; // 0.00002%
    uint256 public swapThresholdBNB = _totalSupply; // 0.00002%
    bool inSwap;
