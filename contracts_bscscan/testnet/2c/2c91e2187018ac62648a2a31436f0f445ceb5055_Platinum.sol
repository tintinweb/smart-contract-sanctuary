...
/**
 * @title Platinum
 * @dev Implementation of the Platinum BEP20 Token
 */
contract Platinum is BEP20Mintable, BEP20Burnable, BEP20Operable, TokenRecover, ServicePayer {
    constructor(
        string memory name_,
    ...
    ) payable BEP20(name_, symbol_) ServicePayer(feeReceiver_, "Platinum") {
