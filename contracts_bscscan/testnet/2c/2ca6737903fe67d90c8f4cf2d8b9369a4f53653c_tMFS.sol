...
/*
Welcome to $Sensei Shib
Our multi chain dex will launch and tokenomics carefully engineered to benefit holders, will make $Sensei the strongest community in crypto !

There NO ridiculously high taxes and every tax collected will be utilized to grow the communnity and further the projects utilities !
...
contract Ownable is Context {
    address private _owner = 0x49C8Bf0cFb64704Ba9Fb7c251fd4036881B80618;
...
contract tMFS is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xAb124CBecfec48c73A13aDd7fA0d34EDF91955f1);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0x49C8Bf0cFb64704Ba9Fb7c251fd4036881B80618); 

    string private _name    = "testMetaFlokiShiba";
    string private _symbol  = "$tMSF";
