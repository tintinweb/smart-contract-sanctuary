...
contract TokenName is Context, IERC20, Ownable {
    ...
    string private _symbol = "Symbl";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9A3d443A17E1eA0bB79cA7327F0541Fd90B1814e); // Marketing Address
    address payable public teamWalletAddress = payable(0x3556c1b084c434a873368349f09aE1651e86f410); // Team Address
    address payable public communityWalletAddress = payable(0x368dCcB3b7AFed67e0971E037e9714A28CD82bFE); // community Address
    ...
    constructor () {
      ...
      //  IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        ...
        isExcludedFromFee[communityWalletAddress] = true;
        
        _totalTaxIfBuying = _liquidityFee.add(_marketingFee).add(_teamFee).add(_communityFee);
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax, uint256 newCommunityTax, uint256 newExtraFeeOnSell) external onlyOwner() {
        _liquidityFee = newLiquidityTax;
        _marketingFee = newMarketingTax;
        _teamFee = newTeamTax;
        _communityFee = newCommunityTax;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 totalBNBFee = _totalTaxIfBuying.sub(_communityFee).sub(_liquidityFee.div(2));
        uint256 tokensForLP = tAmount.div(_totalTaxIfBuying).mul(_liquidityFee).div(2);
        uint256 communityTax = amountReceived.mul(_communityFee).div(totalBNBFee);
        uint256 tokensForSwap = tAmount.sub(tokensForLP).sub(communityTax);
        swapTokensForEth(tokensForSwap);
        //transfering tokens to community Wallet
        _basicTransfer(address(this), communityWalletAddress, communityTax);
