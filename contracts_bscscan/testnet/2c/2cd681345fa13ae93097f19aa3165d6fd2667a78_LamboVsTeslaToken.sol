...
/**
   ...
   1 in 5 chance to x1.5
   1 in 10 chance to x2

   3% fee auto add to the liquidity pool
   3% fee auto to marketing wallet
...
contract LamboVsTeslaToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress; //= payable(0xb505DAaCA2e254e0a2dF7C15469C31E8EEA624Cc); // Marketing Address
    ...
    string private _name = "LamboVsTesla";
    string private _symbol = "LamboVsTesla";
