...
contract WenlamboMultipleNFTV2 is Initializable,BEP1155Upgradeable, OwnableUpgradeable, BEP1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        BEP1155Upgradeable.__BEP1155_init("", "We-NFT", "We-NFT");
        __Ownable_init();
        _tid = 1;
