...
contract Keymaker is Context, IBEP20, Ownable {
   ...
   address public FeeAddress;
    ...
    constructor (string memory _name, string memory _symbol, uint8 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress, uint256 _charityStarting, address tokenOwner) {
  		_NAME = _name;
  		_SYMBOL = _symbol;
  		_DECIMALS = _decimals;
