...
contract Windmill_Trade_Deployer is Adressable, AccessControlEnumerable, With_DAORole, With_BUSDToken, I_Windmill_Trade_Deployer{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
	...
	function setDeployerCode(bytes memory _bytecode, string memory _name) external onlyRole(DAO_ROLE){
        name = _name;
        bytecode = _bytecode;
    ...
    function _initTrade(I_Windmill_Trade_Abstract trade, address owner, address manager, address fund) internal{
