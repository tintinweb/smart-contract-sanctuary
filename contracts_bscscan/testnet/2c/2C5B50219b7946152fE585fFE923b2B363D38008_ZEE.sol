...
contract ZEE{
    ...
    uint public token_price = 52083333333333;
...
// 	uint public  MINIMUM_BUY = 3e17;
    ...
    event checkValue(string msg, uint256 value, uint256 token);
   //For Token Transfer
   ...
   mapping(address => uint256) public boughtOf;
	...
	function buyToken(uint tokenQty,address _referrer) public payable
	{
	     ...
	     require(tokenQty>=MINIMUM_BUY,"Invalid minimum quatity");
	      emit checkValue("value",token_price,tokenQty);
	     uint256 buy_amt=(tokenQty*token_price)*1e18;
	     require(msg.value>=buy_amt,"Invalid buy amount");
	     emit checkValue("msgvalue",msg.value,buy_amt);
