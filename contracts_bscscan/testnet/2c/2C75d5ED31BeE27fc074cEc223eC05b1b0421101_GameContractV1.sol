...
contract GameContractV1 is HashUpERC20 {
    ...
    modifier isAdminOrModerator() {
        require(msg.sender == admin || msg.sender == moderator, "Caller is not admin or moderator");
        _;
    }
    
    event AdminSet(address indexed oldAdmin, address indexed newAdmin);
    event ModeratorSet(address indexed oldModerator, address indexed newModerator);
    ...
    function changeAdmin(address newAdmin) external isAdminOrModerator returns (bool) {
    ...
    function setDescription(string memory newDescription) public isAdminOrModerator returns (bool) {
    ...
    function setIcon(string memory newIconUrl) public isAdminOrModerator returns (bool) {
        iconUrl = newIconUrl;
        return true;
    }
    ...
    function setGameUrl(string memory newGameUrl) public isAdminOrModerator returns (bool) {
        gameUrl = newGameUrl;
        return true;
    }
    ...
    function setGameLandingPageUrl(string memory newLandingPageUrl) public isAdminOrModerator returns (bool) {
    ...
    function setTelegramUrl(string memory newTelegramUrl) public isAdminOrModerator returns (bool) {
    ...
    function setFacebookUrl(string memory newFacebookUrl) public isAdminOrModerator returns (bool) {
    ...
    function setInstagramUrl(string memory newInstagramUrl) public isAdminOrModerator returns (bool) {
    ...
    function setLinkedinUrl(string memory newLinkedinUrl) public isAdminOrModerator returns (bool) {
    ...
    function setTrailerUrl(string memory newTrailerUrl) public isAdminOrModerator returns (bool) {
    ...
    function pushCreatorGame(address creatorGame) public isAdminOrModerator returns (bool) {
        creatorGames.push(creatorGame);
        return true;
    }
    
    function removeForCreatorGameArray(uint index) public isAdminOrModerator returns (bool) {
    ...
    function setCreatorCompanyName(string memory newCompanyName) public isAdminOrModerator returns (bool) {
    ...
    function setCreatorCompanyUrl(string memory newCompanyUrl) public isAdminOrModerator returns (bool) {
    ...
    function setCreatorCompanyIconUrl(string memory newCompanyIconUrl) public isAdminOrModerator returns (bool) {
    ...
    function setCreatorCompanyLogoUrl(string memory newCreatorCompanyLogo) public isAdminOrModerator returns (bool) {
    ...
    function getLikes() public view returns (uint) {
        return likes.length;
    }
    
    function getDislikes() public view returns (uint) {
    ...
    function setStartPriceInHash(uint256 startPriceInHash_) public isAdminOrModerator returns (bool) {
    ...
    // string[] public tags;
    function setTags(string[] memory tags_) public isAdminOrModerator returns (bool) {
        tags = tags_;
        return true;
    }
