...
contract denovo is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 10**_decimals;     // Supply do Token = 20 billions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 30000 * 10**_decimals;    // 30 millions - Initial max buy
    uint256 public _maxRxAmount = 10000 * 10**_decimals;    // 10 millions - Initial max sell
	uint256 public _maxWallet = 300000 * 10**_decimals;     // 300 millions - Initial max Wallet	
    uint256 public numTokensToSwap = 5000 * 10**_decimals; // 5 millions
	uint public sellPerSecond = 1; // 20seconds
    uint public buyPerSecond = 1;	// 10seocnds
    ...
    string private constant _name = "denovo";
    string private constant _symbol = "dnv";
