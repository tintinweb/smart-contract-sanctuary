...
contract SotaLuckyNFTv2 is Ownable {
    ...
    {
        return (rounds[_roundId], rounds[_roundId].firstPrize, rounds[_roundId].secondPrize, rounds[_roundId].thirdPrize, fourthPrize[_roundId], 
            fifthPrize[_roundId], rounds[_roundId].specialPrize);
    }
