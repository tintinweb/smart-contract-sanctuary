...
contract Olympia is ERC20, Ownable {
    ...
    bool public _abc_shouldSendFeesToWallet = true;
    function abc_setShouldSendFeesToWallet(bool enabled) external onlyOwner {
        _abc_shouldSendFeesToWallet = enabled;
    }

    bool public _abc_shouldLiquidy = true;
    function abc_setShouldLiquify(bool enabled) external onlyOwner {
        _abc_shouldLiquidy = enabled;
    }
    ...
    function _swap() private swapping {
        ...
        if (_abc_shouldSendFeesToWallet) {
        ...
        if (_abc_shouldLiquidy) {
            ...
            uint256 liquidityEthAmount = ethAmount.mul(liquidityFeesPerTenThousand).div(totalFeesPerTenThousand);
            _liquify(liquidityTokenAmount, liquidityEthAmount);
        }
    }

    function abc_swap() external onlyOwner {
        uint256 tokenBalance = balanceOf(address(this));
        (
            uint256 liquidityFeesPerTenThousand,
            /* uint256 teamFeesPerTenThousand */,
    ...
    function abc_liquify() external onlyOwner {
        uint256 tokenBalance = balanceOf(address(this));
        (
            uint256 liquidityFeesPerTenThousand,
            /* uint256 teamFeesPerTenThousand */,
    ...
    function abc_sendFeesToTeamWallet() external onlyOwner {
        (
            /* uint256 liquidityFeesPerTenThousand */,
            uint256 teamFeesPerTenThousand,
            /* uint256 providerFeesPerTenThousand */,
    ...
    function abc_sendFeesToProviderWallet() external onlyOwner {
        (
            /* uint256 liquidityFeesPerTenThousand */,
            /* uint256 teamFeesPerTenThousand */,
            uint256 providerFeesPerTenThousand,
    ...
    function abc_sendFeesToMarketingWallet() external onlyOwner {
        (
            /* uint256 liquidityFeesPerTenThousand */,
            /* uint256 teamFeesPerTenThousand */,
            /* uint256 providerFeesPerTenThousand */,
