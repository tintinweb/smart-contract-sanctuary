...
/// @custom:security-contact [email protected] //TODO: change this when u have domain name
 ...
 * Fund sends back BNB to contract, function to distribute them and make them claimable so that we don't pay the gas fee can be another contract tho
 */

 //RUN ALL TEST THAT HAS TODO WITH VOTING WITH A REAL DEPLOYMENT COMPATING IT WITH THE VOTING FROM WIZARD AND GOV THING G LESGO

/**
 * SPDX-License-Identifier: MIT
 * OpenZeppelin libraries
 * Optimized: Yes; basecode, multisigwallet, vote
 */
pragma solidity ^0.8.4;
