...
contract SharkMarketplace is Pausable, AccessControl, Utils {
        ...
        internal
    {
        ...
        require(_nftContract.ownerOf(_sireId) == _msgSender(), "SharkMarketplace: _sireId own error");
        require(_nftContract.ownerOf(_matronId) == _msgSender(), "SharkMarketplace _matronId own error");
