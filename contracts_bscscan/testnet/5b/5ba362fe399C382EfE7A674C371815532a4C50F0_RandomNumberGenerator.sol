...
// File: contracts/interfaces/ICrosschainSwapLottery.sol

pragma solidity ^0.8.4;

interface ICrosschainSwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in PYE per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in PYE token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInPYE: price of a ticket in PYE
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public CrosschainSwapLottery;
     ...
     * @param _seed: seed provided by the CrosschainSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == CrosschainSwapLottery, "Only CrosschainSwapLottery");
    ...
    /**
     * @notice Set the address for the CrosschainSwapLottery
     * @param _CrosschainSwapLottery: address of the CrosschainSwap lottery
     */
    function setLotteryAddress(address _CrosschainSwapLottery) external onlyOwner {
        CrosschainSwapLottery = _CrosschainSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ICrosschainSwapLottery(CrosschainSwapLottery).viewCurrentLotteryId();
    }
}