...
contract Bullish is Context, IERC20, Ownable { //CHANGE IT
    ...
    address payable public marketingWalletAddress = payable(0x9F5FdaE4680068fb0BAfEC1dE7Ca3054461818e4); // Marketing Address //CHANGE IT
    address payable public buyBackWalletAddress = payable(0xe8aa3db99396cf267A22F1cF74bf503f3215D98e); // buyback Address     //CHANGE IT
    ...
    uint256 public _walletMax               = 500 * 10**6 * 10**9;  // 500 million
