...
/*
🚀DIVIDEND YIELD PAID IN SAFEMOON!🚀

💰• 7% Safemoon Redistribution
💷• 5% Marketing/Development
💴• 3% Liquidity

📞 Telegram: @babysafemoon_Official
...
contract BabySAFEMOON is IBEP20, Auth {
    ...
    string constant _name = "Baby SAFEMOON";
    string constant _symbol = "babysafemoon";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000000000 * 10**_decimals;

    uint256 public _maxWalletToken = 1000000000000000 * 10**_decimals;
