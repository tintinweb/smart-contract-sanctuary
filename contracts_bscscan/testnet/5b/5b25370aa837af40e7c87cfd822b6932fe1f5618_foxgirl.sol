...
contract foxgirl is Context, IERC20, Ownable { 
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require(Buy_Fee <= maxPossibleFee, "Buy fee set too high!");
        require(Sell_Fee <= maxPossibleFee, "Sell fee set too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
    ...
    */
    ...
    // Set the maximum permitted wallet holding (in tokens)
    ...
    function _transfer(
        ...
        */
        ...
        Set fee for amount for buy or for sell.
    ...
    */
    ...
    // Manual Tokens Process Trigger - Enter the percent of the tokens that you'd like to send to process
