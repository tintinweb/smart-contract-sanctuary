...
import "./MetaNFTBase.sol";

contract MetaBuilding is MetaNFTBase {
    constructor() ERC721("Meta Building", "MTB") {}
}
...
abstract contract MetaNFTBase is
    ERC721,
    ...
    Ownable
{
    ...
    // ========== Events ========== //
    event Birth(address indexed _owner, uint256 indexed _tokenId);
    ...
    /**
     * @dev Lock token to use in game
     */
    function lock(uint256 tokenId) public {
        require(approvalWhitelists[_msgSender()], "Must be valid approval whitelist");
    ...
    function unlock(uint256 tokenId) public {
        require(approvalWhitelists[_msgSender()], "Must be valid approval whitelist");
        require(_exists(tokenId), "Must be exist");
