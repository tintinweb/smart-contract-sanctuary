...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Captain T";
    string internal constant SYMBOL = "CBT";
    ...
    /**
     * @dev Wallet for feeType.External
     */

    address internal devAddress = 0x559acE6C43266065D0C5eBe7cf18c33e648AAA6E;

    enum FeeType {Antiwhale, Liquidity, Rfi, External }
    struct Fee {
        FeeType name;
        uint256 value;
        address recipient;
