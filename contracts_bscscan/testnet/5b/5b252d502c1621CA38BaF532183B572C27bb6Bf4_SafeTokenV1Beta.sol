    ...
    ReentrancyGuard
{
    ...
    // from tokenId to value added
    mapping(uint256 => uint256) internal token2value;
    ...
    function addNftTokenValue(
        ...
        require(
            _nftToken.balanceOf(_msgSender) > 0,
        ...
        onlyIfVestingScheduleNotRevoked(vestingScheduleId)
    {
        ...
        //isCurrentlyVesting[_beneficiary] = false;
