...
contract SexyDodge is Context, IERC20, Ownable {
    ...
    string private _name = "Sexy Doge";
    string private _symbol = "SxDoge";
    ...
    address public teamWallet = 0x1458b54ef432337aB78876a5A3A162De1C00e538;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _charityFee== 0 && _burnFee== 0 && _teamFee== 0 ) return;
