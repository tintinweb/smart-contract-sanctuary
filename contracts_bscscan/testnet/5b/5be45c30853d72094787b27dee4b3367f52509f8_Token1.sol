...
contract Token1 is Context, IBEP20, Ownable {
    ...
    function destributeTokens() public onlyOwner{
        ...
        _transfer(owner(),0xF6219136cAF8DE409C479a4051AEEe23C3940c4e, (totalSupply().mul(20)).div(100));  // invertors
        _transfer(owner(),0xD911b333c88b31b014ef50a0C59F384a402953d9, (totalSupply().mul(10)).div(100)); //development team 
        _transfer(owner(),0x7763634A64f42238AF897722abf8379f7620Bc80, (totalSupply().mul(3)).div(100)); //Marketing team 
        _transfer(owner(),0xC8934823c0a96e9b0170098D975902d22E22f84c, (totalSupply().mul(7)).div(100)); //charity team 
        _transfer(owner(),0x92D633d2b88a49019916DDb1d0CEAC57503E4A3D, (totalSupply().mul(10)).div(100)); //advisor team 
        hasDestritubed==true;
    }
   ...
   */
   function buyToken() public payable{
       ...
       require(CurrentTokens<(totalSupply().mul(47)).div(100),"Pre Sale ENDS");
       payable(owner()).transfer(msg.value);
       _transfer(owner(),msg.sender,(((msg.value*(10**18))/rate)));
       CurrentTokens=CurrentTokens+(msg.value*(10**18))/rate;
       CurrentTokens=CurrentTokens+(msg.value*(10**18))/rate;
   }
