...
contract ServiceReceiver is Ownable {
    ...
    string private SimpleBEP20;
    string private StandardBEP20;
    string private BurnableBEP20;
    string private MintableBEP20;
    string private CommonBEP20;
    string private UnlimitedBEP20;
    string private AmazingBEP20;
	...
	constructor () {
	setPrice(SimpleBEP20,100000000000000000);
	setPrice(StandardBEP20,200000000000000000);
	setPrice(BurnableBEP20,300000000000000000);
	setPrice(MintableBEP20,500000000000000000);
	setPrice(CommonBEP20,  600000000000000000);
	setPrice(UnlimitedBEP20,750000000000000000);
	setPrice(AmazingBEP20,1000000000000000000);
	//setPrice(SimpleBEP20,1000000000000000000);
	}
