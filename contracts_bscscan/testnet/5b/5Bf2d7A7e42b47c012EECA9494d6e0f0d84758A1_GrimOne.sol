...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BTCB = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
// CHANGE
contract GrimOne is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address BTCB = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GrimOne";
    string constant _symbol = "grONE";
