...
4% fee added to development and team wallet
2% fee added to marketing wallet
4% fee added to wallet for buyback SmokyDoge in dip
*/
...
contract SmokyDoge is Context, IBEP20, Ownable {
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x10CA6AB56D052E59Af8c2c0E1Adc3C77AB34a9b6),                             // Dev+Team wallet
        payable(0xa2dA71Ecfd3D8693CF003195B0FeBd9948021cA0),                             // Marketing wallet
        payable(0x0e2D2EBD6A60b4F009D50DeDdCa4b49Ff6026Bd2)                              // Buyback wallet
    ];
    // ********************************** END VARIABLES ***********************************
