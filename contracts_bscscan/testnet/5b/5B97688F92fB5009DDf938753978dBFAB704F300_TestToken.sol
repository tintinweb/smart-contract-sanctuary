...
contract TestToken is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, address _FeeAddress,address tokenOwner) {
		_NAME = _name;
		_SYMBOL = _symbol;
		_DECIMALS = 9;
		_DECIMALFACTOR = 10 ** uint256(9);
		_tTotal = 1000000000000000000000;
    ...
    uint256 public _maxTxAmount = 1000000000000000000; // Max Transaction: 1 Trillion (0.1%)
    uint256 public _maxWalletToken = 8000000000000000000; // Max Wallet: 8 Trillion (0.8%)
