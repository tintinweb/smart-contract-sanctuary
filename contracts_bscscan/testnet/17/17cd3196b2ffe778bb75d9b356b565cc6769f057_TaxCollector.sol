...
contract TaxCollector is Ownable {
  ...
  function setBuyandback (uint256 percent_, address wallet_) public onlyOwner { buybackandburnPercentage = percent_; buybackandburnWallet = wallet_; }
  ...
  , IERC20Metadata
{
  ...
  function setBuybackandburnTax(uint256 percent_, address wallet_) public onlyOwner { iTaxCollector.setBuyandburn(percent_, wallet_); }
