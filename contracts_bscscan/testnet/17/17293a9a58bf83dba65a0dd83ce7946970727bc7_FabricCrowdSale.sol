...
contract Fabric is ERC20Interface, SafeMath{
    ...
    address owner;
    string  public name = "Fabric DeFi";
    string  public symbol = "FABS";
...
contract FabricCrowdSale{
    ...
    uint256 internal bnbBasePrice;
    
    
    uint256 internal tokenAllocation = 5000000 * 10 **18;
    ...
    constructor(address _tokenContract) public{
        ...
        bnbBasePrice  = 1000000000000000000; ///baseprice of 1BNB in wei
        bnbTokenPrice = 485436890000000; ///one week average BNB price equivalent in wei
    ...
    function calculateNumberOfTokens(uint256 _investment)internal view returns(uint256){
      _investment = safeMul(msg.value,bnbBasePrice); 
      return safeDiv(_investment,bnbTokenPrice);  
    }
    ...
    function returnTokenBal() onlyOwner public returns(bool){
