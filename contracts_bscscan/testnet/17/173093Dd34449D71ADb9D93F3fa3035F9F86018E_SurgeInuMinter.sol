...
contract SurgeInu is ERC721Tradable{
  constructor() ERC721Tradable("Surge Inu NFT", "SINU") {  }

  function baseTokenURI() override public pure returns (string memory) {
        return "https://storage.googleapis.com/surgeinu/Jsons/";
  }
...
contract SurgeInuMinter is Ownable {
    using Strings for string;
    using SafeMath for uint256;
    ...
    function mint(address _toAddress, uint256 amount) external payable {
        ...
        SurgeInu jrnyClub = SurgeInu(nftAddress);
    ...
    function withdraw() external onlyOwner {
        ...
        address wallet = 0xA6E7D32a6318f9B207d564Ed1fB69933DF782bdA;
