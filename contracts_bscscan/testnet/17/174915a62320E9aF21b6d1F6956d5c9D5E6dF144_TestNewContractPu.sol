...
contract TestNewContractPu {
    ...
    uint256 public constant survey = 7700;
    ...
    function getPublicOne(uint256 a) public view returns (uint256) {
        if(a == 1){
           return  number;
        }else{
            return survey;
    ...
    function getCalculator(uint256 a, uint256 b) internal pure returns (uint256) {
        return (a+b);
    }
}