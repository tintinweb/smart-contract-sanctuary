...
*/
contract Akeelah is Context, IERC20, Ownable {
    ...
    string private constant _name = "Akeelah";
    string private constant _symbol = "AKEELAH";
    ...
    uint256 public _maxTxAmount = 10000000000 * 10**18; // 1% of max supply 
    uint256 public numTokensSellToAddToLiquidity = 1000000000 * 10**18; //0.1% of max supply
    ...
    constructor() {
        ...
        _MarketingWalletAddress = 0x82A4C9437C7aA6711b79e8916820a86761c43619;
