...
contract DancerContract is Ownable {
    ...
    address public marketingWallet = 0xEe47465e3283D9B9678657A0A545bD3CBE070B39;
...
contract Cocktail is ERC20, Ownable {
    ...
    address payable public marketingWallet = 0xEe47465e3283D9B9678657A0A545bD3CBE070B39;
    ...
    function setBeginning(bool value) external onlyOwner {
        beginningOn = value;
    }

    function getTradingBeginning() external onlyOwner view returns (bool,bool)
    {
        return (tradingIsEnabled, beginningOn);
    }
