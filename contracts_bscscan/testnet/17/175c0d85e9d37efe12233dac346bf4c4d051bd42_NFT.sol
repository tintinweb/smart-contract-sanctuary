...
contract NFT is ERC721Enumerable , ReentrancyGuard , Ownable{
    ...
    constructor() ERC721("DNX NFT", "DNX NFT" ,"https://erc721.helixnft.net/metadata/") Ownable() {
        ...
        _setLeverMultiple(1,1);
        _setLeverMultiple(2,2);
		_setLeverMultiple(3,4);
        _setLeverMultiple(4,8);
        _setLeverMultiple(5,16);
        _setLeverMultiple(6,25);
        _setLeverMultiple(7,50);
        _setLeverMultiple(8,75);
        _setLeverMultiple(9,100);
        _setLeverMultiple(10,200);
        _setLeverMultiple(11,300);
        _setLeverMultiple(12,500);		
	...
	function _setImgURI(string memory imgURI_) internal {
        _imgURI = imgURI_;
    }
  ...
  //      nftMap[_NftId].name = roleAttMap[_roleId].name;
	...
	function setLeverMultiple(uint256 _leverId, uint256 _multiple)external onlyOwner{
		_setLeverMultiple(_leverId,_multiple);
	}	
