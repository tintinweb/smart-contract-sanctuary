...
contract Presale is Ownable, ReentrancyGuard {
    ...
    function claimCrss() external onlyOwner {
        uint256 balance = crssToken.balanceOf(address(this));
        crssToken.transfer(masterWallet, balance);
        emit ClaimCrss(address(this), masterWallet, balance);
    }
