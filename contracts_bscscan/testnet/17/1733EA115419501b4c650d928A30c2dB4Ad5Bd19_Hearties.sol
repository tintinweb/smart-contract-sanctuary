...
contract Hearties is PausableToken {
    ...
    function buyTokens() payable public {
        ...
        uint tokenPresalePrice;
        uint tokensBought;
       // address buyer = msg.sender;
        
       tokenPresalePrice = 1000000000000000000/10000 * 1; // 1 token is equal to 10^14 wei
       tokensBought = msg.value / tokenPresalePrice; // sent value divided by per token price
       //buyer.transfer(tokensBought);
