...
contract LASTTOKEN is Context, IBEP20, Ownable {
    ...
    string private _name = "LTK";
    string private _symbol = "LTK";
    ...
    uint256 public timeDay = 10 * 60;   // 20min
    uint256 public timeWeek = 20 * 60;  // 40min
    uint256 public timeMonth = 40 * 60; // 1h
