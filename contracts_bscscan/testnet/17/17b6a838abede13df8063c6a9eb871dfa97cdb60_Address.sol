...
contract ZEZOL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0x150D69d0f8e751951ED6eBd40C6782d8718D32f6); 
    ...
    uint256 private _tTotal = 2137000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ZEZOL Coin";
    string private _symbol = "ZEZOL";
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 1;
        _liquidityFee = 10;
        _maxTxAmount = 4000000 * 10**6 * 10**9;
    }
