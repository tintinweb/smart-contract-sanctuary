...
contract GalaxyRebase is ERC20Detailed, Ownable {
    ...
    uint256 public wagersFee = 10;
    uint256 public totalFee =
        ecosystemFee.add(liquidityFee).add(marketingFee).add(wagersFee);
    ...
    address public wagersFeeReceiver;
    ...
    constructor() ERC20Detailed("GalaxyRebase", "GalaxyRebase", uint8(DECIMALS)) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Sushi 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 // Cake 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        ...
        marketingFeeReceiver = 0xafAB8f77E71C93B8383eC23f3c79Fb6aAF953769;
        ecosystemFeeReceiver = 0x4Cc6Eceb3e88570b0e9927e387AC6c655A6454AF;
        wagersFeeReceiver = 0x8Fa106bD76803c3674D06b1248d3c4A8Ff00EF0C;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHLiquidity = amountETH
            ...
            .div(totalETHFee)
            .div(2);
        uint256 amountETHWagers = amountETH.mul(wagersFee).div(totalETHFee);
        ...
        (success, ) = payable(wagersFeeReceiver).call{
            value: amountETHWagers,
            gas: 30000
        }("");
    ...
    function setFees(
        ...
        wagersFee = _wagersFee;
        marketingFee = _marketingFee;
        totalFee = ecosystemFee.add(liquidityFee).add(marketingFee).add(wagersFee);
    ...
    function setFeeReceivers(
        ...
        address _wagersFeeReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        ecosystemFeeReceiver = _ecosystemFeeReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        wagersFeeReceiver = _wagersFeeReceiver;
    }
