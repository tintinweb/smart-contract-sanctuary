...
contract META_45 is Context, IERC20, Ownable {
    ...
    string private _name = "META_45";
    string private _symbol = "META_45";
    ...
    modifier if_All_Yes_Votes() {
        ...
        uint256 required_votes_count = Marketing_Managers_Count + Blockchain_Managers_Count + 1;
    ...
    function F44_Add_Marketing_Manager(address account) external {
    ...
    function F47_Add_Blockchain_Manager(address account) external {
        require(!Security_Provider[account], "A Security Provider cannot have other roles");
        require(account != Security_Manager, "A Security Manager cannot have other roles");
