...
/**
    DeerGirl:
    https://t.me/deergirlcoin
    https://deergirlcoin.com
*/
...
contract DeerGirl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x1769df787CA0d69d871a9d590801AF473B81e43B); // Marketing Address
        
    address payable public teamAddress =
        payable(0x000000000000000000000000000000000000dEaD); // Team Address
    ...
    string private constant _name = "DeerGirl";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 2 / 1000; // 0.2% maxTransactionAmountTxn
        maxWallet = _tTotal * 2 / 100;  // 2% Max wallet
