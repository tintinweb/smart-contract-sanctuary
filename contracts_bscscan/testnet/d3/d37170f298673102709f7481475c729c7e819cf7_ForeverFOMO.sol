...
contract ForeverFOMO is ERC20Detailed, Ownable {
    ...
    uint256 private gonSwapThreshold = (TOTAL_GONS * 100) / 1;
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
    ...
    constructor() ERC20Detailed("ForeverFOMO", "ForeverFOMO", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0xA095121E91d6D7542c32B65E61060D48a10E9Bb9;
        ecosystemFeeReceiver = 0xA095121E91d6D7542c32B65E61060D48a10E9Bb9;
        buyBackFeeReceiver = 0xA095121E91d6D7542c32B65E61060D48a10E9Bb9;
