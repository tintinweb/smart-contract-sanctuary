...
contract TresLechesCake is IBEP20, Auth {
    ...
    //We need to define wallets here.
            ...
            marketingFeeReceiver = msg.sender;//msg.sender; //Set Marketing Wallet
            charityFeeReceiver = msg.sender; //msg.sender; //Set Charity Wallet
            devFeeReceiver = msg.sender; // Set Dev Wallet
