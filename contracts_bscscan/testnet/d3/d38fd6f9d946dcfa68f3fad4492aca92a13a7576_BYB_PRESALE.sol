...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function rate() public view returns (uint256) {
        // if (amountWei >= 50000000000000000) { return ((_rate / 100) * 120); } // 20 percent bonus on presale period, returns 12000
        return _rate;
    }
...
contract PostDeliveryCrowdsale is TimedCrowdsale {
    ...
    function _processPurchase(address beneficiary, uint256 tokenAmount) internal {
        ...
        if(tokenAmount >= 5000000){
             _deliverTokens(address(_vault), tokenAmount.add(1000000));
        }
...
// File: contracts/IndividuallyCappedCrowdsale.sol
...
contract BYB_PRESALE is Crowdsale, CappedCrowdsale, TimedCrowdsale, CapperRole, Ownable, PostDeliveryCrowdsale,WhitelistedRole{
    ...
    function _updatePurchasingState(address beneficiary, uint256 weiAmount) internal {
     ...
     function addManyWhitelisted(address[] memory accounts)
            public
            onlyWhitelistAdmin
        {
