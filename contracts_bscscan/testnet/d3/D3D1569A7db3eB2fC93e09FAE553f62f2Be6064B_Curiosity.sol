 ...
 * 
   Name: Curiosity
   Symbol: CURIOZ
   Total Supply: 100,000,000 CURIOZ
   
   Website: https://Curioscrew.com
   Twitter: https://twitter.com/Curioscrew
   Reddit: https://www.reddit.com/r/Curioscrew
   Telegram: https://t.me/Curioscrew
   GitHub: https://github.com/Curioscrew
 * 
 **/
...
contract Curiosity is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private constant _SYMBOL = "CURIOZ";
    ...
    address public burnAddress = 0x0C9186611Cfc19B11D712112fE33E86BF3eB9678; 
    ...
    function swapTokensForBnb(uint256 tokenAmount) private {
        ...
        // make the swap
        // @dev A reliable Oracle is to be introduced to avoid possible sandwich attacks.
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmount) external onlyOwner() {
        require(newAmount <= 1e6 * 10**_DECIMALS, 
            "BEP20: the amount must be lesser than or equal to one hundred thousand."
        );      
