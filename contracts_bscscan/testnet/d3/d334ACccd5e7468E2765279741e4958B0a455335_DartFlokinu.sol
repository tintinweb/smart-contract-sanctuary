...
//Redesigned By Maverick and Cryptomaniacs Team
// https://www.dartflokiinu.com/
// https://t.me/DartFlokiInu
...
contract DartFlokinu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DartFlokiu";
    string constant _symbol = "DFfg";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1225 * 10**10 * 10**_decimals;

    uint256 public _maxTxAmount = 61250000000000;
    uint256 public _maxWalletToken = 61250000000000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xaAB1c14Ff1A647d44AED28D2090FF283513F59fE;
        teamFeeReceiver = 0x16710444BF00456b6E7e5b3Fa050E259A1A390E2;
        charityFeeReceiver = 0x3C6C3Cd7C9934B55aa8Ef937c029b73d59dfa793;
