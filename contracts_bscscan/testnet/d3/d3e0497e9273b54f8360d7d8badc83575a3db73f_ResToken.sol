...
contract ResToken is BEP20 {
	...
	// start Block Swap
    uint256 public startBlockSwap = 19352680;
    // Min amount to swap. (default 2 RESs)
    uint256 public minAmountToSwap = 2 ether;
	// Min buy to get Reward	
	uint256 public minBuyBid = 1 ether ;
	// time bid	(default 100 block)
	uint16 public timeBid = 60;
	IBEP20 public BUSD = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
	...
	uint256 public timeLimitSwap = 1;
     ...
     */
    constructor() public BEP20("RestaurantDeFi Token", "RES11") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
		...
		if (limitSwap == true && _excludedPoolsContracts[sender] == false && _excludedPoolsContracts[recipient] == false) {	
			...
			if(swapToBNBEnabled == true && amount >= minBuyBid && buyTransaction == true){ 
				...
				if(checkWin > timeBid && lastReward > 0){
					uint256 sendReward = lastReward.mul(60).div(100);
				...
				winnersInfo[0].reward = lastReward.mul(60).div(100);
        ...
        if (recipient == BURN_ADDRESS || transferTaxRate == 0) {
            ...
            require(taxAmount == burnAmount + rewardAmount, "RES::transfer: Burn value invalid");
