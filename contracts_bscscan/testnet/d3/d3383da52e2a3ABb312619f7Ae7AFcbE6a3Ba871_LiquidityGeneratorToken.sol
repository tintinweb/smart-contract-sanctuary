...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    // bsc testnet router
    address public router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // PCS v2 testnet
    ...
    constructor (address tokenOwner,string memory name, string memory symbol,uint8 decimal, uint8 setTaxFee, uint8 setLiqFee, uint256 _maxTaxFee, uint256 _maxLiqFee, uint256 _minMxTxPer) public {
        _name = name;
        _symbol = symbol;
        _decimals = decimal;
        uint256 amountOfTokenWei = 250000000000000000;
