...
contract InfinityRIZE is Context, IERC20, Ownable {
    ...
    uint256 public _circulatingSupply = (_tokenTotal - (_tokenBalance[deadAddr] + _tokenBalance[zeroAddr] +_tokenBalance[rewardsVault]));
    ...
    function rewardsVaultBalance() public view returns (uint256) {
        return _tokenBalance[rewardsVault];
    }
