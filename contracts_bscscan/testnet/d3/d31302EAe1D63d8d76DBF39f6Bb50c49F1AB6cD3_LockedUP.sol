...
contract LockedUP is IBEP20, Ownable
{
	...
	uint256 private enableDecliningTaxes = 0; //Usually enabled after launch using the onlyOwner functions coded in
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            //Declining Taxes
            if(block.timestamp >= dTTimer + hourlyCheck && _sellTax == 13 && enableDecliningTaxes == 1) {
                _buyTax=13;
