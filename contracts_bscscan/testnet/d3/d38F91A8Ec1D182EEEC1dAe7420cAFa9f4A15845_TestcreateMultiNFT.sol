...
contract TestcreateMultiNFT is Ownable, ReentrancyGuard {
    ...
    struct SaleBox {
        ...
        uint256 qtyThirdStar;
        uint256 qtySecondStar;
    }
    ...
    constructor(
        ...
        saleBoxs[0] = SaleBox(0, 720 * 10 ** 18, 1635458400, 1635717600, 5, 10, 1000, 0, 5000, 10000);
        saleBoxs[1] = SaleBox(1, 480 * 10 ** 18, 1635458400, 1635717600, 2, 7, 1000, 0, 5000, 10000);
        saleBoxs[2] = SaleBox(2, 240 * 10 ** 18, 1635458400, 1635717600, 1, 5, 3000, 0, 5000, 10000);
    }
