...
contract Swap is ISwap, SwapCore, AccessControlEnumerable, ReentrancyGuard {
    ...
    */
    ...
    // See SwapCore.sol
    function addSwap(address itemToken_, uint256 fee_, uint256 supply_, uint256 tokenType_) external onlyRole(ADMIN_ROLE) {
    ...
    // See SwapCore.sol
    function addERC20Swap(address currencyToken_, address itemToken_, uint256 fee_, uint256 supply_, uint256 tokenType_) external onlyRole(ADMIN_ROLE) {
