...
contract Megatron is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress = payable(0x89BC8F12048B7BeB78bC50634f8Bc850f235f2FB);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 100000000000000000, "MGD: MaxtxAmount must be more than 100000000000000000 ");
