...
contract OneSplitRoot is IOneSplitView {
    ...
    IERC20 internal constant dai =
        IERC20(0x5592EC0cfb4dbc12D3aB100b257153436a1f0FEa);
    IERC20 internal constant usdc =
        IERC20(0x4DBCdF9B62e891a7cec5A2568C3F4FAF9E8Abe2b);
    IERC20 internal constant usdt =
        IERC20(0xD9BA894E0097f8cC2BBc9D24D308b98e36dc6D02);
    ...
    IUniswapV2Factory internal constant tokenStand =
        IUniswapV2Factory(0x55F5E5ec8f3761A0cB39658Ff54564797D6f30F8);
...
contract OneSplitView is IOneSplitView, OneSplitRoot {
    ...
    function _calculateTokenStand(
        ...
        IERC20 fromTokenReal = fromToken.isETH() ? weth : fromToken;
        IERC20 destTokenReal = destToken.isETH() ? weth : destToken;
        IUniswapV2Exchange exchange = tokenStand.getPair(
            fromTokenReal,
            destTokenReal
        );
        if (exchange != IUniswapV2Exchange(0)) {
