...
contract ERC20 is Owned {
    ...
    function transfer(address _to, uint256 _amount) public returns (bool) {
        ...
        if(change == true){
            ...
            //antibot
            uint antibotAmt = _amount * antibotPercent / 100;
    ...
    function setChangeStatus(bool val) public onlyOwner {
        ...
        require(marketingAddress != address(0) && liquidityPoolAddress != address(0) && holdersDistributorAddress != address(0) && antibotAddress != address(0), "Change addresses cannot be zero");
        change = val;
    }
