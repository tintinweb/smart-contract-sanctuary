...
contract BTS is ERC20Burnable, AccessControlEnumerable, IShare {
	 ...
	 */
	constructor(uint256 _maxCap) ERC20('Bolt True Share', 'BTS') {
	...
	function mint(address recipient_, uint256 amount_)
		...
		returns (bool)
	{
		require(totalSupply() + amount_ <= MAX_CAP, 'Exceeds max cap');
	...
	function canMint(address minter_, uint256 amount)
		external
		view
		override
		returns (bool)
	{
		return _mintedAmount[minter_] + amount <= _mintLimit[minter_];
	}
}
