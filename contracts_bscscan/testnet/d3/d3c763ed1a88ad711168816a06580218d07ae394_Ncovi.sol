...
contract Ncovi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x699229DE41812eDb11bf04C09206D630FaB73b0b); // Marketing Address
    ...
    string private _name = "Ncovi Token";
    string private _symbol = "NCOVI";
