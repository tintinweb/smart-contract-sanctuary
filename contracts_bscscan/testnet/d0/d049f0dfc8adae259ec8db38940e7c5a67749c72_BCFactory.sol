...
contract BCFactory is Ownable {
	...
	//Cake
	address constant _pancakeRouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
	...
	constructor(address payable devAddr, address payable projectAddr, address payable marketingAddr, uint256 start, address _cakeTokenAddress) {
		...
		_cakeAddress = _cakeTokenAddress;
        _cakeToken = IBEP20(_cakeTokenAddress);
	}
