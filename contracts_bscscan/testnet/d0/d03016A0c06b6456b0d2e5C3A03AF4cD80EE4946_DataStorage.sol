...
contract DataStorage {
    ...
    function getPandoBoxPower(uint256 _pandoBoxLevel) external pure returns(uint256) {
        return 0;
    }
    ...
    function getJDroidBotCreating(uint256 _pandoBoxLevel) external view returns (uint256, uint256) {
        return (100000 * 10000 * (MULTIPLIER ** _pandoBoxLevel) / (PRECISION ** _pandoBoxLevel), 100 * 2000000 * (MULTIPLIER ** _pandoBoxLevel) / (PRECISION ** _pandoBoxLevel));
    }

    function getJDroidBotUpgrading(uint256 _droidBot0Level, uint256 _droidBot1Level) external view returns (uint256, uint256) {
        //_droidBot1Level <= _droidBot0Level
        return (100000 * 10000 * (MULTIPLIER ** _droidBot1Level) / (PRECISION ** _droidBot1Level),100 *  2000000 * (MULTIPLIER ** _droidBot1Level) / (PRECISION ** _droidBot1Level));
    }
}
