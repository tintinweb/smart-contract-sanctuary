...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x4Fb99590cA95fc3255D9fA66a1cA46c43C34b09a); //the reward token you want distributed - AVAX
...
contract ChristmasElf is IBEP20, Auth {
    ...
    address REWARDS = 0x4Fb99590cA95fc3255D9fA66a1cA46c43C34b09a; // AVAX
    ...
    address public charityWallet = 0x6fDf209E24C4509722B8FFE333D8c58170767339;
    ...
    uint256 public buyingRewardFee = 3;
    
    uint256 public sellingLpFee = 2;
    uint256 public buyingLpFee = 2;
    
    uint256 public sellingCharityFee = 1;
    uint256 public buyingCharityFee = 1;
    
    uint256 public sellingDevFee = 1;
    uint256 public buyingDevFee = 1;
    
    uint256 public buyersTotalFees = buyingMarketingFee.add(buyingRewardFee).add(buyingLpFee).add(buyingCharityFee).add(buyingDevFee);
    uint256 public sellersTotalFees = sellingMarketingFee.add(sellingRewardFee).add(sellingLpFee).add(sellingCharityFee).add(sellingDevFee);
    ...
    // Total = 100%
    uint256 public marketingPortionOfSwap = 35; // 35%
    uint256 public rewardPortionOfSwap = 30; // 30%
    uint256 public devPortionOfSwap = 10; // 10%
    uint256 public charityPortionOfSwap = 10; // 10%
    uint256 public lpPortionOfSwap = 15; // 15%
    ...
    function calcBuyersTotalFees() private {
        buyersTotalFees = buyingMarketingFee.add(buyingRewardFee).add(buyingLpFee).add(buyingCharityFee).add(buyingDevFee);
    }
    
    function calcSellersTotalFees() private {
        sellersTotalFees = sellingMarketingFee.add(sellingRewardFee).add(sellingLpFee).add(sellingCharityFee).add(sellingDevFee);
    }
    ...
    uint256  devPortion, uint256 charityPortion, uint256 lpPortion) external onlyOwner {
        
        uint256 totalPortion = marketingPortion.add(rewardPortion).add(devPortion).add(charityPortion).add(lpPortion);
    ...
    function swapBack() internal {
        ...
        transferToAddressBNB(payable(charityWallet), amountBNBCharity);
