...
contract BABYCAKE is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x66967156BbbFCf84eF642D6e0b5F41a3E27D8E92;
    ...
    constructor() public ERC20("LisangeCake", "TamiCake") {
        ...
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), address(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F));
