...
contract BullDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDc132EB5290D78b735e295582A02BA214B499893); // Marketing Address
    ...
    string private _symbol = "BullDOGE";
    ...
    uint256 private minimumTokensBeforeSwap = 20 * 10**6 * 10**9; 
