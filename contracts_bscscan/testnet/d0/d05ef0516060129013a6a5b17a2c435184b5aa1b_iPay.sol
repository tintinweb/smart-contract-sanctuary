...
contract iPay is Context, IERC20, Ownable { 
    ...
    */
    ...
    function _set_Fees(uint256 TeamTokens_Buy,
        ...
        require((TeamTokens_Buy+Reflection_Buy+MarDev_Buy) <= _FeeMaxPossible, "Buy fees set to high!");
        require((TeamTokens_Sell+Reflection_Sell+MarDev_Sell) <= _FeeMaxPossible, "Sell fees set to high!");
                       ...
                       _FeeMarDev_Buy         = MarDev_Buy;
                       _FeeMarDev_Sell        = MarDev_Sell;

                       _Total_Fee_On_Buys   = _FeeTeamTokens_Buy + _FeeReflection_Buy + _FeeMarDev_Buy;
                       _Total_Fee_On_Sells  = _FeeTeamTokens_Sell + _FeeReflection_Sell + _FeeMarDev_Sell;
