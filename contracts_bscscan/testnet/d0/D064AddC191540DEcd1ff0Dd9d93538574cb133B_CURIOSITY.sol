 ...
 * Default configuration is for the PancakeSwap exchange.
 * PancakeSwap is a leading decentralized exchange on the binance smart chain.
 * 
 * WETH returns the canonical address for WBNB token. Refer below link fore more details.
...
contract CURIOSITY is Context, IERC20, Ownable {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn and development wallet
     ...
     * of the contract.  
     */
    function withdrawBalanceBNB(address payable recipient, uint256 amount) external onlyOwner() {
        require(amount <= address(this).balance, "ERC20: amount should not exceed the contract balance");
    ...
    /**
     * @dev Call this function to change the Max transaction percentage.
     * Adjusting of 'maxTxPercent' will be required during the initial stage.
     */      
