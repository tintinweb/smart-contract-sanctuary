...
contract Cr7Legend is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CRTESTDAI";    // edit
    string constant _symbol = "CRTESTDAI";  // edit
    ...
    // SETMEUP
    address _presaler = 0xc87DFBf4F4EdffB2FC488d4f61eFaD231eBDC5a3; // edit
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = payable(0xc87DFBf4F4EdffB2FC488d4f61eFaD231eBDC5a3); // edit
    ...
    function setDistributorSettings(uint256 gas) external authorized {
        require(gas < 750000);  // edit from 750000
        distributorGas = gas;
    }
