    ...
    ReentrancyGuard
{
    ...
    uint256 public availableMarketing = 30000000   * 10 ** 18; // 3% for marketing
    
    // Tokens for rewards
    uint256 public availableRewards = 200000000  * 10 ** 18; // 20% for rewards
    
    // Tokens for airdrop
    uint256 public availableAirdrop = 20000000   * 10 ** 18; // 2% for airdrop
