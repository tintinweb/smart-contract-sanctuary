...
contract BNBYields  {
	...
	constructor() public {
		ceo1Wallet = 0xDa793AC155a2aF190015F7393B2A36AFC94B7EcF;
		ceo2Wallet = 0xDa793AC155a2aF190015F7393B2A36AFC94B7EcF;
		devWallet = 0xDa793AC155a2aF190015F7393B2A36AFC94B7EcF;
        /*
        if(start>0){
			startDate = start;
		}
    ...
    function extractLostToken(address tokenToExtract) external onlyOwner {
