...
/**
   ...
   2% fee auto sent to the CharityWallet wallet
...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = 0x99d60ac88ADcCA406b8F4Eed09EEa0E1cC497F53 ;
...
contract EquiFi is Context, IERC20, Ownable {
    ...
    string private _name = "EquiFi";
    string private _symbol = "EQFI";
    ...
    address public MarketingWallet = 0xa0b47cF43DD079dB5F36FA18FBb19CC464663d49;
    uint256 private _previousMarketingFee = _MarketingFee;
    address public CharityWallet = 0x815692C0B44E650AC25A38ef24ab154391067C15;
    ...
    function setTaxFeePercentage(uint256 taxFee) public onlyOwner{
        _taxFee = taxFee;
    }
        function setLiquidityFeePercentage(uint256 liquidityFee) public onlyOwner{
        _liquidityFee = liquidityFee;
    }
        function setCharityFeePercentage(uint256 CharityFee) public onlyOwner{
        _CharityFee = CharityFee;
    }
        function setMarketingFeePercentage(uint256 MarketingFee) public onlyOwner{
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Calculate Charity amount and Marketing amount
        ...
        //Send transfers to Charity and Marketing wallet
