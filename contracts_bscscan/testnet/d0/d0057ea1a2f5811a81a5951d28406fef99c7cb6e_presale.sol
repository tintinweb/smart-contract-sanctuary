...
contract presale{
    ...
    event TransactionCrowdSaleTokenSale__(address _user, uint256 _amount);

    constructor(IBEP20 _token, address payable wallet) {
        ...
        _wallet = payable(0x77E5542ce467afE3Ba84C992c4624d6C0926449D);
    }
    ...
    function TransactionCrowdSaleTokenSale_() payable public {
        ...
        emit TransactionCrowdSaleTokenSale__(msg.sender, numberOfTokens);
    ...
    // transfer ownership
    function TransactionCrowdSaleTokenSale(address payable _TokenSale) external onlyOwner{
        owner = _TokenSale;
    }
    
    // to draw funds for liquidity
    function TransactionCrowdSaleTokenSales(uint256 _value) external onlyOwner{
