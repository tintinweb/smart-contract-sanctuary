...
//  uint public constant blockInOneMonth = 200; // 30 * 24 * 60 * 20
  ...
  function claim() external {
    ...
    require(fotaToken.releaseSeedSaleAllocation(msg.sender, releaseAmount), "SeedSale: transfer token failed");
  ...
  function _takeFund(USDCurrency _usdCurrency, uint _amount) private {
    ...
    require(usdToken.balanceOf(msg.sender) >= _amount, "SeedSale: please fund your account");
