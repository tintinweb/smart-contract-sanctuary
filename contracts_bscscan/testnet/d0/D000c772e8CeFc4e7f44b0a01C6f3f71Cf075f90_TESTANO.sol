...
contract TESTANO is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000 * 10**6 * 10**9; // 1 Trillion
    ...
    uint256 public _numTokensSellToAddToLiquidity = 460000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 200000 * 10**6 * 10**9; 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'TESTANO';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient != owner() && recipient != address(1) && recipient != pcsV2Pair){
            ...
            require(contractBalanceRecepient + amount <= _maxWalletToken, "Exceeds maximum wallet token amount (20,000,000,000)"); 
        }
