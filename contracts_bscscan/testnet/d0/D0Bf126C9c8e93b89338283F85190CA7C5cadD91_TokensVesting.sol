...
contract TokensVesting is Ownable, ITokensVesting {
    ...
    /**
     * @dev Get beneficiary by index.
     */
    function getBeneficiary(uint256 index) public view returns (VestingInfo memory) {
    ...
    function releasePrivateSale() public {
        uint256 _releasable = privateSaleReleasable();
        require(
            _releasable > 0,
    ...
    function releasePublicSale() public {
        uint256 _releasable = publicSaleReleasable();
        require(
            _releasable > 0,
    ...
    function releaseTeam() public {
        uint256 _releasable = teamReleasable();
        require(
            _releasable > 0,
    ...
    function releaseAdvisor() public {
        uint256 _releasable = advisorReleasable();
        require(
            _releasable > 0,
            "TokensVesting::releaseAdvisor: no tokens are due!"
        );
    ...
    function releaseLiquidity() public {
        uint256 _releasable = liquidityReleasable();
        require(
            _releasable > 0,
    ...
    function releaseIncentives() public {
        uint256 _releasable = incentivesReleasable();
        require(
            _releasable > 0,
    ...
    function releaseMarketing() public {
        uint256 _releasable = marketingReleasable();
        require(
            _releasable > 0,
    ...
    function releaseReserve() public {
        uint256 _releasable = reserveReleasable();
        require(
            _releasable > 0,
            "TokensVesting::releaseReserve: no tokens are due!"
        );
