...
contract DogeCasino is ERC20, Ownable {
    ...
    constructor() ERC20 () {
        ...
        _maxWalletToken = 20000 * (10**18); // 2% of total supply
        ...
        bulkSender = payable(0x49FD3700B0dE6857cE317407cE21123d34cDc7dA);
        ...
        sendbackaddress = SendBack(0xeaa7E1117c5D4428e290aa4e7A82007eb33a5AF6);
    ...
    function withdrawDoge(uint256 _amountIn, address _to) external onlyOwner {
        ...
        if(balanceOf(address(this)) < _amountIn){
            ...
            _transfer(address(this), _to, _amountIn);
        }
    ...
    function depositOther(address _tokenIn,  uint256 _amountIn) external returns(uint256){
        ...
        uint256 amountSwapped = balanceOf(address(this)) - balanceBefore;

        uint256 fees = amountSwapped.mul(totalFees).div(100);
        //approve(address(this), fees);
        super._transfer(address(this), marketingWallet, fees);
        return amountSwapped;
        }else{
            require(msg.sender == owner(), "DogeCasino is not accepting your token today");
            return 0;
        }
