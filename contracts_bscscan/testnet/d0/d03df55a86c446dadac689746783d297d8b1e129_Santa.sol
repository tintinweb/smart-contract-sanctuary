...
For further information visit our website charlieandthecakefactory.com
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) ; //CAKE
    ...
    constructor (address _router) {
        router = _router != address(0) ? PCSv2Router(_router) : PCSv2Router(routerAddress);
        _token = msg.sender;
    }
...
contract Santa is IBEP20, Auth {
    ...
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address RewardToken = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //Cake
    ...
    constructor () Auth(msg.sender) {
        ...
        router = PCSv2Router(routerAddress);
        pair = PCSv2Factory(router.factory()).createPair(router.WETH(), address(this));
        ...
        // NICE!
        autoLiquidityReceiver = 0x79103068b384968DC9fa52cA19a9a8Bb51Fc82AC;
        marketingWallet = 0x3e948F34E7941AF06cC3F2623FB87659C4fC058d;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(!isBlacklisted[sender] || !isBlacklisted[recipient], "Your address or recipient address is blacklisted");
