...
contract WizardNFT is ERC721, ERC721Enumerable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    string private _baseURIString;


    constructor() ERC721("NFT Wizard", "NFT Wizard") {
    ...
    function setBaseURI(string memory _newBaseURIString) external onlyOwner {
