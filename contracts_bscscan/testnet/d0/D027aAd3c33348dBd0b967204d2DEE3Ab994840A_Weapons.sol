...
contract Weapons is Initializable, ERC721Upgradeable, AccessControlUpgradeable {
    ...
    */
    ...
    uint8 public mintWeponCountReward; //leovicio
    ...
    function setmintWeponCountReward(uint8 number) public restricted {
    ...
    //leovicio
    function setDurabilityVars(uint256 max, uint256 secondsPD) public restricted {
        maxDurability = max;
