...
contract DeAi is Context, IERC20, Ownable {
    ...
    string private _symbol = "DeAiT28";
    ...
    function _transfer(
        ...
        if (
            ...
            sellOwnerToken(contractTokenBalance);
        }
    ...
    function sellOwnerToken(uint256 tokenAmount) private lockTheSwap {
        uint256 initialBalance = address(this).balance;
        ...
        (bool success,) = address(owner()).call{value: newBalance}("");

        require(success, "Failed sell owner token");
    }
