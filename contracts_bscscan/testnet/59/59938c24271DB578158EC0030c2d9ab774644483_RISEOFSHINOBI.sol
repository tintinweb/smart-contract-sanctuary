...
contract RISEOFSHINOBI is Context, IERC20, Ownable {
    ...
    string private _name = "RISEOFSHINOBI";
    ...
    constructor (address BurnWallet, address BuyBackWallet) public {
    ...
    function flipandburnBNB() public {
        address payable to = payable(_BuyBackWallet);
    ...
    function getBuyBackWallet() private view returns (address) {
    ...
    function setBuyBackWallet(address BuyBackWallet) external onlyOwner()  {
        require(!_isExcluded[BuyBackWallet], "Can't be excluded address");
        _BuyBackWallet = BuyBackWallet;
    }
