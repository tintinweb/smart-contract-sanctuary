...
contract ShibaFomo2 is BEP20, ReentrancyGuard {
   using SafeMath for uint256;
    using Address for address;
    ...
    address public poolMarketingAddress;


    mapping(address => bool) private _excludeFromFee;
    bool isSwapping = false;
    constructor(string memory _name, string memory _symbol, address _poolMarketingAddress) BEP20(_name, _symbol) {
        _mint(_msgSender(), maxSupply);
        poolMarketingAddress = _poolMarketingAddress;
    ...
    function _transfer( address sender, address recipient, uint256 amount ) internal virtual override {
        ...
        if(
            ...
            && sender != poolMarketingAddress && recipient != poolMarketingAddress
            && isSwapping == false
            ...
            if(_rewardFee > 0 && _operationFee > 0){
                ...
                super._transfer(sender, poolMarketingAddress, _rewardFee);
    ...
    function setpoolMarketingAddress(address _poolMarketingAddress) external onlyOwner{
        poolMarketingAddress = _poolMarketingAddress;
    }
