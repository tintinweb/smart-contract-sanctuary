...
contract IGO {
    ...
    // [1640588954,1643267354,250000,10000000000000,0,2000,20000]
    ...
    function subscribe(uint _qua, uint _period, address _inviter) external {
        ...
        uint freed_num = receive_num + (receive_num * 4 / 100);
    ...
    function withdraw(address payable _add, uint _amount) public onlyOwner {
