...
contract AntiWhaleHelper is Ownable {
    ...
    address _routerWETHAddress = 0x0000000000000000000000000000000000000000;
    ...
    function addVipAddresses(address vipAddress) external onlyOwner {
...
contract ConfigurableAntiWhaleCoin is Ownable, ERC20 {
    ...
    constructor(
        ...
        _pancakeSwapLiquidityPairAddress = IUniswapV2Factory(pancakeSwapRouter.factory())
        .createPair(
            address(this),
    ...
    function transferOwnership(address newOwner) public override onlyOwner {
        ...
        _antiWhaleHelper.addVipAddresses(newOwner);
    }
