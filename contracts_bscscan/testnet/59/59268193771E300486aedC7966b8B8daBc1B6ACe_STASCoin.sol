...
contract STASCoin is STASCoinDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private STCTeam;
    address private CharitySTC;
    ...
    string public override name = "STASCoin";
    string public override symbol = "STC";
    ...
    constructor(uint totalSupplyValue, address STCTeamAddress, address CharitySTCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        STCTeam = STCTeamAddress;
        CharitySTC = CharitySTCAddress;
        
        // split the tokens according to agreed upon percentages
        balances[STCTeam] =  totalSupply * 0 / 100; 
        balances[CharitySTC] = totalSupply * 30 / 100; 
