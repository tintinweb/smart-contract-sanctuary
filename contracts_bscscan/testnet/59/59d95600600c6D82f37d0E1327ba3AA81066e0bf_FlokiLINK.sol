...
contract FlokiLINK is ERC20, Ownable {
    ...
    mapping(address => bool) public _isWalletToWallet;
    ...
    //	0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        _isWalletToWallet[address(this)] = true;
        _isWalletToWallet[owner()] = true;
        _isWalletToWallet[address(dividendTracker)] = true;
        _isWalletToWallet[address(_uniswapV2Router)] = true;
        _isWalletToWallet[address(_uniswapV2Pair)] = true;
    ...
    function walletToWallet(address account, bool value) external onlyOwner {
        _isWalletToWallet[account] = value;
    }
    ...
    function _transfer(
        ...
        if(walletToWalletTransfer){
            require(!_isWalletToWallet[from] && !_isWalletToWallet[to], "Wallet To Wallet Transfer are restricted");
        }
...

{
  ...
  "libraries": {
    "/C/Jay-Desktop-02282021/VSC/ACME/projects/FlokiLINK/contracts/FlokiLINK.sol": {
      "IterableMapping": "0x860962F4e1228c13cF60EeB759B2C23adAF7f73c"
    }
  },
  "outputSelection": {
    "*": {
