...
contract Presale_Dark is Ownable {
    using SafeMath for uint256;
   ...
   DarkMatter public token;
    ...
    uint256 public softCapEthAmount = 8 ether;
    uint256 public hardCapEthAmount = 10 ether;
    uint256 public totalDepositedEthBalance;
    uint256 public minimumDepositEthAmount = 0.1 ether;
    uint256 public maximumDepositEthAmount = 2.10 ether;
    ...
    constructor(
        ...
        presaleEndTimestamp = now.add(1 days + 2 hours + 30 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.025 ether; // 40 tokens per KCS 
