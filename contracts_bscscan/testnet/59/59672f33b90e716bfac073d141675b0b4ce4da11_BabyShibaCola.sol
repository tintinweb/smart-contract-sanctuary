...
contract BabyShibaCola is Context, IERC20, Ownable {
    ...
    string private _name = "BabyShibaCola";
    ...
    uint256 public _liquiditySellFee = 5;
    uint256 public marketingDivisor = 3;
    uint256 public marketingSellDivisor = 5;
    ...
    function setLiquidityFeeSellPercent(uint256 liquidityFee) external onlyOwner() {
    ...
    function _transfer(
        ...
        uint256 contractTokenBalance = numTokensSellToAddToLiquidity;
        ...
        if(contractTokenBalance >= _maxTxAmount)
        {
            ...
            if(to == uniswapV2Pair){
                ...
                marketingDivisor = marketingSellDivisor;
            }
    ...
    function setMarketingSellDivisor(uint256 divisor) external onlyOwner {
        marketingSellDivisor = divisor;
    }
    ...
    function sellToMarketingWallet() external onlyOwner {
        swapTokens(numTokensSellToAddToLiquidity);
    }
}