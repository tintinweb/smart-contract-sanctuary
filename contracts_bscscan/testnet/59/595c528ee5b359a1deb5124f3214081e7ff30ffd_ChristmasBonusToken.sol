...
contract ChristmasBonusToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8F83fE2607e5cE63F15AD6878A366d72A1FD0f5c); 
    ...
    string private _name = "Christmas Bonus Token";
    ...
    uint256 public _maxTxAmount = 100 * 10**6 * 10**9; // 10% of total supply
