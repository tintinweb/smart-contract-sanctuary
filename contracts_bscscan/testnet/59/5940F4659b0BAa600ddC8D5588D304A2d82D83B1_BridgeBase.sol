...
contract BridgeBase is Context, Ownable {
    ...
    address bridgeFeesAddress = address(0xDF4aFe2711A3f42769958f1049e6256fB8865E69);
   ...
   function updateShihContract(address _shih) external onlyOwner {
    ...
    function swapBack(
        ...
        //   TransferHelper.safeApprove(shih,address(this),fees);
        TransferHelper.safeTransfer(shih, bridgeFeesAddress, fees);

        //   TransferHelper.safeApprove(shih,address(this),temp);
