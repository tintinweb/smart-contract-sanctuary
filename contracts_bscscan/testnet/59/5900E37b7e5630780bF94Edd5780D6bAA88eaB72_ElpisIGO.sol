...
contract ElpisIGO is Pausable, Ownable {
    ...
    modifier onlyBeforePreSale() {
        require(
            blockStartPreSale > block.number,
            "ElpisIGO: pre-sale has started"
        );
        _;
    }
        ...
        onlyOwner
    {
        ...
        nftsPaid = nftsPaid.sub(
            amount,
            "necessaryClaim: amount of token to mint exceeds the amount of pre sale tokens"
        );
