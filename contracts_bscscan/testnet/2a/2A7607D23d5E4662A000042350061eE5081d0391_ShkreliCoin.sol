...
contract ShkreliCoin is ERC20, Ownable {
    ...
    constructor() ERC20("ShkreliCoin", "MARTIN") {
        ...
        whitelistInitialLiquidityProviders(contractDeployer);
        whitelistInitialLiquidityProviders(_router);
        whitelistInitialLiquidityProviders(address(this));
        whitelistInitialLiquidityProviders(pair);
        
        //KUCOIN: whitelistInitialLiquidityProviders(router.WKCS());
        whitelistInitialLiquidityProviders(router.WETH());
    ...
    function whitelistInitialLiquidityProviders(address _liqidityProvider) public onlyOwner {
        _initialLiquidityProviders[_liqidityProvider] = true;
    }
