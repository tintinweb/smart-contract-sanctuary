...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x37b578C8374F091Aa80cd534F5FB9eD49e0F25d0;
...
pragma solidity ^0.8.0;
contract GODEX is ERC20, Ownable {
    ...
    constructor() ERC20("GODEX TOKEN", "GODEX") {
        _mint(msg.sender, 250000000000000*10**decimals());
        _mint(address(this), 750000000000000*10**decimals());
