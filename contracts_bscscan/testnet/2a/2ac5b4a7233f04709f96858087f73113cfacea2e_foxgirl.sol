...
contract foxgirl is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x06376fF13409A4c99c8d94A1302096CB4dC7c07e); //3
    ...
    function _set_Fee(uint256 DevFee) external onlyOwner() {

        // Check fee limits

          require(DevFee <= maxPossibleFee, "Fee set too high!");
          _DevFee = DevFee;
