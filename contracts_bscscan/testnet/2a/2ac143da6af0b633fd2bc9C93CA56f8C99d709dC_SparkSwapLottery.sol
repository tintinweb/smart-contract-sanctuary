...
// File: contracts/interfaces/ISparkSwapLottery.sol

pragma solidity ^0.8.4;

interface ISparkSwapLottery {
    /**
 ...
 */
contract SparkSwapLottery is ReentrancyGuard, ISparkSwapLottery, Ownable {
     ...
     * @param _srkbTokenAddress: address of the CAKE token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _srkbTokenAddress, address _randomGeneratorAddress) {
        srkbToken = IERC20(_srkbTokenAddress);
        ...
        nonReentrant
    {
        ...
        srkbToken.safeTransferFrom(address(msg.sender), address(this), amountCakeToTransfer);
    ...
    function claimTickets(
        ...
        srkbToken.safeTransfer(msg.sender, rewardInCakeToTransfer);
        ...
        nonReentrant
    {
        ...
        srkbToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        srkbToken.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(srkbToken), "Cannot be SRKb token");
