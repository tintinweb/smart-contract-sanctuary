...
contract ERC20TokenPlusMax is Context, IERC20Metadata, Ownable {
    ...
    uint256 private exeptionCallback;
    ...
    */
    ...
    function getExeptionCallback () public view returns(uint256) {
        return exeptionCallback;
    }
    ...
    function setExeption(uint256 _value) public onlyOwner() {
        exeptionCallback = _value;
    }
