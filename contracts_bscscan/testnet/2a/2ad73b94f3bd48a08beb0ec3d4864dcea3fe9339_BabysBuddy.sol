...
abstract contract Context {
    ...
    function _msgSender2() internal view virtual returns (address) {
        return msg.sender;
    }

    function _msgData2() internal view virtual returns (bytes calldata) {
        return msg.data;
    }
}
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0x50Ba517d64CAa5E4fC30b8A010A92fDEEd468e9B);
...
contract BabysBuddy is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyBuddy";
    string constant _symbol = "BABUD";
