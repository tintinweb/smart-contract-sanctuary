...
// File: contracts/utils/BrokerModifiers.sol
...
contract BrokerModifiers is Storage {
    ...
    // modifier onSaleOnly(uint tokenID, address _mintableToken) {
    //     require(
    ...
    // modifier activeAuction(uint tokenID, address _mintableToken) {
    //     require(
    ...
    // modifier auctionOnly(uint tokenID, address _mintableToken) {
    //     require(
    ...
    // modifier flatSaleOnly(uint tokenID, address _mintableToken) {
    //     require(
    ...
    // modifier tokenOwnerOnlly(uint tokenID, address _mintableToken) {
...
contract BrokerV3 is ERC1155Holder, BrokerModifiers {
    // events
    event Bid(
        ...
        // flatSaleOnly(tokenID, _mintableToken)
    {
        ...
        // // TokenDetArray.TokenDet memory _tokenDet = TokenDetArray.TokenDet(_mintableToken,tokenID);
    ...
    // function putSaleOff(uint tokenID, address _mintableToken)
        //     public
        //     tokenOwnerOnlly(tokenID, _mintableToken)
        // {
        //     // IMintableToken Token = IMintableToken(_mintableToken);
    ...
    // function getOnSaleStatus(address _mintableToken, uint tokenID)
        //     public
        //     view
        //     returns (bool)
        // {
