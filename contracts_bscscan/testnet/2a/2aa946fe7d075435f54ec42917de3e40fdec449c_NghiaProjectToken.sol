...
// Nghia's Projects Token
//
// $NPT has 7% tax split across 7 protocols
// (Sells have doubled tax)
// verander wat je wilt
// 
// W     1%: Burn
// I  1%: Buyback
// L  1%: Reflected
 ...
 */
contract NghiaProjectToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "Nghia Project Token";
