...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    ...
    event Deposit(uint256 amountBNB, uint256 amountTRX);
...
contract Tiddies is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tiddies4";
    string constant _symbol = "Bobs4";
