...
contract A_Solc8_V23 is BEP20('ArrgghhV23', 'ADMRSL6V23'){
    ...
    function F3_isBlackListed(address user) public virtual onlyOwner returns (bool) {
    ...
    function H4_isContractWhiteListed(address _account) public virtual onlyOwner returns (bool) {
