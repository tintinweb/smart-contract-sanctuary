...
contract ENMT is ERC20 {
    ...
    constructor(string memory _name, string memory _symbol, uint8 _decimals, address _creator, uint256 _totalSupply) ERC20(_name, _symbol) {
        _mint(msg.sender, _totalSupply * (uint256(10) ** _decimals));
...
contract TokenFees is Ownable{
    ...
    constructor() {
        SETTINGS.FLAT_FEE = 100000000000000000;
        SETTINGS.TS_FEE = 2;
        SETTINGS.TOKEN_FEE_ADDRESS = payable(0xB3Fa213EAb8401Aeb7AdfC8c2eC30e90aFf23005);
    }
...
contract MintGenerator is Ownable {
    ...
    constructor(address _tokenFees) {
