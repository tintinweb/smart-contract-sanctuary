...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xdaDafd8056538A89660462C680D863D5797f37Bb); // Marketing Address
    address payable public devAddress = payable(0x00629abCcd8b7Adfbf2Fe4Fa7D1d60F94143CBc3); // Dev Address
    ...
    uint256 private _tTotal = 21000 * 10**6 * 10**9;
    ...
    uint256 public devAndMarketingDivisor = 5;
...
contract BNBPay is ERC1363, TokenRecover {
    constructor ()
        ERC1363("KJFKJKGKEK.COM", "$BFKEOKKKKD")
    {
    }
}