...
contract PresaleExchange {
    ...
    uint256 public startDate = 1633222800;                  // Sunday, October 3, 2021 8:00:00 AM GMT+07:00
        
    uint256 public totalTokensToSell = 1000000 * 10**18;      // 10000 tokens for sell
    uint256 public tokenPerPRE = 1 * 10**18;                // 1.000.000 PRE = 1 TOKEN
    uint256 public minPerTransaction = 0;                   // min amount per transaction
    uint256 public maxPerUser = 1000000000 * 10**18;       // 1 bil max amount per user
