...
/**
  ...
  `--. \  / _ \| '_ \ / __|| '_ \ | || || '_ \ | | | |
  /\__/ /|  __/| | | |\__ \| | | || || || | | || |_| |
 \____/  \___||_| |_||___/|_| |_||_||_||_| |_| \__,_|
...
contract SenshiInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1200000000000000 * 10**_decimals;
    
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name            = "yeni7";
    string private _symbol          = "yeni7";
    uint8 private _decimals         = 9;
    
    uint256 public _burnFee         = 4; // Burn fee
    uint256 public _taxFee          = 4; //Reward fee
    uint256 public _liquidityFee    = 0; // liquidity fee
    uint256 public _marketingFee    = 4; // Marketing fee

    
    //address public deadAddress    = 0x90a24035aF049A78fa97e8f6e8e63caE8FDeF01f;
    address public mainAddress      = 0xBDD326f4CBE6Cef18a453B148b223406d193E744;
    address public deadAddress      = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet  = 0x3F981A54bDA38B8eA99Cc14Ffd1A513774D2c3e3;
    
    address public uniSwapAdress=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    //address public uniSwapAdress=0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50000000000 * 10**_decimals;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(uniSwapAdress);
    ...
    function removeTaxFee() public onlyOwner {
        if(_taxFee == 0 ) return;
        _previousTaxFee = _taxFee;
        _taxFee = 0;
    }
    
    function removeliquidityFee() public onlyOwner {
    ...
    function takeBurn(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private returns (uint256, uint256)
    {
    ...
    function takeMarketing(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private returns (uint256, uint256)
    {
