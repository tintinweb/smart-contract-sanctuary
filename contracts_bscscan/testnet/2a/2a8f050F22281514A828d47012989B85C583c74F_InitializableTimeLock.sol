 ...
 */
contract InitializableTimeLock is InitializableOwnable {
    ...
    /**
     * @notice Transfers fix tokens held by timelock to beneficiary.
     */
    function releaseFixedAmount(uint256 _amount) public virtual {
        require(
            block.timestamp >= _releaseTime,
            "TokenTimelock: current time is before release time"
        );
