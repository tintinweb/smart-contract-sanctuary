...
contract MegaverseToken is Context, IERC20, Ownable {
    ...
    string private _name = "Megaverse";
    ...
    constructor (address _router, address _owner) public {
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tBurn = calculateLiquidityFee(tAmount);
