...
contract HB_LV1 is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("Level One Of HB NFT", "HB_LV1") { }
    ...
    function mint() external nonReentrant payable {
        ...
        payable(address(0x0DDe70cBf8cB395Bd0f68e815273E43bC25d193E)).transfer(msg.value);
    }
