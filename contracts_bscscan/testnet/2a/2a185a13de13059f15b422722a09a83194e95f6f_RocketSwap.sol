...
pragma solidity ^0.8.0;
contract RocketSwap is ERC20, Ownable {
    ...
    constructor() ERC20("RocketSwap", "ROCKET") {
        _mint(msg.sender, 59400000*10**decimals());
        _mint(address(this), 138600000*10**decimals());
        startSale(block.number, 999999999,0,15000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,8*75**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
