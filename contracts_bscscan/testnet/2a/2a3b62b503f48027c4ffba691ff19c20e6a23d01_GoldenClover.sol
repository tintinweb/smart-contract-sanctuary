...
contract GoldenClover is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    address public  _charityWalletAddress = 0xAa60d3cdCe8d6D80DbACAb9608ee26b3ae1a65D7;
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own GCLV to claim reward');
