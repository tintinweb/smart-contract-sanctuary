...
contract NexusFolioV2 is IERC20, Ownable {
    ...
    string private constant _name = "NexusFolio v15";
    string private constant _symbol = "NFv15";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 maketingBNBShare = address(this).balance.div(2);
        uint256 innovationBNBShare = address(this).balance.div(2);
