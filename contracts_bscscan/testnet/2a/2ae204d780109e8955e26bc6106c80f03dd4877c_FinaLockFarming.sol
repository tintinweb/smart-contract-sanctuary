...
contract FinaLockFarming is Initializable, OwnableUpgradeable, FinaFarming {
    ...
    function withdrawLP(uint _pid, uint _amount) external virtual override onlyEOA whenNotPaused {
        ...
        if(pending > 0 && block.timestamp >= user.averageDepositedTime + depositTier[3]) {
            ...
            emit Rewards(_msgSender(), _pid, pending * rewardRatioByTier[3] / 10000, pendingExtra * rewardRatioByTier[3] / 10000);
            ...
            emit Rewards(_msgSender(), _pid, pending * rewardRatioByTier[2] / 10000, pendingExtra * rewardRatioByTier[2] / 10000);
            ...
            emit Rewards(_msgSender(), _pid, pending * rewardRatioByTier[1] / 10000, pendingExtra * rewardRatioByTier[1] / 10000);
        } else if(pending > 0 && block.timestamp < user.averageDepositedTime + depositTier[0]){
            ...
            emit Rewards(_msgSender(), _pid, pending * rewardRatioByTier[0] / 10000, pendingExtra * rewardRatioByTier[0] / 10000);
        }
        if(_amount > 0) {
