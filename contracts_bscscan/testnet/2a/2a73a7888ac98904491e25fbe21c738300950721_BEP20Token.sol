...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
  ...
  function totalSupply() external view returns (uint256) {
   ...
   function maxTrx() external view returns (uint256) {
    return _maxTrx;
   }
   ...
   function previousTaxFee() external view returns (uint256) {
   ...
   function previousPlatformFee() external view returns (uint256) {
     return _previousPlatformFee;
   }
