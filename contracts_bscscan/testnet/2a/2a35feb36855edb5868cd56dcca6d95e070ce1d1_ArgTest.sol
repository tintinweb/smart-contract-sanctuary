...
contract ArgTest is Context, IERC20, Ownable {
    ...
    string private _symbol = "ARG3";
    string private _name = "ArgTest3";
    ...
    uint256 public _maxTxAmount = 500000 * 10**_decimals; // 0.1% of total supply
