...
contract OricaToken is BEP20Token{
    ...
    */
    ...
    // timestamp of the whitlist end
    uint public deadline_for_whitelist;
    
    // timestamps of the presale start and end
    ...
    constructor() public{
        ...
        team_amount = 15000000;

        // Total_supply для Advisors группы
        advisors_amount = 10000000;
    ...
    function burnSeed(uint amount) external onlySuperAdmin {
        seed_amount -= amount;
        _burn(msg.sender, amount);
    }
