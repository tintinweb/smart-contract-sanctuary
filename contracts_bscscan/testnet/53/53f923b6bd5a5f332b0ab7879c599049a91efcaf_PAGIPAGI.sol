...
contract PAGIPAGI is Context, IERC20, Ownable {
    ...
    string private _name = "PAGIPAGI";
    string private _symbol = "PAGIPAGI";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xEc402D4b84527D783947D8DAE71f40818512C760);
