...
contract Jenkins is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x8ed904861Dc2bf77b647910dc72dCB0DA270Ef0D); // Marketing Address

    address payable public teamAddress =
        payable(0x51968c4E37e4fca1465A4C44FC335e5b3A81651D); // Team Address

    address payable public liquidityAddress =
        payable(0x264653E45E66df3f5ccFfCD639434748fAC160fc); // Liquidity Address
    ...
    string private constant _name = "Jenkins";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 5 / 1000; // 0.05%
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 5 / 100; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 10 / 100; // 1% maxWalletToken (add "0"  to 100 if u want change it back to 1%)
