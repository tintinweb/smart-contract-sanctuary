...
contract testTOKEN is ERC20, Ownable {
    ...
    function setFee(uint256 _bnbRewardFee, uint256 _liquidityFee, uint256 _marketingFee, uint256 _DevsFee, uint256 _buybackFee) 
    public onlyOwner 
    {
        ...
        totalFees = BNBRewardsFee.add(liquidityFee).add(marketingFee).add(DevsFee).add(buybackFee); // total fee
    }
    ...
    constructor() ERC20("testTOKEN", "TEST") 
    {
        ...
        marketingWallet = payable(0x97c52bF89fc71C9727fc88BFCea6f42CC7Bc0e1D);
        DevsWallet = payable(0x7547eBCA509960C9f2DdbCF1994e7321576b0874);
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // worthy Devs fee
        uint256 DevsAmount = deltaBalance.mul(DevsFee).div(totalFees);
        if (DevsAmount > 0) {
