...
contract BAFRATOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public ecosystemAddress = payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
