...
contract Groove is Context, IERC20, Ownable {
    ...
    address payable public charityWallet = payable(0xaBc96686A0688723a7eD69528a6A7E076838A71e); // charity Address
    address payable public marketingWallet = payable(0x981D658a0C35Ad072Fc9D428a66c9A5FA1B6E458); // marketing Address
