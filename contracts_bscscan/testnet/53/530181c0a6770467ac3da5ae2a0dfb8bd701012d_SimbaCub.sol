...
contract SimbaCub is PausableToken {
    ...
    function purchaseToken() public payable {
        ...
        uint token = (msg.value.div(perTokenPrice)).mul(10**decimals);
    ...
    function withdrawTokenFromContract(address to, uint256 token) public onlyOwner{
        this.transfer(to,token);
        emit Transfer(address(this),to, token);
    }
    
    function withdrawBNBFromContract(address to) public onlyOwner{
