...
contract DogeReferral is Ownable {
   ...
   /**
    ...
    function addReferrer(address referrer) external {
        ...
        require(!isCircularReference(referrer, msg.sender), "Referrer and referee cannot be the same");
        require(accounts[msg.sender].referrer == address(0) || defaultParents[accounts[msg.sender].referrer], "Address has registered upline");
