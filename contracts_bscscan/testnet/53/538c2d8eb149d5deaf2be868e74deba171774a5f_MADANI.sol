...
contract MADANI is Context, IERC20, Ownable {
    ...
    uint256 public  _tTotal = 10 * 10**6 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;

    string public _name = 'Madani';
    string public _symbol = 'MDI';
    ...
    function mint(address recipient, uint256 amountToMint) public returns(bool){
        
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee) = _getValues(amountToMint);
