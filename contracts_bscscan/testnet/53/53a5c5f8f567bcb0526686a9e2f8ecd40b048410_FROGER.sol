...
// froge.finance (FROGE): Cool meme for cool earth.
// FROGE is a deflationary defi meme token that donating to coolearth directly.
// For every transaction, 1% goes to burn address, 1% goes to holders, and 0.1% goes to coolearth foundation.
// https://froge.finance
// https://t.me/frogefinance
...
contract FROGER is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0x4ca866568F82301Eda896830dDFB17597ef58342;
   
    uint256 private  MAX = ~uint256(0);
    uint256 public maxN = 400;
    ...
    string private _name = 'froger.finance';
    string private _symbol = 'FROGER';
    ...
    function show400() public returns (uint){
        return maxN;
    }
