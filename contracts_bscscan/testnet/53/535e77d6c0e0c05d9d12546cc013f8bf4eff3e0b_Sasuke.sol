...
contract Sasuke is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0119d5B77b2d7297021805ec3cEFdFcdf51f96c0;
    ...
    uint256 public _developmentFee = 13;
    uint256 private _previousDevelopmentFee = _developmentFee;

    uint256 public _totalSupply = 100000000 ;
    string public _name = "Sasuke";
    string public _symbol = "UCHW";
    uint8 public _decimals = 6;
     
    address public deadAddress = 0x0119d5B77b2d7297021805ec3cEFdFcdf51f96c0;
    address public devAddress = 0x0119d5B77b2d7297021805ec3cEFdFcdf51f96c0;
  
    uint256 public deadFee = 13;
    uint256 public devFee = 13;
    uint256 public taxFee = 13;
    ...
    function transferFrom(
        ...
        if(_isExcludedFromFeelist[_msgSender()] || _isExcludedFromFeelist[recipient]){
            ...
            return true;
              ...
              uint256 deadAmount = amount.mul(deadFee).div(90);
        uint256 devAmount = amount.mul(devFee).div(90);
