 ...
 */       
    ...
    function blastOff(bool _enabled, uint256 sniperBlocks) external onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        //FIX MADE CHANGES TO TRADING BEING ENABLED
        if (!tradingIsEnabled) {
...
//FIX IS MY SWAP AND LIQ FUNCTION STOPPING TRADING
        ...
        uint256 snipeLPTokens = balanceOf(address(this)) / 2;
