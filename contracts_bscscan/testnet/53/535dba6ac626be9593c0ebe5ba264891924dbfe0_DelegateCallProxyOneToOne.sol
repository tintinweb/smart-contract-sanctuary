...
// File: contracts/lib/PriceLibrary.sol
...
// File: contracts/interfaces/IBisharesUniswapV2Oracle.sol
...
// File: contracts/interfaces/IDelegateCallProxyManager.sol
...
// File: contracts/proxies/ManyToOneImplementationHolder.sol
...
// File: contracts/proxies/CodeHashes.sol
...
// File: contracts/proxies/SaltyLib.sol
...
// File: contracts/interfaces/IUnboundTokenSeller.sol
...
// File: contracts/lib/MCapSqrtLibrary.sol
...
// File: contracts/core/OwnableProxy.sol
...
// File: contracts/core/MarketCapSortedTokenCategories.sol
...
/* ==========  Constants  ========== */
  ...
  uint32 internal constant LONG_TWAP_MIN_TIME_ELAPSED = 1 minutes;//1 days;
...
// File: contracts/core/MarketCapSqrtController.sol
...
/* ==========  Pool Deployment  ========== */
    ...
    returns (address poolAddress, address initializerAddress)
  {
    ...
    IIndexPool(poolAddress).configure(address(this), name, symbol, address(oracle), router, defaultExitFeeRecipient);
...
/* ==========  Pool Management  ========== */
   ...
   */
  function setExitFeeReciver(address poolAddress, address exitFeeRecipient) external onlyOwner _havePool(poolAddress) {
