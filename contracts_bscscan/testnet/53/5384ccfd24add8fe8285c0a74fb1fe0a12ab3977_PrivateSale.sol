...
// dev functions     
    ...
    */
    ...
    function buyCurrentSale(uint256 _purchaseAmount) external payable onlyInvestors() saleActive() {
        ...
        _amountPurchased = _amountPurchased * (10** claimTokenDecimalCount);
        ...
        if(investorPurchased[tokenForSale][sender].isInvestor){
            ...
            investorPurchased[tokenForSale][sender] = Sale(nextSaleID,sender,tokenForSaleDecimalCount,tokenForSale,tokenForContribution,_amountPurchased,false,firstVest,startTime,endTime,true);
