  ...
  function calculateFee(
        ...
        )
    {
       ...
       function processTax(
        ...
        super._transfer(msg.sender, marketingAddress, buyBacksAmount); // transfer n% to the main wallet    
    ...
    function ListingTax(uint256 _amount) internal {
        require(listingTaxEnabled == true, "Listing tax status false.");
        uint256 totalSupply = totalSupply();
        uint256 previousBalance = IBEP20(address(this)).balanceOf(msg.sender);
   ...
   function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
    ...
    //modifer for
    modifier coolDown() {
        require(block.timestamp > lastTransactionAt, "Wait for 60 Seconds");
        _;
    }
}
