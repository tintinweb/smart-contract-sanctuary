...
contract Fishlegs is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x8a8EfBC916aaBd4330df1C328E0a646c28eECA2D);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);

    string private _name    = "Fishlegs";
