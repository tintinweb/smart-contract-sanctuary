...
contract DogeFootball is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x880B7D3F7fcE55Fb80e415Ee091594A446064964); // Marketing Address
    ...
    string private _name = "DogeFootball";
    string private _symbol = "DOGEFOOTBALL";
