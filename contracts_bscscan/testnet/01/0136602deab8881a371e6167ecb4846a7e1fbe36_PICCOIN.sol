...
contract PICCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "PICCOIN";
    string private _symbol = "PICCOIN";
    ...
    uint256 public _teamFee = 1; // 1% team fee 30% goes to marketing fee
    uint256 private _previousteamFee = _teamFee;
    
    uint256 public _marketingFee = 0; // 30% of team fee is marketing fee
    ...
    uint256 public _maxTxAmount = 100000 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**8;
