...
contract Jabari is Context, IERC20, Ownable {
    ...
    string private _name = "Gorilla God";
    string private _symbol = "Jabari";
    ...
    function _burn(address account, uint256 amount, bool takeFee) internal virtual {
