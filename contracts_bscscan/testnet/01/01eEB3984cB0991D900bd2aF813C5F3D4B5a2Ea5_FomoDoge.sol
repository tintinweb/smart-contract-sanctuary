...
contract FomoDoge is Context, IERC20, Ownable {
    ...
    function updateGameSettings(
        ...
        if(minimumBuyForPotEligibility > 0)  {
            require(minimumBuyForPotEligibility >= 100 * 10**18 && minimumBuyForPotEligibility <= 100000 * 10**18);
