...
contract Dqb is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9F8bb2e18313C2e2842D888e1821224c110F2F9A); // Marketing Address
    ...
    string private _name = "DQB";
    string private _symbol = "DQB";
