...
contract WeaponMasterToken is ERC20("Weapon Master Token", "WMT"), Ownable {
    ...
    constructor(uint256 _startReleaseBlock, uint256 _endReleaseBlock) public {
        ...
        _setupDecimals(18);
        mint(msg.sender, manualMintLimit);
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(totalSupply().add(_amount) < _cap, "Mint Error: totalSupply must be less than cap");
        _mint(_to, _amount);
    }
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        // balance of underlying FORKs (not scaled);
