...
contract gOHM is IgOHM, ERC20 {
        ...
        ERC20("Governance OHM", "gOHM", 18)
    {
        ...
        approved = 0x1bF99f349eFdEa693e622792A3D70833979E2854;
        // require(_sOHM != address(0), "Zero address: sOHM");
        sOHM = IsOHM(0xA051bF5E87014F08e9a4ABb023bD4850C668d418);
    }
    ...
    function balanceFrom(uint256 _amount) public view  returns (uint256) {
        return _amount.mul(index()).div(10**uint256(decimals()));
    }
    ...
    function balanceTo(uint256 _amount) public view  returns (uint256) {
        return _amount.mul(10**uint256(decimals())).div(index());
    }
