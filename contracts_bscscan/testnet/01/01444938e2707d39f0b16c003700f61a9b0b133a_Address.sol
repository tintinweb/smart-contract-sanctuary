...
contract StarTracker1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4DF398C3ddeD0387fdca96c7A94Cd68A29b7f570); // Marketing Address
    ...
    uint256 private _tTotal = 9000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "StarTracker1";
    string private _symbol = "STT1";
