...
contract YogiInu is IBEP20, Auth {
   ...
   // uint256 start = 1639857420;
    uint256 start = 1639845720;
  //  uint256 WLTime = 3 minutes;
    uint256 WLTime = 10 minutes;
    ...
    constructor () Auth(msg.sender) {
       ...
       // emit Transfer(address(0), msg.sender, _totalSupply * 41 / 100);
        _balances[0x362f08Fc2bde3328221AfaF642e78f6ED6A734CD] = _totalSupply * 41 / 100;
        emit Transfer(address(0), 0x362f08Fc2bde3328221AfaF642e78f6ED6A734CD, _totalSupply * 41 / 100);
        authorizations[0x362f08Fc2bde3328221AfaF642e78f6ED6A734CD] = true;
