...
contract NFTStaking is ReentrancyGuard, DataStorage, Events, Ownable, Pausable {
    ...
    address public iUltisProxy = 0xA81fbE1a08F3E416BaBF1088C2Fd76Fa08d412Ac;
    INFTCore public nftCore = INFTCore(0xAE8cBb2a21b01E15BeD62d3c386930133dE7FAb1);
    /**
        ...
        whenNotPaused
    {
        ...
        require(user.nftId == 0, "unstake nft before");
        require(keccak256(abi.encodePacked(nftCore.getNFT(_nftId).class)) == keccak256(abi.encodePacked("Zuki Hero")), "not a hero");
        user.nftId = _nftId;
