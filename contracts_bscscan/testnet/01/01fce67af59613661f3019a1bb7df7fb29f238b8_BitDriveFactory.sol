...
contract UniswapV2ERC20 {
    ...
    string public constant name = "VOLBIT-LP";
    string public constant symbol = "VOLBITLP";
...
contract BitDriveFactory {
    ...
    function transferAmount(
        ...
        require(msg.sender == routerAddress, "Permission denined");

        SwapPair(pairaddress).transferToken(token, to, amount);
    }
