...
contract BABYFATCAKE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "BABY FATCAKE";
    string private _symbol = "FATCAKE";
    ...
    uint256 private buyBackUpperLimit = 6000000000000000; // Minimum Required 0.006 BNB in CA
    uint256 private buyBackBNBLimit = 3000000000000000; // Minimum Required 0.003 BNB in CA
    ...
    constructor () {
        ...
        pancakeV2Pair = IPancakeV2Factory(_pancakeV2Router.factory()).createPair(address(this), _pancakeV2Router.WETH());
        pancakeV2Router = _pancakeV2Router;
        marketingAddress = payable(0xF72Dd1bE327Db45C0BFffd6Cc0f03c871F1Fe319);
        ...
        _isExcludedReward[marketingAddress] = true;
    ...
    function buyBackBNBLimitAmount() public view returns (uint256) {
        return buyBackBNBLimit;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == pancakeV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(3000000000000000)) {

                if (balance > buyBackUpperLimit){
                    buyBackTokens(buyBackBNBLimit);
                }
            }
        }
        bool takeFee = true;
    ...
    function swapETHForTokens(uint256 amount) private {
        ...
        path[1] = address(this);
        pancakeV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value : amount}(0, path, deadAddress, block.timestamp.add(300));
    ...
    function setBuyBackBNBLimit(uint256 buyBackLimit) external {
        require(_mgr == _msgSender());
        buyBackBNBLimit = buyBackLimit * (10 ** 18);
    }
