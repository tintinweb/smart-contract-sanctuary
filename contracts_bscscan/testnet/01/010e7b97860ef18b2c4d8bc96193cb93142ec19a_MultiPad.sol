...
contract MultiPad is IERC20 {
    ...
    constructor (string memory name, string memory symbol, uint256 totalSupply, address owner) public {
        ...
        _balances[Reserve] = ReserveAmount*(10**uint256(_decimals));
        _balances[Marketing] = MarketingAmount*(10**uint256(_decimals));
        _balances[Team1] = Team1Amount*(10**uint256(_decimals));
        _balances[Team2] = Team2Amount*(10**uint256(_decimals));
        _balances[Liquidity] = LiquidityAmount*(10**uint256(_decimals));
        _balances[IDO] = IDOAmount*(10**uint256(_decimals));
        _balances[Partners] = PartnersAmount*(10**uint256(_decimals));
