...
contract SwapScrapYard {
    ...
    constructor () {
        ...
        scrap = IBEP20(0xb0FFD9311eC4880F686EB26d36CE25Ff82bE1Bfb);
    ...
    function getScrapCurrentRateBnb() public view returns(uint256){
        ...
        return getCurrentPrice(scrapPairAddress,scrap.decimals());
    }

    function getScrapCurrentRateBusd() public view returns(uint256){
        address scrapPairAddress = factoryContract.getPair(address(scrap),pancakeRouter.WETH());
        uint256 rateBnb = getCurrentPrice(scrapPairAddress,scrap.decimals());
