...
contract GENIPassSale is IGENIPassSale, IERC721Receiver, PermissionGroup, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        address _busd,
        address _bnb, 
        uint _referralBonusLv0,
        uint _referralBonusLv1,
        uint _referralBonusLv2,
        uint _referralBonusLv3,
        uint _referralBonusLv4
    ) {
        geni = geniAddr;
        ...
        busd = _busd;
        bnb = _bnb;
        referralBonusLv0 = _referralBonusLv0;
        referralBonusLv1 = _referralBonusLv1;
        referralBonusLv2 = _referralBonusLv2;
        referralBonusLv3 = _referralBonusLv3;
        referralBonusLv4 = _referralBonusLv4;
    }
