...
contract DragonSlayerWarrior is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, Tradable, WarriorInterface {
    ...
    /** WARRIOR **/
    function createWarrior (address _to, DRS.Warrior memory _warrior) override public onlySpawner returns (DRS.Warrior memory) {
        return _createWarrior(_to, _warrior);
    }
