...
/**
If the XMEN team can print unlimited $USDT then why can't we? Join our lively community on this wild moonride and earn $USDT in the process! 
...
contract XMEN is IBEP20, Auth {
    ...
    string constant _name = "XMEN";
    string constant _symbol = "XMEN";
