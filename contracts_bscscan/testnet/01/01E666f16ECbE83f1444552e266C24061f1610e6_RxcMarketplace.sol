...
contract RxcMarketplace is Ownable, ReentrancyGuard {
    ...
    function setMaintenanceMode(bool _maintenanceMode) public onlyOperators {
    ...
    function setRxcTokenAddress(address _rxcToken) public onlyOperators {
        rxcToken = IERC20(_rxcToken);
    }
    ...
    function delistMarketItem(address nftContract, uint256 itemId) public nonReentrant {
        require(!maintenanceMode,"Maintenance mode");
        require(msg.sender == idToMarketItem[itemId].seller,"Character not owned");
        require(!idToMarketItem[itemId].sold,"Character already sold");
    ...
    function createMarketSale(address nftContract, uint256 itemId) public nonReentrant {
        ...
        require(rxcToken.balanceOf(msg.sender) >= price, "Insufficient balance");
        
        rxcToken.transferFrom(msg.sender,idToMarketItem[itemId].seller,price);
