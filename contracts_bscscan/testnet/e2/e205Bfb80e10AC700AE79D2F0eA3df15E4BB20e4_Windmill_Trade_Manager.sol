...
contract Windmill_Trade_Manager is Math, Adressable, AccessControlEnumerable, With_DAORole, With_FundContract,
                                   I_Windmill_Trade_Manager{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    function addTradeDeployer(I_Windmill_Trade_Deployer deployer) external onlyRole(DAO_ROLE){
    ...
    function startTrade(uint256 deployerId, uint256 nbEnergy) external returns (uint256){
        require(nbEnergy <= getRemainingEnergy(msg.sender), "Windmill_Trade_Manager: Not enough energy.");
        require(deployerId < deployers.length, "Windmill_Trade_Manager: Trade deployer not found.");
        ...
        I_Windmill_Trade_Abstract trade = deployer.deployer.deployNewTrade(msg.sender, thisAddr, address(fund));
