...
/* -------------------------- Accumulator Triggers -------------------------- */
	...
	uint256[5] public triggerLog = [0, 0, 0, 0, 0];
	// Will keep track of trigger indexes, which can be triggered during current tx.
	uint8[] public canTrigger;

	function setCanTrigger(uint8[] memory _canTrigger) external onlyOwner {
