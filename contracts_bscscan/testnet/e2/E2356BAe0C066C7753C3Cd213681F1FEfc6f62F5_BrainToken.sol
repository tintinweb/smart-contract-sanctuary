...
contract BnbRainDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("BnbRain_Dividend_Tracker", "BnbRain_Dividend_Tracker", 9) {
    	claimWait = 600;
        minimumTokenBalanceForDividends = 10000000 * (10**9); //must hold 10000+ tokens
    }
...
contract BrainToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x0db1C827D803E0753fcEA8A695C29FB7c7299942;
