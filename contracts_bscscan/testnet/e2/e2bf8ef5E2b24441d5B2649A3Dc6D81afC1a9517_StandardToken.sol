...
contract StandardToken is Ownable, Pausable {
    ...
    address public WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //change
	...
	function setFees(uint256 _liquidity, uint256 _holders, uint256 _burn, uint256 _denominator) onlyOwner public {
        uint256 _total = _liquidity + _holders + _burn;
    ...
    constructor(address _owner) {
        ...
        holdersWallet = 0x1EEcF3334A3b9C07048Ed82717b2405A82F88569; // change (holders wallet)
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //change ()
