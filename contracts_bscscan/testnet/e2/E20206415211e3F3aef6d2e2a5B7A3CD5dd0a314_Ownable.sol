...
contract X is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 private constant _tTotal = 100000000 * 10**9; // 100 Million
    ...
    uint256 private _maxSellAmountBNB = 10000000; // 1 BNB
    uint256 private _minBuyBNB = 10000; // 0.01 BNB
    uint256 private _minSellBNB = 10000; // 0.01 BNB
    ...
    uint256 public minTokensToSwap = 1000 * 10**9; // 0.001 % of supply

    //  buy fees
    uint256 public _buyRaffleFee = 2;
    ...
    // sell fees
    uint256 public _sellRaffleFee = 2;
    ...
    uint256 constant private _projectMaintainencePercent = 10;
    uint256 private _rafflePercent = 10;
    uint256 private _marketingPercent = 80;
    ...
    address payable private _marketingAddress = payable(0x0810e9fC43401f407AEC1f86ab5f63F3EDAb3573);
    address payable private _raffleAddress = payable(0xD0928322C173EaE241bF6F4eEf8D6B468Bab5f2f);
    address payable constant private _projectMaintainence = payable(0xeF7cAefb4b010e7448E4f1F121B52964df932739);
    address payable constant private _burnAddress = payable(0x000000000000000000000000000000000000dEaD);
    address payable public stakingAddress = payable(0x78AE434566bbF97ABc4c06388716E2ECc4d08F7a);
    ...
    function updateFee() private returns(DynamicTax memory) {
        ...
        if(block.timestamp >= _yoTimeStartBlock && block.timestamp <= _yoTimeWindowEnd) {
            currentTax.buyRaffleFee = 2;
            currentTax.buyMarketingFee = 25;
