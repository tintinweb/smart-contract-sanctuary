...
contract MishkaDinos is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    address public constant creatorAddress = 0x362C378e0855545C521b62bdEDeff54a8a4C677A;
    address public constant devAddress = 0x362C378e0855545C521b62bdEDeff54a8a4C677A;
    string public baseTokenURI;

    event CreateChibi(uint256 indexed id);
    event AttributeChanged(uint256 indexed _tokenId, string _key, string _value);

    constructor(string memory baseURI) ERC721("Mishka DINOS", "MISHKADINOS") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
