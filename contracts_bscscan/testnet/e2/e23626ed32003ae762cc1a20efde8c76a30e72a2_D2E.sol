...
contract D2E is Context, IERC20, Ownable {
    ...
    uint256 public _FeeAnimation_X100 = 200;
    uint256 public _FeeDev_X100 = 50;
    uint256 public _FeeMarketing_X100 = 159;





    uint256 _promoFee = (_FeeAnimation_X100+_FeeDev_X100+_FeeMarketing_X100)/100;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x000000000000000000000000000000000000dEaD)] = true; //fee_collector
        _isExcludedFromFee[address(0x6380AD4BdEc5B2c562Cd55dddD650E1d5a7c1eCf)] = true; //fee_collector
        ...
        _isCommunity[address(0x6380AD4BdEc5B2c562Cd55dddD650E1d5a7c1eCf)] = true; //fee_collector

        //don't need to hold GEN
        putYourGenAway[address(0x000000000000000000000000000000000000dEaD)] = true; //dead
        putYourGenAway[address(0x6380AD4BdEc5B2c562Cd55dddD650E1d5a7c1eCf)] = true; //fee_collector
