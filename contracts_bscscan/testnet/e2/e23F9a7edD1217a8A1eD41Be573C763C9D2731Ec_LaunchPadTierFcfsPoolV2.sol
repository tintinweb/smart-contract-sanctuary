...
contract LaunchPadTierFcfsPoolV2 is Ownable, Initializable {
    // Contract libs
    ...
    uint256 public tierRequiredLockedAmount;
    ...
    function setTierParams(
        ...
        uint256 _tierRequiredLockedAmount
    ) public onlyOwner {
        tierName = _tierName;
        tierRequiredLockedAmount = _tierRequiredLockedAmount;
    }
    ...
    function buylaunchPadTokens() public {
        ...
        require(
            lockPool.validWhitelist(_msgSender(), tierRequiredLockedAmount),
