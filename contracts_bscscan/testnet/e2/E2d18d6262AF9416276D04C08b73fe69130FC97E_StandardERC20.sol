...
contract TokenFactoryBase is Ownable {
  using SafeMath for uint256;
...
// Dependency file: contracts/tokens/StandardERC20.sol
...
// import "contracts/tokens/StandardERC20.sol";
...
contract StandardTokenFactory is TokenFactoryBase {
  ...
  function create(
    ...
    payable(feeTo).sendValue(msg.value);
