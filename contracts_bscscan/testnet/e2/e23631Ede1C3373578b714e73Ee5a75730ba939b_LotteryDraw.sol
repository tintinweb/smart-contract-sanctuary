...
contract LotteryDraw is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000 * 10**_decimals;         // 0,2% supply Maximum buy and sell at a time
	uint256 public _maxWallet = 5000 * 10**_decimals;           // 1% supply Maximum Wallet
    uint256 private _timestamp = 1630537200;                    // Start of shopping
	uint public sellPerSecond = 10;                             // time Sell purchases
    uint public buyPerSecond = 10;                              // time Buy purchases
    uint public TaxExtra01 = 13;                                // extra_tax 01
    uint public TaxExtra02 = 15;                                // extra_tax 02
    uint public TaxExtra03 = 17;                                // extra_tax 03
