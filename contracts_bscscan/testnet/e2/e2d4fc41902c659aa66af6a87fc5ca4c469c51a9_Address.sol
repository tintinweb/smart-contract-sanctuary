...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    string public _name = "SafeBoom";
    string public _symbol = "SAFEBOOM";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1 * 10**6 * 10**9; // 1 million
	...
	*/
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) public {
        ...
        uniswapV2Router.addLiquidityBNB{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            //owner(),  // TBA replacing with tokenContract to hold LP and can not be touched forever
			address(this), // TBA replacing with tokenContract to hold LP and can not be touched forever
            block.timestamp
        );
    }
