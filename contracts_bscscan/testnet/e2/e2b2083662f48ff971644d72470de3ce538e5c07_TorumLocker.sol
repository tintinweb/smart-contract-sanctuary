...
contract TorumLocker is ReentrancyGuard  {
   ...
   constructor(ERC721 _NFT, ERC20 _ERC20, string memory _name) public {
        NFT = _NFT;
        LiquidToken = _ERC20;
        creator = msg.sender;
        name = _name;
