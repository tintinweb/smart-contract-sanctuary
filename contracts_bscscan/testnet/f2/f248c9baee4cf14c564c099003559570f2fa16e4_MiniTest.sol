...
contract MiniTest is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xad761ddC60f206F203516838eb3B4baeED6dDBe3); 
    ...
    constructor () {
        ...
        // Pancakerouteraddy testnet v2(0x6EF53411545BeC56998AeE35F39406472ec2FeD0);
        // Pancakerouteraddy mainnet v2(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6EF53411545BeC56998AeE35F39406472ec2FeD0);
