...
contract MultiPad is IBEP20 {
    ...
    address private Reserve = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2;
    address private Marketing = 0xCA35b7d915458EF540aDe6068dFe2F44E8fa733c;
    address private Team1 = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db;
    address private Team2 = 0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;
    address private Liquidity = 0xd9C868C63f0AEeE1772e6348a7baf723Aa58d1a5;
    address private IDO = 0xaDF20cF44Ef922A3c1Da2EE60ff72eE414930E94;
    address private Partners = 0x14723A09ACff6D2A60DcdF7aA4AFf308FDDC160C;
    ...
    */
    ...
    function claimPurchasedTokens(uint256 _lockNumber) external validateClaim(msg.sender,_lockNumber) returns (bool){
        ...
        _contributionBNB[msg.sender] = _contributionBNB[msg.sender] - _finalSoldAmount[msg.sender].div(4).div(tokenPrice);
    ...
    function getSoldStatus() public view returns(uint256 _totalAvailable, uint256 _currentAvailable){
       ...
       _currentAvailable = balanceOf(IDO);
    }
