...
contract BuybackProtocol is Ownable, ReentrancyGuard {
    ...
    event WithdrawBUSD(address indexed owner, uint256 amount);
    ...
    constructor (address _BYIELD, uint256 _startingBlockNumber) public {
    ...
    function buybackAndBurn() external {
        ...
        if( block.number < lastBuybackBlock && lastBuybackBlock != 0){
            ...
            uint256 buybackAmount = contractBUSD.mul(3).div(100);
    ...
    function withdrawFunds () external onlyOwner {
        ...
        BUSD.safeTransfer(devaddr, amount);
