...
contract Proposal is Ownable {
    ...
    // function GetVoteCount(uint pId_, uint option_) public view returns(uint) {
    //     return voteInfo[pId_].option[option_].count;
    // } 
    ...
    // function cardIsVote(uint pId_, uint tokenId_) public view returns(bool) {
    //     if (voteInfo[pId_].tIdIsVote[tokenId_]) {
    //         return true;
    //     }
    //     if (KTA.ownerOf(tokenId_) != _msgSender()) {
    //         return true;
    //     }
    //     return false;
    // }
