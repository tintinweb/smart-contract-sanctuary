...
contract DMMFactory is IDMMFactory, ManageUser {
    ...
    function changeRatio(address pool, uint32 newRatio) public _admin {
...
contract TestManageUser is ManageUser {
    ...
    function testOnlySuperAdmin() public view _superAdmin returns (uint256) {
        return 100;
    }

    function testAdmin() public view _admin returns (uint256) {
        return 200;
    }

    function everyoneCanRead() public pure returns (uint256) {
        return 300;
    }
}
