...
contract hello is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0x1BAe0feda37F7F2Aa0BBbfc95A1f0B0A25040887); //team Address
    address payable public marketingWalletAddress = payable(0x28061B111D044d574822A9C08D26925F3d0a3DfD); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x441694B93b09bFA0CC59B094c26373BB7825b848); // buyback Address
