...
//migrated
    ...
    event Airdrop(address indexed _owner, uint _amount, uint _balance);
        ...
        require( totalDistributed < _totalSupply );
        
        _balances[_participant] = _balances[_participant].add(_amount);
        ...
        // log
        emit Airdrop(_participant, _amount, _balances[_participant]);
...
contract Groot is AlixERC20, ReentrancyGuard {
    using SafeMath for uint256;
