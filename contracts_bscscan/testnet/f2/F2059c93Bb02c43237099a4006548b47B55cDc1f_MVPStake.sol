...
contract MVPStake is ERC20("MVPS1 Stake", "ST-MVPS1") {
    ...
    IERC20 public mvp;
    TokenineRewardPoint mvpp;
    uint public endDate = 1625934632; //  Saturday, July 10, 2021 11:30:32 PM GMT+07:00
    ...
    function enter(uint256 _amount) public {
        ...
        mvpp.mint(msg.sender, _amount.div(10));
        mvp.transferFrom(msg.sender, address(this), _amount);
    }

    function leave(uint256 _share) public {
        require(endDate<=now, "ERC20: Stake for 14 days");
        uint256 totalShares = totalSupply();
        uint256 what = _share.mul(mvp.balanceOf(address(this))).div(totalShares);
...
contract TokenineRewardPoint is Context, ERC20, AccessControl, Ownable {
    ...
    constructor() public ERC20("MVP special 1", "MVPS1") {
