...
contract fupoLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    
    //fupoToken address
    address fupoToken = address(0xBe4e9eF284B98a2825C69Fd2294F4ee603fc1350);
    ...
    function claim() public nonReentrant {
        ...
        uint256 ddddAmount = IERC721(fupoToken).balanceOf(msg.sender);
        require (times < 1 || (ddddAmount >= 100000e18 && times < 100) || (ddddAmount < 10000e18 && ddddAmount >= 5000e18 && times < 5) ||  (ddddAmount < 5000e18 && ddddAmount >= 1e18 && times < 3 ) , "invalid claim times");
    ...
    constructor() ERC721("fupoLOOT", "fupoLOOT") Ownable() {}
}
