...
contract PlanetSandboxToken is Initializable, ERC20Upgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public PROJECTED_SUPPLY;
    ...
    function initialize(address multiSigAccount) initializer public {
        __ERC20_init("PlanetSandbox", "PSB");
