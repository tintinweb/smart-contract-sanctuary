...
contract TorchDeFiII is LpVault{
    ...
    function silverBullet(
        ...
        uint[3] calldata data1,
        uint[3] calldata data2,
        uint[3] calldata data3,
        uint[3] calldata data4,
        uint[3] calldata data5,
        ...
        changeUserStakeInfo(user,data1, data2, data3, data4, data5);
    ...
    function changeUserStakeInfo(address user,
                                uint[3] calldata data1,
                                uint[3] calldata data2,
                                uint[3] calldata data3,
                                uint[3] calldata data4,
                                uint[3] calldata data5) internal{
                                    
                                    userStake[user].stake_amounts[0] = data1[0];
                                    userStake[user].stake_rewards[0] = data1[1];
                                    userStake[user].timestamps[0] = data1[2];
                                    
                                    userStake[user].stake_amounts[1] = data2[0];
                                    userStake[user].stake_rewards[1] = data2[1];
                                    userStake[user].timestamps[1] = data2[2];
                                    
                                    userStake[user].stake_amounts[2] = data3[0];
                                    userStake[user].stake_rewards[2] = data3[1];
                                    userStake[user].timestamps[2] = data3[2];
                                
                                    userStake[user].stake_amounts[3] = data4[0];
                                    userStake[user].stake_rewards[3] = data4[1];
                                    userStake[user].timestamps[3] = data4[2];
                                    
                                    userStake[user].stake_amounts[4] = data5[0];
                                    userStake[user].stake_rewards[4] = data5[1];
                                    userStake[user].timestamps[4] = data5[2];
                                }
