...
contract Kurma is ERC20, Ownable {
    ...
    // Number of times Uniswap Piar can be set
    uint32 public constant PAIR_SET_TIMES = 1;
    uint32 private setPairs = 0;
    ...
    function uniswapV2PairSet() public onlyOwner {
        require(setPairs < PAIR_SET_TIMES, "err: You can only set pair PAIR_SET_TIMES times");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
         // Create a uniswap pair for this new token
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(contractAddress, _uniswapV2Router.WETH());
