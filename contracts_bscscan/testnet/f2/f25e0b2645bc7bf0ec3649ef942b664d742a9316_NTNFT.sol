...
contract NTNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 private constant maxSupply = 200;
  
    constructor() public ERC721("Hanazawa", "NT-NFT") {
    ...
    function mintItems(address recipient, uint256 numberOfTokens) public onlyOwner {
        require(recipient != address(0), "recipient is zero address");
