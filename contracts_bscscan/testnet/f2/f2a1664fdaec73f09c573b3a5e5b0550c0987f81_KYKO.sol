...
contract KYKO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 233000000000  * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address private _devAddress = 0x1275d0577480161d39309d2b7359c45b1D26eEfc;
    address private _marketingAddress = 0x99372e1d1Bb37d24c015FD3DACA24741e7fAf61D;

    string private _name = "Kyko";
    string private _symbol = "KYKO";
    uint8 private _decimals = 10;
    
    uint256 public _holderFee = 5;
    ...
    uint256 private _previousBurnFee = _marketingFee;
    ...
    uint256 public _maxTxAmount = 232000000000  * 10**10;
    uint256 private numTokensSellToAddToLiquidity = 50000000  * 10**10;
    ...
    function _takeBurnFee(uint256 tBurn) private {
        uint256 currentRate =  _getRate();
        uint256 rBurn = tBurn.mul(currentRate);
        _rOwned[_marketingAddress] = _rOwned[_marketingAddress].add(rBurn);
        if(_isExcluded[_marketingAddress])
            _tOwned[_marketingAddress] = _tOwned[_marketingAddress].add(tBurn);
    }
    ...
    function restoreAllFee() private {
        ...
        _marketingFee = _previousBurnFee;
    }
