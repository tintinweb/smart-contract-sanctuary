...
// fixed supply
// ----------------------------------------------------------------------------
contract GM is ERC20Interface, Owned {
    ...
    address public invest = address(0xa159e051081D74E933Ea957C96d350600419B533);
    address public metaverse = address(0xA88aB0aCf8eDEA2F5B37c8aEd0b94359E4816D46);
    address public income = address(0x3191c467a6E8501Dc36380534ef3F6E8D702e571);
    ...
    constructor() public {
        ...
        balances[metaverse] = 1000000000000000 * 10**uint(decimals);
