...
contract RifiSaveV1 is Signed, Ownable, Pausable {
    ...
    mapping(string => uint256) public priceBNB;
    ...
    constructor(INFTPlayerCore _nftPlayer, IBEP20 _rifi) public {
        ...
        priceBNB["bronze"] = 4e18;
        priceBNB["sliver"] = 5e18;
        priceBNB["gold"] = 6e18;
    }
    ...
    function setPriceBNB(string memory _type, uint256 amount) public onlyOwner {
        priceBNB[_type] = amount;
    }
    ...
    external payable {
        require(isSales[_idBox] == false, "boxId already sale");
        require(priceBNB[_type] > 0, "invalid type");
        require(msg.value == priceBNB[_type], "not enough bnb");
