...
contract BasketCoin is BEP20, Pausable, Ownable {
    ...
    bool public convertStatus = true;
    ...
    constructor() BEP20("BasketCoin", "BSKT") {}
    ...
    function convert(storeParams memory vars) public {
        require(convertStatus, "unable to use this function");
        ...
        _mint(vars.user,vars.amount);
    }
    
    function burn(address user,uint256 amount) public {
        require(_msgSender() == devAddress, "Developer only accessible");
    ...
    function convertStatusUpdate(bool status) public onlyOwner {
