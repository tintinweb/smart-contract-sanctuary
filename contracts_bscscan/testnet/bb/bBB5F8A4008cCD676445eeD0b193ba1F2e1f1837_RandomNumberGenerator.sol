...
interface IBSCdefiSwapLottery {
    ...
    /**
     * @notice Draw the final number, calculate reward in BSCdefiToken per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in BSCdefiToken
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInBSCdefiToken: price of a ticket in BSCdefiToken
    ...
    function startLottery(
        uint256 _endTime,
        uint256 _priceTicketInBSCdefiToken,
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public BSCdefiSwapLottery;
     ...
     * @param _seed: seed provided by the BSCdefiSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == BSCdefiSwapLottery, "Only BSCdefiSwapLottery");
    ...
    /**
     * @notice Set the address for the BSCdefiSwapLottery
     * @param _BSCdefiSwapLottery: address of the BSCdefiSwap lottery
     */
    function setLotteryAddress(address _BSCdefiSwapLottery) external onlyOwner {
        BSCdefiSwapLottery = _BSCdefiSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBSCdefiSwapLottery(BSCdefiSwapLottery).viewCurrentLotteryId();
    }
}