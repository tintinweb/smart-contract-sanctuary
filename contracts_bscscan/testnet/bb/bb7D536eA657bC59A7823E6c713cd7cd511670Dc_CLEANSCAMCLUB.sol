...
/**
 * 
CLEANSCAMCLUB is the world’s most community-centric CLEANSCAM marketplace, where artists and art collectors can easily find each other while simultaneously managing the limitless potential of their own marketplace. Our vision is to put the power back in the hands of art and content creators so the true value of their work is realized.

$CLEANSCAMCLUB is used in Our CLEANSCAMCLUB Marketplace where CLEANSCAM Product creator will shared media product and get paid by users in CLEANSCAM, Whole system will be decentralised. 
*/
...
contract CLEANSCAMCLUB is Context, IERC20, Ownable {
