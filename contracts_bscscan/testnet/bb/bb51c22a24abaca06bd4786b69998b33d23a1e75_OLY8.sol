...
/**
 ...
 set max wallet to high before add lp
 
 WIP
dividend is verified by deploying the dividenddistributor.sol separately. bscscan will find a match auto. but need to test it works properly
add show maxwallet 
...
contract OLY8 is IBEP20, Auth {
    ...
    string constant _name = "OLY8";
    string constant _symbol = "OLY8";
  ...
  //  uint256 buybackMultiplierLength = 30 minutes;
    ...
    function checkMaxWallet(address recipient, uint256 amount) internal view { 
        require(balanceOf(recipient)+amount <= maxWallet, "Max Wallet Exceeded 2%"); //added for maxWallet
    }
