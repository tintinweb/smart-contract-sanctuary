...
contract BPManager is AccessControl{
    ...
    function getFastestBuyers() external view onlyRole(DEFAULT_ADMIN_ROLE) returns (address[] memory) {
        return _botProtectionContract.getFastestBuyers();
    }


    function getFastestBuyersValidUntil() external view onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256) {
        return _botProtectionContract.listingTimestamp() + _botProtectionContract._fastestBuyersTimeframe();
    }

    function getBlackListValidUntil() external view onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256) {
        return _botProtectionContract.listingTimestamp() + _botProtectionContract._blacklistTimeframe();
    }
    function getMaxSellAmount() external view onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256){
        return _botProtectionContract._maxSellAmount();
    }

    function getMaxBuyAmount() external view onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256){
        return _botProtectionContract._maxBuyAmount();
    }


    function getSellCooldown() external view onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256){
        return _botProtectionContract._sellCooldown();
    }

    function getBuyCooldown() external view onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256){
    ...
    function getBlacklistArray() external view onlyRole(DEFAULT_ADMIN_ROLE) returns(address[] memory){
