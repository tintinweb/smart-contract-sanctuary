...
//Context, ERC20, ERC20Burnable, Pausable, Ownable
 contract  Lgtbi is Context, IERC20, Ownable {
    ...
    string private _name = "LGTBI+ Coin";
    string private _symbol = "LGTBI+";
    
    uint8 private _decimals = 5;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**5;
                            //1000000000 * 10**6 * 10**8;
                            //1000000 0000
                            //10.000.000.000
    ...
    uint256 public _maxTxAmount = 3000 *  10**5;
    uint256 private minimumTokensBeforeSwap = 2000  * 10**5; 
    uint256 private buyBackUpperLimit = 1 * 10**5;
    ...
    //to recieve BNB from PancackeSWAP when swaping
