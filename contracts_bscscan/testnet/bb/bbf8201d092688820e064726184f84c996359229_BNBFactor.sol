...
contract BNBFactor {
	...
	constructor(address payable wallet, address payable wallet1, address payable wallet2, address payable wallet3, IBEP20 tokenAdd) public {
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		commissionWallet1.transfer(fee);
		commissionWallet2.transfer(fee);
		commissionWallet3.transfer(fee);
