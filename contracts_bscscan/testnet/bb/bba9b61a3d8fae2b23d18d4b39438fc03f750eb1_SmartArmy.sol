...
contract SmartArmy is UUPSUpgradeable, OwnableUpgradeable, ISmartArmy {
  ...
  function _initLicenseTypes() internal {
    updateLicenseType(1, "Trial",       100,    1, true);
    updateLicenseType(2, "Opportunist", 1_000,  3, true);
    updateLicenseType(3, "Runner",      5_000,  5, true);
    updateLicenseType(4, "Visionary",   10_000, 7, true);
  }
