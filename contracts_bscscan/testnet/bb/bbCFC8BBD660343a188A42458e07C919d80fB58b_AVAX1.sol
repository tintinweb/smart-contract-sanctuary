...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xf888772956607FE9440e1Daa6285bb90D804bF4b); //the reward token you want distributed - AVAX
...
contract AVAX1 is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0xf888772956607FE9440e1Daa6285bb90D804bF4b; // AVAX
    
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address private boosterWallet = 0xaAD40945e1E721cC43D3BeAbd4d7D60E536da8b1;
    address private charityWallet = 0xaAD40945e1E721cC43D3BeAbd4d7D60E536da8b1;

    address routerv2 = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

    string constant _name = "AVAX1";
    string constant _symbol = "AVAX1";
    ...
    uint256 public buyingBoosterFee = 6;
    ...
    uint256 public buyersTotalFees = buyingBoosterFee.add(buyingRewardFee).add(buyingLpFee).add(buyingCharityFee);
    uint256 public sellersTotalFees = sellingBoosterFee.add(sellingRewardFee).add(sellingLpFee).add(sellingCharityFee);
    ...
    function calcBuyersTotalFees() private {
        buyersTotalFees = buyingBoosterFee.add(buyingRewardFee).add(buyingLpFee).add(buyingCharityFee);
    }
    
    function calcSellersTotalFees() private {
        sellersTotalFees = sellingBoosterFee.add(sellingRewardFee).add(sellingLpFee).add(sellingCharityFee);
    }
    ...
    uint256 charityPortion, uint256 lpPortion) external onlyOwner {
        
        uint256 totalPortion = boosterPortion.add(rewardPortion).add(charityPortion).add(lpPortion);
