...
contract KRC20 is Context, IKRC20, Ownable {
    uint256 private constant _preMineSupply = 500 * 1e18; // refer tokenomics
    uint256 private constant _maxSupply = 35000* 1e18; // max limit
...
// p token with Governance.
contract oken is KRC20('p', 'p') {
