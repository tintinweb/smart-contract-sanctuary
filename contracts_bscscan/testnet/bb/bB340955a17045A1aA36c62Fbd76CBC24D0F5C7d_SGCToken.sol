...
contract SGCToken is Ownable, IBEP20 
{
    ...
    address funds = 0xF337Cb77d30384C330f7B65D878fd1dB62C8AE57; 
    
    // Wallet de recaudacion para el desarrollo de juegos
    address gamers = 0x188Ed70ed3928d26bB193413c0Fc242de7e18e90;

    // Wallet de recaudacion para publicidad
    address market = 0xF1020cB7716e620296De96bF35DF4320c5d62038;
    ...
    constructor() 
    {
        _name = "Super Token"; // Descripcion de la moneda
        _symbol = "ST"; // Simbolo de la moneda
        _decimals = 9; // Decimales
        _totalSupply = 2 * 10 ** 15 * 10 ** 9; // Primera parte 24 ceros, y 18 ceros de Decimales
        _totalHolders = 5; // Inicialmente cuantos holders hay para calcular
        ...
        holders.push(CEOAddress);
        holders.push(coreTeamAddress1);
        holders.push(coreTeamAddress2);
        holders.push(coreTeamAddress3);
        holders.push(coreTeamAddress4);
