...
contract ImageContract is IERC721Metadata, ERC721{
  ...
  constructor()  ERC721("Image_NFT", "NFT Mint")  {}

  function mint(string memory _Artwork_name, string memory _Artwork_description, string memory _Artwork_url_image, uint _Artwork_price) public returns (uint){
  ...
  function setInstructor(string memory _fName, uint _age) public {
   ...
   function getInstructor() public view virtual  returns (string memory , uint) {
       return (fName, age);
   }
 function approveNFT(address _to, uint _tokenId) public {
  ...
  function updatePrice(uint _id, uint _Artwork_price) public returns (bool){
    require(ownerOf(_id) == msg.sender);
    imageData[_id].Artwork_price = _Artwork_price;
  ...
  function approveForAuction(address _to, uint _tokenId, uint _Artwork_price, uint _time) public {
    ...
    ad.Artwork_price = _Artwork_price;
    ad.time = _time;
