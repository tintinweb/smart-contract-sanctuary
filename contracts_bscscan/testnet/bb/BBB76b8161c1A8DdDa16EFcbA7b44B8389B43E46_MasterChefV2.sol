...
// File: contracts/libs/IReferralSystem.sol
...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    MintablePiston public immutable revolution;
    ...
    constructor(
        MintablePiston _revolution,
        address _feeAddress,
        uint256 _startBlock
    ) public {
        require(_startBlock >= block.number && _startBlock < 16155700, "invalid startBlock"); 
