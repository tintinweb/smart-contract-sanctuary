...
//   event SetValue(address indexed from, uint256 main, uint256 _author, uint256 _platform);
  ...
  function buyNFT(address nft_a,uint256 tokenId, address buyer) public{
        ...
        if(revenueShare.checkTokenOwnerIsArtist(tokenId)){
  ...
  require(msg.sender == 0xb1b008a2009CeB738f6cD4de87D14C713B831Cf9 || msg.sender == 0x0160b796792D38B98cd19f718F8dF6c143E5c529,"Not Authorized");
  _;
  }
