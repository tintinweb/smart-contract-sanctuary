...
pragma solidity ^0.6.12;
    ...
    contract Bansol is Context, IERC20, Ownable {
        ...
        uint256 private _maxTxAmount = 11000000000e9;
        ...
        constructor (address payable charityWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // UniswapV2 for BSC network
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xa193DCbB5DfEd08B35637A3fC7619C41a49D884F, 'We can not exclude Uniswap router.');
