...
/**
   #AnteUp (ANTE)
       ...
       0% Redistribute To All Holders
       1% fee auto add to the liquidity pool.
       1% fee auto moved toMarketing wallet
       1% fee auto burn.
 */
...
contract AnteUp is Context, IBEP20, Ownable {
    ...
    address public   MarketingWallet = 0x0C7a11e33cb2Da150260B60B653F3B876F3aF78e; //Marketing Wallet address Here ....
    
    string private _name = "AnteUp";
    string private _symbol = "ANTE";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0; // Redistribute fee
    ...
    function setMarketingFeePercentage(uint256 MarketingFee) external onlyOwner() {
       ...
       function setBurnFeePercentage(uint256 burnFee) external onlyOwner() {
        _burnFee = burnFee;
        _previousBurnFee = _burnFee;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Calculate burn amount andMarketing amount
        ...
        //Temporarily remove fees to transfer to burn address andMarketing wallet
        _taxFee = 0;
        _liquidityFee = 0;

        //Send transfers to burn andMarketing wallet
