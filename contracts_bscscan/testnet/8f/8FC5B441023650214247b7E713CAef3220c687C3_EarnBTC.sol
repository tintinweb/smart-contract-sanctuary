...
contract EarnBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EarnBTC";
    string constant _symbol = "EarnBTC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 350; // 3.5%
    ...
    uint256 public swapThreshold = _totalSupply / 50; // 0.5%
    bool inSwap;
