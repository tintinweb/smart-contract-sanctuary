...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    function MintCatNIPNFT(address minterAddress, string memory tokenURIstring, uint256 costOfNFT, uint256 codeForCatMechanism) public returns (uint256) {
        ...
        // if(codeForCatMechanism > currenctCode.add(50) || codeForCatMechanism < currenctCode.sub(50)){   // if it's out of range.
        //     require(codeForCatMechanism == currenctCode, "Wrong code format.");
        // }
        ...
        // if(codeForCatMechanism < currenctCode.add(50) && codeForCatMechanism > currenctCode.sub(50)){   
