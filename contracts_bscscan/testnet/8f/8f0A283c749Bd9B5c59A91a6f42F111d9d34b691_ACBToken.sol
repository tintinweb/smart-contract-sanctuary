...
contract StandardTokenWithFees is StandardToken, Ownable {
  ...
  function _mint(address account, uint256 amount) internal {
    ...
    require(_totalSupply + amount <= _maxSupply, "Mint exceeds max supply");
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    require(balances[account] - amount >= 0, "ERC20: burn amount exceeds balance");
...
contract ACBToken is Pausable, StandardTokenWithFees, BlackList, MinterRole{
    ...
    function ComputingPowerToken() public {
        name = "ACBToken";
        symbol = "ACB";
        decimals = 0;
        _maxSupply = 900000;
    ...
    function mint(uint amount, address account) onlyMinter public{
        _mint(account, amount);
        
        emit MintToAddress(account, amount);
    }
    
    function burn(uint amount, address account) onlyMinter public{
        _burn(account, amount);
        
        emit BurnFromAddress(account,amount);
    }
    ...
    event MintToAddress(address owner, uint amount);
    event BurnFromAddress(address owner, uint amount);
}