...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**18); // 1 ETH minimum auto send
...
contract KingHolder is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "King Holder";
    string constant _symbol = "KHLD";
