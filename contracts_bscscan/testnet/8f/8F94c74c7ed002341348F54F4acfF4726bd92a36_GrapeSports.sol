...
contract GrapeSports {
    ...
    *  *****************************/
    ...
    function supplyPool(uint fixture, uint position, uint256 amountInWei) external
    {
        ...
        {
            fixturePoolTeamAway[fixture] = SafeMath.safeAdd(fixturePoolTeamAway[fixture], fixturePoolTeamAway[fixture]);
        }
        else if(position == 3)
        {
            fixturePoolDraw[fixture] = SafeMath.safeAdd(fixturePoolDraw[fixture], fixturePoolDraw[fixture]);
        }
        else
        {
