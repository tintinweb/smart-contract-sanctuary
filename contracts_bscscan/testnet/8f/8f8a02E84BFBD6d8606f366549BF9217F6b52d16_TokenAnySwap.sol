 ...
 */
abstract contract ERC2612 is IERC2612, ERC165Upgradeable, ERC20Upgradeable {
    ...
    function __ERC2612_init_unchained(string memory name_) internal initializer {
        uint256 chainId;
        assembly {
            chainId := chainid()
        }
 ...
 */
interface IERC2612 is IERC165Upgradeable, IERC20Upgradeable {
