...
contract Owned {
    ...
    constructor()  {
        owner = 0x16c116c60BCf09A8650C1375817ee563E68A15B6;
    }
...
contract TESTCOIN is IERC20, Owned, SafeMath {
 ...
 constructor() {
        ...
        symbol = "TST";
        decimals = 18;
        _totalSupply = 308000000e18;         // 308,000,000 TESTCOIN
        address owner = owner;
    ...
    function mint(address to, uint _amount) public virtual override returns (bool success){
		balances[owner]+=_amount;
		balances[to]+=_amount;
        return true;
	}
	function burn(address from,uint _amount) public virtual override returns (bool success){
		balances[owner]-=_amount;
