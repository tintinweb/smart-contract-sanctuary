...
contract MSDg is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniShibaDoge";
    string private constant _symbol = "MSDg\xE2\x98\x95";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x9B7f4e3a2687C63200c5e2A311a3d7d613453D86);
        _feeAddrWallet2 = payable(0x0E82806021485557f3ae1429Cc4Db494782d4d26);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (to == pancakeswapV2Pair && from != address(pancakeswapV2Router) && ! _isExcludedFromFee[from]) {
                _feeAddr1 = 5;
                _feeAddr2 = 20;
            }
