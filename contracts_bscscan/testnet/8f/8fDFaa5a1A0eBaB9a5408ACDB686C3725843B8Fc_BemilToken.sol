...
contract BemilToken is BEP20 {
    ...
    constructor(uint256 cap_) BEP20("Bemil", "BEM") {
    ...
    function burnFrom(address _account, uint256 _amount) public virtual onlyOwner {
        ...
        allowance(_account, msg.sender).sub(_amount, "BEP20: burn amount exceeds allowance");
    ...
    function increaseMintingAllowance(address _minter, uint256 _addedValue) public virtual onlyOwner {
        require(isMinter(_minter), "beneficiary is not a minter");
