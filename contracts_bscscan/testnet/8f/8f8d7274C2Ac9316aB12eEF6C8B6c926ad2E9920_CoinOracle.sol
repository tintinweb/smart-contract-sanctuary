...
/**  
    ...
    -4% of each transaction is converted to BNB and used for marketing and development
    -3% each transaction is distributed to the holders automatically
...
contract CoinOracle is Context, IBEP20, Ownable {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(!takeFee || (!containOriginalFee && isNFTContract(sender)))
            removeAllFee();
