...
contract Creator{
  ...
  function wd(address tokenAd) public onlyOwner{
  ...
  function testDAI(uint exp) public payable{
      newContract(0x8a9424745056Eb399FD19a0EC26A14316684e274, 0xAE4C99935B1AA0e76900e86cD155BFA63aB77A2a, exp);
  }
...

  {
    ...
    require(block.timestamp > users[tokenAddress].time, 'contract has been active');
    ...
    assembly {
        ...
        contracts.push(addr);
        users[tokenAddress].adr = addr;
        users[tokenAddress].time = getExpiry;
        users[tokenAddress].contract0 = addr;
