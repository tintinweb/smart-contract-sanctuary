...
contract TEST is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 210000 * (10**18);
    uint256 public maxSellTransactionAmount = 100000 * (10**18);
    uint256 public swapTokensAtAmount = 4000 * (10**18);
    uint256 public maxWalletToken = 315000 * (10**18); // 1.5% of total supply

    uint256 public dividendRewardsFee;
    uint256 public marketingFee;
    uint256 public immutable totalFees;

    // sells have fees of 12 and 6 (10 * 1.01 and 5 * 1.01)
    uint256 public sellFeeIncreaseFactor = 101;
    ...
    constructor() ERC20("TESTbb", "TESTbb") {
        ...
        buyBackWallet = 0x37cD1356418CeC0e3403eF8cf3EB2D00C4e7c95E;
