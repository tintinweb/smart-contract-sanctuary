...
contract HEARTK is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(string memory name_, string memory symbol_) ERC20(name_, symbol_) {
        addressForMarketing = 0xA73505453F58E367c80F16685079dAD6f4EA6b18;

        _mint(
            _msgSender(),
            MAX_TOTAL_SUPPLY.sub(tokensForAirdrop).sub(tokensForRewards)
        );
    ...
    function setMinTokensBeforeSwap(uint256 _tokensForMarketing)
        public
        onlyOwner
    {
    ...
    function claimAirdrop() public {
        ...
        require(
            tokensForAirdrop > 0,
            "The amount of tokens available for the airdrop has been exhausted."
        );
    ...
    function _transfer(
        ...
        if (
            ...
            super._transfer(
                address(this),
                addressForMarketing,
                _fee.mul(marketingDivisor).div(100)
            );
