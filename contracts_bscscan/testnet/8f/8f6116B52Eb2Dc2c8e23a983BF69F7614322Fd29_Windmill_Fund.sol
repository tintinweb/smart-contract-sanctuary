 ...
 */
interface I_Windmill_Fund is I_With_PWRToken, IAccessControlEnumerable {

    function setPancakeRouter(PancakeRouter addr) external;
...
contract Windmill_Fund is With_PWRToken, I_Windmill_Fund{
    IERC20 public BUSDToken;
    IERC20 public WBNBToken;
    PancakeRouter public pancakeRouter;

    address payable public DAOAddr;
