...
contract PayCoinSolutions is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PaySolution";

    address[] private _excluded;
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 120000000000000* 10**_decimals;     // Supply do Token = 120 trillions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public _maxTxAmount = 960000000000 * 10**_decimals;    // 960 billions - Initial max buy 
    uint256 public _maxRxAmount = 50000000 * 10**_decimals;        // 50 millions - Initial max sell
    uint256 public _maxWallet = 1440000000000 * 10**_decimals;     // 1.44 trillions - Initial max Wallet	
    uint public sellPerSecond = 20; // 20 seconds
    uint public buyPerSecond = 5;   // 5 seconds
    ...
    struct feeRatesStruct {
        ...
        uint256 burn;      // refletion to burn
    }
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
        ...
        marketingAddress = payable(0x2Be8CaBdE4662F02E5A1bC48E52A6Aa8C30E6Ca0); // wallet that accumulates bnb
