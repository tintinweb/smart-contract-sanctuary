...
/**         
     *REFLECT TOKEN * BUSD REWARDS * 24HR SELL LIMIT
     *         
     ...
     *3% LP
     *3% BNB Reflections
     *Can only sell once ever 24hours
     *
     *LP LOCKED FOREVER
...
contract REFLECT is IBEP20, Context {
    using SafeMath for uint256;
    ...
    uint256 public _maxSellToken = _maxWalletAmount / 10 ;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pcs2BNBPair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
