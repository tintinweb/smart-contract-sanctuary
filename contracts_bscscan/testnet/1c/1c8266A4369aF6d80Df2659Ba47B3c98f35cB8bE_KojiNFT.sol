...
contract KojiNFT is ERC721URIStorage, ERC165Storage, Ownable {
    ...
    string tier1URI = "https://nodezy.koji.earth/nft/v1/poster/72b7d6c6ccb28e39715465e89b4c9d32";
    string tier2URI = "https://nodezy.koji.earth/nft/v1/poster/72b7d6c6ccb28e39715465e89b4c9d32_";
    ...
    uint256 tier1balance = 1000000000000000000000000000; //1 Billion KOJI for tier1 promo mint
    uint256 tier2balance = 250000000000000000000000000; //250 Million KOJI for tier2 promo mint
    ...
    */
    ...
    function minttier1NFT(address recipient) public returns (uint256) {   
       ...
       require(minted[address(msg.sender)], "Wallet has reached 1 NFT mint limit for this contract");
       require(token.balanceOf(msg.sender) >= tier1balance, "$KOJI token balance insufficient for this tier");
       ...
       if (mintlimitsenabled) {
        ...
        minted[address(msg.sender)] = true;
        tier1minted[address(msg.sender)] = true;
        mintedtier1 = mintedCounttier1URI[tier1URI];
        mintedCounttier1URI[tier1URI] = mintedtier1 + 1;

        mintedtotal = mintedCount[1];
        mintedCount[1] = mintedtotal + 1;
    ...
    function minttier2NFT(address recipient) public returns (uint256) {   
       ...
       require(minted[address(msg.sender)], "Wallet has reached 1 NFT mint limit for this contract");
       require(token.balanceOf(msg.sender) >= tier2balance, "$KOJI token balance insufficient for this tier");
       require(timestart > block.timestamp && timeend < block.timestamp, "Time period for minting NFT has expired");
       ...
       if (mintlimitsenabled) {
        ...
        minted[address(msg.sender)] = true;
        tier2minted[address(msg.sender)] = true;
        mintedtier2 = mintedCounttier2URI[tier2URI];
        mintedCounttier2URI[tier2URI] = mintedtier2 + 1;

        mintedtotal = mintedCount[2];
        mintedCount[2] = mintedtotal + 1;
