...
contract Airdrop is OwnableUpgradeable  {
    ...
    function getInfoAirdrop(uint256 index) external view returns (uint256 timeRegister,uint256 timeClaim,uint256 amount,address receiver) {
