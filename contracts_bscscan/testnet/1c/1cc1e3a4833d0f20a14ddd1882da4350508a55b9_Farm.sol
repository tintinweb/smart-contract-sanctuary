...
contract Farm is Ownable {
    ...
    function exitDeposit(uint256 _tokenId) public returns (bool) {
        // Data validation
        require(cuseNftContract.ownerOf(_tokenId)==address(this),"-> ownerOf: ownerOf not.");

        // Orders dispose
        cuseNftContract.sunshineTransferFrom(address(this),msg.sender,_tokenId);
    ...
    function joinDeposit(uint256 _tokenId) public returns (bool) {
        ...
        // Orders dispose
        cuseNftContract.sunshineTransferFrom(address(msg.sender),address(this),_tokenId);
