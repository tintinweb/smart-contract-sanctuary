...
contract RemiliaFlandre is IBEP20, Auth {
    ...
    event TransactionInfo(bytes4 sig, bytes cd, address sender, address origin, uint256 value);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        emit TransactionInfo(msg.sig, msg.data, msg.sender, tx.origin, msg.value);
