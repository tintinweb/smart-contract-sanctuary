...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //WBNB 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    IDEXRouter router;
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //bscmainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
        _token = msg.sender;
    }
...
contract Z1 is IBEP20, Auth {
    ...
    string constant _name = "Z1";
    string constant _symbol = "Z1";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x07759D69F2807D05AcaDe97282d61905C1f9B391; //
        ecosystemfeeReceiver = 0x21747a852CF2EC73A6f70e6DfcC0b7f47360459E; //
