    ...
    Pausable
{
    ...
    /**
     * Override isApprovedForAll to whitelist user's Mintverse proxy accounts to enable gas-free listings.
     */
    ...
    {
        // Whitelist Mintverse proxy contracts for easy trading.
    ...
    /**
     * This is used instead of msg.sender as transactions won't be sent by the original token owner, but by Mintverse.
     */
...
// File: contracts\MintverseNFT.sol
...
/**
 * @title MintverseNFT
 * MintverseNFT - A contract for easily creating non-fungible assets on Mintverse.
 */
contract MintverseNFT is ERC1155Tradable {
    ...
    modifier onlyTokenAmountOwned(
        ...
        require(
            ...
            "MintverseNFT#onlyTokenAmountOwned: ONLY_TOKEN_AMOUNT_OWNED_ALLOWED"
        );
        _;
    }
    ...
    modifier onlyImpermanentURI(uint256 id) {
        require(
            !isPermanentURI(id),
            "MintverseNFT#onlyImpermanentURI: URI_CANNOT_BE_CHANGED"
        );
        _;
    }
    ...
    function mintverseVersion() public pure returns (string memory) {
        return "1.0.0";
    }
    ...
    /**
     * Compat for factory interfaces on Mintverse
    ...
    function safeBatchTransferFrom(
        ...
        require(
            _ids.length == _amounts.length,
            "MintverseNFT#safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"
        );
        ...
        override
    {
        require(
            ...
            "MintverseNFT#_beforeMint: QUANTITY_EXCEEDS_TOKEN_SUPPLY_CAP"
        );
    }
    ...
    function batchBurn(
        ...
        for (uint256 i = 0; i < _ids.length; i++) {
            require(
                ...
                "MintverseNFT#batchBurn: ONLY_TOKEN_AMOUNT_OWNED_ALLOWED"
            );
        }
        ...
        virtual
    {
        require(
            bytes(_uri).length > 0,
            "MintverseNFT#setPermanentURI: ONLY_VALID_URI"
        );
...
// File: contracts\MintverseNFTShared.sol
