...
contract Corex is ERC20, Ownable {
    ...
    event CoxRoarChange(bool indexed newValue, bool indexed oldValue);
    ...
    constructor() ERC20("COX", "COX") {
        liquidityWallet = address(0x51D6F2a75027fb913b3B352bF958B1236d46ABb3);
    	marketingWallet = address(0xE2234e40723Bd02A9674bc3AD7418f56f1Dd1dc3);
    	salaryWallet = address(0x453240ae7056619d261391a0668555aAfd16d77a);
    	buyBackWallet = address(0x40DB74440707925A8fAf72AFa3b2375a4f0A54E3);
    	
    	dividendTracker = new COXDividendTracker();
    
        IShabuswapV2Router02 _ShabuswapV2Router = IShabuswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Testnet
        //IShabuswapV2Router02 _ShabuswapV2Router = IShabuswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Mainnet
    ...
    function cancelLaunch() public onlyOwner {
        require(this.isInLaunch(), "COX: Launch is not set");
    ...
    function setCoxRoar() public onlyOwner {
        require(!this.isInRoar(), "COX: Roar is already set");
        require(isTradingEnabled, "COX: Trading must be enabled first");
        require(!this.isInLaunch(), "COX: Must not be in launch period");
        emit CoxRoarChange(true, false);
        _roarStartTimestamp = _getNow();
    }
    function cancelCoxRoar() public onlyOwner {
        require(this.isInRoar(), "COX: Roar is not set");
        emit CoxRoarChange(false, true);
        _roarStartTimestamp = 0;
    }
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "COX: The dividend tracker already has that address");
        COXDividendTracker newDividendTracker = COXDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "COX: The new dividend tracker must be owned by the COX token contract");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "COX: Automated market maker pair is already set to that value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFee[account] != excluded, "COX: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTransactionLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTransactionLimit[account] != excluded, "COX: Account is already the value of 'excluded'");
        _isExcludedFromMaxTransactionLimit[account] = excluded;
        emit ExcludeFromMaxTransferChange(account, excluded);
    }
    function excludeFromMaxWalletLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxWalletLimit[account] != excluded, "COX: Account is already the value of 'excluded'");
        _isExcludedFromMaxWalletLimit[account] = excluded;
        emit ExcludeFromMaxWalletChange(account, excluded);
    }
    function blacklistAccount(address account) public onlyOwner {
        uint256 currentTimestamp = _getNow();
        require(!_isBlacklisted[account], "COX: Account is already blacklisted");
        if (_isLanched) {
            require(currentTimestamp.sub(_launchStartTimestamp) < _blacklistTimeLimit, "COX: Time to blacklist accounts has expired");
        }
        _isBlacklisted[account] = true;
        emit BlacklistChange(account, true);
    }
    function unBlacklistAccount(address account) public onlyOwner {
        require(_isBlacklisted[account], "COX: Account is not blacklisted");
        _isBlacklisted[account] = false;
        emit BlacklistChange(account, false);
    }
    function setLiquidityWallet(address newAddress) public onlyOwner {
        require(liquidityWallet != newAddress, "COX: The liquidityWallet is already that address");
    ...
    function setMarketingWallet(address newAddress) public onlyOwner {
        require(marketingWallet != newAddress, "COX: The marketingWallet is already that address");
        emit MarketingWalletChange(newAddress, marketingWallet);
        marketingWallet = newAddress;
    }
    function setBuyBackWallet(address newAddress) public onlyOwner {
        require(buyBackWallet != newAddress, "COX: The buyBackWallet is already that address");
    ...
    function setSalaryWallet(address newAddress) public onlyOwner {
        require(salaryWallet != newAddress, "COX: The salaryWallet is already that address");
    ...
    function setLiquidityFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnBuy != newvalue, "COX: The liquidityFeeOnBuy is already that value");
    ...
    function setMarketingFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnBuy != newvalue, "COX: The marketingFeeOnBuy is already that value");
    ...
    function setHolderFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnBuy != newvalue, "COX: The holdersFeeOnBuy is already that value");
    ...
    function setBuyBackFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnBuy != newvalue, "COX: The buyBackFeeOnBuy is already that value");
    ...
    function setSalaryFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnBuy != newvalue, "COX: The salaryFeeOnBuy is already that value");
    ...
    function setLiquidityFeeOnSell(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnSell != newvalue, "COX: The liquidityFeeOnSell is already that value");
    ...
    function setMarketingFeeOnSell(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnSell != newvalue, "COX: The marketingFeeOnSell is already that value");
    ...
    function setHolderFeeOnSell(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnSell != newvalue, "COX: The holdersFeeOnSell is already that value");
    ...
    function setBuyBackFeeOnSell(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnSell != newvalue, "COX: The buyBackFeeOnSell is already that value");
    ...
    function setSalaryFeeOnSell(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnSell != newvalue, "COX: The salaryFeeOnSell is already that value");
    ...
    function setShabuswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(ShabuswapV2Router), "COX: The router already has that address");
    ...
    function setGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "COX: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "COX: Cannot update gasForProcessing to same value");
        emit GasForProcessingChange(newValue, gasForProcessing);
        gasForProcessing = newValue;
    }
    function setMaxTxAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxTxAmount, "COX: Cannot update maxTxAmount to same value");
        emit MaxTransactionAmountChange(newValue, maxTxAmount);
        maxTxAmount = newValue;
    }
    function setMaxWalletAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxWalletAmount, "COX: Cannot update maxWalletAmount to same value");
        emit MaxWalletAmountChange(newValue, maxWalletAmount);
        maxWalletAmount = newValue;
    }
    function setMinimumTokensBeforeSwap(uint256 newValue) public onlyOwner {
        require(newValue != minimumTokensBeforeSwap, "COX: Cannot update minimumTokensBeforeSwap to same value");
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            require(isTradingEnabled, "COX: Trading is currently disabled.");
            require(!_isBlacklisted[to], "COX: Account is blacklisted");
            require(!_isBlacklisted[from], "COX: Account is blacklisted");
            if (_isInLaunch && currentTimestamp.sub(_launchStartTimestamp) <= 300 && isBuyFromLp) {
                require(currentTimestamp.sub(_buyTimesInLaunch[to]) > 60, "COX: Cannot buy more than once per min in first 5min of launch");
            }
            if (!_isExcludedFromMaxTransactionLimit[to] && !_isExcludedFromMaxTransactionLimit[from]) {
                require(amount <= maxTxAmount, "COX: Buy amount exceeds the maxTxBuyAmount.");
            }
            if (!_isExcludedFromMaxWalletLimit[to]) {
                require(balanceOf(to).add(amount) <= maxWalletAmount, "COX: Expected wallet amount exceeds the maxWalletAmount.");
            }
        }
    ...
    function _swapAndLiquify() private {
        ...
        uint256 tokensInCoxForLiquidity = _liquidityTokensToSwap.div(2);
        uint256 amountToSwapForBNB = contractBalance.sub(tokensInCoxForLiquidity);
        
        // initial BNB balance
        uint256 initialBNBBalance = address(this).balance;
        // Swap the Cox for BNB
        ...
        _addLiquidity(tokensInCoxForLiquidity, bnbForLiquidity);
        emit SwapAndLiquify(amountToSwapForBNB, bnbForLiquidity, tokensInCoxForLiquidity);
...
contract COXDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("COX_Dividend_Tracker", "COX_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5000000 * (10**18); 
    }
    function _transfer(address, address, uint256) internal pure override {
        require(false, "COX_Dividend_Tracker: No transfers allowed");
    }
    function withdrawDividend() public pure override {
        require(false, "COX_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main COX contract.");
    }
    ...
    function setTokenBalanceForDividends(uint256 newValue) external onlyOwner {
        require(minimumTokenBalanceForDividends != newValue, "COX_Dividend_Tracker: minimumTokenBalanceForDividends already the value of 'newValue'.");
        minimumTokenBalanceForDividends = newValue;
    } 
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "COX_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "COX_Dividend_Tracker: Cannot update claimWait to same value");
