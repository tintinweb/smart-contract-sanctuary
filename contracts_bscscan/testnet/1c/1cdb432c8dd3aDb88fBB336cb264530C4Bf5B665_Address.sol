...
/**
   ...
   #Pabit's SafeMoon BSC Conversion
   # Author - CJ Andren
   # Author URL - https://pandabit.club/
   #
   #All Credit for SafeMoon Code goes to the SafeMoon team and respective contributors
   #This contract is simply modified to make it more readable for BSC users!
   #Changed Uniswap to Pancake routers and ETH to BNB
...
contract Pabit is Context, IERC20, Ownable {
