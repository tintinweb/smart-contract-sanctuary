...
/*   BNBTreasure - Community Experimental yield farm on Binance Smart Chain.
 *   The only official platform of original BNBTreasure
 *   All other platforms with the same contract code are FAKE
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://bnbtreasure.site                                   │
 *   │                                                                       │
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 5-level referral reward: 5% - 3% - 2% - 1% - 1%
 *
 *   [FUNDS DISTRIBUTION]
 *
 ...
 *         referral rewards. Payments is possible only if contract balance have enough BNB. Although some 
 *         part of the funds fee one reach higher enough balance will be used for mining, trading using 
 *         our sophisticated bot for added funds in the contract. Please analyze the transaction
