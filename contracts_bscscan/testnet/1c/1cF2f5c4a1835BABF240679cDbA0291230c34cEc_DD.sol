...
/**
   ...
   2% Marketing fee
   1% fee auto burnt to dead wallet
...
contract DD is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0x7552Ce8524AB8745458107C8E683c26733c56574);
    ...
    function swapAndLiquifyTokens(uint256 numTokens) external onlyOwner() {
        uint256 contractTokenBalance = balanceOf(address(this));
        require(contractTokenBalance >= numTokens, "Contract does not have this many tokens");
        swapAndLiquify(contractTokenBalance);
    }
