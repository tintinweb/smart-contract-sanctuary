...
contract sToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Asgard", "sASD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sASD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sASD
