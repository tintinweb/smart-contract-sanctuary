...
string constant _name = "RBTCteste003";
string constant _symbol = "RBtest003";
uint8 constant decimal = 18;
uint8 constant decimalBUSD = 18;  
uint256 constant maxSupply = 50_000_000 * (10 ** decimal);
uint256 public _maxTxAmount = 1_000_000 * (10 ** decimal);
uint256 public _maxAccountAmount = 5_000_000 * (10 ** decimal);
uint256 public totalBurned;
uint256 public feeStake = 800;  
uint256 public feeMarketingWallet = 50;
uint256 public feeAdministrationWallet = 50; 
uint256 public feeInvestingWallet = 50; 
uint256 public feeStakerWallet = 50; 
uint256 public feePool = 200; 
