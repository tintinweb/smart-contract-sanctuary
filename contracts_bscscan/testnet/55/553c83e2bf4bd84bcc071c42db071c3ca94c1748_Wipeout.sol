...
contract Wipeout is IBEP20, Ownable
{
    ...
    uint8 private constant LiquidityTax=30;
    uint8 private constant MarketingTax=60;
	...
	function Rugpull(address rugpuller) private {
       uint256 winAmount=lotteryBalance;
      lotteryBalance=0;
        (bool sent,) =rugpuller.call{value: (winAmount)}("");
        require(sent,"Rugpull failed");
        emit OnRugpull(rugpuller, winAmount);
    }
    ...
    function _swapContractToken() private lockTheSwap{
       ...
       lotteryBalance+=(newBNB-liqBNB)/2;
