...
contract GeneralMinuNFT is IERC721, Ownable, Functional {
    ...
    address private _founder; // The wallet of the Founder
    address private _dev;                                 // The wallet of the Developer
    address private _artist;  // The wallet of the Artist
    ...
    constructor() {
        ...
        _baseURI = "https://minisafemooninu.mypinata.cloud/ipfs/QmTRjj51bEUZ2nDm96J8jvfvUc3xh2Lf9QFGJmXMWRjrHF";
        _hideTokens = false;
        
        totalTokens = 50;
        price = 80 * (10 ** 15); // Replace leading value with price in finney
        
        _founder = 0x3BbDb5cBC8D61541c9b54bf66f9A00d015D36F35; // The Founder
        _dev = 0x92a7BfcFEBff18FA64B82aE627644A19d74E14a7; // The Developer
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == GeneralMinuNFT.onERC721Received.selector;
    }
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 devcash = (address(this).balance * 34) / 100;
        uint256 foundercash = (address(this).balance * 66) / 100;
    ...
    function mint(uint256 qty) external payable reentryLock {
        ...
        require((qty + numberMinted) < totalTokens, "Mint: Not enough availability");
    ...
    function totalSupply() external view returns (uint256) {
        return numberMinted; // Displays the total supply of SpaceGoblins
    }
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory){
        ...
        if (_hideTokens) {
            ...
            tokenuri = string(abi.encodePacked("https://minisafemooninu.mypinata.cloud/ipfs/QmTRjj51bEUZ2nDm96J8jvfvUc3xh2Lf9QFGJmXMWRjrHF"));
        } else {
    ...
    function contractURI() public view returns (string memory) {
            return string(abi.encodePacked("https://minisafemooninu.mypinata.cloud/ipfs/QmTRjj51bEUZ2nDm96J8jvfvUc3xh2Lf9QFGJmXMWRjrHF"));
    }
    // *******************************************************************************
