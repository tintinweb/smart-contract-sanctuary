...
contract OLY3 is IBEP20, Auth {
    ...
    string constant _name = "OLY3";
    string constant _symbol = "OLY3";
    ...
    function shouldTakeFee(address sender, address recipient) internal view returns (bool) {
        if( recipient == pair || sender == pair || isFeeExempt[sender] || isFeeExempt[recipient]) return false; 
        return true;
    }
