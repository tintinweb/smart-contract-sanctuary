...
contract Prediction is IPrediction, Ownable, Pausable {
     ...
     */
    function buyTicket(uint256 _pid, bool _label, address _referral, uint256 _quantity) public poolExisted(_pid) whenNotPaused(_pid) returns(uint256 _price, uint256 _fee) {
