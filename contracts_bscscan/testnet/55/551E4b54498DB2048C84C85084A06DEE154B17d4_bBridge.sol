 ...
 *
 * Attributes:
 * - Mints bPRISM tokens from an authorized member after a cross-chain migration
 * - Burns bPRISM tokens from the bridge and emits a cross-chain fee migration event
 */
contract bBridge is SatelliteMultiBridge {
  constructor(ISatellitePRISM bPrism, uint256[] memory chainList) public SatelliteMultiBridge(bPrism, chainList) {}
}
