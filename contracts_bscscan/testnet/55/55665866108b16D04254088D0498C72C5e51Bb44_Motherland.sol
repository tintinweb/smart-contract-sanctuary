...
░████▀░░░▀▀█████▄▄▄▄█████████▄░░
░░▀▀░░░░░░░░░▀▀██████▀▀░░░▀▀██░░
This is Motherland - a proof of concept. Since the socialist economic model never worked on real life given that a trustless system was impossible to achieve,
this token was born with the purpose of testing the trustless system provided by the blockchain via smart contracts. 

$socialism is a proof of concept token that seeks to test if socialism can work on the blockchain via smartcontracts - a trustless system. 
    
Max Wallet 3%
Max Transaction 1%
No Marketing Wallet, Developers are getting max wallet and that's it. No bs. 
25% Tax = 25% on Buy / 25% on Sell // Of those taxes,
15% LP
10% BUSD reflections

All LP Tokens sent to burn address since this is socialism and not communism.

Join our telegram fellow marxist! - https://t.me/MotherlandToken
...
contract Motherland is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x0000000000000000000000000000000000000000;

    address routerv2 = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;

    string constant _name = "Motherland";
    string constant _symbol = "socialism";
