...
contract LadyLassie is Context, IERC20, Ownable {
    ...
    Taxes public highTaxes = Taxes(18, 35, 18, 9, 9);
    ...
    function transferFrom(
        ...
        bool hasHighTaxes = !_isExcludedFromFee[sender] &&
            ...
            block.number <= genesis_block + 300;
    ...
    function setHighTaxes(
        ...
        highTaxes = Taxes(_rfi, _marketing, _liquidity, _dev, _buyback);
        emit FeesChanged();
    }
    ...
    function _getRValues2(
        ...
        bool takeFee,
        uint256 currentRate
    ) private pure returns (uint256 rDev, uint256 rBuyback) {
        if (!takeFee) {
            return (0, 0);
        }
    ...
    function _tokenTransfer(
        ...
        if (s.rLiquidity > 0 || s.tLiquidity > 0) {
            ...
            emit Transfer(
                sender,
                address(this),
                s.tLiquidity + s.tMarketing + s.tDev + s.tBuyback
            );
        }
