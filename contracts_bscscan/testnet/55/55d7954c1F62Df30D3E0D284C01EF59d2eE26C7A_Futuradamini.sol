...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xf86dADCa79c559Bf1D7fc9197acd625ACe06daD7);
...
contract Futuradamini is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xf86dADCa79c559Bf1D7fc9197acd625ACe06daD7;
    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Futurada mini";
    string constant _symbol = "Fumi";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x40e137ef8f5a812dD93Ec32A127C46839c1FA0cC;
        address firstBurnWallet = 0x6df6c821Baf84fe916840ccB5Ab73D77981451a3;
        address secondBurnWallet = 0x9df75106806116742d8797c6CFF9E264834B15EA;
        ...
        uint burnWallet1 = _totalSupply.div(50); 
        uint burnWallet2 = _totalSupply.div(50);
        uint marketingWallet = (_totalSupply / 100).mul(3); 

        _balances[msg.sender] = _totalSupply.sub(burnWallet1).sub(burnWallet2).sub(marketingWallet);
        emit Transfer(address(0), msg.sender, _totalSupply.sub(burnWallet1).sub(burnWallet2).sub(marketingWallet));
        
        _balances[firstBurnWallet] = burnWallet1;
        emit Transfer(address(0), firstBurnWallet, burnWallet1);

        _balances[secondBurnWallet] = burnWallet2;
        emit Transfer(address(0), secondBurnWallet, burnWallet2);

        _balances[marketingFeeReceiver] = marketingWallet;
        emit Transfer(address(0), marketingFeeReceiver, marketingWallet);
