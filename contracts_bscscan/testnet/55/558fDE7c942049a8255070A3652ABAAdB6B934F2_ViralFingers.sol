 ...
 *
 * Project-name: viral-fingers
 * Network-Deployment: Fantom (chain ID 250)
 * Website: https://www.ViralFingerFTM.club/
 *
 */
...
contract ViralFingers is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
 ...
 */
  ...
  constructor() ERC721("Viral Fingers", "Finger") { // address _main, address _one, address _two, address _three
    // init of all variables
    tokenCounter = 0;
    mintFee = 1 * 10**18; // 300 FTM
    maxMint = 123; // Total Amount
    royaltyFee = 1; // as a percentage
    royaltyAddress = msg.sender; // pending
    devAddress = msg.sender;
    enableMinter = true;
    directory = "QmV31xwxVBtVQp9CtWxQ5de7aoP85iwKmX172LUj28iu9K/";
  ...
  function paymentSplitter(uint256 _amount) internal {
    ...
    uint256 secondPayment = _amount * 7 /100; //7%
    uint256 leftOver = _amount-firstPayment-secondPayment; // remaining 83%
