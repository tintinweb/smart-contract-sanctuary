...
contract Zap is IZap, Ownable {
    ...
    */
    ...
    function _swapBNBToLpToken(address lpToken, uint256 amount, address receiver, uint bnbBalanceBefore) private returns(uint liquidity) {
    ...
    */
	function _addLiquidityBNB(address token, uint amount, address receiver, uint bnbBalanceBefore) private returns(uint liquidity) {
        emit LogInt('bnbBalanceBefore', bnbBalanceBefore);
        ...
        emit LogInt('bnbBalanceAfter', bnbBalanceAfter);
