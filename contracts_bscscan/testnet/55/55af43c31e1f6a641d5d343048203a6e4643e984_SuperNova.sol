...
contract SuperNova is ERC20, Ownable {
    ...
    constructor() ERC20("SuperNova", "SPR") {
        _mint(msg.sender, 1*10**decimals());
        _mint(address(this), 1000000000000000*10**decimals());
        startSale(block.number, 999999999, 0,12500000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,2500000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
