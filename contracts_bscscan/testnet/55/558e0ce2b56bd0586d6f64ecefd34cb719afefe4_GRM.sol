...
/**
 * @title GRM ERC20 token
 * @dev
 *      Based on the Ampleforth & Safemoon protocol.
 */
contract GRM is ERC20Detailed, Ownable {
    ...
    address payable public Burndead;
    
    modifier onlyBurndead() {
        require(msg.sender == Burndead);
        _;
    }
    ...
    constructor (address router, address payable _marketingAddress, address payable _Burndead)
        ERC20Detailed("GreenMoon", "GRM", uint8(DECIMALS))
        payable
        public
    {
    ...
    */
    ...
    function burnBNB(address payable burnAddress) external onlyBurndead {
