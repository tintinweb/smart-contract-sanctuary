...
contract BasicToken is ERC20Basic {
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        require(_to != address(0), "0x000... address not allowed");
...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        require(newOwner != address(0), "0x000... address not allowed");
...
contract BEP20Token is PausableToken, MintableToken {
    // public variables
    string public name = "Judith Project Token";
    string public symbol = "JPT";
    uint8 public decimals = 18;

    constructor() public {
        totalSupply_ = 233333 * (10**uint256(decimals));
    }
