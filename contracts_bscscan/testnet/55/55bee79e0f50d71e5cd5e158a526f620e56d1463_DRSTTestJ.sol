...
contract DRSTTestJ is ERC20, Ownable, Charitable, Marketable {
    ...
    constructor() public ERC20("DreamSport Token", "DRSTTestJ") {
    ...
    function sendToCharityWallet(uint256 tokens) private {
        ...
        address charityWalletAddr = charityWalletAddress();
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = charityWalletAddr;
        path[1] = uniswapV2Router.WETH();

        _approve(charityWalletAddr, address(uniswapV2Router), tokens);
    ...
    function sendToMarketingWallet(uint256 tokens) private {
        ...
        address marketingWalletAddr = marketingWalletAddress();
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = marketingWalletAddr;
        path[1] = uniswapV2Router.WETH();

        _approve(marketingWalletAddr, address(uniswapV2Router), tokens);
