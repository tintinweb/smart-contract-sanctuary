...
contract TDWL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC5B563932F240923e3e08b176FDAF7faD0AAFBc8); // Marketing Address
    ...
    string private _name = "TDWL";
    string private _symbol = "TDWL";
    ...
    function initContract() external onlyOwner() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xC5B563932F240923e3e08b176FDAF7faD0AAFBc8); // PancakeSwap: Router v2;
        ...
        _isExcludedFromFee[address(this)] = true;
         marketingAddress = payable(0x46DD7643cA64C3d627BC7C4B9E4E58f6353B5a68);
    }
