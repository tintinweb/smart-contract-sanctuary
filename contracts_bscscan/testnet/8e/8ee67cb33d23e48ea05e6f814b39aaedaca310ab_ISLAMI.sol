...
contract ISLAMI is BEP20, Ownable{
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        else if(sender == msg.sender && address(this).balance >= givecharity) {                                                                    //  2.5% will be on the investor (Represent Zakkat)
            super._transfer(sender,recipient, transferAmount);
            super._transfer(sender,address(0xD8A73Bfbd1444ce4796409c9b77800e6067b591a),givecharity);
        }
        else {                                                                   
   ...
   // uint256 public AirDrop_Amount = (aAmt / 10000000);
   // uint256 public AirDrop_Cap = aCap;
   // uint256 public Selling_Price_For_Each_BNB = (sPrice / 10000000);
