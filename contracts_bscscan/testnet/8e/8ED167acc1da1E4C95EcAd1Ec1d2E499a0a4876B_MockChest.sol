...
contract MockChest {
    ...
    function remove(string memory rank, uint index) private {
        require(index < cardRank[rank].length);
        cardRank[rank][index] = cardRank[rank][cardRank[rank].length-1];
        cardRank[rank].pop();
    }
