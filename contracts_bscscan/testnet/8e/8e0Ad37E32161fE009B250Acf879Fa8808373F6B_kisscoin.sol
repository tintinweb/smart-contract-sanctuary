...
contract kisscoin is Context, IERC20, Ownable {
    ...
    string private _name = "kisscoin";      //CHANGE_REQUIRED: name of token
    string private _symbol = "KSC";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
