...
contract CryptoShibaController is Ownable{
    ...
    constructor (){
        ...
        // busdTokenAddress = address(0x55d398326f99059fF775485246999027B3197955);
    ...
    function claimToken() public{
        ...
        uint256 claimAmount = claimPrice.mul(1e18).div(priceCheck(token, busdTokenAddress, 1e18)).div(10**claimPriceDecimal).mul(nftBalance);
        
        uint256 amount = (myshiba.getClaimTokenAmount(_msgSender()) > claimAmount)? claimAmount : myshiba.getClaimTokenAmount(_msgSender());
