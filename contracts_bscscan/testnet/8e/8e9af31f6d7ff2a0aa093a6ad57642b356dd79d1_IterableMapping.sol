...
contract Test is ERC20, Ownable {
    ...
    address payable public marketingWallet = 0x21C1b8Ec6a7740d0973e35BcB874eF46a4C30b48;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 1000000, "Test: gasForProcessing must be between 200,000 and 1,000,000");
...
contract TestDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 900 && newClaimWait <= 86400, "test_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
