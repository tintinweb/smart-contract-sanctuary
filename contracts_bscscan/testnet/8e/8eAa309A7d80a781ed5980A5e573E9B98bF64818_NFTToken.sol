...
contract NFTToken is ERC721 {
    ...
    function createCharacter(string memory name, uint16 rank, uint16  level,uint256  exp, string memory uri) public returns (uint256) {
        _tokenIds.increment();
        ...
        Characters[newCharacterId] = Character(newCharacterId,name,rank,level,exp, msg.sender, uri);
