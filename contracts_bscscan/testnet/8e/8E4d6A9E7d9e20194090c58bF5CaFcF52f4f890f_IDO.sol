...
contract IDO is interfaceIDO {
    ...
    function setminInvest(uint _amount) public onlyOwner() {
        minInvest = _amount;
    }
    ...
    function invest(uint256 _amount) public {
        require(startInvest == true, "invest not accepted, IDO isn't start");
        require(startClaim == false, "Invested not accepted, IDO is completed");
    ...
    function remainingContribution(address _users) public view returns (uint256) {
