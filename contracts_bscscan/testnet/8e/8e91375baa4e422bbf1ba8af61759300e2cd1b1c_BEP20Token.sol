...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
  function transfer(address recipient, uint256 amount) override external onlyAllowedContracts returns (bool) {
   ...
   * `amount`.
   */
  function transferFrom(address sender, address recipient, uint256 amount) override external onlyAllowedContracts returns (bool) {
