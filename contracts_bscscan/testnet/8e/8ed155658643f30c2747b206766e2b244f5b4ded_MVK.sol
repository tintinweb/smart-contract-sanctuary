...
contract MVK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2498dBf2dEBDad1e562427fF0C63e3717437e7Fa); // Marketing Address
    ...
    uint256 private _tTotal = 21000000000000000* 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Moon Vikings";
    string private _symbol = "MVK";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x2498dBf2dEBDad1e562427fF0C63e3717437e7Fa);
    }
