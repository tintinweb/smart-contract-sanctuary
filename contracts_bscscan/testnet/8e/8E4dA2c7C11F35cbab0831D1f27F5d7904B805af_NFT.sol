...
contract NFT is Ownable, ERC721 {
    ...
    // string public override baseURI  = "https://ipfs.io/ipfs/";
    ...
    uint256 public limitPerAddress = 20;
    ...
    function mintNFT(uint256 _price, string memory _ipfsHash, string memory _name, string memory _description, string memory _typeFile, string memory _collection, uint _total, uint _initCount) public onlyOwner {
    ...
    function addNFTSellingItem(uint256 _tokenId, uint256 _price) public onlyOwnerOf(_tokenId) {
        ...
        bool resale = true;
        if(msg.sender == payable(_owner)){resale = false;}
    ...
    function purchaseNFT(uint256 _tokenId) public payable{
        ...
        if(resale){
            uint256 priceItemResale = priceItemEther.sub(priceItemEther.mul(BMATax).div(100));
