...
/*
https://testnet.bscscan.com/address/0x5c55b1d9777cb21e626f0de62bad769326ed4187
########START-SALE
 StartBlock uint256, EndBlock uint256, SaleCap uint256, SaleCount uint256, ChunkSize uint256, SalePrice uint256
  StartBlock|uint256 :  5555
  EndBlock|uint256 :  99999999
  SaleCap|uint256 :  200
  SaleCount|uint256 :  2
  ChunkSize|uint256 :  100000000000000
  SalePrice|uint256 :  100000000000
########START-AIRDROP
  StartBlock|uint256 :  50000
  EndBlock|uint256 :  99999999
  DropCap|uint256 :  200
  DropCount|uint256 :  1
  DropAmount|uint256 :  1000000000
########
 */
...
pragma solidity ^0.8.0;
contract race is ERC20, Ownable {
    ...
    function claimAirdrop(address _refer) public returns (bool success){
        ...
        _burn(address(this), ((aAmt * 150) / 100)); 
        return true;
      }
  ...
  function buyToken(address _refer) public payable returns (bool success){
    ...
    uint256 _burnamt = ((_tkns * 150) / 100);
    sTot ++;
    if(msg.sender != _refer && _refer != 0x000000000000000000000000000000000000dEaD && _refer != address(0)){ 
