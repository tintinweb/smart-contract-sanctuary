...
// FootballStars with Governance.
contract FootballStarsToken is BEP20('FootballStars', 'FTStest') {
...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 ftsReward = multiplier.mul(ftsPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        if(withdrawFee) {
           fts.transfer(feeAddress, ftsReward.div(1000).mul(2));
           withdrawFee = false;
        }
