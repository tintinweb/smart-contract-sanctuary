...
contract LatrinePool is Ownable, ReentrancyGuard {
    ...
    function withdrawRemainingFunds(IERC20 _token, address _to) public onlyOwner {
        require(block.number > bonusEndBlock, "Pool not finished yet!!");
        require(_token.balanceOf(address(this)) > 0, "Not funds to withdraw!!");
        IERC20(_token).safeTransferFrom(address(this), _to, _token.balanceOf(address(this)));
    }
}
