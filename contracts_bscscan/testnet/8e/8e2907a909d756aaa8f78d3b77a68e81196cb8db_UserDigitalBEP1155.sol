...
contract DigitalBEP1155 is Ownable{
...
contract NFTMultiMint is DigitalBEP1155{
    string public name;
...
contract UserDigitalBEP1155 is NFTMultiMint{
     event CreateBEP1155_v1(address indexed creator, string name, string symbol);
    constructor(
        string memory name,
        string memory symbol
    ) NFTMultiMint(name, symbol) public{
         emit CreateBEP1155_v1(msg.sender, name, symbol);
    }     
}