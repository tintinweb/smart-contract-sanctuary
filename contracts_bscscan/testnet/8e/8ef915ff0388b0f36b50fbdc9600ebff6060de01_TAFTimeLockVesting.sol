...
MMP""MM""YMM   db      `7MM"""YMM     `7MMF'   `7MF'`7MM"""YMM   .M"""bgd MMP""MM""YMM `7MMF'`7MN.   `7MF' .g8"""bgd  
P'   MM   `7  ;MM:       MM    `7       `MA     ,V    MM    `7  ,MI    "Y P'   MM   `7   MM    MMN.    M .dP'     `M  
     MM      ,V^MM.      MM   d          VM:   ,V     MM   d    `MMb.          MM        MM    M YMb   M dM'       `  
     MM     ,M  `MM      MM""MM           MM.  M'     MMmmMM      `YMMNq.      MM        MM    M  `MN. M MM           
     MM     AbmmmqMA     MM   Y           `MM A'      MM   Y  , .     `MM      MM        MM    M   `MM.M MM.    `7MMF'
     MM    A'     VML    MM                :MM;       MM     ,M Mb     dM      MM        MM    M     YMM `Mb.     MM  
   .JMML..AMA.   .AMMA..JMML.               VF      .JMMmmmmMMM P"Ybmmd"     .JMML.    .JMML..JML.    YM   `"bmmmdPY  
