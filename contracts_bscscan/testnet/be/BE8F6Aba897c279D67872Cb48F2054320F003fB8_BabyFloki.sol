...
contract BabyFloki is Context, Ownable, ERC20 {
    ...
    */
    ...
    constructor() Ownable() ERC20("Baby Floki", "BABYFLOKI") {
    ...
    function _claim(uint256 tokenId, address tokenOwner) internal {
        ...
        _mint(tokenOwner, babyflokiPerTokenId);
    }
    ...
    function daoSetAdventureGoldPerTokenId(uint256 adventureGoldDisplayValue)
        ...
        onlyOwner
    {
        babyflokiPerTokenId = adventureGoldDisplayValue * (10**decimals());
    }
