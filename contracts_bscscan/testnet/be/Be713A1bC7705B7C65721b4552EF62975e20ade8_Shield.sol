...
// Shield Token
contract Shield is BEP20 {
    
    // Transfer tax rate in basis points.
    uint16 public transferTaxRate = 500;
    
    // Transfer Burn Rate: 1%.
    uint16 public constant BURN_RATE = 100;
    
    // Transfer FEE Rate: 2%.
    uint16 public constant FEE_RATE = 200;
    
    // Transfer LOQ Rate: 2%.
    uint16 public constant LIQ_RATE = 200;
    
    // Burn address
    address public constant BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;
    
    // DEV address
    address public constant DEV_ADDRESS = 0x63964b83832288811455551CC03Ea0C0CF7AFf43;
    
    // Fee address
    address public constant FEE_ADDRESS = 0xA3a18888df0E02A6398be6834AE420101eAF1769;
    ...
    // Min amount to liquify. (default 50 SHIELDs)
    ...
    /**
     * @notice Constructs the SHIELD Token contract.
     */
    constructor() public BEP20("Shield Centaurus.Network", "SHIELD") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        { super._transfer(sender, recipient, amount); } 
            ...
            uint256 liqAmount = amount.mul(LIQ_RATE).div(10000);
            
            // 95% of transfer sent to recipient
            uint256 sendAmount = amount.sub(burnAmount).sub(feeAmount).sub(liqAmount);
            
            require(amount == sendAmount + burnAmount + feeAmount + liqAmount, "SHIELD::transfer: Tax value invalid");
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onlyOperator {
        require(_maxTransferAmountRate <= 1000, "SHIELD::updateMaxTransferAmountRate: Max transfer amount rate must not exceed the maximum rate.");
        require(_maxTransferAmountRate >= 100, "SHIELD::updateMaxTransferAmountRate: Max transfer amount rate must exceed the minimum rate.");
