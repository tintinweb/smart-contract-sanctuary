...
contract CustomERC20 is TheOwnable {
    ...
    uint256 public tradeBurnRatio = 400;
    uint256 public tradeFeeRatio = 400;
    address public team;
    ...
    function changeBurnRatio(uint256 _tradeBurnRatio) external onlyOwner {
        require(_tradeBurnRatio >= 0 && _tradeBurnRatio <= 1000, "TRADE_BURN_RATIO_INVALID");
        tradeBurnRatio = _tradeBurnRatio;
    }

    function changeFeeRatio(uint256 _tradeFeeRatio) external onlyOwner {
        require(_tradeFeeRatio >= 0 && _tradeFeeRatio <= 1000, "TRADE_FEE_RATIO_INVALID");
