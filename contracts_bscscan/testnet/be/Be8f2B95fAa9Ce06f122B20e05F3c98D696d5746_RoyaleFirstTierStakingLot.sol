...
contract StakingLot is ERC20, IStakingLot, ERC1155Receiver, Ownable {
    ...
    uint public constant LOT_PRICE = 100 * 10**18;
    uint public constant DISCOUNTED_LOT_PRICE = 80 * 10**18;
    ...
    uint256 public lockupPeriod = 1800;
    ...
    function buyWithNFT(uint256 amount, uint256 id) external{
        ...
        require(amount > 0, "Amount is zero");
        require(id >108, "Should be First tier NFT");
...
contract RoyaleFirstTierStakingLot is StakingLot, IStakingLotERC20 {
    using SafeERC20 for IERC20;
    using SafeMath for uint;
