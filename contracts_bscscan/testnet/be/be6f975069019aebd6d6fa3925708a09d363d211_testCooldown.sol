...
contract testCooldown is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "testCooldown";
	string private _symbol = "CRG2";
    ...
    function _handleSellCooldown(address from) internal {
        if (_sellCooldown > 0 && from != owner() && from != addressPoolPancake && from != address(this)) {
    ...
    function _handleBuyCooldown(address to) internal {
        if (_buyCooldown > 0 && to != owner() && to != addressPoolPancake) {
