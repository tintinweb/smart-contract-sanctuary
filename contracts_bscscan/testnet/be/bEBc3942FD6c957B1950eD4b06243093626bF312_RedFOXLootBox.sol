...
contract RedFOXLootBox is VRFConsumerBase, Ownable {
    ...
    mapping(bytes32 => Request) userRequests;
        ...
        )
    {
        ...
        return (request.requestId, request.pack, request.timestamp);
    }
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness)
        ...
        override
    {
        (bytes32 requestId, Pack pack, uint256 timestamp) = getRequestOwner(_requestId);
