...
contract TEST_NEW is Context, IERC20, Ownable { 
    ...
    string private constant _name = "TEST_NEW"; 
    string private constant _symbol = "TEST_NEW"; 

    // Counter for liquify trigger
    address payable public Counter_Wallet = payable(0xcf427cffaF76027Ee1bc5540F283cEa650ee96bf);  //luck gen 1
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if(
            _tOwned[Counter_Wallet] >= swapTrigger && 
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
    ...
    */
    ...
    _tOwned[Counter_Wallet] = _tOwned[Counter_Wallet]+1;
            }
