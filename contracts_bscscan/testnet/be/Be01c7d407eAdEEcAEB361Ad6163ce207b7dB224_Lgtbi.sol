...
2) 4% -->2% burn & 2% Go to PanckakeSwap liquidity Pool 
...
contract Lgtbi is RMB {
    ...
    address burnAddress, address donationAddress, address [] memory  board)  {
        _name = 'Lgtib+ Coin9';
        _symbol = 'LGT9';
        _decimals = 18;
        ...
        emit Transfer(CEO, burnAddress, _BurnPercent);
