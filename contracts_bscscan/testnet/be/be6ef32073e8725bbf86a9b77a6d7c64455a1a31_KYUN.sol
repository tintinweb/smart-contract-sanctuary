...
contract KYUN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100000000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "KYUN";
    string private constant _symbol = "KN";
    ...
    uint256 public _maxWallet = 2000000 * 10**1 * 10**9;
