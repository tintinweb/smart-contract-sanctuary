...
contract wrbsent is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "wrbsent";
    string private _symbol = "wrbS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc70B5239e915C58412B08Ce5A611eBbe843570A8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc70B5239e915C58412B08Ce5A611eBbe843570A8); // BuyBack Address
