...
// modifiers
   modifier stakeEnabled {
        require(stakeDisabled == false , "Staking is paused !");
        _;
    }

   modifier withdrawEnabled {
        require(withdrawDisabled == false , "Withdrawing is paused !");
        _;
    }
...
// variable definitions
    ...
    bool stakeDisabled;   // set by owner, turns off/on stake process
    bool withdrawDisabled;   // set by owner, turns off/on withdraw process
