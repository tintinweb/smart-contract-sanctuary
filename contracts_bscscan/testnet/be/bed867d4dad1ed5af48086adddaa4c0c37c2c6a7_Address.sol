...
contract OnferToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x6e0d7933d3dFB019777beFda09eB065D5d79a49e;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 990000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "bestnewkaas";
    ...
    uint256 public _maxTxAmount = 990000000 *  10**18;
