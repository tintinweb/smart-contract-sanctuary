...
contract Presale is Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        currentPresaleId = currentPresaleId + 1;
    }
    ...
    {
        amount =
            (hardCap[_saleId] * publicRate[_saleId] * (100 + performanceFee)) /
            100;
    }
    ...
    function addLiquidity(uint256 realAmount, uint256 _saleId) internal {
        ...
        address payable msgSender = payable(msg.sender);
        _liquidityAdd(token, routerAddr, isDefaultRouter, routerTokenAmount, routerBNB, _saleId, _token, realRate);
