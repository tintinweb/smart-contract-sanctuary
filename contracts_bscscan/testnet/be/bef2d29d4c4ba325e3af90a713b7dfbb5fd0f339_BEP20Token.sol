...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
  ...
  function setEndTime(uint256 timeInSec)  public returns (uint256) {
  ...
  function setBurnAmount(uint256 newBurnAmount)  public returns (uint256) {
      require(msg.sender == owner(), 'only owner');
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    require(burnFlag == true, 'Please update end time');
