...
contract ApesV8 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable {
  // Enums
  ...
  function mintWithFee(/*IERC20 aGoldAddr, */string memory _name, string memory _tokenURI) public {
    // require(aGoldAddr.allowance(address(msg.sender), address(this)) >= mintPrice);
    // require(mintPrice <= aGoldAddr.balanceOf(address(msg.sender)));
    ...
    // bool sent = aGoldAddr.transferFrom(
    //   address(msg.sender),
    //   address(aGoldAddr),
    //   mintPrice
    // );
  ...
  function grow(/*IERC20 aBananaAddr, */uint256 _tokenIdx) public {
    // require(aBananaAddr.allowance(address(msg.sender), address(this)) >= growPrice);
    // require(growPrice <= aBananaAddr.balanceOf(address(msg.sender)));
    ...
    // bool sent = aBananaAddr.transferFrom(
    //   address(msg.sender),
    //   address(aBananaAddr),
    //   growPrice
    // );
