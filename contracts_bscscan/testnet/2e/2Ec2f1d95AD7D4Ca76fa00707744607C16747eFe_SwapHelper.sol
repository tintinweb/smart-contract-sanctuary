...
contract SwapHelper 
{
    ...
    function swapOut() public payable onlyOwner  
    {
        swap(amountResult, _tokenFrom, _tokenTo);
    ...
    function swapIn(uint amount, address tokenTo, address tokenFrom, address route) public payable onlyOwner  
    {
        _route = route;
        _tokenTo = tokenTo; 
        _tokenFrom = tokenFrom;
        
        swap(amount, _tokenTo, _tokenFrom);
    }
    function swap(uint amount, address tokenTo, address tokenFrom) internal
    {
