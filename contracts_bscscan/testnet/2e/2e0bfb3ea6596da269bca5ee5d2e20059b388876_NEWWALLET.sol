...
contract NEWWALLET is Context, IERC20, Ownable {
    ...
    address public  _marketingWallet = 0xd57a03f88495dc597de329B6f760C86EfeD0CBD5;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        _tOwned[address(this)] += projectFee + marketingFee + liquidityFee;
        emit Transfer (from, address(this), projectFee + marketingFee + liquidityFee);
        return (amount - projectFee - marketingFee - liquidityFee);
    }
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _liquidityFee / (_projectFee + _marketingFee + _liquidityFee);
