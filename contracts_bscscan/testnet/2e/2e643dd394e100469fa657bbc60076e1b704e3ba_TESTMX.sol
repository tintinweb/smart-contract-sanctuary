...
contract TESTMX is Context, IERC20, Ownable {
    ...
    string public _name = "TEST MOON X";
    string public _symbol = "TESTMX";
    ...
    address private marketingWallet = 0x648EB5427F7447197C42c870425DCB01ef1e9084;
