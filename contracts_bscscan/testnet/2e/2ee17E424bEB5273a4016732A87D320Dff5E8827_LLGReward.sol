...
contract LLGReward is Ownable {
    ...
    address public taxWallet = 0xb10147EBcf02BeF123d24EAa5Ace3A8A05A8c3Bc;
    address public bonusWallet = 0x410b8c8451c6D2E437905027BF8CbBB502424A09;
    ...
    function getTokens(address _addr, uint256 _funds) external onlyOwner {
            llgContract.transfer(_addr, _funds * 10**9);
    }
