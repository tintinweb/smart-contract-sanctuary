...
contract Jackpot is IBEP20, Auth {
    ...
    address jackpotDaily  = 0x3409B94D85475C30EebD34D765546Cdf919706C4; 
    address jackpotWeekly = 0x3409B94D85475C30EebD34D765546Cdf919706C4;
    address jackpotMonthly = 0x3409B94D85475C30EebD34D765546Cdf919706C4;

    address dev1 = 0x3409B94D85475C30EebD34D765546Cdf919706C4;
    address dev2 = 0x3409B94D85475C30EebD34D765546Cdf919706C4;
    address dev3 = 0x3409B94D85475C30EebD34D765546Cdf919706C4;
    address dev4 = 0x3409B94D85475C30EebD34D765546Cdf919706C4;
    address dev5 = 0x3409B94D85475C30EebD34D765546Cdf919706C4;

    string constant _name = "Jackpot";
    string constant _symbol = "777";
    uint8 constant _decimals = 7;

    uint256 _totalSupply = 777777777 * 10 ** 6 * (10 ** _decimals);
    ...
    function setJackpotDailyFeeReceivers(address _jackpotDaily) external authorized {
        jackpotDaily = _jackpotDaily;
    }

    function setJackpotWeeklyFeeReceivers(address _jackpotWeekly) external authorized {
        jackpotWeekly = _jackpotWeekly;
    }

    function setJackpotMonthlyFeeReceivers(address _jackpotMonthly) external authorized {
        jackpotMonthly = _jackpotMonthly;
    }

    function setDev1FeeReceivers(address _Dev1) external authorized {
        dev1 = _Dev1;
    }

    function setDev2FeeReceivers(address _Dev2) external authorized {
        dev2 = _Dev2;
    }

    function setDev3FeeReceivers(address _Dev3) external authorized {
        dev3 = _Dev3;
    }

    function setDev4FeeReceivers(address _Dev4) external authorized {
        dev4 = _Dev4;
    }

    function setDev5FeeReceivers(address _Dev5) external authorized {
        dev5 = _Dev5;
    }
