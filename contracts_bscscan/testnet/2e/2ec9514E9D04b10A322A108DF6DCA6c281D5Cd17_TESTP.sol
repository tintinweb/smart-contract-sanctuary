...
contract TESTP is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    string private _name    = "TEST-P";
    string private _symbol  = "TEST-P";
    uint8 private _decimals = 9;

    uint256 public taxFee          = 0; // Fee that gets re-distributed to holders.
    uint256 public liquidityFee    = 0;
    uint256 public buybackFee      = 0;
    uint256 public marketingFee    = 0;
    uint256 private researchFee    = 0;
    uint256 private _previousTaxFee = taxFee;

    uint256 private _buyTaxFee         = 6;
    uint256 private _buyLiquidityFee   = 4;
    uint256 private _buyBuybackFee     = 3;
    uint256 private _buyMarketingFee   = 2;
    uint256 private _buyResearchFee    = 1;
    
    uint256 private _sellTaxFee         = 6;
    uint256 private _sellLiquidityFee   = 4;
    uint256 private _sellBuybackFee     = 3;
    uint256 private _sellMarketingFee   = 2;
    uint256 private _sellResearchFee    = 1;
