...
contract METAVERSAGE is IBEP20, Auth {
    ...
    string private constant _name = "METAVERSAGE";
    string private constant _symbol = "MSAGE";
    ...
    uint256 private selldevelopmentFee = 4;
   
    uint256 private totalSellFee = 16;
    ...
    uint256 private tempdevelopmentFee;
    ...
    uint256 private amountdevelopmentFee; 
    uint256 private amountSecdevelopmentFee; 
    uint256 private amountUtilityFee;
    
    address private marketingFeeReceiver =0x9D4A034Af0e5AC554383c99678392987bA66dFCB;
    address private developmentFeeReceiver = marketingFeeReceiver;
    ...
    function getSwapFees() internal {
        ...
        tempdevelopmentFee = developmentFee.add(selldevelopmentFee).div(2);
    ...
    function swapBack() internal swapping {
        ...
        totalBNBFee = tempTotalFee.sub(tempLiquidityFee.div(2)); 
        ...
        amountdevelopmentFee = amountBNB.mul(tempdevelopmentFee).div(totalBNBFee); 
      
        amountUtilityFee = amountBNB.mul(tempUtilityFee).div(totalBNBFee);
        
       
        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (bool DevSuccess, /* bytes memory data */) = payable(developmentFeeReceiver).call{value: amountdevelopmentFee, gas: 30000}("");
       (bool utilitySuccess, /* bytes memory data */) = payable(utilityFeeReceiver).call{value: amountSecdevelopmentFee, gas: 30000}("");
        require(MarketingSuccess && DevSuccess && utilitySuccess,"receiver rejected ETH transfer");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _utilityFee,  uint256 _marketingFee, uint256 _developmentFee,  uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        
        developmentFee = _developmentFee; 
        utilityFee = _utilityFee;
        uint256 tempFee = _liquidityFee.add(_marketingFee).add(_developmentFee);
        totalFee = tempFee.add(_utilityFee);
        feeDenominator = _feeDenominator;
    }
    
    function setSellFees(uint256 _liquidityFee, uint256 _utilityFee,  uint256 _marketingFee, uint256 _developmentFee,  uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        
        selldevelopmentFee = _developmentFee; 
        sellUtilityFee = _utilityFee;
        uint256 tempSellFee = _liquidityFee.add(_marketingFee).add(_developmentFee);
    ...
    function setdevelopmentFeeReceiver(address _developmentFeeReceiver) external authorized {
