...
contract Definitive is IBEP20, Auth {
    ...
    uint256 setPriceTimestampInterval = 10 minutes;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function feeInfo() public view returns (uint256 Liquidity_fee, uint256 Buyback_fee, uint256 Dividend_fee, uint256 Airdrop_fee, uint256 Total_fee, uint256 Total_fees_collected) {
        return (liquidityFee.div(feeDenominator.div(100)), buybackFee.div(feeDenominator.div(100)), reflectionFee.div(feeDenominator.div(100)), airdropFee.div(feeDenominator.div(100)), totalFee.div(feeDenominator.div(100)), totalFeesCollected.div(10 ** 18));
    }    
