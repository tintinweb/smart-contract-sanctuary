...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2F4e9c97aAFFD67D98A640062d90e355B4a1C539); // Afro Token for rewards
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
           // : IDEXRouter(0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7); // ApeSwap
           : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // PancakeSwap Testnet
        _token = msg.sender;
    }
...
contract AFROPLUS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AFROPLUS";
    string constant _symbol = "AFROPLUS";
    ...
    constructor() Auth(msg.sender) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // PancakeSwap Testnet
