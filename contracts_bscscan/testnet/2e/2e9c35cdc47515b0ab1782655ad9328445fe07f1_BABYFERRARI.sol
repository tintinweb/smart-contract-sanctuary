...
/**
     Telegram : https://t.me/babyferrari
     Max wallet: 500 tokens
     Max sell amount: 200 tokens to prevent dumping
     EARN 10% BUSD REFLECTION FOR HOLDING
 */
...
contract BABYFERRARI is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "Baby Ferrari";
    string private _symbol = "BRARI";
    ...
    uint256 public _maxSellTransactionAmount = 200 * 10**9; // can't sell more than this
    uint256 public _maxWalletToken = 500 * 10**9; // can't buy or accumulate more than this
