...
// File: contracts/WagashiProfile.sol
...
contract WagashiProfile is AccessControl, ERC721Holder {
    ...
    function createProfile(
        ...
        wagashiToken.safeTransferFrom(_msgSender(), address(this), numberWagashiToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        wagashiToken.safeTransferFrom(_msgSender(), address(this), numberWagashiToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        wagashiToken.safeTransferFrom(_msgSender(), address(this), numberWagashiToReactivate);
...
// File: contracts/AnniversaryAchievementEvent.sol

pragma solidity ^0.6.12;

/**
 * @title AnniversaryAchievementEvent.
 * @notice It is a contract to distribute points for 1st anniversary.
 */
contract AnniversaryAchievementEvent is Ownable {
    WagashiProfile public wagashiProfile;
    ...
    /**
     * @notice Constructor
     * @param _wagashiProfile: Wagashi Profile
     ...
     */
    constructor(
        address _wagashiProfile,
        uint256 _numberPoints,
        uint256 _thresholdPoints,
        uint256 _campaignId,
        uint256 _endBlock
    ) public {
        wagashiProfile = WagashiProfile(_wagashiProfile);
    ...
    function claimAnniversaryPoints() external {
        ...
        wagashiProfile.increaseUserPoints(msg.sender, numberPoints, campaignId);
    }
    ...
    function canClaim(address _user) public view returns (bool) {
        if (!wagashiProfile.getUserStatus(_user)) {
            return false;
        }

        (, uint256 numberUserPoints, , , , ) = wagashiProfile.getUserProfile(_user);
