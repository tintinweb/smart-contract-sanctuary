...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FLOKI = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //0x10ED43C718714eb63d5aA57B78B54704E256024E pancake
        _token = msg.sender;
    }
...
contract catdoge is IBEP20, Auth {
    ...
    address FLOKI = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cat DOGE BSC";
    string constant _symbol = "CDBSC";
   ...
   // buy fee
    ...
    address public Owner=0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1; // owner address
    ...
    constructor () Auth(Owner) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // 0x10ED43C718714eb63d5aA57B78B54704E256024E mainnet
        ...
        marketingFeeReceiver = 0x204A87334C3eDbDe658368Df8cd68931eE861305; // marketing address
