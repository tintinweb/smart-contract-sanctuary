...
contract MiloToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("MiloToken", "MILO") ERC20Permit("MiloToken")
    {

    }

    uint256 constant private _maxTotalSupply = 10000000e18; // 10,000,000 max shades
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s ) external {
        ...
        require(signatory != address(0), "SHADE::delegateBySig: invalid signature");
        require(nonce == _useNonce(signatory), "SHADE::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "SHADE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SHADE::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying SHADEs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SHADE::_writeCheckpoint: block number exceeds 32 bits");
