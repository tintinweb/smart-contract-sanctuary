...
contract CarbonToken is ERC20, Pausable, ERC20Detailed {
    ...
    constructor() public ERC20Detailed("Carbon-7", "CO2", 9) {
        ...
        transferAndLock(privateSaleWallet, 25000000 * 10**uint256(decimals()), 1666396800);      // transfer 25 million tokens and lock up until Sat Oct 22 2022 00:00:00 GMT
    }
