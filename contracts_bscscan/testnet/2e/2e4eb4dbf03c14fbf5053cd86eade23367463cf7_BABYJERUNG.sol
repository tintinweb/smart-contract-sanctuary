...
contract BABYJERUNG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0C9EE73dDFa60dEc38377a6B0b14d4f0532fd371); // Marketing Address
    ...
    string private _name = "BABYJERUNG";
    string private _symbol = "BABYJERUNG";
