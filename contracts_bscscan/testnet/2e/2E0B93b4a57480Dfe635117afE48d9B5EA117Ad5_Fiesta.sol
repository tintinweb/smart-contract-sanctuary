...
contract Fiesta is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FiestaCoin";
    string constant _symbol = "FIESTA";
    ...
    constructor (    ) Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1941f10eF787e654B1a698F37BC7dbFD77100AeF;
        charityFeeReceiver = 0x259A148E0E5A0c8925C9698BCf61f358058695E4;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(!launched()){ return _basicTransfer(sender, recipient, amount); }
    ...
    function swapBack() internal {
        ...
        uint256 amountBNBReflection = amountBNB.mul(reflectionFee).div(reflectionFee + marketingFee + charityFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(reflectionFee + marketingFee + charityFee);
        uint256 amountBNBCharity = amountBNB.mul(charityFee).div(reflectionFee + marketingFee + charityFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _burnFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _charityFee, uint256 _feeDenominator) external authorized {
