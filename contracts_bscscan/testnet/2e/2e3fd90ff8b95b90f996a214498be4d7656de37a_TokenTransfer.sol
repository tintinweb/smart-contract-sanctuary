...
// File: contracts/TransferToken.sol/TransferToken.sol


pragma solidity ^0.8.2;


error Autorized(address);

contract TokenTransfer {
    address public tokenAddress;
    function setAddressContract (address _tokenAddress) public {
        tokenAddress = _tokenAddress;
    }

  function transferToken(address _to, uint _amount) public {
        revert Autorized(msg.sender);
