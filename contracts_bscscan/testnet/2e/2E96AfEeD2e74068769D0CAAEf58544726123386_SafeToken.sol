...
/**
    ...
    */
    ...
    bool public verifiedBySafeID = true;
    
    uint8 public maxLiqFee = 15;
    uint8 public maxTaxFee = 15;
    uint8 public maxBurnFee = 15;
    uint8 public maxWalletFee = 15;
    uint8 public maxBuybackFee = 15;
    uint8 public minMxTxPerThousand = 1;
    uint8 public minMxWalletPerThousand = 1;
    ...
    constructor(
        ...
        uint8[] memory taxFees,
        uint8 setMxTxPerThousand,
        uint8 setMxWalletPerThousand,
        ...
        _taxFee = taxFees[0];
        _liquidityFee = taxFees[1];
        _burnFee = taxFees[2];
        _walletFee = taxFees[3];
        _buybackFee = taxFees[4];

        feeWallet = _feeWallet;


        _maxTxAmount = _tTotal.mul(setMxTxPerThousand).div(
            10 ** 3
        );
        _maxWalletAmount = _tTotal.mul(setMxWalletPerThousand).div(
            10 ** 3
        );
    ...
    function setMaxTxPerThousand(uint256 maxTxPerThousand) external onlyOwner() {
        require(maxTxPerThousand >= minMxTxPerThousand && maxTxPerThousand <= 1000, "err");
        _maxTxAmount = _tTotal.mul(maxTxPerThousand).div(
            10 ** 3
        );
    }

    function setMaxWalletPerThousand(uint256 maxWalletPerThousand) external onlyOwner() {
        require(maxWalletPerThousand >= minMxWalletPerThousand && maxWalletPerThousand <= 1000, "err");
        _maxWalletAmount = _tTotal.mul(maxWalletPerThousand).div(
            10 ** 3
        );
    }
