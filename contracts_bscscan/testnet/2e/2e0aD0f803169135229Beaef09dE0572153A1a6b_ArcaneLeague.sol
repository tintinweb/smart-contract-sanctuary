...
contract ArcaneLeague is ERC721("ARCANELEAGUE", "ARCANELEAGUE"), ERC721Enumerable, Ownable {
    ...
    */
    ...
    uint256 public NFTPrice = 1;  // 0.01 BNB
    ...
    */
        ...
        payable 
    {
        ...
        require(NFTPrice.mul(1) == msg.value * 100, "Ether value sent is not correct");
