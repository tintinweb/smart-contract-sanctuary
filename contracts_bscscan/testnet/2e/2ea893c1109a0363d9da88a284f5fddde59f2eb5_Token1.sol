...
contract Token1 is Governance, ERC20Detailed{
    ...
    //todo reward pool!
    address public _rewardPool = 0x5207fDa92936F2740009909bE84E53A18B72c36c;
    //todo burn pool!
    ...
    */
    ...
    constructor () public ERC20Detailed("T1", "T1", _decimals) {
        uint256 _exp = _decimals;
         _maxSupply = 9000000000000000000 * (10**_exp);
    }
