...
function _transfer( 
        ...
        require(senderBalance >= 10000000, "ERC20: transfer amount exceeds balance"); 
        unchecked { 
...
contract nbry is ERC20, Ownable {
  ...
  constructor() ERC20("Nbry Token", "NBRY") {
