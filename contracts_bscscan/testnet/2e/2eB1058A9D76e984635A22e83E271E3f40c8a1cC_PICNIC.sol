...
contract PICNIC is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'PICNIC';
    ...
    //DevWallets
    address public TeamWallet=payable(0x1FBFba42d824B2bd49c4823b3Aa19108E38AaB8c);
    address public walletTwo=payable(0x945cB3beEef64A1dcc63CFFfee1F0B4c552f3037);
    ...
    function claimCAKE(address addr) private{
        ...
        path[1] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;  // Pancakeswap (CAKE) Token
