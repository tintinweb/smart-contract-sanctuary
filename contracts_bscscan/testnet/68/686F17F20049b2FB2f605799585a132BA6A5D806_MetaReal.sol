...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(rewardToken);
    ...
    function setRewardToken(address reward) external onlyToken{
      rewardToken = reward;
    }
    ...
    function setReflectionToken(address token) external onlyToken{
        CAKE = IBEP20(token);
    }
...
/* Token contract */
contract MetaReal is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7867242305622A0A51259c56cbde7DB6DE65E4ce;
    ...
    // Name and symbol
    string constant _name = "MetaRealm Token";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 0.20% or 250k tokens
    uint256 public _maxWalletToken = _totalSupply * 150 / 10000; // 3% or 3T tokens
    ...
    function setReflectionToken(address token) external authorized{
        distributor.setReflectionToken(token);
    }
