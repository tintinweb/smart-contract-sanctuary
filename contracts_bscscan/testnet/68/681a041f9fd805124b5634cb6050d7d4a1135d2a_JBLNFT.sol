...
contract ERC721 is ERC165, IERC721{
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        // uint256 a = mint_count(to);
        // _ownedTokens[to][a]=tokenId;

        emit Transfer(address(0), to, tokenId);
    }
    
    function get_addr_tokenid(address addr)public view returns (uint256[]) {
...
contract JBLNFT is ERC721{
    ...
    constructor ()  public ERC721("Smiling George Hit", "Hit"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "Smiling George Hit";
        string memory _t = "Hit";
        string memory tokenURI = "https://jbl.i-recu.com/assets/images/player/coop_5.png";
