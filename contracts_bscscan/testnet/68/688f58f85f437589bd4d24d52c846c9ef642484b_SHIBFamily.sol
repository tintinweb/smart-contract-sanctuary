...
contract SHIBFamily is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5eBF7032A0C504BCe0A1687A424EDe33Ba977F45); // Marketing Address
    ...
    string private _name = "SHIBFamily";
    string private _symbol = "SHIBFamily";
