...
contract R {
    ...
    function setVariables(uint8 _fee, uint256 _minDeposit, address _feeReceiver) public onlyOwner {
        fee = _fee;
    ...
    function deposit(string memory token) public payable {
        ...
        require(amount >= minDeposit, 'Error: amount is under min deposit');
    ...
    function withdraw(uint256 amount, address receiver, string memory token) public {
        ...
        require(amount <= balance, 'Error: amount exceeds account balance');
