...
contract DividendDistributor {
    ...
    function switchToken(address rewardToken) external onlyToken {
...
contract test3x is IBEP20, Auth {
    ...
    string constant _name = "3x";
    string constant _symbol = "3xx";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!isFeeExempt[sender]) { require(tradingOpen, "Trading is disabled"); }
