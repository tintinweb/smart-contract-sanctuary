...
contract AmostDone is IBEP20, Ownable
{
    ...
    string private constant _name = "AlmostDone";
    string private constant _symbol = "AD";
    uint8 private constant _decimals = 8;
    uint256 private constant InitialSupply=  10000000000 * 10**_decimals;
    ...
    */
    ...
    uint256 private  balanceLimit = 2000000000 * 10**_decimals;
    uint256 private  sellLimit = 50000000 * 10**_decimals;
    uint256 private  buyLimit = 1000000000 * 10**_decimals;
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function SetTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 marketingTaxes) public onlyOwner{
        uint8 totalTax=burnTaxes+liquidityTaxes+stakingTaxes+marketingTaxes;
        require(totalTax==100, "burn+liquidity+staking+marketing needs to equal 100%");
