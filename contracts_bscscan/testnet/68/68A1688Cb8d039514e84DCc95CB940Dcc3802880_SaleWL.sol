...
contract SaleWL {
    ...
    IERC20 constant public token = IERC20(0x444386aAD287f92830F21512e8DE778429FF747E);// Token MetaPad
    IERC20 constant public busd = IERC20(0xD88C6Ec2D3fBD90892c6749CF83De6ad10c30B4b);// Token BUSD
    ...
    function invest(uint256 _amount) public {
        ...
        require(getLeftToken() >= _minBUSD.mul(_RATE),"Sale ended");
    ...
    function getToken() public {
        require(block.timestamp >= _START_TIME.add(_SALE_DAYS) || getLeftToken() < _minBUSD.mul(_RATE) || _status == false,"Expect the end of the sell");
