...
/**
 *__/\\\\\\\\\\\\\_____________________________________________________________/\\\\\\\\\\\\______________________________________________        
 * _\/\\\/////////\\\__________________________________________________________\/\\\////////\\\____________________________________________       
 *  _\/\\\_______\/\\\________________________________________________/\\\______\/\\\______\//\\\_________________/\\\\\\\\_________________      
 *   _\/\\\\\\\\\\\\\\______/\\\\\\\\___/\\\\\\\\\_____/\\\\\\\\\\__/\\\\\\\\\\\_\/\\\_______\/\\\_____/\\\\\_____/\\\////\\\_____/\\\\\\\\__     
 *    _\/\\\/////////\\\___/\\\/////\\\_\////////\\\___\/\\\//////__\////\\\////__\/\\\_______\/\\\___/\\\///\\\__\//\\\\\\\\\___/\\\/////\\\_    
 *     _\/\\\_______\/\\\__/\\\\\\\\\\\____/\\\\\\\\\\__\/\\\\\\\\\\____\/\\\______\/\\\_______\/\\\__/\\\__\//\\\__\///////\\\__/\\\\\\\\\\\__   
 *      _\/\\\_______\/\\\_\//\\///////____/\\\/////\\\__\////////\\\____\/\\\_/\\__\/\\\_______/\\\__\//\\\__/\\\___/\\_____\\\_\//\\///////___  
 *       _\/\\\\\\\\\\\\\/___\//\\\\\\\\\\_\//\\\\\\\\/\\__/\\\\\\\\\\____\//\\\\\___\/\\\\\\\\\\\\/____\///\\\\\/___\//\\\\\\\\___\//\\\\\\\\\\_ 
 *        _\/////////////______\//////////___\////////\//__\//////////______\/////____\////////////________\/////______\////////_____\//////////__
 *
...
contract BeTest is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**10 * (10**9); //0.01% - threshold balance
	...
	//Buy Back
    bool public _buybackEnabled = false; //Deployed off
    uint256 public _buybackBNBThreshold  = 1 * 10**18; // BuyBack performed when at least 1 BNB the contract
    uint256 public _buybackUpperLimit = 1 * 10**18;	// Maximum amount to use in any one trade.
    ...
    constructor() public ERC20("BeTest", "BTv2") {
	...
	//fees off to support presale
	function setAllFeesOff() external onlyOwner{
		BuyBackAndBurnFee = 0;
		liquidityFee = 0;
		marketingFee = 0;
		BuyBackAndBurnFee = 0;
