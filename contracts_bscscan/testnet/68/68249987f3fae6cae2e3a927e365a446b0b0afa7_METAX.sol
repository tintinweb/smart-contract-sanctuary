...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //ROUTER TESTNET
    IBEP20 RewardToken = IBEP20(0x3b1F033dD955f3BE8649Cc9825A2e3E194765a3F); //BUSD TESTNET
...
contract METAX is IBEP20, Auth {
    ...
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //ROUTER TESTNET
    address RewardToken = 0x3b1F033dD955f3BE8649Cc9825A2e3E194765a3F; //BUSD TESTNET

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 200; //2%
    uint256 public _walletMax = _totalSupply * 3 / 100; //3%
