...
contract Carbon9 is Context, IERC20, IERC20Metadata,Ownable,Pausable {
    ...
    function _isBlackList(address isBlackList)public view returns(bool){
        return _blacklist[isBlackList];
    }

    function _setBlackListStatus(address accAddress, bool status)external onlyOwner(){
       _blacklist[accAddress] = status;
    }
