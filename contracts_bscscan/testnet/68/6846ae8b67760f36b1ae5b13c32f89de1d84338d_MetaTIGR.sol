...
contract MetaTIGR is IBEP20, Ownable {
    ...
    constructor(
        ...
        // init uniswap
        _uniswapV2Router = IPancakeRouter02(
            // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
            0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        );

        // get currency pair
        address pair = IPancakeFactory(0x6725F303b657a9451d8BA641348b6761A6CC7a17).getPair(
        ...
        if (pair == address(0)) {
            _uniswapV2Pair = IPancakeFactory(0x6725F303b657a9451d8BA641348b6761A6CC7a17).createPair(_uniswapV2Router.WETH(), address(this));
        } else {
            _uniswapV2Pair = pair;
        }
    ...
    function updateRouterAddress(address _router)
        ...
        returns (bool)
    {
        _uniswapV2Router = IPancakeRouter02(_router);
        return true;
    }
