...
contract Prediction is IPrediction, Ownable, Pausable {
     ...
     */
    function numbersDrawn(uint256 _pid, bytes32 _requestId, uint256 _randomNumber) external override {
        uint256 _epoch = currentEpoch[_pid] - 1;
        require(msg.sender == specifications[_pid][_epoch].oracle, "PREDICTION: Only oracle can call");
