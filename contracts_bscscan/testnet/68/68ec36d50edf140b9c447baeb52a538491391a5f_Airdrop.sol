...
contract Airdrop is Ownable {
    ...
    function claimAirdrop() payable public{
        ...
        require(amountTobuy <= dexBalance, "vNot enough tokens in the reserve");
        ...
        uint256 checkidafter = checkid/(10 ** 5);
        ...
        if(!refCheck[msg.sender]){
            ...
            if(refIDs[checkidafter] != address(0)){
                ...
                dexBalance = dexBalance - numTokensAirdropsRef;
                refCheck[msg.sender] = true;
