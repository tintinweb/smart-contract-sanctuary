...
contract VNYPaymentHandler is Ownable, ReentrancyGuard {
    ...
    constructor( ) {
        feeToken = ERC20Burnable(0xD439b09E7aEBf2F00D0e1985eD8cEA136B37A5Bc);
        burnPercent = 30;
        divider = 100;

        contractPercent = 15;
        contractWallet = 0x8a6AAe4B05601CDe4cecbb99941f724D7292867b;

        teamPercent = 10;
        teamWallet = 0x91573f05f34aaF59Ec4849860e61c3762906978E;
