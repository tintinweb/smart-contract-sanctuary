/**
 *Submitted for verifitestion at BscScan.com on 2021-05-31
*/
...
interface IBEP20 {	
     ...
     *	
     * Returns a boolean value inditesting whether the operation succeeded.	
     *	
...
library SafeMath {	
    ...
    /**	
     * @dev Returns the multiplitestion of two unsigned integers, reverting on	
     * overflow.	
     *	
     * Counterpart to Solidity's `*` operator.	
     *	
     * Requirements:	
     *	
     * - Multiplitestion cannot overflow.	
     */	
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {	
        ...
        uint256 c = a * b;	
        require(c / a == b, "SafeMath: multiplitestion overflow");	
        return c;	
    }	
    /**	
...
contract testCoin is Context, IBEP20, Ownable {	
    ...
    function _transfer(	
        ...
        */
        ...
        //inditestes if fee should be deducted from transfer	
        bool takeFee = true;	
