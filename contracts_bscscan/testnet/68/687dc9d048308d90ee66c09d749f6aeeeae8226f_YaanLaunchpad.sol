...
contract YaanLaunchpad {
    ...
    constructor() {
        ...
        tiers.push(Tier(1200, 40, 20 minutes));
        tiers.push(Tier(1500, 100, 25 minutes));
        tiers.push(Tier(1800, 150, 30 minutes));
        tiers.push(Tier(2100, 200, 35 minutes));
    ...
    function userdetails(address addr) public view returns(uint topTier, uint stakedAmount, uint stakedAt, bool stakedWithdrawn, bool claimBtnStatus, uint withdrawableAmt) {
        ...
        withdrawableAmt = withdrawable(addr);
