...
╚══════╝░╚═════╝░╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░╚══════╝░░░╚═╝░░░╚═╝░░╚═╝
    ...
    Welcome to BABYETH ($BABYETH)

    The Official Token for the BABYETH Community!





    📱 Telegram for Announcements:: https://t.me/bbyethofficial

    🌎 Website: https://babyethcoin.com/

    Twitter: https://twitter.com/BabyETHOfficial





    Thank you for being a part of our community and making BABYETH Great!
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable ETH = address(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F);
...
contract BABYETH is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 500000000 * (10**18); // 0.05 VITALIK BABY
    ...
    constructor() ERC20("BABYETH", "BABYETH") {
        ...
        marketingWallet = address(0x021087FF9b8E7Eab771E6d719E01f96617Fa93aA);
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        ...
        require(newLiquidityWallet != liquidityWallet, "BABYETH: The liquidity wallet is already this address");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            ...
            require(canTransferBeforeTradingIsEnabled[from], "BABYETH: This account cannot send tokens until trading is enabled");
...
contract BABYETHDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BABYETH_Dividend_Tracker", "BABYETH_Dividend_Tracker") {
