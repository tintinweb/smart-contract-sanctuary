...
contract LotDogToken is Context, IERC20, Ownable {
    ...
    string private _name = "Test Token 4";
    ...
    uint256 public _liquidityFee = 9; //(2% liquidityAddition + 1% rewardsDistribution + 1% devExpenses)
