 ...
 *  Telegram Group: https://t.me/bnbprimedapp
 ...
 *   - Contract Total amount bonus: +0.1% for every 45 BNB on platform Contract Balance
...
contract Smartinu {
	...
	uint256[] public ReferralCommissions = [700, 200, 50, 50]; //7% 2% .5 .5
	uint256 constant public Day = 1 days;
	uint256 constant public ROICap = 25000; //250%
	uint256 constant public PercentDiv = 10000;
	uint256 constant public ContractIncreaseEach = 25 * 10**18;
	uint256 constant public StartBonus = 550; //5.5%
	uint256 constant public ContractBonusCap = 1000; //contract limit 10% daily
	uint256 constant public HoldBonusCap = 300; //0.3%
	uint256 constant public Advertising = 2000; //20%
