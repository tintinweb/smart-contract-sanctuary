...
contract NomadTravelToken is IBEP20, Ownable {
    ...
    string internal _symbol = "TTT";
    string internal _name = "TestToken";
    ...
    constructor() {
        ...
        IPancakeRouter02 _router = IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        router = _router;
    ...
    function updateRates(uint256 rewards, uint256 marketing, uint256 liquidity) external onlyOwner {
        _token_rates = TokenRates(_tokenRewardsTax, _tokenMarketingTax, _tokenLiquidityTax, rewards + marketing + liquidity);
    }
