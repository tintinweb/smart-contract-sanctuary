...
contract Aggreator {
    ...
    event request(uint256 roundId, string pair);
    event priceUpdated(string _pair,uint256 _roundId,int256 _price);
    ...
    function init(string memory _pair) external {
        ...
        emit request(roundIds[_pair].roundId, _pair);
    }
        ...
        // ensureLatestResponsesReceived(_priceId)
    {
        ...
        emit priceUpdated(_pair,_roundId,currentPriceTemp);
    }
