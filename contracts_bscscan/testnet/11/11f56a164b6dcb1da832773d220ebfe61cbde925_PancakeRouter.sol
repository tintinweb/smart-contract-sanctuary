...
function getPairData(address pairaddress)  public view returns(address _T0Address,string memory _T0Symbol,uint _T0Decimals,uint _t0Reserves,address _T1Address,string memory _T1Symbol,uint _T01ecimals){
...
address  token0=pair.token0();
  ...
  return (token0,t0Symbol,t0Decimal,reserve0,token1,t1Symbol,t1Decimal);
 }
