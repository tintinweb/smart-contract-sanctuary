...
contract LotteryToken is Context, IERC20, Ownable {
    ...
    function sendLotteryAward(address winner, uint256 tokenAmount, uint tier) private{
        ...
        if(tier == 1){
            lastTier1Award = bnbReward.mul(80).div(100);
        }else if(tier == 2){
            lastTier2Award = bnbReward.mul(80).div(100);
        }else if(tier == 3){
            lastTier3Award = bnbReward.mul(80).div(100);
        }
    }
        ...
        if(tier == 1){
            while(found == false){
                ...
                if (current.sub(tier1TimeStamp[tier1Cadidates[winnerIndex]]) >= tier1QualifiedTime){
                    ...
                    sendLotteryAward(lastTier1Winner, _currentTier1LotteryAward, 1);
            ...
            while(found == false){
                ...
                if (current.sub(tier2TimeStamp[tier2Cadidates[winnerIndex]]) >= tier2QualifiedTime){
                    ...
                    sendLotteryAward(lastTier2Winner, _currentTier2LotteryAward, 2);
            ...
            while(found == false){
                ...
                if (current.sub(tier3TimeStamp[tier3Cadidates[winnerIndex]]) >= tier3QualifiedTime){
                    ...
                    sendLotteryAward(lastTier3Winner, _currentTier3LotteryAward, 3);
