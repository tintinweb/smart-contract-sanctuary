...
contract Strat_Pancake is StratPCS {
    constructor(
...
abstract contract StratPCS is Ownable, ReentrancyGuard, Pausable {
    ...
    function _safeSwap(
        ...
        uint256[] memory amounts =
            IPancakeRouter02(_uniRouterAddress).getAmountsOut(_amountIn, _path);  // uint fee = 25 on solarRouter
