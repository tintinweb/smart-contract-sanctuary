...
contract ANFT is BNFT, IPokMonsterNFT, ReentrancyGuard {
    using Address for address;
    ...
    address private _stats;

    constructor() BNFT(_msgSender(), "https://", "NFT", "nft") {}

    function setPokeStats(address stats) external onlyAdmin {
        _stats = stats;
    }
