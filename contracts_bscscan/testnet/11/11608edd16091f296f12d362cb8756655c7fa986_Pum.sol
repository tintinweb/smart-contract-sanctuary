...
contract Pum is BEP20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0xaD8c4565BADDcCc3fEe80eF824c6B555E959cBC5] = _totalSupply;
        emit Transfer(address(0), 0xaD8c4565BADDcCc3fEe80eF824c6B555E959cBC5, _totalSupply);
    }
    function totalSupply() public constant returns (uint) {
