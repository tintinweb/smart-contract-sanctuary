...
contract ApeHeroMarketplace is Pausable, IERC721Receiver, Ownable, AccessControlEnumerable {
    ...
    // --- public --- //
    function listItem(address collection, uint tokenId, uint price) public payable whenNotPaused {
    ...
    function delistItem(address collection, uint tokenId) public payable whenNotPaused {
    ...
    function buyItem(address collection, uint tokenId) public payable whenNotPaused {
        require(_listedItemsById[collection].contains(tokenId), "Item not currently listed");
