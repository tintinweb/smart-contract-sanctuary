...
contract TestFLOKI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3Fd4f281b725824855AF70f1506B23E3d1A59d1C); // Marketing Address
    ...
    string private _name = "TestFLOKI";
    string private _symbol = "TestFLOKI";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x3Fd4f281b725824855AF70f1506B23E3d1A59d1C);
    }
