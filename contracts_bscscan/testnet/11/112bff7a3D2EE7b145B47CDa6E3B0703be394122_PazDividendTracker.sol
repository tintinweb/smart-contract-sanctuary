...
contract PazDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(address pazAddress, address routerAddress, address busdAddress)DividendPayingToken("PazDividendTracker", "PazDividendTracker", busdAddress){
        ...
        // add  paz, busd, ts, rice
        setAllowedTokens(pazAddress, true);
        setAllowedTokens(BUSD, true);
        setAllowedTokens(0x3504de9e61FDFf2Fc70f5cC8a6D1Ee493434C1Aa, true); // ts
        setAllowedTokens(0xC4eEFF5aab678C3FF32362D80946A3f5De4a1861, true); // rice

        // add v1 router for ts
        setAllowedRouter(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F, true); // v1 pancake router
...
//        setTokenRouter(0x4bCdd13aa5911b82dFDd873be81015a887754913, 0x9aa68E4818A79E024d5a3bFd32Bca116EcB240ED);
    ...
    /// @dev all tokens without an router will go to the default router
...
interface IPazzive {
  ...
  function PRIZE_WALLET (  ) external view returns ( address );
  ...
  function getUserSellFee ( address user ) external view returns ( uint256 );
  function increaseAllowance ( address spender, uint256 addedValue ) external returns ( bool );
  function isBlacklisted ( address account ) external view returns ( bool );
  function isDumper ( address ) external view returns ( bool );
  ...
  function lastSaleToPenalty ( uint256 ) external view returns ( uint8 );
  ...
  function lockDurationToUserCount ( uint256 ) external view returns ( uint256 );
  ...
  function setIsBlacklisted ( address user, bool blacklisted ) external;
  function setIsDumper ( address[] calldata dumperList, bool _isDumper ) external;
  function setLastSaleToPenalty ( uint256 timePeriod, uint8 penalty ) external;
  function setLockDurationToBonus ( uint256 duration, uint256 bonus ) external;
  function setLockingEnabled ( bool enable ) external;
  function setMarketingAddress ( address _marketingAddress ) external;
  function setMaxSellAmount ( uint256 _maxSellAmount ) external;
  function setPrizeWallet ( address prizeWalletAddress ) external;
  function setProcessDividendGasAmount ( uint256 dividendGasAmount ) external;
  function setProgressiveFeeEnabled ( bool isEnabled ) external;
  ...
  function setSwapPair ( address pair ) external;
  function setSwapPairs ( address pair, bool isPair ) external;
  ...
  function taxFreeLiquidity ( uint256 tokenAmount ) external;
  function taxFreeReinvest ( address token, uint256 amount ) external;
  ...
  function userLockedForYear ( address ) external view returns ( bool );
