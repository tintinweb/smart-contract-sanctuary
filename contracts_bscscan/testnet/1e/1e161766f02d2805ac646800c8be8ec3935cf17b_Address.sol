...
contract SUCCESS is Context, IBEP20, Ownable {
    ...
    string private _name = "SUSS";
    string private _symbol = "SUSS";
        ...
        if(tier == 1){
            ...
            while(found = false){
                ...
                if (
                    ...
                    current.sub(tier1TimeStamp[tier2Cadidates[winnerIndex]]) >= tier2QualifiedTime){
