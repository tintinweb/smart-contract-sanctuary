...
contract FG3_TEST is Context, IERC20, Ownable { 
    ...
    uint256 public Percent_FoxGirl = 0;
    uint256 public Percent_Burn = 0;
    uint256 public Percent_Token_Wallet = 0;
...
/*
  ...
  // Must have a liquidity pair to be able to do the swap  - 
    ...
    function _A_SWAP_BUSD_TO_TOKENS_3_STEP_A() public onlyOwner  {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            ...
            0,
            path,
            0x06376fF13409A4c99c8d94A1302096CB4dC7c07e, // Sending to wallet to avoid the path 0/1 !to address error
            block.timestamp
        );
    }
 ...
 // THIS ONE DOES NOT WORK :( 
    function _A_SWAP_BUSD_TO_TOKENS_3_STEP_B() public onlyOwner  {
        uint256 BUSD_BAL = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7).balanceOf(address(this));
        uint256 swapAmount = BUSD_BAL / 2;
        address[] memory path = new address[](3);
        path[0] = BUSD_T;
        ...
        IERC20(BUSD_T).approve(address(this),swapAmount * 10);
        _approve(BUSD_T, address(uniswapV2Router), swapAmount);
 ...
 // THIS ONE DOES NOT WORK :( 
    function _A_SWAP_BUSD_TO_TOKENS_3_STEP_C() public onlyOwner  {
        uint256 BUSD_BAL = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7).balanceOf(address(this));
        uint256 swapAmount = BUSD_BAL / 2;
        address[] memory path = new address[](3);
        path[0] = BUSD_T;
        ...
        _approve(BUSD_T, address(uniswapV2Router), swapAmount);
        _approve(BUSD_T, address(this), swapAmount);
    ...
    // THIS ONE WORKS :)
    function _A_SWAP_TOKENS_TO_BUSD_3_STEP() public onlyOwner  {
