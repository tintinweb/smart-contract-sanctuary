...
contract TPFD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TPFD";
    string constant _symbol = "TPFD";
    ...
    uint256 public _walletMax = 25 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        charityWallet = 0xd9Cb687EccC712A045eE3Af1542A4b057d8611C1;
    ...
    function changeFees(uint256 newLCharityFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee, uint256 newBurnFee) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 bnbCharity = amountBNB.mul(charityFee).div(totalFee).div(2);
    ...
    function prepareForLaunch(uint256 newLCharityFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee, uint256 newBurnFee) external onlyOwner {
        ...
        _maxTxAmount = 10 * 10**6 * (10 ** _decimals);
    }
