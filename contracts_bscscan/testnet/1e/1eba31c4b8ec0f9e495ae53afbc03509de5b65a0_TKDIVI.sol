...
contract TKDIVI is ERC20, Ownable {
    ...
    constructor() public ERC20("DiviPlanXX", "xDVPLX") {
        // LP burn address
    ...
    function _transfer(
        ...
        if (
            ...
            to != address(uniswapV2Router) //router -> pair is adding liquidity which shouldn't have fee
        ) {
            require(
        ...
        if(takeFee || buyOrSell) {
            ...
            if(_isExcludedFromFees[from] || _isExcludedFromFees[to] || from == address(uniswapV2Router) || to == address(uniswapV2Router)){
