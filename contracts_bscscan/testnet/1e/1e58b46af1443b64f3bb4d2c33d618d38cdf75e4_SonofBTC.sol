...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTCP = IBEP20(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BTCP.balanceOf(address(this));
        ...
        uint256 amount = BTCP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BTCP.transfer(shareholder, amount);
...
contract SonofBTC is IBEP20, Auth {
    ...
    address BTCP = 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca;
