...
interface DividendPayingTokenInterface {
  ...
  /// @notice Withdraws the one distributed to the sender.
  /// @dev SHOULD transfer `dividendOf(msg.sender)` wei to `msg.sender`, and `dividendOf(msg.sender)` SHOULD be 0 after the transfer.
  ///  MUST emit a `DividendWithdrawn` event if the amount of harmony transferred is greater than 0.
  function withdrawDividend() external;

  /// @dev This event MUST emit when harmony is distributed to token holders.
  /// @param from The address which sends harmony to this contract.
  /// @param weiAmount The amount of distributed harmony in wei.
  ...
  /// @param to The address which withdraws one from this contract.
  /// @param weiAmount The amount of withdrawn harmony in wei.
...
interface IERC20 {
     ...
     * https://github.com/harmony/EIPs/issues/20#issuecomment-263524729
     *
...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * harmony and Wei. This is the value {ERC20} uses, unless this function is
     * overridden;
     *
...
/// @author Roger Wu (https://github.com/roger-wu)
/// @dev A mintable ERC20 token that allows anyone to pay and distribute harmony
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ONE = address(0x03fF0ff224f904be3118461335064bB48Df47938); //ONE


  // With `magnitude`, we can properly distribute dividends even if the amount of received harmony is small.
  // For more discussion about choosing the value of `magnitude`,
  //  see https://github.com/harmony/EIPs/issues/1726#issuecomment-472352728
  ...
  /// @notice Withdraws the harmony distributed to the sender.
  /// @dev It emits a `DividendWithdrawn` event if the amount of withdrawn one is greater than 0.
  function withdrawDividend() public virtual override {
    _withdrawDividendOfUser(payable(msg.sender));
  }

  /// @notice Withdraws the harmony distributed to the sender.
  /// @dev It emits a `DividendWithdrawn` event if the amount of withdrawn harmony is greater than 0.
...
contract HarmonyKong is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private constant ONE =
        address(0x03fF0ff224f904be3118461335064bB48Df47938); //HARMONY

    uint256 public swapTokensAtAmount = 2 * 10**6 * (10**18);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x9909ACcDF19e77005E539e6628B3911CD12c76B7)); //marketing wallet
    ...
    constructor() ERC20("HarmonyKong", "HKG") {
...
//      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  //BSC mainnet
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeONEDividends(newBalance);
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("OneKong_Dividen_Tracker", "OneKong_Dividend_Tracker")
    {
        claimWait = 3600;
