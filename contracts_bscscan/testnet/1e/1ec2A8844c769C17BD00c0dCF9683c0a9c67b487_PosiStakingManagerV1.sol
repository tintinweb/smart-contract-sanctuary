...
contract PosiStakingManagerV1 is Ownable, ReentrancyGuard {
    ...
    // The Position TOKEN!
    IPositionTokenV1 public position;
    // Dev address.
    ...
    function updatePool(uint256 _pid) public {
        ...
        console.log("transfer for dev: %s", positionReward.div(10));
