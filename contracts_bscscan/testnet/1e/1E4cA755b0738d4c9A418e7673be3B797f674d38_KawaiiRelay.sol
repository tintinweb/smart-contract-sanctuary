...
interface IKawaiiSalePack {
    function buyPack(address nftRegister, address sender, uint256 pack, uint256 amount, uint256 price, uint8 v, bytes32 r, bytes32 s) external;
}
...
contract KawaiiRelay {
    ...
    function buyPack(IKawaiiSalePack kawaiiSalePack, address nftRegister, address sender, uint256 pack, uint256 amount, uint256 price, uint8 v, bytes32 r, bytes32 s) external {
        kawaiiSalePack.buyPack(nftRegister, sender, pack, amount, price, v, r, s);
    }
