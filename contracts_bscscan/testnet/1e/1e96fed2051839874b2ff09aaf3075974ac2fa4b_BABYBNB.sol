...
// Welcome to BABYBNB - The original token for WBNB dividends

//Join us!
    //https://t.me/babybnbofficial


// What does this contract do?
    // BABYBNB is a new contract concept that rewards hodlers in WBNB 
    // Dividient yield is paid in WBNB directly
    // The auto claim feature allows to automatically receive WBNB for hodling in your wallet
    // Hodl BABYBNB to receive WBNB in your wallet with every transaction

    //This contract is designed to reward hodlers of BABYBNB with WBNB dividends
    //The tokenomics provide an effective anti-whale and anti-automation system 
    //that prevents HFTA (high frequency trading activity == bot selling)

// Tokenomics 
    // MaxTaxRate - 20% 
    // BalanceLimit - 1% 
    // WhitelistMaxBalance - 0.2% 
    // SellLimit - 0.05% 
    // MaxSellLockTime - 0.25 hour 
    // LiquidityLocktime - 1 hour 
    // BuyTax - 7% (High for initial max. burn)
    // SellTax - 1% 
    // TransferTax - 1% 
...
contract BABYBNB is IBEP20, Ownable
{
    ...
    uint16 public constant MaxSellLockTime=0.25 hours;
    ...
    address public constant LiqWallet=0xfaD7e634b3C26C6A7734d923601CB4982B3A020C;  //Mainnet | Testnet
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    constructor () {
        //contract creator gets 93% of the token to create LP-Pair
        uint256 deployerBalance=_circulatingSupply*93/100;
        _balances[msg.sender] = deployerBalance;
        emit Transfer(address(0), msg.sender, deployerBalance);

        //contract gets 7% of the token to generate LP token and marketing budget phase
       ...
       //Sets sellLockTime to be max by default
        ...
        //Set Starting Tax to very high percentage(7%) to achieve maximum burn in the beginning
