...
contract Token is Context, IBEP20, Ownable {
    ...
    */
    ...
    function getMined(address account) public view returns(uint256){
         if(_miners[account].exist){
            ...
            return _miners[account].hashRate.mul(span);//token per second;
        } else {
            return 0;
        }
    }
    ...
    **/
    ...
    function addRemoveScammAddress(address sAddress, bool state) public onlyOperator{
        _scamAddresses[sAddress]=state;
    }
    
    function addRemoveBotAddress(address bAddress, bool state) public onlyOperator{
