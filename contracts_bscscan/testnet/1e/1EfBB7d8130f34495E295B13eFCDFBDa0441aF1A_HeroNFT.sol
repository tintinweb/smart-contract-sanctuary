...
contract HeroNFT is BaseNFT {
  ...
  mapping (uint16 => uint[6]) private strengthIndexReferences;
  mapping (uint16 => uint[6]) private strengthBonuses;
  ...
  function getStrengthIndexReferences(uint16 _tokenId) external view returns (uint, uint, uint, uint, uint, uint) {
    return (
      strengthIndexReferences[heroes[_tokenId].id][0],
      strengthIndexReferences[heroes[_tokenId].id][1],
      strengthIndexReferences[heroes[_tokenId].id][2],
      strengthIndexReferences[heroes[_tokenId].id][3],
      strengthIndexReferences[heroes[_tokenId].id][4],
      strengthIndexReferences[heroes[_tokenId].id][5]
    );
  }

  function getStrengthBonuses(uint16 _tokenId) external view returns (uint, uint, uint, uint, uint, uint) {
    return (
      strengthBonuses[heroes[_tokenId].id][0],
      strengthBonuses[heroes[_tokenId].id][1],
      strengthBonuses[heroes[_tokenId].id][2],
      strengthBonuses[heroes[_tokenId].id][3],
      strengthBonuses[heroes[_tokenId].id][4],
      strengthBonuses[heroes[_tokenId].id][5]
    );
  }
  ...
  function _initData() private {
    ...
    strengthBonuses[1] = [100, 100, 100, 100, 100, 100];
  ...
  function updateStrengthBonus(uint16 _classId, uint[6] calldata _strengthBonuses) external onlyMainAdmin {
  ...
  function addHeroClass(string calldata _race, string calldata _class, string calldata _name, uint[6] calldata _strengths, address _creator) external onlyMainAdmin {
