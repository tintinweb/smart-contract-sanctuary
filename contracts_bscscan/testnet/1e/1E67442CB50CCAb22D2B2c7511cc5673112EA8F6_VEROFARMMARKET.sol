...
contract VEROFARMMARKET is Ownable {
    ...
    uint nonce = 0;
    IERC20 public veroERC20;
    IERC721 public veroNFT;
    uint256 feeSale = 0.001 ether;
    uint256 feeMarket = 100;
    address payable public feeWallet;
    address payable public saleWallet;
    uint256 constant public PERCENTS_DIVIDER = 10000;

    constructor(IERC20 _veroERC20, address payable _feeWallet, address payable _saleWallet, IERC721 _veroNFT)  {
        veroERC20 = _veroERC20;
        feeWallet = _feeWallet; 
        saleWallet = _saleWallet;
        veroNFT = _veroNFT;
    }
    
    function setFeeSale(uint256 _fee) onlyOwner public {
        feeSale = _fee;
    }
    ...
    function setSaleWallet(address payable _wallet) onlyOwner public {
        saleWallet = _wallet;
    }
    ...
    */
    ...
    function fillOrder(uint256 _tokenId) public {
        ...
        veroERC20.transferFrom(_msgSender(), feeWallet, _feeMarket);
        veroERC20.transferFrom(
            _msgSender(),
            itemSale.owner,
    ...
    function tokenOrder(
        ...
        ItemSale storage itemSale = markets[_tokenId];
        if (_sell) {
            veroNFT.transferFrom(_msgSender(), address(this), _tokenId);
            ...
            veroNFT.transferFrom(address(this), _msgSender(), _tokenId);
