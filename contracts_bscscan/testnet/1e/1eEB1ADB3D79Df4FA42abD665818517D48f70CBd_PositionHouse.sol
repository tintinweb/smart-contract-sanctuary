...
//                }
    ...
    function getAddedMargin(IPositionManager _positionManager) public view returns (int256) {
        address _trader = _msgSender();
    ...
    function clearPosition(IPositionManager _positionManager, address _trader) public {
