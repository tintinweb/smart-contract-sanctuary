...
contract RewardsBunny is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    event setTransferFeeTX(uint256 TransferTaxFeeIsSetTo, uint256 TransferLiquidityFeeIsSetTo);
    event setBuyFeeTX(uint256 BuyTaxFeeIsSetTo, uint256 BuyLiquidityFeeIsSetTo);
    event setSellFeeTX(uint256 SellTaxFeeIsSetTo, uint256 SellLiquidityFeeIsSetTo);
    event setReinvestFeeTX(uint256 ReinvestTaxFeeIsSetTo, uint256 ReinvestLiquidityFeeIsSetTo);
    ...
    function setMinTokenBalance(uint256 minTokenBalance) external onlyOwner {
        ...
        emit setMinTokenBalanceTX(minTokenBalance);
    }
