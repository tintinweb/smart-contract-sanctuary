...
contract CACTI is Context, IERC20, Ownable {
    ...
    function _updateMarketingFee(address _sender, uint256 _marketingFee) private {
     ...
     function swapAndLiquify(uint256 token) private {
    ...
    function _updateLpFee(uint256 _lpFee) private {
        ...
        // First transfer the amount to the contract and than swapTokens to liquidity
        _transfer(_msgSender(), address(this), _lpFee);        
