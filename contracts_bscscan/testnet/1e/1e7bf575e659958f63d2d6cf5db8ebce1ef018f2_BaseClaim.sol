...
contract BaseClaim is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    address payable public charityAddress = 0x8cB0776624965652bAD5940b433F410b44921Eb4;
    ...
    string private _name = "Base.Claim";
