...
contract With_WithdrawerContract is AccessControlEnumerable, With_DAORole, I_With_WithdrawerContract{
...
contract Windmill_Trade_Manager is Math, Adressable, AccessControlEnumerable, With_DAORole, With_UpdaterContract,
    ...
    function startTrade(uint256 deployerId, uint256 nbEnergy) external returns (uint256){
        ...
        I_Windmill_Trade_Abstract trade = deployer.deployer.deployNewTrade(msg.sender, thisAddr, address(fund), address(updater), address(withdrawer));
        ...
        withdrawer.grantRole(withdrawer.TRADE_ROLE(), address(trade));
    ...
    function endTrade(uint256 tradeId) external{
        ...
        withdrawer.revokeRole(withdrawer.TRADE_ROLE(), address(data.trade));
