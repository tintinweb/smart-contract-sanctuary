...
contract PandoraToken is ERC20Capped, SafeOwnable {
    using SafeMath for uint256;

    event MinterChanged(address indexed minter, bool avaliable);

    uint256 public constant MAX_SUPPLY = 55 * 10 ** 8 * 10 ** 18;
    mapping(address => bool) public minters;

    constructor() ERC20Capped(MAX_SUPPLY) ERC20("Pandora Metaverse", "RDA") {
