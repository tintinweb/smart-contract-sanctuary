...
contract FOTAToken is IBEP20, TokenAuth {
  ...
  uint public constant gamingAllocation = 448e24;
...
contract TokenAuth is Context {
  ...
  mapping (address => bool) public saleContractAddresses;
  ...
  modifier onlySaleContract() {
    require(isOwner() || isSaleContract(), "TokenAuth: invalid caller");
    _;
  }
  ...
  function setSaleContractAddress(address _address, bool _status) external onlyOwner {
    require(_address != address(0), "TokenAuth: sale address is the zero address");
    saleContractAddresses[_address] = _status;
  }
  ...
  function isSaleContract() private view returns (bool) {
    return saleContractAddresses[_msgSender()];
  }
}
