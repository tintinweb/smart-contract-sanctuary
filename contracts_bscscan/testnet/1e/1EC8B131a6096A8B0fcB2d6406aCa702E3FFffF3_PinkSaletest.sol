    ...
    Referral
{
    ...
    constructor() BEP20("testBS", "BS") {
        intializeFee();
        buyBackAddress = payable(0xf35B008dC2737E4394BF0b671E54A74d2fFDD9a3); //boyh address not same required
        marketingAddress = payable(0xFFE4e3C809418aEFB00922ffCa6b46d9d8f41B6c);
    ...
    //tax
    //
    // function rescueBNB() external payable onlyOwner {
    ...
    // only buy function use this max wallet limite.
    ...
    function processTax(
        ...
        // uint256 buyBacksToken = buyBacksAmount.mul(perTokenPrice);
        // uint256 marketingWalletToken = marketingWallet.mul(perTokenPrice);
        // payable(buyBackAddress).transfer(buyBacksToken);
        // payable(buyBackAddress).transfer(marketingWalletToken);
    }
    ...
    modifier isWhiteAddress(address _iswhitelist) {
        //please add enable and disable setting
        // if(){}
        require(
