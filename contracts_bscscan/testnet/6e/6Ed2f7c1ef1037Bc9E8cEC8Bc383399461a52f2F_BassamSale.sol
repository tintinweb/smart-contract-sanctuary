...
contract BassamSale is ReentrancyGuard, OwnerContract {
    using SafeMath for uint256;
    ...
    constructor() {
        _rate = 100;
        _wallet = payable(0xC18b4148F069336965022e8029D7113A7ED19A65);
        _token = IERC20(0xe187ddE10EF95EF13eC8F7789703f5AB6eFf4B29);
    }
