...
contract S20 is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 69420 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "S20";
    string private _symbol = "S20";
    ...
    address public devWallet = 0xF6da32eeD61Bc3feAB01aD659209bD5dDFdE5949; //Will be set to 0x00...dead when contract is renounced
    ...
    uint256 public _maxTxAmount = 2000 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 690 * 10**9 * 10**9;
