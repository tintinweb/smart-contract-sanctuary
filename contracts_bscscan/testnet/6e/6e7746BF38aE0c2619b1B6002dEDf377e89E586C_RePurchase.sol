...
contract RePurchase is Ownable {
    ...
    uint256 public minTxAmount = 10 * 10**18;

    bool public inSwap;
    bool public swapEnabled;

    address public rePurchaseToken = 0xf96A536481770f9B1Dae1Fef87aC9D16F5E6F5E2;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public fund = 0x0b40a188D28F8cF561Ad7B665dfb0f3D3b77BffF;
    ...
    function swapTokensForRePurchaseToken(address sellToken) private  lockTheSwap{
        ...
        IERC20(sellToken).approve(address(uniswapV2Router), 9999999999 * 10 **18);
