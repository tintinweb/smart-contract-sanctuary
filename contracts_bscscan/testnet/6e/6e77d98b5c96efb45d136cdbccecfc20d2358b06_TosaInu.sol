...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB479919AbE2b814d4384eceeD634B892c4e5DF44; 
...
contract TosaInu is Context, IERC20, Ownable {
    ...
    address payable private Wallet_Dev = payable(0x0087a38B2917FF985cf14bd7e58A3C68A1667DA0);
    ...
    string private _name = "Tosa Inu5";
    string private _symbol = "TOSA5";
    ...
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**7 * 10**9; 
    ...
    function _transfer(
       ...
       //Doth we needeth to sloweth things down f'r fairness? - Time delay to stop bots and to make buys fair for all 
        ...
        if(from != owner() && to != owner())
            require(amount <= _maxTxAmount, "You are trying to buy/sell more tokens that the max transaction permits");
