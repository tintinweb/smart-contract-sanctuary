...
contract CryptoDogyNFTDrop is IERC721{
    ...
    uint256 public constant TOKEN_LIMIT = 999999;
    ...
    string internal nftName = "Binance Doggy Drop";
    string internal nftSymbol = "DoggyDrop";
    ...
    function startAirdrop() external onlyDeployer {
        require(!publicDrop);
        startTime = 1633454380;  //////////////////////////////////////////////////////////////////// sale start time by unixtimestamp
        endTime = startTime + 21 days;
        publicDrop = true;
        emit DropBegins();
    }
     ...
     * Public Drop minting.
     */
    function claimDrop() external reentrancyGuard {
        ...
        require(
            ...
            'DoggyDrop: Airdrop already claimed.'
        );
        _mint(msg.sender);
    }
    ...
    modifier onlyTokenOwner(uint256 _tokenId) {
        require(_tokenId < 999999, "doggy number is wrong");
