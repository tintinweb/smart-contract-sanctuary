...
contract FToken is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "FToken";
    string constant public symbol = "FToken";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "F: transaction fee percentage exceeds 10");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "F: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "F: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "F: transfer called from blacklisted address");
