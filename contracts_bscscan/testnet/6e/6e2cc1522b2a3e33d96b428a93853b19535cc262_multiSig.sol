...
Ability to change wallets
3 permisison wallets person - but only two need permisison 
Check balance on contract is sufficient
...
contract multiSig{
    ...
    function AskPermission(address payable Wallet_Address, uint256 Amount_of_BNB) public {

        require (Ask_Wallet == msg.sender, "Wrong Person asking!");        
