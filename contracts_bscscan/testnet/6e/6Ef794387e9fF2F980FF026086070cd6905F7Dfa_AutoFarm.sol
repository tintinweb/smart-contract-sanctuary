...
contract AutoFarm is Ownable, ReentrancyGuard {
    ...
    address public BUST = 0x6e03884333a30eE91AFda92E429fF4FD95Dc2850;
    address public BNB = 0x44Bc761E0B58Aa6727202eBd2B636DC924dA9f1a;
    ...
    function deposit(uint256 _pid, uint256 _wantAmt) public nonReentrant {
        ...
        if (user.shares > 0) {
            ...
            if (pendingBUSTD > 0) {
                ...
                safeBUSTTransfer(bankRollAddress,bankrollReward);
