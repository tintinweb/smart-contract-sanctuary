...
contract BNBRetriever is ERC20, Ownable {
    ...
    address payable public marketingWallet = 0x09439e2CAFf1212A079A6793D3FEbE2661DB22Ff;
    ...
    uint256 public _buyBNBRewardsFee = 6;
    ...
    mapping (address => bool) IsMaxTxAmountExempt;    
    ...
    event MaxTxAmountExemptUpdated(address holder, bool exempt);    
    ...
    function setIsMaxTxAmountExempt(address holder, bool exempt) external  {
        IsMaxTxAmountExempt[holder] = exempt;
        emit MaxTxAmountExemptUpdated(holder, exempt);
    }    
