...
contract BSC_Defi {
    ...
    uint256 public MARKET_EGGS_DIVISOR = 10;
    ...
    /** withdrawal tax **/
    uint256 public WITHDRAWAL_TAX = 40;
	...
	uint256 public WITHDRAW_COOLDOWN = 4 * 60 * 60; /** 6 hours  **/
    ...
    constructor(address payable _owner, address payable _project, address payable _partner, address payable _marketing, address payable _buyback) {
		require(!isContract(_owner) && !isContract(_project) && !isContract(_partner) && !isContract(_marketing) && !isContract(_buyback));
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
		...
		token_BUSD.transfer(partner, partnerFee);
    ...
    **/
    ...
    function SET_WITHDRAWAL_TAX(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
        require(value <= 50); /** Max Tax is 50% or lower **/
