...
contract DividendDistributor is IDividendDistributor {
    ...
    function getUnpaidEarnings(address shareholder) public view returns (uint256 unpaidAmount) {
        ...
        if(shares[shareholder].amount == 0){ return 0; } 
             ...
             uint256 tempdivspershare = dividendsPerShareAccuracyFactor.mul(dividendsPerShare);
    ...
    function mathInfo() external view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        return (totalShares, totalDividends, netDividends, totalDistributed, totalReinvested, totalWithdrawn, frameDividends, frameDividendsPerShare, dividendsPerShare);
    }
...
contract KojiEarth is IBEP20, Auth {
    ...
    string constant _symbol = "KOJI v1.43";
    ...
    function ViewMathInfo() external view returns (uint256 totalshares, uint256 totaldividends, uint256 netdividends, uint256 totaldistributed, uint256 totalreinvested, uint256 totalwithdrawn, uint256 framedivs, uint256 framdivspershare, uint256 dividendspershare) {
