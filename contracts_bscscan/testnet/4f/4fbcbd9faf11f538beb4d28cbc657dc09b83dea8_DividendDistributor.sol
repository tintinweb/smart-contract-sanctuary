...
contract Test is ERC20Detailed, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(distributor).call{value: amountETHReward, gas: 30000}("");
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        } else if (dividendLockTimer[recipient] < block.timestamp && isDividendLocked[recipient] && !isDividendExempt[recipient]) {
