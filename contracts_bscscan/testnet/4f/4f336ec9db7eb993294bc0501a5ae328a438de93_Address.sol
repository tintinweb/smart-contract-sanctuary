...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0xe30818f5b5bb31dda55012b6cf10e7468b67bc0285daa9304f4d6c869d6aa3c3;
...
contract KOISHIBA is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2f5C836971D4965d0c423d7bCA6C43AA4033C7eF); // Marketing Address
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x2f5C836971D4965d0c423d7bCA6C43AA4033C7eF);
    }
