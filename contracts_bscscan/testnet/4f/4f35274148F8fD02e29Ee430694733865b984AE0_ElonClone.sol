...
contract ElonClone is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3014000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ElonClone";
    ...
    uint256 public _maxTxAmount = 3014000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 3014000 * 10**6 * 10**9;
