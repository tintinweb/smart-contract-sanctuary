...
interface ERC20Metadata is ERC20 {
 ...
 contract LordeToken is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private lubovta;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name;
    string private _symbol = "LordeElon";
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWallet1 = 0x1F5afb5C491881B391ed145D3Ade814CC57F1b4a;
    address private _feeAddrWallet2 = 0x1F5afb5C491881B391ed145D3Ade814CC57F1b4a;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private _emiliq = 0x1F5afb5C491881B391ed145D3Ade814CC57F1b4a;
