...
contract TokenBankContract is Authorized, ERC20 {
  ...
  string constant _name = "TokBak44";
  string constant _symbol = "TBKX44";

  // Token supply control
  uint8 constant decimal = 18;
  uint8 constant decimalBUSD = 18;  
  uint256 constant maxSupply = 500_000_000 * (10 ** decimal);
  ...
  constructor()ERC20(_name, _symbol) {
    ...
    exemptAmountLimit[TOKENBANK_POOL] = true;
    exemptTxLimit[TOKENBANK_POOL] = true;
    exemptStaker[TOKENBANK_POOL] = true;
  ...
  function buyBackWithDecimals(uint256 decimalAmount, address destAddress) private {
    ...
    bool previousExemptFeeState = exemptFee[TOKENBANK_POOL];
    exemptFee[TOKENBANK_POOL] = true;
    ...
    exemptFee[TOKENBANK_POOL] = previousExemptFeeState;
  }
