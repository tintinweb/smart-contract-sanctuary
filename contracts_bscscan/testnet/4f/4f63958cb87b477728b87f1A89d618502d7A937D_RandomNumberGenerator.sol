...
interface IGoldenDogeLottery {
    ...
    /**
     * @notice Draw the final number, calculate reward in GDOGE per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in GDOGE token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInCake: price of a ticket in GDOGE
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public goldenDogeLottery;
     ...
     * @param _seed: seed provided by the GoldenDoge lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == goldenDogeLottery, "Only GoldenDogeLottery");
    ...
    /**
     * @notice Set the address for the GoldenDogeLottery
     * @param _goldenDogeLottery: address of the GoldenDoge lottery
     */
    function setLotteryAddress(address _goldenDogeLottery) external onlyOwner {
        goldenDogeLottery = _goldenDogeLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IGoldenDogeLottery(goldenDogeLottery).viewCurrentLotteryId();
    }
}