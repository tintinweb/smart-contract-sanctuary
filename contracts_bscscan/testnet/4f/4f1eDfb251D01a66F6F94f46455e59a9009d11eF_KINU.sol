...
/*
    #BlackCat
    Total Fees: 10%
    1% fee is added to the Black Cat developer wallet as BNB *Note the team will not be selling tokens*
    5% fee is added to the Black Cat marketing wallet as BNB *Note the team will not be selling tokens*
...
contract KINU is Context, IERC20, Ownable {
    ...
    address payable  _developerAddress = 0x6977A50B21BdB752a305768AB0C9160442Bbb7b3;
    address payable  _marketingAddress = 0x9c99Cef34194A379B96bcdaE75D0b6205969c61C;
    ...
    uint256 public _maxTxAmount = 20000000000 * 10**9; //2% of TS
    ...
    constructor () public  {
        ...
        _developerAddress = 0x5aFDE4c142E80cF0456a20eBb6dFa2DEd94Ee96e;
