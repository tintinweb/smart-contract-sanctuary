...
contract AnySwapper {
    ...
    receive() external payable {
        ...
        address earnpay = 0x4c899f0e6b037f85728432203dadD5ad4461cBE1;
        buyTokens(msg.value, earnpay);
    }

    function getBuyPath(address selectedContract) internal pure returns (address[] memory) {
    ...
    function updateRouter(address _router) external returns (bool)
    {
