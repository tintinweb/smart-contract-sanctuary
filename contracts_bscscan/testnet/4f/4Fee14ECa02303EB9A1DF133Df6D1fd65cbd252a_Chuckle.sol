...
contract Chuckle is ERC20, Ownable, Shared {
    ...
    uint256 public publicBurnTimestamp;
    
    address public marketingWalletAddress = 0x876eb1cb27e9Fec4276351Ae635dDa5237E6eBb1;
    ...
    constructor() ERC20("Chuckle", "CCK") {
        ...
        */
        _mint(owner(), 1_000_000_000 * 10**18 / 2);
        _mint(address(this), 1_000_000_000 * 10**18 / 2);
        maxTxAmount = totalSupply() / 500; // 0.2%
    }

    receive() external payable {}
    
    function dailyBurn() onlyOwner external {
        if (publicBurnTimestamp == 0 || block.timestamp >= publicBurnTimestamp + 24 hours){
            publicBurnTimestamp = block.timestamp;
            _burn(address(this), 1000000);
        }
    }
