...
/**
   ...
   1% fee auto distributed to the marketing wallet
...
contract GalaxyDogeNew is Context, IERC20, Ownable {
    ...
    uint256 numTokensSellToAddToLiquidity = 50000000 * 10**_decimals;
    ...
    string private constant _name = "Galaxy Doge";
    ...
    constructor () {
        ...
        MarketingAddress= 0x1326BC31e76EAAE687b01e310Da9929a907b4065;
    ...
    function SetNumTokensSellToAddToLiquidity(uint256 newAmount, uint8 decimal) external onlyOwner() {
    ...
    function withdraw() onlyMarketing public {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (contractTokenBalance >= numTokensSellToAddToLiquidity  && !inSwapAndLiquify && from != pancakeswapV2Pair && swapAndLiquifyEnabled) {
