...
contract Coin is IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8608dbaaEc0f1920100f75c719b39EAB1914801e);
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _maxTxAmount = 10**9 * 10**6 * 10**9;
    }
    
	/// resume buyback & anti-whale
    function afterPreSale() external onlyOwner {
        setSwapAndLiquifyEnabled(true);
        _maxTxAmount = 3 * 10**6 * 10**6 * 10**9;
    }
    ...
    function saveStuckedToken(address _token, address _to) public onlyOwner returns(bool _sent){
        require(_token != address(this), "Can't take out Coin.");
