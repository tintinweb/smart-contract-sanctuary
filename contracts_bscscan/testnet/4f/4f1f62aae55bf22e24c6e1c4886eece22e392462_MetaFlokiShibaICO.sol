...
contract MetaFlokiShibaICO is Initializable, ContextUpgradeable, OwnableUpgradeable{
    ...
    IERC20UpgradeableMetaFlokiShiba public tokenMetaFlokiShiba;
    ...
    function initialize(
        ...
        address _metaFlokiShibaContractAddress,
        ...
        require(
            _metaFlokiShibaContractAddress != address(0),
        ...
        tokenMetaFlokiShiba = IERC20UpgradeableMetaFlokiShiba(_metaFlokiShibaContractAddress);
    ...
    function buyICOByBUSD(uint256 amount) external payable {
        ...
        tokenMetaFlokiShiba.transferLockToken(sender, buyAmountToken);
    }
    ...
    function claimToken() external onlyAdmin {
        address sender = _msgSender();
        uint256 remainAmountToken = tokenMetaFlokiShiba.balanceOf(address(this));
        tokenMetaFlokiShiba.safeTransfer(sender, remainAmountToken);
    }

    function setContractToken(address contractToken) external onlyOwner {
        tokenMetaFlokiShiba = IERC20UpgradeableMetaFlokiShiba(contractToken);
    }
