...
contract DaiSwap is SafeMath {
    ...
    Token   daiContract = Token(0x8edE3Ed54CED2644416ccABDf5302EA702f0CAA6);
    Token  usdcContract = Token(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    function swapForUSDC(uint dai) public {
        ...
        if ( !daiContract.transferFrom(msg.sender, address(feeReceiver), dai)) revert();
        if (!usdcContract.transfer(msg.sender, usdc)) revert();
    }
