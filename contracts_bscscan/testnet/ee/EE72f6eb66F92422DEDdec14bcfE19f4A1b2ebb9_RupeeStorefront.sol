...
contract RupeeStorefront is ReentrancyGuard, Ownable {
  ...
  uint256 private _rupeeTokenId;
  address private _craftingInventory;
  ...
  function setRupeeTokenId(uint256 tokenId) public onlyOwner {
      _rupeeTokenId = tokenId;
  }

  function setCraftingInventory(address craftingInventory) public onlyOwner {
  ...
  function createStoreListing(
    ...
    require(price > 0, "Price must be at least 1 rupee wei");
  ...
  function purchaseStoreListing(
    ...
    IERC1155(_craftingInventory).safeTransferFrom(msg.sender, 0x000000000000000000000000000000000000dEaD, _rupeeTokenId, price, "");
