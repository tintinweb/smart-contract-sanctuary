...
contract NoNameToken is IBEP20, Ownable
{
    ...
    uint16 public constant MaxSellLockTime= 30; // 30 Seconds
	...
	uint256 private enableRandomTaxes = 1;
	uint256 private taxChangeTime = 600; // 10 Minutes in seconds.
	uint256 private hourlyCheck = 300; // 1 Hour in Seconds
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            //Random Tax Changes
            if(block.timestamp >= rTaxTimer + hourlyCheck && enableRandomTaxes == 1) {
