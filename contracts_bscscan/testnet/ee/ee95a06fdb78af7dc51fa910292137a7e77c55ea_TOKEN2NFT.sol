...
contract TOKEN2NFT is  IERC721Receiver, Ownable {
    ...
    function insertNFT(uint256[] calldata ids) external onlyOwner {
     ...
     function initialiaze(address _stakingtoken, address _nftredeemaddress, uint256 _claimtime, uint256 _redeemstarting, uint256 _redeemend, uint256 _stakingamount) public onlyOwner {
