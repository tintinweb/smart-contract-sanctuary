...
contract Manager is Ownable {
  ...
  function setPriceEgg(uint256 _priceEgg) external {
    priceEgg = _priceEgg;
  }
  
  function setPriceStone(uint256 _price) external {
    priceStone = _price;
  }

  function setFeeMarketRate(uint256 _feeMarketRate) external {
  ...
  function setDivPercent(uint256 _divPercent) external {
