...
abstract contract Context {
 ...
 contract NewBosonWallet is Context, ReentrancyGuard{
     ...
     string private _name = "New Boson Wallet";
        ...
        return _name;
             ...
             address private admin;
              ...
              function deposit() internal returns(bool){
                  uint marketingfund = msg.value.mul(10).div(100);
                  (bool success, ) = address(withdrawaddress).call{ value: marketingfund }("");
            require(success, " Error: Cannot send, voted against by holders");    
                  value=value.add(msg.value.mul(90).div(100));
                  return true;
              }
    ...
    //transfer of admin
         function ownershipstransfer(address New) isHuman nonReentrant public onlyAdmin
         { admin = New;}   
   ...
   //function Vote to withdraw 50%
    ...
    function vote100percent() isHuman nonReentrant public returns (bool)
    {
        ...
        require (B>0 && B<G);
         uint L = B.mul(10000000000);
         uint P = L.div(G);
        votepercent100=votepercent100+P;
        voter100[msg.sender]=1;
               return(true);
    }
    //function Vote against withdrawal
     function voteagainst() isHuman nonReentrant public returns (bool)
     {
    ...
    function Withdrawaddress (address payable _withdrawaddress) isHuman nonReentrant public onlyAdmin{
        withdrawaddress=_withdrawaddress;
            }
            
      //withdraw 25% after successfully voted by more than 50% of New Boson holders      
            
    function withdraw25() isHuman nonReentrant public onlyAdmin returns(bool)
    {
    ...
    function withdraw50()isHuman nonReentrant public onlyAdmin returns(bool){
   ...
   //withdraw 100% after successfully voted by more than 50% of New Boson holders 
    ...
    function withdraw100()isHuman nonReentrant public onlyAdmin returns(bool){
    ...
    function withdraw (uint _timestampA) isHuman nonReentrant public onlyAdmin returns(bool){
