...
/* ==========  Constants  ========== */
  ...
  uint32 internal constant LONG_TWAP_MIN_TIME_ELAPSED = 20 minutes; //1 days;
  uint32 internal constant LONG_TWAP_MAX_TIME_ELAPSED = 4 hours; //1.5 weeks;
...
/* ========== Views ========== */
  ...
  function getOracle() external view returns (IBisharesUniswapV2Oracle);
}
