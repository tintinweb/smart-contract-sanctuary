...
contract CarrotBSC is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 100000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "CARROT";
    ...
    address private marketingWallet = 0xA246BE2ad3A4676361f9C28e3bE097400e1eA996;
