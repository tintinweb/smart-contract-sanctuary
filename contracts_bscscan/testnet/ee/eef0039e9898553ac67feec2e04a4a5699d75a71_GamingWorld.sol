...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("HADOUKEN_Busd_Dividend_Tracker", "HADOUKEN_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 3000000000 * (10**9); //must hold 3,000,000,000+ tokens
    }
...
contract MarketingDistributor{
    ...
    uint256 public liquidityThreshhold = 1000*(10**9);
    IERC20 public BUSD = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    IERC20 public immutable HDKNToken;
 
    address  public  marketingWallet = 0x88897EF82452f44416Cc900785684BCA3ec081Ff;
...
contract GamingWorld is ERC20, Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 7777000000000000*(10**9);
    ...
    constructor() ERC20("GamingWorld", "GWM") {
