...
contract Ownable is Context {
    ...
    */
    function _transferMintership(address newMinter) internal {
        require(newMinter != address(0), "Mintable: new minter is the zero address");
        emit MintershipTransferred(_owner, newMinter);
        _minter = newMinter;
    }
...
contract AiriToken is Context, IBEP20, Ownable {
