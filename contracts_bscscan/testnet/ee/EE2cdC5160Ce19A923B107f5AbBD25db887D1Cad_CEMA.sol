...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "PURGE";
    string internal constant SYMBOL = "PGE";
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Rfi, 25, address(this) );
...
abstract contract PURGE is BaseRfiToken, Liquifier, Antiwhale {
...
contract CEMA is PURGE{

    constructor() PURGE(Env.Testnet){
