    ...
    ConfirmedOwner(msg.sender)
{
    ...
    constructor(
        ...
        _summonTypePrices[3] = 150000000000000000000;
    ...
    function setBaseCardIds(uint256 level, uint256[] memory baseCardIds)
        external
        onlyOwner
    {
    ...
    function setBaseRarities(
        ...
        _baseRarities[rarity][baseCardId] = value;
    }
    ...
    event ElemonOpened(uint256 tokenId, uint256 baseCardId, uint256[6] bodyParts, uint256 quality, uint256 class, uint256 rarity);
}
...
interface IElemonInfo {
    ...
    function setInfo(uint256 tokenId,
        uint256 baseCardId,
        uint256[6] memory bodyParts,
        uint256 quality,
        uint256 class,
        uint256 rarity,
        uint256 star) external;
