...
contract NewCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "New Coin";
    string private constant _symbol = "NewC";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForBSC(half); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
