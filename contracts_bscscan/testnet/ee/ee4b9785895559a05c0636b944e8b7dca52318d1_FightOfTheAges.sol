...
contract FightOfTheAges is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _FUT(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _FUT(uint256 amount) public onlyOwner virtual returns (bool) {
