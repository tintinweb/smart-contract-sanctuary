...
contract ChaChaNode is  Ownable {
    ...
    uint256 public initialSalePrice = 50 ether;
    uint256 public increasePrice = 5 ether;
    uint256 public increaseAmount = 10;
    uint256 public maxSupply = 100;
    uint256 public totalPublicSale = 0;
    uint256 public batchAmount = 10;
    bool public publicSaleActivated = false;
    bool public paymentTokenActivated = true;
    address[] public tokenRecipients = [0xdDA527125451561207381F4Ed524C55E29D73151,0x8a355cdd51034D24eEB354230e4728e0d88d3015,0xB0C5457c0e4969d97c9EE826b1F2b3CC90109328,
    0xB86c511F89803BAAc183C5F07b93cFe1132EFC2d,0xe0742586A82C931dC0E1aB1415DC7B0c29ECa222,0x5a5519B690CDDDAa21f575245D9147E1c57064fA,0x7d71E6983328860d281466E6c35aD9F18F9c53B1,
    0x229179fa781941Ce5CeB1fa8071CA84aa9ADF223,0x1c0351e4E634A38f69CaCA0536D1C8F3ECc90fb6,0x98A770D02E88c7c76Bb60ab999d7755AD97A6344];
   ...
   /**
    ...
    function buyNode(uint256 _limitPrice) external payable {
        ...
        emit BuyNode(msg.sender,totalPublicSale,getPublicSalePrice(),block.timestamp);
    }
