...
contract TronCrowd {
    ...
    constructor(address payable _owner, address payable _admin_fee, IERC20 _depositTokenAddress) public {
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        else require(_amount >= 1e0 && _amount <= cycles[0], "Bad amount");
        ...
        depositToken.safeTransfer(admin_fee, _amount * 3 / 100);
