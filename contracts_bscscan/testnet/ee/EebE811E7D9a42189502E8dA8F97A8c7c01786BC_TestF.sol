...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xd389468Ea139a8Ac8856c948C8AE0c3068AF84B2);
        _token = msg.sender;
    }
...
contract TestF is IBEP20, Auth {
    ...
    string constant _name = "TestF";
    string constant _symbol = "TestF";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xd389468Ea139a8Ac8856c948C8AE0c3068AF84B2);
