...
contract ShibaDashICO is Ownable {
  ...
  uint256 public constant RATE = 8333333333; // Number of tokens per Ether
  ...
  function isActive() public view returns (bool) {
    return (
        initialized == true && goalReached() == false // Goal must not already be reached
    );
  }
