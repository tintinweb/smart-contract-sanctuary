...
contract LatrinePool is Ownable, ReentrancyGuard {
    ...
    // vault address who can deposit reward tokens
    ...
    function depositReward(address _token, uint256 _amount) public nonReentrant {
        require(msg.sender == vault, "You cannot deposit reward!!");
