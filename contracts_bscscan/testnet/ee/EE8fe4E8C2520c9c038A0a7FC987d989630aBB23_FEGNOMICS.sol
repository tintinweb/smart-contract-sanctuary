...
contract FEGNOMICS is IBEP20, Auth {
	using SafeMath for uint256;
	...
	string constant _name = "Fegnomics";
	string constant _symbol = "FEGN";
  ...
  // Sauce
	...
	function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		require(isAuthorized(recipient) || !isContract(recipient), //anto-bot
