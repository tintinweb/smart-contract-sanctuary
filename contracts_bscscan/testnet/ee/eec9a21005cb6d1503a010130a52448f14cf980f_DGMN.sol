...
contract DGMN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x5c57CE95F023bcF5B92d713Ae13E94e27948C2F9); // Marketing Address
        
    address payable public teamAddress =
        payable(0x647CB2d7C340Bab050c89BF3F9c12F9a53428a50); // Team Address
    ...
    string private constant _name = "DGMN";
    string private constant _symbol = "DGMN";
