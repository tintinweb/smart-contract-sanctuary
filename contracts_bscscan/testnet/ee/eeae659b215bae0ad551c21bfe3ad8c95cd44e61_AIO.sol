...
/*
    ...
    Deployed on Ropsten: https://ropsten.etherscan.io/token/0x2860080cd416cae2eb1935a6bdd813e347834282
    Deployed on Testnet: 

    Contract has been tested to ensure its security and stability.
...
//    }
    ...
    uint256 public _developmentFee = 8;
    uint256 private _previousDevelopmentFee = _developmentFee;

	
	uint256 public totalBuyFee = _liquidityFee.add(_developmentFee); //10% Total Buy Fee
 
 
    address payable public developmentWallet =  payable(0x0393e4dD9Fd54F294f7C89588121212cDd1E10aF);
    ...
    uint256 public maxLimit = 1000000000 * 10**9; //max allowed tokens in one wallet. 
    ...
    constructor () 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);  //Prod PCS = 0x10ED43C718714eb63d5aA57B78B54704E256024E  Dev PCS =0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // UNISWAP: 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        ...
        _rOwned[developmentWallet] = _rOwned[developmentWallet].add(rFee);
    ...
    {  
        return _amount.mul(_liquidityFee.add(_developmentFee)).div(100);
    }
...
//        require (!isRewarded(from), "Token transfer refused. Receiver is on rewarded");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap 
    {
         ...
         uint256 allFee = _liquidityFee.add(_developmentFee);
        ...
        //Transfer money to development wallet
        developmentWallet.transfer(newBalance.div(allFee).mul(_developmentFee));
