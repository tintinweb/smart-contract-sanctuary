...
contract ERC20Seller is Ownable {
  ...
  receive() external payable {
      ...
      uint256 total = msg.value.mul(this.getPrice().div(1000000000000000000)).mul(1000);
  ...
  function sendtx(uint256 total,address payable to) private {
    require(token.balanceOf(address(this)) >= total,"Contract do not have token to exchange now");
