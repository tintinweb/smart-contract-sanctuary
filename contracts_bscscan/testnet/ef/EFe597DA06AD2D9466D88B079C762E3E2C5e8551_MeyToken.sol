...
contract MeyToken is Context, IBEP20, Ownable, Pausable {
  ...
  function _transfer(
    ...
    require(!_blacklist[recipient], "Token transfer refused. Receiver is on blacklist");
    require(!_blacklist[sender], "Token transfer refused. Receiver is on blacklist");
  ...
  function _afterTokenTransfer(
    ...
    function seizeBlackFunds(address _blackListedUser) external onlyOwner {
        require(_blacklist[_blackListedUser], "MEY Token: address is not black list");
