...
contract metintoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x59a395CAAA08847a8631ECe8b6e2C0756a2a4199); // Marketing Address
    ...
    string private _name = "MetinToken";
