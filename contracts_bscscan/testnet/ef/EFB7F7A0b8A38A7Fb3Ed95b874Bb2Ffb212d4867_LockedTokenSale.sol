...
contract LockedTokenSale {
    ...
    function sellLockedToken(uint plan) public payable returns(uint){
        ...
        //     ITokenVesting.LockParams memory lockParam2;
        //     lockParam2.owner = payable(msg.sender);
        //     lockParam2.amount = amount * 10 / 100;
        //     lockParam2.startEmission = 0;
        //     lockParam2.endEmission = endEmission;
        //     lockParam2.condition = address(0);
        //     lockParams[1] = lockParam2;
        // }
