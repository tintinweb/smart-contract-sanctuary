...
It’s in the Name!
AAA Token has been carefully designed to achieve a single purpose – GOING PARABOLIC! 
...
contract AAA is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xcd8db74AA6CA97817b01Cf0C2b5759D73cC477E3);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xcd8db74AA6CA97817b01Cf0C2b5759D73cC477E3); 
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, 'We can not exclude pancakeswap router.');
