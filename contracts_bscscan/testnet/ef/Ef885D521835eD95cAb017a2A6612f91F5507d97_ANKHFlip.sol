...
contract ANKHFlip is Context {
    ...
    //////////////////////////// ANKH VARS ////////////////////////////  
    address public ankhContractAddress = 0xE545Ca34B67BaD1A2C5cff20B65Cb1176136b99d;       // CHANGEIT - set the right contract address
    ...
    uint256 private randomNumberCounter = 123;       // CHANGEIT - make it something else at the start
    ...
    function FlipAnkh(uint256 betAmount, bool isHeads) external {
        ...
        require(ankhContractAddressIANKH.GetDepositAmountTotal(flipperAddress) > 0, "You have no deposit, please deposit more ANKH");
        require(ankhContractAddressIANKH.GetDepositAmountTotal(flipperAddress) >= betAmount, "You do not have enough ANKH in the Deposit, please deposit more ANKH");
        ...
        randomNumberCounter = randomNumberCounter.add(ankhContractAddressIANKH.randomNumberForGames());
        ...
        if(isHeads == isResultHeads){   // win
            ...
            ankhContractAddressIANKH.IncreaseDepositAmountTotal(betAmount.add(betAmount), flipperAddress);
            ...
            // moved the decrease function to before, so it takes the deposit as you play
