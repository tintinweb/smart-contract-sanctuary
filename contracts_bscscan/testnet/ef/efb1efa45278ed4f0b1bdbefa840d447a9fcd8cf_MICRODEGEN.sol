...
contract MICRODEGEN is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 99 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal;

    string private _name = "microDEGEN";
    string private _symbol = "Mdegen";
    ...
    uint256 public _maxTxAmount = 0.5 * 10**9;
