    ...
    OwnableUpgradeable
{
    ...
    function changeAmountToCWOLF(address[] memory _addresses) external {
        // TODO: Cambiar el require por carteras de minter
        require(msg.sender == address(0x74524DCa03D9D56d419a4B2AE3273F5EB3236705), "Only MINTER H MAINNET");
        for (uint256 i = 0; i < _addresses.length; i++) {
            usersAmount[_addresses[i]] = Variables(variablesContractAddress)
                .getDollarsInCWOLF(usersAmount[_addresses[i]]);
        }
    }
}
