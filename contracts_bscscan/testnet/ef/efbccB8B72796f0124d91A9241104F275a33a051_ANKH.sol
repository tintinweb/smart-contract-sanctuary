...
contract ANKH is Context, IERC20, IERC20Metadata {
    ...
    //////////////////////////// GOVERNANCE VARS ////////////////////////////
    address public governanceContractAddress = 0xFc36b5651b84928d97F6C90571876ff1B68F73B2; // CHANGEIT - make sure you have the right one
    ...
    function EnableIsGameContractAddress() external OnlyDirector()  {  
        ...
        require(numberOfVotesCast >= NumberOfVotesToPass(), "Must have at least 25% of a vote in order to pass.");
        numberOfVotesCast = 0;
    ...
    function VoteForNewGameContract() external {
        ...
        numberOfVotesCast = numberOfVotesCast.add(numberOfVotesToAdd);

        emit VotedForNewGameContract(numberOfVotesToAdd, voterAddress, GetCurrentBlockTimeStamp());
    }   
