...
contract TorekkoVesting is ReentrancyGuard, Ownable {
    ...
    function addVester(
        ...
        require(vestingTypes[vesting].releaseRate != 0, "Vesting: vesting type don't exist, please add a new type");
