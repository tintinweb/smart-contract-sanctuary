...
contract BattleHeroPrivateSaleWallet is Context, Whitelist{
    ...
    uint256 private _bathPrice = 13689628737268 wei;

    uint256 private _firstClaimAvailable;
    uint256 private _saleStarts;
    uint256 private _subDate;

    uint256 private constant MAX_ACCEPTED = 12 ether;
    ...
    constructor(){  
        ...
        _saleDuration              = 10 days;        
    }

    
    function startSale() public {
        require(msg.sender == _owner);
        _saleStarts = block.timestamp;
    }
    ...
    function invest() public payable onlyWhitelisted{
        ...
        require(block.timestamp >= _saleStarts && block.timestamp <= _firstClaimAvailable, "Private sale not start or ended");        
