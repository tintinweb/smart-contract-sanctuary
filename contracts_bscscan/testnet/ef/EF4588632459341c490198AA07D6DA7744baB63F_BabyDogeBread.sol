...
CakeCandy is a fair, fun CAKE rewards token from the Candy Factory launch team.
...
https://t.me/candycakebsc

Join our calls channel https://t.me/cryptocrusaderkings
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x32Bcbd0919bB5DAA9634201468Ce3E8e2fdF5Db5); //the reward token you want distributed 
...
contract BabyDogeBread is IBEP20, Auth {
    ...
    address MATIC = 0x32Bcbd0919bB5DAA9634201468Ce3E8e2fdF5Db5; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AnotherTest";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets just adjust 3. 
