...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable USDT = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //USDT
...
contract SHIBINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _buybackWalletAddress = 0x0f71b877BE22f28507700D7a6359ae4088775E4a;
    ...
    constructor() public ERC20("SHIB INU", "SHIB") {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SHIB: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 800000, "SHIB: gasForProcessing must be between 200,000 and 500,000");
...
contract SHIBDividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 60 && newClaimWait <= 86400, "SHIB_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
