...
contract PZilla is ERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 20_000_000_000_000 * 10**9;
    uint256 public maxBuyAmount = 1000_000_000_000 * 10**9;
    uint256 public maxSellAmount = 5000_000_000_000 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(7,4,2,1,1,1,1);
    Taxes public sellTaxes = Taxes(7,4,2,1,1,1,1);
    ...
    uint256 public coolDownBalance = 10000000000000 * 10**9;
   ...
   ///////////////////////
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _liquidity, uint256 _operations,  uint256 _dev,uint256 _lottery, uint256 _burn) external onlyOwner{
        buyTaxes = Taxes(_rewards, _marketing, _liquidity, _operations, _dev, _lottery, _burn);
    }

    function setSellTaxes(uint256 _rewards, uint256 _marketing, uint256 _liquidity,uint256 _operations, uint256 _dev, uint256 _lottery, uint256 _burn) external onlyOwner{
        sellTaxes = Taxes(_rewards, _marketing, _liquidity, _operations, _dev, _lottery, _burn);
    }
