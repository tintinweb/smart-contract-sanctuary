...
contract BitVision is Context, IBEP20, Ownable {
    address public liquidityBank;
    uint256  public dividendPerToken;
    uint256 private DENOMINATOR = 10_000;
    uint256 private LIQUIDITY_PERCENT = 200;
    uint256 private ALL_HOLDER_PERCENT = 300;
    uint256 private BURN_PERCENT = 300;
    ...
    constructor () Ownable(0xD90CC4995FB55361F6773061CaaCf4Cf061ae0c5) {
        require(0xD90CC4995FB55361F6773061CaaCf4Cf061ae0c5 != address(0), "BEP20: transfer from the zero address");
        require(0x2AaEF6c5F7Ca43316Ea8efF3E96373275Cf78Bad != address(0), "BEP20: transfer from the zero address");
        liquidityBank = 0x2AaEF6c5F7Ca43316Ea8efF3E96373275Cf78Bad;
        _totalSupply = 100000000000000 * 10 ** uint256(decimals());
        _name = "BitVision";
        _symbol = "BIVI";
        _balances[0xD90CC4995FB55361F6773061CaaCf4Cf061ae0c5] = _totalSupply;
        emit Transfer(address(0) , 0xD90CC4995FB55361F6773061CaaCf4Cf061ae0c5, _totalSupply);
    }
