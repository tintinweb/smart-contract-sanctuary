...
contract Holdem is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public projectAddress = payable(0x2867Dd2Be31bd0dF16EDA3920D20FCeb0DF61b5b); // Project Address
    ...
    string private _name = "Holdem";
    string private _symbol = "HOLDEM";
    ...
    uint256 public _minimumTokensBeforeSwap = 900000 * 10**9;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(projectAddress, transferredBalance.div(_liquidityFee).mul(_projectFee));
   }
    ...
    function removeAllFee() private {
        if(_reflectionFee == 0 && _liquidityFee == 0 && _projectFee == 0) return;
    ...
    function setBuybackAmountLimit(uint256 buybackAmountLimit) external onlyOwner() {
        _buybackAmountLimit = buybackAmountLimit * 10**18;
    }

     
    function setBuybackDivisor(uint256 buybackDivisor) external onlyOwner() {
