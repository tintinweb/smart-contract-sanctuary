...
//SPDX-License-Identifier: MIT
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        IBEP20 DYOR = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
        ...
        uint256 private minDistribution = 1 * (10 ** 18);
        ...
        function deposit() external payable override {
            uint256 balanceBefore = DYOR.balanceOf(address(this));
            ...
            uint256 amount = DYOR.balanceOf(address(this)).sub(balanceBefore);
        ...
        function distributeDividend(address shareholder) internal {
            ...
            if(amount > 0){
                ...
                DYOR.transfer(shareholder, amount);
    ...
    contract SEEK is IBEP20, Auth {
        using SafeMath for uint256;
    
        address DYOR = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        address DEAD = 0x000000000000000000000000000000000000dEaD;
    
        string constant _name = "SEEK";
        string constant _symbol = "SEEK";
        uint8 constant _decimals = 9;
    
        uint256 _totalSupply = 200000000000000 * (10 ** _decimals); // 200,000,000,000,000 (2TRILLION)
        uint256 public _maxTxAmount = _totalSupply / 200; // 5,000,000,000 (.5%)
        ...
        uint256 reflectionFee = 700; // 7%
        uint256 marketingFee = 100; // 1%
        uint256 TeamFee = 100; // 1%
        uint256 totalFee = 1100; // 11%
        ...
        // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 https://pancake.kiemtienonline360.com/#/swap
        ...
        function checkLaunched(address sender) private view {
        ...
        function takeFee(address sender, address receiver, uint256 amount) private returns (uint256) {
        ...
        function swapBack() private swapping {
            if(liquidityFeeAccumulator >= swapThreshold && autoLiquifyEnabled){
                ...
                uint256 amountBNBDev = amountBNB.mul(TeamFee).div(totalFee);
                ...
                (success, ) = payable(TeamFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
                if(success){ TeamFees = TeamFees.add(amountBNBDev); }
    
                emit SwapBack(amountToSwap, amountBNB);
            }
        }
    
        function shouldAutoBuyback() private view returns (bool) {
            return msg.sender != pair
            && !inSwap
            && autoBuybackEnabled
        ...
        function _buyback(uint256 amount) private authorized {
        ...
        function triggerAutoBuyback() internal  {
            ...
            if(autoBuybackAccumulator > autoBuybackCap){ autoBuybackEnabled = true; }
        }
        ...
        function setFees(
            ...
            totalFee = buybackFee.add(reflectionFee).add(marketingFee).add(TeamFee);
            ...
            emit FeesUpdated(_enabled, _liquidityFee, _buybackFee, _reflectionFee, _marketingFee, _TeamFee, _feeDenominator);
        }
        ...
        function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _TeamFeeReceiver) external authorized {
            ...
            emit FeeReceiversUpdated(_autoLiquidityReceiver, _marketingFeeReceiver, _TeamFeeReceiver);
        }
        ...
        function getAccumulatedFees() external view returns (uint256, uint256) {
            return (marketingFees, TeamFees);
        }
    
        function getAutoBuybackSettings() private view returns (bool,uint256,uint256,uint256,uint256,uint256) {
            return (
                autoBuybackEnabled,
                autoBuybackCap,
        ...
        function getFees() private view returns (bool,uint256,uint256,uint256,uint256,uint256,uint256) {
            return (
                feeEnabled,
                buybackFee,
                reflectionFee,
        ...
        event FeesUpdated(bool enabled, uint256 liquidityFee, uint256 buybackFee, uint256 reflectionFee, uint256 marketingFee, uint256 TeamFee, uint256 feeDenominator);
        event FeeReceiversUpdated(address autoLiquidityReceiver, address marketingFeeReceiver, address TeamFeeReceiver);
