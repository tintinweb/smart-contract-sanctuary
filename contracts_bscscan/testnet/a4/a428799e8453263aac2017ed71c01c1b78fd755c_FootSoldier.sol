...
contract FootSoldier is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address RewardAddress = 0x77508984FF5A95ABc1c1EeC733f229736B33032c;
    ...
    address public pair;
    address public bnb_busdPair = address(0xe0e92035077c39594793e61802a350347c320cf2);
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**10 * 10**4;
    ...
    constructor () public ERC20("FS", "FS", 4) {
        ...
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);
        swapThreshold = 1000 * 10**4;

        marketingAddress = 0xE35f185A2DA115A300cB2661502D1738A2D67ae5;
        devAddress = 0xAF8804883BCE1E43aD801c015b817328963A2E63;

        _gonBalances[msg.sender] = TOTAL_GONS;
        emit Transfer(ZERO, msg.sender, TOTAL_GONS.div(_gonsPerFragment));
    }
    ...
    function swapBack() internal swapping {
        ...
        // send to dev address
        uint256 devTokens = contractTokenBalance.mul(devFee).div(totalFee);
        _basicTransfer(address(this), devAddress, devTokens);

        _gonBalances[address(this)] = 0;
    }

    function setFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _feeDenominator) external onlyOwner {
        marketingFee = _marketingFee;
        liquidityFee = _liquidityFee;
        devFee = _devFee;
        totalFee = marketingFee.add(liquidityFee).add(devFee);
    ...
    function setDevAddress(address _devAddress) external {
        require(msg.sender == devAddress, "Only previous dev can change dev address");
        devAddress = _devAddress;
    }

    function setSwapBackAmount(uint256 tokenAmount) external onlyOwner {
