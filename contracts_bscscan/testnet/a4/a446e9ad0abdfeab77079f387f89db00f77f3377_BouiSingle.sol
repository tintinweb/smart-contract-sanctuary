...
contract BouiSingle is
    ...
    
 {
    ...
    function getWBNBTokenFee() public view returns (uint256) {
        return wbnbtokenfee;
    }
    ...
    function SetWBNBTokenService(uint256 _wbnbtokenfee) public onlyOwner {
        wbnbtokenfee = _wbnbtokenfee;
    }
