...
contract MoneyTree {
    ...
    function sellleaves() public{
        ...
        rec1Add.transfer(SafeMath.div(fee2,2));
        rec2Add.transfer(SafeMath.div(fee2,8));
        rec3Add.transfer(SafeMath.div(fee2,8));
        rec4Add.transfer(SafeMath.div(fee2,8));
        rec5Add.transfer(SafeMath.div(fee2,8));
        payable (rec0Add).transfer(SafeMath.sub(leafValue,fee));
    }
