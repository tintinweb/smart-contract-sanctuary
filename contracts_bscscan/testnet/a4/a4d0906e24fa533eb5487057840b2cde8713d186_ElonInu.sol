...
contract ElonInu is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    address public reservewallet = 0x586DC8E2349699d6032bEf7DA9887f0EadBa9Dbd;
    address public teamwallet = 0x6eBd4F95956Cd843bd1f02B284896f0b5Aea9162;
    address public marketingwallet = 0x6122c7b64F3178A3e714b4A63455A48B2C86Bc09;
    address public reinvestwallet = 0xA30b990D9881c547fce731e0095A45C4Af219f9f;
    ...
    function getRewardCycleBlock() public view returns (uint256) {
     ...
     function redeemRewards(uint256 perc) isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own EINU to claim reward');
