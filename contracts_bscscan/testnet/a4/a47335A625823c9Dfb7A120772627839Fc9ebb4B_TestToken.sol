...
contract TestToken is Context, IBEP20, Ownable {
    ...
    function _getValues(uint256 tAmount) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tBurn, uint256 currentRate) public pure returns (uint256, uint256, uint256, uint256) {
