...
contract Marketplace is Pausable, AccessControl {
    ...
    function addSupportedNFT(address _nftAddress) public onlyRole(MARKET_CONFIG) {
        supportedNFT[_nftAddress] = true;
    }

    function removeSupportedNFT(address _nftAddress) public onlyRole(MARKET_CONFIG) {
