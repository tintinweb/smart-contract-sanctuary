...
contract TitanTest is Context, IERC20, Ownable {
    ...
    string private _name = "Titan Test";
    string private _symbol = "TTF";
    ...
    function setWalletLocked(address wallet) public onlyOwner{
    ...
    function setWalletUnLocked(address wallet) public onlyOwner{
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
    ...
    function _takeBurnFee(uint256 tBurn) private{
        uint256 currentRate = _getRate();
        uint256 rBurn = tBurn.mul(currentRate);
        _rOwned[address(0x0000000000000000000000000000000000000000)] = _rOwned[address(0x0000000000000000000000000000000000000000)].add(rBurn);
        if(_isExcluded[address(this)])
            _tOwned[address(0x0000000000000000000000000000000000000000)] = _tOwned[address(0x0000000000000000000000000000000000000000)].add(tBurn);
        //_rOwned[address(sender)] = _rOwned[address(sender)].sub(rBurn);
