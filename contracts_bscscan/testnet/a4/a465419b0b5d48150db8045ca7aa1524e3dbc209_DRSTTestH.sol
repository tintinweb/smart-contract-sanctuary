...
contract DRSTTestH is ERC20, Ownable, Charitable, Marketable {
    ...
    event AmountRecievedInCharityWallet(uint256 tokens, uint256 bscReceived);

    event AmountRecievedInMarketingWallet(uint256 tokens, uint256 bscReceived);
    ...
    constructor() public ERC20("DRSTTestH", "DRSTTestH") {
    ...
    function sendToCharityWallet(uint256 tokens) private {
        ...
        uint256 initialBalance = marketingWalletAddress().balance;
        ...
        uint256 bscReceived = marketingWalletAddress().balance - initialBalance;
        emit AmountRecievedInCharityWallet(tokens,bscReceived);
    }
    ...
    function sendToMarketingWallet(uint256 tokens) private {
        ...
        uint256 bscReceived = marketingWalletAddress().balance - initialBalance;
        emit AmountRecievedInMarketingWallet(tokens,bscReceived);
    }
