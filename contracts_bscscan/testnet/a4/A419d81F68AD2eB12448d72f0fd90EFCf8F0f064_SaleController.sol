...
contract SaleController is Ownable {
    ...
    function createSale(
        ...
        sale.init(_token, _tokenPrice, _softCap, _hardCap, _minContribution, _maxContribution, _liquidityPercentage, _listingPrice, _startTime, _endTime, _liquidityLockUntilTime);
    ...
    function routerAll() external view returns (SwapRouter[] memory) {
        return routers;
    }
}
