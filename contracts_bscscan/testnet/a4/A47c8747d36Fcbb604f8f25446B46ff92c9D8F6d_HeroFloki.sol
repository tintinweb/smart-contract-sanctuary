...
contract HeroFloki is ERC20, Ownable {
    ...
    constructor(
        ...
        tracker = new MultiDividendTracker(dividendCurrencies, 0);
...
contract MultiDividendTracker is Ownable {
    ...
    function withdrawAllDividendsOf(address account) public {
        for (uint8 i = 0; i < supportedCurrencies.length; i++) {
            withdrawDividendOf(supportedCurrencies[i], account);
        }
    }
    ...
    function withdrawDividendOf(address currency, address account) public {
    ...
    function _setBalance(address account, uint256 newBalance) internal {
        if (newBalance != balances[account]) {
            /*console.log("Setting balance of %s at %s (now %s)", account, newBalance, balances[account]);
            console.log("Total balance before is %s", totalBalance);
            for (uint8 i = 0; i < supportedCurrencies.length; i++) {
                console.log("Dividends before are %s", dividendOf(account, supportedCurrencies[i]));
            }*/
            ...
            /*for (uint8 i = 0; i < supportedCurrencies.length; i++) {
                console.log("Dividends after are %s", dividendOf(account, supportedCurrencies[i]));
            }
            console.log("Total balance after is %s", totalBalance);
            console.log("----------");*/
        }
    }
}
