...
import "./HeroInfinityToken.sol";

contract TokenGovernor is Context, Ownable {
  HeroInfinityToken public token;
  ...
  constructor(address payable _tokenAddress) {
    token = HeroInfinityToken(_tokenAddress);
  }
  ...
  function proposalValidPeriod() public pure returns (uint256) {
  ...
  function propose(
    ...
    require(
      proposal.proposalExpiresAt == 0,
      "Governor: proposal already exists"
    );

    proposal.proposalExpiresAt = block.timestamp + proposalValidPeriod();
  ...
  function execute(
    ...
    require(
      proposal.canceled == false &&
        ...
        proposal.proposalExpiresAt > block.timestamp,
  ...
  modifier onlyOperator() {
    require(_msgSender() == operator, "Covernor: not operator");
    _;
  }
}
