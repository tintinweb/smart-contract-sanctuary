...
contract DRCRebaser {
    ...
    constructor(address DRCAddress_, address DRCBUSDPair_) public {
        ...
        pancakeDRCBUSDPair = DRCBUSDPair_;
        DRCAddress = DRCAddress_;
    ...
    function getPrice() public view returns (uint256) {
        ...
        if (DRCPrice == 0) {
            return DRCReserve.div(BUSDReserve);
        } else {
            return DRCPrice;
        }
    }
    ...
    function setInitialRate(uint256 initialRate_) external onlyGov {
        require(initialRate_ > 0);
