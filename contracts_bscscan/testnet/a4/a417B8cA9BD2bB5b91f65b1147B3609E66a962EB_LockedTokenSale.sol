...
contract LockedTokenSale {
    ...
    constructor(address _pancakeRouter, address _tokenVesting, address _ref, address _Token) {
        pancakeRouter = IPancakeRouter01(pancakeRouter); // 0x9ac64cc6e4415144c455bd8e4837fea55603e5c3
        tokenVesting = ITokenVesting(_tokenVesting); // 0xfAeC4775FE1f391C48F0e219a14C853a2003843f
    ...
    function sellLockedToken(uint plan) public payable returns(uint){
        ...
        uint256 endEmission = block.timestamp + 10;
    ...
    function approve() external {
        IERC20(token).approve(address(tokenVesting), 1e15);
    }
}
