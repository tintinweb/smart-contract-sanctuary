...
contract MetaStarAuction is Pausable, Ownable, ReentrancyGuard {
    ...
    IMETABurnable public immutable META_BURNABLE;
    ...
    // FIXME: only for test
    uint256[] nftPriceFirst = [15, 20, 25, 30];
    ...
    constructor(
        ...
        META = IERC20(_META);
        META_BURNABLE = IMETABurnable(address(_META));
    ...
    function claim(uint256 _period) external nonReentrant {
        ...
        if (isWinner(_period, account)) {
            ...
            META_BURNABLE.burn(_averagePrice.mul(80).div(100));
    ...
    function levelUp(uint256 tokenId) public nonReentrant whenNotPaused {
        require(
