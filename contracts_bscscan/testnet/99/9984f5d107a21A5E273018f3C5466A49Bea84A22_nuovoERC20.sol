...
contract nuovoERC20 is ERC20Upgradeable, OwnerBuilder, OwnableUpgradeable{

    event InitFatta(address mio);
    address public cagacazzo;

    function init(TokenStruct memory tokenStruct) public override {

        __Ownable_init();
        //__ERC20_init(tokenStruct.tsName , tokenStruct.tsSym);
        //__Ownable_init();
        cagacazzo = tokenStruct.tsOwnerAddress;
        emit InitFatta(msg.sender);
    }
...
interface OwnerBuilder {
    ...
    function init(TokenStruct memory) external;
