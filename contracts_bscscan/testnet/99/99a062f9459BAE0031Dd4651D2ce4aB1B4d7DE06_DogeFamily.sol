...
contract DogeFamily is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2899c1f472915AD7956AfEE790465305C0A63AcD); // Marketing Address
    ...
    uint256 public _maxTxAmount = 300000000000 * 10**6 * 10**9;
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 10;
        _maxTxAmount = 3000000000000 * 10**6 * 10**9;
    }
