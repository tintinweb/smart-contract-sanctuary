...
contract NFTStorePokerFI is ReentrancyGuard, Ownable , WidgetInterface{
  ...
  function createMarketItem( 
    ...
    auctionEndTime = block.timestamp + (auctionEndTime * 1 hours);
        ...
        for (uint i = 0; i < itemCount; i++) {
          ...
          /*registrar carteiras para essa NFt tokenId eterno só a primeira vez*/
  ...
  function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant {
    ...
    //AQUI VAMOS VERIFICAR SE EH UM ITEM "BEAHAVIOR" = 0 SEIGNIFICA Q EH UM MODELO
