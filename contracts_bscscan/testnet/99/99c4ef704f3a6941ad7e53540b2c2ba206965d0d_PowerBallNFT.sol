...
contract PowerBallNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
/*      pote de 5 bnb en total, 
        precio = 0.1 bnb
        50% va a un wallet que se selecciona random al final,   
        registrar si los % entre cada mint estan correctos
        (restar fees calcular wei)
