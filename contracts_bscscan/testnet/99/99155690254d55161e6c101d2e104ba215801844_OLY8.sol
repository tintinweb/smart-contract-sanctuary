...
//    }
    ...
    function getFloppaFee() public view returns (uint256) {
        ...
        return totalFee > 0 ? totalFee.add(feeIncrease.mul(remainingTime).div(feeMultipliersDuration)) : 0;
    }
    ...
    function getBingusFee() public view returns (uint256) {
        ...
        return totalFee > 0 ? totalFee.sub(feeDecrease.mul(remainingTime).div(feeMultipliersDuration)) : 0;
    }
