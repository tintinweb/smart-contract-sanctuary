...
contract ExoticMonsterController is Ownable {
    ...
    function inPool(uint256 poolid,uint256 amount,uint256 heroId) public {
        ...
        // newPool.myPoolId = users[msg.sender].poolIds;
    ...
    function outPool(uint256 poolId) public {
        ...
        //解锁加入矿池的英雄
        userHeros[msg.sender][userPools[msg.sender][poolId].myPoolId].isPooled = false;
    ...
    function _getHero() internal virtual returns (uint256) {
        ...
        uint256 number =  uint256(keccak256(abi.encodePacked(block.timestamp, block.difficulty,msg.sender))) % 10000 + 3000;
