...
contract OlympusBondDepository is Ownable {
    ...
    address public immutable OX; // token given as payment for bond
    address public immutable principle; // token used to create bond
    address public immutable treasury; // mints OX when receives principle
    ...
    struct Bond {
        uint payout; // OX remaining to be paid
    ...
    function deposit( 
        ...
        require( payout >= 10000000, "Bond too small" ); // must be > 0.01 OX ( underflow protection )
        ...
        /**
            ...
            approved and
            deposited into the treasury, returning (_amount - profit) OX
         */
    ...
    function stakeOrSend( address _recipient, bool _stake, uint _amount ) internal returns ( uint ) {
        if ( !_stake ) { // if user does not want to stake
            IERC20( OX ).transfer( _recipient, _amount ); // send payout
    ...
    /**
     *  @notice calculate current ratio of debt to OX supply
    ...
    /**
     *  @notice calculate amount of OX available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or OX) to the DAO
     *  @return bool
     */
