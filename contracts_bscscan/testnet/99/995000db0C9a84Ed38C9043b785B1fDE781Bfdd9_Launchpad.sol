...
import './DataStorageZkey.sol';

contract Access is DataStorageZkey {
...
contract DataStorageZkey {

	uint256 public PROJECT_FEE = 0 ether;
	uint256 public CLAIM_FEE = 0 ether;
	uint256 public TOTAL_SLOT = 21000;

  	uint256 public wasSale;
	uint256 public quantityToken = 1000000000000000000;
	uint256 public totalSupply= 21000000000000000000000;
	uint256 public minInvest = 1000*10**18;
	uint256 public maxInvest = 1000*10**18;
	uint256 public totalRegister;
	uint256 public totalClaim = 0;
	uint256 public TIME_STEP = 30 days;
	uint256 public LIMIT_CLAIMED = 1;
...
contract Launchpad is Ownable, DataStorageZkey, Access, Events {
