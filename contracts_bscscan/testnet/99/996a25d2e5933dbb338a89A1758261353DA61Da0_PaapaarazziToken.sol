...
contract PaapaarazziToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x343961e206615eE233b2E31Dc6cDeCF3517aBF6D); // Marketing Address
    address payable public charityAddress = payable(0x343961e206615eE233b2E31Dc6cDeCF3517aBF6D); // Charity/Dev Address
    ...
    string private _name = "PAPAARAAZI";
    string private _symbol = "PPRZ";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 100000000000000000000; // 300,000,000; token will be given on airdrop
    ...
    uint256 private salePrice = 50000;// 0.01*100000000000=10,000,000,000 token for 0.01 bnb (set as per requirements)
