...
contract cycleBurn is Ownable {
    ...
    */
    ...
    /** 
     * @dev Calls failsafe() function to withdraw .
     * @param _amount transfer to owner.
    */
    function failsafe(uint _amount) public onlyOwner {
        require(IERC20(DXB).balanceOf(address(this)) >= _amount, "insufficient fund to transfer");
        
        IERC20(DXB).transfer(owner(), _amount);
        cycleToBurnSupply -= _amount;
    }
