...
contract DDETH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(address(0x726E50288CCfa246a9344BE00a3559E9b507bEC0)); //marketing wallet
    ...
    constructor() ERC20("Daddy Ethereum", "DDETH") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("DDETH_Dividen_Tracker", "DDETH_Dividend_Tracker")
    {
        claimWait = 3600;
