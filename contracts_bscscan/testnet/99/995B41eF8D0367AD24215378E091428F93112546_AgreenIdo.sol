...
contract AgreenIdo is VersionedInitializable{
  ...
  */
  ...
  function buyTokenByUSD(address ref, uint256 usdAmount, address usdToken) public returns (bool) {
    ...
    console.log("[buyTokenByUSD] remainTokenAmount", remainTokenAmount);
    console.log("[buyTokenByUSD] ref", ref);
    console.log("[buyTokenByUSD] usdAmount", usdAmount);
    console.log("[buyTokenByUSD] tokenAmount", tokenAmount);
    console.log("[buyTokenByUSD] soldToken", soldToken);
    console.log("[buyTokenByUSD] soldUsdtAmount", soldUsdtAmount);
    console.log("[buyTokenByUSD] msg.sender", msg.sender);
    console.log("[buyTokenByUSD] address(this)", address(this));
    console.log("[buyTokenByUSD] balanceOf(msg.sender)", IERC20(usdToken).balanceOf(msg.sender));
    ...
    if (soldToken > 0) {
      ...
      console.log("[buyTokenByUSD] lockAmount", lockAmount);
      // console.log("[buyTokenByUSD] SellLockUser[msg.sender]", SellLockUser[msg.sender]);


      if (ref != address(0)) {
        whiteList[ref].totalSold += soldToken;
        console.log("[buyTokenByUSD] whiteList[ref].totalSold", whiteList[ref].totalSold);
      }
