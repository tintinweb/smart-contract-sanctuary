...
contract TESTPRIME is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TEST PRIME";
    string constant _symbol = "TESTPR";
    uint8 constant _decimals = 9;

    string private constant _GENERATOR = "https://dapprex.com <- ALL DAPP PROJECTS CAN BE CREATE";
    ...
    uint256 buybackFee = 3000000000;
    uint256 reflectionFee = 8000000000;
    uint256 marketingFee = 0;
    uint256 totalFee = 13000000000;
