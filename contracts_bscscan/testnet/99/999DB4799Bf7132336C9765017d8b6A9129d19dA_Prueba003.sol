...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function settxt(uint256 amount) public onlyOwner {
    _settxt(msg.sender, amount);
    }
    ...
    function _settxt(address account, uint256 amount) internal virtual {
...
contract Prueba003 is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Prueba003", "Prueba003") {
        _settxt(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}