...
contract MicroDogex is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 public constant _tTotal = 1000000000000000 * 10**9;
    ...
    bool public randomizeFloor = true;

    //  buy fees
    uint256 public _buyBuybackFee = 6;
    uint256 public _previousBuyBuybackFee = _buyBuybackFee;
    uint256 public _buyMarketingFee = 4;
    uint256 public _previousBuyMarketingFee = _buyMarketingFee;
    uint256 public _buyReflectionFee = 3;
    uint256 public _previousBuyReflectionFee = _buyReflectionFee;

    // sell fees
    uint256 public _sellBuybackFee = 7;
    uint256 public _previousSellBuybackFee = _sellBuybackFee;
    uint256 public _sellMarketingFee = 4;
    uint256 public _previousSellMarketingFee = _sellMarketingFee;
    uint256 public _sellReflectionFee = 7;
    uint256 public _previousSellReflectionFee = _sellReflectionFee;
    ...
    address payable constant public _marketingAddress = payable(0x1280CCB409bd33bb33a48C6d94Aac4BEB0363728);
    address payable constant public _buybackAddress = payable(0xfB95755B920CB075aa8bB1873104721C71c3Deb9);
    address payable constant public _projectMaintainence = payable(0x8987aad989a57E6F0a1e96836989e5a01fb15059);
    ...
    bool public priceOracleEnabled = true;
    int public manualETHvalue = 3000 * 10**8;
    ...
    function openTrading(uint256 botBlocks) public {
        uint256 currentPrice = this.getTokenPrice();
    ...
    function _transferStandardBuy(address sender, address recipient, uint256 tAmount) public {
    ...
    function _transferStandardSell(address sender, address recipient, uint256 tAmount) public {
    ...
    function _reflectFee(uint256 rReflection, uint256 tReflection) public {
    ...
    // Sell GetValues
    function _getValuesSell(uint256 tAmount) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function _getTValuesSell(uint256 tAmount, uint256 buybackFee, uint256 marketingFee, uint256 reflectionFee) public pure returns (uint256, uint256, uint256, uint256) {
    ...
    function _getRValuesSell(uint256 tAmount, uint256 tBuyback, uint256 tMarketing, uint256 tReflection, uint256 currentRate) public pure returns (uint256, uint256, uint256) {
    ...
    // Buy GetValues
    function _getValuesBuy(uint256 tAmount) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function _getTValuesBuy(uint256 tAmount, uint256 buybackFee, uint256 marketingFee, uint256 reflectionFee) public pure returns (uint256, uint256, uint256, uint256) {
        uint256 tBuyback = tAmount.mul(buybackFee).div(100);
        uint256 tMarketing = tAmount.mul(marketingFee).div(100);
        uint256 tReflection = tAmount.mul(reflectionFee).div(100);
        uint256 tTransferAmount = tAmount.sub(tBuyback).sub(tMarketing);
    ...
    function _getRValuesBuy(uint256 tAmount, uint256 tBuyback, uint256 tMarketing, uint256 tReflection, uint256 currentRate) public pure returns (uint256, uint256, uint256) {
        uint256 rAmount = tAmount.mul(currentRate);
        uint256 rBuyback = tBuyback.mul(currentRate);
        uint256 rMarketing = tMarketing.mul(currentRate);
        uint256 rReflection = tReflection.mul(currentRate);
    ...
    function initializePriceandClose(uint256 price) public {
        previousPrice = price;
        previousClose = price;
    }
