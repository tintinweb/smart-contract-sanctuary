...
import "./BlocksRewardsManagerExclusive.sol";
...
contract BlocksSpaceExclusive is Ownable {
    struct Block {
        uint256 price;
        address owner;
    ...
    BlocksRewardsManagerExclusive public rewardsPool;
    uint256 public blockClaimPrice = 1e14; // 0.0001 BNB
    ...
    constructor(address rewardsPoolContract_, bool hasLogo) {
        rewardsPool = BlocksRewardsManagerExclusive(rewardsPoolContract_);
        if(hasLogo){
...
contract BlocksRewardsManagerExclusive is Ownable {
    // Info of each user.
    struct UserInfo {
