...
contract SepgodToken is Context, IBEP20 {
  ...
  string private constant _symbol = "TestV6";
  string private constant _name = "TestV6";
  ...
  function getAllTaxesAmount() internal view returns (uint256) {
    return (_liquidityTax + _burnTax + _developmentTax + _prizeTax);
  }
  ...
  function setLiquidityTax(uint8 value) external onlyOwner {
    require(getAllTaxesAmount() <= 12, "Liquidity tax is too high");
    _liquidityTax = value;
  }
  ...
  function setDevelopmentTax(uint8 value) external onlyOwner {
    require(getAllTaxesAmount() <= 12, "Development tax is too high");
  ...
  function setBurnTax(uint8 value) external onlyOwner {
    require(getAllTaxesAmount() <= 12, "Burn tax is too high");
    _burnTax = value;
  }
  ...
  function setPrizeTax(uint8 value) external onlyOwner {
    require(getAllTaxesAmount() <= 12, "Prize tax is too high");
    _prizeTax = value;
  }
  ...
  function getTiketsQuantity() external view returns (uint256)  { 
