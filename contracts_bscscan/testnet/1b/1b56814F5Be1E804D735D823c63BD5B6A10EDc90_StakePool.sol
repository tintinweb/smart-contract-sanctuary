...
// variable definitions
    ...
    // EXPERIMENTAL !!  
     ...
     uint public timeLock; //---> create a setter to be altered after deployment

    // control buttons for the admimn
    bool stakeEnabled;   // set by owner, turns off/on stake process
    bool withdrawEnabled;   // set by owner, turns off/on withdraw process
...
// setters 
    ...
    function setEnableStake(bool _flag) external onlyOwner {
        // do some checks 
        stakeEnabled = _flag;
    }

    function setEnableWithdraw(bool _flag) external onlyOwner {
        // do some checks 
        withdrawEnabled = _flag;
    }
