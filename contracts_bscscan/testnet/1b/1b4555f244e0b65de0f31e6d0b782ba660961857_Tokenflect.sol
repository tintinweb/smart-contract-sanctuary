...
// 15%~ Slippage required: 8% ADA Auto-reflect /5% Dev & Marketing Wallet/2% Auto-LP
    ...
    contract Tokenflect is IBEP20, Ownable {
        ...
        address payable public _partWalletAddress      = payable(0xbFc9B7F6352C4f684c93d09e049b006f203DBbF5); // Wallet Partenaires "générique" (quand nous n'avons pas add influenceur un acheteur pour le link à un partenaire, pour les 1,5% partenaires en BUSD et 1,5% partenaires en token)
        ...
        function prepForLaunch() public onlyOwner {
            ...
            address _pair = getPair(address(this), BUSD);
            
            if(!automatedMarketMakerPairs[_pair]){
                automatedMarketMakerPairs[uniswapV2Pair] = true;
            }
        ...
        function getPair(address tokenA, address tokenB) public view returns (address) {
            return IUniswapV2Factory(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc).getPair(tokenA, tokenB);
        }
        ...
        function setRouterAddress(address router) public onlyOwner() {
            ...
            address newPair = IUniswapV2Factory(newPancakeSwapRouter.factory()).getPair(address(this), BUSD);
            if(newPair == address(0)){
                newPair = IUniswapV2Factory(newPancakeSwapRouter.factory()).createPair(address(this), BUSD);
            }
