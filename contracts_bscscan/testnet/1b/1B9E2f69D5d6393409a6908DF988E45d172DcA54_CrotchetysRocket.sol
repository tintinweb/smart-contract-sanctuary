...
contract CrotchetysRocket is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MARK = 0x3379CefC1ae2535b0645D20ce25f0f026Cb7A8A5;

    string constant _name = "THESHITBITCH";    
    string constant _symbol = "SHITBITCH";
