...
contract Token is Ownable, IBEP20 {
    ...
    address private _ownerAddress = payable(0x543918706eae93dC22331527d22910a0A18c9DE7);

    // Address of  Investment Fund
    address private _InvestmentFund = payable(0x543918706eae93dC22331527d22910a0A18c9DE7);

    // Address of marketing and dev
    address private _marketingDev = payable(0x543918706eae93dC22331527d22910a0A18c9DE7);

    // Address of  AR Game
    address private _ArGame = payable(0x543918706eae93dC22331527d22910a0A18c9DE7);

    // Address of Service for sale
    address private _service = payable(0x543918706eae93dC22331527d22910a0A18c9DE7);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tokenTotal = 1 * 500000000000000*10 * 10;
    uint256 private _reflectTotal = (MAX - (MAX % _tokenTotal));
    uint256 private _tokenFeeTotal;

    string public _name = "TEST50";
    string public _symbol = "T50";
