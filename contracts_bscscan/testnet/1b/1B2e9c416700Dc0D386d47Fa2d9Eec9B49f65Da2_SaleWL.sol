...
contract SaleWL {
    ...
    IERC20 constant public token = IERC20(0xBD4302865A013ac11aB2B827204738F0Ce6ef2Fd);// Token MetaPad
    IERC20 constant public busd = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);// Token BUSD
    ...
    function invest(uint256 _amount) public {
        ...
        uint256 tokens = _amount.mul(_RATE);
