...
contract UFOMO is Context, IERC20, Ownable {
    ...
    string private _name = "UFOMO";
    string private _symbol = "UFO";
    ...
    uint256[5] public feeFomo = [8, 13, 18, 23, 28];
    ...
    function getHealthLevel() private view returns(uint256) {
        ...
        if (bal <= gameSettings.level1balance * 10**15) {
            return 4;
        } else if (bal <= gameSettings.level2balance * 10**15) {
            return 3;
        } else if (bal <= gameSettings.level3balance * 10**15) {
            return 2;
        } else if (bal <= gameSettings.level4balance * 10**15) {
            return 1;
        }
