...
contract PoolData is Ownable {
    ...
    event LogDelegatecall(bool, bytes);
    ...
    function addPool(IERC20 _lpToken, uint256 _lockBlockCount, uint256 _depositLimit, uint256 _firstDepositLimit) public onlyOwner {
        (bool success, bytes memory data) = serviceAddress.delegatecall(abi.encodeWithSignature("addPoolService(IERC20,uint256,uint256,uint256)", _lpToken, _lockBlockCount, _depositLimit, _firstDepositLimit));
        emit LogDelegatecall(success, data);
    ...
    function setPool(uint256 _poolId, uint256 _minDepositLimit, uint256 _minFirstDepositLimit) public onlyOwner {
        (bool success, bytes memory data) = serviceAddress.delegatecall(abi.encodeWithSignature("setPoolService(uint256,uint256,uint256)", _poolId, _minDepositLimit, _minFirstDepositLimit));
        emit LogDelegatecall(success, data);
