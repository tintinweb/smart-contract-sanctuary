...
/* ==========  Constants  ========== */
  ...
  uint32 internal constant LONG_TWAP_MIN_TIME_ELAPSED = 1 hours; //1 days;
  uint32 internal constant LONG_TWAP_MAX_TIME_ELAPSED = 8 hours; //1.5 weeks;

  // TWAP parameters for assessing current price
  uint32 internal constant SHORT_TWAP_MIN_TIME_ELAPSED = 20 minutes; //20 minutes;
  uint32 internal constant SHORT_TWAP_MAX_TIME_ELAPSED = 4 hours; //2 days;
...
/* ==========  Constants  ========== */
  ...
  uint256 internal constant POOL_REWEIGH_DELAY = 1 days; //1 weeks;
