...
//  IGDP public gdpToken = IGDP(0xe724279dCB071c3996A1D72dEFCF7124C3C45082);
  ...
  bytes32 public rootHash = 0xaa584e16986dad8a42a546945d6965a6547b03f8e07462eee64bd33f67dbc7e0;
  ...
  function claim(uint _index, uint _amount, bytes32[] _path) public {
    ...
    bytes32 hash = keccak256(abi.encodePacked(msg.sender, _amount, _index));
  ...
  function getHash(address _address, uint _amount) public pure returns (bytes32) {
    return keccak256(abi.encodePacked(_address, _amount));
  }

  function checkValid(address _address, uint _amount, uint _index, bytes32[] _path) public view returns (bool) {
    bytes32 hash = keccak256(abi.encodePacked(_address, _amount, _index));
