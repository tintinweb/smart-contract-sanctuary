...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
...
contract flokiETH is ERC20, Ownable {
    ...
    // address private _devWallet = address(0x320a019E5659fA7E07739eAD16CaeBa2B7bC7C6a);
    ...
    uint256 public maxBuyTranscationAmount = 10000 * (10**18); // 1% of total supply
    uint256 public maxSellTransactionAmount = 10000 * (10**18); // 1% of total supply
    ...
    uint256 public immutable tradingEnabledTimestamp = 1626933500;
    ...
    constructor() public ERC20("GetLTC", "GetLTC") {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "flokiETH: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "flokiETH: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "flokiETH: gasForProcessing must be between 200,000 and 500,000");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "flokiETHBSC: Account is already the value of 'excluded'");
...
contract flokiETHDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("flokiETH_Dividend_Tracker", "flokiETH_Dividend_Tracker") {
    	claimWait = 3600;
