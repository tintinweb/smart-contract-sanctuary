...
contract LCRtoken is ERC20 {
    ...
    constructor() ERC20("Lucrar", "LCR")
    {
		...
		intervalBlocksYear = 14400; // testes 12 minutos
    ...
    function getStakeInfo(address account) public view returns (uint256 stakedBalance, uint256 interest)
	{		
		...
		{
			interestToPay = stakeBalances[account] * (1 / stakeInterest);			
