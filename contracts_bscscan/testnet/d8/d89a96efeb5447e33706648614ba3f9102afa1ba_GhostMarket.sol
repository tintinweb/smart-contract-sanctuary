...
contract GhostMarket is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    function claimRewards() external nonReentrant {
        ...
        balance += getReflectionMintBalance(msg.sender)*mintCount;
 ...
 function getReflectionMintBalance(address senderAddress) public view returns (uint256){
      return totalMintDividend - lastMintDividendAt[senderAddress];
    }
