...
contract Store is Ownable, ReentrancyGuard {
    ...
    constructor(MintableToken _mintableToken, address _marketplaceToken) {
    ...
    function listing(uint256 _nftId, uint256 _price) public onlyOwner {
        ...
        mintableToken.transferFrom(owner(), address(this), _nftId);
    ...
    function unlisting(uint256 _nftId) public onlyOwner {
        ...
        mintableToken.transferFrom(address(this), owner(), _nftId);
...
contract MintableToken is ERC721URIStorage, Ownable {
