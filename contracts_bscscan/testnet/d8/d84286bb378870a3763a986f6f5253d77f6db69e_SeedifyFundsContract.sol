...
contract SeedifyFundsContract is Ownable {
  ...
  uint256 _tierSevenValue,uint256 _tierEightValue ,uint256 _tierNineValue    ) public {
    maxCap = _maxCap;
    ...
    totalparticipants = totalUserInTierOne + totalUserInTierTwo + totalUserInTierThree +totalUserInTierFour + totalUserInTierFive +
                        totalUserInTierSix + totalUserInTierSeven + totalUserInTierEight + totalUserInTierNine;
  }
