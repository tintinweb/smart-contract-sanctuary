 ...
 * Auto Burn liquidity
 * 8% Cake reflection
 * 4% Auto Burn Liquidity
 * 4% Going To Marketing  
*/
...
contract GalaxyCakeSpace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Galaxy Cake Space";
    string constant _symbol = "GC";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 10;
