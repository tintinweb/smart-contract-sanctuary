...
contract AirSaleBNB {
        ...
        uint256 public _BNBreffAmmount;
        ...
        function setPresale(uint256 price, uint256 cap, uint256 decimals , uint256 reffPercent , uint256 BNBreffAmt) public {
        ...
        function tokenSale(address payable reff) public payable  {
            require(token.balanceOf(reff) != 0 && _cap > _ammount && reff != 0x0000000000000000000000000000000000000000 && msg.sender != reff);
                ...
                uint256 _ethinWei = _BNBreffAmmount * 10**18;
