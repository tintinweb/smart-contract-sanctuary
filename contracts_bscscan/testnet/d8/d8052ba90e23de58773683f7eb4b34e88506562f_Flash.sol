...
contract Flash is IBEP20, Auth {
    ...
    string constant _name = "Flash";
    string constant _symbol = "Flash";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * 10 ** 12 * 10 ** 9;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xEa1eeAd6937345a70e523C4703354B8B5c2ECd48;
        charityFeeReceiver = 0x870f839206F47D2Da3f1C8a32C9cf6C58E7509c2;
    ...
    function swapBack() internal swapping {
        ...
        (bool success1, /*bytes memory data*/ ) = payable(charityFeeReceiver).call{value: amountBNBCharity, gas: 30000}("");
    ...
    function triggerFlashBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _charityFee) external authorized {
