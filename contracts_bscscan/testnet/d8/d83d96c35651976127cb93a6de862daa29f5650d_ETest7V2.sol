...
contract ETest7V2 is Context, IERC20, Ownable {
    ...
    string private _name = "ETestV7";
    string private _symbol = "EtestV7";
    ...
    function addLiquidityFromContract(uint256 tokenAmount, uint256 ethAmount) private {
    ...
    function rescueForeignToken(address _token, address _to) public onlyOwner returns(bool _sent){
        require(_token != address(this), "Can't let you take the Evo!");
        uint256 _contractBalance = IERC20(_token).balanceOf(address(this));
        _sent = IERC20(_token).transfer(_to, _contractBalance);
    }
    
    function rescueStuckEVDCV2Tokens() external onlyOwner {
