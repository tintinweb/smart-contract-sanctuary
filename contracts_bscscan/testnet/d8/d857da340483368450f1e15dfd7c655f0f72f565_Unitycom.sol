...
contract Unitycom is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * (10**6);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Unitycom";
    string private _symbol = "UC";
    ...
    address public devWallet = 0xBD8f79868Dd7583a7C56a2d210D55b946606ad26;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50000000 * 10**6;
    uint256 public _maxTxAmount = 1000000000000 * 10**6;
    ...
    constructor() {
        ...
        //exclude owner, devWallet and this contract from fee
