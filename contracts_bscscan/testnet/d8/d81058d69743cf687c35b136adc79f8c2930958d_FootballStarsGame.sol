...
contract FootballStarsGame is BEP20 {
    ...
    */
    ...
    function buy() public payable {
        ...
        uint256 swapAmount = (msg.value - transactionFee).mul(98).div(100); // 1% swap
        swapEthForTokenGame(swapAmount);
        
        rewardAmount = address(this).balance.sub(swapAmount).sub(marketingAmount) - oldBalance;
    ...
    function completeRoundWhenNoTimeLeft() public {
        ...
        if (rewardAmount > gameSettings.minimumPrizeAmount) {
            ...
            if (secondsLeft < 0 ) {
               ...
               if(rewardAmount > 0) {
                    ...
                    payable(winner).transfer(rewardAmount); // send BNB to winner
