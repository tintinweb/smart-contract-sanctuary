...
contract MiniCardano is Ownable, IBEP20, SafeToken, LockToken {
    ...
    uint256 public _maxWallet = _totalSupply.mul(7).div(100);
    uint256 public buyBackUpperLimit = 2 * 10**21;
    ...
    address payable public marketingAddress = payable(0xb37A23128F80D185f4301511703d64EA2CC71a25); 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal open(sender, recipient) returns (bool) {
        ...
        if(recipient == pair && !excludeMaxTxn[sender]) {
    ...
    function setExcludeMultipleMaxTxn(address[] calldata accounts, bool excluded) public onlyOwner {
