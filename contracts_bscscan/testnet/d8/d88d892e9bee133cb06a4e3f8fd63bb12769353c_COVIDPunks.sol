...
contract COVIDPunks is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  uint256 private _price = 0.02 ether; // 30000000000000000
  
  string public punkcontractURI;
  
  constructor() ERC721("COVIDPunks", "PUNK") {}
  /**
  代币合约：0xe4cfae3aa41115cb94cff39bb5dbae8bd0ea9d41
  创建者：0xD9Eb7Ddd1d5f9081BA745dcf0e56B39788b91f94
   */
  // for wd
//   address oaf = 0x15776c1F16C3B766A8a4af06DdB83dAD1512C9E9;
//   address quack = 0xD9Eb7Ddd1d5f9081BA745dcf0e56B39788b91f94;

  address oaf = 0x44Fd9a9706EAa450967C6b7599b53b451ac7F977;
  address quack = 0xaaFEaC8EcdE0C26Cd2185bD5be26506bC8a31aB2;
