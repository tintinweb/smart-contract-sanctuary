...
contract NFTFactory {
    ...
    function createNFT(
        ...
        console.log("owner of NFT: %s", owner);
        console.log("baseURI: %s", baseURI);
        emit NFTCreated(address(nft), name, symbol);
        console.log("address NFT: %s", address(nft));
        return address(nft);
    }
}
...
contract BNFT is BRC721Enumerable, Pausable {
    ...
    constructor(
        ...
        console.log("BNFT - baseURI: %s", baseURI_);
        console.log("BNFT - admin: %s", admin_);
        console.log("BNFT - baseURI encoded: %s", baseURI);
    }
