...
uint256 fee = msg.value.mul(OWNER_FEE).div(PERCENTS_DIVIDER);
	...
	uint256 profit = 0;
	if(isRound1){
	 profit=msg.value.mul(55000).div(1000000000);
   
	}
	else if(isRound2){
	 profit=msg.value.mul(50000).div(1000000000);
   
	}
	else if(isRound3){
	 profit=msg.value.mul(45000).div(1000000000);
   
	}
else if(isRound4){
	 profit=msg.value.mul(40000).div(1000000000);
   
	}
	else if(isRound5){
	 profit=msg.value.mul(35000).div(1000000000);
   
	}
	else if(isRound6){
	 profit=msg.value.mul(30000).div(1000000000);
   
	}else{
	    profit=msg.value.mul(20000).div(1000000000);
	}
 ...
 function storound1() public{
        if(msg.sender==commissionWallet){
            isRound1=false;
            isRound2=true;
        }
    }
    function storound2() public{
        if(msg.sender==commissionWallet){
            isRound2=false;
            isRound3=true;
        }
    }
    function storound3() public{
        if(msg.sender==commissionWallet){
            isRound3=false;
            isRound4=true;
        }
    }
    function storound4() public{
        if(msg.sender==commissionWallet){
            isRound4=false;
            isRound5=true;
        }
    }
    function storound5() public{
        if(msg.sender==commissionWallet){
            isRound5=false;
            isRound6=true;
        }
    }
    function storound6() public{
        if(msg.sender==commissionWallet){
            isRound6=false;
