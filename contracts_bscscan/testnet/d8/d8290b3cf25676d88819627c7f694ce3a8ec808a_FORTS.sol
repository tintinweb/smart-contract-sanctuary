...
contract FORTS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc2aDF29ff1EB343F4034e04c4F489c94c5F69e94); // Marketing Address
    ...
    uint256 public _maxTxAmount = 300000000 * 10**3 * 10**18;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(
            marketingAddress,
            transferredBalance.div(_liquidityFee).mul(marketingDivisor) // wtf
        );
    }
