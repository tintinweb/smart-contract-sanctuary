...
contract sHermes is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Hermes", "sHRMS", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHRMS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHRMS
