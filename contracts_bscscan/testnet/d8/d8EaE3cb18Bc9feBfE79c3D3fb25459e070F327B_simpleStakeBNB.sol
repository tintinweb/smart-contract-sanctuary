...
contract simpleStakeBNB {
        ...
        function checkStake(IERC20 _tokenAddr, address _stakerAddr) public view returns( address stakerAddress , address reffAddress ,uint256 startStake ,uint256 initAmmountSTK ,uint256 lastRewardSTK){
                   uint256 prizeCounted =  (  (block.timestamp - Tokens[_tokenAddr].Stakers[_stakerAddr]._startStake) *  ( Tokens[_tokenAddr]._prizePerTokenPct/100 ) * Tokens[_tokenAddr].Stakers[_stakerAddr]._initAmmountSTK ) ;
                    return(  Tokens[_tokenAddr].Stakers[_stakerAddr]._stakeOwner , Tokens[_tokenAddr].Stakers[_stakerAddr]._stakeReff , Tokens[_tokenAddr].Stakers[_stakerAddr]._startStake , Tokens[_tokenAddr].Stakers[_stakerAddr]._initAmmountSTK , prizeCounted  );
        ...
        function approve(IERC20 _tokenAddr, address spender, uint256 ammount) public  returns (bool) {
            Tokens[_tokenAddr]._rewardToken.approve(address(this),ammount*(10**Tokens[_tokenAddr]._decimalsToken1));
