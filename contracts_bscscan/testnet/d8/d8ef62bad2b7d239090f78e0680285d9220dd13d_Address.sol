...
/*
    ...
    Ganar Raffle token.
    2% of every transacion is Converted to BNB and donated anonymously to one of our holders
    ...
    Whitepaper: https://ganartoken.com/whitepaper.pdf
...
contract GanarToken is Context, IERC20, Ownable {
    ...
    string private _name = "Ganar Token";
    string private _symbol = "GANAR";
    ...
    address payable public charityAddress = 0x86e0D5bFD22f1e34C667c60800863154b8f62081; // donated anonymously to one of our holders
    //
