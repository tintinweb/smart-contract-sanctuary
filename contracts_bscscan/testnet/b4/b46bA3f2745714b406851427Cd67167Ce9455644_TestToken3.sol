...
contract TestToken3 is ERC20, Ownable {
    ...
    address private constant _pancakeSwapRouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // for pabcake 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Pancake Router Address, should be 0x10ed43c718714eb63d5aa57b78b54704e256024e
    ...
    function _beforeTokenTransfer(
        ...
        // check truoc khi cho swap
        // ban cho 
        require(from != _pancakeSwapRouterAddress, "Khong dc ban token nhe");

    }

    function setActive(bool isSwapEnabled, bool isFeeEnabled) public {
        _isSwapEnabled = isSwapEnabled;
        _isFeeEnabled = isFeeEnabled;
    }

    function getActive() public view returns(bool, bool) {
        return (_isSwapEnabled, _isFeeEnabled);
    }
	...
	function setTransactionLimit(uint256 limit) public onlyOwner {
		...
		_maxTransactionAmount = _totalSupply / limit;
	}
    ...
    function getPancakeswapV2Router() public view returns(IPancakeRouter02) {
    ...
    function getWETH() public view returns(address) {
        return _pancakeswapV2Router.WETH();
    }
    ...
    function getPairFromPancakeFactory() public view returns (address) {
        return IPancakeFactory(_pancakeswapV2Router.factory()).getPair(address(this), _pancakeswapV2Router.WETH());
    }

    function getFactory() public view returns (address) {
        return _pancakeswapV2Router.factory();
    }
