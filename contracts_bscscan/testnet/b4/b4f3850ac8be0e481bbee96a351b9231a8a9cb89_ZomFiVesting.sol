...
// File: utils/AccessProtected.sol
...
contract ZomFiVesting is AccessProtected {
    ...
    constructor(address _tokenAddress) {
        require(_tokenAddress.isContract(),"Invalid Token Address");
        ...
        returns (uint256)
    {
        ...
        uint256 currentTimestamp = block.timestamp > _claim.endTime
            ? _claim.endTime
            : block.timestamp;
        uint256 claimPercent = ((currentTimestamp - _claim.startTime) *
            (1e18)) / (_claim.endTime - _claim.startTime);
