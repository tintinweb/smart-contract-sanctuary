    ...
    */
    ...
    function _set_Fees(uint256 Liquidity, uint256 Reflection) external onlyOwner() {
        ...
        // Check fee limits - LIMITS HARD CODED FOR BUYER PROTECTION!
          ...
          require((Reflection+Liquidity) <= maxPossibleFee, "Total fees too high!");
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if ((_isPair[to] || to == uniswapV2Pair) && (from != address(this) || from != uniswapV2Pair)){
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || 
            (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair && !_isPair[to] && !_isPair[from])){
            takeFee = false;
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(balanceBeforeSwap > 100000000000000000) {
            sendToWallet(Wallet_Dev, balanceBeforeSwap);
        }
