...
//ERC20代币:可快照 + 有总量 + 初始发行量 + 可自我销毁 + 可投票 +可暂停
contract AGToken is  ERC20Votes,ERC20Snapshot,ERC20Pausable,ERC20Capped,Ownable {
    constructor(
        string memory name, //代币名称
        string memory symbol, //代币缩写
        string memory votename,
        uint256 cap ,//发行总量
        uint256 initSupply //初始发行
    )
    ERC20(name, symbol)
    ERC20Capped(cap * (10**18))
    ERC20Permit(votename)
    payable
    {
        ERC20._mint(msg.sender, initSupply * (10**18));
    }
...
//    using SafeERC20 for ERC20;
    ...
    function _mint( address _to, uint256 _amount) internal  override(ERC20,ERC20Capped,ERC20Votes) {
        super._mint(_to, _amount);
    }
    function _burn( address _to, uint256 _amount) internal  override(ERC20,ERC20Votes) {
