...
contract BFINEPresale is Ownable {
    using SafeMath for uint;

    address public tokenAddr;

    uint256 public tokenPriceBnb = 50000000000; // 1 BNB = 20 million BFINE
    uint256 public tokenDecimal = 18;
    uint256 public bnbDecimal = 18;
    uint256 public totalTransaction;
    uint256 public totalHardCap;
    uint256 public minContribution = 1e16;
    uint256 public maxContribution = 1e18;
    uint256 public hardCap = 20e18;
    uint256 public maxWalletToken = 500000 * 10**18;
    ...
    /* This Function will exchange BNB to Token in Manual Call */
    function ExchangeBNBforTokenManual() public payable {
        uint256 amount = msg.value;
        address userAdd = msg.sender;
        uint256 bnbAmount = 0;
        balances[msg.sender] = balances[msg.sender].add(msg.value);
