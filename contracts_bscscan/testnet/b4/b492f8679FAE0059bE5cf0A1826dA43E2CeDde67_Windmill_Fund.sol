...
interface I_Windmill_Trade_Deployer_Abstract is IAccessControlEnumerable, I_With_DAORole{
	function name() external returns (string memory);
	
	function deployNewTrade(address owner) external returns (address);
}// Version: 1.0.0



interface I_Windmill_Trade_Abstract is IAccessControlEnumerable, I_With_DAORole{
...
contract With_DAOContract is AccessControlEnumerable, With_DAORole, I_With_DAOContract{
    ...
    function setDAO(I_Windmill_DAO _DAO) external onlyRole(DAO_ROLE){
        DAO = _DAO;
    }
}// Version: 1.0.0
...
contract Windmill_Fund is Adressable, Math, Payable, AccessControlEnumerable, With_DAORole, With_DAOContract,
                          With_PWRToken, With_BUSDToken, With_WBNBToken, With_PancakeRouter, I_Windmill_Fund{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    function getBNBForGasRefund(uint256 amountBNB) external onlyRole(DAO_ROLE){
        ...
        payable(address(DAO)).transfer(amountBNB);
    }
