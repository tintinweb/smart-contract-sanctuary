...
contract ERC20 is Context, IERC20, Owned {
    ...
    uint public EpochSizeMin = 100;
    
    uint256 public lottoPool;
    uint256 public lottoPayout;
    ...
    function unstakeTokens() public {
        ...
        IERC20(token).transfer(msg.sender, share[msg.sender]);
    ...
    function calculateLotto() private {
        if (lottoPool >= lottoPayout){
           uint256 i = random()%stakers.length;
