...
contract FancyCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    FancyDividendTracker public dividendTracker;
    ...
    uint256 public maxWalletToken = 5000000000 * (10**18); // 5% of total supply
    ...
    constructor() ERC20("FancyCake", "FancyCake") {
    	...
    	dividendTracker = new FancyDividendTracker();

    	buyBackWallet = 0xb4bbFCB47Db3Aa0DE96C98C934c3289F95BC83df;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        FancyDividendTracker newDividendTracker = FancyDividendTracker(payable(newAddress));
...
contract FancyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
