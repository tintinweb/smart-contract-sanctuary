...
contract Meta is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        reflectionFee.push(600);  // buy
        reflectionFee.push(700);  // sell
    ...
    function takeFee(address sender,address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 gameDev = amount.mul(gameDevFee[feeIndex]).div(10**(feeDecimal + 2));
        ...
        uint256 feeAmount = amount.mul(totalFee).div(10**(feeDecimal + 2));
