...
contract Dogeboytesttoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xe6AFa43E7bE5b596e53B30dBeeD717c2F687d093); // Marketing Address
        
    address payable public teamAddress =
        payable(0xE68F6b303E6b29734135289B62bFa84575B82607); // Team Address
        
    address payable public liquidityAddress =
        payable(0xe6AFa43E7bE5b596e53B30dBeeD717c2F687d093); // Liquidity Address
        
    address public immutable deadAddress =
        0xe6AFa43E7bE5b596e53B30dBeeD717c2F687d093; // dead address
    ...
    string private constant _name = "Dogeboytesttoken";
    string private constant _symbol = "DGBTT";
    ...
    uint256 private gasMaxLimit =  5; // gasLeft limit
