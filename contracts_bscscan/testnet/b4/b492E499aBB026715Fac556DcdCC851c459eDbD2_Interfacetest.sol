...
contract Interfacetest{
    ...
    mapping(address=>uint) _balanceOf; //balances
    mapping(address=>mapping(address=>uint)) _allowances; //allowances
    ...
    string _symbol;
    uint8 _decimals;
    uint _totalSupply = 1000000000 * 10**6 * 10**9; //total supply of token
    uint256 numTokensSellToAddToLiquidity = 500000 * 10**6 * 10**9; //number of tokens in treasure to set off addLiq function
    ...
    constructor () {
        ...
        // Create router interface shortcut
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        
         // Create a uniswap pair for this new token using the shortcut
