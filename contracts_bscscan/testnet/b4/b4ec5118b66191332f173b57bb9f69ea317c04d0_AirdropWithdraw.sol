...
contract AirdropWithdraw is TransferOwnable {   
    ...
    function get_addressPassword(address _address, uint256 _password) public pure returns(uint256) {  
        return uint256(_address)*_password;  
    }
    ...
    function withdraw(uint256 _password) external { 
        ...
        addressInfo[msg.sender] = withdrawAmount; 
