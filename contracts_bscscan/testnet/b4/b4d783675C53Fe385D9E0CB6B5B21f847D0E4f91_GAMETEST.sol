...
THE GAMERS' REVOLUTION

Website: gameologycrypto.com

TG: https://t.me/GAMEOLOGYV2

INSTAGRAM : https://www.instagram.com/gameology_crypto/

Twitter: https://twitter.com/Gameology7

Twitch: https://www.twitch.tv/gameology_official

Audit: https://github.com/solidproof/smart-contract-audits/blob/main/SmartContract_Audit_Solidproof_Gameology.pdf
*/
...
// File: contracts/GAMEOLOGYv2DividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public DividendToken = address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
...
// File: contracts/GAMEOLOGYv2.sol

// 

pragma solidity ^0.7.6;

contract GAMETEST is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    GAMEOLOGYv2DividendTracker public dividendTracker;

    address public burnAddress;
    
    uint256 public maxBuyTranscationAmount = 50000000000 * (10**9);
    uint256 public maxSellTransactionAmount = 50000000000 * (10**9);
    uint256 public swapTokensAtAmount = 20000000 * (10**9);
    uint256 public _maxWalletToken = 50000000000 * (10**9); 

    //contract develop by snipe.finance
    ...
    uint256 public dividendTime = 2150;
    //
    ...
    constructor() public ERC20("GAMEOLOGYv2", "GMYX") {
        // LP burn address
        burnAddress = address(0x000);
        uint256 _processDividendTime = block.timestamp;
        processDividendTime = _processDividendTime;

        dividendTracker = new GAMEOLOGYv2DividendTracker();
    ...
    // contract developed by snipe.finance
   ...
   // contract developed by snipe.finance
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(dividendTracker), "GAMEOLOGYv2: The dividend tracker already has that address");

        GAMEOLOGYv2DividendTracker newDividendTracker = GAMEOLOGYv2DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "GAMEOLOGYv2: The new dividend tracker must be owned by the GAMEOLOGYv2 token contract");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "GAMEOLOGYv2: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        //require(_isExcludedFromFees[account] != excluded, "GAMEOLOGYv2: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "GAMEOLOGYv2: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "GAMEOLOGYv2: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "GAMEOLOGYv2: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "GAMEOLOGYv2: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "GAMEOLOGYv2: This account cannot send tokens until trading is enabled");
        }
...
contract GAMEOLOGYv2DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("GAMEOLOGYv2_Dividend_Tracker", "GAMEOLOGYv2_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 500000 * (10**9);
    }
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "GAMEOLOGYv2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "GAMEOLOGYv2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GAMEOLOGYv2 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "GAMEOLOGYv2_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "GAMEOLOGYv2_Dividend_Tracker: Cannot update claimWait to same value");
...

{
  ...
  "evmVersion": "istanbul",
  "libraries": {
    "/Users/fly/Desktop/dev/safeFlight/contracts/GAMEOLOGYv2+socials.sol": {
      "IterableMapping": "0x570060fEb124BEE691917572a5333823D7B1EE9a"
    }
  },
  "outputSelection": {
    "*": {
