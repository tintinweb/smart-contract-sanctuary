...
//** Author Vipin : Decubate Crowdfunding 2021.5 */
...
contract DecubateCrowdfunding is IDecubateFactory, Ownable, ReentrancyGuard {
    ...
    modifier requireDCB(address _wallet) {
        ...
        require(
            ...
            "you need to have more than 0 in your account"
        );
        _;
    }
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "User already joined agreement pool"
        );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "End date not arrived / Soft cap not met"
        );
