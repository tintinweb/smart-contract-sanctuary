...
contract MTPToken is ERC20, Pausable, ReentrancyGuard, Ownable {
    using EnumerableSet for EnumerableSet.AddressSet;
    using Address for address;

    // ------------------- constants  -------------------

    uint256 private constant _initialSupply = 1000000 * 1e18;       // mint 1M tokens on day-0
    uint256 private constant _minimumSupply = 100000 * 1e18;        // minimum supply
    
    
    // ------------------- deployment logic  -------------------

    constructor() ERC20("MusicTherapyPro", "MTP") {
    ...
    function burn(uint256 amount) external nonReentrant whenNotPaused {
        require(canBurn(amount), "Burn amount exceeds supply" );
