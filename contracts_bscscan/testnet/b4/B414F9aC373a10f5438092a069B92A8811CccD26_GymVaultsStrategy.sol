...
contract GymVaultsStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public uniRouterAddress = address(0xc351628EB244ec633d5f21fBD6621e1a683B1181); // PancakeSwap: Router

    address public constant wbnbAddress = address(0x5081a39b8A5f0E35a8D959395a630b68B74Dd30f);
