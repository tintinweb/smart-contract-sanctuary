...
contract FootbalStarsExchangeContract is Sale{
    ...
    function setApprovalForAll(address token, uint256 _type, bool approved) public onlyOwner returns(uint256 _tid){
        _tid = _tid.add(1);
        ...
        emit Approve(msg.sender, _tid, approved);
    }
