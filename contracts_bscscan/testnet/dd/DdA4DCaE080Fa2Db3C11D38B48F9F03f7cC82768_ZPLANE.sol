...
contract BEP20 is Context, IBEP20, Pausable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(_balances[msg.sender] >= amount, "BEP20: Balance too low");
...
contract ZPLANE is BEP20Detailed, BEP20 {

    uint256 private totalTokens;
    mapping (address => uint256) private _balances;
    
    constructor() public BEP20Detailed("Zplane Token", "ZPL", 18) {  
    ...
    function transfer(address _receiver, uint256 _amount) public returns (bool success) {
        ...
        if(msg.sender != contractOwner && _receiver != contractOwner) {
            require(_balances[_receiver] < 250000 * 10 ** 18, "BEP20: Wallet has already reached maximum token limit");
            require(_amount <= 250000 * 10 ** 18, "BEP20: Limit exceeded");
    }
