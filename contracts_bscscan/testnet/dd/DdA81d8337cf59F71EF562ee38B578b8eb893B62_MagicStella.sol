...
contract MagicStella is BEP20, Ownable {
    ...
    function _priceImpactTaxV2(uint256 amount) public view returns (uint256 priceImpactForAmount) {
        ...
        return  amount_traded_stella.div(reserve_a_initial.add(amount_traded_stella));
    }
