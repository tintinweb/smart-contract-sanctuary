...
contract Khalifa is Context, IERC20, Ownable {
    ...
    string private _name = "KhalifaFinance";
    ...
    uint256 public _taxFee = 60; // means 0% which distribute to all holders reflection fee
    ...
    uint256 public _burnFee = 30; // means 0.3% it menas burn 3%

    

    address tokenFeeAddress=0xa7155AcB6F4CCA6Ff39A6073d21A247e10Ab7f36;//dummy address
...
IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingFee = newBalance.mul(_buyBackFee).div(10**(_feeDecimal + 2));

        

        uint256 liquidityBal=newBalance.sub(marketingFee);
