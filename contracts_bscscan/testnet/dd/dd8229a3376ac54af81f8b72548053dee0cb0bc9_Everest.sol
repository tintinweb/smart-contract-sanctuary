...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address _wbnb)
        public
        DividendPayingToken("EverestDividenTracker", "EverestDividendTracker", _wbnb)
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "EverestDividenTracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(
            false,
            "EverestDividenTracker: withdrawDividend disabled. Use the 'claim' function on the main Everest contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "EverestDividenTracker: claimWait must be updated to between 1 and 24 hours"
        );
        uint256 _oldClaimWait = claimWait;
        require(
            newClaimWait != _oldClaimWait,
            "EverestDividenTracker: Cannot update claimWait to same value"
        );
...
contract Everest is ERC20, Ownable {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "Everest: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "Everest: The new dividend tracker must be owned by the Everest token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        ...
        require(newAddress != _oldUniswapV2Router, "Everest: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Everest: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(
            pair != uniswapV2Pair,
            "Everest: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Everest: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Everest: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Everest: Cannot update gasForProcessing to same value"
        );
