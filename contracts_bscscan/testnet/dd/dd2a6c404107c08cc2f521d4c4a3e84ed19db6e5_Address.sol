...
contract Babybnb is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc45Bd9cDCaaC4B72962a30f00283AA1190a3a15D); // Marketing Address
    ...
    string private _name = "LAMBO2";
    string private _symbol = "LBO2";
