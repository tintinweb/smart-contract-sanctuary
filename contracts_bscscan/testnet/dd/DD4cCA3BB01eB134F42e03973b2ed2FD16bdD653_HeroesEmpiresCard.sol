...
contract HeroesEmpiresCard is ERC721URIStorage {
    address public ownerHeroes;
    constructor() ERC721("Heroes&EmpiresCard", "HEC") {
        ownerHeroes = msg.sender;
    }
    mapping(address => bool) public miner;
    function createOrEditMiner(address _address) public {
        require(msg.sender == ownerHeroes, 'You are not a owner');
