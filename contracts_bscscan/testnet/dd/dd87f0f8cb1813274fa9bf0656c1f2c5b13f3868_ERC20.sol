...
contract FLOKIFATHER is ERC20, Ownable {
    ...
    uint16 public feeliq_buy = 0; 
    uint16 public feeliq_sell = 0; 
    ...
    constructor() ERC20("Bunny Terminator", "BUNNYTERMINATOR") {
        _mint(msg.sender, 3e9 * 10 ** decimals());      
