...
contract CoffeCake is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2E1A732553A759B40A1376c01923e9899ae9B1c1); // Marketing Address
    ...
    string private _name = "CoffeCake";
    string private _symbol = "COFFECAKE";
