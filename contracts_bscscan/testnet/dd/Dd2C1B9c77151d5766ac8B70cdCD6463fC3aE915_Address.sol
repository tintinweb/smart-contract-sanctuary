...
//EarnADA Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract Greenled is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'GreenLed';
    string private constant _symbol = 'GLED';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 24 * 10**6 * 10**_decimals;//equals 24.000.000 token
    ...
    address public constant TeamWallet=0xc0B0996dbE8CBE239dc49dDB22Dd2E39FF3cA363;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimADA(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawADA(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimADA(address addr) private{
        ...
        path[1] = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;  //Binance-Peg ADA Token
        ...
        emit OnWithdrawADA(amount, addr);
        _isWithdrawing=false;
    }
