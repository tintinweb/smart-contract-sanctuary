...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = address(0x6c63727aC026f9C8d20e95c62C7dda565D0Af455);
...
contract Teslacoin  is Context, IBEP20, Ownable {
    ...
    string private _name = "Teslacoin";
    string private _symbol = "TSLA";
	...
	address public marketWallet = 0x6c63727aC026f9C8d20e95c62C7dda565D0Af455;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5784d75D97b3257984eb3BcD0b5b61aE9D12d7b5);
    ...
    function totalFeePerTx(uint256 tAmount) internal view returns(uint256) {
        uint256 percentage = tAmount.mul(_holderFee.add(_liquidityFee).add(_marketFee)).div(100);
        return percentage;
    }
    ...
    function setMarketeFeePercent(uint256 marketeFee) external onlyOwner() {
        _marketFee = marketeFee;
    }
    ...
    function _takeMarketeFee(uint256 tAmount) private {
        uint256 tMarketeFee = tAmount.mul(_marketFee).div(100);
		uint256 rMarketeFee = tMarketeFee.mul(_getRate());
		_rOwned[marketWallet] = _rOwned[marketWallet].add(rMarketeFee);
        if(_isExcluded[marketWallet])
            _tOwned[marketWallet] = _tOwned[marketWallet].add(tMarketeFee);
        emit Transfer(_msgSender(), marketWallet, tMarketeFee);
    }
