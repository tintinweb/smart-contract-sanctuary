...
//Cambiado añadido onlyOwner blackListAddress
contract PausableToken is Token2, Pausable {
...
contract CoinToken is PausableToken {
	...
	//Cambiado function burn(uint256 _value) public{ a 	function burn(uint256 _value) public onlyOwner{ Para que solo haga burn el dueño
/** Se sustituye esta función de burn por la siguiente, para evitar tokens residuales en DeFi
