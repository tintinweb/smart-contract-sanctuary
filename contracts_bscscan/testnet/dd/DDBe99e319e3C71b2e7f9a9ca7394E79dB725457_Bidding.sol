...
contract Bidding is SuperAdmin {
    Entity entities;
    Package packages;
    ...
    function deleteBidding(string memory biddingId) public {
        ...
        revert('Can not delete bidding');
    }

    // get bidding detail by id
    function getBiddingDetailById(string memory _biddingId) view external onlySuperAdmin returns(
        string memory,
        string memory,
        string memory,
        string memory,
