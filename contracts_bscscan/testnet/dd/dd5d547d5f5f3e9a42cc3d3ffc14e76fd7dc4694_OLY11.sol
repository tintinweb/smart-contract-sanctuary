...
contract OLY11 is IBEP20, Auth {
  ...
  //  uint256 buybackMultiplierLength = 30 minutes;
    ...
    //greenwall
    uint256 public sellNumerator = 25;
    uint256 public buyNumerator = 25;
    uint256 public buyMultipliersDenominator = 100;
...
//    }
    ...
    function getFloppaFee() public view returns (uint256) {
        ...
        return totalFee.add(sellNumerator.mul(remainingTime2).div(buyMultipliersDuration)); // replace feeincrease with sellNumerator 
    }
    ...
    function getBingusFee() public view returns (uint256) {
        ...
        return totalFee.sub(buyNumerator.mul(remainingTime2).div(buyMultipliersDuration)); // replace feeDecrease with buyNumerator
    }
