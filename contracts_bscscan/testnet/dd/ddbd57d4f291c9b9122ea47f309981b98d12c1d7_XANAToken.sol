...
contract XANAToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xd934EBf314cbC46f52E10Fa2f78d7AA5A4aE6fa4);
    address payable public devAddress = payable(0x6eB2bc9baDc0d39b5dB1E8c867C939B89bf75CD5);
    address payable public burnAddress = payable(0x000000000000000000000000000000000000dEaD);

    mapping(address => bool) public isAutomatedMarketMakerPair;

    string private constant _name = "XANA Token";
    string private constant _symbol = "XANA";

    bool private inSwapAndLiquify;

    // Anti-Whale Settings
    uint256 public _whaleBuySellThreshold = 50_000_000_000 * 10**_decimals; // 50 Billion
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (isAutomatedMarketMakerPair[from]) {
                ...
                if (newTotalBuy > _whaleBuySellThreshold) {
    ...
    function setBuyFees(
        ...
        buySellRates.marketing = _marketing;
        buySellRates.dev = _dev;
        buySellRates.lp = _lp;
        buySellRates.toSwap = _marketing + _dev + _lp;
    }
    ...
    function setWhaleFees(
        ...
        whaleRates.rfi = _rfi;
        whaleRates.marketing = _marketing;
        whaleRates.dev = _dev;
        whaleRates.lp = _lp;
        whaleRates.toSwap = _marketing + _dev + _lp;
    }
