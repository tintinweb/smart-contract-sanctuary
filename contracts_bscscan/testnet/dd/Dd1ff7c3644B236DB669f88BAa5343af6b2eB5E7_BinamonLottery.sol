...
// File: contracts/library/IBinamonLottery.sol
...
interface IBinamonLottery {
     ...
     */
    function buyTickets(uint256 tokensAMount) external;
...
// File: contracts/BinamonLottery.sol
...
contract BinamonLottery is
    VRFConsumerBase(
        0xa555fC018435bef5A13C6c6870a9d4C11DEC329C,
        0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06
    ),
    IBinamonLottery,
    ERC721("Binamon Lottery", "BNML")
{
    ...
    modifier onlyEnded {
        require(
            ...
            "BinamonLottery: Lottery needs to have ended for this"
        );
        _;
    }
    ...
    modifier onlyOn {
        require(
            _lottery[_lotteryID.current()].endTimestamp > block.timestamp,
            "BinamonLottery: No lottery is on right now"
        );
        _;
    }

    constructor() {
        _token = IERC20(0xa016efdbaF373bC476Ace360470b090CFFb70361);
        _feeReceiver = address(0xD3d031e008C90C0AD17e76067257EB258f817C5e);
        _chainlinkKeyHash = 0xcaf3c3727e033261d383b315559476f48034c13b18f8cafed4d871abe5049186;
        _chainlinkFee = 1e17; // Prod: 2e17
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "BinamonLottery: Cannot transfer tickets"
        );
    }
    ...
    function buyTickets(uint256 tokenAmount) external override onlyOn {
        uint256 ticketPrice = _lottery[_lotteryID.current()].ticketPrice;
        uint256 amountOfTickets = tokenAmount / ticketPrice;

        require(amountOfTickets != 0, "BinamonLottery: Not enough tokens");
        require(
            _token.balanceOf(_msgSender()) >=
                tokensNeededForTickets(_msgSender(), amountOfTickets),
            "BinamonLottery: You don't have enough tokens"
        );
        uint256 neededTokens = amountOfTickets * ticketPrice;
        
        IERC20(_token).transferFrom(msg.sender, address(this), neededTokens);
    ...
    function claimFees() public override {
        ...
        transferToken(_feeReceiver, fee);
    ...
    {
        require(!_rewardClaimed, "BinamonLottery: Reward already claimed");
        require(!_inClaimReward, "BinamonLottery: Reward is being claimed");
        ...
        require(
            ...
            "BinamonLottery: Put some LINK into the contract"
        );
    ...
    function fulfillRandomness(bytes32, uint256 randomness) internal override {
        ...
        transferToken(winner, amountWon);
        _rewardClaimed = true;
    ...
    function createLottery(
        ...
        require(
            _rewardClaimed,
            "BinamonLottery: Claim the reward before starting a new lottery"
        );
        require(
            percentageToKeepForNextLottery + ticketFee < 10000,
            "BinamonLottery: You can not take everything or more as a fee"
        );
        require(
            lotteryLength <= 2629744,
            "BinamonLottery: Must be under or equal to 1 month"
        );
    ...
    function toNextLottery() public view override returns (uint256) {
        ...
        return
            ((_token.balanceOf(address(this)) + totalFees) *
