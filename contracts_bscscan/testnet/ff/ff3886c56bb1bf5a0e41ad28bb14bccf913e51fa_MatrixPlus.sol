...
contract MatrixPlus is Ownable {
    ...
    uint256 public upgradePrice = 100*10**18; //  with 18 decimals
    ...
    function updatePoolId(address user) external onlyOwner returns(bool){
        ...
        // Index in poolBase starts with '0'
        // check for BUSD Approval
    ...
    function updatePlanId(address user) external onlyOwner returns(bool){
        ...
        _User[user].planId = prevPlanlId+1;
