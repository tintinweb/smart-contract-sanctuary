...
contract SexyDoge is Context, IERC20, Ownable {
    ...
    address payable public developerAddress = 0x1458b54ef432337aB78876a5A3A162De1C00e538; // Charity Address
...
function totalTeamBNB() public view returns (uint256) {
        // BNB has  18 decimals!
        return _tTeamTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tTeamTotal = _tTeamTotal.add(address(this).balance);
        TransferDeveloperETH(developerAddress, address(this).balance);
    }
    ...
    function TransferDeveloperETH(address payable recipient, uint256 amount) private {
        recipient.transfer(amount);
    }
