...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0DF6b519cbCDb49efBC45E411A56846540f6A56c;
...
contract AutCoin is Context, IERC20, Ownable {
    ...
    address private _MarketingAddress = 0x91a7c0acef1fC528CE695513A648490C8242191A;
    ...
    string private _name = "Hustlin crypto token";
    string private _symbol = "Hnc";
    uint8 private _decimals = 18;
    						//total = 5 + 3 + 3 = 11 percent
    uint256 public _taxFee = 5;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _MarketingFee = 3;
    uint256 private _previousCharityFee = _MarketingFee;
    ...
    function removeAllFee() private {
        ...
        _previousCharityFee = _MarketingFee;
    ...
    function restoreAllFee() private {
        ...
        _MarketingFee = _previousCharityFee;
