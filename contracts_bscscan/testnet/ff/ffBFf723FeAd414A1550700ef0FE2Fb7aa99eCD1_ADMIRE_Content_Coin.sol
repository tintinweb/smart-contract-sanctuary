...
contract ADMIRE_Content_Coin is BEP20('ADMIRE Content Coin', 'ADMRSol6V2'){
    ...
    constructor() public {
        ...
        // comment out if you want the CHARITY_ADDRESS static
        _charityaddress = CHARITY_ADDRESS;
        // comment out if you want the TAX_ADDRESS static
        _taxaddress = TAX_ADDRESS;
        emit OperatorTransferred(address(0), _operator);
        emit ContractAddressTransferred(address(0), _contractaddress);
        
        emit CharityAddressTransferred(address(0), _charityaddress);
        emit TaxAddressTransferred(address(0), _taxaddress);
    ...
    function isContractWhiteListed(address user) public view returns (bool) {
   ...
   /**
    * @dev Returns the address of the current charity address.
    *  comment out this function if you want the CHARITY_ADDRESS static
    */
    function charitytaddress() public view returns (address) {
        return _charityaddress;
    }
    
       /**
    * @dev Returns the address of the current charity address.
    * comment out this function if you want the TAX_ADDRESS static
    */
  ...
  /**
    ...
    */
    function transferCharitytAddress(address newCharityAddress) public whenCharityRateChangeOn onlyOwner {
        ...
        emit CharityAddressTransferred(_charityaddress, newCharityAddress);
    ...
    */
    function transferTaxtAddress(address newTaxAddress) public whenTaxRateChangeOn onlyOwner {
        ...
        emit TaxAddressTransferred(_taxaddress, newTaxAddress);
