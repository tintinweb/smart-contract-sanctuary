...
/**
    Tokenswap contract: send BNB get tokens
    Input the rate, the wallet that will receive BNB payments, and the token address to sell. 
    Send your desired amount of tokens to the contract
 */
...
contract Swaptoken is ReentrancyGuard, Context, Ownable {
    ...
    //Start Pre-Sale
    function startICO(uint _minPurchase, uint _maxPurchase) external onlyOwner {
