...
contract AmazoInfiniteToken is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "AmazoInfiniteToken";
    ...
    uint256 private minTokenNumberToSell =  20000 * 10**9; // this tx amount will trigger swap and add liquidity
    ...
    uint256 public _taxFee = 30; // 3% will be redistributed among the holders
    ...
    uint256 public _devFee = 50;  // 5% will go to the maeketingAndDev address 
