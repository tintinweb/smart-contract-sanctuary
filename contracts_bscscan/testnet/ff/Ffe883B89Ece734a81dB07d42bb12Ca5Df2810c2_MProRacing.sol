...
contract MProRacing is Ownable {
     ...
     */
    address public tokenAddress = 0xa6188F620844641D2b9ecdbD47DBAf51ea452F9e;
     ...
     */
    address public gameWallet = 0xf304B2A262f3067C236a78BD85D1081f4Bf37Cc0;
    ...
    function finishRoom(uint256 _id, address _winner) public onlyOwner {
        require(rooms[_id].roomOpen  == true);
