...
contract EGRTokenSale{
    ...
    EgriddToken public token;                       // The token

    uint tokenPrice = 250000000000000000; // 0.25 busd
    uint public hardCap = 30000000000000000000000; // 30,000 busd 
    
    uint public raisedAmount; 
    uint public saleStart;
    uint public saleEnd; //ICO ends in 52 weeks
    uint public tokenTradeStart; //transferable in a week after sale end    
    uint public maxInvesment = 50000000000000000000000; // 50,000 busd
    uint public minInvesment = 20000000000000000000; //20 busd
