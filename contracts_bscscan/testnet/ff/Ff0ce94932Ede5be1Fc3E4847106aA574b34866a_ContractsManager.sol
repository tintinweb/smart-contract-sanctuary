...
contract ContractsManager {
    ...
    function getExecutedTransactionCount() public view returns (uint) {
        return executedTransactions.length;
    }
    ...
    function getApprovedTransactions() public view returns (Transaction[] memory) {
        return approvedTransactions;
    }

    function getExecutedTransactions() public view returns (Transaction[] memory) {
