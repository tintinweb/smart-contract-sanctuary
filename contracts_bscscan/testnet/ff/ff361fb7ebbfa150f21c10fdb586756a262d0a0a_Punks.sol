...
contract Punks is IERC721 {
    ...
    uint256 public constant TOKEN_LIMIT = 55555;
    ...
    function setMoonReferral(NFTReferral _tokenReferral) public onlyDeployer {
    ...
    modifier onlyTokenOwner(uint256 _tokenId) {
        require(_tokenId < 55555, "punk number is wrong");
    ...
    function buyPunk(uint256 punkIndex) public payable reentrancyGuard {
        require(marketPaused == false, "Market Paused");
        require(punkIndex < 55555, "punk number is wrong");
