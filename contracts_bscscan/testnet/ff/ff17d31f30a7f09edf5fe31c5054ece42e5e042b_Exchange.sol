...
contract Exchange is Ownable {
    ...
    uint256 public limit = 100000 * 10**9; 
    // contract status. 
    bool public pause;
    ...
    function exchange(uint256 _amount) external isPause {
        require(_amount >= limit, "insufficient token");
        
        uint256 value = _amount.div(limit);
        
        require(wow.transferFrom(msg.sender, address(this), value.mul(limit)), "wow transer Failed");
        
        require(newWow.transfer(address(this), value), "new transer Failed");
        
        emit ExchangeWOW(msg.sender, value.mul(limit), value);
