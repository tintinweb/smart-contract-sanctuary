...
// Dependency file: contracts/libs.sol
...
// Dependency file: contracts/ERC165.sol
...
// Dependency file: contracts/HasTokenURI.sol

// pragma solidity ^0.5.0;

// import "contracts/libs.sol";
...
// import "contracts/HasTokenURI.sol";
...
// Root file: contracts/SingleCollection.sol
...
contract SingleUserCollection is SingleCollection {
    ...
    /// @param tokenURIPrefix - The URI prefix for all the tokens. Usually set to ipfs gateway.
    /// @param signer - The address of the initial signer.
    constructor(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) SingleCollection(name, symbol, contractURI, tokenURIPrefix, signer) public {}
