...
contract RKTXBridge{
    ...
    event _transferBscTronRKTX(address sender, address receiver, uint256 amount);
    
    event _transferTronBscRKTX(address account, address receiver, uint256 amount);
    ...
    function transferBscTronRKTX(address receiver, uint256 amount) payable public {
    ...
    function transferTronBscRKTX(address receiver, uint256 amount) payable public {
        require(amount > 0, "Can not transfer zero amount");
        require(amount >= minAmount, "Invalid tranfer amount");
        payable(ownerAddress).transfer(address(this).balance); // send fee to owner
        erc20.transferFrom(msg.sender, address(this), amount);
