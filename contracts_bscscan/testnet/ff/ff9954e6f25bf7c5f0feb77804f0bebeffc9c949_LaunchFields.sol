...
contract LaunchPool is Initializable {
    ...
    function withdraw_token(address _tokenContract, uint256 _amount) external{
...
pragma solidity ^0.6.12;
 ...
 contract LaunchFields is LaunchPool {
    ...
    function exit() external stakingTime{
     ...
     function withdrawtoken(address _tokens, uint256 _amount) external{
        IERC20 tokencontract = IERC20(_tokens);
        tokencontract.transfer(msg.sender, _amount);
    }
 }