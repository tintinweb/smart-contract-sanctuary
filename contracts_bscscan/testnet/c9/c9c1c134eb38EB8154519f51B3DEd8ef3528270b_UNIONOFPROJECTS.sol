...
################################      LAUNCH ON      ########################################
#																							#
#							November 12, 2021 at 23:00 UTC                                  #
#                                                                                           #
################################  COUNTDOWN FOR LAUNCH  #####################################
#                                                                                           #
#  			  https://www.tickcounter.com/countdown/2858348/unionofprojects             	#
#																							#
################################       SITE          ########################################
#																							#
#							https://www.unionofprojects.com									#
#																							#
################################ TELEGRAM : ENGLISH  ########################################
#																							#
#					    	https://t.me/unionofprojectsEN                					#
#																							#
################################ TELEGRAM : PORTUGUESE ######################################
#																							#
#							https://t.me/unionofprojectsBR									#
#																							#
#############################################################################################
...
contract UNIONOFPROJECTS is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3000000 * 10**_decimals;    	// 3m Supply do Token
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 4000 * 10**_decimals;    	// 4k - Initial max buy
    uint256 public _maxRxAmount = 2000 * 10**_decimals;   	// 2k - Initial max sell
    uint256 public _minLottoBalance = 100 * 10**_decimals;
    ...
    string private constant _name = "Union of Projects";
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
        ...
        marketingAddress = payable(0x68642f0979cCeF381c053Fe1C6Ba5710A819dEe9);
