...
contract Vaivotest is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000 * 10**4 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Vaivox Testnet";
    string private _symbol = "Vaivoxt";
    ...
    uint256 public _maxTxAmount = 100 * 1 * 10**4 * 10**2;
    uint256 private minimumTokensBeforeSwap = 1 * 1 * 10**4 * 10**2;
    uint256 public buyBackSellLimit = 1 * 10**4;
