...
contract CustomContract is Context, IBEP20, Ownable {
    ...
    uint256 private _takeTotal = 18 * 10**6 * 10**9;
    uint256 private _reflectTotal = (MAX - (MAX % _takeTotal));
    uint256 private _takeFeeTotal;

    string private constant _name = "CustomContract";
    string private constant _symbol = "Custom";
    ...
    uint256 public _maximumValueOfTransaction = 18 * 10**6 * 10**9 ;
    uint256 private numTokensSellToAddToLiquidity = 9 * 10**4 * 10**9 ;
    ...
    constructor () {
        ...
        address payable _pancakeFactory = payable(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc);
