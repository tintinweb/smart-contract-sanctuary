...
contract Testing {
		...
		uint256 public pool_b_owner_checkpoint = block.timestamp;
		uint256 public pool_c_owner_checkpoint = block.timestamp;
		uint256 public pool_d_owner_checkpoint = block.timestamp;
		uint256 public pool_e_owner_checkpoint = block.timestamp;
