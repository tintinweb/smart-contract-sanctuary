...
contract OkexFlyBsc is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 250000 * 10**6 * 10**18;
    ...
    constructor (address _minterAddr) {
        _rOwned[ONE] = _rTotal;
    ...
    function burn(uint256 amount, bytes calldata data) external {
        ...
        //emit Transfer(_msgSender(), ONE, amount);
    }
    ...
    external //onlyMinter  
    {
        ...
        //emit Transfer(ONE, account, amount);
    }
