...
contract SwapContract is Ownable {
    ...
    function execute(
        ...
        address[] memory path = getPath(_token);
    ...
    function getPath(address _token)
        public
        view
        returns (address[] memory path)
    {
        address pair1 = factory.getPair(swapToken, _token);
        address pair2 = factory.getPair(WBNB, _token);
