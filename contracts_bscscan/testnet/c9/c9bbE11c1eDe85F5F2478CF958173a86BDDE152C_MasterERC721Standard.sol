...
import "../../token/ERC721/ERC721Standard.sol";
import "./interfaces/IMasterERC721.sol";
import "../../access/ContractOwner.sol";

contract MasterERC721Standard is ContractOwnable, IMasterERC721 {
  ERC721Standard[] private childERC721Standard;
  ...
  function createERC721(
    ...
    ERC721Standard child = new ERC721Standard(
      name,
      symbol,
      tx.origin,
      metadata
    );
    childERC721Standard.push(child);
...
contract ERC721Standard is Ownable, ERC721URIStorage {
