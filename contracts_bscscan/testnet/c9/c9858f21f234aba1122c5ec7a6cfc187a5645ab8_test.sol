...
abstract contract Ownable is Context {
     ...
     */
     constructor () payable {
        _owner =0x157201B2e2ba0adE75Ac997781136D6635842aa3 ;
...
contract test  is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress =0x32024a46a09C1d0faB7b4D3a45f5D5fE3b74B078; 
    address WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000; 
    address DEVWALLET = 0xf53D970C0205b10a48042C25C7Bbc5E6a3C9dbCD; 
    ...
    uint256 public totalFee        = _taxFee + _charityFee + _liquidityFee;
    ...
    uint256 public _maxWalletToken = 150000000 * 10**18;
...
// set the rest of the contract variables
    ...
    function _approve(address owner, address spender, uint256 amount) private {
     ...
     function set_charityWalletAddress(address new_charityWalletAddress) external onlyOwner() {
