...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = "DINKI INU";
    ...
    address public MarketingWallet = 0x291a65211b46C926Ef88B1A05c82F618E9E398f8; //5% for marketing 
    ...
    uint256 public _maxTxAmount = 100000000 * 10**9; //1% of total supply   //ANTIDUMP
    uint256 private numTokensSellToAddToLiquidity = 2430  * 10**9;
    uint256 public _maxWalletToken = 30000  * 10**9;
