...
contract MetaFucker is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaFucker";
    ...
    function swapBack() internal swapping {
        ...
        (bool success, /* bytes memory data */) = payable(EcoFeeReceiver).call{value: amountBNBEco, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _EcoFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        EcoFee = _EcoFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_EcoFee);
        feeDenominator = _feeDenominator;
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _EcoFeeReceiver) external authorized {
