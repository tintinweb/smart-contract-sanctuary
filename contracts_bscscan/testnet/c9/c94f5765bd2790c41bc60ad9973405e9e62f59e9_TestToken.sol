...
contract TestToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8757edDE8a82dbb033727f4e01c5aA61Aa01e6c9); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 219325 * 10**9;
