...
contract HBCT_Trader is Security {
    ...
    function Convert() payable external onlyContr {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(0, _pathCONV, reciever, block.timestamp);
    }
    ...
    function Trade() payable external {
        ...
        IERC20(BUSD).transfer(reciever, _feeSize); // Transfer the fees
