...
// File: contracts/MetaDao-Dev1.sol
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private _name = "MetaDa0 - H2";
    string private _symbol = "MetaH2";
...
contract MetaDaoFloki is ERC20, Ownable {
    ...
    constructor() ERC20() {
    	...
    	marketingAddress = address(0x0AF41A3B994Cae0e4d9451d3788b72a8CF359bFA); // set as marketing wallet
    	devAddress = address(0x09C81836495bA6F3B80AbCB8340136C3009a599C); // set as dev wallet
        charityAddress = 0xa8007dF1655a73e0d67B4c55443fdd9461eaEf72;
    ...
    function swapBack() private {
        ...
        ethForLiquidity -= ethForMarketing + ethForDev + ethForCharity;
