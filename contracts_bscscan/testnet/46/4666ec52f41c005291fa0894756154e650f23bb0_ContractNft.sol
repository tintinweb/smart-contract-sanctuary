...
contract ContractNft is ERC721, Ownable {
    ...
    //    require(ownerOf(tokenId) == offer.seller, "Not seller");
        ...
        // Transfer the NFT
        (bool success, bytes memory result) = _exchange.call(abi.encodeWithSignature("transferFrom(address from, address to, uint256 tokenId)", seller, _msgSender(),tokenId));
