...
contract EarningBUSD is IBEP20, Ownable
{
    ...
    function getBNBUnlock() external view returns (uint256) {
        return _liquidityUnlockTime;
    }
    
    function get10plusBNBUnlock() external view returns (uint256) {
        return  _liquidityUnlockTime+10 minutes;
    }
    ...
    function TeamRemoveRemainingBNB() public onlyTeam{
        require(block.timestamp >= _liquidityUnlockTime+10 minutes, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
