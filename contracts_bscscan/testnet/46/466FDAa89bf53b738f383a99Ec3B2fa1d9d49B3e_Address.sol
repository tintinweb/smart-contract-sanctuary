...
contract Prosperous is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8A0b1193b1f65f863335cbC08b7A62E32626B580); // Marketing Address
    ...
    string private _name = "Prosperous";
    string private _symbol = "PRP";
