...
contract KabyHero is IKabyHero, ERC721, AcceptedToken, ReentrancyGuard {
    ...
    ) ERC721("KabyHero", "HERO") AcceptedToken(tokenAddress)
    {
        ...
        _uri = baseURI;
        versions.push(Version(0, 0, maxSupply, maxForSell, salePrice, startTime, revealTime, provenance, true));
     ...
     * @param isUseSummonStaking new useSummonStaking value
     */
    function addNewVersion(
        ...
        versions.push(Version(0, 0, maxSupply, maxForSell, salePrice, startTime, revealTime, provenance, isUseSummonStaking));
