...
// File contracts/UnlimitedMBOwnableToken.sol
...
contract UnlimitedMBOwnableToken is BEP20Base, BEP20Mintable, BEP20Burnable, Ownable, FeeProcessor {
    constructor(
        string memory name,
        ...
        FeeProcessor(feeReceiver, "UnlimitedMBOwnableToken")
        payable {

        require(initialSupply > 0, "UnlimitedMBOwnableToken: initial supply cannot be zero");
