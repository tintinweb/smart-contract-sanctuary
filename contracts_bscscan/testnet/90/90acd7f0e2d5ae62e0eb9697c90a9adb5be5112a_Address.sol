...
There is a tax of 10% over every transfer:
4% fee, redistributed to the holders
8% fee, used for buybacks (2%) and marketing (4%)
...
contract KurbagaToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb6cB3C321A701aA2B11Fe383f670f0cb79ABe2dC); // Marketing Address
    ...
    string private _name = "Kurbaga Token";
    string private _symbol = "KURB";
