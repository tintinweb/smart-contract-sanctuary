...
contract CardSellOnSale is Context, Ownable, Pausable {
  using SafeERC20 for IERC20;
  using SafeMath for uint256;

  // Dont forget to set the selling parameter
  uint256 public constant MAX_SELL_PER_TX = 1;
  uint256 public constant MAX_SELL = 2021;
  uint256 public constant MAX_SELL_PER_USER = 99;
  ...
  uint256 public flashSalePrice1;
  uint256 public flashSalePrice2;
  uint256 public flashSaleDuration1 = 10 minutes;
  uint256 public flashSaleDuration2 = 1 hours + 30 minutes;
  ...
  constructor(
    ...
    uint256 _price,
    uint256 _flashSalePrice1,
    uint256 _flashSalePrice2,
    ...
    price = _price;
    flashSalePrice1 = _flashSalePrice1;
    flashSalePrice2 = _flashSalePrice2;
  ...
  function getPrice() public view returns (uint256) {
    if (block.timestamp >= startSellTimestamp + flashSaleDuration1)
      return flashSalePrice1;
    else if (block.timestamp >= startSellTimestamp + flashSaleDuration2)
      return flashSalePrice2;
    else return price;
  }
  ...
  function buyCard(uint256 n) external onlyEOA whenNotPaused {
    ...
    for (
      ...
      emit CardSale(_msgSender(), tokenId, cardCategory, getPrice());
    }
  }
