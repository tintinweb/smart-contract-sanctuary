...
// SPDX-License-Identifier: Unlicensed
    ...
    contract WARI is ERC20 {
        ...
        constructor () ERC20("Warrior Inu", "WARI"){


            _liquidityFee = 3;
            _marketingFee = 7;
            _sellFee      = 20;
            _maxTxAmount = 50000000000 * 10 ** decimals();
            numTokensSellToAddToLiquidity = 100000000 * 10 ** decimals();
            _marketingWalletAddress = 0x410C98A6719831424Ab383Fc373A592BC62a33cb;
        ...
        function setSaleFeePercent(uint256 sellFee) external onlyOwner {
            _sellFee = sellFee;
        }    
        ...
        function _transfer(
            ...
            if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
              super._transfer(from, to, amount);
                 ...
                 uint256 fees = amount.mul(_marketingFee.add(_liquidityFee).add(_sellFee)).div(100);
            ...
            {
                uint256 fees = amount.mul(_marketingFee.add(_liquidityFee)).div(100);
                amount= amount.sub(fees);
                super._transfer(from, address(this), fees);
                super._transfer(from, to, amount);
        ...
        uint256 marketingTokens = contractTokenBalance.div(tFee).mul(
            _marketingFee
        );
        ...
        // Send funds to marketing wallet into bnb
        ...
        require(success, " _marketingWallet transfer is reverted");
