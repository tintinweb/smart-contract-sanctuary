...
contract GAMART is Context, IERC20, Ownable {
    ...
    string private _name = "GAMART";
    string private _symbol = "GAMART";
...
contract GAMARTNFT is ERC721URIStorage {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "#GAMARTNFT: ONLY_OWNER_CAN_ACCESS_THIS_FUNCTION");
        _;
    }
    ...
    function createNFT(string memory _tokenURI, uint256 _royaltyPercentage)
        ...
        returns (uint256)
    {
        require(msg.value == NFTCreationFees, "#GAMARTNFT : INVALID_NFT_CREATION_FEES_SENT");
        require(_royaltyPercentage <= 5, "#GAMARTNFT : ROYALTY_PERCENTAGE_SHOULD_BE_LESS_THAN_5");
        _tokenIds.increment();
