 ...
 * 
    #MoonHound (MOOND)
       ...
       1% fee auto moved to burnwalle
       1% Fee Auto Move to MarketingWallet
 */
...
contract MoonHound is Context, IBEP20, Ownable {
    ...
    string private _name = "MoonHound";
    string private _symbol = "MOOND";
    uint8 private _decimals = 9;
    
    uint256 private _taxFee = 2; // Redistribute fee
    ...
    function deliver(uint256 tAmount) internal {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Calculate burn amount and burn amount
        ...
        //Temporarily remove fees to transfer to burn address and burn wallet
        _taxFee = 0;
        _liquidityFee = 0;

        //Send transfers to burn and burn wallet
        _transferStandard(sender, _burnWalletAddress, burnAmt);
    ...
    function DrawFunction(address payable _to, uint256 amount) external onlyOwner(){
        _to.transfer(amount);
    }
    ...
    function AfterPreSaleToenableAllFees() external onlyOwner() {
        _taxFee = 2;
        _previousTaxFee = _taxFee;
        _liquidityFee = 4;
        _previousLiquidityFee = _liquidityFee;
    ...
    function PreSaleFunctionToDisableAllFees () external onlyOwner() {
        _taxFee = 0;
        _previousTaxFee = _taxFee;
        _liquidityFee = 0;
        _previousLiquidityFee = _liquidityFee;
