...
contract OneClickMint is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
        ...
        nonReentrant
    {
        ...
        collateral.safeApprove(address(router), _swapCollateralAmount);
        ...
        collateral.safeApprove(address(kusdPool), _remainCollateralAmount);
        share.safeApprove(address(kusdPool), _dopxActualAmount);
