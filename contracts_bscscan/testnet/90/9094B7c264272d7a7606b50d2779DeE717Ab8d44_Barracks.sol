...
//        zombie = _zombie;
    ...
    struct Barrack {
        ...
        uint minimum;                           // minimum amount to deposit.
    ...
    function createBarrack(
        ...
        barracks[totalBarracks].minimum = _minimum;
    ...
    function checkRemainingAmount(uint _barrackId) public view returns(uint) {
        return barracks[_barrackId].totalDeposited - barracks[_barrackId].lockAmount;
    }

    function deposit(address _token, uint _barrackID, uint _amount) public payable returns(bool) {
        ...
        if (barracks[_barrackID].bnb) {
            ...
            require(msg.value >= barracks[_barrackID].minimum || barracks[_barrackID].minimum == 0, "Not enough balance.");
            ...
            require(_amount >= barracks[_barrackID].minimum || barracks[_barrackID].minimum == 0, "Not enough balance.");
