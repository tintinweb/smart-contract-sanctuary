...
abstract contract Auth {
    ...
    function authorizeMultipleAccounts(address[] calldata accounts, bool excluded) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
        authorizations[accounts[i]] = excluded;
        }
    }
...
contract SantaManta is IBEP20, Auth {
    ...
    uint16 public buyTax = 10;
    uint16 public sellTax = 16;
    uint16 public transferTax = 10;

    uint16 public inCreaseFactor = 1;
    ...
    uint16 public feeDenominator = 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        buyBackFeeReceiver = 0xc27Ce14Fa75339C316164FE4d06b85ACd253ca23;
