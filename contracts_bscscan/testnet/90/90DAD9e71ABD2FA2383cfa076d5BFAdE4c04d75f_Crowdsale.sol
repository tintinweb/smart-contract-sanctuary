...
//    events
  event TokenPurchase(
    ...
    uint256 amount
      ...
      modifier claimDisabled {
        require(claimEnabled == true , "Claiming not started yet!");
        _;
    }
      modifier enabledlaim {
        require(claimEnabled == false , "Claiming has already started !");
        _;
    }
    ...
    constructor (uint256 _rate, address _token, address _busd )  {
     require(_rate > 0);
  ...
  // Core routines
    ...
    function buyTokens(uint _amount) public payable   enabledlaim {
    ...
    function claimTokens() external  claimDisabled {
    ...
    internal view returns (uint256)
  {
    ...
    function depositTokens(uint _amount) external  { 
        // do some checks 
        require(token.balanceOf(msg.sender) >= _amount, "!amount");
    ...
    function totalSuplly () view public returns(uint) {
    ...
    function withdrawFunds() public onlyOwner {
        ...
        busd.transfer(msg.sender,weiRaised);
        
    }
    function withdrawDepositedTokens() public onlyOwner {
        
        token.transfer(msg.sender,availTokens);
