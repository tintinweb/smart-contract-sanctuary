...
// KafeSwap Token with Governance.
contract KafeSwapToken is BEP20 {
    ...
    // Min Max transfer amount rate can be set: 0.1% of total supply
    uint16 public constant minTXRate = 10;
    ...
    // Min amount to liquify. (default 1000)
     ...
     */
    constructor() public BEP20("KafeSwap Token", "KAFESWAP") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (recipient == BURN_ADDRESS || transferTaxRate == 0 || _excludedFromTransferTax[sender] == true) {
            ...
            require(taxAmount == burnAmount + liquidityAmount, "KafeSwap::transfer: Burn value invalid");

            // default 90% of transfer sent to recipient
            uint256 sendAmount = amount.sub(taxAmount);
            require(amount == sendAmount + taxAmount, "KafeSwap::transfer: Tax value invalid");
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOperator {
        require(_transferTaxRate <= MAXIMUM_TRANSFER_TAX_RATE, "KafeSwap::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate.");
    ...
    function updateBurnRate(uint16 _burnRate) public onlyOperator {
        require(_burnRate <= 100, "KafeSwap::updateBurnRate: Burn rate must not exceed the maximum rate.");
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onlyOperator {
        require(_maxTransferAmountRate <= 10000, "KafeSwap::updateMaxTransferAmountRate: Max transfer amount rate must not exceed the maximum rate.");
        require(_maxTransferAmountRate >= minTXRate, "KafeSwap::updateMaxTransferAmountRate: Max transfer amount rate must not less than 0.1%.");
    ...
    function updateSwapRouter(address _router) public onlyOperator {
        ...
        require(swapPair != address(0), "KafeSwap::updateSwapRouter: Invalid pair address.");
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "KafeSwap::transferOperator: new operator is the zero address");
