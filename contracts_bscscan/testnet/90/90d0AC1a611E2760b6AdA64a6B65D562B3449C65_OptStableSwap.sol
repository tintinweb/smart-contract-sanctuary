...
contract OptStableSwap {
    ...
    function get_dx(uint256[] memory curve_balances, uint256 _A, uint256 ic, uint256 jc, uint256[] memory fixed_product_balances, 
    uint256 ifp, uint256 jfp, uint256 xi, uint256 yi, uint256 curve_fee, uint256 curve_fee_denominator) private returns (uint256 dx, uint256 dy_) {
        ...
        _A = stablePool.A();
        uint256 dy_ = stablePool.get_dy(i, j, dx); 
    ...
    function f_neg(uint256 Xfp_, uint256 xi, uint256 X0, uint256 Yfp, uint256 x, uint256 y) private returns (uint256) {
        return  Xfp_ * y + (xi + X0) * Yfp;
    }

    function f_pos(uint256 Yfp, uint256 yi_, uint256 Y0, uint256 Xfp_, uint256 x, uint256 y) private returns (uint256) {
        return Yfp * x + (yi_ + Y0) * Xfp_;
    }

    function find_intersection_of_l_with_tangent(uint256 X0, uint256 Y0, uint256 Pr_, uint256 D, uint256 Yfp, uint256 Xfp_, uint256 yi_, uint256 xi) private returns (uint256 x, uint256 y) {
        uint256 omega_num = X0 * Y0 + Pr_ * (D ** 2 / Y0);
        uint256 omega_den = X0 * Y0 / D + Pr_ * D / Y0;
        uint256 omega = omega_num / omega_den;
        uint256 fX0Y0_pos = f_pos(Yfp, yi_, Y0, Xfp_, X0, Y0);
        uint256 fX0Y0_neg = f_neg(Xfp_, xi, X0, Yfp, X0, Y0);
    ...
    function newton_step_along_line(uint256 X0, uint256 Y0, uint256 Pr_, uint256 D, uint256 Yfp, uint256 Xfp_, uint256 yi_, uint256 xi, uint256 S, uint256 Ann) private returns (uint256 x, uint256 y) {
        uint256 x = X0;
        uint256 y = Y0;
        uint256 xy = x * y;
    ...
    function ver_hor_newton_step(uint256 X0, uint256 Y0, uint256 Pr_, uint256 D, uint256 Yfp, uint256 Xfp_, uint256 yi_, uint256 xi, uint256 S, uint256 Ann) private returns (uint256 x, uint256 y) {
        uint256 x = X0;
        uint256 y = Y0;
        uint256 x1 = x;
        ...
        x = x1 + f_neg(Xfp_, xi, X0, Yfp, x1, y1) / temp - f_pos(Yfp, yi_, Y0, Xfp_, x1, y1)/temp;
        ...
        y = y1 + f_pos(Yfp, yi_, Y0, Xfp_, x1, y1) / temp - f_neg(Xfp_, xi, X0, Yfp, x1, y1)/temp;
    }

    function within_distance(uint256 x1, uint256 x2, uint256 d) private returns (bool) {
        if (x1 > x2) {
            if (x1 - x2 <= d) {
                return true;
            }
