...
contract InfinityFinance is ERC20, Ownable {
    ...
    address public _ecosystemWalletAddress = 0xc762879Edd0a994e349F475E99Efe0C2cfc0fb32;
    ...
    constructor() ERC20("InfinityFinance" , "INF") {

//        dividendTracker = new DividendTracker();


//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);//mainnet pcs
...
//        dividendTracker.excludeFromDividends(address(_uniswapV2Router));
    ...
    function swapAndSendToAll(uint256 tokens) private  {
        uint256 liquidityTokens = tokens * liquidityFee / 2 / totalFees; //1000000000000 * 2 / 2 / 15 = 66666666666
        uint256 tokensToSwap = tokens - liquidityTokens; //1000000000000 - 66666666666 = 933333333334
        uint256 initialBalance = address(this).balance;
        swapTokensForEth(tokensToSwap);
        uint256 receivedBNB = address(this).balance - initialBalance; //93147216312
        uint256 totalFeesAdjusted = totalFees - liquidityFee / 2; //15 - 2/2 = 14

        uint256 liquidityBNB = receivedBNB * liquidityFee / 2 / (totalFeesAdjusted);//93147216312 * 2/2 / 14 = 6653372593
        uint256 dividendBNB = receivedBNB * dividendFee / (totalFeesAdjusted); //93147216312 * 8 / 14 = 53226980749
        uint256 ecosystemBNB = receivedBNB - dividendBNB - liquidityBNB; // 93147216312 - 53226980749 - 6653372593 = 33266862970
        ...
        (success,) = address(_ecosystemWalletAddress).call{value: ecosystemBNB}("");
            if (success) {
                emit SentToEcosystem(_ecosystemWalletAddress, ecosystemBNB);
             }
    }
