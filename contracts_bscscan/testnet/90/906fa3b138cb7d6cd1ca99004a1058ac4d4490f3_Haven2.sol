...
contract SafeHaven is ISafeHaven {
    ...
    IBEP20 ETHB = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    uint256 public minDistribution = 30 / 1000000 * (10 ** 18); // 1 USD of ETHB minimum auto send
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ETHB.balanceOf(address(this));
        ...
        uint256 amount = ETHB.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ETHB.transfer(shareholder, amount);
...
contract Haven2 is IBEP20, Haven2Auth {
    using SafeMath for uint256;

    address ETHB = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Haven2";
    string constant _symbol = "HAVEN 2.0";
