...
contract StakingContract is Ownable {
    ...
    MainToken public immutable token;
    ...
    constructor(
        ...
        require(address(_token) != address(0), "Token is a zero value");
        token = _token;
    ...
    function remove(uint256 _pid) external onlyOwner validatePoolByPid(_pid) {
