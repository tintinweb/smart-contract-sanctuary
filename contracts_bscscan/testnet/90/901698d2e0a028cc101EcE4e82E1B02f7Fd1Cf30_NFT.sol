...
contract NFT is ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    mapping(uint256 => uint256) public energies;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("NFT TAPME", "NFTTAP") {}
    ...
    function safeMint(address to, uint256 _level, uint256 _energy) public onlyOwner returns (uint256) {
        uint256 tokenId = _tokenIdCounter.current();
        _safeMint(to, tokenId);
        _tokenIdCounter.increment();

        levels[tokenId] = _level;
        energies[tokenId] = _energy;
