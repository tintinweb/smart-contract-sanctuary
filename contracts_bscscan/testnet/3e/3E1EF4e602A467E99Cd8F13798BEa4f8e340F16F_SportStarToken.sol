...
contract SportStarToken is ERC1155 {
    ...
    function createNFT(address _to,string memory _teamId) external onlyOwner returns(uint256) {
        //the amount is set to 1 as we are minting an NFT
        _mint(_to, tokenCounter, 1,"");
        tokenURIs[tokenCounter] = _teamId;
