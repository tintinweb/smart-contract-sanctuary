...
contract Bank {
    ...
    function deposit() payable external {
        ...
        require(tokenApproved[_tokenContract], "Please deposit only FREE");
        require(msg.value > 0, "Must deposit more than 0 BNB");
        accounts[msg.sender] += msg.value;
    }

    function withdraw(uint256 _amount) external {
        address _tokenContract;
        //require(tokenApproved[_tokenContract], "Please withdraw only FREE");
