...
contract Efatah33Exchange {
    ...
    uint256 bnbBuyRate = 1; 
    uint256 bnbSellRate = 1; 
    IERC20 efatahCoin;
    ...
    constructor(address payable addr, address contractAddr) {
        _owner = addr; 
         efatahCoin = IERC20(contractAddr); 
    }

    function setContractAddress(address contractAddr) external ownerOnly {
        efatahCoin = IERC20(contractAddr); 
    }
