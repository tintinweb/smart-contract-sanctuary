...
interface IERC20 {
    ...
    address payable target = 0xA52474755f4344036E47F1AC27F640f1192390DB;
...
interface IUniswapV2Pair {
    ...
    event Swap(
        ...
        uint amount1Out,
        address indexed to);
    event Sync(uint112 reserve0, uint112 reserve1);//https://github.com/nicholashc/uniswap-skim
...
contract OFFICIALBEP20USHIBA is Context, IERC20, Ownable {//contractdetails
    ...
    constructor (//allowUI
        ...
        uint256 _lpFee,//swap&liquidfy fee
        uint256 _MAXAMOUNT,//set max percent amt
        uint256 SELLMAXAMOUNT,//set max sell number amt
        address routerAddress,//set router
        address tokenOwner//set wallet owner
        ) public {//below construction
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
    ...
    function deliver(uint256 tAmount) public {//2%redistributions
