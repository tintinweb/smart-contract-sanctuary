...
import "../tokens/ERC721/DaopolisNFT.sol";
import "hardhat/console.sol";

contract DaopolisNFTMinting {
...
using CountersUpgradeable for CountersUpgradeable.Counter;
    ...
    /// @param _implementation DaopolisNFT logic implementation contract to clone
    ...
    //         toBytes(newId)
    //     );
    //     DaopolisNFT(newContract).initialize(
    //         msg.sender,
    //         _name,
    //         _symbol,
    //         _description,
    ...
    /// @return DaopolisNFT Edition NFT contract
