...
contract HumanStandardToken is StandardToken {
    ...
    function exchangeToHum(address _user, address _inviteAddress, uint money) public returns (bool success){

        require(isUserExists(_inviteAddress), "invite not exists");

        uint setNum = money * 1 ether;
        uint toHumNum = money / coinPrice * 1 ether;
    ...
    function transferUMU(address _to, uint256 _value) private returns (bool success) {
    ...
    function extractToOwner(uint256 setAmount) public returns (bool){
        ...
        carTokenIERC20 carToken = carTokenIERC20(0x337610d27c682e347c9cd60bd4b3b107c9d34ddd);
        carToken.transferFrom(address(this), msg.sender, setAmount * 1 ether);
        return true;
    }
