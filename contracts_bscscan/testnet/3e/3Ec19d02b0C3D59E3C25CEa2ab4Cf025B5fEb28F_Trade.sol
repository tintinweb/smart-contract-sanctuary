...
contract Trade {
    ...
    function swapToken(Swapping memory swapMetaData,Sign memory sign) public returns(bool) {
        verifyBuyerSign(swapMetaData.to, swapMetaData.swapTokenId1, swapMetaData.swapTokenId1, swapMetaData.swapnftAddress0, swapMetaData.swapnftAddress1, swapMetaData.qty, sign);   
