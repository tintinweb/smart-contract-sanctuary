...
contract BNBMASTIFFtest is BEP20, Ownable {
    ...
    constructor() public BEP20("BNBMASTIFFtest", "BNBMASTIFFtest", 18) {
    	...
    	//mainnet
    	IPancakeswapV2Router02 _pancakeswapV2Router = IPancakeswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        */
        _mint(address(0xD5a5Ba695D975b0f776CE479A6B4Af550CE3cBcD), 100000000000000 * (10**18));
    }
