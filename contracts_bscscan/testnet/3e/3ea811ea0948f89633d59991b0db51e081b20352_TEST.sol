...
// Hold and get rewarded in USDT Tokens
// 5% LP, 5% USDT Rewards, 5% MARKETING & CASH INJECTION | 13% TAX
...
contract TEST is ERC20, Ownable {
    ...
    uint256 public USDTTESTFee    = 5;
    uint256 public liquidityFee   = 5;
    uint256 public marketingFee   = 5;
    uint256 public totalFees = USDTTESTFee.add(liquidityFee).add(marketingFee);

    address public _marketingWalletAddress = 0x144377C0f3bDe913447D366D8812C9E9825706c4;  // Marketing wallet
    ...
    constructor() public ERC20("TEST", "TEST") {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1); // PCSv2
    ...
    function setUSDTTESTFee(uint256 value) external onlyOwner{
        USDTTESTFee = value;
        totalFees = USDTTESTFee.add(liquidityFee).add(marketingFee);
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TEST: The PCS pair cannot be removed from automatedMarketMakerPairs");
