...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    address public immutable Ethereum = address(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca); //Ethereum Testnet
...
contract FomoETH is ERC20, Ownable {
    ...
    constructor() ERC20("FomoETH", "FomoETH") {
        ...
        updateUniswapV2Router(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Router testnet
    ...
    function getBuyFees() external view onlyOwner returns(uint256, uint256) {
        return (marketingFee, dividendFee);
    }

    function getSellFees() external view onlyOwner returns(uint256, uint256) {
        return (sellMarketingFee, sellDividendFee);
    }
