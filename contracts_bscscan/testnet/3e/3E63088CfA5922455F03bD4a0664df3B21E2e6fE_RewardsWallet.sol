...
contract RewardsWallet is Ownable, IRewardsWallet {
    ...
    function transfer(
        ...
        require(isOpen, "Transfer failed, can not use now");
        require(recipient != address(0), "Transfer failed, recipient is zero address");
        require(amount > 0, "Transfer failed, amount is zero");
