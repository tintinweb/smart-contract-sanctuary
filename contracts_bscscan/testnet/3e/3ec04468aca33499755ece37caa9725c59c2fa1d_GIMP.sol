...
contract GIMP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gimp";
    ...
    uint256 public numTokensSellToAddToLiquidity = 100 * 10**6 * 10**9;   //0.1%
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    function setThreshholdForLP(uint256 threshold) external onlyOwner {
      numTokensSellToAddToLiquidity = threshold * 10**6 * 10**9;
    }
