...
contract Lottery is StarlinkComponent, ShopItemFulfilment, PancakeSwapHelper, IDepositable {
    ...
    constructor(IXLD xld, IStarlinkEngine engine, IShop shop, IRandomNumberGenerator _randomNumberGenerator, ILeveling _leveling, address routerAddress) StarlinkComponent(xld, engine) ShopItemFulfilment(shop) PancakeSwapHelper(routerAddress) {
    ...
    function doClaim(address from, uint256[] calldata ticketIds) private {
        ...
        for(uint i = 0; i < ticketIds.length; i++) {
            ...
            require(!ticket.used, "Lottery: Already claimed");
            ticket.used = true;
