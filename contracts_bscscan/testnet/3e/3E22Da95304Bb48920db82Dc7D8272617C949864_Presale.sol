...
contract Presale {
    ...
    constructor() public {
        bscsDevAddress = payable(0x46B5862Cb841536719BCdcF7C7297dfD5895d12f);
        token = IERC20(0x81C179C3ef61181c098847401D0896B9512Dcf05);
        unsoldTokensDumpAddress = 0x46B5862Cb841536719BCdcF7C7297dfD5895d12f;

        totalTokens = 13 * 10 **4 * 10**18;
        tokensLeft = 13 * 10 **4 * 10**18;
        tokenPriceInWei = 0.0045 * 10**18;
        hardCapInWei = 3 * 10**18;
        softCapInWei = 2 * 10**18;
        maxInvestInWei = 10 * 10**18;
        minInvestInWei = 0.1 * 10**18;
        openTime = 1626267600;
        closeTime = 1626300000;
        whitelistedAddresses[0x46B5862Cb841536719BCdcF7C7297dfD5895d12f] = true;
        whitelistedAddresses[0x2320C99C295636025dBbD89c0B79121dF4c55040] = true;
        whitelistedAddresses[0xAFA3266ae838EcBeC98FfB1551111aB8E1716311] = true;
        whitelistedAddresses[0x2da6600674B171c97C6e6A58A2FE37a1fBafF85f] = true;
        whitelistedAddresses[0x5D2f92505bcbF6c3FD8B9C56F8f9541cdC8e7b4e] = true;
    }
