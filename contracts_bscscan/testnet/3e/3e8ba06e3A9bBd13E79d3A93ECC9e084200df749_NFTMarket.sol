...
contract NFTMarket is Ownable {
    ...
    constructor(address payable _feeWallet, address _nft)  {
   ...
   /**
    ...
    function placeOrder(uint256 _tokenId, uint256 _price, address _token) public {
        ...
        require(keccak256(abi.encodePacked(nftCore.getNFT(_tokenId).class)) == keccak256(abi.encodePacked("Zuki Hero")), "not a hero");
