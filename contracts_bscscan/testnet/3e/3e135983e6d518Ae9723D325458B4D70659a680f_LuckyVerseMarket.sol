...
contract LuckyVerseMarket is Classifieds(address(0), address(0)), ERC721Enumerable {
    ...
    event OpenTrade(address indexed poster, uint256 price, uint256 ad);
    event ExecuteTrade(address indexed seller, address indexed buyer, uint256 ad, uint256 price);
    event CancelTrade(address indexed poster, uint256 ad);

    constructor () ERC721("LuckyVerse Marketplace", "LUCKYVERSE-TRADE")  {
    }
