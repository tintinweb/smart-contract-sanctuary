...
/___/\__/\__/\_,_/_/_/_/ /___//_\_\\__/_//_/\_,_/_//_/\_, /\__/ 
	...
	#SteamX - https://steamexchange.ca
 	...
 	Total Fees: 13%
 	4% fee is added to the Steam Exchange platform wallet
 	2% fee is added to the marketing wallet
...
contract SteamX is Context, IERC20, Ownable {
    ...
    string private _symbol = "SteamXchange";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> SteamX swap when swap+liquify is triggered
