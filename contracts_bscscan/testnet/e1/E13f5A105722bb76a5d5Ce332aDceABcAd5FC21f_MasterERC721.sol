...
contract MasterERC721 is Initializable, OwnableUpgradeable {
  ...
  function createTokenERC721(
    ...
    require(s != address(0), "ERC721: address is not zero");

    iMasterERC721 = IMasterERC721(s);
    address child = iMasterERC721.createERC721(name, symbol, metadata);
    emit ChildCreatedERC721(_keyTypes, child, name, symbol, metadata);
