...
/* Crypto Ants Fossil Token - The main fuel of Crypto Ants Evolution, the first ever NFT Simulation Game in Binance Smart Chain
...
contract CryptoAntsFossil is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9aC134cEBCe957325Ae99968784E88fB3dCD143C); // Marketing Address
    address payable public charityAddress = payable(0x956d5065784969A6e7f55F317D8f8544FB0C8362); // Charity/Dev Address
    ...
    uint256 private _tTotal = 100000000 * 10**18; // 100 Million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Crypto Ants Fossil";
    string private _symbol = "CAF";
    uint8 private _decimals = 18;


    uint256 public _taxFee = 2; //Holders distribution  fee
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 50000000000000000000; // 50 CAF; token will be given on airdrop
