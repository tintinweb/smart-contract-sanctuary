...
contract StakeContract is Ownable {
    ...
    uint256 public rewardperblock = 1*10**6;
    ...
    function unstake(uint256 _amount) public updatePool {
        ...
        staketoken.safeTransfer(address(msg.sender), _stakedBalance[msg.sender]);
    ...
    function emergencyWithdraw() public {
        staketoken.safeTransfer(address(msg.sender), _stakedBalance[msg.sender]);
        totalpoolstacked = totalpoolstacked.sub(_stakedBalance[msg.sender]);
        _stakedBalance[msg.sender] = 0;
        _userReward[msg.sender] = 0;
        emit EmergencyWithdraw(msg.sender, _stakedBalance[msg.sender]);
    }
