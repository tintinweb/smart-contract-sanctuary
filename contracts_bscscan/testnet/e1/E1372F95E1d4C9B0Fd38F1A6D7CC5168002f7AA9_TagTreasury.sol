...
contract TagTreasury is TagRates {
    ...
    function setUserLevel(address _child, uint256 _level) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool) {
...
contract TagRates is AccessControl {
    ...
    function setQ(uint256 _Q) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool) {
        Q = _Q;
        return true;
    }
