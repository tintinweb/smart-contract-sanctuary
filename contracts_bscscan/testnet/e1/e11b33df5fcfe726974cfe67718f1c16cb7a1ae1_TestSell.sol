...
contract TestSell is Context, IBEP20, Ownable, Pauseable {
    ...
    address private _charityWalletAddress = 0xB3fACb1aB11f25892f30d466e8ed9097B2F6aa55; // Multisig wallet
    ...
    string private _name = "Test Sell";
    string private _symbol = "SELL";
    ...
    function _transfer(
        ...
        address to,
        uint256 amount
    ) private isPausedOverride isBlackedListed(from, to) {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Temporarily remove fees to transfer to charity address
        _taxFee = 0;
        _liquidityFee = 0;
