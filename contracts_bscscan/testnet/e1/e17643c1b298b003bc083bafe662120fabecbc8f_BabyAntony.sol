...
// BabyAntony on BSC for all the Antony that wanted cheap transfers and swaps! 
...
contract BabyAntony is Context, IERC20, Ownable {
    ...
    string private _name = 'BabyAntony Token';
