    ...
    function withdrawalFarmYield(uint256 _farmId,uint256 _index) public returns (bool) {
        ...
        if(_farmId==1){
            ...
            if(order.exitProfitIndex==0){
                ...
                oneFarmOrders[_index].profitAmount = 2;// Finish the last extraction
            }
            ...
            emit WithdrawalFarmYield(msg.sender,_farmId, profitAmount);// set log
            ...
            if(order.exitProfitIndex==0){
                ...
                twoFarmOrders[_index].profitAmount = 2;// Finish the last extraction
            }
