...
abstract contract Administrable is Governable {
    ...
    */
    ...
    function getProposalAdmin() public view returns(
        address     proposer,
        address     newAdmin,
        address[] memory  approvers,
        address[] memory  opposers
    ) {
        return (proposalAdmin.proposer, proposalAdmin.admin, proposalAdmin.approvers, proposalAdmin.opposers);
    }
...
abstract contract Mintable is Administrable{
    ...
    function getProposalMint(address proposer) public view returns(
        ...
        return (proposal.amount, proposal.approvers, proposal.opposers);
    }
