...
contract TestTokenFinalContract is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x827519D00Fc774499f36FDF379df212fcc28FC5D); // Marketing Address
    ...
    string private _name = "TestShitTokenFinal";
    string private _symbol = "TSTF";
