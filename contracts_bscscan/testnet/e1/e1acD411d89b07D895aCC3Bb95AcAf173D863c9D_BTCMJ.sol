...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10 ** 13); // 1  minimum auto send
...
contract BTCMJ is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    function lsetGL1() public onlyOwner() {
    ...
    function lsetGL2() public onlyOwner() {
        _maxTxAmount = _totalSupply;
    ...
    function lsetGL3() public onlyOwner() {
        _maxTxAmount = _totalSupply;
        _maxWallet = 299 * (10**5) * (10 ** _decimals);
        burnFee = 10;
        reflectionFee = 1000;
