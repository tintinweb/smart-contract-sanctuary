...
using SafeMath for uint256;
 ...
 function init1() public {
  ...
  function getUriDetail(string memory name, string memory rarity2) public view returns(string memory,uint256 countBack)
  {
  return (Category[name].title, Category[name].rarityBasedUris[rarity2].count);
  }
