...
1. Token name: Hidden Global 
2. Token Symbol: $HDDN 
3. Decimals: 18 
4. Total Supply: 281.113.000 
5. ICO capacity. (Dxsale) 
6. Binance Quality Smart Contract. 
7. Non-Mineable. 
8. All tokens avaliable from the creation of this. 
9. Listing on exchanges capacity. 
10. NON deflactionary token, just transfer capacity to a burn addreess. 
11. TOP Security and audited smart contract. 
12. Verified Smart Contract. With full ownership and source code Owner will bear gas fees for mainnet deployment
*/
