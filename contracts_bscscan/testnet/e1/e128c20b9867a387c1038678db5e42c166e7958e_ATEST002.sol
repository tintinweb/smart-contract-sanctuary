...
contract ATEST002 is Context, IERC20, Ownable {
    ...
    address private _prWalletAddress = 0x59F77bfeeb6FCec14695b3944b8ef647FE1a1495;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ATest 002";
    string private _symbol = "ATST002";
