...
contract TreatDAOContract is ERC20, Ownable {
    ...
    mapping(address => bool) public isAddressTaxed;
    ...
    constructor(
        ...
        // set the pair and router as taxed addresses

        pancakeRouter = _pancakeRouter;
        taxedContracts.push(_pancakeRouter);
        taxedContracts.push(uniswapV2Pair);
        isAddressTaxed[uniswapV2Pair] = true;
        isAddressTaxed[pancakeRouter] = true;
    ...
    */
    function calculateTokenFee(
        ...
        for(uint i=0; i < taxedContracts.length; i++) {
            if(taxedContracts[i] == _to || taxedContracts[i] == _from) {
                isTaxed = true;
