...
contract DaxGameToken is Context, IERC20, Ownable {
    ...
    string private _name = "DaxGame";
    string private _symbol = "DAX";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 circulatingSupply = _tTotal - balanceOf(address(0)); //Total supply - death address balance
 
        if(circulatingSupply <= 1000000000 * 10**9){
            _burnFee = 0;
            _taxFee = 0;
            _liquidityFee = 0;
        }
