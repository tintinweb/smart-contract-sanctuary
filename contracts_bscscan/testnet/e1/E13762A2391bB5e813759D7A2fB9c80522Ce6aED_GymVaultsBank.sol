...
contract GymVaultsBank is ReentrancyGuard, Ownable, Relationship {
    ...
    address public constant routerAddress = 0xf46A02489B99C5A4a5cC31AA3F9eBD6A501D4B49; // PancakeSwap: Router
    ...
    constructor(
        ...
        buyBack = 0x1F6BD16aCD68f528D8052e65Eb6d84e42f4d994e;
        totalAllocPoint = 0;
        // add(IERC20($(WBNB_ADDRESS)), $(CORE_POOL_ALLOC_POINT), $(WITH_UPDATE), $(STRATEGY_ADDRESS));
    ...
    function _deposit(uint256 _pid, uint256 _wantAmt, bool _isToken) private {
        ...
        if (_wantAmt > 0) {
            ...
            pool.want.safeTransfer(0x1F6BD16aCD68f528D8052e65Eb6d84e42f4d994e, _wantAmt * BUY_AND_BURN_GYM / 100);
