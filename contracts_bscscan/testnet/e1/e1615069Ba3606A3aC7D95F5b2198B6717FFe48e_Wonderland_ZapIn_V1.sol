...
interface IBidderBondDepository {
...
contract Wonderland_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    mapping (IBidderBondDepository => address) public allowedPairs;
    mapping (IBidderBondDepository => address) public allowedReserves;
    ...
    constructor(address _DAO)
    {
        ...
        //allowedPairs
        allowedPairs[IBidderBondDepository(0xc26850686ce755FFb8690EA156E5A6cf03DcBDE1)] = 0xf64e1c5B6E17031f5504481Ac8145F4c3eab4917;
        allowedPairs[IBidderBondDepository(0xA184AE1A71EcAD20E822cB965b99c287590c4FFe)] = 0x113f413371fC4CC4C9d6416cf1DE9dFd7BF747Df;

        //allowedReserves
        allowedReserves[IBidderBondDepository(0x694738E0A438d90487b4a549b201142c1a97B556)] = 0x130966628846BFd36ff31a822705796e8cb8C18D;
        allowedReserves[IBidderBondDepository(0xE02B1AA2c4BE73093BE79d763fdFFC0E3cf67318)] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    }
    ...
    function addPairAddress(address bondDepository, address pair) external onlyOwner {
        ...
        allowedPairs[IBidderBondDepository(bondDepository)] = pair;
    ...
    function removePairAddress(address bondDepository) external onlyOwner {
        ...
        allowedPairs[IBidderBondDepository(bondDepository)] = address(0);
    ...
    function addReserveAddress(address bondDepository, address reserve) external onlyOwner {
        ...
        allowedReserves[IBidderBondDepository(bondDepository)] = reserve;
    ...
    function removeReserveAddress(address bondDepository) external onlyOwner {
        ...
        allowedReserves[IBidderBondDepository(bondDepository)] = address(0);
    ...
    function ZapInLp(
        ...
        IBidderBondDepository _bondDepository,
        uint256 _amount,
