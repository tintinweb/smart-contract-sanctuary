...
interface INonFungibleApesHelper {
    ...
    function isTier1(uint256) external view returns (bool);
    function isTier2(uint256) external view returns (bool);
    function isTier3(uint256) external view returns (bool);
    function isTier4(uint256) external view returns (bool);
    function isTier5(uint256) external view returns (bool);
...
contract NFAStaking is Ownable, Initializable {
    ...
    function  validNFt(uint256 _id) public view returns (bool) {
        if (TIER == 1) {
            return NFA_TIERS.isTier1((_id));
        } else if (TIER == 2) {
            return NFA_TIERS.isTier2((_id));
        }  else if (TIER == 3) {
            return NFA_TIERS.isTier3((_id));
        }  else if (TIER == 4) {
            return NFA_TIERS.isTier4((_id));
        }  else if (TIER == 5) {
           return  NFA_TIERS.isTier5((_id));
        }
        return false;
    }
