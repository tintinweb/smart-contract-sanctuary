...
contract tokenSwap {
	...
	address public WBNBaddress = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;  //Testnet WBNB
	address public tokenaddress = 0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5;  //Testnet BAKE
	address public finaladdress = 0x27b6B7245F0Df46F5CE35658B2AEeb97D0f64912;  //Testnet BAKE
	uint256 private constant amountOutMinTest = 1000;
	...
	function buySwapT1() external {
		...
		address[] memory buyPath;
		buyPath = new address[](2);
		buyPath[0] = WBNBaddress;
		buyPath[1] = tokenaddress;

        address[] memory sellPath;
		sellPath = new address[](2);
		sellPath[1] = WBNBaddress;
		sellPath[0] = tokenaddress;

        IUniswapV2Router(UNISWAP_V2_ROUTER).swapExactETHForTokensSupportingFeeOnTransferTokens{value: BNBin}(amountOutMinTest, buyPath, finaladdress, block.timestamp);
