...
contract MintContract is Ownable {
    ...
    function mintFromReferral(address _address) public {
        ...
        require(gfx_.balanceOf(msg.sender) > 0, "MintContract: No GFX");
        require(!invitor[msg.sender], "MintContract: Mint failed");
        ...
        emit NewInvitor(_address, msg.sender);
    }

    function claimAward() public {
        require(referrals[msg.sender] > 0, "MintContract: No referral");
        ...
        require(
            gfx_.transfer(msg.sender, amount + 1),
            "MintContract: Transfer failed"
        );
