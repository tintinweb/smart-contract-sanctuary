...
contract HungerToken is Context, IERC20, Ownable {
    ...
    function includeInReward(address account) external onlyOwner {
        ...
        if(balance > 0) {
            ...
            _reflectionBalance[account] = balance * reflectionRate;

            _reflections.reflectionsCirculating += uint128(balance * reflectionRate);
            _reflections.reflectionSupply += uint128(balance * reflectionRate);
        }
    }
    ...
    function excludeFromReward(address account) external onlyOwner {
        ...
        uint256 balance = _reflectionBalance[account];
        ...
        if (balance > 0) {
            ...
            _tokenBalance[account] = balance / reflectionRate;
