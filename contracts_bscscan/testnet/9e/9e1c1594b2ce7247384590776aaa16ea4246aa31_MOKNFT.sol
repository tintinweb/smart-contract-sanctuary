...
contract MOKNFT is ERC721Pausable, AccessControl, Ownable {
  ...
  mapping(uint256 => TokenData) private _tokenData;
    ...
    function mint(address to, string memory _tokenURI,uint32 royalty) public payable returns (uint256 tokenId) {
