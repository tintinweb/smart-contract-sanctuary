...
contract VaultProxy is VaultAdminStorage, VaultErrorReporter {
    ...
    /**
      * @notice Emitted when pendingVaultImplementation is accepted, which means LP Vault implementation is updated
      */
...
contract VaultStorage is VaultAdminStorage {
    ...
    /// @notice The vault TOKEN! Can be LP contract or an single token
    IBEP20 public vaultAsset;
