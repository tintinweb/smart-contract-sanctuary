...
interface IRewardsDistributor {
    ...
    function updateBitridesTotals() external payable;
...
contract RewardsDistributor is IRewardsDistributor {
    ...
    function updateBitridesTotals() external payable override onlyToken {
    ...
    function updateWBNBTotals() external payable override onlyToken {
...
contract BitRides is IBEP20, Ownable {
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        try distributor.updateBitridesTotals{value: ridesReflectionFee}() {} catch {}
    ...
    function swapBack() internal swapping {
        ...
        try distributor.updateWBNBTotals{value: amountBNBReflectionWBNB}() {} catch {}
