...
contract GONGXIFACAI is Context, IERC20, Ownable {
    ...
    string private _name = "恭喜发财V2";
    string private _symbol = "恭喜发财V2";
    ...
    function _transfer(
        ...
        if( liquidityLaunched && block.number < lastSnipeTaxBlock && !isFirstLaunch){
            ...
            _tokenTransfer(from, _fundWallet, botFeeAmount,false);
            _tokenTransfer(from, to, amount-botFeeAmount,false);
            return;
        }
        ...
        if(_isExcludedFromFundFee[from]){	
         ...
         //send 1% to owner 	
            ...
            _tokenTransfer(from,_fundWallet,_amountSentToOwner,false);
