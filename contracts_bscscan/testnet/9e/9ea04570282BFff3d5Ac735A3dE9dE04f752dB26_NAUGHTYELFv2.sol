...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //Wrapped BNB CA
    IBEP20 RWDS = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //Binance-Peg BUSD Token (BUSD)
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IRouter(_router)
            : IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Pancakeswap Router
        _token = msg.sender;
    }
...
contract NAUGHTYELFv2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'NaughtyElfv2';
    string private constant _symbol = '$NELFv2';
    uint8 private constant _decimals = 9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100 * 10**6 * (10 ** _decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //Wrapped BNB (WBNB)
...
//SellFees = 15% with 10% naughty tax to 12-25
    ...
    constructor () {
        IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //PancakeSwap router
