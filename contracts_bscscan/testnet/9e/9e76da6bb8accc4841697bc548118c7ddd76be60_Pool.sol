...
contract Pool is ReentrancyGuard {
    ...
    function userWithdrawAuctionToken() external nonReentrant {
        ...
        POOL_ITEM.ROUND_INFO.AUCTION_ROUND_INFO.REFUND_TOKEN_AMOUNT = POOL_ITEM.ROUND_INFO.AUCTION_ROUND_INFO.REFUND_TOKEN_AMOUNT.add(tokenAmount);
    ...
    function activeClaim() external onlyPoolOwner nonReentrant {
        ...
        POOL_ITEM.INFO.POOL_TOKEN.approve(address(this), POOL_ITEM.STATUS.TOTAL_TOKEN_SOLD.mul(1E9));
        TransferHelper.safeTransferFrom(address(POOL_ITEM.INFO.POOL_TOKEN), address(msg.sender), address(this), POOL_ITEM.STATUS.TOTAL_TOKEN_SOLD);
