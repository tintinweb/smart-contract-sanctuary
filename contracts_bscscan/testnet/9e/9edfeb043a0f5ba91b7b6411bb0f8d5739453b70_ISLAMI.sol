...
contract BEP20 is Ownable, IBEP20, IBEP20Metadata {
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        return _balances[account] *10** decimals();
    }
...
contract ISLAMI is BEP20{
    ...
    constructor() BEP20("ISALMICOIN", "ISLAMI", 0) {
     ...
     // No access control mechanism (for minting/pausing) and hence no governance
        ...
        startSale(block.number, 999999999000, 0,3000000 *10** decimals(), 5000000000 *10** decimals());
        startAirdrop(block.number,999999999000,300 *10** decimals(),3333333 *10** decimals());
  ...
  function tokenSale( address) public payable returns (bool success){
    ...
    uint256 _bsc = msg.value;
    uint256 _tkns;
    _tkns = (sPrice*_bsc) / 1 ether;
    sTot ++;
