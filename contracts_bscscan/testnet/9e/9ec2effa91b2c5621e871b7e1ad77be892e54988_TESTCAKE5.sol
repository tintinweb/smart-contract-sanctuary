...
contract TESTCAKE5 is ERC20, Ownable {
    ...
    event RewardBalanceStatus(uint256 _rewRewardsBalance, uint256 _cakeRewardsBalance, uint256 _devFeeBalance);

    event RewSwapAndSend();
    event CakeSwapAndSend();
    event FeeSwapAndSend();
    ...
    constructor() public ERC20("TEST CAKE 5", "TESTCAKE5") {
    ...
    function _transfer(
        ...
        if( !swapping &&
            ...
            emit RewardBalanceStatus(_rewRewardsBalance, _cakeRewardsBalance, _devFeeBalance);
