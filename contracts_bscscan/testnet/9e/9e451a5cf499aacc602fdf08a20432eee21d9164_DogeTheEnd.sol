...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public REWARD = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274);
...
contract DogeTheEnd is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint public sellPerSecond = 15;
    uint public buyPerSecond = 15;
   
    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; // 5000
    ...
    uint256 public swapThreshold = _totalSupply / 198; 
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _development = 0xD12ee8533D842dB7f02690477fE980422b1b106C;
