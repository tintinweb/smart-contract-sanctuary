...
Earn Bogged without getting rugged!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BOG = IERC20(0xB09FE1613fE03E7361319d2a43eDc17422f36B09);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BOG.balanceOf(address(this));
        ...
        uint256 amount = BOG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BOG.transfer(shareholder, amount);
...
contract SafeDOGGED is IERC20, Ownable {
    using SafeMath for uint256;

    address BOG = 0xB09FE1613fE03E7361319d2a43eDc17422f36B09;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SafeDOGGED";
    string constant _symbol = "SDOGGED";
