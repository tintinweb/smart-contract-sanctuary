...
Website: testcrypto.com

TG: https://t.me/testV2

INSTAGRAM : https://www.instagram.com/test_crypto/

Twitter: https://twitter.com/test7

Twitch: https://www.twitch.tv/test_official

Audit: https://github.com/solidproof/smart-contract-audits/blob/main/SmartContract_Audit_Solidproof_test.pdf
*/
...
// File: contracts/testv2DividendPayingToken.sol
...
// File: contracts/testv2.sol

// 

pragma solidity ^0.7.6;

contract testv2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    testv2DividendTracker public dividendTracker;
    ...
    constructor() public ERC20("dica", "dc") {
        // LP burn address
        ...
        dividendTracker = new testv2DividendTracker();
   ...
   // contract developed by snipe.finance
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(dividendTracker), "testv2: The dividend tracker already has that address");

        testv2DividendTracker newDividendTracker = testv2DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "testv2: The new dividend tracker must be owned by the testv2 token contract");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "testv2: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        //require(_isExcludedFromFees[account] != excluded, "testv2: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "testv2: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "testv2: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "testv2: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "testv2: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "testv2: This account cannot send tokens until trading is enabled");
        }
...
contract testv2DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("testv2_Dividend_Tracker", "testv2_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "testv2_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "testv2_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main testv2 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "testv2_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "testv2_Dividend_Tracker: Cannot update claimWait to same value");
