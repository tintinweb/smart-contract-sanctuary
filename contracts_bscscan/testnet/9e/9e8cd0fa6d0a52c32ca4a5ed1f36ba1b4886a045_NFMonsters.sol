...
// NFMonters - Play to Earn - Playing is already good, earning with it is even better!

// Website: https://nfmonsters.com/
// Telegram: https://t.me/nfmonsters
// Telegram Ann.: https://t.me/nfannouncs
// Twitter: https://twitter.com/nf_monsters
...
/**
 * @dev Interface of the BIP20 standard as defined in the EIP.
 */
interface IBIP20 {
    /**
...
contract NFMonsters is Context, IBIP20, Ownable {
    ...
    string private _name = 'NFMonsters';
    string private _symbol = 'NFMON';
    ...
    function CurrentTaxFee() public view returns (uint256) {
        return _taxFee;
    }
    function CurrentBurnFee() public view returns (uint256) {
        return _burnFee;
    }
    function CurrentMaxAmount() public view returns (uint256) {
        return _maxTxAmount;
    }
    ...
    function excludeAccount(address account) external onlyOwner() {
        //require(account != 0xA7D969da551D2E66206dBa365f8b785eFAd2160e, 'We can not exclude Pancake router.');
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 100e9 , 'maxTxAmount should be greater than 100e9');
