...
contract Ownable is Context {
    ...
    /**
     * @dev Returns the address of the current owner. It is private because owner can also be seen from _owner function which is public.
     */
...
contract FLOWER is Context, IBEP20, Ownable {
    ...
    string  public Website = "www.google.org";
    ...
    function Total_DistributedToHolders() public view returns (uint256) {
        return _tFeeTotal;
    }
    ...
    function Total_LiquidityGeneratedandLocked() public view returns (uint256) {
        return _tLiquidityPoolTotal;
    }
    
    function BURN_FEE() public view returns (uint256) {
        return _BURN_FEE / 100;
    }
    
    function LIQUIDITY_FEE() public view returns (uint256) {
        return _LIQUIDITYPOOL_FEE / 100;
    }
    
    function REWARD_FEE() public view returns (uint256) {
        return _TAX_FEE / 100;
    }
