...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x79D38EfCE0C6b0f1a085C0535D1aD2f2Ead89BDD;
...
contract Oasis is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x82F80Cac527249a95D3750B90cf128C461E6a7EA;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Oasis";
    string private _symbol = "OAS";
