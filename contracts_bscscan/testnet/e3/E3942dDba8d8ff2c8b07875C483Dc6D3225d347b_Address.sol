...
contract RedeemPackage is Ownable {
    ...
    address public addressBurn = 0x0000000000000000000000000000000000001000;
    string uri = "https://s2.coinmarketcap.com/static/img/coins/64x64/1.png";
    ...
    function faucetNewPackage(uint256 tokenId) public {
        tokenerc721.mint(msg.sender, tokenId, uri);
        emit faucetPackage(
            msg.sender,
            tokenId,
            uri
