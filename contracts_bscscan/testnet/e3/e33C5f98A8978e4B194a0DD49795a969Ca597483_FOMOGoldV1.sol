...
abstract contract Tokenomics {
    ...
    address internal miscFeeAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    address internal moonbaseFundAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    address internal fudFightersFundAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    address internal refundInsuranceAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    address internal raffleAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    address internal rainyDayFundAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    address internal collegeFundAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    address internal gambleFundAddress = 0x959FD7Ef9089B7142B6B908Dc3A8af7Aa8ff0FA1;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 10, miscFeeAddress ); // Shipping and Handling fees
        _addFee(FeeType.External, 25, moonbaseFundAddress ); // Wen moon? Planning early.
        _addFee(FeeType.External, 35, fudFightersFundAddress ); // FUD Fighters protect against disinformation
        _addFee(FeeType.External, 50, refundInsuranceAddress ); // In case of product failures or recalls
        _addFee(FeeType.External, 15, raffleAddress ); // For raffles, giveaways, community-specific rewards
        _addFee(FeeType.External, 15, rainyDayFundAddress ); // In case of emergency
        _addFee(FeeType.External, 25, gambleFundAddress ); // Ideally used up _before_ college fund
        _addFee(FeeType.External, 25, collegeFundAddress ); // Sending YOUR kids to college
...
abstract contract Presaleable is Manageable {
    ...
    function setPresaleEnabled(bool value) external onlyManager {
        isInPresale = value;
    }
}
