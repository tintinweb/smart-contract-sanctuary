...
interface IWhiteList {
    ...
    function getClaimStatus(address _add) external view returns(bool);
    function setClaimed(address user) external returns(bool);
}
...
contract Monster is ERC1155, Ownable{
    ...
    IWhiteList private _white = IWhiteList(0xd3c300f26D919d4134A8719979299b23266DCFFC);
    ...
    //address private oracle = "0xda4714fee90ad7de50bc185ccd06b175d23906c1";
    
    uint256 public totalCount = 90000;
    uint256 public totalSupply = 0;

    event ClaimWhiteNft(address addr, uint256 coinType);
    ...
    constructor() public ERC1155("https://game.example/api/item/{id}.json") {
        ...
        _supplyCount[7] = 45000;  //map
        _tokenUri[7] = "https://upgrade.ozlys.com/icon8/icon2.png";
    }
    ...
    function setWhiteContract(address contractAddr) public onlyOwner {
        _white = IWhiteList(contractAddr);
    }
    ...
    function buyCoin(uint256 numberOfNfts, uint256 coinType) public payable returns(bool) {
        ...
        for (uint i = 0; i < numberOfNfts; i++) {
            _userTokens[msg.sender].push(tokenInfo(coinType, totalSupply.add(i).add(1), block.timestamp));
        }
    ...
    function claimWhite() public returns(uint256) {
        require(isWhiteOpen, "activity not exist.");
        require(!_white.getClaimStatus(msg.sender), "areadly claimed");
        ...
        _white.setClaimed(msg.sender);
        _userTokens[msg.sender].push(tokenInfo(coinType, totalSupply, block.timestamp));

        emit ClaimWhiteNft(msg.sender, coinType);
        return coinType;
    }
