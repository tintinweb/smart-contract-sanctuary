...
contract TESTPMMT is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "TESTPMMT"; // token name
    string private _symbol = "TPM"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 10080 minutes; // duration betweeen each buyback
    ...
    uint256 public _maxTokensPerAddress          = _tTotal.div(1000); // Max number of tokens that an address can hold
