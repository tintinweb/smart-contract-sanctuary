...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function multiTransferFrom(address from, address to, uint256[] memory tokenIds) public virtual {
    ...
    ERC721URIStorage
{
    ...
    event Burn(address indexed from, address indexed to, uint256 indexed tokenId);
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Enumerable, AccessControlEnumerable, ERC721) returns (bool){
    ...
    function mintMulti(uint256[] memory tokenId, address to) public virtual {
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),"ERC721: must have admin role to set Token URIs");
