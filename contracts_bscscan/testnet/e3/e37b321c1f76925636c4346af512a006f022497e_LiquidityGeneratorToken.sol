...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        _name = "Vojta je pica, inu";
        _symbol = "VOJTAJEPICAINU";
        uint8 decimal = 18;
        uint256 totalTokens = 100000000000;
        uint8 setTaxFee = 2;
        uint8 setLiqFee = 2;
        uint256 DEC = 10**uint256(decimal);
        uint256  _totalSupply = totalTokens * DEC;


        uint256 amountOfTokenWei = _totalSupply;

        uint256 _maxTaxFee = 10;
        uint256 _maxLiqFee = 10;
        uint256 _minMxTxPer = 50;
