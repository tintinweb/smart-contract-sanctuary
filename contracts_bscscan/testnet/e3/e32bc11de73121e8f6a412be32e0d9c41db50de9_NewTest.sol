...
contract NewTest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FiverrTest";
    string constant _symbol = "FIVERRTEST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000000000000 * (10 ** _decimals);
    ...
    uint256 reflectionFee   = 3;                // holder
    uint256 marketingFee    = 2;                // marketing
    uint256 charityFee      = 4;                // charity
    uint256 public totalFee = 12;
    uint256 feeDenominator  = 100;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver = 0x0e828bcb636D35a8752e7133Dcec7D0FE3d3b29d; 
    address public charityFeeReceiver   = 0xeBF114B7B2c754baDfeA4BE1Ee02662f47C7470E;
