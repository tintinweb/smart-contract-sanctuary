...
contract Mafagafo is Context, IERC20, Ownable {
    ...
    function startLiquidity(address router) public returns (bool) {
    ...
    function _getRValues(
        ...
        if (swapAndLiquifyEnabled) {
            rTransferAmount = rAmount.sub(rLiquidity);
        } else {
