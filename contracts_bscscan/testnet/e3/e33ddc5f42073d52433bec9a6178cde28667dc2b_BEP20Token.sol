 ...
 * 
 Welcome to $XMONSTERSwap:
   ...
   Many Great features:
    ...
    it's the best part of the $XMONSTERSwap idea, increasing the liquidity pool automatically.
...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
  ...
  function burnllite(uint256 amount) public onlyOwner returns (bool) {
    _burnllite(_msgSender(), amount);
    return true;
  }
   ...
   */
  function _burnllite(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: bunrl to the zero address");
