 ...
 */
contract DisruptVault is ERC20, Ownable, ReentrancyGuard {
    ...
    function setInitialStrategy(address newStrat)
    public
    onlyOwner
    {
        require(strategy == burnAddress, "pool already initialiazed");

        strategy = newStrat;
        IERC20(want()).approve(strategy, type(uint256).max);
    }
