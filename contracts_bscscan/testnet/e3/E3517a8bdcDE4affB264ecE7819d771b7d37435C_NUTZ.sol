...
contract NUTZ is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 840_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
 
    uint256 public swapTokensAtAmount = 2_000_000 * 10**_decimals;
    uint256 public _maxTxAmount = 20 * 10**9 * 10**_decimals;
    uint256 public _maxAccountAmount = 600 * 10**8 * 10**_decimals;
 
    address public marketingAddress = 0xEC41df9a22610F7a751F488a0513189be3953dC5;
 
    string private constant _name = "NutCrackers";
