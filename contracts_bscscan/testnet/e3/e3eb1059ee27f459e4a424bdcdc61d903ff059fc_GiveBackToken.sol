...
/**
   ...
   3% fee auto distribute to all holders in WBNB
   4% fee auto moved to charity wallet WBNB
   2% fee auto moved to marketing wallet WBNB
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private Reward = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); 
    ...
    // This is to switch between mainnet and testnet
...
contract GiveBackToken is IBEP20, Auth {
    using SafeMath for uint256;
    
    address private Reward = WBNB; 
    address private WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address private DEAD = 0x000000000000000000000000000000000000dEaD;
    address private ZERO = 0x0000000000000000000000000000000000000000;
    

    string constant _name = "GiveBackTTT";
    string constant _symbol = "GiveBackTTT";
    uint8 constant _decimals = 9;

    //anti-whale function
    uint256 private _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 100;           // max buy / sell in one transaction (here is 5%)
    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 100;    // max wallet holding of 10% 
    ...
    uint256 public liquidityFee    = 3;                // liquidity pool
    uint256 public reflectionFee   = 3;                // holder
    uint256 public marketingFee    = 2;                // marketing
    uint256 public charityFee      = 4;                // charity
    uint256 public totalFee = 12;
    uint256 private feeDenominator  = 100;

    address private autoLiquidityReceiver;
    address public marketingFeeReceiver = 0x38651D737700d3Ec1C2094de0261AF440875c24d; 
    address public charityFeeReceiver   = 0x0DfcED54C350123A762c671aA6CD63e271f0Cf30;
    ...
    bool public buyCooldownEnabled = true;  //45 sec between transactions(uint156 is in seconds)
    ...
    // enable cooldown between trades   //what are the units of time interval
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess2,) = payable(charityFeeReceiver).call{value: amountBNBcharity, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _charityFee) external authorized {
