...
contract WOWSummit is ERC721 {
    ...
    modifier onlyAuction() {
        require(msg.sender == auction, "WOWSummit: wrong contract");
        _;
    }
    ...
    constructor() public ERC721("WOWSummit", "WOWSummit") {
        dev = msg.sender;
    }
    ...
    function addAuction(address _auctionAddress) public {
        require(msg.sender == dev, "WOWSummit: Wrong call");
        require(
            auction == address(0),
            "WOWSummit: Auction contract already added"
        );
