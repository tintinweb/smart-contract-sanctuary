...
contract preSaleBnb is ReentrancyGuard {
    ...
    function initialize(
        ...
        token = _token;
        tokenPrice = parameters[1];//_tokenPrice;
        preSaleTime = parameters[2];//_presaleTime;
        initialClaimPercent = parameters[3];//_initialClaimPercent;
        vestingPercent = parameters[4];//_vestingPercent;
        refPercent = parameters[5];//_refPercent;
        minAmount = parameters[6];//_minAmount;
        maxAmount = parameters[7];//_maxAmount;
        hardCap = parameters[8];//_hardCap;
        softCap = parameters[9];//_softCap;
        listingPrice = parameters[10];//_listingPrice;
        liquidityPercent = parameters[11];//_liquidityPercent;
        totalClaimCycle = parameters[12];//_totalClaimCycle;
    }
