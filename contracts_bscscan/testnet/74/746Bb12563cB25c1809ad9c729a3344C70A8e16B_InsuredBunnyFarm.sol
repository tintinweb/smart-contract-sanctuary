...
contract InsuredBunnyFarm is Ownable, ReentrancyGuard {
    ...
    ERC20 constant bunny = ERC20(0x8B0c01a3a6C3cE63429BCEBb8c5887dc540a7385);
    ERC20 constant wbnb = ERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    ...
    ChipsStaking chipsStaking = ChipsStaking(0x4CF87a9FDd9306f80f64F46f2eA82192e9138D5B);
    BunnyPool constant bunnyPool = BunnyPool(0x2b8a43F1Fa9e3eD032834581Ba0b5125e2451c24);
    
    OracleSimpleBNBBunny bunnyTwap = OracleSimpleBNBBunny(0x5F0C52D3Bf129B0eb9C65d1522320B16C07982e4);
    OracleSimpleBNBchips chipsTwap = OracleSimpleBNBchips(0xc97cFD7624deCEDC67d54D69aCA4681f07b9C8cB);
    UniswapV2 ape = UniswapV2(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    CookieGovernance governance = CookieGovernance(0xfd43eC9f3a0D866DEe736Ecd20D77f210E6F3C87);
    ...
    constructor() public {
        ...
        bunny.approve(address(ape), 2 ** 255);
