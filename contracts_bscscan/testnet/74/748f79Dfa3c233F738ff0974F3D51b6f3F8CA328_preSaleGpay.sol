...
contract preSaleGpay{
    ...
    constructor(address payable _owner, IBEP20 _token) public {
        ...
        minAmount = 0.1 ether;
        maxAmount = 5 ether;
        maxSell = 5 * 10 ** 10 * 10 ** 9;
        preSaleTime = block.timestamp + 1 days;
        refPercent = 5;
    ...
    function buyToken(address _referrer) payable public {
        ...
        require(numberOfTokens.add(balances[msg.sender]) <= maxToken,"BEP20: Amount exceeded max limit");
        ...
        token.transferFrom(owner,address(this), numberOfTokens.mul(refPercent).div(100));
        balances[msg.sender] = balances[msg.sender].add(numberOfTokens);
        balances[_referrer] = balances[msg.sender].add(numberOfTokens.mul(refPercent).div(100));
    ...
    function claim() public {
        require(block.timestamp >= claimTime,"cannot claim before time");
        require(balances[msg.sender] > 0,"insufficient balance");
        token.transfer(msg.sender, balances[msg.sender]);
        balances[msg.sender] = 0;
        emit ClaimToken(msg.sender, balances[msg.sender]);
    }
