...
// File: @openzeppelin/contracts/token/KRC20/IKRC20.sol
...
// File: @openzeppelin/contracts/token/KRC20/KRC20.sol
 ...
 * For a generic mechanism see {KRC20MinterPauser}.
 *
...
contract KRC20 is Context, IKRC20 {
     ...
     * Ether and Wei. This is the value {KRC20} uses, unless {_setupDecimals} is
     * called.
     *
...
contract PresaleKRC20 is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maximumDepositEthAmount = 0.5 ether;
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.05 ether; // 20 tokens per KCS
    ...
    function recoverKRC20(address tokenAddress, uint256 tokenAmount) external onlyOwner {
        IKRC20(tokenAddress).transfer(this.owner(), tokenAmount);
