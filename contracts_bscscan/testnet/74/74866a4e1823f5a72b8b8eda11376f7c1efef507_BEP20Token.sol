...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  string private constant _symbol = "TSWIFTY11";
  ...
  function swapTokensForBNB(address sourceOfTokens, address receiverOfBnb, uint256 tokenAmount) private lockSwapping {
