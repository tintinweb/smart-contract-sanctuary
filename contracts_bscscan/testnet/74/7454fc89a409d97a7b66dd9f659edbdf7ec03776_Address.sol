...
`7MMF'     A     `7MF'`7MMF'     A     `7MF'    `7MMF'    `7MMF'    `7MMF'
  `MA     ,MA     ,V    `MA     ,MA     ,V        MM        MM        MM
   VM:   ,VVM:   ,V      VM:   ,VVM:   ,V         MM        MM        MM
    MM.  M' MM.  M'       MM.  M'
      ::::::::::: ::::    ::: :::    :::
         :+:     :+:+:   :+: :+:    :+:
        +:+     :+:+:+  +:+ +:+    +:+
...
########### ###    ####  ########
MM.  M'         MM        MM        MM
    `MM A'  `MM A'        `MM A'  `MM A'          MM        MM        MM
     :MM;    :MM;          :MM;    :MM;           MM        MM        MM
      VF      VF            VF      VF          .JMML.    .JMML.    .JMML.


https://t.me/worldwar3inu

Created by @FDASHO as part of Memeconics.
...
contract letsgo is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x0EE0b7A343Fb546c55D8FbbB0eC18BC73634e1CA); // Marketing Address

    address payable public teamAddress =
        payable(0x0EE0b7A343Fb546c55D8FbbB0eC18BC73634e1CA); // Team Address
