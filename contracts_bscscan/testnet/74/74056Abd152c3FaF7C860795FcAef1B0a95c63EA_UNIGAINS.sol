...
contract UNIGAINS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "UNIGAINS";
    string private _symbol = "UGN";
    ...
    uint256 public _taxFee; // 200 = 2.00%
    uint256 public _buybackv1Fee; // 300 = 3.00%
    uint256 public _buybackv2Fee; // 300 = 3.00%
    uint256 public _burningFee; // 100 = 1.0%
    uint256 public _smarketingFee; // 100 = 1.0%
    ...
    address public buybackv1Address;      
    address public buybackv2Address;    
    address public burningAddress;
    address public smarketingAddress;     
...
function _approve(address owner, address spender, uint256 amount) private {
    ...
    function set_READY_TO_LAUNCH()public onlyOwner{
        _taxFee = 200;
        _burningFee = 100;
        _buybackv1Fee = 300;
        _buybackv2Fee = 300;
        _smarketingFee = 100;
        _maxTxAmount = 150000000 * 10**18;
        buybackv1Address = 0x1e50Cd8574361eBe09e69D61B6379984546aE66d;      
        buybackv2Address = 0xc2F58f26019790B941E50a87c439a5E8ae858D76;    
        burningAddress = 0x000000000000000000000000000000000000dEaD;
        smarketingAddress = 0xE1B08C1DF897B5F1F21E101ce76E41059ee89a20;     
    }
