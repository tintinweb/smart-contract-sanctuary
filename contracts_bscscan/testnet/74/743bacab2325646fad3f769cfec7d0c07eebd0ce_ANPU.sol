...
contract ANPU is IBEP20, Auth {
    ...
    string constant _name = "ANPU TOKEN";
    string constant _symbol = "ANPU";
    ...
    function triggerANPUBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
