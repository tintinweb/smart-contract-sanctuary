...
interface IBundlesToken {
    /**
     * @dev Deposits the BUND Tokens to the user adrress.
     */
    function deposit(address user, bytes calldata depositData) external;
}

// Bundles Bridge
contract BundlesBridge is ReentrancyGuard, NativeMetaTransaction {
    IBundlesToken public immutable token;

    constructor(IBundlesToken _token) {
        _initializeEIP712("BundlesBridge", "1");
        token = _token;
    }
