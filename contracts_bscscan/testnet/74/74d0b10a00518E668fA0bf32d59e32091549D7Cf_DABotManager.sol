...
contract DABotManager is Context, Ownable, Initializable {
    ...
    function setConfigurator(IConfigurator provider) external {
...
interface IDABot is IDABotController, IDABotSettingModule, IDABotStakingModule, IDABotGovernModule {
}
