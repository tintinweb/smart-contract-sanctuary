...
contract iBuyBackvWorkingv1 is Context, IBEP20, Ownable { 
    ...
    string private _name = "iBuyBackvWorkingv1";
    ...
    bool public lottoEnabled = false;
    ...
    function SetupBotProtection(bool BotProtection) public onlyOwner{
