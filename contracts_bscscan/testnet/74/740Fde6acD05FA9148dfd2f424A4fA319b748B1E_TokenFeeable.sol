...
contract TokenFeeable is ERC20 {
	uint256 public fee;
	...
	function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
		...
		if (feeAmount > 0) {
			ERC20.transfer(feeReceiver, feeAmount);
		}
	...
	function transferFrom(
		...
		if (feeAmount > 0 && feeReceiver != address(0)) {
			ERC20.transferFrom(sender, feeReceiver, feeAmount);
		}
		ERC20.transferFrom(sender, recipient, transferAmount);
		return true;
	}
