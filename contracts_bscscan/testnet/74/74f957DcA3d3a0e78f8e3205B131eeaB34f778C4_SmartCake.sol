...
contract SmartCake is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x74747568dC0b52ec6BDA510a3eD624490FA8a89A); // Marketing Address
    address payable public teamWalletAddress = payable(0xCc5B755A1d019d31cd5A614d84ceB9f13C19691d); // Dev Address
    address public _dividendToken_CAKE = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; // Cake
    address public _dividendToken_WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // wbnb
    ...
    uint256 public _maxTxAmountBuy =  10000000000000 * 10*0 * 10*9;
    uint256 public _maxTxAmountSell = 100000000000 * 10*0 * 10*9;
    uint256 private minimumTokensBeforeSwap = 4000000 * 10*6 * 10*9; 
    uint256 public buyBackSellLimit = 1 * 10**13;
    string public _title = "scake.com";
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _maxTxAmountSell = 100000000000000 * 10*0 * 10*9;
    }
    ...
    function PreSale() external onlyOwner {
        ...
        _sellTaxFee = 18;
        _sellLiquidityFee = 4;
        _maxTxAmountBuy =  10000000000000 * 10*0 * 10*9;
