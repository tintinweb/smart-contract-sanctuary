...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner =0xD2cF2a41fE3c3319285dCad81EfacE6302a20E38 ;
...
contract testtoken  is Context, IERC20, Ownable {
    ...
    address payable public _charityWalletAddress = payable(0x32024a46a09C1d0faB7b4D3a45f5D5fE3b74B078);
    address public marketingWalletToken = 0x157201B2e2ba0adE75Ac997781136D6635842aa3;
    ...
    function _approve(address owner, address spender, uint256 amount) private {
     ...
     function set_charityWalletAddress(address payable new_charityWalletAddress) external onlyOwner() {
        _charityWalletAddress = new_charityWalletAddress;
    }
