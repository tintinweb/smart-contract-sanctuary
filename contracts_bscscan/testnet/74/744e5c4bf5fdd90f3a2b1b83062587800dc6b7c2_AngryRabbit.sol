...
contract AngryRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "Angrytrooper";
    ...
    address payable public marketingWalletAddress = payable(0xB83CF0D9F9f375A1a4E936927ce4E657623C7e47); 
    ...
    function setMarketingWalletAddressBNB(address newAddress) external onlyOwner() {
