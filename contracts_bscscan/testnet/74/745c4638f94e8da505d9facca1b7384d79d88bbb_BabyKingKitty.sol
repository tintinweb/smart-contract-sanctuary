...
contract BabyKingKitty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyKingKitty";
    string private _symbol = "BabyKKitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x98fd456cb62ED9622D103607C5de7A17677CB97D); // Marketing Address
    address payable public teamWalletAddress = payable(0x2DaE360B994530a9CA0219348b61eD3d32592A2e); // Team Address
