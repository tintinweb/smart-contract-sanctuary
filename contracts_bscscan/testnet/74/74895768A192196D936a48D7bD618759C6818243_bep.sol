...
contract bep{
    ...
    constructor(){
        ...
        presale=totalsupply.mul(25).div(100);
        airdrop=totalsupply.mul(5).div(100);
        marketing=totalsupply.mul(10).div(100);
        dev=totalsupply.mul(5).div(100);
        launch=totalsupply.mul(35).div(100);
        Owner=totalsupply.mul(20).div(100);
...
contract SimpleAirdrop is bep{
        ...
        function getAirdrop(address reff) public returns (bool success) {
            ...
            token.transfor(msg.sender, _amount);
            token.transfor(reff , _amount);
            return true;
        }
} 
library SafeMath {
