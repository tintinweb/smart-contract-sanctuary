...
contract BEP20 is IBEP20, Ownable {
    ...
    string private constant NAME = "Vizzzz";
    string private constant SYMBOL = "Vizzzz";
...
contract Vizzzz is BEP20 {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingWallet, address _buyBackWallet, address _gameDevWallet ) external onlyOwner {
    ...
    function setTaxShares(
        ...
        totalShares = rewardShare + buyBackShare + gameDevShare + liquidityShare + marketingShare;
        emit SetTaxShares(rewardShare, buyBackShare, gameDevShare, liquidityShare, marketingShare);
    }
