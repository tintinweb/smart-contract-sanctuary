...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD Main NET 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB MAIN NET
    IDEXRouter router;
...
contract PorcelainX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD MAIN NET
   // address BUSD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // BUSD TEST NET 
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;// WBNB MAIN NET
   // address public WBNB = 0xae13d989dac2f0debff460ac112a837c89baa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PorcelainX";
    string constant _symbol = "PCX";
