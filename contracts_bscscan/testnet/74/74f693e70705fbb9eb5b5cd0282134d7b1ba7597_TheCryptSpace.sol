...
contract TheCryptSpaceDividendDistributor is IDividendDistributor {
    ...
    function getCumulativeDividends(uint256 share) internal view returns (uint256) {
        return share.mul(dividendsPerShareRewardToken[address(rewardtoken)]).div(dividendsPerShareAccuracyFactor);
    }
...
*/
    ...
    uint256 rewardtokenFee = 600;
    uint256 sellpremium = 2600;
    ...
    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external authorized {
        ...
        require(_minDistribution <= 2 && _minDistribution > 0, "can not set the distribution to anything more than 2 bnb and it must be greater than 0");
