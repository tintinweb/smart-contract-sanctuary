...
contract Name is Context, IERC20, Ownable {
    ...
    string private _name = "Name Moeda";
    ...
    address public charityWallet = 0x65AA76CEba5dC86B4749d9F82Ae826214f8C14eb;
    uint256 private _previouscharityFee = _charityFee;

    uint256 public _maxTxAmount = 50 * 10**6 * 10**9; // Max Transaction: 50 Million (0,5%)
	uint256 public _maxWalletToken = 100 * 10**6 * 10**9; // Max Wallet: 100 Million (1.3%)
	...
	function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient != owner() && recipient != address(1) && recipient != uniswapV2Pair){
