...
contract KOKODIE is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xEdaf0298db71E3D65276e874Dab319Cd573EA0Bc;
    ...
    string private _name = "KOKODIE";
    string private _team = "KOKO'S SQUAD";
    string private _symbol = "KKD";
    ...
    function team() public view returns (string memory) {
        return _team;
    }
