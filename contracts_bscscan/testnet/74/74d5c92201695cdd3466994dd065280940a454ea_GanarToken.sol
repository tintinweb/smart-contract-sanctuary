...
/*
    ...
    Whitepaper: https://ganartoken.com
...
contract GanarToken is Context, IERC20, Ownable {
    ...
    uint256 public _marketingTeamFee = 2; //hardcoded and unchangeable 
    ...
    address payable public charityAddress1 = 0x07d0d60FCEa13eBf618A596Dd895533eB80Fa349; // Charity Address for Binance Charity
    address payable public marketingAddress = 0x07d0d60FCEa13eBf618A596Dd895533eB80Fa349; //Marketing
    address payable public teamAddress = 0x07d0d60FCEa13eBf618A596Dd895533eB80Fa349; //Team 
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //V2!
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 sumOfParts = _marketingTeamFee.add(_donationFee);
        uint256 partsOfBalance = contractETHBalance.div(sumOfParts); 
        //1+2 = 3 parts usually, implementing this if we would increas donation fee in the future
        
        uint256 donationAmount = (partsOfBalance.mul(_donationFee)).div(1); 
        TransferCharityBNB(charityAddress1, donationAmount); 
        
        uint256 afterTransferBalance = address(this).balance;
        _tDonationTotal = _tDonationTotal.add(contractETHBalance.sub(afterTransferBalance)); //Only sum up donated amounts
        
        uint256 marketingBNB = (partsOfBalance.div(10)).mul(6);
        TransferMarketingBNB(marketingAddress, marketingBNB);
        
        uint256 teamBNB = (partsOfBalance.div(10)).mul(4);
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_donationFee.add(_marketingTeamFee)).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _donationFee == 0 && _marketingTeamFee == 0) return;
