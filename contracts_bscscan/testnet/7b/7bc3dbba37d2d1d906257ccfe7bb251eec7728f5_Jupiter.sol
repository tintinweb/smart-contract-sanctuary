...
contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = payable(0x2b15CE39C4b79eDE726fD47D5b3613Fcaa436761);
...
contract Jupiter is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private _tTotal = 10 *1e10 * 1e10;
    ...
    uint256 public _taxFee = 20; // 2% will be distributed among holder as Jupiter divideneds
    ...
    uint256 public _burnFee = 50;  // 5% will go to the Dead address to deflate Jupiter
    ...
    function setWinningDoubleRewardPercentage(uint256 percent) external onlyOwner {
        winningDoubleRewardPercentage = percent;
    }
    
    function setDisruptiveCoverageFee(uint256 amount) external onlyOwner {
        disruptiveCoverageFee = amount;
    }
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own Jupiter to claim reward');
