...
contract TOKINA is IERC20 {
    ...
    string constant _name = "Tokinaaa";
    ...
    address payable private _marketingWallet = payable(0x0df780B6D74Af9bD794747c0Bf5AE15f666f44C5);
    ...
    constructor (uint _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0x09c40E37950540dd63244f8c4b465930ED041468] = true;
        _isDividendExcluded[0x09c40E37950540dd63244f8c4b465930ED041468] = true;
