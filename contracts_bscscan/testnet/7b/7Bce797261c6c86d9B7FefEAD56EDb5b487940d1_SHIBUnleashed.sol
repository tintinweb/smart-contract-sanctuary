...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public SHIBA = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    ...
    uint256 public minDistribution = 1 * (10 ** 16); // 1 SHIBA minimum auto send
    ...
    constructor () {
        ...
        // Mainnet Router : 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
...
contract SHIBUnleashed is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public _maxWallet = 3 * (10**10) * (10 ** _decimals);
    ...
    uint256 public swapThresholdBNB = _totalSupply * 10 / 10000; 
    bool inSwap;
