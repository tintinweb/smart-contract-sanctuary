...
contract SafeColiseum is Context, IBEP20, Ownable, DateTime {
    ...
    string private _symbol = "SCOMT15";
    ...
    function checkAccountPurchaseAmount(address account)
        public
        view
        returns (uint256)
    {
    ...
    function checkAccountLastSaleDate(address account)
        public
        view
    ...
    function checkAccountConcurrentSaleDayCount(address account)
        public
        view
        returns (uint256)
    {
    ...
    function checkAccountLastDayTotalSell(address account)
        public
        view
        returns (uint256)
    {
    ...
    function getAccountType(address account)
        public
        view
        returns (type_of_wallet)
    {
