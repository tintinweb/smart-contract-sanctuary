...
contract NFT_MARKETPLACE_OPERATOR is Ownable {
    ...
    */
        ...
        internal
    {
        ...
        require(address(_latest_quote.committer) != address(msg.sender), "[E:0001,auctionBiddingLogic]");
        
        // Price of the target NFT must more than 0.
        require(_price.amount > 0, "[E:0002,auctionBiddingLogic]");
        
        // Price of the quote must greater than the price of the NFT and the latest bid.
        require(quote.amount > _price.amount && quote.amount > _latest_quote.amount, "[E:0003,auctionBiddingLogic]");
