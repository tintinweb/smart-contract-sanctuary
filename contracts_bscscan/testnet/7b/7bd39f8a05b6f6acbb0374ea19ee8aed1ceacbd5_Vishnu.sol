...
// VISHNU - Vishnu: BEP20 token contract
// Telegram: https://t.me/VishnuToken
// Website: https://vishnutoken.net

// TOKENOMICS
// ----------------------------------------------------------------------------
// Symbol: VISHNU
// Name: Vishnu
// Total supply: 1,000,000,000,000,000.000000000000000000
// Decimals: 9
// ----------------------------------------------------------------------------
// Max buy 1% max, hold 4%
// 51% Burnt to dead wallet
// 40% Liquidity & Pre-sale
// 3% Charity wallet
// 3% Operating wallet
// 3% Team wallet
// Ownership renounced && LP lock
// ----------------------------------------------------------------------------
// REDISTRIBUTION: 15%
// >> 1% Burn
// >> 4% Back to the Liquidity Pool
// >> 2% To charity wallet
// >> 2% To operating wallet
...
abstract contract Tokenomics {
    ...
    // --------------------- Token Settings ------------------- //
    string internal constant NAME = "Vishnu";
    string internal constant SYMBOL = "VISHNU";
    ...
    address internal charityAddress =
        0xa8c046B3FeE8E7fEb560AE43833138109B238CDF;
    address internal marketingAddress =
        0x0e047f0E6Ae0D50aC68d49EC5224AcC683eb6b7d;
    ...
    function _addFees() private {
         ...
         */
        _addFee(FeeType.Rfi, 60, address(this));
...
abstract contract VishnuToken is BaseRfiToken, Liquifier, Antiwhale {
    using SafeMath for uint256;
...
contract Vishnu is VishnuToken {
    constructor() VishnuToken(Env.Testnet) {
