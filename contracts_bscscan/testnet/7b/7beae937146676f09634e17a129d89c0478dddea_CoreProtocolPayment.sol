...
contract CoreProtocolPayment is Context{
    ...
    function name()public view returns(string memory contractName){
        return _name;
    }
    function applyForMerchantAccount(string calldata merchantName) public {
        _applications[msg.sender].name = merchantName;
