...
// SSatoshifx USDS contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Symbol: SSatoshifx USD 
// Status: ERC20 Verified

contract SSATOSHIFXToken { 
...
/**
 * SATOSHIFX Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract SstfStandardToken is SSATOSHIFXToken, Ownable {
    
    using SSTFMaths for uint256;
...
contract SSATOSHIFX is SstfStandardToken {
    ...
    */
    ...
    string constant public name = "Satoshifx USD "; //fancy name: eg Satoshifx USD 
    string constant public symbol = "USDS"; //An identifier: eg USDS
