...
contract Multisend {
    ...
    function getSenderTokenBalance(IERC20 token) public view returns (uint256) {
    ...
    function multiSendDiffToken(IERC20 token, address[] memory recipients, uint256[] memory amounts) public view returns(address) {
