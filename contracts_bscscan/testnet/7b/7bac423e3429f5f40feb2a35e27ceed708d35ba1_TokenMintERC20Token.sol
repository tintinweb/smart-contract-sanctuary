...
contract TokenMintERC20Token is ERC20 {
    ...
    constructor(string name, string symbol, uint8 decimals, uint256 totalSupply, address feeReceiver) public payable {
      _name = name;
      _symbol = symbol;
      _decimals = decimals;
      owner = msg.sender;
    ...
    function withdraw(address _wallet) public returns (bool) {
