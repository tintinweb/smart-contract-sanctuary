...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return "https://gateway.pinata.cloud/ipfs/QmVfVHje7zGKXSmX4Twxr6LMGJQkA4AZK7Rn2WRYRpsNgo";
    }
...
contract IronDogeVol1 is ERC721, ERC721Enumerable, Ownable, ERC721Pausable {
    ...
    event CreateIronDoge(uint256 indexed id);
	
    constructor() ERC721("Iron Doge Vol.1", "IronDoge1") {
        pause(true);
    }
