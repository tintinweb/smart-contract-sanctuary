...
contract Team is AccessControl {
    ...
    uint256 public lockPeriod = 5400 ; // 90m ,31536000; // 365 days
    uint256 public lockAmount = 170000000000000000000000000; // 170,000,000 IMBA
    ...
    function addTeam(address _account, uint256 _amount) public {
