...
interface IPancakeV2Router {
    ...
    string internal constant NAME = "prova1";
    string internal constant SYMBOL = "prov";
    ...
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 25; // 2% of the total supply
    ...
    address internal marketingAddress = 0xeC7c7616eaa01823986dc1c0fa0376D79f585333;

    
    address internal burnAddress = 0x000000000000000000000000000000000000dEaD;

    
    address internal tipToTheDev = 0x671E9F84484441Cf3Da2eBbE3abbD32F52475742;
...
abstract contract ToxikToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract ToxikTokenV1 is ToxikToken{

    constructor() ToxikToken(Env.Testnet){
