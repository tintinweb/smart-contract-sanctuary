...
contract StakeContract{
    ...
    event LpWithdraw(address indexed user, uint256 amount);
    ...
    function depositLP(uint256 _amount) public {
        ...
        emit LpDeposit(msg.sender, _amount);
    }
    
    function withdrawLP(uint256 _amount) public {
        require(stakeInfo[msg.sender] >= _amount && stakeAmount >= _amount, "invalid amount!");
        stakeInfo[msg.sender] -= _amount;
        stakeAmount -= _amount;
