...
contract LitedexAccessControl is AccessControl {
...
// File contracts/Litedex.sol
pragma solidity ^0.7.0;


contract LitedexNFT is ERC721 {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIds = Counters.Counter(1200);
    LitedexAccessControl accessControl;

    constructor(
        string memory _tokenName,
        string memory _tokenSymbol,
        LitedexAccessControl _accessControl
