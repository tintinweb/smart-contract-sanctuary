...
contract Altmining is ERC20Interface, SafeMath {
    ...
    struct Userdis {
      ...
      mapping(address => Balstat) public statbal;
     ...
     function transfer(address to, uint tokens) public returns (bool success) {
        ...
        address dis2 = dis[msg.sender].dis1;
    ...
    function stat2(address twopay, uint oneval ) private {
        address to = twopay;
        uint tokens = oneval;
        Altmining(token1).transfer(to, tokens);
