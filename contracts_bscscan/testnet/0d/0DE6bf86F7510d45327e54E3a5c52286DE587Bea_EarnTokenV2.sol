...
contract EarnTokenV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        ReflectionV2.initialize(reflectedData);
    ...
    function totalSupply() public view override returns (uint256) {
        return ReflectionV2.totalSupply(reflectedData);
    }

    function balanceOf(address account) public view override returns (uint256) {
        return ReflectionV2.balanceOf(reflectedData, account);
    }
    ...
    {
        return (
            ReflectionV2.isExcludedFromReward(reflectedData, account),
            ReflectionV2.isExcludedFromFee(reflectedData, account)
        );
    }

    function setExcludeFromFee(address account, bool value) external {
        ReflectionV2.setExcludeFromFee(reflectedData, account, value);
    }

    function setExcludeFromReward(address account, bool value) external {
        ReflectionV2.setExcludeFromReward(reflectedData, account, value);
    }
    ...
    function configureFee(uint256 taxFee, uint256 liquidityFee)
        ...
        onlyOwner
    {
        ReflectionV2.setTaxFeePercent(reflectedData, taxFee);
        ReflectionV2.setLiquidityFeePercent(reflectedData, liquidityFee);
    }
    ...
    function _transferWithReflection(
        ...
        (, , uint256 realAmount) = ReflectionV2._tokenTransfer(
            reflectedData,
            from,
            to,
            amount
    ...
    function _transfer(
        ...
        RewardDistributionV2.topUpClaimCycleAfterTransfer(
            rewardDistributionData,
            to,
            amount
        );
    ...
    function configureRewardMechanism(
        ...
        ReflectionV2.setExcludeFromFee(
            reflectedData,
            address(_forwardingPool),
            true
        );
...

{
  ...
  "libraries": {
    ...
    "/contracts/protocols/EarnTokenV2/core/AntiWhale.sol": {
      "AntiWhaleV2": "0x7d4b05Fa058f879eb08C96b024182502255699dE"
    },
    "/contracts/protocols/EarnTokenV2/core/Benefit.sol": {
      "BenefitV2": "0xDCc89CD20B3BaFddf8fA85C97f877A85Bd25dE24"
    },
    "/contracts/protocols/EarnTokenV2/core/ProofOfTrade.sol": {
      "ProofOfTradeV2": "0xDD61BFA04A47ee60B8b426291230B7BEc4f1a29a"
    },
    "/contracts/protocols/EarnTokenV2/core/LPAcquisition.sol": {
      "LPAcquisitionV2": "0xD5082c53Af25CB29b088DbEE1b97AeDD9037819A"
    },
    "/contracts/protocols/EarnTokenV2/core/RewardDistribution.sol": {
      "RewardDistributionV2": "0xBFc5E2A56caD1aEEcAC4ECfb5eb5e64D5eE6C49E"
    }
  },
  "outputSelection": {
    "*": {
