...
// File: contracts/SimplePlanets.sol
...
contract  SimplePlanets is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable, VRFConsumerBase {
    ...
    uint256 public maxSupply = 9999; //starting from 0;
    uint256 public maxMintAmount = 25;
    // uint256 public cost = 100000000000000000;
    uint256 public cost = 1000000000000000; // Test
        ...
        )
    {
        ...
        fee = 2 * 10 ** 18; // Chainlink oracle fee
        ...
        payable
    {
        ...
        require(_mintAmount <= maxMintAmount, "Cannot mint more than 10 at a time.");
        require(tokenCount() + _mintAmount <= maxSupply, "Cannot mint more than max supply.");

        if (!hasRole(DEFAULT_ADMIN_ROLE, _msgSender())) {
            require(msg.value >= cost * _mintAmount, "SimplePlanets: must send correct price");
        }
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            if(tokenCount() == 100) {
                ...
                payable(ownerOf(tokenNumber)).transfer(10000000000000000); // Test
            ...
            if(tokenCount() == 250) {
                ...
                payable(ownerOf(tokenNumber)).transfer(15000000000000000); // Test
            }
            ...
            if(tokenCount() == 500) {
                ...
                payable(ownerOf(tokenNumber)).transfer(25000000000000000); // Test
            }
            ...
            if(tokenCount() == 1000) {
                ...
                payable(ownerOf(tokenNumber)).transfer(50000000000000000); // Test
            }
            ...
            if(tokenCount() == 1750) {
                ...
                payable(ownerOf(tokenNumber)).transfer(75000000000000000); // Test
            }
            ...
            if(tokenCount() == 2750) {
                ...
                payable(ownerOf(tokenNumber)).transfer(100000000000000000); // Test
            }
            ...
            if(tokenCount() == 4000) {
                ...
                payable(ownerOf(tokenNumber)).transfer(125000000000000000); // Test
            }
            ...
            if(tokenCount() == 7500) {
                ...
                payable(ownerOf(tokenNumber)).transfer(200000000000000000); // Test
            }
            ...
            if(tokenCount() == 10000) {
                ...
                // payable(ownerOf(tokenNumber)).transfer(15000000000000000000);
                payable(ownerOf(tokenNumber)).transfer(150000000000000000); // Test 
            }
        }
    }
    ...
    // function testRandomToken(uint256 amount) public view returns (uint256) {
    //     return expand(randomResult) % amount;
    // }
    ...
    function setBaseURI(string memory baseURI) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "SimplePlanets: must have admin role to change base URI");
        _baseTokenURI = baseURI;
    }

    function setTokenURI(uint256 tokenId, string memory _tokenURI) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "SimplePlanets: must have admin role to change token URI");
    ...
    function test10000Loop() public view returns (uint256) {
        uint county = 1;
    ...
    function claimRewards() public {
        ...
        require(count > 0, "SimplePlanets: You must have at least 1 Simple Planet to claim rewards");
        for(uint i=0; i < count; i++){
    ...
    function claimReward(uint256 tokenId) public {
        require(ownerOf(tokenId) == _msgSender(), "SimplePlanets: Only owner can claim rewards");
    ...
    function reflectDividend(uint256 amount) private {
        for (uint i = 0; i < tokenCount(); i++) {
            uint tokenHolder = tokenByIndex(i);
    ...
    function checkWithdrawBalance() public view onlyRole(DEFAULT_ADMIN_ROLE)  returns (uint256) {
