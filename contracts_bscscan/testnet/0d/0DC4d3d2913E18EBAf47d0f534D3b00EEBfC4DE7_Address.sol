...
contract HempireWorld is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeCast for int256;
  
    string private _name = "HempireWorld";
    string private _symbol = "HEMPX";
    ...
    constructor() public {
        ...
        address _owner = 0x67180Fd87AD0d01E3D2A3B95eB395bE695D3cB3F;
        marketingWallet = 0x6e8a219c6d1c2691D41dC7B271C3AAB01b959f36;
        admin = 0x6eA7126f89ccc1567b0a9508de6D0Fae379ac337;
        bnbVaultWallet = 0x17fd8045FcAe33C245fd9983429C5365a40f9270;
