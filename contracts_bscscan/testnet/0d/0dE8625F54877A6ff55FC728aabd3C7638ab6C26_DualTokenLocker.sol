...
contract DualTokenLocker is ITokenLocker, Ownable, ReentrancyGuard {
    ...
    function getMerkleProofWithIndex(bytes32[] calldata _merkleProofs, uint128 startIndex, uint32 length) internal returns (bytes32[] calldata) {
        return _merkleProofs[startIndex:length];
    }
