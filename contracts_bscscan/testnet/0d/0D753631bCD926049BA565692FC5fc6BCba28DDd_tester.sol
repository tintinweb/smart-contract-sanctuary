...
contract tester is Context, IBEP20, Ownable {
    ...
    uint256 private _maxWallet = _tTotal.div(10**2).mul(3); // 3% of total supply
    ...
    function SellFee (uint256 _sell) public onlyOwner() {
         Fee_sell = _sell;
    }
    
    function BuyFee (uint256 _buy) public onlyOwner() {
         Fee_buy = _buy;
    }
