...
contract AuctionBase {
        ...
        returns (uint256)
    {
        ...
        // payable(seller).transfer(price);
        {
            ...
            require(success,"seller.call{value: price}("")");
        }
      
        uint256 bidExcess = _bidAmount - price;
        // payable(msg.sender).transfer(bidExcess);
        {
            (bool success, ) = msg.sender.call{value: bidExcess}("");
            require(success,"msg.sender.call{value: bidExcess}("")");
        }
...
contract SiringAuction is AuctionBase {
    ...
    function cancelAuction(uint256 _tokenId) external {
        ...
        require(isOnAuction(_tokenId),"!isOnAuction(_tokenId)");
        address seller = auction.seller;
