...
contract SkippyTOKEN is Context, IERC20, Ownable {
    ...
    string _name = 'SkippyTOKEN';
    string _symbol = 'SkippyTOKEN';
    uint8 _decimals = 18;
    ...
    constructor(address _charity,  address _marketing, address _rAndD, address _legal, address _team) {
        ...
        //_excludeFromTimeLimit[uniswapV2Pair] = true;
