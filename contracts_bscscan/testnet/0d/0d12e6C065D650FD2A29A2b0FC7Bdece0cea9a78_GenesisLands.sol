...
interface IERC721 is IERC165 {
     ...
     * move this token by either {approve} or {setApprovalForAll}.
...
library Address {
     ...
     * https://solidity.readthedocs.io/en/v0.5.11/securi
     * ty-considerations.html#use-the-checks-effects-interactions-pattern[checks-effects-interactions pattern].
     */
     ...
     * use https://solidity.readthedocs.io/en/latest/u
     * nits-and-global-variables.html?highlight=abi.decode#abi-encoding-and-decoding-functions[`abi.decode`].
     *
     * Requirements:
     *
...
interface IERC721Receiver {
     ...
     * If any other value is returned or the interface is 
     * not implemented by the recipient, the transfer will be reverted.
     *
...
contract GenesisLands is ERC721Enumerable, Ownable {
    using Strings for uint256;
