...
contract BbEth is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(address(0x8b424AB5d021230f7bDCa288700606844aC84694)); //marketing wallet
    ...
    constructor() ERC20("BabyEthereum2", "BBETH2") {
