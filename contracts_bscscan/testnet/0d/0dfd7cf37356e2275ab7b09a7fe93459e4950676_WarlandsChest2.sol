...
contract WarlandsChest2 {
    ...
    function setTotalSilverMinted(uint256 newSilverChestMintedCount)
        public
        onlyOwner
    {
    ...
    function setTotalDiamondMinted(uint256 newDiamondChestMintedCount)
        public
        onlyOwner
    {
    ...
    function setTotalPlatinumMinted(uint256 newPlatinumChestMintedCount)
        public
        onlyOwner
    {
