...
contract BabyBabyOLYMPUS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyLambo";
    string constant _symbol = "BabyLambo";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 917000000000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply / 14550; // 0.005%
    bool inSwap;
