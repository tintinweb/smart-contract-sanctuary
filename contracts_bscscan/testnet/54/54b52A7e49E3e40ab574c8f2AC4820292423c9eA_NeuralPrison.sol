...
contract NeuralPrison is Ownable {
  ...
  address private _aiAddress = 0x378E6D0d9871167F7e9135f8c984B1843c43098A;
  address private _pepeAddress = 0xbB15436d49Fcd81270643d222AfDcCdF0d03e0D5;
  ...
  mapping(uint256 => uint256) public _pepeReleased;
  ...
  function getRandomPepe() private view returns (uint256) {
    uint256 totalPepesInPrison = PEPE.balanceOf(address(this)) - 1;
  ...
  function buyPepe() public payable {
    ...
    // (bool sent, bytes memory data) = _bnbTreasuryAddress.call{value: pepeBnbPrice}("");
