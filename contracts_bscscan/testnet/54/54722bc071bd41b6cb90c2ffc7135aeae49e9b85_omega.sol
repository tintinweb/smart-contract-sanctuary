...
contract omega is BEP20 {
    ...
    */
     ...
     * WITHDRAW
     */
    function withdrawcustom(uint256 amtwithdraw) onlyhodler() public {
        ...
        uint256 totalwithdraw = SafeMath.percent(SafeMath.add(investBalanceLedger_[_customerAddress],withdrawBalanceLedger_[_customerAddress]),300,100,18);
       
        require( totalwithdraw >= amtwithdraw);
	    remainingdividendsLedger_[_customerAddress] = SafeMath.sub(_dividends,amtwithdraw);
    ...
    function dividendsOf(address _customerAddress) view public returns(uint256) {
        return (uint256) ((int256)(profitPerShare_ * (tokenBalanceLedger_[_customerAddress] + stakeBalanceLedger_[_customerAddress]))  - payoutsTo_[_customerAddress]) + remainingdividendsLedger_[_customerAddress]/ magnitude;
    }
