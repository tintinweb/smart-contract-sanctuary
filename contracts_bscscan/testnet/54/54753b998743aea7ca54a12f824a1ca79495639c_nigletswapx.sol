...
/**
     ...
     *
     * 
     * A community meme-token built on BSC
     * 
     * 
     * 10,000,000,000 Total Supply
     * 200,000,000 Max Wallet / Max Tx (2%)
     *  
     * 10% Fee: 5% to holders, 5% back into liquidity
     * 
     * LP tokens will be Locked for 6 months.
...
contract nigletswapx is Context, IBEP20, Ownable {
    ...
    uint256 public _maxWalletToken = 2000 * 10**6 * 10**9;
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'nigletswapx';
    string private _symbol = 'nignignigx';
