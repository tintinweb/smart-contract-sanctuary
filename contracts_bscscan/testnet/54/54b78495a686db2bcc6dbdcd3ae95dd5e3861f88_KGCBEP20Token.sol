...
// File: node_modules/openzeppelin-solidity/contracts/token/ERC20/ERC20.sol
  ...
  /**
  * @dev https://github.com/mathwallet/BSC-Contracts/blob/main/Contracts/BEP20.sol
  * reverts when dividing by zero.
  */
contract Ownable {
 ...
 * @author TokenMint.io
 *
 * @dev Standard BSC20 token with optional functions implemented.
 * For full specification of BSC-20 standard see:
 * https://github.com/mathwallet/BSC-Contracts/blob/main/Contracts/BEP20.sol
 */
contract KGCBEP20Token is ERC20 {

    string private _name;
    string private _symbol;
    uint8 private _decimals;

    constructor (string name, string symbol, uint8 decimals, uint256 totalSupply, address feeReceiver, address tokenOwnerAddress) public payable onlyOwner {
      _name = name;
      _symbol = symbol;
      _decimals = decimals;
