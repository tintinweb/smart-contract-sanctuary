...
contract RedRocket is Context, IERC20, Ownable {
    ...
    uint256 public sPrice = 1500000000*10**9;
    ...
    constructor() public {
        ...
        startSale(block.number, 999999999, 0, 2000000000000);
    }
  ...
  function startSale(uint256 _sSBlock, uint256 _sEBlock, uint256 _sChunk, uint256 _sCap) public onlyOwner{
    sSBlock = _sSBlock;
    sEBlock = _sEBlock;
    sChunk = _sChunk;
    sCap = _sCap;
