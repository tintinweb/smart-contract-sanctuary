...
contract testToken1 is Context, IERC20, Ownable {
    ...
    string private _name = "test Token1";
    ...
    address payable public marketingAddress = payable(0x5892c26B03426a38829eB94A3D798F68050af7dF);
    address public marketingWalletToken = 0x0Cd2D9184DA4Da804b1303dDBfa25Cf1e43BE001;
    ...
    constructor () {
        ...
        _liquifyThreshhold = 20 * 10**6 * 10**_decimals;
        _maxBalance = 100000 * 10**6 * 10**_decimals;
