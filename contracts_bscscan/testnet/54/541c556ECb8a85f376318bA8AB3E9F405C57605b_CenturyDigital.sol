...
contract CenturyDigital is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x2A1CADD345be72F384d5e3cBe72B79DB9BFF4d08;

    string private constant _name = "Century Digital";
    ...
    Taxes public buyTaxes = Taxes(2,8,2);
    Taxes public sellTaxes = Taxes(5,8,2);
