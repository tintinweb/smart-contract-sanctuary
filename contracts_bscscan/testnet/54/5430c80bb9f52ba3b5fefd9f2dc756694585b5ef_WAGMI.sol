...
contract WAGMI is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x0000000000000000000000000000000000000000);
    address payable private _marketingAddress = payable(0x0000000000000000000000000000000000000000);
