...
// File: contracts/BitcoinBinancedFarm.sol
...
contract BitcoinBinancedFarm is Ownable, ReentrancyGuard {
    ...
    function _updatePool() internal {
        ...
        if (block.number < 31000000) {} // 0.2 / block
    	else if (block.number < 62500000) {rewardPerBlock = 60000000000000000;} // 0.06 / block
        else {rewardPerBlock = 33800000000000000;} // 0.0338 / block
