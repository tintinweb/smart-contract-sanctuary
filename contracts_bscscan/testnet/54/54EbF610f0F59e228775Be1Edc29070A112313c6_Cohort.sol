...
interface IEpoch {
    ...
    function requestDeposit(address _pool, uint _amount) external;

    function updateTotalDeposit(address _pool) external;

    function updateUserDeposit(address _user, address _pool) external;
