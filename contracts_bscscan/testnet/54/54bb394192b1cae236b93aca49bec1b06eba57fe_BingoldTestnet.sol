...
WEBSITE: https://bingold.finance
TELEGRAM: https://t.me/BinGoldFinance
TWITTER: https://twitter.com/BinGoldFinance
...
contract BingoldTestnet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x99fa7F4e89f1Cd945EF2e28BBC578369999ac773); // Marketing Address
    ...
    string private _name = "BINGOLD_TESTNET";
    string private _symbol = "$BGOLD_TESTNET";
