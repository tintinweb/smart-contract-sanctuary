...
contract iWin is ERC20, Ownable{
    ...
    address public privateInvestorsWallet = 0x3d30Be3b2748E941904C10f7f3Ce9E9e3B4e92F3;
    ...
    constructor() ERC20("iWin", "iWin") {
        ...
        // it exists as a router contract on the test net for sure.
        ...
        // Lottery wallet is the contract address.
        ...
        // Allow transfer for all the wallets.
       ...
       if(!exemptFee[recipient] && lotteryInfo.enabled && amount >= lotteryInfo.lotteryThresholdAmt && sender == pair && block.timestamp >= lotteryInfo.lastWinTimestamp + 1 days){
        ...
        if(fee > 0){
            ...
            if (currentTaxes.privateInvestors > 0){
               _balances[privateInvestorsWallet] += amount * currentTaxes.privateInvestors / 1000;
            }
