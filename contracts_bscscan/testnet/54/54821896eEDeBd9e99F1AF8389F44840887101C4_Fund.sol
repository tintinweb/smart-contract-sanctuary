...
contract Fund is PriceQrawler {
    ...
    function query() onlyOwner external {
        ...
        qrawlerQuery(reqId, QueryType.PriceOracle, "");
    }
...
abstract contract PriceQrawler is Qrawler {
     ...
     */
    function qrawlerCallback(string memory _reqId, QueryType _type, bytes calldata _calldata) external override {
...
abstract contract Qrawler is IQrawler, Ownable {
