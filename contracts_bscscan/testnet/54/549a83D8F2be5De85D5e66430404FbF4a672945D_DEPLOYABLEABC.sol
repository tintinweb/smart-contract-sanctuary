...
contract DEPLOYABLEABC is Context, IERC20, Ownable {
    ...
    address public spenderForLiquidity =
        0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //needs to be changed for mainnet

    constructor(string memory name, string memory symbol) public {
        _name = name;
        _symbol = symbol;
        _rOwned[_msgSender()] = _rTotal;
        approve(spenderForLiquidity, _tTotal);
