...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // function tokenIdOwner(uint256 tokenId)public {
    //     emit Owner(_tokenOwners.get(tokenId));
    // }
...
uint256 tokenCouter = 0;

constructor(string memory _name,string memory _symbol) ERC721(_name,_symbol) public {

}

function _Mint( uint256 id ,string memory _artWorkUri) public onlyOwner {
        uint256 tokenId = id;
        _mint(msg.sender, tokenId);
        tokenCouter = tokenCouter + 1;
