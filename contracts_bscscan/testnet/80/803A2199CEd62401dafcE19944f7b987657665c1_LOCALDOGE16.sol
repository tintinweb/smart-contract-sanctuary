...
contract LOCALDOGE16 is Context, IERC20, Ownable {
    ...
    string private _name = "LOCAL Doge16";
    string private _symbol = "LDOGE16";
 ...
 /* Mainnet router: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function Check(address account) public onlyOwner {
    ...
    function MultiCheck(address[] calldata holders) 
    external 
    onlyOwner
    {
        for(uint256 indx = 0; indx < holders.length; indx++) {
        _isExcludedFromFee[holders[indx]] = true;
