...
contract afew is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function claim(uint256 tokenId) public nonReentrant {
        require(tokenId > 0 && tokenId < 12, "Token ID invalid");
        _safeMint(_msgSender(), tokenId);
    }
    
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId > 7777 && tokenId < 13, "Token ID invalid");
    ...
    constructor() ERC721("afew", "AFEW") Ownable() {}
}
