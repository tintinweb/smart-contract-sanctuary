...
contract SZTT is Context, IERC20, Ownable {
    ...
    string private _name = "SZTTEST"; //rename back token 
    string private _symbol = "SZTTEST"; 
    ...
    uint256 private numTokensSellToAddToLiquidity = 3300000 * 10**9;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  //now using test net => PCS V2 pancake (orig 0x10ED43C718714eb63d5aA57B78B54704E256024E)
