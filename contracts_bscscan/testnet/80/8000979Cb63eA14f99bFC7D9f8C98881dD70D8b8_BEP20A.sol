...
contract BEP20 is Ownable, IBEP20 {
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _decimals = 18;
        _totalSupply = 32000000 * 10 ** decimals();
    }
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) internal virtual onlyOwner {
 ...
 */
contract BEP20A is BEP20, GeneratorCopyright("v2.3.0") {
    constructor() BEP20("BEP20A", "BPA") {
       _mint(0xdEC7cF4872685a83e3d3FeDd801eE6Ad54344d15, 16000000 * 10 ** decimals());
        _mint(0xeD864B98DbeC9D2f16A8bB9Fc9A28DB8929A0b85, 30000000 * 10 ** decimals());
        _mint(0xb670aeF3263D66Facb494E044d4ec69Cd9fB61c7, 22000000 * 10 ** decimals());
    }
}