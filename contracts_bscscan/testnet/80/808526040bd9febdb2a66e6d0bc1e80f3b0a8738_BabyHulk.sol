...
contract BabyHulk is Context, IERC20, Ownable, Versionable {
    ...
    function setFees(uint256 burnFee, address burnAddr, uint256 teamFee, address teamAddr, uint256 marketingFee, address marketingAddr, uint256 devFee, address devAddr) external onlyOwner() pctInput(teamFee) {
        _burnFee = burnFee;
		_burnAddr = burnAddr;
		_teamFee = teamFee;
		_teamAddr = teamAddr;
