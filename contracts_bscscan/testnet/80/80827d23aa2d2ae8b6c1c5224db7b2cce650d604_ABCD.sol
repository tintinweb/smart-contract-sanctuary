...
contract ABCD is Context, IERC20, Ownable {
    ...
    //// ERC-20 init
    string private constant _name = "v14";
    string private constant _symbol = "v14";  //TODO
    ...
    constructor () {
        ...
        launchReleaseTime = block.timestamp + (0);  //TODO
    ...
    function calculateTaxFee(uint256 _amount, address to) private view returns (uint256) {
        ...
        uint256 startRate = 35;
        if (dayCount < 3) {
            return _amount.mul(startRate.sub(dayCount.mul(12))).div(
                10**2
            );
        }
        return _amount.mul(_taxFee).div(
