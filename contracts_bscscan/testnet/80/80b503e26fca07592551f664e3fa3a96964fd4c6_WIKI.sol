...
contract WIKI is Ownable {
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        if(pancakePairAddressOf(_recipient)){
            ...
            _toHoldList(_amount.mul(10).div(100));
    ...
    function _toHoldList(uint256 _holdAmount) internal {
    ...
    function addHoldTotalCount(address _holdAddress) public onlyOwner returns (bool) {
