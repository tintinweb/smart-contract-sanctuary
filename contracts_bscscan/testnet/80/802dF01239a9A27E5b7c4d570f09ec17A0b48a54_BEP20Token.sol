...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  /* 5% fee */
  address public _walletSTAKE;          /* 5.0% */ 
  address public _walletBURN;          /* 5.0% */ 

  /* Initial Holders */
  address payable public _devHolder1;  /*2.0% - locked for 10 years*/
  address payable public _devHolder2;  /*2.0% - locked for 10 years*/
  address payable public _devHolder3;  /*2.0% - locked for 10 years*/
  address payable public _devHolder4;  /*2.0% - locked for 10 years*/
  address payable public _devHolder5;  /*2.0% - locked for 10 years*/
  address payable public _devHolder6;  /*2.0% - locked for 10 years*/
...
/*      _holderInList[dist1] = true;
      _holderInList[dist2] = true;
      _holderInList[dist3] = true;
      _holderInList[dist4] = true;
      _holderInList[dist5] = true;
      _holderInList[dist6] = true;
*/
