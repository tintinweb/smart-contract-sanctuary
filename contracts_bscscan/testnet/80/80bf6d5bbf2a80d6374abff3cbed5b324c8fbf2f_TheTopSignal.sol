...
contract TheTopSignal is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA4e1b929c3a5Ba509Eb3C7387BdA8A3C20462f67); // Marketing Address
    ...
    string private _name = "The Top Signal";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xA4e1b929c3a5Ba509Eb3C7387BdA8A3C20462f67);
    }
