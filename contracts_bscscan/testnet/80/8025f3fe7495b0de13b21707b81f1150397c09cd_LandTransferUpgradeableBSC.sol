...
contract LandTransferUpgradeableBSC is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Land Transfer", "LT");
        __Ownable_init();
        setURI("https://ipfs.io/ipns/k51qzi5uqu5dgqtirtxnm0vy6zvtu3enn4vmisee4dd67g0ue9plk8mhm2mwq3/LT");
    ...
    function mint(address user, uint256 _tokenId) external {
        ...
        require(_tokenId < _maxTokenId, "CNGE010");
        _safeMint(user, _tokenId);
        _tokenIds.push(_tokenId);
    }

    function saleOfLand(uint256 _tokenId, uint256 _price, uint256 _days) external {
    ...
    function banLand(uint256 _tokenId) external {
        require(msg.sender == ownerOf(_tokenId), 'CNGE001');
    ...
    function landTransfer(uint256 _tokenId) external {
