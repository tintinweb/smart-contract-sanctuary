...
contract ZIONDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("ZION_Dividend_Tracker", "ZION_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override pure {
        require(false, "ZION_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override  pure {
        require(false, "ZION_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ZION contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "ZION_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "ZION_Dividend_Tracker: Cannot update claimWait to same value");
...
contract ZIONIX is ERC20, Ownable {
    
    using SafeMath for uint256;

    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;
    ZIONDividendTracker public dividendTracker;

    address public _marketingWallet = 0xad05b47B81c37c32B7f41B0235c259b9dBeF7b89;
    ...
    uint256 public sellFeeIncreaseFactor = 170; 
    ...
    constructor() ERC20("ZIONIX", "ZIONX") {

        dividendTracker = new ZIONDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "ZION: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ZION: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ZION: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "ZION: Cannot update gasForProcessing to same value");
