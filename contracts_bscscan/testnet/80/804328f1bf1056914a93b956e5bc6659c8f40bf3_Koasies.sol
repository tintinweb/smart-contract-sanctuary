...
/**
   #Koasies(Kali)
   30% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   7% fee auto moved to charity wallet
*/
...
contract Koasies is Context, IERC20, Ownable {
