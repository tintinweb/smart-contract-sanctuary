...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe320Df552e78D57E95cF1182B6960746d5016561);
...
contract MiniDogeCola is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MiniDogeCola OFFICIAL";
    string constant _symbol = "MDC";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0xe320Df552e78D57E95cF1182B6960746d5016561;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x84D4e534ABdD447Ef2Cc8ABD1593a7a7d514F088;
