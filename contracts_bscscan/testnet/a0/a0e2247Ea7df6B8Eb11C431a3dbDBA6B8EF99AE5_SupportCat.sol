...
// SupportCat is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterApe.
contract SupportCat {
    ...
    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many Pie tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws Pie tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes Pie tokens.
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        uint256 stakedSupply = pie.balanceOf(address(this));
    ...
    function updatePool() public {
        ...
        uint256 syrupSupply = pie.balanceOf(address(this));
        if (syrupSupply == 0) {
    ...
    // Deposit Pie tokens to SupportCat for Reward allocation.
    function deposit(uint256 _amount) public {
        require (_amount > 0, 'amount 0');
        UserInfo storage user = userInfo[msg.sender];
        updatePool();
        pie.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    // Withdraw Pie tokens from SupportCat.
    ...
    function emergencyWithdraw() public {
        UserInfo storage user = userInfo[msg.sender];
        pie.safeTransfer(address(msg.sender), user.amount);
