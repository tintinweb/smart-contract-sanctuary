...
contract RuyiToken is Context, IERC20, Ownable, ITokensRecoverable {
    ...
    constructor(address _stakingPool, address _MarketingWallet, address _LiquifyWallet) public {
    ...
    function _tokenTransferStandard(
        ...
        _tOwned[MarketingWallet] = _tOwned[MarketingWallet].add(marketingAmount);
        ...
        _tOwned[LiquifyWallet] = _tOwned[LiquifyWallet].add(AddToLiquidityAmount);
