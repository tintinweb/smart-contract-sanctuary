...
/**
   SYSUSD is a token that rewards holders with BUSD.
...
contract SYSUSD is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    address MAAA = 0x8EB63b3bD16F7f9E52bb609d56926436d8baFC29;

    string constant _name = "SYSUSD";
    string constant _symbol = "SUSD";
    uint8 constant _decimals = 19;

    uint256 _totalSupply = 10000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 1; // 100%
    uint256 public _maxSellTxAmount = _totalSupply / 2; // 50%
    ...
    uint256 buybackMultiplierNumerator = 30;
