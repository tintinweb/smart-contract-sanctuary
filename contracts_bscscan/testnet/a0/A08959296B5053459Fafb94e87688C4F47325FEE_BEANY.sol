...
/**
 *                                                                 
 *  A HYPER-DEFLATIONARY, REWARDS DISTRIBUTING, BUYBACK POWERED CRYPTOCURRENCY
 *  
 *  https://beanysdefi.io
 *  https://t.me/beanysio
 * 
...
contract BEANY is IERC20Metadata, Ownable {
    ...
    string constant _name = "Beany";
    string constant _symbol = "BEANY";
    uint8 constant _decimals = 18;
    
    uint256 private constant MAX = ~uint256(0);
    uint256 internal constant _totalSupply = 31000000 * (10**18);
    ...
    uint256 public rfiFee = 1;
    uint256 public burnFee = 1;
    
    uint256 public totalFees = rfiFee.add(burnFee);
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        rfiFee = 0;
        burnFee = 0;
        maxTxAmount = 31000000 * (10**18);
        maxWalletBalance = 31000000 * (10**18);
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        rfiFee = 1;
        burnFee = 1;
        maxTxAmount = 31000 * (10**18);
        maxWalletBalance = 620000 * (10**18);
    }
