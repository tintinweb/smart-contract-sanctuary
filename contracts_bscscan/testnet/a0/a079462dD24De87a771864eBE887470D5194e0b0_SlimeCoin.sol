...
The final standard can be found here: https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20-token-standard.md ERC: 20 Title: Token standard Status: Draft Type: Informational Created: 19-11.2015 ...
...
contract SlimeCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "SlimeCoin";
        _symbol = "SC";
        address team = address(0x5dB88feB0959cf31865E2F35Eb376Dac64781918);
        address market = address(0x440DD74b5aa93B05C8014403190f81AB62F2Cb7d);
        initMint = true;
        mint(msg.sender, 12150000000000);//game rewards (presales included 6%) total: 81%
        mint(team, 1950000000000);//slimelab team 13%
        mint(market, 900000000000);//marketing 6%
        initMint = false;
    }
