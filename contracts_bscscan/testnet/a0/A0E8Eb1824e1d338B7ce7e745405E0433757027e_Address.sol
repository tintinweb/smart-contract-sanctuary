...
contract HedgeDAO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50000000000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "HedgeDAO";
    string private _symbol = "HDGE";
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**1 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 50000000 * 10**1 * 10**9;
