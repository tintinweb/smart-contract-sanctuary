...
contract BABOX is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABOX";
    string private constant _symbol = "BABOX";
    ...
    function allowPreTrading(address account, bool allowed) public onlyOwner {
        require(preTrader[account] != allowed, "Already enabled.");
