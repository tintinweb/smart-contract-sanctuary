...
contract CareLpLocker is Ownable, ReentrancyGuard {
    ...
    constructor(IPancakeFactory _pancakeFactory) {
    ...
    */
    function increaseLockAmount(uint256 lockId, uint256 amountToIncrement) external nonReentrant onlyLockOwner(lockId) {
        ...
        lock.tokenAmount += actualIncrementAmount;
