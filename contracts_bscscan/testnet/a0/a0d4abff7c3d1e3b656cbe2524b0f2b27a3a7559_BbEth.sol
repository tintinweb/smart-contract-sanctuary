...
contract BbEth is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(address(0x73488599e3396967B52B1990CE22bAfc706C09DF)); //marketing wallet

    address payable public devWallet =
        payable(address(0x2a033DF499Ed6b18b7187FC1E90e7477d174F63e)); //dev wallet
    ...
    constructor() ERC20("Baby Ethereum 3.0", "BBETH") {
        ...
        buyFee.dev = 30;
        buyFee.burn = 10;
        totalBuyFee = buyFee.reward + buyFee.marketing + buyFee.dev;

        sellFee.reward = 50;
        sellFee.marketing = 30;
        sellFee.dev = 30;
        sellFee.burn = 10;
        totalSellFee = sellFee.reward + sellFee.marketing + sellFee.dev;
    ...
    function setDevWallets(address payable _devWallet) external onlyOwner {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            newClaimWait >= 2600 && newClaimWait <= 86400,
