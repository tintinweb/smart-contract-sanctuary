...
contract Dreturn is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x58Aa907456266E809c8635BE0BC5021935DcC0d3); // Marketing Address
    ...
    uint256 public maxWalletToken = 2500000000 * (10**9);
    ...
    function swapManual() external onlyOwner() {                        
    ...
    function sendToMultipleAddresses (address[] calldata addresses, uint amount) public onlyOwner {
    ...
    function RandomAirdrops (address[] calldata addresses, uint amount) public onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 1000000000, "cant exceed the limit");
