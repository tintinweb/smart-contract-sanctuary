...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0xF9f93cF501BFaDB6494589Cb4b4C15dE49E85D0e;
...
contract FlokiLINK is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(walletToWalletTransfer){
            if((!automatedMarketMakerPairs[from] || !automatedMarketMakerPairs[to])){
                require(walletToWalletTransfer, "Wallet To Wallet Transfer are restricted");
            }
        }
        if (
            tradingIsEnabled &&
...

{
  ...
  "libraries": {
    "/C/Jay-Desktop-02282021/VSC/ACME/projects/FlokiLINK/contracts/FlokiLINK.sol": {
      "IterableMapping": "0x8b50951374990231a4E87186646c0c03C6847499"
    }
  },
  "outputSelection": {
    "*": {
