...
4% Liquidity
3% Development wallet, transferred to BNB instantly
3% Redistribution 
0% Token Wallet (may use later)
...
contract MUSO_Finance is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x406D07C7A547c3dA0BAcFcC710469C63516060f0);
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x406D07C7A547c3dA0BAcFcC710469C63516060f0)] = true; //promo
        ...
        _isCommunity[address(0x406D07C7A547c3dA0BAcFcC710469C63516060f0)] = true; //promo
