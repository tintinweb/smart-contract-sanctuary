...
contract RifiScoutAgent is Signed, Ownable, Pausable {
    ...
    external {
        ...
        address signer = getSigner(
            keccak256(
                abi.encode(address(this), this.scout.selector, _inputMetadatas, fee, nonce)
            ), v, r, s);
        require(isSigner[signer], "Forbidden");

        nftPlayer.mint(msg.sender, _inputMetadatas);
    }
