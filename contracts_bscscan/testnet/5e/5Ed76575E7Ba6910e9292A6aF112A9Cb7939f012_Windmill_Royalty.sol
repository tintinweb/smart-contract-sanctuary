...
event GasLog_Windmill_Royalty(uint256 line, uint256 gas);
    ////
    ////
    ////
    //////////////// Public variables ////////////////
...
emit GasLog_Windmill_Royalty(78, gasleft());
        holders.push(address(0x0));
emit GasLog_Windmill_Royalty(79, gasleft());
    }

    function _isHolder(address addr) internal returns (bool){
emit GasLog_Windmill_Royalty(82, gasleft());
        return addressToholderId[addr] != 0;
emit GasLog_Windmill_Royalty(83, gasleft());
    }

    function _addHolder(address addr) internal{
emit GasLog_Windmill_Royalty(86, gasleft());
        addressToholderId[addr] = holders.length;
emit GasLog_Windmill_Royalty(87, gasleft());
        holders.push(addr);
emit GasLog_Windmill_Royalty(88, gasleft());
    }

    function _deleteHolder(address addr) internal{
emit GasLog_Windmill_Royalty(91, gasleft());
        uint256 i = addressToholderId[addr];
emit GasLog_Windmill_Royalty(92, gasleft());
        uint256 lastI = holders.length-1;
emit GasLog_Windmill_Royalty(93, gasleft());
        if (i != lastI){
emit GasLog_Windmill_Royalty(94, gasleft());
            address lastAddr = holders[lastI];
emit GasLog_Windmill_Royalty(95, gasleft());
            holders[i] = lastAddr;
emit GasLog_Windmill_Royalty(96, gasleft());
            addressToholderId[lastAddr] = i;
emit GasLog_Windmill_Royalty(97, gasleft());
        }
        holders.pop();
emit GasLog_Windmill_Royalty(99, gasleft());
    }

    function _afterTokenTransfer(address from, address to, uint256) internal override {
emit GasLog_Windmill_Royalty(102, gasleft());
        if (!_isHolder(to)){
emit GasLog_Windmill_Royalty(103, gasleft());
            _addHolder(to);
emit GasLog_Windmill_Royalty(104, gasleft());
        }

        if (from != address(0x0) && balanceOf(from) == 0){
emit GasLog_Windmill_Royalty(107, gasleft());
            _deleteHolder(from);
emit GasLog_Windmill_Royalty(108, gasleft());
        }
    }
