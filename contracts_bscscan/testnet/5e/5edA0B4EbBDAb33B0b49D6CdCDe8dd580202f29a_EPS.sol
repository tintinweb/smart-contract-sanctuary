...
contract EPS is Context, IERC20, Ownable {
    ...
    uint256 public _maxBuyAmount = 100000000 * 10**_decimals;    // 100m - Initial max buy
    uint256 public _maxSellAmount = 100000000 * 10**_decimals;    // 100m  - Initial max sell
	  uint256 public _maxWallet = 100000000 * 10**_decimals;     // 100m - Initial max Wallet	
    ...
    string private constant _name = "MidGard Token";
  ...
  //  IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
   IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0xB3dd05DE487E4Ad5EF6D2ADB143ACeCd2ac5bd1C); // wallet that accumulates bnb
    ...
    function setMaxBuyPercent(uint256 maxBuyPercent) public onlyOwner {
        _maxBuyAmount = maxBuyPercent * 10**_decimals;
    }

    function setMaxSellPercent(uint256 maxSellPercent) public onlyOwner {
        _maxSellAmount = maxSellPercent * 10**_decimals;
    }
