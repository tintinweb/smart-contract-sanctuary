...
//** Author Alex Hong : Decubate Vesting Contract 2021.6 */
...
contract DecubateVesting is IDecubateVesting, Ownable, ReentrancyGuard {
    ...
    function addWhitelist(
        ...
        whitelistPools[_wallet].wallet = _wallet;
        whitelistPools[_wallet].dcbAmount = _dcbAmount;
        ...
        returns (uint256)
    {
        if (now < vestingPools[whitelistPools[_wallet].vestingOption].cliff) {
            ...
            return whitelistPools[_wallet].dcbAmount;
        } else {
            return
    ...
    function revoke(address _wallet) public onlyOwner {
        ...
        uint256 balance = whitelistPools[_wallet].dcbAmount;
