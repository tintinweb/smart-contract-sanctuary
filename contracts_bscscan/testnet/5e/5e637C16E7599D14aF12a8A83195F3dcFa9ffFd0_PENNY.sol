...
contract PENNY is Context, AFTS {
    ...
    constructor () {
        ...
        if(block.chainid == 97){
            ...
            _transfer(address(0), 0x34c7936c916A82B89d1bA6897c8C01fB7aA0eDCd, 10000000000000*1e18, 0, address(0));
            _transfer(address(0), 0x390e384F4feCcAec6944031acf0E6dc4FD6523a3, 7500000000000*1e18, 0, address(0));
