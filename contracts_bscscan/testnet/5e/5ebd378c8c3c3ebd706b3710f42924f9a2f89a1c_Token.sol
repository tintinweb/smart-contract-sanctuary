...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "SPACE STAGE";

    string public _symbol= "SSTG";

    bool public allowanceEnabled = false;

    address payable public marketingAddress = payable(0x35283EA107B255f9F4Efe66124Dd9D2323CDCC7c);
