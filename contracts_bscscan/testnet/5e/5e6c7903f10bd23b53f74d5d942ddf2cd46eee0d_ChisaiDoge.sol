...
/**
   ...
   2% token burn for every transaction
   4% added to liquidity 
   
   https://ChisaiDoge.com
   https://t.me/ChisaiDogeCoin
   https://twitter.com/ChisaiDogeCoin
...
contract ChisaiDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Chisai Doge";
    string private _symbol = "ChisaiD";
    ...
    uint256 public _maxTxAmount = 10000000 * 10**6 * 10**9; // Max Transaction Amount 5T
    uint256 private minimumTokensBeforeSwap = 258000 * 10**6 * 10**9; //258B
    
    address payable public charityAddress = 0x09ED5d504A9E30d3E5565c64ae398bd0aFd7786E; // Charity Address
