...
contract SWAPToken is ApproveAndCallFallBack, IBSC, Owned {
    ...
    function receiveApproval(address sender, uint256 amount, address tokenContract, bytes memory data) public override {
        ...
        if(tokenContract == VICC) {
            ...
            balances[sender] = balances[sender].addSafe(amountExpected);
