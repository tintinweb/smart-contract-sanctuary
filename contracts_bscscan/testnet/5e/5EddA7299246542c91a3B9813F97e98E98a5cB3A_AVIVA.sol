...
// AVIVA on BSC for all the GOSPEL that wanted cheap transfers and swaps! 
...
contract AVIVA is Context, IERC20, Ownable {
    ...
    string private _name = 'AVIVA';
    string private _symbol = 'AVIVA';
