...
contract WFSH is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _devFee = 1;
        _buybackFee = 1;
        _maxTxAmount = 45000000 * 10 ** _decimals; // 3% of supply
        numTokensSellToAddToLiquidity = 150000 * 10 ** _decimals;
        _marketingWalletAddress = 0xdb8A7F75A36128bCEf6ab048eef7D210313Cf68C;
        _buybackWalletAddress = 0xdb8A7F75A36128bCEf6ab048eef7D210313Cf68C;
        _devWalletAddress = 0xdb8A7F75A36128bCEf6ab048eef7D210313Cf68C;
    ...
    function setTaxFees(uint256 taxFee,uint256 marketingFee,uint256 liquidityFee,uint256 devFee,uint256 buybackFee) external onlyOwner() {
        _taxFee       = taxFee;
    ...
    function _transfer(
        ...
        {    uint256 DevTokens = amount.mul(_devFee).div(10**2);
             uint256 BuybackTokens = amount.mul(_buybackFee).div(10**2);
            _transfer(address(this),_devWalletAddress,DevTokens);
            _transfer(address(this),_buybackWalletAddress, BuybackTokens);
            amount = amount.sub(DevTokens).sub(BuybackTokens);
        }
