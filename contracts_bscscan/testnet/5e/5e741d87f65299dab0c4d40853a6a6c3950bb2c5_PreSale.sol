...
contract PreSale {
    ...
    function buy() external payable {
        ...
        require(totalBought + msg.value <= 0.2 ether, "PreSale#receive: PRESALE_EXHAUSTED");
        require(bought[msg.sender] + msg.value <= 0.1 ether, "Presale#receive: CANT_BOUGHT_MORE_THAN_0.1BNB");
