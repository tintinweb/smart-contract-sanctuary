...
contract HOURS48 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 230000000 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxBuyAmount = 48000000 * 10**3 * 10**9;
    uint256 public maxSellAmount = 230000000 * 10**3 * 10**9;
    uint256 public swapTokensAtAmount = 1000 * 10**3 * 10**9;
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public giveawaysAddress = 0x11Fa36875b668174Ee360738c6eC1104f6419C29; // Giveaway wallet
