...
contract FRKNLKN is Context, IBEP20, Ownable {
    ...
    string private _name = "furkan";
    string private _symbol = "frknlkn";
...
constructor (uint256 marketFee, uint256 gameFee, uint256 resAndDevFee, uint256 taxFee, uint256 nftFee,
