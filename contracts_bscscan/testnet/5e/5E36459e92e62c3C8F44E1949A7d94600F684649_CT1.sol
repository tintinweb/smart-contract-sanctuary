...
contract CT1 is ERC20, Ownable {
    ...
    constructor() ERC20("CT v6", "CT6") {
        ...
        pairAddress = address(uniswapV2Pair);
        ...
        minimumTokensAmountInContract = 10 * 1e18; // todo: updade, to check value!! Swap tokens only if minimumTokensAmountInContract is reached.
