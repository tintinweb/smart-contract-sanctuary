...
// File: contracts/TheDudeToken.sol
...
contract TheDudeToken is Context, IERC20, Ownable {
    ...
    string private _name = "fakecoin";
    string private _symbol = "Dudes";
    ...
    modifier antiWhale(address from, address to, uint256 amount) {
        if (maxTransferAmount() > 0) {
            if (!_excludedFromAntiWhale[from] &&  !_excludedFromAntiWhale[to]) {
    ...
    constructor () public {
        ...
        // address testnet_router = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        address mainnet_router = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(mainnet_router);
        ...
        _excludedFromAntiWhale[address(mainnet_router)] = true;
