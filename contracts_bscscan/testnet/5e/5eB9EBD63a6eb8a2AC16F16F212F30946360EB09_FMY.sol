...
Stealth Launch! 
 ...
 Funky Monkey $FMY
 Group of Brothers were tired of Lazy Devs, we came to provide an honest token to the cryptospace.
Devoted Marketing and hard work to provide an absolute moonshot. 
Hold Tight and Enjoy the ride, its going to get Funky! 

 2% REFLECTIONS 
 8% MARKETING 
 3% LIQUIDITY  
  
  TELEGRAM : FUNKYMONKEYBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA0f580d060C46F9aE2c8221600DcE9A4d66C7686;
...
contract FMY is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x527Fb82Aa571D4220a1CeFbe811A34ec6cb80E29;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Funky Monkey";
    string private _symbol = "FMY";
