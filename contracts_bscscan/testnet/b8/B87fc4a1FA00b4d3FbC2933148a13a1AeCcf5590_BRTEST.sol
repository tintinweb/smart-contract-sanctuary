...
contract BRTEST is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "BRTEST Token";
    string private _symbol = "BRTEST";
    ...
    address payable public _crowdfundWalletAddress;
    ...
    constructor(
        address payable crowdfundWalletAddress,
        address payable marketingWalletAddress,
        address payable devWalletAddress
    ) public {
        _crowdfundWalletAddress = crowdfundWalletAddress;
    ...
    function _setcrowdfundWallet(address payable crowdfundWalletAddress)
        external
        onlyOwner()
    {
        _crowdfundWalletAddress = crowdfundWalletAddress;
    ...
    function sendETHTocrowdfund(uint256 amount) private {
        swapTokensForEth(amount);
        _crowdfundWalletAddress.transfer(address(this).balance);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 crowdfundPercentage = contractTokenBalance.div(10000).mul(1875);
        ...
        sendETHTocrowdfund(crowdfundPercentage);
        sendETHToMarketing(mmPercentage);
        sendETHToDev(devPercentage);

        emit DistributeRewards(crowdfundPercentage, mmPercentage, devPercentage);
    }
