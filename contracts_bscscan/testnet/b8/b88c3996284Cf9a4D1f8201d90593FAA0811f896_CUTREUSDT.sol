...
contract CUTREUSDT is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CUTREUSDT";
    string constant _symbol = "CUDT";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x0E97635291d9540fa4D24411f19885E031eFde04);
