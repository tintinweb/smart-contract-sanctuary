...
contract YCake is IBEP20, Auth {
    ...
    string constant _name = "Yummy Cake";
    string constant _symbol = "YCake";
   ...
   // sell fee
    ...
    address public Owner=0x9738907b83a4DCe1d52187356448F4f003766590; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x15Ae4f48483BF78a65c3732A58fb7054b849C424; // marketing address
