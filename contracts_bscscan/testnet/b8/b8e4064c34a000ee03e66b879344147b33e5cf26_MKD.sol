...
contract MKD is Ownable {
    ...
    string public constant name = "Making";
    string public constant symbol = "mkd";
    uint256 public constant decimals = 6;

    uint256 private constant DECIMALS = 6;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 3300000 * 10**DECIMALS;
