...
contract FLOKI is Context, IERC20, Ownable {
    ...
    address payable EcoAddress = payable(0x38bd94287Da3e765Ea16C36B0732758CA42b7467);// Eco-system address
    ...
    function initContract() external onlyOwner() {
        ...
        EcoAddress = payable(0x38bd94287Da3e765Ea16C36B0732758CA42b7467);
    }
    ...
    function sendETHToFee(uint256 amount) private {
        marketingAddress.transfer(amount.mul(3));
        EcoAddress.transfer(amount.mul(1));
    }
