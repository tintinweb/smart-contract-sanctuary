...
library Address {
     ...
     * [IMPORTANT]
     * ====
     * Leaving a reference to C o m f y T o k e n here
...
contract Lu3 is Context, IERC20, Ownable {
    ...
    string private _name = "Lu3";
    string private _symbol = "LU3";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 5; //default value, but isn't used - calculateProgressiveFee handles this.
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 5; //default value, but isn't used - calculateProgressiveFee handles this.
    ...
    // the magic sauce - cmVk - c o m f y
