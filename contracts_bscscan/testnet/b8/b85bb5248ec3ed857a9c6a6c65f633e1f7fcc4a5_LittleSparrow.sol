...
contract Ownable is Context {
     ...
     */
    constructor() {
        _owner = 0x8a9319A10A26FA5b61587b1902Bd016Bb2c2eb63;
...
contract LittleSparrow is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Little Sparrow";
    string private _symbol = "SPRW";
    ...
    address public charityWallet = 0x26F237531a608d17Ef959d19dc2711675BD3F988;
    ...
    function prepareForPresale() external onlyOwner() {
        ...
        _burnFee = 0;
        _previousBurnFee = _burnFee;
        _maxTxAmount = 1000000000000000000000 * 10**9;
        inSwapAndLiquify = false;
