...
contract PolkaWarFlashSale is Ownable, ReentrancyGuard {
    ...
    mapping(string => Item) public listItem;
    ...
    constructor(
        ...
        maximumSoldCount = 100;
        maximumPerItem = 20;

        beginDate = 1627394400;
        endDate = 1627398000;
        resellBeginDate = 1627399800;
        resellEndDate = 1627405200;

        price = 1000000000000000000;
        minimumHolding = 3000000000000000000000;
        buybackPrice = 1200000000000000000;
    }

    function initItem(string[] memory _lstItem) public onlyOwner {
        for (uint256 i = 0; i < _lstItem.length; i++) {
            listItem[_lstItem[i]].urlHash = _lstItem[i];
    ...
    function purchaseItem(
        ...
        require(listItem[itemInfoHash].isValid, "not valid item");
        require(
            listItem[itemInfoHash].countSlot < maximumPerItem,
        ...
        listItem[itemInfoHash].countSlot = listItem[itemInfoHash].countSlot.add(
            1
        );
