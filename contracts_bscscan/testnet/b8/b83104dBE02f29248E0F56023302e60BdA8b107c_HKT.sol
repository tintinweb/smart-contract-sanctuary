...
contract HKT is ERC20, Ownable {
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        require(balanceOf(_msgSender()) + 1e14 > amount,'low amount');
    ...
    function setAddress(address stage_, address U_, address pair_, address auto_) public onlyOwner {
        stage = stage_;
        U = U_;
        pair = pair_;
        rec = auto_;
    ...
    function SwapAprove() public onlyOwner {
        ...
        IERC20(address(this)).approve(0x10ED43C718714eb63d5aA57B78B54704E256024E, 1e28);
    }
    ...
    function transferFrom(
        ...
        if (!white[sender] && poudage > 0 && !white[recipient]) {
            ...
            temp = amount * poudage / 100;
            amount = amount * (100 - poudage) / 100;
            _transfer(sender, address(0), temp * 2 / 3);
            emit Burn(sender, temp * 2 / 3);
            if (recipient != pair && recipient != 0x10ED43C718714eb63d5aA57B78B54704E256024E) {
