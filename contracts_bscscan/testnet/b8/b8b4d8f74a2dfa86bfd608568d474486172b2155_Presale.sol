...
contract Presale is Ownable, Whitelisted, ReentrancyGuard {
    ...
    function addLiquidity () external onlyOwner nonReentrant {
        ...
        SafeERC20.safeApprove(IERC20(token), address(novaRouter), tokenLiquidity);
        ...
        SafeERC20.safeTransfer(IERC20(token), address(feeManager), feeToken);
    ...
    function widthdrawLiquidity () external nonReentrant {
        ...
        SafeERC20.safeTransfer(IERC20(liqPair), address(Payee), liqAmount);
