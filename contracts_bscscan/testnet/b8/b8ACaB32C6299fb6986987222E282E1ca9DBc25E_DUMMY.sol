...
Change uniswapv2 to MainNet
Update Owner Wallet
Update Dev Wallet - 0xee0FA8Ec7DbE981502898289a9458dd2DF4AFfe5
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a1CE9adae0Fea8e2945eE008dF3D690bE730663; //ACC1
...
contract DUMMY is Context, IERC20, Ownable {
    ...
    address payable private Wallet_Dev = payable(0x9a1CE9adae0Fea8e2945eE008dF3D690bE730663); 
    ...
    uint256 public _FeeLiquidity = 8;
    ...
    //The gleam nuggets holder of maximum repute is donned upon you - Max Wallet Holding Limit!
    ...
    //Setteth p'rmit'd Gallants by trade of knights 100 strong - Set max transation (in percent)
    ...
    //Setteth p'rmit'd Gallants for oneth fine trade - Set max transation in tokens
