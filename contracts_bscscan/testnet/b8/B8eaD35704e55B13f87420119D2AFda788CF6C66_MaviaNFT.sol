  ...
  IMaviaRoyalty
{
    ...
    returns (bool)
  {
    return
      ...
      _interfaceId == type(IMaviaRoyalty).interfaceId ||
  ...
  function burn(uint256 _id) external override {
    require(ownerOf(_id) == _msgSender() || hasRole(BURNER_ROLE, _msgSender()), "MaviaNFT:01");
    ...
    return
      _hashTypedDataV4(
        keccak256(
          abi.encode(
            keccak256(
              "MaviaNFT(address _creator,uint256 _id,uint256 _royaltyFeePercentage,uint256 _priceType,uint256 _price,uint256 _buyNowPrice,uint256 _startTime,uint256 _endTime,uint256 _status)"
            ),
            _creator,
            _id,
  ...
  function setApprovalForAll(address _operator, bool _approved) public override {
    require(_msgSender() != _operator, "MaviaNFT:04");
