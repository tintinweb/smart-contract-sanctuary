...
contract BasicTokenProcessor is MyVeriable{
    ...
    function getTokenAddress(string memory _symbol) onlyOwner public view returns(address)
    {
    ...
    function transferFrom(string memory _symbol, address _fromAddress, address _toAddress1, uint256 _amount1, address _toAddress2, uint256 _amount2) onlyOwnerOrWhiteAccount public returns(bool)
    {
    ...
    function transferFrom(string memory _symbol, address _fromAddress, address _toAddress1, uint256 _amount1, address _toAddress2, uint256 _amount2, address _toAddress3, uint256 _amount3) onlyOwnerOrWhiteAccount public returns(bool)
    {
        transferFrom(_symbol, _fromAddress, _toAddress1, _amount1);
        if(_amount2 > 0 && _toAddress2 != address(0) && _fromAddress != _toAddress2)
        {
