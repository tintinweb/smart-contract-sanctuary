...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Nsur.V6Beta";
    string internal constant SYMBOL = "Nsur.V6Beta";
    ...
    uint256 internal constant numberOfTokensToSwapToLiquidity = 100 ; // 50K BUSD

    // --------------------- Fees Settings ------------------- //

    address internal InsuranceAddress = 0x85FA6B211f4511656d4B8a1C15752aB8433dd534;
    address internal marketingAddress = 0xD8D90330c9Bfe5b683036c96FD2cb80aac3c8639;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.ExternalWithEvent, 15, marketingAddress );
