...
contract CatMoonCoin is Context, IBEP20, Ownable {	
    ...
    string private _name = "CatMoonCoin.com TestNet";	
    ...
    // Set janitor address, ideally a multi-sig wallet managed by the team
    ...
    // Rescue foreign tokens accidentally sent to this contract address by rookies
    ...
    // Liquidates marketing funds in tiny pieces automatically so that receipents of the marketing funds dont hurt the price by selling all at once    
