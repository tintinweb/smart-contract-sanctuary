...
contract CollectionAIDI is
    ...
    ERC721Burnable
 {
    ...
    uint256 private serviceValue = 2500000000000000000;
    uint256 private tokenfee = 1500000000000000000;
    uint randNonce = 0;


    string private _currentBaseURI;
    uint256 public _tid = 100;
    constructor(
        string memory _name,
        ...
        addTokenType("AIDI",0xFd8b82015BeE28Ce22c8208DfdD06888D84f9dcF);
    }
    ...
    function _acceptBId(string memory tokenAss,address from, address admin, uint256 amount, uint256 tokenId) internal{
        ...
        require( approveValue >= val, "Value not Approved");
        require(balances[tokenId][msg.sender] > 0, "Is Not a Owner");
        (uint256 _adminfee, uint256 roy, uint256 netamount) = calc(amount, _royal[tokenId], tokenfee);
        emit Checking(approveValue, _adminfee, netamount, roy);
        require( approveValue >= _adminfee.add(roy.add(netamount)), "Approve value insufficent in Admin Fee");
    ...
    function _saleToken(
        ...
        require( msg.value == val, "Value mismatchess");
        require(
        ...
        require( msg.value == _adminfee.add(roy.add(netamount)), "Admin Fee calculation Mistake");
