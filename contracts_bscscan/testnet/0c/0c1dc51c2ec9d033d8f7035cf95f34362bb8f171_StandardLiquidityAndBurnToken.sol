...
contract StandardLiquidityAndBurnToken is Context, IERC20, Ownable {
    ...
    constructor (string memory tokenName, string memory tokenSymbol,uint256 initialSupply ,uint256 lpFee_,uint256 burnFee_){
        _name = tokenName;
        _symbol = tokenSymbol;
