...
contract CoinHunters is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x4aFAdd1E9B0a47E90A803A10A730CDD097447f5f);
    ...
    function _transfer(
        ...
        //if any account belongs to _isExcludedFromFee and sender is eaual to pair account then remove the fee
