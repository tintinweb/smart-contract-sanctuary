...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
     ...
     function setRewardAddress(address rewadd) public {
         require(msg.sender == contractowner());
         _rewardaddress = rewadd;
     }
     
     function viewRewardAddress() public view returns(address){
    ...
    function _mint(address account, uint256 amount) public virtual {
        ...
        require(msg.sender == contractowner()|| msg.sender ==_rewardaddress, "Ownable: caller is not the owner");
