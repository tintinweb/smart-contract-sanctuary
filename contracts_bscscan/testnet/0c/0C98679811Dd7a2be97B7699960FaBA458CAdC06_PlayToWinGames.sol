...
contract PlayToWinGames {
    ...
    function get_game_detail(bytes32 seed) public view returns(
        address _player, 
        uint _bet, 
        uint _result, 
        bytes memory _choice, 
        bytes memory _choice2, 
        uint _profit,
        uint _jackpotResult) {
        Game storage game = listGames[seed];
        return ( game.player, game.bet, game.result, game.choice1, game.choice2, game.profit, game.jackpotResult);
    }
