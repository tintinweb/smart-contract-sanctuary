...
contract AAA_MONKEY is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _balance_reflected;
    mapping (address => uint256) private _balance_total;
    ...
    // for marketing
    uint256 public _fee_marketing = 1;
...
// Made all parameters in alphabetical order
    ...
    function _setAllFeesTriggers(uint256 dev_fee_convert_limit, uint256 giveaway_fee_convert_limit, uint256 marketing_fee_convert_limit) private {
    ...
    function setAllFees(uint256 Marketing_Fee, uint256 Dev_Fees, uint256 Liquidity_Fees, uint256 Reflection_Fees, uint256 GiveawayFee) external onlyOwner() {
