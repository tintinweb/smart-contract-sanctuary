...
contract ShibaElfTestnet is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaElf Testnet";
    string private _symbol = "SHELFT";
    ...
    address payable public marketingWallet = payable(0x097733966C7ac293a3269C072B00877d02a891B2);
