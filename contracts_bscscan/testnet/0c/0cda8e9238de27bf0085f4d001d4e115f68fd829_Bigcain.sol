...
contract Bigcain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bigcain";
    string constant _symbol = "BCN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 11000000000e9;
    uint256 public _maxTxAmount = 200000000e9;

    //max wallet holding of 2% 
    uint256 public _maxWalletToken = 2000000000e9;
    ...
    address public Owner=0xa193DCbB5DfEd08B35637A3fC7619C41a49D884F; // owner address
    ...
    uint256 public swapThreshold = 1000000e9; // 0.01% of supply
    bool inSwap;
    ...
    constructor () Auth(Owner) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x686990D1481f4C4e842FB84e7DFe826E448f3d23;
