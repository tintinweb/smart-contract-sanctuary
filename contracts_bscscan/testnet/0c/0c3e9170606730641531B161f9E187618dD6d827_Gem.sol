...
contract Gem is IGem, ERC1155, AcceptedToken {
    ...
    function createItem(
        ...
        _items.push(Item(name, maxSupply, 0, 0, 1, 0, rarity, gemType));
     ...
     * @param itemId Id of Item
     */
    function getGemType(uint itemId) external view override returns (GemType) {
        return _items[itemId].gemType;
    }
