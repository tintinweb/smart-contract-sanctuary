...
contract StakingKill {
  ...
  address constant public OWNER = 0x6b3357eEbf0439FeFD77F548355eef79141BF0eF;
  ...
  constructor(uint256 minTerm,uint256 percent,uint256 percentPer,uint256 minDeposit,uint256 accrualPeriod, uint256 timeClose) public {
    _minTerm = minTerm;
    _percent = percent;
