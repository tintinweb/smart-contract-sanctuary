...
contract GoldenDogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("GoldenDogeDividendTracker", "GoldenDoge_DividendTracker") {
        claimWait = 3600;
    ...
    function withdrawDividend() public pure override {
        require(false, "GoldenDogeDividendTracker: withdrawDividend disabled. Use the 'claim' function on the main GoldenDoge contract.");
    }
...
contract GoldenDoge is ERC20, Ownable {
    ...
    address public marketingWallet = 0x32E8EA857B9745C5479735C14423288A1c01A730;
    address public buybackWallet = 0xD8Cc8D2c070AfCd008B5c0c74b46c3DeD1FA8044;
    ...
    constructor() ERC20("Golden Doge", "GDOGE") {
    ...
    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeRouter), "GoldenDoge: The router already has that address");
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "GoldenDoge: The dividend tracker already has that address");

        GoldenDogeDividendTracker newDividendTracker = GoldenDogeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "GoldenDoge: The new dividend tracker must be owned by the GoldenDoge token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GoldenDoge: Account is already the value of 'excluded'");
    ...
    function excludeFromPeriodLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromPeriodLimit[account] != excluded, "GoldenDoge: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTxLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTxLimit[account] != excluded, "GoldenDoge: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "GoldenDoge: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "GoldenDoge: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "GoldenDoge: This account cannot send tokens until trading is enabled");
        }
