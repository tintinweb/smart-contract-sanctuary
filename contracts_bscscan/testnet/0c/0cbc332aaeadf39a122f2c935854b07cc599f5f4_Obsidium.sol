...
contract Obsidium is Context, IBEP20, Ownable {
  ...
  constructor() {
    ...
    _teamWallet = payable(0x02Fc0D04A866147D98969aBC6C5f8c7b9C086056); 
    _buybackWallet = payable(0x02Fc0D04A866147D98969aBC6C5f8c7b9C086056);
  ...
  */
  ...
  /**
    * @dev Swap tokens from obsidium to bnb
   */
  ...
  /**
    * @dev Add obsidium token and bnb as same ratio on pancakeswap router
   */
  ...
  /**
    * @dev the Owner can swap regarding the obsidium token's amount of contract balance
  ...
  /**
    * @dev the Owner can send regarding the obsidium token's amount of contract balance
    * this is for manual function
