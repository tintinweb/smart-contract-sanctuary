...
contract IgoErc20V3 is AccessControl, ReentrancyGuard {
    ...
    mapping(uint => uint) public offers;        // OfferId to tokenId mapping
    ...
    event OfferFilled(uint amount, uint totalPrice, address filler);
    event FundClaimed();
