...
//Just launched in YaniInu. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//YaniInu Hold we will To the moon
//telegram : @YaniInu
...
contract YaniInu is Context, IERC20, Ownable {
    ...
    string private _name = "YaniInu";
    string private _symbol = "YaniInu";
