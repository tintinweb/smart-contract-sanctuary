...
contract CurrencyRegistry is ICurrencyRegistry, Ownable {
    ...
    constructor() {
        ...
        _addressOf["USDC"] = 0x8fa1Bfde90b94F63612Ce42Ea866C52F0B00878d;
        _tickerOf[0x8fa1Bfde90b94F63612Ce42Ea866C52F0B00878d] = "USDC";
    ...
    function addCurrency(string memory ticker, address addr)
        external
        override
        onlyOwner
    {
...
interface ICurrencyRegistry {
    function addCurrency(string memory, address) external;
