...
contract PancakeRouter is IPancakeRouter02 {
    ...
    function _checkIfPairExist(address tokenA, address tokenB) public view returns(bool) {
        return (IPancakeFactory(factory).getPair(tokenA, tokenB) == address(0));
    }

    function _checkGetReserves(address tokenA, address tokenB) public view returns(uint reserveA, uint reserveB) {
    ...
    function _checkPairFor(address tokenA, address tokenB) public view returns(address){
        address pair = PancakeLibrary.pairFor(factory, tokenA, tokenB);
        return pair;
    }
