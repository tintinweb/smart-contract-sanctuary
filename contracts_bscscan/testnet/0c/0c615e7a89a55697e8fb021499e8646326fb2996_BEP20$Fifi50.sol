...
//*TG link hshblock official https://t.me/
//*TG link hshblock official announcement https://
//*Facebook page 
//*Website *//
...
contract BEP20$Fifi50 is Context, IBEP20, Ownable{
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    _balances[account] = _balances[account].sub(amount, "FiFi: burn amount exceeds balance");
