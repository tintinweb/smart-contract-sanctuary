...
// EmpMembers smart contract inherits ERC721 interface
contract EmpMembers is ERC721 {

  // this contract's token collection name
  string public collectionName;
  // this contract's token symbol
  string public collectionNameSymbol;
  // total number of Empress Members minted
  ...
  mapping(uint256 => CryptoBoy) public allEmpMembers;
  ...
  constructor() ERC721("Empress Members Collection", "CB") {
    collectionName = name();
  ...
  function mintCryptoBoy(string memory _name, string memory _tokenURI, uint256 _price, string[] calldata _colors) external {
    ...
    0,
    true);
    // add the token id and it's crypto boy to all Empress Members mapping
    allEmpMembers[cryptoBoyCounter] = newCryptoBoy;
  }
  ...
  function buyToken(uint256 _tokenId) public payable {
    ...
    // get that token from all Empress Members mapping and create a memory of it defined as (struct => CryptoBoy)
    CryptoBoy memory cryptoboy = allEmpMembers[_tokenId];
    ...
    allEmpMembers[_tokenId] = cryptoboy;
  }
