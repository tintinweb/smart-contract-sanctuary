...
contract PresaleDragRace is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public softCapEthAmount = 0.1 ether;
    uint256 public hardCapEthAmount = 0.5 ether;
    ...
    constructor(Piano _token) public {
        token = Piano(_token);
        presale = 0x583d2A624acFC4a01ad93cdDE2a759ad344992A6;
        

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(0 days + 0 hours + 30 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0001 ether; // 10.000 tokens per BNB
