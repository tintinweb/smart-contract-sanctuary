...
contract Olympia is ERC20, Ownable {
    ...
    function _getBuyFeesPerThousand() public view returns (uint256 reflectionFeePerThousand, uint256 liquidityFeePerThousand, uint256 marketingFeePerThousand, uint256 totalFeePerThousand) {
        return (
