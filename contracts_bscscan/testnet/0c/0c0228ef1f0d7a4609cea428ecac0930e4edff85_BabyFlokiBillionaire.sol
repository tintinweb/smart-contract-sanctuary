...
Baby Floki Billionaire is the son of the famous and now trending coin Floki on Binance Smart Chain!
...
contract BabyFlokiBillionaire is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xe2Ff672AeE280F8007c12881Fbdf67cc9765F310;
    address public operationsAddress = 0x6ec070b30dc0E95fA61d4Dc9c39b5a83709d30C8;
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if( from != owner() && to != owner() && to != address(0) && to != address(0xdead) && !_isExcludedFromFee[to]){
