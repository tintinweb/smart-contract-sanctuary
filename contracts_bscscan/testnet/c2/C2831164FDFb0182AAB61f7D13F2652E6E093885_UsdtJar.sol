...
contract UsdtJar is Context {
    ...
    address public UBXT = 0x60D0A3d9642E015DC27a85A037245E43251B6ab8; // testnet ubxt
    IERC20 public token;
    ...
    //Staking pool
    uint256 private _stakedTokenPool; //T
    ...
    {
        require(_currentRewards(msg.sender) >= amount, "Insufficient accrued UBXT");
    ...
    function earnedUBXT(address addy) public view returns (uint256)
    {
        return _accruedUBXT[addy];
    }

    function totalEarnedUBXT() public view returns (uint256)
    {
        return _actualAccruedUBXT;
    }
    ...
    function claimVaultUBXT() private
    {
