...
contract OCTO is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 1000000000000000000000000000  * (10**9);
    uint256 public maxSellTransactionAmount = 1000000000000000000000000000  * (10**9);
    uint256 public swapTokensAtAmount = 1000000000 * (10**9);
    uint256 public _maxWalletToken = 1000000000000000000000000000  * (10**9);
    ...
    // fee aggiuntiva alla vendita del 0%
    ...
    constructor() public ERC20("OCTO", "OCTO") {
        uint256 _tokenRewardsFee = 5;
        uint256 _liquidityFee = 5;
        uint256 _wallet1Fee = 2;
        ...
        burnAddress = address(0xb8c447b8817b799AEa086A2578518252541CDc46);
        ...
        */
        _mint(owner(), 1000000000000000000000000000 * (10**9));
    }
...
contract OCTODividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("OCTO_Dividend_Tracker", "OCTO_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1000000000000 * (10**9); //min 1 trillion
