...
contract BunnySpecialPrediction is Ownable {
    ...
    BnbPricePrediction public anpansPrediction;
    ...
    constructor(
        ...
        anpansPrediction = BnbPricePrediction(_anpansPrediction);
    ...
    function _canClaim(address _userAddress) internal view returns (bool) {
        if (hasClaimed[_userAddress]) {
            ...
            if (!anpansProfile.getUserStatus(_userAddress)) {
                ...
                (roundId, ) = anpansPrediction.getUserRounds(_userAddress, 0, 1);
