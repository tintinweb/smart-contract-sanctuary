...
contract FlokiFinance is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "Floki Inu Finance";
    string private _symbol = "FLOKIF";
    uint8 private _decimals = 9;
   
    uint256 private constant MAX = ~uint256(0);
	uint256 private _DECIMALFACTOR = 10 ** uint256(_decimals);
    uint256 private _tTotal = 5000000000 * _DECIMALFACTOR;
    ...
    uint256 public _maxTxAmount = 50000000 * _DECIMALFACTOR;
    uint256 private numTokensSellToAddToLiquidity = 5000000 * _DECIMALFACTOR;
    ...
    constructor (address _uniswapV2RouterAddress) public {
    ...
    function _transfer(
		...
		require(!paused || from == owner() || to == owner(), "paused");
