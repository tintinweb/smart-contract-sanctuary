...
contract DoctorDoge is IBEP20, DrDogeAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doctor Doge";
    string constant _symbol = "DRDOGE";
    ...
    constructor () DrDogeAuth(msg.sender) {
