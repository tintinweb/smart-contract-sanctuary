...
contract SkillCalculator {
    using ABDKMath64x64 for int128;
    
    function getTokenGainForFight(int128 fightRewardGasOffset, int128 fightRewardBaseline, uint24 monsterPower) public pure returns (int128) {
