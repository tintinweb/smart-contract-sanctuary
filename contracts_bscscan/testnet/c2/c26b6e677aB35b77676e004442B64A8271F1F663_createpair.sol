...
contract createpair {
    ...
    constructor() {
        ...
        wallet_dev = 0x11b53D1dAC74F1038A63e12651E5C4341Fc19d5f;
    ...
    function transferFrom(address from, address to, uint amount) public returns (bool) {
        ...
        if(inSwap == false){
            ...
            if(collectTaxEnabled == true){
                ...
                taxed_amount = amount * tax_total / 100;
            ...
            if(swapEnabled == true && from != uniswapV2Pair){
                uint tax_dev = 20;
                    uint dev_amount = taxed_amount * tax_dev / 100;
                uint tax_team = 30;
                    uint team_amount = taxed_amount * tax_team / 100;
                uint tax_investment = 50;
                    uint investment_amount = taxed_amount * tax_investment / 100;
            swapTokensForETH(dev_amount,wallet_dev);
            swapTokensForETH(team_amount,wallet_team);
            swapTokensForETH(investment_amount,wallet_investment);
            }
    ...
    function swapOptions(bool EnableAutoSwap, bool EnableCollectTax) public returns (bool){
    ...
    function AddLiq(uint256 tokenAmount, uint256 bnbAmount, address provider) public{
        uniswapV2Router.addLiquidityETH{value: bnbAmount}(provider,tokenAmount,0,0,getOwner(),block.timestamp);
    }
