...
contract FarmingPool is Controller, ReentrancyGuard {
    ...
    function updateConfig(address _rewardsDistribution,
        address _stakingToken,
        address _rewardsToken,
        address _stakingContract) external onlyAdmin{
            stakingToken = IERC20(_stakingToken);
            rewardsToken = IERC20(_rewardsToken);
            staking = Staking(_stakingContract);
            rewardsDistribution = _rewardsDistribution;
    ...
    function setMinPoint(uint256 rewardMinPoint) external nonReentrant onlyAdmin{
        ...
        updateReward(msg.sender)
    {
        ...
        uint256 totalPoint = staking.userPoints(msg.sender);
        ...
        updateReward(msg.sender)
    {
        ...
        stakingToken.safeTransfer(msg.sender, amount); // note: fix here
