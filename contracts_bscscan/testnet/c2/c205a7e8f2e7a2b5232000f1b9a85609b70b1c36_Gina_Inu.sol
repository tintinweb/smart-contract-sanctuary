...
// change "name1" into ur name
    contract Gina_Inu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Gina Inu";
    string private _symbol = "GINAINU";
    ...
    constructor() public {
        ...
        devWallet = 0x31566E75E7a7a889Af25612361cFA458426d2E86;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
