...
contract FuzzyswapPool is IFuzzyswapPool, NoDelegateCall {
    ...
    constructor() {
        ...
        (_externalOracle, factory, token0, token1, _tickSpacing) = IFuzzyswapPoolDeployer(msg.sender).parameters();
        ...
        noDelegateCall
    {
        ...
        uint16 observationCardinalityNextNew =
            externalOracle.grow(observationCardinalityNextOld, observationCardinalityNext);
    ...
    function initialize(uint160 sqrtPriceX96) external override {
        ...
        (uint16 cardinality, uint16 cardinalityNext) = externalOracle.initialize(_blockTimestamp());
        ...
        )
    {
        ...
        if (params.liquidityDelta != 0) {
            if (_slot0.tick < params.tickLower) {
                ...
                (slot0.observationIndex, slot0.observationCardinality) = externalOracle.write(
                    _slot0.observationIndex,
                    _blockTimestamp(),
                    _slot0.tick,
                    liquidityBefore,
    ...
    function _changeFee(
        ...
        uint112 TWVolatilityAverage = externalOracle.getVolatilityAverage(
            _time,
            _tick,
            _index,
            _liquidity,
        ...
        fee = uint24(49 * TWVolatilityAverage + fee_);
    }
    ...
    function swap(
            ...
            if (state.sqrtPriceX96 == step.sqrtPriceNextX96) {
                ...
                if (step.initialized) {
                    ...
                    if (!cache.computedLatestObservation) {
                        (cache.tickCumulative, cache.secondsPerLiquidityCumulativeX128,) = externalOracle.observeSingle(
        ...
        _changeFee(cache.blockTimestamp, state.tick, slot0.observationIndex, liquidity, slot0.observationCardinality);
