...
contract bundlememe is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 10000000 * 10**3 * 10**18;  //1% of total supply 10 000 000 000 
    uint256 public maxSellAmount = 10000000 * 10**3 * 10**18; //1% of total supply 10 000 000 000  
    uint256 public _maxWalletSize = 50000000 * 10**3 * 10**18; // 5% of total supply 50 000 000 000 
    uint256 public swapTokensAtAmount = 10000 * 10**3 *10**18; 
    ...
    string private constant _name = "bundlememe";
    string private constant _symbol = "BDM";
