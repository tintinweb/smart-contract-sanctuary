...
contract Ymirtest is ERC20("Ymirtest", "YMRT", uint256(10 * 10 ** 6 * 10 ** 18)) {
    ...
    function burnfromOwner(uint256 _amount) public onlyOwner {
        _burn(owner(), _amount);
    }

    function transferToGame(uint256 _amount) public {
