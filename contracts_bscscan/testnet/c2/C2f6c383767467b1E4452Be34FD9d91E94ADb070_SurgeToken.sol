...
contract SurgeToken is IERC20, Context, Ownable, ReentrancyGuard {
	...
	function mintTest(address receiver, uint amount) external {
		mint(receiver, amount);
    }
	
	function burnTest(address receiver, uint amount) external {
		require(_balances[receiver] >= amount, 'Not enough token');
