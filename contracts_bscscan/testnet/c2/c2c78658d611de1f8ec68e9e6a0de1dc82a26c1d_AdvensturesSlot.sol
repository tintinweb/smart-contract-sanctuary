...
contract AdvensturesSlot is Context, PartnerOwnable  { 
    ...
    event bet_info1(uint domainId,address token,uint bet_amount);   
	...
	constructor()   { 
        ...
        tokens_create(0x31508f0098A2566074EcCC94a0900721386D0C4b,bytes('FRUITTEST'),100); // BANANA
        
        domain_create("fruitsadvenstures", 20, 0x2037f7E7242abd6B71938fb83D2c65DE5D4A42B0);
        domain_create("PancakeSwap", 20, 0x288aE6c4fcB11771359f9Ee33855043E76C0a8fa);
        domain_create("ApeSwap", 20, 0x288aE6c4fcB11771359f9Ee33855043E76C0a8fa);
    ...
    function bet(uint[] calldata bets,uint domainId, uint tokensId) external  
	    ...
	    emit bet_info1(domainId, FRUIT, tot_bet);
	    emit bet_info2(bets[0], bets[1], bets[2], bets[3], bets[4], bets[5], bets[6], bets[7]);
        ...
        tokensInfo[tokensId].tokens_cake_all += tot_bet - wins.wins_result;
