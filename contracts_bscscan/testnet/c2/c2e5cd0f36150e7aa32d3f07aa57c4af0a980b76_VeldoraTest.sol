...
contract VeldoraTest is Context, IERC20, Ownable {
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        _completeTransfer(sender, recipient, values, takeFee);
    }
    ...
    function _completeTransfer(address sender, address recipient, ExtraValues memory values, bool takeFee) private {
        if (takeFee) {
