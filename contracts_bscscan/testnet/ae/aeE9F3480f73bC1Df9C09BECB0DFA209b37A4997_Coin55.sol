...
contract Coin55 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x2B12cbc94da60F0d1E65B1bcaF34D1F058bf0aBa;
    ...
    string private _name = "Coin 55";
    string private _symbol = "C55";
...
//
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair) {
            require(amount <= _maxSellAmount, "Price impact too high.");
        }
