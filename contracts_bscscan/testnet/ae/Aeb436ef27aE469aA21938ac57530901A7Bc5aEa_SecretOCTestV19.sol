...
/*
 *  This is just a Test Contract intended ONLY for the BSC TestNet. This testing token will be temporarily called “Secret OC Test Token V17” ($SOCT17).
 ...
 *  SOCT17 is a fork of TAMARIN which improved the original SAFEMOON contract.
 *  
 *  SOCT17 total Supply is 100.000.000.000 (100B).
 ...
 *  
 *  #SOCT17 10% Taxes are applied to all the token transactions, which is divided as follows:
 *
 ...
 *  any SOCT17 OR BNB tokens being raised on the CC. Thus, preventing any kind of donations scam.
 *
 */
...
interface CharitiesContractCall {
    function checkIfReadyToSwapBNB() external;
}

contract SecretOCTestV19 is Context, IERC20, Ownable {
	...
	string private _name = "SecretOCTest V19";
	string private _symbol = "SOCT19";
   ...
   */
	...
	function _transferBurnAndCharity(uint256 tBurn, uint256 tCharity) private {
		...
		CharitiesContractCall(CHARITIES_CONTRACT).checkIfReadyToSwapBNB();
	}
