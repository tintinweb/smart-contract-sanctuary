...
contract MONKE is Context, IERC20, Ownable {
    ...
    uint256 private minTokensBeforeSwap = 3000000 * 10**_decimals; // 3m
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _rOwned[_P2EWallet] = _rOwned[_P2EWallet].add(rTransferAmount);
        emit Transfer(address(this), _P2EWallet, tTransferAmount);
        restoreAllFee();
    ...
    function updateMinTokensBeforeSwap(uint256 amount) public onlyOwner() {
        require(amount > 100000, "Must be more than 100K tokens!");
        minTokensBeforeSwap = amount * 10 ** _decimals;
    }

    function setP2EWallet(address _address) public onlyOwner() {
        _P2EWallet = _address;
    }
