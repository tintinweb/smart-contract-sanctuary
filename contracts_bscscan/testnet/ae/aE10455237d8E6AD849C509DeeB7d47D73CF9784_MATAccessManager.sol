...
contract MATAccessManager is IMATAccessManager, Ownable {
    ...
    function setEvolveWhilelist(address _to, bool _isWhilelist) public onlyOwner {
        evolveWhilelist[_to] = _isWhilelist;
    }

    function setBreedWhilelist(address _to, bool _isWhilelist) public onlyOwner {
        breedWhilelist[_to] = _isWhilelist;
    }

    function setDetroyWhilelist(address _to, bool _isWhilelist) public onlyOwner {
        detroyWhilelist[_to] = _isWhilelist;
    }
    ...
    function setDetroyPublicAll(bool _detroyPublicAll) public onlyOwner {
        detroyPublicAll = _detroyPublicAll;
    }
    ...
    {
        //TODO: can check _gene and _nftId validation
        return publicAll || bornPublicAll || detroyWhilelist[_caller];
    }
}
