...
contract StakeContract {
    ...
    uint256 [6] private plans = [15 minutes,30 minutes,60 minutes,90 minutes,120 minutes,365 minutes];
    uint256 [6] private percentages = [75,150,300,450,600,1825];
    bool public allow;
    ...
    function stake(uint256 amount,uint256 plan, address refferer) public{
        require(plan >=0 && plan <6 ,"put valid plan details");
        
        token.transferFrom(msg.sender,address(this),(amount));
        token.transferFrom(owner,refferer,amount.mul(refPercent).div(100));
