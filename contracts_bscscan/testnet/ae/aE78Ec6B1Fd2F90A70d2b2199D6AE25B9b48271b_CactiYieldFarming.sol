...
/**
 * @notice - CactiYieldFarming (BEP20 version on BSC) is the master contract of GovernanceToken. This contract can make GovernanceToken.
 */
contract CactiYieldFarming is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        governanceToken.transfer(devaddr, governanceTokenReward.div(10));  /// [Note]: mint method can be used by 
        governanceToken.transfer(address(this), governanceTokenReward);    /// [Note]: mint method can be used by only owner
