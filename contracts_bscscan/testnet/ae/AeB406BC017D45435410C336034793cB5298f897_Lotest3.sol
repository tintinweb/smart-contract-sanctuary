...
contract Lotest3 is Context, IERC20, Ownable { 
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rReflection, uint256 tTransferAmount, uint256 tReflection, uint256 tLiquidity) = _getValues(tAmount);
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return (_amount * _advTotalBNB) / 100;
    }
