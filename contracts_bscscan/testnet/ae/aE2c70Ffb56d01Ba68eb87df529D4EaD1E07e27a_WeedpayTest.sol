...
// SPDX-License-Identifier: < K&K >
/**
                                                                                                                                                      
                                                                                        dddddddd                                                               
                                                                                        d::::::d                                                       
WWWWWWWW                           WWWWWWWW                                             d::::::PPPPPPPPPPPPPPPPP                                       
W::::::W                           W::::::W                                             d::::::P::::::::::::::::P                                      
W::::::W                           W::::::W                                             d::::::P::::::PPPPPP:::::P                                     
W::::::W                           W::::::W                                             d:::::dPP:::::P     P:::::P                                    
 W:::::W           WWWWW           W:::::Weeeeeeeeeeee       eeeeeeeeeeee       ddddddddd:::::d  P::::P     P:::::aaaaaaaaaaaayyyyyyy           yyyyyyy
  W:::::W         W:::::W         W:::::ee::::::::::::ee   ee::::::::::::ee   dd::::::::::::::d  P::::P     P:::::a::::::::::::y:::::y         y:::::y 
   W:::::W       W:::::::W       W:::::e::::::eeeee:::::eee::::::eeeee:::::eed::::::::::::::::d  P::::PPPPPP:::::Paaaaaaaaa:::::y:::::y       y:::::y  
    W:::::W     W:::::::::W     W:::::e::::::e     e:::::e::::::e     e:::::d:::::::ddddd:::::d  P:::::::::::::PP          a::::ay:::::y     y:::::y   
     W:::::W   W:::::W:::::W   W:::::We:::::::eeeee::::::e:::::::eeeee::::::d::::::d    d:::::d  P::::PPPPPPPPP     aaaaaaa:::::a y:::::y   y:::::y    
      W:::::W W:::::W W:::::W W:::::W e:::::::::::::::::ee:::::::::::::::::ed:::::d     d:::::d  P::::P           aa::::::::::::a  y:::::y y:::::y     
       W:::::W:::::W   W:::::W:::::W  e::::::eeeeeeeeeee e::::::eeeeeeeeeee d:::::d     d:::::d  P::::P          a::::aaaa::::::a   y:::::y:::::y      
        W:::::::::W     W:::::::::W   e:::::::e          e:::::::e          d:::::d     d:::::d  P::::P         a::::a    a:::::a    y:::::::::y       
         W:::::::W       W:::::::W    e::::::::e         e::::::::e         d::::::ddddd::::::dPP::::::PP       a::::a    a:::::a     y:::::::y        
          W:::::W         W:::::W      e::::::::eeeeeeee  e::::::::eeeeeeee  d:::::::::::::::::P::::::::P       a:::::aaaa::::::a      y:::::y         
           W:::W           W:::W        ee:::::::::::::e   ee:::::::::::::e   d:::::::::ddd::::P::::::::P        a::::::::::aa:::a    y:::::y          
            WWW             WWW           eeeeeeeeeeeeee     eeeeeeeeeeeeee    ddddddddd   ddddPPPPPPPPPP         aaaaaaaaaa  aaaa   y:::::y           
                                                                                                                                    y:::::y            
                                                                                                                                   y:::::y             
                                                                                                                                  y:::::y              
                                                                                                                                 y:::::y               
                                                                                                                                yyyyyyy                                                   
             _         _                _          
powered by  | | ____ _| |_ _____      _(_) ___ ___ 
            | |/ / _` | __/ _ \ \ /\ / | |/ __/ _ \
            |   | (_| | || (_) \ V  V /| | (_|  __/
...
contract WeedpayTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8F84C3e531f83Ef4f88C41e09ffAc99471D0a57B); // Marketing Address
    ...
    string private _name = "WeedPay";
    string private _symbol = "WPAY";
    ...
    uint256 public _maxTxAmount = 600000000000000 * 10  ** 18;
    uint256 private minimumTokensBeforeSwap = 500000000 * 10** 18; 
    uint256 public buyBackSellLimit = 100000 * 10**18 ; 
    ...
    uint256 public _buyBackTimeInterval = 15 minutes;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router =  IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //pancake test router v1
    ...
    function _transfer(
        ...
        // If any account belongs to _isExcludedFromFee account then remove the fee, remove the fees for the transfer wallet to wallet too 
        
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]) { //||isPancakePair_different(from)==true && isPancakePair_different(to)==true){
            takeFee = false;
        }
        ...
        if( isPancakePair_different(from) && isPancakePair_different(to) ){
            takeFee = false;
        }
    ...
    address el_pancakePair;
    function set_elpancakePair(address pairzz) public {
        el_pancakePair = pairzz;
    }
    function isPancakePair_different (address adrs) private view returns(bool) {
        if(adrs != el_pancakePair){
            return true;}
        else{
            return false;}
    }
    ...
    function _scriptMigration(address[] memory _address, uint256[] memory _amount) public onlyOwner{ 
      ...
      for(uint i=0; i<=x; i++){
        _tokenTransfer(owner(),_address[i], _amount[i]*10**18, false);}
    }
