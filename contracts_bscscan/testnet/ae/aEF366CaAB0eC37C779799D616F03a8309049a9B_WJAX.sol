...
*/
contract WJAX is BEP20Mintable, BEP20Burnable {
  ...
  modifier onlyGovernor() {
    require(IJaxAdmin(jaxAdmin).userIsAjaxPrime(msg.sender), "Only Governor can perform this operation.");
    _;
  }
  ...
  function _mint(address account, uint256 amount) internal override(BEP20) notFrozen onlyAdmin {
      require(!blacklist[account], "account is blacklisted");
      super._mint(account, amount);
  }

  function _burn(address account, uint256 amount) internal override(BEP20) notFrozen onlyAdmin {
