...
contract ClockAuction is Pausable, ClockAuctionBase {
        ...
        whenNotPaused
    {
        ...
        require(_startingPrice == uint256(uint128(_startingPrice)),"test 1");
        require(_endingPrice == uint256(uint128(_endingPrice)),"test 2 ");
        require(_duration == uint256(uint64(_duration)),"test 3");

        require(_owns(msg.sender, _tokenId),"test 4");
...
contract KittyMinting is KittyAuction {
    ...
    function createGen0Auction(uint256 _genes) external onlyCOO {
        require(gen0CreatedCount < GEN0_CREATION_LIMIT,"test 0");
