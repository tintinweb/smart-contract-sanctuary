...
contract SeedifyFundsContract is Ownable {
  ...
  constructor(uint _maxCap, uint256 _saleStartTime, uint256 _saleEndTime, address payable _projectOwner,
    ...
    totalUserInTierOne =5 ;
    totalUserInTierTwo = 5;
    totalUserInTierThree =5;
    totalUserInTierFour = 5;
    totalUserInTierFive =5 ;
    totalUserInTierSix =5 ;
    totalUserInTierSeven = 5;
    totalUserInTierEight = 5;
    totalUserInTierNine = 5;
