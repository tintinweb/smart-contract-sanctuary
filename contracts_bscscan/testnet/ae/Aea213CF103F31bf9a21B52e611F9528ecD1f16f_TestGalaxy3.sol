...
contract TestGalaxy3 is Context, IBEP20, Ownable {
    ...
    string private _name = "TestGalaxy3";
    string private _symbol = "TestGalaxy3";
    ...
    function openTrading() external onlyOwner() {
        ...
        tradingOpen = true;
        //IBEP20(pancakeswapV2Pair).approve(address(pancakeswapV2Router), type(uint).max);
    }
