...
contract BabyOHM is Context, IERC20, Ownable {
    ...
    string private _symbol = "BabyOHM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF9BCc45E0058857515dd371D26a0063914c3D0C1); // Marketing Address
    address payable public BuybackWalletAddress = payable(0xfC69aBdc64C772BAbCD824535B0ee4F5A113FE48); // Buyback Wallet Address
	...
	function setIsExcludedFromMax(address account, bool newValue) public onlyOwner {
