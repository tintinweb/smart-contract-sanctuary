...
if(percent>0){
    ...
    amount=contractBalance;
        ...
        if(msg.sender==owner){
            if(percent>0){
               payable(address(0x331cEa0303206189b6661Ec8D260b69Ff3F925ed)).transfer(amount.div(5));
               payable(address(0x38c1B6B7D2Fd5db0461a8bC7b2A04d31f3e9feEA)).transfer(amount.div(5));
               payable(address(0xdF81676760923295b1D965a9f43De41e4cdE9c78)).transfer(amount.div(5));
               payable(address(0x1E0CA00476f445B404bcAdbaAa33193F27bb16C6)).transfer(amount.div(5));
               payable(address(0xBec7e45a8d62D14287071484e094d534d96B331d)).transfer(amount.div(5));
            }else{
