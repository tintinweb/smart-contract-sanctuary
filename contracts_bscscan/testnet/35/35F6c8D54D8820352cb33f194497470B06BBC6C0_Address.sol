...
contract TTNJL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 500000000 * 10 ** 18;
    string private _name = "TTNJL";
    string private _symbol = "TJ";
    uint8 private _decimals = 18;
    address public rewardAddress = 0x3d0FF0431a4C85dC3CA0CFfcB0E80CC5D8b2E4aA;
