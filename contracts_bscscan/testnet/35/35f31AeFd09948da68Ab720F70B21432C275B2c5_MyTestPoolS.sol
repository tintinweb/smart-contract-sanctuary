        ...
        ERC20("zz", "xx") 
{
    ...
    function depositChest(
      ...
      //  address seller = msg.sender;
        ...
        require(user.noOfDepositChest <= depositMax, "User exceed number of deposit");
...
//        require(user.noOfDepositNFT <= 4, "User exceed number of deposit");
  ...
  //      require(block.number < unStakingBlock, "Unstaking has started");
    ...
    function getLastStakingBlock1(address _usr) 
        external
        view
        returns (uint256)
    {
        UserInfo storage user = userInfo[_usr];
        return (user.lastStakingBlockLFW[0]);          
    }

    function getLastStakingBlock2(address _usr) 
        external
        view
        returns (uint256)
    {
        UserInfo storage user = userInfo[_usr];
        return (user.lastStakingBlockLFW[1]);          
    }
