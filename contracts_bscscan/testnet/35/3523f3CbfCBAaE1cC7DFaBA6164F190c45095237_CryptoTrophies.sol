...
contract CryptoTrophies is ERC721, Ownable {
     ...
     */
    constructor(string memory _baseURI) public ERC721("CryptoTrophies", "CRYPT") {
        setBaseURI(_baseURI);
    }
     ...
     */
    function mineCryptoTrophies(address[] memory _receivers) external onlyOwner {
        ...
        for (uint256 i = 0; i < receiverLength; i++) {
            ...
            require(_receivers[i] != address(0), "mineCryptoTrophies: receiver cannot be address zero");
     ...
     * @dev To get all mined bravo awards
     */
    function cryptoTrophiesOf(address _owner) external view returns (uint256[] memory) {
