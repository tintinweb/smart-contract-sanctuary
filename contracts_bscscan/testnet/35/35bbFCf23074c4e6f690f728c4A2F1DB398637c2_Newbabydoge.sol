...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Newbabydoge is Context , IERC20, Ownable {
    ...
    string private _name = "New Baby Doge";
    string private _symbol = "Newbabydoge";
    ...
    address public devWallet = 0xC60aa863ae29CEE687A0a5D2d5eEdAbbCaE038Be; //2% for marketing ,1% for giveaways
    ...
    uint256 public _maxTxAmount = 10000 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 30000 * 10**9 * 10**9;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //v2 router
