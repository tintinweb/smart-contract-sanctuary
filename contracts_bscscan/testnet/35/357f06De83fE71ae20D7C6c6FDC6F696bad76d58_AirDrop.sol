...
contract AirDrop is Ownable{
    ...
    constructor(){
        ...
        amount = 1250 * 1e18;
        contributors = address(0xd38beA145dAcAd674227d2D2F523A7A710bB7Fb2);
    }

    function setContritubors(address _contributors) public onlyOwner{
    ...
    function airDrop(address _address) public{
        require(IContributors(contributors).exist(_address), "not allowed");
