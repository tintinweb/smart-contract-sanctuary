...
contract ONEi is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xA155C24f6d9AFa6161f1941e22821C6A4aE80f5A);
    address payable public islandWallet = payable(0xE14b972F3896a76D8049D8DD7B07d0413d079E9f);
