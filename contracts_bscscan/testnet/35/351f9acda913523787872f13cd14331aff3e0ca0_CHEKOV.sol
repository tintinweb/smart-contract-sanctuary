...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 690000 * (10**9); // user must hold 210 token
...
contract CHEKOV is
    BASEToken("CHEKOV", "CHEKOV", 69000000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    function setPair(address _pair, bool enable) public onlyOwner {
        pairs[_pair] = enable;
        excludeDividend[_pair] = enable;
    }
