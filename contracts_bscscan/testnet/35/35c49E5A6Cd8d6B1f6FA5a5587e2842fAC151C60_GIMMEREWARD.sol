...
contract GIMMEREWARD is ERC20, Ownable {
    ...
    address public immutable CAKE = address(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca); //CAKE
    ...
    constructor() public ERC20("GIMMEREWARD", "BABYTOK") {
...
contract BABYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    function excludeFromDividends(address account) external onlyOwner {
    	require(!excludedFromDividends[account], "Truffle fuckyourself!");
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 300 && newClaimWait <= 86400, "BABYCAKE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
