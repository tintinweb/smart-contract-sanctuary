...
contract HOTGame{
    ...
    IBEP20 public hotglpAddress;
    IBEP20 public busdAddress;
    IBEP20 public bnbAddress;
    address public destinationAddress;
    
    constructor(
        IBEP20 _hotgAddress,
        IBEP20 _hotglpAddress,
        IBEP20 _busdAddress,
        IBEP20 _bnbAddress,
        address _destinationAddress
    ) public{
        hotgAddress = _hotgAddress;
        hotglpAddress = _hotglpAddress;
    ...
    function sendCoinsViaHOTG(uint256 amount) public {
    ...
    function sendCoinsViaHOTGLP(uint256 amount) public {
         hotglpAddress.safeTransferFrom(
            address(msg.sender),
            address(destinationAddress),
            amount
        );
    ...
    function sendCoinsViaBUSD(uint256 amount) public {
         busdAddress.safeTransferFrom(
            address(msg.sender),
            address(destinationAddress),
            amount
        );
    ...
    function sendCoinsViaBNB(uint256 amount) public {
         bnbAddress.safeTransferFrom(
            address(msg.sender),
            address(destinationAddress),
            amount
        );
