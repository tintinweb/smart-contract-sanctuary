...
contract BabyBackDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0e6e8989E254043Ab19eB7A86b6F9c0BA7D081d2); // Marketing Address
    ...
    string private _name = "BabyBackDOGE";
    string private _symbol = "BBDOGE";
