...
Join the NEWEST addition to the DoTEX🐾 family! DoTEX is the first ever AutoBoost token. HODL and Earn Tokens
AutoBoost: DotEXCoin is the worlds first ever crypto with an adjusting buyback feature for sells of DotEXCoin token. You Sell, We Buy!
 🔘 Buy Tax 12%
    6% Goes to AutoBoost Function
    4% to Marketing Wallet
    2% to Holders
 🔘Sell Tax 18%
    7% goes to AutoBoost Function
    4%% to marketing wallet
    7% to Holders
✅DotEX is built for the holders to win. 12% buy fees and 18% sell fee.
  for more information visit dotexcoin.com
*/
...
contract dotEXCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x07508830574d6ed0966aaCFa2Bb53cd35Bc0a92e); // Marketing Address
