...
contract MEGAETH is ERC20, Ownable {
    ...
    address public ETH = address (0x8BaBbB98678facC7342735486C851ABD7A0d17Ca); //ETH 0x2170Ed0880ac9A755fd29B2688956BD959F933F8
    ...
    function _transfer(
	    ...
	    canSwap &&
            ...
            uint256 buybackTokens = contractTokenBalance.mul(1).div(totalFees);
