...
contract IHC_TEST is Context, IBEP20, Ownable {
    ...
    address private transactionFeeDistributeAddress;
    
    uint private apy;
    uint private loanFeeAmount;
    ...
    */
    ...
    function getLoanFeeAmount() public view returns (uint) {
    ...
    */
    function transfer(address recipient, uint256 amount) public returns (bool) {
        ...
        require(transactionFeeDistributeAddress != address(0), "BEP20: transfer to the zero address");
        ...
        if (_isExcludedTransactionFee[recipient] == true) {
            ...
            _transfer(_msgSender(), transactionFeeDistributeAddress, feeAmount);
        }
    ...
    */
    ...
    function setTransactionFeePercent(uint256 newTransactionFeePercent) public onlyOwner returns (uint256){
    ...
    /**
    * @dev See transactionFeeDistributeAddress.
    */
    function setTransactionFeeDistributeAddress(address newTransactionFeeDistributeAddress) public onlyOwner returns (address) {
        transactionFeeDistributeAddress = newTransactionFeeDistributeAddress;
        return newTransactionFeeDistributeAddress;
    }
    ...
    */
    function getTransactionFeePercent() public view returns (uint256) {
        return transactionFeePercent;
    }
