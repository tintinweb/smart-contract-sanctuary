...
contract MrBatBean is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable (0x0Cf2a37A87d88914Dc13058beDAC6Af5698dFe64); // Marketing Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (30 * 10**6 * 10**9), "Max wallet should be less or euqal to 3% totalSupply");
