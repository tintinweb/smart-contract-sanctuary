...
contract ClaimTokens is Context, Ownable{
    ...
    modifier threeMonthsOnly() {
        require(
            initializedTime +90 days >= block.timestamp,
    ...
    modifier sixMonthsOnly() {
        require(initializedTime + 180 days >= block.timestamp, "Tokens are not unlocked");
        _;
    }
