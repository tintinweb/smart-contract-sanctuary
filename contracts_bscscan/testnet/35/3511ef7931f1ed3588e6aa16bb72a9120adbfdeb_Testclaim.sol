...
//Contract
contract Testclaim is IBEP20, Ownable {
    ...
    string private constant _name = 'TestClaim';  
    string private constant _symbol = 'BNB';    
    ...
    address public MainReward=0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;   //change this address to desired reward token
    address public MiscReward=0x8a9424745056Eb399FD19a0EC26A14316684e274;   //Only MiscReward can be changed to BNB
...
//constructor
    constructor () {
        ...
        defaultBuyBackTax=10;
        defaultDevTax=10;
        defaultBurnTax=10;
        defaultMarketingTax=10;
        defaultLiquidityTax=20;
        defaultStakingTax=40;
