...
contract CTCADVANCED{
   ...
   //For Token Transfer
    ...
    constructor(address ownerAddress,IBEP20 _ctcToken,address _comissionWallet,address _rewardWallet) public 
    {
        ...
        investmentPlans_.push(Plan(50,600*60*60*24,50)); //540 days and 5%
    ...
    function buyToken(uint tokenQty,address referrer) public payable
	{
	     ...
	     address(uint160(comissionWallet)).transfer((msg.value*0)/100);
	     address(uint160(rewardWallet)).transfer((msg.value*0)/100);
    ...
    function withdraw() public payable {
        ...
        ctcToken.transfer(address(this),(withdrawalAmount/priceLevel[priceIndex]));
