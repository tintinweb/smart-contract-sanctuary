...
contract LabradorInu is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 210 *10**6  * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public BurnAddress = 0x000000000000000000000000000000000000dEaD;
    
    string private _name = "Labrador Inu";
    string private _symbol = "LABI";
    ...
    uint256 private numTokensSellToAddToLiquidity = 105 *10**6 * 10**18;
