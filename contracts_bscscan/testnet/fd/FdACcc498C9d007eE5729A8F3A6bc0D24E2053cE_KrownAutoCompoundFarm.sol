...
/**
 * @author The KingDefi Team
 * @title Autocompounding contract for KROWN
 */
contract KrownAutoCompoundFarm is ReentrancyGuard, Pausable, Ownable {
    ...
    function withdraw(uint amount) public nonReentrant  {
        ...
        require(krw.balanceOf(address(this)) >= totalStaked + pendingAmount, "Not enough rewards in contract.");
        ...
        // send amount to user
        krw.safeTransfer(msg.sender, totalAmount);
