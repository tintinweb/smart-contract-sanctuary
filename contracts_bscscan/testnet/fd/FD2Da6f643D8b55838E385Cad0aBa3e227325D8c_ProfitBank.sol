...
// File: contracts/pantherswap-farms/Profit Bank.sol
...
contract ProfitBank is Context, IERC20, Ownable {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender == uniswapV2Pair && ( !excludeFromTaxes[recipient])) {
            _transferStandard(sender, recipient, amount, 0);
        } else if (recipient == uniswapV2Pair && ( !excludeFromTaxes[sender])) {
