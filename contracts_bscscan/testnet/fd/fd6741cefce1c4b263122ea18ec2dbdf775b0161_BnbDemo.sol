...
contract BnbDemo is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public _taxFee = 20; // 2% will be distributed among holder as Bnbdemo divideneds
    ...
    uint256 public _burnFee = 50;  // 5% will go to the Dead address to deflate Bnbdemo
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own Bnbdemo to claim reward');
