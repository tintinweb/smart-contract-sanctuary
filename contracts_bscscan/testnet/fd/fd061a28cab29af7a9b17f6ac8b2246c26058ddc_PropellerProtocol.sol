...
contract PropellerProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Propeller Protocol";
    string private _symbol = "PPP";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee <= 70, "Fee too high.");
        require(taxFee >= 10, "Fee too low.");
        _taxFee = taxFee;
    }
    
    function setLiquidityPercent(uint256 lFee) external onlyOwner() {
        _liquidityFee = lFee;
    }
