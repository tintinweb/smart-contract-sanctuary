...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47); // TESTNET BUSD
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // TESTNET ROUTER
        _token = msg.sender;
    }
...
contract ZetaReticulai is IBEP20, Auth {
    ...
    address BUSD = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // TESTNET BUSD
    address public WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; // TESTNET WBNB
