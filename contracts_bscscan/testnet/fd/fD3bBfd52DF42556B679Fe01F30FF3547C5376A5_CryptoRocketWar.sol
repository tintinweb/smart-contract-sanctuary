...
contract CryptoRocketWar{
    ...
    uint public liquidityLockTime = 1 minutes; // Tiempo que va a estar bloqueada la liquidez.
    ...
    constructor(address payable _teamPinksaleWallet, address payable _marketingWallet, address payable _firstPresaleContract) {
