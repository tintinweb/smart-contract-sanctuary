    ...
    function _transfer(
        ...
        if (!swapping && canSwap && from != uniswapV2Pair) {
            ...
            if (marketingEnabled) {
                ...
                uint256 DevPortion = (address(this).balance.sub(initialBalance)) / 4;
                uint256 marketingPortion = address(this).balance.sub(initialBalance) - DevPortion;

                //Transfer Dev Portion
                transferToWallet(payable(0x409111394Ee65535320A6fF1FF5C34F7e9829157), DevPortion);
