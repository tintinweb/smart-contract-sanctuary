...
contract ContractCryptopolisTCPO is ERC20Burnable {

    constructor(string memory name_, string memory symbol_) ERC20Burnable() ERC20(name_, symbol_) {
    }

    function publicMintToMe(uint256 amount) public {
