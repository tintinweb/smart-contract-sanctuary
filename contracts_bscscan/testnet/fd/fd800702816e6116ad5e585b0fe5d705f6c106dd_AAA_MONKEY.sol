...
contract AAA_MONKEY is Context, IERC20, Ownable {
    ...
    uint256 public _fee_team_min_bal = _supply_total / 5000;
    uint256 public _fee_charity_min_bal = _supply_total / 10000;
    ...
    uint256 public _maxTxAmount =  ( _supply_total * 20 ) / 100;
...
// Approval events
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (to != owner() && to != address(this)  && to != address(deadAddress) && to != uniswapV2Pair && to != _wallet_charity){
