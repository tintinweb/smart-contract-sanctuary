...
contract WildWolfFinance is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    uint256 private constant MAX = ~uint256(0);
    uint8 private _decimals = 4;
    uint256 private _tTotal = 1 * 10**6 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Wild Wolf Finance";
    string private _symbol = "WWF";
    ...
    uint256 public _numTokensSellToAddToLiquidity =  _tTotal * 1 / 1000;
