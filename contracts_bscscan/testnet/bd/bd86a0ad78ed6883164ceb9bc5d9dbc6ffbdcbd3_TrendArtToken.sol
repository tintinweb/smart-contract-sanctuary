...
contract TrendArtToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20000 * 10**8 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Trend Art Token";
    string private _symbol = "TANFT";
    ...
    address public unirouteraddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(unirouteraddress);
