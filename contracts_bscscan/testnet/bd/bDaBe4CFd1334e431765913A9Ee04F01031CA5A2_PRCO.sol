...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TCX = IBEP20(0xC380Fa4b673b267b6626EF177CEA421F9e704Ed0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TCX.balanceOf(address(this));
        ...
        uint256 amount = TCX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TCX.transfer(shareholder, amount);
...
contract PRCO is IBEP20, Auth {
    using SafeMath for uint256;

    address TCX = 0xC380Fa4b673b267b6626EF177CEA421F9e704Ed0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PRCO";
    string constant _symbol = "BPRCOTCR";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xB64E311C44CbAbFE6c2273Cdd7721Af5Dd5b9C38;
