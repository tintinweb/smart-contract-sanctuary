...
contract sYeti is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Yeti", "sYETI", 9) ERC20Permit() {
    ...
    /**
        @notice increases sYETI supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sYETI
