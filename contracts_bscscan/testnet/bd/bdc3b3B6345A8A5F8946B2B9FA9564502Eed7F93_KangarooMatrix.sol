...
contract KangarooMatrix {
    ...
    uint256 public constant periodDuration=2592000; //86400 * 30 = 2592000 seconds
    ...
    function setRefBlocked(uint32 _userID,bool _status) external onlyRoot {
        require(
            _userID>0 
