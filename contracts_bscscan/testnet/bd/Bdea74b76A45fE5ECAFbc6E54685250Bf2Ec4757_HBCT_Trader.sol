...
contract HBCT_Trader is Security {
    ...
    function Convert() payable external onlyContr {
    ...
    function Trade() payable external {
        ...
        this.Convert{value: msg.value}(); // Convert to TOKEN
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(_amTOKEN, 0, _pathTRADE, _msgSender(), block.timestamp);
    }
}
