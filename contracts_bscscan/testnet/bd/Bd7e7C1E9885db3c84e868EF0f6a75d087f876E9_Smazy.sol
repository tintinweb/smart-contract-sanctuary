...
contract Smazy is Ownable, ERC20 {
    ...
    constructor() ERC20("Smazy token", "MAZY") {
        ...
        _totalStakeSupply = 2_000_000_000_000_000_000_000_000;
    ...
    function unstaking(uint256 stakeId) public {
        ...
        uint256 amount = (_stakeOwners[stakeId].amount *
            numberOfBlock *
            _stakeOwners[stakeId].apr) / 1051200000000;
        _mint(_msgSender(), amount);
    ...
    function seToBlock(uint256 newToBlock) public onlyOwner returns (bool) {
        _toBlock = newToBlock;
        return true;
    }

    function seLockBlock(uint256 newLockBlock) public onlyOwner returns (bool) {
