...
contract RugScanToken is ERC20, Ownable {
    ...
    address public _buyBackToken = 0x7d2A2B26bE5570B186A490150c4fB818F188B2b7;
    ...
    constructor() ERC20("RugScan", "RGSN") {
        ...
        devWallet = 0xfcCaA044c7e1d567b191978Fe998a8C6860f0af0;
    ...
    function setMarketingDivisor(uint256 divisor) external onlyOwner {
        require(
            ...
            "RugScan: Marketing divisor must be between 0 (0%) and 100 (100%)"
        );
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(
            ...
            "RugScan: The liquidity wallet is already this address"
        );
