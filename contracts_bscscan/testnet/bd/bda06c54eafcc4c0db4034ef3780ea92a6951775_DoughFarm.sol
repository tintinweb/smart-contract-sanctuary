...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB address
...
contract Dough is ERC20, Ownable, Authorizable {
    ...
    address public _dividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB address
    ...
    constructor() ERC20("Dough", "DOUGH") {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD1E15281258959B3dE7CbC119bB230a668cD92A6); // ExtendSwap Router
...
//
// Do you need a Solidity Developer?
// Do you want a contract like this made for you?
// Contact me on Telegram: @bytesoul (https://t.me/bytesoul)
//
...
contract DoughFarm is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number, _pid);
        uint256 doughReward = multiplier.mul(pool.doughPerBlock);
        dough.mint(address(this), doughReward);
