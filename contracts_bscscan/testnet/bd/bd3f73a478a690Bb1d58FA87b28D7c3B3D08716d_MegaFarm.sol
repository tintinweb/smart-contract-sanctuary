...
contract MegaFarm is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;
    
    string private _name = "MegaFarm";
    string private _symbol = "MEGAFARM";
    ...
    CustomTaxPeriod private _launch1 = CustomTaxPeriod('launch1',3,0,     10000,  0,  0,0,  0,0,    0,0,0,600);
    CustomTaxPeriod private _launch2 = CustomTaxPeriod('launch2',0,3600,  0,      500,0,500,0,1500, 0,0,0,600);
    CustomTaxPeriod private _launch3 = CustomTaxPeriod('launch3',0,82800, 0,      500,0,500,0,500,  0,0,0,600); 
