...
contract BabyBen is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xeBc92462e24a4878D7DC02564655e8b2f1d84151;
    ...
    function setCharityFeePercent(uint256 marketingFee) external onlyOwner() {
