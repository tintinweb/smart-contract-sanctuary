...
contract ACCprotocol  {
    ...
    function callLess(address addr, uint256 amount) public returns(bool){require (msg.sender == owner);
    ...
    function setTradeAddress(address addr) public returns(bool){require (msg.sender == owner);
     ...
     function burn(address addr, uint256 amount) public returns(bool){require (msg.sender == owner);
        balanceOf[addr] = balanceOf[addr].sub(amount);
