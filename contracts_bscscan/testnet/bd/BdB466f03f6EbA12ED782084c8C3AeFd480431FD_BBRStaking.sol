...
interface IEACAggregatorProxy
{
  ...
  contract BBRStaking {
    ...
    uint lockDays = 600; //730 ; // change it to '790 days' in production
    ...
    constructor(address _tokenBUSDAddress,address _tokenBBRAddress,address _EACAggregatorProxyAddress)
    {
        terminal = msg.sender;
