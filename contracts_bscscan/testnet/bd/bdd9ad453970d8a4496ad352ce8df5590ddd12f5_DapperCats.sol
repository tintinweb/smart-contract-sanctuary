...
contract DapperCats is Context, IERC20, Ownable 
{
    ...
    uint256 private _tTotal = 26000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Dapper Cats";
    string private _symbol = "DAPCAT";
    ...
    address public charityWallet =  0xeCeE8a2652D5E9B64B9C61A68d8D2FB60d1bD1f2;  
    ...
    uint256 public _maxTxAmount = 26000000000 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        _transferStandard(sender, charityWallet, amtWalletS);
