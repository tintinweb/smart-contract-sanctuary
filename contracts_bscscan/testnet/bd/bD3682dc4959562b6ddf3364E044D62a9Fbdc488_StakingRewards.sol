...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
   ...
   // using SafeERC20 for IERC20;
    ...
    constructor(
        address _rewardsDistribution, // contract calling the staking contract
    ...
    function getBalance(address _sender) external view returns (uint256) {
        return stakingToken.balanceOf(_sender);
    }
