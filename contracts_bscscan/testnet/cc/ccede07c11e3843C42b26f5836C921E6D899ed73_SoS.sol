...
contract SoS is ERC20, Ownable {
    ...
    TIKADividendTracker public dividendTracker;
    ...
    constructor() public ERC20("ShibaofSteel", "SoS") {
    	...
    	dividendTracker = new TIKADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        TIKADividendTracker newDividendTracker = TIKADividendTracker(payable(newAddress));
...
contract TIKADividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
