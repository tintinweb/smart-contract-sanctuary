 ...
 * DogeBomber-v2
 *
 * This DbomBv2 Token created and Govern by 168 Project Community
 * Code edited by @Vhanzz
 * Special thanks to @LemanCrypto
 */
...
contract DogeBomber2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeBomber v2";
    string constant _symbol = "DBOMB2";
