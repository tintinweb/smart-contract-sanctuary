...
contract BTAARMADA is IERC20Metadata, DepreciatingFees, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public MarketingChestAddress = 0xd858c9c6bE677cF105aCC3f3Ea46137Ba2082222; // MarketingChest Address
    address internal deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public presaleAddress = address(0);
    
    string constant _name = "BTAArmada";
    string constant _symbol = "BTAARMD";
    ...
    constructor () {
        ...
        IPancakeV2Router _newPancakeRouter = IPancakeV2Router(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Test router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 || normal router = 0x10ED43C718714eb63d5aA57B78B54704E256024E 
