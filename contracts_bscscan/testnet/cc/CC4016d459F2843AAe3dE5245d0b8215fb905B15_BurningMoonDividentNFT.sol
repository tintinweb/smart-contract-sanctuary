...
contract BurningMoonDividentNFT is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    ...
    uint256 public currentValue=10**16/4; //0.0025BNB per NFT
    ...
    constructor() {
        ...
        NFTPrototypes.push(NFTData("Prismatic Sacrifice Blade", ""));
        NFTPrototypes.push(NFTData("Prismatic BurningMoon Blade", ""));
        NFTPrototypes.push(NFTData("Prismatic Gabriel's Song", ""));
        NFTPrototypes.push(NFTData("Prismatic Rainhard's Might", ""));
        NFTPrototypes.push(NFTData("Sacrifice Blade", ""));
        NFTPrototypes.push(NFTData("BurningMoon Blade", ""));
        NFTPrototypes.push(NFTData("Gabriel's Song", ""));
        NFTPrototypes.push(NFTData("Rainhard's Might", ""));
        NFTPrototypes.push(NFTData("Sword 01 Metallic", ""));
        NFTPrototypes.push(NFTData("Sword 01 Magic", ""));
        NFTPrototypes.push(NFTData("Minion 01 BM", ""));
        NFTPrototypes.push(NFTData("Minion 02 BM", ""));
        NFTPrototypes.push(NFTData("Minion 03 BM", ""));
        NFTPrototypes.push(NFTData("Minion 04 BM", ""));
        NFTPrototypes.push(NFTData("Minion 01", ""));
        NFTPrototypes.push(NFTData("Minion 02", ""));
        NFTPrototypes.push(NFTData("Minion 03", ""));
        NFTPrototypes.push(NFTData("Minion 04", ""));
        Minted=new uint[](18);
    ...
    uint256 public MaxNFTCount=800;
    ...
    function getUniqueCountOfRarity(uint NFTType, address account) public view returns(uint){
        uint[] memory counts=NFTHold[account];
        uint count;
        for(uint i=0;i<counts.length;i++){
            if(uint8(NFTs[i])==NFTType){
                if(counts[i]>0)
                count++;
            }
        }
    ...
    function _AddNFT(address account, uint256 ID) private{
        ...
        uint Shares=getSharesOfNFT(NFTs[ID]);
        totalShares+=Shares;
