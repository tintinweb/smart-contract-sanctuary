...
contract MyTokenNew is Context, IERC20, Ownable {
    ...
    uint    private startingSupply = 1000000000000; // Underscores aid readability
    ...
    string  private _name = "MyTokenNew";
    string  private _symbol = "NEW1";
    ...
    uint256 public _marketingFeeSell = 10; // 1%, divisor is 100
    uint256 private _previousMarketingFeeSell = _marketingFeeSell;

    uint256 public _burnFeeSell = 10; // 1%, divisor is 100
...
,        address to,
        ...
        if(to == uniswapV2Pair){
            ...
            _marketingFeeSell = _marketingFeeSell;
            _burnFeeSell = _burnFeeSell;
        }
    ...
    function checkDoubleTaxAmt(address recipient, uint256 amount) internal {
        if (recipient == uniswapV2Pair) {
            if (amount > _doubleTaxAmt) {
                ...
                _marketingFeeSell = _marketingFeeSell.mul(2);
                _previousBurnFeeSell = _previousBurnFeeSell.mul(2);
            }
        }
    }
