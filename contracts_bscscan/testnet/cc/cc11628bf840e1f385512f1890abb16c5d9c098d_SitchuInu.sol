...
/* 
    ...
    Name: SitchuInu
    Telegram Community: https://t.me/Sitchuinu_Official
    Website: http://sitchuinu.com/
...
contract Ownable is Context {
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(_owner).transfer(amountBNB * amountPercentage / 100);
    }
}
...
contract SitchuInu is Context, IERC20, Ownable {
    ...
    string private _name = "Sitchu Inu";
    string private _symbol = "Sitchu";
    ...
    address payable public marketingWallet = payable(0x58C9e700422a465E4568FE3c46f12C0590Fe1641);
    address payable public devWallet = payable(0x58C9e700422a465E4568FE3c46f12C0590Fe1641);
    ...
    uint256 public maxWalletToken = 10000000000000 * 10**9;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
         // Create a uniswap pair for this new token / 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 testnet
