...
// ----------------------------------------------------------------------------
// SmartWalletToken main contract (2021) 
//
// Symbol       : SWT
// Name         : SmartWalletToken
...
// SWT BEP20 Token 
// ----------------------------------------------------------------------------
contract SWT is Owned {
    using SafeMath for uint;

    bool public running = true;
    string public constant symbol = "SWT";
    string public constant name = "SmartWalletToken";
    ...
    constructor() {
        _totalSupply = 300000000000 * 10**uint(decimals);
