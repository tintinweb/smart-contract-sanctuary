...
contract FUCKPIXIU is ERC20, Ownable {
    ...
    uint256 public burnBlocks;
    bool private swapping;
    FUCKPIXIUDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public BNB = address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    // test dai 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    // test bnb 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    // online cake 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82
    // online bnb 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    uint256 public swapTokensAtAmount = 50 * (10**6) * (10**18);

    mapping(address => bool) public _isBot;
    uint256 public _maxTxAmount = 5000 * (10**6) * (10**18); // 5% of total supply
    ...
    constructor() public ERC20("QVQ", "QVQ") {
        dividendTracker = new FUCKPIXIUDividendTracker();
    ...
    function setBurnBlocks(uint256 value) external onlyOwner {
        burnBlocks = value;
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        FUCKPIXIUDividendTracker newDividendTracker = FUCKPIXIUDividendTracker(
            payable(newAddress)
        );
    ...
    function checkBurn() public view returns (bool) {
        return launchedAt + burnBlocks >= block.number;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 sellTokens = contractTokenBalance.mul(BNBRewardsFee).div(
                totalFees
            );
...
contract FUCKPIXIUDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor()
        public
        DividendPayingToken(
            "FUCKPIXIU_Dividen_Tracker",
            "FUCKPIXIU_Dividend_Tracker"
        )
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 100 * (10**6) * (10**18);
    }
