...
contract LinaCoin is Context, IBEP20, Ownable {
    ...
    string private _name = "Lina Coin";
    ...
    address public CharityWallet = 0x8AD1eCF53bdedB0b5B619427a490Fdd63B39FAC3; // Charity Wallet address Here ....
    ...
    constructor () public {
     ...
     startSale(block.number, 999999999, 0,100000*10**18, 100000000000);
