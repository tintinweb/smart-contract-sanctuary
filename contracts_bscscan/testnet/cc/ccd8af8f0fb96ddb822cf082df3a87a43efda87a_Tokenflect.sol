    ...
    contract Tokenflect is IBEP20, Ownable {
        ...
        function _priceImpactTax(uint256 amount) private returns (bool) { 
            ...
            if (_reserveA == 0 && _reserveB == 0){
                ...
                uint256 _delta_price  = _market_price.div(_new_price);
                
                emit Watch2("_priceImpactTax _delta_price = ", _delta_price.mul(100));
                
                return (_delta_price.mul(100) > 1200000000000000000); // 2% de variation
            }
        }
