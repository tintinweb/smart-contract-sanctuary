...
~ ANTI-WHALE CONTROL FEATURES:
  ...
  Max withdraw amount of 6666 ADA per day.
...
contract adalmoonfarm {
	using SafeMath for uint256;

	IERC20 public erctoken;
	address token = 0x9fa4fE8a0b1e621847c729CD3a6d9DA9f642728f; /** ADA **/
	/** default percentages **/
	...
	uint256 public MAX_WITHDRAW = 6666 ether;
	...
	uint256 public LOTTERY_TICKET_PRICE = 50 * 1e17; /** 5 ADA **/
	...
	constructor(address ownerAddress, address payable projectAddress, address payable marketingAddress, address payable communityAddress) {
        ...
        plans.push(Plan(200, 30, 50 * 1e17, 0, 0, 0, 0, true));
        plans.push(Plan(40,  70, 50 * 1e17, 0, 0, 0, 0, true));
        plans.push(Plan(60,  65, 50 * 1e17, 0, 0, 0, 0, true));
        plans.push(Plan(80,  60, 50 * 1e17, 0, 0, 0, 0, true));
	}
