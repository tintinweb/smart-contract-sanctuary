...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 46 * 10**12 * 10**9;
    ...
    uint256 public _maxWalletToken = 46 * 10**9 * 10**9; // Max Wallet: 46 billion 
    ...
    uint256 public _maxTxAmount = 46 * 10**8 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 25000 * 10**3 * 10**9;
    ...
    constructor()  {
        ...
        setRouterAddress(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //update this address
        
        // 0xD99D1c33F9fC3444f8101754aBC46c52416550D1    97
        // 0x10ED43C718714eb63d5aA57B78B54704E256024E    57
        

        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[address(0x000000000000000000000000000000000000dEaD)] = true; //burn address
    ...
    // Owner cannot transfer out contract coin from this smart contract
