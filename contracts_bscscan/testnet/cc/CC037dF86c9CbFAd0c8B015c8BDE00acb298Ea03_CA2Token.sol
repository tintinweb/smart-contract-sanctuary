...
contract CA2Token is MinterRole, IERC20 {
    ...
    constructor() public {
        ...
        _symbol = "CA2";
        _decimals = 18;
        _totalSupply = 25000000000000000000000000 ether; // test
        _maxAmount = 25000000000000000000000000 ether; // test
        _balances[msg.sender] = 25000000 ether;
    }
