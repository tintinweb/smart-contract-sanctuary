...
contract RedFrog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    string public _name = "RedFrogTest";
    ...
    address payable public feeWallet = payable(0x47A597414808f233dD0e2d1402370954E7c03437);
