...
contract CryptoInvetorInu is ERC20, Ownable {
    ...
    constructor() ERC20("testss", "test") {
        _mint(msg.sender, 1000000000*10**decimals());
        _mint(address(this), 100000000*10**decimals());
        startSale(block.number, 999999999, 0,5000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,200*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
