...
contract TTHStake is Owned , ReentrancyGuard {
    ...
    function calculateEarnings(address _stakeholder) public view returns(uint) {
        ...
        uint activeDays = (block.timestamp.sub(lastClock[_stakeholder])).div(180);
    ...
    function withdrawEarnings() external returns (bool success) {
        ...
        uint totalReward = (referralRewards[msg.sender]).add(calculateEarnings(msg.sender));
        ...
        uint remainder = (block.timestamp.sub(lastClock[msg.sender])).mod(180);
