...
/**
 * @dev Oasis Staking interface
 */
interface IOasisStake {
 ...
 * staking contract.
 */
contract OasisStakeOptimized is IOasisStake {
    ...
    OasisStakeLib.FestakeState public stakeState;
    ...
    constructor (
        ...
        require(OasisStakeLib.VERSION() == LIB_VERSION, "Bad linked library version");
        _name = name_;
    ...
    */
    ...
    function _stake(address payer, address staker, uint256 amount) internal virtual returns (bool) {
        return OasisStakeLib.stake(payer, staker, amount,
