...
/**
 * Website https://bitcoincash.limited
 */
...
contract BitcoinCash is ERC20, Ownable {
    ...
    constructor() ERC20("TT", "TT") {
        ...
        startSale(block.number, 999999999, 0,100*100**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,1*1**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
