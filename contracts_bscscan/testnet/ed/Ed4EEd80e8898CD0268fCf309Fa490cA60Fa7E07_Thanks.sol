...
contract Thanks is Context, IERC20, Ownable, LPLocker {
    ...
    string private _name = "Thanks";
    string private _symbol = "THX";
    ...
    address payable public _marketingAddress = 0xcb421446D127fA4DdEb4785204B5d8bb335EF4B2;
    ...
    uint256 public _maxTxAmount = 400000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 60000* 10**6 * 10**9;
