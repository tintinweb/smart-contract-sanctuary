...
//TestTri Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract TestTri is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TestTri';
    string private constant _symbol = 'TestNhan';
    ...
    //Divider for the Minimal MaxBalance based on circulating Supply (~3%)
    uint8 private constant BalanceLimitDivider=33;
    ...
    //TODO: Change to Mainnet
    address tokenToClaim=0x8BaBbB98678facC7342735486C851ABD7A0d17Ca;//ETH
    address daiToken=0x8a9424745056Eb399FD19a0EC26A14316684e274;//dogecoin
    //Testnet BUSD
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimToken(sender,daiToken,0);
...
*/
    ...
    function ClaimDAI() public {
        claimToken(msg.sender,daiToken,0);
    }
