...
contract COIN is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // Supply
    // @note: 10**18 means a 1 with 18 zeroes.  
    // @note: 1 * 10**18 is 1 with 18 decimals.
    uint8 private _decimals = 18;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 666 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    // Max TX in tokens
    uint256 public _maxSellTxAmount = 0.666 * 10**18;
    uint256 public _maxBuyTxAmount = 0.666 * 10**18;

    // Max Wallet in tokens
    uint256 public _maxWalletSize = 666 * 10**18;

    // Cooldowns
    uint16 public constant MaxSellLockTime = 30 seconds;
    ...
    uint256 private marketingFeeBuy = 0; 
    uint256 private totalFeeBuy = 10;

    // Sell tax in percentage
    uint256 private liquidityFeeSell = 10;
    uint256 private burnFeeSell = 0;
    uint256 private taxFeeSell = 0;
    uint256 private marketingFeeSell = 0;
    uint256 private totalFeeSell = 10;
    ...
    uint256 private numTokensSellToAddToLiquidity = 0.1337 * 10**18; 
    ...
    function _transfer(
        ...
        // TODO: Should test how much numTokensSellToAddToLiquidity should be used
    ...
    // Sets swap and liquify true or false
