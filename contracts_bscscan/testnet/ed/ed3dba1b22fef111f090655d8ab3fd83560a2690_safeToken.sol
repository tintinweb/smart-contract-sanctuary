...
contract safeToken is Context, IERC20, Ownable {
    ...
    address private _safeInvestmentFund = 0x576619b4071A620AfC625e45E1fa348A3E2251Dc;
    address private _donationWalletAddress = 0x576619b4071A620AfC625e45E1fa348A3E2251Dc;
    address private _safeArGameWalletAddress = 0x576619b4071A620AfC625e45E1fa348A3E2251Dc;
    address private _serviceWalletAddress = 0x576619b4071A620AfC625e45E1fa348A3E2251Dc;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000e10;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_safeInvestmentFund] = true;
        _isExcludedFromFee[_donationWalletAddress] = true;
        _isExcludedFromFee[_safeArGameWalletAddress] = true;
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_safeInvestmentFund] = _rOwned[_safeInvestmentFund].add(rDev);
        if(_isExcluded[_safeInvestmentFund])
            _tOwned[_safeInvestmentFund] = _tOwned[_safeInvestmentFund].add(tDev);
    }
