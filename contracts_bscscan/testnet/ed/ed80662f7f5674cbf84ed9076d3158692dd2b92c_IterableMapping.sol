...
contract Cryptotem is ERC20, Ownable {
    ...
    constructor() ERC20("RESPECTthePAMP", "RTP") {
        BNBRewardsFee = 4;
        liquidityFee = 4;
        CryptotemFee = 2;
        MarketingFee = 4;
        CryptotemWallet = payable(0x081a159B3C5F90f925024482C176d59CcafCBd79);
        MarketingWallet = payable(0x081a159B3C5F90f925024482C176d59CcafCBd79);
