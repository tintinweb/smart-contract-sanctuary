...
contract MissDoge is Context, ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingAddress = payable(0x1476275ac229E8aFcE46D9C7EC126ee10178036E); 
    ...
    int256 private _testInt;

    string private _name = "Miss Doge";
    string private _symbol = "MDOGE";
    uint8 private _decimals = 9;


    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee.add(0x01);
    ...
    constructor () ERC20("Godzilla", "GODZ"){
        ...
        //uniswapV2Pair = address(0x1476275ac229E8aFcE46D9C7EC126ee10178036E);
    ...
    function getTestInt() public onlyOwner() returns (int256){
        return _testInt.add(0x11);
    }
