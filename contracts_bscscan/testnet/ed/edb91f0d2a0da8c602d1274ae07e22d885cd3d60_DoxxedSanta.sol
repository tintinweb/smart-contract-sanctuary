...
contract DoxxedSanta is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 3_000_000_000_000 * 10**18;
    uint256 public maxSellLimit = 1_000_000_000_000 * 10**18;
    uint256 public maxWalletLimit = 10_000_000_000_000 * 10**18;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xC53d164eb59357742aB81FeBF82d314fEaD036ea;
    address public devWallet = 0xC53d164eb59357742aB81FeBF82d314fEaD036ea;
    address public buybackWallet = 0xC53d164eb59357742aB81FeBF82d314fEaD036ea;
    address public lotteryWallet;
    address public charityWallet = 0xC53d164eb59357742aB81FeBF82d314fEaD036ea;
    ...
    Taxes public taxes = Taxes(3, 5, 3, 1, 1, 4, 1);
    Taxes public sellTaxes = Taxes(3, 5, 3, 1, 1, 4, 1);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        if(state == true && genesis_block == 0) genesis_block = block.timestamp;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tLottery = tAmount*temp.liquidity/100;
