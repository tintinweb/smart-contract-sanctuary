...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1C277C1eBD3Fc028692701975cDAf7FA00Fc5D8D;
...
contract NODROP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0000000000000000000000000000000000000000;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NODROP";
    string private _symbol = "NDRP";
