...
contract CHARITY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "4CH4RITY";
    string private _symbol = "4CHAR";
    ...
    uint256 internal _tokenTotal = 100000000000000000e9;
    ...
    uint256 public _liquidityFee = 0; // means 0% add liquidity on each buy and sell
    uint256 public _burnFee = 5; // means 5% it menas on burn 
    
    uint256 public MarketingFee=500; //500 means 5% will send to Marketing
    
    
    address MarketingAddress=0x64590dC089ff1c1668153681af5dB513c3e0Bd3f; //
    ...
    constructor() public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // for test
    ...
    function _transfer(
        ...
        uint256 tokensToBurn = find2Percent(transferAmount);
        uint256 tokensToTransfer = transferAmount.sub(tokensToBurn);
        ...
        _reflectionBalance[recipient] = _reflectionBalance[recipient].add(tokensToTransfer.mul(rate));
