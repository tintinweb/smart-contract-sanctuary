...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Bajo Dvica";
    string internal constant SYMBOL = "BJJ";
     ...
     */
    address internal tipToTheDev = 0x498189dB4b1059Fb721B5be69aA3c40e97D0c87B;
    ...
    function _addFees() private {
         ...
         */ 
        _addFee(FeeType.Rfi, 120, address(this) ); 
...
abstract contract BajoTokenAbs is BaseRfiToken, Liquifier, Antiwhale {
...
contract BajoToken is BajoTokenAbs{

    constructor() BajoTokenAbs(Env.Testnet){
