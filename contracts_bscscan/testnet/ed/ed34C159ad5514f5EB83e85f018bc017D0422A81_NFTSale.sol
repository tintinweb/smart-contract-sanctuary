...
contract NFTSale is Ownable { 
    ...
    function BuyToken(uint256 _tokenId, IERC721Metadata _contractNFT) public payable{
        ...
        if (address(allTokenSale[_contractNFT][_tokenId].contractERC20) != address(0)) {
            allTokenSale[_contractNFT][_tokenId].contractERC20.transferFrom(msg.sender, allTokenSale[_contractNFT][_tokenId].owner, allTokenSale[_contractNFT][_tokenId].price);
            _contractNFT.transferFrom(address(this), msg.sender, _tokenId);
        } else {
            (bool sent, ) = allTokenSale[_contractNFT][_tokenId].owner.call{value: allTokenSale[_contractNFT][_tokenId].price}("");
