...
/**
   ...
   Modified SafeMoon contract code.
   Recompiled using 0.8.9+commit.e5eed63a compiler.
   Original source code : https://github.com/safemoonprotocol/Safemoon.sol
...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    string private _name = "Koin Bejat";
    string private _symbol = "KNBJT";
    ...
    constructor() {
        ...
        pancakeswapV2Pair = IPancakeswapV2Factory(_pancakeswapV2Router.factory())
            .createPair(address(this), _pancakeswapV2Router.WBNB());
    ...
    function setRouterAddress(address newRouter) external onlyOwner {
        ...
        pancakeswapV2Pair = IPancakeswapV2Factory(_newPancakeRouter.factory()).createPair(address(this), _newPancakeRouter.WBNB());
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        pancakeswapV2Router.addLiquidityBNB{value: ethAmount}(
            address(this),
            tokenAmount,
