...
contract TEST_Token is Context, IERC20, Ownable {
    ...
    address public charityAddress = 0x484dcdeBC1188C9b8977c56D28BD698386985974;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(tradingEnabled || sender == owner() || recipient == owner() || isExcludedFromFee[sender] || isExcludedFromFee[recipient], "Trading is locked before presale.");
    ...
    function QueryExcluded(address _user) public view returns (bool) {
        return _isExcluded[_user];
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _tokenBalance[account] = accountBalance.sub(amount, "ERC20: burn amount exceeds balance");
