...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        emit SwapCheck (overMinTokenBalance, inSwapAndLiquify, swapAndLiquifyEnabled, from != uniswapV2Pair,  from, uniswapV2Pair);
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
            ...
            //add liquidity
            emit SwapStart(contractTokenBalance);
