...
contract ZombieERC20 is Ownable, ERC20 {
    ...
    uint256 public fightZombies = _maxSupply.mul(11).div(10**2);
    uint256 public warZones = _maxSupply.mul(11).div(10**2);
    uint256 public training = _maxSupply.mul(11).div(10**2);

    uint256 public amountPlayToEarn = fightZombies + warZones + training;
    uint256 public playToEarnReward;
    
    uint256 internal amountFarm = _maxSupply.mul(12).div(10**2);
...
contract ZombToken is ZombieERC20, ReentrancyGuard {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 maxSupply_)
        ZombieERC20(name, symbol, decimals, maxSupply)
    {
