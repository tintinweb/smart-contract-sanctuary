...
contract StarGod is STGDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private STGTeam;
    address private CharitySTG;
    ...
    string public override name = "StarGod";
    string public override symbol = "STG";
    ...
    constructor(uint totalSupplyValue, address STGTeamAddress, address CharitySTGAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        STGTeam = STGTeamAddress;
        CharitySTG = CharitySTGAddress;
        
        // split the tokens according to agreed upon percentages
        balances[STGTeam] =  totalSupply * 10 / 100;
        balances[CharitySTG] = totalSupply * 10 / 100;
    ...
    // Get the address of the token's STGTeam pot
