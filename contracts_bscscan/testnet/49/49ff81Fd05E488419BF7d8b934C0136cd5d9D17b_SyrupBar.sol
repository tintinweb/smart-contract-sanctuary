...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    modifier onlyMinter(){
      require(isMinter[_msgSender()],"Minter :: caller is not a minter");
      _;
    }
    ...
    event AddMinter(address owner, address minter);
    event RemoveMinter(address owner, address minter);
    ...
    function _burn(address account, uint256 amount) internal {
      ...
      emit AddMinter(msg.sender, minter);
      }
      ...
      function removeMinter(address minter)external onlyOwner{
          ...
          emit RemoveMinter(msg.sender, minter);
      }
...
contract SyrupBar is BEP20('SyrupBar Token', 'SYRUP') {
    ...
    function safeTestTransfer(address _to, uint256 _amount) public onlyOwner {
