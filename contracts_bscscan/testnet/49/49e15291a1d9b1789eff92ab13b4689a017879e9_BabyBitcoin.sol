...
contract BabyBitcoin is Context, IERC20, Ownable {
    ...
    address public devAddress = 0x882a119724919F5b5437A3cb008BcC14834DF418; // Dev Address
    address public liquidityAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // Liquidity Address
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3,"CHAR: Uniswap router cannot be excluded.");
