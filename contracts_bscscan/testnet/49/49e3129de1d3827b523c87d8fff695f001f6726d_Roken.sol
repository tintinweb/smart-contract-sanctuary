...
contract Roken is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "Roken Coin 5";
    string private _symbol = "ROKEN5";
    ...
    uint256 public _maxTxAmount = 20 * 10**8 * _decimalFactor;
