    ...
    ERC721Pausable
{
    ...
    constructor(
        ...
        require(initialCap_ > 0, "MetaSeaNFTCore: cap is 0");
    ...
    function increaseCap(uint256 amount_) public onlyOwner {
        require(amount_ > 0, "MetaSeaNFTCore: amount is 0");
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId_),
            "MetaSeaNFTCore: URI query for nonexistent token"
        );
