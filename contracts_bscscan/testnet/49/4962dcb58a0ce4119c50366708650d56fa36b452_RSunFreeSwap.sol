...
contract RSunFreeSwap is RSunAuth, IERC721Receiver {
    ...
    uint public bnbSwappablePerNFT = 10 * 10 ** 18;
    ...
    function setCouponsClaimableToZero(address user) external authorizedFor(Permission.AdjustCouponsClaimable) {
        couponsClaimable[user] = 0;
    }
