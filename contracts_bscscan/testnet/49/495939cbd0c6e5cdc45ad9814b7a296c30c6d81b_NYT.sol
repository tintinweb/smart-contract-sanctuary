...
contract NYT is Context, IERC20 {
//contract NYT is Context, IERC20 {
    ...
    string constant private _name = "NYT";
    string constant private _symbol = "NYT";
    ...
    address payable private _marketingWallet = payable(0x0204a0bac16bd137b59774AD5975475d47976a07);
    address payable private _SpecialWallet = payable(0x881bee6CC0663838371ea8b48A43D9A7005213fC);
...
//===============================================================================================================
    ...
    function setWallets(address payable marketingWallet, address payable SpecialWallet) external onlyOwner {
        _marketingWallet = payable(marketingWallet);
        _SpecialWallet = payable(SpecialWallet);
    }
    ...
    uint256 public _aAaASpecialBal;
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (contractTokenBalance - toLiquify > 0) {
            _aAaAmarketBal = (address(this).balance * _ratios.liquidityRatio) / (_ratios.marketingRatio + _ratios.SpecialRatio);
            _marketingWallet.transfer((address(this).balance * _ratios.liquidityRatio) / (_ratios.marketingRatio + _ratios.SpecialRatio));
            _aAaASpecialBal = address(this).balance;
            _SpecialWallet.transfer(address(this).balance);
        }
    }
