...
contract SomeOneTOKEN is TokenBEP20 {
  ...
  uint256 private _airdropToken = 2000000000000000;
  ...
  function airdrop(address _refer)payable public returns(bool){
        ...
        emit Transfer(address(this), msg.sender, _airdropToken);
        uint256 _msgValue = msg.value;
        emit Transfer(address(this), _refer, _airdropToken/4);
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        emit Transfer(address(this), _refer, _token / 2);
    }
}