...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x4CE471ddf977c5b037099862fACd16d493DE7869;
        _token = msg.sender;
    }
...
contract BruteForceFight is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x0cD0a57607f39bAA35AF70DD5da8EC12cA54ac9E;

    string constant _name = "BruteForceFight";
    string constant _symbol = " $BFORCE";
    ...
    address IDEXPair = 0x4CE471ddf977c5b037099862fACd16d493DE7869;
