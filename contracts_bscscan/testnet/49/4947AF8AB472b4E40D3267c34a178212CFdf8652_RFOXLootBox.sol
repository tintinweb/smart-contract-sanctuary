...
import "./interfaces/IRFOXCollectible.sol";

contract RFOXLootBox is VRFConsumerBase, Ownable {
    using SafeMath for uint256;

    // Configuration for Chainlink Randomness
    bytes32 internal keyHash;
    uint256 internal chainlinkFee;
    IRFOXCollectible RFOXCollectible;
    ...
    modifier packEnabled(Pack _pack) {
        ...
        require(
            ...
            "RFOXLootbox: Pack not exist or disabled"
        );
        _;
    }
    ...
    modifier classExists(Class _class) {
        require(
            ...
            "RFOXLootbox: Class out of bounds"
        );
        _;
    }
     ...
     * fee = 0.1 * 10 ** 18;
     */
    constructor(address _RFOXCollectible)
        VRFConsumerBase(
            0xa555fC018435bef5A13C6c6870a9d4C11DEC329C,
            0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06
        )
    {
        RFOXCollectible = IRFOXCollectible(_RFOXCollectible);
    ...
    function openPack(Pack _pack) external payable packEnabled(_pack) {
        PackSettings memory pack = packToSettings[uint256(_pack)];
        require(msg.value >= pack.price, "RFOXLootbox: Underprice");
    ...
    /// @param _price Price of this Pack
    ...
    function openRandomCards(
        ...
        for (uint256 i = 0; i < guarantees.length; i++) {
            if (guarantees[i] > 0) {
                ...
                RFOXCollectible.mintOneBatch(_owner, cardIds, "");
            }
        }
        ...
        if (remainCards > 0) {
            ...
            RFOXCollectible.mintOneBatch(_owner, remainCardIds, "");
        }
    }
