...
// File: contracts/pokedx-imports.sol
...
// File: contracts/pokedx-token.sol
 ...
 * PokeDX v0.01
 *
 * This is a rewrite of Safeoon & Safetoken in the hope to:
 *
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "PokeDX.v0.1";
    string internal constant SYMBOL = "PDX.v0.1";
...
// mapping(FeeType => string) public _showFee;
// mapping(FeeType => string) public Liquidity;
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    // PancakeSwap Testnet = https://pancake.kiemtienonline360.com/ RINKEBY
...
contract PokeDXV7alpha is PokeDX {
