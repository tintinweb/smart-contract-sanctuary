...
// File: DEX/transfer_token_test.sol
...
contract Atransfertoken{
    ...
    constructor() public{
        token_address = 0x4Acd39Dcdc5F1b741faE7E163eCcF6F2aE2f0451;
    }

    IBEP20 tokenx = IBEP20(token_address);

    function appr(uint256 amount) public returns(bool){
        bool apprx = tokenx.approve(msg.sender, amount);
        return apprx;
        
    }

    function transferx(uint256 amount) public returns(bool){
    ...
    function withdrawErc20(IBEP20 token) public {
