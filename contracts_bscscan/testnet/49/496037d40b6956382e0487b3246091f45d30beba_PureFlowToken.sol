...
contract PureFlowToken is Context, IERC20, Ownable 
{
    ...
    string private _name = "Pure Flow Token";
    ...
    address public developmentWallet =  0x652B68Ca14B5dd59d9A685E56253404A01EbAAc0;
    ...
    uint256 public _maxTxAmount = 100_000_000_0 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100_000_00 * 10**9;
    uint256 public  maxLimit = 200_000_000_0 * 10**9;
    ...
    constructor () 
    {
        ...
        _isExcludedFromWhale[developmentWallet]=true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
       ...
       {
            uint256 allFees = _taxFee.add(_liquidityFee).add(_burnFee).add(_developmentFee);
        ...
        uint256 amtWalletS = amount.mul(_developmentFee).div(100);
        ...
        if(amtWalletS>0)
        {
           _transferStandard(sender, developmentWallet, amtWalletS);    
        }  
        restoreAllFee();
    }
