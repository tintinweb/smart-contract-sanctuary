...
interface IERC20 {
    ...
    function balanceOf(address accAount) external view returns (uint256);
...
contract test12321 is Context, IERC20, Ownable {
    ...
    string private _name = "test12321";
    string private _symbol = "JOJOJORABBIT";
