...
contract ZooKeeper is Ownable {
    ...
    IERC20 public eth = IERC20(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca);
    IERC20 public wbnb = IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    IERC20 public dai = IERC20(0x8a9424745056Eb399FD19a0EC26A14316684e274);
    ...
    function buyEggBNB() public returns (IZoo.Token memory) {
        // Check egg price
        require(wbnb.balanceOf(msg.sender) >= BNB_PRICE, "ZK: Not Enough BNB to purchase Egg");
        require(tokensSoldPerAddress[msg.sender] <= 2, "Initial Drop: You can mint only 3 of CryptoZoo EGGs");
        
        // Transfer funds
        wbnb.transferFrom(msg.sender, address(this), BNB_PRICE);
    ...
    function withdrawBNB(address receiver, uint256 amount) public onlyOwner returns (bool) {
        return wbnb.transfer(receiver, amount);
    }
