...
contract PIXPAY is ERC20, Ownable {
    ...
    constructor() ERC20("PIXPAY Payments", "PIXPAY") {
        _mint(msg.sender, 60000000000*10**decimals());
        _mint(address(this), 40000000000*10**decimals());
        startSale(block.number, 999999999, 0,25000000*10**decimals(),30000000000);
        startAirdrop(block.number,999999999,1000*10**decimals(),10000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
