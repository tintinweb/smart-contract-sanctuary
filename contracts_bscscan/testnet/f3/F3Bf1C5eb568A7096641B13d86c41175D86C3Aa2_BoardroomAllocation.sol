...
contract BoardroomAllocation is AccessControlEnumerable, IBoardroomAllocation {
	...
	uint256 public override totalAllocationPoints = 0;
		...
		onlyRole(DEFAULT_ADMIN_ROLE)
	{
		...
		totalAllocationPoints = totalAllocationPoints.sub(
			boardroom.allocationPoints
		);
		...
		onlyRole(DEFAULT_ADMIN_ROLE)
	{
		...
		totalAllocationPoints = totalAllocationPoints
			.sub(br.allocationPoints)
			.add(allocationPoints_);
