...
// File: contracts/MockCake.sol

pragma solidity ^0.6.0;

contract MockCake is BEP20 {
    constructor(
        string memory name,
    ...
    // Mint Mock CAKE tokens to anyone requesting with a max of 100 CAKE
    function mintCAKE(uint256 _amount) external {
        require(_amount < 100000000000000000001, "100 CAKE max"); // 100 Mock CAKE
