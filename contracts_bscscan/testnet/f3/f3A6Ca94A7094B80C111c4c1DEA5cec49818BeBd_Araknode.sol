...
contract Araknode is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("Araknode", "ARAK") PaymentSplitter(payees, shares) {
...
//
        ...
        //}
        //require(totalSupply() == 20456743e18, "CONSTR: totalSupply must equal 20 million"); // fix
