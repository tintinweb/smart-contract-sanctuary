...
/**
    OMEGACAKE ~ FAIR LAUNCH
    https://t.me/OmegaCake
    ...
    💵 2% Max Buy Tx ( 2,000,000,000 $OCAKE )
    💵 2% Max Sell Tx ( 2,000,000,000 $OCAKE )
    💰 4% Max Bag ( 4,000,000,000 $OCAKE )
    🔃 5 Seconds TX Cooldown ( Buy & Sell ) , the cooldown timer is independent between wallet and between buy & sell
...
contract OMEGACAKE is IERC20, Ownable {
    ...
    // LIMITTER
    uint256 public _maxBuyTxAmount = (_totalSupply * 20) / 1000; // 1.4% MAX 1,400,000,000
    uint256 public _maxSellTxAmount = (_totalSupply * 20) / 1000; // 0.7% MAX 700,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x33A8E801c767729dfdd1e8cf36019913ED1dE944);
