    ...
    DividendPayingTokenOptionalInterface
{
    ...
    address public immutable SHIB =
        address(0xb9515fd0eD72eE1674992C101f56C9116Cb2D41C);
...
contract ShibArmy is ERC20, Ownable {
    ...
    constructor() ERC20("ShibArmy", "ShibArmy") {
        ...
        maxBuyTransactionAmount = 1000 * (10**18);
        maxSellTransactionAmount = 100 * (10**18);
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            if (automatedMarketMakerPairs[from]) {
                require(
                    ...
                    "ERC20: Buy transfer amount exceeds the maxBuyTransactionAmount"
                );
            }
            if (automatedMarketMakerPairs[to]) {
                require(
                    amount <= maxSellTransactionAmount,
                    "ERC20: Buy transfer amount exceeds the maxSellTransactionAmount"
                );
            }
        }
