...
contract PuzlUnpack is ERC1155 {
    ...
    /// do its part
    function open(uint256 tokenId) public payable {
    ...
    function open(address who, uint256 tokenId) private {
        ...
        ids[0] = (100000 + tokenId);
        ids[1] = (200000 + tokenId);
        ids[2] = (300000 + tokenId);
        ids[3] = (400000 + tokenId);
        ids[4] = (500000 + tokenId);
        ids[5] = (600000 + tokenId);
        ids[6] = (700000 + tokenId);
        ids[7] = (800000 + tokenId);
        ids[8] = (900000 + tokenId);
        for (uint256 i = 0; i < ids.length; i++) {
            amounts[i] = 1;
        }
       _safeBatchTransferFrom(address(this), who, ids, amounts, "");
       // _mintAPart(who, (200000 + tokenId));
       // _mintAPart(who, (300000 + tokenId);
       // _mintAPart(who, (400000 + tokenId);
       // _mintAPart(who, (500000 + tokenId);
       // _mintAPart(who, (600000 + tokenId);
       // _mintAPart(who, (700000 + tokenId);
       // _mintAPart(who, (800000 + tokenId);
