...
contract TERC20Dividend is ERC20Capped, ERC20Snapshot, ERC20Burnable, AccessControl, ReferralManager {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function claimDividend(uint256 _snapshotId) external {
        ...
        uint256 _totalFeeAmount = transferReferralFee(dividend, dividendAmount);
        dividend.safeTransfer(msg.sender, dividendAmount.sub(_totalFeeAmount));

        emit ClaimDividend(msg.sender, _snapshotId, dividendAmount);
    }
...
import "../TERC20Dividend.sol";


contract DIVToken is TERC20Dividend {
    constructor(address _dividend, address admin)
        public
        TERC20Dividend("DIVINE Token", "DIV", _dividend, 1e24, admin)
    {}
}
