...
//testTokenBEP is a token on Binance Smart Chain.tested
//Total tax 5% [[ 2%  LP : 2% Dev/Marketing/Charity : 1% burn ]]

//0x9eB309a797f3902e6cbe897C3262426f63B241d1  - DEV
//0xfE967F84165B03974c4fE9dD660b95f7dB1A5698 - FEE
...
contract testTokenBEP is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, 
        uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,
        uint256 _charityFee,address _FeeAddress,address tokenOwner) {
	...
	function updateFee(uint256 _txFee,uint256 _burnFee,uint256 _charityFee) onlyOwner() public {
		require(_txFee < 200 && _burnFee < 100 && _charityFee < 200);
        _TAX_FEE = _txFee * 100;
        _BURN_FEE = _burnFee * 100;
		_CHARITY_FEE = _charityFee * 100;
		ORIG_TAX_FEE = _TAX_FEE;
