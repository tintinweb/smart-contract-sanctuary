...
// File contracts/PhoenixChainV2.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;
contract PhoenixChainV2 is ERC20, Ownable {
    ...
    address private marketingWallet = 0x2959c81aa03C1a9cFFB3038584264763b153021B;
    address private RewardsWallet = 0x780feBd79B1ddbB6Dbf1b32249699aD100BD1141;
    ...
    constructor() ERC20("PhoenixChain V2", "PCNV2") {
    ...
    function setBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _RewardsFee) external onlyOwner {
    ...
    function setSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _RewardsFee) external onlyOwner {
