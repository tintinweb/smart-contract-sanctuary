...
contract Bridge is Pausable, AccessControl, SafeMath {
    ...
    function claim(bytes32 resourceID) external whenNotPaused {
        ...
        emit Claim(msg.sender, resourceID);
    }
    ...
    */
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        ...
        if (_tokenContractAddressToFee[tokenAddress] > 0) {
            ...
            emit NewClaimOrder(recipientAddress, _claimOrderCount[recipientAddress]);
        }
        else {
    ...
    function _executeProposal(
        ...
        if (_burnList[tokenAddress]) {
            mintERC721(tokenAddress, recipientAddress, tokenID, metaData);
        }
        else {
