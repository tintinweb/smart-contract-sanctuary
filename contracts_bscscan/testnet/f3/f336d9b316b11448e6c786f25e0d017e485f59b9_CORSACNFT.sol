...
contract CORSACNFT is BEP721,Ownable {
    ...
    function mint(string memory tokenUri,
        ...
        address _signer = 0xB273216C05A8c0D4F0a4Dd0d7Bae1D2EfFE636dd;
        address _to = 0x14723A09ACff6D2A60DcdF7aA4AFf308FDDC160C;
        string memory _message = "coffee and donuts";
        uint _nonce = 1;
        uint _verifyamount = 123;
        bool vf = verify( _signer, _to, _verifyamount, _message, _nonce, signature);
