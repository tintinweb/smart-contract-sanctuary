...
contract CuisineCoin is Context, IERC20, Ownable {
	...
	string private _name = "Cuisine Coin";
	string private _symbol = "CUISINE(B)";
    ...
    address private _charityWalletAddress = 0xA9E548d5533B8a259910C7A118AF8D14Dac923da;		
	...
	function _txToCharityWallet(address sender, uint256 totalFee) internal {
        uint256 charityAmount = totalFee.div(10); 
	...
	function _reflectFee(uint256 rFee, uint256 rBurn, uint256 tFee,uint256 tBurn) private {
		uint256 actualRFee = rFee.div(2); 

		_rTotal = _rTotal.sub(actualRFee).sub(rBurn);
	...
	function _transferStandard(
        ...
        _txToCharityWallet(sender, rFee.mul(5));
