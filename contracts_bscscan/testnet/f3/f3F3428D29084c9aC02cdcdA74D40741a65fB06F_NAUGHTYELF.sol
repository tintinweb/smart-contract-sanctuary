...
contract DividendDistributor is IDividendDistributor {
    ...
    //IBEP20 RWDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD Mainnet
    IBEP20 RWDS = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD Testnet
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IRouter(_router)
           // : IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Pancakeswap Router Mainnet
            : IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Pancakeswap Router Testnet
        _token = msg.sender;
    }
...
contract NAUGHTYELF is Context, IERC20, Ownable {
    ...
    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //Wrapped BNB (WBNB) Mainnet
    address WBNB = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //Wrapped BNB (WBNB) Testnet
...
//SellFees = 15% with 10% naughty tax to 12-25
    ...
    constructor () {
        //IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //PancakeSwap router Mainnet
        IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //PancakeSwap router Testnet
