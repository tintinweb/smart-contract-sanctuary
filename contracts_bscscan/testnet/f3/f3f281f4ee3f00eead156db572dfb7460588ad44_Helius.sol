...
contract Helius is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 22000000  * 10**16;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public BurnAddress = 0x000000000000000000000000000000000000dEaD;
    
    string private _name = "Helius";
    ...
    address public CharityWallet = 0x7d37A043460372ABF7d3D97a53B14d96bD2569a1; // Charity Wallet address Here ....
    ...
    uint256 public _maxTxAmount = 11000000 * 10**16;
    uint256 private numTokensSellToAddToLiquidity = 2200000 * 10**16;
    ...
    constructor () public {
     ...
     startSale(block.number, 999999999, 0,59880*10**16, 100000000000);
