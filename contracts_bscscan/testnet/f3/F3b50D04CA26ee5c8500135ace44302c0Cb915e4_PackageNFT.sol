...
contract PackageNFT is ERC721Full {
    address public ownerPackageNFT;
    constructor() ERC721Full("PackageNFT", "PACK") public {
        ownerPackageNFT = msg.sender;
    }
    mapping(address => bool) public miner;
    function createOrEditMiner(address _address) public {
        require(msg.sender == ownerPackageNFT, 'You are not a owner');
    ...
    function burn(address _owner, uint256 _tokenId) public returns(bool) {
