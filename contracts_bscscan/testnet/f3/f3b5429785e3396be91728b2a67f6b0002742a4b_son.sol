...
contract son{
    ...
    function get_amount_bnb_to_token_a_in_pancake(uint amount_bnb_In, address token1) external view returns(uint[] memory list){
        ...
        path[0] = bnb;
        path[1] = token_a;
        list = v2.getAmountsOut(amount_bnb_In,path);
        return list;
