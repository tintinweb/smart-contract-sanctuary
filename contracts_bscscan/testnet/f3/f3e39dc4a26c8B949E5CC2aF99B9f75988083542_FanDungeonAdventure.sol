    ...
    AdventureInfo
{
    ...
    uint256 public _crystalPoolSize = 10000;
    ...
    function dungeonLevelFor(uint256 _dungeonId,uint256[] calldata _heroIds) external view returns(uint256 level) {
       uint32 power = calculateAllHeroPower(_heroIds);
       uint levelDungeonCap = fanDungeonStage.levelCapOf(_dungeonId);
       for (uint32 i=1;i<levelDungeonCap;i++) {
        ...
        )
    {
        ...
        uint256 _remainingCrystal = _crystalPoolSize - dungeon.reservedCrystal;
