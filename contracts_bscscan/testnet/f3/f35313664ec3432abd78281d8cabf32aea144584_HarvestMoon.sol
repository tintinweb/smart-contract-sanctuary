...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //change router
    IBEP20 RewardToken = IBEP20(0xAC51066d7bEC65Dc4589368da368b212745d63E8); //RewardToken
...
contract HarvestMoon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Harvest Moon";
    ...
    address RewardToken = 0xAC51066d7bEC65Dc4589368da368b212745d63E8;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 5 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xd6509B16911b2fF480b78e7b4377b4adDb50877D; //liquidityFee
        marketingWallet = 0xd6509B16911b2fF480b78e7b4377b4adDb50877D; //marketing wallet
        devWallet = 0xbb2019F8d1e4538e31DbE49461EDEb073913BC94; //dev fee
