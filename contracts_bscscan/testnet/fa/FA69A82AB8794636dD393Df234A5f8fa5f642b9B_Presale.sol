...
contract Presale is Ownable, ReentrancyGuard {
    uint256 private constant INVEST_UNIT = 0.001 ether; //For test purpose
    ...
    uint256 private totalDepositedBNBBalance;
    ...
    modifier oneBNB {
        ...
        console.log("UNIT = ", INVEST_UNIT);
        require(msg.value == INVEST_UNIT, "Incorrect value");
        _;
    }

    receive() external payable {}

    function deposit() external payable oneBNB nonReentrant {
        if (deposits[msg.sender] == 0) {
            console.log("Adding to DepositorList");
            depositAddressList.push(msg.sender);
        }
        deposits[msg.sender] += INVEST_UNIT;
        totalDepositedBNBBalance += 1;
    }
    ...
    function withdrawFunds() external onlyOwner nonReentrant {
        ...
        require(sent, "Failed to release");
    }
