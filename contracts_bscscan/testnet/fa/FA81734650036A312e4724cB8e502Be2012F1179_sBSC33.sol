...
contract sBSC33 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sBSC33", "sBSC33", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBSC33 supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBSC33
