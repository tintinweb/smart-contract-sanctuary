...
abstract contract BaseLiquidity is BaseToken, Manageable {
    ...
    address private _kiemtienonlineAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
...
//   ======================================  
    constructor () {
       ...
       address _swapRouterAddress = _kiemtienonlineAddress;

       if (_swapNet == 99) { _swapRouterAddress = _mainnetRouterAddress;}
       else 
       if (_swapNet == 88) { _swapRouterAddress = _testnetRouterAddress;}
...
contract SymplexiaToken is  AntiWhale,  BaseLiquidity,  BaseRFI {
  ...
  //
    ...
    constructor () BaseToken ( "DEBUG19", "DBG19", 5, 5, 5, 
