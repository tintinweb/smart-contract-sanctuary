...
contract ArcaneLeagueNFT is ERC721("ARCANELEAGUENFT", "ARCANELEAGUENFT"), ERC721Enumerable, Ownable {
    ...
    */
    ...
    uint256 public maxNFT = 40;

    uint256 public _mintingPrice;
    
    IERC20 _mintingCurrency;
    ...
    */
     ...
     */
    function setMintingCurrency(IERC20 newMintingCurrency) onlyOwner external {
        _mintingCurrency = newMintingCurrency;
    }
    
    /*
     * Function to mint new NFTs during the public sale
     * It is payable. Amount is calculated as per (NFTPrice.mul(1))
     * payable
    */
    function mintNFT() 
        public 
    {
        ...
        require(totalSupply().add(1) <= maxNFT, "Purchase would exceed max public supply of NFTs");
