...
/**
    Welcome to ShibaZillaInu.
    The world of Zilla awaits.
    We are so glad you are here!
    You are now part of a growing community,
    lets collaborating and connecting to make this community bigger.
...
contract ShibaZillaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaZillaInu";
    string constant _symbol = "ShibaZillaInu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 5; // 5%
