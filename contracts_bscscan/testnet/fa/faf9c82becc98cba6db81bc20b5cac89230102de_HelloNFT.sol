...
contract HelloNFT is ERC20, ERC20Burnable, Ownable, HelloNFTInterface {
    ...
    modifier onlyBanker () {
        require(manager.onlyBanker(_msgSender()), "Caller is not evolver");
        _;
    }
    
    constructor() ERC20("HelloNFT", "HNF") {
     ...
     */
    function rewards(address recipient, uint256 amount) override external onlyBanker {
