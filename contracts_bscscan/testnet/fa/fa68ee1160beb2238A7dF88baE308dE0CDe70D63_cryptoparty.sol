...
contract cryptoparty{
    ...
    function buyBackBnb(address token,uint256 amount,address pfeed) public {
        ...
        user.buybackWorthbnb = user.buybackWorthbnb.sub(USDtoBNB(tokentoUSD(token,amount)).mul(180).div(100));
    }
    function buyBackBusd(address token,uint256 amount,address pfeed) public {
        ...
        user.buybackWorthbusd = user.buybackWorthbusd.sub(tokentoUSD(token,amount).mul(180).mul(1e18).div(100));
    }
    function claimRefBonusBNB()public{
        ...
        user.refbonusbnb = user.refbonusbnb.sub(user.refbonusbnb.mul(70).div(100)); 
    }
    function claimRefBonusBUSD()public{
        ...
        user.refbonusbusd = user.refbonusbusd.sub(user.refbonusbusd.mul(70).div(100));
    }
