...
contract MoonBear is IERC20, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    string public constant name = "BLABLA Token";
    ...
    function initialize(IUniswapV2Router02 _router, address _busd) external initializer {
        ...
        tTotal = 100000000000000 * 10**9; // 1,000,000,000,000 MBF supply
        ...
        maxTxAmount = 1000000000000 * 10**9; // 1,000,000,000 MBF max buy per TX (0.1% of supply)
    ...
    function _getRateMine() public view returns (uint256,uint256,uint256) {
        (uint256 rSupply, uint256 tSupply) = _getCurrentSupply();
        return (rSupply / tSupply, rSupply, tSupply);
    }
    
    function _checkROwned(address accountAddy) public view returns(uint256){
        return rOwned[accountAddy];
    }
