    ...
    OwnableUpgradeable
{
    ...
    event XXX(uint256 hastaloshuevos);
    ...
    function buyItem(bytes32 _id) external payable whenNotPaused {
        ...
        console.log("_sellerAddress: ", _sellerAddress);
        console.log("_askingPriceInDollars: ", _askingPriceInDollars);

        uint256 _sellPriceInCWOLF = Variables(variablesContractAddress)
            .getDollarsInCWOLF(_askingPriceInDollars);

        console.log("_sellPriceInCWOLF: ", _sellPriceInCWOLF);
