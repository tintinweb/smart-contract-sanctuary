...
contract IDR2 is Context, IBEP20, Ownable {
    ...
    string private _name = "INDONESIA2";
    string private _symbol = "IDR2";
    ...
    uint256 public _maxTxAmount = 1000 * 10**4; // Max buy per 1x txn 0,1%
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**4; // Max sell per 1x txn 0,1% to LP
    uint256 private buyBackUpperLimit = 5000 * 10**4;
    ...
    constructor (address payable marketingWallet, address payable charityWallet, address payable researchWallet, address deadAddress, address pancakeSwapRouter) {
        ...
        _isExcludeAddressFromMaxTx[_charityWallet] = true;
    ...
    function manualSend() public onlyOwner() {
        ...
        sendBNBToMarketing(contractETHBalance);
    }
    ...
    function setBuyBackUpperLimit(uint256 amount) external onlyOwner() {
