...
contract BSCBAY is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    BSCBAYDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x22E42585334F5C0D59B1d1ED5Ab3524f765d1375;
    ...
    constructor() public ERC20("BSCBAY TOKEN", "BSCBAY") {

    	dividendTracker = new BSCBAYDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BSCBAYDividendTracker newDividendTracker = BSCBAYDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the BSCBAY token contract");
    ...
    function swapOnDemand(bool sendToFee, bool liquify, bool sendDividends, bool buybacktax) external onlyOwner {
        swapping = true;
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if (buyBackEnabled && accumulatedBuyback > buybackamount && amount > buyBackthresholdLimit ) {
...
contract BSCBAYDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BSCBAY_Dividend_Tracker", "BSCBAY_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2 * (10**18); //must hold 200000+ tokens
    }
