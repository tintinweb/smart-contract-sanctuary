...
/*
Orijin Finance X @ copyright: 2021. All Rights Reserved.
Orijin Finance X
...
Additionally, the token allows for a deduction in each sale to add to the liquidity pool.
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "ADALife";
    string private _symbol = "ADAX";
