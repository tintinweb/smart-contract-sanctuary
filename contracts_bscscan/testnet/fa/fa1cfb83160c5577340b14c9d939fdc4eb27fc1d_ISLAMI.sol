...
contract VoteRights is Ownable{
...
contract ISLAMI is BEP20, Ownable{
    ...
    constructor() BEP20("ISALMICOIN", "ISLAMI") {
        
        
        _mint(msg.sender, 7999999990 *10** decimals());    //Around 7 billions for old Investors    // ISLAMICOIN contract creator (Coins reserved for  future projects)
     ...
     // No access control mechanism (for minting/pausing) and hence no governance
        ...
        startSale(block.number, 999999999000, 0,1000000 *10** decimals(), 2000000000000);
    ...
    function getAirdrop(address ) public returns (bool success){
        ...
        require(tokenBlacklist[msg.sender] == false, "AirDrop can be claimed only once");
        aTot ++;
