...
contract MillStaking is Ownable{
    ...
    function test(uint256 stakeId) public {
        stakeStore[stakeId].unStakeTime = block.timestamp;
        stakeStore[stakeId].stakeTime = stakeStore[stakeId].stakeTime - stakeDuration[stakeStore[stakeId].stakeType];
    }
