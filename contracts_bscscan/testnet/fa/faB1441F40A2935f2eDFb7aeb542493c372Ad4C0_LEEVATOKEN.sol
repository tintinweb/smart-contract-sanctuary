...
*/
// token Contract: 0xA2062122996cB440035E71fD5a92aC2505d6B96a
...
contract LEEVATOKEN{
   ...
   //For Token Transfer
    ...
    constructor(address ownerAddress,IBEP20 _leevaToken) public 
    {
        owner = ownerAddress;
    ...
    function buyToken(uint tokenQty,address referrer) public payable
	{
	    ...
	    // require(tokenQty>=MINIMUM_BUY,"Invalid minimum quantity");
	     ...
	     leevaToken.transfer(msg.sender , tokenAmount);
