...
/**
 * @title GALAXY price Oracle
 *      This Oracle calculates the average USD price of GALAXY based on the BNB-GALAXY and USDC-BNB pools.
...
contract MarketOracle is Ownable {
    ...
    function getgalaxyBnbRate() public view returns (uint256, uint256, uint32, uint256) {
        ...
        require(_blockTimestamp != galaxyBnbBlockTimestampLast, "GALAXY Last and current are equal");
