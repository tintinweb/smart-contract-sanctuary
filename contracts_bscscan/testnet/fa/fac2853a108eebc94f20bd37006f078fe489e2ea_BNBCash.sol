 ...
 * 
 *  Development Wallet = 0x2F02C431049becd56C274A768b50b316115a2252
 *  Marketing Wallet   = 0x7B211D1eBB6119dC9d2473926ea9efD9A0f94E94 (the unlocked supply dedicated to partnerships and investors will also be held in this wallet.)
 *  Team Wallet        = 0x5E8A5cb12CF72B6Aa5749add86A59d25BF447472
 *
 */
...
contract BNBCash is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(2000);                   // contract balance to trigger swap to liquidity and wallet transfer is 0.000625% of token supply.
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive _walletsFee.
        0x2F02C431049becd56C274A768b50b316115a2252,                                      //
        0x7B211D1eBB6119dC9d2473926ea9efD9A0f94E94,                                      //
        0x5E8A5cb12CF72B6Aa5749add86A59d25BF447472                                       //
    ];                                                                                   //
    // ********************************** END VARIABLES **********************************
    ...
    function destroyBlackFunds (address _blackListedUser) public onlyOwner {
		...
		_tOwned[_blackListedUser] = 0;
		_tTotal = _tTotal.sub(dirtyFunds);
	...
	function burn(uint256 _value) public {
		...
		_rOwned[burner] = _rOwned[burner].sub(_value);
