...
contract LadyLassie is Context, IERC20, Ownable {
    ...
    Taxes public botTaxes = Taxes(18, 35, 18, 9, 9);
    ...
    function setBotTaxes(
        ...
        botTaxes = Taxes(_rfi, _marketing, _liquidity, _dev, _buyback);
        emit FeesChanged();
    }
    ...
    function _transfer(
        ...
        if (
            ...
            else swapAndLiquify(swapTokensAtAmount, botTaxes); //90% for bots
        }
        bool takeFee = true;
        bool isSell = false;
