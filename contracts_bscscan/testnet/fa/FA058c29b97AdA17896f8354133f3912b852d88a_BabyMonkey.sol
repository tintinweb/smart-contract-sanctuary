...
/**
 * 
   - 3% of every transaction is redistributed to all holders
   ...
   - 3% of every transaction is converted to BNB to buyback!
...
contract BabyMonkey is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x7e6EF1E1a8a1451152e99dd1acED64cEadFd4e9f;
    address private _devWalletAddress = 0x5180905cD309d4d414d1934ebbB059768Bf46F5a;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**18 * 10**10;
