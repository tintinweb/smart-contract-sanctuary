...
contract DummyStaking {
    ...
    modifier nonContract {
        ...
        require (size == 0 && callerAddress == tx.origin, "DummyStaking: only human!");
        _;
    }
    ...
    function depositBNB(uint256 amount) public payable nonContract {
        require(msg.value == amount, "DummyStaking: Incorrect value");
        _principal[msg.sender] = _principal[msg.sender].add(amount);
        emit Deposit(msg.sender, amount);
    }

    function withdrawBNB(uint256 amount) public nonContract {
        require(_principal[msg.sender] >= amount, "DummyStaking: Insufficient amount");
