...
//BabyUSDC
/* 
The ultimate USDC raider token.
*/
/* Tokenomics:
    * 69 BILLION Total Supply
    *  10% USDC reflection
    *  3% marketing fee
    *  4% liquidity fee
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    ...
    uint256 public minDistribution = 1 * (10 ** 18) / (100); // Minimum sending is 0.1 USDC
...
contract BabyTest is IBEP20, Auth {
    ...
    address USDC = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    uint256 public _maxTxAmount = _totalSupply / 200 * 3; // 1.5%
    uint256 public _maxWalletAmount = _totalSupply / 200 * 3; // 1.5%
    ...
    uint256 totalFee = reflectionFee.add(marketingFee).add(liquidityFee);

    address public marketingFeeReceiver;
    address public liquidityFeeReciever;
    ...
    constructor () Auth(msg.sender) {
        ...
        liquidityFeeReciever = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBliqudity = amountBNB.mul(liquidityFee).div(totalFee);
        swapAndLiquify(amountBNBliqudity);
    ...
    function swapAndLiquify(uint256 amount) private {
        ...
        (address(this), otherHalf, 0, 0, liquidityFeeReciever , block.timestamp);
    }
    ...
    function setFeeReceivers(address _marketingFeeReceiver, address _liquidityFeeReciever) external authorized {
        marketingFeeReceiver = _marketingFeeReceiver;
        liquidityFeeReciever = _liquidityFeeReciever;
    }
