...
contract TorchDeFiII is LpVault{
    ...
    function viewSpecialLev(address user) external view onlyOwner returns(uint){
    ...
    function claimDynamic_d() external updateReward(_msgSender()) notBlack{
    ...
    function claimDynamic_g() external updateReward(_msgSender()) notBlack{
        UserInfo storage user = userInfo[_msgSender()];
    ...
    function getLevel(address _user)public view returns(uint l){
        ...
        if(userAccount[_user].refer_n_direct>=5 && userReferLevels[_user][3]>=2 && userInfo[_user].GroupLPinPool >= levelLP_group[4] && userStake[_user].stake_total >= level_indiv[4])
        {L=5;}
        else if(userAccount[_user].refer_n_direct>=5 && userReferLevels[_user][2]>=2 && userInfo[_user].GroupLPinPool >= levelLP_group[3] &&  userStake[_user].stake_total >= level_indiv[3])
        {L=4;}
        else if(userAccount[_user].refer_n_direct>=5 && userReferLevels[_user][1]>=2 && userInfo[_user].GroupLPinPool >= levelLP_group[2] && userStake[_user].stake_total >= level_indiv[2])
        {L=3;}
        else if(userAccount[_user].refer_n_direct>=5 && userReferLevels[_user][0]>=2 && userInfo[_user].GroupLPinPool >= levelLP_group[1] && userStake[_user].stake_total >= level_indiv[1])
        {L=2;}
        else if(userAccount[_user].refer_n_direct>=5 && userInfo[_user].GroupLPinPool >= levelLP_group[0] && userStake[_user].stake_total >= level_indiv[0])
        {L=1;}
        else{L=0;}
