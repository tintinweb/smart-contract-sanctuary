...
contract TESTENOO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_100 * 10**9;
    uint256 public _maxTxAmount = 6_000_000_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6_000_000_000_000 * 10**9; 

    string private constant _name = "TESTENOO"; 
    string private constant _symbol = "NOO"; 
