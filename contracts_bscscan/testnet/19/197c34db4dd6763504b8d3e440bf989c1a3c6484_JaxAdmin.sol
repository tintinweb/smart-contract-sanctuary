...
contract JaxAdmin is IJaxAdmin, Initializable, JaxOwnable {
  ...
  modifier onlyOperator() {
    require(userIsOperator(msg.sender) || userIsGovernor(msg.sender), "Only operator can perform this operation");
    _;
  }
  ...
  function setPancakeRouter(address pancakeRouter) external onlyAdmin {
