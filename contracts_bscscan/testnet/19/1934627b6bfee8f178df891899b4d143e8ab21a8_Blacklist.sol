...
contract ERC20 is Context, IERC20 {
     ...
     */
     ...
     /* Ortaya bir para bırakıp onun oradan istediğin kişiye transfer edilebileceği anlamına geliyor */ 
     ...
     * - `spender` cannot be the zero address.
     */
     /* Kişilerin kendi hesabından gönderi ödeme ücreti */
     ...
     * `subtractedValue`.
     */
     /* Kişilerin kendi hesabından gönderi(EFT) ödeme ücreti */
     ...
     */
     /* Kontroller burada yapılıyor blacklist mi pauseble mı dönen boolean ni dönüyor ona bakmak lazım */
...
contract CorvusToken is Ownable, ERC20Pausable, Blacklist {
    using SafeMath for uint256;
    
    uint256 constant totalFreeSupply = 30011000000000000;
    uint8 	constant numDecimals = 9;
    
    constructor() Ownable() ERC20('Corvus Token2','CRES') public
    {
