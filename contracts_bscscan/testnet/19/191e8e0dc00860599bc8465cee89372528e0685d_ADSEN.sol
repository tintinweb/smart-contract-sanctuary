...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0b9f00Ff9819B7a1b8488c42cAf960c168aC8527;
...
contract ADSEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 150000 * 10**3 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ADSEN";
    ...
    uint256 public _maxTxAmount = 1500000 * 10**3 * 10**9;
