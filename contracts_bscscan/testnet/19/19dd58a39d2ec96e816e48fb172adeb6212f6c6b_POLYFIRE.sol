...
* Taxes structure:
*
* 8% taxes for Liquidity
* 4% reflected to HODLERS
...
contract POLYFIRE is Context, IERC20, Ownable {
    ...
    string private constant _name = "PolyFire";
    string private constant _symbol = "POLYFIRE";
    uint8 private constant _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 1000000 * 10**9 * 10**_decimals;
    ...
    feeRatesStruct public feeRates = feeRatesStruct(
     {rfi: 4,
      liquidity: 8
      }); //32 bytes - perfect, as it should be
    ...
    uint256 public _maxTxAmount = 1000000 * 10**5  * 10**_decimals;  
    uint256 public numTokensSellToAddToLiquidity = 1000000 * 10**6 * 10**_decimals;   //0.1%
