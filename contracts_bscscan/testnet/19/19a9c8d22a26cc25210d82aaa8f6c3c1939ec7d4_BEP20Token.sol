...
contract BEP20Token is  IBEP20Fee{
    ...
    function getAllFees() external view returns (string[] memory) {
        ...
        data[0]=string(abi.encodePacked(feeData.taxTitle,"-",feeData.taxAmount,"-",feeData.taxAddress,"-",feeData.thresholdToActivate,"-",feeData.typeOfAction));
        data[1]=string(abi.encodePacked(feeData1.taxTitle,"-",feeData1.taxAmount,"-",feeData1.taxAddress,"-",feeData1.thresholdToActivate,"-",feeData1.typeOfAction));
       return data;
    } 
