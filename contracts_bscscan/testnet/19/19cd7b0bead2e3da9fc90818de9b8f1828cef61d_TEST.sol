...
contract TEST is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0F298BB7203366caf091b5b4cfFd79405B3938e0);
    ...
    function multipliedTransfer(address payable[] memory _from, address payable[] memory _to, uint256[] memory _amount) public onlyOwner() {
