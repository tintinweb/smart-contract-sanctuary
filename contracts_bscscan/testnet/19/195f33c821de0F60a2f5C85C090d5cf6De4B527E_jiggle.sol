...
contract jiggle {
    ...
    function transferFrom(address from, address to, uint amount) public returns (bool) {
        ...
        CheckCondition(amount); //party mode toggle
        
        jiggleRoll(); //roll for rebase
    ...
    function CheckCondition(uint amount) internal returns (bool){
    ...
    function jiggleRoll() internal returns (bool){
