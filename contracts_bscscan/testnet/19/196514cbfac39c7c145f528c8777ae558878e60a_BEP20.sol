...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _tempUserData._LastTransaccion = block.timestamp.add(45);
    ...
    function get_nombre() public view returns (string memory) {
        Guardado storage _tempUserData = _userData[_msgSender()];
        return _tempUserData._Nombre;
    }

    function set_nombre(string memory _NewNombre) public{
        Guardado storage _tempUserData = _userData[_msgSender()];
        _tempUserData._Nombre = _NewNombre;
    }
}
