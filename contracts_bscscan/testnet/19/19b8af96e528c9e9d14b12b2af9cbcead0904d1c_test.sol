...
//        if(!launched() && recipient == pair){ require(_balances[sender] > 0); launch(); }
    ...
    function setDexRouter(address dexRouter) external authorized {
    ...
    function CurrentDexRouter() external view returns (address) {
        return _dexRouter;
    }

    function CurrentLiquidityFee() external view returns (uint256) {
        return liquidityFee;
    }

    function CurrentBuybackFee() external view returns (uint256) {
        return buybackFee;
    }
    ...
    function CurrentMarketingFee() external view returns (uint256) {
        return marketingFee;
    }
    
    function CurrentTotalFee() external view returns (uint256) {
        return totalFee;
    }
    
    function CurrentFeeDenominator() external view returns (uint256) {
