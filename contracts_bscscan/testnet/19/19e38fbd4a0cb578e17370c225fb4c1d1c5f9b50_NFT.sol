...
contract NFT is ERC721Enumerable , ReentrancyGuard , Ownable{
    ...
    constructor() ERC721("DNX NFT", "DNX NFT" ,"http://game.emarkt.cn/api/index/index/id/") Ownable() {
		...
		_imgURI = "https://game.emarkt.cn/api/index/nftimg/id/";
		...
		_setBlindBoxMap(0,true,bnxAddress,10*10**18,10,boxNftKeys,boxNftProb);
        ...
        maxNumOfDay = 5;
		wallet = 0xe332Bc0e4A5937e199A7Ec558256aC0a59855d01;
