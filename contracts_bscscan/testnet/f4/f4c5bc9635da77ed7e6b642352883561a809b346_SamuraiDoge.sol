...
contract SamuraiDoge is ERC721, Ownable {
    ...
    uint256 preMintCycle = 1000;
    uint256 primaryMintCycle = 4000;
    ...
    * Pause sale if active, make active if paused
    */
    function flipPrimarySaleState() public onlyOwner {
    ...
    * Mints Bored Apes
    */
    function preMintApe(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Ape");
        uint256 supply = totalSupply() + preMintCycle;
    ...
    * Mints Bored Apes
    */
    function primaryMintApe(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Ape");
        require(numberOfTokens <= maxApePurchase, "Can only mint 20 tokens at a time");
        uint256 supply = totalSupply() + primaryMintCycle;
        require(totalSupply() < supply);
    ...
    * Mints Bored Apes
    */
    function postMintApe(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint Ape");
        require(numberOfTokens <= maxApePurchase, "Can only mint 20 tokens at a time");
