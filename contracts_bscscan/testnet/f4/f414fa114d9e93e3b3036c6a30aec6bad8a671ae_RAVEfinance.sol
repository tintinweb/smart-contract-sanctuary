...
contract RAVEfinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0A1EA37618b031Dba0DC5013EC0D14d693745a00); // Marketing Address
    ...
    string private _name = "RAVEfinance";
