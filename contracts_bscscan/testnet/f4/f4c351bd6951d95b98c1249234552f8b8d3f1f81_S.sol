...
contract S is Context, IERC20, Ownable, LGEWhitelisted {
    ...
    uint256 private constant _tTotal = 1250000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'S_';
    ...
    constructor (address router, address communityAddress, address jackpotAddress, address quoteToken) public {
        ...
        _reflectSellFeePct = 500; // send 20% of supply to dead address = effective 1% burn on reflects
        
        _buyMaxAmount = 10000000 * 10**9;   //1% of supply
        _sellMaxAmount = 10000000 * 10**9;
