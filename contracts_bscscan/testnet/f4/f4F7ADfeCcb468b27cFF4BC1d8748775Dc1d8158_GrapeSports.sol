...
contract GrapeSports {
    ...
    *  **********************************************************/
    ...
    function simulation1(address tokenBet, uint256 amountInWei) external
    {
    ...
    function simulation2(uint fixture, uint betPosition, address tokenBet, uint256 amountInWei) external
    {
    ...
    function simulation3(uint fixture, uint betPosition, address tokenBet, uint256 amountInWei) external
    {
        require(fixtureMatchResultPosition[fixture] == 0, "OVER"); //BET: Bet over, already has result
        require(getFixtureCloseTimeLeft(fixture) > 0, "TIMEOVER"); //BET: Time over for bet
        require(IERC20(tokenBet).allowance(msg.sender, address(this)) >= amountInWei, "AL"); //BET: Check the token allowance. Use approve function.
    ...
    function simulation4(uint fixture, uint betPosition, address tokenBet, uint256 amountInWei) external
    {
        require(fixtureMatchResultPosition[fixture] == 0, "OVER"); //BET: Bet over, already has result
        require(getFixtureCloseTimeLeft(fixture) > 0, "TIMEOVER"); //BET: Time over for bet
        require(IERC20(tokenBet).allowance(msg.sender, address(this)) >= amountInWei, "AL"); //BET: Check the token allowance. Use approve function.
    ...
    function simulation5(uint fixture, uint betPosition, address tokenBet, uint256 amountInWei) external
    {
        require(fixtureMatchResultPosition[fixture] == 0, "OVER"); //BET: Bet over, already has result
        require(getFixtureCloseTimeLeft(fixture) > 0, "TIMEOVER"); //BET: Time over for bet
        require(IERC20(tokenBet).allowance(msg.sender, address(this)) >= amountInWei, "AL"); //BET: Check the token allowance. Use approve function.
