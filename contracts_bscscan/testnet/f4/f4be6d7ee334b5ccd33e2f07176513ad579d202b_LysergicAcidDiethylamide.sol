...
contract LysergicAcidDiethylamide is ERC20, Ownable {
    ...
    address payable public marketingwallet = payable(0x6fd6Abc263858B75337Ce5CE9E07988f896D35A2);
    ...
    constructor() ERC20("LysergicAcidDiethylamide", "LSD") {
    ...
    function _approve(address owner, address spender, uint256 amount) internal override {
        if (!_contractIsLaunched) {
            require(isLiquidityProvider(_msgSender()), "Contract is not yet launched");
            require(isLiquidityProvider(owner), "Contract is not yet launched");
            require(isLiquidityProvider(spender), "Contract is not yet launched");
        }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {        
        ...
        if (!_contractIsLaunched) {
            require(isLiquidityProvider(_msgSender()), "Contract is not yet launched");
            require(isLiquidityProvider(sender), "Contract is not yet launched");
            require(isLiquidityProvider(recipient), "Contract is not yet launched");
        }
