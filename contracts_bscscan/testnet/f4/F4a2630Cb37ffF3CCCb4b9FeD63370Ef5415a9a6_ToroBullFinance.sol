...
contract ToroBullFinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxBuyAmount = _tTotal.mul(2).div(100);
    uint256 public maxSellAmount = _tTotal.mul(1).div(100);
    uint256 public swapTokensAtAmount = 5000000000000000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 2000000000000000000000000 * 10**_decimals; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0x18ec9758122f036cfd89e35eCD026F0Ebd1Dfd94;
    address public operationsAddress = 0x987D58e8df7a614Da30239aafE7b46520cFF4463;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "ToroBullFinance";
    string private constant _symbol = "TOROB";
