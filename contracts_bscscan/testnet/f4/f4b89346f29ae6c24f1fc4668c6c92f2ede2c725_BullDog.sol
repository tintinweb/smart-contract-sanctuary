...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**17); // 10 Doge minimum auto send
...
contract BullDog is
    BASEToken("BullDog", "BullDog", 100000000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    constructor() {
        ...
        marketing = 0x809f683c0625A66dEA556EC33c575fB87d2cfC33;
