...
contract TESTToken is PausableToken {
    string  public  constant name = "The Blue Monkeys";
    string  public  constant symbol = "TBM";
    ...
    function TESTToken( address _admin, uint _totalTokenAmount ) 
    {
        // assign the admin account
        admin = _admin;

        // assign the total tokens to TEST
