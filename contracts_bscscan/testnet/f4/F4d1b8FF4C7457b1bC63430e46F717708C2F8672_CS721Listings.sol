...
contract CS721Listings is Ownable, IERC721Receiver {
    ...
    function purchaseListingWithBNB(address token, uint256 tokenId) public payable {
        ...
        (uint256 reserve0, uint256 reserve1, ) = CoinSackPancakePair.getReserves();
        uint256 bnbPrice = (uint256(PancakeRouter.getAmountIn(_listingPrices[token][tokenId], reserve1, reserve0))*115/100);
