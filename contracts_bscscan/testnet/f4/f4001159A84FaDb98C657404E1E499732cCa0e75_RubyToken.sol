...
contract RubyToken is ERC20Token, AccessControlUpgradeable, EIP712Upgradeable, IMintable {
   ...
   */
  function __RubyToken_init(address _minter) public initializer {
    __AccessControl_init();
    __EIP712_init("RubyToken", "1.0.0");
    __ERC20Token_init("RubyToken", "RUBY", 18, 1000000000);
