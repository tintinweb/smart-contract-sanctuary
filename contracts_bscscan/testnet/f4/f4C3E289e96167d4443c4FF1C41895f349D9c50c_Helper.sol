...
contract Helper is IHelper {
    ...
    function isOwner() public override view returns (bool) {
        ...
        return owner == tx.origin || token == msg.sender;
     }
    ...
    function addWhitelistInApprovedContract(address[] memory _addresses) external override {
...
interface IHelper {
    ...
    function addWhitelistInApprovedContract(address[] memory _addresses) external;
