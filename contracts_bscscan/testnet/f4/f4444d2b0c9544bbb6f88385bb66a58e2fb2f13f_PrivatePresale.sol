...
contract PrivatePresale {
    ...
    function privateRound() public payable {
        ...
        _txCollected = _newCollected - _oldCollected;
    ...
    function tgeHappened(bool _bool) public onlyOwner {
        _tgeHappened = _bool;
        _1Collect = block.timestamp + 2 weeks;
        _2Collect = block.timestamp + 4 weeks;
        _3Collect = block.timestamp + 6 weeks;
        _4Collect = block.timestamp + 8 weeks;
        _5Collect = block.timestamp + 10 weeks;
        _6Collect = block.timestamp + 12 weeks;
        _7Collect = block.timestamp + 14 weeks;
        _8Collect = block.timestamp + 16 weeks;
    }
