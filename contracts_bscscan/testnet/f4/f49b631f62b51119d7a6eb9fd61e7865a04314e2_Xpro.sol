...
contract Xpro is Context, IBEP20, Ownable {
    ...
    function setFee(uint8 fee, uint8 BbFee, uint8 LqFee, uint8 MktFee, uint8 RFee) external onlyOwner() {
        taxFee = fee;
        buybackFee = BbFee;
        liquidityFee = LqFee;
        marketingFee = MktFee;
    ...
    function setSellFee(uint8 SellTaxfee, uint8 SellBuybackFee, uint8 SellLiquidityFee, uint8 SellMarketingFee, uint8 SellResearchFee) external onlyOwner() {
