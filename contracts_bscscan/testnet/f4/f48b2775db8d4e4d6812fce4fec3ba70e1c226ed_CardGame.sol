...
using SafeMath for uint256;
 ...
 function init1() public {
  ...
  function addUriToCategory(string memory name,string memory rarityInput, string memory uris, uint256 cost, uint256 attack, uint256 toughness, string[] memory abilities, string memory element) adminAdd public {
    ...
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].tokenUris = uris;// test this
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].cost = cost;
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].attack = attack;
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].toughness = toughness;
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].abilities = abilities;
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].abilityCount = abilities.length;
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].element = element;
    Category[name].rarityBasedUris[rarityInput].attributes[Category[name].rarityBasedUris[rarityInput].count].pureCheck = true;
...
function weightGenerator(uint256 Input) internal returns(string memory)  {
 ...
 function reset(string memory name, string memory rarity2 ) public {
   Category[name].rarityBasedUris[rarity2].count = 0;
 }
}