...
contract BabyAxieCake is IBEP20, Ownable
{
    ...
    address public immutable CAKE = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); //USDT
    address public immutable AXS = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimAxieAndCake(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawAxieAndCake(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimAxieAndCake(address addr) private{
        ...
        emit OnWithdrawAxieAndCake(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function AxieCakeWithdraw() public{
        claimAxieAndCake(msg.sender);
    }
    ...
    function TeamWithdrawMarketingBNB() public onlyTeam{
        ...
        marketingBalance=0;
        (bool sent,) =TRev.call{value: (amount)}("");
    ...
    function TeamReleaseLiquidity() public onlyTeam {
        ...
        if(liquidityRelease20Percent)
        {
            ...
            amount=amount*2/10;
            liquidityToken.transfer(TRev, amount);
        }
        else
        {
    ...
    function TeamRemoveRemainingBNB() public onlyTeam{
        ...
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
        (bool sent,) =TRev.call{value: (address(this).balance)}("");
        require(sent);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //external//////////////////////////////////////////////////////////////////////////////////////////////
