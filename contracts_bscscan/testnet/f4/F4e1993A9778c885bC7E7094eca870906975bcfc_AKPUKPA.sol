...
contract AKPUKPA is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "AKPUKPA";
    string private _symbol = "AKPUKPA";
    ...
    function PercentageOfLiquidity() public view returns (uint256)
    {
    ...
    function setLiquidityPercent(uint256 PercentageOfLiquidity) external onlyOwner() {
        _PercentageOfLiquidity = PercentageOfLiquidity;
    }
    ...
    uint256 public _liquidityFee = 10; // 3% will be added pool, 4% will be converted to BNB, 3% will be added into GhostFace BNB
    uint256 private _PercentageOfLiquidity = 30;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public rewardThreshold = 1 ether;
    
    uint256 private _totalGhostCollected = 0;
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        !(from == address(this) && to == address(pancakePair)) // swap 1 time
            ...
            // ghost here
            uint256 balanceToBread = deltaBalance.mul(PercentageOfLiquidity().div(10**2));
            uint256 tokensExtra = otherPiece.mul(PercentageOfLiquidity().div(10**2));
