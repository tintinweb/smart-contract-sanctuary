...
contract PrivatePresale {
    ...
    function approve(uint256 _depositAmount) public {
        uint256 _depositAmountCorr = _depositAmount*10**18;
        depositToken().safeIncreaseAllowance(msg.sender, _depositAmountCorr);
    }
    ...
    function privateRound(uint256 _depositAmount) public {
        ...
        //uint256 txCollected = depositToken().balanceOf(address(this)) - previousCollected;
