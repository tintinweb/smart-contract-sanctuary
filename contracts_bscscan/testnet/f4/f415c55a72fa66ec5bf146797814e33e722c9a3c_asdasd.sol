...
contract asdasd is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**9 * 10**9; // 15 Billion
    ...
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**2 * 10**9;
