...
Catchy Token:
   5% fee added to the locked liquidity pool
   5% fee added directly in BNB to the dev wallet
   2% fee for burn
   0% fee for redistribution tax
   Sum of all fees can never exceed 13%
   Dev fees can never exceed 5%
   
Telegram: https://t.me/CatchyCoin
Website: https://catchy.finance/
Reddit: https://www.reddit.com/r/Catchycoin/
*/
...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    address public router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // PCS V1 BSC testnet router
