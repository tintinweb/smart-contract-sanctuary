...
contract v100xCoin is ERC20, Ownable {
    ...
    */
    ...
    constructor()  ERC20("100xCoin", "100x") {
        ...
        _devWallet = 0x2bf977F1D8F6E3bC281CFF257c42A775bE42d7B0;
        _manualBurnWallet = 0xc17D00AD3B2Ed99b45CC3AAf7c3045BDfEc8D03F;
    ...
    */
    ...
    function setManualBurnFee(uint32 newFee) public onlyOwner {
        _manualBurn = newFee;
    }
    ...
    function withdrawAnyToken(
        ...
        require(
            _ERC20address != uniswapV2Pair,
            "Can't transfer out LP tokens!"
        );
        require(
            _ERC20address != address(this),
            "Can't transfer out contract tokens!"
        );
