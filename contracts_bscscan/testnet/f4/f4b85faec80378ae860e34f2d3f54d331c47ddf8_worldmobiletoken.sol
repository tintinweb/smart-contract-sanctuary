...
/* Binance launch Pad- BNB Reward Token
...
contract worldmobiletoken is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5318b9D626663873b2187DC643B1F34699101497); //nice
    address payable public charityAddress = payable(0x5318b9D626663873b2187DC643B1F34699101497); //nice
    ...
    uint256 private _tTotal = 1900000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "World Mobile Token"; //CC
    string private _symbol = "WOR";  //nice
    ...
    uint256 public _maxTxAmount = 28500 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 28500 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 19000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 28500;// 0.01*285 token for 0.01 bnb (set as per requirements)
