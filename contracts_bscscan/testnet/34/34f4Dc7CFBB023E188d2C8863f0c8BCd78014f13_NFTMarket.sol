...
//    mapping(uint256 => address) private _tokenSellers;
    mapping(address => mapping(uint256 => address)) private _tokenSellersData;
...
//        quoteErc20 = IERC20(_quoteErc20Address);
    ...
    // 购买NFT
    function buyToken(address _nftAddress, uint256 _tokenId) public whenNotPaused {
        buyTokenTo(_nftAddress,_tokenId, _msgSender());
    }

    // 为 _to 购买NFT
    function buyTokenTo(address _nftAddress, uint256 _tokenId, address _to) public whenNotPaused {
    ...
    function readyToSellToken(address _nftAddress, address _coinAddress,uint256 _tokenId, uint256 _price) public whenNotPaused {
        readyToSellTokenTo(_nftAddress, _coinAddress, _tokenId, _price, address(_msgSender()));
    }
