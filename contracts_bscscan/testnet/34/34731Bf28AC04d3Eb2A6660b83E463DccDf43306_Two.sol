...
contract Two is ExtendedReflections {
    ...
    uint32 private _decimals = 2;

    constructor (address _adminAddress) ExtendedReflections("Two", "TWO", _decimals, _tokenSupply) {
