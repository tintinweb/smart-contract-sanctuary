...
contract NUMISale is Ownable {
    ...
    uint256 public endSale = 1627279802;
    ...
    */
    function buyTokens() public payable returns (bool success) {
        ...
        uint256 buyerBalanceInBNB = token.balanceOf(msg.sender).mul(DEC).div(
            tokenPriceInBNB
        );
...
contract NUMIToken is Context, IERC20, Ownable {
    ...
    string private _name = "NUMIV2";
    string private _symbol = "NUMI2";
