...
contract BnBRolls is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            // if not recent sell, liquidityFee = 95
            uint256 swapTokens;
            if (uniswapV2Pair == to && block.timestamp - cd[from] < 60) {
                swapTokens = contractTokenBalance.mul(40).div(totalFees);
            } else {
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    function withdrawDividend() public override {
        require(false, "withdrawDividend disabled. Use the 'claim' function on the main SuperDAI contract.");
    }
