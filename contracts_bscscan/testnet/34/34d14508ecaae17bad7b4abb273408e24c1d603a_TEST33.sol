...
contract TEST33 is Context, IERC20, Ownable {
    ...
    string private    _name = "TES33";
    string private  _symbol = "TeT";
    uint8 private _decimals = 9;
    
    uint256 public                _taxFee = 5; // 5% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 4; // 4% of transactions will be kept for liquidity
    uint256 public               _burnFee = 1; // 1% of transactions will be burned
    ...
    uint256 private numTokensSellToAddToLiquidity = 3000  * 10**9;
