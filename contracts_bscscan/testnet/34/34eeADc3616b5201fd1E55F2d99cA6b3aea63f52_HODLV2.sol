...
contract HODLV2 is Context, IBEP20, Ownable, ReentrancyGuard {
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    address public reservewallet = 0x6a38C935BcFBDe08FD5666238221Dd0744cfe2CF;
    address public teamwallet = 0x5eA12747Ecd2FebDBcBEF66E47c501165d09ad1E;
    address public marketingwallet = 0xB0b5d4fbd88576056270d9C267c6Dd25F528B743;
    address public reinvestwallet = 0x6bFf2dE1b4207cB7FafF9ff4b50E6B2F3df7537e;
    ...
    function swapAndLiquify(address from, address to, uint256 amount) private {
        ...
        !(from == address(this) && to == address(pancakePair)) // swap 1 time
            ...
            IWBNB(payable(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)).deposit{value: buybackreward}();     
            ...
            if (to == address(pancakePair)) 
               {
             uint256 balance = IWBNB(payable(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)).balanceOf(address(this));
    ...
    // }
       ...
       function activateContract() public onlyOwner {
        ...
        // approve contract
        _approve(address(this), address(pancakeRouter), 2 ** 256 - 1);
        IWBNB(payable(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c)).approve(address(pancakeRouter),2 ** 256 - 1);
    }
