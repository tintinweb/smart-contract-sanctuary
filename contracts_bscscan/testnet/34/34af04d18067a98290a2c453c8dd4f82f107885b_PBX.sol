...
/**
Project Name : Polarbear100x.co

Max Cap 10,000,000,000 Tokens ; 1000,000 tokens trading limit per transaction

6% Trading Fee:
 - 2% Allocate to All Holders
 - 3% Add to LP
 - 1% Marketing and Operational Expenses & Burn
**/
...
contract PBX is Context, IERC20, Ownable {
    ...
    string private _name = "PolarBear X DeFi Robotics";
    ...
    constructor(address _optional, address _router) public {
        _rOwned[_msgSender()] = _rTotal;
        
        TEAM_ADDRESS = _optional;
