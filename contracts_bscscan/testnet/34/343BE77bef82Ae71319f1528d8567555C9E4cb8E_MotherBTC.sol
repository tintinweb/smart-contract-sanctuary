...
contract MotherBTC is Context, IERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x3F3be9ad41536eC095eE2FDed1EfD94a2e14c10c); // Marketing Address
    ...
    string private _name = "MoTest";
    string private _symbol = "MoTest";
    ...
    uint256 public _liquidityFeeWhenBuy = 8;
