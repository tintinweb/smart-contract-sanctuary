...
contract NFT is Ownable, ERC721Token, ERC721Holder {
    ...
    uint public countTokenPayment = 0;
    ...
    function mintNFT(string _ipfsHash, string _name, string _description) public payable {
    ...
    function mintDefault(string _ipfsHash, string _name, string _description) public onlyOwner {
         require(ipfsHashToTokenId[_ipfsHash] == 0);
    ...
    function purchaseNFTSellingItem(uint256 _tokenId) public payable {
        ...
        if (sellingItem.price > 0) {
            ...
            uint256 proceeds = sellingItem.price - actualPublisherCut;
