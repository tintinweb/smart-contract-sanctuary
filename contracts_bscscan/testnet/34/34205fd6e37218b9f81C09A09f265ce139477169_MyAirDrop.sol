...
using SafeMath for uint256;
   ...
   * to the airdrop list with the default of 30 token
   */
  ...
  internal
  {
      ...
      contrib.tokenAmount = _tokenAward.mul(10e18);
   ...
   * airdrop list with the default of 30 token
   */
...
function setAirdropAddressWasClaimed(address _addressToChange, bool _newWasClaimedValue)
  ...
  function() payable public {
    revert("Coin not accepted");
  }

}

contract MyAirDrop is AirDropWinners {
  using SafeMath for uint256;

  address initTokenContractAddress = 0xb0EB5A12E75BE1bd5a4204e0606FB82dEFfbaa77;
