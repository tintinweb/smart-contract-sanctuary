...
contract TK3 is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "Test Token 3";

    string constant _symbol = "TK3";
    ...
    address public marketingFeeReceiver = 0x88434294d84B82C66dEE6e81685D8Df996b2d2c4;

    address public buybackFeeReceiver = 0x88434294d84B82C66dEE6e81685D8Df996b2d2c4;
