...
contract FullCode1 is IBEP20, Ownable
{
    ...
    string private constant _name = "FullCode1";
    string private constant _symbol = "FC1";
    ...
    uint256 private  balanceLimit = 100000000 * 10**_decimals;
    uint256 private  sellLimit = 10000000 * 10**_decimals;
    uint256 private  buyLimit = 50000000 * 10**_decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private{
        ...
        if(isContractTransfer || isLiquidityTransfer || isExcluded){
            ...
            require(sellLockDisabled,"Panic Sell Protection");
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function LiquidityReleaseTimeInSeconds() public view returns (uint256){
    ...
    function Limits() public view returns(uint256 balance, uint256 sell){
        return(balanceLimit/10**_decimals, sellLimit/10**_decimals);
    }

    function Taxes() public view returns(uint256 burnTax,uint256 liquidityTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
    ...
    function SellLockTimeInSeconds() public view returns(uint256){
        return sellLockTime;
    }
    ...
    function SwitchManualBNBConversion(bool manual) public onlyOwner{
        manualConversion=manual;
    }



    function SetTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 marketingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyOwner{
    ...
    function UpdateLimits(uint256 newBalanceLimit, uint256 newSellLimit, uint256 newBuyLimit) public onlyOwner{
    ...
    function DisableSellLock() public onlyOwner{
        sellLockDisabled=true;
    }
    function EnableSellLock() public onlyOwner{
