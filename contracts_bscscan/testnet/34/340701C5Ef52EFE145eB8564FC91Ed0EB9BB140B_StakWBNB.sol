...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BRISE = IBEP20 (0x8FFf93E810a2eDaaFc326eDEE51071DA9d398E83);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BRISE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BRISE);
        ...
        uint256 amount = BRISE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BRISE.transfer(shareholder, amount);
...
contract StakWBNB is IBEP20, Auth {
    using SafeMath for uint256;

    address BitRise = 0x8FFf93E810a2eDaaFc326eDEE51071DA9d398E83;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "StakWBNB";
    ...
    address public marketingFeeReceiver = 0x2579599b78126840aA4eEb4228B4151Cf6E88B6f;
