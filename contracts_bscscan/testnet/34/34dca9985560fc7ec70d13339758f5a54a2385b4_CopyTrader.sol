...
contract CopyTrader is Ownable {
    ...
    uint256 private constant INITIAL_FEE_BALANCE = uint256(int256(1)/10000);
    uint256 private constant MIN_TOKEN_AMOUNT = uint256(int256(1)/1000000);
    ...
    function swapBNBForToken(
        ...
        Asset storage destAsset = asset(destToken);
    ...
    function swapTokenForBNB(
        ...
        Asset storage fromAsset = asset(fromToken);
