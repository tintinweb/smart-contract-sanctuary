...
www.pappaeth.com 
 ...
 |  _/ _` | '_ \ '_ \/ _` | _|  | | | __ |
 |_| \__,_| .__/ .__/\__,_|___| |_| |_||_|
          |_|  |_|                       

TAX: 16% (10% back to holders in Ethereum, 5% to marketing, 3% to locked LP)
REWARDS: For every transaction, holders earn 10% in Eth 
ETH BSC: 0x2170Ed0880ac9A755fd29B2688956BD959F933F8
DXSALE MINI FAIRLAUNCH!
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x96D502E3A0272Ea35AE4a5eC88B6Ea2ef7D3a323);
    address WBNB = 0x96D502E3A0272Ea35AE4a5eC88B6Ea2ef7D3a323;
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
        _token = msg.sender;
    }
...
contract DaddyETH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PappaETH";
    string constant _symbol = "PappaETH";
