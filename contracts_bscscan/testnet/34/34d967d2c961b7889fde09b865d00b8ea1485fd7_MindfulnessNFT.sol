...
contract MindfulnessNFT is ERC721,ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    event MintedFixedToken(address indexed minter, uint256 price, address currency, uint256 nftID, uint256 royalty, string uri);
    event PriceUpdate(address indexed owner, uint256 oldPrice, uint256 newPrice, uint256 nftID);
    event Purchase(address indexed previousOwner, address indexed newOwner, uint256 price, address currency, uint256 nftID, string uri);
    ...
    event AuctionStart(address indexed owner, uint256 minBidPrice, address currency, uint256 startTime, uint256 endTime, uint256 nftID);
    event Sell(address indexed previousOwner, address indexed newOwner, uint256 bidPrice, address currency, uint256 nftID, string uri);
    ...
    function mintFixed(string memory _tokenURI, uint256 _price, address _currency, uint256 _royalty) public returns (uint256) {
        ...
        emit MintedFixedToken(_msgSender(), _price, _currency, _tokenId, _royalty, _tokenURI);
    ...
    function buy(uint256 _id) external payable _validateBuy(_id) {
        ...
        emit Purchase(_previousOwner, _newOwner, mapNFTAttribute[_id].price, mapNFTAttribute[_id].currency, _id, tokenURI(_id));
    }
    ...
    function sell(uint256 _id, address _buyer) public _validateSell(_id, _buyer){
        ...
        emit Sell(ownerOf(_id), _buyer, _price, _currency, _id, tokenURI(_id));
    }
    ...
    function startAuction(uint256 _tokenId, uint256 _minBidPrice, address _currency, uint256 _startTime, uint256 _endTime) external _validateStartAuction(_tokenId){
        ...
        emit AuctionStart(_msgSender(), _minBidPrice, _currency, _startTime, _endTime, _tokenId);
    }
