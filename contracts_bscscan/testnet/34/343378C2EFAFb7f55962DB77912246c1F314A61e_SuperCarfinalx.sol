...
contract SuperCarfinalx is Context, IERC20, LockToken {
    ...
    uint256 private _tTotal = 100_000_000_000 * 10**4;  //total supply. 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SuperCarfinalx"; //token name
    string private _symbol = "SUPCfinalx"; // token symbol. 
    ...
    uint256 private minimumTokensBeforeSwap = 100_000 * 10**4; 
    ...
    {    
        ...
        _maxTxAmount = 10_000_000_000 * 10**4;
    }
