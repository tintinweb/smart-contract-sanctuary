...
/**
   # Toshiba Inu Token ($TOSHI)
   Total rnsaction Fee 4%
   2% fee auto add to the liquidity pool to locked forever when selling
   1% Will be burnt with every Transaction  
   1% will be distributed in holders
   ttl supply = 100,000,000
   Decimals 18
*/
...
contract $TOSHI is Context, IERC20, Ownable {
    ...
    string private _name = "Toshiba Inu Token";
