...
contract LiquidationAuction02 is ReentrancyGuard {
    ...
    **/
    ...
    function buyout(address asset, address owner) public nonReentrant checkpoint(asset, owner) {
        require(vault.liquidationBlock(asset, owner) != 0, "CryptoPeso protocol : LIQUIDATION_NOT_TRIGGERED");
        ...
        // ensure that at least 1 CryptoPeso of token is transferred to cdp owner
