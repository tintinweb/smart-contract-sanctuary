...
contract NewAMasterChef is InitializeOwnable, DEFIToken, Initializable{
        ...
        )
    {
        ...
        allocAmount = (pool.accPerShare > 0) ? pool.accPerShare.mul(mSupply).div(1e12) : 0;
        ...
        )
    {
        ...
        availableToClaim = (poolAvalible() > 0) ? (poolAvalible() - supply) : 0;
        expectedClaim = availableToClaim; //Distribute
