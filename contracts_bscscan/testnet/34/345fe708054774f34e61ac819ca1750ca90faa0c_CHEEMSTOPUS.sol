...
contract CHEEMSTOPUS is Context, IERC20, Ownable {
    ...
    string private _name = "Cheemstopus Games";
    string private _symbol = "BONK";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 250000000  * 10**18;

    address payable public marketingAddress = payable(0x32024a46a09C1d0faB7b4D3a45f5D5fE3b74B078);
    address public marketingWalletToken = 0xD7b9E3064CED62D4cc6Bc1be3F92D32E7332D21C;
    ...
    constructor () {
        ...
        _liquidityThreshhold = 1000  * 10**18;
        _maxBalanceWallet = 150000000  * 10**18;
