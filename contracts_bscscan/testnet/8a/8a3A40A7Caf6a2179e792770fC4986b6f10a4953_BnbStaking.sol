...
contract BnbStaking is Ownable {
    ...
    // limit 10000 BNB here
    uint256 public limitAmount = 10000000000000000000000;
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if (block.number > pool.lastRewardBlock && lpSupply != 0) {
            ...
            uint256 pepeReward = multiplier.mul(rewardPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
