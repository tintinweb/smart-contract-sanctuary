...
// Contract created by www.GenTokens.com
...
contract TEST is Context, IERC20, Ownable { 
    ...
    uint8 public _Tax_On_Buy = 10;
    uint8 public _Tax_On_Sell = 10;

    // Fee distribution (total must = 100%)
    uint8 public Percent_Marketing = 40;
    uint8 public Percent_Burn = 0;
    uint8 public Percent_Token_Wallet = 20;
    uint8 public Percent_AutoLP = 40; 

    // Max possible fee on buy and sell
    uint8 public constant _Tax_On_Buy_MAX = 12; 
    uint8 public constant _Tax_On_Sell_MAX = 15;
    ...
    */
    ...
    function _set_Fees(uint8 Tax_On_Buy, uint8 Tax_On_Sell) external onlyOwner() {
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint8 Marketing, uint8 Auto_Liquidity, uint8 Token_Wallet, uint8 Auto_Burn) external onlyOwner() {
    ...
    */
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            // Increase the fee processing counter
            txCount++;
