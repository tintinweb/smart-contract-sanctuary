...
contract XxX is Context, IBEP20, Ownable {
    ...
    uint256 private totalLiqFee = liquidityFee.add(marketingFee).add(charityFee).add(researchFee);
    ...
    uint256 public _maxTxAmount = 1000000 * 10**9; // Max buy per 1x txn 0,1%
    ...
    constructor (address payable marketingWallet, address payable charityWallet, address payable researchWallet, address pancakeSwapRouter) {
    ...
    function setLiquidityFeePercent(uint256 LiquidityFee) external onlyOwner() {
        ...
        totalLiqFee = liquidityFee.add(marketingFee).add(charityFee).add(researchFee);
    }
    ...
    function setResearchFeePercent(uint256 ResearchFee) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 ethForLiquidity = balanceDiff.sub(ethForMarketing).sub(ethForCharity).sub(ethForResearch);
