...
contract RijentContract {    
    ...
    function deposit(uint amount, uint lockingType) public {
        ...
        ///dep.packages.push( Package( sender, amount, lockingType, packagePer, time, packageExpiry, timeDiff, packageForMonth,0,0 ) );
		
        ////emit DepositAt(sender, amount, lockingType, packagePer, time, packageExpiry, timeDiff, packageForMonth,0,0);
    }
