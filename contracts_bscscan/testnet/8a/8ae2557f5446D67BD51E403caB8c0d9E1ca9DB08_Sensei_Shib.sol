...
contract Sensei_Shib is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x5955302f312f74924665c500036a7391017f6A7C);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0x5955302f312f74924665c500036a7391017f6A7C); 

    string private _name    = "Sensei Shib";
