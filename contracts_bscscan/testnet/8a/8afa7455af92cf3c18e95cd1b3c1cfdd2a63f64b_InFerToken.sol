...
contract InFerToken is IBEP20, Ownable {
    ...
    bool private setTeam = false;
    mapping (address => bool) public isWalletTeam;
    ...
    function setTeamWallets(address team1, address team2, address team3) external onlyOwner {
        require(setTeam == false, "Team wallets were set");
        setTeam == true;
        isWalletTeam[team1] = true;
        isWalletTeam[team2] = true;
        isWalletTeam[team3] = true;
        isMaxWalletLimitExempt[team1] = true;
        isMaxWalletLimitExempt[team2] = true;
        isMaxWalletLimitExempt[team3] = true;
    }
