...
contract KTest is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x10B4E9c92B405571aa4C8DCe666B0b3Ce76684B6); // Marketing Address
        
    address payable public teamAddress =
        payable(0xACb3243823F37Bf7da8Ec0C86ee2B2857f9E27BF); // Team Address
        
    address payable public liquidityAddress =
        payable(0xf3583fD499395DC406ae6Ad8a872DB3D715DD748); // Liquidity Address
    ...
    //uint256 private constant _tTotal = 100 * 1e9 * 1e18;//10**9 * 10**DECIMALS;
