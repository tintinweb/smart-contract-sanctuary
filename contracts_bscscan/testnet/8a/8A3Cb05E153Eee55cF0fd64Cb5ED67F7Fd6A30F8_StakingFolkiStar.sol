...
contract StakingFolkiStar{
    ...
    uint256 public FolkiStar;
    uint256 public FolkiStarinvestor;
...
address owner;
	...
	event Withdrawn(address indexed user, uint256 amount);
     ...
     function stakeFolkiStar(address referrer,uint256 amount) public    {
         uint8 plan=0;
     ...
     balanceOf[address(this)] = balanceOf[address(this)].add(token);
        ...
        if(IERC20(tokenContract).balanceOf(msg.sender)<token){
         ...
         IERC20(tokenContract).transferFrom(msg.sender,address(this),token);
	...
	function withdraw() public {
		...
		IERC20(tokenContract).transferFrom(address(this),msg.sender,withdrawAmount);
