...
contract ToxicPrueba is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000000 * 10**9;//SUPPY
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ToxicPrueba";
    string private _symbol = "TXTP";
    ...
    address public marketingWallet = 0x628cD13C2f10c2fa8727E71dF3d8B90F5eddf2D0;// CARTERA DONDE LLEGARAN LOS FONDOS PARA MARKETING
