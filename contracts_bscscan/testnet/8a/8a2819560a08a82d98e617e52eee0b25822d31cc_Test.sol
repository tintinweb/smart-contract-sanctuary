...
contract Test is Context, IERC20, Ownable {
    ...
    address immutable public deadAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    uint256 private _tTotal = 150* 10**12 * 10**_decimals;
    ...
    constructor (address routerAddress) {
        ...
        excludeFromReward(0x89EbF88686dC667d37738e15866eF80d3862B237);
        excludeFromReward(0xf9C934f119A8D2c81B6438135B2e9167E024Ab95);
        excludeFromReward(0xD3B7a3c4E88883588e2cF1C0Afce1e97A8fF1C97);
        excludeFromReward(0xA113489399F935A260866bEe007d8B0411D2bf75);
        excludeFromReward(0x17c82411CDAAfFAAEEC0b37A4CeF4591393b082E);
        excludeFromReward(0xC1E22b0fE83804677230515C60f80517DC652fe9);
        excludeFromReward(0x4a2a888F04028E307A6450FeF3c5690A9600eA0b);
    ...
    function checkCircSupply() internal view returns(uint256){
        return (_tTotal - balanceOf(deadAddress));
    }

    function _getValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory to_return) {
        to_return = _getTValues(tAmount, takeFee);
        (to_return.rAmount, to_return.rTransferAmount, to_return.rRfi, to_return.rBurn, to_return.rLiquidity) = _getRValues(to_return, tAmount, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount-s.tRfi-s.tBurn-s.tLiquidity;
        return s;
    }

    function _getRValues(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi, uint256 rBurn, uint256 rLiquidity) {
        ...
        rTransferAmount =  rAmount-rRfi-rBurn-rLiquidity;
        return (rAmount, rTransferAmount, rRfi,rBurn,rLiquidity);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if(circSupply <= 1e9 * 10**_decimals){
            takeFee = false;
        }
