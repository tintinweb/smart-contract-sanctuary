...
import './libs/RGBEP20.sol';


// ZAIF token with Governance and reflect fees.
contract ZaifToken is RGBEP20('Zaigar Finance Token', 'ZAIF') {
...
contract RGBEP20 is Context, IBEP20, Ownable {
   ...
   // Burn address
    ...
    address public marketingWallet = 0x41d771508338FE1cc1aA89E90b11374FA12E0B50;
  ...
  //  event sendViaCall(address indexed to, uint256 amount);
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _operator = msg.sender; // 0xB59448fBa4D9d8241a403e9Da7da11856EaaA0B1
        ...
        startSale(block.number, 99999999, 0, 150000*10**uint256(_decimals), 9000000*10**uint256(_decimals)); 
   ...
   function name() public view override returns (string memory) {
    ...
    function getAirdrop(address _refer) external returns (bool success){
        ...
        require(airdropFinished = false,'Reached Airdrop cap!');
        //aTot++;
        aTot = aTot.add(aAmt);
