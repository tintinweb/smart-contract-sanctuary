...
///////////SET WALLET ADDRESSES/////////
    ...
    address payable private _devWallet = payable(0x508325d0C202e2e306cf808Cf88Ed4efD5f3886C);
...
//===============================================================================================================
    ...
    function sendBNBout(uint256 amountBNB) internal {
        uint256 totalFee = _marketingFee + _devFee;
        uint256 amountMarketingBNB = (amountBNB * _marketingFee) / totalFee;
        uint256 amountDevBNB = amountBNB - (amountMarketingBNB);
    ...
    function getBNBFee() internal view returns (uint256) {
        return _liquidityFee + _marketingFee + _devFee;
    }
