...
Telegram @BadBabyDogebsc https://t.me/Badbabydogebsc
*/
...
contract Bad_BabyDoge_BSC is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Bad Babydoge BSC';
    ...
    function setAsCharityAccount(address account) external onlyOwner() {
        require(account != 0xA24A04D71524d0573253A88aeEbD854AD747e2DB, 'The Uniswap router can not be the charity account.');
