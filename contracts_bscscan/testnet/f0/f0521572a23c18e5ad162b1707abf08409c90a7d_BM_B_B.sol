...
contract BM_B_B{
    ...
    function buyEggs(address ref, uint256 _amount) public payable{
        require(initialized);
		icApp.transferFrom(msg.sender, address(this), _amount);
        uint256 eggsBought=calculateEggBuy(_amount,SafeMath.sub(address(this).balance,_amount));
