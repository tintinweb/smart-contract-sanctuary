...
contract WalletsToken is IERC20, Ownable {
    ...
    constructor() public {
        ...
        totalAdminFees = _liquidityFee + _wallet1Fee + _wallet2Fee + _wallet3Fee + _wallet4Fee + _wallet5Fee;
    ...
    function updateFees(uint256 _tokenRewardsFee, uint256 _liquidityFee, uint256 _wallet1Fee, uint256 _wallet2Fee, uint256 _wallet3Fee, uint256 _wallet4Fee, uint256 _wallet5Fee) external onlyOwner {
        ...
        totalAdminFees = _liquidityFee + wallet1Fee + wallet2Fee + wallet3Fee + wallet4Fee + wallet5Fee;
    }
