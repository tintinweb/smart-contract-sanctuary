...
abstract contract AbstractDeflationaryToken is Context, IERC20, Security {
    ...
    bool public _disabled = true; // Start disabled, prevent bots
    ...
    function setDisabled(bool state) external onlySecOwner {
        _disabled = state;
    }
