...
// File: @openzeppelin/[email protected]/token/BEP20/IBEP20.sol
...
// File: @openzeppelin/[email protected]/token/BEP20/BEP20.sol
...
abstract contract AccessControl is Context {
     ...
     */
    function getRoleMembBEPount(bytes32 role) public view returns (uint256) {
        return _roles[role].members.length();
    }

    /**
     * @dev Returns one of the accounts that have `role`. `index` must be a
     * value between 0 and {getRoleMembBEPount}, non-inclusive.
     *
     * Role bearers are not sorted in any particular way, and their ordering may
     * change at any point.
     *
     * WARNING: When using {getRoleMember} and {getRoleMembBEPount}, make sure
...
// File: @openzeppelin/[email protected]/token/BEP20/BEP20Pausable.sol
...
// File: @openzeppelin/[email protected]/token/BEP20/BEP20Capped.sol
...
// File: @openzeppelin/[email protected]/token/BEP20/BEP20Burnable.sol
...
contract BoltToken is BEP20Burnable, BEP20Capped, BEP20Pausable, AccessControl {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() public BEP20Capped(100 * 10**6 * 10**18) BEP20("0xBolt", "0XB") {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(BEP20, BEP20Pausable, BEP20Capped) {
        super._beforeTokenTransfer(from, to, amount);
    }
}