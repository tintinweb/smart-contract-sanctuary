...
contract TESTOKEN is Context, IERC20, Ownable {
    ...
    address public constant TREASURY_ADDRESS = 0x240B3Eac52af95C3217fd4fb848F9182c31ecEA9;  
    ...
    event TaxChange(uint value);
    event LiquidityChange(uint value);
    event TreasuryChange(uint value);
    event MaxTxChange(uint value);
    ...
    constructor (address _routerAddress) {
        ...
        IPancakeV2Router02 _pancakeV2Router = IPancakeV2Router02(_routerAddress);//0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F //0x10ED43C718714eb63d5aA57B78B54704E256024E
...
/*
    ...
    */
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint tTreasury = calculateTreasuryFee(tAmount);
    ...
    function _takeTreasury(uint256 tTreasury) private {
        uint256 currentRate =  _getRate();
        uint256 rTreasury = tTreasury.mul(currentRate);
        _rOwned[TREASURY_ADDRESS] = _rOwned[TREASURY_ADDRESS].add(rTreasury);
        if(_isExcluded[TREASURY_ADDRESS])
            _tOwned[TREASURY_ADDRESS] = _tOwned[TREASURY_ADDRESS].add(tTreasury);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //take crumbs to treasury - user distribution through seperate contract later
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        (, , uint liquidity) = pancakeV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
