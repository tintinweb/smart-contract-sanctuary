...
// DIXIE AMERICAS HOUSEHOLD PUP THE DOG EVERYONE LOVES WHEN ELON MUSK WAS JUST A BABY BEFORE THERE WAS DOGE FLOKI SHIB AND ALL 
// THE BABY DOGS THERER WAS ELONS FAVORITE COMPANION DIXIE THE DOG OF THE HEARTLAND DID WE MENTION DIXIE LOVES TO FEEL THE AIR 
// OUTSIDE AS SHES RIDING WITH ELON IN THERE TESLA
...
contract DIXIEINU is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "DIXIE INU";                  
    string private _symbol = "DIX";                                 
   ...
   // address public  pancakeRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancake TestRouter Version 2 address
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x9527315798628de940c7B58b574dCa4Dd53495A1),                             // Dev wallet
        payable(0xD9C9C7a60e40Fb088342C84973eF748AB66b0832),                             // Marketing wallet
        payable(0x2EAC974D37F28bc4C6765c96CD398159FA7233Df),                             // Team Dev wallet
        payable(0xfD5cCe02Cf511F201fF87836636d474f672A591a),                             // Charity wallet
        payable(0x016Ba94d432141bF1460Bd01C5f6a4785b9c48fF)                              // SPARE1
 ];
    ...
    constructor () {
        ...
        _maxBalanceWallet = 100000 * 10**uint256(_decimals);
   ...
   function isExcludedFromMaxBalance(address account) public view returns(bool) {
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "DIX is not live yet");
     if(
