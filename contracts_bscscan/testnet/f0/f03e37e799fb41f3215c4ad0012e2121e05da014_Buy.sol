...
contract Buy is AccessControl {
    ...
    function initAgent(
        ...
        require(agents[_promoCodeDigest].wallet != address(0), "Agent with this promo code already exists");
        agents[_promoCodeDigest].wallet = _agent;
        agents[_promoCodeDigest].amount = 0;
        
        emit NewAgent(_agent, _promoCodeDigest);
    ...
    function swap(
        ...
        bytes32 _promoCodeDigest
            ...
            require(directRoundLimit + _value >=  totalSold, "All tokens was sold");
            ...
            ERC20(usdToken).safeTransfer(agents[_promoCodeDigest].wallet, _value.div(10));
        
            emit TokenExchanged(msg.sender, _value, amountInHype);  
...
/*
    function claimUSDbyAgent(bytes32 _promoCodeDigest) external {
        ...
        ERC20(usdToken).safeTransfer(msg.sender, amount.div(10));
