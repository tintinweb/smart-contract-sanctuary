...
interface Interface_Simple_Bank {
    ...
    */    
    ...
    function depositERC721(address erc721_address, uint256 serial_no, address erc721_owner_addres, string memory notes) external;
    
    function withdrawERC721(address erc721_address, uint256 serial_no, string memory note) external;

    function sendERC721(address erc721_address, uint256 serial_no, address recipient_address, string memory note) external;
...
contract SIMPLE_BANK is Ownable, IERC721Receiver, Interface_Simple_Bank {
    ...
    */
        ...
        public
    {
        ...
        require(IERC20(erc20_address).transferFrom(_sender, address(this), amount), "E:[0001,depositERC20]");
        
        // Add new deposit amount to total deposit amount of sender by each ERC20 token.
        $erc20_total[erc20_address][_sender] += amount;
    }
    ...
    function getTotalDepositAmount(
        ...
        returns (uint256)
    {
        return $erc20_total[erc20_address][msg.sender];
    }
