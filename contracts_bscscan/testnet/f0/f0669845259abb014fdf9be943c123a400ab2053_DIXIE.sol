...
contract DIXIE is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "DIXIE";                  
    ...
    uint[] public _percentages = [50,50];                                                // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x96cc997DA78ad32E6Fe4566251DFb968556b9971),
        payable(0x96cc997DA78ad32E6Fe4566251DFb968556b9971),                             // Dev wallet
        payable(0xdA022E8053b89f0adF1Ba2885d5666C0B1b009E2)                              // Rewards address wallet
    ];
