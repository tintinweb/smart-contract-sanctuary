...
2) 11% buyback and marketing tax is collected and 4% of it is sent for marketing fund and other % is used to buyback the tokens    
*/
...
contract NFTMARS_TOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe4E44b2C3A9298391524b244C42825e3E2cd2454); // Marketing Address
    ...
    string private _name = "Nftmars";
    string private _symbol = "Mars1";
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > buyBackUpperLimit) {
                ...
                buyBackTokens(balance.mul(_burnPercent).div(100));
            }
        }
    ...
    function isinSwapAndLiquify() public view  returns (bool) {
