...
contract BNBOOB is Context, IERC20, Ownable, specialEvent  {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDfd423fEF030B8657c4E2696454cB61520a09b61); // Marketing Address
    ...
    string private _name = "BNBOOB";
    string private _symbol = "BNBOOB";
    ...
    uint256 public _sellLiquidityFee = 16;
