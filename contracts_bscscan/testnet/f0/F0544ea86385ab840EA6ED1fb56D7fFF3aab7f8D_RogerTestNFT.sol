...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata{
    ...
    // metadata api
    string baseUri = "https://opensea-test.netlify.app/.netlify/functions/api/"; 
...
contract RogerTestNFT is ERC721, Ownable, VerifySignature{
     
    uint256 public totalSupply = 0; // Total Minted Supply
    uint256 private constant totalSale = 25; // total NFTs
    uint256 public reserved = 0; // reserved for selected users
    uint256 public mintPrice = 4 * 10 ** 16;  // minting price 0.04 ETH
    uint256 launchedAt; 

    mapping(address => uint256) public whitelistMinted;

    constructor(uint256 _launchedAt, uint256 _reserved) ERC721("RogerTestNFT", "RTF"){
