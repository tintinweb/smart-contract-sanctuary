...
contract APIDO is ReentrancyGuard, OwnableUpgradeable {
    ...
    function initialize(address _sellingToken, uint256 _rate)
        external
        initializer
    {
        __Ownable_init();
        ...
        status = 0;
        totalRaiseAmount = 0;
        minBuyAmount = 100000000000000000; // 0.1 BNB
        maxBuyAmount = 2 ether;
        startTime = 1632528000;
        endTime = 1632549600;
        rate = 75705;
        admin = msg.sender;
    }
    ...
    modifier onlyWhitelist() {
        require(whitelist[msg.sender], "!admin");
        _;
    }
