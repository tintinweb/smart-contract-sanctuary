...
contract MetaBurn is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x92Ae99DD468b4F3baeB49419b3A2b5b7337938b8); 
    address payable public Wallet_Dev = payable(0xE1fe622FFD9ED05E808b0873B10515B4ebaD1d9C);
    ...
    string private constant _name = "MetaBurn"; 
    ...
    uint256 public Percent_Marketing = 40;
    ...
    constructor () {
        ...
        _owner = 0x1dADe2F1b608156e8dcAc728d36acAdc8D7A7515;
