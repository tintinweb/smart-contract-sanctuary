...
contract BodhiToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xB06121d11d2cc7834430bbbEE0F2EDdDA2Fa8153;   
    ...
    string private _name = "Bodhi Token";
...
function reflectionFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xfc769148a2f56855A018429d629EE00BAaD8209f, 'We can not exclude Uniswap router.');
