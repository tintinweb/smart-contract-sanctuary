...
ADD - LOCK TRADING AND LOCK SETTING OFF!!!!

add wallets that can trade from when locked
add the 



UPDATE WALLETS - ADD SOCIALS - CREATE GUIDE 

NOT USING DXSALE - DOING PRIVATE SALE AND THEN ADDING LP  <--- GUIDE!
...
Total Fees 12%
Max Possible Fees 14% (Hard-Coded)

Owner wallet:
0x616A99E737379792781cC4455CC165e924794Ae1

Marketing wallet:
0x754131Aa0691F49d9a109fAB199a4c9562FFbd96

Reward pool:
0x0C7003D80f09dB0b9a782C24B294c719efB937F7

Authors wallet:
0xEd9Bf1C7389C63C4c54eFa7F0169418E85381058
...
contract BookWorm is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_REWARD_POOL = payable(0x981Ab956D6575b40F49AcBb769342BE91db95828); //4
    address payable public Wallet_AUTHOR = payable(0x2240a100BCb9b846C0F2e0cb1A1E4bf38a3cc46C); //5
    ...
    */
    ...
    string private _name = "Book Worm"; 
    ...
    */
    ...
    PURGE RANDOM TOKENS - People send random tokens to contracts! This function allows you to remove them
