...
contract WoonklyNFT1155 is Ownable{
...
contract WoonklyMultiMint is WoonklyNFT1155{
    string public name;
    string public symbol;

    mapping (uint256 => string) private _tokenURIs;

    constructor(string memory _name, string memory _symbol) WoonklyNFT1155(name, symbol) public{
        name = _name;
        symbol = _symbol;
    }
}