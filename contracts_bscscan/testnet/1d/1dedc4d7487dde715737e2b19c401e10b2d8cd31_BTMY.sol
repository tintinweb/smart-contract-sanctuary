...
/**
   RHYTHM ($MUSIC) - https://rhythm.cash/
...
contract BTMY is Context, BEP20, Ownable {
    ...
    string private constant _name = "ByteMoney";
    string private constant _symbol = "BTMY";
    uint8 private constant _decimals = 9;
    
    uint256 public _reflectionTaxFee = 5;
    ...
    function transfer(address recipient, uint256 amount) public override whenNotFrozen(msg.sender) returns (bool) {
    ...
    // Approve transaction
    function approve(address spender, uint256 amount) public override whenNotFrozen(msg.sender) returns (bool) {
        _approve(_msgSender(), spender, amount);
        return true;
    }
    
    // Transfer Rhythm from sender to recipient
    function transferFrom(address sender, address recipient, uint256 amount) public override whenNotFrozen(msg.sender) returns (bool) {
