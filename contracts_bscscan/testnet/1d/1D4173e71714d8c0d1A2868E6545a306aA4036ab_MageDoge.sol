...
contract MageDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0x325CE22790d0B9ddF9eC987c06EcBF73105A9A75); 
    ...
    string private _name = "Mage Doge";
    string private _symbol = "MGDG";
    ...
    uint256 private minimumTokensBeforeSwap = 150000 * 10**6 * 10**9; 
