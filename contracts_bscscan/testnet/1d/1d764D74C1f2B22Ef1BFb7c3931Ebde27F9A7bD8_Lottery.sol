...
abstract contract Timing {
    uint32 public constant LOTTERY_DURATION =  30 minutes; //12 hours;  // 12 hours
    uint32 public constant SUPER_LOTTERY_DURATION = 1 hours; //24 hours; //24 hours
...
contract Lottery is Timing, Ownable, ILottery{
    ...
    function updateLottery(uint256 _round, address _account, uint256 _amount) internal {
        ...
        buyin[_round][_account] = buyin[_round][_account] + 1;
