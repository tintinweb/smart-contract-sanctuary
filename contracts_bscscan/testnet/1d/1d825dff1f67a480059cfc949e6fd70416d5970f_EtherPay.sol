...
╚════╝    ██╔══╝     ██║   ██╔══██║██╔══╝  ██╔══██╗    ██╔═══╝ ██╔══██║  ╚██╔╝      ╚════╝
          ███████╗   ██║   ██║  ██║███████╗██║  ██║    ██║     ██║  ██║   ██║             
          ╚══════╝   ╚═╝   ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝    ╚═╝     ╚═╝  ╚═╝   ╚═╝             
- Earn Ethereum on every transaction - Hourly Payments - Anti-Whale Mechanism - Anti-Bot Mechanism -
  - Dividends are automatically reflected relative to your holdings in Binance-Peg Ethereum Token -
                     -  Passive ETH income for the first time at BSC -
                     
                      -----------------------------------------------
                     TELEGRAM INFO AND GROUP: https://t.me/etherpaybsc     
                      -----------------------------------------------
*/
...
contract EtherPay is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EtherPay";
    string constant _symbol = "ETHPAY";
