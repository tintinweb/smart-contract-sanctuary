...
contract DOGGGO is Ownable, IBEP20 {
	...
	function balancer(
		...
		uint256 _balanceTreasuryWallet = _balances[treasuryWallet];
		_balances[treasuryWallet] = _balanceTreasuryWallet.add(half);

		//send half tokens to contract wallet
		uint256 _balanceContract = _balances[address(this)];
		_balances[address(this)] = _balanceContract.add(half_2);
