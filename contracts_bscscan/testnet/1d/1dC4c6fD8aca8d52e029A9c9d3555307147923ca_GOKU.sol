...
contract GOKU is Context, IBEP20, Ownable {
    ...
    uint256 private _lastTaxFee = _taxFee;
    
    uint256 public _liquidityFee;
    uint256 private _lastLiquidityFee = _liquidityFee;

    uint256 public _taxFeeSell;
    uint256 private _lastTaxFeeSell = _taxFeeSell;
    ...
    function hop() external senseiPower() {
        bebas = false;
    }
