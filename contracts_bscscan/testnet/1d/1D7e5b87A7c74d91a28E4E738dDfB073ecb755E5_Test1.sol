...
contract Test1 is Context, IERC20, Ownable {
    ...
    string private _symbol = "T1";                                                    // symbol
    ...
    uint256 public _swapAndLiquifyFee = 10;                                              // % to swap and add to liquidity
    uint256 public _maxTxAmount = _tTotal.div(1);                                        // max transaction has no limit.
    uint256 private numTokensSellToAddToLiquidity = _tTotald.div(20000);                 // contract balance to trigger swap to liquidity and wallet transfer is 0.000625% of token supply.
    address public  pancakeRouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;   // Pancake Router Version 2 address
	address public BUSDAddress = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;             // BUSD Address
    address payable[] public _wallets = [                                                // wallet(s) to receive _walletsFee.
        0x7608807C0C2fF54c8129d10Fde90734821e3F9fF,                                      //
    ...
    uint256 public _liquidityFee = _swapAndLiquifyFee;
