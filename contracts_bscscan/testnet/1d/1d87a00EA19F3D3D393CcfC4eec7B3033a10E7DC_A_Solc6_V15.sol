...
contract A_Solc6_V15 is BEP20('ArrgghhV15', 'ADMRSL6V15'){
    using Address for address;
 ...
 //whenMintWrappersOn
    ...
    function contractwhitelistUpdate(address user, bool value) public virtual onlyOwner whenApproveSpendableAddressOn {
        // require(_owner == _msgSender(), "Only owner is allowed to modify blacklist.");
        _contractwhitelist[user] = value;
        emit ContractWhitelistUpdated(user, value);
    }
    
    function MinterRoleUpdate(address user, bool value) public virtual onlyOwner whenApproveSpendableAddressOn {
    ...
    function isMinterRole(address user) public view onlyOwner returns (bool) {
    ...
    // @dev WARNING! Things will break! Only for pausing during partner sites' and/or BSC network-wide hacks.
    function MintHardlock_TurnOn_EMERGENCY_ONLY() public onlyOperator whenMintHardlockOn {
        _stop_mint_hardlock();
    }

     function MintHardlock_TurnOff_ResumeNormal() public onlyOperator whenMintHardlockOff {
   ...
   function Revoke_Rate_Change() public onlyOperator whenRateChangeOn {
        _stop_rate_change();
    }

    function Allow_Rate_Change() public onlyOperator whenRateChangeOff {
        _start_rate_change();
    }
    ...
    function Revoke_Approve_Spendable_Address() public onlyOperator whenApproveSpendableAddressOn {
        _stop_approve_spendable_address();
    }

     function Allow_Approve_Spendable_Address() public onlyOperator whenApproveSpendableAddressOff {
        _start_approve_spendable_address();
    }

    // @dev WARNING! This will absolutely break things! Whitelist every known contract first!
      function Revoke_NonWhitelistedContracts() public onlyOperator whenNoContractsOn {
        _stop_nocontracts();
    }

     function Allow_NonWhitelistedContracts() public onlyOperator whenNoContractsOff {
        _start_nocontracts();
    }
   ...
   /// destroy the contract and reclaim the leftover funds. REMOVE FOR PRODUCTION USE
     ...
     */
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOwner whenRateChangeOn {
     ...
     * Can only be called by the current operator.
     */
    function updateCharityRate(uint16 _charityRate) public onlyOwner whenRateChangeOn {
  ...
  /**
    ...
    */
    function transferCharitytAddress(address newCharityAddress) public whenRateChangeOn onlyOwner {
    ...
    * Comment out this function if you want CHARITY_ADDRESS to be static
    */
    function transferTaxAddress(address newTaxAddress) public whenRateChangeOn onlyOwner {
