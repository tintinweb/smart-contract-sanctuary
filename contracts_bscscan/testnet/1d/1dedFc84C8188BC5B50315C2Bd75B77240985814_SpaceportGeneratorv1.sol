...
contract SpaceportGeneratorv1 is Ownable {
    ...
    constructor() public {
        SPACEPORT_FACTORY = ISpaceportFactory(0x2cfF8750D78990C60E99e50187620F44Fc3B4fcA);
        SPACEPORT_SETTINGS = ISpaceportSettings(0xC6636D5B8E298F258427E2FE266dB83415569f28);
    }
...
contract Spaceportv1 is ReentrancyGuard {
  ...
  constructor(address _spaceportGenerator) public {
    ...
    PLASMASWAP_FACTORY = IPlasmaswapFactory(0xEC12386e2318378335102eBE5c0743c85EdEc6C4);
    WETH = IWETH(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F);
    SPACEPORT_SETTINGS = ISpaceportSettings(0xC6636D5B8E298F258427E2FE266dB83415569f28);
    SPACEPORT_LOCK_FORWARDER = ISpaceportLockForwarder(0x0fD045e31cd850B8464086da18F549f48D4a1e0F);
    PLFI_DEV_ADDRESS = 0xf41da34fe2839959013480AD81D982638840A6D6;
  }
...

{
  ...
  "libraries": {
    "/Users/pavelbulochkin/plasmapay/Plasma-contracts/Spaceport-IDO-LaunchPad/contracts/Spaceport-v1-periphery/contracts/SpaceportHelper.sol": {
      "SpaceportHelper": "0xCA00D4E3DcE108D10a2B003B0dA7614DAa6496f9"
    }
  },
  "outputSelection": {
    "*": {
