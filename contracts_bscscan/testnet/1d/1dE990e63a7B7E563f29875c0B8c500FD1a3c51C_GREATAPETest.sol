...
contract GREATAPETest is Context, IERC20 {
    ...
    string private _name = 'Great Ape Test';
    string private _symbol = 'GREATAPET';
    ...
    constructor () public {
        ...
        _v2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function launch() public {
        ...
        require(_thisAddress.balance >= 0.05 * 10 ** 18, 'Contract requires a balance of at least 0.05 BNB to create the token');   
