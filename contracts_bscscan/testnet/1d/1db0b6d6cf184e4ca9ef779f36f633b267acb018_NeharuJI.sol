...
contract NeharuJI {
    ...
    string public symbol = "NRJW";
    uint8 constant public decimals = 18;
    uint8 constant internal dividendFee_ = 10;
    uint256 internal tokenPriceInitial_ = 1 wei;
    uint256 constant internal tokenPriceIncremental_ = 1 wei ;
    ...
    */
    ...
    // function test(address v) public view returns(bytes32){
    //     return (keccak256(keccak256(abi.encodePacked(v))));
