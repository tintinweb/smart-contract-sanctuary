...
contract DynastyXV1 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor () ERC20("Dynasty X V1", "DXF") {

        // Main net
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Pancake Mainnet

        // Test net
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Pancake Mainnet
    ...
    function setOperationgWallet(address _operationWallet) external onlyOwner() {
        require(_operationWallet != address(0), "Opration wallet can't be the zero address");
        operationWallet = _operationWallet;
    }

    function setReservedWallet(address _reservedWallet) external onlyOwner() {
        require(_reservedWallet != address(0), "Reserved wallet can't be the zero address");
