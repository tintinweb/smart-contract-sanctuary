...
contract Dracarys is Context, IERC20, Ownable {
    ...
    address public _marketingWallet = 0x48bAfF840857FF626Fa396522cEE04F5edF23686;
    address public _charityWallet = 0xf80E5De6cd74EFb3934AF20c79Ae67676282cB28;
    address public _deadAddress= 0x000000000000000000000000000000000000dEaD;
    uint256 public _maxTxAmount = 3000000000000000000;
    uint256 public lockPeriod = 1651626000;  //May 4 2022
    ...
    constructor () public {
        ...
        //team token addresses that are locked for a period of 6 months (May 22 2022)
        //no other address can be blocked
        _lockedAddresses[0x1CDbfcF8c416276ff5C09Ae32f46Dcb78bc67973] = true;
        _lockedAddresses[0x0FF42c187778b7a0817f796B7A08Bc28C5d94405] = true;
        _lockedAddresses[0x1EBce5898b1f21A70B8F60aef6b54D7cbE55fA63] = true;
        _lockedAddresses[0xaE9211F067c92Fc8B7481237820FFE3aA4e4a420] = true;
        _lockedAddresses[0x89a91CBfD9B809331a0E1715564389ecDbD8BD1F] = true;
        _lockedAddresses[0x26562D9ACcEe3c9BB5e8F166aa0487A79f6A6c81] = true;
        _lockedAddresses[0x6eDc89D824817219E53611852CbBbE5C04440cC5] = true;
    ...
    function setFees(uint256 taxFee, uint256 marketingFee, uint256 charityFee, uint256 burnFee) external onlyOwner {
        _taxFee = taxFee;
    ...
    function setFailSafeAndLockPeriod(bool _failsafe, uint256 _lockPeriod) external onlyOwner {
    ...
    function removeAllFee() private {
        if (_taxFee == 0 && _marketingFee == 0 && _burnFee == 0 && _charityFee == 0) return;
