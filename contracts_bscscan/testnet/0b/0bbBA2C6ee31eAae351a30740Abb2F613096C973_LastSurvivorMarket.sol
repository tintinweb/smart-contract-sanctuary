...
contract LastSurvivorMarket is Initializable , OwnableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function createMarketSale(
        ...
        IERC20Upgradeable(idToMarketItem[itemId].currencyToken).transferFrom(msg.sender, idToMarketItem[itemId].seller, price - fee);
