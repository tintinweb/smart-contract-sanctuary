...
contract BlindBoxSale is ERC1155Holder, Ownable {
   ...
   function _transferNftToAuctionContract(
    ...
    modifier batchWithinLimits(uint256 _batchTokenIdsLength) {
        require(
            _batchTokenIdsLength > 0 && _batchTokenIdsLength <= 1000,
   ...
   function _resetAuction(address _nftContractAddress, uint256 _tokenId,address __nftSeller)
        internal
    {   
        nftContractAuctions[_nftContractAddress][_tokenId][__nftSeller].buyNowPrice = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][__nftSeller].amount = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][__nftSeller].auctionEnd = 0;
        nftContractAuctions[_nftContractAddress][_tokenId][__nftSeller].nftSeller = address( 0);
        nftContractAuctions[_nftContractAddress][_tokenId][__nftSeller].whitelistedBuyer = address(0);
        nftContractAuctions[_nftContractAddress][_tokenId][__nftSeller].ERC20Token = address( 0 );
        nftContractAuctions[_nftContractAddress][_tokenId][__nftSeller].recipient = address( 0 );
    }
