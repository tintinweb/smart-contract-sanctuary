...
contract PixelJay is ERC721URIStorage, ERC721Enumerable, SecurityBase
{
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    string public baseTokenURI;

    constructor() ERC721("PixelJay", "PJAY") {
    }

    function safeMintPJAY(address to) public onlyMinter returns (uint256) {
        _tokenIds.increment();
    ...
    function batchMintPJAY(address to, uint count) public onlyMinter returns (uint) {
    ...
    function batchTransfer(address[14] memory addressList, uint256[14] memory tokenIds) public onlyMinter  {
        for (uint i = 0; i < 14; i++) {
    ...
    function _burn(uint256 tokenId) internal whenNotPaused onlyMinter override(ERC721, ERC721URIStorage) {
        super._burn(tokenId);
    }
