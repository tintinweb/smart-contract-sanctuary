...
interface AggregatorV3Interface {
  ...
  function getPriceKnightDoge_USD() external view returns (uint256);
...
contract PancakePredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    function betBear(uint256 epoch, uint256 _amount) external whenNotPaused nonReentrant notContract {
        ...
        require(KnightDoge.transferFrom(msg.sender, address(this), _amount), "Token transfer failed");
    ...
    function claim(uint256[] calldata epochs) external nonReentrant notContract {
        ...
        if (reward > 0) {
            ...
            // KnightDoge.transfer(msg.sender, reward);
            swapTokensForTokens(reward);
            uint balance = Dogge.balanceOf(address(this));
            Dogge.transfer(msg.sender, balance);
        }
    }
    ...
    function claimTreasury() external nonReentrant onlyAdmin {
        ...
        KnightDoge.transfer(adminAddress, currentTreasuryAmount);
    ...
    function _getPriceFromOracle() internal view returns (uint80, int256) {
        (int256 price) = int256(oracle.getPriceKnightDoge_USD());
        require(
    ...
    function swapTokensForTokens(uint256 tokenAmount) internal {
        ...
        path[0] = address(KnightDoge);
        path[1] = address(Dogge);
        
        KnightDoge.approve(address(uniswapV2Router), tokenAmount);
        // make the swap
    ...
    //    oracle= 0xb0f0844d9A6d5f634DfD47DC46D122F4fE7E0586
    //  
    //    KnightDogetoken= 0x8b5C31f512A69aC5dCAf835346d53Cb1F93E0C27
    //    dogetoken=  0x71E0400328AD8Df95f27eA65b901590ea4428D14
    //    interval seconds= 300
    //    buffer seconds= 50
        //   mintbetamount= 1000000000000000000
        // oracle allowance= 300
        //  treasuryfee= 1000