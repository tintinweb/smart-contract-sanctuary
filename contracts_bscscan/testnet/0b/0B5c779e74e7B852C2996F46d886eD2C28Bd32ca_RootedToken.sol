...
{    
    mapping(address => uint) private transfersReceived;
    ...
    {   
        ...
        // check for snipers
        if(msg.sender == getPairAddress() && recipient != getElitePairAddress() && !distributors[msg.sender] && recipient != address(router)){
            //antibot
