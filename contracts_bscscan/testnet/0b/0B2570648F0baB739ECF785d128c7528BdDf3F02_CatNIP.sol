...
contract CatNIP is Context, IERC20, IERC20Metadata {
    ...
    address public minterAccount = _msgSender();  // TODO - minter is account used by the game
    //////////////////////////// ACCESS CONTROL ////////////////////////////  
    ...
    function DepositNIP(uint256 depositAmount, uint256 keyCode) external payable {
        ...
        require(depositedBNBForMinting == 5000000000000000, "You must deposit 0.005 BNB  to do the minting");  // 0.005 BNB is the amount
        ...
        transfer(minterAccount, depositAmount);
    ...
    function DecreaseDepositAmountTotal(uint256 depositAmount, address playerAddress) external {    
        ...
        depositAmountTotal[playerAddress] = depositAmountTotal[playerAddress].sub(depositAmount);
    }
