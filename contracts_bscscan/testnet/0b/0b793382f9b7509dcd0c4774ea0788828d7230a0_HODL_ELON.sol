...
set up onlyAuthorised modifier - so that a contract in futre can exclude people from rewards

update dev wallet

change the way the rewards work so it's the other way around! And all start as false 
...
contract HODL_ELON is Context, IERC20, Ownable { 
    ...
    */
    ...
    // The meme tokens
    IERC20 HODL_F = IERC20(0xd4294c0f64eBA74089315D4b0278698f7181037e);
    IERC20 HODL_B = IERC20(0x9973885595Cf0C17accD7E46f96dbd937A7E627C);
    IERC20 HODL_G = IERC20(0x9973885595Cf0C17accD7E46f96dbd937A7E627C);
    ...
    */
    ...
    function _transfer(
        ...
        if (launchPhase){
                ...
                // Buying in 1st block - probably a snipe bot!
                if(TradeOpen){


                        // Block snipes for 2 Blocks
                        if (launchBlock + 30 > block.number){
