...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Binance Smart Chain Girl Moon";
    string public constant TOKEN_SYMBOL = "BSCGIRLMOON";
...
contract BSCGIRLMOON is Consts, FreezableMintableToken, BurnableToken, Pausable
