...
contract BNB_infinity {
    ...
    */
    ...
    /**
     * Converts all incoming bnb to tokens for the caller, and passes down the referral address (if any)
     */
        ...
        returns(bool)
    {
        ...
        uint256 _dividends = tokensTobnb_(_tokenFee);
