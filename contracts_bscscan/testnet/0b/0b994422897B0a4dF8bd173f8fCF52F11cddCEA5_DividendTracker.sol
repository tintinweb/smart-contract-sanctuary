...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x32Bcbd0919bB5DAA9634201468Ce3E8e2fdF5Db5)); // BUSD - 0
      rewardTokens.push(address(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06)); // LINK - 1
      
      // Mainnet
      
      /*
      rewardTokens.push(address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8)); // ETH - 0
      rewardTokens.push(address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47)); // ADA - 1
      rewardTokens.push(address(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE)); // XRP - 2
      rewardTokens.push(address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82)); // CAKE - 3
      rewardTokens.push(address(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402)); // DOT - 4
      */
  ...
  function _withdrawDividendOfUser(address payable user, address _rewardToken) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
      ...
      if(!success) {
        withdrawnDividends[_rewardToken][user] = withdrawnDividends[_rewardToken][user].sub(_withdrawableDividend);
        return 0;
      }
...
contract FesBNBStaking is Ownable {
    
    IERC20 public immutable fesBNBToken; // update to fesBNB token address
    ...
    constructor() {
        fesBNBToken = IERC20(address(0x274643375BD85Ad14Bf740DaE0fE1e5Ad859a542)); // set to FesBNB contract
    ...
    function stake(uint256 amount) external nonReentrant {
        require(fesBNBToken.allowance(msg.sender, address(this)) >= amount, "Not enough allowance to transfer tokens to contract");
        require(amount > 0, "Must be greater than 0");
        uint256 initialBalance = fesBNBToken.balanceOf(address(this));
        fesBNBToken.transferFrom(msg.sender, address(this), amount);
        uint256 newBalance = fesBNBToken.balanceOf(address(this)) - initialBalance;
    ...
    function unstake(uint256 amount) external nonReentrant {
        ...
        fesBNBToken.transfer(msg.sender, amount);
