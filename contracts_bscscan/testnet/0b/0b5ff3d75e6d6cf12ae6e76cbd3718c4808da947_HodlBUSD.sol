...
contract HodlBUSD is IBEP20, HBusdAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "HodlBUSD";
    string constant _symbol = "HBUSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10 * 10 ** 15 * (10 ** _decimals); 
    ...
    constructor () HBusdAuth(msg.sender) {
