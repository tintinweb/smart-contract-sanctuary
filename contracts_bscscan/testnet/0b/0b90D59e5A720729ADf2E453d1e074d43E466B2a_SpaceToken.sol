...
contract SpaceToken is Context, IERC20, Ownable {
    ...
    string private _name = "Space Token";
    string private _symbol = "SPACE";
    uint8 private _decimals = 9;
    
    uint256 public _distributionFee = 5;
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        uint256 tCharity = tOtherFee.mul(_charityFee).div(otherFee);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        uint256 tOtherFee = tLiquidity.add(tCharity);
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        _tTotal = _tTotal.add(tLiquidity);
    ...
    function removeAllFee() private {
        if(_distributionFee == 0 && _liquidityFee == 0 && _charityFee == 0) return;
    ...
    function _transfer(
        ...
        //transfer amount, it will take distribution, charity and liquidity fee
    ...
    function _getOtherFee() private view returns (uint256) {
        uint256  otherFee = _previousLiquidityFee.add(_previousCharityFee);
        return otherFee;
    }
