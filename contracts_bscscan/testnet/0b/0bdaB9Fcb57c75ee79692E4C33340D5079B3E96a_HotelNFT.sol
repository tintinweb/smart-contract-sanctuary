...
contract HotelNFT is ERC721Enumerable {
  ...
  constructor(address marketplaceAddress, string memory baseTokenURI) ERC721("Hotel NFT", "HNFT") {
    contractAddress = marketplaceAddress;
    _baseTokenURI = _baseTokenURI = baseTokenURI;
  }
