...
contract MyRevengeCat is Ownable, ReentrancyGuard {
    ...
    address payable public distributeReward;
    ...
    constructor(address _LoveToken, address payable _distributeReward) Ownable() {
    ...
    function feed() public payable nonReentrant {
        ...
        address devAddr = 0x408ECB06EF97705Afb02646ae1E5537F370a6bfB;
    ...
    function clean() public payable nonReentrant {
        ...
        distributeReward.transfer(msg.value);
