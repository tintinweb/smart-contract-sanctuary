...
contract Ottomanempirev3 is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function Padisah(uint256 tokenId) public view returns (string memory) {
    ...
    function getWaist(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "W",  waistArmor);
    }
    ...
    constructor() ERC721("OttomanEmpirev3", "OTEM") Ownable() {}
}
