...
/**
 * @dev Extension of BEP20 to support Compound's voting and delegation. This version exactly matches Compound's
 * interface, with the drawback of only supporting supply up to (2^96^ - 1).
 *
 * NOTE: You should use this contract if you need exact compatibility with COMP (for example in order to use your token
 * with Governor Alpha or Bravo) and if you are sure the supply cap of 2^96^ is enough for you. Otherwise, use the
 * {BEP20Votes} variant of this module.
 *
 * This extension keeps a history (checkpoints) of each account's vote power. Vote power can be delegated either
 * by calling the {delegate} function directly, or by providing a signature to be used with {delegateBySig}. Voting
 ...
 * _Available since v4.2._
 */
abstract contract BEP20VotesComp is BEP20Votes {
    /**
...
contract ISLAMI is BEP20, Ownable {
    ...
    BEP20("ISALMICOIN", "ISLAMI") {
        ...
        _mint(msg.sender, 8979999990 *10** decimals());                                                   //ISLAMICOIN contract creator (Coins reserved for different Liquidity providers and future projects)
     ...
     // No access control mechanism (for minting/pausing) and hence no governance
        ...
        Charity = 5; // Devided by 2 in Transfere function to represent Zakkat persentage 2.5%
