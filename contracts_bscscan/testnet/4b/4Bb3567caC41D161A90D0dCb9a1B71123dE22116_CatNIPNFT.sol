...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    //////////////////////////// ACCESS CONTROL ////////////////////////////  
    address public directorAccount;     // TODO - MULTISIG!!!
    //////////////////////////// ACCESS CONTROL ////////////////////////////  
    ...
    constructor() {
        ...
        directorAccount = _msgSender();     // CHANGEIT - get the right director account
    ...
    //////////////////////////// BURN FUNCTIONS ////////////////////////////
    // destroys tokenId, and says that it is transferred to the zero address
    function _burn(uint256 tokenId) internal virtual {

        // TODO - make it send to the DEAD address instead, actually update the ownership, you may not even need to have this function.
        address owner = ownerOf(tokenId);
    ...
    function MintCatNIPNFT(address minterAddress, string memory tokenURIstring, uint256 codeForCatMechanism) public returns (uint256) {
