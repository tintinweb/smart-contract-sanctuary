...
contract TekilaShiba is Ownable, StakingReward {
  ...
  */
    ...
    IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02( 0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//0x10ED43C718714eb63d5aA57B78B54704E256024E
     ...
     */
      function calculateStakeReward(Stake memory _current_stake) internal view returns(uint256){
        //  1 month second: 24 hour * 3600 * 30 = 2592000 second
          uint256 stakingPeriod = (block.timestamp - _current_stake.since) / 2592000;
          uint256 monthReward = 0;
          uint256 yearReward = 0;
          monthReward = (stakingPeriod * _current_stake.amount) * (rewardPerMonth / 1000);// for clearning: 0.4%
          
          if(stakingPeriod >= 12) {
            yearReward = ((stakingPeriod / 12) * _current_stake.amount) * (rewardPerYear / 1000); // yearly 8%;
          }
