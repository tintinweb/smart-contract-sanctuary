...
//Invisible Inu Contract /////////////

contract INVISIBLEINU is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'InvisibleInu';
    string private constant _symbol = 'INVISINU';
    ...
    //DevWallets
    address public TeamWallet=payable(0x2e4db97A07aBD4Eee1c7f9276b962CAf8560BEB0);
    address public walletTwo=payable(0xcE03Cc2fbc65bBA6a7A405b5B167fb1ea2797380);
    //TestNet
	...
	uint256 private antiWhale = 12000000 * 10**_decimals;
