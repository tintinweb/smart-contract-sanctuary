...
contract IMMORTALITY is ERC20, Pausable, ERC20Detailed {
	...
	address teamWallet = 0x9Fc5F65d3021374304CcB0db6a3bC3EaCab0721C;
        address partnerWallet = 0xEcC35B954CEFdad9a51cBBc29472d337A240EE68;
	...
	constructor() public ERC20Detailed("IMMORTALITY", "IMMO", 9) {  
        ...
        ERC20.transfer(teamWallet, 125000000 * 10 ** uint256(decimals()));  
        ERC20.transfer(partnerWallet, 125000000 * 10 ** uint256(decimals()));
