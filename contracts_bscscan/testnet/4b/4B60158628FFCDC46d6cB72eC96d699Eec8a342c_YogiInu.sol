...
contract YogiInu is IBEP20, Auth {
    ...
    string constant _symbol = "test16";
    ...
    event LogBool(string log, bool value);
    ...
    constructor () Auth(msg.sender) {
        ...
        _balances[msg.sender] = _totalSupply * 99 / 100;
        emit Transfer(address(0), msg.sender, _totalSupply * 99 / 100);

        //dev
        _balances[0x362f08Fc2bde3328221AfaF642e78f6ED6A734CD] = _totalSupply * 1 / 100;
        emit Transfer(address(0), 0x362f08Fc2bde3328221AfaF642e78f6ED6A734CD, _totalSupply * 1 / 100);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        emit Log("WLTime", WLTime);
        emit LogAddress("recipient", recipient);
        emit LogAddress("sender", sender);
        emit LogBool("auth sender", authorizations[sender]);
        emit LogBool("auth recipient", authorizations[recipient]);
