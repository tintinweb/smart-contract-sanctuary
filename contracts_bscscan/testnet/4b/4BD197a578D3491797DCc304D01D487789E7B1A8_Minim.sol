...
/**
     THIS SC JUST FOR BSC MAINNET TEST... 
 DONT BUY THIS TOKEN!!!                                                    
...
contract Minim is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x99768aC5F69a88561bd3A148Bbd383303043Da8F); // Marketing Address
    ...
    string private _name = "MINIM LAGI";
