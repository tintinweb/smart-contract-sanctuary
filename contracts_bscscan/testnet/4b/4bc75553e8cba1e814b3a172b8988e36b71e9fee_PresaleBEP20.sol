...
contract PresaleBEP20 is Ownable {
    ...
    */
    ...
    function deposit() public payable {
        ...
        balanceMap[msg.sender].add(tokenAmount);
    ...
    function withdraw()public{
        ...
        token.mint(msg.sender, balanceMap[msg.sender]);
    }
    
    function getBuyedTokenBalance(address buyerAddress) public view returns (uint256){
        return balanceMap[buyerAddress];
    }
