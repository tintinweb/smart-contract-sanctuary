...
contract FlokiAustralia is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Australia";
    ...
    uint256 public _maxWalletToken = 400000000000000 * (10**18); // 2% / 4% after burn 
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        _maxWalletToken = _tTotal.mul(maxTxPercent).div(
            10**2
        );
    }
