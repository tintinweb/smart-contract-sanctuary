...
import "../lib/XBEP20.sol";

contract VRP is XBEP20 {

    constructor() XBEP20("VRP token", "VRP", 18, 1000000000000000*(10**18), 0) {
    }
 ...
 */
contract XBEP20 is BEP20Capped, BEP20Mintable, BEP20Burnable, BEP20Fee {
     ...
     * `amount`.
     */
    function transferFrom(address sender, address recipient, uint256 amount) public override(BEP20, BEP20Fee) returns (bool) {
     ...
     */
    function transfer(address recipient, uint256 amount) public override(BEP20, BEP20Fee) returns (bool) {
