...
contract DeflationaryToken is Context, IBEP20, Ownable {
        ...
        ) Ownable(ownerAddress)
    {
        ...
        _tTotal = _tokenSupply * 10 ** _tokenDecimals;
    ...
    function totalFeePerTx(uint256 tAmount) internal view returns(uint256) {
        uint256 percentage = tAmount.mul(_holderFee.add(_liquidityFee)).div(100);
        return percentage;
    }
