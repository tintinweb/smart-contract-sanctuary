...
contract NftDexV4 is ERC721Full, ERC721MetadataMintable, Ownable {
 ...
 // events
  ...
  function getResevers() public view returns(uint256, uint256, uint256, uint256, uint256, uint256){
     uint256 bnbLpReserve;
            uint256 busdLpReserve;
            uint256 bnbTime;
            (bnbLpReserve, busdLpReserve, bnbTime) = LPBNB.getResevers();
            ...
            uint256 aliaTime;
            (aliaPanReserve, bnbPanReserve, aliaTime) = LPAlia.getResevers();
            return (bnbLpReserve, busdLpReserve, bnbTime, aliaPanReserve, bnbPanReserve, aliaTime );
  }
}