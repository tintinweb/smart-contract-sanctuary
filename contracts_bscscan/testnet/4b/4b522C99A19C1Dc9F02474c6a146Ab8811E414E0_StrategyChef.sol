...
contract StrategyChef is ReentrancyGuard, Pausable {
    // Maximises yields in pancakeswap

    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    bool public immutable isCAKEStaking; // only for staking CAKE using pancakeswap's native CAKE staking contract.
    bool public immutable isStaking; // if delegate farming
    ...
    constructor(
        ...
        //        transferOwnership(_MasterChefAddress);
    }
