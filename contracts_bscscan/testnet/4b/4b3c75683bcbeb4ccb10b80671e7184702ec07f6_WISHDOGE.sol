...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            {
                uint256 extraFeeN = extraFee/2;
                swapAndSendBNBToBB(extraFeeN); // swap the marketing fee on second
            }
        }
    ...
    function swapAndSendBNBToBB(uint256 tokenAmount) private {
        swapTokensForBnb(tokenAmount, BBWallet);
    }
