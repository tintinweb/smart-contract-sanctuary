...
contract Team is AccessControl {
    ...
    uint256 public vestingPeriod = 63072000; // 730 days
    uint256 public lockPeriod = 1800 ; // 31536000; // 365 days
    uint256 public lockAmount = 22500000000000000000000000; // 17,000,000 DEB
