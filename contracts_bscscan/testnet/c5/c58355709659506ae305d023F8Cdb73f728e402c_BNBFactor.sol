...
contract BNBFactor {
	...
	constructor(IERC20 _shiva, address payable wallet, address payable dev, address router) {
		shiva = _shiva;
        ...
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).getPair(address(shiva), uniswapV2Router.WETH());
