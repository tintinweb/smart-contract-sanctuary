...
contract V5_CR is Context, IERC20, Ownable {
    ...
    string private _name = "V5_CR";
    string private _symbol = "V5_CR";
    ...
    uint256 public _convertToBNBFee = 9;
    uint256 private _previousBNBFee = _convertToBNBFee;
    
    uint256 public _maxTxAmount = 1 * 10**14 * 10**18;
     ...
     *
     * NOTE: LP tokens will be sent to the ower address.
     * 
     */
