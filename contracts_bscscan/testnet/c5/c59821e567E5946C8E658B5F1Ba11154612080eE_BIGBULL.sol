...
contract BIGBULL is IERC20Metadata, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address internal deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xEAcDF93e9Fd9f4E921043D67032cc13f77f01FC8;
    address public presaleAddress = address(0);
    
    string constant _name = "The Big Bull";
    ...
    uint256 public rfiFee = 4;
    uint256 public marketingFee = 1;
    
    uint256 public totalFees = rfiFee.add(liquidityFee).add(marketingFee);
    ...
    function calcTotalFees() private {
        totalFees = rfiFee.add(liquidityFee).add(marketingFee);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if( canSwap && !swapping && swapEnabled && recipient == pair) {
            swapping = true;
