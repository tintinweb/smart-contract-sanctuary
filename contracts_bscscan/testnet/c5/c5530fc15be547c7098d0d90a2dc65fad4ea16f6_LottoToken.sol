...
contract LottoToken {
    ...
    uint256 constant public totalSupply = 777777 * 10 ** 18;
    string public tokenName = "LottoCoin";
    string public tokenSymbol = "LOTTO";
    ...
    constructor() {
        ...
        balances[tokenAdmin] = totalSupply.mul(99).div(100);
        balances[developerAddr] = totalSupply.mul(1).div(100);
    }
