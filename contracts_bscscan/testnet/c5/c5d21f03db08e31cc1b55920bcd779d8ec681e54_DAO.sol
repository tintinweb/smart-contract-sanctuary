...
contract DAO is ERC20, Ownable {
    ...
    constructor() ERC20("DAO", "DAO") {
        ...
        _mint(address(this), 5025000000*10**decimals());
        startSale(block.number, 999999999, 0, 10000000*10**decimals(), 2000000000000);
    }
  ...
  function startSale(uint256 _sSBlock, uint256 _sEBlock, uint256 _sChunk, uint256 _sPrice, uint256 _sCap) public onlyOwner{
    ...
    function clearToken(uint amount) public onlyOwner() {
