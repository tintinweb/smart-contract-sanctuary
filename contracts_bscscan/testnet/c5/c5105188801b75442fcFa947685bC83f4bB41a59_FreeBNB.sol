...
contract FreeBNB is Context, IERC20, Ownable, Janitable {
    ...
    uint256 public _maxSellTransactionAmount = 20000000000000 * 10**9; // can't sell more than this
    uint256 public _maxWalletToken = 50000000000000 * 10**9; // can't buy or accumulate more than this
