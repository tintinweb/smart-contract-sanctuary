...
contract CharacterNFT is ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable{
  ...
  function upStar(address _owner,uint256 _nftId) internal  {
  ...
  function upRank(address _owner,uint256 _mainNftId, uint256 _materialNftId) internal  {
...
function getCharacterPublic(address _owner, uint256 _id) public view returns (
  ...
  function changeVersionV2(uint256 _version) public  {
    version=_version;
  }
