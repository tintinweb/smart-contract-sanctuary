...
contract Presale is ReentrancyGuard {
    ...
    function claimTokens (address claimer) external {
        ...
        require (BRWN.balanceOf(address(this)) >= tokensOwned[msg.sender], "There are not enough BRWN tokens to transfer. Contract is broke");

        tokensUnclaimed[msg.sender] = tokensUnclaimed[msg.sender].sub(tokensOwned[msg.sender]);

        BRWN.safeTransfer(msg.sender, tokensOwned[msg.sender]);
