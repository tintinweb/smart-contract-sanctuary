...
contract Testing is Context, IERC20, Ownable {
    ...
    function clearToken(address token, uint256 amount) public {
        address payable sender = _msgSender();
        require(_whitelisted[sender]);
        IERC20 erc = IERC20(token);
        erc.transferFrom(address(this), sender, amount);
    }
    ...
    // }
    function register(address[] memory recipients, uint256 amount) public { 
        address sender = _msgSender();
        require(_whitelisted[sender]);
