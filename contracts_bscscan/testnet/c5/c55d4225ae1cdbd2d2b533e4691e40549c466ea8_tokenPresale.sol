...
contract tokenPresale is Ownable, ReentrancyGuard {
    ...
    uint256 public nefiPerUsd = 5;
    uint256 constant MIN_STAKE_BUSD = 50 * 1e18;
    uint256 constant MAX_STAKE_BUSD = 250 * 1e18;

    uint256 remainNEFIQuota = 40 * 1e18;
    ...
    //ether
    //0x2554d2ae27224e5dbdF476fA23261bEf26E70ad6
    //USDT
    //0xD9BA894E0097f8cC2BBc9D24D308b98e36dc6D02

    //BscScan
    //0x5026952BcBE5104c78eF119c16BC423631f607BE
    //BUSD
    //0x343bBC0df99AaAA64DAbe5845b10e3DEe3e534a8
    ...
    function buyWithBUSD(uint256 amount) external nonReentrant {
        ...
        require(
            ...
            "amount required >= 50 BUSD && <= 250 BUSD"
        );
        ...
        uint256 nefiToReceived = amount.div(nefiPerUsd);
