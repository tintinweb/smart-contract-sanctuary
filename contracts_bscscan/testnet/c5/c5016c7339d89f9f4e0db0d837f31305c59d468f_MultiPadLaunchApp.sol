    ...
    */
    ...
    modifier validateClaim(address _userAddress, uint256 _lockNumber)
    {
        ...
        if(_lockNumber == 2){    // 1 month
            require(block.timestamp > saleEndTime + _claimTime1 +  300  && reEntrance[_userAddress][_lockNumber] != true , "Insufficient Unlocked Tokens");
        }
        _;
    }
    ...
    function getClaimDates() view external returns(uint256 _d1, uint256 _d2, uint256 _d3, uint256 _d4, uint256 _d5){
        _d1 = saleEndTime + _claimTime1;   // After 1 Hours of end sale
        _d2 = saleEndTime + _claimTime1 +  300;
        _d3 = 0;
        _d4 = 0;
        _d5 = 0;
