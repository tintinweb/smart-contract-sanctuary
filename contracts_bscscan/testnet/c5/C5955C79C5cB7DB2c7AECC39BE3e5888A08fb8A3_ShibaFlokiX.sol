...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  function changeToken1(address _token) public onlyOwner {
      rewardTokens[0] = _token;
  }
    function changeToken2(address _token) public onlyOwner {
      rewardTokens[1] = _token;
  }
...
contract ShibaFlokiX is ERC20, Ownable {
    ...
    constructor() ERC20("ShibaFlokiX", "SFX"){
        ...
        devWallet = address(0xD9240Ff31Cf0Df2e2a00574D52a0Dd76577Ad484);
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // router
    ...
    function updateToken1Distributor(address _token) public onlyOwner {
        dividendTracker.changeToken1(_token);
    }
     function updateToken2Distributor(address _token) public onlyOwner {
        dividendTracker.changeToken2(_token);
    }
    ...
    function updateFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _buybackFee, uint256 _devFee, uint256 _feeDivisor) external onlyOwner {
        ...
        totalFees = marketingFee + rewardsFee + liquidityFee + buybackFee + devFee;
        if(_feeDivisor == 100){
