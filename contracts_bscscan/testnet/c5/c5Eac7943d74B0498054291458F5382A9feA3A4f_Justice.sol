...
#JUSTICE features:
Max transaction amount: 0.1% of max supply	
Transaction fees: 	2%
	Redistribution:	1%
	Burn:			1%
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Justice";
    ...
    uint256 internal constant TOTAL_SUPPLY = 200000000 * ZEROES;
     ...
     */
    uint256 public maxTransactionAmount = TOTAL_SUPPLY / 1000; // 0.1% of the total supply
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
  ...
  function setmaxTransactionAmount(uint256 TransactionLimit) external onlyManager() {
