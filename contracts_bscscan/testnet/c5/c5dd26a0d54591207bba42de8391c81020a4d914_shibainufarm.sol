 ...
 *Submitted for verification at BscScan.com on 2022-01-11
 /**
 * No Bullshit No Honeypot No Rug No Scam - Liquidity would be locked & Extend 
 * We are a refelection token that gives Shiba Inu - all would be transparent
 * BUY  TAX: 6% refelection 4% marketing 2% Liquidity 
 * SELL TAX: 8% refelection 4% marketing 2% Liquidity 
 * SELLER PAYS: 2% EXTRA
*/
...
/**
 * Standard shibainufarm, stripped down to just add/sub/mul/div
 */
library shibainufarm {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "shibainufarm: addition overflow");

        return c;
    }
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "shibainufarm: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "shibainufarm: multiplication overflow");

        return c;
    }
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "shibainufarm: division by zero");
    }
...
contract DividendDistributor is IDividendDistributor {
    using shibainufarm for uint256;
    ...
    uint256 public minDistribution = 1 * (10 ** 18); // 1 SHIB minimum auto send
...
contract ShibaINUfarm is IBEP20, Auth {
    using shibainufarm for uint256;
    ...
    string constant _name = "Shiba Inu Farm";
    string constant _symbol = "shibainufarm";
    ...
    address public marketingFeeReceiver = 0x4c9932A8BD02d2AC6804Ac11985526F860a7bE1E;
    address public buybackFeeReceiver = 0x4c9932A8BD02d2AC6804Ac11985526F860a7bE1E;
