...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    name = "NBIT Token";
    decimals = 18;
    _totalSupply =  7800000*10** uint(decimals);
    balances[owner] = 4800000*10** uint(decimals);
    balances[address(this)] = 3000000*10** uint(decimals);
    emit Transfer(address(0), owner, 4800000*10** uint(decimals));
    emit Transfer(address(0), address(this), 3000000*10** uint(decimals)); 
  }
...
contract NBIT is TokenBEP20 {
  ...
  constructor () public {
      ...
      startAirdrop(block.number,99999999, 1*10** uint(decimals), 20000000);
      startSale(block.number, 99999999, 0, 10000*10** uint(decimals), 300000000);
}
