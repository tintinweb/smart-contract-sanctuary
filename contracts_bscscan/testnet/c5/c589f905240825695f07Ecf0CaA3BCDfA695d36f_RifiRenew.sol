...
contract RifiRenew is Signed, Ownable, Pausable {
    ...
    function renew(uint256 id, bytes memory adminSignedData,uint256 fee) external whenNotPaused {
        ...
        address signer = getSigner(
            keccak256(
                abi.encode(address(this), this.renew.selector, id, fee, nonces[msg.sender]++)
            ), v, r, s);
        require(isSigner[signer], "Forbidden");

        nftPlayer.updatePlayerMatch(id, 0);
    }
