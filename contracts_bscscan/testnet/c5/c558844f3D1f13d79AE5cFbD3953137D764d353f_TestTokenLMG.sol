...
contract TestTokenLMG is Context, IERC20, Ownable {
    ...
    uint256 public prevLiqFee = maxLiqFee;
    uint256 public prevTaxFee = maxTaxFee;
    ...
    string private _name = 'Lumi Ghost';
    string private _symbol = 'LUMI';
    ...
    constructor () public {
        ...
        numTokensSellToAddToLiquidity = _maxTxAmount.mul(1).div(1000);
