...
contract simpleStakeBNB {
        ...
        //need redo
        function checkStake(string calldata _tokenAddr, address _stakerAddr) public view returns( address stakerAddress , address reffAddress ,uint256 startStake ,uint256 initAmmountSTK ,uint256 lastRewardSTK ,uint256 nowBlock ,uint256 estimatedReward){
        ...
        function stakeToken(string calldata _tokenAddr, uint256 stakedAmmount ,address payable reff) public payable  {
        ...
        function claimReward(string calldata  _tokenAddr) public payable  {
        ...
        function unStake(string calldata  _tokenAddr) public payable  {
