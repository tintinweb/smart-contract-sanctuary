...
contract dotDXCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x75FBD1d805457C8464B7a9eB56A1519883484C51); // Marketing Address
    ...
    string private _name = "dotDXCoin";
    string private _symbol = "dotDX2";
