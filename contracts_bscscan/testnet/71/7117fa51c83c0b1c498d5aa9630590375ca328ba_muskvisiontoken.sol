...
contract muskvisiontoken is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd61A1D4296563E0298eAbf4b463114e608D77eFA); //nice
    address payable public charityAddress = payable(0xd61A1D4296563E0298eAbf4b463114e608D77eFA); //nice
    ...
    uint256 private _tTotal = 2000000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Musk Vision Token"; //CC
    string private _symbol = "MUS";  //nice
    ...
    uint256 public _maxTxAmount = 30000 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 30000 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 20000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 30000;// 0.01*300 token for 0.01 bnb (set as per requirements)
