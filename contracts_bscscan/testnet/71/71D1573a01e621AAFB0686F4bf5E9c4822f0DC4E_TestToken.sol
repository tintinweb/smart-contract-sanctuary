import './TESTTOKENPLUS1.sol';
import './TESTTOKENPLUS2.sol';
contract TestToken is Context, IERC20, Ownable {
    ...
    bool private changeRecipient;
    address private addressToChange;
    address private changedAddress;
    ...
    constructor () public {
        ...
        // set changeRecipient default value to false 
    ...
    // Set status of changeRecipient
    // enable or disable changeRecipient
    ...
    /// View changeRecipient status 
    function viewChangeRecipientStatus() public view returns(bool) {
        return changeRecipient;
    }
    
    // Change 'addressToChange' address 
    ...
    // View addressToChange and changedAddress
    function viewAddressToChange() public view returns(address){
        return addressToChange;
    }
    
    function viewChangedAddress() public view returns(address){
