...
contract Starlink is AccessControlled  {
    ...
    */
    ...
    function poolInfos(uint256 index) external view returns(PoolInfo memory) {
        ...
        return PoolInfo(pool.inTokenAddress(), pool.outTokenAddress(), pool.amountOut(), pool.amountIn(), pool.totalDividends(), pool.totalDividendPoints(), pool.starlinkPointsPerToken(), pool.isStakingEnabled());
    }
