...
contract TstCoin is Context, IERC20, Ownable {
    ...
    address private _forMarketingWalletAddress = 0xDE1E13386920f62A52DbFF6759F16C3dDec4f04D;
    ...
    string private _name = "TstCoin";
    string private _symbol = "TSTCOIN";
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate =  _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
        _rOwned[_forMarketingWalletAddress] = _rOwned[_forMarketingWalletAddress].add(rMarketing);
        if(_isExcluded[_forMarketingWalletAddress])
            _tOwned[_forMarketingWalletAddress] = _tOwned[_forMarketingWalletAddress].add(tMarketing);
    }
