...
contract RewardsBunny is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    event setExcludedFromFeeTX(address TheFollowingAddressIsExcludedFees);
    ...
    event setExcludedFromClaimTX(address Address, bool AddressExcludedFromClaimIsSetTo);
    ...
    function setExcludedFromFee(address account, bool e) external onlyOwner {
        ...
        emit setExcludedFromFeeTX(account);
    }
