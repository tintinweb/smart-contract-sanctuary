...
contract SERINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "$tesste";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31c31F037aFA8C348d27858F50348e5A83d5C9BD); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x31c31F037aFA8C348d27858F50348e5A83d5C9BD); // BuyBack Address
