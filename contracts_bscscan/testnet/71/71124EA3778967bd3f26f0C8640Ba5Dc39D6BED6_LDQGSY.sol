...
contract LDQGSY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LDQGSY";
    string private _symbol = "LD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFf35C861f71677Db81D8B66386DdC8DDfBca4351); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xFf35C861f71677Db81D8B66386DdC8DDfBca4351); // buyback Address
