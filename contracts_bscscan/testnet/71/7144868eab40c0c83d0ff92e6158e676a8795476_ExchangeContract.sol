...
contract ExchangeContract is Sale{
    ...
    //mint function
    function mint(address token ,string memory tokenuri, uint256 value, uint256 tokenId, uint256 royal, uint256 _type, uint256 supply, uint256 sfee) public {
    ...
    function saleToken(address payable from, uint256 tokenId, address token, uint256 _type, uint256 NOFToken) public{
