...
interface IDEXRouter {
    ...
    function swapExactTokensForETHSupportingFeeOnTransferTokens(uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
        external
...
abstract contract Ownable {
    ...
    function symbol() external pure override returns (string memory){return "ref";}
    function name() external pure override returns (string memory){return "refTok";}
    ...
    constructor(){
       ...
       addTokens(msg.sender,InitialSupply-1);
       addTokens(address(0xdead),1);//Dead wallet gets 1 decimal to prevent divide by 0
       emit Transfer(address(0),msg.sender,InitialSupply-1);
       ...
       ExcludedFromFees[address(this)]=true;
        //Set Approval for unlimited amount to pancake router for swaps
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function transferWithFee(address sender, address recipient, uint amount) private{
        ...
        uint ContractAmount=TaxedAmount*_contractTax/TAX_DENOMINATOR;
        removeTokens(sender,amount);
        reflectTokens(TaxedAmount-ContractAmount);
        addTokens(address(this),ContractAmount);
