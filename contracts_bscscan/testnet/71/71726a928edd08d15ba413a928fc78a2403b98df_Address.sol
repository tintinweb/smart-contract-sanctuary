...
contract EverestCoin is Context, IERC20 {
    ...
    string private _name = "everestroz";
    string private _symbol = "EVROZ";
    ...
    address payable private _marketingWallet = payable(0xEae69F47bB89BdCfd826984078EaFc3E38b27829);
    address payable private _devWallet = payable(0x2677E8ED1F85Fa418ADbef136c283C0aeb780Bd9);
    address payable private _modWallet = payable(0x801f594FDa4e3ecEd6d7fC487f6bc76303E0Bbd4);
    address payable private _charityWallet = payable(0x22CbDb6A65A521d3c73563E3553CDF14B7C19A7a);
    address payable private _gameAdvWallet = payable(0x2EE5BE3078e371102F24A496382b986751738fba);
