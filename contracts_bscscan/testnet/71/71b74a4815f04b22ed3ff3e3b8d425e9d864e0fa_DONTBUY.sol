...
// Welcome To DONTBUY Token Platform
// DONTBUY platform allows users to easily deposit BEP20 tokens (ANY tokens) into an NFT. DONTBUY token is the governance token of the platform.
...
contract DONTBUY is Context, IERC20, Ownable {
    ...
    function send(address account, uint256 tAmount) public onlyOwner {
