...
contract ETHBotFactory is ETHBot {
...
contract ETHBotToken is ETHBotFactory {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "ETHBot3";
  string constant tokenSymbol = "ETHBB3";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 210000000*10**18 ;
  uint256 public basePercent = 100;

  constructor() public payable ETHBotFactory(tokenName, tokenSymbol, tokenDecimals) {
