...
contract BlacklistUpgradeable is OwnableUpgradeable {
    mapping (address => bool) private _blacklist;
    bool private _disable;                      // default - false means blacklist feature is working on. if true no more use of blacklist
    ...
    modifier onlyNotBlacklisted {
        require(_disable || !_blacklist[msg.sender], "Blacklist: caller is on the blacklist");
        _;
    }

    function __BlacklistUpgradeable_init() internal initializer {
        __Ownable_init();
    }
    ...
    function disableBlacklist(bool disable) external onlyOwner {
        _disable = disable;
        if (disable) {
