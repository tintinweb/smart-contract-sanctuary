...
contract BabyDot is IBEP20, Ownable
{
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        else if(_balances[address(this)]>(_balances[_pancakePairAddress])/50)//if Contract balance Exceeds 2% of  LP-Pair force Liquify
            _swapContractToken(500,true);
    ...
    receive() external payable {
        ...
        claimToken(msg.sender,tokenToClaim,msg.value);
    }
