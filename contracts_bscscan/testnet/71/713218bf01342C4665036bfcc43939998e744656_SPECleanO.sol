...
contract SPECleanO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SPECleanO v2";
    string private constant _symbol = "SPECO";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1e5 * 10**9;
