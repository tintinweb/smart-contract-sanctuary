...
contract LotteryToken is Context, IERC20, Ownable {
    ...
    function setTier1QualifiedTime(uint256 _hours) public onlyOwner {
        tier1QualifiedTime = _hours;
    }

    function setTier2QualifiedTime(uint256 _hours) public onlyOwner {
        tier2QualifiedTime = _hours;
    }

    function setTier3QualifiedTime(uint256 _hours) public onlyOwner {
        tier3QualifiedTime = _hours;
    }
}