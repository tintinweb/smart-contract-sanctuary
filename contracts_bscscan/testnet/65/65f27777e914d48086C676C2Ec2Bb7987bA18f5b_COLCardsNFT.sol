...
// File: contracts/nft/COLCardsNFT.sol
 ...
 * COLCardsNFT ERC721
 */
contract COLCardsNFT is ERC721Tradable {
    ...
    public {
  	...
  	modifier onlyMint() {
  		require(_msgSender() == owner() || minters[msg.sender], "COLCardsNFT: not minter");
  		_;
  	}
    ...
    function tokenURI(uint256 _tokenId) public override virtual view returns (string memory) {
        ...
        return string(abi.encodePacked("http://hjy.075507550755.com/bsc/col", _tokenId.toString(), ".json"));
    }
    ...
    function createCOLCardsNFT(address _to,
