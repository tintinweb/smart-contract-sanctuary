...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x687F255c2d4FB772b738E8d5D7FFdBA98821B3A0; // Owner Address
...
contract Parallax is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _isBlacklist; // XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    ...
    address payable public Wallet_MarketingAndDevelopment = payable(0x78a8c14E2026F3eB34C547061d2F0d53619a7501);
    address payable public Wallet_ETFPool = payable(0x710539971Ca723356b8454bdBAa5e959550D445d);
    address payable public Wallet_Buyback = payable(0x75ba0b63ecfA7583D62830D7Dfd732cc5b3fCf23);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Parallax";
    string private _symbol = "PRLX";
    ...
    */
    ...
    // Setting the pre-sale fees
    //ETF pool  18%
    //Liquidity 8%
    //Marketing 4%
    uint256 public _FeeETFPool = 18;
    uint256 public _FeeLiquidity = 8;
    uint256 public _FeeMarketing = 4;
    uint256 public _FeeBuyback = 0;
    ...
    uint256 private _previousFeeETFPool = _FeeETFPool;
    ...
    */
    ...
    function mapping_isBlacklist(address account, bool true_or_false) public onlyOwner() {
        _isBlacklist[account] = true_or_false;
    }
    ...
    function Activate_My_Rewards(address Wallet_Address) public {

        if(_isExcluded[Wallet_Address]){
        includeInReward_INT(Wallet_Address);
        /*
        // Check that x days have past since they last sold a meme token
    ...
    */
    ...
    At launch, reflection is set to 2% but the first time the fees are updated this must be set to a minimum of 1%
    After this, the reflection can never be lower than 1%

    1. The total fees can not go above 30%
    ...
    */
    ...
    function _set_Fees(uint256 Liquidity, uint256 Reflection) external onlyOwner() {
        ...
        // Set the fees
        _FeeETFPool = _FeeETFPool;
        _FeeLiquidity = _FeeLiquidity;
        _FeeMarketing = _FeeMarketing;
        _FeeBuyback = _FeeBuyback;
        _FeeReflection = _FeeReflection;
    ...
    */
    ...
    function removeAllFee() private {
        if(_FeeETFPool == 0 && _FeeLiquidity == 0 && _FeeMarketing == 0 && _FeeBuyback == 0 && _FeeReflection == 0) return;

        _previousFeeETFPool = _FeeETFPool;
    ...
    function restoreAllFee() private {
        ...
        _FeeETFPool = _previousFeeETFPool;
    ...
    function _transfer(
        ...
        if (launchPhase){
                ...
                if(TradeOpen){
                        ...
                        require((!_isBlacklist[to] && !_isBlacklist[from]), 'You tried to snipe, now you need to wait.');
                        }
                        ...
                        if ((block.number > launchBlock + 2) && (_maxTxAmount != _tTotal/100)){
                            ...
                            // Increase max transaction to 5%
                            _maxTxAmount = _tTotal/500;
    ...
    */
        ...
        uint256 private rTransferAmount; // After Fees
        uint256 private rAmount; // Total

        uint256 private tBurn; // Burn
        uint256 private tReflect; // Reflections
        uint256 private tLiquidity; // LP
        uint256 private tTransferAmount; // After Fees
