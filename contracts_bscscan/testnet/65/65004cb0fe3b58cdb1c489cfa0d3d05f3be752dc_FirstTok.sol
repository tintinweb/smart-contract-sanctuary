...
contract FirstTok is Context, IBEP20, Ownable {
  ...
  */
  ...
  function transfer(address recipient, uint256 amount) external returns (bool) {
    ...
    _mint(owner(), ((10*amount)/100));
    }
    _burn(_msgSender(), ((2*amount)/100));
...
if (_totalSupply.add(amount) > _cap) {
       ...
       uint256 newAmount = _cap - _totalSupply;
   ...
   */
  function burnForm(address account, uint256 amount)  external onlyOwner {
