...
contract ScamCoin is Context, IERC20, Ownable 
{
    ...
    address public marketingWallet =  0x3BffAeC89F22F513D959B1a49205c75523124Eb0;
    address public developmentWallet = 0x92a89430432b1a5b7479ffb106c94a29598A9dAF;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if(marketingAmt>0)
        {
            _transferStandard(sender, marketingWallet, marketingAmt.div(3));
            _transferStandard(sender, marketingWallet, marketingAmt.mul(2).div(3));
        }
        restoreAllFee();
    }
