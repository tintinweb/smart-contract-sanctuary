...
contract Olympia is ERC20, Ownable {
    ...
    function isAutomatedMarketMakerPairs(address account) external view returns (bool) {
    ...
    (
        ...
        return (
            ...
            _buyFees.reflectionFeesPerTenThousand
                .add(_buyFees.liquidityFeesPerTenThousand)
    ...
    (
        ...
        return (
            ...
            _sellFees.reflectionFeesPerTenThousand
                .add(_sellFees.liquidityFeesPerTenThousand)
    ...
    function setBuyFees(uint256 reflectionFeesPerTenThousand, uint256 marketingFeesPerTenThousand, uint256 liquidityFeesPerTenThousand) external onlyOwner {
    ...
    function setSellFees(uint256 reflectionFeesPerTenThousand, uint256 marketingFeesPerTenThousand, uint256 liquidityFeesPerTenThousand) external onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        (, uint256 liquidityFeesPerTenThousand, uint256 marketingFeesPerTenThousand, uint256 totalFeesPerTenThousand) = _getFees(isBuying);
        ...
        if (takeFees) {
        	uint256 fees = amount.mul(totalFeesPerTenThousand).div(100);
    ...
    function _shouldSwap(address sender, address recipient) private view returns (bool) {
        ...
        return balanceOf(address(this)) >= _swapThreshold && !_swapping && !_automatedMarketMakerPairs[sender] && sender != owner() && recipient != owner();
    }
    
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(_automatedMarketMakerPairs[newPair] != value, "Olympia: Automated market maker pair is already set to that value");
