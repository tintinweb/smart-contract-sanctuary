...
contract KalmarBondingStrategy is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public constant lockDuration = 60 * 5;
    // Total kalm sold
    ...
    function claimableToken(address user) external view returns (uint256 avaliable) {
    ...
    function _kalmPrice() internal pure returns (uint256) {
      return 1500000000000000000;
    }

    function _bondPrice() internal pure returns (uint256) {
      return 1250000000000000000;
    }

    function _stakingTokenPrice() internal pure returns (uint256) {
      return 1000000000000000000;
    }

    function _calculateBondPerToken(uint256 _amount) internal pure returns (uint256) {

      uint256 buyAmountUsd = _amount.mul(_stakingTokenPrice()).div(1e18);
      uint256 amountBond = buyAmountUsd.div(_bondPrice()).mul(1e18);
      return amountBond;
    }
