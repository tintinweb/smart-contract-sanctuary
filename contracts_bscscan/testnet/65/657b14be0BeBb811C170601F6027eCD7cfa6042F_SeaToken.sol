...
contract SeaToken is BEP20('Sea Token', 'SEA'), MinterRole, Pausable {
    ...
    function _transfer(address _sender, address _recepient, uint256 _amount) internal override antiWhale(_sender, _recepient, _amount) {
        ...
        require (_blocklistFromTransfer[_sender] == false && _blocklistFromTransfer[msg.sender] == false, 'SEA::transfer blocked from transfer');
    ...
    function updateBlacklistFromTransfer(address _user, bool _isBlocked) external onlyOperator {
