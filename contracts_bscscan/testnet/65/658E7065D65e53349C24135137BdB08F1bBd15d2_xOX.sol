...
contract xOX is ERC20Permit, Ownable {
    ...
    constructor() ERC20("xOX", "xOX", 9) ERC20Permit() {
    ...
    /**
        @notice increases xOX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess xOX
