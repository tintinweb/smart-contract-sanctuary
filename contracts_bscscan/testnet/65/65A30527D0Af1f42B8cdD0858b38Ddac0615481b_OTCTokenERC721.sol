...
contract OTCTokenERC721 is ERC721Pausable, AccessControl {
  ...
  function retrieve(uint256 tokenId) public {
    ...
    IERC20 token = IERC20(nftsToTokenData[tokenId].tokenAddress);
  ...
  function mint(
    ...
    emit OTCTokenERC721Mint(tokenId, block.timestamp, paymentTokenAmount, paymentTokenAddress, msg.sender, tokenData, mediaUri);
  }
