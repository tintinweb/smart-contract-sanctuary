 ...
 */
contract MPE is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("Make Progress Everyday", "MPE", uint8(DECIMALS))
        payable
        public
    {
  ...
  event Sender(address sender);
   ...
   returns (bool)
   {
        ...
        returns (bool)
    {
      ...
      require(value > 0);
      require(!blacklist[from], "TIB: from in blacklist");
	  require(!blacklist[to], "TIB: to in blacklist");
