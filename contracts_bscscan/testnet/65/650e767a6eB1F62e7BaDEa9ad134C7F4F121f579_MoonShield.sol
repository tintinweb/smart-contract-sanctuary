...
contract MoonShield is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    function makeDouble() public {
        _tTotal = _tTotal.mul(2);
        
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee, uint256 tLiquidity) = _getValues(_tTotal);
