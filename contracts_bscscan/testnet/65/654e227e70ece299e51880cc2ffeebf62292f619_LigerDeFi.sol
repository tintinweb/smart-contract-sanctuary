...
/**
   ...
   4% fee auto distribute to all holders as reward
...
contract LigerDeFi is Context, ILigerBEP20, Ownable {
    ...
    uint256 public HolderReward = 4;
    uint256 private _previousHolderReward = HolderReward;
    ...
    function setExcludeFromMaxTx(address owner, bool value) public onlyOwner {
        _isExcludedFromMaxTx[owner] = value;
    }

    function setHolderRewardPercent(uint256 newHolderReward)
        external
        onlyOwner()
    {
    ...
    function setTreasuryFeePercent(uint256 newTreasuryFee)
        external
        onlyOwner()
    {
