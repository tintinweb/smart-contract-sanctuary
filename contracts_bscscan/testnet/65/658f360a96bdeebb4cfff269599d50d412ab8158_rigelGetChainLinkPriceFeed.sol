...
// import "https://github.com/smartcontractkit/chainlink/blob/develop/contracts/src/v0.6/AggregatorFacade.sol#L57";
...
contract rigelGetChainLinkPriceFeed is Context {
    ...
    function addMulAggregator(address[] calldata _aggregators, uint256[] calldata _decimal) external onlyAdmin {
