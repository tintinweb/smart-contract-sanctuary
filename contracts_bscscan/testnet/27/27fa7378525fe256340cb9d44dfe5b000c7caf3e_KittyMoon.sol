...
library Address {
     ...
     * ==== 
     * *VM* vice info k adresse: https://soliditydeveloper.com/extcodehash
     */
...
contract KittyMoon is Context, IERC20, Ownable {
    ...
    string private _name = "Kitty Moon";
    string private _symbol = "kitmoon";
    ...
    //Paid in BNB - it's a percentage of _liquidityFee !!!
    uint256 public _marketingFee = 2;
    address payable public marketingWallet = payable(0xD966adBC27c597a68a28E5f361D19B0429E020AF);
    uint256 private _previousMarketingFee = _marketingFee;
    
    //Paid in BNB - it's a percentage of _liquidityFee !!!
    uint256 public _charityFee = 1;
    address payable public charityWallet = payable(0x824831627a4849A07c080bEfBb86Ee8Da1Eb6E99);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingAndCharityFraction = _marketingFee.add(_charityFee);
        ...
        if(address(this).balance > 0) {
            ...
            uint256 marketingFraction = _marketingFee.div(marketingAndCharityFraction);
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 charityFee, uint256 burnFee) external onlyOwner() {
        _taxFee = taxFee;
