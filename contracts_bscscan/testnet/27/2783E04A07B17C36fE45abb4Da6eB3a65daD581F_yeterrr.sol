...
contract yeterrr is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "YETER AMK";                                          // name
    string private _symbol = "YETR";                                             // symbol
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "SWAT is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "ROAR is not live yet");
