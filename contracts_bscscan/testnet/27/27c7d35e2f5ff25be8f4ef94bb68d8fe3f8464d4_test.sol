...
contract test is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xF1390C7CB8a7D272c9e0DE5c3661a229072A0Ae5;
    address public devWallet = 0x073bbc306ACd3BB6196C860C9336F3468c16a9df;

    string private constant _name = "testo";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            require(tradingEnabled, "Trading is not active yet");
        }
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external onlyOwner{
        require(maxBuyLimit >= (_tTotal/(10**decimals()))/2000 , "Too less");
        require(maxSellLimit >= (_tTotal/(10**decimals()))/2000 , "Too less");
