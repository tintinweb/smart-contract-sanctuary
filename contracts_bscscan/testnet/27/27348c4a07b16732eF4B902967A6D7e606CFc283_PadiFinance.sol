...
pragma solidity ^0.8.0;
contract PadiFinance is ERC20, Ownable {                                
    ...
    constructor() ERC20("Padi.Finance", "PADI") {                    
        _mint(msg.sender, 4025*10**decimals());
        _mint(address(this), 19371*10**decimals());
        contractOwner = msg.sender;
        startSale(block.number, 500000, 0, 4000*10**decimals(), 19371);
        startAirdrop(block.number, 30000, 10*10**decimals(), 5000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
