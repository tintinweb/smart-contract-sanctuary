...
contract Silcoinu is Context, IERC20, Ownable {
    ...
    //address private _owner = msgSender(this);
    ...
    constructor() payable {
        _rOwned[owner()] = (_rTotal / 1000) * 700;
        _rOwned[address(this)] = (_rTotal / 1000) * 300;

        maxTransactionAmount = (_tTotal * 5) / 1000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = (_tTotal * 30) / 1000; // 1.5% maxWalletAmount
        minimumTokensBeforeSwap = (_tTotal * 5) / 10000; // 0.05% swap tokens amount

        marketingAddress = payable(0xAFbBA4cadDa73202612E8c9745d611dA636E5728); // Marketing Address

        devAddress = payable(0xAFbBA4cadDa73202612E8c9745d611dA636E5728); // Dev Address
