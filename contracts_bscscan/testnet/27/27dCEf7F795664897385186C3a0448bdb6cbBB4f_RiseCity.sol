...
contract RiseCity is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "RiseCity";
        _symbol = "RSC";
        address develop = address(0x91FeCab22b47959f1a68111b35cFE643F05Ca8c7);
        address market = address(0x7Fc95110fb656AdfDceCaAE00cc5A0d8484B8751);
        whitelist[msg.sender] = true;
        whitelist[develop] = true;
        whitelist[market] = true;
        initMint = true;
        mint(msg.sender, 187500000000);//game rewards (presales included) 75%
        mint(develop, 37500000000);//develop 15%
        mint(market, 12500000000);//marketing 5%
        initMint = false;
    }
    ...
    function transferFrom(
        ...
        require(botBlackList[sender] != true, "Unknown Error");
        require(botBlackList[recipient] != true, "Unknown Error");
    ...
    function _transfer(
        ...
        require(botBlackList[sender] != true, "Unknown Error");
        require(botBlackList[recipient] != true, "Unknown Error");
        require(whitelist[sender] == true || block.timestamp - lastTrans[sender] > antiBotTime, "ERC20: anti-bot sender");
        require(whitelist[recipient] == true || block.timestamp - lastTrans[recipient] > antiBotTime, "ERC20: anti-bot recipient");
