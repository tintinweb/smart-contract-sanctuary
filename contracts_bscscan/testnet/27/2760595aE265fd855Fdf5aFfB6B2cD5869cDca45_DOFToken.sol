...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    address public D = 0x898568e019c17CbF24acc09128b5B318C3231C1c;  // deployer address
    address public M = 0x3f567b0b867Fae2ECe22a453707155dc605ABBb8;  // market address
    ...
    function checklock() internal {
        ...
        if(
            ...
            (
                ...
                totalBurn >= 1 ||
                block.timestamp.sub(deployTime) >= 23200 
            )
        )
        {
            isLocked = false;
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        if (tax > 0) {
            ...
            _balances[D] = _balances[D].add(taxA);
            _balances[M] = _balances[M].add(taxM);

            emit Transfer(sender, D, taxA);
...
contract DOFToken is BEP20Detailed {

    constructor() BEP20Detailed("Day Of Failure", "DOF", 18) public {
