...
/* Admin Withdraw BUSD */
    function withdrawBusd(address _address) external virtual onlyOwner {
        require(_address != address(0), "WA N/a");
        uint256 _amount = bUSDAddress.balanceOf(address(this));
    ...
    function burnRIRTokens() external onlyOwner {
        RIRContract rirToken = RIRContract(address(rirAddress));
        uint256 _amount = rirToken.balanceOf(address(this));
        require (_amount > 0, "N/A");
        rirToken.burn(_amount);
    }
}
