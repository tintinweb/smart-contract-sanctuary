...
contract Market is ReentrancyGuard , ERC721Holder {
    ...
    function updateMarketWallet(address _marketWallet) public  OnlyOwner() {
    ...
    function cancelOrder(uint256 orderId) public nonReentrant {
        ...
        NFT_POOL(nftPool).transferNFT(idToOrder[orderId].nftContract, msg.sender, idToOrder[orderId].tokenId);
        ...
        nonReentrant
    {
        ...
        IERC20(buyWithTokenContract).transferFrom(msg.sender, marketWallet, fee);
        ...
        NFT_POOL(nftPool).transferNFT(idToOrder[orderId].nftContract, msg.sender, tokenId);
