...
contract FishyEgg is ERC20, ERC20Burnable, Ownable, HasAdmin {
  ...
  function approve(address spender) external {
    _approve(msg.sender, spender, ~uint256(0));
  }

  function transferAndBurn(address from, address to, uint256 amount) external onlyAdmin {
    uint256 burnAmount = amount.mul(90).div(100);
