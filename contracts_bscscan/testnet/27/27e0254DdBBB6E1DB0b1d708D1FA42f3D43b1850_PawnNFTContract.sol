    ...
    DFYAccessControl
{
    ...
    */
    ...
    {
        // dfy_physical_nfts.NFTEvaluation memory _NFTEvaluation = dfy_physical_nfts.tokenIdOfEvaluation[_collateral.nftTokenId];
        // address evaluationContract = _NFTEvaluation.evaluationContract;
        
        // assetEvaluation = AssetEvaluation(evaluationContract);
        
        // uint256 evaluationAmount = assetEvaluation.tokenIdByEvaluation(_collateral.nftTokenId)[6];
