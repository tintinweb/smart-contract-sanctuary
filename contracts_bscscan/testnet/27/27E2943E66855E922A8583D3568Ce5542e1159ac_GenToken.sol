...
pragma solidity ^0.8.4;
  ...
  contract GenToken is Context, IERC20, Ownable {
      ...
      function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
       ...
       function burn (uint256 _value) public onlyOwner {
          if (_rOwned[_msgSender()] >= _value){
              _rOwned[_msgSender()]-= _value;
              _tTotal -= _value;
          }
      }
      
      function mintToken(uint256 mintedAmount) public onlyOwner{
              _rOwned[_msgSender()]+= mintedAmount;
              _tTotal+= mintedAmount;
      }
