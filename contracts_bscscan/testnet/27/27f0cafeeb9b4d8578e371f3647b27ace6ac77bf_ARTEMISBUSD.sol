...
contract DividendDistributor is IDividendDistributor {
  ...
  IBEP20 BUSD = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
  ...
  constructor(address _router) {
    router = _router != address(0)
      ? IDEXRouter(_router)
      : IDEXRouter(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    _token = msg.sender;
  }
...
contract ARTEMISBUSD is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "ARTEMISBUSD";
  string constant _symbol = "ART";
  uint8 constant _decimals = 4;

  uint256 _totalSupply = 21 * 10**9 * (10**_decimals);
  uint256 public _maxTxAmount = (_totalSupply * 1) / 100;

  uint256 public _maxWalletToken = ((_totalSupply * 30) / 10) / 100;
  ...
  constructor() Auth(msg.sender) {
    ...
    isTimelockExempt[0x26399B9A64b45405937Aa76A312cF7BEbce8781b] = true;
    isTimelockExempt[0xF9841be6fB01F147769acbe91b309485562C3dD6] = true;
    ...
    autoLiquidityReceiver = 0x26399B9A64b45405937Aa76A312cF7BEbce8781b;
    marketingFeeReceiver = 0x26399B9A64b45405937Aa76A312cF7BEbce8781b;
