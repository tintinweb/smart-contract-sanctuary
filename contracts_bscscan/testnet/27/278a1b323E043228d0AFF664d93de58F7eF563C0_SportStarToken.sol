...
contract SportStarToken is ERC721 {
    ...
    function team() public pure returns (string) {
    ...
    function createToken(string _name, string _team, address _owner) public onlyMasterContract returns (uint256 _tokenId) {
    ...
    // For creating Token
    function _createToken(string _name, string _team, address _owner) private returns (uint256 _tokenId) {
