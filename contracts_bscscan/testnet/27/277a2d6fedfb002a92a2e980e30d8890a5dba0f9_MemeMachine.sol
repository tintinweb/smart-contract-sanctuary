...
/**
    MeMa is made to disrupt the meme cryptocurrency space - our motivation is meme innovation

    Website: https://mematoken.io 
    Twitter: https://twitter.com/MeMaToken 
    Telegram: https://t.me/MeMaTokenOfficial
*/
...
contract MemeMachine is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x0F0d162d8543a452A76b7c7a714b5930dfaf009a);
        
    address payable public teamAddress =
        payable(0xC8D134B06540BA345daCD6712adABb4cCa629BB8);
    ...
    uint256 private constant _tTotal = 1 * 1e15 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "Meme Machine";
    string private constant _symbol = "MeMa";
