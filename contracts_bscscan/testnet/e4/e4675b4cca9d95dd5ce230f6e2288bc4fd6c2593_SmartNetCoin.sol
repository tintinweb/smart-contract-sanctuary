...
/**
   SNTCoin
   SmartNetCoin on binance chain

   SmartNetCoin comes with sophisticated features such as liquidity pool.
   automatic and manual burns and static reflections for all holders. 
   SmartNetCoin decentralized platform is developed as a revolutionary approach towards the centralized platform. 
   It is developed to aid in the swift trading of BEP-20 tokens while still providing traders with full custody over their tokens.
   
   website: https://smartnetcoin.com/ 
   telegram: https://t.me/smartnetcoin 
   twitter: https://twitter.com/smartnetcoin 
   instragram: https://instagram.com/smartnetcoin/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1e41cCd02A3Bc5af70d9A7596d9651E8702B1aC4;
...
contract SmartNetCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1e41cCd02A3Bc5af70d9A7596d9651E8702B1aC4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SmartNetCoin";
    string private _symbol = "SNTCoin";
