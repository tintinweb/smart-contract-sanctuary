...
contract DogePad is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 5e5 * 10**9;
    ...
    modifier lockTheSwap {
        ...
        constructor () public {
        _FeeAddress = 0x658d6D87b7610AC37F20Ca3c8506B258656b2473;
        _marketingWalletAddress = 0xD8525c77C0B0fEC032aC280E82Dce51dA2411361;
	...
	function setMaxWalletPercent(uint256 maxWallet) external {
	    require(_msgSender() == _FeeAddress);
	    require(maxWallet > 0);
