...
contract AnnexFarm is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accAnnexPerShare; // Accumulated SWIPEs per share, times 1e12. See below.
    }
    // The SWIPE TOKEN!
    ...
    // Safe annex transfer function, just in case if rounding error causes pool to not have enough SWIPEs.
