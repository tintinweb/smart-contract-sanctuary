...
contract Dividends is IBEP20, Ownable
{
    ...
    uint16 public constant MaxBuyLockTime= 60 minutes;
    ...
    //DevWallets
    address public TeamWallet=payable(0x15b200B3caF3fE1b34B406FCa185aFaB23413A73);
    address public walletTwo=payable(0x5c62742BB596033b52886A71daedC918FaDB8c2a);
    address public walletThree=payable(0xFC8Fb20098CE43E598546277D0C4e14e1418D372);
    address public walletFour=payable(0x2bbe7A4ea4d8C64BdF85073A6Dbc81072ee5B75B);
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer(amount / 4);
        payable(walletTwo).transfer(amount / 4);
        payable(walletThree).transfer(amount / 4);
        payable(walletFour).transfer(amount / 4);
    ...
    function TeamChangeWalletThree(address newWalletThree) public onlyOwner{
      walletThree=payable(newWalletThree);
    }
    
    function TeamChangeWalletFour(address newWalletFour) public onlyOwner{
      walletFour=payable(newWalletFour);
    }
