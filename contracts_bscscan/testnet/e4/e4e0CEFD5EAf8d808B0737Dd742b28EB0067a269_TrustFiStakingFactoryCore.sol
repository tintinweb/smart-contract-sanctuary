...
contract TrustFiStakingFactoryCore is ITrustFiStakingFactoryCore {
    ...
    */
    ...
    function addPool(
        ...
        poolViewInfo.logo = poolViewParams[4];
        ...
        }else{//Added new mining currency
            PoolRewardInfo memory poolRewardInfo; //Mine pool bonus information
            poolRewardInfo.token = rewardToken; //Reward token
            poolRewardInfo.rewardTotal = rewardTotals; //The total reward
            poolRewardInfo.rewardPerBlock = rewardPerBlocks; //Block rewards, the decreasing mode will decrease proportionally every day
            // poolRewardInfo.rewardProvide //The default is zero
            // poolRewardInfo.rewardPerShare //The default is zero
            poolRewardInfos[vars.poolId] = poolRewardInfo;
        }
