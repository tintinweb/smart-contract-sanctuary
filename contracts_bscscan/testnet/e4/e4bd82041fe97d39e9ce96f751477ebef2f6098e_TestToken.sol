...
abstract contract MinterControl is AccessControl {
    ...
    /// @dev Revoke an account from the minter role. Restricted to admins.
    function revokeMinter(address account) public virtual onlyAdmin {
    ...
    /// @dev Revoke oneself from the admin role.
    function renounceAdmin() public virtual {
        renounceRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }
}

contract TestToken is ERC20, MinterControl {
