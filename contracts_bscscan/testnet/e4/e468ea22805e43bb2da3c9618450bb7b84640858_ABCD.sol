...
contract ABCD is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "le3y";  //TODO
    ...
    function _takeReferrerFee(uint256 tReferrer, address referrerAddr) private {
        ...
        //addweb
        referralRewardToken[referrerAddr] = referralRewardToken[referrerAddr].add(tReferrer);  // not include reflection
        //endweb
    ...
    function _takeReferreeFee(uint256 tReferree, address referreeAddr) private {
        ...
        //addweb
        referralRewardToken[referreeAddr] = referralRewardToken[referreeAddr].add(tReferree);  // not include reflection
        //endweb
    ...
    function removeLiquidity(uint256 liquidity) external onlyOwner {
        ...
        (amountToken, amountBNB) = uniswapV2Router.removeLiquidityETH(
            ...
            0, 
            0, 
            payable(0xb064E75eC7E154f8279B61B1bb20cb5f0862D929),  //TODO: can be another contract has it's own lock machenism 
            block.timestamp + 360
        );
        // update unlocked liquidity
