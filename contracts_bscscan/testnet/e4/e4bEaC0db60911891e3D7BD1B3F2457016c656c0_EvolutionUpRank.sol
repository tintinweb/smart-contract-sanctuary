...
contract EvolutionUpRank is OwnableUpgradeable, PausableUpgradeable   {
    ...
    mapping(uint256 => uint256) public bplusNeeds;
    ...
    function setConfigUpgrade (uint256 _rank,uint256 _bplusNeed, uint256 _material) public onlyOwner {
        materials[_rank]=_material;
        bplusNeeds[_rank]=_bplusNeed;
    } 
    ...
    function upRank(uint256 _mainNftId, uint256 [] memory _materialNftIds) public whenNotPaused returns (bool) {
        ...
        uint256 bplusUpRank = bplusNeeds[rank];
