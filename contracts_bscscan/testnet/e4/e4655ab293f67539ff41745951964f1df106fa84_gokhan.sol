...
contract gokhan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public ecosystemAddress = payable(0x403426c22c3B725ADE55bd53164E0201f70fDb72);
    ...
    string private _name = "ENSACMA";
    string private _symbol = "ENsM";
