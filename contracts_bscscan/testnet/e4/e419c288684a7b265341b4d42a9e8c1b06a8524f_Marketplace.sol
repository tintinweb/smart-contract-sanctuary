    ...
    IEmergency
{
    ...
    event ChangeListingPrice(address indexed seller, address indexed nftAddress, uint indexed id, uint newPrice);
    ...
    uint public newParamV2;
    
    function setParmam2(uint val) external {
        newParamV2 = val;
    }
    ...
    // This is required for unit test mock currencies
    ...
    function changeListingPrice(address nft, uint id, uint newPrice) external nonReentrant {
        require(_isSeller(nft, id, msg.sender), "Not Seller");
        _listings[nft][id].price = newPrice;
        emit ChangeListingPrice(msg.sender, nft, id, newPrice);
    }
