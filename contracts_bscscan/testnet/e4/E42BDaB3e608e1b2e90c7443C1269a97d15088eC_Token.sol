...
contract Token is BEP20 {
    ...
    function getClaim(address addr, uint256 invitePower) public view returns(uint256, uint256) {
        ...
        if (data[addr][0] > 0 && etime > data[addr][1]) {
            ...
            claimNum += ((etime - data[addr][1]) * power) * half;
        }
