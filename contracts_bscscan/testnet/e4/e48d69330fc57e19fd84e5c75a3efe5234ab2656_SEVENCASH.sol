...
DECIMAL: 9 MAIN WALLET 
PROJECT: 0x2195f772d7D30d797b2de95f13bfca3D28dcdC3b 
MARKETING WALLET: 0x12A43726750A5BCa2F63F8E727315e5666C04caD 
5% LIQUIDITY 
3% MARKETING 
2% PROJECT (Return main wallet) 
...
contract SEVENCASH is Context, IERC20, Ownable {
    ...
    string private _name = "SEVEN CASH 777";
    string private _symbol = "C777";
    ...
    uint256 public _fundingFee = 5;
    uint256 private _previousFundingFee = _fundingFee;
    
    address  public MARKETINGAddress = 0x820938567b0FE5c0a992093401A07Ec31469F7Be;
    address  public PROJECTAddress = 0x964429dB3BD7678625752B79D5017cF87b500827;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn MARKETING and PROJECT wallets
        _transferStandard(sender, address(0), burnAmt);
        _transferStandard(sender, MARKETINGAddress, fundingPiece.mul(3));
        _transferStandard(sender, PROJECTAddress, fundingPiece.mul(2));
