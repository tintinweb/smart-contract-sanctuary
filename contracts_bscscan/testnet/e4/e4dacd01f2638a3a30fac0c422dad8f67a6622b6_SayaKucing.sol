...
contract SayaKucing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x13233400aBdE6D868Ebe1Df85deD0aaCfb08eB85); // Marketing Address
    ...
    string private _name = "SayaKucing";
    string private _symbol = "SYKG";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x13233400aBdE6D868Ebe1Df85deD0aaCfb08eB85);
    }
