...
contract SpaToken is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 47;
    ...
    function _setCharityWallet(address payable devWalletAddress) external onlyOwner() {
        _devWalletAddress = devWalletAddress;
    }
