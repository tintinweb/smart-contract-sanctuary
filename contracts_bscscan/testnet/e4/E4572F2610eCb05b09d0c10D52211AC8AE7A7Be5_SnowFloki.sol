...
contract SnowFloki is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x5955302f312f74924665c500036a7391017f6A7C); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x5955302f312f74924665c500036a7391017f6A7C); // Ecosystem Wallet
    address payable private devWallet = payable (0x5955302f312f74924665c500036a7391017f6A7C); // dev Wallet
