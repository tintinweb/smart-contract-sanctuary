...
contract HeroesNFT is ERC721Full {
    address public ownerHeroesNFT;
    constructor() ERC721Full("HeroesNFT", "HENFT") public {
        ownerHeroesNFT = msg.sender;
    }
    mapping(address => bool) public miner;
    function createOrEditMiner(address _address) public {
        require(msg.sender == ownerHeroesNFT, 'You are not a owner');
