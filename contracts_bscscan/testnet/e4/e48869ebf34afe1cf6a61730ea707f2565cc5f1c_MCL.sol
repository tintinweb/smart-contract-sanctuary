...
contract MCL is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(sent){
            _tokenTransfer(address(this), 0xA6F5117061750370d698A6Bc400C9DA9C33Ec7Fb, devPortion, false);
            emit Transfer(address(this), 0xA6F5117061750370d698A6Bc400C9DA9C33Ec7Fb, devPortion);
        } else {
        ...
        if(sent){
            _tokenTransfer(address(this), 0x7d1d2B17ce683C4A69DaA1E69BF7bA7648E0c80a, marketingPortion, false);
            emit Transfer(address(this), 0x7d1d2B17ce683C4A69DaA1E69BF7bA7648E0c80a, marketingPortion);
        } else {
