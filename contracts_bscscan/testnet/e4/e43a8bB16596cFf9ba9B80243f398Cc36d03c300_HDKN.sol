...
contract MarketingDistributor{
    ...
    //IUniswapV2Router02  constant uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //mainnet
    IUniswapV2Router02  constant uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //testnet
    ...
    IERC20 public BUSD = IERC20(0x82Ed27e5F7BF6465618990dFdBdbeE3E5892468F); //testnet
    IERC20 public immutable HDKNToken;

    address  public  marketingWallet = 0x60d4e5Df559D146131428De8cCecaC691dcAe385;
...
contract HDKN is ERC20, Ownable {
    ...
    constructor() ERC20("HADOUKEN", "HDKN") {
    	...
    	//busdDividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //Mainnet
        busdDividendToken = 0x82Ed27e5F7BF6465618990dFdBdbeE3E5892468F; //Testnet
