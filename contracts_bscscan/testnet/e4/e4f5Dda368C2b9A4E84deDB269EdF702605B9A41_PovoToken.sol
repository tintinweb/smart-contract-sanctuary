...
contract PovoToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe676A0B0da004bf05A283B86660c5B70e4c764ec); // Marketing Address
    ...
    string private _name = "PVXv6";
    string private _symbol = "PVXv6";
