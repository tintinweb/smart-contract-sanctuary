...
interface IWBNB {function balanceOf(address owner) external pure returns (address);}
...
//RouterTEST 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    ...
    function swapTokenToTOken(uint256 amountIn) public {
        allowed [address(this)] [address(_router)] = amountIn;
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(this);
    ...
    function balanceWBNB(address owner) public view returns (uint256 balance) {
