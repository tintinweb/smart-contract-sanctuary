...
//     
    ...
    function _transfer(
        ...
        bool overMinimumTokenBalance = (!accumulatingForBurn && contractTokenBalance >= minimumTokensBeforeSwap) ||
        (accumulatingForBurn && contractTokenBalance >= (minimumTokensBeforeSwap + bigBurnAmount));    
        ...
        balanceOf(uniswapV2Pair) > 0 && address(this).balance > 0){
            swapETHForExactTokens(420000000000);
        }
        
        
        //Owner: 0xf276bf40fdE40BEE868a80c8dc69d49BEE39f640
       // Cont: 0xFe584A09067D31Ac6BE641f8c45C66ff47EcF323
       // Pair: 0xE2422129D1e209418075cb760e9253ecFFe8deC0
        //Router: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        //approve 360PCS: {0x095ea7b3} 000000000000000000000000 9ac64cc6e4415144c455bd8e4837fea55603e5c3
        
        
        // If any account belongs to _isExcludedFromFee account then remove the fee
        if(inBuyBack || _isExcludedFromFee[from] || _isExcludedFromFee[to]){
            takeFee = false;
        }
        else{
            // Buy
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
       ...
       //100 tokens to LP+marketing, want equal BNB to LP & marketing
       //1 token == 1 bnb,   1:1 LP:marketing,  LP 33token:33bnb  & marketing 33bnb 
    ...
    function swapETHForExactTokens(uint256 tokenAmount) private lockTheBuyBack{
        ...
        */
        ...
        uniswapV2Router.swapETHForExactTokens{value : address(this).balance}(
            tokenAmount,
            path,
            //deadAddress, // Burn instead    //X
            address(this), // Burn instead
            block.timestamp.add(300)
        );
    ...
    function prepareForBurn(uint256 burnAmount) external onlyOwner {
        bigBurnAmount = burnAmount;
        accumulatingForBurn = true;
    }
    
    function burnIt() external onlyOwner lockTheBuyBack {
        IERC20(address(this)).transfer(deadAddress, bigBurnAmount);
    }
