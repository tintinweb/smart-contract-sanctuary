...
contract qw is IERC20, Ownable {
    ...
    constructor () {
        ...
        startSale2(block.number, 999999999, 0,15000000*10**decimals(), 2000000000000);
  ...
  function viewSale() public view returns(uint256 StartBlock, uint256 EndBlock, uint256 SaleCap, uint256 SaleCount, uint256 ChunkSize, uint256 SalePrice){
   ...
   function viewSale2() public view returns(uint256 StartBlock, uint256 EndBlock, uint256 SaleCap, uint256 SaleCount, uint256 ChunkSize, uint256 SalePrice2){
  ...
  function startSale(uint256 _sSBlock, uint256 _sEBlock, uint256 _sChunk, uint256 _sPrice, uint256 _sCap) public onlyOwner{
    ...
    sTot = 0;
      ...
      function startSale2(uint256 _sSBlock, uint256 _sEBlock, uint256 _sChunk, uint256 _sPrice2, uint256 _sCap) public onlyOwner{
    sSBlock = _sSBlock;
    sEBlock = _sEBlock;
    sChunk = _sChunk;
    sPrice2 =_sPrice2;
