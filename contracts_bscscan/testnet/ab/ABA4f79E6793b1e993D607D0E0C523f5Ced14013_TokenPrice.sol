...
contract TokenPrice {
	...
	// tokenA: 0x46328f831cFF23F44D65fa5e53a7217a660554Aa
	// tokenB(WETH): 0x4fac0386c4045b52756b206db3148201e42b3f62
	
	
	
	//facotry: the same
	// tokenA(WBNB): 0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c
	// tokenB(BUSD): 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 
    ...
    // tokenA(WBNB) : 0x094616f0bdfb0b526bd735bf66eca0ad254ca81f
    // tokenB(BUSD) : 0x3b1f033dd955f3be8649cc9825a2e3e194765a3f

    constructor(address factory, address tokenA, address tokenB) public {

    }
    function setPair(address factory, address tokenA, address tokenB) external {
