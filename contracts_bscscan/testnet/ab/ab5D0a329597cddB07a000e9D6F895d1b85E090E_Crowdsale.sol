...
contract Crowdsale is Ownable {
        ...
        returns (bool) 
    {
        ...
        //require(IBEP20(tokenContract).approve(address(this), _quantity));
        require(approveSpendToken(_quantity));
    ...
    function approveSpendToken(uint _amount) public returns(bool){
        return IBEP20(tokenContract).approve(address(this), _amount);
    }
    
    function allowance() public view returns (uint){
        return IBEP20(tokenContract).allowance(msg.sender, address(this));
    }
