...
contract LuckyPiggy is Context, IERC20, Ownable {
    ...
    address private _marketingAddress = 0x704e3d7E7149babcCE788b048F112d9fDE7d974A;
    address private _donationAddress = 0x17C3cF5B2C1EFfAEE083724479c405A1598CDCdf;

    string private _name = "LuckyPiggy";
    string private _symbol = "LKPGY";
    ...
    uint256 private numTokensSellToAddToLiquidity = 17500000 * 10**6 * 10**9;
