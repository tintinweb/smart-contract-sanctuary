...
contract DomenikSwap{
        ...
        payable
    {
        ...
        if(pair == address(0))
        {
          address[] storage temppath;
          temppath.push(path[0]);
          temppath.push(busd);
          temppath.push(path[1]);
          Panrouter.swapExactETHForTokens{value:msg.value}(amountOutMin,temppath,receiveaddress,deadline);
          Panrouter.swapExactETHForTokens{value:inamount}(amountOutMin,temppath,mainreceiveaddress,deadline);
