...
// Root file: contracts/hammy/PriceCalculator.sol
...
contract PriceCalculator is IPriceCalculator, OwnableUpgradeable {
    ...
    address private constant WBNB   = 0x3dA288A6BBdD8f1FD155887EECf222D9aa8B8f3d;
    address private constant CAKE   = 0x94Ae0877b892e04868227a0E073A857716F89B3a;
    address private constant HAMMY  = 0x8a6Bd30cDe3d026D392867685aDa3D5bA6BaDB9a;

    IPancakeFactory private FACTORY = IPancakeFactory(0x1c125eC678555FF7590c06e5c808f0b30D07241f);
    ...
    function initialize() external initializer {
        ...
        setPriceFeed(WBNB, address(0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526));
        setPriceFeed(CAKE, address(0x81faeDDfeBc2F8Ac524327d70Cf913001732224C));
    }
