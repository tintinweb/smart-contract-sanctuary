...
contract NFT is Ownable, ERC721Token, ERC721Holder {
    ...
    function purchaseNFTSellingItem(uint256 _tokenId) public payable {
        ...
        if (sellingItem.price > 0) {
            ...
            _distribuiteToHolders(sellingItem.price);
    ...
    function _distribuiteToHolders(uint256 _amount) internal {
        uint256 amount = _amount.mul(feeToHolders).div(100).div(totalSupply()); 
