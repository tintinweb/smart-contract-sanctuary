...
contract Testing is IERC20 {
    ...
    uint256 public _buyLiquidityFee = 2000;
    uint256 public _buyMarketingFee = 400;

    uint256 public _sellReflectionFee = 400;
    uint256 public _sellLiquidityFee = 2000;
    ...
    uint256 public maxReflectionFee = 400;
    uint256 public maxLiquidityFee = 2000;
    uint256 public maxMarketingFee = 400;
    ...
    address payable private _marketingWallet = payable(0xCbDa0d8418d420A8Ee97049738D06f4044ec0fc1);

    // Max Buy TX amount is 1.5% of the total supply.
    uint256 private buyMaxTxPercent = 20; // Less fields to edit
    ...
    // Max Sell TX amount is 3% of the total supply.
    uint256 private sellMaxTxPercent = 40; // Less fields to edit
