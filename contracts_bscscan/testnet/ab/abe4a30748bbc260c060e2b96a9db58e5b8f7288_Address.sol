...
contract OlympicBunny is Context, IERC20, Ownable {
    ...
    string private _name = "OlympicBunny";
    string private _symbol = "OlympicBunny";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000000 * 10**6 * 10**18;
