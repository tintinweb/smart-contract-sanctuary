...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && contractTokenBalance > 0 && swapAndLiquifyEnabled && to == uniswapV2Pair) {
...
contract AghtyOcculus is ERC1363 {
    constructor (address routerAddress)
        ERC1363("AghtyOcculus", "AGHTYOCC", routerAddress)
    {
    }
}