...
contract test777  is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "test777";
  string constant tokenSymbol = "test777";
  ...
  function ProofOfBurn() external onlyOwner() {
        tradingEnabled = true;
  }
