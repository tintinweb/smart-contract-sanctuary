...
/**
    # Nibba Inu
    Great features: A total of 6% fee is levied on transactions
    2% fee For Automatic Liquidity on PancakeSwap (1/2 BNB & 1\2 CHIBBA)
    2% fee automatically distribute to all holders
    2% fee autofundmatically move to charity wallet (dispersed on every Sunday to valid charities)


    2% tokens are burned from owner's wallet automatically on every transaction
   
    
    Wallet Alpha – Main wallet. Airdrops, DxSale, etc from this wallet
    Wallet Beta – Founder’s wallet
    Wallet Gamma – Developer's Wallet
    Wallet Delta – Burn Wallet
    Wallet Theta – Wallet Dedicated to charity
   
    Burn – Every time a transaction takes place, 2% of tokens equivalent to 2% of that transaction are burned from “Wallet Delta”
    Locking – 
    Tokens sent for Airdrops between 05th October & 07th October for airdrops have a 3 month lock
    Tokens sent for Presale between 27th September & 30th September for presale on DxSale to have a 1 month lock post distribution

    Token Minting Schedule
        1.Phase 1 – Total 35% - 18th September
        Wallet Alpha – 35%

        2.Phase 2 – Total 27% - 19th September
        Wallet Alpha – 3.5%
        Wallet Beta – 5%
        Wallet Gamma – 8.5%
        Owner Wallet 4 – 10%

        3.Phase 3 – Total 19% = 20th October
        Wallet Alpha – 3.5%
        Wallet Beta – 4.5%
        Wallet Gamma – 3.5%
        Wallet Theta – 7.5%

        4.Phase 4 – Total 16% - 20th November
        Wallet Alpha – 8.5%
        Wallet Beta – 1.5%
        Wallet Gamma – 0.5%
        Wallet Delta – 5.5%

        5.Phase 5 – Total 3% - 20th December
        Wallet Alpha – 1%
        Wallet Delta – 2 %
 */
...
contract NibbaToken is Context, IERC20, Ownable {
    ...
    uint256 communityLockFromTime  = 1633381200;
    uint256 communityLockToTime    = 1633554000;
    uint256 communityUnLockTime    = 1641420000;
    ...
    uint256 dxsaleLockFromTime   = 1632690000;
    uint256 dxsaleLockToTime     = 1633035600;
    uint256  dxsaleLockTokenAmount= 0;
    uint256 dxsaleUnLockTime     = 1635804000;
    ...
    constructor () {
        ...
        mintpara[0].fromTime      = 1631924567;
        mintpara[0].toTime        = 1632010967;
        ...
        mintpara[1].fromTime      = 1632011207;
