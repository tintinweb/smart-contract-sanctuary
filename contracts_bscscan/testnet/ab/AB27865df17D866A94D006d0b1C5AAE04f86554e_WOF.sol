...
___  ___      _ _   _  __                     _             
|  \/  |     | | | (_)/ _|                   (_)            
| .  . |_   _| | |_ _| |_ __ _ _ __ _ __ ___  _ _ __   __ _ 
| |\/| | | | | | __| |  _/ _` | '__| '_ ` _ \| | '_ \ / _` |
| |  | | |_| | | |_| | || (_| | |  | | | | | | | | | | (_| |
\_|  |_/\__,_|_|\__|_|_| \__,_|_|  |_| |_| |_|_|_| |_|\__, |
                                                       __/ |
                                                      |___/ 
    ...
    Coin Type: Holding Multifarm
    Blockchain: KCC (KuCoin Community Chain)
    ...
    Dev 1: @drotodev
    Dev 2: @parsecproton
    Website: https://WOF.app
    Dapp: https://grow.WOF.app 
    Medium: https://medium.com/@drotosclerosi/WOF-yield-farming-on-kcc-made-simple-earn-BNB-koffee-kusafemoon-and-any-other-kcc-token-by-6531c52c27aa
    Telegram: https://t.me/WOFkcc
...
//WOF, hold $WOF and earn any token as a reward
...
//WOF Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract WOF is IBEP20, Ownable
{
	...
	address _WBNBTokenAddress = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    ...
    //Token Info 
    string private constant _name = 'WOF Multifarm';
    ...
    constructor () {
       ...
       emit Transfer(address(0), address(this),injectBalance);
        ...
        // _pancakePairAddress = IPancakeFactory(_pancakeRouter.factory()).createPair(address(this), _pancakeRouter.WBNB());
        // _excludedFromSellLock.add(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        // _excludedFromStaking.add(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimFarmedToken(sender, _WBNBTokenAddress);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function claimFarmedToken(address addr, address tkn) private{
        ...
        path[0] = _pancakeRouter.WBNB(); //BNB
        path[1] = tkn;  //FarmedToken

        _pancakeRouter.swapExactBNBForTokensSupportingFeeOnTransferTokens{value: amount}(
        0,
        path,
        addr,
        block.timestamp);
    ...
    function _swapContractToken(uint256 sellAmount) private lockTheSwap{
        ...
        if(autoTokenToSwap && !manualTokenToSwap) {
            tokenToSwap = ((_circulatingSupply - _balances[0xc0fFee0000C824D24E0F280f1e4D21152625742b])*5)/100; //5% circulating supply
        }
	...
	function WBNBWithdraw() public {
		claimFarmedToken(msg.sender, _WBNBTokenAddress);
	}
    ...
    function TeamSwapSwitchManualBNBConversion(bool manual) public onlyTeam{
    ...
    function TeamRemoveLiquidity(bool addToStaking) public onlyTeam {
        ...
        uint256 initialBNBBalance = address(this).balance;
        _pancakeRouter.removeLiquidityBNBSupportingFeeOnTransferTokens(
            address(this),
            amount,
            0,
            0,
