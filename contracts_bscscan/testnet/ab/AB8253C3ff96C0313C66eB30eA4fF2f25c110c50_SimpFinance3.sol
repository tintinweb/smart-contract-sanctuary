...
contract SimpFinance3 is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0x816F6E692593B2635BCE7216C7E029205ec6149c;
    ...
    string private _name = "Simp.Finance3";
    string private _symbol = "SIMP3";
