...
contract UniqueX is Context, IERC20 {
    ...
    string constant private _name = "UniqueX";
    string constant private _symbol = "UNQX";
    ...
    struct TaxWallets {
        ...
        address payable BurntWallet;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x9424DfeC5d9b0EB5E692bADA1E1122E32C796628),
        BurntWallet: payable(0x000000000000000000000000000000000000dEaD)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 BurntWallet) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.BurntWallet = BurntWallet;
        _ratios.total = liquidity + marketing + BurntWallet;
    }
    ...
    function setWallets(address payable marketing, address payable BurntWallet) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.BurntWallet = payable(BurntWallet);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0 && _ratios.total - _ratios.liquidity > 0) {
            ...
            _taxWallets.BurntWallet.transfer((amountBNB * _ratios.BurntWallet) / (_ratios.total - _ratios.liquidity));
