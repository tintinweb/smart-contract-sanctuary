...
contract FlokiLINK is ERC20, Ownable {
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    require(sellFeeIncreaseFactor >= 100 && sellFeeIncreaseFactor <= 500, "FlokiLINK: Sell transaction multipler must be between 100 (1x) and 500 (2x)");
...

{
  ...
  "libraries": {
    "/C/Jay-Desktop-02282021/VSC/ACME/projects/FlokiLINK/contracts/FlokiLINK.sol": {
      "IterableMapping": "0xbfCB257b12E2FB1475793a30CC48C0bE3c9B2DFE"
    }
  },
  "outputSelection": {
    "*": {
