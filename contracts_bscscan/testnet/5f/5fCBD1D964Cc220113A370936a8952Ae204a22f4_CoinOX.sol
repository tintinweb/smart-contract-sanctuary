...
/**
 * CoinOX Anti Whale Token
 * Total Supply : 100,000,000
 * Total Burn : 79,000,000
 * Remainder : 21,000,000
 * Team : 500,000
 * PancakeSawap Liquidity Lock : 20,500,000 - 1 YEAR
 * Liqudity Lock Check : https://mudra.website/
 * Telegram Group : https://t.me/coinoxtokenoffical
 */
...
contract CoinOX is Ownable, ERC20Burnable {
    using SafeMath for uint256;

    mapping(address => bool) whales;
    uint256 public maxSupply = 100 * 10**6 * 10**18;
    uint256 public capFarm = 79 * 10**6 * 10**18;
