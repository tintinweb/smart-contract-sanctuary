...
/**
   ...
   4% fee auto moved to BuyBack wallet
   Developed by Abdur Telegram @abdur4567
*/
...
contract BabyMa is Context, IERC20, Ownable {
    ...
    address private _BuyBackWallet = 0xfe6db7D1De49524a5Da1790009De72099A6b353F;
    ...
    constructor () {
       ...
       // testnet router addredd IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[_BuyBackWallet] = _rOwned[_BuyBackWallet].add(rCharity);
        if(_isExcluded[_BuyBackWallet])
            _tOwned[_BuyBackWallet] = _tOwned[_BuyBackWallet].add(tCharity);
    }
