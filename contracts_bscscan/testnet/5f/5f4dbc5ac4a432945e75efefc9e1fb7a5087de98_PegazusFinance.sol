...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.1.0/contracts/utils/Address.sol
...
contract PegazusFinance is Context, IERC20, Ownable {
    ...
    string private _name = "Pegazus Finance";
    ...
    uint256 private minimumTokensBeforeSwap = 3 * 10**11 * 10**9; 
    
    address payable public charityAddress1 = payable(0xb677638fc7AD0E9F0BaceD78F43aC8f19F46d6e7);
    // address payable public charityAddress2 = payable(0xd73258a16041c32BF4fae19b40Aa75E63C9F22Bd);
    // address payable public charityAddress3 = payable(0x57a91d0Ff82B9047d05922C5666ed46bd7aD6A5d);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 donationTransfer = address(this).balance;
        // uint256 donationTransfer = (address(this).balance) / 3;
        
        TransferCharityBNB(charityAddress1, donationTransfer); 
        ...
        _tDonationTotal = _tDonationTotal + donationTransfer;
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount * _donationFee / 10**2;
    }
    ...
    function setMaxTxPercent(uint256 maxTxPercent, uint256 maxTxDecimals) external onlyOwner() {
        _maxTxAmount = _tTotal * maxTxPercent / 10**(uint256(maxTxDecimals) + 2);
    }    
