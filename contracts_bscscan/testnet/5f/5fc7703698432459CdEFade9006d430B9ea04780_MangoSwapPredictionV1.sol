...
contract MangoSwapPredictionV1 is Ownable, Pausable, ReentrancyGuard {
  ...
  function _calculateRewards(uint256 epoch) internal {
    ...
    // Add to treasury
    treasuryAmount += totalAmount - rewardAmount;
  ...
  function claimTreasury() external nonReentrant onlyOwner {
    ...
    treasuryAmount = 0;
    _safeTransferBNB(_owner, currentTreasuryAmount);
  ...
  function controlRoundStart() external onlyOwnerOrOperator whenNotPaused {
