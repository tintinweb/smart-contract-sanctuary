...
contract Voting1 {
    ...
    WithdrawalDays=Voters.GetBlockNumber(account)/24/60/60;
    ...
    if(YouAreStar1==true){YouAreStar=1;starActiveDays=star1update/24/60/60;}
    if(YouAreStar2==true){YouAreStar=2;starActiveDays=star2update/24/60/60;}
    if(YouAreStar3==true){YouAreStar=3;starActiveDays=star3update/24/60/60;}
    if(YouAreStar4==true){YouAreStar=4;starActiveDays=star4update/24/60/60;}
