...
contract LpVault{
    ...
    event Stake(address indexed _user, uint _poolId, uint _amount, uint lpRewards);
...
//------------------------------------------AirDrop--------------------------------------------------
    ...
    */
    ...
    event StakeAirdrop(address indexed user, uint amount);
    
    event UnstakeAirdrop(address indexed user, uint amount);
