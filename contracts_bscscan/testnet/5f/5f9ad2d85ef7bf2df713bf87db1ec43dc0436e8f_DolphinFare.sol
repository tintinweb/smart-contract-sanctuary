...
contract DolphinFare is Context, IERC20, Ownable {
    ...
    string private _name = "DolphinFare";
    string private _symbol = "PHIN";
    ...
    function _transfer(
        ...
        require (!isBlackListed(from) && !isBlackListed(to), "Token transfer refused. Receiver is on blacklist");
