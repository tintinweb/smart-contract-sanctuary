...
import "./BigreflectionDistributor.sol";
import "./SafeMath.sol";
import "./Address.sol";
import "./IERC20.sol";
import "./Context.sol";
 ...
 *  3.75% Marketing
 */
contract Bigreflection is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = "Bigreflection";
    ...
    address public marketingFeeReceiver = 0x50a9f5E130dC160164d4F62f48D553799c20CD70;
    ...
    // gas for distributor
    BigreflectionDistributor public distributor;
    ...
    // Uniswap Router V2 ? IDEXRouter(_router) : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);  //pcsV2 mainnet
    ...
    constructor (
        ...
        distributor = new BigreflectionDistributor(_dexRouter);
    ...
    function setDistributor(address payable newDistributor) external onlyOwner {
        ...
        distributor = BigreflectionDistributor(newDistributor);
