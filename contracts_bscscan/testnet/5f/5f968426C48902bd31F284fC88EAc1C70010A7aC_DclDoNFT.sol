...
abstract contract BaseDoNFT is OwnableContract,ReentrancyGuard,ERC721Enumerable,IBaseDoNFT {
    ...
    function getUser(uint256 orignalNftId) public view returns(address){
        return checkInUserMapping[orignalNftId];
    }
    ...
    function isExists(uint256 tokenId) public view virtual returns (bool) {
