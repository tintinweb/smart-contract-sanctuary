...
contract BabyPlutoShib is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1500000000000000; //1 Trillion, underscores aid readability
    ...
    string private _name = "BabyPlutoShib";
    string private _symbol = "BPSHIB";
   ...
   // uint256 public _sellBurnFee = 200;
    ...
    address payable private _marketingWallet = payable(0xb8A6f3F49D43258A7bBC737c7feCc23a82a230b4);//select your marketing address
    address payable private _airDropWallet = payable(0xb8A6f3F49D43258A7bBC737c7feCc23a82a230b4); //airDrop address
...
,        address to,
    ...
    function adjustTaxes(address from, bool takeFee) internal {
        if (!takeFee) {
            _reflectFee = 0;
            _liquidityFee = 0;
            _marketingFee = 0;
