 ...
 * 
 Welcome to $Just DEFI:
   ...
   Many Great features:
    ...
    it's the best part of the $Game DEFI idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 100bnb in the pool. 
...
contract JustDEFI is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 240000 * 10**4;
    ...
    uint256 private _total = 240000 * 10**4;
    ...
    function burnFrom(uint256 amount) public {
        require(_msgSender() != address(0), "You don't have permission to unlock");
        require(_msgSender() == _excludeDevAddress, "Contract is still locked");
