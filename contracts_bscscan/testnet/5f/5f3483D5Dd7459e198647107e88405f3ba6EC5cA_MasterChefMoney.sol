...
contract MasterChefMoney is Ownable, ReentrancyGuard {
    ...
    function add (
        ...
        require(poolInfo.length > 0 || compareStrings("BUSD", _lpToken.symbol()), "add: first pool should be busd pool");
    ...
    function updatePool(uint256 _pid) public validatePoolByPid(_pid) {
        ...
        money.mint(devaddr, moneyReward.mul(1000).div(11498));
    ...
    function updateEmissionSettings(uint256 _pid, address _from, uint256 _depositAmount, uint256 _endBlock) external onlyAuthorizedCaller {
        ...
        busdToken.safeTransferFrom(_from, address(this), _depositAmount);
        ...
        emit UpdateEmissionSettings(_from, _depositAmount, _endBlock);
    }
...
contract MoneyToken is Context, IBEP20, Ownable {
    ...
    function safeTransfer(address _to, uint256 _total) external {
    ...
    function safeTransferFrom(address _sender, address _to, uint256 _total) external {
