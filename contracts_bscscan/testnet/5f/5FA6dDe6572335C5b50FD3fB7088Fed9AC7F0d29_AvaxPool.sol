...
//Avax Pool Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract AvaxPool is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'AvaxPool';
    string private constant _symbol = 'AVAXPOOL';
    ...
    uint16 public constant MaxSellLockTime= 15 minutes;
    //The time Liquidity gets locked at start and prolonged once it gets released
    uint256 private constant DefaultLiquidityLockTime=10 days;
    //The Team Wallet
    address public constant TeamWallet=0x530EdA6268F7F3F67a2f93Cb93ad3bF88472DDC3;
    //TestNet
    ...
    uint8 public constant MaxTax=21;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            //Sells can't exceed the sell limit(100.000 Tokens at start, can be updated to circulating supply)
            ...
            if(amount<=10**(_decimals)) claimAVAX(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    //Devs share
    uint8 public marketingShare=25;
    ...
    event OnWithdrawAVAX(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimAVAX(address addr) private{
       ...
       // path[1] = 0x1ce0c2827e2ef14d5c4f29a091d735a204794041;  //AVAX Binance-Peg
        ...
        emit OnWithdrawAVAX(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function AVAXWithdraw() public{
        claimAVAX(msg.sender);
    }
    ...
    //Sets Taxes, is limited by MaxTax(21%) to make it impossible to create honeypot
    ...
    function TeamRemoveLiquidity() public onlyTeam {
        ...
        //Removes Liquidity and either distributes liquidity BNB to stakers
        ...
        uint256 newBNBBalance = address(this).balance-initialBNBBalance;
            ...
            _liquidityRemoved = true;

    }
    //Releases all remaining BNB on the contract wallet, so BNB wont be burned
    //Can only be called after liquidity is added to staking pool
    function TeamRemoveRemainingBNB() public onlyTeam{
        
        if(_liquidityRemoved){
            require(block.timestamp >= _liquidityUnlockTime+3 days, "Not yet unlocked");
            _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
