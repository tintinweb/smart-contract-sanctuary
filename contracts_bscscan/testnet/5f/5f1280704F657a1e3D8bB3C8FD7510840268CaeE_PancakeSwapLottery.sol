...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    mapping(uint256 => mapping(uint64 => uint256)) private _numberTicketsPerLotteryId;
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < _ticketNumbers.length; i++) {
            ...
            _numberTicketsPerLotteryId[_lotteryId][1 + (thisTicketNumber % 100)]++;
            _numberTicketsPerLotteryId[_lotteryId][11 + (thisTicketNumber % 10000)]++;
            _numberTicketsPerLotteryId[_lotteryId][111 + (thisTicketNumber % 10000000)]++;
            _numberTicketsPerLotteryId[_lotteryId][1111 + (thisTicketNumber % 100000000)]++;
            _numberTicketsPerLotteryId[_lotteryId][11111 + (thisTicketNumber % 10000000000)]++;
            _numberTicketsPerLotteryId[_lotteryId][111111 + (thisTicketNumber % 1000000000000)]++;
        ...
        nonReentrant
    {
        ...
        for (uint32 i = 0; i < 6; i++) {
            uint32 j = 5 - i;
            uint32 transformedWinningNumber = _bracketCalculator[j] + (finalNumber % (uint32(10)**((j + 1)*2)));
