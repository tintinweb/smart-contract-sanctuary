...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0x41a0bb70e8bbc07b53e60135514d4e3a112f285bd9300bfc522404bf19591a2f;
...
contract Bitrub is Context, IERC20, Ownable {
    ...
    string private constant _symbol = 'RUBS';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x649E5D8FC80e34fD7D2C114Bdd05a6084F78D1De, 'We can not exclude router.');
