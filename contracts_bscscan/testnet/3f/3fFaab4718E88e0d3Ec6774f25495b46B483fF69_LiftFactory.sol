...
contract LiftFactory is IPancakeFactory {
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(LiftPair).creationCode));
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        bytes memory bytecode = type(LiftPair).creationCode;
...
contract LiftPair is IPancakePair, PancakeERC20 {
