...
contract SafeBank is ERC20, Ownable {
    ...
    // timestamp for when the token can be traded freely
    ...
    constructor() public ERC20("SafeBank", "sBank") {
        uint256 _tokenRewardsFee = 0;
        uint256 _liquidityFee = 0;
        uint256 _wallet1Fee = 0;
        uint256 _wallet2Fee = 0;
        uint256 _wallet3Fee = 0;
        ...
        // abilita trasferimento prima del trading 
    ...
    // trading disabilitato fino a data impostata 
