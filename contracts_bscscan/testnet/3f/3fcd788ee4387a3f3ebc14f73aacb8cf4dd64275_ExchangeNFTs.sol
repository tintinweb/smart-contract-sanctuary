    ...
    UUPSUpgradeable
{
    ...
    function readyToSellTokenToNoStatus(
        address _nftToken,
        uint256 _tokenId,
        address _quoteToken,
        uint256 _price,
    ...
    function readyToSellTokenNoStatus(
        address _nftToken,
        uint256 _tokenId,
        address _quoteToken,
        uint256 _price
    ...
    function readyToSellTokenTo(
        ...
        require(_msgSender() == IERC721Upgradeable(_nftToken).ownerOf(_tokenId),
                'Not owner');
    ...
    function updateBidPrice(
        ...
        require(bidEntry.price != _price, "Same price");
        require(
