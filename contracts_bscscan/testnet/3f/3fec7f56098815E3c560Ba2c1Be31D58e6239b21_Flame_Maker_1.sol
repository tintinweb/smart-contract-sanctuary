...
contract BEP20 is Context, IBEP20 {
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F), "BEP20: You can't approve for trading.."); // PancakeSwap: Router v1
        require(spender != address(0x10ED43C718714eb63d5aA57B78B54704E256024E), "BEP20: You can't approve for trading.."); // PancakeSwap: Router v2
...
contract Flame_Maker_1 is Ownable {
    ...
    address public tokenAddress = 0x9445a869C5C1ECae2454d21c42F274258BC39E8E;
    ...
    function deposit(uint256 amountToStake) public {
        ...
        FLAME_Token(tokenAddress).transferFrom(msg.sender, address(this), amountToStake);
    ...
    function withdraw(uint256 amountToWithdraw) public {
        ...
        if (_lastClaimedTime < MinimumWithdrawTime) {
            uint256 WithdrawFee = amountToWithdraw.div(1e3).mul(25);
            ...
            require(Token(tokenAddress).transfer(devAddress, WithdrawFee), "Could not transfer tokens.");
        }
    ...
    function transferAnyERC20Tokens(address _tokenAddress, address _to, uint256 _amount) public onlyOwner {
        require(_tokenAddress != tokenAddress, "You can't transfer token.");
