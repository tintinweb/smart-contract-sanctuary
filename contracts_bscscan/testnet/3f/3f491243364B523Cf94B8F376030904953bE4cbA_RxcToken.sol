...
contract RxcToken is Context, IBEP20, Ownable, ReentrancyGuard {
  ...
  function setBlacklistAddress(address blacklistAddress, bool toggleBlacklistAddress) public onlyOwner {
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "dec allowance below zero"));
    return true;
  }
  ...
  function _transfer(address actualSender, address sender, address recipient, uint256 amount) internal {
    ...
    require(_getCurrentBalance(sender) >= amount,"insufficient balance");
  ...
  function acceptPresaleUnlockPayment() public nonReentrant payable {
      require(safeSaleActive, "Presale inactive");
      require(msg.value == _presaleUnlockPrice, "Unlock fee incorrect");
      require(totalTokensTradedPresale <= presaleMaxTokens, "Presale is Full");
      _presaleUnlocked[msg.sender] = true;
      emit presaleUnlockSuccessful(msg.sender, "Presale unlock!");
  }
  ...
  */
  function acceptPresalePayment() public nonReentrant payable {
      ...
      require(_presaleUnlocked[msg.sender], "Wallet not unlocked"); // make sure they unlocked
      require(tokenLocks[msg.sender].amount == 0, "Already have tokens locked");
      ...
      emit presalePaymentSuccessful(msg.sender, "Payment Success");
  ...
  function manualPresaleAssignment(address recipient, uint256 _tokens, uint256 _lockStartTime, uint256 _lockEndTime) public onlyOwner {
      ...
      emit presalePaymentSuccessful(recipient, "Payment Success");
  }
