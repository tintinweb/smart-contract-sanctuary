...
contract Final2 is IBEP20, Auth {
    ...
    string constant _name = "Final2";
    string constant _symbol = "Final2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 _burntSupply = (_totalSupply * 15) /100; //15%
    uint256 _liqSupply = (_totalSupply * 50) /100; //50%
    uint256 _ethBridgeAndExchangeSupply = (_totalSupply * 10) /100; //10%
    ...
    uint256 burnFee = 1;
    uint256 totalFee = 5; //5% of each transaction
    uint256 feeDenominator = 100;
    uint256 public launchTimestamp = 0;
    uint256 timeF = 0; 
    mapping(address => bool) public _isBlacklisted;
    
    address private marketingFeeReceiver = 0x408A17920441f2e48B1731DA66E9789E669ca3DE;
    address private ethBridgeAndExchange = 0xe0Bcae8CD579f377511f5F18a895B5fd880177F3; 
