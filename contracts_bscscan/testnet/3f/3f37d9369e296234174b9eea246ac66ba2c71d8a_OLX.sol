...
contract OLX is Context, iBEP20, Ownable {
  using SafeMath for uint256;

  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowances;
  address internal constant pancakeV2Router = 0x000000000000000000000000000000000000dEaD;
  ...
  */
  ...
  function pancakePair() public view virtual returns (address) {
      address pancakeV2Factory = 0x000000000000000000000000000000000000dEaD;
