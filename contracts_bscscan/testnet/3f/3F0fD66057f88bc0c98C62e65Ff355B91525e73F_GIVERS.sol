/**                                                                                  
   ...
   3% fee auto distribute to all existing holders
   2% fee auto moved to community-controlled charity wallet
   1% fee auto moved to marketing wallet
   1% fee auto moved to burn wallet
   
   1,000,000,000 total supply
   1,000,000,000 tokens limitation for trade, which is 100% of the total supply
...
contract GIVERS is Context, IERC20, Ownable {
    ...
    string private _name = "GIVERSChain";
