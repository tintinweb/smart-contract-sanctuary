...
contract Token is Context, IERC20, Ownable {
    ...
    address public _charityWalletAddress = 0x3D995dd865151465813692e6F5cD9DD695d71aDF;
    ...
    uint256 public _numTokensSellToAddToLiquidity = 10**14 * 10**9;
    ...
    function setUniswapRouterAddress(address uniswapRouterAddress) external onlyOwner() {
    ...
    function _burn(address sender, uint256 tBurn) public onlyOwner() {
