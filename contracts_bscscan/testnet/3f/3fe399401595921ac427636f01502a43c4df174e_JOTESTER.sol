...
contract JOTESTER is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4ABdD6e4BAe7c3a97d665AFeD43Ccc992ab83f19); // Marketing Address
    ...
    string private _name = "JOETESTER";
    string private _symbol = "JT99";
