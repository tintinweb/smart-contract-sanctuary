...
contract MarketPlace is ERC721Enumerable , ReentrancyGuard{
    ...
    function purchaseToken(uint256 _tokenId) public nonReentrant {
        ...
        require(IERC20(token).allowance(msg.sender,ownerOf(_tokenId)) >= _tokenMeta[_tokenId].price);
        ...
        IERC20(token).transferFrom(msg.sender,tokenSeller,_tokenMeta[_tokenId].price);
    }
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract Doge is ERC721, MarketPlace, ERC721Metadata {
    constructor (string memory name, string memory symbol,address _token) public ERC721Metadata(name, symbol) MarketPlace(_token){
