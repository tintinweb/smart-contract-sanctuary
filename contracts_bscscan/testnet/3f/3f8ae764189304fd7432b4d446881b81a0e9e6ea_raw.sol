    ...
    contract raw is Context, IERC20, Ownable {
        ...
        constructor (address payable charityWalletAddress) public {
          ...
          //IPancakeV2Router02 _pancakeV2Router = IPancakeV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Mainnet
            IPancakeV2Router02 _pancakeV2Router = IPancakeV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // testnet // https://twitter.com/PancakeSwap/status/1369547285160370182
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if(_isAntiDumpEnabled == true && sender != owner() && recipient != owner()){
                ...
                else if(sender != pancakeV2Pair && recipient != pancakeV2Pair){
            ...
            if (!inSwap && swapEnabled && overMinTokenBalance && sender != pancakeV2Pair) {
