...
contract iSure is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x4f6C16Dedd6219c0C57C11040e4F8a50BA6Dd477;
    ...
    string private _name = "iSure";
    string private _symbol = "ISUR";
    ...
    uint256 private numTokensSellToAddToLiquidity = 900000000  * 10**18;
    ...
    function setcharityWalletAddress(address newAdd) external onlyOwner() {
