...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Bruteforcefight is Context , IERC20, Ownable {
    ...
    string private _name = "Brute Force Fight";
    string private _symbol = "$BFORCE";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 3;
    uint256 private _previousTaxFee = _taxFee;
        address public TaxWallet = 0xE212bE426c98fbd42c56B78964D12e01282a1eAa; 
    ...
    uint256 public _maxTxAmount = 100000 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9;
    uint256 public _maxWalletToken = 500000 * 10**9;
