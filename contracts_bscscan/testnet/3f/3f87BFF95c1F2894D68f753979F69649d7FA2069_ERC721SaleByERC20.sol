...
contract ERC721SaleByERC20 is Ownable, IERC721Receiver, AbstractSale {
    ...
    function buy(IERC721 token, uint256 tokenId, address erc20, uint256 price, uint256 sellerFee, Sig memory signature) public payable {
        ...
        transferERC20(token, tokenId, erc20, price, owner, sellerFeeToSlash);
    ...
    function transferERC20(IERC721 token, uint256 tokenId, address _erc20, uint256 price, address owner, uint256 sellerFeeToSlash) internal returns (uint256) {
