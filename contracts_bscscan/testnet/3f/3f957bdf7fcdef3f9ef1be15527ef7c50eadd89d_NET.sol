...
contract NET is ITRC20, Owend{
    ...
    uint256 private _totalPool=210000000*10**18;
    ...
    address private _kolAddress = 0x532792B73C0C6E7565912E7039C59986f7E1dD1f;

    address private _poolAddress=0x3d91185a02774C70287F6c74Dd26d13DFB58ff16;
    ...
    function output()public onlyOwner{
        ...
        require(block.timestamp.sub(_lastTimestamp)>60,"Error: not yet time");
        ...
        _lastTimestamp=_lastTimestamp.add(60);
    ...
    function _release(address _address) private{
        ...
        uint256 _cycleTimestamp=_cycle.mul(60).mul(60);
