...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x9a01bf917477dD9F5D715D188618fc8B7350cd22); //BUSD
...
contract PORONGA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PORONGA FINANCE";
    ...
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address RewardToken = 0x9a01bf917477dD9F5D715D188618fc8B7350cd22;

    uint256 _totalSupply = 69_69_69_69 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xC9B144f431ea695ED3bCaB6b027929Ec6382155D;  // teamwallet
        lotteryWallet = 0xC9B144f431ea695ED3bCaB6b027929Ec6382155D;  // lotterywallet
