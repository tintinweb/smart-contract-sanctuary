...
contract Lgtbi is RMB {
    ...
    address separateForControllBurns, address donationAddress, address [] memory  board)  {
        ...
        emit Transfer(address(0), CEO, _tTotal);
        //transfer to Board
        emit Transfer(CEO, CMO,_tenPercent );
        emit Transfer(CEO, RHH,_tenPercent);
        emit Transfer(CEO, separateForControllBurns, _BurnPercent);
        emit Transfer(CEO, donationAddress, _DonationPercent);
    }
