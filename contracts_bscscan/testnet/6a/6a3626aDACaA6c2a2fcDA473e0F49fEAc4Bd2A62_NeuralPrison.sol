...
contract NeuralPrison is Ownable {
  ...
  address private _aiAddress = 0xF347EEFeEbB934FbAB19a5C709B1693F6C6ddDCf;
  address private _pepeAddress = 0x723ECe96C7AA58b1fd3bc2bf1F08549C9f801D88;
  ...
  mapping(uint256 => uint256) private _pepeRevealed;
  ...
  function swapPepeForPepe(uint256 incomingTokenId) public {
    ...
    require(AI.balanceOf(_msgSender()) >= pepeAiPrice, 'Not enough ai');

    AI.transferFrom(msg.sender, _aiTreasuryAddress, pepeAiPrice);
    PEPE.safeTransferFrom(msg.sender, address(this), incomingTokenId);
