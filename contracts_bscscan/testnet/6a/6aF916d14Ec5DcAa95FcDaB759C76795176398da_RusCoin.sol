...
//////////((/*//*,.,/*,,.........   .....   .........,,***,,*///////*////////// On BEP-20 5,000,000 RSC coins in total, 26% for the team, marketing, etc.
///////////*/*.,***,......  .,*****************,.. .......**,*,,(/*/*////////// 74% for investors
///////(/*//,,,**,.......,*,,*/((####((((((###((/*,,*,.......,**,,,//*///****//
...
/*(***,. ..,,*((,         *##################(*.                   . .,/**(*///
//(,***,....,*/#/.        *#####%/ *#######*.                      . .,**,(*(// Send BNB to the address of this contract and you will receive RSC to your wallet within 30 seconds.
///****,....,**((*        *#####%(   *#######(.                   ....*,/,(*(//
...
//(/*/,,**,.....,**(#/.   .******,         .********.  ,//.    ....**,,//*(((//
//%%(*(,.*/,......***/#(,                           .*(/***, ....,/*..(*/#%%%// Creator of RusCoin fund is Alexey Bykov (albykov.com), Ph.D. in economics, best option trader of Russia in 2014.
//////*(/.,**,......,*,*/#(*.                    ,/(/*,*,. ....,***.*(*(/////// Team of the fund are professionals in finance, IT development, marketing and public relations with 25+ experience.
////////*/*,,,**.......,*****/(((/**,,,,,,**/((//****,. .....,**,,*(*//,,,,,,//
////////(/*//,.,/*,....,. .,,***,,*********,,,**,.. .,....,*/*.,/(*/((/,,,,,,// 1. Get profit due to price growth of RusCoin (limited amount of tokens, 2x offer price in every round of sales).
/////////*##///*,,,***,...............................,,**,,,*//*(/**********// 2. Fund investment decisions lead to an increase in token prices (80% of profit is directed to the buyback of RSC).
/////////*##*/(**(/..*,,//,..,,..     .      ..,..,*/*,*,.*(/*((/(/**********// 3. Get profit from staking (payments on the 1st and 15th of each month). Read more on ruscoin.vip.
/////////*##*/###(/*///*,,.,**********************,,,,///*/((##(/(/**********//
/////////*##*/#######((/**/((/*,,.,. * ,..,.,,*/((/**/(#####(##(/(/**********// Twitter: https://twitter.com/RusCoin20
/////////*##*/#######((#####((//******/******//((##(########(##(/(/**********// LinkedIn: https://www.linkedin.com/in/ruscoin/
/////////////////////////////////////////////////////////////////////////////// Facebook: https://www.facebook.com/groups/ruscoin.eng/
/////////////////////////////////////////////////////////////////////////////// Telegram: https://t.me/RusCoin_Eng
/////////////////////////////////////////////////////////////////////////////// Instagram: https://www.instagram.com/ruscoin20/, https://www.instagram.com/alekseybykov1/
///////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////// Vkontakte RUS: https://vk.com/ruscoin2020, Facebook RUS: https://www.facebook.com/groups/ruscoin, Telegram RUS: https://t.me/ruscoin_20
///////////////////////////////////////////////////////////////////////////////
...
contract RusCoin is ERC20, Ownable, ERC20Burnable, ERC20Permit {
    ...
    uint256 public gasPrice = 500; // BNB price
    uint256 public minBoughtPrice = 0.2 * 10 ** 8; // min BNB to buy RusCoin

    /* first sales round RusCoin == $50 (28.08.2021 - 28.11.2021) */
    uint256 public rusCoinToSell = 700000 * 10 ** decimals(); // 700 000 RusCoin
    uint256 public rusCoinPrice = 50; // RusCoin USDT price
    uint256 public start = 1630108800; // start date: 28.08.2021
    uint256 public end = 1638057600; // end date: 28.11.2021

    /* second sales round RusCoin == $100 (28.12.2021 - 28.03.2022) */
    // uint256 public rusCoinToSell = 1000000 * 10 ** decimals(); // 700 000 RusCoin for the first round of sales
    // uint256 public rusCoinPrice = 100; // RusCoin price
    // uint256 public start = 1640649600; // 28.12.2021
    // uint256 public end = 1648425600; // 28.03.2022

    /* third sales round RusCoin == $200 (28.04.2022 - 28.10.2022) */
    // uint256 public rusCoinToSell = 1000000 * 10 ** decimals(); // 700 000 RusCoin for the first round of sales
    // uint256 public rusCoinPrice = 100; // RusCoin price
    // uint256 public start = 1651104000; // 28.04.2022
    // uint256 public end = 1672185600; // 28.12.2022

//    uint256 public minimalStakingDays = 100; // minimal staking days

    constructor() ERC20("NovoCoin9", "NSC") ERC20Permit("RusCoin") {
    ...
    function withdrawBalance(uint256 amount) public returns (bool) {
        ...
        uint256 ownerShare = amount * 2 / 100;
    ...
    function setGasPrice(uint256 _gasPrice, uint256 _minBoughtPrice) public onlyOwner returns (bool) {
        gasPrice = _gasPrice;
    ...
    function setPurchaseRound(uint256 _rusCoinToSell, uint256 _rusCoinPrice, uint256 _start, uint256 _end) public onlyOwner returns (bool) {
    ...
    function _sellRusCoin (address from, uint256 amount) private {

        // calculate the number of RusCoin equivalent to this BNB amount
        // and round RusCoin's value to 2 decimals
        uint256 tokens = ((amount * gasPrice / rusCoinPrice / 1000) + 5) / 1000 * 1000;
        ...
        require(tokens <= rusCoinToSell, 'Not enough RusCoin in this round of purchase, sorry :(');
    ...
    event SellEvent(address from, uint256 amount, uint256 tokens);
}
