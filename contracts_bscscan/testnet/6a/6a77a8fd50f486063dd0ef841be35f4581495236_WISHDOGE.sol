...
contract WISHDOGE is ERC20, Ownable, SafeToken, LockToken {
    ...
    constructor() ERC20("testWishDoge", "TTWG") {
        BNBRewardsFee = 4;
        liquidityFee = 6;
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    //    uint256 toSwap = contractTokenBalance.sub(tokensToAddLiquidityWith);
        ...
        uint256 buyBackandburnportion = deltaBalance.mul(liquidityFee.div(4).div(totalFees));
        ...
        buyBackAndBurn(buyBackandburnportion);
