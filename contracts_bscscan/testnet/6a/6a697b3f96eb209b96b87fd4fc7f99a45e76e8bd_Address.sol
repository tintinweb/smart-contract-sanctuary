...
contract PAMIRToken is Context, IERC20, Ownable {
    ...
    string private _name = "PAMIR";
    string private _symbol = "PAMIR";
    ...
    uint256 public _maxTxAmount = 9000000000 * 10**1 * 10**9;
    ...
    constructor (address payable charityWalletAddress) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD7d6ab940d422F82f9D933ef5c88c6e207e05C3F);
