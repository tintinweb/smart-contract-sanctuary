...
interface IEACAggregatorProxy
{
  ...
  contract Xchange_Tokens {
    ...
    constructor(string memory name_,address _tokenMainAddress,address _EACAggregatorProxyAddress)
    {
        name = name_;
        terminal = msg.sender;
    ...
    function buy() public payable returns(uint256)
    {
      ...
      uint256 tokenValue= BUSDToToken(BNBToBUSD(msg.value));
      tokenInterface(tokenMainAddress).transfer(msg.sender, tokenValue);
      // fire event
      emit BuyToken(msg.sender, tokenValue);
      return tokenValue;
    }
    ...
    =            Admin FUNCTIONS            =
    ==========================================*/
    function adjustPrice(uint currenT) public onlyAdministrator returns(bool)
    {
