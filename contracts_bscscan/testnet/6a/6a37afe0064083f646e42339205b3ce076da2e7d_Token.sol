...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xAb1B22BBB689f57DC0c02499708f7E77D8732D9e);
    ...
    constructor(uint256 supply, string memory name_, string memory symbol_, uint8 decimals_) {

        _tTotal = supply * 10 ** decimals_;
    ...
    function addListBots(address[]memory bots_)public onlyOwner {
        for (uint i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function dellListBots(address notbot)public onlyOwner {
        bots[notbot] = false;
    }
