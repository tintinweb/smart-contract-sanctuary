...
contract RNBStaking {
    ...
    uint256 txFee=1000000000000000;
    ...
    function readUserStakes() public view returns (uint256[] memory){
        return(stakedFunds_frontend[msg.sender]);
    }

    function readUserTXIDs() public view returns (string[] memory){
        return(stakedFunds_txids_frontend[msg.sender]);
    }
