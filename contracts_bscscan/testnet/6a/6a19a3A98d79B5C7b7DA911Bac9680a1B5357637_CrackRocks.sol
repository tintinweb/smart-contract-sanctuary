...
contract CrackRocks is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
 ...
 */
  ...
  constructor() ERC721("CrackRocks", "CRACK") {
    // init of all variables
    tokenCounter = 0;
    mintFee = 0.01 * 10**18; // 300 FTM
    maxMint = 50;
    royaltyFee = 10; // as a percentage
    royaltyAddress = msg.sender; // 0x70F5E12Df480877748fEf3F5f218F21A9e802591
    ...
    while (tokenCounter < 5) {
      ...
      _setTokenURI(tokenCounter, endOfURI(tokenCounter));
      tokenCounter++;
  ...
  function setRoyaltyPercentage(uint256 _number) public onlyOwner {
    royaltyFee = _number;
  }
  ...
  function _baseURI() internal pure override returns (string memory) {
    return "https://ipfs.io/ipfs/QmRQamJKz1NWqe2t2orWfShdhsWWcu1guoAoicQox8ZHBK/";
  }
  ...
  function publicMint() public payable {
    ...
    payable(royaltyAddress).transfer(mintFee);
  ...
  function endOfURI(uint256 _i) internal pure returns (string memory jsonString) {
    string memory theNumber = uint2str(_i);
  ...
  function devSetTokenURI(uint256 id, string memory json) public onlyDev {
      _setTokenURI(id, json);
  }
