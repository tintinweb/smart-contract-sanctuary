...
contract SoccerPunks is ERC721URIStorage, Ownable{
    ...
    uint256 public totalCount = 14000; //bruhTotal
    uint256 public maxBatch = 20; // bruhBatch
    uint256 public price = 60000000000000000; // 0.06 eth
    uint256 public releaseUnix = 1630447200; // 1631916000 works KEKW
    ...
    function mintSoccer(uint256 _times) payable public mintEnabled {
