...
contract DogeFruit is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xCA22CF897aE8279c1fbb8f4139760E6B3DAA0a30); // Marketing Address
    ...
    string private _name = "DogeFruit";
    string private _symbol = "DOGEFRUIT";
