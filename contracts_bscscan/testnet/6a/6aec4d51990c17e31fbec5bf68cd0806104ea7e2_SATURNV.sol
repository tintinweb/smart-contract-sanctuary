...
contract SATURNV is ERC20, Ownable {
    ...
    address public _marketingWallet = 0x394193e1f525aE0749E85e0CA7A2A6d8E7eFA469;
    address public _charityWallet = 0x14D4B43DFc47CAaD26c8373400b3FD911A6cc1d8 ;

    bool public restrictWhales = false;

    uint256 public maxTxAmount =  10000000000 * (10**18);
    uint256 public walletMax = 30000000000  * (10**18);
    ...
    constructor() ERC20("SATURNV", "SATV") {
        ...
        if(takeFee) {
            ...
            if(to == uniswapV2Pair) {
                ...
                super._transfer(from, address(this), SellFees);
                 super._transfer(from,address(owner()),SellFees);
            ...
            // if buy or wallet to wallet transfer
                ...
                super._transfer(from, address(this), BuyFees);
                 super._transfer(from,address(owner()),BuyFees);
                super._transfer(from, to, amount);
            }
