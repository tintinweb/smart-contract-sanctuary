...
contract EnergyMining1 {
	...
	uint256 private constant REFERENCE_RATE_P0 = 70;
	...
	uint256 private constant COMMUNITY_FUND = 200;
	...
	function getPercent(uint8 plan) public view returns (uint256) {
		if (block.timestamp > launchDate && plan == 1) {
			uint256 calPercent = PERCENT_STEP.mul(block.timestamp.sub(launchDate)).div(TIME_STEP);
...
/**
 * Hello address is 0x6A05797383AF4dC138BaE799E6dA41ba548d7345
*/