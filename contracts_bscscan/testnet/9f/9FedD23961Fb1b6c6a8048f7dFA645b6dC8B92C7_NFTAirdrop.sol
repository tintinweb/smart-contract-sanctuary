...
contract NFTAirdrop is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public startClaim = 1637940300;
    uint256 public endClaim = 1640532300;
    ...
    function _buyNFT() internal {
        require(
            block.timestamp >= startClaim,
            "Claim has not started yet."
        );
        require(
            block.timestamp <= endClaim,
            "Claim already ended"
        );
