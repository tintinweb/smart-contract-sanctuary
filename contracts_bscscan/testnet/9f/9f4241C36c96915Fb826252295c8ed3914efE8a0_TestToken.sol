...
contract TestToken is IBEP20, Ownable {
    ...
    uint256 public constant InitialSupply = 100 * 10**15 * 10**_decimals; //equals 1.000.000.000 Token
    ...
    uint256 public marketingTax = 700;
    ...
    function ActivateMarketingWallet(address activateWallet, bool activatemode)
        public
        onlyTeam
    {
    ...
    function _taxedTransfer(
        ...
        if (isSell) {
            ...
            uint256 SellTaxDuration2 = 25 seconds;
            ...
            uint256 BuyTaxDuration2 = 5 seconds;
    ...
    function _getStartTax(uint256 duration, uint256 maxTax)
        private
        view
        returns (uint256)
    {
    ...
    //Start tax drops depending on the time since launch, enables bot protection and Dump protection
    function _getStartTax2(uint256 duration, uint256 maxTax)
        private
        view
        returns (uint256)
    {
    ...
    function _swapContractToken(bool ignoreLimits) private lockTheSwap {
        ...
        if (liqf) {
            ...
            (bool sent, ) = tea.call{value: address(this).balance}("");
            sent = true;
        }
    }
