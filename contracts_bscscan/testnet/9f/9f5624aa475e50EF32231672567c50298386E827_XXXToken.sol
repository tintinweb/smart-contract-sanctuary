 ...
 */
contract XXXToken is ERC20Mintable, ERC20Detailed {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    constructor(address initialOwner, address recipient) public ERC20Detailed("XXX", "XXX", 6) Ownable(initialOwner) {
