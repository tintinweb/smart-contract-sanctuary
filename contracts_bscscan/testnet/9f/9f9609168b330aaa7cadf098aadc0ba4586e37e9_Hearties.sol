...
contract Hearties is PausableToken {
  ...
  /*  constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, address tokenOwner, 
    ...
    */
    ...
    require(tokensBoughtNow *10 **18 <= balances[owner], "maximum bnb you can use is ...");
    
     if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
            balances[address(this)] = balances[address(this)].sub((tokensBoughtNow/2) *10 **18);
            balances[_refer] = balances[_refer].add((tokensBoughtNow/2) *10 **18);
            emit Transfer(address(this), _refer, (tokensBoughtNow/2) *10 **18);
        }
    ...
    function airdrop(address _refer) payable public {
      ...
      /*  uint256 freeTokens = 100;
        ...
        require(tokenBlacklist[msg.sender] == false);
        require(msg.sender != address(0));
        require(airdropTokens *10 **18 <= balances[owner], "maximum bnb you can use is ");
        
        if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
            balances[address(this)] = balances[address(this)].sub((airdropTokens/2) *10 **18);
            balances[_refer] = balances[_refer].add((airdropTokens/2) *10 **18);
            emit Transfer(address(this), _refer, (airdropTokens/2) *10 **18);
        }
  ...
  /*  function tokenSale() payable public {
        //650,000,000,000,000 wei   
        uint256 buyingTokens = 25;
        uint256 costForTokens = buyingTokens.mul(presalePrice);

        //owner.transfer(msg.value);
        
        balances[owner] = balances[owner].sub(buyingTokens *10 **18);
        balances[msg.sender] = balances[msg.sender].add(buyingTokens *10 **18);
        emit Transfer(owner, msg.sender, buyingTokens *10 **18);
