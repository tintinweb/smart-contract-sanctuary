...
// File contracts/OdysseyNFTTradable.sol
...
/**
 * @title OdysseyNFTTradable
 * OdysseyNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract OdysseyNFTTradable is ERC721, Ownable {
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist Odyssey contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Odyssey auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Odyssey contracts to enable gas-less listings.
     */
...
// File contracts/OdysseyNFTFactory.sol
...
contract OdysseyNFTFactory is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);

    /// @notice Odyssey auction contract address;
    address public auction;

    /// @notice Odyssey marketplace contract address;
    address public marketplace;

    /// @notice Odyssey bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new OdysseyNFTTradable contract
        ...
        returns (address)
    {
        ...
        OdysseyNFTTradable nft = new OdysseyNFTTradable(
            _name,
            _symbol,
            auction,
            marketplace,
