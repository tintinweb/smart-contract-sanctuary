...
Name:       UNVAXXED
Symbol:     UNVAXXED
Telegram: https://t.me/UnvaxxedCoin

Tokenomics

   

    4%      Auto liquidity (sent directly to burn)
    2%      Reflections to holders
    1%      Marketing 
    1%      Developer fee
    
    8%     Total Fee - The max possible fee is hardcoded. Fees can be adjusted but the total must be <= 12%. 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD768132bB18cEC38A4AB35002f266037f4D6A2e6;
...
contract UNVAXXED is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0xF84ec7Fe79c0ba5109CeA7d6f920506b95A78A09);
    address payable public Wallet_Dev = payable(0xE812dA98b0AbC34C7EE6D92134D4b7617529f74D); 
    ...
    uint256 public _FeeMaxPossible = 15;
    ...
    */
    ...
    function _set_Fees(uint256 Liquidity, uint256 Marketing, uint256 Reflection) external onlyOwner() {
        ...
        // Buyer protection - The fees can never be set above the max possible (15%)
