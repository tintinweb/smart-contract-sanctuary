...
contract MysteryDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xe4d5EFe9E5FeEF8457b60E33047231C633Ffb5BB); // Marketing Address
    ...
    string private _name = "MysteryDoge";
    string private _symbol = "MysteryD";
    ...
    uint256 public _maxTxSellAmount = 1000000000000000000000000;
    uint256 public _maxTxBuyAmount = 3000000000000000000000000;
