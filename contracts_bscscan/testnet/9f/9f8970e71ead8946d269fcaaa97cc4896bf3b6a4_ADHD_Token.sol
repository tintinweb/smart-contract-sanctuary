...
contract ADHD_Token is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "ADHD Token";
    ...
    uint256 public _developerFee = 400; // 4% of every transaction is sent to developer wallet
    ...
    uint256 public _numTokensSellToAddToLiquidity = 500000000 * 10**18;
