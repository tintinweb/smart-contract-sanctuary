...
contract CactusCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x10f1b2b1D5d51C396DfD58c843a4b21EcdD463c4); // Marketing Address
    ...
    string private _name = "Cactus Coin";
    ...
    uint256 public _maxTxAmount =  5000000000 * 10**6 * 10**3;
    uint256 private minimumTokensBeforeSwap = 4000000000 * 10**6 * 10**3; 
    uint256 public buyBackSellLimit = 1000000000 * 10**6;
