...
contract Lottery is Ownable, Initializable {
    ...
    function createNewLottery(uint8[] calldata _prizeDistribution,
        uint256[] calldata _nftlinks, uint256 _costPerTicket, uint256 _minTicketsToBuy,
        uint256 _closingTimestamp) external onlyOwner()
    {
        ...
        allLotteries[lotteryId].nftIDs.push(_nftlinks[0]);
        allLotteries[lotteryId].nftIDs.push(_nftlinks[1]);
        allLotteries[lotteryId].nftIDs.push(_nftlinks[2]);
