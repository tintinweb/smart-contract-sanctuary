...
contract SpookyCowboy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public developmentAddress = payable(0x5Be5700149DCFB6FAB8E3966b8E8f675Fc5fC5F6); // Development Address
    ...
    string private _name = "SpookyCowboy";
    string private _symbol = "KYCO";
    ...
    uint256 public developmentDivisor = 1;
    ...
    function setMarketingAddress(address _developmentAddress) external onlyOwner() {
