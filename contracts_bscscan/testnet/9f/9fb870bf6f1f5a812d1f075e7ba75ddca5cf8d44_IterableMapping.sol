    ...
    Ownable
{
        ...
        onlyOwner
    {
        require(
            ...
            "MetaGenesis: The router already has that address"
        );
...
contract MetaGenesis is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MetaGenesisDividendTracker public dividendTracker;
    ...
    constructor() ERC20("MetaGenesis", "MetaGenesis", 9) {
        dividendTracker = new MetaGenesisDividendTracker();
        ...
        onlyOwner
    {
        require(
            ...
            "MetaGenesis: setWhiteListAMM:: AMM is a wallet, not a contract"
        );
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "MetaGenesis: The dividend tracker already has that address"
        );

        MetaGenesisDividendTracker newDividendTracker = MetaGenesisDividendTracker(
                payable(newAddress)
            );

        require(
            newDividendTracker.owner() == address(this),
            "MetaGenesis: The new dividend tracker must be owned by the MetaGenesis token contract"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "MetaGenesis: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MetaGenesis: The liquidity wallet is already this address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MetaGenesis: The operations wallet is already this address"
        );
    ...
    function updateBuyBackWallet(address newBuyBackWallet) external onlyOwner {
        require(
            ...
            "MetaGenesis: The buyback wallet is already this address"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "MetaGenesis: updateFees:: Liquidity Perc must be equal to or higher than operations and buyback combined."
        );
        emit FeesUpdated(
            bnbRewardPerc,
            liquidityPerc,
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "MetaGenesis: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "MetaGenesis: Cannot update gasForProcessing to same value"
        );
    ...
    function setRewardToken(address rewardTokenAddress) public returns (bool) {
        require(
            ...
            "MetaGenesis: setRewardToken:: Address is a wallet, not a contract."
        );
        require(
            rewardTokenAddress != address(this),
            "MetaGenesis: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        );
        require(
            !isIgnoredToken(rewardTokenAddress),
            "MetaGenesis: setRewardToken:: Reward Token is ignored from being used as rewards."
        );
    ...
    function setRewardTokenWithCustomAMM(
        ...
        require(
            ammContractAddress != address(uniswapV2Router),
            "MetaGenesis: setRewardToken:: Use setRewardToken to use default Router"
        );
        require(
            rewardTokenAddress != address(this),
            "MetaGenesis: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        ...
        require(
            ...
            "MetaGenesis: setRewardToken:: AMM is not whitelisted!"
        );
        dividendTracker.setRewardToken(
            msg.sender,
            rewardTokenAddress,
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(
            ...
            "MetaGenesis: buyBackTokensWithNoFees:: Cannot Spend more than earned."
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MetaGenesis: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function _transfer(
        ...
        require(
            ...
            "MetaGenesis: To/from address is ignored"
        );
    ...
    function swapAndLiquify(uint256 tokens) private {
        if (liquidityFee > 0) {
            ...
            if (operationsFee > 0) {
                ...
                require(
                    success,
                    "MetaGenesis: SwapAndLiquify:: Unable to send BNB to Operations Wallet"
                );
            }
            ...
            if (buyBackFee > 0) {
                ...
                require(
                    success,
                    "MetaGenesis: SwapAndLiquify:: Unable to send BNB to BuyBack Wallet"
                );
            }
...
contract MetaGenesisDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "MetaGenesis_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MetaGenesis_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MetaGenesis contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "MetaGenesis_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "MetaGenesis_Dividend_Tracker: Cannot update claimWait to same value"
        );
