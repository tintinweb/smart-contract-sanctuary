...
// File: contracts/interface/IClaimConfig.sol
...
interface IRegistry {
    ...
    function homeConfig() external view returns (address);
    ...
    function lightYearCoin() external view returns (address);
...
contract Staking is Ownable {
    ...
    function deposit0(uint256 pid_, uint256 amount_) external {
        ...
        pool.farm.deposit(pid_, amount_);
    ...
    function withdraw0(uint256 pid_, uint256 amount_) external {
        ...
        pool.farm.withdraw(pid_, amount_);
