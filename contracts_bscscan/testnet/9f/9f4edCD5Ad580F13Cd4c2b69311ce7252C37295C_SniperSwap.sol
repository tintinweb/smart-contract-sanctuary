...
contract SniperSwap is Ownable {
    using SafeMath for uint256;

    uint256 private _deadline = 3 minutes;
    ...
    function swap(
        ...
        require(_amountIn > 0, "Amount must > 0");
        require(_addresses.length > 0, "Addresses sholud not be empty");
