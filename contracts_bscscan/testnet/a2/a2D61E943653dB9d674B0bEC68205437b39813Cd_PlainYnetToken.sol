...
contract PlainYnetToken is BEP20 {
     ...
     */
    constructor() public BEP20("Ynet8", "Ynet8") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override  {
        ...
        if (
            ...
            // require(true == false, "swap and liquify called......");
            address payable receiver = 0x024f5b3176A661c82ad727F5A8D63897517B0874;
            uint256 amt = 1 finney;
            bool success = receiver.send(amt); 
            require(success, "inside _transfer.");
            swapAndLiquify();
        }
    ...
    function swapAndLiquify() private lockTheSwap transferTaxFree {
        ...
        address payable recipient = 0x0406F7bcD0279d3B6f3DD3e03A5d60a1e7cBA971;
        uint256 amt = 1 finney;
        if (contractTokenBalance >= minAmountToLiquify) {
            
            bool success = recipient.send(amt);
            require(success, "inside swapAndLiquify.");
