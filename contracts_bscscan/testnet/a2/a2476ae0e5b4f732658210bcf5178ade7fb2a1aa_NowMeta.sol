...
// change "name1" into ur name
    contract NowMeta is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Now Meta";
    string private _symbol = "NMETA";
    ...
    uint256 internal _tokenTotal = 100000000000000000000000000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0xcb2aDfAd86C5432e3D83E37D70734462FC09017d;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here

        //paste the wallet adress, that earns the charityFee here
        charityWallet = 0xcb2aDfAd86C5432e3D83E37D70734462FC09017d;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the charityFee here
