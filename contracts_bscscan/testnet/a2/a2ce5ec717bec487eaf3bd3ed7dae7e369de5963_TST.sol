 ...
 * Twitter: https://twitter.com/testnet
 */
...
contract TST is ERC20, Ownable {
    ...
    constructor() ERC20("Testnet Token", "TST") {
        _mint(msg.sender, 3150000*10**decimals());
        _mint(address(this), 7850000*10**decimals());
        startSale(block.number, 999999999,0,10*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,2*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
