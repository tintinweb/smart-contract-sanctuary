...
contract BagusTokenVesting {
    ...
    /**
     * Starting timestamp of the first stage of vesting (Tuesday, 18 Oct 2021, 09:00:00 GMT).
     * Will be used as a starting point for all dates calculations.
     */
    uint256 public vestingStartTimestamp = 1634485500;
    ...
    function initVestingStages () internal {
       ...
       // uint256 month = 30 days;
        ...
        stages[1].date = vestingStartTimestamp + minute * 3;
        stages[2].date = vestingStartTimestamp + minute * 5;
        stages[3].date = vestingStartTimestamp + minute * 10;
        stages[4].date = vestingStartTimestamp + minute * 15;
        stages[5].date = vestingStartTimestamp + minute * 20;
        stages[6].date = vestingStartTimestamp + minute * 25;
        stages[7].date = vestingStartTimestamp + minute * 30;
        stages[8].date = vestingStartTimestamp + minute * 35;
        stages[9].date = vestingStartTimestamp + minute * 40;
     ...
     */
    function sendTokens (uint256 tokensToSend) public  {
        if (tokensToSend > 0) {
