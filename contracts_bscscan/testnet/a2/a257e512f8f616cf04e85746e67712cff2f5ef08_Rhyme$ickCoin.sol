...
*
 RhymeSick Coin (R$C) - Community Token
 *
 * 
...
contract Rhyme$ickCoin is Context, IERC20, Ownable {
    ...
    string private _name = "RhymeSick Coin";
