...
//    Phase public currentPhase = Phase.Open;
    ...
    constructor(address _dev_) Auth(msg.sender) {
        ...
        boxes[Rarity.Common] = Box(0.1 * 10 ** 18, Rarity.Common, 0, 0, 10, 30, 60);
        boxes[Rarity.Uncommon] = Box(0.25 * 10 ** 18, Rarity.Uncommon, 0, 0, 10, 30, 60);
        boxes[Rarity.Rare] = Box(0.5 * 10 ** 18, Rarity.Rare, 0, 0, 10, 30, 60);
        boxes[Rarity.Epic] = Box(0.75 * 10 ** 18, Rarity.Epic, 0, 0, 10, 30, 60);
        boxes[Rarity.Legendary] = Box(1 * 10 ** 18, Rarity.Legendary, 0, 0, 10, 30, 60);
    ...
    function buyBoxLc(Rarity _rarity_) external {
        ...
        uint256 rewards = box.price * 5 / 100;
...
//            uint256 power = _box_.price / 60 / 86400;
            uint256 power = _box_.price / 60 / 30;
