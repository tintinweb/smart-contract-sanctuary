...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RWRD = IERC20(0x9222D24274E912F4d5E889b460924C4fEFe97954); //wBAN
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1); //QUICKSWAP
        _token = msg.sender;
    }
...
contract AXD is IERC20, Auth {
    ...
    address WMATIC = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AAAAA";
    ...
    uint256 public swapThreshold = (rSupply * 10) / 100;
    uint256 public rate;
    ...
    constructor() Auth(msg.sender) {
       // Quickswap testnet 0xbdd4e5660839a088573191A9889A262c0Efc0983
        router = IDEXRouter(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1); //QUICKSWAP
        ...
        charityFeeReceiver = 0x5de4E31bFdaBf1764a43f33280C556D0c99B4018; // Charity Wallet
        devFeeReceiver = 0x5de4E31bFdaBf1764a43f33280C556D0c99B4018; // Buybacks and project developments
    ...
    {
        uint256 amountMATIC = address(this).balance;
        payable(msg.sender).transfer((amountMATIC * amountPercentage) / 10);
    }
