...
contract BridgeBank is Initializable, BscBank, BridgeBankPausable, Ownable, LockTimer{
     ...
     */
    function initialize(address _operatorAddress) public payable initializer {
    ...
    function emergencyWithdraw(address tokenAddress, uint256 _amount)
        public
        onlyOperator 
        whenPaused 
        isAbleToWithdraw
    ...
    /*
     * @dev: Refun BNB and BEP20 tokens held on the contract.
     *
     * @param _recipient: recipient's is an bsc address
     * @param _token: token contract address
     * @param _symbol: token symbol
