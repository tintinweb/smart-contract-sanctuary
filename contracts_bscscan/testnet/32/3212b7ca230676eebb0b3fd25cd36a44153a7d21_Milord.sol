...
contract Milord is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0659671cB3209611Ec7A94D550039cbadEaEeb50); // Marketing Address
    ...
    string private _name = "MILORD";
    string private _symbol = "MILORD";
