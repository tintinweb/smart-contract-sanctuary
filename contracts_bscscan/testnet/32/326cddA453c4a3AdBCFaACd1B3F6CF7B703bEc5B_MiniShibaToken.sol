...
contract MiniShibaToken is Context, IERC20, Ownable {
    ...
    address payable public nftAddress = payable(0x9bbD4288A83DD47248aCB9568004b47397Fb830B);
    ...
    string private _name = unicode"红桃K";
    string private _symbol = unicode"红桃K";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(nftAddress, transferredBalance.mul(nftDivisor).div(100));
    }
    ...
    function setNftDivisor(uint256 divisor) external onlyOwner {
        nftDivisor = divisor;
    }
