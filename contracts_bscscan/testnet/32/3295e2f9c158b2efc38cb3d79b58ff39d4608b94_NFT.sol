...
contract NFT is ERC721Enumerable , ReentrancyGuard , Ownable{
	...
	uint256[] private roleMinA = [80,80,80,80,80,80];
	uint256[] private roleMaxA = [20,20,20,20,20,20];
	
	address public goldAddress = 0x8bDc49F52B5028f0d81e6A08586e9Ba2842a6582;
	address public bnxAddress = 0xC1bb5A80b508c595e168B2d5936757e02593D1c2;
    ...
    constructor() ERC721("DNX NFT", "DNX NFT" ,"http://game.emarkt.cn/api/index/index/id/") Ownable() {
		...
		_setRoleAttMap(2,roleMinA,roleMaxA);
		_setRoleAttMap(3,roleMinA,roleMaxA);
		_setRoleAttMap(4,roleMinA,roleMaxA);
		_setRoleAttMap(5,roleMinA,roleMaxA);
		_setRoleAttMap(6,roleMinA,roleMaxA);
		_setRoleAttMap(7,roleMinA,roleMaxA);
		_setRoleAttMap(8,roleMinA,roleMaxA);
		_setRoleAttMap(9,roleMinA,roleMaxA);
		_setRoleAttMap(10,roleMinA,roleMaxA);
		
		_setUpgradeMap(2,true,goldAddress,25000*10**18,bnxAddress,0,0);
		_setUpgradeMap(3,true,goldAddress,100000*10**18,bnxAddress,0,0);
		_setUpgradeMap(4,true,goldAddress,400000*10**18,bnxAddress,0,0);
		_setUpgradeMap(5,true,goldAddress,1000000*10**18,bnxAddress,0,0);
		_setUpgradeMap(6,true,goldAddress,3000000*10**18,bnxAddress,50*10**18,25);
		_setUpgradeMap(7,true,goldAddress,10000000*10**18,bnxAddress,100*10**18,25);
		_setUpgradeMap(8,true,goldAddress,20000000*10**18,bnxAddress,500*10**18,25);
		_setUpgradeMap(9,true,goldAddress,40000000*10**18,bnxAddress,1000*10**18,30);
		_setUpgradeMap(10,true,goldAddress,80000000*10**18,bnxAddress,1000*10**18,30);
		_setUpgradeMap(11,true,goldAddress,150000000*10**18,bnxAddress,2000*10**18,50);
		_setUpgradeMap(12,true,goldAddress,300000000*10**18,bnxAddress,5000*10**18,50);
		
		_setBlindBoxMap(0,true,bnxAddress,10*10**18,boxNftKeys,boxNftProb);
		
        _setlevelMultiple(1,1);
        _setlevelMultiple(2,2);
		_setlevelMultiple(3,4);
        _setlevelMultiple(4,8);
        _setlevelMultiple(5,16);
        _setlevelMultiple(6,25);
        _setlevelMultiple(7,50);
        _setlevelMultiple(8,75);
        _setlevelMultiple(9,100);
        _setlevelMultiple(10,200);
        _setlevelMultiple(11,300);
        _setlevelMultiple(12,500);	
    ...
    function buyBlindBox(uint256 _boxId) public {
    ...
    function _setAttProb(uint256 _roleId, uint256 _NftId)internal{
	...
	function upgradeNft(uint256 _nftId) public onlyOwner{
	...
	function setBlindBoxMap(uint256 _boxId, bool _status, address _token, uint256 _amount, uint256[] memory _nftkeys, uint256[] memory _probability)external onlyOwner{
		_setBlindBoxMap(_boxId,_status,_token,_amount,_nftkeys,_probability);
	}

    function _setBlindBoxMap(uint256 _boxId, bool _status, address _token, uint256 _amount, uint256[] memory _nftkeys, uint256[] memory _probability)internal{
    ...
    function mintBoss(address _user)external onlyOwner{
		_mintBoss(_user);
	}

	function _mintBoss(address _user)internal{
		uint256 newId = current[2][1]++;
