...
contract DividendDistributor {
    ...
    IERC20 SHIB = IERC20(0xB4a81261b16b92af0B9F7C4a83f1E885132D81e4); // MainNet 
...
contract ShibaEightbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba 8 bit";
    string private _symbol = "SHIB8B";
    uint8 private _decimals = 9;
    

    address payable public marketingWalletAddress = payable(0x93C9A8981397fd8770931606850e3dF098665002); // Marketing Address
    address payable public rewardsWalletAddress = payable(0x404d7F24034Dd5b00eD62cb90Dc5eE7E925C8890); // Rewards Address 
    ...
    uint256 private _totalSupply = 5 * 10**7 * 10**9;
