...
contract GIANTPANDA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBE65BADB8FAdBc238F719c7ed6e2760777c4040b); // AHOUSE Marketing Address
    address payable public satoshiAddress = payable(0xBE65BADB8FAdBc238F719c7ed6e2760777c4040b); // Satoshi Foundation Address
    ...
    string private _name = "GIANTPANDA";
    string private _symbol = "GPANDA";
