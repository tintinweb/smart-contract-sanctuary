...
contract StakeContract is Ownable {
    ...
    uint256 public firstMonthRewardperblock = 0.0000001851851852 * 10 ** 18; //first month block reward % * 1e18
    uint256 public afterRewardperblock = 0.00000009259259259 * 10 ** 18; //after first block reward % * 1e18
    uint256 private firstMonthBlockPeriod = 864000; //30days block = 836129.0323, we use 864000
    uint256 private unlockblockperiod = 432000; //15days block = 418064.5161, we use 432000
    address public rewardaddress = 0x6c1dE9907263F0c12261d88b65cA18F31163F29D ; //rewardaddress
    address public stakeaddress = 0x6c1dE9907263F0c12261d88b65cA18F31163F29D ; //stakeaddress
    uint256 public totalpoolstacked = 0;
    uint256 public lastRewardBlock = 11135000;  // should be same as start block at the beginning
