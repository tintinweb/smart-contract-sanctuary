...
contract SOLIDIUM is Context, IBEP20, Ownable {
    ...
    */
    ...
    function taxDistributor() private lockTheSwap {
        ...
        */
        ...
        if(contractBalance > _minTaxWalletBalance){
            // Tokens for the pool
            uint256 liquidityTokens = contractBalance.div(4); 
            // Tokens for the dev team wallets
            uint256 devTokens = contractBalance - liquidityTokens; // 2.25%
    ...
    */
    ...
    /**
    * @dev the Owner can swap contract token balance to ETH
    */
    ...
    /**
    * @dev the Owner can send ETH contract balance
    */
