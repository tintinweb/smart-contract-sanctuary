...
contract DONOTBUY is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5db2Ae85d9C61e9267c479ebDD3F3e363a8dc481); // Marketing Address
    ...
    string private _name = "Baby Dont";
    string private _symbol = "BabyDont";
    uint8 private _decimals = 9;

    uint256 public _maxWallet = 8 * (10**8) * (10**9); //800 Billion
    ...
    uint256 public _maxTxAmount = 8 * (10**8) * (10**9);
    uint256 private minimumTokensBeforeSwap = 5 * (10**8) * (10**9);
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != uniswapV2Pair) {
            require(trading == true); //haltbuy
            
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
            
            uint256 contractBalanceRecepient = balanceOf(to); 
            require(contractBalanceRecepient + amount <= _maxWallet, "Exceeds maximum wallet token amount."); //antiwhale
    ...
    function addLP() external onlyOwner { //break
    ...
    function letsGoLive() external onlyOwner() { //commence
