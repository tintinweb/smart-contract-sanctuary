...
contract GymVaultsBank is ReentrancyGuard, Ownable, Relationship {
    ...
    address public constant routerAddress = 0xe04A641914e646437aE5d935f735Cec2505c9faE; // PancakeSwap: Router
    ...
    constructor(
        ...
        buyBack = 0x5FbDB2315678afecb367f032d93F642f64180aa3;
        totalAllocPoint = 0;
        add(IERC20(0x7a5760296FCBe78178d9b84786d0C76732a9a051), 30, false, 0x4ed7c70F96B99c776995fB64377f0d4aB3B0e1C1);
    ...
    function depositBNB( address _referrer) external payable{
        addRelationship(msg.sender, _referrer);
        IWETH(0x7a5760296FCBe78178d9b84786d0C76732a9a051).deposit{value: msg.value}();
    ...
    function _deposit(uint256 _pid, uint256 _wantAmt, bool _isToken) private {
        ...
        if (_wantAmt > 0) {
            ...
            pool.want.safeTransfer(0x5FbDB2315678afecb367f032d93F642f64180aa3, _wantAmt * BUY_AND_BURN_GYM / 100);
        ...
        if (_wantAmt > 0) {
            ...
            if (_wantAmt > 0) {
                if(_isToken){
                    ...
                    IWETH(0x7a5760296FCBe78178d9b84786d0C76732a9a051).withdraw(_wantAmt);
...
contract Relationship {
    ...
    uint8[5] private _DIRECT_REFERRAL_BONUS;

    constructor() {
        _DIRECT_REFERRAL_BONUS = [30, 25, 20, 15, 10];
    ...
    function distributeRewards(
        ...
        while (_index < _DIRECT_REFERRAL_BONUS.length) {
            token.transfer(
                userToReferrer[_user],
                (_wantAmt * _DIRECT_REFERRAL_BONUS[_index]) / 100
            );
