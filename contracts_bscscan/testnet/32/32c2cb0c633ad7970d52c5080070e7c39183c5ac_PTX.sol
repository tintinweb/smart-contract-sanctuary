...
contract PTX is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address public marketingAddress = 0x0572689b9Cb91789325C32E5f4b3d2b6A4e7D526; // Marketing wallet Address.
    ...
    string private _name = "PotatoX";
    string private _symbol = "PTX";
    ...
    uint256 public _maxTxAmount = 1_000_000_0 * 10**18; //1%
    ...
    {
        _amount = _amount.div(100-_marketingFee-_burnFee).mul(100);
