...
contract Kodiak is ERC20, Ownable {
    ...
    constructor() ERC20("Kodiak", "KODI") {

    	dividendTracker = new KODIDividendTracker();
        totalFees = BNBRewardsFee.add(liquidityFee).add(marketingFee);

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    	//BSC MAIN IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    	//BSC TEST IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
