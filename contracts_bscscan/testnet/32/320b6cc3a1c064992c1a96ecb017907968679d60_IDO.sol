...
contract IDO {
    ...
    uint256 public softCap = 1 * 10**18;  
    uint256 public hardCap = 2 * 10**18;  		
    ...
    constructor() {
        ...
        address _TOKEN = 0xA9A8306AfE4C0D62E5E8EaB678bc3ec131e20391;
        address _pair = 0x7B9903BfF2A4f95Af21e99c7d9989d86BBf5C45e;
        owner = msg.sender;
        TOKEN = IBEP20(_TOKEN);
        LP = IBEP20(_pair);
        airdropfundAddress = 0x7Baf1D03ba8e0Ce490A6f84Cd37420e0377E7f6b;
    }
    ...
    function provideLP() public {
        require(msg.sender == owner && saleEnded && !allowRefunds);
            ...
            address(this),
            block.timestamp);
            lockTime = block.timestamp + 400 days;
    }
    function sendUnsoldTokens() public {
        require(msg.sender == owner && saleEnded && !allowRefunds && lockTime > 0);
