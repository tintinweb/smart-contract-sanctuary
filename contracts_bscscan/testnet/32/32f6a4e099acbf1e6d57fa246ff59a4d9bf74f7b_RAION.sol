...
/*
 Hodl $RAID and get Reflection automatically in your wallet every day! 
 
 Supply: 20,000,000,000 (20 Billions)
 Max Wallet Size = 300,000,000 (300 Million or 1,5%)
 Max Buy = 75,000,000 (75 Million or 0.37%)

 Reflection/Taxes: 3% in Tokens to Holders, 3% in Liquidity, 1% to Developers Wallets, 1% Burn , 3% Execution Wallet
 
 Buy Slippage: 11-13% 


      *******
  *****    THE MAX A WALLET CAN HAVE IS . . .
           . . .  300,000,000! THAT IS 1,5%!     ******
                                          **********
...
contract RAION is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 20_000_000_000; //20 Billions, underscores aid readability
   
    uint256 private constant MAX = ~uint256(0);
    uint8 private _decimals = 9;
    uint8 private _tree = 3;
    uint8 private _two = 2;
    uint8 private _one = 1;
    ...
    string private _name = "Raidon";
    string private _symbol = "RAION";
    ...
    uint256 public _boostedReflectFee = 300;
    ...
    uint256 public _boostedBuyBackFee = 100;
    ...
    address public manualBurn = 0x0F8D6fB35935bDF8f9313CcB4FD09776D2721098;
    address payable private _marketingWallet = payable(0x5A26dA339B31F99a7671561c34b8f25125C4299f);
    address payable private _devWallet = payable(0xc72f020c19098Da58283556fF6206348B06f1995);
    ...
    uint256 private maxTxPercent = _one / _tree; // Less fields to edit
    uint256 private maxTxDivisor = 100;
    uint256 public maxWallet = _tTotal * (_tree / _two) / 100; // 1.5%
    ...
    constructor () {
        ...
        _isExcludedFromFee[manualBurn] = true;
        ...
        //DEVS & Marketing Wallets
        _isExcludedFromFee[0x5A26dA339B31F99a7671561c34b8f25125C4299f] = true;
        _isExcludedFromFee[0x6634a033fA34BA392D5c58fae03dA1cb3066ec97] = true;
        _isExcludedFromFee[0x14B1Dd097B24BC1a9c22AD65EfFca0897d291C43] = true;
        _isExcludedFromFee[0x9A84fe49626D09531c3C5Fd7A6ceC26B18e689Fd] = true;
...
,        address to,
        ...
        if(_hasLimits(from, to))
            require(amount <= _maxTxAmount, "Transfer amount exceeds the allowed.");
            require(amount + balanceOf(to) <= maxWallet, "Forbidden! Exceeding wallet capacity");
