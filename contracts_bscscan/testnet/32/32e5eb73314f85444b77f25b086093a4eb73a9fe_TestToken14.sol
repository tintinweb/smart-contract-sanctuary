...
contract TestToken14 is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 500000000 * 10**18; // fixed total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public constant name     = "TestToken14";
    string public constant symbol   = "TT14";
