...
contract BabyBitcoin is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 1000000 *10**18; // 1 Billion totalSupply
    ...
    uint256 public _taxFee = 4; // 100 = 1%, IF ITS SET TO 0, ITS BECAUSE OF PRESALE
    uint256 public _charityFee = 2; // 100 = 1%, IF ITS SET TO 0, ITS BECAUSE OF PRESALE
    uint256 public _lastFee = 2; // 100 = 1%, IF ITS SET TO 0, ITS BECAUSE OF PRESALE
    uint256 public _liquidityFee = 2; // 100 = 1%, IF ITS SET TO 0, ITS BECAUSE OF PRESALE
    ...
    address public charityAddress = 0xbA63dBd497a36a8116142c4471f2DfaBe5b2124C; // Charity Address
    address public liquidityAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Liquidity Address
    address public lastAddress = 0xbA63dBd497a36a8116142c4471f2DfaBe5b2124C; // 2nd charity Address
