...
contract TokandoTor is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8F4Cea95361373aDd28dbD810F1a0FF93bd1dB0D); // Marketing Address
    ...
    string private _name = "TokandoTor";
