...
contract Dakota is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Dakota";
    string constant _symbol = "Dakota";
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountDakota);
