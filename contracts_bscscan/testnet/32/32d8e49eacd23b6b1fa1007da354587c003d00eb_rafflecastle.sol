...
contract rafflecastle is IBEP20, Auth {
    ...
    string constant _name = "bit16";
    string constant _symbol = "bit16";
...
*/
    ...
    uint256 public SlidingBuyFee = totalBuyFee;
    uint256 public SlidingSellFee = totalSellFee;
    uint256 public SlidingTriggeredAt = 0;
    uint256 public SlidingBuyNumerator = 25; 
    uint256 public SlidingSellNumerator = 50; 
    uint256 public SlidingBuyDuration = 10 minutes; 
    uint256 public SlidingSellDuration = 20 minutes; 
    uint256 public SlidingBuyLimit = 1200;
    uint256 public SlidingSellLimit = 2600;
    ...
    function getTotalFee(bool selling) public view returns (uint256) { 
        ...
        if (selling && SlidingTriggeredAt.add(SlidingSellDuration) > block.timestamp) {return getSlidingSellFee();} // changed from redwallTriggeredAt
        return selling ? totalSellFee : totalBuyFee;
    }
    
    function getSlidingBuyFee() public view returns (uint256) { 
        uint256 totalFee = SlidingBuyFee;
        return totalFee;
    }
    
    function getSlidingSellFee() public view returns (uint256) { 
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        //  greenwall();
        if(isSell(recipient) == true || isBuy(sender) == true){
