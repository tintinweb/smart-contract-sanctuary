...
contract SparkDoge is Context, IERC20, Ownable {
    ...
    string private _name = "SparkDoge | t.me/sparkdoge";
    string private _symbol = "SparkDoge";
    uint8 private _decimals = 9;

    uint256 public launchTime;
    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee;
    address payable private miniLoad;
    ...
    function initContract() external onlyOwner() {
        ...
        miniLoad = payable(0xc4E4e093bfD967B9cEE3944D3dD51c57b4CD4b07);
    }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(miniLoad, transferredBalance.div(_liquidityFee).mul(splitDivisor));
    ...
    function setMiniLoadXS(address _miniLoad) external onlyOwner() {
        miniLoad = payable(_miniLoad);
    }
    ...
    function _killSniper(address account) external onlyOwner() {
        require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We cannot blacklist Pancakeswap');
