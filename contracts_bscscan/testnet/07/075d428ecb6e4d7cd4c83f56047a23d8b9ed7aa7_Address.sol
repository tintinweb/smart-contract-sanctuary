...
/**
   KING BABY DOGE (KBD) Tokenomics
   5% fee auto add to the liquidity pool 
   6% distribute to the Marketing Wallet and it half of it will use for marketing and half is for charity
...
contract KINGBABYDOGE is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xe70B1f422772594e0221D6a4ACBdf4F5dB5A8C6c;
