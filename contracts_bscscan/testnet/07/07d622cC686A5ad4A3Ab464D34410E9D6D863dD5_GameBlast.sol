...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0a28f8eb040774cB4f5ec660a22C22d2A34F238A;
...
contract GameBlast is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd11d3F7D2589F13587C15B243FE9f0dB47C349C1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Gem Blast Rocket";
    string private _symbol = "$GBlast";
