...
contract NFAStaking is Ownable, Initializable {
    ...
    struct UserInfo {
        ...
        uint256[] stakedIds;     // How many LP tokens the user has provided.
        uint256[] stakedNfts;     // How many LP tokens the user has provided.
