...
contract Pharao3 is ERC20 {
    ...
    constructor() ERC20("Pharao3","PHRX3"){
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
         if(nofee[msg.sender] == true) {
             _transfer(_msgSender(), recipient, amount);
        }
         
         else { 
            uint burnAmount = amount.mul(BURN_FEE) / 1000;
            uint adminAmount = amount.mul(TAX_FEE) / 1000;
