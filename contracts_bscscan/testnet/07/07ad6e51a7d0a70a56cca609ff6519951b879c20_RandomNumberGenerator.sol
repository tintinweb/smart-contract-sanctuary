...
// File: contracts/interfaces/IAnpanSwapLottery.sol

pragma solidity ^0.8.4;

interface IAnpanSwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in ANPAN per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in ANPAN token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInAnpan: price of a ticket in ANPAN
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public anpanSwapLottery;
     ...
     * @param _seed: seed provided by the AnpanSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == anpanSwapLottery, "Only AnpanSwapLottery");
    ...
    /**
     * @notice Set the address for the AnpanSwapLottery
     * @param _anpanSwapLottery: address of the AnpanSwap lottery
     */
    function setLotteryAddress(address _anpanSwapLottery) external onlyOwner {
        anpanSwapLottery = _anpanSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IAnpanSwapLottery(anpanSwapLottery).viewCurrentLotteryId();
    }
}