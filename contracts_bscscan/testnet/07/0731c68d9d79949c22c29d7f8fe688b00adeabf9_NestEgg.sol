...
contract NestEgg is ERC20, Ownable {
    ...
    address public toBurnGolduckBnbAddress = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;  //BurningGolduckBnb Address
    ...
    constructor() ERC20("Nest Egg", "NEGG") {
        ...
        a80DividendToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
        b20DividendToken = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADA80_Dividend_Tracker", "ADA80_Dividend_Tracker", 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADA20_Dividend_Tracker", "ADA20_Dividend_Tracker", 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 20000 * (10**18); //must hold 20000+ tokens
    }
