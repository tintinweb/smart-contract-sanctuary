        ...
        if (_tokenIds.length == 1) {
            ...
            for (uint256 i = 0; i < royaltyReceivers_[0].length; i++) {
                ...
                for (uint256 j = 0; j < royalties[_tokenIds[0]].length; j++) {
                    if (royalties[_tokenIds[0]][j].receiver == royaltyReceivers_[i][0] && royalties[_tokenIds[0]][j].amount == royaltyAmounts_[i][0]) {
                        toPush = false;
                        break;
                    }
                }
            ...
            for (uint256 i = 0; i < royaltyReceivers_.length; i++) {
                for (uint256 j = 0; j < royaltyReceivers_[i].length; i++) {
                    ...
                    for (uint256 k = 0; k < royalties[_tokenIds[i]].length; k++) {
                        if (royalties[_tokenIds[i]][k].receiver == royaltyReceivers_[j][i]
                            && royalties[_tokenIds[i]][k].amount == royaltyAmounts_[j][i]) {
                            toPush = false;
                            break;
                        }
                    }
