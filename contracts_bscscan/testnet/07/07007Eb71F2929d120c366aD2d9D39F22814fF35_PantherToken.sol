...
contract PantherToken is BEP20 {
    ...
    IUniswapV2Router02 public pantherSwapRouter = IUniswapV2Router02(0xD0C6Ce0b3Cb6F2577Dd2B0269669740174017400);
    // The trading pair
    address public pantherSwapPair = IUniswapV2Factory(pantherSwapRouter.factory())
            .getPair(address(this), pantherSwapRouter.WETH());
