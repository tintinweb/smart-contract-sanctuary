...
//
contract Axiszilla is ERC20, Ownable {
    ...
    constructor()  ERC20('Axiszilla', 'Axiszilla') {
    ...
    function updateBuyBackAddress(address payable newBuyBackAddress) public onlyOwner {
        require(newBuyBackAddress != gamePoolAddress, 'The buyBackAddress address is already this address');
