...
abstract contract Router {
    ...
    uint8 public constant totalDEX = 1;            // Total no of DEX aggregators or exchanges used
...
contract Degen is Router, Ownable {
    ...
    function executeSwap(
        ...
        _swap(orderType, path, assetInOffered, minExpectedAmount, msg.sender, dexId, distribution);
    ...
    function executeCrossExchange(
        ...
        if(path[0] == USDT) {
            ...
            uint256 minAmountExpected = _swap(orderType, path, assetInOffered, minExpectedAmount, address(this), dexId, distribution);
    ...
    function callbackCrossExchange(
        ...
        _swap(orderType, path, assetInOffered, 0, user, dexId, distribution);
        return true;
    }
