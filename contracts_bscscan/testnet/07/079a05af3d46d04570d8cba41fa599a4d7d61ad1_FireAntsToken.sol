...
contract 
FireAntsToken is Ownable,ERC20 {
...
// Advisor+team wallets
    address[] advisors = [
         0x38e25102870a696dB2DAcDf5D125017aAa0E770e, //owner
         0x997EF4CeF5B6EB101D347Cf4788c3F8540dE1dfD, //M
         0x95911d1f420246ebe772B50e79a71388635d5809  //R
    ];

// Public variables of the token
    string public name          = "FireAnts eXPerience";
...
//Our external FireAntsContract
    address private FireAntsContract;
    ...
    modifier onlyAuthorizedContract(){
        require(msg.sender == FireAntsContract,"Caller not authorized for this action");
        _;
    }
    ...
    function setCryptozContract(address _FireAntsContract) public onlyOwner{
        require(_FireAntsContract != address(0x0));
        FireAntsContract = _FireAntsContract;
    }
    
    function getFireAntsContractAddress() public view returns(address){
        return FireAntsContract;
    }
