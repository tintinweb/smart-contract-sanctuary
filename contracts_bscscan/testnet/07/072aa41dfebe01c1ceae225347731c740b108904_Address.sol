...
contract EBA is Operator {
    ...
    constructor () public {
        ...
        IUniswapV2Factory factory = IUniswapV2Factory(0x7D7701029C00De308b67B8c1979452A46703d9D2);
        address pair = factory.createPair(address(this),address(0x7D7701029C00De308b67B8c1979452A46703d9D2)); 
        setFeeList(pair,true);

        setWhiteList(address(0x7D7701029C00De308b67B8c1979452A46703d9D2),true);
    }
