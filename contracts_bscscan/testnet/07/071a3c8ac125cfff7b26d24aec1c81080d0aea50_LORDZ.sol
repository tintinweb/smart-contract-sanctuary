...
contract LORDZ is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, VRFConsumerBase {
    using Strings for uint256;
    ...
    uint256 internal aFreq;
    uint256 internal bFreq;
    uint256 internal cFreq;
    uint256 internal dFreq;
    uint256 internal eFreq;

    uint256 internal linkFee;
    uint256 internal randomResult;

    uint256 internal lordzMintCost;
    uint256 internal lordzVRFCost;
    uint256 internal bnbMintCost;
    uint256 internal bnbVRFCost;

    address internal tokenAddr;
    address internal royalAddr;

    address constant internal linkAddr = 0x404460C6A5EdE2D891e8297795264fDe62ADBB75;
    address constant internal VRF = 0x747973a5A2a4Ae1D3a8fDF5479f1514F65Db9C31;

    string internal resultVRF;

    mapping (uint256 => string) internal catalog;
    mapping (uint256 => string) internal lordzID;
    mapping (uint256 => string) internal rarity;
    mapping (address => bool) internal mintLocked;

    constructor() ERC721("Lordz", "LORDZ") VRFConsumerBase(VRF, linkAddr) {

        keyHash = 0xc251acd21ec4fb7f31bb8868288bfdbaeb4fbfec2df3735ddbd4f7dc8d60103c;
        linkFee = 0.2 * 10 ** 18; // 0.1 LINK (Varies by network)

        tokenAddr = 0x2541Be91fE0D220fFCbe65f11d88217a87A43bDA;
        royalAddr = 0xaB5Ff3844Dd23A292dDD26e86Fc211Ae15Cb7f11;

        bnbMintCost = 0;
        bnbVRFCost = 0.01 * 10 ** 18;
        lordzMintCost = 5;
        lordzVRFCost = 5;
        ...
        baseURI = "https://memelordz.mypinata.cloud/ipfs/QmfTboBQdQcRi8dvNovuUAL888zuU7LV14yfxYgs1wejf1/";
    }
    ...
    /**
     * To be called after every OP Mint
     */
    ...
    function tokenIdsByOwner(address account) external view returns (uint256[] memory) {
