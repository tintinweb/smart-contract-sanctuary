...
contract SeedVesting is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
	...
	/* the cliff time of the Seed vesting */
    uint256 private cliffTime;

	/* the duration of the Seed vesting */
	...
	/* the whitelist of the Seed sale */
