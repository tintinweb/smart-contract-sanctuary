...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 1 hours; //auto-reflect 1 hours
...
contract testdogev2 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "testdogev2";
    string constant _symbol = "testdogev2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 40; //2.5% of total supply
    ...
    uint256 liquidityFee = 300;//3% liquidity
    uint256 buybackFee = 200;//2% Buyback
    uint256 reflectionFee = 500;//5% DOGE reward
    uint256 marketingFee = 500;//5% Marketing and Development
    uint256 totalFee = 1500;//15% tax
    ...
    function prepareForPreSale() external onlyOwner {
        swapEnabled = false;
         liquidityFee = 0;//3% liquidity
         buybackFee = 0;//2% Buyback
         reflectionFee = 0;//5% DOGE reward
         marketingFee = 0;//5% Marketing and Development
        _maxTxAmount = 1000000000 * 10**6 * 10**9;
    }
    
    function afterPreSale() external onlyOwner {
        swapEnabled = true;
         liquidityFee = 300;//3% liquidity
         buybackFee = 200;//2% Buyback
         reflectionFee = 500;//5% DOGE reward
         marketingFee = 500;//5% Marketing and Development
         totalFee = 1500;//15% tax
          _maxTxAmount = (_totalSupply * 1) / 40;
    }
