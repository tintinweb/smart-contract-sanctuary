...
abstract contract Tokenomics {
    ...
    // --------------------- Token Name ----------------------- //
    string internal constant NAME = "PURGETEST";
    string internal constant SYMBOL = "TESTING";
    ...
    uint256 internal constant TOTAL_SUPPLY = 999000000000000 * ZEROES;
    ...
    // --------------------- Addresses --------------------- //
    address internal purgeAddress = 0xe790e227795a2661760cC36bB2B7079003Eb6f17;
    address internal marketingAddress = 0xC2d659B43fdd4f00bB1a6180735A7E06eca1ddc7;
    address internal burnAddress = 0x0000000000000000000000000000000000000085;
    address internal developmentAddress = 0xcC6139e568816AC4E35c086bB7af9A779E946ba5;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.ExternalToETH, 10, marketingAddress );
        _addFee(FeeType.ExternalToETH, 5, purgeAddress );
        _addFee(FeeType.ExternalToETH, 5, developmentAddress );
    }
...
abstract contract PURGETEST is BaseRfiToken, Liquifier, Antiwhale {
...
contract TESTINGV1 is PURGETEST{

    constructor() PURGETEST(Env.Testnet){
