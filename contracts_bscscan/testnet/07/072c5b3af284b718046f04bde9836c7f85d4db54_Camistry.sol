...
function changefee(uint _fee)public virtual onlyOwner{
...
contract Camistry is Context, ERC20, Ownable, ERC20Burnable{
  ...
  uint _fee;
    ...
    function changefee(uint _fee)public override virtual onlyOwner{
  fee = _fee;
    }
