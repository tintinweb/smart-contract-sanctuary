...
contract JBLNFT is ERC721{
    ...
    uint256 public NFT_APY = 8*1*10**17; //基礎APY：80 , 加成APY：0
    ...
    constructor ()  public ERC721("JBL-LYCsite", "JBL-LYCsite"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "JBL-LYCsite";
        string memory tokenURI = "https://farms.jblgamefi.io/assets/images/player/Jimmy_2.png";
