...
contract FuelPad is IERC20, Ownable {
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 totalSwapFee = buyTotalFees.sub(buyLiquidityFee);
        uint256 marketingFeeBnb = swappedBnbAmount.mul(buyMarketingFee).div(
            totalSwapFee
        );
        uint256 tokensToReward = swappedBnbAmount.sub(marketingFeeBnb);
