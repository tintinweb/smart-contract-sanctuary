...
contract DumbCoin is Context, IERC20, Ownable {
    ...
    address public taxWallet = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1a9adB7910dbAe1DA63dA392cd75EebCd2536d28);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x1a9adB7910dbAe1DA63dA392cd75EebCd2536d28, 'We can not exclude Pancake router.');
    ...
    function setFromFee(address newWallet) external onlyOwner {
        taxWallet = newWallet;
    }
    
    function setInFee(address newWallet) external onlyOwner {
        taxWallet = newWallet;
    }
