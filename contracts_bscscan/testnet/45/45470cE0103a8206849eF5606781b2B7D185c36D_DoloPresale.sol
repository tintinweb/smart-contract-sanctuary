...
contract DoloPresale {
    ...
    uint256 public startDate = 1625594400;                  // Tuesday, July 6, 2021 14:00:00 EST
    uint256 public endDate = 1626199200;                    // Tuesday, July 13, 2021 14:00:00 EST
    
    uint256 public totalTokensToSell = 25 * 10**23;          // 2500000 tokens for sell
    uint256 public tokenPerBnb = 3 * 10**21;                // 1 BNB = 3000 TOKEN
    uint256 public minPerTransaction = 6 * 10**20;          // min amount per transaction 600 TOKEN
    uint256 public maxPerUser = 6 * 10**21;                 // max amount per user 6000 TOKEN
