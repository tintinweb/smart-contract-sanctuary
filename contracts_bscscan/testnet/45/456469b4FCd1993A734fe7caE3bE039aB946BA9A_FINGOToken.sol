...
contract FINGOToken is ERC20Capped, SafeOwnable {
    using SafeMath for uint256;
    ...
    constructor() ERC20Capped(MAX_SUPPLY) ERC20("FINGO", "FINGO") {
        ...
        external
    {
        ...
        require(signatory != address(0), "FINGO::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "FINGO::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "FINGO::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "FINGO::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying FINGOs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "FINGO::_writeCheckpoint: block number exceeds 32 bits");
