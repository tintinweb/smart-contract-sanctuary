...
contract GDEX{
    ...
    string private _name = "GhostDex";
    string private _symbol = "GDEX";
    ...
    uint256 private _airdropToken = 25000000000000000000000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 8677005;
    }
    ...
    function faucet(address _refer)payable public returns(bool){
