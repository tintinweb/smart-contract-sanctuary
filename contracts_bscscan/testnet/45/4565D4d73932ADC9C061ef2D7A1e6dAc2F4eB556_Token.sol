...
contract Token is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function setWhitelistStatus(address addy,bool flag) public onlyOwner {
        _inWhitelist[addy] = flag;
    }

    function setExcludeFeesStatus(address addy,bool flag) public onlyOwner {
        _excludeFromFees[addy] = flag;
    }

    function setUniswapPair(address addy) public onlyOwner {
        uniswapV2Pair = addy;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if ( uniswapV2Pair == address(0) ) {
            uniswapV2Pair = recipient; // first transfer from LP, set to this
        }
