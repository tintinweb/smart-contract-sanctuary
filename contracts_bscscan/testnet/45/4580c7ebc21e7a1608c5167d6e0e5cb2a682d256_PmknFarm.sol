...
contract PmknToken is BEP20("PmknToken", "PMKN") {
...
contract PmknFarm is Ownable {
    ...
    function calculateYieldTotal(address user) public view returns(uint256) {
        ...
        uint multiplier =  POOL_MULTIPLIER / 100;
    ...
    function setPoolMultiplier(uint256 _amount) public onlyOwner {
        POOL_MULTIPLIER = _amount;
    }
