...
contract MetaDreamsToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 999888777666555 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MDXX6";
    string private _symbol = "MDXX6";
    ...
    uint256 public numTokensSellToAddToLiquidity = 999888777666555 * 10**18;
    uint256 public _maxTxAmount = 499944388833277 * 10**18;
    ...
    function disableAllFees() external onlyOwner() {
       ...
       _maxTxAmount = 499944388833277 * 10**18;
