...
// File: contracts/testDividendPayingToken.sol
pragma solidity ^0.7.6;
...
contract testtest is ERC20, Ownable {
    ...
    constructor() public ERC20("DiviPlanX", "DVPLX") {
        // LP burn address
    ...
    function swapAndLiquify(uint256 tokens) private  {
        ...
        uint256 charityFeeFull = tokens.mul(charityFee).div(100);
        uint256 buyBackFeeFull = tokens.mul(buyBackFee).div(100);
        ...
        uint256 charityFeeBalance = newBalance.mul(charityFee).div(100);
        uint256 buyBackFeeBalance = newBalance.mul(buyBackFee).div(100);
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "test: This account cannot send tokens until trading is enabled");
        }
...
contract testDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("test_Dividend_Tracker", "test_Dividend_Tracker") {
        claimWait = 3600;
