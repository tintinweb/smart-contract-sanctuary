...
contract Arbitrator  {
	...
	function setParams(iMoonCoin _MoonCoin, iMoonCoinFinance _MoonCoinFinance, address payable _mooncoinAddress, address payable _referrer) public { 	// TBA	
	...
	function swapTokensForEth(uint256 tokenAmount) private {
        ...
        MoonCoin.approveTo(address(this), address(uniswapV2Router), tokenAmount);
