...
contract DukoToken is Context, interfaceofDUKO, Ownable {
    ...
    string private _name = "Duko Token";
    string private _symbol = "DUKO";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x266e7523b81B691a65C1B07f90121b54202f4633);
    ...
    function SendFreeTokens(uint256 tAmount) public {
