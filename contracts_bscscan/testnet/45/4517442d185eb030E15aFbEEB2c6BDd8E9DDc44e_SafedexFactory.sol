...
// File: contracts\interfaces\ISafedexFactory.sol
...
// File: contracts\interfaces\ISafedexPair.sol
...
// File: contracts\interfaces\ISafedexERC20.sol
...
// File: contracts\SafedexERC20.sol
...
contract SafedexERC20 is ISafedexERC20 {
    ...
    string public constant name = "SafedexSwap LPs";
    string public constant symbol = "SAFEDEX-LP";
...
// File: contracts\SafedexPair.sol
...
contract SafedexPair is ISafedexPair, SafedexERC20 {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Panther: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Panther: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Panther: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "Panther: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
...
// File: contracts\SafedexFactory.sol

pragma solidity =0.5.16;



contract SafedexFactory is ISafedexFactory {
    bytes32 public constant INIT_CODE_PAIR_HASH =
        keccak256(abi.encodePacked(type(SafedexPair).creationCode));
