...
Sells/ transfers from wallet to wallet:
4.5% reflections
4.5% lottery
6% marketing (Bnb)
2% liq
...
ABOUT LOTTERY:
Every tx a percentage goes to a random address that have at least 20M tokens
If the user can't win, do another try for winner, otherwise the tokens will be burnt

ABOUT ANTIWHALE:
more than 250M tokens = 2.5% extra tax 
more than 500M tokens = 5% extra tax 
more than 1B tokens = 7.5% extra tax
these tax will go to liquidity
...
contract LotteryDoge is Context, IERC20, Ownable {
    ...
    uint256 public _minLottoBalance = 20* 10**6 * 10**_decimals; //20M is the minimum to be eligible to win
    ...
    constructor () {
        ...
        marketingAddress = payable(0xa83a9d5A7C1bdA04885aD8Da66F9D6930Cd5BaAb);
