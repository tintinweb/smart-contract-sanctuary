...
contract EthEarn is IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 4) / 1000; //0.2% of total supply
    ...
    constructor () {
        ETHEREUM = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47;
        ...
        distributor = new DividendDistributor(address(router), ETHEREUM);
    ...
    function checkTxLimit(address sender, address recipient, uint256 amount) internal view {
        ...
        require(
            recipientBalance + amount <= _maxWalletToken,
