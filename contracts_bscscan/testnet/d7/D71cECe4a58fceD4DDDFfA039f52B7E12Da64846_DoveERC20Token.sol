...
library EnumerableSet {
  ...
  /**
   * Inserts new value by moving existing value at provided index 
   to end of array and setting provided value at provided index
   */
...
contract DoveERC20Token is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("Dove", "DOVE", 9) {
    }
