...
// CASCADE token contract based on the full ERC 20 Token standard
...
/**
 * CASCADE Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract CacStandardToken is CASCADEToken, Ownable {
    
    using CACDMaths for uint256;
...
contract CASCADE is CacStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 750000000 * 10**8 ; // 
    string constant public name = "CASCADE"; //fancy name: eg CASCADE
    string constant public symbol = "CACD"; //An identifier: eg CACD
