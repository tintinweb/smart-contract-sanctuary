...
library PriceLibrary {
    ...
    function price(uint amountIn, address _factory, address _from, address _to) public view returns(uint amountOut) { 
        if(_from==_to){
            return amountIn;
        }
        ...
        if(_pair!=address(0)){
            ...
            amountOut = getAmountOut(amountIn, ureserve0, ureserve1);
        }
    }
