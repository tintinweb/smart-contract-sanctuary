    ...
    OwnableUpgradeable
{
    ...
    function _calculateInitialWolfPackLife(uint256 _wolfPackId) internal view returns (uint256) {
        uint256 initialLife;
    ...
    function destroyWolfPack(uint256 _wolfPackId) external returns (bool) {
        ...
        uint256 initialLife = _calculateInitialWolfPackLife(_wolfPackId);
        require(wolfPackLife[_wolfPackId] >= initialLife, "You cannot destroy this wolfpack");
