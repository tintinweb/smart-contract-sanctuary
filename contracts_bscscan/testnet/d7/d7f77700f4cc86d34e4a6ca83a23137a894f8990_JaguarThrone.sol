...
contract JaguarThrone is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCfE88c94f53BBa557048B01Bdb5369b3caC5C02D); // Marketing Address
    address payable public charityAddress = payable(0xA6296eC752A0Ca797bf2Ac791a6E10304CC2BB83); // charity Address
    ...
    string private _name = "Jaguar Throne";
    string private _symbol = "JTH";
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(forWallets > 0 && _marketingFee.add(_CharityFee) > 0)
        {
            ...
            if(WalletShare > 0)
                transferToAddressETH(charityAddress, WalletShare);
        }
    ...
    function setTaxes(uint256 newBurnFee, uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newCharityTax) external onlyOwner() {
        _burnFee = newBurnFee;
