...
contract FoMo3DSoon is F3Devents{
    ...
    //==============================================================================
    constructor(address stakingpool, address playerbook, address communitybank)
    public
    {
        StakingPool = StakingPoolInterface(stakingpool);
    ...
    modifier isActivated() {
        require(activated_ == true, "its not ready yet.  check ?eta in Telegram");
        _;
    }
    ...
    returns (F3Ddatasets.EventReturns)
    {
        ...
        //community bank
        if(_com > 0) {
            CommunityBank.deposit.value(_com)();
            _com = 0;
        }
    ...
    public
    {
        ...
        require(
            msg.sender == 0xB6b0E7Bfafd4bcf7B8D964aeb8c1D1F5b2A22ade ||
            msg.sender == 0xa9F749C0A298e121311086c0D08EB52d8A0618F0,
            "only team just can activate"
        );
