...
contract SamuraiRecruiting is RSunAuth, IERC721Receiver {
    ...
    uint public maxUsagesGeneral = 20; // generals can be used 30 times
    uint public rsunCost = 15000 gwei; // 15k RSUN ~ 15-20$

    uint public lockDurationBase = 40;
    uint public lockDurationPerUsage = 20;

    uint public lockDurationBaseGeneral = 20;
    uint public lockDurationPerUsageGeneral = 10;
    ...
    event RecruitmentStarted(address user, uint[] cardIds, uint missionId);
    event RecruitmentFinished(address user, uint missionId);
