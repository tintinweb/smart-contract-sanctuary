...
contract MiniSports is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa350369f04b7Aaa7d261DD54356993Ca42109B8b); 
    ...
    string private _name = "koko sport token";
    string private _symbol = "KST";
