...
contract sToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Zjh", "sZJH", 9) ERC20Permit() {
    ...
    /**
        @notice increases sZJH supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sZJH
