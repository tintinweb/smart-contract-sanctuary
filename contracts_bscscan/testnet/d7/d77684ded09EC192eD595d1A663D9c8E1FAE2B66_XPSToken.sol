...
contract XPSToken is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityTriggerAmount = 1 * 10 ** 12; // = 500,000 tokens
    uint256 public _marketingTriggerAmount = 1 * 10 ** 12; // = 500,000 tokens
    uint256 public _communityTriggerAmount = 1 * 10 ** 12; // = 500,000 tokens
