...
contract DevSalary {
    ...
    function addDeveloper(address _newDev, uint256 _monthlyAllowance) public onlyOwner {
        ...
        msnDevelopers[_newDev].monthlyAllowance = _monthlyAllowance*10**18;
        emit DeveloperAdded(_newDev, msnDevelopers[_newDev].monthlyAllowance);
    }
    ...
    function _returnMonthsSinceTGE() public view returns (uint256) {
