...
contract $KDASHDividendDistributor is IDividendDistributor {
...
contract KARDASH is IBEP20, Auth {
    ...
    $KDASHDividendDistributor public distributor;
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new $KDASHDividendDistributor(address(router));
