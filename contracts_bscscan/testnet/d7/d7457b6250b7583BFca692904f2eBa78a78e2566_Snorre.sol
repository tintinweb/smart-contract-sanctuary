...
contract Sviki is BEP20{
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (_isNonTaxedTransfer)   //  (recipient == BURN_ADDRESS || recipient == FEE_ADDRESS || sender == DEV_ADDRESS ) 
        {
...
contract Snorre is BEP20{
    ...
    // Fee address
    address public constant FEE_ADDRESS = 0x0FC6b15ab41db1064C901A9E1C233c5Ffd40C535;
