...
contract ANKHFlip is Context {
    ...
    constructor () {
        ...
        // DEPLOYMENT PLAN
        // Set the ANKH Address


        nameOfToken = "Ankh Flip";

        ankhContractAddress = 0x453c3Ed0E14099Fcb65Ffb18350273D8731c1Fd1;
        ...
        minBetAmount = totalSupplyOfToken.div(10**15);   // set to 1 ANKH
    ...
    function GetHeadsOrTails() internal view returns (uint256) {
        ...
        return uint256(keccak256(abi.encodePacked(block.number, block.timestamp, randomNumberCounter, ankhContractAddressIERC20.balanceOf(depositWallet)))).mod(headsOrTails);
    }
    ...
    //     uint256 headsOrTails = 2;
    //     return uint256(keccak256(abi.encodePacked(block.number, block.timestamp, randomNumberCounter, balanceOf(depositWallet)))).mod(headsOrTails);
    // }
