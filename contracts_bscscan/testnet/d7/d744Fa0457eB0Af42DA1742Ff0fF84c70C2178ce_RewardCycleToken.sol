...
contract RewardCycleToken is ERC20Upgradeable, OwnableUpgradeable, IRewardCycleToken {
  ...
  function initialize(
    ...
    address[7] memory addrs; // [0] = owner, [1] = rewardToken, [2] = router, [3] = marketing wallet, [5] = dev wallet, [6] = burn address
    string memory name_;
    ...
    addrs[0] = 0x2C4C168A2fE4CaB8E32d1B2A119d4Aa8BdA377e7;
    addrs[1] = 0xD500E3CF845CC41ABa54bB1dD426bD3485bD8Cd5 ;
    addrs[2] = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    addrs[3] = 0xFC242f42127494934efc79386ec03DCc8991d095;
    addrs[4] = 0xFC242f42127494934efc79386ec03DCc8991d095;
    addrs[5] = 0x63f976b389DF606A4504848c57EaFe644230ccee;
    addrs[6] = 0x000000000000000000000000000000000000dEaD;

    name_ = "TEST";
    symbol_ = "TST";
    totalSupply_ = 1000000000 * 10 ** 18;
    tokenRewardsFee_ = 2;
    tokenRewardsFeeByEth_ = 5;
    liquidityFee_ = 3;
    marketingFee_ = 4;
    devFee_ = 1;
    burnFee_ = 1;
    minimumTokenBalanceForDividends_ = 10 * 10 ** 18;
    ...
    */
    ...
    swapTokensAtAmount = 0; //totalSupply_.mul(2).div(10**6); // 0.002%
    ...
    dividendTrackerByEth.initialize(WETH, minimumTokenBalanceForDividends_);
  ...
  function burn(uint256 tBurn) public {
    super._transfer(_msgSender(), _burnAddress, tBurn);
  }
  ...
  function swapAndSendDividendsByEth(uint256 tokens) public {
    swapTokensForEth(tokens);
    uint256 dividends = address(this).balance;

    (bool success,) = address(dividendTrackerByEth).call{value: dividends}("");
