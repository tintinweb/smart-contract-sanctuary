    ...
    ConfirmedOwner(msg.sender), IERC721Receiver
{
    ...
    returns(uint256 baseCardId, uint256[6] memory bodyParts, uint256 quality, uint256 class, uint256 rarity){
        ...
        uint256[6] memory bodyParts = [
            _getBodyPartItem(randomNumber, _bodyParts[group][baseCardId][1]),
            _getBodyPartItem(randomNumber, _bodyParts[group][baseCardId][2]),
            _getBodyPartItem(randomNumber, _bodyParts[group][baseCardId][3]),
            _getBodyPartItem(randomNumber, _bodyParts[group][baseCardId][4]),
            _getBodyPartItem(randomNumber, _bodyParts[group][baseCardId][5]),
            _getBodyPartItem(randomNumber, _bodyParts[group][baseCardId][6])
        ];
