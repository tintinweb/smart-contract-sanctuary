...
contract PresaleOne is AccessControl {
    ...
    uint256 public lockAmount = 22500000000000000000000000; // 22,500,000 DEB
    ...
    function getBalanceToken(address _address) public view returns( uint256 ) {
        ...
        if(block.timestamp > lockTime){
            ...
            uint256 remainAmount70Percent = remainAmount[address(_address)].mul(7).div(10);
            uint256 remainCurrent = remainAmount70Percent.mul(claimPeriod).div(vestingPeriod) + remainAmount[address(_address)].div(10);
