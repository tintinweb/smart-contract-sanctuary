...
// File: contracts/BSCSBasicStartPool.sol

//pragma solidity 0.6.12;

contract BSCSBasicStartPool is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
...
contract SmartChefFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(BSCSBasicStartPool).creationCode;
        ...
        BSCSBasicStartPool(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
