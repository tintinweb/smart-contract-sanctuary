...
contract EverRiseA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc615d979776Db5e829f2814d8A9846a107581908); // Marketing Address
    ...
    string private _name = "EverRiseA";
    string private _symbol = "RISEA";
