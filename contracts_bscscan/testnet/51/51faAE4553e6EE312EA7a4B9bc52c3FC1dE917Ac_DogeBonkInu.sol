...
contract DogeBonkInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeBonkInu";
    ...
    uint256 private marketingShare = 6000;
    uint256 private partnerShare = 5000;
    uint256 private teamShare = 4000;
    uint256 private liquidityShare = 2000;
    uint256 private buybackShare = 2000;
    ...
    uint256 public buyTaxFloor = 1000;
