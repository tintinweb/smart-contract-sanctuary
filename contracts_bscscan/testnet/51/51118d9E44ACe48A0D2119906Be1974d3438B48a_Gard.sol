...
contract Gard is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xBfAfeF0f5435c01cBa41AEa4d63BC4B816F23BEB); // Marketing Address

    address payable public teamAddress =
        payable(0x583bC868bcA4d5eF6F783a26dccc5D91004D44a7); // Team Address

    address payable public liquidityAddress =
        payable(0x7C929c2f39a4c4B0b1d38ddD42eB63a4CFaCda32); // Liquidity Address
    ...
    string private constant _name = "gard";
    string private constant _symbol = "gard";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 5 / 100; // 0.05%
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 5 / 100; // 0.5% maxWalletToken
