...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function init_testnet() public operator {
        ...
        _add(1000, address(token), 500, 2500, 120, 120, 500, true, 0, 500);
        _add(1000, token_wbnb, 500, 2500, 120, 120, 500, true, 0, 500);
        _add(1000, token_busd, 500, 2500, 120, 120, 500, true, 0, 500);

        _add(500, wbnb_busd, 0, 500, 120, 120, 400, true, 1, 0);
        _add(200, wbnb_eth, 0, 500, 120, 120, 400, true, 2, 0);
        _add(200, router.WETH(), 0, 200, 120, 120, 400, true, 3, 0);
        _add(200, busd, 0, 500, 120, 120, 400, true, 4, 0);
        _add(200, eth, 0, 500, 120, 120, 400, true, 0, 0);
