...
contract TestContract is IBEP20, Auth {
    ...
    mapping (address => uint256) liquidityAmountProvided;
    mapping (address => uint256) liquidityProvidedShare;
    address[] internal liqProviders;
    ...
    function swapBack() internal swapping {
        ...
        for (uint256 i = 0; i< numberOfLiqProvider; i +=1){
            ...
            uint256 transferAmountLiqProvider = amountBNBLiqProvider.mul(sharePercentage);
