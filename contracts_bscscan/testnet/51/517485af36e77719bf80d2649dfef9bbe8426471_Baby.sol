...
contract Baby is ERC20, Ownable {
    ...
    constructor() ERC20("Baby", "BY") {

        address newOwner = address(0xfC69aBdc64C772BAbCD824535B0ee4F5A113FE48);
    	...
    	marketingWallet = address(0x50f514f70DFc09bA5E3E18cF529FEc0AABC40474); // set as marketing wallet
    	buyBackWallet = address(0xF9BCc45E0058857515dd371D26a0063914c3D0C1); // set as buyback wallet
