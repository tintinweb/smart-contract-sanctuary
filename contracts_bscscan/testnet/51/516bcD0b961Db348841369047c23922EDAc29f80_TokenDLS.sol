...
contract TokenDLS is ERC20Burnable, AccessControl {
     ...
     */
    function mint(uint256 amount, address owner) public payable onlyRole(MINTER_ROLE) {
        _mint(owner, amount);
    }
    
    function burn(uint256 amount, address owner) public payable onlyRole(BURNER_ROLE) {
        _burn(owner, amount);
    }
