...
contract PreSale$MSQUID is Context, Ownable {
    IBEP20 public token;
    ...
    mapping(address => uint256) public contributeBalances;
    ...
    function buyToken() payable public {
        ...
        contributeBalances[msg.sender] = contributeBalances[msg.sender].add(numberOfTokens);
    ...
    function calculateClaimAmount(address _user, uint256 multiplier) private view returns (uint256) {
        uint256 remainingBalance = contributeBalances[_user];
