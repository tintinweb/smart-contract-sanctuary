...
contract RijentContract {    
    ...
    // View details 
    function allDetails(address addr) public returns(address, uint, uint, uint, uint, uint, uint, uint, uint) {
        ...
        dep.balanceRoi    = roiAmt - dep.withdrawRoi;
        
        return (addr,dep.lockingType,dep.investAmount,dep.roiPer,timeDiff,roiAmt,dep.withdrawRoi,dep.balanceRoi,dep.balance);
    }
    ///withdraw roiAmt
    function withdraw() external returns (bool) {
        ...
        uint donewithdrawRoi   = dep.withdrawRoi+withAmt;
        dep.withdrawRoi    = donewithdrawRoi;        
        dep.balance        = dep.investAmount + roiAmt-donewithdrawRoi ;
