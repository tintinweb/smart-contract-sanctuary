...
/* * Low Effort Token *
 ...
 No TG. No website. No roadmap. Just a playground for degens. Set slippage to 7%. Max wallet 2%.

 LP burned. Ownership renounced. Totally safe contract. Have fun with it.
...
contract LowEffortToken is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isExcludedFromTxn;
    ...
    string private constant _name = "Low Effort Token"; // 
    string private constant _symbol = "LET"; //    
    ...
    address public  _marketingWallet = 0x1e306316c989580E07B54B3672CC96f897b4f984;
    
    uint256 public _buyCooldown = 10 seconds;
    ...
    constructor () {
        ...
        _isExcludedFromTxn[_marketingWallet] = true;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(from != owner() && to != owner() && to != uniswapV2Pair && !_isExcludedFromTxn[to] && !_isExcludedFromTxn[from])
