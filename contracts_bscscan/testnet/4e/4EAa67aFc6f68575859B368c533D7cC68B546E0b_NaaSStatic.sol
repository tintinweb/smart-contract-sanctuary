...
contract StaticTransferWithFee {
    ...
    function checkTransferWithFees(
        ...
        if (asset.assetClass == LibERC1155Lazy.ERC1155_LAZY_MULTI_ASSET_CLASS) {
            (fills, counterAsset) = checkMultiAssetClass(counterAsset, assetExtraData, false, data);
        } else if (counterAsset.assetClass == LibERC1155Lazy.ERC1155_LAZY_MULTI_ASSET_CLASS) {
    ...
    function checkMultiAssetClass(
        ...
        bytes calldata data
    ) internal pure returns (uint256 totalAmount, LibAsset.Asset memory payingAsset) {
        ...
        totalAmount = assetIds.amounts.getArraySum();
