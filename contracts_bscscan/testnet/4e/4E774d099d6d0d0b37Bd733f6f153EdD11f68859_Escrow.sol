...
contract Escrow {
    ...
    function releasePayment(uint256 _id) public {
        ...
        if(temp.payType){
            ...
            IERC20(token).transfer(getEscrow[_id].seller,buyerReflection);
        }
    ...
    function cancelProposal(uint256 _id) public {
        require(getProposal[_id].buyer==msg.sender,"You havent created this Proposal");
        uint256 _amount = getProposal[_id].amt;
        require(balances[msg.sender]>=_amount,"You dont have enough funds");
