...
contract BIMPVestingFund1{
    ...
    uint256 public initialTokensBalance = 888888888 * 10 ** 8;
    
    // Amount of tokens already sent
    uint256 public tokensSent = 0;
    ...
    function initVestingStages () internal {
        stages[0].date = 1629132415;
        stages[1].date = 1629132615;
        stages[2].date = 1629132715;
        stages[3].date = 1629132915;
