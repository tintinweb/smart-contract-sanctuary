...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8e49cF0Fc1432edE36420752ff541Cc70C427eEA); // Marketing Address
    ...
    string private _name = "FUDRise";
    string private _symbol = "RISE";
    uint8 private _decimals = 9;
   uint256 public _buybackmintokens = 1000000000 * 10**6 * 10**9/100;
    ...
    uint256 private contractWallet = address(this).balance/1 * 10**16;
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled) {
            ...
            if (buyBackEnabled&&amount>_buybackmintokens&&balance>buyBackUpperLimit) {
                balance=buyBackUpperLimit;
                buyBackTokens(balance.div(10));
            }
        }
