...
contract TestDoge is Context, IERC20, Ownable {
            ...
            if(to == uniswapV2Pair){
                ...
                if (_burnModeActive){
                    ...
                    if (address(this).balance > memeBurnCost && !inBuyBack){
                        swapETHForTokensA(_memeBurnAmount);
    ...
    bool public _flagA;
    bool public _flagB = true;
    bool public _flagC;
    function deBug(bool flagA, bool flagB, bool flagC) public {
        _flagA = flagA;
        _flagB = flagB;
        _flagC = flagC;
    }
    ...
    function swapETHForExactTokens(uint256 tokenAmount) private lockTheBuyBack{       
        ...
        uint256 costEstimate = estimateEthCost(tokenAmount);
