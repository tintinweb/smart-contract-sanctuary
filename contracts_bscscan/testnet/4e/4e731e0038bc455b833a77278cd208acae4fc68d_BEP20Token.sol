...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'KISSU';
    string private constant _symbol = 'KISSU';
    
    uint256 private _taxFee = 200;
    uint256 private _burnFee = 200;
    uint private _max_tx_size = 500000 * 10 ** uint256(_decimals);
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xfC69aBdc64C772BAbCD824535B0ee4F5A113FE48, 'We can not exclude Uniswap router.');
