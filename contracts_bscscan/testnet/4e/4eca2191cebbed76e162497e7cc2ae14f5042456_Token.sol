...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name    = "MMT2";
    string private _symbol  = "MMT2";
    ...
    uint256 public _externalTokenMinAmount          = 5 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmountBuy                  = 500 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmountSell                 = 500 * 10**6 * 10**_decimals;
    uint256 public _numTokensSellToAndTransfer      = 500 * 10**6 * 10**_decimals;
    uint256 public _maxTokensPerAddress             = 2000 * 10**6 * 10**_decimals;
