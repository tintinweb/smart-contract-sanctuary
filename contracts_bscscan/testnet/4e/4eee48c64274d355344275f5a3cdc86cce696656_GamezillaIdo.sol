...
contract StakingDetails {
    ...
    constructor() {
        stakeGetter = STAKE(0xc3bf39979615EB1d9801D176384B492F6845a904); //stake contract address
    }
...
contract GamezillaIdo {
    ...
    uint tier1Alloc = 42857142 * 10**15;
    uint tier2Alloc = 35714285 * 10**15;
    uint tier3Alloc = 35714285 * 10**15;
    uint tier4Alloc = 28571428 * 10**15;
    
    mapping(address => uint) public userAlloc;
    address private owner = msg.sender;
    address claimTokenAddr = 0x3cc97b7fcE42d372d3f5f08ED8121245B1a66fFF; // clainTokenAddress
