...
// list of stableCoin
    ...
    function calculateFee() public onlyOwner {
    ...
    ChainIdHolding
{
    ...
    string public constant override name = "DTO CCSC LP";
    string public constant override symbol = "CCSC-LP";
    ...
    function _balanceOf(address from) internal view returns (uint256) {
