...
import "./BalanceInvestorContract.sol";
...
contract HGTCrowdsale is Crowdsale {
    ...
    KycContract kyc;
    BalanceInvestorContract balanceInvestor;
    ...
    constructor(
        ...
        IERC20 _token,
        KycContract _kyc,
        BalanceInvestorContract _balanceInvestor
        ...
        kyc = _kyc;
        balanceInvestor = _balanceInvestor;
    }
    ...
    */
    ...
    function _updatePurchasingStateCustom(address beneficiary, uint256 weiAmount, uint256 tokens) internal virtual override {
        // solhint-disable-previous-line no-empty-blocks
        // (address token,address beneficiary, uint256 weiAmount, uint256 tokenAmount) 
        balanceInvestor.registerBalances(address(this),beneficiary,weiAmount,tokens);
...
contract BalanceInvestorContract {
    ...
    mapping (address => Balance) balanceInitial;
    mapping (address => Balance) balanceUpdated;
