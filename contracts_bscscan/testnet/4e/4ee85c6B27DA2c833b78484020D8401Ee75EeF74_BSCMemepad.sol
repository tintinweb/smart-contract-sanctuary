...
contract BSCMemepad is Owned {
    ...
    address public tokenAddress = 0xB96484Bb253E7Ee7E1550775cdB1FCcC88127F16;
    uint256 public tokenDecimals = 9;
    
    
    uint256 public tokenRatePerEth = 30000000 * 10**9;
    uint256 public rateDecimals = 0;
    
    uint256 public minEthLimit = 1e17; // 0.1 BNB
    uint256 public maxEthLimit = 10e17; // 1 BNB
    ...
    function addWhitelistedAddress(address _address, uint256 _allocation) external onlyOwner {
        whitelistedAddresses[tokenAddress][_address] = _allocation * 100 ** tokenDecimals;
    }
    ...
    function addMultipleWhitelistedAddresses(address[] calldata _addresses, uint256[] calldata _allocation) external onlyOwner {
         for (uint i=0; i<_addresses.length; i++) {
             whitelistedAddresses[tokenAddress][_addresses[i]] = _allocation[i] * 100 ** tokenDecimals;
         }
    }
