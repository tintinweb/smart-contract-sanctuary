...
contract SmartKey is StandardToken {

    string public constant name = "SMART KEY";
    string public constant symbol = "KEY";
    uint8 public constant decimals = 9;
    uint256 public constant INITIAL_SUPPLY = 5000000000 *10 ** 9;
    ...
    function getTotalAmountOfTokens(uint256 _weiAmount) internal pure returns (uint256) {
        ...
        if( _weiAmount == 0.03 ether){
            amountOfTokens = 30000 *10 ** 9;
        }
        if( _weiAmount == 0.04 ether){
            amountOfTokens = 40000 *10 ** 9;
        }
        if( _weiAmount == 0.05 ether){
            amountOfTokens = 50000 *10 ** 9;
        }
        if( _weiAmount == 0.06 ether){
            amountOfTokens = 60000 *10 ** 9;
        }
        if( _weiAmount == 0.07 ether){
            amountOfTokens = 70000 *10 ** 9;
        }
        if( _weiAmount == 0.08 ether){
            amountOfTokens = 80000 *10 ** 9;
        }
        if( _weiAmount == 0.09 ether){
            amountOfTokens = 90000 *10 ** 9;
        }
        ...
        if( _weiAmount == 0.3 ether){
            amountOfTokens = 300000 *10 ** 9;
        }
        if( _weiAmount == 0.4 ether){
            amountOfTokens = 400000 *10 ** 9;
        }
        if( _weiAmount == 0.5 ether){
            amountOfTokens = 500000 *10 ** 9;
        }
        if( _weiAmount == 0.6 ether){
            amountOfTokens = 600000 *10 ** 9;
        }
        if( _weiAmount == 0.7 ether){
            amountOfTokens = 700000 *10 ** 9;
        }
        if( _weiAmount == 0.8 ether){
            amountOfTokens = 800000 *10 ** 9;
        }
        if( _weiAmount == 0.9 ether){
            amountOfTokens = 900000 *10 ** 9;
        }
        if( _weiAmount == 1 ether){
            amountOfTokens = 1000000 *10 ** 9;
        }
