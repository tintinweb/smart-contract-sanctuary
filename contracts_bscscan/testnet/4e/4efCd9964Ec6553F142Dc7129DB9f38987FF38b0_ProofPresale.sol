...
contract ProofPresale is Pausable {
  ...
  function init(address _token,address payable  _wallet, uint256 _minInvestment,uint256 _maxInvestment, uint256 _cap, uint256 _rate)public onlyOwner{
    ...
    wallet = _wallet;
    rate = _rate;
    minInvestment = _minInvestment.div(100).mul(10**18);  //minimum investment in wei  (=10 ether)
    maxInvestment = _maxInvestment.div(100).mul(10**18);
