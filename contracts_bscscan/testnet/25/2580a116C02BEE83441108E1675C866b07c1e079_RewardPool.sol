...
contract LPTokenWrapper {
    ...
    function _setLPToken(address yAddress) public {
        y = IERC20(yAddress);
    }
...
contract RewardPool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    constructor(address _LPTokenAddress, address _yfiAddress) {
        super._setLPToken(_LPTokenAddress);
        yfi = IERC20(_yfiAddress);
    }
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            yfi.transfer(msg.sender, reward);
