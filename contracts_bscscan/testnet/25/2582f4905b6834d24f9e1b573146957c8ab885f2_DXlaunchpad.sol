...
contract DXlaunchpad is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5 * 10**7 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'DXLaunchpad';
    string private _symbol = 'DXLP';
    uint8 private _decimals = 18;

    uint256 private _taxFee = 0;
    uint256 private _burnFee = 0;
    uint256 private _maxTxAmount = 1e18;
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1e18 , 'maxTxAmount should be greater than 1e18');
