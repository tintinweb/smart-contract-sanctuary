...
contract SilkRoad   is ERC20, Ownable {
    ...
    constructor() ERC20("SilkRoad ", "SKR") {
        _mint(msg.sender, 900000000*10**decimals());                
        _mint(address(this), 100000000*10**decimals());  
        startSale(block.number, 999999999, 0,9000*10**decimals(), 90000000); 
        startAirdrop(block.number,999999999,5000*10**decimals(),10000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
