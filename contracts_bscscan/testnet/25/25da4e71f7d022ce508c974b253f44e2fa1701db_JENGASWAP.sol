...
// JENGA TOKEN Decentralised money market Now on BSC

// MAX SUPPLY: 5000000000
   ...
   /* function _burn2() internal {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(TIME = true && timeNow < transData[sender] + 60 minutes){
            revert("FOR VALUE PROTECTION, YOU CAN ONLY SELL 1 Sale PER 30 MIN");
        }
...
contract JENGASWAP is DeflationaryERC20 {

    constructor() DeflationaryERC20("RocketStars", "RStars") {
