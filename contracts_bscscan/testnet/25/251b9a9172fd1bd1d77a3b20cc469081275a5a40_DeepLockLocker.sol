...
contract DeepLockLocker is Ownable, ReentrancyGuard {
    ...
    function lockTokens(
        ...
        require(_unlockTime > block.timestamp, 'Unlock time must be in future');
         ...
         emit logtrack1(msg.sender, IBEP20(_tokenAddress).name(), IBEP20(_tokenAddress).approve(address(this), _amount));
         emit logtrack1(address(this), "this", true);
        ...
        //IBEP20(_tokenAddress).transferFrom(msg.sender, address(this), _amount);
/*
