...
// WELCOME TO OPPA-FINANCE Initial Liquidity Offering (ILO)
...
// OppaToken with Governance.
contract OppaFinance is BEP20("Oppa Governance Token", "OPPA") {
...
contract ILO {
    ...
    function initialise(OppaFinance _token, uint256 _availabletoken)
        public
        onlyOwner
    {
        token = _token;
    ...
    function WithdrawToken(uint256 _amount) external onlyOwner {
        OppaFinance(token).transfer(msg.sender, _amount);
    }
