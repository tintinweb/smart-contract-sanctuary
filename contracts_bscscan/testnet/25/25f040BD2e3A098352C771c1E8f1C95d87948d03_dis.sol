...
contract Adamant is Context, IERC20, Ownable {
    ...
    uint256 public _burnFee = 3; // Burn Fee
    ...
    constructor () public {
        _devWalletAddress = 0x4Fc4bFeDc5c82644514fACF716C7F888a0C73cCc;
    ...
    function _setCharityWallet(address payable devAddress) external onlyOwner() {
...
contract dis is Ownable {
    ...
    Adamant inter = Adamant(0x76dF2CB66C1Eac11fAF565e0736DE08F534129dE);
