...
contract PlayBoyCoin is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    constructor (
        ...
        _rOwned[_msgSender()] = _rTotal;    // 5% for presale
        // _rOwned[blackholeAddress] = _rTotal.mul(50).div(100);   // 50% to blackhole
        // _rOwned[address(0xA3EB0428a59acdbe2A5829c3c9E84BeFF49bA19B)] = _rTotal.mul(4).div(100); // 12% for team wallet(4% per wallet)
        // _rOwned[address(0x0ee1bd464954018186DF12dDF74d41A07d78b999)] = _rTotal.mul(4).div(100);
        // _rOwned[address(0x059C28941ce57B0b588C472412DDc1904A0c94Cd)] = _rTotal.mul(4).div(100);
        // _rOwned[saleAddress] = _rTotal.mul(33).div(100);    // 33% for sale
