...
contract Staking {
    ...
    function withdraw() public returns (bool) {
        ...
        if(saleAddress == address(0)){
            ...
            if(user[sender].tier == 1){
                    endTime = user[sender].lastStakeTime + 2 minutes;
                    ...
                    user[sender].totalStaked = 0;
            }
    
            else if(user[sender].tier == 2){
                    endTime = user[sender].lastStakeTime + 4 minutes;
                    since = user[sender].lastStakeTime ;
                    ...
                    endTime = user[sender].lastStakeTime + 6 minutes;
                    since = user[sender].lastStakeTime ;
            ...
            if(user[sender].tier == 1){
                if(sale.showSaleStatus() == true){
                    if(sale.userBuyStatus(sender) == true){
                        ...
                        if(saleEndTime < endTime){
                            endTime = user[sender].lastStakeTime + saleEndTime;
                        }
                        else{
                            endTime = user[sender].lastStakeTime + 2 minutes;
                        }
