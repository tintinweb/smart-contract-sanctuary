...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    //////////////////////////// NIP VARS ////////////////////////////  
    address public nipContractAddress = 0xa9f75317EB3d96086b896Cb8f2E5De87F9Cd2d52;       // CHANGEIT - set the right contract address
    ...
    function MintCatNIPNFT(string memory tokenURIstring, uint256 costOfNFT, address addressToMintTo) OnlyMinter() public returns (uint256) {
        ...
        require(nipContractAddressICatNIP.GetDepositAmountTotal(addressToMintTo) >= minimumAmountInDepositToMint, "You do not have enough NIP in the Deposit, At least have the minimum amount.");
        require(nipContractAddressICatNIP.GetDepositAmountTotal(addressToMintTo) >= costOfNFT, "You do not have enough NIP in the Deposit, please deposit more NIP");
    ...
    function SetCatNIPNFTMetaData(uint256 itemId, string memory newTokenURIstring, uint256 costOfChange, address addressOfNFTtoChange) OnlyMinter() external {
        ...
        require(nipContractAddressICatNIP.GetDepositAmountTotal(addressOfNFTtoChange) > 0, "You have no deposit, please deposit more NIP");
        require(nipContractAddressICatNIP.GetDepositAmountTotal(addressOfNFTtoChange) >= minimumAmountInDepositToChangeMetaData, "You do not have enough NIP in the Deposit, At least have the minimum amount.");
        require(nipContractAddressICatNIP.GetDepositAmountTotal(addressOfNFTtoChange) >= costOfChange, "You do not have enough NIP in the Deposit, please deposit more NIP");
