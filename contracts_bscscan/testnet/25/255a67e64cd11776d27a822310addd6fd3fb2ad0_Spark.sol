...
contract Spark is IERC20, Owend{
    ...
    address public newPledgeAddress=0x5400C770752dF676b0d1B23CB0264819F7788b69;
    constructor()public{
   ...
   function totalSupply() public view override returns (uint256) {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(amount >0, "ERC20: amount must more than zero ");
        require(_allowances[msg.sender][sender] >= amount, " _allowances must more than amount ");
