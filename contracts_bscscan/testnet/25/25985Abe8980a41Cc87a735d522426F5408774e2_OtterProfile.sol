...
// File: @Otterswap/Otter-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/OtterProfile.sol
...
*/
contract OtterProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public otterToken;
    ...
    uint256 public numberOtterToReactivate;
    uint256 public numberOtterToRegister;
    uint256 public numberOtterToUpdate;
    ...
    constructor(
        IBEP20 _otterToken,
        uint256 _numberOtterToReactivate,
        uint256 _numberOtterToRegister,
        uint256 _numberOtterToUpdate
    ) public {
        otterToken = _otterToken;
        numberOtterToReactivate = _numberOtterToReactivate;
        numberOtterToRegister = _numberOtterToRegister;
        numberOtterToUpdate = _numberOtterToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends OTTER to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer OTTER tokens to this contract
        otterToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberOtterToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer OTTER token to this address
        otterToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberOtterToUpdate
    ...
    /**
     * @dev Claim OTTER to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        otterToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of OTTER to register
     * Callable only by owner admins.
     */
    function updateNumberOtter(
        uint256 _newNumberOtterToReactivate,
        uint256 _newNumberOtterToRegister,
        uint256 _newNumberOtterToUpdate
    ) external onlyOwner {
        numberOtterToReactivate = _newNumberOtterToReactivate;
        numberOtterToRegister = _newNumberOtterToRegister;
        numberOtterToUpdate = _newNumberOtterToUpdate;
    }
