...
contract UberDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc53E4d2A3c7Dac84B8e11fe780838Ccc768d27ad); // Marketing Address
    ...
    string private _name = "UberDoge";
    string private _symbol = "UBERDOGE";
