...
contract fishingTownPresale is Ownable {
    ...
    event TransferToTreasury(address treasuryAddress, uint256 amount);
    ...
    function whiteListPresale (uint256 busdAmount) external onlyWhiteList {
        ...
        require(whiteListBusdBalances[msg.sender] + amount <= maxPrice && (amount >= (100 * 1 ether)|| whiteListBusdBalances[msg.sender] >(200 * 1 ether)));
        ...
        totalBUSDfund+= amount;
    }

    function getMyBalance() public view returns (uint256) {
        return whiteListBusdBalances[msg.sender];
    }

    function getWhiteListBalance(address wlAddress) onlyOwner public view returns(uint256)  {
