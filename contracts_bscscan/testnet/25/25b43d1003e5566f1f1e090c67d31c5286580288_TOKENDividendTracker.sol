...
contract TOKEN is ERC20, Ownable {
    ...
    address private constant CAKE =
        address(0x77c21c770Db1156e271a3516F89380BA53D594FA); //CAKE

    uint256 public swapTokensAtAmount = 2 * 10**6 * (10**9);
    uint256 public maxTxLimit = 1 * 10**8 * (10**9);
    uint256 public maxWalletLimit = 5 * 10**8 * (10**9);
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant CAKE = address(0x77c21c770Db1156e271a3516F89380BA53D594FA); //CAKE
