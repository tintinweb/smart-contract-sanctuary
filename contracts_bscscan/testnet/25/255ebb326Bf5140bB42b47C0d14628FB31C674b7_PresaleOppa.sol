...
contract PresaleOppa {
    ...
    uint256 pricePerToken = 100000000000000000;

    uint256 public availableToken;
    uint256 MinPurchase = 100000000000000000; // 1 Oppa OPPA
    uint256 MaxPurchase = 2000000000000000000; // 20 BNB
