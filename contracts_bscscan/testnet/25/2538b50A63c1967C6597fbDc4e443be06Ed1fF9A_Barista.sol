...
contract Barista is Context, IERC20, Ownable {
    ...
    //pancakerouter testnet
    address public router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    
    uint256 private constant MAX = ~uint256(0);
    uint256 public _tTotal = 13000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string public _name = "Barista";
    string public _symbol = "BRTA";
    ...
    uint256 public numTokensSellToAddToLiquidity = 1300000000 * 10**9;
    ...
    function _transfer(
        ...
        if (
            ...
            contractTokenBalance = _tTotal.mul(_liquidityFee).div(_liquidityFee.add(_taxFee));
            //add liquidity
    ...
    function enableFees(uint256 liquidityFee, uint256 taxFee) public onlyOwner {
        _maxTxAmount = _tTotal;
        _liquidityFee = liquidityFee;
        _taxFee = taxFee;
