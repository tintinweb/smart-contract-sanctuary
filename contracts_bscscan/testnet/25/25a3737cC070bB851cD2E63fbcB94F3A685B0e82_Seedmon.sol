...
contract Seedmon is ERC721Enumerable, TrustCaller {
    event SeedmonCreated(string name);
    event SeedmonChanged(string name);
    ...
    string[] public names;
    mapping(string => Profile) public nameToProfile;
    mapping(string => Stat) public nameToStat;
    mapping(string => BaseAction) public nameToBaseAction;
    mapping(string => string) public nameToTokenURI;

    mapping(uint256 => string) public tokenIdToName;
    mapping(uint256 => UniqueProfile) public tokenIdToUniqueProfile;
    mapping(uint256 => Stat) public tokenIdToBonusStat;
    ...
    function allNames() external view returns (string[] memory) {
        return names;
    }
    ...
    function mint(address to, string calldata name_, UniqueProfile calldata uniqueProfile_, Stat calldata bonusStat_) external onlyTrustCaller {
    ...
    function createSeedmon(string memory name, Profile calldata profile_, Stat calldata stat_, BaseAction calldata baseAction_, string calldata uri) external onlyOwner {
    ...
    function adjustSeedmon(string memory name, Profile calldata profile_, Stat calldata stat_, BaseAction calldata baseAction_) external onlyOwner {
    ...
    function setTokenURI(string memory name, string calldata uri) external onlyOwner {
        require(doesSeedmonExist(name), "Seedmon: does not exist");
    ...
    // ================== Internal method ============
    function doesSeedmonExist(string memory name_) internal view returns (bool doesExist) {
