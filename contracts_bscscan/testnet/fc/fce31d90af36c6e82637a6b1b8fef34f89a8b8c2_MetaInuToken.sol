...
contract MetaInuToken is BEP20Pausable {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    uint256 private _price;

    constructor() BEP20("Meta Inu Token", "MIT", 18, 80000000000000000000000000) {}
    ...
    function withdrawbalances(address tokenAddress) external onlyOwner {
