...
library PangolinLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'd0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66' // init code hash PCS TEST ROUTER
            ))));
    }
    // // calculates the CREATE2 address for a pair without making any external calls
    // function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
...
contract DistributorV5 is Ownable {
    ...
    address public constant Factory = address(0x6725F303b657a9451d8BA641348b6761A6CC7a17);
    address public constant Router = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
