...
/**
   ...
   1% token burn for every transaction
   4% added to liquidity 
   
   https://ChisaiDogeCoin.com
   https://t.me/ChisaiDogeCoin
   https://twitter.com/ChisaiDogeCoin
   https://www.reddit.com/r/realgoldeninu
...
contract ChisaiDoge is Context, IERC20, Ownable {
    ...
    string private _symbol = "ChisaiDoge";
    ...
    uint256 public _maxTxAmount = 2500000 * 10**6 * 10**9; // Max Transaction Amount 2.5T
