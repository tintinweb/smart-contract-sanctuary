...
//
// Copyright of The $7SINS Team
//
//
//                                                                   ,.x+=:.
//       dL ud7Nu  :7c       .x777777hx       '@77>,                       ^%
//       7Fd777777L %7      d77777777777hxx    %7P      ;'    u.        .    <k
//       4N77777777cuR     7" ... `"*7777%`     .     [email protected] [email protected] [email protected]"
//       4F   ^""%""d       !"   ` .xnxx.     [email protected]  ^"7777""7777"  [email protected]^%7777"
//       d       .z7        X   .H7777777%:  ''777E`   7777  777R  x77:  `
//             z777         'hn7777777*"  ;>   777E    7777  777R  7777N=*7777
//           d7777'       .  `*77777%`    |!   777E    7777  777R    "    R77
//          777777        '7h.. ``     ..x7>   777E    7777  777R    @7DJx 9%
//         :777777         `77777777777777f    777&   "*77*" 7777" .777777P`
//          777777          '%7777777777*"     R777"    ""   'Y"  `   ^"F
//          '%**%              ^"****""`        ""
//
//
//
//       Gluttony, Wrath, Sloth, Lust, Greed, Pride and Envy
// 
//       $7SINS has a 7% tax split across 7 Sins
//       (All Sells have doubled tax)
// 
//       Gluttony    1%: Burn
//       Wrath       1%: Buyback
//       Sloth       1%: Reflected
...
/**
 * @dev The official 7Sins smart contract
 */
contract SSins is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "7Sins";
    string private _symbol   = "7SINS";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for 7SINS/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xD033FA3c9C5E78612bA3Ac74b63aF2C7736BDE41); // Marketing address used to pay for marketing
    ...
    // Timer Constants 
    uint private constant WEEK = 604800; // How many seconds in a week
    
    // Anti-Whale Settings 
    uint256 public _whaleSellThreshold = 500 * 10**9 * 10**9; // 500 billion
    uint    public _whaleSellTimer     = WEEK;                 // 1 week
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $7SINS will be used to buy at maximum in any one trade
    ...
    uint256 public  _lotteryMinimumSpend = 10 * 10**6 * 10**9; // 10 million tokens required to buy before lottery can be triggered
    ...
    /**
     * @notice Withdraws non-7SINS tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts 7SINS balance for buybacks, giveaway, liquidity and marketing
    ...
    /**
     * @notice Burns 7SINS tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of 7SINS tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from 7SINS)
