...
contract RobotContract {
     ...
     * 初始化方法
     */
    function initialize(address _admin, address _teamAddr, address _usdtAddr, address _ebkAddr, address _rvAddr, address _hptoAddr, address _fgoAddr, address _ftoAddr, address _ocoAddr, address _oioAddr) external {
