...
contract test3x is IBEP20, Auth {
    ...
    string constant _name = "manyak";
    string constant _symbol = "manyak";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(tradingEnabled || (isFeeExempt[sender] || isFeeExempt[recipient]), "Boda: Trading has not started yet");
