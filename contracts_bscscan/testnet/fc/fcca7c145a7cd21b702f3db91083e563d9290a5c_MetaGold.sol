...
/**
  ...
  __  __ ______ _______          _____       _     _ 
 |  \/  |  ____|__   __|/\      / ____|     | |   | |
 | \  / | |__     | |  /  \    | |  __  ___ | | __| |
 | |\/| |  __|    | | / /\ \   | | |_ |/ _ \| |/ _` |
 | |  | | |____   | |/ ____ \  | |__| | (_) | | (_| |
 |_|  |_|______|  |_/_/    \_\  \_____|\___/|_|\__,_|
...
contract MetaGold is Context, IERC20, Ownable {
    ...
    string private constant _name = "META Gold";

    string private constant _symbol = "MEGO";
    ...
    uint private _redisFeeOnSell = 8;
    ...
    address payable private _marketingAddress = payable(0x303291B32206811e1881793C8b99aEB95b24278C);
    ...
    uint public _maxTxAmount = 1000000000000000 * 10**9;

    uint public _maxWalletSize = 1000000000000000 * 10**9;

    uint public _swapTokensAtAmount = 1000000000000000 * 10**9;
