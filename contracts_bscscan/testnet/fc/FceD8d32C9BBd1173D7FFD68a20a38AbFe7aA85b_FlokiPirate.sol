...
/**                                          FlokiPirate IS THE FUTURE
 FlokiPirate is the ruler of the cryptocurrency world and the Pirate of DeFi.
 FLOPISTREAMS, PIRATES NFTS, The High Rewarding System.
  Earn up to 10% in BTT simply by holding at least 200,000 FLOPI. 
 
 Join us on telegram for updates:
 https://t.me/FlokiPirate
 
 Website:
 https://FlokiPirate.com/
...
contract FlokiPirate is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FlokiPirate";
    string constant _symbol = "FLOPI";
    ...
    uint256 public swapThreshold = 2 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x7a1bBdEde3C05B20fdf2592e22bFB58320C208cB;
        devWallet = 0x147DA00d0C6846ebf7BA025611f82BEE7D05E1B2;
