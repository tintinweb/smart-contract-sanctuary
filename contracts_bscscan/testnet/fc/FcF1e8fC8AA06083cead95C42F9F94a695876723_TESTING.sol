...
contract TESTING is Context, IBEP20, Ownable {
    ...
    string private _name = "DuckToken";
    ...
    uint256 public _maxTxAmount =  _tTotal.div(400);
    uint256 private numTokensToSwap =  _tTotal / 2000; // 0.005%
   ...
   function getFeesandWallet() external view returns (address GameAddress,address NFTAddress,uint256 GamePool, uint256 NFTPool, uint256 Liquidity) {
    ...
    function setPoolAddress(address gameaccount,address nftaccount) external onlyOwner {
        require(gameaccount != GamePoolAddress, 'This GamePoolAddress was already used');
        require(nftaccount != NFTPoolAddress, 'This NFTPoolAddress was already used');
