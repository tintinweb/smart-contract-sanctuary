...
contract  BSCSphynxSwapAgentImpl is Context {
    ...
    */
     ...
     * @dev fillETH2BSCSwap
     */
    function fillETH2BSCSwap(bytes32 ethTxHash, address erc20Addr, address toAddress, uint256 amount) onlyOwner external payable notContract returns (bool) {
        ...
        ISphynxBEP20(bscTokenAddr).transferFrom(owner, toAddress, amount);
    ...
    function swapBSC2ETH(address bep20Addr, uint256 amount) payable external notContract returns (bool) {
        ...
        IERC20(bep20Addr).safeTransferFrom(msg.sender, owner, amount);
        if (msg.value != 0) {
