...
10% Buy tax
    -8% BUSD reflection (30% marketing, 70% to holder)
    -2% Auto LP

20% Sell tax
    -16% BUSD reflection(30% marketing, 70% to holder)
    -4% Auto LP
*/
...
contract BabyEarnBUSD is IBEP20, Ownable
{
    ...
    address public constant TeamWallet=0x88BB3E5A87928Cb9A194907d521dc8cEfFC555c3;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            require(amount<=sellLimit,"Whale protection");
    ...
    function getLimits() public view returns(uint256 balance, uint256 sell){
        return(balanceLimit/1000, sellLimit/1000);
    }
