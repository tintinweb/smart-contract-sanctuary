...
contract SportPrediction is Ownable {
    ...
    function createNewMatch(
        ...
        require(
            matches[_matchId].startTime == 0,
            "SportPrediction: Duplicated matchId"
        );
        require(
            _startTime > block.timestamp,
            "SportPrediction: StartTime is gone"
        );
        require(_endTime > _startTime, "SportPrediction: Invalid EndTime");
        ...
        emit NewMatch(_matchId, _startTime, _endTime, _matchType, _description);
