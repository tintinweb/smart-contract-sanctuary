...
contract Zeus is IBEP20, Auth {
    ...
    uint256 zenLaunchBuyAllowance = 1000 ; // 0.00001%
    ...
    function checkZenLaunchTxLimit(address recipient, uint256 amount) public {
        ...
        if(msg.sender != pair) {
            ...
            emit log(ConcatenateStrings("///revert////////////////// Zen Launch Error: Transfer out not allowed during this phase ####### -- Zen Launch ends in (min): ", remainingTime.toString()));
        ...
        // if buy, and not enough allowance
            ...
            emit log(ConcatenateStrings("///revert////////////////// Zen Launch Error: Over Buy Allowance Limit ####### -- Remaining Buy Allowance: ", remainingAllowance.toString()));
    ...
    function setAllowanceTax(address sender, address recipient) internal {
        ...
        if(recipient == pair) {
            ...
            emit log("////////////////// Zen Allowance: selected tax - 'overAllowanceSell'");
        }else { 
            ...
            selectedTax = 'default';
            emit log("///revert////////////////// Zen Allowance: selected tax - 'overAllowanceSell'");
