...
contract BlucaDependency {
    ...
    modifier onlyBreeder() {
        require(whitelistedBreeder[msg.sender], "S-PMS103");
        _;
    }
    ...
    BlucamonAirdrop
{
    ...
    function breed(uint256 _blucamonId1, uint256 _blucamonId2)
        ...
        onlyBreeder
    {
        require(isBreedable(_blucamonId1), "S-BRD100");
        require(isBreedable(_blucamonId2), "S-BRD100");
        Blucamon storage _blucamon1 = blucamons[indexMapping[_blucamonId1]];
        _blucamon1.elementalFragments = _blucamon1.elementalFragments - 1;
        Blucamon storage _blucamon2 = blucamons[indexMapping[_blucamonId2]];
        _blucamon2.elementalFragments = _blucamon2.elementalFragments - 1;
    }
