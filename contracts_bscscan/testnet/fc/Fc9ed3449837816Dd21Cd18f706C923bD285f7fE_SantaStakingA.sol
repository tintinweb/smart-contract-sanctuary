...
contract SantaStakingA is Ownable, ReentrancyGuard {
    ...
    // The reward token
    IERC20 public rewardToken = IERC20(0x2995bD504647b5EeE414A78be1d7b24f49f00FFE);
    // The reflection token of staking token
    IERC20 public reflectionToken = IERC20(0x2995bD504647b5EeE414A78be1d7b24f49f00FFE);
