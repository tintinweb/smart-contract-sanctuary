...
contract WarriorChest is IChest, Ownable, ReentrancyGuard, Pausable {
    string public constant chestName = "Warrior Pack";
    uint256 public constant totalSupply = 100;
    uint256 public constant totalChestUserCanBuy = 1;

    mapping (address => bool) winnerAddr;

    using SafeERC20 for IERC20;
    // Token DOR
    IERC20 private constant DOR = IERC20(0x8d58514eaa7DfD24B400633d11d6bDcbC36e02BE);
    ...
    function buyChest() external override nonReentrant {
        require(!paused(), "WarriorChestPausable: Buy chest while paused");
        ...
        require(
          DOR.balanceOf(msg.sender) >= chestPrice,
          'insufficient balance'
        );

        DOR.safeTransferFrom(msg.sender, address(this), chestPrice);
