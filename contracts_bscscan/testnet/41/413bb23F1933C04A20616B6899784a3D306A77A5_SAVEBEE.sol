...
contract SAVEBEE is Context, IERC20, Ownable {
    ...
    uint256 public _maxRxAmount = 10000 * 10**_decimals;   // 10k - Initial max sell
    ...
    uint public TokensFee1 = 5000 * 10**_decimals;                          
    // Porcentagem da taxa do TokensFee1
    uint public taxaFee1 = 25;                              

    // Numero de Token para Taxar
    uint public TokensFee2 = 7500 * 10**_decimals;
    // Porcentagem da taxa do TokensFee2
    uint public taxaFee2 = 50;    

    // Numero de Token para Taxar
    uint public TokensFee3 = 9000 * 10**_decimals;
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
        ...
        marketingAddress = payable(0x6d02acbC290aB7F1504652C0b054Bff9A2159fa5);
