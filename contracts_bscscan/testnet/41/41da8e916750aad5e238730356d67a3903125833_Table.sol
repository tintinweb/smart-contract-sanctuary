 ...
 */
contract Table is ERC20Detailed, ERC20Pausable, ERC20Burnable {
     ...
     * @param name The display name of the token: Table
     * @param symbol The symbol of the token: TABLE
     * @param decimals The amount token decimals: 18
     */
    constructor(
        string memory name,
        string memory symbol,
