...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    /*** Restrict access to Egoras role*/    
      modifier onlyApproved() {        
       require(smartContractAddress[msg.sender] == true, "Address is not allowed to perform this task!");       
      _;}
    // Token name
   ...
   constructor(string memory name_, string memory symbol_, address _loanSmartContact){
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://images.egoras.com/";
    }
...
function burn(uint tokenID) external onlyApproved returns (bool){
	_burn(tokenID);
	return true;
 }
    /**
