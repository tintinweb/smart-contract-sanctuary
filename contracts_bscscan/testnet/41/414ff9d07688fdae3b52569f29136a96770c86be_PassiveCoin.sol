...
contract PassiveCoin is IBEP20, Ownable {
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 0.5% transfer limit
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(shouldTakeFee(sender)) { !determineTaxFee(recipient) ? amountReceived = takeBuyFee(sender, amount): amountReceived = takeSellFee(sender, amount); }
