...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xc7c980D5f3ED980E359CD045E49cC5f41E77bf6F;
...
contract FirstResponderToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xfDD093900334bf1a98dDd2014Fe476BaCf1e922F;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1500000  * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Human Charity Coin Protocol";
    string private _symbol = "HCCP";
