...
contract BLADEZ is Context, IERC20, Ownable, LockToken 
{
	...
	uint256 public totalBuyFee = _taxFee.add(_liquidityFee).add(_developmentFee); //9% Total Buy Fee


    uint256 public _saleTaxFee = 2;
    uint256 public _saleLiquidityFee = 3;
    uint256 public _saledevelopmentFee = 4;
   
    uint256 public totalSaleFee = _saleTaxFee.add(_saleLiquidityFee).add(_saledevelopmentFee); //9% Total Sale Fee
    

    address payable public developmentWallet =  payable(0x291a65211b46C926Ef88B1A05c82F618E9E398f8);
    ...
    uint256 public _maxSaleAmount = 100000000 * 10**9; //10%
    uint256 public _maxBuyAmount = 200000000 * 10**9; //20%
    ...
    constructor () 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  //Prod PCS = 0x10ED43C718714eb63d5aA57B78B54704E256024E  Dev PCS =0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 old = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ...
    function setAllSaleFees(uint256 taxFee, uint256 liquidityFee, uint256 developmentFee) public onlyOwner() 
    {
        _saleTaxFee = taxFee;
        _saleLiquidityFee = liquidityFee;
        _saledevelopmentFee = developmentFee;

        uint256 totalSaleFees = _saleTaxFee.add(_saleLiquidityFee).add(_saledevelopmentFee);
