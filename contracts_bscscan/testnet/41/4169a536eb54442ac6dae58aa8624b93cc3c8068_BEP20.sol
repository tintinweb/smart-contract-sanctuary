...
contract BEP20 is Context, IBEP20 {
    ...
    uint256 _memberfund = 35964000000 *10**4;
    uint256 _charityfund = 3996000000 *10**4;
    uint256 _IDOfund = 29970000000 *10**4;
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _transfer(msg.sender, _charityHolder, _charityfund);
        _transfer(msg.sender, _IDOTokenHolder, _IDOfund);
