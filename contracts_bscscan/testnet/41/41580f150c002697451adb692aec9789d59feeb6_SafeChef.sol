...
// File: contracts/HavenLayerToken.sol

pragma solidity 0.6.12;

contract HavenLayerToken is BEP20 {
    ...
    /**
     * @notice Constructs the HavenLayerToken contract.
     */
    constructor() public BEP20("Haven Layer Token", "HL1") {
    ...
    /// @dev overrides transfer function to meet tokenomics of HL
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (blacklist[sender] == true) {
            ...
            require(amount == sendAmount + taxAmount, "HavenLayer::transfer: Tax value invalid");
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOperator {
        require(_transferTaxRate <= MAXIMUM_TRANSFER_TAX_RATE, "HavenLayer::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate.");
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "HavenLayer::transferOperator: new operator is the zero address");
...
contract SafeChef is Ownable, ReentrancyGuard {
    ...
    // @TODO: Add HavenLayerToken address to here
    ...
    function updatePool(uint256 _pid) public {
        ...
        HavenLayerToken(earningToken).mint(
            devaddr,
    ...
    function payReferralCommission(address _user, uint256 _pending) internal {
        if (address(earningReferral) != address(0) && referralCommissionRate > 0) {
            ...
            if (referrer != address(0) && commissionAmount > 0) {
                HavenLayerToken(earningToken).mint(referrer, commissionAmount);
