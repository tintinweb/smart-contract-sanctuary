...
contract Quoter is IQuoter, IFuzzyswapSwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        return IFuzzyswapPool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
