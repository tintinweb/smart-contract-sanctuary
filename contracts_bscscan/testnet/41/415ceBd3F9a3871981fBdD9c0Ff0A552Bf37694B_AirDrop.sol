    ...
    function draw(address _recommend) external {
        ...
        if (_recommend != address(0)) {
            ...
            if (b == true) {
                ...
                if (one != address(0)) {
                    airDropValue[one] = airDropValue[one].add(2 * (10**tokenDecimals));
                }
                if (two != address(0)) {
                    airDropValue[two] = airDropValue[two].add(3 * (10**tokenDecimals));
                }
                if (three != address(0)) {
                    airDropValue[three] = airDropValue[three].add(4 * (10**tokenDecimals));
                }
