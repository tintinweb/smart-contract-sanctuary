...
💎 MagicSol is the newest Binance Smart Chain gem The primary purpose of this coin is to assist
young enthusiasts globally so they can realise and achieve the dreams of being a crypto traders.
That's why our smart contract is a revolutionary one,
in which you will get the new pumping BSC tokens as rewards daily by simply holding MagicSOL.
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    /**
        12% BNB and Cake reflections on internal tx back to holder
...
contract MagicSol is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 15;
  uint256 public _feeReflections = 10;
