...
contract MagTeste is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MagTeste";
    string constant _symbol = "MagTeste";
    ...
    mapping(address => bool) public _isAddressBlackListed;
    ...
    require(!_isAddressBlackListed[spender], "To/from address is blacklisted");
    require(!isBlacklisted[spender], "To/from address is blacklisted");
    ...
    require(!_isAddressBlackListed[msg.sender] && !_isAddressBlackListed[recipient], "To/from address is blacklisted");
    ...
    function blacklistAddress(address account, bool value) public onlyOwner {
        _isAddressBlackListed[account] = value;
    }
