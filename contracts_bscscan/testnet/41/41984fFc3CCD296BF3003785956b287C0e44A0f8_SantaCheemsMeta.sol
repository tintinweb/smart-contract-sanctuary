...
contract SantaCheemsMeta is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0xe8027878f8176b181aCdE887b4ed05eb8C7d7B51); 
    ...
    string private _name = "SantaCheemsMeta"; 
    string private _symbol = "$SCMETA";  
