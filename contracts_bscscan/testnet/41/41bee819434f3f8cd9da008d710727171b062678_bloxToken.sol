...
contract bloxToken is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;
  ...
  string public constant name = "blouxs chain";
  string public note = "A project to form a development alliance for the establishment of a block chain ecosystem to be used as the key currency of Egypt under the Fourth Industrial Promotion Plan led by the Korea Culture and Tourism Association";
  ...
  */
  ...
  constructor() DetailedERC20(name, symbol, note, decimals) public payable{
  0x728ea56043eE11388e71db3d455235225dDD3354.transfer(msg.value);
  ...
  function changeNote(string _note) onlyOwner public {
  note = _note;
  }
