...
contract DevolutionXBurningMoonNFTs is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    ...
    constructor() {
        ...
        NFTPrototypes.push(NFTData("Common Flokimon", "QmXLwBPvhmj8Y3MTYaJNB95doM8EGpsvuRAffGsuURuRni"));
        NFTPrototypes.push(NFTData("Common Veromon", "QmcGg1muKnKbuawxxFAXDK8YNWf8XUu9LbUYzwdcTsbkLV"));
        NFTPrototypes.push(NFTData("Common Metamon", "QmdHRSjdc9GgCn7tKbRRWFucXstAcx3HSn8MMbHRHod8VU"));
        NFTPrototypes.push(NFTData("Common Trustmon", "QmP98Pc1kYrv4KXs8a6YBK3QGb6D7HGVkdkjmNMaGgPFKf"));
        NFTPrototypes.push(NFTData("Rare Flokimon", "QmeQSNbAiCeZs6dbpHaUku8XUbX7Hw4u24GA3MA6GZneTb"));
        NFTPrototypes.push(NFTData("Rare Veromon", "QmR7bijvF1BBmQtZVXy8KW1U7ssdkwJ6x8FdV2CcQDYtu2"));
        NFTPrototypes.push(NFTData("Rare Metamon", "QmbVgiN517vUc4yfg3bo5LFpJbhv4DrMdPGVE9rL8RUdLc"));
        NFTPrototypes.push(NFTData("Rare Trustmon", "QmahJvMPfUzrJVA4Ekkt7s8raH2Jvkmvp6B3j2hv4yKU6r"));
