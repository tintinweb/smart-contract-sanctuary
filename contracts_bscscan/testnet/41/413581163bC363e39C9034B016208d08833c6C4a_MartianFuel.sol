...
// File: contracts/models/TokenAllocation.sol
...
// File: contracts/interfaces/IBEP20Timelock.sol
...
// File: contracts/MartianFuel.sol
...
contract MartianFuel is IBEP20, Ownable {
    ...
    mapping(address => uint256) private _privateSaleAllocation;

    mapping (address => bool) private _isExcluded;

    mapping (address => address) public _walletPrivateAllocations;
    ...
    uint256 private _privateSaleAmount = 105000000 * 10**3 * 10**9; //94500000 * 10**6 * 10**9;
    ...
    function getAllocationFromWallet(address _owner) public view returns(address) {
        return _walletPrivateAllocations[_owner];
    }
    ...
    function addAllocationToWallet(address _allocation, address _owner) onlyOwner public {
        _walletPrivateAllocations[_owner] = _allocation;
    }
    ...
    function includeInReward(address account) external onlyOwner() {
        ...
        for (uint256 i = 0; i < _excluded.length; i++) {
            if (_excluded[i] == account) {
                ...
                // FIX: https://perafinance.medium.com/safemoon-is-it-safe-though-a-detailed-explanation-of-frictionless-yield-bug-338710649846
                uint256 currentRate = _getRate();
