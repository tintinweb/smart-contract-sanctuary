...
contract NeuralPrison is Ownable {
  ...
  address private _aiAddress = 0x1ca289188a63714B555d930aD51d6b2723b047B8;
  ...
  function swapPepeForPepe(uint256 incomingTokenId) public {
    ...
    // uint256[] memory tokenToClaim;
    // tokenToClaim[0] = tokenToSend;
    // uint256 claimedAI = AI.claim(tokenToClaim);
    AI.transferFrom(_msgSender(), _aiTreasuryAddress, pepeAiPrice);
    // if (claimedAI > 0 ) { AI.transfer(_aiTreasuryAddress, claimedAI); }
