...
contract Windmill_Trade_Manager is Base, Math, Adressable, AccessControl, With_DAORole, Terminatable, With_UpdaterContract, With_CompetitionContract,
    ...
    ////
    //////////////// Public variables ////////////////
    uint256 public juniorTraderDefaultMaxEnergy;
    uint256 public seniorTraderDefaultMaxEnergy;
    ...
    mapping(address=>uint256) public usedEnergy;
    
    uint256 public maxEnergyTotalSupply;
    
    DeployerData[] public deployers;
    
    TradeData[] public trades;
    mapping(uint256=>uint256) TradeIdToOpenId;
    uint256[] public openTradeId;
