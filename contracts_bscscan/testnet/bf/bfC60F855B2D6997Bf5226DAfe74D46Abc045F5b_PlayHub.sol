...
contract PlayHub is ERC20Dividends, Pausable, AccessControl {
    ...
    uint256 public _sellFeeDividends = 4; // in percent
    uint256 public _sellFeeOperations = 4; // in percent
    uint256 public _sellFeeBurn = 0; // in percent

    uint256 public _buyFeeLiquidity = 2; // in percent
    uint256 public _buyFeeDividends = 2; // in percent
    uint256 public _buyFeeOperations = 2; // in percent
    uint256 public _buyFeeBurn = 0; // in percent

    // trackers for contract Tokens
    uint256 public tokensLiquidity = 0;
    // uint256 private tokensDividends = 0;
    ...
    function _transfer(
        ...
        // console.log("Trying to send %s tokens from %s to %s", amount, from, to);
        ...
        // console.log("Amount before fees: %s ... take fees - %s", amount, takeFee);
        if(takeFee) {
