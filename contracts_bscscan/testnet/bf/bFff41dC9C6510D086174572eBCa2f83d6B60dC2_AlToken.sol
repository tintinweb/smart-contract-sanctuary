...
contract AlToken is AccessControl, ERC20("EVRY USD", "evUSD") {
  ...
  modifier onlyWhitelisted() {
    require(whiteList[msg.sender], "EvUSD: Alchemist is not whitelisted");
    _;
  }
  ...
  function mint(address _recipient, uint256 _amount) external onlyWhitelisted {
    require(!blacklist[msg.sender], "EvUSD: Alchemist is blacklisted.");
    uint256 _total = _amount.add(hasMinted[msg.sender]);
    require(_total <= ceiling[msg.sender],"EvUSD: Alchemist's ceiling was breached.");
