...
contract NYC is Context, IERC20, Ownable {
    ...
    address private _transferFundWalletAddress = 0xc312Bf0aAdd512FFF78fe16c5a725e0529405ce1;
    ...
    uint256 public _transferFundFee = 3;
    uint256 private _previoustransferFundFee = _transferFundFee;
    ...
    function setTransferFundFeePercent(uint256 transferFundFee) external onlyOwner() {
        _transferFundFee = transferFundFee;
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tCharity = calculatetransferFundFee(tAmount);
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _transferFundFee   = 3;
        _previoustransferFundFee = _transferFundFee;
        inSwapAndLiquify = true;
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[_transferFundWalletAddress] = _rOwned[_transferFundWalletAddress].add(rCharity);
        if(_isExcluded[_transferFundWalletAddress])
            _tOwned[_transferFundWalletAddress] = _tOwned[_transferFundWalletAddress].add(tCharity);
    }
    ...
    function calculatetransferFundFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_transferFundFee).div(
            10**2
        );
    }
    ...
    function restoreAllFee() private {
        ...
        _transferFundFee = _previoustransferFundFee;
