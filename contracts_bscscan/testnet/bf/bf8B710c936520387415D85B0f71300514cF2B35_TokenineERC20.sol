...
contract MVPStake is ERC20("MVPS1 Stake", "ST-MVPS1") {
    ...
    uint256 public startDate = 1627923600;  // Tuesday, August 3, 2021 12:00:00 AM GMT+07:00
    uint256 public endDate = 1628787600;    // Friday, August 13, 2021 12:00:00 AM GMT+07:00
            
    uint256 private constant PRECISION = 1e18;

    constructor(IERC20 _mvp, TokenineERC20 _mvpp) public {
        mvp = _mvp;
        mvpp = _mvpp;
    }
...
contract TokenineERC20 is ERC20, AccessControl, Ownable {
    ...
    constructor(address _admin) public ERC20("SHOT Token", "SHOT") {
