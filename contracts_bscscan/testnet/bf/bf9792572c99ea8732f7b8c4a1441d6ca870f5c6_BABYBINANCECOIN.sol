...
contract BABYBINANCECOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x518DFB64e4DFEAA90FCdd14b70942F30F2E6833c); // Marketing Address
    ...
    string private _name = "Baby Binance";
