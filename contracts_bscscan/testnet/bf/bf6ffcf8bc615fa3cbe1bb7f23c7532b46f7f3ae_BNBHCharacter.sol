...
contract BNBHCharacter is Initializable, AccessControlUpgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable {
    ...
    function initialize () public initializer {
        ...
        randomTable = [4,5,9,6,20,8,10,0,5,2,14,3,13,3,1,12,12,9,10,9,14,5,7,10,9,8,16,7,7,3,11,14,8,2,2,1,8,13,3,0,2,4,17,1,6,7,15,2,19,10,8,13,6,18,8,11,5,5,11,15,14,13,3,2,0,4,1,4,2,4,7,1,10,0,4,11,0,7,8,9,9,17,5,15,17,6,12,0,16,10,3,6,12,0,16,6,1,4,9,6];

        baseChances = [700, 670, 630, 590, 550, 510, 400, 1000];
        baseBNBRewards = [30 * 10 ** 14, 36 * 10 ** 14, 42 * 10 ** 14, 48 * 10 ** 14, 54 * 10 ** 14, 60 * 10 ** 14, 24 * 10 ** 15, 500 * 10 ** 18];
        baseEnemyXps = [100, 110, 120, 130, 150, 200, 400, 400];
        requiredHps = [200, 200, 200, 200, 200, 200, 400, 200];

        baseTownTimes = [0, 24, 24, 48, 0, 24, 24, 48, 0, 24, 24, 48, 0, 24, 24, 24];
        baseTownRatio = [0, 3, 6, 16, 0, 5, 12, 27, 0, 30, 60, 90, 0, 30, 60, 140];
        maxHeroesCount = 10000;
    }
