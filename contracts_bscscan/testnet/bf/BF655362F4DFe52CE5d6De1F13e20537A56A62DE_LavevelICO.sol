...
contract LavevelICO is Ownable {
  ...
  uint256 public constant RATE = 15000; // Number of tokens per BNB
  uint256 public constant CAP = 6000; // Cap in BNB
  uint256 public constant START = 1637817999; // Nov 25, 2021 @ 05:26 GMT
  uint256 public constant DAYS = 15; // 15 Day
  
  uint256 public constant initialTokens = 100000 * 10**18; // Initial number of tokens available
