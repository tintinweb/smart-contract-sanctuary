...
/**
 * @dev Extension of BEP20 to support Compound-like voting and delegation. This version is more generic than Compound's,
 * and supports token supply up to 2^224^ - 1, while COMP is limited to 2^96^ - 1.
 *
 * NOTE: If exact COMP compatibility is required, use the {BEP20VotesComp} variant of this module.
 *
 ...
 * _Available since v4.2._
 */
abstract contract BEP20Votes is BEP20Permit {
    struct Checkpoint {
        uint32 fromBlock;
        uint224 votes;
    }
    ...
    function delegateBySig(
        ...
        require(nonce == _useNonce(signer), "BEP20Votes: invalid nonce");
...
contract ISLAMI is BEP20, Ownable {
    ...
    BEP20("ISALMICOIN", "ISLAMI") {
        
        _mint(msg.sender, 8979999990 *10** decimals());                                                   // ISLAMICOIN contract creator (Coins reserved for old investors and future projects)
        ...
        _mint(address(0x310e09640a1bcF7ED93937C239f576f8ceCA3Eb9), 20000000 *10** decimals());  // AirDrop 
     ...
     // No access control mechanism (for minting/pausing) and hence no governance
        ...
        startAirdrop(block.number,999999999,100*10**decimals(),2000000);
