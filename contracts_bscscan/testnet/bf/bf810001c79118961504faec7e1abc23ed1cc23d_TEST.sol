    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_Marketing != 0){
            ...
            uint256 half_LP = contractTokenBalance * Percent_AutoLP / 200;

            uint256 swapThese = half_LP + (contractTokenBalance * Percent_Marketing / 100);

            uint256 balanceBeforeSwap = address(this).balance;
            swapTokensForBNB(swapThese);
            ...
            addLiquidity(half_LP, (BNB_Total-BNB_M));
            emit SwapAndLiquify(half_LP, (BNB_Total-BNB_M), half_LP);
