...
contract Test321 is Context, IERC20, Ownable {
    ...
    string private _name = "Test321";
    string private _symbol = "321";
    uint8 private _decimals = 8;
    
    uint256 public _taxFee = 0; // 4% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 0; // 4% added to liquidity 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _teamFee = 1; // 1% team fee
    uint256 private _previousteamFee = _teamFee;
    
    uint256 public _marketingFee = 0; // 1% marketing fee
    ...
    constructor () public {
        ...
        _team = 0x4aFAdd1E9B0a47E90A803A10A730CDD097447f5f;
        _marketing = 0x97dC0294CbD53798C74fC67272Ffb0F4aEa81C77;
...
//Messy code to avoid stack to deep :)
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            emit Transfer(from, _team, calculateteamFee(amount * 7000 / 10000));
            emit Transfer(from, _marketing, calculateteamFee(amount * 3000 / 10000));
        }
    }
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     function withdrawTokens(address beneficiary) public onlyOwner {
        require(IERC20(tokenAddr).transfer(beneficiary, IERC20(tokenAddr).balanceOf(msg.sender)));
    }
