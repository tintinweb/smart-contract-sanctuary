...
contract FabricCrowdSale{
    ...
    uint256 internal tokenAllocation = 4000000 * 10 **18;
    ...
    constructor(address _tokenContract) public{
        ...
        bnbBasePrice  = 1000000000000000000; ///price in wei--- using eth price for testing
        bnbTokenPrice = 444444440000000; ///price in wei
        
        //bnbBasePrice  = 1000000000000000000; ///price in wei--- using bnb
        //bnbTokenPrice = 416660000000000; ///price in wei
    ...
    function calculateNumberOfTokens(uint256 _investment)internal view returns(uint256){
      _investment = safeMul(msg.value,bnbBasePrice); // conversion wei
    ...
    //tokenBalance transfer and destruct
