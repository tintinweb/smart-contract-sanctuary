...
contract SHIBOSHNI is Context, IERC20, Ownable {
    ...
    string private _name = "ShibOSHNI";
    string private _symbol = "SHIBOSHNI";
    ...
    uint256 public _maxTxAmount = 14 * 10**10 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 10**10 * 10**9;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 1000, "Swap Threshold Amount cannot be less than 1000");
