...
contract AXLToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor () {
        ...
        require(_totalSupply == _presaleAmount + _stakingAmount + _cexReseveredAmount + _teamAmount + _incentiveAmount + _dexAmount + _airdropAmount, "Amount total  is not same with other all distributions");
    ...
    {
        require(_deadlineTeamTimeStamp <= block.timestamp, "Token for team is locked for 3 years.");
