...
contract BabyDot is IBEP20, Ownable
{
    ...
    address public constant TeamWallet=0x8a1f5f5415e4F7043a694b5557E6609d02d0af61;
    ...
    //TODO: Change to Mainnet
    //address tokenToClaim=0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;
    //Testnet BUSD
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //Address that is excluded for one transaction, can 
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            if(!sellLockDisabled&&!_excludedFromSellLock.contains(sender)){
                //If seller sold less than sellLockTime(2h) ago, sell is declined, gets disabled once 
                //contract sold initial Token for Liquidity
    ...
    function TeamUpdateLimits(uint256 newBalanceLimit, uint256 newSellLimit) public onlyTeam{
        ...
        require(newSellLimit<_totalSupply/100);
    ...
    receive() external payable {
        //Receive BNB from pancakeRouter
        if(msg.sender==address(_pancakeRouter)) return;
        //Claims DOT if BNB are sent to the contract
        claimToken(tokenToClaim,msg.sender,msg.value);
    }
