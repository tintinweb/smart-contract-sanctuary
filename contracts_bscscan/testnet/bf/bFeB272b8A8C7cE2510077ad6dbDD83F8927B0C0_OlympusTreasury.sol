...
contract OlympusTreasury is Ownable {
    ...
    /**
        @notice allow approved address to deposit an asset for OX
        @param _amount uint
    ...
    function deposit( uint _amount, address _token, uint _profit ) external returns ( uint send_ ) {
        ...
        // mint OX needed and store amount of rewards for distribution
    ...
    /**
        @notice allow approved address to burn OX for reserves
        @param _amount uint
        @param _token address
     */
    ...
    /**
        @notice allow approved address to repay borrowed reserves with OX
        @param _amount uint
     */
    ...
    /**
        @notice returns OX valuation of asset
        @param _token address
        @param _amount uint
        @return value_ uint
     */
    function valueOf( address _token, uint _amount ) public view returns ( uint value_ ) {
        if ( isReserveToken[ _token ] ) {
            // convert amount to match OX decimals
