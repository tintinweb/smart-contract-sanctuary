...
contract ERC20Token is ERC20Upgradeable, OwnableUpgradeable {
  ...
  function setPresenter(address _presenter) public onlyOwner {
    ITokenPresenter(presenter).setRouter(router);
...
contract MLVToken is ERC20Token {
  /**
   * @dev Upgradable initializer
   */
  function __MLVToken_init(
    string memory name_,
    string memory symbol_,
    uint8 decimals_,
    uint256 initialSupply_,
    ...
    __ERC20Token_init(name_, symbol_, decimals_, initialSupply_, router_);
  }
}
