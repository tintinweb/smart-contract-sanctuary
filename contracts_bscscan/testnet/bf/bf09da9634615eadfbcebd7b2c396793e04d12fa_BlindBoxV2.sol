...
contract BlindBoxV2 {
 ...
 function init1() public {
  ...
  function addAgent(string memory agentId, address _agentAddress, string memory artistId, uint256 _percentage, uint256 _companyPercentage, uint256 _artistPercentage, uint256 index) adminAdd public {
