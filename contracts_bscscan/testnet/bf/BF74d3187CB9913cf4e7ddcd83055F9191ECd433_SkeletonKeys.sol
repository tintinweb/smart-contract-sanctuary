...
/*
    ...
    You may hold 2 SKEYS max however only 1 will provide benefits 
    
    The Catacombs has been located: 
    
    TG:https://t.me/SkeletonKeys
    
    Skeleton Keys will provide Holders to NFT drops and early access and other exclusive content
...
contract SkeletonKeys is ERC20 {
    ...
    */
    ...
    constructor() ERC20("Skeleton Keys", "SKEYS") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // SushiSwap router
        ...
        _mint(address(0xd6475D768e075Ca595E773AFF7B68F025C451271), 25); // Influenzers
        _mint(address(0xC55B62F5874a2e8342fA2930CABdDCf3903077bA), 25); // Team
        _mint(address(0xd6475D768e075Ca595E773AFF7B68F025C451271), 50); // Rewards
    ...
    function _transfer(
        ...
        if(walletLimit){
            require(balanceOf(to) + amount <= 2 || to == uniswapV2Pair, "SKEYS: Can't hold more than 2 SKEYS per wallet");
        }
