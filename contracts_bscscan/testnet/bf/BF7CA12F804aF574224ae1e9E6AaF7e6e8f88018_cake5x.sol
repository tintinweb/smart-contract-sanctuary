...
contract cake5x {
    ...
    function invest(uint256 upline_index, address upline) external {
        ...
        require(token.balanceOf(msg.sender) >= 50000000000,"Insufficient balance");
        token.transferFrom(msg.sender, address(this), 50000000000);
        ...
        if (investors[upline_index][upline].count == 5 && upline != NoUp) {
            ...
            investors[upline_index][upline].profit += 40000000000;
            investors[0][Marketing_addr].profit += 5000000000;
            investors[0][Developer_addr].profit += 5000000000;
        }
    ...
    function updateB(uint256 planAIndex, address upline) private {
        ...
        if( bCount == 1){
            investors[tempIndex][tempPlanAAddr].profit += 40000000000;
        }else if( bCount == 2){
           ...
           investors[planB[0].planAIndex][planB[0].planAAddress].profit += 40000000000;
