...
interface ITokenConverter {
     ...
     */ 
    function isPairExistsSym(string memory _token0Symbol, string memory _token1Symbol) external view returns (bool _existing);
     ...
     */ 
    function getReservesSym(string memory _token0Symbol, string memory _token1Symbol) external view returns (uint112 _token0Reserve, uint112 _token1Reserve);
     ...
     * @return _token1Reserve second token reserve
     */ 
    function getReserves(address _token0Address, address _token1Address) external view returns (uint112 _token0Reserve, uint112 _token1Reserve);
     ...
     */ 
    function convertSym(uint256 _amountInTokenFrom, string memory _tokenFromSymbol, string memory _tokenToSymbol) external view returns (uint256 _amountInTokenTo); 
...
contract TokenConverter is ITokenConverter {
    ...
    override {
        ...
        require(!isPairExistsSym(_token0Symbol, _token1Symbol), '[TokenConverter]: Cant add already existed pair');
    ...
    function isPairExistsSym(string memory _token0Symbol, string memory _token1Symbol)
    public 
    view
    override
    ...
    returns (bool _existing) {
        ...
        return isPairExistsSym(_token0Symbol, _token1Symbol);
    }
    ...
    function getReservesSym(string memory _token0Symbol, string memory _token1Symbol)
    public
    view
    override
    ...
    function getReserves(address _tokenFromAddress, address _tokenToAddress)
    public
    view
    override
    returns (uint112 _token0Reserve, uint112 _token1Reserve) {
        require(_tokenFromAddress != address(0) && _tokenToAddress != address(0), '[TokenConverter]: Cant convert pair from or to address 0x0');
        string memory _tokenFromSymbol = IERC20(_tokenFromAddress).symbol();
        string memory _tokenToSymbol = IERC20(_tokenToAddress).symbol();
        return getReservesSym(_tokenFromSymbol, _tokenToSymbol);
    }


    function convertSym(uint256 _amountInTokenFrom, string memory _tokenFromSymbol, string memory _tokenToSymbol)
    public
    view 
    override
    returns (uint256 _amountInTokenTo) {
        require(isPairExistsSym(_tokenFromSymbol, _tokenToSymbol), '[TokenConverter]: Cant convert this pair');
        (uint112 _tokenFromReserve, uint112 _tokenToReserve) = getReservesSym(_tokenFromSymbol, _tokenToSymbol);
    ...
    returns (uint256 _amountInTokenTo) {
        ...
        string memory _tokenFromSymbol = IERC20(_tokenFromAddress).symbol();
        string memory _tokenToSymbol = IERC20(_tokenToAddress).symbol();
        return convertSym(_amountInTokenFrom, _tokenFromSymbol, _tokenToSymbol);
    }
