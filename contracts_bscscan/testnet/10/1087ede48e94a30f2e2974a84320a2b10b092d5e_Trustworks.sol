...
pragma solidity 0.7.6;
 ...
 // Telegram: https://t.me/Trustworks 
 // Website: https://trustworks.global/
...
contract Trustworks is Context, IBEP20, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    using Address for address payable;
 
    IPCS private constant pancake =  IPCS(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
    IpancakeV2Factory private constant pancakeFactory = IpancakeV2Factory(0xBCfCcbde45cE874adCB698cC183deBcF17952812);
    ...
    uint256 private _totalSupply;
     ...
     string private constant _name = "Trustworks";
    ...
    address payable constant deflect = 0x5ABBd94bb0561938130d83FdA22E672110e12528;
    address public pool;
 
    uint256 public immutable liquidityUnlock;
 
 
    uint256 public ethSent;
    uint256 constant tokensPerBNB = 500;
   ...
   modifier onlyOwner() {
    ...
    receive() external payable {
     ...
     function buyTokens() public payable nonReentrant  {
        ...
        require(ethSent < 750 ether, "Hard cap reached");
        require (msg.value.add(ethSent) <= 750 ether, "Hardcap will be exceeded");
        require(ethSpent[msg.sender].add(msg.value) <= 25 ether, "You cannot buy more");
    ...
    function claimDevFeeAndAddLiquidity() external onlyOwner {
       ...
       multisig.sendValue(forMultisig);
       deflect.sendValue(forDeflect);
    ...
    function moonMissionStart() internal {
        ...
        this.approve(address(pancake), tokensForpancake);
        ...
        if (tokensToBurn > 0) {
        _balances[address(this)] = _balances[address(this)].sub(tokensToBurn, "bep20: burn amount exceeds balance");
    ...
    function recoverbep20(IBEP20 tokenAddress, uint256 tokenAmount) public onlyOwner  {
        require(block.timestamp >= liquidityUnlock, "Can't withdraw yet");
        tokenAddress.safeTransfer(_owner, tokenAmount);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!transferPaused || sender == _owner || sender == address(this) || sender == multisig, "We didn't launch yet");
