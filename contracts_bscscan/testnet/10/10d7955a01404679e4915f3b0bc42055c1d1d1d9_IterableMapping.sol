...
/**
    ...
    */
    ...
    contract ADACatto is ERC20, Ownable {
        ...
        uint256 public minSellTransactionAmount = 1 * 10**18;
        ...
        constructor() ERC20("ADACatto", "ADAC") {
          ...
          marketingWallet = address(0x2B12cbc94da60F0d1E65B1bcaF34D1F058bf0aBa);
          liquidityWallet = address(0x3525BfD3Ee87D04D9d9dc4d39C45bfbf9add6cFC);
          //Testnet BUSD
        ...
        function tradeStart() external onlyOwner {
            ...
            minSellTransactionAmount = 1 * 10**18;
    ...
    contract FIRSTDividendTracker is DividendPayingToken {
        ...
        constructor() DividendPayingToken("ADACatto_Dividend_Tracker", "ADACatto_Dividend_Tracker", 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7) {
          claimWait = 3600;
