...
interface ISummitReferral {
    function swap(address account, address input, address output, uint256 amountInput, uint256 amountOutput) external returns (bool);
}
...
contract SummitswapRouter02 is ISummitswapRouter02, Ownable {
    ...
    address public override summitReferral;
...
library SummitswapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'fe604490e88884eee0a2ef7362417e3771d067dc74cd2e605d0b3e1e90f300cb' // init code hash
            ))));
    }
