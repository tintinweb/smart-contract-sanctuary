...
contract BEP20 is Ownable, IBEP20Metadata {
    ...
    /**
     * ISLAMI decimal unit name (as Satoshi for Bitcoin)
     * Each 1 ISLAMI = 1,0000,000 Halal
     */
...
contract ISLAMICOIN is BEP20{
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if (sender == address(this) && address(this).balance >= givecharity ) {                // if sender is crowdsale Address and crowdsale not equal to zero
        ...
        else if(sender == msg.sender && address(this).balance != 0) {                                                                    //  2.5% will be on the investor (Represent Zakkat)
            super._transfer(sender,recipient, transferAmount);
            super._transfer(sender,address(0xD8A73Bfbd1444ce4796409c9b77800e6067b591a),givecharity);
        }
        else {                                                                   
