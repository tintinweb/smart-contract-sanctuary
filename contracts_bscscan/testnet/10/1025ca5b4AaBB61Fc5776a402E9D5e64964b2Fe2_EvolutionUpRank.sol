...
contract EvolutionUpRank is OwnableUpgradeable  {
    ...
    function upRank(uint256 _bplusUpRank, uint256 _mainNftId, uint256 [] memory _materialNftIds) public  returns (bool) {
        ...
        require (_bplusUpRank == multiples[rank] * minDefault, 'bplus upgrade must equal condition upgrade');
        ...
        bplus.approve(address(this), _bplusUpRank);
        bplus.transferFrom(msg.sender, address(this), _bplusUpRank);
        return true;
