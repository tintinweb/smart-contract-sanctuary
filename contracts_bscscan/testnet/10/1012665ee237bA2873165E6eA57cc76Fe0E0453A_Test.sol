...
contract Test is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x1B5359eeF0a546cC3F99d2eF492F197fccFD34dC);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);

    string private _name    = "Testing Coin, Do Not Buy";
    string private _symbol  = "TestDX";
