...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            TOKENPAIR = 0x62067799fc824694BE7CFb76F0c0668B67D33721;
        _token = msg.sender;
    }
...
contract TaxReturnTycoon is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x6B0A5b8E1B05Eac3D7f2cb06a8498fBA8262D51f;
    address GiveawayWallet  = 0x4a0C101EF47002E800BB6b77D9ac75304dE95C6e;

    string constant _name = "Tax Return Tycoon";
    string constant _symbol = "TAXRT";
    ...
    uint256 public totalFee = marketingFee + reflectionFee + liquidityFee + giveawayFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        giveawayFeeReceiver = GiveawayWallet;
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(giveawayFeeReceiver).call{value: amountBNBGiveaway, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _giveawayFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        giveawayFee = _giveawayFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_giveawayFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator);
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _giveawayFeeReceiver) external authorized {
