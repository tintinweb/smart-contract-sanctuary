...
/* Token contract */
contract MarketCapWars is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4C8A48d26BA79023FD26DD7c3102444b75A15a94;
    ...
    // Name and symbol
    string private _name = "t.me/marketcapwars";
    string private _symbol = "TurdSandwich";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 1.0% on launch
    ...
    // Sell fees
    uint256 liquidityFeeSell = 3000;
    uint256 buybackFeeSell = 0;
    uint256 reflectionFeeSell = 3000;
    uint256 marketingFeeSell = 1000;
    uint256 devFeeSell = 500;
    uint256 totalFeeSell = 7500;
    ...
    uint256 public earlybuyBlocks = 20;  // for $NWA holders to buy early
    ...
    constructor () Auth(msg.sender) {
        ...
        NWA = IBEP20(0xEE3C05A4aFB583708AE4C912DEd03588262Ac792);  // NWA contract
    ...
    function _hasDiscount(address sender) internal view returns (bool) {
        return NWA.balanceOf(sender) >= NWA.totalSupply() * holdingThreshold / 10000;
    }
