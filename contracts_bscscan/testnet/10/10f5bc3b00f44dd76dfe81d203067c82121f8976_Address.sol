...
/**
 *Submitted for test verification at BscScan.com on 2021-12-13
*/
...
contract ElixirTestFut is Context, IERC20, Ownable {
    ...
    //uint256 private _tTotal = 8 * 10**9 * 10**18;
	uint256 private _tTotal = 1000000000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ElixirTestFut";
    string private _symbol = "ETF";
    ...
    uint256 public _burnFee = 210345;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 burnAmt = amount.mul(_burnFee).div(10000000);
