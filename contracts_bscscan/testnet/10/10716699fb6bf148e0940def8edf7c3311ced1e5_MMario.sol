...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x80f20ABFDf03dcf0f53110ba7aA186784d0692C2;
...
contract MMario is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD29e648Ad6FAC7e63a7E5233efB78Cd8Bb662f2c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Mario";
    string private _symbol = "MMario";
