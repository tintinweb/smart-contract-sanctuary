...
import "./CustomStakingReward.sol";
import "./interfaces/IStakingRewards.sol";
...
contract StakingRewardFactory{
    ...
    function createStakingReward(address _stakingToken, address _rewardsToken, address owner) external returns (address) {
        CustomStakingReward staking = new CustomStakingReward();
    ...
    function createProxyStakingReward(address _stakingToken, address _rewardsToken, address owner, address proxyAdmin) external returns (address) {
