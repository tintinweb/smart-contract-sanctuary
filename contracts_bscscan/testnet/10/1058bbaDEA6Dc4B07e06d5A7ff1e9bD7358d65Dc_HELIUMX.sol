...
contract HELIUMX is ERC20, Ownable{
    ...
    uint256 public maxBuyLimit = 500_000 * 10**18;
    uint256 public maxSellLimit = 500_000 * 10**18;
    ...
    address public buybackWallet = 0x38d299932074B6640df3172bd81Ad12dCF3185CC;
    address public lotteryWallet = 0xfb248a737ed1B8CB7A0D1654AB413f598ebe70dc;
    address public charityWallet = 0x1A8E09365EEc68bcebDE9EFb31839c060176f714;
    ...
    Taxes public taxes = Taxes(5, 3, 1, 1, 4, 1);
    Taxes public sellTaxes = Taxes(5, 3, 1, 1, 4, 1);
