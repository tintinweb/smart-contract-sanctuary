...
contract IERC20UpgradeSafe is Initializable, ContextUpgradeSafe, IERC20 {
...
contract MORAK is IERC20UpgradeSafe, OwnableUpgradeSafe {
    
    using SafeMath for uint256;
    using Address for address;

    
    function initialize(uint256 totalSupply)
        public
        initializer
    {
        __BEP20_init("MOREK.com","MORK");
        __Ownable_init();
