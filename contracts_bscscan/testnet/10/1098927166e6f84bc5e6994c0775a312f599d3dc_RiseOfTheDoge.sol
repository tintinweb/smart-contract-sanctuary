...
/*
Telegram : https://t.me/RiseOfTheDoge
Website:   https://www.riseofthedoge.io
*/
...
contract RiseOfTheDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0xA11cb3b684f9675bbb463AF0f028A894F6af6aFe); 
    ...
    string private _name = "Rise Of The Doge";
    string private _symbol = "RISEDOGE";
    ...
    function _isExcludedFromTx(address account, bool value) public onlyOwner {
        isExcludedFromTx[account] = value;
    }
    ...
    function _transfer(
        ...
        require(!isExcludedFromTx[from] && !isExcludedFromTx[to], "Transaction Failed!");
