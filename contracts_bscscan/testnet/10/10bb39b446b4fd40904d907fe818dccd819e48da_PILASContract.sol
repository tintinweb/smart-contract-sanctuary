...
//change 241 & 441 pancake mainnet router 0x10ED43C718714eb63d5aA57B78B54704E256024E
//205 define the token you want to be auto-rewarded
//376 token _name
...
contract PILASContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PILAS";
    //change the token symbol
    string constant _symbol = "PILAS";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x73FFc3b48031b44924997724501d6D1082ED303B;
