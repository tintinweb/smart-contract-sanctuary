...
// Presenting all new AR NFT Marketplace to all major chains. MartianDoge
// JOIN TG: https://t.me/MartianDoge
...
contract MartianDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbEc556EC78be1b10Fa83404F92925057CB26b645); // Marketing Address
    ...
    string private _name = "MartianDoge";
    string private _symbol = "MartianDoge";
    ...
    address private LP_Reciever = 0x000000000000000000000000000000000000dEaD;
    ...
    uint256 public _maxTxAmount = 20000000 * 10**3 * 10**18;
    uint256 private minimumTokensBeforeSwap = 200000 * 10**3 * 10**18; 
    uint256 public buyBackSellLimit = 1000000000 * 10**18;

    // LookBack into historical sale data
    SellHistories[] public _sellHistories;
    bool public _isAutoBuyBack = true;
    uint256 public _buyBackDivisor = 15;
    ...
    function checkBuyBack() public onlyOwner {
        if (buyBackEnabled) {
    ...
    function _AiSupportBuyBack(uint256 amount) public onlyOwner{
    	if (amount > 0) {
    	    swapETHForTokens(amount);
	    }
    }
    ...
    function changeLPAddress(address _address) public onlyOwner {
        LP_Reciever = _address;
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _maxTxAmount = 1000000000 * 10**3 * 10**18;
    }
    
    function afterPreSale() external onlyOwner {
        setSwapAndLiquifyEnabled(true);
        _maxTxAmount = 20000000 * 10**3 * 10**18;
    }
