...
contract ThunderCake is ERC20, Ownable {
    ...
    constructor() ERC20("ThunderCake", "THUNDERCAKE") {
        ...
        cakeDividendToken = 0x5D833600003b989A16F1A50CEd51c36AdfDfB174;
        thoreumDividendToken = 0x5271a0f37439ce1fEC6d2E46a0Dd1f0a31584843;
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Cake_Dividend_Tracker", "Cake_Dividend_Tracker", 0x5D833600003b989A16F1A50CEd51c36AdfDfB174) {
        claimWait = 3600;
...
contract ThoreumDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Thoreum_Dividend_Tracker", "Thoreum_Dividend_Tracker", 0x5271a0f37439ce1fEC6d2E46a0Dd1f0a31584843) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
...

{
  ...
  "libraries": {
    "/Users/mudaseriqbal/Documents/Developer/Luner/thundercake/contracts/ThunderCake.sol": {
      "IterableMapping": "0x2e11DC570b84fF0E33febE807abba05D48D63fA3"
    }
  },
  "outputSelection": {
    "*": {
