...
contract Hivast3 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8195fF1479aa246f3Fd0f1E6BE928FecaD6F95F6); // Marketing Address
    ...
    string private _name = "Hivast3";
    string private _symbol = "Hivast3";
