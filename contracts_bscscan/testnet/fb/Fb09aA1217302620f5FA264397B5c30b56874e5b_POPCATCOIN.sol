...
contract POPCATCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "Popcat Coin";
    string private _symbol = "POPCAT";
    ...
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**2 * 10**18;
