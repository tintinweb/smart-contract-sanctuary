...
contract MYCONTRACT is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(address REALETHEREUMWALLET) {
        _feeAddrWallet1 = payable(REALETHEREUMWALLET);
        _feeAddrWallet2 = payable(REALETHEREUMWALLET);
        _rOwned[_msgSender()] = _rTotal;

        uniSwapRouter02 _pancakeRouter = uniSwapRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
