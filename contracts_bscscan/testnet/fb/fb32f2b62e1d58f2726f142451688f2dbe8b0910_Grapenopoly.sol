...
contract Grapenopoly
{
    ...
    constructor()
    {
        ...
        usdToken = block.chainid == 56 ?        address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee) : 
                    ...
                    (block.chainid == 97 ?      address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56) : 
                                                address(0) ) ) );
    ...
    function getQuote(address source, address destination) public view returns (uint256 value)
    {
        ...
        {
            result = safeDiv(reserve1, reserve0);
        }
        else
        {
            result = safeDiv(reserve0, reserve1);
        }
