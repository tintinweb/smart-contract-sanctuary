...
contract TestingFork is Context, IERC20, Ownable {
    ...
    string private _name = "TestingFork";      //CHANGE_REQUIRED: name of token
    string private _symbol = "TESTINGFORK";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
