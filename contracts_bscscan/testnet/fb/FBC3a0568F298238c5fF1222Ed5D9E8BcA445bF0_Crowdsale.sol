...
contract Crowdsale is Ownable {
        ...
        returns (bool) 
    {
        ...
        require(IBEP20(tokenContract).allowance(msg.sender, address(this)) <= _quantity * IBEP20(tokenContract).decimals(), "not enough allowance");
        require(IBEP20(tokenContract).transferFrom(msg.sender, address(this), _quantity * IBEP20(tokenContract).decimals()));
        ...
        c.price = _price;
        emit NewSale(salesIndex, c.startDate, c.endDate, c.quantity, c.price);
        return true;
    }
