...
contract IDO {
	...
	address public tokenPairAddress; //for LP tokens
    ...
    function RefundBNB(uint256 tokens) public returns(bool) {
        ...
        totalSold = totalSold.add(tokens);
        TOKEN.transferFrom(sender, address(this), tokens);
		
		payable(sender).transfer(amountBNBtoRefund);
