...
contract CodibnbTransferManager is Ownable, Whitelist {
...
contract Codibnb is StandardToken, Ownable {
  event Airdrop(address indexed _to, uint256 _amount);

  string public constant name = 'CODIBNB';
  string public constant symbol = 'CODIBNB';
  uint8 public constant decimals = 18;

  CodibnbTransferManager public transferManagerContract;
  ...
  function setTransferManagerContract(CodibnbTransferManager _transferManagerContract) onlyOwner public {
