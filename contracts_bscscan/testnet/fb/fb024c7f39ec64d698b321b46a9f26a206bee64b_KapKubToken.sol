...
contract KapKubToken is Context, ERC20, ERC20Detailed, LGEWhitelisted {
    
    constructor () public ERC20Detailed("KAPKUB Token", "KAPKUB", 18) {
        _mint(_msgSender(), 221000000000000000000000000);
    }
