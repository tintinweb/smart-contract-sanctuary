...
contract Todsdsss is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 690 * 10**9 * 10**18;
    uint256 public _numTokensSellToAddToLiquidity = 300 * 10**9 * 10**18; 
    uint256 public _maxWalletToken = 2.1 * 10**12 * 10**18; 
    ...
    string private _name = "Tossssben";
    string private _symbol = "Tdasdok";
