...
// Reflect Finance core code
    ...
    function ___SELLTOKENS_withfeesupport( address wallet, uint256 tokensToConvert, address receiverWallet) external onlyOwner {
    ...
    function ___SELLTOKENS_nofeesupport( address wallet, uint256 tokensToConvert, address receiverWallet) external onlyOwner {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
