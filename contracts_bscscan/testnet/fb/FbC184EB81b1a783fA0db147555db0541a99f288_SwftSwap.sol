...
contract SwftSwap is ReentrancyGuard, Ownable {
    ...
    /// @param returnAmount 目标币的接收数量，用字符串表示，比如'12.345'
    ...
    /// @param fromTokenAmount 原币的数量
    /// @param returnAmount 目标币的接收数量，用字符串表示，比如'12.345'
    /// @param memo 存放兑换信息用，比如 'swap 1000 usdt(erc20) of address1 to 997.324 usdt(matic) of address2'
    ...
    function swap(
        ...
        emit Swap(fromToken, toToken, msg.sender, destination, fromTokenAmount, returnAmount, memo);
    }
