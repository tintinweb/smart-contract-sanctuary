...
contract BEP20 is Ownable, IBEP20 {
    ...
    // timestamp when burn will complete
    ...
    function finishBurn() external onlyOwner{
        _beforeTokenTransfer(_owner, address(0), _pendingBurn);
        _balances[_owner] = _balances[_owner]  - _pendingBurn;
        _totalSupply -= _pendingBurn;
        uint256 _amountBurned = _pendingBurn;
        _pendingBurn = 0;
        emit Transfer(_owner, address(0), _amountBurned);
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _pendingBurn=_pendingBurn+amount;
    }
