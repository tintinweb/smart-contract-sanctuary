...
contract AirDrop is Ownable {
    ...
    function draw(address _recommend) external {
        require(IERC20(token).balanceOf(address(this)) > airDropValue, "Issued");
        require(addWhiteList(msg.sender, _recommend) == true, "drawed");
        IERC20(token).transfer(msg.sender, airDropValue);
    }
