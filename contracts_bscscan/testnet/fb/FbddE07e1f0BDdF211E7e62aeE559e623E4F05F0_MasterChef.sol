...
contract MasterChef is Ownable, SignerRecover, Initializable {
    ...
    function setNFTStakingPointHook(address _nftStakingPointHook) external onlyOwner {
        nftStakingPointHook = INFTStakingPoint(_nftStakingPointHook);
    }
    ...
    function depositNFT(
        ...
        for(uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            uint256 stakingPoint = nftStakingPointHook.getStakingPoint(_tokenId, address(nft));
