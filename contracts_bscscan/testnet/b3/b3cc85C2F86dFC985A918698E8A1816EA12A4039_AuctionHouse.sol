...
contract AuctionHouse is IERC721Receiver, Ownable {
    ...
    function getNft(address _address) view public returns (uint256 [] memory)  {
    ...
    modifier onlyAuctioneer(uint256 _auctionId) {
        require(msg.sender == auction[_auctionId].auctioneer, "Only auctioneer can perform this action");
        _;
    }
