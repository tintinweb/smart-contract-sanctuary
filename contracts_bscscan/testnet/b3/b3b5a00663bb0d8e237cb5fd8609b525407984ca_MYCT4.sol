...
contract MYCT4 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MYCT4";
    string private _symbol = "MYCT4";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5998Ce570370087CD4fFeAc005d6fC1Fb02B8E31); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1138f14674a9e0D374461a8071ADc0D4Dd4f3a5e); // Treasury / Buyback
    ...
    uint256 public _buyBuyBackFee = 7;
    ...
    uint256 private _totalSupply = 1000 * 10**6 * 10**9; // 1 Billion
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1000 * 10**6 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
