...
contract DividendDistributor is IDividendDistributor {
    ...
    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; ABB
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            //: IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); ABB
...
contract ForeverBNB is IBEP20, Auth {
    ...
    string constant _name = "FeeeerBNB";
    string constant _symbol = "FBXB";
    ...
    constructor () Auth(msg.sender) {
        //router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); ABB
        ...
        //marketingFeeReceiver = 0xBeAD6601f765653D41bdC65D1A9427Db6cb95425; ABB
        //devFeeReceiver = 0x1715062166526a7Be3D6B0A79fbF77D5eF695FcE; ABB
        marketingFeeReceiver = 0xe0F1B20d7d831E0f0421964fF79Ef00550160723;
        devFeeReceiver = 0xe0F1B20d7d831E0f0421964fF79Ef00550160723;
