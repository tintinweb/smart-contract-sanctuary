...
// File: contracts/TESTBOI

/**
 *                
 *                TestBoi9001
 *       Dividend Token that rewards Boys only
 *      Fees on Buy: 20% / Fees on Sell: 20%
 *  15% BUSD Rewards 37% Liquidity 350% Marketing
 *                          
 * 
...
contract Testboyv3 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TestBabys";
    ...
    uint256 _totalSupply = 1 * 50000**2 * (10 ** _decimals);
    ...
    uint256 public rewardsFeeBuy = 10;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x002a384ca3e3b24c788B7140CDE855ca7a873Fa2;  // marketingwallet
