...
contract DopeToken is IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; //0.4% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 2) / 100; //1% of total supply
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            // payable(address(lottery)).call{value: amountBNBMarketing, gas: 30000}("");
            // lottery.sendWinner();
...
//     function draw() external override onlyToken{{
