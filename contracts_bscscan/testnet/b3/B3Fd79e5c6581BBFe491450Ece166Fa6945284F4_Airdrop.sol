...
contract Airdrop is AccessControl {
    ...
    uint256 public vestingPeriod = 15724800; // 182 days
    uint256 public lockPeriod = 1800 ; // 30m ,7776000; // 90 days
    uint256 public lockAmount = 7500000000000000000000000; // 7,500,000 DEB
