...
contract HBT is Context, IBEP20, IBEP20Metadata, Pausable, Ownable{
    ...
    uint256 public maxSwapLimitForCharity = 5 * 10 ** 18;
    ...
    function _transfer(
        ...
        bool takeFee = false;
         ...
         if(charityBalance > maxSwapLimitForCharity){
            uint256 tempCharityBalance = 0;
            if(enableFee){
                enableFee = false;
                taxDisableInLiquidity = true;
            }
            tempCharityBalance = charityBalance;
            charityBalance = 0;
       ...
       if(marketingBalance > maxSwapLimitForMarketing){
            uint256 tempMarketingBalance = 0;
            if(enableFee){
                enableFee = false;
                taxDisableInLiquidity = true;
            }
            tempMarketingBalance = marketingBalance;
            marketingBalance = 0;
