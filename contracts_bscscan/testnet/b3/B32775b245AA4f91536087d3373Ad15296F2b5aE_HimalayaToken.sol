...
contract HimalayaToken is BEP20 {
     ...
     */
    constructor() public BEP20("Montagne", "MTN") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        taxFreeList[recipient] == true ||
            ...
            require(amount == sendAmount + taxAmount, "HIML::transfer: Tax value invalid");

            // default 5% sent to burn address
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOperator {
        require(_transferTaxRate <= MAXIMUM_TRANSFER_TAX_RATE, "HIML::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate.");
