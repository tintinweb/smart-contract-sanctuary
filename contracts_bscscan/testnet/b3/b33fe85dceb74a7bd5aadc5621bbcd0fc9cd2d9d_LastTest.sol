...
contract LastTest is IBEP20, Ownable
{
    ...
    mapping (address => bool) private _NodiamondBalls;
    ...
    string private constant _symbol = 'LTEST';
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 10000000 * 10**_decimals;//equals 101
    ...
    uint8 private constant _whiteListBonus=100;
    ...
    uint8 public constant MaxTax=18;
    ...
    //address public constant TeamWallet=0x77b79692063e59d2f94fc2240dC14CEc3D0a3C7f;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            //As soon someone sells, diamondBalls are gone
            _NodiamondBalls[sender]=true;
            tax=_sellTax;
    ...
    function TeamSetdiamondBalls(uint8 fee, bool feeOn) public onlyTeam{
        require(fee<=50,"diamond balls Fee is capped to 50%");
        nodiamondBallsFeeOn=feeOn;
        nodiamondBallsFeePercent=fee;
    }
    uint8 public nodiamondBallsFeePercent=50;
    bool public nodiamondBallsFeeOn=true;
    ...
    function claimToken(address addr, address token, uint256 payableAmount) private{
        ...
        //If you don't have diamond balls you are redistributing a part of your reward
        //Compound wont be punished
        if(nodiamondBallsFeeOn&&_NodiamondBalls[addr]&&token!=address(this)){
            uint256 nodiamondBallsFee=amount*nodiamondBallsFeePercent/100;
            amount=amount-nodiamondBallsFee;
            _distributeStake(nodiamondBallsFee,false);
        }
    ...
    function hasdiamondBalls(address AddressToCheck) public view returns(bool){
        return !_NodiamondBalls[AddressToCheck];
    }
    ...
    function getDividentsOf(address addr) public view returns (uint256){
        ...
        if(nodiamondBallsFeeOn&&_NodiamondBalls[addr])
            amount-=amount*nodiamondBallsFeePercent/100;
        return amount;
    }
    ...
    //Sets Taxes, is limited by MaxTax(18%) to make it impossible to create honeypot
