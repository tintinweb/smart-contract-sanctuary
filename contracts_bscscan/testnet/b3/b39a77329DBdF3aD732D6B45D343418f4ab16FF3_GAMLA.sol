...
/*    4% fee
 	...
 	100% of total supply is divided into 6 Wallets as defined below:
 
	Development Wallet: 160,000,000 GART Tokens
	charity Wallet: 50,000,000 GART Tokens
	marketing: 150,000,000 GART Tokens
	Bounty Wallet: 5,000,000,000 GART Tokens
	Governance Wallet: 50,000,000 GART Tokens
	Presale: 110,000,000 GART Tokens
	Airdrop & Reward: 80,000,000 GART Tokens
...
contract GAMLA is Context, IERC20, Ownable {
    ...
    address public _DevelopmentWallet = 0xA9A1ea64ed715ab2222Fe24ec5253C55C6552fa3;
    address public _charityWallet = 0x933896e52E517D6b8EAB7Ae2A4bd4c544Ef268FE;
    address public _marketingWallet = 0xF9BB81B89Fb71393c8cF687b4Ba3DC542A5e695D;
    address public _bountyWallet = 0xE43FdCd152D6e16Ad0Bffc3c82ADA354f52eE2DA;
    address public _GovernanceWallet = 0xB832aCd00096B831165EAe76616Fe23420e50191;
    address public _founderWallet = 0x5bB1897C9C2cfDD4593595a0219c532440dacc5B;
    ...
    string private _name = "GAMLA";
    string private _symbol = "GAMLA";
    ...
    constructor () {
        ...
        _DevelopmentWallet = msg.sender;
        _charityWallet = msg.sender;
        _marketingWallet = msg.sender;
        _bountyWallet = msg.sender;
        _GovernanceWallet = msg.sender;
        _founderWallet = msg.sender;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the BNB -> GART swap when swap+liquify is triggered
  ...
  // Check out 0f0crypto's solidity support channel for all your troubleshooting needs https://discord.gg/k3rewGKYmD
   ...
   function calculateRfiFee(uint256 amount) internal view returns (uint256){ 
    ...
    function setbountyWallet(address _address, address account) public onlyOwner() {
        _bountyWallet = _address;
        excludeFromFee(account);
        excludeFromReward(account);
    }
 
    function setGovernanceWallet(address _address, address account) public onlyOwner() {
        _GovernanceWallet = _address;
        excludeFromFee(account);
    }
