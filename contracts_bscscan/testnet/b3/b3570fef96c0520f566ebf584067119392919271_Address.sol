...
contract TrungDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0x15cFa59EbE8f83B8cC014eFF1B40C121ebfe3544); 
    ...
    string private _name = "Trung Doge";
