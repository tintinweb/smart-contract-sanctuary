...
contract natern is Context,IBEP20,Ownable {
    ...
    string private constant _name = "natern";
    string private constant _symbol = "ntrn";
    ...
    function burnTokensFromBurnWallet(uint256 amount) external  {
        require(_msgSender() == _burnWallet,"natern: Only burn wallet can burn the tokens ");
        uint256 currentRate = _getRate();
