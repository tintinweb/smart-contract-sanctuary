...
contract BM is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TBM6';
    string private constant _symbol = 'TBM6';
    ...
    function _regularTransfer(address sender, address recipient, uint256 amount) private{
        ...
        //if sender and recipient are the same address initiate claim
            if(sender==recipient){
