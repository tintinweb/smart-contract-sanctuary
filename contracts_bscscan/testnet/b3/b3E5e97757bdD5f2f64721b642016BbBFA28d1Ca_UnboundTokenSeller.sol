...
interface IIndexPool {
  ...
  function getUniswapV2oracle() external view returns (address);
...
/* ==========  Constructor  ========== */
    ...
    _control_
  {
    ...
    _oracle = IBisharesUniswapV2Oracle(_pool.getUniswapV2oracle());
    _uniswapV2router = IUniswapV2Router02(_pool.getUniswapRouter());
  }
