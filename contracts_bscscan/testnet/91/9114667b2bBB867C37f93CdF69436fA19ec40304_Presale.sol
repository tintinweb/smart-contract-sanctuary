...
contract Presale is Ownable {
    ...
    uint256 private immutable _devFee = 10;
    uint256 private immutable _marketingFee = 10;
    ...
    /**
     * Throws if called by any account that does not have permission to set kycVerified data.
     */
    modifier onlyKycVerifiedAdmins() {
        require(
            owner() == msg.sender || kycVerifier == msg.sender,
            "EFutureCoinPresale: caller is not a kyc verified data admin."
        );
        _;
    }
        ...
        view
    {
        ...
        require(
            isKycVerified[beneficiary],
            "EFutureCoinPresale: account not KYC verified"
        );
        require(
    ...
    function approveKycVerifier(address newKycVerifier) public onlyOwner {
        kycVerifier = newKycVerifier;
    }

    function setKycVerified(address userAddr, bool verified)
        public
        onlyKycVerifiedAdmins
    {
        isKycVerified[userAddr] = verified;
    }
