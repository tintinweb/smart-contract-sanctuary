...
contract HoneyPad is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount;  // 10000000000000000000000
    uint256 public maxHoldingAmount;  // 10000000000000000000000
    uint256 public swapTokensAtAmount = 10000 * (10**decimals());  // 200000000000000000000

    uint256 public buyback = 5;  // 4
    uint256 public marketingFee = 5;  // 7
    uint256 public dividendFee = 5;  // 4

    uint256 public sellBuybackFee = 7;  // 6
    uint256 public sellMarketingFee = 6;  // 8
    uint256 public sellDividendFee = 7;  // 6
    ...
    uint256 public gasForProcessing = 300000;  // 500000 

    /********* TX LIMITS *********/

    mapping (address => uint256) public accountLastPeriodSellVolume;
    uint256 public restrictionPeriod = 24 hours;  // 14400 
    struct Sell {
        uint256 time;
        uint256 amount;
    }
    ...
    bool public tradingEnabled = true;  // true
    bool public swappingEnabled = true;  // true
    ...
    constructor() ERC20("HONEYPAD", "$HONEY") {
        ...
        updatePancakeRouter(0x09f36613e8eacA92A893E533b6DfbC21A2e4a3c3);  // treeSwap bsctestnet
