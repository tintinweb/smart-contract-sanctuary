...
contract Company is SuperAdmin {
    ...
    // create company
    function addCompany(string memory companyId, string memory dataCompany) public {
    ...
    function addEmployeeToCompany(string memory companyId, string memory userMappingId, string memory role) public {
    ...
    function addAdminToCompany(string memory companyId, string memory userMappingId, string memory role) public {
        companyUsers.push(CompanyUser(
            companyId,
            userMappingId,
            role,
