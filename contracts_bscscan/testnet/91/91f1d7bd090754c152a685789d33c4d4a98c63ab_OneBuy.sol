...
contract OneBuy {
    ...
    mapping(address => uint256[3]) private buynum;
    ...
    function getConfig(address addr) public view returns (address[3] memory, uint256[11] memory) {
        ...
        uint256[11] memory numbs = [
            ...
            buynum[addr][0], buynum[addr][1], buynum[addr][2],
