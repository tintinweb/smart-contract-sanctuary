...
contract UnsealMe is Context, Ownable, ReentrancyGuard {
    ...
    event UnsealCalled(uint newUnsealTimeEnd, address newLatestUnsealer, uint256 newPayableAmount);
    ...
    function unseal() public nonReentrant payable {
        uint256 payableAmount = ((address(this).balance) * _entryPricePercentage) / 10**2;
        ...
        emit UnsealCalled(_unsealTimeEnd, _latestUnsealer, ((address(this).balance) * _entryPricePercentage) / 10**2);
    }
