...
contract ContractNft  {
    ...
    //    require(ownerOf(tokenId) == offer.seller, "Not seller");
     ...
     _exchange.call(abi.encodeWithSignature("transferFrom(address from, address to, uint256 tokenId)", 0xaD9383d3E2859770A6C705081e7D25a46c49fAF9, 0x261d814b51Ab6e52a8ea29bD016f0D0f84986d47,tokenId));
