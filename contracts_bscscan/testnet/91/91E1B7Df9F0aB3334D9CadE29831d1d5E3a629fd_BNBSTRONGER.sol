...
contract BNBSTRONGER {
    ...
    uint256[] public COMMON_PERCENTS = [0,0,0,0,0,0,200,180,165,152,140];
    uint256[] public RANDOM_PERCENTS = [0,0,0,0,0,0,180,160,145,132,120];
	...
	constructor(address payable wallet, address payable _developer, address payable _marketing) public {
        ...
        for(uint8 tarifDuration = 6; tarifDuration <= 10; tarifDuration++) {
