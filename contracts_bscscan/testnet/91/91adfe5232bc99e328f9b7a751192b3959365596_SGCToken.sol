...
contract SGCToken is Ownable, IBEP20 
{
    ...
    //address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Ruta para pruebas en testnet con pancakeswap ! ya no funciona!!
    ...
    uint maxima_compra = 1 * 10 ** 15 * (10**9); // Especificamos el maximo de compra para evitar ballenas
    uint maxima_venta = 5 * 10 ** 12 * (10**9);  // Especificamos un maximo de venta tambien para evitar balleneas
    ...
    function setMaxSellAmount(uint256 amount) public virtual onlyCEOandSign()
    {
    ...
    function setMaxBuyAmount(uint256 amount) public virtual onlyCEOandSign()
    {
