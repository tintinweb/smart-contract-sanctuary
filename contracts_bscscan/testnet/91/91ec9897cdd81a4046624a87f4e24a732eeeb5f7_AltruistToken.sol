...
// File: contracts/AltruistToken.sol
...
contract AltruistToken is Context, IBEP20, Ownable {
    ...
    address payable public _marketingWalletAddress = payable(0xdC9c869C8474352f4756eD2891B3E031Fb233754);
    address payable public _charityWalletAddress = payable(0x60f1F0412B509Bd52f91C895ACF58628c4D9e1C8);
    ...
    string private _name = "Altruist Token";
    ...
    constructor () public {
        ...
        address pancakeRouter_ = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        ...
        removeAllFee();
        _transferBothExcluded(_msgSender(), _initialCharityWallet, charityAmount);
        _transferBothExcluded(_msgSender(), _initialMarketingWallet, marketingAmount);
        _transferBothExcluded(_msgSender(), _teamWallet, teamAmount);
        _transferBothExcluded(_msgSender(), _devWallet, devAmount);
        restoreAllFee();
    }
    ...
    function swapCharityMarketingTokensForEth(address payable walletAddress, uint256 tokenAmount) private {
        uint256 initialBalance = address(this).balance;
        swapTokensForEth(tokenAmount);
        uint256 transferredBalance = address(this).balance.sub(initialBalance);
        
        transferToAddressEth(walletAddress, transferredBalance);
    }
