...
// CHANGE
contract NAME_TEST is IERC20, Ownable {                                                                             //!\ CHANGE THE NAME OF THE CONTRACT (example put the name of the token)
    using SafeMath for uint256;
    ...
    string constant _name = "TEST NAME";
    string constant _symbol = "TESTSYMBOL";
