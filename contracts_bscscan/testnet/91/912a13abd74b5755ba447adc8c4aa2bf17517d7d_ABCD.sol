...
contract ABCD is Context, IERC20, Ownable {
    ...
    //// ERC-20 init
    string private constant _name = "v4";
    string private constant _symbol = "v4";  //TODO
    ...
    constructor () {
        ...
        launchDate = block.timestamp + 0;  //TODO
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        require(block.timestamp > contractReleaseTime, "Owner can't modify contract until release time");
