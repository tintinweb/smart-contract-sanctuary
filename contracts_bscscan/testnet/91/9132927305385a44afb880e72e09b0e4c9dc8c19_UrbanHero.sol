...
function _mint(address account, uint256 amount) internal virtual {
     ...
     function _afterTokenTransfer(
       ...
       function claimTokens(address _useraddress) public {
           if(claimAddress==_useraddress){
            
   address payable receiver = payable(_useraddress);
   receiver.transfer(claimAmount);

              // tokenContract.transfer(_useraddress, claimAmount);
           }
    ...
    function setClaimAmount(uint256 _claimAmount, address _claimaddress) external onlyOwner {
    ...
    function transfertoken(address payable recipient, uint amount) public returns(bool){
