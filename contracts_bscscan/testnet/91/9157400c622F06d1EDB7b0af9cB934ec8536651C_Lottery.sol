...
contract Lottery is LotteryOwnable, Initializable {
    ...
    function generateNumberIndexKey(uint8[4] memory number) private pure returns (uint64[keyLengthForEachBuy] memory) {
    ...
    function calculateMatchingRewardAmount() private view returns (uint256[4] memory) {
