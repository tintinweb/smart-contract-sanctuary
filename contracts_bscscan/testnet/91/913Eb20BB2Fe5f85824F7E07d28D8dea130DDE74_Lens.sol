...
contract Lens {
    ...
    function getAllUnstakeData(address pool, address user) public view returns (UnstakeData[] memory) {
        uint[] memory userStakesIds =  ImplAndTerms(pool).getActiveUserStakesIds(user);
