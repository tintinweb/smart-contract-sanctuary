...
contract STUPIDHEAD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1111111111115eb4E67473bbE0A33e7febD7AA8F); // Marketing Address
    ...
    string private _name = "STUPID";
    string private _symbol = "STUPID";
