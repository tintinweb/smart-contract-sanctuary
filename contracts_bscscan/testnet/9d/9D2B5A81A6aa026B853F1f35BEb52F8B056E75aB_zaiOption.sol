...
contract zaiOption is Ownable, Pausable, ReentrancyGuard {
    ...
    address public Maintenance = 0x41d771508338FE1cc1aA89E90b11374FA12E0B50; // TODO
 ...
 // Set the token contract address
    ...
    function claimTreasury() external nonReentrant onlyAdmin {
        ...
        if(commissionBBAmt > 0){
            IERC20(zaif).safeTransfer(Maintenance,commissionBBAmt);
            commissionBBAmt = 0;
        }
        ...
        IERC20(zaif).safeTransfer(buybackAddress, buybackAmt);
