...
contract Stealth is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x30A45e73d3E9b7C74d54B564585a8Be23Fa6A044); // Marketing Address
    ...
    address public charityWallet = 0xa2983441b65eE6Dc760fB4F20D8C45b52a44959a;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require (taxFee <= 7, "Up to 7%");
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require (liquidityFee <= 2, "Up to 2%");
        _liquidityFee = liquidityFee;
    }

    function setCharityFeePercent(uint256 charityFee) external onlyOwner() {
        require (charityFee <= 3, "Up to 3%");
