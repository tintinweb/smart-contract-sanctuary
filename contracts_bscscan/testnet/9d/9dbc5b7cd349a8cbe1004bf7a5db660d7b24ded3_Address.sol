...
contract DexBerry is Context, IERC20, Ownable {
    ...
    string private _name = "DexBerry";
    string private _symbol = "DEXBY";
    ...
    address  public charityWallet = 0x41A0ABaEA6af29aE3824C683bF62875a1aE4CF2E;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 fundingAmt = amount.mul(_charityFee).div(100);
        ...
        _transferStandard(sender, charityWallet, fundingAmt);
