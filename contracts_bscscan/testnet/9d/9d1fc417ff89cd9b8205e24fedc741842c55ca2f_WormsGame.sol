...
contract WormsGame is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 3333;
    uint public  minCashBackCount = 51;
    uint public  freeStop = 300;
    uint public  basePrice = 8*10**16; // 0.08 ETH
    uint public  BackGasPrice = 0; //0 gwei
    ...
    constructor(string memory baseURI) ERC721("WormsGame", "WORMS")  {
        setBaseURI(baseURI);
    }
