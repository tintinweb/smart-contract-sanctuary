...
contract ZombieERC20 is Ownable, ERC20 {
    ...
    uint256 public fightZombies;
    uint256 public warZones;
    uint256 public training;

    uint256 public amountPlayToEarn;
    uint256 public playToEarnReward;
    
    uint256 internal amountFarm;
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 maxSupply) ERC20(name, symbol, decimals) {
        ...
        fightZombies = _maxSupply.mul(11).div(10**2);
        warZones = _maxSupply.mul(11).div(10**2);
        training = _maxSupply.mul(11).div(10**2);
        
        amountPlayToEarn = fightZombies + warZones + training;
        
        amountFarm = _maxSupply.mul(12).div(10**2);
    }
