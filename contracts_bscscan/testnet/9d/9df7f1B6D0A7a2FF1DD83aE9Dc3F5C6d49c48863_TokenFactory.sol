...
contract ProjectToken is Ownable, BEP20, Pausable, BEP20Burnable {

    constructor(string memory name, string memory symbol, uint256 initialSupply, address owner) BEP20(name, symbol) {
