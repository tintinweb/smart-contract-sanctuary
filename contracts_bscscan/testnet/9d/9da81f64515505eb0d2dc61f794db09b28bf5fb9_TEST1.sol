...
contract TEST1 is Context, IERC20, Ownable, Pausable 
{
    ...
    uint256 public _founderFee = 8;
    uint256 private _previousfounderFee = _founderFee;
    
    
    uint256 public developerDivisor = 3;
    uint256 public marketingDivisor = 2;
    uint256 public charityDivisor = 2;
    uint256 public walletsTotal = developerDivisor.add(marketingDivisor).add(charityDivisor);
    ...
    address payable public charityWallet =    payable(0xc85bFE12db63992F2c0Bd32654c1A406766A1888);
    ...
    uint256 public maxLimit = _maxTxAmount = _tTotal.div(100).mul(2); //2%;
    ...
    function restoreAllFee() private {
        ...
        _founderFee = _founderFee;
    }


    function setAllFees(uint256 taxFee, uint256 liquidityFee, uint256 burnFee, uint256 founderFee) external onlyOwner() 
    {
        _taxFee = taxFee;
        ...
        _previousfounderFee = founderFee;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        developerWallet.transfer(newBalance.div(walletsTotal).mul(developerDivisor));
        marketingWallet.transfer(newBalance.div(walletsTotal).mul(marketingDivisor));
        charityWallet.transfer(newBalance.div(walletsTotal).mul(charityDivisor));
    }
    ...
    function setAllWallets(address developer, address marketing, address charity) external onlyOwner() 
    {
        developerWallet = payable(developer);
    ...
    function  setWalletsDivisors(uint256 developer, uint256 marketing, uint256 charity) public onlyOwner 
    {
        developerDivisor = developer;
        marketingDivisor = marketing;
        charityDivisor = charity;
        walletsTotal = developerDivisor.add(marketingDivisor).add(charityDivisor);
    }    
