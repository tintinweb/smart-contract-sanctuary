...
contract BNBGAINS {
    ...
    uint256 public constant BASE_PERCENT = 200; // 2% per day
    uint256[] public REFERRAL_PERCENTS = [800, 200, 150, 100, 50];
    uint256 public constant MARKETING_FEE = 400;
    uint256 public constant PROJECT_FEE = 600;
    uint256 public constant PERCENTS_DIVIDER = 10000;
    uint256 public constant MAX_USERS_BONUS = 200; //2%
