...
contract DirectSwap is Ownable  {
    ...
    function approveSender(address _sender) public onlyOwner {
        if(approvedSenders[_sender]) return;
    ...
    modifier onlyApprovedUser() {
        require(approvedSenders[msg.sender] == true, "Ownable: caller is not the owner");
        _;
    }
