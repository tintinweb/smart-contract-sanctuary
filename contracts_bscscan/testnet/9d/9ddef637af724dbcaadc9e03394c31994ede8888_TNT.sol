...
contract TNT is ERC20, Ownable{
    ...
    constructor() ERC20("TNTToken3", "TNT3") {
    ...
    uint256 public _burnFee = 5;//用户销毁手续费
    ...
    uint256 public _adminFee = 12;//用户销毁手续A
    ...
    function mining() public onlyOwner {
        ...
        //当日挖矿BDK数量   
        uint256 tokenNum = totalTokenInPool.mul(_mineRate()).div(10000);
    ...
    function userDrawReturnFee() public {
        ...
        // require(lastState[msg.sender] == 2,"Not added to the liquidity pool");
