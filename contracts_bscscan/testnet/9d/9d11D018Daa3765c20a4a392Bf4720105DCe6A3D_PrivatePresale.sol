...
contract PrivatePresale {
    ...
    uint256 public _previousCollected = 0;
    ...
    function privateRound() public payable {
        ...
        uint256 _newCollected = busd.balanceOf(address(this));
        uint256 _txCollected = _newCollected - _previousCollected;
        _previousCollected = _newCollected;
