...
contract PUPPYDOGEX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "PuppyDogeX";
    ...
    uint256 public _buybackPercent = 65;
    ...
    address payable constant private _marketingAddress = payable(0xE0718f32bdc9C980B307B3892DA39635176B04f2);
    address payable constant private _buybackAddress = payable(0xEfd9Ef23b4923b2cb95f98655eC17B07c812fF89);
    ...
    address public _oraclePriceFeed = 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE; //bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router)) {//buys
                ...
                if(previousClose == 0) { // At launch set previousClose to 70% of starting price
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amount) external onlyOwner() {
        require(airdropWallets.length == amount.length, "Pancake: airdropToWallets:: Arrays must be the same length");
        require(airdropWallets.length < 40, "Pancake: airdropToWallets:: Cannot airdrop more than 40 wallets due to gas limit restrictions");
