...
contract FireZard is Storage, Context, IERC20, Ownable, Initializable {
    ...
    uint256 private buyBackAmountLimit = 30 * 10**18;
    ...
    function initialize () public initializer {
        //rewardAddress = payable(0xf2C1107D223E01A8707CbeDb29fBa8D5A389FB3F); // Reward Address
        buyBackEnabled = true;
        _taxFee = 2;
        _liquidityFee = 9;
        rewardDivisor = 4;
        _maxTxAmount = 3000000 * 10**6 * 10**9;
        minimumTokensBeforeSwap = 200000 * 10**6 * 10**9; 
