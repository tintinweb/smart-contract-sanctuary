...
// CHANGE
contract ElrondReward  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Elrond Reward";
    string constant _symbol = "ELOREW";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x9f66baf39cbfDab1A1f4b60a5A51b9db90e109F5);
