...
contract test is ERC20, Ownable {
    ...
    address marketingWallet = 0x3C5D9E56A90E36d20cb685d29Cf61255D738CDa9;
    address devWallet = 0x47b1Bd5434CB5c50c0CD782C8AcA565aC99B6DF3;
    ...
    /// @notice Withdraw tokens sent by mistake. Impossible to withdraw test tokens
    /// @param tokenAddress The address of the token to withdraw
    function rescueBEP20Tokens(address tokenAddress) external onlyOwner {
        require(
            tokenAddress != address(this),
            "Impossible to withdraw test tokens"
        );
...
contract testDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        public
        DividendPayingToken(
            "test_Dividen_Tracker",
            "test_Dividend_Tracker"
        )
    {
        claimWait = 3600;
    }
