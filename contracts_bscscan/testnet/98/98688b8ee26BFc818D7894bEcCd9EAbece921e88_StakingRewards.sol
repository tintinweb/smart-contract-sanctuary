...
contract StakingRewards is ReentrancyGuard, Pausable {
    ...
    mapping(address => uint256) private _primeLPBalances;
    ...
    function primeLPBalanceOf(address account) external view returns (uint256) {
        return _primeLPBalances[account];
    }
