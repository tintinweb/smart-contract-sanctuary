...
contract RocketFi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 40000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "RocketFi";
    string private _symbol = "RKF";
    uint8 private _decimals = 18;
    
    uint256 public _buyBack = 3;
    uint256 private _previousTaxFee = _buyBack;
    ...
    address public marketingWallet = 0x3ae23ceB211F0450cd32C30A1905444d13092b82;
    ...
    function removeAllFee() private {
        if(_buyBack == 0 && _liquidityFee == 0 && _marketingFee==0 && _burnFee==0) return;
        
        _previousTaxFee = _buyBack;
