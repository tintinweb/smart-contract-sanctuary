...
contract AKPv4 is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "AKPv4";
    string private _symbol = "AKPv4";
    ...
    function setLiquidityPercent(uint256 PercentageOfLiquidity) public view onlyOwner() {
        PercentageOfLiquidity = _PercentageOfLiquidity;
    }
    ...
    uint256 private _PercentageOfLiquidity = 20;
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        // reward 
        if (reward >= 0) {
             uint256 charityPiece = reward.div(100);
             uint256 claimableReward = reward.sub(charityPiece);
             uint256 swapbusd = claimableReward.div(2);
            ...
            reward = claimableReward.sub(swapbusd);
        }
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        !(from == address(this) && to == address(pancakePair)) // swap 1 time
            ...
            // ghost here
           // uint256 balanceToBread = deltaBalance.mul(_PercentageOfLiquidity).div(10**2);
            //uint256 tokensExtra = otherPiece.mul(_PercentageOfLiquidity).div(10**2);
            
            //initialBalance = initialBalance.sub(balanceToBread);
...

{
  ...
  "libraries": {
    "contracts/TAR.sol": {
      "Utils": "0x45955de354f1e724c191f620dba8c1f486321a72"
    }
  }
}