...
contract foxgirl is Context, IERC20, Ownable { 
    ...
    */
    ...
    function remove_Random_Tokens(address random_Token_Address, address _to) public onlyOwner returns(bool _sent){
        require(random_Token_Address != address(this), "Can not remove native token");
        uint256 randomBalance = IERC20(random_Token_Address).balanceOf(address(this));
        _sent = IERC20(random_Token_Address).transfer(_to, randomBalance);
    }
