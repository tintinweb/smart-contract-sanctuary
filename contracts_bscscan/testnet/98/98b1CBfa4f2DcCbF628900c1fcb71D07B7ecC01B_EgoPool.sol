...
contract EgoPool is BasePool {
    ...
    function _stakeAsset(uint256 assetStakeAmount, StakerInfo memory stakerInfo, CelebrityInfo memory celebrityInfo) internal virtual override{
        ...
        uint256 vBalance = assetStakeAmount;
        ...
        celebrityInfo.assetBalanceInfo.vBalance += vBalance;
    }
    ...
    function _unstakeAsset(StakerInfo memory stakerInfo, CelebrityInfo memory celebrityInfo, uint256 assetStakeAmount) internal virtual override {
        require(_assetToken.transfer(msg.sender, assetStakeAmount));
    ...
    function celebrityClaim(address celebrity) external {
        ...
        if (egoClaim.claimAmount > 0) {
            if(celebrityInfo.egoBalanceInfo.vBalance > egoClaim.vClaimAmount)
                celebrityInfo.egoBalanceInfo.vBalance -= egoClaim.vClaimAmount;
            else {
