...
contract La2 is Context, ReentrancyGuard {
    ...
    mapping(string => Deposit) deposits;
    ...
    function setHolderDepositAmount(uint256 amount, string memory _tokenSymbol)
        internal
    {
        Deposit storage deposit = deposits[_tokenSymbol];
        deposit.tokenAmount = deposit.tokenAmount + amount;
    }

    function getHolderDepositAmount(string calldata _tokenSymbol)
        external
        view
        returns (uint256)
    {
        Deposit storage deposit = deposits[_tokenSymbol];
        return deposit.tokenAmount;
    }
    ...
    function addNewToken(
        ...
        tokensAvailable.push(_tokenAddress);
    }
        ...
        nonReentrant
    {
        ...
        setHolderDepositAmount(_depositAmount, _tokenSymbol);
    ...
    function withdraw(
        ...
        emit Withdraw(_withdrawto, _withdrawAmount);
    }

    function tokenBalance(string calldata _tokenSymbol)
        external
        view
        returns (uint256)
    {
