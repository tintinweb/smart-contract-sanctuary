...
// Project Name: HeroShiba

// Symbol: heSHIBA

// Tax Fee: 3%
// Distributed to the holders: 3%
// Auto Burn : 1% burn (forever gone) 
// Marketing wallet fee: 1%
// Project website https://heroshiba.finance
...
contract Test4U_4_0 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 1e15 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Test4U_4_0";
    string private _symbol = "T4U_4";
    ...
    address public marketingWallet = address(owner());
    ...
    uint256 public _maxTxAmount = _tTotal * 5 / 10000;
