...
contract MyTokenPreSale is Ownable, ReentrancyGuard {
    ...
    // was 40 move to 1
    uint256 public tokenPerUsd = 20;
    // was min 50 move to 1
    uint256 constant MIN_STAKE_BNB =  20 * 1e18;
    uint256 constant MAX_STAKE_BUSD = 500 * 1e18;

    uint256 remainTOKENQuota = 11650485 * 1e18;
    ...
    event LogBuyWithBUSD(
        ...
        uint256 updatedRemainTOKENQuota,
        uint256 datetime
    );
    ...
    function buyWithBUSD(uint256 amount) external nonReentrant {
        ...
        require(
            amount >= MIN_STAKE_BNB && amount <= MAX_STAKE_BUSD,
        ...
        onlyOwner
    {
        ...
        uint256 tokenAmount = uint256(3).mul(buyerAmount[buyerAddress]).div(100);
    ...
    function balanceRemainTOKENQuota() external view returns (uint256) {
        return remainTOKENQuota;
    }
