...
contract GameReward is Ownable, Events {
    ...
    address public contractAddress = address(0x0);
    ...
    function lock(address _from, uint256 amount) public returns(bool){
        ...
        IERC20(qdropToken).approve(lockAddress, amount);
        IERC20(qdropToken).approve(contractAddress, amount);
        IERC20(qdropToken).approve(_from, amount);
