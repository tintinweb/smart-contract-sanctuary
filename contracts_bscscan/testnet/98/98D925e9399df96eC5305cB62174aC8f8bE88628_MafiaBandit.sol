...
contract MafiaBandit is ERC721Enumerable, Ownable {  
    using Address for address;
    ...
    uint256 public reserved = 25;

    // Price of each token
    uint256 public initial_price = 0.25 ether;
    uint256 public price;

    // Maximum limit of tokens that can ever exist
    uint256 public constant MAX_SUPPLY = 1000;
    uint256 public constant MAX_PRESALE_SUPPLY = 1000;
    uint256 public constant MAX_MINT_PER_TX = 200;

    // The base link that leads to the image / video of the token
    string public baseTokenURI = "https://api.funkycrocs.io/";

    constructor () ERC721 ("Mafia Bandit", "BAN") {
        price = initial_price;
    }
