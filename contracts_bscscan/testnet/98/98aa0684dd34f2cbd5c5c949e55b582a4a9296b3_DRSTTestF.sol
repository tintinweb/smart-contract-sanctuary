...
contract DRSTTestF is ERC20, Ownable, Charitable, Marketable {
    ...
    constructor() public ERC20("DRSTTestF", "DRSTTestF") {
    ...
    function sendToCharityWallet(uint256 tokens) private {
        ...
        path[0] = charityWallet;
        path[1] = uniswapV2Router.WETH();

        _approve(charityWallet, address(uniswapV2Router), tokens);
    ...
    function sendToMarketingWallet(uint256 tokens) private {
        ...
        _approve(marketingWallet, address(uniswapV2Router), tokens);
