...
pragma solidity ^0.8.0;
contract DeathRoad is ERC20, Ownable {
    ...
    constructor() ERC20("Death Road", "DRACE") {
        _mint(msg.sender, 850000000*10**decimals());
        _mint(address(this), 150000000*10**decimals());
        startSale(block.number, 999999999, 0,83000*10**decimals(), 2000000000000);
