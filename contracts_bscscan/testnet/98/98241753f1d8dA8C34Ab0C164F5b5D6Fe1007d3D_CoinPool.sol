...
// Let's CoinPool!
contract CoinPool is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 5000000000 * 10**6 * 10**9;
    uint256 private _dTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CoinPool";
    string private _symbol = "CPOOL";
    ...
    address public _pancakeRouterAddr = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
