...
contract sAnnex is IsANN, ERC20Permit {
    ...
    /**
        ...
        @return uint256
     */
    function rebase(uint256 profit_, uint256 epoch_) public override  returns (uint256) {
        uint256 rebaseAmount;
        uint256 circulatingSupply_ = 0;
        // if (profit_ == 0) {
...
rebaseAmount = 1 ;
        ...
        // _gonsPerFragment = TOTAL_GONS.div(_totalSupply);cls
