...
//===============================================================================================================
    ...
    function excludePresaleAddresses(address router, address presale) external onlyOwner {
        ...
        _liquidityHolders[router] = false;
        _liquidityHolders[presale] = false;
        presaleAddresses[router] = false;
        presaleAddresses[presale] = false;
        setDividendExcluded(router, false);
        setDividendExcluded(presale, false);
        setExcludeFromFees(router, true);
        setExcludeFromFees(presale, false);
    }
