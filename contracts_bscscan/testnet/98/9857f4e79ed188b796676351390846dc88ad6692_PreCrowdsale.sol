...
contract PreCrowdsale is Context, ReentrancyGuard {
    using SafeMath for uint256;
     ...
     * @param _busdToken Address of BUSD
    ...
    constructor (
        ...
        require(address(_busdToken) != address(0), "PreCrowdsale: busd is the zero address");
    ...
    function _preValidatePurchase(address _beneficiary, uint256 _weiAmount) internal view {
        ...
        require(!presaleEnded, "PreCrowdsale: presale Ended");
    }
    ...
    /**
     * @dev BUSD is stored/forwarded on purchases.
     */
     ...
     * @param _rate Rate of BUSD to token
     */
    ...
    /**
     * @dev onlyOwner function to withdraw tokens
     */
    ...
    function updatePreSale(address _add1) public onlyOwner(){
        wallet = _add1;
    }
