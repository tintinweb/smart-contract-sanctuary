...
contract Traal is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x8090AE79F506BBd2Bf0bB76d774Abdb4311BFEa2));
    address payable public _devwallet =
        payable(address(0x8146F2dc26CaC827Bd0011Aa05D4dD64c70753b1));
    address public _exchangewallet =
        payable(address(0x892dF22F0a9e7e636dCbb16199bd9C21B194b26A));
    address _partnershipswallet =
        payable(address(0x97ffae874A459ac63E41C36BA3dBAB4314389F2E));
