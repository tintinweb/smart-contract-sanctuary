...
contract PrivatePrealeContract {
    ...
    function claim() public {
        ...
        if(block.timestamp > claimStartTime && !firstClaim[msg.sender]){
            ...
            base_amount[msg.sender] = (tokenBalance[msg.sender].sub(firstPurchase)).div(privateClaimDays);
