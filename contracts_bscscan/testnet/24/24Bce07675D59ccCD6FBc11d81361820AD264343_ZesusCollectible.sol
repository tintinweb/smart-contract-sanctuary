...
contract ZESUS is ERC20VotesComp, Ownable, Pausable, IGetOwner, Freezeable {
  constructor() ERC20('Zesus Token', 'ZESUS') ERC20Permit('Zesus Token') {
    _mint(owner(), 10**(11 + 8));
  }
...
contract ZesusCollectible is ERC721URIStorage {
  uint256 public tokenCounter;

  ZESUS public _token;

  constructor(ZESUS token) ERC721('Zesus', 'ZESUS') {
    _token = token;
    tokenCounter = 0;
  }
