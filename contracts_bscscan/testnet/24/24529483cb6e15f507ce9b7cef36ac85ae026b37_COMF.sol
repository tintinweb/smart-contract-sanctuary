...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0DF6b519cbCDb49efBC45E411A56846540f6A56c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Hello World";
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount)  public { }
