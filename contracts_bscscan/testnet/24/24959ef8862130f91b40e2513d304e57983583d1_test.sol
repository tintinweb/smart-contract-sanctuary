...
contract test is Ownable {
    ...
    uint256 public constant REFERENCE_LEVEL1_RATE = 60;
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(77, 20*60*60*24)); //2 days
        investmentPlans_.push(Objects.Plan(88, 16*60*60*24)); //4 days
        investmentPlans_.push(Objects.Plan(99, 14*60*60*24)); //10 days
    }
