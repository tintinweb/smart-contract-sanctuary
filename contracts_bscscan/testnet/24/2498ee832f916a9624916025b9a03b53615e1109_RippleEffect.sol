...
contract RippleEffect is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TEST";
    string constant _symbol = "XRP.E";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 20 / 100000000;

    //max wallet holding of 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000000;
    ...
    uint8 private cooldownTimerInterval = 45;
    mapping (address => uint) private cooldownTimer;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply * 100 / 10000; // 0.01% of supply
    bool inSwap;
