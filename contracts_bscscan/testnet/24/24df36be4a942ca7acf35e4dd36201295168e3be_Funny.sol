...
contract Funny is Context, IERC20, Ownable {
    ...
    string private _name = "Funny COIN";
    string private _symbol = "fum";
    ...
    address public marketingWallet = 0xf01642A44CDdF1A3e2a3A432b171B067De857482;
...
//Router: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
       ...
       //  uniswapV2Pair = IUniswapV2Factory(0x6725F303b657a9451d8BA641348b6761A6CC7a17).createPair(address(this), _uniswapV2Router.WETH());
        ...
        IUniswapV2Factory ff = IUniswapV2Factory(0x6725F303b657a9451d8BA641348b6761A6CC7a17);

        uniswapV2Pair = ff.createPair(address(this), _uniswapV2Router.WETH());
