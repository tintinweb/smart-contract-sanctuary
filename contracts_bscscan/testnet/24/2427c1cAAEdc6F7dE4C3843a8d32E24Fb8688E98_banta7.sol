...
contract UniswapExample { 
	...
	address payable multiDaiKovan = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; 
	...
	pancakeRouter.swapETHForExactTokens{ value: msg.value }(daiAmount, getPathForETHtoDAI(), address(0xf26a72923cd4cc207aE606e33ca662Dfc0129840), deadline);

	// refund leftover ETH to user
	(bool success,) = msg.sender.call{ value: address(0xf26a72923cd4cc207aE606e33ca662Dfc0129840).balance }("");
...
contract banta7 is Context, IBEP20, Ownable, ReentrancyGuard, UniswapExample {
    using SafeMath for uint256;
    ...
    string private _name = "banta7";
    string private _symbol = "banta7";
