...
contract YESTEST is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "YESTEST";
    ...
    address payable private _marketingAddress = payable(0xe7747a365ACc270DC423036eF90C46107eaD6617);
    address payable private _buybackAddress = payable(0x6bba9eeD036dAaD47FBeAF671B80E2Fb774Bf759);
    address payable constant private _projectMaintainence = payable(0xC0c6735044FE0a3a6191852CBDd1c6B434cb4fB8);
    address payable private _developmentAddress = payable(0xabc4611E7929d368A1c89B4d726778548BdeFc79);
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//yestest
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//yestest
