...
abstract contract RSunAuth {
    ...
    constructor(address owner_) {
        ...
        permissionNameToIndex["WithdrawBNB"] = uint(Permission.WithdrawBNB);
        ...
        permissionIndexToName[uint(Permission.WithdrawBNB)] = "WithdrawBNB";
    }
...
contract RSunTokenLocker is RSunAuth {
    ...
    address public BUSD = 0xbcca17a1e79Cb6Fcf2A5B7433e6fBCb7408Ca535;
    ...
    function withdrawFees() public authorizedFor(Permission.WithdrawBNB) {
        (bool success,) = payable(msg.sender).call{ value: address(this).balance }("");
        require(success, "Failed to send BNB");
    }

    function withdrawBUSD() public authorizedFor(Permission.WithdrawBNB) {
