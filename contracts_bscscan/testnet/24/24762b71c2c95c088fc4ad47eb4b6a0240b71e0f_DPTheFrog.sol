...
Tokenomics
    💵 1% Max Buy Tx ( 1,000,000,000 $INU2k )
    💵 0.5% Max Sell Tx ( 500,000,000 $INU2k )
    💰 2% Max Bag ( 2,000,000,000 $INU2k )
...
/* Token contract */
contract DPTheFrog is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "TEST INU2K";
    string constant _symbol = "INU2K";
    ...
    constructor () Auth(msg.sender) {
        _router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
