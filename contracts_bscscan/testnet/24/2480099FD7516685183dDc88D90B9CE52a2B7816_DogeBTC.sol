...
contract DogeBTC is ERC20, Ownable {
        ...
        onlyOwner
    {
        require(
            ...
            "DogeBTC: Sell transaction multipler must be between 100 (1x) and 200 (2x)"
        );
    ...
    function setMarketingDivisor(uint256 divisor) external onlyOwner {
        require(
            ...
            "DogeBTC: Marketing divisor must be between 0 (0%) and 100 (100%)"
        );
    ...
    function triggerBuyBack(uint256 amount) public onlyOwner {
        require(
            !swapping,
            "DogeBTC: A swapping process is currently running, wait till that is complete"
        );
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "DogeBTC: The dividend tracker already has that address"
        );

        DogeBTCDividendTracker newDividendTracker = DogeBTCDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "DogeBTC: The new dividend tracker must be owned by the FLOKIBUSD token contract"
        );
    ...
    function updateDividendRewardFee(uint8 newFee) public onlyOwner {
        require(
            newFee >= 0 && newFee <= 10,
            "DogeBTC: Dividend reward tax must be between 0 and 10"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "DogeBTC: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "DogeBTC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DogeBTC: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(
            ...
            "DogeBTC: The liquidity wallet is already this address"
        );
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DogeBTC: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DogeBTC: Cannot update gasForProcessing to same value"
        );
...
contract DogeBTCDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "DogeBTC_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DogeBTC contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "DogeBTC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "DogeBTC_Dividend_Tracker: Cannot update claimWait to same value"
        );
...

{
  ...
  "evmVersion": "istanbul",
  "libraries": {
    "/C/Users/DELL/Downloads/projects/erc20tokenPresale/contracts/DogeBTC.sol": {
      "IterableMapping": "0x865B643AB142122806b3627de8b3A445D7b0D67B"
    }
  },
  "outputSelection": {
    "*": {
