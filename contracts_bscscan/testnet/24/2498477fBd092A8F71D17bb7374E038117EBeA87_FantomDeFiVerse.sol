...
contract FantomDeFiVerse is ERC721, ERC2981, IMAX721, ERC165Storage, PaymentSplitter, Developer, Ownable {
  ...
  event UpdatedRoyalties(uint256 _old, uint256 _new);
 ...
 */
  ...
  function publicMint(uint256 amount) public payable {
    ...
    for (uint i = 0; i < amount; i++) {
      ...
      _setRoyalties(_tokenIdCounter.current(), msg.sender, _percentRoyalty);
 ...
 */
  ...
  function setRoyaltyInfo(uint8 _percentage) public onlyOwner {
    uint8 old = _percentRoyalty;
    _percentRoyalty = _percentage;
    emit UpdatedRoyalties(old, _percentRoyalty);
  }
