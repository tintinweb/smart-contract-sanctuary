...
contract CakeLiq {
    ...
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;     // Canonical WBNB address used by Pancake
    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;     // Settlement BUSD contract address
    address ROUTER = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;   // Pancake V2 ROUTER
    ...
    function depositBEP20(address asset, address provider, uint value, uint JOBID) external {
