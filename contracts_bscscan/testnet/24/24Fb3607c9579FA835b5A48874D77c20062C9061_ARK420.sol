...
contract ARK420 is IBEP20, Ownable, Pausable {
    ...
    uint public constant vestingSaleReleaseStart = 1642777800; // 00:00:00 20 April 2022 GMT+00:00 1650412800
    uint public constant vestingSaleSecondPeriod = 365 minutes; // 1/365 each day

    uint public constant vestingFoundationReleaseStart = 1642779000; // 00:00:00 22 January 2022 GMT+00:00 + 2 Months 2022 GMT+00:00 1642809600
    ...
    uint public constant stakingContractRelease = 1642777800; // 00:00:00 20 April 2022 GMT+00:00 1650412800
    uint public stakingAmount;

    address public liquidityContract; // can be set once
    uint public constant liquidityContractRelease = 1642777800; // 00:00:00 20 April 2022 GMT+00:00 1650412800
    uint public liquidityAmount;

    address public exchangeListingContract; // can be set once
    uint public constant exchangeListingContractRelease = 1642777800; // 00:00:00 20 April 2022 GMT+00:00 1650412800
    uint public exchangeListingAmount;

    address public advisorsAndTeamContract; // can be set once
    uint public constant advisorsAndTeamContractRelease = 1642779600; // 00:00:00 22 January 2022 GMT+00:00 + 2 Weeks 1642809600
    uint public advisorsAndTeamAmount;
