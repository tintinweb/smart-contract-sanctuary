...
import './libraries/ERC721PresetMinterPauserAutoId.sol';
import "./interfaces/INft.sol";

contract Nft is ERC721PresetMinterPauserAutoId, Ownable, INft {
    using Strings for uint256;
    mapping(uint256 => string) private _tokenURIs;

    constructor() ERC721PresetMinterPauserAutoId("Slimmy", "SLM", "") {}
    ...
    function safeMint(address to, string memory _tokenURI) external {
        ...
        require(ownerOf(tokenId) == to, "Create Nft not success");
    }

    function setTokenURI(uint256 tokenId, string memory _tokenURI) external override {
        require(hasRole(ADMIN_ROLE, _msgSender()), "ERC721PresetMinterPauserAutoId: must have admin role to set value");
        _setTokenURI(tokenId, _tokenURI);
    }
...
interface INft is IERC721, IERC721Burnable {
