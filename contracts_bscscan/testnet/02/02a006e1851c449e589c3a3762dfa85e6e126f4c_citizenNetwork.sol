...
contract citizenNetwork is Context, IERC20 {
    ...
    uint256 public endStamp = 13396000;//////////////////////////////*** calculate and enter new endStamp before deploying ***
    ...
    function applicationForCitizenship(string memory _telegramID)  _checkAddr  external payable returns(string memory) { 
        ...
        if(msg.value == 100000000 gwei  && block.timestamp < endStamp){
            ...
            emit success(nextId -1); 
                ...
                revert("value should be equal to 0.1 BNB & Current timestamp should be less than applicationRegister end timestamp");
        }
