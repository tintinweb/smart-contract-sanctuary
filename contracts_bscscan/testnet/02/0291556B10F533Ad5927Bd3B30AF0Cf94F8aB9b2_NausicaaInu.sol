...
contract NausicaaInu is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x22e60923929Cce18d7a6AAE33B193454E4829bf3); // Marketing Address
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyDevFee <= 1500, "Must keep buy taxes below 15%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellDevFee <= 2000, "Must keep sell taxes below 20%");
