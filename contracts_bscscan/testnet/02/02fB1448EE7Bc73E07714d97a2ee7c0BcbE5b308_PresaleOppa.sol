...
contract PresaleOppa {
    ...
    uint256 pricePerToken = 58823529;

    uint256 public availableToken;
    uint256 MinPurchase = 100000000000000000; //
    uint256 MaxPurchase = 2000000000000000000; // 14 TRILLION
    ...
    function _transfer(uint256 _msg) internal {
        ...
        require(
            _msg <= MaxPurchase && _msg >= MinPurchase,
            "Limit purchase only"
        );
        ...
        token.transfer(msg.sender, sendvalue * 1e18);
...
contract Oppa is Context, IBEP20, Ownable {
    ...
    constructor() public {
        ...
        _symbol = "OPPA";
        _decimals = 18;
        _totalSupply = 100000000000000000000000000000000000; // 100 Quadrillion
