...
contract preSaledeployerOPT {
    ...
    constructor() {
        admin = payable(0x171C10C05bbf0B87907561Ee50D6a2Bb6aB17502); //0x2dC900A489DA7d5Eb5E1eAc7F6B9f9246f4dD16d
        projectCoinFee = 3;
        projectTokenFee = 3;
        userFee = 10;
    ...
    function createPreSale(IERC20 _token, IERC20 _coin, uint256[] memory _preSaleData)
        external
    ...
    function setProjectCoinFee(uint256 _percent) external onlyAdmin {
        projectCoinFee = _percent;
    }
    function setProjectTokenFee(uint256 _percent) external onlyAdmin {
        projectTokenFee = _percent;
    }
    function setUserFee(uint256 _percent) external onlyAdmin {
        userFee = _percent;
    }
