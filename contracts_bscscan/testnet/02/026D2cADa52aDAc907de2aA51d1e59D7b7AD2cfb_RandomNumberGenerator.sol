...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public safemoonLottery;
     ...
     * @param _seed: seed provided by the Safemoon lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == safemoonLottery, "Only SafemoonLottery");
    ...
    /**
     * @notice Set the address for the SafemoonLottery
     * @param _safemoonLottery: address of the Safemoon lottery
     */
    function setLotteryAddress(address _safemoonLottery) external onlyOwner {
        safemoonLottery = _safemoonLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ISafemoonLottery(safemoonLottery).viewCurrentLotteryId();
    }
}