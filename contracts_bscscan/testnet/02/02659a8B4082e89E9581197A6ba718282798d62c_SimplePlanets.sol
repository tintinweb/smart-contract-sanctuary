...
contract  SimplePlanets is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable, VRFConsumerBase {
     ...
     * Requests randomness 
     */
    function getRandomNumber() public onlyRole(DEFAULT_ADMIN_ROLE) returns (bytes32 requestId) {
        ...
        payable
    {
        ...
        if (whitelistOnly) {
            require(verifyUser(msg.sender), "SimplePlanets: Must be whitelisted to mint currently.");
        }
    ...
    function addUser(address _addressToWhitelist) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function setWhitelistOnly(bool _whitelistStatus) public onlyRole(DEFAULT_ADMIN_ROLE) {
