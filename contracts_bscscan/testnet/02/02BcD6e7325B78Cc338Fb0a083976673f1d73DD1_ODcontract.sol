 ...
 * 
 * NOTE:
 * - Added overdoseMode and setters, should be tested.
...
contract ODcontract is IBEP20, Auth {
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 5000 ) / 10000; // 50%
    ...
    uint256 overdoseDuration = 30 minutes;
    ...
    // Enable overdose
    function enableOverdose(uint256 _minutes) public authorized {
        overdoseTriggeredAt = block.timestamp;
        overdoseDuration = _minutes;
    }
