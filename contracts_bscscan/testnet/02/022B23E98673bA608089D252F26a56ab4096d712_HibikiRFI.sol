...
contract HibikiRFI is IBEP20 {
    ...
    constructor(address creator, string memory n, string memory s, uint8 d, uint256 tokenSupply, uint256 liqTax, uint256 refTax) {
		owner = creator;
		_name = n;
		_symbol = s;
		_decimals = d;
        ...
        IDexRouter _router = IDexRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
