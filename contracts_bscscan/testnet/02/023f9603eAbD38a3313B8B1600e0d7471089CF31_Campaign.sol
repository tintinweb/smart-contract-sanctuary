...
contract Campaign is Ownable, Initializable, Pausable, ERC1155Holder {
    ...
    function setCampaignKey(uint256 _campaignKey) external onlyOwner {
        require(_campaignKey != campaignKey, "No Need To Update");
...
//        require(_mysteryBoxIds.length == 4, 'Not Enough Mystery Box For Special Box');
    ...
    function buyMysteryBox(
        ...
        bytes32 message = prefixed(keccak256(abi.encodePacked(_msgSender(), campaignKey, address(this))));
