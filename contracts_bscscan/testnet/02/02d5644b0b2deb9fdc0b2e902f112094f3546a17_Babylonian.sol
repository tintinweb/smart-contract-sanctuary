...
/**
 * @title GRX price Oracle
 *      This Oracle calculates the average USD price of GRX based on the BNB-GRX and USDC-BNB pools.
...
contract MarketOracle is Ownable {
    ...
    address private constant _wbnb = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //0xC61080751F412d8bA8AbbEA2e64a957a14292dcc
    address private constant _busd = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //0xae13d989dac2f0debff460ac112a837c89baa7cd
/*
    address private constant _wbnb = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //0xC61080751F412d8bA8AbbEA2e64a957a14292dcc
    address private constant _busd = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //0xae13d989dac2f0debff460ac112a837c89baa7cd
*/
    ...
    constructor(
        address __grv_bnb,   // Address of the grv-BNB pair on Pancakeswap
    ...
    function getgrvBnbRate() public view returns (uint256, uint256, uint32, uint256) {
        ...
        require(_blockTimestamp != grvBnbBlockTimestampLast, "GRX Last and current are equal");
