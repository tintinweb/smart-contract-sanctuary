 ...
 *    ╚══════╝╚═╝  ╚═╝ ╚═════╝     ╚═╝ ╚═════╝ ╚══════╝
 *
 *  These have been calculated below, and are the standards
 ...
 */
   ...
   *     ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝╚══════╝   ╚═╝   
   */
  constructor() ERC721("CrypTards", "TARDS") { //address _main, address _one, address _two, address _three, address _four
    // init of all variables
    tokenCounter = 0;
    mintFee = 1 * 10**18; // .069 ETH
    maxMint = 10000; // Total Amount
    royaltyFee = 5; // as a percentage
    teamMintCount = 0;
    teamMintMax = 50;
    whiteListEnd = 200;
    royaltyAddress = msg.sender; //0xC1C857631a1A0E3f55AC183E8AbF8209b60DBff9;
    devAddress = msg.sender;
    gandmPaymentOne = msg.sender; //_one;
    gandmPaymentTwo = msg.sender; //_two;
    gandmPaymentThree = msg.sender; //_three;
    gandmPaymentFour = msg.sender; //_four;
    crypTardsOne = msg.sender; //0x3C2d2104A7A660868D7a853f7961E12593a75d46;
    crypTardsTwo = msg.sender; //0x9EB6d7624243947143C0fE4dFCC2DEBacEc6A17E;
    enableMinter = false;
 ...
 *    ╚═╝      ╚═════╝ ╚═╝  ╚═══╝ ╚═════╝   ╚═╝   ╚═╝ ╚═════╝ ╚═╝  ╚═══╝╚══════╝
 *
 * Formerly "Sweep functions," now the onlyDev function
 * Token/"ETH"/setTokenURI/onlyDev transfer-renounce
 */
