...
/*
 * Get USDT Tokens just by holding Neso!
 *  Add Tether(USDT) to your wallet = 0xdAC17F958D2ee523a2206206994597C13D831ec7
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0xdAC17F958D2ee523a2206206994597C13D831ec7); 
...
contract Nesko is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c ;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x606D332e56F2338219671BEa2678Fa524057d767;

    string constant _name = "Nesko";
    string constant _symbol = "Nesko";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1 Quadrillion
    uint256 public _maxTxAmount = 5000000000000 * (10 ** _decimals); // 0.5%
    uint256 public _maxWalletToken = 50000000000000 * (10 ** _decimals); // 5%
