...
contract Ownable is Context {
    ...
    modifier onlyManager() {
        (bool success) = (_manager == _msgSender() || _owner == _msgSender());
        require(success, "Ownable: caller is not the owner / manager of this contract");
        _;
    }
...
contract DogeFlight is Context, IERC20, Ownable {
    ...
    string private _name = "DogeFlight";
    string private _symbol = "DFL";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 3;
    uint256 public _liquidityFee = 6;
    uint256 private _tTotal = 10000 * 10 ** uint256(_decimals);
    uint256 public _maxTxAmount = 1000 * 10 ** uint256(_decimals);
    uint256 private numTokensSellToAddToLiquidity = 50000 * 10 ** uint256(_decimals);
    ...
    address payable public _marketingAddress = 0x58E602c8400B72DB50e5E30dD8fb8a2806bBBBac;
    address private _deadwallet = 0x000000000000000000000000000000000000dEaD;

    address private pancakerouter_live = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address private pancakerouter_test = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(pancakerouter_test); //@todo change it to live "pancakerouter_live"
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
        uniswapV2Router = _uniswapV2Router;

        // Wallets To be Excluded from Fees
        ...
        // Wallets To Be Excluded From Rewards
        _isExcluded[address(this)] = true;
        _isExcluded[owner()] = true;
        _isExcluded[_deadwallet] = true;
    ...
    function setnumTokensSellToAddToLiquidity(uint256 ToSellToLQ) external onlyManager() {
        numTokensSellToAddToLiquidity = ToSellToLQ *  10 ** uint256(_decimals);
    }
    function setMarketingWalletAddress(address payable mkwallet) external onlyManager() {
        _marketingAddress = mkwallet;
    }
    function setSellToLiquifyPercent(uint256 taxFee) external onlyOwner() {
        numTokensSellToAddToLiquidity = taxFee;
    }
