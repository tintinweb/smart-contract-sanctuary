...
contract TokenSale is Initializable, Ownable {
  ...
  function initialize(
    ...
    require(
      _publicSalePurchaseLevel <= _purchaseLevels.length - 1,
    ...
    whitelisted
  {
    ...
    uint256 purchaseCap = purchaseLevels[investor.whitelistPurchaseLevel];
    ...
    purchaseToken.safeTransferFrom(msg.sender, address(this), investmentAmount);
    ...
    whitelisted
  {
    ...
    Investor storage investor = investors[msg.sender];
    uint256 purchaseCap = purchaseLevels[publicSalePurchaseLevel];
  ...
  function finalize() external onlyOwner {
    ...
    purchaseToken.safeTransfer(admin, balance);
