...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBe17A51531C6D7375CB93bCe37b5bEf47524f45D;
...
contract Hexagon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x98A29e0F4a5e1a35029d33c081BB8534baDc9463;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Hexagon";
    string private _symbol = "HXG";
