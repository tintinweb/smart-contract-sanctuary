...
contract Altruvault is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x25A7aB5a0A175688adE82bC452A638B0E964EdAD); 
    address payable public developmentAddress = payable(0x0C118331D0D44dD90c60E7AF910fCC586b26f386); 
    address payable public charityAddress = payable(0xf878591572C4D3277A509664BcBE59194ADacD99); 
    address payable public vaultRewardAddress = payable(0x0Da28B84260bb625be5d5ca1a71f39422Fe782c8); 
    ...
    string private constant _name = "BESTTEST1";
    string private constant _symbol = "BESTTEST1";
