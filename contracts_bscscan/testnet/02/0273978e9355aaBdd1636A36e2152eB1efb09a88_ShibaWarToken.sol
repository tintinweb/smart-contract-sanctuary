...
contract ShibaWarToken is ERC20, Ownable {
    ...
    uint256 internal minimumAmmountToSellLiquidity = 200000 * 10**decimals();
    uint256 internal minimumAmmountToSellRewards = 150000 * 10**decimals();
    uint256 internal minimumAmmountToSellDev = 70000 * 10**decimals();
    ...
    constructor() ERC20("Version1.6", "RAWv1.6") {
        ...
        _mint(msg.sender, 500_000_000_000_000 * 10**decimals());
