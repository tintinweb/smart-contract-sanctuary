...
contract GlobalsAndUtility is ERC20 {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        */
        uint256 viral = (payout * g._claimedBtcAddrCount) /
        ...
        */
        uint256 crit = (payout * g._claimedSatoshisTotal) /
        ...
        */
        ...
        if (day < CLAIM_PHASE_END_DAY) {
            uint256 bigPaySlice = (g._unclaimedSatoshisTotal *
                HEARTS_PER_SATOSHI) / CLAIM_PHASE_DAYS;
...
contract StakeableToken is GlobalsAndUtility {
    ...
    function _stakeStart(
        ...
        uint256 bonusHearts = _stakeStartBonusHearts(
            newStakedHearts,
            newStakedDays
        );
    ...
    function _shareRateUpdate(
        ...
        if (stakeReturn > st._stakedHearts) {
            ...
            */
            ...
            uint256 newShareRate = ((stakeReturn + bonusHearts) *
...
contract UTXOClaimValidation is StakeableToken {
    ...
    function _claimMessageCreate(
        ...
        bool includeAddrChecksum = (claimFlags &
            CLAIM_FLAG_ETH_ADDR_LOWERCASE) == 0;

        bytes memory addrStr = _addressStringCreate(
            claimToAddr,
            includeAddrChecksum
        );
...
contract UTXORedeemableToken is UTXOClaimValidation {
    ...
    function _satoshisClaim(
        ...
        require(
            g._currentDay < CLAIM_PHASE_END_DAY,
            "HEX: Claim phase has ended"
        );
        ...
        uint256 autoStakeHearts = (totalClaimedHearts *
        ...
        returns (uint256)
    {
        ...
        */
        return
            (claimedHearts * (daysRemaining - 1)) /
            ((CLAIM_PHASE_DAYS - 1) * 5);
    }
}

// Part: TransformableToken
...
contract TransformableToken is UTXORedeemableToken {
     ...
     * @return rawAmount Raw amount that was entered with; referrerAddr Referring Eth addr (optional; 0x0 for no referrer)
     */
