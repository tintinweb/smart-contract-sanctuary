...
contract Frickcoin is Context, IERC20, Ownable {
    ...
    string private _name = "Frickin Heck Coin";
    string private _symbol = "FRICK";
    ...
    // Owner cannot transfer out frickcoin from this smart contract
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out FRICKCOIN!");
