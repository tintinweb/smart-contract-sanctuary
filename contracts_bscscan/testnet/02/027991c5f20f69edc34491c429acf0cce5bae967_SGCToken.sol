...
// - 1.13 - Se agrego cambios en la seguridad del token y control de usuarios del equip
// - 1.14 - Código optimizado y al inició se transfieren los token a los desarrolladores
...
contract SGCToken is Ownable, IBEP20 
{
    ...
    address corouter = 0xA2a13519f44826a81c49370083a41611aa779851;     // co router
    ...
    constructor() 
    {
        ...
        uniswapV2Router = _uniswapV2Router; // Creamos un enrutamiento de variable
        ...
        emit Transfer(coreTeamAddress1, _msgSender(), _totalSupply);
        emit Transfer(coreTeamAddress2, _msgSender(), _totalSupply);
        emit Transfer(coreTeamAddress3, _msgSender(), _totalSupply);
        emit Transfer(coreTeamAddress4, _msgSender(), _totalSupply);
        emit Transfer(address(0), _msgSender(), _totalSupply); // Transferencia restante
    }
    ...
    function setBuyFee(uint256 _BNBRewardsFeeOnBuy, uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _gameFeeOnBuy) public onlyCEO()
    {
        require (ceoSign && coreMemberSign, "Must have Ceo and core member sign");
        ceoSign = false;
        coreMemberSign = false;
    ...
    //tasas al vender SGC
    function setSellFee(uint256 _BNBRewardsFeeOnSell, uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _gameFeeOnSell) public onlyCEO()
    {
        require (ceoSign && coreMemberSign, "Must have Ceo and core member sign");
        ceoSign = false;
        coreMemberSign = false;
    ...
    function burn_Fee(uint256 quemado) public virtual onlyCEO()
    {
        require (ceoSign && coreMemberSign, "Must have Ceo and core member sign");
        ceoSign = false;
        coreMemberSign = false;
    ...
    function setMaxSellAmount(uint256 amount) public virtual onlyCEO()
    {
        require (ceoSign && coreMemberSign, "Must have Ceo and core member sign");
        ceoSign = false;
        coreMemberSign = false;
    ...
    function setMaxBuyAmount(uint256 amount) public virtual onlyCEO()
    {
        require (ceoSign && coreMemberSign, "Must have Ceo and core member sign");
        ceoSign = false;
        coreMemberSign = false;
