...
contract BNBDistributor is Ownable {
    ...
    function depositExternalBNB() external payable {
        IERC20(WBNB).approve(msg.sender, msg.value);
     ...
     *
     */
    function withdrawBNB(address receiver) payable external onlyOwner {
