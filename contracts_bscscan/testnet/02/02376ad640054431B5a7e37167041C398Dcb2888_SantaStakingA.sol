...
contract SantaStakingA is Ownable, ReentrancyGuard {
    ...
    IERC20 public rewardToken = IERC20(0x2995bD504647b5EeE414A78be1d7b24f49f00FFE); // testnet
    // The reflection token of staking token
    // IERC20 public reflectionToken = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    IERC20 public reflectionToken = IERC20(0x2995bD504647b5EeE414A78be1d7b24f49f00FFE); // testnet
    ...
    function initialize(
        ...
        if(startBlock < block.number) startBlock = block.number;
    ...
    function depositRewards(uint _amount) external nonReentrant {
        ...
        totalRewards = totalRewards.add(afterAmt).sub(beforeAmt);
    }
