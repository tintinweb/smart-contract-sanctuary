...
contract CorSeedSale is Ownable {
    ...
    // function for test sale ///////////
    function setBlocksPerMonth(uint256 _time) public onlyOwner {
        TIMESTAMP_PER_MONTH = _time;
    }

    function setCorgiToken(IERC20 _corgiToken) public onlyOwner {
        corgiToken = _corgiToken;
    }
    ...
    function setReleaseTime(uint256 _time) public onlyOwner {
        // require(_time > block.timestamp, "time not real"); // comment to pass ez on test
