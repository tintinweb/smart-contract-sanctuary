...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x68FD2167a40b3A9A4fbbb5fB36bdcB7324BAe1a4;
...
contract POLARToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xE8242D1a9C414cC66E1e25E497961FF7bE7514bb;   //Dev&Marketing Wallet
    ...
    string private _name = "POLAR";
    string private _symbol = "PRL";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 4;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _charityFee = 4; // we dont donate to charity, we will use this for marketing and development!!!!
