...
contract TestKit2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TestKit2";
    string constant _symbol = "TKv2";
    ...
    uint256 public rewardsFeeBuy = 4;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8A3eeA2dB7AedF69756Eadfa0EC8026064EDa9e5;  // marketingwallet
        anothermarketingWallet = 0x9844F10060dd5dbafC48a9D607b056696D30121F; //owner
        
        totalBuyFee = liquidityFeeBuy.add(marketingFeeBuy).add(rewardsFeeBuy);
        totalSellFee = liquidityFeeSell.add(marketingFeeSell).add(rewardsFeeSell);
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell, uint256 newLiqFeeBuy, uint256 newRewardFeeBuy, uint256 newMarketingFeeBuy) external authorized {
        liquidityFeeSell = newLiqFeeSell;
        rewardsFeeSell = newRewardFeeSell;
        marketingFeeSell = newMarketingFeeSell;

        liquidityFeeBuy = newLiqFeeBuy;
        rewardsFeeBuy = newRewardFeeBuy;
        marketingFeeBuy = newMarketingFeeBuy;

        totalSellFee = liquidityFeeSell.add(rewardsFeeSell).add(marketingFeeSell);
        totalBuyFee = liquidityFeeBuy.add(rewardsFeeBuy).add(marketingFeeBuy);
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountToLiquify = tokensToLiquify.mul(liquidityFeeSell).div(totalSellFee).div(2);
        ...
        uint256 totalBNBFee = totalSellFee.sub(liquidityFeeSell.div(2));
