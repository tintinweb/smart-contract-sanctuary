 ...
 */
contract ppStrategyCake is Ownable, Pausable {
    ...
    address public constant cake =
        address(0xbe766e68D7888934d1A3E0332B46c4Cd27A169aE);
    ...
    address public constant masterchef =
        address(0x994DAb3f28712198357AB84E4bb8Bf8762381997);
    address public constant strategist =
        address(0xfB997db0eECb09F1D8e369Bd19a5c14087160cc5);
    ...
    uint256 public constant WITHDRAWAL_FEE = 0;
    ...
    function chargeFees() internal {
        uint256 toWbnb = IERC20(cake).balanceOf(address(this)).mul(4).div(100);
        ...
        uint256 callFee = wbnbBal.mul(10).div(40);
        IERC20(wbnb).safeTransfer(msg.sender, callFee);


        uint256 strategistFees = wbnbBal.mul(5).div(40);
        IERC20(wbnb).safeTransfer(strategist, strategistFees);
