...
contract N is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public maxSellTransactionAmount = 25000000 * (10 ** _decimals);
    
    uint256 public _maxWallet = 25000000 * (10 ** _decimals);
