...
contract GoInvest is IGoStake {
    ...
    function stakeOf() external view returns (uint256) {
        ...
        return stakeState.stakes[msg.sender];
    }
    ...
    function tryWithdraw(address to, uint256 amount) public _positive(amount)
...
library SafeAmount {
    ...
    function safeTransferFrom(
        ...
        IERC20(token).safeIncreaseAllowance(from, amount);
...
interface IGoStake is IStakable, IWithdrawble, IRewardable {
