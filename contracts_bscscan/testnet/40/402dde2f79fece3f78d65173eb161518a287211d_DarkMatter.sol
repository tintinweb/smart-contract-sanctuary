...
contract DarkMatter is BEP20 ('DarkMatter', 'KDM'), MinterRole {
    
    uint256 public constant HARD_CAP = 9 * (10 ** 6) * (10 ** 18);
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DarkMatters (not scaled);
