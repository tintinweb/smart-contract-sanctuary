...
contract WiKiFarm is Ownable {
    ...
    constructor () public {
          ...
          inviterJoinRateNo1 = 3000;
          inviterJoinRateNo2 = 2000;
          inviterJoinRateNo3 = 1000;// /10000
    }
    ...
    function exitFarm(uint256 _farmId, uint256 _orderIndex) public returns (bool) {
        ...
        if(_farmId==1){
            ...
            twoFarmAccountOrders[msg.sender][_orderIndex].withdrawalTime = block.timestamp;
    ...
    function joinFarm(uint256 _farmId, address _inviterAddress) public returns (bool) {
        ...
        if(_farmId==1){
            ...
            oneFarmAccountOrders[msg.sender][oneFarmAccountOrderCount[msg.sender]] = FarmAccountOrder(oneFarmAccountOrderCount[msg.sender],address(msg.sender),true,block.timestamp,block.timestamp,0,0,oneFarmNeedWnftAmount,oneFarmNeedBzzoneAmount,0,0);// add FarmAccountOrder
