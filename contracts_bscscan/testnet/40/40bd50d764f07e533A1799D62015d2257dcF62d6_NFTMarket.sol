...
/*
TODO REF: https://dev.to/dabit3/building-scalable-full-stack-apps-on-ethereum-with-polygon-2cfb
*/
...
contract NFTMarket is Ownable, ReentrancyGuard {
    ...
    uint256 private _listingPrice = 0.002 ether;
    ...
    mapping(uint256 => MarketItem) private _marketItems; // _itemIds.current() => MarketItem
        ...
        nonReentrant
    {
        ...
        emit BoughtNFT(itemId, nftContract, tokenId, msg.sender, price);
    }
        ...
        nonReentrant
    {
        ...
        // Change token's seller to current sender.
        ...
        emit SoldNFT(itemId, nftContract, tokenId, msg.sender, price);
    }
