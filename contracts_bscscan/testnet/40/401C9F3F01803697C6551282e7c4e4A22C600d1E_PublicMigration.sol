...
contract PublicMigration is Ownable, Lockable {
    ...
    function initialize (
        ...
        emit Initialize(_GIZA, _pToken, _principle, _treasury, _calculator, _market);
    }
    ...
    onlyInitialized() {
        ...
        uint256 _amount = pToken.balanceOf(msg.sender);
    ...
    function reclaim() external onlyOwner() {
        ...
        pToken.safeTransfer(address(market), ptokenAmount);
