...
contract MoniwarClaimNFT is Ownable, ReentrancyGuard {
    ...
    function getHasClaim(address _user) public view returns (bool claim) {
    ...
    function claimNFT() public payable nonReentrant {
        ...
        uint256 mowaBal = mowa.balanceOf(_msgSender());
        require(mowaBal >= feeClaim, "Not enough money to claim");
        mowa.transferFrom(_msgSender(), feeWallet, feeClaim);
