...
contract RMC is IBEP20, Auth {
    ...
    constructor (
        ...
        marketingFeeReceiver = 0x297583c17492C82e15e48C718b9C2265b9B9c152;
    ...
    function enableTrading(bool trade) external authorized
    {
        _enableTrading = trade;
    }

    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(_enableTrading = true, "Trading is not enabled");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function getTotalFee(bool sellOrBuy) public view returns (uint256) {
        if(sellOrBuy){ return getMultipliedFee(); }
        return totalFee;
    }
