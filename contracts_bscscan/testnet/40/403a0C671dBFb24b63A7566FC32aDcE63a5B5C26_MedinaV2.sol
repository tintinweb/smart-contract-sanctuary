...
contract MedinaV2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000; //reduced to 100,000 from 10B  for ease of testing
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MedinaV2";
    string private _symbol = "MED2";
    //uint8 private _decimals = 18; //changed to 18 from 9
    uint8 private _decimals = 0; //changed to 18 from 9 -for testing made this 0 so we can work with 100,000 tokens
    ...
    uint256 public _marketingAndDevBudget = 2;
    ...
    //uint256 public _maxTxAmount = 10000000000 *10**18; // made same as _tTotal
    uint256 public _maxTxAmount = 100000; // made same as _tTotal - reduced to 100,000 for ease of testing
    // set this number to adjust the rate of swaps
    //uint256 private numTokensSellToAddToLiquidity = 250000000000 * 10**9;
    //uint256 private numTokensSellToAddToLiquidity = 250000000 * 10**18; //25% of total supply (_tTotal)
    uint256 private numTokensSellToAddToLiquidity = 25000; //25% of total supply (_tTotal) reduced for testing
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Pancake V2 Swap's test net address
...
//     }
    ...
    //     require(firstOwner() == _msgSender(), "Caller not authorised");
...
*/
    ...
    //     return _amount.mul(_liquidityFee + _charityFee + _marketingAndDevBudget).div(
    //         10**2
    //     );
    // }
