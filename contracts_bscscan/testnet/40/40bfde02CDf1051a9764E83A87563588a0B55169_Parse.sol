...
contract Parse is Ownable {
    ...
    address public _punkAddress = 0xfb1042aad64D3339a4252D19D09362D130C302DE;
    ...
    function setWallet(uint256 nftId, string memory chainName, string memory wallet) public {
        require(IMasks(_punkAddress).ownerOf(nftId) == msg.sender, "not the Owner");
        BnsInfo storage itemInfo = infoMap[nftId];
