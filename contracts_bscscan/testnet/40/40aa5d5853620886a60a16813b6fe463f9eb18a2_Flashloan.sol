...
contract Flashloan is FlashLoanReceiverBase {
    ...
    address uniswapV2Router02 = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address usdc = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    address hexToken = 0x2b591e99afE9f32eAA6214f7B7629768c40Eeb39;
        ...
        override
    {
        ...
        */
        ...
        uniswapRouter.swapExactTokensForTokens(5 * 1e4 * 1e6, 1, path1, address(this), block.timestamp);
        uint256 hexAmount1 = IERC20(hexToken).balanceOf(address(this));
        address[] memory path2 = new address[](2);
        path2[0] = hexToken;
        path2[1] = eth;
        IERC20(hexToken).approve(uniswapV2Router02, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        ...
        for(uint8 i = 0; i < 4; i++) {
            uniswapRouter.swapExactTokensForTokens(5 * 1e4 * 1e6, 1, path1, address(this), block.timestamp);
            hexAmount1 = IERC20(hexToken).balanceOf(address(this));
            uniswapRouter.swapExactTokensForETH(hexAmount1, 1, path2, address(this), block.timestamp);
            uniswapRouter.swapExactETHForTokens{value: address(this).balance}(1, path3, address(this), block.timestamp);
        }
        ...
        */
        ...
        path4[0] = usdc;
        path4[1] = eth;
        uniswapRouter.swapExactTokensForETH(2 * 1e5 * 1e6, 1, path4, address(this), block.timestamp);
