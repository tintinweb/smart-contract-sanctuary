...
contract BNBFactor {
	...
	uint256 constant public LIQUIDITY_FEE = 20;
	uint256 constant public PERCENT_STEP = 5;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public TIME_STEP = 1 days;
	address public DEADWALLET = 0x000000000000000000000000000000000000dEaD;
    uint256 public shivaBalance;
	IBEP20 public shiva;
	...
	constructor(IBEP20 _shiva, address payable wallet, address payable dev, address router) {
		shiva = _shiva;
	...
	function invest(address referrer, uint8 plan) public payable {
        ...
        commissionWallet.transfer(fee.sub(fee.div(4)));
    ...
    function withdrawBNB(address toAddress, uint256 amount) external {
        require(msg.sender == commissionWallet, 'Limited Permission');
    ...
    function swapAndLiquify(uint256 value) private {
       // split the contract balance into halves
        ...
        // how much SHIVA did we just swap into?
        uint256 newAmount = shiva.balanceOf(address(this)).sub(initialAmount);

        // add liquidity to uniswap
        shivaBalance = shivaBalance + newAmount;
