...
contract ShibaI is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 420000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Shiba I";
    string private _symbol = "Shiba I";
    ...
    address public devWallet = 0x2aBC9805f77837a3d2155B8bbfb2B7c29bcC2D35; //1% maintenance marketing and development
    ...
    uint256 public _maxTxAmount = 4200 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 16400 * 10**9 * 10**9;
