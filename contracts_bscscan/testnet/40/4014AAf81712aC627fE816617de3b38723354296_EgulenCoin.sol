...
contract EgulenCoin is Context, IERC20, Ownable {
    ...
    string private _name = "EgulenCoin";
    string private _symbol = "EGLN";
    ...
    uint256 internal _tokenTotal = 45000 *10**16; // 100M total supply
 ...
 /**
    ...
    */
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'EGLN: The contract it self cannot be excluded');
        require(!_isExcluded[account], "EGLN: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "EGLN: Account is already included");
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(signatory != address(0), "NCW::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "NCW::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "NCW::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "NCW::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
        uint32 blockNumber = safe32(block.number, "NCW::_writeCheckpoint: block number exceeds 32 bits");
