...
abstract contract Windmill_Trade_Abstract is Adressable, AccessControlEnumerable, With_DAORole, With_BUSDToken, I_Windmill_Trade_Abstract{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    ////
    //////////////// Public functions ////////////////
    function initTrade(address _owner, address _manager, address _fund) public onlyRole(DAO_ROLE) virtual{
        owner = _owner;
        manager = _manager;
        fund = _fund;
        
        grantRole(DAO_ROLE, owner);
        grantRole(DAO_ROLE, manager);
        revokeRole(DAO_ROLE, deployer);
    }
    
    function endTrade() public onlyRole(DAO_ROLE) virtual{
...
interface I_Windmill_Trade_Swap_Long is I_Windmill_Trade_Abstract{

}

contract Windmill_Trade_Swap_Long is Windmill_Trade_Abstract, I_Windmill_Trade_Swap_Long{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    function initTrade(address _owner, address _manager, address _fund) public onlyRole(DAO_ROLE) override(I_Windmill_Trade_Abstract, Windmill_Trade_Abstract){
        super.initTrade(_owner, _manager, _fund);
        
        
    }
    
    function endTrade() public onlyRole(DAO_ROLE) override(I_Windmill_Trade_Abstract, Windmill_Trade_Abstract){
