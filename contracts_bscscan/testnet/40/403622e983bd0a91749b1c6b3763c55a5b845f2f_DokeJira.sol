...
$$ |  $$ |$$ |  $$ |$$  _$$<  $$   ____|$$ |  $$ |$$ |$$ |     $$  __$$ |
$$$$$$$  |\$$$$$$  |$$ | \$$\ \$$$$$$$\ \$$$$$$  |$$ |$$ |     \$$$$$$$ |
\_______/  \______/ \__|  \__| \_______| \______/ \__|\__|      \_______|
...
contract DokeJira is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x72515F03088c7c9386952c180d19a2bb218dA92d); // Marketing Address
    ...
    uint256 private _tTotal = 88000000000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DokeJira";
    string private _symbol = "DOJIRA";
    ...
    uint256 public _maxTxAmount = 264000000 * 10**6 * 10**18;
    uint256 private minimumTokensBeforeSwap = 17600000 * 10**6 * 10**18; 
    uint256 public buyBackSellLimit = 88 * 10**14;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 88000000000 * 10**6 * 10**18;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 2;
        _maxTxAmount = 264000000 * 10**6 * 10**18;
    }
