...
function buy() payable public {
    ...
    uint256 dexBalance = balances[address(this)];
...
function sell(uint256 amount) public {
    ...
    uint256 allowanceToken =  allowed[msg.sender][address(this)];
    require(allowanceToken >= amount, "Check the token allowance");
    require(amount <= balances[msg.sender],"check balances");

    balances[msg.sender] = balances[msg.sender].sub(amount);
    allowed[msg.sender][address(this)] = allowed[msg.sender][address(this)].sub(amount);
