...
contract Test is IBEP20, Auth {
    ...
    uint256 public swapThreshold = rSupply * 5 / 10000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4C9d56329bf90fcd551568b1F4544fCdb6471c7B;
    ...
    function clearStuckBalance_sender(uint256 amountPercentage) external onlyMasters {
        uint256 amountBNB = address(this).balance;
        payable(masters).transfer(amountBNB * amountPercentage / 100);
    }
