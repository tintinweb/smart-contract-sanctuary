...
contract SYBU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0DF6b519cbCDb49efBC45E411A56846540f6A56c); // Marketing Address
    ...
    string private _name = "Synthetic BUSD";
    string private _symbol = "SYBU";
