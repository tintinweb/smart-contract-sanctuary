...
interface ISWAP {
  ...
  function burnFrom(uint256 amount, address recipient) external returns (bool);
}
/*
...
contract SwapToken is ERC20, ReentrancyGuard, Ownable {
  ...
  function mintTo(uint256 amount, address recipient) external onlyFactory returns (bool) {
  ...
  function burnFrom(uint256 amount, address recipient) external onlyFactory returns (bool) {
