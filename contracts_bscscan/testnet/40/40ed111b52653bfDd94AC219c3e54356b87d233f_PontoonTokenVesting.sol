...
contract PontoonTokenVesting is ITokenVesting, Ownable {
    ...
    */
     ...
     */
    uint256 private constant ECOSYSTEM_AND_MARKETING_SUPPLY_PERCENT = 3000;
     ...
     */
    uint256 private constant PUBLIC_SUPPLY_PERCENT = 100;
    ...
    function _addTeam(
        ...
        newTeamInfo.cliffEndTime = _startTime + _cliffPeriod;
    ...
    function _addRound(
        ...
        newRoundInfo.cliffEndTime = _startTime + _listingPeriod + _cliffPeriod;
    ...
    function _massUpdateCliffEndTime(uint256 _startTime) private {
        for (uint256 i = 0; i < 4; i++) {
            roundInfo[RoundType(i)].cliffEndTime = _startTime + roundInfo[RoundType(i)].cliffPeriod;
