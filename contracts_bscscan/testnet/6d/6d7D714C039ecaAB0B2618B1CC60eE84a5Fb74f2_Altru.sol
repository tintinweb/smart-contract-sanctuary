...
contract Altru is Context, IERC20, Ownable {
    ...
    string private _name = "Altru";
    string private _symbol = "ALTRU";
...
contract Butter is Context, IERC20, Ownable {
    ...
    //Milk stuff
    address private milkAddress = address(0x1c01E7C87EaA5Da5C56483b168270F69863377e9);
