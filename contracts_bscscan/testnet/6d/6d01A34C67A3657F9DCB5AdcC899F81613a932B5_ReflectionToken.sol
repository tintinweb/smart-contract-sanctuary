...
contract ReflectionToken is Context, IERC20, Ownable, AccessControl {
  ...
  constructor(string memory init_name, string memory init_symbol) {
    _name = init_name;
    _symbol = init_symbol;
    _decimals = 8;

    _tTotal = 1000000000 * 10**6 * 10**_decimals;
    _rTotal = (MAX - (MAX % _tTotal));

    _maxTxAmount = 5000000 * 10**6 * 10**_decimals;
    numTokensSellToAddToLiquidity = 500000 * 10**6 * 10**_decimals;
