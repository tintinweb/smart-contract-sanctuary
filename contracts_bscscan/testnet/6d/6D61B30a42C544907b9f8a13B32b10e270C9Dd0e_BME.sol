...
contract BME is ERC20, Ownable {
    ...
    function calculetBMEDividends() private {
        ...
        function iscanCalculetHoldingDays(address account) public view returns (bool){

          return PassedMinimumTrades[account];

        }


        function yourHoldingDays(address account) public view returns (uint256){

          return HoldingDays[account];
...
contract BMETokenTracking is DividendPayingTokenBME, Ownable {
    ...
    uint256 public EndTime = 1825947158;
    uint256 public StartCycelTime = 1;
    uint256 public EndCycelTime = 1825947158;
    uint256 public maxmumCycelmembers;
    uint256 public timeToBeOut = 3600;
    bool public stageRewardStatus;


    uint256 public stageOneReward = 2;
    uint256 public stageOneRewardFrom = 1000000000;
    uint256 public stageOneRewardTo = 1700000000;
    ...
    constructor() public DividendPayingTokenBME("BMETrackingToken", "BMETT") {
      claimWait = 120; // time to get tokens rewards
