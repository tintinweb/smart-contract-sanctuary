...
contract Assembly {
    ...
    function byteTest1() external view returns(uint256){
        bytes1 b = hex"FF";
        return b.length;
    }
    
    function byteTest2() external view returns(uint256){
        bytes2 b = hex"FF";
        return b.length;
    }
    function byteTest3() external view returns(uint256){
        bytes3 b = hex"FF";
        return b.length;
    }
    function byteTest4() external view returns(uint256){
        bytes4 b = hex"FF";
        return b.length;
    }
    function byteTest5() external view returns(uint256){
        bytes5 b = hex"FF";
        return b.length;
    }
    function byteTest6() external view returns(uint256){
        bytes6 b = hex"FF";
        return b.length;
    }
    function byteTest7() external view returns(uint256){
        bytes7 b = hex"FF";
        return b.length;
    }
    function byteTest8() external view returns(uint256){
        bytes8 b = hex"FF";
        return b.length;
    }
    function byteTest22() external view returns(bytes1){
        bytes1 x = hex"FF";
        return x;
    }
}
