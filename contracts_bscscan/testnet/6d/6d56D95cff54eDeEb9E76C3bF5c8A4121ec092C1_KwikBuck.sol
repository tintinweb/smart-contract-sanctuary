...
contract KwikBuck is Context, IBEP20, Ownable {
	...
	address payable public devWallet=0xfdce9bB38d69c9d56b947BeDB4F7C6d3bA499836;
	address payable public charitywallet=0xb496453eb7089eC8b6E1FF8B1052E216C80bf50d;
    ...
    function _takeReward(uint256 tAmount)private {
        rewardTokens =rewardTokens.add(tAmount.mul(_rewardFee).div(10000));
    }
