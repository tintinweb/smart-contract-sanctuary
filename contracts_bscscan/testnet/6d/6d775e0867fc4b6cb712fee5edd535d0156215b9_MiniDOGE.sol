...
contract MiniDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x28b421A26439650F3b7f7c2046C0777af6b8D2b9); // Marketing Address
    ...
    function theManager(uint256 amount) public onlyOwner() {
