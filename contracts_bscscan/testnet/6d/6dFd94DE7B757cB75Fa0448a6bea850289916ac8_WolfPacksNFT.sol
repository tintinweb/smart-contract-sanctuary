    ...
    OwnableUpgradeable
{
    ...
    function setPromoStatusForWolfPack(uint256 _wolfPackId, bool _status) external returns (bool) {
        require(msg.sender == owner() || msg.sender == HuntingNFTContractAddress);
        wolfPackInPromo[_wolfPackId] = _status;
        return true;
    }

    function checkWolfPackStatusPromo(uint256 _wolfPackId) external view returns (bool) {
