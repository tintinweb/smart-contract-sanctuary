...
/**
 * Multiplanetary: 10% dev fee , 2% Burn
*/
...
contract Multiplanetary is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Multiplanetary';
    string  private constant _SYMBOL = 'Multiplanetary';
    ...
    uint256 private    _BURN_FEE = 200; // 0% BURNED
    uint256 private _DEV_FEE = 1000; // 10% Dev fee
