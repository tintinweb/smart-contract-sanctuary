...
abstract contract Frozen is Context {
    /**
 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Context, Frozen, ERC165, IERC721, IERC721Metadata, AccessControlEnumerable {
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(!getFrozen(), "ERC721: token transfer while frozen");
 ...
 */
contract VelanNft is  ERC721, Ownable {
    ...
    event Mint(address indexed minter,  uint nftID, string uri);
    
    constructor() ERC721("VELA", "VelanNft") {} 
        ...
        returns (uint256)
    {
        ...
        emit Mint(_recipient, _tokenId, _tokenURI);
    ...
    function setBlacklist(address[] memory _accounts, bool _status)
        public
    {
        //require(hasRole(OPERATOR_ROLE, _msgSender()), "VelanNft: must have operator role to set");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal virtual override {
        require(!blacklist[from], "VelanNft: account is in blacklist");
