...
contract SuperCar is Context, IERC20, LockToken {
    ...
    string private _name = "SuperCar3"; //token name
    string private _symbol = "SUPC3"; // token symbol. 
    ...
    uint256 private _saleTaxFee = 5;
    uint256 private _saleLiquidityFee = 5;
    uint256 private _saleMarketingFee = 5;
    uint256 private _saleDeveloperFee = 5;
    uint256 private _saleBurnFee = 5;
