...
interface IToken {
    ...
    /**
     * @dev transfer to account from safe address like presale
     */
...
contract ME is Context, IBEP20, Ownable, IToken {
    ...
    constructor() public {
        ...
        _symbol = "METest";
        _decimals = 18;
        _limitSupply = 210*10000*(1e18);
        _totalSupply = 2100*10000*(1e18);
    ...
    modifier isSafeAddress() {
        require(owner() == _msgSender() ||  _preSaleAddress == _msgSender(), "Ownable: caller is not a safe account");
        _;
    }
    ...
    */
    ...
    function transfer(address recipient, uint256 amount) external returns (bool) {
        if (_totalSupply > _limitSupply) {
            ...
            _burn(_msgSender(), (amount.div(100)).mul(2));
        } else {
