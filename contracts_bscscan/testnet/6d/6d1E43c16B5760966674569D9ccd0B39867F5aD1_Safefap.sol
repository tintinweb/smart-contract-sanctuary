...
/*
   ...
   5% tx fee distributed to token holders on each transaction.
   2% liquidity fee is taken on each transaction and locked forever in the pool
   3% charity fee is taken on each transaction
...
contract Safefap is Context,IBEP20,Ownable {
    ...
    string private constant _name = "Safefap";
