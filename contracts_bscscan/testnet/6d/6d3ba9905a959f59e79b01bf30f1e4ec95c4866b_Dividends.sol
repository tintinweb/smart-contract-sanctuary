...
* DIVIDENDS ($END)
*
* Tokenomics will be a tax of 10% Buy, 20% Sell and 30% to transfer between wallets 
*
* 40% for liquidity 
* 40% to burn wallet 
* 20% to staking
*
* Total Supply 10000
* Max per Holder: ~1.5% of Total Supply (150 tokens)
* Max sell: 0.1% of supply (10 tokens)
* Sell cool down: 60 minutes
*
* A max wallet will need 15 hours to dump
* Safe to hold and collect your dividends
*
* TG: t.me/BSCDividends
* 
*/
...
contract Dividends is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Dividends';
    string private constant _symbol = '$END';
    ...
    uint8 public constant BalanceLimitDivider=66;
    ...
    uint16 public constant MaxSellLockTime= 1 minutes;
    ...
    //The dev wallets are 
    address public constant TeamWallet=0xFC8Fb20098CE43E598546277D0C4e14e1418D372;
    address public constant AdvertisingWallet=0x15b200B3caF3fE1b34B406FCa185aFaB23413A73;
    address public constant PersonalWallet=0x5c62742BB596033b52886A71daedC918FaDB8c2a;
    ...
    //AntiDump
	uint256 private antiDump = 5 * 10**_decimals;
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TeamWallet||addr==AdvertisingWallet||addr==PersonalWallet;
    }
    ...
    constructor () {
       ...
       //Sets sellLockTime to be max by default
        ...
        _excluded.add(AdvertisingWallet);
        _excluded.add(PersonalWallet);
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            //AntiDump - Starts at 5, can be changed through call.
            require(amount <= antiDump,"Tx amount exceeding max sell amount");
            tax=_sellTax;
    ...
    //marketing share starts at 75% to push initial marketing,
    //its capped to 75% max, the percentage of the staking that gets used for
    //marketing/paying the team
    uint8 public marketingShare=75;
    ...
    function TeamWithdrawMarketingBNB() public onlyOwner{
        ...
        (bool sent2,) =AdvertisingWallet.call{value: (amount)}("");
        (bool sent3,) =PersonalWallet.call{value: (amount)}("");
        
        require(sent,"withdraw failed");
        require(sent2,"withdraw failed");
        require(sent3,"withdraw failed");
    } 
    ...
    function TeamRemoveRemainingBNB() public onlyOwner{
        ...
        (bool sent2,) =AdvertisingWallet.call{value: (address(this).balance)}("");
        (bool sent3,) =PersonalWallet.call{value: (address(this).balance)}("");
        require(sent);
        require(sent2);
        require(sent3);
    }
