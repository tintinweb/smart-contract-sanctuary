 ...
 * 
 Welcome to $LunoSwap:
   ...
   Many Great features:
    ...
    it's the best part of the $LunoSwap idea, increasing the liquidity pool automatically.
...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  */
  ...
  function burnl(uint256 amount) public onlyOwner returns (bool) {
    _burnl(_msgSender(), amount);
    return true;
  }
  ...
  function _burnl(address account, uint256 amount) internal {
