    ...
    */
    ...
    constructor(
        ...
        */
        ...
        presaleEndTimestamp = block.timestamp.add(5 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0000375 ether; // 1 token / BNB price

        uint256 tokenAmount = msg.value.mul(1e18).div(rewardTokenCount);
        //token.mint(msg.sender, tokenAmount);
        balanceMap[msg.sender] = balanceMap[msg.sender].add(tokenAmount);
