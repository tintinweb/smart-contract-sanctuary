...
contract BCStakeTest01 is Ownable {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 0.01 ether;
	uint256 constant public INVEST_MAX_AMOUNT = 50 ether;
	uint256 constant public BASE_PERCENT = 200;
	uint256[] public REFERRAL_PERCENTS = [700,500,300,100,50];
	uint256 constant public PROJECT_FEE = 3400; //used for profittable trading for cashflow & long-term growth
	uint256 constant public MARKETING_FEE = 400;
	uint256 constant public DEV_FEE = 200;
	uint256 constant public TOTAL_FEE = 4000;
	uint256 constant public ROI = 40000;
	uint256 constant public TOTAL_DAYS = 201;
	uint256 constant public PERCENTS_DIVIDER = 10000;
	uint256 constant public CUT_RUN = 6000;
	uint256 constant public CUT_RUN_DAYS = 31;
	uint256 constant public ROUND = 2;
	uint256 constant public ROUND_LOCK = 1;
	uint256 constant public WITHDRAW_SEND = 8000;
	uint256 constant public WITHDRAW_RESERVED = 2000;
	...
	function invest(address referrer) public payable {
		...
		require(msg.value >= INVEST_MIN_AMOUNT,"Min amount is 0.01 BNB");
		require(msg.value <= INVEST_MAX_AMOUNT,"Max amount is 50 BNB");
	...
	function claimToken(uint256 amount) public onlyOwner {
		require( block.timestamp >= startDate.add(200 * TIME_STEP),"only after 200 days");
