...
contract MasterChef is Ownable {
    ...
    // The HAKU token max total supply 100M
    uint256 public constant hakuMaxSupply = 10 ** 26;
    ...
    function getMultiplier(uint256 _from, uint256 _to)
        ...
        returns (uint256)
    {
        if (cake.totalSupply() >= hakuMaxSupply) {
            return 0;
        }
    ...
    function updatePool(uint256 _pid) public {
        ...
        // HakuSwap Tokenomics
        // The emission is deducted 95% every month
        // total supply 100M
        // 8% team
        // xHAKU reward 15%
        // Trade mining Rewards 15%
        // ecosystem 19.35%
        // NFT staking reserve 5%
        // IDO 2.65%

        cake.mintFor(ecoaddr, cakeReward.mul(41).div(100));
        cake.mintFor(reserveaddr, cakeReward.mul(11).div(100));
    ...
    function setEcoaddr(address _addr) public {
        require(msg.sender == ecoaddr, "ecoaddr: wut?");
        ecoaddr = _addr;
    }
