...
//(Vesting by divide # of months)
contract USXVESTING is Ownable{
   ...
   address[] vestaddr = [0xC4243595BE664cd162e1b96da4f8B12aB455E29f];
    uint256[] vestamount = [1350000000000];
    uint256[] vestlockMonths = [8];
    mapping(address => vestingBox) private vestingBoxes;

    constructor() {
        token = IERC20(vestaddr[0]);
        distributeTokens();
    }
