...
contract AllocationOfTeam is  Ownable {
  ...
  uint256 public timeUnlock = 1627404600;
  address public tokenNfl = 0xb92202b01A5f54247fDac6c1b3E8Be4Ec4eE0e6F;
  ...
  function transferToken() public onlyOwner {
    require(block.timestamp > timeUnlock, "not claim time");
    uint256 amount = getBalanceToken(tokenNfl);
    IBEP20(tokenNfl).safeTransfer(msg.sender, amount);
