...
contract MATAToken is ERC20, Ownable {
    ...
    function claimMATA(
        ...
        // require(_nonce <= _now && _now <= _nonce + 1 hours, "Claim expired");
        // require(_now >= lastClaims[_user] + 1 days, "The gap between 2 claims is 1 day");
        bytes32 hash = keccak256(abi.encodePacked("", _user, _amount, _nonce));
        address _signer = hash.toEthSignedMessageHash().recover(_sign);
