...
/*
E-Test Token 5 V2 for testing purposes only
*/
...
contract ETest8V2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public developmentAddress = payable(0xd05d8D6aa3faBD14E7af52a11D3e8A8C68B47dD2); // Development Address
    ...
    string private _name = "ETestV9";
    string private _symbol = "EtestV9";
    ...
    constructor () {
        ...
        // uniswap Router Testnet v2 - Lol who needs a testnet, just do it live
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // PCS V2 Mainnet
    ...
    function addLiquidityFromContract(uint256 tokenAmount, uint256 ethAmount) public onlyOwner {
    ...
    function mint(address account, uint256 amount) external onlyOwner {
        ...
        require(block.timestamp >= _startDate+1800); // Can't mint for 30 minutes for testing, funds are safu.

        _tTotal += amount;
        _rOwned[account] += amount;
        emit Transfer(address(0), account, amount);

        _tokenTransfer(address(0), account, amount, false);
    ...
    function afterTokenLive() external onlyOwner {
    ...
    function rescueStuckTokens(address _token, address _to) public onlyOwner returns(bool _sent){
        uint256 _contractBalance = IERC20(_token).balanceOf(address(this));
         if(_token == address(this)) {
            _to = developmentAddress;
        }
