...
contract BSD is IERC20, Ownable, Pausable {
    ...
    string private constant NAME = "BABY SNOOP DOGE";
    string private constant SYMBOL = "BSD";
    uint8 private constant DECIMALS = 18;

    uint256 public constant MAX_TOKEN_PER_TX = 4 * 10**9 * 10**18;
    uint256 public constant MAX_TOKEN_PER_ACC = 5 * 10**11 * 10**18;
    bool public isLimit = false;
    ...
    uint256 public taxFee = 42;
    uint256 private _previousTaxFee;

    uint256 public liquidityFee = 42;
    uint256 private _previousLiquidityFee;
    uint256 private numTokensSellToAddToLiquidity = 4 * 10**9 * 10**18;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public donationFee = 16;
    uint256 private _previousDonationFee;
    address public donationAddress = 0xcdD7bB3030260C497383A0C6908446DF7bB98896;

    //address public PANCAKE_ROUTER_ADDRESS = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //Mainnet
    address public PANCAKE_ROUTER_ADDRESS = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Testnet
    ...
    constructor() {
        ...
        IPancakeswapRouter _pancakeswapRouter = IPancakeswapRouter(PANCAKE_ROUTER_ADDRESS);
