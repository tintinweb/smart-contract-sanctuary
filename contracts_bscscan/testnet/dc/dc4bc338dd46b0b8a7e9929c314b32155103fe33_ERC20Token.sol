...
contract ERC20Token is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, uint256  totalSupply_, uint256 taxFee_, uint256 liquidityFee_, address owner_) Ownable(owner_) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        ...
        // BSC MAINNET PANCAKESWAP ROUTER V1 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F
