...
interface IArtKitchen {
     ...
     */
    function create(string calldata _itemName, string calldata _tokenURI, uint256 _price, string calldata _msg, bytes memory _signature) external returns (uint256);
