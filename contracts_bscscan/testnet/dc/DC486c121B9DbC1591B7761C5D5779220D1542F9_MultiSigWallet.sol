...
contract MultiSigWallet {
    ...
    /**
     * @notice call has been separated into its own function in order to take advantage of the Solidity's code generator to produce a loop that copies tx.data into memory.
     * @param destination Transaction target address.
     * @param value Transaction ether value.
    ...
    /**
     * @notice  array with owner addresses, which confirmed transaction.
     * @param transactionId Transaction ID.
