...
/* This is a copy of DrunkDoge deployed to the BSC TestNet for the purpose of demonstrating DogWalker.

   The Uniswap Router it uses is connected to this testnet pancakeswap instances, which you can use for testing:
