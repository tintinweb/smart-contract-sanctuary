...
contract NFT_MARKETPLACE_AGENCY is Ownable, IERC721Receiver, Interface_NFT_MARKETPLACE_AGENCY {
    ...
    */
    ...
    // $quote[nft_address][serial_no][committer_address] => quote
    mapping(address => mapping(uint256 => mapping(address => NFT_Price))) private $quote;
    mapping(address => mapping(uint256 => mapping(address => string))) private $quote_note;
    ...
    */
    ...
    function getQuote(address erc721_address, uint256 serial_no, address committer)
        ...
        returns (NFT_Price memory)
    {
        return $quote[erc721_address][serial_no][committer];
    }
    ...
    function getQuoteNote(address erc721_address, uint256 serial_no, address committer)
        ...
        returns (string memory)
    {
        return $quote_note[erc721_address][serial_no][committer];
    }
        ...
        public
    {
        ...
        $quote[erc721_address][serial_no][committer] = quote;

        $quote_note[erc721_address][serial_no][committer] = note;
