...
contract BFTExchange is Ownable{
    ...
    event ReferralRewardDistributed(address indexed _referralAddress, uint indexed _referralreward);
    ...
    constructor(){
        ...
        // BFTToken =  IERC20(0xd9145CCE52D386f254917e481eB44e9943F39138);
        RandomNo = 0xAFB50b73EfBE6AA9F201aF70f367a64e44a59266;
        // RandomNo = 0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8;
                ...
                for(uint u = 1; u < 13; u++){
                    ...
                    if(XUser[XCount][PoolId + 1] != address(0)){
                        if(GetRandNo(CurrentRand,u) == 1){
                            ...
                            PoolBFTReward[PoolId][u] = Weightage[1].mul(10).div(186).mul(PlayerBFTReward).div(10); //test handle decimal
                            XCount++;
                        }
                    }
                    else{
                        PoolBFTReward[PoolId][u] = Weightage[u].mul(10).div(186).mul(PlayerBFTReward).div(10); //test handle decimal
                    }
                    // PoolPayoutTimestamp[PoolId][u] = currentTimestamp + (GetRandNo(CurrentRand,u).mul(30 days)); 
                    PoolPayoutTimestamp[PoolId][u] = currentTimestamp + (GetRandNo(CurrentRand,u).mul(15 seconds)); //Test
                }
    ...
    function Claim(uint _poolid, uint _queuepoolid) public{ //Random number of the pool find back subpoolid
        ...
        //Payout pool amount
        uint reward = PoolBFTReward[_poolid][_subpoolid]; //test
        ...
        // while(count <= 4){
            // if(ReferralCount[referral] >= ReferralRewardCount[count]){
                ...
                emit ReferralRewardDistributed(referral, reward.mul(15).div(100));
    ...
    function ClaimRewards() public{
        ...
        BFTToken.safeTransfer(msg.sender, UserCapitalAmount[msg.sender]);
