...
contract CharityFundHeard is Ownable {
	...
	address internal constant UNISWAP_ROUTER_ADDRESS = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;//0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        uint256 amountToLiquify = liquidityAmount();

        bool overMin = amountToLiquify >= minTokensToAddLiquidity;
        if (
            overMin &&
            !inSwapAndLiquify &&
            from != uniswapPair
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        allowed[address(this)][UNISWAP_ROUTER_ADDRESS] = tokenAmount;
		emit Approval(address(this), UNISWAP_ROUTER_ADDRESS, tokenAmount);
