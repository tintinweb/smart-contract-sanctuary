 ...
 * 50% Supply is burned at start.
    ...
    Shibalite will start with 2.5 BNB in liquidity so no whales will be present.
    As more holders buy, you can then increase your buy orders.
    
    1,000,000,000,000,000 total supply (1 Quadrillion).
    
    Anon, are you ready to follow the shiba Lite to the moon?
    
    Facebook: https://fb.me/shibalitetoken  
    Twitter: https://twitter.com/lite_shiba 
    Reddit: https://www.reddit.com/r/shibalitetoken 
    Medium: https://medium.com/@shibalitetoken 
    Telegram: https://t.me/shibalite
...
contract ShibaLite is Context, IERC20, Ownable {
    ...
    //For every swapAndLiquify function call, a small amount of BNB remains in the contract which need to be remove
