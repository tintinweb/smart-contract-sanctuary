...
contract HowlsCastle is Ownable, ReentrancyGuard {
    ...
    struct PoolInfo {
        ...
        string quoteToken;        // quote token of this Pool
    }
    ...
    function add(uint256 _allocPoint, IBEP20 _lpToken, uint16 _depositFeeBP, uint256 _harvestInterval, string memory _quoteToken, bool _withUpdate) public onlyOwner {
