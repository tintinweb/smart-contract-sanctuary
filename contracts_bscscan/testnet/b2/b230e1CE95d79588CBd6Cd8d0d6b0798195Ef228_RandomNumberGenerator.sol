...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public sparkSwapLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == sparkSwapLottery, "Only SparkSwapLottery");
    ...
    /**
     * @notice Set the address for the SparkSwapLottery
     * @param _sparkSwapLottery: address of the SparkSwap lottery
     */
    function setLotteryAddress(address _sparkSwapLottery) external onlyOwner {
        sparkSwapLottery = _sparkSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ISparkSwapLottery(sparkSwapLottery).viewCurrentLotteryId();
    }
}