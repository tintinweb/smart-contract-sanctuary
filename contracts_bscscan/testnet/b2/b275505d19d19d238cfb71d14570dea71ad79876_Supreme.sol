...
contract DividendDistributor is IDividendDistributor {
    ...
    //IBEP20 ADA = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); //Mainnet
	 IBEP20 ADA = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // TESTNET
...
contract Supreme is IBEP20, Auth {
    using SafeMath for uint256;

    //address ADA = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; // mainet
	IBEP20 ADA = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // TESTNET
    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //mainet
	address WBNB = (0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); // TESTNET
    ...
    string constant _name = "Supreme";
    string constant _symbol = "SPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; //500
	uint256 public _walletMax = _totalSupply / 40; // 2500;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        _balances[sender] = _balances[sender].sub(amount, "Insufficient Balance");
		    ...
		    if(recipient != pair && !isTxLimitExempt[sender] && !isTxLimitExempt[recipient] && restrictWhales)
            require(_balances[address(recipient)] + amount <= _walletMax, "Transfer amount exceeds the _walletMax."); 
