...
contract PIPA is ITRC20, Owend{
    ...
    address private _feeAddress=0x60b90EEf6228fF5462834aaA0a16912e90a4ad01;

    address private _outAddress=0x769AbcD15B508cc5B1E95e7Fb54605053e40a2bd;
    ...
    function output()public onlyOwner{
        ...
        require(block.timestamp.sub(_lastOutputTIme) > 300, "It's not time yet");
