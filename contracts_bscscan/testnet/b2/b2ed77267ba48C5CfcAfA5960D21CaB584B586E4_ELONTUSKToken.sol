...
// File: contracts\libs\FixedBEP20.sol
...
contract FixedBEP20 is Context, IBEP20, Ownable {
    ...
    */
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), 'ELONTUSK: mint to the zero address');
        
        uint256 remainingAmount = _totalSupply.sub(_totalMinted);
        require(remainingAmount != 0, 'ELONTUSK: mint zero amount');
...
// File: contracts\ELONTUSKToken.sol

pragma solidity 0.6.12;


// ELONTUSKToken with Governance.
contract ELONTUSKToken is FixedBEP20('ELONTUSK Token', 'ELONTUSK', 200000000e18) {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "ELONTUSK::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ELONTUSK::delegateBySig: invalid nonce");
        require(now <= expiry, "ELONTUSK::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "ELONTUSK::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "ELONTUSK::_writeCheckpoint: block number exceeds 32 bits");
