...
contract HotCocoa is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!_lockSwap && _transferType != TransferType.Excluded) {
            ...
            if (
                ...
                (uint128 tokenA, uint128 tokenB, ) = IPancakePair(PancakePair)
                    .getReserves();
                ...
                if (
                    ...
                    tokensToBurn = buyTokensAndGetBurn(amount, tokenA, tokenB);
                }
    ...
    function _burn(uint128 amount) private {
        ...
        if (_reflectionSupply >= amount)
             _reflectionSupply -= amount;
