...
abstract contract ERC20Pausable is ERC20, Pausable, BlackList {
    function _beforeTokenTransfer(
        ...
        require(!isBlackListed[_msgSender()], "BlackList: black address now allowed");

        require(!paused(), "ERC20Pausable: token transfer while paused");
    }
}

contract DreamDust is ERC20Pausable {
    constructor(uint256 initialBalance) ERC20("DreamDust", "DD") {
