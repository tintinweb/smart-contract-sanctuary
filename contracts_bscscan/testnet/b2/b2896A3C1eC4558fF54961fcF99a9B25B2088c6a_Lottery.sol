...
contract Lottery is Ownable, Pausable, ReentrancyGuard {
    ...
    function drawWinner(address rewardTokenAdress, uint256 poolId, uint256 reward, uint256 ownerSalt) public onlyOwner {
    ...
    function drawWinnersArray(address token, uint256[] memory poolIds, uint256[] memory rewards, uint256 ownerSalt) external onlyOwner {
