...
contract agaico is Crowdsale, PausableCrowdsale, CappedCrowdsale, CapperRole {
...
constructor (
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        super._preValidatePurchase(beneficiary, weiAmount);
        // solhint-disable-next-line max-line-length
        require(_contributions[beneficiary].add(weiAmount) >= getCap(beneficiary), "AGAPA: Minimum Amount is 1 Agapa");
    }
