...
contract EthToTokenExchangeContract {
  ...
  //  function () payable public {
    ...
    function buyTokens(uint256 numberOfTokens) public payable {
        ...
        require(tokenBalance >= scaledAmount, "Not enough tokens available to sell.");
    ...
    */
      ...
      function ownerTransfer(uint256 trans_amount) public payable {
      payable(owner).transfer(trans_amount);
  }
    ...
    function endSale() external payable {
       ...
       //msg.sender.call.value{thisBalance};
       
        uint256 transferableAmount = address(this).balance;
        
        msg.sender.call{value:transferableAmount}; //works 8.4
        //msg.sender.call.value(transferableAmount).gas(35000)();
        // msg.sender.transfer(owner, tokenContract.balanceOf(address(this)));
        
       
//        owner.transfer(transferableAmount);
        ownerTransfer(transferableAmount);
