...
contract Arbitrage is Ownable {
  ...
  function pancakeCall(
    ...
    _onLendCall(_sender, _amount0, _amount1, _data);
  }
...
/*
    ...
    /*
    if(address(otherToken) != apeWETH && address(otherToken) != pancakeWETH) {
      otherToken.transfer(profitReceiver, amountReceived - amountRequired);

    } else {
      otherToken.transfer(address(this), amountReceived - amountRequired);
      otherToken.approve(amountReceived - amountRequired);
    }*/
  }
