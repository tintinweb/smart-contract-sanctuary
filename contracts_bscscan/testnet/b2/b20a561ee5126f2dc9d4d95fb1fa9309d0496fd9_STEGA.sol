...
interface IERC20 {
     ...
     *
     * Returns a booSTEGA value indicating whether the operation succeeded.
     *
...
contract STEGA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000 * 10**3;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "STEGA";
    string private _symbol = "STG";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50000 * 10**3;
    ...
    function _takeMarketing(uint256 tMarketing) private {
        ...
        if(_isExcluded[marketingAddress])
            _tOwned[marketingAddress] = _tOwned[address(this)].add(tMarketing);
    ...
    function _transfer(
        ...
        //transfer remaining amount, it will take tax, burn, liquidity fee
    ...
    address constant TEAM_ADDRESS = address(0x35283EA107B255f9F4Efe66124Dd9D2323CDCC7c);
