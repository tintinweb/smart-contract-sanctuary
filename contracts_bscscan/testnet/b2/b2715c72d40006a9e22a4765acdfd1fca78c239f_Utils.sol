...
contract SAVETHEBEE is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0x2e788CF84B9d3eE07a3288FA8549cB1D8436dFea;
    ...
    string private _name = "SAVE THE BEE 🐝";
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    // Innovation for protocol by PEGANG Team
