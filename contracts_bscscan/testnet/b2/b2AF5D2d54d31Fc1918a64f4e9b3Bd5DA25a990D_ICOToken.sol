...
contract ICOToken is ERC20 {
    ...
    modifier afterCrowdsale() {
        require(
            block.timestamp > ICOEndTime || msg.sender == crowdsaleAddress,
            "It allow only after crowdsale"
        );
        _;
    }
    ...
    function mint(address _to, uint256 _value) public onlyOwner {
        require(_to != address(0), "Not allow zero address");
        require(_value != 0, "Not allow mint zero value");

        _mint(_to, _value);
    }

    function burn(uint256 _value) public {
        require(_value != 0, "Not allow burn zero value");
