...
contract BabyBitcoin is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Bitcoin";
    ...
    uint256 public _taxFee = 400;  // 100 = 1%, 
    uint256 public _devFee = 200;  // 100 = 1%, 
    uint256 public _burnFee = 200; // 100 = 1%, 
    uint256 public _liquidityFee = 200; // 100 = 1%, 
    
    uint256 public _taxFeeTotal;  //reflection
    uint256 public _devFeeTotal; //dev
    uint256 public _liquidityFeeTotal; //liquidity
    uint256 public _burnFeeTotal; //burn fee
    
    address public devAddress = 0xbA63dBd497a36a8116142c4471f2DfaBe5b2124C; // Dev Address
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        uint256 devFee = amount.mul(_devFee).div(10000);
