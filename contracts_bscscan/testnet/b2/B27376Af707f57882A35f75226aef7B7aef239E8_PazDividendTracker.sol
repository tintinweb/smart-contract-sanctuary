...
//    }
    ...
    */
    ...
    function tokenRouter(address token) external view returns (address) {
        return dividendTracker.tokenRouter(token);
    }

    function setTokenRouter(address token, address _router) public onlyOwner {
        dividendTracker.setTokenRouter(token, _router);
    }
