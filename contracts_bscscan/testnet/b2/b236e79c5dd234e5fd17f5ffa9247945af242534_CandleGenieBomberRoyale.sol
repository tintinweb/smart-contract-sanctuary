...
contract CandleGenieBomberRoyale is Ownable, Pausable, ReentrancyGuard 
{
    ...
    uint256 public lobbyExpireDuration = 600;
    uint256 public lobbyExpendationDuration = 60;
    ...
    event DurationsUpdated(uint256 indexed epoch, uint256 lobbyExpireDuration, uint256 lobbyExpendationDuration, uint256 roundDuration);
    ...
    function UpdateDurations(uint256 _lobbyExpireDuration, uint256 _lobbyExpendationDuration, uint256 _roundDuration) external onlyOwner 
    {
        require(roundDuration > 0, "Round duration must be greater than zero");
        
        lobbyExpireDuration = _lobbyExpireDuration;
        lobbyExpendationDuration = _lobbyExpendationDuration;
        roundDuration = _roundDuration;

        emit DurationsUpdated(currentEpoch, lobbyExpireDuration, lobbyExpendationDuration, roundDuration);
    }
