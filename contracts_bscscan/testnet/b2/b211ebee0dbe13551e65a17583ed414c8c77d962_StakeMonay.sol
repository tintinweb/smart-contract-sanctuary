...
contract StakeMonay is Context, IBEP20, Ownable {
  ...
  constructor() {
    ...
    _addressesExcludedFromFees[msg.sender] = true;
    _addressesExcludedFromFees[address(this)] = true;
    _balances[msg.sender] = 850000000000000000;  
    
    _firstDayDate = block.timestamp;
    emit Transfer(address(0), msg.sender, _totalSupply);
  }

    function initialDistribution (address payable dist1 ,address payable dist2,address payable dist3 ) public onlyOwner() {
    require( _owner == msg.sender,"security guaranteed administrator only");
    _walletStake = dist1;
    _walletMarkting = dist2;
    _DevWallet = dist3;
    _balances[_DevWallet] = 100000000000000000;   
    _balances[_walletMarkting] =  50000000000000000;   
    emit Transfer(address(0), _DevWallet,  100000000000000000);
    emit Transfer(address(0), _walletMarkting,   50000000000000000);
