...
contract StakingMock is Context, ReentrancyGuard, AccessControl {
    ...
    function createEvent(
        ...
        require(_startTime > _blockTimestamp, "Start time must be in future date");
    ...
    function stake(uint256 _stakeEventId, uint256 _amount) external nonReentrant {
        ...
        require(stakeEvent.isActive && stakeEvent.endTime >= _blockTimestamp, "Stake event closed");
        ...
        StakingLib.StakeInfo memory stakeInfo = StakingLib.StakeInfo(_stakeEventId, _blockTimestamp, _amount, false);
    ...
    function _getRewardClaimable(uint256 _stakeEventId) internal view returns (uint256 rewardClaimable) {
        ...
        uint256 stakeDays = (_blockTimestamp - stakeInfo.stakeTime) / 1 days;
    ...
    function withrraw(uint256 _stakeEventId) external nonReentrant {
        ...
        require(!stakeEvent.isActive || stakeEvent.endTime < _blockTimestamp, "It's not time to withdraw yet");
