...
contract PcakeTest is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PoCAKE-TEST";
    ...
    function isTxExempt(address account) public view returns (bool) { return isTxLimitExempt[account]; }
    ...
    function setMaxTx(uint256 numerator, uint256 divisor) external onlyOwner() {
        require(numerator > 0 && divisor > 0 && divisor <= 10000);
