...
contract Cars is ERC20, Ownable {
    ...
    constructor(
        ...
        _mint(address(0x55f856842437aAB72afbddeCF0ca882Bf2ADA952), 20800 * 10**6); // OWNER ADDRESS     - 208,000,000
        _mint(address(0x673eBA8066C49c34b72Fd391F193aad306F3eDf2), 68250 * 10**6); // ADMIN ADDRESS     -  68,250,000
        _mint(address(0x693F9b9E5322Aa510Ca3D3fA51b677D0DA02F121), 16250 * 10**6); // MARKETING ADDRESS -  16,250,000 
        _mint(address(0x6c9c7C8A9088a516B253B918CD5cDE15AE20Ab9f), 32500 * 10**6); // RESERVA ADDRESS   -  32,500,000
