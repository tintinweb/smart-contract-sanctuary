...
contract SUSHIPUMP is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

   
    address payable public marketingAddress =
        payable(0xFab240A36135D929eFd6E10A765c8473736bF60A); // Marketing Address
    ...
    uint256 private _tTotal = 1000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    // DUPA change here name and symbol
    string private _name = "Sushi Pump";
    string private _symbol = "SUSH";
    ...
    constructor() {
        ...
        // DUPA this address is a Pancakeswap router so if you want to use different blockchain/exchange for liquidity change this address
