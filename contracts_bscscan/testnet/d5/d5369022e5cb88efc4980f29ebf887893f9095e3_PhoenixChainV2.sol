...
contract PhoenixChainV2 is ERC20, Ownable {
    ...
    address public marketingWallet = 0x199a3Ae2157EB06d540a77030B1Fe3Af6b1633D2;
    address public RewardsWallet = 0x55eb04B6B77EbEd44bB90f490182C85C27cdA86D;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on sell
                ...
                tokensForBuyBack += fees * sellRewardsFee / sellTotalFees;
            ...
            // on buy
                ...
                tokensForBuyBack += fees * buyRewardsFee / buyTotalFees;
