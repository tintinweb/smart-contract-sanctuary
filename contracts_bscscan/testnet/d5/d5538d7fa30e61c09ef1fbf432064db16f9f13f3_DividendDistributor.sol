...
contract Bananas is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bananas Token";
    string constant _symbol = "BBN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(800); // 0.5%
    ...
    function getBNB(uint256 amount) external onlyOwner{
