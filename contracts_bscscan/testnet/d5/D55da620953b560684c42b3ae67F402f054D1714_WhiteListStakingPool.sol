...
contract WhiteListStakingPool is IWhiteListStakingPool, ReentrancyGuard {
    ...
    function stake(uint256 amount_) external override nonReentrant {
        ...
        emit Staked(msg.sender, amount_, _totalSupply);
    }
    ...
    function withdraw(uint256 amount_) external override nonReentrant {
        ...
        emit Withdrawn(msg.sender, amount_, _totalSupply);
    }
}