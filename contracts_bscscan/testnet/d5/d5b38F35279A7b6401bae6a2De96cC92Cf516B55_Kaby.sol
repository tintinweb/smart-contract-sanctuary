...
contract Kaby is IKaby, ERC721, AcceptedToken, ReentrancyGuard {
    ...
    function claimHero(uint versionId, uint amount, uint skillId) external override payable {
...
interface IKaby {
     ...
     */
    function claimHero(uint versionId, uint amount, uint skillId) external payable;
