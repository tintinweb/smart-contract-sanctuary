...
contract ApeHeroNFT is Ownable, ERC721, ERC721Enumerable {
    ...
    function cData() public view returns (bool, uint, uint, uint, uint, uint, uint, string memory, address) {
        return (_mintingStarted, _decimalBase, _maxSupply, _mintPrice, _reflection, _maxMintPerTx, _marketingMint, _assetsBaseURI, _lotteryWallet);
    }
