...
contract  SafeAmazon is Context, IERC20, Ownable {
    ...
    string private _name = "SafeAmazon";
    string private _symbol = "SAPAY";
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax fee, Marketing fee, liquidity fee
