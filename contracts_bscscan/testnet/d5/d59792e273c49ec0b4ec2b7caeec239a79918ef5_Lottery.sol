...
contract Lottery is Ownable {
    ...
    string[] priceFeeds = ['BNB','BUSD','BTCB','BTC-USD','ETH','USDC','XRP'];
    struct asset {
        string symbol;
        address asset;
    ...
    Stake public stake = Stake(0x16d4Ad727c07F2f07c7d88Bc51Bf3CB17c305504);
    address payable public StakeBNB = 0x16d4Ad727c07F2f07c7d88Bc51Bf3CB17c305504;
    ...
    function buy(uint _seri, uint[] memory _number, uint[] memory _numTicket, uint _assetIndex) public payable{
        ...
        if(_assetIndex == 0) {
            ...
            StakeBNB.transfer(shareStakeAmount);
    ...
    function configAddress(address payable _stake, address payable _purchase, address payable _takeToken, address payable _affiliateAddress, NFT _nft) public onlyOwner {
        StakeBNB = _stake;
        stake = Stake(_stake);
        purchase = _purchase;
