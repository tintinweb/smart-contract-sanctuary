...
/* DISCLAIMER
* WAKANDA TOKEN is a social token utilized by Wakanda Community. 
* WAD does not represent any form of, or registered  security under any law 
* BUT "GOVERNED" by rules of Ethereum Virtual Machine
* Crypto investments are subject to high volatility and market risks.
...
contract WAD {
    ...
    */
    ...
    string public constant name = "Wakanda Token";

    string public constant symbol = "WAD";

    uint8 public constant decimals = 18;

    uint public constant totalSupply = 10000000000e18; // 10 Billion WAD
