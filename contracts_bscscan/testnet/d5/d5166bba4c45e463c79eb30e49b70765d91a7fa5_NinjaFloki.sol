...
contract NinjaFlokiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("NinjaFloki_Dividend_Tracker", "NinjaFloki_Dividend_Tracker") {
        claimWait = 3600;
...
contract NinjaFloki is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NinjaFloki", "NFLOKI") {
        BNBRewardsFee = 4;
        liquidityFee = 4;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 2;
        marketingWallet = payable(0x709DA45269B0cD7F0FCf7BCacA8C8e7cb19e7902);
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "NinjaFloki: Account is already the value of 'excluded'");
