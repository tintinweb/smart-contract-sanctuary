...
abstract contract Tokenomics {
     ...
     */
    uint256 internal constant maxTransactionAmount = (TOTAL_SUPPLY / 500);
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Liquidity, 50, address(this) ); // 4% added to liquidity
        _addFee(FeeType.External, 20, marketingAddress ); // 2% to marketing Address
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    address internal currentPairTokenAddress;
    address internal currentPoolAddress;
    IPancakeV2Router internal currentRouterAnddress;
    ...
    function _setRouterAddress(address router) private {
        ...
        currentPoolAddress = _pair;
        currentPairTokenAddress = _newPancakeRouter.WETH();
        currentRouterAnddress = _newPancakeRouter;
    ...
    */
    ...
    function _updatePoolAndPairToken(
        ...
        require(poolAddress != address(0), "PapyDoge: Pool address is zero.");
        require(
            pairTokenAddress != address(0),
            "PapyDoge: Pair token address is zero."
        );
        require(
            pairTokenAddress != address(this),
            "PapyDoge: Pair token address self address."
        );
        require(
            pairTokenAddress != currentPairTokenAddress,
            "PapyDoge: Pair token address is same as current one."
        );
