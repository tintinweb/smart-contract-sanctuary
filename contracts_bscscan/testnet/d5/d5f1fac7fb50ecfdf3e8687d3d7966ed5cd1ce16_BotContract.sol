...
contract BotContract{
    ...
    function buySell(
        ...
        if (_tokenIn != WBNB){
            ...
            this.sell(_tokenOut, _amountIn, _amountOutMin);
        ...
        int spamCount) external  returns(bool success) {
            ...
            this.sell(_tokenIn, _amountHP, 0);
        ...
        function sell(address _token, uint amountSell, uint amountOutMin) external returns(bool success) {   
