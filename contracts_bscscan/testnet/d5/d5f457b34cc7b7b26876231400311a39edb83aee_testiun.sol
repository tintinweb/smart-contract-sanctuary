...
contract testiun is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8223b47De3312B85d36F9e728b1Ed5afB5f566EA); // Marketing Address
    ...
    string private _name = "testssss";
    string private _symbol = "testssss";
