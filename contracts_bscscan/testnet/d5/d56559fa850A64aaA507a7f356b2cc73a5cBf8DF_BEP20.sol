...
contract CPCCore is BEP20Detailed, BEP20 {
    uint256 private totalTokens;
    address public PVUToken = 0x31471E0791fCdbE82fbF4C44943255e923F1b794;
	 
    constructor() public BEP20Detailed("CryptoPlants Token", "CPC", 18) {  
	...
	/** Used for liquidity works, etc */
	function getBalance() public view returns(uint256) {
        return BEP20.balanceOf(address(this));
    }
	
	function withdrawBalance() external onlyOwner {
        BEP20.transfer(owner(), getBalance());
    }
}