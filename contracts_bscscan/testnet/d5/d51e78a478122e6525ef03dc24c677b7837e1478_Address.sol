...
contract JingleBalls is Context, IERC20, Ownable {
    ...
    string private _name = "Jingle Balls";
    string private _symbol = "JB";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000000000000 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x77a776B59fA9C27c745ef440a1FEFB7C454d552F);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 2 * 10**12 * 10**_decimals;
        _maxBalance = 30 * 10**12 * 10**_decimals;
    ...
    function setMaxBalance(uint256 newMaxBalance) external onlyOwner(){
        // Minimum _maxBalance is 3% of _totalSupply 
        require(newMaxBalance >= _totalSupply.mul(3).div(100));
