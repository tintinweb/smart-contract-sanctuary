...
contract fayrenewexchange is Sale{
    ...
    function saleToken3(address payable from, address payable admin,uint256 tokenId, uint256 amount, address token, uint256 _type, uint256 NOFToken) public payable{
