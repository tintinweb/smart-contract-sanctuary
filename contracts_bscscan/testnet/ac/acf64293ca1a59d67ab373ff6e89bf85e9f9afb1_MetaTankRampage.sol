...
/*
Welcome to $Meta Tank Rampage ($MTR)
Our multi chain dex will launch and tokenomics carefully engineered to benefit holders, will make $MTR the strongest community in crypto !
...
This token create for play to earn game project call Meta Tank: Rampage.
Please read through our website to find out more, or join our telegram and ask any questions you may have.
Telegram: https://t.me/metatankrampage
Website: https://web.io
*/
...
contract MetaTankRampage is Context, IERC20, Ownable {
    ...
    */
    ...
    address private constant marketingWallet    = 0x26D8aFb80449f42bD180ab665fEaA313e9C88581;
    ...
    string private _name    = 'Meta Tank: Rampage';
    string private _symbol  = 'MTR';

    uint256 reflectionFeePercentage = 5;
    uint256 liquidityFeePercentage  = 5;
    uint256 marketingFeePercentage  = 5;
    uint256 burnFeePercentage       = 0;

    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9 * 10**9;

    /*
    #####################################
    END OF TOKEN INFO VARIABLES
    #####################################
    */
