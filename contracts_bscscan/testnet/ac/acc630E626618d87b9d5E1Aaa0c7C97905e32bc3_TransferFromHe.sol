...
contract TransferFromHe {
    using SafeMath for uint;
    using SafeBEP20 for IBEP20;
    IBEP20 public heroesToken;
    address payable receiveFee = payable(0xa6f6346fa66e8138ABB19dbB497cf0a7A36c29fb);
    constructor( address _heroesToken ) {
        heroesToken = IBEP20(_heroesToken); // Token HeroesNFT
	}
    function transferHe(uint256 amount) public {
        heroesToken.safeTransferFrom(address(msg.sender), address(receiveFee), amount);
    }
}
