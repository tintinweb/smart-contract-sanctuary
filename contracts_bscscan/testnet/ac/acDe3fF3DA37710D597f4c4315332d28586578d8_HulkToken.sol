...
contract HulkToken is Context, IERC20, Ownable {
    ...
    string private _name = "HulkToken";
    ...
    uint256 public _vipFee = 3;
    uint256 private _previousVipFee = _vipFee;
    
    uint256 public _dailyFee = 3;
    uint256 private _previousDailyFee = _dailyFee;
    
    uint256 public _weeklyFee = 3;
    uint256 private _previousWeeklyFee = _weeklyFee;
    ...
    address public vipWallet = owner();
    address public deailyWallet = owner();
    address public weeklyWallet = owner();
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(rewardAddress, transferredBalance.div(_liquidityFee).mul(_rewardFee));
