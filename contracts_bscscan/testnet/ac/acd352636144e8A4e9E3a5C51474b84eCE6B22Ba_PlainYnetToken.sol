...
contract PlainYnetToken is BEP20 {
    ...
    IUniswapV2Router02 public ynetRouter;
    // The trading pair
     ...
     */
    constructor() public BEP20("Ynet4", "Ynet4") {
    ...
    function updateYnetRouter(address _router) public onlyOperator {
        ynetRouter = IUniswapV2Router02(_router);
        ynetPair = IUniswapV2Factory(ynetRouter.factory()).getPair(address(this), ynetRouter.WETH());
