...
contract planetpay is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4773a1Ab0bf1893B122306F4f0d5700E6622A16D); //nice
    address payable public charityAddress = payable(0x4773a1Ab0bf1893B122306F4f0d5700E6622A16D); //nice
    ...
    uint256 private _tTotal = 600000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Planet Pay"; //CC
    string private _symbol = "PLA";  //nice
    ...
    uint256 public _maxTxAmount = 9000 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 9000 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 6000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 9000;// 0.01*90 token for 0.01 bnb (set as per requirements)
