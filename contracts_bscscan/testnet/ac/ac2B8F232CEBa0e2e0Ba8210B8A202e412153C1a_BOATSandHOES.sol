...
contract BOATSandHOES is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BOATSandHOES", "BOATS&HOES") {
    ...
    function updateBusdDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newBusdDividendTracker.owner() == address(this), "must be owned by BOATSandHOES");
    ...
    function updateUsdtDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newUsdtDividendTracker.owner() == address(this), "must be owned by BOATSandHOES");
