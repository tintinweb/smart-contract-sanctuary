...
contract UCATS is Context, IERC20, Ownable {
    ...
    address[] private _whilelist;
    bool private _isNeedCheckTransferWhitelist = false;
    ...
    function whitelist() public view onlyOwner() returns (address[] memory) {
      address[] memory ret = new address[](_whilelist.length);
    ...
    function setTaxFeePercent(bool newValue) external onlyOwner() {
