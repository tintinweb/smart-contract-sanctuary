...
contract MChefTestV4 is Context, IERC20, Ownable {
    ...
    address private _monsterChefKitchenFund = 0x64B6275D88D2335ED04Db657da1b8d14cd71FeD7;
    address private _donationWalletAddress = 0x369176e7207e35a23560ee652D57E84D26e0A086;
    address private _monsterChefProjectAddress = 0x03E115E5dD650B98e2d34bC1bEc13e11286486C4;
    address private _serviceWalletAddress = 0x6c433c8e810FC062FE82CceB2A96A5e07ADF9771;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000 * 10**15 * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MChefFinal";
    string private _symbol = "V5";
    uint8 private _decimals = 10;

    uint256 public _taxFee = 3;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _fundOrBurnFee = 3;
    ...
    uint256 public _maxTxAmount = _tTotal * _maxTxPercent / 10**3; //
    uint256 private numTokensSellToAddToLiquidity = _tTotal * _maxTxPercent / 2 * 10**3;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_monsterChefKitchenFund] = true;
        _isExcludedFromFee[_donationWalletAddress] = true;
        _isExcludedFromFee[_monsterChefProjectAddress] = true;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        ...
        _maxTxAmount = _tTotal.mul(_maxTxPercent).div(10**3);
    }
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_monsterChefKitchenFund] = _rOwned[_monsterChefKitchenFund].add(rDev);
        if(_isExcluded[_monsterChefKitchenFund])
            _tOwned[_monsterChefKitchenFund] = _tOwned[_monsterChefKitchenFund].add(tDev);
    }
