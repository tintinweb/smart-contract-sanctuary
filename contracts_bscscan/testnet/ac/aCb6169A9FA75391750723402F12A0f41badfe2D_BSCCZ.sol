...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Binance Smart Chain BOY CZ";
    string public constant TOKEN_SYMBOL = "BSCCZ";
...
contract BSCCZ is Consts, FreezableMintableToken, BurnableToken, Pausable
