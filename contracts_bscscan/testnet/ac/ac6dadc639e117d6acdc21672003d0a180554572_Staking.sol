...
contract Staking is Ownable, Pausable{
    ...
    function update1() public {
        stakeStore[1].stakeTime = block.timestamp;
        stakeStore[1].stakeAmount = 100e18;
        stakeStore[1].stakeType = 1;
    }
    
    function pendingRewards2(uint256 stakeId,uint256 time) public view returns(uint256) {
        uint256 deposit = stakeStore[stakeId].stakeTime - time;
        uint256 stakeTime = (block.timestamp - deposit).mul(1e12).div(stakeDuration[stakeStore[stakeId].stakeType]);
