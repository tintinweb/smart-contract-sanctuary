...
contract Ico is Crowdsale, CappedCrowdsale, TimedCrowdsale, PostDeliveryCrowdsale, AllowanceCrowdsale, CapperRole {
    ...
    uint256 public hardCap = 300 * (10**18);          // 300 BNB
    uint256 public tokenRate = 53333;
     ...
     */
    function setInvestorMaxCap(address beneficiary, uint256 cap) external onlyCapper {
     ...
     */
    function getInvestorMaxCap(address beneficiary) public view returns (uint256) {
    ...
    function changeHardCap(uint256 value) public onlyCapper {
        hardCap = value;
    }
