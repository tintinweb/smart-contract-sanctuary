...
contract DABotManager is BotManagerSetting {
    ...
    function addTemplate(address template) public onlyOwner {
        ...
        IDABot botTemplate = IDABot(template);

        emit TemplateRegistered(template, botTemplate.botSymbol(), botTemplate.botType()); 
    }
    ...
    params:
        ...
        `setting`   : various settings of the bot. See {DABotCommon.sol\DABot.BotSetting}
     */
