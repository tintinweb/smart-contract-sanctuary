...
contract Staking is Ownable, ReentrancyGuard {
    ...
    function harvest() external nonReentrant {
        ...
        IERC20(stakeToken).transferFrom(hotWallet, msg.sender, unlockedTokens.mul(apy.div(100)).mul((daysStaked.div(noOfDaysYear))));
        
        _isFullyClaimed();
        
        emit StakeHarvest(msg.sender, block.timestamp, unlockedTokens);
        emit RewardHarvest(msg.sender, block.timestamp, unlockedTokens.mul(apy.div(100)).mul((daysStaked.div(noOfDaysYear))));
    }
