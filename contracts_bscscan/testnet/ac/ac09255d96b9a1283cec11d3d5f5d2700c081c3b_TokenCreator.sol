...
contract TokenCreator {
    ...
    event tokenCreatorResult(address _XContract);
	...
	uint256 _initialAmount
       ...
       returns (bool)
    {
        address _Tokencreator = address(createToken(_tokenName, _tokenSymbol, _decimalUnits, _initialAmount, msg.sender));
    ...
    {
        return new TokenERC20(_tokenName, _tokenSymbol, _decimalUnits, _initialAmount, _Xcreator);
    }
}