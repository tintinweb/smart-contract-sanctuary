...
contract COIN is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // Max TX in tokens
    uint256 public _maxSellTxAmount = 1 * 10**9;
    uint256 public _maxBuyTxAmount = 2 * 10**9;
    ...
    function getAllBuyFees() public view returns (uint256, uint256, uint256, uint256){
        return (liquidityFeeBuy, burnFeeBuy,  rewardFeeBuy, devFeeBuy);
    }

    // Get all the sell fees
    function getAllSellFees() public view returns (uint256, uint256, uint256, uint256){
