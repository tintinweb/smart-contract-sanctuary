...
contract TestEscrow is Context, Ownable, IERC1155Receiver, ERC165 {
    ...
    function getSupply() public view returns (uint256) {
        MyNFT cntr = MyNFT(_mainContract);
        uint256 balance = cntr.balanceOf(address(this), _tokenId);
        return balance;
    }
    ...
    function withdraw(uint256 _amount) public onlyOwner  {
        MyNFT cntr = MyNFT(_mainContract);
        cntr.safeTransferFrom(msg.sender, address(this), _tokenId, _amount, bytes(""));
    }
...
/*
    function withdraw(uint256 _amount) public onlyOwner  {
        ...
        MyNFT cntr = MyNFT(_mainContract);
        cntr.safeTransferFrom(address(this), owner(), _tokenId, _amount, bytes(""));
