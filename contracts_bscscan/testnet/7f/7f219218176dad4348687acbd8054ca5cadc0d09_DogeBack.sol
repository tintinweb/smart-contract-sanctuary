...
contract DogeBack is ERC20, Ownable {
    ...
    uint256 private _totalSup = 100 * (10**18);

    uint256 public maxBuyTranscationAmount = (_totalSup * 3) / 1000;
    ...
    uint256 public maxWalletToken = (_totalSup * 2) / 100; // 2% of total supply
    ...
    constructor() ERC20("DogeBack", "DOGEBACK") {
    	...
    	buyBackWallet = 0xCDe950560e09Af953393e37d8c6e2009841cF37C;
    ...
    receive() external payable {
  	...
  	function setPrivatesaleMode() external onlyOwner {
        setTradingIsEnabled(false);
        dividendRewardsFee = 0;
        marketingFee = 0;
        maxBuyTranscationAmount = (_totalSup * 100) / 100;
        maxWalletToken = (_totalSup * 100) / 100; // 2% of total supply
    }
    
    function setPublicMode() external onlyOwner {
        setTradingIsEnabled(true);
        dividendRewardsFee = 10;
        marketingFee = 5;
        maxBuyTranscationAmount = (_totalSup * 3) / 1000;
        maxWalletToken = (_totalSup * 2) / 100; // 2% of total supply
    }
...
contract DogeBackDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DogeBack_Dividend_Tracker", "DogeBack_Dividend_Tracker") {
    	claimWait = 180;
        minimumTokenBalanceForDividends = 10; //must hold 10000+ tokens
    }
