...
contract NFT_MARKETPLACE_OPERATOR is Ownable {
    ...
    */
        ...
        internal
    {
        ...
        _NFT_Marketplace_Agency.sendERC20(_latest_quote.currency_address, _latest_quote.amount, _price.committer);
        ...
        internal
    {
        ...
        require(msg.sender == _price.committer, "[E:0001,auctionSellCancel]");
