...
///////////*/*.,***,......  .,*****************,.. .......**,*,,(/*/*////////// On ERC-20 5,000,000 RSC coins in total, 26% for the team, marketing, etc.
///////(/*//,,,**,.......,*,,*/((####((((((###((/*,,*,.......,**,,,//*///****// 74% for investors
/////(*//,*,**,.....,*,,*/#%(*.               .,/##(****, .....,*,*,//*(///////
//((/*/*.***,.....,***(#(*.                        ,/#(*,*,. ....,**.,(*/((((// 700.000 RSC for 50 USDT in ETH until 11.28.2021
//(/*(,.,/,.....,*,/##*   *################(/*.       .(#/*,.  ,.../*. #*//////
//(*(,,**,....,***(#*     *######################/.      .      ....**,.(*///// 1,000,000 RSC for 100 USDT in ETH from 12.28.2021 to 03.28.2022
//*(,***,....,**/#/.      *######(,.....,*/#%######*.            ....***,(,(///
///*,,*,....,**/#/.     .*(######(**,       .(######*             ,.../.,*/*(// 2,000,000 for 200 USDT in ETH from 04.28.2022 12.28.2022
//(,***,....,**#(.      .(%########%/        (######*              . .***,(*(//
/*(,**,, ..,**(#*         *#####%/        .,(######/.              . .,/,,(*/// Buy from 2 to 100 RSC - get 5% bonus in RSC
/*/,**,, ..,**((,         *######################(,                , .,/,,///// Buy from 100 to 1000 - get 10% bonus in RSC
/*(***,. ..,,*((,         *##################(*.                   . .,/**(*/// Buy more 1000 RSC - get + 20% bonus in RSC
//(,***,....,*/#/.        *#####%/ *#######*.                      . .,**,(*(//
///****,....,**((*        *#####%(   *#######(.                   ....*,/,(*(// Send Eth to the address of the contract and you will receive RSC to your address within 30 seconds.
//*(,***,....,**((*       *#####%(     ,(######(,                ....***.(*((
/////,,**.....,*,/#/.     *#####%(       ,(#######*.            .. .,*,,///((// We are using AI NutCracker (Stock robot) to buy MOEX (Moscow Exchange) shares (moex.com).
//(/*/,,**,.....,**(#/.   .******,         .********.  ,//.    ....**,,//*(((// Our aim is to buy 25% of the shares of MOEX in order to obtain a blocking stake.
//%%(*(,.*/,......***/#(,                           .*(/***, ....,/*..(*/#%%%
...
contract RusCoin is ERC20, Ownable, ERC20Burnable, ERC20Permit {
    address public creator = 0x73Dae04c1B01113Cf7f71FFCF56F106F865A7064; // RusCoin Founder
    address public fund = 0x3fB606d75149fBED71aD48B2F62f7F1f2b3E9076; // RusCoin Fund

    uint public gasPrice = 3300; // Gas price
    uint public minBoughtPrice = 0.03030 ether; // min Ether to buy RusCoin
...
//    uint public minimalStakingDays = 100; // minimal staking days

    constructor() ERC20("NovoCoin3", "NSC") ERC20Permit("RusCoin") {
    ...
    // external function to withdraw contract's Ether (for owner or creator only)
    ...
    receive() external payable {
        ...
        require(amount >= minBoughtPrice, 'Not enough Ether for minimal bought');
    ...
    function _sellRusCoin (address from, uint amount) private {
        ...
        // calculate the number of RusCoin equivalent to this Ether amount
        // and round RusCoin's value to 2 decimals
        uint tokens = ((amount * gasPrice / rusCoinPrice / 100000000000000) + 5) / 10000 * 100000;
    ...
    event SellEvent(address from, uint tokens);
}
