...
contract PancakeRouter is IPancakeRouter02 {
    ...
    event AddLiquidity(address _token ,address _sender, address _pair, uint _amount);
    function addLiquidity(
        address tokenA,
        address tokenB,
        uint amountADesired,
        ...
        emit AddLiquidity(tokenA, msg.sender, pair, amountA);
        TransferHelper.safeTransferFrom(tokenB, msg.sender, pair, amountB);
        emit AddLiquidity(tokenB, msg.sender, pair, amountB);
