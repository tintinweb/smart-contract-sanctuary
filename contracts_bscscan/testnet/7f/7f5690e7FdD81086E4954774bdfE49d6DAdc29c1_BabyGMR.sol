...
contract BabyGMR is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 300000000 * 10**18; // 0.3%
    uint256 private minimumTokensBeforeSwap = 2000000 * 10**18; // 0.002%        
    uint256 private buyBackUpperLimit = 100000 * 10**18; // 0,0001%
...
event UpdateUniswapV2Router(address indexed newAddress, address indexed oldAddress);
    ...
    constructor () {
        ...
        // Set initial uniswap router and pair
        ...
        // Exclude owner wallet, this contract, and marketing wallet from fees
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        
        // Set marketing address
        setMarketingAddress(0xf613E85B79BD538d393Ed0269b4eec49b3B2937b);
	...
	function updateUniswapV2Router(address newAddress) public onlyOwner {
		require(newAddress != address(uniswapV2Router), "The router address is identical with the new address");
    ...
    // Needed to receive ETH from uniswapV2Router when swaping
