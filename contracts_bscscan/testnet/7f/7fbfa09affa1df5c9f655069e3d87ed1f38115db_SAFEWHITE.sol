...
contract SAFEWHITE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2C951AE28e5EE7d8edaC3b06Fe85f4752C60181a); // Marketing Address
    ...
    string private _name = "Safe White";
    string private _symbol = "SAFEWHITE";
