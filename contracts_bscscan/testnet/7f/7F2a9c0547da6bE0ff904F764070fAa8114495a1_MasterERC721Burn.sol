...
import "../../token/ERC721/ERC721Burn.sol";
import "./interfaces/IMasterERC721.sol";
import "../../access/ContractOwner.sol";

contract MasterERC721Burn is ContractOwnable, IMasterERC721 {
  ERC721Burn[] private childERC721Burn;
  ...
  function createERC721(
    ...
    ERC721Burn child = new ERC721Burn(
      name,
      symbol,
      tx.origin,
      metadata
    );
    childERC721Burn.push(child);
...
contract ERC721Burn is Ownable, ERC721URIStorage {
  ...
  constructor(
    ...
    if (
      ...
      mintToken(_owner, metadata);
    }
  }

  function mintToken(address owner_, string memory metadataURI)
    public
    returns (uint256)
  {
    require(owner() == tx.origin, "ERC721Mint: caller is not owner");
    _tokenIds.increment();
