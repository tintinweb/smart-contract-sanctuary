...
//ERC20("LFW Start Pools", "LFW-BSCS")
// ERC20("LFW Start Pools", "LFWBNB-BSCS")//2
...
// OwnableUpgradeable,
contract LFWNFTBaseStartPool is
    Ownable,
    ReentrancyGuard,
    ERC20("LFW Start Pools", "LFW-NFT")
{
     ...
     * @param _minStakeForNFT: minimum amount of token have to take to earn NFT
     * @param _blockStakeForNFT: minimum block have to take to earn NFT
     */
    function initialize(
        ERC20 _stakedToken,
