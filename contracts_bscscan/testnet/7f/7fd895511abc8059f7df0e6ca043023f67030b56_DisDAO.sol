...
contract DisDAO is ERC20, EIP712 {
    ...
    address public constant ADDR_DAO =
        0xE450fe0f9DeAad5B1cB8fC691d95Ce1f723e0ced;
    ...
    address public constant ADDR_STAKING =
        0x1fF3A2Bf533ABd1F863B5aE5f601554068A5818F;
    ...
    string public constant APPROVE_MSG =
        "approve(address account, uint256 amount)";
    ...
    constructor(
        ...
        address _signer
    ) ERC20(_name, _symbol) EIP712("DisDAO", "1.0") {
    ...
    function claim(uint256 amount, address ttt)
        public
        view
        virtual
        returns (
        ...
        )
    {
        ...
        bytes32 aaa = keccak256(abi.encode(APPROVE_MSG, ttt, amount));
        bytes memory bbb = abi.encodePacked(
            "\x19Ethereum Signed Message:\n32",
            aaa
        );
        bytes32 ccc = keccak256(bbb);
        return (aaa, bbb, ccc);
    }
