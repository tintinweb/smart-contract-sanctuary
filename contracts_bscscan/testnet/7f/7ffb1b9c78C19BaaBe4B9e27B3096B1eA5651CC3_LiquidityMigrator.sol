...
import "../interfaces/IDMMCallee.sol";
import "../interfaces/IDMMFactoryTotal.sol";
import "../interfaces/IDMMPool.sol";
import "../interfaces/IWETH.sol";
import "../libraries/DMMLibrary.sol";
...
contract ExampleFlashSwap is IDMMCallee {
    ...
    function dmmSwapCall(
        ...
        uint256 amountETH;
        {
            ...
            assert(IDMMFactoryTotal(factory).isPool(token0, token1, msg.sender));
...
import "./IDMMFactory.sol";
import "./IDMMFactoryDelegate.sol";

interface IDMMFactoryTotal is IDMMFactory, IDMMFactoryDelegate {}
