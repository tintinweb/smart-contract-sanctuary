...
contract ShiftToken is Context, IERC20, Ownable {
  ...
  address public royaltyAddress = 0x0b741253a8e4FeE7B524133100f276477F5F6161; 
  ...
  uint256 private  _totalSupply = 2000000 * 10**6 * 10**9;
  ...
  string private _name = "ShiftCoin";
  ...
  function applyExternalTransactionTax(
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        _reserveTokenBalance[account] = _reserveTokenBalance[account].add(amount);
