...
contract WebooToken is Context, Auth, IERC20 {
    ...
    constructor(address _routerAddress) Auth(msg.sender) {
        /** Initialize Wallet or Contract Address */
        routerAddress = _routerAddress;
        marketingAddress = 0xF9a95ebBF4580639c3eEa160177016Be9935794B;
        defaultReferralAddress = 0x0765C017868910fA8fA1139e5368751b325b081B;
        defaultFarmingAddress = 0x8A460FF3F443a34a8D6388945f726Ecb004b5315;
        // rewardAddress = _rewardAddress;

        _approve(address(this), routerAddress, _totalSupply);

        /** Set maximum transaction limit equal to totalSupply */
        maxTradingLimit = _totalSupply;
        maxTransferLimit = _totalSupply;

        /** Exclude owner from fee, txlimit, reward, and can registering referral */
    ...
    function _transfer(
        ...
        /** Transaction has 2 type, basic transfer or trade transfer */
    ...
    /** Check Trading Limit If
    * 1. maxTradingLimit < totalSupply and
    * 2. sender is not router address
    * 3. sender is not pair
    * 4. sender is not farming address
    * */
    ...
    /**
    * Check Transfer Limit If
    * 1. maxTransferLimit < totalSupply and
    * 2. sender is not router address
    * 3. sender is not pair address
    * 4. sender is not farming address
    */
    ...
    /** For Basic Transfer, check if transaction 
     * if inSwap, then transaction is basic or
     * if sender exclude from fee, then basic transfer
     * if tax disable, then basic transfer
     * if recipient is special without fee, then basic transfer
     */
    ...
    function _tradeTransfer(
        ...
        /** SwapforWeth if condition filled */
    ...
    /** Check if transaction need swap for weth if
    * If isAutoSwapBack enable and
    * If sender is not pair (meaning for selling only)
    * If not inSwap prevent for loop
    * If balance for swap greater than treshold
    */
    ...
    */
    function getFee(
        ...
        // 1. is 1% of transaction amount*100/10000
        ...
        // 2. Tax for Weth amount*1300/10000 and transfer to this address waiting for swapping
        ...
        /** Amount left is amount-(totalTax+referral+farming) */
    ...
    function _swapForWeth(uint256 amount, address sender, address recipient) internal swapping {    
        ...
        /** Get estimation amount for swapping */
        ...
        /** Doing swap if amount greater then treshold */
    ...
    /** Transfer weth from token to specific address only from owner */
    ...
    /** Setting Auto Swapback For Weth */
    ...
    /** Grant address for registering referral */
    ...
    /** Set referral relation parent child */
    ...
    /** Removing referral parent child */
    ...
    /** Getting referral address, if not exists, then return defaultReferralAddress */
    ...
    /** Getting Farming address, if not exists, then return defaultFarmingAddress */
    ...
    /** Setting Maximum Trading Limit for Account */
    ...
    /** Setting Maximum Limit for Transfer */
    ...
    /** Setting recipient exclude from fee */
    ...
    /** Setting auto set share for reward for every transaction */
    ...
    /** Setting is Trading Limit and Transfer Limit Enable */
