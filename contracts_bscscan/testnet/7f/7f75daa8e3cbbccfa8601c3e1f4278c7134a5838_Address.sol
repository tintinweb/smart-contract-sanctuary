...
contract RizxCoin is Context, IERC20, Ownable {
    ...
    string private _name = "RizxCoin";      //CHANGE_REQUIRED: name of token
    string private _symbol = "RXC";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
