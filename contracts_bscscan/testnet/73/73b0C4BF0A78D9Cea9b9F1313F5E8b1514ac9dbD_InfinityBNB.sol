...
contract InfinityBNB is Ownable, AccessControl{
  ...
  address payable private slp1;
  address payable private slp2;
  ...
  function setAddresses(address[] memory _wtFees, address[] memory _slipPages) public onlyAdmin {
    wtFees = [
      payable(_wtFees[0]),
      payable(_wtFees[1]),
      payable(_wtFees[2]),
    ...
    slp1 = payable(_slipPages[0]);
    slp2 = payable(_slipPages[1]);
  }
