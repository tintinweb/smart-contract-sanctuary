...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 17;
    ...
    function getUnpaidEarnings(address shareholder) public view returns (uint256 unpaidAmount) {
        ...
        if(shares[shareholder].amount == 0){ return 0; } 
            ...
            uint256 tempdividendsPerShare = dividendsPerShare.mul(dividendsPerShareAccuracyFactor);
                 
             uint256 shareholderTotalDividends = shares[shareholder].amount.mul(tempdividendsPerShare).div(dividendsPerShareAccuracyFactor);
...
contract KojiEarth is IBEP20, Auth {
    ...
    string constant _symbol = "KOJI v1.39";
