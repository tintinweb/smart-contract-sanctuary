...
import "./IPoollotto.sol";
import "./IPoollottoRandomNumberGenerator.sol";

contract PoollottoRandomNumberGenerator is VRFConsumerBase, IPoollottoRandomNumberGenerator, Ownable { 
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPoollotto(pltLottery).viewCurrentLotteryId();
    }
}
...
interface IPoollottoRandomNumberGenerator {
