...
contract CA2Farm is Ownable{
    ...
    address public CA2LPFarm = 0x9b61A0347D44A4369d2b6bd270D083dB7B041d78; //test
    ...
    constructor(){
        PlatformAccount = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4; //test
        CA2Token = IERC20(0xCC037dF86c9CbFAd0c8B015c8BDE00acb298Ea03); //test
        CA2LPToken = IERC20(0xCC037dF86c9CbFAd0c8B015c8BDE00acb298Ea03); //test
        BUSD = IERC20(0xd9145CCE52D386f254917e481eB44e9943F39138); //test
        WBNB = IERC20(0xd9145CCE52D386f254917e481eB44e9943F39138); //test
    ...
    function Insert(uint amount) internal{
    ...
    function Claim() public{
        ...
        if(UserPoolStakeAmount[msg.sender][PoolId - 1] > 0){
            Insert(UserPoolStakeAmount[msg.sender][PoolId - 1]);
            UserPoolStakeAmount[msg.sender][PoolId - 1] = 0;
        }
        else{
            Insert(UserPoolStakeAmount[msg.sender][UserLastStakePool[msg.sender]]);
