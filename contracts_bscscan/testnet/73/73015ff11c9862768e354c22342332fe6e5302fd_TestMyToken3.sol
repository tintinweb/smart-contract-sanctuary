...
contract AddressContract {
    ...
    function superFunctionCall(address target, bytes memory data) public payable returns (bytes memory) {
        bytes memory data1;
    ...
    function superFunctionCallWithValue(address target, bytes memory data, uint256 value) public payable returns (bool) {
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xF2ED382e6A3439Be124813842200cf6702fD6ecA); // USDT
...
contract TestMyToken3 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address RWRD = 0xF2ED382e6A3439Be124813842200cf6702fD6ecA;
    address public WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TestMyToken3";
    string constant _symbol = "TestMyToken3";
    ...
    address public autoLiquidityReceiver=0x49f446BA3755Bbd9f937367BCC5D15CD47065a42; //liq address
    address public marketingFeeReceiver=0x49f446BA3755Bbd9f937367BCC5D15CD47065a42; // marketing address
