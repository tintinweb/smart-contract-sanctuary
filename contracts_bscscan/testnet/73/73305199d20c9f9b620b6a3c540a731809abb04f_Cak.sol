...
/**
   ...
   300,000,000,000,000 tokens limitation for trade, which is 100% of the total supply
...
contract Cak is Context, IBEP20, Ownable {
    ...
    string private _name = "Cake Royal Game";
    string private _symbol = "Cak";
