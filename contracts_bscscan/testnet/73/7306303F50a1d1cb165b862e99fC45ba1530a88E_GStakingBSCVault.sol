...
contract GStakingBSCVault is Pausable, GStakingPermission {
    ...
    function _claim(
        ...
        uint rewardByTier = _pendingReward * _currentTier / MAX_TIER;
        uint lockedAmount = _pendingReward - rewardByTier;
        ...
        emit ClaimReward(msg.sender, _poolId, _pendingReward, rewardByTier);
    }
...
contract GStakingBSCRoles is GStakingRoles {
