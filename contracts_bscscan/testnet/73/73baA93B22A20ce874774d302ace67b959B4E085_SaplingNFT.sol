...
contract SaplingNFT is ERC721Enumerable, AccessControl, Ownable {
    ...
    uint256 public whitelistSalePrice = 8 ether;
   ...
   /**
        ...
        returns (uint256)
    {
        ...
        // console.log("_timestamp %s ", _timestamp);
        // console.log("priceDiff %s ", priceDiff);
        
        // console.log("dutchAuction.startPrice - dutchAuction.reservePrice %s ", dutchAuction.startPrice - dutchAuction.reservePrice);
        if (priceDiff > dutchAuction.startPrice - dutchAuction.reservePrice) {
            // console.log("priceDiff > dutchAuction.startPrice %s ", dutchAuction.reservePrice);
