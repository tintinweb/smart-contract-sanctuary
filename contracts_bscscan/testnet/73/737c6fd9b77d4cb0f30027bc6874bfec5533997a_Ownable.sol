...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = keccak256('0x5adf23AeB1e2c7F9268d4962804A1B92416B0879');  //0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470;
...
contract TestMoon is Context, IERC20, Ownable {
    ...
    address private _charityAddress = 0x0d859d3898548126Da3fbf2d3d9272041765787f;
