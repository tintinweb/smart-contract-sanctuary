...
`----'                                 ---`-'    `---`                         `----'   
 ...
 // Website:    https://flokicoke.com 
 // Telegram:   https://t.me/flokicoke 
...
contract FlokiCoke is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiCoke";
    string private _symbol = "FLOKICOKE";
