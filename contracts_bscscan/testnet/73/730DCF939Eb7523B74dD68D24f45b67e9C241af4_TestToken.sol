...
contract TestToken is Context, IERC20, Ownable {
    ...
    //address payable public marketingAddress = payable(0xc353c0f14b1D5d864Ed9991e9C4C77a00B78D604); // Marketing Address
    
    //JSVM
    address payable public marketingAddress = payable(0x579e7889ee18882ECD32c910340CCE7E032ffC9C); // Marketing Address
...
//     
    ...
    uint256 public _buyBackAmount = 420 * 10**9;
    ...
    function _transfer(
        ...
        */
        ...
        balanceOf(uniswapV2Pair) > 0 && overMinimumTokenBalance){
            contractTokenBalance = minimumTokensBeforeSwap;
            swapTokens(contractTokenBalance);   
        ...
        if (address(this).balance > _buyBackAmount){
            swapTokensForExactETH(_buyBackAmount);
        }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
       ...
       //100 tokens to LP+marketing
       //1 token == 1 bnb,   1:1 LP:marketing,   33token:33bnb, 33bnb marketing
        
        //T2: 0xc353c0f14b1D5d864Ed9991e9C4C77a00B78D604
        //T3+mark: 0x579e7889ee18882ECD32c910340CCE7E032ffC9C
        
        uint256 initialBalance = address(this).balance;
        swapTokensForEth(contractTokenBalance.mul(2).div(3));
        uint256 transferredBalance = address(this).balance.sub(initialBalance);

        transferToAddressETH(marketingAddress, transferredBalance.div(2));
        addLiquidity(contractTokenBalance.div(3), transferredBalance.div(2));
    }
    ...
    function swapTokensForExactETH(uint256 tokenAmount) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
