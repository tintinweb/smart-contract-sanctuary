...
contract StakingContract{
	...
	event FeePayed(address indexed user, uint256 totalAmount);
      ...
      function stakeBlrsTokens(uint256 amount)public returns(bool){
		...
		user.deposits.push(Deposit(amount, amount.mul(1000),0, block.timestamp,block.timestamp,0,0,0,false,block.timestamp));
      ...
      function winthdrawBullBnbTokens(uint256 i)public returns(bool){
       ...
       require(block.timestamp>user.deposits[i].starter.add(firstwithdrawltime)," you cannot withdraw within 30 days of initial investment");
		uint256 totalAmount;
		uint256 dividends;
