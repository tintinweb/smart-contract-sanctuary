...
contract sXSP is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public XSP = IERC20(0xEC94CE7ab51C08b12f3574E7b90205c8Ba3E7515);
    ...
    address public constant XSP_TOKEN_ADDRESS = 0xEC94CE7ab51C08b12f3574E7b90205c8Ba3E7515;
    

    address[4] public SUPPORTED_STAKING_COIN_ADDRESSES = [XSP_TOKEN_ADDRESS];
    uint256[4] public SUPPORTED_STAKING_COIN_WEI_MULTIPLE = [10000000000000000];

    mapping(address => uint256) public supportedStakingCoinWeiMultiple; // token_address -> wei_multiple (because XSP has decimals = 8 only. Need to multiply by 1e16)
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 1) {
            ...
            XSP.safeTransfer(msg.sender, reward);
    ...
    function depositOwnerTokens(uint256 amount) external onlyOwner {
        XSP.transferFrom(msg.sender, address(this), amount);
    ...
    function withdrawOwnerTokens(uint256 amount) external onlyOwner {
        XSP.transfer(msg.sender, amount);
