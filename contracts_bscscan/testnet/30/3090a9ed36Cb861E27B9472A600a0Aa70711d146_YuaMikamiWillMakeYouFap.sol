...
contract YuaMikamiWillMakeYouFap is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Dev = payable(0xEda238E062Fb9D2928734A1c31094671eE4E8a2A); 
    ...
    string private constant _name = "YuaMikakmiWillMakeYouFap"; 
    string private constant _symbol = "YMWMYfap";  
    ...
    uint256 public _FeeMarketing = 0;
