...
contract ASK_v03 is Context, IBEP20, Ownable {
   ...
   //end skizzo
    ...
    function viewMaxBalance() view external returns (string memory) {
        ...
        result = concatenate(result, ", MaxBalance.Mul97.Div100: ");
        result = concatenate(result,uint2str(maxBalance.mul(97).div(100)));
       return result;
    ...
    function _transfer(
        ...
        if (overMinTokenBalance && !inSwaptoBNB && from != uniswapV2Pair && SwaptoBNBEnabled) {
            if (to == uniswapV2Pair) {
               ...
               if (buyBackEnabled && (balanceOf(uniswapV2Pair) > (maxBalance.mul(97)).div(100)  )) {
