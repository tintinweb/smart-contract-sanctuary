...
contract busdavaxmix {
	...
	uint256 public LOTTERY_TICKET_PRICE = 10 * 1e17; /** 10 BUSD **/
	...
	constructor(address ownerAddress, address payable projectAddress, address payable marketingAddress, address payable communityAddress) {
        ...
        plans.push(Plan(200, 30, 10000000000000000000 ether, 0, 0, 0, 0, true)); // 10busd
        plans.push(Plan(40,  70, 10000000000000000000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(60,  65, 10000000000000000000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(80,  60, 10000000000000000000 ether, 0, 0, 0, 0, true));
	}
