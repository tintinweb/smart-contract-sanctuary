...
contract LizardSwapToken is BEP20 {
    ...
    modifier onlyOperator() {
        require(_operator == msg.sender, 'Only operator allowed');
        _;
    }

    modifier antiWhale(address sender, address recipient, uint256 amount) {
        if (_excludedFromAntiWhale[sender] == false && _excludedFromAntiWhale[recipient] == false) {
            require(tradingEnabled == true, "LIZARD::Swap: Cannot transfer at the moment");
        }
        _;
    }

    constructor() BEP20("LizardSwap", "Lizard") public {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override antiWhale(from, to, amount) {
        if (_excludedFromAntiWhale[from] == true && _excludedFromAntiWhale[to] == true) {
            ...
            require(amount == sendAmount + burnAmount, "Lizard::transfer: Burn value invalid");
