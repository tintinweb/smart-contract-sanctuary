...
contract TeamVault is Ownable {
    ...
    constructor( address[4] memory _teamWallet, address _rewardPool, uint _startTime)  {
        teamWalletsList.push(_teamWallet[0]);
        teamWalletsList.push(_teamWallet[1]);
        teamWalletsList.push(_teamWallet[2]);
        teamWalletsList.push(_teamWallet[3]);
        
        teamVault[_teamWallet[0]]._isExist = true;
        teamVault[_teamWallet[1]]._isExist = true;
        teamVault[_teamWallet[2]]._isExist = true;
        teamVault[_teamWallet[3]]._isExist = true;
    ...
    */
    ...
    function updateRewardPool( address _rewardPool) public onlyOwner {
        require(address(_rewardPool) != address(0), "TeamVault :: updateRewardPool : invalid _rewardPool address");
        rewardPool = _rewardPool;
    }
    ...
    function updateTeamBalance() public onlyOwner {
        ...
        teamVault[teamWalletsList[0]]._balances = 15000000000000e18;
        teamVault[teamWalletsList[1]]._balances = 7000000000000e18;
        teamVault[teamWalletsList[2]]._balances = 1000000000000e18;
        teamVault[teamWalletsList[3]]._balances = 250000000000e18;
    ...
    */
    function getReward() public returns (bool) {
        ...
        if(_newBalance > 0){
            ...
            teamVault[teamWalletsList[0]]._pendingReward = teamVault[teamWalletsList[0]]._pendingReward.add((currentSharePerBlock.mul(teamVault[teamWalletsList[0]]._balances).div(1e12)).div(1e18));
            teamVault[teamWalletsList[1]]._pendingReward = teamVault[teamWalletsList[1]]._pendingReward.add((currentSharePerBlock.mul(teamVault[teamWalletsList[1]]._balances).div(1e12)).div(1e18));
            teamVault[teamWalletsList[2]]._pendingReward = teamVault[teamWalletsList[2]]._pendingReward.add((currentSharePerBlock.mul(teamVault[teamWalletsList[2]]._balances).div(1e12)).div(1e18));
            teamVault[teamWalletsList[3]]._pendingReward = teamVault[teamWalletsList[3]]._pendingReward.add((currentSharePerBlock.mul(teamVault[teamWalletsList[3]]._balances).div(1e12)).div(1e18));
        }
    ...
    */
    function claimDXB() public returns (bool) {
        require(address(oldDXB) != address(0), "TeamVault :: claimDXB : oldDXB is not updated");
        ...
        require(teamVault[_msgSender()]._balances > 0, "TeamVault :: claimDXB : no available DXB to claim");
        ...
        if((_msgSender() == teamWalletsList[0]) || (_msgSender() == teamWalletsList[3])) {
            require(oldDXB.balanceOf(_msgSender()) >= teamVault[_msgSender()]._balances, "IAirDrop :: claimDXB : insufficient balance to migrate");
            require(oldDXB.allowance(_msgSender(),address(this)) >= teamVault[_msgSender()]._balances, "IAirDrop :: claimDXB : insufficient allowance to migrate");

            require(oldDXB.transferFrom(_msgSender(), address(this), teamVault[_msgSender()]._balances), "claimDXB : transferFrom old tokens failed");
            oldDXB.burn(teamVault[_msgSender()]._balances);
        }
    ...
    */
    function viewTeamReward( address _teamWallet) public view returns (uint) {
        ...
        uint rewardBNB = (currentSharePerBlock.mul(teamVault[_teamWallet]._balances).div(1e12)).div(1e18);
