...
contract Lottery is Ownable, Initializable {
    ...
    function cancle() external onlyOwner(){
        require((allLotteries[lotteryId].closingTimestamp < block.timestamp)&&(ticketsSold[lotteryId] == 0),'Users bought tickets so you are not able to cancle the lottery!');
