...
library Config {
    ...
    bytes32 constant PROPOSAL_CREATOR_MININUM_SHARE = keccak256('minpower.goverance.config');
...
contract CEXFundManagerModule is DABotModule, IDABotFundManagerModuleEvent {
    ...
    function award(AwardingDetail[] calldata data) external {
...
library DABotSettingLib {
    ...
    function requireSettingChangable(address account) internal view {
        ...
        require(account == voteController, Errors.BSL_CALLER_IS_NOT_VOTE_CONTROLLER);
    }
