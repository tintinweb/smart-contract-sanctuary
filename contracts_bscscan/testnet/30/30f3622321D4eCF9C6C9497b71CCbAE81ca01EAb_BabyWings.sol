...
import "./facades/ERC20.sol";
import "./facades/Ownable.sol";
import "./facades/SafeMath.sol";
import "./facades/Uniswap.sol";

import "./facades/A80DividendTracker.sol";
import "./facades/B20DividendTracker.sol";


contract BabyWings is ERC20, Ownable {
    ...
    // constructor(address payable a80Tracker, address payable b20Tracker) ERC20("BABYWINGS", "BABYWINGS") {
    constructor() ERC20("BABYWINGS", "BABYWINGS") {
        ...
        marketingWallet = 0xec07942F8d70c09f8265ce4FFAFA02962128b9c8;

        //a80DividendToken = 0x0487b824c8261462F88940f97053E65bDb498446; // mainnet WINGS address
        //b20DividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  // mainnet WBNB address
        a80DividendToken = 0x21C02AEc796EFb672a222300f309c340e9b4331b; // testnet WINGS address
        b20DividendToken = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; // testnet WBNB address
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by BabyWings");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by BabyWings");
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("WING80_Dividend_Tracker", "W80_Dividend_Tracker", 0x21C02AEc796EFb672a222300f309c340e9b4331b) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BNB20_Dividend_Tracker", "B20_Dividend_Tracker", 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x25849726fFB602Bd654e70B6A3A3801A1Ef11239;
