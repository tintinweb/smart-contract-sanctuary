...
contract SharkMarketplace is Pausable, Ownable {
    ...
    function setSettlementOfficialNumerator(
        ...
        onlyOwner
    {
        require(burn + invite <= denominator, "SetSettlementOfficialNumerator: sum of numerator must equal denominator");
    ...
    function setSettlementNumerator(
        ...
        onlyOwner
    {
        require(seller <= denominator, "SetSettlementNumerator: sum of numerator must equal denominator");
