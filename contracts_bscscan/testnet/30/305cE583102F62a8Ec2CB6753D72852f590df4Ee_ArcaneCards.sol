...
abstract contract Tokenomics {
     ...
     */
    uint256 public  maxWalletBalance = TOTAL_SUPPLY / 200; // 0.5% of the total supply
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    /** Functions required by IERC20 **/
        ...
        function setmaxTransactionAmount(uint256 value) external onlyManager {
        maxTransactionAmount = value;
        }

        function setmaxWalletBalance(uint256 value) external onlyManager {
