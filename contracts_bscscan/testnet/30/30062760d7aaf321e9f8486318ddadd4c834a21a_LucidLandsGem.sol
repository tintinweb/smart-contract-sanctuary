...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71e86f12FFAD517C766d5b878d4b2a7176e3255b;
...
library Address {
    ...
    contract LucidLandsGem is Context, IERC20, Ownable {
        ...
        address payable private _marketingWalletAddress = payable(0x0534474C7D2E7023196c5d5c769cCEc8FcB239BD);
        address payable private  _devWalletAddress = payable(0xBd25a03B27CD302CD3681bA3274a36F3Aafc84f7);
        address private _contractAddress = address(this);
        string private _name = "LucidLandsGem";
        string private _symbol = "LLG";
        uint256 private _decimals = 18;
        uint256 private _totalsupply = 10**8 * 10**18;
        uint256 private _maxWalletToken = 5000000 * 10**18;
        uint256 private _maxTransaction = 5000000 * 10**18;
        uint256 private _minBuy = 100 * 10**18;
