...
contract Gasoline is Ownable {
    ...
    event MarketEvent(address indexed _user,uint256 orderId,string  currency,uint256 _value,uint256 _price);
    ...
    function sellMarket(string memory currency,uint256 value,uint256 price) external  {
        ...
        emit MarketEvent(msg.sender,orderId,currency,value,price);
    }
    ...
    function redeemMarket(uint256 _orderId, string memory currency) external {
        ...
        emit MarketEvent(msg.sender,_orderId,currency,value,price);
    }
