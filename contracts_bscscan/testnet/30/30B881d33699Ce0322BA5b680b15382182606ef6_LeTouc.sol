...
contract LeTouc is Ownable, IBEP20 {
    uint256 private constant _initialSupply = 10000000000 * 10 ** 9; // 10 billion
    ...
    /*** Balance & Sell Limits ***/
    uint256 private _maxWalletSize = _initialSupply; // No limit
    uint256 private _maxSellSize = _initialSupply;  // No limit
    ...
    /*** Team Wallet ***/
    address public teamWallet = 0xa2f6a6e42A98090706785747A38d727b305B465F;
    ...
    event TeamSetmineToken(address indexed mineToken);
...
///////////////////////////////////////////
    ...
    function teamSetmineToken(address _mineToken) public onlyTeam {
        require(_mineToken != address(this) && _mineToken != _pancakePairAddress);
        mineToken = _mineToken;
        emit TeamSetmineToken(mineToken);
    }
...
///////////////////////////////////////////
    function claimToken() public {
        ...
        require(!_automatedMarketMakers[mineToken] && !_isWithdrawing && amountWei > 0);
        uint256 oldBalance = IBEP20(mineToken).balanceOf(msg.sender);
        _swapBNBForTokens(msg.sender, mineToken, amountWei);
        uint256 newBalance = IBEP20(mineToken).balanceOf(msg.sender) - oldBalance;
