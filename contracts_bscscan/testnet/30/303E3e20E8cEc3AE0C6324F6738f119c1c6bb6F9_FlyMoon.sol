...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _cake, address _wbnb, address _router) {
        CAKE = IBEP20(_cake);
        WBNB = _wbnb;
...
contract FlyMoon is IBEP20, Auth {
    using SafeMath for uint256;
...
//    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(CAKE, WBNB, _dexRouter);
