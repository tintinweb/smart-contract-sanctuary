...
contract BNBApe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BNBApe";
    string constant _symbol = "BAPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 3000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20; // 0.5%
    ...
    function apeSlap(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function apeHand(address adr) external authorized {
