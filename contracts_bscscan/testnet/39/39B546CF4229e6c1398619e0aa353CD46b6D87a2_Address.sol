...
contract FullD is Context, IERC20, Ownable {
    ...
    string private _name = "Full D";
    string private _symbol = "fulld";
    ...
    uint256 public _maxTxAmountBuy = 600000000 * 10**6 * 10**9;
    uint256 public _maxTxAmountSell = 600000000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 40000000 * 10**6 * 10**9; 
    uint256 public buyBackSellLimit = 1 * 10**13;
    string public _message = "Wassup";
    ...
    function recoverTokens(address recipient , uint256 _amount) external onlyOwner(){
        uint256 amount = _amount * 10**_decimals;
         require(balanceOf(address(this)) >= amount,"Not Enough Tokens");
        _transfer(address(this),recipient,amount);
    }
    
    function recoverBNB(address payable recipient , uint256 _amount) external onlyOwner(){
