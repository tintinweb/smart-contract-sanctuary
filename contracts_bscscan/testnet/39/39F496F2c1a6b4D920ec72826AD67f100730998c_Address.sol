...
// File: contracts/protocols/Lucky777.sol

pragma solidity >=0.6.8;
pragma experimental ABIEncoderV2;

contract Lucky777Official is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Lucky777Official";
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    address public reservewallet = 0x697ED7ffFe8303dC28c74dEf5685F450E5A3aA60;
    address public teamwallet = 0xE48aF2dde48238e9Ee959e53d5A3A53cbBfac782;
    address public marketingwallet = 0x720b9877ad430dCa877D4f4f7016b9C7636e829a;
    address public reinvestwallet = 0x1BAAA47C1231e16984dE480b7d345c6c688287E0;
    ...
    function getRewardCycleBlock() public view returns (uint256) {
     ...
     function redeemRewards(uint256 perc) isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own Lucky777Official to claim reward');
