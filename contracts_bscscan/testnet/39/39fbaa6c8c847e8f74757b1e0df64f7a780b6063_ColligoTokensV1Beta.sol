 ...
 * 
 * Liquidity            ?%
 * ----Transfer Tax Allocation - Total 12%
 * Artist               1%
 * Marketing            2%
 * Development          4%
 * Rfi (HolderRewards)  3%
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "ColligoTokensV1B";
    string internal constant SYMBOL = "COTKV1B";
     ...
     */
    /**
     * 0xfbC63C5836E783D889d0BA661b124500180b0c74 --> this is Huy's Address for testing
     * */
    address internal artistAddress = 0x43a3eb84d5629e586418e6537D5098E2Bc13348d;  /** COTK1-artistAddress Test */
    address internal marketingAddress = 0x5E99CC56C9EaA5163d010aeEeF905862B4D2589a; /** COTK1-marketingAddress Test */
    address internal developmentAddress = 0xaF457466acD476179c906E515E6FcdaA780d6792; /** COTK1-developmentAddress */
     ...
     */
    address internal burnAddress = 0x0000000000000000000000000000000602214076;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 10, artistAddress );
        _addFee(FeeType.External, 20, marketingAddress );
        _addFee(FeeType.External, 40, developmentAddress );
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
     ...
     * 
     * Ref from this https://discord.gg/dAmr6eUTpM
     */
...
abstract contract ColligoTokens is BaseRfiToken, Liquifier, Antiwhale {
...
contract ColligoTokensV1Beta is ColligoTokens{

    constructor() ColligoTokens(Env.Testnet){
