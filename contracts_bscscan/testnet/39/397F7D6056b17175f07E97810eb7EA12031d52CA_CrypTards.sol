 ...
 */
  ...
  event NewTeamMintQuantity(uint256 newTeamMintCount);
  event NewTeamMint(uint256 newID, uint256 newTeamMintCount);
 ...
 */
  ...
  function enableWhiteList() public onlyOwner {
    enableWhitesale = true;
    emit MinterStatusWhitelist(enableWhitesale);
  }

  function disableWhiteList() public onlyOwner {
    enableWhitesale = false;
    emit MinterStatusWhitelist(enableWhitesale);
  }
  ...
  function setTeamMintCount(uint256 _number) public onlyOwner {
    ...
    emit NewTeamMintQuantity(teamMintCount);
  }
  ...
  function teamMint(address _address) public onlyOwner {
    ...
    _setTokenURI(tokenCounter, _endOfURI(tokenCounter));
    emit NewTeamMint(tokenCounter, teamMintCount);
    tokenCounter++;
    teamMintCount--;
  }
