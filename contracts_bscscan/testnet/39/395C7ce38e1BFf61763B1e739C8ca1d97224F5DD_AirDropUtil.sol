...
contract GodfatherStorage is SamoyedStorage {
    ...
    function bulkMint(
        ...
        //console.log("tmin: %d , tmax: %d , tcur: %d", tmin, tmax, tcur);
        require(tcur >= tmin, "GodfatherStorage: Cannot Below Min Value");
        require(tcur + (trv * mintQuantity) - 1 <= tmax, "GodfatherStorage: Cannot Exceed Max Value");
        //console.log("tmin: %d , tmax: %d , tcur: %d", tmin, tmax, tcur);
        //console.log("F: %d +  ( %d * %d ) - 1  ", tcur, trv, mintQuantity);
