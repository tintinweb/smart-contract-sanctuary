...
abstract contract Ownable is Context {	
     ...
     */
    constructor () {
        _owner = 0x6875816F7406CeC025297187D7A80322f7d2D73C;
...
//SkizZO MOD
   ...
   EnumerableSet.AddressSet private _isExcludedFromReward; //anche no
    ...
    uint256 private _DEFTaxFee = 1;
    uint256 public _taxFee = _DEFTaxFee;
 
    uint256 private _DEFBNBFee = 1;
...
//dynamic fees
	...
	uint256 private _feeDurationHalf =  60 ;//30 * 24 * 3600;
	uint256 private _feeDurationMax =  120 ;//30 * 24 * 3600;
...
//END SkizZO MOD
    ...
    string private _name = "RWOR.finance (t.me/RugWarOnRugs)";
    ...
    function _transfer(
        ...
        //SkizZO
				//dynamic fees in function transfer
