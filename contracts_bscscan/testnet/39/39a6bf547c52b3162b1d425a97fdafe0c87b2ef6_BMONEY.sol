...
interface IBEP20 {
    ...
    function depositesOf(address account) external view returns (uint256);
...
contract BMONEY is Context, IBEP20, IBEP20Metadata {
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
     ...
     function depositesOf(address account) public view virtual override returns (uint256) {
    ...
    function refundNBurn (address payable recipient) external{
        ...
        require(_deposits[msg.sender]*50 ==_balances[msg.sender]*1e10, "Please check your token balance");
