...
contract CrosschainSmartChefInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
...
contract CrosschainSmartChefFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(CrosschainSmartChefInitializable).creationCode;
        ...
        CrosschainSmartChefInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
