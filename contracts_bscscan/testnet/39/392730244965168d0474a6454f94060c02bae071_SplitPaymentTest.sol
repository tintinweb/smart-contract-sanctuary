...
uint public currentNum;
uint public currentNumy;
...
function splitPaymentBNBValue(uint _amount) payable external {
 currentNum = msg.value;
 currentNumy = _amount;
}
...
/* function splitPaymentApproveToken(address tokenAddress, uint256 tokenAmountToApprove) external {
    IERC20(tokenAddress).approve(address(this), tokenAmountToApprove);
}*/
