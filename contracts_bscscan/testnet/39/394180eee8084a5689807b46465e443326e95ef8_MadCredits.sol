...
contract DividendDistributor is IDividendDistributor {
     ...
     */
    constructor (address _madladsNFT) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = msg.sender;
        BUSD = IBEP20(msg.sender);
        madlads = IERC721Enumerable(_madladsNFT);
    }
...
contract MadCredits is IBEP20, Auth {
    using SafeMath for uint256;

    IERC721Enumerable madlads;
    uint256 public totalMadlads = 0;
    address public madladsNFT = 0x088b2621d7FfD6E1A4ca32b8282fF346a815A599;
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(madladsNFT);
        ...
        // initializeMints();
        madlads = IERC721Enumerable(madladsNFT);
    }
