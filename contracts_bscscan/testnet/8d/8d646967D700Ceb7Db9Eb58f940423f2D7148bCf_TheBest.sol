...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0x0fA9651a0ecC19906843C13c60443300B9d37355);
...
contract TheBest is IBEP20, Auth {
    ...
    uint256 burnFee = 1200;
    uint256 extraFeeOnSell = 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0xeAD468684102da07294006F96376FF78b760C9BD;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if (selling) {
            _totalFee = totalFee.add(extraFeeOnSell).div(1000);
        }
        return _totalFee;
    }
