...
contract DividendDistributor {
    ...
    //IERC20 SIMP = IERC20(0xD0ACCF05878caFe24ff8b3F82F194C62Ed755707); // MainNet SIMP
    IERC20 SIMP = IERC20(0xa78AcaE5c1646D2c9E2Cc0d743fC14ef791f67d8); // Testnet SIMP
    ...
    function deposit() external payable {
        uint256 balanceBefore = SIMP.balanceOf(address(this));
        ...
        uint256 amount = SIMP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SIMP.transfer(shareholder, amount);
...
contract FlokiSimp is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private startingSupply = 69_000_000_000;

    uint8 private _decimals = 9;
    uint256 private _total = startingSupply * (10 ** uint256(_decimals));

    string constant _name = "FlokiSimp";
    string constant _symbol = "FSIMP";

    uint256 public _liquidityFee = 200;
    uint256 public _reflectionFee = 290;
    ...
    uint256 public _reflectionFeeSell = 690;
    ...
    address payable private _marketingWallet = payable(0x26b799d6507f6d44Aa68A8A7E9aEd6a108E196c0);
    ...
    uint256 private antiSniperGasLimit = 20 gwei;
    ...
    constructor (uint256 _snipeBlockAmt) payable {
        ...
        // PinkSale Locker Address (BSC)
        _isExcludedFromFee[0xA188958345E5927E0642E5F31362b4E4F5e064A2] = true;
        isDividendExempt[0xA188958345E5927E0642E5F31362b4E4F5e064A2] = true;
		_liquidityHolders[0xA188958345E5927E0642E5F31362b4E4F5e064A2] = true;
        ...
        if (sniperProtection) {
            ...
            if (!_hasLiqBeenAdded) {
                ...
                if (_liqAddBlock > 0 
                    ...
                    if (block.number - _liqAddBlock < snipeBlockAmt + 3 && tx.gasprice >= antiSniperGasLimit) {
