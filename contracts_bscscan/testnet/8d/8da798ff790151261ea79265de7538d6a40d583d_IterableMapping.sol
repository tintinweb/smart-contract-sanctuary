...
contract BabyTetherDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("BabyTether_Dividend_Tracker", "BabyTether_Dividend_Tracker", 9) {
    	claimWait = 14400;
...
contract BabyTetherToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x14bA8cb960028f3b94Ab5556c23B9F79DA07Ec8D;
    ...
    constructor() public BEP20("BabyTether", "BRAIN", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "BabyTether: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "BabyTether: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
