...
contract test is Context, IERC20, Ownable { 
    ...
    address payable private wallet_team = payable(0x6efeA836E4F969fFf6b3d067d50C326ce6f0c99c);     
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 amountTokensLiquity = contractTokenBalance.div(100).mul(liquidtyFees); // % Liquitys Fees 
        uint256 amountTokensDev = contractTokenBalance.div(100).mul(_devFee); // % devFee 
        uint256 amountswapToBNB = contractTokenBalance.sub(amountTokensLiquity).sub(amountTokensDev); 
        ...
        addLiquidity(amountTokensLiquity, newBalance);
        sendToWallet(amountTokensDev);
        
        emit SwapAndLiquify(amountTokensLiquity, newBalance, amountTokensDev);
    }
    // Manual Swap
