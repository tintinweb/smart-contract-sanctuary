...
contract lk8test is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 88888888 * 10**0 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "newluck";
    string private _symbol = "newluck";
    ...
    address public charityWallet = 0x11a4511FD2a1Ec09cAB25551d6cf6347372797A2;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**0 * 10**9;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount.sub(tFee).sub(tLiquidity).sub(calculateCharityFee(tAmount));
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 currentRate) private view returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount.sub(rFee).sub(rLiquidity).sub(calculateCharityFee(tAmount).mul(currentRate));
