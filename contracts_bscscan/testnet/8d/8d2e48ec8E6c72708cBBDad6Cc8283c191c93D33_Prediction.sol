...
contract Prediction is Ownable, Pausable {
    ...
    /**
     * @dev Allowed delay time when getting price and randomness number in seconds after round expiration.
     */
    ...
    function setFeeAndLotteryRatio(uint256 _feeRatio, uint256 _lotteryRatio) public onlyOwner {
        ...
        require(_feeRatio <= 2e5, "PREDICTION: feeRatio need to be less than 20%");
