...
contract TKDIVI is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 300000000 * (10**decimals());
    uint256 public maxSellTransactionAmount = 100000000000 * (10**decimals());
    uint256 public swapTokensAtAmount = 20000000 * (10**decimals());
    uint256 public _maxWalletToken = 1500000000 * (10**decimals()); // 1.5% of total supply
...

{
  ...
  "libraries": {
    "/Users/fly/Desktop/dev/safeFlight/contracts/buybackTokenNoTxFeesBurnZeroFeeLimitsV9.sol": {
      "IterableMapping": "0x54e30963c437f4E3e2405b35076C51e9D3efE7f8"
    }
  },
  "outputSelection": {
    "*": {
