...
contract Testje is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0x5e2C0592c93cA9B46C71179d3bD0bAda34cDd335); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xD756310C29e6D716469352A1718Ada4f4587fBF2); // Ecosystem Wallet
    address payable private devWallet = payable (0x2c82978254cCf301CE8108EBDd17648fe4aB08E4); // dev Wallet
    ...
    string private _name = "Testje";
    string private _symbol = "TESTJE";
    ...
    uint256 public _buyMarketingFee = 50;   //4%
    uint256 public _buyReflectionFee = 0;

    uint256 public _sellLiquidityFee = 50; //5%
    uint256 public _sellMarketingFee = 50;  //5%
