...
contract Evergreentoken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2F4cDC2cd8e669142CAaD5D2F950B04E1b6c052C); // Marketing Address
    ...
    string private _name = "Dog House Token";
    string private _symbol = "kaiDHT";
    ...
    uint256 private buyBackUpperLimit = 2 * 10**9;
