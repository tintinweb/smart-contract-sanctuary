...
contract FreeLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function claim(uint256 tokenId) public nonReentrant payable {
        ...
        require(!claimed[msg.sender], "Only claim once!");
        require(msg.value >= 0.05 ether, "Must more than 0.05ether!");
        _safeMint(_msgSender(), tokenId);
        claimed[msg.sender] = true;
    }

    function claimFree(uint256 tokenId) public nonReentrant payable {
        require(tokenId >= 8001 && tokenId <= 300000, "Token ID invalid");
        require(!claimed[msg.sender], "Only claim once!");
        _safeMint(_msgSender(), tokenId);
        claimed[msg.sender] = true;
    }
    ...
    constructor() ERC721("Loot on BSC", "FLOOT") Ownable() {}
}
