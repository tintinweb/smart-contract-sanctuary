...
abstract contract PancakeSwap is OwnableUpgradeable {
    ...
    address private constant hammy = 0x565b72163f17849832A692A3c5928cc502f46D69;
...
contract HammyMinter is IHammyMinter, PancakeSwap {
    ...
    IBEP20  private constant HAMMY = IBEP20(0x8a6Bd30cDe3d026D392867685aDa3D5bA6BaDB9a);
    address private constant DEV   = 0xdCEFFb505d5F006E0D2E8e9d2fDBd604D38b8B8b;
    address private constant DEAD  = 0x000000000000000000000000000000000000dEaD;

    IPriceCalculator public constant CALCULATOR = IPriceCalculator(0xe89c0EEEa3dbF0Dc2c1C35B98e21554560a34D04);
    IStakingRewards public constant REWARD_POOL = IStakingRewards(0xF4Fb1eA23A5A4722c659dFA68cEf0bBe6a56479D);
    ...
    function _mint(uint amount, address to) private {
        ...
        uint hammyForDev = amount.mul(15).div(100);
