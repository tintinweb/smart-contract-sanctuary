...
contract Lottery is Ownable, Initializable {
    ...
    uint256 public timesTicket = 100;
    ...
    function buyTickets(
        ...
        ticketsSold[_lotteryId] = ticketsSold[_lotteryId].add(containsNFT[msg.sender] == true? timesTicket.mul(_numberOfTickets).div(100):_numberOfTickets);
        ...
        emit TicketPurchased(
            ...
            totalCost,
            _numberOfTickets,
            containsNFT[msg.sender]? false: true
        );
    }
    ...
    function RempveNFTContainer(address user) external onlyAdmins {
