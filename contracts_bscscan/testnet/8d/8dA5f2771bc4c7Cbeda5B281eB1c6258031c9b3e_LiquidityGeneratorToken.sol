...
contract LiquidityGeneratorToken is IERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize (
       ...
       address owner_ = 0xF962282365431e748735F5Bcc9F74E2A186A7558;
        string memory name_ = "SmartTesting_Alfcontract_03" ;
        string memory symbol_ = "SMTALF03";
        uint256 totalSupply_ = 10000000000000* 10**9;
        address router_ = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // pancakeswap router
        address charityAddress_ = 0xf03DfE8D74beCd0CA669Fea794A9885430cB90C8; // charity wallet addresss
        uint16 taxFeeBps_ = 3; // 3% tax
        uint16 liquidityFeeBps_ = 3; // 3% for liquidity
        uint16 charityFeeBps_ = 4; // 4% for charity
        uint16 maxTxBps_ = 10; // TODO: check this one
