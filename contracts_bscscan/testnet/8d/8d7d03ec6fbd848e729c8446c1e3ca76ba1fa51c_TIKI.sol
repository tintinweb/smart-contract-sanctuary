...
contract TIKI is ERC20, Ownable {
    ...
    uint256 public immutable fixedSaleStartTimestamp = 1626980000; //July 22, 23:52 PST, 2021
    ...
    uint256 public immutable tradingEnabledTimestamp = 1626982000; //June 17, 22:00 UTC, 2021
    ...
    constructor() public ERC20("testTIKI", "TTK") {
        ...
        address _bounceFixedSaleWallet = 0xCB190E5324c383a1FBCaf8eb56d2e43A77892777;
...
contract TIKIDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "TIKI_Dividend_Tracker: claimWait must be updated to between 30 minutes and 24 hours");
