...
4th - charity tax - goes to charity wallet.
*/
...
contract PlatanoPower is Context, BEP20, Ownable {
    ...
    constructor () {
        ...
        marketingAddress = payable(0x4aFdfF9f86F5C519569DB0e358c877BaED97FB53);
        charityAddress = payable(0xCD82A564192A6FA235246595f1d0E2BCcB8c4480);
        ...
        _liquidityFee = buybackFee + marketingFee + charityFee;
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == pancakeswapV2Pair) {
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(charityAddress, transferredBalance.div(_liquidityFee).mul(charityFee));
    ...
    function setWhitelist(address account, bool added) public onlyOwner {
        whitelist[account] = added;
    }
    ...
    function setBuybackFee(uint256 _buybackFee) external onlyOwner() {
        ...
        _liquidityFee = buybackFee.add(marketingFee).add(charityFee);
    }
