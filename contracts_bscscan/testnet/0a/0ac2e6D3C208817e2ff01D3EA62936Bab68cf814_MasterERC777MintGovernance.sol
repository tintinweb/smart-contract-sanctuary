...
import "../../token/ERC777/ERC777MintGovernance.sol";
import "./interfaces/IMasterERC777.sol";
import "../../access/ContractOwner.sol";

contract MasterERC777MintGovernance is ContractOwnable, IMasterERC777 {
  ERC777MintGovernance[] private childERC777MintGovernance;
  ...
  function createERC777(
    ...
    ERC777MintGovernance child = new ERC777MintGovernance(
      name,
      symbol,
      decimal,
    ...
    childERC777MintGovernance.push(child);
