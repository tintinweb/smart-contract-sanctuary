...
contract Swap {
    ...
    address private constant WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
     ...
     //Swap function Eth to token
    function swapE2T(address _tokenIn, address _tokenOut, uint _amountIn, uint _amountOutMin, address _to) external {
        ...
        IPancakeRouter01(PANCAKE_V2_ROUTER).swapExactETHForTokens(_amountOutMin, path, _to, block.timestamp);
