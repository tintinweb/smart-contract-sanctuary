...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x6cd2Bf22B3CeaDfF6B8C226487265d81164396C5); //BUSD
...
contract BabyBall is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private constant ETH = address(0x6cd2Bf22B3CeaDfF6B8C226487265d81164396C5); //BUSD

    uint256 public swapTokensAtAmount = 100 * 10**6 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x61B194AfA085a049AF3861f31506630DE8d39525)); //marketing wallet
    ...
    constructor() ERC20("BabyBall", "BBall") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("BabyBall_Dividend_Tracker", "BabyBall_Dividend_Tracker")
    {
        claimWait = 3600;
