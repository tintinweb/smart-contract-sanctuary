...
contract EggWars is Context, IERC20, Ownable {
    ...
    string private _name = "Egg Wars";
    string private _symbol = "EWars";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000 * 10**5 * 10**_decimals;

    address payable public marketingAddress = payable(0xd11d3F7D2589F13587C15B243FE9f0dB47C349C1);
    ...
    constructor () {
        ...
        _liquidityThreshhold = 30 * 10**5 * 10**_decimals;
        _maxBalanceWallet = 100 * 10**5 * 10**_decimals;
