...
contract HODL2022 is Context, IBEP20, Ownable {
    ...
    uint256 private _burnRateFromFee = 0;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 totalFees = amount * takingFeeRate / 100;
            uint256 takingFees = totalFees;

            if (_burnRateFromFee > 0) {
                uint256 burn_fees = takingFees * _burnRateFromFee / 100;
                takingFees -= burn_fees;
            ...
            _balances[sender] -= takingFees;
            _balances[_marketingAddress] += takingFees;
            emit Transfer(sender, _marketingAddress, takingFees);
    ...
    function setFee(uint256 buyingFee, uint256 sellingFee, uint256 burnRate) public onlyOwner {
        ...
        require(_burnRateFromFee < 100, "2022HODL: burn rate is too high");
        _buyFee = buyingFee;
        _sellFee = sellingFee;
