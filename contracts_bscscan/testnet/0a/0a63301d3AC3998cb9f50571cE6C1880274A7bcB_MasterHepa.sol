...
contract MasterHepa is Ownable, Authorizable, ReentrancyGuard {
    ...
    // Minted tokens percent for dev
    uint256 public mintForDevPercent;
    ...
    constructor(
        ...
        govToken = _govToken;
        devaddr = _devaddr;
        mintForDevPercent = _mintForDevPercent;
    ...
    // Sets mintForDevPercent
    function setMintForDevPercent(uint256 percent) external onlyOwner {
        mintForDevPercent = percent;
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        govToken.mint(devaddr, GovTokenForFarmer.mul(mintForDevPercent).div(100));
