...
contract HungerToken is Context, IERC20, Ownable {
    ...
    address payable private _projectLayer2;
    ...
    constructor() {
        ...
        _projectLayer2 = payable(address(this));
        ...
        onlyOwner
    {
        ...
        _projectLayer2 = payable(layer2Address);
    }
        ...
        if (!_lockSwap) {
            ...
            require(
                charityRate <= 45 ||
                    ...
                    buybackRate <= 45 ||
                    liquidityRate <= 45,
                "All rates must be in the range of 0-45"
            );
    ...
    function __transfer(
        ...
        /// Take Fees
        if (tokenFees > 0) {
            _tokenBalance[_projectLayer2] += tokenFees - reflectionFee;
            emit Transfer(from, _projectLayer2, tokenFees - reflectionFee);
        }
