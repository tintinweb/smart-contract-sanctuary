...
contract TalentCoin is Context, IBEP20, Ownable {
    ...
    string private _name    = "Final Test Contract";
    string private _symbol  = "FECK";
    ...
    uint256 private _reflectionFeeBuy           = 10;
    uint256 private _previousReflectionFeeBuy  = _reflectionFeeBuy;

    uint256 private _externalFeeBuy             = 90;
    ...
    uint256 private _reflectionFeeSell           = 10;
    uint256 private _previousReflectionFeeSell  = _reflectionFeeSell;

    uint256 private _externalFeeSell             = 90;
    ...
    uint256 private _externalTokenMinAmount          = 50000 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmountBuy                  = 100000000000 * 10**_decimals;
    uint256 public _maxTxAmountSell                 = 100000000000 * 10**_decimals;
    uint256 public _numTokensSellToAndTransfer      = 20000 * 10**_decimals;
    uint256 public _maxTokensPerAddress             = 100000000000 * 10**_decimals;
    ...
    function swapAndLiquify(uint256 tokenBalance) private lockTheSwap {
        ...
        if(_externalFeeBuy > 0 || _externalFeeSell > 0)
        {
        ...
        if(_liquidityFeeBuy > 0 || _liquidityFeeSell > 0)
        {
...
contract StakeContract {
    ...
    TalentCoin public token;
    
    address public owner;

    // uint256 _start = 1640649600;  //unixtimestamp 2021.12.28 00:00:00
    ...
    address _ceoAddress = 0x23029006646dfb22F27a20C299144cCB4ea2e9DE;
    
    address[] buyerList;

    constructor (TalentCoin _token){
        owner=msg.sender;
        token = _token;
    }

    function stake(uint256 _amount) public {
        require(_amount > 0, "Stake more than 0 token");
        uint256 amount = _amount.mul(10 ** 9);
