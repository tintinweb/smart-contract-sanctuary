...
//Mainnet Maincontract: 0xF2cC1B41794f33fda2b4b54856532c1998b97340
...
interface IBNBdistributor {
    function startBNBdistribution() external;
    function setBNBdistributionParameters(uint256 _minPeriod, uint256 _minDistribution, uint256 _gas) external;
...
contract BNBdistributor is IBNBdistributor {
    ...
    function startBNBdistribution() external override initialization onlyMain {
    ...
    function migrate(address distributor) external override onlyMain {
        BNBdistributor bnbdistributor = BNBdistributor(distributor);
        require(!bnbdistributor.initialized());
        TOKEN.transfer(distributor, TOKEN.balanceOf(address(this)));
    }

    function setBNBdistributionParameters(uint256 _minPeriod, uint256 _minDistribution, uint256 _gas) external override onlyMain {
