...
contract HapiSimpleContract is Ownable {
    // Address structure
    struct AddressInfo {
        uint8 rank;
        uint32 category;
     ...
     */
    event AddressReported(address indexed account, uint8 rank, uint32 category, address reporterAccount);
     ...
     */
    function reportAddress(address account_, uint8 rank_, uint32 category_) external {
        ...
        emit AddressReported(account_, rank_, category_, _msgSender());
    }
}
