...
contract Roles is Context {
    ...
    function setPayee(address payable _Payee) external onlyPayer onlyMediator{
        _payee = _Payee;


    }

    function viewPayee() public view returns(address){
        return _payee;
    }
    ...
    function viewPayer() public view returns(address){
        return _payer;
    }
...
contract TheCollectiveEscrow is Context, Roles{
    ...
    address payable currentPayee = _payee;
