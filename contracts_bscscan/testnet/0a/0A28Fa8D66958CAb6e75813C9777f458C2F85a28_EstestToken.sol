...
contract EstestToken is ERC20, Ownable {
    ...
    constructor() ERC20("TokenTest", "Test") {
        _mint(msg.sender, 15000000000000*10**decimals());
        _mint(address(this), 85000000000000*10**decimals());
        startSale(block.number, 999999999, 0,100000000*10**decimals(), 2000000000000);
