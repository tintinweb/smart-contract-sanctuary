...
contract TestUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TestUSD";
    string constant _symbol = "TUSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000000 * (10 ** _decimals); // 1%
    uint256 public _maxWallet = 15000000000 * (10 ** _decimals); // 1.5%
    ...
    function checkmaxWallet(address sender, uint256 amount) internal view {
	    require(amount <= _maxWallet || isTxLimitExempt[sender], "Max Wallet Exceeded");
