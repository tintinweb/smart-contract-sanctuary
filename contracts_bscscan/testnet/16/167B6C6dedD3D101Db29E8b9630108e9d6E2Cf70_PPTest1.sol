...
contract PPTest1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x630CDa98Aa4B375Da71c76B2fad1a03B3AdE5382); // Marketing Address
    ...
    string private _name = "PPtest1";
    string private _symbol = "ptest1";
