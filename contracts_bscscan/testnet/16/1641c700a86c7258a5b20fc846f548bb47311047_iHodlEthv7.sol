...
//iHodlEth Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract iHodlEthv7 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'iHodlEthv7';
    string private constant _symbol = 'iHodlEthv7';
    uint8 private constant _decimals = 9;
    uint256 public constant _totalSupply =  100000 * 10**12 * 10**9; //equals 100,000,000,000,000,000

    //BotProtection values
    bool private _botProtection;
    uint8 constant BotMaxTax=10;
    ...
    uint8 public constant MaxTax=40;
    ...
    //TODO: Change to Mainnet
    //address tokenToClaim=0x4DbF253521E8e8080282c964975f3aFB7F87ceCe;//USDT
    //Testnet BUSD
    address tokenToClaim=0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;

    //variables that track balanceLimit and sellLimit,
    //can be updated based on circulating supply and Sell- and BalanceLimitDividers
    uint256 public  balanceLimit = _totalSupply;
    uint256 public  sellLimit = _totalSupply;
    ...
    //calculatePriceImpact - 07/20/2020    
    function calculatePriceImpact(uint256 amount, bool isSell) public view returns(uint256 PriceImpact, uint256 Price){
       ...
       if(!isSell){
        ...
        uint256 _amount = amount*10**11;
        uint amountInWithFee = _amount;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        bool _NothingTriggered;
        bool _IsPITriggered;
        bool _IsPriceDownTriggered;
        bool _IsSellTriggered;
        ...
        if(isSell){
            ...
            (uint256 _PI,uint256 _NowPrice) = calculatePriceImpact(amount,isSell);
             _IsSellTriggered = true;
            if(_NowPrice >= _ATHPrice){
               _ATHPrice = _NowPrice;
            }else{
               PriceGoingDown = true;
            }   
                if(PriceGoingDown && _PI>=1){
                    //If Price Impact greater than 1% and price going down add 20
                    tax = 40;
                    _IsPITriggered = true;
                    _IsPriceDownTriggered =true;
                } else if (_PI>=1){
                    //If Price Impact greater than 1% add 15%
                    tax = 35;
                    _IsPITriggered = true;
                } else if (PriceGoingDown){
                    //If price going down add 10%
                    tax = 30;
                    _IsPriceDownTriggered =true;
                }else{
                    tax = _sellTax;
                    _NothingTriggered =true;
                }
        }else if(isBuy){
    ...
    function getErrorLogs() public view returns(bool _IsPITriggered,bool _IsPriceDownTriggered, bool _IsSellTriggered, bool _NothingTriggered){
        return (_IsPITriggered,_IsPriceDownTriggered,_IsSellTriggered,_NothingTriggered);
    }
