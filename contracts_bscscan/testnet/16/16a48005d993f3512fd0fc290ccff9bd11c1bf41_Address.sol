...
contract ElonziCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Elonzi Coin";
    string private _symbol = "ELONZI";
    ...
    uint256 public _maxTxAmount = 500000 * 10**6 * 10**10;
    uint256 private numTokensSellToAddToLiquidity = 50000 * 10**6 * 10**10;
