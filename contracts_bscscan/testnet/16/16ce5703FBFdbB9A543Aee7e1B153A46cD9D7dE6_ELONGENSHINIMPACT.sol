...
/*
TG: https://t.me/ElonGenshinImpact
Website - https://betadividend.com/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD REWARD
...
contract ELONGENSHINIMPACT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ElonGenshinImpact";
    string constant _symbol = "EGI";
    ...
    uint256 public reward          = 4;
    uint256 public marketingFee    = 4;
    uint256 public devFee          = 1;
    uint256 public totalFee        = marketingFee + reward + buyback + devFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        buybackReceiver = 0xa29b53ef3C2c2e5322a0e30CE6e35ADCD8589905;
        marketingFeeReceiver = 0xa29b53ef3C2c2e5322a0e30CE6e35ADCD8589905;
        devFeeReceiver = 0xa29b53ef3C2c2e5322a0e30CE6e35ADCD8589905;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver  && recipient != buybackReceiver){
    ...
    function setFees(uint256 _buyback, uint256 _reward, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        buyback = _buyback;
        reward = _reward;
        marketingFee = _marketingFee;
        devFee = _devFee;
        totalFee = _buyback.add(_reward).add(_marketingFee).add(_devFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/3, "Fees cannot be more than 33%");
    }

    
    function setFeeReceivers(address _buybackReceiver, address _marketingFeeReceiver, address _devFeeReceiver ) external authorized {
