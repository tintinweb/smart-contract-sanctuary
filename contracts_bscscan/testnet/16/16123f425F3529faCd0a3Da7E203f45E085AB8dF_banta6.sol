...
contract UniswapExample { 
	...
	address private multiDaiKovan = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; 
	...
	pancakeRouter.swapETHForExactTokens{ value: msg.value }(daiAmount, getPathForETHtoDAI(), address(this), deadline);
...
contract banta6 is Context, IBEP20, Ownable, ReentrancyGuard, UniswapExample {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0xd9a784e2E92a29c9610d0a171B00Af35221bD62c;
    
    address payable private currentAddress =  0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    string private _name = "banta6";
    string private _symbol = "banta6";
