...
contract TestToken is IERC20, IERC20Metadata, Ownable {
    ...
    uint256[4] public _saleFees = [10,15,20,25]; // fee percentages for each sale within day

    uint256 public _userFee = 90; // fee for user-to-user transfer

    uint256 public _buyFee = 10; // buy fee

    uint256 public _burnFee = 2; // burn fee
