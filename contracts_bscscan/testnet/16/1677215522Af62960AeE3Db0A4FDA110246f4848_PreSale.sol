...
contract PreSale is Context, Ownable {
    ...
    constructor() public {
        maxMintable = 10000000000000000000000000;
        funding = true;
        exchangeRate = 8500;
        softCap = 100000000000000000000;
        isClosed = false;
        withdrwAddress = 0xB289e155165CdD2100c70eecf74a8C9F077A9b93;
        refererAddress = [0x29028ec042Bf7648d61aBDFa27BF2E6147Fa1C5B, 
        0x73Fa235d88b39d4Bcb1B3459d26268BA767901d6, 
        0x95F38fF1aA62e627dEA8021FD8134D73cF00b2bA,
        0x3869daDD922e68DB7BbDE81Fb920F435A44a9E9E];
    ...
    */
    ...
    function transferToReferers() external onlyOwner {
        uint256 numberOfReferers = refererAddress.length;
        uint256 amount = maxMintable.div(10).div(numberOfReferers);
        
        uint i = 0;
        
        for (i; i < numberOfReferers ; i++){
            totalMinted += amount;
            _balances[refererAddress[i]] = _balances[refererAddress[i]].add(amount);
            Token.transferTo(refererAddress[i], amount);
        }
    ...
    */
    ...
    function setTokenPricePerBNB(uint256 _exchangeRate) public  {
    ...
    function releaseFunds() external onlyOwner {
        ...
        totalMinted = totalMinted.sub(address(this).balance);
    }
