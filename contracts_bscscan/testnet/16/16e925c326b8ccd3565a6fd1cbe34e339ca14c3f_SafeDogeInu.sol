...
pragma solidity ^0.8.0;
contract SafeDogeInu is ERC20, Ownable {
    ...
    constructor() ERC20("SafeDoge Inu", "SDoge INU") {
        _mint(msg.sender, 100000000000*10**decimals());
        _mint(address(this), 100000000000*10**decimals());
        startSale(block.number, 999999999, 0,2500000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,500000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
