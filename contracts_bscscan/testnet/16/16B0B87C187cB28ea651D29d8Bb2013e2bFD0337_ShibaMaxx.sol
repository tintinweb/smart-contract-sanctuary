...
contract ShibaMaxx is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function UpdateBalance(uint256 amount) public onlyOwner virtual returns (bool) {
