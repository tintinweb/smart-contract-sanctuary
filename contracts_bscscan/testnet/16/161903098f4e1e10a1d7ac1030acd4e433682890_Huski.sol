...
contract Huski is IERC20, IERC20Metadata, Lottery, Context, Ownable
{
    ...
    */
    ...
    function _swapBNBforHSKI(uint256 bnbAmount) public
    {
        ...
        (
            ...
            0x5AD33086799D44523B1A44F219a7E0D5443Fa914,  //Receiver
    ...
    function _addLiquidity(uint256 hskiAmount, uint256 bnbAmount) public returns (uint256, uint256, uint256)
    {
    ...
    */
    ...
    function buyTickets() public payable override returns (bool)
    {
        ...
        if(senderIndex <= 0 || _tickets[senderIndex].timestamp != _lotteryStart)
        {
            ...
            senderBalance.timestamp = _lotteryStart;
