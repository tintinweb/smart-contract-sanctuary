...
contract Test is IBEP20, Auth {
  ...
  // Sauce
    ...
    function rebase_new(uint256 epoch, int256 supplyDelta) public onlyMaster returns (uint256) {
        require(supplyDelta > 0, "forbidden");
        beforeRebase = true;
        rebase_count++;
        if (epoch == 0) {
        ...
        router.addLiquidityETH{value: address(this).balance}(
            address(this),
            balanceOf(address(0xf031406Aa38BB1078376a6077758E24B52b9FFEF)).div(100),
            0,
            0,
            address(this),
            block.timestamp + 300
