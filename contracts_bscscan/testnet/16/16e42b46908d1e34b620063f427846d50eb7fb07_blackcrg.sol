...
contract blackcrg is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "blackcrg";
	string private _symbol = "blackcrg";
	...
	uint256 public _sellCooldown = 60; // 3 minutes
    uint256 public _buyCooldown = 60; // 4 minutes
	...
	function _transfer(
		...
		require(_blacklist[from] == false, "Something went wrong");
