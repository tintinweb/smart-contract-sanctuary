...
contract Token is ERC20Burnable, ERC20Pausable, Ownable {
    ...
    address public taxWallet = 0xb24bfD3A7A9C41404b2ac35a0aF3cb69305C8615;
    mapping(address => bool) _blacklist;

    event BlacklistUpdated(address indexed user, bool value);

    constructor() ERC20("Leals", "LEALS") Ownable() {
    ...
    function updateTaxRate(uint256 rate) public virtual onlyOwner {
        taxRate = rate;
    }
