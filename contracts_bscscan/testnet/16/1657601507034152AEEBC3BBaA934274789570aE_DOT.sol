...
// File: contracts/DOT.sol

pragma solidity 0.6.12;


// SakuraToken with Governance.
contract DOT is BEP20("DOT", "DOT") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "SAKURA::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "SAKURA::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "SAKURA::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "SAKURA::_writeCheckpoint: block number exceeds 32 bits"
        );
