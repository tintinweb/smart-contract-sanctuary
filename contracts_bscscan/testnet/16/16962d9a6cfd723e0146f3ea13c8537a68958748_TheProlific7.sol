...
contract TheProlific7 is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x5C1232C335c963a052F86A7949e6369dEacF9AdC;
    address public charityAddress = 0xd6260481A3d19a209376663faed4876f1e91D63a;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if (fundingAmt > 0) {
            _transferStandard(sender, charityAddress, fundingAmt.div(4).mul(3));
        }
