...
contract InfernapeInu is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 9; //(3% liquidityAddition + 2% rewardsDistribution + 4% marketting/dev)
    ...
    constructor () public {
        ...
        wallet = payable(0xC6711aE4e387291463B8617e10289926d90fCa6a);
        rewardsWallet= payable(0x5A193cCDD15F942C4a56859F3f963fe802d8F474);
