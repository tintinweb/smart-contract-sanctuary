...
contract Ownable is Context {
    ...
    address private _owner = 0xd7d265104E0cE79Af34dD6C73787903a8C71d7D6;
...
contract YSL_CAKE is Context, IBEP20, Ownable { // contract name
    ...
    uint256 public _maxTokensPerAddress          = _tTotal.div(1); // Max number of tokens that an address can hold 2% of total supply
