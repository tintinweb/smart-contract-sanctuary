...
interface IERC20 {
  ...
  */
   ...
   * s̴u̷m̴m̴e̵r̵c̷a̶k̸e̸ ̵c̵o̷p̶y̴
   */
...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // See: https://github.com/OpenZeppelin/s*u*m*m*e*r_c_a_k_e/pull/522
        if (a == 0) {
            return 0;
        }
...
contract HujanKoin is IERC20, Ownable {
    ...
    string constant _name = "HujanKoin";
    string constant _symbol = "HUJANKOIN";
    ...
    address payable private _marketingWallet = payable(0xE085C2Ecaf17226CC8AaEe6B7782b0f93b69F736);
    address payable private _withdrawAddress = payable(0xc312c77A4557dff0Bd2c66e767f41fBc4a73BdeD);
    ...
    function setAllowLiquidity(bool value) external onlyOwner() {
        _hasLiqBeenAdded = value;
        _liqAddBlock = block.number;
        _liqAddStamp = block.timestamp;
    ...
    modifier withdrawAddressOnly() {
        require(msg.sender == _withdrawAddress, 'only withdrawer can call this');
        _;
    }
}