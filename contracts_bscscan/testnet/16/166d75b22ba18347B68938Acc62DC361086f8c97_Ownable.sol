...
contract StarGodv1 is STGv1Deployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private STGv1Team;
    address private CharitySTGv1;
    ...
    string public override name = "StarGodv1";
    string public override symbol = "STGv1";
    ...
    constructor(uint totalSupplyValue, address STGv1TeamAddress, address CharitySTGv1Address) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        STGv1Team = STGv1TeamAddress;
        CharitySTGv1 = CharitySTGv1Address;
        
        // split the tokens according to agreed upon percentages
        balances[STGv1Team] =  totalSupply * 45 / 100;
        balances[CharitySTGv1] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's STGv1Team pot
