...
contract BabyLeaf is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Babyleaf";
    string constant _symbol = "BabyLeaf";
    ...
    function checkDividendExempt(address holder) public view returns(bool){
