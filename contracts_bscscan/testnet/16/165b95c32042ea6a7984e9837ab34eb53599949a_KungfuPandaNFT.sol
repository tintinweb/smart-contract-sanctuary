...
contract KungfuPandaNFT is ERC721URIStorage, Ownable {
    ...
    uint256 public box1MaxTimes = 250;
    uint256 public box2MaxTimes = 50;
    uint256 public box3MaxTimes = 20;

    uint256 public box1Price = 1000;
    uint256 public box2Price = 3000;
    uint256 public box3Price = 5000;
    ...
    function openBlindBox(uint256 boxTypes) public returns (uint256[5] memory types){
        ...
        if(boxTypes == 1){
            ...
            BMV.transferFrom(msg.sender, address(this), box1Price * 10 **6);
        ...
        if(boxTypes == 2){
            ...
            BMV.transferFrom(msg.sender, address(this), box2Price * 10 **6);
        ...
        if(boxTypes == 3){
            ...
            BMV.transferFrom(msg.sender, address(this), box3Price * 10 **6);
