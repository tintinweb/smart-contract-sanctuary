 ...
 * ----------------------------------------------------------------------------
 * 
 * Deployed to: 0x66015D10d2A0450d689eAd46E9E89B898E037d84
 * Symbol: AWI
 * Name: ShitCoinTraders
 * Total supply: 1,000,000,000
 * Decimals: 9
 * 
 * Deployed by ShitCoinTraders Ecosystem.
 * 
 * ----------------------------------------------------------------------------
 */
 ...
 */
contract AWI is Context, IBEP20, IBEP20Metadata, Ownable {
    ...
    string private constant _name = "AntiWhaleInu";
    ...
    /**
     * @dev gettotal holders.
     */
     
    function totalHolders() external view virtual returns (uint256){
        return holders;
    }
    ...
    function transfer(address recipient, uint256 amount) external virtual override returns (bool) {
      ...
      //  if(_balances[recipient] - amount == 0) holders++;
        //if(_balances[sender] == 0) holders--;
