...
contract CondomCoin is IBEP20, Auth {
    ...
    string constant _name = "CondomCoin";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100;  //1% max wallet
    ...
    address private marketingFeeReceiver = 0xE723fa9E6734B80a8c728f71e3d13e7c03299323;
    address private teamFeeReceiver = 0xE723fa9E6734B80a8c728f71e3d13e7c03299323;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 18; // 1.8%
    bool inSwap;
