...
contract Funding {
  ...
  function fund(string memory name_, uint256 amount_) public payable {
    ...
    _funds[name_][msg.sender]             = amount_;
    emit EAction("Fund", name_, name_, msg.sender, amount_, _budget[name_], _pPro[name_].budget);
  }
