...
contract MarketplaceBnb is Ownable, HasSignature {
    ...
    function matchTransaction(
        ...
        require(
         ...
         require(
            values[2].add(period) > block.timestamp && values[2] < block.timestamp,
        ...
        // );
        require(msg.value == values[1],"Please deposit more BNB");
        ...
        //     payToSellerAmount
        // );
        // address payable seller = addresses[0];
        ...
        require(!list.getTokenId(values[0]), "TokenId in blacklist");
