...
contract SnowTime is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xD52389Bc32247eCA808288aDbAC4F2C8b10A46B5); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xD52389Bc32247eCA808288aDbAC4F2C8b10A46B5); // Ecosystem Wallet
    address payable private devWallet = payable (0x6aBE11b4c153aab50b28c4CE235F73ffB07C0347); // dev Wallet
    ...
    string private _name = "SnowTime";
    string private _symbol = "SNOWTime";
