    ...
    PausableUpgradeable
{
    ...
    CryptiaNFT private _cryptiaNFTContract;
    ...
    function sellNFT(
        ...
        require(msg.sender == _cryptiaNFTContract.ownerOf(tokenId));
        require(_informationOf[tokenId].price == 0 && price > 0);
        require(_cryptiaNFTContract.getApproved(tokenId) == address(this));
        ...
        whenNotPaused
    {
        require(address(this) == _cryptiaNFTContract.ownerOf(tokenId));
        require(msg.sender == _informationOf[tokenId].seller);
        require(_informationOf[tokenId].price > 0 && newPrice > 0);
        _informationOf[tokenId] = Information(
