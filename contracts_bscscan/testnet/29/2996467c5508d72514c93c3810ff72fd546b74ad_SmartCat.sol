...
contract SmartCat is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Smart Cat";
     ...
     * construction.
     */
    constructor(address fundPoolAddress) {
        _fundPoolAddress = fundPoolAddress;
        _mint(msg.sender, 10 * 10**15 * 10**6);
