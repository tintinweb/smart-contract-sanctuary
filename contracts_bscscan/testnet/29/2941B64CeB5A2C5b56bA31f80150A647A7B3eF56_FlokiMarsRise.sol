...
contract FlokiMarsRise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiMarsRise";
    string private _symbol = "FLMR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0265C89B75406D69dd74b378e7f80BF12C81144b); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xa0b4c54A016B440D1f4d3E2CB661B7f749bE3157); // buyback Address
