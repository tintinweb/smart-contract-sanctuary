...
contract mybiToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 82000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "My Bingo v3";
    ...
    uint256 public numTokensSellToAddToLiquidity = 82000000 * 10**9;
