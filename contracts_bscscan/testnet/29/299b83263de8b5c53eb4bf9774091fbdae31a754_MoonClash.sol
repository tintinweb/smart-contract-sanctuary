...
contract MoonClash is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB387515486d9f17C80bB8F6467dF2B75a6eE5d97); // Marketing Address
    ...
    string private _name = "MoonClash";
    string private _symbol = "MCLASH";
