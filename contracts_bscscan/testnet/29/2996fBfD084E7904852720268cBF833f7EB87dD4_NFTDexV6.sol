...
interface IERC20 {
  ...
  function getSellDetail(uint256 tokenId) external view returns (address, uint256, uint256, address, uint256, uint256, uint256);
    ...
    function transferAlia(uint256 price, uint256 tokenId, uint256[3] calldata percentages,  address[5] calldata addresses, string calldata ownerId, bytes4 referralCode  ) external returns(bool);
   ...
   function placeBid(uint256 _tokenId, uint256 _amount, bool awardType, address from)  external;
    ...
    function getReffererDetails(uint256 tokenId, bytes4 referralCode) external view returns(address,string memory, bool, uint256);
    function referralUsed(uint256 _tokenId, bytes4 referralCode) external;
}
...
function placeBid(uint256 _tokenId, uint256 _amount, bool awardType, address from)  public{
  ...
  require(msg.sender == 0x0160b796792D38B98cd19f718F8dF6c143E5c529);
  _;
  }
