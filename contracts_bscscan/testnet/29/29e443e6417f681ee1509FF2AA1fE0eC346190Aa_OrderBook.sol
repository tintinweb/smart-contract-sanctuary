...
contract OrderBook {
    ...
    bytes32 public immutable DOMAIN_SEPARATOR_test;
    ...
    constructor() public {
        ...
        DOMAIN_SEPARATOR_test = keccak256(abi.encode(
    ...
    function recoverOrder2(Orders.Order memory order)
        public
        view
        returns (address)
    {
    ...
    function recoverOrder3(Orders.Order memory order)
        public
        view
        returns (address)
    {
