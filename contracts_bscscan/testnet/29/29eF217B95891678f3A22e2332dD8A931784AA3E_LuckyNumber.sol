...
contract LuckyNumber {
    ...
    function setGameSetting(uint256 _amount)public ownerOnly{
        buyGameCont = _amount;
         makeNumber();
    }
    ...
    function startGame() external {
        gameTokenAddress.transferFrom(
            address(msg.sender),
            address(this),buyGameCont.mul(gameTokenDecimal)
        );
    ...
    function _makeRate() private {
        ...
        //                 ((7 - _rateAll) - ((_luckyGame.luckyMan - i) * 2)) - 1,
        //                 i
        //             ).add(2);
