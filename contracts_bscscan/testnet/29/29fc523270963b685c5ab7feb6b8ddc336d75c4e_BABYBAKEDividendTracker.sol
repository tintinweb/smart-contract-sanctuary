...
contract GamesRewards is ERC20, Ownable {
    ...
    address public PANCAKESWAP_ROUTER = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    uint256 public maxSellTransactionAmount = totalSupply().mul(5).div(1000); // 0.5 % max sell
