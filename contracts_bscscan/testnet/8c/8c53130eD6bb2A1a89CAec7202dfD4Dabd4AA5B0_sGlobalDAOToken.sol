...
contract sGlobalDAOToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked GlobalDAO", "sGLBD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGlobalDAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sGlobalDAO
