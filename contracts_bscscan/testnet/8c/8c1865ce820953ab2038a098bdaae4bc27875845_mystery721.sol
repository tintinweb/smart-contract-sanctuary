...
contract mystery721 is ERC721Full, Ownable, IERC721Receiver {
    using SafeMath for uint256;
    
    
    string public tokenURIPrefix = "http://47.100.13.133:18881/wapi/mysteryboxes/";
    ...
    function setMysteryIndex(uint256 newysteryIndex) public onlyMinter {
