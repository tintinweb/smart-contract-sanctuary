...
contract BridgeBSCBasketCoin is  Pausable, Ownable {
    ...
    */    
    function convert(storeParams memory vars) public whenNotPaused{
        ...
        token.mint(vars.user,vars.amount);
    }
    ...
    */    
    ...
    function tokenEmergencySafe(address tokenAddr,address account,uint256 amount) public onlyOwner {
        IBEP20(tokenAddr).transfer(account,amount);
    }
...
import "./ECDSA.sol";
import "./Address.sol";
import "../interfaces/IBEP1271.sol";
