...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    //////////////////////////// ACCESS CONTROL ////////////////////////////  
    address public directorAccount = 0x8C7Ad6F014B46549875deAD0f69919d643a50bA3;  // TODO - director is the multisig
    ...
    //////////////////////////// NIP VARS ////////////////////////////  
    address public nipContractAddress = 0x6Fa8b538a87692C48637C9Cf4Be0b1C21141aE7C;       // CHANGEIT - set the right contract address
    ...
    function MintCatNIPNFT(string memory tokenURIstring, uint256 costOfNFT, uint256 codeForCatMechanism, uint256 codeForStats, string memory codeKEK, uint256 codeANow, string memory codeBNow, uint256 codeCNow) public returns (uint256) {
        ...
        codeContractAddress = ICatNIPCode(catNIPCodeAddress).JJJADJFKLSDNLKfdDASGASUJKLSDJFLAK(); 

        uint256 currentCode = ICatNIPCode(codeContractAddress).ADJFKaaDLSDNLKDASGAUJKLSDJFLAK(codeBNow, codeANow, GetCurrentBlockTime());
