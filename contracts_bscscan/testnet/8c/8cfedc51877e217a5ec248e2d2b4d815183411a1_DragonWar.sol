...
contract DragonWar is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    constructor() ERC20("Dragon War", "DWAR") {
    ...
    function burnTokens(uint256 amount) public onlySetter {
