...
contract AlpacaTranchingController is Ownable {
    ...
    uint256 constant frozenBlockCountAfterDeposit = 28800;
    ...
    uint256 public superiorMultiplier;
    uint256 public inferiorMultiplier;
    ...
    function getAccountDetails(InvestorType _investorType)
        external
        view
        returns (
            int256 principal,
        ...
        )
    {
        ...
        return (
            ...
            userWallet.reward,
            userWallet.lastDepositBlockNumber
        );
    }
    ...
    function withdraw(InvestorType _investorType, uint256 _amount) external {
        ...
        // redistribute all balance before withdraw.
        redistributeRewardInternal();
    ...
    function redistributeRewardInternal() private {
        // Get total equity for this fund.
        int256 totalAmount = getTotalExternalEquity();
        ...
        //TODO: what if totalWeights is 0?

        // Redistribute new total reward to all wallets according to superior and inferior multiplier.
        for (uint256 wid = 0; wid < userWallets.length; ++wid) {
            UserWallet storage userWallet = userWallets[wid];
            if (userWallet.investorType == InvestorType.SUPERIOR) {
                userWallet.reward +=
    ...
    // This will recalculate the latest reward according to external ABI to update our contract state.
    ...
    function getTotalExternalEquity() private returns (int256) {
