...
contract SGCTestToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address CEOAddress = 0x58ffd69B6b24065F4593eeb81df03f655E5d8916;
    address coreTeamAddress1 = 0xD43b983A76140bF60137bb30305a720E1722a328; 
    address coreTeamAddress2 = 0x49851A77d6B8A9366780C83e2De938C7C7005805; 
    address coreTeamAddress3 = 0x3551D88076782dfaaa3bfb3D7BdF894E7AaB00a7; 
    address coreTeamAddress4 = 0x8B3a9bC8E990847c6050326a80b122D4b3803f32; 

    constructor() public ERC20("TEST TOKEN", "SGCTSTT") {
        ...
        */
        ...
        //_mint(CEOAddress, 2 * 10 ** 13 * (10*9));
        _mint(coreTeamAddress1, 2 * 10 ** 13 * (10**9));
        _mint(coreTeamAddress2, 2 * 10 ** 13 * (10**9));
        _mint(coreTeamAddress3, 2 * 10 ** 13 * (10**9));
        _mint(coreTeamAddress4, 2 * 10 ** 13 * (10**9)); 
    }
    ...
    function _transfer(
        ...
        for (uint i = 0; i < LockList.length; i++ ) {
            if (msg.sender == LockList[i]){
                require(!isWalletLocked,"Your Wallet is locked You cant sell or transfer");
                return;
            } 
        }
        ...
        if (coreTeam.has(msg.sender)) {
            require (coreTeamCanSell,"Core Team Members can not sell or transfer Tokens");
            return;
        }
        
        // if (from == coreTeamAddress2 ) {
        //     require (coreTeamCanSell,"Core Team Members can not sell or transfer Tokens");
        //     return;
        // }
        
        // if (from == coreTeamAddress3 ) {
        //     require (coreTeamCanSell,"Core Team Members can not sell or transfer Tokens");
        //     return;
        // }
        
        // if (from == coreTeamAddress4 ) {
        //     require (coreTeamCanSell,"Core Team Members can not sell or transfer Tokens");
        //     return;
        // }
