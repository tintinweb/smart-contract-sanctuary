...
contract Ownable is Context {
    ...
    // beast - Received from core Constructor
    constructor (address initialOwner) {
        _owner = initialOwner;
        emit OwnershipTransferred(address(0), initialOwner);
    }

    // Initialized by beast constructor
...
contract beast is Context, IBEP20, Ownable {
    ...
    string private _name     = "Test232";
    string private _symbol   = "Test232";
    ...
    uint256 public _percentageOfLiquidityForMarket = 15; 
    
    // Percentage removed from total liquidityFee to be added to Staking
    uint256 public _percentageOfLiquidityForStake = 55;
