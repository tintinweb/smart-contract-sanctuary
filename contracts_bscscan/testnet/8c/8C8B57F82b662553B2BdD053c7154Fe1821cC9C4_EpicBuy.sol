...
contract EpicBuy is Context, IERC20, Ownable {
    ...
    uint256 private minimumTokensBeforeSwap = 100000 * 10**6 * 10**9;
    uint256 public buyBackSellLimit = 1 * 10**14;

    // this can only be enabled once presale is over
    ...
    constructor (address routerAddress) {
        ...
        // ISwapRouter _uniswapV2Router = ISwapRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);

        // uniswap Router Testnet v2 - Not existing I guess
        // ISwapRouter _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);

         ISwapRouter _uniswapV2Router = ISwapRouter(routerAddress);

        swapPair = ISwapFactory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
    ...
    function canSell(address account) internal view returns(bool) {
        ...
        return lastSale[account].add(coolDownPeriod) <= block.timestamp;
    }
