...
// Name and symbol of token
    contract BABYPIPER is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//Name and symbol of token
    string private _name = "BABY PIPER";
    string private _symbol = "BPIPER";
    ...
    uint256 internal _tokenTotal = 100_000_000_000_0000e8;
    ...
    constructor() public {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // for BSC
        ...
        marketingWallet = 0xf1A59e7904d8C3C6A3a533B774BD82fBa4aCdaaD;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
