...
15% FEE : 2% to LP, 0% buyback, 10% Reflection to HODLERS, 3% to donation wallet 
...
contract SuperUselessToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Super Useless Token";
    ...
    address public _reflectiontokenaddress;
    ...
    function setReflectionTokenaddress(address _reflectiontokenaddress) external authorized {
        USDT = _reflectiontokenaddress;
