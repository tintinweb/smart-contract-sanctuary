...
contract PuppyLottoCheckV2 is SamoyedLottoCheck {
    ...
    function claimMultipleReward(uint8 _round, uint256[] memory _tokenIDArray) external nonReentrant {
        ...
        for (uint256 i = 0; i < _tokenIDArray.length; i++) {
            ...
            // console.log("_tokenID: %d , puppyValidToken : %d", _tokenID, puppyValidToken);
            ...
            address winnerAddress = SamoyedLottoCheck._getERC721OwnerAddress(puppyStorage, _tokenID);
