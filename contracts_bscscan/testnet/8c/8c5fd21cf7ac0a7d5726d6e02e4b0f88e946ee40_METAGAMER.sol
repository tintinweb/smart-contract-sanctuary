...
contract METAGAMER is Context, IERC20, Ownable {
    ...
    string private _name = "MetaGamer";
    string private _symbol = "MVG";
    ...
    uint256 public _Treasury_FEE = 200; // 3%
    uint256 private _previousTreasury = _Treasury_FEE;
    ...
    constructor (address TreasuryWallet) {
        ...
        IUniswapV2Router _uniswapV2Router = IUniswapV2Router(0xA051966f823DEF0433Ac9eA84B0C5EFBA5011a08); // Testnet
    ...
    function totalReserveFee() public view returns (uint256) {
        return _tBurnTotal;
    }
  function getTreasuryWallet() public view returns (address) {
    ...
    receive() external payable {}
     ...
     function _reflectFee(uint256 rFee, uint256 rBurn, uint256 tFee, uint256 tBurn) private {
        ...
        _rOwned[_TreasuryWallet] = _rOwned[_TreasuryWallet].add(rBurn);
    }
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _Treasury_FEE == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousLiquidityFee = _liquidityFee;
        _previousTreasury = _Treasury_FEE;
    ...
    function restoreAllFee() private {
        ...
        _Treasury_FEE = _previousTreasury;
    }
