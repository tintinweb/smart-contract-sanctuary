...
contract CheeseMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa6A72df65567bdAC75180fa537e6B4780588b776); // Marketing Address
    ...
    string private _name = "CheeseMoon";
    ...
    uint256 public _maxTxAmount = 300000000000000000 * 10**6 * 10**9;
