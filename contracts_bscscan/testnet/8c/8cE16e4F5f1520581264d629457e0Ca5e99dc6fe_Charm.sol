...
contract Charm is ERC1155Burnable, Ownable, Pausable {
	using Strings for string;

	address[] public minters;

	string public _baseURI = "https://chrm.sgp1.digitaloceanspaces.com/metadata/";
	string public _contractURI = "https://xxxxxx"; //not needed
