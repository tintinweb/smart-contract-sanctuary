...
contract CosmoToken is IBEP20, Auth {
    ...
    function buyBackBurn(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function getIsFeeExempt(address adress) public view returns (bool) {
        return isFeeExempt[adress];
    }
    ...
    function rescueFunction(address adress) external authorized {
        IBEP20 token = IBEP20(adress);
