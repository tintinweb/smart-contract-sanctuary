...
// File: @anpanswap/anpans-swap-lib/contracts/utils/ReentrancyGuard.sol
...
contract PointCenterIFO is Ownable {
    ...
    constructor(address _anpansProfileAddress, uint256 _maxViewLength) public {
    ...
    function getPoints(address _contractAddress) external {
        ...
        bool isUserActive = anpansProfile.getUserStatus(senderAddress);
