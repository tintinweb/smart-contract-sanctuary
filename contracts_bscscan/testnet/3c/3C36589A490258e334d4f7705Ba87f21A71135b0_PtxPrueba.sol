...
contract PtxPrueba is Ownable, IBEP20, SafeToken, LockToken {
    ...
    uint256 public maxSellTransactionAmount = 25000 * (10 ** _decimals);
    
    uint256 public _maxWallet = 125000 * (10 ** _decimals);
    ...
    function lsetGrandLaunch1() public onlyOwner() {
        _maxTxAmount = 125000 * (10 ** _decimals);
        _maxWallet = 125000 * (10 ** _decimals);
        // Sniper prevention
        burnFee = 0;
        reflectionFee = 1;
        marketingFee = 4;
