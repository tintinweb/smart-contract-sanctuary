...
contract BloomSmartToken is Context, IERC20, Ownable, Initializable 
{
    ...
    string private _name = "Bloom Smart Token";
    ...
    uint256 public maxlimit = 50000000000 * 10**18;
    ...
    function setAntiWhaleMaxLimit(uint256 newlimit) public onlyOwner 
    {
        maxlimit = newlimit;
    }

    function getAntiWhaleMaxLimit() public view returns(uint256) 
    {
        return maxlimit;
    }
