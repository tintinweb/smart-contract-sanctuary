...
/**
    Content copy from RichMonkeys NFT contract
 */
contract NFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public constant MAX_TOTAL_SUPPLY = 8888;

    constructor() ERC721("EyeMarket Token", "EMTT") {}
    ...
    // override ownable to disable renounce ownership feature
