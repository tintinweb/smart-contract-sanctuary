...
contract  CubanShiba is Context, IERC20, Ownable {
    ...
    string private _name = "CubanShiba";
    string private _symbol = "CBNSH";
    ...
    address public charityWallet = 0x47FEe71480Bb7ac0ddb1AfebEe8490BFa91a76C6;
    address public developerWallet = 0x47FEe71480Bb7ac0ddb1AfebEe8490BFa91a76C6;
    ...
    constructor() {
        ...
        uint256 tEightBillion = 8000000000 * 10**18;
        uint256 rEightBillion = tEightBillion.mul(_getRate());
        
        _rOwned[_msgSender()] = _rTotal.sub(rEightBillion);
        emit Transfer(address(0), _msgSender(), _tTotal.sub(tEightBillion));

        _rOwned[developerWallet] = rEightBillion;
        emit Transfer(address(0), developerWallet, tEightBillion);        
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax fee, charity fee, liquidity fee
    ...
    function setChartityFeePercent(uint256 newFee) external onlyOwner() {
        _charityFee = newFee;
        _previousCharityFee = _charityFee;
    }
