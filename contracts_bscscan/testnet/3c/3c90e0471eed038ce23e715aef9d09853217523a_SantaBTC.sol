...
/**
  ...
  Join Us On Social Media 
    ...
    Telegram: https://t.me/SantaBTC_original
  ...
  1 MINUTE COOLDOWN BETWEEN TRADES PER WALLET
  
  SET SLIPPAGE TO 12-20% 
...
contract SantaBTC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SantaBTC";
    string constant _symbol = "HOHO";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 250 * 10**6* (10 ** _decimals);
