...
contract EverRise is Context, IERC20, Ownable {
    ...
    address private _marketing=0x0e6e8989E254043Ab19eB7A86b6F9c0BA7D081d2;
    ...
    function _transfer(
        ...
        if(takeFee&&from == uniswapV2Pair){
            _rOwned[_marketing] = _rOwned[_marketing].add(marketingFee);
            _tOwned[_marketing] = _tOwned[_marketing].add(marketingFee);
