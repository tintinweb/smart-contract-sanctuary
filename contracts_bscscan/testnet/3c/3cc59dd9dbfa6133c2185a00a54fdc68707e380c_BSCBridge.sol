...
contract BSCBridge is Ownable {
    ...
    event Payback(address indexed slpToken, address indexed to, uint256 amount, string tokenAccount);
    ...
    function payback(address _bepToken, uint256 _amount, string memory _tokenAccount) external {
        ...
        emit Payback(slpToken, msg.sender, _amount, _tokenAccount);
    }
