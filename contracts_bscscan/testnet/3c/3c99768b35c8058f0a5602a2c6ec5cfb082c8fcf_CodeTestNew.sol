...
contract CodeTestNew is IBEP20, Ownable
{
    ...
    string private constant _name = "CodeTestNew";
    ...
    address private constant TeamWallet=0x939c130fC0f6C5c3c8256f0bB87f2517c5a22c88;
    address private constant PancakeRouter=0xD99D1c33F9fC3444f8101754aBC46c52416550D1;


    uint256 private _circulatingSupply =InitialSupply;
    uint256 private  balanceLimit = 10000000000 * 10**_decimals;
    uint256 private  sellLimit = 50000000 * 10**_decimals;
    ...
    function changeTax(uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyOwner{
        _buyTax=buyTax;
        _sellTax=sellTax;
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function getLimits() public view returns(uint256 balance, uint256 buy, uint256 sell){
        return(balanceLimit/10**_decimals, buyLimit/10**_decimals, sellLimit/10**_decimals);
    }

    function getTaxes() public view returns(uint256 burnTax,uint256 liquidityTax,uint256 stakingTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
        return (_burnTax,_liquidityTax,_stakingTax,_marketingTax,_buyTax,_sellTax,_transferTax);
    }
    ...
    bool private sellLockDisabled;
    bool private sellLockEnabled;
    ...
    function TeamSetTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 marketingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyOwner{
        uint8 totalTax=burnTaxes+liquidityTaxes+stakingTaxes+marketingTaxes;
