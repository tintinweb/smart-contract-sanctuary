...
contract CATACOIN is ERC20Interface,Ownable,Pausable {
    ...
    //routuer 
    address routerAdress = 0xDE2Db97D54a3c3B008a097B2260633E6cA7DB1AF;
    ...
    constructor() public {
        ...
        supplyTaxAddress = 0xb92104388cc1B300AdE3AA69c2c904f0F8E9e5EF;
        marketingTaxAddress = 0xaD314Fd1b2F82A6F8151001c001bd06fbCc597a6;
        rewardTaxAddress = 0x64E5dd7D770f1b00412bb3c0288836cabcE4Ab24;
        burnAddress = 0x384c815F76dD3eD3AC845Db3aab010FDc9B3783B;
        ...
        uint burnAmount  = balances[owner()].div(2);
        balances[owner()] = balances[owner()].sub(burnAmount);
...
function burn(uint _value) public {
    ...
    function getBurnAddress() external view returns (uint256){
         return balances[burnAddress];
    }
