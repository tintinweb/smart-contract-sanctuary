...
contract ReflectionToken is Context, ERC20, Ownable, AccessControl {
  ...
  constructor(string memory init_name, string memory init_symbol) ERC20(init_name, init_symbol) {
    _decimals = 9;
