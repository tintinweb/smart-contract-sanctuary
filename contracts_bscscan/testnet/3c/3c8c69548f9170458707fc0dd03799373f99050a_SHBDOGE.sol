...
/**
 *    SuperHeavyBoosterDoge Tokenomics
 *    totalSupply = 100 Billion
 *     30% burn at launch
 *    Note:
 *      - 4% tx fee redistributed to token holders on each transaction.  
 *      - 4% liquidity fee is taken on each transaction and locked forever in the liquidity pool.
 *      - 4% marketing fee is taken on each transaction.
 *      - Cleaned up solc warnings
 *      - Updated to compile under solc >=0.8.0
 *      SuperHeavyBoosterDoge.io
 *      t.me/shbdoge
 */
...
contract SHBDOGE is Context,IBEP20,Ownable {
    ...
    string private constant _name = "SHBDOGE";
    string private constant _symbol = "SHBDOGE";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 50000000000 * 10**9;
