...
contract TankNFT is ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant RESERVE_NFT = 50;
    uint256 public constant PUBLIC_NFT = 950;
    uint256 public constant MAX_NFT = RESERVE_NFT + PUBLIC_NFT;
    uint256 public constant NFT_PRICE = 0.5 ether;

    uint256 public constant MAINSALE_PURCHASE_LIMIT = 5;
    ...
    constructor() ERC721("TankPad", "TANK") {}
    ...
    // Function to giveaway
    function giveaway(address _to, uint256[] memory _tokenIds) external onlyOwner {
        for(uint256 i=0; i < _tokenIds.length; i++) {
            require(_tokenIds[i] < RESERVE_NFT, "Can't giveaway from public Ids");
