...
contract WoofCoin is Context, IERC20, Ownable {
    ...
    string  private constant _name = 'WoofCoin';
    ...
    //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); Testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    address public routerAddress=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount= 300000000000000 * _DECIMALFACTOR;
    uint256 public numTokensSellToAddToLiquidity= 200000000000000 * _DECIMALFACTOR;
    ...
    //Presales part
    uint256 public preSaleLimit = 500000000000000 *_DECIMALFACTOR;
    uint256 public pricePerToken = 400000 ; // This is the price per token in BNB (Total 200BNB to be funded during crowdsale)
    uint256 public preSaleDone = 0;
    bool preSaleAllowed = true;
    address payable internal FundLP;
    ...
    function preSalePurchase() public payable returns (bool) {
            ...
            require(msg.sender != FundLP, "Owner can not Purchase Presale");
            ...
            _transfer(FundLP, buyer, totalTokenValue);
            FundLP.transfer(address(this).balance);
