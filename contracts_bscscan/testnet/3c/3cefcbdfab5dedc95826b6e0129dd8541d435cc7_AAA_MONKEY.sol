...
// Fee & Wallet Related
    ...
    function _fees_to_bnb(uint256 tokensToConvert, address payable feeWallet) private {
        ...
        if(tokensToConvert  <= balanceOf(feeWallet)){
            ...
            _transferStandard(feeWallet,address(this),tokensToConvert,tokensToConvert*_getRate(),tokensToConvert,tokensToConvert*_getRate());
          //  _balance_reflected[feeWallet] -= tokensToConvert * _getRate();
           // _balance_reflected[address(this)] += tokensToConvert * _getRate();
           // emit Transfer(feeWallet,address(this),tokensToConvert);
