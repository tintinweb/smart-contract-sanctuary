    ...
    function _cancelRaffle(uint256 _raffleId) internal {
        ...
        if (
            ...
            active_silver_raffles[
                ...
                active_silver_raffles.length - 1
            ];
            rafflesIndices[active_silver_raffles[active_silver_raffles.length - 1]]
                .active_raffles_by_type_index = rafflesIndices[_raffleId]
                .active_raffles_by_type_index;
            ...
            active_diamond_raffles[
                ...
                active_diamond_raffles.length - 1
            ];
            rafflesIndices[active_diamond_raffles[active_diamond_raffles.length - 1]]
                .active_raffles_by_type_index = rafflesIndices[_raffleId]
                .active_raffles_by_type_index;
