...
/**
   #Contract Test 6
   Contract is Lockable - Test 6
   3% fee auto add to the liquidity pool and locked 
...
contract ContTest6 is Context, IERC20, Ownable {
    ...
    string private _name = "Contract Test_6";
    string private _symbol = "CTest_6";
