...
contract FAE is Context, IERC20, Ownable {
    ...
    address private _marketingAddress = 0x554362AD3A15247Be23E2E7BEd2C474e909718b8;
    address private _burnAddress = 0x0000000000000000000000000000000000000001;

    string private _name = "Fuck All Exchangs";
    string private _symbol = "FAE";
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256) {
        ...
        uint256 tDev = calculate_marketingFee(tAmount);
    ...
    function _take_marketingFee(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
    ...
    function calculate_marketingFee(uint256 _amount) private view returns (uint256) {
