...
/*
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_Liquidity != 0){
            ...
            uint256 balanceBeforeSwap = IERC20(BUSD_T).balanceOf(address(this));
            uint256 swapAmount = tokens_to_LP_Half + tokens_to_M - balanceBeforeSwap;
            ...
            // Send BUSD to Marketing Wallet
            uint256 BUSD_Bal = IERC20(BUSD_T).balanceOf(address(this));
            IERC20(BUSD_T).transfer(Wallet_Marketing, BUSD_Bal);
   ...
   function _transferTokens(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (!takeFee){
            ...
            rOtherFees = rOtherFees.mul(_getRate());

            // Calculate Transfer Amounts
            tTransferAmount = tAmount - (tReflect + rOtherFees);
