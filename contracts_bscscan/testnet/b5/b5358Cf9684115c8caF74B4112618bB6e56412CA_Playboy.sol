...
contract Playboy is Context, IERC20, Ownable {
    ...
    address  public marketingWallet = 0xc358f8515f6d32aC3998ea16147E43EC1AbdF74e;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 fundingAmt = amount.mul(_marketingFee).div(100);
        ...
        //Send transfers to burn marketing and community wallets
        _transferStandard(sender, address(0), burnAmt);
        _transferStandard(sender, marketingWallet, fundingAmt);
    ...
    function setmarketingFee (uint marketingFee) external onlyOwner() {
    ...
    function _burn(address account, uint256 amount) public onlyOwner() {
        require(account != address(0), "ERC20: sent to the zero address");
