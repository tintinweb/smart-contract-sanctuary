...
contract LinkExtreme is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LinkExtreme";
    string constant _symbol = "E-LINK";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x9BFB4d0f6e69267a075c47f521Ffc8699B3A22aa;  
