...
contract DividendDistributor is IDividendDistributor {
    ...
    address private _routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;//ropstenn 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //bsc test 0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//bsc main net 0x10ED43C718714eb63d5aA57B78B54704E256024E);
...
contract Token is Context, IERC20, IERC20Extented, Ownable {
    ...
    string private _name = "WheelofFortunes";
    string private _symbol = "$WFT";
    ...
    IRouter01 public router;
    address public pair;
    address private _routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;//ropstenn 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //bsc test 0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//bsc main net 0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    constructor() {
        ...
        // NICE
        marketingWallet = 0xe7747a365ACc270DC423036eF90C46107eaD6617; //@Dev update to current address
        _buybackwallet = 0x6bba9eeD036dAaD47FBeAF671B80E2Fb774Bf759; //@Dev update to current address
        _oraclePriceFeed = 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526; //rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
