...
contract UFomo12 is Context, IERC20, Ownable {
    ...
    string private _name = "UFomo12";
    string private _symbol = "UFO12";
    ...
    // uint256[6] public feeFomo = [0, 8, 9, 10, 11, 13];  //10
    //    uint256[6] public feeFomo = [0, 1, 1, 1, 1, 1];  //8
    //   uint256[6] public feeFomo = [ 0, 8, 8, 8, 8, 8]; //11
        uint256[6] public feeFomo = [0, 1, 1, 1, 1, 1];  //12
