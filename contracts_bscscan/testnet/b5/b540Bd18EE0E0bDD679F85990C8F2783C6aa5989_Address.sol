...
contract FeedVillage is Context, IBEP20, Ownable {
    ...
    address payable private Wallet_Charity = payable(0xfDBc3E2861329eC307f9b59Abe26424794001340); 
 ...
 //Setting the fee values
    ...
    constructor () {
        ...
        pancakeswapV2Pair = IPancakeswapV2Factory(_pancakeswapV2Router.factory())
            .createPair(address(this), _pancakeswapV2Router.BNB());
...
function name() public view returns (string memory) {
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && to != address(this)  && to != address(0x000000000000000000000000000000000000dEaD) && to != pancakeswapV2Pair){
    ...
    function precDiv(uint a, uint b, uint precision) internal pure returns ( uint) {
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       uint256 __tokensToCharity = 0;
        ...
        swapTokensForBNB(__tokensToCharity);
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = pancakeswapV2Router.BNB();
