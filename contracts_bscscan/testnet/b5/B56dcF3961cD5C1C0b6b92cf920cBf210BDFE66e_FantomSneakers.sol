 ...
 *
 * Project-name: fantom-sneakers
 * Network-Deployment: Fantom (chain ID 250)
 * Website: https://www.fantomsneakers.com/
 *
 */
...
contract FantomSneakers is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
 ...
 */
  ...
  constructor() ERC721("Fantom Sneakers", "FTMSNEAK") { // address _main, address _one, address _two, address _three
    // init of all variables
    tokenCounter = 0;
    mintFee = 10**18; //200 * 10**18; // 200 FTM
    maxMint = 103; // Total Amount
    royaltyFee = 1; // as a percentage
    royaltyAddress = msg.sender; //0x829AcFb30eAd21441a8e9887e4620cB858f67f12;
    devAddress = msg.sender;
    enableMinter = false;
    directory = "QmUWgT46EQUiz1TVEzyXu7N5LzXtT5Jxqb5gtiVv1xEYSH/";
    mainPayment = msg.sender; //_main; 0x829AcFb30eAd21441a8e9887e4620cB858f67f12
    gandmPaymentOne = msg.sender; //_one;
    gandmPaymentTwo = msg.sender; //_two;
    gandmPaymentThree = msg.sender; //_three;

    // constructor mint of ID 0 "aka first one"
  ...
  function paymentSplitter(uint256 _amount) internal {
    uint256 gandm = _amount * 15 / 100; //15%
    uint256 firstPayment = gandm / 2; //50%
    uint256 secondPayment = gandm / 4; //25%
    uint256 leftOver = _amount-gandm; // remaining
 ...
 */
  ...
  function devSetPayments(address _one, address _two, address _three) public onlyDev {
