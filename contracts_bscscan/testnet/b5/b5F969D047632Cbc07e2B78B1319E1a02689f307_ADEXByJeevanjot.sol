...
contract ADEXByJeevanjot is Ownable {
    ...
    function approval_blxm(uint256 token_blxm) public returns(bool) {
        blxm.approve(address(this), token_blxm);
    }
    
    function approval_stables(uint256 token_stables) public returns(bool) {
        stables.approve(address(this), token_stables);
    }
