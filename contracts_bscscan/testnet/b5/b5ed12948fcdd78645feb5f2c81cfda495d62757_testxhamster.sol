...
contract testxhamster is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc5c69bbaD4c80021141a30f491cd931114C39338); // Marketing Address
    ...
    string private _name = "testxhamster";
    string private _symbol = "testxhamster";
