...
**    Total tax - 4%
**
**    2% - Marketing: this will be sent straight to the tax generated marketing wallet as UNIQUECOIN. 
**
**    2% - Charity: this will be sent to a charity wallet as UNIQUECOIN
**    
**/
// you can read code from Template Contract (line number 689)
...
contract Token  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200 * 10**9 * 10**15; 
    ...
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10*6 * 10**15;
    ...
    function _getRValues(uint256[5] memory tValues, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        //function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, tMarketing, tCharity uint256 currentRate) private pure returns (uint256, uint256, uint256) {
