 ...
 */
contract RainbowLotto is ReentrancyGuard, IRainbow, Ownable {
    ...
    uint256 private minimumPrice = 1 * 1e18;
    ...
    function setLotteryTime(uint256 _time) external notContract {
        require(_time > 0);

        lotteryTime = _time * 20;
    }
