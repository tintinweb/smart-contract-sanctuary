...
contract Emperorshiba  is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    event ExcludeMaxSellTransactionAmount(address indexed account, bool isExcluded);
  ...
  function ExcludeMaxSellTransaction(address account, bool excluded) public onlyOwner {
        require(_isExcludedMaxSellTransactionAmount[account] != excluded, "AdaRise: Account is already the value of 'excluded'");
        _isExcludedMaxSellTransactionAmount[account] = excluded;

        emit ExcludeMaxSellTransactionAmount(account, excluded);
  }
  function isExcludedMaxSellTransactionAmount(address account) public view returns(bool) {
        return _isExcludedMaxSellTransactionAmount[account];
  }
