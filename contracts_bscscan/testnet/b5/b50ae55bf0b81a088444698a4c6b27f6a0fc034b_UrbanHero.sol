...
contract UrbanHero is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
      mapping(address => uint256) private _balances;
    
    address payable marketingAddress = payable(0xC5f2da703488F6D1d1B77317C18F2BB7fc707BaC); 
    ...
    string private _name = "UrbanHero";
    string private _symbol = "UHERO";
