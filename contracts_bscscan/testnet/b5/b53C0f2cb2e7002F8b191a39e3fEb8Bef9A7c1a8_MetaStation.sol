...
contract MetaStation is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xD8C8Ad5190Ee8a38469f261457A460B1870050c0); // 
    ...
    string private _name = "MetaStation";
    ...
    uint256 private numTokensSellToAddToLiquidity = 30 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToBuyback = 70 * 10**6 * 10**9;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 _numTokensSellToAddToLiquidity) external onlyOwner() {
     ...
     //check
    function setNumTokensSellToAddToBuyback(uint256 _numTokensSellToAddToBuyback) external onlyOwner() {
        numTokensSellToAddToBuyback = _numTokensSellToAddToBuyback;
    }
