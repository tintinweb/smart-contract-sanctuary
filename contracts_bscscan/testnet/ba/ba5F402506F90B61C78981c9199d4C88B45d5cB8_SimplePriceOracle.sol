...
contract CErc20 is EToken, CErc20Interface {
    ...
    function initialize(address underlying_,
        ...
        EToken etoken;
        etoken.initialize(esgtroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_);
...
contract SimplePriceOracle is PriceOracle {
    ...
    function getUnderlyingPrice(EToken eToken) public returns (uint) {
        if (ecopareStrings(eToken.symbol(), "cETH")) {
            return 1e18;
        } else {
    ...
    function ecopareStrings(string memory a, string memory b) internal pure returns (bool) {
