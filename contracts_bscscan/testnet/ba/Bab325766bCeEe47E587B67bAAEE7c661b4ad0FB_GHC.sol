...
contract GHC is Context, IBEP20, Ownable {
    ...
    string private _name = "MemesKing";
    ...
    uint256 public _taxFee = 0; //consists of reflect tax
    ...
    address payable public buybackAddress = payable(0xF996e4C92B853f1bE290B99e60C362DA1AFfb501);
    address payable public devAddress = payable(0x1Bd3dB16E37D9875Eaf5Bb848dccdDE31AB17f61);
    address payable public lpAddress = payable(0xD709B7f820A3F910356f52AAD0Db9371Cd6945be);
    address payable public stakingAddress = payable(0x55B427cA0b6Ef5b4CF6264c8328F69dD18A4A21A);
