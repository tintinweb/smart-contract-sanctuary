...
contract PonziCoin is StandardToken, SafeMath {
    ...
    uint public buyPrice = 25000000000 wei;
    uint public sellPrice = 25000000000 wei;
    uint public tierBudget = 100000;
    uint public floor = 1;
    uint public prefloor = 1;

    mapping (address => uint) private PastTokenCounts;
      ...
      returns (bool)
    {
      ...
      PastTokenCounts[msg.sender] += tokenCount;
      ...
      while (prefloor != floor) {
        balances[msg.sender] += PastTokenCounts[msg.sender];
        Issuance(msg.sender, PastTokenCounts[msg.sender]);
        totalSupply += PastTokenCounts[msg.sender];
        prefloor += 1;
      }
