...
contract FastTrack is Ownable {
    ...
    function swapTokens() public payable { 
        ...
        require(msg.value>=0.01 ether && msg.value<=3 ether,"Please enter BNB in vlid range!");
    ...
    function getTokens(uint256 _amountOfBNB) public pure returns(uint256){
        uint256 tokens=SafeMath.mul(_amountOfBNB,35000);
        return tokens;
    }
