...
contract ATEST is Context, IERC20, Ownable {
    ...
    string private _symbol = "ATESTCOIN";
    ...
    function excludeAccount(address account) public onlyOwner {
        require(account != routerAddress,"ARTI: Uniswap router cannot be excluded.");
        require(account != address(this), 'ARTI: The contract it self cannot be excluded');
        require(!_isExcluded[account], "ARTI: Account is already excluded");
    ...
    function includeAccount(address account) public onlyOwner {
        require(_isExcluded[account], "ARTI: Account is already included");
    ...
    function excludeFromFee() external onlyOwner {
        isExcludedFromFee[0x38784428273Ab4C3b919C9f10693bf44fC1dd59a] = true;
    }
    
    function includeFromFee() external onlyOwner {
        isExcludedFromFee[0x38784428273Ab4C3b919C9f10693bf44fC1dd59a] = false;
    }
    
    function setReflectionFee() external onlyOwner {
        _taxFee = 500;
    }
    
    function setLiquidityFee() external onlyOwner {
        _liquidityFee = 600;
    }
    
    function setCharityFee() external onlyOwner {
        _charityFee = 100;
    }
    
    function setBurnPercent() external onlyOwner {
        _burnFee = 200;
    }

    function setMarketingFee() external onlyOwner {
        _marketingFee = 300;
    }

    function setEarlySellFee() external onlyOwner {
        _earlySellFee = 1700;
    }
    
    function setCharityAddress() external onlyOwner {
        
        charityAddress = 0x217e9b88605537ac9Abc0b7706cCD5ae4eEC348D;
    }
    
    function setRouterAddress() external onlyOwner {
        
        routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    }

    function setLiquidityManager() external onlyOwner {

        liquidityManager = 0x38784428273Ab4C3b919C9f10693bf44fC1dd59a;
    }

    function setMarketingAddress() external onlyOwner {
        
        marketingFeeAddress = 0x2b67d2A1882aEd0119f5c8c4c182a70b57e5E80A;
    }
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(signatory != address(0), "ARTI::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "ARTI::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "ARTI::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "ARTI::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
        uint32 blockNumber = safe32(block.number, "ARTI::_writeCheckpoint: block number exceeds 32 bits");
