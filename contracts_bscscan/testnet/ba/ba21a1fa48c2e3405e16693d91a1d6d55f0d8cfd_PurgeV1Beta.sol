...
abstract contract Tokenomics {
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.ExternalToETH, 4, purgeAddress );
        _addFee(FeeType.ExternalToETH, 5, marketingAddress );
        _addFee(FeeType.ExternalToETH, 1, DevelopmentAddress );
    }
