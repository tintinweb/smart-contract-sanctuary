...
contract ISLAMI is BEP20, Ownable{
    ...
    string Adp = "Air Drop Amount: ";
    string Adpc = "Air Drop Capital Raised: ";
    string onebnb = "1 BNB = ";
    string syislami = " ISLAMI";
    ...
    function AirDropAmount() public view virtual returns (string memory, uint256, string memory){
        return (Adp, (aAmt / 1000000000), syislami);
    }
    function AirDropCap() public view virtual returns (string memory, uint256){
        return (Adpc, aCap);
    }
    function SellingPrice() public view virtual returns (string memory, uint256, string memory){
        return (onebnb, (sPrice / 1000000000), syislami);
    }
