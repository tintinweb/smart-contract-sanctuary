...
contract BasePool is Ownable, ReentrancyGuard {
    ...
    event RewardMaxTxAmountUpdated(uint256 newRewardMaxTxAmount);
    ...
    function setRewardMaxTxAmount(uint256 _maxTxAmount) public onlyManager {
        // 0 = no limit
        rewardMaxTxAmount = _maxTxAmount;
        emit RewardMaxTxAmountUpdated(rewardMaxTxAmount);
    }
    ...
    function rewardPerBlockUI() public view returns (uint256) {
        return rewardPerBlock / (10**uint256(rewardDecimals));
    }
}
