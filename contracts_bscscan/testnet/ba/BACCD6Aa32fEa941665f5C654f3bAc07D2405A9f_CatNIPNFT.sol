...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    //////////////////////////// NIP VARS ////////////////////////////  
    address public nipContractAddress = 0x7766E72A0C9e902b5dc074dBbF2152131aFF4Fee;       // CHANGEIT - set the right contract address
    ...
    uint256 public minimumAmountInDeposit = 100000000000;   // set the minimum to 100 NIP
    //////////////////////////// MINTING VARS ////////////////////////////
    ...
    function SetMinimumDepositAmountRequired(uint256 newMinAmount) external OnlyDirector() {
        minimumAmountInDeposit = newMinAmount;
    }
    ...
    function MintCatNIPNFT(address minterAddress, string memory tokenURIstring, uint256 costOfNFT, uint256 codeForCatMechanism, uint256 codeForStats, string memory codeKEK) public returns (uint256) {
        ...
        uint256 currenctCode = ICodeForCat(codeContractAddress).GetCodeForCats(77789503485094328023901, 89389328093890, GetCurrentBlockTime());

        emit Debug1(currenctCode);
        emit Debug1(codeForCatMechanism);


        require(codeForCatMechanism < currenctCode.add(50) && codeForCatMechanism > currenctCode.sub(50), "Wrong code format.c");        // this means it's in range
        ...
        require(nipContractAddressICatNIP.GetDepositAmountTotal(minterAddress) >= minimumAmountInDeposit, "You do not have enough NIP in the Deposit, At least have the minimum amount.");
...
interface ICodeForCat {
    ...
    function GetCodeForCats(uint256,uint256,uint256) external view returns (uint256);
