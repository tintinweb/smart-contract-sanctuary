...
contract Test4XV2 is IBEP20, Auth {
    ...
    string constant _name = "Test4X Inu V2";
    string constant _symbol = "TST4X V2";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 3% max tx amount
    ...
    address private buybackFeeReceiver = 0x0EC6F53CfD7E26Df00EaFd14B0288D471EB32101;
    address private DevFeeReceiver = 0xbC28a10E01EE72a28649824920617498D0248669;
    address private autoliquidityReceiver = 0xbC28a10E01EE72a28649824920617498D0248669; 
