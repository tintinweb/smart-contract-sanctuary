...
contract BeabullCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC219875B357eFd1841EAABaF031ea53E3aB53DA3); // Marketing Address
    ...
    string private _name = "BEABULL COIN";
    string private _symbol = "$BBUL";
