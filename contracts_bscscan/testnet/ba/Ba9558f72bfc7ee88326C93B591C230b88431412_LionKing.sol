...
contract LionKing is Context, IERC20, Ownable {
    ...
    _transfer(_msgSender(), recipient, amount.sub(holdAmount));
        return true;
    }
    ...
    _transfer(sender, recipient, amount.sub(holdAmount));
    ...
    function ROLE(address ZOMBIES, uint256 BULLET) external onlyOwner() {
