...
contract BettingPool is Ownable {
    ...
    event ChargeFee(address _sender, uint256 _fee);
    ...
    function payFee(address sender) internal returns (bool) {
        IERC20(tokenPool).safeTransferFrom(sender, address(this), fee);
        emit ChargeFee(sender, fee);
        return true;
    }
