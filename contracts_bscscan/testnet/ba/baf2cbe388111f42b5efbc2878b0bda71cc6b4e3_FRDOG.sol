...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FCF = IBEP20(0x4673f018cc6d401AAD0402BdBf2abcBF43dd69F3);
    ...
    uint256 public minPeriod = 24 hours; // 24 hour delay
    uint256 public minDistribution = 1 * (10 ** 18); // 1 FCF minDistribution
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FCF.balanceOf(address(this));
        ...
        uint256 amount = FCF.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FCF.transfer(shareholder, amount);
...
contract FRDOG is IBEP20, RSunAuth {
    using SafeMath for uint256;

    address public FCF = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "French Bulldog Token";
    string constant _symbol = "FRBOG";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100 billion
    uint256 public _maxTxAmount = 150000000; // 
    ...
    uint256 buybackFee = 100;  //2%
    uint256 reflectionFee = 800; //8% FCF reward
    ...
    uint256 public swapThreshold = _totalSupply / 5000000; // 0.5%
    bool inSwap;
    ...
    constructor () RSunAuth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xa7eb1aC444426D86C06ca6Fb2b9B6bbcf62846ca;
        marketingFeeReceiver = 0xa7eb1aC444426D86C06ca6Fb2b9B6bbcf62846ca;
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator, uint256 _totalSellFee) external authorizedFor(Permission.AdjustContractVariables) {
        ...
        require(totalBuyFee <= feeDenominator / 13, "Buy fee too high");
        require(totalSellFee <= feeDenominator / 20, "Sell fee too high");
    }
