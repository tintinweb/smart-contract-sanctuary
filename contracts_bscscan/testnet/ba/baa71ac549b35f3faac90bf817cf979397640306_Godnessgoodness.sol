...
contract Godnessgoodness is Context, IERC20, Ownable {
    ...
    string private _name = "Godnessgoodness";
    string private _symbol = "NESS";
    ...
    address public charityWallet = 0x390FDe51d3EC1C0C9045Cc633FDDF33FdD0506B6;
    ...
    uint256 public numTokensSellToAddToLiquidity = 200000000 * 10**9;
    ...
    function updateAllFees(uint256 taxFee, uint256 liquidityFee, uint256 burnFee, uint256 charityFee) public onlyOwner {
        _taxFee = taxFee;
        _previousTaxFee = _taxFee;
    ...
    //for new pancakeswap router address, change it here
