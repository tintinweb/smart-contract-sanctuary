...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable {
     ...
     * construction.
     */
    function _ERC20_init(string memory _nm, string memory _sym, address payable marketingAddress_, address payable teamAddress_, address psiAddress_, address buybackAddress_, address router_) internal initializer  {
        _name = _nm;
        _symbol = _sym;
        _decimals = 18;
...
contract AstroBirdsV2 is Initializable,ERC20Upgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, address payable marketingAddress_, address payable teamAddress_, address psiAddress_, address buybackAddress_, address router_) public initializer  {
        ERC20Upgradeable._ERC20_init(_name, _symbol, marketingAddress_, teamAddress_, psiAddress_, buybackAddress_, router_);
