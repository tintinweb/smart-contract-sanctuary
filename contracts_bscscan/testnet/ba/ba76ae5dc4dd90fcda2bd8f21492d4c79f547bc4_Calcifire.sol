...
contract Calcifire is Context, IERC20, Ownable {
    ...
    uint256 private _tokenTotal = 999999 * 10**18;
    ...
    uint256 public _sellTreasuryFee = 8;
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        _reflectTotal = _reflectTotal.add(amount);
        _reflectOwned[account] = _reflectOwned[account].add(amount);
