...
contract DADDYFEG is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x5fAc36F132E5ddb920AB7396446a4E457c85521A;
    ...
    uint256 public _buyBackUpperLimit = 1 * 10**18;
    uint256 public _percentageOfLiquidityForBuyBack = 50;
    ...
    function setPercentageOfLiquidityForBuyBack(uint256 p) external onlyOwner {
        _percentageOfLiquidityForBuyBack = p;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        newBalance = newBalance - newBalance.mul(_percentageOfLiquidityForBuyBack).div(100);
        addLiquidity(otherHalf, newBalance);        
        emit SwapAndLiquify(half, newBalance, otherHalf);

        uint256 balance = address(this).balance;
        if (_buyBackEnabled && balance > uint256(1 * 10**18)) {
