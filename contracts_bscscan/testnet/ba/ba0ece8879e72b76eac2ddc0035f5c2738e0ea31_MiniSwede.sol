...
contract MiniSwede is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe681B488099918fcE41C0A873B79Fb0F7852e1Eb); // Marketing Address
    ...
    string private _name = "MiniSwede";
    string private _symbol = "MiniSwede";
