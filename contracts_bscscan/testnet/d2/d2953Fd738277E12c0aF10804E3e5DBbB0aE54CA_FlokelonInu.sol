...
contract FlokelonInu is IBEP20, Auth {
    ...
    uint256 public _maxWalletSize = _totalSupply.div(100); // 1%
...
//        emit Transfer(sender, recipient, amount);
    ...
    function triggerMoonRun(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function setMaxWallet(uint256 numerator, uint256 divisor) external authorized() {
