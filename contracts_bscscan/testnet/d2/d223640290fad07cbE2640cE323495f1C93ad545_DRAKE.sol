...
contract DRAKE is ERC20, Ownable {
    ...
    constructor() ERC20("Drake", "DRAKE") {
        ...
        address newOwner = address(0x48B9ceF829B94c7a16799A4F428127C93AeA5F4c);
    	...
    	marketingWallet = address(0x48B9ceF829B94c7a16799A4F428127C93AeA5F4c); // set as marketing, development and farming wallet
    	buyBackWallet = address(0x48B9ceF829B94c7a16799A4F428127C93AeA5F4c); // set as buyback wallet
