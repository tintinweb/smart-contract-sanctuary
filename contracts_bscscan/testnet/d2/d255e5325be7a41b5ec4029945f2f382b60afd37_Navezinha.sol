...
contract Navezinha is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Navezinha";
    string constant _symbol = "NV";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 300000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; // 1.405.000
    uint256 public _maxWalletToken = _totalSupply / 94; // 3.000.00
    ...
    uint256 public swapThreshold = _totalSupply / 500; // 56,2k
    bool inSwap;
