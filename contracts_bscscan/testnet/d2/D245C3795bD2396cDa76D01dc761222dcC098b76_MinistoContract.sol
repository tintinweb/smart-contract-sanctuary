...
contract MinistoContract is Ownable {
    ...
    */
    ...
    function CompraCotas(uint QuantidadeDeCotas) public payable{
        ...
        //uint valor = (totalSupply*QuantidadeDeCotas)/100;
        investidores[msg.sender].investBalance += QuantidadeDeCotas;
        ContractTransfer(msg.sender, QuantidadeDeCotas);
        ...
        emit InvestimentoRealizado(msg.sender, QuantidadeDeCotas);
