...
contract MetaLink {
    ...
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [100, 50, 30, 20, 10]; // 10%, 5%, 3%, 2%, 1%
    ...
    constructor() {
        ...
        for (uint8 tarifDuration = 200; tarifDuration <= 200; tarifDuration++) {
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        payable(owner).transfer(msg.value / 3);
