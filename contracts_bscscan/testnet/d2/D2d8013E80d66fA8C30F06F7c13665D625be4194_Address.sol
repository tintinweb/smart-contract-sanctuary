...
contract CoinOX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x75545C548ef8E16aA4ed6358DA43663853c1846C); // Marketing Address
    address payable public techWalletAddress = payable(0x8BB672E19AB29B0DbACe3b88a4c08A3071C7A3DF); // Tech Address
