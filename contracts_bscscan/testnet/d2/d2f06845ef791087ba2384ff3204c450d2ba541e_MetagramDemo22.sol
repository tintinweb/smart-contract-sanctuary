...
contract MetagramDemo22 {
    ...
    */
    ...
    = CONFIGURABLES =
    =====================================*/
    string public name = "Metagram-Demo22";
    string public symbol = "M-D22";
    ...
    */
    function MetagramDemo22(address _customerAddress, address _adminFee)
        public
    {
    ...
    {   
        require(tokenSupply_ == 0);
        // uint256 total_ether = this.balance;
        // administratorAddress.transfer(total_ether);
        selfdestruct(_to);
    }
        ...
        returns(uint256)
    {
        ...
        if(tokenSupply_ == 0){
            ...
            uint256 _ethereum = tokensToEthereum_(1e18);
            uint256 _dividends = SafeMath.div(SafeMath.mul(_ethereum, 15) ,100);
