...
contract BABYCAKE is ERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 500000 * 10**9; // Max Transaction: (10%) Ja!
    uint256 public _maxTxAmount = 500000 * 10**9; // Max Transaction: (5%)


    address public _marketingWalletAddress = 0x5211BBfAf5170aC646AA8965E054ddA5966762f4;//Marketingwallet
