...
contract TeamSaleBEP20 is Ownable {
    ...
    uint256 public teamMinDepositUSD = 100 ether;
    uint256 public teamMaxDepositUSD = 200 ether;
    uint256 public teamMaxCap = 500 ether;
    uint256 public teamDepositBalance;
    
    address token = 0x5026952BcBE5104c78eF119c16BC423631f607BE;
    //0x5B786d0124451E29374C16E44bF2d1e4b094605E
    ...
    function depositTeamSale(uint256 amount) external {
        //require(block.timestamp >= saleStart && block.timestamp < teamSale, "presale is not active");
        //require(teamDepositBalance.add(amount) <= teamMaxCap, "deposit limits reached");
        //require(depositsTeam[msg.sender].add(amount) >= teamMinDepositUSD && depositsTeam[msg.sender].add(amount) <= teamMaxDepositUSD, "incorrect amount");
        ...
        //uint256 tokenAmount = amount.mul(tokenPrice);
        
        //balanceMapTeam[msg.sender]=balanceMapTeam[msg.sender].add(tokenAmount);
        //depositStateTeam[msg.sender]=true;
        //teamDepositBalance = teamDepositBalance.add(amount);
        //depositsTeam[msg.sender] = depositsTeam[msg.sender].add(amount);
    ...
    function withdrawTeamSale()public{
        ...
        IERC20(token).transfer(msg.sender,balanceMapTeam[msg.sender]);
    }
