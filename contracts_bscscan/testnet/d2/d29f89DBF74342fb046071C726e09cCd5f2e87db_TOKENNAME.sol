...
* 5% Marketing | 3% Liquidity / 1% Reflections
...
contract TOKENNAME is IBEP20, Auth {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(devFee).div(totalBNBFee); //NOTE: Added this for dev fee


        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool successMarketing, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (bool successDev, /* bytes memory data */) = payable(DEV).call{value: amountBNBDev, gas: 30000}(""); //NOTE: Added this for dev fee
