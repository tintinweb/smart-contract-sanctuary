...
contract MiniSafeMoon is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xb7E2c46192251e50B8e5f0f65090EbBd49D6B481); // Marketing Address
    ...
    string private _name = "MiniSafeMoon";
    string private _symbol = "MiniSafeMoon";
    ...
    function swapETHForTokens(uint256 amount) public {
        // Generate the uniswap pair path of token -> WETH
        address[] memory path = new address[](2);
