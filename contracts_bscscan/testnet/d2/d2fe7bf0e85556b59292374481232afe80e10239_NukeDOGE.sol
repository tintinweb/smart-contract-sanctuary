...
contract NukeDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3f8fB8C7cBb9CdCCcdfd6bd209af84405b636A11); // Marketing Address // TEST NET
    ...
    string private _symbol = "NukeDOGE";
