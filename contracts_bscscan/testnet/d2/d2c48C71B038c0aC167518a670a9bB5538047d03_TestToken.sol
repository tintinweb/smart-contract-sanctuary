...
contract TestToken is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 3000000 * 10**6 * 10**9;           //3 Trillion
    uint256 public _maxTxDivisor = 3333;                             //3 Trillion at launch
    uint256 public _maxWalletAmount = 1000000000 * 10**6 * 10**9;    //1 Quadrillion
    uint256 public _maxWalletDivisor = 100;                          //1 Quadrillion at launch
    bool public _useConstantMaxTxAmount;
    bool public _useConstantMaxWalletAmount;
    ...
    bool public _useConstantMinTokensBeforeSwap;
    ...
    function swapTokens(uint256 tokenAmountCandidate) private lockTheSwap {
        ...
        if (initialBalance < memeBurnCost.mul(_memeBurnBuffer)){
            ...
            if (_accumulatingForBurn){
                ...
                uint256 totalBurnBuffer =  _bigBurnAmount.mul(_bigBurnBufferPercent).div(100); // Total amount for BigBurn and subsequent BurnMode
    ...
    //////////////////////
    function DebugswapTokens(uint256 tokenAmountCandidate) public lockTheSwap {
