...
contract VANTHANH is Context, IERC20, Ownable {
    ...
    string private _name = "VTT TOKEN";
    ...
    address public devWallet = 0xa3853Af45cC86357bA2B41fe763A8C458f90F91F;   
    ...
    uint256 public _maxWalletToken = 15 * 10**5* 10**9;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xbEEA1a03d5A0C3F652356e4511b3fb574205cCA9, 'We can not exclude Pancake router.'); //v2
