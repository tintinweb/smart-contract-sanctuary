...
contract RewardMiner is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Reward Miner";
    string constant _symbol = "RewardMiner";
    ...
    constructor (
        ...
        marketingFeeReceiver = payable(0x0D889F72b3FeD2bE2b7481b5B852d3DeB2bA578F);
    ...
    function triggerBuyback() internal {
        buybackTokens(autoBuybackAmount);
      
    }

    function buybackTokens(uint256 amount) public authorized {
        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(this);
