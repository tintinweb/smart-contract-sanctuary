...
contract HONEYPADV2 is ERC20, Ownable {
    ...
    event UpdateMarketingWallet(address oldMarketing, address newMarketing);
    ...
    event UpdateFee(uint256 oldBuyFee, uint256 newBuyFee, uint256 oldSellFee, uint256 newSellFee);
    ...
    constructor() ERC20("HONEYPADV2", "$HONEY") {
...
//        updatePancakeRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    function updateFee(uint256 _buyFee, uint256 _sellFee)  external onlyOwner {
        require(_buyFee < 4000 && _sellFee < 4000, "Too much");
        emit UpdateFee(buyFee, _buyFee, sellFee, _sellFee);
        buyFee = _buyFee;
        sellFee = _sellFee;
    }
    ...
    function setMarketingWallet(address newMarketingWallet) external onlyOwner {
        ...
        emit UpdateMarketingWallet(marketingWallet, newMarketingWallet);
    ...
    function _transfer(
        ...
        if(
            ...
            swapping = true;
            swapTokensAndSendBNB(swapTokensAtAmount, marketingWallet);
            swapping = false;
        }
        ...
        if(
            ...
            uint256 fee;
            if (to == pancakePair) {
                fee = amount * sellFee / DENOMINATOR;
            } else {
                fee = amount * buyFee / DENOMINATOR;
            }
    ...
    function swapTokensAndSendBNB(uint256 tokenAmount, address recipient) private {
