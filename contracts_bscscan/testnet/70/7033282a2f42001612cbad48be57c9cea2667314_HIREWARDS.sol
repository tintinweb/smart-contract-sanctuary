...
📊 70% Liquidity
🔥 12% Burn
💥 Total Suply : 10,000,000,000
🔸 Telegram:https://t.me/hirewardstest.com
🔸 Website: https://hirewardstest.com
🔸 Twitter:https://twitter.com/hirewardsbsc
...
abstract contract Ownable is Context {
    ...
    //uint256 private _lockTime; No need to lock contract. scammers do that
...
contract HIREWARDS is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000_000_000_000; 
    ...
    string private _name = "HIREWARD";
    string private _symbol = "HIW";
    
    uint256 private _rewards = 5;
    uint256 private _previousRewards = _rewards;
    ...
    address _marketingWallet = 0xD52389Bc32247eCA808288aDbAC4F2C8b10A46B5;
    ...
    function setRewardsPercent(uint256 rewardsPercent) external onlyOwner() {
        require(rewardsPercent >= 4); // Rewards have to be greater than 4%.
        _rewards = rewardsPercent;
    }
   ...
   function setRewardsEnabled(bool _enabled) public onlyOwner {
    ...
    function deliver(uint256 tAmount) public {
        ...
        _RewardsTotal = _RewardsTotal.add(tAmount);
    }
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        ...
        _RewardsTotal = _RewardsTotal.add(tFee);
    }
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_rewards).div(
            10**2
        );
    }
    ...
    function removeAllFee() private {
        if(_rewards == 0 && _liquidityFee == 0) return;
        
        _previousRewards = _rewards;
