...
contract SimpleNFT2 is ERC721, ERC721URIStorage, ERC2981Collection, ContractURI, IMAX721, ReentrancyGuard, ERC165Storage, DeveloperV2, Ownable {
  ...
  uint256 private freeMintAmount;
  string private base;
  ...
  event UpdatedTokenAddress(ERC20 _old, ERC20 _new);
 ...
 */
  ...
  function publicMint(uint256 amount) public nonReentrant() {
    ...
    tokenAddress.transferFrom(msg.sender, DEAD_ADDRESS, tokenAmount);
 ...
 */
  ...
  function setTokenAddress(address _tokenAddress) public onlyDev {
    ERC20 old = tokenAddress;
    tokenAddress = ERC20(_tokenAddress);
    tokenName = tokenAddress.name();
    emit UpdatedTokenAddress(old, tokenAddress);
  }
  ...
  // @notice this is a getter for ERC20 token set for this minter
  function ERC20TokenNameBackup() public view returns (string memory) {
    return tokenName;
  }
