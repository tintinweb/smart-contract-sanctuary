...
contract TBNB is ERC20, Ownable {
    ...
    function updateSteps(bool step11, bool step22, bool step33, bool step44) public onlyOwner {
        step1 = step11;
        step2 = step22;
        step3 = step33;
        step4 = step44;
    ...
    function _transfer(address from, address to, uint256 amount ) internal override {
       ...
       if(cooldownEnabled && to == uniswapV2Pair && !isTimelockExempt[from])//SELL
        {
    ...
    function swapBack(uint256 tokensToLiquify) internal lockTheSwap {
        ...
        if(step1)
        {
            ...
            if(step3)
            {
                (bool tmpSuccess1,) = payable(_devWallet).call{value: bnbForDev, gas: 30000}("");
                (bool tmpSuccess2,) = payable(_marketingWallet).call{value: bnbForMarketing, gas: 30000}("");
            }
