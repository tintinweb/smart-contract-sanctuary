...
contract Ownable is Context {
    address private _owner = 0x3c0a3d1994C567Fd4BF17dc5858eC84fF1F87501;
...
contract PMMT is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "PMMT"; // token name
    string private _symbol = "PM"; // token symbol
	...
	*/
    ...
    function _transfer(
        ...
        if(block.timestamp >= previousBuyBackTime.add(durationBetweenEachBuyback)
            && address(this).balance > 0 && !inSwapAndLiquify)
        {
