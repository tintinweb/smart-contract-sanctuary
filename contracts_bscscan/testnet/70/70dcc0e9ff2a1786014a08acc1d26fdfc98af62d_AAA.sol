...
contract AAA is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0659671cB3209611Ec7A94D550039cbadEaEeb50); // Receipent of Marketing Fees
    address payable public devAddress = payable(0x0659671cB3209611Ec7A94D550039cbadEaEeb50); // Dev Address to Keep the Contract Alive
    address payable public devWalletAddress = payable(0x0659671cB3209611Ec7A94D550039cbadEaEeb50); // Receipent of Dev Fees
    ...
    string private _name = "AZOV";
    string private _symbol = "AZOV";
    ...
    uint256 public buyBackSellLimit = 1 * 10**6 * 10**9;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(devAddress, transferredBalance.mul(devDivisor).div(100));
