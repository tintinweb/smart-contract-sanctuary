...
contract SaleGamePad1 {
   ...
   // IERC20 constant public token = IERC20(0xD88C6Ec2D3fBD90892c6749CF83De6ad10c30B4b);// Token MetaPad
    //IERC20 constant public busd = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);// Token BUSD

    IERC20 constant public token = IERC20(0xd0B01cf45D0E907C9c7c550376350CfaF2C12646);// Token 
    IERC20 constant public busd = IERC20(0x10E3814D5F83F32f5Fd893896CD630272eaE8842);// testbusd
    ...
    function getToken() public {
        ...
        require(balances[msg.sender] > 0, "You have not tokens");
        require(getContractBalanceToken() >= balances[msg.sender], "Not enough tokens");
   ...
   function Approve() public {
        ...
        //IERC20(busd).allowance[msg.sender][address(this)] = "10000000000000000000000";
        IERC20(busd).approve(address(this), 10000000000000000000000);
       // return true;
