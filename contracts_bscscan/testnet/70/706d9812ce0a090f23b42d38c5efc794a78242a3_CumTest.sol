...
contract CumTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public maxTaxFee = 2;                // Transaction fee % that would be distributed to holders (0-10)
    uint8 public maxBurnFee = 2;               // Transaction fee % that would be burned (0-10)
