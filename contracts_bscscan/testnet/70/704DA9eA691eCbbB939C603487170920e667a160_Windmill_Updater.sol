...
abstract contract With_StackingContract is Base, AccessControlEnumerable, With_DAORole, I_With_StackingContract{
...
abstract contract With_RoyaltyContract is Base, AccessControlEnumerable, With_DAORole, I_With_RoyaltyContract{
...
interface I_Windmill_DAO is IAccessControlEnumerable, I_With_DAORole, I_With_UpdaterRole, I_With_FundContract,
     ...
     *
     */
    function init(uint256[12] calldata data,
...
abstract contract With_DAOContract is Base, AccessControlEnumerable, With_DAORole, I_With_DAOContract{
...
contract Windmill_Updater is Base, Math, Adressable, Payable, Gas_Refundable, AccessControlEnumerable, With_DAORole, With_DAOContract,
