...
Our upcoming private sale will be conducted on www.infinitypad.io only. The Private Sale is available only to Whitelist Winners, and each winner will have a guaranteed allocation. The whole process of private sale will be conducted by a smart contract to eliminate any security risks 
*/
...
contract INFP is Context, IERC20, Ownable {
