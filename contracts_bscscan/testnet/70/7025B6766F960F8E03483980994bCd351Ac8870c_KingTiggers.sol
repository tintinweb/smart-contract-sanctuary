...
contract KingTiggers is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe21140e55E4065F7B1698bFC8F81831AeAbD798b); // Marketing Address
    ...
    string private _name = "KingTiggers";
    string private _symbol = "Ktig";
