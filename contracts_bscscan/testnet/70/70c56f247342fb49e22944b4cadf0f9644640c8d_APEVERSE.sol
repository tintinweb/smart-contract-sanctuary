...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendsPerShareAccuracyFactor = 50 ** 36;
    uint256 public minPeriod = 3;
    uint256 public minDistribution = 5000 * (10 ** 9);
...
contract APEVERSE is Context, IERC20, Auth {
    ...
    uint256 public _maxTxAmount = ( _tTotal * 1 ) / 5000;
    uint256 public _maxWalletToken = ( _tTotal * 2 ) / 5000;
    uint256 public _mStx = ( _tTotal * 1 ) / 500;
    uint256 public _asT = 2000 * (10 ** _decimals);
    ...
    uint256 public sT = 5000 * (10 ** _decimals);
    bool LFG = false;
