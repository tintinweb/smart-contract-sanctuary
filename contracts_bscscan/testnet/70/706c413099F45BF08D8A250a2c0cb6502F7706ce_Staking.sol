...
contract Staking {
    ...
    function getTimeRemaining() public view returns (uint256) {
        uint256 timeRemaining = block.timestamp <= stopTime ? stopTime - block.timestamp : 0;
        return timeRemaining;
    }

    function getTimeElapsed() public view returns (uint256) {
        uint256 timeElapsed = block.timestamp >= startTime ? block.timestamp - startTime : 0;
        return timeElapsed;
    }
    ...
    function exit() public {
        ...
        require(stakeholder.staked > 0, "Staking: you have not participated in staking OR already withdrawn");
