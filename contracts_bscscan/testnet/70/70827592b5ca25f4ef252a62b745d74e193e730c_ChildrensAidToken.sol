...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4F950FC1C75170D0e2F9B0B55D958535cbEaD76d;
...
contract ChildrensAidToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCAF6E01961Bd9Cb8d493087d5aF61906f4F86f71;//charity
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Children's Aid Token13";
    string private _symbol = "CAT13";
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);//Live bsc
