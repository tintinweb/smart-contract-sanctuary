 ...
 * COIN
 */
contract TestyReflect is Context, IERC20, Ownable, ReentrancyGuard {
    // Libraries
    ...
    // Token
    string private _name = "TestyReflect";
    string private _symbol = "TSTY R"; 
    ...
    // Max TX in tokens
    uint256 public _maxSellTxAmount = 2000 * 10**18;
