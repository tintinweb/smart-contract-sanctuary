...
//    uint256 public _min_Swap = _tTotal / 10000; // 0.01% of total supply XXXX
    ...
    bool public _aa_wallet_limit = false;
    bool public _aa_trans_limit = false;
    bool public _aa_buy_sell_fee = false;
    bool public _aa_transfer_before = false;
    bool public _aa_process_on_buy = false;


    function __aa_wallet_limit(bool true_or_false) external onlyOwner() {    
        _aa_wallet_limit = true_or_false;
    }
    function __aa_trans_limit(bool true_or_false) external onlyOwner() {    
        _aa_trans_limit = true_or_false;
    }
    function __aa_buy_sell_fee(bool true_or_false) external onlyOwner() {    
        _aa_buy_sell_fee = true_or_false;
    }
    function __aa_transfer_before(bool true_or_false) external onlyOwner() {    
        _aa_transfer_before = true_or_false;
    }
    function __aa_process_on_buy(bool true_or_false) external onlyOwner() {    
        _aa_process_on_buy = true_or_false;
    }
    ...
    */
    ...
    function _transfer(
        ...
        // Select correct fee - XXX Check this!! 
