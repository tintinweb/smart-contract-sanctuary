...
contract MCL is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 25000000000000000 * 10**9;
    // set this number to adjust the rate of swaps
    uint256 public numTokensSellToAddToLiquidity = 250000000000 * 10**9;
