    ...
    BEP20("MBNB LP", "MBNB")
{
    ...
    function OutStake(uint256 MBNBAmount) external {
        ...
        _burn(msg.sender, MBNBAmount);
        sendBNBDividends(msg.sender,payBNB);
    }
    ...
    Ownable,MBNBPool
{
    ...
    function getMBNBPoolBalance() public view returns (uint256){
        return address(this).balance;// address(pool).balance/pool.totalSupply();
    }
