...
event OperatorTransferred(address indexed previousOperator, address indexed newOperator);
  ...
  // Addresses that excluded from antiWhale
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) external onlyOwner  {
        require(_maxTransferAmountRate <= 10000, "SES::updateMaxTransferAmountRate: Max transfer amount rate must not exceed the maximum rate.");
        require(_maxTransferAmountRate >= BASE_MAX_TRANSFER_AMOUNT_RATE, "SES::updateMaxTransferAmountRate: _maxTransferAmountRate should be at least _maxTransferAmountRate");
      ...
      function setExcludedFromAntiWhale(address _account, bool _excluded) external onlyOwner {
