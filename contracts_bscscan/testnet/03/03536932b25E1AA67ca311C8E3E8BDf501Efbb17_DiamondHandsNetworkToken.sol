...
contract DiamondHandsNetworkToken is ERC20, Ownable {
    ...
    constructor() public ERC20("DHNTests-6", "DHNT6") {
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            //    contractTokenBalance = contractTokenBalance.mul(10).div(100);
            //}
    ...
    function swapTokensForFees(uint256 contractTokenBalance) private{
        ...
        // swap tokens for ETH
        swapTokensForEth(tokensForSwap); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
        ...
        transferToAddressETH(_marketingWalletAddress, ethForMkting);

        addLiquidity(halfLiq, ethForLiq);

        swapAndSendDividends(ethForDivs, tokensForDivs);
