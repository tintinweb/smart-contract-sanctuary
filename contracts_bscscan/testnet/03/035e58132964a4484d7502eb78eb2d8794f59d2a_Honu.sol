...
contract Honu is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x63e5656D082c1C5Cd8b7aA842AA9f1a80637d32c;
    ...
    string private _name = "AB_5 test";
    string private _symbol = "AB_5";
    ...
    function setSellFee(address sender) private {
        ...
        if (timeSinceBuy < 3 * minute) {
            _marketingFee = 14;
            _liquidityFee = 27;
        } else if (timeSinceBuy < 10 * minute) {
            _marketingFee = 11;
            _liquidityFee = 24;
        } else if (timeSinceBuy < 15 * minute) {
            _marketingFee = 7;
            _liquidityFee = 18;
        } else if (timeSinceBuy < 20 * minute) {
            _marketingFee = 5;
            _liquidityFee = 10;
        } else {
            _marketingFee = 2;
