...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  function accumulativeDividendOf(address _owner) public view override returns(uint256) {
      int256 b = int256(magnifiedDividendPerShare.mul(balanceOf(_owner)));
      require(b >= 0);
    return b.add(magnifiedDividendCorrections[_owner]).toUint256Safe() / magnitude;
  }
...
contract RAKUCDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("RAKUC_Dividen_Tracker", "RAKUC_Dividend_Tracker") {
    	claimWait = 1800;
...
contract FlokiGravity is ERC20Detailed, Ownable {
    ...
    public {
        ...
        marketingAddress = 0x9dAD45C0E2AA55cc679bB8b38c904351C8cec437;
