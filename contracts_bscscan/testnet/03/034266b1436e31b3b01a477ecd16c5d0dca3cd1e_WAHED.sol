...
contract WAHED is ERC20, ERC20Burnable, Ownable, ERC20Pausable {
    constructor(
        string memory name,
        ...
        uint256 publicSaleTokens = 1000000; // 5100000/1000000 = 5.1 million
        _initialTransfer(
            0xe1B16df896c83997fdbD48852Efae7Ff3Be14FA7,
            (publicSaleTokens * decimalFactor)
        );
        // payrol
        uint256 payrolTokens = 1000000; // 7.5 million
        _initialTransfer(
            0xC1155f8AFcB638B9413Ef276dC608eE0EaCc7171,
            (payrolTokens * decimalFactor)
        );
        // security
        uint256 securityTokens = 1000000; // 5.4 million
        _initialTransfer(
