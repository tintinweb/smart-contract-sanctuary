...
contract WagyuToken is BEP20('WagyuSwap Token', 'Wagyu') {
    ...
    */
        ...
        external
    {
        ...
        require(now <= expiry, "WAGYU::delegateBySig: signature expired");
...
contract SyrupBar is BEP20('SyrupBar Token', 'SYRUP') {
    ...
    // Safe wagyu transfer function, just in case if rounding error causes pool to not have enough WAGYUs.
