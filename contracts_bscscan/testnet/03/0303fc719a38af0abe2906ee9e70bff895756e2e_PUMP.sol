...
contract DividendDistributor is IDividendDistributor {
    ...
    function setDistributionCriteria(uint256 newMinPeriod, uint256 newMinDistribution) external override pumpiumToken {
        minPeriod = newMinPeriod;
        minDistribution = newMinDistribution;
    }

    function setShare(address shareholder, uint256 amount) external override pumpiumToken {
    ...
    function deposit() external payable override pumpiumToken {
    ...
    function process(uint256 gas) external override pumpiumToken {
    ...
    function claimDividend(address shareholder) external pumpiumToken{
        distributeDividend(shareholder);
    }

    function rescueDividends(address to) external pumpiumToken {
        RewardToken.transfer(to, RewardToken.balanceOf(address(this)));
    }

    function setRewardToken(address _rewardToken) external pumpiumToken{
...
contract PUMP is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x908327B8d345Dd5401249Df7105e017ce04B4f1f;
