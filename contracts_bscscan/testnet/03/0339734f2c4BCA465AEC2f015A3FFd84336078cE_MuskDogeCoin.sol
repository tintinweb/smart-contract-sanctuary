...
contract MuskDogeCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Musk Doge Coin";
    string private _symbol = "MDC";
    ...
    constructor (uint256 _supply, uint256 _txFee, uint256 _lpFee, uint256 _mFee, uint256 _MAXAMOUNT, uint256 SELLMAXAMOUNT, address routerAddress, address tokenOwner, address _marketingAddress) public {
    ...
    function _takeMarketing(uint256 tMarketing) private {
        ...
        if(_isExcluded[marketingAddress])
            _tOwned[marketingAddress] = _tOwned[marketingAddress].add(rMarketing);
    }
