...
// EVER WISH YOU HELD A TOKEN THAT ELON JUST TWEETED ABOUT OR ONE THAT A MAJOR INFLUENCER TWEETED ABOUT
// NOW YOU CAN WITH HYPETOKEN THE ULTIMATE HYPE TOKEN YOU CAN NOW HOLD A TOKEN AND THE MOMENT A MAJOR TWEET COMES
// WE CAN UPDATE THE NAME AND TICKER TO CATCH THAT NEXT PUMP AND HOLDERS CAN GET THERE 2 3 10X 
// LETS FACE IT INFLUENCERS ARE WHAT PUMP CRYPTO NOTHING ELSE REALLY DOES LETS MAKE SOME CASH
...
contract HYPETOKEN is Context, IERC20, Ownable {
    ...
    //
    string private _name = "HYPETOKEN";
    string private _symbol = "APE";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000000 * 10**9 * 10**_decimals;
    //
    address payable public marketingAddress = payable(0x526042beF2728533489EC5e648076f2b0547A2A2);
    //
