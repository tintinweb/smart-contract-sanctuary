...
contract NFTWPower is Context, IBEP20, Ownable {
    ...
    */
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        _NFTWtoken.transferFrom (msg.sender, address(0), amount);
        
        (address Father)=GetRelationShip(msg.sender);
        uint256 FatherAmount = amount.mul(100).div(1000);
        Update(msg.sender);
    ...
    function _SetStars(address account) internal{
        ...
        UserS[account].IsGade4 = true;UserS[account].Gade4update = block.number;}
        
        for(uint i = 0; i < UserS[account].Sons.length; i++){sons = UserS[account].Sons[i];
        if((block.number-UserS[sons].Gade4update)<= 20*60*24*30){Gade4updatesum = Gade4updatesum + 1;}
        ...
        if(Gade4sum >= 5&&UserS[account].IsStar1==false){UserS[account].IsStar1 = true;}
        if(Star1sum >= 3&&UserS[account].IsStar2==false){UserS[account].IsStar2 = true;}
        if(Star2sum >= 3&&UserS[account].IsStar3==false){UserS[account].IsStar3 = true;}
        if(Star3sum >= 3&&UserS[account].IsStar4==false){UserS[account].IsStar4 = true;}
        
        
        if(UserS[account].IsStar1==true&&UserS[account].IsStar2==false&&Gade4updatesum >= 1){UserS[account].Star1update = block.number;}
        
        if(UserS[account].IsStar2==true&&UserS[account].IsStar3==false&&Gade4updatesum == 1){UserS[account].Star1update = block.number;}
        if(UserS[account].IsStar2==true&&UserS[account].IsStar3==false&&Gade4updatesum >= 2){UserS[account].Star2update = block.number;}
        
        if(UserS[account].IsStar3==true&&UserS[account].IsStar4==false&&Gade4updatesum == 1){UserS[account].Star1update = block.number;}
        if(UserS[account].IsStar3==true&&UserS[account].IsStar4==false&&Gade4updatesum == 2){UserS[account].Star2update = block.number;}
        if(UserS[account].IsStar3==true&&UserS[account].IsStar4==false&&Gade4updatesum >= 3){UserS[account].Star3update = block.number;}
    ...
    function GetStarNumbers() public view returns(uint256 Star1Numbers,uint256 Star2Numbers,uint256 Star3Numbers,uint256 Star4Numbers){
        ...
        if(UserS[_ALLUSRES[i]].IsStar1==true&&(block.number-UserS[_ALLUSRES[i]].Star1update)<= 20*60*24*30){Star1Numbers = Star1Numbers+1;}
        
        if(UserS[_ALLUSRES[i]].IsStar2==true&&(block.number-UserS[_ALLUSRES[i]].Star1update)<= 20*60*24*30){Star2Numbers = Star1Numbers+1;}
        if(UserS[_ALLUSRES[i]].IsStar2==true&&(block.number-UserS[_ALLUSRES[i]].Star2update)<= 20*60*24*30){Star2Numbers = Star2Numbers+1;}
        
        
        if(UserS[_ALLUSRES[i]].IsStar3==true&&(block.number-UserS[_ALLUSRES[i]].Star1update)<= 20*60*24*30){Star3Numbers = Star1Numbers+1;}
        if(UserS[_ALLUSRES[i]].IsStar3==true&&(block.number-UserS[_ALLUSRES[i]].Star2update)<= 20*60*24*30){Star3Numbers = Star2Numbers+1;}
        if(UserS[_ALLUSRES[i]].IsStar3==true&&(block.number-UserS[_ALLUSRES[i]].Star3update)<= 20*60*24*30){Star3Numbers = Star3Numbers+1;}
        
        if(UserS[_ALLUSRES[i]].IsStar4==true&&(block.number-UserS[_ALLUSRES[i]].Star1update)<= 20*60*24*30){Star4Numbers = Star1Numbers+1;}
        if(UserS[_ALLUSRES[i]].IsStar4==true&&(block.number-UserS[_ALLUSRES[i]].Star2update)<= 20*60*24*30){Star4Numbers = Star2Numbers+1;}
        if(UserS[_ALLUSRES[i]].IsStar4==true&&(block.number-UserS[_ALLUSRES[i]].Star3update)<= 20*60*24*30){Star4Numbers = Star3Numbers+1;}
        if(UserS[_ALLUSRES[i]].IsStar4==true&&(block.number-UserS[_ALLUSRES[i]].Star4update)<= 20*60*24*30){Star4Numbers = Star4Numbers+1;}}
    ...
    function GetStarPower(address account) public view returns(uint256){
        ...
        (uint256 Star1Numbers,uint256 Star2Numbers,uint256 Star3Numbers,uint256 Star4Numbers)=GetStarNumbers();
         if(UserS[account].IsStar1==true&&(block.number-UserS[account].Star1update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star1Power/1000/Star1Numbers*GetBlockNumber(account);}
        
         if(UserS[account].IsStar2==true&&(block.number-UserS[account].Star1update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star1Power/1000/Star1Numbers*GetBlockNumber(account);}
         if(UserS[account].IsStar2==true&&(block.number-UserS[account].Star2update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star2Power/1000/Star2Numbers*GetBlockNumber(account);}

         if(UserS[account].IsStar3==true&&(block.number-UserS[account].Star1update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star1Power/1000/Star1Numbers*GetBlockNumber(account);}
         if(UserS[account].IsStar3==true&&(block.number-UserS[account].Star2update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star2Power/1000/Star2Numbers*GetBlockNumber(account);}
         if(UserS[account].IsStar3==true&&(block.number-UserS[account].Star3update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star3Power/1000/Star3Numbers*GetBlockNumber(account);}

         if(UserS[account].IsStar4==true&&(block.number-UserS[account].Star1update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star1Power/1000/Star1Numbers*GetBlockNumber(account);}
         if(UserS[account].IsStar4==true&&(block.number-UserS[account].Star2update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star2Power/1000/Star2Numbers*GetBlockNumber(account);}
         if(UserS[account].IsStar4==true&&(block.number-UserS[account].Star3update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star3Power/1000/Star3Numbers*GetBlockNumber(account);}
         if(UserS[account].IsStar4==true&&(block.number-UserS[account].Star4update)<= 20*60*24*30)
        {StarPower = oneblockreward*_Star4Power/1000/Star4Numbers*GetBlockNumber(account);}
    ...
    function GetBonus(address account) public view returns(uint256){
         ...
         income = (blockNumber.mul(UserRatio).mul(oneblockreward).div(AllPower)+StarPower).div(60);}
         else{income = blockNumber.mul(UserRatio).mul(oneblockreward).div(AllPower).div(60);}
    ...
    function Update(address account) internal{
        ...
        if(UserS[account].IsStar1==true){
        UserS[account].Pending = UserS[account].Pending.add(GetStarPower(account));}
