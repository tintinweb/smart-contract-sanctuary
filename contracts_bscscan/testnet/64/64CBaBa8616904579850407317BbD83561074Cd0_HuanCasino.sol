...
contract HuanCasino is ERC1155Holder {
  ...
  constructor(address lowbToken_, address checker_, address _uyangNft, address _uyangToken ) public payable {
 ...
 fallback() external payable {}
  ...
  function bet_1(uint256 numberSelected) public payable {
    ...
    require(uyangToken.transferFrom(address(this), msg.sender, uyangAmout), "uyangStone transfer failed");
