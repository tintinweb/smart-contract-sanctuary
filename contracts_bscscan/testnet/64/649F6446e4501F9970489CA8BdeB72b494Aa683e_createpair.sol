...
contract createpair {
    ...
    function pool_address() public view returns (address){
    ...
    function AddLiq(uint256 tokenAmount, uint256 bnbAmount) public{
        ...
        // add the liquidity
        uniswapV2Router.addLiquidityETH{value: bnbAmount}(address(this),tokenAmount,0,0,uniswapV2Pair,block.timestamp);
    }
