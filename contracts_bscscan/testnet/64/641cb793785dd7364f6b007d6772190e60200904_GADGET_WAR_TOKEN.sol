...
contract GADGET_WAR_TOKEN is owned {
    /*===============================
    =         DATA STORAGE          =
    ===============================*/
    ...
    string private constant _name = 'GADGETWAR';
    ...
    struct allocationType {
        ...
        uint256 monthlyReleaseLimitInPercent; // In Percent with 18 decimal Places
    ...
    uint256 public tokenPrice = 10**_decimals;
    ...
    event defineAllocationEv(
        ...
        uint256 _monthlyReleaseLimitInPercent,
    ...
    function editAllocationReleaseLimit(
        ...
        allocationTypes[allocationTypeIndex]
            .monthlyReleaseLimitInPercent = _monthlyReleaseLimitInPercent;
        return true;
    }
        ...
        returns (bool)
    {
        ...
        uint256 currentMonthCount = ((block.timestamp - releaseTime) / 1800 seconds) + 1;
        uint256 amountClaimable = (_allocationBalance[allocationTypeIndex][msg.sender] *
            allocationTypes[allocationTypeIndex].monthlyReleaseLimitInPercent) /
            (10**(_decimals + 2));
        amountClaimable =
            amountClaimable *
            currentMonthCount -
    ...
    function claimAmountView(uint256 allocationTypeIndex)
        public view
        returns (uint)
    {
        require(allocationDefined, 'allocation type not defined');
        ...
        uint256 currentMonthCount = ((block.timestamp - releaseTime) / 1800) + 1;
        uint256 amountClaimable = (_allocationBalance[allocationTypeIndex][msg.sender] *
            allocationTypes[allocationTypeIndex].monthlyReleaseLimitInPercent) /
            (10**(_decimals + 2));
        amountClaimable =
