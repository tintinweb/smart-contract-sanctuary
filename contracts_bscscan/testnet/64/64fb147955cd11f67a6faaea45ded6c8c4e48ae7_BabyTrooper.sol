...
contract BabyTrooper is Context, IERC20, Ownable {
    ...
    string private _name = "BabyTrooper";
    ...
    address public charityWallet = 0xB83CF0D9F9f375A1a4E936927ce4E657623C7e47;
    uint256 private _previouscharityFee = _charityFee;

    uint256 public _maxTx = 100000000 * 10**18;
    ...
    */
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, 'We can not exclude Pancake router V2.');
        require(account != 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F, 'We can not exclude Pancake router V1.');
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         require(amount<_maxTx, "Transfer amount must be less them maxTx");
         }
   
   
        uint256 contractTokenBalance = balanceOf(address(this));        
        bool overMinTokenBalance = contractTokenBalance >= numTokensSellToAddToLiquidity;
        //bool overMinTokenBalance = true;
    ...
    function setMarketingFeePercent(uint256 charityFee) external onlyOwner() {
    ...
    function setBurnFeePercent(uint256 burnFee) external onlyOwner() {
     ...
     function set_maxTx(uint256 maxTx) external onlyOwner() {
        _maxTx = maxTx;
    }
    
    
    /**
     function set_numTokensSellToAddToLiquidity(uint256 numToken) external onlyOwner() {
