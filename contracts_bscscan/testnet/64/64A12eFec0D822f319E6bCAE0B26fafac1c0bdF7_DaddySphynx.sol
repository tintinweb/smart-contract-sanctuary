...
contract DaddySphynx is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DaddySphynx";
    string constant _symbol = "DSPHYNX";
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 90 >= block.number){ return feeDenominator.sub(1); }
