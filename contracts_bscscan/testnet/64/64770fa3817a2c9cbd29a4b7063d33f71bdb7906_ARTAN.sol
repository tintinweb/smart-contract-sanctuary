...
// ARTAN Token contract based on the full BEP 20 Token standard
// Symbol: ARTAN
// Status: BEP20 Verified

contract ARTANToken { 
    /* This is a slight change to the BEP20 base standard.
...
/**
 * ARTAN Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract ARTANStandardToken is ARTANToken, Ownable {
    
    using ARTANMaths for uint256;
    ...
    function transfer(address _to, uint256 _value) returns (bool success) {
        ...
        require(
            ...
            && (msg.data.length >= (2 * 32) + 4)); //mitigates the BEP20 short address attack
...
contract ARTAN is ARTANStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 100000000 * (10 ** uint256(decimals)); // 100 Million tokens, 18 decimal places
    string constant public name = "ARTAN"; //fancy name: eg ARTAN 
    string constant public symbol = "ATN"; //An identifier: eg ARTAN
