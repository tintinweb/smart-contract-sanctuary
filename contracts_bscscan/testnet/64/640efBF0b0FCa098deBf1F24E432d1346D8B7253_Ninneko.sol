...
contract Ninneko is Initializable, ERC721Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    event PetCreated(address indexed ownerId, uint256 indexed petId, uint256 matronId, uint256 sireId, uint8 generation);
    ...
    function breed(uint256 _matronId, uint256 _sireId) external payable onlyPetBreedOwner(_matronId, _sireId) {
        ...
        require(_isParent(_matronId, _sireId), "Can't breed between these two");
        require(_isParent(_sireId, _matronId), "Can't breed between these two");
