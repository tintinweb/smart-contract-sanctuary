...
import "../Bein20/BeinRC20.sol";

contract BeinFactory20 {
    ...
    function createNewToken(
        ...
        BeinRC20 token = new BeinRC20(owner, name, symbol);
...
contract BeinRC20 is Context, IERC20, IERC20Metadata {
    ...
    function _beforeTokenTransfer(
        ...
        require(_msgSender() == from, "not token owner");
    }
