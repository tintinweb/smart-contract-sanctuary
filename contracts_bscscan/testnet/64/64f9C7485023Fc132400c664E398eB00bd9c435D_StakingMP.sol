...
contract StakingMP {
  ...
  constructor(
    ...
    _owner = owner;
    InvestPlans.push(InvestPlan({title: "Bronze", min_amount: 10000*10**18, max_amount: 24999*10**18, percent: 0, term: 3*60}));
    InvestPlans.push(InvestPlan({title: "Bronze", min_amount: 10000*10**18, max_amount: 24999*10**18, percent: 46, term: 6*60}));
    InvestPlans.push(InvestPlan({title: "Silver", min_amount: 25000*10**18, max_amount: 74999*10**18, percent: 0, term: 3*60}));
    InvestPlans.push(InvestPlan({title: "Silver", min_amount: 25000*10**18, max_amount: 74999*10**18, percent: 46, term: 6*60}));
    InvestPlans.push(InvestPlan({title: "Gold", min_amount: 75000*10**18, max_amount: 149999*10**18, percent: 0, term: 3*60}));
    InvestPlans.push(InvestPlan({title: "Gold", min_amount: 75000*10**18, max_amount: 149999*10**18, percent: 46, term: 6*60}));
    InvestPlans.push(InvestPlan({title: "Platinum", min_amount: 150000*10**18, max_amount: 0, percent: 0, term: 3*60}));
    InvestPlans.push(InvestPlan({title: "Platinum", min_amount: 150000*10**18, max_amount: 0, percent: 46, term: 6*60}));
  }
  ...
  function testCount(uint256 id) public view returns(uint256){
    uint256 count;
    for (uint256 i = 0; i < users[msg.sender].deposits.length; i++) {
      if(users[msg.sender].deposits[i].investplan == id){
        if(users[msg.sender].deposits[i].status == 1){
