...
contract PIPERINU2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PiperINU2";
    //change the token symbol
    string constant _symbol = "PINU2";
    //dont change that
    ...
    address public marketingFeeReceiver = 0xf1A59e7904d8C3C6A3a533B774BD82fBa4aCdaaD;
