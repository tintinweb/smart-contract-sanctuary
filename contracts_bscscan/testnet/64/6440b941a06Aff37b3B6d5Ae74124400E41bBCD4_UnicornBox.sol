...
contract PriceController is Ownable, IPriceController {
    ...
    function getPrice(uint256 amountIn, address tokenIn, address tokenOut) external view override returns(uint256 amountOut) {
