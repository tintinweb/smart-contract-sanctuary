...
contract Airdrop is Ownable {
    ...
    modifier onlyVestedRecipient() {
        require(
            ...
            "recipient haven't got any airdrop."
        );
        _;
    }

    /**
     * @dev Transfer token to this contract and locked given amount with the given duration.
    ...
    function addAirdrop(
        ...
        require(
            ...
            "recipient is already claimed airdrop"
        );
        require(
        ...
        require(
            ...
            "airdrop amount must be greater than 1 $TOKEN"
        );
