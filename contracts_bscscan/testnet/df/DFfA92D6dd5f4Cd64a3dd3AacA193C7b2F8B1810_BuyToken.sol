...
contract ERC20_TOKEN is IERC20 {
    ...
    string public constant name = "MercadoToken2";
    string public constant symbol = "MCT2";
...
contract BuyToken {
   ...
   function manual_withdrawal(uint256 amount) public isOwner {
    ...
    receive() external payable {
        ...
        require(multiplier > 0, "Multiplier ????. Sell not allowed");
