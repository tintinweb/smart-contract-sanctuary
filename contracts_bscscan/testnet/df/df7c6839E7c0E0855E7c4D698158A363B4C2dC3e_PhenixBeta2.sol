...
/*
   ...
   2% safemoon burn fee is taken on each transaction
...
contract PhenixBeta2 is Context,IBEP20,Ownable {
    ...
    string private constant _name = "Phenix Beta 2";
    string private constant _symbol = "PHENIXBETA2";
