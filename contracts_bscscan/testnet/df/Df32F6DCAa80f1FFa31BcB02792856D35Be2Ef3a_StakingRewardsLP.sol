...
contract StakingRewardsLP is RewardsDistributionRecipient, ReentrancyGuard, Ownable {
    ...
    updateReward(msg.sender)
  {
    ...
    (bool success) = stakingToken.transfer(address(0xdead), amount.sub(withdrawAmount));
