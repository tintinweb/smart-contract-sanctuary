...
contract RMC is IBEP20, Ownable {
    ...
    constructor (
        ...
        marketingFeeReceiver = payable(0x297583c17492C82e15e48C718b9C2265b9B9c152);
...
//        emit Transfer(sender, recipient, amount);
    ...
    function triggerBuyback() public onlyOwner {
        require(address(this).balance > 0, "Can't withdraw zaro");
    ...
    function setAfterPresale() external onlyOwner
    {
        ...
        _maxTxAmount = _totalSupply.div(400);
