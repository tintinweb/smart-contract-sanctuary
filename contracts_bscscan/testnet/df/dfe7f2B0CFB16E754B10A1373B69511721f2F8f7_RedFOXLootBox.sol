...
contract RedFOXLootBox is VRFConsumerBase, Ownable {
    ...
    function openRandomCards(
        ...
        emit Results(cardIds[0]);
        emit Results(cardIds[1]);
        emit Results(cardIds[2]);
        emit Results(cardIds[3]);
        emit Results(cardIds[4]);
        emit Results(cardIds[5]);
    }
