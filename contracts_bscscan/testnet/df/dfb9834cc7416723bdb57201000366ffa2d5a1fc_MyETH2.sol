...
contract DividendDistributor is IDividendDistributor {
    ...
    function changeToken(address newToken) external override onlyToken {
        uint256 previousAmount = TargetToken.balanceOf(address(this));
...
contract MyETH2 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MyETH2";
    string constant _symbol = "MyETH2";
    ...
    address public marketingFeeReceiver = address(0x83726AcdD57a1c934eDaE55C6D0445F8B182967a);
    ...
    constructor () {
        ...
        TargetToken = 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06;
