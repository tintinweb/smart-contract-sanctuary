...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // Initial emission rate: 1 MERD per block.
    ...
    constructor(Mermaid _merd,  IMerdReferral _merdReferral) public {
        merd = _merd;
    ...
    // Update the given pool's MERD allocation point and deposit fee. Can only be called by the owner.
    function set(
        uint256 _pid,
        uint256 _allocPoint,
        uint16 _withdrawFeeBP,
