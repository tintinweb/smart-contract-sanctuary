    ...
    ReentrancyGuard
{
        ...
        onlyIfVestingScheduleNotRevoked(vestingScheduleId)
    {
        ...
        uint256 PaidNftListeningValue = _getNftListeningValue(vestingSchedule.beneficiary, vestingSchedule.tokenId);
    ...
    function _getNftListeningValue(address beneficiary, uint256 tokenId) public view returns(uint256){
        return token2value[beneficiary][tokenId];
    }
