...
contract NFT is ERC721Enumerable , ReentrancyGuard , Ownable{
    ...
    constructor() ERC721("Galaxy Heroes", "Galaxy Heroes" ,"https://game.galaxyheroesx.com/api/index/index/id/") Ownable() {
        ...
        maxNumOfDay = 5;
		wallet = 0x08c6dBa15496d38e82F183bbd75B5e52C015683E;
    ...
    function buyBlindBox(uint256 _boxId) public {
		...
		IERC20(blindBoxMap[_boxId].token).transferFrom(msg.sender,wallet,blindBoxMap[_boxId].amount);
        ...
        //IERC20(blindBoxMap[_boxId].token).transfer(wallet, blindBoxMap[_boxId].amount);
    }
