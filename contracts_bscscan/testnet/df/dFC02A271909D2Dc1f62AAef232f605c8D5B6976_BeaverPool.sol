...
// Root file: contracts/pools/BeaverPool.sol
...
contract BeaverPool is IPoolStrategy, Ownable, Pausable, ReentrancyGuard {
    ...
    function depositFor(address account, uint256 amount) external {
        require(msg.sender == address(beaverMinter), "only BeaverMinter");
    ...
    function withdraw(uint256 amount) public override nonReentrant {
        ...
        beaverToken.transfer(msg.sender, amount);
    ...
    function _deposit(uint256 amount, address _to) private whenNotPaused {
        ...
        beaverToken.transferFrom(msg.sender, address(this), amount);
