...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = _owner;
        creator = 0x909DD7a490612941328728C932B496Eb23344F3a;
...
contract METEOR is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address public gameContract = 0x909DD7a490612941328728C932B496Eb23344F3a;
    string constant _name = "Meteor";
    string constant _symbol = "Meteor";
    ...
    // uint256 devFee = 1; // will transfer to METEOR address every transfer
    // uint256 buybackFee = 2; // will transfer to METEOR address every transfer
    // uint256 reflectionFee = 5; // will transfer to METEOR address every transfer
    // uint256 marketingFee = 3; // will transfer to METEOR address every transfer
    // uint256 gameFee = 4; // will transfer to GAME address every transfer
    // uint256 totalFee = 15;
    uint256 foundationFee = 0;
    uint256 gameFee = 5;
    uint256 totalFee = 5;
    ...
    constructor() Auth(msg.sender) {
        ...
        foundationFeeReceiver = msg.sender;
    ...
    function setDEX() external authorized capGasPrice {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBFoundation = amountBNB.mul(foundationFee).div(totalFee);
        ...
        (bool successDev, /* bytes memory data */) = payable(foundationFeeReceiver).call{value: amountBNBFoundation, gas: 3000000}("");
    ...
    function setFees(uint256 _foundationFee, uint256 _gameFee, uint256 _feeDenominator) external authorized capGasPrice {
        if(feesLocked) {
            require( _foundationFee.add(_gameFee) < (_feeDenominator.div(4)) );
        }
        foundationFee = _foundationFee;
        gameFee = _gameFee;
        totalFee = _foundationFee.add(_gameFee);
    ...
    function setFoundationFeeReceiver(address _foundationFeeReceiver) external authorized capGasPrice {
