...
IP2Coin is built upon the fundamentals of Buyback and increasing the investor's value
...
contract IP2Coin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xeDAc648F319680948336cF3216803922597E3Ae1); // Marketing Address
    ...
    string private _name = "IP2 Coin";
    string private _symbol = "IP2";
