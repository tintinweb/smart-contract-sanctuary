...
contract CinemaDraft is IBEP20, Ownable
{
    ...
    string private constant _name = 'Cinema Draft';
    string private constant _symbol = 'CD3D';
    ...
    uint256 private  balanceLimit = 20000000 * 10**_decimals;
    uint256 private  sellLimit = 200000 * 10**_decimals;
    uint256 private  buyLimit = 10000000 * 10**_decimals;
