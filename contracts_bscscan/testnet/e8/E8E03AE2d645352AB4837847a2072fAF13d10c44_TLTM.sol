...
// File contracts/tokens/deflational/extensions/FeeToAddr/FeeToAddr.sol


pragma solidity ^0.8.0;
contract FeeToAddrDeflToken is DeflationaryToken, FeeToAddress {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
...
// File contracts/tokens/deflational/extensions/FeeToAddr/TLTM_constructed.sol


pragma solidity ^0.8.0;
contract TLTM is FeeToAddrDeflToken, AbstractBurnableDeflToken {
    constructor(
        string memory tName, 
        string memory tSymbol, 
        uint256 totalAmount,
