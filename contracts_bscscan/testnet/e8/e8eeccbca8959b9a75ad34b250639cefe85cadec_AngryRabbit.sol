...
/**
 _______           _        _                  _________ _______  _        _______  _       
(  ____ \|\     /|( (    /|| \    /\|\     /|  \__   __/(  ___  )| \    /\(  ____ \( (    /|
| (    \/| )   ( ||  \  ( ||  \  / /( \   / )     ) (   | (   ) ||  \  / /| (    \/|  \  ( |
| (__    | |   | ||   \ | ||  (_/ /  \ (_) /      | |   | |   | ||  (_/ / | (__    |   \ | |
|  __)   | |   | || (\ \) ||   _ (    \   /       | |   | |   | ||   _ (  |  __)   | (\ \) |
...
FUNKY TOKEN is a Tokenomic created for people who want to see the moon !
...
contract AngryRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "FUNKYTOKEN";
    ...
    address public marketingWallet = 0xB215585C1E17F6DFE0983a7e760e3da09D12c714;
    address payable public _marketingWallet = payable(0xB215585C1E17F6DFE0983a7e760e3da09D12c714);
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       **/
        ...
        uint256 _totalFeesForBNB = _marketingFee.add(_marketingFee).mul(2);
        uint256 lpPart = contractTokenBalance.mul(_marketingFee).div(_totalFeesForBNB).div(2);
        
        uint256 marketingAndDevelopmentPart = contractTokenBalance.sub(lpPart).div(2);
        uint256 marketingAndDevelopmentPart2 = contractTokenBalance.sub(lpPart).div(2);
