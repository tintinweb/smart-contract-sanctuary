    ...
    ERC20PausableUpgradeable
{
    ...
    function initialize() public initializer {
        __Ownable_init();
        __ERC20_init("BANG Decentralized", "BANG");
    ...
    uint256 public _BuytaxFee = 3; // % of transactions will be redistributed among holders
    ...
    uint256 public _BuymarketingFee = 300; // % of transactions will be kept for marketing wallet
    uint256 public _SelltaxFee = 27; // % of transactions will be redistributed among holders
    uint256 public _SellliquidityFee = 1000; // % of transactions will be kept for liquidity
    uint256 public _SellburnFee = 0; // % of transactions will be burned
    uint256 public _SellmarketingFee = 300; // % of transactions will be kept for marketing wallet
    uint256 public _transferTaxFee = 3;
    uint256 public _transferLiquidityFee = 300;
    uint256 public _transferburnFee = 0;
    uint256 public _transfermarketingFee = 300;
    ...
    address public marketingWallet = 0xeDDE1f5f13fddcEbd0e2dc48576751c2b396F89f;
    ...
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out BANG!");
