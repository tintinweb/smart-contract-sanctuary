...
contract StrategyNative is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isCAKEStaking = false; // always set to FALSE
    bool public isNativeVault = false; // always set to FALSE
    ...
    address public uniRouterAddress =
        0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // not used, no buyback

    address public constant wbnbAddress =
        0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // not used
