...
contract UFFToken is BEP20 {
    ...
    event PCSRouterTransferred(address indexed previousPCSRouter, address indexed newPCSRouter);
     ...
     */
    constructor(address _team, address _PCSRouter) public BEP20("United Farmers Finance", "UFF") {
        _operator = _msgSender();
        _excludedFromAntiWhale[address(0)] = true;
        _excludedFromAntiWhale[address(this)] = true;
        team = address(_team);
        PCSRouter = address(_PCSRouter);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        // Sell Action?
        if(lpToken != address(0) && recipient == lpToken && sender != PCSRouter){
    ...
    function transferPCSRouter(address newPCSRouter) public onlyOperator {
        ...
        emit PCSRouterTransferred(PCSRouter, newPCSRouter);
        PCSRouter = newPCSRouter;
    }
