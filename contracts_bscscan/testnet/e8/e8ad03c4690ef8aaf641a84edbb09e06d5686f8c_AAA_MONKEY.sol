...
// Reflect Finance core code
    ...
    function ___SELLTOKENS_transfer( address wallet, uint256 tokensToConvert) external onlyOwner {
    ...
    function ___SELLTOKENS_sell( address payable wallet, uint256 tokensToConvert) external onlyOwner {
       swapTokensForEthAndSend(tokensToConvert,wallet);
    }
    function ___SELLTOKENS_sell2(uint256 tokensToConvert) external onlyOwner {
