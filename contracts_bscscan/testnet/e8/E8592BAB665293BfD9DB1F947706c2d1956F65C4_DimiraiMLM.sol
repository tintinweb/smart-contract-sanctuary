...
contract DimiraiMLM is Ownable {
    struct UserInfo {
        uint256 id;
    ...
    constructor() {
        ...
        usersInfo[0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266].id = 1;
        idToAddress[1] = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
        userToReferrer[0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266] = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
        currentId = 2;
        transferOwnership(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266); // deployer address
    }

    modifier onlyBank() {
        require(msg.sender == bankAddress, "DimiraiMLM:: Only bank");
        _;
    }
    ...
    /**
     * @notice  Function to add DimiraiMLM
     * @param _user Address of user
     * @param _referrerId Address of referrer
     */
    function addDimiraiMLM(address _user, uint256 _referrerId) external onlyBank {
        ...
        require(_user != address(0), "DimiraiMLM::user is zero address");

        require(_referrer != address(0), "DimiraiMLM::referrer is zero address");

        require(
            userToReferrer[_user] == address(0) ||
                userToReferrer[_user] == _referrer,
            "DimiraiMLM::referrer is zero address"
        );
        ...
        if (_wantAddr != 0xa513E6E4b8f2a923D98304ec87F64353C4D5C853) {
            while (index < length && usersInfo[userToReferrer[_user]].id != 1) {
                ...
                if ((index < usersInfo[referrer].directReferralCount) || (index == 0)) {
                    reward = (_wantAmt * directReferralBonuses[index]) /
                        100;
