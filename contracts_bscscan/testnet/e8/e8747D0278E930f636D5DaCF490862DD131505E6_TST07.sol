...
contract TST07 is ERC20, Ownable {
    using SafeMath for uint256;
 
    uint256                     private _totalSupply = 150000000000000;
    ...
    constructor() public ERC20("TST07", "TST07") { 
    ...
    function _transfer(
        ...
        emit debugTransfer(amount, maxSellTransactionAmount, swapAuthorized, amountExeeded, isOwner);
    ...
    function setMaxSellTxAMount(uint256 amount) external onlyOwner{
        uint256 oldAmount = maxSellTransactionAmount;
        maxSellTransactionAmount = amount;
        emit debugMaxSellAmount(
            oldAmount,
            amount,
