...
contract TotallyARugPull is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**6 * 10**18;

    string private _name = "Totally A Rug Pull";
    string private _symbol = "TARP";
    ...
    address public charityWallet = 0x758d89D5962256e0e57d099bBE89B2185D0Ed321;
