...
contract WealthCoinInterface {
  function buy(address _referredBy) payable public;
  function exit() public;
}

contract WealthVaultTest01 {
    ...
    WealthCoinInterface public wealthCoin;
    ...
    uint256 public constant WEALTH_COIN_FEE = 5;
    ...
    constructor(uint256 _releaseTime, uint256 _minDeposit, WealthCoinInterface _wealthCoin) public {
        owner = msg.sender;
        wealthCoin = WealthCoinInterface(_wealthCoin);
        releaseTime = _releaseTime;
        minDeposit = _minDeposit;

        tarifs.push(Tarif(260, 400));
        tarifs.push(Tarif(150, 300));
        tarifs.push(Tarif(85, 214));
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        uint256 wealthCoinFee = msg.value.mul(WEALTH_COIN_FEE).div(100);
        wealthCoin.buy.value(wealthCoinFee)(address(this));
    ...
    function migrateWealthCoin() public returns(uint256 bnbAmount){
      require(msg.sender == owner, "unauthorized call");
