...
contract FanDungeonLand is ERC721, ERC721Enumerable, OperatorControl {
    ...
    mapping(uint256 => uint256) internal _landTypes;

    /**
     * @notice view type of land
     * @param _tokenId: token Id
     */
    function viewType(uint256 _tokenId) external view returns (uint256) {
        return _landTypes[_tokenId];
    }

    /**
     * @notice set type of land
     * @param _tokenId: token Id
     * @param _type: type of land
     */
    function setType(uint256 _tokenId, uint256 _type) external onlyOperator {
        _landTypes[_tokenId] = _type;
    }
