...
contract ANKH is Context, IERC20, IERC20Metadata {
    ...
    bool public areDepositsEnabled;
    //////////////////////////// DEPOSIT VARS ////////////////////////////
    ...
    bool public isGameSystemEnabled;
    ...
    function InitializeContract() external OnlyDirector() {
        require(!isInitialized, "Initialization can only happen once.");
        isInitialized = true;
        ...
        minDepositAmount = totalSupplyOfToken.div(10**15);   // set to 1 ANKH
        minWithdrawAmount = totalSupplyOfToken.div(10**15);   // set to 1 ANKH
        ...
        //////////////////////////// KOFFEESWAP VARS ////////////////////////////  
        // routerAddressForDEX = 0xc0fFee0000C824D24E0F280f1e4D21152625742b;        // CHANGEIT
    ...
    function TransferDirectorAccount(address newDirector) external OnlyDirector()  {   
        emit DirectorAccountTransferred(directorAccount, newDirector, timeGameContractWasEnqueued);
    ...
    function IncreaseDepositAmountTotal(uint256 betAmount, address playerAddress) external {     // TODO - is this actually going to work?
    ...
    function DecreaseDepositAmountTotal(uint256 betAmount, address playerAddress) external {     // TODO - is this actually going to work?
        require(isGameSystemEnabled, "Game System must be enabled.");
        require(isGameContractAddress[_msgSender()], "Caller is not a Game Contract");  
        depositAmountTotal[playerAddress] = depositAmountTotal[playerAddress].sub(betAmount);
    }

    function IncreaseTotalWinStreak(address playerAddress) external {     // TODO - is this actually going to work?
        require(isGameSystemEnabled, "Game System must be enabled.");
        require(isGameContractAddress[_msgSender()], "Caller is not a Game Contract");  
    ...
    function IncreaseTotalLossStreak(address playerAddress) external {     // TODO - is this actually going to work?
        require(isGameSystemEnabled, "Game System must be enabled.");
        require(isGameContractAddress[_msgSender()], "Caller is not a Game Contract");  
