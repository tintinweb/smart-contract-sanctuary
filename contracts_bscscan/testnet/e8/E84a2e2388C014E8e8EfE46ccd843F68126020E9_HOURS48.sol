...
contract HOURS48 is Context, IERC20 {
    ...
    uint256 private startingSupply = 48_000_000_000;

    string constant private _name = "HOURS48";
    string constant private _symbol = "HOURS48";
    ...
    address payable private _marketingWallet = payable(0xAC1892F4fdE9582EA5e83E17F4b77320543E1298);
    ...
    uint256 private maxWPercent = 48;
    uint256 private maxWDivisor = 10000;
    ...
    uint256 private swapThreshold = (_tTotal * 5) / 1000000;
    uint256 private swapAmount = (_tTotal * 5) / 1000000;
...
//===============================================================================================================
    ...
    function setTaxesBuy(uint16 reflect, uint16 liquidity, uint16 marketing) external onlyOwner {
        ...
        require(liquidity + reflect + marketing <= 4450);
    ...
    function setMaxTxPercent(uint256 percent, uint256 divisor) external onlyOwner {
        ...
        require(check >= (_tTotal / 100), "Max Transaction amt must be above 1% of total supply.");
        _maxTxAmount = check;
    ...
    function setMaxWalletSize(uint256 percent, uint256 divisor) external onlyOwner {
        uint256 check = (_tTotal * percent) / divisor;
        require(check >= (_tTotal / 100), "Max Wallet amt must be above 1% of total supply.");
