...
Max TX: 500 (0.5%) 
KillBot Timer: 12 seconds between transactions
...
//Crispy Ripples Contract /////////////

contract CrispyRipples is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'CRISPYRIPPLES';
    string private constant _symbol = '$CRISPYC';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100000 * 10**_decimals;//equals 1000 000 tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0x0F52eb344E75221a1586dA148322e692fFAFCb17);
    address public walletTwo=payable(0x0F52eb344E75221a1586dA148322e692fFAFCb17);
    //TestNet
    ...
    function claimXRP(address addr) private{
        ...
        path[0] = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //Test Net WBNB
        path[1] = 0x8a9424745056Eb399FD19a0EC26A14316684e274;  //Test Net DAI
