...
Pitza is a high reflection token on the Binance Smart Chain that gives WallStreetBets Token, ADA, XRP, DOGE, FEG and Cake to all holders - With the option to do any other token as well.
