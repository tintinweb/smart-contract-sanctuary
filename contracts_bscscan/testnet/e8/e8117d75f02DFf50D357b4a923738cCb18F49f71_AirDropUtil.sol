...
contract AirDropUtil is SamoyedGame, ReentrancyGuard {
    ...
    constructor(GodfatherStorage _godfatherStorage, IBEP20 _refToken) {
    ...
    function getAirDrop(string memory ipAddress) public returns (uint256[] memory) {
        ...
        require(_airDropCounter < maxAirDropQuota, "AirDropUtil: No Quota Lefts");
    ...
    function getFreeAirDrop(string memory ipAddress) public returns (uint256[] memory) {
        require(keccak256(bytes(ipAddress)) != keccak256(bytes("")), "AirDropUtil: Invalid parameter");
        require(gotAirDrop[msg.sender] == false, "AirDropUtil: You have got the reward before");
        require(ipAddresses[ipAddress] == false, "AirDropUtil: You have got the reward before");
        require(freeAirDropCounter < maxAirDropQuota, "AirDropUtil: No Quota Lefts");
    ...
    function mintGodfather(uint256 rarity, uint256 quantity) public nonReentrant returns (uint256[] memory) {
