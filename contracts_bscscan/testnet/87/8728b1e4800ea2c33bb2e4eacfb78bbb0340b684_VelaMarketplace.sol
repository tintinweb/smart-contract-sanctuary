...
contract VelaMarketplace is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event History(string action, address erc721, uint256 tokenId, address seller, address buyer, address erc20, uint256 price, bool auction, uint256 beginAuction, uint256 endAuction, uint256 timestamp);
    ...
    function listingPrice(address erc721, address erc20, uint256 tokenId, uint256 price) public whenNotPaused nonReentrant inWhitelist(erc721, erc20){
        ...
        emit  History("listingPrice", erc721, tokenId, msgSender, address(0), erc20, price, false, 0,0, block.timestamp);
    }
    ...
    function buy(address erc721, uint256 tokenId) public payable whenNotPaused nonReentrant {
        ...
        emit History("buy", erc721, tokenId, info.seller, msgSender, info.erc20, info.price, false, 0,0, block.timestamp);
    }
    ...
    function cancelListing(address erc721, uint256 tokenId) public whenNotPaused nonReentrant{
        ...
        emit History("cancelListing", erc721, tokenId, msgSender, address(0), info.erc20, info.price, false, 0,0, block.timestamp);
    }
