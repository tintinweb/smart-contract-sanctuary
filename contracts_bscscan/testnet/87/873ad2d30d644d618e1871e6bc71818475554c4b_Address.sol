...
contract Cairo is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 209100 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cairo";
    string private _symbol = "EGPYT";
    ...
    uint256 public _maxTxAmount = 500 * 10**6 * 10**19;
    uint256 private numTokensSellToAddToLiquidity = 6336 * 10**6 * 10**19;
