...
// File: contracts/FoxHouseRoyaltyRegistry.sol
 ...
 * @title IERC721 Non-Fungible Token Creator basic interface
 */
contract FoxHouseRoyaltyRegistry is OwnableUpgradeable, IERC721CreatorRoyalty {
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////////////
    function InitializeFoxHouseRoyaltyRegistry(address _iERC721TokenCreator) public initializer
    {
        require(
            _iERC721TokenCreator != address(0),
            "constructor::Cannot set the null address as an _iERC721TokenCreator"
