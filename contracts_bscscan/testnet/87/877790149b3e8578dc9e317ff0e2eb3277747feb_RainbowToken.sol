...
contract RainbowToken is Context, IERC20, Ownable {
    ...
    // General Info
    string private _name     = "Magic Willy RainbowToken";
    string private _symbol   = "MWRT";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x7f43dCb0eB0d1Dc84214b8BB9fbB1Cf061d95727); // Marketing address used to pay for marketing
