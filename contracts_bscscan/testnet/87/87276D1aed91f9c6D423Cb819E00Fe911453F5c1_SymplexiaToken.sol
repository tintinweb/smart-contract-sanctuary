...
//   ======================================
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       // has been manually sent to the contract. 
        ...
        if (swappedCoins > 0)  _addLiquidity(liquidityAmount, swappedCoins);
...
contract SymplexiaToken is  AntiWhale,  BaseLiquidity,  BaseRFI {
  ...
  //
    ...
    constructor () ERC20 ("DEBUG27", "DBG27") BaseToken (5, 5, 5, 
                                     0x9dc83Ab4f953B78ddcEEd5f7c1c879cd890B43Ac, 
                                     0xB2019936b9ea80e3fAC12007597495794C9b749d, 1 ) {}
