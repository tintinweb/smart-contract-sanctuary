...
contract StakingRewards is Ownable, ReentrancyGuard {
    ...
    function rewardPerToken() public view returns (uint256) {
        ...
        console.log("Reward per token : %s", rewardPerTokenStored +
    ...
    function earned(address _account) public view returns (uint256) {
        console.log("Earned: %s", ((userInfo[_account].balance *
    ...
    function deposit(uint256 _amount, uint256 _lockTime) public nonReentrant updateReward(msg.sender) {
        require(userInfo[msg.sender].isLocked != true, "deposite: user already deposited and rewards locked");
