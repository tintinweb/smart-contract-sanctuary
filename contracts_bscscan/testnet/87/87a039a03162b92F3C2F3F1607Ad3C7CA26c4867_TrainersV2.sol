...
contract TrainersV2 is ITrainersV2, Initializable, ERC721Upgradeable, AccessControlUpgradeable {
    ...
    uint256 public constant STAMINA_RECOVER_SPEED_IN_SECONDS = 20; // 5 mins 1 STA TODO: revert to 300s after testing
    ...
    function get(uint256 id) public view noFreshLookup(id) returns (uint16, uint8, uint8, uint64) {
        ...
        return (trainer.exp, trainer.level, trainer.element, staminaTimestamp[id]);
    }
    ...
    // =========================== BATTLE ===========================
    function getBattleDataAndDrainStamina(uint256 id, uint8 _stamina) external onlyGameContract returns(uint96) {
    ...
    function fuse(uint256 _fusionID, uint256 _burnID) public onlyGameContract {
    ...
    // =========================== CLAIM EXP ===========================
    function claimExp(uint256 id, uint16 exp) public onlyGameContract {
        Trainer storage trainer = trainers[id];
