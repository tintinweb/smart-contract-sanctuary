...
~ PLAN REQUIREMENTS: 
  plan 1 - min. 10 BUSD, max. of 8000 BUSD
  plan 2 - min. 10 BUSD, max. of 6500 BUSD
  plan 3 - min. 10 BUSD, max. of 5000 BUSD
  plan 4 - min. 10 BUSD, max. of 3500 BUSD
...
~ ANTI-WHALE CONTROL FEATURES:
  ...
  Max active deposit limit of 23000 BUSD.
  Max withdraw amount of 1230 BUSD per day.
...
contract busdavaxmix {
	...
	uint256 public MAX_WITHDRAW = 15000 ether;
	uint256 public WALLET_LIMIT = 2300 ether;
	...
	uint256 public LOTTERY_TICKET_PRICE = 100 * 1e17; /** 0.80 BUSD **/
	...
	constructor(address ownerAddress, address payable projectAddress, address payable marketingAddress, address payable communityAddress) {
        ...
        plans.push(Plan(200, 30, 80 * 1e17, 8000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(40,  70, 80 * 1e17, 6500 ether, 0, 0, 0, 0, true));
        plans.push(Plan(60,  65, 80 * 1e17, 5000 ether, 0, 0, 0, 0, true));
        plans.push(Plan(80,  60, 80 * 1e17, 3500 ether, 0, 0, 0, 0, true));
	}
