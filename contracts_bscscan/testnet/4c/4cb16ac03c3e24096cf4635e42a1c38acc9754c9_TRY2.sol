...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x830f5B3C88b9552fBA5dFd66d5F65C6B4a6204EE;
...
contract TRY2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x137e4184c7ef30CC4825Da260cE562751F50F2F4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TRY2 TOKEN";
    string private _symbol = "TRY2";
