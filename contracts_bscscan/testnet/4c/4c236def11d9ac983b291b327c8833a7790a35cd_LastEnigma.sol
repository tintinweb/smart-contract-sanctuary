...
contract LastEnigma is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Last Enigma";
    string constant _symbol = "LEnigma";
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountRealEnigma);
