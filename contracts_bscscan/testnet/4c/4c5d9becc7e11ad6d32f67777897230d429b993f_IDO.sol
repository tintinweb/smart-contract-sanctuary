...
contract IDO {
    ...
    uint256 public startDate = 1633370400;                 
    uint256 public endDate = 1738378000;               
    
    uint256 public totalTokensToSell = 50000000 * 10**9;          
    uint256 public tokenPerBnb = 20000 * 10**9;              
    uint256 public minPerTransaction = 2000 * 10**9;                  
    uint256 public maxPerUser = 1000000 * 10**9;                
    ...
    modifier checkSaleRequirements(uint256 buyAmount) {
        require(now >= startDate && now < endDate, 'IDO time passed');
    ...
    function buyIDO(uint256 buyAmount) public payable checkSaleRequirements(buyAmount) {
    ...
    // function to set the IDO start date
    // only owner can call this function
