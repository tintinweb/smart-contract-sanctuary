...
contract UNIWAVE is  ERC721PresetMinterPauserAutoId  {
    ...
    constructor() ERC721PresetMinterPauserAutoId("UNIWAVE", "UNIWAVE", "https://localhost")
    {
        owner = msg.sender;
    ...
    function poolMinting(address to) payable public {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721PresetMinterPauserAutoId: must have minter role to mint");
        super.mint(to);
    }
