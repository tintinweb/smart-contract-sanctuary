 ...
 * 3% token REWARDS, 3% EXECUTION, 1% BURN, 1% DEVs - 3% for LIQUIDITY 


 Supply: 20,000,000,000 (20 Billions)
 Max Wallet Size = 300,000,000 (300 Million or 1,5%)
 Max Transaction Size = 20,000,000 (20 Million or 0,1%)

 Reflection/Taxes: 3% in Tokens to Holders, 3% in Liquidity, 1% to Developers Wallets, 1% Burn , 3% Execution Wallet
 
 Buy Slippage: 11-13% 

 **THE MAX A WALLET CAN HAVE IS 300,000,000! THAT IS 1,5%! YOU CAN SELL A MAX OF 0.1%! ***
 *** ***
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BOOK = IBEP20(address(this));
    ...
    function deposit() external payable override {
        uint256 balanceBefore = BOOK.balanceOf(address(this));
        ...
        uint256 amount = BOOK.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BOOK.transfer(shareholder, amount);
...
contract BOOK is IBEP20, Auth {
    ...
    string constant _name = "Book";
    string constant _symbol = "BOOK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 20000000000 * (10 ** _decimals); // 1,000,000,000,000,000
    ...
    address public marketingFeeReceiver = 0x5A26dA339B31F99a7671561c34b8f25125C4299f;
    address public devFeeReceiver = 0x0F8D6fB35935bDF8f9313CcB4FD09776D2721098;
    address public devFeeReceiver1 = 0x6634a033fA34BA392D5c58fae03dA1cb3066ec97;
    address public devFeeReceiver2 = 0x14B1Dd097B24BC1a9c22AD65EfFca0897d291C43;
    address public devFeeReceiver3 = 0x9A84fe49626D09531c3C5Fd7A6ceC26B18e689Fd;
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver2 = msg.sender;
        devFeeReceiver3 = msg.sender;
    ...
    function swapBack() internal swapping {
        if(liquidityFeeAccumulator >= swapThreshold && autoLiquifyEnabled){
            ...
            (success, ) = payable(devFeeReceiver1).call{value: amountBNBDev, gas: 30000}("");
            if(success){ devFees = devFees.add(amountDev); }
            (success, ) = payable(devFeeReceiver2).call{value: amountBNBDev, gas: 30000}("");
            if(success){ devFees = devFees.add(amountDev); }
            (success, ) = payable(devFeeReceiver3).call{value: amountBNBDev, gas: 30000}("");
            if(success){ devFees = devFees.add(amountDev); }
