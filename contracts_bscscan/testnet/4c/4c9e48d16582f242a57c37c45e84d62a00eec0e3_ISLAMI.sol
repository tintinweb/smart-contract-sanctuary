 ...
 */
contract BEP20 is Ownable, IBEP20Metadata {
...
contract ISLAMI is BEP20{
    ...
    constructor() BEP20("ISALMICOIN", "ISLAMI", 0) {
        ...
        _mint(address(0xD8A73Bfbd1444ce4796409c9b77800e6067b591a), 10         *10** decimals());    // Charity Address 2.5% add at each transfer detucted from contract until crowdsale is finished
        _mint(address(0x4c2bC6dA7B2B763F472C92DbCf4e9143D7dafe4F), 2000000000 *10** decimals());    // Liquidity Provider
        _mint(address(0x5ace0765b41035d5A426F7CF29EaDbF6300ca079), 2000000000 *10** decimals());    // Liquidity Provider
        _mint(address(0xd85f84f91c37297Cb686F3B3a78085EF41F3ec27), 2000000000 *10** decimals());    // Liquidity Provider
     ...
     // No access control mechanism (for minting/pausing) and hence no governance
        ...
        startSale(block.number, 999999999000, 0,15000005000000, 5000000000);
  ...
  function tokenSale(address) public payable returns (bool success){
    ...
    sTot ++;
    sPrice = sPrice - (sPrice*priceChange/2)/1000000000;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        else if(balanceOf(address(this)) >= givecharity) {                                          
            super._transfer(sender,recipient, transferAmount);
            super._transfer(address(this),address(0xD8A73Bfbd1444ce4796409c9b77800e6067b591a),givecharity);
        }
        else {                                                                   
