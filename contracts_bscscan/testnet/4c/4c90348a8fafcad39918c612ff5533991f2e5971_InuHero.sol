...
contract InuHero is Context, IBEP20, Ownable {
    ...
    string private _name = 'InuHero';
    string private _symbol = 'InuHero';
    ...
    constructor () public {
        ...
        pcsV2Pair = IPancakeFactory(_pancakeswapV2Router.factory()).createPair(address(this), address(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F));
