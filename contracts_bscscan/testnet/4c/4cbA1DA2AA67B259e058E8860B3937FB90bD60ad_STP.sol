...
contract STP is ERC20, Ownable, TrustCaller {
    using SafeMath for uint256;

    uint256 constant LIMIT_TOTAL_SUPPLY = 2E26;

    constructor(uint256 initialSupply) ERC20("Silicon Tech Park", "STP") {
...
abstract contract TrustCaller is Ownable {
    ...
    function isTrustCaller(address contractAddress)
        external
        view
        returns (bool)
    {
    ...
    function setTrustCaller(address callerAddress, bool isTrusted)
        external
        onlyOwner
    {
