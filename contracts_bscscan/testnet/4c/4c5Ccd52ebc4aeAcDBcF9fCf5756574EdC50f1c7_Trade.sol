...
contract Trade {
    ...
    function swapToken(Swapping memory swapMetaData,Sign memory sign) public returns(bool) {
        ...
        if(swapMetaData.nftType == BuyingAssetType.ERC721) {
            ...
            transferProxy.erc721safeTransferFrom(IERC721(swapMetaData.swapnftAddress0), swapMetaData.from, swapMetaData.to, swapMetaData.swapTokenId0);
        ...
        if(swapMetaData.nftType == BuyingAssetType.ERC1155)  {
            ...
            transferProxy.erc1155safeTransferFrom(IERC1155(swapMetaData.swapnftAddress0), swapMetaData.from, swapMetaData.to, swapMetaData.swapTokenId0, swapMetaData.qty, ""); 
            transferProxy.erc1155safeTransferFrom(IERC1155(swapMetaData.swapnftAddress1), swapMetaData.to, swapMetaData.from, swapMetaData.swapTokenId1, swapMetaData.qty, "");
