...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD); 
...
contract GoldenLink  is IERC20, Auth {
    ...
    using SafeMath for uint256;
     ...
     address RWRD = 0xF8A0BF9cF54Bb92F17374d9e9A321E6a111a51bD;  
    ...
    string constant _name = "ArcticTundra";

    string constant _symbol = "$SnowFlake";
    ...
    constructor () Auth(msg.sender) {
        ...
        isMaxWalletExempt[0x78b1872460E83100c11e3a9190D403bd39D67f74] = true;
