...
contract BababebToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BababebToken";
    string constant _symbol = "BABABEB";
    ...
    function _takeFeeForBNBTransfer(uint256 tFeeForStorage) private {
        uint256 currentRate = _getRate();
        uint256 rFeeForStorage = tFeeForStorage * (currentRate);
        _rOwned[address(this)] = _rOwned[address(this)] + (rFeeForStorage);
