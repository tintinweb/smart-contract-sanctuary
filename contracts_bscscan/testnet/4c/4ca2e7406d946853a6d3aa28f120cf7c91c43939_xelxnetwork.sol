...
contract xelxnetwork is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string public Function1 = "VNetwork";
    string public Function2 = "VDex";
    
    function SetFunction1(string memory name1) public onlyOwner {
        Function1 = name1;
    }
    
    function SetFunction2(string memory name2) public onlyOwner {
        Function2 = name2;
    }
