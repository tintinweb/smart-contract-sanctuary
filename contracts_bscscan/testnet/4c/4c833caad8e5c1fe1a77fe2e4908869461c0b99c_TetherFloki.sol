...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        // Solidity only autoMAKERally asserts when dividing by 0
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MAKER = IBEP20(0x55d398326f99059fF775485246999027B3197955);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MAKER.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MAKER);
        ...
        uint256 amount = MAKER.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MAKER.transfer(shareholder, amount);
...
contract TetherFloki is IBEP20, Auth {
    using SafeMath for uint256;

    address MAKER = 0x55d398326f99059fF775485246999027B3197955;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TetherFloki";
    string constant _symbol = "TetherFloki";
    ...
    uint256 maxSellForOneDayPercentage    =  10;
    ...
    function setMaxSellForOneDayPercentage(uint256 _maxSellForOneDayPercentage) external authorized {
        maxSellForOneDayPercentage = _maxSellForOneDayPercentage;
