...
contract TESTIN1 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8f9613abA80608931c852D187A11DB58a0f40fC4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TESTIN1";
