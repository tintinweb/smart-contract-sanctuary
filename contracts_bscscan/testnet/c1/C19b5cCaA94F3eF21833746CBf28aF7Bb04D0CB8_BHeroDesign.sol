    ...
    IBHeroDesign
{
    ...
    function setAbilityRate(uint256[] memory value)
        external
        onlyRole(DESIGNER_ROLE)
    {
        abilityRate = value;
        ...
        returns (uint256 nextSeed, uint256 encodedDetails)
    {
        ...
        (seed, details.bombSkin) = Utils.randomRangeInclusive(
            seed,
            1,
            BOMB_SKIN_COUNT
        );
        (seed, details.bombPower) = Utils.randomRangeInclusive(
            seed,
            stats.bombPower.min,
            stats.bombPower.max
        );
        ...
        (seed, details.abilities) = Utils.weightedRandomSampling(
            seed,
            abilityIds,
            rate,
            stats.ability
