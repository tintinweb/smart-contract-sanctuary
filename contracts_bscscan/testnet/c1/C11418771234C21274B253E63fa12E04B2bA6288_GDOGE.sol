...
contract GDOGE is Context, IERC20, Ownable {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x706E47a7c00Fb1cC5e8DD6b8DaCDeCbf344585c4, 'We can not exclude Uniswap router.');
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(sent){
            _tokenTransfer(address(this), 0xD0db9F3FaDE935c8D7493fa09d5a6f02Aa3Da04A, charityPortion, false);
            emit Transfer(address(this), 0xD0db9F3FaDE935c8D7493fa09d5a6f02Aa3Da04A, charityPortion);
        } else {
        ...
        if(sent){
            _tokenTransfer(address(this), 0xFD6c85312D04B28ccbdcF0B67A457Fa5140e3762, marketingPortion, false);
            emit Transfer(address(this), 0xFD6c85312D04B28ccbdcF0B67A457Fa5140e3762, marketingPortion);
        } else {
