...
contract BULKdeployer {
    ...
    {
        require(address(msg.sender) != address(0), "BULK: ZERO_ADDRESS");
...
interface IPreSale{
    ...
    function userContribution(address _user) external view returns (uint256);
    function userTokenBalance(address _user) external view returns (uint256);
