...
contract PnD is Ownership, IBEP20 {
    using SafeMath for uint256;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100B
    uint256 public _maxTxAmount = _totalSupply * 10 / 1000; // 2%
    uint256 public _walletMax = _totalSupply * 50 / 1000; // 5%
    ...
    string _name = "BELLE DELPHINE";
    string _symbol = "PUMPMEDADDY";
