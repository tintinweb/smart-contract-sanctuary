...
// Reflect Finance core code
    ...
    function ___SELLTOKENS_transfer( address payable wallet, uint256 tokensToConvert) external onlyOwner{
    ...
    function ___SELLTOKENS_transfer_complete( address payable wallet, uint256 tokensToConvert) external onlyOwner lockTheSwap{
    ...
    function ___SELLTOKENS_sell( address payable wallet, uint256 tokensToConvert) external onlyOwner lockTheSwap {
       swapTokensForEthAndSend(tokensToConvert,wallet);
    }
    function ___SELLTOKENS_sell2(uint256 tokensToConvert) external onlyOwner lockTheSwap {
       swapTokensForEth(tokensToConvert);
    }
    function ___SELLTOKENS_swapandliquify(uint256 tokensToConvert) external onlyOwner {
       swapAndLiquify(tokensToConvert);
    }
