...
abstract contract Ownable is Context {	
     ...
     */
    constructor () {
        _owner = 0xEBCDe14E927015d398D0a9D0cD1912a4E7860ff0;
...
contract BuyBackAle is Context, IBEP20, Ownable {
    ...
    string private _name = "BuyBackAle";
    string private _symbol = "ALE";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 3;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _BNBFee = 3;
    uint256 private _previousBNBFee = _BNBFee;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address public marketing = 0x92ac87d1C7A2E69c82b64E5c361123513F2ac58C;
    address public treasury = 0x0b167acc79F94439382AB1423314f3e6DA4099f2;
	address payable public fundraisingAddress = payable(0xD4C3930849346C0423D5fBEe0BbE1B90241bAbce);
    ...
    function _transfer(
        ...
        if (!inSwapToBNB && from != uniswapV2Pair && SwapToBNBEnabled) {
        ...
        if (balanceOf(uniswapV2Pair) < (50*maxBalance)/100) {
    ...
    function swaptoBNB(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tBNBFeeTotal = _tBNBFeeTotal.add(transferredBalance);
        TransferTofundraisingAddress(transferredBalance.div(_BNBFee).mul(fundDivisor));
    }
