...
contract BITFARMS_V2 {
    ...
    IBEP20 token;
    IBEP20 tokenT;
    uint256 public constant INVEST_MIN_AMOUNT = 1e18; 
    ...
    constructor(address payable wallet, address payable _wallet1, IBEP20 ADD_T1, IBEP20 ADD_T2  ) public {
    ...
    function invest(
        ...
        token.transfer(BuyBurnWallet, fee1);
        	...
        	tokenT.transfer(msg.sender, _amount.mul(10**18).div(1*10**20));
