...
contract StakingPoolFactory is PoolCreator {
    ...
    event PoolCreated(
        ...
        // coinSymbolAndPoolType[0] = coinToPredictSymbol,
        // coinSymbolAndPoolType[1] = poolType,
        // string[2] coinSymbolAndPoolType,
    ...
    WrappedTokenDistributor
{
        ...
        WrappedTokenDistributor(_swapRouter, _usdToken, _wrappedTokenContract)
    {
        ...
        // ToDo: _variables[8] is burnRate
        stakeTaxRate = _variables[8];
        minimumStakeAmount = _variables[9];   
        // poolType = _variables[10];
        // wrappedTokenSymbol = _variables[11];
