    ...
    UUPSUpgradeable
{
    ...
    // event
    event Claim(address indexed signer, address indexed user, uint256 amount, uint256 nonce);

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() public initializer {
        __ERC20_init("Chakra", "CKR");
    ...
    function claim(
        ...
        emit Claim(signer, msg.sender, amount, nonce);
    }
}
