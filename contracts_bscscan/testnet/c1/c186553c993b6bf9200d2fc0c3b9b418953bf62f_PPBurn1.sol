...
10% Burn Fee
5% Marketing
1B supply ♠ 25M max tx ♠ 50M max wallet ♠
 */
...
contract PPBurn1 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PPBurn1";
    string constant _symbol = "PPBurn1";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x04BC430Cd0FFfA94170DC03496119dDD01599fc2;
