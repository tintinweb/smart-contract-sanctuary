...
contract ISTPledgeLp is Context, Ownable {
    ...
    //******************************************
    function testSetPledegAmount(uint256 _pledgeAmount) public returns (bool) {
        pledegTotalAmount = _pledgeAmount;
        return true;
    }

    function testSetMintAmount(uint256 _mintAmount) public returns (bool) {
        mintTotalAmount = _mintAmount;
        return true;
    }

    function testSetPledgeData(uint256 _pledgeToken) public returns (bool) {
