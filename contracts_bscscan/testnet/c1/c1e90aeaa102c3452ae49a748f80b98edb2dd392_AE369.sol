...
Team modifier for wallets etc

About Genius Boy Æ369
...
Dev Tokens Wallet Fee

This is a fee (taken in tokens) that can be used to replace any of the standard BNB fees if needed.


Change 

Wallet for DEV - 0x406D07C7A547c3dA0BAcFcC710469C63516060f0 2
Wallet for PCS
Wallet for AE369
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x406D07C7A547c3dA0BAcFcC710469C63516060f0; //AE369 Wallet
...
contract AE369 is Context, IERC20, Ownable {
    ...
    //Pre-Public launch on the GenTokens LaunchPad. 5T GEN/2 required to purchase before public launch. 
    ...
    */
    ...
    //Dev tokens fee
    uint256 public _FeeDevTokens = 5; 
    ...
    //amount (in tokens) at launch set to 1% of total supply
