...
contract TOKENEMERALD is IBEP20, Auth {
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Contrato WBNB
    address DEAD = 0xDe8Bb8894b7bf875b55b8A8B8e7Ffde2EA20f118; // Endereço de queima
    address ZERO = 0xD156Fa16DF4098964D9C8d37709d888e3621103e; // Endereço de queima
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x9685727f8263B8403EE762F4BFB620Ad3008bBC1; // carteira de pré venda (coloque uma sua mesmo se não tiver pré venda)
