...
contract Hosehla is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e12  * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Hosehla";
    string private _symbol = "HSH";
    ...
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out HSH!");
