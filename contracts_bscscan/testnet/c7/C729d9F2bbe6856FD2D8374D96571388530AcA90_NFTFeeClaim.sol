...
contract NFTFeeClaim is INFTFeeClaim, TokensRecoverable, ReentrancyGuard
{
    ...
    //map address to map of nft id to claim
    ...
    function checkNFTBalance(address _address, address _nftContract, uint256 _nftId) public view returns (bool)
    {
        return IERC721(_nftContract).ownerOf(_nftId) == _address;
    }
