...
contract BabyDogeInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xEdaf0298db71E3D65276e874Dab319Cd573EA0Bc); // Marketing Address
    address payable public techWalletAddress = payable(0xa350369f04b7Aaa7d261DD54356993Ca42109B8b); // Tech Address
    ...
    string private _name = "Baby test k";
