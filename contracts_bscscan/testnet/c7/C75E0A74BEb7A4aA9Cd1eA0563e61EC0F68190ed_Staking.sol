...
contract Staking is Ownable {
    ...
    function deposit(uint256 _amount) public {
        ...
        stakingWallets[msg.sender].unlockBlock = block.number + 200; // three months
        stakingWallets[msg.sender]._2Claim = stakingWallets[msg.sender].unlockBlock + 200; // 14 days
        stakingWallets[msg.sender]._3Claim = stakingWallets[msg.sender]._2Claim + 200;
        stakingWallets[msg.sender]._4Claim = stakingWallets[msg.sender]._3Claim + 200;
