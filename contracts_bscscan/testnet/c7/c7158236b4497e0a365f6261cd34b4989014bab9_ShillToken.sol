 ...
 *     ____        __                 ___       ___                  ______      __                  ____                 __                   
 *    /\  _`\     /\ \         __    /\_ \     /\_ \                /\__  _\    /\ \__              /\  _`\              /\ \                  
 *    \ \,\L\_\   \ \ \___    /\_\   \//\ \    \//\ \               \/_/\ \/    \ \ ,_\             \ \ \L\ \     __     \ \ \____   __  __    
 *     \/_\__ \    \ \  _ `\  \/\ \    \ \ \     \ \ \                 \ \ \     \ \ \/              \ \  _ <'  /'__`\    \ \ '__`\ /\ \/\ \   
 *       /\ \L\ \   \ \ \ \ \  \ \ \    \_\ \_    \_\ \_                \_\ \__   \ \ \_              \ \ \L\ \/\ \L\.\_   \ \ \L\ \\ \ \_\ \  
 *       \ `\____\   \ \_\ \_\  \ \_\   /\____\   /\____\               /\_____\   \ \__\              \ \____/\ \__/.\_\   \ \_,__/ \/`____ \ 
 *        \/_____/    \/_/\/_/   \/_/   \/____/   \/____/               \/_____/    \/__/               \/___/  \/__/\/_/    \/___/   `/___/> \
 *                                                                                                                                       /\___/
 *                                                                                                                                       \/__/ 
...
contract ShillTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("ShillToken_Dividend_Tracker", "ShillToken_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 40000 * (10**18); //must hold 40000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "ShillToken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "ShillToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ShillToken contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "ShillToken_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");	
        require(newClaimWait != claimWait, "ShillToken_Dividend_Tracker: Cannot update claimWait to same value");
...
contract ShillToken is ERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    ...
    ShillTokenDividendTracker public dividendTracker;
    ...
    address payable public  marketingWallet = payable(0x96A719FE394a078E45E8e17e7D02ccdf29F5CF3a);
    ...
    constructor() ERC20("Shill Token", "SHILL") {
        BNBRewardsFee = 2;
        liquidityFee = 5;
    	...
    	dividendTracker = new ShillTokenDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "ShillToken: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ShillToken: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ShillToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ShillToken: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ShillToken: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "ShillToken: Cannot update gasForProcessing to same value");
