...
contract Windmill_Fund is AccessControlEnumerable {
    ...
    function getTotalFreePWR() public view returns (uint256){
    ...
    function getPWRAmountFromBUSD(uint256 amountBUSD) public view returns (uint256){
        ...
        uint256 PWRSupply = getTotalFreePWR();

        uint256 nbPWRToMint = 100 ether;
        if (PWRSupply > 0 && nbBUSD > 0){
            nbPWRToMint = amountBUSD * PWRSupply / nbBUSD;
        }
