...
/**
    ...
    %2 of each transaction to the dev wallet(in BNB)
    %1 of each transaction to holders
    
    I make this token #GGG (Gigabyte Games), the first coin earning returns quarterly from all its affiliate gaming sites
    linked to Gigabyte Games.
    Every Quarter 60% of the gaming net profit will be redistributed to all holders according to the holders' % held
    The other 40% of the net profit will be used to create more gaming sites and apps for you to earn returns on.
*/
...
contract GGG is Context, IBEP20, Ownable {
    ...
    string private _name     = "Gigabyte Games";
