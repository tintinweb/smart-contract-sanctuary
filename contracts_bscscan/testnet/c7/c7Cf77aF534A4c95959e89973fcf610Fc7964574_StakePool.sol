...
// constructor
    constructor(address _stakeToken) {
        ...
        // Fill Tiers
        addTier(20000, 750, uint32(1 days));
        addTier(10000, 300, uint32(1 days));
        addTier(5000, 130, uint32(1 days));
        addTier(2000, 40, uint32(1 days));
        addTier(1000, 15, uint32(1 days));
...
// core functions
    function stake(uint _amount) external {
        ...
        require(_amount >  10 ,  "minimum 10!");
        require((_amount +  stakeBalances[msg.sender])  >= 1000 , "user should stake a minimum 1000!");
