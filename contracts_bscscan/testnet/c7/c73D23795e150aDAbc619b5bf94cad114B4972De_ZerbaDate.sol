...
contract ZerbaDate is Ownable, ERC721 {
    struct Metadata {
        uint16 year;
        uint8 month;
        uint8 day;
    ...
    constructor() ERC721("ZerbaDate", "ZERBADATE") {
    ...
    function mint(uint16 year, uint8 month, uint8 day, uint8 color, string memory title) public {
