...
contract AngryRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiBoom";
    ...
    address public marketingWallet = 0xB83CF0D9F9f375A1a4E936927ce4E657623C7e47; //marketing Wallet
    uint256 public _buybackFee = 2;
    address payable public _buybackWallet = payable(0xeBc92462e24a4878D7DC02564655e8b2f1d84151); // buyback Wallet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 _totalFeesForBNB = _liquidityFee.add(_buybackFee);
        ...
        if( marketingAndDevelopmentPart > 0)
        {
            ...
            transferToAddressBNB(_buybackWallet,newBalance);
    ...
    function setBuyBackPercent(uint256 Fee) external onlyOwner() {
        _buybackFee = Fee;
    }
