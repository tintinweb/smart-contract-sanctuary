...
contract HentaiholidaySingle is
    ...
    
 {
    ...
    function SalewithToken(address bidtoken,address bidaddr,  uint256 amount, uint256 tokenId) public{
        // uint256 val = pBEPent(amount, serviceValue).add(amount);
        BEP20 t = BEP20(bidtoken);
        t.allowance(bidaddr, address(this));
        ...
        // require( approveValue > _adminfee.add(roy.add(netamount)), "Insufficient Balance 0");
        // require( approveValue >= _adminfee.add(roy.add(netamount)), "Insufficient Balance 1");
