...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        if (user.amount > 0) {
            ...
            if (pending > 0) {
                require(IBEP20(BNB).balanceOf(address(msg.sender)) >= 2000000000000000, "Deposit:: Not Enough BNB");
                IBEP20(BNB).safeTransferFrom(address(msg.sender), feeAddress, 1000000000000000);
