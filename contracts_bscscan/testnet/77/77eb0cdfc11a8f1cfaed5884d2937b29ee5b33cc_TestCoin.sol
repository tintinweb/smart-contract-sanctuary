...
contract TestCoin is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 4000000000 * 10**18; // 4% Supply
    uint256 public _maxWalletToken = 4000000000 * 10**18; //4% Supply
    uint256 public swapTokensAtAmount = 1000000 * 10**18; //1M
    uint256 public buyBackUpperLimit = 1000000 * 10**18; //1M
    ...
    function setActivePairFees(bool true_or_false) external view onlyOwner{
    ...
    function updateDevelopmentWallet(address newWallet) external onlyOwner{
       ...
       function updateTeamWallet(address newWallet) external onlyOwner{
        require(teamAddress != newWallet ,'Wallet already set');
        teamAddress = payable(newWallet);
        ItsActivedFees[devAddress] == false;
    }
