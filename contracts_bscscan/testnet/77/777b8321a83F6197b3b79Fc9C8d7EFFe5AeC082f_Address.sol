...
/**
    ...
    */
    ...
    contract token is Context, IERC20, Ownable {
        ...
        string private _name = "DOGE FOOD";
        string private _symbol = "DOGE FOOD";
        ...
        address public ownerAddres = address(0x5C2B4466cF8e05D72BF4Dcd249478f8997629F33);
        address public devAddress = address(0x5C2B4466cF8e05D72BF4Dcd249478f8997629F33);
        ...
        function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            swapTokensForDividendToken(half.mul(2));
        }
        ...
        function swapTokensForDividendToken(uint256 tokenAmount) private {
            ...
            IERC20(_dividendToken).transfer(address(devAddress), dividends);
