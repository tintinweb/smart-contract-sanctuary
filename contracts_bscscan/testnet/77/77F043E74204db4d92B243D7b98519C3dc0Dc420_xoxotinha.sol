...
contract xoxotinha is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 2000 * 10**18; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _taxFee = 0;
    uint256 public _liquidityFee = 95;
    ...
    uint256 public _numTokensSellToAddToLiquidity = 150 * 10**18; 
    uint256 public _maxWalletToken = 200 * 10**18; 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Xoxota';
    string private _symbol = 'xota';
