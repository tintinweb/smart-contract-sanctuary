...
interface ApproveAndCallFallBack {
    function callback(address from, uint256 tokens) external returns(bool);
}
  ...
  */
   ...
   */
    function ApproveAndCall(address spender, uint tokens) public returns (bool success) {
        ...
        return ApproveAndCallFallBack(spender).callback(msg.sender, tokens);
    }
