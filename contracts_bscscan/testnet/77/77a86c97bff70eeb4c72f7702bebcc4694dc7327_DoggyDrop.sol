...
contract DoggyDrop is IERC721{
    ...
    function startAirdrop() external onlyDeployer {
        require(!publicDrop);
        dropStartTime = 1632413940;  //////////////////////////////////////////////////////////////////// sale start time by unixtimestamp
        endTime = dropStartTime + 28 days;
        publicDrop = true;
        emit DropBegins();
    }
    ...
    function claimDrop(uint256 index, address account) external reentrancyGuard {
