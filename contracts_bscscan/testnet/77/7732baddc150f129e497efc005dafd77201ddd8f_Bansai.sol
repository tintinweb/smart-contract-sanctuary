...
contract Bansai is ERC20("BansaiToken", "BANSAI"), Ownable {
    ...
    constructor() public // address _marketingaddr,
    // address _feesaddr,
    // address _devaddr

    {
        marketingAddr = 0xc17D00AD3B2Ed99b45CC3AAf7c3045BDfEc8D03F;
        //feesAddr = 0x85eE68703D80Fe7958C146BB61623c3163E458E9;
        devAddr = 0x2bf977F1D8F6E3bC281CFF257c42A775bE42d7B0;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        uint256 bnbLiquidity = address(this).balance.sub(initialBalance).div(
            1000
        );
        uint256 bnbMarketing = address(this).balance.sub(initialBalance).sub(
            bnbLiquidity
        );

        // send bnb to the marketing Wallet
        payable(marketingAddr).transfer(bnbMarketing);
