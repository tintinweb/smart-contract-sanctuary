...
/**
                Safehold token, projects you can trust.
                    |>>>                        |>>>
                    |                           |
                _  _|_  _                   _  _|_  _
               | |_| |_| |                 | |_| |_| |
...
_---~            |     |  .   /+++++++\    . | .   |         ~---_
     ...
     ____--`~    '--~~__ .    |+++++++|----~    ~`---,              ___^~-__
                         ...
                         BabyIlluminati token
                    Verification code: AACLMR202101
*/
...
contract BabyIlluminati is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyIlluminati";
    string constant _symbol = "BabyIllu";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x5b2ff29B79197CC119c65679F0E4C7a021c8cC2f;
