...
contract BnbTradebot {
    ...
    uint256 public bot_daily_rate = 500;
    ...
    function withdraw() external {
        ...
        //     for(uint8 i = 0; i <= top_earners.length; i++) {
        //         if(i == top_earners.length){
        //             break;
        //         }
                
        //         if(users[temp_addr].total_payouts > users[top_earners[i]].total_payouts){
        //             temp_top = top_earners[i];
        //             top_earners[i] = temp_addr;
        //             temp_addr = temp_top;
        //         }
        //     }
        // }
        // if(top_earners.length == 0){
        //     top_earners.push(msg.sender);
        // } else {
        //     address temp_addr = msg.sender;
        //     address temp_top;
    ...
    // function getTopEarners(uint256 _top) public view returns (address[] memory _top_earners){
    ...
    //     for(uint8 i = 0; i <= top_earners.length; i++) {
    //         if(i == _top){
    //             _top_earners.push(temp_addr);
    //             break;
    //         }
            
    //         if(users[temp_addr].total_payouts > users[top_earners[]].total_payouts){
    //             temp_top = top_earners[i];
    //             top_earners[i] = temp_addr;
    //             temp_addr = temp_top;
    //         }
    ...
    // function example(address _address) public view returns (address[] memory) {
