...
contract StriteToken is Context, IERC20, Ownable {
    ...
    uint256 private devSupply = 600000 * 10**18;

    address payable private _1stDevWallet;
    address payable private _2ndDevWallet;
    
    string private _name = "Strite";
    string private _symbol = "STRI";
    ...
    constructor (address payable _devAddress, address payable _devWallet) {
        ...
        _1stDevWallet = _devAddress;
        _2ndDevWallet = _devWallet;
        
        _transfer(_msgSender(), _1stDevWallet, devSupply);
    ...
    function _takeDev(uint256 tDev) private {
        ...
        _rOwned[_2ndDevWallet] = _rOwned[_2ndDevWallet].add(rDev);
        if(_isExcluded[_2ndDevWallet]){
            _tOwned[_2ndDevWallet] = _tOwned[_2ndDevWallet].add(tDev);
        }
    }
