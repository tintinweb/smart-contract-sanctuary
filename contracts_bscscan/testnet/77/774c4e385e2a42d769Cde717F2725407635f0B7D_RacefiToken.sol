...
contract RacefiToken is Initializable, ERC20, AccessControl, ReentrancyGuard {
    ...
    constructor(address _multiSigAccount) ERC20("Racefi", "RAFI") {
    ...
    function revokeVestingToken(address _beneficiary) external onlyAdmin {
...
library AddressesLib {
    using AddressesLib for Addresses;
    ...
    function at(Addresses storage self, uint256 index) internal view returns (address) {
