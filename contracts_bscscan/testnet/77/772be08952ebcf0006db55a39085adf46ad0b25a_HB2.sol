...
contract HB2 is Context, IBEP20, Ownable {
    ...
    string private _name = "HB2";
    string private _symbol = "$HB2";
    ...
    uint256 public timeDay = 3 * 60 * 60;       // 3h
    uint256 public timeWeek = 9 * 60 * 60;      // 9h
    uint256 public timeMonth = 15 * 60 * 60;     // 15h
    ...
    constructor () public {
        ...
        IPancakeV2Router02 _pancakeV2Router = IPancakeV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // PancakeSwap: Router Testnet
