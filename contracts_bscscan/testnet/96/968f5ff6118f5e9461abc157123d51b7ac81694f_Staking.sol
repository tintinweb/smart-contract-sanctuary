...
contract Staking is Ownable {
    ...
    /**
        @notice stake AlphaOX to enter warmup
        @param _amount uint
        @return bool
     */
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        IERC20( AlphaOX ).safeTransferFrom( msg.sender, address(this), _amount );
    ...
    /**
        @notice forfeit xOX in warmup and retrieve AlphaOX
     */
    function forfeit() external {
        ...
        IERC20( AlphaOX ).safeTransfer( msg.sender, info.deposit );
    }
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        IERC20( AlphaOX ).safeTransfer( msg.sender, _amount );
    }
    ...
    /**
        @notice returns contract AlphaOX holdings, including bonuses provided
        @return uint
     */
    function contractBalance() public view returns ( uint ) {
        return IERC20( AlphaOX ).balanceOf( address(this) ).add( totalBonus );
    }
