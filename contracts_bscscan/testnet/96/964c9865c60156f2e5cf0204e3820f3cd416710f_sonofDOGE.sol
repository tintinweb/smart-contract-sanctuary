...
contract DividendDOGE is IDividendDOGE {
...
contract sonofDOGE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor (
        ...
        distributor = new DividendDOGE(address(router));
    ...
    function triggerSDogeBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
