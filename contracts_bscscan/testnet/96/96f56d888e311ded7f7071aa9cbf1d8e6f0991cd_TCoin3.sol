...
contract TCoin3 is Context, IERC20, Ownable {
    ...
    string private _name = "TCoin3";
    string private _symbol = "TCOIN3";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
         // Create a uniswap pair for this new token - Test Swap - 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3   PS - 0x10ED43C718714eb63d5aA57B78B54704E256024E
