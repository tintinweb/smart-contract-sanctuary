...
//DOGILLA Binance Smart Chain Token
...
contract dogilla is Context, IERC20, Ownable {
    ...
    string private constant _name = 'test'; // to be determined
    string private constant _symbol = 'test'; // to be determined
    uint8 private constant _decimals = 9;

    //Supply and Reflected Supply and other options
    uint256 private constant _decimalFactor = 10**uint256(_decimals);
    uint256 private _tokenTotal = 100000 * 10**6 * 10**9;
