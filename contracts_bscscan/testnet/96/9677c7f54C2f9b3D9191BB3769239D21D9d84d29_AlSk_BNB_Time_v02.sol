...
contract AlSk_BNB_Time_v02 is Context, IBEP20, Ownable {
   ...
   //end skizzo
    ...
    function viewMaxBalance() view external returns (string memory) {
        ...
        calculatedbalance = maxBalance - (maxBalance/100)*10 ;
        result = "MaxBalance: ";
        result = concatenate(result, uint2str(maxBalance));
        result = concatenate(result, ", CalculatedBalance: ");
        result = concatenate(result,uint2str(calculatedbalance));
        result = concatenate(result, ", BBack Balance: ");
        result = concatenate(result,uint2str(address(this).balance));
       return result;
