 ...
 * 
    ...
    * Max per Holder: ~2% of Total Supply (20.000 tokens)
    * Max sell: 1% of supply (10.000 tokens)
    * Sell cool down: 30 minutes
    
    5% LP, 8% reflection, 2% Burn
...
contract PepeDegen is IBEP20, Ownable
{
    ...
    address public constant TeamWallet=0x7ca12f82097656BE43e17a10847F180Bb6f6CB05;
    address public constant ChanWallet=0xE995f6Ee7A77332a16d367A18984416475C7f351;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        uint256 tokensToBeBurnt=_calculateFee(amount, tax, _bTx);
        //staking and liquidity Tax get treated the same, only during conversion they get split
        uint256 contractToken=_calculateFee(amount, tax, _sTx+_lTx);
    ...
    uint8 public marketingShare=95;
    ...
    function claimBUSD(address addr) private{
        ...
        path[1] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // testnet 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7  //mainnet 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenForLiquidity=(tokenToSwap*_lTx)/totalTax;
    ...
    function pepeWithdraw() public onlyOwner{
        uint256 totalPepe = marketingBalance * 75 / 100;
        uint256 totalChan = marketingBalance - totalPepe;
        marketingBalance=0;
        (bool sent,) =TeamWallet.call{value: (totalPepe)}("");
        require(sent,"withdraw failed");
        
        (sent,) =ChanWallet.call{value: (totalChan)}("");
        require(sent,"withdraw failed");
    } 
    ...
    function setSellTaxes(uint8 sellTax) public onlyOwner {
      _sellTax=sellTax;
    }
