...
// * DiceWin.io - fair games that pay BNB. Version 5.
//
//
...
//
// * Refer to https://DiceWin.io/whitepaper.pdf for detailed description and proofs.
...
contract dicewin {
    ...
    // threshold. On rare occasions DiceWin.io croupier may fail to invoke
    ...
    // Funds withdrawal to cover costs of DiceWin.io operation.
    ...
    //                    by the DiceWin.io croupier bot in the settleBet transaction. Supplying
    ...
    // in a situation like this, just contact the DiceWin.io support, however nothing
