...
contract TYCOONTOKANPLAN is Ownable {
    bytes32 data_;
    ...
    function multisendTYCOONTOKAN(address _senderads, uint256 _amttoken, uint256 membcode, uint256 rcode, uint64 plan) public {
       // uint256 total = msg.value;
