...
Max Buy/Sell: 1% (10,000,000,000,000)
Max Wallet:   2% (20,000,000,000,000)
...
contract SurpRise is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbFCfE658332b04b4184226aa4Dbe427183bac159); // Marketing Address
    ...
    string private _name = "SurpRise";
    string private _symbol = "SURPRISE";
    ...
    uint256 public _maxTxAmount = 10000000 * 10**6 * 10**9;      // Max Buy/Sell: 1.0%
    uint256 public _maxWalletAmount = 20000000 * 10**6 * 10**9; // Max Wallet:    2.0%
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressBNB(marketingAddress,
