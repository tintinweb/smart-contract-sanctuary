...
contract PoolFactory is Ownable {
    ...
    mapping(address => uint256) public total_contributors;
    ...
    function recordContribution(address sender, address pool) external {
        contributors[pool].push(sender);
        total_contributors[pool] = total_contributors[pool] + 1;
    }
