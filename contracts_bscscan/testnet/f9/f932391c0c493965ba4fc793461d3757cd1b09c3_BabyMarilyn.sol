...
contract BabyMarilynDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("BabyMarilyn_Dividend_Tracker", "BabyMarilyn_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 40000 * (10**18); //must hold 40000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "BabyMarilyn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BabyMarilyn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyMarilyn contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BabyMarilyn_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");	
        require(newClaimWait != claimWait, "BabyMarilyn_Dividend_Tracker: Cannot update claimWait to same value");
...
contract BabyMarilyn is ERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    ...
    BabyMarilynDividendTracker public dividendTracker;
    ...
    address payable public  marketingWallet = payable(0x37e194FA789118eaE4eb76f70b5C1F4237bA1928);
    ...
    constructor() ERC20("BabyMarilyn", "BMT") {
        BNBRewardsFee = 9;
        liquidityFee = 3;
    	...
    	dividendTracker = new BabyMarilynDividendTracker();
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyMarilyn: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabyMarilyn: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyMarilyn: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyMarilyn: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BabyMarilyn: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BabyMarilyn: Cannot update gasForProcessing to same value");
