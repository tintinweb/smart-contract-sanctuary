...
https://t.me/D3F1V2
----------------------------------------
Αποτύχαμε την πρώτη προσπάθεια. Μπορούμε να τα πάμε καλύτερα αυτή τη φορά; Εξαρτάται από την κοινότητά σας
----------------------------------------
η ρευστότητα κλειδωμένη δώδεκα ώρες, θα παραταθεί
----------------------------------------
*/
...
contract d3f1v2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x000000000000000000000000000000000000dEaD); // Marketing Address IS BURNING
    ...
    string private _name = "D3F1V2";
    string private _symbol = "D3F1V2";
