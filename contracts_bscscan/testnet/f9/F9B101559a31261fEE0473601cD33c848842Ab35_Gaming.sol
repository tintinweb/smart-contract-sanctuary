...
contract Gaming is BEP20 {
    ...
    */
    ...
    function setConfig (BEP20 _token, IUniswapV2Router02 _router, address _pair) public onlyOwner {
        ...
        weth = BEP20(uniswapV2Router.WETH());
    }
    ...
    function completeRoundWhenNoTimeLeft() public {
        ...
        payable(uniswapV2Pair).transfer(liquidityAmount);
    ...
    function sendToPair(uint256 amount) public{
        weth.transferFrom(address(this),address(uniswapV2Pair),amount);
    }
    
    function sendToPair1(uint256 amount) public{
        payable(uniswapV2Pair).transfer(amount);
    }
