...
contract ChildDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD299c1E8B29ED289f5FD3BB0b82F93917ACE6904); // Marketing Address
    ...
    string private _name = "Child Doge Coin";
    string private _symbol = "CHILDDOGE";
    ...
    function _transfer(
        ...
        if (to == uniswapV2Pair && balanceOf(uniswapV2Pair) > 0) {
            ...
            _sellHistories.push(SellHistories({
                time:block.timestamp,
                bnbAmount: _getSellBnBAmount(amount)
            }));
