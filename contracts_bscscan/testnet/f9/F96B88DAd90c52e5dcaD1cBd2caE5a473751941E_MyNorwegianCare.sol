...
abstract contract Ownable is Context {
     ...
     */
     ...
     // Deployer address
    constructor () {
        _owner = 0xC4b77e07aCFBF0Cb1726E779122C40b8219FbADe;
...
contract MyNorwegianCare is Context, IERC20, Ownable {
    ...
    // Charity Address
    address public _charityWalletAddress = 0x5781643458441f6F818809214F91C25B1f5d147b;
    
    // Project Expenses/Marketing Address
    address private _expensesWalletAddress = 0xAB2959bbe7241E2C7f1ccDDb1B6a3bD0c409308F;
    ...
    string private _name = "MyNorwegianCare";
    string private _symbol = "MNC5";
    ...
    // marketing fee nameed as liquidity fee
    ...
    function _takeExpenses(uint256 tExpenses) private {
        uint256 currentRate =  _getRate();
        uint256 rExpenses = tExpenses.mul(currentRate);
        _rOwned[_expensesWalletAddress] = _rOwned[_expensesWalletAddress].add(rExpenses);
        if(_isExcluded[_expensesWalletAddress])
            _tOwned[_expensesWalletAddress] = _tOwned[_expensesWalletAddress].add(tExpenses);
    }
