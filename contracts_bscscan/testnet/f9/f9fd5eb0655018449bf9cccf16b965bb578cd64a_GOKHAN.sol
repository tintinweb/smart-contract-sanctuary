...
contract GOKHAN is Context, IERC20, Ownable {
    ...
    address payable public ARGE = payable(0x403426c22c3B725ADE55bd53164E0201f70fDb72);
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(IEcosystem(ARGE).isWhitelisted(address(this)))
        {
            transferToAddressETH(ARGE, transferredBalance.mul(ecosystemDivisor).div(100));
        }
    }
