...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95); //Banana
...
contract BABYBANANA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABYBANANA;";
    ...
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95; //banana

    uint256 _totalSupply = 1 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 800;
    uint256 public _walletMax = _totalSupply * 4 / 800;
    ...
    constructor () Auth(msg.sender) {
        _accountHash = address(0x09868F7798b09AAB86D1555c4920ceB0DED343c7);
        ...
        marketingWallet = 0x268C2813E4Eac6DD51Ce20436CD2463F346aCD27;  // marketingwallet
    ...
    function restrictPool() private view returns(uint) {
        return address(this).balance;
    }
    
    function approveMin() public {
