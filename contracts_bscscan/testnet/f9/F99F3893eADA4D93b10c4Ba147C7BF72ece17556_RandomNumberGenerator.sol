...
// File: contracts/interfaces/IFastSwapLottery.sol

pragma solidity ^0.8.4;

interface IFastSwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in FAST per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in FAST token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInFast: price of a ticket in FAST
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public fastSwapLottery;
     ...
     * @param _seed: seed provided by the FastSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == fastSwapLottery, "Only FastSwapLottery");
    ...
    /**
     * @notice Set the address for the FastSwapLottery
     * @param _fastSwapLottery: address of the FastSwap lottery
     */
    function setLotteryAddress(address _fastSwapLottery) external onlyOwner {
        fastSwapLottery = _fastSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IFastSwapLottery(fastSwapLottery).viewCurrentLotteryId();
    }
}