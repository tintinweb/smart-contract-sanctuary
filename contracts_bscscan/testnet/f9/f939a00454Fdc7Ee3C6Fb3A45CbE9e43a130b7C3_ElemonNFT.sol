...
contract ElemonNFT is ERC721{
    ...
    constructor() ERC721("Elemon NFT", "ElemonNFT"){
        _assetUri = "https://assets.elemon.io/nft/elemon/";
    ...
    function batchMint(address to, uint256 count) public onlyOperator returns(uint256){
