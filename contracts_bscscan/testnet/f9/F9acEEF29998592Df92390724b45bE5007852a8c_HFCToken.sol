...
contract HFCToken {
    ...
    event Sell(address user_address,uint256 balances);
...
*/
    ...
    function sell(uint256 _value) public {
        ...
        balances[treasure_wallet_address]+= _value.mul(treasure_wallet_fees).div(100);
        balances[pool_address]+= _value.mul(pool_holders_percentage).div(100);
