...
contract GymVaultsStrategyAlpaca is Ownable, ReentrancyGuard, Pausable {
        ...
        returns (uint256)
    {
        ...
        uint256 ibAmount = (_wantAmt * vault.totalSupply()) /
            vault.totalToken();
     ...
     */
    function earn(uint256 _amountOutAmt, uint256 _deadline)
        public
        whenNotPaused
    {
     ...
     */
    function convertDustToEarned(uint256 _amountOutAmt, uint256 _deadline)
        public
        whenNotPaused
    {
        require(isAutoComp, "GymVaultsStrategyAlpaca: !isAutoComp");
