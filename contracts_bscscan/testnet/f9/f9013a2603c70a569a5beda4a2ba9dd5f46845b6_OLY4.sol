...
interface IDEXFactory {
    function createPair(address tokenA, address tokenB) external returns (address PCSpair); // is this correct? pair or pcspair?
}
...
contract OLY4 is IBEP20, Auth {
    ...
    string constant _name = "OLY4";
    string constant _symbol = "OLY4";
