...
contract mutiSwap is Ownable {
   ...
   // address private routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // main net
    ...
    function getParameterpublic() public view returns(uint8,address){
        return (maxSwap,routerAddress);
    }
    
    function setParameter(uint8 maxSwap_ , address routerAddress_)public onlyOwner {
        maxSwap = maxSwap_;
        routerAddress = routerAddress_;
        router = IUniswapV2Router02(routerAddress); 
    }
  
    function wihtdrawSwapFee(uint256 amount) public onlyOwner {
