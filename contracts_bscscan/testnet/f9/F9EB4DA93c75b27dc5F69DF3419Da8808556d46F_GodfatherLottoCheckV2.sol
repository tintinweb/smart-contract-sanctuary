...
contract GodfatherLottoCheckV2 is SamoyedLottoCheck {
    ...
    function claimMultipleReward(uint256 _round, uint256[] memory _tokenIDArray) external nonReentrant {
        ...
        // AwardResultObject _awardResultObject = getLottoResultByRound(_round);
        uint8 round;
        ...
        (round, timestamp, wonNumber, godfatherValidToken, puppyValidToken, winnerSharingQuantity) = samoyedLottoAwardV2
        ...
        // console.log("godfatherWonNumber : %d", godfatherWonNumber);
        // console.log("godfatherValidToken : %d", godfatherValidToken);
...
import "./SamoyedLottoAwardV2.sol";
...
abstract contract SamoyedLottoCheck is ReentrancyGuard, Ownable {
    ...
    SamoyedLottoAwardV2 public samoyedLottoAwardV2;
