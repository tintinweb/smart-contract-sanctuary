...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public constant token = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD
...
contract TestToken2 is ERC20, Ownable {
    ...
    constructor() ERC20("Test Token2", "TToken") {
        ...
        marketingSellFee = 4;
        liquiditySellFee = 1;
        totalSellFees = rewardsSellFee + buyBackSellFee + developmentSellFee + marketingSellFee + liquiditySellFee;
        ...
        marketingBuyFee = 2;
        liquidityBuyFee = 1;
        totalBuyFees = rewardsBuyFee + buyBackBuyFee + developmentBuyFee + marketingBuyFee + liquidityBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	buyBackWallet = address(0xd81522D2FB544EF65a1c2Bd153aA7d0F27c7D234); // set as buyBack wallet
        developmentWallet = address(0x41B80F453a955BCf42dF31698d8894819c5d04E4); // set as development wallet
    ...
    function updateBuyFees(uint256 _buyBackFee, uint256 _rewardsFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        buyBackBuyFee = _buyBackFee;
        rewardsBuyFee = _rewardsFee;
        developmentBuyFee = _developmentFee;
        marketingBuyFee = _marketingFee;
        liquidityBuyFee = _liquidityFee;
        totalBuyFees = buyBackBuyFee + rewardsBuyFee + developmentBuyFee + marketingBuyFee + liquidityBuyFee;
        require(totalBuyFees <= 20, "Must keep fees at 20% or less");
    }
    
    function updateSellFees(uint256 _buyBackFee, uint256 _rewardsFee, uint256 _developmentFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        buyBackSellFee = _buyBackFee;
        rewardsSellFee = _rewardsFee;
        developmentSellFee = _developmentFee;
        marketingSellFee = _marketingFee;
        liquiditySellFee = _liquidityFee;
        totalSellFees = buyBackSellFee + rewardsSellFee + developmentSellFee + marketingSellFee + liquiditySellFee;
    ...
    function updateDevelopmentWallet(address newDevelopmentWallet) external onlyOwner {
        require(newDevelopmentWallet != address(0), "cannot set to address 0");
    ...
    function swapBack() private {
        ...
        bool success;
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForBuyBack + tokensForDevelopment + tokensForMarketing + tokensForRewards;
        ...
        uint256 ethForLiquidity = ethBalance - ethForBuyBack - ethForRewards - ethForDevelopment - ethForMarketing;
