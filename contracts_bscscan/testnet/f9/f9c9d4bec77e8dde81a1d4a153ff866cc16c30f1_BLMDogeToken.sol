...
/** 
   ...
   it's the best part of the #DRCOIN idea, increasing the liquidity pool automatically, 
...
contract BLMDogeToken is Context, IERC20, Ownable {
    ...
    string private _name = "BLMDogeToken";
    string private _symbol = "BLMDOGE";
