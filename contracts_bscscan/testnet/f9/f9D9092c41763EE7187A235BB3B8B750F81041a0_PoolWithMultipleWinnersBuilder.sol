...
// import "../prize-pool/lifetime/LifeTimePrizePoolProxyFactory.sol";
...
contract PoolWithMultipleWinnersBuilder {
  ...
  // event LifeTimePrizePoolWithMultipleWinnersCreated(
  //   LifeTimePrizePool indexed prizePool,
  //   MultipleWinners indexed prizeStrategy
  // );
  ...
  // LifeTimePrizePoolProxyFactory public lifetimePrizePoolProxyFactory;
  ...
  constructor (
    ...
    // LifeTimePrizePoolProxyFactory _lifetimePrizePoolProxyFactory,
  ...
  // function createLifetimeMultipleWinners(
  //   AMCStakingPrizePoolConfig memory prizePoolConfig,
  //   MultipleWinnersBuilder.MultipleWinnersConfig memory prizeStrategyConfig,
  //   uint8 decimals
  // ) external returns (LifeTimePrizePool){
  //   LifeTimePrizePool prizePool = lifetimePrizePoolProxyFactory.create();
  //   MultipleWinners prizeStrategy = multipleWinnersBuilder.createMultipleWinners(
  //     prizePool,
  //     prizeStrategyConfig,
  //     decimals,
  ...
  //   );
  //   prizePool.transferOwnership(msg.sender);
  //   emit LifeTimePrizePoolWithMultipleWinnersCreated(prizePool, prizeStrategy);
  //   return prizePool;
  // }
