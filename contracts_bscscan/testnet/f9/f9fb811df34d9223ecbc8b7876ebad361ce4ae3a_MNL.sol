...
/**
   ...
   1.5% fee auto moved to marketing wallet
...
contract MNL is Context, IERC20, Ownable {
    ...
    string private _name = "MNL";
    string private _symbol = "MNL";
    ...
    uint256 public pvtSaleLockDuration = 180 days;

    uint256 private _launchTime;
    uint256 private sellMultiplier = 150;
    uint256 private baseMultiplier = 100;
    ...
    function transferToPvtInvestor(address recipient, uint256 amount) public onlyOwner returns (bool) {
    ...
    function setMarketingFeePercentToZero() external onlyOwner() {
        _marketingFee = 0;
    }
    ...
    function calculateMarketingFee(uint256 _amount) private view returns (uint256) {
        uint256 fee = _amount.mul(_marketingFee).div(10**2);
        if(isItASell) {
            return fee.mul(sellMultiplier).div(baseMultiplier);
        }
        return fee;
