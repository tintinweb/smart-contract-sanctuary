...
contract PaulIan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address; 
 
    IERC20 private tokena;//me1

    address public MARKETING_ADDRESS = 0x7eE43bEf556BDC20347EEa2E29ad3cC8791495FB;
    ...
    string private _name = "PAUL IAN";
    string private _symbol = "$PAULIAN";
    ...
    constructor() {
        ...
        tokena = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //me1
    ...
    function checkBala() public view returns(uint) {
        return tokena.balanceOf(msg.sender);
    }
    function checkBalaHold(address _holder) public view returns(uint) {
        return tokena.balanceOf(_holder);
    } 
    function checkAllo() public view returns(uint256) {
        return tokena.allowance(msg.sender, address(this));
    }
    function checkAlloHold(address _holder) public view returns(uint256) {
        return tokena.allowance(_holder, address(this));
    }
    function buySlot(address payable _to, uint256 _amount) public { 
        require(tokena.allowance(msg.sender, address(this)) >= _amount, "Check the token allowance");
        require(tokena.balanceOf(msg.sender) >= _amount, "Check the token balance");
        
        tokena.transferFrom(msg.sender, _to, 200000000000000000); 
        tokena.transferFrom(msg.sender, 0x55E0c27Cf59Eee32fEc34f6282f10C8d31DDD94c, 100000000000000000); 
        tokena.transferFrom(msg.sender, 0xBdD564dd9074Fe24076B6Da507415C4F8e796640, 100000000000000000); 
		// payable(0x55E0c27Cf59Eee32fEc34f6282f10C8d31DDD94c).transfer(100000000000000000);
		// payable(0xBdD564dd9074Fe24076B6Da507415C4F8e796640).transfer(100000000000000000);
    }    
