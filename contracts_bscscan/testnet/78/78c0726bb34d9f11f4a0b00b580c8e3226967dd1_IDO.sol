...
contract IDO is ReentrancyGuard, Context, Ownable {
        ...
        returns (uint256)
    {
        ...
        amount = (((beforeFirstClaim[msg.sender] * 10)/100) * ((block.timestamp - claimTime[msg.sender]) / 5 minutes)) - claimed[msg.sender];
    ...
    function changeWaitTime(uint256 _timeToWait) external returns(bool){
        timeToWait =_timeToWait;
        return true;
    }
