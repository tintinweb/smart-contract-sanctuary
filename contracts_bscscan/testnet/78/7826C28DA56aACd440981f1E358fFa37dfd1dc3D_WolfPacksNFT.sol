    ...
    OwnableUpgradeable
{
    ...
    function buyEnergy(uint256 _wolfPackId, uint256 _amountCWOLF) external {
        ...
        uint256 _amountInDollar = Variables(VariablesContractAddress).getDollarsInCWOLF(
            _amountCWOLF
        );
        require(_amountInDollar >= energyPointPriceInCWOLF, "The amount is not valid");
        ...
        wolfPackEnergy[_wolfPackId] = wolfPackEnergy[_wolfPackId] + _amountInDollar;
    ...
    function checkWolfPackLink(uint256 _wolfPackId, uint256 _fromTimestamp)
        external
        view
        returns (bool)
    {
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function burnWolf(uint256 _tokenId) public returns (bool) {
        ...
        uint256 amountToReturn = amountCWOLF * 1000 / 10000;
    ...
    OwnableUpgradeable
{
        ...
        returns (bool)
    {
        ...
        // TODO: SUPERIMPORTANTE Comprobar la vida de la manada ¿?
        ...
        returns (bool)
    {
        for (uint256 index = 0; index < _huntingIds.length; index++) {
            ...
            /*
            uint256 pointsOfAttackWolfPack = WolfPacksNFT(
                WolfPackNFTContractAddress
            ).pointsOfWolfPack(wolfPackIdLocal);
            */
    ...
    function claim(uint256 _huntingId) external  {
        require(ownerOf(_huntingId) == msg.sender, "Not owner");
    }

    function pendingRewards() external {
        // Recorrer el mapping y mirar si hay recompensas pendientes
    }
