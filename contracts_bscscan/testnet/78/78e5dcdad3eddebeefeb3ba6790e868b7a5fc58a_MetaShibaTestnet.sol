...
contract MetaShibaTestnet is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0x98A382265b4653eFddd43E031825361200D8352F;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MetaShibaTestnet";
    string constant _symbol = "METATEST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000000000;
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; // 100 000 000 tokens per tx to launch 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xA48A649B03b6111c860Cf4915F5FbBc1DA4170CD;
