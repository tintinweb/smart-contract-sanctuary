...
contract medgrids is Context, IERC20, Ownable {   //nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x341532fE0B716655cC9F10C6B3d152be2CEd5f94); //nice
    address payable public charityAddress = payable(0x341532fE0B716655cC9F10C6B3d152be2CEd5f94); //nice
    ...
    uint256 private _tTotal = 500000 * 10**18;  //nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Med Grids"; //CC
    string private _symbol = "MED";  //nice
    ...
    uint256 public _maxTxAmount = 7500 * 10**18;  //nice
    uint256 private minimumTokensBeforeSwap = 7500 * 10**18; //nice
...
//mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 5000000000000000000; //nice  (000000000000000000)
    ...
    uint256 private salePrice = 7500;// 0.01*75 token for 0.01 bnb (set as per requirements)
