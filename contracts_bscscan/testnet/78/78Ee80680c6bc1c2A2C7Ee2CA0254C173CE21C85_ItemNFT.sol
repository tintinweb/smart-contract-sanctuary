...
contract ItemNFT is BaseNFT {
  ...
  function getStrengthIndexReferences(uint16 _tokenId) external view returns (uint, uint, uint, uint, uint, uint) {
    return (
      strengthIndexReferences[items[_tokenId].class][0],
      strengthIndexReferences[items[_tokenId].class][1],
      strengthIndexReferences[items[_tokenId].class][2],
      strengthIndexReferences[items[_tokenId].class][3],
      strengthIndexReferences[items[_tokenId].class][4],
      strengthIndexReferences[items[_tokenId].class][5]
    );
  }
