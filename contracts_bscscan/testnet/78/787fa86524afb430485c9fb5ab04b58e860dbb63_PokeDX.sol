 ...
 * PokeDX
 *
 * This contract is a rewrite of Safemoon that aims to:
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "PokeDX-BETA";
    string internal constant SYMBOL = "PDX-BETA";
...
contract PokeDX is BaseRfiToken, Liquifier {
    ...
    function increaseFee(uint256 index, uint256 addedValue ) external onlyOwner{
        require (sumOfFees >= 40, "Maximum 4% fee is allowed!" );
    ...
    function decreaseFee(uint256 index, uint256 subtractedValue ) external onlyOwner{
        require(sumOfFees >= 0, "Can't really go negative in there..." );
        uint256 _sumOfFees = sumOfFees;
