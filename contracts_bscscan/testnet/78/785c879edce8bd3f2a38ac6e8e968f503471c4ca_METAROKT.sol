...
contract METAROKT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxTxAmountBuy = _tTotal / 200; // 0,5% of supply
    ...
    string private constant _name = "METAROKT";
    string private constant _symbol = "METAROKT";
