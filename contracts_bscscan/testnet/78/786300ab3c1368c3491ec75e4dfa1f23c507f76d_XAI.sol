...
// 🌎 Website:  https://www.xaidex.com/
//    Twitter:  https://twitter.com/XaideX_Project
//    Telegram: https://t.me/xaidex_project


//    Xaidex is a new exoplanet born on Binance Smart Chain in 2021
//    The distance Earth-Moon is 380 thousand km. The distance Earth-Xaidex varies between 100 and 300 billion km
...
contract XAI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2021 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1 * 10**_decimals;

    string private constant _name = "Xaidex";
    string private constant _symbol = "XAI";

    address public marketingWallet = 0x77E4fEdB8a053B64Ca779f846c9FDa59b845F143;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        bool feesEnabled = (feeRates.liquidity + feeRates.marketing) > 0;
        if(!swapping && swapEnabled && canSwap && from != pair && feesEnabled){
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
        ...
        uint256 denominator= (feeRates.liquidity + feeRates.marketing) * 2;
    ...
    function setFeeRates(uint256 _rfi, uint256 _liq, uint256 _marketing) external onlyOwner{
        feeRates.rfi = _rfi;
