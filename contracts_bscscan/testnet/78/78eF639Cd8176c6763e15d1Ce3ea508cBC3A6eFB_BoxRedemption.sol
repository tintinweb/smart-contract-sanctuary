...
contract BoxRedemption is Ownable {
    ...
    function GetRandomNumberWithMod(
        ...
        if (digit == 1) {
            return (randomNumber % 100) % mod;
        } else if (digit == 2) {
            return ((randomNumber % 10000) / 100) % mod;
        } else if (digit == 3) {
            return ((randomNumber % 1000000) / 10000) % mod;
        } else if (digit == 4) {
            return ((randomNumber % 100000000) / 1000000) % mod;
        } else if (digit == 5) {
            return ((randomNumber % 10000000000) / 100000000) % mod;
        } else if (digit == 6) {
            return ((randomNumber % 1000000000000) / 10000000000) % mod;
        } else if (digit == 7) {
            return ((randomNumber % 100000000000000) / 1000000000000) % mod;
        } else if (digit == 8) {
            return ((randomNumber % 10000000000000000) / 100000000000000) % mod;
        } else if (digit == 9) {
            return
                ((randomNumber % 1000000000000000000) / 10000000000000000) %
                mod;
        } else if (digit == 10) {
            return
                ((randomNumber % 100000000000000000000) / 1000000000000000000) %
                mod;
        }
    ...
    function GenerateNFTCode(uint256 randomNumber, uint256 _id)
        internal
        view
        returns (string memory)
    {
        uint256 nftTypeCode = GetRandomNumberWithMod(randomNumber, 1, 5);
        ...
        if (nftTypeCode == BLUEPRINT_FRAGMENT_COMMON) {
            ...
            if (equipmemtTypeId == SUITE) {
                equipmemtRandom = GetRandomNumberWithMod(randomNumber, 2, 3);
            } else {
                equipmemtRandom = GetRandomNumberWithMod(randomNumber, 2, 4);
            }
            ...
            uint256 number = GetRandomNumberWithMod(randomNumber, 2, 7);
            ...
            if (_id == CM_BOX) {
                trainingCode = GetRandomNumberWithMod(randomNumber, 2, 5);
                battleGearCode = GetRandomNumberWithMod(randomNumber, 3, 30);
                battleDroneCode = GetRandomNumberWithMod(randomNumber, 4, 30);
                battleSuiteCode = GetRandomNumberWithMod(randomNumber, 5, 18);
                battleBotCode = GetRandomNumberWithMod(randomNumber, 6, 30);
                humanGenomeCode = GetRandomNumberWithMod(randomNumber, 7, 28);
                weaponCode = GetRandomNumberWithMod(randomNumber, 8, 29);
            } else if (_id == R_BOX) {
                trainingCode = GetRandomNumberWithMod(randomNumber, 2, 5);
                battleGearCode = GetRandomNumberWithMod(randomNumber, 3, 30);
                battleDroneCode = GetRandomNumberWithMod(randomNumber, 4, 30);
                battleSuiteCode = GetRandomNumberWithMod(randomNumber, 5, 19);
                battleBotCode = GetRandomNumberWithMod(randomNumber, 6, 30);
                humanGenomeCode = GetRandomNumberWithMod(randomNumber, 7, 25);
                weaponCode = GetRandomNumberWithMod(randomNumber, 8, 34);
            } else if (_id == E_BOX) {
                trainingCode = GetRandomNumberWithMod(randomNumber, 2, 30);
                battleGearCode = GetRandomNumberWithMod(randomNumber, 3, 30);
                battleDroneCode = GetRandomNumberWithMod(randomNumber, 4, 30);
                battleSuiteCode = GetRandomNumberWithMod(randomNumber, 5, 17);
                battleBotCode = GetRandomNumberWithMod(randomNumber, 6, 30);
                humanGenomeCode = GetRandomNumberWithMod(randomNumber, 7, 29);
                weaponCode = GetRandomNumberWithMod(randomNumber, 8, 32);
            }
