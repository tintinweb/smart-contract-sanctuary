...
contract DemocratInu is ERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    ...
    uint256 public maxSellTransactionAmount = 25 * 10**10 * (10**18);
    ...
    constructor(address _routerAddress,address payable _marketingWallet ) ERC20("Democrat Inu", "DEMINU") {
        BNBRewardsFee = 13;
        liquidityFee = 3;
