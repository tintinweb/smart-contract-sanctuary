...
contract Hare is ContextUpgradeable, IBEP20, OwnableUpgradeable {
    ...
    event LiquidityPercentSet(uint256 newFee);
    ...
    event UpdatedAdvisoryWallet(address indexed walletAddress);
    event UpdatedDevelopmentWallet(address indexed walletAddress);
    event UpdatedLiquidityWallet(address indexed walletAddress);
    event UpdatedMarketingWallet(address indexed walletAddress);

    event AdvisoryTaxPercentSet(uint256 newFee);
    event DevelopmentTaxPercentSet(uint256 newFee);
    event MarketingTaxPercentSet(uint256 newFee);
    event ReflectionTaxPercentSet(uint256 newFee);
   ...
   function _transfer(
    ...
    function updateRouterAddress(address newRouter) external onlyOwner {
        ...
        excludeFromLimits(newRouter, true);
        ...
        onlyOwner
    {
        ...
        emit UpdatedAdvisoryWallet(advisoryWalletAddress);
    }
    ...
    function updateDevelopmentWalletAddress(
        ...
        emit UpdatedDevelopmentWallet(developmentWalletAddress);
    }
    ...
    function updateLiquidityWalletAddress(
        ...
        emit UpdatedLiquidityWallet(liquidityWalletAddress);
    }
    ...
    function updateMarketingWalletAddress(
        ...
        emit UpdatedMarketingWallet(marketingWalletAddress);
    }
    ...
    function setReflectionTaxPercent(uint256 newFee) external onlyOwner {
        ...
        emit ReflectionTaxPercentSet(newFee);
    }
    ...
    function setAdvisoryTaxPercent(uint256 newFee) external onlyOwner {
        ...
        emit AdvisoryTaxPercentSet(newFee);
    }
    ...
    function setDevelopmentTaxPercent(uint256 newFee) external onlyOwner {
        ...
        emit DevelopmentTaxPercentSet(newFee);
    }
    ...
    function setMarketingTaxPercent(uint256 newFee) external onlyOwner {
        ...
        emit MarketingTaxPercentSet(newFee);
    }
    ...
    function setLiquidityTaxPercent(uint256 liquidityFee) external onlyOwner {
        ...
        emit LiquidityPercentSet(liquidityFee);
    }
