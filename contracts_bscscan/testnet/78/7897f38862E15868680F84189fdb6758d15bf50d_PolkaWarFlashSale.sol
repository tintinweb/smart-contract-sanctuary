...
contract PolkaWarFlashSale is Ownable, ReentrancyGuard {
    ...
    uint256 beginDate;
    uint256 endDate;
    uint256 maximumSoldCount;
    uint256 maximumPerItem;
    uint256 price;
    ...
    mapping(string => uint256) internal countItemSlot;
    ...
    constructor(
        ...
        beginDate = 1626357600;
        endDate = 1626361200;
        resellBeginDate = 1626363000;
        resellEndDate = 1626368400;
    ...
    function purchaseItem(
        ...
        require(
            countItemSlot[itemInfoHash] <= maximumPerItem,
        ...
        countItemSlot[itemInfoHash] = countItemSlot[itemInfoHash].add(1);
