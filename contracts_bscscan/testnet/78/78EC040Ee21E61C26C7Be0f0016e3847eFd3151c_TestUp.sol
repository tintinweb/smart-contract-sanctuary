...
contract TestUp is BEP20 {
     ...
     */
    constructor(uint _startTradingTime, address _pcsRouter) public BEP20("Test65", "T65") {

        // Mint initial supply - 1 Billion tokens
        // No minting after this of course
        //_mint(msg.sender, 1 * 1e9 * 1e18);
        _mint(msg.sender, 5 * 1e3 * 1e18);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override 
        ...
        if (recipient == address(0)
            ...
            emit Debug("Tax received",taxAmount);
    ...
    function swapAndLiquify() private lockTheSwap transferTaxFree {
        ...
        if (contractTokenBalance >= minAmountToLiquify) {
            ...
            emit Debug("buyback tr", newBalance.div(990).mul(400));
            // We send 190/990th tokens to the mkt wallet
            emit Debug("marketing tr", address(this).balance);
