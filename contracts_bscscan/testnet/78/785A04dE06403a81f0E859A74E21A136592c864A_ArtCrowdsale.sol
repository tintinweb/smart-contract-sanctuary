    ...
    Ownable
{
    ...
    {
        require(_goal <= _cap, "ArchRealm Sale: goal is greater than cap");
    ...
    function setCrowdsaleStage(uint256 _stage) public onlyOwner {
        ...
        } else if (uint256(CrowdsaleStage.PrivateSale) == _stage) {
        ...
        if (stage == CrowdsaleStage.PreSale) {
            _changeableRate = 100000;
        } else if (stage == CrowdsaleStage.PrivateSale) {
            _changeableRate = 120000;
        }
    }
