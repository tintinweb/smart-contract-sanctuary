...
contract MoniwarClaimNFT is Ownable, ReentrancyGuard {
    ...
    mapping(address => ClaimItem) public claims;
    ...
    constructor(
        ...
        whiteList[address(0xcff45eb1f86DAe6135ae64219e477331cD0e68E6)] = true;
        whiteList[address(0xDF7A967a0022F7F2366CcAa5c88A9Ce5C7f6d6C4)] = true;
        whiteList[address(0x8b9588F69e04D69655e0d866cD701844177360A7)] = true;
    }

    function setFeeClaim(uint256 _fee) public onlyOwner {
        feeClaim = _fee;
    }

    function setFeeClaim(address _user) public view returns (bool wl) {
    ...
    function claimNFT() public payable nonReentrant {
        require(whiteList[_msgSender()], "not valid whitelist");
        require(msg.value == feeClaim, "fee not enough");
        require(claims[_msgSender()].owner == address(0), "already claimed");
        uint256 tokenId = mowaNFT.getNextNFTId();
        ClaimItem storage claimItem = claims[_msgSender()];
        claimItem.owner = _msgSender();
        claimItem.tokenId = tokenId;
