    ...
    IVesting
{
    ...
    function emergencyWithdraw(address _erc20Token) public override whenPaused onlyOwner {
    ...
    function setPreventiveWallet(address preventiveAddress) public override onlyOwner {
    ...
    function getListOperators() public override view returns (address[] memory) {
...
interface IVesting is BaseInterface {
    ...
    function getListOperators() external view returns (address[] memory);
}
