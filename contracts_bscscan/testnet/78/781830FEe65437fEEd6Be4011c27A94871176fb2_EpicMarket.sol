...
contract EpicMarket is AccessControl {
    ...
    function acceptOffer(uint256 marketId, uint256 offerId) public onlyExistItem(marketId){
        ...
        require(msg.sender == itemData._owner, "You can't accept this auction");
    ...
    function closeOffer(address itemOwner, uint256 offerId, uint256 marketId) public onlyExistItem(marketId){
        ...
        require(ERC20.balanceOf(itemOwner) >= fee, "Balance is not enough to pay fee");
        ERC20.transferFrom(itemOwner, _wallet, fee);
