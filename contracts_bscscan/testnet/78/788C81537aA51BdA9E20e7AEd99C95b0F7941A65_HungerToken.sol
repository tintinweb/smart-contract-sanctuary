...
contract HungerToken is Context, IERC20, Ownable {
    ...
    function _useContractBNB(
        ...
        if (!_lockSwap) {
            ...
            if (
                ...
                buybackRate > 45 ||
                liquidityRate > 45
            ) revert("All rates must be in the range of 0-45");
    ...
    function __handleReflections(
        ...
        //     reflections.inCirculation += (amount * reflectionRate);
        //     reflections.totalSupply += amount;
