...
contract JokerNFT is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    mapping (uint256 => uint256) nftRarity;
    mapping(address => uint256[]) public ownedTokens;
    
    constructor() ERC721("Joker NFT", "JOKER") {}

    function safeMint(string memory uri, uint256 rarity) public payable {
