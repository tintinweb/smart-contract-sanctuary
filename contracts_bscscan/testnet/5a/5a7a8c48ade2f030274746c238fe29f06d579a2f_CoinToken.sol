...
contract CoinToken is Context, IBEP20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(_isBlacklisted[sender], "Sorry You are blacklisted , please contact owner");
        require(_isBlacklisted[recipient], "Sorry You are blacklisted , please contact owner");
