...
contract DogeMalone is ERC20, Ownable {
    ...
    address payable public devWallet = 0xdB898C319a67A7e647Dc570d5d20FA4d64A093F3;

    uint256 public swapTokensAtAmount = 1 * (10**18);
    uint256 public maxTxAmount = 10000 * (10**18); // .1%
    uint256 public maxSellTransactionAmount = 10000 * (10**18);
    uint256 public maxWalletBalance = 5000 * (10**18);
    ...
    constructor() public ERC20("DogeMalone", "DMAL") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DogeMalone: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DogeMalone: The PanCAKESwap pair cannot be removed from automatedMarketMakerPairs");
...
contract DogeMaloneDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("DogeMalone_Dividend_Tracker", "DogeMalone_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2500 * (10**18);
    }
