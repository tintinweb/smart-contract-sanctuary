...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  receive() external payable {
              require(msg.sender == 0x10ED43C718714eb63d5aA57B78B54704E256024E); // issue # 7 fixed 
    distributeDividends();
  }
...
*/
    constructor() ERC20("DefVerse", "DVERSE") {
        ...
        _status = _NOT_ENTERED; // Reentrancy Status 
    ...
    //	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
      ...
      //  dividendTracker.excludeFromDividends(address(_uniswapV2Router)); // Point #  6 
...
// Removed as per auditors recommendations 
 //   receive() external payable {
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function _transfer(
        ...
        address to,
        uint256 amount
    ) open(from, to) internal override nonReentrant {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //uint256 bnbToAddLiquidityWith = deltaBalance.mul(liquidityFee).div(totalFees.mul(2).sub(liquidityFee)); // remove as recommended by auditors issue # 12 
        uint256 bnbToAddLiquidityWith = tokensToAddLiquidityWith;
...
//        uint256 marketingAmount = deltaBalance.sub(bnbToAddLiquidityWith).div(totalFees.sub(liquidityFee)).mul(marketingFee);
            uint256 marketingAmount = deltaBalance.sub(bnbToAddLiquidityWith).mul(marketingFee).div(totalFees); // issue # 13 
