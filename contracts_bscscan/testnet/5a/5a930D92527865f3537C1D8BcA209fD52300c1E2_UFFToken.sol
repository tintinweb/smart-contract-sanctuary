...
contract UFFToken is BEP20 {
    ...
    uint256 public cap = 69696969 * 10**18;
    ...
    // PCS Router Address
    IUniswapV2Router02 private PCSRouter;
    ...
    bool private _maxHoldingEnable = false;
     ...
     */
    constructor(address _treasury) public BEP20("United Farmers Finance", "UFF") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (sender == owner() || recipient == owner() || transferTaxRate == 0 || _isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
            ...
            uint256 treasuryAmount = taxAmount.mul(treasuryRate).div(100);
            uint256 liquidityAmount = taxAmount.sub(treasuryAmount);
