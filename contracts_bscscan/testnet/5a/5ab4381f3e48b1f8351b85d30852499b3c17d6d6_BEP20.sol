...
contract EZGToken is BEP20, Pausable, BEP20Detailed {
    ...
    constructor() public BEP20Detailed("EZG-v1.0", "EZG", 18) {
        totalCoins = 1000000000000000 * 10**uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 1 million billion tokens
    }
        ...
        returns (bool success)
    {
        ...
        return BEP20.transfer(receiver, amount);
    }
    ...
    function transferFrom(
        ...
        return BEP20.transferFrom(from, receiver, amount);
    }
    ...
    function transferAndLock(
        ...
        BEP20._transfer(msg.sender, receiver, amount);
     ...
     */
    function getNumberOfLockedAddresses() external view returns (uint256 _count) {
     ...
     *
     */
    function getCirculatingSupplyTotal() external view returns (uint256 _amount) {
