...
contract WF is ERC20Detailed, Ownable {
    ...
    uint256 public totalFee = liquidityFee.add(marketingFee).add(buyBackFee);
    ...
    constructor() ERC20Detailed("We Finance", "WFFINAL", uint8(DECIMALS)) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        autoLiquidityReceiver = 0xf590e8B342E99886a84fA890dCD23b49C5C04eFE;
        marketingFeeReceiver = 0xcE376907b95C166C0ba785b1bC9aa3aBA6BBd107;
        buyBackFeeReceiver = 0xE93e09f310dBd083949B1bF629c87d88A2Dea403;
    ...
    function swapBack() internal swapping {
        ...
        if(amountETHBuyBack > 0)
                transferToAddressETH(payable(buyBackFeeReceiver), amountETHBuyBack);

        if(amountETHMarketing > 0)
                transferToAddressETH(payable(marketingFeeReceiver), amountETHMarketing);
