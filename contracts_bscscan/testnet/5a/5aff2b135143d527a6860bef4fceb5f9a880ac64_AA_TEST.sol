...
contract AA_TEST is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_BNB = payable(0xF84ec7Fe79c0ba5109CeA7d6f920506b95A78A09);
    address payable public Wallet_Tokens = payable(0xF84ec7Fe79c0ba5109CeA7d6f920506b95A78A09);
    address payable public Wallet_Dev = payable(0xA9EeD95EbE986867063B1E43e5850f6a7217E668); 
    ...
    uint256 public _FeeOther = 10;


    uint256 public _FeeBuy_Reflection = 5; 
    uint256 public _FeeBuy_Other = 10;


    uint256 public _FeeSell_Reflection = 5; 
    uint256 public _FeeSell_Other = 10;




    uint256 private rReflect; // Reflections
    uint256 private rFees; // Includes LP and Marketing Fees
    ...
    uint256 private tFees; // Includes LP and Marketing Fees
    ...
    */
    ...
    function _set_Fees(uint256 Reflection_BUY, uint256 Other_BUY, uint256 Reflection_SELL, uint256 Other_SELL) external onlyOwner() {

        // Set the fees
          _FeeBuy_Reflection = Reflection_BUY;
          _FeeBuy_Other = Other_BUY;

          _FeeSell_Reflection = Reflection_SELL;
          _FeeSell_Other = Other_SELL;

          _FeeReflection = Reflection_SELL;
          _FeeOther = Other_SELL;

          // XXX Show total fees for public? 
    ...
    */
    ...
    function _transfer(
        ...
        // XXX NEED TO CHECK IF IT IS A BUY OR A SELL! AND SET CORRECT FEE OR REMOVE FEE COMPLETELY 
  ...
  /*     
   ...
   function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        tFees = tAmount*_FeeOther/100;

        rAmount = tAmount.mul(_getRate());
        rReflect = tReflect.mul(_getRate());
        rFees = tFees.mul(_getRate());
