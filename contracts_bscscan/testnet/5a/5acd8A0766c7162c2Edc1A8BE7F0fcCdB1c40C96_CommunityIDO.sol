...
/**
 * @dev contract that allows project to create a community IDO. This contract can
 * be used like a pot where community can contribute util the raising amount is
 * reached.
 */
