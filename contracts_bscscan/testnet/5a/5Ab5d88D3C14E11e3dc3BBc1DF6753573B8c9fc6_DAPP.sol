...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADA = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
// CHANGE
contract DAPP is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address ADA = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DAPP";
    string constant _symbol = "DAP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 300,000
    ...
    uint256 liquidityFee = 4; // 4%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 
    uint256 devFee = 11; // 14%
    uint256 totalFee = 15; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
