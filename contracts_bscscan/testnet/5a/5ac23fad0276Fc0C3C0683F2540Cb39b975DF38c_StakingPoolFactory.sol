    ...
    BTCDistributor
{
        ...
        returns (uint256) 
    {
        ...
        uint256 rewardPerStake = first.add(second).sub(third);

        rewardPerStake = rewardPerStake.add(forth).sub(fifth).add(sixth);
...
contract USDRetriever {
    ...
    // change the name to getUSDBalance
    function getUSDBalance() internal view returns (uint256) {
