...
contract TheTrueTest is Context, IERC20, Ownable {
    ...
    string private _name = "TheTrueTest";
    ...
    uint256 public _maxSellPerDay = 10000 * 10**9; // Max number of tokens that can be sold per day
