...
contract hiDollar is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    uint256 public constant RATIO_PRECISION = 10 ** RATIO_DECIMALS /** ratio precision */;
    ...
    function collectFee(uint256 amount) public returns (bool) {
        require(msg.sender == feeCollector, "Only fee collector can collect fee");
        require(amount <= fees, "The amount exceeds the collectable fee");
        fees -= amount;
