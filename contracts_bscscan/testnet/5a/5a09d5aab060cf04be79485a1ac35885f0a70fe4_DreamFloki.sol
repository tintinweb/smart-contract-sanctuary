...
contract DreamFloki is IERC20 {
    ...
    string constant _name = "Dream Floki";
    string constant _symbol = "DrmFloki";
    ...
    address payable private _marketingWallet = payable(0x29906c39c5362Ebc11cEA946009a89Bfa0bAef43);
