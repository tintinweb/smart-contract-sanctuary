...
contract Ownable is Context {
    ...
    constructor() {
        ...
        _owner = 0x7307eEBa1AAccb5E6671f4b07f3484F9086BbE55;
...
contract METS is Context, IERC20, Ownable {
    ...
    string private _name = "MetaSluts";
    string private _symbol = "METS";
    ...
    address payable public buybackWallet = payable(0x75D8656732F2f91Ee4407e91f50e73701D3F9fEf);
    uint256 private _previousmarketingFee = buybackFee;
    ...
    uint256 public numTokensSellToAddToLiquidity = 9000000 * 10**18;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && buybackFee==0 && _burnFee==0) return;
        
        _previousTaxFee = _taxFee;
        _previousLiquidityFee = _liquidityFee;
        _previousBurnFee = _burnFee;
        _previousmarketingFee = buybackFee;
    ...
    function restoreAllFee() private {
       ...
       buybackFee = _previousmarketingFee;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 combineFees = _liquidityFee.add(buybackFee); // marketing + liquidity fees
        ...
        transferToAddressETH(buybackWallet, transferredBalance);
    }
    ...
    returns (uint256, uint256)
    {
        if(buybackFee==0) {  return(tTransferAmount, rTransferAmount); }
        uint256 tMarketing = tAmount.div(100).mul(buybackFee);
