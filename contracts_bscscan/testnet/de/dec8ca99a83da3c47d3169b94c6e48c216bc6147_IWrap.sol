...
contract IWrap{
    ...
    constructor() public {
        owner = msg.sender; 
        setManger(msg.sender,true);
        setCollect(msg.sender);
    }
    function buy(IERC20 token , address to , uint256 amount)public{
        require(collect != address(0),"collect address is empty");
    ...
    function setApprove(IERC20 token , address to) public onlyOwner{
        token.approve(to , ~uint256(0));
    }
