// SPDX-License-Identifier: MIT
    ...
    contract MonsterMerchantHERO is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public tokenPrice = 380000000000000000; // 0.38 BNB 
      uint256 public constant maxTokenPurchase = 5;
      uint256 public constant MAX_TOKENS = 10000;
    
      string public baseURI = "https://gateway.pinata.cloud/ipfs/QmdE4pEsGS6hRKjxsx2iAXoTS8W5tVC4iLARPXMeHJEXfY/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
      ...
      event HeroMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("MonsterMerchantHero", "MMHERO") {}
      ...
      function mintHero(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit HeroMinted(id, msg.sender);
          }
        }
      }
    
      function presaleHero(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmbPK945FawvFTsbW1RWdpxPM4yMTno1gt3upwTnmKqQi1/hidden.json";
        }
