...
contract StakeContract is Ownable {
    ...
    uint256 public startBlock = 11135000 ; // set start block
    uint256 public minimum_deposit = 4000*10**18; //minimum deposit
    uint256 public endBlock =   12863000 ;  // set end block
    uint256 public rewardperblock = 0.2*10**18; // set block reward
    uint256 private unlockblockperiod = 864000; 
    address public rewardaddress = 0x6c1dE9907263F0c12261d88b65cA18F31163F29D ;
    address public stakeaddress = 0x6c1dE9907263F0c12261d88b65cA18F31163F29D ;
    uint256 public totalpoolstacked = 0;
    uint256 public lastRewardBlock = 11135000;  // set start block
