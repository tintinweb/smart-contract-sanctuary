...
// Dependency file: contracts/interfaces/ISecondaryFeeCollection.sol
...
// Dependency file: contracts/test/AbstractFeeAuction.sol
...
// import "@openzeppelin/contracts/utils/introspection/IERC165.sol";
// import "contracts/interfaces/ISecondaryFeeCollection.sol";

contract AbstractFeeAuction is IERC165, ERC165Storage, ISecondaryFeeCollection {
    struct Fee {
    ...
    function _setFee(uint256 _id, Fee[] memory _fees) internal {
...
// Root file: contracts/test/ERC721Mock.sol


pragma solidity >=0.6.2;

// import "@openzeppelin/contracts/token/ERC721/ERC721.sol";
// import "contracts/test/AbstractFeeAuction.sol";

contract ERC721Mock is AbstractFeeAuction, ERC721("Test ERC721", "TEST721") {
    function mint(address to, Fee[] memory _fees, uint tokenId) external {
        _mint(to, tokenId);
    }

    function setFee(uint256 _id, Fee[] memory _fees) external {
        _setFee(_id, _fees);
    }

    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, AbstractFeeAuction) returns (bool) {
        return super.supportsInterface(interfaceId);
    }
}