...
abstract contract BasePool is Ownable {
    ...
    function unstake(address celebrity, uint256 assetStakeAmount) public {
        ...
        stakerInfo.egoBalanceInfoOriginal.amount = stakerInfo.assetBalanceInfo.amount * AssetRate * DecimalAdjustment / DEFAULT_BASE;
        ...
        if(stakerInfo.egoBalanceInfoOriginal.amount > egoChange)
            stakerInfo.egoBalanceInfoOriginal.amount -= egoChange;
        else 
