...
contract Token {
    ...
    string public name = "DOASSCOIN";
    string public symbol = "DOASS";
    ...
    constructor() {
        uint donations = (totalSupply * 12 / 100);
        uint founders = (totalSupply * 3 / 100);
        contractOwner = msg.sender;
        balances[0xA9Add69Ad2113bcc413660D91e42EAbB21cC7893] = donations;
        balances[0xA9Add69Ad2113bcc413660D91e42EAbB21cC7893] = founders;
        balances[msg.sender] = totalSupply - donations - founders;
    }
