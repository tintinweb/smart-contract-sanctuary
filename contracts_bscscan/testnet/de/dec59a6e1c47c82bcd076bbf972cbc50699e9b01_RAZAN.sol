...
contract RAZAN is ERC20, Ownable {
    ...
    RAZANDividendTracker public dividendTracker;
    ...
    address private immutable DEFAULTREWARDTOKEN = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); // Default reward token - USDT // main net 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 //testnet 0x7ef95a0fee0dd31b22626fa2e10ee6a223f8a684
    ...
    address public rewardTokenForMarketing = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Default reward token - USDT // main net 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 //testnet 0x36d468D6055ac88d2D08793B4816B67AB49a0339;
    ...
    constructor() public ERC20("RAZAN", "RAZAN") {

        dividendTracker = new RAZANDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        RAZANDividendTracker newDividendTracker = RAZANDividendTracker(payable(newAddress));
    ...
    function setRewardToken(address tokenAddress) external{
        require(address(this) != tokenAddress, "RAZAN can't be set as a reward token.");
...
contract RAZANDividendTracker is Ownable, DividendPayingToken {
    ...
    function setRewardToken(address account, address token) public onlyOwner{
        require(tokenHoldersMap.getIndexOfKey(account) >= 0, "You must hold RAZAN tokens to set up reward tokens.");
