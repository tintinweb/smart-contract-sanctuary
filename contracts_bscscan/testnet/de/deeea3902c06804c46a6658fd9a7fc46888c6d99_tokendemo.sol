...
contract tokendemo is Context, IERC20, Ownable {
    ...
    /// @dev SOUND tokens can't be rescued
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out SOUND!");
