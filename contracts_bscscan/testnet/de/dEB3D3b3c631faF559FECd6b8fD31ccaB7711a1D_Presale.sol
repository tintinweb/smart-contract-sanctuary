...
contract Presale is Ownable {
    ...
    uint256 public softCapEthAmount = 200 ether;
    ...
    uint256 public maximumDepositEthAmount = 5 ether; // max 5 BNB

    uint256 rewardTokenCount = 0.002 ether; // 500 tokens per BNB
    ...
    constructor(
        ...
        presale =  payable(0x8f20414da923498f8d762459502cab3bE69292Fb);
    ...
    function claimToken() public {
        ...
        require(newTokenUpdate, "new token is not updated");
        require(isClaim[msg.sender] == true, "you already claimed tokens !");
