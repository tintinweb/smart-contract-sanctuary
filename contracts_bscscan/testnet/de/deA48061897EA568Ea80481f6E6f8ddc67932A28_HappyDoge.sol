...
contract HappyDoge is ERC20, Ownable {
    ...
    uint256 public bigLottoAmount = 10000;
    uint256 public _minBuyUsdt = 1 * 10 ** 18;
    uint public numTokensSell = 1000 * 10 ** 18;
    ...
    constructor(address payable _marketingWallet, address payable _devWallet) public ERC20("HappyDoge t", "HappyDoge t") {
