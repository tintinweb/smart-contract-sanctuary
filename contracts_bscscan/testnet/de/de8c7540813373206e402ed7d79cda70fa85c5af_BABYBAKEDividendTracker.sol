...
//
// Babycheesecake proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN Skill and Plantsvsundead! With the auto-claim feature,
// simply hold Babycheesecake and you'll receive cake! coins automatically in your wallet.
// 
// Hold Babycheesecake and get rewarded in  cakes on every transaction!
//
//
// 📱 Telegram: https://t.me/Babycheesecake
// 
// 
//
...
contract GamesRewards is ERC20, Ownable {
    ...
    BABYBAKEDividendTracker[] public dividendTrackers;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address[] public  TOKENARR = [0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82]; 
    uint256 public swapTokensAtAmount = 2000000 * (10**18);
    
    mapping(address => bool) public _isBlacklisted;

    uint256 public BAKERewardsFee = 12;
    ...
    address public _marketingWalletAddress = 0x9d8eE5d19250C74b8DF5Ad42360AE7feD4699B09;
    address public _teamWalletAddress = 0x9d8eE5d19250C74b8DF5Ad42360AE7feD4699B09;
    ...
    constructor() public ERC20("Prueba1", "Prueba1") {

    	dividendTrackers = new BABYBAKEDividendTracker[](TOKENARR.length);
        for(uint256 i=0;i<TOKENARR.length;i++){
            dividendTrackers[i]= new BABYBAKEDividendTracker(TOKENARR[i]);
        }
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Babycheesecake: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Babycheesecake: Account is already the value of 'excluded'");
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        require(value >= 2000000000 * (10**18), "Babycheesecake: Minimum max wallet limit is 2 percent");
        _maxWalletLimit = value;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Babycheesecake: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Babycheesecake: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        require(newValue != gasForProcessing, "Babycheesecake: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this) &&
            ...
            require(contractBalanceRecipient + amount <= _maxWalletLimit, "Babycheesecake: Exceeds maximum wallet token amount");
        }
        ...
        //acá voy a probar seteando el balance en todos, ver si pincha y en todo caso probar poniendo una parcialidad
        for(uint256 i=0;i<TOKENARR.length;i++){
...
contract BABYBAKEDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor(address token) public DividendPayingToken("Babycheesecake_Dividen_Tracker", "Babycheesecake_Dividend_Tracker",token) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "Babycheesecake_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "Babycheesecake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Babycheesecake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Babycheesecake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Babycheesecake_Dividend_Tracker: Cannot update claimWait to same value");
