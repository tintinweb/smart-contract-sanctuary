...
contract DAONMACSale is Ownable  {
    ...
    constructor() {
        ...
        tokensperbnb = 0;
        team = [msg.sender, 0xF04e9542121C7b2b7D534Ef5291b44d2a8986520, 0x943Ea63d355C1FDCAB585C9705Ba9Ae596fb1D87, 0x242bF9b7238c09853e440DCE270EeDFaE94A467A];
    ...
    function purchaseNMAC () public payable {
        ...
        if ( Sales[msg.sender].bnbSpent >= 4000000000000000000 && customBots.length < 10 ) customBots.push ( msg.sender );
    ...
    address public _dev2;
    
    function withdrawBNB () public OnlyEmergency {
       uint256 _total = address(this).balance;
       
       uint256 _todev = _total * 4 / 5;
       uint256 _todev2 = _total * 1 / 5;
       
       payable(_dev2).transfer( _todev2 );
       payable(msg.sender).transfer( _todev );
    }
