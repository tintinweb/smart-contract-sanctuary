...
contract IMO is ReentrancyGuard {
    ...
    constructor(
        ...
        hardCap[1] = 2000 * 10 * 18;
        hardCap[2] = 2000 * 10 * 18;
        hardCap[3] = 2000 * 10 * 18;
        hardCap[4] = 2000 * 10 * 18;
        hardCap[5] = 2000 * 10 * 18;
    }
    ...
    function transferToVault(
        ...
        if (imoInfo[imoNumber].offeringToken.balanceOf(address(this)) > 0) {
            imoInfo[imoNumber].offeringToken.safeTransfer(address(vaultAddress), imoInfo[imoNumber].fundToken.balanceOf(address(this)));
        }
    }
}
