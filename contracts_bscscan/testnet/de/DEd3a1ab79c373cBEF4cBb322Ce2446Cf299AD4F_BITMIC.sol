...
contract BITMIC is Pausable, StandardToken, BlackList {
    ...
    function BITMIC(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
    ...
    // Forward BEP20 methods to upgraded contract if this one is deprecated
