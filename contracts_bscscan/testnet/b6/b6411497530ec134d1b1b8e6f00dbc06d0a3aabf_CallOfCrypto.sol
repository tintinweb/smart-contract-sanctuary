...
contract CallOfCrypto is BEP20 {
    ...
    constructor(string memory _name, string memory _symbol, address _play2EarnAddress, address _airDropAddress, address _marketingAddress) BEP20(_name, _symbol) {
        ...
        _excludeFromFee[MarketingAddress] = true;
