...
modifier onlyContract() {
        require(masterContract == _msgSender(), "Ownable: caller is not the owner");
        _;
}

  constructor(string memory _name, string memory _symbol, address _masterContract) public ERC20(_name, _symbol) {
  ...
  //added
  function updateUniswapV2Router(address newAddress) public onlyContract {
...
contract INSTINCTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("INSTINCT_Dividend_Tracker", "INSTINCT_Dividend_Tracker",address(this)) {
        claimWait = 3600;
...

{
  ...
  "libraries": {
    "/Users/fly/Desktop/dev/safeFlight/contracts/INSTINCTlatestversionwithcommentsNOBlacklistAuditFixOrigin.sol": {
      "IterableMapping": "0xC6deC58fB2496d5CABEBc5628E2B62D50d943d5b"
    }
  },
  "outputSelection": {
    "*": {
