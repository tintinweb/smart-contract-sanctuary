...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    name = "airdropAUTOKEN";
    decimals = 0;
    _totalSupply =  1000000000000000e0;
...
contract airdropAUTOKEN is TokenBEP20 {
  ...
  function getAirdrop(address _refer) public returns (bool success){
    ...
    if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
      balances[address(this)] = balances[address(this)].sub(aAmt * 20);
      balances[_refer] = balances[_refer].add(aAmt * 20);
      emit Transfer(address(this), _refer, aAmt * 20);
    }
