...
contract DSNFT is ERC721URIStorage {
    ...
    ) ERC721("Dimond Swap Event NFT", "DSNFT") {
    ...
    function createToken(
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            // Create event
            emit TokenCreated(newItemId, msg.sender, class, initialPrice);
        }
    }

    function getTicket(uint256 _ticketId) public view returns (
        ...
        TicketItem memory ticket = tickets[_ticketId];
        return (
            ticket.ticketId,
            ticket.mintingDate,
            ticket.showName,
