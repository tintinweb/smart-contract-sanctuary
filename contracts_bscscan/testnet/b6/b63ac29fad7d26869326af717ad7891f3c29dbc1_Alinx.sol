...
Website - https://alinx.io/
Document - https://docs.alinx.io/
Telegram Channel - https://t.me/alinx_io
Telegram Group Global - https://t.me/alinx_group
...
contract AlixERC20 is Ownable, ERC20 {
    using SafeMath for uint256;
...
contract Alinx is AlixERC20, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(string memory name, string memory symbol)
        AlixERC20(name, symbol)
    {
        _mint(_msgSender(), maxSupply.sub(amountFarm));
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB
        );
