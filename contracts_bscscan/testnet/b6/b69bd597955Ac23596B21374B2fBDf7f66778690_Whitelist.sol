...
contract Whitelist is Ownable {
    ...
    function addAddressToAdminlist(address _address) public onlyOwner {
        adminlist[_address] = true;
    }

    function removeAddressFromAdminlist(address _address) public onlyOwner {
        adminlist[_address] = false;
    }

    function isAdminlisted(address _address) public view returns(bool) {
