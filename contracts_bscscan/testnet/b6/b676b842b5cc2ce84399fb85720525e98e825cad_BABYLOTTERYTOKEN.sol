...
/**
    5% Liquidity pool
    1% lottery wallet (accessible by the Dev team to award winner for each draw)
    2% distributed across holders
    1% Burn (sent to a dead wallet)- 0x0000000000000000000000000000000000000001
    4% Marketing/development wallet
*/
...
contract BABYLOTTERYTOKEN is Context, IBEP20, Ownable {
    ...
    string private _name = "Baby Lottery";
    ...
    uint256 public _devMarketingFee = 4;
    ...
    address public _devMarketingAddress = 0x518DFB64e4DFEAA90FCdd14b70942F30F2E6833c;
    address public _lotteryAddress = 0x78cAC2950Bb350F5be1dB735b526df4555e2273c;
    ...
    constructor () public {
        ...
        _burnAddress = 0x0000000000000000000000000000000000000001;
    ...
    function setDevMarketingFeePercent(uint256 fee) external onlyOwner() {
        _devMarketingFee = fee;
    }

    function setLotteryFee(uint256 fee) external onlyOwner() {
        _lotteryFee = fee;
    }
    ...
    function _transfer(
        ...
        if (takeFee){
            uint256 toDevMarket = calculateDevMarketingFee(amount);
            uint256 toLottery = calculateLotteryFee(amount);
