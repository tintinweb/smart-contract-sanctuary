...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
...
contract ShibaXRocket is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaXRocket";
    string constant _symbol = "SXR";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x68FB34B58510a19cCB93dB69e8d9151981F0FB1B;
        teamFeeReceiver = 0x8Cb87566312f478096DdfF53a346ed6F412eAfB5;
        buybackFeeReceiver = 0x96C3690D8e4728311E039284E87C5a0b90C482F3;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDividend = amountBNB.mul(buybackFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        require(success, "receiver rejected ETH transfer");
        (bool success1, /* bytes memory data */) = payable(buybackFeeReceiver).call{value: amountBNBDividend, gas: 30000}("");
        require(success1, "receiver rejected ETH transfer");
        (bool success2, /* bytes memory data */) = payable(teamFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _buybackFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        buybackFee = _buybackFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_buybackFee).add(_teamFee);
        feeDenominator = _feeDenominator;
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _buybackFeeReceiver) external authorized {
    ...
    function manualSend() external authorized {
        ...
        payable(buybackFeeReceiver).transfer(contractETHBalance);
    }
    ...
    function setRewardsToken(address _rewardsToken) external authorized {
