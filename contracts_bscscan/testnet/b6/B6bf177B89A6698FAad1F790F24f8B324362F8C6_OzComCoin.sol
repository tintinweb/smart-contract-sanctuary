...
contract OzComCoin is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xB40A3308dB0dD4C012B201fEcA9cd12901972F6D;
    ...
    function _takeMarketing(uint256 tMarketing) private {
        ...
        uint256 newBalance = address(this).balance.sub(initalBalance);
    ...
    function viewAllFees() public view returns(uint256 Tax, uint256 Marketing, uint256 Liquidity) {
    return (_taxFee, _marketingFee, _liquidityFee);
    }
