...
contract MultiSig is Context {
    ...
    // @dev Include for BEP20_Pausable.sol, just seprating out some logic
    
    // @dev Initializes the contract with MultiSig _mint_to_stopped state control off.
    // @dev Initializes the contract in _change_operator_stopped state.
    // @dev Initializes the contract in _taxrate_change_stopped state.
    // @dev Initializes the contract in _charityrate_change_stopped state.
    // @dev Initializes the contract in _blacklist_stopped state.
    // @dev Initializes the contract in _antiwhale_stopped state.
    // @dev Initializes the contract in _mint_stopped state.
    constructor () internal {
