...
contract IVGoldNew is Context, IERC20, Ownable, Initializable {
    ...
    string private _name = "IVGoldNew";
    string private _symbol = "IVGN";
    ...
    address public charityWallet = 0xe54b6002C9713A6B235C562a1201214C7c7A1647;  
    ...
    uint256 public maxlimit = 30000000000 * 10 ** 9;
