...
/**
    ...
    */
    ...
    event SellConditionWithSwapAndSendToFeed(address _from, address _to);
    event weEnterInTransferFct(address _from, address _to);
    event weCheckIfMsgSenderIsBlacklisted(address _from, address _to);
    event weAreInSwapAndSendToFeeFct(string text);
    event weAreInSwapInLiquify(string text);
    event activeTakeFeeCondition(string text);
    event WeAreInTokensTransferFct(string text);
    ...
    */
    function _transfer(address from, address to, uint256 amount) private {
        ...
        emit weEnterInTransferFct(from, to);
        ...
        if (takeFee && to == _pancakeswapV2LiquidityPair) {
            ...
            emit weCheckIfMsgSenderIsBlacklisted(from, to);
        ...
        if (!takeFee) {
            emit activeTakeFeeCondition("Active !takeFee condition");
            removeAllFees();
        }
    ...
    */
    function _tokenTransfer(address sender, address recipient, uint256 tAmount) private {
        ...
        emit WeAreInTokensTransferFct('Hello');
    ...
    */
    ...
    function _priceImpact(uint256 amount) public view returns(bool) { 
    ...
    */
    function swapAndSendToFee(uint256 token) private lockSwapping {
        ...
        emit weAreInSwapAndSendToFeeFct("swapAndSendToFee - 2368");
    ...
    function swapAndLiquify(uint256 tokens) private {
       // split the contract balance into halves
        ...
        emit weAreInSwapInLiquify("swapAndLiquify");
