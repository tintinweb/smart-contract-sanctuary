...
contract VRP is IVRP, Initializable, JaxOwnable {
    ...
    function deposit_reward(uint amount) public {
        ...
        newEpoch.wjxnStakedAmount = IERC20(rewardToken).balanceOf(IJaxAdmin(jaxAdmin).jaxSwap());
    ...
    function get_latest_apy() external view returns(uint) {
        ...
        return 1e8 * 365 * 24 * 3600 * last1Epoch.reward / last1Epoch.wjxnStakedAmount / period;
    }
