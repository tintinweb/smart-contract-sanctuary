...
/// @title Migrator
/// @notice Enables migration of liqudity from Uniswap v2-compatible pairs into BitrielSwap pools
interface IMigrator is IMulticall, ISelfPermit, IPoolInitializer {
    ...
    /// @notice Migrates liquidity by burning Uniswap v2 liquidity and minting a new position for BitrielSwap
    /// @dev Slippage protection is enforced via `amount{0,1}Min`, which should be a discount of the expected values of
    /// the maximum amount of BitrielSwap liquidity that the Uniswap v2 liquidity can get. For the special case of migrating to an
...
/// @notice Wraps BitrielSwap positions in a non-fungible token interface which allows for them to be transferred
/// and authorized.
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0xb38d98bd856dc12841801989112fe2ddf70448dda475a1601602947fd760c4e9;
