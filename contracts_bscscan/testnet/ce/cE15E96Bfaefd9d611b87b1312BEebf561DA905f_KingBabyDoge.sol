...
contract KingBabyDoge is Context, IERC20, Ownable {
    ...
    function setAddressFee(address _address, bool _enable, uint256 _addressLiquidityFee, uint256 _addressCharityFee, uint256 _addressMarketingFee) external onlyOwner {
        _addressFees[_address].enable = _enable;
        _addressFees[_address]._liquidityFee = _addressLiquidityFee;
        _addressFees[_address]._charityFee = _addressCharityFee;
