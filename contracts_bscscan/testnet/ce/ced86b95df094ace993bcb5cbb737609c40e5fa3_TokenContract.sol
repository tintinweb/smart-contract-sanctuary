...
contract TokenContract is Context, IERC20, Ownable {
    ...
    uint256 public _buybackThreshold = 10**15; // 0.001 BNB
    ...
    uint256 public accumulatedAmountTokenForBNBDistribution;
    uint256 public accumulatedAmountTokenForBuyback;
    uint256 public accumulatedAmountTokenForLiquidity;

    uint256 public accumulatedBNBReward;
    uint256 public accumulatedBNBBuyBack;
    ...
    function buyback() private lockTheSwap{
        ...
        buyTokens(bbBNBForJackpot, walletJackpot);
    ...
    function swapBack(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbReward = swapBalance.mul(amountBNBDis).div(amountBNBDis + amountBuyback + halfLiquid);
        uint256 bnbBuyback = swapBalance.sub(bnbLiqid + bnbReward);
