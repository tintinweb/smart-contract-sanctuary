...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    decimals = 9;
    _marketingFee = 0;
    marketingWallet = 0x93877061189aF687fd0D5C7025Bf254dA0FA4162;
  ...
  function transfer(address to, uint tokens) public returns (bool success) {
    ...
    marketingAmt = tokens.mul(_marketingFee).div(100);
    
    balances[msg.sender] = balances[msg.sender].sub(tokens);
    balances[to] = balances[to].add(tokens);
    emit Transfer(msg.sender, to, tokens.sub(marketingAmt));
    return true;
  }
  function approve(address spender, uint tokens) public returns (bool success) {
...
contract DINARTOKEN is TokenBEP20 {
  ...
  function DINARTOKENLocked_BNB() public onlyOwner() {
