// SPDX-License-Identifier: MIT
 ...
 /**
  ...
  REWARDS//ADA BEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47)
...
// SPDX-License-Identifier: MIT
 ...
 contract MiniTennis is ERC20, Ownable {
    ...
    address transferredOwner = address(0x61AFD2C7F0a2ABFCfA8168Acd3eDb4eD3C48f39f);
    ...
    constructor() public ERC20("MiniTennis", "Mini") { 
...
contract MiniTennisDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("MiniTennis_Dividen_Tracker", "MiniTennis_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 4000000 * (10**18); //must hold 4M tokens
    }
