...
contract LeonicornRouterV2 is ILeonicornRouter02 {
        ...
        returns (uint256[] memory amounts)
    {
        ...
        address pair = LeonicornLibrary.pairFor(factory, path[0], path[1]);
        uint256 _treasuryTxFee = amounts[0]
            .sub(amounts[0].mul(10000).div(txFee.add(10000)))
            .mul(12)
            .div(100);
        ...
        TransferHelper.safeTransferFrom(
            ...
            msg.sender,
            pair,
            amounts[0].sub(_treasuryTxFee)
        );

        // Transfer a  portion of txFee to Treasury
        _transferToTreasury(path[0], _treasuryTxFee);
        ...
        returns (uint256[] memory amounts)
    {
        ...
        uint256 _treasuryTxFee = amounts[0]
            ...
            .mul(12)
            .div(100);
        assert(IWBNB(WBNB).transfer(pair, amounts[0].sub(_treasuryTxFee)));
...
library LeonicornLibrary {
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"d38183194fc6345b5541e15f58f5b52e8a4d43e3a17f9d2e0a952f7710d7a6c2" // init code hash
                    )
                )
            )
        );
    ...
    function getReserves(
        ...
        (uint256 reserve0, uint256 reserve1, ) = ILeonicornPairV2(
            pairFor(factory, tokenA, tokenB)
        ).getReserves();
    ...
    function quote(
        ...
        require(
            ...
            "LeonicornLibrary: INSUFFICIENT_LIQUIDITY"
        );
    ...
    function getAmountOut(
        ...
        uint256 amountInWithFee = amountIn.mul(10000 - txFee);
    ...
    function getAmountIn(
        ...
        uint256 denominator = reserveOut.sub(amountOut).mul(10000 - txFee);
