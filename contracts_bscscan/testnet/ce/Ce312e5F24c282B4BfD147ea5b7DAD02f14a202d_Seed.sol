...
contract Seed is ERC20, Ownable, TrustCaller {
    ...
    uint256 constant TO_ALLOCATION = 95;
    ...
    function mint(address toAccount, uint256 amount) external onlyTrustCaller {
        ...
        uint256 devFee = amount.mul(FEE_ALLOCATION).div(TOTAL_ALLOCATION);
        uint256 toAmount = amount.mul(TO_ALLOCATION).div(TOTAL_ALLOCATION);
        transferFrom(address(this), feeWallet, devFee);
        transferFrom(address(this), toAccount, toAmount);
    }
