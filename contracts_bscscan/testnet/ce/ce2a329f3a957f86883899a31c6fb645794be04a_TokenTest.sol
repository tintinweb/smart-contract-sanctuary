...
contract TokenTest is Context, IERC20, Ownable {
    ...
    address private _MarketingwalletAddress = 0x87e3Fe1E9f587049C7A88aaFefb64aDc3ECdCd5C;
    ...
    string private _symbol = "TTOKEN1";
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "TTOKEN is not live yet");
