...
contract testxt is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa670CF327f7553F7f50E02f2a66fC607F82aAbbd); // Marketing Address
    ...
    string private _name = "testxt";
    string private _symbol = "testxt";
