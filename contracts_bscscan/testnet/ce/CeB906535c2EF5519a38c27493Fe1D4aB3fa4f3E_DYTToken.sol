...
contract DYTToken is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 maxAmount =  200 * 10**3 * 10**18;

    address public mktAddr = 0xaf580f615E58F737e24701Cd90BbdfFFb598ffCd;
    uint256 public swapTokensAtAmount = 10 * 10**3 * 10**18;
    uint256 public addLPTime = 1636536952;
    ...
    function setFee(uint256 _sellFee, uint256 _buyFee) public onlyOwner{
        require(1<= _sellFee && _sellFee <=10, "SellFee <= 10");
        require(1<= _buyFee && _buyFee <=10, "BuyFee <= 10");
        sellFee = _sellFee;
        buyFee = _buyFee;
    } 
