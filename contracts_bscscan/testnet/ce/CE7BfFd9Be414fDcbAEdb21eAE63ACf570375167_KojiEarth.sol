...
contract DividendDistributor is IDividendDistributor {
    ...
    function mathInfo() external view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        return (totalShares, netDividends, totalDistributed, totalReinvested, totalWithdrawn, frameDividends, totalDividends);
    }
...
contract KojiEarth is IBEP20, Auth {
    ...
    string constant _symbol = "KOJI v0.150";
    ...
    function ViewMathInfo() external view returns (uint256 totalshares, uint256 netdividends, uint256 totaldistributed, uint256 totalreinvested, uint256 totalwithdrawn, uint256 framedivs, uint256 totaldividends) {
