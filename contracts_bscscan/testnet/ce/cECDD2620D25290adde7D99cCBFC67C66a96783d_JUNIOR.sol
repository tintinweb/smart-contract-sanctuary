 ...
 * Name:  Junior
 * Symbol: JUNIOR
 * Telegram: https://t.me/BUSDeriusjunior
 * Twitter: https://twitter.com/BUSDeriusJunior 
 */
...
contract JUNIOR is Context, IBEP20, Ownable, ReentrancyGuard{ 
    using SafeMath for uint256;
    ...
    uint256 public externalFee = 9;
    uint256 private _previousExternalFee = externalFee;
    ...
    uint256 public _buyExternalFee = 6;
    uint256 public _buyLiquidityFee = 4;
    uint256 public _buyBurnFee = 1;

    uint256 public _sellReflectionFee = 5;
    uint256 public _sellExternalFee = 6;
    uint256 public _sellLiquidityFee = 4;
    uint256 public _sellBurnFee = 1;

    uint256 public _buytotalBNBFee = _buyReflectionFee.add(_buyExternalFee).add(_buyLiquidityFee).add(_buyBurnFee);
    uint256 public _selltotalBNBFee =_sellReflectionFee.add(_sellExternalFee).add(_sellLiquidityFee).add(_sellBurnFee);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _maxTxAmount || isTxLimitExempt[sender], "Max token limit for this account exceeded. Try a lower amount.");
        ...
        "Wait for the trade cooldown to finish before making another trade.");
    ...
    function removeAllFee() public {
        if( totalBNBFee == 0 && reflectionFee == 0 && externalFee == 0 && liquidityFee == 0 && burnFee == 0) return;

        _previousReflectionFee = reflectionFee;
        _previousExternalFee   = externalFee;        
    ...
    function restoreAllFee() public {
        ...
        externalFee   = _previousExternalFee;        
    ...
    function setRewardFees(uint256 _rewardFee) external onlyOwner {
        ...
        totalBNBFee = reflectionFee.add(externalFee).add(liquidityFee).add(burnFee);
    }
