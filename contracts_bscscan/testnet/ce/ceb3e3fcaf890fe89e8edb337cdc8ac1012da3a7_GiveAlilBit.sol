...
/**
   ...
   1% Goes to burn address on every transaction.
*/
...
contract GiveAlilBit is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 369 * 10**6 * 10**10;
    ...
    uint256 public _maxTxAmount = 150 * 10**6 * 10**10;
    uint256 private numTokensSellToAddToLiquidity = 170 * 10**6 * 10**10;
    ...
    function setburnFeePercent(uint256 burnFee) internal onlyOwner() {
        _burnFee = burnFee;
    }
