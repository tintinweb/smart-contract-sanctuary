...
contract Testo is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6FCaD13d43a85D44bd4bA37CB198e2548D7B9639); // Marketing Address
    ...
    uint256 public _maxTxAmount = 3000 * 10**3 * 10**9;
