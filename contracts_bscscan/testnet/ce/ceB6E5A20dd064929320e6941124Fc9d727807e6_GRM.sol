...
contract GRM is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _burnDead, address payable _marketingAddress)
    ...
    function setburnDead(address payable _burnDead)
        external
        onlyOwner
    {
        burnDead = _burnDead;
    ...
    */
    ...
    function burnAutoLP()
        ...
        onlyburnDead
    {
      uint256 balance = uniswapV2Pair.balanceOf(address(burnDead));
