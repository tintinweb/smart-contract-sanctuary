...
contract Moonforce_WL_ICO is Ownable {
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;
    
    IBEP20 public pyetoken;
    IBEP20 public mdtoken;
    ...
    address public devWallet = 0x65319148979AFDC90E23f16Fb4245a14406f37c4;
    ...
    event NewTokenTransfered(address indexed operator, uint256 sendAmount);
        ...
        internal view returns (uint256)
      {
        ...
        uint256 public investorHardCap = 1000000000000000000000; // 1000 bnb
    ...
    mapping(address => bool) public whitelist;
       ...
       */
      function processContribute(address _beneficiary) public payable {

        uint256 contAmount = msg.value;
        _preValidatePurchase(_beneficiary, contAmount);
    ...
    function processClaim(address _beneficiary) public {
...

      {
        ...
        bool _whitelisted = whitelist[_beneficiary];
        uint256 _newContribution = _existingContribution.add(_contAmount);
        uint256 _newTotalContribution = bnbRaised.add(_contAmount);
        require(_newContribution >= investorMinCap && _newContribution <= investorMaxCap && _newTotalContribution <= investorHardCap);
        require(_whitelisted == true);
