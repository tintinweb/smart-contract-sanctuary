...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "INCOME ISLAND";
    string internal constant SYMBOL = "INCOME";
    ...
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 1; // 100% of the total supply
    ...
    address internal donationAddress = 0x9970eB4a8e335F832D1A5466C93EaC0835f9d06A;
    address internal marketingAddress = 0x9970eB4a8e335F832D1A5466C93EaC0835f9d06A;        
    address internal BuybackWallet = 0x78476106932265a21D6F4bD07E590dd2f6f2d6a2;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 30, donationAddress );
        _addFee(FeeType.Liquidity, 40, address(this) );
        _addFee(FeeType.External, 40, BuybackWallet );
...
abstract contract CoviShieldtoken is BaseRfiToken, Liquifier, Antiwhale {
...
contract CoviShieldtokenWrap is CoviShieldtoken{

    constructor() CoviShieldtoken(Env.Testnet){
