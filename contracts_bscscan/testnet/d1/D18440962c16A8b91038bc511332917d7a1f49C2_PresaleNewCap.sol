...
contract PresaleNewCap is Ownable, Trusted{
    ...
    function buyTokens(uint256 quantity, address buyer) private onlyHuman {
        ...
        require(quantityBought[buyer].add(quantity) < 1e18, '[ERROR: THANK YOU FOR YOUR KIND SUPPORT, BUT YOU CAN NOT BUY SO MANY TOKENS. Wait for launch to purchase more]');
