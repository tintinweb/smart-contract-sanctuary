...
contract preSale {
    ...
    constructor(address payable _owner, IBEP20 _token,uint256 _claimTime) {
        owner = _owner;
        token = _token;
    ...
    function claim() public {
        require(block.timestamp > claimTime, "PRESALE: Claim not started.");
    ...
    function updateClaimTime(uint256 _time) external onlyOwner {
        claimTime = _time;
    }
