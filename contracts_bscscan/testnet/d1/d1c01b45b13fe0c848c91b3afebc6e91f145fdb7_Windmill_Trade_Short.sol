...
abstract contract Windmill_Trade_Borrow is Base, Windmill_Trade_Swap, I_Windmill_Trade_Borrow{
    ...
    function setInitBUSDBalance(uint256 _initBUSDBalance) public override(I_Windmill_Trade_Abstract, Windmill_Trade_Abstract) onlyRole(TRADE_MANAGER_ROLE){
        ...
        BUSDReserve = (_initBUSDBalance * (maxStopLoss.denominator - maxStopLoss.numerator) * (securityFactor.denominator - securityFactor.denominator)) / (maxStopLoss.denominator * securityFactor.denominator);
    }
    ...
    function getAvailableBUSD() public view override(I_Windmill_Trade_Swap, Windmill_Trade_Swap) returns(uint256){
