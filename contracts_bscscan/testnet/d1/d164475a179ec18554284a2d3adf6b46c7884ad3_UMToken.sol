...
contract UMToken is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    uint256 liquidityFee = 1500;     // 1.5%   Liquidez
    uint256 marketingFee = 1500;     // 1.5%   Marketing

    uint256 totalSellFee = 1600;    // 16% Venda ( 6% + 6% + 3% + 1% )

    string constant _name = "DIV TOKEN V1";
    string constant _symbol = "D1 TOKEN";
