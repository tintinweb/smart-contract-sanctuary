...
// change "name1" into ur name
    contract StandardInGold is Context, IERC20, Ownable {
...
//change "name1" and "symbol"
    ...
    // this goes to a specific wallet
    uint256 public _operationFee = 300;
    ...
    constructor() public {
        ...
        operationWallet = 0x748d67756CC7E9099F7F9dF968535B0BcA75fA32;
        marketingWallet = 0x4Db5d5FdE39D7224d5690B475D21cA09A0d78e96;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
