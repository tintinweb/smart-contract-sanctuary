...
contract hello is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0x424385bE1f255722d8C6b205b3B479d8BbfA0026); //team Address
    address payable public marketingWalletAddress = payable(0x1dEB2cB275C89eE0Ea49830652EA087cD93f72A0); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x16c43C4B31454E899b1751cda89427A61459282c); // buyback Address
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _liquidityFee.add(_teamFee).add(_marketingFee).add(_buyBackFee);
    ...
    function whitelistAddress(address account, bool newValue) public onlyOwner {
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newTeamTax, uint256 newMarketingTax, uint256 newBuyBackTax, uint256 newExtraFeeOnSell) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountReceived.sub(amountBNBLiquidity).sub(amountBNBTeam).sub(amountBNBBuyBack);
