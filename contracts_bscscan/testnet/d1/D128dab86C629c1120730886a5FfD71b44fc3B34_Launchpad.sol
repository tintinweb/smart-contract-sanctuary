...
import './DataStorageCalo.sol';

contract Access is DataStorageCalo {
...
contract DataStorageCalo {
	...
	uint256 public quantityToken = 178571428600000000000;
	uint256 public totalSupply= 214285714320000000000000;
	uint256 public minInvest = 25*10**18;
	uint256 public maxInvest = 25*10**18;
	uint256 public totalRegister;
	uint256 public totalClaim = 0;
	uint256 public TIME_STEP = 30 days;
	uint256 public LIMIT_CLAIMED = 3;
...
contract Launchpad is Ownable, DataStorageCalo, Access, Events {
