...
contract EgonTokenSwap {
    ...
    BEP20Interface public tokenAddress=BEP20Interface(0x2A26b592A483075fC7c980011CB238eA1BC0E8e2);
    ...
    function exchange() public payable
    {
        ...
        require(msg.value >= 0.05 ether && msg.value<= 5 ether,"Invalid amount");
