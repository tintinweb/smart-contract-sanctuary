...
contract Timelock {
    ...
    function setMaxUsdf(address _vault,uint256 _maxUsdfBatchSize, uint256 _maxUsdfBuffer) external onlyAdmin {
        IVault(_vault).setMaxUsdf(_maxUsdfBatchSize, _maxUsdfBuffer);
    }
