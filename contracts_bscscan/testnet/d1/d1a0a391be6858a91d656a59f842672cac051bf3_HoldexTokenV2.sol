...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes calldata) {
        this; // silence state mutability warning without generating holdexfinance
        return msg.data;
    }
}
...
contract HoldexTokenV2 is ERC20Decimals, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover {
    constructor(
        string memory name_,
