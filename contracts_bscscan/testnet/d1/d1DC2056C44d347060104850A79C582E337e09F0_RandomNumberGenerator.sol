    ...
    Ownable
{
    ...
    address public whaleFallLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == whaleFallLottery, "Only whaleFallLottery");
    ...
    /**
     * @notice Set the address for the whaleFallLottery
     * @param _whaleFallLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _whaleFallLottery) external onlyOwner {
        whaleFallLottery = _whaleFallLottery;
    }
        ...
        override
    {
        ...
        latestLotteryId = IWhaleFallLottery(whaleFallLottery)
...
interface IWhaleFallLottery {
     ...
     * @param _priceTicketInWhaleFall: price of a ticket in WhaleFall
    ...
    function startLottery(
        uint256 _endTime,
        uint256 _priceTicketInWhaleFall,
...
import "../interfaces/ILinkTokenInterface.sol";
...
abstract contract VRFConsumerBase is VRFRequestIDBase {
    ...
    ILinkTokenInterface internal immutable LINK;
