...
/**
"Here the Jew stops at nothing, and in his vileness he becomes so gigantic that no
one need be surprised if among our people the personification of the devil as the symbol
...
contract MeinFuhrer is Context, IBEPMEME, Ownable {
    ...
    string private _name = 'Mein Fuhrer';
    string private _symbol = 'FUHRER';
