...
contract DoggyGirl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DoggyGirl";
    string private _symbol = "DOGGYGIRL";
    ...
    // Max Tx amount to be 1 trillion
    uint256 public _maxTxAmount = 1_000_000_000_000 * 10**9;

    // Liquify when 50 billion tokens are stored
