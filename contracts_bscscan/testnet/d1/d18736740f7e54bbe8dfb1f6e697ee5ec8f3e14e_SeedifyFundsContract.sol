...
contract SeedifyFundsContract is Ownable {
    ...
    constructor(
        ...
        totalUserInTierOne = 100;
        totalUserInTierTwo = 100;
        totalUserInTierThree = 100;
        totalUserInTierFour = 100;
        totalUserInTierFive = 100;
        totalUserInTierSix = 100;
        totalUserInTierSeven = 100;
        totalUserInTierEight = 100;
        totalUserInTierNine = 100;
    ...
    function addWhitelistTwo(address[] memory _address) external onlyOwner {
       uint i;
            for(i= 1; i<= _address.length ; i++){
            TierTwo memory a = TierTwo(_address);
                whitelistTierTwo.push(a);
            }
    }
    ...
    function addWhitelistThree(address[] memory _address) external onlyOwner {
        uint i;
            for(i= 1; i<= _address.length ; i++){
            TierThree memory a = TierThree(_address);
                whitelistTierThree.push(a);
            }
    }
    ...
    function addWhitelistFour(address[] memory _address) external onlyOwner {
        uint i;
            for(i= 1; i<= _address.length ; i++){
            TierFour memory a = TierFour(_address);
                whitelistTierFour.push(a);
            }
    }
    ...
    function addWhitelistFive(address[] memory _address) external onlyOwner {
        uint i;
            for(i= 1; i<= _address.length ; i++){
            TierFive memory a = TierFive(_address);
                whitelistTierFive.push(a);
            }
    }
    ...
    function addWhitelistSix(address[] memory _address) external onlyOwner {
        uint i;
            for(i= 1; i<= _address.length ; i++){
            TierSix memory a = TierSix(_address);
                whitelistTierSix.push(a);
            }
    }
    ...
    function addWhitelistSeven(address[] memory _address) external onlyOwner {
        uint i;
            for(i= 1; i<= _address.length ; i++){
            TierSeven memory a = TierSeven(_address);
                whitelistTierSeven.push(a);
            }
    }
    ...
    function addWhitelistEight(address[] memory _address) external onlyOwner {
        uint i;
            for(i= 1; i<= _address.length ; i++){
            TierEight memory a = TierEight(_address);
                whitelistTierEight.push(a);
            }
    }
    ...
    function addWhitelistNine(address[] memory _address) external onlyOwner {
        uint i;
            for(i= 1; i<= _address.length ; i++){
            TierNine memory a = TierNine(_address);
                whitelistTierNine.push(a);
            }
    }
   ...
   //////// check the address in whitelist tier one/////////
    ...
    function getWhitelistTwo(address _address) public view returns (bool) {
       uint i;
        for (i = 0; i < whitelistTierTwo.length; i++) {
          TierTwo memory a = whitelistTierTwo[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
    ...
    function getWhitelistThree(address _address) public view returns (bool) {
        ...
        for (i = 0; i < whitelistTierThree.length; i++) {
          TierThree memory a = whitelistTierThree[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
    ...
    function getWhitelistFour(address _address) public view returns (bool) {
       uint i;
        for (i = 0; i < whitelistTierFour.length; i++) {
          TierFour memory a = whitelistTierFour[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
    ...
    function getWhitelistFive(address _address) public view returns (bool) {
       uint i;
        for (i = 0; i < whitelistTierFive.length; i++) {
          TierFive memory a = whitelistTierFive[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
    ...
    function getWhitelistSix(address _address) public view returns (bool) {
       uint i;
        for (i = 0; i < whitelistTierSix.length; i++) {
          TierSix memory a = whitelistTierSix[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
    ...
    function getWhitelistSeven(address _address) public view returns (bool) {
       uint i;
        for (i = 0; i < whitelistTierSeven.length; i++) {
          TierSeven memory a = whitelistTierSeven[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
    ...
    function getWhitelistEight(address _address) public view returns (bool) {
       uint i;
        for (i = 0; i < whitelistTierEight.length; i++) {
          TierEight memory a = whitelistTierEight[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
    ...
    function getWhitelistNine(address _address) public view returns (bool) {
       uint i;
        for (i = 0; i < whitelistTierNine.length; i++) {
          TierNine memory a = whitelistTierNine[i];
          if (a._address[i] == _address) {
            return true;
          }
        }
