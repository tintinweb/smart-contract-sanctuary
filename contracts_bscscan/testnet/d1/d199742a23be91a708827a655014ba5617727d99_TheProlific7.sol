...
contract TheProlific7 is Context, IERC20, Ownable {
    ...
    string private _name = "The Prolific 7";
    string private _symbol = "PRO7";
    ...
    uint256 private _fundingFee = _marketingFee.add(_charityFee);
    uint256 private _previousFundingFee = _fundingFee;
    
    address public marketingAddress = 0x4Ab21668C0a9B9917F342Aeb1D5019Bd34aa3cA9;
    address public charityAddress = 0x88bF343a26d713Be9b8FcD09A35F4D7f2Ee43Fb6;
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, burn, liquidity and funding fee
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Temporarily remove fees to transfer to burn address and funding wallet
        removeAllFee();

        //Send transfers to deadAddress, charity and marketing address
        if (burnAmt > 0) {
            _transferStandard(sender, deadAddress, burnAmt);
        }
        
        if (fundingAmt > 0) {
            _transferStandard(sender, charityAddress, fundingAmt.div(4).mul(_charityFee));
        }
        
        if (fundingAmt > 0) {
            _transferStandard(sender, marketingAddress, fundingAmt.div(4));
        }
