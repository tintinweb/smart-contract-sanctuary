...
contract FarmAuction is Ownable, ReentrancyGuard {
    ...
    event AdminAuctionClaim(uint256 indexed auctionId, uint256 amount);
    ...
    event NewBid(address indexed account, uint256 amount, uint256 indexed auctionId);
    event NewClaim(address indexed account, uint256 amount, uint256 indexed auctionId);
    ...
    function bid(uint256 _amount) external nonReentrant {
        ...
        if (auctionBids[currentAuctionId][msg.sender].totalAmount == 0) {
            require(_amount >= initialBidAmount, "Bid: Initial amount incorrect");
        }
    ...
    function startAuction(
        ...
        require(_topLeaderboard > 0, "Auction: Leaderboard cannot be zero");
        ...
        nonReentrant
    {
        ...
        emit AdminAuctionClaim(_auctionId, claimableAmount);
    }
