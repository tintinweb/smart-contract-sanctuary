...
contract DividendDistributor is IDividendDistributor {
    ...
    event Deposit(uint256 amountBNB, uint256 amountAXS);
...
contract PoCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PoCake TESTNET V3";
    string constant _symbol = "PCAKETSTNT";
