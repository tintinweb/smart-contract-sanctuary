...
contract ExoticMonsterController is Ownable {
    ...
    function approve() public {
        EMC20.approve(address(this), EMC20.balanceOf(msg.sender));
    }

    function allowance() public returns (uint256) {
        return EMC20.allowance(msg.sender, address(this));
    }
    ...
    function ownerWithdrew(uint256 amount) public  onlyOwner{
        ...
        EMC20.transfer(msg.sender, amount * 10 **18 );
    }
    ...
    function ownerDeposit( uint256 amount ) public onlyOwner {
        ...
        EMC20.transferFrom(msg.sender, address(this), amount * 10 **18);
    }
    ...
    function selectBox(uint8 boxId) public {
        ...
        if(1 == boxId){
            ...
            //用户支付币
            EMC20.transferFrom(msg.sender,_boxAddress,1800 * 10 **18);
        ...
        if(2 == boxId){
            ...
            EMC20.transferFrom(msg.sender,_boxAddress,5200 * 10 **18);
        ...
        if(3 == boxId){
            ...
            EMC20.transferFrom(msg.sender,_boxAddress,8100 * 10 **18);
