...
contract MyDiamondTeam_AirdropV1 {
    ...
    bool public teamairdrop_enabled;
    ...
    function initialize(address _mainContract, address _projectWallet) external{
        ...
        teamairdrop_enabled = true;
        minamount = 1000000000000000; // 0.001 bnb
    ...
    function airdrop(address payable _to) payable external {
        ...
        require(airdrop_enabled, "feature inactive");
    ...
    function teamAirdrop(uint256 teamId, bool excludeOwner) payable external {
        require(started, "contract inactive");
        require(teamairdrop_enabled, "feature inactive");
        ...
        require(amountDivided > 0, "zero value not allowed");
        require(exdata__team.members.length > 1, "no team members");
   ...
   function start() external {
    ...
    function CHANGE_AIRDROP_ENABLED(bool value) external {
        require(msg.sender == owner, "Admin use only");
        airdrop_enabled = value;
    }

    function CHANGE_TEAMAIRDROP_ENABLED(bool value) external {
        require(msg.sender == owner, "Admin use only");
        teamairdrop_enabled = value;
    }
