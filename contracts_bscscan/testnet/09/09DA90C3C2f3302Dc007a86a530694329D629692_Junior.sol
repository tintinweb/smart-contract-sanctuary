...
contract Junior is Context, IERC20, Ownable{
        ...
        constructor (address payable opsTeamWalletAddress) public {	
			...
			//IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // BSC Main Adaptor
        ...
        function excludeAccount(address account) external onlyOwner() {
			//require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We can not exclude Uniswap router.'); // BSC Main net
			require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We can not exclude Binance router.'); // BSC Test Net	
