...
contract MarketMaker is Ownable, ERC20, ERC1155TokenReceiver {
        ...
        atStage(Stage.Paused)
    {
        ...
        if (fundingChange > 0) {
            ...
            if (totalSupply() == 0) {
                _mint(msg.sender, uint(fundingChange));
            } else {
                _mint(msg.sender, uint(fundingChange).mul(totalSupply()).div(funding));
            }
        ...
        if (fundingChange < 0) {
            ...
            if (totalSupply() == 0) {
                _burn(msg.sender, uint(-fundingChange));
            } else {
                _burn(msg.sender, uint(-fundingChange).mul(totalSupply()).div(funding));
            }
        ...
        returns (uint fees)
    {
        ...
        // Transfer fees
        require(collateralToken.transfer(msg.sender, fees));
