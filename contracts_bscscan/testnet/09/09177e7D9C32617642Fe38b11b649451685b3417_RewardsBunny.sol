...
contract RewardsBunny is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    function _getCurrentSupply() private view returns(uint256, uint256) {
        ...
        rSupply = rSupply - _rOwned[_uniswapV2Pair];
        tSupply = tSupply - _tOwned[_uniswapV2Pair];

        rSupply = rSupply - _rOwned[address(_uniswapV2Router)];
        tSupply = tSupply - _tOwned[address(_uniswapV2Router)];
