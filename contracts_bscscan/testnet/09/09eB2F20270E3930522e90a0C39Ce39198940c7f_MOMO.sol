...
import "./SafeMath.sol";
import "./MOMODividendTracker.sol";
...
contract MOMO is ERC20, Ownable {
    ...
    uint256 public lastTransferTokenRewardsInterval = 1800; // Sending 50% of the BNB Balance to the Rewards Pool every hour so that there is no wastage of BNB.
    ...
    constructor() public ERC20("MOMOToken", "MOMO") {
