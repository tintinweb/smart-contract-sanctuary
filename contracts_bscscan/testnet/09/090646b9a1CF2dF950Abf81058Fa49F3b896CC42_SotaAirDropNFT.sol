...
contract SotaAirDropNFT is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    mapping(uint256 => AirDropNFT) public airDropNFT;
    ...
    function operatorLuckyDraw(uint256 _start, uint256 _end, address[] calldata _addressDraw) external {
        ...
        newRound.drawTime = block.timestamp;
        ...
        uint256 randomNumber = uint(keccak256(abi.encodePacked(block.difficulty, block.timestamp, msg.sender)));
