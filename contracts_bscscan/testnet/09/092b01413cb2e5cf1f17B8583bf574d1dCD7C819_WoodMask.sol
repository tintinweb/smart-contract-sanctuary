...
contract WoodMask is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x963E6Cde8cA8448eEF87Fc9582b22B45B2d5374E); // Marketing Address
    ...
    string private _name = "WoodMask";
    string private _symbol = "Wood";
