...
contract Convert {
    ...
    function sendAfterConvert(
        ...
        IBEP20(tokenAddress).transfer(address(address1), tokenBalance.div(3));
        // IBEP20(tokenAddress).transfer(address2, tokenBalance.div(3));

        // uint256 rest = tokenBalance - IBEP20(tokenAddress).balanceOf(address(this));

        // IBEP20(tokenAddress).transfer(address3, rest);
    }
}