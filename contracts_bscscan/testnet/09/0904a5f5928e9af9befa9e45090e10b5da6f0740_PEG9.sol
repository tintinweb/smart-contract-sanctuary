...
contract PEG9 {
    ...
    string public name = "Play Earn Game9";
    string public symbol = "PEG9";
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        approve(msg.sender, toBurn);
        require(transferFrom(msg.sender, dead, toBurn));
        approve(msg.sender, toTax);
        require(transferFrom(msg.sender, taxWallet, toTax));
        balances[to] += value;
