...
contract TEST2 is ERC20, Ownable, Pausable {
    // CONFIG START

    uint256 denominator = 100;
    
    // TOKEN
    string tokenName = "Test2 token";
    string tokenSymbol = "T2";
    uint256 tokenTotalSupply = 2_000_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0x8Cca3B561E001dEDf2429D166e7a454846096Bac;
    address devWallet = 0x56E104b022256339e82f4b833Bb946722f746630;
    address router02 = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

    // BUY TAX
    uint256 public devTaxBuy = 1;
    uint256 public marketingTaxBuy = 3;
    uint256 public redistributeTaxBuy = 8;

    // SELL TAX
    uint256 public devTaxSell = 2;
    uint256 public marketingTaxSell = 6;
    uint256 public redistributeTaxSell = 16;
