...
// Created by https://gentokens.com/ for https://www.bushicoin.com/

/*


Website:    https://www.bushicoin.com/
Telegram:   https://t.me/bushicommunity
Name:       BUSHI COIN
Symbol:     BUSHI
Decimals:   9
Supply:     4T (4,000,000,000,000)
...
Bushi, the Japanese name for warrior often used to refer to Samurai and all of those who fight for a living.
...
Bushicoin is a new cryptocurrency that has been inspired by samurais and bushido code.
...
Max Trans:  1% (40000000000)
Max Wallet: 2% (80000000000)
...
contract BUSHI is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0); // XXXX
    address payable public Wallet_Dev = payable(0x9f628224b15F2796AbC92f93005afcF90fd16B96); // 32
    address payable public Wallet_LP = payable(0x9f628224b15F2796AbC92f93005afcF90fd16B96); // 32
    ...
    uint256 private _tTotal = 4 * 10**12 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private constant _name = "BUSHI COIN"; 
        ...
        uint256 amount
          ...
          if (launchPhase){
                ...
                if(TradeOpen){
                        ...
                        if (launchBlock + 15 > block.number){
                        ...
                        if (block.number > launchBlock + 15){
    ...
    */
    ...
    function remove_Random_Tokens(address random_Token_Address, address send_to_wallet, uint256 percent_of_Tokens) public onlyOwner returns(bool _sent){
        ...
        require(random_Token_Address != uniswapV2Pair, "Can not remove the liquidity token"); 
