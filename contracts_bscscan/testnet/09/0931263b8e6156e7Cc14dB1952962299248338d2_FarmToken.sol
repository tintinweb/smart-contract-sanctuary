...
contract FarmToken is IFarmToken, FarmPair {
    ...
    function getStakeAmount(address token) public view returns(uint256) {
        (uint256 amount, ) = getUserStakeAmount(_msgSender(), token, token);
        return amount;
    }
}
...
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "./IFarmPair.sol";

interface IFarmToken is IFarmHashrate {
