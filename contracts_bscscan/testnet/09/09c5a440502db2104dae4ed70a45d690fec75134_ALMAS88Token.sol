...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "ALMAS88 Token";
    string internal constant SYMBOL = "ALMAS88";
     ...
     * `maxTransactionAmount = 2 * 10**13 * 10**9;`
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY; // 5% of the total supply
...
contract ALMAS88Token is SafeToken{
