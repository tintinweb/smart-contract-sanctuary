    ...
    */
    ...
    function withdrawTokens() public  {
      ...
      */
      ...
      function returnVestable() public view {
      	...
      	u_maxvestable=0;
      	if (block.timestamp > 1626828035)  u_maxvestable = (purchasedTokens[msg.sender] / 5) *1; //eg 100
   		if (block.timestamp > 1626830582 )    u_maxvestable = (purchasedTokens[msg.sender] / 5) *2 ;  //eg 200
    	if (block.timestamp > 1626840582 )   u_maxvestable = (purchasedTokens[msg.sender] / 5) *3 ; //eg 300
    	if (block.timestamp > 1626850582 )    u_maxvestable = (purchasedTokens[msg.sender] / 5) *4 ; //eg 300
