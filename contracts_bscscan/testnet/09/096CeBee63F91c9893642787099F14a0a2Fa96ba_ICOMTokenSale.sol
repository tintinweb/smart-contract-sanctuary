...
contract ICOMTokenSale {
    ...
    function buyTokens(uint256 _numberOfTokens) public payable {
        emit Temp(msg.value, _numberOfTokens);
        emit Temp2(msg.value*1000000000000000000, multiply(_numberOfTokens, tokenPrice)/1000000000000000000);
        
        require(msg.value*1000000000000000000 == multiply(_numberOfTokens, tokenPrice)/1000000000000000000,"Amount does not match");
