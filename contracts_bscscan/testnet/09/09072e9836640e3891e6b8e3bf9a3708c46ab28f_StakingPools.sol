...
// File: interfaces/IStakingPoolRewarder7.sol
...
// File: interfaces/IStakingPoolMigrator7.sol
...
contract StakingPools is Ownable {
  ...
  uint256 private constant ACCU_REWARD_MULTIPLIER = 10**20; //  10**20 Precision loss prevention
  ...
  function executeMigratorChange() external payable {
