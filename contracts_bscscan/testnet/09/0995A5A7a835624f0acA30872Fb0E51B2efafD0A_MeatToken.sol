...
contract MeatToken is BEP20, Ownable {
    ...
    constructor() BEP20("MiniNBA", "DUNK", 18) {
        ...
        // address _pancakeswapV2Pair = IPancakeswapV2Factory(_pancakeswapV2Router.factory())
        //     .getPair(address(this), address(WBNB));
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "MiniNBA: The dividend tracker already has that address");

        MiniNBADividendTracker newDividendTracker = MiniNBADividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "MiniNBA: The new dividend tracker must be owned by the MiniNBA token contract");

        newDividendTracker.excludeFromDividends(address(newDividendTracker));
        newDividendTracker.excludeFromDividends(address(this));
        newDividendTracker.excludeFromDividends(address(burnAddress));
        newDividendTracker.excludeFromDividends(address(preSaleWallet));
        newDividendTracker.excludeFromDividends(address(teamWallet));
        newDividendTracker.excludeFromDividends(address(marketingWallet));
        newDividendTracker.excludeFromDividends(address(prizeWallet));
        newDividendTracker.excludeFromDividends(address(contractOfficialWallet));
...

{
  ...
  "libraries": {
    "/contracts/library/IterableMapping.sol": {
      "IterableMapping": "0xFe8C525C29D97EFb2c73DD94644627d1396d6e2F"
    }
  },
  "outputSelection": {
    "*": {
