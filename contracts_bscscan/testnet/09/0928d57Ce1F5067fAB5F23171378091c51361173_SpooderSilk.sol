...
contract SpooderSilk {
    ...
    address public contractSPOOD = 0x786559c3a753AC02002b01Dae7454E45635061eD;
    ...
    constructor() {
        ...
        // LP Wallet
        balances[lpWallet] = 100000000*0.6 * 10 ** 18;
        // Tax Wallet - ONLY FOR DEVELOPMENT
        balances[taxWallet] = 100000000*0.1 * 10 ** 18;
        // Staking Wallet - ONLY FOR DEVELOPMENT
        balances[stakeWallet] = 100000000*0.1 * 10 ** 18;
    }
    ...
    function stake(uint value) public returns(bool) {
        ...
        SpooderToken(contractSPOOD).transfer(stakeWallet, value);
        balances[msg.sender] += value;
