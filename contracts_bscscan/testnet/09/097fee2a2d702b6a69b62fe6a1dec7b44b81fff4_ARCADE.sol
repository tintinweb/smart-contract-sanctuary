...
contract ARCADE is ERC20, Ownable {
    ...
    ARCADEDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x4EaAB06cCC996328743CA9cB76d0e44b499f3528;
    ...
    constructor() public ERC20("Arcade Finance", "ARCADE") {

    	dividendTracker = new ARCADEDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ARCADEDividendTracker newDividendTracker = ARCADEDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ARCADE: The new dividend tracker must be owned by the ARCADE token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ARCADE: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ARCADE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ARCADE: gasForProcessing must be between 200,000 and 500,000");
...
contract ARCADEDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("ARCADE_Dividen_Tracker", "ARCADE_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2000000 * (10**18); //must hold 2000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "ARCADE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "ARCADE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ARCADE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "ARCADE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "ARCADE_Dividend_Tracker: Cannot update claimWait to same value");
