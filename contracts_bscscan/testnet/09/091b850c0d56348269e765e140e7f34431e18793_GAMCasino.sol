...
contract GAMCasino {
  ...
  function kill() public {
    ...
    function setMaximumBet(uint256 maximumBetty) public onlyOwner returns(bool) {
            maximumBetsNr = maximumBetty;
            return true;
    }
    
    function setMinimumBet(uint256 minimumBetty) public onlyOwner returns(bool) {
            minimumBet = minimumBetty;
            return true;
    }
  ...
  function forceGenerateNumberWinner() public{
