...
/**
 * Name: DAIerius Junior
 * Symbol: JUNIOR
 * Telegram: https://t.me/DAIeriusjunior
 * Twitter: https://twitter.com/DAIeriusJunior 
 */
...
contract DAIeriusJunior is Context, IBEP20, Ownable, ReentrancyGuard{ 
    ...
    address public marketingAddress = 0xF3453315aCcfb7Be09c200065fDA26A296375469; 
    address public autoLiquidityReceiver = 0xB17Abe4bD20891de60faA1f619468B99832055a1;

    string constant _name = "DAIeriusJunior";
    string constant _symbol = "JUNIOR";
    ...
    uint256 public totalFee        = marketingFee + liquidityFee + rewardFee + burnFee;
    ...
    uint256 public _maxTxLimit = _totalSupply / 100;
    uint256 public _maxWalletToken = _totalSupply / 50;
    uint256 public minTokensBeforeSwapThreshold = _totalSupply / 10000;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(isExcludedFromAntiWhale[recipient] || balanceOf(recipient) + amount <= _maxWalletToken,
    ...
    function swapBack() internal swapping {
        uint256 amountToLiquify = minTokensBeforeSwapThreshold.mul(liquidityFee).div(totalFee).div(2);
        ...
        uint256 amountBNBLiquidity = receivedBNB.mul(liquidityFee).div(totalBNBFee).div(2);
        uint256 amountBNBReward = receivedBNB.mul(rewardFee).div(totalBNBFee);
        uint256 amountBNBMarketing = receivedBNB.mul(marketingFee).div(totalBNBFee);
    ...
    function setMaxWalletToken(uint256 amount) external onlyOwner {
        _maxWalletToken = amount.mul(10**_decimals);
    }
    ...
    function setFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _rewardFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        ...
        totalFee = _marketingFee + _liquidityFee + _rewardFee + _burnFee;
