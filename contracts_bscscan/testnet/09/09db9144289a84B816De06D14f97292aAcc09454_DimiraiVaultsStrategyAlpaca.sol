...
contract DimiraiVaultsStrategyAlpaca is Ownable, ReentrancyGuard, Pausable {
    ...
    modifier onlyOperator() {
        require(
            operator == msg.sender,
            "DimiraiVaultsStrategyAlpaca: caller is not the operator"
        );
        _;
    }
    ...
    modifier onlyStrategist() {
        require(
            ...
            "DimiraiVaultsStrategyAlpaca: caller is not the strategist"
        );
        _;
    }
    ...
    modifier strategyRunning() {
        require(
            !strategyStopped,
            "DimiraiVaultsStrategyAlpaca: strategy is not running"
        );
        _;
    }
        ...
        onlyOperator
    {
        require(
            ...
            "DimiraiVaultsStrategyAlpaca: !safe - too low"
        );
        require(
            _entranceFeeFactor <= entranceFeeFactorMax,
            "DimiraiVaultsStrategyAlpaca: !safe - too high"
        );
    ...
    function setControllerFee(uint256 _controllerFee) external onlyOperator {
        require(
            ...
            "DimiraiVaultsStrategyAlpaca: too high"
        );
    ...
    function withdraw(address, uint256 _wantAmt)
        ...
        returns (uint256)
    {
        require(_wantAmt > 0, "DimiraiVaultsStrategyAlpaca: !_wantAmt");
        ...
        if (isAutoComp && !strategyStopped) {
            ...
            if (
                ...
                IWETH(0xDfb1211E2694193df5765d54350e1145FD2404A1).deposit{
                    value: (_wantAmt * vault.totalToken()) / vault.totalSupply()
                }();
            }
        }
    ...
    function earn(uint256 _amountOutAmt, uint256 _deadline)
        ...
        whenNotPaused
    {
        require(isAutoComp, "DimiraiVaultsStrategyAlpaca: !isAutoComp");
        require(
            !notPublic || isAuthorised(msg.sender),
            "DimiraiVaultsStrategyAlpaca: !authorised"
        );
