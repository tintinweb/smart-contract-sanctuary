...
//Based on https://github.com/HQ20/StakingToken/blob/master/contracts/StakingToken.sol
// Stakeable NftpToken.
contract NftpToken is ERC20('NFT Plot', 'NFTP'), Ownable {
    ...
    event Unstaked(address stakeholder, uint256 amount);
    /*
