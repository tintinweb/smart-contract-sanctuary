...
contract FuckIt is iBEP20, Context, Ownable {
    ...
    IPancakeRouter02 public immutable ipancakeRouter02;
    address public immutable ipancakePair;
    ...
    constructor (address payable marketingWalletAddress) public {
        ...
        IPancakeRouter02 _ipancakeRouter02 = IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        // Create a pancake pair for this new token
        ipancakePair = IPancakeFactory(_ipancakeRouter02.factory())
            .createPair(address(this), _ipancakeRouter02.WETH());

        // set the rest of the contract variables
        ipancakeRouter02 = _ipancakeRouter02;
       ...
       function name() public view override returns (string memory) {
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We can not exclude IPancakeP router.');
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if (!inSwap && swapEnabled && overMinTokenBalance && sender != ipancakePair) {
        ...
        function swapTokensForEth(uint256 tokenAmount) private lockTheSwap{
            ...
            path[0] = address(this);
            path[1] = ipancakeRouter02.WETH();

            _approve(address(this), address(ipancakeRouter02), tokenAmount);

            // make the swap
            ipancakeRouter02.swapExactTokensForETHSupportingFeeOnTransferTokens(
                tokenAmount,
