...
contract ElpisStaking is Ownable {
    ...
    constructor(
        ...
        require(address(_rewardsToken) != address(0), "rewards token can't be the zero address");
        ...
        returns (uint256)
    {
        ...
        return
            user.amount.mul(accRewardsPerShare).div(PRECISION).sub(user.rewardDebt);
    }
    ...
    function deposit(uint256 _pid, uint256 _amount) external {
        ...
        user.rewardDebt = user.amount.mul(pool.accRewardsPerShare).div(PRECISION);
