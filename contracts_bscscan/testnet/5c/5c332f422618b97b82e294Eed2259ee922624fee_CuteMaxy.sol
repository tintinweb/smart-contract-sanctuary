...
Ownable {
    ...
    constructor (string memory NAME, string memory SYMBOL, uint256 DECIMALS, uint256 SUPPLY, uint256 txFee, uint256 LPFee, uint256 maxAmount, uint256 maxSellAmountAllowed, address routerAddress, address tokenOwner) public {
        _name = NAME;
        _symbol = SYMBOL;
        _decimals = DECIMALS;
