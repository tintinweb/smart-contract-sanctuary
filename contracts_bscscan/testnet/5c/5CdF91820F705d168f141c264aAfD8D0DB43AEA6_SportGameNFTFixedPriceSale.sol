...
contract SportGameNFTFixedPriceSale is SportGameAuctionBase {
    ...
    function nftForSale(uint256 tokenId, uint256 unitPrice, string memory symbol, uint256 deadline) public {
        ...
        _tokenPrices[tokenId] = TokenSalePriceModel(tokenId, unitPrice, symbol, deadline);
        
        emit NFTForSaleEvent(_msgSender(), tokenId, unitPrice, symbol, deadline);
    }
    ...
    function purchaseNFT(uint256 tokenId) public payable {
        ...
        require(model.deadline >= block.timestamp, "Err: NFT-Sale-Time-Ended");
    ...
    function cancelListingNFT(uint256 tokenId) public {
        ...
        require(_tokenPrices[tokenId].unitPrice > 0, "Err: NFT-Not-On-Sale");
    ...
    function fetchTokenSalePrice(uint256 tokenId) public view returns (uint256) { 
