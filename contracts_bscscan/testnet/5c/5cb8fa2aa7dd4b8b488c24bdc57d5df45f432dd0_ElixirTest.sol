...
contract ElixirTest is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "ElixirTest";
	string private _symbol = "ElixirTest";
	...
	constructor () {
		...
		//
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);		// binance PANCAKE V2 testnet
