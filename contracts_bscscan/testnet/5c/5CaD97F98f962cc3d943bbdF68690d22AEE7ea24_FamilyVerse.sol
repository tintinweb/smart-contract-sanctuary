...
contract FamilyVerse is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0xF2f6941Ad7cd061960936d9Fa4f25139aD6399f3;
    address public buyBackWallet = 0xF2f6941Ad7cd061960936d9Fa4f25139aD6399f3;
    address public devWallet = 0xF2f6941Ad7cd061960936d9Fa4f25139aD6399f3;
    address public liquidifyWallet = 0xF2f6941Ad7cd061960936d9Fa4f25139aD6399f3;
    ...
    uint256 private gasPriceLimit = 30 * 1 gwei; // do not allow over x gwei for launch
    ...
    event liquidifyWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("FamilyVerse", "FMV") {
    ...
    function updateLiquidifyWallet(address newWallet) external onlyOwner {
        emit liquidifyWalletUpdated(newWallet, devWallet);
        liquidifyWallet = newWallet;
    }
