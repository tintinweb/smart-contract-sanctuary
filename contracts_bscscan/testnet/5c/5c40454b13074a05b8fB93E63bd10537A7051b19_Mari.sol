...
/*
       ...
       Magenta ETH miner ( Hold mETH Earn ETHER )
       AUTO Payout
       
       telegram : https://t.me/MagentaETH
       twitter  : https://twitter.com/megentaeth
       dev. : MAARI
...
interface MariFactory {
    function createPair(address tokenA, address tokenB) external returns (address pair);
}

interface MariRouter {
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 bETH = IBEP20(0xeA2405166A4D94888F1B3fd1f7Ad774819D616E7);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? MariRouter(_router)
            : MariRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        _token = msg.sender;
    }
...
contract Mari is IBEP20, Auth {
    using SafeMath for uint256;

    address bETH = 0xeA2405166A4D94888F1B3fd1f7Ad774819D616E7;
    ...
    string constant _name = "Magenta Ethereum";
    ...
    // SETMEUP
    address _admin = 0x5708d4075d4127E07e18502aa3Afa356c33D294B;
    ...
    constructor () Auth(msg.sender) {
        router = MariRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        pair = MariFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = uint256(-1);

        distributor = new DividendDistributor(address(router));

        isFeeExempt[_admin] = true;
        isTxLimitExempt[_admin] = true;

        // No timelock for these people
        isTimelockExempt[_admin] = true;
        ...
        marketingFeeReceiver = payable(0x1EaC28E990a1Ca4D4af6c8a6CA324C3581E06804);
