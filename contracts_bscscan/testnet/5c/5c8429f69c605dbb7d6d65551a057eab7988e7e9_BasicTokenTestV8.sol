...
contract BasicTokenTestV8 is Context, IERC20, Ownable {
    ...
    string private _name = "BasicTokenTestV8";
    string private _symbol = "BTTV8";
    ...
    uint256 public _tokenSwapPercentage = 100;
    ...
    function setTokenSwapPercentage(uint256 tokenSwapPercentage) external onlyOwner {
        _tokenSwapPercentage = tokenSwapPercentage;
    }
