...
//     BabyBusd Smart Contract - https://t.me/BabyBusdToken
//
//
//     Tokenomics:
//     8% Busd reflection
...
contract BabyBusd is ERC20, Ownable {
    ...
    address public immutable BUSDToken = address(0x55d398326f99059fF775485246999027B3197955);
    address private _marketingWallet = address(0x3BA28d3a2361EDd8F4f979e7992949558Bf4A21e);
    ...
    constructor() ERC20("BabyBusd", "BabyBusd") {
...
contract BabyBusdDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BabyBusd_Dividend_Tracker", "BabyBusd_Dividend_Tracker") {
        claimWait = 3600;
