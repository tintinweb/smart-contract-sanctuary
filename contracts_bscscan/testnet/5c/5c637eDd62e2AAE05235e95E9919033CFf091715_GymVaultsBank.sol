...
contract GymVaultsBank is ReentrancyGuard, Ownable {
    ...
    address constant buyBack = 0x05818D8bC51Ca2AE20775b6Eb76414B62aA9D62c;
    address public farming;
    // contracts[7] - RelationShip address 
    address constant relationship = 0xCa1913DFa79aF386108D06D21cd369BA7190f4e8;
    ...
    function deposit(
        ...
        PoolInfo storage pool = poolInfo[_pid];
        if (address(pool.want) == 0xDfb1211E2694193df5765d54350e1145FD2404A1) { // If `want` is WBNB
    ...
    function _deposit(
        ...
        if (_wantAmt > 0) {
            if (address(pool.want) != 0xDfb1211E2694193df5765d54350e1145FD2404A1) { // If `want` not WBNB
    ...
    function _transfer(address _token, address _receiver, uint256 _amount) private {
        if (_token == 0xDfb1211E2694193df5765d54350e1145FD2404A1) { // If _token is WBNB
