...
contract HoldMePresale is Ownable {
    using SafeMath for uint256;

    HoldMe public token;
    uint256 public tokensPerBnb = 124333333;

    constructor(address tokenAddress) {
        token = HoldMe(payable(tokenAddress));
    }

    function buyToken() public payable {
        token.transfer(msg.sender, msg.value * tokensPerBnb);
    }
    ...
    function claimBnb(uint256 amount) public onlyOwner {
        ...
        require(sent, "Failed to claim BNB");
    }
...
import "./HoldMeDividendTracker.sol";
import "./HoldMeGame.sol";

contract HoldMe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    HoldMeGame public holdMeGameInstance;
    bool public isGameEnabled;

    HoldMeDividendTracker public dividendTracker;
    address public charityWallet = 0x1D0484fDD5B7eBfb9a7f6a0538c95fb6fabE5a1C;
    address public liquidityWallet = 0x41af2f296b7B65874Cb72A8A2D8FfB9AC61D0Fc3;
    address public marketingWallet = 0x793e34AC061610221840ECc2C3D2b1214AB05624;

    uint256 public swapTokensAtAmount = 10000 * (10**decimals());

    uint256 public sellDividendFee = 40;
    ...
    uint256 public holdMeAmountLiquidityFee = 0;
    ...
    event UpdateWallets(
        ...
        address oldLiquidity,
        address newLiquidity
    );
    ...
    constructor() ERC20("CALUT", "CAL") {
        dividendTracker = new HoldMeDividendTracker();
        ...
        */
        ...
        maxHoldingAmount = totalSupply().div(100).mul(2);
    }

    function setIsGameEnabled(bool _isGameEnabled) public onlyOwner {
        isGameEnabled = _isGameEnabled;
    }

    function setHoldMeGameAddress(address _holdMeGameAddress) public onlyOwner {
        holdMeGameInstance = HoldMeGame(_holdMeGameAddress);
    }

    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(
            newAddress != address(pancakeRouter),
            "HoldMe: The router already has that address"
        );
    ...
    function setWallets(
        ...
        require(newLiquidityAddress != address(0), "Liquidity Zero address");
        emit UpdateWallets(
            charityWallet,
            newCharityAddress,
            marketingWallet,
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "HoldMe: The dividend tracker already has that address"
        );

        HoldMeDividendTracker newDividendTracker = HoldMeDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "HoldMe: The new dividend tracker must be owned by the HoldMe token contract"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "HoldMe: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "HoldMe: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "HoldMe: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        if (!tradingEnabled) {
            require(
                ...
                "HoldMe: This account cannot send tokens until trading is enabled"
            );
        }
        ...
        // end user games
        if (isGameEnabled && msg.sender != pancakePair) {
            holdMeGameInstance.endUserGames(msg.sender);
        }
    }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        holdMeAmountLiquidityFee = amounts[0];
...
contract HoldMeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    ...
    constructor()
        DividendPayingToken("HoldMeDividendTracker", "HoldMe_DividendTracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "HoldMeDividendTracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HoldMeDividendTracker: withdrawDividend disabled. Use the 'claim' function on the main HoldMe contract."
        );
    }
...
contract HoldMeGame is Ownable {
...
import "./standard/SafeMath.sol";
import "./standard/SafeMathUint.sol";
import "./standard/SafeMathInt.sol";
