...
*/
contract TokenV6 is Context, IBEP20, Ownable {
    ...
    string private constant _name = 'TokenV6';
    string private constant _symbol = 'TOKV6';
    ...
    constructor() {
        ...
        pancakeV2Router = IDexRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
