...
contract VenusStrategy is BaseRhoStrategy, PausableUpgradeable {
    ...
    function _bonusPerBlockPerUnderlying() internal view returns (uint256 usdPerBlockPerUnderlying) {
        ...
        usdPerBlockPerUnderlying =
            (xvsPerBlockPerUnderlying * xvsUsdPriceOracle.priceByQuoteSymbol(address(xvs))) /
    ...
    function deploy(uint256 _amount) public override onlyRole(VAULT_ROLE) {
        require(_amount > 0, "VenusStrategy: deploy amount zero");
