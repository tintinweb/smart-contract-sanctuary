...
contract PetCoinToken is BEP20 {
    ...
    function updatePETSSwapRouter(address _router) public onlyOwner {
        ...
        emit PETSSwapRouterUpdated(msg.sender, address(PETSSwapRouter), PETSSwapPair);
    ...
    function setAutomatedMarketMakerPair(address _pair, bool _value) public onlyOwner {
        require(_pair != PETSSwapPair, "PETS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
