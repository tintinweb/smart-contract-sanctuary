...
contract PrivateSellToken is VersionedInitializable{
  ...
  uint256 public constant REVISION = 10;
   ...
   * @return true if the transfer succeeds, false otherwise
   **/
  function buyToken(address recipient, address ref, uint256 usdtAmount, address usdToken) public sellEnabled returns (bool) {
    require(whiteList[ref].enable, "Ref invalid");
