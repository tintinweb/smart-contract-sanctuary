...
contract Sensei is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 111000000 * 10**3 * 10**3;
    ...
    constructor () public {
        ...
        _rOwned[0x9AF792E2F1f44F0d20BBDAA66811978Ecb4C488e] = _rTotal.div(100).mul(65); // supply restant 65%
        ...
        emit Transfer(address(0), 0x9AF792E2F1f44F0d20BBDAA66811978Ecb4C488e, _tTotal.div(100).mul(65)); // supply restant 65%
    }
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _marketingFee == 0 && _burnFee == 0 && _tresorFee == 0 && _stakingFee == 0) return;
