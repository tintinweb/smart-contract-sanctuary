...
contract Swap {
    ...
    address private constant DEV_WALLET = 0x000000000000000000000000000000000000dEaD;
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(address _tokenIn, address _tokenOut, uint _amountIn) external {
      ...
      IPancakeRouter(PANCAKE_V2_ROUTER).swapExactETHForTokensSupportingFeeOnTransferTokens{value:msg.value}( 0, path, msg.sender, block.timestamp);
    }
}