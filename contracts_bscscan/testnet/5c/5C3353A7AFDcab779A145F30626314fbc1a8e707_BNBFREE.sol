...
2% fee, redistributed to the holders
8% fee, used for buybacks (5%) and marketing (3%)
...
contract BNBFREE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x20F84c0F5BB181F00073e89D02CEcf6227514794); // Marketing Address
    ...
    string private _name = "BNBFREE";
    string private _symbol = "BNBFREE";
