...
contract Darcade is ReentrancyGuard, Ownable, Machine {
    ...
    */
     ...
     */
    function collectReward(string memory machineId, string memory gameId, uint256 amountInWei, address payable receiver) public onlyProcessor {
    ...
    */
     ...
     */
    function resetUserGameSession(string memory gameId, string memory userId) internal {
