...
contract CentiRef is ERC20Interface, SafeMath {
  ...
  function transferowner(address newowner) public onlyOwnercont {
   ...
   User memory newUser; 
    ...
    function referadd(address to) private  {
      ...
      users[msg.sender].dis1 = to;
      users[msg.sender].dis2 = users[dis1].dis1;
      users[msg.sender].dis3 = users[dis2].dis1;
      users[msg.sender].dis4 = users[dis3].dis1;
      users[msg.sender].stat = 1;
      
      sales(dis1,dis2,dis3,dis4);
    }
    
    function sales(address  dis1, address  dis2, address  dis3, address  dis4)private {
    ...
    function end(address to) private {
        referadd(to);
    }
