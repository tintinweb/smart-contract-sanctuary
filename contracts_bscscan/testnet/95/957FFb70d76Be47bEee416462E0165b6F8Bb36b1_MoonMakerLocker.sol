...
contract MoonMakerLocker is Ownable, ReentrancyGuard {
    ...
    address payable public moonmakerboss = 0xD3876313e812A6255c7Fc236db33075290cFC526;
    ...
    // Token -> { sender1: unlock time, ... }
    mapping(address => mapping(address => uint256)) public unlockTokenTime;

    //
    mapping(address => uint256[]) public idsByUserAddress;
    ...
    function lockTokens(
        ...
        unlockTokenTime[_tokenAddress][msg.sender] = unlockTokenTime[_tokenAddress][msg.sender].add(_unlockTime);
        ...
        idsByUserAddress[msg.sender].push(_id);
    ...
    function withdrawTokens(uint256 _id) external {
        ...
        unlockTokenTime[tokenAddress][msg.sender] = 0;
    ...
    function getSimpleDetails(uint256 _id) view public returns (uint256)
    {
        return (lockedToken[_id].unlockTime);
    }
    ...
    function getIdByUserAddress(address _address) view public returns (uint256[] memory)
    {
        return idsByUserAddress[_address];
    }

    function _forwardFunds() internal {
        moonmakerboss.transfer(msg.value);
    }
