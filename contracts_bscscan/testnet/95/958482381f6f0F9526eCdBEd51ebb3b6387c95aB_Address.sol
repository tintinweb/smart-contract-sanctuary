...
contract MelaCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 144000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MelaCoin";
    string private _symbol = "MLCN";
    ...
    address private constant MELACOIN = 0x28A2C669d3a01477fa160f2b7181eEB153d65172;   /*  0xE0C7FB1819C73B2b07686b62123Ece18571a7ce4;*/
    
    function swap(address _tokenIn, address _tokenOut, uint _amountIn, uint _amountOutMin, address _to) public payable {
      ...
      address[] memory path;
       if (_tokenIn == MELACOIN || _tokenOut == MELACOIN) {
        path = new address[](2);
        path[0] = _tokenIn;
        path[1] = _tokenOut;
      } else {
    ...
    function getAmountOutMin(address _tokenIn, address _tokenOut, uint _amountIn) public view returns (uint) {
      address[] memory path;
      if (_tokenIn == MELACOIN || _tokenOut == MELACOIN) {
          path = new address[](2);
          path[0] = _tokenIn;
