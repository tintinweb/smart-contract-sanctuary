...
contract SQUEEZYSHIBA is Context, IERC20, IERC20Extented, Ownable {
    ...
    string private constant _name = "SQUEEZY SHIBA";
    string private constant _symbol = "SQZ";
    ...
    uint256 public _botBuyLiquidityFee = 40;
    ...
    address payable constant private _projectMaintainence = payable(0x1CED5b40481E2124646198e7079a127De9083277); //devpercent
    ...
    uint256 private _maxTxAmount = 150000000 * 10**9; //150 000 000
