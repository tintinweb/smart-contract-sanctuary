...
Telegram: https://t.me/nfinitywealth
Website: http://infinitywealth.io/
...
Max Transaciton 0.2% (2000000000 Tokens)
Max Wallet 1.5% (15000000000 Tokens)
...
contract InfinityWealth is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x06376fF13409A4c99c8d94A1302096CB4dC7c07e); 
    address payable public Wallet_BuyBack = payable(0x981Ab956D6575b40F49AcBb769342BE91db95828); 
    address payable public Wallet_Dev = payable(0x2240a100BCb9b846C0F2e0cb1A1E4bf38a3cc46C);
    ...
    string private _name = "Infinity Wealth"; 
    ...
    uint256 public maxPossibleFee = 16; 
    ...
    Max Holding 1.5% of supply
    Max Transaction 0.2% of supply
    ...
    */
    ...
    // Max wallet holding (1.5% at launch)
