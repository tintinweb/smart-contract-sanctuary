...
library SafeMath {
    ...
    /** 
     * Returns the subtraction of two unsigned integers, reverting with
    ...
    /** 
     * Returns the integer division of two unsigned integers. Reverts with
    ...
    /** 
     * Returns the remainder of dividing two unsigned integers.
     * (unsigned integer modulo), Reverts with custom message when dividing by zero.
     * Counterpart to Solidity's `%` operator. This function uses a 'revert' opcode
     * (which leaves remaining gas untouched) while Solidity uses an invalid opcode
...
contract TokenT50 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TokenT50";
    string constant _symbol = "TokenT50";
    ...
    constructor () Auth(msg.sender) {
        address _WBNBinput = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
        WBNB = _WBNBinput;
        ///Not Sure Here for wbnb input address
