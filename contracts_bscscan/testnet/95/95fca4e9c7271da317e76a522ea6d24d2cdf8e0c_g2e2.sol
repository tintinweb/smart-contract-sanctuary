...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2240a100BCb9b846C0F2e0cb1A1E4bf38a3cc46C;
...
contract g2e2 is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x6380AD4BdEc5B2c562Cd55dddD650E1d5a7c1eCf);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "g2e2";
    string private _symbol = "g2e2";
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x54338DF60770184219ac146f66C29B1dCBEEFB86)] = true; //dev 
        ...
        _isCommunity[address(0x54338DF60770184219ac146f66C29B1dCBEEFB86)] = true; //dev 
        ...
        putYourGenAway[address(0x54338DF60770184219ac146f66C29B1dCBEEFB86)] = true; //dev 
