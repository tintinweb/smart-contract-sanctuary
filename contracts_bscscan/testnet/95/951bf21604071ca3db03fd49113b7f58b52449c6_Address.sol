...
contract tttest4 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2aBC9805f77837a3d2155B8bbfb2B7c29bcC2D35); // Marketing Address
    ...
    string private _name = "tttest4";
    string private _symbol = "tttest4";
