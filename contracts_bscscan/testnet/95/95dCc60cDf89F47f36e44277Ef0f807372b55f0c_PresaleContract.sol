...
contract PresaleContract is Ownable {
    ...
    uint256 private _minPrice = 10000000;
    uint256 private _maxPrice = 500000000;
    ...
    function preSale( uint256 tokenCount) external payable duringPreSale {
        uint256 realTokenCount = msg.value * 15000 / 10**18;
     ...
     */
     function getCurrentBNBAmount() external view onlyOwner returns(uint256){
