...
Every transaction consumes your $GME:

  2% auto distributed back to $GME holders
...
contract GME is Context, IERC20, Ownable {
    ...
    string private _name = "Game Coin";
    string private _symbol = "GME";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendBNBToCharity(portionForFees.div(3).mul(5).div(2));
