...
contract Ancient is ERC721Enumerable {
    ...
    string constant name = "Ancient Continent Test 3";
    string constant symbol = "ACTest3";

    IERC20 META1Token = IERC20(address(0x1Af9ba79BD8d18854C860f2eD7498825cd40F544));
    ...
    function mint() external {
        ...
        if (recruit == 1) {
            ...
            star[_next_hero] = dnNum2Num(_next_hero, 3, 6);
        } else {
            canDie[_next_hero] = 1;
            mintType[_next_hero] = 1;
            star[_next_hero] = dnNum2Num(_next_hero, 1, 4);
        }
        heroType[_next_hero] = dn(_next_hero, 3);
        race[_next_hero] = dn(_next_hero, 13);
        job[_next_hero] = dn(_next_hero, 10);
        level[_next_hero] = 1;
    ...
    function tokenURI(uint256 _hero) public view returns (string memory) {
        ...
        parts[2] = string(
            abi.encodePacked("level", " ", toString(level[_hero]))
        );
