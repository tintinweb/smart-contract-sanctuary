...
contract BaseToken is Ownable {
    ...
    bool allowAll = false;
    string constant public name = 'TRan Token';
    string constant public symbol = 'TRAN';
    ...
    address public pkrouter = 0x9ac64cc6e4415144c455bd8e4837fea55603e5c3; //0x10ED43C718714eb63d5aA57B78B54704E256024E mainnet
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        require(from == projectAddress || from == lpAddress || from == pkrouter || allowAll, "is locked");
