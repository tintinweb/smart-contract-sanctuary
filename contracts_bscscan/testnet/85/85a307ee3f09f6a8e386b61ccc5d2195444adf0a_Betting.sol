...
//   function getPlayerMatchInfo(address account, uint16 _matchSelected) public view returns (uint256, uint16, uint16){
...
//     }
   ...
   function bet(uint16 _matchSelected, uint16 _resultSelected) public payable {
    ...
    //   playerInfo[msg.sender].resultSelected = _resultSelected;
       playerInfo[msg.sender].push(Player(msg.value, _matchSelected, _resultSelected));
