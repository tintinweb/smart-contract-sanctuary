   ...
   */
    ...
    function setWinner(string memory _gameId, address addr) public isOwner {
        ...
        if (games[_gameId].betAmount > 0) {
            uint betX = games[_gameId].betAmount * 1000000000;
    ...
    function bet(string memory _gameId, uint _level) public {
        int _fees = validatedFees(_level);
        uint fees = 0;
        require(_fees >= 0, "fees not good"); 
        address from = msg.sender;
        if (_fees > 0) {
            fees = uint256(_fees);
            _token.transferFrom(from, address(this), fees);
        }
        if (games[_gameId].level > 0) {
            games[_gameId].player2 = from;
            games[_gameId].betAmount = games[_gameId].betAmount + fees;
        }else {
            games[_gameId] = Game(fees, _level, from, 0x0000000000000000000000000000000000000000, 0x0000000000000000000000000000000000000000);
    ...
    function validatedFees(uint level) private pure returns (int) {
        ...
        if (level == 7) {
            return 64000000000000000;
        }
        if (level == 8) {
            return 128000000000000000;
        }
        if (level == 9) {
            return 256000000000000000;
        }
