...
Introducing the 'Shiba On Doge'! The  token with a built-in referral system, and a passive earn-any-token reward system!

- Visit http://shibaondoge.com/ and use our innovative dashboard to get your referral link & set your reward token!
...
USEFUL LINKS:
➥ TG DISCUSSION: t.me/@ShibaOnDoge
➥ TG NEWS: t.me/@ShibaOnDogeNews
➥ WEBSITE: shibaondoge.com
➥ TWITTER: twitter.com/ShibaOnDoge
...
contract SOD is ERC20, Ownable {
    ...
    SODDividendTracker public dividendTracker;

    address public liquidityWallet;

    address payable public marketingAddress = payable(0xDbAec89D07D618141678a2fCB4E49c84b9292a35);
    ...
    uint256 public BNBRewardsSellFee = 10;
    uint256 public BNBRewardsSellFeeReferred = 10;
    ...
    constructor() ERC20("Shiba On Doge", "SOD") {
        dividendTracker = new SODDividendTracker(payable(this));
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        SODDividendTracker newDividendTracker = SODDividendTracker(
            payable(newAddress)
        );
...
contract SODDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(address payable mainContract)
        DividendPayingToken(
            "SOD_Dividend_Tracker",
            "SOD_Dividend_Tracker"
        )
    {
        sod = SOD(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SOD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SOD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SOD contract."
        );
    }
