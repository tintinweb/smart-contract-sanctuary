 ...
 *      the locking and unlocking of BNB/BEP20/BEP721 token assets
 *      based on Bsc.
 **/

contract BridgeBank is Initializable, BscBank, BridgeBankPausable {
    ...
    function emergencyWithdraw(
        ...
        if (tokenAddress == address(0)) {
            ...
            require(
                BridgeToken(tokenAddress).transfer(operator, _amount),
    ...
    /*
     * @dev: Locks received BEP721 funds.
     *
     * @param _recipient: representation of destination address.
     * @param _token: token address in origin chain
     * @param _tokenId: Token ID of BEP721.
     */
    function lock721(
        address _recipient,
        address _token,
        ...
        // Set symbol to the BEP721 token's symbol
    ...
    /*
     * @dev: Unlocks BEP721 tokens held on the contract.
     *
     * @param _recipient: recipient's Bsc address
     * @param _token: token contract address
     * @param _symbol: token symbol
     * @param _tokenId: Token ID of BEP721.
     */
...
contract BscBank {
    ...
    /*
     * @dev: Creates a new Bsc deposit with a unique id.
     *
     * @param _sender: The sender's bsc address.
     * @param _recipient: The intended recipient's evrnet address.
     * @param _token: The currency type, either erc20 or bsc.
     * @param _tokenId: Token ID of BEP721.
     */
