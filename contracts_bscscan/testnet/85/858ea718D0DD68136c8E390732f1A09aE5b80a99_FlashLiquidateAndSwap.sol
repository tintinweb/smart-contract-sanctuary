...
contract FlashLiquidateAndSwap is Exponential,FlashLiquidateInterface,Ownable {
    ...
    function _swap() public onlyOwner {
    ...
    function _tradeOnPancake(uint256 amountIn, uint256 amountOutMin, uint256 deadline) private onlyOwner {
    ...
    external
    {
        ...
        address payable base = msg.sender;

        base.transfer(address(this).balance);
