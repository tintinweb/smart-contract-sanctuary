...
contract Vault is ERC20 {
    ...
    // address public constant pancakeRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // testnet

    // address public constant wbnb = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // mainnet
    address public constant wbnb = 0x20a9d8C51C21808f0C6365629104c10Db87eA788; // testnet
    
    uint256 public constant percentUpbotsFee = 10;
    uint256 public constant percentBurn = 300;
    uint256 public constant percentStakers = 300;
    uint256 public constant percentAlgo = 400;
    ...
    constructor(address _tokenA, address _tokenB, address _strategist)
        public
        ERC20("xUBXT", "xUBXT")
    {
    ...
    function sell() public {
        ...
        require(position == 1, "The vault is already in open position");
    ...
    function takeUpbotsFees(address token, uint256 amount) private returns(uint256) {
        ...
        IERC20(token).safeTransfer(company, fee);
    ...
    function takePerformanceFees(uint256 amount) private {
        ...
        uint256 devAmount = amount.mul(percentAlgo).div(percentMax);
