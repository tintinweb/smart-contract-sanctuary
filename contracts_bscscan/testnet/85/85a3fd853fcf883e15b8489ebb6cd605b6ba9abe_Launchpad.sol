        ...
        for(uint a = 0; a < buyer[msg.sender].buyPrice.length; a++){
            ...
            if(buyer[msg.sender].buyPrice[a] == 11){
                ...
                for(uint i = 0; i < buyer[msg.sender].bought.length; i++){
                    ...
                    require(timediff >= 3 minutes, "Claim time not reached");
        ...
        for(uint a = 0; a < buyer[msg.sender].buyPrice.length; a++){
            ...
            if(buyer[msg.sender].buyPrice[a] == 11){
                ...
                for(uint i = 0; i < buyer[msg.sender].bought.length; i++){
                    ...
                    require(timediff >= 6 minutes, "Claim time not reached");
        ...
        for(uint a = 0; a < buyer[msg.sender].buyPrice.length; a++){
            ...
            if(buyer[msg.sender].buyPrice[a] == 11){
                ...
                for(uint i = 0; i < buyer[msg.sender].bought.length; i++){
                    ...
                    require(timediff >= 9 minutes, "Claim time not reached");
        ...
        for(uint a = 0; a < buyer[msg.sender].buyPrice.length; a++){
            ...
            if(buyer[msg.sender].buyPrice[a] == 11){
                ...
                for(uint i = 0; i < buyer[msg.sender].bought.length; i++){
                    ...
                    require(timediff >= 12 minutes, "Claim time not reached");
