 ...
 */
interface I_Windmill_Fund is I_Math, I_Payable, IAccessControlEnumerable, I_With_DAORole, I_With_PWRToken,
                             I_With_BUSDToken, I_With_WBNBToken, I_With_PancakeRouter{

    function setDAOAddr(address payable addr) external;
 ...
 */
interface I_Windmill_DAO is I_Payable, I_Gas_Refundable, IAccessControlEnumerable, I_With_DAORole,
     ...
     */
    function setFundAddress(I_Windmill_Fund _fund) external;
...
contract Windmill_DAO is Math, Adressable, Payable, Gas_Refundable, AccessControlEnumerable, With_DAORole,
                         With_PWRToken, With_BUSDToken, With_WBNBToken, With_PancakeRouter, I_Windmill_DAO{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    function setFundAddress(I_Windmill_Fund _fund) external onlyRole(DAO_ROLE){
        fund = _fund;
    }
