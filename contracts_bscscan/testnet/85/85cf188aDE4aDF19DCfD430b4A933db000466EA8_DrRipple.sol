...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47); //the reward token you want distributed 
...
contract DrRipple is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DrRipple";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "DRIP";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xE40e0f679355Ec1B858921800FE60393Ce20fb24;
