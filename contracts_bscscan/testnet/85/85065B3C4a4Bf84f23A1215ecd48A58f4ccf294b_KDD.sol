...
contract KDD is Context, IERC20, Ownable {
    ...
    event Transfer1(uint256 contractTokenBalance,uint256 initialBalance,uint256 transferredBalance,uint256 transferredrBalance);
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        emit Transfer1(contractTokenBalance,initialBalance,transferredBalance,transferredBalance.div(_liquidityFee).mul(marketingDivisor));
    }
