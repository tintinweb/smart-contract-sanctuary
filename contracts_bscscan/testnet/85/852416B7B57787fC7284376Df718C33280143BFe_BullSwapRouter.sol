...
interface IBullSwapRouter is IBullSwapRouter01 {
...
contract BullSwapRouter is IBullSwapRouter {
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        require(
            ...
            'BullSwapRouter: INSUFFICIENT_OUTPUT_AMOUNT'
        );
    }
    function swapExactETHForTokensSupportingFeeOnTransferTokens(
        uint amountOutMin,
        ...
        ensure(deadline)
    {
        ...
        require(amountOut >= amountOutMin, 'BullSwapRouter: INSUFFICIENT_OUTPUT_AMOUNT');
...
library BullSwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'c77c879e1b82e0c305aea04633a968a80c88f71ce0d58e8480b9dbc722c4470e' // init code hash
            ))));
    }
