...
contract CaritaCoinLight is IBEP20, ContextSlave {
    ...
    constructor () {
        ...
        _allowances[preSalesAddress][charityVaultAddress] = type(uint128).max;
    ...
    function manualSwapBack() public swapping {
...
contract PreSale is ContextSlave {
    ...
    function triggerLiquidityBuy() public {
    ...
    function CharityBuyForLiquidityv2() public payable {
