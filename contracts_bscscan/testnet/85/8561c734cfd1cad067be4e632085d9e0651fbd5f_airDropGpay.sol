...
contract airDropGpay is ReentrancyGuard{
    ...
    constructor(address payable _owner, IBEP20 _token) public{
        owner = _owner;
        token = _token;
        claimAmount = 2000;
        referalAmount = 5000;
    ...
    function claimAirDrop(address _referrer) public payable isHuman nonReentrant {
        ...
        require(token.balanceOf(_referrer) > 0,"referrer is not Gpay holder");
    ...
    function setAirDrop(uint256 _startTime, uint256 _endTime) external onlyOwner{
