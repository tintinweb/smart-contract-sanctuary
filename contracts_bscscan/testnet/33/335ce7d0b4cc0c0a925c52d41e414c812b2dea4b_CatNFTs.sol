...
// File: contracts/v1-mining/implement/CatNft.sol
...
contract CatNFTs is ERC721Upgradeable,AccessControlUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable,PausableUpgradeable {
    using SafeMathUpgradeable for uint256;
