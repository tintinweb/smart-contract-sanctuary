...
contract DogeBack is ERC20, Ownable {
    ...
    constructor() ERC20("Caroline_Test", "CLT") {
    ...
    function setBuyBackWhiteList(address account, bool excluded) public onlyOwner {
    ...
    function _transfer(
        ...
        bool takeFee = (!whiteList[from] || !whiteList[to]) && !swapping;
