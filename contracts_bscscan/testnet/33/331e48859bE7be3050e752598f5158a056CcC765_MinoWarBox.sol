...
contract MinoWarBox is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        saleBoxs[0] = SaleBox(0, 40000 * 10 ** 18, 1629813629, 1661349629, 5, 25);
        saleBoxs[1] = SaleBox(1, 30000 * 10 ** 18, 1629813629, 1661349629, 2, 20);
        saleBoxs[2] = SaleBox(2, 20000 * 10 ** 18, 1629813629, 1661349629, 1, 15);
    }
    ...
    function _randBlindbox(uint256 _typeBox, uint256 _amount) internal {
        ...
        if (starRand == 1) {
            starBox = 3;
            characterRand = 13;
        } else if (starRand == 2 || starRand == 3) {
            starBox = 2;
            characterRand = 10;
        } else {
            starBox = 1;
            randManager.randModEight(_msgSender());
            uint256 characterRand8 = randManager.currentRandMod();
            if (characterRand8 == 1) {
                characterRand = 0;
