...
contract CNYFloki is IBEP20, MBCAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "CNYFloki";
    string constant _symbol = "CNYFloki";
    uint8 constant _decimals = 18;

    uint256 _totalSupply =1000000000000000000000000000000; //1 trillion
    uint256 public _maxTxAmount = _totalSupply / 1000; // 1%

    // @dev  added max hold so that no single wallet can hold more than 1%.
    uint256 public _maxHold = _totalSupply / 100; // 10 %
    ...
    address public marketingFeeReceiver =0xE93d01B3fbFf6E682b12D03c4C16052cB87d944C ;
    address public buybackFeeReceiver =0xd93096Fd348753F742E700B4bcA27BBD843b4823 ;
