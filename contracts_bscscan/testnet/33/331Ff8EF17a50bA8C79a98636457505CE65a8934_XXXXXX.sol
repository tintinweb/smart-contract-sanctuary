...
contract XXXXXX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8Ea7dC8d7852BE772CbAf036Ba14b22f17f93E65;
        ...
        marketingFeeReceiver = 0x8Ea7dC8d7852BE772CbAf036Ba14b22f17f93E65;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                1.05 * 10**6 * (10 ** _decimals),
                0.105 * 10**6 * (10 ** _decimals),
