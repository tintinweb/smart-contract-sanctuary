...
contract velocity is Context, IERC20, Ownable{
    ...
    uint256 public _taxFee = 8; //Holders distribution  fee
  ...
  function setALLFeePercent(uint256 team,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
        teamDivisor = team;
           _sellLiquidityFee = sellLiquidityFee;
             _sellTaxFee = sellTaxFee;
              _buyLiquidityFee = buyLiquidityFee;
