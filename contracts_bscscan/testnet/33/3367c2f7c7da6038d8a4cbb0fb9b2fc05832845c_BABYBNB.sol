...
//     The BABYBNB contract is designed to reward hodlers of BABYBNB with dividends paid in WBNB
//     The auto claim feature allows to automatically receive WBNB for hodling BABYBNB in your wallet
//     The tokenomics provide an effective anti-whale and anti-automation system 
//     Effective prevention of HFTA (high frequency trading activity == bot selling)
...
contract BABYBNB is IBEP20, Ownable
{
    ...
    address public constant marketingWallet=0xC6552CD727AE52e292a9a9C8bf314133A490dFEa; 
    ...
    constructor () {
       ...
       //Sets sellLockTime to be max by default
        ...
        //be converted to LP and Marketing
        _liquidityTax=10; // Liquidity
        _stakingTax=3; // Staking
