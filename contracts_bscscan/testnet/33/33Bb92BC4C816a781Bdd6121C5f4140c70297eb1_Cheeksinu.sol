...
contract Cheeksinu is Context, IERC20, Ownable {
    ...
    function seDevWallet(address newWallet) external onlyOwner {
    ...
    function whiteListPresale(address _presale) external onlyOwner {
        _isAuthorized[_presale] = true;
        _isExcludedFromFee[_presale] = true;
        _isExcludedFromAutoLiquidity[_presale] = true;
        _isExcluded[_presale] = true;
        _excluded.push(_presale);
    }
