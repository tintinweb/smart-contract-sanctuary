...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // Testnet BUSD
...
contract babyChristmasElf is IBEP20, Auth {
    ...
    address REWARDS = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // Testnet
    address routerv2 = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // Testnet
    ...
    address _marketingAdr = 0x19429cab1d00140902Ede2E261B0c10E45079E4D;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee) external authorized {
        // feeDenominator is hardcoded, totalFee must be lower than 25% (2500)
        require(totalFee < feeDenominator/4, "Fee is too high!");
