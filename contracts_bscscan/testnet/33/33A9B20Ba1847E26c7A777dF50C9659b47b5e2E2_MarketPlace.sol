...
contract MarketPlace is MarketAuth, PausableUpgradeable {
  ...
  function listHeroes(
    ...
    for(uint i = 0; i < _quantity; i++) {
      ...
      marketMakeOrder(_type, OrderKind.hero, _nftId, _price, _price, 365 days);
    }
  }
  ...
  function listItems(
    ...
    for(uint i = 0; i < _quantity; i++) {
      ...
      marketMakeOrder(_type, OrderKind.item, _nftId, _price, _price, 365 days);
    }
  }

  function marketMakeOrder(
    OrderType _type,
    OrderKind _kind,
    uint _nftId,
    uint _startPrice,
