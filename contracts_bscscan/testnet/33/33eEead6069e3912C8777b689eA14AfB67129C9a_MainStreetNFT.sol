...
contract MainStreetNFT is ERC721, Ownable {
//    using SafeMath for uint256;
    using Strings for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 public constant nftPrice = 400000000000000000; //0.4 BNB
    ...
    */
    ...
    function mintNFT() public payable {
        ...
        stakingContract.transfer(msg.value); // transferring all fees to stakingContract
        _tokenIds.increment();
