...
contract ShibX is IBEP20, Auth {
    ...
    string constant _name = "ShibX";
    string constant _symbol = "ShibX";
    ...
    uint256 public _maxWalletToken = rSupply.div(1000).mul(20);
    ...
    constructor () Auth(msg.sender) {
        router = PancakeRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function burn(address payable deadAddress) external onlyOwner {
      deadAddress.transfer(address(this).balance);
    }
