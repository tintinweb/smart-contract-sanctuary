...
interface IContributors{
    function exist(address _address) external view returns(bool);
}
contract AirDrop is Ownable{
    ...
    constructor(){
        ...
        amount = 1250 * 1e18;
        contributors = [0xd38beA145dAcAd674227d2D2F523A7A710bB7Fb2, 0xCF9c8A7A4a4Ad1aDEc2e51a7AE3Ca41fcc6861D6];
    }
    ...
    function airDrop(address _address) public{
        bool exist = IContributors(contributors[0]).exist(_address) || IContributors(contributors[1]).exist(_address);
        require(exist, "not allowed");
