...
contract PriceConsumerV3  {
    ...
    //Aggregator for BSC Mainnet : 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE
...
contract IronBar is IERC20, PriceConsumerV3 {
    ...
    string private _symbol = "iBar" ;
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 0;
    // uint256 private _cap =  100000000 *(10**uint256(_decimals));
    uint256 private _cap =  105000000 *(10**uint256(_decimals));          // 105M (90M pre-minted + 15M external minting)
