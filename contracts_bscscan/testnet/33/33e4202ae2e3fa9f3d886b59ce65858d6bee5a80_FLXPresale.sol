...
contract FLXPresale is ReentrancyGuard, Context, Ownable {
    using SafeMath for uint256;
    
    mapping (address => uint256) public _contributions;
	mapping (address => bool) public _whitelisted;
    mapping (address => bool) public _hasReceived;
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount,uint256 tokens) internal view {
        ...
        require(availableTokensICO.sub(tokens) >= 0, 'Insufficient amount of tokens');
