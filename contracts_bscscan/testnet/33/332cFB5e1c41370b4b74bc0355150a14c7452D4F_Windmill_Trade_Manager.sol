...
abstract contract With_DAOAddress is Base, AccessControlEnumerable, With_DAORole, I_With_DAOAddress{
...
contract Windmill_Trade_Manager is Base, Math, Adressable, AccessControlEnumerable, With_DAORole, With_UpdaterContract, With_CompetitionContract,
    ...
    constructor(){
        ...
        baseEnergyBonusRatio.numerator = 10;
        baseEnergyBonusRatio.denominator = 100;
    }
    ...
    function endTrade(uint256 tradeId) external{
        ...
        require(data.owner == msg.sender || msg.sender == address(updater), "Windmill_Trade_Manager: Only the owner or updater can end the trade.");
