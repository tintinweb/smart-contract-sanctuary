...
contract ASK_RC12 is Context, IBEP20, Ownable {
   ...
   //end skizzo
    ...
    string private _name = "AleSkizz_RC12";
    string private _symbol = "AKR12";
	...
	uint256 private _feeDurationHalf =  (360-180);//1800; seconds
	uint256 private _feeDurationMax =  360;//3 * 24 * 3600; seconds
	...
	address payable public fundraisingAddress = payable(0x37bb2Eac7f2fBdD815511f7040f19286795F459B);
