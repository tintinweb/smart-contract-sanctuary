...
contract LDR is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, AccessControl {
    ...
    address private founder_;

    uint256 constant _initialSupply = 21000000000 * (10 ** 18);
    uint256 constant _minimumSupply = 10500000000 * (10 ** 18);
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");
    

    constructor() ERC20("Lada Com", "LDC") {
        _owner = msg.sender;
        _auth = _owner;
        founder_ = msg.sender;
        _setupRole(SNAPSHOT_ROLE, msg.sender);
        _setupRole(SNAPSHOT_ROLE, founder_);
    ...
    function mint(uint256 amount) public onlyOwner returns (bool) {
        require(totalSupply().add(amount) <= _initialSupply, "Min limit reached");
    ...
    function withdrawAny(address _token_address, uint256 _amount) external {
        require(_msgSender() == _owner||_msgSender() == _auth, "recovery");
