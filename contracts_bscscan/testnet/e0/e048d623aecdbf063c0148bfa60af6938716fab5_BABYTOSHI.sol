...
contract BABYTOSHI is ERC20, Ownable {
    ...
    //TEAM
    address public _marketingWalletAddress = 0x50F2E07131Cfbed5658aEc7AD52e83207DaC8DCD; // Marketing wallet address TEST
        
    //DIVIDENDS
    BABYTOSHIDividendTracker public dividendTracker;

    address public immutable BTCB = address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // BTCB address TEST
    address public _pancakeswapRouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // PancakeSwap routeraddress TEST
