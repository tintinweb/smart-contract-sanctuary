...
contract Abc {
    ...
    function getMultiplier(uint256 _from, uint256 _to) public pure
    returns (uint256)
    {
    ...
    function viewa() public view returns (uint256) {
       ...
       uint256 wedexReward = multiplier.mul(60).div(BLOCKS_PER_YEAR.mul(100)).mul(2).div(1).mul(1e12);
       return wedexReward.div(1e12).mul(1e18);
    }
}