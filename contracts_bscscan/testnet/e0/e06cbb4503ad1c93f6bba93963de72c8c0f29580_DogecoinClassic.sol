...
/*
   Dogecoin Classic
   3% fee that auto adds to the liquidity pool/burned
   2% fee that auto adds to the charity/marketing wallet
   4% fee that auto distribute to all holders
*/
...
contract DogecoinClassic is Context, IERC20, Ownable {
  ...
  string private _name = "Dogecoin Classic";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> POOSH swap when swap+liquify is triggered
