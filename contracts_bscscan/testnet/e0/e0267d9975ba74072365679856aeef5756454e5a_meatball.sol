...
contract meatball is Context, IERC20, Ownable {
    ...
    string private _name = "meatball";
    string private _symbol = "meats";
    ...
    uint256 public maxWalletToken = 270000000 * 10**18;
