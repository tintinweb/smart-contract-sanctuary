...
contract Rezerve is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFeeOnSale = 5;
    ...
    uint8 public lpPullPercentage;
    
    
    uint256 public theReserveClock;
    uint256 public reserveReset = 5 minutes;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 21000  * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 2100  * 10**9;
    ...
    constructor ()  {
        _rOwned[_msgSender()] = _rTotal;
         DAI = 0x7964Ce9BC81482d01df56D7259d81873E0fdf19B;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
         // Create a uniswap pair for this new token
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), DAI );
        theReserveClock = block.timestamp;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        IERC20 _dai = IERC20 ( DAI );
        _dai.transfer( reserveVault, _dai.balanceOf(address(this)));
    ...
    function removeLP () public onlyOwner  { 
        IERC20 _uniswapV2Pair = IERC20 ( uniswapV2Pair );
         uint256 _lpbalance = _uniswapV2Pair.balanceOf(address(this));
         uint256 _perc = (_lpbalance.mul(lpPullPercentage)).div(10);
        ...
        sendToExchange( _reserve  );
    }
    
    function sendToExchange( uint256 _reserve ) internal  {
