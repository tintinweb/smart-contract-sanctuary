...
contract IDO is Ownable {
    ...
    function getSwapBasic() public view returns (uint256 DayTime,ERC20 UsdtTokenContract,ERC20 DtuTokenContract,address OfficialAddress,bool OneSwapSwitchState,bool TwoSwapSwitchState,bool ThreeSwapSwitchState,
    ...
    {
        return (dayTime,usdtTokenContract,dtuTokenContract,officialAddress,oneSwapSwitchState,twoSwapSwitchState,threeSwapSwitchState,releaseSwitchState,
