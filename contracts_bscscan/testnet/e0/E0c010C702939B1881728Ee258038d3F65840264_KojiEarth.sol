...
contract KojiEarth is IBEP20, Auth {
    ...
    string constant _symbol = "KOJI Beta v1.08";
    ...
    function swapBack() internal swapping {
        ...
        (bool successTeam2, /* bytes memory data */) = payable(nftRewardWallet).call{value: amountBNBnft, gas: 30000}("");
    ...
    function reinvest(uint256 _percent, uint256 _amountOut) external {
        distributor.reinvestDividend(msg.sender, _percent, _amountOut);
    }
