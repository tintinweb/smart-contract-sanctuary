...
//
// Copyright of The $MVU Team  
// 
// $MVU has 7% tax split across 5 protocols
// 
// African Elephant     1.5%: Conservation
// Black Rhino          1.5%: Development and Marketing
// Cheetah              1.5%: Sustainable Liquidity
// Mountain Gorilla     1.5%: Reflection
// Pangolin             1%: Burn
...
/**
 * @dev The official MVulaToken smart contract
 */
contract MvulaToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "MvulaToken";
    string private _symbol   = "MVU";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for MVU/WBNB
    ...
    // Addresses
    address payable public _development_marketingAddress = payable(0xc00f35215Bc5590C2E7D3ec0A13F1A1Af78A92D8); // Development and Marketing address used to pay for development and marketing
    ...
    uint256 public  _sellTaxFee       = 15; // 15% tax 
    uint256 public  _whaleSellTaxFee  = 25; // 25% tax 
    ...
    constructor () {
        ...
        IUniswapV2Router02 pancakeswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //change this to the MainNet PancakeSwap V2 Router Address
    ...
    /**
     * @notice Withdraws non-MVU tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function setDevelopmentMarketingAddress(address developmentMarketingAddress) external onlyOwner() {
        _development_marketingAddress = payable(developmentMarketingAddress);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts MVU balance for development and marketing, concervation and liquidity
    ...
    /**
     * @notice Burns MVU tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of MVU tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from MVU)
        // We want to send 4/7ths to the marketing wallet and keep 2/7ths within the contract for buyback
        uint256 development_marketingBNB = receivedBNB.div(7).mul(4);
        
        // Send the remaining BNB to the marketing wallet
        transferBNBToAddress(_development_marketingAddress, development_marketingBNB);
