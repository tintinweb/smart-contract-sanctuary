...
contract EtokenburnPlus is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 5000000000000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'E-Token Plus';
    string private _symbol = 'ETOKEN+';
