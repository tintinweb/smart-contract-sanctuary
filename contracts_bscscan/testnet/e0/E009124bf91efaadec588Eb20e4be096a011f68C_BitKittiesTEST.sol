...
/**
    ...
    \___  _   \|__|/  |_| |/ /|__|/  |_/  |_|__| ___    ______   ______    ________    
      |  |_|  /| \_  __/ | /  | \_  __/   __/ |/ __ \ /  ___/    \___  \   \   __  \  
     |  |_|  \| | | | | |\ \ | | | |  | |  | || ___/ \___ \       / ___/ ___\  \_\  \ ___ 
    |_______/|_| |_| |_|  \_\_| |_|  |_|  |_| \___/______/        \_____\\__\\_______\\__\                     
...
contract BitKittiesTEST is IBEP20, Auth {
    ...
    function shouldSwapBack() internal view returns (bool) {
        ...
        && !inSwap
        && swapEnabled
        && _balances[address(this)] >= _totalSupply.div(swapThresholdDen);
    }

    function swapBack() internal swapping {
        uint256 dynamicLiquidityFee = isOverLiquified(targetLiquidity, targetLiquidityDenominator) ? 0 : liquidityFee;
        uint256 amountToLiquify = _totalSupply.div(swapThresholdDen).mul(dynamicLiquidityFee).div(totalFee).div(2);
        uint256 amountToSwap = _totalSupply.div(swapThresholdDen).sub(amountToLiquify);
