...
contract NehruJi {
    ...
    = CONFIGURABLES =
    =====================================*/
    string public name = "Nehruji";
    string public symbol = "JNP";
   ...
   /*================================
    ...
    mapping(address => uint256) internal reward_update;
    ...
    uint256 public current_time = block.timestamp*1000;
    ...
    */
    function NehruJi(address _customerAddress, address _adminFee)
        public
    {
...
//      */
        ...
        public
    {
        ...
        _dividends += referralBalance_[_customerAddress];
        referralBalance_[_customerAddress] = 0;
        _dividends += reward_update[_customerAddress];
        reward_update[_customerAddress] =0;
        // delivery service
        ...
        public
    {
        ...
        // // update holding reward
        // holding_Reward_amount += (holding_reward * magnitude / (tokenSupply_));
        // int256 reward_update = (int256) (holding_Reward_amount * _tokens + (_taxedEthereum * magnitude));
        // reward_update[_customerAddress] += reward_update;
    ...
    function claim() onlyhodler() public returns(bool)
    {
        address _customerAddress = msg.sender;

        require(block.timestamp*1000 >= start_time[_customerAddress]);
        require(tokenSupply_ >0);
        uint256 reward = SafeMath.div(tokenBalanceLedger_[_customerAddress] ,tokenSupply_);
        uint256 _updatedPayouts = (uint256) ( holding_Reward_amount * reward );
        reward_update[_customerAddress] += _updatedPayouts;
        // payoutsTo_[_customerAddress] += _updatedPayouts;
        start_time[_customerAddress] = (block.timestamp*1000) ;
        return true;
    }
...
function setAdministrator(address _identifier, bool _status)
        ...
        returns(uint256)
    {
        ...
        start_time[_customerAddress] = (block.timestamp + (30 * 1 days)) *1000;
        
        int256 _updatedPayouts = (int256) ((profitPerShare_ * _amountOfTokens) - _fee);
        payoutsTo_[_customerAddress] += _updatedPayouts;
        
        // int256 _updated = (int256) ((holding_Reward_amount * _amountOfTokens) - _fee);
        // reward_update[_customerAddress] += _updated;
