...
contract BM_B_B{
    ...
    function buyEggs(address ref, uint256 _amount) public payable{
        ...
        uint256 eggsBought=calculateEggBuy(_amount,SafeMath.sub(icApp.balanceOf(address(this)),_amount));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256){
        return calculateTrade(eggs,marketEggs,icApp.balanceOf(address(this)));
    }
    ...
    function calculateEggBuySimple(uint256 eth) public view returns(uint256){
        return calculateEggBuy(eth,icApp.balanceOf(address(this)));
    }
    ...
    function getBalance() public view returns(uint256){
        return icApp.balanceOf(address(this));
    }
