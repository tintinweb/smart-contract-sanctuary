...
contract Token is ERC20, Ownable, IToken {
    ...
    function addItem(string memory name, uint256 priceUsd, uint256 activeAfterDelay) public onlyOwner {
    ...
    function updatePrice(uint32 itemId, uint256 priceUsd) public onlyOwner {
