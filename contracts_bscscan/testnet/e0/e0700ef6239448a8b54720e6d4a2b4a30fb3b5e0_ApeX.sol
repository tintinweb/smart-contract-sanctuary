...
contract ApeX is IERC20, Ownable {
    ...
    string constant _name = "Ape-X Coin";
    string constant _symbol = "APEXCOIN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 1) / 2000000000000;
    uint256 _maxSellTxAmount = (_totalSupply * 1) / 2000000000000;
    uint256 _maxWalletSize = (_totalSupply * 2) / 100000000000000;
