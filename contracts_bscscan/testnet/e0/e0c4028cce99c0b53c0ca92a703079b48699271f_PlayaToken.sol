...
Marketing wallet
Conservation group wallet for Blackrock Desert   
10% selling tax, 
4% to marketing wallet, 
2% to burn wallet, 
2% to a conservation group wallet for Blackrock Desert, 
2% redistribution to holders
*/



contract PlayaToken is Context, IERC20, Ownable {
    ...
    string private _name = "Playa Token";
    string private _symbol = "PLAYA";
    ...
    address  public MarketingAddress = 0x85454C0503ff1dD83B33ef02ac21B20749B127D7; // Marketing 
    address  public ConservationGroupAddress = 0xD9a99C64f639bda8Ec5F2956BCfd1d242Dc353a3; // ConservationGroup 
 ...
 //   function withdrawLPToken(uint256 _sid, uint256 _rate, uint256 _desirePrice, uint256 _slippage) external  {
  ...
  //  }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn Marketing and ConservationGroup wallets
        ...
        _transferStandard(sender, ConservationGroupAddress, fundingPiece.mul(2));
...
*/    
    function setComunityWallet(address newWallet) external onlyOwner() {
        emit FeeEvent(newWallet); 
        ConservationGroupAddress = newWallet;
    }
