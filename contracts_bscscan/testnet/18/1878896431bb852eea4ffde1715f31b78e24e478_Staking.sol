...
contract Staking {
  ...
  constructor()  {
    ...
    function deposit(uint tokenAmount) public {
        ...
        require(tokenAmount > 10000000000000000000, "Deposit more than 10 tokens");
    ...
    function withdrawRoi() public {
        ...
        for(uint i = 0; i < len; i++) {
            ...
            for(timediff >= 3 minutes; timediff <= 21 minutes; timediff+3 minutes){
                ...
                totalWithdrawal += withdrawableAmt;
            }
            
            if(timediff < 3 minutes){
                revert("Withdraw time not reached");
            }
        }
        token.transfer(msg.sender, withdrawableAmt);
    }
