...
contract IDOv2 is Ownable, ReentrancyGuard {
    ...
    function getRoundTotalAllocation(uint256 currentRoundId) public view returns (uint256) {
        ...
        if (currentRoundId <= 4) {
            ...
            return (fundTarget * controller.getMultiplierAtTierId(5 - currentRoundId)) / multiplierSum;
        }
    ...
    function getFunderInfo(address funder) external view returns (User memory) {
        ...
        info.totalSaleToken =
            tierFunders[funder].totalSaleToken +
            whitelistFunders[funder].totalSaleToken +
            fcfsFunders[funder].totalSaleToken;
    ...
    function setVestingInfo(
        ...
        require(_cliffTime > claimTime, "CliffTime should be greater than claimTime");
