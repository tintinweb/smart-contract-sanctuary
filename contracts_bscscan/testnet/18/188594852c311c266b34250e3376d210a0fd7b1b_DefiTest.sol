...
string public constant symbol = "DFT9";
string public constant name = "DEFI9 TEST TOKEN";
...
function setAdmin(address user) public {
    ...
    function stake(uint256 _amount, uint16 _stakingDuration, uint8 _stakingPool) public {
        require(isStaking[msg.sender] == true, "You are already staked! Take a new address!");
