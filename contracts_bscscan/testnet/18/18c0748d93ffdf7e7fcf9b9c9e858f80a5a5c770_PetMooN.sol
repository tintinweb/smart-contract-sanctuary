...
/**
   ...
   #PetMOON features:
    ...
    5% fee is split 50/50 half of which is sold by the contract into BNB, 
while the other half the PETMOON tokens are paired automatically
with the previously mentioned BNB and added as a liquidity pair on Pancake Swap
...
contract PetMooN is Context, IBEP20, Ownable {
