...
contract FG3_TEST is Context, IERC20, Ownable { 
    ...
    */
    ...
    // Turn fess on/off for a wallet - Default is true
    event wallet_Pays_fee(address Wallet_Address, bool true_or_false);
    function wallet_Pays_Fees(address Wallet_Address, bool true_or_false) public onlyOwner {
        _isExcludedFromFee[Wallet_Address] = true_or_false;
        emit wallet_Pays_fee(Wallet_Address, true_or_false);
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 max_Transaction_Percent) external onlyOwner() {
        ...
        require(max_Transaction_Percent != 0, "Max transaction can not be zero!");
        _maxTxAmount = _tTotal*max_Transaction_Percent/100;
        emit set_Max_Trans_Percent(max_Transaction_Percent);
    }
    ...
    function set_Max_Wallet_Holding_Percent(uint256 max_Wallet_Holding_Percent) external onlyOwner() {
        ...
        require(max_Wallet_Holding_Percent != 0, "Max wallet holding can not be zero!");
        _maxWalletToken = _tTotal*max_Wallet_Holding_Percent/100;
        emit set_Max_Hold_Percent(max_Wallet_Holding_Percent);
    }
    ...
    function _transfer(
        ...
        PRE-LAUNCH ACCESS - Adding LP and Airdrop 
