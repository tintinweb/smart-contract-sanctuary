...
contract Mount is ERC721Enumerable, Ownable {
    ...
    uint public constant PRICE = 0.035 ether;
    uint public constant MAX_PER_MINT = 5;
    
    string public baseTokenURI;
    
    constructor(string memory baseURI) ERC721("Mount", "MNT") {
        setBaseURI(baseURI);
    }
