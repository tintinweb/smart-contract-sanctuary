...
contract Colonize is Context, IERC20, Ownable {
    ...
    string private _name = "Colonize";
    string private _symbol = "CNE";
    ...
    address public marketingWallet = 0x6A3d62D04C3B4eBa91a673F23173681a0796E83C;  
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if(marketingAmt>0) { _transferStandard(sender, marketingWallet, marketingAmt); }
    ...
    function getBalanceInBnb(address addr) public view returns(uint256)
    {
        return address(addr).balance;   
    }


    function  getTokenBalanceInContractAddress() public view returns(uint256)
    {
        return balanceOf(address(this));   
    }
    

    function getBnbBalanceInContractAddress() public view returns(uint256)
    {
        return address(this).balance;   
    }


    function doManualSwapAndLiquify(uint256 contractTokenBalance) public onlyOwner 
    {
        swapAndLiquify(contractTokenBalance);
    }   
