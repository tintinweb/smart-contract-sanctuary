...
contract TokenNew is Context, IERC20, Ownable {
    ...
    uint256 public BNB_Balance = 0; // variabile da eliminare
    uint256 public WETH_Balance = 0; // variabile da eliminare
    ...
    function get_GameDevAddress() external view returns (address) {
        return _gameDevAddress;
    }
...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _distributeInWETH(uint256 amount) private lockTheSwap {
        ...
        BNB_Balance = BNB.balanceOf(address(this));
