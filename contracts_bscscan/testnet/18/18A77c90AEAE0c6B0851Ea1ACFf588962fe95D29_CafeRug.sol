...
contract CafeRug is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Caferug";
    string private _symbol = "CAFERUG";
    ...
    uint256 public _maxWalletAmount = 10 * 10**9;
    ...
    constructor() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F));
