...
contract HumanityWorld is Context, Ownable, IERC20 {
    ...
    string private _name = "HumanityWorld";
    ...
    address payable public referralWallet = payable(0x33Be5a11a3eF9957F822797097a047998a321704);
    address payable public rewardWallet = payable(0xd86E0Daa2010949113e87A390469a41C289EBE01);
    address payable public liquidityWallet = payable(0x91ebf329E952419Db963062E02F03E2A70E2bb05);
    address payable public marketingWallet = payable(0x98C3bc8678E984DF06b01A34006EC99dF3A49b2A);
