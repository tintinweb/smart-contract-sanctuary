...
contract iBNB_Swap {
    ...
    function buyTokens(uint256 _iBNBAmount) public payable
    {
        ...
        iBNB.transfer(msg.sender, _iBNBAmount*1000000000);
     ...
     function SellTokens(uint256 _iBNBAmount) public payable
    {
        ...
        iBNB.transferFrom(msg.sender,address(this), _iBNBAmount*1000000000);
    ...
    function setRate(uint256 _Rate)public onlyOwner{
     ...
     function GetToken(uint256 _iBNBAmount)public onlyOwner{
         iBNB.transfer(msg.sender, _iBNBAmount*1000000000);
    }
}