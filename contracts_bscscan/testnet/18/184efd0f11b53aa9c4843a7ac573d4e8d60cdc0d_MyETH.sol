...
contract MyETH is IERC20, Ownable {
    ...
    string constant _name = "MyETH";
    string constant _symbol = "$MyETH";
    ...
    uint256 minBetweenTwoEntry = 60 seconds;
    uint256 minFirstTransaction = 60 seconds;
    ...
    address public marketingFeeReceiver = address(0xCDe950560e09Af953393e37d8c6e2009841cF37C);
