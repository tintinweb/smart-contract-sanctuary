...
contract MYTHO is ERC20Detailed, Ownable {
    ...
    address internal dev = address(0x5aB7beE5e79711bd249E74C28cb364E5e595808D);
    ...
    constructor()
        ERC20Detailed("LeGrosMytho", "MYTHO", uint8(DECIMALS))
        public
    {
