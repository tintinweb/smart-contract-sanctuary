...
contract TestToken is Context, IERC20, Ownable, LockToken 
{
    ...
    function setAllBuyFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() 
    {
        _taxFee = taxFee;
    ...
    function setAllSaleFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() 
    {
        _saleTaxFee = taxFee;
