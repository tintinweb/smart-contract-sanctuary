...
contract contractMytoken3 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x79906671157ADdeedeeE035ec5bdE5de4a4a8158); // Marketing Address
    ...
    string private _name = "nameMYtoken3";
    string private _symbol = "nmt3";
