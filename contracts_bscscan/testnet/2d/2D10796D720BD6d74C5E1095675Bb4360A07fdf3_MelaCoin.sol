...
contract MelaCoin is Context, IERC20, Ownable {
    ...
    function swap(address _tokenIn, address _tokenOut, uint _amountOut, uint _amountInMax, address _to) external {
      ...
      IERC20(_tokenIn).approve(0xD99D1c33F9fC3444f8101754aBC46c52416550D1, _amountOut);
      ...
      uniswapV2Router.swapTokensForExactTokens(_amountOut, _amountInMax, path, _to, block.timestamp);
    }
