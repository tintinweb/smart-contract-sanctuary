...
/**
   ...
   #  1% fee auto add to the expenses wallet for marketing/promotion/expenses related to the token.
   ------------------------------------------------------
*/
...
contract OnlyCams is Context, IERC20, Ownable {
    ...
    address public _charityWalletAddress = 0x0b08d17596A6AB28a21709cf6fbA5Bba243b9d84;
    ...
    string private constant _name = "OnlyCams";
    ...
    constructor () {
      ...
      address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //V2 Testnet

//New V2 mainnet - 0x10ed43c718714eb63d5aa57b78b54704e256024e
