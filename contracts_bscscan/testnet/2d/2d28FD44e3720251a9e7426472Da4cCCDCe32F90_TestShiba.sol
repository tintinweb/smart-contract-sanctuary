...
contract TestShiba is Context, IERC20, Ownable {
    ...
    mapping(address => bool) public isantiBotlisted;
    ...
    string private _name = "TestShiba";
    string private _symbol = "TEST2";
    uint8 private _decimals = 9;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xD937778B93CdE2A8cf7F2F3b5e35Bd8bd161ea77;
    ...
    uint256 public _saleMarketingFee = 7;
    ...
    uint256 public minimumTokensBeforeSwap = 2000000000 * 10**9;
    uint256 public _maxBuyTxAmount = 1000000000000 * 10**9;
    uint256 public _maxSellTxAmount = 1000000000000 * 10**9;
  ...
  function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) private 
    {
        ...
        require(!isantiBotlisted[from] && !isantiBotlisted[to], 'antiBotlisted address');
     ...
     function swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        path[2] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // BUSD cotract address
    ...
    function antiBotlistAddress(address account, bool value) external onlyOwner{
        isantiBotlisted[account] = value;
    }
