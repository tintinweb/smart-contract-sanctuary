...
contract StableCollateralReserve is AccessControlUpgradeable {
        ...
        returns (uint256 _totalExcess)
    {
        ...
        if (_ecr <= _tcr) {
            ...
            _totalExcess =
                ((_ecr - _tcr) * globalCollateralValue()) /
                RATIO_PRECISION;
        }
    }
        ...
        returns (uint256 _collateralNeeded)
    {
        ...
        uint256 _diff = _tcr.sub(_ecr);
        _collateralNeeded = _diff
            .mul(totalGlobalSynthValue())
            .div(PRICE_PRECISION)
            .sub(globalCollateralValue());
    }
    ...
    function recollateralizeShare(
        ...
        uint256 _recollateralizeValue = recollateralizeAmount();
...
contract KUSDPool is AccessControlUpgradeable {
    ...
    function mintFractionalSynth(
        ...
        synth.mint(msg.sender, _synthAmount);
        synth.mint(address(this), _fee);
    }
