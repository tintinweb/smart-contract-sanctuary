...
/**
 * @title HempirePrediction
 */
contract HempirePrediction is Ownable, Pausable, ReentrancyGuard {
    ...
    address public adminAddress1; // address of the admin
    address public adminAddress2; // address of the admin
    address public adminAddress3; // address of the admin
    address public adminAddress4; // address of the admin
    ...
    event NewAdminAddress1(address admin1);
    event NewAdminAddress2(address admin2);
    event NewAdminAddress3(address admin3);
    event NewAdminAddress4(address admin4);
    ...
    modifier onlyAdmin() {
        require(msg.sender == adminAddress1 || msg.sender == adminAddress2 || msg.sender == adminAddress3, "Not admin");
        _;
    }

    modifier onlyAdminOrOperator() {
        require(msg.sender == adminAddress1 || msg.sender == adminAddress2 || msg.sender == adminAddress3 || msg.sender == operatorAddress, "Not operator/admin");
        _;
    }
     ...
     * @param _adminAddress1: admin address1
     * @param _adminAddress2: admin address2
     * @param _adminAddress3: admin address3
     * @param _adminAddress4: admin address4
    ...
    constructor(
        ...
        adminAddress3 = _adminAddress3;
        adminAddress4 = _adminAddress4;
    ...
    function claimTreasury() external nonReentrant onlyAdmin {
        ...
        treasuryAmount = 0;
        _safeTransferBNB(adminAddress1, (currentTreasuryAmount * 25) / 100);
        _safeTransferBNB(adminAddress2, (currentTreasuryAmount * 25) / 100);
        _safeTransferBNB(adminAddress3, (currentTreasuryAmount * 25) / 100);
        _safeTransferBNB(adminAddress4, (currentTreasuryAmount * 25) / 100);
     ...
     * @dev Callable by owner
     */
    function setAdmin1(address _adminAddress1) external onlyOwner {
        require(_adminAddress1 != address(0), "Cannot be zero address");
        adminAddress1 = _adminAddress1;

        emit NewAdminAddress1(_adminAddress1);
    }

    function setAdmin2(address _adminAddress2) external onlyOwner {
        require(_adminAddress2 != address(0), "Cannot be zero address");
        adminAddress2 = _adminAddress2;

        emit NewAdminAddress2(_adminAddress2);
    }

    function setAdmin3(address _adminAddress3) external onlyOwner {
        require(_adminAddress3 != address(0), "Cannot be zero address");
        adminAddress3 = _adminAddress3;

        emit NewAdminAddress3(_adminAddress3);
    }

    function setAdmin4(address _adminAddress4) external onlyOwner {
        require(_adminAddress4 != address(0), "Cannot be zero address");
        adminAddress4 = _adminAddress4;

        emit NewAdminAddress4(_adminAddress4);
    }
