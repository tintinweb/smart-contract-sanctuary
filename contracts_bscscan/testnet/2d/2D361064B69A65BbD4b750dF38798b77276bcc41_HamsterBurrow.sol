...
contract HamsterBurrow {
    ...
    event Debug(string _memo, address _addr, uint256 _value1, uint256 value2);
    ...
    function transfer(address _from, address _to, uint256 _amount) external onlyWhitelisted returns (bool) {
        ...
        if(_amount > 0) {
            ...
            emit Debug('transfer:', _from, balances[msg.sender][_from], _amount);
    ...
    function updateBalance(address _owner) private returns (bool) { // ToDo: make it private
        ...
        emit Debug('updateBalance: balances[BABY]', _owner, balances[tokenNames['BABY']][_owner], currentBabyBalance);
    ...
    function transmute(address _owner, uint256 _amount) private returns (bool) {
        ...
        emit Debug('transmute: _burn', _owner, balances[tokenNames['BABY']][_owner], _amount);
