...
/**
   ...
   6% fee auto distributed to all hodlers
   3% fee auto sent to the Burn Address
...
contract INSUROBO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 *10**6 * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "INSUROBO";
    string private _symbol = "INSR";
    ...
    uint256 public _maxTxAmount = 1 *10**6 * 10**10;
    uint256 private numTokensSellToAddToLiquidity = 20 *10**6 * 10**10;
    ...
    function _burn(uint256 amount) public virtual onlyOwner {
        ...
        _tOwned[address(0x000000000000000000000000000000000000dEaD)] += amount;
        _rOwned[address(0x000000000000000000000000000000000000dEaD)] += rAmount;
