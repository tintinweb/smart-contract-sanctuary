...
contract unlimited is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 22 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "UNLIMITED";
    string private _symbol = "ULM";
    ...
    address public charityWallet = 0x1711AB01CD35535192063C513fd1Be6EfFc66e2B;
    ...
    uint256 private numTokensSellToAddToLiquidity = 11 * 10**9;
