...
/**
 * ____  _____   _____  _____    ______         _        ___  ____    _____  _____  
 * |_   \|_   _| |_   _||_   _| .' ____ \       / \      |_  ||_  _|  |_   _||_   _| 
 *   |   \ | |     | |    | |   | (___ \_|     / _ \       | |_/ /      | |    | |   
 *   | |\ \| |     | '    ' |    _.____`.     / ___ \      |  __'.      | '    ' |    
 *  _| |_\   |_     \ \__/ /    | \____) |  _/ /   \ \_   _| |  \ \_     \ \__/ /    
 * |_____|\____|     `.__.'      \______.' |____| |____| |____||____|     `.__.'     
 * 
 * fee auto add to the liquidity pool to locked forever when selling
 * fee auto moved to Oxygenerator wallet
 * fee auto moved to marketing wallet
 * 
*/
...
contract N4 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public oxygeneratorAddress = payable(0x0769A637Fc8f4Cd1B00715fF6465d0F41325f52c); // Oxygenerator Address
    address payable public marketingAddress = payable(0x8115299d7BFeD104c2Dc408758e9bF6381ef0389); // Marketing Address
    ...
    string private _name = "N4";
    string private _symbol = "N4";
    ...
    uint256 private buyBackUpperLimit = 777777777 * 10**9;
