...
pragma solidity 0.6.0;
  ...
  contract XYROLDGame {  
    ...
    function playgame(uint256 _gameId, uint8 _choice) public payable returns (bool){
        ...
        address _winner = getgameresult(_playGame.player1, _oponent, _gameId);
    ...
    function getgameresult(address _p1, address _p2, uint256 _gameId) internal view returns (address)
    {
