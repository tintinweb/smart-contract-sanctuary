...
contract AVADOGE is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "AVADOGE";
    string public constant symbol   = "AVADOGE";
    ...
    uint256 public _percentageOfLiquidityForW00f = 40;
    ...
    event setW00fWalletTX(address TheFollowingAddressIsSetAsTheW00fWallet);
    ...
    event setPercentageOfLiquidityForW00fTX(uint256 PercentageOfLiquidityForW00fIsSetTo);
    ...
    constructor (address cOwner, address W00fWallet) Ownable(cOwner) {
        _W00fWallet = W00fWallet;
        ...
        _isExcludedFromFee[_W00fWallet] = true;
    ...
    function Lepus() public pure returns(string memory) {
        return "01000001011101100110000101000100011011110110011101100101  ";
    }
    ...
    // STATE
    function setW00fWallet(address W00fWallet) external onlyOwner {
        _W00fWallet = W00fWallet;
        emit setW00fWalletTX(W00fWallet);
    }
    ...
    function setPercentageOfLiquidityForW00f(uint256 percentageOfLiquidityForW00f) external onlyOwner {
        _percentageOfLiquidityForW00f = percentageOfLiquidityForW00f;
        emit setPercentageOfLiquidityForW00fTX(percentageOfLiquidityForW00f);
    }
    ...
    // When AVADOGE becomes an utility token with 0% tax, withdrawToken function will allow us to remove the remaining token inside the contract address.
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        bool shouldAddLiquidity = (_percentageOfLiquidityForBnbReward + _percentageOfLiquidityForW00f) < 100;
        ...
        uint256 bnbForW00f  = newBalance * _percentageOfLiquidityForW00f / 100;
        uint256 bnbForLiquidity  = newBalance - bnbForRewardPool - bnbForW00f;

        // send BNB to W00f
        if (bnbForW00f > 0) {
            payable(_W00fWallet).transfer(bnbForW00f);
        }
