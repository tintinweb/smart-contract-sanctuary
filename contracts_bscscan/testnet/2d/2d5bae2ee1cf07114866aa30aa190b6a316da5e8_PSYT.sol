...
// File: contracts/CharityDoge.sol
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x347742B3017Cd17D90E2ead33a0cd2f3Ce4953a8;
...
contract PSYT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x365ACF5A0c94BDcB202C7b60295f6E9f0Fb5fCEd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Charity Doge";
    string private _symbol = "PSYT";
