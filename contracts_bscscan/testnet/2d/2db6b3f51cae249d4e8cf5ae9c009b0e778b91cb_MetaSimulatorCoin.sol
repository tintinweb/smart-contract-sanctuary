...
contract MetaSimulatorCoin is Context, IERC20, Ownable {
...
/**
10,000,000,000
Token Name: meta simulator coin 
Token Symbol: MSC
Total Supply: 10 billions
Decimals: 18

Taxation on Buy 
reflection to holders : 2% in BNBs 
Auto Liquidity : 3% in BNBs 
Community & Marketing : 8% in BNBs
Taxation on Sell 
reflection to holders : 3% in BNBs 
Auto Liquidity : 4% in BNBs 
Community & Marketing : 9% in BNBs
*/
    string private constant _name = "Meta Simulator Coin";
    string private constant _symbol = "MSC";
    ...
    constructor() {
        ...
        _setRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 ); 
        //_setRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _marketingWallet = payable(0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2);
        _liqWalletAddress = 0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2;
    ...
    function setBuyTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _buyTaxFee = taxFee;
        require(_buyTaxFee + _buyMarketingFee + _buyLiquidityFee <= 20, "Total fees exceed 20%");
    }
    ...
    function setSellTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _sellTaxFee = taxFee;
        require(_sellTaxFee + _sellMarketingFee + _sellLiquidityFee <= 25, "Total fees exceed 25%");
    }
    ...
    function setMarketingWallet(address _address) external onlyOwner() {
        ...
        _marketingWallet = payable(_address);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(_marketingWallet, transferredBalance);
    }
