...
contract HaggleX is Initializable, BEP20Upgradeable, BEP20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    */
    function getHalvedReward() public view returns (uint) {
            ...
            if (getTotalSupply() >= 200000 gwei && getTotalSupply() <= 211680 gwei) {//halvening 1
               reward =  8 gwei;
            }
            else if (getTotalSupply() > 211680 gwei && getTotalSupply() <= 217520 gwei) {//halvening 2
               
               reward =  4 gwei;
            }
            else if (getTotalSupply() > 217520 gwei && getTotalSupply() <= 220440 gwei) { //halvening 3
               
               reward =  2 gwei;
            }
            else if (getTotalSupply() > 220440 gwei && getTotalSupply() <= 221900 gwei) { //halvening 4
               
               reward =  1 gwei;
            }
            else if (getTotalSupply() > 221900 gwei && getTotalSupply() <= 222630 gwei) { //halvening 5
               
               reward =  0.5 gwei;
            }
            else if (getTotalSupply() > 222630 gwei && getTotalSupply() <= 222995 gwei) { //halvening 6
               
               reward =  0.25 gwei;
            }
            else if (getTotalSupply() > 222995 gwei && getTotalSupply() <= 223177.5 gwei) { //halvening 7
               
               reward =  0.125 gwei;
            }
            else if (getTotalSupply() > 223177.5 gwei) { //halvening 8
