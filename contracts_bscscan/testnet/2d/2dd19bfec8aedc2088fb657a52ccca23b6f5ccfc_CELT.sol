...
contract LockedWallets is Context, Ownable {
    
    address payable public lockedWallet; 
    uint256 internal constant _releaseTime = 1638250500;

    function setLockedWallet(address payable wallet) external onlyOwner {
        lockedWallet = wallet;
    }
...
contract CELT is Context, IERC20, Ownable, LockedWallets{
