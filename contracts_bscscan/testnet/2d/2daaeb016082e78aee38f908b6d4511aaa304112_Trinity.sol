...
contract Trinity is FinanceBase {
	...
	constructor (address routerAddress) FinanceBase(routerAddress) {
		...
		_tokensList["MATIC"] = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47;  // mainnet 0xCC42724C6683B7E57334c4E856f4c9965ED682bD || testnet 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47
		_tokensList["DOT"] = 0xE2EEEaa527f78eE845EB46355210FbeD77e92C47;   // mainnet 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402  || testnet 0xE2EEEaa527f78eE845EB46355210FbeD77e92C47
		_tokensList["AVAX"] = 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca;  // mainnet 0x1CE0c2827e2eF14D5C4f29a091d735A204794041  || testnet 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca
	...
	function doClaimReward(address user) private returns (bool) {
		...
		|| (!_tokensAllowance[firstTokenAddress] && !_tokensAllowance[secondTokenAddress])) { 
		    firstTokenAddress = address(this);
