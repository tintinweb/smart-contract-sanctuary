...
contract PancakeByalanLP is ByalanIsland, Sailor, GasThrottler, IByalan, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using Address for address payable;

    // Tokens used
    address public constant WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address public constant CAKE = 0xe8C199E149EAE91ab4Ee763978e75887c350F989;
    address public override want;
    address public lpToken0;
    address public lpToken1;

    // Third party contracts
    address public constant MASTERCHEF = 0x3892331a44e02d2377b05E900Af4F246daf367d1;
    ...
    constructor(
        ...
        ByalanIsland(
            _hydra,
            0xD9b138Ca45e31c2a2d52A32ecCF5E5383B540345,
            _izlude,
            _kswFeeRecipient,
    ...
    function chargeFees() internal nonReentrant {
        uint256 toWbnb = (IERC20(CAKE).balanceOf(address(this)) * totalFee) / MAX_FEE;
        IUniswapV2Router02(unirouter).swapExactTokensForETH(toWbnb, 0, cakeToWbnbRoute, address(this), block.timestamp);
    ...
    function pendingReward() external view override returns (uint256) {
        return IMasterChef(MASTERCHEF).pendingCake(pid, address(this)) + IERC20(CAKE).balanceOf(address(this));
    }
