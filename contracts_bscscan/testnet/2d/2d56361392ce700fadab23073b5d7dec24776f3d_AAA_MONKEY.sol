...
interface IDividendDistributor {
    ...
    function manualDividendforGreedyHumans(address greedyboy) external;
...
contract DividendDistributor is IDividendDistributor {
    ...
    function manualDividendforGreedyHumans(address greedyboy) external override onlyToken {
        distributeDividend(greedyboy);
    }
...
contract AAA_MONKEY is IBEP20, Auth {
    ...
    function ___claimDividend() external {
        distributor.manualDividendforGreedyHumans(msg.sender);
    }
