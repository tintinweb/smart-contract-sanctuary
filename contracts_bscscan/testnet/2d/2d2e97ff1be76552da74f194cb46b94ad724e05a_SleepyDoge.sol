 ...
 * Total Supply:  10,000,000,000,000 SDOGE (10 billion)
 * Max Transaction: 100 Million (1%)
 * Max Wallet: 100 Million (1%)
 * 1% Reflections
 * 10% To liquidity
 * LP burned on launch
 * AUTO LP generated & burned on each SELL
...
contract SleepyDoge is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 100 * 10**9;
    uint256 public _maxWalletToken = 100 * 10**6 * 10**9; // Max Wallet: 100 Million (1%)
    uint256 public _minBNBBalance = 1 * 10**17;
    ...
    function minBNBBalance() public view returns (uint256) {
        return _minBNBBalance;
    }
    
    function currentBNBBalance() public view returns (uint256) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(buyBackEnabled && BNBbalance > _minBNBBalance){
             buyBackTokens(BNBbalance.div(100));
        }
