...
contract TokenineERC20Dividend is ERC20Capped, ERC20Snapshot, ERC20Burnable, AccessControl {
    using SafeMath for uint256;
...
contract MockToken is TokenineERC20Dividend {
    constructor(address _dividend, address admin)
        public
        TokenineERC20Dividend("Mock Token", "MOCK", _dividend, 1e24, admin)
    {}
}
