...
contract LotteryTracker is ILotteryTracker, LotteryWinner, Ownable {
    ...
    constructor(address rewardToken,  uint256 drawInterval) {
...
abstract contract LotteryHelper is Pancake {
    ...
    uint256 public entryDivider = 1000 * 10**18;
    uint256 gasForProcess = 300000;

    constructor(address _weeklyAddress) {
...
LotteryHelper {
    ...
    constructor (uint256 whaleMaxSell, uint256 whaleMinBalance, address _weeklyAddress) TxLimits(whaleMaxSell, whaleMinBalance) LotteryHelper(_weeklyAddress) {
