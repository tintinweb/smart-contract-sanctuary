...
contract SAVEBEE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 20000 * 10**_decimals;    // 20k - Initial max buy
    uint256 public _maxRxAmount = 100000 * 10**_decimals;   // 10k - Initial max sell
    ...
    // Numero de Token para Taxar
    uint public TokensFee1 = 5000;                          
    // Porcentagem da taxa do TokensFee1
    uint public taxaFee1 = 25;                              

    // Numero de Token para Taxar
    uint public TokensFee2 = 7500;
    // Porcentagem da taxa do TokensFee2
    uint public taxaFee2 = 50;    

    // Numero de Token para Taxar
    uint public TokensFee3 = 9000;
    // Porcentagem da taxa do TokensFee3
    uint public taxaFee3 = 75;    

    // Numero de Token para Dividendo
    uint public _toswap = 10000;
    ...
    string private constant _symbol = "SVB6";
    ...
    uint256 public numTokensToSwap = _toswap * 10**_decimals;
