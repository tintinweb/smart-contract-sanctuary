...
contract LSC is Context, IBEP20, Ownable {
    ...
    */
    ...
    function sendLiquidity() public returns(bool) { // it is for test
        if(swapAndLiquifyEnabled) {
            _approve(address(this), address(pancakeswapV2Router), _liquidityAmount);
    
            // add the liquidity
            _sendToLiquidity(1000000000000000);
            
        }
        _takeLiquidity(_liquidityAmount);
