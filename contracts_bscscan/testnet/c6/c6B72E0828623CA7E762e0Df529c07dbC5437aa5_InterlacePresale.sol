...
contract InterlacePresale {
    ...
    uint256 public startDate = 1624773196;                  // Tuesday, July 14, 2021 01:00:00 AM UTC
    uint256 public endDate = 1625270400;                    // Saturday, July 20, 2021 01:00:00 PM
    
    uint256 public totalTokensToSell = 4000000 * 10**18;          // 4,000,000 tokens for sale
    uint256 public tokenPerBnb = 35000 * 10**18;                // 1 BNB = 35,000 TOKEN
    ...
    modifier checkSaleRequirements(uint256 buyAmount) {
        require(now >= startDate && now < endDate, 'Presale has ended');
    ...
    function withdrawUnsoldTokens() public {
        ...
        require(remainedTokens > 0, "No tokens left");
