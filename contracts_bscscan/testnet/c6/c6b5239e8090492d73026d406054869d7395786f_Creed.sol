...
contract Creed is Context, IBEP20, Ownable {
    ...
    address payable private Maddress = payable(0xE8171F3847ebAeC6C9579eA1793dB9B061fCeD43); //Mark Address
    ...
    string public _name = "Creed"; 
    string public _symbol = "CREED";
    ...
    uint256 private MTSTATT = 1000000000 * 10**1 * 10**_decimals;
