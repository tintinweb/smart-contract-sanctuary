...
//iHodlEth Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract iHodlEthv3 is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'iHodlEthv3';
    string private constant _symbol = 'iHodlEthv3';
    ...
    uint256 public _PriceDownTaxPercent = 10;
    ...
    function calculatePriceImpact(uint256 amount, bool isSell) public view returns(uint256, uint256){
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            if(!sellLockDisabled&&!_excludedFromSellLock.contains(sender)){
                ...
                if(PriceGoingDown){
                 _sellTax = _sellTax + 10;
                 //If price going down add 10%
                }
                //If Price Impact greater than 1% add 10%
                if(_PI>=10000000){
                  _sellTax = _sellTax + 15;
                }
             }
            ...
            //Check if price is going down, if so tax is cheaper.
            if(PriceGoingDown){
