...
/*
    Sasin template token tokenomics:
        - Max Supply: 40,000,000
        - Max TX: 400,000 (1%)
        - Min TX: 1
        - 1% of all sells are automatically redistributed to all holders
        - 5% fee is automatically added to the liquidity pool
        - 3% fee goes to a "marketing address"
        - 1% fee goes to a "charity address"
*/

contract Sasin is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "Sasin";
    string private _symbol = "Sasin";
    ...
    uint256 private _tTotal = 40 * 10**6 * _decimalFactor; // Tokens total
    ...
    uint256 public _maxTxAmount = 4 * 10**5 * _decimalFactor;
    uint256 public _minTxAmount = 1 * _decimalFactor;
    ...
    /* Payable fee wallets */
    address payable _developerAddress = payable(0xc9a50A3D7E8274Baef8566325c5D2E065b78Fc59);
    address payable _marketingAddress = payable(0x3486a018902Df0cA2E2f74E2f359EE6fa431e489);
