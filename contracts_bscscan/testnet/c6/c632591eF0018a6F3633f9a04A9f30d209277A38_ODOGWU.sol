...
contract ODOGWU is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 500 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Odogwu';
    string private _symbol = 'ODGW';
    uint8 private _decimals = 8;

    uint256 public _taxFee = 2;  // 2% reflect fee
