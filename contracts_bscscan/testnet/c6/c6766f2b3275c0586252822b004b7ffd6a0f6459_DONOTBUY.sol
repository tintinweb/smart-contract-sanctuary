...
// DNBIE AMERICAS HOUSEHOLD PUP THE DOG EVERYONE LOVES WHEN ELON MUSK WAS JUST A BABY BEFORE THERE WAS DOGE FLOKI SHIB AND ALL 
// THE BABY DOGS THERER WAS ELONS FAVORITE COMPANION DNBIE THE DOG OF THE HEARTLAND DID WE MENTIONDNBIE LOVES TO FEEL THE AIR 
// OUTSIDE AS SHES RIDING WITH ELON 
...
contract DONOTBUY is Context, IBEP20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 5 / 100;
    ...
    constructor () {
        ...
        uniswapV2Router = _uniswapV2Router;
         ...
         maxTransactionAmount = _tTotal * 5 / 100;// 5.0% maxTransactionAmount
