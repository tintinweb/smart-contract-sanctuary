...
contract VendingMachine is OwnableUpgradeable, OracleClient {
    ...
    event CreateSeedmon(address indexed player, uint256 ticketID, bytes32 name);
    ...
    function createPack(uint256 _tokenPrice, uint256 _bonusPoint, uint256 _minPrivilegeLevel, uint256 _ticketLimit)
        external
        onlyOwner
    {
        ...
        emit CreatePack(packID, _tokenPrice, _bonusPoint);
    }
        ...
        override
    {
        ...
        emit CreateSeedmon(ticket.player, ticketID, seedmonName);
    }
