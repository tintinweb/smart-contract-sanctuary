...
contract MainDex is Ownable {
  ...
  uint256 public platformPerecentage;
  struct fixedSell {
...
uint256[] allowedArray;
  ...
  function init2()public {
    _supportNft[address(0xCf184b05451dA92c79699FA987852D8f1e47245f)] = true;
  }
...
//   }
  ...
  function getXNFTAddress () public view returns(address) {
      return address(XNFT);
  }
