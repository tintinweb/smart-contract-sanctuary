...
contract MoonNation3 is Context, IERC20, Ownable {
    ...
    string private _name = "Moon Nation3";
    string private _symbol = "MNG";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1; // 3% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 10; // 3% added to liquidity 
