...
contract Gaming is BEP20 {
    ...
    */
    ...
    function buy() public payable {
        ...
        (bool success, ) = address(this).call { value: msg.value * gameSettings.prizeRewardPercentage.div(100), gas: 5000 }("");  // prize 1%
        
        require(success, "Failed to send BNB to contract");
        
        withdrawMarketingFee(marketingWallet, msg.value * gameSettings.marketingWalletPercent.div(100)); // marketingFee 1%
