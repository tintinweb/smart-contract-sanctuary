...
contract Shibnobi is Context, IERC20, Ownable {
    ...
    function setSwapThresholdPercent(uint256 SwapThresholdPercent) external onlyOwner() {
        numTokensSellToAddToLiquidity = _tTotal.mul(SwapThresholdPercent).div(1000);
    }
