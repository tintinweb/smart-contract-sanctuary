...
pragma solidity ^0.8.0;
contract ANNASWAP is ERC20, Ownable {
    ...
    constructor() ERC20("ANNA SWAP", "ANNA") {
        _mint(msg.sender, 13800000*10**decimals());
        _mint(address(this), 9200000*10**decimals());
        startSale(block.number, 999999999, 0,25000*10**decimals(), 2000000);
        startAirdrop(block.number,999999999,5*10**decimals(),2000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
