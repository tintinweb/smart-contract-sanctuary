...
contract TokenVesting is Initializable, Ownable {
    ...
    function lock(address _addr, uint256 _amount,uint256 _cliff, uint256 _vetsingPercent) external {
        ...
        if (_amount > 0) {
            ...
            VestingInfo storage vesting = vestings[_addr];
            vesting.unlockedFrom = block.timestamp.add(_cliff);
