...
contract GymVaultsBank is ReentrancyGuard, Ownable, Relationship {
    ...
    address public constant routerAddress = 0x2B893B6c22343252E7eCf47006C837005E11ac71; // PancakeSwap: Router
    ...
    constructor(
        ...
        buyBack = 0xE59627162CbDC2DBD7bcb67A3509273c8ab782dD;
        totalAllocPoint = 0;
        add(IERC20(0x7a5760296FCBe78178d9b84786d0C76732a9a051), 30, false, 0x36C02dA8a0983159322a80FFE9F24b1acfF8B570);
    ...
    function _deposit(uint256 _pid, uint256 _wantAmt, bool _isToken) private {
        ...
        if (_wantAmt > 0) {
            ...
            pool.want.safeTransfer(0xE59627162CbDC2DBD7bcb67A3509273c8ab782dD, _wantAmt * BUY_AND_BURN_GYM / 100);
