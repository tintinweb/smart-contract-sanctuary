...
contract PresalePrivateContract is Ownable {
    ...
    function getTokenInfo(address _token) public view  returns(string memory,string memory,uint256) {
    ...
    function createPresale(
        ...
        bool _whitelist
            ...
            saveAdvance(getEstimatedToken(_saleRate,_hardCap),_softcap,_hardCap,_saleRate,_saleId) ;
  ...
  function saveSettings(uint256 _vestingScheduled,uint256 _vetsingPercentage, uint256 _count) internal {
