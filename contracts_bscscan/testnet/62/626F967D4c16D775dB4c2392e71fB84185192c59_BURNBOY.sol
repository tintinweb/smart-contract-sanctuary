...
contract BURNBOY is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _name = "$BURNBOY";
    string private _symbol = "$BURNBOY";
    ...
    uint256 public _saleBurnFee = 5; 

    address payable public marketingWallet =  payable(0xc85bFE12db63992F2c0Bd32654c1A406766A1888);
    ...
    function setAllBuyFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() 
    {
        _taxFee = taxFee;
    ...
    function setAllSaleFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() 
    {
        _saleTaxFee = taxFee;
