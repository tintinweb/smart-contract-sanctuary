...
contract pixelNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, IERC721Mintable {
    ...
    function safeMint(address to, string memory uri) public onlyMinters override {
