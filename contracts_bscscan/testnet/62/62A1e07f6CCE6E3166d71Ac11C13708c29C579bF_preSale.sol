        ...
        if (
            ...
            if (claimCount[msg.sender] == 0) {
                ...
                remainingCoins = coinBalancePublic[msg.sender].sub(
                    coinBalancePublic[msg.sender].mul(adminFeePercent).div(100)
                );
        ...
        if (
            ...
            if (claimCount[msg.sender] == 0) {
                ...
                remainingCoins = coinBalancePrivate[msg.sender].sub(
                    coinBalancePrivate[msg.sender].mul(adminFeePercent).div(100)
                );
        ...
        if (
            ...
            if (claimCount[msg.sender] == 0) {
                ...
                remainingCoins = coinBalanceSeed[msg.sender].sub(
                    coinBalanceSeed[msg.sender].mul(adminFeePercent).div(100)
                );
