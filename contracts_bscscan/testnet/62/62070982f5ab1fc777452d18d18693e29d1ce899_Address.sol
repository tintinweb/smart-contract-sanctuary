...
contract LMOON is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Laika Moon";
    ...
    address public charityWallet = 0xe88378a2e119CbDf86225B6bFCD624f66DC4d341;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1 * 1**18;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x6725F303b657a9451d8BA641348b6761A6CC7a17, 'We can not exclude Pancake router.');
