...
contract CoinLoginTest is Context, IBEP20, Ownable, TransactionThrottler {
    ...
    uint256 private _tTotal = 48 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tDonationTotal;

    string private _name = "CoinLogin";
    string private _symbol = "CLG";
