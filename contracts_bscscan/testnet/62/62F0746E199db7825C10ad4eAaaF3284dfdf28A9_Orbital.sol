...
/**
  Orbital - $ORBIT
  https://t.me/OrbitalCoin
  Orbital $ORBIT token just fair launched and is making changes to revolutionise the defi world. This token is fair launched DeFi Token.
  Join our Telegram, meet the community and discover what all the hype is about! Don’t miss $ORBIT in our early stages.
**/
...
contract Orbital is Context, IBEP20, Ownable {
