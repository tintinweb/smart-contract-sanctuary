...
contract TDogeColony is Context, IERC20, Ownable {
    ...
    string private _name = "TDogeColony";
    string private _symbol = "TDOGECO";
    ...
    uint256 public minimumTokensBeforeSwap = 2000000000 * 10**18;
    uint256 public _maxBuyTxAmount = 1000000000000 * 10**18;
    uint256 public _maxSellTxAmount = 1000000000000 * 10**18;
