...
contract QuamNFTMultiple is BEP1155, Ownable, BEP1155Burnable{
    event Approve(
    ...
    function saleWithToken(
        ...
        string memory _type
            ...
            _saleToken(from, tokenId, amount, bidtoken,_type);
    ...
    function saleToken(
        ...
        _saleToken(from, tokenId, amount, "BNB",_type);
    ...
    function _saleToken(
        ...
        if(keccak256(abi.encodePacked((bidtoken))) == keccak256(abi.encodePacked(("BNB")))){   
            ...
            if(userbalance.div(1e20)>=discountMinAmount){
