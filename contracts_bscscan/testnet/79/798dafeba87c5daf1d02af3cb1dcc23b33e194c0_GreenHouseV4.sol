...
abstract contract OracleClient is IClient {
    ...
    function requestBurnTreeAvailable(uint256 requestId, address treeOwner, uint256 providedGas) internal{
        ...
        oracle.requestBurnTreeAvailable{value: providedGas}(requestId, treeOwner);
        emit RequestBurnTreeAvailible(requestId, treeOwner);
    }
    ...
    // ============ Prophet method ============
    function onBurnTreeAvailableReceived(uint256 requestId, uint256 availbleTree) override external onlyOracle returns (bool isCompleted){
...
interface IClient {
    function onBurnTreeAvailableReceived(uint256 requestId, uint256 availbleTree) external returns (bool isCompleted);
