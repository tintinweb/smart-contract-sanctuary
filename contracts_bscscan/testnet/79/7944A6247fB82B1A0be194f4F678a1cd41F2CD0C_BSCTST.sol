...
contract BSCTST is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 100000000000000 * 10**_decimals;
    ...
    address public devAddress = 0xa9C61315e5734caBEB5cDeF157453a4B73d34384;

    string private constant _name = "BSC Trial Token Test";
    string private constant _symbol = "BSCTST";
