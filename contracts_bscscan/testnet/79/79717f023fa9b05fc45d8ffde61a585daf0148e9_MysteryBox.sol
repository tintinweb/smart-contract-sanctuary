...
/** 
 *  SourceUnit: d:\Projects\realream\nft-smart-contracts\contracts\MysteryBox.sol
*/
...
contract MysteryBox is AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable  {
    ...
    function setBaseURI(string memory baseTokenURI) public virtual {
        ...
        require(bytes(baseTokenURI).length > 0, "MysteryBox: baseTokenURI is invalid");
    ...
    function mintBatch(uint256[] memory tokenIds, address[] memory accounts) external virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "MysteryBox: must have minter role to mint");
    ...
    function mintBatch(uint256[] memory tokenIds, address account) external virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "MysteryBox: must have minter role to mint");
