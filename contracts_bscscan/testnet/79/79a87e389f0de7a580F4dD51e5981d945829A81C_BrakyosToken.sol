...
contract DividendDistributor is IDividendDistributor {
    ...
    // MAINNET
    address _CARDANO_MAIN = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    ...
    // TESTNET
    address _CARDANO_TEST = 0xaC2A889dEfE2205AA18BD46c0A24e8cAE7084DBB;
    address _WRAPBNB_TEST = 0xaa25Aa7a19f9c426E07dee59b12f944f4d9f1DD3;
    ...
    IBEP20 CARD = IBEP20(_CARDANO_TEST);
...
contract BrakyosToken is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    uint256 reflectionFee = 1000;   // 10%    Reflexao
    uint256 buybackFee = 300;       // 3%     Buyback
    uint256 liquidityFee = 150;     // 1.5%   Liquidez
    uint256 marketingFee = 150;     // 1.5%   Marketing

    uint256 totalSellFee = 1600;    // 16% Venda ( 6% + 6% + 3% + 1% )

    string constant _name = "Brakyos Digital";
    string constant _symbol = "BRAK";
