...
contract FcnPresell is Ownable {
    ...
    event PresellFcn(address indexed account,uint256 convertToken);
    ...
    function presellFcn(uint _convertToken) public returns (bool) {
        ...
        require(presellTotalCount<5,"-> presellTotalCount: Sold out.");// Up to 1000 pre-sale
        ...
        emit PresellFcn(msg.sender,_convertToken);// set log
