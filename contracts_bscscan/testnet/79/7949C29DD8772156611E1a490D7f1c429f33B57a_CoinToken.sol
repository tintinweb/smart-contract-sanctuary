...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string public _name = "CryptoBlades Skill Token";
    string public _symbol = "SKILL";
    ...
    constructor(uint256 _supply, address _pancakeRouter) public {
        _totalSupply = _supply * 10**_decimals;
        balance[owner()] = _totalSupply;

        IUniswapV2Router02 _router = IUniswapV2Router02(_pancakeRouter);
            // Create a uniswap pair for this new token
        address _pancakePair = IUniswapV2Factory(_router.factory()).createPair(address(this), _router.WETH());
    ...
    function _transfer(address from, address to, uint256 amount) private {
        require(to != address(this), "You're to transfer 0 BNB to the MDCBNB address. Not MDCBNB");
