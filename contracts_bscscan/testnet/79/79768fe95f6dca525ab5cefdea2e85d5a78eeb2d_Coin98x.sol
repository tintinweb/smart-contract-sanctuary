...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x55d398326f99059fF775485246999027B3197955); //the reward token you want distributed 
...
contract Coin98x is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x55d398326f99059fF775485246999027B3197955; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Coin 98x";    
    string constant _symbol = "Coin98x";
