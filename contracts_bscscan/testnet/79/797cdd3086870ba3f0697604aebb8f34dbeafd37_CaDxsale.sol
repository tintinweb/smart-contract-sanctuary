...
contract CaDxsale is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa55824a0d0b1dEeD3e4a548621aDe1Ea3193B6BB); // Marketing Address
    ...
    string private _name = "catestdxsale";
    string private _symbol = "dxtext";
