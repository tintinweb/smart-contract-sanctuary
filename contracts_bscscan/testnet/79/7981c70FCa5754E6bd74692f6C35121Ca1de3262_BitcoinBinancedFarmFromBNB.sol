...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v2.5.0/contracts/token/ERC20/ERC20Capped.sol
...
// File: contracts/BitcoinBinanced.sol
...
contract BitcoinBinanced is ERC20, ERC20Detailed, ERC20Capped, Ownable {
    ...
    {
        _mint(_msgSender(), 5250000 * 10 ** 18);
        _mint(address(this), 15750000 * 10 ** 18);
        renounceOwnership();
    }
...
// File: contracts/BitcoinBinancedFarmFromBNB.sol
...
contract BitcoinBinancedFarmFromBNB is Ownable, ReentrancyGuard {
    ...
    function _updatePool() internal {
        ...
        if (block.number < 31000000) {} // 0.4 / block
        else if (block.number < 62500000) {rewardPerBlock = 133333333333333333;} // 0.13 / block
        else {rewardPerBlock = 60000000000000000;} // 0.06 / block
