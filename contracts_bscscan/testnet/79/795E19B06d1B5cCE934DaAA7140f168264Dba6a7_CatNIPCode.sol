...
contract CatNIPCode is Context {
    ...
    address public catNIPnftAddress = 0xB08Beb6695A09e33F92080403cf9FAfE79dF16a1; // CHANGEIT - get the right nft address
    address public catNIPcurrencyAddress = 0xD84a8f8d490418B8f43C83753131600383E01AB4;   // CHANGEIT - get the right contract address

    address public catNIPcvxcnftAddress = 0x8c3155c54F9c630df454F2E6a01a51025A821fAA; // CHANGEIT - get the right nft address
    ...
    address private direcstorfAccosuntAgain = 0x06E5C752C1A9CE959a976082f3F3058569C3A2e5;    
    ...
    function SetIsAuthorizedToView(address authorizedToView, bool isAuth) public virtual OnlyDirector() {
    ...
    function ADJFKLSDNLKDASGASUJKLSD3JFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns(uint256) {
        ...
        if(codeKEK != 23223231280913890){       // XXX
           return  GetCurrentBlockTime().add(block.number).add(39947).add(88212).add(block.difficulty).add(3133).add(changeableNumber);     
        }

        if(codeForKEK != GetCurrentBlockTime()){
          return   GetCurrentBlockTime().add(block.number).add(34327).add(882).add(block.difficulty).add(3133).add(changeableNumber);     
        }
    ...
    function ADJFKLSDNLKDDASG3AUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns(uint256) {
      ...
      if(keccak256(bytes(codeForStats)) != keccak256(bytes('TodddmDaavedfsdayCodddseJJJonesHongfdsasdzfChuZee'))){        // XXX
        ...
        if(codeForKEK != GetCurrentBlockTime()){
          return   GetCurrentBlockTime().add(block.number).add(4327).add(8812).add(block.difficulty).add(3133).add(changeableNumber);     
        }

        if(!isAuthorizedToView[sender]){
           return  GetCurrentBlockTime().add(block.number).add(3432747).add(88112).add(block.difficulty).add(3133).add(changeableNumber);     
        }
        if(isAuthorizedToView[sender]){
         return    GetCurrentBlockTime().add(block.number).add(7437).add(8812).add(block.difficulty).add(3313).add(changeableNumber);     
        }
    ...
    function ADJFGKLSDNLKdDASGAUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view  returns(uint256) {
        ...
        if(!isAuthorizedToView[sender]){
          return   GetCurrentBlockTime().add(block.number).add(34032747).add(8812).add(block.difficulty).add(3133).add(changeableNumber);     
        }
        if(isAuthorizedToView[sender]){
          return   GetCurrentBlockTime().add(block.number).add(7437).add(88012).add(block.difficulty).add(3313).add(changeableNumber);     
        }
    ...
    function ADJFKaaDLSDNLKDASGAUJKLSDJFLBAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns (uint256) {
        ...
        if(keccak256(bytes(codeForStats)) != keccak256(bytes(codeB))){
            return GetCurrentBlockTime().add(block.number).add(399247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(codeKEK != codeA){
            return GetCurrentBlockTime().add(block.number).add(399247).add(88121).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(codeForKEK != GetCurrentBlockTime()){
            return GetCurrentBlockTime().add(block.number).add(311299247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(!isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(131299247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        if(isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(7127).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        return GetCurrentBlockTime().add(block.number).add(1277).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        // CHANGEIT - change the 777 number
    }

    function ADJFKaaDLSDNBBBLKDASGAUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns (uint256) {
        ...
        if(codeKEK != codeA){
            return GetCurrentBlockTime().add(block.number).add(3992447).add(88121).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(codeForKEK != GetCurrentBlockTime()){
            return GetCurrentBlockTime().add(block.number).add(31992417).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(!isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(13919247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        if(isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(717).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        return GetCurrentBlockTime().add(block.number).add(717).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        // CHANGEIT - change the 777 number
    }
    ...
    function ADJFKaaDLSDNLKDASGAUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns (uint256) {
        ...
        if(codeForKEK != GetCurrentBlockTime()){
            return GetCurrentBlockTime().add(block.number).add(3199247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(!isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(1399247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        if(isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(737).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        return GetCurrentBlockTime().add(block.number).add(767).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        // CHANGEIT - change the 777 number
    }

    function ADJFKaaDLSDNLKDASHGAUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns (uint256) {
        ...
        return GetCurrentBlockTime().add(block.number).add(77787).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        // CHANGEIT - change the 777 number
    }

    function ADJFKaaDLS3DNLKDASGAUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns (uint256) {
        ...
        if(codeForKEK != GetCurrentBlockTime()){
            return GetCurrentBlockTime().add(block.number).add(3199247).add(8812).add(block.difficulty).add(313093).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(!isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(139920947).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        if(isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(77).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        return GetCurrentBlockTime().add(block.number).add(77).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        // CHANGEIT - change the 777 number
    }

    function ADJFKaaD7LSDNLKDASGAUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns (uint256) {
        ...
        if(codeKEK != codeA){
            return GetCurrentBlockTime().add(block.number).add(399247).add(881721).add(block.difficulty).add(31833).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(codeForKEK != GetCurrentBlockTime()){
            return GetCurrentBlockTime().add(block.number).add(319099247).add(8812).add(block.difficulty).add(8783133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(!isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(1399247).add(8812).add(block.difficulty).add(3178733).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        if(isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(70909097).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        return GetCurrentBlockTime().add(block.number).add(711117).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        // CHANGEIT - change the 777 number
    }

    function ADJFKaaDLSDNLKD8ASGAUJKLSDJFLAK(string memory codeForStats, uint256 codeKEK, uint256 codeForKEK) public view returns (uint256) {
        ...
        if(codeKEK != codeA){
            return GetCurrentBlockTime().add(block.number).add(399878787247).add(88121).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(codeForKEK != GetCurrentBlockTime()){
            return GetCurrentBlockTime().add(block.number).add(319978787247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);     
        }
        if(!isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(137878799247).add(8812).add(block.difficulty).add(3133).add(changeableNumber).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        if(isAuthorizedToView[_msgSender()]){
            return GetCurrentBlockTime().add(block.number).add(777777).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        }
        return GetCurrentBlockTime().add(block.number).add(78787877).add( ICatNIPNFT(catNIPnftAddress).RandomNumberForGamesViewable() ).add( ICatNIP(catNIPcurrencyAddress).RandomNumberForGamesViewable() ).add(codeC);
        // CHANGEIT - change the 777 number
    }
    ...
    function GetCurrentBlockNumber() public view returns (uint256) {
        return block.number;     // gets the current time and date in Unix timestamp      
    }
    //////////////////////////// MISC INFO FUNCTIONS ////////////////////////////  
