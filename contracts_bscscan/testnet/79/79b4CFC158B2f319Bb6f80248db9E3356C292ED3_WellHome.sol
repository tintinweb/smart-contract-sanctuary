...
contract WellHome is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x420F827405Ae33d5FA72D070C51aC13e8Fa676D2); // Marketing Address
    ...
    string private _name = "WellHome";
    string private _symbol = "WHOME";
    ...
    uint256 public _maxTxAmount = 50000000; //5%
    uint256 private minimumTokensBeforeSwap = 500000 ; //0,05%
