...
contract BagMan is Context, IERC20, Ownable {
    ...
    string private _name = "BagMan";
    string private _symbol = "BagM";
    ...
    uint256 private _totalTokens = 1000000000 * 10**9;
    uint256 private _minTokensBeforeSwap = 1000000 * 10**9;

    address payable private _MarketingAddress = payable(0xF572a157622C260186b6de19F999a328E035910D);
    ...
    function _swapTokensForHouse(uint256 tokensToSwap) private lockTheSwap {
        ...
        (bool success, ) = _MarketingAddress.call{value:bnbSwapped}("");
