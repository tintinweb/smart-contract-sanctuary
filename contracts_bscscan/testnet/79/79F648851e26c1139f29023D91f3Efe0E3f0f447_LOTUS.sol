...
contract LOTUS is Context, IERC20, Ownable { 
    ...
    uint256 private antiSniperBlock;
    bool public antiSniperArmed;
    uint256 private snipeBalance;
...
//FIX PUT IN SNIPER BOT MEASURES
        ...
        if (tradingIsEnabled && antiSniperArmed && (antiSniperBlock <= block.number)) {
            _totalBNBFees = 90;
            } else if (tradingIsEnabled && antiSniperArmed && (antiSniperBlock > block.number)){
