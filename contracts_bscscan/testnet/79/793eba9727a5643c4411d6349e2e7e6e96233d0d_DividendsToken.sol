...
Pitza is a high reflection token on the Binance Smart Chain that gives WallStreetBets Token, ADA, XRP, FEG and Cake to all holders - With the option to do any other token as well.
...
Links:
https://t.me/pitzavsboorgir
https://twitter.com/PitzaVsBoorgir
https://pitzavsboorgir.com/
...
contract DividendsToken is IBEP20, Auth, TokensRescuer {
    ...
    uint256 targetLiquidityDenominator = 0;
    ...
    uint256 public maxWalletSize = _totalSupply / 50; // 2%
    ...
    constructor(
		...
		autoLiquidityReceiver = address(0x2a65BE1112d672db5272e8991D0ea8728E4447bD);
        marketingFeeReceiver = address(0xcA56a708331E6337585F1a06B60C32dd03F5dCDe);
        developmentFeeReceiver = address(0x93Df6B3707A0e342C4A8B9b8B3eC11B69b5B41Ba);
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalBNBFee = totalFee.sub(dynamicLiquidityFee.div(3));
