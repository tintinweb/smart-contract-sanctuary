...
/* Token contract */
contract buysell is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3E9393883d42F75a6b6817daC2E8Da473c036527;
    ...
    // Name and symbol
    string constant _name = "BSContract";
    string constant _symbol = "BSC1";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 3%
