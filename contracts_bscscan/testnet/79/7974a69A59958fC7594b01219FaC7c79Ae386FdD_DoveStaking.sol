...
contract DoveStaking is Ownable {
    ...
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        IERC20( DOVE ).safeTransferFrom( msg.sender, address(this), _amount );
        ...
        IERC20( sDOVE ).safeTransfer( warmupContract, _amount );
        return true;
    }
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        IERC20( sDOVE ).safeTransferFrom( msg.sender, address(this), _amount );
        IERC20( DOVE ).safeTransfer( msg.sender, _amount );
    }
    ...
    function contractBalance() public view returns ( uint ) {
        return IERC20( DOVE ).balanceOf( address(this) ).add( totalBonus );
    }
    ...
    function giveLockBonus( uint _amount ) external {
        ...
        IERC20( sDOVE ).safeTransfer( locker, _amount );
    }
    ...
    function returnLockBonus( uint _amount ) external {
        ...
        IERC20( sDOVE ).safeTransferFrom( locker, address(this), _amount );
    }
