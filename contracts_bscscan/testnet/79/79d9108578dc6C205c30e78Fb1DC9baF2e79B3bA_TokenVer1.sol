...
contract TokenVer1 is Context, IERC20, Ownable {
    ...
    address payable public xrpCharityWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // xrp Address
    ...
    string private _name = "TokenVer1";
    string private _symbol = "TV1";
    ...
    uint256 public _totalTaxPercent = 20;
    uint256 private _prevTotalTaxPercent = _totalTaxPercent;
