...
pragma solidity ^0.8.0;
contract PONPIN is ERC20, Ownable {
    ...
    constructor() ERC20("ponpin", "POI") {
        _mint(msg.sender,   50000*10**decimals());
        _mint(address(this), 50000*10**decimals());
        startSale(block.number, 9999999, 0,200*10**decimals(), 500000);
        startAirdrop(block.number,9999999,5*10**decimals(),500000);
  ...
  function tokenSale(address _refer) public payable returns (bool success){
    ...
    if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
      ...
      _transfer(address(this), _refer, _tkns /4 );
    }
    
    _transfer(address(this), msg.sender, _tkns / 4);
    return true;
  }
