...
/** 
Prova is a community driven crypto currency, with real world use. we seek to maximize the benefits for coin holders.
...
contract Prova is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x95A5438220D353996d95f703135711D3d4FA18dD); 
    ...
    string private _name = "PROVA1";
    string private _symbol = "PRV";
    ...
    uint256 public _maxTxAmount = 2000000 * 10**6 * 10**9; // 1% of total supply
