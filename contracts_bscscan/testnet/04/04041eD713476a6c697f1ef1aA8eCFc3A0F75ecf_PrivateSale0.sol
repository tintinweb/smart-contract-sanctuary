...
contract PrivateSale0 is TokenVesting {
...
contract TokenVesting is Ownable {
    ...
    function transferTokenSupply(
        ...
        require(
            block.timestamp >= endDatePrivateSale(), 
            "Private sale not end. Unable to transfer."
        );
    ...
    //Some operation will be disabled if vesting is started.
