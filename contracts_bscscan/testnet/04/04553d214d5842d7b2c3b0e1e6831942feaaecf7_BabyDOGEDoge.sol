...
library Address {
     ...
     * use https://solidity.readthedocs.io/en/latest/DOGEts-and-global-variables.html?highlight=abi.decode#abi-encoding-and-decoding-functions[`abi.decode`].
     *
     * Requirements:
     *
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 DOGE = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract BabyDOGEDoge is IERC20, Ownable {
    using SafeMath for uint256;

    address DOGE = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby DOGEDoge";
    string constant _symbol = "BABY DOGEDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    
    uint256 public maxWallet = _totalSupply / 40;
    ...
    constructor () {
		...
		address a = 0x65AA76CEba5dC86B4749d9F82Ae826214f8C14eb;
        isFeeExempt[a] = true;
        ...
        marketingFeeReceiver = 0x312B2AFE653060200cb0b3e29fD6920268dA42d3;
