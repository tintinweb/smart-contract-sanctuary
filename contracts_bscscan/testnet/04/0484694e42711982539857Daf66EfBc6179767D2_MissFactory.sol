...
contract MissFactory {
    ...
    function createMissAny(
        ...
        uint256 price,
        uint256 maxNft
    ) external returns (address newMiss) {
        bytes memory bytecode = type(MissAny).creationCode;
        ...
        emit NewMissAny(name, symbol, newMiss, price, maxNft);
