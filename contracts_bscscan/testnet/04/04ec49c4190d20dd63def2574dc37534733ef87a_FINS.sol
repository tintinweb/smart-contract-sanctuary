...
abstract contract Ownable is Context {
     ...
     */
    constructor() {
        _setOwner(0x9b9545EBcf54A99217Dd2980B9597fb395Fd665F);
    }
...
contract FINS is ERC20, Ownable {
    ...
    constructor() {
        ...
        uint256 teamFirstUnlockTime = block.timestamp + (86400 * 90); // first unlock after the contract is deployed + 90 days
        ...
        uint256 rsvFirstUnlockTime = block.timestamp + (86400 * 90); // first unlock after the contract is deployed + 90 days
        ...
        uint256 NISFirstUnlockTime = block.timestamp + (86400 * 90); // first unlock after the contract is deployed + 90 days
        ...
        uint256 APEPFirstUnlockTime = block.timestamp + (86400 * 90); // first unlock after the contract is deployed + 90 days
        ...
        uint256 CBFirstUnlockTime = block.timestamp + (86400 * 90); // first unlock after the contract is deployed + 90 days
        ...
        uint256 RFFirstUnlockTime = block.timestamp + (86400 * 90); // first unlock after the contract is deployed + 90 days
        ...
        uint256 total = teamAmount + rsvAmount + NISAmount;
