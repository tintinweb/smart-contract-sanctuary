...
/**
 * 
The FlexMatrix token is a hyper deflationary token with unique tokenomics on the BSC network.
A substantial part of the taxation is rewarded to the holders, both in reflections as well as in BNB dividend.
High-prized lotteries and a supporting utility from which the revenues are 100% put back into the token!
Improved BuyBack& Burn mechanism in place. 
*/
...
contract FMX is Context, IERC20, Ownable {
