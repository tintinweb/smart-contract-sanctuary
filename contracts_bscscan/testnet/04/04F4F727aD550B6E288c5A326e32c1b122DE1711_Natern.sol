...
contract Natern is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 private maxLiqFee = 10;
    uint8 private maxTaxFee = 80;
    uint8 private maxBurnFee = 10;
    uint8 private maxWalletFee = 30;
    uint8 private maxBuybackFee = 10;
    uint8 private minMxTxPercentage = 1;
    uint8 private minMxWalletPercentage = 1;
    ...
    // 1,000,000,000,000 Natern
    uint256 public _tTotal = 1 * 10**3 * 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    string public _name = "NATERN";
    string public _symbol = "NTRN";
    uint8 public _decimals = 18;
    
    uint8 public _taxFee = 8;
    ...
    address payable public feeWallet = payable(0xa41E7b8231E9d6E23E59ce2fDF12b215E2222A00);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // 1% of total supply
    uint256 public _maxTxAmount = _tTotal.mul(1).div(10**2);
    // 1% of total supply
    uint256 public _maxWalletAmount = _tTotal.mul(1).div(10**2);
    // 0.1% of total supply
    uint256 public numTokensSellToAddToLiquidity = _tTotal.mul(1).div(10**3);
    // 1BNB
