...
contract Staking is Ownable {
    ...
    function deposit(uint256 _amount) public {
        ...
        stakingWallets[msg.sender].unlockBlock = block.number + 3600; // three months
        stakingWallets[msg.sender]._2Claim = stakingWallets[msg.sender].unlockBlock + 1200; // 14 days
