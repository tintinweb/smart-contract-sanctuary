...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 POLKADOT = IBEP20(0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B);
...
contract BabyPolkadot is IBEP20, Auth {
    using SafeMath for uint256;

    address POLKADOT = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Polkadot";
    string constant _symbol = "BabyDot";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 1000; // 0.1%
    uint256 public _maxWalletToken = 150000000000 * (10** _decimals); // 1.5% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x9001D81e45e59077EF82c26896dCE47eC1f9fa3E;
