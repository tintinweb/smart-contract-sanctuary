...
abstract contract RuffyCoinBase is IERC20Metadata, Ownable, ReentrancyGuard {
	...
	address private _developerWallet = 0xD0a34356Fdf911708EB7feE899C7afB89507bf60;
    ...
    constructor (address routerAddress, address pinkAntiBot_) {
		...
		setBuyFees(3, 3, 3, 3, 3);
		setSellFees(5, 5, 5, 5, 5);
...
contract RuffyCoin is RuffyCoinBase {
    ...
    MinimumTokenBalance private T1 = MinimumTokenBalance(1 * 10**decimals(), 17);
	MinimumTokenBalance private T2 = MinimumTokenBalance(10000000 * 10**decimals(), 33);
	MinimumTokenBalance private T3 = MinimumTokenBalance(100000000 * 10**decimals(), 50);
