...
contract NewStart is Context, IERC20, Ownable {
    ...
    uint256 private _walletLockTime;
    ...
    function lockTimeOfWalletUsingSender() public view returns (uint256) {
        return _tLocked[_msgSender()];
    }
    
    function lockTimeOfWalletUsingInt() public view returns (uint256) {
        return _walletLockTime;
    }
    ...
    function lockWallet(uint256 time) public  {
        ...
        _walletLockTime = block.timestamp + time;        
    }
