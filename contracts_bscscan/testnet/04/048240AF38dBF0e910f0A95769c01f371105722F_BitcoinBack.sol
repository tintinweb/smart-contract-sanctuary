...
contract BitcoinBack{
    ...
    uint256 public totalSupply=21000000;//21 Million
    ...
    constructor(){
        ...
        balances[msg.sender]=totalSupply;//give  totalSupply to sender
    ...
    function bonusOf(address addy)public view returns (uint ret){
        ...
        if(taxEnabled==true){
            if(lastClaim[addy]<totalClaimed){
                ...
                (balances[addy]/totalSupply);
            }
            //if overflow occurred
            else{
                if(lastClaim[addy]!=0){
                    bonus+=(115792089237316195423570985008687907853269984665640564039457584007913129639935-lastClaim[addy])*balances[addy]/totalSupply;
                }
                bonus+=totalClaimed*balances[addy]/totalSupply;
            }
        }
        return bonus;
    }
