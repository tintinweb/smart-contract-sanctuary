...
contract InspirePoolV3 is Ownable, Initializable {
    ...
    bool public paused;
    bool public pausedBusd;
    bool public pausedGsb;
    ...
    function depositBusd(uint256 _amount, address _refer) public notPauseBusd {
        address _user = _msgSender();
    ...
    function depositGsb(uint256 _amount1, address _refer) public notPauseGsb {
        address _user = _msgSender();
        _migrateComplete(_user);
    ...
    function withdraw(uint256 _miningCount) public notPauseWithdraw {
        address _user = _msgSender();
    ...
    modifier notPauseBusd() {
        require(pausedBusd == false, "BUSD Mining has been suspended");
        _;
    }
    modifier notPauseGsb() {
        require(pausedGsb == false, "GSB Mining has been suspended");
        _;
    }
    modifier notPauseWithdraw() {
        require(pausedWithdraw == false, "Withdraw has been suspended");
        _;
    }
    ...
    function setPauseBusd() public onlyOwner {
        pausedBusd = !pausedBusd;
    }
    function setPauseGsb() public onlyOwner {
        pausedGsb = !pausedGsb;
    }
    function setPauseWithdraw() public onlyOwner {
