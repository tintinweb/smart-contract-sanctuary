...
contract MoneyPocket is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MoneyPocket", "MPT") {
    ...
    function afterPreSale() external onlyOwner {
        a80DividendRewardsBuyFee = 2;
        b20DividendRewardsBuyFee = 2;
        marketingBuyFee = 2;
        buyBackAndLiquidityBuyFee = 0;
        
        a80DividendRewardsSellFee = 6;
        b20DividendRewardsSellFee = 2;
        marketingSellFee = 2;
        buyBackAndLiquiditySellFee = 2;
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned");
    ...
    function _transfer(
        ...
        require(!isBlacklisted(from), "MPT: sender blacklisted");
        require(!isBlacklisted(to), "MPT: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "MPT: sender blacklisted");
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "MPT: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "MPT: Account is not blacklisted");
