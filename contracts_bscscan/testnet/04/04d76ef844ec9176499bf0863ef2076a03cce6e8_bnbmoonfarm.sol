...
~ ANTI-WHALE CONTROL FEATURES:
  ...
  Max withdraw amount of 20 BNB per day.
...
contract bnbmoonfarm {
	using SafeMath for uint256;

	IERC20 public erctoken;
	address token = 0xB8c77482e45F1F44dE1745F52C74426C631bDD52; /** BNB **/
	/** default percentages **/
	...
	uint256 public MAX_WITHDRAW = 20 ether;
	...
	uint256 public LOTTERY_TICKET_PRICE = 50 * 1e15; /** 0.05 BNB **/
	...
	constructor(address ownerAddress, address payable projectAddress, address payable marketingAddress, address payable communityAddress) {
        ...
        plans.push(Plan(200, 30, 50 * 1e15 ether, 0, 0, 0, 0, true));
        plans.push(Plan(40,  70, 50 * 1e15 ether, 0, 0, 0, 0, true));
        plans.push(Plan(60,  65, 50 * 1e15 ether, 0, 0, 0, 0, true));
        plans.push(Plan(80,  60, 50 * 1e15 ether, 0, 0, 0, 0, true));
	}
