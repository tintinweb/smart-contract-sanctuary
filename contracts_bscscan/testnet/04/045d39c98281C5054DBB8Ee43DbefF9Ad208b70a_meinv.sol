...
contract meinv is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "meinv";
    string private _symbol = "meinv";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1BAe0feda37F7F2Aa0BBbfc95A1f0B0A25040887); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x28061B111D044d574822A9C08D26925F3d0a3DfD); // buyback Address
