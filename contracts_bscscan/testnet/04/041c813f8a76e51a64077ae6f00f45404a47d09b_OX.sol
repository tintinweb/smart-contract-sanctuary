...
contract DividendDistributor is IDividendDistributor {
    ...
    // REAL IBEP20 BUSD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    // REAL  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
          ...
          /// REAL   : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = msg.sender;
    }
...
contract OX is IBEP20, Auth {
    using SafeMath for uint256;
    address BUSD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    //  REAL address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    // REAL address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "OX";
    string constant _symbol = "OX";
    ...
    constructor () Auth(msg.sender) {
       ...
       // REAL router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
