...
contract pixelSquidObserver is  IERC721,Ownables {
  ...
  function buyObserver(uint256 _amount,string memory _token_name ,uint256 _quality,uint256 _lv, string memory _url, string memory _animation_url,string memory _background,uint256 _watchLimit) public {
      ...
      bool isPay =  IBEP20(inputtoken).transferFrom(msg.sender,address(this), _amount);  
