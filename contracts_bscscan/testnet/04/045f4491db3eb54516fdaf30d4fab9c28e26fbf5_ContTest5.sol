...
contract ContTest5 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xAD4A2909575aDF597067CB2a9ed4E9DC48bEA654;
    ...
    string private _name = "Contract Test_5";
    string private _symbol = "CTest_5";
    ...
    constructor () {
        ...
        //                     Pancake Swap Router address - 0x10ED43C718714eb63d5aA57B78B54704E256024E
        //Mian Net
    ...
    //remove this function after testing
        ...
        function setNumTokensSellToAddToLiquidity(uint256 newNumTokensSellToAddToLiquidity) public onlyOwner() {
