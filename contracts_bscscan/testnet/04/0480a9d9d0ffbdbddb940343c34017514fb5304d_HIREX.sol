...
contract HIREX is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 10000000 * 10**9; // Max buy per 1x txn 1% from Total Supply
    uint256 private minimumTokensBeforeSwap = 500000 * 10**9; 
    uint256 public buyBackSellLimit = 1000000000;
    ...
    constructor (address payable MarketingAddress, address BurnAddress, address IUniswapV2Router) {

        _rOwned[_msgSender()] = _rTotal;
        
        marketingAddress = MarketingAddress;
        deadAddress = BurnAddress; // 0x000000000000000000000000000000000000dEaD

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(IUniswapV2Router);
