    ...
    OwnableUpgradeable
{
    ...
    // Whitelist Addresses
    mapping(address => bool) public whitelistAddresses; // ! REVISAR PARA ELIMINAR

    constructor() initializer {}

    function initialize(bool testnet_, address rewardsWallet_)
        public
        initializer
    {
        __ERC20Capped_init(100 * 1e6 * 1e18);
        __Ownable_init();
        __ERC20_init("BURG Token - CryptoBurgers.io", "BURG");

        console.log("testnet_: ", testnet_);

        if (testnet_ == true) {
            _mint(owner(), 20 * 1e6 * 1e18); // 20M Play to owner
            _mint(0x62Eb4E8C1629feD1eF5f93f15e69233157B64E1A, 30 * 1e6 * 1e18); // 30M Play to earn
        } else {
        ...
        _mint(0xc1F6e12F3A56766DA16191e03D124Fc197940f2f, 2 * 1e6 * 1e18); // Private Sale
        _mint(0x7C8449230A7D1857619612F9B0C00169732b524f, 1 * 1e6 * 1e18); // Airdrop

        // AntiWhale 2021-01-01 to 2100-01-01
        setAntiWhale(1641028005, 4102477605, 20 * 1e3 * 1e18);
    ...
    function changeWhitelistAddressses(address _address, bool _allowed)
        external
        onlyOwner
    {
