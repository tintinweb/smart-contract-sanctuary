...
contract SeederVerseBridge is OwnableUpgradeable, ERC721Holder, BridgeOracleClient {
    ...
    event SeedmonWithdrawn(uint256 ticketId, uint256 tokenId, address withdrawer, bool isSuccess);
    ...
    event SeedDownloaded(uint256 ticketId, uint256 amount, address downloader, bool isSuccess);
    ...
    function processWithdraw(uint256 ticketId, uint256 tokenId, uint256 exp, bool isSuccess) internal override {
        ...
        emit SeedmonWithdrawn(ticketId, tokenId, withdrawer, isSuccess);
    }
    ...
    function processDownload(uint256 requestId, uint256 tokenBalance, bool isSuccess) internal override {
        ...
        emit SeedDownloaded(requestId, requestAmount, downloader, isSuccess);
    }

    function processCancel(uint256 requestId, uint256 providedGas) internal override {
        address downloader = ticketIdToDownloader[requestId];
        require(downloader != address(0), "SeederVerse: Ticket is not valid");
