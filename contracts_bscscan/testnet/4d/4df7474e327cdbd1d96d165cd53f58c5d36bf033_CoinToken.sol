...
/**
    ...
    Symbol      : OUSE
    Name        : Ouse Token
    Total supply: 4 000 000 000 000
    Decimals    : 18
    ----------------------------------------------------------------------------
    1% REDISTRIBUTE TO ALL HOLDERS
    1% AUTOMATICALLY BURN ON EVERY TRANSACTION
    ----------------------------------------------------------------------------
*/
...
contract CoinToken is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,address tokenOwner){
		_NAME = _name;
		_SYMBOL = _symbol;
		_DECIMALS = _decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        bool takeFee = true;
        if (_isExcluded[recipient] || sender ==owner()) {
            takeFee = false;
        }   
