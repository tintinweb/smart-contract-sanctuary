...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _symbol = "MCCN";
        _decimals = 9;
        _tTotal = 2e22 * 10**_decimals;
        _rTotal = (MAX - (MAX % _tTotal));

        marketingAddress = payable(0x43821715327B305967C2ddcB674320F79Fa78350);
        lp_poolAddress = payable(0x43821715327B305967C2ddcB674320F79Fa78350);
        ...
        _liquidityFee = _taxFee + marketingFee;
        ...
        payable(lp_poolAddress).transfer(msg.value);
