...
contract GiveAlilBit is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 369 *10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GiveAlilBit";
    string private _symbol = "GLB";
    ...
    uint256 private numTokensSellToAddToLiquidity = 160 *10**6 * 10**9;
