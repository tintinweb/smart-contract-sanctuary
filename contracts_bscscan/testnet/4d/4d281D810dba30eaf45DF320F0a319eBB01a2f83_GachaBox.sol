...
contract GachaBox is Initializable , OwnableUpgradeable{
    ...
    // Update boxConfig
    function updateBoxConfig(uint256 _quota, uint256 _price, uint256 _boxId) public onlyOwner{
    ...
    // Open box
    function openBox(uint256 _boxId) public onlyNonContract {
...
interface ILastSurvivorCharacter is IERC165Upgradeable {
    ...
    function safeMint(address to, uint256 _charId, uint256 _typeID) external;
}
