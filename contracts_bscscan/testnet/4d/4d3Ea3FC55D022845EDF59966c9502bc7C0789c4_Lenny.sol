...
contract Lenny is EIP712, IERC20, Context, Democratic {

    // All ERC20 State Variables and mappings
    ...
    // All Lenny Defi State Variables, Mappings and Arrays
    uint256 public maxTokenPerAddress;
    mapping (address => bool) private _isExcludedFromMaxToken;
    address[] private _excludedMaxToken;

    function excludedMaxToken() public view returns (address[] memory) {
        return _excludedMaxToken;
    }
    ...
    function excludeFromMaxToken(address account) public demokratia() {
        ...
        _excludedMaxToken.push(account);
    ...
    function includeInMaxToken(address account) public demokratia {
        ...
        for (uint256 i = 0; i < _excludedMaxToken.length; i++) {
            if(_excludedMaxToken[i]==account){
                delete _excludedMaxToken[i];
            }
        }
   ...
   function approve(address spender, uint256 amount) external override returns (bool) {
    ...
    // Permit to approve ERC20 spending by signing a message (No cost)
