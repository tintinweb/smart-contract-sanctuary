...
contract MiniClaus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = payable(0xb7A511e85e23bfB0b5001431C0590451c6A766aF); // Charity Address
    ...
    string private _name = "MiniClaus";
