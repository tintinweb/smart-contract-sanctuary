...
contract FHT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0572689b9Cb91789325C32E5f4b3d2b6A4e7D526); // Marketing Address
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1_000_000_000_000_000 * 10**18;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 5;
        _maxTxAmount = 1_000_000_000_000_0 * 10**18;
    }
