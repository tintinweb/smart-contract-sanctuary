...
contract FlotillaToken is Context, IERC20, Ownable {
    ...
    string private _name = "FLOTILLA PROTOCOL";
    string private _symbol = "FLOTILLA";
    ...
    uint256 public _maxTxAmount = 10000 * 10**1 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 300000 * 10**1 * 10**9;
