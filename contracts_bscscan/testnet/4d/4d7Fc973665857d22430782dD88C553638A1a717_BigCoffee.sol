...
contract BigCoffee is Context, IERC20, Ownable {
    ...
    string private _name = "BigCoffee";
    string private _symbol = "BGCOFFEE";
...
,        address to,
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee.add(_burnFee)).div(masterTaxDivisor);
    }
