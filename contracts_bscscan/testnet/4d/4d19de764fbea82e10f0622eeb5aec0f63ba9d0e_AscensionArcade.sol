...
/*
Welcome to Ascension Arcade we are developing a cutting edge online gaming experience for the digital world. 
Super addictive games and tokenomics carefully engineered to do nothing but pump the chart! 

Powered by our native token $AAT our first game is set for release in December and we cannot wait for you to Play & Win $AAT !!!
All profits made from our games will be redistributed back to YOU the community and forever push the price of $AAT to new heights!
...
Telegram: https://t.me/AscensionArcade
Website: https://www.ascensionarcade.com/                    DI
*/
...
contract AscensionArcade is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xeD36c1D1d6cc6305FB6C8Db4e307e87a9F6a77b7);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0x9c87c55BE6E4dDaB815c4ee17837c157b24866BE); 

    string private _name    = "AscensionArcade";
    string private _symbol  = "AAT";
