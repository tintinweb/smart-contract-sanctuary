...
contract NFT2NFT is  IERC721Receiver, Ownable {
    ...
    function stakeNft(uint256 _id) public {
     ...
     emit stake(msg.sender, address(this), _id);    
    }
    ...
    function emergencyunstakenft(uint256 _id) public {
     ...
     emit unstake(address(this), msg.sender, _id);  
    }
    ...
    // function setstakeNft(address _add) public onlyOwner {
    ...
    function initialiaze(address _nftstakingadress, address _nftredeemaddress, uint256 _claimtime, uint256 _stakingStart, uint256 _stakingend, uint256 _redeemstarting, uint256 _redeemend) public onlyOwner {
