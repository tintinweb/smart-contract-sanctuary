...
/**
 * Baby Harmony One
 * The 1000x token with great rewarding mechanism!
 * 9% ONE Rewards Fee | 4% Auto-Liquidity Fee | 7% Marketing Fee
 * 
 * Telegram : https://t.me/OfficialBabyHARMONY
 * 
 * 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  ONE  = IBEP20(0x03fF0ff224f904be3118461335064bB48Df47938);
...
contract BabyHarmonyOne is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "BBYONE";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 20000; // 0.005% of supply
    bool inSwap;
