...
contract Farm is Ownable {
    ...
    event AddressList(address indexed _account, address _macTokenContract, address _magicNftContract, address _platinumNftContract, address _genesisAddress);
    ...
    function getFarmBasic() public view returns (uint256 DayTime,ERC20 MacTokenContract,ERC721 MagicNftContract,ERC721 PlatinumNftContract,address GenesisAddress,bool FarmSwitchState,uint256 FarmStartTime,uint256 FarmNowTotalCount,uint256 FarmNowJoinCount,uint256 FarmNowJoinMacAmount) {
        return (dayTime,macTokenContract,magicNftContract,platinumNftContract,genesisAddress,farmSwitchState,farmStartTime,farmNowTotalCount,farmNowJoinCount,farmNowJoinMacAmount);
    }
    ...
    function setAddressList(address _macTokenContract,address _magicNftContract,address _platinumNftContract,address _genesisAddress) public onlyOwner returns (bool) {
        ...
        emit AddressList(msg.sender, _macTokenContract, _magicNftContract, _platinumNftContract, _genesisAddress);
        return true;
    }
