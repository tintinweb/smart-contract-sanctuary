...
contract METATEST is Context, IERC20, Ownable {
    ...
    function F10_Set_Sell_Price_Impact1__Multiplied_by_100(uint256 Price_impact1) external onlyOwner {
        require (Price_impact1 < price_impact2 || price_impact1 == 0 || price_impact2 == 0, "Aborted. Price impact1 must be less than price impact2 or zero");
        ...
        // 
        // If set to 0 then the price impact feature will
    ...
    function F11_Set_Sell_Price_Impact2__Multiplied_by_100(uint256 Price_impact2) external onlyOwner {
        require (price_impact1 != 0 && Price_impact2 > price_impact1 || Price_impact2 == 0, "Aborted. Price impact2 must be larger than price impact1 or zero"); 
