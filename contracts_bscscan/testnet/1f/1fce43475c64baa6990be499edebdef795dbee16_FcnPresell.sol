...
contract FcnPresell is Ownable {
    ...
    uint256 public convertUsdtAmount = 500 * 10 ** decimals;
    uint256 public convertBzzoneAmount = 10 * 10 ** decimals;
    ...
    constructor () public {
        fcnTokenContract = ERC20(0x22807Ba8dCdE7C9856283C3b47a8803987449FaD);
