...
abstract contract Tokenomics {
    ...
    uint256 internal constant TOTAL_SUPPLY = 30 * 10**6 * 10**9;
    ...
    uint256 public maxWalletBalance = (TOTAL_SUPPLY * walletdivisor) / 10000; // 
    ...
    address internal marketingAddress = 0x9166213C7142929C2e9D7B6A0cc5ACD71093dF71;
...
contract Staking is Ownable {
    ...
    * Sua utilidade é apenas para governança do sistema
    ...
    function removePoolBalance() public onlyOwner {
        ...
        arcanecards.transferFrom(address(this), msg.sender, poolSaldo);
    }
