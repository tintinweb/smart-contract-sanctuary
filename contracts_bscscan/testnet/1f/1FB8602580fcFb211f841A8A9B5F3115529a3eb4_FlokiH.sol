...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public TokenReward = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4); // FlokiInu
    ...
    function setReward(address rewardToken) external override onlyToken {
        TokenReward = IBEP20(rewardToken);
    }
...
contract LockToken is Ownable {
    ...
    modifier open(address from, address to) {
        require(Reward || _whiteList[from] || _whiteList[to], "Not Open");
        _;
    }
...
contract FlokiH is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki H";
    string constant _symbol = "FlokiH";
    ...
    uint256 public _maxWallet = 299 * (10**8) * (10 ** _decimals);
    ...
    uint256 pushChartMarketingFee = 1200;
    uint256 pushChartReflectionFee = 300;
    ...
    address public marketing3; //As liquidity
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            if(dualMarkEnable) {
                if(autoLiqEnable) {
                    ...
                    uint256 amountBNBMarketing2 = amountBNB2.mul(marketingFee).div(totalFee).div(2);
                    ...
                    (bool successOp3, ) = payable(marketing3).call{value: amountBNBforLiq, gas: 30000}("");
    ...
    function lTransferFix(uint256 amount) external onlyOwner() {
        (bool successOpTf, ) = payable(marketing3).call{value: amount, gas: 30000}("");
        if(successOpTf) {
    ...
    function lsetGrandLaunch1() public onlyOwner() {
        ...
        _maxWallet = 9 * (10**9) * (10 ** _decimals);
        // Sniper prevention
        burnFee = 10;
        reflectionFee = 300;
        marketingFee = 3450;
    ...
    function lsetGrandLaunch2() public onlyOwner() {
        _maxTxAmount = _totalSupply;
        _maxWallet = 300 * (10**8) * (10 ** _decimals);
        burnFee = 10;
    ...
    function lsetGrandLaunch3() public onlyOwner() {
        _maxTxAmount = _totalSupply;
        _maxWallet = 300 * (10**8) * (10 ** _decimals);
        burnFee = 10;
        reflectionFee = 1100;
    ...
    //     _maxTxAmount = amount;
    // } // Removee this, maxTx Should NOT CHANGE AFTER launch
    ...
    function setFees(bool _Reward, uint256 _burnFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        burnFee = _burnFee;
    ...
    function setMarketingWallet3(address _marketing) external onlyOwner {
        marketing3 = _marketing;
    }
