...
contract Goshas_Gang_BSC is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Goshas Gang BSC';
    ...
    uint256 private _MARKETING_FEE = 300; // 3% TO Marketing WALLET
