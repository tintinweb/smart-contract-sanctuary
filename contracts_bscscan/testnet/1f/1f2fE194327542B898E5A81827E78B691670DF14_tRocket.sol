...
contract tRocket is ERC20, Ownable, MinterRole {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TRocket", "TROC") {
        ...
        burnWallet = address(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(tradingOpened && !_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
