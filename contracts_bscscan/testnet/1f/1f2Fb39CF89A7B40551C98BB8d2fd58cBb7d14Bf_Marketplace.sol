    ...
    ERC721Holder
{
    ...
    */
    ...
    function setPublicationFee(uint256 _publicationFeeRate) external onlyOwner {
        require(
            _publicationFeeRate < 1000,
            "The fee to publish should be 0% to 99.9%"
        );
    ...
    function getPublicationFee(uint256 _price) public view returns (uint256) {
        //We want marketplace publishing fees to range from 0% - 99.9%
        return
            _price.mul(publicationFeeRate).div(10 ** publicationFeeDecimal);
    }
