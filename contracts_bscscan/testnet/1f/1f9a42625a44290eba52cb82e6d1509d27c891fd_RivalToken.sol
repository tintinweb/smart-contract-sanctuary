...
contract RivalToken is BEP20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (_excludedFromTax[sender] || _excludedFromTax[recipient] || transferTaxRate == 0) {
            ...
            require(amount == sendAmount + taxAmount, "RIVAL::transfer: Tax value invalid");
    ...
    */
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "RIVAL::_writeCheckpoint: block number exceeds 32 bits");
