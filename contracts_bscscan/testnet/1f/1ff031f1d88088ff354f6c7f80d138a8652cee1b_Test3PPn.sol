...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract Test3PPn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Test3PPn";
    string constant _symbol = "Test3PPn";
    ...
    uint256 public deadBlocks = 200;

    bool public tradingOpen = false;
    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply / 2500; // 0.04%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x963E2FB3dA25F2949D35a0FA6F5c9e8D25201B1A;
        ...
        marketingFeeReceiver = 0xd98409413e4CC112e06C7fc4c91640a4582fCCd8;
