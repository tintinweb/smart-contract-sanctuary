...
contract BillionToken is Context, IERC20, Ownable {
    ...
    uint256 public _maxSellTransactionAmount = 500000 * 10**9; // can't sell more than this per transaction
    uint256 private _cooldownPeriod = 86400; // number of seconds for timeout
    uint256 public _maxCumulativeSell = 1000000 * 10**9; // max to be sold per day
