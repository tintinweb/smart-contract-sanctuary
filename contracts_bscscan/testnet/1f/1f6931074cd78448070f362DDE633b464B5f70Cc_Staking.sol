...
contract Staking is Ownable {
    ...
    constructor(
        ...
        poolInfo.push(PoolInfo({
            stakedToken: _PATO,
            allocPoint: 100, // TOkens en stake dentro de la pool
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (_amount > 0) {
            ...
            pool.totalTokensInPool += _amount;
    ...
    function reinvest() public{
        ...
        pool.totalTokensInPool += (pending - pending.mul(7).div(1000));
...
contract PatoVerde is ERC20 {
   ...
   */
  constructor(address masterChef) ERC20('Pato Verde', 'PVT') {
