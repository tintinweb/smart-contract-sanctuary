...
contract PolkaBull is Context, IBEP20, IBEP20Metadata, Ownable {
    ...
    //address V2ROUTER = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address public _marketingWalletAddress = 0x3592138ef05EA61FB3a478E74bd3b5b9A82024F6;
    ...
    uint256 private firstWeekLimit = 250000 * 10**9;
    mapping (address => uint256) private firstWeekTime;
    mapping (address => bool) private firstWeekEnter;
    //uint256 private _oneWeek = 604800;
    uint256 private _oneWeek = 300;
    ...
    function _transfer(
        ...
        if(!firstWeekEnter[sender] && sender != owner()){
            if(amount > firstWeekLimit){
                amount = firstWeekLimit;
            }
        }
        if(firstWeekEnter[sender] && sender != owner()){
            if(currentTime - firstWeekTime[sender] <= _oneWeek){
                if(amount> firstWeekLimit){
                amount =firstWeekLimit;
       ...
       //transfer amount, it will take tax, burn, liquidity fee
        ...
        if(!firstWeekEnter[sender] && sender != owner()){
           firstWeekEnter[sender] = true;
           firstWeekTime[sender] = currentTime;
        }
    }
