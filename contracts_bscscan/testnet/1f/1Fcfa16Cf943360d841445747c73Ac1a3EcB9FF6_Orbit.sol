...
contract Orbit is BEP20 {
     ...
     * construction.
     */
    constructor () BEP20("tokten test", "TOK") {
    }
...
abstract contract BEP20 is Context, IBEP20, Ownable, Pausable {
     ...
     */
    constructor (string memory namet, string memory symbolt)  {
        _name = namet;
        _symbol = symbolt;
        _decimals = 18;
    ...
    //     return transferFrom(_from, _receiver, _amount);
    // }
