...
contract DSMerchNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Diamond Boyz Army Incentive Airdrop", "DSNFT") {}
    ...
    function createToken(
        ...
        require(numberOfTokens > 0, "DSNFT: should not be zero");
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            emit TokenCreated(newItemId, recipient);
        }
    }
