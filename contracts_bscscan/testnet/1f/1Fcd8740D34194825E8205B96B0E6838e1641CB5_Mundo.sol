...
contract Mundo is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0x238c83A3E8bc75207786F3f23F69c9a4293f4b8B); // Dev Wallet Address
    address payable public marketingAddress = payable(0x848964a4a3d84708c008c456616D818bA4dEb336); // Marketing Wallet Address
    address payable public p2eAddress = payable(0x848964a4a3d84708c008c456616D818bA4dEb336); // p2e Wallet Address
