...
contract PuzlBuilder is ERC1155, Ownable {
    // The OG Puzl packs contract
    IERC721 immutable puzl;
    IERC1155 immutable unpack;
    ...
    uint256 public constant MINT_PRICE = 2 * 10**16;

    address public PUZL_PUNK;
    address public PUZL_UNPACK;
    ...
    constructor(
        ...
        puzl = IERC721(_puzl);
        unpack = IERC1155(_puzlUnpack);
        PUZL_PUNK = _puzlPunk;
        PUZL_UNPACK= _puzlUnpack;
        name = "Puzl Punk Builder";
        symbol = "PUZLBuilder";
    }
    ...
    function updatePuzlPunkCollection(address _puzlPunk) public onlyOwner {
     ...
     function updatePuzlUnPacker(address _puzlunpack) public onlyOwner {
        PUZL_UNPACK = _puzlunpack;
    }

    function makePunk(uint256[] calldata _ids, uint256[] calldata _amts, address _vls ) public payable returns(bool){
        uint256 cost = (_vls == address(0)) ? PRICE : 0;
        require(msg.value >= cost, "Value below price");
        unpack.safeBatchTransferFrom(msg.sender, address(this), _ids, _amts, "");
        IPuzlPunk(PUZL_PUNK).mintPunk(msg.sender);
        return true;
    }
    ...
    function onERC1155BatchReceived(
        ...
        require(msg.sender == address(PUZL_UNPACK), ErrMsgs.IsNotPuzlPart);
        return PuzlBuilder.onERC1155BatchReceived.selector;
    }
    ...
    function contractURI(uint256 _tokenId) public view returns (string memory) {
     ...
     function tokenURI(uint256 _tokenId) public view returns (string memory) {
        ...
        parts[0] = 'https://prereveal.puzlpunks.com/part/';
