...
contract _0xMoon is IBEP20, Ownable
{
    ...
    uint256 private MarketingTax=9000;
    uint256 private constant _TaxDivider=1000;
    ...
    constructor () {
        ...
        uint StakingToken=6000000*10**_decimals;
        uint TeamToken=3000000*10**_decimals;
        _balances[address(this)] = ContractToken;
        _balances[address(0x9c4E667695690c2089C7103677AA9A1701D9CbD2)]=StakingToken;
        _balances[msg.sender]=TeamToken;

        emit Transfer(address(0), address(this), ContractToken);
        emit Transfer(address(0), address(0x9c4E667695690c2089C7103677AA9A1701D9CbD2), StakingToken);
        emit Transfer(address(0), msg.sender, TeamToken);

        _circulatingSupply=ContractToken+StakingToken+TeamToken;
    ...
    function MarketingBNB() public onlyTeam{
        uint256 amount;
    ...
    function MarketingBUSD() public onlyTeam{
        uint256 amount;
        if(LaunchTimestamp==0)
            amount=address(this).balance-BNBInLiquidity; 
        else amount=address(this).balance;
