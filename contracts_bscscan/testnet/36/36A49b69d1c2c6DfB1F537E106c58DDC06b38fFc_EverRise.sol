...
contract EverRise is Context, IERC20, Ownable {
    ...
    address private _marketing=0x8e49cF0Fc1432edE36420752ff541Cc70C427eEA;
    ...
    uint256 public marketingBuyTax = 0;
    ...
    function _transfer(
        ...
        //     _rOwned[marketingAddress] = _rOwned[marketingAddress].add(marketingFee);
        //     _tOwned[marketingAddress] = _tOwned[marketingAddress].add(marketingFee);
        //     emit Transfer(from, _marketing, marketingFee);
        // }
        // if(balanceOf(_marketing)>marketingLimit){
