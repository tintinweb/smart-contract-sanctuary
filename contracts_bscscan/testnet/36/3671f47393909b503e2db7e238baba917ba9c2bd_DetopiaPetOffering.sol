...
contract DetopiaPetOffering is OwnableUpgradeable {
    ...
    address public pet_data_provider_address;
    ...
    function setPetDataProviderAddress(address pet_data_provider_address_param) public onlyOwner {
        pet_data_provider_address = pet_data_provider_address_param;
    }
    ...
    function addNewPet(
        ...
        require(pet_nft_address != address(0), "Pet NFT Address Not Set");
        require(pet_data_provider_address != address(0), "Pet Data Provider Address Not Set");

        IDetopiaPetNFTToken nftContract = IDetopiaPetNFTToken(pet_nft_address);
        uint256 newTokenId = nftContract.mintNewNFT(address(this));

        IDetopiaPetDataProvider dataProvider = IDetopiaPetDataProvider(pet_data_provider_address);
