...
pragma solidity ^0.6.12;
    ...
    contract RakuCoin is Context, IERC20, Ownable {
        ...
        constructor (address payable MarketingPoolWalletAddress,address payable StakePoolWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // PancakeV2 for BSC network
    ...
    // List of front-runner & sniper bots from t.me/FairLaunchCalls
        ...
        require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We can not blacklist Uniswap router.');
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if(sender != owner() && recipient != owner() && recipient != uniswapV2Pair && recipient != address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1) 
            ...
            if (block.timestamp < launchTime + 5 seconds) {
                ...
                && sender != address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1)
                    && sender != address(uniswapV2Router)) {
