...
contract LUTF is IBEP20, LUTFAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Lutf Coin";
    string constant _symbol = "LUTF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply =5000000000000000000; //5 billion
    uint256 public _maxTxAmount = _totalSupply / 200000; // 2%

    // @dev  added max hold so that no single wallet can hold more than 10%.
    uint256 public _maxHold = _totalSupply / 200; // 2 %
    ...
    address public marketingFeeReceiver =0x4072E226D21644eE049f8B37637a8b12436B69af ;
    address public buybackFeeReceiver =0xD27f94963A1d36bC1FAB138d0b0c44C975f3A0F4 ;
    ...
    uint256 public swapThreshold = _totalSupply / 500000; // 2%
    bool inSwap;
    ...
    constructor () LUTFAuth(msg.sender) {
