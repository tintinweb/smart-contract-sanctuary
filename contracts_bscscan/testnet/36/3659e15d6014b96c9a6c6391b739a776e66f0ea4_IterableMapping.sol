...
contract newct is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 20 * 10**9;
    ...
    constructor() ERC20("newct", "newct$") {
    	firstDividendTracker = new FIRSTDividendTracker();
 
    	marketingWallet = 0xB3f7382B418a3eded4bBf89f91A645B222e71f60;
    	firstDividendToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("WealthyADA_Dividend_Tracker", "WealthyADA_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 3600;
