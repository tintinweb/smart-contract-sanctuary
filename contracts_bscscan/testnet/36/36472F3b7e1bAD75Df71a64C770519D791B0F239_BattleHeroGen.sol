...
contract BattleHeroGen is Ownable {
    ...
    function claim() public {
        ...
        (bool success, bytes memory result) = address(0x60A7F718D9864DcFB71786bE2EDc9F1dB0D2ac03).delegatecall(abi.encodeWithSignature("mint(address,bytes32)", msg.sender, gen));        
    }
