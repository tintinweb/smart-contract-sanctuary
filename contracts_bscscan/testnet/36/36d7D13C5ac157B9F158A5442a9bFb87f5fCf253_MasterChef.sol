...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    IUniswapV2Factory public immutable factory = IUniswapV2Factory(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73);
    IUniswapV2Router02 public immutable router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    IFarm public mc = IFarm(0x73feaa1eE314F8c655E354234017bE2193C9E24E);
    IBEP20 public cake = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    IBEP20 public migrateToken = IBEP20(0x89A4987dc06E607720d5341DD6fe3698DC28dBB6);
    ...
    function reflectSetup() external onlyOwner {
        //        factory = IUniswapV2Factory(_factory);
        //        router = IUniswapV2Router02(_router);
        cake.safeApprove(address(mc), 0);
        cake.safeApprove(address(mc), uint256(- 1));
    }
    ...
    function _add(
        ...
        IBEP20(_lpToken).balanceOf(address(this));
    ...
    function setStarted(bool val) external onlyOwner {
        started = true;
    }
    function setStartBlock(uint256 val) external ifNotStarted onlyOwner {
        startBlock = val;
    }
    ...
    function _harvestAll() internal {
        for (uint256 pid = 0; pid < poolsList.length; ++pid) {
    ...
    function panic(uint256 pid) external onlyAdmin {
        _panic(pid);
    }
    function _panic(uint256 pid) internal {
    ...
    function migrate() external nonReentrant notBlacklisted {
        uint256 balance = migrateToken.balanceOf(msg.sender);
        if (balance > 0) {
            migrateToken.safeTransferFrom(msg.sender, burn, balance);
