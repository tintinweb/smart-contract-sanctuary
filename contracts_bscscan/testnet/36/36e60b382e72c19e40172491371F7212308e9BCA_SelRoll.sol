...
// SelRoll helps your migrate your existing Uniswap LP tokens to BitrielSwap LP ones
contract SelRoll {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'SelRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'SelRoll: INSUFFICIENT_B_AMOUNT');
    }
