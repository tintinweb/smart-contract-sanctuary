    ...
    AcceptedToken
{
    ...
    modifier onlyNotBlacklist(uint256 warriorId) {
        require(blacklist[warriorId] == false, "WaW: blacklisted");
        _;
    }
    ...
    function buy(uint256 warriorId, uint expectedPrice)
        external
        payable
        override
        onlyNotBlacklist(warriorId)
    ...
    function acceptOffer(uint256 warriorId, address buyer, uint expectedPrice)
        external
        override
        nonReentrant
        onlyWarriorOwner(warriorId)
        onlyNotBlacklist(warriorId)
    {
        ...
        require(buyer != seller, "WAW: invalid buyer");
