...
contract Entity is SuperAdmin {
    ...
    function addEmployeeToEntity(string memory entityId, string memory userMappingId, string memory role) public {
        entityUsers.push(EntityUser(
            entityId,
            userMappingId,
            role,
            "viewer",
    ...
    // add admin to entity
    function addAdminToEntity(string memory entityId, string memory userMappingId, string memory role) public {
        entityUsers.push(EntityUser(
            entityId,
            userMappingId,
            role,
