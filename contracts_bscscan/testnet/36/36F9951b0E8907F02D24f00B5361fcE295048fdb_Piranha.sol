...
contract DividendDistributor is IDividendDistributor {
    ...
    function claimDividend(address account) external {
...
contract Piranha is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Piranha";
    string constant _symbol = "PIRANHA";
    ...
    function deadCRYPTOVENGERS() external view returns(uint256) {return IBEP20(address(this)).balanceOf(DEAD); }
	...
	if(!selling){require(amount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");}
    ...
    function PIRANHA(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function delaysettings(bool SDEnable, uint256 SDTime) external authorized {
