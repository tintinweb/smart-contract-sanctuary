...
contract ParallelToken is ERC20, ERC20Snapshot, AccessControl, Pausable {
    ...
    constructor() ERC20("Parallel Token", "PRL") {
    ...
    function _initPair() private {
        ...
        pancakePair = pancakeFactory.createPair(
            address(this),
            0x54EbEe6d60a012b5DCfdDe698418992CC4Be7760
        );
    }

    function snapshot() public onlyRole(VOTE_ROLE) returns (uint256) {
        return _snapshot();
    }
