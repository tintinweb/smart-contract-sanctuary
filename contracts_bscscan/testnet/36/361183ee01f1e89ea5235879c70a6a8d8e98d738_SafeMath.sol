...
contract CryptoCowboys is Context, IERC20, IERC20Metadata,Ownable {
  ...
  string private _name = "CryptoCowboys";
  string private _symbol = "CCS";
  uint256 private _initSupply = 1000000000*10**18;

  uint256 public dexTaxFee = 10; //take fee while sell token to dex
