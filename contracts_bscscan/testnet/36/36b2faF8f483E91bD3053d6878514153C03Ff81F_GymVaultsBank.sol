...
contract GymVaultsBank is ReentrancyGuard, Ownable, Relationship {
    ...
    address public constant routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // PancakeSwap: Router
    ...
    constructor(
        ...
        buyBack = 0x7f6e5c88F829fC9Dd0ce496b29f826dB40b5E5C8;
        totalAllocPoint = 0;
    ...
    function _deposit(uint256 _pid, uint256 _wantAmt, bool _isToken) private {
        ...
        if (_wantAmt > 0) {
            ...
            pool.want.safeTransfer(0x7f6e5c88F829fC9Dd0ce496b29f826dB40b5E5C8, _wantAmt * BUY_AND_BURN_GYM / 100);
        ...
        if (_wantAmt > 0) {
            ...
            if (_wantAmt > 0) {
                if(_isToken){
                    ...
                    IWETH(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).withdraw(_wantAmt);
