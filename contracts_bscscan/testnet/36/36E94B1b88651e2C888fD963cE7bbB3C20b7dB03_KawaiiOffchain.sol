...
contract KawaiiOffchain is Signed, Pausable, SignData {
    ...
    event Offchain(address indexed sender);
    ...
    function convertOffchain(bytes memory data) external whenNotPaused {
        ...
        );
        {
            ...
            address signer = getSigner(
                keccak256(
                    abi.encode(address(this), this.convertOffchain.selector, sender, _inputBurnNFTIds, _inputBurnAmounts, _inputNFTIds, _inputAmounts, _timestamp, nonce)
                ), v, r, s);
