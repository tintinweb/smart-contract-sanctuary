...
contract SecuredMoonRat is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 10 ** 6 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Secured XDAI";
    string private _symbol = "SD1";
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 30 minutes;
        rewardCycleBlock = 7 minutes;
