...
contract BullDogGo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9cE4d850B57995Ee80319534917458b698feeD1c); // Marketing Address
    ...
    string private _name = "BullDogGo";
    string private _symbol = "GODOGE";
