...
contract LANCV22 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x3C35BabBAbA4636881C37A7c4cd0965d26Ff00CC;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 350 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Lancv22";
    string private _symbol = "lanc22";
