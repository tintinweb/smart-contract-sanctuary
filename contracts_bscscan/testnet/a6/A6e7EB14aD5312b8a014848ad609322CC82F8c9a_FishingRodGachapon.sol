...
// File contracts/interfaces/IFishingRod.sol
...
// File contracts/FishingRodGachapon.sol
...
contract FishingRodGachapon is Ownable {
    using SafeERC20 for IERC20;

    event Purchase(address indexed buyer, uint256 tokenId);

    IERC20 public token;
    IFishingRod public fishingRod;
    ...
    constructor(
        ...
        token = IERC20(_token);
        fishingRod = IFishingRod(_fishingRod);
