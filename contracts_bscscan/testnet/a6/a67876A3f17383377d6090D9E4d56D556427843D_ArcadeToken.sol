...
contract ArcadeToken is ERC20, Ownable {
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    ...
  	    require(multiplier >= 100 && multiplier <= 200, "Arcade Token: Sell transaction multipler must be between 100 (1x) and 200 (2x)");
  	...
  	function setMarketingDivisor(uint256 divisor) external onlyOwner {
  	    ...
  	    require(divisor >= 0 && divisor <= 100, "Arcade Token: Marketing divisor must be between 0 (0%) and 100 (100%)");
