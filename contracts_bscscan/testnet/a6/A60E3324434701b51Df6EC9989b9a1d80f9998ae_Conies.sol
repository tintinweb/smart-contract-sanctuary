 ...
 *
 * Project-name: conies
 * Network-Deployment: Fantom (chain ID 250)
 * Website: https://www.MyLittleConies.com/
 * Discord: https://discord.gg/aauYsFHv2E
 * Twitter: https://twitter.com/mylittleconies
 *
 */
...
contract Conies is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
 ...
 */
  ...
  constructor() ERC721("My Little Conies", "CONIES") { // address _main, address _one, address _two, address _three
    // init of all variables
    tokenCounter = 0;
    mintFee = 1 * 10**18; // 100 FTM
    maxMint = 10000; // Total Amount
    royaltyFee = 5; // as a percentage
    royaltyAddress = msg.sender; // 0x2C36989E4499361635708D382519C51869A20410;
    devAddress = msg.sender;
    enableMinter = true;
    directory = "QmUh1a2gM1gv7QijUH1ywSEtpmt8awcjxc4WiwCpPwYWiF/";
    mainPayment = msg.sender; // 0x2C36989E4499361635708D382519C51869A20410;
    gandmPaymentOne = msg.sender;
    gandmPaymentTwo = msg.sender;
    gandmPaymentThree = msg.sender;
  ...
  function paymentSplitter(uint256 _amount) internal {
    uint256 firstPayment = _amount / 10; // 10%
    uint256 secondPayment = _amount / 20; // 5%
    uint256 leftOver = _amount-firstPayment-secondPayment-secondPayment; // remaining 80%
    payable(mainPayment).transfer(leftOver);
    payable(gandmPaymentOne).transfer(firstPayment);
    payable(gandmPaymentTwo).transfer(secondPayment);
    payable(gandmPaymentThree).transfer(secondPayment);
  }
 ...
 */
  ...
  function devSetPayments(address _one, address _two) public onlyDev {
