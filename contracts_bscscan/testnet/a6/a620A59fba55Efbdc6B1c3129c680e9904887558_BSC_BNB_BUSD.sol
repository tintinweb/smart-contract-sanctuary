...
contract BSC_BNB_BUSD{
	...
	// BNB->BUSD, pancake exchange should exist, BUSD token address: 0xed24fc36d5ee211ea25a80239fb8c4cfd80f12ee,  pancake router: 0xd954551853F55deb4Ae31407c423e67B1621424A , BNB address: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd BUSD address: 0xed24fc36d5ee211ea25a80239fb8c4cfd80f12ee
	...
	function buyEggs(address ref) public payable{
		...
		eventId++;
		emit Evt_inputs(eventId, msg.value, _amount );
    }
	...
	function getBalances(address adr) public view returns(uint256, uint256, uint256,uint256,uint256) {
		return ( 0, ocApp.balanceOf(address(adr)), ic[adr], icc[adr], oc[adr]);
	}
