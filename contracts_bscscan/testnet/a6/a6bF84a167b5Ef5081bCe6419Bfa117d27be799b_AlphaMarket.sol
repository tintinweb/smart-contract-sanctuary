...
contract AlphaMarket is Ownable, Lockable {
    ...
    onlyAlphalist(msg.sender) {
        ...
        uint256 _prinAmount = calculator.principleAmount(_amount, marketPrice, aZJH.decimals());
    ...
    onlyAlphalist(msg.sender) {
        ...
        aZJH.safeTransfer(msg.sender, _amount);
    ...
    function reclaim() external onlyOwner() {
        ...
        uint256 azjhAmount = aZJH.balanceOf(address(this));

        aZJH.safeTransfer(address(treasury), azjhAmount);
