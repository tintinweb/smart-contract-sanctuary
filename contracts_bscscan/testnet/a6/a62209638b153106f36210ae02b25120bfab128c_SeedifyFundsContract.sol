...
contract SeedifyFundsContract is Ownable {
  ...
  // CONSTRUCTOR  
  constructor(uint _maxCap, uint256 _saleStartTime, uint256 _saleEndTime, address payable _projectOwner, uint256 _tierOneValue, uint256 _tierTwoValue, uint256 _tierThreeValue, uint _tierOneMinValuePerUser,
              uint _tierTwoMinValuePerUser, uint _tierThreeMinValuePerUser,uint256 _tierOneUsersValue, uint256 _tierTwoUsersValue, uint256 _tierThreeUsersValue,uint _totalparticipants) public {
    maxCap = _maxCap;
    ...
    minAllocaPerUserTierOne = _tierOneMinValuePerUser;
    minAllocaPerUserTierTwo = _tierTwoMinValuePerUser; 
    minAllocaPerUserTierThree = _tierThreeMinValuePerUser;
  ...
  receive() external payable {
    ...
    if (getWhitelistOne(msg.sender)) { 
      ...
      require(buyInOneTier[msg.sender] + msg.value <= maxAllocaPerUserTierOne ,"buyTokens:You are investing more than your tier-1 limit!");
           require( minBuyInOneTier[msg.sender] + msg.value >= minAllocaPerUserTierOne , "your purchasing Power is so Low") ;   
      ...
      require( minBuyInTwoTier[msg.sender] + msg.value >= minAllocaPerUserTierTwo , "your purchasing Power is so Low") ;   
      ...
      require( minBuyInThreeTier[msg.sender] + msg.value >= minAllocaPerUserTierThree , "your purchasing Power is so Low") ;   
