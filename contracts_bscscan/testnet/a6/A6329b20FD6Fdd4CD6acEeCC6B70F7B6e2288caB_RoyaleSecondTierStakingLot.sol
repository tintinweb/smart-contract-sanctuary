...
contract StakingLot is ERC20, IStakingLot, ERC1155Receiver, Ownable {
    ...
    uint public constant LOT_PRICE = 1000 * 10**18;
    uint public constant DISCOUNTED_LOT_PRICE = 800 * 10**18;
...
contract RoyaleSecondTierStakingLot is StakingLot, IStakingLotERC20 {
    using SafeERC20 for IERC20;
    using SafeMath for uint;
    ...
    constructor(ERC20 _token, ERC20 usdc, RoyaNFT rnft, address _multisigWallet) public
        StakingLot(_token, "SROYA", "sRoya", rnft, _multisigWallet) {
        USDC = usdc;
    }
