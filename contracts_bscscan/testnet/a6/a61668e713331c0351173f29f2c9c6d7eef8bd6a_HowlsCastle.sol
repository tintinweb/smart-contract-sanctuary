...
contract HowlsCastle is Ownable, ReentrancyGuard {
    ...
    //call source String
    bytes32 internal callSource = "internal";
    ...
    function deposit(uint256 _pid, uint256 _amount, bool _boost, bytes32 _callSource, address _referrer) public nonReentrant {
        PoolInfo storage pool = poolInfo[_pid];
    ...
    function setCallSource(bytes32 _callSource) public onlyOwner {
