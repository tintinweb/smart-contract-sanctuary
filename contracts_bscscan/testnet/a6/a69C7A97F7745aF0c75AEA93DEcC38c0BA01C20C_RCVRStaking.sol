...
contract RCVRStaking is Context, Ownable {
    ...
    address public RCVRAddress;
    address public Owner;
    address public liquidtycontract;
    address public burnaddress = 0x000000000000000000000000000000000000dEaD;
    address public USDTAddress = 0x55d398326f99059fF775485246999027B3197955;
    address payable public autoLPcontract; //Contract for autpsend of Eth
    address payable public payee;
    address payable public charity = 0xee5f9D777479A0FFC1Fedde04d375824C48c9456;
    address public rcvrlpcontract;
    ...
    uint public treasuryrcvr = 20; //default to 5%
    uint public treasurybnbfee = 2000000000000000; //Default to 0.005
    uint public safeinterval = 89; //Default interval for safe timer
    ...
    uint public numhoursforreflect = 4; //Default = 4. Valid options are 2,4,8,12,24
    ...
    uint public whalelimit = 100e18; //Default to 100
    uint public whalereward = 100e18; //Limit the reward payout to 100
  ...
  function returnRCVRTokens(bool _returnall,uint _amountOfRCVR) public onlyOwner{
   ...
   function rebase(bool _fromforced,bool _isRisky) private {
       ...
       uint riskyprice = riskyoldprice + 1;
  ...
  function autoTriggerRebase() public{
      ...
      {
          if (block.timestamp > lastreflection + 1 minutes)
          {
              reflectBNB();
          }
      }
  ...
  function enableRebase(bool _onoroff) public onlyOwner
  {
   ...
   function reflectBNB() public {
    ...
    uint USDTPrice = 3490865588578880;
    uint RCVRPrice = 33422183972720;
       ...
       for (uint256 s = 0; s < stakeholders.length; s += 1){
          address stakeholder = stakeholders[s];
           ...
           amountoftokens = walletbalance.div(1000000000000000000);
           RCVRwalletinUSDT = RCVRPrice.mul(amountoftokens);
           if (RCVRwalletinUSDT >= inflatedprice)
           {
               canreflect[stakeholder] = true;
               numreflectors +=1;
           }
           if (RCVRwalletinUSDT < inflatedprice) //ensure the user doesnt stay being able to reflect
           {
       ...
       BNBsplit = address(this).balance.div(100); //divides it into 1% splits
       ...
       shareofBNB = amounttoreflectors.mul(1000000000000000000);
       for (uint256 s = 0; s < stakeholders.length; s += 1){
