...
contract Test1J is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdaAc948B0A920411Fd8D3Be56F531cfF591dfC8E); // Marketing Address
    ...
    string private _name = "HDtest1";
    string private _symbol = "deptesth2";
