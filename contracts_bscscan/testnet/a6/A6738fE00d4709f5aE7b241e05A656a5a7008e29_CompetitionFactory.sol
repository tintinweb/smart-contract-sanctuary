...
contract CompetitionFactory is Ownable {
    ...
    {
        return
            IFactory(typeToAddress[CompetitionType.RegularCompetition])
                .createCompetitionContract(_owner, _creator);
    }
    ...
    {
        return
            IFactory(typeToAddress[CompetitionType.P2PCompetition])
                .createCompetitionContract(_owner, _creator);
    }
}
