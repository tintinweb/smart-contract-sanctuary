...
contract SmartToken is Context, IBEP20, Ownable {
    ...
    */
        ...
        if (_excludedFromFee[sender] || _excludedFromFee[recipient]) {
            ...
            if(sender == _intermediaryAddress && toPair) {
                ...
                if (recipient == _intermediaryAddress) {
                    ...
                    uint256 taxAmount = amount.mul(_getCurrentSellTax().mul(700).div(1000)).div(100);
                    ...
                    uint256 taxAmount = amount.mul(_buyTaxFee.mul(700).div(1000)).div(100);
                    uint256 recvAmount = amount.sub(taxAmount);
                    _balances[recipient] = _balances[recipient].add(recvAmount);
     ...
     */
    function _getCurrentSellTax() private view returns (uint256) {
