...
contract AuctionHouse is IAuctionHouse, ReentrancyGuard, Ownable {
    ...
    function setCollectionApproval(address collectionAddress, bool isApproved)
        public
        onlyOwner
    {
    ...
    function setPlatformWallet(address _platformWallet, uint8 _curatorFeePercentage)
        public
        onlyOwner
    {
        ...
        nonReentrant
    {
        ...
        if (
            amount >= auctions[auctionId].buyNowPrice &&
            auctions[auctionId].buyNowPrice != 0
        ) {
