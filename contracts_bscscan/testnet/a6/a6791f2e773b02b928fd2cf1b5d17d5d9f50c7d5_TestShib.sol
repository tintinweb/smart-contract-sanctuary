...
contract TestShib is Context, IBEP20, Ownable {
    ...
    string private _name = "NyanTest";
    string private _symbol = "NYTEST";
    ...
    address public MarketingWallet = 0x2d5D62bC47345476a726FE2b1725A35309a41281; // Marketing Wallet address Here ....
    ...
    constructor ()  {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);// Testnet addres
     // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);// Mainnet addres
