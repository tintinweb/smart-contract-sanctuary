...
/**
   DogeBUSD is a token that rewards holders with BUSD. We know that everyone is sick of scams
   and we will burn the LP and the we will be transparent.
   
   6% reflections in BUSD
   4% fee auto add to the liquidity pool when selling
   2% marketing fee
...
contract DogeBUSD is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address MAAA = 0xb3fb45224E9807D085Ac81B47f37f643A08C5E14;

    string constant _name = "DogeBUSD";
    string constant _symbol = "DogeBUSD";
