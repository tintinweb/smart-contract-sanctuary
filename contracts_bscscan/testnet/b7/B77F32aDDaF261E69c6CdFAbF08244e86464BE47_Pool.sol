...
contract Pool is Ownable, ReentrancyGuard {
    ...
    uint256 public depositLimitInDollar;
    ...
    constructor(
        ...
        address _variablesContractAddress,
        ...
        variablesContractAddress = _variablesContractAddress;
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        uint256 depositLimitInCWOLF = Variables(variablesContractAddress).getDollarsInCWOLF(depositLimitInDollar);
        require(_amount <= depositLimitInCWOLF, "Amount exceeds limit");
        PoolInfo storage pool = poolInfo[_pid];
    ...
    function setVariablesAddress(address _newVariablesContractAddress) external onlyOwner {
        variablesContractAddress = _newVariablesContractAddress;
    }

    function setDepositLimitInDollar(uint256 _newDepositLimitInDollar) external onlyOwner {
        depositLimitInDollar = _newDepositLimitInDollar;
    }

    function changePoolLockupDuration(uint256 _pid, uint256 _newLockupDuration) external onlyOwner {
        PoolInfo storage pool = poolInfo[_pid];
        pool.lockupDuration = _newLockupDuration;
    }
}
