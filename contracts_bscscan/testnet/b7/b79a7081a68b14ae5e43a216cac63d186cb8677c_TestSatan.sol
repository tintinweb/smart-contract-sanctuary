...
contract TestSatan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0xA7939676359641e6dA69B70F3AbA503d84749d7F); // Marketing Address
    ...
    string private _name = 'TESTSATAN';
