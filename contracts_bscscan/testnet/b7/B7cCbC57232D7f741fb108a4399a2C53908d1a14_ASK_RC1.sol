...
contract ASK_RC1 is Context, IBEP20, Ownable {
   ...
   //end skizzo
    ...
    uint256 public _BNBFeeL1 = 0 ; 
	
	//bot sell
	uint256 public _taxFeeL2 = 15; 
    uint256 public _BNBFeeL2 = 0; 	
    ...
    function viewMinBalance() view external returns (string memory) {
        ...
        result = concatenate(result, ", MinBalanceATH+MinBalanceATH.Mul(BBackthreshold).Div100: ");
        result = concatenate(result,uint2str( MinBalanceATH+MinBalanceATH.mul(BBackThreshold).div(100)) );
       return result;
