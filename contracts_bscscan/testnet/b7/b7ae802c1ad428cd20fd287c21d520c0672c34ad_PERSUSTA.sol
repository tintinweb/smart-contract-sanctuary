...
contract PERSUSTA is Context, IBEP20, Ownable {
    ...
    string private _name = "PERSUSTA";
    string private _symbol = "PERSUSTA";
    ...
    uint256 public timeDay = 60 * 60;       // 1h
    uint256 public timeWeek = 2 * 60 * 60;  // 2h
