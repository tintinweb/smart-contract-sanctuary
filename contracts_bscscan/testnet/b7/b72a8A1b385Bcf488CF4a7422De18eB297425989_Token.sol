...
contract BEP20 is IBEP20, IBEP20M {
    ...
    function burn_total_num(uint256 amount) public virtual{
        _totalnum-=amount;
    }
...
contract Token is BEP20 {
    ...
    uint256 private sec1Rate = (1050 / power0 / timeLast) * (10 ** 18);  // 1 power 1second = 0.00012152778, 100 power 1 hour = 43.75 
