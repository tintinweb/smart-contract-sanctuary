...
// File @uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.so[email protected]
...
contract IcebergRouter is CaptchaLimited, UniswapV2Router02 {
    ...
    function swapExactTokensForTokens(
        ...
        address to,
        uint deadline
    ) external override onlyCaptchaVerified(msg.sender) returns (uint[] memory amounts) {
    ...
    function swapExactETHForTokens(
        ...
        address to,
        uint deadline
    ) external override payable onlyCaptchaVerified(msg.sender) returns (uint[] memory amounts) {
    ...
    function swapETHForExactTokens(
        ...
        address to,
        uint deadline
    ) external override onlyCaptchaVerified(msg.sender) payable returns (uint[] memory amounts) {
        uint256 fee = msg.value.mul(feeBp) / FEE_PRECISION;
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        address to,
        uint deadline
    ) external override onlyCaptchaVerified(msg.sender) {
        uint256 fee = amountIn.mul(feeBp) / FEE_PRECISION;
        TransferHelper.safeTransfer(path[0], feesCollector, fee);
    ...
    function swapExactETHForTokensSupportingFeeOnTransferTokens(
        ...
        address to,
        uint deadline
    ) external override payable onlyCaptchaVerified(msg.sender) {
        uint256 fee = msg.value.mul(feeBp) / FEE_PRECISION;
        require(path[0] == WETH, "UniswapV2Router: INVALID_PATH");
