...
contract start2 is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "start2";
	string private _symbol = "start2";
	...
	function includeBot(address account) public onlyOwner {
	...
	function _transfer(
		...
		require(_isBot[from] == false, "Something went wrong");
