...
contract CT1 is ERC20, Ownable {
    ...
    constructor() ERC20("CT v4", "CT4") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(uniswapRouterV2Address); //updated to use variable for the address
        ...
        minimumTokensAmountInContract = 500 * 1e18; // updated
        ...
        _isExcludedFromContractBuyingLimit[uniswapRouterV2Address] = true;
        ...
        if(limitsInEffect){
            if (
                ...
                //when transfers to another wallet?
                    ...
                    require(amount + balanceOf(to) <= maxWallet, "Max wallet exceedede");
                }
            }
        }
