...
// MOMO TOKEN 
// https://kryptomomo.com/
// [email protected]
// https://twitter.com/Krypto_MoMo
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15f248716E022CaF1fD8451A941B7bd00D6D8004;
...
contract KryptoMomo is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8675B53036Bca627F24B971E3031DFce1e851E50;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 600000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MOMO";
