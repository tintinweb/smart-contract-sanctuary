...
contract HOTGame{
    ...
    function Auth() public {
        ...
        peoples[msg.sender].block = block.number;
    }

    
    function sendCoins(uint256 amount) public {
         hotgAddress.safeTransferFrom(
            address(msg.sender),
