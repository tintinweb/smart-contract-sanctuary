...
contract TEST is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 10 * 100**8; //100 Million
    uint256 private numTokensSellToAddToLiquidity = 10 * 100**8; //100 Million
    uint256 public _maxWalletToken = 10 * 100**8; // .3% of total supply
