 ...
 */
 ...
 contract Test01 is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable {
     ...
     constructor() ERC721("Test01", "T01") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x6350755312348c3A448F1105315E496BFdF7Ca30); 
          _setupRole(MINTER_ROLE, 0x6350755312348c3A448F1105315E496BFdF7Ca30); 
          _setupRole(MINTER_ADMIN_ROLE, 0x6350755312348c3A448F1105315E496BFdF7Ca30); 
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x6350755312348c3A448F1105315E496BFdF7Ca30);  
     }
     ...
     function mint_by_id(address to, uint256 tokenId) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "T01/minter-role-required");
         _mint(to, tokenId);
     }      
     /**
