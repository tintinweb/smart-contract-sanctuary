...
contract Test is TRC20, TRC20Pausable, CoinFactory, Blacklist {
    ...
    function fundTransferFrom2(address token, address from, address to, uint value) public returns (bool){
