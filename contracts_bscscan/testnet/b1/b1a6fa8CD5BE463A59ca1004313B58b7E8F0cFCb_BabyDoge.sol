...
import './resources/IERC20.sol';
import './resources/SafeMath.sol';
import './resources/SafeMath.sol';
import './resources/Address.sol';
import './resources/IUniswapV2Factory.sol';
import './resources/IUniswapV2Router01.sol';
import './resources/IUniswapV2Router02.sol';
import './resources/IUniswapV2Pair.sol';
...
contract BabyDoge is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = 0x8A655a72ab6927DF82d720D0da71bdDd6490f10d;
    ...
    uint256 public _maxTxAmount = 300000000000000000000000000;

    uint256 public numTokensSellToAddToLiquidity = 210000000000000000000000;
    ...
    constructor () public {
        ...
        //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 - pancake
    ...
    function setMarketingFee(uint256 marketingFee) public onlyOwner {
        require(_liquidityFee > marketingFee, "Marketing fee gotta be smaller then liquidity fee");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingTokenBalance = contractTokenBalance.div(_liquidityFee).mul(_marketingFee);
