...
contract WTF is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    //to receive TRX from pancakeRouter when swapping
    ...
    function _transfer(
        ...
        if (
            ...
            if (
                ...
                // swap TESTE into ETH to add to liqudity
    ...
    function calculateTRXReward(address ofAddress)
        public
        view
        returns (uint256)
    {
    ...
    function getTRXReward(
        uint256 currentBalance,
        uint256 currentTRXPool,
        uint256 tSupply
    ) private pure returns (uint256) {
        uint256 TRXPool = currentTRXPool;
    ...
    function claimTRXReward() public isHuman nonReentrant {
        require(
        ...
        require(
            ...
            "Error: must own TESTE to claim reward"
        );

        uint256 reward = calculateTRXReward(msg.sender);
