...
contract FlokiTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingAddress = payable(0x9b4Fcac810d56D02e047AcF9b0c09726a86BCc1A); // Marketing Address
    ...
    string private _name = "FlokiTest";
    string private _symbol = "FLOKITEST";
