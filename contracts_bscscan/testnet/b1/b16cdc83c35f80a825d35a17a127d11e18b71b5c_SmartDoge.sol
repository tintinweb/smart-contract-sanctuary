...
/**
	...
	|  $$$$$$ | $$_  $$_  $$ |____  $$ /$$__  $$|_  $$_/  | $$  | $$ /$$__  $$ /$$__  $$ /$$__  $$
	 ...
	 /$$  \ $$| $$ | $$ | $$ /$$__  $$| $$        | $$ /$$| $$  | $$| $$  | $$| $$  | $$| $$_____/
	|  $$$$$$/| $$ | $$ | $$|  $$$$$$$| $$        |  $$$$/| $$$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$$
	 \______/ |__/ |__/ |__/ \_______/|__/         \___/  |_______/  \______/  \____  $$ \_______/
																			   /$$  \ $$          
																			  |  $$$$$$/          
																			   \______/           
   #SmartDoge
   ...
   500,000,000,000,000,000 total supply
   5,000,000,000,000,000 tokens limitation for trade, which is 1% of the total supply
...
contract SmartDoge is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 500000000000000000 * 10**18;
	
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Smart Doge Coin";
