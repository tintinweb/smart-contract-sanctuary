...
contract RuyiToken is Context, IERC20, Ownable {
    ...
    function _tokenTransferStandard(
        ...
        uint256 StakingPoolAmount = amount.sub(amount.mul(StakingPoolTax).div(100));
        uint256 marketingAmount = amount.sub(amount.mul(MarketingTax).div(100));
        uint256 AddToLiquidityAmount = amount.sub(amount.mul(LiquidityPoolTax).div(100));
