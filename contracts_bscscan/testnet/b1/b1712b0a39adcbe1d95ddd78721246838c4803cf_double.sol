...
contract double is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "double";                                           // name
    ...
    address payable public marketingWallet = payable(0x60A386794027071245f1535087015adE99f731E2);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xBBe737384C2A26B15E23a181BDfBd9Ec49E00248, 'We can not exclude Uniswap router.');
