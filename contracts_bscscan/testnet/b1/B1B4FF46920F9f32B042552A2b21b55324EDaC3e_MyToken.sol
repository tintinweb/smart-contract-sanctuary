...
contract MyToken is Context, IERC20, Ownable {
    ...
    address payable public develomentAddress = payable(0x611C17DA7943DF1F059A8BdAB5f7284cabB19cE5); // Develoment Address
	address payable public marketingAddress = payable(0xE8Ddc4325c9548fa27aC78218352e4d370E9C3eD); // Marketing Address
	...
	constructor() {
		...
		balanceOf[develomentAddress] = totalSupply * 5 / 100;
		balanceOf[marketingAddress] = totalSupply * 5 / 100;
