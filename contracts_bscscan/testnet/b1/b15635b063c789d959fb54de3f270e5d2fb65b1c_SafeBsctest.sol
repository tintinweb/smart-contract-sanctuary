...
contract SafeBsctest is Context, IERC20, Ownable {
    ...
    string private _name = "SafBsctest";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x15Cd8Cda3Acc6B23761eB8e36827Eff3AA708068, 'We can not exclude Uniswap router.');
