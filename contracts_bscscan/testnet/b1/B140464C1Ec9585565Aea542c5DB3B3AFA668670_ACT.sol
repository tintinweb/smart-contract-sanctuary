...
contract ACT is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Arcan Craft Token";
    ...
    uint256 public _DevelopmentFee = 200; // 2% of every transaction is sent to Development wallet
