...
contract MultiPad is IBEP20 {
    ...
    */
    ...
    modifier checkSaleValidations(address _userAddress, uint256 _value){
     ...
     require(_finalSoldAmount[_userAddress] >= saleMinimumAmount, "Total amount should be more than minimum limit");
     require(_finalSoldAmount[_userAddress] <= saleMaximumAmount, "Total amount should be less than maximum limit");
