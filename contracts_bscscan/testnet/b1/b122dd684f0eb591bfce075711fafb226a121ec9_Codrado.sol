...
contract Codrado is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xa03a89a1a31D76AdCFed977e174e7793D35Ae1c1); // Marketing Address
    ...
    string private _name = "Codrado Coin";
    ...
    uint256 private minimumTokensBeforeSwap = 20 * 10**9 * 10**9; 
