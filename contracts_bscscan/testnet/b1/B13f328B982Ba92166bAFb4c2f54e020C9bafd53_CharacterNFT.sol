...
contract CharacterNFT is ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable{
  ...
  function upStar(address _owner,uint256 _nftId) public onlyAcademyUpStar onlyOwner {
  ...
  function upRank(address _owner,uint256 _mainNftId, uint256 _materialNftId) public {
  ...
  function upExp(address _owner,uint256 _nftId,uint256 _exp) public onlyAcademyUpStar onlyOwner {
    Character memory character= getCharacter(_owner,_nftId);
