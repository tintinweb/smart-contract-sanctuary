...
contract MultiSig is Context {
    ...
    // @dev must be public for inheritance 
...
contract ADMIRE_Content_Coin is BEP20('ADMIRE Content Coin', 'ADMRSol6V5-2'){
    ...
    modifier NoContractsOn(address sender, address recipient) {
            ...
            if (
                _nocontracts_stopped = true 
                && (recipient.isContract() || sender.isContract())
    ...
    /**
     * This is for MultiSig whenNoContractsOff to just block contracts altogether without whitelisting
     * 
     * function Revoke_DisableContractBlocking(address sender) public onlyOwner whenNoContractsOff {
     *    _start_nocontracts(sender);
     *    }
     */
    
    function Revoke_DisableContractBlocking() public onlyOwner whenNoContractsOff {
        _start_nocontracts();
    }
