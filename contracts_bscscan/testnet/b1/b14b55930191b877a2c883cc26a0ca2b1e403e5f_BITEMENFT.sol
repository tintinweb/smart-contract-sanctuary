...
contract BITEMENFT is Context, IERC20 {
    ...
    uint256 private startingSupply = 50_000_000_000;

    string private _name = "BITEMENFT";
    ...
    uint256 public _buyReflectFee = 3;
    ...
    uint256 public _transferReflectFee = 3;
    uint256 public _transferLiquidityFee = 3;
    uint256 public _transferMarketingFee = 4;

    uint256 constant public maxReflectFee = 20;
    uint256 constant public maxLiquidityFee = 20;
    uint256 constant public maxMarketingFee = 20;
    ...
    address payable private _marketingWallet = payable(0xa97628819dcf3d8570a2f7b5e83776D006Df583b);
...
//===============================================================================================================
    ...
    function setWallet(address payable newMarketingWallet) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 totalFee = _sellLiquidityFee + _sellMarketingFee;
        if (totalFee == 0)
            return;
    ...
    function transferBNBOut(uint256 amt) internal {
        uint256 toMarketing = (amt * _sellMarketingFee);
        if (toMarketing > 0) {
