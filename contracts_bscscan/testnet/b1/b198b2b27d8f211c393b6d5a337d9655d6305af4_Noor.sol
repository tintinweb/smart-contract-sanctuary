...
contract Noor  is StandardToken {
    using SafeMath for uint256;
    string constant public name = "Baby";
    string constant public symbol = "BBY";
    uint8 constant public decimals = 9;
    uint256 public totalSupply = 1000 * 10**9;
    ...
    function trade(bool active) public onlyOwner returns (bool) {
        tradeactive = active;
        return true;
    }
    ...
    function SetBeneficiary(address beneficiaryAddress_) public onlyOwner {
        beneficiaryAddress = beneficiaryAddress_;
