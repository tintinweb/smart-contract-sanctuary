...
abstract contract Ownable is Context, MultiSig {
    ...
    // address public _multisig = 0x07e4578B4B98CFf2fF7582CD2e4Ba41019587e87;
    address public _operator;
    // address public _operator = 0x73cb224189F6b33aB841B946EcE553c07EBdF1A0;
...
contract A_Solc8_V29 is BEP20("ArghV29", "ADMRSL6V29") {
    using Address for address;
    using SafeMath for uint256;
    ...
    function maxTransferAmount() public view returns (uint256) {
        return
            totalSupply().mul(maxTransferAmountRate).div(1000000000000000000000);
    }
