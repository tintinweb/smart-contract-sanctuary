...
contract Token is Context, IBEP20, Ownable {
    ...
    address payable devWallet = payable(0x9E29c7be0530C192cE3F7759b57d52b9C1760c26);
    uint256 private limitTokensToDev = 100000 * 10**9;
    ...
    function _transfer(
        ...
        bool overMinTokenBalance = contractTokenBalance >= limitTokensToDev;
        if (
            overMinTokenBalance
        ) {
