...
contract Seedmon is ERC721EnumerableUpgradeable, TrustCallerUpgradeable {
    ...
    bytes32[] private targets;
    mapping(bytes32 => bool) private targetToActiveStatus;

    bytes32[] private aims;
    mapping(bytes32 => bool) private aimToActiveStatus;

    bytes32[] private baseActions;
    mapping(bytes32 => bool) private baseActionToActiveStatus;

    bytes32[] private names;
    mapping(bytes32 => SeedmonAttribute.Profile) private nameToProfile;
    mapping(bytes32 => SeedmonAttribute.Stat) private nameToStat;
    mapping(bytes32 => SeedmonAttribute.BaseAction) private nameToBaseAction;
    mapping(bytes32 => string) private nameToTokenURI;
    ...
    // TODO: try to combine all setup meta
