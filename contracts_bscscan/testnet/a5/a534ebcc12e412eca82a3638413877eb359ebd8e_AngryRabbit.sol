...
contract AngryRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "AngryRabbit";
    ...
    address public marketingWallet = 0xB83CF0D9F9f375A1a4E936927ce4E657623C7e47;
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public _maxTx = 1000000000000 * 10**18;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, 'We can not exclude Pancake router.');
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
     ...
     function swapTokensForEthMarketing(uint256 tokenAmount,address sender) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        ...
        _transferFromExcluded(sender, marketingWallet, tokenAmount);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _transferStandard(sender, address(0), burnAmt);
         ...
         swapTokensForEthMarketing(marketingAmt,sender); 
