...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    function setamount1(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function setamount2(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function excludeamount(address _account_) onlyOwner public {
