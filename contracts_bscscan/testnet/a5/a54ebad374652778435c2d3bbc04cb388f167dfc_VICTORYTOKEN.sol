...
ORIGINAL TOKENOMICS
Supply
Max Supply: 1,000,000,000,000,000 (one quadrillion billion) 
Buy tax
Tax: 10% (slippage 11%)
...
contract VICTORYTOKEN is BEP20, ReentrancyGuard {
    string public constant symbol = "VICTORY"; //VICTORY
    string public constant name = "VICTORY TOKEN"; 
    uint8 public constant decimals = 9;

    //1,000,000,000,000,000+18 zeros
    uint256 constant initialSupply = 1000000000000000000000000000000000; //1 qua tokens
...
//        __balanceOf[address(this)] = __totalSupply/2;
   ...
   AddTokentoPayoutList(address(this), "VICTORY"); //this contract token
