...
contract CoinToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if(takeFee){
            ...
            // tAmount = tAmount.sub(tAmount.div(100).mul(_destroyFee));
            _tokenO[sender] = _tokenO[sender].sub(tAmount.sub(tAmount.div(100).mul(_destroyFee)));
            _tokenO[recipient] = _tokenO[recipient].add(tAmount.sub(tAmount.div(100).mul(_destroyFee)));
        }else{
