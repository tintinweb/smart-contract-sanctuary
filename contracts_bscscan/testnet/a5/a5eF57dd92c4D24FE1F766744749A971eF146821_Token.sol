    ...
    ERC20Capped
{
     ...
     * @dev See {-_setupRole}.
     */
    function setupMintRole(address account_) public onlyOwner {
        _setupRole(MINTER_ROLE, account_);
    }

    /**
     * @dev See {-_setupRole}.
     */
    function setupPauseRole(address account_) public onlyOwner {
        _setupRole(PAUSER_ROLE, account_);
    }
