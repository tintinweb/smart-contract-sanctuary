...
contract PhoenixChain is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0x1CBF51F52396C74601F967F91BA62fB2AD194740;
    ...
    string private _name = "PhoenixChain";
    string private _symbol = "PCN";
    ...
    // Innovation for protocol by PhoenixChain Team
    ...
    uint256 public _liquidityFee = 10; // 4% will be added pool, 6% will be converted to BNB for a reward
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        */
        ...
        if (
            ...
            uint256 tokenAmountToBeSwapped = contractTokenBalance.mul(11).div(14);
