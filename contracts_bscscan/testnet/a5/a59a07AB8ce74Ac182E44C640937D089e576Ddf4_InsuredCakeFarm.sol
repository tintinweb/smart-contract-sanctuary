...
contract InsuredCakeFarm is Ownable, ReentrancyGuard {
    ...
    ERC20 constant public  cake = ERC20(0xbaAAB4BD7dA03921B9F682F6b65e564160b95E51);
    ERC20 constant public chips = ERC20(0xe332cC31B93cbC7F5cb46221ef51FE47A561F74e);
    ERC20 constant public wbnb = ERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    ERC20 constant public chipsLP = ERC20(0x1a43B06A0eD8735B7a27F8C5354A96b1434CfbF6);

    ChipsStaking constant public chipsStaking = ChipsStaking(0x4CF87a9FDd9306f80f64F46f2eA82192e9138D5B);
    SyrupPool constant public cakePool = SyrupPool(0x067F7Ea8037DE3B942390ca3c8d710FA6B931fc4);
    
    OracleSimpleBNBCake public cakeTwap = OracleSimpleBNBCake(0xA896545EE7D91A4B8Bb48bC782e6B74D81B2eA7f);
    OracleSimpleBNBchips public chipsTwap = OracleSimpleBNBchips(0xf96d1a97F881ff3BEbF5CbB4a892fEf0A7078E7c);
    UniswapV2 public pancake = UniswapV2(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    CookieGovernance public governance = CookieGovernance(0x9f493501B4bb326184068CDF917EFC09e287b62C);
