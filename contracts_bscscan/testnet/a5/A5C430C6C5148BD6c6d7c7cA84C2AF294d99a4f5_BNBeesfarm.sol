...
/*   BNBees Farming - Community Experimental yield farm on Binance Smart Chain.
 *   The only official platform of original BNBees team! All other platforms with the same contract code are FAKE!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://bnbees.farm                                        │
 *   │                                                                       │
 *   │   Telegram Public Chat: @bnbeesfarm                                   │
 *   │                                                                       │
 ...
 *   [FUNDS DISTRIBUTION]
 *
 *   - 96% Platform main balance, using for participants payouts, affiliate program bonuses
