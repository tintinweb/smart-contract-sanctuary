...
contract Coin is Operator {
    ...
    uint256 public constant maxSupply = 1000000000000000;
    ...
    constructor () public {
        ...
        IUniswapV2Factory factory = IUniswapV2Factory(0x6725F303b657a9451d8BA641348b6761A6CC7a17);
        address pair = factory.createPair(address(this),address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
)); 
        setFeeList(pair,true);

        setWhiteList(address(0xB6291fe9d172D4d4D47fB2Fa39Efe47abF8058D2),true);
    }
