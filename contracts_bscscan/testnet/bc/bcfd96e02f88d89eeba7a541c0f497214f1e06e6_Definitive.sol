...
//        emit Transfer(sender, recipient, amount);
    ...
    function provideFirstLP() external authorized {
        ...
        else if(amountTokenLiquidity < balanceOf(address(this))) { this.transfer(airdropfundAddress, balanceOf(address(this)).sub(amountTokenLiquidity));}
        ...
        lockLPTime = block.timestamp + 10 minutes; //lock LP for 400 days
        launch();
