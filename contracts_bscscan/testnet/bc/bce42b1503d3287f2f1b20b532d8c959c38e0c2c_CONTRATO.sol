...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Token-1";
    string internal constant SYMBOL = "TK-1";
...
abstract contract NOMEToken is BaseRfiToken, Liquifier, Antiwhale {
    ...
    uint256 weiToSend = 1000000000000000000;  // 1 BNB
    uint256 tokenToReceive = 10000000000;     
    using SafeMath for uint256;
