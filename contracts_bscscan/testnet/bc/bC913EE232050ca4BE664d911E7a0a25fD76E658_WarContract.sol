...
contract WarContract is Ownable {
    ...
    function processWarbotReturn ( uint256 _warbot, address _warbotowner ) internal {
    ...
    function goTurn ( uint256 _war , uint8 _option, uint256 _target, int8 _x, int8 _y, uint256 _cardnumber ) public {
        ...
        require ( _target < getBotsInWar(_war ).length, "Target Out of BotsInWar Array Bounds");
        require (  BotsInWar[ _war] [ _target] != BotsInWar[ _war] [ warbotOrderPointer[_war] ], "Warbot Cannot Target Self");
