    ...
    MarketplaceStorage
{
    ...
    function initialize(address _legacyNFTAddress) public initializer {
    ...
    function createItem(
        ...
        require(sender == assetOwner, "Only the owner can create item");
        require(
    ...
    function buyItem(
        ...
        require(item.price == price, "The price is not correct");
        require(
