...
contract KiBridgeV22b is KiBridgeV1Factory {
  ...
  function tokenOutTransferToUser(
    ...
    external 
    permittedTokenOutCheck(_token,this.tokenOutTransferToUser.selector)
  {
  ...
  function tokenOutMintToUser(
    ...
    external 
    permittedTokenOutCheck(_token,this.tokenOutMintToUser.selector)
  {
    userInfo[_user].tokenBalance[_token] -= _amount;
  ...
  modifier permittedTokenOutCheck(IERC20 _token, bytes4 _functionId) {
    require(
      tokenInfo[_token].tokenOutFunctionId == _functionId,
        "FunctionId Not Permitted"
    );
    _;
  }
