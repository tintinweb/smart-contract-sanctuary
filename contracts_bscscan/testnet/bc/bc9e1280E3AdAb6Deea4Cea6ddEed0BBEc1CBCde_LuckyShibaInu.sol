...
//
// There is a pot of gold at the end of every LUCKYSHIBAINU transaction
// 
// $LUCKYSHIBAINU has 9% tax split across 7 awesome protocols
// (Sells incurs 16% tax and DumpSells incurs 23%)
// 
// 3%: Lottery
// 1%: Burn
// 1%: Buyback
...
contract LuckyShibaInu is Context, IERC20, Ownable {
    ...
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for LUCKYSHIBAINU/WBNB
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $LUCKYSHIBAINU will be used to buy at maximum in any one trade
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts LUCKYSHIBAINU balance for buybacks, charity, liquidity and marketing
