...
contract Share is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuard {
    ...
    uint256 public taxRate; // buy back Dollar and add liquidity
    address public taxFund; // fund buy back Dollar
    ...
    function initialize(address _taxFund) public initializer {
        __ERC20_init("Share", "FBS");
        OwnableUpgradeable.__Ownable_init();

        require(_taxFund != address(0), "zero");
        taxFund = _taxFund;
        burnRate = 0; // 0%
        taxRate = 100; // 1% (0.5% to buyback Dollar, 0.5% to add liquidity)
        _isExcludedFromFee[_msgSender()] = true;
        _isExcludedToFee[_msgSender()] = true;
        _isExcludedFromFee[_taxFund] = true;
        _isExcludedToFee[_taxFund] = true;

        cap = 10000000000 ether;

        _mint(msg.sender, 25000000 ether); // for Treasury
    }
