...
/*
 * HiFi Gaming Society - Into the HiFi Verse Collection
 * App:             https://hifigamingsociety.org/
 * Medium:          https://hifigamingsociety.medium.com/
 * Twitter:        https://twitter.com/HiFiDeFi
 * Telegram:        https://t.me/HiFiGamingSocietyPlatform
 * Announcements:  https://t.me/HiFiGamingSocietyNews
 * GitHub:       https://github.com/HiFiDeFi-Finance
 */
...
contract Hifi is Context, AccessControlEnumerable, ERC721Enumerable, VRFConsumerBase {
...
/// @dev must be called by an account with MINTER_ROLE
    function mint() public virtual onlyRole(DEFAULT_ADMIN_ROLE) {
        requestRNG();
    }
