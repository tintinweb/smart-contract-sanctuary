...
contract Rucd is Context, IBEP20, Ownable {
    address public liquidityBank;
    uint256  public dividendPerToken;
    uint256 private DENOMINATOR = 10_000;
    uint256 private LIQUIDITY_PERCENT = 0;
    uint256 private ALL_HOLDER_PERCENT = 800;
    uint256 private BURN_PERCENT = 500;
    ...
    constructor () Ownable(0xEF4D80Ba953676cFd7e9FbD15F3D43a176A5E056) {
        require(0xEF4D80Ba953676cFd7e9FbD15F3D43a176A5E056 != address(0), "BEP20: transfer from the zero address");
        require(0xEF4D80Ba953676cFd7e9FbD15F3D43a176A5E056 != address(0), "BEP20: transfer from the zero address");
        liquidityBank = 0xEF4D80Ba953676cFd7e9FbD15F3D43a176A5E056;
        _totalSupply = 100 * 10 ** uint256(decimals());
        _name = "Rucd";
        _symbol = "DGH";
        _balances[0xEF4D80Ba953676cFd7e9FbD15F3D43a176A5E056] = _totalSupply;
        emit Transfer(address(0) , 0xEF4D80Ba953676cFd7e9FbD15F3D43a176A5E056, _totalSupply);
    }
