...
contract LiqsContract {
    ...
    function getWbnbRevenue() public view returns(uint) {
        return _wbnbRevenue;
    }
    ...
    function getOrder(address tokenAddress) public view returns(uint) {
        address payable getter = payable(msg.sender);
        return _orders[getter][tokenAddress];
    }
    ...
    function cancelOrder(address tokenAddress) public {
        ...
        _orders[canceling][tokenAddress] = 0;
        _order_length = _order_length - 1;
    }
