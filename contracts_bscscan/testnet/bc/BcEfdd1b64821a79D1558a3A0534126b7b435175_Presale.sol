...
contract Presale{
    ...
    uint256 public MAX_BUY_LIMIT = 350*1e18;
    
    uint256 public totalPresaleQuantity=7000 ether;

    mapping(address=>uint256) public userLockedBalances;
    
    constructor(IERC20 _token , uint256 endTime,uint256 _presaleStarts, IERC20 _usdc) public{
        owner = msg.sender;
        token = _token;
    ...
    function withdrawUSDT() public IsOwner{
