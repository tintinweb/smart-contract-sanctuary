...
contract BattleHeroAirdropWallet is Context{
    ...
    constructor(){
        ...
        // _vestingTime                  = 90 days;
        // _subDate                   = 1632139200; // 20 September 2021 12:00 UTC
        // _airdropDuration           = 1 days;


        // Testnet
        _firstClaimAvailable       = 1631908800; // 20 October 2021 12:00 UTC 
        _airdropStarts             = 1631907000; // 15 October 2021 12:00 UTC
        _vestingTime               = 30 minutes;
        _subDate                   = _firstClaimAvailable - 10 minutes;
        _airdropDuration           = 30 minutes;
    }
