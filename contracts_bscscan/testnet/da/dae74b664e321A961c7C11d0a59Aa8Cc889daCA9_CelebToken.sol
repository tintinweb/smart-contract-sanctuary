...
contract CelebToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 11000000 * 10**6 * 10**9;
    ...
    string private _name = "Celeb Token";
    string private _symbol = "Celeb";
    uint8 private _decimals = 9;
    
    //Reflection reward to holders
    ...
    address public marketingWallet = 0x83Ff2D646EDc4930B7380488831bd48B7D314a03;
    ...
    uint256 private numTokensSellToAddToLiquidity =11000000 * 10**6 * 10**9;
    ...
    constructor () public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);//Mainet
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//TestNett
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x863EE3DC1994A73A8741264c6359A883c4008cb5, 'We can not exclude Pancake router.');
