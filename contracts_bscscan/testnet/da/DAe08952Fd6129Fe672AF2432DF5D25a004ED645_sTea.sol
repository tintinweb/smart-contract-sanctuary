...
contract sTea is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Tea", "sTEA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTEA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTEA
