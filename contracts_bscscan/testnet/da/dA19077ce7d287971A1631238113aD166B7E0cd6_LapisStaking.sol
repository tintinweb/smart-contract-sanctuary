...
library Address {
     ...
     * types of addresses:
    Note: Unable to determine contructor arguments, please check and replace with correct values () *
...
contract LapisStaking is Ownable {
    ...
    constructor(
        ...
        require(address(_ticket) != address(0), "ticket can't be the zero address");
        ticket = _ticket;
    ...
    modifier averageBlockTimeIsValid(uint256 averageBlockTime) {
        require(averageBlockTime > 0, "average block time must be greater than 0");
        _;
    }
    ...
    function buyBatchTicket(
        ...
        for (uint256 i = 0; i < length; ++i) {
            ...
            require(tokenId > 0, "buyBatchTicket: invalid ticket");
            require(
                _amount > 0,
                "buyBatchTicket: amount must be greater than 0"
            );
    ...
    function buyTicket(
        ...
        (uint256 tokenId, uint256 price, ) = ticket.getTicketInfo(_tokenId);
        require(tokenId > 0, "buyTicket: invalid ticket");
