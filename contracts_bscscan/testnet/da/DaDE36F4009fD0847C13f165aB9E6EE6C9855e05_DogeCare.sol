...
contract DogeCare is Context, IBEP20, Ownable {
	...
	address payable public charitywallet=0xEf42b6c18998aeBD8Aa706E2288BBe156C091AaD;
	address payable public devwallet = 0x32A9D7b3Fc1f1C4631b2994aeB2f9BB59b4f9687;
    ...
    function totalFeePerTx(uint256 tAmount) internal view returns(uint256) {
        uint256 percentage = tAmount.mul(_holderFee.add(_liquidityFee).add(_devFee).add(_charityFee)).div(100);
        return percentage;
    }
    ...
    function _takeLiquidity(uint256 tAmount) private {
         devTokens =devTokens.add(tAmount.mul(_liquidityFee).div(100));
   ...
   function _takeCharityFee(uint256 tAmount) private {
    ...
    function _transfer(
        ...
        charitywallet.transfer(newBalance);
