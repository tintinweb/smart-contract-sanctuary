...
contract VaultRewardsChef is Ownable, ReentrancyGuard {
    ...
    constructor(IBEP20 _stakeToken, IBEP20 _rewardToken, uint256 _allocPoint, uint256 _rewardsPerBlock) public {
