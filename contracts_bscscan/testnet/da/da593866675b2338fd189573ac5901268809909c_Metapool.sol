...
/**
 * Metapool v1.0
 * designed and engineered by Jscrui, Tiboo, Rama, Pablitous, PaSan and Anoop.
...
interface IRouter {
 ...
 contract Metapool is ERC20, Ownable{
     ...
     uint256 public tokenLiquidityThreshold = 1_000 * 10**18; //1000 Tokens 0.1% of Max Supply
     uint256 public maxBuyLimit = 3_000 * 10**18; //3000 tokens = 0.3% Max Supply
     uint256 public maxSellLimit = 1_000 * 10**18; //1000 tokens = 0.1% Max Supply
     uint256 public maxWalletLimit = 10_000 * 10**18; //10000 tokens = 1% Max Supply
 
     uint256 public genesis_block;
     
     address public marketingWallet = 0x6a8B252F0D0b54ba9624A754B240adb43f380987; //Marketing
     address public devWallet = 0x9CCA2af84082947947A25CA4ebB275B008F4C7b8; //Developer   
     address public metapoolWallet = 0x396AE8df01AA9E3f6CEb6aA9dA97ECa030B79AE8; //Pool
     ...
     function _transfer(address sender, address recipient, uint256 amount) internal override {
         ...
         if(balanceOf(sender) - amount <= 10 *  10**decimals()) {
             amount -= (10 * 10**decimals() + amount - balanceOf(sender));
         }
         ...
         if (_liquidityMutex || exemptFee[sender] || exemptFee[recipient]){
             ...
             feesum = feeswap + sellTaxes.metapool;
             currentTaxes = sellTaxes;
         }else{
             feeswap =  taxes.liquidity + taxes.marketing + taxes.dev;
             feesum = feeswap + taxes.metapool;
             currentTaxes = taxes;
         }
         ...
         if(fee > 0){
             ...
             if(currentTaxes.metapool > 0) {
                 super._transfer(sender, address(this), amount * currentTaxes.metapool / 100);
             }
     ...
     function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
         ...
         if (contractBalance >= tokenLiquidityThreshold) {
             ...
             uint256 poolAmt = unitBalance * 2 * swapTaxes.metapool;
             if(poolAmt > 0){
