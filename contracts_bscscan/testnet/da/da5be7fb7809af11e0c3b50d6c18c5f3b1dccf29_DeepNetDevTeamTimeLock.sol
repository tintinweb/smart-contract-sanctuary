...
// NextMoon Liquidity lock
//we will set the lock to around 1 year , read why on our social media 
//the time value is determined by epoch time stamp, find below 1648832355 you can convert the value at epochconverter.com
// before the lock time expires it is not possible to release the LP tokens ... locked till april 1st 2022
...
contract DeepNetDevTeamTimeLock is TokenTimelock {
    constructor () public TokenTimelock(
        IERC20(0xc2C1c86E9356A155a43444289Fbb679bf44927A2), // token
        0xf309dae7604eb3CfB81B6d087c1e970Ff69733e8, // beneficiary
        1636684237) {
    }
