...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTC = IBEP20(0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8); // testnet
    //IBEP20 BTC = IBEP20(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0); // Mainnet
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // switch: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        _token = msg.sender;
    }
...
contract AAA_MONKEY is IBEP20, Auth {
    using SafeMath for uint256;
    address BTC  = 0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8; // testnet
    //address BTC  = 0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0; // mainnet
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // switch: 0x10ED43C718714eb63d5aA57B78B54704E256024E
