...
contract GGToken is ERC20Detailed, ERC20GatewayWhitelist {
  constructor()
    public
    ERC20Detailed("GGToken Infinity Shard", "GGToken", 18)
  {
    totalSupply = uint256(270000000).mul(uint256(10)**18);
    balanceOf[msg.sender] = totalSupply;
    emit Transfer(address(0), msg.sender, totalSupply);
    
    address _mainchainGateway = 0x1A2a1c938CE3eC39b6D47113c7955bAa9DD454F2;
