...
contract AngelAndDemonToken is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function setTokenBaseURI(string memory _newBaseURI) public onlyOwner{
