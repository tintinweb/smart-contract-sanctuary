...
contract Bird is ERC20, AccessControl {
    bytes32 public constant CREATOR_ADMIN = keccak256("CREATOR_ADMIN");
    constructor(address minter,uint256 initialSupply) ERC20("Bird", "BIRD") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(CREATOR_ADMIN, minter);
        _mint(msg.sender, initialSupply);
    }

    function mintBird(address _player, uint256 _amount) public {
