...
contract Launchpad {
    ...
    function showBool() public view returns (uint[] memory, uint[] memory, bool[] memory, bool[] memory, bool[] memory, bool[] memory, bool[] memory) {
        ...
        return(tokens, dates, firstClaim, secondClaim, thirdClaim, fourthClaim, fifthClaim);
    }
