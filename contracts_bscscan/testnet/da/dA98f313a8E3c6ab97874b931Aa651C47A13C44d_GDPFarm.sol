...
//  address stakingContract = 0xa5a8Be4c28218cc21047d334D035AC59fdBaE8F8;
  // TODO end local
  IFARM oldFarm = IFARM(0x35B1e4e78d8Cb5575D8eB47B5aAbA00625397C8c); // testnet
...
//  uint constant blocksIn180Days = 5184000;
  ...
  modifier onlyNewContract () {
      require(msg.sender == newContractAddress, 'GDPFarm: only new contract');
    _;
  }
  ...
  function syncData() onlyNewContract public {
