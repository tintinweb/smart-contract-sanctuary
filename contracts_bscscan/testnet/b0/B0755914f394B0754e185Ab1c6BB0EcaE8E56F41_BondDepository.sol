...
contract BondDepository is Ownable {
  ...
  function deposit(
    ...
    uint256 value = Treasury(treasury).valueOf(principle, _amount);
    ...
    */
    ...
    Treasury(treasury).deposit(_amount, principle, profit);
...
// TODO: remove after EVHY contract done
...
contract Treasury is Ownable {
  ...
  */
  function deposit(
    ...
    // TODO: will check this comment later
    // IERC20Mintable( EVHY ).mint( msg.sender, send_ );

    //TODO: user mock token to mint for now, waiting for evhy contract done
    MockERC20(EVHY).mint(msg.sender, send_);
