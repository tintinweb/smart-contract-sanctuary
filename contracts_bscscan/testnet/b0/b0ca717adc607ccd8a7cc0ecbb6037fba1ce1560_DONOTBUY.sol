...
contract DONOTBUY is Context, IBEP20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 100000 * 10**uint256(_decimals);
    uint256 public _maxTxAmount = 100000 * 10**uint256(_decimals);                        // contract balance to trigger swap & liquify + wallet transfer.
    address public  pancakeRouterAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;   // Pancake Router Version 2 address
    uint[] public _percentages = [10,10,10,10,10,10,10,10,10,10];                        // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        ...
        payable(0xcd05d9901FA3d22B4332E8a17cd6691feFD33328),                             // Marketing wallet
        payable(0xBB6D3a56AEDE258784Ec142308c6a148e0aaaD43),                             // Team Dev wallet
        payable(0xBA096e1841c44BF0cD90A571bDC98E17bb01B899),                             // Charity wallet
        payable(0x66C39f73D6A85Fb04285848908c3301BA908C31a),                             // Lotto 1 wallet
        payable(0x046c6E2A52Ab021169f551BE5a5D1E096c1b0Be0),                             // Lotto 2 wallet
        payable(0x1b0A3dBEb691674e2338A4364818fc933a6AB987),                             // Lotto 3 wallet
        payable(0xC8cC734AC909Fd6d4253AAfc833D027ba0D28bC7),                             // Burn wallet
        payable(0x9dCC3bC0baA048e69b36fcE1F1ce8ED024642Cf8),                             // Lotto rewards wallet
