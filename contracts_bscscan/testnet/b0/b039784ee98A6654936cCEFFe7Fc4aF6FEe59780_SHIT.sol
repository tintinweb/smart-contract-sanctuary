...
contract SHIT is IBEP20, SHITAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIT Maker";
    string constant _symbol = "SHIT";
    uint8 constant _decimals = 18;

    uint256 _totalSupply =5000000000000000000000000000; //5 billion
    ...
    constructor () SHITAuth(msg.sender) {
