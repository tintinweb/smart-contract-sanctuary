...
interface IDividendDistributor {
    ...
    function getInfo(bool hideDecimal) external view returns(uint256, uint256, uint256, uint256, uint256, uint256, uint256); 
...
contract DividendDistributor is IDividendDistributor {
    ...
    function getInfo(bool hideDecimal) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        uint256 shareholderCount = shareholders.length;
        if(hideDecimal){ return (totalShares.div(10 ** 18), totalDividends.div(10 ** 18), totalDistributed.div(10 ** 18), dividendsPerShare.div(10 ** 18), minDistribution.div(10 ** 18), annualMulipler, shareholderCount); } 
        else return (totalShares, totalDividends, totalDistributed, dividendsPerShare, minDistribution, annualMulipler, shareholderCount);
    }
...
//        emit Transfer(sender, recipient, amount);
    ...
    function getDistributorInfo(bool hideDecimal) public view returns (uint256 totalShares, uint256 totalDividends, uint256 totalDistributed, uint256 dividendsPerShare, uint256 minDistribution, uint256 annualMulipler, uint256 shareholderCount) {
