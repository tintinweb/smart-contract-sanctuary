...
contract PureFlowToken is Context, IERC20, Ownable 
{
    ...
    address public developmentWallet =  0xdb995a5e8564Af80C411374fAf951cE267558DAA;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        if(!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient])
        {
            ...
            uint256  burnAmount = amount.div(100).mul(_burnFee);
            uint256  devAmount = amount.div(100).mul(_burnFee);
            amount = amount.sub(burnAmount).sub(devAmount);
            removeAllFee();
