...
contract BNBFactor {
	...
	uint256[] public REFERRAL_PERCENTS = [70, 30, 2, 10, 10];
	...
	constructor(address payable wallet, address payable _wallet1, address payable _wallet2, address payable _wallet3 ) public {
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		uint256 fee2 = msg.value.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);
		commissionWallet2.transfer(fee2);
		
		uint256 fee3 = msg.value.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);
