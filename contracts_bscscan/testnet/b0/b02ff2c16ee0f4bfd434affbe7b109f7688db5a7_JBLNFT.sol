...
contract JBLNFT is ERC721{
    ...
    uint256 public NFT_APY = 11*10**17; //基礎APY：100 , 加成APY：10
    uint256 public PRICE = 5; //單位5個JBL-Token

    Card[] public cards; // First Item has Index 0
    address public owner;
    mapping (uint256 => string) private _tokenURIs;
    uint16 public maxSupply = 520;
    uint16 public mint_total = 520;
    ...
    constructor ()  public ERC721("JBL-DD-OF", "JBL-DD-OF"){
        owner = msg.sender; 
