...
contract Creator{
  ...
  function getBytecode(address thisToken, 
      address getLP, 
      uint256 getExpiry, 
      uint8 getDecimals, 
      address getToken0, 
      ...
      private pure returns (bytes memory) {
        ...
        return abi.encodePacked(bytecode, abi.encode(thisToken, getLP, getExpiry, getDecimals, getToken0, getToken1, getTokenSymbol, getWBNBSymbol));
    }
...

  {
    ...
    address addr;
    (address thisToken, address getLP, uint256 getExpiry, uint8 getDecimals, address getToken0, address getToken1, string memory getTokenSymbol,string memory getWBNBSymbol) = preview(tokenAddress, lpToken);

    bytes memory bytecode = getBytecode(thisToken, getLP, getExpiry, getDecimals, getToken0, getToken1, getTokenSymbol, getWBNBSymbol);
    ...
    assembly {
            addr := create2(
                ...
                getDecimals // Salt from function arguments
            )
