...
abstract contract CoordinatedWithdrawal is ReentrancyGuard {
    ...
    uint256 private constant TRANSFER_PERCENTAGE = 10;

    /**
    * @dev Returns the amount of the most recent withdrawal.
    */
    function getCurrentWithdrawal(address sender) public virtual returns (uint256) {
...
contract BEP20Token is Context, IBEP20, Ownable, CoordinatedWithdrawal {
    using SafeMath for uint256;
...
*/
    ...
    * - `sender` must have a balance of at least `amount`.
    */
    function _transferFromDEX(address sender, address recipient, uint256 amount) internal nonReentrant {
    ...
    */
    function _swapAndAddToLiquidity(uint256 contractLiquidityBalance) internal nonReentrant {
        ...
        _balanceVirtualLiquidity = _balanceVirtualLiquidity.sub(newBalance, "Swap: Liquidity error");
