...
contract CoinTapLaunchpad is ICoinTapLaunchpad, Ownable, Pausable, Whitelist {
    ...
    function buyToken() public override payable {
      ...
      require(status != SharedConstants.Statuses.CANCELLED, "CoinTapLaunchpad: Launchpad is cancelled or finalized");
      require(status != SharedConstants.Statuses.FINZALIZE, "CoinTapLaunchpad: Launchpad is cancelled or finalized");
