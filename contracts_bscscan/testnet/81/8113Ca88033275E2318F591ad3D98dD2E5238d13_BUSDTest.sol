...
contract BUSDTest is IBEP20, Auth {
    ...
    string constant _name = "BUSD Test";
    ...
    uint256 public swapThreshold = _totalSupply / 80; // 0.1%
    bool inSwap;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setFees(uint256 _reflectionFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        reflectionFee = _reflectionFee;
        devFee = _devFee;
        totalFee = _reflectionFee.add(_devFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/4);
    }

    function setdevFeeReceivers(address _devFeeReceiver) external authorized {
