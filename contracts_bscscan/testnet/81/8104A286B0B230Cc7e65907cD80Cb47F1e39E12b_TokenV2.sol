...
contract TokenV2 is ERC20, ERC20Burnable {
  ...
  address public devfee = address(0xBCC04780cDd65EB90BEb16631E97acB9B9647D77);
  ...
  constructor() ERC20("Fruit Farm Game", "FFG3") {
    owner = msg.sender;
 ...
 function setDev(address wallet)  public {
  ...
  function transfer(address _to, uint256 _amount) 
   public virtual override returns (bool) {
    uint256 fee = _amount.div(100).mul(fees); // Calculate fee
  ...
  function transferFrom(
        ...
        uint256 fee = amount.div(100).mul(fees); // Calculate fee
