...
contract sTrapeza_v2 is IsFIDL, ERC20Permit {
    ...
    // do this last
    function initialize(address stakingContract_, address prevSFIDLContract_, uint256 totalSupply_ ) external {
        require(msg.sender == initializer, "Initializer:  caller is not initializer");
        ...
        require(totalSupply_ != IsFIDL(prevsFIDLContract).totalSupply(), "Incorrect TotalSupply");
