...
contract ExchangeContract is Sale{
    ...
    function mint(address token ,string memory tokenuri, uint256 value, uint256 tokenId, uint256 _type, uint256 supply, address[] memory royaltyaddr, uint[] memory royaltypercentage) public{
