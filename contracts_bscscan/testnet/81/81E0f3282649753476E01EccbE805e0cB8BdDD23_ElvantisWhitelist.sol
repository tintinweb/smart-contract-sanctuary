...
contract ElvantisWhitelist is Ownable, AccessControl {
    ...
    uint256 public tokenRate = 100e18;
    uint256 public minContribution = 1 ether;
    ...
    function claim() external {
        ...
        uint256 _contributions = userContribution[msg.sender];
    ...
    function setSignerRoleAdmin(address admin) external onlyOwner {
        require(admin != address(0), "ElvantisWhitelist: INVALID_ADMIN!");
        _setupRole(DEFAULT_ADMIN_ROLE, admin);
    }

    function grandRewardSignerRole(address account) external onlyOwner {
        require(account != address(0), "ElvantisWhitelist: INVALID_ACCOUNT!");
