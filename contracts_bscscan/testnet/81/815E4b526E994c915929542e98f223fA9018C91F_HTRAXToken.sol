...
contract HTRAXToken is ERC20, ERC20Snapshot, Ownable, Pausable, AccessControl, HTRAXTokenSale {
    ...
    /**
     * @dev transfer the token from address of this contract to address of the owner
     * @param _tokenContract is address of the token
     * @param _amount of token need to be in format: _value *10^18
     */
    function WithdrawBalance(address _tokenContract, uint256 _amount) public onlyOwner {
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(recipient != address(this), "ERC20: transfer to the token smart contract address");
