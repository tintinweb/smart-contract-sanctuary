...
contract RugMuncher is Context, IERC20, Ownable {
    ...
    address private _MarketingWalletAddress = 0x22e8CFdff216bB9E07dEd7B8D00c79F8ce356325;
    ...
    string private _name = "Rug Muncher"; // Token name here
    string private _symbol = "RUGMUNCHER"; // Token Symbol Here
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 4; // Redistribution Fee %
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _MarketingFee = 3; // MarketingFee % 
    uint256 private _previousMarketingFee = _MarketingFee;
    uint256 public _liquidityFee = 3; // Liquidity percentage
