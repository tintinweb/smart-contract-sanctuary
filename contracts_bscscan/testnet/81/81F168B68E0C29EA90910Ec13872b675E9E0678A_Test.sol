...
contract Test is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount =_totalSupply * 2 / 200; // 1% of total supply
    uint256 public _walletMax = _totalSupply * 5 / 200; //2.5% of total supply
    ...
    uint256 public swapThreshold = _totalSupply * 20 / 100000; //0.02% of total supply
