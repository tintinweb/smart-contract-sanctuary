...
contract AuctionERC721 is AuctionBase {
...
abstract contract AuctionBase is IAuctionBase, AcceptedTokenList, Operators, ReentrancyGuard, IERC721Receiver, IERC1155Receiver {
    ...
    mapping(uint256 => mapping(address => bool)) withdrawnByBidder;
    ...
    nonReentrant {
        ...
        require(!withdrawnByBidder[auctionId][msg.sender], "withdraw already");
        Auction memory auction = auctions[auctionId];
        require(
        ...
        withdrawnByBidder[auctionId][msg.sender] = true;
    }
