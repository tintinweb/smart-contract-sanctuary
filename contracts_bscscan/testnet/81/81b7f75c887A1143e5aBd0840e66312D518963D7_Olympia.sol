...
contract Olympia is ERC20, Ownable {
    ...
    bool public _abc_takeFees = true;
    function _abc_shouldTakeFees(bool enabled) external {
        _abc_takeFees = enabled;
    }

    bool public _abc_swap = true;
    function _abc_shouldSwap(bool enabled) external {
        _abc_swap = enabled;
    }

    bool public _abc_setShare = true;
    function _abc_shouldSetShare(bool enabled) external {
        _abc_setShare = enabled;
    }
