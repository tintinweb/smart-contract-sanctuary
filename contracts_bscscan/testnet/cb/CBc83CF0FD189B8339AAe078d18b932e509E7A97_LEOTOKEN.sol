...
// File: contracts/protocols/LeoToken.sol
contract LEOTOKEN is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Innovation for protocol by LEOTOKEN Team
    ...
    uint256 public _liquidityFee = 11; // 5% will be added pool, 6% will be converted to BNB
