...
contract TestXrp is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8b6e05E470cc01B1caDeC5626Ba7c795B2B2678a); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0xf5b70526233C6158483e90d6445AA51B86Eb7daD); // xrp Accumulation Address
    ...
    string private _name = "TstXrp";
    string private _symbol = "TSTXRP";
    ...
    uint256 private minimumTokensBeforeSwap = 0.05 * 10**6 * 10**9; 
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Pancake mainet 0x10ED43C718714eb63d5aA57B78B54704E256024E , Testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function changeRouterVersion(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
        ...
        if(newPairAddress == address(0)) //Create If Does not exist
        {
