...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    function dailyDataUpdate(uint256 beforeDay) external {
        ...
        require(g._currentDay > CLAIM_PHASE_START_DAY, "TBNBT: Too early");

        if (beforeDay != 0) {
            require(
                beforeDay <= g._currentDay,
                "TBNBT: beforeDay cannot be in the future"
            );
    ...
    function _stakeLoad(
        ...
        require(
            ...
            "TBNBT: stakeIdParam not in stake"
        );
...
contract StakeableToken is GlobalsAndUtility {
        ...
        external
    {
        ...
        require(
            ...
            "TBNBT: newStakedDays lower than minimum"
        );
    ...
    function stakeGoodAccounting(
        ...
        require(stakeLists[stakerAddr].length != 0, "TBNBT: Empty stake list");
        require(
            stakeIndex < stakeLists[stakerAddr].length,
            "TBNBT: stakeIndex invalid"
        );
        ...
        require(
            ...
            "TBNBT: Stake not fully served"
        );

        /* Stake must still be locked */
        require(st._unlockedDay == 0, "TBNBT: Stake already unlocked");
    ...
    function stakeEnd(uint256 stakeIndex, uint40 stakeIdParam) external {
        ...
        /* require() is more informative than the default assert() */
        require(stakeListRef.length != 0, "TBNBT: Empty stake list");
        require(stakeIndex < stakeListRef.length, "TBNBT: stakeIndex invalid");
        ...
        if (g._currentDay >= st._lockedDay) {
            ...
            /* Deny early-unstake before an auto-stake minimum has been served */
            require(!st._isAutoStake, "TBNBT: Auto-stake still locked");
    ...
    function _stakeStart(
        ...
        require(
            ...
            "TBNBT: newStakedDays higher than maximum"
        );
        ...
        require(
            newStakeShares != 0,
            "TBNBT: newStakedHearts must be at least minimum shareRate"
        );
...
contract UTXOClaimValidation is StakeableToken {
    ...
    function btcAddressIsClaimable(
        ...
        require(
            ...
            "TBNBT: Claim phase has not yet started"
        );
        require(day < CLAIM_PHASE_END_DAY, "TBNBT: Claim phase has ended");
    ...
    function claimMessageMatchesSignature(
        ...
        require(v >= 27 && v <= 30, "TBNBT: v invalid");
    ...
    function pubKeyToBtcAddress(
        ...
        */
        ...
        if (compressed) {
            ...
            require(!(nested && bech32), "TBNBT: claimFlags invalid");
...
contract UTXORedeemableToken is UTXOClaimValidation {
    ...
    function _satoshisClaim(
        ...
        require(
            ...
            "TBNBT: CHK: _claimedBtcAddrCount"
        );
        ...
        )
    {
        ...
        require(
            ...
            "TBNBT: CHK: _claimedSatoshisTotal"
        );
...
contract TransformableToken is UTXORedeemableToken {
    ...
    function xfLobbyEnter(address referrerAddr) external payable {
        ...
        require(enterDay < CLAIM_PHASE_END_DAY, "TBNBT: Lobbies have ended");

        uint256 rawAmount = msg.value;
        require(rawAmount != 0, "TBNBT: Amount required");
    ...
    function xfLobbyExit(uint256 enterDay, uint256 count) external {
        require(enterDay < _currentDay(), "TBNBT: Round is not complete");
        ...
        if (count != 0) {
            ...
            require(headIndex < endIndex, "TBNBT: count invalid");
        }
    ...
    function xfLobbyFlush() external {
        require(address(this).balance != 0, "TBNBT: No value");
        ...
        returns (uint256 rawAmount, address referrerAddr)
    {
        ...
        require(entry.rawAmount != 0, "TBNBT: Param invalid");
