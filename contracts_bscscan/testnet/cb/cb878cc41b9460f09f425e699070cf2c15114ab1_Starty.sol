...
contract Ownable is Context {
    ...
    // Starty - Received from core Constructor
    constructor (address initialOwner) {
        _owner = initialOwner;
        emit OwnershipTransferred(address(0), initialOwner);
    }

    // Initialized by Starty constructor
...
contract Starty is Context, IBEP20, Ownable {
    ...
    string private _name     = "Starty";
    string private _symbol   = "Starty";
