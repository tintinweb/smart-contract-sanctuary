...
contract LotteryDraw is Context, IERC20, Ownable {
    ...
    uint public extra_01 = 13;                             // extra_tax 01
    uint public extra_02 = 15;                             // extra_tax 02
    uint public extra_03 = 17;                             // extra_tax 03
...
//      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
        ...
        antiwhale_measures[0] = antiwhale({selling_treshold: _tTotal*extra_01/10000, extra_tax: 25}); 
        antiwhale_measures[1] = antiwhale({selling_treshold: _tTotal*extra_02/10000, extra_tax: 50});
        antiwhale_measures[2] = antiwhale({selling_treshold: _tTotal*extra_03/10000, extra_tax: 75});
