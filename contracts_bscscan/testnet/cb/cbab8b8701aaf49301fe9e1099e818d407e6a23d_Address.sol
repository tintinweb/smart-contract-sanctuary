...
contract DogeVerse is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge verse";
    string private constant _symbol = "DV";
    ...
    constructor() {
        address newOwner = address(0x4e0dA2df5D38a384b7B9498b8eeEF98984e98C71);
        ...
        marketingAddress = payable(0x02116D15AC94F77631f0069dD3A70dD9542Ba364); // Marketing Address
        devAddress = payable(0x96683787dC6ff26337A993EC0d75B985BB574F70); // Dev Address
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellDevFee <= 3000, "Must keep sell taxes below 30%");
