...
contract TOKENR01 is IBEP20, Auth {
    ...
    string constant _name = "TOKENR01";
    string constant _symbol = "TOKENR01";
    ...
    function permit(
        ...
        require(holder != address(0), "TOKENR01/invalid-address-0");
        require(
            holder == ecrecover(digest, v, r, s),
            "TOKENR01/invalid-permit"
        );
        require(
            expiry == 0 || block.timestamp <= expiry,
            "TOKENR01/permit-expired"
        );
        require(nonce == nonces[holder]++, "TOKENR01/invalid-nonce");
