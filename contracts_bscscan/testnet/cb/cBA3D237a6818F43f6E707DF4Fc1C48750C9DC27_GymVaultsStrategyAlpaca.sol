...
contract GymVaultsStrategyAlpaca is Ownable, ReentrancyGuard, Pausable {
    ...
    address public uniRouterAddress = address(0xf46A02489B99C5A4a5cC31AA3F9eBD6A501D4B49); // PancakeSwap: Router
    ...
    modifier onlyStrategist() {
        require(strategist == msg.sender || operator == msg.sender, "GymVaultsStrategyAlpaca: caller is not the strategist");
        _;
    }
    ...
    function earn() public whenNotPaused {
        ...
        if (earnedAddress != wantAddress) {
            ...
            IPancakeRouter02(uniRouterAddress).swapExactTokensForTokensSupportingFeeOnTransferTokens(earnedAmt, 0, earnedToWantPath, address(this), block.timestamp + 60);
        }
    ...
    function convertDustToEarned() public whenNotPaused {
        ...
        if (wantAddress != earnedAddress && wantAmt > 0) {
            ...
            IPancakeRouter02(uniRouterAddress).swapExactTokensForTokensSupportingFeeOnTransferTokens(wantAmt, 0, wantToEarnedPath, address(this), block.timestamp + 60);
