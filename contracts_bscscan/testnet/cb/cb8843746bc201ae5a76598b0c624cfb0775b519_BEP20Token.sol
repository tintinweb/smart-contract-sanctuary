...
contract BEP20Token is Context, Ownable {
    ...
    uint256 public preSaleRate = 0.000314 ether;
    // Min purchase size of incoming ETH during pre sale period fixed at 0.1 ETH
    uint256 public minPurchasePreSale = 0.1 ether;
    ...
    // Token base Pre sale
    address public BASEToken; //= 0xbfc402572ecdee2d7da9e676cf3465e90a3388ac;

    constructor() public {
        _name = "Pre Sale V 1.0.0";
        _decimals = 18;
    }
    ...
    */
    ...
    function buyToken() external payable returns (bool) {
        ...
        // uint256 _amountToken = _amount / preSaleRate;
