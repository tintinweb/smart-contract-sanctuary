...
contract Dinki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DINUDividendTracker public dividendTracker;
 
    uint256 public swapTokensAtAmount = 50000000 * (10**9);
    uint256 public _maxTransactionAmount = 10000000000 * (10**9);
    ...
    constructor() ERC20("Dinki Inu", "DINU") {
        buyFee.rewardFee = 2;
        ...
        _marketingWallet = payable(address(0x65272E9424017850aD239562360cbBa3F2Ee1B7A)); 
    	dividendTracker = new DINUDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        DINUDividendTracker newDividendTracker = DINUDividendTracker(payable(newAddress));
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DINU: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
 
        _setAutomatedMarketMakerPair(pair, value);
    }
 
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DINU: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "DINU: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "DINU: Cannot update gasForProcessing to same value");
...
contract DINUDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("DINU_Dividend_Tracker", "DINU_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000 * (10**9); //must hold 1000 tokens
    }
 
    function _transfer(address, address, uint256) internal pure override {
        require(false, "DINU_Dividend_Tracker: No transfers allowed");
    }
 
    function withdrawDividend() public pure override {
        require(false, "DINU_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Token contract.");
    }
