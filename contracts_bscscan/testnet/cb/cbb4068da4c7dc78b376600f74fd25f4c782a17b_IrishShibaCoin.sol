...
contract IrishShibaCoin is IBEP20, Ownable {
    ...
    mapping(uint=>uint) public minValues;
    mapping(uint=>uint) public maxValues;
    uint public totalRate = 0;
    ...
    function processDailyPrize(address candidate) public onlyOperator {
        require(candidate != address(0), "Error: Invalid winner.");
        ...
        // _balances[address(this)] = _balances[address(this)] - _dailyTaxSum;
        _dailyTaxSum = 0;
