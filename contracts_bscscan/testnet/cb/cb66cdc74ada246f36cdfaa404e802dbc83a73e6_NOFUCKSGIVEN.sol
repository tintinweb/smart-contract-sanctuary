...
//Contract
contract NOFUCKSGIVEN is IBEP20, Ownable
{
    ...
    string private constant _name = 'NOFUCKSGIVEN';
    ...
    address public MarketingWallet;     //This wallet has authorization and access to marketing
    ...
    address public currentReward=0x8BaBbB98678facC7342735486C851ABD7A0d17Ca;   //change this address to desired reward token
