...
/**
    ...
    */
    ...
    contract Evocardano is ERC20, Ownable {
        ...
        uint256 public constant maxMarketingFee = 6;
        ...
        constructor()  ERC20("Evocardano", "EVOC") {
          ...
          marketingWallet = address(0x046d8a5EBDd47735e3446F1F69f4D564be877069);
          liquidityWallet = address(0x87b754229539874be79d640984A95Cdfe7d283C5);
          //Testnet BUSD
          ...
          IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
            ...
            */
            ...
            _initialiseSupply(owner(), 1000000 * (10**18));
        ...
        function tradeStart() external onlyOwner {
            ...
            minSellTransactionAmount = 0 * 10**18;
        ...
        function setTradingIsEnabled(bool _enabled) public onlyOwner {
            require(_enabled == true, "Evocardano: Trading can not be disabled");
        ...
        function updateMarketingWallet(address _newWallet) external onlyOwner {
            require(_newWallet != marketingWallet, "Evocardano: The marketing wallet is already this address");
        ...
        function excludeFromFees(address account, bool excluded) public onlyOwner {
            require(isExcludedFromFees[account] != excluded, "Evocardano: Account is already exluded from fees");
        ...
        function excludeFromBuyFees(address account, bool excludefromBuyFees) public onlyOwner {
            require(isExcludedFromBuyFees[account] != excludefromBuyFees, "Evocardano: Account is already exluded from buy fees");
      ...
      function getAccountFirstDividendsInfo(address account)
        ...
        function _transfer(
            ...
            require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "Evocardano: Trading has not started yet");
    ...
    contract FIRSTDividendTracker is DividendPayingToken {
        ...
        constructor() DividendPayingToken("Evocardano_Dividend_Tracker", "Evocardano_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
          claimWait = 3600;
            minimumTokenBalanceForDividends = 20000 * (10**18); //must hold 20000+ tokens
            limitMinimumTokenBalanceForDividends = 25000; //limit max 25000+ tokens
        }
