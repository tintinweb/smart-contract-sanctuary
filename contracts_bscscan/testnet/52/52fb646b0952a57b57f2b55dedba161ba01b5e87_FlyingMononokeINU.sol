...
contract FlyingMononokeINU is Context, IERC20, Ownable {
    ...
    string private _name = "Flying Mononoke INU";
    string private _symbol = "monok";
    ...
    address public marketingWallet = 0xaF2edF8EB5638f03d5f63916C1624e392994A95d;
    ...
    constructor() {
        ...
        //exclude owner, marketingWallet and this contract from fee
    ...
    function setFeePercent(uint256 marketingFee, uint256 liquidityFee, uint256 taxFee, uint256 burnFee) external onlyOwner() {
