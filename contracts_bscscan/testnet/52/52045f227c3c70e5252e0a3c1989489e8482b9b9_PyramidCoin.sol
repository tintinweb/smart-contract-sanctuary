...
contract PyramidCoin is Context, IERC20 {
    ...
    string private _name = "PyramidCoin";
    ...
    uint256 public _sellModFee = 300;
    uint256 public _sellGameAdvFee = 100;
    uint256 public _sellCharityFee = 200;
    uint256 public _sellBurnFee = 300;
    ...
    address payable private _marketingWallet = payable(0x01fC30dA4AcB0982a51546037e9B72172aba08a5);
    address payable private _devWallet = payable(0x0A8F5C12F092353cbabae05f53eFC31CC86e856F);
    address payable private _modWallet = payable(0x1D464Fe8A58061023f16F5aF8c11810d01bEC2f5);
    address payable private _charityWallet = payable(0xc35E1A201A95A2d00048B94754df7bA292A639F6);
    address payable private _gameAdvWallet = payable(0x508325d0C202e2e306cf808Cf88Ed4efD5f3886C);
