...
contract BUSD is ERC20MintBurn, Ownable {

    uint8 public override decimals = 18;
    string public override symbol = "BUSD";
    string public override name = "Binance USD";

    uint256 public interval;
    uint256 public faucetAmount = 1000e18;
    uint256 public faucetTotal = 10000000e18;
    uint256 public giveawayTotal;
    bool public faucetEnabled = true;

    mapping(address => uint256) userLastTime;

    constructor(address _owner, uint256 _interval) Ownable(_owner) {
        _mint(owner(), 2400e18);
        interval = _interval;
    }
    ...
    function faucet() external {
        ...
        require(giveawayTotal <= faucetTotal - faucetAmount, "Faucet total is running out now.");
