...
pragma solidity ^0.8.0;
contract MicroEthereum is ERC20, Ownable {
    ...
    constructor() ERC20("MicroEthereum", "mETH") {
        _mint(msg.sender, 75000000*10**decimals());
        _mint(address(this), 25000000*10**decimals());
        startSale(block.number, 999999999, 0,200000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,100*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
