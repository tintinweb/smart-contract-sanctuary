...
contract RenderverseSwap is AccessControl {
    ...
    function preSale(address payable sender) public  payable {
        require((msg.value>=minimunEther*100000000000000000) && (msg.value<= maximumEther*1000000000000000000),"Sent Value of Ether is Not Valid");
        payable(sender).transfer(msg.value); //kjhkjhashdka
    ...
    function publicSale(address payable sender) public payable {
        require((msg.value>=minimunEther*100000000000000000) && (msg.value<= maximumEther*1000000000000000000),"Sent Value of Ether is Not Valid");
        payable(sender).transfer(msg.value); ////kjbaskjdkans
