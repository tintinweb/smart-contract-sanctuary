...
15% en compra que se destinan o propio token y gasfee de 1.80€
...
contract BabyPooCoin1 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyPooCoin1";
    string constant _symbol = "BabyPoo1";
