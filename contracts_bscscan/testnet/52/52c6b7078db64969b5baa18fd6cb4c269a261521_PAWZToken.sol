    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            if (overMinimumTokenBalance) {
                ...
                uint256 restBalance = address(this).balance;
                uint256 initialTokenBalance = balanceOf(address(this));
                swapETHForTokens(restBalance.div(2));
                uint256 swappedTokenBalance = balanceOf(address(this)).sub(initialTokenBalance);
                addLiquidity(swappedTokenBalance, restBalance.div(2));
            }
        }
