...
contract HappyCows is Ownable, ERC721URIStorage {
    ...
    function buyBlindBox(string memory _metaHash, address contractAddress) public {
        ...
        string memory s = string(abi.encodePacked(_metaHash, Strings.toString(newItemId), '.json'));
