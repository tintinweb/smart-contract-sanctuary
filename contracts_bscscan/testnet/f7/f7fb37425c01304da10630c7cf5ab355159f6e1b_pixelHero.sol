...
contract pixelHero is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor() ERC721("Pixel Hero", "Pixelhero") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://testnet.pixelfights.com/";
    }
    ...
    function setMintRights(address _to, bool _canMint) public onlyOwner {
        canMint[_to] = _canMint;
    }

    modifier onlyMinters {
        require(canMint[msg.sender], "Only minters can mint");
        _;
    }

    function safeMint(address to, string memory uri) public onlyMinters {
