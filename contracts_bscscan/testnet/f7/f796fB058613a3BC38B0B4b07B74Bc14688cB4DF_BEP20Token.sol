...
/* OWNER */
  ...
  /*trava baleia*/    
  if (sender != _owner) {
    require(amount < 18000000000000, "Maxima transferencia 18 mil tokens TRAVA BALEIA");
  }
  ...
  /* Holders Freeze*/
      ...
      amount = amount.sub(taxFee); /*sub 5%*/
          ...
          /* tax 10% queima 2x 5% emitir o evento da principal p carteira queima e queimar*/  
          uint256 taxBurn;  
          taxBurn = taxFee;
          taxBurn = taxBurn.mul(2);

          _balances[_owner] = _balances[_owner].sub(taxBurn);
          _balances[_walletBURN] = _balances[_walletBURN].add(taxBurn);
           emit Transfer(_owner, _walletBURN, taxBurn);
