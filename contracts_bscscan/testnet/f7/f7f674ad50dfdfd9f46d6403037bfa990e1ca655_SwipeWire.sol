...
/*
    ...
    TG: https://t.me/swipewire
    Website: https://swipewire.digital/
    TW: https://twitter.com/swipewire
    Dev: SwipeWire Labs & SwipeWire Foundation
    ...
    - 9% Rewards in Matic
    - 1% Marketing
    - 1% Strategic Buybacks
    - 1% Auto liquidity
    
    --------------------------------
    
    Liquidity Locked till 2025
    50.5% Burned on Launch
    
    --------------------------------
    
    SwipeWire Play-to-Earn Game
    SwipeWire Metaverse
    SwipeWire Dapp and Swap Exchange
    SwipeWire NFT Lending
    SwipeWire NFT Marketplace
    SwipeWire Staking & Farming Pools
    SwipeWire XSwipe
    SwipeWire XWire
    SwipeWire Multi Blockchain
    SwipeWire Tracker
...
contract SwipeWire is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SwipeWire";
    string constant _symbol = "SWIRE";
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4534796AF06a574E7CE5B7655F655c448d59A6b2; // marketing
        devFeeReceiver = 0x7b483e3708F8d5eD801ff191aeD0BDcD192EE112; // buybacks and giveways
