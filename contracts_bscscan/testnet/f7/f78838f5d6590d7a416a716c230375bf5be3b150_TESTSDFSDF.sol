...
contract TESTSDFSDF is Context, IERC20, Ownable {
    ...
    string private constant _name = "TEST MANDALIN"; // 
    string private constant _symbol = "TM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 6;
    address public  _marketingWallet = 0xa1ed8416F0368C29BAF93684fa82F2e47abeE40F;
