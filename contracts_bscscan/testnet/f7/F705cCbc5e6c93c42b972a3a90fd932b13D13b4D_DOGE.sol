...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Old DOGE";
    string internal constant SYMBOL = "DOGE";
...
abstract contract DOGEToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract DOGE is DOGEToken {
    constructor() DOGEToken( Env.Testnet ) {
