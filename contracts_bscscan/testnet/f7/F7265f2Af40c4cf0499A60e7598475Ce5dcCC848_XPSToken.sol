...
contract XPSToken is Context, IERC20, Ownable {
    ...
    bool public _communityTriggerFlag = true;
    bool public _marketingTriggerFlag = true;
    bool public _liquidityTriggerFlag = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(!isExcludedFromFee(_msgSender())) {
            ...
            if(
                ...
                if(_currentCommunityTriggerAmount >= _communityTriggerAmount && !inSwapAndCommunity && _communityTriggerFlag) {
                    swapAndCommunity(_currentCommunityTriggerAmount);
                    _currentCommunityTriggerAmount = 0;
                }
                
                if(_currentMarketingTriggerAmount >= _marketingTriggerAmount && !inSwapAndMarketing && _marketingTriggerFlag) {
                    swapAndMarketing(_currentMarketingTriggerAmount);
                    _currentMarketingTriggerAmount = 0;                    
                }
                
                if(_currentLiquidityTriggerAmount >= _liquidityTriggerAmount && !inSwapAndLiquify && _liquidityTriggerFlag) {
    ...
    */
    ...
    function swapOnTransactionFlag(bool swapOnTransaction) public onlyOwner {
        _swapOnTransaction = swapOnTransaction;
    }

    function setTriggerFlag(bool communityTriggerFlag, bool marketingTriggerFlag, bool liquidityTriggerFlag) public onlyOwner {
        _communityTriggerFlag = communityTriggerFlag;
        _marketingTriggerFlag = marketingTriggerFlag;
        _liquidityTriggerFlag = liquidityTriggerFlag;
    }
