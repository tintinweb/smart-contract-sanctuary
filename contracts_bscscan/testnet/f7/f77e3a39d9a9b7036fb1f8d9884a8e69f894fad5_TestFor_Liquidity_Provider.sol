...
contract TestFor_Liquidity_Provider is Context, Ownable{
    ...
    uint256 public _feeKapexBNBLiquidity = 1000; // BNB to Kapex liquidity fee 10%
    ...
    address payable public _kapexTokenAddress           = payable(0x0000000000000000000000000000000000000000); // TO-DO kapex token Address
    address payable public _lpTokensLockAddress         = payable(0x0000000000000000000000000000000000000000); // TO-DO to lock lp tokens 
    ...
    address payable public _stakingRewardTokenAddress   = payable(0x0000000000000000000000000000000000000000); // TO-DO address of token that will be rewarded for staking koda
