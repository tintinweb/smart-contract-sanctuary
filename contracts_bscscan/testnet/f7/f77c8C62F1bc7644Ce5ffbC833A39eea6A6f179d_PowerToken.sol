...
contract PowerToken is Context, IBEP20, Ownable {
    ...
    //Test
    uint256 public timeHour = 60 * 60;  //1h Min
    uint256 public timeDay = 60 * 60;       // 1h
    uint256 public timeWeek = 6 * 60 * 60;      // 6h
    uint256 public timeMonth = 12 * 60 * 60;     // 12h
