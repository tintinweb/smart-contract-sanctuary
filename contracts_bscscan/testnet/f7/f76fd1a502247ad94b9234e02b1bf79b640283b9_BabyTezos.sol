...
GET REWARDED WITH Tezos (XTZ) JUST FOR HOLDING BabyTezos!
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x16939ef78684453bfDFb47825F8a5F714f12623a;
...
contract BabyTezos is ERC20, Ownable {
    ...
    address public _dividendToken = 0x16939ef78684453bfDFb47825F8a5F714f12623a;
    ...
    constructor() ERC20("BabyTezos", "BEZOS") {
    	...
    	buyBackWallet = 0x51BD8eF4B5252FCa8bC27c81F77Fa63FA8F08CdB;
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    require(sellFeeIncreaseFactor >= 100 && sellFeeIncreaseFactor <= 200, "BabyTezos: Sell transaction multipler must be between 100 (1x) and 200 (2x)");
  	    sellFeeIncreaseFactor = multiplier;
  	}
  	
  	function setMarketingDivisor(uint256 divisor) external onlyOwner {
  	    require(marketingDivisor >= 0 && marketingDivisor <= 100, "BabyTezos: Marketing divisor must be between 0 (0%) and 100 (100%)");
    ...
    function triggerBuyBack(uint256 amount) public onlyOwner {
        require(!swapping, "BabyTezos: A swapping process is currently running, wait till that is complete");
    ...
    function updateDividendRewardFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "BabyTezos: Dividend reward tax must be between 0 and 10");
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(newBuyBackWallet != buyBackWallet, "BabyTezos: The liquidity wallet is already this address");
...
contract BabyTezosDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BabyTezos_Dividend_Tracker", "BabyTezos_Dividend_Tracker") {
    	claimWait = 3600;
