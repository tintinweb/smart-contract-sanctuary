...
contract MiniGame is SamoyedGame, ReentrancyGuard {
    ...
    function drawWinner() public {
        ...
        emit wonEvent(sitAddress[nextWinnerDrawRoomNo][winner[nextWinnerDrawRoomNo]], currentRoomNo, winner[nextWinnerDrawRoomNo]);
        nextWinnerDrawRoomNo++;
    }

    function immediatelyBeginRound() public {
        require(getAddressSitQuantityLength(currentRoomNo,msg.sender)>=minimumSeatToImmediatelyBeginRound,"MiniGame: Need at Least 4 Seats");
        createNewRoom();
    }    
