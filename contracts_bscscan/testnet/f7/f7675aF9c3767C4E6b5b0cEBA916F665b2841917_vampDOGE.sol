...
contract vampDOGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    vampdogeDividendTracker public dividendTracker;
    ...
    address payable public marketingWallet =
        0x2e1e3ceebf5E06bb15e4438E6E15391D51811248; // notgood
    ...
    uint256 public manualBuybackFee = 1;
    ...
    constructor() ERC20("vampDOGE", "vampDOGE") {
        totalFees = BNBRewardsFee.add(liquidityFee).add(buybackFee);

        dividendTracker = new vampdogeDividendTracker();
    ...
    function changeFees(
        ...
        uint256 liquidity,
        uint256 buyback,
        uint256 manualBuyback
    ) public onlyOwner {
        BNBRewardsFee = rewards;
        liquidityFee = liquidity;
        buybackFee = buyback;
        manualBuybackFee = manualBuyback;
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "vampDOGE: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "vampDOGE: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    }
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "vampDOGE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "vampDOGE: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function setPresaleWalletandRouter(
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "vampDOGE: gasForProcessing must be between 200,000 and 1,000,000"
        );
        require(
            newValue != gasForProcessing,
            "vampDOGE: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        if (!tradingIsEnabled) {
            require(
                ...
                "vampDOGE: This account cannot send tokens until trading is enabled"
            );
        }
        ...
        bool takefirstFewBlocks = firstFewBlocks &&
            tradingIsEnabled &&
            !swapping;
    ...
    function swapAndBuyback(uint256 tokenAmount) private {
        ...
        transferToAddressETH(
            marketingWallet,
            bnbSold.div(buybackFee).mul(manualBuybackFee)
        );
...
contract vampdogeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "vampdoge_Dividend_Tracker: No transfers allowed");
    }
    ...
    function withdrawDividend() public override {
        require(
            false,
            "vampdoge_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main vampdoge contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "vampdoge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "vampdoge_Dividend_Tracker: Cannot update claimWait to same value"
        );
