...
contract Presale is Ownable, ReentrancyGuard {
	...
	uint256 constant maxGoal = 187500 * (10**9) * 10**9;     //the goal bnb is 3125
	...
	uint256 constant price = 60 * 10**9  ;  //60
    ...
    constructor(IERC20 _token, uint256 _start, uint256 _dead1, uint256 _dead2, uint256 _dead3, uint256 _end, string memory _randome ) {
        tokenReward = _token;
		start = _start;
		deadline1 = _dead1;
		deadline2 = _dead2;
