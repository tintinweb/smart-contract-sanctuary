...
abstract contract RSunAuth {
    ...
    constructor(address owner_) {
        owner = 0x33C78813Aa20dE43238e19792A065070822c3f53;
...
contract SMH is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Skipping Mental Health";
    string constant _symbol = "SMH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 77 * 10 ** 9 * (10 ** _decimals); // 77 billion
    ...
    constructor () RSunAuth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xd2377bDA64928EeE9460a43f4bE8E217c8EEBa8e;
        marketingFeeReceiver = 0xd2377bDA64928EeE9460a43f4bE8E217c8EEBa8e;
