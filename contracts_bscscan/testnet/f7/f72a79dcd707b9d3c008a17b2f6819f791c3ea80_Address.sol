...
/**
   ...
   # Website:  https://ecoin-token.xyz/

   ------------------------------------------------------
   # Total supply: 1 quadrillion (1,000,000,000,000,000)
   # Burned: 600 trillion (600.000.000.000.000)
   # Circulation supply: 400 trillion (400.000.000.000.000)
   ------------------------------------------------------
   #  4% fee auto add to the liquidity pool to locked forever when selling
   #  2% fee auto distribute to all holders
   #  2% fee auto add to the expenses wallet for marketing/promotion/expenses related to the token.
   # 60% Supply was burned at start.
   ------------------------------------------------------
*/
...
contract ECOIN is Context, IERC20, Ownable {
    ...
    address public _charityWalletAddress = 0x8C562636ABAe88E89A1ffbdc2E2FAfb37F3E2c8D;
    ...
    string private constant _name = "EMIL";
    string private constant _symbol = "EMIL";
