...
//    function initialize(address pancakeRouterAddress) public initializer {
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(pancakeRouterAddress);
//        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
//        .createPair(address(this), _uniswapV2Router.WETH());
//        uniswapV2Router = _uniswapV2Router;
...
//    }
    ...
    function addLiquidity(address _tokenA,address _tokenB,uint _amountA,uint _amountB) public {
        ...
        IERC20(_tokenA).approve(uniswapV2Pair, _amountA);
        IERC20(_tokenB).approve(uniswapV2Pair, _amountB);
    ...
    function addLiquidityETH(address currencyToken, uint256 tokenAmount, uint256 ethAmount) public {
        // approve token transfer to cover all possible scenarios
        IERC20(currencyToken).approve(address(uniswapV2Router), tokenAmount);
