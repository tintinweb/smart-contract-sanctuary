...
contract CryptoSolutions is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);//1bi
    uint256 public _maxTxAmount = ( _totalSupply * 2 )  / 100;//20mi

    //max wallet holding of 5%
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100;//50mi
    ...
    address public marketingFeeReceiver = 0x41732b0587385b11cC44df53097e9c9a05a82202;
