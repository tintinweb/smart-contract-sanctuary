...
contract BingoBsc is ReentrancyGuard, Ownable {
    ...
    function setPlan(bytes32 _planName, uint _planTime, uint _planInterest) public onlyOwner isPlan(_planName) returns (bool) {
        if (_planName == PLAN_A) {
