...
/**
   #TestCoin 5
   Contract has Reflection, Burn, Charity, is lockable
   3% fee auto burned to dead address 
...
contract TestCoin5 is Context, IERC20, Ownable {
    ...
    string private _name = "TestCoin5";
    string private _symbol = "TCOIN5";
    ...
    address public charityWallet = 0xAD4A2909575aDF597067CB2a9ed4E9DC48bEA654;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
         // Create a uniswap pair for this new token - Test Swap - 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
         //  PS Live Router Address -  0x10ED43C718714eb63d5aA57B78B54704E256024E
         // PS Testnet - 0xD99D1c33F9fC3444f8101754aBC46c52416550D1  
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require (taxFee <= 3, "Maximum of 3%");
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require (liquidityFee <= 3, "Maximum of 3%");
        _liquidityFee = liquidityFee;
    }
    
    function setChartityFeePercent(uint256 charityFee) external onlyOwner() {
        require (charityFee <= 4, "Maximum of 4%");
    ...
    function setBurnFeePercent(uint256 burnFee) external onlyOwner() {
        require (burnFee <= 10, "Maximum of 10%");
        _burnFee = burnFee;
    }
