...
contract VIVAairdrop is Ownable {
  struct Claimer {
    address referer;
    uint256 tier1;
    uint256 tier2;
  ...
  uint256 public _claimTokenRegister = 1 * 1e15;
  uint256 public _claimTokenTier1 = 2 * 1e15;
  uint256 public _claimTokenTier2 = 3 * 1e15;
  uint256 public _claimTokenTier3 = 4 * 1e15;
  uint256 public _claimTokenTier4 = 5 * 1e15;
