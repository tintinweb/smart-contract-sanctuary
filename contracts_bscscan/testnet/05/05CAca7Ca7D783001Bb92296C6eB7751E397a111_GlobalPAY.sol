...
contract GlobalPAY is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 public _taxFee = 20; // 2% will be distributed among holder as Gpay divideneds
    ...
    uint256 public _burnFee = 50;  // 5% will go to the Dead address to deflate Gpay
    ...
    function setDisruptiveTransferEnabledFrom(uint256 _time) external onlyOwner {
        disruptiveTransferEnabledFrom = _time;
    }
