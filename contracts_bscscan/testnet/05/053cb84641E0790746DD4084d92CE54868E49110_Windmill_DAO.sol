...
abstract contract With_UpdaterContract is Base, AccessControlEnumerable, With_DAORole, I_With_UpdaterContract{
...
contract Windmill_DAO is Base, Math, Adressable, AccessControlEnumerable, With_DAORole, With_UpdaterRole,
    ...
    ////
    //////////////// Public variables ////////////////
    uint256 public constant nbProposals = 36;
    ...
    function _updateOneDAO(uint256 i) internal{
        ...
        bool isSuper = isProposalSuper[proposal.id];
