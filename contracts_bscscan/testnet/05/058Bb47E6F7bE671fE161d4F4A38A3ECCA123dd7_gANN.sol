...
// File contracts/governance/gANN.sol
...
contract gANN is IgANN, ERC20 {
    ...
    constructor(address _migrator, address _sANN)
        ERC20("Governance ANN", "gANN", 18)
    {
     ...
     * @param _sANN address
     */
    function migrate(address _staking, address _sANN) external override onlyApproved {
        ...
        require(_sANN != address(0), "Zero address found");
        sANN = IsANN(_sANN);
    }
    ...
    /**
     * @notice pull index from sANN token
     */
    ...
    /**
        @notice converts gANN amount to ANN
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts ANN amount to gANN
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gANN::getPriorVotes: not yet determined");
