...
/**
 * @title TokenPriceOracle Oracle
 *
 * @notice Provides a value onchain that's aggregated from a whitelisted set of
 *         providers.
 */
contract TokenPriceOracle is OwnableUpgradeSafe, IOracle {
    ...
    */
    ...
    /**
    * @notice Computes TokenPrice of provider reports whose timestamps are in the
    *         valid timestamp range.
    * @return AggregatedValue: TokenPrice of providers reported values.
