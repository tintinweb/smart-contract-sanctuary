...
contract DaisyDuck is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DaisyDuck";
    string private _symbol = "DD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfeC9535C385f347B0a2FD31e7b56393bB13b744E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xa6E4268ceF6A07787f559198bC0860F55C954865); // BuyBack Address
