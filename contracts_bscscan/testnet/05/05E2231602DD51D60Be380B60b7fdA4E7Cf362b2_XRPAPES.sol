...
contract XRPAPES is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8FB3DbF203b4ec634dCf49Ed812f80d26725113D); // Marketing Address
    ...
    string private _name = "XRP APES";
    string private _symbol = "$XRPAPES";
