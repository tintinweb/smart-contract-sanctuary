...
contract LigerDeFi is Context, ILigerBEP20, Ownable {
    ...
    constructor(address DEXaddress, address TreasuryAddress) public {
        ...
        // set the Treasury Address variable
    ...
    function setTreasuryFeeAddress(address newTreasuryAddress)
        external
        onlyOwner()
    {
        TreasuryVault = newTreasuryAddress;
    }
    ...
    function _tokenTransfer(
        ...
        if (TreasuryFee != 0 && TreasuryBool) {
            ...
            _transferStandard(sender, TreasuryVault, _treasuryFee);
        }
