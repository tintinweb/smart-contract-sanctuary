...
contract TestToken13 is Context, IBEP20, Ownable {
    ...
    string public constant name     = "TestToken13";
    string public constant symbol   = "TT13";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
		...
		// require transfer amount greater than zero
        require(amount > 0, "Transfer amount must be greater than zero");
