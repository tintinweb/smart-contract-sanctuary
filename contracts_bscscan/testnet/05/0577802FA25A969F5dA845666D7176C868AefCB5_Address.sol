...
contract  HomelessPeopleToken is Context, IERC20, Ownable {
    ...
    string private _name = "HWW Coin";
    string private _symbol = "HWWT";
    ...
    constructor() {
        ...
        _rOwned[deadWallet] = _rTotal.div(100).mul(30);
        emit Transfer(address(0), deadWallet, _tTotal.div(100).mul(30));        
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax fee, charity fee, marketing fee, liquidity fee
