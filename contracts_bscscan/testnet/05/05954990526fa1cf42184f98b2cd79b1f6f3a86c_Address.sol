...
contract SafemoonFork is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000 * 10**6 * 10**9; //CHANGE_OPTIONAL: total supply of token. Recommended to keep unchanged
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MyForkTest";      //CHANGE_REQUIRED: name of token
    string private _symbol = "MFT001";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
    ...
    uint256 public _maxTxAmount = 50000000 * 10**6 * 10**9;                  //CHANGE_OPTIONAL: max amount of tokens that can be transferred per transaction
    uint256 private numTokensSellToAddToLiquidity = 5000000 * 10**6 * 10**9; //CHANGE_OPTIONAL: minimum number of tokens in contract to sent to Pancakeswap pool
