...
contract BabyMidKnight is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMidKnight";
    string constant _symbol = "BMK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 500000000; // 100%
    ...
    uint256 public swapThreshold = _totalSupply / 50000; // 0.005%
    bool inSwap;
