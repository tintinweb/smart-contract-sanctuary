...
contract CryptoBoys is ERC721, Ownable {
  ...
  function setRedeemAddress(address to) public onlyOwner {
  ...
  function buyToken(uint256 _tokenId) public payable {
    ...
    require(cryptoboy.forSale == true, "Token not for sale");
  ...
  function redeem(uint _tokenId) public {
      ...
      _transfer(tokenOwner, redeemAddress, _tokenId);
