...
contract FeeCollector  {
  ...
  constructor() {
    ...
    function ApproveVault(IERC20 token, uint256 amount) public {
    ...
    function createVault(string memory name, IERC20 token, uint256 amount, uint256 duration) public payable returns(uint256 vaultId) {
