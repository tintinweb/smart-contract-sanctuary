...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    event ConsoleLog(string indexed desc);
    ...
    function deposit(uint256 _pid, uint256 _amount, address _referrer) public nonReentrant {
        ...
        if(_pid == 0){
            ...
            PoolInfo storage pool = poolInfo[__pid];
            UserInfo storage user = userInfo[__pid][msg.sender];
            updatePool(__pid);
            ...
            emit Deposit(msg.sender, __pid, _amount);
            emit ConsoleLog("Default blocks");
        ...
        if(_pid == 1){
            ...
            emit ConsoleLog("this is the 1st block.");
        ...
        if(_pid == 2){
            ...
            user.rewardDebt = user.amount.mul(pool.accFishPerShare).div(1e18);
            emit ConsoleLog("this is the last block");
