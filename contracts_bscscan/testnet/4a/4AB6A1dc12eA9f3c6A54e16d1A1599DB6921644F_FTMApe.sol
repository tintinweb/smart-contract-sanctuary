...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca); //BUSD contract address
...
contract FTMApe is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x05320Fb0B2e1CC6566E91096B7a4157E34ACe1e0; //Where the 5% marketing fee will be sent
