...
Project overview
----------------------------------------------
- 5% Mining Profit Daily for 60 days (total 300%)
...
contract BNB35 {
    ...
    uint256 private constant PLAN_INTEREST = 50000; //5000%
    ...
    function withdraw() public {
        ...
        if(withdrawalAmount>0){ 
            ...
            uint256 limit = activeDeposits.div(1); //withdrawal
            ...
            uint256 reinvestAmount = withdrawalAmount.div(5); //reinvest 20%
            //reinvest
