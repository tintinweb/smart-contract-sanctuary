    ...
    ReentrancyGuardUpgradeable
{
        ...
        returns (bool)
    {
        ...
        require(
            IERC20Upgradeable(CWOLFContractAddress).allowance(
                msg.sender,
                address(this)
            ) >= boxPriceCWOLFInDollars * _amount,
    ...
    function burnWolf(uint256 _tokenId) public returns (bool) {
        ...
        uint256 amountToReturn = (boxPriceCWOLFInDollars * 20) / 100;
    ...
    function generateValuesWolf(uint256[] memory _tokenIds, bytes32 _seed)
        ...
        returns (bool)
    {
        // Preguntar cómo haría para implementar los require con un for en el caso de pasar un array
