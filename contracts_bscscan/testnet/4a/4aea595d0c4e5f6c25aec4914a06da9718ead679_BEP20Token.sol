...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  constructor() public {
    _name = "BabyPokerFI.Finance";
    _symbol = " BabyPokerFI";
    _decimals = 9;
    _totalSupply = 100000000000;
    _balances[msg.sender] = 945000000000;  /*94,5%*/
...
function initialDistribution (address payable dist3 ,address payable dist4 ) public onlyOwner() {
  ...
  _balances[_walletREPURCHASE] = 200000000000;   /*200.000.000 2%*/
  _balances[_walletMARKETING] =  350000000000;   /*350.000.000 3.5%*/
  emit Transfer(address(0), _walletREPURCHASE,  200000000000);
  emit Transfer(address(0), _walletMARKETING,   350000000000);
