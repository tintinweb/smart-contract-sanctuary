...
contract PosiNFTMintProxy is Governance, IGegoRuleProxy{
    ...
    function cost( MintParams calldata params, Cost721Asset calldata costSet1, Cost721Asset calldata costSet2 ) external override returns (  uint256 mintAmount,address mintErc20 ){
