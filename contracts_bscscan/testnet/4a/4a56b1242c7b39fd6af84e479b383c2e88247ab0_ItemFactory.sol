...
contract ItemFactory is Ownable, IItemFactory {
    ...
    function _addTypeArtifact(
        ...
        require(_supportedArtifactIds.add(artifactId_), "ItemFactory: _supportedArtifactIds contains artifactId_");
    ...
    function addBoxType(uint256 boxType_) external onlyOwner {
        require(_supportedBoxTypes.add(boxType_), "ItemFactory: item type is already supported");
    }
