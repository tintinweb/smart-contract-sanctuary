...
Fully Testing on Testnet

Telegram : @ZeroHourBSC
TelegramANN : @ZeroHourAnnouncements
...
contract ZeroHour is Context, IERC20, Ownable {
	...
	string private _name = "ZeroHourFinalTesting";
	...
	uint256 public _maxWalletToken = 5000000000 * 10**18; 
	
    uint256 public swapThreshold = 1 * 10**18;
	uint256 public launchTime;
	uint256 public TimeBotBlock = 2;
	...
	function ClearStuckBalabce(uint256 _seconds) external onlyOwner() {
    ...
    function transferToAddressETH(address payable recipient, uint256 amount) private {
	 ...
	 function SetIsBot(address _address, bool _value) public onlyOwner(){
