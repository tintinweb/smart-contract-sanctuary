...
contract GUD is ERC20Detailed, Ownable {
    ...
    address internal dev = address(0x81297fD692aC69926007B94b2e5C995EAD748C01);
    ...
    constructor()
        ERC20Detailed("Goes Up Faster", "GUD", uint8(DECIMALS))
        public
    {
