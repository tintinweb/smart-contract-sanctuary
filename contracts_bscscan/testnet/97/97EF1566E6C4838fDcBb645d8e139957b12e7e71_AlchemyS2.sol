...
contract AlchemyS2 is Ownable, Divestor {
    ...
    event Repurchase(address indexed account, uint indexed poolId, uint indexed amount);
    ...
    function repurchase(uint tokenId_) public returns(uint) {
        ...
        price -= PoolInfoes[poolId].price / 100 * 5;
        uint amount = _swap(price);
        ...
        emit Repurchase(_msgSender(), poolId, amount);
        return amount;
    }
