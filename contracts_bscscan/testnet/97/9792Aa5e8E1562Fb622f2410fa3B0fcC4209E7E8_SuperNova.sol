...
contract SuperNova is OwnableUpgradeable {
    ...
    function initialize(
        ...
        minumumBNBBalance = 10**16; //0.01 BNB
        minumumNexusBalance = 10**3 * 10**18; // 1000 Nexus
        maxBNBTransaction = 5 * 10**18; // 5 BNB
        maxNexusTransaction = 100 * 10**3 * 10**18; // 100k Nexus
