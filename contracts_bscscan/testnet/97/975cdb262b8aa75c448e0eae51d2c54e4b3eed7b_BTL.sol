...
contract BTL is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "BTL";
    string private constant _symbol   = "BTL";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 400; // 3% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 400; // 3% of every transaction is kept for liquidity
