...
contract MedinaV5 is Context, IERC20, Ownable {
    ...
    string private _name = "MedinaV5";
    string private _symbol = "MED5";
    ...
    function setGiveawayAddress(address payable charity) public onlyOwner {
    ...
    function setGiveawayFeePercent(uint256 charityFee) external onlyOwner {
    //     _charityFee = 0;
    //     if(charityFee <= 5) {
