...
contract kidmad is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6aF7Ea6c1A46c79278Ca5D742b22d06bbA56f8F8); // Marketing Address
    ...
    string private _name = "kidmad";
    string private _symbol = "kidmad";
