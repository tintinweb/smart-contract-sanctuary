...
contract TESTINGTEST is ERC20, Ownable {
    ...
    CIVTESTDividendTracker public dividendTracker;
    ...
    // sell fees
    uint256 public sellDividendRewardsFee = 1;
    ...
    constructor() ERC20("CIVTEST", "CTEST") {
        dividendTracker = new CIVTESTDividendTracker();

        teamWallet = 0x169c329026afc6E7f896c6d98857977106c23981;
        devWallet = 0x9cD20040fbf99766CEA83bDaA11CA89f47f030aF;
        marketingWallet = 0xFE21a85666276b84661fA551b8B975703D217aBF;
    ...
    function whitelistPinkSale(address _presaleAddress) public onlyOwner {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        CIVTESTDividendTracker newDividendTracker = CIVTESTDividendTracker(
            payable(newAddress)
        );
...
contract CIVTESTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
