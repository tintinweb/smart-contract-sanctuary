...
contract TokenRewardRate {
    ...
    function removeIteamInArray(uint index, uint[] memory _array) internal pure returns(uint[] memory) {
        require(index >= _array.length);
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable, TokenRewardRate {
...
contract UniVerse is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    address public constant testAddress = 0x8A1eAA7f43D44D06ac1b7677FD6B979538EBc652;
    ...
    function upgradToken(uint256 _id) external onlyOwner {  //TODO: update furture;
        ...
        _burn(_id);
        rates = removeIteamInArray(_id, rates);
