...
contract Test is ERC721, Ownable {
    ...
    // Adopt your own Test on the Binance Smart Chain,
    ...
    // Decrease the MAX_Test variable only if these items aren't sold.
    ...
    function reserveGiveaway(uint256 numTest) public onlyOwner {
        uint currentSupply = totalSupply();
        require(numTest > 0 && numTest <= 50, "Max 50 to reserve at once");
        require(totalSupply().add(numTest) <= MAX_Test, "Exceeds MAX_Test");
