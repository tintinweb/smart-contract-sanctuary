...
contract PolkaBridgeINO is ERC1155, Ownable, ReentrancyGuard {
    ...
    function addWhitelist(address user, uint256 pid) public onlyOwner {
        ...
        uint256 packagesLength = pools[poolIndex].PackageIds.length;
   ...
   // Check if user IsWhitelist
    function IsWhitelist(address user, uint256 pid) public view returns (bool) {
        uint256 poolIndex = pid.sub(1);
        uint[] memory packageIds = pools[poolIndex].PackageIds;
        return whitelist[pid][packageIds[0]][user].IsWhitelist;
    }
        ...
        )
    {
        ...
        uint[] memory packageIds = pools[poolIndex].PackageIds;
        return (
            whitelist[pid][packageIds[0]][msg.sender].UserAddress,
            whitelist[pid][packageIds[0]][msg.sender].IsWhitelist,
            whitelist[pid][packageIds[0]][msg.sender].TotalETHPurchase,
            whitelist[pid][packageIds[0]][msg.sender].IsClaimed
        );
    }
