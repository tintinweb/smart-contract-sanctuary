...
contract FanDungeonLand is LandInfo, ERC721, ERC721Enumerable, OperatorControl {
    ...
    // Keep track of land info for a given token Id
    mapping(uint256 => Land) internal _lands;
     ...
     */
    function setLand(uint256 _tokenId, uint256 _landType,uint256 _terrain) external onlyOperator {
