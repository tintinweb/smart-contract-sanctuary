...
* WENPONZI ($WPZ)
*
* Tokenomics will be a tax of 12% Buy, 18% Sell and 18% to transfer between wallets 
*
* 50% for liquidity 
* 30% to burn wallet 
* 20% to staking
...
* Max per Holder: 40000
* Max sell: 10000
* Sell cool down: 5 minutes
*
*
* TG: t.me/WenPonzi
* 
...
contract WenPonzi is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'WenPonzi';
    string private constant _symbol = '$WPZ';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000 * 10**_decimals;//equals 10000 token
