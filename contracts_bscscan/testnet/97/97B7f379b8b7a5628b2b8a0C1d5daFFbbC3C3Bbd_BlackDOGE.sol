...
// Telegram Group => https://t.me/black_doge
// Website        => https://blackdoge.com
...
contract BlackDOGEDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("BlackDOGE_Dividend_Tracker", "BlackDOGE_Dividend_Tracker", 9) {
    	claimWait = 14400;
    ...
    function withdrawDividend() public override {
        require(false, "BlackDOGE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BlackDOGE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BlackDOGE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BlackDOGE_Dividend_Tracker: Cannot update claimWait to same value");
...
contract BlackDOGE is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public BEP20("BlackDOGE", "BDOGE", 9) {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BlackDOGE: The dividend tracker already has that address");

        BlackDOGEDividendTracker newDividendTracker = BlackDOGEDividendTracker(payable(newAddress));
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "BlackDOGE: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BlackDOGE: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "BlackDOGE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BlackDOGE: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BlackDOGE: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BlackDOGE: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BlackDOGE: Cannot update gasForProcessing to same value");
        emit GasForProcessingUpdated(newValue, gasForProcessing);
        gasForProcessing = newValue;
    }
    
    function initializeBlackDOGE(uint256 initialTokenAmount) public onlyOwner {
        /*
