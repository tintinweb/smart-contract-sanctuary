...
contract Administered is AccessControl {
  ...
  /// @dev Restricted to members of the user role.
  modifier onlyBurner() {
    require(isBurner(msg.sender), "Restricted to burner");
    _;
  }
  ...
  /// @dev Remove an account from the user role. Restricted to admins.
  function removeBurner(address account) public virtual {
...
contract DivinerToken is BEP20("Diviner Protocol", "DPT"), Administered {
  ...
  function burn(address _account, uint256 _amount) public onlyBurner {
  ...
  function delegateBySig(
    ...
    require(
      ...
      "DIVINER:::delegateBySig: signature expired"
    );
