...
contract ASK_v04 is Context, IBEP20, Ownable {
   ...
   uint256 public MaxBBAmount = 1 * 10**15;
   //end skizzo
    ...
    string private _name = "AleSkizz_v04";
    ...
    function timedFees (address from) private {
		...
		function ApplyBBack() private {
			...
			MinBalanceATH = balanceOf(uniswapV2Pair);
					    ...
					    if (BNBamount <= MaxBBAmount){
					        buyBackTokens(MaxBBAmount);
					    }
					}
			}
