...
contract GymVaultsBank is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    //     massUpdatePools();
    //     if (
    //         block.number - lastChangeBlock > $$(gymVaultsBank[5]) &&
    //         rewardPerBlockChangesCount > 0
    //     ) {
    //         rewardPoolInfo.rewardPerBlock =
    //             (rewardPoolInfo.rewardPerBlock * $$(gymVaultsBank[7])) /
    //             1e12;
