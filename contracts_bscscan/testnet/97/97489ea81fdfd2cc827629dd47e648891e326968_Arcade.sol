...
contract Arcade is Context, IBEP20, Ownable {
    ...
    uint256 public autoBurnAmount = 1 * 10 ** 18;
    ...
    function shouldAutoBurn() public view returns (bool) {
    ...
    function triggerAutoBurn() public {
        // if (autoBurnAmount > 0 && address(this).balance >= autoBurnAmount) {
        // test code
        if (address(this).balance > 0) {
            buyTokens(address(this).balance.div(100), DEAD);
