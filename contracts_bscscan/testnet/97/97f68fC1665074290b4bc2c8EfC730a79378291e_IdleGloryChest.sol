    ...
    Ownable
{
    ...
    function mint(address to, uint256 tokenId) public virtual {
        require(
            ...
            "IdleGloryChest: must have minter role to mint"
        );
        require(
            !_exists(tokenId),
            "IdleGloryChest: must have unique tokenId"
        );
    ...
    function mintBatch(address to, uint256[] memory tokenIds) public virtual {
        ...
        require(
            counter > 0,
            "IdleGloryChest: number of tokens must be greater then 0"
        );
