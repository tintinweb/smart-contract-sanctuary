...
contract Ploutus is Context, IBEP20, Ownable {
...
contract Banki{
   ...
   Ploutus public tokenContract;

    constructor(uint256 _minimumStake, address _tokenContract, address _multisigVault) public payable{
        owner= msg.sender;
        tokenContract = Ploutus(_tokenContract);
    ...
    function staking(uint256 amount) public{
     ...
     tokenContract.transfer(multisigVault,amount);
    ...
    function checkStakerStatus(address stake) public view returns(bool){
