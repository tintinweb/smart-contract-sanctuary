...
contract PSHIBtest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFCa7B672f85Fe85FAFbD26dD519b541DF9302B6C); // y 
    ...
    string private _name = "POWER SHIBAtestnet";
    string private _symbol = "P-SHIBtest";
    ...
    uint256 public _buyBackRangeRate = 1;
    ...
    uint256 public _maxTxAmount = 3000 * 10**3 * 10**9;  // 0,3% of supply
    uint256 private minimumTokensBeforeSwap = 200 * 10**3 * 10**9; // 0,02% of supply 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000 * 10**3 * 10**9;
    }
