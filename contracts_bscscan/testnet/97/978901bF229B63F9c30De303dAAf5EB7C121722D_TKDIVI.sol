...
contract TKDIVI is ERC20, Ownable {
    ...
    constructor() public ERC20("DiviPlanTest", "DVPLT") {
        // LP burn address
    ...
    function _transfer(
        ...
        if(takeFee || buyOrSell) {
            ...
            // added if to exclude burn from those excluded from fees
...

{
  ...
  "evmVersion": "istanbul",
  "libraries": {
    "/Users/fly/Desktop/dev/safeFlight/contracts/buybackTokenNoTransferFeesWithBurn.sol": {
      "IterableMapping": "0x2c90Db1765030f261A65B0668609D9130B7CFFB9"
    }
  },
  "outputSelection": {
    "*": {
