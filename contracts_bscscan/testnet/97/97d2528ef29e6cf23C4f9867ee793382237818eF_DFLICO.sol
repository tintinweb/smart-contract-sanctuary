...
contract DFLICO  {
	...
	function withdraw() public payable 
	{
        ...
        uint256 totalToken=users[msg.sender].freeStakedToken+((withdrawalAmount.div(tokenPrice)).mul(1e18))+((users[msg.sender].levelBonus.div(tokenPrice)).mul(1e18));
        ...
        total_virtual_withdraw=total_virtual_withdraw+(totalToken*tokenPrice);
