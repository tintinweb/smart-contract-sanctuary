...
contract MythicsNFT is ERC721URIStorage, IERC721Enumerable, Ownable
{
    ...
    constructor(address payable feeAddress)  ERC721("Mythics Leader","MythicsNFT") {               
        ...
        priceListByRarity[CommonRarity] = 1 / 4 * 10 ** 18; // 0.25 BNB
        priceListByRarity[RareRarity] =   1 / 2 * 10 ** 18; // 0.5 BNB
        priceListByRarity[UltraRareRarity] = 1 * 10 ** 18; // 1 BNB
    ...
    */
    ...
    //TOOD: New Base URI for mechbots
    function _baseURI() override internal pure returns (string memory) {        
        return "https://ipfs.io/ipfs/QmfWkj94SxMo7ym7vmmNRSWWLvhZ7GKNrvELs8mJb72Afp/";
    }
