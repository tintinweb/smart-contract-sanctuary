...
contract start1 is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "start1";
	string private _symbol = "start1";
	...
	function _transfer(
		...
		if(_isStart == true && from == addressPoolPancake){
		    require(balanceOf(to) <= _startLimit, "Wait 5 minutes");
		}
