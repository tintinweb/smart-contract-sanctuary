...
/**
    IGU CASINO BSC TOKEN
    
    I suggest the following telegram group: https://t.me/igucasino


    Token info:

   100,000,000,000,000,000 total supply
   500,000,000,000,000 IGU max limit for per trade
   ...
   I will add some liquidity all the left 50% total supply to the pool
   ...
   helping pool grow from the small init pool.
...
contract IGU is Context, IERC20, Ownable {
    ...
    string private _name = "IGU CASINO";
    string private _symbol = "IGU";
