 ...
 */
contract TESTJURASSIC is Context, IBEP20, Ownable, AntiWhale {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "TESTJURASSIC";
    string private _symbol = "TestJ";
    uint8 private _decimals = 18;

    uint256 constant maxCap = 150000000 * (10**18);
