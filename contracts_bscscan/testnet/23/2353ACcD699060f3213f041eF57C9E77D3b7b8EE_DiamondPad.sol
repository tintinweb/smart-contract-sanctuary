...
contract DiamondPad is ERC20, Ownable {
    ...
    address public marketingWallet = 0xC1A23f4825C351f07874B1cdb6Ae348D545Fac3D;
    address public buybackWallet = 0x95B20B927E7Da0805AD72610f1F62E621D2bc90e;
    ...
    function updatePancakeRouter(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeRouter), "DiamondPad: The router already has that address");
    ...
    function excludeFromPeriodLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromPeriodLimit[account] != excluded, "DiamondPad: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTxLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTxLimit[account] != excluded, "DiamondPad: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "DiamondPad: This account cannot send tokens until trading is enabled");
        }
...
contract DiamondPadDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DiamondPadDividendTracker", "Diamond_DividendTracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**decimals()); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "DiamondPadDividendTracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "DiamondPadDividendTracker: withdrawDividend disabled. Use the 'claim' function on the main Diamond contract.");
    }
