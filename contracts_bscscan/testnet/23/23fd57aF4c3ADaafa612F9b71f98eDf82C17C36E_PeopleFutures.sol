...
contract PeopleFutures {
    ...
    event EscrowCreated(string escrowId, address sponsor, address prospect, uint256 totalPayment, uint256 escrowPercent, uint256 feePercent, uint256 numberOfYears, uint256 firstYear, uint256 agreementInitialPayout);
    ...
    function initializeNewContract(
        ...
        emit EscrowCreated(contractId, _sponsor, _prospect, _totalPayment, _escrowPercent, _feePercent, _numberOfYears, _firstYear, _agreementInitialPayout);
    }
    ...
    function initializeValues(
        ...
        emit InitializeValuesEvent(_contractId, escrows[_contractId].sponsor, escrows[_contractId].prospect, _tierOnePercent, _tierTwoPercent, _tierThreePercent, _tierTwoMinimum, _tierThreeMinimum, _minimumPayout);
    ...
    function calculateProjectedPayout(string memory _contractId) public {
        ...
        emit CalculateProjectedPayoutEvent(_contractId, escrows[_contractId].projectedPayout);
    }
    ...
    function initialPayment(address _sponsor, string memory _contractId) public virtual onlyAdmin {
        ...
        emit InitialPaymentMade(_contractId, escrows[_contractId].sponsor, escrows[_contractId].prospect, escrows[_contractId].totalPayment);
    ...
    function reportEarnings(string memory _contractId, uint256 _earnings) public virtual onlyAdmin {
        ...
        emit ProspectReportedEarnings(_contractId, currentYear, _earnings);
    ...
    function verifyEarningsReport(string memory _contractId,uint256 _earnings) public virtual onlyAdmin {
        uint256 currentYear = DateTime.getYear(block.timestamp);
    ...
    function payPortionOfEarnings(string memory _contractId) public virtual onlyAdmin {
        uint256 currentYear = DateTime.getYear(block.timestamp);
        ...
        emit ProspectPaidSponsor(_contractId, escrows[_contractId].sponsor, escrows[_contractId].prospect, earningReports[_contractId].payout);
        emit EscrowReleased(_contractId, escrows[_contractId].sponsor, escrows[_contractId].prospect, earningReports[_contractId].escrowAmount);
    ...
    function getTotalPayment(string memory _contractId) public virtual onlyAdmin view returns(uint256) {
        return escrows[_contractId].totalPayment;
    }

    function getEscrowPercent(string memory _contractId) public virtual onlyAdmin view returns(uint256) {
        return escrows[_contractId].escrowPercent;
    }

    function getProjectedEarnings(string memory _contractId) public virtual onlyAdmin view returns(uint256[] memory) {
    ...
    function getAgreementInitialPayout(string memory _contractId) public virtual onlyAdmin view returns(uint256) {
        return escrows[_contractId].agreementInitialPayout;
    }

    function getSponsor(string memory _contractId) public virtual onlyAdmin view returns(address) {
        return escrows[_contractId].sponsor;
    }

    function getNumberOfYears(string memory _contractId) public virtual onlyAdmin view returns(uint256) {
        return escrows[_contractId].numberOfYears;
    }

    function getBaseEscrow(string memory _contractId) public virtual onlyAdmin view returns(uint256[] memory) {
        return escrows[_contractId].baseEscrowBalances;
    }

    function getProjectedPayout(string memory _contractId) public virtual onlyAdmin view returns(uint256[] memory) {
    ...
    function setPrompti(address _newPrompti) public virtual onlyAdmin {
        prompti = _newPrompti;
    }
    ...
    function balanceOf(address account) public virtual onlyAdmin view returns (uint256) {
        return balances[account];
    }


    function deposit(address _owner, uint _amount) public virtual onlyAdmin {
        balances[_owner] += _amount;
        emit Deposit(_owner, _amount);
    }

    function withdraw(address _owner, uint _amount) public virtual onlyAdmin {
