...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private _totalSupply=2500000;
  ...
  // BHFSTToken with Governance.
contract BHFSTToken is BEP20('BHFST Token', 'BHFSTTOKEN') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BHFSTToken::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BHFSTToken::delegateBySig: invalid nonce");
        require(now <= expiry, "BHFSTToken::delegateBySig: signature expired");
