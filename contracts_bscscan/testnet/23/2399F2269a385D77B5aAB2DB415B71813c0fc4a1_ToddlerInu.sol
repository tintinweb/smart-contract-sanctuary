...
- Ownership will be transfered in the future to our toddlerDAO
- marketingAddress is used for buying lottery gift
*/
...
contract ToddlerInu is Context, IERC20, Ownable {
    ...
    // address public constant pancakeSwapRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // ON BSC MAINNET
    address public constant pancakeSwapRouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // ON BSC TESTNET
    // address public constant pancakeSwapRouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // ON ALL ETHEREUM NETWORK
    ...
    function calculateLiquidityFee(uint256 _amount, address recipient)
        private
        view
        returns (uint256)
    {
