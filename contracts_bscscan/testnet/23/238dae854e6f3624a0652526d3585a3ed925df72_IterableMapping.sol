...
contract BabyBUSD is ERC20, Ownable {
    ...
    // uint256 public maxBuyTranscationAmount = (_totalSup * 400) / 400;
    ...
    // uint256 public _maxWalletToken = (_totalSup * 100) / 100; // 2% of total supply

    uint256 public maxBuyTranscationAmount = (_totalSupply * 1) / 400 * (10**18);
    uint256 public maxSellTransactionAmount = (_totalSupply * 1) / 400 * (10**18); //0.25% of total supply
    uint256 public swapTokensAtAmount = (_totalSupply * 1) / 2000 * (10**18); // 0.05% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 100) / 100 * (10**18); // 2% of total supply
...
contract BabyBUSDDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BabyBUSD2_Dividend_Tracker", "BabyBUSD2_Dividend_Tracker") {
    	claimWait = 60;
