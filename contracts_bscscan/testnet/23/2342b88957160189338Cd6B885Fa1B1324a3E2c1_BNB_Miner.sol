...
contract BNB_Miner{
    ...
    constructor() public{
        ...
        ceoAddress2=payable(address(0x35B01cbA279E670406FB7E1Cdb95634D47Ae04cA));
    }
    ...
    function getEggsSinceLastHatch(address adr) public view returns(uint256){
        uint256 secondsPassed=min(BNB_TO_HATCH_1MINERS,SafeMath.sub(block.timestamp,lastHatch[adr]));
