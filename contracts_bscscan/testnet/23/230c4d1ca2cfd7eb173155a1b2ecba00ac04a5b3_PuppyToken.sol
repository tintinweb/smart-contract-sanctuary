...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "PUPPY";
    ...
    uint256 internal constant TOTAL_SUPPLY = 20000000000 * ZEROES;
    ...
    address internal charityAddress = 0xF066f366d85529D574E99Eff5e843937A6589386;
    address internal ventureCapitalAddress = 0xB4e466c05297349C19481Fa0cD3f91273D68fC3b;
     ...
     */
    address internal tipToDevsKid1 = 0x2bB7bec8f19ed641d2c70b062DfB7827d29eB877;
    address internal tipToDevsKid2 = 0xF681fE01fF9e98FB225D6f32EFAAd4C3F72A6D9d;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Liquidity, 23, address(this));
        _addFee(FeeType.External, 5, charityAddress);
        _addFee(FeeType.External, 15, ventureCapitalAddress);

        // 0.1% as a tip to the devs kids
        _addFee(FeeType.ExternalToETH, 1, tipToDevsKid1);
        _addFee(FeeType.ExternalToETH, 1, tipToDevsKid2);
    }
...
contract PuppyToken is SafeToken {
