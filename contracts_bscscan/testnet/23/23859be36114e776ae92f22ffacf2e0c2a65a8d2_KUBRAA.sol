...
contract KUBRAA is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 300 * 10**12 * 10**18; 
    ...
    string private _name = "KUBRAA";
    string private _symbol = "KUBRAA";
