...
contract EarlyBird is ERC20, Ownable {
    ...
    function swapETHForBUSD(uint256 ethAmount, address who) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        swapETHForBUSD(half, operations1Address);
        swapETHForBUSD(otherHalf, operations2Address);
...
contract EarlyBirdDividendTracker is DividendPayingToken, Ownable {
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            // if no tokenAddress assume BUSD payout
            if (
                !allowCustomTokens ||
                ...
                address[] memory path = new address[](2);
                path[0] = uniswapV2Router.WETH();
                path[1] = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; //BUSD
