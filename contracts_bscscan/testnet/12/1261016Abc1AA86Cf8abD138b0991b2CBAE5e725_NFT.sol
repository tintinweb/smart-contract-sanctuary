...
contract NFT is ERC721, Ownable {
    ...
    modifier onlyMinter(address user) {
        require(minter[user], "Only Minter");
        _;
    }

    function setMinter(address _minter, bool _isMinter)
        public
        onlyOwner
    {
    ...
    function mint(string memory _tokenURI, address _toAddress, uint _price) public onlyMinter(msg.sender) returns (uint) {
