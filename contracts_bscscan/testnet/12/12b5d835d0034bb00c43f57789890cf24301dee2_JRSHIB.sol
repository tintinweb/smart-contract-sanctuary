...
contract JRSHIB is Context, IERC20, Ownable
{
    ...
    string private _name 	= 'TEST500';
    string private _symbol 	= 'TEST500';
    ...
    uint256 public MIN_BUY_SELL_TXN_AMOUNT 	= 4000000000000;
    ...
    function _getETHBalance() public view returns(uint256 balance) {
        ...
        function _getselllimit() public view returns(uint256 balance) {
        return MIN_BUY_SELL_TXN_AMOUNT;
    }
