...
//SushiChef Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract SushiChef is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SushiChef';
    string private constant _symbol = 'SCHEF';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1 * 10**9 * 10**_decimals;//equals 1.000.000.000 token

    //Divider for the MaxBalance based on circulating Supply (2.5%)
    uint8 public constant BalanceLimitDivider=40;
    //Divider for the Whitelist MaxBalance based on initial Supply(1%)
    uint16 public constant WhiteListBalanceLimitDivider=100;
    ...
    uint16 public constant MaxSellLockTime= 4 hours;
    //TODO: Change to 7 days
    //The time Liquidity gets locked at start and prolonged once it gets released
    uint256 private constant DefaultLiquidityLockTime=2 days;
    //The Team Wallet is a Multisig wallet that reqires 3 signatures for each action
    address public constant TeamWallet=0x34b7cdA09AaE5E6aa924D213b62b9443dF3afD07;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimSUSHI(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawSUSHI(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimSUSHI(address addr) private{
        ...
        path[1] = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;  //Binance-Peg Sushi Token
        ...
        emit OnWithdrawSUSHI(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function SUSHIWithdraw() public{
        claimSUSHI(msg.sender);
    }
