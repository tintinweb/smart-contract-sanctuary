...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD contract address
    ...
    function setDistributionCriteria(uint256 newMinPeriod, uint256 newMinDistribution) external override heliumToken {
        minPeriod = newMinPeriod;
        minDistribution = newMinDistribution;
    }

    function setShare(address shareholder, uint256 amount) external override heliumToken {
    ...
    function deposit() external payable override heliumToken {
    ...
    function process(uint256 gas) external override heliumToken {
    ...
    function claimDividend(address shareholder) external heliumToken{
        distributeDividend(shareholder);
    }

    function rescueDividends(address to) external heliumToken {
        RewardToken.transfer(to, RewardToken.balanceOf(address(this)));
    }

    function setRewardToken(address _rewardToken) external heliumToken{
...
pragma solidity ^0.7.4;
contract FCUM is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "ApprovedTrash";
    ...
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = _totalSupply * 15 / 100; // 15% of total supply.
    uint256 public _walletMax = _totalSupply * 15 / 100; // 15% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x97b1BEDec00dD9Ca4b3A88192A96d3B2D25476e5;
