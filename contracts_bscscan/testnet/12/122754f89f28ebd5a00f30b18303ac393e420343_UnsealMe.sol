...
contract UnsealMe is Context, Ownable, ReentrancyGuard {
    ...
    function unseal() public nonReentrant payable {
        ...
        uint256 beforeSentBalance = (address(this).balance) - SentAmount;
        uint256 payableAmount = (beforeSentBalance * _entryPricePercentage) / (10**2);
...
//0x9bA8030157DEA7F0d5A71d4f5c2B6eF76aFF589b