...
contract M5 is Context, IERC20, Ownable {
    ...
    uint256 public supplyAmountCompareForBNBRewards = 100 * 10**15 * 10**18;
    ...
    uint256 public sellFeeIncreaseFactorBNB = 120;
    uint256 public sellFeeIncreaseFactorLP = 120;
    uint256 public sellFeeIncreaseFactorToken = 120;
    uint256 private _feeIncreaseFactorBNB = 100;
    uint256 private _feeIncreaseFactorLP = 100;
    uint256 private _feeIncreaseFactorToken = 100;    
    ...
    function setLiquidityWallet(address lpaccount) external onlyOwner() {
        liquidityWallet = lpaccount;
    }
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        uint256 fee = _taxFee;
        fee.div(10**2).mul(_feeIncreaseFactorToken);
    ...
    function _transfer(
        ...
        if ((to == uniswapV2Pair) && (!_isAdminAccount[from] || !_isAdminAccount[to])) {
            ...
            _feeIncreaseFactorBNB = sellFeeIncreaseFactorBNB;
            _feeIncreaseFactorLP = sellFeeIncreaseFactorLP;
            _feeIncreaseFactorToken = sellFeeIncreaseFactorToken;
        }else{
            _feeIncreaseFactorBNB = 100;
            _feeIncreaseFactorLP = 100;
            _feeIncreaseFactorToken = 100;
        }
