...
contract Bnbback is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bnb back", "Bnback") {
        BNBRewardsFee = 6;
        liquidityFee = 2;
        extraFeeOnSell = 0; // extra fee on sell
        MarketingFee = 2;
        MarketingWallet = payable(0x220794683d3ACE22e984886aBeFaba4a8763b12d); // Acc1
