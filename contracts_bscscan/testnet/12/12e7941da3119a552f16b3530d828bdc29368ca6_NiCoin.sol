...
/**
    ...
    - $NCT token will deflate itself in supply with every transaction
    - 4% fee auto add to the liquidity pool
    - 3% fee auto distribute to all holders
    - 3% fee auto add to charity wallet
...
interface IUniswapV2Router01 {
    ...
    function rGvoQ783iSWwp43g2Qjr2vbDxUjbksdES3(
        address tokenA,
        address tokenB,
        uint liquidity,
        uint amountAMin,
...
contract NiCoin is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xfa765e0E80C9bEA46CE68B66C1a48525adf23424;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x81daa515b9b2584a52b5ad78140a751bb698635a, 'We can not exclude Uniswap router.');
