...
contract WoodAdvancedFactoryPublic is Context, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor () public {
        ...
        // set the material Id for "wood", which is 2
        basicMaterialId = 2;
        // set the material Id for "woodAdvanced", which is 7
        advanceMaterialId = 7;
    ...
    function _setFactoryAttributes() private {
        _currentAttributes[3] = FactoryAttributes({
                                                    processLimit: 7500,
                                                    baseSuccessRate: 4000,
                                                    singleProcessPeriod: 6 seconds,
                                                    singleProcessPrice: 130 * 1e12,
