...
// Root file: contracts/pools/BeaverSwapPool.sol
...
contract BeaverSwapPool is IPoolStrategy, Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    IERC20 public stakingToken;
    IBeaverChef public beaverChef;
    IBeaverMinter public beaverMinter;
    ...
    function rewardOf(address account) external view override returns (uint256) {
        return beaverChef.pendingBeaver(address(this), account);
    }
    ...
    function withdraw(uint256 amount) public override nonReentrant {
        ...
        beaverChef.notifyWithdrawn(msg.sender, amount);
    ...
    function getReward() public override nonReentrant {
        uint256 beaverAmount = beaverChef.safeBeaverTransfer(msg.sender);
        emit ProfitPaid(msg.sender, beaverAmount);
    }
    ...
    function setBeaverChef(IBeaverChef newChef) public onlyOwner {
        beaverChef = newChef;
    }

    function setBeaverMinter(IBeaverMinter newMinter) public onlyOwner {
        beaverMinter = newMinter;
    }
    ...
    function _deposit(uint256 amount, address _to) private whenNotPaused {
        ...
        beaverChef.notifyDeposited(_to, amount);
