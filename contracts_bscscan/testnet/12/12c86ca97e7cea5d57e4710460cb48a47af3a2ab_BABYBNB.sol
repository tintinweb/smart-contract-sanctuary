...
// WELCOME TO BABYBNB
// THE ORIGINAL BNB REWARD TOKEN!
// HOLD BABYBNB AND CLAIM BNB REWARDS.
...
contract BABYBNB is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0x46501BdB129B432ab7Dfdf11a3A729e5E3655f14;
    ...
    uint256 private _tTotal = 100000 * 10 ** 6 * 10 ** 9; // 100,000,000,000
    ...
    uint256 public _taxFee = 1; //redistribution of BBNB
    uint256 private _previousTaxFee = _taxFee; 

    uint256 public _liquidityFee = 15; // 5% will be added pool, 10% will be converted to BNB for a reward
