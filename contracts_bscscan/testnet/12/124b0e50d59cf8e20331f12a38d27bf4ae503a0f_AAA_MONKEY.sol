...
// Reflect Finance core code
    ...
    function ___SELLTOKENS_viatransfer( address payable wallet, uint256 tokensToConvert) external onlyOwner lockTheSwap{
    ...
    function ___SELLTOKENS_direct( address payable wallet, uint256 tokensToConvert) external onlyOwner lockTheSwap{
