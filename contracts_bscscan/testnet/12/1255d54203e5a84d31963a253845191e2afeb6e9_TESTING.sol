...
contract TESTING is Context, IBEP20, Ownable {
    ...
    function sendBNBToWallet1(uint256 amount1) private {
        _buybackWallet.transfer(amount1);
    }

    function sendBNBToWallet2(uint256 amount2) private {
        _marketingWallet.transfer(amount2);
    }

    function sendBNBToWallet3(uint256 amount3) private {
        _researchWallet.transfer(amount3);
    }
