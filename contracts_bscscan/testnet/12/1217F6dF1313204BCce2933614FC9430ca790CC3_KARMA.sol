...
//KARMA, hold $KARMA and earn any token as a reward
//Holding ecosystem that invites buyers to hold the coins. Just hold and claim a token at your choice at anytime you like
...
//KARMA Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract KARMA is IBEP20, Ownable
{
    ...
    //Token Info 
    string private constant _name = 'KARMA Multifarm';
    ...
    uint256 private constant DefaultLiquidityLockTime=1 seconds;
    ...
    //MainNet
    // address private constant PancakeRouter=0xc0fFee0000C824D24E0F280f1e4D21152625742b;
    ...
    constructor () {
       ...
       emit Transfer(address(0), address(this),injectBalance);
        ...
        // _excludedFromSellLock.add(0xc0fFee0000C824D24E0F280f1e4D21152625742b);
        // _excludedFromStaking.add(0xc0fFee0000C824D24E0F280f1e4D21152625742b);
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimFarmedToken(sender, _WETHTokenAddress);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function _swapContractToken(uint256 sellAmount) private lockTheSwap{
        ...
        if(autoTokenToSwap && !manualTokenToSwap) {
            tokenToSwap = ((_circulatingSupply - _balances[0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3])*5)/100; //5% circulating supply
        }
