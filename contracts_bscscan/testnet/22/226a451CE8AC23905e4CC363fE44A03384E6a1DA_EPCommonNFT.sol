...
contract EPCommonNFT is ERC721, Ownable, MinterRole {
    ...
    uint public constant MAX_PURCHASE_AMOUNT = 5;
    ...
    constructor(string memory name, string memory symbol, uint256 maxSupply) ERC721(name, symbol) {
        ...
        creator = msg.sender;
        uint mintIdx = totalSupply();
        _safeMint(address(msg.sender), mintIdx);
    }
    ...
    function toggleSaleEnableStatus() public onlyOwner {
        saleEnabled = !saleEnabled;
    }

    function setStartIndexBlock() public onlyOwner {
        require(startIndexBlock == 0, "Starting index block is already set");
	 ...
	 */
    function mint(address to, uint qty) public virtual onlyMinter {
