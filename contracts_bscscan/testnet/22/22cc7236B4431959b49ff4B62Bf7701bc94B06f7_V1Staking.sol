...
// File contracts/IBEP20Mintable.sol
...
contract V1Staking is Ownable {
    ...
    constructor() public {
        ...
        add(108e6, IBEP20(0xde41b94464E0a064CD15180579da10723ce90568), IBEP20(0xde41b94464E0a064CD15180579da10723ce90568), 0, 0, 0, _withdrawFee);
    }
    ...
    function add(
        ...
        require(address(_stakedToken) != address(0), "Invalid Staked token address");
        require(address(_rewardToken) != address(0), "Invalid Reward token address");
        require(poolInfo.length <= 1000, "Pool Length Full!");
        require(!poolExists[address(_stakedToken)][address(_rewardToken)], " Pool Already Exists!");
    ...
    function deposit(uint256 _pid, uint256 _amount) external {
        ...
        PoolInfo storage pool = poolInfo[_pid];
        require(!pool.lockDeposit, " Deposit Locked!");
        UserInfo storage user = userInfo[_pid][msg.sender];
        updatePool(_pid);
        payOrLockupPendingToken(_pid);
        if (_amount > 0) {
            require(_amount >= poolInfo[_pid].minDeposit, " Not Enough Required Staking Tokens!");
    ...
    function emergencyWithdraw(uint256 _pid) external {
        ...
        require(amount != 0, " Not enought staked tokens!");
    ...
    function emergencyAdminWithdraw(uint256 _pid) external onlyOwner {
        ...
        require(balanceToWithdraw != 0, " Not enough balance to withdraw!");
