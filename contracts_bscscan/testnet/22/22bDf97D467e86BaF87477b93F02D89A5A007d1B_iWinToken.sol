...
abstract contract Lottery is BaseErc20 {
    ...
    function setIsLotteryExempt(address who, bool enabled) public onlyOwner {
        excludedFromLottery[who] = enabled;
    }
    
    function setLotteryMinimumSpend(uint256 minimumSpend) public onlyOwner {
    ...
    function setLotteryChance(uint256 chance) public onlyOwner {
        lotteryChance = chance;
    }
    
    function setLotteryCooldown(uint256 second) public onlyOwner {
...
abstract contract AntiSniper is BaseErc20 {
   ...
   function sniperTax() public virtual view returns (uint256) {
    ...
    function setMaxGasLimit(uint256 amount) public onlyOwner {
        maxGasLimit = amount;
    }
