...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #CATENA  

    I make this #CATENA to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/lacatenadeiblocchi
   ...
   I will renounce the ownership to burn addresses to transfer #CATENA to the community, make sure it's 100% safe.

   I will add 0.1 BNB and all the left 49.5% total supply to the pool
   ...
   it's the best part of the #CATENA idea, increasing the liquidity pool automatically, 
...
contract CatenaProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Catena Protocol";
    string private _symbol = "CTENA";
