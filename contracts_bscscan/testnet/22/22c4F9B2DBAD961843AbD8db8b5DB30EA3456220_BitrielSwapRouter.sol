    ...
    SelfPermit
{
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IBitrielPool) {
        return IBitrielPool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    /// @inheritdoc IBitrielSwapCallback
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x47d63d19f08f0e698fa6ca2ad5dc62ac8f27c2828b23f5cd2cb224f72290dde8;
    ...
    /// @param factory The Bitriel factory contract address
