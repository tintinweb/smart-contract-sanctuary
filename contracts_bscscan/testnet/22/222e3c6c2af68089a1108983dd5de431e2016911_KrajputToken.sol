...
contract KrajputToken {
    string public name = "Krajput Token";
    string public symbol = "KRT";
    uint256 public totalSupply = 10000000000000* 10 ** 9; // 1 million tokens
...
contract MultiSend is Ownable {
  function transferMultiple(address _tokenAddress, address[] recipients, uint256[] values) public onlyOwner returns (uint256) {
    KrajputToken token = KrajputToken(_tokenAddress);
