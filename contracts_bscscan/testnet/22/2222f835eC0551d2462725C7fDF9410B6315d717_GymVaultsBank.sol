...
contract GymVaultsBank is ReentrancyGuard, Ownable {
    ...
    address constant buyBack = 0x10ee57952F5bA4aC70b1666aBb6CB09cBd26B49D;
    address public farming;
    // contracts[7] - RelationShip address
    address constant relationship = 0xf79357b75a0Ff9b7Cb6843CbA3057D71a20bcb2d;
     ...
     */
    function getBNBAmount(uint256 _pid, address _user)
        public
        view
        returns (uint256)
    {
        ...
        uint256 pendingAlpacaContract = IFairLaunchV1(0xac2fefDaF83285EA016BE3f5f1fb039eb800F43D)
        ...
        uint256[] memory alpacaToBNBAmount = IPancakeRouter02(0x367633909278A3C91f4cB130D8e56382F00D1071)
        ...
        uint256 userAmount = (user.shares *
            IFairLaunchV1(0xac2fefDaF83285EA016BE3f5f1fb039eb800F43D).userInfo(1, pool.strategy).amount) /
            wantLockedTotal;
