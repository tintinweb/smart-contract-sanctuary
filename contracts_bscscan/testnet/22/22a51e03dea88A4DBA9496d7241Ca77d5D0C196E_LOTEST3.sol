...
//        uint256 sTeamFee
        ...
        require (enoughFees <= MAX_FEE_RATE);
...
//FIX PUT IN SNIPER BOT MEASURES
        ...
        //FIX IS THIS WHERE MY ISSUES ARE?
        if (tradingIsEnabled && (antiSniperArmed = true) && (antiSniperBlock <= _whatTimeIsIt)) {
            _totalBNBFees = 30;
            } else if (tradingIsEnabled && (antiSniperArmed = true) && (antiSniperBlock >= _whatTimeIsIt)){
