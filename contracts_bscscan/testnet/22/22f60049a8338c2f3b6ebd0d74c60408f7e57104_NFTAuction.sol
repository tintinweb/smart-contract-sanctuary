...
contract NFTAuction {
    ...
    */
    ...
    /**
        SALES
    */
    function setupSale(address nftContractAddress, uint tokenId, uint _minPrice, uint _buyNowPrice) internal {
        Auction storage auctions = nftContractAuctions[nftContractAddress][tokenId];
    ...
    function createSale(address nftContractAddress, uint tokenId, uint _minPrice, uint _buyNowPrice) external isAuctionNotStartedByOwner(nftContractAddress, tokenId) priceGreaterThanZero(_buyNowPrice) {
        setupSale(nftContractAddress,tokenId,_minPrice,_buyNowPrice);
