...
contract SummitReferrals is ISummitReferrals {
    ...
    function burnUnclaimedReferralRewardsAndRolloverRound(address referee) external onlyCartographer() override {
        ...
        summit.transfer(referee, burnReward <= 2e18 ? burnReward : 2e18);
    ...
    function getPendingReferralRewards() public view returns (uint256) {
        return pendingReferralRewards[roundIndex][msg.sender];
    }
    function getTotalReferralRewards() public view returns (uint256) {
        return totalReferralRewards[msg.sender];
    }
