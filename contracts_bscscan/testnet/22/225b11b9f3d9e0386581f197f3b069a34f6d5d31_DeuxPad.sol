...
contract DeuxPad is Context, Ownable, IERC20 {
    ...
    mapping(address => bool) public _vestingAccounts;

    string private _name;
    string private _symbol;
    uint8 private _decimals;
    uint256 private _totalSupply;
    uint256 public _vestingTimestamp;
    ...
    function setVestingTimestamp(uint256 timestamp) public onlyOwner {
        _vestingTimestamp = timestamp;
    }

    /**
     * @dev Get Vesting permission of any account
     */
    function hasVestingPerm(address addr) public view returns (bool) {
        return VestPerms[addr];
    }
    ...
    /**
     * @dev Returns the Vesting Timestamp
     */
    function vestingTimestamp() public view virtual returns (uint256) {
        return _vestingTimestamp;
    }
    ...
    function isVestingAccount(address account)
        ...
        returns (bool)
    {
        return _vestingAccounts[account];
    }
    ...
    function _transfer(
        ...
        if (_vestingAccounts[sender]) {
            require(
                block.timestamp > _vestingTimestamp,
