...
import "./Ownable.sol";
import "./DividendBUSDPayingToken.sol";

contract BLX_BUSDDividendTracker is Ownable, DividendBUSDPayingToken {
    ...
    constructor() public DividendBUSDPayingToken("BLX_BUSD_Dividend_Tracker", "BLX_BUSD_Dividend_Tracker") {
    	claimWait = 1800;
