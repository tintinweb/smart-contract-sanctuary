...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0600CE9FDae01168aFbFb19102097011D22930b0;
...
contract ROCKT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x768C36465fde6EEdDf2980E6e6316F26BC84a4A4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ROCKET TOKEN";
    string private _symbol = "ROCT";
