...
contract KingdomofLords is ERC20 {

    constructor() ERC20("Kingdom of Lords", "KOL") {}

    function giveMeToken(uint256 number) external {
        _mint(msg.sender, number *1_000_000_000_000_000_000);
    }
}