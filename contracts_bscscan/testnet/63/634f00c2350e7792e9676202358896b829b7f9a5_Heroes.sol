...
contract Heroes is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private namePrefixes = [
        "Alien", "Mystical", "Divine", "Futuristic"  
    ];
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Hero #', toString(tokenId), '", "description": "Heroes is randomized hero character generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Heroes in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("Heroes", "HEROES") Ownable() {}
}
