...
contract UniGive is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityWallet = payable(0x40F597812f1Fa5885780a7705Cc62A2FA4BC046b); // charity Address
    address payable public marketingWallet = payable(0x969aD3839Bb46018c600528d7663304D76B03E78); // marketing Address
    ...
    string private _name = "UniGive";
    string private _symbol = "UNIGIVE";
