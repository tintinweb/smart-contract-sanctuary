...
contract Ownable is Context {
    ...
    constructor() {
        ...
        _owner = 0x6c8E827042cf11Dff9b926c96e19A4645664BaF3;
...
contract testcoin is Context, IERC20, Ownable {
    ...
    uint256 public _charityFee=200; //means 2% goes to charity address
    uint256 public _devFee=200; //means 2% goes to devdloper address
    uint256 public _marketingFee=200; //means 2% goes to marketing address
    
    
    address private marketingAddress=0x6c953Ef81b4A087c4E3ec3b2dc5dFb1F017401d6;
    address private charityAddress=0x396C7bf1E1E18354C751d35f6331c326ADB36Cb4;
    address private devAddress=0x7983Ada075e4b42640224a72CcF228427a9bC0de;
    ...
    constructor()  {
       ...
       // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // for Ethereum uniswap v2
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // for BSC Pncake v2
        ...
        // charity fee
          ...
          if(_devFee != 0){
            ...
            if(_isExcluded[devAddress]){
                _tokenBalance[devAddress] = _tokenBalance[devAddress].add(devFee);
            }
