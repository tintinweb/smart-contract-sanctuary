...
contract GetRichInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "GetRich Inu";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4B221c94FfC64f823Bbe16c1346Bc2a766543512);
        _feeAddrWallet2 = payable(0x2e3ccD9Ee95BDef4ef1D3266157196516B01b5FE);
