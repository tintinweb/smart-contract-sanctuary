...
contract GRV is ERC20Detailed, Ownable {
    ...
    uint256 public _liquidityFee = 981;
    ...
    bool private haveAirdropped = false;
  ...
  event Sender(address sender);
   ...
   returns (bool)
   {
        ...
        returns (bool)
    {
      ...
      uint256 _maxTxAmount = _totalSupply.div(1);
      uint256 numTokensSellToAddToLiquidity = _totalSupply.div(2000);
      ...
      if(from != owner() && to != owner()){
        ...
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            msg.sender != uniswapV2PairAddress &&
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        uint256 rLiquidity = tLiquidity.mul(_gonsPerFragment);
        _gonBalances[address(this)] = _gonBalances[address(this)].add(rLiquidity);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        emit Balance(balanceOf(address(this)));
