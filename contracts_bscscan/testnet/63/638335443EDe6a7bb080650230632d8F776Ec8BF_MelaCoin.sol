...
contract MelaCoin is Context, IERC20, Ownable {
   ...
   address private constant WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    ...
    function addLiquidityToToken(
        ...
        uint sum = amountADesired.add(amountBDesired);
      
        transferFrom(msg.sender, address(this), amountADesired);
        approve(ROUTER, amountADesired);
     
        transferFrom(msg.sender, address(this), amountBDesired);
        approve(ROUTER, amountBDesired);
      

          
     
        uniswapV2Router.addLiquidity(tokenA, tokenB, amountADesired, amountBDesired, 
          amountAMin, amountBMin, address(this), block.timestamp);
    }   
}