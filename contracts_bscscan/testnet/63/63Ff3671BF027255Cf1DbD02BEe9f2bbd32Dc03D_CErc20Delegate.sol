...
contract CErc20Delegate is CErc20, CDelegateInterface {
     ...
     */
    function _becomeImplementation(bytes calldata data) external override virtual{
     ...
     */
    function _resignImplementation() external override virtual{
        // Shh -- we don't ever want this hook to be marked pure
        if (false) {
            implementation = address(0);
        }
...
contract CErc20 is EToken, CErc20Interface {
     ...
     */
    function getCashPrior() public view override returns (uint) {
