...
contract Buds is Context, IERC20, Ownable, VRFConsumerBase(0xa555fC018435bef5A13C6c6870a9d4C11DEC329C, 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06) {
    ...
    //Addition to sumOfBalances\\
    
    //2)when ownerContract sends coins to an address
        //Subtraction from sumOfBalances\\
    //2)when an address sends coins to the owner contract (won't happen)
    ...
    function totalSupply() external view override returns (uint) {
        return supply; //perhaps this logic can be upgraded to include only the supply - tokens burnt
    }
    ...
    function viewAddresses() public view returns(
        ...
        address _zombie) {
        return(goodBudsWallet, smokeOutWallet, manualLiquidityWallet, zombie);
    }
    ...
    //consider adding fallback() as well
    ...
    //add functionality to subtract from sumOfBalances after fees!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
contract BudsSupplyOwner {
    ...
    function balanceOf(address account) public view returns(uint) {
        return budsContract.balanceOf(account);
    }
