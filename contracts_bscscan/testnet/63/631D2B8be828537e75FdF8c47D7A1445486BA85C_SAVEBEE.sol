...
contract SAVEBEE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 100000 * 10**_decimals;    // 20k - Initial max buy
    uint256 public _maxRxAmount = 50000 * 10**_decimals;   // 10k - Initial max sell
	uint256 public _maxWallet = 1000000 * 10**_decimals;     // 100k - Initial max Wallet	
    ...
    // Numero de Token para Taxar 50k
    uint public TokensFee1 = 30000 * 10**_decimals;                          
    // Porcentagem da taxa do TokensFee1
    uint public taxaFee1 = 25;                              

    // Numero de Token para Taxar  100k
    uint public TokensFee2 = 40000 * 10**_decimals;
    // Porcentagem da taxa do TokensFee2
    uint public taxaFee2 = 50;    

    // Numero de Token para Taxar  150k
    uint public TokensFee3 = 50000 * 10**_decimals;
    ...
    string private constant _symbol = "SVB7";
