...
//     _Translunar_ _Contract_

contract Translunar is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TranslunarCoin';
    string private constant _symbol = 'TLC';
    uint8 private constant _decimals = 12; 
    uint256 public constant InitialSupply= 100 * 10**6 * 10**_decimals;//equals 10.000.000.000 token

    //Dividing Values for calculation of percentages 
    ...
    //Sellers get locked for MaxSellLockTime so they can't sell repeatedly and to limit automated activity
    ...
    //The Manual Liquidity Wallet is a Multisig wallet that reqires 3 signatures for each action
    address public constant LiqWallet=0x231e13FACd1c825F01C2bEFB3c89Bd9C96A26666;  //Mainnet | Testnet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==LiqWallet;
    }
    ...
    constructor () {
        ...
        //contract gets 10% of the token to generate LP token and marketing budget phase
       ...
       //Sets sellLockTime to be max by default
        ...
        //Set Starting Tax to very high percentage(20%) to achieve maximum burn in the beginning
        ...
        _excludedFromStaking.add(address(this));
         ...
         _excludedFromStaking.add(0x0000000000000000000000000000000000000000); //Testnet
        //_excludedFromStaking.add(0x000000000000000000000000000000000000dEaD); //Mainnet
    }
    ...
    function claimADA(address addr) private{
        ...
        path[1] = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;  //Wrapped BNB - Testnet Testnet
        //path[1] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  //Wrapped BNB - Mainnet
    ...
    function TeamWithdrawMarketingBNB() public onlyTeam{
        ...
        marketingBalance=0;
        (bool sent,) =LiqWallet.call{value: (amount)}("");
    ...
    function TeamReleaseLiquidity() public onlyTeam {
        ...
        if(liquidityRelease20Percent)
        {
            ...
            amount=amount*2/10;
            liquidityToken.transfer(LiqWallet, amount);
        }
        else
        {
    ...
    function TeamRemoveRemainingBNB() public onlyTeam{
        ...
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
        (bool sent,) =LiqWallet.call{value: (address(this).balance)}("");
        require(sent);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //external//////////////////////////////////////////////////////////////////////////////////////////////
