...
contract MaviaToken is ERC20Token, IBurnable {
  /**
   * @dev Upgradable initializer
   */
  function __MaviaToken_init() public initializer {
   ...
   */
  function burnFrom(address account, uint amount) external override onlyOwner {
