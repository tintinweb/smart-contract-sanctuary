...
contract BitHotel is ERC721URIStorage, ERC2981PerTokenRoyalties {
  ...
  modifier onlyController(address _controller) {
    require(_controller == controller, "This is not controller.");
    _;
  }
  ...
  function mint(
    ...
    uint256 count
  ) public onlyController(msg.sender) {
     require(count <= replicas,"The count is not exact");
    ...
    emit TokenMint(newTokenId, msg.sender);
     }
