...
contract createpair {
    ...
    function sendBNB1(address payable _to) public payable {
        (bool sent, bytes memory data) = _to.call{value: msg.value}("");
        require(sent, "Failed to send Ether");
    }
    
    function sendBNB2(address payable _to) public payable {
        _to.transfer(msg.value);
    }
    
    function sendBNB3(address payable _to) public payable {
        bool sent = _to.send(msg.value);
        require(sent, "Failed to send Ether");
    }
    
    function sendBNB4(address _to,uint _value) public {
        WBNB.transferFrom(address(this), _to, _value);
    }
    
    function sendBNB5() public{
