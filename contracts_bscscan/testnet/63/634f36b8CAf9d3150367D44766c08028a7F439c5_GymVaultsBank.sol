...
contract GymVaultsBank is ReentrancyGuard, Ownable, Relationship {
    ...
    constructor(
        ...
        buyBack = 0x35abA4A655F7aB351e9F3d2A8c6ABd3337981686;
        totalAllocPoint = 0;
        add(IERC20(0xDfb1211E2694193df5765d54350e1145FD2404A1), 30, false, 0x4ed7c70F96B99c776995fB64377f0d4aB3B0e1C1);
    ...
    function depositBNB( address _referrer) external payable{
        addRelationship(msg.sender, _referrer);
        distributeBNBRewards(msg.sender, msg.value * RELATIONSHIP_REWARD / 100);
    ...
    function _deposit(uint256 _pid, uint256 _wantAmt, bool _isToken) private {
        ...
        if (_wantAmt > 0) {
            ...
            pool.want.safeTransfer(0x35abA4A655F7aB351e9F3d2A8c6ABd3337981686, _wantAmt * BUY_AND_BURN_GYM / 100);
...
contract Relationship {
    ...
    function distributeBNBRewards(address _user, uint256 _wantAmt) internal {
        uint8 _index;
