...
/* Token contract */
contract LastInuToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xBE0e6B5670139C3CDb121637D745aEf8219B2cb2;

    // These are owner by default
    address public autoLiquidityReceiver;
    address marketingFeeReceiver = 0x7867242305622A0A51259c56cbde7DB6DE65E4ce;

    // Name and symbol
    string constant _name = "LastInuToken";
    string constant _symbol = "LIT";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000000000 * (10 ** _decimals); // 100b 
