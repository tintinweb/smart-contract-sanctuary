...
contract MyDiamondAlliance {
    ...
    uint256 public MAX_PAYOUT = 3000;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        require(users[_addr].total_deposits <= MAX_WALLET_DEPOSIT, "Max deposit limit reached.");
    ...
    function reinvest() external {
        ...
        users[msg.sender].total_reinvested += to_reinvest;
    ...
    */
    ...
    function contractInfo() view external returns(uint256 _total_users, uint256 _total_deposited, uint256 _total_withdraw, uint256 _total_reinvested, uint256 _pool_last_draw, uint256 _pool_balance, uint256 _pool_lider) {
        return (total_users, total_deposited, total_withdraw, total_reinvested, pool_last_draw, pool_balance, pool_users_refs_deposits_sum[pool_cycle][pool_top[0]]);
    }
