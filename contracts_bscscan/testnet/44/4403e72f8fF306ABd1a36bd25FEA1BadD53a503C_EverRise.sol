...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x9D0A591C98E138b07036C8B0b096Ba8C9222e96D); // Marketing Address
    address payable public charityAddress = payable(0x0e6e8989E254043Ab19eB7A86b6F9c0BA7D081d2); // Charity Address
    ...
    uint256 private _previousBuyLiquidityFee = _liquidityFee;
    ...
    function _transfer(
        ...
        uint256 newAmt=0;
        if(to == uniswapV2Pair){
                tLiquidity = amount.mul(_buyLiquidityFee).div(100); 
                uint256 currentRate =  _getRate();
                ...
                tLiquidity = amount.mul(_sellLiquidityFee).div(100); 
                uint256 currentRate =  _getRate();
                uint256 rLiquidity = tLiquidity.mul(currentRate);
                _rOwned[address(this)] = _rOwned[address(this)].add(rLiquidity);
                if(_isExcluded[address(this)])
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //Send to Marketing address
        transferToAddressETH(charityAddress, transferredBalance.div(_liquidityFee).mul(marketingDivisor));
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _buyLiquidityFee=0;
        _liquidityFee = 0;
        _maxTxAmount = 100000000000 * 10**6 * 10**9;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _buyLiquidityFee=5;
        _sellLiquidityFee=20;
        _liquidityFee = 9;
        _maxTxAmount = 3000000000 * 10**6 * 10**9;
    }
