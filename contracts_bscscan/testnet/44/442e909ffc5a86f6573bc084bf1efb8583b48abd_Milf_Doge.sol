...
contract Milf_Doge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x350c4a60f739d49a33cBb23Ae3a7C8f9Fd286D49); // Marketing Address
    ...
    string private _name = "Milf Doge";
    string private _symbol = "MILFDOGE";
