...
contract WanaMoon is Context, IERC20, Ownable{
    ...
    uint256 public earlySellingFeeLevel2InHrCutOffPercent = 15;
    ...
    string private constant _symbol   = "WANAMOON";
    ...
    function setContractSellThreshold(uint256 minimumTokenBalance) external onlyOwner {
        require(minimumTokenBalance > 100000000000000, "Max transaction is less than 100000");
