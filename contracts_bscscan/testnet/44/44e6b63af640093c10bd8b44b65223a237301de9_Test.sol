...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 75 * 10**9 * 10**_decimals;
    uint256 public maxBuyAmount = 150 * 10**9 * 10**_decimals;
    ...
    function updateMaxBuyAmount(uint256 amount) external onlyOwner{
        uint256 amt = amount * 10** _decimals;
        require(amt >= _tTotal.mul(1).div(10000), "maxBuyAmount must be higher than 0.01% of total supply");
        maxBuyAmount = amt;
    }
    
    function updateMaxSellAmount(uint256 amount) external onlyOwner{
        uint256 amt = amount * 10** _decimals;
        require(amt >= _tTotal.mul(1).div(10000), "maxSellAmount must be higher than 0.01% of total supply");
        maxSellAmount = amt;
    }
