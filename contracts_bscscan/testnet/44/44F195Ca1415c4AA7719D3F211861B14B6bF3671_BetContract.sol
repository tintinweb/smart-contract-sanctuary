...
contract BetContract{
    ...
    function getLatestPricetoken1() public view returns (uint256) {
        (,int price,,,) = AggregatorV3Interface(0x5e66a1775BbC249b5D51C13d29245522582E671C).latestRoundData();
        return uint256(price);
    }
    function getLatestPricetoken2() public view returns (uint256) {
        (,int price,,,) = AggregatorV3Interface(0x887f177CBED2cf555a64e7bF125E1825EB69dB82).latestRoundData();
        return uint256(price);
    }
    function getLatestPricetoken3() public view returns (uint256) {
        (,int price,,,) = AggregatorV3Interface(0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526 ).latestRoundData();
        return uint256(price);
    }
    function getLatestPricetoken4() public view returns (uint256) {
        (,int price,,,) = AggregatorV3Interface(0x5741306c21795FdCBb9b265Ea0255F499DFe515C).latestRoundData();
        return uint256(price);
    }
    function getLatestPricetoken5() public view returns (uint256) {
        (,int price,,,) = AggregatorV3Interface(0x81faeDDfeBc2F8Ac524327d70Cf913001732224C).latestRoundData();
        return uint256(price);
    }
