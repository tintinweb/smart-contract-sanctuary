...
/**
   Daddy Feg (DADDYFEG) Tokenomics
   6% fee auto add to the liquidity pool 
   2% distribute to the Marketing Wallet 
   2% of transaction fee will go to Holders
   ttl supply = 1000000000000000
   decimals 9
*/
...
contract TaiwanNo1 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x582b094B2505CC692C2e40f6CD4B889A478aD489;
    ...
    string private _name = "TaiwanNo1";
    string private _symbol = "TAIWNANO1";
