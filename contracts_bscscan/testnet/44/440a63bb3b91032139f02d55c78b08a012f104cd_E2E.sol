...
contract E2E is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 222222222222 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name     = "Easy Exchange";
    string private constant _symbol   = "E2E22";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 0; // 0% of every (buying) transaction is used for marketing, platform & LP
    uint256 public _liquidityFee = 600; // 6% of every (buying) transaction will be converted into BNB

    uint256 public _sellTaxFee       = 0; // 0% of every selling transaction is used for marketing, platform & LP
    uint256 public _sellLiquidityFee = 800; // 8% of every selling transaction will be converted into BNB

    uint256 public _burnFee      = 0; // 0% of every transaction is burned

    uint256 public _maxTxAmount                   = 222222222222 * 10**9;
