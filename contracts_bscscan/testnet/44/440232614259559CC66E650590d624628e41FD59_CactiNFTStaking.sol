...
contract CactiNFTStaking is IERC721Receiver, ReentrancyGuard {
    ...
    // function clientUpdateRewards() external view returns (bool){
    //     // Require
    //     require(block.number >= lastRewardedBlock.add(3), 'Must be at least 3 blocks after last update');
    //     updateRewards();
    //     return true;
    // }
    // function adminUpdateRewards() external onlyDao view returns (bool){
    //     updateRewards();
    //     return true;
    // }
