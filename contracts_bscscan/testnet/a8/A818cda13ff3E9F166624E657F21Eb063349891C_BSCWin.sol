...
contract BSCWin is Context, IERC20, Ownable {
    ...
    function nextLotteryTime() public view returns(uint256) {
        ...
        if (lotteriesToday == maxLotteriesPerDay) {
            ...
            if (block.timestamp.sub(lastLotteryTime) > timeBetweenLottery) {
                ...
                return lastLotteryTime.add(timeBetweenLottery);
            }
        }
    }
    ...
    function triggerLottery() public {
        ...
        if (!isLiquidityUnwrapped) {
            ...
            currentLotteryStart = lastLotteryTime;
        ...
        if (currentTrys == 0 && !isLiquidityUnwrapped) {
            _tokenTransfer(address(this), marketingWallet, callerRewardHeldActual, false);
    ...
    function lotteryCheck() internal {
        ...
        if (winnerValid) {
            ...
            lastLotteryTime = currentLotteryStart.add(timeBetweenLottery);
    ...
    function _transfer(
        ...
        _tokenTransfer(address(this),marketingWallet,contractTokenBalance,false);
