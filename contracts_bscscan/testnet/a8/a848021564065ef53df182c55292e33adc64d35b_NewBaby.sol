...
Receive ZCash directly in your wallet for holding.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ZCash = IBEP20(0x1Ba42e5193dfA8B03D15dd1B86a3113bbBEF8Eeb);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ZCash.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ZCash);
        ...
        uint256 amount = ZCash.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ZCash.transfer(shareholder, amount);
...
contract NewBaby is IBEP20, Auth {
    using SafeMath for uint256;

    address ZCash = 0x1Ba42e5193dfA8B03D15dd1B86a3113bbBEF8Eeb;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NewBaby";
    string constant _symbol = "NewBaby";
