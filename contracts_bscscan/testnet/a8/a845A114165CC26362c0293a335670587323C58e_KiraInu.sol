...
Tokenomics
    💵 1.0% Max Buy Tx ( 1,000,000 $KIRA)
    💵 0.20% Max Sell Tx ( 250,000 $KIRA)
    💰 5% Max Bag ( 5,000,000,000 $KIRA )
...
contract DividendDistributor is IDividendDistributor {
    ...
    function setDistributionCriteria(uint256 minPeriod, uint256 minDistribution) external override _onlyToken {
        _minPeriod = minPeriod;
        _minDistribution = minDistribution;
    }
    
    function setShare(address shareholder, uint256 amount) external override _onlyToken {
    ...
    function deposit() external payable override _onlyToken {
    ...
    function process(uint256 gas) external override _onlyToken {
    ...
    function claimDividend(address shareholder) external _onlyToken{
        distributeDividend(shareholder);
    }
...
contract KiraInu is IBEP20, Auth {
    ...
    address DEV = 0x563527D42b47F614C8A677c2FA2aB479bc31dd00;
    ...
    uint8 public _cooldownTimerInterval = 5;
