...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    //////////////////////////// NIP VARS ////////////////////////////  
    address public nipContractAddress = 0x67B034841d0133926D5dAf5F5153a8EC21a81176;       // CHANGEIT - set the right contract address
    ...
    address private codeContractAddress = 0xBBe5451de0CdF6dA6813fAf65692F065A0375E89;    // CHANGEIT - set the right contract address
    ...
    function MintCatNIPNFT(address minterAddress, string memory tokenURIstring, uint256 costOfNFT, uint256 codeForCatMechanism) public returns (uint256) {
        ...
        emit Debug1(ICodeForCat(codeContractAddress).GetCodeForCats());
        emit Debug1(codeForCatMechanism);
        emit Debug1(GetCodeForCats());



        // require(codeForCatMechanism == ICodeForCat(codeContractAddress).GetCodeForCats(), "Wrong code format.");
        // require(codeForCatMechanism == GetCodeForCats(), "Wrong code format.");
    ...
    function GetCodeForCats() public view returns (uint256) {
        return ICodeForCat(codeContractAddress).GetCodeForCats();
    }
