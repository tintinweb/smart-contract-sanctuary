...
contract MultiPad is IBEP20 {
    ...
    address private IDO = 0x71fC42De1bf58182f60861B021188a48b8257f1a;
    ...
    */
    ...
    modifier checkSaleValidations(address _userAddress, uint256 _value){
     ...
     require(_finalSoldAmount[_userAddress] + _value.mul(tokenPrice).div(decimalBalancer) >= saleMinimumAmount, "Total amount should be more than minimum limit");
     require(_finalSoldAmount[_userAddress] + _value.mul(tokenPrice).div(decimalBalancer) <= saleMaximumAmount, "Total amount should be less than maximum limit");
    ...
    function getClaimDates() view public returns(uint256 _d1, uint256 _d2, uint256 _d3, uint256 _d4){
        _d1 = saleEndTime + 10800;   // After 3 hours of end sale
