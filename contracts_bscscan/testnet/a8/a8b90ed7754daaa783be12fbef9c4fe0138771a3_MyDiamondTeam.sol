...
contract MyDiamondTeam {
    ...
    constructor(address payable ownerAddress, address payable projectAddress, address payable marketingAddress, address payable reservedAddress) {
        require(!isContract(ownerAddress) && !isContract(projectAddress) && !isContract(marketingAddress)&& !isContract(reservedAddress));
        owner = ownerAddress;
    ...
    function fees(uint256 amount) internal {
    ...
    */
    ...
    function contractFund(uint256 amount) internal {
