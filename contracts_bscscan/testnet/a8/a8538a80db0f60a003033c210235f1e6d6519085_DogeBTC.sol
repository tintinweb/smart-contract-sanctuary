...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // Binance-Peg BTCB
...
contract DogeBTC is ERC20, Ownable {
    ...
    address public _dividendToken = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // Binance-Peg BTCB
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    bool private swapping;
    bool public tradingIsEnabled = true;
    bool public marketingEnabled = true;
    bool public marketingRandomEnabled = false;
    ...
    event marketingRandomEnabledUpdated(bool enabled);
    ...
    constructor() ERC20("DogeBTC", "DogeBTC") {
    	...
    	marketingWallet = 0x40b1A5396215D3F2a527A41734d28A317e6d67FA;
    ...
    function afterPreSale() external onlyOwner {
        ...
        marketingFee = 5;
        maxBuyTranscationAmount = 300000 * (10**18);
        maxWalletToken = 1500000 * (10**18);
    }
    ...
    function setmarketingRandomEnabled(bool _enabled) public onlyOwner {
        marketingRandomEnabled = _enabled;
        emit marketingRandomEnabledUpdated(_enabled);
    }
    
    function triggermarketing(uint256 amount) public onlyOwner {
        ...
        swapBNBForTokens(marketingBalance.div(10**2).mul(amount));
    }
    ...
    function updatemarketingWallet(address newmarketingWallet) public onlyOwner {
        require(newmarketingWallet != marketingWallet, "DogeBTC: The liquidity wallet is already this address");
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && canSwap) {
                ...
                uint256 marketingBalance = address(this).balance;
                if (marketingEnabled && marketingBalance > uint256(1 * 10**18)) {
                    swapBNBForTokens(marketingBalance.div(10**2).mul(rand()));
                }
...
contract DogeBTCDividendTracker is DividendPayingToken, Ownable {
    ...
    function excludeFromDividends(address account) external onlyOwner {
    	...
    	emit ExcludeFromDividends(0x000000000000000000000000000000000000dEaD);
    }
