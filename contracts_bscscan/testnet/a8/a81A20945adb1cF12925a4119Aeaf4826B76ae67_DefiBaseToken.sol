...
contract DefiBaseToken is BEP20('DefiBase Token', 'DFB'), LGEWhitelisted {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "DFB::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DFB::delegateBySig: invalid nonce");
        require(now <= expiry, "DFB::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "DFB::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DFBs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "DFB::_writeCheckpoint: block number exceeds 32 bits");
