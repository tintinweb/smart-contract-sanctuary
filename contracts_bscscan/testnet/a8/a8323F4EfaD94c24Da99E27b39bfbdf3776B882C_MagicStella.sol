...
contract MagicStella is BEP20, Ownable {
  ...
  uint256 public priceImpact = 2;
	...
	bool public internalSwapEnabled = true;	
	bool public useSwapV2 = true;	
  ...
  address public constant USDT = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
	address public constant ETH = address(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca);
	...
	function ActiveInternalSwap(bool active) public authorized {
		internalSwapEnabled = active;
	}

	function ActiveUseSwapV2(bool active) public authorized {
		useSwapV2 = active;
	}
    ...
    path1[1] = BUSD;
    path1[2] = USDT;
		path1[3] = stellaRouter.WETH();

		address[] memory path2 = new address[](4);
		path2[0] = address(this);
    path2[1] = BUSD;
    path2[2] = ETH;
		path2[3] = stellaRouter.WETH();

		address[] memory path = path1;
