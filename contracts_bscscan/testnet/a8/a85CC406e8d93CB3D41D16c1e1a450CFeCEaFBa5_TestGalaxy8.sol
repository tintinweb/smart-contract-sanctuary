...
// Clear Roadmap
// Team consists of Engineers from Microsoft\Google\Facebook\Amazon
...
// No one can sell more than .2% of the total supply
...
contract TestGalaxy8 is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount   = 100000000000 * 10**9; // 100B
    uint256 public _maxWalletSize = 500000000000 * 10**9; // 500B
    ...
    function addBotToBlackList(address account) public onlyOwner {
        require(account != _routerAddress, "Can't blacklist router.");
