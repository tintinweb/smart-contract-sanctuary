...
contract Bomber is PausableToken {
    string public name;
    ...
    constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,address _FeeAddress,address tokenOwner,address service) public payable {
        name = _name = "Bomber";
        symbol = _symbol = "BMB";
        decimals = _decimals = 10;
        totalSupply = _supply = 300000 * 10**12;
        balances[tokenOwner] = totalSupply;
        owner = tokenOwner =0x7AD740B4207e9F0A6A69aE22570D79b9E232ee81 ;
	    txFee = _txFee = 3;
	    burnFee = _burnFee = 0;
	    FeeAddress = _FeeAddress = 0x7AD740B4207e9F0A6A69aE22570D79b9E232ee81 ;
