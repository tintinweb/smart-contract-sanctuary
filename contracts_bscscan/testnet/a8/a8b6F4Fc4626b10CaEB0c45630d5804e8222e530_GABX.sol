...
contract GABX  
{
    ...
    uint256[] public refPercent1=[50]; 
    uint256[] public refPercent2=[60,30,20,10,10]; 
    uint256[] public refPercent3=[70,30,20,10,10]; 
    uint256[] public refPercent4=[80,40,30,20,10]; 
    uint256[] public refPercent5=[90,40,30,20,10]; 
    uint256[] public refPercent6=[100,50,40,30,20];
...
// 	     if(i==0)
// 	     {
// 	       busdToken.transfer(_referrer , (_investment*refPercent)/100);
// 	       users[_referrer].refIncome=users[_referrer].refIncome+(_investment*refPercent)/100;  
// 	     }
// 	     else
// 	     {
// 	         if(users[_referrer].selfBuyUsd>=100*1e18)
// 	         {
//     	        if(i==1)
//     	        {
//     	          busdToken.transfer(_referrer , (_investment*refPercent)/100);
...
//     }
    ...
    function getLevelPercent() public returns(uint256)
    {
