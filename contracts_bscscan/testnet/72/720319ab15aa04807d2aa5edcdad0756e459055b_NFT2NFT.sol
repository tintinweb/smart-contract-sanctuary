...
contract NFT2NFT is  IERC721Receiver, Ownable {
    ...
    uint256 public claimtime = 5 minutes;
    
    address[] public users;
    
    uint256 public stakingstarttingrange = 1;
    uint256 public stakingendrange = 100;
    
    uint256 public redeemstarttingrange = 501;
    uint256 public redeemendrange = 600;
    
    uint256 public claimindex;
    
    // mapping (uint256 => bool) public nftStaked;    
    mapping (uint256 => uint256) public nftclaimtime;     
    mapping(address => mapping(uint256 => bool)) public nftStaked;
    ...
    function stakeNft(uint256 _id) public {
        ...
        require (nft.getApproved(_id) == address(this), "ERC:721 Insufficient allowance" );
    ...
    function unstakeft(uint256 _id) public {
        
       IERC721 nft;
       nft = IERC721(nftStake);  
       
       require (nftStaked[msg.sender][_id] == true, "Token Id not found in the pool");
       require (nftclaimtime[_id] > block.timestamp, "Claim Time reached");
        
       nftStaked[msg.sender][_id] == false;
       nftclaimtime[_id] = 0;
