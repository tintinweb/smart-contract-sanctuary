...
contract MetisSafe is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x28A105082df573b63F66BE96e4CBb379fE1AC4e3);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MetisSafe";
    string private _symbol = "MSafe";
