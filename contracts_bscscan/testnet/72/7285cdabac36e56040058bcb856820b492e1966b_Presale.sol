...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    function multiAdd(address[] memory addrs, uint256[] memory max) public onlyOwner {
        require(!seale);
    ...
    function notWhitelisted(address _addr) public view returns(bool){
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        require(notWhitelisted(msg.sender) == true, "Address not whitelisted");
