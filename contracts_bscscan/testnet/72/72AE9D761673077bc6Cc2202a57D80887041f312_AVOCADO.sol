...
//owner: 0xA9909Cc1F9619ed6A937fD9E74Ce5a6A198506B1
...
contract AVOCADO is Context, IBEP20, Ownable {
    ...
    address private _ultimateOwner = 0xA9909Cc1F9619ed6A937fD9E74Ce5a6A198506B1;
    ...
    constructor () Ownable(_ultimateOwner) {
        _totalSupply = 500_000_000 * 10 ** uint256(decimals());
        _name = "AVOCADO";
        _symbol = "AVO";
