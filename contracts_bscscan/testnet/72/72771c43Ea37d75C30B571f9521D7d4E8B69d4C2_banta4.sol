...
contract banta4 is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0xd9a784e2E92a29c9610d0a171B00Af35221bD62c;
    //address payable public routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    uint256 private _tTotal = 1 ** 4 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "banta4";
    string private _symbol = "banta4";
