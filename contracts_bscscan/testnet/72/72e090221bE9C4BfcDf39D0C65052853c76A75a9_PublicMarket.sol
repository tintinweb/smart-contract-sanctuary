...
contract PublicMarket is Ownable, Lockable {
    ...
    uint256 public mintTokens = 80000 * 10e9; // 80,000 Tokens warning: make sure the dec is matched
    uint256 public marketPriceDynamic;
    ...
    onlyInitialized() 
    {
        ...
        marketPriceDynamic = calculator.marketPrice(
            totalFunds,
            mintTokens,
            principle.decimals(),
            pGIZA.decimals()
