...
contract MoonRaiseToken is ERC20, Ownable {
    uint256 maxSupply = 100_000_000 ether;
    uint256 minHold = 1000000000000000; // 0.001
    ...
    function _transfer(
        ...
        require(amount > 1000000000000000, "Transfer amount must be greater than 0.001");
        uint realAmount = amount - minHold ;
