...
contract Jackge is Context, IERC20, Ownable {
    ...
    string private _name = "JACKGE";
    string private _symbol = "JKGE";
    ...
    constructor (uint256 taxFee, uint256 liqFee, uint256 burnFee) {
    ...
    function ChangeRouter(address addr) public onlyOwner
    {
    ...
    function ChangeLiquidityTrashold(uint256 amount) onlyOwner public
    {
        numTokensSellToAddToLiquidity = amount;
    }
    function GetLiquidityTrashold() public view returns(uint256)
    {
