...
contract ExoticMonster20 is ERC20 {
    ...
    constructor(address admin) ERC20("Exotic Monster", "EMSC") {
        _mint(admin,100000000 * 10 ** 18);
    }
...
contract ExoticMonsterController is Ownable {
    ...
    constructor() {
        ...
        _marketAddress = 0xC5a89985D57FdddEFCE3E9f26faB99EbF471516A;
        
        //_communityAddress = communityAddress; , address communityAddress
        
        EMC20  =  new ExoticMonster20(msg.sender);
        
        monsters[1] = Monster(1,1,87,2315,106,15,6,1,1);
        monsters[2] = Monster(2,2,70,2372,141,18,7,1,1);
        monsters[3] = Monster(3,3,56,2457,178,23,8,1,2);
        monsters[4] = Monster(4,4,39,2568,267,28,11,1,3);
        monsters[5] = Monster(5,5,25,2854,435,35,13,1,5);  
        
        
        heros[1] = Hero(1,1,2,0,0);
        heros[2] = Hero(2,2,3,0,0);
        heros[3] = Hero(3,3,4,0,0);
        heros[4] = Hero(4,4,5,0,0);
        heros[5] = Hero(5,5,6,0,0);      
    ...
    function selectBox(uint8 boxId) public {
        ...
        if(1 == boxId){
            ...
            EMC20.transfer(_marketAddress,1800);
        ...
        if(2 == boxId){
            EMC20.transfer(_marketAddress,5200);
        ...
        if(3 == boxId){
            EMC20.transfer(_marketAddress,8100);
    ...
    function selectMonster(uint8 monsterID) public {
    ...
    function _addHeroToUser(address user ) internal virtual{
       ...
       users[user].heroNumber = users[user].heroNumber + 1;
       
       users[user].myHeros[users[user].heroNumber] = heros[heroLevel];
    ...
    function _getMonsterNumber(uint256 number ) internal virtual returns (uint256) {
