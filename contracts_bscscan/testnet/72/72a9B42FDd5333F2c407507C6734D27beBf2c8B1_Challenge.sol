...
contract Challenge is Ownable, ReentrancyGuard {
    ...
    // The address of the owner of the contract admin, 
    address public ADMIN_FACTORY;

    // Whether a limit is set for users
    bool public hasUserLimit;

    // Whether it is initialized and ready to use
    ...
    // Thetotal reward token amount to be mined
    ...
    // this is a mapping of Info of each user that stakes tokens (stakedToken)
    ...
    function initialize(
        ...
        require(msg.sender == ADMIN_FACTORY, "Not factory");
