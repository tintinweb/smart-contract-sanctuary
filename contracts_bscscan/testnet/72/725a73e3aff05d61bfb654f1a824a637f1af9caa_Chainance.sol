...
contract Chainance is Context, Ownable{
    ...
    function CreateAccount(address _address, string memory _UserName, string memory _NameSurname, string memory _Birthday, string memory _Email, string memory _Description, string memory _WebSite) public 
        ...
        AccountStruct[_address].Account_Address = msg.sender;
    ...
    function CreateAccountImage(string memory _Link, string memory _Info) public LoginControl {
        ...
        ImageStruct[msg.sender].index = ImageIndex.length;
    ...
    function CreateData(string memory _Data, string memory _DataImageLink) public LoginControl {
        ...
        DataStruct[msg.sender].index = DataIndex.length;
    ...
    //- Get Profile Image's
    function getAccountImage(address _address) public view returns(uint256, uint256, string memory, string memory, address) {
        require(ImageStruct[_address].Image_Address == _address, "err_code : 6");
        
        return(ImageStruct[msg.sender].index,
        ImageStruct[msg.sender].ImageTime,        
    ...
    //- Get Data
    function getData(address _address) public view returns(uint256, uint256, string memory, string memory, string memory, address) {
        require(DataStruct[_address].Data_Address == _address, "err_code : 6");
        
        return(DataStruct[msg.sender].index,
        DataStruct[msg.sender].DataTime,
