...
interface RANDOM_WORKER {
    function startRandom() external returns (uint256) ;
}

contract BoxRedemption is Ownable {

    address public constant MISTORY_BOX_CONTRACT = 0xfB684dC65DE6C27c63fa7a00B9b9fB70d2125Ea1;
    address public constant ECIO_NFT_CORE_CONTRACT = 0x7E8eEe5be55A589d5571Be7176172f4DEE7f47aF;
    address public constant RANDOM_WORKER_CONTRACT = 0x5ABF279B87F84C916d0f34c2dafc949f86ffb887;
    ...
    function openBox(uint256 _id) public {
        ...
        uint256 randomNumber = RANDOM_WORKER(RANDOM_WORKER_CONTRACT).startRandom();

        randomNumberToSender[randomNumber] = msg.sender;
        requestToNFTId[randomNumber] = _id;
        _token.burn(msg.sender, _id, 1);
        mintNFT(randomNumber, "1212122121212");
    }
