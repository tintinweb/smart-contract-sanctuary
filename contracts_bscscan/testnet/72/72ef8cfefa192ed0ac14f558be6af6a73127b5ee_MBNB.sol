...
import "./SafeMath.sol";
import "./MBNBDividendTracker.sol";
...
contract MBNB is ERC20, Ownable {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "MBNB: The dividend tracker already has that address");

        MBNBDividendTracker newDividendTracker = MBNBDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "MBNB: The new dividend tracker must be owned by the MBNB token contract");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "MBNB: The liquidity wallet is already this address");
