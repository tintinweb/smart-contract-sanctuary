...
*/
  ...
  */
  ...
  function balanceOf(address account) external view returns (uint256) {
    ...
    function changeTreasuryWalletFee(uint256 _fee) public onlyOwner  {
        treasure_wallet_fees = _fee;

    
    }
     function changeCoinHolderPercentge(uint256 _percentage) public  onlyOwner {
        coin_holders_percentage = _percentage;

    
    }

    function changeTreasuryWalletAddress(address _addr) public  onlyOwner {
        treasure_wallet_address = _addr;
