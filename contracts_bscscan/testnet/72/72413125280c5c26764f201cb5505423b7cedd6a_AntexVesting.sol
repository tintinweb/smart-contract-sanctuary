...
contract AntexVesting is Context, Ownable, ReentrancyGuard {
        ...
        if (_listHistoryTime.length == 0) {
            ...
            if (_listHistoryTime.length <= seedMonth) {
                if (_listHistoryTime.length == seedMonth) {
                    ...
                    _nextClaimAmount = SEED_REMAIN_AMOUNT[userAddress].div(100).mul(seedPercentMonth[_listHistoryTime.length - 1]);
                }
            }
        }
        ...
        if (_listHistoryTime.length == 0) {
            ...
            if (_listHistoryTime.length <= seedMonth) {
                if (_listHistoryTime.length == seedMonth) {
                    ...
                    _nextClaimAmount = PRIVATE_REMAIN_AMOUNT[userAddress].div(100).mul(seedPercentMonth[_listHistoryTime.length - 1]);
                }
            }
        }
    ...
    function claimPrivateRound() nonReentrant allowToClaim external returns (bool) {
        ...
        if (listHistoryTime.length == 0) {
            ...
            PRIVATE_REMAIN_AMOUNT[msg.sender] = PRIVATE_AMOUNT[msg.sender].sub(takeAmount);
        } else {
            ...
            if (listHistoryTime.length == privateMonth) {
                ...
                takeAmount = PRIVATE_REMAIN_AMOUNT[msg.sender].div(100).mul(percent);
            }
        }
        ...
        if (_listHistoryTime.length == 0) {
            ...
            if (_listHistoryTime.length <= seedMonth) {
                if (_listHistoryTime.length == seedMonth) {
                    ...
                    _nextClaimAmount = PRESALE_REMAIN_AMOUNT[userAddress].div(100).mul(seedPercentMonth[_listHistoryTime.length - 1]);
                }
            }
        }
    ...
    function claimPresaleRound() nonReentrant allowToClaim external returns (bool) {
        ...
        if (listHistoryTime.length == 0) {
            ...
            PRESALE_REMAIN_AMOUNT[msg.sender] = PRESALE_AMOUNT[msg.sender].sub(takeAmount);
        } else {
            ...
            if (listHistoryTime.length == presaleMonth) {
                ...
                takeAmount = PRESALE_REMAIN_AMOUNT[msg.sender].div(100).mul(percent);
            }
        }
