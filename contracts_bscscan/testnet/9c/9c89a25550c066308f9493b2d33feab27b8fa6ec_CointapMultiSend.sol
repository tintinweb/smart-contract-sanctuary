...
contract CointapMultiSend is Context, Ownable, SafeTransfer {

    address SERVICE_ADDRESS;
    uint256 SERVICE_COST = 0.04 * 10**18;
    uint256 MULTIPLIER_TRIAL = 1;
    uint256 MULTIPLIER_PREMEUM = 10;
    ...
    function setBaseCost(uint256 newBaseCost) public virtual onlyOwner returns (bool) {
        SERVICE_COST = newBaseCost;
        return true;
    }

    function setMultilierTrial(uint256 newMul) public virtual onlyOwner returns (bool) {
        MULTIPLIER_TRIAL = newMul;
        return true;
    }

    function setMultilierPremeum(uint256 newMul) public virtual onlyOwner returns (bool) {
        MULTIPLIER_PREMEUM = newMul;
        return true;
    }
    
    function setDisable(bool newStatus) public virtual onlyOwner returns (bool) {
