...
/**
 * The contract mints a NFT
 * Users need to pay with an ERC20/BEP20 `token` with certain `amount`
 */
contract NFTminter is Context, AccessControl, Pausable {
    ...
    constructor(
        ...
        // buy with token, 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 // busd for example here
        buyWithToken = token;
        // for reference 10 BUSD = 10 * 1e18 as with most ERC20/BEP20 tokens
        nft_price = price;
    ...
    function mint() public virtual whenNotPaused {
        ...
        erc20.safeTransferFrom(_msgSender(), vault_address, nft_price);
        NFT(nftToken).mint(_msgSender());
    }
...
contract elemint_nft_minter_01 is NFTminter {
    constructor() NFTminter(
        0x69c806E08b5A49945afeac00483ecFa2cAE1357a, 
        0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,
        10e18,
        0xcf0EAEEC2bb5C74072086F8b91f07066180F88f7
        ){
