...
contract Jordan is Context, IERC20, Ownable {
    ...
    string private _name = "Jordan Love Monster";
    string private _symbol = "LMonster";
    ...
    uint256 public _maxTxAmount = 1 * 1 * 10**8 * 10**8;
    uint256 private minimumTokensBeforeSwap = 1 * 1 * 10**8 * 10**8;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000000 * 10**4 * 10**4;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 10;
        _maxTxAmount = 3000000 * 10**4 * 10**4;
    }
