...
//WEBSITE https://shibawarrior.net
// Telegram:t.me/shibawarrior1
//Features
//*13% buy/sell tax
//*Reflection paid hourly
//*Buy/Sell tax sharing:
//                     1% - liquidity
//                     9% - Shiba Rewards
//                     1% - Team
//                     2% - Marketing
...
contract shibawarrior is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBA WARRIOR";
    string constant _symbol = "SHIBAWA";
    ...
    // Anti-Bot v2
    uint256 public maxRoomRent = 800000;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1000000000000 * 10**_decimals;// 100Billion
    uint256 public swapThreshold = rSupply * 10 / 1;
    ...
    uint256 public _maxTxAmount = rSupply.mul(1);
    uint256 public _maxWalletToken = rSupply.mul(1);
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0x40df4D11dB13DAa61101FD21CAF7df2dCfe01506;// Team Fee Receiver Address
