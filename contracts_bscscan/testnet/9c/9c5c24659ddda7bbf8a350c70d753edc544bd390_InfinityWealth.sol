...
Max Transaciton 0.5% (5000000000 Tokens)
...
contract InfinityWealth is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x981Ab956D6575b40F49AcBb769342BE91db95828);  //4
    address payable public Wallet_BuyBack = payable(0x06376fF13409A4c99c8d94A1302096CB4dC7c07e); //3
    address payable public Wallet_Dev = payable(0x18fcA8704312760A0D4ef10608C5Cf85Dd01F6Ba);
