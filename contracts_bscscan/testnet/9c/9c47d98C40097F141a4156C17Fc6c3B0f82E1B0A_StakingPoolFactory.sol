...
contract StakingPoolFactory is PoolCreator {
    ...
    function create(
        ...
        address newPool = createPool( _oracleContract, _coinSymbolAndPoolType, variables, isEnhancedEnabled);
    ...
    function createPool(
        ...
        address newPool =
            address(
                new StakingPool(
                    _coinSymbolAndPoolType[0],
                    _coinSymbolAndPoolType[1],
                    totemToken,
                    rewardManager,
    ...
    BTCDistributor
{
    ...
    string public coinToPredictSymbol;
    ...
    constructor(
        string memory _coinToPreidictSymbol,
    ...
    {
        coinToPredictSymbol = _coinToPreidictSymbol;
        poolType = _poolType;
