...
/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to creat PITJUPITER designed.
    
    I make this #PITJUPITER to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/PitjupiterCHAT
   ...
   I will renounce the ownership to burn addresses to transfer #PITJUPITER to the community, make sure it's 100% safe.

   I will add 0.3 BNB and all the left 50% total supply to the pool
   Can you make #PITJUPITER 100000X? 

   100,000,000,000,000,000 total supply
   500,000,000,000,000 PITJUPITER max limit for per trade
   ...
   it's the best part of the #PITJUPITER idea, increasing the liquidity pool automatically, 
...
contract PITJUPITER is Context, IERC20, Ownable {
    ...
    string private _name = "PITJUPITOR";
    string private _symbol = "PITJUPITORSYMBOL";
