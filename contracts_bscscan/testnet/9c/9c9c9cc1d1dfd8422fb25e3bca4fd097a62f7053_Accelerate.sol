...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//   Social Media Handles Of Accelerate   

//   Website = https://
//   TG      = https://
//   Twitter = https://twitter.com/

//  Accelerate (XLR8) is a token that provides a use case, An
//  automated DeFi trading bot with various advanced features such as:
//  Limit Trades
//  Slow Sell Off of positions
//  Sell Dust
//  Additional functionality to be announced
...
contract Accelerate is Context, IERC20, Ownable { 
    ...
    address payable private _devWalletAddress = payable(0xf40C2fA57A147ce4662f730497e5bc0C20Fd313f);
    address payable private _marketingWalletAddress = payable(0xdd9b2120F4072BfA0abECb7ac53cbeF9E7a3D561);
    address payable private _developmentWalletAddress = payable(0xA226b33aaa89C5917Dcc5655B6951820E468089b);
    ...
    string private _name = "Accelerate v2";
    string private _symbol = "XLR8";
 ...
 function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function recoverBNB(address payable recipientAddress) external onlyOwner {
    ...
    function airDrop(address[] calldata recipients, uint256[] calldata values) external onlyOwner {
      for (uint256 i = 0; i < recipients.length; i++) {
        _tokenTransfer(msg.sender, recipients[i], values[i], false);
      }
    }
