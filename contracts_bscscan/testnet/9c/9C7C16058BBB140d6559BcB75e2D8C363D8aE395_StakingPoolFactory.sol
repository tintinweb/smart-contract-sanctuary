...
library IndexedClaimRewardLib {
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 stakingReward = _getIndexedStakingReward(
            _staker, 
            _stakeIndex,
            _lps
        );
        (prizeReward, wrappedTokenPrizeReward) = _getIndexedPrizeReward(
            _staker, 
            _stakeIndex,
            _lps,
            _prizeRewardRates
    ...
    ////////////////////////// internal functions ///////////////////
    function _getIndexedStakingReward(
        StakingPoolStorageStructure.StakeWithPrediction[] storage _staker, 
        uint256 _stakeIndex,
        StakingPoolStorageStructure.LibParams storage _lps
    ) 
    ...
    function _getIndexedPrizeReward(
        StakingPoolStorageStructure.StakeWithPrediction[] storage _staker, 
        uint256 _stakeIndex,
        StakingPoolStorageStructure.LibParams storage _lps,
        StakingPoolStorageStructure.PrizeRewardRate[] storage _prizeRewardRates
...
library ClaimRewardLib {
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 prizeReward;
        uint256 wrappedTokenPrizeReward;
        uint256 stakingReward = _getStakingReward(_staker, _lps);
        (prizeReward, wrappedTokenPrizeReward) = _getPrizeReward(_staker, _lps, _prizeRewardRates);
