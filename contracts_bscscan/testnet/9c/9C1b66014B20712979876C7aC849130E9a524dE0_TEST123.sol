...
contract TEST123 is Context, IERC20, Ownable { 
    ...
    uint256 private _banTotalFee = _marketingfee + _developmentfee + _devFee + _banLiquidityFee;
    ...
    function setBanLiquidityFeePercent(uint256 banLiquidityFee) external onlyOwner() {
        _banLiquidityFee = banLiquidityFee;
        _banTotalFee = _marketingfee + _developmentfee + _devFee + _banLiquidityFee;
    }
