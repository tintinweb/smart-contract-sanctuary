...
// CHANGE
contract ojm is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ojm";
    string constant _symbol = "OJM";
    ...
    uint256 public _sellMultiplier = 3; // 2x for sells in the first hour... manually handled
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xaE2081f16f1E4b7CA4D6943fd3F0FE4fd483B1F0);
