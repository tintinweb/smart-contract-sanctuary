...
// Contract created for https://bushidocoin.com/ by https://gentokens.com/


/*


Name:       BUSHIDOCOIN.COM
Symbol:     BUSHIDO


Website:    https://bushidocoin.com/
Telegram:   https://t.me/bushidocoin


Tokenomics

    Supply  1,000,000,000,000 (Bushido is deflationary. The Total Supply will reduce over time whenever tokens are burned.)

    5%      Auto liquidity (sent directly to burn)
    3%      Reflections to holders
    3%      Marketing 
    1%      Developer fee
    
    12%     Total Fee - The max possible fee is hardcoded. Fees can be adjusted but the total must be <= 12%. 
    3%      Anti-Whale max wallet
...
Anti-Snipe
    ...
    The true Bushido investor must buy with loyalty, courage, veracity, compassion, and honor.
    An appreciation and respect of other Bushido investors is imperative. Using snipe-bots is not the Bushido way.


Contract created by https://gentokens.com/ for https://bushidocoin.com/
...
contract BUSHIDO is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Dev = payable(0xA9EeD95EbE986867063B1E43e5850f6a7217E668); // 25 
    ...
    string private _name = "BUSHIDOCOIN.COM"; 
    string private _symbol = "BUSHIDO";  
    ...
    */
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // ETH V2
    ...
    */
    ...
    function Wallet_Update_Dev(address payable wallet) public {
        require(wallet != address(0), "new wallet is the zero address");
        ...
        uint256 amount
          ...
          if (launchPhase){
                ...
                if(TradeOpen){
                        ...
                        // Buy in first block = snipe (During the firrst block the max wallet and transaction are limited to 0.2% of supply)
                        ...
                        // From Block 2 the transaction is increased to 1% and max wallet to 2%
                        ...
                        // From block 5 (approx 15 seconds) transactions and wallet limits are set to max (3% of supply) and launchphase is automatically ended
                        if ((block.number > launchBlock + 5) && (_maxTxAmount != _tTotal.mul(3).div(100))){

                            // Increase max transaction to 3%
...
/*
    ...
    01000111 01101001
    01011001 01110101
    01001010 01101001 01101110
    01010010 01100101 01101001
    01001101 01100001 01101011 01101111 01110100 01101111
    01001101 01100101 01101001 01111001 01101111
    01000011 01101000 01110101 01100111 01101001
    ...
    Unlicensed SPDX-License-Identifier is not Open Source 
    This contract can not be used/forked without permission 
    Contract created specifically for ModelCoin - https://BUSHIDOCOIN.com/
