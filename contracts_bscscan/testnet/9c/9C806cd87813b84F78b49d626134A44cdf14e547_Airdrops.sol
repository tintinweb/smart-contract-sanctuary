...
*/
	...
	constructor( iMoonCoin _MoonCoin) public { 
	  ...
	  function setJoinBonus(uint256 _JOIN_BONUS) external { 
		...
		function resetUser(address userAddress, uint256 _issued, uint256 _claimed, uint256 _allocated, uint256 _pastClaims, uint256 _allocateTime, uint256 _allocationPercent) public {
			 ...
			 user.issued=_issued;
			  user.claimed=_claimed;
			   user.allocated=_allocated;
				...
				user.allocateTime=_allocateTime;
				user.allocationPercent=_allocationPercent;
