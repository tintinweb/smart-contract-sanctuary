...
contract VNSC is ERC1155, Ownable {
  ...
  function buyCoin(uint256 numberOfNfts, uint256 coinType, address invitor) public returns(bool) {
        ...
        _token.transferFrom(_msgSender(), address(this), fee.mul(3).div(100));
        _token.transferFrom(_msgSender(), _etwallet, fee.mul(85).div(100));
        _token.transferFrom(_msgSender(), _twWallet, fee.mul(12).div(100));
