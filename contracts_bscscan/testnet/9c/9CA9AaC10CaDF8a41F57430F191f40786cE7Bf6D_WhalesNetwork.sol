 ...
 * via msg.sender and msg.data, they should not be accessed in such a direc
...
contract WhalesNetwork is Context, IERC777, IERC20 {
    ...
    uint256 private _totalSupply=350000000*10**18;
    uint256 public _tokenPrice= 10**18;

    string public _name ="Whales Network";
    string public _symbol="Whales";
    ...
    constructor(
        ...
        IERC1820Registry registry_
    ) {
        owner=msg.sender;
        _ERC1820_REGISTRY = IERC1820Registry(registry_);
