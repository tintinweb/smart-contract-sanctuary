...
contract AlgoPadTestNet is Context, IBEP20, Ownable {
    ...
    string  private _name = 'AlgoPad';
    string  private _symbol = 'AlgoPad';
    ...
    uint256 private _tax_fee = 75;
    uint256 private _burn_fee = 75;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (!(sender == owner() || _isExcluded[sender])) {
