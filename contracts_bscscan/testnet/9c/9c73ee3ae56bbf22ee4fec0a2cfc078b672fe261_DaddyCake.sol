...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #DaddyCake to the community, make sure it's 100% safe.
   ...
   it's the best part of the #DaddyCake idea, increasing the liquidity pool automatically, 
...
contract DaddyCake is Context, IERC20, Ownable {
    ...
    string private _symbol = "DaddyCake";
