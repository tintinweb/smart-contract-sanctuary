...
contract JaxAdmin is IJaxAdmin, Initializable, JaxOwnable {
  ...
  function setTokenAddresses(address _wjxn, address _wjax, address _vrp, address _jusd) public onlyAdmin {
    wjxn = IERC20(_wjxn);
    wjax = IERC20(_wjax);
    vrp = IERC20(_vrp);
    jusd = IERC20(_jusd);
    IJaxSwap(jaxSwap).setTokenAddresses(_wjxn, _wjax, _vrp, _jusd);
