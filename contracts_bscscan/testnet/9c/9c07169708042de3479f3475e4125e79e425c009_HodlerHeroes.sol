...
contract DividendPayingToken is ERC20, IDividendPayingToken {
    ...
    address public adminAddress = 0xc357BDD63E3b585250971709EbE7c060Bbf3CF01;
...
contract CaptainDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("HODLERHEROES_CAPTAIN_Dividend_Tracker", "HODLERHEROES_CAPTAIN_Dividend_Tracker", 0xfa766806aCa18749FB3A91b3AA28758D9836B00F) {
        claimWait = 3600;
...
contract HodlerHeroes is ERC20, Ownable {
    ...
    address public teamWallet = 0x1b3432391Dc9B686CD58C71D4B206C6b2130e52C;
    address public marketingWallet = 0x06E6D0d4Fd14AF257BDb97cB721BdD131339Af5c;

    address public captainDividendToken = 0xfa766806aCa18749FB3A91b3AA28758D9836B00F;
    CaptainDividendTracker public captainDividendTracker;

    address public wbnbReflectToken = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address public wbnbReflectTracker = 0xe6DC665091364f2dCDCDcE9F352440B7c7d64419;
    address public toBurnAllianceToken = 0xfa766806aCa18749FB3A91b3AA28758D9836B00F;
    address public gameTreasury = 0x578005d3D337f0997ecD4aFd0E04d7A2229FABc1;
    ...
    constructor() ERC20("HodlerHeroes NFT", "HHNFT") {
        ...
        IDEXRouter _dexRouter = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //testnet
        //IDEXRouter _dexRouter = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //mainnet
