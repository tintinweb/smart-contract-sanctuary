...
* TokenDistributor
* -
* Receives tokens and manages the distribution amongst receivers
...
contract TokenDistributor is Ownable, VersionedInitializable {
    ...
    function configureTokenDistributor(
        address _recipientBurn,
        address _tokenToBurn,
        address _kyberProxy,
        address[] memory _receivers,
