 ...
 * @title Lock Contract
 * @author ETHST-TEAM
 * @notice This Contract Lock ET
 */
contract Lock is AccessControlEnumerable {
    using EnumerableSet for EnumerableSet.AddressSet;

    IERC20 public etToken;
     ...
     */
    constructor(address etAddr, address manager) {
        etToken = IERC20(etAddr);
    ...
    function deposit(uint256 amount) external {
        ...
        etToken.transferFrom(msg.sender, address(this), amount);
