...
// \ \  _ <'  /'__`\\ \ \ \ \ ,__\ /'__`\    /',__\\ \ \/  
//  \ \ \L\ \/\  __/ \_\ \_\ \ \_//\ \L\.\_ /\__, `\\ \ \_ 
//   \ \____/\ \____\/\____\\ \_\ \ \__/.\_\\/\____/ \ \__\
//    \/___/  \/____/\/____/ \/_/  \/__/\/_/ \/___/   \/__/
// @BelfastTokenITA - Fair Launch - no presale - no private sale
//                           launched by Krakovia o/ (@karola96)
...
contract belfast is ERC20, Ownable {
//custom
...
//switch functions
    ...
    function setsendToMarketing(bool _state) external onlyOwner {
        sendToMarketing = _state;
    }
//set functions
