...
contract BNBLottery is ReentrancyGuard, IBNBLottery, Ownable {
     ...
     * @param _BNBTokenAddress: address of the BNB token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _BNBTokenAddress, address _randomGeneratorAddress, address _treasuryAddress) {
        BNBToken = IERC20(_BNBTokenAddress);
        ...
        nonReentrant
    {
        ...
        BNBToken.safeTransferFrom(address(msg.sender), address(this), amountBNBToTransfer);
    ...
    function claimTickets(
        ...
        BNBToken.safeTransfer(msg.sender, rewardInBNBToTransfer);
        ...
        nonReentrant
    {
        ...
        BNBToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        BNBToken.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(BNBToken), "Cannot be BNB token");
