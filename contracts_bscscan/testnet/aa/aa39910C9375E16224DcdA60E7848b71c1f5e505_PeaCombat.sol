...
contract PeaCombat is Ownable {
    ...
    function combatReward(
        ...
        uint256 bonusPercentage = rewardBonus[_peaLevel];
    ...
    function combat(uint256 _tokenId, Monster _monster) external {
        ...
        uint8 peaChamp = _pean.champ;
        uint8 peaLevel = _pean.level;
        ...
        uint256 winRate = getWinRate(peaLevel, monsterLevel, rnd.div(10));
