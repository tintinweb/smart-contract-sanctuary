...
// TODO should bts be burnable?
contract BTS is ERC20Burnable, AccessControlEnumerable, IMintableToken {
	bytes32 public constant minterRole = keccak256('minterrole');

	/**
	 * @notice Constructs the Bat True Bond ERC-20 contract.
	 */
	constructor() ERC20('Bolt True Share', 'BTS') {
	...
	function burn(uint256 amount) public override onlyRole(minterRole) {
		super.burn(amount);
	}
