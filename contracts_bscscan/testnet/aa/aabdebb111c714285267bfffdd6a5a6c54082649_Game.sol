...
contract Game {
    ...
    constructor(address payable _owner,address mainaddr_) public {
        ...
        token = Token(0x415cEE42a124532AEa459DBd440526e738c59442);
    }
    ...
    function Bet_test(uint256 amount,uint8 number) payable public {
        //转入代币 
    ...
    function startGame(uint8 number,uint256 amount)  private {
