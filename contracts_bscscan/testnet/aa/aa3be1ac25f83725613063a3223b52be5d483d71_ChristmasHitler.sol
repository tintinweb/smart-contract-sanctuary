...
//ChristmasHitler bringing Green down your chimneys
...
contract ChristmasHitler is IBEP20, Auth {

	address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

	string constant _name = "ChristmasHitler";
    string constant _symbol = "Chimney";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 148800000000 * (10 ** _decimals);
    ...
    uint256 public _maxBuyToken = 14880000;
    uint256 public _maxSellToken = 6000000;
    uint256 public _maxWalletToken = 14880000;
    uint256 public _coolDown = 666;
	...
	constructor() Auth(msg.sender) {
		...
		_balances[msg.sender] = _totalSupply/ 1000000 * 1000000;

        // Airdropping money skelly
_balances[0xf1Ee027222feC4aEcFfAFEdde9F86098A958b3e8] = _totalSupply / 1000000 *10000;
    ...
    function setFees(uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator / 3, "Maximum allowed taxation on this contract is 20%.");
    }
