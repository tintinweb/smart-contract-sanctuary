...
contract BabyFlokiShibha is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd802389806aBc05e5b59Bf41787b5C3f9ebA3E8f); // Marketing Address
    ...
    string private _symbol = "BFSHIBA";
