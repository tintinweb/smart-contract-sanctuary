 ...
 * X Add sell cooldown
 * X Add liq fee
 * X Lock trades by default and start it 
 * - Max wallet ????
 * - Withdraw bnb from contract (rip Burn pioneer) (not possible?)
 ...
 * - Notes
 * --------------------------------------------------
 * If we renounce we cant pull liquidity (!)
 */
