...
contract CS721Factory is Ownable {
    ...
    IPancakePair public immutable PancakePair = IPancakePair(0xec829197B1c45B197cDa4104f22511e9ec53Dc61);
    ...
    function mintWithCS() public returns (address, uint256) {
    ...
    function mintWithBNB() public payable returns (address, uint256) {
...
contract CS721 is ERC721 {
    ...
    function _baseURI() internal view override returns (string memory) {
        string memory baseURI = "https://api.coin-sack.com/";
