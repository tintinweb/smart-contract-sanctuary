 ...
 * 
 *  Development Wallet = 0xEFd37e96c8FFa621De664C4040C7C7926fD2b3fe
 *  Marketing Wallet   = 0x0C59cEA0f2dF623fFe3E7a1bF38525374ab86E6f (the unlocked supply dedicated to partnerships and investors will also be held in this wallet.)
 *  Team Wallet        = 0x31eb2937e76C33F626B6029708B0b6d96F14Df9B
 *
 */
...
contract LottoBunny is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES *********************************
    string private _name = "Lotto Bunny";                                                   // name
    string private _symbol = "LBT";                                                    // symbol
    uint256 private _tTotal = 200000000 * 10**uint256(_decimals);                        // total supply
    uint256 public _taxFee = 3;                                                          // % to holders
    uint256 public _swapAndLiquifyFee = 6;                                               // % to swap and add to liquidity
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive _walletsFee.
        0xEFd37e96c8FFa621De664C4040C7C7926fD2b3fe,                                      //
        0x0C59cEA0f2dF623fFe3E7a1bF38525374ab86E6f,                                      //
        0x31eb2937e76C33F626B6029708B0b6d96F14Df9B                                       //
    ];                                                                                   //
    // ********************************** END VARIABLES **********************************
