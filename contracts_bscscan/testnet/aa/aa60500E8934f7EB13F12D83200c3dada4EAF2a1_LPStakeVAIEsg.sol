...
contract LPStakeVAIEsg is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public esgRewardTotal; //ESG reward total
    ...
    }else
    {
        ...
        esgRewardTotal = esgRewardTotal.add(accReward);
    ...
    uint256 reward = user.rewardTotal.sub(user.rewardPayout);
        ...
        uint256 esgAmt = IERC20(esgAddress).balanceOf(address(this));
        if (reward > esgAmt) {
            reward = esgAmt;
        }

        IERC20(esgAddress).safeTransfer(msg.sender, reward);
