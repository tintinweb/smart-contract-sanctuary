...
contract ArtKitchenAuction is ERC721Holder, Ownable, AccessControl, SignatureVerifier, FeeCalculator {
...
//    mapping (uint256 => Status) public statuses;
    ...
    function _getTokenIdFrom(uint256 _auctionId) internal view returns (uint256) {
...
//        statuses[_tokenId] = Status.Auction;
    ...
    function bid(uint256 _auctionId) external payable {
        uint256 _tokenId = _getTokenIdFrom(_auctionId);
//        require(statuses[_tokenId] == Status.Auction, "Art Kitchen: The item is not listed");
        IArtState _state = IArtState(stateAddress);
        require(_state.isAuction(_tokenId), "Art Kitchen: The item is not listed");
