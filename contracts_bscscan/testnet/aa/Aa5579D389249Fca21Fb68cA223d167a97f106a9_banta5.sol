...
contract banta5 is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "banta5";
    string private _symbol = "banta5";
	...
	function setRouterAddress(address payable routerAddress) public onlyOwner {
