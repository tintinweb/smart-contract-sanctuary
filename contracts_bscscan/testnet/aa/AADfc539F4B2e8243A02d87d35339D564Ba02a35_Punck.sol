...
contract Punck is ERC1155, Ownable {
    ...
    event BuyNftWithBnb(uint256 numberOfNfts, uint256 coinType, uint256 invitorId, uint256 secId);
    ...
    function buyWithBnb(uint256 numberOfNfts, uint256 coinType, uint256 invitorId) public payable returns(uint256) {
        ...
        emit BuyNftWithBnb(numberOfNfts, coinType, invitorId, _firstInvitors[invitorId]);
        return msg.value;
    }
