...
contract BEP20Token is  IBEP20Fee{
    ...
    function getAllFees() external view returns (feeStructure[] memory) {
        feeStructure[] memory temp = new feeStructure[](2);
        temp[0]=feeStructure("PrivateInvestors",12,0xac4B5a779a15E40cEA5D0d76a049e928e6DC4D5b,1000000,ActionTypes.ORIGINAL);
        temp[1]=feeStructure("PrivateInvestor1s",12,0xac4B5a779a15E40cEA5D0d76a049e928e6DC4D5b,1000000,ActionTypes.ORIGINAL);
       return temp;
    }  
