...
contract TitanTest is Context, IERC20, Ownable {
    ...
    function buyToken(uint256 amountOfToken) public payable{
        ...
        uint256 quantity = amountOfToken * 10 **9 ;
    ...
    function withdrawTokens() public onlyOwner{
        require(remainingTokens > 0,"There is no remaining tokens");
        require(block.timestamp > releaseTime,"TokenSale is not ended");
        require(releaseTime == 0,"TokenSale is not started yet");
