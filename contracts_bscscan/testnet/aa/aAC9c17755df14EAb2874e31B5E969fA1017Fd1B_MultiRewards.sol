...
contract MultiRewards is ReentrancyGuard, Pausable {
    ...
    function checkTotalReward(address account, address _rewardsToken) public view returns (uint256) {
    ...
    function getReward() public nonReentrant updateReward(msg.sender) {
        for (uint i; i < rewardTokens.length; i++) {
            ...
            require(actualAmount>0 && actualAmount <= reward, "No unlocked reward available");
