...
| '_ \/ _` || '_ \| || |\ V  V // _` || ' \))/ _` || / / / _` | 
|_.__/\__,_||_.__/ \_, | \_/\_/ \__,_||_||_| \__,_||_\_\ \__,_| 
                   |__/                                         
                        
                        

TG: https://t.me/babywanaka
website: http://www.babywanaka.space/
...
contract BabyWanaka is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyWanaka";
    string constant _symbol = "BWANAKA";
    ...
    uint256 public swapThreshold = _totalSupply * 3 / 100; // 0.01% of supply
    bool inSwap;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(marketingFeeBuyback).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFeeBuyback, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFeeBuyback = _marketingFeeBuyback;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFeeBuyback);
