...
contract HeroDogeCoin is Context,IERC20,Ownable {
    ...
    constructor (string memory NAME, string memory SYMBOL, uint256 DECIMALS, uint256 SUPPLY, uint256 taxFee, uint256 LPFee, uint256 charityFee, address charityWallet, uint256 maxTransactionAmount, uint256 maxSellAmountAllowed, address routerAddress, address heroDogeOwner) public {
        _name = NAME;
        _symbol = SYMBOL;
        _decimals = DECIMALS;
