...
abstract contract BEP20Fee is BEP20 {
    ...
    function setJaxCorpDAO(address jaxCorpDao_wallet) public onlyOwner {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if(_referrers[recipient] == address(0) && _referrers[msg.sender] != recipient && _referrers[_referrers[msg.sender]] != recipient && _referrers[_referrers[_referrers[msg.sender]]] != recipient  && _referrers[_referrers[_referrers[_referrers[msg.sender]]]] != recipient && recipient != msg.sender && amount >= _referrer_amount_threshold) {
