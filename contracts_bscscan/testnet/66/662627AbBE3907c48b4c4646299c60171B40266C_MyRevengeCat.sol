...
contract MyRevengeCat is Ownable, ReentrancyGuard {
    ...
    address public distributeReward;
    ...
    function sendBNB() public payable nonReentrant {
        payable(distributeReward).transfer(address(this).balance);
    }
...
contract DistributeReward {
    ...
    //address public constant CAKEVault = 0x408ECB06EF97705Afb02643ae1E5537F370a6bfB;
    //address public constant vaultAddr = 0x408ECB06EF92705Afb02646ae1E5537F370a6bfB;
   ...
   function deposit() payable public {
    ...
    function distribute() public {
        ...
        uint256 devReward = balance * 17 / 100;
        //uint256 NFTReward =  balance * 80 / 100;
        //uint256 callReward = balance * 2 / 100;

        payable(dev).transfer(devReward);
        //payable(CAKEVault).transfer(NFTReward);
        //payable(msg.sender).transfer(callReward);

        //CAKEVault(vaultAddr).harvestCAKE();
    }

    function getCallRewardBalance() public view returns(uint256) {
        uint256 balance = address(this).balance;
        uint256 callReward =  balance * 4 / 100;
