...
contract Distributor_v2 is IDistributor {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        require(_fidl != address(0), "Zero address: OHM");
        ohm = IERC20(_fidl);
     ...
     */
    function setBounty(uint256 _bounty) external override {
     ...
     */
    function addRecipient(address _recipient, uint256 _rewardRate) external override {
