...
//    IBEP20	ONE	= IBEP20(0x03fF0ff224f904be3118461335064bB48Df47938); // Mainnet 
//    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Mainnet
    IBEP20 ONE = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // Testnet
    ...
    uint256 public minPeriod = 15 minutes; // min 15 mins delay
    uint256 public minDistribution = 2 * (10 ** 18); // 2 ONE minimum auto send
...
contract TESTER is IBEP20, Ownable {
    ...
    string constant _name = "TESTERRR";
    string constant _symbol = "TAXTEST";
    uint8 constant _decimals = 8;
    uint256 _totalSupply = 13 ** 12 * (10 ** _decimals);
    ...
    uint256 public _maxHold = _totalSupply / 123;
	address public marketingFeeReceiver = 0x6a03eb63F62d7CE43E780ba615219B0475b3DfB4;
    address public buybackFeeReceiver = 0x6a03eb63F62d7CE43E780ba615219B0475b3DfB4;
//  address ONE  = 0x03fF0ff224f904be3118461335064bB48Df47938; // Mainnet
//	address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Mainnet
    ...
    bool inSwap;
    uint256 public swapThreshold = _totalSupply / 5500; // 0.022lel
