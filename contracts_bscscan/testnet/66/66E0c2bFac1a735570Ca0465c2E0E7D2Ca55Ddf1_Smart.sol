...
contract Smart is Ownable, ERC20 {
    ...
    constructor(address swapRouter) ERC20("Smart Token","SMART") public {
    ...
    function setTaxFee(uint256 _taxFee) external onlyOwner {
        require(_taxFee > 0 && _taxFee <= 1000, "SMART: Tax Fee out of range!");
        taxFee = _taxFee;
    ...
    function transferFrom(address sender, address recipient, uint amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), allowance(sender,_msgSender()).sub(amount, "SMART: transfer amount exceeds allowance"));
        return true;
    }
