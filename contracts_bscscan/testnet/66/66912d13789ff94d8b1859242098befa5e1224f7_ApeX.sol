...
contract ApeX is IERC20, Ownable {
    ...
    uint256 _maxBuyTxAmount = (_totalSupply * 1) / 2000000000000000000000;
    uint256 _maxSellTxAmount = (_totalSupply * 1) / 2000000000000000000000;
    uint256 _maxWalletSize = (_totalSupply * 2) / 100000000000000000000000;
