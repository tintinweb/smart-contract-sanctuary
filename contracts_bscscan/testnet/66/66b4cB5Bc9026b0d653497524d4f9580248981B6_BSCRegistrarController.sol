 ...
 */
contract BSCRegistrarController is Ownable {
...
contract BaseRegistrar is IERC721, Ownable {
    uint constant public GRACE_PERIOD = 28 days;
    ...
    // The namehash of the TLD this registrar owns (eg, .bsc)
