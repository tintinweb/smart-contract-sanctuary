...
contract Buds is Context, IERC20, Ownable, VRFConsumerBase(0xa555fC018435bef5A13C6c6870a9d4C11DEC329C, 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06) {
   ...
   function contractCLinkTestingState() public onlyOwner() {
       setAddresses(0x409C262ED26950fAcb247D9eF23F20f05CD81709,
                    0x3a209AdD5682a0a36c3695B130b8f3908C24Ea1a,
                    0xdd43E2C523FF0730469c102bBCc4f37498869EAa,
                    0xFD7B37FbEacF32C0a11a70B5ed789B653f6042FC,
                    0x6f59aDAefAd2ac77e27995d4C7d6616770564B39
        );
   }
   

   function readResultAfterRandomNumber() public view onlyOwner() returns(uint randomNumber, uint liquidityWalletBalance, uint zombieBalance, address lotteryWinner) {
       return ( randomResult,
                balanceOf(0xdd43E2C523FF0730469c102bBCc4f37498869EAa),
                balanceOf(0x6f59aDAefAd2ac77e27995d4C7d6616770564B39),
                lastLotteryWinner
              );
   }
}
...
contract BudsSupplyOwner {
    ...
    function setContractAddresses(
        ...
        budsContract.setAddresses(_goodBudsWallet, _smokeOutWallet, _manualLiquidityWallet, _budsBank, _zombie);
         _goodBudsWallet = 0x1Fb77Ed37265cFcB8Fc34a7B26Baeb93029A5e08;
        _smokeOutWallet = 0xf62e2BEfd38f70Cf5e286a932A5ca0E07a53E13A;
        _manualLiquidityWallet = 0x451eB4eA78925Dc04D3d4adb59f24d147292A02F; // Bumblebee
        _budsBank = 0xF0eb6C40F5839ba6fE2DA9e0C62E4DABc4DdCa02; // CareBuds II
        _zombie = 0xBEDC582C084d334AE991836dbE9ED324955e9b1E; // Dopey Bud 
    }
