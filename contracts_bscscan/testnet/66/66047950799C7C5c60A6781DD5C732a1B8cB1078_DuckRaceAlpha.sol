...
contract DuckRaceAlpha is Ownable {
    ...
    uint256 public stake = 10000000 ** 10*18;
    uint256 private winnerPrize;
    ...
    receive () payable external{
        ...
        // each player sends exactly the required stake of DUCKRACE 
    ...
    function pickWinner(address payable account) public{
        // only the manager can pick a winner if there are at least 3 players in the game
        require(msg.sender == _manager);
