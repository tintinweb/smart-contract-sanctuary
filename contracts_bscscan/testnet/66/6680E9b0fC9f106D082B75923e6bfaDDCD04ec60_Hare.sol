...
contract Hare is Context, IBEP20, Ownable {
    ...
    uint256 public _companyTotalFees =
        _advisoryFee + _developmentFee + _liquidityFee + _marketingFee;
    uint256 private _previousTotalCompanyFees = _companyTotalFees;
    uint256 public maxWalletAmount = 10000000000 * 10**uint8(_decimals);
    ...
    uint256 public _maxTxAmount = (totalSupply() * 2) / 1000;
    ...
    constructor(
        ...
        _advisoryWalletAddress = advAddr;
        _developmentWalletAddress = devAddr;
        _marketingWalletAddress = mktgAddr;
        _liquidityWalletAddress = liqAddr;
