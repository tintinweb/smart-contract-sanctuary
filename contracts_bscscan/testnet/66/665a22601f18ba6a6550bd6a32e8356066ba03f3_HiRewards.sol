...
contract HiRewards is Context, IERC20, Ownable {
    ...
    string private _name = "HI REWARDS";
    string private _symbol = "$HIR";
    
    uint256 private _rewardsFee = 5;
    ...
    address _marketingWallet = 0xaAD40945e1E721cC43D3BeAbd4d7D60E536da8b1;
    ...
    function setRewardsPercent(uint256 rewardsFee) external onlyOwner() {
        require(rewardsFee >= 4); // Rewards fee has to be greater than 4%
    ...
    function removeAllFee() private {
        if(_rewardsFee == 0 && _liquidityFee == 0) return;
