...
contract BibleBucks is Context, IBEP20, LockToken {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7219C7602Bf0633E26A723F2c7E43b58605Bad7A); // Marketing wallet Address.
    address payable public developerAddress = payable(0x47D3550C1C17b77f3523A6D435fdd48Cf0c6b75E); // developer wallet address. 
    ...
    uint256 private _tTotal = 777_777_777 * 10**18;  //total supply. 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BibleBucks"; //token name
    string private _symbol = "$JZUS"; // token symbol. 
    ...
    uint256 public _maxTxAmount = 777_777_77 * 10**18;
    uint256 private minimumTokensBeforeSwap = 7_777 * 10**18; 
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 777_777_777 * 10**18;
    }
