...
contract Game {
    ...
    uint constant firstGameTime = 2000000000; // 06/24/2017 @ 5:00pm (UTC)
    ...
    function playerWager() payable public {
    ...
    **/
    ...
    function pendingWithdrawalForAddress(address payable userAddress) public view returns(uint) {
