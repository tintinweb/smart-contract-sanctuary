...
contract Zippy is IBEP20, Auth {
    ...
    string constant _name = "Zippy";
    //change the token symbol
    string constant _symbol = "ZPY";
    //dont change that
    uint8 constant _decimals = 8;

    //defines the total supply --> 100 = 100e8 <-- THE e8 HAS TO BE THERE
    uint256 _totalSupply = 1000000_000e8;

    //3% of all token can be bought with one transaction
    uint256 public _maxTxAmount = _totalSupply * 3 / 100;

    //one wallet can only hold 3% of all token
    ...
    address public marketingFeeReceiver = 0x388c42817A246eE350D3343dCea9b58F36D401d4;
