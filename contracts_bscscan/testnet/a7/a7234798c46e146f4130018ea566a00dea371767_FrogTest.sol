...
contract FrogTest is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FrogTest";
    string constant _symbol = "Frog";
    ...
    address public autoLiquidityReceiver = 0x6D17567acFa982a76ac88Ae757cB021B343477B3; //Owner Wallet
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountCrazyFrog);
