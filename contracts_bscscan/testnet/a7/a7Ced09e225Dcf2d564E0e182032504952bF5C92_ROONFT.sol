...
contract ROONFT is ERC721Pausable, AccessControl, Ownable {
    ...
    function mint(address to, string memory _tokenURI) public payable returns (uint256 tokenId) {
        ...
        // 发行量判断
        require(nextTokenId <= maxSupply,'Exceed the maximum circulation!');
        ...
        _mint(to, tokenId);
        nextTokenId++;
        _setTokenURI(tokenId, string(abi.encodePacked(_tokenURI,tokenId.toString())));
