...
// STATED CHANGES CONTRACT NAME TOKEN NAME TOKEN SYMBOL ALL FEES SET TO 1 PERCENT (TAX MARKETING LIQUIDITY) ROUTER ADDRESS
// Tax Elon!!! lmao
...
contract TaxElon is Context, IERC20, Ownable {
    ...
    string private _name = "Tax Elon";
    string private _symbol = "TaxElon";
