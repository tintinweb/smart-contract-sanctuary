...
contract NFTStaking_V2 is IERC721Receiver, ReentrancyGuard {
    ...
    uint256 public farmingEndTimestamp = farmingStartTimestamp + 1728000; // No more rewards after 20 days;
    ...
    // Setters
    function setFarmingEndTimestamp(uint256 _endTimeStamp) external onlyDao {
