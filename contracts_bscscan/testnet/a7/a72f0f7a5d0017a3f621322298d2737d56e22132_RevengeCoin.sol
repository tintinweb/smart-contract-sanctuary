...
contract RevengeCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Revenge Coin";
    string private _symbol = "REVCITY";
    ...
    uint256 public _liquidityFee = _innovationFee;
    ...
    uint256 private minimumTokensBeforeSwap = 500000000 * 10**18; 
    
    address payable public innovationAddress = 0x21F2bae3D05735F0Ad29200AFA707C2639c86765; // Innovation wallet
