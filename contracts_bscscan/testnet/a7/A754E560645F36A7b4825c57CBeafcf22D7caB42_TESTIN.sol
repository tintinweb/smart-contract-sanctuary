...
/**
  _                  _                  _                   _______   ______    _____   _______   ______    _____ 
 | |                | |                | |                 |__   __| |  ____|  / ____| |__   __| |  ____|  / ____|
 | |_    ___   ___  | |_    ___      __| |   ___    ___       | |    | |__    | (___      | |    | |__    | (___  
 | __|  / _ \ / __| | __|  / _ \    / _` |  / _ \  / __|      | |    |  __|    \___ \     | |    |  __|    \___ \ 
 | |_  |  __/ \__ \ | |_  |  __/   | (_| | | (_) | \__ \      | |    | |____   ____) |    | |    | |____   ____) |
  \__|  \___| |___/  \__|  \___|    \__,_|  \___/  |___/      |_|    |______| |_____/     |_|    |______| |_____/ 
...
contract TESTIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2000 ;     // Supply do Token = 20 billions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 0;    // 30 millions - Initial max buy
    uint256 public _maxRxAmount = 0;    // 10 millions - Initial max sell
	uint256 public _maxWallet = 2000;     // 300 millions - Initial max Wallet	
    uint256 public numTokensToSwap = 0; // 5 millions
	uint public sellPerSecond = 0; // 20seconds
    uint public buyPerSecond = 0;	// 10seocnds
    ...
    string private constant _name = "TESTE DOS TESTES";
