...
contract SmartMatrixForsage is SmartMatrixForsageBasic {
    ...
    function updateX3Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        TEST1 = users[referrerAddress].x3Matrix[level].referrals.length;
    ...
    function sendETHDividends(address userAddress, address _from, uint8 matrix, uint8 level) private {
        ...
        depositToken.safeTransfer(receiver, 0.4e18);
    ...
    function sendETHDividends1(address userAddress, address _from, uint8 matrix, uint8 level) private {
        ...
        depositToken.safeTransfer(receiver, TEST_PRICE);
