...
interface IApesLandV2 {
  ...
  function collateral_ (  ) external view returns ( address );
  ...
  function stackedAtLand ( address, address, uint256 ) external view returns ( address contractAddr, uint256 buildingId, uint256 buildType, uint256 usedSlots, uint256 cumulativeReward, uint256 releaseBlockNum, uint256 startBlockNum, uint256 rewardRatio );
  function stakeApe ( address apeContract, uint256 apeId ) external;
  function stakeBuilding ( address buildingContract, uint256 buildingID ) external;
  function supportsInterface ( bytes4 interfaceId ) external view returns ( bool );
  function transferOwnership ( address newOwner ) external;
  function unpause (  ) external;
  function unstakeApe ( address apeContract, uint256 apeId ) external;
  function unstakeBuilding ( address buildingContract, uint256 buildingID ) external;
  function upgradeTo ( address newImplementation ) external;
  function upgradeToAndCall ( address newImplementation, bytes memory data ) external;
  function uri ( uint256 ) external view returns ( string memory);
  function userApesCounter ( address, address, uint256 ) external view returns ( uint256 );
  function userBuildingsCount ( address, address, uint256 ) external view returns ( uint256 );
}
