...
contract test1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "testo4";
    string private constant _symbol = "testtt4";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 100) {
            require(to != pair, "Sells not allowed for first 100 blocks for blacklisting bot buyers");
        }
