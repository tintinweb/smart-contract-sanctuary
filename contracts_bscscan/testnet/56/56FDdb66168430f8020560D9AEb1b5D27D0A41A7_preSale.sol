...
contract preSale{
    ...
    function bnbToToken(uint256 _amount) public view returns(uint256){
        ...
        uint256 numberOfTokens = _amount.mul(tokenPerBnb).mul(precision).div(1e18);
        return numberOfTokens.mul(1e8).div(precision);
    }
    ...
    // to change price
    function setPriceOfToken(uint256 _tokenPerBnb) external onlyOwner{
