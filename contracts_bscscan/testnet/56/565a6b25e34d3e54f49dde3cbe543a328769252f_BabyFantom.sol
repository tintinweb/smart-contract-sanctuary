...
\______   \_____ \_ |__ ___.__.\_   _____/____    _____/  |_  ____   _____  
 |    |  _/\__  \ | __ <   |  | |    __) \__  \  /    \   __\/  _ \ /     \ 
 |    |   \ / __ \| \_\ \___  | |     \   / __ \|   |  \  | (  <_> )  Y Y  \
 |______  /(____  /___  / ____| \___  /  (____  /___|  /__|  \____/|__|_|  /
        \/      \/    \/\/          \/        \/     \/                  \/ 
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FANTOM = IBEP20(0xAD29AbB318791D579433D831ed122aFeAf29dcfe);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = FANTOM.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(FANTOM);
        ...
        uint256 amount = FANTOM.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            FANTOM.transfer(shareholder, amount);
...
contract BabyFantom is IBEP20, Auth {
    using SafeMath for uint256;

    address FANTOM = 0xAD29AbB318791D579433D831ed122aFeAf29dcfe;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Fantom";
    string constant _symbol = "BabyFantom";
