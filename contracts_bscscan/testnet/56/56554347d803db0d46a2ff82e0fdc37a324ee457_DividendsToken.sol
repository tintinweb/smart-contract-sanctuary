...
BullRush ADA is a high reflection token on the Binance Smart Chain that gives Binance-Peg Cardano Token ($ADA) to all holders - With the option to do any other token as well.
...
Fairlaunched with no prelaunch team or dev wallets.
Tokens used for liquidity 100%.

Links:
https://t.me/BullRush_ADA
https://twitter.com/BullRush_ADA
https://www.bullrushada.com
...
contract DividendsToken is IBEP20, Auth, TokensRescuer {
    ...
    constructor(
        ...
        autoLiquidityReceiver = address(0x8b861Ace52284E41D2178971A9C374199D25C3c8);
        marketingFeeReceiver = address(0x2d73F88BeddFc7c669462C5C15FfF58561e27Be4);
        developmentFeeReceiver = address(0x575bDD11207D86ADb38106b141Df2b4bEb1424E8);
