...
contract DNFVault is ERC1155Holder, Ownable {
    ...
    uint256 public dnfCount;

    uint256 private _totalSupply;

    mapping(address => StakeInfo[]) private stakeList;
    mapping(address => RewardNft) private rewardNftList;
    ...
    function stake(uint256 amount) public {
        ...
        dnfToken.safeTransferFrom(msg.sender, address(this), amount);

        StakeInfo memory si;
        si.stakeAmount = amount;
