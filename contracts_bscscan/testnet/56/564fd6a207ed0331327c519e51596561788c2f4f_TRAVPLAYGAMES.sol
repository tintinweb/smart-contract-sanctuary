...
contract TRAVPLAYGAMES is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    
    using SafeMath for uint;

    uint256 private totalTokens;

    constructor() ERC20("TRAVPLAY", "TRAV") {
        totalTokens = 100 * 10 ** 6 * 10 ** uint256(decimals()); // 420M
