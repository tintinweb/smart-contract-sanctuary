...
abstract contract DepreciatingFees {
    ...
    */
    ...
    function reAdjustFees(address userAddress, uint256 _amount, uint256 accruedFees, uint256 _rfiFee, uint256 _buyBackFee,  uint256 _marketingFee, 
        ...
        (uint256 _newRfiFee, uint256 _newMarketingFee, uint256 _newBuyBackFee, uint256 _newAntiDumpFee) = 
            calculateBuyingReadjustment (userAddress, _amount, accruedFees, _rfiFee, _marketingFee, _buyBackFee, _antiDumpFee);
...
contract ARMADA is IERC20Metadata, DepreciatingFees, Ownable {
    ...
    address public marketingAddress = 0x5A312c525cfff880A80f8fD1d4D709C05C2Ce1Ce; // Marketing Address
