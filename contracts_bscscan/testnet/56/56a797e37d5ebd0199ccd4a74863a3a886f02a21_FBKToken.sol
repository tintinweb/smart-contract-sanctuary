...
contract FBKTokenBase is ERC20, DSMath {
    uint256                                            _supply;
    ...
    uint256  airdropNum  =  10*10**8;                // 10FBK each time for airdrop
...
contract FBKToken is FBKTokenBase(10*10**9*10**8), ContractLock(1639782400) {
    ...
    // Optional token name
    string   public  name = "Facebook Token";
