...
contract MafiaMadDogs is ERC721Enumerable, Ownable {
    ...
    uint public  basePrice = 30*10**18; // MATIC
    ...
    MafiaMadDogs internal MGG = MafiaMadDogs(0x990E77E415079CD59538F95FA293d4De1f37a0B9);  // 0x700320a1C1E7DCcF410CA5597d4C1Ad3bC623e2a
	MafiaMadDogs internal BZC = MafiaMadDogs(0x7D725436259eD7FA3Cf56f71aE6D26914Fc8776b);  //  0x4bca2c2ece9402b5d4dd031b49d48166c40b7957
    ...
    function MGGview(address _owner_) external view  returns (uint256[] memory) {
         return MGG.tokensOfOwner(_owner_); 
    }
    ...
    function TokenForMintAvailableMGG(address _holder) public view virtual returns (uint256) {
        ...
        function mintForMGG(uint _count) public {
        require(msg.sender == _owner || saleEnable, "Sale not enable");
        require(totalSupply() +_count <= MAX_TOKEN, "Exceeds limit");
    ...
    //mint for BZC
    function BZCview(address _owner_) external view  returns (uint256[] memory) {
         return BZC.tokensOfOwner(_owner_); 
    }
    ...
    function TokenForMintAvailable(address _holder) public view virtual returns (uint256) {
        ...
        function mintForBZC(uint _count) public {
        require(msg.sender == _owner || saleEnable, "Sale not enable");
        require(totalSupply() +_count <= MAX_TOKEN, "Exceeds limit");
