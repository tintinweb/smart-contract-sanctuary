/*
                 ...
                 #PAPYDOGE (PAPY DOGE COIN)

    Website: https://papydogecoin.com
    Twitter: https://twitter.com/PapyDogeCoin
    Telegram: https://t.me/PapyDogeCoin

   #PAPYDOGE features:
		- 5% Redistribute to holders
		- 1% Burn
		- 5% added to liquidity
		- 1% to marketing Address
    - 40% Supply is burned at start

		Total Supply: 2Q (2,000,000,000,000,000 - two quadrillion)
		First Burn: 800T (800,000,000,000,000 - eight hundred trillion)

 * SPDX-License-Identifier: Unlicensed
 */
pragma solidity ^0.8.4;

import "./papydoge_imports.sol";
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Papy Doge Coin";
    string internal constant SYMBOL = "PAPYDOGE";
    ...
    address internal marketingAddress = 0x0BBB84b7c70beBC1A96A98b1fe1dBBba07Db2465;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 10, marketingAddress ); // 1% to marketing Address
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    constructor() {
        ...
        // exclude owner, this contract and marketingAddress from fee
    ...
    function burn(uint256 amount) external {
        ...
        require(sender != address(0), "PAPYDOGE: burn from the zero address");
        require(sender != address(burnAddress), "PAPYDOGE: burn from the burn address");

        uint256 balance = balanceOf(sender);
        require(balance >= amount, "PAPYDOGE: burn amount exceeds balance");
    ...
    function _approve(address owner, address spender, uint256 amount) internal {
        require(owner != address(0), "PAPYDOGE: approve from the zero address");
        require(spender != address(0), "PAPYDOGE: approve to the zero address");
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        require(sender != address(0), "PAPYDOGE: transfer from the zero address");
        require(recipient != address(0), "PAPYDOGE: transfer to the zero address");
        require(sender != address(burnAddress), "PAPYDOGE: transfer from the burn address");
    ...
    function _transferTokens(address sender, address recipient, uint256 amount, bool takeFee) private {
         ...
         * (like with `_getValues`). All that is required
...
abstract contract PapyDogeToken is BaseRfiToken, Liquifier, Antiwhale, AntiBot, AntiDump {
...
contract PAPYDOGE is PapyDogeToken{

    constructor() PapyDogeToken(Env.Testnet) {
