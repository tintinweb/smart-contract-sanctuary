...
import "./crunchtoken-imports.sol";

/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
0xBc5ec * the actual name of the contract `SafeTokenV1Beta` at the very bottom **and** the `environment` into which
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Crunch";
    string internal constant SYMBOL = "CRNCH";
    ...
    address internal charityAddress = 0x14b8876D096b027ab772d120F3E70C1479c319B5;
     ...
     */
    address internal burnAddress = 0x0000014500000000070080002035000338602174;
