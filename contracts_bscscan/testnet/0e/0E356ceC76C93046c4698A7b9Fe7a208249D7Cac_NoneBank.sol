...
contract NoneBank {
    ...
    event UpdateLoanApp();
    event CloseLoanApp(uint256 loanID);
    event DepositLoan();
    event WithdrawLoan();
    ...
    function closeLoanApp(uint256 _id) public {
        LoanApplication storage app = loanApplications[_id];
        require(app.id == _id, "r1");
        require(app.owner == msg.sender, "r2");
        app.open = false;
        uint256 amount = app.loanAmount;
        app.loanAmount = 0;

        require(IERC20(app.loanToken).transfer(app.owner, amount), "r2");

        emit CloseLoanApp(_id);
    }
    ...
    function depositLoan(uint256 _id, uint256 amount) public {
        LoanApplication storage app = loanApplications[_id];
    ...
    function withdrawLoan(uint256 _id, uint256 amount) public {
        ...
        require(app.loanAmount >= amount, "r1");
        if (amount == 0) {
    ...
    function repay(uint256 bid, uint256 amount) public {
        Borrow storage b = borrows[bid];
        require(b.open == true, "r0");
    ...
    function depositCollateral(uint256 bid, uint256 amount) public {
        Borrow storage b = borrows[bid];
        require(b.open == true, "r1");
