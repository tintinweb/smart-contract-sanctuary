...
contract LotteryTracker is Ownable,VRFConsumerBase {
    ...
    function pickWeeklyWinners() public {
        ...
        while(winnerCount < 3){
            ...
            if(block.timestamp.sub(lastSoldTime[winner]) >= 600){
...
contract GodShibaToken is ERC20, Ownable {
    ...
    uint256 public maxHoldLimit = 2 * 10**7 * 10**18;
    ...
    address payable public _marketingWallet = payable(address(0x71eA1341a4087Fe9F309C6273877a8d50503A7FC));
    address payable public _devWallet = payable(address(0x76a376E39F02837A5A60b5d9C0A8b75A38b077D4));
    address payable public _charityWallet = payable(address(0x6cF4A2Bd96D504Cbc50dA862D7312c71a3F0c25a));
    ...
    constructor() ERC20("GodShiba TOKEN", "GSHIB") {

        //Test IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // tesnet V2 Router
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02 (0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // pcs V2 Router
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(!automatedMarketMakerPairs[to] && !_isExcludedFromWhale[to]){
                require(balanceOf(to) + amount <= maxHoldLimit,"Balance exceeds hold limit");
            }
