...
contract AdvensturesSlot is Context, PartnerOwnable { 
	...
	constructor()   { 
        ...
        tokens_create(0x4ECfb95896660aa7F54003e967E7b283441a2b0A,bytes('FRUIT'),10); // FRUIT
        tokens_create(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82,bytes('CAKE'),1); // CAKE
        tokens_create(0x31508f0098A2566074EcCC94a0900721386D0C4b,bytes('TEST'),5); // CAKE
