...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa08c8c8dD74D169d021bBA1fd4E3BeBee143b643;
...
contract test is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xc56520fd01D7FF742c2cfAfa21A671725b02F2A0);
    ...
    */
    ...
    function set_Transfers_Without_Fees(bool true_or_false) external onlyOwner {
        ...
        if (noFeeToTransfer == true){
         _isExcludedFromFee[routerAddress] = false;  
        }
    }
    /*
    SETTING FEES
