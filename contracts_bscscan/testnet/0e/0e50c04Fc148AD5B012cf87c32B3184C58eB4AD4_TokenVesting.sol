...
contract TokenVesting is Ownable, ReentrancyGuard {
    ...
    bool public isOnlyOwnerCanRelease;
     ...
     */
    function claimToken(address _beneficiary) external nonReentrant {
        if(isOnlyOwnerCanRelease){
            require(owner() == _msgSender(),"You don't have permission.");
        }
    ...
    function setIsOnlyOwnerCanRelease(bool _value) onlyOwner external{
        isOnlyOwnerCanRelease = _value;
    }
}