...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000000000000000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'KishuProctocol';
    string private constant _symbol = 'KHP';

    uint256 private _taxFee = 400;
    uint256 private _burnFee = 400;
    uint private _max_tx_size = 100000000000000000000000000 * 10 ** uint256(_decimals);
