...
contract UniswapV2ERC20 is IUniswapV2ERC20 {
    ...
    string public override constant name = 'GandalfSwap';
    string public override constant symbol = 'GLP';
...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        ...
        emit Mint(tx.origin, amount0, amount1, to, liquidity);
    }
    ...
    function burn(address to) external lock returns (uint256 amount0, uint256 amount1) {
        ...
        _update(balance0, balance1, _reserve0, _reserve1);
        if (feeOn) kLast = uint256(reserve0).mul(reserve1); // reserve0 and reserve1 are up-to-date
        emit Burn(tx.origin, amount0, amount1, to, liquidity);
    }
    ...
    function swap(
        ...
        _update(balance0, balance1, _reserve0, _reserve1);
        emit Swap(tx.origin, amount0In, amount1In, amount0Out, amount1Out, to);
    }
