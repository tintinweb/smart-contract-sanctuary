...
contract NewYearsCheems is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "New Years Cheems";
    ...
    uint256 public totalFeeBuy = 0; //Total Fee
    ...
    uint256 public totalFeeSell = 50; //Total Fee
