...
contract VonderGame is Ownable {
    ...
    constructor() {
        console.log("Deploying Vonder Game...");
    }
    ...
    function sellChip(address tokenAddress, address seller, uint256 amount) public onlyOwner {
        ERC20 token = ERC20(tokenAddress);
        token.transferFrom(treasury, seller, amount);
        emit SellChip(seller, amount);
    }
}
