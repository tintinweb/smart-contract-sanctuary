...
contract GMT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xC8E16a16705ccb30B8F669b9535e7Cc0eE7F361C);
    address public taxAddress = address(this);
    ...
    string private _name = "Giving Medicine Token";
    ...
    uint256 private buyBackContractLimit = 1 * 10**9;
    uint256 private buyShare = 100;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(pancakeswapRouterAddress);
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > buyBackContractLimit) {
                if (balance > buyBackUpperLimit)
                    balance = buyBackUpperLimit;
                buyBackTokens(balance.div(buyShare));
            }
        }
        bool takeFee = true;
    ...
    function setbuyBackContractLimit(uint256 buyBackConLimit) external onlyOwner() {
       buyBackContractLimit = buyBackConLimit;
    }
    function setBuybackUpperLimit(uint256 buyBackLimit) external onlyOwner() {
        buyBackUpperLimit = buyBackLimit;
    }
    function setBuybackShare(uint256 _buyShare) external onlyOwner() {
        buyShare = _buyShare;
    }
