...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274); //the reward token you want distributed 
...
contract TestX is IBEP20, Auth {
    using SafeMath for uint256;
    address MATIC = 0x8a9424745056Eb399FD19a0EC26A14316684e274; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "TestX";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
