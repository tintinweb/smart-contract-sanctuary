...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TRX = IERC20(0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = TRX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TRX.transfer(shareholder, amount);
...
contract yourmomdotcom is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "YMdCoM";
    string constant _symbol = "YmDc";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 80; //2.5% of total supply
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xb6B46B02fF132C0BC6623742Da827B58863875Ef;
