...
contract BAToken is StandardToken, SafeMath {
    ...
    // constructor
    function BAToken()
    {                 //controls pre through crowdsale state
      totalSupply = 100 * (10**6) * 10**decimals;   // 100m TAT reserved for Brave Intl use;
      balances[msg.sender] = 100 * (10**6) * 10**decimals;   // 100m TAT reserved for Brave Intl use
    }
}