...
// File: contracts/TOSHIFLIP_NOW/PlayersTest.sol
...
// File: contracts/TOSHIFLIP_NOW/ToshiGameTest.sol
...
abstract contract ToshiGame is Ownable {
    ...
    address public constant BABYTOSHI_ADDRESS = address(0x382ecCa048f1Fca7C5795A30E8977F41F5c229a4);  //Test : 0x382ecCa048f1Fca7C5795A30E8977F41F5c229a4   --- REAL : 0xD2309BbD6Ec83D8B3341cE5b061ce378F45c2621
    address public constant MARKETING_WALLET = address(0x50F2E07131Cfbed5658aEc7AD52e83207DaC8DCD); //TEST: 0x50F2E07131Cfbed5658aEc7AD52e83207DaC8DCD   --- REAL : 0x61472ced7d1dea15d3ef3e30158006a4152e48b5
    ...
    function createGameAddress() internal view returns (address randomPlayer) {
        //address random = address(uint160(uint(keccak256(abi.encodePacked(nbRandomAddress, _msgSender(), here, block.timestamp, block.difficulty, blockhash(block.number))))));
...
// File: contracts/TOSHIFLIP_NOW/ToshiFlipTest.sol
...
contract ToshiFlip is ToshiGame {
    ...
    */
     ...
     */
    function joinFlip(address _key, address currency, uint256 amount, bool _choice) public notTeam notPlayerOne(_key) onlyExistingFlip(_key) notFinishedFlip(_key) {
        if( !isPlayer(_msgSender()) ){
            players.add(_msgSender());
        }
        address key = _key;
