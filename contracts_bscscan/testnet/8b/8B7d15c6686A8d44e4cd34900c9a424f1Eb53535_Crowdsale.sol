...
contract Crowdsale is Context, ReentrancyGuard, Ownable {
    ...
    uint256 crowdSaleSupply = 30000000 * 10**uint256(_decimals); 
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        require(statusICO == true, "Only allowed in ICO times");
        ...
        require(tokens <= crowdSaleSupply, "Too much amount");
    ...
    /*
    @dev Handling statusICO
    */
    
    function setStatusICO(bool status) public onlyOwner {
        statusICO = status;
    }
    
    function getStatusICO() public view returns (bool) {
        return statusICO;
    }
    ...
    function finalizeICO() public onlyOwner {
        statusICO = false;
        finalizeStatus = true;
        _deliverTokens(owner(), crowdSaleSupply);
    }
}