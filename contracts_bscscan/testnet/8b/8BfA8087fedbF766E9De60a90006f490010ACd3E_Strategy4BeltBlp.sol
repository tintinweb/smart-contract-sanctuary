...
abstract contract StrategyBase {
    ...
    modifier onlyBenevolent {
        require(
            msg.sender == tx.origin || msg.sender == initiator || msg.sender == owner
        );
        _;
    }
...
abstract contract StrategyFarmBase is StrategyStakingRewardsBase {
    ...
    address public ubxt = 0x60D0A3d9642E015DC27a85A037245E43251B6ab8;
    ...
    function harvest() public override onlyBenevolent {
        ...
        if (_belt > 0) {
            ...
            IERC20(ubxt).safeTransfer(
                jar, // vault
                _ubxt.sub(_upbotUBXT).sub(burnUBXT)
            );
        }
