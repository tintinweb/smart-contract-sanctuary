 ...
 */
contract BEP20 is IBEP20, HasForeignAsset, Pausable {
    ...
    contract SKIPPYPROJECT is BEP20 {

    constructor () BEP20("SKIPPY", "SKPY", msg.sender) {
        _mintOnce(msg.sender, 1000000 * (10 ** uint256(decimals())));
    }
}