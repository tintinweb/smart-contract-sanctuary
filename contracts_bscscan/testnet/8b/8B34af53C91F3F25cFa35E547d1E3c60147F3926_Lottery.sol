...
contract Lottery is Ownable, Pausable {
    ...
    mapping (uint256 => uint256) public ticketPoints;
    ...
    function addDraw(uint256 _drawNumber, Levels _nftLevel) external onlyOwner {
    ...
    function addTicketPoints(uint256 _nftLevel, uint256 _points) external onlyOwner {
    ...
    function calculatePoints(address account) internal {
