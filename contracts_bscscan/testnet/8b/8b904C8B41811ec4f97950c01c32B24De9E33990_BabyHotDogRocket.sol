...
/**
🚀 Welcome ToBabyHotDogRocket🚀 
 
BabyHotDogRocket is the only BNB rewards tokens with a unique auto-claim feature. 
BabyHotDogRocket  rewards are sent to your wallet directly. All you need to do is earnBabyHotDogRocket rewards after 60 MINUTES.
Our unique reward system is triggered by volume (buy + sell activity to cover gas fees). 
Payouts to holders may not occur every hour if trading volume is low. When this is the case, the amount of rewardedBabyHotDogRocket each holder will receive does not decrease. 
However, will accrue over a longer period of time until it is suitable for a payout to trigger (usually 15 Minutes).
AddBabyHotDogRocket to your wallet to see reward

💰Tokenomics:
💥• 10% Cake Rewards
💥• 2% Added to LP
🔥• 25% Burn
💷• 5% Marketing/Dev. Wallet
💴• 70% Liquidity
🌭• Slippage to Buy/Sell 12-14% 
🔐• Liquidity Locked: 2 Years
💣• Total Supply: 10,000,000,000
Telegram: https://t.me/BabyHotDogRocket
Twitter:  https://twitter.com/BabyHotDogRocket
Website : https://BabyHotDogRocket.tech/
...
contract BabyHotDogRocket is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BHTDG";
  string private _name = "BabyHotDogRocket";
