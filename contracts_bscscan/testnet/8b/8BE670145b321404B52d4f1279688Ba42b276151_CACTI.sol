...
contract CACTI is Context, IERC20, Ownable {
    ...
    uint256 public totalTaxAlloc = marketingTaxAlloc.add(lpTaxAlloc).add(operationsTaxAlloc).add(buybackTaxAlloc).add(bountiesTaxAlloc).add(daoTreasuryTaxAlloc);
    ...
    function _updateOperationsFee(uint256 _operationsFee) private {
        ...
        emit UpdateOperationsFee(_operationsFee);
    }
    ...
    function _updateBountiesFee(uint256 _bountiesFee) private {
        ...
        emit UpdateBountiesFee(_bountiesFee);
    }
    ...
    function _updateDaoTreasuryFee(uint256 _daoTreasuryFee) private {
        ...
        emit UpdateDaoTreasuryFee(_daoTreasuryFee);
    }
    ...
    function setTaxAllocations(
        ...
        totalTaxAlloc = operationsTaxAlloc.add(buybackTaxAlloc).add(bountiesTaxAlloc).add(daoTreasuryTaxAlloc).add(_marketingTaxAlloc).add(_lpTaxAlloc);
    ...
    function setMultiSigTaxAllocations(
        ...
        totalTaxAlloc = marketingTaxAlloc.add(lpTaxAlloc).add(_operationsTaxAlloc).add(_buybackTaxAlloc).add(_bountiesTaxAlloc).add(_daoTreasuryTaxAlloc);
