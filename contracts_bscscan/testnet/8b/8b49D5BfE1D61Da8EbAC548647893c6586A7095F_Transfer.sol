...
contract Transfer is Ownable {
     ...
     */
    constructor(IIncomeisland _incomeIsland, IUtility _utility) {
    ...
    function sale(
        ...
        incomeIsland.safeTransferFrom(_from, _to, _nftType, 1, "");
        utility.updateNFTHistory(_from, _nftType, _nftNum, 0);
        utility.updateNFTHistory(_to, _nftType, _nftNum, 1);
    }
