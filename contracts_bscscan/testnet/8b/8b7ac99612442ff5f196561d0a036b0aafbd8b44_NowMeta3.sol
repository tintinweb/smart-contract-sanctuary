...
// The name of the token
    contract NowMeta3 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//token "name" and "symbol"
    string private _name = "Now Meta3";
    string private _symbol = "NMETA3";
    ...
    uint256 internal _tokenTotal = 100000000000000000000000e8;
    ...
    // this goes to a specific wallet (line 406)
    uint256 public _marketingFee = 400;
    // this also goes to a specific wallet  (line 410)
    ...
    constructor() public {
        ...
        marketingWallet = 0xA0C6f9ff74B5a820Ca0490F70DE9e785c8ffFD5d;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here

        //paste the wallet adress, that earns the charityFee here
        charityWallet = 0x9db563411489c77E319F9c109d8b1e3A5C29108B;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the charityFee here
