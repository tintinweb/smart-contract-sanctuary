...
contract AnjiFees is Ownable {
    ...
    address public anjiTokenContract = 0xb0996BBA551E7BDfcE03dDFb69d19792fC1dD460;
     ...
     * @notice set the charity wallet address by owner
     *
     * @param _anjiToken: charity wallet address
     */
    function setAnjiTokenAddress(address _anjiToken) external onlyOwner {
        anjiTokenContract = _anjiToken;
    }
     ...
     *
     */
    function distributeDividend() public virtual{
        ...
        if (amountToAnji > 0) {
            IBEP20(WBNB).approve(address(this), amountToAnji);
