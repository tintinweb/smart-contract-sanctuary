...
contract PassiveBUSD is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "PassiveBUSD";
    string constant _symbol = "PassiveBUSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10 ** 9 * (10 ** _decimals); // 1T
