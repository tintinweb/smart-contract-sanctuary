...
contract BASH is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x7D883Ff1ECd7Af5a9FE99F3084273a9a05373805); // -
    address payable public Wallet_Dev = payable(0x9f628224b15F2796AbC92f93005afcF90fd16B96); // -
    address payable public Wallet_LP = payable(0xdfE0028A43713f1faa58025fC99c9c0d6543b201); // -
    ...
    string private constant _name = "BASHI INU"; 
