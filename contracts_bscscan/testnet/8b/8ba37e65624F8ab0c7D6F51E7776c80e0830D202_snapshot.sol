...
interface IPancakeswapV2Router02 is IUniswapV2Router01 {
...
contract snapshot is Context, IERC20, Ownable {
    ...
    constructor()  {
        IPancakeswapV2Router02 _pancakeswapV2Router = IPancakeswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // for BSC Pncake v2
        ...
        _isExcluded[address(
            pancakeswapV2Pair)] = true;
        _excluded.push(address(pancakeswapV2Pair));
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && overMinTokenBalance && sender != pancakeswapV2Pair && swapAndLiquifyEnabled) {
