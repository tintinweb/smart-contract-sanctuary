...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47); //Solana contract address
...
contract GODHAND is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "God Hand";
    string constant _symbol = "HAND";
    ...
    uint256 public _walletMax = _totalSupply * 25 / 1000; // 2,5% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xD8251a6B0A8eC43659Edf5bC34ada5C1dA63D4AD;
