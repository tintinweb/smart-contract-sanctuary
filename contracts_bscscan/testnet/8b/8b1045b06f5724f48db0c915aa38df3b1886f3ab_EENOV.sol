...
contract EENOV is  ERC721PresetMinterPauserAutoIdUpgradeable  {
    ...
    function initialize() initializer public {
        __ERC721PresetMinterPauserAutoId_init("EENOV", "EENOV", "https://localhost");
    ...
    function sendBal(address payable receiver, uint amount) payable external  returns(bool success) {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "EENOV must have admin role to withdraw");
