 ...
 */
contract SingleCollection is Ownable, ERC721, IERC721Metadata, ERC721Burnable, ERC721Base, SignerRole {
...
contract SingleUserCollection is SingleCollection {
    ...
    constructor(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix) SingleCollection(name, symbol, contractURI, tokenURIPrefix, address(this)) public {}
