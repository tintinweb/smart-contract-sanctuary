...
contract iUSDC is ERC20, ERC20Detailed, ReentrancyGuard, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address _token, address venus_) public ERC20Detailed(name_, symbol_, 18) {
        token = _token;
        venus = venus_;
        approveToken();
