...
contract NFTMARS_PUBLIC_TESNET {
    ...
    function setAddressInfo(
        ...
        require(_unsoldTokensDumpAddress != address(0), "_unsoldTokensDumpAddress Error");
    ...
    function setGeneralInfo(
        ...
        require(_totalTokens > 0, "_totalTokens <= 0");
    ...
    function allowClaim(uint256 _cakeLiquidityAddingTime) external onlyBscsDev {
        require(_cakeLiquidityAddingTime > 0, "LP Time Error");
        require(closeTime > 0, "Close Time =0");
        require(_cakeLiquidityAddingTime >= closeTime ,"LP Time < CloseTime");
        ...
        presaleIsNotCancelled
    {
        ...
        require(tokensLeft > 0, "tokensLeft = 0");
        ...
        onlyRefundAllowed
    {
        ...
        require(presaleBalance > 0, "PresaleBalance Error");
    ...
    function cancelAndTransferTokensToDev() external onlyBscsDev {
        ...
        require(!presaleCancelled, "PresaleCancelled False");
