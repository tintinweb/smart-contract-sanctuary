...
FURVINTOKEN is built upon the fundamentals of Buyback and increasing the investor's value
...
contract FURVINTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "FURVINTOKEN";
    string private _symbol = "FURV";
    ...
    uint256 private minimumTokensBeforeSwap = 200000 * 10**1 * 10**9; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000000 * 10**1 * 10**9;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 9;
        _maxTxAmount = 3000000 * 10**1 * 10**9;
    }
