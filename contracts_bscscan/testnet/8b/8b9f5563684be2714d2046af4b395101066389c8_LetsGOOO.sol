...
contract LetsGOOO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LetsGOOO", "LetsGOOO", 9) {
    ...
    function _transfer(
        ...
        require(!_isBot[to] || !_isBot[from], "MagicDOGE: To/from address is a bot");
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to] || from == address(this) || isTradingEnabled) {
            takeFee = false;
        }
...
contract MagicDOGEDividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("MagicDOGE_Dividend_Tracker", "MagicDOGE_Dividend_Tracker", 9) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10 * 10 ** 9 * (10**9); //must hold 30,000,000,000+ tokens to get divs
    }
