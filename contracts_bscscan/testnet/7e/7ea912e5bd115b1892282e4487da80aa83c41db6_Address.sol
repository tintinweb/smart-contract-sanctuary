...
It’s in the Name!
dummy1 Token has been carefully designed to achieve a single purpose – GOING PARABOLIC! 
Our super addictive games and tokenomics will benefit the coin and consistently take it to new heights. Our game will be released in November, so don’t miss your chance to get in early!
...
contract dummy1 is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xc7ae9dFc3cD94c188076c3cEbC5978c43B532EA4);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xc7ae9dFc3cD94c188076c3cEbC5978c43B532EA4); 

    string private _name    = "dummy1";
    string private _symbol  = "dum";
