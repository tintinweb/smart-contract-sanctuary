...
contract BIN is SafeMath{
    ...
    constructor () public{
        balanceOf[msg.sender] = 1000000000000000000000000000000000;            // Give the creator all initial tokens
        totalSupply = 1000000000000000000000000000000000;                    // Update total supply
        name = 'Baby Ink';                                 // Set the name for display purposes
        symbol = 'BIN';                                   // Set the symbol for display purposes
        decimals = 18;                                      // Amount of decimals for display purposes
        owner = msg.sender;
        emit Transfer(0x0000000000000000000000000000000000000000, msg.sender, 1000000000000000000000000000000000);
    }
