...
contract Chainance is Context, Ownable{
    ...
    //- Get Account
    function getAccount(address _address) public view returns(uint256, uint256, string memory, string memory, string memory, string memory, string memory, string memory, address) {
        require(AccountStruct[_address].Account_Address == _address, "err_code : 6"); //- No account found at Wallet address.
        
        return(AccountStruct[msg.sender].index,
        AccountStruct[msg.sender].CreateTime,
