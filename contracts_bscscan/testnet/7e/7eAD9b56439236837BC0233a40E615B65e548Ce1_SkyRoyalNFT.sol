...
contract SkyRoyalNFT is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 payment) public  {
        ...
        if (msg.sender != owner()) {
            ...
            uint256 royality = (payment * royalityFee) / 100;
            _payRoyality(royality);

            uint256 value = payment - royality;
            skyToken.transferFrom(msg.sender, owner(),value);
        }
...
contract SkyToken is ERC20Interface{
