...
contract Token is BEP20 {
     ...
     */
    constructor() public BEP20("test Token", "TToken") {
    ...
    function _transfer( address sender, address recipient, uint256 amount ) internal virtual override {
        if(
            sender != farmAdrress && sender != owner() && sender != devRewardAdrress && sender != minterAdrress &&
            recipient != owner() && recipient != devRewardAdrress && recipient != minterAdrress
        ){
