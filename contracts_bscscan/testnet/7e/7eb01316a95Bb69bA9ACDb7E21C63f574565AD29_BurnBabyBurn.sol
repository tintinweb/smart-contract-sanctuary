 ...
 * COIN
 */
contract BurnBabyBurn is Context, IERC20, Ownable, ReentrancyGuard {
    // Libraries
    ...
    // Token
    string private _name = "rhgadsfhg";
    string private _symbol = "keklord";
    ...
    function setMaxSellTxTokens(uint256 maxTxTokens) external onlyOwner {
        _maxSellTxAmount = maxTxTokens * 10**18;
    }

    // Set the max buy tx in tokens
    function setMaxBuyTxTokens(uint256 maxTxTokens) external onlyOwner {
       _maxSellTxAmount = maxTxTokens * 10**18;
    }
