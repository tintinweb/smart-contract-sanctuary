...
contract Smazy is Ownable, ERC20 {
    ...
    constructor() ERC20("Smazy token", "MAZY") {
        _mint(_msgSender(), 1_000_000_000_000_000_000_000_000_000);
    ...
    function sellMazy(uint256 amount) public {
        ...
        require(
            ...
            "The Smart Contract's USD balance is not enough to make this transaction"
        );
