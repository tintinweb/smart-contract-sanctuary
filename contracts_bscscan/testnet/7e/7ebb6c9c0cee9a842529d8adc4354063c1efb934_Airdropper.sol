...
contract Airdropper is Ownable {
    ...
    function AirTransfer(address _recipients, address _tokenAddress) public returns (bool) {
        
        require((_received[_recipients] + 24 hours) < now, 'You can only collect once in 24 hours');
