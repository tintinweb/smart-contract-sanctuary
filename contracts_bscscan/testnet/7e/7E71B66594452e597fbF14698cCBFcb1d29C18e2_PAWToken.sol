...
contract BEP20 is Context, IBEP20, Pausable {
     ...
     * `amount`.
     */
    function transferFrom(address sender, address recipient, uint256 amount) public override virtual whenNotPaused returns (bool) {
...
contract PAWToken is BEP20Detailed, BEP20 {

    uint256 private totalTokens;
    
    constructor() public BEP20Detailed("ZooForce", "PAW", 18) {  
