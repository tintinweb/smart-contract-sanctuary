...
contract HoldMePresale is Ownable {
    ...
    /**
        ...
        Token in $ = 300_000/10^11 = 0.000003 $

        373$..........1 BNB
        Token-in-$....X BNB
        
        1 Token.......8.04289544e-9 BNB * 10^18
        X Token.......0.1 BNB * 10^18
        x = 12433333.3333 Tokens    
     */

    uint256 public priceRatio = 8042895440;
    ...
    function buyToken() public payable {
        uint256 expectedTokenAmount = msg.value.div(priceRatio);
        token.transfer(msg.sender, expectedTokenAmount);
    }
