...
contract TBD123 is ERC20, Ownable {
    ...
    constructor() public ERC20("TBD123", "TBD123") {
        ...
        _marketingWallet = 0xed344d0b7DA5d31A83c95b73eC5C50936C1d43f1;
        _devWallet = 0xb289bd090CAbECA807F3BD890221d705d44aF90C;
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "KODI: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "KODI: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "KODI: The liquidity wallet is already this address");
...
contract KODIDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "KODI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
