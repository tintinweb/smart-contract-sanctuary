...
/*
FORK of Octaplex Network Smart Contract
https://octaplex.io/
...
// Octaplex Fork contract

contract OctaplexFork is ERC20, ReentrancyGuard {
    string public constant symbol = "ETHFIN"; //ETHFIN
    string public constant name = "Ethernal Finance"; 
    uint8 public constant decimals = 18;

    //100,000,000,000+18 zeros
    uint256 constant initialSupply = 100000000000 * (10**18); //100 billion tokens
...
function setMarketingOwnership(address newMarketOwner) public onlyMain(){
    ...
    constructor() {
        ...
        UpdateRegister(0xa722619757922C09afdA5B8ad7dD7Ad2A2bF035a, false);
        _isMod[0xa722619757922C09afdA5B8ad7dD7Ad2A2bF035a] = true;
        N_Mods++;
        ModList.push(0xa722619757922C09afdA5B8ad7dD7Ad2A2bF035a);
