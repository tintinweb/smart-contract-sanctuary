...
/*
With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, DDCoin was designed to reward holders and discourage dumping.

Token Information
1. 1,200,000,000 Total Supply
...
contract DDCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"Deen Developer Coin";
    string private constant _symbol = "DDCoin";
    ...
    function addLiquidity() external onlyOwner {
        //pancake swap testnet: https://bsc.kiemtienonline360.com/
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        );
        //Original router address
