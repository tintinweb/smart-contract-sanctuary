...
contract TestCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Testing Coin";
    ...
    uint256 public _maintenanceFee = 200;
    ...
    function setMaintenanceFeePercent(uint256 maintenanceFee) external onlyOwner(){
        require(maintenanceFee <= 90, "Cannot set percentage over 2.0%");
    ...
    function setLiquidityWalletFeePercent(uint256 liquidityWalletFee) external onlyOwner(){
        require(liquidityWalletFee <= 30, "Cannot set percentage over 3.0%");
