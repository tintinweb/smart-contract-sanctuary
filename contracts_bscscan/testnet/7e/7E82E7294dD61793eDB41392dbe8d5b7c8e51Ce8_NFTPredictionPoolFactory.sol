...
contract NFTPredictionPoolFactory is PoolCreator{
    ...
    function createPoolProxy(
        ...
        address[4] memory storageUSDIDOCreator = [usdStorage, usdTokenAddress, _nftToken, _msgSender()];
    ...
    */
    ...
    function setNewPredictionNumber(IPredictionNumber _predictionNumber) external onlyPoolCreator {
        predictionNumberContract = _predictionNumber;
