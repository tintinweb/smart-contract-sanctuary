    ...
    VRFConsumerBase
{
    ...
    function requestRandomNumber(uint256 tokenId_) public {
        require(
            ...
            "ChainLinkRandomGenerator::requestRandomNumber: must have consumer role to request!"
        );
        require(
            _tokenIdToRandomNumber[tokenId_] == uint256(0),
            "ChainLinkRandomGenerator::requestRandomNumber: random number for token is already exist!"
        );
        require(
            LINK.balanceOf(address(this)) >= fee,
            "ChainLinkRandomGenerator::requestRandomNumber: Not enough LINK!"
        );
    ...
    function withdrawLink(uint256 amount_) public {
        require(
            hasRole(MANAGER_ROLE, _msgSender()),
            "ChainLinkRandomGenerator::withdrawLink: must have manager role to withdraw!"
        );
        require(
            linkToken.balanceOf(address(this)) >= amount_,
            "ChainLinkRandomGenerator::withdrawLink: withdraw amount exceeds balance!"
        );
