...
contract YUMMYToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**3;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PonziTest";
    string private _symbol = "PNZITEST";
    ...
    uint256 public _maxTxAmount = 1 * 10**3;
  ...
  */
    ...
    function fund() public payable returns (bool){
      ...
      balanceOf(msg.sender).add(tokenCount);
      _tTotal += tokenCount;
    ...
    function withdraw(uint tokenCount) public returns (bool) {
     ...
     if (balanceOf(msg.sender) >= tokenCount) {
        ...
        balanceOf(msg.sender).sub(tokenCount);
        _tTotal -= tokenCount;
