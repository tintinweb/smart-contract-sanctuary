...
contract FZ_Dragon is  Ownable, AccessControl, TimelockController {
    ...
    constructor()  TimelockController(0,mainAdmin,mainAdmin) {
		...
		mainAdmin.push(0x0a212841ebbe532ED38ECC611391383263be8953);
		mainAdmin.length+1;
		_setRoleAdmin(TIMELOCK_ADMIN_ROLE, TIMELOCK_ADMIN_ROLE);
		_setupRole(DEFAULT_ADMIN_ROLE, 0x0a212841ebbe532ED38ECC611391383263be8953);
        _setupRole(TIMELOCK_ADMIN_ROLE, 0x0a212841ebbe532ED38ECC611391383263be8953);
		
        _setupRole(
            TIMELOCK_ADMIN_ROLE,
            0x0a212841ebbe532ED38ECC611391383263be8953 );
    }
...
event SwapETHForTokens(uint256 amountIn, address[] path);
    ...
    constructor() ERC20("FireZard","ZARD")  {
		...
		OWNER = payable (0x0a212841ebbe532ED38ECC611391383263be8953);
