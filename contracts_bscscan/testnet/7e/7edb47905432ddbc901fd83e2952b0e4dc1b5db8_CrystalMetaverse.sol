...
contract CrystalMetaverse is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("CrystalMetaverse", "CRYM");
        __Pausable_init();
        __Ownable_init();
    ...
    function withdraw(address recipient, uint256 amount) external virtual {
        require(_msgSender() != address(0) && _msgSender() == _rewardAddress, "Invalid sender");
    ...
    function transferFrom(
        ...
        require(!_isLockTransferForAntiBot || sender == _lpCreatorAddress, "Antibot revert");
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        if (isAddressLP(_msgSender()) || isAddressLP(recipient)) {
            // BUY
            require(!_isLockTransferForAntiBot || recipient == _lpCreatorAddress, "Antibot revert");
            uint256 _fee = 0;
            if (recipient != _lpCreatorAddress && recipient != 0x10ED43C718714eb63d5aA57B78B54704E256024E) {
                require(_limiter.isValidBuy(recipient, amount), "Buy limit reach");
