...
contract MidoNFTSale is IMidoTokenSale, Whitelist {
    ...
    uint64 public totalRoudIndex;

    bool public publicSale = false;

    MidoHero public immutable midoHero;
     ...
     */
    function setSaleRound(uint64 _saleRoudIndex) external onlyOwner {
    ...
    function newSale(
        ...
        totalRoudIndex = uint64(_saleConfig.length - 1);
        midoHero.updateTotalSupplyWithNewSale(_maxSupply);
    }
...
contract MidoHero is ERC721, ERC721Enumerable, ERC721Burnable, AccessControl, Pausable {
    ...
    constructor() ERC721("MidoHero", "MIDOHERO") {
