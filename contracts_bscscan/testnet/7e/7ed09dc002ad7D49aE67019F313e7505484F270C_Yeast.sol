...
contract Ownable is Context {
    ...
    // Initialized by Yeast constructor
 ...
 * Required for PancakeSwap auto-liquidity
 * 
 *  
 * 
 */
...
contract Yeast is Context, IBEP20, Ownable {
    ...
    // Total Liquidity Fee removed during Swap and Liquifiy
    uint256 public _liquidityFee = 10; 
    
    // Percentage removed from total for Marketing
    uint256 public _percentageOfLiquidityForMarket = 25; 
    
    // Percentage removed from total to be added to Staking
    uint256 public _percentageOfLiquidityForStake = 25;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        uint256 bnbForLiquidity = newBalance.sub(marketFee);
        bnbForLiquidity = bnbForLiquidity.sub(stakeFee);
