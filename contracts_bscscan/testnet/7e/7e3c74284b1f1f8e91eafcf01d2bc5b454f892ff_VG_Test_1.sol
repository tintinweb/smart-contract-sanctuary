...
contract VG_Test_1 is Context, IERC20, Ownable {
    ...
    string private _name = "VG_Test_1";
    string private _symbol = "VG_TEST_1";
    ...
    uint256 private minimumTokensBeforeSwap = 3 * 10**9 * 10**9; 
    
    address payable public charityAddress1 = 0x35642F3C8B25401Ed0B04EC5a583f1f5204Be7fe;
    address payable public charityAddress2 = 0x289054C2d919B919ae0C4Ce14943899C2c8F7D69;
    address payable public charityAddress3 = 0x69Af94Ff12cD34Fb479D677E664C740cA2bEB1b7;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 donationTransfer = (address(this).balance).div(10);
        
        TransferCharityBNB(charityAddress1, donationTransfer*8); 
        TransferCharityBNB(charityAddress2, donationTransfer);
        TransferCharityBNB(charityAddress3, donationTransfer);
    ...
    function setDonationAddress1(address payable charity1) external onlyOwner() {
        charityAddress1 = charity1;
    }
    
    function setDonationAddress2(address payable charity2) external onlyOwner() {
        charityAddress2 = charity2;
    }
    
    function setDonationAddress3(address payable charity3) external onlyOwner() {
        charityAddress3 = charity3;
    }
