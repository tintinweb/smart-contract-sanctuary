...
contract Gid is Context, IBEP20, Ownable {
    address public liquidityBank;
    uint256  public dividendPerToken;
    uint256 private DENOMINATOR = 10_000;
    uint256 private LIQUIDITY_PERCENT = 100;
    uint256 private ALL_HOLDER_PERCENT = 400;
    uint256 private BURN_PERCENT = 400;
    ...
    constructor () Ownable(0x3532baadBD5C314BAFf991F39aE8eCE7f3F66786) {
        require(0x3532baadBD5C314BAFf991F39aE8eCE7f3F66786 != address(0), "BEP20: transfer from the zero address");
        require(0x21Fb2fF5571E6f2957450A55a5077c27c84e2376 != address(0), "BEP20: transfer from the zero address");
        liquidityBank = 0x21Fb2fF5571E6f2957450A55a5077c27c84e2376;
        _totalSupply = 1 * 10 ** uint256(decimals());
        _name = "Gid";
        _symbol = "FKP";
        _balances[0x3532baadBD5C314BAFf991F39aE8eCE7f3F66786] = _totalSupply;
        emit Transfer(address(0) , 0x3532baadBD5C314BAFf991F39aE8eCE7f3F66786, _totalSupply);
    }
