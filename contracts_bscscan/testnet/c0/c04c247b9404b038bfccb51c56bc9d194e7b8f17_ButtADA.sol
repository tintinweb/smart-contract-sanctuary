...
contract ButtADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ButtADADividendTracker public dividendTracker;
    ...
    constructor() public ERC20("ButtADA", "$ButtADA") {

    	dividendTracker = new ButtADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ButtADADividendTracker newDividendTracker = ButtADADividendTracker(payable(newAddress));
...
contract ButtADADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("ButtADA Dividends", "ButtADA_dividends") {
    	claimWait = 3600;
