...
contract SOSV is Context, IERC20 { 
    ...
    */
    ...
    address payable public Wallet_Marketing = payable(0x9D3E8C456019deAc5C613CBc5E14998BfFAC95c3); 
    address payable public Wallet_LP = payable(0x9D3E8C456019deAc5C613CBc5E14998BfFAC95c3);
    address payable public Wallet_Tokens = payable(0x9D3E8C456019deAc5C613CBc5E14998BfFAC95c3); 
    ...
    string private constant _name = "SOSV"; 
    string private constant _symbol = unicode"SOSV"; 
    ...
    uint256 public constant _Tax_On_Buy_MAX = 99; 
    uint256 public constant _Tax_On_Sell_MAX = 99;
    ...
    constructor () {
        ...
        _owner = 0x9D3E8C456019deAc5C613CBc5E14998BfFAC95c3;
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 Marketing_Wallet, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((Marketing_Wallet + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
   
        Percent_Marketing = Marketing_Wallet;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_Marketing != 0){
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing);
        ...
        } else if (Percent_AutoLP == 0 && Percent_Marketing != 0){
