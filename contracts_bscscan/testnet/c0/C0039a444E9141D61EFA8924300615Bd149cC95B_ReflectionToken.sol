...
contract ReflectionToken is IERC20, Ownable{
    ...
    address public immutable pancakePair = IPancakeFactory(pancakeRouter.factory()).createPair(address(this), pancakeRouter.WETH());
    ...
    bool public swapAndLiquifyEnabled = true; // should be true to turn on auto liquidate the pool
    bool public reflectionFeesdiabled = false; // should be true to disable fees
    bool public buyBackEnabled = true;  // should be true to turn on buy back from liquidity pool
