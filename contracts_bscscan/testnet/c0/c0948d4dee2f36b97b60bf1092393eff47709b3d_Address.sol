...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        _symbol = "TESTT";
        _decimals = 9;
        _tTotal = 420000000000000000 * 10 ** 9;
        _rTotal = (2100000000000000 - (2100000000000000 % _tTotal));
        _taxFee = 2;
        _liquidityFee = 2;
        _previousTaxFee = 2;
        _previousLiquidityFee = 2;
        _maxTxAmount = 2100000000000000 * 10 ** 9;
        numTokensSellToAddToLiquidity = 2100000000000000 * 10 ** 9;
        
        address tokenOwner = 0xaA122Ab9cF0EFE3dD51d2479e140bF9C9Ba4bcDD;
