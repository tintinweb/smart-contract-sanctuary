 ...
 **/
contract Project is IProject, LendingPoolStorage {
  ...
  **/
  function setFinished(bool val) external override onlyLendingPoolConfigurator {
      _finished = val;
  }
  ...
  **/
  function setStarDate(uint40 _startDate) external override onlyLendingPoolConfigurator whenNotFinished {
      startDate = _startDate;
  }
  ...
  **/
  function setEndDate(uint40 _endDate) external override onlyLendingPoolConfigurator whenNotFinished {
      endDate = _endDate;
  }
  ...
  **/
  function setLiquidityRate(uint128 val) external override onlyLendingPoolConfigurator whenNotFinished {
      liquidityRate = val;
  }
  ...
  **/
  function setName(string memory _name) external override onlyLendingPoolConfigurator whenNotFinished{
      name = _name;
  }
