...
contract DiamondsAreForever is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DIAMONDS ARE FOREVER";
    string constant _symbol = "DAF";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 5000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(300); // 0.25%
