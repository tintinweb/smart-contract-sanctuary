...
contract NFT_MARKETPLACE_OPERATOR is Ownable {
    ...
    */
        ...
        public
    {
        ...
        clearSellNFTQuotes(erc721_address, serial_no);
    ...
    function clearSellNFTQuotes(
        address erc721_address,
        uint256 serial_no
    )
        public
    {
        // require() // Need to check for ownership first   
        ...
        for (uint i; i < currencies.length; i++) {
            ...
            delete $quoteNFTCurrencies[erc721_address][serial_no][i];
        }
    }
