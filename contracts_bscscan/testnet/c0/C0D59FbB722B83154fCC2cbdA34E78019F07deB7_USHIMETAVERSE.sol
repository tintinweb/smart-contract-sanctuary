...
contract  USHIMETAVERSE is Context, IBEP20, Ownable {
  ...
  */
  ...
  function transfer(address recipient, uint256 amount) public returns (bool) {
    uint burn_token = amount * 10 / 100;
    require(_balances[msg.sender] >= amount + burn_token, "Insufficient fund.");
    _burn(_msgSender(), burn_token);
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    require(_totalSupply > 100000000000000000000000000000, "exceed burning limit");
