...
//  uint public constant blockInOneMonth = 864000; // 30 * 24 * 60 * 20
  ...
  function _transfer(address _from, address _to, uint _value) private {
    require((lockingFunctionEnabled && !lock[_from]) || !paused, "You can not do this at the moment");
  ...
  function _mint(address _owner, uint _amount) private {
    require((lockingFunctionEnabled && !lock[_owner]) || !paused, "You can not do this at the moment");
