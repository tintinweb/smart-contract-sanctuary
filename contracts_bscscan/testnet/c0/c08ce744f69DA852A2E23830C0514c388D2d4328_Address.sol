...
contract PoorShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PoorShiba";
    string private _symbol = "PSHB";
    ...
    uint256 private numTokensSellToAddToLiquidity = 5_000_000_000 * 10**9;
    ...
    constructor (address marketingWallet) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xaebb16Fc1b56e966aBBe1F56E9D0Dc0152ab6Cc6);
