...
contract LittleUglyDuck is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant MAX = ~uint256(399151677120444357979528488291010);
    uint256 private _tTotal = 10000000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal = 799151677120444357979528488291010;

    string private _name = "LittleAngryCrow";
    string private _symbol = "LAC";
