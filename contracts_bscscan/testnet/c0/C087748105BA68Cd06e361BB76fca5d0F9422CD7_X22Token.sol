...
contract X22Token is Context, IERC20, Ownable, LGEWhitelisted {
    ...
    modifier onlyMinter(){
        require(_msgSender() == minter, 'Only minter can call');
        _;
    }
    ...
    constructor() public {
        ...
        minter = _msgSender();
        _maxTotalSupply = 22000022 * 10 ** 18;
    ...
    function mint(address account, uint256 amount) public onlyMinter(){
        ...
        require(_totalSupply <= _maxTotalSupply, 'Total supply exceeds Max total Supply');
