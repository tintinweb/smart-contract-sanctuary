...
contract GameNFT is ERC721Full, Governance {
    
    mapping(address => bool) public _minters;
    

    constructor() public ERC721Full("GameNFT", "GNFT") {
    ...
    function setURIToken(uint256 tokenId, string memory tokenURI) public onlyGovernance {
