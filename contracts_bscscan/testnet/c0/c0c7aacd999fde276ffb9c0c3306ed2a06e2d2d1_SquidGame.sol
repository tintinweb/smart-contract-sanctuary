...
contract SquidGame is Ownable {
    ...
    {   
        ...
        require(address(this).balance > 0, "The prize pot is not filled up yet"); // should be 456
    ...
    function playTheRound() public returns (bool)
    {
        ...
        for (uint256 i = 0; i < nftCount; i++) {
            uint nftID = getNftID(msg.sender, i);
