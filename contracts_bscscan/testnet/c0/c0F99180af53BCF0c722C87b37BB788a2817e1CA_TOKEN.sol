 ...
 *     --------------------------------------------------------
 *     |- Total Supply 1000
 *     |- Max per Holder: 10 tokens (1% total supply)
 *     |- Max sell: 1 token (0.1% of supply)
 *     |- Sell cool down: 3 minutes
 *     |- 10% Buy Tax
 *     |- 20% Sell Tax
 *     |- 30% Wallet transfer tax
 *     |
 *     |- TG: TBD
 *     |
 *     |- Made by the Pillars of Creation.
 *     -------------------------------------------------------
 *     
 */
...
/**
 * @dev Contract module which provides a extensive mechanism, where
...
contract TOKEN is IBEP20, Ownable
{
    ...
    string private constant _name = 't1k 01';
    string private constant _symbol = 't1k';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000 * 10**_decimals; // 10000
    ...
    //TODO: PoC Wallet (DEV)
    address public constant TeamWallet=0xFf06F79F18B588249C3C8De2cF610653D02fdfFa;
    // PoC Wallet
    //address public constant TeamWallet=0x349ECC3D46218714Fb3A048b1E7BE2D6AC5F02Ce;
    //TODO: https://pancake.kiemtienonline360.com/#/swap
    ...
    function _transfer(address sender, address recipient, uint256 amount) private{
        ...
        // @NOTE: This could be used for paying respects for people in the PoC community
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimBUSD(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
        ...
        //Swapping AutoLP and (M)BNB is only possible if sender is not pancake pair, 
    ...
    event OnWithdrawBUSD(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimBUSD(address addr) private{
        ...
        //TODO: testnet BNB
        path[1] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;  // BUSD 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56   BTC 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c
        ...
        emit OnWithdrawBUSD(amount, addr);
        _isWithdrawing=false;
    }
