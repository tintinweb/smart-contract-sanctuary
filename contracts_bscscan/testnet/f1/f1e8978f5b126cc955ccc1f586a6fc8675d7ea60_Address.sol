...
contract DOGEGOD is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "DOGE GOD";
    string private _symbol = "DOGEGOD";
    ...
    function _transfer(
        ...
        if (
            ...
            if (
                ...
                // swap DOGEGOD into ETH to add to liqudity
