...
contract AAH is IBEP20, Auth {
    ...
    string constant _name = "Avax Hunt";
    string constant _symbol = "AAH";
    ...
    function getOwner() external view override returns (address) { return msg.sender; }
