...
contract FOMOFLOKI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Fomo Floki";
    string constant _symbol = "FFKI";
    ...
    constructor (address fomoflokiowner) Auth(fomoflokiowner) {
        ...
        isFeeExempt[fomoflokiowner] = true;
        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[fomoflokiowner] = true;

        isTimelockExempt[msg.sender] = true;
        isTimelockExempt[fomoflokiowner] = true;
        ...
        autoLiquidityReceiver = fomoflokiowner;
        marketingFeeReceiver = fomoflokiowner;
        charityFeeReceiver = fomoflokiowner;

        _balances[msg.sender] = _totalSupply;
        emit Transfer(address(0), fomoflokiowner, _totalSupply);
    }
