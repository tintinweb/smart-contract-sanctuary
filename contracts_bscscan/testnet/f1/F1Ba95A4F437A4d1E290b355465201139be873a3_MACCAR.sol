...
contract MACCAR {
    ...
    constructor()
    {
        ...
        _transferCharityFunds(owner);
        _transferAirdropSenderFunds(owner);
    ...
    string public tokenName = "MACCAR";

    string public tokenSymbol = "MAC";

    uint8 public decimal = 9;
    
    uint256 public totalSupply = 1000000000 * 10**9;

    uint256 public burnedAmount = 225000000 * 10**9;

    uint256 public devFunds = 3500000 * 10**9;

    uint256 public charityFunds = 20000000 * 10**9;

    uint256 public airdopFunds = 1500000 * 10**9;

    uint256 public preSaleLimit = 100000000 * 10**9;

    uint256 public pricePerToken = 4000000000000;
    ...
    address dev = address(0x84dd5a9b9433Acc74795016b92f94B60Be5a1efD);
    
    address charity = address(0xA1D52894a239F1B296Ff3a91D60ED0B304C00fc3);

    address airdrop_sender = address(0xE4A585E0F873Fa49167B88FD63Ba0500dd4B0f88);
    ...
    function initialBurn(address sender) public {
        _transfer(sender, address(0), burnedAmount);
        emit Burned(sender, address(0), burnedAmount);
    }
    ...
    function _transferCharityFunds(address sender) public {
        _transfer(sender, charity, charityFunds);
    }

    function _transferAirdropSenderFunds(address sender) public {
        _transfer(sender, airdrop_sender, airdopFunds);
    }
