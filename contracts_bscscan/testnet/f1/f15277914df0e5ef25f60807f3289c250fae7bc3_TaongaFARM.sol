...
contract TaongaFARM is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 690 * 10**4 * 10**18; 
    uint256 public _numTokensSellToAddToLiquidity = 500 * 10**4 * 10**18; 
    uint256 public _maxWalletToken = 2.1 * 10**8 * 10**18; 
    ...
    string private _name = "TAONGAFarm";
    string private _symbol = "TAONGAFarm";
