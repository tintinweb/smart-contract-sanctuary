...
contract PreSale is ReentrancyGuard, Context, Ownable{
    ...
    uint public maxContribution = 2 ether;
    
    uint startDate = 1636193393; // 1636988400 2021-11-15 15:00:00 UTC
    ...
    uint public bnbRate = 6800000; // 6,800,000 MILKY per BNB
