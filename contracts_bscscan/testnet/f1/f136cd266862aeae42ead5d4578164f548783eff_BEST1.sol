...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FV = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x3632B0819D3e539715C1572F40E4892Bc0bBBc50);
        _token = msg.sender;
    }
...
contract BEST1 is IBEP20, Auth {
    using SafeMath for uint256;

    address FV = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Best1";
    string constant _symbol = "BEST1";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x3632B0819D3e539715C1572F40E4892Bc0bBBc50);
