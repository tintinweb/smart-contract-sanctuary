...
contract Lottery is Ownable {
    ...
    //roll for a winner
    function draw() private onlyOwner returns(address){
        require(TICKETBAG.length > 0);
        require(LOTTO_LIVE);
        uint256 randomNum = uint(keccak256(abi.encode(block.difficulty, block.timestamp, TICKETBAG)));
