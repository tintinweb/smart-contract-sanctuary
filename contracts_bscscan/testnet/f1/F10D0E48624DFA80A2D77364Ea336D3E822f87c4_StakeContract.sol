...
contract StakeContract is Ownable {
    ...
    uint256 public startBlock = 16219383 ; // set start block
    uint256 public minimum_deposit = 1*9**18; //minimum deposit
    uint256 public endBlock =   116136712 ;  // set end block
    uint256 public rewardperblock = 0.2*10**18; // set block reward
    uint256 private unlockblockperiod = 0; 
    address public rewardaddress = 0x35c77BEfA581Ae0F3861ceF24e7350aF5239c2c5 ;
    address public stakeaddress = 0x8D700052B7eb419BcdFFc08658dD3dC3E5548F33 ;
    uint256 public totalpoolstacked = 0;
    uint256 public lastRewardBlock = 16219383;  // set start block
