...
contract GymVaultsBank is ReentrancyGuard, Ownable {
    ...
    */
    ...
    function getBNBAmount(address _user) public view returns (uint256){
        ...
        uint256[] memory alpacaToBNBAmount = IPancakeRouter02(0x367633909278A3C91f4cB130D8e56382F00D1071).getAmountsOut(pendingAlpacaContract, alpacaToWBNB);
...
interface IFarming {
    ...
    function setrewardPerBlock(uint256) external;
    
    function getMultiplier(uint256, uint256) external view returns (uint256);
    ...
    function speedStake( uint256, uint256, uint256, uint256, uint256, uint256) external payable;
}
