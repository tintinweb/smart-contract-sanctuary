...
contract ChivesZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9Eaff6cEc386aCaA08172B1c1DcA1Ff0F28E1595); // Marketing Address
    ...
    uint256 private _tTotal = 69 * 10**21 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _maxWalletTotal = 138 * 10**19 * 10**9;
    uint256 private _tFeeTotal;

    string private _name = "ChivesZilla";
    ...
    //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        marketingAddress = payable(0x9Eaff6cEc386aCaA08172B1c1DcA1Ff0F28E1595);
    }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            require(amount <= _maxWalletTotal, "Transfer amount exceeds the maxTxAmount.");
