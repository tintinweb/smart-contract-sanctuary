...
contract DoomsDayController is Ownable {
    ...
    constructor() {
        ...
        DOO = DMToken(0x7A1B732e7280B1e41a0e286cd9EB7fF378f2563B);
    ...
    function updateMiningRatio() public onlyOwner {
        ...
        uint256 DOMNum = DOM.balanceOf(pairAddr);

        //精度问题???
        uint256 price = 10000 * WBNBNum.div(DOMNum);
