...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4d6b282B019ec68C1686D553F294927c9FC58540;
...
contract QuickSpace is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x29D7d1dd5B6f9C864d9db560D72a247c178aE86B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "QuickSpace";
    string private _symbol = "QuickSpace";
