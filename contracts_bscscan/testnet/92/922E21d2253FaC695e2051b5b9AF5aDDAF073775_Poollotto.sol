...
contract Poollotto is ReentrancyGuard, IPoollotto, Ownable {
    ...
    IPoollottoRandomNumberGenerator public randomGenerator;
    ...
    constructor(address _pltTokenAddress, address _randomGeneratorAddress) {
        ...
        randomGenerator = IPoollottoRandomNumberGenerator(_randomGeneratorAddress);
    }
    ...
    function changeRandomGenerator(address _randomGeneratorAddress) external onlyOwner {
        ...
        // Request a random number from the generator based on a seed
        IPoollottoRandomNumberGenerator(_randomGeneratorAddress).getRandomNumber();

        // Calculate the finalNumber based on the randomResult generated by ChainLink's fallback
        IPoollottoRandomNumberGenerator(_randomGeneratorAddress).viewRandomResult();
    ...
    function _calculateRewardsForTicketId(
        ...
        if(winningNumber == winningTicketNumber) {
            return _lotteries[_lotteryId].amountToShareToWinners / ( _lotteries[_lotteryId].ticketPerPool[winningNumber]);
        } else {
            return 0;
        }
    }
