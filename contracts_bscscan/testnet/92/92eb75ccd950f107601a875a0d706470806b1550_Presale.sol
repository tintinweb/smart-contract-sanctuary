...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    mapping (address => uint256) public _TokensReserved;
    ...
    function bulkAddtoWhitelist(address[] memory _addresses) public onlyOwner {
    ...
    function buyTokens() public nonReentrant icoActive payable {
        ...
        _TokensReserved[beneficiary] = tokens;
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(checkWhitelist(beneficiary) == true, "Address not whitelisted");
    ...
    //Refund if presale not reached the softcap
