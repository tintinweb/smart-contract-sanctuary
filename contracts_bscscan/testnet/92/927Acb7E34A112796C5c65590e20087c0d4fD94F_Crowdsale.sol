...
contract Crowdsale is Ownable {
  ...
  uint256 public rate = 666666666.67 ether;
  ...
  */
  ...
  /**
   * @dev Constructor, creates RefundVault and takes rate, wallet, token, opening and closing time
  ...
  */
  constructor(address _wallet, IERC20 _token) {
    ...
    closingTime = openingTime + 2 hours;
  ...
  */
  ...
  function takeBack() onlyOwner public {
    require(isFinalized);
  ...
  function claimRefund() public {
    require(!goalReached());
    uint256 _contrib = contributions[msg.sender];
    uint256 _refundTokens = _getTokenAmount(_contrib);
    token.transferFrom(msg.sender, wallet, _refundTokens);
