...
contract TAURUSDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("TAURUS_Dividend_Tracker", "TAURUS_Dividend_Tracker") {
        claimWait = 3600;
...
contract TAURUS is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
...
/////---BUYBACK----////    
    ...
    constructor() ERC20("TAURUS", "TAU") {
        BNBRewardsFee = 3;
        liquidityFee = 5;
        extraFeeOnSell = 1; // extra fee on sell
        marketingFee = 1;
        buybackFee = 1;
        marketingWallet = payable(0xf24ec8c162F94314903DeBC2e19c34B7022877dF);
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TAURUS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
