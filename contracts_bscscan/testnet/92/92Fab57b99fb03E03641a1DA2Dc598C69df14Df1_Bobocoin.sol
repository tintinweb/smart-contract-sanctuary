...
/**
   ...
   Bobocoin is a memecoin with Charity Purpose to Rescue Abondoned Cats & Dogs
   ...
   A dedicated charity wallet account will be use to collect all the fund that collected in every buy and sale transactions.
   Meow....    
 */
...
contract Bobocoin is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = payable(0x1bcFedD9bFE7c163e2A0b1AE909639BF8aaA4d73); // Marketing Address
