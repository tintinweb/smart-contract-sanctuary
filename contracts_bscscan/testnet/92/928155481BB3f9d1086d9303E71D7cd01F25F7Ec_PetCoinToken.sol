...
contract PetCoinToken is BEP20 {
    ...
    function swapAndLiquifyHadleFee() private lockTheSwap transferTaxFree{
        ...
        uint256 charityTokens = contractTokenBalance.mul(charityFee).div(transferTaxRate);
        swapAndSendFee(charityTokens, CharityWalletAddress);

        uint256 treasuryTokens = contractTokenBalance.mul(treasuryFee).div(transferTaxRate);
