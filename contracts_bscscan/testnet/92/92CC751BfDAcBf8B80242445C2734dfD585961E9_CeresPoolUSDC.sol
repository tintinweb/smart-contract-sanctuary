...
abstract contract CeresPool is AccessControl {
    ...
    uint256 public mintRevenueRecent;  // mint revenue percent last time

    uint256 public redeemRevenueRecent;  // redeem revenue percent last time
...
contract CeresPoolUSDC is CeresPool {
    ...
    function determine() external onlyGovernance override{
        ...
        if (ascPrice > PRICE_TARGET + ceresAnchor.priceBand()) {
            ...
            mintRevenueRecent = ascPrice - PRICE_TARGET;
            ...
            redeemRevenueRecent = PRICE_TARGET - ascPrice;
        }
