...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router, address _ETHEREUM) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        WBNB = router.WETH();
        ETHEREUM = IERC20(_ETHEREUM);
        _token = msg.sender;
    }
...
contract EthEarn is IERC20, Ownable {
    ...
    constructor () {
        ...
        // address ETHEREUM = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
        
        address routerAddress = address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        address _ETHEREUM = address(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);
