...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract AVAXPrinter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable token = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD
    ...
    constructor() ERC20("AVAXPrinter", "VAPER") {
        uint256 _rewardsFee = 10;
        uint256 _operationsFee = 3;
        uint256 _liquidityFee = 2;
        uint256 _buybackFee = 0;
        
        uint256 totalSupply = 10000 * 1e12 * 1e10; // 1 Billion total supply
        
        maxSell = totalSupply * 5 / 1000; // 0.5% maxSellTxn
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = totalSupply * 1 / 100; // 1.5% maxWallet

        rewardsFee = _rewardsFee;
        operationsFee = _operationsFee;
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        totalFees = rewardsFee + operationsFee + liquidityFee + buybackFee;
        
    	dividendTracker = new DividendTracker();
    	
    	operationsWallet = address(0xA381a78079f8Bd33B3244A3Ce2c05b97afF2d9cf);
    	buybackWallet = address(0xA381a78079f8Bd33B3244A3Ce2c05b97afF2d9cf);
        devWallet1 = address(0xA381a78079f8Bd33B3244A3Ce2c05b97afF2d9cf);
		devWallet2 = address(0xA381a78079f8Bd33B3244A3Ce2c05b97afF2d9cf);
    	
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    	
    	//0xD99D1c33F9fC3444f8101754aBC46c52416550D1 testnet
    	//0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 mainnet
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 buybackAmt = address(this).balance.mul(rewardsFee).div(totalFees - liquidityFee - rewardsFee);
        (success,) = address(buybackWallet).call{value: buybackAmt/2}("");
        
        
        uint256 devAmt = address(this).balance / 5;
        (success,) = address(devWallet1).call{value: devAmt/2}("");
        (success,) = address(devWallet2).call{value: devAmt/2}("");
