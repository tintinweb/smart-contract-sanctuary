...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0x55d398326f99059fF775485246999027B3197955);//Binance-Peg BSC-USD (BSC-USD)
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            // : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//PancakeTestRouter
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//PancakeRouter
        _token = msg.sender;
    }
...
contract Token is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//pancakeswap
