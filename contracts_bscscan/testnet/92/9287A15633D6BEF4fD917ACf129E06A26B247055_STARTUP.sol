...
contract STARTUP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "STARTUP";
    string constant _symbol = "START";
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator, uint256 _totalSellFee) external onlyOwner {
