...
contract NFTGiveaway is Ownable {
    ...
    function whitelistNFT(address nftContract) external onlyOwner {
        ...
        require(nftContract.isContract(), "Provided address is not a contract address");
    ...
    function distributeNFTs(
        ...
        require(isNFTWhiteListed[nftContract], "Cannot distribute: not a whitelisted NFT");
        require(receivers.length == tokenIds.length, "Cannot distribute: unequal params");
        for (uint256 i = 0; i < receivers.length; i++) {
            IERC721(nftContract).safeTransferFrom(from, receivers[i], tokenIds[i]);
     ...
     */
    function getDistributedNFTs(address nftContract) external view returns (uint256[] memory _distributedNFTs) {
