...
//FlokiTokyo Hold we will Tothemoon
...
contract FlokiTokyo is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiTokyo";
    string private _symbol = "Ftokyo";
    ...
    uint256 public _liquidFee = 8;
    uint256 private _previousLiquidFee = _liquidFee;
    
    uint256 public maxBuyTranscationAmount = 25000000 * 10**6 * 10**9;
    uint256 public maxSellTransactionAmount = 1000000000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 25000000 * 10**6 * 10**9;
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private liquidAddress = 0x4936F1014EC95317fd5B7e81A21692B988936733;
