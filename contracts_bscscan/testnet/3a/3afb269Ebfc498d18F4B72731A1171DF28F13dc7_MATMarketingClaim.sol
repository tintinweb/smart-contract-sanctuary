...
contract MATMarketingClaim is Ownable, ReentrancyGuard {
    ...
    constructor(IBEP20 _mat, address _marketingAddress) {
        MAT = IBEP20(_mat);
    ...
    function setTgeTime(uint256 _tge) public onlyOwner {
        ...
        //transfer 15% for marketingAddress;
        uint256 matUnlockAtTge = (lock * 15) / 100;
        lock -= matUnlockAtTge;
        MAT.transfer(marketingAddress, matUnlockAtTge);
    }

    function updateAddress(address _marketingAddress) public onlyOwner {
    ...
    function claim() external nonReentrant {
        ...
        require(_msgSender() == marketingAddress, "Address invalid");
