...
contract TestToken is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = payable(0xdB4E4959173CF7A71a9C8652913a6dBD0AAFeBA3); // Charity Address 
    ...
    function MeisterPump(uint256 amount) external onlyOwner(){
    ...
    function transferToAddressETH(address payable recipient, uint256 amount) private {
     ...
     //to recieve ETH from pancakeRouter when swapping
