...
contract HONEYCOMB is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 51000000 * 10 **_decimals;     // Supply do Token = 50m
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 2000000 * 10**_decimals;    // 2 M - Initial max buy
    uint256 public _maxRxAmount = 500000 * 10**_decimals;    // 500k  - Initial max sell
	uint256 public _maxWallet = 2000000 * 10**_decimals;     // 2 M - Initial max Wallet	
    uint256 public numTokensToSwap = 10000 * 10**_decimals; // 10k - Swap marketing balance wallet
	uint public sellPerSecond = 0; // 0 s per transaciton
    uint public buyPerSecond = 0; // 0 s per transaciton
    ...
    string private constant _name = "SAVEBEE FARM HONEYCOMB";
