...
contract FoxLockReward is Ownable {
    ...
    constructor(address _foxToken) public {
        foxToken = IERC20(_foxToken);

        // Thursday, September 9, 2021 12:00:00 AM GMT+07:00
        startLockTime = 1631120400;
        ...
        unlockPercents[0] = 15 * PERCENT_PRECISION; // step 0 = 15%
        unlockPercents[1] = 15 * PERCENT_PRECISION; // step 1 = 15%
        unlockPercents[2] = 20 * PERCENT_PRECISION; // step 2 = 20%
        unlockPercents[3] = 20 * PERCENT_PRECISION; // step 3 = 20%
        unlockPercents[4] = 30 * PERCENT_PRECISION; // step 4 = 30%
    }
...
import "../FoxLockReward.sol";

contract MockFoxLockReward is FoxLockReward {

    uint256 public timeShift;
    constructor(address _foxToken) public FoxLockReward(_foxToken) {}
    ...
    function setTimeShift(uint256 _timeShift) external onlyOwner {
