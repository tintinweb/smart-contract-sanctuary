...
contract test is IBEP20, Auth {
    ...
    address _marketingAddress = 0x4E6B3993952fc2dC2A3F83ae80e94f82eF83ACa2;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!isFeeExempt[sender] && !isFeeExempt[recipient] && recipient != address(this) && recipient != address(DEAD) && recipient != address(ZERO) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
