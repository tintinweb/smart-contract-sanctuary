...
contract TestToken is ERC20, Ownable {
    ...
    bool public adaDividendEnabled = false;
    ...
    constructor() ERC20("TestToken", "TT") {
        ...
        marketingWallet = 0xbE72B654d021522A69D0951CE684fCAcCfC42A8F;
        divident = 0x2712100F7AF1A8189E65af385986E5C41AcCDd09;
    ...
    function setBuyBackAndLiquifyEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            ...
            totalFees = buyBackAndLiquidityFee.add(marketingFee).add(adaDividendRewardsFee).add(cakeDividendRewardsFee);
            buyBackAndLiquifyEnabled = _enabled;
        }
    ...
    function setCakeDividendEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            ...
            totalFees = cakeDividendRewardsFee.add(marketingFee).add(adaDividendRewardsFee).add(buyBackAndLiquidityFee);
            cakeDividendEnabled = _enabled;
        }
    ...
    function setAdaDividendEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            ...
            totalFees = adaDividendRewardsFee.add(marketingFee).add(cakeDividendRewardsFee).add(buyBackAndLiquidityFee);
            adaDividendEnabled = _enabled;
        }
    ...
    function setMarketingEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            ...
            totalFees = marketingFee.add(adaDividendRewardsFee).add(cakeDividendRewardsFee).add(buyBackAndLiquidityFee);
            marketingEnabled = _enabled;
        }
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newCakeDividendTracker.owner() == address(this), "must be owned by TestToken");
    ...
    function updateAdaDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newAdaDividendTracker.owner() == address(this), "must be owned by TestToken");
    ...
    function updateAdaDividendRewardFee(uint8 newFee) external onlyOwner {
        ...
        totalFees = adaDividendRewardsFee.add(cakeDividendRewardsFee).add(marketingFee).add(buyBackAndLiquidityFee);
    }

    function updateMarketingFee(uint8 newFee) external onlyOwner {
        marketingFee = newFee;
        totalFees = marketingFee.add(cakeDividendRewardsFee).add(adaDividendRewardsFee).add(buyBackAndLiquidityFee);
    }

    function updateBuyBackAndLiquidityFee(uint8 newFee) external onlyOwner {
        buyBackAndLiquidityFee = newFee;
        totalFees = buyBackAndLiquidityFee.add(cakeDividendRewardsFee).add(adaDividendRewardsFee).add(marketingFee);
    }
