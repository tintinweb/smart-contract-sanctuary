...
/**
 * @dev The official BLMToken smart contract
 */
contract BLMToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "BLM2";
    string private _symbol   = "BLMToken2";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for BLMToken/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x0583AD448c6D456Ba50c2AC08595B24FbDB4D2c9); // Marketing address used to pay for marketing
    ...
    uint256 public  _sellTaxFee       = 20; // 20% tax 
    uint256 public  _whaleSellTaxFee  = 30; // 30% tax 
    ...
    // Timer Constants 
    uint private constant DAY = 259200; // How many seconds in a day
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $BLMToken will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-BLMToken tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts BLMToken balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns BLMToken tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of BLMToken tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from BLMToken)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of BLMToken
            path,
