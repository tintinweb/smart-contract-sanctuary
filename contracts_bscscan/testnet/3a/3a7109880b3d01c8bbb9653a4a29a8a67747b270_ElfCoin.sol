...
contract ElfCoin is ERC20, Ownable, IElfCoin {
    ...
    constructor(address router, address wbnb, address busd) ERC20("Elf Coin", "ELFIE") {
    ...
    function _shouldTakeFees(address from, address to) internal view returns (bool) {
        return (from == uniswapV2Pair || to == uniswapV2Pair) && !(isExcludedFromFees(from) || isExcludedFromFees(to));
    }
