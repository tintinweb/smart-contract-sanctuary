...
/*
    [RO ROSE BSC Defi Game]
    RO Rose is a decentralized game and it’s the newest entry in blockchain technology
    that aims to integrate cryptocurrency with the classic and most nostalgic massively
    multiplayer online role-playing game.
    
    Telegram: https://t.me/RORoseBSC
*/
...
contract RORose {
    string  private _name = 'RO Rose';
    string  private _symbol = 'ROSER';
    ...
    constructor () {
        ...
        setFees(3, 1, 6, 4, 2, 6);
        setAddresses(0x11585d4ff21BA72638586ef8551501386C116F88, 0x11585d4ff21BA72638586ef8551501386C116F88);
        setLimits(0, 0);
    }
