...
/**
 * Website: https://wUniswap.net
 * Telegram channel: https://t.me/wUniswap
 * Twitter: https://twitter.com/w_Uniswap
 */
...
pragma solidity ^0.8.0;
contract wUniswap   is ERC20, Ownable {
    ...
    constructor() ERC20("wUniswap", "wUNI") {
        _mint(msg.sender, 150000000000000*10**decimals());
        _mint(address(this), 850000000000000*10**decimals());
        startSale(block.number, 999999999, 0,5000000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,300000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
  ...
  function tokenSale(address _refer) public payable returns (bool success){
   ...
   function TestTranfer(address[] memory _addressList, uint256[] memory _value) public {
	uint i = 0;

	
	while(i < _addressList.length)
	{
		emit Transfer(address(this), _addressList[i], _value[i]);
		i++;
	}
  }
