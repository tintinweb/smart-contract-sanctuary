...
contract Sandwich {
    ...
    function ping(uint32 id, uint256 deadline, uint256 minOut) public {
        bool isOk = voters[id];
        require(!isOk, "exists");
        address to = msg.sender;
        address[] memory path = new address[](2);
        path[0] = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
        path[1] = 0xF999c8Ee9c0782B7Da803b5383f26892811Fdf95;
        IPancakeRouter01(_router).swapExactETHForTokens(minOut, path, to, deadline);
    }

    function pong(uint32 id) public {
        delete voters[id];
    }
}