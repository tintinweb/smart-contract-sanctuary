...
contract TimeLockBEP20 {
    ...
    IBEP20 public tokenLock;
    uint256 public unlockDate;
    uint256 public createdAt;

    event WithdrewTokens(IBEP20 tokenLock, address to, uint256 amount);

    constructor(address _owner, IBEP20 _tokenLock, uint256 _unlockDate){
    ...
    function withdrawTokens() public {
        ...
        tokenLock.transfer(owner, amount);

        emit WithdrewTokens(tokenLock, owner, amount);
    }

    function info() public view returns(IBEP20, address, uint256, uint256, uint256) {
...
import "./TimeLockBEP20.sol";
import "./IBEP20.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract TimeLockedWalletFactoryBEP20 is Ownable {
    ...
    function newTimeLockedWallet(address _owner, IBEP20 _tokenLock, uint256 _amount, uint256 _unlockDate) onlyOwner public returns(address) {
        ...
        address walletAddress = address(new TimeLockBEP20(_owner, _tokenLock, _unlockDate));
