...
contract MultiPad is IERC20 {
    ...
    uint256 private decimalBalancer = 1000000000*(10**uint256(_decimals));
    ...
    uint256 private IDOAmount = 20000000*(10**uint256(_decimals));
    ...
    address private Liquidity = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    constructor (string memory name, string memory symbol, uint256 totalSupply, address owner) public {
        ...
        _balances[Reserve] = ReserveAmount;
        _balances[Marketing] = MarketingAmount;
        _balances[Team1] = Team1Amount;
        _balances[Team2] = Team2Amount;
        _balances[Liquidity] = LiquidityAmount;
        _balances[IDO] = IDOAmount;
        _balances[Partners] = PartnersAmount;
