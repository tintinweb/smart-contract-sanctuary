...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = "MoviBit";
    _decimals = 9 ;
    _totalSupply = 98000000000000000;

    _balances[msg.sender] = 98000000000000000;  /* distruibuicao inicial 100%*/
...
/* OWNER */
  function initialSetup (address payable dist1, address payable dist2) public onlyOwner() {
    ...
    require ( _alreadySetuped == false, "Executed only once");
     ...
     //10% BRUN 
     _transfer (_owner, _walletBURN,  9800000000000000);
  ...
  require(recipient != address(0), "BEP20: transfer to the zero address");
      ...
      if (_itsWhale[sender] == false) {
        require(amount <= 15000000000000, "Maximum transfer 15k MoviBit");
      }



      /* minimun to calc 100 wei*/
      require(_balances[sender] >= 100, "Minimu tranfer wei to tax fee 100 MoviBit");
