...
// dev functions     
    ...
    */
    ...
    function buyCurrentSale(uint256 _purchaseAmount) external payable onlyInvestors() saleActive() {
        ...
        uint256 claimTokenDecimalCount = investorPurchased[tokenForSale][sender].tokenSaleDecimalCount;
        uint256 _amountPurchasedWithDecimals = _amountPurchased * (10** claimTokenDecimalCount);
