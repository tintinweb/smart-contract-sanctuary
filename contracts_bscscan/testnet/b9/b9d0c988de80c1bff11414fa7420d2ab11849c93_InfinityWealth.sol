...
contract InfinityWealth is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_BuyBack = payable(0x981Ab956D6575b40F49AcBb769342BE91db95828); //4
    address payable public Wallet_Dev = payable(0x2240a100BCb9b846C0F2e0cb1A1E4bf38a3cc46C); //5
    ...
    uint256 private _promoFee_BUY = _FeeMarketing_BUY+_FeeDev+_FeeBuyBack_BUY;
    uint256 private _promoFee_SELL = _FeeMarketing_SELL+_FeeDev+_FeeBuyBack_SELL;
    ...
    uint256 private _liquidityAndPromoFee_BUY = _FeeMarketing_BUY+_FeeDev+_FeeBuyBack_BUY+_FeeLiquidity;
    uint256 private _liquidityAndPromoFee_SELL = _FeeMarketing_SELL+_FeeDev+_FeeBuyBack_SELL+_FeeLiquidity;


    uint256 private _FeeMarketing;
    uint256 private _FeeBuyBack ;
    uint256 private _promoFee;
    uint256 private _liquidityAndPromoFee;
    ...
    */
    ...
    function _set_Fees(uint256 Liquidity, uint256 Reflection, uint256 Marketing_BUY, uint256 Marketing_SELL, uint256 BuyBack_BUY, uint256 BuyBack_SELL) external onlyOwner() {
        ...
        // For calculations and processing 
          ...
          _promoFee_BUY = _FeeMarketing_BUY+_FeeDev+_FeeBuyBack_BUY;
          _promoFee_SELL = _FeeMarketing_SELL+_FeeDev+_FeeBuyBack_SELL;
          _liquidityAndPromoFee_BUY = _FeeLiquidity+_promoFee_BUY;
          _liquidityAndPromoFee_SELL = _FeeLiquidity+_promoFee_SELL;
            ...
            removeAllFee();
                ...
                txCount++;
                    ...
                    if (sender == uniswapV2Pair){
                        ...
                        _promoFee = _promoFee_BUY;
                        _liquidityAndPromoFee = _liquidityAndPromoFee_BUY;
                        ...
                        _promoFee = _promoFee_SELL;
                        _liquidityAndPromoFee = _liquidityAndPromoFee_SELL;
