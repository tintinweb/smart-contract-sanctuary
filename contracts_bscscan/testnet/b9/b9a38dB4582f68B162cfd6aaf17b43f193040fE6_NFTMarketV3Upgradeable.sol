...
* 主合约
*/
contract NFTMarketV3Upgradeable is ERC721Holder, OwnableUpgradeable, PausableUpgradeable {
    using SafeMath for uint256;
...
//    }
    ...
    function initialize() initializer public {
        ...
        __Pausable_init();
        // 状态变量初始化
        __NFTMarket_init_unchained();
    }

    function __NFTMarket_init_unchained() internal initializer {
        feeAddr = payable(_msgSender());
        feePercent = 10;

        updateSupportNFT(address(0), true);
        updateSupportCoin(address(0), true);
