...
//_buybackWallet - 0xa2C9dFfCfA04969Dbab050a310E7B0F99122C8d0


/*
> I want the reflection to be every hour
> I want 7% to be redistributed in Uniswap coins to all holders
> I want 5% to be redistributed in BUSD to the dev/buyback wallet  (0x2893f4464efC212405d5c8b798a1AFFA069b20Ae) 
> 3% per transaction to the LP
> Total supply: 1000T = 1 Quadrillion (1.000.000.000.000.000)

Pending
> Sells to be limited to 0.1% of the total supply and I want there to be a 2% extra tax on 
> Is it also possible to have a max. buy amount at the beginning and and make the max. amount more and more over time

The token will be named “Baby Unicorn”
BABYUNICORN
*/
...
/*
* TODO
*  add maxSellTransactionAmount and make it configurable"
*  Selling tax - 2%
*  make buybackwallet address configurable
*  check for transfer logic
*  Check if cake contract exists somewhere
*  add dev wallet addresses
*  check the addresses! Make sure cake is not there anywhere!
*  change busd/uni to private (opt)
*  Test updateBuybackAddress
*  Test updateMaxSellTransactionAmount
*  Test updateLiquidityWallet
*  Test maxSellTrx amount
*/

//DRST:::::::::: minimumTokenBalanceForDividends - 10*4, swapTokensAtAmount - 2 ** 10*5 - maxsupply 10**9
//TIKI:::::::::: minimumTokenBalanceForDividends - 10*4, swapTokensAtAmount - 2 ** 10*5 - maxsupply 10**9
//BABYCAKE:::::: minimumTokenBalanceForDividends - 2 ** 10*5, swapTokensAtAmount - 2 ** 10*6 - maxsupply 10 ** 11

//BABYCAKE:::::: minimumTokenBalanceForDividends - 2 ** 10*9, swapTokensAtAmount - 2 ** 10*10 - maxsupply 10 ** 15
...
contract BABYUNICORN is ERC20, Ownable {
    ...
    address public _buybackWalletAddress = 0xa2C9dFfCfA04969Dbab050a310E7B0F99122C8d0;
    ...
    event UpdateMaxSellTransactionAmount(uint newValue, uint oldMaxSellTransactionAmount);
    ...
    constructor() public ERC20("BBUUU", "BBUUU") {
...
contract BABYUNICORNDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("BBUUU_DIVIDEND_TRACKER", "BBUUU_DIVIDEND_TRACKER") {
    	claimWait = 3600;
