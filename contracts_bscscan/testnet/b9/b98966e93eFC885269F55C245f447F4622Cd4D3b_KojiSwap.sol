...
interface IBEP20 {
    ...
    function safeTransferFrom(IBEP20 token, address from, address to, uint256 value) external;
...
contract KojiSwap is Ownable, ReentrancyGuard {
    ...
    function swapTokens() external nonReentrant {
        ...
        //get v1 tokens
        tokencontractv1Interface.safeTransferFrom(tokencontractv1Interface, address(_msgSender()), address(this), tokencontractv1Interface.balanceOf(_msgSender()));
