...
contract Leveling is ILeveling, StarlinkComponent, ShopItemFulfilment {
    ...
    uint256 constant public STARLINK_POINTS_LIMIT = 1000000000000 * 10**10; 
    ...
    function xpRateOf(address userAddress) external view returns (uint256) {
        return xpRateOf(userInfo[userAddress]);
    }
    ...
    function calculateBaseXpRate(uint256 starlinkPoints) public pure returns (uint256) {
        ...
        uint256 lowSweetSpotThreshold = 200000000 * 10**10 * STARLINK_POINTS_PRECISION;
        ...
        uint256 midSweetSpotThreshold = 1000000000 * 10**10 * STARLINK_POINTS_PRECISION;
        ...
        uint256 highSweetSpotThreshold = 10000000000 * 10**10 * STARLINK_POINTS_PRECISION;
        ...
        uint256 whaleSweetSpotThreshold = 30000000000 * 10**10 * STARLINK_POINTS_PRECISION;
    ...
    function fulfill(uint256 id, address from, uint256, uint256) external override onlyShop notPaused {
        ...
        (uint256 typeId, uint256 val1, uint256 val2) = shop.itemInfo(id);
    ...
    function doLevelUp(address userAddress) private {
        ...
        if (address(levelingRewards) != address(0)) {
