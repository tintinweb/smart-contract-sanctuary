...
contract SmartWorld {
    ...
    function adjustment(address payable userAddress , uint256 _referrerID, uint side) public onlyDeployer {
        ...
        emit Registration(userAddress, lastIDCount, originalReferrer, side, 1);
    }
