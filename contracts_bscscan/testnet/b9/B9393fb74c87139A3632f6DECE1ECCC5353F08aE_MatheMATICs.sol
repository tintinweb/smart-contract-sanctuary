...
/**                                                                                                                
*                                ,,                                                                               
* `7MMM.     ,MMF'         mm   `7MM               `7MMM.     ,MMF'      db   MMP""MM""YMM `7MMF' .g8"""bgd        
*   MMMb    dPMM           MM     MM                 MMMb    dPMM       ;MM:  P'   MM   `7   MM .dP'     `M        
*   M YM   ,M MM   ,6"Yb.mmMMmm   MMpMMMb.  .gP"Ya   M YM   ,M MM      ,V^MM.      MM        MM dM'       `,pP"Ybd 
*   M  Mb  M' MM  8)   MM  MM     MM    MM ,M'   Yb  M  Mb  M' MM     ,M  `MM      MM        MM MM         8I   `" 
*   M  YM.P'  MM   ,pm9MM  MM     MM    MM 8M""""""  M  YM.P'  MM     AbmmmqMA     MM        MM MM.        `YMMMa. 
*   M  `YM'   MM  8M   MM  MM     MM    MM YM.    ,  M  `YM'   MM    A'     VML    MM        MM `Mb.     ,'L.   I8 
* .JML. `'  .JMML.`Moo9^Yo.`Mbmo.JMML  JMML.`Mbmmd'.JML. `'  .JMML..AMA.   .AMMA..JMML.    .JMML. `"bmmmd' M9mmmP' 
*                                                                                                                 
*/
...
/* Token contract */
contract MatheMATICs is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "MatheMATICs";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 3000 / 10000; // 0.5%
    uint256 public _maxSellTxAmount = _totalSupply * 3000 / 10000; // 0.5%
    uint256 public _maxWalletToken = ( _totalSupply * 3000 ) / 10000; // 3%
