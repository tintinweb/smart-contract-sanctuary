 ...
 * COIN
 */
contract TinyBlocks is Context, IERC20, Ownable, ReentrancyGuard {
    // Libraries
    ...
    // Token
    string private _name = "TinyBlocks";
    string private _symbol = "Tblocks";
    ...
    // Max TX in tokens
    uint256 public _maxSellTxAmount = 100 * 10**18;
    uint256 public _maxBuyTxAmount = 200 * 10**18;
