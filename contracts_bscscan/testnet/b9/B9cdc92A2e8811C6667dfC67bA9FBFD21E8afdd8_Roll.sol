...
contract Roll {
    ...
    constructor(bool _bettingEnabled, string memory _nonce, uint _rollUnderLowerLimit, uint _rollUnderUpperLimit, uint _taxFree, uint _minimumBet, uint _maximumBet, uint _totalRolls, uint _totalBet, uint _totalWon) {
        manager = msg.sender;
        nonce = _nonce;
