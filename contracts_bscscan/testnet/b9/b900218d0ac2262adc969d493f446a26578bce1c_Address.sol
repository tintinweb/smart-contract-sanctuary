...
knpay - The future of merchant cryptocurrency payments

Pay expenses & earn $KNPAY rewards with your crypto
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x9c5eA80F8035dDfc0C0f1d085aAb00F485B4d585); // Marketing Address
    address payable public devAddress = payable(0xAe8eFb84213A53cff2fDF2Be59A4Ad7c986E3671); // Dev Address
...
contract knpay is ERC1363, TokenRecover {
    constructor ()
        ERC1363("knpay", "KNPAY")
    {
    }
