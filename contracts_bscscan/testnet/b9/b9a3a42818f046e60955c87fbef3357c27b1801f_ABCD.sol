...
contract ABCD is Context, IERC20, Ownable {
    ...
    //// ERC-20 init
    string private constant _name = "le3y";
    string private constant _symbol = "le30";  //TODO
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 2 * 10**5 * 10**9;  //TODO
    address private constant _devAddress = 0x2e034F16eC6249C181f3388697d20feefd03833B;  //TODO
    ...
    uint256 public _maxTxAmount = 10**2 * 10**9;
    ...
    function setReferrer(address account) public {
        ...
        require(account != _msgSender(), "Rferrer can't be same as referree.");
    ...
    function removeLiquidity(uint256 liquidity) external onlyOwner {
        ...
        (amountToken, amountBNB) = uniswapV2Router.removeLiquidityETH(
            ...
            0, 
            0, 
            payable(_devAddress),  //TODO: can be another contract has it's own lock machenism 
            block.timestamp + 360
        );
        // update unlocked liquidity
