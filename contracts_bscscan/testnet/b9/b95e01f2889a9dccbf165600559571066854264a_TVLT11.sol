...
contract TVLT11 is Context, IBEP20, Ownable {
    ...
    string private _name = "TestVault11";
    string private _symbol = "TVLT11";
    ...
    address public _marketingWalletAddress = 0xdeFF216a3dA9fBC3DE51b21E8a7061cb2c66B163;
    address public _VaultAddress = 0xa3fAf8EF5E032E6E80413A31029F16434a0fB54a;
    ...
    public {
        ...
        _isForeverExcludedFromReward[_VaultAddress] = true;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 tokens) private onlyOwner {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            uint256 toVault = calculateVaultFee(amount);
