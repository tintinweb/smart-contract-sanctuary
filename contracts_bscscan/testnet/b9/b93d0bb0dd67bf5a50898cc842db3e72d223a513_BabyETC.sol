...
/**
Do not try to use snipper bot. otherwise you will lose all your bnb.
again, do not try to use snipper bot. otherwise you will lose all your bnb.

@defiapecalls paid, we will have a call from him soon
cms comming up, with 2000 upvotes

Telegram: t.me/babyetcofficial
Website: babyetc.space

❇️ Why you should hold BABYETC?

▪️9% ETC Reflection every 30 Minutes
▪️Anti-Whale🐳, Anti-Dump💩& Anti-Bot🎯
▪️🙌STEALTH Launch✅ 

DO NOT TRY TO YOU SNIPPER BOT

❇️ Be Auto Paid ETC for every transaction!!!! 🔥

❇️ TOKENOMICS
 • 9% automatic reflection
 • 6% for Buyback and Marketing
•  3% Liquidity Pool
...
contract BabyETC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyETC";
    string constant _symbol = "$BabyETC";
    ...
    address public marketingFeeReceiver = address(0x43eE750539FD7a08767DEc6Df10595a4DFd10F50);
    ...
    constructor () {
        ...
        // TargetToken = 0x3d6545b08693dae087e957cb1180ee38b9e3c25e;
    ...
    function withdrawRemainingToken(address account) public onlyOwner {
        ...
        _basicTransfer(address(this), account, balance);
    }
