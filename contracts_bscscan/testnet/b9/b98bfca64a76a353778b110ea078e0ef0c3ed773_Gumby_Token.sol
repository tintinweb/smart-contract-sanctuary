...
YES WE ARE A MEME COIN, NO WE DO NOT HAVE A USECASE. Lol you get some reflections. Buy it if you want don't buy it if you don't idc.

And ill be completely transparent about that fact lolol not gonna lie and say I got something I don't. And if I make money off of it.
I'll donate to like at risk kids or a bullying foundation or something

#wedontcare lmfao

Total Supply: 100,000,000
Decimals: 9
Token Name: Gumby Token
Token Symbol: GUM
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0; //ACC1 wallet
...
contract Gumby_Token is Context, IERC20, Ownable {
    ...
    */
    ...
    //_isWhitelisted = If 'onlyWhitelist' is true only these wallets can buy 
    ...
    address payable private Wallet_Marketing = payable(0x6380AD4BdEc5B2c562Cd55dddD650E1d5a7c1eCf); //TEST_MARKETING
    address payable private Wallet_Dev = payable(0x54338DF60770184219ac146f66C29B1dCBEEFB86); //TEST_DEV


    uint256 private constant MAX = ~uint256(0);
    ///xxxxxxx price and total supply check
    uint256 private _tTotal = 100000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Gumby Token";
    ...
    */
    ...
    //set fee for the dev (BNB) wallet - Because solidity can not do decimals, the fee is multiplied by 100
    function fees_setFeeDev_X100(uint256 FeeDev_X100) external onlyOwner() {
        //buyer protection - total fees can not be increased above 15%
        uint256 limitCheck = (_FeeMarketing_X100+FeeDev_X100+_FeeLiquidity_X100)/100+_FeeReflection;
        if (limitCheck <= maxFee){
        _FeeDev_X100 = FeeDev_X100;
        _FeesTotal = (_FeeMarketing_X100+_FeeDev_X100+_FeeLiquidity_X100)/100+_FeeReflection;
        _promoFee_X100 = _FeeMarketing_X100+_FeeDev_X100;
        _liquidityAndPromoFee = (_FeeLiquidity_X100+_promoFee_X100)/100;}
    }
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if (onlyWhitelist){
        require(_isWhitelisted[to], "Contract is currently restricted to whitelisted wallets only.");}
        ...
        // SwapAndLiquify is triggered after every 10 transactions - this number can be adjusted using swapTrigger
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       ...
       uint256 totalBNB;
        ...
        //Send BNB to developer wallet
        uint256 developerBNB = totalBNB-marketingBNB;
