...
contract MakaSwap is Ownable, ReentrancyGuard {
  ...
  //Router TESTNET: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 Testnet 360 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
  ...
  function buyToken() public payable returns(bool){
    ...
    if (_whitelistedAddresses[msg.sender]) {
      ...
      uint256 tokensReservedForMarketing = feeAmount - tokensReservedForReward - tokensReservedForContract;
        _pancakeswapV2Router.swapExactETHForTokens{value: bnbToSend}(0, path, msg.sender, block.timestamp);
        _pancakeswapV2Router.swapExactETHForTokens{value: tokensReservedForContract}(0, path, TOKEN, block.timestamp);
