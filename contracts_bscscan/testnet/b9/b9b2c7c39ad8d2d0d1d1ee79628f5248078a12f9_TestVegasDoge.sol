...
contract TestVegasDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TestVegasDoge";
    ...
    // SETMEUP
    address _presaler = 0x689d0caC2cd1A4dAE1242f658C50798a1fdc090D;

    // SETMEUP for DXSALE
    //address _presaleContract = 0xB939304eb2b93C9c95150f816a7c9D0958f0fb5A;
    ...
    // tesnet router 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    // mainnet router 0x10ED43C718714eb63d5aA57B78B54704E256024E
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = payable(0x689d0caC2cd1A4dAE1242f658C50798a1fdc090D);
