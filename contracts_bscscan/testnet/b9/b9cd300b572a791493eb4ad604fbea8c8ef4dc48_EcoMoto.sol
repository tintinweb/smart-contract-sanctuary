...
/**
 *CHUPA MEU PINTO SE VAGABUNDO Scan.com on 2021-10-17
*/
...
contract EcoMoto is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TesTe Viking";
    string constant _symbol = "VKNG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 1; // 100000 1%
    uint256 public _maxWalletToken = _totalSupply / 1; // 25000000000 2.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6a72d632561B027ddFFD42F676b8F762E477abC4;
