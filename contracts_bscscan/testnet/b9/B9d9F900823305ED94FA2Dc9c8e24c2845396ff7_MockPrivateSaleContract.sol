    ...
    FlexibleTimedCrowdsale
{
    ...
    uint256 public constant VESTING_TOTAL_DURATION = 1055 days; // Total vesting for 3 years
    uint256 public constant VESTING_DURATION =
        VESTING_TOTAL_DURATION - VESTING_CLIFF; // Vesting duration after cliff (2 years)
     ...
     */
    function buyPackageWithStable(string calldata name, uint256 package) external onlyWhileOpen onlyWhitelisted {        
