...
Join the movement, baby! 
    -> t.me/babybnbofficial



Welcome to BabyBNB! 

I am Dr. 匿名 - the leading developer for the BabyBNB contract. 
Please note that the contract is currently edited to support the initial startup phase of the BabyBNB 
movement and contains elements that will be changed in the coming days and weeks. 
No changes will ever be made without previous introduction and explanation in the telegram group.

Let me introduce you to the innovative features of the contract that will let this movement succeed.



The basic principle
* BabyBNB ($BBNB) is designed to reward hodlers with $WBNB dividends
* All features are created to find balance between flexibility and security 


Tax and LP 
* 10% Liquidity fee on transactions
* 5% Staking fee on transactions (Split 80/20)


Anti whale protection
* 1000000000 coins max. wallet size
* 50000000 coins max. sell limit


Liquidity Lock
* 365 days initial liquidity lock 


HFTA Avoidance
* Sales are allowed once per second to decrease HFTA (High-Frequency-Trading-Activity)
* Theoretical sale density of 50000000 coins/second/account 


BNB Autostake 
* 10% BNB reflection
* Uses the balances of each hodler to redistribute auto generated BNB 
* Withdraw BNB anytime without timelocks


Startup Phase
* Implementation of special rules for startup phase to guarantee marketing funding  
* 80% of the 5% staking fee will be used for marketing in the launch phase - capped after successful launch phase
* 20% of the 5% staking fee will be locked in the contract
* 3% of all burned tokens are distributed to contract for LP 


If you have any questions about the technicals of the contract, please tag me in your question in the telegram group (t.me/babybnbofficial).
I will not respond to DMs to ensure complete transparency.
...
contract BABYBNB is IBEP20, Ownable
{
    ...
    uint256 public constant MaxSellLockTime=1 seconds; // decreased to 1 second to not lock funds too long(community decision)
    //The time Liquidity gets locked at start and prolonged once it gets released
    uint256 private constant DefaultLiquidityLockTime=365 days; //locked liquidity for 1 year
    
    
    //The Manual Liquidity Wallet is a Multisig wallet that reqires 3 signatures for each action
    address public constant marketingWallet=0xfaD7e634b3C26C6A7734d923601CB4982B3A020C; 
    ...
    constructor () {
        ...
        //100% of the token for LP-Pair creation
        uint256 deployerBalance=_circulatingSupply*100/100;
       ...
       //Sets sellLockTime to be max by default
        ...
        //Set Starting Tax to very high percentage(5%) to achieve maximum burn in the beginning
        ...
        //97% gets burned
        //a small percentage gets added to the Contract to be converted to LP and Marketing
        _burnTax=97;
        ...
        _excludedFromStaking.add(0x0000000000000000000000000000000000000000); 
     }
    ...
    uint8 public marketingShare=80; // 80% of the 3% staking fee used for marketing wallet 
    ...
    function claimBNB(address addr) private{
        ...
        path[1] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  //Wrapped BNB ($WBNB) contract
