...
// File contracts/DFY-AccessControl.sol
...
contract DFYAccessControl is AccessControlUpgradeable {
    ...
    *
    * NOTE: The main contract must inherit `Pausable` or this ROLE doesn't make any sense
    */ 
...
// File contracts/EvaluationUpgradable.sol
...
contract AbcUpgradable is Initializable, PausableUpgradeable, DFYAccessControl {
