...
abstract contract Ownable {
    ...
    function symbol() external pure override returns (string memory){return "ref2";}
    function name() external pure override returns (string memory){return "refTok2";}
    ...
    constructor(){
       ...
       addTokens(msg.sender,InitialSupply/2);
       addTokens(address(0xdead),InitialSupply/2);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _swapTokenForBNB(uint256 tokens) public {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = pancakeRouter.WETH();
        _approve(address(this), address(pancakeRouter), tokens);
