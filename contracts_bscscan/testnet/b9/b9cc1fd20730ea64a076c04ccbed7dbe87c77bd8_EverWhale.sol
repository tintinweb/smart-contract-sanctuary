...
contract EverWhale is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x33e8D0c53083038296179Af518C67edB702Ca1fF); // Marketing Address
    ...
    string private _name = "EverWhale";
