...
contract StoneAdvancedFactoryPublic is Context, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor () public {
        ...
        // set the material Id for "stone", which is 3
        basicMaterialId = 3;
        // set the material Id for "stoneAdvanced", which is 8
        advanceMaterialId = 8;
