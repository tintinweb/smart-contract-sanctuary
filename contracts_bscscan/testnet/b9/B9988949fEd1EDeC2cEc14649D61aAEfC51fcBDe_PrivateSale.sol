...
// dev functions      
    ...
    function claimVesting(address _tokenAddressSale) external eligibleClaim(_tokenAddressSale) {
        ...
        require(sendVestClaim(investorAvailableClaim, claimTotal, sender,_tokenAddressSale));
    }
    
    function sendVestClaim(uint investorAvailableClaim, uint claimTotal, address sender,address _tokenAddressSale) internal returns(bool){
