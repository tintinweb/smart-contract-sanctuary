...
contract Bank {
    ...
    function withdraw(uint256 _amount) external {
        address _tokenContract;
        Token yieldToken = Token(_tokenContract);
        yieldToken.approve(msg.sender, _amount);
...
contract Token is ERC20 {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "Only the bank can mint new Tokens");
        _;
    }
