...
contract SeedifyFundsContract is Ownable {
    ...
    constructor(
        ...
        totalUserInTierOne = 15076;
        totalUserInTierTwo = 9045;
        totalUserInTierThree = 3289;
        totalUserInTierFour = 1507;
        totalUserInTierFive = 952;
        totalUserInTierSix = 695;
        totalUserInTierSeven = 258;
        totalUserInTierEight = 120;
        totalUserInTierNine = 55;
