...
//Contract
contract BullRun2022 is IBEP20, Ownable {
    ...
    string private constant _name = 'BullRun2022';  
    string private constant _symbol = 'BR2022';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 1000000000 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=20; //1%% = 10,000,000
    uint16 private constant SellLimitDivider=10; //2% = 20,000,000
    uint8 public constant MaxTax=40;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
