...
Here put website url,telegram all of info of your token
...
// CHANGE
contract Testie2 is IERC20, Ownable {                                                                             //!\ CHANGE THE NAME OF THE CONTRACT (example put the name of the token)
    using SafeMath for uint256;
    ...
    string constant _name = "Testie2";
    string constant _symbol = "Testie2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 2% MAX 20,000,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 4% MAX 40,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xC83579C434dce252b3Ff9aE48173B15AA552f0Ea);                                   //!\ CHANGE WITH YOUR DEV / MARKETING WALLET
