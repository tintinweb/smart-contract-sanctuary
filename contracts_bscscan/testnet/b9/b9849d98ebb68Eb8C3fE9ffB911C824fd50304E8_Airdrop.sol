...
contract Airdrop is Ownable {
    ...
    function sendDifferentValue(uint256[] memory amounts, address[] memory to) external onlyOwner {
    ...
    function sendSameValue(uint256 amount, address[] memory to) external onlyOwner {
      require(amount > 0);
