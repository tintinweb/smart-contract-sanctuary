...
contract CommunityIDO {
    ...
    uint public timeBeforeClaim = 0;
    uint public claimDuration = 1209600; // minimum number of second between 2 claims
    ...
    function createLiquidityPool () external postIDO() Demokratia() {
        ...
        timeBeforeClaim = block.timestamp + claimDuration;

        liquidityDeployment = true;
    }

    function distributeLPToken (uint distributionPercentage) public postIDO() Demokratia(){
        require(block.timestamp > timeBeforeClaim, 'You can only claim once every 2 weeks.');
        ...
        dosc.RegisterCall('CommunityIDO', 'distributeLPToken');
    }
    ...
    constructor() {
        ...
        addressDOSC = 0x666d9E245AD14424E3D279876Af444485FB73535;
