...
contract DimiraiFarming is Ownable, ReentrancyGuard {
    ...
    ILiquidityProvider public liquidityProvider =
        ILiquidityProvider(0x2B1C93fFfF55E2620D6fb5DaD7D69A6a468C9731);
    uint256 public liquidityProviderApiId = 0;
    address public bankAddress;
    address public constant ROUTER_ADDRESS = 0x610178dA211FEF7D417bC0e6FeD39F05609AD788;
    ...
    constructor(
        ...
        require(
            ...
            "DimiraiFarming::SET_ZERO_ADDRESS"
        );
    ...
    modifier poolExists(uint256 _pid) {
        require(_pid < poolInfo.length, "DimiraiFarming::UNKNOWN_POOL");
        _;
    }

    modifier onlyBank() {
        require(msg.sender == bankAddress, "DimiraiFarming:: Only bank");
        _;
    }
    ...
    /**
     * @notice Deposit LP tokens to DimiraiFarming for reward allocation
    ...
    /**
     * @notice Deposit LP tokens to DimiraiFarming from DimiraiVaultsBank
     * @param _pid: pool ID on which LP tokens should be deposited
     * @param _amount: the amount of reward tokens that should be converted to LP tokens and deposits to DimiraiFarming contract
     * @param _from: Address of user that called function from DimiraiVaultsBank
     */
