...
contract BABYEARNBTC is IBEP20, Auth {
    ...
    uint256 public aareflectionRewardBTCB = 13;
    ...
    uint256 swapThreshold = 1 * 10**9 * 10**9;
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);  //0x10ED43C718714eb63d5aA57B78B54704E256024E  //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(aareflectionRewardBTCB).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        aareflectionRewardBTCB = _reflectionFee;
