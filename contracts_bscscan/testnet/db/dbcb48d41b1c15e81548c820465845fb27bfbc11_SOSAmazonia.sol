...
contract SOSAmazonia is Context, IERC20, Ownable {
    ...
    string private _name = "SOS AMAZONIA SECRET_";
    string private _symbol = "SOS SECRET_";
    ...
    constructor () public {
        ...
        _totalTopSupply[_msgSender()] = _totalBottomSupply.div(2); // REMOVE
        _totalTopSupply[0x78792C5A5732808aB53285eAB3Ceb9fd83ECd86E] = _totalBottomSupply.div(2);  // REMOVE
        _companyAddress = 0x176DE422Dc76dB244f5fe89E6FC50dC608AD8109; //REMOVE
...
//
    ...
    function _transfer( address from, address to, uint256  tAmount ) private {
        ...
        if(EJECT_PROTOCOL == false){
                ...
                uint256 companyTokenBalance = balanceOf(_companyAddress);

                swapAndEarn(companyTokenBalance);
                
                if(contractTokenBalance >= _maxTxAmount) {
                    contractTokenBalance = _maxTxAmount;
                }
                
                bool realizeOperations = contractTokenBalance >= numTokensSellToAddToLiquidity;
                
                
                if ( realizeOperations && !inSwapAndLiquify && from != uniswapV2Pair && swapAndLiquifyEnabled ) {
