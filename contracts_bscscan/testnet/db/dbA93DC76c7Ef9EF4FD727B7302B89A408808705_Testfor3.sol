...
contract Testfor3 is Ownership, IBEP20 {

    uint256 _totalSupply = 100000000 * 1**18 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20;
    uint256 public _walletMax = _maxTxAmount;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address marketingContract = 0x0EE0b7A343Fb546c55D8FbbB0eC18BC73634e1CA;
    ...
    string constant _name = "Testfor3";
    string constant _symbol = "Testfor3";
    ...
    uint256 public swapThreshold = (_totalSupply * 1) / 100000000;
    ...
    constructor() Ownership(msg.sender) {
        ...
        marketingFeeReceiver = marketingContract;
    ...
    function marketingAndLiquidity() private lockTheSwap() {
    ...
    function modifyFees(uint256 newLiqFee, uint256 newmarketingFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newmarketingFee;
        totalFee = liquidityFee + marketingFee;
        totalFeeIfSelling = totalFee;
    }
    function modifyFeeReceivers(address newLiquidityReceiver, address newmarketingContract) external onlyOwner {
        autoLiquidityReceiver = newLiquidityReceiver;
        marketingFeeReceiver = newmarketingContract;
    }
