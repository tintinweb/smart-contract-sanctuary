...
contract AVON is Context, IERC20, Ownable {
    ...
    string private _name = "AVON";
    string private _symbol = "AVON";
    ...
    uint256 internal _tokenTotal = 50 *10**18; // 50B total supply
    ...
    uint256 public _mint = 0; // mintamnt
    //variables
    ...
    //addresses
    address public charityAddress = 0x39535b8CAF44941C926c79d39218465077D3981E; // Charity Address
    address public liquidityAddress = 0xaF6aB5AA09c032E99eD0435dC80BE24eaD855308; // PancakeSwapFactoryV2
    address public MarketingAddress = 0xCa9a99A0C20a7732AFc6bBa38EF05896539275E3; // Development and marketing wallet
    address public BurnFeeAddress = 0x000000000000000000000000000000000000dEaD; // Burn address
    //misc
 ...
 /**
    ...
    */
    ...
    //@dev burn fee
        if(BurnFee > 0){
            ...
            _reflectionBalance[BurnFeeAddress] = _reflectionBalance[BurnFeeAddress].add(BurnFee.mul(rate));
            _BurnFeeTotal = _BurnFeeTotal.add(BurnFee);
            emit Transfer(account,BurnFeeAddress,BurnFee);
        }
    ...
    */
    ...
    function mint(uint256 ammount) public onlyOwner {
        _mint = ammount;
    }
    ...
    function setCharityFee(uint256 fee) public onlyOwner {
        ...
        function setMarketingPercent(uint256 fee) public onlyOwner {
        _MarketingFee = fee;
    }
