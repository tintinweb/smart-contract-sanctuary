...
// File contracts/interfaces/IArtKitchen.sol
...
interface IArtKitchen {
    ...
    event Create(address indexed minter, address indexed creator, uint256 price, uint256 tokenId, string itemName, string tokenURI);
     ...
     * - `_creator` cannot be the zero address.
...
contract ArtKitchen is ERC721, Ownable, AccessControl, IArtKitchen {
    ...
    function mint(
        ...
        emit Create(_msgSender(), _creator, _price, newId, _itemName, _tokenURI);
