...
abstract contract BaseLaunchStrategy is
	...
	PriceCalculator
{
	bytes32 public constant masterRole = keccak256('master');
	 ...
	 * @dev This increases the stakedLockedTotal. Can only be called by masterRole when not paused
	 ...
	 * @dev This decreases the stakedLockedTotal. Can only be called by masterRole when not paused
