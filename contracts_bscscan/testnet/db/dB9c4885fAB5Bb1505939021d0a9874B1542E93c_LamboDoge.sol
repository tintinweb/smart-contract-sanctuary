...
contract LamboDoge is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingTokens = contractTokenBalance.mul(_marketingFee).div(_100percent);
        ...
        uint256 deltaBalanceMarketing = deltaBalance.mul(_marketingFee).div(_100percent);
