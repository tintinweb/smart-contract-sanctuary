...
contract  ICO is  Ownable
{
    ...
    uint public preSalePrice = 0.000027624 ether;
    uint public icoPrice = 0.000033148 ether;
    uint public preSaleMinQuantity=36000* 10**18;
    uint public preSaleMaxQuantity=360000* 10**18;
    ...
    constructor()  {
       ...
       erc =  IERC20(0xBE89CAC45F7777923F731c50Ec5DBeb112E1396a);
       Owner=msg.sender;
    ...
    function preSale(uint256 _quantity) public payable
    {
        ...
        erc.transferFrom(Owner,msg.sender,quantity20per);
