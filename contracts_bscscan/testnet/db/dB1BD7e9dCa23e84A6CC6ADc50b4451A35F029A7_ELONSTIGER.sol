...
/*                                     
ElonsTiger
Telegram: https://t.me/elonstiger_etiger
Twitter: https://twitter.com/ElonsTiger
Website: https://elonstiger_etiger (by success)

Tax: 10% for buys and sells
4% liquidity fee
6% marketing fee
*/
...
contract ELONSTIGER is IBEP20, Auth {
    ...
    string constant _name = "ELONSTIGER";
    string constant _symbol = "ETIGER";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount =  _totalSupply / 100; 
    uint256 public _maxWalletSize = _totalSupply / 50; 
    ...
    address private marketingFeeReceiver = 0x3fa56609fe9D276634d657FBbCcCB8aE3fCF3a85;
