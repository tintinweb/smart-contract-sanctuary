...
contract PresaleFactory is Ownable {
    ...
    function getPresalesApproved(uint256 _index, uint256 _amountToFetch)
        external
        view
        returns (Presale[] memory, IERC20[] memory)
    {
        ...
        for (uint256 i = 0; i < _amountToFetch; i++) {
            if (
                ...
                presales[currIndex].presaleIsApproved() == true
            ) {
                tempPresales[i] = presales[currIndex++];
                selectedCount++;
            }
    ...
    function getPresalesOfTier1(uint256 _index, uint256 _amountToFetch)
        external
        view
        returns (Presale[] memory, IERC20[] memory)
    {
    ...
    function getPresalesOfTier2(uint256 _index, uint256 _amountToFetch)
        external
        view
        returns (Presale[] memory, IERC20[] memory)
    {
    ...
    function getPresalesOfTier3(uint256 _index, uint256 _amountToFetch)
        external
        view
        returns (Presale[] memory, IERC20[] memory)
    {
