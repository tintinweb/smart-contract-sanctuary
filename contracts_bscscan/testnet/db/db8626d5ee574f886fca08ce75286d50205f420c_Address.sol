...
contract BABYXRP is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2BAE657f74cde160557C5675485144f5e58fc404); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0x2BAE657f74cde160557C5675485144f5e58fc404); // xrp Address
    ...
    string private _name = "nanafan";
    string private _symbol = "nanafan";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1); //Prod
