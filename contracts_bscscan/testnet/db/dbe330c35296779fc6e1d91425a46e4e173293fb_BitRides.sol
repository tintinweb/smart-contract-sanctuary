...
interface IBEP20 {
  ...
  event SwapBack(uint256 rewardamount, uint256 marketingamount, uint256 amountBNBLiquidity);
}
...
contract BitRides is IBEP20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        emit SwapBack(amountBNBReflectionWBNB, amountBNBMarketing, amountBNBLiquidity);
