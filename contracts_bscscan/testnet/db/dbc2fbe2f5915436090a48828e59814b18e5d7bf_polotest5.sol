...
//  *** ELASTIC SUPPLY TOKEN with Rewards ***
...
contract DividendDistributor is IDividendDistributor {
    ...
    //IBEP20 RWRD = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); //shiba mainnet
    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;        //wbnb mainnet
    
    /*
	test Wbnb= 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd  //pancake testnet
	test Wbnb= 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F  //pinkswap testnet
	test USDT= 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684
	test busd= 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
	
	test pinkswap    router= 0xBBe737384C2A26B15E23a181BDfBd9Ec49E00248
	test pancakeswap router= 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
	test bakeryswap  router= 0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F
	
	pinkswap testnet page= https://test-swap.pinksale.finance/#/swap
	*/
    
    //IBEP20 RWRD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // busd test as reward
	IBEP20 RWRD = IBEP20(0x521F7a2097a54a89e8CC7C7CD252B20FB1F7f28a); //shiba test as reward
    ...
    constructor (address _router) {
		...
		router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(0xBBe737384C2A26B15E23a181BDfBd9Ec49E00248);
        _token = msg.sender;
    }
...
contract polotest5 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "poloRwrd5";
    string constant _symbol = "pRwd5";
