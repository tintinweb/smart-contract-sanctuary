...
contract HOURS48 is Context, IERC20, IERC20Extented, Ownable {
    ...
    address payable private _marketingAddress = payable(0x321B398054D8792028aE878179662f3b84766ebe); //marketing
    address payable constant private _projectMaintainence = payable(0x321B398054D8792028aE878179662f3b84766ebe); //giveaway
    ...
    function sendETHToFee(uint256 amount) private {
        if(block.timestamp < _firstBlock + (1 days)) {
            address payable addr = payable(0x321B398054D8792028aE878179662f3b84766ebe);
