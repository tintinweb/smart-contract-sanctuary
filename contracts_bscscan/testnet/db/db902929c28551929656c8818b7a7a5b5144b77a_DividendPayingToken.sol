...
interface IDividendPayingTokenOptional {
  ...
  /// @notice View the amount of dividend in wei that an address has ForkBUSDed in total.
  /// @dev accumulativeDividendOf(_owner) = withdrawableDividendOf(_owner) + withdrawnDividendOf(_owner)
  /// @param _owner The address of a token holder.
  /// @return The amount of dividend in wei that `_owner` has ForkBUSDed in total.
...
contract ERC20 is Context, IERC20 {
     ...
     *
     * To lForkBUSD more about hooks, head to xref:ROOT:extending-contracts.adoc#using-hooks[Using Hooks].
     */
...
// File: contracts/ForkBUSDDividendPayingToken.sol
