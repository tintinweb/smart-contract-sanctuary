...
/**
    Student Token is a soft fork of Elvolution that incorporates adjustable
    yield rates (so early buyers can continue to earn reasonable yields as
    more holders enter the ecosystem). Student also has a deflationary supply
...
contract Student is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7 * 10**6 * 10**8 ;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Student Token';
    string private _symbol = 'Student';
    uint8 private _decimals = 8;

    uint256 private _taxFee = 3;
    uint256 private _burnFee = 1;
    uint256 private _maxTxAmount = 250000000e8;
