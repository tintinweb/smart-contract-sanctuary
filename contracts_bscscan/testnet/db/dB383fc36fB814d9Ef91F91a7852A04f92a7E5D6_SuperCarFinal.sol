...
//1% Auto Burn
//1% Dev
//1% / 2% Rewards to Holders

// TELEGRAM https://t.me/
// WEBSITE https://www.com./
// TWITTER https://mobile.twitter.com/xxx
...
contract SuperCarFinal is Context, IERC20, LockToken {
    ...
    uint256 private _tTotal = 1_000_000_000_00* 10**4;  //total supply. 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SuperCarFinal"; //token name
    string private _symbol = "SUPCF"; // token symbol. 
    ...
    uint256 public _maxTxAmount = 1_000_000_000 * 10**4;
    uint256 private minimumTokensBeforeSwap = 10_000 * 10**4; 
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 1_000_000_000_00 * 10**4;
    }
    ...
    {    
        ...
        _maxTxAmount = 1_000_000_000 * 10**4;
    }
