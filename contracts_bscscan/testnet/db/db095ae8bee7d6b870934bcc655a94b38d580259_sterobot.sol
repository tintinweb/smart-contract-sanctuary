...
abstract contract Tokenomics {
    using SafeMath for uint256;
    string internal constant NAME = "XtestSterobot";
    string internal constant SYMBOL = "Xtes$SBT";
    ...
    uint256 internal constant maxTransactionAmount = 5000000000000*ZEROES; 
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 20; 
    uint256 internal constant numberOfTokensToSwapToLiquidity = 5000000000000 ; 
    address internal burnAddress = 0x000000000000000000000000000000000000dEaD;
    address internal marketingAddress = 0xa4d8057CCB1E92241de3521C772143F8933113c6;
    address internal devAddress = 0xd5183254B184877e144D5e87ff156671dcc65fE1;
    enum FeeType { Antiwhale, Burn, Marketing, Dev,  Liquidity, Rfi, External, ExternalToETH }
    struct Fee {
        FeeType name;
        uint256 value;
        address recipient;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Marketing, 20, marketingAddress);
        _addFee(FeeType.Dev, 20, devAddress);
    }
