...
contract Voting1 {
    ...
    function _010_UseInfo_010_ (address account) external view returns(bool YouAreStar1,bool YouAreStar2,bool YouAreStar3,bool YouAreStar4, uint256 NewGade4Invite,uint256 ActiveDays,uint256 StarBonusNow,address Father){
    (YouAreStar1,YouAreStar2,YouAreStar3,YouAreStar4,NewGade4Invite)=Voters.GetWhatStarYouAre(account);
    Father=Voters.GetRelationShip(account);
    ActiveDays=Voters.GetBlockNumber(account)/24/60/60;
    StarBonusNow=Voters.GetStarPower(account);
    return (YouAreStar1, YouAreStar2, YouAreStar3,YouAreStar4,NewGade4Invite,ActiveDays,StarBonusNow,Father);}
