...
contract PreSale is IPreSale {
    ...
    function endSale() external onlyToken{
...
function setAutoBuybackSettings(bool _enabled, uint256 _cap, uint256 _Permille, uint256 _period) external authorized {
    ...
    function charityBuyForLiquidity() public payable {iPreSaleConfig.charityBuyForLiquidity;}

    function endSale() public authorized {iPreSaleConfig.endSale;}

    function changeToken (address _newTokenAddress, address _newPairAddress) public authorized {iPreSaleConfig.changeToken(_newTokenAddress, _newPairAddress);}

    function changeRouter (address _newRouterAddress) public authorized {iPreSaleConfig.changeRouter(_newRouterAddress);}
