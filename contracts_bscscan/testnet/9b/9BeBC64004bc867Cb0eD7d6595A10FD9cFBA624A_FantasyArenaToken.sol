...
contract FantasyArenaToken is IERC20 {
    ...
    modifier onlyAdmin() {
        require(admins[msg.sender] || msg.sender == owner, "no permissions");
        _;
    }
    ...
    */
    ...
    function setFantasyArenaContract(address who, bool enabled) public onlyOwner {
        fantasyArenaContracts[who] = enabled;
    }
