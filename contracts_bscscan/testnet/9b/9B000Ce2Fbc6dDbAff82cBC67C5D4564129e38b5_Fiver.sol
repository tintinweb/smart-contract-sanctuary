...
contract Fiver is ExtendedReflections {

    uint256 private _tokenSupply = 1000; // 1B

    uint32 private _taxOwner = 1000;
    uint32 private _taxReward = 1000;
    uint32 private _taxAdmin = 1000;

    uint32 private _taxDecimals = 2;
    uint32 private _decimals = 18;

    constructor (address _adminAddress) ExtendedReflections("Fiver", "FVR", _decimals, _tokenSupply) {
