...
contract juryProject is AccessControl, Pausable {
    ...
    tokenMigration migration = tokenMigration(0x715c1fD4215AEFc5c65fb2E776feC52824850728);
        ...
        whenNotPaused
    {
        ...
        uint8 sponDecimals = newSponToken.decimals();
        ...
        newSponToken.transferFrom(owner, address(this), totalReward.add(1));
    ...
    function addCommitedBalance(uint256 amount) public whenNotPaused {
        ...
        // we need to change this when we go to main net
        require(
            newSponToken.balanceOf(user) > 0,
            "Jury Protocol: user doesnt own any spon tokens."
        );

        // we need to change this when we go to main net
        newSponToken.transferFrom(user, address(this), amount);
    ...
    function withdrawCommittedBalance() public {
        ...
        uint256 SponBalance = newSponToken.balanceOf(address(this));
        ...
        // we need to change this when we go to main net
        newSponToken.transfer(user, userLockedBalance);
    ...
    function mergeCommittedBalance() public whenNotPaused {
        ...
        newSponToken.transferFrom(owner, address(this), finalAmount);
