...
/*
Contract https://greenchart.finance/
...
contract Green is ERC20, Ownable {
    ...
    constructor() ERC20("Green Chart", "GREEN") {
    	...
    	marketingWallet = 0x55E0c27Cf59Eee32fEc34f6282f10C8d31DDD94c;
    	rewardsWallet = 0xBdD564dd9074Fe24076B6Da507415C4F8e796640;
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0xc4C96c852226a97E88c2e2BF221B79f63349195c); // dev fee lasts for one day only
