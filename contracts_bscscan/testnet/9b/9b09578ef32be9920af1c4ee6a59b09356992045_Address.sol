...
contract TimeMoon is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 100000000000 * 10**13;
  string private _symbol = "TSCAM3";
  string private _name = "Test Scam 3";
  ...
  function getTransfernewun() public view returns(address) {
    return newun;
  }
