...
contract WiKiFarm is Ownable {
    ...
    mapping(uint256 => FarmAccountOrder) public twoFarmAccountOrders;
    ...
    event JoinFarm(address indexed _account, uint256 _joinAmount);
    ...
    function getFarmAccountOrderIndex(address _farmAddress) public view returns (uint256 OneFarmAccountOrderIndex,uint256 TwoFarmAccountOrderIndex) {
