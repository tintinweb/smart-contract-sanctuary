...
contract ISLAMI is BEP20, Ownable {
    ...
    //ufixed8x1 public Charity;

    constructor() 
    
    BEP20("ISALMICOIN", "ISLAMI") {
        
        _mint(msg.sender, 15979999990 *10** decimals()); //ISLAMICOIN contract creator (Coins reserved for different Liquidity providers and future projects)
        _mint(address(this), 5000000000 *10** decimals());  //Contract Address for crowdsale feature
        ...
        _mint(address(0x4d1a71F898DE61F9401B65daB99a4faFFbC15f51), 3000000000 *10** decimals());   // ISLAMICOIN Development Team Lock 90%
        _mint(address(0x310e09640a1bcF7ED93937C239f576f8ceCA3Eb9), 20000000 *10** decimals());   // AirDrop 
     
        Charity = 5; // Represents Zakkat persentage 2.5%
