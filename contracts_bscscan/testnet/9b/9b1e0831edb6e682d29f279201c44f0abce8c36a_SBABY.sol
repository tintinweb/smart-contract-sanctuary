...
contract SBABY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9F8e8418E031923d13c0Bee63dB83C55F8785494); // Marketing Address
    ...
    uint256 private _tTotal = 2100000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "sbaby";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x039B5818e51dfEC86c1D56A4668787AF0Ed1c068);
    ...
    function setFreeTransfer(bool _enabled) public onlyOwner {
        freeTranfer = _enabled;
    }
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 2100000000 * 10**6 * 10**9;
    }
