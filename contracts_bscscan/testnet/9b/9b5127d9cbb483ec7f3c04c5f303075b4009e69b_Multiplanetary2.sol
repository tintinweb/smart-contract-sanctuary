...
/**
 * Multiplanetary2: 10% dev fee , 2% Burn
*/
...
contract Multiplanetary2 is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Multiplanetary2';
    string  private constant _SYMBOL = 'Multiplanetary2';
    ...
    uint256 private     _TAX_FEE = 0; // 0% BACK TO HOLDERS
    uint256 private    _BURN_FEE = 0; // 0% BURNED
    uint256 private _DEV_FEE = 10000; // 10% Dev fee
    ...
    constructor () {
        ...
        _isDev[0xb1BCBE2DB3089927D6cfE1f5406d3F34a024eb13] = true;
        _dev.push(0xb1BCBE2DB3089927D6cfE1f5406d3F34a024eb13);
         _isExcluded[0xb1BCBE2DB3089927D6cfE1f5406d3F34a024eb13] = true;
        _excluded.push(0xb1BCBE2DB3089927D6cfE1f5406d3F34a024eb13);
    }
    ...
    function setAsDevAccount(address account) external onlyOwner() {
        require(account != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, 'The Uniswap router can not be the dev account.');
