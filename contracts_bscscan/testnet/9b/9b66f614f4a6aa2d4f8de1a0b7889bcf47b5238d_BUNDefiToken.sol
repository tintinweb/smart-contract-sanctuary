...
contract InitializableOwnable {
    ...
    modifier notInitialized() {
        require(!_INITIALIZED_, "BUN_INITIALIZED");
        _;
    }
...
// File: contracts/BUNToken/BUNDeFiToken.sol


/**
 * @title BUN Token Mapped on BSC
 * @author BUN Breeder
 */
contract BUNDefiToken is InitializableOwnable {
    using SafeMath for uint256;

    string public name = "BUNNY DeFi";
    ...
    function redeem(uint256 value, address redeemToEthAccount) external {
        require(balances[msg.sender] >= value, "BUNDeFiToken: NOT_ENOUGH");
