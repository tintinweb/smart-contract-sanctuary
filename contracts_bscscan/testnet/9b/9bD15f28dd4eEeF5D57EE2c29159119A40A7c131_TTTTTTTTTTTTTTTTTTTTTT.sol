...
contract TTTTTTTTTTTTTTTTTTTTTT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x5067c2827DC68f24536aE5a4E754565C521Dd792); // Marketing Address
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x5067c2827DC68f24536aE5a4E754565C521Dd792);
    }
