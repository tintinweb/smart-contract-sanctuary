...
contract LSC is BEP20 {
    ...
    constructor() public BEP20("Lottoescape", "LSC") {
    ...
    */
    ...
    function sendLiquidity() public returns(bool) {
        if(swapAndLiquifyEnabled)
            ...
            _balances[address(this)].add(_liquidityAmount);
        }
    ...
    function _sendToLiquidity1(uint256 tokenAmount) public {
    ...
    function swapTokensForBNB1(uint256 tokenAmount) public {
