...
contract CUFFY is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "CUFFY";
    string private constant _symbol = "$CUFFY" ;
   ...
   function setMaxWalletpercent (uint8 maxWalletPercent) external onlyOwner() {
        require (maxWalletPercent >= 1 && maxWalletPercent <= 100, "CUFF: The max wallet percentage must be between 1% (1) and 100% (100)");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            require (balanceOf(to) + amount <= maxWalletAmount, "CUFF: Receiver's wallet balance exceeds the max wallet amount");
            }
