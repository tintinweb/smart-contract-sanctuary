...
contract Stacking is Ownable {
    ...
    function setRewardPercentage(uint8 _reward ) public onlyOwner{
        rewardPercentage=_reward/(1000);
    }
    ...
    function deposite(uint256 amount) public  {
        ...
        require(amount>=100,"Amount Must be Gratar than 100");
        require(amount<=1000,"Amount Must be less than 1000");
        require(stakedToken.balanceOf(msg.sender)>=amount.mul(1e18),"deposite amount is less then amount ");
    ...
    function calclulateReward(uint256 id) public view returns(uint256){
        ...
        uint256 reward = (currentTime.sub(depositeTime)).mul(rewardPercentage);
    ...
    constructor() {
        rewardPercentage = 333;  //0.033
        stakedToken = IBEP20(0xA3F8BC37EfBc1d67CB2FC593B382e5A8eAC5d74F); 
    }
