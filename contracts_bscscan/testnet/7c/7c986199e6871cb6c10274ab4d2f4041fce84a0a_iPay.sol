...
// Tryign to swap and send to contract old way - EMIT NEEDED? 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            // Remove iPAY Tokens from Contract and send to BUSD LP wallet
            _tOwned[address(this)] = _tOwned[address(this)] - tokens_to_LP_Half; 
            _tOwned[LIQUIDITY_CONTRACT] = _tOwned[LIQUIDITY_CONTRACT] + tokens_to_LP_Half;



/*

Only works with Process LP function not from transactions
