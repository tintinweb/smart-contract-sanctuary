...
contract RoArtz_BUSD_Distributor is IDividendDistributor {
...
contract RoArts is IBEP20, Auth {
    ...
    string constant _name = "RoArts";
    string constant _symbol = "RoArts";
    ...
    RoArtz_BUSD_Distributor distributor;
    ...
    constructor (
        ...
        distributor = new RoArtz_BUSD_Distributor(address(router));
