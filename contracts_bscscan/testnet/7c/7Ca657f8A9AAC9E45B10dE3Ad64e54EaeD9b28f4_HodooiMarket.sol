...
contract HodooiMarket is HodooiManager, ERC1155Holder, ERC721Holder, VerifySign, ReentrancyGuard {
    ...
    bytes4 private constant _INTERFACE_ID_ERC721 = 0x80ac58cd; // 0x09603e74 // 0x80ac58cd
    ...
    function adminMigrateData(uint256 _fromOrderId, uint256 _toOrderId) external {
