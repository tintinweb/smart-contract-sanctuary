...
contract SuperCarFinal2 is Context, IERC20, LockToken {
    ...
    uint256 private _tTotal = 1_000_000_000_00* 10**9;  //total supply. 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SuperCarFinal2"; //token name
    string private _symbol = "SUPCF2"; // token symbol. 
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 1_000_000_000_00 * 10**9;
    }
