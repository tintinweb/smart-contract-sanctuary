...
// File: fox-marketplace-feediv.sol
...
contract Marketplace is AccessControl, Ownable {
    ...
    address public MARKETING_ADDRESS =
        0xB183eE73A5bD8f4b389AcEc44F437e022D128D5D;
    address public DEV_ADDRESS = 0xEC254c788d397fB18bb84Ad47a77d53424e93240;
    address public CREATION_ADDRESS =
        0xeA3d00e68e1a890348298a60b75F117aFd685152;

    uint256 public MARKETING_PERCENT = 15;
    uint256 public DEV_PERCENT = 43;
    uint256 public CREATION_PERCENT = 10;
    ...
    function addNewProduction(
        ...
        hashes.push(_hash);
        hashToIndex[_hash] = hashes.length - 1;

        return true;
    }

    // Set some props to the existing Production in the Marketplace
    function updateProductionByHash(
        string memory _name,
        string memory _description,
        uint256 _price,
        uint256 _quantity,
        ...
        require(
            owner() == _msgSender() || (foxProds[_hash].owner == _msgSender()),
        ...
        require(foxProds[_hash].flag == 1, "Product doesn't exist");
        // require(
        //     foxProds[_hash].owner == _msgSender(),
    ...
    function deleteProdByHash(string memory _hash) public returns (bool) {
        ...
        require(foxProds[_hash].flag == 1, "Product does not exist.");
        uint256 arrIndex = hashToIndex[_hash];
        string memory lastHash = hashes[hashes.length - 1];
        hashes[arrIndex] = lastHash;
        hashToIndex[lastHash] = arrIndex;
        hashes.pop();
    ...
    function setDEVData(address _newAdd, uint256 _newPer) public onlyOwner {
        DEV_ADDRESS = _newAdd;
        DEV_PERCENT = _newPer;
    }

    // Set MARKETING Address and Fee
    function setMARKETINGData(address _newAdd, uint256 _newPer)
        public
        onlyOwner
    {
    ...
    function setCREATIONDate(address _newAdd, uint256 _newPer)
        public
        onlyOwner
    {
