    ...
    Ownable
{
    ...
    uint256 private _BurnSecondsAppart = 20;
    ...
    constructor(
        ...
        _burncap = 100 * 10**6 * 10**18;
        _burnBurst = 1 * 10**6 *10**18;
        _burnCount = 0;
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        require(_lastBurnDate <= (_lastBurnDate + _BurnSecondsAppart * 1 seconds), "Burn action is allowed only once in 30 Days");
   ...
   function transferAnyBEP20Token(address tokenAddress, uint tokens) public onlyOwner returns (bool success) {
        return IBEP20(tokenAddress).transfer(address(this), tokens);
    }
