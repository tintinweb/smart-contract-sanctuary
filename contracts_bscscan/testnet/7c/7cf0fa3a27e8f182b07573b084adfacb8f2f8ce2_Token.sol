...
contract Token is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_, address uniswapRouterAddress) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        ...
        _inWhitelist[_uniswapV2Pair] = true; // automatically add LP
