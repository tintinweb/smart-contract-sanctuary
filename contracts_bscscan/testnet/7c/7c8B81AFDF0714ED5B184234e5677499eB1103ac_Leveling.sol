...
contract Leveling is ILeveling, StarlinkComponent, ShopItemFulfilment {
    ...
    function calculateBaseXpRate(uint256 starlinkPoints) public pure returns (uint256) {
        ...
        uint256 lowSweetSpotThreshold = 2000000000 * STARLINK_POINTS_PRECISION;
        ...
        uint256 midSweetSpotThreshold = 10000000000 * STARLINK_POINTS_PRECISION;
        ...
        uint256 highSweetSpotThreshold = 100000000000 * STARLINK_POINTS_PRECISION;
        ...
        uint256 whaleSweetSpotThreshold = 800000000000 * STARLINK_POINTS_PRECISION;
