...
contract RewardMechanism is IRewardMechanism {
    ...
    uint256 public minDividendForReward = 2000000 * (10 ** 9);
...
contract PassiveCoin is IBEP20, Ownable {
    ...
    constructor () {
        ...
        isMaxTransferLimitExempt[msg.sender] = true;
        isMaxTransferLimitExempt[address(this)] = true;
        isMaxTransferLimitExempt[pair] = true;
        isMaxTransferLimitExempt[0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3] = true;
