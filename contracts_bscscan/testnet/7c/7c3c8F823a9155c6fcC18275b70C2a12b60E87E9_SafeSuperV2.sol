...
abstract contract Tokenomics is Fees {
    ...
    constructor(
        ...
        address _marketingAddress // uint256 _rfifee, // uint256 _burnfee, // uint256 _liquidityfee, // uint256 _charityfee, // uint256 _marketingfee
    ) {
        NAME = _name;
        SYMBOL = _symbol;
...
contract SafeSuperV2 is SafeSuper {
    constructor(
        string memory _name,
        string memory _symbol,
        uint256 _totalSupply,
