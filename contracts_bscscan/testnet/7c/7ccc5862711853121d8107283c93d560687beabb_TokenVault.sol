...
contract TokenVault is AccessControlEnumerable, ITokenVault {
    ...
    modifier onlyFarm() {
        require(hasRole(FARM_ROLE, _msgSender()), "TokenVault: Call Only Staking Contract");
        _;
    }
    ...
    // Safe tokenAddress transfer function, just in case if rounding error causes pool to not have enough ABURAs.
    ...
    function rescueFunds(
        ...
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "TokenValue: You are not admin role");
