...
contract Ownable is Context {
    address private _owner = 0xc9f5A812745357D4730A71EAF8361941C931644A;
...
contract TESTANO is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xc9f5A812745357D4730A71EAF8361941C931644A); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "TESTANO"; // token name
    string private _symbol = "TENO"; // token symbol
    ...
    uint256 public _buyBackFee = 20; // buyback fee 12%
    ...
    uint256 public _liquidityFee = 90; // liquidity fee 3%
    ...
    uint256 public _minTokensSwapToAndTransferTo = 600 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
