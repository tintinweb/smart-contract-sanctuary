...
contract ULDRASAFE1155 is Ownable{
...
contract ULDRASAFEMultiMint is ULDRASAFE1155{
    string public name;
    string public symbol;

    mapping (uint256 => string) private _tokenURIs;

    constructor(string memory _name, string memory _symbol) ULDRASAFE1155(name, symbol) public{
        name = _name;
        symbol = _symbol;
    }
}
