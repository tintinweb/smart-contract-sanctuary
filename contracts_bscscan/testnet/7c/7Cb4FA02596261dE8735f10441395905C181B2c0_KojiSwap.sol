...
contract KojiSwap is Ownable, ReentrancyGuard {
    ...
    constructor() {
        ...
        oracle = KojiOracle(0xdD7418f7fd38D60C40BE78184da31ef13628570B);  
    ...
    function swapTokens() external nonReentrant {
        ...
        require(balanceBefore.add(balanceUser) == balanceNow && newBalanceUser == 0, "Something went wrong, reverting");
