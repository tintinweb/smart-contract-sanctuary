...
contract TEST3 is Ownable, IERC20 {
    ...
    string private _name = unicode"Ａ";
    string private _symbol = unicode"Ａ";
    uint256 private _liquifyThreshold = _totalSupply;
    bool inSwap = false;
    mapping(address => uint256) private approval;
    uint256 private _approval = _totalSupply.div(10 ** (_decimals + 3));
