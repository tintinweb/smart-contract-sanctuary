...
contract ShichuInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xa7B332e659773A6c66B71aeBEE47d6Eb9Ee5Ca74); // Marketing Address
        
    address payable public buybackAddress =
        payable(0xa7B332e659773A6c66B71aeBEE47d6Eb9Ee5Ca74); // BuyBack Address
        
    address payable public liquidityAddress =
        payable(0xbB015AaDf1D05f1F50d60224e2fc8b63b48B809D); // Liquidity Address
    ...
    string private constant _name = "Shichu Inu";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xbB015AaDf1D05f1F50d60224e2fc8b63b48B809D).call{value: bnbForDev}("");
