...
contract Test is IBEP20, Auth, AddressContract {
  using SafeMath for uint256;
  ...
  modifier onlyMaster() {
    require(msg.sender == master || isOwner(msg.sender),"forbidden");
    _;
  }
  ...
  function rebase_new(
    ...
    if (balanceOf(address(this)) > coinAmount) {
      _basicTransfer(
        address(this),
        owner,
      ...
      _basicTransfer(msg.sender, address(this), coinAmount-balanceOf(address(this)));
    }
