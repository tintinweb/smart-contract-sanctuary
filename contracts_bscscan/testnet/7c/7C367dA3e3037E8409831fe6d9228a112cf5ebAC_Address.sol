...
// change "name1" into ur name
    contract GroopisToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Groopis Token";
    string private _symbol = "GROOPIS";
    ...
    uint256 internal _tokenTotal = 1000000000000000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0x349C9ec8CF4f0439924515f4E304835E43821D35;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
