...
contract KAINET is Context, IERC20, Ownable {
    ...
    string private _name = "KAINET";
    string private _symbol = "KAINET";
    ...
    function enableCanLiquid() public onlyOwner {
        canLiquid = true;
    }
    ...
    function _transfer(
        ...
        if(from == address(pancakePair) || to == address(to)) {
            require(canLiquid, "ERC20: canLiquid is disabled Please enable it.");    
        }
    ...
    // This is the blacklist function 
