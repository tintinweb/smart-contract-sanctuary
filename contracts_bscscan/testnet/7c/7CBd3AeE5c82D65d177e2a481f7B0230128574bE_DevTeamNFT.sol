...
contract DevTeamNFT is Context {

    using Address for address;
    using Strings for uint256;

    string private constant _name = "LennyVerse";
    string private _symbol = "dLENNY";
    ...
    constructor(address _addressDOSC){
    ...
    function createNFT(string memory _tokenURI) public Demokratia() returns (uint) {
