...
contract KawaiiTokenRebase is Context, IERC20, Ownable {
    ...
    constructor ( uint256 _txFee, uint256 _lpFee, uint256 _MAXAMOUNT, uint256 SELLMAXAMOUNT, address routerAddress, address tokenOwner) public {
        _name = "KWT_REBASE";
        _symbol = "KWT_REBASE";
        _decimals = 18;
        _tTotal = 8000000000000 * 10 ** _decimals;
