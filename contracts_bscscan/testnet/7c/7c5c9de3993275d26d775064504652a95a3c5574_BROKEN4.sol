...
contract BROKEN4 is Context, IBEP20, Ownable {
    ...
    string private _name = "BRK4";
    string private _symbol = "BRK4";
    ...
    uint256 public timeWeek = 30 * 60;  // 2h
    uint256 public timeMonth =  60 * 60; // 4h
