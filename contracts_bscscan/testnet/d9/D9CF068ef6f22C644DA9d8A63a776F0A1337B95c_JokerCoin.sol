...
contract Ownable is Context {
    ...
    constructor () {
        _owner = payable(0x64043ff148D416E7AEf0b49731c30dd3D53C2242);
...
contract JokerCoin is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 public minBuy = 0.0003 ether; // minimum buy is 0.03 Bnb by default can be change later
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        if (
            ...
            if (buyBackEnabled && initialBalance > uint256(buyBackLowerLimit)) {
                ...
                Utils.swapETHForTokens(address(pancakeRouter), burnAddress, initialBalance);
            }
