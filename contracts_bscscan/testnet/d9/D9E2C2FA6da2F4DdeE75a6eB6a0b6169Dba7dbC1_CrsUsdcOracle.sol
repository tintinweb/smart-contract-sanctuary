...
import "../pancake/libraries/FixedPoint.sol";
import "../pancake/libraries/PancakeLibrary.sol";
import "../pancake/libraries/PancakeOracleLibrary.sol";

// fixed window oracle that recomputes the average price for the entire period once every period
// note that the price average is only guaranteed to be over at least 1 period, but may be over a longer period
contract CrsUsdcOracle {
    using FixedPoint for *;

//    uint public constant PERIOD = 24 hours;
    uint public constant PERIOD = 5 seconds; // TODO Modify
    ...
    constructor(address factory, address tokenA, address tokenB) public {
        ...
        require(reserve0 != 0 && reserve1 != 0, 'CrsUsdcOracle: NO_RESERVES'); // ensure that there's liquidity in the pair
    }
    ...
    function update() external {
        ...
        require(timeElapsed >= PERIOD, 'CrsUsdcOracle: PERIOD_NOT_ELAPSED');
    ...
    function consult(address token, uint amountIn) external view returns (uint amountOut) {
        if (token == token0) {
            ...
            require(token == token1, 'CrsUsdcOracle: INVALID_TOKEN');
...
//                 hex'999d725d835587f1863c4dc228319669e1ca9f9cefa7b94e170cce47b9e48b42' // init code hash
