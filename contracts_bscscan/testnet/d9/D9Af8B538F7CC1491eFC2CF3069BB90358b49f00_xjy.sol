...
contract xjy is ERC20 {
    ...
    bool public megaburnIsEnabled = true;
    ...
    xjiDividendTracker public dividendTracker;

    address public burnAddress;
    address payable public marketingAddress =
        payable(0xd107fC153AA61B277e1dcFF89dDE98619007da73); // Marketing Address
    ...
    constructor() public ERC20("xjy", "XJY") {
        ...
        dividendTracker = new xjiDividendTracker();
    ...
    function updateMegaburnIsEnabled(bool value) external onlyOwner {
        megaburnIsEnabled = value;
    }
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        require(
            ...
            "xjy: The dividend tracker already has that address"
        );

        xjiDividendTracker newDividendTracker = xjiDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "xjy: The new dividend tracker must be owned by the xjy token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(
            ...
            "xjy: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "xjy: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "xjy: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "xjy: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "xjy: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "xjy: Cannot update gasForProcessing to same value"
        );
    ...
    function setMaxSellTransaction(uint256 maxTxn) external onlyOwner {
        require(
            maxTxn >= 200000000,
            "Sell transaction amount cannot be less than 0,2% of total supply"
        );
    ...
    function _transfer(
        ...
        if (cooldownEnabled) {
            ...
            if (
                block.timestamp - timeTradingEnabled > 30 minutes &&
                block.timestamp - lastRun > 60 seconds
            ) {
                lastRun = block.timestamp;
                sellFeeIncreaseFactor = 150;
            }
            if (block.timestamp - timeTradingEnabled > 39 minutes) {
                cooldownEnabled = false;
                sellFeeIncreaseFactor = 110;
            }
        }
    ...
    // modified to support different dividends
...
contract xjiDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        public
        DividendPayingToken("xjy_Dividend_Tracker", "xjy_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "xjy_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(
            false,
            "xjy_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main xjy contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "xjy_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "xjy_Dividend_Tracker: Cannot update claimWait to same value"
        );
...

{
  ...
  "libraries": {
    "contracts/TestToken/IterableMapping.sol": {
      "IterableMapping": "0x3784c20696e0Ce0e21fEDca18996B501e699aB63"
    }
  },
  "outputSelection": {
    "*": {
