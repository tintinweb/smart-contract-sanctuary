...
contract Litechee is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 3000000000 * (10**18);
    uint256 public maxWalletToken = 30000000000 * (10**18); // 3% of total supply
    ...
    constructor() ERC20("LitecheeTest", "LCHEETST") {
    	...
    	buyBackWallet = 0x89E5edBD9e126a6C9bd8be233B9D416165e55582;
