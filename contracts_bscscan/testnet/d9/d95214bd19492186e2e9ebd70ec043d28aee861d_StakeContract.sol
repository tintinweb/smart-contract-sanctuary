...
contract StakeContract is Ownable {
    ...
    uint256 public startBlock = 15244566 ; // set start block
    uint256 public minimum_deposit = 4000*10**18; //minimum deposit
    uint256 public endBlock =   17244566 ;  // set end block
    uint256 public firstMonthRewardperblock = 0.0000000141096281 * 10 ** 18; //first month block reward % * 1e18
    uint256 public afterRewardperblock = 0.000000007316259792 * 10 ** 18; //after first block reward % * 1e18
    uint256 private firstMonthBlockPeriod = 400; //30days block = 836129.0323, we use 864000
    uint256 private unlockblockperiod = 200; //15days block = 418064.5161, we use 432000
    ...
    uint256 public lastRewardBlock = 15244566;  // should be same as start block at the beginning
