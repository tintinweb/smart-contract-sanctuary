    ...
    VRFConsumerBase
{
    ...
    function requestRandomNumber(uint256 tokenId_) public {
        require(
            ...
            "ChainLinkRandomGenerator::requestRandomNumber: must have commander role to request!"
        );
        require(
        ...
        override
    {
        ...
        IRandomConsumer _consumer = IRandomConsumer(_payload.sender);
