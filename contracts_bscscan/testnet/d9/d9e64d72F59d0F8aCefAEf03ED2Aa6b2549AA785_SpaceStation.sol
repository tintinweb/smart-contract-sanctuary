...
contract SpaceStation is ReentrancyGuard, EIP712 {
    ...
    function _hashBatch2(IStarNFT _starNFT, uint256[] calldata _dummyIdArr, uint256[] calldata _powahArr, address _account) public view returns (bytes32) {
    ...
    function _hashForge2(IStarNFT _starNFT, uint256[] calldata _nftIDs, uint256 _dummyId, uint256 _powah, address _account) public view returns (bytes32) {
        return keccak256(abi.encode(
