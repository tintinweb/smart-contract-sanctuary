...
contract Pyro is Context, IBEP20, Ownable {	
    ...
    uint256 public lotteryThreshold = 10 * _decimalFactor;
   
   	uint256 private _minLottoBalance = 1 * _decimalFactor;
    bool public _shouldSwapToBNB = false;
    
    uint256 public _maxTxAmount = _tTotal;
    uint256 private numTokensSellToAddToLiquidity = 500 * _decimalFactor;
    
    // anti whale
    bool    public _isAntiWhaleEnabled = true;
    uint256 public _antiWhaleThreshold = 100 * _decimalFactor;
