...
contract MetadogToken{
    ...
    uint256 private _referToken =   50000000000000000000000; //fix 50k per referral Token
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 11115596872;
    }
