...
contract CoinToken is Context, IBEP20, Ownable {
	...
	function updateFee(uint256 _txFee,uint256 _burnFee,uint256 _charityFee,uint256 _liqFee) onlyOwner() public{
		require(_txFee < 100 && _burnFee < 100 && _charityFee < 100 && _liqFee < 100);
        _TAX_FEE = _txFee* 100; 
        _BURN_FEE = _burnFee * 100;
		_CHARITY_FEE = _charityFee* 100;
		_LIQ_FEE = _liqFee* 100;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        emit Transfer(sender, recipient, tLiquidity);
