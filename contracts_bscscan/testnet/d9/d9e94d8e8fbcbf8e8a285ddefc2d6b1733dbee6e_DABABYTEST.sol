...
contract DABABYTEST is IERC20 {
    ...
    string constant _name = "DABABYTEST";
    string constant _symbol = "DABABYTEST";
    ...
    address payable private _marketingWallet = payable(0x64EeB68136d555d058e068153E5A6AEA023b741F);
