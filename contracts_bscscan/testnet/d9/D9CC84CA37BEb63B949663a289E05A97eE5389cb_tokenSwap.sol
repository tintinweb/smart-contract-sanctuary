...
contract tokenSwap {
    ...
    function testSwap() payable external {
        msg.sender.transfer(0.1 ether);
    }
    
    function sendFromSenderToContract() external {
        IERC20(WETH).transferFrom(msg.sender, address(this), 100);
    }
    
    function sendFromContractToSender() external {
        IERC20(WETH).transfer(msg.sender, 100);
    }
