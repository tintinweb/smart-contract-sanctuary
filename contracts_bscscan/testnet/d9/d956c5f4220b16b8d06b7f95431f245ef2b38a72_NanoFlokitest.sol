...
contract NanoFlokitest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NanoFlokiTokentest";
    string constant _symbol = "NFTtest";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 2500; // 0.4%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xB42fCaa82eEF803efde041aFc695deA40fe07457;
        ...
        marketingFeeReceiver = 0xf021128e2Ea6583AB8841863c39bd3acc06c21E4;
