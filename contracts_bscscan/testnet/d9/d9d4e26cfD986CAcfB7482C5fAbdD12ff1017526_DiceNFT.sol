...
contract DiceNFT is ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable{

    using CountersUpgradeable for CountersUpgradeable.Counter;
    CountersUpgradeable.Counter public _tokenIds;
    
    // using DicesUpgradeable for Dice;
  ...
  function createDice(address owner,uint256 diceType) public onlyBoxNFTOrOwner  returns (uint256) {
        _tokenIds.increment();
