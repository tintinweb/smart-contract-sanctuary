...
contract MetaDreamsToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 999000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MDXX8";
    string private _symbol = "MDXX8";
    ...
    address public marketingWallet = 0x0897b6f79Fb000Fa4BF6c7E8B972f09Fc95293f6;
    ...
    uint256 public numTokensSellToAddToLiquidity = 999000000000000000000 * 10**9;
    uint256 public _maxTxAmount = 499500000000000000000 * 10**9;
    ...
    {
        //Exclude all fees from transfer
        /*
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee, uint256 tLiquidity) = _getValues(tAmount);
