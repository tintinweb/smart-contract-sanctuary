...
pragma solidity ^0.8.0;
contract BSCNFT2 is ERC20, Ownable {
    ...
    constructor() ERC20("BSC NFT2", "BNFT2") {
        _mint(msg.sender, 6601016*10**decimals());
        _mint(address(this), 26404064*10**decimals());
        startSale(block.number, 999999999,0,33333*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,33*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
