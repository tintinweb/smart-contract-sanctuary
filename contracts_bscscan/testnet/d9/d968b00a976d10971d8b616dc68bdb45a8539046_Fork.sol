...
contract Fork is IBEP20, Auth {
    ...
    address LIQD = 0xBF451904632dB4c6F591d81406c469193190eD55;
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 10; // 1% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        isTimelockExempt[LIQD] = true;
        isTimelockExempt[address(this)] = true;

        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[LIQD] = true;

        // NICE!
        autoLiquidityReceiver = LIQD;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // max wallet code
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(LIQD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
