...
contract Broker is ERC721Holder{
    ...
    // events
    event Bid(address collection, uint tokenId, address seller, address bidder, uint amouont, uint time);
    event Buy(address collection, uint tokenId, address seller, address buyer, uint amount, uint time);
    event Collect(address collection, uint tokenId, address seller, address buyer, address collector, uint time);
    event OnSale(address collection, uint tokenId, address seller, uint auctionType, uint amount, uint time);
    event OffSale(address collection, uint tokenId, address seller, uint time);
