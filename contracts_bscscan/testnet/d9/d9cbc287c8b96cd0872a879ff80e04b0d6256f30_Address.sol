...
contract STBL is ERC20, Ownable {
    ...
    constructor(
    ) public ERC20("Sensi Dollar", "STBL") {
        _devWallet = 0x44843619C2985410c59ae358F6bA395c50FCad12;
        DAI = ERC20(0x58d519D7383a14850a7362f2A4F95E02cBFe347E);

    }
    
    function mint(uint256 amount) public {
        require(DAI.allowance(_msgSender(), address(this)) >= amount , "amount exceeds allownace");
        DAI.transferFrom(_msgSender() ,address(this), amount);
        uint256 _fee = calculateTokenFee(amount, fee);
        _mint(_msgSender() , amount.sub(_fee));
        _mint(_devWallet , _fee);
    }
     ...
     function withdraw(uint256 amount) public {
        ...
        uint256 _fee = calculateTokenFee(amount , fee);
        DAI.transfer(_msgSender(), amount.sub(_fee));
        DAI.transfer(_devWallet, _fee);
    }
    ...
    */
    function _transfer(
        ...
        uint256 amount
            ...
            // take the fee and send those tokens to dev address
    ...
    */
    function calculateTokenFee(
        ...
        locked = _amount.mul(_fee).div(100000000000000000000);
    }
