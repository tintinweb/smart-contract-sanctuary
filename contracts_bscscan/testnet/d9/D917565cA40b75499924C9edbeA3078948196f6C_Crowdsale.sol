...
contract Crowdsale {
    ...
    uint public publicTokensBought; // Used internally.
    uint public publicEthInvested; // Total ETH invested so far for a public presale. Compared against hard/softcap
    uint public softCap;
    uint public hardCap;
    uint public publicReserveRate; //In bips, amount of Ether to reserve from the public sale. Not used in this instance.
