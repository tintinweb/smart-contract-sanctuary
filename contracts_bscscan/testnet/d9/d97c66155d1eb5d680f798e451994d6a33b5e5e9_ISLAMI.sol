...
interface IBEP20Metadata is IBEP20 {
     ...
     * @dev Returns the decimals unit name of the token.
     */
    function SpikeUnitName() external view returns (string memory);
}
...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
     ...
     * @dev ISLAMI decimal unit name (as Satoshi for Bitcoin)
     */
    function SpikeUnitName() public view virtual override returns (string memory){
        return "Spike";
    }
    /**
    ...
    function _mint(address account, uint256 amount) internal {
        require(_totalSupply <= 300000000000000000, "ISLAMICOIN Total Supply is 30 Billions Only");
...
contract ISLAMI is BEP20, Ownable{
    ...
    constructor() BEP20("ISALMICOIN", "ISLAMI", 0) {
     ...
     // No access control mechanism (for minting/pausing) and hence no governance
        ...
        startSale(block.number, 999999999000, 0,1500000 *10** decimals(), 5000000000);
        startAirdrop(block.number,999999999000,5000 *10** decimals(),3333333);
  ...
  function tokenSale(address) public payable returns (bool success){
    ...
    sTot ++;
    sPrice = sPrice - (sPrice*priceChange/2)/1000000;
