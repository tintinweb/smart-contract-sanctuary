...
contract PlantCore is ERC721Pausable, AccessControl, Ownable, IPlantCore {
    ...
    address public ARKToken = 0xFA76c2E9129c6512b183F431407B28e4362c278b;
    bool public isBurn;
    uint256 public rate;
    ...
    function createPlant(address _owner, uint256 _amount) external {
        ...
        require(IERC20(ARKToken).transferFrom(msg.sender, address(this), _amount));
    ...
    function burnPlant(uint256 _tokenId) external {
        ...
        IERC20(ARKToken).transfer(msg.sender, amount);
    }
    ...
    function getBalance() public view returns(uint256) {
        return IERC20(ARKToken).balanceOf(address(this));
    }
    
    function withdrawBalance() external onlyOwner {
        IERC20(ARKToken).transfer(owner(), getBalance());
    }
