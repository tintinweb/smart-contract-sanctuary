...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**18); // 1 FLOKI minimum auto send
...
contract DogesCoin is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Doges Coin";
    string constant _symbol = "DOGESC";
