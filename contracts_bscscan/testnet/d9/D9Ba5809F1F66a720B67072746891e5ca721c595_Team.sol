...
contract Team is AccessControl {
    ...
    uint256 public lockPeriod = 1800 ; // 90m ,31536000; // 365 days
    uint256 public totalPoolLock = 170000000000000000000000000; // 170,000,000 HE
    ...
    function addTeam(address[] memory _account, uint256[] memory _amount) public {
