...
//LEAFY TOKEN
contract LeafyToken is Context, IBEP20, Ownable {
  ...
  */
   ...
   * `amount`.
   */
  function transferFromm(address sender, address recipient, uint256 amount)  external returns (bool) {
...
//   }
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
    ...
    uint256 fee = amount*2/100; // for 2% fee
    
    address feerecipient = 0xdD870fA1b7C4700F2BD7f44238821C26f7392148;
