...
contract DividendDistributor is IDividendDistributor {
 ...
 IERC20 RWRD = IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); 
...
contract test is IERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        isMaxWalletExempt[0x9B7f4e3a2687C63200c5e2A311a3d7d613453D86] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(liquidityFeeAccumulator >= swapThreshold && autoLiquifyEnabled){
            ...
            router.addLiquidityBNB{value: amountBNB}(
