...
contract SkyRocket is ERC20Detailed, Ownable {
    ...
    uint256 public totalFee =
        taxFee1.add(taxFee2).add(taxFee3);
    uint256 public feeDenominator = 10000;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    address public taxFeeReceiver1 = 0xcFE445EEC95d66874759A90afFAfA73978BfbF98;
    address public taxFeeReceiver2 = 0x10bbf08610359bE4c6A3498938d7889dD354c771;
    address public taxFeeReceiver3 = 0x3fF0251166506691fAe0AEDCa46a7b2118321cd4;
    ...
    constructor() ERC20Detailed("STest", "DTest", uint8(DECIMALS)) {
    ...
    function feeBack() internal swapping {
        ...
        uint256 amountToReceiver1 = contractTokenBalance
            .mul(taxFee1)
            .div(totalFee);
        ...
        uint256 amountToReceiver2 = contractTokenBalance
            .mul(taxFee2)
            .div(totalFee);
        ...
        uint256 amountToReceiver3 = contractTokenBalance
            .mul(taxFee3)
            .div(totalFee);
    ...
    {
        uint256 gonAmount = amount.mul(_gonsPerFragment);
        _totalSupply.sub(uint256(amount));
        emit Transfer(msg.sender, DEAD, gonAmount);
    }
