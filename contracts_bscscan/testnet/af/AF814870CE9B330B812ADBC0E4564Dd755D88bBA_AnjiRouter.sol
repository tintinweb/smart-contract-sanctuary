...
contract AnjiRouter is IPancakeRouter02 {
    ...
    function swapTokensForExactTokens(
        ...
        uint fee = amounts[0].mul(anjiFeeAmount)/10000;
        TransferHelper.safeTransferFrom(
            path[0], msg.sender, PancakeLibrary.pairFor(factory, path[0], path[1]), amounts[0].sub(fee)
        );
        TransferHelper.safeTransferFrom(path[0], msg.sender, anjiFeeAddress, fee);
        _swap(amounts, path, to);
    }
