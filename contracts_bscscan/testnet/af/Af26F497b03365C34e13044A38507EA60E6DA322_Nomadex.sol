...
/**
    * Nomadex is a utility BSC project aimed at connecting holders to travel amenities; 
    * accommodations, camping spots, and beyond! Our aim is to help "Nomads" 
    * live a truly decentralized life- unburdened by traditional banking and currency systems.
    * A portion of the transaction fees will be donated to charity as 
    * well as go towards funding development to ensure project longevity.
    *
    * Telegram: https://t.me/Nomadextoken
    * Twitter: https://twitter.com/Nomadex
    * Website: https://nomadex-token.com
    * Discord: https://discord.gg/bbykZcuJ
    * Medium: https://nomadextoken.medium.com/
    */
...
contract Nomadex is Context, IERC20, Ownable {
    ...
    string private _name = "Nomadex";
    string private _symbol = "NMDX";
