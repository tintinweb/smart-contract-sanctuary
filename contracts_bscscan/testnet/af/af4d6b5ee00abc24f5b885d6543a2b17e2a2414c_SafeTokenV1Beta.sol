...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SAFECAT";
    string internal constant SYMBOL = "SCAT";
    ...
    function _addFees() private {
         ...
         */ 
        _addFee(FeeType.Rfi, 40, address(this) ); //reflection or distribution between holders
