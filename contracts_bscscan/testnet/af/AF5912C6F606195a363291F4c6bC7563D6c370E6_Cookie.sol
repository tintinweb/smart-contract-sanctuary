...
CookieToken is built upon the basicsof Buyback and increasing the investor's value wth a total of 9% tax
    
Main features are
    
1) 2% tax is collected and distributed to holders for HODLing
2) 7% buyback and marketing tax is collected and 1% of it is sent for marketing fund and othe 6% is used to buyback the tokens
