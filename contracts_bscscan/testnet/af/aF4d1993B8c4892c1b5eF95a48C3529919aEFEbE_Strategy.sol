...
import "./cake/FeeManagerCake.sol";
import "./cake/StratManagerCake.sol";



contract Strategy is StratManagerCake, FeeManagerCake {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wrapped = address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); //addresse du wbnb
    
    // Third party contracts
    address public want ; //addresse du cake
    ...
    function setVaultAddress(address _newAddress) public onlyOwner {
        vault = _newAddress;
    }

    function setMasterChefAddress(address _newAddress) public onlyOwner {
        masterchef = _newAddress;
    }
