...
contract GymVaultsBank is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    address public constant buyBack = 0xc6e7DF5E7b4f2A278906862b61205850344D4e7d;
    address public farming;
    // contracts[7] - RelationShip address
    address public constant relationship = 0x3Aa5ebB10DC797CAC828524e59A333d0A371443c;
    ...
    function deposit(
        ...
        PoolInfo storage pool = poolInfo[_pid];
        if (address(pool.want) == 0xa513E6E4b8f2a923D98304ec87F64353C4D5C853) {
            // If `want` is WBNB
