...
contract REEE is Context, IBEP20, Ownable {
     ...
     function _transfer(
        ...
        if (
            ...
            recipient != pcsV2Pair
                        ...
                        if(sender != owner() && recipient != pcsV2Pair && block.number == launchedAt){
                boughtEarly[recipient] = true;
                emit BoughtEarly(recipient);
            }
            
                       if(boughtEarly[sender]  && earlyBuyPenaltyEnd <= block.number){
