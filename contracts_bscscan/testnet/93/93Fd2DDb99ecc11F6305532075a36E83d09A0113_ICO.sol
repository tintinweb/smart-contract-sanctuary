...
contract ICO is Ownable {
    ...
    // So, if you are using a rate of 1 token with 3 decimals called TOK
     ...
     * @param _crowdsaleRate Number of token units a buyer gets per wei
     * @dev The rate is the conversion between wei and the smallest and indivisible
     * token unit. So, if you are using a rate of token
    ...
    function buyTokens(address _referrer) public payable {
        ...
        uint256 tokens = weiAmount * crowdsaleRate;
