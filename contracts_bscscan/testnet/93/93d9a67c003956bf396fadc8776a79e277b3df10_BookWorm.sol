...
TESTNET
GUIDE - NO DXSALE!!!
WEBSITE - double check it;s corretc and see if live!

guide

add set_as_pair to uniswapv2
add uniswapv2 to whitelist
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && !_isPair[to] && !_isPair[from] && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        }
