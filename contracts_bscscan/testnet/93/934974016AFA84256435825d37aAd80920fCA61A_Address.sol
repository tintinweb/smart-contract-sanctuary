...
contract DividendDistributor is IDividendDistributor {
    ...
    // Reward in WETH
    address WETH = 0xE3a0db5113ba6C3B5EfF7F19C5A43e5319b693EB; //mainnet 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47
    ...
    constructor (address _router) {
        ...
        : IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //   main router 0x10ED43C718714eb63d5aA57B78B54704E256024E
        _token = msg.sender;
    }
