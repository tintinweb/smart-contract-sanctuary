...
interface IERC721 {
    ...
    function ViewCardInfo(uint _cardId) external view  returns(uint, address, uint, uint, uint, bool, bool);
}
...
contract RPSController{
    ...
    function getCardInfo(uint256 _cardId) public view returns(uint NFTId, address Owner, uint Energy, uint Replication_Limit, uint Replicated_Count, bool Activated, bool ForSale) {
