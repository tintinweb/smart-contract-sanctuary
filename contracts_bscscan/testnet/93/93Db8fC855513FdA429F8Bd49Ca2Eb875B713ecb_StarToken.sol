...
// StarToken with Governance.
contract StarToken is BEP20('Yield Star', 'STAR') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "STAR::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "STAR::delegateBySig: invalid nonce");
        require(now <= expiry, "STAR::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "STAR::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "STAR::_writeCheckpoint: block number exceeds 32 bits");
