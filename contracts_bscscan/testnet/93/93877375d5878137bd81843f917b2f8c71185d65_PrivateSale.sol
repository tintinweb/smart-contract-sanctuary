...
contract PrivateSale is ReentrancyGuard, Context, Ownable{
    ...
    IERC20 private _token = IERC20(0x36479B6d61961ba7100B7F50DBCC8D979Fdb984d); 
    ...
    uint public maxEntries = 150;
    
    uint public minContribution = 1 ether;
    uint public maxContribution = 3 ether;
    
    uint startDate = 1634303403; // 2nd October @ 5PM UTC
    ...
    uint public bnbRate = 8600000; // 8,600,000 MILKY per BNB
