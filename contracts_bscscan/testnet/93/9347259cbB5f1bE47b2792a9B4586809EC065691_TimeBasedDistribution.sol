...
contract TimeBasedDistribution is Ownable, ReentrancyGuard {
  ...
  uint256 public jackpotDistributionTimes;
  ...
  function addMember(address _memberAddress, uint256 _allocation) external onlyOwner {
    ...
    Member memory member = Member({ allocation: _allocation, lockedAmount: 0, releaseAmountPerPeriod: 0 , effectiveJackpotBlock: block.number });
