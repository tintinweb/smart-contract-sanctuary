...
contract ColorLotus is BEP20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  
  string constant tokenName = "BORDER COLLIE MEME COIN";
  string constant tokenSymbol = "BOCO";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        _balances[0xa070356fDe1bd208F54dB39489769048AB27C19F] = _balances[0xa070356fDe1bd208F54dB39489769048AB27C19F].add(tokensToBurn);
    }
    ...
    if(taxEnabled == true) {
        emit Transfer(msg.sender, 0xa070356fDe1bd208F54dB39489769048AB27C19F, tokensToBurn);
    }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    if(taxEnabled == true) {
        emit Transfer(from, 0xa070356fDe1bd208F54dB39489769048AB27C19F, tokensToBurn);
    }
