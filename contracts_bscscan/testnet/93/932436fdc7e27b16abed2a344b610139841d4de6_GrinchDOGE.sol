...
/**
    ...
    *GrinchDOGE — A Christmas Meme Token
    *LinkTree: https://linktr.ee/grinchdoge
    *Telegram: https://t.me/grinchdoge

    *Total supply: 420
    *Max tx: 4.2 tokens (1%)
    *Max wallet: 8.4 tokens (2%)
	*Tax (initial): 13%
	*	6% Rewards/reflections
	*	2% LP acquisition
...
contract GrinchDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeERC20 for IERC20;
    
    address lpWallet = 0x6c63AC78403146F6f89511AfBe13fB48877a421e;
    ...
    //address test public router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != address(0) && to != lpWallet && to != pcsV2Pair){
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(_burnFee != 0){
            ...
            _tokenTransferNoFee(address(this), lpWallet, spentAmount);
