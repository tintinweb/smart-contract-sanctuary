...
contract Uzma is Context, IERC20, Ownable {
    ...
    string private _name = "Uzma";      //CHANGE_REQUIRED: name of token
    string private _symbol = "UZMA";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
