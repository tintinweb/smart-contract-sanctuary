 ...
 * @notice Buffer BNB Options Contract
 */
contract BufferBNBPredictions is BaseBufferBNBOptions
{
    bytes32 public constant PREDICTION_EXERCISER =
        keccak256("PREDICTION_EXERCISER");
    mapping(uint256 => uint256) public predictions;
    ...
    constructor(
        ...
        IBufferStakingBNB staking,
        BufferBNBPool _pool
    ) BaseBufferBNBOptions(pp, staking, _pool, "Buffer Prediction", "pBFR") {
        ...
        returns (uint256 optionID)
    {
        ...
        uint256 amount = (msg.value * 1e18) / totalFee ;
        ...
        predictions[optionID] = expectedChange;
