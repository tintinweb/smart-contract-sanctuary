...
contract Horus is ERC721, Ownable, Pausable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    mapping(string => uint8) hashes;

    constructor() public ERC721("Horus", "HOR") {}

    function approve(address to, uint256 tokenId) public override whenNotPaused {
        super.approve(to, tokenId);
    }

    function awardItem(address recipient, string memory hash, string memory metadata ) public onlyOwner whenNotPaused returns (uint256) {
    ...
    function _pause() internal virtual override onlyOwner whenNotPaused {
        super._pause();
    }

    function _unpause() internal virtual override onlyOwner whenPaused {
        super._unpause();
    }
}