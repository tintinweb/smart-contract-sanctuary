...
contract Ninneko is Initializable, ERC721Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    modifier validateBreed(uint256 _pet1Id, uint256 _pet2Id) {
        ...
        require(block.timestamp >= adulthoodTime + uint256(pets[_pet1Id].birthTime), "pet1 can't breed yet");
        require(block.timestamp >= adulthoodTime + uint256(pets[_pet2Id].birthTime), "pet2 can't breed yet");
