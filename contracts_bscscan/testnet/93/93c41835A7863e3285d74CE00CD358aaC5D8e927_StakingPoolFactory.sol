...
contract StakingPoolFactory is PoolCreator {
    ...
    function create(
        ...
        uint256[10] memory variables = [_variables[0], _variables[1], _variables[2], _variables[3], _variables[4], _variables[5], _variables[6], _variables[7], _variables[8], _variables[9]];
        ...
        address newPool = createPool( _oracleContract, _wrappedTokenContract, _wrappedTokenSymbole, _poolType, variables, isEnhancedEnabled);
