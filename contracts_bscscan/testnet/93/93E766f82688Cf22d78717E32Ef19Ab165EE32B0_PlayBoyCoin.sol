...
contract PlayBoyCoin is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "PlayBoyCoin";
    string private _symbol = "PBC";
    uint8 private _decimals = 9;

    IPancakeRouter02 public immutable pancakeRouter;
    address public immutable pancakePair;
    address public dao = 0x059C28941ce57B0b588C472412DDc1904A0c94Cd;
    address public saleAddress = 0x059C28941ce57B0b588C472412DDc1904A0c94Cd;
    uint256 public daoFee = 1;

    address public blackholeAddress = 0xaD38eAf681701fb9F98515c463502cbf5Afd2676;
    ...
    constructor (
        ...
        _rOwned[_msgSender()] = _rTotal.div(100).mul(5);    // 5% for presale
        _rOwned[blackholeAddress] = _rTotal.div(100).mul(50);   // 50% to blackhole
        _rOwned[address(0xA3EB0428a59acdbe2A5829c3c9E84BeFF49bA19B)] = _rTotal.div(100).mul(4); // 12% for team wallet(4% per wallet)
        _rOwned[address(0x0ee1bd464954018186DF12dDF74d41A07d78b999)] = _rTotal.div(100).mul(4);
        _rOwned[address(0x059C28941ce57B0b588C472412DDc1904A0c94Cd)] = _rTotal.div(100).mul(4);
        _rOwned[saleAddress] = _rTotal.div(100).mul(33);    // 33% for sale
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        _tOwned[dao] = _tOwned[dao].add(amount.mul(daoFee).div(100));
        _tOwned[sender] = _tOwned[sender].sub(amount.mul(daoFee).div(100));
    ...
    uint256 public rewardCycleBlock = 1 minutes;
    uint256 public easyRewardCycleBlock = 1 days;
    uint256 public threshHoldTopUpRate = 4;
    uint256 public _maxTxAmount = 10000000000 * 10 ** 9;
    uint256 public disruptiveCoverageFee = 4 ether;
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own PBC to claim reward');
