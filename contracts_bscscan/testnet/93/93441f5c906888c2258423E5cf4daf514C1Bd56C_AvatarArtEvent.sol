...
contract AvatarArtEvent is ReentrancyGuard, Runnable {
     modifier onlyAdmin{
    ...
    constructor(
        ...
        _nftTypeLimitAmounts[1] = 3;
        _nftTypeLimitAmounts[2] = 2;
    }
        ...
        whenRunning
    {
        ...
        require(_userClaimedNfts[_msgSender()][nftType] < _nftTypeLimitAmounts[nftType], "Reach limit nft type amount");
