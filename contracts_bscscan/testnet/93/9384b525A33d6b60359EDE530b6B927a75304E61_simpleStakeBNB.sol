...
contract simpleStakeBNB {
        ...
        function checkContract(string memory _tokenAddr) public view returns(  IERC20 stakeTokenAddr, IERC20 rewardTokenAddr, uint256 stakeTokenBalance  , uint256 rewardTokenBalance  , uint256 prize , uint256 cap ){
        ...
        function checkContract2(string memory _tokenAddr) public view returns( address contractAddress, IERC20 stakeTokenAddr, IERC20 rewardTokenAddr, uint256 totalStaker , uint256 totalStaked){
