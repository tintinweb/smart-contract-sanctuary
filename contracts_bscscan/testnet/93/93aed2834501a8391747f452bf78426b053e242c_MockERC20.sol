...
contract MockERC20 is Context, IBEP20, Ownable {
  ...
  constructor(string memory _name_, string memory _symbol_, uint256 _totalSupply_) public {
    // _name = "BUSD Token";
    // _symbol = "BUSD";
    _name = _name_;
    _symbol = _symbol_;
  ...
  */
   ...
   * - `msg.sender` must be the token owner
   */
  function mint1M() public returns (bool) {
