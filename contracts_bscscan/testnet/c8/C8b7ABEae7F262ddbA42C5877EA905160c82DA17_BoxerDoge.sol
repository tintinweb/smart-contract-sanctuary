...
contract BoxerDoge is Context, IERC20, Ownable {
    ...
    address payable public ecosystemAddress = payable(0xc40a1f0517aD3CffF2578d51e8CD1BFe781Ee924);
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 0; // to prevent adding liquidity from private buyers before the presale
    }
