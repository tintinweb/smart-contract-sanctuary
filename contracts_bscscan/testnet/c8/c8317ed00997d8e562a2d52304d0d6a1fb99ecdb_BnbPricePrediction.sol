...
contract BnbPricePrediction is Ownable, Pausable {
    ...
    function executeRound() external onlyOperator whenNotPaused {
        ...
        //TODO: add distribute rewards
        _distributeRewards(currentEpoch - 2);
    ...
    function _getPlayerList(uint256 epoch) internal returns (address[] memory) {
