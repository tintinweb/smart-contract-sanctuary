...
contract LegacyNMACSale is Ownable  {
    ...
    function purchaseNMAC () public payable {
        ...
        Sales[msg.sender].balanceleft  += _amount;
    ...
    function receiveTokens() public  {
         ...
         require ( Sales[msg.sender].balanceleft > 0  , "No Balance left available" );
         
         
         Sales[msg.sender].numberofpaymentsreceived++;
         Sales[msg.sender].lastpaymentblocktime = block.timestamp + 300 seconds; // change to days
