...
contract Ownable is Context {
    ...
    constructor () {
        _owner = payable(0x501e3becfF381e257aacb4DB8BFBa42E6B860C92);
...
contract JokerCoin is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 100 *1e9 * 1e9;
    ...
    uint256 public antiSnipingTime; // can be set only once 
    ...
    uint256 public minBuy = 0.00003 ether; // minimum buy is 0.03 Bnb by default can be change later
    uint256 buyBackLowerLimit = 0.5 ether;
    uint256 buyBackUpperLimit = 2 ether;

    //lottery pools calculations
    uint256 public pool1Count;
    uint256 public pool2Count;
    uint256 public pool3Count;
    uint256 public pool4Count;
    uint256 public pool5Count;
    uint256 public pool1Amount;
    uint256 public pool2Amount;
    uint256 public pool3Amount;
    uint256 public pool4Amount;
    uint256 public pool5Amount;
    uint256 public pool1Lottery = 2;
    uint256 public pool2Lottery = 5;
    uint256 public pool3Lottery = 7;
    uint256 public pool4Lottery = 9;
    uint256 public pool5Lottery = 11;
    ...
    function checkLotteryFeePercent(uint256 lotteryFee) external onlyOwner {
    ...
    function checkLottery(address user, uint256 amount) internal{
        ...
        pool1Amount = pool1Amount.add(amount.mul(3).div(100));
        pool2Amount = pool2Amount.add(amount.mul(1).div(100));
        pool3Amount = pool3Amount.add(amount.mul(1).div(100));
        pool4Amount = pool4Amount.add(amount.mul(1).div(100));
        pool5Amount = pool5Amount.add(amount.mul(1).div(100));
