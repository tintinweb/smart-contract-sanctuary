...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TXC = IBEP20(0xC380Fa4b673b267b6626EF177CEA421F9e704Ed0);
...
contract NewTOXICGAMENFT is IBEP20, Auth {
    using SafeMath for uint256;

    address TXC = 0xC380Fa4b673b267b6626EF177CEA421F9e704Ed0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NewToxicGameNFT";
    ...
    uint256 public swapThreshold = _totalSupply / 2; // 50%
    bool inSwap;
