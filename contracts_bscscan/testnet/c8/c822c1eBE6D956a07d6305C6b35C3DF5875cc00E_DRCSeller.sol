...
contract DRCSeller is Context, ReentrancyGuard, Ownable {
    ...
    bool private _end;
    AggregatorV3Interface BUSDBNB = AggregatorV3Interface(0x0630521aC362bc7A19a4eE44b57cE72Ea34AD01c);
    IERC20 BUSD = IERC20(0xE0dFffc2E01A7f051069649aD4eb3F518430B6a4);
   ...
   function tokensSold() public view returns (uint256) {
    ...
    function buyDRCwithBNB() public nonReentrant payable {
        address beneficiary = _msgSender();
        uint256 amount = msg.value;
        require(amount != 0, "Amount is 0");
        uint256 BNBPrice = uint(BUSDBNB.latestAnswer());
        uint256 tokenAmount = _getTokenAmount(amount.div(BNBPrice));
    ...
    function buyDRCwithBUSD() public nonReentrant payable {
        address beneficiary = _msgSender();
        uint256 amount = BUSD.allowance(beneficiary, address(this));
    ...
    function _getTokenAmount(uint256 amount) internal view returns (uint) {
        return amount.mul(_rate).mul(10**9);
    }
