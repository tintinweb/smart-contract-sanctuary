...
contract Presale{
    ...
    uint256 round2 = 3 days;
       uint256 round3 = 5 days;
...
address owner;
    ...
    function presaleSet() public{
        if(msg.sender==owner){
        presSaleStart=block.timestamp;
        }
       
    }
    function deposit() public payable    {
         require(presSaleStart>0 , "Presale Not start");
        ...
        else if(block.timestamp>presSaleStart+round1Days+gapDays&&block.timestamp<=presSaleStart+round1Days+gapDays+round2){
        ...
        else if(block.timestamp>presSaleStart+round1Days+gapDays+round2+gapDays&&block.timestamp<=presSaleStart+round1Days+gapDays+round2+gapDays+round3){
