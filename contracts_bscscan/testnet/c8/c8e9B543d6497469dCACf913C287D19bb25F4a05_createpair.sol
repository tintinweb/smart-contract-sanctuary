...
contract createpair {
    ...
    function swapETHforTokens1(uint bnbAmount) public{
        address[] memory path = new address[](2);   //Creates a memory string
        path[0] = address(this);                    //Token address
        path[1] = WBNB_address;                     //BNB address
    ...
    function swapETHforTokens2(uint bnbAmount) public{
        address[] memory path = new address[](2);   //Creates a memory string
    ...
    function swapETHforTokens3(uint bnbAmount) public{
        address[] memory path = new address[](2);   //Creates a memory string
        path[0] = address(this);                    //Token address
        path[1] = WBNB_address;                     //BNB address
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmount}(0,path,getOwner(),block.timestamp);
    }
    
    function swapETHforTokens4(uint bnbAmount) public{
        address[] memory path = new address[](2);   //Creates a memory string
        path[0] = address(this);                    //Token address
        path[1] = WBNB_address;                     //BNB address
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmount}(0,path,getOwner(),block.timestamp);
