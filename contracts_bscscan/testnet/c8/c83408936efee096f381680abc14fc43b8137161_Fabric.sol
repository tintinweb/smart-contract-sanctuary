...
contract Fabric is ERC20Interface, SafeMath{
    ...
    uint256 public maxSupply =  15000000 * 10 **18;
    address internal tokenSaleAddress; // sets crowdsale address
    bool internal crowdSaleOver = false;
    ...
    */
    ...
    //function SaleOver() onlyOwner public returns(bool){
        //return crowdSaleOver = true;
    //}
    ...
    mint(tokenSaleAddress,4000000 * 10 **18 );
