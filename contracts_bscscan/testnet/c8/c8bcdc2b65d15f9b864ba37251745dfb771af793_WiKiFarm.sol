...
contract WiKiFarm is Ownable {
    ...
    function exitFarm(uint256 _farmId, uint256 _orderIndex) public returns (bool) {
        ...
        if(_farmId==1){
            ...
            twoFarmAccountOrders[msg.sender][_orderIndex].withdrawalTime = oneFarmAccountOrders[msg.sender][_orderIndex].exitTime;
            ...
            twoFarmAccountOrders[msg.sender][_orderIndex].withdrawalTime = twoFarmAccountOrders[msg.sender][_orderIndex].exitTime;
