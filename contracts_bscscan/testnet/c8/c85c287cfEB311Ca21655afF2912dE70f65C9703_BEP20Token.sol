...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  address public _fundWallet = 0xF7121EB5b436543555A6f26d900548988e1Ec1f1;
  address private _previousFundWallet = _fundWallet;

  //taxfee beetween 0 and 500 to get 2 decimals (5=0.05% // 500=5%)
  ...
  */
  ...
  function _getFundWallet() external view returns(address) {
      return _fundWallet;
  }

  function _getPreviousFundWallet() external view returns(address) {
      return _previousFundWallet;
  }

  function _setFundWallet(address fundWallet) external onlyOwner() {
