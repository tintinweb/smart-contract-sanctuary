...
contract TokenDeployer{
    ...
    function createToken (
      ...
      uint256 totalSupply
        ...
        IBEP20 newToken = new DeflationaryToken(payable(owner), name, symbol, decimals, totalSupply);
        getUserToken[owner][++getUserTokenCount[owner]] = address(newToken);
