...
/**
 * 
Solana Max De-Fi Launch-Pad Platform

Solana Max aim to be the leaders in Launch-Pad Technology in the De-fi World.

Crypto enthusiasts – get early access to some of the most promising crypto and De-Fi projects. If you have a crypto business, launch your project into the world with Solana Max.
...
contract SOLMAX is Context, IERC20, Ownable {
