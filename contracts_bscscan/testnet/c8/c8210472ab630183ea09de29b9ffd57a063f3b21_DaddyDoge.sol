...
contract DaddyDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * (10 ** uint256(decimals())) * 10**9;
    ...
    uint256 public _maxTxAmount = 10000000 * (10 ** uint256(decimals())) * 10**9;

    // Liquify when 250 billion tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 250000 * (10 ** uint256(decimals())) * 10**9;
