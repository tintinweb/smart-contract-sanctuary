...
contract Camo is Context, IERC20, Ownable, LockToken 
{
    ...
    uint256 public _maxSaleAmount = _tTotal.div(100).mul(1); //1%
    uint256 public _maxBuyAmount = _tTotal.div(100).mul(2); //2%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(100).mul(1000);
    uint256 public maxLimit = maxLimit = _tTotal.div(100).mul(2); //max allowed tokens in one wallet. 
