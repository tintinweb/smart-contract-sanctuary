...
// File: contracts/prettyshapes2.sol

pragma solidity ^0.8.0;



contract PrettyShapes2 is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("PrettyShapes2", "PS2")  {
        setBaseURI(baseURI);
    ...
    function mint(address _to, uint256 num) public payable {
        ...
        if(msg.sender != owner()) {
          ...
          require( num < (_maxMint+1),"You can only mint 20 PS2 at a time");
          require( msg.value >= _price * num,"BNB sent is not correct");
        }
