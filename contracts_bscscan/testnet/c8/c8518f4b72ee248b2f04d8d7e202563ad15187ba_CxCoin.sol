...
contract CxCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB83CF0D9F9f375A1a4E936927ce4E657623C7e47); // Marketing Address
    ...
    string private _name = "Ananas";
    string private _symbol = "AN";
