...
contract IrishShibaCoin is IBEP20, Ownable {
    ...
    uint public prizeFee = 2500;       // 25%
    uint public liquidityFee = 2500;   // 25%
    uint public coFounderFee = 2000;   // 25%

    function setFees(uint prizeFee_, uint liquidityFee_, uint coFounderFee_) public onlyCoFounder {
        prizeFee = prizeFee_;
