...
contract Grapenopoly
{
    ...
    mapping(uint256 => uint256) public nftState;
    ...
    function mint(string calldata _nftName, string calldata _nftDescription, string calldata _nftImageURI, uint256 _nftPrice) external returns (uint256 tokenId)
    {
    ...
    function bulkMint(string[] calldata _nftName, string[] calldata _nftDescription, string[] calldata _nftImageURI, uint256[] calldata _nftPrice) external
    {
        //Only contract owner is able to create properties
        require(msg.sender == owner, 'FN'); //Forbidden
