...
/**
 * BIGFISHToken Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract BfhStandardToken is BIGFISHToken, Ownable {
    
    using BFHMaths for uint256;
...
contract BIGFISH is BfhStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 1 * (10**11) * 10**18 ; // 1 Bllion tokens, 18 decimal places
    string constant public name = "BigFish"; //fancy name: eg BIGFISH
    string constant public symbol = "BFH"; //An identifier: eg BFH
