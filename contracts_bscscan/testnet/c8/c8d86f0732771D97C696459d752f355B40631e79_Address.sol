...
contract SelfAware is Context, IERC20, Ownable {
...
//  uint256 private _tTotal = 1000000000000000 * 10**_decimals;
    uint256 private _tTotal = 6789136869 * 10**_decimals;
    ...
    address public marketingAddress = 0x0E3A0C71547e0526653C0d87793A9307030267e7;
    address public operationsAddress = 0x5e3Bbd7C33fda4C2d780604b220EaA7753A194AA;
    address public constant deadAddress = 0x0000000000000000000000000000000000000010;

    string private constant _name = "SELF AWARE";
    string private constant _symbol = "SELF";
