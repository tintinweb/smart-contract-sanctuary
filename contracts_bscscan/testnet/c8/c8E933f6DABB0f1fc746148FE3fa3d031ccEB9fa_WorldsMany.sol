...
interface IHolderRewarderDistributor {
    ...
    function addSupply(uint256 bnbAmount, uint256 tSupply, uint256 mSupply) external;
...
contract HolderRewarderDistributor is IHolderRewarderDistributor {
  ...
  */
  ...
  function addSupply(uint256 bnbAmount, uint256 tSupply, uint256 mSupply) external onlyToken {
...
contract WorldsMany is IBEP20, Authorization {
  ...
  */
  ...
  function sendBUSDToRewards() internal {
    uint256 initialBalance = address(this).balance;
    ...
    uint256 newBalance = address(this).balance.sub(initialBalance);
    distributor.addSupply(newBalance, _tSupply, _mSupply);
    _tSupply = 0;
    _mSupply = 0;
  }
