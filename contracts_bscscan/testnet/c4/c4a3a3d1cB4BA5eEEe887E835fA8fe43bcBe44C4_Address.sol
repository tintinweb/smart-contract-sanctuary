...
/**
This is a test contract, tested from 0x344424e5d0b3037c78c698609cd56b36e7481951
...
contract YourMomToken is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = payable(0x4FDcFb8B319c2Df93B79756e2C44F82Af9777666);
    ...
    string private _name = "YourMomToken";
    string private _symbol = "URMOM";
    uint8 private _decimals = 9;
    
    uint256 public _charityFee = 50;    // 5%
    uint256 private _previousCharityFee = _charityFee;

    uint256 public _burnFee = 50;   // 5%
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _reflectionFee = 100;    // 10%
    uint256 private _previousReflectionFee = _reflectionFee;
    
    uint256 private _taxFee = _burnFee.add(_reflectionFee);
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _crctLiquidityFee = 50; // 5%, total fees: 25%
