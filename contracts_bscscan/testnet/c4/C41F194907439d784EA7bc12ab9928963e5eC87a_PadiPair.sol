...
// File: contracts/interfaces/IPadiERC20.sol
...
// File: contracts/interfaces/IPadiFactory.sol
...
// File: contracts/interfaces/IPadiCallee.sol

pragma solidity >=0.5.0;

interface IPadiCallee {
    function PadiCall(address sender, uint amount0, uint amount1, bytes calldata data) external;
}

// File: contracts/PadiPair.sol
...
contract PadiPair is IPadiPair, PadiERC20 {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        { // scope for _token{0,1}, avoids stack too deep errors
            ...
            if (data.length > 0) IPadiCallee(to).PadiCall(msg.sender, amount0Out, amount1Out, data);
            balance0 = IERC20(_token0).balanceOf(address(this));
            balance1 = IERC20(_token1).balanceOf(address(this));
        }
