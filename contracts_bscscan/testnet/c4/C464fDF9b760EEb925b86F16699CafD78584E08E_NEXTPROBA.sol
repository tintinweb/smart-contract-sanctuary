...
contract NEXTPROBA is ERC20, AccessControl, Pausable {
    ...
    // TOKEN
    string tokenName = "NEXT2";
    string tokenSymbol = "NEXT2";
       ...
       // uint256 taxSum;
        ...
        if(isBuy) {
            ...
            if(feeTokens > 0 && exchange == true) {
                ...
                transferTokens(address(this), devWallet_a, distributeFees * 10**18);
                transferTokens(address(this), devWallet_b, distributeFees * 10**18);
                transferTokens(address(this), devWallet_c, distributeFees * 10**18);
                transferTokens(address(this), devWallet_d, distributeFees * 10**18);
                transferTokens(address(this), devWallet_e, distributeFees * 10**18);
