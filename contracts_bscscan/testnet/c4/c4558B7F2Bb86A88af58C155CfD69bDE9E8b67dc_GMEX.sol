...
contract GMEX is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    struct amountsLiquidity{
        uint tokenAmount;
        uint ethAmount;
        uint liquidityFromUser;
    }
    
    mapping (address => amountsLiquidity) public userLiquidityAmounts;
    ...
    uint256 public lockTime = 172800;
    ...
    function _setLockTime(uint256 time) external {
        lockTime = time;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendBNBToCharity(portionForFees.mul(5).div(6));
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) public {
        ...
        // add the liquidity
        ( uint _tokenAmount,uint _ethAmount ,uint liquidity) = uniswapV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
        ...
        liquidityAddedTime[msg.sender] = block.timestamp;
        userLiquidityAmounts[msg.sender].tokenAmount = _tokenAmount;
        userLiquidityAmounts[msg.sender].ethAmount = _ethAmount;
        userLiquidityAmounts[msg.sender].liquidityFromUser = liquidity;
    }
    
    function removeLiquidity(uint256 _liquidity) public {
        require(userLiquidityAmounts[msg.sender].liquidityFromUser >= _liquidity, "You can not remove liquidity more than you provided!");
        require(liquidityAddedTime[msg.sender].add(lockTime) <block.timestamp, "The assets are locked for 48 hours!");
