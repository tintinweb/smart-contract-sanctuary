...
contract NFTStorePokerFI is ReentrancyGuard, Ownable {
  ...
  mapping(uint256 => MarketItem) private idToMarketItem;
    ...
    /* Initial Holders */
  address payable public _walletComis1;  /*ADM*/
  address payable public _walletComis3;  /*DEV*/
  ...
  function setupWallets (address payable dist3 ,address payable dist4 ) public onlyOwner() {
   require( _owner == msg.sender,"security guaranteed administrator only");
    _walletComis1 = dist3;
    _walletComis3 = dist4;
  }
  ...
  function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant {
    ...
    if (idToMarketItem[itemId].behavior == 0) {
       ...
       _walletComis1.transfer(tax15);
       commis2.transfer(tax15);
       _walletComis3.transfer(tax1);
  ...
  /*taxa situacao 1%*/ 
    ...
    uint256 tax2;
       ...
       /*BNBTransfers*/  
       //idToMarketItem[itemId].seller.transfer(amount); 
       _walletComis1.transfer(amount); 
       _walletComis1.transfer(tax1);
       commis2.transfer(tax1);
       _walletComis3.transfer(tax2);
