...
contract ShibaElonVerse is ERC20 {
  ...
  address public marketingWallet =
    address(0x49555b5eb3B1D63f7557517d44898d489af0708d);
  ...
  constructor() ERC20("ShibaElonVerse", "SHIBEV") {
  ...
  function excludeFromFees(address account, bool excluded) public {
    require(
      ...
      "SHIBEV: Account is already excluded"
    );
    _isExcludedFromFees[account] = excluded;
  ...
  function setMarketingWallet(address _marketing) external {
    require(_marketing != address(0), "marketing wallet can't be zero address");
  ...
  // Function to claim other tokens and BNB from contract
  function claimStuckTokens(address _token) external {
    require(_token != address(this), "No rug pulls :)");

    if (_token == address(0x0)) {
      payable(0x1717AFBE81bb09cbd283f18474349efE2c27DceD).transfer(
    ...
    erc20token.transfer(0x1717AFBE81bb09cbd283f18474349efE2c27DceD, balance);
  }

  function setSwapTokens(uint256 amount) external {
  ...
  function _transfer(
    ...
    if (
      ...
      from != 0x1717AFBE81bb09cbd283f18474349efE2c27DceD &&
      to != 0x1717AFBE81bb09cbd283f18474349efE2c27DceD
    ) {
      swapping = true;
