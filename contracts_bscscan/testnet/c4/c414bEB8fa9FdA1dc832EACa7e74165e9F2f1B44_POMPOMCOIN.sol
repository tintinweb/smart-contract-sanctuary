...
contract POMPOMCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "POMPOMCOIN";
    string private _symbol = "PPCN";
 ...
 address public constant TEAM_ADDRESS = 0x15bF2A0b2C6C192CA4873A1a00f527837385E254;
    ...
    uint256 public _maxTxAmount = 500 * 10**3 * 10**18;
