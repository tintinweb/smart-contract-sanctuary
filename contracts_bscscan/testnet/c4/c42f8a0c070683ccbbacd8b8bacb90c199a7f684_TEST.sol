...
contract TEST is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Tokens = payable(0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0);  ///XXXXXX need to be ablee to change this! 
    ...
    */
    ...
    function _set_Fee_Distribution_Percent__Total_100(uint256 Marketing, uint256 Auto_Liquidity, uint256 Token_Wallet, uint256 Auto_Burn) external onlyOwner() {

        require((Marketing + Auto_Liquidity + Token_Wallet + Auto_Burn) == 100, "Must add up to 100!");
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0 && Percent_Marketing != 0){
            ...
            // Calculate how many tokens need to be swapped for BNB (Marketing BNB and 1/2 Auto Liquidity)
            ...
            // Send BNB to marketing wallet - Check again incase some is added during calculations
            ...
            // Swap tokens for BNB and send to Marketing Wallet if Auto LP is 0
            ...
            // Create the Auto LP if Marketing is 0
