...
contract Contract is IERC20, Ownable {
    ...
    constructor(
        ...
        (, bytes memory data) = router.factory().call(abi.encodeWithSignature('createPair(address,address)', address(this), router.WETH()));

        uniswapV2Pair = abi.decode(data, (address));
