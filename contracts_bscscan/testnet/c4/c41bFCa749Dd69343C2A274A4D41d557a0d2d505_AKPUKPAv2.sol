...
contract AKPUKPAv2 is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    address payable public charityAddress = 0x993431ED64Fe392E7B048f3181CC02F056d2613E;
    ...
    function charitySlice() public view returns (address) {
    ...
    uint256 public _liquidityFee = 8; // 3% will be added pool, 4% will be converted to BNB, 3% will be added into GhostFace BNB
