...
contract ArkarusMysteriousBox is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() public ERC721("ArkarusMysteriousBox", "AKSMB") {}

    uint8 constant SURPRISE_BOX  = 1;
    uint8 constant MYSTERIOUSCONTAINER_BOX  = 2;
    uint8 constant BATTALIONCARGO_BOX  = 3;
    ...
    event BurnOpenGacha(address indexed _from, uint8 boxType);
    ...
    function setGachaBoxPool(uint _roundId, uint256 _maxPerTime, uint256 _maxMysteriousContainerBox, uint256 _maxMysteriousCargoBox, uint256 _maxBattalionPackBox) external onlyOwner 
    {
        ...
        gachaLimit[_roundId][SURPRISE_BOX ] = _maxMysteriousContainerBox;
        gachaLimit[_roundId][MYSTERIOUSCONTAINER_BOX ] = _maxMysteriousCargoBox;
        gachaLimit[_roundId][BATTALIONCARGO_BOX ] = _maxBattalionPackBox;
    }
    ...
    {
        maxGachaBoxPerAccount[_roundId][SURPRISE_BOX ] = _maxMysteriousContainerBox;
        maxGachaBoxPerAccount[_roundId][MYSTERIOUSCONTAINER_BOX ] = _maxMysteriousCargoBox;
        maxGachaBoxPerAccount[_roundId][BATTALIONCARGO_BOX ] = _maxBattalionPackBox;
    }
    ...
    {
        priceGachaBox[SURPRISE_BOX ] = _priceMysteriousContainerBox * 10 ** 18;
        priceGachaBox[MYSTERIOUSCONTAINER_BOX ] = _priceMysteriousCargoBox * 10 ** 18;
        priceGachaBox[BATTALIONCARGO_BOX ] = _priceBattalionPackBox * 10 ** 18;
    }
    ...
    function privateGachaBox(uint8 _boxType, uint _amount) external
    {
        ...
        require(timeNow() <= roundsEndTime[ROUND_1], "Private sale has been closed.");
        require(accountRoundId[msg.sender] == ROUND_1, "The account is not whitelist.");
    ...
    function publicGachaBox(uint8 _boxType, uint _amount) external
    {
        ...
        require(timeNow() <= roundsEndTime[ROUND_2], "Public sale has been closed.");
    ...
    function burnOpenGacha(uint8 boxType) external
    {
        ...
        emit BurnOpenGacha(msg.sender, boxType);
    }
    ...
    function getAvailableGachaBox(uint _roundId) public view returns (uint256[] memory)
    {
        ...
        availableGachaBox[0] = gachaLimit[_roundId][SURPRISE_BOX ] - gachaCounter[_roundId][SURPRISE_BOX ];
        availableGachaBox[1] = gachaLimit[_roundId][MYSTERIOUSCONTAINER_BOX ] - gachaCounter[_roundId][MYSTERIOUSCONTAINER_BOX ];
        availableGachaBox[2] = gachaLimit[_roundId][BATTALIONCARGO_BOX ] - gachaCounter[_roundId][BATTALIONCARGO_BOX ];
