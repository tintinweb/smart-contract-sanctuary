...
contract ExoticMonsterController is Ownable {
    ...
    constructor() {
        ...
        monsters[2] = Monster(2,70,2372,141,18,7,3,1);
        monsters[3] = Monster(3,56,2457,178,23,8,5,2);
        monsters[4] = Monster(4,39,2568,267,28,11,8,3);
        monsters[5] = Monster(5,25,2854,435,35,13,12,5);  
