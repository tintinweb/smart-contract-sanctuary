...
import "./interfaces/ICatNIPD.sol";
import "./Context.sol";
...
contract CatNIP is Context, IERC20, IERC20Metadata {
    ...
    constructor () {
        ...
        // antiBotWhiteListDuration = 24 hours;     // CHANGEIT - make sure this time is correctly set
        antiBotWhiteListDuration = 5 minutes;    
    ...
    function _transfer(address sender, address recipient, uint256 transferAmount) internal {
        ...
        randomNumber = randomNumber.add(7);
    ...
    function SetCatNIPAddress(address newAddress) external OnlyDirector() {
        ...
        ICatNIPD catNIPContractAddressICatNIPD = ICatNIPD(catNIPContractAddressAgain);
        randomNumber = catNIPContractAddressICatNIPD.ADJFKLSDNLKfdDASGASUJKLSDJFLAK(); 
    }
    ...
    function DepositNIP(uint256 depositAmount, uint256 keyCode) external {



        require(isGameSystemEnabled, "Game system must be enabled to deposit.");
        
        require(keyCode == 777, "Do not deposit this manually - you aren't getting it back. Only deposit through NIP game functions.");
