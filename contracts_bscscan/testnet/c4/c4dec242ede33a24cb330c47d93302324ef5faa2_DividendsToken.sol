...
contract DividendsToken is IBEP20, Auth, TokensRescuer {
    ...
    address public autoLiquidityReceiver = 0x8b861Ace52284E41D2178971A9C374199D25C3c8;
    address public marketingFeeReceiver = 0xfa7208A16a2790C312172f69cfd0E592137f480D;
    address public developmentFeeReceiver = 0x575bDD11207D86ADb38106b141Df2b4bEb1424E8;
    ...
    constructor(
        ...
        address _marketingFee,
        address _developmentFee,
         address _autoLiquidity
        
    ) Auth(msg.sender) TokensRescuer(msg.sender) public {
        _name = _token_name;
        _symbol = _token_symbol;
        marketingFeeReceiver = _marketingFee;
        developmentFeeReceiver = _developmentFee;
        autoLiquidityReceiver = _autoLiquidity;
