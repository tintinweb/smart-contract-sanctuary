...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x6754d57337d4feC6041523864646ae54d998De5A;
...
contract Orfanotest3 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xE9210e2c1806126897ba2cC2962ce91fba308121;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Orfanotest3";
    string private _symbol = "ORF3";
