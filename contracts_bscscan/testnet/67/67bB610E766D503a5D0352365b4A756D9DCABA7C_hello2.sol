...
contract hello2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1dEB2cB275C89eE0Ea49830652EA087cD93f72A0); // Marketing Address
    ...
    string private _name = "hello2";
    string private _symbol = "hello2";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x1dEB2cB275C89eE0Ea49830652EA087cD93f72A0);
    }
