...
// Code:https://t.me/fairlaunchdegens
...
//Contract
contract FlokiFireSacrifice is IBEP20, Ownable {
    ...
    string private constant _name = 'Floki Fire Sacrifice';  
    string private constant _symbol = 'FFS';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 1000000000000 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=50; //2% = 20,000,000,000
    uint16 private constant SellLimitDivider=200; //0.5% = 5,000,000,000
