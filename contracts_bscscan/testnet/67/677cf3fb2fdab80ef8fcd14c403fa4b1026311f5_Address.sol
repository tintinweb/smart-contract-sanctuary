...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    uint256 public _devFee = 19;
    uint256 private _previousDevFee = _devFee;
    
    uint256 public _privateInvastorsFee = 11;
    uint256 private _previousPrivateInvestorsFee = _privateInvastorsFee;
    ...
    uint256 public _maxTxAmount = totalSupply().mul(5).div(1000);
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**6 * 10**9;
    uint256 public maxWalletAmount = totalSupply().mul(2).div(100);
    ...
    uint256 public lotteryThersholdAmount;
    ...
    function setPrivateInvestorsFeePercent(uint256 PrivateInvestorsFee) external onlyOwner() {
        _privateInvastorsFee = PrivateInvestorsFee;
    }
    ...
    {
        uint256 PrivateInvestorsPercentageInTotalTax = (_privateInvastorsFee.mul(100).div(_taxFee)).div(10);
    ...
    function SetLotteryThershold(uint256 amount) external onlyOwner
    {
        lotteryThersholdAmount = amount;
    }
    
    function lottery() public 
    {
        require(_balances[msg.sender] >= lotteryThersholdAmount, "STOP!!. You don't have enough tokens");
...
contract TEST is BEP20, BEP20Detailed {
  ...
  constructor () BEP20Detailed("TESTToken", "TEST", 9) {
      _owner = msg.sender;
    _totalSupply = 15000000000 * (10**9);
