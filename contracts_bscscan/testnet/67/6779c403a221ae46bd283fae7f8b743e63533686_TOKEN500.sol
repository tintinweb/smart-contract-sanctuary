...
contract TOKEN500 is IBEP20, Auth {
    ...
    string constant _name = "TOKEN500";
    string constant _symbol = "TOKEN500";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10**15 * (10**_decimals);
    uint256 _maxTotalSupply = _totalSupply.div(10**_decimals);

    // Max Transfer and Wallet Amounts
    uint256 public _maxTxAmount = _maxTotalSupply.div(400); // 0.25%
    uint256 public _maxWalletAmount = _maxTotalSupply.div(40); // 2.5%
    ...
    function _transferFrom(
        ...
        if (
            ...
            recipient != gasWalletFeeReceiver &&
    ...
    function setWalletLimit(uint256 amount) external authorized {
        require(amount >= _maxTotalSupply / 40);
        _maxWalletAmount = amount;
    }

    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _maxTotalSupply / 400);
        _maxTxAmount = amount;
    }
