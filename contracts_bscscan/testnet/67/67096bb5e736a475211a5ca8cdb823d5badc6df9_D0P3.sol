...
/*
 ____  _____  ____   __    __  __  ____  __  __  ____ 
(  _ \(  _  )(  _ \ /__\  (  \/  )( ___)(  \/  )( ___)
 )(_) ))(_)(  )___//(__)\  )    (  )__)  )    (  )__) 
(____/(_____)(__) (__)(__)(_/\/\_)(____)(_/\/\_)(____)

Twitter: https://twitter.com/Dopameme11
Telegram: https://t.me/dopamemetoken
Reddit: https://www.reddit.com/user/Dopameme11
Smart-contract developed by snipe.finance: [email protected] - t.me/SnipeFinance
...
// File: contracts/D0P3DividendPayingToken.sol
...
// File: contracts/D0P3.sol

pragma solidity ^0.7.6;

contract D0P3 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    D0P3DividendTracker public dividendTracker;

    address public burnAddress;
    
    uint256 public maxBuyTranscationAmount = 40000000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 40000000000000 * (10**18);
    ...
    constructor() public ERC20("D0P3", "D0P3") {
        ...
        */
        _mint(owner(), 40000000000000 * (10**18));
    }
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(dividendTracker), "D0P3: The dividend tracker already has that address");

        D0P3DividendTracker newDividendTracker = D0P3DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "D0P3: The new dividend tracker must be owned by the D0P3 token contract");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "D0P3: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        //require(_isExcludedFromFees[account] != excluded, "D0P3: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "D0P3: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "D0P3: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "D0P3: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "D0P3: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "D0P3: This account cannot send tokens until trading is enabled");
        }
...
contract D0P3DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("D0P3_Dividend_Tracker", "D0P3_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "D0P3_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "D0P3_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main D0P3 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "D0P3_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "D0P3_Dividend_Tracker: Cannot update claimWait to same value");
