...
contract TesTokenV8 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TesToken V8", "$TESTV8") {
...
//            uint256 rewardAmount = amount.mul(BUSDRewardFee).div(feeUnits);
        ...
        emit SetBalance(from, balanceOf(from));
        emit SetBalance(to, balanceOf(to));
        emit Log(swapping, noFee);
