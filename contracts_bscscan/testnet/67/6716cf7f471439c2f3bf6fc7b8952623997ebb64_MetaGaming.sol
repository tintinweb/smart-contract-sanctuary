...
contract MetaGaming is Context, IERC20, Ownable {
    ...
    string private _name = "MMetaGaming";
    string private _symbol = "MTGM";
    ...
    constructor (address marketingAndDev) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Change router address accordingly
