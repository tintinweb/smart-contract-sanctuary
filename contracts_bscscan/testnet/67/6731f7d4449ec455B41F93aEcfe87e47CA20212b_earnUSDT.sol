...
// SPDX-License-Identifier: MIT 
 ...
 /*   earnUSDT - investment platform based on Binance Smart Chain blockchain smart-contract technology. Safe and legit!
 *   
 *   [USAGE INSTRUCTION]
 *
 ...
 *   2) Choose one of the tariff plans, enter the USDT amount (1.0 USDT minimum) using our website "Stake USDT" button
 *   3) Wait for your earnings
 *   4) Withdraw earnings any time using our website "Withdraw" button
 *
 *   [INVESTMENT CONDITIONS]
 *
 *   - Basic interest rate: +0.4% every 24 hours (~0.02% hourly) - only for new deposits
 *   - Days reduction plan: Plans length reduces -0.25 days every day.
 *   - Lottery Bonus: Earn +0.005% per participation.
 *   - Ref Bonus: Earn an Additional +0.1% for every 10 users you invite.
 *   - Minimal deposit: 1 USDT, no maximal limit
