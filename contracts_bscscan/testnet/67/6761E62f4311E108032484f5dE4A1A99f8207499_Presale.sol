...
contract Presale is Ownable, Whitelisted, ReentrancyGuard {
    ...
    address public constant sNova = 0x0c0bf2bD544566A11f59dC70a8F43659ac2FE7c2; // 0x0c0bf2bD544566A11f59dC70a8F43659ac2FE7c2, 0xb79927bA8D1dF7B9c2199f3307Ddf6B263eBa6A3
    address public constant nova = 0x56E344bE9A7a7A1d27C854628483Efd67c11214F; // 0x56E344bE9A7a7A1d27C854628483Efd67c11214F, 0x7cc3F3945351F1Bc3b57836d90af3D7dCD0bEF9c
    address public constant novaRouter = 0xeb17Dd35e47B1a41ba4D86B3506ec1f9b680b56a; // 0xeb17Dd35e47B1a41ba4D86B3506ec1f9b680b56a, 0xA58ebc8d0D2f1d7F07656A3FbE6e2E51ae767ae9
    address public constant novaFactory = 0x251912dE998ec91DFDf67EfBe032d6f4aB5EC485; // 0x251912dE998ec91DFDf67EfBe032d6f4aB5EC485, 0x1723f701B8940Fa18Af0D5BB963b45EE57C499e6
    ...
    uint256 public maxBuy = 1500000000000000000; // 2000000000000000000 = 2 bnb make sure to add 1 to avoid overflow on UI add 1 for overflow on ui
    uint256 public minBuy = 20000000000000000; // .05 bnb 50000000000000000
    ...
    function swap() public payable nonReentrant{
        ...
        require(presaleFailed == false, 'Presale Failed');

         if (block.timestamp < endBlock &&
            IERC20(sNova).balanceOf(msg.sender) >= minSNova ||
            IERC20(nova).balanceOf(msg.sender) >= minNova) {
