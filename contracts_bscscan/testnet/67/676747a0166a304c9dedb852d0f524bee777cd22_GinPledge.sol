...
contract GinPledge {
    ...
    function pledgeToken(address payable fisctokenaddress , uint256 FiscAmount) public   { 
    ...
    function intoFisc(uint256 amount) public payable {
        _TokenFisc.safeTransferFrom(msg.sender, address(this), amount);
    }
    
    function intoFil(uint256 amount) public payable {
        _TokenFil.safeTransferFrom(msg.sender, address(this), amount);
    }
