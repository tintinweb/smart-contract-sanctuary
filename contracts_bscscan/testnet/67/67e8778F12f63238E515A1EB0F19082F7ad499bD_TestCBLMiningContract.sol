...
contract TestCBLMiningContract is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ICBL cblToken;

    function setCBLToken(address _cbltoken) public {
    ...
    function claim() public {
        ...
        cblToken.transfer(sender, 100 * 10 **12);
        
        cblToken.Destory(1000 * 10 **12);
