...
contract FrostedCake is IBEP20, Auth {
    ...
    string constant _name = "Frosted Cake";
    string constant _symbol = "FROSTEDCAKE";
    ...
    address public Owner=0xeD0A1ec486714a2DdCd096fd1BFc13D034fA91aE; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x93A3a987Fa2859bE413E57494f1052015217eDF9;
