...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of FCKs
        // entitled to a user but is pending to be distributed is:
        //
        //   pending reward = (user.amount * pool.accFCKPerShare) - user.rewardDebt
        //
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. FCKs to distribute per block.
        uint256 lastRewardBlock;  // Last block number that FCKs distribution occurs.
        uint256 accFCKPerShare;   // Accumulated FCKs per share, times 1e12. See below.
    ...
    // Safe FCK transfer function, just in case if rounding error causes pool to not have enough FCKs.
