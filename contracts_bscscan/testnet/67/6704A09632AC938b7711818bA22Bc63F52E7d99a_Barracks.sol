...
contract Barracks is Ownable {
    ...
    function getUserInfo(uint _barrackId) public view returns (UserInfo memory) {
        return UserInfo(
            {
                depositedAmount: barracks[_barrackId].deposits[msg.sender].amount,
                claimed: barracks[_barrackId].deposits[msg.sender].claimed
            }
        );
    }
