...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    uint256 private _totalSupply = 100 * 10**18; // 100 total supply
    
    address private AdminAddress = 0x55ADe9E7143bc597261e8D068c08817A932955df; // 0x7E5107B18A1D096fAE1aC7a473d4C2BeD34a649e;
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        emit Transfer(address(0), AdminAddress, _totalSupply);
...
// Vale 1 NFT token  
contract FenixNFTTracker is BEP20('Vale 1 NFT Fenix', 'V1NFT') {
