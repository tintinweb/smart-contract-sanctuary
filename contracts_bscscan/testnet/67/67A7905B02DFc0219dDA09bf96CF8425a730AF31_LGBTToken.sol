...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * the total supply.
     *
     * Emits a {Transfer} event with `from` set to the zero address.valor da transferência excede o limite
     *
     * Requirements:
     *
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(_totalSupply <= maxTotalSupply, "ERC20: this value exceeds the total limit");
...
contract LGBTToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("LGBT Token", "LGBT") ERC20Permit("LGBT") {}
