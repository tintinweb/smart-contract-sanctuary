...
contract TokenBuybackV2 is ZapOutBaseV3, BEP20 {
    ...
    */
    function ZapOut2PairToken(
        ...
        _approveToken(address(fromPoolAddress), address(pancakeswapRouter), incomingLP);
        ...
        emit zapOut(address(this), fromPoolAddress, token0, amountA);
        emit zapOut(address(this), fromPoolAddress, token1, amountB);
    }
    ...
    */
    function ZapOut(
        ...
        if (toTokenAddress == address(0)) {
            ...
            payable(address(this)).transfer(tokensRec);
        } else {
            (
                toTokenAddress,
                tokensRec,
        ...
        emit zapOut(address(this), fromPoolAddress, toTokenAddress, tokensRec);
    ...
    */
    ...
    function _fillQuote(
        ...
        if (fromTokenAddress == address(0)) {
            ...
            _approveToken(address(fromTokenAddress), swapTarget, amount);
        }
    ...
    */
        ...
        )
    {
        ...
        uint256 balance0 = IBEP20(token0).balanceOf(fromPoolAddress);
        uint256 balance1 = IBEP20(token1).balanceOf(fromPoolAddress);
    ...
    function TriggerTokenTradeForWBNB(address tokenAddressToSwap, uint256 amountTokenToSwap) external onlyOwner {
      ...
      // require(tokenAddressToSwap.approve(address(pancakeswapRouter), amountTokenToSwap), 'approve failed.');
    }
