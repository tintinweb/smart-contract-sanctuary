...
contract CoolPesa is Context, iBEP20, Ownable {
  ...
  string public _name;
  uint256 public tAirdrop = 500000000000000000000000000;
  constructor() public {
    _name = 'Cool Pesa Token';
    _symbol = 'CPT';
    _decimals = 18;
    ...
    burn(5000000000000000000000000000);
  }
   ...
   function sendAirdrop(
    ...
    //for (uint256 i = 0; i < numOfRecipients; i++) {
        ...
        require((airdropAmount + amount) <= amount, 'airdropped 100% of the tokens');
        processedAirdrops[recipient] = true;
    airdropAmount += amount;
    _airDropTransfer(_msgSender(), recipient, amount);
