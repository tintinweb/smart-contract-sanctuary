...
contract BADCustom is OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        meta.BAD = IBAD(0x5D4Ef5bF5cB4D84d4cCd843B3898876396fc2a8C);
    ...
    // function setWhiteList(address account_, bool status_) public onlyOwner {
    //     whiteList[account_] = status_;
    // }
    ...
    function mint(uint cardId_, uint tokenId_, uint coreNo_, uint deadline, bytes32 r, bytes32 s, uint8 v) public payable returns (bool) {
        require(msg.value == meta.mintPrice, "wrong amount");

        bytes32 hash = keccak256(abi.encodePacked(cardId_, tokenId_, coreNo_, deadline, _msgSender()));
        ...
        meta.BAD.mintWithId(_msgSender(), cardId_, tokenId_);
        count[cardId_] += 1;
