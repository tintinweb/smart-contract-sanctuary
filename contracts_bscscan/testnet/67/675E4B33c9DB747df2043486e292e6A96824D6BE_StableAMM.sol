...
contract StableAMM {
    ...
    constructor (USD adrUSD, StableToken adrToken){
        ...
        indexDebt = 0;
        totalDebt = 0;
        treasuryUSD = 1500000000000000000000000;
    ...
    function swap(uint usd, uint token) public returns (bool){
        ...
        if (usd == 0) {
            ...
            require(addressStable.transferFrom(msg.sender, address(this), token), 'Cant transfer USD');
        } else {
            require(addressUSD.allowance(msg.sender, address(this)) >= usd);
            require(addressUSD.transferFrom(msg.sender, address(this), usd), 'Cant transfer USD');
        }
