...
contract KiBridgeV25 is KiBridgeV1Factory {
    ...
    permittedTokenInCheck(_token, this.tokenInBurnToBurnAddrToChain.selector)
  {
    ...
    _token.safeTransferFrom(msg.sender, BURN_ADDRESS, _amount);
  ...
  modifier checkToChainToken(address _token) {
    require(_token != address(0), "Invalid toChainToken address");
    _;
  }
}
