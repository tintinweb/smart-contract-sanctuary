...
contract MemepadProject is Ownable {
  ...
  function getUsersPaging(uint _offset, uint _limit) public view returns (Whitelist[] memory users, uint nextOffset, uint total) {
  ...
  function buyTokens() external payable {
    ...
    require(acceptedAmount > 0, "You must pay some BNB to get tokens");
    ...
    require(
      ...
      "You can not buy more than max payable amount"
    );
