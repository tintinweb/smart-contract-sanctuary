...
contract GrainToken is BEP20 {
    // Supply capped at 32MM
    uint256 public cap = 32000000 * 10**18; //INMUTABLE
    ...
    uint256 public minAmountToLiquify = 50 ether; // INMUTABLE
     ...
     */
    constructor(address _PCSRouter, address _uffToken) public BEP20("Grain", "GRAIN") {
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(grainSupply().add(_amount) <= cap, "GRAIN: cap exceeded");
        _mint(_to, _amount);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (sender == owner() || recipient == owner() || transferTaxRate == 0 || _isExcludedFromFee[sender] || _isExcludedFromFee[recipient] && recipient != lpToken) {
            ...
            require(tradingOpen == true || recipient == lpToken, "Trading not yet open.");
    ...
    function swapAndLiquify() private lockTheSwap transferTaxFree {
        ...
        if (contractTokenBalance >= minAmountToLiquify) {
            ...
            uint newBalanceAfterGrainSell = address(this).balance.sub(initialBalance);
            ...
            // add liquidity
            addLiquidity(address(this), newBalanceAfterGrainSell.div(4), newBalance);
            addLiquidity(uffToken, newBalanceAfterGrainSell.div(4), newBalance);
