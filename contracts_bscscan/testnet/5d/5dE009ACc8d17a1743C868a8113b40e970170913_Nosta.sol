...
/**
    ...
    */
    ...
    event WeEnterInBuyConditionFromPCS(address _from, address _to);
    event WeEnterInBuyConditionToPCS(address _from, address _to);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        emit WeEnterInTransferPrivateFct(from, to);
         ...
         if (from == _pancakeswapV2LiquidityPair) {
             emit WeEnterInBuyConditionFromPCS(from, to);
        ...
        if (to == _pancakeswapV2LiquidityPair) {
             emit WeEnterInBuyConditionToPCS(from, to);
