...
contract TestEscrow is Context, Ownable, IERC1155Receiver, ERC165 {
    ...
    function withdraw(uint256 _amount) public onlyOwner returns (bool) {
        require(_amount <= _supply, "Insufficient amount to withdraw.");
    ...
    receive() external payable {
        ...
        require (_supply >= tokenAmount, "Insufficient NFT balance to sell.");
