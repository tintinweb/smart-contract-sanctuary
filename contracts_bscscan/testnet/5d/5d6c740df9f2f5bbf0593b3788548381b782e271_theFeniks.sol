...
/**
 * TheFeniks NEW ENTERTAINMENT PLATFORM
...
contract theFeniks is Context, IBEP20, Ownable {
    ...
    address public LiqiuditeAddress;
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,address tokenOwner, address _TeamAddress, address _PlatformAddress, address _LiqiuditeAddress, address _SaleAddress) {
    _NAME = _name;
    _SYMBOL = _symbol; 
    _DECIMALS = _decimals;
    ...
    _BURN_FEE = _burnFee * 100;
     ORIG_TAX_FEE = _TAX_FEE;
      ORIG_BURN_FEE = _BURN_FEE;
        ...
        LiqiuditeAddress = _LiqiuditeAddress;
