 ...
 *   2) Choose one of the Wault, enter the BNB amount (1 BUSD minimum) using our website "deposit" button
...
contract BITFARMSV2 {
	...
	IBEP20 public BitFarms;
	IBEP20 token;
	
    uint256 constant public INVEST_MIN_AMOUNT = 1e18; // 1BUSD
	...
	address BToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
	...
	constructor(address payable wallet, address payable _wallet1, IBEP20 BitFarmsAdd) public {
		require(!isContract(wallet));
		TreasureWallet = wallet;
		BuyBurnWallet = _wallet1;
		BitFarms = BitFarmsAdd;
	...
	function invest(address referrer, uint8 plan,  uint256 _amount) public payable {
		...
		token.transfer(BuyBurnWallet, fee1);
				...
				BitFarms.transfer(msg.sender, _amount.mul(10**18).div(2*10**17));
