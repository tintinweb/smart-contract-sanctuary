...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); // Binance Pegged ETH
...
// File: contracts/MommyEthereum.sol
...
contract MommyEthereum is ERC20, Ownable {
    ...
    address public buybackToken =
        address(0xa9a86dc63bE528F4C5D3AB28941a4A7120806d5e); // BBETH address

    uint256 public swapTokensAtAmount = 2 * 10**8 * (10**9);
    uint256 public maxTxAmount = 1 * 10**9 * 10**9;
    uint256 public maxWalletAmount = 5 * 10**10 * 10**9;

    address payable public _marketingWallet = payable(address(0x3A554142d430F80F7150D9405307c0308A2A86eB));
    ...
    constructor() ERC20("Mommy Ethereum", "MMETH") {
