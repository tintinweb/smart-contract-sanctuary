...
contract Private_Sale_Distribution is ReentrancyGuard, Context, Ownable{
    ...
    function claimTokens() public nonReentrant {
        require(airdropLive == true, 'Private Sale Token Distribution not started yet');
    ...
    function avalTokens() public view returns (uint256) {
