...
contract WNDG95DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address tokenAdd)  DividendPayingToken("WNDG95_Dividen_Tracker", "WNDG95_Dividend_Tracker") {
        token = tokenAdd;
    	claimWait = 3600;
    ...
    function withdrawDividend() public override {
        setBalance(msg.sender, IERC20(token).balanceOf(msg.sender));
