...
contract BountyDistributor is IBountyDistributor {
    ...
    IBEP20 FLOKI = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);
...
contract FlokelonInu is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address FLOKI = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47;
    address public WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Flokelon Inu";
    string constant _symbol = "FLOK";
    ...
    constructor (
        ...
        WBNB = router.WETH();
        distributor = new BountyDistributor(_dexRouter);
        distributorAddress = address(distributor);

        isFeeExempt[msg.sender] = true;
        isTxLimitExempt[msg.sender] = true;
        isBountyExempt[pair] = true;
        isBountyExempt[address(this)] = true;
        isBountyExempt[DEAD] = true;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function triggerMarsRun(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function setIsBountyExempt(address holder, bool exempt) external authorized {
