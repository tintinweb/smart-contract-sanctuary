...
contract MoniwarMinningNFT is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        poolNFT[8]  = PoolNFT(8, 1, 8.4 * 10**18);
        poolNFT[9]  = PoolNFT(9, 1, 8.4 * 10**18);
        poolNFT[10] = PoolNFT(10, 120, 483 * 10**18);
        poolNFT[11] = PoolNFT(11, 120, 483 * 10**18);
        poolNFT[12] = PoolNFT(12, 120, 483 * 10**18);
        poolNFT[13] = PoolNFT(13, 195, 787.5 * 10**18);
        poolNFT[14] = PoolNFT(14, 50, 210 * 10**18);
        poolNFT[15] = PoolNFT(15, 50, 210 * 10**18);
        poolNFT[16] = PoolNFT(16, 50, 210 * 10**18);
        poolNFT[17] = PoolNFT(17, 120, 483 * 10**18);
        poolNFT[18] = PoolNFT(18, 195, 787.5 * 10**18);
        poolNFT[19] = PoolNFT(19, 50, 210 * 10**18);
        poolNFT[20] = PoolNFT(20, 50, 210 * 10**18);
        poolNFT[21] = PoolNFT(21, 50, 210 * 10**18);
        poolNFT[22] = PoolNFT(22, 120, 483 * 10**18);
        poolNFT[23] = PoolNFT(23, 195, 787.5 * 10**18);
    }
    ...
    function depositNFT(uint256 _pid, uint256 uid, uint256 _tokenId) public nonReentrant {
        ...
        if(feeStake > 0){
            ...
            mowaToken.transferFrom(address(msg.sender), address(this), feeStake);
        }
        updatePool(_pid);
        payOrLockupPendingMowa(_pid);
