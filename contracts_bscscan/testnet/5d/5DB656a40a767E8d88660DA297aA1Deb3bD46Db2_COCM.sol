...
contract COCM is Context, Ownable {
...
contract COC is Context, IBEP20, Ownable {
    ...
    address private holders1 = 0x675CA97b43d7f19374b1FCFD7BadabEdb690864f; // 70% INITIAL SUPPLY
    address private holders2 = 0x3825ff8012730F35f7D201b681AC3A14E425a291; // 10% INITIAL SUPPLY
    address private holders3 = 0xB3009449c14a2e12851D5eE0E7f70BfaF907De04; // 10% INITIAL SUPPLY
    address private holders4 = 0x3Dcc420b0a5fb11e8F7C9933F5514f40AC309C20; // 10% INITIAL SUPPLY
...
//        require(balanceOf(_msgSender()) >= amount, "BEP20: balance of sender is not enough");
