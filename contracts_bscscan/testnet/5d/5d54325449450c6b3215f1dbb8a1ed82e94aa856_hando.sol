...
contract hando is Context, IERC20, Ownable {
    ...
    string private _name = "Handout Charity Token";
    string private _symbol = "HANDO";
    ...
    address public charityWallet = 0xB9F8f0C6D6A41E0403491504948A72EF640a1829;
    ...
    constructor () public {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //V2 PancakeSwap mainnet
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Fork of Pancake https://pancake.kiemtienonline360.com/
    ...
    function restoreAllFee() private {
        _taxFee = 3;
        _liquidityFee = 0; // disable liquidityfees
        _burnFee = 1;
        _charityFee = 6;
    }

    // Restore Reward to set fees
    ...
    //Call this function after finalizing the presale on unicrypt
