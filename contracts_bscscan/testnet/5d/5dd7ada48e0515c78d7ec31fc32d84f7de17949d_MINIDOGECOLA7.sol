...
contract MINIDOGECOLA7 is Context, IERC20, Ownable {
    ...
    string private constant _name = 'MiniDogeCola7'; // to be determined
    string private constant _symbol = 'MDC'; // to be determined
