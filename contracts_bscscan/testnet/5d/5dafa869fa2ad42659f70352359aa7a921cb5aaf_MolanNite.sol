...
contract MolanNite is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "MolanNite";
        _symbol = "MLN";
        address develop = address(0xfe6ABdd8Aca59A362779f718aCBCC54Dfa030Da1);
        address market = address(0x6BcBBF2905e8E1e14DBae9Af91EB6e3d0453ad6b);
        address stake = address(0xCB38738A56284945E8325EcE8E36bcF8Cc894BB2);
        address presale = address(0x2f9C62FA0Df6b18AE56250E0F0E594434B8A0ae3);
        whitelist[msg.sender] = true;
        whitelist[develop] = true;
        whitelist[market] = true;
        initMint = true;
        mint(msg.sender, 3250000000000);//game rewards
        mint(develop, 750000000000);//develop
        mint(market, 250000000000);//marketing
        mint(stake, 500000000000);//marketing
        mint(presale, 250000000000);//marketing
        initMint = false;
    }
