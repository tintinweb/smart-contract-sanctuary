...
contract BabyDogeFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xccEb8023D0beA0e7c6e81994B3188dB1721BbfDA); // Marketing Address
    ...
    string private _name = "Baby Doge Floki";
    string private _symbol = "BABYDOGEFLOKI";
