...
contract SeedmonGachapon is Ownable, OracleClient {
    ...
    function gacha(uint256 packId) payable external {
        ...
        requestRandomSeedmon(latestRequestId, packId, 0, 9, msg.value);
    ...
    function setSeedmonList(uint256 _packID, bytes32[] memory name, uint256[] memory birthRate) external {
