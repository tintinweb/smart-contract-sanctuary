...
contract Deneme is IERC20, ERC20Ownable, EAHelper, GeneratorInfo {
    ...
    address pcsV2RouterAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    constructor() EAHelper("ea_123") 
    {
        _name = "ErdemAltunToken";
        _symbol = "EAT";
        _decimals = 18;
        _tTotal = 100000000;
        ...
        IUniswapV2Router02 _pcsV2Router = IUniswapV2Router02(pcsV2RouterAddress);
