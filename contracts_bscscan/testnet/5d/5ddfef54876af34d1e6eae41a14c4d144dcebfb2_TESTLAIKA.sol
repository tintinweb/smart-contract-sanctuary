...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x41417CC9e0eb8AB6326D7f1D8292B88bd841CDea;
...
contract TESTLAIKA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x96067aA2020Fed179fbaF65E62422188a6E635C9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LAIKATEST";
    string private _symbol = "LAIKATEST";
