...
/*
 Curiobnb is a test token created by Curiscrew with the following token features and rewards in BNB.
  * Token reward fee: 5%
  * Auto add liquidity: 3%
  * Marketing Fee: 2%
*/
...
contract Curiobnb is ERC20Upgradeable, OwnableUpgradeable {
    using SafeMath for uint256;
    ...
    CuriobnbDividendTracker public dividendTracker;
    ...
    constructor() {
        implementation = address(new CuriobnbDividendTracker());
    }
    ...
    function initialize(
        ...
        dividendTracker = CuriobnbDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "Curiobnb: The dividend tracker already has that address"
        );

        CuriobnbDividendTracker newDividendTracker = CuriobnbDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "Curiobnb: The new dividend tracker must be owned by the Curiobnb token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Curiobnb: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Curiobnb: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Curiobnb: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Curiobnb: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Curiobnb: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Curiobnb: Cannot update gasForProcessing to same value"
        );
...
contract CuriobnbDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Curiobnb contract."
        );
    }
