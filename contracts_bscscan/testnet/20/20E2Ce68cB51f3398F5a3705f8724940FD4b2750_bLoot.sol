...
contract bLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Bag #',
                        toString(tokenId),
                        '", "description": "bLoot is randomized adventurer gear generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use bLoot in any way you want.", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("Loot on BSC", "bLOOT") Ownable() {}
}
