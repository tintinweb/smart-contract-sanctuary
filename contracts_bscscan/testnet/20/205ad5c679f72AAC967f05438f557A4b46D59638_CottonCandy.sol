...
// File: contracts/CottonCandy.sol
...
contract CottonCandy is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "CottonCandy";
    string private _symbol = "CottonCandy";
    uint8 private _decimals = 9;
    address payable public reinvestWallet = 0x1892eac4DC2479a19953eCF8a3A7ae16B9178858;
    ...
    // Innovation for protocol by CottonCandy Team
    ...
    bool public isLotteryWon = false;

    uint256 public _liquidityFee = 8; // 4% will be added pool, 5% will be converted to BNB
    ...
    function claimBNBReward() public isHuman nonReentrant {
        ...
        require(
            ...
            "Error: must own CottonCandy to claim reward"
        );
        ...
        if (reward >= rewardThreshold) {
            uint256 reinvestamount = reward.div(5);
            (bool success, ) = address(reinvestWallet).call{ value: reinvestamount }("");
    ...
    function changeReinvestWalletAddress(address payable _newaddress) public onlyOwner {
