...
import "./Options/BufferBNBOptions.sol";
...
contract FakeWETH is ERC20("FakeWETH", "FAKE") {
    constructor() {
        // _setupDecimals(8);
    }
...
contract FakeBuffer is ERC20("FakeBuffer", "FAKEH") {
    function mintTo(address account, uint256 amount) public {
        _mint(account, amount);
    }
...
contract BrokenBNBOptions is BufferBNBOptions {
    constructor(AggregatorV3Interface pp, IBufferStakingBNB staking)
        BufferBNBOptions(pp, staking, new BufferBNBPool())
    {}
}
