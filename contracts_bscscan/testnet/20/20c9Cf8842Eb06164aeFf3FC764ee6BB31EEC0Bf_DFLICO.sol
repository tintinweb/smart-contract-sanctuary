...
contract DFLICO  {
    ...
    function claimAirdrop(address referrerAddress) public 
    {
	    ...
	    uint256 refIncome=((airDropToken.mul(3)).div(100).mul(tokenPrice)).div(1e18);
    ...
    function start_staking(uint256 walletUsedBusd,uint256 rewardUsedBusd,uint256 compoundUsedBusd,uint256 airdropToken,uint256 _planId,address referrer) public 
    {
