...
contract ZmnBtcBank is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function manualAddRate(
        ...
        _calcRate.accPaybackBtcb = _r.accPaybackBtcb;
    ...
    {
        if (_amountCollateralZmn < minCollateralZmnAmount) {
            return (0, 0, 0);
        }
    ...
    function _payback(uint256 _loanId, uint256 _confirmAmountIn) internal {
    ...
    function payback(uint256 _loanId, uint256 _confirmAmountIn) public {
        ...
        _payback(_loanId, _confirmAmountIn);
    }

    function paybackFor(uint256 _loanId, uint256 _confirmAmountIn) public {
        LoanAgreement memory _loanAgreement = loanAgreements[_loanId];
        require(
