...
contract BabyAnon is Context, IERC20, Ownable {
    ...
    uint256 public _totalSupply = 1000000000000000 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % _totalSupply));
    uint256 public _tFeeTotal;

    string public _name = "Baby Anon";
    string public _symbol = "BABYANON";
