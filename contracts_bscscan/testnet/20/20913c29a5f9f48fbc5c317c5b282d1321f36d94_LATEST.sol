...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x10CE3dB50D271688eCE25588Aa9Af04C87b3DFcb;
...
contract LATEST is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x71789A664B25841Bb67Fc53e6c514a94e7d1c171;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Latest";
    string private _symbol = "LATE";
