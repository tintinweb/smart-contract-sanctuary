...
contract GingerBreadBoys is Ownable, ERC721, ERC721Enumerable {
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((p*20)/100);
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((p*20)/100);
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((p*20)/100);
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((p*20)/100);
        payable(owner()).transfer((p*20)/100);
        _balanceTeam = 0;
    }
    

    function withdraw() public payable onlyOwner {
        uint balance = _balanceTeam;
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((balance*20)/100);
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((balance*11)/100);
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((balance*23)/100);
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((balance*23)/100);
        payable(0x0222ACc312f26df763fd2883541903256ac0a825).transfer((balance*23)/100);
    }
