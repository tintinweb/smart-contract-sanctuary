...
contract simpleStakeBNB {
        ...
        event ClaimReward(IERC20 tokenStaked, IERC20 tokenReward, address staker, uint256 ammountStaked , uint256 rewardClaimed ,uint256 reffReward ,uint256 totalTokenStaked,uint256 totalStaker);
        event UnStake(IERC20 tokenStaked, IERC20 tokenReward, address staker, uint256 ammountStaked , uint256 rewardClaimed ,uint256 reffReward ,uint256 totalTokenStaked,uint256 totalStaker);
        ...
        //need redo
        function checkStake(IERC20 _tokenAddr, address _stakerAddr) public view returns( address stakerAddress , address reffAddress ,uint256 startStake ,uint256 initAmmountSTK ,uint256 lastRewardSTK ,uint256 nowBlock ,uint256 estimatedReward){
        ...
        function stakeToken(IERC20 _tokenAddr, uint256 stakedAmmount ,address payable reff) public payable  {
            require(Tokens[_tokenAddr]._rewardToken.balanceOf(reff) != 0 && Tokens[_tokenAddr]._rewardToken.balanceOf(address(this)) != 0 && reff != 0x0000000000000000000000000000000000000000 && msg.sender != reff);
                ...
                emit Staking(Tokens[_tokenAddr]._stakeToken, Tokens[_tokenAddr]._rewardToken, Tokens[_tokenAddr].Stakers[msg.sender]._stakeOwner, Tokens[_tokenAddr].Stakers[msg.sender]._initAmmountSTK , Tokens[_tokenAddr].Stakers[msg.sender]._enterStake , Tokens[_tokenAddr]._totalStaked  , Tokens[_tokenAddr]._totalStaker);    
                   
        }
        
        function claimReward(IERC20 _tokenAddr) public payable  {
            require(Tokens[_tokenAddr]._rewardToken.balanceOf(address(this)) > 0  && Tokens[_tokenAddr].Stakers[msg.sender]._stakeOwner == msg.sender);
                ...
                Tokens[_tokenAddr].Stakers[msg.sender]._enterStake = block.timestamp;
                emit ClaimReward(Tokens[_tokenAddr]._stakeToken, Tokens[_tokenAddr]._rewardToken, Tokens[_tokenAddr].Stakers[msg.sender]._stakeOwner, Tokens[_tokenAddr].Stakers[msg.sender]._initAmmountSTK , countReward , countReffReward , Tokens[_tokenAddr]._totalStaked  , Tokens[_tokenAddr]._totalStaker);    
                   
        }
        
        
        function unStake(IERC20 _tokenAddr) public payable  {
            require(Tokens[_tokenAddr]._stakeToken.balanceOf(address(this)) > 0  && Tokens[_tokenAddr].Stakers[msg.sender]._stakeOwner == msg.sender);
                ...
                emit UnStake(Tokens[_tokenAddr]._stakeToken, Tokens[_tokenAddr]._rewardToken, Tokens[_tokenAddr].Stakers[msg.sender]._stakeOwner, Tokens[_tokenAddr].Stakers[msg.sender]._initAmmountSTK , countReward , countReffReward , Tokens[_tokenAddr]._totalStaked  , Tokens[_tokenAddr]._totalStaker);    
