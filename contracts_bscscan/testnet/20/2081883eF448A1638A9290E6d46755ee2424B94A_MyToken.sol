...
contract MyToken is ERC20, ERC20Detailed, Ownable {
    ...
    function createFreeStake() public {
        ...
        freeStakeTime[msg.sender] = block.timestamp;
    }

    function distributeFreeStake(address freeStakeHolder) public onlyOwner{
        uint256 stakeAmount = (fixAmount * 90)/100;
        uint256 mintAmount = (fixAmount * 10)/100;
        freeStakes[msg.sender] = freeStakes[msg.sender].add(stakeAmount);
