...
The Token With Burning and Rewards SHIB (SHIBA INU)
TG: https://t.me/shibarisechat
Website: https://shibarise.net/
TW: https://twitter.com/shiba_rise_
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 13000 * (10 ** 8);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xBBe737384C2A26B15E23a181BDfBd9Ec49E00248);
        _token = msg.sender;
    }
...
contract ShibaRise is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaRise";
    string constant _symbol = "SHIBAR";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + BuyBack;
    uint256 public feeDenominator  = 100;

    // Anti-Bot v2
    uint256 public maxRoomRent = 8000000000;
    bool public BotkillerMode = false;
    ...
    uint256 public swapThreshold = rSupply * 10 / 100000;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xBBe737384C2A26B15E23a181BDfBd9Ec49E00248);
        ...
        marketingFeeReceiver = 0x4D03fD96A8DD0835B22E3afDEB71DBA71c1f9b8F;
        BuyBackReceiver = 0xF2cD1c0E8A647dBb4A2E46D754A227A7Fdc484B7;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(BuyBack).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(BuyBackReceiver).call{value: amountBNBDev, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _BuyBack, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        BuyBack = _BuyBack;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_BuyBack);
