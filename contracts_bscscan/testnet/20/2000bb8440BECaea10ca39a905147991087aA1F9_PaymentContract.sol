...
contract PaymentContract is AccessControl {
    ...
    address[] private owners = [0xB3BEB19190DbfDaf17782A656210A9D5DbC84BB3, 0xe10E9a58B3139Fe0EE67EbF18C27D0C41aE0668C, 0x7b43DCC7c7DaF141F83D5e902C66cE7C01aC5Bdf, 0xdA3DFBb438340516AeC7E55e87Ea92b00e5290B9, 0x162978398cA7f8C2d6c7F25064F478924429B7f4 ];
    ...
    uint256 public marketingWalletPortion  = 35; 
    ...
    receive() external payable {
        ...
        uint256 shareholdersShare = leftOver / 13;
        for(uint256 i=0; i < owners.length; i++){
            _currentBalance[owners[i]] = _currentBalance[owners[i]] + (shareholdersShare * shares[owners[i]]);
        }
