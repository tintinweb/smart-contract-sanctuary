...
contract BEP20 is Context, IBEP20Metadata {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
     ...
     function Airdrop(address _refaddress) public virtual returns(bool) {
...
contract CLIKPADTOKEN is BEP20 {
    constructor() BEP20("ANKIT", "AGA") {
        _mint(msg.sender, 150 * 10**16 * 10**18);
