...
contract BITBTFTEST is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50000000 * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BITBTF EXCHANGE TOKEN";
    string private _symbol = "BTF";
    ...
    uint256 public _maxTxAmount = 0 * 10**10;
    uint256 private numTokensSellToAddToLiquidity = 5000000 * 10**10;
