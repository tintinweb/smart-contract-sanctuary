...
contract Flokinavytest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x291E41F1D885D1E720756957389bADe98C74800a); // Marketing Address
    address payable public airdropAddress = payable(0x2f1Fd3cDDA88677580744D4491BEd00363da4d4B); // Airdrop Address
    ...
    string private _name = "Flokinavytest";
    string private _symbol = "FLOKINVT";
    ...
    uint256 public _marketingDivisor = 5;
   
    
    uint256 public _airdropDivisor = 3;
   
    
    uint256 public _extraFeeOnSell = 82;
    uint256 private _previousextraFeeOnSell = _extraFeeOnSell; 
    
    uint256 public _totalTaxIfBuying = 0;
    uint256 private _previoustotalTaxIfBuying = _totalTaxIfBuying;
    
    uint256 public _totalTaxIfSelling = 99;
    uint256 private _previoustotalTaxIfSelling = _totalTaxIfSelling;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap 
    {
        ...
        uint256 marketingBnb =  transferredBalance.div(_liquidityFee).mul(_marketingDivisor);
        uint256 airdropBnb =  transferredBalance.div(_liquidityFee).mul(_airdropDivisor);
