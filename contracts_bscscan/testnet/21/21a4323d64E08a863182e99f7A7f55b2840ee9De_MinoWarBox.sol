...
contract MinoWarBox is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        saleBoxs[0] = SaleBox(0, 720 * 10 ** 18, 1629813629, 1661349629, 5, 25);
        saleBoxs[1] = SaleBox(1, 480 * 10 ** 18, 1629813629, 1661349629, 2, 20);
        saleBoxs[2] = SaleBox(2, 240 * 10 ** 18, 1629813629, 1661349629, 1, 15);
    }
