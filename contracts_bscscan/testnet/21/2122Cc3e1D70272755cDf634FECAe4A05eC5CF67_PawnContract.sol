...
contract PawnContract is IPawn, Ownable, Pausable, ReentrancyGuard {
    ...
    */
        ...
        whenContractNotPaused
    {
        ...
        // require(loanAmount > 0, "10");

        // uint256 loanAmount = 1000 * 10 ** 18; // test data
        // uint256 exchangeRate = 58 * 10 ** 16; // test data
        ...
        // console.logAddress(collateral.loanAsset);
        ...
        // console.logUint(IERC20Upgradeable(collateral.loanAsset).balanceOf(collateral.owner));

        require(loanAmount > 0, "A");
        ...
        require(address(this) != address(pawnLoanContract), "B");
