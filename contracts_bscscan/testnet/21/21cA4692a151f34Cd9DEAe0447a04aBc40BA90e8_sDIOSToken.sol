...
contract sDIOSToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Dios", "sDIOS", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDIOS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDIOS
