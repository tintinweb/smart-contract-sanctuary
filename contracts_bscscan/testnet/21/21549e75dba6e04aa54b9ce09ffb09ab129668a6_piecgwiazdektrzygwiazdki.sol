...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x41381887b734CeBAdf50dc2E579102150Dc1e23c;
...
contract piecgwiazdektrzygwiazdki is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5F6B99931046dFBbd17134Da15376CDF0C478983;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "jebac ***";
    string private _symbol = "5*3*";
