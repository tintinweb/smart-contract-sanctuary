...
contract MambaToken10 is Context, IERC20, Ownable {
    ...
    string private _name = "Mamba2021";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        {
            uint256 mktgFee = amount.div(100).mul(_developmentFee);
            uint256 devFee = amount.div(100).mul(_developmentFee);
            amount = amount.sub(mktgFee).sub(devFee);
            _transferBothExcluded(sender, marketingWallet, mktgFee);
            _transferBothExcluded(sender, developmentWallet, devFee);
        }
