...
contract BurnERC20Token is Ownable{
    string public name;
    ...
    constructor() public {
        ...
        name = "Burn Token";                                   // Set the name for display purposes
        symbol = "BNT";                                        // Set the symbol for display purposes
    }
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        uint previousBalances = balanceOf[_from] + balanceOf[BURN_ADDRESS] + balanceOf[_to];
		
        uint burnAmount = _value * burnRate / 100;
        uint256 sendAmount = _value - burnAmount;

        // Subtract from the sender
        balanceOf[_from] -= _value;
        // Add burn Amount to the BURN ADDRESS
        balanceOf[BURN_ADDRESS] += burnAmount;	
        // Add send Amount to the recipient
        balanceOf[_to] += sendAmount;
        emit Transfer(_from, BURN_ADDRESS, burnAmount);
        emit Transfer(_from, _to, sendAmount);
        // Asserts are used to use static analysis to find bugs in your code. They should never fail
        assert(balanceOf[_from] + balanceOf[BURN_ADDRESS] + balanceOf[_to] == previousBalances);
    }
