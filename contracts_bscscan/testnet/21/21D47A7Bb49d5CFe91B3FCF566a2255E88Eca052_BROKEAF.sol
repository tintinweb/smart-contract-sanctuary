...
contract BROKEAF is Context, IERC20, Ownable {
    ...
    string private _name = "BROKE AF";      //CHANGE_REQUIRED: name of token
    string private _symbol = "BROKEAF";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
