...
contract RodeoCoin is ERC20, Ownable {
    ...
    address public immutable token =
        address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // ETH
    ...
    constructor() ERC20("RodeoCoin", "RodeoCoin") {
        ...
        marketingWallet = address(0x7ad2dD65CE42cDBE93A6B4BA5fCbD12Db3305e53); // set as marketing wallet
        devWallet = address(0x06A967A57da0b66473417557D87745991847689d); // set as dev wallet
    ...
    function emergencyPresaleAddressUpdate(
        address _presaleAddress,
        address _presaleRouterAddress
    ) external onlyOwner {
        presaleAddress = _presaleAddress;
    ...
    function afterLaunchOn(bool enable) external onlyOwner {
        require(
            !launchTaxUsed || !enable,
            "Already used Launch tax, cannot call again."
        );
