 ...
 * the owner.0081a976b240c787d4a7126f3a541523fbb9acf5844166fea2143822620d6342
 */
...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256,uint256) {
        (uint256 tFee,uint256 tLiquidity,uint256 tDev,uint256 tCharity) = calculateFees(tAmount);
        uint256 tTransferAmount = tAmount.sub(tFee.add(tLiquidity).add(tDev).add(tCharity));
