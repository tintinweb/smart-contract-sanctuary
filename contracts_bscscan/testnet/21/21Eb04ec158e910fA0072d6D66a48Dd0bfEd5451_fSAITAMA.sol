...
contract fSAITAMA is Context, IERC20, Ownable {
    ...
    constructor () {
        IRouter _router = IRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // 0x10ED43C718714eb63d5aA57B78B54704E256024E
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function setFeeRates(uint256 _rfi, uint256 _operations, uint256 _liquidity, uint256 _buyback) external onlyOwner {
        feeRates.rfi = _rfi;
    ...
    function setSellFeeRates(uint256 _rfi, uint256 _operations, uint256 _liquidity, uint256 _buyback) external onlyOwner{
