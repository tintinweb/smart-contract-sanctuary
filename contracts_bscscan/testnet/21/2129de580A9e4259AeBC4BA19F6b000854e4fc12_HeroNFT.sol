...
contract HeroNFT is BaseNFT {
  ...
  mapping (uint16 => uint[12]) private strengthIndexReferences;
  mapping (uint16 => uint[12]) private strengthBonuses;
  ...
  event BaseStrengthUpdated(
    uint16 classId,
    uint[12] baseStrength
  );
  event StrengthBonusUpdated(
    uint16 classId,
    uint[12] experienceBonus
  );
  event SkillUp(
    uint tokenId,
    uint index,
  ...
  function getStrengthIndexReferences(uint16 _tokenId) external view returns (uint, uint, uint, uint, uint, uint) {
    return (
      strengthIndexReferences[_tokenId][0],
      strengthIndexReferences[_tokenId][1],
      strengthIndexReferences[_tokenId][2],
      strengthIndexReferences[_tokenId][3],
      strengthIndexReferences[_tokenId][4],
      strengthIndexReferences[_tokenId][5]
    );
  }

  function getStrengthIndexReferencesPlus(uint16 _tokenId) external view returns (uint, uint, uint, uint, uint, uint) {
    return (
      strengthIndexReferences[_tokenId][6],
      strengthIndexReferences[_tokenId][7],
      strengthIndexReferences[_tokenId][8],
      strengthIndexReferences[_tokenId][9],
      strengthIndexReferences[_tokenId][10],
      strengthIndexReferences[_tokenId][11]
    );
  }

  function getStrengthBonuses(uint16 _tokenId) external view returns (uint, uint, uint, uint, uint, uint) {
    return (
      strengthBonuses[_tokenId][0],
      strengthBonuses[_tokenId][1],
      strengthBonuses[_tokenId][2],
      strengthBonuses[_tokenId][3],
      strengthBonuses[_tokenId][4],
      strengthBonuses[_tokenId][5]
    );
  }

  function getStrengthBonusesPlus(uint16 _tokenId) external view returns (uint, uint, uint, uint, uint, uint) {
    return (
      strengthBonuses[_tokenId][6],
      strengthBonuses[_tokenId][7],
      strengthBonuses[_tokenId][8],
      strengthBonuses[_tokenId][9],
      strengthBonuses[_tokenId][10],
      strengthBonuses[_tokenId][11]
    );
  }
  ...
  function _mint(address _owner, uint16 _classId, uint _price, uint _index) private returns (uint) {
    ...
    heroes[newId].race = mappingHeroRace[_classId];
    heroes[newId].class = mappingHeroClass[_classId];
    heroes[newId].name = mappingHeroName[_classId];
  ...
  function _initData() private {
    ...
    strengthIndexReferences[1] = [100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100];

    strengthBonuses[1] = [100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100];
  ...
  function updateBaseStrengths(uint16 _classId, uint[12] calldata _strengths) external onlyMainAdmin {
    strengthIndexReferences[_classId] = _strengths;
    emit BaseStrengthUpdated(_classId, _strengths);
  }

  function updateStrengthBonus(uint16 _classId, uint[12] calldata _strengthBonuses) external onlyMainAdmin {
  ...
  function addHeroClass(string calldata _class, uint[12] calldata _strengths, address _creator) external onlyMainAdmin {
    countId += 1;
  ...
  function updateFailedUpgradingAmount(uint _tokenId, uint _amount) override onlyGameContract external {
