...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xCbDa0d8418d420A8Ee97049738D06f4044ec0fc1); // Marketing Address
    address payable public devAddress = payable(0x0685B541eBe3d1979682cD73B5c5E233557820a2); // Dev Address
    ...
    uint256 public _liquidityFee = 20;   // Marketing + dev + buyback
...
contract BPay is ERC1363, TokenRecover {
    constructor ()
        ERC1363("BPay", "BPAY")
    {
    }
