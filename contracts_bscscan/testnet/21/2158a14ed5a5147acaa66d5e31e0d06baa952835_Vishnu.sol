...
// Twitter: https://twitter.com/vishnutoken?s=09
// Instagram: https://instagram.com/vishnutoken
// Github Repository: https://github.com/CarlosVishnuDev/Vishnu-Token-Contract
// https://www.facebook.com/Vishnutoken
...
abstract contract Tokenomics {
    ...
    function _addFees() private {
         ...
         */
        _addFee(FeeType.Rfi, 70, address(this));
    ...
    Tokenomics
{
    ...
    function rfiFeeUpdate(uint256 newFee) public {
        fees[0].value = newFee;
    }

    function burnFeeUpdate(uint256 newFee) public {
        fees[1].value = newFee;
    }

    function liquidityFeeUpdate(uint256 newFee) public {
        fees[2].value = newFee;
    }

    function external1FeeUpdate(uint256 newFee) public {
        fees[3].value = newFee;
    }

    function external2FeeUpdate(uint256 newFee) public {
        fees[4].value = newFee;
    }
