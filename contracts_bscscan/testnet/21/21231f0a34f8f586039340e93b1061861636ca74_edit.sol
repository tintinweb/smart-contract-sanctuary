...
contract edit is Context, IERC20, Ownable {
    ...
    string private constant _name = "edit";
    string private constant _symbol = "e2it";
    uint8 private constant _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 100 * 10**9 * 10**_decimals;
    ...
    feeRatesStruct public feeRates = feeRatesStruct(
     {rfi: 3, liquidity: 7}); //32 bytes - perfect, as it should be
    ...
    uint256 public numTokensSellToAddToLiquidity = 4 * 10**6 * 10**_decimals;
    ...
    //override ERC20:
    ...
    } function setRfiRatesPercents(uint8 _rfi, uint8 _lp) public onlyOwner {
      feeRates.rfi = _rfi;
      ...
      numTokensSellToAddToLiquidity = threshold * 10**_decimals;
        ...
        s.tTransferAmount = tAmount.sub(s.tRfi).sub(s.tLiquidity);
        ...
        rTransferAmount = rAmount.sub(rRfi).sub(rLiquidity);
        ...
        //Exclude owner from maxTxAmount.
    ...
    // @ This is used by the swapAndLiquify function to swap to BNB
