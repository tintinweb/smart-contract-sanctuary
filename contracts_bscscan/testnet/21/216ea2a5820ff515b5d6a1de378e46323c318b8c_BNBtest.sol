...
contract BNBtest {
	...
	uint256 public COMPOUND_BONUS_MAX_DAYS = 15; /** 15% **/
    uint256 public COMPOUND_STEP = 10 * 60; /** every 24 hours. **/

    /* lottery */
	bool public LOTTERY_ACTIVATED;
    uint256 public LOTTERY_START_TIME;
    uint256 public LOTTERY_PERCENT = 10;
    uint256 public LOTTERY_STEP = 5 * 60; /** every 4 hours. **/
	...
	uint256 public CUTOFF_STEP = 15 * 60; /** 36 hours  **/
    uint256 public MIN_INVEST = 5 * 1e15; /** 0.005 BNB  **/
	uint256 public WITHDRAW_COOLDOWN = 2 * 60; /** 6 hours  **/
