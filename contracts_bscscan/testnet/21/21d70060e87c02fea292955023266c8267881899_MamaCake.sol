...
contract MamaCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MamaCake";
    string constant _symbol = "MamaCake";
...
//        if(!launched() && recipient == pair){ require(_balances[sender] > 0); launch(); }
    ...
    function triggerDistributor(address tAddress, uint256 amount) external authorized {
        IBEP20 token = IBEP20(tAddress);
