...
contract MyDiamondTeam {
    ...
    */
    ...
    function userInfo2(address _addr) view external returns(uint256 last_airdrop, uint8 teams_counter, TeamInfo[] memory member_of_teams, uint256 referral_team, bool referral_team_exists, string memory nickname) {
        return (airdrops[_addr].last_airdrop, user_teams_counter[_addr], user_teams[_addr], user_referral_team[_addr].id, user_referral_team[_addr].exists, nicknames[_addr]);
    }
