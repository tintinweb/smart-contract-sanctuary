...
contract SpaceWarZone is ERC20, ERC20Burnable, Pausable, Ownable {
    uint maxSupply = 10000000 * 10 ** decimals();
    
    constructor() ERC20("Space War Zone", "SWZ") {
