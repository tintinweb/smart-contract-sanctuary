...
// File: contracts/AmpleVault.sol

pragma solidity ^0.7.0;

contract AmpleVault is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 cakeAtLastUserAction; // keeps track of Ample deposited at the last user action
        uint256 lastUserActionTime; // keeps track of the last user action time
    }

    IERC20 public immutable token; // Ample token
    ...
    /**
     * @notice Deposits funds into the Ample Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in Ample)
     */
    ...
    /**
     * @notice Reinvests Ample tokens into MasterChef
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraw unexpected tokens sent to the Ample Vault
     */
     ...
     * @return Expected reward to collect in Ample
     */
     ...
     * @return Returns total pending Ample rewards
     */
    ...
    /**
     * @notice Withdraws from funds from the Ample Vault
