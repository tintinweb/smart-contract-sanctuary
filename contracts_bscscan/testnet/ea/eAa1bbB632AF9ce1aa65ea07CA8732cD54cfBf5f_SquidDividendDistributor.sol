...
contract SquidDividendDistributor is IDividendDistributor, Ownable {
    ...
    address _dividendToken = 0x3B34D1EECA3aF0EFf2293E8E7771274dd604c1FA;
    address _token;
    address _referral;
    uint256 _gas = 500000;
    ...
    /**
     * @dev calculate amount of SQUID for each share. 50% of squid will be reserved for next block
     * @return amount of SQUID for each share
     */
