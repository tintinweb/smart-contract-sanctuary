...
contract MarketDistribution is TokensRecoverable, IMarketDistribution {
    ...
    uint256 public immutable totalRooted = 1e24;

    uint256 public rootedTokenSupply; // 1 Million, or dynamically set
    ...
    function distribute() public override {
        ...
        rootedToken.transfer(oneshotController, rootedTokenSupply.mul(25).div(100));
