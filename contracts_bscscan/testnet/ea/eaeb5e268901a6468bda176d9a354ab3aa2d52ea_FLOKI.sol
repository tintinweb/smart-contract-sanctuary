...
contract FLOKI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xBE95a00948ce2510a1dD42721086527e1e93CA59); // Marketing Address
    ...
    string private _name = "TBiHODLv2";
    string private _symbol = "TBV2";
