...
contract PlanetSandboxToken is ERC20Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function withdrawERC20(address token, uint256 amount) external onlyOwner {
        require(amount > 0, "PlanetSandbox: Amount must be greater than 0");
        require((totalSupply().add(amount)) <= TOTAL_SUPPLY, "PlanetSandbox: ERC20 not enough balance");
        require(IERC20Upgradeable(token).transfer(_msgSender(), amount), "PlanetSandbox: transfer ERC20 failed");
    }
