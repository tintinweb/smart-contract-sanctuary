...
contract GymMasterChef is Ownable, ReentrancyGuard {
    ...
    */
    ...
    uint256 public gymForFirstBlock;
    ...
    constructor(
        ...
        gym = _gym;
        devaddr = _devaddr;
        gymForFirstBlock = _gymForFirstBlock;
        endBlock = _endBlock;
    ...
    function getRewardForBlock(uint256 _block) public view returns (uint256) {
        ...
        return
            gymForFirstBlock.sub(
                _block.sub(startBlock).mul(gymForFirstBlock).div(
