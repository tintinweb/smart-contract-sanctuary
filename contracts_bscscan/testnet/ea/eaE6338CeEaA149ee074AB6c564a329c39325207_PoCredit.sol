...
contract PoCredit is ERC20Capped, ReentrancyGuard {

  address constant public POKI = 0x63eFA74329110A04447939792e68F6c7462b3f23;
  address constant public BRIDGE = 0x3D9Cab05a98c1865C7118422E3F249616568c394;
  
  constructor() ERC20("PoCredit", "POCR") ERC20Capped(80000 ether) {
  }

  function deposit(uint256 _amount) public nonReentrant {
    PoToken(POKI).burnFrom(msg.sender, _amount);
...
contract PoToken is ERC20Burnable {
  ...
  constructor(address _masterchef, address _bridge) ERC20("Po Token", "POT") {
