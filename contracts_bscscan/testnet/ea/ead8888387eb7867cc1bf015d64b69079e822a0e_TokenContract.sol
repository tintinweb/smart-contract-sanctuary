...
//t.me/t4
//Tokenomics start on line 474. Welcome to T4
...
contract TokenContract is Context, IERC20, Ownable {
    ...
    address private _charityWallet = 0x8A6019AEbB8f7E18A7a1fdC38B7a5435305de33E;
    ...
    function setCharityFeePercent(uint256 charityFee) external onlyOwner() {
        require(charityFee <= 5); // Prevents owner from abusing fees.
    ...
    function _takeCharity(address sender, uint256 tCharity) private {
        ...
        emit Transfer(sender, _charityWallet, tCharity); // Transparency is the key to success.
    }
