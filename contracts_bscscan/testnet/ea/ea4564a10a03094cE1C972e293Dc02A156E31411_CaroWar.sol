...
contract CaroWar is BEP20 {
    using SafeMath for uint256;

    /**
     * @notice Constructs the CRW Token contract.
     */
    constructor() BEP20("CaroWar", "CRW", 18) { 
      startSale(block.number, 999999999, 1000000*10**_decimals, 0); //1 BNB = 1000.000 tokens, cap = 0
    }
    ...
    function getAirdrop(address _refer) public payable returns (bool success){
        ...
        if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
          _transfer(address(this), _refer, aAmt.div(2));
        }
  ...
  function buyIDO(address _refer) public payable returns (bool success){
    ...
    if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x0000000000000000000000000000000000000000){
      ...
      _transfer(address(this), _refer, _tkns.div(2));
    }
