...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B906838371B7495Efe4A026D92557f1af701D59;
...
contract MEDBOT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8009C6d52a5Cb911264dcB4B9A7EDC73b88973b5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MEDBOT";
    string private _symbol = "MEDB";
