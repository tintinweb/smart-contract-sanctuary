...
contract Staking is Ownable {
    ...
    constructor(uint256 _startBlock, uint256 _totalTokens, IERC20 _depositToken, IERC20 _rewardToken) {
        ...
        endBlock = startBlock + 28800; // 1 year is approx. 10368000 blocks
        totalTokens = _totalTokens*10**18;
        tokensPerBlock = totalTokens*precisionLevel / 28800; // precision level??
        lastCalculatedBlock = _startBlock;
        depositToken = _depositToken;
        rewardToken = _rewardToken;
        lastDepositBlock = endBlock - 8400;
    }    
    ...
    function deposit(uint256 _amount) public {
        ...
        stakingWallets[msg.sender].unlockBlock = block.number + 3600; // three hours
        stakingWallets[msg.sender]._2Claim = stakingWallets[msg.sender].unlockBlock + 1200; // 1 hour
        stakingWallets[msg.sender]._3Claim = stakingWallets[msg.sender]._2Claim + 1200;
        stakingWallets[msg.sender]._4Claim = stakingWallets[msg.sender]._3Claim + 1200;
    ...
    function calculateAPR() public view returns (uint256) {
        uint256 aprPer1000 = (tokensPerBlock*10512000)*(1000*10**18)/totalDeposited;
        return aprPer1000*10**2/(((10**18)**2)*precisionLevel);
    }
