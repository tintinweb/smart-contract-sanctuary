...
contract KuLuckyDoge is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => uint256) private winStreak;
    mapping(address => uint256) private lossStreak;

    mapping(address => bool) public isBannedForManipulation;
    mapping(address => uint256) private lastBlockFlippedCoin;
    //////////////////////////// COIN FLIP VARS ////////////////////////////
    ...
    function GetLossStreak(address addressToCheck) public view returns(uint256) {
        return lossStreak[addressToCheck];
    }

    function GetWinStreak(address addressToCheck) public view returns(uint256) {
        return winStreak[addressToCheck];
    }
    ...
    function FlipCoin(uint256 betAmount, bool isHeads) external {
