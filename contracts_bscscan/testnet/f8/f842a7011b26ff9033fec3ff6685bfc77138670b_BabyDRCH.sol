...
/**
 * @title BDRCH ERC20 token
 * @dev
 *      Based on the Ampleforth & Safemoon protocol.
 */
contract BabyDRCH is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("BabyDRCH", "BDRCH", uint8(DECIMALS))
        payable
        public
    {
  ...
  event Sender(address sender);
   ...
   returns (bool)
   {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 getBal = contractTokenBalance;
        ...
        // swap tokens for ETH
        swapTokensForEth(getBal); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
        ...
        emit SwapAndLiquify(getBal, newBalance);
  ...
  function setFee(uint256 _transactionTax) public onlyOwner {
