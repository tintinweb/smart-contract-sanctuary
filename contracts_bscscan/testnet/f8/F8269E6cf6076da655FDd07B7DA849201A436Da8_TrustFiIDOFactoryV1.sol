...
contract TrustFiIDOFactoryV1 is ITrustFiIDOFactoryV1 {
    ...
    */
    ...
    function addPoolWhileList(uint256 poolId,address[] memory users,uint256[] memory amounts) external override onlyOperater{
...
interface ITrustFiIDOFactoryV1 is BaseStruct {
    ...
    */
    ...
    function addPoolWhileList(uint256 poolId,address[] memory users,uint256[] memory amounts) external;
