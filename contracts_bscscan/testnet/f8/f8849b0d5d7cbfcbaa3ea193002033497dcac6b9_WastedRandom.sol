...
// File: contracts/WastedRandom.sol
...
contract WastedRandom is VRFConsumerBase, PermissionGroup {
    ...
    function withdrawLink() external onlyOwner {
        require(LINK.balanceOf(address(this)) > 0, "WastedHero: Not enough LINK");
