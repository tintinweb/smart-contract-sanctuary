...
contract ThunderCake is ERC20, Ownable {
    ...
    constructor() ERC20("ThunderCake", "THUNDERCAKE") {
        ...
        cakeDividendToken = 0xb289b361a633A9D2b0B39BAE76BB458d83f58CEC;
        thoreumDividendToken = 0xE0dFffc2E01A7f051069649aD4eb3F518430B6a4;
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Cake_Dividend_Tracker", "Cake_Dividend_Tracker", 0xb289b361a633A9D2b0B39BAE76BB458d83f58CEC) {
        claimWait = 3600;
...
contract ThoreumDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Thoreum_Dividend_Tracker", "Thoreum_Dividend_Tracker", 0xE0dFffc2E01A7f051069649aD4eb3F518430B6a4) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
...

{
  ...
  "libraries": {
    "/Users/mudaseriqbal/Documents/Developer/Luner/thundercake/contracts/ThunderCake.sol": {
      "IterableMapping": "0xB482046dBC31B0aF3eE7940FE788b66855e1A0c0"
    }
  },
  "outputSelection": {
    "*": {
