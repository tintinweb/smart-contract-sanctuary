...
contract MomContract is ChildDeployer {
  ...
  function bornDaughter(string memory name, uint256 year) internal returns (address child) {
  ...
  function bornSon(string memory name, uint256 year) internal returns (address child) {
...
contract ChildDeployer is IChildDeployer {
  ...
  function deploy(address mom, string memory name, uint256 birthYear) public returns (address house) {
