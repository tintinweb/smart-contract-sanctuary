...
contract Punks is IERC721 {
    ...
    IMoonReferral public tokenReferral;
    ...
    string internal nftName = "SexPunks";
    string internal nftSymbol = "SexPunks";
    ...
    function startSale() external onlyDeployer {
        require(!publicSale);
        saleStartTime = 1631563286;  //////////////////////////////////////////////////////////////////// sale start time by unixtimestamp
    ...
    function setMoonReferral(IMoonReferral _tokenReferral) public onlyDeployer {
    ...
    function mint(uint256 numberOfNfts, address _referrer) external payable reentrancyGuard {
        ...
        if (numberOfNfts > 0 && address(tokenReferral) != address(0) && _referrer != address(0) && _referrer != msg.sender) {
         ...
         if (numberOfNfts > 0 && address(tokenReferral) != address(0) && _referrer != address(0) && _referrer != msg.sender) {
            tokenReferral.recordReferralCount(msg.sender, numberOfNfts);
        }
