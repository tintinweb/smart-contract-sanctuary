...
contract BeeNetwork is Context, ERC20, Ownable {
    ...
    // Address that include in Bee LP list
    mapping(address => bool) private _includeInBeeNetworkLpList;
    ...
    // Minimum Bee sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInBeeNetworkLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInBeeNetworkLpList(address _address) public view returns (bool) {
        return _includeInBeeNetworkLpList[_address];
    }

    function setIncludeInBeeNetworkLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInBeeNetworkLpList[_address] = _isIncludedOrNot;
    }
    ...
    function _transfer(
        ...
        && !isIncludedInBeeNetworkLpList(from)
        && from != owner()
        ) {
            ...
            if (isIncludedInBeeNetworkLpList(to)) {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= MIN_TX_AMOUNT_HARD_CAP, "maxTxAmount have to be greater than 1 BeeNetwork");
