...
// File: contracts/lottery/interfaces/IPancakeSwapLottery.sol
...
// File: contracts/lottery/interfaces/IRandomNumberGenerator.sol
...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    uint256 public maxPriceTicketInCake = 500 ether;
    uint256 public minPriceTicketInCake = 50 ether;

    uint256 public pendingInjectionNextLottery;

    uint256 public constant MIN_DISCOUNT_DIVISOR = 0;
    uint256 public constant MIN_LENGTH_LOTTERY = 20 minutes - 5 minutes; // 4 hours
