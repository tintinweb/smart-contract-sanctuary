...
import { IERC20 } from "../Interface/IERC20Burnable.sol";
...
contract StakingRewards is RewardsDistributionRecipient, ReentrancyGuard, Ownable {
    ...
    updateReward(msg.sender)
  {
    ...
    require(lastStakedTime[msg.sender].add(lockPeriod) < block.timestamp, "Withdraw not possible in lock period");
    ...
    updateReward(msg.sender)
  {
    ...
    stakingToken.burn(amount.sub(withdrawAmount));
    emit Withdrawn(msg.sender, amount);
  }
