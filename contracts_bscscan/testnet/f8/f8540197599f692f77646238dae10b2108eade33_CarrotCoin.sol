...
contract CarrotCoin is Context, IBEP20, Ownable {
    ...
    string private constant NAME = "CarrotCoin";
    string private constant SYMBOL = "CARR";
    ...
    function _takeBNBFees (uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityBalance = contractTokenBalance.mul(_liquidityFeePermille).div(FEE_DIVISOR);
        uint256 structureBalance = contractTokenBalance.mul(_structureFeePermille).div(FEE_DIVISOR);
        ...
        // Send the remaining BNB to the structure providepayable wallet
