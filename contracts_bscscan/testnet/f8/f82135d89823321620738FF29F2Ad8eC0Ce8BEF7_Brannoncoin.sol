...
/**
   ...
   I created a black hole so #CRATER token will deflate itself in supply with every transaction
...
contract Brannoncoin is Context, IERC20, Ownable {
    ...
    string private _name = "brannon coin";
    string private _symbol = "BANDS";
