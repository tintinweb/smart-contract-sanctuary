...
contract MyCoinL is Context, IERC20, Ownable {
    ...
    uint256 public _platformFee = 8;
    address public platformAddress = 0x1B7649c4404674a5B8baAE829147f8e2771ea8ca;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _platformFee==0 && _burnFee==0) return;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 charityAmt = amount.mul(_platformFee).div(100);
        ...
        _transferStandard(sender, platformAddress, charityAmt);
