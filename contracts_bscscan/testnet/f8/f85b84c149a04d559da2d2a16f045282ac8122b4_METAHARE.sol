...
/* METAHARE - BNB Reward Token

Website: https://metahareofficial.com
telegram: https://t.me/Metahareoffical
Lock LQ: 6 months
================================
...
contract METAHARE is Context, IERC20, Ownable {
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 300000000000000000000000000; // 200,000,000; token will be given on airdrop
