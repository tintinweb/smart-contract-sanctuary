...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MNG = IBEP20(0x5941f87EB62737eC5EBbECab3e373c40fe40566B);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MNG.balanceOf(address(this));
        ...
        uint256 amount = MNG.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MNG.transfer(shareholder, amount);
...
contract BabyMoonNation is IBEP20, Auth {
    using SafeMath for uint256;

    address MNG = 0x5941f87EB62737eC5EBbECab3e373c40fe40566B;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Moon Nation";
    string constant _symbol = "$BMNG";
...
// ps: hold token $BMNG to get token $MNG. Baby Moon Nation is our future !