...
contract MysteryBoxS5 is ERC721Holder, RandomGenerator, Ownable {
    ...
    constructor() {
        ...
        uint[5] memory amounts_ = [uint(2), uint(2), uint(2), uint(2), uint(2)];
