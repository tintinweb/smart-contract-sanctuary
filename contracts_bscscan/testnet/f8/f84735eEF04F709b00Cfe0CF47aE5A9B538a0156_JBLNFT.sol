...
contract JBLNFT is ERC721{
    ...
    constructor ()  public ERC721("Smiling George Rest", "Rest"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "Smiling George Rest";
        string memory _t = "Rest";
        string memory tokenURI = "https://jbl.i-recu.com/assets/images/player/coop_4.png";
