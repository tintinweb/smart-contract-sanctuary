...
contract sDoob is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked Doob", "sDoob", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDoob supply to increase staking balances relative to profit_
