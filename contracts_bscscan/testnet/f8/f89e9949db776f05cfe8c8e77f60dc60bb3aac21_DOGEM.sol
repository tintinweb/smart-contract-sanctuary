...
contract DOGEM is Context, IBEP20, Ownable {
    ...
    string private _name = "Dogematrix";
    ...
    uint256 public _taxFee = 2; // Consists of Reflection Tax (2%)
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 13; // Consists of Buyback (7%) + Liquidity (2%) + Dividends (4%) Tax
    ...
    constructor (address _initiationAddress, address payable _buybackAddress) {
        ...
        distributor = new DividendDistributor(address(uniswapV2Router), _initiationAddress);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        if(multiBuybackWallet){
            ...
            transferToAddressETH(buybackAddress1, bal1);
            transferToAddressETH(buybackAddress2, bal2);
        }else{
            transferToAddressETH(buybackAddress1, marketingBalance);
        }
        if(dividendContractActive){
