...
/**
 *CREATED BUY COINSLIST.XYZ
 *coinslist.xyz* TICKER - CLIST
 *Telegram - https://t.me/coinslistxyz
 *Website = https://coinslist.xyz
 *
 *COINSLIST.XYZ IN NOT RESPONSIBLE FOR THE MISUSE OF THIS CONTRACT* 
 *
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 public maxDevFee = 100;
    uint256 public minMxTxPercentage = 100;
    uint256 public minMxWalletPercentage = 100;
    ...
    address public router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // TESTNET - https://pancake.kiemtienonline360.com/
    ...
    uint256 public _devFee = maxDevFee / 200;
    ...
    constructor (address tokenOwner,string memory tokenName,
        string memory tokenSymbol, uint256 decimal, uint256 amountOfTokenWei,
        uint256 setMxTxPer, uint256 setMxWalletPer,
        ...
        numTokensSellToAddToLiquidity = amountOfTokenWei.mul(1).div(100);
        ...
        _isTxLimitExempt[pcsV2Pair] = true;
        _isTxLimitExempt[dead] = true;

        _isExcludedFromFee[tokenOwner] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[pcsV2Pair] = true;
    ...
    function setAllFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 burnFee, uint256 walletFee, uint256 buybackFee) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 totFee  = _burnFee + _walletFee + _liquidityFee + _buybackFee;
        ...
        if(_devFee != 0){
            spentAmount = contractTokenBalance.div(20);
            swapTokensForDEV(spentAmount);
            totSpentAmount = totSpentAmount + spentAmount;
        }
    ...
    function swapTokensForDEV(uint256 tokenAmount) private {
        ...
        pcsV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            0, 
            path,
            // 0x963BA5ebD5662D443E2430E188D622d75B1d9CA7, //MAINNET - https://bscscan.com/address/0x963ba5ebd5662d443e2430e188d622d75b1d9ca7
            0x92d342940Ec88F6638064f26cb31eb7BfD7Da6A9, //TESTNET - https://testnet.bscscan.com/address/0x92d342940ec88f6638064f26cb31eb7bfd7da6a9
            block.timestamp
        );
    }
