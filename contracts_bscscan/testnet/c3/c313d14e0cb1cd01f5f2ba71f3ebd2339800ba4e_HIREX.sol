...
contract HIREX is Context, IBEP20, Ownable {
    ...
    uint256 private buyresearchFee      = 3;
    ...
    uint256 private _previousResearchFee    = researchFee;
	...
	function setBuyFee(uint256 buyTaxFee, uint256 buyLiquidityFee, uint256 buyMarketingFee, uint256 buyResearchFee) external onlyOwner {
        buytaxFee = buyTaxFee;
    ...
    function setSellFee(uint256 sellTaxFee, uint256 sellLiquidityFee, uint256 sellMarketingFee, uint256 sellResearchFee) external onlyOwner {
    ...
    function removeAllFee() private {
        if(taxFee == 0 && liquidityFee == 0 && marketingFee == 0 && researchFee == 0) return;
        
        _previousTaxFee = taxFee;
        _previousLiquidityFee = liquidityFee;
        _previousMarketingFee = marketingFee;
        _previousResearchFee = researchFee;
    ...
    function restoreAllFee() private {
        ...
        researchFee = _previousResearchFee;
    }
