 ...
 */
contract WempBep20 is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    string private constant _name = "WempBep20";
    string private constant _symbol = "WEMP_BEP20";
    ...
    address public constant UNISWAPV2ROUTER = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    constructor (address _charityWallet, address _welfareWallet,  address _bridgeAddress) {
        ...
        require ( _bridgeAddress != address ( 0 ) , "WempToken: _bridgeAddress cant be zero address") ;

        _rOwned[_bridgeAddress] = _rTotal;
        charityWallet = _charityWallet;
        welfareWallet = _welfareWallet;
        emit Transfer(address(0), _bridgeAddress, initialSupply);
