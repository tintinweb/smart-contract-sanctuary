...
contract XXX is ERC20, Ownable {
    ...
    // tax
    //TBD
    uint256 public buyTransferFee = 2;
    uint256 public sellTransferFee = 2;
    uint256 public whaleTax = 20;
    uint256 public whaleThreshold = 500*10**18;  

    //wallet address to be create
    address public taxAddress = 0xE3d63E584b3A554130CAaBe113718535fb0a1eCE;
    address public rewardAddress = 0x1CadAA969d8396d7D0d80c6456054Cc5D6D80635;
    address public devAddress = 0xc326E7cfe2c83C1a6cB3277A23E1c83a64F55B4b;
    address public marketingAddress = 0x9d90dbD402a41F5d8DAAf2A727c29dc232871DE4;
    address public reserveAddress = 0x7bFBEad2080fd52e4CbdFeC486e25527D099d4f1; 
    ...
    constructor() public ERC20("XXX", "XXX Token"){ // TICKER
        ...
        super.transfer(marketingAddress, maxSupply.mul(10).div(100)); 
        super.transfer(rewardAddress, maxSupply.mul(30).div(100)); 
        super.transfer(devAddress, maxSupply.mul(10).div(100));
        super.transfer(reserveAddress, maxSupply.mul(10).div(100));        
    }
