...
// File contracts/CoinaryToken.sol
...
contract CoinaryToken is Context, AccessControl, ERC20Burnable, ERC20Capped, ERC20Permit {
    ...
    // Test values
    address public constant NFT_EMPIRE_TEAM_ADDRESS = 0xb44F5317675A5e51593182A921F6F53F407757f4;//20%
    address public constant NFT_EMPIRE_MARKETING_ADDRESS = 0xd88970c90636bf81a7E8e3412C8A3787Ae9105a5;//15%
    address public constant NFT_EMPIRE_ECOFUND_ADDRESS = 0xbF012f9d496e5AfD0121776dC65102dBe57B752d;//20%
    address public constant NFT_EMPIRE_PARTNER_ADDRESS = 0xA46De66058e21ee12Fa9DF44A65Af8048a2fE9eB;//10%
    address public constant NFT_EMPIRE_PLAY_TO_EARN_ADDRESS = 0xD560216fe5382981b53c3c6A0438BeB7EDde6c0f;//20%
    address public constant NFT_EMPIRE_NFT_POOL_ADDRESS = 0xB73eF98F553844C58432f9aC1F77577AfA44C6d3;//10%
    address public constant NFT_EMPIRE_PRIVATE_SALE_ADDRESS = 0x67061f3392E828032A7E690C4C1cCD3EDdDfA95d;//5%
    ...
    constructor(
        ...
        _mint(NFT_EMPIRE_TEAM_ADDRESS, 20000000 ether);
        _mint(NFT_EMPIRE_MARKETING_ADDRESS, 15000000 ether);
        _mint(NFT_EMPIRE_ECOFUND_ADDRESS, 20000000 ether);
        _mint(NFT_EMPIRE_PARTNER_ADDRESS, 10000000 ether);
        _mint(NFT_EMPIRE_PLAY_TO_EARN_ADDRESS, 20000000 ether);
        _mint(NFT_EMPIRE_NFT_POOL_ADDRESS, 10000000 ether);
        _mint(NFT_EMPIRE_PRIVATE_SALE_ADDRESS, 5000000 ether);
