...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47); // BUSD - TESTNET
    address BUSD = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; //BUSD - TESTNET
...
contract ELEMENTAL is IBEP20, Context {
    ...
    address REWARDS = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // ** BUSD - TESTNET ** Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address BUSD = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // BUSD - TESTNET

    //address REWARDS = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // ** BUSD ** Input the token address of whatever your reward is. leave 431,432,433 as is. 
    //address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD
    ...
    uint256 _totalSupply = 100000000000 * 10**1 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply;
    uint256 private _maxTxAmountBuy = ( _totalSupply * 1 ) / 100;
    uint256 private _maxTxAmountSell = ( _totalSupply * 1 ) / 100000;
    ...
    uint256 public _maxWalletToken = _maxWalletAmount;
