...
contract SpaceportGeneratorv1 is Ownable {
    ...
    constructor() public {
        SPACEPORT_FACTORY = ISpaceportFactory(0xEeAB9B886C653c0Ef0653560a5786D2B390d956C);
        SPACEPORT_SETTINGS = ISpaceportSettings(0x9626F20EFaD0A86907828a4349BF2F0dCc5FB7A4);
    }
...
contract Spaceportv1 is ReentrancyGuard {
  ...
  constructor(address _spaceportGenerator) public {
    ...
    PLASMASWAP_FACTORY = IPlasmaswapFactory(0x06AC9D070bD01a42a198373F34547cFF26FBDbdC);
    WETH = IWETH(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    SPACEPORT_SETTINGS = ISpaceportSettings(0x9626F20EFaD0A86907828a4349BF2F0dCc5FB7A4);
    SPACEPORT_LOCK_FORWARDER = ISpaceportLockForwarder(0xeb6f6eCD825f7D7fDA3Fd0020e0857963e08e35B);
...

{
  ...
  "libraries": {
    "/Users/pavelbulochkin/plasmapay/Plasma-contracts/Spaceport-IDO-LaunchPad/contracts/Spaceport-v1-periphery/contracts/SpaceportHelper.sol": {
      "SpaceportHelper": "0x00B9D55C472e98C04245e0Fd036EeAa6a022fE55"
    }
  },
  "outputSelection": {
    "*": {
