...
contract SaleAirDrop is Ownable{
    ...
    */
    ...
    function getAirDropInWallet(address addr) external view returns(bool) {
        return _airDropInWallet[addr];
    }

    function setAirDropInWallet(address addr, bool trueOrFalse) external onlyOwner {
        _airDropInWallet[addr] = trueOrFalse;
    }
