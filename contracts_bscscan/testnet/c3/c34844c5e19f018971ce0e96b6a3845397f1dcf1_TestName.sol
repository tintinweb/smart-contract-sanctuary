...
contract TestName is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("TestName11","Symbol11")  {
        setBaseURI(baseURI);
    }
    ...
    function genID() private returns(uint256) {
        uint256 scope = MAX_Supply+1-scopeIndex;
        uint256 swap;
        uint256 result;
    ...
    function mint(uint256 numTestName) public payable {
        require(hasSaleStarted == true, "Sale hasn't started");
        require(totalSupply() < MAX_Supply, "All TestName have been sold");
        require(numTestName > 0 && numTestName <= 11, "You can mint minimum 1, maximum 11 TestName");
        require(totalSupply().add(numTestName) <= MAX_Supply, "Exceeds MAX_Supply");
        require(msg.value >= price.mul(numTestName), "Ether value sent is below the price");
