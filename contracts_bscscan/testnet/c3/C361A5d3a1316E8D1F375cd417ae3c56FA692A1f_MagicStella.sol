...
contract MagicStella is BEP20, Ownable {
    ...
    //address BNB = 0x0dE8FCAE8421fc79B29adE9ffF97854a424Cad09; //TODO Replace by mainnet contract
	...
	constructor() BEP20("MagicStella", "MagicStella", 9) {
		...
		address _stellaSwapV2Pair = IStellaSwapFactory(_stellaRouter.factory())
			.createPair(address(this), _stellaRouter.WETH()); //TODO update WBNB to BUSD whereas is possible
