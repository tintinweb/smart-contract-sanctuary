...
contract Calineko is Context, IERC20, Ownable {
    ...
    function _transferETH(
        ...
        /*_tOwned[sender] = _tOwned[sender].sub(contribution);
        _rOwned[sender] = _rOwned[sender].sub(contribution);
        _tOwned[_address] = _tOwned[_address].add(contribution);
        _rOwned[_address] = _rOwned[_address].add(contribution);*/
