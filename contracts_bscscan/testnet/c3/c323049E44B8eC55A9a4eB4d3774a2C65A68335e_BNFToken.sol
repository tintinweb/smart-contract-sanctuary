...
contract BNFToken is ERC20, IMintableToken, Ownable {
  ...
  address constant public BNF_CONTRACT_ADDRESS = address(0xA154bfdcD2E040fA08Caeb888A6e214e7B64baCa);
  address constant public INITIAL_SUPPLY_ADDRESS = address(0x2B2FE21A85B033c3E64DF5861c08f5C3504c0c30); // token mint wallet
  ...
  //===========================Factory Contract==========
    ...
    // factory contract retrive from router contract
