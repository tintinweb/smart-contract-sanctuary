...
// #Features:
// This smart contract handles all the technical creation of the NFTs.
...
contract VNYWrappedNFT is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    IERC20 public constant vnyToken = IERC20(0xAbc69f2025bDb12efcdB8fd048d240fFf943ca82);

    constructor() public ERC721("VNYWrappedNFT", "VNYWRAPPEDNFT") {
    ...
    function setAuthorized(address addy, bool auth) external onlyOwner returns (bool){
    ...
    function mintNFT(address payable recipient, string calldata needle, uint256 tokenAmount) external returns (uint256)
    {
        ...
        needleMapWeight[needle] = needleMapWeight[needle].mul(8).div(10);
    ...
    function claim(string calldata needle) external returns (bool){
        dividendTracker.processAccount(msg.sender, false, needle);
    }
}
