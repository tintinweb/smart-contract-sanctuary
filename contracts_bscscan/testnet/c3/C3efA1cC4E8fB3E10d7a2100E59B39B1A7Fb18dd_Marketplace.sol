...
contract Marketplace is IERC721Receiver {
    ...
    function getOffer(address _nftAddress, uint256 _tokenId)
        external
        view
        ...
        validNFTContractAddress(_nftAddress)
    {
        ...
        quoteErc20.safeTransferFrom(msg.sender, _listing.owner, _listing.price);
    ...
    function _listingExists(Listing storage _listing) internal view returns (bool) {
