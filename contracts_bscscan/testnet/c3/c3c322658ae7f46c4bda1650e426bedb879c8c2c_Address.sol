...
// change "name1" into ur name
    contract Token_Inu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Token Inu";
    string private _symbol = "TOKENINU";
    ...
    constructor() public {
        ...
        marketingWallet = 0xc984EEa45C51B4fcA5cf9b9908D2D160f7aF7Bf9;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
