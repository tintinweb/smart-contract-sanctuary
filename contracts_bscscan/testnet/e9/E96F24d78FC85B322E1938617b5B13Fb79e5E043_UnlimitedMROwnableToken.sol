...
// File contracts/UnlimitedMROwnableToken.sol
...
contract UnlimitedMROwnableToken is BEP20Base, BEP20Mintable, BEP20Recoverable, FeeProcessor {
    constructor(
        string memory name,
        ...
        FeeProcessor(feeReceiver, "UnlimitedMROwnableToken")
        payable {

        require(initialSupply > 0, "UnlimitedMROwnableToken: initial supply cannot be zero");
