    ...
    IMetaxyNFT
{
    ...
    string public override baseMetaxyURI;
    ...
    constructor(string memory name_, string memory symbol_, address market721_)
    ...
    modifier onlyGenesisMinter() {
        require(
            ...
            "MetaxyERC721: caller is not genesis minter"
        );
        _;
    }

    /**
     * @dev set market721 to a new address.
     * Can only be called by the current owner.
     * @param newMarket721 the new market721 address
     */
    function setMarket721(address newMarket721) external onlyOwner {
        market721 = newMarket721;
    }
    ...
    function safeTransferFrom(
        ...
        require(_msgSender() == market721, "ERC721: transfer caller is not from market place");
