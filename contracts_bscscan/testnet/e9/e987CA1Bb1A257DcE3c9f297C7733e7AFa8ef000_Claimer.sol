...
contract Claimer is Ownable {
    ...
    function getClaimsInfo() public view returns(Claim[] memory) {
        return claims;
    }
    ...
    function getClaims(address account) external view returns (uint256[] memory, uint256[] memory, uint256[] memory, bool[] memory, uint256[] memory) {
    ...
    function getTotalAccountClaimable(address account) external view returns (uint256) {
    ...
    function getTotalAccountClaimed(address account) external view returns (uint256) {
        return claimedTotal[account] + getAlreadyDistributedAmount(allocation[account]);
    }
    ...
    function isClaimable(address account, uint256 claimIdx) public view returns (bool) {
    ...
    function isClaimed(address account, uint256 claimIdx) public view returns (bool) {
        return
