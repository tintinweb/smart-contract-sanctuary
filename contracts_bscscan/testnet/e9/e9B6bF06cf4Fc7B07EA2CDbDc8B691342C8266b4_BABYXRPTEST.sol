...
contract BABYXRPTEST is Context, IERC20, Ownable {
    ...
    address payable public xrpCharityWalletAddress = payable(0xd9Cb687EccC712A045eE3Af1542A4b057d8611C1); // xrp Address
    ...
    string private _name = "BABYXRPTEST";
    string private _symbol = "BBYXRPTEST";
