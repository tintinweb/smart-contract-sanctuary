...
contract Ownable is Context {
    ...
    function lock(uint256 time) public virtual onlyOwner { // The Lock functions allows the contract deployer to "temporarily" renounce contract ownership.
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked, and not enough time has passed to unlock.");
...
contract ETEST3V2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public devAddress = payable(0xD14516ffa978a08285CAdEcE569cD17a0398BE4e); // Marketing Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public lockedLiquidity = payable(0); // Locked Liquidity Address to be set once launched
    ...
    string private _name = "ETESTnet3 V2";
    string private _symbol = "ETEST3V2";
    ...
    uint256 public _buyLiquidityFee = 450;
    
    uint256 public _sellTaxFee = 50;
    uint256 public _sellLiquidityFee = 550;
    ...
    constructor () {
        ...
        // uniswap Router Testnet v2 - guess I'll go F myself
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //pcs V2 mainnet

        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // kovan testnet v2
    ...
    function isForSureABot(address account) public view returns (bool) {
        return _isForSureABot[account];
    }
    ...
    function _transfer(
        ...
        require(_isForSureABot[to] = false, "Recipient is unable to receive tokens");
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(devAddress, transferredBalance.mul(devDevisor).div(100));
    ...
    function calculateTaxFee(uint256) private view returns (uint256) {
        return _taxFee;
    }
    
    function calculateLiquidityFee(uint256) private view returns (uint256) {
    ...
    function isThisABot(address account) public view returns(bool) {
        return _isForSureABot[account];
    }
    ...
    function setdevDevisor(uint256 divisor) external onlyOwner {
        devDevisor = divisor;
    }
    ...
    function setLockedLiquidity(address _lockedLiquidity) external onlyOwner {
        lockedLiquidity = payable(_lockedLiquidity);
    }
    ...
    function removeBotfromTrading(address _user) external onlyOwner {
        _isForSureABot[_user] = true;
    }
    
    function oopsIAccidentlyAHuman(address _user) public onlyOwner {
        _isForSureABot[_user] = false;
    }    
    ...
    function updateRouterVersion(address _router) public onlyOwner returns(address _pair) {
