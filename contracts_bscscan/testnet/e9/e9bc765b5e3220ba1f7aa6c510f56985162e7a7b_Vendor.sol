...
contract Vendor is Ownable, ReentrancyGuard {
  ...
  /**
    ...
    */
  constructor (uint256 rate, address payable wallet, IBEP20 token) {
      require(rate > 0 && wallet != address(0) && address(token) != address(0));
  ...
  */
  ...
  function _deliverTokens(address beneficiary, uint256 tokenAmount) internal { _token.transfer(beneficiary, tokenAmount); }
