...
contract ArcaneLeagueToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ARCANELEAGUETOKEN";
    string private _symbol = "ARCANELEAGUETOKEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x54aD9808fd12493C1f673D3048D6BF0B3972b38A); // Marketing Address
    address payable public developmentWalletAddress = payable(0x728A55CEc216A5E90c188189eFAC965522b78E50); // Development Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    address public NFTAddress = 0x000000000000000000000000000000000000dEaD;
     ...
     */
    function spend(address from, uint256 value) external override returns (bool) {
        
        require(msg.sender == NFTAddress, "Address is not the NFT Address.");
