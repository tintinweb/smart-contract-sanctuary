...
contract SpintopToken is Ownable, BEP20Pausable, Blacklist {
    ...
    uint256 constant hardcap = 610000000000000000000000000;
    ...
    address address5 = 0xA971699A905c630B73D53C34b370055632a95aFd;
    //address address5;
    
    constructor() Ownable() BEP20('Spintop-Mock7','SPIN7')
    {
        _setupDecimals(numDecimals);
        //_mint(owner(), totalFreeSupply);
        _mint(address1, 40000000000000000000000000);
        _mint(address2, 20000000000000000000000000);
        _mint(address3, 20000000000000000000000000);
        _mint(address4, 20000000000000000000000000);
        _mint(address5, 18000000000000000000000000);
    }
