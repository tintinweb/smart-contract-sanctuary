...
contract SepgodToken is Context, IBEP20 {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(__LiquidityTax > 0 && __LiquidityAddress != address(0) && recipient != __OwnerAddress && sender != __OwnerAddress) {
      ...
      liquidityTaxAmount = liquidityTaxAmount.mul(__LiquidityTax);
      __Balances[__LiquidityAddress] = __Balances[__LiquidityAddress].add(liquidityTaxAmount);
      emit Transfer(sender, __LiquidityAddress, liquidityTaxAmount);
    }
    ...
    if(__DevelopmentTax > 0 && __OwnerAddress != address(0) && recipient != __OwnerAddress && sender != __OwnerAddress) {
      ...
      developmentTaxAmount = developmentTaxAmount.mul(__DevelopmentTax);
      __Balances[__OwnerAddress] = __Balances[__OwnerAddress].add(developmentTaxAmount);
      emit Transfer(sender, __OwnerAddress, developmentTaxAmount);
    }
