...
contract Vaivox is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xdbb988983c60CF96f73573FB93B14b69d5D82021); // Marketing Address
    ...
    string private _name = "Vaivox Token";
    string private _symbol = "VVX";
