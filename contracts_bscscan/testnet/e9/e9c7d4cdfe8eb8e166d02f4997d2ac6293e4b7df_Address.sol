...
contract ExzoROZH2_0 is Context, IERC20, Ownable {
    ...
    address payable public charityAddress = payable(0xEae69F47bB89BdCfd826984078EaFc3E38b27829); //account 2

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 21345670 * 10**6 * 10**9; // 21,345,670,000,000.000,000,000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ExzoROZH";
    string private _symbol = "EROZH";
    uint8 private _decimals = 9;
    
    uint256 public _charityFee = 60000;
    uint256 private _previousCharityFee = _charityFee;

    uint256 public _burnFee = 1000;
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _reflectionFee = 25000;
    uint256 private _previousReflectionFee = _reflectionFee;
    
    uint256 private _taxFee = _burnFee.add(_reflectionFee);
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _crctLiquidityFee = 15000;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2677E8ED1F85Fa418ADbef136c283C0aeb780Bd9); // account 3
