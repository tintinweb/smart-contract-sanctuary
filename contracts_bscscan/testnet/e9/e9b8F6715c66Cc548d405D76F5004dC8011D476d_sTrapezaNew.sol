...
contract sTrapezaNew is ERC20Permit, Ownable {
    ...
    uint public INDEX;
    IERC20 private oldsFidl;
    address private constant OLD_STAKING_ADDRESS = 0x0e41Cd1691F50766595B4Ad5Cd25567cE2C657E6;
    ...
    constructor(address _oldSFidl) ERC20("Staked Trapeza", "sFIDL", 9) ERC20Permit() {
        initializer = msg.sender;
        _totalSupply = INITIAL_FRAGMENTS_SUPPLY;
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);

        require(_oldSFidl != address(0), "Zero address: sOHM");
        oldsFidl = IERC20(_oldSFidl);
    }
    ...
    function circulatingSupply() public view returns ( uint ) {
        return _totalSupply.sub( balanceOf( stakingContract ) ).add(oldsFidl.totalSupply() - oldsFidl.balanceOf(OLD_STAKING_ADDRESS));
    }
