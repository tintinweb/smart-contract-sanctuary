...
contract STANDARD_TOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _devWalletAddress = address(0x10548823e477A8feA3daa85d87E0F8700c265Aaa); // fee for development
    ...
    constructor(string memory _token_name, string memory _token_symbol, uint256 _supply) ERC20(_token_name, _token_symbol) {
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 devTokens = (contractTokenBalance.mul(totalFees).div(100));
            if(devTokens > 0){
