...
/**
    ...
    Great features:
    3% fee auto add to the liquidity pool to burn
...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github-dotcom.gateway.web.tr/ethereum/solidity/issues/2691
        return msg.data;
    }
}
...
interface IBEP20 {
     ...
     * https://github-dotcom.gateway.web.tr/ethereum/EIPs/issues/20#issuecomment-263524729
     *
...
contract Token is Ownable, IBEP20 {
    ...
    address private _ownerAddress = payable(0xaCb4085ee68CFACd39900816a5192e624D775A99);

    // Address of  Investment Fund
    address private _InvestmentFund = payable(0xaCb4085ee68CFACd39900816a5192e624D775A99);

    // Address of marketing and dev
    address private _marketingDev = payable(0xaCb4085ee68CFACd39900816a5192e624D775A99);

    // Address of  AR Game
    address private _ArGame = payable(0xaCb4085ee68CFACd39900816a5192e624D775A99);

    // Address of Service for sale
    address private _service = payable(0xaCb4085ee68CFACd39900816a5192e624D775A99);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tokenTotal = 1 * 9**15 * 10**10;
    uint256 private _reflectTotal = (MAX - (MAX % _tokenTotal));
    uint256 private _tokenFeeTotal;

    string public _name = "TESNET LAGII WOII";
    string public _symbol = "TESNET KE 2";
    uint8 private _decimals = 9;

    uint256 private _distributeFee = 3;
    uint256 private _fundOrBurnFee = 3;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_InvestmentFund] = true;
        _isExcludedFromFee[_marketingDev] = true;
        _isExcludedFromFee[_ArGame] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != owner() && to != owner()) {
            ...
            require(_tokenOwned[to] + amount <= _maxTokenHold, "Recipient's wallet will exceed max token hold 500,000,000  with your amount");
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance, uint256 donateFund, uint256 donateDev, bool burn) private lockTheSwap {
        ...
        if (burn) {
            ...
            TransferBnbToExternalAddress(_InvestmentFund, fundBalance);
