...
interface ApproveAndCallFallBack {
    function receiveApproval(address tokenOwner, uint256 amount, address tokenContract) external;
}
...
contract SWAPToken is ApproveAndCallFallBack, IBSC, Owned {
    ...
    function receiveApproval(address _tokenOwner, uint256 _amount, address _tokenContract) public override {
