...
contract HandyMan2Presale {
    ...
    uint256 public startDate = 1627383151;                  // July 8, 2021 01:00:00 AM UTC
    uint256 public endDate = 1635331951;                    // July 15, 2021 01:00:00 AM UTC
    
    uint256 public totalTokensToSell = 10000 * 10**18;          // 10000 tokens for sell
    uint256 public tokenPerBnb = 1 * 10**18;                // 1 BNB = 1 TOKEN
    uint256 public minPerTransaction = 0;                   // min amount per transaction
    uint256 public maxPerUser = 10000 * 10**18;                 // max amount per user
