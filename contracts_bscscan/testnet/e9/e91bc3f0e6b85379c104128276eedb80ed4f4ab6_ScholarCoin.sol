...
contract ScholarCoin is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Scholar Coin";
    string constant _symbol = "Scholar";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 80000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1; //0.5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 1) / 1; // 1%
    ...
    uint256 public swapThreshold = _totalSupply / 200000; // 0.05%
    bool inSwap;
