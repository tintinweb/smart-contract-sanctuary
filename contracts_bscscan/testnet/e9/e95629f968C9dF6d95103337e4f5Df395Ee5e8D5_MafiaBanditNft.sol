...
contract MafiaBanditNft is ERC721Enumerable, Ownable {  
    using Address for address;
    ...
    uint256 public constant MAX_SUPPLY = 75000;
    ...
    address public a1 = 0xf54423c2E93F142c55979016c5C0F419F00EE046;
    address public a2 = 0xB44D92D3471969D615e7FD22b043eB3CD6AccA0F;

    constructor () ERC721 ("Bandit", "BDT") {
        price = initial_price;
    }
    ...
    function withdrawTeam(uint256 amount) public payable onlyOwner {
        ...
        require(payable(a1).send(percent * 87));
        require(payable(a2).send(percent * 13));
    }
}