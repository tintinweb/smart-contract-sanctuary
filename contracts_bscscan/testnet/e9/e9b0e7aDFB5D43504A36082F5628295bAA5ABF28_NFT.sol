...
contract Auction is ReentrancyGuard {
    ...
    function placeBid() nonReentrant() payable external returns(bool){
    ...
    function withdrawToken() nonReentrant() external returns(bool){
    ...
    function withdrawFunds() nonReentrant() external returns(bool){
        require(getAuctionState() == AuctionState.ENDED || getAuctionState() == AuctionState.DIRECT_BUY); // The auction must be ended by either a direct buy or timeout
    ...
    function cancelAuction() nonReentrant() external returns(bool){ // Cancel the auction
...
contract NFT is ERC721,ReentrancyGuard {
  ...
  constructor() ERC721("Tetra Hedra NFT", "TTHNFT") {}
  ...
  */
  ...
  function getItem() nonReentrant() payable public returns (uint256) {
