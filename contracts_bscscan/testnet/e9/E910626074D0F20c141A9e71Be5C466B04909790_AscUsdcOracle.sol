...
//    uint public constant PERIOD = 24 hours;
    ...
    constructor(address factory, address tokenA, address tokenB) public {
        ...
        require(reserve0 != 0 && reserve1 != 0, 'AscUsdcOracle: NO_RESERVES'); // ensure that there's liquidity in the pair
    }
    ...
    function update() external {
        ...
        require(timeElapsed >= PERIOD, 'AscUsdcOracle: PERIOD_NOT_ELAPSED');
    ...
    function consult(address token, uint amountIn) external view returns (uint amountOut) {
        if (token == token0) {
            ...
            require(token == token1, 'AscUsdcOracle: INVALID_TOKEN');
