...
// File contracts/CYFToken.sol

contract Cyforce is ERC20, Ownable, ERC20Burnable, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    
    uint256 private _totalSupply = 300 * 10**6 * 10 ** decimals(); //300M tokens
    ...
    function setBots(address _bot) external onlyOwner {
        require(!bots[_bot]);
    ...
    function setEnableAntibot(bool _enableAntiBot) external onlyOwner {
        antiBotEnabled = _enableAntiBot;
    }
