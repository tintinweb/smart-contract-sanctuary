...
contract AlexandriaTEST is Ownable {
    ...
    // Timestamps for the start of Private sale, Public sale and Claim phase
    ...
    constructor(address _alxAddr, uint256 _depositTimestamp, uint256 _claimTimestamp, uint256 _publicTimestamp) {
        ALX = _alxAddr;
        DAI = ERC20(0x8a9424745056Eb399FD19a0EC26A14316684e274);
    ...
    /* allow non-blacklisted users to buy ALX */
    ...
    function presaleBuy(uint256 amount) public onlyEOA {
        require(depositTimestamp <= block.timestamp, "deposit not started");
        // est dans la presale OU timestamp après public
