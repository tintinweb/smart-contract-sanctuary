...
contract ContratoTeste is IBEP20, Auth {
    ...
    string constant _name = "Cteste";
    string constant _symbol = "CTeste";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 20000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; // 1kk max
    uint256 public _maxWalletToken = _totalSupply / 1; // 20kk max;
