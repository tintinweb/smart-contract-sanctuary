...
// File: contracts/RandomNumberGeneratorBase.sol
...
contract RandomNumberGeneratorBase is IRandomNumberGenerator, Ownable {
    address public lottery;
    uint256 public randomResult;
    uint256 public latestGameId;

    /**
     * @notice View latestGameId
     */
    function viewLatestGameId() external view override returns (uint256) {
        return latestGameId;
    }
     ...
     * @param _seed seed provided
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == lottery, "Only Lottery");
        randomResult = uint256(keccak256(abi.encodePacked(_seed)));
        latestGameId = ILottery(lottery).viewCurrentGameId();
    }
}