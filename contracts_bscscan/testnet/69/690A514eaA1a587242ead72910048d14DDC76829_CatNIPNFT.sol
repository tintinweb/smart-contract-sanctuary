...
contract CatNIPNFT is Context, IERC165, IERC721, IERC721Metadata, IERC721Receiver {
    ...
    //////////////////////////// NIP VARS ////////////////////////////  
    address public nipContractAddress = 0x4b075Cd50D8Ac2b1b4ADA34fAfbd5B43a70186EE;       // CHANGEIT - set the right contract address
    ...
    function MintCatNIPNFT(string memory tokenURIstring, uint256 costOfNFT, uint256 codeForCatMechanism, uint256 codeForStats, string memory codeKEK, uint256 codeANow, string memory codeBNow, uint256 codeCNow, uint256 codeDNow) public returns (uint256) {
        ...
        require(codeForStats == 777, "Wrong code format."); 
        require(codeForKEK == keccak256(abi.encodePacked(codeKEK)), "Wrong code format."); 
        ...
        require(codeForCatMechanism < currentCode.add(timerRange) && codeForCatMechanism > currentCode.sub(timerRange), "Wrong code format.");        // this means it's in range    

        emit Debug1(codeForCatMechanism);
        emit Debug1(currentCode);
