...
contract DiaoCoin is PausableToken, FrozenableToken {
    string public name = "Diao Coin";
    string public symbol = "DC";
    uint256 public decimals = 18;
    uint256 INITIAL_SUPPLY = 123456 * (10**uint256(decimals));
    ...
    function transferFrom(
        ...
        address _to,
        uint256 _value
    ) public override whenNotFrozen(_from) returns (bool) {
        return super.transferFrom(_from, _to, _value);
    }
}
