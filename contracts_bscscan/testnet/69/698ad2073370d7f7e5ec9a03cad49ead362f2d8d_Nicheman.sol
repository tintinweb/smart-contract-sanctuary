...
contract Nicheman is OwnableUpgradeable, ERC20Upgradeable, ERC20PermitUpgradeable, INicheman  {
    ...
    function initialize( address _router, address factory) public initializer {
        reflectionFee = 1000; // in basis points, so 1% on default;
        liquidityBuyFee = 1000; // in basis points, so 1% on default;
        liquiditySellFee = 2000; // in basis points, so 1% on default;
    ...
    function setDefaultRouter2(address _router) public override onlyOwner {
...
interface INicheman is IBEP20, IERC20PermitUpgradeable {
    ...
    function setDefaultRouter2(address _router) external;
