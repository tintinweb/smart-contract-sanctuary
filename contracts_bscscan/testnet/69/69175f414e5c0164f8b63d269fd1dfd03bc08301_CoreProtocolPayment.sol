...
contract Merchant{
    ...
    function removedmin(address adminAddress)external {
        _admins[adminAddress] = false;
    }
}

contract CoreProtocolPayment is Context{
    string public _name = 'Core Protocol Payment';
    ...
    function approveMerchantApplication(address applicantAddress, string calldata merchantName) public onlyAdmin(){
        Merchant merchant = new Merchant(applicantAddress, merchantName);
