...
SexyShiba ($SEXY) is the next moonshot on bsc - trust the team, trust the process.
SexyShiba has unique tokenomics that favor and reward the holders.
Gain access to $CAKE rewards through SexyShiba- as easy as that.

TG: https://t.me/sexyshiba_bsc
*/
...
contract SexyShiba is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x71E84412F0Fb99Bb55A5b20144D4b7cC57199B5D; // token locker
    address public marketingFeeReceiver =
        0x71E84412F0Fb99Bb55A5b20144D4b7cC57199B5D;
    address public ecosystemFeeReceiver =
        0x200f2aCcE483c2Dad0289AF65ABBfA13f4D68934;
    ...
    constructor()
        ERC20Detailed("SexyShiba", "$SEXY", uint8(DECIMALS))
    {
