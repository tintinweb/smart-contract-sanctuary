...
/*
   Laughing Emoji Token
    
https://t.me/laughingemojitoken
 
10% reward in BUSD, 6% LP , 3% dev fee
...
contract FNtest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FNtest";
    string constant _symbol = "FN";
