...
// File: Infinirise Finance/libs/IDividendDistributor.sol
...
// File: Infinirise Finance/libs/IDEX.sol
...
// File: Infinirise Finance/libs/SafeMath.sol
...
// File: Infinirise Finance/libs/Auth.sol
...
// File: Infinirise Finance/libs/IBEP20.sol
...
// File: Infinirise Finance/DividendDistributor.sol
...
// File: Infinirise Finance/DistributorFactory.sol
...
contract DistributorFactory {
    ...
    function addDistributor(
        ...
        require(
            ...
            "Infinirise/Distributor already exists"
        );
        ...
        returns (bool)
    {
        require(
            distributorsMapping[_BEP_TOKEN].exists,
            "Infinirise/Distributor not found"
        );
...
// File: Infinirise Finance/InfiniriseFinance.sol
...
contract Infinirise is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Infinirise Finance";
    string constant _symbol = "IRF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 200_000_000_000 * (10**_decimals);
    ...
    function permit(
        ...
        require(holder != address(0), "Infinirise/invalid-address-0");
        require(
            holder == ecrecover(digest, v, r, s),
            "Infinirise/invalid-permit"
        );
        require(
            expiry == 0 || block.timestamp <= expiry,
            "Infinirise/permit-expired"
        );
        require(nonce == nonces[holder]++, "Infinirise/invalid-nonce");
