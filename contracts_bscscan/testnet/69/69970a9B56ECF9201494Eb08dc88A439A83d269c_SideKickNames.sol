...
contract SideKickNames {
        ...
        returns (bool _success)
    {
        ...
        require(payRooted(isNamed, msg.sender), "Must pay required fee");
    ...
    function payRooted(bool isNamed, address payee) private returns (bool _success) {
        if (isNamed) {
            rooted.transferFrom(payee, address(this), taxedPrice);
        }
        rooted.transferFrom(payee, address(this), price);
        return _success;
    }
