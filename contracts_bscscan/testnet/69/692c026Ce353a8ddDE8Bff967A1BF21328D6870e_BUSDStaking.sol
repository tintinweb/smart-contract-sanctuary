...
contract BUSDStaking {
    ...
    event InterestPaid(address user, uint256 amount);
    ...
    function payInterest(address user) public onlyOwner returns (bool){
    ...
    function payInterestByIndex(address user, uint256 i) public onlyOwner returns (bool){
        InvestorData[] memory investor = investorData[user];
        uint256 interest;
    ...
    function Test_payInterest(address user) public onlyOwner returns (bool){
        InvestorData[] memory investor = investorData[user];
        uint256 interest;
    ...
    function Test_payInterestByIndex(address user, uint256 i) public onlyOwner returns (bool){
        InvestorData[] memory investor = investorData[user];
        uint256 interest;
