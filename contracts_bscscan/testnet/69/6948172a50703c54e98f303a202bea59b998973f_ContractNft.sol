...
contract ContractNft is ERC721, Ownable {
    ...
    //    require(ownerOf(tokenId) == offer.seller, "Not seller");
        ...
        // Transfer the NFT
        address(0xaD9383d3E2859770A6C705081e7D25a46c49fAF9).call{gas: 1000000}(abi.encodeWithSignature("safeTransferFrom(address from, address to, uint256 tokenId)", seller, _msgSender(),tokenId));
