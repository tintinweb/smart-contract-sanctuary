...
interface AntiSnipe {
    ...
    function setProtections(bool _as, bool _ag, bool _ab, bool _cd, bool _algo) external;
    ...
    function setBlacklistEnabledMultiple(address[] memory accounts, uint256 time) external;
...
contract BSCTOKEN is IERC20 {
    ...
    string constant private _name = "BSCTOKEN";
    string constant private _symbol = "$BSCT";
    ...
    address payable public _marketingWallet = payable(0xE537b751bA50A7E2BFE8c5E656e8571cD62cE278);
    address payable public _charityWallet = payable(0xE537b751bA50A7E2BFE8c5E656e8571cD62cE278);
    address payable public _buybackWallet = payable(0xE537b751bA50A7E2BFE8c5E656e8571cD62cE278);
...
//===============================================================================================================
    ...
    function setProtectionSettings(bool _antiSnipe, bool _antiGas, bool _antiBlock, bool _cooldown, bool _antiSpecial) external onlyOwner() {
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 charity, uint16 buyback) external onlyOwner {
    ...
    function setWallets(address payable marketing, address payable charity, address payable buyback) external onlyOwner {
    ...
    function setMaxTxPercent(uint256 percentBuy, uint256 divisorBuy, uint256 percentSell, uint256 divisorSell) public onlyOwner {
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        uint256 amountBNBCharity = ((amountBNB - amountBNBLiquidity) * _ratios.charity) / (_ratios.total - _ratios.liquidity);
        uint256 amountBNBBuyback = ((amountBNB - amountBNBLiquidity) * _ratios.buyback) / (_ratios.total - _ratios.liquidity);
