...
https://www.shibajunior.com/
https://t.me/ShibJunior
...
Owner wallet 
0x9311b5F0a5F1833037Ecb8Db145aa796902201dF 

Marketing wallet 
0x1c61ff691f8D89513B3B8CA9BA7433a7f19c943b 
...
Reflection will be removed at a later date! XXXXXXX
...
contract SHIBAJUNIOR is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0); 
    address payable public Wallet_Dev = payable(0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0); 
    ...
    string private constant _name = "SHIBA JUNIOR"; 
    string private constant _symbol = unicode"♛SHIBJ♛"; 
    ...
    */
    ...
    function _set_Fees(uint256 Liquidity, uint256 Marketing, uint256 Reflection, uint256 Burn) external onlyOwner() {
        ...
        require((Liquidity+Marketing+Reflection+Burn+_FeeDev) <= _FeeMaxPossible, "Total fees set to high!");
