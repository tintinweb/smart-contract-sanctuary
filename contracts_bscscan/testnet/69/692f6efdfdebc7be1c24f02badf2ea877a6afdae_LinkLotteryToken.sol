...
contract LinkLotteryToken is linkStandardToken, ERC677Token {

  uint public constant totalSupply = 10**27;
  string public constant name = 'Link Lottery Token';
  uint8 public constant decimals = 18;
  string public constant symbol = 'LOTTERYLINK';
  uint _drop;

  function LinkLotteryToken()
    public
  {
