...
/**
 * Fast NEYMO just started
 * NEYMO NEYMO NEYMO NEYMO NEYMO NEYMO NEYMO NEYMO NEYMO NEYMO give us money
 */
...
/**
*NEYMO NEYMOToken contract
*/


  contract NEYMOToken is ERC20 {
...
function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
 ...
 function allowance(address _owner, address _spender) public view returns (uint256) {
  ...
  contract PausableToken is NEYMOToken, Pausable {
...
*/
  ...
  contract NEYMO is PausableToken {
      string public name;
