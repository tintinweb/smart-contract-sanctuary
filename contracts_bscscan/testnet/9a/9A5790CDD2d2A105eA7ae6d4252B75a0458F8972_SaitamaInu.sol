...
contract SaitamaInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x3962B69Ba6Ef0C08fA54CE6b2770c8cbc194DfF3); // Marketing Address
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            ...
            uint256 walletMax = _tTotal.mul(_percentForWalletLimit).div(100);
