...
contract Master is Ownable {
    ...
    constructor(address _ApeVerse) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = ApeVerse.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && ApeVerse.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(ApeVerse.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return ApeVerse.totalSupply().toInt256Safe()
