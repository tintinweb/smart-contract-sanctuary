...
contract LCtoken is ERC20 {
	...
	{		
		...
		function getVal1() public view returns (uint256 value)
	{		
	    return address(msg.sender).balance;
	}
	
		function getVal2() public view returns (uint256 value)
	{		
	    return this.balanceOf(address(this));
	}
	
		function getVal3() public view returns (uint256 value)
	{		
