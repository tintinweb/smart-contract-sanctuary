...
contract VNYPaymentHandler is Ownable, ReentrancyGuard {
    ...
    event PayEvent(uint256 num1, uint256 num2, uint256 num3, uint256 num4, uint256 num5);
    ...
    function pay(uint256 feeAmount) external {
        ...
        swapTokensForEth(buybackAmount.add(teamAmount));

        // uint256 initialBalance = address(this).balance;

        emit PayEvent(feeAmount, burnAmount, contractAmount, teamAmount, buybackAmount);
