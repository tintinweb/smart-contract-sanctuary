...
/**
    Project BSC: Mini8Ball
    
    Mini8Ball features:
    12% Tax sell or over every Transfer
    ---------------------------------
    2% Holders Fee
    3% Liquidity Fee
    1% Teeam dev Fee 
...
contract Mini8Ball is Context, IERC20, Ownable {
    ...
    string private _name   = "Mini8Ball";
    string private _symbol = "Ball";
    ...
    uint256 public _Marketing   = 7;
    address public Marketingwallet = 0xe21dA53539B4bC9bE832FBA039B6c71C14E5A334;
    uint256 private _previousMarketing = _Marketing;
    ...
    uint256 public _maxTxAmount = 1500000000 * 10**6 * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Calculate burn amount and BurnCharity amount
        uint256 burnAmt = amount.mul(_burnFee).div(100);
        uint256 BurnCharityAmt = amount.mul(_Marketing).div(100);
        ...
        _transferStandard(sender, Marketingwallet, BurnCharityAmt);
