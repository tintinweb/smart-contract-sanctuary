...
contract BBNB is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf2e35f6045EEF4664cBC142627173d69A88DE90b); // Marketing Address
    address payable public charityAddress = payable(0xf2e35f6045EEF4664cBC142627173d69A88DE90b); // Charity/Dev Address
    ...
    uint256 private _tTotal = 85000000000 * 10**18; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BabyBNB"; // nice
    string private _symbol = "BBNB";
    ...
    uint256 public _maxTxAmount = 85000000000 * 10**18;  
    ...
    constructor () 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf2e35f6045EEF4664cBC142627173d69A88DE90b);
