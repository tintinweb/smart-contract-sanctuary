...
interface IDividendDistributor {
    function changeToken(address newTargetToken) external;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06);
    ...
    function changeToken(address newTargetToken) external override onlyToken {
...
contract EarnIt is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "EarnIt";
    string constant _symbol = "EarnIt";
    ...
    uint256 public _sellMultiplierNumerator = 130;
    ...
    function setReflectToken(address newTargetToken) external onlyOwner {
        require(newTargetToken.isContract(), "Enter valid contract address");
        distributor.changeToken(newTargetToken);
    }
