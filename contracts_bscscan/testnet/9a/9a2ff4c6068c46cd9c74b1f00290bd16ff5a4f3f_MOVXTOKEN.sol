...
contract MOVXTOKEN is Context, IBEP20, Ownable {
    ...
    uint256 public _sellMaxTxAmount    = 2000000 * 10**9; // 0.3% of total supply
    ...
    function sendBNBToWallet1(uint256 amount) private {
        _marketingWallet.transfer(amount);
    }
    
    function sendBNBToWallet2(uint256 amount) private {
        _researchWallet.transfer(amount);
    }
    
    function sendBNBToWallet3(uint256 amount) private {
    ...
    function manualSend() public onlyOwner() {
        uint256 contractBNBBalance1 = address(this).balance;
        uint256 contractBNBBalance2 = address(this).balance;
        uint256 contractBNBBalance3 = address(this).balance;
        sendBNBToWallet1(contractBNBBalance1);
        sendBNBToWallet2(contractBNBBalance2);
        sendBNBToWallet3(contractBNBBalance3);
    }
