...
contract CDOG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xfc78A051BF1A0903e60cbd7388512Cb1c1145795); // Marketing Address
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xfc78A051BF1A0903e60cbd7388512Cb1c1145795);
    }
