...
contract TeamSplitter {
    ...
    function distribute() public returns (bool _success) {
        ...
        _teamMember[1].baseBalance += base.mul(2000).div(10000);
        _teamMember[2].baseBalance += base.mul(1000).div(10000);
        _teamMember[3].baseBalance += base.mul(1000).div(10000);
        _teamMember[4].baseBalance += base.mul(1000).div(10000);
        _teamMember[5].baseBalance += base.mul(1000).div(10000);
        _teamMember[6].baseBalance += base.mul(1000).div(10000);
        _teamMember[7].baseBalance += base.mul(1000).div(10000);
        _teamMember[8].baseBalance += base.mul(1000).div(10000);
        _teamMember[9].baseBalance += base.mul(1000).div(10000);
    ...
    function distributeTokens(address _token) public returns (bool _success) {
        ...
        _teamMember[1].tokenBalance += tokens.mul(2000).div(10000);
        _teamMember[2].tokenBalance += tokens.mul(1000).div(10000);
        _teamMember[3].tokenBalance += tokens.mul(1000).div(10000);
        _teamMember[4].tokenBalance += tokens.mul(1000).div(10000);
        _teamMember[5].tokenBalance += tokens.mul(1000).div(10000);
        _teamMember[6].tokenBalance += tokens.mul(1000).div(10000);
        _teamMember[7].tokenBalance += tokens.mul(1000).div(10000);
        _teamMember[8].tokenBalance += tokens.mul(1000).div(10000);
        _teamMember[9].tokenBalance += tokens.mul(1000).div(10000);
