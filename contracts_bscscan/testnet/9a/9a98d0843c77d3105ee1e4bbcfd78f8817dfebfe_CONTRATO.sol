...
abstract contract Tokenomics {
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 2000; // 0.05% of the total supply
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Liquidity, 90, address(this) );
...
abstract contract NOMEToken is BaseRfiToken, Liquifier, Antiwhale {
    ...
    uint256 weiToSend = 10000000000000000;  // 0.01 BNB
    uint256 tokenToReceive = 1000000000;     
    using SafeMath for uint256;
