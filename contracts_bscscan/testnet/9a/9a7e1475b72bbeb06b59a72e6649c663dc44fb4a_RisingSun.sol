...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x1bD09973eD5Ba6b5ddBc93fbc19200B4a30d8029);
    address WBNB = 0x6C7Fc5cCf983E818e209873470179cCa6c3FF860;
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x0036E21CCed51756cC18C22d61f8a3b0b988A25A);
        _token = msg.sender;
    }
...
contract RisingSun is IBEP20, RSunAuth {
    ...
    address BUSD = 0x1bD09973eD5Ba6b5ddBc93fbc19200B4a30d8029;
    address WBNB = 0x6C7Fc5cCf983E818e209873470179cCa6c3FF860;
    ...
    constructor () RSunAuth(msg.sender) {
        router = IDEXRouter(0x0036E21CCed51756cC18C22d61f8a3b0b988A25A);
