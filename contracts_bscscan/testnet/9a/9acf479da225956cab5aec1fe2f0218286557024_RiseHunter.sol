...
import "./Risehunter-imports.sol";

/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `RiseHunter` at the very bottom **and** the `environment` into which
 * you are deploying the contract `RiseHunter(Env.Testnet)` or `RiseHunter(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "RiseHunter";
    string internal constant SYMBOL = "RISH";
     ...
     */
    address internal tipToTheDev = 0xce75e43553F439FfaD317E60449FF879a5cE4420;
...
contract RiseHunter is SafeToken{
