...
contract SparkToken is IBEP20
{
    ...
    event ReflectFee(address indexed sender, uint256 tFee, uint256 tSupply);
    ...
    function _reflectFee(address sender, uint256 rFee) private {
        
        if(!_takebonus) {
            return;
        }
        
        uint256 tFee = tokenFromReflection(rFee);
        ...
        emit ReflectFee(sender, tFee, tSupply);
    }
