...
20% Tax on all transactions

7% BNB Rewards to Giveaway (from each transaction)
7% redistributed to holders (tokens)
6% Liquidity Pool
...
contract MooneyTrain is Context, IBEP20, Ownable {
    ...
    string private _symbol   = "MNYTRAIN";
