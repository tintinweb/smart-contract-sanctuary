...
contract OlevelX is Context, IERC20, Ownable {
    ...
    string private _name = "OlevelX";
    string private _symbol = "OlevX";
    ...
    function get_HodlingTimeV3(address account) public view returns(uint256, uint256) {     
