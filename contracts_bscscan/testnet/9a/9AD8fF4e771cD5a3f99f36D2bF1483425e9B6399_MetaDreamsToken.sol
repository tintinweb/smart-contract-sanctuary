...
contract MetaDreamsToken is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MDXX7';
    string private constant _symbol = 'MDXX7';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 3000000000000000000000 * 10**_decimals;//equals 500B tokens
    ...
    //DevWallets
    address public teamWallet=payable(0x7a16AE36Fb86F42C8432Ba2CbE4bEF03bF79d5C2);
    address public marketingWallet=payable(0x0897b6f79Fb000Fa4BF6c7E8B972f09Fc95293f6);
    //MainNet
	...
	uint256 private antiWhale = 30000000000000000000 * 10**_decimals;
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==teamWallet||addr==marketingWallet;
    }
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(marketingWallet).transfer((amount*25) / 100);
    } 
    ...
    function TeamChangemarketingWallet(address newmarketingWallet) public onlyOwner{
