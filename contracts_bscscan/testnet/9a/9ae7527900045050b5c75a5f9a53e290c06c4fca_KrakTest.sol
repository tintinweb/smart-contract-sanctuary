...
contract KrakTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x2e73d5d7518de6F2Ae38D6f764812CAADfC8Ad1A); // Marketing Address
    ...
    string private _name = "KrakTest";
    string private _symbol = "KTEST";
