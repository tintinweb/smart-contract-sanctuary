...
contract Presale is ReentrancyGuard, Context, Ownable, IPresale{
    ...
    uint public override _firstTokenReleaseMinuteAfterLisiting;
    ...
    function initLaunchInfo(
        ...
        if (_usingTeamVesting)
        {
            ...
            _teamFirstReleasePercent = extraInfo[5];
...
interface IPresale {
    ...
    function _firstTokenReleaseMinuteAfterLisiting() external view returns (uint);
