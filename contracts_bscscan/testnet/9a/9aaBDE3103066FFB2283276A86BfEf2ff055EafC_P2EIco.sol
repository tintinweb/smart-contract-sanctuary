...
contract P2EIco {
    ...
    constructor(
        ERC20 _sendToken, address _sendTokenReceiver, IP2EToken _receiveToken, uint _idoPrice, TokenLocker _tokenLocker, uint256 _totalAmount
    ) {
    ...
    function deposit(address _receiver, uint256 _amount) external {
        ...
        uint receiveAmount = _amount.mul(uint(10) ** (sendTokenMisDecimal)).mul(PRICE_BASE).div(idoPrice).div(uint(10) ** (receiveTokenMisDecimal));
    ...
    function totalLockAmount() external returns (uint256) {
