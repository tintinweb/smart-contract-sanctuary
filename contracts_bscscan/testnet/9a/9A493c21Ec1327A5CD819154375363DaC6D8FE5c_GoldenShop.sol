...
contract GoldenShop{
    ...
    uint public buy_ratio_Token=10000;                      // 1 eth = 10.000 AOB
    uint public sell_ratio_Token=12000;                     // 1 eth = 12.000 AOB
    uint public minimum_buy_Token=1000000000000000;         // 0.001 BNB
    uint public minimum_sell_Token=100*1000000000000000000; // 100 AOB
    bool public buy_active = true;                          // true
    ...
    function buy_Token() public payable{
        require(buy_active==true, "[001] Token is not for sell right this time.");
        require(msg.value>=minimum_buy_Token, "[002] You can not buy less 10 Goldm (0.001 BNB)"); 
    ...
    function withdraw_all_BNB() public checkMaster{
        require(address(this).balance>0, "[011] Sorry, not BNB to withdraw");
        payable(owner).transfer(address(this).balance);
    }
