...
contract pad is Context, IERC20, Ownable {
    ...
    // testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 for https://pancake.kiemtienonline360.com/#/swap
    // mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E for https://pancakeswap.finance/
    ...
    */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            } else if(liqPairs[to] && balanceOf(to)>0) { //sell transaction (initial liq add is excluded)
    ...
    //give approval to multiple acounts to get token out of the communityRewardAddress
    ...
    //transfer community rewards get token out of the communityRewardAddress
