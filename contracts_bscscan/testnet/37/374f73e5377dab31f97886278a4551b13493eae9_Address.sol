...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4F78b1ED4F5740209d03e1A51222Cf56d2107362;
...
contract Bulbasaur is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x41D87c5C11AF97Ac7B8Bd48E315E4278c77Ce96D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bulbasaur";
    string private _symbol = "BULB";
