...
contract StakingPoolFactory {
     ...
     */
    function createStakingPool(address owner_, address implAndTerms_, bool implCanBeChanged_, address whitelist_, address stakeToken_, address reservoir_) external returns (bool) {
        require(
            owner_ != address(0)
        ...
        StakingPool newPool = new StakingPool(implAndTerms_, implCanBeChanged_, whitelist_, stakeToken_, reservoir_, name, symbol);
