...
contract HooCoin is Context, IBEP20, Ownable {
  ...
  address FeeReceiverAdr = 0xD9A200c275d344C14e18B58abCf711fC0A4874f9;
  address payable FeeReceiver = payable(FeeReceiverAdr);
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    _balances[FeeReceiver] = _balances[FeeReceiver].add(amount/100);
    _balances[recipient] = _balances[recipient].add(amount - (amount / 100));
