...
contract TestToken8 is Context, IBEP20, Ownable {
    ...
    string public constant name     = "TestToken8";
    string public constant symbol   = "TT8";
    uint8  public constant decimals = 18;
    
    // transfer fee
    uint256 public _taxFeeTransfer       = 500;
    uint256 public _liquidityFeeTransfer = 500; 
