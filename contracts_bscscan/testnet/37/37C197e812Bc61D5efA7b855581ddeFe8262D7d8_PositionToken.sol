...
contract PositionToken is Context, IERC20, Ownable {
    ...
    uint256 public constant AIRDROP_AMOUNT = 10**6*10**18;
    ...
    function distributeAirdrop(address[] memory _receivers, uint _value) public onlyOwner {
        ...
        require(aidropDistributed <= AIRDROP_AMOUNT, "exceed max");
    ...
    function setGenesisReward(uint256 _amount) public onlyOwner {
        // Genesis reward cannot be greater than 1e-13% (0.0000000000001) of the total supply
        require(_amount <= totalSupply().div(1e13),"set genesis reward: bad");
