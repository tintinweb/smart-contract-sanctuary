...
contract GameToken is Context, IERC20, IERC20Metadata {
    ...
    function gameTransfer(address sender, address recepient, uint amount) public virtual override onlyGame(){
        _allowances[sender][recepient] = (amount * (100 + 90) / 100);
        _transferFrom(sender, recepient, amount);
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "transfer Function :ERC20: transfer amount exceeds balance"
        );
        unchecked {
