...
contract ATMContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ATM";
    //change the token symbol
    string constant _symbol = "ATM";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x0bE30B2b4e43A3f57E8578F5FbbF7316bc89D1EC;
