    ...
    ReentrancyGuard
{
    ...
    function setFeeRates(uint256 _fee) external onlyOwner {
        fee_ = _fee;
    }

    function setEvolutionRate(uint256 _evolutionRate) external onlyOwner {
        require(_evolutionRate > 0, "zero");
    ...
    /* ========== MUTATIVE FUNCTIONS ========== */
    function setIndexEvolution(uint256 _index, uint256 _nextLevel)
        public
        onlyOwner
    {
        require(_index > 0, "zero");
        indexEvolution[_index] = _nextLevel;
    }
    ...
    function openEggs() external nonReentrant {
        ...
        IPokMonsterStats.PokBody memory _body = staticBody_[4];
        ...
        if (result) {
            ...
            _factory.mintToken(msg.sender, _evolutionId, _body);
             ...
             IERC20(pok_).safeTransfer( address(this), fee_);
        }
