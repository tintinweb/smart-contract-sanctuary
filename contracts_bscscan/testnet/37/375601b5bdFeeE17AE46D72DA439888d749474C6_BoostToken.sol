...
contract BoostToken is Context, IBEP20, Ownable {
    ...
    uint256 public _TAX_FEE = 500;
    uint256 private _previousTaxFee = _TAX_FEE;
    
    uint256 public _BURN_FEE = 500;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(isBlacklisted(sender) == false, "You are in blacklist");
