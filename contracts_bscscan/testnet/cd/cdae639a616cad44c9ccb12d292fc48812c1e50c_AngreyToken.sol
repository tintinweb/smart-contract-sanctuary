...
contract AngreyToken is Context, IERC20, Ownable {
    ...
    string private _name = "AngryToken";
    ...
    constructor () public {
        ...
        _rOwned[0x397f149591E9A35BE0eA47F62693bB01ec0dc030] = _rTotal.div(100).mul(6); // Seed Investment Pool - 6%
        ...
        _isExcludedFromFee[0x397f149591E9A35BE0eA47F62693bB01ec0dc030] = true; //Dev
        _isExcludedFromFee[0x08F299745d127D6596Ddc122FCE23Bdf0f0CdFca] = true; //Dev
        _isExcludedFromFee[0x92C93118EC51BAaF842239cb4FE74FA96dE61D06] = true; //Dev
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), 0x397f149591E9A35BE0eA47F62693bB01ec0dc030, 6000 * 10**6 * 10**9); // Seed Investment Pool - 6%
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if(balanceOf(address(0)) < 9000 * 10**6 * 10**9){
            _transferStandard(sender, address(0), burnAmt);
        } else if (_isExcludedFromFee[sender] = false){
            _transferStandard(sender, address(0), burnAmt);    
        }
