...
contract LuckyFortune is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc9f5A812745357D4730A71EAF8361941C931644A); // Marketing Address
    ...
    uint256 public _maxTxAmount = 9900000 * 10**6 * 10**9;
