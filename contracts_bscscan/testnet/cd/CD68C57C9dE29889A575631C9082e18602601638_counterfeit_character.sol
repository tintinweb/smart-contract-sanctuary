...
contract counterfeit_character is ERC721Enumerable, Ownable{
    ...
    constructor(address _beneficiary) ERC721("counterfeit", "counterfeit") {
        _baseTokenURI = "https://meebits.larvalabs.com/meebit/";
    ...
    function mint_character() public payable returns (uint256){
        require(totalSupply() <= 20000, "enough minting");
