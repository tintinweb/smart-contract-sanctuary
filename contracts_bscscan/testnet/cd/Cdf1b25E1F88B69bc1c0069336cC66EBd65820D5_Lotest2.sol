...
contract Lotest2 is Context, IERC20, Ownable { 
    ...
    string private _name = "Lotest2";
    string private _symbol = "Lotest2";
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         if (antiSniperArmed == true) {
            ...
            if (antiSniperBlock <= _whatTimeIsIt) {
                _reflectionFee = _setReflectionFee;
                _previousReflectionFee = _setReflectionFee;
   ...
   //FIX THIS IS WHERE PINK HAD THEIR ANTIBOT
        }
 ...
 function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        _setReflectionFee = reflectionFee;
    ...
    //    bool _enabled
        ...
        _reflectionFee = snipeReflectionFee;
