...
contract StakeForMoreSameToken is Ownable {
    ...
    */
    function _calculateReward(address _stakeHolder) private view returns (uint256) {
        ...
        if(balanceTokenInContract <= reward)
            return balanceTokenInContract;
    ...
    */
    function distributeRewards() public onlyOwner {
        for (uint256 s = 0; s < stakeHolders.length; s += 1) {
            ...
            uint256 reward = _calculateReward(stakeHolder);
