...
SaturnX is an improved fork of DogeX
*/
...
contract SaturnX is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SaturnX";
    string private constant _symbol = "SATURNX";
    ...
    address payable constant private _marketingAddress = payable(0xf046Ebb8B6b85A60aF90CeFF542C6d0628c81E8E);
    address payable constant private _buybackAddress = payable(0x18478E00EbAF68DAE1aB2F976e372e90c6463645);
    address payable constant private _projectMaintainence = payable(0xd0728687ba60CF0417E02A46188711c5B09a0Fc2);
    ...
    address public _oraclePriceFeed = 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//saturnx
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//saturnx
