...
Super Micro Shiba Inu

    750 Total amountTokens
    1 token max by
    1 token max sell
    10-15 max wallet
    

    router address of Pancakeswap.
...
contract SuperMicroShibaInu is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 750 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal;

    string private _name = "SuperMicroShibaInu";
    string private _symbol = "SUPERMICROSHIBA";
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // binance PANCAKE V2 - currently set for TestNet
