...
contract Comptroller is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
     ...
     * @param atlantisVaultRate_ The amount of Atlantis wei per block to distribute to LP Vault
     */
    function _setAtlantisVaultRate(address vault_, uint atlantisVaultRate_) public {
        require(msg.sender == admin, "only admin can set Atlantis LP vault rate");
    ...
    function _releaseToVaultInternal(address vault_) internal {
        ...
        atlantis.transfer(vault_, actualAmount);
    ...
    function getAtlantisAddress() public view returns (address) {
        return 0xD68655d5d04E1D863A83958FABC83eD58Cb0009a;
    }
}
...
contract ComptrollerV5Storage is ComptrollerV4Storage {
    ...
    struct VaultInfo {
        ...
        /// @notice Minimum release amount to LP Vault
    ...
    mapping(address => uint) public atlantisVaultRate;
     ...
     /// @notice The Atlantis LP vault info
