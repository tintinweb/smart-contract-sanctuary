...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _balances[0x2daECe952cF0cC8666d2aD19F19979113Bb44B57] = _totalSupply;
        emit Transfer(address(0), 0x2daECe952cF0cC8666d2aD19F19979113Bb44B57, _totalSupply);
    }
...
contract Gaming is BEP20 {
    ...
    */
    ...
    function buy(uint256 amount) public {
        require(_msgSender() != marketingWallet && _msgSender() != _devWallet,"The dev can't play game");
        require(amount>=gameSettings.minimumBuyForPotEligibility,"Less than min amount");
    ...
    function swapTokensForEthGame(uint256 tokenAmount) public {
    ...
    function sendToPair(uint256 amount) private{
        IWETH(weth).deposit{value: amount}();
        IWETH(weth).transfer(address(uniswapV2Pair), amount);
    }
