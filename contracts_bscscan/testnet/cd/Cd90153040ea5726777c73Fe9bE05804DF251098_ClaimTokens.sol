...
contract ClaimTokens is Context, Ownable{
    ...
    uint256 public launchTimePeriod; 
    ...
    function initialize(address tokenAddres) external onlyOwner {
        ...
        launchTimePeriod = block.timestamp;
    ...
    modifier threeMonthsOnly() {
        require(
            launchTimePeriod +90 days >= block.timestamp,
    ...
    modifier sixMonthsOnly() {
        require(launchTimePeriod + 180 days >= block.timestamp, "Tokens are not unlocked");
        _;
    }
