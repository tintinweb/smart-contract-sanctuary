...
contract ContractNft is ERC721, Ownable {
    ...
    //    require(ownerOf(tokenId) == offer.seller, "Not seller");
        ...
        // Transfer the NFT
        (bool success,) = address(0xaD9383d3E2859770A6C705081e7D25a46c49fAF9).call(abi.encodeWithSignature("safeTransferFrom(address from, address to, uint256 tokenId)", seller, _msgSender(),tokenId));
