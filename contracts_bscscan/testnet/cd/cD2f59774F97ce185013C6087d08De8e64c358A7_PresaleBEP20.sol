...
contract PresaleBEP20 is Ownable {
    ...
    address public immutable ETIGER = address(0x9572d6BC4e3190c43765E8E1A8a8D89374Bed543);
    ...
    function deposit(address presale_token, uint256 busdAmount) public {
    ...
    function releaseFunds(address tokenAddress, uint256 tokenAmount) external onlyOwner {
        IBEP20(tokenAddress).transfer(multisigAddress, tokenAmount);
    }
