...
contract RewardPoolPAYB is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public earnContract = IERC20(0x9BF37C96cee5B0b65E67De385FE72143370FfBd5); /// TODO : Add vault address, bsc testnet data
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            earnContract.safeTransfer(msg.sender, reward);
