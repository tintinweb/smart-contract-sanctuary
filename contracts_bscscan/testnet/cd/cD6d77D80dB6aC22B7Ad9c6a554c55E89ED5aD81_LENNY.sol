...
contract LENNY {
    ...
    uint256 public maxTokenPerAddress = 5000000000 * 10 ** 10; //
    ...
    function setCommunityContribution(bool _enabled) external Demokratia {
        communityContributionEnabled = _enabled;
    }

    function setContributionFeePerThousand(uint8 contributionFee) external Demokratia {
    ...
    constructor () {
        ...
        _balances[burningAddress] = 15000000000 * 10**10;
        emit Transfer(address(0), burningAddress, 15000000000 * 10**10);

        // set owner Address
        _isExcludedFromContribution[0x35BE2BF3523c820b66dD44908d4753d53F064fd5] = true;
        _excludedContribution.push(0x35BE2BF3523c820b66dD44908d4753d53F064fd5);
        _isExcludedFromRestriction[0x35BE2BF3523c820b66dD44908d4753d53F064fd5] = true;
        _excludedRestriction.push(0x35BE2BF3523c820b66dD44908d4753d53F064fd5);
        _balances[_msgSender()] = 100000000000 * 10**10;
        emit Transfer(address(0), burningAddress, 15000000000 * 10**10);
        ...
        addressDOSC = 0x36ef2CAe369B0597B44199F2C8902409FbF081F2;
