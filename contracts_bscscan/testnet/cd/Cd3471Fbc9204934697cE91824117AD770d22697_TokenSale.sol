...
contract TokenSale is Crowdsale {
    ...
    function buyToken(address _beneficiary) public payable {
        ...
        uint256 tokens = _getTokenAmount(msg.value) * 10 / 100;
...
contract VestingVault is Ownable {
        ...
        external
    {
        ...
        token.crowdsaleApprove(_recipient, address(this), _amount);
    ...
    function calculateGrantClaim(address _recipient) public view returns (uint256, uint256) {
        ...
        uint256 elapsedMonths = currentTime().sub(tokenGrant.startTime).div(1 minutes).add(1); 
