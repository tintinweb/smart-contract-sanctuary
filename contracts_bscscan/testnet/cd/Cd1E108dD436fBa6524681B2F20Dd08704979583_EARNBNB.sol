...
contract EARNBNB is Context, IBEP20, Ownable { // change contract name
     ...
     * @dev Anti sniper bot
     */
    function AntiSniperBot(address addresses) public onlyOwner(){
     ...
     */
    function AntiSniperBotsMultiple(address[] calldata addresses) public onlyOwner(){
     ...
     */
    function isAntiSniperBot(address addresses) public view returns (bool){
