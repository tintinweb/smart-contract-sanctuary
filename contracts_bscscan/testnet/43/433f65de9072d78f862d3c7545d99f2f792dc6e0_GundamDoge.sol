...
//Introducing GundamDoge, the most badass doge of them all. 
//Musk base is prepared for launch. The Bezos Federation can not and will not force the Gundam Doge forces to relive the massacre of 2032. 
//United the Musk Base has recruited an army of Mobile Doges and civilian anons to reclaim dominance of BSC.
//Tokenomics start on line 474. Welcome to GundamDoge
...
contract GundamDoge is Context, IERC20, Ownable {
    ...
    string private _name = "GundamDoge";
    string private _symbol = "GUNDOGE";
    ...
    address private _MarketingWallet = 0x24f749103c9cb116dBa688b3007c56201C4dABe7;
