...
miniakitozz is built upon the fundamentals of Buyback and increasing the investor's value
...
contract miniakitozz is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF4Cbc0147930C3F1E9920A2dB64BE02EcB4192aD); // Marketing Address
    ...
    string private _name = "miniakitozz";
    string private _symbol = "MKTZ";
