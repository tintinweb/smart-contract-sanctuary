...
/**
 Telegram Fr: https://t.me/QuaranteHuit_Officiel
 Telegram Us: https://t.me/FortyEight_Official
 Website: https://48hours-token.com/
*
/**
 * 48 hours and not even a second longer, This Token will self-destruct within 48 hours!
 * Will you be able to get in and out at the right time, make your profit?
 * The countdown is set and ready to start.
/**
 * 48 Hours Token
 * 
 * BUY TAXES (Token lifetime) : 3% Auto-Liquidity Fee | 1% Marketing Fee | 1% Giveway Fee
 * 
 * SELL TAXES :
 *              < 50K MARKET CAP : 23% Auto-Liquidity Fee | 8% Marketing Fee | 9% Giveway Fee : Total 40%
 *              < 50K to 100K MARKET CAP : 20% Auto-Liquidity Fee | 7% Marketing Fee | 8% Giveway Fee : Total 35%
 *              < 100K to 250K MARKET CAP : 18% Auto-Liquidity Fee | 5% Marketing Fee | 7% Giveway Fee : Total 30%
 *              < 250K to 500K MARKET CAP : 16% Auto-Liquidity Fee | 3% Marketing Fee | 6% Giveway Fee : Total 25%
 *              < 500K MARKET CAP : 10% Auto-Liquidity Fee | 2% Marketing Fee | 3% Giveway Fee : Total 15%
 * 
 * FUCK YOU SNIPER BOT AND HOLDERS
 *  
*/
...
contract HOURS48 is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "48HOURS";
    string private constant _symbol = "48HOURS";
    ...
    uint256 private constant _tTotal = 48000000000 * 10**9; // 48 000 000 000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _priceImpact = 10;
    uint256 private _firstBlock;
    uint256 private _botBlocks;
    uint256 public _maxWalletAmount = 230000000 * 10**9; //230 000 000
    ...
    uint256 constant private _projectMaintainencePercent = 2;
    uint256 private _marketingPercent = 98;
    ...
    address payable private _marketingAddress = payable(0xbFD7c47b145D797cc7D0099A9d9A11b096952e6F); //marketing
    address payable constant private _projectMaintainence = payable(0xbFD7c47b145D797cc7D0099A9d9A11b096952e6F); //giveaway
    ...
    uint256 private _maxTxAmount = 48000000 * 10**9; //48 000 000
    ...
    function getTokenPriceBNB(uint256 amount) external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//48HOURS
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//48HOURS
    ...
    function sendETHToFee(uint256 amount) private {
        if(block.timestamp < _firstBlock + (1 days)) {
            address payable addr = payable(0xbFD7c47b145D797cc7D0099A9d9A11b096952e6F);
