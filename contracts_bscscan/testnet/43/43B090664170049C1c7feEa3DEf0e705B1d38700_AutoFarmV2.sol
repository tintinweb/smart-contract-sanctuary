...
contract AutoFarmV2 is Ownable, ReentrancyGuard {
    ...
    constructor(address _AUTOv2) public {
        AUTOv2 = _AUTOv2;
    }
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({want: _want, allocPoint: _allocPoint, lastRewardBlock: lastRewardBlock, accAUTOPerShare: 0, strat: _strat}));
    }
