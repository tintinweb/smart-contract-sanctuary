...
contract SmallestRandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    address public racingTokenRouter;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        require(latestRequestId == requestId, "Wrong requestId");
         ...
         latestRaceId = IRacingTokenRouter(racingTokenRouter).viewCurrentRaceId();
    }   
