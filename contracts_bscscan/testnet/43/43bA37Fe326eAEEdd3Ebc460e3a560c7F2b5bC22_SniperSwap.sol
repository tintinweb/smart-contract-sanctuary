...
contract SniperSwap is Ownable {
    ...
    //         "Liquidity does not exist for that pair."
    //     );
    ...
    //     require(
    //         msg.sender ==
    //             UniswapV2Library.pairFor(address(_factory), token0, token1)
    //     );
    ...
    //     uint256 amountReceived = _router.swapExactTokensForTokens(
    //         amountToken,
    //         amountRequired,
    //         path,
    //         msg.sender,
    ...
    //             "Router didn't give enough tokens."
    //         );
    //     }
