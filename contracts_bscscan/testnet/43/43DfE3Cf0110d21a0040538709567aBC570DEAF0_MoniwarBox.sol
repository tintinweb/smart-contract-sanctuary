...
contract MoniwarBox is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        minoToken = _mowaToken;
        saleBoxs[0] = SaleBox(0, 720 * 10 ** 18, 1634265827, 1634371200, 1, 2);
        saleBoxs[1] = SaleBox(1, 480 * 10 ** 18, 1634265827, 1634371200, 1, 2);
        saleBoxs[2] = SaleBox(2, 240 * 10 ** 18, 1634265827, 1634371200, 1, 2);
    }
    ...
    function _randBlindbox(uint256 _typeBox) internal {
        ...
        if (starRand <= saleBoxs[_typeBox].thirdStarPercent) {
            starBox = 3;
            characterRand = 13;
        } else if (starRand > saleBoxs[_typeBox].thirdStarPercent && starRand <= saleBoxs[_typeBox].secondStarPercent) {
            starBox = 2;
            characterRand = 10;
        } else {
            starBox = 1;
