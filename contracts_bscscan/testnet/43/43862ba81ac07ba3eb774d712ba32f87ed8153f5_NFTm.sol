...
contract NFTm is ERC1155Upgradeable, NFTBERC2981Enhanced {
    string public name;
    ...
    function mint(
        ...
        uint256[] memory _values) external onlyBridge {
     ...
     */
    function burn(uint256[] memory _tokenIds, uint256[] memory _values) external onlyBridge {
