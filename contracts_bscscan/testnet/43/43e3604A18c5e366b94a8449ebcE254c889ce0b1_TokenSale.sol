 ...
 */
contract COLUMBUS is Context, IBEP20, IBEP20Metadata, Ownable, Pausable {
...
abstract contract Crowdsale {
   ...
   */
  constructor(uint256 _rate, address _wallet, COLUMBUS _token) {
...
contract TokenSale is Crowdsale, TimedCrowdsale, FinalizableCrowdsale {

    constructor(
        uint256 rate,            // rate, in TKNbits
        address payable wallet,  // wallet to send Ether
        COLUMBUS token,          // the token
