...
contract MegaDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0xc88E4952fC62ad0EEE2331Fa8D9C1F40fb177137);
    ...
    string private _name = "MegaDoge";
    string private _symbol = "MegaDoge";
    uint8 private _decimals = 9;
    
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 2 * 10**3 * 10**9; 
    ...
    uint256 private marketingDivisor = 2;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 10000000000000, "MegaDoge: MaxtxAmount >= 10000000000000 ");
    ...
    function setMinimumTokensBeforeSwap(uint256 _minimumTokensBeforeSwap) external onlyOwner() {
     ...
     function setBuybackLimit(uint256 buyBackLimit) external onlyOwner() {
