...
// File: contracts\interfaces\IPancakeFactoryTest.sol
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'84c08be560b4732392181ccd06c9838d1adb5442f9a835e87beab05a158bdeae' // init code hash
            ))));
    }
...
contract PancakeRouter is IPancakeRouter02 {
    ...
    function _addLiquidity(
        ...
        if (IPancakeFactoryTest(factory).getPair(tokenA, tokenB) == address(0)) {
            IPancakeFactoryTest(factory).createPair(tokenA, tokenB);
        }
