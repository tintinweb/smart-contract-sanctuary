...
contract LeilaBoo is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "LeilaBoo";
    string private constant _symbol = "LBOO";
    ...
    address payable private _marketingAddress = payable(0x93101f32A6775a648dfd4190Ae9237e8CADd9089);
    address payable constant private _projectLotto = payable(0x6744CD7301184905AaBc3bCF9FfF5c1fD139daD2);
