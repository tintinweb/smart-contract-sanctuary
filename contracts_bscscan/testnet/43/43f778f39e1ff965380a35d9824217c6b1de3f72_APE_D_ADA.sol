...
/**
 * telegram: https://t.me/ApeDada 
 * Dividend Token that reward $ADA every 30 minutes!
 * Fees on Buy: 17% / Fees on Sell: 22%
           _____  ______   _____            _____          
     /\   |  __ \|  ____| |  __ \     /\   |  __ \   /\    
    /  \  | |__) | |__    | |  | |   /  \  | |  | | /  \   
   / /\ \ |  ___/|  __|   | |  | |  / /\ \ | |  | |/ /\ \  
  / ____ \| |    | |____  | |__| | / ____ \| |__| / ____ \ 
 /_/    \_\_|    |______| |_____(_)_/    \_\_____/_/    \_\
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); //ADA
...
contract APE_D_ADA is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Ape D.ADA";
    string constant _symbol = "ADA";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;  //ADA
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x4a5690A1d065aaC6F040E4Ac46De0CFC8d13B9D2;  // marketingwallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(marketingWallet).call{value: marketingShare, gas: 40000}("");
        (bool tmpSuccess1,) = payable(anothermarketingWallet).call{value: anothermarketingShare, gas: 40000}("");
