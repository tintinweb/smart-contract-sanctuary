...
contract Testbec is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x86c9964DD05c49FE8c75f73f5FfBFEC12aEE07f6); // Marketing Address
    ...
    string private _name = "Testbec";
    string private _symbol = "Tsbc";
