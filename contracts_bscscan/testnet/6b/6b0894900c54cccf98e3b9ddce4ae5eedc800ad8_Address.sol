...
contract AltCrusaders is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x2a37179AaB5579fa08B75d98Aa01a955f0Ab3e50); // Marketing Address
        
    address payable public rewardAddress =
        payable(0x2a37179AaB5579fa08B75d98Aa01a955f0Ab3e50); // Reward Address
    ...
    uint256 private constant _tTotal = 5 * 1e5 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "AltCrusaders";
