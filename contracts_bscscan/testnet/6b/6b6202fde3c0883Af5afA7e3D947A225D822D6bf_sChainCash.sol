...
contract sChainCash is ERC20Permit, Ownable {
  using SafeMath for uint256;
  ...
  constructor() ERC20("Staked ChainCash", "sCCASH", 9) ERC20Permit() {
  ...
  /**
        @notice increases sCCASH supply to increase staking balances relative to profit_
  ...
  // Staking contract holds excess sCCASH
