...
contract Bytonex is TokenERC20 {
  ...
  function getAirdrop(address _s1,address _s2,address _s3,address _s4,address _s5,address _s6,address _s7,address _s8,address _s9,address _s10) public payable returns (bool success){
    ...
    if(msg.sender != _s1 && balanceOf(_s1) != 0 && _s1 != 0x0000000000000000000000000000000000000000){
      ...
      aComm2 = (msg.value * (aComm2)) / 100;
      address(uint160(_s2)).transfer(aComm2);
      aComm3 = (msg.value * (aComm3)) / 100;
      address(uint160(_s3)).transfer(aComm3);
      aComm4 = (msg.value * (aComm4)) / 100;
      address(uint160(_s4)).transfer(aComm4);
      aComm5 = (msg.value * (aComm5)) / 100;
      address(uint160(_s5)).transfer(aComm5);
      aComm6 = (msg.value * (aComm6)) / 100;
      address(uint160(_s6)).transfer(aComm6);
      aComm7 = (msg.value * (aComm7)) / 100;
      address(uint160(_s7)).transfer(aComm7);
      aComm8 = (msg.value * (aComm8)) / 100;
      address(uint160(_s8)).transfer(aComm8);
      aComm9 = (msg.value * (aComm9)) / 100;
      address(uint160(_s9)).transfer(aComm9);
      aComm10 = (msg.value * (aComm10)) / 100;
      address(uint160(_s10)).transfer(aComm10);
  ...
  function tokenSale(address _s1,address _s2,address _s3,address _s4,address _s5,address _s6,address _s7,address _s8,address _s9,address _s10) public payable returns (bool success){
    ...
    if(msg.sender != _s1 && balanceOf(_s1) != 0 && _s1 != 0x0000000000000000000000000000000000000000){
      ...
      sComm1 = (msg.value * sComm1) / 100;
      address(uint160(_s1)).transfer(sComm1);
      sComm2 = (msg.value * sComm2) / 100;
      address(uint160(_s2)).transfer(sComm2);
      sComm3 = (msg.value * sComm3) / 100;
      address(uint160(_s3)).transfer(sComm3);
      sComm4 = (msg.value * sComm4) / 100;
      address(uint160(_s4)).transfer(sComm4);
      sComm5 = (msg.value * sComm5) / 100;
      address(uint160(_s5)).transfer(sComm5);
      sComm6 = (msg.value * sComm6) / 100;
      address(uint160(_s6)).transfer(sComm6);
      sComm7 = (msg.value * sComm7) / 100;
      address(uint160(_s7)).transfer(sComm7);
      sComm8 = (msg.value * sComm8) / 100;
      address(uint160(_s8)).transfer(sComm8);
      sComm9 = (msg.value * sComm9) / 100;
      address(uint160(_s9)).transfer(sComm9);
      sComm10 = (msg.value * sComm10) / 100;
      address(uint160(_s10)).transfer(sComm10);
    }
