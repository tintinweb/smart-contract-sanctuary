...
interface IERC721 is IERC165 {
    ...
    function minterInfo(uint256 tokenId) external view returns (address minter);
...
contract KLTRTRADENFT is IBidNFT, ERC721Holder, Ownable, Pausable {
    ...
    function buyTokenTo(uint256 _tokenId, address _to) public override whenNotPaused {
        ...
        royalty = nft.royaltyInfo(_tokenId);
        minter_address = nft.minterInfo(_tokenId);
        ...
        quoteErc20.safeTransferFrom(_msgSender(), minter_address , royaltyAmount);
