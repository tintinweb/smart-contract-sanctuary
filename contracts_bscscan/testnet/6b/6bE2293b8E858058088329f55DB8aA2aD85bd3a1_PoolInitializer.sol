...
/* ========== Mutative ========== */
  ...
  function createCategory(bytes32 metadataHash, IBisharesUniswapV2Oracle oracle, address router) external;
  ...
  function finishPreparedIndexPool(address poolAddress, address[] calldata tokens, uint256[] calldata balances) external;
...
/* ========== Views ========== */
  ...
  function computeAverageMarketCaps(address[] calldata tokens, IBisharesUniswapV2Oracle oracle) external view returns (uint144[] memory);
