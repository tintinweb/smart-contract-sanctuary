...
contract WyssCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyAmount = 1 * 10**6 * 10**9;
    uint256 public maxSellAmount = 1 * 10**6 * 10**9;
    ...
    constructor() ERC20("Wyss Coin", "WYS") {
        ...
        */
        _mint(owner(),  5 * 10**8 * (10**9)); //500 million supply
    }
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("WYS_Dividend_Tracker", "WYS_Dividend_Tracker")
    {
        claimWait = 3600;
