...
contract BYGNFTStaking is Ownable {
    ...
    ERC20 public constant trustedStakeTokenAddress = ERC20(0x4F7B627b88651e3DddcA0240bcA68a3062632C8c);
 ...
 //   uint public amountToStake = 10 * (10**18);
    ...
    function stake(uint amountToStake) public {
        ...
        require(trustedStakeTokenAddress.transferFrom(msg.sender, address(this), amountToStake), "Insufficient Token Allowance");
    ...
    function unstake() public {
        ...
        require(ERC20(trustedStakeTokenAddress).transfer(msg.sender, amountToWithdraw), "Could not transfer tokens.");
    ...
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(ERC20(_tokenAddr) != trustedStakeTokenAddress, "Admin cannot transfer out Stake Tokens from this contract!");
