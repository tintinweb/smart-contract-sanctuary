...
contract ZionCoin is Context, IBEP20, Ownable {	
    ...
    string private _name = "WTFNI";	
    string private _symbol = "WTFNI";
    ...
    bool public _shouldSwapToBNB = true;
    ...
    uint256 public _antiWhaleThreshold = 1 * 10**9 * 10**9;
