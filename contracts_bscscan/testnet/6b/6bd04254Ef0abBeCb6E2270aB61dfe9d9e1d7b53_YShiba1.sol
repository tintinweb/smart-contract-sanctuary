...
contract YShiba1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5af67dcC08c69180fF0e7eb6195F31b8f000Fdb8); // Marketing Address
    ...
    string private _name = "YShiba1";
    string private _symbol = "YShiba1";
