...
contract NFT_MARKETPLACE_OPERATOR is Ownable {
    ...
    */
        ...
        internal
    {
        ...
        clearNFTSell(agency_address, erc721_address, serial_no, note);
    }
        ...
        internal
    {
        ...
        Interface_NFT_MARKETPLACE_AGENCY.NFT_Price memory _price = _NFT_Marketplace_Agency.getNFTPrice(erc721_address, serial_no, _latest_quote.currency_address);

        require(msg.sender == _price.committer, "[E:0002,auctionSellCancel]");
        ...
        internal
    {
        ...
        _NFT_Marketplace_Agency.withdrawERC721(erc721_address, serial_no, note);
    }
