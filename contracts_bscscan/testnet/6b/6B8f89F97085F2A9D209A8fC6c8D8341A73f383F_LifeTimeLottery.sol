...
contract LifeTimeLottery {
    ...
    function buyNewLevel(uint8 matrix, uint8 level) external {
        ...
        require(amcToken.transferFrom(msg.sender, address(this), _amcAmount), "reward_fail");
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        uint256 _amcAmount = getAMC4USDT(levelPrice[1]);
        require(amcToken.transferFrom(msg.sender, address(this), _amcAmount * 2), "reward_fail");
