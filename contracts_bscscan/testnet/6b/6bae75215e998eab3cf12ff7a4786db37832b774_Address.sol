...
contract MakeElonGreatAgain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x72AcdC575ECef5e1B905B4E814d4a02cA5eBe98B); // Marketing Address
    ...
    string private _name = "MakeElonGreatAgain";
