...
ReentrancyGuardUpgradeable {
    ...
    returns (uint256) {
        ...
        if (duration < 60 days) {
            return 5000 + (duration - (30 days))*10000/(30 days);
        }
        return 10000;
    }
    ...
    function calculateAdditionalReward(address user) public returns (uint256) {
        ...
        emit Debug('33333', userBalance * (block.timestamp - lasttimeUpdateReward)/(365*86400));
