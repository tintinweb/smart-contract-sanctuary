...
contract Mappy is Context, IERC20, Ownable, Pausable {
    ...
    address private constant ROUTER = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Pancakeswap Router
    ...
    uint256 public constant MAX_MINT = 1 * 10**9 * 10**18; // 1 Billion MAPPY maximum
    uint256 public constant BASE_MINT = 1 * 10**6 * 10**18; // 1 Million MAPPY to mint per time
