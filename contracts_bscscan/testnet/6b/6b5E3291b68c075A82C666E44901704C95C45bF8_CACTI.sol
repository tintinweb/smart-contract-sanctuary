...
contract CACTI is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        // getting  the current balance in the contract
        // is the contract token balance equal or higher to the swapTokensAtAmount lock?
        // if so than set canSwap to true
        // from should not be the uniswapPair because that would mean it's a buy.
        // extra check if swapAndLiquifyEnabled is enabled or not to turn off/on the swapAndLiquify
