...
contract VEECOIN is Context, IBEP20, Ownable 
{
    ...
    address internal WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;//WBNB Address
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name     = "VEECOIN";
    ...
    uint256 public  _maxTxAmount     = 25000 * 10**4;
    uint256 private _minTokenBalance = 5000 * 10**4;
