...
contract SalvationCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Salvation Coin";
    ...
    event SetCharityAddress(address caller, address account);
    ...
    function setCharityAddress(address charityAddress) public onlyOwner{
        require(charityAddress != address(0),"Address not be Zero address");
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        uint256 tFee = tAmount.mul(_taxFee).mul(1000);
        uint256 tLiquidity = tAmount.mul(_liquidityFee).mul(1000);
    ...
    function _transfer(
        ...
        if (
            ...
            _tokenTransfer(address(this), _charityAddress, contractTokenBalance.div(4), false);
            _tokenTransfer(address(this), burnAddress, contractTokenBalance.div(4), false);
        }
