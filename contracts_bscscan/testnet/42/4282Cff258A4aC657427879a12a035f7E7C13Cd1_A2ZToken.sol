...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274);   // edit - it is DAI

    // BNB MAINNET: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    // BNB TESTNET: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;      // edit
    IDEXRouter router;
...
contract A2ZToken is IBEP20, Auth {    // edit
    using SafeMath for uint256;

    // SETMEUP
    // BUSD MAINNET: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    // BUSD TESTNET: 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
    address BUSD = 0x8a9424745056Eb399FD19a0EC26A14316684e274;      // edit - It is DAI
    ...
    string constant _name = "A2Z Token";    // edit
    string constant _symbol = "A2Z";  // edit
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**6 * (10 ** _decimals);    // edit
    ...
    uint256 distributorGas = 500000;   // edit from 500000
    ...
    // SETMEUP
    address _presaler = msg.sender; // edit
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);    // edit
        ...
        marketingFeeReceiver = payable(msg.sender); // edit
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}(""); // edit from 30000
