...
*/
contract XGGToken is ERC20Interface, SafeMath {
...
contract PlayerFactory is XGGToken{
...
contract EnergyControl is PlayerFactory{
    ...
    function _addEnergy(uint _amount) external {
        
        require(approve(0xFA242778F601397788c2a52C578dF6aA277Fa23b, _amount));
        
        transferFrom(msg.sender, 0xFA242778F601397788c2a52C578dF6aA277Fa23b, _amount);
