...
contract RainbowLottery is ReentrancyGuard, IRainbow, Ownable {
     ...
     * @dev Callable by users
     */
    function buyTickets(uint32 _ticketNumbers, uint256 _amount, uint32 _bracket, address referral)
        external
        override
        notContract
        nonReentrant
    {
        ...
        require(_referrals[msg.sender] != address(0), "Not allow to bet without upline");
