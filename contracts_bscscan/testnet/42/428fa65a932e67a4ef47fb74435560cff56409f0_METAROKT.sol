...
contract METAROKT is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 10000; // 1% of supply
    uint256 public maxTxAmountSell = _tTotal / 10000; // 1% of supply
    uint256 public maxWalletAmount = _tTotal / 5000; // 2% of supply
