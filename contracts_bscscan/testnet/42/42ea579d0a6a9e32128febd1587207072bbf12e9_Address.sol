...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x0b0dd6585c02f064b85cab0ff0d482001bdbaf605a4333c4bbb09548d3eef336 is returned
        // for accounts without code, i.e. `bansos256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x0b0dd6585c02f064b85cab0ff0d482001bdbaf605a4333c4bbb09548d3eef336;
...
contract Bansos is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bansos";
    string private _symbol = "Bansos";
    uint8 private _decimals = 9;
    

    address payable public marketingWalletAddress = payable(0x2292E3e5A591A4b5B7701b5d9B86Bd27dA8b6e7c); // Marketing Addresss
    address payable public buyBackWalletAddress = payable(0x66C499eAb226384cd15271a13b3B9bb4E03c479c); // buyback Addresss
