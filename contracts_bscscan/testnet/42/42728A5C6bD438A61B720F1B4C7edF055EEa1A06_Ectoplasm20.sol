...
contract Ectoplasm20 is ERC20, Ownable {
    ...
    constructor() ERC20("Ectoplasm", "ECTO") {
        _mint(address(this), 10030000 * (10**uint256(decimals())));
        _approve(address(this), msg.sender, totalSupply());
        _transfer(address(this), msg.sender, totalSupply());
        minted = minted.add(10030000 * (10**uint256(decimals())));
    }
    ...
    function burn(address user, uint256 amount) external onlyMintingContract {
        require(amount > 0);
        _burn(user, amount);
    }
}
