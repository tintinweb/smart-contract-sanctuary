...
contract LFG is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x0659671cB3209611Ec7A94D550039cbadEaEeb50);
    address payable private _marketingAddress = payable(0x98080f47E2c4795645570721d83B50Dc9404084f);
    ...
    function janitorRescueForeignTokens(address _tokenAddr, address _to, uint _amount) public onlyDev() {
