...
contract Aestherium is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = initialSupply * 25 / 10000; //200_000_000, maximum buy & sell tranx is 0.25% initial Supply
    ...
    constructor() ERC20("AESTHERIUM", "AEST") {
        liquidityWallet = address(0xD7);
    	marketingWallet = address(0x56);
    	salaryWallet = address(0x0);
    	buyBackWallet = address(0x20);
    ...
    function setMarketingWallet(address newAddress) public onlyOwner {
        require(marketingWallet != newAddress, "AESTHERIUM: The marketingWallet is already that address");
        emit MarketingWalletChange(newAddress, marketingWallet);
        marketingWallet = newAddress;
    }
    function setBuyBackWallet(address newAddress) public onlyOwner {
        require(buyBackWallet != newAddress, "AESTHERIUM: The buyBackWallet is already that address");
    ...
    function setSalaryWallet(address newAddress) public onlyOwner {
        require(salaryWallet != newAddress, "AESTHERIUM: The salaryWallet is already that address");
    ...
    function setMarketingFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnBuy != newvalue, "AESTHERIUM: The marketingFeeOnBuy is already that value");
    ...
    function setHolderFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnBuy != newvalue, "AESTHERIUM: The holdersFeeOnBuy is already that value");
    ...
    function setBuyBackFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnBuy != newvalue, "AESTHERIUM: The buyBackFeeOnBuy is already that value");
    ...
    function setSalaryFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnBuy != newvalue, "AESTHERIUM: The salaryFeeOnBuy is already that value");
    ...
    function setMarketingFeeOnSell(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnSell != newvalue, "AESTHERIUM: The marketingFeeOnSell is already that value");
    ...
    function setHolderFeeOnSell(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnSell != newvalue, "AESTHERIUM: The holdersFeeOnSell is already that value");
    ...
    function setBuyBackFeeOnSell(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnSell != newvalue, "AESTHERIUM: The buyBackFeeOnSell is already that value");
    ...
    function setSalaryFeeOnSell(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnSell != newvalue, "AESTHERIUM: The salaryFeeOnSell is already that value");
        emit FeeOnSellChange(newvalue, salaryFeeOnSell, "salaryFeeOnSell");
        salaryFeeOnSell = newvalue;
    }
    function setShield1BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _buyBackFeeOnBuy,uint256 _salaryFeeOnBuy,uint256 _holdersFeeOnBuy) public onlyOwner {
        _setCustomBuyTaxPeriod(_shield01,_liquidityFeeOnBuy, _marketingFeeOnBuy,_buyBackFeeOnBuy,_salaryFeeOnBuy,_holdersFeeOnBuy);
    }
    function setShield01SellFees(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell,uint256 _buyBackFeeOnSell,uint256 _salaryFeeOnSell,uint256 _holdersFeeOnSell) public onlyOwner {
        _setCustomSellTaxPeriod(_shield01,_liquidityFeeOnSell, _marketingFeeOnSell,_buyBackFeeOnSell,_salaryFeeOnSell,_holdersFeeOnSell);
    }
    function setShield2BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _buyBackFeeOnBuy,uint256 _salaryFeeOnBuy,uint256 _holdersFeeOnBuy) public onlyOwner {
        _setCustomBuyTaxPeriod(_shield02,_liquidityFeeOnBuy, _marketingFeeOnBuy,_buyBackFeeOnBuy,_salaryFeeOnBuy,_holdersFeeOnBuy);
    }
    function setShield02SellFees(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell,uint256 _buyBackFeeOnSell,uint256 _salaryFeeOnSell,uint256 _holdersFeeOnSell) public onlyOwner {
        _setCustomSellTaxPeriod(_shield02,_liquidityFeeOnSell, _marketingFeeOnSell,_buyBackFeeOnSell,_salaryFeeOnSell,_holdersFeeOnSell);
    }
    function setShield03BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _buyBackFeeOnBuy,uint256 _salaryFeeOnBuy,uint256 _holdersFeeOnBuy) public onlyOwner {
        _setCustomBuyTaxPeriod(_shield03,_liquidityFeeOnBuy, _marketingFeeOnBuy,_buyBackFeeOnBuy,_salaryFeeOnBuy,_holdersFeeOnBuy);
    }
    function setShield03SellFees(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell,uint256 _buyBackFeeOnSell,uint256 _salaryFeeOnSell,uint256 _holdersFeeOnSell) public onlyOwner {
        _setCustomSellTaxPeriod(_shield03,_liquidityFeeOnSell, _marketingFeeOnSell,_buyBackFeeOnSell,_salaryFeeOnSell,_holdersFeeOnSell);
    }
    ...
    function getShield01BuyFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_shield01.liquidityFeeOnBuy,_shield01.marketingFeeOnBuy, _shield01.buyBackFeeOnBuy, _shield01.salaryFeeOnBuy, _shield01.holdersFeeOnBuy);
    }
    function getShield01SellFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_shield01.liquidityFeeOnSell,_shield01.marketingFeeOnSell, _shield01.buyBackFeeOnSell, _shield01.salaryFeeOnSell, _shield01.holdersFeeOnSell);
    }
    function getShield02BuyFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_shield02.liquidityFeeOnBuy,_shield02.marketingFeeOnBuy, _shield02.buyBackFeeOnBuy, _shield02.salaryFeeOnBuy, _shield02.holdersFeeOnBuy);
    }
    function getShield02SellFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_shield02.liquidityFeeOnSell,_shield02.marketingFeeOnSell, _shield02.buyBackFeeOnSell, _shield02.salaryFeeOnSell, _shield02.holdersFeeOnSell);
    }
    function getShield03BuyFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_shield03.liquidityFeeOnBuy,_shield03.marketingFeeOnBuy, _shield03.buyBackFeeOnBuy, _shield03.salaryFeeOnBuy, _shield03.holdersFeeOnBuy);
    }
    function getShield03SellFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_shield03.liquidityFeeOnSell,_shield03.marketingFeeOnSell, _shield03.buyBackFeeOnSell, _shield03.salaryFeeOnSell, _shield03.holdersFeeOnSell);
    }
    ...
    function _getCurrentTotalFee(bool isBuyFromLp, uint256 amount) internal returns (uint256 returnAmount, uint256 fee) {
        ...
        if (this.isInShield()) {
            if (_isInShield01()) {
                ...
                _marketingFee = isBuyFromLp && _shield01.marketingFeeOnBuy > 0 ? _shield01.marketingFeeOnBuy : !isBuyFromLp && _shield01.marketingFeeOnSell > 0 ? _shield01.marketingFeeOnSell : _marketingFee;
                _buyBackFee = isBuyFromLp && _shield01.buyBackFeeOnBuy > 0 ? _shield01.buyBackFeeOnBuy : !isBuyFromLp && _shield01.buyBackFeeOnSell > 0 ? _shield01.buyBackFeeOnSell : _buyBackFee;
                _salaryFee = isBuyFromLp && _shield01.salaryFeeOnBuy > 0 ? _shield01.salaryFeeOnBuy : !isBuyFromLp && _shield01.salaryFeeOnSell > 0 ? _shield01.salaryFeeOnSell : _salaryFee;
                _holdersFee = isBuyFromLp && _shield01.holdersFeeOnBuy > 0 ? _shield01.holdersFeeOnBuy : !isBuyFromLp && _shield01.holdersFeeOnSell > 0 ? _shield01.holdersFeeOnSell : _holdersFee;
            }
                ...
                _marketingFee = isBuyFromLp && _shield02.marketingFeeOnBuy > 0 ? _shield02.marketingFeeOnBuy : !isBuyFromLp && _shield02.marketingFeeOnSell > 0 ? _shield02.marketingFeeOnSell : _marketingFee;
                _buyBackFee = isBuyFromLp && _shield02.buyBackFeeOnBuy > 0 ? _shield02.buyBackFeeOnBuy : !isBuyFromLp && _shield02.buyBackFeeOnSell > 0 ? _shield02.buyBackFeeOnSell : _buyBackFee;
                _salaryFee = isBuyFromLp && _shield02.salaryFeeOnBuy > 0 ? _shield02.salaryFeeOnBuy : !isBuyFromLp && _shield02.salaryFeeOnSell > 0 ? _shield02.salaryFeeOnSell : _salaryFee;
                _holdersFee = isBuyFromLp && _shield02.holdersFeeOnBuy > 0 ? _shield02.holdersFeeOnBuy : !isBuyFromLp && _shield02.holdersFeeOnSell > 0 ? _shield02.holdersFeeOnSell : _holdersFee;
            }
            else {
                ...
                _marketingFee = isBuyFromLp && _shield03.marketingFeeOnBuy > 0 ? _shield03.marketingFeeOnBuy : !isBuyFromLp && _shield03.marketingFeeOnSell > 0 ? _shield03.marketingFeeOnSell : _marketingFee;
                _buyBackFee = isBuyFromLp && _shield03.buyBackFeeOnBuy > 0 ? _shield03.buyBackFeeOnBuy : !isBuyFromLp && _shield03.buyBackFeeOnSell > 0 ? _shield03.buyBackFeeOnSell : _buyBackFee;
                _salaryFee = isBuyFromLp && _shield03.salaryFeeOnBuy > 0 ? _shield03.salaryFeeOnBuy : !isBuyFromLp && _shield03.salaryFeeOnSell > 0 ? _shield03.salaryFeeOnSell : _salaryFee;
                _holdersFee = isBuyFromLp && _shield03.holdersFeeOnBuy > 0 ? _shield03.holdersFeeOnBuy : !isBuyFromLp && _shield03.holdersFeeOnSell > 0 ? _shield03.holdersFeeOnSell : _holdersFee;
            }
        }
