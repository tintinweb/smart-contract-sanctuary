...
contract MuskyUP is IBEP20, RSunAuth {
    ...
    constructor () RSunAuth(msg.sender) {
        ...
        pancakeV2BNBPair = IDEXFactory(router.factory()).createPair(WBNB_TOKEN_ADDR, address(this));
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            (bool marketingSendFeeSuccess, bytes memory marketingSendFeeData) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
