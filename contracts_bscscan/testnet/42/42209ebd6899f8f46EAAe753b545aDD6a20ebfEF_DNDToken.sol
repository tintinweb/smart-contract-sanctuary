...
/**
DNDToken implementation
 */
contract DNDToken is ERC20Upgradeable, OwnableUpgradeable {
  ...
  function _transfer(
    ...
    if (presenter != address(0) && presenter != _msgSender()) {
      ...
      require(ITokenPresenter(presenter).receiveTokens(_msgSender(), _from, _to, _amount), "DNDToken: transfer error");
    } else {
