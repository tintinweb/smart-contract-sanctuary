...
contract BLTester is Context, IERC20 {
    ...
    string private _name = "BLTester";
    string private _symbol = "BLTESTER";
    ...
    uint256 public _marketingRatio = 200;
    uint256 public _developmentRatio = 100;
