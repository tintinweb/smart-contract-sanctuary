...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public buyLimit = 7000 * 10**18;
    uint256 public sellLimit = 2000 * 10**18;
    ...
    address public pancakeSwapRouter =
        address(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45); // 10ed43c718714eb63d5aa57b78b54704e256024e for mainnet;
    ...
    function _transfer(
        ...
        if (recipient == pancakePair) {
            ...
            if (!liquiFlag) {
                if (getPrice(maxSellPerDayLimit + amount) > maxSellPerDay) {
                    require(
...
contract DoxyFinance_V3 is ERC20, Ownable {
    ...
    function staking(address _address, uint256 _amount) external {
