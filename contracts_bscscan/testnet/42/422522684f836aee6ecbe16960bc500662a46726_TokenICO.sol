...
contract TokenICO is Ownable{
    ...
    uint256 internal price=20000; 
    uint256 public minPrice=1*1e17;
    uint256 public maxPrice=2*1e18;
    uint256 public maxInvestment=2*1e18;
    ...
    function purchaseTokens() payable public{
        ...
        require(totalInvestment <= 1000*1e18,"preSale Limit Reached!");
        ...
        user[msg.sender].claimableAmount =  user[msg.sender].claimableAmount + tokenAmount;
    ...
    function claimTokens() public{
        uint256 tokenAmount = user[msg.sender].claimableAmount;
        ...
        user[msg.sender].claimableAmount = 0;
