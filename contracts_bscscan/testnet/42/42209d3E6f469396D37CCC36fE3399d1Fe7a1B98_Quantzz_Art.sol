...
contract Quantzz_Art is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Quantzz_Art", "Demo5") {
      fee = 100000000000000000 wei; //0.1 BNB
      baseUri = "ipfs://QmSkijR9n2dxbXKJxiqjNc8t1MgrMJZvXfuDcMdsbanfpK/";
    }
    ...
    */
    function mint(address player, uint numberOfMints)
        ...
        returns (uint256)
    {
        require(_tokenIds.current() + numberOfMints <= 500, "Maximum amount of tokens already minted.");
        require(msg.value >= fee * numberOfMints, "Fee is not correct.");  //User must pay set fee.
        require(numberOfMints <= 5, "You cant mint more than 5 at a time.");
