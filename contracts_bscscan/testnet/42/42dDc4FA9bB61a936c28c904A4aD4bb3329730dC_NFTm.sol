    ...
    override onlyBridge {
        ...
        for (uint256 i = 0; i < royaltyAmounts_.length; i++){
            ...
            for (uint256 j = 0; j < royaltyAmounts_[i].length; j++){
                royaltyPayment = royaltyPayment + royaltyAmounts_[j][i];
            }
            require(
        ...
        if (_tokenIds.length == 1) {
            ...
            for (uint256 i = 0; i < royaltyReceivers_[0].length; i++) {
                royalties[_tokenIds[0]].push(
                    RoyaltyInfo(royaltyReceivers_[i][0], royaltyAmounts_[i][0])
                );
            }
        } else {
            ...
            for (uint256 i = 0; i < royaltyReceivers_.length; i++) {
                for (uint256 j = 0; j < royaltyReceivers_[i].length; i++) {
                    royalties[_tokenIds[i]].push(
                        RoyaltyInfo(royaltyReceivers_[j][i], royaltyAmounts_[j][i])
                    );
                }
            }
        }
