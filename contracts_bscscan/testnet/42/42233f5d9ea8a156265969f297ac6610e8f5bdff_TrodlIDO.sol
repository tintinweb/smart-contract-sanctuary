...
library AttoDecimal {
    ...
    uint256 internal constant SQUARED_ONE_MANTISSA =
        ONE_MANTISSA * ONE_MANTISSA;
    uint256 internal constant MAX_INTEGER = uint256(-1) / ONE_MANTISSA;

    function add(Instance memory a, Instance memory b)
        internal
        pure
    ...
    function add(Instance memory a, uint256 b)
        internal
        pure
        returns (Instance memory)
    {
    ...
    function sub(Instance memory a, Instance memory b)
        internal
        pure
        returns (Instance memory)
    {
    ...
    function sub(Instance memory a, uint256 b)
        internal
        pure
        returns (Instance memory)
    {
    ...
    function sub(uint256 a, Instance memory b)
        internal
        pure
        returns (Instance memory)
    {
    ...
    function mul(Instance memory a, Instance memory b)
        internal
        pure
        returns (Instance memory)
    {
    ...
    function mul(Instance memory a, uint256 b)
        internal
        pure
        returns (Instance memory)
    {
    ...
    function div(Instance memory a, Instance memory b)
        internal
        pure
        returns (Instance memory)
    {
        return
            Instance({mantissa: a.mantissa.mul(ONE_MANTISSA).div(b.mantissa)});
    }

    function div(Instance memory a, uint256 b)
        internal
        pure
        returns (Instance memory)
    {
    ...
    function div(uint256 a, Instance memory b)
        internal
        pure
        returns (Instance memory)
    {
        return
            Instance({mantissa: a.mul(SQUARED_ONE_MANTISSA).div(b.mantissa)});
    }
    ...
    function idiv(Instance memory a, Instance memory b)
        internal
        pure
        returns (uint256)
    {
    ...
    function idiv(Instance memory a, uint256 b)
        internal
        pure
        returns (uint256)
    {
    ...
    function idiv(uint256 a, Instance memory b)
        internal
        pure
        returns (uint256)
    {
    ...
    function ceil(Instance memory a) internal pure returns (uint256) {
        return
            (a.mantissa / ONE_MANTISSA) +
            (a.mantissa % ONE_MANTISSA > 0 ? 1 : 0);
    }

    function eq(Instance memory a, Instance memory b)
        internal
        pure
        returns (bool)
    {
    ...
    function gt(Instance memory a, Instance memory b)
        internal
        pure
        returns (bool)
    {
    ...
    function lt(Instance memory a, Instance memory b)
        internal
        pure
        returns (bool)
    {
    ...
    function sum(Instance[] memory array)
        internal
        pure
...
contract TrodlIDO is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    function poolProps(uint256 poolIndex)
        public
        view
        returns (Type type_, Props memory props)
    {
    ...
    function poolState(uint256 poolIndex)
        public
        view
    ...
    function increaseIssuance(uint256 poolIndex, uint256 amount)
        external
    ...
    function createPaymentLimit(uint256 poolIndex, uint256 limit)
        external
        returns (uint256 limitIndex)
    {
        Pool storage pool = _getPool(poolIndex);
    ...
    function withdrawPayments(uint256 poolIndex)
        external
        returns (bool success)
    {
        Pool storage pool = _getPool(poolIndex);
    ...
    function collectFee(uint256 poolIndex)
        external
        onlyOwner
        returns (bool success)
    {
    ...
    function withdrawFee(IERC20 token)
        external
        onlyOwner
        returns (bool success)
    {
    ...
    function nominateNewPoolOwner(uint256 poolIndex, address nominatedOwner_)
        external
        returns (bool success)
    {
        Pool storage pool = _getPool(poolIndex);
    ...
    function acceptPoolOwnership(uint256 poolIndex)
        external
        returns (bool success)
    {
        Pool storage pool = _getPool(poolIndex);
    ...
    function _assertPoolOwnership(Pool storage pool, address account)
        private
        view
    {
    ...
    function _validateLimitIndex(Pool storage pool, uint256 limitIndex)
        private
        view
    {
        require(
