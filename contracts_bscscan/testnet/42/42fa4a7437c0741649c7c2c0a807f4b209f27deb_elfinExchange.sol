...
contract elfinExchange is ERC721Full, Ownable, IERC721Receiver {
    ...
    //mapping(uint256=>uint256) eAuctionCode;
    ...
    function auctionMint(address _to) public onlyOwner {
    ...
    function mysteryMint(address _to,uint256 _quantity) public onlyOwner{
