...
contract DogeGun is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xF29918d1A6616cE9004de940ff3d3c528cfD5146); // Marketing Address

    address payable public teamAddress =
        payable(0xF29918d1A6616cE9004de940ff3d3c528cfD5146); // Burn Address

    address payable public liquidityAddress =
        payable(0xF29918d1A6616cE9004de940ff3d3c528cfD5146); // Liquidity Address
    ...
    uint256 public _maxWalletToken = 2000000 * 1e7 * 1e9;
    ...
    constructor() {
        ...
        _maxWalletToken = _tTotal * 2 / 100; // 2% maxWallet
