...
contract IBGBooster is Ownable {
    ...
    mapping(address => uint256) public depositCheckpoint;
    ...
    function handleWithdrawal(uint256 _pid,uint256 rewardAmount ,uint256 principalAmount,address _user) internal{
        ...
        bool isPreMature = depositCheckpoint[_user].add(pool.lockPeriod) > block.timestamp;
        if(isPreMature){
