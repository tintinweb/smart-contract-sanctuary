...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* Origin address */
    address internal constant ORIGIN_ADDR = 0x06bc86A0109D1d2D1319183d3Fb073D3FFBfEC53;

    /* Flush address */
    address payable internal constant FLUSH_ADDR = 0xf105C8d70F889eCaE22C4Ba2ECa2aE7E0dba4144;

    /* ERC20 constants */
    string public constant name = "TRE";
    string public constant symbol = "TRE";
...
contract StakeableToken is GlobalsAndUtility {
        ...
        external
    {
        ...
        require(newStakedDays >= MIN_STAKE_DAYS, "TRE: newStakedDays lower than minimum");
...
contract TRE is TransformableToken {
    constructor()
        public
    {
