...
contract Advancedshitcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Advancedshitcoin";
    string private constant _symbol = "Advashit";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xCbC30A4Ce59Be74F6b053d1C338Caa080F881432);
        _feeAddrWallet2 = payable(0x4AA634b9007A20d281C72f073cE6393816ca16a8);
