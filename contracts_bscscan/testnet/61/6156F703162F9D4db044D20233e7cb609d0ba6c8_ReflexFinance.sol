...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public rewardToken = IERC20Extended(0x73445033cEA2d4b74c1c6119E1514da7B6a28739);
...
contract ReflexFinance is IERC20Extended, Auth {
    ...
    function swapBack() internal swapping {
        uint256 amountTokenStaking = swapThreshold
            .mul(stakingFee)
            .div(totalFee);
        ...
        uint256 amountToLiquify = swapThreshold
            ...
            .div(totalFee)
            .div(2);
        uint256 amountToSwap = swapThreshold.sub(amountToLiquify).sub(amountTokenStaking);
        ...
        uint256 totalBNBFee = totalFee.sub(dynamicLiquidityFee.div(2)).sub(stakingFee);
        ...
        _balances[stakingFeeReceiver] = _balances[stakingFeeReceiver].add(amountTokenStaking);
    ...
    function setAntiWhaleSellLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 1000000,"amount must be greate than 0.0001 of supply");
