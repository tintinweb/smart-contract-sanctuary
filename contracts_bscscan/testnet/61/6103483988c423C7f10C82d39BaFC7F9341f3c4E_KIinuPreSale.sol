...
contract KIinuPreSale is Ownable, TimedCrowdsale, AllowanceCrowdsale {
    using SafeMath for uint256;

    uint256 _openingTime = now;
    uint256 _closingTime = now + 21 days;
    uint256 _rate = 500;
    address payable _wallet = address(
        0xc3BcbC64A0603aF4dF99a51CdBaBe7Fab862AF39)
        ;
  
    IERC20 _token = IERC20(0x2CBeB9927A75C106b5A99A085A0C0dc9382bC5B9);
    address _tokenWallet = address(0xc3BcbC64A0603aF4dF99a51CdBaBe7Fab862AF39);
