...
contract Blocstarz is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Blocstarz";
    string constant _symbol = "Starz";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals); // 1 Quadrillion
    uint256 public _maxTxAmount = _totalSupply.div(400); // 0.25% (Anti-Whale)
