...
contract StakeContract is Ownable {
    ...
    uint256 public startBlock = 16136712 ; // set start block
    uint256 public minimum_deposit = 4000*10**18; //minimum deposit
    uint256 public endBlock =   116136712 ;  // set end block
    uint256 public rewardperblock = 0.2*10**18; // set block reward
    uint256 private unlockblockperiod = 864000; 
    address public rewardaddress = 0x35c77BEfA581Ae0F3861ceF24e7350aF5239c2c5 ;
    address public stakeaddress = 0x35c77BEfA581Ae0F3861ceF24e7350aF5239c2c5 ;
    uint256 public totalpoolstacked = 0;
    uint256 public lastRewardBlock = 16136712;  // set start block
