...
contract DFLICO  {
    ...
    constructor(address ownerAddress, IBEP20 _busdToken, IBEP20 _dflToken) public 
    {
        ...
        investmentPlans_.push(Plan(33,3600,33)); //300 days and 0.33%
        investmentPlans_.push(Plan(42,3600,42)); //300 days and 0.42%
        investmentPlans_.push(Plan(50,3600,50)); //300 days and 0.5%
        investmentPlans_.push(Plan(58,3600,58)); //300 days and 0.58%
	...
	function withdraw() public payable 
	{
        ...
        dflToken.transfer(msg.sender,withdrawalAmount*tokenPrice);
