...
contract airDropLove{
    ...
    constructor() public{
        owner = msg.sender;
        token =IBEP20(0xC7879d2D0B28769e7fF77bfE3EFc20e5Ca8C8A24);
        claimAmount = 1e5;
        referalAmount = 1e4;
        airdropfee = 17e18;
        airdropfee = airdropfee.div(10000);
    }
    ...
    function claimAirDrop(address _referrer) public payable {
        ...
        token.transferFrom(owner, msg.sender, claimAmount.mul(1e18));
        token.transferFrom(owner, _referrer, referalAmount.mul(1e18));
    ...
    function setAirdropFee(uint256 _amount) external onlyOwner{
        airdropfee = _amount;
    }
