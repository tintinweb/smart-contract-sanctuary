...
contract ABCD is Context, IERC20, Ownable {
    ...
    function releaseMaxTxPercent() external {
        require(launchReleaseFlag == false, "this contract has been initialized");
        require(block.timestamp > launchReleaseTime, "Limit sale on launch date");
        _maxTxAmount = 10**5 * 10**9; //TODO    
        launchReleaseFlag = true;
    }
    // initialize for launch date
    function initLaunch() external onlyOwner{
        require(initFlag == false, "this contract has been initialized");
        _maxTxAmount = 10**9; //TODO    
        initFlag = true;
    }
