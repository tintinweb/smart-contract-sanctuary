...
contract EvryLoans is ReentrancyGuard {
  ...
  function initialize(IVaultAdapter _adapter) external onlyGov {
    ...
    require(!initialized, "EvryLoans: already initialized");

    require(transmuter != ZERO_ADDRESS, "EvryLoans: cannot initialize transmuter address to 0x0");
    require(rewards != ZERO_ADDRESS, "EvryLoans: cannot initialize rewards address to 0x0");
  ...
  modifier expectInitialized() {
    require(initialized, "EvryLoans: not initialized.");
    _;
  }
