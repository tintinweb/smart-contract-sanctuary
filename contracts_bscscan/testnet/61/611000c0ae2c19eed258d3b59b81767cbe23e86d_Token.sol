...
contract    Token
{
    ...
    string  private  constant    _name       = "Q999 Token";    //qsdc
    string  private  constant    _symbol     = "Q999";
    uint256 private  constant    _decimals   = 2;

    uint256 private              _totalSupply = (100 * 10**1) * 10**_decimals;        // 100 Billions token with 18 decimals precision
