...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name    = "TLS2";
    string private _symbol  = "TLS2";
    ...
    constructor (address tokenOwner, uint8 setMxTxPer, uint8 setMxWalletPer) {
        ...
        _isExcludedFromTransactionlock[tokenOwner]              = true;
        ...
        _isExcludedFromMaxTxAmount[tokenOwner]              = true;
        ...
        _isExcludedFromMaxWalletAmount[tokenOwner]                = true;
        _isExcludedFromMaxWalletAmount[address(this)]             = true;
        _isExcludedFromMaxWalletAmount[pancakePair]               = true;
        _isExcludedFromMaxWalletAmount[address(_pancakeRouter)]  = true;
