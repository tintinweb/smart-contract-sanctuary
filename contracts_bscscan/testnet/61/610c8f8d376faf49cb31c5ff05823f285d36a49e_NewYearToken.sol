...
contract NewYearToken is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0x7DC02BEd715A79B9444fB30DC48743529cd8120C;

    address routerv2 = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;

    string constant _name = "NewYearTest";
    string constant _symbol = "NYT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 20212022000000000;
     //max wallet holding of 1%
    uint256 public _maxTxAmount = 202120;

    //max wallet holding of 1%
    uint256 public _maxWalletToken = 202120;
