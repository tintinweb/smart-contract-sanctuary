...
contract Staking is Ownable, ReentrancyGuard {
        ...
        onlyOwner
    {
        ...
        require(_amount > 0, "StakeAndLock:: Amount can not be zero");
    ...
    function unStake() external nonReentrant {
        require(UserInfos[msg.sender].isStaked, "Unstake:: No Stake Found");
        require(
            !UserInfos[msg.sender].isFullClaimed,
            "Unstake:: Invalid Withdrawal, You have fully claimed"
        );

        // Check if user claimed Half First
    ...
    function fullyClaimed() internal {
        if (UserInfos[msg.sender].noOfWithdrawls == 99) {
    ...
    function harvestDaily() internal {
        ...
        require(
            ...
            "HarvestRewards:: Withdrawing too early"
        );
