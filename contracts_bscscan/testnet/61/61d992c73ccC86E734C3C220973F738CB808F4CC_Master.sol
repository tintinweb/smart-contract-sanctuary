...
contract ModelCollection is ERC721 {
    ...
    event Debug1(string lineNumber, uint256 value);
    event Debug(string lineNumber, address value);
    ...
    function burnNFT(uint256 tokenId) public {
        emit Debug1("361", tokenId);
        address owner = ownerOf(tokenId);
        emit Debug("356", owner);
//        super._beforeTokenTransfer(owner, address(0), tokenId);
