...
interface KishuMale {
    function mintMeSome(uint256 _qty ) external payable;
    function transferFrom (address _from , address _to , uint256 _amount ) external;
    function totalSupply() external returns( uint256) ;
}

interface MaleBreederTokenContract {
     function approve(address _spender, uint256 _amount ) external;
     function transferFrom (address _from , address _to , uint256 _amount ) external;
}


contract SaleTwo is Ownable  {
    
    bytes4 ERC721_RECEIVED = 0x150b7a02;
    
    address public EmergencyAddress; 
    address public KishuMaleAddress;
    address public MaleBreederTokenAddress;
    
    address payable public teamWallet = payable(0x5aF50A821C11C4376746aD5DB455f62E09950566);
    
    
    constructor() {
        EmergencyAddress = msg.sender;
        KishuMaleAddress = 0xbd50F53Ed0b8145AF66a321196f3F3165f38C24d;
        MaleBreederTokenAddress = 0xF9f9859f1F6c61F9013bDC9c87b6B520555080BC;
        
        KishuMaleAddress = 0xD2Ec867bc607aBcF224431D60eF202aBb2d1Ec59;
        MaleBreederTokenAddress = 0x3756cfc0870917D360c4Ecc2563C801f920959e0;
    }
    
    function purchaseMale () public payable {
        require ( msg.value == 1000000000000000000 , "Wrong BNB Amount" );
        
        MaleBreederTokenContract _malebreeder = MaleBreederTokenContract ( MaleBreederTokenAddress );
        _malebreeder.transferFrom ( msg.sender, address(this), 1 );
        _malebreeder.approve ( KishuMaleAddress, 1 );
       
        KishuMale _kishumale = KishuMale ( KishuMaleAddress );
       _kishumale.mintMeSome{value:500000000000000000}( 1 );
      
       _kishumale.transferFrom ( address(this), msg.sender, _kishumale.totalSupply() );
       teamWallet.transfer( 500000000000000000 );   
