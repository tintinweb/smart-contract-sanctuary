...
contract Tester is Context, IERC20, Ownable {
    ...
    uint256 public _teamFee; // 100 = 1.00%
    uint256 public _burningFee; // 300 = 3.0%
...
function _approve(address owner, address spender, uint256 amount) private {
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        uint256 teamFee = amount.mul(_teamFee).div(10000);
        ...
        if(teamFee > 0){
            ...
            _reflectionBalance[teamAddress] = _reflectionBalance[teamAddress].add(teamFee.mul(rate));
            _teamFeeTotal = _teamFeeTotal.add(teamFee);
            emit Transfer(account,teamAddress,teamFee);
        }
    ...
    function setTeam_Address(address _Address) public onlyOwner {
