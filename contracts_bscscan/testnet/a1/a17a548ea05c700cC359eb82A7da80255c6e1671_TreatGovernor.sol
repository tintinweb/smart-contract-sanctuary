...
contract TreatGovernor is
    Governor,
    GovernorCountingSimple,
    GovernorTimelockControl
{
    IBabyDogeGoldenTreat token;
    uint256 public minToPropose;

    constructor(
        IBabyDogeGoldenTreat _token,
        TimelockController _timelock,
        uint256 _minToPropose
    ) Governor("MyGovernor") GovernorTimelockControl(_timelock) {
        token = _token;
        minToPropose = _minToPropose;
    }
    ...
    function propose(
        ...
        require(token.balanceOf(msg.sender) >= minToPropose);
...
abstract contract Governor is Context, ERC165, EIP712, IGovernor {
    ...
    function _castVote(
        ...
        console.log(proposal.voteStart.getDeadline());
