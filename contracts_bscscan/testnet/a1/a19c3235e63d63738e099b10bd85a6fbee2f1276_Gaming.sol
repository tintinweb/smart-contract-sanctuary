...
contract Gaming is BEP20 {
    ...
    */
    ...
    int256 public lastTime;
    uint256 public gameWinTime;
    ...
    function buy() public payable {
        ...
        payable(marketingWallet).transfer(msg.value * gameSettings.marketingWalletPercent / 100); // marketing 1%
        
        uint256 swapAmount = (address(this).balance - oldBalance) * 98 / 100;
    ...
    function setMinPrizeAmount(uint256 amount) public {
        gameSettings.minimumPrizeAmount = amount;
    }
    
    
    // Function to withdraw all Ether from this contract.
    function withdrawMarketingFee (address payable _to, uint256 amount) public {
        // send all Ether to owner
        // Owner can receive Ether since the address of owner is payable
        (bool success, ) = _to.call{value: amount}("");
        require(success, "Failed to send BNB to marketingWallet");
    }
    ...
    function timeLeft() public view returns (int256) {
        ...
        return int256(blocksSinceLastBuy.mul(3));
    }
    ...
    function completeRoundWhenNoTimeLeft() public {
        ...
        if (lastBuyBlock != 0 && secondsLeft >= 0 ) {
           ...
           uint256 amount = buyerInfo[buyerInfo.length].amount / 100;
           
           if(amount > 0) {
                (bool success, ) = winner.call { value: amount, gas: 5000 }("");
