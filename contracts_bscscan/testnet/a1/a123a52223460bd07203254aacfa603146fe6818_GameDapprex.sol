...
contract GameDapprex {
    ...
    constructor(
        ...
        function showGameDetails(uint game) public view returns (string memory, uint, uint, uint, uint, address) {
             return ("win",g_run[game],g_win[game],g_bet[game],g_ern[game],g_ply[game]);
        }
