...
contract EverAyeRise is Context, IERC20, Ownable {
    ...
    string private _name = "EverAyeRise";
    string private _symbol = "AyeRISE";
    ...
    function SetupEnableTrading(bool BotProtection) private {
