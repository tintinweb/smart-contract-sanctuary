    ...
    UUPSUpgradeable
{
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, _tokenId)) : "";
    }
    ...
    function mint(
        ...
        if(_owners[_id] != address(0) && _to == _owners[_id]) {
            transferFrom(address(this), _owners[_id], _id);
            delete _owners[_id];
            return;
        }
        
        _mint(_to, _id);
        _datas[_id] = NFTdata(_data, _type);
    ...
    function burnBatch(uint256[] memory _tokenIdArr) public virtual {
