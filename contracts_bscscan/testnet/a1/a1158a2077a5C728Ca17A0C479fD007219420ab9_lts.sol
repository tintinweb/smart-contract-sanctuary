...
contract lts is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    function excludeAccountFromTxAndFees(address account) public onlyOwner() {
    ...
    function manualBurn(uint256 tokenBurnAmount) private onlyOwner() nonReentrant returns (bool) {
