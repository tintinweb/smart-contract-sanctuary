...
contract ABCD is Context, IERC20, Ownable {
    ...
    //// ERC-20 init
    string private constant _name = "v103";
    string private constant _symbol = "v103";  //TODO
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 625000000 * 10**9;  //TODO
    ...
    function calculateTaxFee(uint256 _amount, address to) private view returns (uint256) {
        ...
        uint256 dayCount = (block.timestamp - launchDate) / 60 / 1;
        uint256 startRate = 38;
        if (dayCount < 30) {
            uint256 _newTaxFee = startRate.sub(dayCount.mul(1));
