...
contract BabyBUSD is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 4000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 1000000000000 * (10**18);
    uint256 public swapTokensAtAmount = 200000000 * (10**18);
    uint256 public _maxWalletToken = 15000000000 * (10**18); // 1.5% of total supply
    ...
    constructor() public ERC20 ("BabyBUSD", "BBSD") {
