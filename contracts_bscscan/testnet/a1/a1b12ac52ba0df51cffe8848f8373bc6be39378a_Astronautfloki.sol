...
contract Astronautfloki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x22d5385Ce4139168f23497068cff4831C105E719); // Marketing Address
    address payable public charityAddress = payable(0x22d5385Ce4139168f23497068cff4831C105E719); // Charity/Dev Address
    ...
    string private _name = "Astronaut Floki";
    ...
    uint256 public _burnFee = 3; //Burn Fee- to Boost the price
    uint256 private _previousBurnFee = _burnFee;    
    
    uint256 public marketingDivisor = 3; //Marketing Fee
    
    uint256 public charityDivisor = 3; //Charity/Dev Fee
    
    uint256 public _maxTxAmount = 10000000000000 * 10**9;  //Maximum amount can be used for transaction (antiwhale setup)) 1%
    uint256 private minimumTokensBeforeSwap = 10000000000000 * 10**9;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 1000000000000;// 0.01*10,000,000,000 token for 0.01 bnb (set as per requirements)
