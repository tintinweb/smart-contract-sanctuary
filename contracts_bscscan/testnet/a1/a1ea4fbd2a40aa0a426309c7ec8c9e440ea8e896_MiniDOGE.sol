...
contract MiniDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xA246BE2ad3A4676361f9C28e3bE097400e1eA996); // Marketing Address
    ...
    uint256 public _intervalMinutesForSwap = 2 minutes;
    function  SetItervalMinutesForSwap (uint256 Minutes) public onlyOwner {
        _intervalMinutesForSwap = Minutes ;
    }
