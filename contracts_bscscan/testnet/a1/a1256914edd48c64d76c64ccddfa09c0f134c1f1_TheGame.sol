...
contract TheGame is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa4cba78Ad0eC55f0420d9517849cfBD712F21E10); // Marketing Address
    address payable public charityAddress = payable(0xa4cba78Ad0eC55f0420d9517849cfBD712F21E10); // Charity Address
    address payable public lotteryAddress = payable(0xa4cba78Ad0eC55f0420d9517849cfBD712F21E10); // Lottery Address
    ...
    string private _name = "The Game";
    string private _symbol = "THEGAME";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 transferredBalance = address(this).balance.sub(initialBalance);
         ...
         // Send to lottery address
        transferToAddressETH(lotteryAddress, transferredBalance.mul(lotteryDivisor).div(100));
