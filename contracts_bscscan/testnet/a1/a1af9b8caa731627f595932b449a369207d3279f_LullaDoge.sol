...
contract LullaDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x966242A79aC6c75e83942dDc760ED73Fa0BDe6Aa); // Marketing Address
    ...
    string private _name = "LullaDoge";
    string private _symbol = "LullaDoge";
    ...
    function _transfer(
        ...
        if (to == POOL_ADDRESS && !firstTransferToPool) {
            releaseTime = block.timestamp + 172800;
