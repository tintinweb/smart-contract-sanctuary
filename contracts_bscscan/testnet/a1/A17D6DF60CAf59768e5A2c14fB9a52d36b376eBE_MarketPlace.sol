...
contract MarketPlace is OwnableUpgradeable, ERC721Holder, PlatformRevenueBase {
    ...
    function selling(
        ...
        require(
            supportedPriceToken[priceToken] == true,
            "MarketPlace: token price is not supported"
        );
        require(
    ...
    function setSupportedPriceToken(IERC20 _token, bool _isSupport)
        external
        onlyOwner
    {
        supportedPriceToken[_token] = _isSupport;
    }
}
