...
contract Staking is Ownable{
     ...
     */
    constructor(uint _APY, uint _panicUnstakePercentage, address _erc20Token, uint _unstakeLockPeriod){
     ...
     * @notice This function will APY and allowed to owner only
     * @param _APY Annual Percentage Yield * 1000
     */
    ...
    function panicUnstake(uint amount) public {
        ...
        //     // Calculate and update reward status
        //     stakeHolders[msg.sender].reward += _calculateReward(msg.sender);
        //     stakeHolders[msg.sender].lastRewardCalculated = block.timestamp;

        //     // Update staked amount status depending of requested amount.
        //     uint requiredAmount = amount - availableAmount;
        //     if (requiredAmount < stakeHolders[msg.sender].stake){
        //         availableAmount += requiredAmount;
        //         stakeHolders[msg.sender].stake -= requiredAmount;
        //     }
        //     else{
        //         availableAmount += stakeHolders[msg.sender].stake;
        ...
        // token.transfer(address(0), panicUnstakeCharges);
