...
contract KangarooMatrix {
    ...
    function migrationsMatrix611(address oldMatrix,uint32 id,uint8 level) public view returns(X6 memory) {
    ...
    function migrationsMatrix621(address oldMatrix,uint32 id,uint8 level) public view returns(bytes memory) {
    ...
    function migrationsMatrix6(address oldMatrix,uint32 id,uint8 level) public view returns(uint32, uint32[] memory, uint32[] memory, bool, uint32, uint32) {

        (bool success,bytes memory data) = oldMatrix.staticcall(abi.encodeWithSignature("usersX6Matrix(uint32,uint8)",id,level));
        require(success && data.length != 0 ,"migrationsMatrix6 FAILED");
        return abi.decode(data, (uint32, uint32[], uint32[], bool, uint32, uint32));
    }

    function migrationsMatrix3(address oldMatrix,uint32 id,uint8 level) public view returns(uint32, uint32[] memory, bool, uint32) {

        (bool success,bytes memory data) = oldMatrix.staticcall(abi.encodeWithSignature("usersX3Matrix(uint32,uint8)",id,level));
        require(success && data.length != 0 ,"migrationsMatrix3 FAILED");
        return abi.decode(data, (uint32, uint32[], bool, uint32));
    }
    ...
    function migrationsUser(address oldMatrix,uint32 id) external returns(bool){
        ...
        for(uint8 level=1;level<=static_user.activeX3Levels;level++){
            ...
            user.x3Matrix[level].reinvestCount)=migrationsMatrix3(oldMatrix,id,level);
        }
