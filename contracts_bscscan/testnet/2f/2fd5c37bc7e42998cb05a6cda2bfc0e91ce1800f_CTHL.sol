...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //pcs router 
        _token = msg.sender;
    }
...
contract CTHL is IBEP20, Auth {
    ...
    string constant _name = "Cthulhu Token";
    string constant _symbol = "CTHLX";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2221dA62d456Fe870Ead2f5f762B36BAd5995859;
        charityFeeReceiver = 0xa8a84C13320fd71E7C6b652F8e1242d7b62da001;
    ...
    function triggerCthlBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
