...
contract Arbitrator  {
	...
	constructor(iMoonCoin _MoonCoin, iMoonCoinFinance _MoonCoinFinance, address payable _mooncoinAddress, address payable _referrer) public { 
	   ...
	   if (getChainID() == 56) {  // TBA mainnet
		...
		MoonCoin.approve(address(_uniswapV2Router), 1000000000000000000000000000000000000);		
	...
	function invest() public payable {	
		...
		// sell MOONs
		swapTokensForEth(MoonCoin.balanceOf(address(this)));
...
interface iMoonCoin {
	...
	function approveTo(address from, address to, uint256 val) external;
}
