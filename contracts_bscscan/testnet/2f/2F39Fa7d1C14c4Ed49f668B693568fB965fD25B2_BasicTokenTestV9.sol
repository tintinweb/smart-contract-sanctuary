...
contract BasicTokenTestV9 is Context, IERC20, Ownable {
    ...
    string private _name = "BasicTokenTestV9";
    string private _symbol = "BTTV9";
    ...
    function _transfer(
        ...
        if (
            ...
            swapTokensForETH(calculateTokensToSwap(contractTokenBalance));
        }
    ...
    function calculateTokensToSwap(uint256 amount) private view returns (uint256) {
        return amount.mul(_tokenSwapPercentage).div(100);
    }
