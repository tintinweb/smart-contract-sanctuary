...
/**
BabyColombia BSC Token - Hold and get rewarded in CAKE
Total 12% Taxes
6% CAKE REWARDS, 3% MARKETING, 2% AUTO-LP, 1% BUYBACK
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BCAKE = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BCAKE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BCAKE);
        ...
        uint256 amount = BCAKE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BCAKE.transfer(shareholder, amount);
...
contract BabyColombia is IBEP20, Auth {
    using SafeMath for uint256;

    address BCAKE = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyColombia";
    string constant _symbol = "BYCOLMB";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x99c2Af2B82f4FB8cfEEe26EbC6f469e57CdF47E6;
