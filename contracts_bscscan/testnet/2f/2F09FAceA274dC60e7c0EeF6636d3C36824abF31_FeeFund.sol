...
contract FeeFund is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000 * 10**18;        // total supply : 5000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Fee Fund";
    string private _symbol = "FFT";
    uint8 private _decimals = 18;

    address private _devWalletAddress = 0x6Ce14490463b697cB9CE25793b982a4B2ee3d912;         // 3% to dev
    address private _teamWalletAddress = 0x8d7689BD829b62C88394eDa0704B49D35a237F7E;        // 2% to team
    address private _listingWalletAddress = 0x41228150AffA06a628205d7fc0A78c3878465398;     // 2% to listing
    address private _marketingWalletAddress = 0x466B3fE16b65cAb05e4A9Cf749373dB513BC9D8b;   // 2% to marketing
    address private _donationWalletAddress = 0x76B67b951602Ae1fBB3355e4A413Dc446d5D3f29;    // 1% to donation
    
    uint256 public _taxFee = 2;                 // 2% to reflection
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 18;          // 18% to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _extraFee = 10;            // dev + team + listing + marketing + donation
    ...
    uint256 public _maxTxAmount = 50 * 10**18;          // anti-whale : 50 per transaction
    ...
    constructor () public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);   // bsc main net
    ...
    function _takeExtra(uint256 tExtra) private {
        ...
        uint256 tDev = tExtra.mul(3).div(10);           // 3% to dev
        ...
        uint256 tTeam = tExtra.mul(2).div(10);          // 2% to Team
        ...
        uint256 tListing = tExtra.mul(2).div(10);
        uint256 rListing = tListing.mul(currentRate);
        _rOwned[_listingWalletAddress] = _rOwned[_listingWalletAddress].add(rListing);
        if(_isExcluded[_listingWalletAddress])
            _tOwned[_listingWalletAddress] = _tOwned[_listingWalletAddress].add(tListing);
        
        uint256 tMarketing = tExtra.mul(2).div(10);
        ...
        uint256 tDonation = tExtra.mul(1).div(10);
