...
contract MakaSwap is Ownable, ReentrancyGuard {
  ...
  function buyMaka(address buyer) payable external isHuman nonReentrant {
    require(msg.sender == buyer, "You are not allowed to buy tokens on behalf of this user");
    require((msg.value/100)*100 == msg.value, 'Too value is small');
