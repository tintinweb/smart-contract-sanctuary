...
contract myltcfarm {
	...
	address erctoken = 0x2B8fF854c5e16cF35B9A792390Cc3a2a60Ec9ba2; //testnet bnb
	...
	constructor(address pOwner, address payable pProjectWwallet, address payable pMarketingWallet, address payable pltcMinerContract) {
        ...
        **/
        ...
        plans.push(Plan(5, 320, 5000000000000000000));
	}
	...
	function invest(address referrer, uint8 plan, uint256 amounterc
        ...
        require(totalDeposits < MAX_WALLET_DEPOSIT, "Wallet deposit limit reached 200 LTC");
