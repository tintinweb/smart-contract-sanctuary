...
contract Token is Context, IERC20, Ownable {
   ...
   //address public router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //uniswap rinkeby
    ...
    uint8 public _manualBuyBackFee = 0;
    uint8 private _previousManualBuyBackFee = _manualBuyBackFee;
    ...
    address payable public manualBuyBackWallet;
    ...
    constructor(
        ...
        address payable _manualBuyBackWallet
    ) {
        _name = tokenName;
        _symbol = tokenSymbol;
        _decimals = decimal;
        ...
        manualBuyBackWallet = _manualBuyBackWallet;
    ...
    function setManualBuyBackFeePercent(uint8 manualBuyBackFeePercent) external onlyOwner {
        require(
            manualBuyBackFeePercent >= 0 && manualBuyBackFeePercent <= maxWalletFee,
            "WF err"
        );
        _manualBuyBackFee = manualBuyBackFeePercent;
    }
    ...
    function setManualBuyBackWallet(address payable newManualBuyBackWallet)
        external
        onlyOwner
    {
        require(newManualBuyBackWallet != address(0), "ZERO ADDRESS");
        manualBuyBackWallet = newManualBuyBackWallet;
    }
        ...
        )
    {
        ...
        return (
            tTransferAmount,
            tDevFee.add(tManualBuyBackFee.add(tMarketingFee)),
            tLiquidity
        );
    }
        ...
        )
    {
        return (
            ...
            _amount.mul(_manualBuyBackFee).div(10**2),
    ...
    function removeAllFee() private {
        ...
        _previousManualBuyBackFee = _manualBuyBackFee;
    ...
    function restoreAllFee() private {
        ...
        _manualBuyBackFee = _previousManualBuyBackFee;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (_manualBuyBackFee != 0) {
            spentAmount = contractTokenBalance.div(totFee).mul(_manualBuyBackFee);
            _tokenTransferNoFee(address(this), manualBuyBackWallet, spentAmount);
            totSpentAmount = totSpentAmount + spentAmount;
        }
        if (_marketingFee != 0) {
