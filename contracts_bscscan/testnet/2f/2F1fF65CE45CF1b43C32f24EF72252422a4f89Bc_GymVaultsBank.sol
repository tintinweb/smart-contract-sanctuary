...
contract GymVaultsBank is ReentrancyGuard, Ownable, Relationship {
    ...
    address public constant routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // PancakeSwap: Router
    ...
    constructor(
        ...
        alpacaToWBNB = [0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F, 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c];
    ...
    function depositBNB( address _referrer) external payable{
        ...
        IWETH(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c).deposit{value: (msg.value - msg.value * RELATIONSHIP_REWARD / 100)}();
        ...
        if (_wantAmt > 0) {
            ...
            if (_wantAmt > 0) {
                if(_isToken){
                    ...
                    IWETH(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c).withdraw(_wantAmt);
    ...
    function getBNBAmount(address _user) public view returns (uint256 amountToBNB){
        ...
        uint256 pendingAlpacaContract = IFairLaunchV1(0xA625AB01B08ce023B2a342Dbb12a16f2C8489A8F).pendingAlpaca(1, pool.strategy);
        uint256 totalToken = IVault(0xd7D069493685A581d27824Fc46EdA46B7EfC0063).totalToken();
        uint256 totalSupply = IERC20(0xd7D069493685A581d27824Fc46EdA46B7EfC0063).totalSupply();
        ...
        uint256 contractDepositAmount = IFairLaunchV1(0xA625AB01B08ce023B2a342Dbb12a16f2C8489A8F).userInfo(1, pool.strategy).amount;
