...
// File: @anpanswap/anpans-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/AnpansBunnies.sol

pragma solidity ^0.6.0;

contract AnpansBunnies is ERC721, Ownable {
    ...
    constructor(string memory _baseURI) public ERC721("Anpans Bunnies", "PB") {
...
contract BunnyFactoryV2 is Ownable {
    ...
    AnpansBunnies public anpansBunnies;
    IBEP20 public anpanToken;
    ...
    // Number of ANPANs a user needs to pay to acquire a token
    ...
    /**
     * @dev Mint NFTs from the AnpansBunnies contract.
     * Users can specify what bunnyId they want to mint. Users can claim once.
     * There is a limit on how many are distributed. It requires ANPAN balance to be > 0.
     */
    function mintNFT(uint8 _bunnyId) external {
        ...
        // Send ANPAN tokens to this contract
        anpanToken.safeTransferFrom(
            address(_msgSender()),
            address(this),
            tokenPrice
        );
        ...
        uint256 tokenId =
            anpansBunnies.mint(address(_msgSender()), tokenURI, _bunnyId);
    ...
    function changeOwnershipNFTContract(address _newOwner) external onlyOwner {
        anpansBunnies.transferOwnership(_newOwner);
    }

    /**
     * @dev It transfers the ANPAN tokens back to the chef address.
     * Only callable by the owner.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        anpanToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    function setBunnyNames(
        ...
        anpansBunnies.setBunnyName(5, _bunnyId5);
        anpansBunnies.setBunnyName(6, _bunnyId6);
        anpansBunnies.setBunnyName(7, _bunnyId7);
        anpansBunnies.setBunnyName(8, _bunnyId8);
        anpansBunnies.setBunnyName(9, _bunnyId9);
    }
