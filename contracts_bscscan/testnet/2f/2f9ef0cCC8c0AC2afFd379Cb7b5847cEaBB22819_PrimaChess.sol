...
contract PrimaChess is Context, IERC20, Ownable {
    ...
    string private _name = "PrimaChess";
    
    string private _symbol = "Prima";
    ...
    address public devWallet = 0xAb8795Da52D807a5a2bB63F69F6ae528eaf71Fd3;
    
    uint256 private _previousdevFee = _devFee;  
    
    uint256 public maxTransactionAmount =  1 * 10000000 * (10**8);
    ...
    function setMaxTransectionLimit (uint txnLimit) external onlyOwner(){
        maxTransactionAmount = txnLimit * 10000000 * (10**8);
    }
