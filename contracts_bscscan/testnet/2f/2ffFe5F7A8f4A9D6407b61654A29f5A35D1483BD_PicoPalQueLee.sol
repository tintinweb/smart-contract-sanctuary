...
contract PicoPalQueLee is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0x39A3E74dFd136112300FaF7A0bfe80C97382Af2c);

    address payable public teamAddress =
    payable(0x026a243b98B6AdE6564870d76FceBFed0C244b3f);

    address payable public liquidityAddress =
    payable(0x87919cd8E996d517810a1Dde0D4029C2dBba0599);
    ...
    string private constant _name = "Crazytest";
    string private constant _symbol = "$Crazytest";
