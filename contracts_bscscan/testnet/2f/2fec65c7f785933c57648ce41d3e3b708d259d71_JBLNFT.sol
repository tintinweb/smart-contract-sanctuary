...
contract JBLNFT is ERC721{
    ...
    uint8 public mint_total = 100;

    constructor ()  public ERC721("Smiling George Homerun", "Homerun"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "Smiling George Homerun";
        string memory _t = "Homerun";
        string memory tokenURI = "https://jbl.i-recu.com/assets/images/player/coop_3.png";

        token.transferFrom(msg.sender, address(this), 1*10**18);

        cards.push(Card(name,_t,tokenURI));
