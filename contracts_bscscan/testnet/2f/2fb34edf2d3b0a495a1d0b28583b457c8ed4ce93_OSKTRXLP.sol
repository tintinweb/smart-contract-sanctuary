...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0xe2Aa3d41faDA0cE9adc0986bc57a5cb25C9EcA77); // Stake Token address
...
contract OSKTRXLP is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public osk = IERC20(0x985a72CcEB7441135231506fA7E31dEaaEcFEf10);
    
    uint256 public constant DURATION = 10 minutes;
    uint256 public constant rewardDebuff = 1 minutes;

    uint256 public starttime = 1641436183;
    ...
    function getReward() public updateReward(msg.sender)  checkStart{
        ...
        if (reward > 0) {
            ...
            safeOSKTransfer(project1, reward.mul(4).div(100)); 
            safeOSKTransfer(project2, reward.mul(4).div(100)); 
            safeOSKTransfer(project3, reward.mul(4).div(100)); 
            safeOSKTransfer(project4, reward.mul(4).div(100)); 
            safeOSKTransfer(project5, reward.mul(4).div(100)); 
            ...
            if(referralRelationships[msg.sender]!=address(0))
            {
                ...
                safeOSKTransfer(referrer, referrerFee); 
    ...
    function safeOSKTransfer(address _to, uint256 _amount) internal {
        ...
        if(_amount > oskBalance) {
            osk.safeTransfer(_to, oskBalance);
        } else {
            osk.safeTransfer(_to, _amount);
        }
