...
contract SsiStaticNFT is ERC721Enumerable, Ownable {
    ...
    uint public mintPrice = 50 ether; // 50 SSI
    ...
    */
    ...
    function pickCharacter(uint seed) public view returns(CharacterInfo memory character, uint randomNum){
