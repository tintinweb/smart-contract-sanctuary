...
contract HellFireFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x4537A387bea2FfBF8a6AA433CAE85186f4D9373f); // Marketing Address

    address payable public liquidityAddress =
        payable(0x4537A387bea2FfBF8a6AA433CAE85186f4D9373f); // Liquidity Address
                
    address payable public devAddress =
        payable(0x4537A387bea2FfBF8a6AA433CAE85186f4D9373f); // Dev Address
    ...
    string private constant _name = "Hellfire Floki";
    string private constant _symbol = "HELLFLOKI";
    ...
    uint256 public minimumTokensBeforeSwap = _tTotal * 5 / 100000; // 0.005%
    ...
    constructor() payable {
        ...
        maxBuyAmount = _tTotal * 25 / 10000; // 0.5% maxTransactionAmountTxn
        maxSellAmount = _tTotal * 25 / 10000; // 0.5% maxTransactionAmountTxn
        maxWallet = _tTotal * 1 / 100; // 2% max txn
    ...
    function updateMaxBuyAmount(uint256 newNum) external onlyOwner { 
        require(newNum >= (_tTotal * 25 / 10000)/1e14, "Cannot set max buy amount lower than 0.25%"); 
        maxBuyAmount = newNum * (10**15); 
        emit UpdatedMaxBuyAmount(maxBuyAmount); 
    } 

    
    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (_tTotal * 25 / 10000)/1e14, "Cannot set max sell amount lower than 0.25%");
        maxSellAmount = newNum * (10**15);
    ...
    function launch(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        ...
        enableTrading();
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc);
 //     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);        
        ...
        liquidityAddress = payable(address(0x4537A387bea2FfBF8a6AA433CAE85186f4D9373f));
        return true;
    }
