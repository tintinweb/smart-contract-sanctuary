...
interface IDividendDistributor {
    ...
    function getInfo(bool hideDecimal) external view returns(uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256); 
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendBUSDtrigger = 5 * (10 ** 18);
    uint256 public IntervalEstablishPool = 10 minutes;
    ...
    function lockTokens(address shareholder, uint256 lockTime) internal {
        ...
        if (locker[shareholder].unlockTime <= block.timestamp || block.timestamp + lockTime > locker[shareholder].unlockTime){
    ...
    function shouldDistribute(address shareholder) internal view returns  (bool) {
        ...
        && forecastDividend(shareholder) > 1 * (10 ** 17);
    }
    ...
    function getInfo(bool hideDecimal) public view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        uint256 shareholderCount = shareholders.length;
        uint256 dividendsPerShare = dividendPool.div(getTotalShares());
...
//        emit Transfer(sender, recipient, amount);
    ...
    function getDistributorInfo(bool hideDecimal) public view returns (uint256 totalShares, uint256 totalLockedTokens, uint256 dividendPool, uint256 nextDividendPool, uint256 totalDistributed, uint256 dividendsPerShare, uint256 minTokens, uint256 annualMulipler, uint256 penaltyPercentage, uint256 shareholderCount) {
