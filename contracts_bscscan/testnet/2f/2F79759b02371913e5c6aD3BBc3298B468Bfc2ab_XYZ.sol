...
contract XYZ is Context, IERC20, Ownable {
    ...
    address payable public _charityAddress =
        payable(0x831849b316f43455A7c123B13A45f674D7aa5829);
    address payable public _marketingAddress =
        payable(0x833089B7ce9694382cebFD004E989f87d6628B4f);
     ...
     */
    function addContractSupportTokens(uint8 index, uint256 amount) external {
    ...
    function _transfer(
        ...
        } // !_lockSwap && _transferType != TransferType.Excluded
        ...
        LockSwap
    {
        ...
        if (
            ...
            tokensToSell += charityFee + marketingFee + buybackFee;

            if (extraLiquidityFee > 0) {
                extraLiquidityFee /= 2; // Divide itself by half

                tokensToSell += extraLiquidityFee;
