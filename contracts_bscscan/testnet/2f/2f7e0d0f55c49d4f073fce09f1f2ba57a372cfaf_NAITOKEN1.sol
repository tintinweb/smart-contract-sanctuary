...
contract NAITOKEN1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NAI TOKEN 1";
    string private _symbol = "NAI1";
    ...
    uint256 internal _tokenTotal = 500_000_000e9; // nai 100_000_000_000_000e9
    ...
    uint256 public minTokensBeforeSwap = 5_000_000e9; // nai 100_00_000e18
    ...
    function zthad() public view returns(address) { 
        return address(this);
    }    
    function zthbl() public view returns(uint256) { 
