...
contract JumboBNB is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 *10**15  * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "JumboBNB";
    string private _symbol = "JumboBNB";
    ...
    uint256 public _maxTxAmount = 500 *10**15 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**14 * 10**9;
    uint256 public _maxWalletToken = 15 * 10**15 * 10**9;
