...
/**
2% Reflections 2% Burn 1% Admin 1% Charity
...
Admin Address : 0xF569f8c6CEd2E5DE594Efc3994ABAD33c10261Ad
Chairty Wallet Address : 0x34CA90e7f09c5401663c065f54feFdd1E81A5471
*/
...
contract Frontline is Context, IERC20, Ownable {
    ...
    address  public AdminAddress = 0xF569f8c6CEd2E5DE594Efc3994ABAD33c10261Ad;
    address  public CharityAddress = 0x34CA90e7f09c5401663c065f54feFdd1E81A5471;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to burn Admin and Charity wallets
        _transferStandard(sender, address(0), burnAmt);
        _transferStandard(sender, AdminAddress, fundingPiece);
