...
contract GOLcoin is Context, IERC20, Ownable {
    ...
    constructor(address _marketingContract) public {
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
       ...
       _rOwned[marketingContract] = _rOwned[marketingContract].add(rFee);
            _tOwned[marketingContract] = _tOwned[marketingContract].add(tFee);
    }
