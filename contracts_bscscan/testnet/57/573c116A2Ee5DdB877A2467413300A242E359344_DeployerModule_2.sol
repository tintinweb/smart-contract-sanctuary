...
import '../generics/SafeMoonGeneric.sol';

contract DeployerModule_2 is Ownable {
    function deployGeneric(
        ...
        SafeMoonGeneric Contract = new SafeMoonGeneric(
            name_,
            symbol_,
            decimals_,
            totalSupply_,
...
contract SafeMoonGeneric is Context, ERC20, Ownable {
    ...
    constructor(
        ...
        uniswapV2Pair = _uniswapV2Router.factory().createPair(address(this), _uniswapV2Router.WETH());
        ...
        if (presaler != address(0)) {
            _isExcludedFromFee[presaler] = true;
        }
