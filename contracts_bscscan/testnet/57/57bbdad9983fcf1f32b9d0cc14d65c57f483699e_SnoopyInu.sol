...
contract SnoopyInu is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "MINT TEST";
...
//   }
  ...
  function burn(address _to, uint256 _amount) onlyOwner public returns (bool){
