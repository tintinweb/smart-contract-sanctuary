...
contract Windmill_Withdrawer is Adressable, Math, AccessControlEnumerable, With_DAORole, With_TradeManagerRole, With_PWRToken,
    ...
    function askWithdraw(uint256 nbPWR) external{
        ...
        (uint256 nbFreePwr, uint256 maxNbLockedPwr, uint256 flatLockPercentNumerator, uint256 maxLockPercentNumerator, uint256[2][] memory lockDatas) = fund.getDataPWRLock(msg.sender);
