...
contract TopElonCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TopElonCoin";
    string private _symbol = "TopECoin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7a74EbB9cD1933688138D22527C5942D58632437); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7a74EbB9cD1933688138D22527C5942D58632437); // BuyBack Address
