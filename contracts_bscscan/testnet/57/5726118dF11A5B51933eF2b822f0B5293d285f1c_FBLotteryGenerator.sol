...
contract FBLotteryGenerator is VRFConsumerBase, Ownable {
    ...
    address public treasuryWallet = address(0xdead); //CHANGEME
    ...
    function getCurrentLotteryStats() public view returns (address lotteryAddress, uint256 lotteryID, address[] memory entrants, uint256 potentialWinnings, uint256 currentTicketsHeld, uint256 endTime, bool isLive) {
        ...
        entrants = currentLottery.getUniqueTicketHolders();
    }
