...
contract BattleHeroGen is Ownable {
    ...
    constructor() {
        setFactoryContract(0x60A7F718D9864DcFB71786bE2EDc9F1dB0D2ac03);
    ...
    function breedsOf(address breeder) view public returns(Breed memory){
        return _breeds[breeder];
    }
    function claim() public {
        ...
        (bool success, bytes memory result) = address(0xAB32E719A6EC0d55D0C3B2FCDb41443b113098e2).delegatecall{gas: 30000}(abi.encodeWithSignature("mint(address,bytes32)", msg.sender, gen));        
    }
