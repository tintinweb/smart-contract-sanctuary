...
contract TKDIVI is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 300000000 * (10**18);
    ...
    constructor() public ERC20("GDIVIPLAN", "GDVPL") {
        // LP burn address
    ...
    function _transfer(
        ...
        if(from != owner() || to != owner() || !_isExcludedFromLimits[from] || !_isExcludedFromLimits[to]){
