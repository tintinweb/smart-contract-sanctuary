...
contract stakeToken {
    ...
    address tokenAddress = 0x92077D8Ab2A229EcfDEF68F0Ad3E1A36fb841752;
    tokenContract tokenContr = tokenContract(tokenAddress);
    ...
    function stakeTokens(uint256 amount) public{
        ...
        tokenContr.transferFrom(msg.sender, address(this), amount);

        // 10% tax is applied and burned.
        uint256 unstakeTax = amount.div(10);
        tokenContr.transfer(0x000000000000000000000000000000000000dEaD, unstakeTax);
    ...
    function unstakeTokens(uint256 amount) public {
        ...
        if(isLocked == false){
            ...
            tokenContr.transfer(msg.sender, amount);
        }
    }
