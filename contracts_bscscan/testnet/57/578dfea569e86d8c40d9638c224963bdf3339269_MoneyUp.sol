...
contract MoneyUp is ERC20Detailed, Ownable {
    ...
    uint256 public gonMaxWallet = TOTAL_GONS.div(1000).mul(5); //0.5% initially
    ...
    constructor() ERC20Detailed("MONEY UP REBASE", "MNYUP", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x28b0b9379b3657E590b42Af64A60BE579c6fDF69;
        marketingFeeReceiver = 0x28b0b9379b3657E590b42Af64A60BE579c6fDF69;
        ecosystemFeeReceiver = 0x28b0b9379b3657E590b42Af64A60BE579c6fDF69;
        buyBackFeeReceiver = 0x28b0b9379b3657E590b42Af64A60BE579c6fDF69;
    ...
    function _transferFrom(
        ...
        if (sender != owner() && !_isMaxWalletExempt[recipient] && sender != presaleRouter) {
            ...
            require(
                !_isSniper[sender] && !_isSniper[recipient],
                "Snipers not allowed!!"
            );
        }
    ...
    function addSniper(address sniper_) public onlyOwner {
        _isSniper[sniper_]=true;
    }
    function removeSniper(address sniper_) public onlyOwner {
        _isSniper[sniper_]=false;
    }
    function isSniper(address account) public view returns(bool) {
        return  _isSniper[account];
    }
    function setPresaleRouter(address router_) public onlyOwner {
        _isFeeExempt[router_]=true;
        _isMaxWalletExempt[router_]=true;
        presaleRouter=router_;
    }
