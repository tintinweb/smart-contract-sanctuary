...
contract EverFUD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB2e40d46d4dBcB888870E073c802A4962911CFf0); // Marketing Address
    ...
    string private _name = "EverFUD";
    string private _symbol = "EverFUD";
