...
contract EMC2 is IERC20, Ownable {
    ...
    function selectBox(uint256 boxId) public {
        ...
        if(1 == boxId && box1MaxTimes > 0){
            //检查 用户资产
            require(balanceOf(msg.sender) > 1800 * 10 **18,"This user dont hava enough EMSC ");

            require(allowance >= 1800 * 10 **18 , "Check the token allowance");
        
            //销毁代币
            transferFrom(msg.sender,address(this),1800 * 10 **18);
            burn(1800 * 10 **18);
        ...
        if(2 == boxId && box2MaxTimes > 0){
            ...
            require(balanceOf(msg.sender)  > 5200 * 10 **18,"This user dont hava enough EMSC ");

            require(allowance >= 5200 * 10 **18 , "Check the token allowance");
            
            transferFrom(msg.sender,address(this),5200 * 10 **18);
            burn(5200 * 10 **18);
        ...
        if(3 == boxId && box3MaxTimes > 0){
            ...
            require(balanceOf(msg.sender)  > 8100 * 10 **18,"This user dont hava enough EMSC ");
            
            require(allowance >= 8100 * 10 **18 , "Check the token allowance");
            
            transferFrom(msg.sender,address(this),8100 * 10 **18);
            burn(8100 * 10 **18);
    ...
    string private _name = "Exotic Monster";
    string private _symbol = "EMSC";
