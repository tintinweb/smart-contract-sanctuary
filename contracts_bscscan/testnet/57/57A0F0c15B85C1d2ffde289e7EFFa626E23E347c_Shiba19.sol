...
contract Shiba19 is Context , IERC20, Ownable {
    ...
    string private _name = "Shib19";
    string private _symbol = "SHIBA19";
    ...
    address public devWallet = 0x000000000000000000000000000000000000dEaD; //Burn baby burn
    ...
    uint256 public _maxTxAmount = 694 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 694 * 10**9 * 10**9;
