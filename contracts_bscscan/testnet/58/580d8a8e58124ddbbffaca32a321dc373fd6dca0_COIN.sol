...
// File: contracts/EarnTokenDividendPayingToken.sol
...
contract COIN is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address public immutable MATICToken = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  // previous parameter address payable user
  ...
  function _withdrawDividendOfUser(address user) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
      ...
      bool success = IERC20(MATICToken).transfer(user, _withdrawableDividend);
...
contract EarnTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("EarnToken_Dividend_Tracker", "EarnToken_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "EarnToken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "EarnToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
            require(newClaimWait >= 3600 && newClaimWait <= 86400, "EarnToken_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "EarnToken_Dividend_Tracker: Cannot update claimWait to same value");
