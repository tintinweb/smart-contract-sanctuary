...
/**
    FLOKICUPCAKE ~ STEALTH LAUNCH
    https://t.me/flokicupcake
    ...
    💵 1.4% Max Buy Tx ( 1,400,000,000 $FLOCAKE )
    💵 0.7% Max Sell Tx ( 700,000,000 $FLOCAKE )
    💰 4% Max Bag ( 4,000,000,000 $FLOCAKE )
    🔃 10 Seconds TX Cooldown ( Buy & Sell ) , the cooldown timer is independent between wallet and between buy & sell
...
// CHANGE
contract FLOKIlaMtEST is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FLOKICUPCAKE";
    string constant _symbol = "$FLOCAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    
    // LIMITTER
    uint256 public _maxBuyTxAmount = (_totalSupply * 14) / 1000; // 1.4% MAX 1,400,000,000
    uint256 public _maxSellTxAmount = (_totalSupply * 7) / 1000; // 0.7% MAX 700,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xaf944a40c7e121195f6D04204Bce40D6A437b903);
