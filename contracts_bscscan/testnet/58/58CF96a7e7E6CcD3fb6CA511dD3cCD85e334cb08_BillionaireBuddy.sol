...
//TG LINK: https://t.me/BillionaireBuddy
...
// CHANGE
contract BillionaireBuddy is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BillionaireBuddy";
    string constant _symbol = "BIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 3% MAX 300,000
    ...
    uint256 devFee = 9900;
    uint256 totalFee = 9900; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4D9AaD60b1a84CC94beF90dFfef873aE173E4d00); // Change
