...
// how the contract works
    ...
    // this contract does not bother how allocPerc is dettermined.
...
// core routines                                           
    function depositTokens(uint _amount) external onlyOwner claimDisabled whenNotStarted { 
        // do some checks 
    ...
    function swap(uint _amount) external claimDisabled onProgress { // 
        // do some checks 
...
// setters
    ...
    //function setWantToken(address _wantToken) external onlyOwner whenNotStarted {
