 ...
 *      Fees on Buy: 13% / Fees on Sell: 13%
 *  4% BUSD Rewards 2% Liquidity 6% Team 1% Lottery
 *                          
 * 
 *                  Pikainubusd
 * 
...
contract Pikainubusd is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Pikainubusd";
    string constant _symbol = "PikaPika";
    ...
    constructor () Auth(msg.sender) {
        ...
        teamWallet = 0x38543a574Bab645Ec07bB4b728076b5453D1237f;  // teamwallet
        lotteryWallet = 0xDeD78013A9fA0eAF8b1D2Ae3d777C6FaBb94C47F;  // lotterywallet
        
        totalFee = liquidityFee.add(teamFee).add(rewardsFee).add(lotteryFee);
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newTeamFee, uint256 newLotteryFee) external authorized {
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newTeamWallet, address newLotteryWallet) external authorized {
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(teamFee).div(totalBNBFee);
        ...
        (bool tmpSuccess,) = payable(teamWallet).call{value: amountBNBMarketing, gas: 30000}("");
