...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD TESTNET
    //dont change that (:
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // ROUTER TESTNET
        _token = msg.sender;
    }
...
contract USA is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //BUSD TESTNET
    //do not change this
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //WBNB TESTNET
    ...
    address public marketingFeeReceiver = 0x4c9E4FD342612936BB8702eCb8D83803882ed44C; //MARKETINGWALLET NEWNIKE
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //ROUTER TESTNET
