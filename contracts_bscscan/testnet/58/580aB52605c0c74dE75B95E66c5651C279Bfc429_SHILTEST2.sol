...
contract SHILTEST2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2b763946E99c733ccBe94a9532093E903e3Cf4b9); // Marketing Address
    ...
    string private _name = "SHILTEST2";
    string private _symbol = "STEST2";
    ...
    constructor () {
        ...
        // uniswap Router Testnet v2 - Not existing I guess
         //Prod IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
