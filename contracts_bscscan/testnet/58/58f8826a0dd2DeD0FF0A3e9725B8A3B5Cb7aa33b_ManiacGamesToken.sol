...
contract ManiacGamesToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0c6011fc8FE20a55a4c8a9334B27D31a4A3ffD86); // Marketing Address
    address payable public charityAddress = payable(0x0c6011fc8FE20a55a4c8a9334B27D31a4A3ffD86); // Charity/Dev Address
    ...
    string private _name = "Maniac Games Token";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   100000000000000000; //0.002 BNB Airdrop fee
    ...
    uint256 private salePrice = 20000;// 0.01*100000000000=10,000,000,000 token for 0.01 bnb (set as per requirements)
