...
NanoDOGE Testnet is the BIGGEST smallest BSC token
...
contract NanoDOGE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8A5235e9fB176a5d3E2367372e5cF4C8cBCc9027); // Marketing Address
    ...
    string private _name = "NanoDOGE";
    string private _symbol = "NanoDOGE";
