...
contract KNCCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3E85a7b349eAFEcf8d8F6f20f4969999E67cC356); // Marketing Address
    ...
    string public _name = "knccoin";
    string public _symbol = "KNC";
    ...
    function _removeOldSellHistories() public {
        uint256 i = 0;
