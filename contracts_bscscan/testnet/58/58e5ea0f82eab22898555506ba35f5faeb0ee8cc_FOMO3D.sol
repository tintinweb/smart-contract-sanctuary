...
contract FOMO3D is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 8 * 10**8 * 10**18;
    uint256 public _numTokensToBeGroupLeader = 100 * 10**4 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FOMO3D";
    string private _symbol = "F3D";
    uint8 private  _decimals = 18;

    uint256 public _taxFee = 2;       //
    uint256 public _referFee = 5;     //2%, 1%, 1% for 1/2/3 level referer, 1% for group leader
    uint256 public _developerFee = 2;  //fixed to 2%
    uint256 public _lotteryFee = 6;
    ...
    IERC20 public usdt = IERC20(0x51657285b545F1D92D8AB80B6120498931cC9Dc7);  //IERC20(0x55d398326f99059fF775485246999027B3197955);
    ...
    uint256 public _extraFeeForNoRefer = 2; //2% extraFee  
    uint256 public _groupLeaderSearchDepth = 10;
    ...
    function _takeReferRewards(address recipient, uint256 rReferReward, uint256 tReferReward) private {
...

        {
            ...
            for (uint256 i= 0; i < REFER_DEPTH - 1; i++){
                ...
                userInfo[beneficiaries[i]].referRewards[i] += tRewards[i];
            }
            ...
            userInfo[beneficiaries[_groupLeaderIndex]].referRewards[_groupLeaderIndex] += tRemain;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if (takeFee) {
            ...
            feeRates = _getFeeRates(extraFee);
        }
