...
abstract contract Tokenomics {
    ...
    string internal NAME = "Chameleon";
    string internal SYMBOL = "CHML";
    ...
    address internal DevMarketingAddress = 0xa1CFc4074eF02F55a45D200AD9C11495f7F80148;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 50, DevMarketingAddress );
    }
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Tokenomics {
    ...
    function setTokenName(string memory newName, string memory newSymbol) external onlyOwner() {
        NAME = newName;
        SYMBOL = newSymbol;
    }
    ...
    function _isUnlimitedSender(address account) internal view returns(bool){
        ...
        return (account == owner() || account == DevMarketingAddress);
    }
    /**
     */
    function _isUnlimitedRecipient(address account) internal view returns(bool){
        ...
        // he/she wants
        return (account == owner() || account == burnAddress || account == DevMarketingAddress);
    }
...
abstract contract Chameleon is BaseRfiToken, Liquifier, Antiwhale {
...
contract ChameleonV1 is Chameleon{

    constructor() Chameleon(Env.Testnet){
