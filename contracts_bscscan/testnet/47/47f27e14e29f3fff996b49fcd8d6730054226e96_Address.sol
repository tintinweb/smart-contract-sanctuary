...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBAACb757F8f68258Fa3501B15D6ee1B0EE6B3Ae8;
...
contract MONOKUMA is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xBAACb757F8f68258Fa3501B15D6ee1B0EE6B3Ae8;
    ...
    string private _name = "TAX TEST TOKEN";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x3CBC7a1EAb6540A38C829DF08147E7ddb03546e3, 'We can not exclude Uniswap router.');
