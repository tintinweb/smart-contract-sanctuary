...
contract HONEYPOT is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 1 * 10**5 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;

    string public _name = "Honeypot";
    string public _symbol = "Honeypot";
    ...
    uint256 public numTokensSellToAddToLiquidity = 7 * 10**2 * 10**9;
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 currentRate) public pure returns (uint256, uint256, uint256) {
