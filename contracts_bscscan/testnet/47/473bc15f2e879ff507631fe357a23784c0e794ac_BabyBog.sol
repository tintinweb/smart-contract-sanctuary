...
/**
     Welcome to BabyBog. Here you will earn massive BOG rewards for holding. This is a perfect token for snipers.
     If you have not used Bogged yet, Check it out. They have great charts, snipers, stop loss, and limit orders!
     Bog is one of the best contracts in BSC with a legandary developer. 
     
     Tokens pay out every 5 minutes with enough volume, Or you can purchase or sell one token and look in your BSC scan to see your rewards. 
     
     Join the TG - https://t.me/BabyBogBSC

     After earning your Bog tokens go to https://bogged.finance/ and use them to better your BSC experiance!
     */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0xB09FE1613fE03E7361319d2a43eDc17422f36B09);
...
contract BabyBog is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyBog";
    string constant _symbol = "BabyBog";
