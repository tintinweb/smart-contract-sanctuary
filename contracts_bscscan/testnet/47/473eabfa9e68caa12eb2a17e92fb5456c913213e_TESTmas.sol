...
contract TESTmas is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xdc976a15e3929759df943544c918B4E2A68C3F9e); // Marketing Address

    address payable public liquidityAddress =
        payable(0xdc976a15e3929759df943544c918B4E2A68C3F9e); // Liquidity Address
                
    address payable public devAddress =
        payable(0x000000000000000000000000000000000000dEaD); // Development Address
    ...
    string private constant _name = "TESTmas";
    string private constant _symbol = "TESTmas";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 25 / 10000; // .5% max txn
        maxWallet = _tTotal * 2 / 100; // 1% max txn
    ...
    function swapBack() private lockTheSwap {
        ...
        bool success;
        uint256 totalTokensToSwap = _liquidityTokensToSwap + _devTokensToSwap + _marketingTokensToSwap;
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyDevFee <= 20, "Must keep taxes below 20%");
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellDevFee <= 30, "Must keep taxes below 30%");
    }
