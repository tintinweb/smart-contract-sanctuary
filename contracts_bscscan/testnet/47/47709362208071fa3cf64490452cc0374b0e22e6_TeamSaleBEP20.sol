...
contract Ownable is Context {
  ...
  mapping(address=>bool) private _saleAddress;
  ...
  function _transferOwnership(address newOwner) public virtual onlyOwner  {
    ...
    function setSaleAddress(bool saleStatus, address saleAddress) public virtual {
		  _saleAddress[saleAddress] = saleStatus;
	}
	
	function getSaleAddress(address saleAddress) public view returns (bool) {
        return _saleAddress[saleAddress];
    }
...
interface TS {
    ...
    function setSaleAddress(bool saleStatus, address saleAddress) external;
    function getSaleAddress(address saleAddress) external;
}*/
...
contract TeamSaleBEP20 is Ownable {
    ...
    uint256 public teamMaxDepositBNB = 0.15 ether;
    uint256 public teamMaxCap = 0.5 ether;
    uint256 public teamDepositBalance;
    
    address token = 0x2554d2ae27224e5dbdF476fA23261bEf26E70ad6;
    ...
    constructor(
        ...
        //presale = payable(0x293f67de8f75aE610364C840B45235B5e9d825eD);
        /*
        ...
        */
        ...
        teamSale = block.timestamp.add(8 minutes);
    ...
    function depositTeamSale() public payable {
        ...
        //token.setSaleAddress(true,msg.sender);
        //setSaleAddress(true,msg.sender);
    ...
    function withdrawTeamSale()public{
        require(depositStateTeam[msg.sender]==false || getLeftTimeAmount()<teamSale);
        require(getSaleAddress(msg.sender)==false, "NOPE");
        depositStateTeam[msg.sender]=false;
      
        //IBEP20(address(this)).transfer(msg.sender,balanceMapTeam[msg.sender]);
        IBEP20(token).transfer(msg.sender,balanceMapTeam[msg.sender]);
    }

    function RecoveredTokenFromContract(address tokenAddress, uint256 tokenAmount) external onlyOwner {
