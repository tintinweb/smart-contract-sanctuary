...
contract TestTokenDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("TestToken_Dividend_Tracker", "TestToken_Dividend_Tracker") {
        claimWait = 3600;
...
contract TestToken is BEP20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    function setFee(uint256 _bnbRewardFee, uint256 _liquidityFee, uint256 _devFee) public onlyOwner {
        BNBRewardsFee = _bnbRewardFee;
        liquidityFee = _liquidityFee;
        devFee = _devFee;

        totalFees = BNBRewardsFee.add(liquidityFee).add(devFee); // total fee transfer and buy
    }
    ...
    constructor() BEP20("TestToken", "TestToken") {
        BNBRewardsFee = 8;
        liquidityFee = 2;
        extraFeeOnSell = 5; // extra fee on sell
        devFee = 5;
        devWallet = payable(0x40E5C545912f22359492521D99Df60eAADef4d2C);
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "TestToken: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "TestToken: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
