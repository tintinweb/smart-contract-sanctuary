...
library SafeCast {
    ...
    function toUint224(uint256 value) internal pure returns (uint224) {
        require(value <= type(uint224).max, "SfeCst: Val not fit in 224 bits");
    ...
    function toUint128(uint256 value) internal pure returns (uint128) {
        require(value <= type(uint128).max, "SfeCst: Val not fit in 128 bits");
    ...
    function toUint96(uint256 value) internal pure returns (uint96) {
        require(value <= type(uint96).max, "SfeCst: Val not fit in 96 bits");
        return uint96(value);
    }
    ...
    function toUint64(uint256 value) internal pure returns (uint64) {
        require(value <= type(uint64).max, "SfeCst: Val not fit in 64 bits");
        return uint64(value);
    }
    ...
    function toUint32(uint256 value) internal pure returns (uint32) {
        require(value <= type(uint32).max, "SfeCst: Val not fit in 32 bits");
        return uint32(value);
    }
    ...
    function toUint16(uint256 value) internal pure returns (uint16) {
        require(value <= type(uint16).max, "SfeCst: Val not fit in 16 bits");
        return uint16(value);
    }
    ...
    function toUint8(uint256 value) internal pure returns (uint8) {
        require(value <= type(uint8).max, "SfeCst: Val not fit in 8 bits");
        return uint8(value);
    }
    ...
    function toInt128(int256 value) internal pure returns (int128) {
        require(value >= type(int128).min && value <= type(int128).max, "SfeCst: Val not fit in 128 bits");
        return int128(value);
    }
    ...
    function toInt64(int256 value) internal pure returns (int64) {
        require(value >= type(int64).min && value <= type(int64).max, "SfeCst: Val not fit in 64 bits");
        return int64(value);
    }
    ...
    function toInt32(int256 value) internal pure returns (int32) {
        require(value >= type(int32).min && value <= type(int32).max, "SfeCst: Val not fit in 32 bits");
        return int32(value);
    }
    ...
    function toInt16(int256 value) internal pure returns (int16) {
        require(value >= type(int16).min && value <= type(int16).max, "SfeCst: Val not fit in 16 bits");
        return int16(value);
    }
    ...
    function toInt8(int256 value) internal pure returns (int8) {
        require(value >= type(int8).min && value <= type(int8).max, "SfeCst: Val not fit in 8 bits");
        return int8(value);
    }
    ...
    function toInt256(uint256 value) internal pure returns (int256) {
        ...
        require(value <= uint256(type(int256).max), "SfeCst: Val not fit in an int256");
        return int256(value);
    }
}
 ...
 */
abstract contract ERC20 is IERC20Metadata, Context, Ownable {
...
abstract contract ERC20Permit is ERC20, IERC20Permit, EIP712 {
   ...
   constructor (address sale) ERC20(sale) {
...
contract QfourTokenUpg is Once, Ownable, ERC20Permit {
