...
contract testswap{
    ...
    function addNFTaddress(address set) external  {
        nftAddress=ERC721(set);
    }

    function addFees(uint256 fees) external  {
        currentPrice=fees;
    }
    ...
    function purchaseToken(uint256 _tokenId) public payable  {
     ...
     function sendTo(address payable _payee, uint256 _amount) public payable  {
