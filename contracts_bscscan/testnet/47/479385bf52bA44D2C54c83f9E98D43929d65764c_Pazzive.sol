...
//    bool public feesOnNormalTransfers = false;
    ...
    */
    ...
    constructor(address routerAddress, address busdAddress) ERC20("Pazzive", "PAZ") {
        ...
        lockDurationToBonus[200 days] = 65;
...
//    }
    ...
    */
    ...
    function taxFreeLiquidity(uint256 tokenAmount, uint256 bnbAmount) external payable {
        require(balanceOf(msg.sender) >= tokenAmount, "Insufficient tokens");
        super._transfer(msg.sender, address(this), tokenAmount);
        router.addLiquidityETH{value: bnbAmount}(address(this), tokenAmount, 0, 0, msg.sender, block.timestamp);
    }
