...
contract ChickenFarming is Ownable {
    ...
    uint256 public eggInterval = 3600;
    uint256 public foodInterval = 3600;
    ...
    // Store chicken in farm
     function deposit(uint256 _farmId,uint256 _chicken, uint256 _days ) public {
        checkandBurnoldChicken(msg.sender) ;
    ...
    function checkandBurnoldChicken(address _user) internal {
    ...
    function removeChicken(uint256 _chicken) public {
            ...
            require(block.timestamp >= getUnlockTime(msg.sender), "Not Unlocked yet.");
