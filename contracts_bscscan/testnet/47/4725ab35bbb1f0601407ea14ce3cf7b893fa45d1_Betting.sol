...
contract Betting {
     ...
     */
    function betOnCandidate(bytes32 candidate, uint256 _amount) public payable  {
        require(bettingActive);
        IERC20 token = IERC20(address(0xab8253c3ff96c0313c66eb30ea4ff2f25c110c50)); // Insert the token contract address instead of `0x123`
