...
contract HumanStandardToken is StandardToken {
    ...
    address moneyAddress = 0x337610d27c682e347c9cd60bd4b3b107c9d34ddd;
    ...
    function exchangeToHum(address _user, address _inviteAddress, uint256 exchangeNum) public returns (bool success){
        ...
        carTokenIERC20 carToken = carTokenIERC20(moneyAddress);
        carToken.transferFrom(_user, address(this), setNum);
        
        carTokenIERC20 carTokenThis = carTokenIERC20(address(this));
        carTokenThis.transfer(_user, toHumNum);
