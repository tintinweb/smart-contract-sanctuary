...
contract Token is Context, IBEP20, Ownable {
    ...
    **/
    ...
    //TODO test
    function minerInfo(address minerAddress) internal view returns(uint mStartTime, uint mExpiry, uint256 mHashRate, address mAddress, address rAddress, string memory mMeta, uint256 unlclaimed){
     ...
     */
    function getMinerInfo(address minerAddress) public view returns(uint mStartTime, uint mExpiry, uint256 mHashRate, address mAddress, address rAddress, string memory mMeta, uint256 unlclaimed){
