...
contract tennis is IERC20, Ownable {
    ...
    string constant _name = "tennis";
    string constant _symbol = "tennis";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1 billion tokens
