...
contract YoiShiba is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1200000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "KM22";
    string private _symbol = "KM22";
    ...
    address public marketingWallet = 0xb98D07e78cF31d140F2BDDE9c484B4dC2034C7B0;
    address public devWallet = 0x1248E2e441DeD37cd0233451f05ae88c12016A3B;
    ...
    uint256 public _maxTxAmount = 1200000000000000 * 10**18;
   ...
   function takeDev(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private
    ...
    function prepareFoePresale() external onlyOwner() {
       ...
       _maxTxAmount = 1200000000000000 * 10**18;
