...
contract RandomGenerator2 is VRFConsumerBaseV2, IRandomGenerator, Ownable {
    ...
    event FulfillRandomNumber(uint256 requestId, uint256 randomNumber);
     ...
     */
    constructor(address _vrfCoordinator, address _linkToken, bytes32 _keyHash) VRFConsumerBaseV2(_vrfCoordinator) {
     ...
     */
    function getRandomNumber() external onlyOwner override returns (uint256)  {
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        emit FulfillRandomNumber(requestId, randomWords[0]);
    }
}
