...
contract Brian is ERC20Interface, SafeMath{
    
    address owner;
    string  public name = "Brian Finance";
    ...
    */
    ...
    function transfer(address _to, uint256 _amount) isReleased public returns(bool success){
    ...
    function transferFrom(address _from, address spender, uint256 _amount) isReleased public returns(bool success){
