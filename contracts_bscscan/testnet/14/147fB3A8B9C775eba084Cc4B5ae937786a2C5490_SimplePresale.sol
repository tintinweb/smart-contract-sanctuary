...
contract SimplePresale {
        ...
        uint256 public _price = 1*10**6*10**_decimals;//price1bnb
        uint256 public _cap = _ammount *10**6*10**_decimals;//1 mill x 1mill cap
        uint256 public _totalSale = 0; 
        ...
        function setPresale(uint256 price, uint256 cap, uint256 decimals , uint256 reffPercent) public {
        ...
        function tokenSale(address reff) public payable  {
