 ...
 * 
 * NOTE:
 * - Added overdoseMode and setters, tested and working.
 * - Added deadblocks for antisnipe, getting taxxed 99% if they are in the first amount of deadBlocks.
 * - Added blacklist function 
 * - Set fees and total supply to real tokenomics
 * - Added safeguard for buybackmultiplier not triggering while overdosed
 * - Changed solidity compiler to  0.8.7
 * - This contract is set up for testnet, walk through the CA before deploying!
 * 
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    // NOTE: ETH(TESTNET) 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca
    // NOTE: WBNB(TESTNET) 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    // NOTE: ETH 0x2170Ed0880ac9A755fd29B2688956BD959F933F8
...
/* Token contract */
contract ODcontract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xdD23Ea576C05DFa7a3C7D13b8A659f5b4D4a8318;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; // 10% > 0.5% on launch 500k
    uint256 public _maxSellTxAmount = _totalSupply * 1000 / 10000; // 10% > 2% on launch 2m
    uint256 public _maxWalletToken = ( _totalSupply * 5000 ) / 10000; // 50% > 2% on launch 2m
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(!inOverdoseTime() &&selling && buybackMultiplierTriggeredAt.add(buybackMultiplierLength) > block.timestamp){ return getMultipliedFee(); }
        return totalFee;
    }
