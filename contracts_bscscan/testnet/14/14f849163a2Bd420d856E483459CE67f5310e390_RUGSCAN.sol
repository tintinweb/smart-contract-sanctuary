...
contract RUGSCAN is IBEP20, Auth {
    using SafeMath for uint256;

    IBEP20 MTR =IBEP20(0x1b2FDBbE3cf9DDA67885e98b729cF0BEE9967E45);
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address buyBackSend = 0x790af21c4313aA9A83f038789741fFa5F338a701;

    string constant _name = "RUGSCAN";
    string constant _symbol = "$Rugscan";
    ...
    uint256 devFee = 100;
    uint256 buyTotalFee = 600;
    uint256 sellTotalFee = 1200;
    uint256 sellBurnFee = 100;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;
    address public developmrntWallet = 0x790af21c4313aA9A83f038789741fFa5F338a701;
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalBNBFee = buyTotalFee.sub(dynamicLiquidityFee.div(2));
        ...
        uint256 amountBNBdev = amountBNB.mul(devFee).div(
            totalBNBFee
        );
       ...
       // send to development
               payable(developmrntWallet).call{
            value: amountBNBdev,
            gas: 30000
        }("");
    ...
    function buyTokens(uint256 amount) internal swapping {
        ...
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: amount
        }(0, path, buyBackSend, block.timestamp);
    }
    ...
    function setFees(
        ...
        buyTotalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(
            _marketingFee
        );
        feeDenominator = _feeDenominator;
        require(buyTotalFee < feeDenominator / 4);
    }
