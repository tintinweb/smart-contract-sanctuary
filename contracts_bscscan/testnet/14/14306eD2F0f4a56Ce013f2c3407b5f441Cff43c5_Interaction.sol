...
import "./CarbonFinance.sol";
contract Interaction is CarbonFinance{
    address public  carbon;
    ...
    //     return carbon.getVaultTotalDeposited(0);
    // }

     function getinteract() external  returns (uint256,uint256) {
         return _withdrawFundsTo(0x9c0Cd2044da3c8220d04Af6cF1dED5aad354d8Ab,1);
     }
