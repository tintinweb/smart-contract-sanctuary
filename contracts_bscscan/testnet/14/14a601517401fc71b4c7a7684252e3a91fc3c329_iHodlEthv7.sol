...
contract iHodlEthv7 is IBEP20, Ownable
{
    ...
    function _changeTax(uint256 amount,bool isSell) private{
        //Sliding Tax Added 07/20/2021
    ...
    //Sets Taxes, is limited by MaxTax(40%) to make it impossible to create honeypot
