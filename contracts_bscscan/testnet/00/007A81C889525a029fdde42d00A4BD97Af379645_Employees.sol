...
contract Employees is Context, AccessControlEnumerable, ERC721Enumerable {
    string private _baseUri = "";
    uint256 private _count = 1;

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    mapping(uint256 => NFTS.EmployeeNFT) private employees;
    ...
    function getEmployee(uint256 id)
        ...
        view
        virtual
        returns (NFTS.EmployeeNFTData memory)
    {
        return NFTS.EmployeeNFTData(employees[id], uris[id]);
    }
    ...
    function buildTokenURI(
        ...
        bytes memory union = abi.encodePacked(
            "?path=head:",
            parts[0],
            ";body:",
            parts[1],
    ...
    function mint(
        ...
        employees[_count] = NFTS.EmployeeNFT(
            head,
            body,
            legs,
            hands,
        ...
        uris[_count] = buildTokenURI(_count, getParts(_count), multiplier);
