...
TG: https://t.me/adaxofficial
Website: https://www.adax.live/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PADA = IBEP20(0xaC2A889dEfE2205AA18BD46c0A24e8cAE7084DBB);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PADA.balanceOf(address(this));
        ...
        uint256 amount = PADA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PADA.transfer(shareholder, amount);
...
contract AdaX is IBEP20, Auth {
    ...
    address PADA = 0xaC2A889dEfE2205AA18BD46c0A24e8cAE7084DBB;
    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AdaX";
