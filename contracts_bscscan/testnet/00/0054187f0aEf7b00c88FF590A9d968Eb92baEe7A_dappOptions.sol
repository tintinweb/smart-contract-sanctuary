...
contract dappOptions {
    ...
    uint internal orderFee = 10;
    uint internal orderFeeBase = 10**2;
    uint internal orderPriceBase = 10**2; // 57111.43
    uint internal roundGamePeriod = 120;
    uint internal availableJoinRoundGamePeriod = 30;
