...
contract goPlayer is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7AEebd1D3B0d4BbD36d3dDbBB33E8fD0B1187fDC); // Marketing Address
    ...
    uint256 public buyBackSellLimit = 1;
