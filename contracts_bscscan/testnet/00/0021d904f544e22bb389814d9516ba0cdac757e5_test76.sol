...
Please be sure to join the right telegram!
MAX WALLET 1%
...
contract test76 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "testing76";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xAd49e6A91b410F778fd083FeBa1e0659b84522cd;  // teamwallet
        lotteryWallet = 0xAd49e6A91b410F778fd083FeBa1e0659b84522cd;  // lotterywallet
