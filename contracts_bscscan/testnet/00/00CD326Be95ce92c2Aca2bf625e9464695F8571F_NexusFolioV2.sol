...
contract NexusFolioV2 is IERC20, Ownable {
    ...
    string private constant _name = "NexusFolio v17";
    string private constant _symbol = "NFv17";
    ...
    uint256 public innovationDivisor;
    ...
    uint256 public lockedBetweenSells;
    uint256 public lockedBetweenBuys;
    ...
    function initialize() public initializer {
        ...
        marketingAddress = payable(0x7eb1fAb57D9aCEf77403184d81C30a5592b72438); // Marketing Address Test Net

        innovationAddress = payable(0xCc164Ac80cB42aBf31B5f5590571BBdB37fBB139);
        ...
        minimumTokensBeforeSwap = 200 * 10**6 * 10**9;
    ...
    function setAntiWahle(bool _enabled) external onlyOwner() {
        antiWhale = _enabled;
    }
    ...
    function setLockTimeBetweenSells(uint256 _seconds) external onlyOwner {
        lockedBetweenSells = _seconds;
    }

    function setLockTimeBetweenBuys(uint256 _seconds) external onlyOwner {
        lockedBetweenBuys = _seconds;
    }
