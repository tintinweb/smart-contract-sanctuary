...
contract Kaby is IKaby, ERC721, AcceptedToken, ReentrancyGuard {
    ...
    /**
     * @dev  owner set new max start for hero
     * @param newMaxStar new max start of hero
     */
    ...
    /**
     * @dev Operators can upgrade star for hero
     * @param heroId id of hero which buyer want to cancel offer
     * @param amount amount to upgade Star
     */
    function upgadeStar(uint heroId, uint amount) external override onlyOperator {
        Hero storage hero = _heros[heroId];
     ...
     * @return star return detail star of hero.
...
interface IKaby {
    ...
    /**
     * @notice Operators can upgrade star for hero
     */
    function upgadeStar(uint heroId, uint amount) external;
