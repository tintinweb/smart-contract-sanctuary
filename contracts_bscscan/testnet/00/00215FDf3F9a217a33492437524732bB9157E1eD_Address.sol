...
contract KISAMA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8C022622572F2d4b7b77Bc512e421276ba2D7cE2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KISAMA INU";
    string private _symbol = "KISINU";
