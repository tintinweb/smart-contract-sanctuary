...
contract rigelLaunchPad {
    ...
    constructor( address _swapToken, address _rgp, uint256 _price, uint256 expectedLockedValue, address _specialPoolC) {
   ...
   function checkPoolBalance(address user) public view returns(bool) {
    ...
    function lockFund(uint256 _tokenAmount) public checkLocked{
        ...
        require(IERC20(swapToken).transferFrom(_msgSender(), address(this), _tokenAmount), "RGP: TRANSFER OF BUSD FAILED!");
