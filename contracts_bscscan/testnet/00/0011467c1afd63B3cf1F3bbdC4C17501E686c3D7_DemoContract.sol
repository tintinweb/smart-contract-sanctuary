...
contract DemoContract  {
    ...
    event Registration(address indexed user, uint indexed userId, User userData);
    
    IBEP20 private siftiToken; 
    IBEP20 private busdToken; 

    constructor(address ownerAddress, IBEP20 _busdToken, IBEP20 _siftiToken)
    {
        owner = ownerAddress;
        ...
        emit Registration(ownerAddress,users[ownerAddress].id, user);
    ...
    */
    function registration(address _userAddress, string memory _name, uint _mobile, bool _ad, uint _sift, uint _busd) public 
    {
        ...
        emit Registration(_userAddress,users[_userAddress].id,user);
    }
