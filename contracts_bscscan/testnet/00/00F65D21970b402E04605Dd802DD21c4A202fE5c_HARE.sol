...
contract HARE is Context, IERC20, Ownable {
    ...
    address payable public _advisoryWalletAddress =
        payable(0xE5D4e37B8729371de54AFAB4368FCF6b0DAdb661);
    address payable public _marketingWalletAddress =
        payable(0x85Eb762eac7Ecc7A1dE3Ed6a2AaE48010A809512);
    address payable public _developmentWalletAddress =
        payable(0xcCA8410CD82F6e83F770ca533e7A99C9cD0387F4);
    ...
    uint256 private _tTotal = TOTAL_COIN * 10**uint8(_decimals);
    ...
    uint256 public _advisoryFee = 1;
    uint256 public _liquidityFee = 3;
    uint256 private _totalBNBFees =
        _marketingFee + _developmentFee + _advisoryFee + _liquidityFee;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensForLP = ((amountToSwap * _liquidityFee) / _totalBNBFees) /
            2;
        ...
        uint256 bnbToBeAddedToLiquidity = ((newBalance * _liquidityFee) /
            totalBNBFee) / 2;

        if (bnbToBeAddedToLiquidity > 0)
            addLiquidity(tokensForLP, bnbToBeAddedToLiquidity);

        uint256 bnbToBeAddedToDev = (newBalance * _advisoryFee) / totalBNBFee;

        if (bnbToBeAddedToDev > 0)
            _advisoryWalletAddress.transfer(bnbToBeAddedToDev);

        uint256 bnbToBeAddedToDevelopment = (newBalance * _developmentFee) /
            totalBNBFee;
        ...
        )
    {
        ...
        (
            ...
            uint256 rTransferAmount,
            uint256 rReflection
        ) = _getRValues(tAmount, tReflection, tLiquidity, _getRate());
        return (
            rAmount,
            rTransferAmount,
            rReflection,
