...
/**
 *SLStars is a Metaverse element game of OKmoon
 * SLStars Token is SLS Metaverse DAO Token
*/
...
contract SLStarsToken is ERC20, ERC20Detailed, ERC20Burnable, ERC20Pausable {
  ...
  constructor(uint256 _initialSupply, address _bridgeAddress, uint256 _bridgeSupply)
    ERC20Detailed("SLStars Token", "SLS", 18) public {
