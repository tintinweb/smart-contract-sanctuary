...
contract KangarooMatrix {
    ...
    function getOldlastUserId() internal view returns(uint32){
    ...
    function finishMigration() external onlyRoot {
        require(lastUserId==getOldlastUserId(),"not all users have migrated");
        oldMatrix=address(0);
        isMigrated=true;
    }
    ...
    function usersMigration(uint32 id) external returns(bool){
        ...
        require(lastUserId==id && id < getOldlastUserId(),"invalid id");
