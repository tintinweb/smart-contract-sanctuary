...
contract SeedDistribution {
    ...
    function setTGEHappened() public onlyOwner {
        ...
        Collect1 = block.timestamp + 2 minutes;
        Collect2 = block.timestamp + 5 minutes;
        Collect3 = block.timestamp + 5 minutes;
        Collect4 = block.timestamp + 5 minutes;
        Collect5 = block.timestamp + 5 minutes;
        Collect6 = block.timestamp + 5 minutes;
        Collect7 = block.timestamp + 5 minutes;
        Collect8 = block.timestamp + 5 minutes;
        Collect9 = block.timestamp + 5 minutes;
        Collect10 = block.timestamp + 5 minutes;
    }
