...
contract SeedifyFundsContract is Ownable {
  ...
  //  address array for tier two whitelist
    ...
    constructor(
        ...
        minAllocaPerUserTierOne =   100000000000000;
        minAllocaPerUserTierTwo =   200000000000000;
        minAllocaPerUserTierThree = 300000000000000;
        minAllocaPerUserTierFour =  400000000000000;
        minAllocaPerUserTierFive =  500000000000000;
        minAllocaPerUserTierSix =   600000000000000;
        minAllocaPerUserTierSeven = 700000000000000;
        minAllocaPerUserTierEight = 800000000000000;
        minAllocaPerUserTierNine =  900000000000000;
        
        totalUserInTierOne = 30;
        totalUserInTierTwo = 30;
        totalUserInTierThree = 30;
        totalUserInTierFour = 30;
        totalUserInTierFive = 30;
        totalUserInTierSix = 30;
        totalUserInTierSeven = 30;
        totalUserInTierEight = 30;
        totalUserInTierNine = 30;
        
        maxAllocaPerUserTierOne = 0.001 * 10**18;
        maxAllocaPerUserTierTwo = 0.002 * 10**18;
        maxAllocaPerUserTierThree = 0.003 * 10**18;
        maxAllocaPerUserTierFour = 0.004 * 10**18;
        maxAllocaPerUserTierFive = 0.005 * 10**18;
        maxAllocaPerUserTierSix = 0.006 * 10**18;
        maxAllocaPerUserTierSeven = 0.007 * 10**18;
        maxAllocaPerUserTierEight = 0.008 * 10**18;
        maxAllocaPerUserTierNine = 0.009 * 10**18;
