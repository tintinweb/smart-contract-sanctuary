...
contract BQBToken is BEP20 {
    ...
    //  _totalSupply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 1,000,000,000,000,000
    ...
    uint256 public minAmountToLiquify = 500;
     ...
     */
    constructor() public BEP20("BloqBall Token", "BQB") {
        ...
        super._transfer(address(0),  msg.sender, _totalSupply);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (recipient == BURN_ADDRESS || transferTaxRate == 0) {
            ...
            uint256 liquidityAmount = taxAmount.sub(burnAmount).mul(30).div(100);
    ...
    function swapTokensForFTM(uint256 tokenAmount) private {
        // generate the BloqBall pair path of token -> weth
    ...
    function updateMasterchef(address _masterchef) public onlyOperator {
        ...
        require(BloqBallMasterchef != address(0), "BQB::updateMasterchef: Invalid masterchef address.");
