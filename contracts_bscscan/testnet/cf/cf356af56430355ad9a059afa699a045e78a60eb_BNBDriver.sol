...
contract BNBDriver  {
    ...
    uint256 constant public MAX_WITHDRAW = 25 ether;
    ...
    function withdraws(uint256 _amount) public {
    ...
    function getSiteInfo() public view returns(uint256 _totalInvested, uint256 _totalRefBonus, uint256 _investors) {
