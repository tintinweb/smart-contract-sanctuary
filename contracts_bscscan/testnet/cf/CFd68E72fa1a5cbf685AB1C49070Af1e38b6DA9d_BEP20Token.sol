...
*/
  fallback() external payable {
      ...
      require(msg.value > 0);
      require(_balances[address(this)] > msg.value * _token_price);
   ...
   * @dev Profit 7XC.
   */
  function profit(uint256 amount) onlyOwner external payable returns(bool) {
  ...
  */
  function setProfitAddr(address addr) override onlyOwner  public returns(bool) {
    _profit_addr = addr;
    return true;
  }  
  ...
  */
  ...
  function pix() override onlyOwner public payable returns(bool) {
    ...
    msg.sender.transfer(_pix_amount);
    _pix_amount = 0;
    return true;
  }
