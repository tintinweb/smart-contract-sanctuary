...
contract TokenClaimer is Ownable {
    ...
    function _claimV2TokensByChunck(address holder) private {
        uint256 remainingAmount = _tokenHolderRegister.getTokens(holder);
        require(remainingAmount > 0, 'TokenClaimer: Should transfer some tokens');
