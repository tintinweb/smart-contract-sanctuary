    ...
    ConfirmedOwner(msg.sender)
{
    ...
    constructor(
        ...
        _summonTypeGroupRates[1] = [0, 100, 0, 0, 0];
        _summonTypeGroupRates[2] = [0, 50, 0, 50, 0];
        _summonTypeGroupRates[3] = [0, 0, 0, 100, 10];

        _summonTypeGroups[1] = [1, 2, 3, 4, 5];
        _summonTypeGroups[2] = [1, 2, 3, 4, 5];
        _summonTypeGroups[3] = [1, 2, 3, 4, 5];
    }
        ...
        override
    {
        ...
        (uint256 baseCardId, uint256[6] memory bodyParts, uint256 quality, uint256 class, uint256 rarity) = 
            getRandomResult(requestInfo.summonType, randomness);
    ...
    function getRandomResult(uint256 summonType, uint256 randomness) public view 
    returns(uint256 baseCardId, uint256[6] memory bodyParts, uint256 quality, uint256 class, uint256 rarity){
        ...
        for (uint256 index = 0; index < _summonTypeGroupRates[summonType].length; index++) {
            processValue += _summonTypeGroupRates[summonType][index];
        }
        ...
        else baseCardId = baseCardIds[randomness % processValue];
        ...
        quality = _getBodyPartItem(randomness, _qualities[group][baseCardId]);
