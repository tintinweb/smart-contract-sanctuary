...
interface IPYDEXReferral {
  ...
  function recordReferralCommission ( address _referrer, uint256 _commission, uint256 level ) external;
  function getReferrer ( address _user ) external view returns ( address firstLevel, address secondLevel, address thirdLevel );
...
contract PYDEXGMasterChef is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    function stakeNFT(uint256 _pid, uint256 nftID) public nonReentrant {
        ...
        require(pool.nftStakingInfo.isNFTStakingEnabled, "Can't Stake in this Pool");
        ...
        if (nftType == 1) {
            pool.nftStakingInfo.silverNFTsLocked = pool.nftStakingInfo.silverNFTsLocked.add(1);
            pool.nftStakingInfo.tokensStakedBySilverStakers = pool.nftStakingInfo.tokensStakedBySilverStakers.add(user.amount);
            user.nftRewardDebt = user
                .amount
                .mul(pool.nftStakingInfo.accPydexPerSilverNFTShare)
                .div(1e18);
        } else if (nftType == 2) {
            pool.nftStakingInfo.goldNFTsLocked = pool.nftStakingInfo.goldNFTsLocked.add(1);
            pool.nftStakingInfo.tokensStakedByGoldStakers = pool.nftStakingInfo.tokensStakedByGoldStakers.add(user.amount);
            ...
            pool.nftStakingInfo.diamondNFTsLocked = pool.nftStakingInfo.diamondNFTsLocked.add(1);
            pool.nftStakingInfo.tokensStakedByDiamondStakers = pool.nftStakingInfo.tokensStakedByDiamondStakers.add(user.amount);
    ...
    function unstakeNFT(uint256 _pid) public nonReentrant {
        ...
        uint256 nftType = _privacyNFT.tokenTypes(nftId);
        if (nftType == 1) {
            pool.nftStakingInfo.silverNFTsLocked = pool.nftStakingInfo.silverNFTsLocked.sub(1);
            pool.nftStakingInfo.tokensStakedBySilverStakers = pool.nftStakingInfo.tokensStakedBySilverStakers.sub(user.amount);

        } else if (nftType == 2) {
            pool.nftStakingInfo.goldNFTsLocked = pool.nftStakingInfo.goldNFTsLocked.sub(1);
            pool.nftStakingInfo.tokensStakedByGoldStakers = pool.nftStakingInfo.tokensStakedByGoldStakers.sub(user.amount);

           
        } else if (nftType == 3) {
            pool.nftStakingInfo.diamondNFTsLocked = pool.nftStakingInfo.diamondNFTsLocked.sub(1);
            pool.nftStakingInfo.tokensStakedByDiamondStakers = pool.nftStakingInfo.tokensStakedByDiamondStakers.sub(user.amount);
    ...
    function pendingPYDEX(uint256 _pid, address _user)
        external
        view
        returns (uint256 normalReward,uint256 nftReward, uint256 totalRewards)
    {
        PoolInfo storage pool = poolInfo[_pid];
    ...
    function updatePool(uint256 _pid) public {
        ...
        if (pydex.totalSupply().add(totalPydexReward).add(devRewards) <= pydex.MAX_SUPPLY()) {
            ...
            if (pool.nftStakingInfo.isNFTStakingEnabled) {
                ...
                if (pool.nftStakingInfo.silverNFTsLocked > 0) {
                    silverShare = nftRewardSplitAmount
                        ...
                        .div(1000);
                    pool.nftStakingInfo.accPydexPerSilverNFTShare = pool.nftStakingInfo
                        .accPydexPerSilverNFTShare
                        .add(silverShare.mul(1e18).div(pool.nftStakingInfo.tokensStakedBySilverStakers));
                }
                ...
                if (pool.nftStakingInfo.goldNFTsLocked > 0) {
                    goldShare = nftRewardSplitAmount
                        ...
                        .div(1000);
                    pool.nftStakingInfo.accPydexPerGoldNFTShare = pool.nftStakingInfo
                        .accPydexPerGoldNFTShare
                        .add(goldShare.mul(1e18).div(pool.nftStakingInfo.tokensStakedByGoldStakers));
                }
                ...
                if (pool.nftStakingInfo.diamondNFTsLocked > 0) {
                    diamondShare = nftRewardSplitAmount
                        ...
                        .div(1000);
                    pool.nftStakingInfo.accPydexPerDiamondNFTShare = pool.nftStakingInfo
                        .accPydexPerDiamondNFTShare
                        .add(diamondShare.mul(1e18).div(pool.nftStakingInfo.tokensStakedByDiamondStakers));
                }
        ...
        if (pool.nftStakingInfo.isNFTStakingEnabled && user.stakedNFTId != 0) {
            ...
            if (nftType == 1) {
                user.nftRewardDebt = user
                    ...
                    .mul(pool.nftStakingInfo.accPydexPerSilverNFTShare)
                    .div(1e18);
                pool.nftStakingInfo.tokensStakedBySilverStakers = pool.nftStakingInfo.tokensStakedBySilverStakers.add(finalAmount);
            } else if (nftType == 2) {
                user.nftRewardDebt = user
                    .amount
                    .mul(pool.nftStakingInfo.accPydexPerGoldNFTShare)
                    .div(1e18);
                pool.nftStakingInfo.tokensStakedByGoldStakers = pool.nftStakingInfo.tokensStakedByGoldStakers.add(finalAmount);
                ...
                user.nftRewardDebt = user
                    ...
                    .mul(pool.nftStakingInfo.accPydexPerDiamondNFTShare)
                    .div(1e18);
                pool.nftStakingInfo.tokensStakedByDiamondStakers = pool.nftStakingInfo.tokensStakedByDiamondStakers.add(finalAmount);
        ...
        if (pool.nftStakingInfo.isNFTStakingEnabled && user.stakedNFTId != 0) {
            ...
            if (nftType == 1) {
                user.nftRewardDebt = user
                    ...
                    .mul(pool.nftStakingInfo.accPydexPerSilverNFTShare)
                    .div(1e18);
                pool.nftStakingInfo.tokensStakedBySilverStakers = pool.nftStakingInfo.tokensStakedBySilverStakers.sub(_amount);
                ...
                user.nftRewardDebt = user
                    ...
                    .mul(pool.nftStakingInfo.accPydexPerGoldNFTShare)
                    .div(1e18);
                pool.nftStakingInfo.tokensStakedByGoldStakers = pool.nftStakingInfo.tokensStakedByGoldStakers.sub(_amount);
                ...
                user.nftRewardDebt = user
                    ...
                    .mul(pool.nftStakingInfo.accPydexPerDiamondNFTShare)
                    .div(1e18);
                pool.nftStakingInfo.tokensStakedByDiamondStakers = pool.nftStakingInfo.tokensStakedByDiamondStakers.sub(_amount);
    ...
    function emergencyWithdraw(uint256 _pid) external nonReentrant {
        ...
        if (pool.nftStakingInfo.isNFTStakingEnabled && user.stakedNFTId != 0) {
            ...
            if (nftType == 1) {
                ...
                pool.nftStakingInfo.tokensStakedBySilverStakers = pool.nftStakingInfo.tokensStakedBySilverStakers.sub(amount);

            } else if (nftType == 2) {
              
                pool.nftStakingInfo.tokensStakedByGoldStakers = pool.nftStakingInfo.tokensStakedByGoldStakers.sub(amount);

            } else if (nftType == 3) {
                pool.nftStakingInfo.tokensStakedByDiamondStakers = pool.nftStakingInfo.tokensStakedByDiamondStakers.sub(amount);
            }
        }
    ...
    function getNftStakingInfo(uint256 _pid)public view returns(NFTStakingInfo memory){
    ...
    function updateEmissionRate(uint256 _newpydexPerBlock) external onlyOwner {
        require(_newpydexPerBlock <= 100e18,"Can't set emissions more than 100 PYDEX perblock");
        massUpdatePools();
        emit EmissionRateUpdated(_msgSender(), pydexPerBlock, _newpydexPerBlock);
        pydexPerBlock = _newpydexPerBlock;
    }

    // Update the pydex referral contract address by the owner
    function setPydexReferral(IPYDEXReferral _pydexReferral) external onlyOwner {
        require(address(pydexReferral) == address(0), "PYDEXReferral already set");
