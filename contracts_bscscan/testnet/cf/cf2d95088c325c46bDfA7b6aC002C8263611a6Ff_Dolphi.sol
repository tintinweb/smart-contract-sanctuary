...
contract Dolphi is Context, Ownable, Staking {
  ...
  address public _charityWallet = 0x59C0e13Fc4AB33ACFd22696F287dDf5cDD844489;
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    require(amount >= amount, "Burn amount exceeds balance");
    _balances[account] = _balances[account] - amount;
    _totalSupply = _totalSupply - amount;
  ...
  function donate(uint256 amount) public onlyOwner returns (bool) {
    _transfer(msg.sender, _charityWallet, amount);
    return true;
  }
}