...
contract slskskl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6d0177dc961DE784fc8bb90fbD75D95F01A83b8C); // Marketing Address
    ...
    string private _name = "SLKSLK";
    string private _symbol = "VSL";
    ...
    event BuyBackEnabledUpdated(bool disable);
