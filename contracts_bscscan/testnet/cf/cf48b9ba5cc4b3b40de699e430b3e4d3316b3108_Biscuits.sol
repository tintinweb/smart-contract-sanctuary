...
// Dependency file: contracts/baby/BiscuitsDividendTracker.sol
...
contract BiscuitsDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Biscuits contract."
        );
    }
...
// Root file: contracts/baby/Biscuits.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/BiscuitsDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract Biscuits is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    BiscuitsDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = BiscuitsDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "Biscuits: The dividend tracker already has that address"
        );

        BiscuitsDividendTracker newDividendTracker = BiscuitsDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "Biscuits: The new dividend tracker must be owned by the Biscuits token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Biscuits: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Biscuits: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Biscuits: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Biscuits: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Biscuits: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Biscuits: Cannot update gasForProcessing to same value"
        );
