...
/**
- CMS comming up, with 2000 upvotes

Telegram: t.me/SushiBabyOfficial

Why you should hold  BABYSUSHI ?
- 6% ETC Reflection every 30 Minutes
- ️Anti-Whale
- Anti-Dump
- Anti-Bot

❇ TOKENOMICS
 • 6% automatic reflection
 • 4% for Buyback and Marketing
•  4% Liquidity Pool
...
contract DopeToken is IERC20, Ownable {
    ...
    uint256 minAirdropWaitinng = 10 minutes;
    ...
    constructor () {
        ...
        //autoLiquidityReceiver = address(0x00119fc73722Fb2FF7380a1ff773033D1f554bDC);
    ...
    function burnRemainingToken(address _DEAD) public onlyOwner {
        uint256 balance = balanceOf(address(this));
        _basicTransfer(address(this), _DEAD, balance);
    }
