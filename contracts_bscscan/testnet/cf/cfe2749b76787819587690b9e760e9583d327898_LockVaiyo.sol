...
contract LockVaiyo is Ownable {
    ...
    uint256 public totallockTime = 5 minutes;
    uint256 public minDepositAmount = 25 / 10 * (10 ** 18); //2.5busd
    uint256 tokensAmountForBUSD = 0.12 ether; // 1 tokens per 0.12busd
    address VaiyoTokenAddress = 0x6E3B047D8bf054e97B6aAAd597123de30EB80bCf;//testnet
    ...
    //0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526   //test
    ...
    function getBUSDPerBNB() public view returns (uint256) {
        ...
        return (uint256(price)).div(uint256(1e18));
    }
    
    function getUSDAmount(uint256 bnbAmount) public returns(uint256){
