...
contract NurseryManagement is Nursery {
    ...
    uint256[4] public maturities = [1 days,2 days,3 days,4 days];//[3 days,7 days,15 days,30 days];
...
contract Nursery is ERC721Enumerable, Ownable {
    ...
    function mintNursery(address _to, uint256 _bronzePrice, uint256 _silverPrice, uint256 _goldPrice, uint256 _platinumPrice)
        external
        onlyAuth
        returns (uint256)
    {
        ...
        EggsPrices storage e = eggsPrices[_newItemId];
        e.bronzePrice = _bronzePrice;
        e.silverPrice = _silverPrice;
        e.goldPrice = _goldPrice;
        e.platinumPrice = _platinumPrice;
