...
import "./NftLootboxStructs.sol";

contract FundsHolder is NftLootboxStructs {
    bool isInited;
    ...
    function withdrawTokens(TokenInfo[] memory tokenInfo, address to) public {
        require(msg.sender == factory, "FundsHolder: Not allowed");

        for (uint256 i = 0; i < tokenInfo.length; ++i) {
            _withdrawToken(tokenInfo[i], address(this), to);
        }
    }
}
...
contract NftLootboxStructs {
    ...
    function _withdrawToken(TokenInfo memory tokenInfo, address from, address to) internal {
