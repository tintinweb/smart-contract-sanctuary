...
contract PoolService is Ownable, PoolData {
    ...
    event LogAddPoolService(IERC20 _lpToken, uint256 lockBlockCount, uint256 depositLimit, uint256 firstDepositLimit);

    function addPoolService(IERC20 _lpToken, uint256 _lockBlockCount, uint256 _depositLimit, uint256 _firstDepositLimit) public {
        emit LogAddPoolService(_lpToken, _lockBlockCount, _depositLimit, _firstDepositLimit);
