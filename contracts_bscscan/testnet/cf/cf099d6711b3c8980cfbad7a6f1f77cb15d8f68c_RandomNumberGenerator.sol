...
// File: contracts/interfaces/IKsfSwapLottery.sol

pragma solidity ^0.8.4;

interface IKsfSwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in KSF per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in KSF token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInKsf: price of a ticket in KSF
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the KsfSwapLottery lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == ksfSwapLottery, "Only KsfSwapLottery");
    ...
    /**
     * @notice Set the address for the KsfSwapLottery
     * @param _ksfSwapLottery: address of the KsfSwapLottery lottery
     */
    function setLotteryAddress(address _ksfSwapLottery) external onlyOwner {
        ksfSwapLottery = _ksfSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IKsfSwapLottery(ksfSwapLottery).viewCurrentLotteryId();
    }
}