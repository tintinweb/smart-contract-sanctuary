...
contract LotteryTracker is Ownable,VRFConsumerBase {
    ...
    event WeeklyLotteryWinners(address[3] winners,uint256 Amount);
    ...
    function pickWeeklyWinners() public {
        ...
        emit WeeklyLotteryWinners(winners,weeklyAmount.div(3));
    }
...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  IERC20 private constant BTC = IERC20(address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c));
...
// File: contracts/GodShibaToken.sol
...
contract GodShibaToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    GodShibaDividendTracker public dividendTracker;
    ...
    address payable public _marketingWallet = payable(address(0x123)); // marketing wallet here
    address payable public _devWallet = payable(address(0x456)); // dev wallet here
    address payable public _charityWallet = payable(address(0x789)); // charity wallet here
    
    uint256 public bep20Amount;
    //IERC20 public token;
    IERC20 token = IERC20(0x8b4fEE6E6DA0d0c63987711915fC0992541e8E07);
    ...
    constructor() ERC20("GodShiba TOKEN", "JEST") {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // tesnet V2 Router
        ...
        dividendTracker = new GodShibaDividendTracker(address(uniswapV2Router));
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "GodShiba: The dividend tracker already has that address");

        GodShibaDividendTracker newDividendTracker = GodShibaDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "GodShiba: The new dividend tracker must be owned by the GodShiba token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "GodShiba: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GodShiba: Account is already excluded");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "GodShiba: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "GodShiba: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "GodShiba: gasForProcessing must be between 200,000 and 500,000");
    ...
    //functions to swap old god shiba tokens with new ones
    ...
    function getnew() external {
        ...
        mytoken.transfer(msg.sender,bep20Amount);
}
...
contract GodShibaDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    using IterableMapping for IterableMapping.Map;
    ...
    constructor(address router) DividendPayingToken("GodShiba_Dividen_Tracker", "GodShiba_Dividend_Tracker",router) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 20000 * (10**18); //must hold 20000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "GodShiba_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend(bool val) public pure override {
        val = !val;
        require(false, "GodShiba_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GodShiba contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "GodShiba_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "GodShiba_Dividend_Tracker: Cannot update claimWait to same value");
