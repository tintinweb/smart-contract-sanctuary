...
contract TheBigShiba is IBEP20, Ownable
{
    ...
    string private constant _name = 'TheBigShiba';
    string private constant _symbol = 'TBSHIB';
    ...
    uint256 private  sellLimit = 1000000 * 10**_decimals;
