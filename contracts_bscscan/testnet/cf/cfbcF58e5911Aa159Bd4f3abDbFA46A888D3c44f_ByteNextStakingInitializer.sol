...
contract ByteNextStakingInitializer is Runnable, ReentrancyGuard {
    using SafeBEP20 for IByteNextERC20;
    ...
    // The reward token
    IByteNextERC20 public rewardToken;

    // The staked token
    IByteNextERC20 public stakedToken;
     ...
     */
    function initialize(
        IByteNextERC20 _stakedToken,
        IByteNextERC20 _rewardToken,
     ...
     */
    function deposit(uint256 _amount) external isRunning nonReentrant {
     ...
     * @param _amount: amount to withdraw (in rewardToken)
     */
    function withdraw(uint256 _amount) external isRunning nonReentrant {
        UserInfo storage user = userInfo[msg.sender];
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        ...
        IByteNextERC20(_tokenAddress).safeTransfer(address(msg.sender), _tokenAmount);
