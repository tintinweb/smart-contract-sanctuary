...
contract BSCWinBulls is Context, ERC20, Ownable, Proxiable, DataLayout {
    using SafeMath for uint256;
    ...
    constructor () ERC20("BSCWin Bulls", "BSCWIN") public {
    ...
    function proxyConstructor(string memory name, string memory symbol) public {
        ...
        ERCProxyConstructor(name, symbol);
