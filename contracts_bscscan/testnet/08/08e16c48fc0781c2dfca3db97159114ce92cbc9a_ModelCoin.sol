...
contract ModelCoin is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Marketing = payable(0x406D07C7A547c3dA0BAcFcC710469C63516060f0); 
    address payable public Wallet_Dev1 = payable(0x06376fF13409A4c99c8d94A1302096CB4dC7c07e); 
    address payable public Wallet_Dev2 = payable(0x981Ab956D6575b40F49AcBb769342BE91db95828);
    address payable public Wallet_CakeLP = payable(0x7D15025D421c5fF186017e8809C584De9036772A); 
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(40).div(10000);
        ...
        uint256 amount
          ...
          if (launchPhase){
                ...
                if (!TradeOpen){
                    ...
                    require(_preLaunchAccess[from], "Trade is not open yet, please come back later");
                    }
   ...
   function _transferStandard(address sender, address recipient, uint256 tAmount) private {
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        // XXXX Test on ETH to see if we need this 
