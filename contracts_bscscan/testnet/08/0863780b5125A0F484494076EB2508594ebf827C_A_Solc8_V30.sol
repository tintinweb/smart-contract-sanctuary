...
contract MultiSig is Context {
    ...
    modifier whenChangeByOperatorOff() {
        require(
            _change_operator_stopped,
            "Multisig: Error: Changing Operator To Permission Revoked"
        );
        _;
    }
    ...
    modifier whenMintHardlockOff() {
        require(
            _mint_hardlock_stopped,
            "ADMIRE::MultiSig::Error: MintHardlock Enabled"
        );
        _;
    }
...
contract A_Solc8_V30 is BEP20("ArghV30", "ADMRSL6V30") {
    using Address for address;
    using SafeMath for uint256;
