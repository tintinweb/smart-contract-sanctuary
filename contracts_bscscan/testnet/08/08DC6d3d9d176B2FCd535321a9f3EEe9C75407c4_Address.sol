...
contract NFUNK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NFUNK";
    string private _symbol = "NFUNK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD49925617caE2750D75d73Cd355cd83a7859d577); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xD49925617caE2750D75d73Cd355cd83a7859d577); // buyback Address
    ...
    uint256 private _totalSupply = 1 * 10**9 * 10**9; // Supply 1,000,000,000 
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9; // 5,000,000 | 0,5% | Max Transaction Buy / Sell 
    uint256 public _walletMax = 20* 10**6 * 10**9; // 20,000,000 | 2% | Max Wallet
    uint256 private minimumTokensBeforeSwap = 40000 * 10**9; //40000
    ...
    function setTradingOpen(bool _enable) public onlyOwner {
        tradingOpen = _enable;
    }
