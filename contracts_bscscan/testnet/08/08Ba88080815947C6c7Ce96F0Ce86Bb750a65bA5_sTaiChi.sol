...
contract sTaiChi is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked TaiChi", "sTAC", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTAC supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTAC
