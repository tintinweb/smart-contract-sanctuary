...
contract test1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "testo2";
    string private constant _symbol = "testtt2";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && block.number <= genesis_block + 10) {
            require(to != pair, "Sells not allowed for first 10 blocks for blacklisting bot buyers");
        }
