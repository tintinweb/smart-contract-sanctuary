...
contract Pawthereum is ERC20, ERC20Burnable {
    ...
    uint256 public maxSupply = 1000000000e9;
    ...
    constructor (address _bridge) ERC20("Pawthereum", "PAWTH") {
    ...
    */
    ...
    function mint(
        ...
        require(_totalSupply <= maxSupply, "Cannot mint more than max supply");
    ...
    */
    ...
    function withdrawTokenToOwner(address _tokenAddress, uint256 _amount) public {
        require(_msgSender() == contractOwner, "Only the owner can call this function");
