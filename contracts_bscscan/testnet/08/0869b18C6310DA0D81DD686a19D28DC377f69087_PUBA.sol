...
contract PUBA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7 * 10**9 * 10**9;
    ...
    uint256 public _maxTxAmount = 7 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**2 * 10**9;

    address payable public charityAddress = 0x1bE1327D256b37096C7B3F57145DF04FA3C4d111; // Charity Address
