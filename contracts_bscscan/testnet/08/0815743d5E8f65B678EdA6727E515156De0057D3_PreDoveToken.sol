...
contract PreDoveToken is Divine {
  using SafeMath for uint256;
  ...
  constructor() Divine("PreDove", "pDOVE", 18) {
    uint256 initialSupply_ = 50000000 * 1e18; // 50,000,000 DOVE
  ...
  function _beforeTokenTransfer (
    ...
    require(
      ...
      "Account not approved to transfer pDOVE."
    );
  }
