...
contract Characters is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    //Loot Contract
    address public lootAddress = 0xea6Ff2d84159cD89fd32635F598dcC33B3373Ed7;
    ...
    function getMagic(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "EARRING", faith);
    }
    
    function getSpeed(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "MOUNT", faith);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[17] = getMagic(tokenId);
        
        parts[18] = '</text><text x="10" y="200" class="base">';

        parts[19] = getSpeed(tokenId);
