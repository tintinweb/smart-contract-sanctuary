...
contract MarketPlace is OwnableUpgradeable, ERC721Holder, PlatformRevenueBase {
    ...
    function selling(
        ...
        // TODO: allowance checking here, should be consistent with buy function
    ...
    function buy(uint256 sellingOrderID) external {
        ...
        // TODO: move to last operation and change to storage
        ...
        // TODO: change to safeTransferFrom
        busd.transferFrom(
            msg.sender,
            address(this),
            operateAmount
    ...
    function cancel(uint256 sellingOrderID) external {
        //TODO: Change to storage and move delete to last operation
        SellingOrder memory sellingOrder = sellingOrderMap[sellingOrderID];
        require(
            sellingOrder.seller != address(0),
