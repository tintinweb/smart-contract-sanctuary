...
contract generalBroker is ERC721Holder, BrokerModifiers {
    // events
    event Bid(
        ...
        public
    {
        ...
        uint256 lastOwner_funds = _auction.currentBid - brokerageAmount;
        ...
        flatSaleOnly(tokenID, _mintableToken)
    {
        ...
        uint256 lastOwner_funds = _auction.buyPrice - brokerageAmount;
