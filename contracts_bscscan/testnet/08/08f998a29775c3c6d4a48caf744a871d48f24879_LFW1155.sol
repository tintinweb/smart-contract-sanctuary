    ...
    AccessControlEnumerableUpgradeable
{
    ...
    */
    ...
    function mintItems(
        ...
        require(hasRole(OPERATOR_ROLE, _msgSender()), "Caller is not operator");
        require(_minter != address(0), "LFW1155: mint to the zero address");
        require(
            _tokenIds.length == _amounts.length,
            "LFW1155: ids and amounts length mismatch"
        );
    ...
    function setAdminRole() external onlyOwner {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }
    ...
    function burnItem(uint256 tokenId, uint256 amount) external {
        require(
            ...
            "LFW1155: burn from the zero address"
        );
        ...
        external
    {
        ...
        require(
            ...
            "LFW1155: burn from this contract address"
        );
        require(
