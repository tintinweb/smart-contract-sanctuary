...
// File contracts/TrollNFT_VRF.sol
...
contract TrollNFT_VRF is TrollNFT, VRFConsumerBase {
    ...
    constructor(
        ...
        VRFConsumerBase(vrfAddresses[0], vrfAddresses[1])
    {
        setVrfParams(vrfParams[0], uint256(vrfParams[1]));
    }

    function setVrfParams(bytes32 _vrfKeyHash, uint256 _vrfFee)
        public
        onlyOwner
    {
        ...
        override
    {
        ...
        // _customAttributes[tokenId] = randomness;
        // emit CustomAttribute(tokenId, randomness);
