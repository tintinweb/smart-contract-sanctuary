...
contract Wallet is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        address _admin,
        bool _checkTokenConfig,
        uint64 _inlogId
    ) {
        admin = _admin;
        checkTokenConfig = _checkTokenConfig;
    ...
    function _check(address _token, uint256 _amount) private view {
        ...
        require(_conf.enabled, "Wallet: token is not enabled");
    ...
    function setCheckTokenConfig(bool _checkTokenConfig) public onlyOwner {
        checkTokenConfig = _checkTokenConfig;
    }
