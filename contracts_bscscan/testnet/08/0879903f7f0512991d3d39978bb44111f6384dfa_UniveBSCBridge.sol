...
//File UniveBSCBridge.sol

contract UniveBSCBridge is Ownable{
    ...
    address public tokenAddress = 0x1DAFc15092ea4A7DC08d4639eEFF55738cbeb609;
    ...
    function claim(address toWallet, uint256 amount, uint256 txId) public onlyOwner{
        ...
        IERC20 token = IERC20(tokenAddress);
        //require(amount < token.balanceOf(tokenAddress), "Claim amount exceeds Bridge balance");
