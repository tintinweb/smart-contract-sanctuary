...
contract TESSHIBAM is Context, IERC20, Ownable {
    ...
    string private _name = "TESSHIBAM";
    string private _symbol = "TESSHIBAM";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xf29C85C4d754F882Ea9490dC921D074FeFA6c538);
    address public marketingWalletToken = 0x73ae44625ad0dE7101944049807168d0B4259114;
