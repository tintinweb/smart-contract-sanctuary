...
contract Minidogecola is IBEP20, Auth {
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(0x84D4e534ABdD447Ef2Cc8ABD1593a7a7d514F088).transfer(amountBNB * amountPercentage / 100);
    }
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(0x84D4e534ABdD447Ef2Cc8ABD1593a7a7d514F088).call{value: amountBNBMarketing, gas: 30000}("");
