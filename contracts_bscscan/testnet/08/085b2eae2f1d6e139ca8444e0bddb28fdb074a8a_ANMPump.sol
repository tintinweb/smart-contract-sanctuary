...
contract ANMPump is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xa41080bc45A113c929FE8032b5B29a9a21B25A3b); // Marketing Address
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        } else if (from != uniswapV2Pair &&!excludedAccount) {
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        maxBuyTransactionAmount = 1000000000 * 10**9;
    }
    ...
    function prepareForLaunch() external onlyOwner {
        ...
        maxBuyTransactionAmount = 100000000 * 10**9;
    }
