...
// token transfers
// ----------------------------------------------------------------------------
contract LAKSHYA is IBEP20, Owned {
    using SafeMath for uint256;
    address ecosys =0x0D8d2D40cFe07F75d8f093749cf0c9FfBdafCAf0;
    address foundation = 0xFE6D52115ff86FfeBcEdEd14793383ff5d6F6C99;
    address team = 0x8f2743088F2b9842b1fb81bAEAFD436b91C90C44;
    address market1 = 0x2bfa8dE98236700C7A1c4FF65Ca913F5d7d1A05E;
    address market2 = 0x2b4b3b9f7ad44D9BBb2Eef264eB19d856aeD9c33;

    string public symbol = "LAKSHYA";
    string public  name = "LAKSHYA";
    ...
    constructor() public {
        ...
        balances[owner] = 20000 * 10 ** (decimals);
        emit Transfer(address(0), owner, balances[owner]);

        balances[owner] = balances[owner].add(10000 * 10 ** (decimals));
        emit Transfer(address(0), owner, balances[owner]);

        balances[team] = 20000 * 10 ** (decimals);
        emit Transfer(address(0), team, balances[team]);
        locked[team].initial = balances[team];
        locked[team].locked = balances[team];

        balances[market1] = 5000 * 10 ** (decimals);
        ...
        balances[market2] = 5000 * 10 ** (decimals);
