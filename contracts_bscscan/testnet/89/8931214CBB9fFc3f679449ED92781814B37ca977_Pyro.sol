...
contract Pyro is Context, IBEP20, Ownable {	
    ...
    uint public _lottoDrawCount = 0;
   	...
   	uint256 private _minLottoBalance = 1;
    ...
    // Testnet
    address private uniswapV2RouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    // Publicnet
    //address private uniswapV2RouterAddress = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;
    ...
    uint256 private numTokensSellToAddToLiquidity = 500;
    uint256 public lotteryThreshold = 1;
    // anti whale
    bool    public _isAntiWhaleEnabled = true;
    uint256 public _antiWhaleThreshold = 100;
    ...
    function _getCurrentSupply() private view returns(uint256, uint256) {	
        ...
        for (uint256 i = 0; i < _excluded.length; i++) {
            if (_rOwned[_excluded[i]] > rSupply) return (_rTotal, _tTotal);
