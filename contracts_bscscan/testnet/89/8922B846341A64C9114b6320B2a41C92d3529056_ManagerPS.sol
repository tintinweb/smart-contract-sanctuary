...
contract ManagerPS is Ownable {
    ...
    address[] public listaUtenti;
    mapping(address=>uint) public UserDB;
    
    address public  tokenAddress = 0x5e9E36a7F7BA7761bd387d86Fd05052ddE7B03e8;//0x000000000000000000000000000000000000dEaD; //da mette address token
    ...
    function inviaPercentuale() public {
        ...
        for ( uint i=0; i<listaUtenti.length; i++){
            ...
            require(tok.transfer(tempU, daInvia));
