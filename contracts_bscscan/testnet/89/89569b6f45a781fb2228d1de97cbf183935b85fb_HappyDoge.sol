...
/**
   ...
   #Happy Doge Tokenomics:
   4% fee auto burn forever.
...
contract HappyDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'Happy Doge';
    ...
    uint private _max_tx_size = 1 * 10**13 * 10**9;
