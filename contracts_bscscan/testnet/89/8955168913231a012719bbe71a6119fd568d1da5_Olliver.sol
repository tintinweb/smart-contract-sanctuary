...
// change "name1" into ur name
    contract Olliver is Context, IERC20, Ownable {
...
//change "name1" and "symbol"
    ...
    constructor() public {
        ...
        devWallet = 0x748d67756CC7E9099F7F9dF968535B0BcA75fA32;
        ceoWallet = 0x31566E75E7a7a889Af25612361cFA458426d2E86;
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        //@dev ceo fee
         if(_ceoFee != 0){
            ...
            _reflectionBalance[ceoWallet] = _reflectionBalance[ceoWallet].add(ceoFee.mul(rate));
    ...
    function setCeoWallet(address account) external onlyOwner {
        ceoWallet = account;
    }
    ...
    function setCeoFee(uint256 amount) external onlyOwner {
        _ceoFee = amount;
    }
