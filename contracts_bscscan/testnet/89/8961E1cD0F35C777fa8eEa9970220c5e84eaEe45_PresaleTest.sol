...
// description PresaleTest.sol 
    // version v1.0.1  date: oct 10, 2021
...
// how the contract works
    ...
    // the calculation availTokens / hardcap gives the amount of tokens a user gets per investment
    ...
    // example: 
    // if the harccap is 50, the availTokens is 10 000 and the allocPerc for userA is 10000 then 
