...
contract MasterERC777 is Initializable {
  ...
  function createTokenERC777(
    ...
    require(s != address(0), "ERC777: address is not zero");

    iMasterERC777 = IMasterERC777(s);
    address child = iMasterERC777.createERC777(name, symbol, decimal, initialSupply, _cap);
    emit ChildCreatedERC777(_keyTypes, child, name, symbol, decimal, initialSupply);
