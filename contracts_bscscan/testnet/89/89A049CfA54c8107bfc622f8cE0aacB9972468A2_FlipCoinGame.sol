...
contract ERC20Token is Context, IERC20, Ownable {
    ...
    uint256 public _nextStartTimestampToRaffle = 1630162200;
    uint256 public _nextEndTimestampToRaffle = 1630162260;
    uint256 public _oneWeekTimestamp = 1*60;//7*24*60*60;
...
contract FlipCoinGame is Context, Ownable {
    ...
    uint256 public _minimalBalanceBar = 5000000000000000;  //5000000 +000000000
    uint256 public _maximalBalanceBar = 10000000000000000; //10000000 +000000000
