...
contract GullToken is ERC20,Ownable,AccessControl,LGEWhitelisted {
    ...
    function excludeFromFees(address account, bool excluded) public {
        require(hasRole(ADMIN_ROLE, msg.sender) || owner() == msg.sender, "No permission");
    ...
    function updateToggles(bool _enableSwap,bool _enableTaxFee) external{
        require(hasRole(ADMIN_ROLE, msg.sender) || owner() == msg.sender, "No permission");
