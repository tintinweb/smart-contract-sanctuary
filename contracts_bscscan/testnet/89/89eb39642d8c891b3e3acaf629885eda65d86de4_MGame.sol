...
contract BEP20 is IBEP20, Ownable {
    ...
    string private constant NAME = "MGame";
    string private constant SYMBOL = "MGame";
...
contract MGame is BEP20 {
 ...
 function setTaxShares(
    ...
    function updatebusdDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(distributor), "ClanGame: The dividend tracker already has that address");
