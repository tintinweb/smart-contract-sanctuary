...
contract standardToken is Context, IERC20, IERC20Metadata,Ownable {
    ...
    bool public generatedUsingCryptMint = true;
     ...
     */
     ...
     function init(address creator_,string memory name_, string memory symbol_,uint8 decimals_, uint256 tokenSupply_) public {
       require(!initialized, "Contract instance has already been initialized");
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        _mint(creator_,tokenSupply_);
        transferOwnershipFromInitialized(creator_);
...
contract LiquidityGeneratorToken is IERC20, Ownable, ILiquidityGeneratorToken {
 ...
 bool private initialized;
    ...
    function initialize(
        ...
        transferOwnershipFromInitialized(owner_);
        initialized = true;
