...
contract CoinToFishV3 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "CoinToFish";
        _symbol = "CTFT";
        address develop = address(0x50508d536C8e406fBA78A8198cA2F1bf6fA99766);
        address market = address(0x50508d536C8e406fBA78A8198cA2F1bf6fA99766);
