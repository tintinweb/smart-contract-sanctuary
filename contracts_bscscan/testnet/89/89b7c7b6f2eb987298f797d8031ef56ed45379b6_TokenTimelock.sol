 ...
 * checks.
*https://bscscan.com/address/0x4aA7f403114D1A1B7098DA8F01a169D74243415c#code
 */
library SafeMath {
...
contract TokenTimelock is Ownable {
    ...
    uint256 public releaseTime = 1635318000;
    
    address public bdsToken = 0xD7F0e8f090Ac6c7Fb2ddbbE6C9c914b19F42C36a;
    address public lpToken = 0x24d682A43Fe14AB6E50D2f44AD2A363366FaDF44;
    /**
     * @notice Transfers tokens held by timelock to owner.
     */
    function releasebdsToken() external onlyOwner {
        // solhint-disable-next-line not-rely-on-time
        require(block.timestamp >= releaseTime, "TokenTimelock: current time is before release time");

        uint256 amount = IERC20(bdsToken).balanceOf(address(this));
        require(amount > 0, "TokenTimelock: no tokens to release");

        IERC20(bdsToken).safeTransfer(owner(), amount);
    }
    ...
    function getbdsTokenBalance() external view returns(uint256) {
        return IERC20(bdsToken).balanceOf(address(this));
    }
    ...
    function setbdsToken(address _bdsToken) external onlyOwner {
        bdsToken = _bdsToken;
    }
