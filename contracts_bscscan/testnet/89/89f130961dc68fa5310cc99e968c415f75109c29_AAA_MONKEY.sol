...
// Liquidity functions
    ...
    function swapTokensForEthAndSend(uint256 tokenAmount, address payable bnbReceiver) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        _approve(address(this), address(uniswapV2Router), tokenAmount);
    ...
    function swapTokensForEthAndSend2(uint256 tokenAmount, address payable bnbReceiver) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
