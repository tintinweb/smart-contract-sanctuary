...
contract DOGEROCKET is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeRocket";
    string constant _symbol = "DOGERKT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x54342989A232598f1541E7F98F4a2040170e6092;
        teamFeeReceiver = 0x9f77b5a1d9bEA7eE71172d60f642804B76EEc6BD;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBTeam = amountBNB.mul(reflectionFee).div(totalBNBFee);
