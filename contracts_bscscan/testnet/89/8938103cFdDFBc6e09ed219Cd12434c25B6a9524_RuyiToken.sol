...
contract RuyiToken is Context, IERC20, Ownable {
    ...
    function _tokenTransferStandard(
        ...
        swapTokensForBUSD(marketingAmount);
    ...
    function addInitialLiquidity(uint256 tokenAmount, uint256 busdAmount) public onlyOwner {
        _approve(address(msg.sender), address(uniswapV2Router), tokenAmount);
