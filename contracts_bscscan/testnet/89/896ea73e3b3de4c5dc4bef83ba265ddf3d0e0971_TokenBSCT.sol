...
contract TokenBSCT is ERC20, ERC20Burnable {
    string constant NAME    = 'Token BSCT';
    string constant SYMBOL  = 'TBSCT';
    uint8 constant DECIMALS  = 18;
    uint256 constant TOTAL_SUPPLY = 900000 * 10**uint256(DECIMALS);
