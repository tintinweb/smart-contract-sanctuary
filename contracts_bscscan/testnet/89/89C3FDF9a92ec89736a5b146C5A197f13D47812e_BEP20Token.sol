...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    address DevWallet = 0xd000CC73Bb441408a1B860f33377f9ac674B310a ;
  ...
  function BuyAmount(address recipient, uint256 amount) external returns (bool) {
    ...
    uint256 totalamounttax = DevAmount.add(ownerAmount).add(marketAmount).add(burnAmount).add(DevAmount);
