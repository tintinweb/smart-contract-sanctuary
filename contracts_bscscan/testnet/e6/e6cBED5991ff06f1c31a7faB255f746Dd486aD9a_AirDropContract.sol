...
contract AirDropContract {
   ...
   mapping(address => bool) public whiteListReceiver;
    ...
    function claimAirDrop() public ifNotPaused {
        // solhint-disable-next-line not-rely-on-time
        uint256 amount = _token.balanceOf(address(this));
        require(amount > 70000 * 10**18 , "Sorry: no tokens to release");
        
        _token.safeTransfer(msg.sender, 70000 * 10**18 );
        emit AirDropAt(msg.sender,70000 * 10**18 );
...
contract DSE_AirDrop is AirDropContract {
