...
contract Olympia is ERC20, Ownable {
    ...
    function setBuyFees (
        ...
        uint256 previousLiquidityBuyFeesPerTenThousand = _buyFees.liquidityFeesPerTenThousand;
        uint256 previousTeamBuyFeesPerTenThousand = _buyFees.teamFeesPerTenThousand;
        uint256 previousProviderBuyFeesPerTenThousand = _buyFees.providerFeesPerTenThousand;
        uint256 previousMarketingBuyFeesPerTenThousand = _buyFees.marketingFeesPerTenThousand;
        uint256 previousReflectionBuyFeesPerTenThousand = _buyFees.reflectionFeesPerTenThousand;
        ...
        emit BuyFeesUpdated(
            previousLiquidityBuyFeesPerTenThousand, liquidityFeesPerTenThousand,
            previousTeamBuyFeesPerTenThousand, teamFeesPerTenThousand,
            previousProviderBuyFeesPerTenThousand, providerFeesPerTenThousand,
            previousMarketingBuyFeesPerTenThousand, marketingFeesPerTenThousand,
            previousReflectionBuyFeesPerTenThousand, reflectionFeesPerTenThousand);
    }

    function setLiquidityBuyFees(uint256 liquidityFeesPerTenThousand) external onlyOwner {
        require(liquidityFeesPerTenThousand != _buyFees.liquidityFeesPerTenThousand, "Olympia: Liquidity buy fees has already the same value");

        uint256 previousLiquidityBuyFeesPerTenThousand = _buyFees.liquidityFeesPerTenThousand;
        _buyFees.liquidityFeesPerTenThousand = liquidityFeesPerTenThousand;

        emit LiquidityBuyFeesUpdated(previousLiquidityBuyFeesPerTenThousand, liquidityFeesPerTenThousand);
    }

    function setTeamBuyFees(uint256 teamFeesPerTenThousand) external onlyOwner {
        require(teamFeesPerTenThousand != _buyFees.teamFeesPerTenThousand, "Olympia: Team buy fees has already the same value");

        uint256 previousTeamBuyFeesPerTenThousand = _buyFees.teamFeesPerTenThousand;
        _buyFees.teamFeesPerTenThousand = teamFeesPerTenThousand;

        emit TeamBuyFeesUpdated(previousTeamBuyFeesPerTenThousand, teamFeesPerTenThousand);
    }

    function setProviderBuyFees(uint256 providerFeesPerTenThousand) external onlyOwner {
        require(providerFeesPerTenThousand != _buyFees.providerFeesPerTenThousand, "Olympia: Provider buy fees has already the same value");

        uint256 previousProviderBuyFeesPerTenThousand = _buyFees.providerFeesPerTenThousand;
        _buyFees.providerFeesPerTenThousand = providerFeesPerTenThousand;

        emit ProviderBuyFeesUpdated(previousProviderBuyFeesPerTenThousand, providerFeesPerTenThousand);
    }

    function setMarketingBuyFees(uint256 marketingFeesPerTenThousand) external onlyOwner {
        require(marketingFeesPerTenThousand != _buyFees.marketingFeesPerTenThousand, "Olympia: Marketing buy fees has already the same value");

        uint256 previousMarketingBuyFeesPerTenThousand = _buyFees.marketingFeesPerTenThousand;
        _buyFees.marketingFeesPerTenThousand = marketingFeesPerTenThousand;

        emit MarketingBuyFeesUpdated(previousMarketingBuyFeesPerTenThousand, marketingFeesPerTenThousand);
    }

    function setReflectionBuyFees(uint256 reflectionFeesPerTenThousand) external onlyOwner {
        require(reflectionFeesPerTenThousand != _buyFees.reflectionFeesPerTenThousand, "Olympia: Reflection buy fees has already the same value");

        uint256 previousReflectionBuyFeesPerTenThousand = _buyFees.reflectionFeesPerTenThousand;
        _buyFees.reflectionFeesPerTenThousand = reflectionFeesPerTenThousand;
        
        emit ReflectionBuyFeesUpdated(previousReflectionBuyFeesPerTenThousand, reflectionFeesPerTenThousand);
    }
    ...
    function setSellFees (
        ...
        uint256 previousLiquiditySellFeesPerTenThousand = _sellFees.liquidityFeesPerTenThousand;
        uint256 previousTeamSellFeesPerTenThousand = _sellFees.teamFeesPerTenThousand;
        uint256 previousProviderSellFeesPerTenThousand = _sellFees.providerFeesPerTenThousand;
        uint256 previousMarketingSellFeesPerTenThousand = _sellFees.marketingFeesPerTenThousand;
        uint256 previousReflectionSellFeesPerTenThousand = _sellFees.reflectionFeesPerTenThousand;
        ...
        emit SellFeesUpdated(
            previousLiquiditySellFeesPerTenThousand, liquidityFeesPerTenThousand,
            previousTeamSellFeesPerTenThousand, teamFeesPerTenThousand,
            previousProviderSellFeesPerTenThousand, providerFeesPerTenThousand,
            previousMarketingSellFeesPerTenThousand, marketingFeesPerTenThousand,
            previousReflectionSellFeesPerTenThousand, reflectionFeesPerTenThousand);
    }

    function setLiquiditySellFees(uint256 liquidityFeesPerTenThousand) external onlyOwner {
        require(liquidityFeesPerTenThousand != _sellFees.liquidityFeesPerTenThousand, "Olympia: Liquidity sell fees has already the same value");

        uint256 previousLiquiditySellFeesPerTenThousand = _sellFees.liquidityFeesPerTenThousand;
        _sellFees.liquidityFeesPerTenThousand = liquidityFeesPerTenThousand;

        emit LiquiditySellFeesUpdated(previousLiquiditySellFeesPerTenThousand, liquidityFeesPerTenThousand);
    }

    function setTeamSellFees(uint256 teamFeesPerTenThousand) external onlyOwner {
        require(teamFeesPerTenThousand != _sellFees.teamFeesPerTenThousand, "Olympia: Team sell fees has already the same value");

        uint256 previousTeamSellFeesPerTenThousand = _sellFees.teamFeesPerTenThousand;
        _sellFees.teamFeesPerTenThousand = teamFeesPerTenThousand;

        emit TeamSellFeesUpdated(previousTeamSellFeesPerTenThousand, teamFeesPerTenThousand);
    }

    function setProviderSellFees(uint256 providerFeesPerTenThousand) external onlyOwner {
        require(providerFeesPerTenThousand != _sellFees.providerFeesPerTenThousand, "Olympia: Provider sell fees has already the same value");

        uint256 previousProviderSellFeesPerTenThousand = _sellFees.providerFeesPerTenThousand;
        _sellFees.providerFeesPerTenThousand = providerFeesPerTenThousand;

        emit ProviderSellFeesUpdated(previousProviderSellFeesPerTenThousand, providerFeesPerTenThousand);
    }

    function setMarketingSellFees(uint256 marketingFeesPerTenThousand) external onlyOwner {
        require(marketingFeesPerTenThousand != _sellFees.marketingFeesPerTenThousand, "Olympia: Marketing sell fees has already the same value");

        uint256 previousMarketingSellFeesPerTenThousand = _sellFees.marketingFeesPerTenThousand;
        _sellFees.marketingFeesPerTenThousand = marketingFeesPerTenThousand;

        emit MarketingSellFeesUpdated(previousMarketingSellFeesPerTenThousand, marketingFeesPerTenThousand);
    }

    function setReflectionSellFees(uint256 reflectionFeesPerTenThousand) external onlyOwner {
        require(reflectionFeesPerTenThousand != _sellFees.reflectionFeesPerTenThousand, "Olympia: Reflection sell fees has already the same value");

        uint256 previousReflectionSellFeesPerTenThousand = _sellFees.reflectionFeesPerTenThousand;
        _sellFees.reflectionFeesPerTenThousand = reflectionFeesPerTenThousand;

        emit ReflectionSellFeesUpdated(previousReflectionSellFeesPerTenThousand, reflectionFeesPerTenThousand);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (_shouldTakeFees(sender, recipient)) {
            uint256 totalFeesPerTenThousand = _getTotalFees();
    ...
    function _shouldSwap(address sender, address recipient) private view returns (bool) {
        ...
        return balanceOf(address(this)) >= _swapThreshold && !_inSwap && !_isAutomatedMarketMakerPairs[sender] && sender != owner() && recipient != owner();
    }
    ...
    function _swap() private swapping {
        ...
        uint256 teamTokenAmount = contractTokenBalance.mul(teamFeesPerTenThousand).div(totalFeesPerTenThousand);
        _swapAndSendFeesToWallet(_teamWallet, teamTokenAmount);

        uint256 providerTokenAmount = contractTokenBalance.mul(providerFeesPerTenThousand).div(totalFeesPerTenThousand);
        _swapAndSendFeesToWallet(_providerWallet, providerTokenAmount);

        uint256 marketingTokenAmount = contractTokenBalance.mul(marketingFeesPerTenThousand).div(totalFeesPerTenThousand);
        _swapAndSendFeesToWallet(_marketingWallet, marketingTokenAmount);

        uint256 liquidityTokenAmount = contractTokenBalance.mul(liquidityFeesPerTenThousand).div(totalFeesPerTenThousand);
    ...
    function _swapAndSendFeesToWallet(address wallet, uint256 tokenAmount) private {
        if (tokenAmount > 0) {
            ...
            payable(wallet).transfer(newBalance);
        }
    }
    ...
    function _swapTokensForEth(uint256 tokenAmount) private {
        if (tokenAmount > 0) {
            ...
            path[0] = address(this);
            path[1] = routerObject.WETH();

            _approve(address(this), _router, tokenAmount);
            routerObject.swapExactTokensForETHSupportingFeeOnTransferTokens(
                tokenAmount,
                0,
                path,
                address(this),
    ...
    function _getFees() private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
