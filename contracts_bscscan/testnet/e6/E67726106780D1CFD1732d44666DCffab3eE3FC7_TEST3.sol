...
contract TEST3 is Context, IERC20, Ownable {
    ...
    uint256 private _maxSellAmount = 0;
    ...
    function _transfer(
        ...
        if(to != owner()) require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
        
        if(from != owner()) require(amount <= _maxSellAmount, "Transfer amount exceeds the maxTxAmount."); 
