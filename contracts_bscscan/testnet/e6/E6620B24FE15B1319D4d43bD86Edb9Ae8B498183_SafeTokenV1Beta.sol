    ...
    ReentrancyGuard
{
    ...
    function createVestingSchedule(
        ...
        uint256 totalVestingAmount = _amount.mul(_duration);
        require(_getNftListeningValue(_beneficiary, _tokenId) > totalVestingAmount,
        "beneficiary doesn't have enough tokens for full vesting cycle");
