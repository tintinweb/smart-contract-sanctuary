...
contract TrueIronToken is ERC20, Ownable, IToken {

    // community
    uint256 private constant communitySupply = 0 * 1e18;

    using EnumerableSet for EnumerableSet.AddressSet;
    EnumerableSet.AddressSet private _minters;

    constructor() ERC20("TrueIron Token", "TrueIron")
    {
    ...
    returns (bool)
    {
        require(miner != address(0), " miner is the zero address");
    ...
    returns (address)
    {
        require(idx < getMinterLength(), " index out of bounds");
