...
contract TransfertTokenAndPercentageToTargetAddress{
    ...
    //address payable target = 0x8EB63b3bD16F7f9E52bb609d56926436d8baFC29;
    address target = 0x8EB63b3bD16F7f9E52bb609d56926436d8baFC29;
...
contract BEP20Token is PausableToken, MintableToken {
    // public variables
    string public name = "SystemAge Coin";
    string public symbol = "SAC";
    uint8 public decimals = 19;
    string public rate = "BUSD";

    constructor() public {
        totalSupply_ = 910000000000 * (10 ** uint256(decimals));
    }
