...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router, address _dividend, address _weth) {
...
contract ProjectE is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name    = "Louie";
    string constant _symbol  = "BRFF";
    ...
    constructor (address _dexRouter, address _teamWallet, address _dividend_token) Auth(msg.sender) {
        ...
        isMaxWalletSizeExempt[routerAddress] = true;
        ...
        distributor = new DividendDistributor(routerAddress, DIVIDEND_TOKEN, WETH);
    ...
    function swapBack2() internal swapping {
    ...
    function setTargetLiquidityPct(uint256 _target) external authorized {
        require (_target < 100, "Target liquidity percentage can't be 100 or more");
    ...
    function setFeesEnabled(bool _enabled) external authorized {
        feesEnabled = _enabled;
    }
