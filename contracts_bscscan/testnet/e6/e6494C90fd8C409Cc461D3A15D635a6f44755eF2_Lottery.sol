...
contract Lottery is Ownable, Initializable {
        ...
        uint256 _closingTimestamp, uint256 _noOfWinners) external onlyOwner()
    {
        ...
        require(_minTicketsToBuy >= _noOfWinners, "Min tickets to purchase should be more than 3");
        ...
        allLotteries[lotteryId].nftlinks.push(_nftlinks[0]);
        allLotteries[lotteryId].nftlinks.push(_nftlinks[1]);
        allLotteries[lotteryId].nftlinks.push(_nftlinks[2]);
    ...
    function cancel() external onlyOwner(){
        require((allLotteries[lotteryId].closingTimestamp < block.timestamp)&&(ticketsSold[lotteryId] == 0),'Users bought tickets so you are not able to cancel the lottery!');
