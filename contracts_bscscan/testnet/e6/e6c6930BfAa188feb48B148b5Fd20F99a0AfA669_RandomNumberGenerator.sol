...
import "./interfaces/ICroxLottery.sol";
    ...
    Ownable
{
     ...
     * @param _seed: seed provided by the Crox lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == croxLottery, "Only Crox Lottery");
    ...
    /**
     * @notice Set the address for the Crox Lottery
     * @param _croxLottery: address of the Crox lottery
     */
    function setLotteryAddress(address _croxLottery) external onlyOwner {
        croxLottery = _croxLottery;
    }
        ...
        override
    {
        ...
        latestLotteryId = ICroxLottery(croxLottery).viewCurrentLotteryId();
    }
}
...
interface ICroxLottery {
    ...
    /**
     * @notice Draw the final number, calculate reward in CROX per group, and make lottery claimable
     * @param _lotteryId: lottery id
     * @param _autoInjection: reinjects funds into next lottery (vs. withdrawing all)
     * @param _croxPerBracket: distribution of winnings by bracket
     * @param _countTicketsPerBracket: total number of tickets in each bracket
     * @dev Callable by operator
     */
    function drawFinalNumberAndMakeLotteryClaimable(
        uint256 _lotteryId,
        uint256[6] calldata _croxPerBracket,
        uint256[6] calldata _countTicketsPerBracket,
        bool _autoInjection
    ) external;
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in CROX token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInUSDT: price of a ticket in CROX
    ...
    function getCurrentTicketPriceInCROX(uint256 _lotteryId)
        external
        view
        returns (uint256);
}
