...
contract LastsurvivorTokenDev is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    {
        if(enableBot){
            _antiBot.protect(sender, recipient, amount);
            emit ABC(_msgSender(), recipient);
        }
...
contract LastsurvivorToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    constructor() initializer {}

    function initialize(address mainWallet) initializer public {
        __ERC20_init("Lastsurvivor dev", "LSC");
        __Ownable_init();
        _mint(mainWallet, 12000000000 * 1e18); // 1.2000.000.000 
    }
}
