...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public shibanceLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == shibanceLottery, "Only ShibanceLottery");
    ...
    /**
     * @notice Set the address for the ShibanceLottery
     * @param _shibanceLottery: address of the Shibance lottery
     */
    function setLotteryAddress(address _shibanceLottery) external onlyOwner {
        shibanceLottery = _shibanceLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPancakeSwapLottery(shibanceLottery).viewCurrentLotteryId();
    }
}
