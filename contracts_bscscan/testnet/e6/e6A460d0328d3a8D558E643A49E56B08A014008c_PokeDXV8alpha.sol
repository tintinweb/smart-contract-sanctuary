...
abstract contract PokeDX is BaseRfiToken, Liquifier, Antiwhale {
    ...
    function increaseFee(uint256 index, uint256 addedValue ) public onlyOwner{
    ...
    function decreaseFee(uint256 index, uint256 subtractedValue ) public onlyOwner{
...
contract PokeDXV8alpha is PokeDX {
