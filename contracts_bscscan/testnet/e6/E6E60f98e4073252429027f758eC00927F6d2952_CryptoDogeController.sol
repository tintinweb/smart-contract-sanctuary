...
contract CryptoDogeController is Ownable{
    ...
    constructor (){
        ...
        cryptoDogeNFT = address(0x53faEdf5A53363972c95FF6BcdD45fe0E75b422E);
        magicStoneNFT = address(0xb05A7eC32D4A72B53F5Ea974bD816a8Fdb4Bf0d3);
        classes[0] = 16;
        classes[1] = 7;
        classes[2] = 3;
        classes[3] = 3;
    ...
    function claimToken() public{
        ICryptoDogeNFT mydoge = ICryptoDogeNFT(cryptoDogeNFT);
        IERC20(token).safeTransfer(_msgSender(), mydoge.getClaimTokenAmount(_msgSender()));
        mydoge.updateClaimTokenAmount(_msgSender(), 0);
    }
