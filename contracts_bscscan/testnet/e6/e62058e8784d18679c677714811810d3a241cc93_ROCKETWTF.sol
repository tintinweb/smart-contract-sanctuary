...
contract ROCKETWTF is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "ROCKET.WTF";
    string private _symbol = "0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3ROCKETBSC";
    uint256 private _tSupply = 1000000000*10**18;
    
    
    
    uint256 public dexTaxFee = 800;
