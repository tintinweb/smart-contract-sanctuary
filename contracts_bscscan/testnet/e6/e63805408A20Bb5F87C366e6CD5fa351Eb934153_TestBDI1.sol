...
contract TestBDI1 is Context, IERC20, Ownable {
    ...
    address payable public techWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // Tech Address
    ...
    string private _name = "TestBDI1";
    string private _symbol = "TestBDI1";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 8;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _totalLiqFee = 0;
