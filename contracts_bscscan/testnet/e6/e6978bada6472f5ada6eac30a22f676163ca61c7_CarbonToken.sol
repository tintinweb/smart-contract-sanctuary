...
interface IERC20 {
    ...
    function transferWithProjectId(address to, uint256 value, uint256 projectId) external returns (bool);
...
contract CarbonToken is ERC20, Pausable, ERC20Detailed {
    ...
    constructor() public ERC20Detailed("Carbon-13.1", "CO2", 9) {
        ...
        transferAndLock(
            ...
            1666371540
        ); // transfer 25 million tokens and locked until 11:59 PM Wyoming (MST/ GMT-7), 21st October 2022
    }
