...
contract BONES is ERC20PresetFixedSupply,Ownable {
    ...
    constructor(string memory name,string memory symbol,uint256 initialSupply,address owner,address feeAccount)  public
