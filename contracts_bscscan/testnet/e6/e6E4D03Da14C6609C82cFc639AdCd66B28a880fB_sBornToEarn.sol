...
contract sBornToEarn is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked BornToEarn", "sBTE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBTE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBTE
    ...
    function transfer( address to, uint256 value ) public override returns (bool) {
        ...
        _gonBalances[ msg.sender ] = _gonBalances[ msg.sender ].sub( gonValue, "sBTE: transfer amount exceeds balance" );
    ...
    function transferFrom( address from, address to, uint256 value ) public override returns ( bool ) {
       _allowedValue[ from ][ msg.sender ] = _allowedValue[ from ][ msg.sender ].sub( value, "sBTE: transfer amount exceeds allowance");
       emit Approval( from, msg.sender,  _allowedValue[ from ][ msg.sender ] );

        uint256 gonValue = gonsForBalance( value );
        _gonBalances[ from ] = _gonBalances[from].sub( gonValue, "sBTE: transfer amount exceeds balance");
        _gonBalances[ to ] = _gonBalances[to].add( gonValue );
    ...
    function decreaseAllowance( address spender, uint256 subtractedValue ) public override returns (bool) {
        ...
        if (subtractedValue >= oldValue) {
            ...
            _allowedValue[ msg.sender ][ spender ] = oldValue.sub( subtractedValue , "sBTE: decreased allowance below zero");
        }
        emit Approval( msg.sender, spender, _allowedValue[ msg.sender ][ spender ] );
        return true;
    }
