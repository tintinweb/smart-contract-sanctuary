...
// File: contracts/TetraCharles/TetraPro.sol
...
contract TetraPro is ERC20, AccessControl, Pausable {
    ...
    //address communityWallet = 0x30B0d6D1cDADbCb3Fca009a03105d21C3d23676F;
    ...
    // REDISTRIBUTION
    //address public token = 0xb036d12BF59A4591C7Dd2503159b384A07844d82;
    ...
    function handleFees(address sender, address recipient, uint256 amount) internal returns (uint256 fee) {
        ...
        if(isBuy) {
            ...
            if(feeTokens > 0) {
               ...
               // uint256 distributedAmount = redistributionTokens * 10**18 / feeTokens * ethGained / 10**18;
                
                //just for testnet
        /*        if(redistributionTokens > 0) {
                    _UniswapV2Router02.swapExactETHForTokens {value: distributedAmount}(
                        0,
                        currentPath,
                        address(this),
                        block.timestamp
