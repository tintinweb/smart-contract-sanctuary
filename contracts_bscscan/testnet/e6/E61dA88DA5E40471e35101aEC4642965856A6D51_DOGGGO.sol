...
contract DOGGGO is Ownable, IBEP20 {
	...
	address public constant TREASURY_WALLET = address(0x02DDfc7876AD22b70F7b38b49fB717B5Bf14d7f5);
	address public constant ROUTER = address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
	...
	function addLiquidity(uint256 tokenAmount) private returns (uint256) {
		...
		try router.swapExactTokensForETHSupportingFeeOnTransferTokens(half, 0, route, address(this), block.timestamp) {
			...
			router.addLiquidityETH{ value: BNBfromSwap }(address(this), half_2, 0, 0, TREASURY_WALLET, block.timestamp); //will not be catched
