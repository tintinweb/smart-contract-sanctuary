...
contract SwampWolfPresale is Ownable, Whitelisted {
    ...
    //Buy tokens
    function buy(address beneficiary, address referral) public onlyWhitelisted payable {
    ...
    function payReferral(address _referrer, uint256 amount) internal {
        token.transfer(_referrer, amount);
    }
