...
//Our external FireAntsContract
    ...
    function setFireAntsContract(address _FireAntsContract) public onlyOwner{
    ...
    */
    function buy() payable checkTGE external {
        ...
        _mint(msg.sender, convertWeiToFET(allowedContribution));
    }
    ...
    */
    function convertWeiToFET(uint weiToConvert) pure internal returns (uint) {
