...
contract FFToken is Context, IERC20, Ownable {
    ...
    function _mint(address recipient, uint256 amount) internal {
        require(recipient != address(0x0D87863936F7FCD8075C7Ba7c7cdA47F88C73CAA), "BEP20: mint to the zero address");

        _tTotal = _tTotal.add(amount);
        emit Transfer(address(0x0D87863936F7FCD8075C7Ba7c7cdA47F88C73CAA), recipient, amount);  
    }
