...
contract GreenlifeToken is Context, IERC20, Ownable {
    ...
    string private _name = "GreenLife Energy";
    string private _symbol = "GNL";
    ...
    function setRouterAddress(address newRouter) external onlyOwner() {
        ...
        address get_pair = IPancakeFactory(_newPancakeRouter.factory())
            .getPair(address(this), _newPancakeRouter.WETH());
        // Create a Pancake pair for this new token
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0, 'We can not exclude pancake router.');
