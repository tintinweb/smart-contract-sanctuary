...
contract VEULOK is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000000000000000; //1 Quadrillion
    ...
    string private _name = "VUELOK";
    string private _symbol = "VUELOK";
