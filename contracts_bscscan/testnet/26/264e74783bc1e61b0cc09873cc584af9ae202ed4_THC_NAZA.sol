...
contract THC_NAZA is ERC721, Ownable {
    ...
    */
    ...
    function randomNumber(uint256 modulo) internal view returns (uint) {
    ...
    */
    function mintRareNFT() external payable {
        ...
        //TODO Implement limit to stop minting once sold out
        require(numMinted < totalSupply, "Sale has already ended");
        
        // Incrementing ID to create new tokenn
        _rareTokenIdentifiers.increment();
        // uint256 newRECIdentifier = _rareTokenIdentifiers.current();
        uint256 newRECIdentifier = randomNumber(10);
    ...
    */
    function mintStandardNFT() external payable {
        ...
        uint256 newRECIdentifier = _standardTokenIdentifiers.current();
        //Incrementing minted tokens count
        ++numMinted;
        _safeMint(msg.sender, newRECIdentifier);
        string memory uid = uint2str(newRECIdentifier);
