...
contract Ownable is Context {
     ...
     */
    constructor() {
        _owner = 0xBD8f79868Dd7583a7C56a2d210D55b946606ad26;
...
contract MetaficialWorld is Context, IERC20, Ownable {
    ...
    string private _name = "Metaficial World";
    ...
    uint256 public _burnWalletFee = 0;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Temporarily remove fees to transfer to burn wallet
        _taxFee = 0;

        //Send transfers to burnWallet
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _burnWalletFee = 1; 
        _previousBurnWalletFee = _burnWalletFee;
    }
    ...
    function setMaxTxAmount(uint256 maxTxAmount, uint8 decimal) external onlyOwner() {
