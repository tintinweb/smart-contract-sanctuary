...
contract velocity is Context, IERC20, Ownable{
    ...
    address payable public marketingAddress = payable(0xB613D8B89962ace06db2079725f44649C4EE3366); // Marketing Address
    address payable public teamAddress = payable(0xB613D8B89962ace06db2079725f44649C4EE3366); // Team/Dev Address
    ...
    uint256 public teamDivisor = 1; //team/Dev Fee
  ...
  function setALLFeePercent(uint256 team,uint256 marketting,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
        teamDivisor = team;
