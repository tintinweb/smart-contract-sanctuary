...
contract Name is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x610152d9857195f8551CE0E098Cc0f594a7Da393;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xcC65F04ffAF6AC9Cb6546Af9Cc18CCf1F90eA6C6, 'We can not exclude Pancake router.');
