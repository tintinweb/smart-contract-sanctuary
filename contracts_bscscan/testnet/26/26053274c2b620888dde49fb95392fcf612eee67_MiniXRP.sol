...
contract MiniXRP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5C1232C335c963a052F86A7949e6369dEacF9AdC); // Marketing Address
    ...
    uint256 private _tTotal = 45000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Mini XRP";
    string private _symbol = "$MXRP";
