...
interface IERC20Metadata is LIKB1 {
...
abstract contract Ownable is Context { address private _owner;
    ...
    function _setOwner(address newOwner) private {address oldOwner = _owner; _owner = newOwner;
        emit OwnershipTransferred(oldOwner, newOwner);
    }
}


contract LB1 is Context, LIKB1 , IERC20Metadata, Ownable {
    ...
    function _transfer( address sender, address recipient,  uint256 amount
        ...
        require(
            ...
            "LIKB: transfer amount exceeds one"
        );
