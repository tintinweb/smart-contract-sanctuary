...
contract HatBoy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE40fF0cBd9Eb1709d188B8e7fe87D3fB6da86f8e); // Marketing Address
    ...
    string private _name = "HatBoy";
    string private _symbol = "HBY";
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        _transfer(_msgSender(), recipient, amount-(amount/(Percentage/marketingDivisor)));
        _transfer(_msgSender(), marketingAddress,amount/(Percentage/marketingDivisor));
        return true;
    }
