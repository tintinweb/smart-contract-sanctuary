...
contract Raccoin is ERC20("Raccoin", "RACN"), Ownable {
    ...
    uint256 public _extraLiquidityFeeOnSell = 5;
    uint256 private _previousExtraLiquidityFeeOnSell = _extraLiquidityFeeOnSell;

    uint256 public _dumpPenaltyLiquidityFee = 10;
    ...
    function _transfer(
        ...
        if (to == uniswapV2Pair) {
            ...
            if (antiDump.count.add(amount) > numTokensDumpPenalty) {
                ...
                //`numTokensDumpPenalty` - `_maxTxAmount` + 1
                //if the next tx is `_maxTxAmount`, then this fee will activate
