  ...
  function transftoken1(address  newtoken1) public onlyOwner {
   ...
   function transftoken2(address  newtoken2) public onlyOwner {
    ...
    function () public payable {
       ...
       transtoken1(to, volum);
       transtoken2(to, volum);
    }
    
    function transtoken1(address to, uint volum) private{
        
        uint tokens = volum*price;
        
        address aaddr = token1;
       CentinummRef(aaddr).transfer(to, tokens);
    }
    function transtoken2(address to, uint volum) private{
        
        uint tokens = volum*10;
