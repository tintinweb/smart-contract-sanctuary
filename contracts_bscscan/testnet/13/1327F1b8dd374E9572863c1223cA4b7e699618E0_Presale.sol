...
contract Token is Context, IERC20, IERC20Metadata { //собственно сам контракт токена
    ...
    string public _name = "testG1"; //Полное имя токена
    
    string public _symbol= "testG1";//краткое имя токена
    
    bool public allowanceEnabled = true; // переменная блокирующая трансфер токенов между кошельками
    
    address payable public marketingAddress = payable(0x76669A1F47D76De5f35eFF83fFaBA65e0A269477); // Marketing Address
