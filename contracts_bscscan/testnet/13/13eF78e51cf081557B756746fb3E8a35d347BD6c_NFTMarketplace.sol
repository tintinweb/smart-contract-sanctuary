...
contract NFTMarketplace is IERC721Receiver {
  ...
  function saveNFTInfo(
    uint256 tokenId,
    uint256 nftPrice, //直接设置几个,不设置小数位
    uint256 level
  ) public {
    address owner = nft.ownerOf(tokenId);
    require(msg.sender == admin, "only admin can do this");
...
contract NFTFactory is StringUtils{
  IERC20 public canBuyCoin = IERC20(0x9bA3363253Ff27EDEed2F28d82A0C6BfBad434f3);
  // IERC20 public canBuyCoin = IERC20(0x1e0c73A22F5f121E5486a77e99c7e756f21569Ef);
  ...
  string public baseurl = "http://47.107.242.74:8080/json/";
