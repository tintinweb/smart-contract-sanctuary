...
contract DevelopmentFeeVault is Ownable {
  ...
  constructor(uint256 _startReleaseBlock, uint256 _endReleaseBlock, address _devAddr, CEAToken _cea) public {
  ...
  //   cea._transfer(_account, address(this), _amount);
  ...
  function unlock() public {
    ...
    cea.transferFrom(address(this), msg.sender, amount);
  }

  // // @dev move CEA with its locked funds to another account
  ...
  //   cea._transfer(msg.sender, _to, cea.balanceOf(msg.sender));
  // }
