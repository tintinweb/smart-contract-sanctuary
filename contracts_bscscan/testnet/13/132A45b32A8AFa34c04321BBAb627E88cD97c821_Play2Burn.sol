...
contract Play2Burn is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = 1 * 10**8 * 10**9;
    ...
    constructor(uint16 _buyliq,
        ...
        buyFee.buybackFee = _buybuyback;
        buyFee.taxFee = _buyreflect;

        sellFee.liquidityFee = _sellliq;
        sellFee.marketingFee = _sellmarket;
        sellFee.buybackFee = _sellbuyback;
        sellFee.taxFee = _sellreflect;
