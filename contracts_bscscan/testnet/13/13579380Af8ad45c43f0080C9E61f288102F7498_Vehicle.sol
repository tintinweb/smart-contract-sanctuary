...
contract Vehicle is Ownable {
    ...
    mapping(address => Order) public VehicleOrder;

    mapping(uint8 => VehicleConfig) public VehicleDetail;

	event Buy(address indexed _user,uint256 _value);
    ...
    function addVehicle( uint8 id,
        ...
        vehicleList.push(VehicleConfig(id, grade,name,value,url,currency));
    }
