...
contract BNBPOWER is ERC20, Ownable, SafeToken, LockToken {
    ...
    function setFee(uint256 _bnbRewardFee, uint256 _liquidityFee, uint256 _marketingFee, uint256 _autoBoostFee) public onlyOwner {
        BNBRewardsFee = _bnbRewardFee;
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        autoBoostFee = _autoBoostFee;

        totalFees = BNBRewardsFee.add(liquidityFee).add(marketingFee).add(autoBoostFee); // total fee transfer and buy
    }
    ...
    function setautoBoostWallet(address payable _newBuybakWallet) public onlyOwner {
        autoBoostWallet = _newBuybakWallet;
    }
    ...
    constructor() ERC20("BNBPOWER", "BBP") {
        ...
        autoBoostWallet = payable(0x1AEfB144350368daF9dE68D3b8A556B298c8c7bf);
        ...
        _isExcludedFromMaxTx[autoBoostWallet] = true;
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        marketingWallet.transfer(marketingAmount);
         ...
         uint256 autoBoostAmount = deltaBalance.sub(bnbToAddLiquidityWith).div(totalFees.sub(liquidityFee).sub(marketingFee)).mul(autoBoostFee);
        autoBoostWallet.transfer(autoBoostAmount);
    ...
    function swapAndSendBNBToBuybak(uint256 tokenAmount) private {
        swapTokensForBnb(tokenAmount, autoBoostWallet);
    }
