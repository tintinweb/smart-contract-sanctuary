...
// Supply                 : 100000000000
// TAX                    : 15%
// -> 6% BUSD Redistribution
// -> 2% ADA Redistribution
// -> 5% Marketing 
// -> 2% BuyBack & Burn
// Telegram               : https://t.me/BabyMoonGlobal
// Twitter                : https://twitter.com/BabyMoonGlobal
// ----------------------------------------------------------- //
...
contract BabyMoon is ERC20, Ownable {
    ...
    constructor() ERC20("BabyMoon", "$BMOON") {
    	wbnbDividendTracker = new WrappedBNBDividendTracker();
    	busdDividendTracker = new BusdDividendTracker();

    	marketingWallet = 0xDd0a4A0d2c4aa58dE4534E8FCe6735D3F99adD18; // Marketing + Project Development + Team
    	wbnbDividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WrappedBNB
    ...
    receive() external payable {
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "BabyMoon: The marketing wallet is already this address");
    ...
    function afterPreSale() external onlyOwner {
        wbnbDividendRewardsFee = 2;
        busdDividendRewardsFee = 6;
        marketingFee = 5;
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyMoon: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(isExcludedFromFees[account] != excluded, "BabyMoon: Account is already exluded from fees");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyMoon: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        require(automatedMarketMakerPairs[pair] != value, "BabyMoon: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue != gasForProcessing, "BabyMoon: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "BabyMoon: Trading has not started yet");
...
contract WrappedBNBDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BabyMoon_WrappedBNB_Dividend_Tracker", "BCDT", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 60;
        minimumTokenBalanceForDividends = 100000 * (10**18); //must hold 100000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "BabyMoon_WrappedBNB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "BabyMoon_WrappedBNB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyMoon contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait != claimWait, "BabyMoon_WrappedBNB_Dividend_Tracker: Cannot update claimWait to same value");
...
contract BusdDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BabyMoon_Busd_Dividend_Tracker", "BBDT", 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56) {
    	claimWait = 60;
        minimumTokenBalanceForDividends = 100000 * (10**18); //must hold 100000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "BabyMoon_Busd_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "BabyMoon_Busd_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyMoon contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait != claimWait, "BabyMoon_Busd_Dividend_Tracker: Cannot update claimWait to same value");
        emit ClaimWaitUpdated(newClaimWait, claimWait);
        claimWait = newClaimWait;
    }
