...
contract Pw1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Pw1";
    string private _symbol = "PW1";
    ...
    constructor() public {
        marketingWallet = 0x5892c26B03426a38829eB94A3D798F68050af7dF; //3
        stakingWallet = 0x9036464e4ecD2d40d21EE38a0398AEdD6805a09B; //4
        charityWallet = 0x005eF44a8D40499F7E5D133B85dBAf2d4EF4DF89; //20
