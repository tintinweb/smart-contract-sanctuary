...
contract PoolService is Ownable, PoolData {
    ...
    function addPoolService(IERC20 _lpToken, uint256 _lockBlockCount, uint256 _depositLimit, uint256 _firstDepositLimit) public onlyOwner {
    ...
    function setPoolService(uint256 _poolId, uint256 _minDepositLimit, uint256 _minFirstDepositLimit) public onlyOwner {
