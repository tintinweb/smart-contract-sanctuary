...
// File: contracts/ApesTogetherStrong.sol
...
contract ApesTogetherStrong is ERC721Enumerable, Ownable {
  using Strings for uint256;

  uint256 public constant MINTABLE = 100;
  ...
  function buyNft(uint256 quantity) external payable {
    require(totalSupply() < MINTABLE, 'OUT_OF_STOCK');
