...
abstract contract Windmill_Trade_Deployer_Abstract is Base, Initializable, Adressable, AccessControlEnumerable, With_DAORole, With_UpdaterRole,
    ...
    ////
    //////////////// Public functions ////////////////
	function setTradeCode(bytes memory _bytecode, string memory _name) external onlyRole(DAO_ROLE) onlyNotInitialized{
        name = _name;
        tradeBytecode = _bytecode;
        initialized = true;
    }
	
	function deployNewTrade(address owner, address manager, address fund, address updater, address withdrawer, address competition) external onlyRole(TRADE_MANAGER_ROLE) onlyInitialized returns (I_Windmill_Trade_Abstract){
 ...
 *          (uint24) -> No used
	...
	function checkProposal(uint256 id, uint256 paramsUint256, address paramsAddress) public view virtual onlyRole(DAO_ROLE) returns (bool){
        require(id < 2, "Windmill_Trade_Deployer_Swap: Proposal id not found");
    ...
    function _initTrade(I_Windmill_Trade_Abstract trade, address owner, address manager, address fund, address updater, address withdrawer, address competition) internal override{
        ...
        I_Windmill_Trade_Swap tradeDerived = I_Windmill_Trade_Swap(tradeAddr);
...
contract Windmill_Trade_Deployer_Swap_Long is Base, Windmill_Trade_Deployer_Swap, I_Windmill_Trade_Deployer_Swap_Long{
	...
	function checkProposal(uint256 id, uint256 paramsUint256, address paramsAddress) public view override(I_Windmill_Trade_Deployer_Abstract, Windmill_Trade_Deployer_Swap) onlyRole(DAO_ROLE) returns (bool){
