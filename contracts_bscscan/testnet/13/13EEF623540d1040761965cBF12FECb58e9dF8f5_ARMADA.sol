...
abstract contract DepreciatingFees {
    ...
    uint256 reduceMarketingChestFee, uint256 reducemutinyFee, uint256 _accruedTime) {
        ...
        return (
            fees[_userAddress].FleetRewardsFee <= accruedTime.mul(FleetRewardsReductionPerSec) ? 0 : 
            fees[_userAddress].FleetRewardsFee.sub(accruedTime.mul(FleetRewardsReductionPerSec)),
            fees[_userAddress].WarChestFee <= accruedTime.mul(WarChestReductionPerSec) ? 0 : 
            fees[_userAddress].WarChestFee.sub(accruedTime.mul(WarChestReductionPerSec)),
            fees[_userAddress].MarketingChestFee <= accruedTime.mul(MarketingChestReductionPerSec) ? 0 : 
            fees[_userAddress].MarketingChestFee.sub(accruedTime.mul(MarketingChestReductionPerSec)),
            fees[_userAddress].mutinyFee <= accruedTime.mul(mutinyreductionPerSec) ? 0 : 
            fees[_userAddress].mutinyFee.sub(accruedTime.mul(mutinyreductionPerSec)),
            accruedTime
            );
        }
    ...
    */
    function calculateBuyingReadjustment(address _userAddress, uint256 _amount, uint256 accruedTime, uint256 _FleetRewardsFee, uint256 _WarChestFee,
    ...
    function reAdjustFees(address userAddress, uint256 _amount, uint256 accruedTime, uint256 _FleetRewardsFee, uint256 _WarChestFee,  uint256 _MarketingChestFee, 
        ...
        (uint256 _newFleetRewardsFee, uint256 _newMarketingChestFee, uint256 _newWarChestFee, uint256 _newmutinyFee) = 
            calculateBuyingReadjustment (userAddress, _amount, accruedTime, _FleetRewardsFee, _MarketingChestFee, _WarChestFee, _mutinyFee);
