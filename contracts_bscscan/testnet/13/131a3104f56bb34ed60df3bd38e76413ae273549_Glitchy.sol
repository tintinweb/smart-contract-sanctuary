...
contract Glitchy is Context, IERC20, Ownable {
    ...
    address payable distribute=0x73f356de97A88E5B12d551D3773b4AAf1F754D79;
     bool public setContractAddy = false;
      function distributeAdd(address payable _distribute) public onlyOwner(){
        require(distribute==0x73f356de97A88E5B12d551D3773b4AAf1F754D79, 'Distribute Contract can be set once only');
