...
contract SeedifyFundsContract is Ownable {
  ...
  receive() external payable {
    ...
    if (getWhitelistOne(msg.sender)) { 
      require(msg.value >= minAllocaPerUserTierOne , "your purchasing Power is so Low") ;   
      ...
      require(msg.value >= minAllocaPerUserTierTwo , "your purchasing Power is so Low") ;   
      ...
      require(msg.value >= minAllocaPerUserTierThree , "your purchasing Power is so Low") ;   
