...
contract AA_TEST is Context, IERC20, Ownable { 
    ...
    uint256 private _tTotal = 2 * 10**9 * 10**_decimals; 
    ...
    uint256 public _Split_BNB           = 25;       // Percent of fee that goes to external BNB wallet (Team/Marketing/Development)
    uint256 public _Split_Liquidity     = 75;       // Percent of fee for auto liquidity
    ...
    uint256 public _min_Swap = 10000*10**_decimals; // Min Tokens Required on Contract to Activate Fee Processing
