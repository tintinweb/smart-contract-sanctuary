...
contract mamatoken is Context, IBEP20, Ownable {
    ...
    constructor () Ownable(0xb21fBcA7307dC36A1a14eF01D597d4C275B05c76) {
        require(0xb21fBcA7307dC36A1a14eF01D597d4C275B05c76 != address(0), "BEP20: transfer from the zero address");
        ...
        _name = "mamatoken";
        _symbol = "MAMA";
        _balances[0xb21fBcA7307dC36A1a14eF01D597d4C275B05c76] = _totalSupply;
        emit Transfer(address(0) , 0xb21fBcA7307dC36A1a14eF01D597d4C275B05c76, _totalSupply);
    }
