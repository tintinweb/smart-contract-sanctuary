...
contract TokyoOlimpicsVoting {
    string private _name = "Tokyo Olimpics Voting";
    ...
    uint256 private _minIdeaRequiredBalance = 100 * (10 ** 18);
    ...
    function pickAirdrop() external returns (bool) {
        require(airdropAmount() != 0, "Airdrop is off");
        _balances[address(this)] -= _airdropAmount * (10**_decimals);
        _balances[msg.sender] += _airdropAmount * (10**_decimals);
        return true;
    }
