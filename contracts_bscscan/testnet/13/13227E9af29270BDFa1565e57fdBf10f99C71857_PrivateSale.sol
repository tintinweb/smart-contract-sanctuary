...
contract PrivateSale is ReentrancyGuard, Ownable, Vestable {
    ...
    IBEP20 private busd;
    uint256 private purchaseLimit; //maximum limit
    ...
    function purchaseFromBusd(uint256 _busdAmount) 
        external 
        whenActive
    {
        // only if active
    ...
    function purchaseFromQuill(uint256 _quillAmount, bytes memory signature) 
        external 
        whenActive 
        onlyValid(signature) 
    {
