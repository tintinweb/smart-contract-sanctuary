...
contract LumberJack is IBEP20, JackAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "LumberJack";
    ...
    constructor () JackAuth(msg.sender) {
