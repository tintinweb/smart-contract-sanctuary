...
contract SamSample is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0xe635539577B0D586276033c8522a85268c403374;
    

    string private _name    = "SamSample";
    ...
    function removeAllFee() private {
        if(_totalLiquidityFee == 0 && _charityFee == 0 && _liquidityFee == 0
