...
contract baikalfinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public developmentAddress = payable(0xC31034134791831f53082708D47CF0d54883594E); // Development Address
    ...
    string private _name = "baikal.finance";
    string private _symbol = "BKAL";
    ...
    uint256 public buyBackSellLimit = 50 * 10**14;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(developmentAddress, transferredBalance.mul(developmentDivisor).div(100));
    ...
    function prepareForAirDrop() external onlyOwner {
    ...
    function afterAirDrop() external onlyOwner {
        setSwapAndLiquifyEnabled(true);
        _taxFee = 2;
        _liquidityFee = 10;
        _maxTxAmount = 150000000 * 10**6 * 10**9;
    }
