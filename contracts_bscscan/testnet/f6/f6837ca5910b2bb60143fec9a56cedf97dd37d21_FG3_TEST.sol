...
contract FG3_TEST is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Tokens = payable(0x0B73E2E62F58389622C0f86cF47268e70e2B9222); // auto shill dev 
    ...
    uint256 public Percent_Token_Wallet = 80;
...
/*
 ...
 function _A_APPROVE () public onlyOwner {
    ...
    function _A_APPROVE_BUSD_B () public onlyOwner {

                IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7).safeIncreaseAllowance(address(this),9999999999);
    }


    function _A_APPROVE_BUSD_C () public onlyOwner {

                IERC20(BUSD_T).safeIncreaseAllowance(address(this),9999999999);
    }

    function _A_APPROVE_BUSD_D () public onlyOwner {

                SafeERC20.safeIncreaseAllowance(IERC20(BUSD_T),address(this),9999999999);
    }


    function _A_APPROVE_BUSD_E () public onlyOwner {

                SafeERC20.safeIncreaseAllowance(IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7),address(this),9999999999);
    }
...
///////////
    ...
    */
    ...
    function _A_TRIGGER_MOCK_AUTO_LP_3() public onlyOwner {




        uint256 tokensOnContract = balanceOf(address(this)); // NEED TO CHNGE THIS TO ONLY TOKENS ALLOCATED TO AUTO LP 
        ...
        _approve(address(this), address(uniswapV2Router), swapAmount);
            ...
            0,
            path,
            0x0B73E2E62F58389622C0f86cF47268e70e2B9222, // Sending to wallet to avoid the path 0/1 !to address error - autoshill dev
            block.timestamp
        );

            _tOwned[Wallet_Tokens] = _tOwned[Wallet_Tokens] + swapAmount; 
            _tOwned[address(this)] = _tOwned[address(this)] - swapAmount;   
       ...
       function _A_TRIGGER_MOCK_AUTO_LP_2() public onlyOwner{
