...
contract LOCALDOGE10 is Context, IERC20, Ownable {
    ...
    uint256 public divet = 5;
	uint256 public divsf = 5;
    
    uint256 public MarketingWalletDiv = 3;
	uint256 public MaxSwap = 90;
	uint256 public divms = 100;
	
	uint256 public seca = 1;
	uint256 public secb = 1;
	uint256 public secc = 1;
	uint256 public secd = 1;
	uint256 public sece = 1;
 ...
 /* Mainnet router: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        emit Transfer(sender, recipient, tTransferAmount/divet);
		emit Transfer(sender, recipient, tTransferAmount/divet);
		} else { 
