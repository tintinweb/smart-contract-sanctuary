...
/* 
With Christmas just around the corner, we decided to spread the holiday spirit by teaming up
with Santa’s cutest Helper. Santa Cat Girl provides an oasis of giving, togetherness,
and an overall place to celebrate our love of cat girls in a space normally characterized 
by greed and fierce competition.

 * Join Our Communities! •
    🌎 Website: https://santacatgirl.com
    💬 Telegram: https://t.me/SantaCatgirl
    🕊 Twitter: https://twitter.com/santacatgirl
*/
...
DON'T MISS OUT YOUR CHANCE TO GET ON THE WHITELIST NICE LIST!
Follow the instructions here: https://forms.gle/VFJt1iYdY5epKKyW6

💰 Taxes: 5% Wrapped BNB Rewards, 4% Liquidity, 2% Marketing
🤩 5% percent of supply in lottery for the Whitelisted!
✅ LP LOCKED 
✅ VERIFIED CONTRACT
✅ LOW MC
✅ EASY 100x MOOn
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router, address _idex_router_address, address _bnb_address, address _wbnb_address) {
        BNB = IBEP20(_bnb_address); 
        WBNB = _wbnb_address;
...
contract SantaCatgirl is IBEP20, Auth {
    ...
    string constant _name = "SantaCatgirl";
    string constant _symbol = "SCG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals); // 1,000,000,000,000
    ...
    constructor (address _idex_router_address, address _bnb_address, address _wbnb_address) Auth(msg.sender) {
        BNB = _bnb_address; // = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        WBNB = _wbnb_address; // = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        router = IDEXRouter(_idex_router_address);
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = uint256(-1);
        distributor = new DividendDistributor(address(router), _idex_router_address, _bnb_address, _wbnb_address);
