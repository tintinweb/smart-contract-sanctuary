...
// MilkTokenTest with Governance.
contract MilkTokenTest is BEP20('Milk Token', 'MILK') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MILK (not scaled);
