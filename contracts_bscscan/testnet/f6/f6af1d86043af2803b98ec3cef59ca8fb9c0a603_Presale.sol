...
contract Presale is ReentrancyGuard {
    ...
    event AddLiquidity(uint256 baseFeeAmount, uint256 tokenFeeAmount, uint256 refererTokenFeeAmount, uint256 baseLiquidity, uint256 tokenLiquidity, uint256 remainingBaseTokenBalance, uint256 remainingSaleTokenBalance, uint256 zeroRoundTokenBurn);
    ...
    constructor(address _presaleGenerator) {
        ...
        PRESALE_SETTING = IPresaleSetting(0xa026d550b85fFf69ABEeB5568CcB4449BC2eedBA);
        PRESALE_LOCK_FORWARDER = IPresaleLockForwarder(0xD975437368a6574D956E49bfDA4B8E53971c8053);
    ...
    function addLiquidity() external nonReentrant {
        ...
        uint256 refererTokenFeeAmount = 0;
        if (PRESALE_ITEM.FEE.REFERER_FEE_ADDRESS != address(0)) {
            ...
            // Token fee
            refererTokenFeeAmount = tokenFeeAmount.mul(PRESALE_ITEM.FEE.REFERER_FEE_PERCENT).div(1000);
        ...
        emit AddLiquidity(baseFeeAmount, tokenFeeAmount, refererTokenFeeAmount, baseLiquidity, tokenLiquidity, remainingBaseTokenBalance, remainingSaleTokenBalance, zeroRoundTokenBurn);
    }
