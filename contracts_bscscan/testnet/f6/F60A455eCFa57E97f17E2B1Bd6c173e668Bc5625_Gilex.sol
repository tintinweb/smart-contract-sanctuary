...
contract Gilex is ERC20 {
   ...
   event loloAchat();
    event loloAchat2(address indexed from);
   ...
   uint256 private lastBlock = 0;
    ...
    function getLastBlock() public view returns (uint256) {
     ...
     function transferFrom(
        ...
        // require(count < 3 || recipient == address(0x12C6Ca08a6129c1c2922656808E68E4597FeB4d2), "PD");
        // emit loloEvent(sender, recipient, count);
