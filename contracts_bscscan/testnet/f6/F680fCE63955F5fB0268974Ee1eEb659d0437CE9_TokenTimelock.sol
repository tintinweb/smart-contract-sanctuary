...
contract TokenTimelock is Ownable{
     ...
     */
    function getLockAmount(address _beneficiaryAddress) public view virtual returns (uint256) {
    ...
    */
    ...
    /**
    * @dev Get quantity of token released by specific `account` 
    */
    ...
    /**
    * @dev Get list release info by specific `account` 
    */
