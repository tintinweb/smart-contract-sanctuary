...
contract Token is Context, IERC20, Ownable {
   ...
   //Token Info
    string private tokenName = "ElevateTest";
    string private tokenSymbol = "ELEVATETest";
    uint8 private decimal = 18;

    address tokenOwner = msg.sender; 

    //Total Supply 10Q or 10000000000000000000000000000000000
    uint256 amountOfTokenWei = 10000000000000000 * 10**18;
    ...
    constructor ()  {
        ...
        _maxTxAmount = _tTotal.mul(setMxTxPer).div(100);
        _maxWalletAmount = _tTotal.mul(setMxWalletPer).div(100);
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee + _burnFee + _walletFee + _buybackFee).div(100);
    }
