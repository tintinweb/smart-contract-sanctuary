...
contract StakeContract is Ownable {
    ...
    uint256 public minimum_deposit = 10*10**18;
    uint256 public endBlock = 100000000000000000;
    uint256 public rewardperblock = 1*10**18;
    uint256 private unlockblockperiod = 720;
    address public rewardaddress = 0x0a75FcC713378941685883b3be9Dd125F6a9Ea82;
    address public stakeaddress = 0x0a75FcC713378941685883b3be9Dd125F6a9Ea82;
