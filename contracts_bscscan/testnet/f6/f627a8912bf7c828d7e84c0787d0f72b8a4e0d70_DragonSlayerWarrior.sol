...
contract DragonSlayerWarrior is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, Tradable, WarriorInterface {
    ...
    /** LIST OF MODIFIER **/
    modifier onlySpawner (address signer) {
        require(manager.onlySpawer(signer), "Caller is not the spawner");
        _;
    }
    ...
    function createWarrior (
        ...
        uint level,
        address signer
    ) override external onlySpawner(signer) returns (DRS.Warrior memory) {
