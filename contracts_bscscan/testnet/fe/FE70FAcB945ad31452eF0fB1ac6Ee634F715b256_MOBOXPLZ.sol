...
//EarnADA Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract MOBOXPLZ is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MoBoxplz';
    string private constant _symbol = 'MBXplz';
    ...
    address public constant TeamWallet=0x78b1872460E83100c11e3a9190D403bd39D67f74;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimMOBOX(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    function claimMOBOX(address addr) private{
        ...
        path[1] = 0x3203c9E46cA618C8C1cE5dC67e7e9D75f5da2377;  //Binance-Peg MOBOX Token
    ...
    function MOBOXWithdraw() public{
        claimMOBOX(msg.sender);
    }
