    ...
    ReentrancyGuardUpgradeable
{
        ...
        returns (uint256)
    {
        ...
        uint256 len = app.availableCollateralTokens.length;
        console.log("len: ", len);
        bool validCollateralToken = false;
        for (uint256 i = 0; i < len; i++) {
            if (app.availableCollateralTokens[i] == _collateralToken) {
                validCollateralToken = true;
                break;
            }
        }
        require(validCollateralToken, "no CollateralToken!");
