...
contract TESTToken is ERC20, Ownable {
    ...
    address public _fireWhaleAddress  = 0x0D889F72b3FeD2bE2b7481b5B852d3DeB2bA578F;
    ...
    constructor() ERC20("TEST", "TEST") {
        ...
        excludeFromFees(_fireWhaleAddress, true);
    ...
    function setFireWhaleWallet(address payable wallet) external onlyOwner{
        _fireWhaleAddress = wallet;
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 marketingandWhaleTokens = contractTokenBalance.mul((marketingFee/100).add(fireWhaleFee)).div(totalFees);
            swapAndSendToFee(marketingandWhaleTokens);
            

            uint256 swapTokens = contractTokenBalance.mul(liquidityFee/100).div(totalFees);
