...
contract TravelCoin is IERC20Extended, Auth, BaseToken {
    ...
    constructor() payable Auth(msg.sender) {
        ...
        rewardToken = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47;
    ...
    function setAutomatedMarketMakerPair(address newPair, bool value) public onlyOwner {
        require(pair != newPair, "TVC: The IUniswapV2 pair cannot be removed from automatedMarketMakerPairs");
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBUSDLiquidity = amountBUSD
            ...
            .div(totalBUSDFee)
            .div(2);
        uint256 amountBUSDReflection = amountBUSD.mul(reflectionFee).div(
            totalBUSDFee
        );
        uint256 amountBUSDMarketing = amountBUSD.mul(marketingFee).div(
            totalBUSDFee
        );

        try distributor.deposit{value: amountBUSDReflection}() {} catch {}
        payable(marketingFeeReceiver).transfer(amountBUSDMarketing);
