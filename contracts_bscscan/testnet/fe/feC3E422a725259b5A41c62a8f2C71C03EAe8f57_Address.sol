...
contract SirRonGamesToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = payable(0xbBd9fE574dBe654F8f2d97AbEFe43aD1F92ceB8E); // Charity Address
    ...
    string private _name = "Sir Ron Games Token";
    string private _symbol = "SRGT";
    ...
    uint256 public charityDivisor = 10; // charity percentage
    
    uint256 private maxTxPercent = 15; // MAX transaction is 1.5%
    ...
    // MAX Wallet amount to purchase and hold is 3% of the total supply, except for deadAddress
