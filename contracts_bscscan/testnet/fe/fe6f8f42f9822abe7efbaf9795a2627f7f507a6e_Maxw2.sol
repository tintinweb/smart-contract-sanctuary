...
contract Maxw2 is IBEP20, Auth {
    ...
    string constant _name = "Maxw2";
    string constant _symbol = "MAXW2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 300 / 10000; 
    uint256 public _maxWalletSize = (_totalSupply * 500) / 10000; 
    ...
    function triggerCGBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
