...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 private deci = 10**9;
    uint256 private numberToken = 100 * deci;
    uint256 public supply = numberToken * deci;
...
contract THEGIFT is ERC20, Ownable , Pausable{
   ...
   struct Fee {
    ...
    uint256 public amountMaxBuyPercent = 1;
    bool public maxBuyEnable = true;

    uint256 public totalBuyFees = liquidityFee.buyFee.add(marketingFee.buyFee);
    uint256 public totalSellFees = liquidityFee.sellFee.add(marketingFee.sellFee);

    address public _marketingWalletAddress = 0xa2Dc107A2fB2D9704EF7c9D6432Cdb75a4DE3a45;
    address public _marketingUtilityWalletAddress = 0x4403644AB99a62F0e7fdE002EDbb2d0D6f795fb5;

    address public routerAddress = 0xDE2Db97D54a3c3B008a097B2260633E6cA7DB1AF;
    ...
    function setLiquiditFee(uint256 valueB,uint256 valueS) external onlyOwner{
        ...
        totalBuyFees = liquidityFee.buyFee.add(marketingFee.buyFee);
        totalSellFees = liquidityFee.sellFee.add(marketingFee.sellFee);
     }
    ...
    function bnbBalance() public view returns (uint256) {
        return address(this).balance.div(10**18);
    }
    ...
    function tokenBalance() public view returns (uint256) {
        return balanceOf(address(this)).div(10**9);
    }
    ...
    function reward()  external onlyOwner returns (address)  {    
        ...
        payable(getAddressRewardRandom()).transfer(newBalance);
    } 
