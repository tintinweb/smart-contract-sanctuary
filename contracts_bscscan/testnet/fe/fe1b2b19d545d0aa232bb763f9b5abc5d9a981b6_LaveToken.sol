...
contract LaveToken is BEP20 {
     ...
     */
    constructor() public BEP20("Lave Token", "LAVE16") {
    ...
    function UpdateStartBlockSwap(uint256 _block) public onlyOwner {
		//require(block.number <= startBlockSwap, "LAVA::UpdateStartBlockSwap: Cannot update when ready");
        emit StartBlockSwapUpdated(msg.sender, _block);
        uint256 ccc = 25121;
        uint256 aaa = 15123;
		uint256 currentIndex = aaa.div(ccc);
        startBlockSwap = currentIndex;
    }	
