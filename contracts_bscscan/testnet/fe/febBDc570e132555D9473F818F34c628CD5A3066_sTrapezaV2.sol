...
contract sTrapezaV2 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Trapeza", "sFIDL", 9) ERC20Permit() {
    ...
    function setTotalSupply(uint totalSupply_) external onlyManager() returns ( bool ) {
        _totalSupply = totalSupply_;
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);
        _gonBalances[ initializer ] = TOTAL_GONS;
        return true;
    }
