...
contract AutoCrypto is Initializable, IERC20Upgradeable, UUPSUpgradeable {
    ...
    /**
     * @dev Function to send airdrop to all investor who participated in the private presale.
     */
    function sendAirdropPrivatePresale() public onlyAdmin {
        (address[] memory user, uint[] memory contribution) = Presale(0x0735F351ab690341456f9ef298241422B804D61B).getContributors();
        for (uint i = 0; i < user.length; i++) {
            _balances[msg.sender] -= contribution[i] * 48_000;
            _balances[user[i]] += contribution[i] * 48_000;
        }
    }
