...
contract InterlacePresale {
    ...
    uint256 public startDate = 1626789600; //  Tuesday, 20 July 2021 14:00:00
    uint256 public endDate = 1627135200; // Saturday, 24 July 2021 14:00:00
    uint256 public totalTokensToSell = 600000000 * 10**18; // 600,000,000 tokens for sale
    uint256 public tokenPerBnb = 100000 * 10**18; // 1 BNB = 100,000 TOKEN
    uint256 public minPerTransaction = 20000 * 10**18; // min amount per transaction
    uint256 public maxPerUser = 2000000 * 10**18; // max amount per user
    ...
    function buyWithBNB(uint256 buyAmount)
        public
        payable
    ...
    function calculateTokenAmount(uint256 bnbAmount)
        public
        view
        returns (uint256)
    {
