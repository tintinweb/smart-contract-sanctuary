...
contract SeedifyFundsContract is Ownable {
  ...
  uint public minAllocaPerUserTierFive;
  uint public minAllocaPerUserTierSix;
  uint public minAllocaPerUserTierSeven;
  uint public minAllocaPerUserTierEight;
  uint public minAllocaPerUserTierNine;
  ...
  mapping(address => uint) public minBuyInFiveTier;
  mapping(address => uint) public minBuyInSixTier;
  mapping(address => uint) public minBuyInSevenTier;
  mapping(address => uint) public minBuyInEightTier;
  mapping(address => uint) public minBuyInNineTier;
  ...
  constructor(uint _maxCap, uint256 _saleStartTime, uint256 _saleEndTime, address payable _projectOwner,
               ...
               uint256 _tierNineValue,uint _totalparticipants) public {
    maxCap = _maxCap;
    ...
    minAllocaPerUserTierTwo = 100000000000000000;
    minAllocaPerUserTierThree = 100000000000000000;
    minAllocaPerUserTierFour = 100000000000000000;
    minAllocaPerUserTierFive = 100000000000000000;
    minAllocaPerUserTierSix = 100000000000000000;
    minAllocaPerUserTierSeven = 100000000000000000;
    minAllocaPerUserTierEight = 100000000000000000;
    minAllocaPerUserTierNine =100000000000000000;
