...
//FanSubs TokenV2 - BEP20 - Binance Smart Chain
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract FanSubsV21 is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000000 * 10**18 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FanSubs V210";
    string private _symbol = "FSTV210";
    ...
    address public devWallet = 0xc3Eb2a98b2a4A13dcd8D6d9DBA9D71899327D022; //set following deployment as foundation wallet
    ...
    uint256 public _maxWalletToken = 10000000000 * 10**18 * 10**18;
