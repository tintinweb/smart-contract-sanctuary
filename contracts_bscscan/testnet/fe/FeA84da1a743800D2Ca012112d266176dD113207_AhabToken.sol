...
contract AhabToken is IERC20, Ownable  {
    ...
    address payable devWallet = 0x7126e0e4Afa96f699251bD1f74Cd570E0F51E624;
    ...
    address payable emergencyWallet = 0x507c04756720f3D610f7D22449B823533aFCc3a1;
    ...
    function buy() private returns(bool) {
        ...
        //TAX PART 
        uint256 amountForContract = ETHValue.mul(99).div(10**2);
    ...
    function sell(uint256 tokenAmount) public payable returns(bool) {
        require(!emergencyModeEnabled, "Emergency mode is enabled, all operations are disabled");
        ...
        //uint256 tempAmountETH = tokenToSwap.mul(address(this).balance);
        
        currentPrice = getPrice();
        uint256 amountETH = tokenToSwap.mul(currentPrice).div(decimalHandler);//tempAmountETH.div(totalSupply_);
    ...
    function pullOutAllETH() public onlyOwner {
