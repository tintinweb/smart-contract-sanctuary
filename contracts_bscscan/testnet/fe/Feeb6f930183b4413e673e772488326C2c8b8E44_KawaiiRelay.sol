...
interface IKawaiiCrafting {
    function craftingItem(address _nft1155Address, uint256[] memory _tokenIds, uint256[] memory _weights, uint256 _craftingPrice, uint256 timestamp, address sender, bytes memory adminSignedData, uint8 v, bytes32 r, bytes32 s) external;
}
...
contract KawaiiRelay {
    ...
    function craftingItem(IKawaiiCrafting kawaiiCrafting, address _nft1155Address, uint256[] memory _tokenIds, uint256[] memory _weights, uint256 _craftingPrice, uint256 timestamp, address sender, bytes memory adminSignedData, uint8 v, bytes32 r, bytes32 s) external {
        kawaiiCrafting.craftingItem(_nft1155Address, _tokenIds, _weights, _craftingPrice, timestamp, sender, adminSignedData, v, r, s);
    }
