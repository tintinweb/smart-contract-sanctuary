...
//#JUSTICE features:
//   0.5% fee auto add to the liquidity pool to be locked forever in each trade.
//   0.5% fee auto distributed to all holders, including the burn wallet (black hole).
 ...
 * `JusticeMath` restores this intuition by reverting the transaction when an
...
library JusticeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        require(c >= a, "JusticeMath: addition overflow");
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        return sub(a, b, "JusticeMath: subtraction overflow");
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        require(c / a == b, "JusticeMath: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        return div(a, b, "JusticeMath: division by zero");
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        return mod(a, b, "JusticeMath: modulo by zero");
