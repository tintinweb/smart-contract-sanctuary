...
contract MiniDogePro is ERC20, Ownable {
    ...
    uint256 public _marketingDivisor = 60;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "MiniDogePro: The new dividend tracker must be owned by the FLOKIBUSD token contract");
    ...
    function updateLiquidityFee(uint8 buyFee, uint8 sellFee) public onlyOwner {
        require(sellFee >= 0 && sellFee <= 15, "MiniDogePro: Liquidity sell tax must be between 0 and 15");
        require(buyFee >= 0 && buyFee <= 15, "MiniDogePro: Liquidity buy tax must be between 0 and 15");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MiniDogePro: _gasForProcessing must be between 200,000 and 500,000");
