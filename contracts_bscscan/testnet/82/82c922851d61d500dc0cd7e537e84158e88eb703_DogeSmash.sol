...
contract DogeSmash is Context, IERC20, Ownable {
    ...
    string private _name = "DogeSmash";
    string private _symbol = "DOGESMASH";
    ...
    address payable public marketingWallet =  payable(0x29Bbdba86DF5386e7fa5dE7100af882E5681F909);
    ...
    uint256 public numTokensSellToAddToLiquidity = 100000 * 10**2;
