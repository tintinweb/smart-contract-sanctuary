...
contract BabyAspin is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0xA2B1f3E7333fD0a1CBa269FF626c766D4A42FE21; //2% for marketing ,1% for giveaways
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 devAmt = amount.mul(_charityFee).div(100);
        ...
        _transferStandard(sender, charityWallet, devAmt);
