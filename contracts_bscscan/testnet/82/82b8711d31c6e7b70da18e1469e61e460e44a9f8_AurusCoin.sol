...
AurusCoin is built upon the fundamentals of Buyback and increasing the investor's value
...
3) Anti snipe/bot protection. Automatically blacklists addresses. 
...
contract AurusCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x33ce5e20C939B0AD9E211a8FecC4c6cc08b2b237); // Marketing Address
    ...
    string private _name = "AurusCoin";
    string private _symbol = "AURUS";
