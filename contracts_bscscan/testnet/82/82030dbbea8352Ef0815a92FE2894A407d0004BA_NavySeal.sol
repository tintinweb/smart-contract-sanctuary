...
contract NavySeal is Context, IBEP20, Ownable {
    ...
    uint256 private _numOfTokensToExchange = 1000000000 * 10**6 * 10**9;
    ...
    constructor() public {
        ...
        IPancakeRouter02 _pancakeswapV2Router =
            IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  // PROD: 0x10ED43C718714eb63d5aA57B78B54704E256024E ; TESTNET: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap =0xaA4E90E6B23D1e32aEd6e5De7A58BEc82656AC88;
