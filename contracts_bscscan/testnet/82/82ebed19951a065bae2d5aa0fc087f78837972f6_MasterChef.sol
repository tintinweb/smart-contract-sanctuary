...
contract DarkMatter is ERC20("DarkMatter", "KDM"), Ownable {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying KDMs (not scaled);
...
contract MasterChef is Ownable {
   ...
   // Return reward multiplier over the given _from to _to block.
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 KDMReward = multiplier.mul(KDMPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        KDM.mint(teamaddress, KDMReward.div(10));
    ...
    function setteamaddress (address _teamaddress) public {
        require(msg.sender == teamaddress, "dev: wut?");
        teamaddress = _teamaddress;
    }
