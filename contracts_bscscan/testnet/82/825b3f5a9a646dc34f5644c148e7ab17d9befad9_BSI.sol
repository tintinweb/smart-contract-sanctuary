...
// The address of the player and => the user info
   ...
   function() public payable {}
    ...
    function distributePrizes(uint256 _gameId, uint16 teamWinner) public onlyAgent {
        Game storage game = gameInfo[_gameId];
        require(bettingActive == false);
        address[1000000] memory winners;
        address[1000000] memory draw;
