...
/*
https://t.me/DeltaTest
https://www.deltatest.co
DTT DetaTest
...
contract BetaTest is ERC20, Ownable {
  ...
  constructor() ERC20("DeltaTest", "DTT") {
  ...
  function updateTeamWallet(address _newWallet) external onlyOwner {
    require(_newWallet != teamWallet, "BetaTest: The team wallet is already this address");
  ...
  function updateMarketingWallet(address _newWallet) external onlyOwner {
    require(_newWallet != marketingWallet, "BetaTest: The marketing wallet is already this address");
    isExcludedFromFees[_newWallet] = true;
  ...
  function updateCakeDividendTracker(address newAddress) external onlyOwner {
    require(newAddress != address(cakeDividendTracker), "BetaTest: The dividend tracker already has that address");
    ...
    require(
      ...
      "BetaTest: The new dividend tracker must be owned by the BetaTest token contract"
    );
  ...
  function updateCakeDividendRewardFee(uint8 newFee) external onlyOwner {
    require(newFee <= 6, "BetaTest: Fee must be less than 6%");
  ...
  function updateUniswapV2Router(address newAddress) external onlyOwner {
    require(newAddress != address(uniswapV2Router), "BetaTest: The router already has that address");
    emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
    uniswapV2Router = IUniswapV2Router02(newAddress);
  }

  function excludeFromFees(address account, bool excluded) public onlyOwner {
    require(isExcludedFromFees[account] != excluded, "BetaTest: Account is already exluded from fees");
  ...
  function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
    require(pair != uniswapV2Pair, "BetaTest: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
    require(
      ...
      "BetaTest: Automated market maker pair is already set to that value"
    );
    automatedMarketMakerPairs[pair] = value;
  ...
  function updateGasForProcessing(uint256 newValue) external onlyOwner {
    require(newValue != gasForProcessing, "BetaTest: Cannot update gasForProcessing to same value");
  ...
  function _transfer(
    ...
    require(
      ...
      "BetaTest: Trading has not started yet"
    );
...
contract CakeDividendTracker is DividendPayingToken {
  ...
  constructor()
    DividendPayingToken(
      "BetaTest_Ethereum_Dividend_Tracker",
      "BetaTest_Ethereum_Dividend_Tracker",
  ...
  function _transfer(
    ...
    require(false, "BetaTest_Ethereum_Dividend_Tracker: No transfers allowed");
  }

  function withdrawDividend() public pure override {
    require(
      false,
      "BetaTest_Ethereum_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BetaTest contract."
    );
  }
  ...
  function updateClaimWait(uint256 newClaimWait) external onlyOwner {
    require(
      ...
      "BetaTest_Ethereum_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
    );
    require(newClaimWait != claimWait, "BetaTest_Ethereum_Dividend_Tracker: Cannot update claimWait to same value");
