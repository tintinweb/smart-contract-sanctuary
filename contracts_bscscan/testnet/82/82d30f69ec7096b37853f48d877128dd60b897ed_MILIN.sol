...
contract MILIN is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public charityAddress = 0xc1A9A410D3b9cC3F3d39F64897dd9Fe08bb744a1;
    ...
    string private _name = "MILIN";
    string private _symbol = "MLN";
  ...
  function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
    ...
    uint256 public threshHoldTopUpRate = 1; // 25 percent
    ...
    uint256 public disruptiveCoverageFee = 0.001 ether; // antiwhale
    ...
    uint256 public rewardThreshold = 0.00000000001 ether;
    ...
    function swapAndLiquify(address from, address to) private {
       ...
       function activateContract() public onlyOwner {
        ...
        // protocol
        disruptiveCoverageFee = 0.001 ether;
