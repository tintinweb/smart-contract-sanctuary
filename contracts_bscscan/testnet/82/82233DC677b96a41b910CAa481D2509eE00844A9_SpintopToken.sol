...
contract SpintopToken is Ownable, BEP20Pausable, Blacklist {
   ...
   //* Addresses to mint initial token supply */////////
    ...
    //uint256[8][3] private  _monthlyMintingAmounts;
    // Minting vars end //
    ...
    uint256 constant _liquidityAmount = 15000000 * 1e18; //15million tokens
     ...
     // Testing Addresses //
     address constant stakingAddr = 0xEa2ED5Db0E74f198e56ceD89a014867a59D15C23;
     address constant treasuryAddr = 0x5FC61B62a957646C1cF01f21aFeA57BF63e3C8AE;
     address constant marketingAddr = 0x85CbC73f02f69a3A05D1dCB3879F0CbFefA755Bf; 
     address constant teamAddr = 0x8A7F0BB09Ef723c582375211ff2aE63B5fd8a8C9;
     address constant idoAddr = 0x78b2c40ed1a57c4f0307851F50a21f59227723a9;
     address constant seedAddr = 0x09F12B460360AAbC8dBD26cb42ce326Cf44B9144;
     address constant liquidityAddr = 0xF0a693994b40a645DD99D83844BEBc29370e6126; //Initial Liquidity
     address constant airdropAddr = 0x5C7FfB85031E025Ba80EB450dCdf6fa1e536F5aC; //Airdrop&Bounty
    ...
    // @dev Setups minting amounts, will be called only on initialization
        ...
        for(uint8 i = 0; i<36; i++){
            if (i == 0){
                ...
                _remainingMintingAmount = _remainingMintingAmount+stakingAmount+treasuryAmount+marketingAmount+teamAmount+idoAmount+seedAmount+airdropAmount;
                continue;
            }
            else if (i == 1) {
                uint256 stakingAmount = 6500000 * 1e18;
        ...
        function mintManager(uint256 amount) external onlyOwner{
            require(currentMintRound() > 60, "Minting date is too early");
