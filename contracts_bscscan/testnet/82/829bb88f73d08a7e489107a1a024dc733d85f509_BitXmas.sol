...
/*
 ***find me on telegram/test2***
        4 % Redistribution Fee (Holders)
        1 % Liquidity Fee
        4 % Marketing wallet
        1 % Auto Burn on every Transaction
*/
...
contract BitXmas is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xf968D000c99F2827Bc5b086357331a71886ba109);
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "BitXmas";
    string private _symbol = "BXM";
    ...
    function setMarketingFeePercentage(uint256 mFee) external onlyOwner(){
        _marketingFee = mFee;
