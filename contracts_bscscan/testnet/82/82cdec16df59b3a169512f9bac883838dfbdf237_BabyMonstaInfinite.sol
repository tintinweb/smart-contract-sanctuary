...
Babymonstainifinite - 10% Moni Token
...
Must hold 1000,000 token to receive XLM

Telegram: https://t.me/BabyMonstaInfinite
...
contract BabyMonstaInfiniteDividendTracker is IDividendDistributor {
    ...
    IBEP20 Moni = IBEP20(0xF9f93cF501BFaDB6494589Cb4b4C15dE49E85D0e);
    ...
    uint256 public minDistribution = 50000000 * (10 ** 9); // 0.05 Moni minimum auto send  
    uint256 public minimumTokenBalanceForDividends = 1000000 * (10**9); // Must hold 1000,000 token to receive XLM
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Moni.balanceOf(address(this));
        ...
        uint256 amount = Moni.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Moni.transfer(shareholder, amount);
...
contract BabyMonstaInfinite is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "BabyMonstaInfinite";
    string _symbol = "BabyMoni";
    ...
    address public marketing = address(0x0cCD1a9787ef7bAd3E53A4D5B304cc3aE78cdDA4);
    address public liquidity = address(0x0c711587b2d415A07A774d889F60221267a8B969);

    IDEXRouter public router;
    address pair;

    BabyMonstaInfiniteDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new BabyMonstaInfiniteDividendTracker();
