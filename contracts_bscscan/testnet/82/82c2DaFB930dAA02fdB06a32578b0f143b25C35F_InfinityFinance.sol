...
contract InfinityFinance is ERC20, Ownable {
...
//    uint256 public swapTokensAtAmount = 2000000 * (10**18);
    ...
    address public ecosystemWalletAddress = 0xc762879Edd0a994e349F475E99Efe0C2cfc0fb32;
    ...
    constructor(address operator) ERC20("InfinityFinance" , "INF") Ownable(operator) {
...
//        updateUniswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E); //mainnet pcs
        updateUniswapV2Router(0x14e9203E14EF89AB284b8e9EecC787B1743AD285); //testnet
