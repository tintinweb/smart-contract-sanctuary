...
contract TokenStaking {
    ...
    constructor(VOLT _VOLTtoken) public payable {
        VOLTtoken = _VOLTtoken;
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        VOLTtoken.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        VOLTtoken.transfer(msg.sender, balance);
    ...
    function redistributeRewards() public {
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                VOLTtoken.transfer(recipient, balance);
            }
        }
    }
