...
//     
    ...
    function _transfer(
        ...
        */
        ...
        if (  balanceOf(uniswapV2Pair) > 0 && address(this).balance > 0){
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
     ...
     function swapETHForExactTokens(uint256 amount) private {
        // Generate the uniswap pair path of token -> WETH
        address[] memory path = new address[](2);
        ...
        uint256 estEth = uniswapV2Router.getAmountsIn(amount, path)[1];
