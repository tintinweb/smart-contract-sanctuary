...
contract EmployeeDeployer is Initializable, AccessControl {
    ...
    uint256 public employeePrice = 2000000000000000000 wei;
    ...
    function mintEmployee(uint8 employeeType) public {
        ...
        uint8 body = baseDeployer.randomBuildType();
        uint8 legs = baseDeployer.randomBuildType();
        uint8 hands = baseDeployer.randomBuildType();
        ...
        employees.mint(
            ...
            legs,
            hands,
            calcEmployeePoints([head, body, legs, hands]),
            msg.sender
        );
    }
