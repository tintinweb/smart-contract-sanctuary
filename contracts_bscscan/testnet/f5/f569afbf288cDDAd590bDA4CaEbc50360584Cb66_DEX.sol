...
contract DEX {
    ...
    uint256 constant public minBNB = 1 ether;//1 BNB
    uint256 constant public maxBNB = 5 ether;//5 BNB
    ...
    uint256 public forSale = 5000 ether;//5000 tokens
    ...
    function invest() public payable{
        ...
        require(amount >= minBNB.div(DIVIDER),"Min amount 0.1 BNB");
        require(amount.add(invested[msg.sender]) <= maxBNB,"Total maximum investment amount 5 BNB");
