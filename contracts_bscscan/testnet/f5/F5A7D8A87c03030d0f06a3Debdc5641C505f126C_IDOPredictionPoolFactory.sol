    ...
    Ownable
{
    ...
    uint256 public immutable idoAllocationFee;
    ...
    {
        if (_rank <= 25) {
            // I checked the Sparks white paper again and didn't anything about Sparks prize to winners
            return prizeAmount;
        }
