...
contract NFTsRealmMarketplace is ReentrancyGuard, Ownable {
    ...
    uint256 public marketFeeForKCS = 75;
    ...
    constructor(
        ...
        payoutAddressMap["PAD"] = padPaymentAddress_;
        tokenAddressMap["PAD"] = address(0x1e2FbB76c8dAf5a0a8F91388BAc09511F3d7AC62);
    ...
    function buyNew(uint256 _id, 
        ...
        // 2.5% commission cut
        if (keccak256(abi.encodePacked((paymentType))) == keccak256(abi.encodePacked(("KCS")))) {
            ...
            uint256 _sellerValue = price[newTokenId].sub(_commissionValue);
            require(IERC20(tokenAddressMap[paymentType]).transferFrom(msg.sender, _creator, _sellerValue));
    ...
    function setMarketFeeForKCS(uint256 _newMarketFeeForKCS) external onlyOwner {
        require(_newMarketFeeForKCS > 1, "Invalid MarketFee For KCS");
