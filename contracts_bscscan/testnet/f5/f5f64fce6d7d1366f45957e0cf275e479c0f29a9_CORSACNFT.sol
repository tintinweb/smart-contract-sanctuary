...
contract CORSACNFT is BEP721,Ownable {
    ...
    function mint(string memory tokenUri, 
        ...
        bool vf = verify(address(this), msg.sender, _amount, _message, _nonce, signature);
        require(vf = true, "Verify faild.");
        require(IBEP20(_CSCT).balanceOf(msg.sender) > _amount * (10 ** uint256(15)), "CSCT: Insufficient CSCT");
        IBEP20(_CSCT).transferFrom(msg.sender, address(this), _amount * (10 ** uint256(15)));
