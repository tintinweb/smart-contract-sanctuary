...
contract BabySushi is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string _name = "BabySushi";
    string _symbol = "BabySushi";
    ...
    uint256 airdropVesting = 15; //Can claim 15% per hour
    ...
    address public marketingFeeReceiver = address(0xAcA187b8F68867610005344e6bCD252389255ac0);
    address public airdropWallet = address(0x124878ea2162AF40C0f58c60F77c91818077524D);
    ...
    function claimAirdrop() external{
        ...
        require(airdrops[airdropAddress].totalClaimed < airdrops[airdropAddress].totalToken, "You have no token to claim");
