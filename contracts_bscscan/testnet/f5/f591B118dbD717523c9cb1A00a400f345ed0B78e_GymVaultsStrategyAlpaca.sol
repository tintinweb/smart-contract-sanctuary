...
contract GymVaultsStrategyAlpaca is Ownable, ReentrancyGuard, Pausable {
    ...
    address public uniRouterAddress = address(0x610178dA211FEF7D417bC0e6FeD39F05609AD788);
    /// WBNB address
    address public constant wbnbAddress = address(0xa513E6E4b8f2a923D98304ec87F64353C4D5C853);
    /// BUSD address
        ...
        returns (uint256)
    {
        ...
        if (isAutoComp && !strategyStopped) {
            ...
            IVault(vaultContractAddress).withdraw(_wantAmt);
            if (
                IVault(0x959922bE3CAee4b8Cd9a407cc3ac1C251C2007B1).token() ==
                IVaultConfig(0x2279B7A0a67DB372996a5FaB50D91eAA73d2eBe6).getWrappedNativeAddr()
                // address(this).balance > 0
            ) {
                IWETH(0xa513E6E4b8f2a923D98304ec87F64353C4D5C853).deposit{value: _wantAmt}();
            }
        }
