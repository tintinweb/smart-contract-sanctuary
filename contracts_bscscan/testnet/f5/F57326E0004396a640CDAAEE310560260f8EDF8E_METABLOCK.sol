...
// META BLOCK TOKEN (MetaBlock.sol)

pragma solidity ^0.8.0;

contract METABLOCK is ERC20, Pausable, Ownable {
    uint256 public immutable maxSupply;

    /**
     * @notice Constructor
     * @param _owner: Address owner of token
     * @param _maxSupply: max totalSupply mint
     */
    constructor(
        address _owner,
        uint256 _maxSupply,
    ...
    /**
     * @notice Allows the owner to burn token
     * @dev Callable by owner
     */
