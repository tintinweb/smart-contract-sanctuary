...
contract LootBox is ERC1155, AccessControl {
    ...
    constructor(address multiSigAccount, IERC721 nftContract) ERC1155("") {
    ...
    function mint(
        ...
        for (uint256 i = 0; i < rewardIds.length; i++) {
            _nftContract.transferFrom(_msgSender(), address(this), rewardIds[i]);

            _rewards[newTokenId].push(rewardIds[i]);
        }
    ...
    function openBox(uint256 boxId) external returns (uint256) {
        ...
        _nftContract.transferFrom(address(this), _msgSender(), rewardId);
