...
contract FreeHeroHolders is Ownable,IFreeHeroHolder {
    using EnumerableSet for EnumerableSet.AddressSet;
    EnumerableSet.AddressSet private holders;
    
    function addFreeHeroHolder(address account) public virtual override onlyController {
        holders.add(account);
    }    
    
    function hasFreeHero(address account) public view virtual override  returns (bool) {
    ...
    function removeHolder(address holder) public onlyController {
