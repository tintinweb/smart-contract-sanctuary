...
contract fksafemoontoken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9099D1EEB68da953c111eb9E90A12A984F9AB8AF); // Marketing Address
    ...
    string private _name = "FK SAFEMOON";
    string private _symbol = "FKSAFEMOON";
