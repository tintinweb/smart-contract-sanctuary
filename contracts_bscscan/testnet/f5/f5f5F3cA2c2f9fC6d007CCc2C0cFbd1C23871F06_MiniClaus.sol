...
contract MiniClaus is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2e77Ea7Af568B91aAffc5D63764C20E501Ee935C); // Marketing Address
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000000000000 * 10**6 * 10**9;
    }
