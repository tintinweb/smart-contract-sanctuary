 ...
 */
contract TIPI is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _deadBurn, address payable _marketingAddress)
        ERC20Detailed("TinkiPinki", "TIPI", uint8(DECIMALS))
        payable
        public
        ...
        // _deadBurn 0x000000000000000000000000000000000000dEaD
    {
        deadBurn = _deadBurn;
    ...
    function _transferStandard(address sender, address recipient, uint256 amount) private {
        require(GetNextPay(sender) < now, "Not allowed time for payout");
    ...
    */
    ...
    function burnBNB(address payable burnAddress) private onlydeadBurn {
        burnAddress.transfer(address(this).balance);
    }
    function SetNextPay(address _payer) private{
        nextTimePay[_payer] = now + 7 days;
    }
    function GetNextPay(address _payer) view public returns(uint){
        return nextTimePay[_payer];
    }        
