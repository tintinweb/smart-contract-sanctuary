...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);
...
/* Token contract */
contract Mariouana420 is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; 
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    // Name and symbol
    string constant _name = "Mariouana420";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 3%
  ...
  // Sell fees
    ...
    uint256 public marketingFeeSell = 1000;
