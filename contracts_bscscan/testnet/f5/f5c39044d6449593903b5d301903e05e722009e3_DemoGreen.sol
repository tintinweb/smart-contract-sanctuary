...
contract DemoGreen is Context, IERC20, Ownable {
    ...
    address payable public rewardAddress = payable(0xF5FE12e739C59AD2A886877bb8840fe3CD157818); // Green & Clean Environment Reward Address
    address payable public foundationAdress = payable(0x1b0155e319d0c77DA13A1644b1d200794c18Ec87); // Founcation Address
    ...
    uint256 public _foundationAmount = 1 * 10**14 * 10**9; // 10 percent of total supply
    ...
    function transferFoundationTokens() external onlyOwner() {
        
        require(balanceOf(foundationAdress) + _foundationAmount == _foundationAmount, "Foundation can have only 10% of total supply");
        transfer(foundationAdress, _foundationAmount);
    }
