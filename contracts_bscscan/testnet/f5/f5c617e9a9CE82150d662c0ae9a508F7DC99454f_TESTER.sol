...
contract TESTER is Context, IBEP20, Ownable {
    ...
    uint256 private _maxWallet = _tTotal.div(10**2).mul(2); // 2% of total supply
    ...
    function set_MaxTransaction(uint256 maxTx) external onlyOwner() {
        _maxTxn = maxTx * 10**9 * 10**8;
      }
