 ...
 */
contract Cthulhutoken is IBEP20, HasForeignAsset {
...
contract PrivateSale is Ownable{
  ...
  constructor(uint256 _rate, address payable _wallet, Cthulhutoken _token, uint256 startTime, uint256 endTime) {
    require(_rate > 0);
