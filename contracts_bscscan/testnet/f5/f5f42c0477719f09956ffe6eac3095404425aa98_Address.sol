...
/**
    ...
    I make this #iMeta to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/iMeta
...
contract iMeta is Context, IERC20, Ownable {
    ...
    string private _name = "iMeta";
    string private _symbol = "iMeta";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9F56956209B89fC1Ef7BA1C230087F7a7cA4C7c3);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x9F56956209B89fC1Ef7BA1C230087F7a7cA4C7c3, 'We can not exclude Uniswap router.');
