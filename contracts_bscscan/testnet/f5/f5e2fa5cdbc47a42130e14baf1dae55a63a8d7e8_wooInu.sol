...
contract wooInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000_000_000_000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'TEST API';
    string private _symbol = 'TAPI';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 0; // 0% reflection fee for every holder (incl. burn address)
    uint256 private _marketingFee = 0; // 0% marketing
    uint256 private _liquidityFee = 0; // 2% into liquidity
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // UniswapV2 for Ethereum network
