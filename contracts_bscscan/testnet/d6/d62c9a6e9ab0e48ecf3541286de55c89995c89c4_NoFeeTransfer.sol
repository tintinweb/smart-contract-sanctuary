...
contract NoFeeTransfer is Context, IERC20, Ownable {
    ...
    string private _name = "NoFeeTransfer";
    string private _symbol = "NoFee";
    ...
    //TRANSFER WITHOUT FEE
      ...
      receive() external payable {
        ...
        // CAn I set this up as a QR code that asks for a specific token to send to a specific address (this contract address)
        // Then I can make one for each artist and they can each have their own QR code. Just scan it, choose the amount and send 

            

          // Change this for MUSO 
...
//0x5e3D1c13c764a7C0C27B8985FC715BfBdF6B7174
    ...
    function ___SendTips() public onlyOwner {

             __Tip_Without_Fees(0x5e3D1c13c764a7C0C27B8985FC715BfBdF6B7174, 0x54338DF60770184219ac146f66C29B1dCBEEFB86);

    }


  function __Tip_Without_Fees(address _token, address _to) internal returns(bool _sent){
