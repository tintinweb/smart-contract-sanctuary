...
contract NFTWithPools is IERC721, ITRC165, IERC721Metadata, IERC721Enumerable {
    ...
    string internal _name = "asdfads";  // TODO
    string internal _symbol = "ddd";       // TODO
    ...
    uint256 public firstStage = 3;
    uint256 public secondStage = 15;
    ...
    function getCurrentUserReward(address user) external view returns(uint256) {
        if (
            ...
            if (users[user].level == 1) {
                ...
                return secondStagePool - users[user].lastKnownReward + users[user].firstStageReward;
            }
        } else {
            return 0;
        }
