...
contract WE is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 minTokenNumberToSell = _tTotal.div(10000); // 0.001%  amount will trigger swap and add liquidity
    ...
    constructor (address payable _marketWallet) {
        ...
        IUniswapV2Factory _uniSwapRouter = IUniswapV2Factory(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
