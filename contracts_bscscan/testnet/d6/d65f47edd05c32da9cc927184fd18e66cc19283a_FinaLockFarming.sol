...
contract FinaLockFarming is Initializable, OwnableUpgradeable, FinaFarming {
    ...
    function withdrawLP(uint _pid, uint _amount) external virtual override onlyEOA whenNotPaused {
        ...
        if(pending > 0 && block.timestamp >= user.averageDepositedTime + depositTier[3]) {
            ...
            finaToken.safeTransferFrom(address(this), _msgSender(), pending * rewardRatioByTier[3] / 10000);
            ...
            finaToken.safeTransferFrom(address(this),_msgSender(), pending * rewardRatioByTier[2] / 10000);
            ...
            finaToken.safeTransferFrom(address(this),_msgSender(), pending * rewardRatioByTier[1] / 10000);
            ...
            finaToken.safeTransferFrom(address(this),_msgSender(), 1000000000000000000);
            secondRewardToken.safeTransferFrom(address(this), _msgSender(), 10000000000000000000);
        }
        if(_amount > 0) {
