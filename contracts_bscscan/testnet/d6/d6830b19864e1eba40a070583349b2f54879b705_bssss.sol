...
contract bssss is Context, IERC20, Ownable {
    ...
    string private _name = "bssss";
    string private _symbol = "bssss";
    ...
    address public marketingWalletAddress = 0x796E5eD81E8264E562185621f95dc71a5D3f8d17;
    ...
    uint256 public _maxTxAmount = 500000 * 10**7 * 10**9;
    ...
    function setmarketingWalletAddress(address newWallet) external onlyOwner() {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        _liquidityFee = 0;
		 uint256 currentRate =  _getRate();
		 uint256 rBurn =  burnAmt.mul(currentRate);
		_rTotal = _rTotal.sub(rBurn);
		_tTotal = _tTotal.sub(burnAmt);

        //_transferStandard(sender, address(0), burnAmt);
        _transferStandard(sender, marketingWalletAddress, marketingAmt);
