...
contract HODLVault is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0x5D8FD08356CF3C2aC3fBEC29826731F288Df454F;
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        ...
        if(isTeamWallets[recipient] || isTeamWallets[msg.sender]) {
    ...
    function triggerLoveBuyback(uint256 amount) external authorized {
