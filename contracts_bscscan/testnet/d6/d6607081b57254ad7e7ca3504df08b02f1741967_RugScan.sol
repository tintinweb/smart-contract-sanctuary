...
////////// Libraries ///////////
////////////////////////////////
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.3/contracts/utils/math/SafeMath.sol
// CAUTION
 ...
 */
contract RugScan is Context, IERC20, Ownable {
    ...
    string private _name = "RugScan";
    string private _symbol = "RSC";
    uint8 private _decimals = 9;
    uint256 private _initSupply = 100 * 10**2 * 10 ** uint256(decimals());
    uint256 public texRate = 5;
    ...
    function updatetexRate(uint256 _texRate) public onlyOwner{
        texRate = _texRate;
    }
    ...
    function _transfer(
        ...
        if(recipient==pairAddress && !_isExcludedFromFee[sender]){
            uint256 taxFee = amount.mul(texRate).div(100);
            _balances[teamAddress] = _balances[teamAddress].add(taxFee);
            emit Transfer(sender, teamAddress, taxFee);
