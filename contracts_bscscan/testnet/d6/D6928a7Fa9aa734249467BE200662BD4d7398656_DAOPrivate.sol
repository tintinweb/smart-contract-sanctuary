...
contract DAOPrivate is Ownable, ReentrancyGuard, Pausable, SignatureVerifyer {
    ...
    constructor(address teamWallet, address _signer, uint256[] memory _levelBase) public {
      require(teamWallet != address(0), 'teamWalletIsZero');
    ...
    function payForLevel(
      ...
      // take fees
      // If first level in round -> take 2% fee to owner
