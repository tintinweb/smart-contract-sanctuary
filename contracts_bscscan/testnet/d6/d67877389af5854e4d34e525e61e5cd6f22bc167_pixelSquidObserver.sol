...
interface IBEP20{
  ...
  */
  ...
  function buybox (address userAddress , uint256 price, address paymentErc20)external returns(bool);
  /**
...
contract pixelSquidObserver is  IERC721,Ownables {
  ...
  string public name_ = "Observer";
   ...
   event Paid(
    ...
    event BuyObserver(address indexed userAddress,
  ...
  address public receiver = 0x2255AdB2F014183c3d9573832fC65AcA39d69c38 ;
  ...
  function buyObserver(address userAddress,address tokenAddress,uint256 _amount,string memory _token_name ,uint256 _quality,uint256 _lv, string memory _url, string memory _animation_url,string memory _background,uint256 _watchLimit) public {
      ...
      uint256 allowToPayAmount = payment.allowance(userAddress, receiver);
      ...
      observerToOwner[id] = userAddress;
      ownerObserverCount[userAddress]++;
      transfer(userAddress,id); 

      emit BuyObserver(userAddress,tokenAddress,_amount,_token_name,_quality,_lv,_url,_animation_url,_background,_watchLimit);
  }
