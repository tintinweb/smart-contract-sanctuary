...
contract Hypersonic is BEP20, Ownable {
	...
	bool public takeFeeEnable = true;
	...
	function setTakeFeeEnable(bool _enabled) public onlyOwner {
        takeFeeEnable = _enabled;
    }
	
	function setLiquifyEnable(bool _enabled) public onlyOwner {
        liquifyEnable = _enabled;
    }
