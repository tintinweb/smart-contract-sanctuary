...
contract YaanLaunchpad {
    ...
    constructor() {
        ...
        tiers.push(Tier(365 days, 40, 1 hours));
        tiers.push(Tier(365 days, 100, 2 hours));
        tiers.push(Tier(365 days, 150, 3 hours));
        tiers.push(Tier(365 days, 200, 4 hours));
    ...
    function stake(uint amt) public returns(bool) {
        ...
        uint amount = user[sender].stakedAmount + amt + withdrawable(sender);
    ...
    function userEndTimeFunc(address uAddr) public view returns(uint) {
        ...
        endTime = stake_.stakedAt > endTime ? tier.endTime : endTime;
        return endTime;
    }
