...
contract PASSIVEINCOME is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private RewardToken =
        address(0x77c21c770Db1156e271a3516F89380BA53D594FA); // BUSD Testnet RewardToken

    uint256 public swapTokensAtAmount = 2 * 10**5 * (10**18);
    uint256 public maxBuyAmount = 1 * 10**6 * 10**18; // 1 000 000
    uint256 public maxSellAmount = 1 * 10**3 * 10**18; // 1 000
    uint256 public maxWalletAmount = 1 * 10**7 * 10**18; // 10 000 000

    address public marketing = address(0x1D96c39B930456Fa155DaEF7edBF931e6cCA6CDb);
    address public dev = address(0x1D96c39B930456Fa155DaEF7edBF931e6cCA6CDb);
    address public giveAway = address(0x1D96c39B930456Fa155DaEF7edBF931e6cCA6CDb);
    ...
    constructor() ERC20("PASSIVE INCOME", "PSI") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000000 * (10**18); //must hold 20000+ tokens
    }
