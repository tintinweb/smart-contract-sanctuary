...
contract PackageNFT is ERC721URIStorage {
    address public ownerPackage;
    constructor() ERC721("PackageNFT", "PACK") {
        ownerPackage = msg.sender;
    }
    mapping(address => bool) public miner;
    function createOrEditMiner(address _address) public {
        require(msg.sender == ownerPackage, 'You are not a owner');
