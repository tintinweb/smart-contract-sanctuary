...
contract EgonMigrate {
    ...
    BEP20Interface public Egon1Address=BEP20Interface(0xFd8Ab035fCc96c3133e08527045ee55b038Cb594);
    BEP20Interface public Egon2Address = BEP20Interface(0x0AAc6b63b5Bdb113924D6127A9E3c737945fFe9d);
	...
	event buyEAN(address indexed user, uint256 tokens);
    ...
    function exchange(uint256 amount) public payable
    {
        ...
        emit buyEAN(userAddress,amount); 
