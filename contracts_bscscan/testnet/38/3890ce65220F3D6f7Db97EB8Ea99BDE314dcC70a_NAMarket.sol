  ...
  */
  function createAuction(address _contractAddress, uint256 _tokenId, uint256 _startingPrice,
    ...
    returns(uint256 auctionId){
      ...
      auctions[auctionId] = Auction(_contractAddress, _tokenId, _startingPrice, _buyNowPrice, msg.sender, address(0), AuctionStatus.OPEN, expiryDate, auctionId, tokenType, quantity);
      //Approval of ownership rights for sale
      IERC721(_contractAddress).isApprovedForAll(msg.sender, address(this));
