...
// CHANGE
contract Testie1 is IERC20, Ownable {                                                                             //!\ CHANGE THE NAME OF THE CONTRACT (example put the name of the token)
    using SafeMath for uint256;
    ...
    string constant _name = "Testie1";
    string constant _symbol = "Testie1";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 4% MAX 40,000,000
