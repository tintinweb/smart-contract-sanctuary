...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CAKE = IERC20(0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5);
...
contract CandyCake is IERC20, Ownable {
    ...
    address CAKE = 0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    function setTxLimit(uint256 amount) external onlyOwner {
        _maxTxAmount = amount * 10 ** _decimals; //percent
    }
