...
contract NftpadFarmingPool is ReentrancyGuard, Ownable {
    ...
    function setRewardsToken(address rewardToken_) public onlyOwner {
        rewardsToken = IERC20(rewardToken_);
    }

    function setNftPad(address nftPad_) public onlyOwner {
        nftPad = NftPad(nftPad_);
    }
...
contract NftPad is Ownable, Pausable {
    ...
    mapping(address => uint256) public stakeToken; //rate point
