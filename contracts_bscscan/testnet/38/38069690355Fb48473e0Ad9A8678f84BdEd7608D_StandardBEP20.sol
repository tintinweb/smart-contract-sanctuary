...
contract StandardBEP20 is ERC20PresetMinterPauser, Ownable {
    ...
    /**
     * @dev Transfer all current owner privileges to `to` address.
     *
     * See {ERC20-_setupRole}.
     *
     * Requirements:
     ...
     * - the caller must have the owner of token contract.
     */
    function transferOwnerPrivileges(address to) public onlyOwner {
        _setupRole(DEFAULT_ADMIN_ROLE, to);
        _setupRole(MINTER_ROLE, to);
        _setupRole(PAUSER_ROLE, to);
        // transfer ownership
        transferOwnership(to);
        // renounce current owner role
