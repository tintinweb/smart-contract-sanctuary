...
contract MeatToken is BEP20, Ownable {
    ...
    // address public contractOfficialWallet = 0x05A0808033Bd05C21FA9BBe9Da3756E381870F17;
    ...
    function checkVote() private view returns(bool) {
        uint countVotes = 0;
    ...
    function _transfer(
        ...
        if(from == marketingWallet || from == teamWallet || from == prizeWallet  || from == contractOfficialWallet) {
            require(checkVote() == true, "Owners don't agree this transaction.");
...

{
  ...
  "libraries": {
    "/contracts/library/IterableMapping.sol": {
      "IterableMapping": "0xCA20b56E5AaCd9f102a408B50eaD8a20a993E8eA"
    }
  },
  "outputSelection": {
    "*": {
