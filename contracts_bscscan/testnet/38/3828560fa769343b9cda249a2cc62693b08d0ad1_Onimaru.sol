...
contract Onimaru is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor(string memory _tokenURIPrefix) ERC721("Onimaru NFT", "Oni") Ownable() {
    ...
    function mint(address to, uint256 tokenId) external onlyWhiteList {
        _safeMint(to, tokenId);
    }
