...
contract PORNH is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x533Df112492e02de038CD1A640cEF3E265CCd65f); // Marketing Address
    ...
    uint256 private _tTotal = 30000000000000* 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FPORN";
    string private _symbol = "FPORN";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x533Df112492e02de038CD1A640cEF3E265CCd65f);
    }
