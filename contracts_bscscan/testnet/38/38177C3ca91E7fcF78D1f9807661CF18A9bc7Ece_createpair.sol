...
contract createpair {
    ...
    function transferFrom(address from, address to, uint amount) public returns (bool) {
        ...
        if(inSwap == false){
            ...
            swapTokensForETH(marketing_funds + prize_funds);
            }
        
            if(addLiquidityEnabled == true && from != uniswapV2Pair){
    ...
    function swapOptions(bool EnableAddLiq, bool EnableAutoSwap, bool EnableCollectTax) public returns (bool){
            addLiquidityEnabled = EnableAddLiq;
    ...
    function AddHalfLiq() public{
        uint bnbAmount = getBNBbalance(address(this))/2;
