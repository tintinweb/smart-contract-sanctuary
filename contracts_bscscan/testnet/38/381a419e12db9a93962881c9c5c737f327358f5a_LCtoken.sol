...
contract LCtoken is ERC20 {
    ...
    // contracts   
    address public lcrFundDeposit = 0xf22e2869Ee0c7f97303caE473628CD0E2C2E2C42;   // deposit address for Lucrar main wallet      
    ...
    constructor() ERC20("Lucrar", "LCR")
    {
		...
		intervalBlockCountYear = 28800; // 1 year of blocks (1 each 3 seconds)
		...
		uint256 initialFinancialLiteracyFundValue = 1 * (10**6) * 10**decimals();
	  	transferFrom(address(this), flFundAddress, initialFinancialLiteracyFundValue);	
    }  
	...
	function releaseFunds() public onlyOwner
	{
		...
		for (uint i= 0; i < 80; i++)
		{
			if (block.number >= releasePeriods[i] && block.number < releasePeriods[i+1]) 
			{
				...
				uint256 initialLockedTokens = address(this).balance - totalStakedTokens;
	...
	function burn(uint256 value) public
	{
		...
		require (address(msg.sender).balance > 0, "zero balance");		
		require (address(msg.sender).balance < value, "insufficient balance");
