...
contract Maharaja is Context, IERC20, Ownable, Pausable 
{
    ...
    string private _name = "Maharaja";
    string private _symbol = "Maharaja";
    ...
    address payable public developerWallet =  payable(0xc85bFE12db63992F2c0Bd32654c1A406766A1888);
    ...
    constructor () 
    {
        ...
        _isExcludedFromWhale[developerWallet]=true;
    ...
    {
        uint256 balZeroWallet = balanceOf(0x000000000000000000000000000000000000dEaD);
        uint256 balDeadWallet = balanceOf(0x0000000000000000000000000000000000000000);
    ...
    {  
        ...
        return totalAmount.mul(_liquidityFee.add(_developerFee)).div(100);
    }
    ...
    {
        uint256 allFee = _liquidityFee.add(_developerFee);
        ...
        developerWallet.transfer(newBalance.sub(ethForLiquidity));
    }
    ...
    {
        developerWallet = payable(newWallet);
    }    
