...
contract BELT is ERC20, Ownable {
    ...
    uint256 public initialSupplyRemaining;
    address public initialSupplyClaimer;
    uint256 public startBlockMining;
    uint256 public BELTPerBlock = 1178000000000000000;
    ...
    constructor(
        ...
        address initialSupplyClaimer_,
        uint256 startBlockMining_
    ...
    function claimInitialSupply(uint256 _amount) public {
        require(
            msg.sender == initialSupplyClaimer,
            "msg.sener has no authority"
        );
        require(
            initialSupplyRemaining >= _amount,
            "_amount exceed an allowance"
        );
    ...
    function getCirculatingSupply() public view returns (uint256) {
        uint256 circulatingSupply = initialSupply - initialSupplyRemaining;

        if (block.number > startBlockMining) {
            circulatingSupply =
                circulatingSupply +
                (block.number - startBlockMining) *
                BELTPerBlock;
        }
