...
contract Wojak is ERC20, Ownable {
	...
	uint256 public maxTxAmount = 25000000000 * 10**9;
	uint256 public maxWalletAmount = 50000000000 * 10**9;
    ...
    function setBuyBUSDRewardsFee(uint256 value) external onlyOwner{
        ...
        totalBuyFees = buyBUSDRewardsFee.add(buyMarketingFee).add(buyCharityFee).add(buyLiquidityFee);
    }
	...
	function setSellBUSDRewardsFee(uint256 value) external onlyOwner{
        ...
        totalSellFees = sellBUSDRewardsFee.add(sellMarketingFee).add(sellCharityFee).add(sellLiquidityFee);
    }
...
contract WOJDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("WOJ_Dividen_Tracker", "WOJ_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 50000000 * (10**9); //must hold 50000000+ tokens
    }
