...
contract SonOfGrinch is Context, IERC20, Ownable {
   using SafeMath for uint256;
   using Address for address;
  
   address payable private marketingWallet = payable(0x96dD2F8A8Aa814faB068AC940B09F81E7510307C); // Marketing Wallet
   address payable private ecosystemWallet = payable(0xd592849d7EC2C1dE11B903A66eAdD4F455591094); // Ecosystem Wallet
   address payable private devWallet = payable (0x7876BD0fFe5783D0F4e1B3664a849288605B3290); // dev Wallet
   ...
   string private _name = "SonOfGrinch";
   ...
   uint256 public _sellMarketingFee = 50;  //4%
   uint256 public _sellDevFee = 20;   //1%
