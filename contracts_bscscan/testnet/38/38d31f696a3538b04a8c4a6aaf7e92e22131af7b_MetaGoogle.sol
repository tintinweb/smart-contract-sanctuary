...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
...
contract MetaGoogle is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Mgtest";
    string constant _symbol = "Mgtest";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address RewardToken = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _walletMaxToken = _totalSupply;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x99cA69148DAE2Fc9C3196BB95E9571EA188f9B87;
        marketingWallet = 0x99cA69148DAE2Fc9C3196BB95E9571EA188f9B87;
        devWallet = 0x99cA69148DAE2Fc9C3196BB95E9571EA188f9B87;
    ...
    function setwalletMaxPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _walletMaxToken = (_totalSupply * maxWallPercent_base1000 ) / 1000;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingWallet && recipient != autoLiquidityReceiver && recipient != devWallet){
            uint256 heldTokens = balanceOf(recipient);
            require((heldTokens + amount) <= _walletMaxToken,"Total Holding is currently limited, you can not buy that much.");}
        
        if (recipient == pair &&
            sellCooldownEnabled &&
            !isTimelockExempt[sender]) {
            require(cooldownTimer[sender] < block.timestamp,"Please wait for cooldown between sells");
