...
contract ClaimSeedSale is Ownable{
    ...
    uint256 public releaseTime = 1642345200;
    ...
    function withdrawtoken(address _to, uint256 _amount) external onlyOwner{
        require(token.balanceOf(address(this)) >= _amount, "Not enough MGT");
    ...
    function claim() external{
        ...
        if(amount > 0){
            require(token.balanceOf(address(this)) >= amount, "Not enough MGT");
            // reward stake
