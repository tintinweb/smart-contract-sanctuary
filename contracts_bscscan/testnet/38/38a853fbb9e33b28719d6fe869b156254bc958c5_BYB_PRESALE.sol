...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function buyTokens(address beneficiary) public nonReentrant payable {
        ...
        if(tokens >= 5000000000000000000000000){
            _processPurchase(beneficiary, tokens.add(1000000000000000000000000));
        }
        else{
    ...
    function _processPurchase(address beneficiary, uint256 tokenAmount) internal {
        ...
        //   _deliverTokens(beneficiary, tokenAmount.add(1000000));  
        // }
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        if(weiAmount == 5000000000000000000){
             return weiAmount.add(1000000000000000000).mul(_rate);
        }
