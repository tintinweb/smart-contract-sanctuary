...
contract EPCommonNFTStore is OwnableOperatorRole, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function createSale (uint itemId) public nonReentrant {
        ...
        EPCommonNFT(address(_itemSales[_saleId].nftContract)).mint(msg.sender, 1);
