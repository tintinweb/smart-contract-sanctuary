...
contract ThetanBoxHub is Ownable, Initializable {
    ...
    constructor(address _paymentReceivedAddress) {
    ...
    function buyBoxWithSignature(
        ...
        // Transfer payment
        paymentToken.transferFrom(userAddress, paymentReceivedAddress, price);
        // Emit payment event
