...
contract JBLNFT is ERC721{
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory tokenURI = "https://emoceanx.i-recu.com/nft/event/JBL-fireW.png";
        ...
        _setTokenURI(cardId, "https://ipfs.io/ipfs/QmNscPEgHiWWS7tUcXCD1YuHfHFtbnxRx7LJGcxxqcptQf?filename=test_1.json");
