...
contract Migrate is ReentrancyGuard, Context, Ownable{
    ...
    address public immutable deadWallet = 0x620BbA4FD3847c1D4A1EF8c2288a307391E668A6;
    ...
    function withdrawAllTokens() external onlyOwner{
        uint256 amount = tokenV2.balanceOf(address(this));
        tokenV2.transfer(msg.sender, amount);
    }
    ...
    function migrateToV2() public {
        ...
        uint256 amtToMigrate = userV1Balance.div(rate);
