...
contract REDEFI_Token is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 1000; // 1000 = 10%
    uint256 public _charityFee = 200; // 200 = 2%
    uint256 public _liquidityFee = 300; // 300 = 3%
    uint256 public _marketingFee = 200; // 200 = 2%; 
    uint256 public _burnFee = 300; // 300 = 3; 
    ...
    address public charityAddress = 0x57FABB0F1729145C2b5dD0557CA65B9A36218F2f; // Charity Address
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        uint256 charityFee = amount.mul(_charityFee).div(20000);
        uint256 liquidityFee = amount.mul(_liquidityFee).div(30000);
        uint256 taxFee = amount.mul(_taxFee).div(100000);
        uint256 marketingFee = amount.mul(_marketingFee).div(20000); 
        uint256 burnFee = amount.mul(_burnFee).div(30000);
