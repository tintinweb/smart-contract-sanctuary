 ...
 */
contract SwapV2 is ISwap, SwapCore, AccessControlEnumerable, ReentrancyGuard {
    ...
    */
    ...
    function addSwap(address itemToken_, uint256 fee_, uint256 supply_) external onlyRole(ADMIN_ROLE) {
        ...
        swapMetadata[_swapCounter.current()] = SwapStorage.Core(core.currencyToken, core.itemToken, core.fee, core.supply, core.issued, core.isEnabled, core.exists, core.isEtherSwap);
        _swapCounter.increment();
    }
