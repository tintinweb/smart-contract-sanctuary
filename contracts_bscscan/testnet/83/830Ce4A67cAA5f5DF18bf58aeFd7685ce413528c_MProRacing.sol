...
contract MProRacing is Ownable {
     ...
     */
    address public tokenAddress = 0x1C5855891FFdB05644aa62DA6BD61ae86D4F1b98;
    ...
    function retrieveRoomId(address _creator) public view returns (uint256) {
        return creatorRooms[_creator][creatorRooms[_creator].length - 1];
    }
