...
// Root file: contracts/test/ERC1155Mock.sol
...
contract ERC1155Mock is AbstractFeeAuction, ERC1155("https://example.com/") {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155, AbstractFeeAuction) returns (bool) {
        return super.supportsInterface(interfaceId);
    }
}