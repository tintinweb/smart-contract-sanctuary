...
$SHILLING Token from Knights DeFi

$SHILLING is a Secure Moonrat Token fork with bug fixes and additional anti-bot / anti-whale features added

Earn claimable BNB by holding!  Earn SHILLING by participating in Knights DeFi's unique Battlefield feature.  Use Shilling to play games and win tokens! 
...
This will be exposed through the front page UI @ https://www.knightsdefi.com.  
...
Website: https://www.knightsdefi.com
Telegram: https://t.me/KnightsOfTheRoundBSCChat
Twitter: https://twitter.com/Knightsbsc
Readme: https://docs.knightsdefi.com

Forked and enhanced by Sir Tristan of Knights Defi
...
contract Shilling is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Shilling Token";
    string private _symbol = "SHILLING";
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'claimBNBReward:: Error: must own SHILLING to claim reward');
