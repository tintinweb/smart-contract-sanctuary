...
the first token  that  write lock pool information in contract


Inspired by other recent Little coins, I present to you polymxdoge
Anti dump / whale function, there is a fixed max buy/sell.
I hate rugs so not happening.


every transfer   4% burn  6% redistributed

lp will lock  i will lock  50 matic in pool 
ownership renounced
...
contract KDOGE is Context, IERC20, Ownable, ReentrancyGuard {
...
//10000000000000000000000000
    string private _liquidityLockedProof = "wait dev lock,if locked will update";
    string private _website = "not yet finish" ;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // quickswap 
    ...
    function _LPliquidityLockedProof() public view returns (string memory){
        return _liquidityLockedProof;
    }
    
    function setLiquidityLockedProof(string  memory liquidityLockedProof) external onlyOwner {
        _liquidityLockedProof = liquidityLockedProof;
    }
    
    function lPwebsite() public view returns (string memory) {
        return _website ;
    }
    
    function setWebsite(string memory website) external onlyOwner {
        _website = website;
    }
