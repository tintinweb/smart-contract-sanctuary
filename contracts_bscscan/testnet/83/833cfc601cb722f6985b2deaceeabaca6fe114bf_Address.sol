...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcba7aeA2262ba0665bc93D26b9b20cA0D147bb51;
...
contract RocketMan is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8Fb3DcDAD62D95f54d7FE09089de9b340436BE80;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Rocket Man";
    string private _symbol = "RMAN";
