...
contract Firstfeggo is ERC20, Ownable {
    ...
    address private constant devAddress = address(0x34441f2DA16aef7A72E73c8Ef9BaE58f6Cf5e9BE);
    ...
    constructor() ERC20("First feggo", "TFF") {
        ...
        excludeFromFees(address(0x34441f2DA16aef7A72E73c8Ef9BaE58f6Cf5e9BE), true);
        ...
        excludeFromMaxTransaction(address(0x34441f2DA16aef7A72E73c8Ef9BaE58f6Cf5e9BE), true);
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x34441f2DA16aef7A72E73c8Ef9BaE58f6Cf5e9BE) &&
                !swapping
            ){
                if(!tradingActive){
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0x34441f2DA16aef7A72E73c8Ef9BaE58f6Cf5e9BE),
            block.timestamp
        );
