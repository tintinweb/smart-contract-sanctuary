...
contract ADMIRE_Content_Coin is BEP20('ADMIRE Content Coin', 'ADMIRE'){
    ...
    * Can only be called by the current operator.
    */
    function transferContractAddress(address newContractAddress) public onlyOwner {
        require(newContractAddress != address(0), "ADMIRE::transferContractAddress: contract cannot be the zero address");
