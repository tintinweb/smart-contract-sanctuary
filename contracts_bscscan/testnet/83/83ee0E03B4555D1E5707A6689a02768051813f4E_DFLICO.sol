...
contract DFLICO  {
	...
	function withdraw() public payable 
	{
        ...
        uint256 totalToken=users[msg.sender].freeStakedToken+(withdrawalAmount.div(tokenPrice))+(users[msg.sender].levelBonus.div(tokenPrice));
	...
	function updateTokenPrice(uint8 _type) private
	{
	   ...
	   else
	   {
	     while(true)
	     {
	         uint256 tempPrice=(tokenPrice*priceDecPercent)/1000000;
	         tokenPrice=tokenPrice-tempPrice;
