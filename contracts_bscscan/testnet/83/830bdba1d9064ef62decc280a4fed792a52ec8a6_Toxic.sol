...
contract Toxic is Context, IERC20, Ownable {
    ...
    address payable public _buybackWallet = payable(0xB83CF0D9F9f375A1a4E936927ce4E657623C7e47);

    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public _maxTx = 10 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 _totalFees= _liquidityFee.add(_buybackFee);
        uint256 lpPart = contractTokenBalance.mul(_liquidityFee).div(_totalFees);
        uint256 buybackPart = contractTokenBalance.sub(lpPart);
