...
contract BuyBack {
    ...
    /**
     * @notice Function to buy and burn Dimirai reward token
    ...
    function buyAndBurnToken(
        ...
        if (_wantAdd != _rewardToken) {
            ...
            IERC20(_wantAdd).safeIncreaseAllowance(0x610178dA211FEF7D417bC0e6FeD39F05609AD788, _wantAmt);
            _path = [_wantAdd, _rewardToken];

            IPancakeRouter02(0x610178dA211FEF7D417bC0e6FeD39F05609AD788)
