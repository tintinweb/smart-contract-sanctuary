...
contract DmiraiVaultsStrategyAlpaca is Ownable, ReentrancyGuard, Pausable {
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "DmiraiVaultsStrategyAlpaca: caller is not the operator");
        _;
    }
    ...
    modifier onlyStrategist() {
        require(
            ...
            "DmiraiVaultsStrategyAlpaca: caller is not the strategist"
        );
        _;
    }

    modifier strategyRunning() {
        require(!strategyStopped, "DmiraiVaultsStrategyAlpaca: strategy is not running");
        _;
    }
    ...
    function setEntranceFeeFactor(uint256 _entranceFeeFactor) external onlyOperator {
        require(_entranceFeeFactor > entranceFeeFactorLL, "DmiraiVaultsStrategyAlpaca: !safe - too low");
        require(_entranceFeeFactor <= entranceFeeFactorMax, "DmiraiVaultsStrategyAlpaca: !safe - too high");
    ...
    function setControllerFee(uint256 _controllerFee) external onlyOperator {
        require(_controllerFee <= controllerFeeUL, "DmiraiVaultsStrategyAlpaca: too high");
    ...
    function withdraw(address, uint256 _wantAmt) public onlyOwner nonReentrant returns (uint256) {
        require(_wantAmt > 0, "DmiraiVaultsStrategyAlpaca: !_wantAmt");
    ...
    function earn(uint256 _amountOutAmt, uint256 _deadline) public whenNotPaused {
        require(isAutoComp, "DmiraiVaultsStrategyAlpaca: !isAutoComp");
        require(!notPublic || isAuthorised(msg.sender), "DmiraiVaultsStrategyAlpaca: !authorised");
