...
/**
         _____ ______ _   _ _______ _    _ _____  _____ ____  _   _ 
 *      / ____|  ____| \ | |__   __| |  | |  __ \|_   _/ __ \| \ | |
 *      | |    | |__  |  \| |  | |  | |  | | |__) | | || |  | |  \| |
 *      | |    |  __| | . ` |  | |  | |  | |  _  /  | || |  | | . ` |
 *      | |____| |____| |\  |  | |  | |__| | | \ \ _| || |__| | |\  |
 *      \_____|______|_| \_|  |_|   \____/|_|  \_\_____\____/|_| \_|
 *
 *     - Total supply 100 tokens
 *     - Max transaction 0.2 token
 *     - Max Wallet 2 tokens
 *     - 5 Minute sell cooldown
 *     - 12% fee ( 2% Reflections // 6% Burn // 4% Liquidity )
 *
 *      Made with <3 PoC
 */
...
contract Centurion is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    /* Token name */
    string private _name = "Century";
    string private _symbol = "CENTU";
