...
contract Lottery is Ownable, Initializable {
    ...
    function buyTickets(uint256 _lotteryId, uint256 _numberOfTickets, bool benefits) external  {
        ...
        uint256 numberOfTickets = benefits == true ? 2*_numberOfTickets : _numberOfTickets;
        ...
        ticketsSold[_lotteryId] = ticketsSold[_lotteryId].add(numberOfTickets);
        ...
        emit TicketPurchased(msg.sender, _lotteryId, numberOfTickets);
    }
    ...
    function SaveNFTContainers(address user, bool _contains) external onlyOwner(){
        containsNFT[user] = _contains;
    }
}
