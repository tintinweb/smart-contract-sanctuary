...
contract HeroesNFT is ERC721, ERC721Enumerable, Pausable, AccessControl {
    ...
    function addHeroesNumber(uint256 tokenId, uint256 _heroesNumber, string memory name, string memory race, string memory class, string memory tier, string memory tierBasic) public onlyRole(MINTER_ROLE) {
        // heroesNumber[tokenId] = HeroesInfo;
        heroesNumber[tokenId].heroesNumber = _heroesNumber;
        heroesNumber[tokenId].name = name;
        heroesNumber[tokenId].race = race;
        heroesNumber[tokenId].class = class;
        heroesNumber[tokenId].tier = tier;
        heroesNumber[tokenId].tierBasic = tierBasic;
        heroesNumber[tokenId].uri = tokenURI(tokenId);
    }
