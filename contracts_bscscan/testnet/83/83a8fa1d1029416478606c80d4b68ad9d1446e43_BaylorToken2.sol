...
contract BaylorToken2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7A47175520A97AeB5Fa3568C254D45aA05800670); // Marketing Address
    ...
    string private _name = "BaylorToken2";
