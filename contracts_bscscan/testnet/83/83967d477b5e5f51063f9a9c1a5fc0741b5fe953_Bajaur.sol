...
contract Bajaur is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BAJAUR";
    string constant _symbol = "BJR";
    ...
    constructor () Auth(msg.sender) {
        //router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); live router address
        router = IDEXRouter(0x73D58041eDdD468e016Cfbc13f3BDc4248cCD65D); //testnet router address
