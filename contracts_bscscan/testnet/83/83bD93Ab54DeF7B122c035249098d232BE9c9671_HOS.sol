...
contract HOS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    address public burnAddress = address(0x6cD8b8F12Da961E36898a7601ec7ab1A1D21bdbe);

    address public tribeAddress = address(0xA57CCAAB5f233Cea91Fc77dc0d675b11683945fa);

    address public liquifyAddress = address(0xf6cB007930e823412A991786C0fa1D32Ef02B7D4);
    ...
    function _transfer(
        ...
        if(isPair[to]){
            ...
            if(tribeAmount>0){
                toAmount = toAmount.sub(tribeAmount);
            }
            emit SellFee(tribeAmount, block.timestamp);
        }
