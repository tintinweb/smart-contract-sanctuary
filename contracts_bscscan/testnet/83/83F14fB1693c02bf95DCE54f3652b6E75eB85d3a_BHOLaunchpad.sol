...
contract BHOLaunchpad is Ownable, Pausable, Whitelist, SharedConstants {
        ...
        returns (uint256 amount, uint256 claimAt)
    {
        ...
        // check it's time to claim with index vesting timeline
        uint256 percent = vestingTimeline.percents[index];
        uint256 timestamp = vestingTimeline.timestamps[index];
    ...
    function emergencyWithdraw() external {
        ...
        require(
            ...
            "CoinTapLaunchpad: Launchpad is finalized"
        );
