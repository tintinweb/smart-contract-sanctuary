...
contract SpacePort is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "SpacePortCoin";
    string private constant _symbol   = "SPC";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 500; // 3% of every transaction is redistributed to holders
