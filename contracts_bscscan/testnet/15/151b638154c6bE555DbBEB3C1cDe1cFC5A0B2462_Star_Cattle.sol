...
contract Star_Cattle is ERC721Enumerable, Ownable {
    ...
    function mint(address player) public {
        ...
        if (cowInfoes[currentId].gender == 1) {
            ...
            emit BornCreationBull(player, currentId, creationAmount,cowInfoes[currentId].life, cowInfoes[currentId].energy, cowInfoes[currentId].growth,deadTime[currentId], cowInfoes[currentId].attack, cowInfoes[currentId].defense, cowInfoes[currentId].stamina);

        } else {
            cowInfoes[currentId].milk = 86 + rand(14);
            cowInfoes[currentId].milkRate = 86 + rand(14);
            emit BornCreationCow(player, currentId, creationAmount, cowInfoes[currentId].life, cowInfoes[currentId].energy, cowInfoes[currentId].growth,deadTime[currentId], cowInfoes[currentId].milk, cowInfoes[currentId].milkRate);
        }
