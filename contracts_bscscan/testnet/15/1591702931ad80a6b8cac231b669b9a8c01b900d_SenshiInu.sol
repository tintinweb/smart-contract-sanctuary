...
contract SenshiInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1200000000000000000000000 * 10**_decimals;
    ...
    address public mainAddress      = 0x7E4BC2e329A836D658fEd8ae8DCDE9A0F72DeC8E;
    address public deadAddress      = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet  = 0xCd90bF73b57D291E97121e1Ad6Cc98A0392079CD;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50000000000000000 * 10**_decimals;
    ...
    function setMainWallet(address _address) public onlyOwner {
         mainAddress = _address;
        
    }

    
    function setSwapWallet(address _address) public onlyOwner {
         uniSwapAdress = _address;
