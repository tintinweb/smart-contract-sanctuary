...
/**
   #BOLFSWAP(BOLF)
   2% fee auto add to the liquidity pool to locked forever when sellin
   3% fee auto distribute to all holders
   5% fee auto moved to owner wallet
*/
...
contract Scarlet is Context, IERC20, Ownable {
