...
contract Brn is ERC20, Ownable {
    ...
    constructor() public ERC20("BRN", "BRN") {
        liquidityWallet = address(0x9EDEB63656E3A02e89659f681a119902c1b19106);
    	marketingWallet = address(0x9EDEB63656E3A02e89659f681a119902c1b19106);
    	salaryWallet = address(0x9EDEB63656E3A02e89659f681a119902c1b19106);
    	buyBackWallet = address(0x9EDEB63656E3A02e89659f681a119902c1b19106);
...
contract BRNDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("BRN_Dividend_Tracker", "BRN_Dividend_Tracker") {
    	claimWait = 3600;
