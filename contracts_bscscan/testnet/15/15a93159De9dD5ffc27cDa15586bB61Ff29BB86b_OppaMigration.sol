...
import "./OPPAToken.sol";

// development
import "hardhat/console.sol";

contract OppaMigration {
    using SafeMath for uint256;

    OPPAToken public tokenV2;
    address public owner;

    uint256 public availableToken;

    event Transfer(address _address, uint256 _amount);

    constructor() {
        owner = msg.sender;
    }

    function initialise(OPPAToken _tokenV2, uint256 _availabletoken)
        public
        onlyOwner
    {
        tokenV2 = _tokenV2;
    ...
    function _transfer(uint256 _amount) internal {
        OPPAToken(tokenV2).transfer(msg.sender, _amount);
    }
...
The first Korean-inspired fan-based cryptocurrency | Doxxed Developers | First of it’s kind | Mix Utilities

Telegram: https://t.me/OPPAtoken
Website: https://oppatoken.com/
...
contract OPPAToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 500000000000000 * 10**_decimals;

    address public marketingAddress =
        0x9F02531855Ed66a5a881E7f84A7679A1172451DE;
    address public operationsAddress =
        0x19bF6D7243396D2ee4B8aF58Ae27d84910e57edC;
    address public constant deadAddress =
        0x000000000000000000000000000000000000dEaD;

    string private constant _name = "OPPA Token";
    ...
    function _tokenTransfer(
        ...
        emit Transfer(
            sender,
            address(this),
            s.tLiquidity + s.tOperations + s.tBurn
        );
