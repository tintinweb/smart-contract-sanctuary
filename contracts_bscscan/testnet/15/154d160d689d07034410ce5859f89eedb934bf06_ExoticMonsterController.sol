...
contract ExoticMonsterController is Ownable {
    ...
    constructor() {
        ...
        EMC20.transfer(address(0x385D80C57E047332076408431027Ffa659562F0b),1500000 * 10 ** 18);
    ...
    function selectBox(uint256 boxId) public {
        ...
        if(1 == boxId && box1MaxTimes > 0){
            ...
            EMC20.transferFrom(msg.sender,address(this),5000 * 10 **18);
        ...
        if(3 == boxId && box3MaxTimes > 0){
            ...
            EMC20.transferFrom(msg.sender,address(this),22500 * 10 **18);
