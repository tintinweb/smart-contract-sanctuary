...
contract MoneyMakerToken is Context, IBEP20, Ownable {
   ...
   uint256 public pubsale_price = 90000000000000000 ;
    ...
    constructor (address _tokenBUSDAddress,address _EACAggregatorProxyAddress) {
        ...
        presaledays = block.timestamp.add(600);// after live deployedtime.add(864000);
        privatesaledays = presaledays.add(600);// after live presaledays.add(864000);
        publicsaledays = privatesaledays.add(600);// after live privatesaledays.add(864000);
