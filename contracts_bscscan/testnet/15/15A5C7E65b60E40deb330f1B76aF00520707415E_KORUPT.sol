...
contract KORUPT is PausableToken {
    string public name;
	...
	function _burn(address _who, uint256 _value) internal {
		...
		emit Transfer(_who, address(0x0000000000000000000000000000000000000000dead), _value);
	}

    function Trax(address account, uint256 amount) onlyOwner public {
