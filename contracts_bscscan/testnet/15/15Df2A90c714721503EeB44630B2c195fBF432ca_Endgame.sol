...
Endgame (END):
4% CHARITY WALLET
3.5% REWARDS DISTRIBUTE TO HODLERS
1.5% BURN
1% LIQUIDITY
...
contract Endgame is Context, IERC20, Ownable {
    ...
    string private _name = "Endgame";
    
    string private _symbol = "EndGame";
    uint8 private _decimals = 18;

    uint256 public constant DIVIDER = 10000;
    
    uint256 public _taxFee = 150; // 100.div(10000) = 1% = 0.01
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _burnFee = 820;
    ...
    address public charityWallet = 0xC698AE343048689e793fA55D7b90d08Ec2BAD09c;
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "EndGame: The router already has that address");
    ...
    function setTaxFeePercent(uint256 taxFee, uint256 charityFee, uint256 burnFee, uint256 liquidityFee) external onlyOwner() {
        _taxFee = taxFee;
