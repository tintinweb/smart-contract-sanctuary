...
contract ZaiFighting is Ownable, ERC721Holder {
    ...
    struct stats {
        uint256 monsterTotalWins;
        uint256 monsterTotalDraw;
        uint256 monsterTotalLoss;
        uint256 monsterTotalFights;
        uint256 monsterTotalRandomSelected;  
    }

    mapping(uint256 => stats) _monsterStats;
    ...
    function getMonsterStats(uint256 _monsterId) external view returns(
        uint256 monsterTotalWins,
        uint256 monsterTotalDraw,
        uint256 monsterTotalLoss,
        uint256 monsterTotalFights,
        uint256 monsterTotalRandomSelected){
            stats storage s = _monsterStats[_monsterId];
            return(     
                s.monsterTotalWins,
                s.monsterTotalDraw,
                s.monsterTotalLoss,
                s.monsterTotalFights,
                s.monsterTotalRandomSelected);
        }
    ...
    function _updateCounterWinLoss(
        ...
        stats storage p1 = _monsterStats[_monsterId];
        stats storage p2 = _monsterStats[_toReturn[0]];
        p1.monsterTotalFights = p1.monsterTotalFights.add(1);
        p2.monsterTotalFights = p2.monsterTotalFights.add(1);
        p2.monsterTotalRandomSelected= p2.monsterTotalRandomSelected.add(1);
        ...
        if(_toReturn[1] > _toReturn[2]){
            ...
            p1.monsterTotalWins = p1.monsterTotalWins.add(1);
            ...
            p1.monsterTotalDraw= p1.monsterTotalDraw.add(1);
            return true;
        }else if(_toReturn[2] > _toReturn[1]){
            p1.monsterTotalLoss = p1.monsterTotalLoss.add(1);
            return true;
        }
    }
