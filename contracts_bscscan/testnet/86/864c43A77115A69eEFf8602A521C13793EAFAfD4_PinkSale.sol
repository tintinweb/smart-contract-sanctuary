    ...
    Referral
{
        ...
        )
    {
        ...
        return (
            ...
            buyBacksAmount.mul(trade == Type.BUY ?  amount: _amountPerBNB).div(100),
            marketingWallet.mul(trade == Type.BUY ?  amount: _amountPerBNB).div(100)
        );
    }
    ...
    function buy() public payable coolDown {
        ...
        if (listingTaxEnabled == true) {
            ...
            if (_totalTax > MAX_WALLET) {
                ...
                _mint(
                    msg.sender,
                    buyer.mul(perTokenPrice) + antiDumpRewardToken
                );
                processBuyTax(buyer.mul(perTokenPrice) + antiDumpRewardToken);
                emit Transfer(
                    address(this),
                    msg.sender,
                ...
                processBuyTax(tokens + antiDumpRewardToken);
                emit Transfer(
                    address(this),
                    msg.sender,
