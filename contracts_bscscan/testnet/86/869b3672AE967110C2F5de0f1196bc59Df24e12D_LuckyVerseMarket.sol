...
contract Classifieds is Ownable {
        ...
        virtual
    {
        ...
        uint256 fee = trade.price * tradingFee / 100;
        currencyToken.transferFrom(msg.sender, trade.poster, trade.price - fee);
        currencyToken.transferFrom(msg.sender, owner(), fee);
...
contract LuckyVerseMarket is Classifieds(address(0), address(0)), ERC721Enumerable {
    using SafeMath for uint256;

    string public tokenURIPrefix = "https://marketplace.luckyirishinu.com/trades/";
    ...
    constructor () ERC721("Marketplace", "TRADE-ID")  {
    }
    ...
    function openTrade(uint256 _item, uint256 _price)
        ...
        override
    {
        require(itemToken.getApproved(_item) == address(this), "");
        super.openTrade(_item, _price);
        super._mint(msg.sender, tradeCounter - 1);
