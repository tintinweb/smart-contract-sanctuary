...
abstract contract Pancake is Ownable {
    ...
    function swapAndAddLiquidity(uint256 tokens) internal {
...
LotteryHelper {
    ...
    LotteryHelper(_weeklyAddress, _daily, _hourly, _rewardToken) {
        ...
        initDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // testnet ropsten
    ...
    function callAfterDeployAndSetOwnersOnLotteryContract() external onlyOwner {
        ...
        setLotteryDrawThreshold(10**18, 10**18); // set the threshold for hourly and daily lottery contracts
    }
    ...
    function callAfterLiquidityIsAdded() external onlyOwner {
        ...
        setAutoBuybackEnabledAndThreshold(true, 10**17); // 0.1 BNB
    }
