...
contract PomeRocket is ERC20, Ownable {
    ...
    address public immutable REWARD = address(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca);
    ...
    address payable public marketingWalletAddress = 0xc17C07546288EBf566E97Cf932C1Bb239d718C8c;
    address payable public coreWalletAddress = 0xc17C07546288EBf566E97Cf932C1Bb239d718C8c;
    ...
    function swapAndSendDividends(uint256 bnbForDividends) private {
        swapBnbForReward(bnbForDividends);
        ...
        if (success) {
            dividendTracker.distributeREWARDividends(dividends);
