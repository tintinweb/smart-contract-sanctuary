...
contract rafflecastle is IBEP20, Auth {
    ...
    string constant _name = "bit20";
    string constant _symbol = "bit20";
    ...
    mapping (address => bool) public isEligibleRaffle;
    ...
    function checkHolder(address sender, address recipient) internal {
        if (sender == PCSpair &&
            balanceOf(recipient) <= minRaffle) {
            isEligibleRaffle[recipient] = true;
        }
    }
