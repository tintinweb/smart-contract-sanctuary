...
contract IHC_TEST is Context, IBEP20, Ownable {
    ...
    */
    ...
    function setExcludedAddressOfTransactionFee(address neweExcludedAddressTransactionFee)  public onlyOwner returns (bool) {
        if (_isExcludedTransactionFee[neweExcludedAddressTransactionFee] == false) {
            _isExcludedTransactionFee[neweExcludedAddressTransactionFee] = true;
            _excludedTransactionFee.push(neweExcludedAddressTransactionFee);
        }
        return true;
    }
