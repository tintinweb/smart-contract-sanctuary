 ...
 *   4%: add to liquidity pool
 *   4% : burns
 *   2.5% for awareness/marketing
 *  4.5% to dev and staff costs/marketing
 * 
 * 
 */
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "DinoToken2";
    string internal constant SYMBOL = "DNO2";
    ...
    address internal charityAddress = 0x29D9A1C688DdfF8Fb9B470B0C1200BB0c5b9F7a7;
    address internal marketingAddress = 0x9Af651bB1dCe0A1D153EB89F8091cC6d982BE7c5;
    uint256 public _MarketingFee = 45;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Burn, _BurnFee, burnAddress );
        _addFee(FeeType.Liquidity, _LiquidityFee, address(this) );
        _addFee(FeeType.External, _CharityFee , charityAddress );
        _addFee(FeeType.External, _MarketingFee, marketingAddress );
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    // PancakeSwap V2
    //_mainnetRouterV2Address:0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    //testnetv2address:0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    address private _mainnetRouterV2Address = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
...
abstract contract EthToken is BaseRfiToken, Liquifier, Antiwhale {
...
contract Dino is EthToken{

    constructor() EthToken(Env.MainnetV2){
    ...
    function setmarketingWallet(address mWallet) external onlyOwner() {
        marketingAddress = mWallet;
    }
    
    function setcharityWallet(address wWallet) external onlyOwner() {
        charityAddress = wWallet;
    }
