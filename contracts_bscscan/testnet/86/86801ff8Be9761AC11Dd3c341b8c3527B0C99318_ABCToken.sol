...
contract ABCToken is Context, IERC20, Ownable {
    ...
    function setburnFeePercent(uint256 burnFee) external onlyOwner() {
        require (burnFee <= 10, 'burnFee should be in 0 - 10');
            _burnFee = burnFee;
    }
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256,uint256) {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, tLiquidity, tBurnFee, _getRate());
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tBurnFee,uint256 currentRate) private pure returns (uint256, uint256, uint256) {
