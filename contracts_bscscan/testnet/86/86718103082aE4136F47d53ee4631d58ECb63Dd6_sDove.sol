...
contract sDove is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Dove", "sDOVE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDOVE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDOVE
