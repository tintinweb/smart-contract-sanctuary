...
contract TestDoge is Context, IERC20, Ownable {
    ...
    uint256 private _maxTxAmount = 500000 * 10**6 * 10**9;            //500 Billion 
    uint256 private _maxTxDivisor = 2000;                             //500 Billion at launch
    ...
    function _transfer(
        ...
        if (justLaunched){
            if (block.timestamp <= launchTime.add(900)){          // minutes [0,15]
                ...
                maxTxAmount = 500000000000 * 10 ** 9;             // 500 billion max tx
