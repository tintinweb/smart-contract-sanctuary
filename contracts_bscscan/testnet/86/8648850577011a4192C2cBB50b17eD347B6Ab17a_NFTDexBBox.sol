...
contract NFTDexBBox is ERC721Full, ERC721MetadataMintable, Ownable {
  ...
  mapping (uint256 => bool) public adminOwner;
 ...
 // events
  ...
  function buyNFT(address nft_a,uint256 tokenId, address buyer) public returns (bool) {
        ...
        uint256 price;
        if(_tokenAuthors[tokenId] == 0x9b6D7b08460e3c2a1f4DFF3B2881a854b4f3b859 && adminOwner[tokenId] && adminDiscount > 0){
  ...
  require(msg.sender == 0x233f88644Bda03395eAf2517c3f0b71bCEE68D30,"Not Authorized");
  _;
  }
  function blindBox(address to, string calldata tokenURI, bool flag) blindBoxAdd external returns(uint256){
  uint256 tokenId;
  tokenId = mintWithTokenURI(to, tokenURI, 1, flag);
      tokenMapping[tokenURI].inserted = true;
      tokenMapping[tokenURI].commercialUse = flag;
  ...
  function transferOwnershipPack(address seller, address to, uint256 tokenId, string calldata ownerId) blindBoxAdd external returns (bool){
