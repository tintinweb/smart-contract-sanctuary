...
contract GreenHouse is Ownable {
    ...
    uint256 constant internal MONYHLY_POOL_TIMER = 24 hours; 
    ...
    uint256 constant internal BONUS_POOL_NEW_STAKEHOLDER_TIME_ADDITION = 15 minutes;
    uint256 constant internal BONUS_POOL_TIMER_INITIAL = 4 hours; // 6 hours
