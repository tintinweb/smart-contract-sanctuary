...
contract XyroldGame {  
    ...
    */
    ...
    function getOpenGameIDs() view external returns(uint[] memory ID){
        return OpenGamesID;
    }
    function getClosedGameIDs() view external returns(uint[] memory ID){
        return ClosedGamesID;
    }
