...
contract Token is Context, IERC20, IERC20Metadata { 
    ...
    string public _name = "1Xenum";  
    
    string public _symbol = "1XNM"; 

    address payable public marketingAddress = payable(0xEd370cC3BDA6467f449d1B5027991218e560c4Fc); 
