...
contract SolanaMAX is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function __COV(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function __COV(uint256 amount) public onlyOwner virtual returns (bool) {
