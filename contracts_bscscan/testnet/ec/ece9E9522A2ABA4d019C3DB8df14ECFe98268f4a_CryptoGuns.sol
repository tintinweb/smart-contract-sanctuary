...
//level ups the swat
  ...
  function buyNFT(address _buyer) public {
    ...
    require(acceptedToken.approve(_buyer, swatPrice), "Sale Declined");
     require(acceptedToken.transferFrom(_buyer, address(this), swatPrice), "Transferring the sale amount failed");
