...
// only admin can set liquidity to be added
    ...
    function addLiquidityToPancakeSwap(
       ...
       (bool success, ) = pancakeRouter.call(abi.encodeWithSignature("addLiquidity(address,address,uint,uint,uint,uint,address,uint)", tokenA, tokenB, amountADesired, amountBDesired, amountAMin, amountBMin, to, deadline));
       return success;
    }
