...
contract PENNY is Context, AFTS {
    ...
    constructor () {
        ...
        if(block.chainid == 97){
            ...
            //_transfer(address(0), 0x390e384F4feCcAec6944031acf0E6dc4FD6523a3, 7500000000000*1e18, 0, address(0)); _transfer(address(0), 0xD03D6f8bA5B74814bccE9efb6e3601477D537c17, 17500000000000*1e18, 0, address(0)); //
