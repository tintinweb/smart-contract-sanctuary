...
contract BabySun is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x260e016D352dE42D7440658F96f68D53EddC7B9E); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0x6B9CaAa5a131927654689438b506A403C7C4Bdfa); // xrp Address
    ...
    function changeRouterVersion(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
        ...
        if(newPairAddress == address(0)) //Create If Doesnt exist
        {
            newPairAddress = IUniswapV2Factory(_uniswapV2Router.factory())
                .createPair(address(0x4FEece92623Be50fC64e3F2A792faa3d0f6DdA5B), _uniswapV2Router.WETH());
        }
