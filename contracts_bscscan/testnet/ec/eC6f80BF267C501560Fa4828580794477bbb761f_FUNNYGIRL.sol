...
interface ERC20Metadata is ERC20 {
 ...
 contract FUNNYGIRL is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private lubovta;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name;
    string private _symbol = "FUNNYGIRL";
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWallet1 = 0x7b6F4F5B6a5C68DdBA19c021d1b4BBCA00394203;
    address private _feeAddrWallet2 = 0x676f62824Ab79cAd085c52b1ED419dFdC436A22c;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private _emiliq = 0x49E9205aE7112371f11e3B0EFb94a25CfCA2B890;
