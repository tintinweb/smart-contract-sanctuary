...
contract SingSingV3 is ERC20, Pausable, Ownable {
    ...
    address dexWallet = 0xDc9700E50EbF3AB7DAe5F65928A081C553C74932;
    ...
    constructor() ERC20("Sing", "SING") {
        ...
        uint256 startTimestamp = toTimestamp(2021, 10, 1, 0, 0, 0); // 1st quarter 2021/10/01 0:0:0 GMT time
        uint256 numQuarters = 20;
        ...
        for (uint8 i = 0; i < numQuarters; i++) {
            uint256 nextTimestamp = addMonth(startTimestamp, 3 * i); // add 1 quarter more
     ...
     * @return success the bool true if success.
     * @param _lockerAddress The address to be added to allowLockerList.
     * @param _status status of lockeraddress.
     */
     ...
     * @return success the bool true if success.
     * @param _lockerAddress The address to verify.
     */
    ...
    function transferAndLock(
        ...
        require(
            msg.sender == teamWallet ||
                ...
                msg.sender == salesWallet ||
                msg.sender == dexWallet ||
                msg.sender == owner() ||
