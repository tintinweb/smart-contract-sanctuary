...
contract SkyRocket is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "SkyRocketPlus";
    string private constant _symbol   = "SR+";
    uint8  private constant _decimals =  9;

    address public BUSD     = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD address for Swapping   // we will add textnet address here 
    
    uint256 public _taxFee       = 150; // 3% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 200; // 3% of every transaction is kept for liquidity
    uint256 public _marketingFee = 50; // 1% of every transaction is sent to marketing wallet
    uint256 public _devFee       = 50; // 1% of every transaction is sent to dev Wallet 
    ...
    constructor (address cOwner, address marketingWallet, address devWallet) Ownable(cOwner) {
        ...
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // this is testnet address now open remix 
