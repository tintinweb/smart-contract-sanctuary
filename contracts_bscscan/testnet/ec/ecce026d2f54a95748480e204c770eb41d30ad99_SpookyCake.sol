...
/**
 Telegram: https://t.me/SpookyCakeOfficial
 Website: https://SpookyCake.org
 Twitter: https://twitter.com/SpookyCakeBSC
*/

/**
 * Spooky Cake
 * 5% ONE Rewards Fee | 8% Auto-Liquidity Fee | 2% Marketing Fee
 * 
 * 
 * Get Cake Tokens just by holding HyperHarmony!
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 200000000 * (10 ** 18);
...
contract SpookyCake is IBEP20, Auth {
    ...
    address MarketingWallet = 0x5D13F0CAa7dD20125DFab2E697c08f0e56a0f816;

    string constant _name = "SpookyCake";
    string constant _symbol = "SPOOKYCAKE";
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _marketingFee;
        reflectionFee = _reflectionFee;
        marketingFee = _liquidityFee;
