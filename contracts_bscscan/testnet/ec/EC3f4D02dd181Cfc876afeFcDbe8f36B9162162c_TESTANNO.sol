...
contract TESTANNO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TESTANNO";
    string constant _symbol = "VETH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xc9f5A812745357D4730A71EAF8361941C931644A;
