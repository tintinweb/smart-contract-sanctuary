...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public presSale1;
    uint256 public presSale2;
    uint256 public presSale3;
    ...
    */
    ...
    uint256 public hardCapEthAmount = 37.5 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x053db14f91164556C2f97B8Bd4029194aAB336fE;
        /*
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0000375 ether; // 1 token / 1BNB price

        uint256 tokenAmount = msg.value.mul(1e18).div(rewardTokenCount);
        //token.mint(msg.sender, tokenAmount);
        balance[msg.sender].add(tokenAmount);
    ...
    function withdraw()public{
        //require(depositState[msg.sender]==false || getTimelock()<now);
        require(depositState[msg.sender]);
        depositState[msg.sender]=false;
        token.mint(msg.sender, balance[msg.sender]);
    }
