...
interface BakePool{
 ...
 contract BakedVault  {
   ...
   // uint256 public participantBalance;
    ...
    function automaticWithDrawRemainingAssets() public campaignConclude {
        ...
        require(locked == 0,"Admin not unlocked");

       // require((liquidityAdmin == 1) && (tokeReleseStatusManual == 1),"Admin not adedd liquidity or not relese Token");
