...
contract TestCoin is Context, IBEP20, Ownable {
    ...
    string private _name = "ZZZ TOKEN";
    ...
    // This is to prevent trading once dxsale finalizes, to give time to airdrop whitelisted users.
    // Once maxTxAmount is set to > 0, it cannot be set back to 0!
