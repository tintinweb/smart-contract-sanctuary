...
contract CaptainHODL is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0xcAD77bE6a1a7445B4522E7E9FF8144dEF6AeA98e); // Marketing Address
    ...
    uint256 private _tTotal = 1000000000 * 10**3 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CaptainHODL";
    string private _symbol = "CAPHODL";
    ...
    uint256 marketingDivisor = 2;
    
    uint256 public _maxTxAmount = 3000000 * 10**3 * 10**4;
    uint256 private minimumTokensBeforeSwap = 200000 * 10**3 * 10**4; 
    uint256 public buyBackSellLimit = 1 * 10**6;

    // LookBack into historical sale data
    SellHistories[] public _sellHistories;
    bool public _isAutoBuyBack = true;
    uint256 public _buyBackDivisor = 9;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 1000000000 * 10**3 * 10**4;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 4;
        _liquidityFee = 5;
        _maxTxAmount = 3000000 * 10**3 * 10**4;
    }
