...
contract SquidSeason2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 800 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Batch Transfer Test";
    string private _symbol = "BATCH";
