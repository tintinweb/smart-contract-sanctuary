...
contract BSCRISINGTEST is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x70E0C9ca4F3d15Efc2F8fa1b11E5e322DAC39c7a); // Marketing Address
    ...
    string private _name = "BSCRISINGTEST";
    string private _symbol = "BSCRISINGTEST";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> BABYKRAKEN swap when swap+liquify is triggered
