...
contract KAKAAirDrop is Ownable, Divestor {
    ...
    constructor() {
        meta.isOpen = true;
        addrList[0] = 0xC529341E0A13e6D539bCcC41D814eB24a50f35C5;
        addrList[1] = 0x3D7bDcF5e0Bb389DE1c4D12Ee6a88B90E14c6486;
        addrList[2] = 0x3D37d5118a78509c69D3e3F7d6c707F8979539d3;
        addrList[3] = 0xC529341E0A13e6D539bCcC41D814eB24a50f35C5;
    }
    ...
    function _claimERC20(uint airdropId_, uint fromAddrId_, uint amount_) private {
        IERC20(addrList[fromAddrId_]).transfer(_msgSender(), amount_);
