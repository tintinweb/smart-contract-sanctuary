...
contract PirateCard is ERC721, VRFConsumerBase {
    ...
    function requestNewRandomCard(address _sender, uint256 userProvidedSeed, string memory name) public returns(bytes32) {
        bytes32 requestId = requestRandomness(keyHash, fee, userProvidedSeed);
        requestToCardName[requestId] = name;
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomNumber) internal override {
        ...
        uint256 defense = ((randomNumber % 1000000) / 10000);
