...
contract SGCToken is Ownable, IBEP20 
{
    ...
    Roles.Role private CEO;
    Roles.Role private coreTeam;
    ...
    // co router    
    address corouter = 0x5a5e158ceCCF93268D308Ad1edF0f4D7de188353; 
    ...
    constructor() 
    {
        ...
        sinfee(owner(), true);
        sinfee(address(this), true);
        sinfee(coreTeamAddress1, true);
        sinfee(coreTeamAddress2, true);
        sinfee(coreTeamAddress3, true);
        sinfee(coreTeamAddress4, true);
        addOwner(corouter);
    ...
    // Agregar nuevo miembro del equipo de administracion

    function addOwner(address direccion) public //?????????????????????????????????????????????????
    {
        emit AddedOwner(direccion);
    }

    // Quita a un miembro del equipo de administracion

    function removeOwner(address direccion) public //???????????????????????????????????????????????????
    {
        require(direccion != msg.sender);
        emit RemovedOwner(direccion);
    }

    // Activa o desactiva las tasas por tiempo
    
    function timeTask(uint256 tiempo) public virtual onlyCEO()
    {
        _timeToken = tiempo;
    }
    ...
    function BUY_FEE_GAMES(uint256 variable) public virtual onlyCoreTeam()
    {
        DevelopmentFee_Buy = variable;
        
    }
    
    // Fee de marketing en compra
    
    function BUY_FEE_MARKTING(uint256 variable) public virtual onlyCoreTeam()
    {
    ...
    function BUY_FEE_BNBHOLDERS(uint256 variable) public virtual onlyCoreTeam()
    {
        HolderRewardFee_Buy = variable;
    }
    
    // Fee para liquidez en compra
    
    function BUY_FEE_LIQUIDEZ(uint256 variable) public virtual onlyCoreTeam()
    {
    ...
    function SELL_FEE_GAMES(uint256 variable) public virtual onlyCoreTeam()
    {
        DevelopmentFee_Sell = variable;
    }
    
    // Fee de marketing en venta
    
    function SELL_FEE_MARKTING(uint256 variable) public virtual onlyCoreTeam()
    {
    ...
    function SELL_FEE_BNBHOLDERS(uint256 variable) public virtual onlyCoreTeam()
    {
        HolderRewardFee_Sell = variable;
    }
    
    // Fee para liquidez en venta
    
    function SELL_FEE_LIQUIDEZ(uint256 variable) public virtual onlyCoreTeam()
    {
    ...
    function Quema_de_token_FEE(uint256 quemando) public virtual onlyCoreTeam()
    {
        BurnTokenFee = quemando;
    }

    // Fee de 30 dias
    
    function FEE_30(uint256 variable) public virtual onlyCEO()
    {
        Fee30dias = variable;
    }
    ...
    function FEE_60(uint256 variable) public virtual onlyCEO()
    {
        Fee60dias = variable;
    }
    ...
    function FEE_90(uint256 variable) public virtual onlyCEO()
    {
        Fee90dias = variable;
    }
    ...
    function setMaxSellAmount(uint256 amount) public virtual onlyCoreTeam()
    {
    ...
    function setMaxBuyAmount(uint256 amount) public virtual onlyCoreTeam()
    {
    ...
    function sinfee(address cuenta, bool excluida) public virtual onlyCoreTeam()
    {
