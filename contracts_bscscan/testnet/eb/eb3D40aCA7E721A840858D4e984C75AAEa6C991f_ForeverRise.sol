...
ForeverRise is built upon the fundamentals of Buyback and increasing the investor's value
    
Main features are
    
1) 4% tax is collected and distributed to holders for HODLing
2) 9% buyback tax is collected used to buyback and burn the tokens
3) 2% tax for marketing to promote ForeverRise
...
contract ForeverRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x241C1360f0550c24d95252b55f92B4196EeA2Bd3); // Marketing Address
    ...
    string private _name = "ForeverRise";
    string private _symbol = "FRISE";
