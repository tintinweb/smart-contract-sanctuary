...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5f3a43841Ad63292aDCD67992E0F2e5486a4bADc;
...
contract CrazyCrypto is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFF64c445bd4165DCd2449Aa5f956684cD949E0bc;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Crazy Crypto";
    string private _symbol = "CRCR";
