...
contract Ownable is Context {
    ...
    modifier onlyOwnerOrMinter() {
        require(_owner == _msgSender() || _minter == _msgSender(), 'Ownable: caller is not the owner or minter');
        _;
    }
...
contract Litedex is BEP20('Litedex', 'LDX') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying ldx (not scaled);
...
contract LitedexStakePosition is BEP20('LDX-SP', 'SLDX') {
