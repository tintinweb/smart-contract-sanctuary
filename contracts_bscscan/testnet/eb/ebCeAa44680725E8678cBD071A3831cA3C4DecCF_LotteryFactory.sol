...
contract LotteryFactory is OnlyType,ILotteryFactory {
    ...
    event Win(uint256 indexed lotteryId,uint32 indexed phase,uint32 ticketId, address winner);
    
    event Reward(uint256 indexed lotteryId,uint32 indexed phase,bool isWinner, address winner,uint256 amount);
