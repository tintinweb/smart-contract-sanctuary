...
contract BabyCakeDoge is ERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 75000000000000 * (10**18);
    ...
    constructor() ERC20("BabyCakeDoge", "BABYCAKEDOGE") {
    	...
    	marketingWallet = 0x42056b06D9D1fDE1E715C18f68ec0ABF848904A8;
    ...
    function updatefirstDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(firstDividendTracker), "BabyCakeDoge: The dividend tracker already has that address");
 
        FIRSTDividendTracker newfirstDividendTracker = FIRSTDividendTracker(payable(newAddress));
 
        require(newfirstDividendTracker.owner() == address(this), "BabyCakeDoge: The new dividend tracker must be owned by the BabyCakeDoge token contract");
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BabyCakeDoge_Dividend_Tracker", "BabyCakeDoge_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 3600;
