...
contract PrivateSale is Ownable {
  ...
  function buyTokens () public payable returns (bool) {
      ...
      totalBuyedBnb = bnbAlreadyBuyed.add(msg.value);
      set_ValuesPrivateSaleWhiteList(msg.sender,tokenAmount,totalBuyedBnb);
  ...
  function getAllBnbBuyed () public view onlyOwner returns (uint256) {
  ...
  function getAllUsersPartecipating () public view onlyOwner returns (uint256) {
    uint256 size = _PrivateSaleWhiteListAccounts.length;
    address keyAddress;
    uint256 AllUsers = 0;
    uint256 BnbBuyedFromUser;
  ...
  function get_BlacklistedPrivateSaleWhiteList (address addr) private view returns (bool) {
