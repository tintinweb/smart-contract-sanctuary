...
contract ShivaFestival is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingAddress = 0xE35f185A2DA115A300cB2661502D1738A2D67ae5;
        rewardAddress = 0xAF8804883BCE1E43aD801c015b817328963A2E63;
    ...
    function swapBack() internal swapping {
        ...
        _basicTransfer(address(this), owner, swapTokens);
        ...
        // send to dev address
        uint256 devTokens = contractTokenBalance.mul(rewardFee).div(totalFee);
        _basicTransfer(address(this), rewardAddress, devTokens);
    ...
    function setRewardAddress(address _rewardAddress) external {
        require(msg.sender == rewardAddress, "Only previous dev can change dev address");
