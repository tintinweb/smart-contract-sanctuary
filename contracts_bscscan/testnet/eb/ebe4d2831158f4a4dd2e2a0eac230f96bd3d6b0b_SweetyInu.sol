...
contract SweetyInu is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0xCAFBd05cd72D69C0cC02209E97D3Ed63f4414783;
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000000000000000;
    ...
    function setSweetyCharityWallet(address newWallet) external onlyOwner() {
