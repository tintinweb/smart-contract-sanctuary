...
contract Hodlperk is Ownable {
    ...
    function addWhiteListedUser(address _addressToWhitelist, bool status) public onlyOwner{
    ...
    function addModifierListUser(address _addressToModifierlist) public onlyOwner{
        modifierList[_addressToModifierlist] = true;
    }

    function removeModifierListUser(address _addressToModifierlist) public onlyOwner{
