...
contract Kaby is IKaby, ERC721, AcceptedToken, ReentrancyGuard {
    ...
    Hero[] private _heros;
    mapping(uint => EnumerableSet.UintSet) private _heroskills;
    ...
    function claimHero(uint versionId, uint amount) external override payable {
        ...
        require(msg.value == version.salePrice * amount, "Kaby: incorrect value");
    ...
    function buy(uint heroId) external override payable nonReentrant {
        ...
        require(msg.value == price, "Kaby: incorrect value");
    ...
    function offer(uint heroId, uint offerValue) external override nonReentrant payable {
        address buyer = msg.sender;
        ...
        require(msg.value == requiredValue, "Kaby: sent value incorrect");
    ...
    function _makeTransaction(uint heroId, address buyer, address seller, uint price) private {
        ...
        (bool transferToSeller,) = seller.call{value: price - marketFee}("");
...
interface IKaby {
     ...
     */
    function claimHero(uint versionId, uint amount) external payable;
    ...
    /**
     * @notice Burns a Hero to claim its `floorPrice`.
     *
     ...
     * - Owner cannot offer.
     */
    function offer(uint heroId, uint offerValue) external payable;
