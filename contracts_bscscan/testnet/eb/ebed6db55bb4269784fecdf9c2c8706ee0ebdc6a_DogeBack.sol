...
contract DogeBack is BEP20, Ownable {
    ...
    constructor() BEP20("DogeBack", "DOGEBACK") {      
        ...
        _isExcludedFromFees[address(pancakeswapV2Pair)] = true;
        ...
        _isExcludedFromTxlock[address(pancakeswapV2Pair)] = true;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        require(_canTransBeforeTon[from], "Warung belum buka goblok");
        ...
        if (tOn && automatedMarketMakerPairs[from] && to != address(this)) {
        ...
        } else if (tOn && automatedMarketMakerPairs[to]) {
