...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet PCS V2
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x14e9203E14EF89AB284b8e9EecC787B1743AD285); // testnet PCS V2
...
//        _isExcludedFromFee[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = true; //ropsten
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair || to == uniswapV2Pair && block.timestamp > nextUpdateTime) {
            updatePrice();
        }
    }
    ...
    function updatePrice() internal {
        ...
        uint256 swapPrice;
        try uniswapV2Router.getAmountsOut(_numTokensSellToAddToLiquidity/2, path) returns (uint256[] memory price){
            swapPrice = price[1];
        } catch {
