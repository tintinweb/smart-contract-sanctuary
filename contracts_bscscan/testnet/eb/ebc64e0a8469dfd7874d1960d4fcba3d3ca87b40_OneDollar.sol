...
contract OneDollar is Context, IERC20, Ownable {
    ...
    string private _name = "OneDollar";
    string private _symbol = "ONED";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 4;  // 4% REDISTRIBUTION
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 3;    // 3% LIQUIDITY ON PCS V1
