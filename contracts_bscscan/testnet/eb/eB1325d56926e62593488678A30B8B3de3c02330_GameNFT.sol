    ...
    Ownable
{
    ...
    function mint(address to, uint256 tokenId) public virtual {
        require(
            ...
            "ImAHero721: must have minter role to mint"
        );
        require(!_exists(tokenId), "ImAHero721: must have unique tokenId");
    ...
    function addApprovalWhitelist(address proxy) public onlyOwner {
        require(
            ...
            "ImAHero721: invalid proxy address"
        );
    ...
    function lockToken(uint256 tokenId, bytes calldata signature) public {
        require(
            ...
            "ImAHero721: this token has been locked already"
        );
    ...
    function unlockToken(uint256 tokenId, bytes calldata signature) public {
        require(lockedTokens[tokenId], "ImAHero721: this token is not locked");
    ...
    function _beforeTokenTransfer(
        ...
        require(
            !lockedTokens[tokenId],
            "ImAHero721: your item has locked to play in game"
        );
