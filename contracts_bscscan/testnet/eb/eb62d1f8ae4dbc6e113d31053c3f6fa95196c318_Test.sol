...
contract Test is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(isFixedSaleBuy) {
            require(block.timestamp >= fixedSaleStartTimestamp, "Test: The fixed-sale has not started yet.");
            ...
            if(!openToEveryone) {
                require(fixedSaleEarlyParticipants[to], "Test: The fixed-sale is only available to certain participants at the start");
            }
