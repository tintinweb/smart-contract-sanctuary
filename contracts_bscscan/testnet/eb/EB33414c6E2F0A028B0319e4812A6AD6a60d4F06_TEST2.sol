...
contract TEST2 is ERC20, Ownable {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "TEST2: The new dividend tracker must be owned by the TEST2 token contract");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        require(newValue != gasForProcessing, "TEST2: Cannot update gasForProcessing to same value");
