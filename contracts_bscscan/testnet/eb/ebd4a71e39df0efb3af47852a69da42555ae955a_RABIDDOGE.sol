...
contract RABIDDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC75E66FB1A0A63F82229bb32D63Ac6b0C158BFb2); // Marketing Address
    ...
    string private _name = "Rabid Doge";
    string private _symbol = "RABIDDOGE";
