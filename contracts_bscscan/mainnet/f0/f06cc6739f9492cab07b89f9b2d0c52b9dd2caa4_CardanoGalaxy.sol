...
// CHANGE
contract CardanoGalaxy is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Cardano Galaxy";
    string constant _symbol = "Cardano Galaxy";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x2705ea8CE5314EaC335bd61f939F39a50A10926B);
