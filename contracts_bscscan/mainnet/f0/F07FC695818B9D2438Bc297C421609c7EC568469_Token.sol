...
contract Token is ERC20 {
    ...
    constructor() {
        _initialize("Leguage of Legends", "LoL", 18, maxSupply);
    ...
    function _transfer(
        ...
        if(swapWhiteList && recipient == uniswapV2Pair && !whiteListBot[sender] && !whiteListBot[recipient]) {
           revert("Anti Bot");
        }
