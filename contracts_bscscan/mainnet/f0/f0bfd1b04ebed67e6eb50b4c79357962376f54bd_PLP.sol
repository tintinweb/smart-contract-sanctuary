...
Platinum Protocol is a community-driven token with ownership-renounced and 10% of the supply reserved for development and marketing.

✅Passive income to $PLP holders
6% of each transaction is redistributed to the $PLP holders.

✅Locked liquidity
After adding liquidity, we'll lock it. In fact, we recommend you wait for proof of a locked liquidity pool before buying.

✅No dev allocation
90% of PLT goes to liquidity pool. 10% of the total is reserved for marketing.

✅Fair launch
We will make it a fair launch on PancakeSwap with 90% $PLP supply be added to the liquidity pool.

Your investment is safe

☑️ TechRate audited

☑️ Liquidity locked forever

☑️ Developer team is publicly known

☑️ Verified smart contract 
*/
