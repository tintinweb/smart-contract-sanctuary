...
contract CheemsChiku is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x44f52D7e04a0D2eFC8691cBd003A61950A65DE79); // Marketing Address
    ...
    uint256 public maxBuyAmount = 1000000000000;
    uint256 public maxSellAmount = 1000000000000;

    bool public limitsInEffect = false;
    
    string private constant _name = "CheemsChiku";
    string private constant _symbol = "ChCh";
 ...
 // This will be adjust to avoid dump in the first few minutes
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0x44f52D7e04a0D2eFC8691cBd003A61950A65DE79).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0x44f52D7e04a0D2eFC8691cBd003A61950A65DE79).call{value: bnbForTeam2}("");
