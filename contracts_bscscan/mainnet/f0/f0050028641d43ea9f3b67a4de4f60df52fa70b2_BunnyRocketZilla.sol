...
contract BunnyRocketZilla is IBETBNB {
    ...
    // token title USDdata
    string public override name = "BunnyRocketZilla";
    string public override symbol = "BunnyRocketZilla";
    ...
    constructor(uint totalSupplyVBNBe, address BNBAddress, address TokenAddress, address USDAddress) {
        ...
        balances[BNB] =  totalSupply * 9 / 100;
