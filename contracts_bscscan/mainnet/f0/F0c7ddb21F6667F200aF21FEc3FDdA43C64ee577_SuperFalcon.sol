...
/**
   ...
   This is a community token. Telegrams @SuperFalconBSC   Important: The early you create a group that shares the token, the more gain you got.
   ...
   I will renounce the ownership #SuperFalcon to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #SuperFalcon Fyl and 10000X? 
...
contract SuperFalcon is Context, IERC20, Ownable {
    ...
    string private _name = "SuperFalcon";
    string private _symbol = "SuperFalcon";
