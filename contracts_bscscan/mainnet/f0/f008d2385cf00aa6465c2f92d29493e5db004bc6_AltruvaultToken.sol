...
Token features include:
    Staking Vault With Rewards (Bonuses for Time Locking)
    Externally Boosted Tokenomics Through Vault Partnerships (app.altruvaults.com)
...
contract AltruvaultToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x924F4D5eFf99F6461Be1EFF4B1ee5152f4359F0c); 
    address payable public developmentAddress = payable(0x879147f5c1bEf6D34DBE3592776979B4C7FF3D2D); 
    address payable public charityAddress = payable(0xf0Ac42e7F03B983318d7481Ce1CB20BaEE116041); 
    address payable public vaultRewardAddress = payable(0x0D953A8Fa309B8F9E6bC7B3034838D46B2e5615A); 
    ...
    uint256 public _bMaxTxAmount = 1000000000 * 10**6 * 10**9;
    uint256 public _sMaxTxAmount = 1000000000 * 10**6 * 10**9;
    uint256 private _trigger = 1000000000 * 10**6 * 10**9;
