...
contract GigaCock is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x3e609C1718122ac29060cc6C8dfb0D768fa49b48;

    //max wallet holding of 4% 
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 100;

    string constant _name = "GigaCock";
    string constant _symbol = "GigaCock";
