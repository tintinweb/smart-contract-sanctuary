...
interface IERC20 {
  ...
  */
   ...
   * https://github.com/ethereum/EIPs/sh/ib/at/ar/20#issuecomment-263524729
   *
...
contract Shibatar is IERC20 {
    ...
    uint256 private constant startingSupply = 750_000_000_000;

    string constant _name = "Shibatar";
    string constant _symbol = "Shibatar";

    uint256 public _buyFee = 1000;
    uint256 public _sellFee = 1400;
    ...
    uint256 public _reflectionRatio = 600;
    ...
    address payable private _marketingWallet = payable(0xeaa367413f4d580b3532dc3c4AEc5C066E07b366);
...
//===============================================================================================================
    ...
    function swapBack(uint256 numTokensToSwap) internal swapping {
        uint256 amountToLiquify = ((numTokensToSwap * _liquidityRatio) / (_marketingRatio + _liquidityRatio + _reflectionRatio)) / 2;
        ...
        uint256 amountBNBLiquidity = ((amountBNB * _liquidityRatio) / (_marketingRatio + _liquidityRatio + _reflectionRatio)) / 2;
        ...
        if (amountBNB - (amountBNBReflection + amountBNBLiquidity) > 0) {
