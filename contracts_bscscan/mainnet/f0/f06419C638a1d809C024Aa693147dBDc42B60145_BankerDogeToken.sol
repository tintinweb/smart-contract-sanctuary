...
BankerDoge brings cutting edge DeFi features to existing BSC tokens like staking and DeFi lending.
Every partner vault benefits the BankerDoge token price and APY
    
Token features include:
    Staking Vaults With Rewards (Bonuses for Time Locking)
    Over 2M Staked Before Launch!
    Externally Boosted Tokenomics Through Vault Partnerships (app.BankerDoge.com)
    Roboboost: Dynamic Auto Buy Back and Burn
    ...
    18% Sell Fee:
        ...
        2% to Marketing
        2% to Development
    Multi-signature Protocol Wallets (Increased Security)
    Doxxed Team With Crypto Experience (Altrucoin.io)
    Learn more at BankerDoge.com
*/
...
contract BankerDogeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x12Fc3CCd4C8BCA5c03a49397B136223552eB0763); 
    address payable public developmentAddress = payable(0x6EC3D658A79fEbB2Fa87a92C66Fd2A3ddd495B74); 
    address payable public charityAddress = payable(0x8cd3282F41ae28Ea2efBcEA59dA7392503DcD46b); 
    ...
    string private constant _name = "BankerDoge";
    string private constant _symbol = "BANKER";
