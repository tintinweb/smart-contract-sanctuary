...
/**
 *
Flying BNB is one of the highest reward in BNB in the market

There is more info in our website about the tocenomics and other stuff.
Any question how this rewards system works? feel free to join our tg group.

Telegram: https://flyingbnb.online/
Website : https://flyingbnb
...
contract FLYINGBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FLYINGBNB";
    string constant _symbol = "FLYBNB";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x7d70481Cf0affCDF6b4c50021E0f5177ce6897C3;
...
// PREPARE TO LOAD YOUR BNB REWARDS!