...
contract JUSTBIGCASINO is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Just Big Casino";
   string constant _symbol = "$JBC";
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x32ae10259Fe334A7751Cadd9c4530D5477466F01;
