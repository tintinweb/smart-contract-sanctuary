...
contract CorgiSwapLottery is ReentrancyGuard, ICorgiSwapLottery, Ownable {
    ...
    uint256 public maxPriceTicketInCoris = 50 ether;
    uint256 public minPriceTicketInCoris = 0.01 ether;
     ...
     */
    function setMinAndMaxTicketPriceInCake(uint256 _minPriceTicketInCoris, uint256 _maxPriceTicketInCoris)
        external
        onlyOwner
    {
