...
// Telegram:KumaInuCoin
// TokenNomics : 50% burn, 48% Pancake< 2% Marketing wallet
...
contract KumaInuCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kuma Inu Coin";
    string constant _symbol = "KUMAINU";
