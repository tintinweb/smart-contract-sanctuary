...
Revolutionary new token NewWorld that is a lottery token for the new New World MMO game. Giveaways and lotteries for in game stuff and gold. More tokens you hold more tickets you have for the lotteries!

Token is from SafeDev team and is rugproof like all our tokens. Website is under construction and will be launched at the same time as New World 31.8.2021 

StealthLaunched for earlybirds to get better foothold before massive adoption!

Telegram t.me/newworldbsc
...
contract NewWorld is SafeERC20 {

    constructor() SafeERC20("NewWorld", "NewWorld") {
        
        _transferTO(msg.sender, 188000000000e18);
    }
