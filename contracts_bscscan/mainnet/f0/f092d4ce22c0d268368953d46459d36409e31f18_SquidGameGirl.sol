 ...
 *
    ...
    Join our Telegram : https://t.me/SquidGameGirlbsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUYBACK = IBEP20(0xBC6479949294F4845c7aDF3644cC624F7f5517aE);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BUYBACK.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BUYBACK);
        ...
        uint256 amount = BUYBACK.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BUYBACK.transfer(shareholder, amount);
...
contract SquidGameGirl is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address MARKETING = 0xBC6479949294F4845c7aDF3644cC624F7f5517aE;

    string constant _name = "SquidGameGirl";
    string constant _symbol = "SQUIDGAMEGIRL";
    ...
    //settting the maximum permitted wallet BUYBACK (percent of total supply)
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Total BUYBACK is currently limited, you can not buy that much.");}
