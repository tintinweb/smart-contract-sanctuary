...
contract defihero is Context, IERC20, Ownable {
    ...
    string private _name = "Defi Hero";
    string private _symbol = "DFH";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 10 * 10**8 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x00A965907F405BB7A78558Dd8eE65a579603cFb0);
    address public marketingWalletToken = 0x087f19C0d3424B02df3d5e7Da2ce4d448670Ed43;
