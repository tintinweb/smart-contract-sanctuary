...
/** 
 *  SourceUnit: d:\GitWork\RoyalFruitNFT\contracts\contracts\KrownCanvasAuction.sol
*/
...
contract KrownCanvasAuction is Ownable, ERC721Holder {
     ...
     */
    function createAuction(uint256 _tokenId, uint256 _startPrice, uint256 _startTime, uint256 _endTime) 
        onlyTokenOwner(_tokenId) public 
    {   
        ...
        newAuction.creator = nftCollection.creatorOf(_tokenId);
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            nftCollection.safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
            ...
            address _creator = nftCollection.creatorOf(myAuction.tokenId);
            uint256 royalty = nftCollection.royalties(myAuction.tokenId);
            ...
            nftCollection.safeTransferFrom(address(this), lastBid.from, myAuction.tokenId);		
            auctions[_auctionId].active = false;
    ...
    modifier onlyTokenOwner(uint256 _tokenId) {
        address tokenOwner = nftCollection.ownerOf(_tokenId);
