...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0x9df465460938f9EBDF51C38CC87D72184471F8F0);
...
/* Token contract */
contract BabyGenopets is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0x9df465460938f9EBDF51C38CC87D72184471F8F0; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xc4f8a6992Ce2819bB715ec49861EeB359421fe0d;
    ...
    // Name and symbol
    string constant _name = "BabyGenopets";
    string constant _symbol = "BabyGenopets";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1 / 50; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 50; // 2%
