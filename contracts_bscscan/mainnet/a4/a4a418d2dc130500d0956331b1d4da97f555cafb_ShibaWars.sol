...
/**
    ...
    Welcome to Shiba Wars

Stealth launching on Sunday 12th December.

Don't be late and join our community now. 

    Telegram : https://t.me/shibawars
    Twitter : https://twitter.com/ShibaWarsCoin
...
contract ShibaWars is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x8C9D7AEc8ef94dD27911E4A2601b8d1829B74ad5); // Marketing Address
    ...
    uint256 public maxBuyAmount = 20000000000;
    uint256 public maxSellAmount = 10000000000;

    bool public limitsInEffect = false;
    
    string private constant _name = "ShiaWars";
 ...
 // This will be adjust to avoid dump in the first few minutes
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0x588787d9F3a7ABa3414483eaDc15290Af8924CA5).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0x588787d9F3a7ABa3414483eaDc15290Af8924CA5).call{value: bnbForTeam2}("");
