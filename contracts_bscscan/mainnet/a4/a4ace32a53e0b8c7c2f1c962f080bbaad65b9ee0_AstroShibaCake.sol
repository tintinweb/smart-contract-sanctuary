...
/**
 ...
 By holding AstroShiba Cake, holders will be rewarded in $ASCAKE and Cake automatically. 
 Moreover, as NFT gaming is now so trending, an amazing Play to Earn platform is coming to town which named AstroShiba Inu Cake ARENA for users to earn AstroShiba Inu Cake through Battles and Mission. Let’s Join us!
 
 
 Telegram: https://t.me/AstroShibacake
 Website: https://astroshibainu.space/
 Twitter: https://twitter.com/Astroshibacake
 
 NFT:
 Marketplace: https://astroshibainu.space/marketplace.html
 NFT Game: https://astroshibainu.space/gaming.html
...
contract AstroShibaCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AstroShibaCake";
    string constant _symbol = "ASCAKE";
