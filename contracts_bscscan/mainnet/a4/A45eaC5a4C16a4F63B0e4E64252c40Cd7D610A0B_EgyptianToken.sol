...
contract EgyptianToken is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 6000000000000000000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Egyptian Pharaoh Inu';
    string private _symbol = 'EGYPI';
