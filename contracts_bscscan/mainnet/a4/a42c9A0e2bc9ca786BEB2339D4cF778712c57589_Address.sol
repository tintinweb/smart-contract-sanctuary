...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Amazonpay is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 999991001000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Amazon Pay";
    ...
    address public MarketingWallet = 0x371Eaf5d53b307429BF4C9f79a5889177CF34789; //3% for marketing 
    ...
    uint256 public _maxTxAmount = 999991001000 * 10**9; //1% of total supply   //ANTIDUMP
    uint256 private numTokensSellToAddToLiquidity = 2430  * 10**9;
    uint256 public _maxWalletToken = 999991001 * 10**9;
