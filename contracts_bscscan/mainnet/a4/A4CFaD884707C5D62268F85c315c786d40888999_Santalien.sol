...
contract Santalien is IBEP20, Ownable
{
    ...
    EnumerableSet.AddressSet private _excludedFromRedistribution;

    string private constant _name = "Santalien";
    ...
    address public constant MarketingWallet=0x561af592b06a6A1aB67FA4960b0D9060D52142c0;
    ...
    uint8 private _redistributionTax;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        uint256 contractToken=_calculateFee(amount, tax, _redistributionTax+_liquidityTax);
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint16 totalTax=_liquidityTax+_redistributionTax;
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function getTaxes() public view returns(uint256 burnTax,uint256 liquidityTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
        return (_burnTax,_liquidityTax,_redistributionTax,_buyTax,_sellTax,_transferTax);
    }
    ...
    function TeamSetTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 redistributionTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyOwner{
        uint8 totalTax=burnTaxes+liquidityTaxes+redistributionTaxes;
        require(totalTax==100, "burn+liq+marketing needs to equal 100%");

        _burnTax=burnTaxes;
        _liquidityTax=liquidityTaxes;
        _redistributionTax=redistributionTaxes;
