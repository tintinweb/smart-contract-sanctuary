...
/**
 *
  Official Baby Panda Coin 
  
  
 * The biggest Baby Panda meme reflection token and the only one with auto-stake feature.
 * Simply love, hold Baby Panda tokens in your wallet and watch your baby panda grow.
...
contract BABYPANDA is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BABY PANDA";
