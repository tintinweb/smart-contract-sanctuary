...
contract SmartBotToken is Context, IERC20, Ownable {
    ...
    string private _name = "SmartBot Token";
    string private _symbol = "SBOT";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100000 ether;
    ...
    // to withdraw all amount of eth of the fees
    function withdrawAll() public onlyOwner {
         require(address(this).balance >= 0, "nothing to withdraw ");
        payable(msg.sender).transfer(address(this).balance);
    }
    
     // to withdraw all amount of weth of fees
    function withdrawAllWETH() public onlyOwner {
        IERC20 WETH = IERC20(uniswapV2Router.WETH());
        uint256 WETHBalance = WETH.balanceOf(address(this));
        require(WETHBalance >= 0, "nothing to withdraw ");
        WETH.transfer(address(msg.sender), WETHBalance);
    }
    
      // to withdraw all amount of SBOT of fees
    function withdrawAllSBOT() public onlyOwner {
        uint256 SBOTBalance = balanceOf(address(this));
        require(SBOTBalance >= 0, "nothing to withdraw ");
        _transfer(address(this), address(msg.sender), SBOTBalance);
    }
}