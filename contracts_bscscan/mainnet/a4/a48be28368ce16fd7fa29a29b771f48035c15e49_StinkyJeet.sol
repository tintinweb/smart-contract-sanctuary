...
/**      
 *  https://t.me/StinkyJeet
 *
 * 50,000,000 Max wallet/transaction
**/
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x1A93ba411cfFDFd158d52bcC73ed23d935Ce2507;
        _token = msg.sender;
    }
...
contract StinkyJeet is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "StinkyJeet";
    string constant _symbol = "PAJEET";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 50000000 * (10 ** _decimals);     // 2%
    uint256 public _maxWalletToken = 50000000 * (10 ** _decimals);  // 2%
    ...
    address IDEXPair = 0x1A93ba411cfFDFd158d52bcC73ed23d935Ce2507;
