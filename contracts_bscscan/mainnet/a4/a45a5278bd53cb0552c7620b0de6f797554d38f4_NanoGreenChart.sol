...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 GREEN = IBEP20(0x5775e60447a0Bc86c67c61472476EBF6FcaB0D87);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GREEN.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(GREEN);
        ...
        uint256 amount = GREEN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GREEN.transfer(shareholder, amount);
...
contract NanoGreenChart is IBEP20, Auth {
    using SafeMath for uint256;

    address GREEN = 0x5775e60447a0Bc86c67c61472476EBF6FcaB0D87;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NanoGreenChart";
    string constant _symbol = "GREEN";
