...
Come join us and be safe from the crypto crash!
https://t.me/SafeCryptoCrash
...
contract SafeCryptoCrash is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafeCryptoCrash";
    ...
    // Max Tx amount to be 10 billion
    uint256 public _maxTxAmount = 10_000_000_000 * 10**9;

    // Liquify when 900 million tokens are stored
    ...
    constructor (address marketingWallet) {
        ...
        //Pancake Swap V2 address //0xD99D1c33F9fC3444f8101754aBC46c52416550D1
