...
/**
 *  Telegram : https://t.me/superpumpy
 * 
 * SuperPumpy it's a BSC Token ONLY Created for being PUMPED! 2 Big Pump Groups will pump it in the next day!
 * 
 * Let's see how far can a community pump a token in ONLY 24 hours! Remember to take profits along the way!
 * 
 *  Stealthlaunch
 * 
 *  
...
contract SuperPumpy is Context, IERC20, Ownable {
    ...
    string private _name = "SuperPumpy";
    string private _symbol = "SuperPumpy";
