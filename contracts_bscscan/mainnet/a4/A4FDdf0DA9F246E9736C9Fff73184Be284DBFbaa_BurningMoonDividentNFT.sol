...
contract BurningMoonDividentNFT is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    ...
    // Token name
    string private _name="EarnADA x BurningMoon";
    // Token symbol
    string private _symbol="eADAxBM";
    ...
    address constant TokenAddress=0x63b96E2Aa10d56a638D23498e81d7403d2b64178;
    //TestNet
    ...
    constructor() {
        ...
        NFTPrototypes.push(NFTData("Common Moongirl", "0", Rarity.Common));
        NFTPrototypes.push(NFTData("Rare Moongirl", "1", Rarity.Rare));
        NFTPrototypes.push(NFTData("Ultra Rare Moongirl", "2", Rarity.UltraRare));
        NFTPrototypes.push(NFTData("Legendary Moongirl", "3", Rarity.Legendary));
        NFTPrototypes.push(NFTData("Legendary Shiny Moongirl", "4", Rarity.LegendaryShiny));
