...
contract Oydess is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xAB0839D13DE8008128BdD27c8C608b5e0C469A6B); // Marketing Address
    ...
    string private _name = "Oydess";
    string private _symbol = "OYDESS";
