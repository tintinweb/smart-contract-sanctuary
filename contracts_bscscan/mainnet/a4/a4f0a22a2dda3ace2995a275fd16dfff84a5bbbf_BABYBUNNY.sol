...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //cake
...
contract BABYBUNNY is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Bunny;";
    string constant _symbol = "BABYBUNNY";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x42d87B211194A98A73C3704a18b1b893D6dC2608;  // marketingwallet
