...
// CHANGE
contract babyhellbound is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Hellbound";
    string constant _symbol = "BabyHellbound";
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x0D3aB71746B2d3FeD6B959CB99C2162fdd8Ed3E6);
