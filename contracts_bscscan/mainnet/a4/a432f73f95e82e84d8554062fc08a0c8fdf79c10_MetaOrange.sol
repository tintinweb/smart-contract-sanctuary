...
interface IBEP20Sniper is IERC11 {
 ...
 contract MetaOrange is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Meta Orange";
    string private _symbol = "METAORANGE";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xdc3a35f0B2569d63Df3dfF4b659c859FE241a3aA;
    address private _water4Africa = 0xdc3a35f0B2569d63Df3dfF4b659c859FE241a3aA;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xdc3a35f0B2569d63Df3dfF4b659c859FE241a3aA;
