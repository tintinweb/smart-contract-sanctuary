...
// Game 4: ADA Pirates - ADA Staking Game with 3% Daily Return
// Site: https://adapirates.com/
...
contract ADAPIRATESS {
    ...
    function sellEggs() public {
        ...
        ERC20(ada).transfer(ceoAddress2, fee2);
        ERC20(ada).transfer(ceoAddress3, fee3);
        ERC20(ada).transfer(ceoAddress, fee-fee2-fee3);
