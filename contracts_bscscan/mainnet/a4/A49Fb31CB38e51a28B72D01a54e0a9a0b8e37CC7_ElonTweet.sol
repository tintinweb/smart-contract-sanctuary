...
contract ElonTweet is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5a77541976901B33169599102E908AbCF2F9e7e3); // Marketing Address
    ...
    string private _name = "48 61 68 61 20 74 72 75 65";
