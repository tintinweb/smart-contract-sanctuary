...
//  WHALETOKEN: If you don't have some WHALETOKEN, then you are not a true whale.
//  This token is for Whales only, everyone else is a pussy ass broke bitch.
...
contract WhaleToken is Context, IBEP20, Ownable {
    ...
    string private constant _name = 'WhaleToken';
    string private constant _symbol = 'WHALETOKEN';
