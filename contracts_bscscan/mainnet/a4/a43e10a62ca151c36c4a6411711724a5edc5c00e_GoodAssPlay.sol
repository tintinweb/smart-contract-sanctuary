...
/**
    This project was launched as a Stealth launch and will be community run.
    ...
    Good Ass Play will start with 1 BNB in liquidity so no whales will be present.
    As more holders buy, you can then increase your buy orders.
    
    100,000,000,000,000,000 total supply (100 Quadrillion).
    
    TELEGRAM: https://t.me/GoodAssPlayBSC
...
contract GoodAssPlay is Context, IERC20, Ownable{
    ...
    string private _name = "Good Ass Play";
    string private _symbol = "GAP";
