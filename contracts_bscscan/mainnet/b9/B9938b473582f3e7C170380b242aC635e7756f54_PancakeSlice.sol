...
contract PancakeSlice is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Pancake Slice";
    string constant _symbol = "SLICE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 20; //0.5% of total supply
