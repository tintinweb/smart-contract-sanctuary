...
Who doesn't know happy meal? someone like elon very loves it.
here's thr tweet.
https://twitter.com/elonmusk/status/1485953263040188416?s=20


Telegram:
https://t.me/happymealofficial
...
contract HappyMeal is Context, IERC20, Ownable {
  ...
  address payable public _HAPPYWalletAddress;
  ...
  constructor(
    address payable HAPPYWalletAddress,
    address payable marketingWalletAddress
  ) {
    _HAPPYWalletAddress = HAPPYWalletAddress;
  ...
  function sendETHToTeam(uint256 amount) private {
    _HAPPYWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _setHAPPYWallet(address payable HAPPYWalletAddress) external onlyOwner {
    _HAPPYWalletAddress = HAPPYWalletAddress;
  }
