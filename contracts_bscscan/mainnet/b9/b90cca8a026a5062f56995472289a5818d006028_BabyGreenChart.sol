...
Be sure to join the right telegram!
t.me/babygreenchartofficial
...
contract BabyGreenChart is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Green Chart", "BabyGREEN") {

    	marketingWallet = 0x53290Df86845C868B41cB7E5631e6AeA5a686C94;
    	rewardsWallet = 0xde53E2E8001e1b4D3a2ADcF86E825171744cb1a3;
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0x6cb47201e14510dD0B2786684e2249FA5294674E); // dev fee lasts for one day only
