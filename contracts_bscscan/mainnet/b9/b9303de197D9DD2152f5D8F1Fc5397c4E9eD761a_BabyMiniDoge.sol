...
/*
* Welcome to Baby Mini Doge
* 50% Token Burned
* LP Burn forever
* Baby Mini Doge will burn 3% every transaction
* 2% reward to holders
*/
...
contract BabyMiniDoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {  
        _name = "Baby Mini Doge";
        _symbol = "BabyMiniDoge";
