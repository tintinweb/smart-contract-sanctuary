...
BITCOINSPACEX - 10% Bitcoin reflection automatically every hour

❣️Female Dev
❣️Project for diamond hands & long term holders
❣️10% Bitcoin reflection automatically every hour
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 1000000 * (10**9); // user must hold 1000,000 token to receive Bitcoin
...
contract BitcoinSpaceX is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "BitcoinSpaceX";
