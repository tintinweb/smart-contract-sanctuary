...
contract BingusStaking is Auth, IBingusStaking {
    ...
    constructor() Auth(msg.sender) {
        _pair = IBEP20(0xafd29Fd11b5570171ff62e5B638BaFfA7F00938f);
        _pairInitialized = true;

        _token = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    /**
     * Factor by which the rewards are inflated to increase accuracy
     */
     ...
     * Preferably do not use whilst LP is staked
     */
