...
/**
                                      ...
                                      Welcome to Power x ($Mx)  


Telegram: https://t.me/Powerxbsc

Power x is created by an experienced team of developers and managers who have supported and worked with numerous projects in the BSC space.

Our team’s focus is delivering and maintaining high quality standards and treat our Power x’s community as our #1 asset
...
(🚨Upcoming HUGE Marketing - ifluencers -📈 Poocoin & Dextools Advertising 📰Press Release 👨🏼‍💻 Shilling Team)
...
🔓 Liquidity Locked Forever (Burned)

📈 Only 5% Reflection Tax for Each Transaction—💯 percent of the tax will be redistributed among the holders to help fill your bags💰
...
contract Powerx is Context, ERC20Detailed, Ownable {
  ...
  string constant tokenName = "Power x";
  string constant tokenSymbol = "Px";
