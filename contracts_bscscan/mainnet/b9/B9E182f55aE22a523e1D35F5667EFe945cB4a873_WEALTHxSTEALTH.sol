...
/**
* Welcome to WEALTHxSTEALTH
*
* BUY/SELL TAX = 13%
*
* 4% tax for Liquidity (lets moon together!)
* 2% tax reflected to HODLERS (get that juice!)
* 6% tax to marketing wallet (amazing marketing incoming!)
* 1% tax to for development of the game (web3 huh?)
*
* 13%-15% recommended slippage
*
* Total supply: 666 000 000 000 WXS
* MAX WALLET/BUY/SELL: 2%
*
*
*
*/
...
contract WEALTHxSTEALTH is Context, IERC20, Ownable {
    ...
    string private constant _name = "WEALTHxSTEALTH";
    string private constant _symbol = "WXS";
    uint8 private constant _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 666 * 10**9 * 10**_decimals;
	...
	uint256 public _bMaxTxAmount = 12 * 10**9 * 10**_decimals; //  2% max
    uint256 public _sMaxTxAmount = 12 * 10**9 * 10**_decimals; //  2% max
