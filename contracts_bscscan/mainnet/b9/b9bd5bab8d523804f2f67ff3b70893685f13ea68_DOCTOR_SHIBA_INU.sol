...
Welcome to Doctor Shiba
   This is a community token. If you want to create a telegram I suggest to name it to @Doctor ShibaChat
   ...
   I will renounce the ownership to burn addresses to transfer #Doctor Shiba to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left 10% total supply to the pool
   Can you make #Doctor Shiba 10000X? 
   ...
   it's the best part of the #Doctor Shiba idea, increasing the liquidity pool automatically, 
...
contract DOCTOR_SHIBA_INU is Context, IERC20, Ownable {
    ...
    string private _symbol = "DR SHIBA";
