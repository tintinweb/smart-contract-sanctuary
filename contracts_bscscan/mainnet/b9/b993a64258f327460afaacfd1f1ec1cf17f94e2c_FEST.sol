...
contract FEST is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // busd = BUSD(0x8301f2213c0eed49a7e28ae4c3e91722919b8b47);
    ...
    uint256 private _tTotal = 8000000*1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Festing";
    string private _symbol = "FEST";
    ...
    uint256 public _maxTxAmount = 1*1e18;
    // uint256 private _numTokensSellToAddToLiquidity = 100*1e18;
    ...
    constructor (address _marketWallet, address _devWallet) public {
        ...
        //0x05ff2b0db69458a0750badebc4f9e13add608c7f  pancake swap router mainnet 
        
        
        
        // testnet addresses.
        
        //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3  pancake swap testnet 
    ...
    function totalFeePerTx(uint256 tAmount) internal view returns(uint256) {
        uint256 percentage = tAmount.mul(_holderFee.add(_liquidityFee).add(_devFee).add(_marketFee)).div(100);
        return percentage;
    }
    ...
    function _takeMarketFee(uint256 tAmount) private {
        uint256 tMarketFee = tAmount.mul(_marketFee).div(100);
