...
/**
   ...
   Welcome to RussianBlueCat
   
   This is a community token. If you want to create a telegram I suggest to name it to @RussianBlueCat
...
contract RussianBlueCat is Context, IERC20, Ownable {
    ...
    string private _name = "Russian Blue Cat";
