...
contract Ashura2K22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ashura2K22";
    string constant _symbol = "ASHURA";
   ...
   // sell fee
    ...
    address public Owner=0x318C641bf338FEac8b0FE15eB94979cd69FB1B65; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x70dC65f6cB56Ed3744FDeD954184960294b35C1C; // marketing address
