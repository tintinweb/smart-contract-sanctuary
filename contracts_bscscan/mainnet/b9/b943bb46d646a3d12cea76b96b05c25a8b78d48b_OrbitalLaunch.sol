...
/**
  Stealth Launched Orbital Launch ( See Elon Musk Tweet )
   ...
   70% of the supply will burn
   LP will locked
   Ownership will be renounce
    TG: @OrbitalLaunchCoin
*/
...
contract OrbitalLaunch  is Context, IERC20, Ownable {
    ...
    string private _name = "Orbital Launch";
    string private _symbol = "ORBITAL";
    ...
    address payable private liquidAddress = 0x8bf21ca52fb23D56846097D5CeE99430c770c575;
