...
Baby Swiss, a no bullshit passive rewards token designed to prioritize the community.
10% Redistribution In ALPACA
4% Marketing and Buyback
4% Liquidity
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F);
...
contract BabySwiss is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabySwiss";
    string constant _symbol = "BABYS";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 20 / 100; // 0.05%

    uint256 public _maxWalletToken = ( _totalSupply * 50 ) / 100; //  2%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x994512169a0633F6121e237B9159B0D16A3CE55F;
