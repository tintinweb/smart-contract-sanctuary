...
contract TailedDemonSlayerToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6835b5CB94e584Cce559dc0F8e2918b1cCe18827); // Marketing Address
    address payable public charityAddress = payable(0x6835b5CB94e584Cce559dc0F8e2918b1cCe18827); // Charity/Dev Address
    ...
    string private _name = "Tailed Demon Slayer Token";
