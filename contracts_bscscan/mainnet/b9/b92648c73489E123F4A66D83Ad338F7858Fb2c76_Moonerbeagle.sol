...
contract Moonerbeagle is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "MoonerBeagle";                                          // name
    string private _symbol = "$beagle";                                             // symbol
    ...
    uint[] public _percentages = [45,22,33];                                             // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x5355D2B5bc37B8f244B69534b4DdD71FadED1983),                             // Dev+Team wallet
        payable(0x1c3E5062792e33108584B402537F856f03636833),                             // Marketing wallet
        payable(0xc4a6A82b4310E69c4Bc995CcA0ccf4CE26b02c51)                              // Buyback wallet
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "Beagle is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "Beagle is not live yet");
