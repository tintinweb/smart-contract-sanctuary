...
// Telegram : https://t.me/Pollarbearcake
// Website : https://pollarbear.website/
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also Pollarbearcakeed.
...
// File: contracts/PollarbearcakeDividendPayingToken.sol
...
// File: contracts/Pollarbearcake.sol
...
contract Pollarbearcake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable Cake = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    address private _marketingWallet = address(0xBF202e27E482550169B882a4A91A432145775e70);
    address private _devWallet = address(0xBF202e27E482550169B882a4A91A432145775e70);
    ...
    PollarbearcakeDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Pollarbearcake", "Pollarbearcake") {
        ...
        dividendTracker = new PollarbearcakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Pollarbearcake: The dividend tracker already has that address");

        PollarbearcakeDividendTracker newDividendTracker = PollarbearcakeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Pollarbearcake: The new dividend tracker must be owned by the Pollarbearcake token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Pollarbearcake: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Pollarbearcake: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Pollarbearcake: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Pollarbearcake: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Pollarbearcake: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Pollarbearcake: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "PollarbearcakeBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "Pollarbearcake: This account cannot send tokens until trading is enabled");
        }
...
contract PollarbearcakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Pollarbearcake_Dividend_Tracker", "Pollarbearcake_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "Pollarbearcake_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "Pollarbearcake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Pollarbearcake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Pollarbearcake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Pollarbearcake_Dividend_Tracker: Cannot update claimWait to same value");
