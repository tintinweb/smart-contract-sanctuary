...
/**
   ...
   I created a black hole so #Single dog token will deflate itself in supply with every transaction
...
contract Singledog is Context, IERC20, Ownable {
    ...
    string private _name = "Single dog Token";
    string private _symbol = "Single dog";
