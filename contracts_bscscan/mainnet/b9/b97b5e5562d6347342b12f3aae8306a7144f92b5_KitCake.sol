...
KitCake - Hold and get rewarded in $CAKE
Total 18% Taxes
12% CAKE REWARDS, ,2% BUY BACK, 1% LP, 3% Marketing Fund  
...
// CHANGE
contract KitCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "KitCake";
    string constant _symbol = "$KitCake";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x990a944a6A713FF71EC7958aC0243acE04A03b3D);
