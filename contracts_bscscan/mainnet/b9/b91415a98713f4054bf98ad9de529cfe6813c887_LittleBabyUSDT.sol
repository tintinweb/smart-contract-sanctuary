...
/**
   ...
   Welcome to LittleBabyUSDT
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyUSDTBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyUSDT to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyUSDT idea, increasing the liquidity pool automatically, 
...
contract LittleBabyUSDT is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby USDT";
    string private _symbol = "LTBABYUSDT";
