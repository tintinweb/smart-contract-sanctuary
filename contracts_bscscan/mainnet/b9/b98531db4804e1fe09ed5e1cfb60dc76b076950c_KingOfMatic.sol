...
/*
Another Token without a Master, KingOfMatic !!
Lp Locked !!
renounceOwnership !!
*/
...
contract KingOfMatic is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = _totalSupply.mul(1).div(1000); //Max tx one time is 10%
