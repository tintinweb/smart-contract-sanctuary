...
// dogeDADA @ https://t.me/DogeDADAD
// Dxsale! Join us and get whitelisted!
...
// File: contracts/dogeDADADividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
contract dogeDADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    address private _marketingWallet = address(0x63a9f5d5ac8E46baf5069F4550B328166Ca4fd45);
    address private _devWallet = address(0xCC86581639EC06642E612B91F45Ee47097c70B26);
    ...
    dogeDADADividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    address public devWallet = _devWallet;

    uint256 public maxBuyTranscationAmount = 100000000000 * (10**18); // 1% of total supply
    uint256 public maxSellTransactionAmount = 100000000000 * (10**18); // 1% of total supply
    uint256 public swapTokensAtAmount = 50000 * (10**18);
    uint256 public _maxWalletToken = 100000000000 * (10**18); // No limit
    ...
    constructor() public ERC20("dogeDADA", "dogeDADA") {
    	...
    	dividendTracker = new dogeDADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "dogeDADA: The dividend tracker already has that address");

        dogeDADADividendTracker newDividendTracker = dogeDADADividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "dogeDADA: The new dividend tracker must be owned by the dogeDADA token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "dogeDADA: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "dogeDADA: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "dogeDADA: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "dogeDADA: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "dogeDADA: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "dogeDADA: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "dogeDADABSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "dogeDADA: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            uint256 BNBTokens = contractTokenBalance.mul(10).div(totalFees);
            swapTokensForBNB2(BNBTokens);
            
            uint256 marketingTokens = contractTokenBalance.mul(2).div(totalFees);
...
contract dogeDADADividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("dogeDADA_Dividend_Tracker", "dogeDADA_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "dogeDADA_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "dogeDADA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main dogeDADA contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "dogeDADA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "dogeDADA_Dividend_Tracker: Cannot update claimWait to same value");
