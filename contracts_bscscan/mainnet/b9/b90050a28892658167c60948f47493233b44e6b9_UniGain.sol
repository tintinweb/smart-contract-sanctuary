...
/**
UniGain - Gain UNI as passive income!
...
contract UniGain is ERC20, Ownable {
    ...
    address public immutable DividendsToken = address(0xBf5140A22578168FD562DCcF235E5D43A02ce9B1);
    address private _marketingWallet = address(0x9a3F2C28316B58C295c4bE05fe690c5DA2757310);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "UniGain: The new dividend tracker must be owned by the test token contract");
    ...
    function swapTokensForBusd(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of UniGain
            path,
            recipient,
            block.timestamp
        );
...
contract UniGainDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public pure override {
        require(false, "UniGain_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main test contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "UniGain_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "UniGain_Dividend_Tracker: Cannot update claimWait to same value");
