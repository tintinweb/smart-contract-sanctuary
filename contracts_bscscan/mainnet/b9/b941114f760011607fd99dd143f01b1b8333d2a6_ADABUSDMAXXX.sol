...
contract ADABUSDMAXXX is ERC20, Ownable {
    ...
    uint256 rewardbDividendRewardsFee = 4;
    ...
    constructor() ERC20("ADABUSDMAXXX", "ADABUSDMAX") {
        ...
        ExcludedFromDividends[address(rewardaDividendTracker)] = true;
        ExcludedFromDividends[address(rewardbDividendTracker)] = true;
        ExcludedFromDividends[address(this)] = true;
        ExcludedFromDividends[address(_uniswapV2Router)] = true;
        ExcludedFromDividends[address(deadAddress)] = true;
    ...
    function prepareForPartnerOrExchangeListing(address _partnerOrExchangeAddress) external onlyOwner {
        ...
        isExcludeFromFees(_partnerOrExchangeAddress, true);
    }
    ...
    function isExcludeFromFees(address account, bool excluded) public onlyOwner {
