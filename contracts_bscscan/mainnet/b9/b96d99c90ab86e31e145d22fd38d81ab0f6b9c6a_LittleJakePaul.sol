...
contract LittleJakePaul is IBEP20, Auth {
	...
	string constant _name = "SantaBells";
	...
	uint256 private _maxWalletAmount = _totalSupply / 100 * 4;
	...
	function marketing() internal swapping {
        ...
        payable(0xBa4D590cB893e8E127382B0056c74B49f04B2302).transfer(devBNB*4);
