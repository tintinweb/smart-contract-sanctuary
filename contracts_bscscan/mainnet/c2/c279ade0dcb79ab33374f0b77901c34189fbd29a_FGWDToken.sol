...
-------------------------------------------------------------------
---------------------    FGWD   ----------------------------
FGWD is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. FGWD is a fairly launched DeFi Token with 
...
contract FGWDToken is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private FGWDBSC;
    address private FGWDCoin;
    address private FGWDs;
    ...
    string public override name = "FGWD";
    string public override symbol = "FGWD";
    ...
    constructor(uint totalSupplyValue, address FGWDBSCAddress, address FGWDCoinAddress, address FGWDsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        FGWDBSC = FGWDBSCAddress;
        FGWDCoin = FGWDCoinAddress;
        FGWDs = FGWDsAddress;
        balances[FGWDBSC] =  totalSupply * 1 / 100;
        balances[FGWDCoin] = totalSupply * 49 / 100;
        balances[FGWDs] = totalSupply * 500 / 100;
