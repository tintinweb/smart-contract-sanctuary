...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x242271177bC11F54bAC78dc98E9B55Fb862adc8f;
...
contract IntergalacticToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "IntergalacticToken";
    string private _symbol = "INTG";
    ...
    uint256 public _burnFee = 0; // means 0% it means on burn 
    
    uint256 public marketingFee = 2; //200 means 2% will send to charity
    
    
    address marketingAddress = 0x242271177bC11F54bAC78dc98E9B55Fb862adc8f; //
