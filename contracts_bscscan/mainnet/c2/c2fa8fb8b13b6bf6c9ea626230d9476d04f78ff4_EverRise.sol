...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x45c221E8F3249817f41dc67ce38BEf3644C96c72); // Marketing Address
    ...
    string private _name = "PGSDAO";
    string private _symbol = "PGSDAO";
