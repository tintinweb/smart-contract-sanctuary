...
/**
🎮 Play FegX 🎮 | Chapter 1 : Stealth Launch soon 🔥

Let's play with us on an adventures to conquer the moon, everyone has one job "Be a solid Community".
...
// CHANGE
contract PlayFegX is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PlayFegX";
    string constant _symbol = "PlayFegX";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 5) / 50; // 5% MAX 5,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xCcd832F98fDA5ce0dB923a7A76d5D421476B6562);
