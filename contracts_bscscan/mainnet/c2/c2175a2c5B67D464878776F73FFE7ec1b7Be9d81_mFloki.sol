...
Official Telegram group : https://t.me/MisterflokiOfficial
...
import "./mFlokiDividendTracker.sol";

contract mFloki is ERC20, Ownable {
    ...
    mFlokiDividendTracker public dividendTracker;
    ...
    //Anti-Whale System
    uint256 public maxWalletTokens =  5000000000 * (10**18);
    ...
    constructor() public ERC20("MisterFloki", "mFloki") {

    	dividendTracker = new mFlokiDividendTracker();

        _marketingWalletAddress = 0xECDfc98498d511695762413d9336F6f6B445DE35;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "mFloki: The dividend tracker already has that address");

        mFlokiDividendTracker newDividendTracker = mFlokiDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "mFloki: The new dividend tracker must be owned by the mFloki token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "mFloki: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "mFloki: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "mFloki: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "mFloki: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "mFloki: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "mFloki: Cannot update gasForProcessing to same value");
