...
contract FlkthebeanDividendDistributor is IDividendDistributor {
...
contract Flkthebean is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki The Bean";
    string constant _symbol = "Flkthebean";
    ...
    */
    ...
    FlkthebeanDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new FlkthebeanDividendDistributor(address(router));
    ...
    function setDistributor(FlkthebeanDividendDistributor dist)external authorized {
        distributor = dist;
    }
