...
contract ClimbFortressVaultBTCB is ERC20, Ownable {
    ...
    /**
     * @dev It initializes the vault's own 'fly' token.
    ...
    ) public ERC20(string(_name), string(_symbol)) {
        token = IERC20(_token);
        strategy = _strategy;
    ...
    function balance() public view returns (uint256) {
        return
            token.balanceOf(address(this)).add(
                IFortressStrategy(strategy).balanceOf()
            );
    }
    ...
    function deposit(uint256 _amount) public {
        IFortressStrategy(strategy).updateBalance();
    ...
    function earn() public {
        ...
        IFortressStrategy(strategy).deposit();
    }
    ...
    function withdraw(uint256 _shares) public {
        ...
        if (b < r) {
            ...
            IFortressStrategy(strategy).withdraw(_withdraw);
    ...
    function upgradeStrat() public onlyOwner {
        ...
        //IFortressStrategy(strategy).retireStrat();
