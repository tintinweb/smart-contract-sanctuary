...
Gain StarCraft token while playing StarCraft   
 
******Will fair launch on Pancakeswap 
******1 BNB Initial Liquidity 
******100% Active Devs 
******LP Will be locked right after launch  
 
    13% total tax. 
     
    8% automatically redistributed as CAKE, no need to claim. 
     
    5% Split between marketing (2%), and liquidity (3%) 
...
contract StarCraft is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "StarCraft";
    string constant _symbol = "StarCraft";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 4; 
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xe015792e0206dB0cD01Adb98b56cDb78922D6594;
