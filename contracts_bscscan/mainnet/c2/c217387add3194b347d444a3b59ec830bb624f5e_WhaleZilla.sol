...
contract WhaleZilla is Context, IERC20, Ownable {
    ...
    string private _name = "Whale Zilla";
    string private _symbol = "WZ";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xAA1Fe23F330Ce32Ef31e1a5cCA15bE499e29C542);
