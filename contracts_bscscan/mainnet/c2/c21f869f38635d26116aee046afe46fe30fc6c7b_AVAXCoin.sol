...
contract AVAXCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbd2bF888C76755371840Fedb497f606D98d648a3); // Marketing Address
    address payable public charityAddress = payable(0xbd2bF888C76755371840Fedb497f606D98d648a3); // Charity/Dev Address
    ...
    string private _name = "AvaxCoin";
    string private _symbol = "AVAXC";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referToken =   7000; //60% Token
    ...
    uint256 private salePrice = 2000000000000;// 0.01*100000000000=20,000,000,000 token for 0.01 bnb (set as per requirements)
