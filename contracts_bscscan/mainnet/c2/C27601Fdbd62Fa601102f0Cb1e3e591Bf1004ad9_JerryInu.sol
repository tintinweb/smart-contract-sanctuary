...
/**
 ...
 JERRYINU by DeGenWeise

 @JERRYINUOFFICIAL
https://JERRYINUTOKEN.com/ - Coming Q1 2022
...
contract JerryInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xcc06d39189EAAa719d7c8Cb081fef33c33fd09a7); // Marketing Address

    address payable public teamAddress =
        payable(0x11ddc2fc0BA22d8C81729cD8CF8c4EA11F556D94); // Team Address

    address payable public liquidityAddress =
        payable(0x690049f129Cc69df11407958bEeB1229e46faee3); // Liquidity Address
    ...
    string private constant _name = "JERRYINU";
