...
contract SleepingDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Sleeping Doge";
    string private _symbol = "SleepingDoge";
    ...
    address payable public marketingWallet = payable(0xC18F2db89Fb564085607542807571291Cd6A1eB6);
