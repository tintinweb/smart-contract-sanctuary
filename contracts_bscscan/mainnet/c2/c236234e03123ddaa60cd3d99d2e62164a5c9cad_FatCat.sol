...
//contract FatCat is Context, IERC20 {
    ...
    string constant private _name = "Fat Cat";
    string constant private _symbol = "FATCAT";
    ...
    address payable private _marketingWallet = payable(0x25B92797Fd36c40F17955093e88082b62768965a);
    address payable private _buybackWallet = payable(0x4387589EEfafE34FF26194F64eb226E5B3802Afb);
