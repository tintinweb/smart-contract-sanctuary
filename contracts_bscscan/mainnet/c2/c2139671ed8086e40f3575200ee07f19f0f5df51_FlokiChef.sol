...
contract FlokiChef is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FlokiChef";
    string constant _symbol = "FLOKICHEF";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000 * 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 8 * 1000000 * (10 ** _decimals);     // 1%
    uint256 public _maxWalletToken = 400 * 1000000 * (10 ** _decimals);  // 3%
    ...
    constructor ()  {
        address marketingFeeReceiver = 0xdEcc0b1444f778eF6ED4f94a5C9da639Fb9a2656;
         owner = msg.sender;
