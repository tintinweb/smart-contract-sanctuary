...
/**
   ...
   Welcome to BitcoinPink
   
   This is a community token. If you want to create a telegram I suggest to name it to @BitcoinPink
...
contract BitcoinPink is Context, IERC20, Ownable {
    ...
    string private _name = "Bitcoin Pink";
