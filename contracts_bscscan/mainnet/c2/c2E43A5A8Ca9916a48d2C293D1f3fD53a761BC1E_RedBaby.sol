...
contract Ownable is Context {
    address private _owner = 0x21d706727C54362E1A01789f4Ea0f57AE12c75DF;
...
contract RedBaby is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "RedBaby"; // token name
    string private _symbol = "RedBaby"; // token symbol
