...
/**Welcome to BritishHairStyle
   ...
   I will renounce the ownership to burn addresses to transfer #BritishHairStyle
   to the community
   Can you make #BritishHairStyle
   100X? 
   ...
   it's the best part of the #BritishHairStyle
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract BritishHairStyle is Context, IBEP20, Ownable {
  ...
  constructor() public {
    _name = "BritishHairStyle";
    _symbol = "BritishHairStyle";
    _decimals = 9;
