...
This is babyMKR  with a HUGE 10% in $MKR tokens rewarded every 60 minutes this is a no-brainer!
Buy yourself a bag and start the shills! This token should easily hit 200k!

We burn all LP right after launch so be sure the get in!
        
TELEGRAM: https://t.me/babyMKRbsc
...
Tokenomics:
    ...
    *set 18% slippage
    *sell will incur 20% extra tax, i.e set 22% slippage for sell tax

ADD: 0x5f0Da599BB2ccCfcf6Fdfd7D81743B6020864350 to you wallet to check MKR rewards!
Join the TG for shill texts and chills!                                           
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public dividendToken = 0x5f0Da599BB2ccCfcf6Fdfd7D81743B6020864350; //MKR
...
contract babyMKR is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public _dividendToken = 0x5f0Da599BB2ccCfcf6Fdfd7D81743B6020864350; //MKR
    ...
    BDDivenendTracker public dividendTracker;
    ...
    constructor() ERC20("babyMKR", "bMKR") {
    	...
    	dividendTracker = new BDDivenendTracker();

    	buyBackWallet = 0x9607A33aB1f402e80ed5F60C481998d2C7175D8b;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BDDivenendTracker newDividendTracker = BDDivenendTracker(payable(newAddress));
...
contract BDDivenendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
