...
// Stealth Launching Join our community here https://t.me/SonsOfCheems
// 4% LP, 4% Marketing 5% Buyback
...
contract SonOfCheems is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x572D73A38E5ad002eC14BE1A19CbB8E64EAeaBD5); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x572D73A38E5ad002eC14BE1A19CbB8E64EAeaBD5); // Buyback Wallet Address
    ...
    uint256 public _maxTxAmount = 1500000 * 10**9; // 2%
    uint256 public _walletMax = 3000000 * 10**9; // 3%
