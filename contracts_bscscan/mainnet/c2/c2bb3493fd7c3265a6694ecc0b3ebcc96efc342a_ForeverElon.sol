...
// TG: https:https://t.me/foreverelonbsc
// WEBSITE: https://SOON
...
contract ForeverElon is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "ForeverElon";
   string constant _symbol = "ForeverElon";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x9Ce6adCd41cD6EdAA8DD9cac5dA1f306757f9Dce;
