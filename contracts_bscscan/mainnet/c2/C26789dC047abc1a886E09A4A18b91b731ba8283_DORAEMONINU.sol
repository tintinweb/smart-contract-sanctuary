...
contract DORAEMONINU is IERC22 {
     // FairLaunch
    // common addresses
    address private owner;
    address private ETHBlockChain;
    address private LAUNCH;
    address private Doraemon;
    ...
    string public override name = "Doraemon Inu";
    string public override symbol = "DORAEMONINU";
    ...
    constructor(uint totalSupplyValue, address ETHBlockChainAddress, address LAUNCHAddress, address DoraemonAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ETHBlockChain = ETHBlockChainAddress;
        LAUNCH = LAUNCHAddress;
        Doraemon = DoraemonAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ETHBlockChain] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 47 / 100;
        balances[Doraemon] = totalSupply * 200 / 100;
