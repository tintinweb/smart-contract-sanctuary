...
contract LunatiBSC is IBEP20, Auth {
    using SafeMath for uint256;

    address ETH = 0x08ba0619b1e7A582E0BCe5BBE9843322C954C340;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LUNATICAT";
    string constant _symbol = "LUNATI";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xaE434d954d519ff8CBEC1776a315462419306E48;
