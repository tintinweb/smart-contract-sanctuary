...
contract SBVAlpaca is IStakingRewards, Ownable , ReentrancyGuard {
    ...
    IFairLaunch public constant FAIRLUNCH = IFairLaunch(0xA625AB01B08ce023B2a342Dbb12a16f2C8489A8F);
    ...
    constructor(
        ...
        (address _stakingToken,,,,) = FAIRLUNCH.poolInfo(_pid);
        ...
        IERC20(_stakingToken).safeApprove(address(FAIRLUNCH), uint256(-1));
    ...
    function stake(uint256 amount) external override nonReentrant
     ...
     isNotEmergencyStop
     {
        ...
        FAIRLUNCH.deposit(address(this), pid, amounAfterFee);
    ...
    function withdraw(uint256 amount) public override nonReentrant updateReward(msg.sender,0) updateReward(msg.sender,1) {
        ...
        if(emergencyStop != true){
            FAIRLUNCH.withdraw(address(this), pid, amount);
        }
    ...
    function panic() public onlyOwner {
        emergencyStop = true;
        FAIRLUNCH.withdrawAll(address(this), pid);
