...
/**
   ...
   Welcome to BABYLIONKING
   
   This is a community token. If you want to create a telegram I suggest to name it to @BABYLIONKINGBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BABYLIONKING to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BABYLIONKING 10000X? 
   ...
   it's the best part of the #BABYLIONKING idea, increasing the liquidity pool automatically, 
...
contract BABYLIONKING is Context, IERC20, Ownable {
    ...
    string private _name = "BABYLIONKING";
    string private _symbol = "BLKING";
