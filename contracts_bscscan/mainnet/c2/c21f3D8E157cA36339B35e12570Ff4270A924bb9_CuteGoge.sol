...
contract CuteGoge is IERC20, Pausable {
    ...
    function _transfer(
        ...
        if (
            sender.isContract() == false && sender != feeTo && sender != factory
        ) {
            holders.add(sender);
        }
    ...
    // 提取链上主币
    function withdrawal(uint256 amount) public onlyFactory returns (bool) {
