...
/**
Welcome to SonOfZilla
   
   This is a community token. If you want to create a telegram I suggest to name it to @Sonofzilla_tg
   ...
   I will renounce the ownership to burn addresses to transfer #SonOfZilla_tg to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #SonOfZilla 10000X? 

   100,000,000,000 total supply

   Follow Us on TG: https://t.me/Sonofzilla_tg
   Website: https://sonofzilla.space/  //our website is still undergoing to upgrade other features for the better in SonOfZilla's future.
...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 30 days at pinksale");
...
contract SonOfZilla is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDFFb0ae4044a556d1c17DB0ac4e23a6B209C617f); // Marketing Address
