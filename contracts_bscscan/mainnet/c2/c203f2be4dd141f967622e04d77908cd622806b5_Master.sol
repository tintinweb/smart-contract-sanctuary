...
contract Master is Ownable {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = based.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && based.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(based.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return based.totalSupply().toInt256Safe()
