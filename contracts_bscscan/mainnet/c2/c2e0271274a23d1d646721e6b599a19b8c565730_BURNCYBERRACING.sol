...
contract BURNCYBERRACING is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Burn CyberRacing";
    string constant _symbol = "bCRACE";
