...
// TG: https:https://t.me/SonOfSuperSonic
// Stealh launch at 50 memberss
...
contract SonOfSuperSonic is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "SonOfSuperSonic";
   string constant _symbol = "SOSS";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 2; // 1%
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x5f679C5A29730f06358dE78a6e398eFF95720E1f;
