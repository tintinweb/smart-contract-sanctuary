...
contract MiniTestX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x24e44A23177B222065F0fae9F3Bff27B9c4671e2); // Marketing Address
    ...
    string private _name = "MiniTestX";
    string private _symbol = "MiniX";
