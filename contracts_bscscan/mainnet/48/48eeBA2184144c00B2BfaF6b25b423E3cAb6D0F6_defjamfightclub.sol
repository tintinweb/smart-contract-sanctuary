...
Def Jam Fight Club
TG: https://t.me/defjamfightclubbsc
https://www.defjamfightclub.com/
Supply: 1,000,000,000,000
6% Marketing | 4% Liquidity
...
// Begin sauce.
contract defjamfightclub is Context, IERC20, Ownable {
    ...
    string private  _name               = "Def Jam Fight Club";
    string private  _symbol             = "DefJam";
    ...
    // marketing
    uint256 public _fee_marketing = 600;
    uint256 private _fee_marketing_old = _fee_marketing;
    address payable public _wallet_marketing = payable(0xe6588323FCa7bCA881dAc55e683667e64f86afc3);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0xe6588323FCa7bCA881dAc55e683667e64f86afc3);

    // for buyback
    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0xe6588323FCa7bCA881dAc55e683667e64f86afc3);
