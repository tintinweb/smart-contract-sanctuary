...
/**
 * @title SHIB ERC20 token
 * @dev  
 *      The goal of SHIB is to SHINBANG in price over time.
 *      Based on the Ampleforth protocol.
 */
contract SHIB is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 8000000 * 10**DECIMALS;
    ...
    constructor()
        ERC20Detailed("Shinbang", "SHIB", uint8(DECIMALS))
        public
    {
