...
contract JCAT is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransfermarketingBNB(marketingAddress1, MarketingTransfer); 
        TransfermarketingBNB(marketingAddress2, MarketingTransfer);
        TransfermarketingBNB(marketingAddress3, MarketingTransfer);
    ...
    function setMarketingAddress1(address payable marketing1) external onlyOwner() {
        marketingAddress1 = marketing1;
    }
 
    function setMarketingAddress2(address payable marketing2) external onlyOwner() {
        marketingAddress2 = marketing2;
    }
 
    function setMarketingAddress3(address payable marketing3) external onlyOwner() {
