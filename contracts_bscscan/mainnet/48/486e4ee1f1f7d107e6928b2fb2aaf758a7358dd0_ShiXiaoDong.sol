...
/**
 #ShiXiaoDong
#LIQ+#RFI+#SHIB+#DOGE = #ShiXiaoDong

   #ShiXiaoDong features:
...
contract ShiXiaoDong is Context, IERC20, Ownable {
    ...
    string private _name = "ShiXiaoDong Token";
    string private _symbol = "ShiXiaoDong";
