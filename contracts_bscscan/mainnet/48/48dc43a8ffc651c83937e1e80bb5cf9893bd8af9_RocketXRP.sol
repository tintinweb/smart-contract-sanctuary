...
// CHANGE
contract RocketXRP is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "RocketXRP";
    string constant _symbol = "RocketXRP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 1,000,000,000
