...
// File: contracts/interfaces/IPoolSwapLottery.sol

pragma solidity ^0.8.4;

interface IPoolSwapLottery {
    /**
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public poolSwapLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == poolSwapLottery, "Only PancakeSwapLottery");
    ...
    /**
     * @notice Set the address for the PoolSwapLottery
     * @param _poolSwapLottery: address of the PoolSwap lottery
     */
    function setLotteryAddress(address _poolSwapLottery) external onlyOwner {
        poolSwapLottery = _poolSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPoolSwapLottery(poolSwapLottery).viewCurrentLotteryId();
    }
}