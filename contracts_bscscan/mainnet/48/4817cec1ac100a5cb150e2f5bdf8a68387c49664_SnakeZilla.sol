...
https://t.me/snakezillabsc
 

🦖🐍🐍SnakeZilla🐍 🦖🐍 
Stealth launch !!!

THE MOST HYPE COMMUNITY TOKEN
🦖🐍🐍SnakeZilla🐍 🦖🐍  AIMS TO BECOME THE MOST DECENTRALIZED MEME-TOKEN IN EXISTENCE
...
contract SnakeZilla   is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SnakeZilla";
    string constant _symbol = unicode"SnakeZilla 🐍";
    ...
    uint256 public swapThreshold = _totalSupply * 5 / 400000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xade005F5A4fF70BC783DAF37c57534ebcc61C980;
