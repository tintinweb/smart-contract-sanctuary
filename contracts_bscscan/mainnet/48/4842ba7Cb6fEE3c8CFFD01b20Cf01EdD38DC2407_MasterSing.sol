...
contract MasterSing is Ownable, ReentrancyGuard{
    ...
    IChef public WL_master=IChef(0x5c8D727b265DBAfaba67E050f2f739cAeEB4A6F9);//MasterApe
    IBEP20 public WL_earn=IBEP20(0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95);//Banana
    IUniswapV2Router02 public ApeRouter = IUniswapV2Router02(0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7);
    // Info of each pool.
    ...
    function pendingEarned(uint _pid,address _user) external view returns (uint256) {
        ...
        if(pool.totalcap!=0){
            uint256 earn=WL_master.pendingCake(pool.stratId, address(this)).mul(100-pool.earnfee).div(100);
