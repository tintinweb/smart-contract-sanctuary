...
𝖳𝗁𝖾 𝖣𝗈𝗀𝖾𝖼𝗈𝗂𝗇 𝗋𝗂𝗏𝖺𝗅 𝗐𝗂𝗅𝗅 𝗋𝖾𝗅𝖾𝖺𝗌𝖾 𝖣𝗈𝗀𝗀𝗒 𝖣𝖺𝗈 𝗂𝗇 𝖺 “𝗌𝗍𝖺𝗀𝖾-𝖻𝗒-𝗌𝗍𝖺𝗀𝖾” 𝗆𝖾𝗍𝗋𝗂𝖼 𝖺𝗇𝖽 𝗉𝗁𝖺𝗌𝖾𝖽 𝖺𝗉𝗉𝗋𝗈𝖺𝖼𝗁.
𝖳𝗁𝖾 𝖿𝗂𝗋𝗌𝗍 𝗉𝗁𝖺𝗌𝖾 𝖼𝖺𝗅𝗅𝖾𝖽 “𝖣𝖠𝖮 𝟣″ 𝗐𝗂𝗅𝗅 𝖻𝖾 𝗂𝗆𝗉𝗅𝖾𝗆𝖾𝗇𝗍𝖾𝖽 𝗐𝗂𝗍𝗁𝗂𝗇 𝗍𝗁𝖾 𝗇𝖾𝗑𝗍 𝖿𝖾𝗐 𝖽𝖺𝗒𝗌.

LP LOCK 100% RO at Start
█▀▄ █▀█ █▀▀ █▀▀ █▄█   █▀▄ ▄▀█ █▀█
█▄▀ █▄█ █▄█ █▄█ ░█░   █▄▀ █▀█ █▄█
*/
...
contract OwnableDAO is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableDAO: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableDAO: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DoggyDao is Context, DAO, OwnableDAO {
    ...
    string private _name = 'Doggy Dao';
    string private _symbol = 'Doggy Dao';
