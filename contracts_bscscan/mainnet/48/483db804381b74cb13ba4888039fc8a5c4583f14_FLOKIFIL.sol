...
HODL4FIL: earn Filecoin rewards by holding . HODL4FIL TOKEN
...
contract FLOKIFIL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FLOKIFIL";
    string constant _symbol = "FLOKIFIL";
