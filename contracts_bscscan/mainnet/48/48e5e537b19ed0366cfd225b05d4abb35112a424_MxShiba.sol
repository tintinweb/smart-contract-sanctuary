...
contract MxShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc6D20322be0B8203443A7a61679166b000b06424); // Marketing Address
    ...
    string private _name = "MX Shiba";
    string private _symbol = "MX Shiba Coin";
