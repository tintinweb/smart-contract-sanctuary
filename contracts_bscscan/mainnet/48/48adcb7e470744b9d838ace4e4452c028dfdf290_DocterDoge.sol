...
contract DocterDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x93aC216B7431aBfbfd02C19ba946D87bEFBd3368); // Marketing Address
    address payable public charityAddress = payable(0x93aC216B7431aBfbfd02C19ba946D87bEFBd3368); // Charity/Dev Address
    ...
    string private _name = "Docter Doge Coin";
    string private _symbol = "DOCC";
