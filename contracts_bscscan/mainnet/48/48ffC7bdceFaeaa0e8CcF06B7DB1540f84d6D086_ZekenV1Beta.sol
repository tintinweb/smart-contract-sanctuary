...
abstract contract Tokenomics {
    ...
    address internal charityAddress = 0xA9E76124e506B4587DCfBdfDE87d83E314594ab1;
    address internal marketingAddress = 0x57909787E9b3C84769946AaA47cBD2b70d5C0dC4;
    ...
    address internal BuyBack = 0xA11028aFA2Cf16617EdD758cD8e9E6fAF8030052;
    ...
    function _addFees() private {
        ...
        // 3% Auto BuyBack
        _addFee(FeeType.ExternalToETH, 30, BuyBack );
    }
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    address private _testnetRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
   ...
   // uint256 private numTokensSellToAddToLiquidity = 5000000 * 10**6 * 10**9;
    ...
    function liquify(uint256 contractTokenBalance, address sender) internal {
        ...
        if ( isOverRequiredTokenBalance && swapAndLiquifyEnabled && !inSwapAndLiquify && (sender != _pair) ){
            // check if the `(sender != _pair)` is necessary because that basically
...
abstract contract Zeken is BaseRfiToken, Liquifier, Antiwhale {
...
contract ZekenV1Beta is Zeken{

    constructor() Zeken(Env.Testnet){
