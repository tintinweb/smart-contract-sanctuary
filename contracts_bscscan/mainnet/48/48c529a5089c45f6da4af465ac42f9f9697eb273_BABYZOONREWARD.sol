...
☄️12% REWARD OF CRYPTOZOON 
🏆LIQIUDITY 1BNB
🔐100%LP LOCK ON DXSALE FOR 3 MONTH
🚨MAX WALLET
✅ 1% Dev wallet

🚀TELEGRAM : https://t.me/babyzoonreward
*/
...
contract BABYZOONREWARD is IBEP20, Auth {
    using SafeMath for uint256;

    address public A_ZOONREWARD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY ZOON REWARD";
    string constant _symbol = "BABYZOON";
    uint8 constant _decimals = 9;
    
    uint256 _totalSupply = 1 * 10**9 * 10**9;
    uint256 public _maxTxAmount = 1 * 10**9 * 10**9;
    uint256 public _maxWallet = 1 * 10**9 * 10**9;
    ...
    uint256 public _ZOONREWARD = 12;
    uint256 marketingFee = 3000;
    uint256 totalFee = 3112;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xBAC9ebED5348F7cc043fc4EfCa6Ee32695b40614;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(_ZOONREWARD ).div(totalBNBFee);
