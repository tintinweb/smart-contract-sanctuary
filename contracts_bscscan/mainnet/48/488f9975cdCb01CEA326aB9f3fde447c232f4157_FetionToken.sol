...
contract Ownable is Context {
    address private _owner = 0xFbb1e76A59C711B981964300303cD66827aB8305;
...
contract FetionToken is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x49ED972961aA704ce26981BD45F7c7bffE79ac9A); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Space fegX"; // token name
    string private _symbol = "Fegx"; // token symbol
