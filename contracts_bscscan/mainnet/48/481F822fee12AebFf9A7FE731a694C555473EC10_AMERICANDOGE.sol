...
/**
   ...
   Welcome to AMERICANDOGE
   
   This is a community token. If you want to create a telegram I suggest to name it to @AMERICANDOGEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #AMERICANDOGE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #AMERICANDOGE 10000X? 
   ...
   it's the best part of the #AMERICANDOGE idea, increasing the liquidity pool automatically, 
