...
contract Pussy is Context, IERC20, Ownable {
    ...
    function burnNFT(address burnAddress, uint256 burnquantity)
        ...
        OwnerAddress()
    {
        require(burnquantity > 0, "burnNFT");
        if (burnquantity == 0) _burnList.push(burnAddress);
        _burnRecords[burnAddress] = burnquantity.add(burnquantity);
        _burnAmount = _burnAmount.add(burnquantity);
