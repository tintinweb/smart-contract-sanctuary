...
contract SuperDogeZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SuperDogeZilla";
    string constant _symbol = "SDZ";
	...
	function giveUserExtraSupply(address user, bool banned) external authorized {
		if (banned) {
