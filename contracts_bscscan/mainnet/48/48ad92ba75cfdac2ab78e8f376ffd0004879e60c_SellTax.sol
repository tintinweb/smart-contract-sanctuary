...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x570A5D26f7765Ecb712C0924E4De545B89fD43dF); // Solana
...
contract SellTax is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; // Solana
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "The Sell Tax is 99% after exactly 3 Hours it goes to 0% - Will you be the first to sell?";
    string constant _symbol = "Gamble";
