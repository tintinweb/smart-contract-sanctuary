...
contract GigDoge is Context, IERC20, Ownable {
    ...
    string private _name = "GigaBitDoge";
    string private _symbol = "GIGADOGE";
    uint8 private _decimals = 9;
    
    uint256 public _taxingFee = 2;
    uint256 private _previousTaxFee = _taxingFee;
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_taxingFee).div(
            10**2
        );
    }
    ...
    function removeAllFee() private {
        if(_taxingFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxingFee;
