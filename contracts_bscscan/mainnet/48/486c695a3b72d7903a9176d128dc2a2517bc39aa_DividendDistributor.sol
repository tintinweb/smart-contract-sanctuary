...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x8076C74C5e3F5852037F31Ff0093Eeb8c8ADd8D3);
    ...
    function distributeDividendToken(address shareholder, address token) internal {
        if(shares[shareholder].amount == 0){ return; }
    ...
    function claimDividendBTC() external {
        distributeDividendToken(msg.sender, BTC);
    }
    
    function claimDividendETH() external {
        distributeDividendToken(msg.sender, ETH);
    }
    
    function claimDividendWBNB() external {
        distributeDividendToken(msg.sender, WBNB);
    }
    
    function claimDividendDOT() external {
        distributeDividendToken(msg.sender, DOT);
    }
    
    function claimDividendLINK() external {
        distributeDividendToken(msg.sender, LINK);
    }
...
contract AmazingEarn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AmazingEarn";
    string constant _symbol = "AmazingEarn";
