...
contract MetaLittleFloki is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Little Floki";
    string private _symbol = "METALILFLOKI";
    ...
    uint256 private minimumTokensBeforeSwap = 5121252 * 10**6 * 10**9; 
