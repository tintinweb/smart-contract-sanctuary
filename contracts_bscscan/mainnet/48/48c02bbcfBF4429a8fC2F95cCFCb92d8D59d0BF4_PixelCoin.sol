...
contract PixelCoin is Context, IERC20, Ownable {
    ...
    address  public communityAddress = 0x9137407DA84867B8e3739c8e6D2784CB38800698;
    ...
    function setCommunityAddress(address newAdd) external onlyOwner() {
        communityAddress = newAdd;
    }
