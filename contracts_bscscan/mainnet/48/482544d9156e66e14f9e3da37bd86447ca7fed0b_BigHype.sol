...
contract BigHype is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x6b5Fd61279BD47Af64fFf1f8d1504738d0d7A987); // Marketing Address
    ...
    string private _name = "Big Hype";
    string private _symbol = "BigHype";
