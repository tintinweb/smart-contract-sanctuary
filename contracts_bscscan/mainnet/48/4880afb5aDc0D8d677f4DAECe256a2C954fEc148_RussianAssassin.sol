...
contract RussianAssassin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Russian Assassin";
    string constant _symbol = "RussianAssassin";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(1).div(1);
    uint256 public _maxWalletToken = _totalSupply.mul(1).div(1);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7c7b88D538Afe4652D175e9Bc53fa46C08189bC5;
        ecosystemfeeReceiver = 0x7c7b88D538Afe4652D175e9Bc53fa46C08189bC5;
