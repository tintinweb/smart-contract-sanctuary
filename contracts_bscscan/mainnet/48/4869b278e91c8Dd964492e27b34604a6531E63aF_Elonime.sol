...
/**
 _______  ___      _______  __    _  ___   __   __  _______ 
|       ||   |    |       ||  |  | ||   | |  |_|  ||       |
|    ___||   |    |   _   ||   |_| ||   | |       ||    ___|
|   |___ |   |    |  | |  ||       ||   | |       ||   |___ 
|    ___||   |___ |  |_|  ||  _    ||   | |       ||    ___|
|   |___ |       ||       || | |   ||   | | ||_|| ||   |___ 
|_______||_______||_______||_|  |__||___| |_|   |_||_______|
...
// CHANGE
contract Elonime is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Elonime";
    string constant _symbol = "ELONIME";
