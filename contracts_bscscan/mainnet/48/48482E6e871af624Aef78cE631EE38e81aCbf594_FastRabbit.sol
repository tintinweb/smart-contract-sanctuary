...
/*
FastRabbit From Honest Dev to Smart Traders ( 100% LP Lock) DYOR
*/
...
contract FastRabbit is IBEP20 {
    ...
    string public override name = "Fast Rabbit";
    string public override symbol = "FastRabbit";
