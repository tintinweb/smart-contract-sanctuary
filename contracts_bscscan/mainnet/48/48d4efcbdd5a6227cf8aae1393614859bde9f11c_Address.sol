...
contract XoloInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xB7BB06d80B2e76FB820A8cda40DEFbD259614fD9); 
    ...
    uint256 public numTokensSellToAddToLiquidity = 90000000 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 combineFees = _liquidityFee.add(marketingFee); // marketing + liquidity fees
    ...
    {
        if(marketingFee==0) {  return(tTransferAmount, rTransferAmount); }
        uint256 tMarketing = tAmount.div(100).mul(marketingFee);
