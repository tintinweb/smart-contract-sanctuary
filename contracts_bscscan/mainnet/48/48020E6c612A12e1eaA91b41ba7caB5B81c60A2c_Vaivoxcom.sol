...
Vaivox token is built upon the fundamentals of Buyback and increasing the investor's value
...
contract Vaivoxcom is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x0F6933b9531de06B91BF9Dd222AD1094ceD2EB53); // Marketing Address
    ...
    string private _name = "VAIVOX | vaivo.com";
