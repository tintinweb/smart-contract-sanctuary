...
LittleBTC V.2 forked LittleBTC
Lets Make LittleBTC x100000
LP's Start from 0.2 BNB
...
contract LittleBTCv2 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "LittleBTC v.2";
    string private _symbol = "LBTC";
