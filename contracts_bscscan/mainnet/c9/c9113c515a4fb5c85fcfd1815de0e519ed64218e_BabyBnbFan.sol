...
contract BabyBnbFan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x57F023111B8c11BA6A4E55B74DE1b2af6A5d3B10); // Marketing Address
        
    address payable public teamAddress =
        payable(0x3E20b5f35664AE3Af28494725E003435AB9F435f); // Team Address
        
    address payable public liquidityAddress =
        payable(0xe457Cf6F0062Cd87c825d0cA0d4585355201951C); // Liquidity Address
    ...
    string private constant _name = "BabyBnbFan";
