...
contract RoseTokenContract {
    ...
    constructor() {
        ...
        balances[0x237B2337f01c49390B6216301b09C17177D845ED] = totalSupply.sub(supplyDevs);
        balances[0x3896f3d649594Fe42fE54486f69C08ECaDb5a992] = supplyDevs;
        frozen_address[0x3896f3d649594Fe42fE54486f69C08ECaDb5a992] = block.timestamp.add(1642961106);
    }
