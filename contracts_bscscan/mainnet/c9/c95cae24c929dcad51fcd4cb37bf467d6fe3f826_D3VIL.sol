...
// D3VIL Finance
// Farm without inflation
// Ultra low supply (666)
...
interface IFeeApprover {
    ...
    function setD3vilTokenAddress(address _D3vilTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 444e18; // 666 Total Supply: 444 for LGE, 222 for the team
    ...
    function initialSetup() internal {
        ...
        uniswapRouterV2 = IUniswapV2Router02(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        uniswapFactory = IUniswapV2Factory(address(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73));
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developer and affiliated parties of D3VIL team are not responsible for your funds. This project is experimental, DYOR.";
        ...
        returns (uint256)
    {
        ...
        return contractStartTimestamp.add(1 days).sub(block.timestamp);
    }
    ...
    function addLiquidityToUniswapD3VILxWBNBPair() public {
        require(liquidityGenerationOngoing() == false, "D3VIL LGE ongoing");
        require(LPGenerationCompleted == false, "D3VIL LGE already finished");
    ...
    function claimLPTokens() public {
        ...
        require(ethContributed[msg.sender] > 0 , "Nothing to claim, move along belzebuth!");
        IUniswapV2Pair pair = IUniswapV2Pair(tokenUniswapPair);
    ...
    function emergencyDrain72hAfterLiquidityGenerationEventIsDone() public onlyOwner {
        require(contractStartTimestamp.add(16 days) < block.timestamp, "Liquidity generation grace period still ongoing"); // About 72h after liquidity generation happens
    ...
    // Minter role is controlled by D3VIL governance only, developer alone cannot invoke the function
    ...
    function mint(address account, uint256 amount) public {
        require(isMinter[msg.sender], "not a minter D3VIL");
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                ID3vilVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
// D3vilToken with Governance.
contract D3VIL is NBUNIERC20 {
    /**
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "D3VIL::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "D3VIL::delegateBySig: invalid nonce");
        require(now <= expiry, "D3VIL::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "D3VIL::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying D3VIL tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "D3VIL::_writeCheckpoint: block number exceeds 32 bits");
