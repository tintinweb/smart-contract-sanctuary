...
miniFIL: earn Filecoin rewards by holding miniFIL. 
...
contract miniFIL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "miniFIL (t.me/miniFIL)";
    string constant _symbol = "miniFIL";
