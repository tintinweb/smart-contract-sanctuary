...
contract GeometricForms is ERC721Tradable {
    string baseURI;
    uint256 public MAX_SUPPLY = 100;
    uint256 public basePrice = 5 * 1e17;
    bool public paused;
    
    constructor()
        ERC721Tradable("SpacePepesAvalanche", "SPAVAX", address(0))
    {
        baseURI = "https://geometricforms.io/json/";
        proxyRegistryAddress = address(new ProxyRegistry());
        paused = true;
    }
