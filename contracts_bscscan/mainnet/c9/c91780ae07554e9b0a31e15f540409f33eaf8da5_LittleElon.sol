...
Inspired by other recent Little coins, I present to you Little Elon
...
contract LittleElon is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Little Elon";
    string private _symbol = "LELON";
