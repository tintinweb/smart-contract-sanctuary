...
🇰🇵 ForeverPyongyang 🇰🇵
Our brother from paris just launched their token and have a trip to the moon, why can't we do the same ?

🚀 Low starting market cap.
🧨 Contract copied from ForeverFOMO.
🚀 Liquidity will be locked for 3 days.
🧨 Rebase System:
...
contract ForeverPyongyang is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Forever Pyongyang", "ForeverPyongyang", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x347Bd89e4163A2E2d83339dDf2714f3A23b2ba1A;
