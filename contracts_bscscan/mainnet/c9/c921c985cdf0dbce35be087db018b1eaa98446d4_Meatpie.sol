...
contract Meatpie is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Meatpie Token';
    string  private constant _SYMBOL = 'MEATPIE';
    ...
    uint256 private _CHARITY_FEE = 300; // 3% TO MARKETING WALLET
    uint256 private constant _MAX_TX_SIZE = 8000000000 * _DECIMALFACTOR;
