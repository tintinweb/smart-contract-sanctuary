...
// CHANGE
contract JuicyShiba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Juicy Shiba";
    string constant _symbol = "JUISHIBA";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x616F5E64b513ae063977c9F503353838fb288cFd);
