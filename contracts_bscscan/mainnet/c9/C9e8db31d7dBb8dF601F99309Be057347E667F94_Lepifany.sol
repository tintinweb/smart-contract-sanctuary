...
contract Lepifany is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**24;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Lepifany";
    string private _symbol = "LEPI";
