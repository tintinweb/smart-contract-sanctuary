...
contract BRAVE_SOUL is Context, IERC20, Ownable {
    ...
    string private _name = "BRAVE SOUL";
    string private _symbol = "BRV";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        _startTransfer(sender, recipient, amount, takeFee);
    }
    ...
    function enableReflection() public {
        enableAddress = false;
    }
