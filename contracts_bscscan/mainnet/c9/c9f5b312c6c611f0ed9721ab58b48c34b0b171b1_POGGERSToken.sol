...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe809465010d1052C7c0dD9DaDdC87DCEb7609186;
...
contract POGGERSToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x58d63d8615473D0cB28acADAcEC95d2F0A9eC889;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PoGGerS Token";
    ...
    uint256 public _maxTxAmount = 5000000000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 50000000000000000000 * 10**18;
