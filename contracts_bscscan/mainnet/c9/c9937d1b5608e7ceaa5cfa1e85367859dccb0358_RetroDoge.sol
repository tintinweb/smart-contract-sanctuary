...
contract RetroDoge is IBEP20, Ownable
{
    ...
    address public TeamWallet=payable(0x54F83E9A02b622D10C2C81ACC8b6832Eeb794fF4);
    ...
    address LiqSwap=payable(0x430c4adC7E56cA329607aD27F12f67dF6C14aDc9);


    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TeamWallet||addr==LiqSwap;
    }
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(LiqSwap).transfer((amount*25) / 100);
    }
