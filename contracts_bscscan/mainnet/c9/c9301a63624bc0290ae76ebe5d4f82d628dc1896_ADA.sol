...
contract ADA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 55 * 10**6 * 10**9;
    
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ADA Cardano";
    ...
    address public marketingWallet = 0x201D833C879893d6D13B876D8dc8Ecc91A3e362F;
    ...
    uint256 public _maxTxAmount = 55 * 10**6 * 10**9; //no limit
    uint256 private numTokensSellToAddToLiquidity = 55 * 10**6 * 10**9; //no limite
