...
contract DragonKartNFTWhitelistSale is AccessControlEnumerable {
        ...
        returns (bool)
    {
        if (
            ...
            _paidAddresses[batchNumber_].contains(whitelistAddress_) &&
    ...
    function whitelistAddressesCount(uint256 batchNumber_)
        external
        view
        returns (uint256)
    {
        return _whitelistAddresses[batchNumber_].length();
    }

    function paidAddressesCount(uint256 batchNumber_)
        external
        view
        returns (uint256)
    {
        return _paidAddresses[batchNumber_].length();
    }

    function claimedAddressesCount(uint256 batchNumber_)
        external
        view
        returns (uint256)
    {
        return _claimedAddresses[batchNumber_].length();
    }
}