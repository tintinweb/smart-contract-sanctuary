...
contract AcriaNetwork is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7D99829216fb60318764116583F97d365c166c4a); // Marketing Address 32
    ...
    string private _name = "Acria Network";
    string private _symbol = "ACRIA";
