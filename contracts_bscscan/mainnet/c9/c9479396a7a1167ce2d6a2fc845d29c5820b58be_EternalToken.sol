...
/**
 *Submitted for verification at BscScan.com on 2022-16-1
*/

/**
 * 
 * 
#ETNA - Eternal Token Features
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
  ...
  contract EternalToken is Context, IERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x08d9Dd5D91c3EA59FBBf54eB4A3fBB8f533AF84C;
    ...
    uint256 public _maxTxAmount = 10 * 10**6 * 10**8;   // 1% from tSupply
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**5  * 10**8;   // 0.1% from tSupply
    ...
    function disableAllFees() external onlyOwner() {
     ...
     //to receive BNB from V2Router when swaping
 ...
 */
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 finalAmount = amount.sub(marketAmt);
        ...
        removeAllFee();
        _transferStandard(sender, address(0),marketAmt );
