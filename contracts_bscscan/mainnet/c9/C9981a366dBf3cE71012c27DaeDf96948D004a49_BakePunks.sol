...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDS = IERC20(0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5);
...
// CHANGE
contract BakePunks is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address REWARDS = 0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BakePunks";
    string constant _symbol = "BAKEPUNKS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 50; // 1% MAX 2,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 50) / 100; // 3% MAX 5,000,000,000
    ...
    uint256 liquidityFee = 500; // 3%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 800; // 8%
    uint256 devFee = 200; // 5%
    uint256 totalFee = 1500; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xa25336a69EfB3E6858DfF3b33C39aa2Cd6Fd2202);
