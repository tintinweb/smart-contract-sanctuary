...
//
// $BabyETHEREUM proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN ETHEREUM! With the auto-claim feature,
// simply hold$BabyETHEREUM and you'll receive ETHEREUM automatically in your wallet.
// 
// Hold Baby ETHEREUM and get rewarded in ETHEREUM on every transaction!
//
//
// BabyEthereum Features Divendend Rewards + Auto-Liqudity + Marketing Fee + Max Wallet Amount + Max Sell Amount + Max Buy Amount
//
// � Telegram: https://t.me/officialbaby
// 🌎 Website: https://www.BabyEthereum.app
// � https://twitter.com/OfficialBabyEth
//
...
contract BabyEthereum is ERC20, Ownable {
    ...
    BabyEthereumDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x53569C1D4680E8Ef358A3feB92e3C6F2e70639d0;
    ...
    constructor() public ERC20("BABY ETHEREUM", "BET") {
        
    maxBuyTranscationAmount = 1500000000; //
    maxSellTransactionAmount = 150000000; //Max Sell .15%
    swapTokensAtAmount = 200000000; // 0.2% of the supply in order to get rewards
    _maxWalletToken = 1500000000; // 1.5% of total supply

    	dividendTracker = new BabyEthereumDividendTracker();
        ...
        */
        _mint(owner(), 100000000000 * (10**18)); //Minted Supply is 100,000,000,000
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BabyEthereumDividendTracker newDividendTracker = BabyEthereumDividendTracker(payable(newAddress));
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyEthereum: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyEthereum: The PanETHEREUMSwap pair cannot be removed from automatedMarketMakerPairs");
...
contract BabyEthereumDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("BabyEthereum_Dividen_Tracker", "BabyEthereum_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BabyEthereum_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BabyEthereum_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyEthereum contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BabyEthereum_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BabyEthereum_Dividend_Tracker: Cannot update claimWait to same value");
