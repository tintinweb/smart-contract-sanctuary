...
Virtual world where people gather to socialize, play, and work

$META token on the BSC smartchain with rewards.

Hold $META and receive 2% $USDT Automatically to your wallet on every transaction as a reward for holding
...
contract Metaverse is IBEP20, Auth {
    ...
    string constant _name = "Metaverse";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6875163f99ba5341E28be88512C3c6a4C6a1aEB6;
