...
contract HONEYPAD is IBEP20 {
    ...
    string public override name = "HONEYPAD";
    string public override symbol = "$HONEY";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 10 / 100;
        balances[foundersPot] = totalSupply * 50 / 100;
