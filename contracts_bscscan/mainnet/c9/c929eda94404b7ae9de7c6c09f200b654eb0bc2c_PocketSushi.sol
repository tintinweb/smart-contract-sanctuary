...
//Hold PocketSushi and get rewarded in Sushi!
// telegram: https://t.me/PocketSushiBSC
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also PocketSushied.
...
// File: contracts/PocketSushiDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable SUSHI = address(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4);
  ...
  function distributeSUSHIDividends(uint256 amount) public {
    require(totalSupply() > 0);
...
// File: contracts/PocketSushi.sol
...
contract PocketSushi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable SUSHI = address(0x947950BcC74888a40Ffa2593C5798F11Fc9124C4);
    address private _marketingWallet = address(0xcBE8dea7667EfEf60c81d6b1e864D3DD524Fdd33);
    address private _devWallet = address(0x25c7341EA69B0784BBB75c222e4F27d3D562B977);
    ...
    PocketSushiDividendTracker public dividendTracker;
    ...
    uint256 public sellFeeIncreaseFactor = 80;
    ...
    constructor() public ERC20("PocketSushi", "PocketSushi") {
        ...
        dividendTracker = new PocketSushiDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "PocketSushi: The dividend tracker already has that address");

        PocketSushiDividendTracker newDividendTracker = PocketSushiDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "PocketSushi: The new dividend tracker must be owned by the PocketSushi token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "PocketSushi: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PocketSushi: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PocketSushi: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "PocketSushi: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "PocketSushi: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "PocketSushi: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "PocketSushiBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "PocketSushi: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            sellFeeIncreaseFactor = sellFeeIncreaseFactor + 3;
    ...
    function swapTokensForSUSHI(uint256 tokenAmount, address recipient) private {

        // generate the uniswap pair path of weth -> SUSHI
    ...
    function swapAndSendDividends(uint256 tokens) private {
        swapTokensForSUSHI(tokens, address(this));
...
contract PocketSushiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("PocketSushi_Dividend_Tracker", "PocketSushi_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "PocketSushi_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "PocketSushi_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PocketSushi contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "PocketSushi_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PocketSushi_Dividend_Tracker: Cannot update claimWait to same value");
