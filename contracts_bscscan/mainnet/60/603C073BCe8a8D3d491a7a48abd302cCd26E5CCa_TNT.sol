...
contract TNT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xF0aF3932100CCD7a23574129FA468104c00d2fce); // Marketing Address
    address payable public teamWalletAddress = payable(0x93f7c5B3f847Fcf91525Fa98C99Ff5994B1320e3); // Team Address
    ...
    uint256 private _totalSupply = 3600 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 3600 * 10**6 * 10**_decimals; 
    uint256 public _walletMax = 3600 * 10**6 * 10**_decimals;
