...
🐶https://t.me/ShibaSwapnomics
🐶http://ShibaSwapnomics.io
...
contract ShibaSwapnomics is IBEP20 {
     // FairLaunch
    // common addresses
    ...
    string public override name = "ShibaSwapnomics";
    string public override symbol = "SHIBANO";
    ...
    constructor(uint totalSupplyValue, address SHIBAddress, address LAUNCHAddress, address BNBAddress) {
        // set total supply
        ...
        balances[SHIB] =  totalSupply * 1 / 100;
