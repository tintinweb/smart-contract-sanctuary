...
/**                                          STACKETH IS THE FUTURE
 STACKETH is the ruler of the cryptocurrency world and the King of DeFi.
 High Rewarding System, Fully Doxxed Team.
 Community Airdrops and much more things to come. Earn up to 20% in $BUSD simply by holding at least 200,000 ShalomArlikoum. 
 
 Join us on telegram for updates:
 https://t.me/ShalomArlikoum
 
 Website:
 https://ShalomArlikoum.finance
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
...
contract STACKETH is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "STACKETH";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xa83cD4029454D2966A78f248E25a18879D6D7655;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 500 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 1000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x72c346cC0CFb3A5B12eCDA5596978FD7e4ce87ed;
        devWallet = 0x4CFEFF3e62C57D778C3b4b24397F483769d1Fa41;
