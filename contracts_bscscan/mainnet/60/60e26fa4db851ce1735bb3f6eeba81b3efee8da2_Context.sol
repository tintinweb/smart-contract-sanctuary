...
OFFICIAL MinimiBitTorrent TOKEN

Token Basic info:
Name: MinimiBitTorrent
Symbol: MinimiBitTorrent
Decimals: 9
...
contract MinimiBitTorrent is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent =      11;
  uint256 private _maxTrxLimit =       (10*10**10*10**8)*0.02;
  uint256 private max_transfer_limit = (10*10**10*10**8)*0.02;
