 ...
 * Initial Burn: 60 Trillion (60%)
 * Max Wallet: 2.5 Trillion (~2.5% of Total Supply)
 * 15% LP Tax
 *
 * Telegram: t.me/HardDogeBSC
 * 
 */
...
contract HardDoge is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 900 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 2500 * 10**9 * 10**9; // Max Wallet: 2.5 Trillion (2.5%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "HardDoge";
    string private _symbol = "HARDOGE";
