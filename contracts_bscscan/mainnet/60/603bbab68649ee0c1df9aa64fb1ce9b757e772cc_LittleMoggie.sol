...
/**
   ...
   Welcome to LittleMoggie
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleMoggie
...
contract LittleMoggie is Context, IERC20, Ownable {
    ...
    string private _name = "Little Moggie";
