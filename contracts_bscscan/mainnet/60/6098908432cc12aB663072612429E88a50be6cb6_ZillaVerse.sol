...
contract ZillaVerse is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 138000000 * 10**15 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "ZillaVerse";
    string private _symbol = "ZVT";
    ...
    address public marketingWallet = 0x7C0670Ca681C47bFD54fD38c2187a26198AEB114;
    ...
    uint256 public _maxTxAmount = 1500000 * 10**15 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 26000 * 10**8 * 10**9;
