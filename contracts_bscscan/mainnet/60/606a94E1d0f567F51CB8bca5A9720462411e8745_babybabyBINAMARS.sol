...
// https://t.me/babybabyBINAMARSbsc
...
// File: contracts/babybabyBINAMARSDividendPayingToken.sol
...
// File: contracts/babybabyBINAMARS.sol
...
contract babybabyBINAMARS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x46880afc2E6FA41bBbE9787c082f7c23F795465E);
    address private _liqAdd = address(0x91Fc4f3822ff82099b935f5cCd353a75ef5a86Dc);
    address private _LPadd = address(0xBB27eC3E75152200C65e575732EA0dDf0159729a);

    bool private swapping;
    bool public airdrop;

    babybabyBINAMARSDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("babybabyBINAMARS", "babybabyBINAMARS") {
    	...
    	dividendTracker = new babybabyBINAMARSDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "babybabyBINAMARS: The dividend tracker already has that address");

        babybabyBINAMARSDividendTracker newDividendTracker = babybabyBINAMARSDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "babybabyBINAMARS: The new dividend tracker must be owned by the babybabyBINAMARS token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "babybabyBINAMARS: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "babybabyBINAMARS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "babybabyBINAMARS: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "babybabyBINAMARS: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "babybabyBINAMARS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "babybabyBINAMARS: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "babybabyBINAMARS: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            uint256 liqtokens = contractTokenBalance.mul(7).div(totalFees);
...
contract babybabyBINAMARSDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("babybabyBINAMARS_Dividend_Tracker", "babybabyBINAMARS_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "babybabyBINAMARS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "babybabyBINAMARS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main babybabyBINAMARS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "babybabyBINAMARS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "babybabyBINAMARS_Dividend_Tracker: Cannot update claimWait to same value");
