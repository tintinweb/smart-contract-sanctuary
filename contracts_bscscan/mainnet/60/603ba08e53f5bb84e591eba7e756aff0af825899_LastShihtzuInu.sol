...
contract LastShihtzuInu is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Last Shihtzu Inu";
    string constant _symbol = "$LSInu";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 100 * 10**_decimals;
    ...
    uint256 public maxBurn = 130;
    uint256 public minSol = 60;
