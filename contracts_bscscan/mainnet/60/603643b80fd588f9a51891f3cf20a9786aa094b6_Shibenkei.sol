...
contract Shibenkei is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x33Cb6418361Bbc1943D00B157Eb0624856e97efA); // Marketing Address
        
    address payable public developerAddress =
        payable(0x17D9AB75c5Dfb77A620f7d1fEAB43a3a8BDDC25D); // developer Address
        
    address payable public liquidityAddress =
        payable(0x33Cb6418361Bbc1943D00B157Eb0624856e97efA); // Liquidity Address
    ...
    string private constant _name = "Shibenkei";
    string private constant _symbol = "$SHBK";
