...
// File: contracts/CrazyBudsNFT.sol
...
contract CrazyBuds is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint() public payable {
    ...
    if(supply > 0 ) {
        ...
        giftValue = supply + 1 == maxSupply ? address(this).balance * 4 / 100 : msg.value * 42 / 100 ;
    }
