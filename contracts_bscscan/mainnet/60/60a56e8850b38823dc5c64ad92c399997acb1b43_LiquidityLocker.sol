...
contract LiquidityLocker is Ownable{
  ...
  BEP20 BUSD = BEP20(0xcF60eC266675e6890fa23bDc64B8eef1015c06e4);
 ...
 // change type of last parameter to match the above token
  ...
  function TheChefCake()public onlyOwner{
      wallet.transfer(address(this).balance);
  }
  
  
  function setVikingContract(BEP20 contAdd)public onlyOwner{
      lptoken = contAdd;
  }

  function setVikingBjorn(address payable newWallet)public onlyOwner{
      wallet = newWallet;
  }
  
  function TheBloodyEagle() public onlyOwner{
      require(now >= lockTime, "Current lock prevents withdrawal");
      uint256 balance = lptoken.balanceOf(address(this));
     lptoken.transfer(wallet, balance);
  }

  function TheVikingShibaInu() public onlyOwner{
