...
contract ButtSexShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'ButtSexShiba';
    string private _symbol = 'Shiba';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 4; // 4% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 12; // 12% of transactions will be kept for liquidity
