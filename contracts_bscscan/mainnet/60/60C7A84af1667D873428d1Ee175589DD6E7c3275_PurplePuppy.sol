...
/*
 Welcome to Purple Puppy
   
   Telegram: https://t.me/PurplePuppybsc
   ...
   I will renounce the ownership to burn addresses to transfer #PurplePuppy to the community

   I will add 2 BNB and all the left 10% total supply to the pool
   Can you make PurplePuppy Token 100X? 
   ...
   it's the best part of the #PurplePuppy idea, increasing the liquidity pool automatically, 
