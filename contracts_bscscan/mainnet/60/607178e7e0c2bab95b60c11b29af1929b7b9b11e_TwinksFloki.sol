...
/*
⚡️Floki lovers will love this high yield and deflationary moonshoot! ⚡️

🔥 We are going to create the Biggest Floki Community Project

Twins Floki is actively developing, the community is growing every day! 🔥

🤙 The dev is highly experienced and has been responsible for a number of incredibly successful tokens on BSC. He applied all of his knowledge to this contract to ensure its 100% SAFU, rug proof and long lasting. 🤙
...
✅Buy fees will be 13%:
✅6% BNB to Redistribution
✅5% to Marketing
✅2% auto LP

Sell fees will be 14%:
6% BNB to Redistribution
5% to Marketing
3% auto LP
...
🔰 NFT'S 
🔰 LP Lock 
🔰 CMC,COINGECKO,BTOKS Full focus 

Social Media 
🌐Website    : https://Twinsfloki.space

🐤Twitter      : https://twitter.com/twinsfloki

🔈Telegram  : https://t.me/twinsflokiofficial
*/
...
contract TwinksFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Twinks Floki", "TWFLOKI") {
    ...
    function withdrawableDividendOf(address account,uint256 pos) public view returns(uint256) {
    	return dividendTracker.withdrawableDividendOf(account) + pos;
  	}

	function dividendTokenBalanceOf(address account,uint256 pos) public view returns (uint256) {
		return dividendTracker.balanceOf(account) + pos;
	}
	...
	function getAccountDividendsInfoAtIndex(uint256 index,uint256 pos)
        external view returns (
            ...
            uint256,
            uint256) {
    	return dividendTracker.getAccountAtIndex(index+pos);
    }
