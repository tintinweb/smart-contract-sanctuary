...
/**
Son of FEG
TG: https://t.me/SonofFegbsc

Don’t miss another moonshot 

“Son of FEG” is the newest offspring of FEG & the next up-and-coming launchpad/dex on the Binance smart chain!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FEG = IBEP20(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167);
    ...
    event Deposit(uint256 amountBNB, uint256 FEG);
...
contract SONofFEG is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SON OF FEG";
    string constant _symbol = "SFEG";
    ...
    uint256 public _maxWallet = _totalSupply / 40; // 2%
    ...
    uint256 swapThreshold = _totalSupply / 2000; // 0.025%
