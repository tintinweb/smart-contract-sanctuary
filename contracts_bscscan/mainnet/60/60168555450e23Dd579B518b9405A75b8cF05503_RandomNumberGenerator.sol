...
// File: contracts/interfaces/IethernLLottery.sol

pragma solidity ^0.8.4;

interface IethernLLottery {
    /**
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the ethernL lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == ethernLLottery, "Only ethernLLottery");
    ...
    /**
     * @notice Set the address for the ethernLLottery
     * @param _ethernLLottery: address of the ethernL lottery
     */
    function setLotteryAddress(address _ethernLLottery) external onlyOwner {
        ethernLLottery = _ethernLLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IethernLLottery(ethernLLottery).viewCurrentLotteryId();
    }
}