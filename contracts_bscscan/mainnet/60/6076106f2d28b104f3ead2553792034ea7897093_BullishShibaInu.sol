...
//
// Fair Launch
// $BullishShibaInu proposes an innovative feature in its contract.
//
// As Bitcoin Tanks its prices we are entering the bearish market, honeypots and slow-rugs are on the rise
// Im bringing in a safe contract for investors to invest into the meme space
// BullishShibaInu posses a hyper-deflationary and static reflaction that rewards holders
// Simply hold and you'll receive static reflections automatically in your wallet
//
// Tokenomics
// 5% Marketing
// 5% Reflection
...
// 
// 
// The contract is set to sell automatically after accumulating 8mil ($BullishShibaInu) tokens on the 15% tax of our holders/traders, 
...
// We are in a bearish market may we beat the odds and turn it into a bullish run for us.
// Telegram : https://t.me/BullishShibaInu
...
contract BullishShibaInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6c7e2164373A35700f282D5974Eceba51Aba11a3;

    string private constant _name = "Bullish Shiba Inu";
    string private constant _symbol = "BullishShibaInu";
    ...
    Taxes public taxes = Taxes(5,5,3,2);
