...
2) 9% buyback and marketing tax is collected and 3% of it is sent for marketing fund and the other 6% is used to buyback the tokens
...
contract Raptorelon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xfD19eA69A6f3c9fe5106d457174202D91Ec51d03); // Marketing Address
    ...
    string private _name = "Raptorelon";
    string private _symbol = "Raptorelon";
