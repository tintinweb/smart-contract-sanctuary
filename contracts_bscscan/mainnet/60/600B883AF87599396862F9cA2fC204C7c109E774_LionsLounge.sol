...
LionsLounge Token
Welcome to the Parent token of @decentralions

LionsLounge (LSL) is the parent token of @decentralions.
$LSL will be fueled by degen projects provided by the lounge in order to 
create an everlasting buying pressure through the rewards contract and fees. The theory is simple. 
You hold $LSL, get additional benefits and perks such as discount taxes on all upcoming degen plays, reflections and NFTs.
Our regular stealth launches will always be allocated 5% of all buy/sell transactions to purchase $LSL. 
...
https://t.me/decentralions
www.decentralion.com/lounge
 *
 */
...
/* Token contract */
contract LionsLounge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x8aBEEa918177AFf1862C5095912db513Da040F6e;
    ...
    // Name and symbol
    string constant _name = "LionsLounge";
    string constant _symbol = "LSL";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1 / 10000; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 1 / 10000; // 0.20% or 250k tokens
    uint256 public _maxWalletToken = _totalSupply * 50 / 10000; // 3% or 3T tokens
    ...
    uint256 public swapThreshold = _totalSupply * 10000 / 10000; // 0.1% of supply
