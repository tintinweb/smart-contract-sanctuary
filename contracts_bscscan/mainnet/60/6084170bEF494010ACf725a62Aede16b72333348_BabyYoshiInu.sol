 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/BabyYoshiInu
 * 
 * 
 * Baby Yoshi Inu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BabyYoshiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Yoshi Inu";
    string constant _symbol = "BYI";
