...
/**
    ...
    https://t.me/GigaBerlinFomo
    
    clean contract for degen!
    tax 10%
    5% Reflect to holder
    5% back to liquidity
    3% max wallet
...
contract GigaBerlinFomo is Context, IERC20, Ownable { 
    ...
    string private _name = " GigaBerlinFomo"; 
    string private _symbol = "GigaBerlinF"; 
