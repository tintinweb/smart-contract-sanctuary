 ...
 *
 * 
 * Telegram: https://t.me/The100Token
 * 
 *
 */
...
contract The100Lottery is Auth, ERC165, IERC721Metadata, IERC721Enumerable {
    ...
    address private _tokenToPay = 0x5E4eF1786791574F490474b42A651e79F30a36f1;
    
	uint256 private currentId = 0;
	uint256 public currentMax = 100;
    ...
    constructor(address receiver) Auth(msg.sender) {
        _name = "The100 Lottery";
        _symbol = "100L";
    ...
    function _buyLotteryTickets() external payable{
        require(currentId <= currentMax, "There are no more available Lottery Tickets. Sorry.");
        ...
        uint256 buyBack = msg.value / 2;
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = address(_tokenToPay);

        // make the swap
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: buyBack}(
            0, // accept any amount of Ethereum
            path,
            address(0xdead),
            block.timestamp
        );
        payable(owner).transfer(msg.value-buyBack);
    }
