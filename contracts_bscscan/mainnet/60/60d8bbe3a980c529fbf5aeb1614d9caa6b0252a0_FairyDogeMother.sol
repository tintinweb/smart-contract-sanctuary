 ...
 * 
 * 
 * The spell casting, reward granting, most magical of all the Doge!
 * 
 * 
 * t.me/FairyDogeMother
 * 
 * https://fairydogemother.com
 * 
*/
...
contract FairyDogeMother is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8BCa13391Aa7d50Be4fb23F1A7FE45Bf01443118); // Marketing Address
    ...
    string private _name = "Fairy DogeMother";
    string private _symbol = "FAIRYDOGE";
