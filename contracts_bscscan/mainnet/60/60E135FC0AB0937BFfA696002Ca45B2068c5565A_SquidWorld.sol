 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/SquidWorldBSC
 * 
 * 
 * SquidWorld token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract SquidWorld is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SquidWorld";
    string constant _symbol = "SQW";
