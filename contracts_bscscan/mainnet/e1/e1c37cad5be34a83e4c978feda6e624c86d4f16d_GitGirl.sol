...
contract Context {
 ...
 contract GitGirl is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private spreltaci;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "GitGirl";
    string private _symbol = "GITGIRL";
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWallet1 = 0x3d88C144F0459e6FD0D49e3c26161B74a1196732;
    address private _feeAddrWallet2 = 0xBe50DDe5C5D68c742621502976BbFF0190760f82;
