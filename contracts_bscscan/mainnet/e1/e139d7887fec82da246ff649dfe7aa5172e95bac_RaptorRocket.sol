...
/**
   ...
   Welcome 29 Raptor Rocket
   
   This is a community token. If you want to create a telegram I suggest to name it to @RaptorRocket29BSC
   Important: Based Elon's Twwitt. The early you create a group that shares the token, the more gain you'll get.
   ...
   I will renounce the ownership to burn addresses to transfer #29RaptorRocket BSC to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #29RaptorRocket BSC 10000X?
...
contract RaptorRocket  is Context, IERC20, Ownable {
    ...
    string private _name = "29 Raptor Rocket";
    string private _symbol = "29RR";
