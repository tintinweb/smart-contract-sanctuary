...
contract BillzHub is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "BillzHub";
    string private _symbol = "Billz";
    ...
    uint256 private minTokenNumberToSell =  1000000 * 10**8; // this tx amount will trigger swap and add liquidity
