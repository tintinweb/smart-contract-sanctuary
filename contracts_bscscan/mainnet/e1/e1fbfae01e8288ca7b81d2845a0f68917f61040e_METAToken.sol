...
contract METAToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Metaverse Coin';
    string private _symbol = 'META';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 39999999 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 31000000 * 10**uint256(_decimals);
