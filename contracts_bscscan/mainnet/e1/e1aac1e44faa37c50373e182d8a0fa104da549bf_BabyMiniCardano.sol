...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BADA = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BADA.balanceOf(address(this));
        ...
        uint256 amount = BADA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BADA.transfer(shareholder, amount);
...
contract BabyMiniCardano is IBEP20, Auth {
    using SafeMath for uint256;

    address BADA = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Mini Cardano";
    string constant _symbol = "BMADA";
