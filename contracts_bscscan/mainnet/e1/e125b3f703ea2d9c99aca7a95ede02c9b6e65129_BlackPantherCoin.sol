...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb37362B265c3b5C99d6CC13c6385d4EAa0bf833d;
...
contract BlackPantherCoin  is Ownable, IBEP20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromTax;
    uint256 public _decimals = 12;
    uint256 public _totalSupply = 10 *10**12 * 10 ** _decimals;
    uint256 public _liquidityFee = 5;
    string private _name = "Black Panther Coin";
    string private _symbol = "PNTHR";
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000000000 * 10** _decimals;
    ...
    function ExcludeFromTax(address add,bool status) external onlyOwner(){
        _isExcludedFromTax[add] = status;
    }
    function IsExcludedFromTax(address add)external view returns(bool){
       return _isExcludedFromTax[add];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (!_isExcludedFromTax[sender]) {
            feeAmount = amount.mul(_liquidityFee).div(100);
