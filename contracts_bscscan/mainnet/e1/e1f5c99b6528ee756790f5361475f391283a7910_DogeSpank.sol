...
/**
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
Sick of high taxes? Tired of losing money even when you’re up? Our token smashes high taxes and goes back to the roots. i've made a basic token with a No tax.
No gimmicks, no tricks, no scams, no lies, everything is completely transparent.

This is a good chance to be early for once.

I will burn liquidity LPs to burn addresses to lock the pool forever.
I will renounce the ownership to burn addresses to transfer #DogeSpank to the community, make sure it's 100% safe.
Can you make DogeSpank 1000X?
 ...
 */
 ...
 contract DogeSpank is Context, ERC20, ERC20Metadata {
