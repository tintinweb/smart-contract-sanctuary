...
For the Reward Apes n Junkies brought you the hottest Rewarding Gem

For the Chads who hold SplinterDoge will be rewarded with SplinterDoge

Let's cut the chase and here is breakdown

Liquidity 2%
Buyback 2%
SPS Reflection 6%
Dev 1% cuz Dev gotta eat too you greedy fucks


and message for you early Apes
DON'T FUCKIN' SELL SO DAMN EARLY HOLY SHIIIIET 
HOLD FOR FFS GAWD DAMMIT 

https://t.me/SplinterDogekek
...
contract DividendDistributor is IDividendDistributor {
  ...
  IBEP20 SPS = IBEP20 (0x1633b7157e7638C4d6593436111Bf125Ee74703F); 
  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function deposit() external payable override {
        uint256 balanceBefore = SPS.balanceOf(address(this));
        ...
        uint256 amount = SPS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SPS.transfer(shareholder, amount);
...
contract SplinterDoge is IBEP20, Auth {
    using SafeMath for uint256;
  
 
     address SPS = 0x1633b7157e7638C4d6593436111Bf125Ee74703F;  
     address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SplinterDoge";
    string constant _symbol = "SplinterDoge";
