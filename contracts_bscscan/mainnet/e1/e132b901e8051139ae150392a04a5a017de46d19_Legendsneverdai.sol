...
* Fees on Buy&Sell: 15%
*
* 🌲Rip all the legends from rappers to my baby betty white
* 
* https://t.me/legendsneverdai
* 
...
contract Legendsneverdai is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Legends Never Dai";
    string constant _symbol = "LND999";
    ...
    uint256 public _maxTxAmount = _totalSupply * 1 / 1000; //  200000 tokens per trx ;
    uint256 public _walletMax = _totalSupply * 1 / 100;    // 1000000 mx wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x8eBdd48D8B05ea7126efEe9016091A2BC9C6bf40; // liquidity
        marketingWallet = 0x33471e9Beb63a68b755c7A9236784c091B938A0B;  // marketing
