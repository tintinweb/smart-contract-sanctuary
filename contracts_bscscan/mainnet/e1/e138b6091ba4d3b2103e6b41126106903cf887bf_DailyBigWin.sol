...
/**
 ...
 Daily Big Win 
 Earn BNB while holding
 Win a big Prize everyday
...
contract DailyBigWin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFCFaa8C21A10b3364227A38b6BA3554B82306c38); // Marketing Address
    ...
    string private _name = "DailyBigWin";
    string private _symbol = "BIGWIN";
    ...
    uint256 private minimumTokensBeforeSwap = 2 * 10**4 * 10**9; 
