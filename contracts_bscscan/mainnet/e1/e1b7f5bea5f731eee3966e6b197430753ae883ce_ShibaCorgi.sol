...
contract ShibaCorgi is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'ShibaCorgi';
    string  private constant _SYMBOL = 'ShiCo';
    ...
    uint256 private _tTotal = 10000000000000000000000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 10000000000000000000000 * _DECIMALFACTOR;
