...
EverRiseMax is built upon the fundamentals of Buyback and increasing the investor's value
...
contract EverRiseMax is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address payable public marketingAddress = payable(0xe375Bd2662a2dc469EF60012F9f04A6CcA9eeF6B); // Marketing Address
    ...
    string private _name = "EverRiseMax";
    string private _symbol = "RISEMAX";
