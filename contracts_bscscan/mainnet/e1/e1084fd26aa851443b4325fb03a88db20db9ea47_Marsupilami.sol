...
contract Marsupilami  is Context, IERC20, Ownable {
    ...
    string private _name = "Marsupilami";
    string private _symbol = "MRSPLM";	
    ...
    bool public SwapAndLiquifys = true;
	

    uint256 public _maxBuyAmount = 5000000000 * 10**18;
    uint256 private minimumTokensBeforeSwap = 200000 * 10**18;
    
    event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    event SwapAndLiquifysUpdated(bool enabled);
    ...
    function setSwapAndLiquifys(bool _enabled) public onlyOwner {
        SwapAndLiquifys = _enabled;
        emit SwapAndLiquifysUpdated(_enabled);
    }
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function removeAllFee() private {
        if(_ReflectionFee == 0 && MarketingFee == 0) return;
    ...
    function _transfer(
        ...
        if(contractTokenBalance >= _maxBuyAmount)
        {
            contractTokenBalance = _maxBuyAmount;
        }
