...
contract MoonCafe is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500 * 10**11 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name   = "MoonCafe";
    string private _symbol = "MC";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 5;   //Frictionless Yield Fee
    ...
    uint256 public _maxTxAmount = 500 * 10**11 * 10**18;
