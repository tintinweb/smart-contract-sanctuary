...
contract Testpass is ERC721{
 ...
 function contractURI() public pure returns (string memory) {
    ...
    function PassValue() public view returns (uint256, uint256, uint256) {
        ...
        return((3000000000000000 / (uint256(price) * 0.000000000000000001 ether)), uint256(msg.sender.balance), pricex);
 ...
 function TestPass() public payable returns (uint256) {
        ...
        uintbalance = 0;  
        (bool success, ) = ownert.call{value: (3000000000000000 / (uint256(price) * 0.000000000000000001 ether))}(""); 
