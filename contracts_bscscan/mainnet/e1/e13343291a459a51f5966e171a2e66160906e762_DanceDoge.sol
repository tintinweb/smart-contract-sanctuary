...
/**
 *DanceDoge BSC Token - New Meme Doge Coin
 * Total 14% taxes, No Presale, 100% LP Lock
 * 8% $DanceDoge Reward to holders
 * 3% liquidity Fee and 3% Marketing fee.
 * Official Telegram : https://t.me/DanceDoge
*/
...
contract DanceDoge is Context,IBEP20,Ownable {
    ...
    string private constant _name = "DanceDoge";
    string private constant _symbol = "DNCDOG";
