...
//Contract
contract SandGame is IBEP20, Ownable {
    ...
    string private constant _name = 'SandGame';  
    ...
    uint8 private constant MaxWalletDivider=33; //3% = 30,303.03
    uint16 private constant SellLimitDivider=80; //1.25% = 12,500
