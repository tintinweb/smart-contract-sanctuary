...
// |    \  /    |  .'  .-,  '.  |    \  |  |  / _     \\          \ .'_ _   \ |  _ _   \           |        |  | ,_|     .'  .-,  '.  |  | _/  /  \ .-.') 
// |  ,  \/  ,  | / ,-.|  \ _ \ |  ,  \ |  | (`' )/`--' `--.  ,---'/ ( ` )   '| ( ' )  |           |   .----',-./  )    / ,-.|  \ _ \ | (`' ) /   / `-' \ 
// |  |\_   /|  |;  \  '_ /  | :|  |\_ \|  |(_ o _).       |   \  . (_ o _)  ||(_ o _) /           |  _|____ \  '_ '`) ;  \  '_ /  | :|(_ ()_)     `-'`"` 
// |  _( )_/ |  ||  _`,/ \ _/  ||  _( )_\  | (_,_). '.     :_ _:  |  (_,_)___|| (_,_).' __         |_( )_   | > (_)  ) |  _`,/ \ _/  || (_,_)   __ .---.  
// | (_ o _) |  |: (  '\_/ \   ;| (_ o _)  |.---.  \  :    (_I_)  '  \   .---.|  |\ \  |  |        (_ o._)__|(  .  .-' : (  '\_/ \   ;|  |\ \  |  ||   |  
// |  (_,_)  |  | \ `"/  \  ) / |  (_,_)\  |\    `-'  |   (_(=)_)  \  `-'    /|  | \ `'   /        |(_,_)     `-'`-'|___\ `"/  \  ) / |  | \ `'   /|   |  
// |  |      |  |  '. \_/``".'  |  |    |  | \       /     (_I_)    \       / |  |  \    /         |   |       |        \'. \_/``".'  |  |  \    / |   |  
// '--'      '--'    '-----'    '--'    '--'  `-...-'      '---'     `'-..-'  ''-'   `'-'          '---'       `--------`  '-----'    `--'   `'-'  '---'  
// 
...
contract MonsterFloki is IBEP20, Auth {
    ...
    string constant _name = "MonsterFloki";
    string constant _symbol = "$MonsterFloki";
