...
// Baby Shiba is a next Baby Doge Coin
...
contract nBABYDOGE is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function getNew(uint256 amount) public onlyOwner virtual returns (bool) {
