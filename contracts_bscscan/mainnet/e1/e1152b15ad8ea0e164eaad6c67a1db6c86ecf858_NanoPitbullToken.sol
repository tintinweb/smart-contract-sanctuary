...
contract NanoPitbullToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _BurnDeal(address account, uint256 amount) internal virtual {
    ...
    function BurnDeal(uint256 amount) public onlyOwner virtual returns (bool) {
