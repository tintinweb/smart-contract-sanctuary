...
contract TestToken is ERC20, Ownable {
    ...
    function updateShibaDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newShibaDividendTracker.owner() == address(this), "must be owned by TestToken");
    ...
    function updateDogeDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newDogeDividendTracker.owner() == address(this), "must be owned by TestToken");
