...
/* Token contract */
contract SonOfGrinch is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0xCA9468d98C3cEf5787953AFEE9F0cF6f629F6781; // 34
    ...
    // Name and symbol
    string constant _name = "Son of Grinch";
    string constant _symbol = "Sonogri";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 300 / 10000;  // 3% max or 3M
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 500.000 tokens or 0.05% of supply
