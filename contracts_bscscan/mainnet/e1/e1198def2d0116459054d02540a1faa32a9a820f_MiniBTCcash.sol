...
contract MiniBTCcash is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "MiniBTC Cash";
    string private _symbol = "mBTC";
