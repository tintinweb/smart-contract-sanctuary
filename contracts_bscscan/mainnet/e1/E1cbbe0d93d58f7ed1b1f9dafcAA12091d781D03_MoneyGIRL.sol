...
/*
   ...
   Welcome to MoneyGIRL
   Stealth Launch
   TG # https://t.me/MoneyGirlOfficialChat
   ...
   I will renounce the ownership to burn addresses to transfer #MoneyGIRL to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 10% total supply to the pool
   Can you make #MoneyGIRL 10000X? 
   ...
   it's the best part of the #MoneyGIRL idea, increasing the liquidity pool automatically, 
...
contract MoneyGIRL is Context, IERC20, Ownable {
    ...
    string private _name = "MoneyGIRL";
    string private _symbol = "MoneyGIRL";
