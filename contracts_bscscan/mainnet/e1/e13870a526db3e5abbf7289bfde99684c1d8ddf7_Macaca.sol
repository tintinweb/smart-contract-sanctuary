...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xC77fa20904482B4202CdA60E288B732Fa21D61f3);
...
contract Macaca is IBEP20, Auth {
    using SafeMath for uint256;
//dont change
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Macaca BSC";
    string constant _symbol = "Macaca";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * 10**6 * 10**9;
//mx wal, tx chng 
    uint256 public _maxTxAmount = _totalSupply.mul(99).div(100);
    uint256 public _maxWalletToken = _totalSupply.mul(99).div(100);
...
//trde
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa8095A08F2f242f10dc2BD9Ed0A287Ff564BA5b9;
        ecosystemfeeReceiver = 0xa8095A08F2f242f10dc2BD9Ed0A287Ff564BA5b9;
