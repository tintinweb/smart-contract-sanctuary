...
contract $DamnBaby is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 20 * 10**5 * 10**9;
    ...
    constructor() ERC20("$DamnBaby", "$DamnBaby") {
    	firstDividendTracker = new FIRSTDividendTracker();
 
    	marketingWallet = 0x3264257170f58d34e0172cDa88FfE8E7beEB598F;
    	firstDividendToken = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; //ADA
    ...
    function updatefirstDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newfirstDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the $BSWISS token contract");
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("$Lovely_Dividend_Tracker", "$Lovely_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) { //ADA
    	claimWait = 3600;
