...
//BidouilleCoin le coin de votre Seigneur
//https://t.me/bidouille_bsc

// Votre seigneur vous salue 


// 10%~ Slippage required: 5% BNB Auto-reflect/4% Dev & Marketing Wallet/1% Auto-LP
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
contract BidouilleCoin is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BidouilleCoin";
    string constant _symbol = "BDC";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 400; // 250 000 tokens per tx 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xFd9fBA0c5cC9c11Bf69FAD2ee9f1d793e1eE341f;
        ...
        uint marketingFee = _totalSupply.div(20);
