...
contract ELMON is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x474c2756AF7D29c4Cb22C471076C6b0D39a8616E;
   
    uint256 public constant MAX = ~uint256(0);
    uint256 public _tTotal = 20000000 * 10**18;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;

    string public _name = "ELMON (Elemon)";
    string public _symbol = "ELMON";
