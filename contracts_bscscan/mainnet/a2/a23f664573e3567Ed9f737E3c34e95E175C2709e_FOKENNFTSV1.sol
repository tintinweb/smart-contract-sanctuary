...
contract FOKENNFTSV1 is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 500000000000000000; /// 0.5 BNB
  ...
  function withdrawFunds(uint256 bnbAmount) external onlyOwner {
