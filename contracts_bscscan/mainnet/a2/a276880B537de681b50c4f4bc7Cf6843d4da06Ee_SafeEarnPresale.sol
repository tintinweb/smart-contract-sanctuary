...
contract SafeEarnPresale is ReentrancyGuard, Ownable {
    ...
    uint256 public whitelisterHardcap = 250 ether;
    ...
    uint256 public tokensPerBNB = 630_000_000_000;
    ...
    function buy (address beneficiary) public payable nonReentrant {
        ...
        require (_bnbSent >= 0.01 ether, "BNB is lesser than min val ue");
        require (_bnbSent <= 2 ether, "BNB is greater than max value");
        require (bnbReceived <= 500 ether, "Hardcap reached");
    ...
    function claimTokens() external nonReentrant {
        ...
        require (safeToken.balanceOf(address(this)) >= tokensOwned[msg.sender], "There are not enough SAFEARN tokens to transfer, wtf?");
