...
contract CyanCoin is Context, IBEP20, Ownable {
    ...
    uint256 public _redistributionFee = 4;
    uint256 public _liquidityFee = 4;

    uint256 public _previousRedistributionFee = _redistributionFee;
    uint256 public _previousLiquidityFee = _liquidityFee;

    uint256 public _maxTxAmount = 10000 * 10**6 * 10**9; // Max Transaction: 100 Million (1%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 20000 * 10**6 * 10**9; // Max Wallet: 200 Million (2%)
        ...
        )
    {
        ...
        uint256 tFee = tAmount.div(10**2).mul(_redistributionFee).mul(multiplier);
        uint256 tLiquidity =
