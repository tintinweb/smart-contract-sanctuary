...
/*
☘️ Lucky Shiba Inu ☘️ is a meme coin that aims to fight against the current Pajeet invasion in the Binance Smart Chain. LuckyShibaInu will help save the BSC by fighting against the Pajeets by donating on every $1 million market cap reached to an Indian charity organization. 
...
contract LuckyShibaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lucky Shiba Inu", "LSI") public {
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function setEnableLiquidityfee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
