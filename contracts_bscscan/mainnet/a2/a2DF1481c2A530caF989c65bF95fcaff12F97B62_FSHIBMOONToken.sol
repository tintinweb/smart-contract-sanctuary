...
/**
*Submitted for verification at BSCinfo.com on 2021-07-06
*/
 ...
 * sender of the transaction and its data. Whil these are generally available
...
contract FSHIBMOONToken is Context, IERC20, Ownable {
    ...
    string private _name = 'FlokiShibaMoon';
    string private _symbol = 'FSHIBMOON';
