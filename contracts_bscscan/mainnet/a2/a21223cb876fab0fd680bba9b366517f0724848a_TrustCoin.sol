...
*
*
*   ONLY 5% Taxes to prevent robots
*
*
*   Ownership will be renounced, LP will be lock
*  
*   This is a community token. So there is no official group.
    If someone wants to create one , I suggest @TrustCoin_bsc.
    There is only one channel recording the information when I released this coin. 
    If you want to view all the information about this coin, please check https://t.me/TrustCoinChannel
*
*   Enjoy the ride
*
*
...
contract TrustCoin is Context, IERC20, Ownable {
