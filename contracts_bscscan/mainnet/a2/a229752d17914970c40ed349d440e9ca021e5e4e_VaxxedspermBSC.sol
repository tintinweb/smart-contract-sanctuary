...
°°°°°VAXXEDSPERM°°°°°
🩸Welcome to Vaxxedsperm on the bsc-network, a new token that is hyped, now more than ever before🩸
...
Telegram = https://t.me/VaxxedspermBSC
...
// CHANGE
contract VaxxedspermBSC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "VaxxedspermBSC";
    string constant _symbol = "VSBSC";
