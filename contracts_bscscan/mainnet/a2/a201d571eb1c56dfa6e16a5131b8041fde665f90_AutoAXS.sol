...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 AXS = IERC20(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
...
// CHANGE
contract AutoAXS is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AutoAXS";
    string constant _symbol = "AutoAXS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; // 10% MAX 100,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; // 10% MAX 100,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x91e51fF13a71d78f8738c6c1d1D129457882F936);
