...
/*
  WELCOME TO SUPERSHIBAINU
  NEW GEMS ON PANCAKESWAP V2

  Use Slippage 10-15%
  Stealth Launch!
  #SUPER+#SHIBA+#INU=SUPERSHIBAINU
  Telegram : https://t.me/SUPERSHIBAINUBSC
...
contract SUPERSHIBAINU is Context, IERC20, Ownable {
    ...
    string private _name = "SUPERSHIBAINU";
    string private _symbol = "SUPESHIBA";
