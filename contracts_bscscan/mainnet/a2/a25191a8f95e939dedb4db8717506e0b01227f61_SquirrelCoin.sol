...
contract SquirrelCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 260 * 10**24 *10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SquirrelCoin";
    string private _symbol = "SQUIX";
    ...
    address public charityWallet = 0xa87A9b3212df339643517018733ceFdbD78DCa3e; // HELP THE WORLD !!!
    ...
    uint256 private numTokensSellToAddToLiquidity = 130 * 10**21 *10**18;
