...
/**
             ...
             Fairlaunching at 25 members!

            💰Tokenomics : 14% TAX (5% back to liquidity, 5% back to holders & marketing fee 4%)
...
contract LisaAnn is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x7547b2413f81CBbCB52BdBEBA67bC74A32fcf4e6); // Marketing Address
    ...
    string private _name = "Lisa Ann";
    string private _symbol = "LisaAnn";
