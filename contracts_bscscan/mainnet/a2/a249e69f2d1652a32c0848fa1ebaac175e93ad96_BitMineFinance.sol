...
/**
 *
 * TOKEN CONTRACT FOR BITMINE FINANCE
 * OFFICIAL TOKEN CONTRAT FOR BMF
 * www.bitmine.finance
*/
...
contract BitMineFinance is Context, IERC20, Ownable {
    ...
    string private _name = "BITMINE FINANCE";
    ...
    uint256 public maxTxAmount = 50000 * 10**18; // maximum 50000 BMF can be transferred in 1 transaction
    
    uint256 private _totalBlockRewards = 0; 
    uint256 private _totalBlocksMined = 1;
    bool public _enableMine = true;
  ...
  */
   ...
   */
    ...
    function setPresaleAddress(address _PresaleAddress) public onlyOwner {
        require(PresaleAddress == address(0), "BMF::PresaleAddress: already set");
