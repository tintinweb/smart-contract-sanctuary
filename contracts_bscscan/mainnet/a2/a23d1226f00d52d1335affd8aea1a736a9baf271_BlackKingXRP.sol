...
-> 2% fee liquidity pool. 
-> 11% reflection as $xrp reward. 
-> 5% fee to  marketing wallet.

 Join our community on Telegram https://t.me/BlackKingXRP
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 XRPRewards = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = XRPRewards.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(XRPRewards);
        ...
        uint256 amount = XRPRewards.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            XRPRewards.transfer(shareholder, amount);
...
contract BlackKingXRP is IBEP20, Auth {
    ...
    address XRPRewards = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BlackKingXRP";
    string constant _symbol = "BKingXRP";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xcDaD886a2C9549bA6e997558E0caf30a9cDEe16e;
