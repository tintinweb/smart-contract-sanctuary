...
contract DGetDegree is Context, IERC20, Ownable {
    ...
    string private constant _name = "D Get Degree"; // Change it to your project name
    string private constant _symbol = "$DGD"; // change the ticker/tracker
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 5;
    address public _marketingWallet = 0x1D19EaCa18B6e343CE66534066be3B3d874ecbCd; 
