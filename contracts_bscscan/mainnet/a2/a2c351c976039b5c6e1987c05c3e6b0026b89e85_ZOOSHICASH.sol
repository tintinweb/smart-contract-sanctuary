...
/*
ZOOSHICASH 
aims to be the best Sushi reflection token on the binance smart chain 
as seen on MarketWatch & Yahoo finance.

- if you missed the $zooshi hype,
you don't wanna miss this.

ZooshiCash token was Inspired by it's father (Zooshi) 
but quickly became an overlord with the help of his community while becoming better at rewarding holder's, 
faster block time and less taxes.

The ZOOSHICASH overlord is here to lead us to triumph. 
But first you got to have a taste of our delicious $SUSHI.  
Prepare to have your mind blown with our upcoming games and rare NFTs!
*/
...
contract ZOOSHICASH is Context, IERC20, Ownable {
    ...
    string private _name = "ZOOSHICASH";
    string private _symbol = "ZOOSHICASH";
    ...
    string public _Reward = "SUSHI";
    string public _RewardAddress = "0x947950BcC74888a40Ffa2593C5798F11Fc9124C4";
    ...
    address _marketingWallet = 0xe46A9aE5c4DD12e5DA6138568a359d82c7bceD8F;
