...
/**
 *   Telegram : https://t.me/babycakerewards
*/
...
contract BabyCakeRewards is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyCakeRewards";
    string constant _symbol = "BCAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 1; //0.5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 20) / 1; // 2%
