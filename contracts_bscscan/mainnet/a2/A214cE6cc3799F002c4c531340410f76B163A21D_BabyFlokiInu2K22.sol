 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/BabyFlokiInu2K22
 * 
 * 
 * BabyFlokiInu2K22 token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract BabyFlokiInu2K22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyFlokiInu2K22";
    string constant _symbol = "BFI2K22";
