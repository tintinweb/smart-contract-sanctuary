...
/**
   ...
   Welcome to LittleBabyCake
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyCakeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyCake to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyCake idea, increasing the liquidity pool automatically, 
...
contract LittleBabyCake is Context, IERC20, Ownable {
    ...
    string private _symbol = "LTBABYCAKE";
