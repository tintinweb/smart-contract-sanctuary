...
/**
I will create this token and leave to community, after add liquidity, I will lock LP and renounce Ownership
The name is EthereumGold I create this token to catch bots only and after make it good for trade
so you can create TG group with this name https://t.me/EarlyGembscss
...
contract ELONCAKEELON is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 1000000000000 * 10**9;
      string private _symbol = "Mi Sxp 🔹";
  string private _name = "Mini Sxp";
