...
/**
   # LOOTBOXTOKEN.Com (LOOTBOX)
   3% fee auto add to the liquidity pool to locked forever when selling
   1% distribute to a Charity Wallet 
   5% of transaction fee will go to Holders
   ttl supply = 7,000,000,000
   decimals 9
*/
...
contract LOOTBOX is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x87f4Cd7eA0973B97791CF5eb543D874996db581C;
    ...
    string private _name = "LOOTBOXTOKEN.com";
    string private _symbol = "LOOTBOX";
