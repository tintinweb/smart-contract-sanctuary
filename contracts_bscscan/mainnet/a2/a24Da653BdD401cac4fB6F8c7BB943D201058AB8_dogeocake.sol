...
governance token will give cake for holding

Doge-O is a deflationary token on the BSC with enhanced tokenomics to protect investors. Take shelter in the Doge-O at http://www.dogeocrypto.com

https://t.me/dogeocrypto
...
contract dogeocake is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "dogeocake";
    string constant _symbol = "dogeocake";
