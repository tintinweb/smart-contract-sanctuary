...
contract MiniGoldMiner is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "MiniGoldMiner";
    string private _symbol = "MINIGM";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 100000000* 1e9;
    uint256 public maxHoldingAmount = 80000000 * 1e9;
