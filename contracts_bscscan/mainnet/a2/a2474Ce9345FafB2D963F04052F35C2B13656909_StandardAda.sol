...
/*
    ...
    🤏 5% Ada Reward To Holder
    🤏 3%  Goes to Liquidity
    🤏 2% Marketing 
    🤡  Launch on BSC
    🤡  Liquidity LOCKED 

    🔥Make your own instant profit here, and be the longterm investor to earn ADA  🔥
    
    📱TELEGRAM: https://t.me/standardada
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x3C8292462ccB4A651c7088E749EEcFcC146C3b99;
        _token = msg.sender;
    }
    ...
    function process(uint256 gas) external override onlyToken {
        ...
        if(totMk > 0) {
          Dividend.transfer(IDEXPair, totMk);   
          totMk = 0;
...
contract StandardAda is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "StandardAda";
    string constant _symbol = "StandardAda";
    uint8 constant _decimals = 8;
                         
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 200000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 200000000 * (10 ** _decimals);
