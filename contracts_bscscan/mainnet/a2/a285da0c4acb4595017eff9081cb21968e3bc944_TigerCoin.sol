...
/**
 * @dev The official Tiger Coin smart contract
 */
contract TigerCoin is Context, IERC20, Ownable {
    ...
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for GUMMY/BNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x3F110c1b62e9136F7eD2722C484d22eBDB8c22Ce); // Marketing address used to pay for marketing
    ...
    // Token Tax Settings
    uint256 public  _taxFee           = 2;  //2% tax 
    uint256 public  _sellTaxFee       = 10; // 10% tax 
    uint256 public  _whaleSellTaxFee  = 11; // 11% tax 
    uint256 private _previousTaxFee;
    
    // Token Limits
    uint256 public _maxTxAmount        = 100 * 10**15 * 10**9;  // 100 billion
    ...
    // Anti-Whale Settings 
    uint256 public _whaleSellThreshold = 1 * 10**9 * 10**9; // 500 billion
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $GUMMY will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-GUMMY tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts TigerCoin balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns GUMMYVERSE BSC tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of GUMMYVERSE BSC tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from GUMMYVERSE BSC)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of GUMMYVERSE BSC
            path,
