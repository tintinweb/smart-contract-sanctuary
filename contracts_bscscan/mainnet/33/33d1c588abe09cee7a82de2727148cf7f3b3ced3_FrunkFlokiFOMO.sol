...
Come Frunking Get Some!

It's time to Frunking MOON!
...
contract FrunkFlokiFOMO is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'FrunkFlokiFOMO';
    string private constant _symbol = 'FrunkFlokiFOMO';
    ...
    uint16 public constant MaxSellLockTime= 10;
    ...
    //Wallets for distribution and Marketing
    address public Marketing=payable(0xa465605749Deca5d19051Dad3Ae6b6705427860d);
    address private RewardPool=payable(0x7E8944a73733760bAd4d2Aa956BC1AB3b979A596);
    address private LiquidityRouter=payable(0xC8c96e7923047C6Ca86319149137a566da9dC51C);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==RewardPool||addr==LiquidityRouter;
    }
    ...
    constructor () {
        ...
        _excluded.add(RewardPool);
        _excluded.add(LiquidityRouter);
    ...
    uint8 private StakingShareLimits=80;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;  // FLOKI BEP-20
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*2)/6);
        payable(RewardPool).transfer((amount*2)/6);
        payable(LiquidityRouter).transfer((amount*2)/6);
    } 
    ...
    function TeamRemoveRemainingBNB() public onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
        (bool sent,) =LiquidityRouter.call{value: (address(this).balance)}("");
        require(sent);
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //external//////////////////////////////////////////////////////////////////////////////////////////////
