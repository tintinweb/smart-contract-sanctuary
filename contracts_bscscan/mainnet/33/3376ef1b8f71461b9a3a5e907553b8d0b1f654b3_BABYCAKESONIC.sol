...
/**Welcome to BABYCAKESONIC
   
   This is a community token. If you want to create a telegram I suggest to name it to @BABYCAKESONICChat
   ...
   I will renounce the ownership to burn addresses to transfer #BABYCAKESONIC to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #BABYCAKESONIC 10000X? 
   ...
   it's the best part of the #BABYCAKESONIC idea, increasing the liquidity pool automatically, 
...
contract BABYCAKESONIC is Context, IERC20, Ownable {
    ...
    string private _name = "BABYCAKE SONIC";
    string private _symbol = "BCAKESONIC";
