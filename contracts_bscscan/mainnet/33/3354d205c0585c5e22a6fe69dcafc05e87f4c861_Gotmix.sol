...
contract Gotmix is Context, IERC20, Ownable {
    using Address for address;
    
    address private constant _burnAddress = 0x2A2002b6b6aB8f426393614aef9CD6cfE71AEDd6;
    ...
    string private constant _name = 'Gotmix token'; 
    string private constant _symbol = 'GTMX'; 
    uint8 private constant _decimals = 2;

    //Supply and Reflected Supply and other options
    uint256 private constant _decimalFactor = 10**uint256(_decimals);
    uint256 private _tokenTotal = 100999999999 * _decimalFactor ; 
