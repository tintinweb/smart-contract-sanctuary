...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25E78C7eB79d51dB9fDb9bE92dE22bD5526d130f;
...
contract ROUNDUP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCFC0C09926d4C0832B9B7d56C82a31E3D31aed88;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ROUNDUP";
    string private _symbol = "ROUND";
