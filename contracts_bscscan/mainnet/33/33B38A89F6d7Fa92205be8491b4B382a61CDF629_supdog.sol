...
contract supdog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3e886E74F8C1Ab685d2ff04513A6425109b0A1A0); // Marketing Address
    ...
    string private _name = "SuperdogZilla";
    string private _symbol = "SuperdogZilla";
