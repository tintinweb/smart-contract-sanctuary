...
/*
* EXTREME DIAMOND ($EXTD)
*
* Tokenomics will be a tax of 12% Buy, 24% Sell and 36% to transfer between wallets 
*
* 40% for liquidity 
* 12% to burn wallet 
* 24% to staking
...
* Max per Holder: 165
* Max sell: 60
* Sell cool down: 60 minutes to prevent dumping
*
*
* TG: https://t.me/EXTREMEDIAMOND
* 
*/
...
//EXTREME DIAMOND Contract /////////////

contract EXTREME is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'EXTREME';
    string private constant _symbol = '$EXTD';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 5000 * 10**_decimals;//equals 5000 token

    //Divider for the MaxBalance based on circulating Supply 
    uint8 public constant BalanceLimitDivider=166;
    //Divider for sellLimit based on circulating Supply
    uint16 public constant SellLimitDivider=83;
    ...
    address public constant TeamWallet=0x6b521f96FbA57e9950296059C084e3e6DC1eFd1E;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x111111111117dC0aa78b770fA6A738034120C302;  //1 Inch Token
