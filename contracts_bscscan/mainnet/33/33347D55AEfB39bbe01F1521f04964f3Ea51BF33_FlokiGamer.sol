...
/**
 * Hello FlokiGamer Community
 * 
 * TG: https://t.me/FlokiGamerBSC
 * 
 * 
 * FlokiGamer token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
In essence, the longer you hold the more you earn.
 * 
 * Thank You, you are all the best / ZeusZero Dev
*/
...
contract FlokiGamer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiGamer";
    string constant _symbol = "FGAMER";
