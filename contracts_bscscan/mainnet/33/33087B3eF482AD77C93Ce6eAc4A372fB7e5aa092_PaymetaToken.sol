...
contract PaymetaToken is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "Paymeta";
    string private _symbol = "PMTA";
    ...
    uint256 private _tTotal = 6000000000 * _decimalFactor; // Tokens total
    ...
    uint256 public _maxTxAmount = 25000000 * _decimalFactor;
    uint256 public _minTxAmount = 100 * _decimalFactor;
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(_paused == false, "Contract transactions are currently paused");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ...
            uint256 totalFee = _marketingFee.add(_liqFee);
    ...
    function _takeFees(uint256 amount, address from) private lockTakeFees {
        ...
        uint256 liquidityPoolETHPortion = swappedETH.sub(marketingETHPortion);

        // Transfer ETH to fee wallets
        (bool sent, bytes memory data) = _marketingAddress.call{value: marketingETHPortion}("");
    ...
    function removeAllFees() private {
        if(_taxFee == 0 && _marketingFee == 0 && _liqFee == 0) return;
