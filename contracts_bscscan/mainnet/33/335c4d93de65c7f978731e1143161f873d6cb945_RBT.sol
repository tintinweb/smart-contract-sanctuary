...
/**
 * 
ROCKBIT is an automatic liquidity acquisition yield farm and decentralized exchange running on Binance Smart Chain and Polygon with lots of unique and creative features that let you earn and win. It mainly covers ERC-20 Protocol whether it's
Binance Smart Chain
Ethereum
Polygon (MATIC)
any other chains.
Rockbit is based on very simple functions such as Staking, Farming or Pooling. with higher APY's and secure investments. 
*/
