...
/*
* Welcome to Mini Doge Rocket
* 50% Token Burned
* LP Burn forever
* Mini Doge Rocket will burn 3% every transaction
* 2% reward to holders
*/
...
contract MiniDogeRocket is Context, IERC20, IERC20Metadata, Ownable { 
