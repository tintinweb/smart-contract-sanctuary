...
/**
OFFICIAL LINKS ANCIENT TORTOISE

Webiste : https://ancienttortoiseweb3.site
*/
...
contract ANCIENTTORTOISE is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100000 * 10**7 * 10**4; // 10B 
    ...
    uint256 public _maxTxAmount = 100000 * 10**7 * 10**4; // 10B 
    uint256 public _numTokensSellToAddToLiquidity = 5000 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 100000 * 10**7 * 10**4; // 10B

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "ANCIENT TORTOISE";
    string private _symbol = "TORTOISE";
