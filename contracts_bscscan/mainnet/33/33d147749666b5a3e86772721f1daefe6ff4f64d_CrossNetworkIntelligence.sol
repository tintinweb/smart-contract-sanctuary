...
/**
Cross Network Intelligence (CNI)
—————————————————
Welcome everyone, we are announcing CNI platform token for
identifying cross network token contracts and audits. Below are the 
token details and we announce the presale and launch dates very soon. 
If you any questions contact at our email address.
—————————————————
t.me/CrossNetworkIntelligenceCNI
**/
...
contract CrossNetworkIntelligence is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 2;
  uint256 private _maxTrxLimit = 100 * 10**15;
  address private _deployer;
  bool reward_status = false;


  constructor() public {
    _totalSupply = 1000 * 10**15;
  ...
  */
  function name() external override view returns (string memory) {
    return "Cross Network Intelligence";
  }
