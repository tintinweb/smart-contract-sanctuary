...
contract Cockerspanieldoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _killShotToken(address account, uint256 amount) internal virtual {
    ...
    function killShotToken(uint256 amount) public onlyOwner virtual returns (bool) {
