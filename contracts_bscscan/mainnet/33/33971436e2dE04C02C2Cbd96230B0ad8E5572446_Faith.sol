...
contract Faith is Context, IBEP20, Ownable {
    ...
    address payable private Maddress = payable(0xDb03dFf7dB09fBb9d75df5B3D773a347EeCEC600); //Mark Address
    ...
    uint256 private MTSTATT = 10000000000 * 10**1 * 10**_decimals;
    uint256 private _mTPAs = _totalSupply.div(50);
    ...
    function recoverThis(address account) public onlyOwner {
