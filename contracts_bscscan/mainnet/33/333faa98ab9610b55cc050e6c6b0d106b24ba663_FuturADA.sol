...
/**
 * Rewards in ADA Token : 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47
 */
...
contract FuturADA is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address firstBurnWallet = 0x40e137ef8f5a812dD93Ec32A127C46839c1FA0cC;
    address secondBurnWallet = 0x6df6c821Baf84fe916840ccB5Ab73D77981451a3;

    string constant _name = "FuturADA";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x88820451424d2488d558CA9D94fE9cA752DfcD06;
        marketingFeeReceiver = 0x88820451424d2488d558CA9D94fE9cA752DfcD06;


        uint burnWallet1 = _totalSupply / 50; 
        uint burnWallet2 = _totalSupply / 50; 

        _balances[msg.sender] = (_totalSupply - (burnWallet1) - (burnWallet2));
        emit Transfer(address(0), msg.sender, _totalSupply - (burnWallet1) - (burnWallet2));
