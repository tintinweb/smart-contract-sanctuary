...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb8b3D227ff9e9B312D747574003934cA22DA46e4;
...
contract JEDISKYWALKER is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x86ca48A3f7CF52FB838Ccd72Bf0f05bBc2A3A08E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TheForceSkywalker";
    string private _symbol = "JEDISKYWALKER";
    ...
    uint256 private numTokensSellToAddToLiquidity = 0.001 * 10**18;
