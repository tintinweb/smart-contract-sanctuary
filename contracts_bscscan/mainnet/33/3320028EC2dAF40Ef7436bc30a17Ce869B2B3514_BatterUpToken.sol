...
contract BatterUpToken is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc32532a6FA59A48aF9C6EC336428Ae53AD682fF2); // Marketing Address
    ...
    string private _name = "Batter Up Token";
    string private _symbol = "$BATUP";
    ...
    function whiteList(address _user, bool enable) external onlyOwner {
        _whiteList[_user] = enable;
    }
