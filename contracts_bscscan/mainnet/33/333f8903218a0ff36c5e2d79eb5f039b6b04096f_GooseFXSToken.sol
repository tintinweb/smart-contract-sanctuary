...
/*
GooseFXS Fork in BSC Beta V1
GooseFX is a full suite DeFi platform built on the Solana blockchain 
and Serum DEX, offering a variety of unique decentralized peer-to-peer financial products

https://goosefx.io/
https://www.t.me/goosefx
*/
...
contract GooseFXSToken is IBEP2 {
     // FairLaunch
    // common addresses
    address private owner;
    address private GooseFXSLocker;
    address private GooseFXSVault;
    address private GooseFXSNode;
    ...
    string public override name = "GooseFXS";
    string public override symbol = "GooseFXS";
    ...
    constructor() {
        ...
        // designate addresses
        owner = msg.sender;
        GooseFXSLocker = 0xefb36AD3B40Df18553229f3Ad60e61426fCD2f58;
        GooseFXSVault = 0x38e210D293d09027D0D3cDc95428Dfbd4651240c;
        GooseFXSNode = 0x6E36cc862467eF82Ed13faAEA6c887b4F180285A;
        balances[owner] = 34500000000000000000 * 10**9;
        balances[GooseFXSLocker] =  5000000000000000000 * 10**9;
        balances[GooseFXSVault] = 34500000000000000000 * 10**9;
        balances[GooseFXSNode] = 69000000000000000000 * 10**9;
