...
Here to solve the Mystery of the missing Green dildo

TG: https://t.me/SherlockCheems
...
contract SherlockCheems is IBEP20, Ownable {

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SherlockCheems";
    ...
    uint256 public _maxWalletToken = _totalSupply/30;
    ...
    address public buyBackReceiver = 0x744c343cFcd08f9F8DA62669276F54ff5A59fB13;
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount) external {
        require(msg.sender == buyBackReceiver || msg.sender == marketingFeeReceiver);
