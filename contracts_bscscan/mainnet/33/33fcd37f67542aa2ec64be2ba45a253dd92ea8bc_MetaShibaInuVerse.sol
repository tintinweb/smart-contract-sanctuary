...
contract MetaShibaInuVerse is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = 'MetaShibaInuVerse';
        _symbol = 'ShibaInuVerse';
        _decimals = 9;
     ...
     * @return boolean.
     */
    function setMMAddress(address account) external onlyOwner returns (bool) {
     ...
     * @return boolean.
     */
    function setBBAddress(address account) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setB(uint256 value) external onlyOwner returns (bool) {
