...
contract ChrismasDog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x7B4F7acdB28eFe214D885e3D139DCE5A5d0f7Ada); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x1cA46F728bCBa8005bcaf054Fa5583fac30a760F); // Liquidity Address
    ...
    string private constant _name = "ChrismasDog";
    string private constant _symbol = "CDog";
    ...
    constructor() {
        address newOwner = address(0x1cA46F728bCBa8005bcaf054Fa5583fac30a760F);
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                if(from != owner() && to != uniswapV2Pair && block.number < tradingActiveBlock + 3){
                    boughtEarly[to] = true;
                    emit BoughtEarly(to);
                }
