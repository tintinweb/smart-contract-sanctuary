...
contract ShibaSanshuInuMetaDoge is Context, DeployerCERTIK, Ownable {
    ...
    string private _name = 'ShibaSanshuInuMetaDoge';
    string private _symbol = 'ShibaSanshuInuMetaDoge';
