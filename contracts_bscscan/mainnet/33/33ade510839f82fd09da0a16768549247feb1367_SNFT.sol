...
/**
 * 
Social NFT, a BNB based NFT (non-fungible token) platform for social media personalities who want to create digital collectibles of their likeness. Social NFT Marketplace is revolutionizing the NFT industry by connecting an NFT marketplace with social media outlets. It provides social media users and businesses a platform to sell their images to earn passive income. Secured with blockchain technology, this project will truly revolutionize the growing NFT space. 
*/
...
contract SNFT is Context, IERC20, Ownable {
