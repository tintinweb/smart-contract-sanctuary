...
contract ShogunPool 
{
    ...
    string  private _name = "\x53\x68\xc5\x8d\x67\x75\x6e\x20\x50\x6f\x6f\x6c";
    ...
    address private _usdmTokenAddress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD
    ...
    {
        require(amount >= 100, "ShogunPool: minimum deposit amount: 100");
    ...
    function emergencyWithdraw() public
    {
        ...
        require(stakingDeposit > 0, "ShogunPool: withdraw amount cannot be 0");
    ...
    {
        require(_userData[msg.sender].stakingDeposit > 0, "ShogunPool: staking deposit is 0");
    ...
    function harvest() public 
    {
        ...
        require(blocksStaking > _harvestCooldownBlocks, "ShogunPool: harvest cooldown in progress");
