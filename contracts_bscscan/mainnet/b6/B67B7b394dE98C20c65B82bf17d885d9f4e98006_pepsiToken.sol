...
contract pepsiToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    
    using SafeMath for uint;

    uint256 private totalTokens;

    constructor() ERC20("Pepsi Token", "PPT") {
        totalTokens = 270 * 10 ** 6 * 10 ** uint256(decimals()); // 270M
