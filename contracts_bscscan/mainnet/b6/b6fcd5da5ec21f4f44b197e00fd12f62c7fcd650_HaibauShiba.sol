...
Welcome to HaibauShiba
     
HaibauShiba is a progressive autostaking token that pays rewards just for storing it in your wallet. Rewards are sent to holders and liquidity providers instantly with every transaction. HaibauShiba belongs to the CanCerbero Finance ecosystem along with its brothers $Rott and $BDog who will later reach the holders of HaibauShiba through an airdrop.

🌎 Telegram: https://t.me/HaibauShibaChat

🌎 Twitter : https://Twitter.com/@HaibauShiba

🌎 coinhunt.cc : https://coinhunt.cc/

🌎 Website : https://countingdownto.com/countdown-pages/_Teom2te
...
contract HaibauShiba is Context, IERC20, Ownable {
    ...
    string private _name = "HaibauShiba";
    string private _symbol = "HaibauShiba";
