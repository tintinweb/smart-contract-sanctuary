...
contract Test3000 is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    string private constant _NAME = "Test3000";
    string private constant _SYMBOL = "Test3000";
    uint8 private constant _DECIMALS = 9;

    uint256 private constant _MAX = ~uint256(0);
    uint256 private constant _tTotal = 888 * 10 ** 9 * ( 10** _DECIMALS); // 888 Billion Test3000
    ...
    constructor() {
        ...
        rewardDistributor = IRewardDistributor(0x1724530e4BD266eE19a91cCf5f435E16630EBbc2);
