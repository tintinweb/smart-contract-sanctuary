...
/* Token contract */
contract FirstOrganicChart is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "First Organic Chart";
    string constant _symbol = "FOC";
    ...
    uint256 public swapThreshold = _totalSupply * 20 / 10000; // 400.000 tokens or 0.04% of supply
