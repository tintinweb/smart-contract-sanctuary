...
contract Comp {
    /// @notice EIP-20 token name for this token
    string public constant name = "Omni COMP Governance Token";

    /// @notice EIP-20 token symbol for this token
    string public constant symbol = "OMNIC";

    /// @notice EIP-20 token decimals for this token
    uint8 public constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint public constant totalSupply = 100000000e18; // 100 million OMNIC
...
contract Comptroller is ComptrollerV3Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
    ...
    function getCompAddress() public view returns (address) {
        return 0x3dEB1119c295558c732a3618F04518b9812EC87A;
    }
}