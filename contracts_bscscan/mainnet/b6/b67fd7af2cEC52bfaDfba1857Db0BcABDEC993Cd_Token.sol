...
contract Token is ERC20, Ownable {
    ...
    function init(string memory tokenName, string memory tokenSymbol, uint8 tokenDecimals, uint256 totalSupply, address owner) external onlyOwner {
        require(false == _isinit, "Token has been initialized"); 
        _name = tokenName;
        _symbol = tokenSymbol;
