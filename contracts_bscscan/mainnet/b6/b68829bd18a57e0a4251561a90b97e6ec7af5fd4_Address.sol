...
contract PRESIDENTSHIBA is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x571Fc57d605d543Fa8eFBA003D67fCeb228488AE); // Marketing Address
    ...
    function _removeSniper(address account) external onlyOwner() {
        require(account != 0x571Fc57d605d543Fa8eFBA003D67fCeb228488AE, 'We can not blacklist Uniswap');
