 ...
 *      Fees on Buy/Sell: 16-20%
 *                          
 * 
 *          https://t.me/BabyMoneyBeijing
 * 
 * 
*/
...
contract BabyMoneyBeijing is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyMoneyBeijing";
    string constant _symbol = "BabyMoneyBeijing";
