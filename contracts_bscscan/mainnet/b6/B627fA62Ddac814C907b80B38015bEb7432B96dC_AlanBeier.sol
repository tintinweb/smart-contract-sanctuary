...
contract AlanBeier is Context, IERC20, Ownable {
    ...
    uint256 private _minLottoBalance = 1000000000000000;

    string private _name = "AlanBeier";
    string private _symbol = "AlanBeier";
    ...
    address public ownerAddress = address(0x0A991AD99654E4Dc5105ED62530e727F9dd8aAA6);
