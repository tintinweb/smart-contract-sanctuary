...
The team is building an infrastructure of  investing in the most lucrative farms, staking and L/P across all blockchain L1 networks.
...
contract BMCC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BINANCE MULTI-CHAIN CAPITAL";
    string private constant _symbol = unicode"BMCC";
