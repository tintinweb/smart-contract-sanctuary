...
contract FLOKELON is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 180000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'FlokiElonInu';
    string private _symbol = 'FLOKELON';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 5;
    uint256 private _burnFee = 5;
    uint256 private _maxTxAmount = 180000000000000 * 10**18;
