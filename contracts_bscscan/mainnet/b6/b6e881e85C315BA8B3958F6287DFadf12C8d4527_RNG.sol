...
/**
RiseAndGrow $RNG is a deflationary token on the Binance Smart Chain that reward holders passively, while staking to our upcoming Decentralized Exchange, Crypto-wallet, and NFT Marketplace Project.

Taxation:
5% HOLDERS REWARD
3% DEVELOPMENT FEE
3% BUYBACK 2% LIQUIDITY
2% MARKETING

RiseAndGrow Project aims to develop red-hot use cases in the segments of decentralized exchanges (DEXs), decentralized token sales (IDOs), yield farming, digital collectibles (non-fungible tokens or NFTs) marketplace and DeFi wallet.
*/
...
contract RNG is Context, IBEP20, Ownable {
