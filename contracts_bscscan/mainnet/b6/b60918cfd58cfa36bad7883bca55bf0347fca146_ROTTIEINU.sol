...
contract ROTTIEINU is Context, IBEP20, Ownable {
    ...
    uint256 private _tRottieTotal;

    string private _name = "Rottie Inu";
    string private _symbol = "ROTTIE";
    ...
    uint256 public _rottieFee = 6;
    uint256 private _previousRottieFee = _rottieFee;
    
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 10000 * 10**6 * 10**9; 
    
    address payable public doghousepoolAddress = 0xba6c3Ec25538FBBdBE3b8304bE48e7b759dD3217; // Doghouse Pool Address
    ...
    function totalRottieBNB() public view returns (uint256) {
        // BNB has  18 decimals!
        return _tRottieTotal;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tRottieTotal = _tRottieTotal.add(address(this).balance);
        TransferRottieBNB(doghousepoolAddress, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_rottieFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _rottieFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousRottieFee = _rottieFee;
    ...
    function setRottieFeePercent(uint256 RottieFee) external onlyOwner() {
        _rottieFee = RottieFee;
    }
    ...
    function TransferRottieBNB(address payable recipient, uint256 amount) private {
