...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = 0x518B084124474c349155fBDb0fb26990BdEAc744;
        emit OwnershipTransferred(address(0), 0x518B084124474c349155fBDb0fb26990BdEAc744);
    }
...
contract testtest is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor () public {
        ...
        _minAmount = 1 * 10 ** 17;
        _maxAmount = 3 * 10 ** 18;
        _deadline = 1638983684; // Время разлока пресейлеров
    ...
    function setDeadline(uint256 _newtime) public onlyOwner {
        _deadline = _newtime;
    ...
    receive() external payable {
        ...
        require(msg.value <= _maxAmount, "Amount too high");
        uint256 tokenAmount = msg.value.mul(_price);
        require(_balances[owner()] >= tokenAmount);
