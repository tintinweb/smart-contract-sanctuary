...
Fair launch join now! anti whale!
...
contract ApeADA is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'ApeADA';
    string private constant _symbol = '$ApeADA';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 2000000000 * 10**_decimals;//equals 2000000 token
    ...
    //DevWallets
    address public TeamWallet=payable(0x872a7b366110AE0A746Ad08560aAD608c78C4aA3);
    address public walletTwo=payable(0x5208C3Ef8fEB0088332505E9d1C1DDb0Bb7795Ad);
    //TestNet
	...
	uint256 private antiWhale = 20000000 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;  // ADA 
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer(amount / 2);
        payable(walletTwo).transfer(amount / 2);
    } 
