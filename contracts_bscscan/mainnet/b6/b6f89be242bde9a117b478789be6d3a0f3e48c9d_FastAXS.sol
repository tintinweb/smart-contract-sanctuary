...
/**
 * 
 * Telegram: https://t.me/FastAXS
 * 
 * 10% AXS Rewards
 * Max Buy: 10,000,000,000 Tokens
 * Max Wallet: 25,000,000,000 Tokens 
 * 
 * Team has a lot of experience and many successful launches.
 * We goin to the moon.
 * 
 * 
*/
...
contract FastAXS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FAST AXS";
    string constant _symbol = "FAXS";
    ...
    //max wallet holding
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 200;
