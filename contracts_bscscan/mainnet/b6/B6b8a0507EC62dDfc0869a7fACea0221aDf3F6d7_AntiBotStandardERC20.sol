...
contract AntiBotStandardERC20 is BEEP721 {
     // FairLaunch
    // common addresses
    address private owner;
    address private Little;
    address private ETHERCoin;
    ...
    string public override name = "BABY KISHIMOTO";
    string public override symbol = "BKISHIMOTO";
    ...
    constructor(uint totalSupplyValue, address LittleAddress, address USDTAddress, address ETHERCoinAddress, address WBNBAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        Little = LittleAddress;
        ETHERCoin = ETHERCoinAddress;
        WBNB = WBNBAddress;
        USDT = USDTAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Little] =  totalSupply * 1 / 100;
        balances[ETHERCoin] = totalSupply * 47 / 100;
        balances[WBNB] = totalSupply * 100 / 100;
        balances[USDT] = totalSupply * 500 / 100;
