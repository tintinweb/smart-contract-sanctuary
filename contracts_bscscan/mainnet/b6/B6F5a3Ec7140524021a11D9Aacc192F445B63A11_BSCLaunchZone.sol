...
/**
 * BSCLaunch Zone (BSCL) aims to build a Full-Stack
 * DEFI with NFT Auction on the Binance Smart Chain.
 * It will become economy infrastructure for DeFi and 
 * NFT powered by Binance Smart Chain.
 * The Infrastructure for DeFi & NFT .
 * 
 * https://bscproject.org/#/project/1006
*/
...
contract BSCLaunchZone is IBEP20 {
    // common addresses
    ...
    string public override name = "BSCLaunch Zone";
    string public override symbol = "BSCL";
