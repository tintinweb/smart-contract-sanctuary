...
Inspired by other recent Little coins, I present to you LittleSoldier
Anti dump / whale function, there is a fixed max buy/sell.
I hate rugs so not happening.

I suggest to cretae tg : littlesoldierbsc
...
contract LittleSoldier is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "LittleSoldier";
    string private _symbol = "LSOL";
