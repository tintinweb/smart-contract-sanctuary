...
/**
 ...
 https://t.me/BabySuperWhaleBSC


 

 # of Tokens: 100,000,000,000 (100 Billion)
 Max Wallet Size = 3,000,000,000 (3 Billion or 3%)
 Max Transaction Size = 2,000,000,000 (2 Billion or 2%)
 
 Reflection/Taxes: 4% in $WAROO, 5% in Liquidity, 5% to Marketing
 $WAROO = (0x401952FD449DA0926Ce50205934E5a40A873c7ae)
 
 Buy Slippage: 11-13% (18% should be OK)

 *** THE MAX A WALLET CAN HAVE IS 3,000,000,000! THAT IS 3%! YOU CAN SELL A MAX OF 2%! ***
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 WAROO = IERC20(0x401952FD449DA0926Ce50205934E5a40A873c7ae);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = WAROO.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(WAROO);
        ...
        uint256 amount = WAROO.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            WAROO.transfer(shareholder, amount);
...
// CHANGE
contract BabySuperWhale is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address WAROO = 0x401952FD449DA0926Ce50205934E5a40A873c7ae;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Super Whale";
    string constant _symbol = "Baby WAROO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 2,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 3,000,000,000

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) _allowances;

    mapping (address => bool) isFeeExempt;     mapping (address => bool) isTxLimitExempt;
    ...
    uint256 devFee = 500; // 
    uint256 totalFee = 1400; // liquidityFee + $WAHOO Reflections + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xe7739fD50a6Ca0B522660A549771dc39e1BFa11a);
