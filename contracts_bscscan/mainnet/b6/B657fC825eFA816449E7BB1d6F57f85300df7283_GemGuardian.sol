...
/**
 * GemGuardian
 * GemGuardian.io | A fantasy NFT style play to earn card game where fantasy meets reality game play
...
contract GemGuardian is Context, BEP20 {
    ...
    string private _name = "GemGuardian";
    string private _symbol = "GEMG";
    uint8 private _decimals = 18;
    uint256 public _LiquidityPool = 50000000000000000000000000;
    ...
    function _transfer(
        ...
        if (
            ...
            _holders[recipient] = _holders[recipient] + ((tAmount / 10) * 5);
        }
