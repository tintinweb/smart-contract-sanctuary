...
/**
 ...
 #Paris Saint-Germain
   ...
   #Paris Saint-Germain features:
   1% fee auto add to the liquidity pool to locked forever when selling 
   1% fee auto distribute to all holders 
   i created a black hole so #Paris Saint-Germain token will deflate itself in supply with every transaction
...
contract ParisSaintGermain is TokenBEP20 {
