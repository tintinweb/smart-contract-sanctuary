...
contract OmaxTokenV2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Omax Token V2", "OmaxTokenV2") {

    	marketingWallet = 0x1F295A832E94bc07B8432e678a84546458B3931A;
    	rewardsWallet = 0x1F295A832E94bc07B8432e678a84546458B3931A;
    ...
    function prepareForMoon() external onlyOwner {
    ...
    function afterMoon() external onlyOwner {
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0x1F295A832E94bc07B8432e678a84546458B3931A); // dev fee lasts for one day only
