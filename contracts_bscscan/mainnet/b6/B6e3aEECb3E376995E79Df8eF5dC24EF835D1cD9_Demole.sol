...
contract Demole is IERC20 {
    ...
    address private Play;
    address private WEB;
    
    // token Playity metadata
    ...
    string public override name = "Demole.io";
    string public override symbol = "DEMOLE";
    ...
    constructor(uint totalSupplyValue, address GamesAddress, address PlayAddress, address WEBAddress) {
        // set total supply
        ...
        balances[Play] = totalSupply * 47 / 100;
