...
contract JEETZILLA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "JEETZILLA";
    string constant _symbol = "JEETZ";
    ...
    uint256 buybackFee = 1700;
    uint256 reflectionFee = 1000;
    uint256 marketingFee = 3500;
    uint256 totalFee = 9700;
