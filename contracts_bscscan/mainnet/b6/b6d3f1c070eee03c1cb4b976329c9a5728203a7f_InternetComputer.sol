...
interface InternetComputerGaming {
    /**
...
contract InternetComputer is Context, InternetComputerGaming, Ownable {
    ...
    string private _name = 'Internet Computer';
    string private _symbol = 'Internet Computer';
