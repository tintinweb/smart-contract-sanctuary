...
library Address{
 ...
 contract LunarFloki is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xdE40b8cB1600132e220ED110E9e8F89483eaCCdD;
    address public BuybackWallet = 0xc440a44a6e92D67b878681dC5b0D8E2408c498b4;

    string private constant _name = "Lunar Floki";
    string private constant _symbol = "LUNARFLOKI";
    ...
    Taxes public taxes = Taxes(2, 6, 4, 2);
    Taxes public sellTaxes = Taxes(2, 6, 4, 2);
