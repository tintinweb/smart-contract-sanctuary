...
contract KingZilla is Context, IERC20, Ownable {
    ...
    address payable public _marketingWallet = payable(0x74AA3e018E0FF44CD8828E363497cF7EfB43F058);
    ...
    string private _name = "King$Zilla";
    string private _symbol = "KingZilla";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(swapTokens); // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
