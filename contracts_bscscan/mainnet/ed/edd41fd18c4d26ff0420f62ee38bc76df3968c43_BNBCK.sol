...
contract BNBCK is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address public marketingWallet = 0xD7a248db1F86343c070eA70c6a415326663Cfb20; //Also holder of development funds
    ...
    uint256 public _maxWalletToken = 100000000000 * (10**18); // Max Wallet: (10 %)
    ...
    uint256 public constant sellFeeIncreaseFactor = 120; 
    ...
    uint256 public tradingEnabledTimestamp = 1627596000; //
    ...
    constructor() public ERC20("BnBack", "BNBCK") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "BnBack: The new dividend tracker must be owned by the UR token contract");
    ...
    function updateMarketingFee(uint256 newMarketingFee) public onlyOwner {
        require(newMarketingFee <= 10, "Marketing fee can't be more than 10%");
    ...
    function updateLiquidityFee(uint256 newLiquidityFee) public onlyOwner {
        require(newLiquidityFee <= 10, "Liquidity fee can't be more than 10%");
    ...
    function updateRewardsFee(uint256 newRewardsFee) public onlyOwner {
        require(newRewardsFee <= 10, "Rewards fee can't be more than 10%");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BnBack: This account cannot send tokens until trading is enabled");
        }
...
contract UnicornDividendTracker is DividendPayingToken, Ownable {
    ...
    function withdrawDividend() public override {
        require(false, "BnBack_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main UR contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "BnBack_Dividend_Tracker: claimWait must be updated to between 0.33 and 24 hours");
