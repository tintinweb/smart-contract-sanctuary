...
/**
    ...
    GrandFatherShiba Features:

    Telegram : https://t.me/GrandFatherShiba
 
    10% TRANSACTION FEE
    - 4% fee per transaction gets distributed to holders.
    - 4% fee per transaction gets added to the liquidity pool.
    - 2% fee per transaction gets added to jackpot pool. It will distributed to 10 holders with lottery every week.
*/
...
contract GrandFatherShiba is Context, IERC20, Ownable {
    ...
    string private _name = "GrandFatherShiba";
    ...
    address public _jackpotfeewallet = 0x91459A057f916f4989BeF29BD068cEa2bb130Aa3;
    uint256 public _jackpotFeePercent = 2;
