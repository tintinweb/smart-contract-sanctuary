...
//Just launched in $FlokiEmirates. We have created a token so rewarding for everyone.
//FlokiEmirates Hold we will Tothemoon
//Tg : t.me/FlokiEmirates
...
contract FlokiEmirates is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKIEMIRATES";
    string private _symbol = "FlokiEmirates";
