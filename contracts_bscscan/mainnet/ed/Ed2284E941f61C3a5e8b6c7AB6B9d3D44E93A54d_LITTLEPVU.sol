...
contract LITTLEPVU is ERC20, Ownable {
    // CONFIG START
    
    // TOKEM
    string tokenName = "LITTLE PVU";
    string tokenSymbol = "LPVU";
    ...
    // TAX (IN %)
    uint8 marketingTax = 10;
    
    // TAX (OUT %)
    uint256 flagLimit = 10; 
    
    // WHALE PROTECTION
    uint256 maxTXAmount = 100_000_000_000 * (10**18);
