...
contract FUD2point0   is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FUD2point0";
    string constant _symbol = "FUD2point0";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x7797c5FFCba0bF07ba4F2486c209C96137a27fD8;
