...
contract ElonSquid is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xAbE3CdD07C45dd7ebF3fdeA0A6444A2A5598DD61); // Marketing Address
        
    address payable public teamAddress =
        payable(0xBc46B1E3968097Aecfbb6e41800f9D14B22C0cFd); // Team Address
        
    address payable public liquidityAddress =
        payable(0x98C395A31B717164c43D1fE5eA5bE5137Fa14414); // Liquidity Address
    ...
    string private constant _name = "ElonSquid";
    string private constant _symbol = "ESQ";
