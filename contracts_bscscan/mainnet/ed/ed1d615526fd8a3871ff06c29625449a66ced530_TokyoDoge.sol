...
Join us to celebrate the TOKYO 2020 Olympic Games with TOYKO DOGE
...
contract TokyoDoge is Context, IERC20, Ownable {
    ...
    uint256 private _supply_total       = 1896 * 10**12 * 10**_decimals;
    uint256 private _supply_reflected   = (MAX - (MAX % _supply_total));
    string private  _name               = "TokyoDoge";
    ...
    uint256 public _fee_champion_min_bal = _supply_total * 2 / 100;
    ...
    uint256 public _numTokensSellToAddToLiquidity =  ( _supply_total * 1 ) / 1000;
...
// Liquidity functions
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isPreseller[to] && to != address(this)  && to != address(deadAddress) && to != uniswapV2Pair && to != _wallet_utility && to != _wallet_champion){
