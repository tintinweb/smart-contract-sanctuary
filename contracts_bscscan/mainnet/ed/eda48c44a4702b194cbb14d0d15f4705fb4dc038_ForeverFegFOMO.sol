...
*/
/*
welcome to ForeverFegFOMO people who have received this token will be 
deemed to have accepted all the following conditions

because the market cap is low, the ForeverFegFOMO will rise and fall very quickly,
...
contract ForeverFegFOMO is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "ForeverFegFOMO";
