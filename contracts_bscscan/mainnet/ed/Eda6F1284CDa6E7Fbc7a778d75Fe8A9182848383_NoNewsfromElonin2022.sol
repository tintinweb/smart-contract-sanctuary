...
contract NoNewsfromElonin2022 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "No News from Elon in 2022";
    string private _symbol = "NoElon22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43a8C389Cc551a4f787F8AaE180f673350f24fa2); // Marketing Address
    address payable public DevWalletAddress = payable(0x34De8cbdd7d97C81763A5DaF57E75B8cA40bD65A); // Dev Address
