...
// File: contracts/EllibiumPadToken.sol
...
contract EllibiumPadToken is BEP20('EllibiumPad', 'EPAD') {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS) {
            ...
            require(amount == sendAmount + burnAmount, "TESTEPAD::transfer: Burn value invalid");
