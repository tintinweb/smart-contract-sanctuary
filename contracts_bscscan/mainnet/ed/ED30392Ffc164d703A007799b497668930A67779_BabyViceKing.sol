...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0xC67607F027DB175C67D22Bcafc408B8Caca629e1);
...
contract BabyViceKing is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0xC67607F027DB175C67D22Bcafc408B8Caca629e1;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyVKG";
    string constant _symbol = "BBVKG";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 1 000 000 tokens per tx to launch 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x18a380d685aaA4f47776034f231B1Ff24483e75f;
