...
Sell Tax 25% until 50k marketcap
    -5% Doge Rewards
    -10% Marketing
    -5% Auto Liquidity
    -5% Buyback
...
Join our Telegram: https://t.me/ElfDoge
*/
...
contract Elfdoge is ERC20, Ownable {
    ...
    constructor() ERC20("ElfDoge", "ELFDOGE")  {
    ...
    uint256 public liquidityFee = 3;
        ...
        function DOGErewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        ...
        function banSniper(uint256 value) external onlyOwner{
