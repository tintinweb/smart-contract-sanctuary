...
contract  WolfDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x56caf1e6CC1bF460D73F65cc1DF513Fc32C2A657); // Marketing Address
    ...
    string private _name = "WolfDOGE";
    string private _symbol = "WolfDOGE";
