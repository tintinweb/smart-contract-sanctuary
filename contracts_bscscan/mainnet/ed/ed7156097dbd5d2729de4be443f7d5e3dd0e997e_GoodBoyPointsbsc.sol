...
contract GoodBoyPointsbsc is IBEP20 {
    ...
    string constant _name = "GoodBoyPoints.cov";
    string constant _symbol = "GBPv";
    ...
    constructor ()  {
        address marketingFeeReceiver = 0x5470983b3d3ad8C1C8Fef78389f12daf11F4Df68;
         owner = msg.sender;
