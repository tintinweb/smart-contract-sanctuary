...
contract CheadleInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xFAfb1E99a04EF2CC508780b172Beaacab07A91cF;
 
    string constant _name = "Cheadle Inu";
    string constant _symbol = "Cheadle";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit antiBotted(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    function setDistributionSetting(bool _enabled, uint256 _amount) external authorized {
    ...
    event antiBotted(uint256 amountBNB, uint256 amountBOG);
}