...
contract SnipeyBoi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SnipeyBoi";
    string constant _symbol = "SnipeyBoi";
    ...
    uint256 init_reflectionFee   = 9;
    uint256 init_marketingFee    = 6;
    uint256 public init_totalFee = 18;
