...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 UNCL = IBEP20(0x0E8D5504bF54D9E44260f8d153EcD5412130CaBb); 
  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function deposit() external payable override {
        uint256 balanceBefore = UNCL.balanceOf(address(this));
        ...
        uint256 amount = UNCL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            UNCL.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 amountUNCL);
...
contract BabyUNCL is IBEP20, Auth {
    using SafeMath for uint256;
  
 
     address UNCL = 0x0E8D5504bF54D9E44260f8d153EcD5412130CaBb;  
     address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyUNCL";
    string constant _symbol = "BaUNCL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);  
    uint256 public _maxTxAmount = _totalSupply / 200;  // 0.1%         
    uint256 public _maxWallet = _totalSupply / 60; // 1.5%
