...
contract ChocolateLavaCake is Context, IERC20, Ownable {
    ...
    string private   _name = "Chocolate_Lava_Cake";
    string private _symbol = "$CLAVACAKE";
