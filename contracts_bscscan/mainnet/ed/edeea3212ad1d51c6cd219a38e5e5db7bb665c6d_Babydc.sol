...
contract Babydc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyDC";
    string private _symbol = "BabyDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF849cD19B13cA23547E97EdA753658df266bf443); // Marketing Address
    address payable public teamWalletAddress = payable(0xF849cD19B13cA23547E97EdA753658df266bf443); // Team Address
