...
// MURU on BSC for all the puppies that wanted cheap transfers and swaps! 
...
contract MURU is Context, IERC20, Ownable {
    ...
    string private _name = 'MURUtoken';
    string private _symbol = 'MUR';
