...
Welcome to MiniPolygon


Telegram: https://t.me/MiniPolygonBsc

Telegram: https://t.me/MiniPolygonBsc


Within the MiniPolygon community we believe transparency is key for a successful project . For this reason we will reveal all relevant information from the beginning;
...
• No Team Tokens
• Marketing Tokens: 5% (Unsold For Reflections)
• Tokens for Burn: 5%
• Giveaway Tokens: 2.5%
...
• Liquidity pool tax is present, which is crucial for any successful project
• Polygon rewards on all sells help to reward all holders as sellers exit
• Burn taxes are mediocre, rather see that extra % go into liquidity tax
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function Claim_Matic() public virtual onlyOwner {
...
contract MiniPolygon is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("MiniPolygon", "MPOL") {
