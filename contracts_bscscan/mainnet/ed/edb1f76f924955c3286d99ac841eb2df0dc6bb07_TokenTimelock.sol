...
contract TokenTimelock is Ownable {
    ...
    uint256 constant public PERIOD = 180 days; // 30 days, 
    uint256 public START_TIME = block.timestamp + PERIOD; // 12:00:00 GMT 27/7/2021
    ERC20 public TOKEN = ERC20(0xBDc085ecA4F8B8Afb965E7347af0Cb76Df168C26);

    uint256 public lockToken = 1000000 * 10**18;
