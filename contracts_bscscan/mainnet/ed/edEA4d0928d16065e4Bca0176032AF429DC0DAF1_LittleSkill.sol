...
contract LittleSkill is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 5000000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 3000000000000 * (10**18);
    uint256 public swapTokensAtAmount = 1500000000000 * (10**18);
    uint256 public maxWalletToken = 100000000000000 * (10**18); // 10% of total supply
...
contract LittleSkillDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("LittleSkill_Dividend_Tracker", "LittleSkill_Dividend_Tracker") {
    	claimWait = 1800;
        minimumTokenBalanceForDividends = 1500000000000 * (10**18); //must hold 1500000000000+ tokens
    }
