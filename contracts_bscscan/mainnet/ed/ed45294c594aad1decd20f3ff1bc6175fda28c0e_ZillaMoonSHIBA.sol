...
// CHANGE
contract ZillaMoonSHIBA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ZillaMoonSHIBA";
        string constant _symbol = "ZillaMoonSHIBA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1,000,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% MAX 5,000,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x2285c9b55a2CC022fBaff5C3524a5b25042675BB);
