...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Rich';
    string constant public symbol = 'RICH';
    uint8 constant public decimals = 18;
    uint256 public totalSupply =  100000000000*10**uint256(decimals);
    uint256 public constant MAXSupply = 1000000000000000000000000000000000000 * 10 ** uint256(decimals);
    ...
    address public projectAddress = 0xed9e392A43192F38A8A0CD2bD36681C723291012;
...
contract METAAPES is BaseToken {
