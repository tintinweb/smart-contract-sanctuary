...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0xB9BFE0bEe0498edd3afEc3F2071A2f0487a0A625; //contract wallet
...
contract FlokiUFC is ERC20, Ownable {
    using SafeMath for uint256;

    /// constants
    uint256 public constant MAX_FEE_RATE = 250;
    ...
    constructor() ERC20("FlokiUFC", "MMA") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        contractWallet = 0x7b8C9fcEe5A4Bf9F48Aaad7424D03B5c9B894D33;
        marketingWallet = 0xEF8B46993f8500a48956c0e73c6C46c31411285B;
        ...
        */
        _mint(deadAddress, 7 * (10**14) * (10**18));
        _mint(contractWallet, 3 * (10**14) * (10**18));
    }
    ...
    function afterPreSale() external onlyOwner {
        a80DividendRewardsFee = 10;
        b20DividendRewardsFee = 10;
        marketingFee = 5;
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by FlokiUFC");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by FlokiUFC");
    ...
    function _transfer(
        ...
        require(!isBlacklisted(from), "FlokiUFC: sender blacklisted");
        require(!isBlacklisted(to), "FlokiUFC: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "FlokiUFC: sender blacklisted");
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "FlokiUFC: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "FlokiUFC: Account is not blacklisted");
