...
//        if(!launched() && recipient == pair){ require(_balances[sender] > 0); launch(); }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(reflectionFee.sub(200)).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee.add(200)).div(totalBNBFee);
