...
/*
     ...
     ______  _______    ____  _____   ______    ____            _____        ______                   
    |      \/       \  |    ||\    \ |\     \  |    |       ___|\    \   ___|\     \  _____      _____
   /          /\     \ |    | \\    \| \     \ |    |      |    |\    \ |     \     \ \    \    /    /
  /     /\   / /\     ||    |  \|    \  \     ||    |      |    | |    ||     ,_____/| \    \  /    / 
 /     /\ \_/ / /    /||    |   |     \  |    ||    |      |    |/____/ |     \--'\_|/  \____\/____/  
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x5E0B09b04d6990E76DFE9BF84552a940FD0BE05E);
...
contract MiniREX is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD = 0x5E0B09b04d6990E76DFE9BF84552a940FD0BE05E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniRex";
    string constant _symbol = "MREX";
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 300; 
    bool inSwap;
