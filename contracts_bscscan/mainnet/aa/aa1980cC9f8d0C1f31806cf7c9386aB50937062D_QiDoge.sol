...
contract QiDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2fcaea9ca054806c90B154892E0D417470555555); // Marketing Address
    ...
    string private _name = "QiDoge";
    string private _symbol = "QiDoge";
