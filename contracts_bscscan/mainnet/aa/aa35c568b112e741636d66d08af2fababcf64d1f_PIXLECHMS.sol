...
- Fairlaunch TBA
- Intial MC 3K$ 
- 12% Slippage buy & sell
- Lock LP by Unycript
- NFT Marketplace Launch

 🌍Web : https://pixelcheems.com 
🕊Twitter: https://twitter.com/pixel_cheems/
🔎Telegram: https://t.me/pixelcheems
*/
...
contract PIXLECHMS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public developmentAddress = payable(0x758E9797671906b8c71f5eeAFC6b9FFEC9FD5318);
    ...
    string private _name = "PIXEL CHEEMS";
    string private _symbol = "PIXLECHMS";
