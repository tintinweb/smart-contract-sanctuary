...
/*JeetCallCenter (SAFU COMMUNITY, SAFU DEV)

Telegram - https://t.me/JeetCallCenter
*/
...
contract JeetCallCenter is IBEP20, Auth {
    ...
    string constant _name = "JeetCallCenter";
    string constant _symbol = "JCC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 100;  //25% max tx
    uint256 public _maxWalletSize = (_totalSupply * 50) / 100;  //50% max wallet
    ...
    address private marketingFeeReceiver =0x49b4fC64F434331b4Bae70aA1DAbB6b084dcBd37;
    address private teamFeeReceiver =0x49b4fC64F434331b4Bae70aA1DAbB6b084dcBd37;
