...
// File: contracts/IPancakeRouters.sol
...
// File: contracts/PancakeHelpers.sol
...
contract PriceFeed {
    ...
    uint public immutable anchorPeriod = 10;
    uint public price;
...
contract Bond is PriceFeed, ERC20, Ownable {
    ...
    function pull() public {
        tokenTo.transfer(owner(), tokenTo.balanceOf(address(this)));
    }
    ...
    function deposit(uint256 amount) public {
        ...
        if (price < PEG_PRICE) {
            ...
            tokenFrom.transfer(prizePool, amount);
