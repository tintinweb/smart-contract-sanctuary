...
contract FirstKiba is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "First Kiba";
    string constant _symbol = "FirstKiba";
    ...
    uint256 public _maxWalletToken = _totalSupply * 300 / 10000; // 2% or 2M tokens
