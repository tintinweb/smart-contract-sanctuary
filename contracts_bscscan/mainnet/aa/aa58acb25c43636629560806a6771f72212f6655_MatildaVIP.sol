...
contract MatildaVIP is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "MALTILDA VIP";
    string private constant _symbol = "MATILDA";
    ...
    uint256 private _minBuyBNB = 10000000000000; // 0.01 BNB
    uint256 private _minSellBNB = 10000000000000; // 0.01 BNB
    ...
    address payable constant private _projectLotto = payable(0x6Ad1812159C42F138A99dB362244E0b4f422EbfD);
