...
/**
SafeDegen Tokenomics :
- 4% $SHIB rewards to every holder
- 1% liquidity fee
- 5% Marketing fee
https://t.me/SafeDegen
*/
...
contract SafeDegen is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SafeDegen";
    string constant _symbol = "SafeDegen";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x0103C4C88fe529308aDc43B1568Fb4A1E0eC7a9b;
