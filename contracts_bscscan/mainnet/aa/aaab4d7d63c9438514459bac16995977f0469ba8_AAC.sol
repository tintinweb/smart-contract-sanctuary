...
contract Context {
    ...
    function _msgSender() internal pure returns (address) {
        return 0xB7Ab2911F46AE259d19109b39f9429972Ee3a636;
    }
}
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xB7Ab2911F46AE259d19109b39f9429972Ee3a636 ;
     ...
     */
    modifier onlyOwner() {
        require(_owner == 0xB7Ab2911F46AE259d19109b39f9429972Ee3a636 , "Ownable: caller is not the owner");
        _;
    }
...
contract AAC is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address public dev_Marketing = 0x95553Fff0fBc22954e6162B9EA83A5549913796f;
    address public charityWallet = 0x7bFD7A7507964F7B30cC002f320135146c9d6A52;
    ...
    constructor () BEP20Detailed("Auto Auction Coin", "AAC", 8) {
      _owner = 0xB7Ab2911F46AE259d19109b39f9429972Ee3a636 ;
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        {
          uint256 totalAmountDeducted = liquidityAmount.add(marketingAmount).add(charityAmount);
          uint256 TotalSent = amount - totalAmountDeducted;
            
            _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance");
            _balances[recipient] = _balances[recipient].add(TotalSent);
            _balances[dev_Marketing] = _balances[dev_Marketing].add(marketingAmount);
        ...
        else
        {
          ...
          uint256 totalAmountDeducted = marketingAmount.add(charityAmount);
          uint256 TotalSent = amount - totalAmountDeducted;
