...
contract ChefShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x73b725eB2505771d5f6d7f13b15e6589909b97DB); // Marketing Address
    address payable public manualBuybackAddress = payable(0xCD39862F75AD5D456D9a0D03C44171Eb57C7320d); // Marketing Address
    ...
    string private _name = "Chef Shiba";
    string private _symbol = "CHEFSHIBA";
    ...
    uint256 public manualBuyBackDivisor = 5;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Send to Manual Buyback address
        transferToAddressETH(manualBuybackAddress, transferredBalance.mul(manualBuyBackDivisor).div(100));        
    }
