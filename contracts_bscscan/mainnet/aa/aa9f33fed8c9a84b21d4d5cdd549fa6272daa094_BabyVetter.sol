...
BabyVetter - Stealth Launch Soon

Telegram: https://t.me/babyvetterofficial
...
contract BabyVetter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyVetter", "bVETTER")  {
    ...
    function antiBotOn() external onlyOwner{
        }

    function antiBotOff() external onlyOwner{
        }
