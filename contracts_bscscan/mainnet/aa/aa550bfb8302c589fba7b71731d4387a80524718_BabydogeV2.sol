...
contract BabydogeV2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Babydoge V2";
    string private _symbol = "Babydoge V2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x111AF96e02511f7B88258cA5dBdaE4A795ccb442); // Marketing Address
    address payable public teamWalletAddress = payable(0x4678F419E174Db09AcAB87C1Bf7c9724EbF7fEc6 ); // Team Address
