...
contract indexfund is Ownable, ERC20PresetMinterPauser {
    ...
    ) ERC20PresetMinterPauser("indexfund Token", "indexfund") {
        token = IERC20(_token);
    ...
    function withdrawAssets(uint256 shares, address withdrawAddress) external {
        require(balanceOf(msg.sender) >= shares, "Not enough indexfund tokens");
