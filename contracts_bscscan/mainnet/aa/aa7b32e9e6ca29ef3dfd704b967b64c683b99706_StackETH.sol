...
contract StackETH is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Stack ETH";
    string constant _symbol = "Stack ETH";
    ...
    address public marketingFeeReceiver = address(0x5d2F5c0F4F448CEb2804993cCDdd63430Bb0FFF2);
