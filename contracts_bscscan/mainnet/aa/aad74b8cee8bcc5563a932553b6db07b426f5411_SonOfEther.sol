...
* SonOfEther is all about being stealthy and exciting! 
 * I am a well known safe dev although anonymous I will appear in the TG when we hit 100k MC.
 * Super stealth launch. No TG yet so I recommend creating one called: https://t.me/SonOfEther
...
/* Token contract */
contract SonOfEther is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "on Of Ether";
