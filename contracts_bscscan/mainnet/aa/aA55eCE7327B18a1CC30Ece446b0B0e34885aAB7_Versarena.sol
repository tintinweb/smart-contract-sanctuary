...
contract ERC20 is IERC20 {
     ...
     */
    function _play(address account, uint256 value) internal {
        require(account != address(0));
...
contract VexarenaContract is ERC20, PlayerRole {
   
    function play(address to, uint256 value) public onlyPlayer returns (bool) {
        _play(to, value);
        return true;
    }
}
...
contract Versarena is VexarenaContract, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("VERSARENA", "VEX", DECIMALS) {
        _play(msg.sender, INITIAL_SUPPLY);
    }
}