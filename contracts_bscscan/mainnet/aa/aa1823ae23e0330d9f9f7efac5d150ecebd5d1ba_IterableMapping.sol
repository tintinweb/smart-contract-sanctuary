...
A unique NFT, episodic content based project 
featuring the adventures of Dr Z. and Gudboi !
🚀 Dedicated based of supporters intent 
to send this project to the moon

https://www.paradoxtoken.net/
https://twitter.com/PARADOXTOKEN
https://t.me/PARADOXTOKEN
...
contract Paradox is ERC20, Ownable {
    ...
    constructor() ERC20("Paradox", "Paradox") {
    	...
    	cakeDividendToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "Paradox: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "Paradox: The new dividend tracker must be owned by the Paradox token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Paradox_Dividend_Tracker", "Paradox_Dividend_Tracker", 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 500000 * (10**18); //must hold 500,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "Paradox_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "Paradox_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "Paradox_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "Paradox_Dividend_Tracker: Cannot update claimWait to same value");
