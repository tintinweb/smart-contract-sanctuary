...
/**
   ...
   Welcome to Ferrari Token - combine together to #Ferrari.
   
   TELEGRAM: https://t.me/FerrariBSC
   ...
   I make this #Ferrari to hand over to the community.
...
contract Ferrari is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Ferrari";
  string constant tokenSymbol = "Ferrari";
