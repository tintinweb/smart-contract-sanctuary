...
AmericaWhale - Big rewards!

TG - https://t.me/AmericaWhale
...
contract AmericaWhale is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "America Whale";
    string constant _symbol = "$MericaWhale";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 500; //0.2% of total supply
