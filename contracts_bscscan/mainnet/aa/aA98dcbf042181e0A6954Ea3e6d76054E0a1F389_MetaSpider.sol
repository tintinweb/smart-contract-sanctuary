...
contract MetaSpider is IBEP20, Auth {
    ...
    string constant _symbol = "METASPIDER";
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardsFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        rewardsFee = _rewardsFee;
        marketingFee = _marketingFee;
        buybackFee = _buybackFee;
        totalFee = _liquidityFee.add(_rewardsFee).add(_marketingFee);
