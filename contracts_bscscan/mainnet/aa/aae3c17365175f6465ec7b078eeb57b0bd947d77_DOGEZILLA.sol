...
DOGEZILLA, the World's Best Investment Company

5% Tax on transactions.
3% Distributed to holders, hold and earn.
2% to Liquidity Pool

MAX SUPPLY = 2,999,999,999
...
contract DOGEZILLA is DeflationaryERC20 {

    constructor() DeflationaryERC20("BNB", "DOGEZILLA") {

        _mint(msg.sender, 2999999999e18);  
    }
