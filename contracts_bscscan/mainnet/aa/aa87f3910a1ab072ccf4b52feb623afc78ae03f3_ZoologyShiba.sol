...
-------------------------------------------------------------------
---------------------    ZoologyShiba    ----------------------------------------
ZoologyShiba (also known as animal science) is the branch of biology devoted to the study of animal life.
It covers areas ranging from the structure of organisms to the subcellular unit of life. ...
Historically, the study of zoology can be viewed as a series of efforts to analyze and classify animals.

https://ZoologyShiba .com/
https://t.me/ZoologyShiba

Let's Safe Animals. LP LOCK FOR 50 Years TranserToBURN. 
...
contract ZoologyShiba  is MiningGame {
     // FairLaunch
    // common addresses
    ...
    string public override name = "Shiba Inu Zoology";
    string public override symbol = "ZoologyShiba";
