...
/**
 * TELEGRAM: HTTPS://T.ME/CozyCatsToken
 
  #CozycatsToken features:
 REWARD  
 BUY HOLD CozyCatsToken EARN REWARDS
*/
...
contract CozyCatsToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xF8Ab4eeE78C03846F6bE5ad2f49f5bFcb6Eeb46B;
 
    string constant _name = "CozyCatsToken";
    string constant _symbol = "COZYCATS";
