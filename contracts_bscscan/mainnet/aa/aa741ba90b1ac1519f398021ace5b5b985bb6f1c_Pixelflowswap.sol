...
contract Pixelflowswap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x96b8a2Dc0110b02b9178D7748a725187db8b7750); // Marketing Address
    ...
    string private _name = "Pixelflowswap";
