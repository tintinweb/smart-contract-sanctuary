...
TheRealDoge is built upon the fundamentals of Buyback and increasing the investor's value
...
contract TheRealDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5981a5C28efEEDB1115Fb0A5f3C6C5b20eF0c183); // Marketing Address
    ...
    string private _name = "TheRealDoge";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xe3252d405C3f72506C3C9F984817d15a39075DC1);
