...
Telegram: https://t.me/parabolicfloki
Website: https://parabolicflokitoken.com
*/
...
contract ParabolicFloki is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xBCE4DD7F540d28cA2410b3518598840bb836FBaE);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xBCE4DD7F540d28cA2410b3518598840bb836FBaE); 

    string private _name    = "ParabolicFloki";
    string private _symbol  = "ParaF";
    ...
    uint256 public _externalFee             = 60;
    ...
    uint256 public _externalTokenMinAmount          = 500 * 10**6 * 10**_decimals;
