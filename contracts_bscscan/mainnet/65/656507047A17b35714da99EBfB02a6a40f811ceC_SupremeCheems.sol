...
contract SupremeCheems is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 888_888_888_888; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "SupremeCheems";
    ...
    uint256 public _marketingFee = 9000; // All taxes are divided by 100 for more accuracy.
    ...
    address public burnAddress = 0x5552E6DFaAc2C47D246Bdc55596f9A3C09Ea311e;
    address payable private _marketingWallet = payable(0x023B472ee427a721E5a14121C3941F8e527e2C3C);
    address payable private _devWallet = payable(0x5552E6DFaAc2C47D246Bdc55596f9A3C09Ea311e);
