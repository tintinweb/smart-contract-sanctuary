...
MetaVerseMask
Community token, stealth launch.
Fair start for each holder including me as a dev.
No dev wallet and pump and dump. SAFU.
Will burn lp tokens forever and renounce myself.
The holders can make a TG group to make this bigger. I believe you can make this 100x.
4% burn fee to avoid bots. 
...
contract MetaVerseMask is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("MetaVerseMask", "META") {
