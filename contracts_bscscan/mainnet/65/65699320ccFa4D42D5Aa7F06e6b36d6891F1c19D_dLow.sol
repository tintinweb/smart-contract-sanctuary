...
Official Telegram -https://t.me/dForeverLow   The group is private for npow!
...
import "./dLowDividendTracker.sol";

contract dLow is ERC20, Ownable {
    ...
    dLowDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("dForeverLow", "dLow") {

    	dividendTracker = new dLowDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "dLow: The dividend tracker already has that address");

        dLowDividendTracker newDividendTracker = dLowDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "dLow: The new dividend tracker must be owned by the dForeverLow contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "dLow: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "dLow: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "dLow: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "dLow: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "dLow: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "dLow: Cannot update gasForProcessing to same value");
