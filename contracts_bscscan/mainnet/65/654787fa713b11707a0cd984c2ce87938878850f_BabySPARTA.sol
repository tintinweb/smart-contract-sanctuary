...
contract BabySPARTA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabySPARTA";
    string constant _symbol = "BabySP";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingAddress = 0x5aFaF8c83A5B2C537749685B56CFCfacfA2539D5;
