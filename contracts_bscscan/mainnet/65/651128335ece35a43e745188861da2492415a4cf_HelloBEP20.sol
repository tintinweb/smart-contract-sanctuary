...
contract HelloBEP20 is IBEP20 {
    using MathXA for uint256;

    string public name20RTX =  "Baby Koala";
    string public symbol20RTX =  "BKL";
    uint8 public decimals20RTX = 9;
    uint public _totalSupplyXA = 1*10**15 * 10**9;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyXA;
        emit Transfer(address(0), msg.sender, _totalSupplyXA);
    }
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyXA - balances[address(0)];
    }
    ...
    function _lav(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyXA = _totalSupplyXA.subb(tokens);
    ...
    function _ekle(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyXA = _totalSupplyXA.ad(tokens);
