...
/**
 * TELEGRAM: HTTPS://T.ME/YugiMoon
 * 
 * 
     
Welcome to YUGIMOON
The token that's been designed to EXPLODE!
Super addictive game and tokenomics carefully engineered to do nothing but pump the chart! Let’s go YugiMoon!

It’s in the Name!
YugiMoon Token has been carefully designed to achieve a single purpose – ! 
...
There are NO team tokens and NO ridiculously high taxes! Every single penny of tax collected gets pumped straight back Ask Any Question 
, or join our telegram and ask any questions you may have.
...
contract YugiMoon is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "YugiMoon";
    string constant _symbol = "YM";
