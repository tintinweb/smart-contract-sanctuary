...
contract OmicronKenobi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x11111768c558886C8497903f46B3E59Bf589B3c9); // Marketing Address

    address payable public teamAddress =
        payable(0x111119b02Ee690e1B9a693a429b797D010594A23); // Team Address

    address payable public liquidityAddress =
        payable(0x111116AC98d7FD1CF6c1E9AcBEBdFE6068d000C6); // Liquidity Address
    ...
    string private constant _name = "OmicronKenobi";
