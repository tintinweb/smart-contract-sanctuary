...
/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #PandaEverRise designed.
   ...
   I will renounce the ownership to burn addresses to transfer #PandaEverRise to the community, make sure it's 100% safe.

   I will add 0.3 BNB and all the left 10% total supply to the pool
   Can you make #PandaEverRise 100000X? 

   1,000,000,000,000,000 total supply
   5,000,000,000,000 PandaEverRise max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #PandaEverRise idea, increasing the liquidity pool automatically, 
...
contract PandaEverRise is Context, IERC20, Ownable {
    ...
    string private _name = "PandaEverRise";
    string private _symbol = "PER🐼";
