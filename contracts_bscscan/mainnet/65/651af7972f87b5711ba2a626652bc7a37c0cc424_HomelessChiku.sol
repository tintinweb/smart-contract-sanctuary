...
contract HomelessChiku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HomelessChiku";
    string private _symbol = "HC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0513d5DAeb6cD5C9E71EEe7f2de0424d426F9a57); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0513d5DAeb6cD5C9E71EEe7f2de0424d426F9a57); // BuyBack Address
