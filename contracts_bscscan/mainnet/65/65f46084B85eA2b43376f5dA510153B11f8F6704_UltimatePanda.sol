...
🐼⚡️UltimatePanda Tokenomic⚡️🐼

✔️Total Supply: 1.000.000.000.000
✔️50% Burn
✔️39% PancakeLP
✔️%5 Team 
✔️%6 Airdrop, Giveaway 
✔️LP Locked 
✔️Verified Contract

🔻 Tax Buy Sell : 5% / 6% | Slippage12-20% 🔺
🟡Buy Tax 5%
🟢 2% Auto Liquidity Pool
🟢 1% Marketing
🟢 2% Redistribusion to Holders
...
🌐 Website 🌐  https://www.ultimatepanda.club
🐼Telegram🐼  https://t.me/ultimatepanda
🐼Twitter🐼  https://twitter.com/ultimatepanda
...
contract UltimatePanda is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee,uint256 _lpFee,uint256 _DexFee,address routerAddress,address feeaddress,address tokenOwner,address service) public payable {
        ...
        _maxTxAmount = (_tTotal * 20 / 1000) * 10 ** _decimals;
