...
/**
 ...
 ^   2) Contribute to the contract with at least the minimum amount of doge required + Blockchain Fees
 ...
 ^   - Minimum deposit: 10 doge, 200000 doge max deposit per wallet due for anti ANTI_WHALE protection
...
contract FarmFactoryDOGE is Context, Ownable {
    using SafeMath for uint256;

    address doge = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    IBEP20 token;

    uint256 public constant INVEST_MIN_AMOUNT = 1 ether;// 1 doge
    ...
    uint256 public constant ANTI_WHALE = 200000 ether;// 200000 doge
    ...
    function invest(address referrer, uint8 plan, uint256 _amount) public payable {
      ...
      require(totalDeposits < ANTI_WHALE, "Deposit limit reached (200,000 doge)");
