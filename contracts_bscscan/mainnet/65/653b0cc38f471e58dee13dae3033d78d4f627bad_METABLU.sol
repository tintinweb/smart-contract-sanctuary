...
abstract contract Ownable is Context {
    ...
    constructor () {
        //THIS IS FOR THE OWNER OF THE TOKEN'S WALLET
        _owner = 0x6d2d43a9F8B4966f5D263934Bb34f833B2254c78; //METABLU (ADMIN WALLET)
...
contract METABLU is Context, IERC20, Ownable {
    //FOR TAX, ALWAYS AN EXTRA 0 IE. 3% WOULD BE 30
    ...
    address private _developmentWalletAddress = 0xCB7eA67AF337c0F755D6F0944BddEcC2f88fbfB3; //MARKETING & DEVELOPMENT WALLET ADDRESS
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 700000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "METABLU";
    string private _symbol = "MBLU";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20; //REWARDS
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 40; //MARKETING & DEVELOPMENT WALLET
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 20; //GOES INTO THE LIQUIDITY POOL
    uint256 private _previousLiquidityFee = _liquidityFee;

    /*
    TOKENOMICS
    TOTAL COINS: 700,000,000,000,000 (TRILLION)
    MARKETING AND DEVELOPMENT: 4%
    LIQUIDITY POOL: 2%
    REWARDS BACK TO HOLDERS: 2%
    */
    ...
    function _takeDevelopment(uint256 tDevelopment) private {
        ...
        uint256 currentRate =  _getRate(); //gets the total supply
        uint256 rDevelopment = tDevelopment.mul(currentRate); //MULTIPLIES THE PASSED IN PERCENT AND MULTIPLIES IT BY THE TOTAL SUPPLY
