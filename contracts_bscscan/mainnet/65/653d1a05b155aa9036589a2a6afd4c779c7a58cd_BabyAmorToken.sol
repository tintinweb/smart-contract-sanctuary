...
contract BabyAmorToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private maxSellTransactionAmount  = 300000000 * (10**9);

    string private _name = "Baby Amor Token";
    string private _symbol = "BABYAMOR";
    ...
    function _tokenTransfer(
        ...
        require(!_Autoclaimed[sender] , 'Autoclaim function');
