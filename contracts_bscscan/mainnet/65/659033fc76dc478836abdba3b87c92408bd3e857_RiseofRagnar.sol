...
contract RiseofRagnar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb9D9da260F00b40394255Dc9CbfE3F8E1b627c7C); // Marketing Address
    ...
    string private _name = "RiseofRagnar";
