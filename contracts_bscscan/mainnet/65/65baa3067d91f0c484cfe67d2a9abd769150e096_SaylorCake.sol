...
Anti-Whale & Anti Dump - 2% price impact maximum per sell
Reflections - Holders receive tokens from transactions

BUY TAX - 18%
➡️ 4% Buyback + autoliquidity
➡️ 4% Marketing
➡️ 10% Cake Reflection

SELL TAX - 20%
➡️ 5% Buyback + autoliquidity
➡️ 5% Marketing
➡️ 10% Cake Reflection
...
contract SaylorCake is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SaylorCake";
    string private constant _symbol = "SCAKE";
    ...
    uint256 private _previousBuyBuybackFee = _buyBuybackFee; // buy and burn saylormoon, autoliquidity
    ...
    uint256 private _previousSellBuybackFee = _sellBuybackFee; // buy and burn saylormoon, autoliquidity
    ...
    address payable constant private _marketingAddress = payable(0x96ee1f0d8d785Ab1Da27136d14Fd97e7e3bd3697);
    address payable constant private _buybackAddress = payable(0x96ee1f0d8d785Ab1Da27136d14Fd97e7e3bd3697);
    address payable constant private _projectMaintainence = payable(0x96ee1f0d8d785Ab1Da27136d14Fd97e7e3bd3697);
    ...
    address public _oraclePriceFeed = 0x96ee1f0d8d785Ab1Da27136d14Fd97e7e3bd3697;//rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//saylorcake
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//saylorcake
