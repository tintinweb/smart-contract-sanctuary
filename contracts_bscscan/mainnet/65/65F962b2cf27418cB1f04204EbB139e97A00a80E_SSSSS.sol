...
contract SSSSS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xF34aF2faF6aB939EC23038A53697c488aBFF2d4D); // Marketing Address
    ...
    string private _name = "SSSSS";
    string private _symbol = "SSSSS";
    ...
    uint256 public _maxTxAmount = 50 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 5 * 10**6 * 10**9; 
    uint256 private buyBackUpperLimit = 5 * 10**18;
