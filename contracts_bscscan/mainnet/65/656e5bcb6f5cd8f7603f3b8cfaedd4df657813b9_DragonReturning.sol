...
contract DragonReturning is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0xf74C0f39e6Fe3537365460864071133CA7B1D748;
    ...
    string private _symbol = "DragonReturning";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account !=0x, 'We can not exclude Uniswap router.');
