...
contract VORTEXTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public devWallet = payable(0x134d975096c1783AdedDb4dC5eFB715a0eE5040b); // dev wallet Address
    address payable public marketingWallet = payable(0x31752FC82ece28A2D5854298c32A6d31CC7d51dF); // marketing Address
    ...
    string private _name = "Vortex Token";
