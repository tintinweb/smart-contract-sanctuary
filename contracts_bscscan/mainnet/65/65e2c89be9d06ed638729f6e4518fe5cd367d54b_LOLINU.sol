...
contract LOLINU is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "LOLINU";                                          // name
    string private _symbol = "LOL";                                             // symbol
    ...
    //2% auto-liq, 3% manual-liq, 4% marketing, 1% elected wallet 
    ...
    uint[] public _percentages = [38,50,12];                                             // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x89d0bc3c83b1Dd9BA0b9512159Cc399c7ACe39A8),                             // Liquidity BuyBack
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for BNB
        swapTokensForBNB(liquifyHalves[0]); // <- this breaks the BNB -> MOONV swap when swap+liquify is triggered
