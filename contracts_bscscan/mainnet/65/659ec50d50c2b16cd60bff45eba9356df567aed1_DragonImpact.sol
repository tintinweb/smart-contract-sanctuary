...
Telegram group we made after cms and web ready

cms and web processes are 70%

supply burn 50% 
max tx 2%
max wallet 4%

https://t.me/DragonImpact 
( made after all is done, in order to avoid fud)
...
contract DragonImpact is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DragonImpact";
    string constant _symbol = "DragonImpact";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xB78af156f818D73b4BcA682b2713420CEAd65C39;
