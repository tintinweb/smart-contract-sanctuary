...
contract godmotherdoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x98c0313069a5Be2732CC0ff32B6435c74D0a5f32); // Marketing Address
    ...
    string private _name = "God Mother Doge";
    string private _symbol = "GodMotherDoge";
