...
contract Token is ERC20, Ownable {
    ...
    uint256 public maxSupply = 800_000_00 ether;

    constructor(string memory _nameToken, string memory _symbol) ERC20(_nameToken, _symbol) {}
    ...
    function mint (address to, uint256 amount) public onlyOwner {
        require((totalSupply() + amount) <= maxSupply, "is max supply");
        _mint(to, amount);
    }
}