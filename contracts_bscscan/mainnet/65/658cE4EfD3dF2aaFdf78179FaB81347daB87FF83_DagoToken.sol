 ...
 */
contract DagoToken is Context, ERC20, Ownable, AccessControl {
    ...
    // Testnet v2: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
	...
	uint256 private _sellFeeForRate = 5;
    ...
    uint256 public swapLockTime = 0; // init time for first 

	/**
	 *  Constructor that gives msg.sender all of existing tokens.
	 */

    constructor() public ERC20("Dago Token", "DAGO") {
        maxSupply = 100 * 10 ** 6 * (10 ** uint256(decimals()));
        _mint(_msgSender(), maxSupply); // total 100.000.000 DAGO
    ...
    function initSwap(address routerAddress) external onlyOwner {
		...
		// lock swap dex for token in 1 year
    ...
    function setSellFeeRate(uint256 fee) external onlyOwner {
        require(fee <= 5, "fee need to set lower than 15%");
        _sellFeeForRate = fee;
    }
