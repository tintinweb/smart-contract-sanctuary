...
/*
🥩 Welcome to Beefereum 🥩

✨ It's time to Beef'n up your pockets! Beefereum is The World’s First Decentralized token that will have a professional trading mechanism that ensures our Chart is always at a higher Low.
—————————————————————
✅ Safe dev
...
contract Beefereum is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Beefereum", "BF")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function taxBuyBack(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function sellFeeTo(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function taxLP(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
        ...
        function taxMarketing(uint256 value) external onlyOwner{
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function buyFeeTo(uint256 value) external onlyOwner {
            buyFee = value;
        }
    ...
    function getClaimWait() external view returns(uint256) {
        ...
        function setLaunchAirdrop(uint256 value) external onlyOwner{
