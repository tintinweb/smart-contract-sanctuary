...
// https://www.miniflokishiba.com/
// https://twitter.com/miniflokishiba
...
contract MFLOKI is IBEP20 {
    ...
    string public override name = "Mini Floki Shiba";
    string public override symbol = "MFLOKI";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[foundersPot] = totalSupply * 45 / 100;
