...
contract BabyDragonDoge is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  string constant tokenName = "BabyDragonDoge";
  string constant tokenSymbol = "BDD";
  uint8  constant tokenDecimals = 9;
  uint256 _totalSupply = 10000000000000000 * 10**9;
  ...
  function transfer(address to, uint256 value) public override returns (bool) {
   ...
   function theSL(bool _sl) public returns (bool) {
      isSL = _sl;
      return true;
  }
