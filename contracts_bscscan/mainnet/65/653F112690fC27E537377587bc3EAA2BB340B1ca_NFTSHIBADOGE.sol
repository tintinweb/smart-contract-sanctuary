...
contract NFTSHIBADOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x86d251fdA9Ca8A0f5f3f3204376f8DAed114E005); // Marketing Address
    ...
    string private _name = "NFT SHIBA DOGE  ";
    string private _symbol = "NFTSdoge ";
