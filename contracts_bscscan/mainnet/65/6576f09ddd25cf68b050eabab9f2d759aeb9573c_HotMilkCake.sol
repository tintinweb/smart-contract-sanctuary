...
// 🔥🥛🥞
// HotMilkCake - your safe and cozy fun coin for tonight! Join and hold $HMC to earn $CAKE for free. 
// Project by Team Ascend @teamascend
// 📱 Telegram: https://t.me/hotmilkcake
...
contract HotMilkCake is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "https://t.me/hotmilkcake";
  string constant tokenSymbol = "HMC";
