...
Telegram: https://t.me/LetsFuckingShib
...
contract LetsFuckingShib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LetsFuckingShib";
    string constant _symbol = "$LFS";
