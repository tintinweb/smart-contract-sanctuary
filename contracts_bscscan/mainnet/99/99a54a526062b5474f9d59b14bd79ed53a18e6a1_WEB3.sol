...
contract WEB3 is ERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0x2218b890D0694AD2cef917DBee33a53e571A509d;
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "WEB3: Account is already the value of 'excluded'");
    ...
    function setExtraSellFee(uint256 value) external onlyOwner{
        extraSellFee = value;
        uint256 totalSellFees = rewardFees + liquidityFee + developmentFee;
    ...
    function _transfer(
        ...
        if (
            ...
            require(contractBalanceRecepient + amount <= maxWalletTokens, "WEB3: Exceeds maximum wallet token amount.");
        }
        if(amount == 0) {
    ...
    function swapETHforRewardsandSendToDividends() payable public{
...
contract WEB3DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("WEB3_Dividen_Tracker", "WEB3_Dividend_Tracker") {
    	claimWait = 3600;
