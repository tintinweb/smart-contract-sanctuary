 ...
 * 
 * 
    Pinklemon Token: Give to Earn and Do Good
   #Pinklemon features: www.pinklemontoken.com
   12% transaciton fee as follows:
    ...
    %.75 fee sent to Dapp development wallet
 *
 */
...
contract Pinklemon is Context, IERC20, Ownable {
    ...
    string private _name = "Pinklemon";
    string private _symbol = "PLMN";
    ...
    address public developmentWallet = 0x4dc25EE92232cD92AdbBEc6d2721f6E35E4cEc8C;
    address public marketingWallet = 0x0580e3F3e54609Aa99A3A011Fd38d2206EB8eB47;
    address public liquidityWallet = address(this); //This is the contract address, LP tokens will be burnt
