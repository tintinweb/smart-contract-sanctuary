...
WinWendy'$ is a P2E (play-to-earn) utility token, which is built on the newest and the safest pragma solidity version.

-Initial liquidity is 1 BNB.
...
contract WinWendy$Token is Context, IERC20, IERC20Metadata, Ownable {   
