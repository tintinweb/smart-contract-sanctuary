...
contract StratVLEV2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public elkFarmAddress;
    address public ELKAddress;
    ...
    address[] public earnedToELKPath;
    ...
    constructor(
        ...
        govAddress = 0x5c3360adfba892e5aC3DD4baaADF0487Da38B01E;
        elkFarmAddress = 0x93e94c14C08863190d541E93f45d02A8C89Fc71a;
        ELKAddress = 0x085a855E457e7010f01e420D84b11B2091bFF22b;

        wantAddress = _wantAddress;
        if (wantAddress == wbnbAddress) {
            wantIsWBNB = true;
        }
        token0Address = ELKAddress;
        token1Address = wbnbAddress;
        lockerAddress = 0x7B3Df164C9b8B59a7516e255a7e517dAEE6704A0;
        
        venusToToken0Path = [venusAddress,wbnbAddress,ELKAddress];
        venusToToken1Path = [venusAddress,wbnbAddress];
        venusToWantPath = [venusAddress,wbnbAddress];
        if (wantAddress != wbnbAddress) {
            venusToWantPath.push(wantAddress);
        }
        earnedToELKPath = [venusAddress,wbnbAddress,ELKAddress];
        ...
        transferOwnership(elkFarmAddress);
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(elkFarmAddress, _wantAmt);
