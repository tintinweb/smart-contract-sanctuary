...
contract BabyFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x85d0b0E83ee6F79fEA340d66B3a053a42ab95a8a); // Marketing Address
    ...
    uint256 public _maxSellAmount = 40000000 * 10**6 * 10**9;
