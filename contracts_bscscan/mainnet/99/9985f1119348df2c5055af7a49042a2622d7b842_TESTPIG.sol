...
/**
   #SAFETOKEN - #LIQ+#RFI+#SAFEMOON, combine together to #SAFETOKEN, just like the name, it is a safe token. 
   ...
   I make this #SAFETOKEN to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/SafeTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #SAFETOKEN to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49% total supply to the pool
   Can you make #SAFETOKEN 1000X? 
...
contract TESTPIG is Context, IERC20, Ownable {
    ...
    string private _name = "Test Pig Token";
    string private _symbol = "TESTPIG";
