...
/**
Telegram: https://t.me/Apple_MetaverseBsc
*/
...
contract Contract is IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 tokens) private {
        uint256 denominator = (buyFee + sellFee) * 2;
        uint256 tokensToAddLiquidityWith = (tokens *
            (buyFee + sellFee)) / denominator;
        uint256 half = tokens - tokensToAddLiquidityWith;
        ...
        addLiquidity(tokensToAddLiquidityWith, bnbToAddLiquidityWith, address(this));}
