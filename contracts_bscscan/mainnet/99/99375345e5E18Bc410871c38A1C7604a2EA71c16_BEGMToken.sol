...
contract BEGMToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "BUBBLE GUM";
    string private constant _symbol = "BEGM";
    uint8 private constant _decimals = 18;

    uint256 private _totalSupply = 100000000 * 10**uint256(_decimals);
    uint256 private _poolReward = 300;
    ...
    function setPoolReward(uint256 reward) external onlyOwner {
        require(reward + _marketingReward <= 1500, "Pancake swap limitation");
        _poolReward = reward;
    }

    function setMarketingReward(uint256 reward) external onlyOwner {
        require(reward + _poolReward <= 1500, "Pancake swap limitation");
