...
/**LibraProtocol TOKEN >> LIBRACOL features:
...
contract LibraProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "LibraProtocol";
    string private _symbol = "LIBRACOL";
    ...
    uint256 constant numTokensSellToAddToLiquidity = 20000 * 10**6 * 10**9;
