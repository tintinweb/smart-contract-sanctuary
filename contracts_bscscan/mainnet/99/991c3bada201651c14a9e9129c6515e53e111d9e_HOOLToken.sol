...
contract HOOLToken is Context, IERC20, Ownable {
    ...
    string private _name = "HOOL Token";
    string private _symbol = "HOOL";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x560f46AFaC0f01e1e493A20BB2E248907233F16f, 'We can not exclude Uniswap router.');
