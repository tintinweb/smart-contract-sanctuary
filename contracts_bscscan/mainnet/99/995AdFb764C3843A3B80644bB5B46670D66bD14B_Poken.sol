...
contract Poken is IBEP20 {
  
    // common addresses
    address private owner;
    address private ethreward;
    ...
    string public override name = "Poken";
    string public override symbol = "PKN";
    ...
    constructor(uint totalSupplyValue, address ethAddress, address BNBAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ethreward = ethAddress;
        BNBreward = BNBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ethreward] =  totalSupply * 3 / 100;
        balances[BNBreward] = totalSupply * 46 / 100;
