...
/**
 The characters you might know, (CaptainCaveman)
 
 THIS TOKEN IS NOT OFFICIALLY HANNA-BARBERA LICENSED,
 PLEASE NOTE; THIS TOKEN DOES NOT HAVE ANY UTILITY,
 ONLY AS A MEME!
 ANY FORM OF PROFIT AND LOSS ARE AT YOUR OWN RISK,
 WE NEVER PROMISE ANYTHING OTHER THAN ORGANIC MARKETING
 FROM THE COMMUNITY.
...
contract CaptainCaveman is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CaptainCaveman";
    string constant _symbol = "CaptainCaveman";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x56b8acDCB97c09a8ba368F545040abeD923ad19A;
