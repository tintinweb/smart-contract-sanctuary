...
contract HamaruToken is BEP20('Hamaru', 'MARU'), MinterRole {
    using SafeMath for uint256;

    uint256 constant public MAX_SUPPLY = 1000000000 * 1e18;  // 1B max supply

    uint16 public transferTaxRate = 1000;
    uint public liquidityFeeRate = 500;
    uint public redistributionFeeRate = 500;
    ...
    address public treasuryForRedistributionFee = 0xD01A3bA68E7acdD8A5EBaB68d6d6CfA313fec272;
    ...
    function _transfer(address _sender, address _recepient, uint256 _amount) internal override {
        ...
        uint liquidityFee = _amount.mul(liquidityFeeRate).div(10000);
        uint redistributionFee = _amount.mul(redistributionFeeRate).div(10000);
        
        super._transfer(_sender, _recepient, _amount.sub(liquidityFee).sub(redistributionFee));
        super._transfer(_sender, address(this), liquidityFee);
        super._transfer(_sender, treasuryForRedistributionFee, redistributionFee);
    }
    ...
    function updateTreasuryForRedistributionFee(address _treasuryForRedistributionFee) public {
        require(msg.sender == treasuryForRedistributionFee);
        treasuryForRedistributionFee = _treasuryForRedistributionFee;
    }
