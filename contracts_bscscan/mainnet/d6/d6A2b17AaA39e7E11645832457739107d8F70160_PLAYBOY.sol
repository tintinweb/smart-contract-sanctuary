...
/**
 Welcome to PLAYBOY
   ...
   I will renounce the ownership to burn addresses to transfer #PLAYBOY to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make PLAYBOY 100X? 
   ...
   it's the best part of the #PLAYBOY idea, increasing the liquidity pool automatically, 
