...
// Telegram group is closed before launch, we will open when we live! @SafeMoonSon
...
contract SafeMoonSon is ERC20Detailed, Ownable {  /////
    ...
    uint256 public gonMaxWallet = TOTAL_GONS.div(100).mul(15);
    ...
    constructor() ERC20Detailed("SafeMoonSon", "SMS", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x70F1BADa9B41bB3C475b40650b28438CE8CeF3e6;
        marketingFeeReceiver = 0x70F1BADa9B41bB3C475b40650b28438CE8CeF3e6;
        ecosystemFeeReceiver = 0x70F1BADa9B41bB3C475b40650b28438CE8CeF3e6;
        buyBackFeeReceiver = 0x70F1BADa9B41bB3C475b40650b28438CE8CeF3e6;
