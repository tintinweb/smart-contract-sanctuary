...
📱 Telegram : https://t.me/ShibaGiftBox
...
contract Context {
 ...
 contract ShibaGiftBox is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ShibaGiftBox";
    string private _symbol = "SHIBAGIFTBOX";
    ...
    address private _pancakeRouterV2 = 0xeeeC0693F28D4d3d84E0D12c1b2C99dB757726CC;
