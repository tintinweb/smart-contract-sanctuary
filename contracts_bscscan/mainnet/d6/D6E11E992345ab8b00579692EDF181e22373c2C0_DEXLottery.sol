...
contract DEXLottery is ReentrancyGuard, IDEXLottery, Ownable {
    ...
    uint256 public maxPriceTicketInDexToken = 50 ether;
    uint256 public minPriceTicketInDexToken = 0.005 ether;
    ...
    function setMinAndMaxTicketPriceInDexToken(uint256 _minPriceTicketInDexToken, uint256 _maxPriceTicketInDexToken)
        ...
        onlyOwner
    {
        require(_minPriceTicketInDexToken <= _maxPriceTicketInDexToken, "minPrice must be < maxPrice");
