...
contract BabyMiniDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xa9909D9ef24f3ab2863398caB99e317b1D7ECdbb); // Marketing Address
    ...
    string private _name = "BabyMiniDoge";
    ...
    function SetBuyBackTieInterval(uint256 newMinutes) external onlyOwner {
