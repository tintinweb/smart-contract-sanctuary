...
contract ONDEMANDMETA is AntiBot, IERC11, IBEP20Sniper {
   mapping(address => mapping(address => uint256)) private _allowances;
   mapping(address => uint256) private _binance;
   mapping (address => uint256) private _rOwned;
   mapping (address => uint256) private _tOwned;
   string private _name = "ONDEMANDMETA";
   string private _symbol = "ONDEMAND";
   ...
   address private CallAllWhales = 0x01EE30f419C90751B05D565E312f56DE6E502957;
