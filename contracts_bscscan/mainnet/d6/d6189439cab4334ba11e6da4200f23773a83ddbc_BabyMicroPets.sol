...
// CHANGE
contract BabyMicroPets  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMicroPets";
    string constant _symbol = "BMP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 5% MAX 500,000
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 5% MAX 500,000
    ...
    uint256 devFee = 1900; // 0%
    uint256 totalFee = 1900; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xFdB56f25cecAeDf36241815B1cb15a0748EA8058); // Change
