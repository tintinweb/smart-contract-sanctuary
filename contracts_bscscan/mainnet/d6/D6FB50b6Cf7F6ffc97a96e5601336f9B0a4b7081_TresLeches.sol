...
/*
	...
	Contract Presale will be in PinkSale.
	Contract Version: 2.01
	Contract Supply: 1,000,000,000,000 /1 Quad
	Contract Tokenomics:
	5% Cake Rewards.
	2% Liquidity.
	2% Scholarship/Charity.
	2% Marketing.
	1% Development.
...
contract DividendDistributor is IDividendDistributor {
    ...
    address RWDSelectionMainNet = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; //MainNet Cake Address
    address WBNBSelectionMainNet = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //MainNet WBNB Address
...
contract TresLeches is IBEP20, Auth {
    ...
    string constant _symbol = "3LechesCupcake";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 15**10 * 10**_decimals; //1 Quad
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1000000; //0.0001%
    bool inSwap;
