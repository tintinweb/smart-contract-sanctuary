...
// 
//
// 📱 Telegram:https://t.me/grinchinutoken
// 🌎 Website:www.grinchinu.site
// 🌐 Twitter: https://twitter.com/grinchinutoken
// 📸 Instagram:
//
/**
...
contract SONOFGRINCH is ERC20, Ownable, Shared {
   ...
   constructor() ERC20("GrinchInu", "$GINU") {
   ...
   function updateUniswapV2Router(address newAddress) public onlyOwner {
       require(newAddress != address(uniswapV2Router), "SONOFGRINCH: The router already has that address");
   ...
   function setMarketingWallet(address payable wallet) external onlyOwner{
       require(marketingWalletAddress != address(0), "SONOFGRINCH: Can't set marketing wallet to the zero address");
       marketingWalletAddress = wallet;
   }
  
   function setDevWallet(address payable wallet) external onlyOwner{
       require(devWalletAddress != address(0), "SONOFGRINCH: Can't set developer wallet to the zero address");
       devWalletAddress = wallet;
   }
  
    function setbuybackWallet(address payable wallet) external onlyOwner{
       require(buybackWallet != address(0), "SONOFGRINCH: Can't set buyback wallet to the zero address");
       devWalletAddress = wallet;
   }
   ...
   function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
       require (maxTxPermille > 0, "SONOFGRINCH: Can't set max Tx to 0");
       maxTxAmount = totalSupply() * maxTxPermille / 1000;
   }
 
   function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
       require(pair != uniswapV2Pair, "SONOFGRINCH: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
   ...
   function _setAutomatedMarketMakerPair(address pair, bool value) private {
       require(automatedMarketMakerPairs[pair] != value, "SONOFGRINCH: Automated market maker pair is already set to that value");
   ...
   function _transfer(
       ...
       require (tradingOpened || isExcludedFromFees[from], "SONOFGRINCH: Trading paused");
       require(from != address(0), "ERC20: transfer from the zero address");
       require(to != address(0), "ERC20: transfer to the zero address");
       require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "SONOFGRINCH: Blacklisted address");
