...
This token is going to have a crazy ride to the top with our effective manual buy back system to eat every Dip! 
https://t.me/FirstKabosu
 */
...
contract FirstKabosu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FirstKabosu";
    string constant _symbol = "FKBU";
    ...
    uint256 buybackMultiplierNumerator = 100;
