...
minidoge fork autoboost function, meme token.
...
contract Testte is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7111a26C6208533240691DAfA3A27B2E732Ec4c3); // Marketing Address
    ...
    string private _name = "Ttest";
    string private _symbol = "TTest";
