...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public farmContractAddress; // address of  PCS farm
    uint256 public pid; // pid of pool in PCS farm
    ...
    uint256 public TENGas_Fee;//  0.4%(0.1% TENGas fee + 0.3% platform fee)
    uint256 public constant TENGas_FeeMax = 10000; // 100 = 1%
    uint256 public constant TENGas_FeeUL = 300;

    uint256 public TENBurn; //   2%(buy-back and burn fee for non-TENFI vaults)
    ...
    uint256 public entranceFeeFactor; // < 1% entrance fee - goes to pool + prevents front-running
    uint256 public constant entranceFeeFactorMax = 10000;
    uint256 public constant entranceFeeFactorLL = 9500; // 5% is the max entrance fee settable. LL = lowerlimit

    uint256 public withdrawFeeFactor; // 0% withdraw fee
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(TENFIFarm, _wantAmt);
...
contract TENFIStrategy_PCS is StratX2 {
