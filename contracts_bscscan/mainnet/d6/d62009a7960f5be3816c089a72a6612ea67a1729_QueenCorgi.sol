...
contract QueenCorgi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**12 * 10**12;
    ...
    string private _name = "Queen Corgi";
    string private _symbol = "QCORGI";
    ...
    uint256 public _maxTxAmount = 1000 * 10**12 * 10**12;
    uint256 private minimumTokensBeforeSwap = 1 * 10**12 * 10**12; 
    
    address payable private charityAddress = 0xCf77904502343069b2dC5C8f27De7E5f8aD4b1B1; // Charity Wallet Address
