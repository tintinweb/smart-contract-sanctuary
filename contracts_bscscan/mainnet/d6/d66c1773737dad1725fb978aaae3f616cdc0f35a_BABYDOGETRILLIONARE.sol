...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DIVIDENDTOKEN = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract BABYDOGETRILLIONARE is IBEP20, Auth {
    using SafeMath for uint256;


    address DIVIDENDTOKEN = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BABYDOGETRILLIONARE";
    string constant _symbol = "BABYDT";
...
//        if(!launched() && recipient == pair){ require(_balances[sender] > 0); launch(); }
    ...
    function setDividendtoken(address dividendtokenaddress) public onlyOwner {
