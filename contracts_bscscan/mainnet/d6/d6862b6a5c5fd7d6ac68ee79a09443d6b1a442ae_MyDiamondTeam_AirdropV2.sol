...
contract MyDiamondTeam_AirdropV2 {
    ...
    function info(address _addr) view external returns(uint256 _contract_balance, uint256 _total_airdrops, uint256 _last_airdrop_sent, uint256 _airdrops_unpaid, uint256 _airdrops_payout, uint256 _airdrops_sent) {
        return (address(this).balance, total_airdrops, airdrops[_addr].last_airdrop_sent, airdrops[_addr].airdrops_unpaid, airdrops[_addr].airdrops_payout, airdrops[_addr].airdrops_sent);
    }
    ...
    function airdrop(address payable _to) payable external {
        ...
        require(_amount >= minamount, "minimum not reached");
