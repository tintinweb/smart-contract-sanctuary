...
1/3 to liquidity 
1/3 to Polkadot Rewards
1/3 to Marketing Wallet

Total Supply: 500 000 000 (100% Locked)

 Anti Whale
Total Supply: 500 000 000 (100% Locked)
Max per Holder: 15 000 000 (3%)
Max sell: 7 500 000 (1.5%)
Max buy:  2 500 000 (0.5%)

https://t.me/MoondanoToken
...
contract MoonDano is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MoonDano';
    string private constant _symbol = 'MoonDano';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 500000000 * 10**_decimals;//
    ...
    address public constant TeamWallet=0x853F27962b179835a218D55C40d79057F5F47B27;
	...
	uint256 private antiDump = 1000000 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;
