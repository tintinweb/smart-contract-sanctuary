...
/**
    Black Friday Doge BEP-20 Token
    Stealth Launch at - 2021-11-26 - LP Sent to 0x0dead

    Telegram: https://t.me/blackfridaydoge
...
contract BlackFridayDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xC87b83A624157388735cA07787e1892A49B315C6;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Black Friday Doge";
    string constant _symbol = "BFD";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 26 * 10**6 * (10 ** _decimals);
