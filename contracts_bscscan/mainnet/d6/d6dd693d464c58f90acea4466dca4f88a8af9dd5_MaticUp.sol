...
//MaticUp contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract MaticUp is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MaticUP';
    string private constant _symbol = 'MATICUP';
    ...
    uint16 public constant MaxSellLockTime= 0.1 hours;
    //TODO: Change to 7 days
    //The time Liquidity gets locked at start and prolonged once it gets released
    uint256 private constant DefaultLiquidityLockTime=24 hours;
    //The Team Wallet is a Multisig wallet that reqires 3 signatures for each action
    address public constant TeamWallet=0x825ca076420902E7cA586A5AeA5411d54bcbF848;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimMATIC(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawMATIC(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimMATIC(address addr) private{
        ...
        path[1] = 0xCC42724C6683B7E57334c4E856f4c9965ED682bD;  //Binance-Peg MATIC Token
        ...
        emit OnWithdrawMATIC(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function TeamRemoveRemainingBNB() public onlyTeam{
        require(block.timestamp >= _liquidityUnlockTime+0.02 days, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
