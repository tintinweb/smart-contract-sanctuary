...
🏅【Tokenomic】🏅
Buy Tax 14%
 ~ Redistribution to Marketing Wallet 
(to keep carrying out Marketing/Advertisement one after another so that your DailyBNB coin keeps rising)

Sell Tax 29%
 ~ 15.00% BNB reward straight into your wallet AUTOMATICALLY
 ~ 13.75% Marketing Wallet 
 ~ 0.25% Dev Wallet

Total Token Supply: 1 Quadrillion

Contract: Will be released only during Fairlaunch. Do NOT fall into fake contract. IGNORE all DM & private message.

Web: https://dailybnb.finance
TG : https://t.me/dailybnbbsc
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function Claim_BNB() public virtual onlyOwner {
...
contract  DAILYBNB  is ERC20 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC20(" DAILYBNB ", " DAILYBNB") {
