...
contract SLIC is Context, IST20, Ownable {
    ...
    string private _name = "SilverLinkChain";
    string private _symbol = "SLIC";
    ...
    constructor (address payable mktWalletAddress) public {
