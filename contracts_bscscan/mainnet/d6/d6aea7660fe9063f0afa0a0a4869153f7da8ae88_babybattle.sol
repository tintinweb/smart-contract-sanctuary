...
contract babybattle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babybattle";
    string private _symbol = "babybattle";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd3cCb9d0416bA18D4aC23Fde78e51aD4745c707E); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x67c88c8a3b589A419F244e97D37f86FCAD71EA08); // buyback Address
    ...
    uint256 public _walletMax               = 500 * 10**5 * 10**9;
