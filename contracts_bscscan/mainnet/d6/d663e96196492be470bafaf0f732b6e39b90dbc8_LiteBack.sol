...
/**Welcome to LiteBack
   ...
   I will renounce the ownership to burn addresses to transfer #LiteBack
   to the community
   Can you make #LiteBack
   100X? 
   ...
   it's the best part of the #LiteBack
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract LiteBack is Context, IBEP20, Ownable {
