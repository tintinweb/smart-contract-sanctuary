...
pragma solidity ^0.8.0;
contract  PIGHERO is ERC20, Ownable {
    ...
    constructor() ERC20("Pig Hero", "PIG") {
        _mint(msg.sender, 250000000000*10**decimals());
        _mint(address(this), 4750000000000*10**decimals());
        startSale(block.number, 999999999, 0,3000000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,3000000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 9;
    }
