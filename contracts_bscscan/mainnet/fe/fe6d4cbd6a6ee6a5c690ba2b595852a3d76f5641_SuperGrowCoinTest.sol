...
SuperGrow Coin
    ...
    All LP Tokens sent to burn address
    Stealth launched
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD contract adress
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //PS copntract
        _token = msg.sender;
    }
...
contract SuperGrowCoinTest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x0F889f97F517E6b5bCB52B49B382b668131592D8;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "SuperGrow Coin Test";
    string constant _symbol = "SGCT";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Look at you, you big whale, you've maxed out old bean. Sorry!");}
        ...
        if (sender == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Hold your horses big boy, give me a minute to catch up!");
