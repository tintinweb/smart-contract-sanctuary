...
| $$      | $$| $$       \____  $$  | $$ /$$      | $$  \ $$ /$$__  $$| $$  | $$| $$_  $$ 
| $$      | $$| $$       /$$$$$$$/  |  $$$$/      | $$$$$$$/|  $$$$$$$| $$  | $$| $$ \  $$
|__/      |__/|__/      |_______/    \___/        |_______/  \_______/|__/  |__/|__/  \__/
...
contract FirstBank is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FirstBank";
    string constant _symbol = "FBANK";
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + buybackFee + burnFee + devFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xCf8079e922e3F26015D6FbA30C101F8bA08b5412;
        marketingFeeReceiver =0xCf8079e922e3F26015D6FbA30C101F8bA08b5412 ;
        buybackFeeReceiver = 0xCf8079e922e3F26015D6FbA30C101F8bA08b5412;
        devFeeReceiver = 0xCf8079e922e3F26015D6FbA30C101F8bA08b5412;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != buybackFeeReceiver  && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver){
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _burnFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        ...
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _buybackFee + _burnFee + _devFee;
