...
Oracle ($ORA) Official Contract by Althors.finance

The first token - Oracle - is the start of this unique ecosystem. It will allow you to receive $LINK and $BAND as dividend.
...
contract ORA is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x06d816F5357d22966CE0456e42FF695E8DFfaC8c); // Marketing Address
    ...
    uint256 private _buylpPajek = 15;
    
    uint256 private _botNeedsPrevention = 25;
    uint256 private _whaleNeedsPrevention = 40;
