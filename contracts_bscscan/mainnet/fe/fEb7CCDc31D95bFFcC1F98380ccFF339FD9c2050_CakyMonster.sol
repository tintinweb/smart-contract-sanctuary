 ...
 * 
 * https://t.me/CakyMonster |  HOLD ON TO CAKYMONSTER TO GET DELICIOUS CAKE REWARDS!
 * 
 * TOKENOMICS:
 * 
 * 8% CAKE reflection TO FEED YOU SOME CAKE
 * 4% to liquidity to keep the token price growing with every txn!
 * 4% to marketing so we can help to make it go BOOM!
 * 
 * 
 * 
 * 
...
contract CakyMonster is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CakyMonster";
