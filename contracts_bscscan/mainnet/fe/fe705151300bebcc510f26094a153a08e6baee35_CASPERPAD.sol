...
contract CASPERPAD is IBEP20, Ownable {
    ...
    string private constant _symbol = "CSPR";
    uint8 private constant _decimals = 9;    
    uint256 private constant _tTotalSupply = 5000000000000000 * 10 ** 9; 
	uint256 private constant _buyMaxTxAmount = 5000000000000000 * 10 ** 9; 
    uint256 private constant _sellMaxTxAmount = 5000000000000000 * 10 ** 9;
    ...
    uint256 private _sellLiquidityFee = 95;
    uint256 private  _sellMarketingFee = 1;

    uint256 private constant numTokensSellToAddToLiquidity = 2500000000000 * 10 ** 9; 
    ...
    constructor() {
        ...
        initialTransfer(_msgSender(), address(this) , 500000000000000 * 10**9);
