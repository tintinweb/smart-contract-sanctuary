...
contract BABYARMYDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("Baby_army_Dividend_tracker", "Baby_army_Dividend_tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 100000000 * (10**9); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override pure {
        require(false, "Baby_army_Dividend_tracker: No transfers allowed");
    }

    function withdrawDividend() public override  pure {
        require(false, "Baby_army_Dividend_tracker: withdrawDividend disabled. Use the 'claim' function on the main Barmy contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86400, "Baby_army_Dividend_tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Baby_army_Dividend_tracker: Cannot update claimWait to same value");
...
contract BabyArmy is ERC20, Ownable {
    
    using SafeMath for uint256;

    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;
    BABYARMYDividendTracker public dividendTracker;

    address public _marketingWallet = 0xd8C25730c42Af431732E3370548A42FEdBD057e5;
    address public _charityWallet = 0x94f057c9fd54eb1AB852239BF11677b012F09131;

    bool public restrictWhales = true;

    uint256 public maxTxAmount = 5000000000000 * (10**9);
    uint256 public walletMax = 10000000000000 * (10**9);
    ...
    constructor() ERC20("Baby Army", "BARMY") {

    	dividendTracker = new BABYARMYDividendTracker();
    ...
    function updateFees(uint256 newRewardFee, uint256 newLiqFee, uint256 newMarketingFee, uint256 newCharityFee) public onlyOwner {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Barmy: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Barmy: Account is already the value of 'excluded'");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Barmy: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Barmy: Cannot update gasForProcessing to same value");
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        walletMax = 1000000000000000 * (10**9);
    }
    ...
    function prepareForLaunch() external onlyOwner {
        ...
        maxTxAmount = 5000000000000 * (10**9);
        walletMax = 10000000000000 * (10**9);
    }
