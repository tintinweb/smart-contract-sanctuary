...
/**
ATTENTION: I AM A PROGRAMMER FROM MEXICO WHO HAS NO EXPERIENCE IN PROMOTING A CRYPTOCURRENCY SO I AM LOOKING FOR A PARTNER.

THIS CONTRACT IS TOTALLY SECURE AND I AM WILLING TO GIVE 100% OF THE CHARITY WALLET TO THE ONE WHO TAKES CARE OF THE MARKETING.

IT IS A GOOD AND UNIQUE OPPORTUNITY. 

AFTER THE DEAL I WILL ADD 0.2 LIQUIDITY AND BLOCK THE LP.

I WILL RENNOUNCE THE CONTRACT AND IT WILL BE 100% SAFE FOR THE INVESTOR AND FOR US.

ONLY ONE RULE: NEVER SCAM

IF U ARE INTERESTED ENTERTO THE GROUP AND SHOW ME WHAT U CAN DO

https://t.me/myfavouritebusd
...
contract MyFavouriteBusd is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;

    string constant _name = "MyFavouriteBusd";
    string constant _symbol = "MFBUSD";
