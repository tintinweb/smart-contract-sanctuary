...
library BabyMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "BabyMath: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "BabyMath: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "BabyMath: multiplication overflow");

        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "BabyMath: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "BabyMath: modulo by zero");
    }
...
contract BabySantaJesus is Context, IERC20, Ownable {
    using BabyMath for uint256;
    ...
    string private _name = "BabySantaJesus";
    string private _symbol = "BSJ";
    ...
    address payable public burnWallet =
        payable(0xDD2A87eC0a4FEE91b969897FeDC436A74f974eFE);
