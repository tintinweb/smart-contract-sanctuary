...
// CHANGE
contract WitchADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "WitchADA";
    string constant _symbol = "$WITCHADA";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x8B74A9de6d330Ba36B0f500306AFa691c8015e54);
