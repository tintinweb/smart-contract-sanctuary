...
// CHANGE
contract BabyByakko  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyByakko";
    string constant _symbol = "BBBK";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x9d236913ED58FEa229E54eFAE25563a4cFd0020a); // Change
