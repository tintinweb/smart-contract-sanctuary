...
contract USxD_Staking is AccessControl {
    ...
    uint256[2] public NETWORK_APY1 = [30, 30]; // 0.03%
    uint256[4] public NETWORK_APY2 = [30, 30, 30, 30];
    uint256[8] public NETWORK_APY3 = [30, 30, 30, 30, 30, 30, 30, 30];

    uint256[] public NETWORK_FEES = [300*10**26, 1200*10**26, 3500*10**26]; // 300 || 1200 || 3500 BUSD
    ...
    constructor(){
        ...
        // Oracle for getting BNB live price
        priceFeed = AggregatorV3Interface(0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE);
        // USxD token Address
        token = IERC20(0x29c86a2Fb163C096f5592D40D3c6Dd137C9Cff60);
        // BUSD token Address
    ...
    function register(address refAddress) external returns(bool){
        ...
        if(refAddress != address(this)){
            require(stakeDetails[refAddress].ref != address(0), "Error: Invalid Ref Address");
        }
    ...
    function transfer() external returns(bool){
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "USxD: must be Admin");
