...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    //SETMEUP, approx time 20 to 30 mins
...
contract MiniSnooker is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniSnooker";
    string constant _symbol = "SNOOK";
    ...
    constructor () Auth(msg.sender) {
        ...
        // Tax addresses
        autoLiquidityReceiver = 0xFa1c293D612276Fafd6164B743D5616c427b5308;
        marketingFeeReceiver = 0xDB49Eb551Fc2bBa4997eF0C1593a2C47726Cb758;
    ...
    // switch Trading
    function playBall(bool _status) public onlyOwner {
        tradingOpen = _status;
    }
