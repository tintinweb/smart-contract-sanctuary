...
/*
    #GothGF3
    Created: 12/26/21
    Website: GothGFbsc.com
    TG: https://t.me/GothGFbsc
    Total Fees: 10%
    2% fee is added to the Black Cat developer wallet as BNB *Note the team will not be selling tokens*
    4% fee is added to the Black Cat marketing wallet as BNB *Note the team will not be selling tokens*
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    contract GothGF3 is Context, IERC20, Ownable {
    ...
    address payable  _developerAddress = 0x8d779184e0497c3d1E3a6e872C4c62aC169c139D;
    address payable  _marketingAddress = 0xe50C7110bE07f310AA4E942fB5486CD3AEd612c5;
    ...
    string private _name = "GothGF 3";
    string private _symbol = "GGF3";
    ...
    uint256 public numTokensSellToAddToLiquidity = 2500000000* 10**9;
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0xe50C7110bE07f310AA4E942fB5486CD3AEd612c5;
        _developerAddress = 0x8d779184e0497c3d1E3a6e872C4c62aC169c139D;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Black Cat: cannot burn from zero address");
    require(_balances[account] >= amount, "Black Cat: Cannot burn more than the account owns");
