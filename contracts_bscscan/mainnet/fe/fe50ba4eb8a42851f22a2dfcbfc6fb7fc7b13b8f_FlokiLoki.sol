...
-SHILL
-CMS AND OTHER SUBREDDIT POSTS
-RAID ACTIVITY
-TWITTER INFLUNCER (cryptomessiah)
-POOCOIN ADS

JOIN COMMUNITY NOW!!!
https://t.me/FlokiLokiToken
...
contract FlokiLoki is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Loki";
    string private _symbol = "FLOKILOKI";
