...
contract AlphaMatrix is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alpha Matrix";
    string private _symbol = "AMB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x45aD33A415386b0d52D1394585C9177CC619024c); // Marketing Address
    address payable public developmentWalletAddress = payable(0xE5CbfaA619cd6547Cf2e24EeD32c4348E8134189); // development address
    ...
    constructor () {
        ...
        _totalTaxIfSelling = _totalTaxIfBuying.add(_developmentFee);
