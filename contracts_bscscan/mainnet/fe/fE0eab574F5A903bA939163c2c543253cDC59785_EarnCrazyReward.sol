...
/**
 ...
 Earn Crazy Reward - Earn crazy amount of rewards in random tokens, 20-50% random reward
...
contract EarnCrazyReward is ERC20, Ownable {
    // CONFIG START
    
    // TOKEN
    string tokenName = "EarnCrazyReward";
    string tokenSymbol = "ECR";
    uint256 tokenTotalSupply = 100_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0xbfe9015fbA3136E9a1E8429c54DA946B8E734820;
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded[account], "CRT: Account already excluded");

        isExcluded[account] = true;
    }

    function unExclude(address account) public onlyOwner {
        require(isExcluded[account], "CRT: Account is not excluded");
