...
Telegram : https://t.me/DaughterOfYeti
...
contract DaughterOfYeti is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public shitmeh = payable(0xFDd1DA6C5b0f47Ae454dAb57f5049cA708f44b00); 
    ...
    string private _name = "DaughterOfYeti";
    string private _symbol = "DOY";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(shitmeh, transferredBalance.mul(marketingDivisor).div(100));
    ...
    function setshitmeh(address _shitmeh) external onlyOwner {
        shitmeh = payable(_shitmeh);
    }
