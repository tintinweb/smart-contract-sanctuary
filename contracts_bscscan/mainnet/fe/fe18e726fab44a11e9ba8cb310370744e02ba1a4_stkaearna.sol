...
contract stkaearna is Ownable {
    ...
    address public constant trustedDepositTokenAddress = 0x9a45A37CB1115f92B9fC9a6b5808a2eC4B7ee4d8;
    // trusted reward token contract address
    address public constant trustedRewardTokenAddress = 0x9a45A37CB1115f92B9fC9a6b5808a2eC4B7ee4d8;
    // reward rate
    uint public rewardRatePercentX100 = 100e2;
    uint public constant rewardInterval = 300 days;
    uint public cliffTime = 2 hours;
    ...
    function getTokenPerSnblPancake() public view returns (uint) {
