...
/**
    ...
    The decreasing 4% every transaction, the strong holder will get a valuable reward
...
contract FAIRBABY is Context, IERC20, Ownable {
    ...
    string private constant _name = 'FAIRBABY';
    string private constant _symbol = 'FAIRBABY';
