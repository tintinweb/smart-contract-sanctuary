...
/*
    ...
    NEBULAX token contract
    
    https://t.me/cryptonebulax
    https://wwww.cryptonebulax.com
    https://twitter.com/cryptonebulax
...
contract NEBULAX is ERC20, Ownable {
    ...
    TDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("NEBULAX", "NBLX") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        TDividendTracker newDividendTracker = TDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the NEBULAX token contract");
...
contract TDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("NEBULAX_Dividend_Tracker", "NBLX_Dividend_Tracker") {
    	claimWait = 1800;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "NEBULAX_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "NEBULAX_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NEBULAX contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "NEBULAX_Dividend_Tracker: claimWait must be updated to between 0.5 and 24 hours");
        require(newClaimWait != claimWait, "NEBULAX_Dividend_Tracker: Cannot update claimWait to same value");
