...
/**
   Welcome Big Mom Shiba
   
   This is a community token. If you want to create a telegram I suggest to name it to @BigMomShiba
   ...
   I will renounce the ownership to burn addresses to transfer #BigMomShiba to the community, make sure it's 100% safe.
...
contract BigMomShiba is Context, IERC20, Ownable {
    ...
    string private _name = "BigMomShiba";
    string private _symbol = "BIGMSHIBA";
