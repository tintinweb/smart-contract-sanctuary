...
/*
	Website: https://meta-renew.com/
	Telegram: https://t.me/MetaRenewOfficial 
	Donate: 0x906A93ff6894d84f685B4F54369f09e44F6af4E6
	Discord: https://discord.gg/ep29yETXFC
	Contract Audited By: 
	Contract Version: 2.02
	Contract Supply: 21 Trillion
	Contract Tokenomics:
	2% BUSD
	3% Charity.
	4% Marketing
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public RWDSelectionMainNet = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //MainNet Cake 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82 Address // SHIB Peg 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D
    ...
    IBEP20 RWRD = IBEP20(RWDSelectionMainNet); //MetaRenew Mainnet Address
    ...
    function updateWbnbandBUSDAddress(address rWbnb, address rBusd) external {
        WBNB = rWbnb;
        RWRD = IBEP20(rBusd);
		RWDSelectionMainNet = rBusd; //Added to Update Rewards from current.
...
contract Metarenew is IBEP20, Auth {
    using SafeMath for uint256;
    address public BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD Address
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
	address PancakerouterDev = 0xfA75752F37a514d964338a147de17b7D0297c9F5; //PancakeRouterDev
	address PancakerouterProd = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //PancakerouterProd
	address PancakeRouterDev2 = 0x59B0A8aba73030999871F73F1fB1cb6FD1cDe1b6; //PancakeRouterDev2
   
    string constant _name = "MetaRenew";
    string constant _symbol = "METR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 21000 * 10**9 * (10**_decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x67Bc1e49654F4Bbd682F28B17c288cec3f13F676;
        marketingFeeReceiver = 0x906A93ff6894d84f685B4F54369f09e44F6af4E6;
        charityFeeReceiver = 0x59B0A8aba73030999871F73F1fB1cb6FD1cDe1b6;
        teamFeeReceiver = 0xbFe2A4d66179a6EbC6E5341c61887CF24eFB1ADE;
    ...
    function isOverLiquified(uint256 target, uint256 accuracy) public view returns (bool) {
	    ...
	    // Withdraw ETH that's potentially stuck in the MetaRenew Contract
    function recoverETHfromTresLechesCC() public virtual onlyOwner {
        payable(charityFeeReceiver).transfer(address(this).balance);
    }

    // Withdraw ERC20 tokens that are potentially stuck in the MetaRenew Contract
