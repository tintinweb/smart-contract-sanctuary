...
WELCOME to RECTORDOGE (REDO)
telegram official:https//t.me/rectordogeee
...
contract RectorDoge is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "RectorDoge";
    string private _symbol = "REDO";
