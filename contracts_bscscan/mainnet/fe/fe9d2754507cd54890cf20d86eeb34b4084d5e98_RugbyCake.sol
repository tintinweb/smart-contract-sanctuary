...
RugbyCakeBSC 
Final Reflection Coin
CAKE - 10% of Every Transaction goes to the HODLers
 4% Liquidity | 2% Marketing
 2% Max Txn | 4% Max Wallet
 
 TG: https://t.me/rugbycakebsc
 Twitter : twitter.com/rugbycakebsc
...
contract RugbyCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RugbyCake";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(antiBot,"AntiBot not active yet");
        }
