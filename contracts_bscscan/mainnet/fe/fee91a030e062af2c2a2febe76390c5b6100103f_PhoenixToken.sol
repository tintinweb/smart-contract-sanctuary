...
contract PhoenixToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TEST"; // PhoenixToken
    string constant _symbol = "TEST"; // PHX
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = 5 * 10**6 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = address(0x09c77325FBF3cE4F676d1FE9f916b8C02122fcDE);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(!isBlacklisted[sender], "Address blacklisted");
    ...
    function setIsBlacklisted(address holder, bool exempt) external authorized {
