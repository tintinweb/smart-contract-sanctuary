...
contract MiniSoccer is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8e22bB9867C52D4E4C6351653b97aE8361617C00); // Marketing Address
    ...
    string private _name = "MiniSoccer";
    string private _symbol = "MiniSoccer";
