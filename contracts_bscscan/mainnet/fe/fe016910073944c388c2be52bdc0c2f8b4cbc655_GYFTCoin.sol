...
/**
    # GYFT Coin (GYFT)
        ...
        10% Fee Auto moved to Charity wallet
*/
...
contract GYFTCoin is Context, IBEP20, Ownable {
    ...
    address public _CharityWalletAddress = 0x46c53cC038B2BDad647e4aFd5Ef7E9931826a789;
    ...
    string private _name = "GYFT Coin";
    string private _symbol = "GYFT";
    ...
    uint256 public _maxTxAmount = 50000 * 10**8;
