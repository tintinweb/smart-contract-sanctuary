...
/**
 *                NEXT 1000X GEM!
 * Dividend Token that reward $AXS every 60 minutes!
 *          https://t.me/INFINITYAXS
*/
...
contract InfinityAXS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "InfinityAXS";
    string constant _symbol = "IAXS";
