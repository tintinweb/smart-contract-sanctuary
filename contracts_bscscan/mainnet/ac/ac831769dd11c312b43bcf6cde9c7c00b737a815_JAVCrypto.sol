...
contract JAVCrypto is Context, IERC20, Ownable {
    ...
    string private _name = "JAV Crypto";
    string private _symbol = "JAV";
    uint8 private _decimals = 18;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWallet = payable(0x0B1fc56e631C9aE6C668FF9677d6C9A178f9e0Fa);
    ...
    uint256 public minimumTokensBeforeSwap = 5000000 * 10**18;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensToAddLiquidityWith = contractTokenBalance.div(_saleLiquidityFee.add(_saleMarketingFee).mul(2)).mul(_saleLiquidityFee);
        ...
        uint256 bnbToAddLiquidityWith = deltaBalance.mul(_saleLiquidityFee).div(_saleLiquidityFee.add(_saleMarketingFee).mul(2)).sub(_saleLiquidityFee);
        
        // add liquidity to uniswap
        addLiquidity(tokensToAddLiquidityWith, bnbToAddLiquidityWith);
        // worthy marketing fee
        uint256 marketingAmount = deltaBalance.sub(bnbToAddLiquidityWith).div(_saleLiquidityFee.add(_saleMarketingFee)).sub(_saleLiquidityFee).mul(_saleMarketingFee);
    ...
    function setBuyFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) 
    external onlyOwner() {
