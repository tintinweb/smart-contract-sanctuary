...
contract NFTGameMonter is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 386386386; //963 million
    ...
    string private _name = "NFT Game Monter";
    string private _symbol = "NFTGM";
