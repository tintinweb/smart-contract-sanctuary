...
contract DEXTER is Context, IERC20, Ownable{
    ...
    uint256 public _BuymarketingFee = 200; // % of transactions will be kept for marketing wallet
    uint256 public _SelltaxFee = 0; // % of transactions will be redistributed among holders
    ...
    uint256 public _SellmarketingFee = 200; // % of transactions will be kept for marketing wallet
    ...
    address public marketingWallet = 0x99E7d604beca6CfA97eEE8d2A2A382feE1AF2cF0;
    ...
    uint256 public                   _maxTxAmount = 5000000000000000 * 10**8;
    ...
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out DEXTER!");
