...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC693b981ad85A163c14A191eCA2AAd78b5C7a84d;
...
contract whitecheemsinu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5234b9B0F1dFE594593FF5A08B80c0915130E7C9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "White Cheems Inu";
    string private _symbol = "WhiteCheems";
