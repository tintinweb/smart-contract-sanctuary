...
// File: contracts/StrategyBananaUpgraderable.sol
...
contract StrategyBananaUpgraderable is ReentrancyGuardUpgradeSafe, OwnableUpgradeable , Pausable {
    // Maximises yields in pancakeswap

    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    bool public isBANANAStaking; // only for staking BANANA using Apeswap's native BANANA staking contract.
    ...
    address public cakeRouterAddress;
    ...
    function initialize(
        ...
        isBANANAStaking = _isBANANAStaking;
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        IPancakeRouter02(cakeRouterAddress)
            .swapExactTokensForTokensSupportingFeeOnTransferTokens(
            wbnbAmt,
            0,
            wbnbToGrandPath,
    ...
    function convertDustToEarned() public whenNotPaused {
        require(isGrandComp, "!isGrandComp");
        require(!isBANANAStaking, "isBANANAStaking");
