...
interface BBEP47Metadata is BBEP47 {
...
contract Jaxmon is Context, BBEP47, BBEP47Metadata {
    ...
    function transferFrom(address sender, address recipient, uint amount) public virtual override returns (bool) {
        ...
        require(currentAllowance >= amount, "BBEP47: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "BBEP47: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(address sender, address recipient, uint amount) internal virtual {
        require(sender != address(0), "BBEP47: transfer from the zero address");
        require(recipient != address(0), "BBEP47: transfer to the zero address");

        _beforeTokenTransfer(sender, recipient, amount);

        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "BBEP47: transfer amount exceeds balance");
        unchecked {
