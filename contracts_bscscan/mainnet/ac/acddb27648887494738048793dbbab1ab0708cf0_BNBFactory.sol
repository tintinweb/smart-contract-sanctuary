...
/**
  ...
  ~ 200 bnb max deposits per wallet.
...
contract BNBFactory {
    ...
    uint256 public PARTNER = 30;
    uint256 public PROJECT = 40;
    uint256 public LOTTERY = 100;
    uint256 public PROJECT_SELL = 5;
    ...
    uint256 public WALLET_DEPOSIT_LIMIT = 200 ether; /** 200 BNB  **/
