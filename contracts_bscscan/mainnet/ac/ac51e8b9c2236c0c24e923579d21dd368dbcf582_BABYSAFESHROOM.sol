...
/**
                                            ...
                                            Telegram : https://t.me/babysafeshroom
                                            max tx and max wallet is 200
                                            EARN BUSD FOR HOLDING
...
contract BABYSAFESHROOM is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "BABYSAFESHROOM";
    ...
    uint256 public _maxSellTransactionAmount = 100 * 10**9; // can't sell more than this
    uint256 public _maxWalletToken = 200 * 10**9; // can't buy or accumulate more than this
