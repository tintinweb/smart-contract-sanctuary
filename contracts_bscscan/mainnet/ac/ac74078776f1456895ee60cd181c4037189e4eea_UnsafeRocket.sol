...
contract UnsafeRocket is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdDc0476D1e6B5b15786D23Ed595C770557Ec5574); // Marketing Address
    ...
    string private _name = "UnsafeRocket";
    string private _symbol = "URK";
