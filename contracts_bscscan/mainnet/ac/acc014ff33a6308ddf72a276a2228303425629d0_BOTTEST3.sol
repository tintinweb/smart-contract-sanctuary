...
contract BOTTEST3 is Context, IBEP20, Ownable {
    ...
    uint256 public _previousTaxFee = 5;
    uint256 public _previousLiquidityFee = 15;
    ...
    string private _name = 'BOTTEST3';
    string private _symbol = 'BTT3';
