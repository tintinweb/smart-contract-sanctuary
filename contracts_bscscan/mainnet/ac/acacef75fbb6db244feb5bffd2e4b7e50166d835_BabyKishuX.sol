...
contract BabyKishuX is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby KishuX";
    string private constant _symbol = "BkishuX";
    ...
    function setBuyTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _buyTaxFee = taxFee;
        require(_buyTaxFee + _buyDevFee + _buyLiquidityFee + _buyMarketFee <= 80, "Total fees exceed 8%");
    }
    ...
    function setSellTaxFeePercent(uint256 taxFee) external onlyOwner() {
        _sellTaxFee = taxFee;
        require(_sellTaxFee + _sellDevFee + _sellLiquidityFee + _sellMarketFee <= 80, "Total fees exceed 8%");
    }
