...
| |     / _` || |/ / / _ \| |\/| | / _ \  / _ \ | '_ \ 
| \__/\| (_| ||   < |  __/| |  | || (_) || (_) || | | |
 \____/ \__,_||_|\_\ \___|\_|  |_/ \___/  \___/ |_| |_|
                                                       
                                                       
    🎉 https://cakemooncoin.com/

CakeMoon is a Deflationary token that rewards it's holders with $CAKE,
while the price goes high you earn cake Go to the Moon eating $CAKE 🚀🚀 
FEATURES 🎂 Rewards Cake 🎂 👨‍👩‍👧‍👦 Community Driven 🚀 Advanced
Marketing Strategy 🌎 International Community 🔮 Safe Contract!!
...
contract CakeMoon is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address DogeReward = 0x8c05c728Ca714D30BBFF30Af4fD98e062e651336;
    ...
    constructor() {
        ...
        _isExcludedFromFee[DogeReward] = true;
        _isExcludedFromReward[DogeReward] = true;
    ...
    function totalDogereward() public view returns (uint256) {
        return balanceOf(DogeReward);
    }
    ...
    function _transferBurn(uint256 tBurn) private {
        uint256 currentRate = _getRate();
        uint256 rBurn = tBurn.mul(currentRate);
        _rOwned[DogeReward] = _rOwned[DogeReward].add(rBurn);
        if (_isExcludedFromReward[DogeReward]) _tOwned[DogeReward] = _tOwned[DogeReward].add(tBurn);
    }
    ...
    function _transferFromExcluded(
        ...
        emit TransferBurn(sender, DogeReward, tBurn);
