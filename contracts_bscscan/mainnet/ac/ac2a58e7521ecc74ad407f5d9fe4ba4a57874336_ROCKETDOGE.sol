...
contract ROCKETDOGE is ERC20, Ownable {
    ...
    uint256 public totalFees = BNBRewardsFee.add(marketingFee).add(buybackFee);
    uint256 public multiplier = 1;
    bool public swapOpen;
    uint256 public launchedAt;
    uint256 public supriseBlockCount;
    address public _marketingWalletAddress =
        0x3c2656250f44245d288b8f6a5a639Da30a0A260A;
    ...
    event Buyback(uint256 tokensBuyback);
    ...
    constructor() public ERC20("Rocket Doge", "ROCKETDOGE") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ROCKETDOGEDividendTracker newDividendTracker = ROCKETDOGEDividendTracker(
                payable(newAddress)
            );
    ...
    function setBNBRewardsFee(uint256 value) external onlyOwner {
        BNBRewardsFee = value;
        totalFees = BNBRewardsFee.add(marketingFee).add(buybackFee);
    }
    ...
    function buyback(uint256 tokens) private {
...
contract ROCKETDOGEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        public
        DividendPayingToken(
            "ROCKETDOGE_Dividen_Tracker",
            "ROCKETDOGE_Dividend_Tracker"
        )
    {
        claimWait = 3600;
