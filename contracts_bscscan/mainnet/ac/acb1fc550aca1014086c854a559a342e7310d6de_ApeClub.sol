...
contract ApeClub is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApeClub";
    ...
    constructor () {
        ...
        teamWallet = payable(0xD422cE33E51099aA88f8A701255711B9Bacd1f16);
    ...
    function transferTokensSupportingFees(address sender, address recipient, uint256 tAmount) private {
        uint256 _reflexFee = getFees(sender, recipient);
    ...
    function getFees(address from, address to) private view returns(uint256) {
