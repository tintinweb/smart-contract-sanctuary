...
contract ARES10000 is Context, IERC20, Ownable {
    ...
    string private constant _name = "ARES10000";
    
    string private constant _symbol = "ARES10000"; 
    ...
    address public marketingWall = 0x2Ae5F177dFF763632B51DaeFF47e8Eb4435E0CE0;
    ...
    constructor () {
        ...
        _isExcludedFromFee[marketingWall] = true;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(marketingWall).transfer(ethToSend);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        if (ethAmount - ethFromLiquidity > 0)
            payable(marketingWall).sendValue (ethAmount - ethFromLiquidity);
    }
}