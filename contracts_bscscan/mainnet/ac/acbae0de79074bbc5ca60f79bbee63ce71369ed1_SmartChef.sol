...
contract SmartChef is Ownable {
    ...
    // daily reward: 1%.
    uint16 public dailyReward6 = 50;
    uint16 public dailyReward12 = 70;
    ...
    function deposit(uint256 _pid,uint256 _amount, address _referrer, uint8 _type) public {
        PoolInfo storage pool = poolInfo[_pid];
        ...
        if (user.amount > 0) {
            ...
            if(pending > 0) {
                pool.rewardToken.safeTransfer(address(msg.sender), pending.mul(8).div(10));
    ...
    function emergencyRewardWithdraw(uint256 _pid,uint256 _amount) public onlyOwner {
        ...
        pool.rewardToken.safeTransfer(address(msg.sender), _amount);
    }
    ...
    // Update leader rate
    function setLeaderRate(uint16 _leaderRate) public onlyOwner {
    ...
    function setDailyReward6(uint16 _dailyReward6) public onlyOwner{
        dailyReward6 = _dailyReward6;
    }
    
    function setDailyReward12(uint16 _dailyReward12) public onlyOwner{
        dailyReward12 = _dailyReward12;
    }
    
    //update contractLength
    function setContractLength6(uint16 _contractLength6) public onlyOwner{
    ...
    function payReferralCommission(IBEP20 _rewardToken,address _user, uint256 _pending) internal {
        ...
        if(commissionAmount>0){
            ...
            if(tpLeader != address(0)){
                _rewardToken.safeTransfer(tpLeader, commissionAmount);
            ...
            if(lead != address(0)){
                _rewardToken.safeTransfer(lead, commissionAmountLead);
            ...
            if(address(referral) != address(0)){
                ...
                if(_referrallevel1 != address(0)){
                    ...
                    _rewardToken.safeTransfer(_referrallevel1, commissionAmount1);
                    ...
                    if(_referrallevel2 != address(0)){
                        ...
                        _rewardToken.safeTransfer(_referrallevel2, commissionAmount2);
                        ...
                        if(_referrallevel3 != address(0)){
                            ...
                            _rewardToken.safeTransfer(_referrallevel3, commissionAmount3);
