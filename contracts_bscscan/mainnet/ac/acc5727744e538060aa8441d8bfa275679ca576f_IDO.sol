...
contract IDO {
    ...
    uint256 public endDate = 1638378000;               
    
    uint256 public totalTokensToSell = 30000000 * 10**18;          
    uint256 public tokenPerBnb = 1000000 * 10**18;              
    uint256 public minPerTransaction = 10000 * 10**18;                  
    uint256 public maxPerUser = 5000000 * 10**18;                
