...
contract Ownable is Context {
    address private _owner = 0xB3DF9ca19DE84237d31a25FA9eE1Cc2D1f5Df285;
...
contract BadMan is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x3D381E656cad72766a356A1AdA9106E9572401bD); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Bad Man"; // token name
    string private _symbol = "BM"; // token symbol
    ...
    uint256 public _liquidityFee = 40; // liquidity fee 3%
