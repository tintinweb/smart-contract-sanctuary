...
contract Ownable is Context {
    address private _owner = 0xd94EeBCFEf190205e47B72a5DDBeA9e9c54cc084;
...
contract FISTSYFIVIP is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xD99810abf25C1F3c59D056b24de685Ce9D531d46); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "FISTS YFIVIP"; // token name
    string private _symbol = "FISTS YFIVIP"; // token symbol
