...
contract ZillionShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ZillionShiba";
    //change the token symbol
    string constant _symbol = "ZSHIB";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x820B81FaACf01feB52fC2C11B40cF261e8ED2e88;
