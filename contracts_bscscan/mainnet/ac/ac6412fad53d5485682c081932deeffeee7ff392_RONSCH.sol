...
// change "name1" into ur name
    contract RONSCH is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "RONSCH";
    string private _symbol = "RNS";
    ...
    constructor() public {
        ...
        marketingWallet = 0x64009b9c4C22183cbAe5701E3e77d3E1e10f298d;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
