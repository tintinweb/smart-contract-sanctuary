...
*
*                                                           .         .                                                                                                                                      
* 8 888888888o.       8 8888          .8.                   ,8.       ,8.           ,o888888o.     b.             8 8 888888888o.      8 888888888o.          ,o888888o.         ,o888888o.    8 8888888888   
* 8 8888    `^888.    8 8888         .888.                 ,888.     ,888.       . 8888     `88.   888o.          8 8 8888    `^888.   8 8888    `^888.    . 8888     `88.      8888     `88.  8 8888         
* 8 8888        `88.  8 8888        :88888.               .`8888.   .`8888.     ,8 8888       `8b  Y88888o.       8 8 8888        `88. 8 8888        `88. ,8 8888       `8b  ,8 8888       `8. 8 8888         
* 8 8888         `88  8 8888       . `88888.             ,8.`8888. ,8.`8888.    88 8888        `8b .`Y888888o.    8 8 8888         `88 8 8888         `88 88 8888        `8b 88 8888           8 8888         
* 8 8888          88  8 8888      .8. `88888.           ,8'8.`8888,8^8.`8888.   88 8888         88 8o. `Y888888o. 8 8 8888          88 8 8888          88 88 8888         88 88 8888           8 888888888888 
* 8 8888          88  8 8888     .8`8. `88888.         ,8' `8.`8888' `8.`8888.  88 8888         88 8`Y8o. `Y88888o8 8 8888          88 8 8888          88 88 8888         88 88 8888           8 8888         
* 8 8888         ,88  8 8888    .8' `8. `88888.       ,8'   `8.`88'   `8.`8888. 88 8888        ,8P 8   `Y8o. `Y8888 8 8888         ,88 8 8888         ,88 88 8888        ,8P 88 8888   8888888 8 8888         
* 8 8888        ,88'  8 8888   .8'   `8. `88888.     ,8'     `8.`'     `8.`8888.`8 8888       ,8P  8      `Y8o. `Y8 8 8888        ,88' 8 8888        ,88' `8 8888       ,8P  `8 8888       .8' 8 8888         
* 8 8888    ,o88P'    8 8888  .888888888. `88888.   ,8'       `8        `8.`8888.` 8888     ,88'   8         `Y8o.` 8 8888    ,o88P'   8 8888    ,o88P'    ` 8888     ,88'      8888     ,88'  8 8888         
* 8 888888888P'       8 8888 .8'       `8. `88888. ,8'         `         `8.`8888.  `8888888P'     8            `Yo 8 888888888P'      8 888888888P'          `8888888P'         `8888888P'    8 888888888888 
*
*
* https://Ditest
* https://t.me/Ditest
...
contract AAAAAAAAAAA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AAAAAE";
    string constant _symbol = "AAAA";
	...
	function deadDIDOS() external view returns(uint256) {return IBEP20(address(this)).balanceOf(DEAD); }
    function BUSDDistributed() external view returns(uint256) {return distributor.totalDistributed(); }
    function cumulativeBUSDDividends() external view returns(uint256) {return distributor.totalDividends(); }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!isTxLimitExempt[sender] && recipient != pair && !isTxLimitExempt[recipient]){
                require(_holderLastTransferTimestamp[recipient].add(transferDelay) <= block.timestamp, "DIDO: Transfer Delay enabled.  Please try again in 30 seconds.");
            }
        }

       if(sellDelayEnabled){
            if (!isTxLimitExempt[sender] && recipient == pair && !isTxLimitExempt[recipient]){     
                require(_holderLastSellTimestamp[sender].add(SellDelay) <= block.timestamp, "DIDO: There must be at least 5 minutes gap between your last sell");
            }
        } 
    ...
    function PUPPYSLAP(uint256 amount) external authorized {
