...
contract DOTFarmer {
    ...
    address dot = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402; // 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402 DOT
    IBEP20 token;
    uint256 public constant INVEST_MIN_AMOUNT = 1 ether; // 1 DOT 
    uint256[] public REFERRAL_PERCENTS = [50, 5, 3, 1, 1];
    uint256 public constant PROJECT_FEE = 10; // 1% base * 
    ...
    constructor() public {
        ...
        ceoAddress2=0xa5327581b7388E82aC68F899A229cDDE4835F73B;             // AB
        ceoAddress3=0x94B9A05A3Ce2441c733555E8b046eCd62DF671BC;             // R
        ceoAddress4=0x015eCEDA1353bdF38C3870C001f59825BCF28b23;             // C
        commissionWallet = 0xc7999De09cc3C3bff8a9b40A46b18Ca9c7eE6446;      // Community wallet
        token = IBEP20(dot);
    ...
    function invest(
        ...
        require (block.number > 12267800);                // Mon Nov 01 2021 06:58:41 GMT+0200
        ...
        token.transfer(commissionWallet, fee);      // 1% Community wallet

        uint256 fee3 = fee.mul(3);
        token.transfer(ceoAddress1, fee3);          // 3% 
        token.transfer(ceoAddress2, fee3);          // 3% 
        
        uint256 fee2 = fee.mul(2);
        token.transfer(ceoAddress3, fee2);          // 2% 
        token.transfer(ceoAddress4, fee2);          // 2% 

        emit FeePayed(msg.sender, fee.mul(11));
