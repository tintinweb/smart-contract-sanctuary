...
/**
 * 
ClearSight is a global freelance platform that offers reliable freelance solutions using blockchain and smart contracts. This interactive platform helps employers to find the right freelancers and vice versa. We have backed up our ecosystem with a BSC based token to promote an exquisite user experience among members. ClearSight understands how freelancers have been tormented with huge commission fees by other freelance websites and are committed to reducing this fee with blockchain technology. Additionally, our user-friendly platform allows you to access your money easily using a Visa Debit Card. ClearSight offers freelancers an opportunity to manage their professional profiles using a digital identity, which protects them from theft and fraud. With 200 million exchangeable tokens, ClearSight offers relatively lower transaction costs while maintaining super fast transactions at the same time. 
*/
...
contract CLST is Context, IERC20, Ownable {
