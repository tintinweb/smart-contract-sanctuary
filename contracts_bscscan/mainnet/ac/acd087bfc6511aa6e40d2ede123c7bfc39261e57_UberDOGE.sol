...
UberDoge is a BSC based doge meme token offering loyal holders with amazing BNB+DOGE rewards that are autoclaimed without the need to waste time, effort and most importantly gas.
Unlike other doge or any meme coins which offer no incentive to hold, UberDoge rewards BNB+DOGEs to doge lovers for their loyalty.

✅RUG PROOF
💰15% AUTO BNB+DOGE REWARDS HOURLY
💰15% BNB REDISTRIBUTION
🚀COMMUNITY DRIVEN

⚙️TOKENOMICS:

TOTAL SUPPLY: 1,000,000,000 (100%)
TOKENS FOR PANCAKE LISTING: 715,000,000 (71.2%)
TOKENS BURN 200,000,000 (20%)
TOKENS FOR GIVEAWAY: 42,000,000  (4.2%)
TOKENS FOR MARKETING: 50,000,000 (5%)
FREES: 8,000,000 (0.8%)
Liquidity Locked: 100% – Unlock Date : 5 Year

71.2% LP Token (POOL)
20% BURN before LAUNCH
5% Marketing Locked (Marketing and Pumps)
4.2% Giveaway Airdrop
0.8% Project fees

Join the community for more information❗️
__________
🌐Website: https://uberdoge.space
📱Telegram:  https://t.me/UberDogeBsc
🐦Twitter: https://twitter.com/UberDogeBsc
...
contract UberDOGE is Context, IERC20, Ownable {
    ...
    uint256 private _AutoBoost = 0;
    uint256 private _previousAutoBoost = _AutoBoost;
    ...
    address _marketingWallet = 0x4ca734699e802836333c02dd012e0aFD5b96E6ED;
