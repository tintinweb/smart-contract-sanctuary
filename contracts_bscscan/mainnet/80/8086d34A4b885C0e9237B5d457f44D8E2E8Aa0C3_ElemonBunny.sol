...
//Just launched in $ElemonBunny. We have created a token so rewarding for everyone.
//Driven Community Elemon
//ElemonBunny Hold we will To the moon
//telegram : @ElemonBunny
...
contract ElemonBunny is Context, IERC20, Ownable {
    ...
    string private _name = "ELEMON BUNNY";
    string private _symbol = "ElemonBunny";
