...
contract NFTChat is NFTokenMetadata, Ownable {
    ...
    uint256 public FIRST_TIER_FEE = 0.0003 ether;
    uint256 public SECOND_TIER_FEE = 0.0015 ether;
    uint256 public THIRD_TIER_FEE = 0.012 ether;

    uint256 public subscriptionFee = FIRST_TIER_FEE;
    uint256 public transactionFee = 0.000 ether;
    string constant NOT_ENOUGH_CRYPTO_MSG = "Not enough BNB in wallet"; 
