...
contract FightClubCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "FightClubCoin";
    string private constant _symbol   = "FCC";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 0; // 3% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 1000; // 3% of every transaction is kept for liquidity
    uint256 public _marketingFee = 0; // 4% of every transaction is sent to marketing wallet
