...
/*
    # King Gatsby
    Total Fees: 15%
    2% fee is added to the King Gatsby developer wallet as BNB *Note the team will not be selling tokens*
    6% fee is added to the King Gatsby marketing wallet as BNB *Note the team will not be selling tokens*
...
contract KingGatsby is Context, IERC20, Ownable {
    ...
    string private _name = "King Gatsby";
    string private _symbol = "KGatsby";
    ...
    uint256 public _maxWallet = 300000 * 10**9; //3% of TS
    uint256 public _maxTxAmount = 100000 * 10**9; //1% of TS
    // set this number to adjust the rate of swaps
    uint256 public numTokensSellToAddToLiquidity = 25000* 10**9;
...
event MinTokensBeforeSwapUpdated(uint256 minTokensBeforeSwap);
    ...
    constructor () public  {
        ...
        _marketingAddress = 0xCBafC4D63A091770AFBb807eDB7C48dd321674dd;
        _developerAddress = 0xd64fC04B75bd2EF2D690B9FaEfC9F2746810eAeA;
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "KingCheemsInu: cannot burn from zero address");
    require(_balances[account] >= amount, "KingCheemsInu: Cannot burn more than the account owns");
