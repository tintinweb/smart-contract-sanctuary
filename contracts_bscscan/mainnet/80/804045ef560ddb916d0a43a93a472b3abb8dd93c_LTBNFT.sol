...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LTB = IBEP20(0x01413859d321F423054f6A26276325E8085Dd5fc);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LTB.balanceOf(address(this));
        ...
        uint256 amount = LTB.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LTB.transfer(shareholder, amount);
...
contract LTBNFT is IBEP20, Auth {
    using SafeMath for uint256;

    address LTB = 0x01413859d321F423054f6A26276325E8085Dd5fc;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LTBNFT";
    string constant _symbol = "LTBNFT";
