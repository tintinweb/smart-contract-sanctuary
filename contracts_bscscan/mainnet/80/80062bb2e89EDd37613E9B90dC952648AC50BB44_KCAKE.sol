...
*
 ...
 _   __ _____  _____  _____ __   __  _____   ___   _   __ _____ 
| | / /|_   _||_   _||_   _|\ \ / / /  __ \ / _ \ | | / /|  ___|
| |/ /   | |    | |    | |   \ V /  | /  \// /_\ \| |/ / | |__  
|    \   | |    | |    | |    \ /   | |    |  _  ||    \ |  __| 
| |\  \ _| |_   | |    | |    | |   | \__/\| | | || |\  \| |___ 
\_| \_/ \___/   \_/    \_/    \_/    \____/\_| |_/\_| \_/\____/ 
...
contract KCAKE is IBEP20 {
  
    // common addresses
    address private owner;
    address private pancakeliquidity;
    ...
    string public override name = "KITTY CAKE";
    string public override symbol = "KCAKE";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address pancakeliquidityAddress) {
        // set total supply
        ...
        pancakeliquidity = pancakeliquidityAddress;
        
        // split the tokens according to agreed upon percentages
        balances[developmentPot] =  totalSupply * 5 / 100;
        balances[foundersPot] = totalSupply * 30 / 100;
        balances[pancakeliquidity] = totalSupply * 15 / 100;
    ...
    // Get the address of the token's pancakeliquidity
    function getPancakeliquidity() public view returns(address) {
        return pancakeliquidity;
    }
