...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53636a647aFc2bb73a1cF275FC5F1bA875cf7bfA;
...
contract DGINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x408e4c0e742FC31F15b7BFc66C56fd9eC5032EF6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Doge Inu";
    string private _symbol = "DGINU";
