...
🤖WELCOME TO BABY ROBOT🤖


BABY ROBOT has automatic BNB reflection tokens! This means you get free BNB just for holding each coin. Sounds crazy? Well buy a small amount & watch it work. Then buy a large amount & get rich :)

👉🏻Reflection👈🏻 : 

It does this by applying a 7% tax on transactions:

✅ 4% goes to holders instantly
...
contract BabyRobot is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BRobot🤖";

  string private _name = "BABY ROBOT";
