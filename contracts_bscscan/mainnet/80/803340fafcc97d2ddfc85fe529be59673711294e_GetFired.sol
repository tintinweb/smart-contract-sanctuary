...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 had = IBEP20(0xA8B314fC3A801740C9c69f9fDa97089BcD443f96);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = had.balanceOf(address(this));
        ...
        uint256 amount = had.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            had.transfer(shareholder, amount);
...
contract GetFired is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GetFired";
    string constant _symbol = "GFI";
