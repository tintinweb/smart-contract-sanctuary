...
/**
     * project info:
     * telegram https://t.me/Pony_Uni
     * twitter https://twitter.com/PonyUniOfficial
     */
...
contract Ponyuni is Context, IERC20, Ownable {
    ...
    string private _name = "Ponyuni";
    string private _symbol = "PUNI";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Temporarily remove fees to transfer to team address and burn address
        _taxFee = 0;
        _liquidityFee = 0;
    ...
    function setMaxTxPercent(uint256 value) external onlyOwner{
        maxTxAmount = _tTotal.mul(value).div(100);
    }
