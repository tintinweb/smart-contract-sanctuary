...
//https://t.me/COULDBERUG SMALL BUY ONLY V2
...
// CHANGE
contract FUCKDREW  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FUCK DREW";
    string constant _symbol = "FUCKDREW";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 1000) / 1000; // 3% MAX 300,000
