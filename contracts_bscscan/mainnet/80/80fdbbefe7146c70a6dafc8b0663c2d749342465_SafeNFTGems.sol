...
/**
SafeNFTGems is a blockchain-based financial service
provider that doesn't depend on central financial
intermediaries like dealerships, exchanges,
or banks to offer traditional financial instruments,
and instead uses smart contracts on blockchain.
SafeNFTGems operates on the BSC network,
which focuses on digital currency and NFT (Non-fungible token).

❗Official Links❗

🌍Website : https://www.safenftgems.com
🌍Telegram : https://t.me/SafeNFTGems
🌍Twitter : https://www.twitter.com/SafeNFTGems
🌍Reddit : https://www.reddit.com/user/Safenftgems
*/
...
contract SafeNFTGems is Context, IBEP20, Ownable {
    ...
    string private _name = "SafeNFTGems";
