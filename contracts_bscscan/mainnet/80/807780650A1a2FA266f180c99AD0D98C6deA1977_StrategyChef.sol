...
contract StrategyChef is Ownable, ReentrancyGuard, Pausable {
    ...
    address public SafeChefAddress;
    ...
    constructor(
        ...
        SafeChefAddress = _SafeChefAddress;
        ...
        transferOwnership(SafeChefAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(SafeChefAddress, _wantAmt);
