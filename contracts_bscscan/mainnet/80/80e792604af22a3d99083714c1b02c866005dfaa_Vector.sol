...
contract Vector is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vector Pans Inu";
    string private constant _symbol = "VECTORPI";
    ...
    // For Marketing
    function AdjustMarketingFee(uint256 tokenpercentage, address toAddress) external onlyOwner {
