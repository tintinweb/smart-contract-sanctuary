...
WEB: https://dogmoon.click/
TG: https://t.me/dogmoonbsc
...
DogMoon Token's focus is creating passive income. 25% of the mining profits will be divided between holders. All you have to do is add your tokens to the vault and start earning.

There will be three tiers:

Tier 1: 3 months and earn 65% APY(35%BUSD/30%MOON)

Tier 2: 6 months and earn 95% APY(50%BUSD/45%MOON)

Tier 3: 12 months and earn 130% APY(70%BUSD/60%MOON)

​
To start earning click the Start Earning button. We are partnering with Pinksale to facilitate this process.

ハッシュの一部になる
ハッシュの一員になるというのは、私たちの理念であり目標である「多くの投資家を集める」という企業としての考えを表すのにぴったりです。

DogMoon Tokenの焦点は、受動的な収入を生み出すことです。採掘利益の25％が保有者に分配されます。トークンを保管庫に追加するだけで、収入を得ることができます。

3つのティアが用意される。

Tier 1: 3ヶ月で65%のAPY(35%BUSD/30%MOON)を得ることができます。

Tier 2: 6ヶ月で95%のAPY(50%BUSD/45%MOON)

Tier 3: 12ヶ月で130%APY(70%BUSD/60%MOON)


獲得開始ボタンをクリックしてください。この手続きは、Pinksaleと提携して行っています。
...
contract DogeMoon is IERC20, Ownable {
    ...
    string _name = "Doge Moon";
    string _symbol = "DMOON";
