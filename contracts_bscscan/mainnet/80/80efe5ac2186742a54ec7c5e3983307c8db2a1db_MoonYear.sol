...
contract MoonYear is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MoonYear";
    string constant _symbol = "MY";
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 100000; // 0.001% of supply
    bool inSwap;
