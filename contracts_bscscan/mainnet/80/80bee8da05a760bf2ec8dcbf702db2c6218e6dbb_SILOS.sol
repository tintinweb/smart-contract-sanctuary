...
contract SILOS is Context, IERC20, Ownable {
    ...
    string private _name = "SILOS";
    string private _symbol = "SILOS";
	...
	function setBurnAddress(address payable burn) public onlyOwner() {
        _burnWallet = burn;
	}
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        return (rAmount, rTransferAmount, rFee, tTransferAmount, data.tFee, data.tLiquidity, data.tMarketing, data.tBurn);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, TData memory) {
        ...
        return (tTransferAmount, TData(0, tFee, tLiquidity, tMarketing, tBurn, 0));
    }
