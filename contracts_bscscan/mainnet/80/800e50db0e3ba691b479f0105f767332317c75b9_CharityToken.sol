...
contract CharityToken is BEP20 {
    ...
    constructor() public BEP20("RocketX", "RKTX"){
    ...
    function _transfer(
        ...
        uint256 charityAmount = calculateCharity(amount);
        ...
        if(sender == owner()) {
            ...
            super._transfer(sender, ownerAddress, charityAmount);
