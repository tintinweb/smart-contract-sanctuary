...
Rebase Cake is Smart Rebase Token with $CAKE as rewards for holding

TG: https://t.me/rebasecake
*/
...
contract RebaseCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Rebase Cake";
    string constant _symbol = "$REBCAKE";
