...
contract QUAI_Staking is Ownable {
	...
	address public constant quaiToken = 0xb48f795a9AdA9Cfd023bD32D32A9974fBd4e951c; //token to stake
	...
	uint256 public minStaked = 1e9; //1000 tokens. min staked per user
