...
contract BNBSwap is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x70ded2Af5e03102aC6e3886d127a0d4E50A94003); // Marketing Address
    ...
    uint256 private minimumTokensBeforeSwap = 30 * 10**6 * 10**9; 
