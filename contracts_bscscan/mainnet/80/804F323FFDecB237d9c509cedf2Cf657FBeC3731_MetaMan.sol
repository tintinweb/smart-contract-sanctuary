...
contract MetaMan is Context, IERC20, Ownable {
    ...
    address payable public liquidityAddress =
        payable(0x30eBAD6af1aA5a944e6A3cD18B5F9EDcBB1b9ce9); // Liquidity Address
    ...
    string private constant _name = "MetaMan";
    string private constant _symbol = "MetaMan";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 9 / 1000; // 0.05%
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 9 / 1000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 9 / 1000; // 0.5% maxWalletToken
