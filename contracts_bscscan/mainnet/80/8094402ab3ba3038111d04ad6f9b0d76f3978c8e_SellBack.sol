...
contract SellBack is Ownable {
    ...
    ICloudEco public cloudEco = ICloudEco(0xBb4c11BFedf0114C617501FBaE5D292d82671d7F);
    ...
    constructor (IBEP20 _xosToken, IBEP20 _usdtToken, address _pancakeRouter,IBEP20 _xosusdtToken) public {
        xosToken = _xosToken;
