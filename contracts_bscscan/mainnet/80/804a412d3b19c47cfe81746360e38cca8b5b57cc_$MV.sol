...
$Moonaverse is one of the most innovative crypto projects to date, integrating charity with cryptocurrencies for a more impactful future.

Contract :

Website : On WaY

TG : https://t.me/MOONAVERSE
...
contract $MV is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonaverse";
    ...
    uint256 private numTokensSellToAddToLiquidity = 920000000000 * 10**9;
