...
/** 	
    ...
    Fat Shiba Inu $FSHIBA	
    	
    10% FEES PER TRANSACTION	
    - 4% of every transaction auto adds to the liquidity pool	
    - 3% of every transaction is distributed to all holders proportionally	
    - 2% of every transaction goes to the dev/marketing wallet	
    - 1% Goes to utilities like Fat Shiba Bridge	
