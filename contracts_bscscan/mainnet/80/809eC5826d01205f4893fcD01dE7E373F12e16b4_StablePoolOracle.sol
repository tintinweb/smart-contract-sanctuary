...
// File: contracts/oracle/StablePoolOracle.sol
...
contract StablePoolOracle is Ownable {
    ...
    address[] public pairs; // poolOracle
    ...
    function addPair(address _pair) external onlyOwner {
        ...
        IPairOracleV2 oracle = IPairOracleV2(_pair);
    ...
    function _consultPair(
        ...
        return IPairOracleV2(pairOracle).consult(token, amountIn);
    }
}