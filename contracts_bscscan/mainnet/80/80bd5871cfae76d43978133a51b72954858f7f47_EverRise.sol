...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8ee3b6C89ee3787dE07dB7A1802F87Fef8E47Af9); // Marketing Address
    ...
    string private _name = "Superharev2";
    string private _symbol = "Superharev2";
