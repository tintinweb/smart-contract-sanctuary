...
contract ElonPunk is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "ElonPunk: The new dividend tracker must be owned by the ElonPunktoken contract");
...
contract ElonPunkDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("ElonPunk_Dividen_Tracker", "ElonPunk_Dividend_Tracker") {
    claimwait = 3600;
    ...
    function withdrawDividend() public override {
        require(false, "ElonPunk_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ElonPunkcontract.");
    }
    ...
    function updateclaimwait(uint256 newclaimwait) external onlyOwner {
        require(newclaimwait >= 7200 && newclaimwait <= 86400, "ElonPunk_Dividend_Tracker: claimwait must be updated to between 1 and 24 hours");
