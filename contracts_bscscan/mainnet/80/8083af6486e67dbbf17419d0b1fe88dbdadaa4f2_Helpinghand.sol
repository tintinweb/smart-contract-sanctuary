...
contract Helpinghand is Context, IERC20, Ownable {
    ...
    string private _name = "Helpinghand";
    string private _symbol = "Hhand";
    ...
    address public _charityWallet = 0x4EeAFe8B5ED71AF385Fef5968f5C1f837f1083C2;
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        return (rAmount, rTransferAmount, rFee, tTransferAmount, tFeeData.tFee, tFeeData.tBurn, tFeeData.tCharity);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, FeeData memory) {
        ...
        FeeData memory tFeeData = FeeData(tFee, tBurn, tCharity);
    ...
    function _getRValues(uint256 tAmount, FeeData memory tFeeData, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rBurn = tFeeData.tBurn.mul(currentRate);
        uint256 rCharity = tFeeData.tCharity.mul(currentRate);
