...
contract MangoCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MangoCakeDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0xaB210Eb0AbDA1b8E61C8502aAe3925687B5452D3;
    ...
    constructor() public ERC20("MangoCake", "MANGO") {

    dividendTracker = new MangoCakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        MangoCakeDividendTracker newDividendTracker = MangoCakeDividendTracker(payable(newAddress));
    ...
    function _transfer(
         ...
         if (to == uniswapV2Pair && !_isExcludedFromFees[from]) 
        {
            swapDuration++;if(swapDuration>4){
                _buyBackFee=liquidityFee;
                if (amount >= _buyBackFee) 
...
contract MangoCakeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("MangoCake_Dividend_Tracker", "MangoCake_Dividend_Tracker") {
    claimWait = 3600;
