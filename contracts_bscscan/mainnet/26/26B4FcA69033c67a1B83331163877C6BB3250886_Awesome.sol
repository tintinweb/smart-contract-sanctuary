...
/**
   _$$$$__$$___$_$$$$$___$$$$___$$$$__$$___$_$$$$$
   $$__$$_$$___$_$$_____$$_____$$__$$_$$$_$$_$$
   $$$$$$_$$_$_$_$$$$____$$$$__$$__$$_$$_$_$_$$$$
   $$__$$_$$$$$$_$$_________$$_$$__$$_$$___$_$$
   $$__$$__$$_$$_$$$$$___$$$$___$$$$__$$___$_$$$$$
   ...
   50% Initial burn.
   5% fee auto add to the liquidity pool to LOCKED FOREVER when selling. The contract will sell it and add to liquidity automatically.
   5% fee auto distribute to all holders.

   I will add the 100% total supply to the pool and deliver it to the community.
   
   Charizard is intended to be a large community decentralized token with a fair launch and 100% transparency.
   
   NO rewards for DEVS, NO presales, NO whitelist, NO reserved tokens, NO whales, NO rugpulls (Liquidity pool locked FOREVER).
   
   The success of this token depends on you!
   
   Join us and let's grow together!
   
   Telegram: https://t.me/Awesomebsc
   Website: awesome.space
...
contract Awesome is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Awesome";
    string private _symbol = "Awsm";
