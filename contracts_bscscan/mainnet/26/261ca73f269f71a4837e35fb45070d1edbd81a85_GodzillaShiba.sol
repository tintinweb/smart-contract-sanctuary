...
contract GodzillaShiba is Context, IERC20, Ownable {
    ...
    string private _name = "GodzillaShiba";
    string private _symbol = "GodzillaShiba";
    ...
    uint256 private _maxWalletToken = 1000000000000 * 10**9;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != address(0) && to != uniswapV2Pair) {
