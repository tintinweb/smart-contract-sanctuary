...
CheemsCake Token
 4% Marketing | 3% LP | 7% Buyback
 2% Max Tax | 3% Max Wallet
 
 TG: https://t.me/CheemsCakeBSC
*/
...
contract CheemsCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CheemsCake";
    string constant _symbol = "CheemsC";
