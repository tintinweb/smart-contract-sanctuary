...
// BlackBNB, The first Token to give BNB rewards to shareholders
...
contract BlackBNB is IBEP20, Auth {
    ...
    string constant _name = "BlackBNB";
    string constant _symbol = "BNB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100000000;
    ...
    uint256 public swapThreshold = _totalSupply / 100000000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x123Af239449590a3b6799a64e67a5f82F62A5C4f;
