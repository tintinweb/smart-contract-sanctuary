...
contract Crypto_Vision_Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Crypto Vision";
    string private _symbol = "CVN";
    ...
    uint256 internal _tokenTotal = 2000000000000 *10**9; // 2 Trillion totalSupply
    ...
    uint256 public _taxFee = 300; // 300 = 3%
    uint256 public _charityFee = 300; // 300 = 3%
    
    uint256 public _taxFeeTotal;
    uint256 public _charityFeeTotal;
    
    address public charityAddress = 0xbf9b6B858E95c6036fD07cF71c96496AdB24062D; // Charity Address 
