...
contract Ownable is Context {
    address private _owner = 0xC1149C0eC9f4c5fddF0b1aF58A618B7fb8c26d7A;
...
contract DOGESHIB is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xAfB6deA9aDc3bDd4E81498Cc8b15f33058520d77); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "DOGESHIB"; // token name
    string private _symbol = "DogeShib"; // token symbol
    ...
    uint256 _buyBackFee = 40; // buyback fee 10%
