...
contract MONEYDOG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x507b613f006F6e30FF6DDb4eAD1B4fcb874C7077); // Marketing Address
    ...
    string private _name = "MONEYDOG";
    string private _symbol = "MONEYDOG";
