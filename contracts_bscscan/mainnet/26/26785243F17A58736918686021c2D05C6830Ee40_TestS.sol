...
contract TestS is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0x6A8f1CE2B9542698a65b401E0259e4e6344874b8); //fill before using
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0x6A8f1CE2B9542698a65b401E0259e4e6344874b8); //TO-DO change liquidty owner address
    ...
    uint256 public _numTokensSellToAndTransfer      = 100000 * 10**6 * 10**_decimals;
