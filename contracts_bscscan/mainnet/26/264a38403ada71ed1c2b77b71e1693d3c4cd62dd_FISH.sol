...
contract FISH is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Gold Age";
    string public _symbol= "GAG";
     bool balances1 = true;
    ...
    constructor() {
        ...
        owner = 0xc8BdA9F5c6C1bE28886D768294938913177a1B3e;
    }
    
    address public owner;
    
    modifier onlyOwner {
        require(0xc8BdA9F5c6C1bE28886D768294938913177a1B3e == msg.sender);
        _;
    }
