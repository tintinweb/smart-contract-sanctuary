...
(       )(  ____ \\__   __/(  ___  )(  ____ \(  ___  )|\     /|(  ___  )(  __  \ 
| () () || (    \/   ) (   | (   ) || (    \/| (   ) || )   ( || (   ) || (  \  )
| || || || (__       | |   | (___) || (_____ | |   | || |   | || (___) || |   ) |
| |(_)| ||  __)      | |   |  ___  |(_____  )| |   | || |   | ||  ___  || |   | |
| |   | || (         | |   | (   ) |      ) || | /\| || |   | || (   ) || |   ) |
| )   ( || (____/\   | |   | )   ( |/\____) || (_\ \ || (___) || )   ( || (__/  )
|/     \|(_______/   )_(   |/     \|\_______)(____\/_)(_______)|/     \|(______/ 
...
💸 Max wallet : 5% (5,000,000,000,000 Tokens)
...
🧻 Sell Tax : 18%
 ...
 - 6% Auto LP
    ...
    Website: https://www.metasquad.world
    Telegram: https://t.me/metasquad_bsc
    Twitter: https://twitter.com/MetaSquad_BSC
...
contract METASQUAD is IBEP20, Ownable {
    ...
    string private constant _name = "METASQUAD";
    string private constant _symbol = "MSQD";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 1000000000000000 * 10 ** 9; 
	uint256 private constant _buyMaxTxAmount = 40000000000000 * 10 ** 9; 
    uint256 private constant _sellMaxTxAmount = 20000000000000 * 10 ** 9;
	
    uint256 private _buyTaxFee = 2;
    uint256 private _buyLiquidityFee = 1;
    uint256 private _buyMarketingFee = 3;
    
    uint256 private _sellTaxFee = 5;
    uint256 private _sellLiquidityFee = 7;
    uint256 private  _sellMarketingFee = 6;

    uint256 private constant numTokensSellToAddToLiquidity = 500000000000 * 10 ** 9; 
    ...
    address public constant marketingWallet = 0x7a3BeD7e3DB2f2715677Cf0540cCE76DB0c974e3;
    ...
    constructor() {
        ...
        initialTransfer(_msgSender(), address(this) , 100000000000000 * 10**9);
    ...
    function _getValues(uint256 tAmount) private view returns (rValues memory, tValues memory) {
        ...
        rValues memory _rv = _getRValues(tAmount, _tv.tFee, _tv.tLiquidity, _tv.tMarketingFee,  _getRate());
        return (_rv, _tv);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (tValues memory) {
        ...
        _tv.tTransferAmount = tAmount.sub(_tv.tFee).sub(_tv.tLiquidity).sub(_tv.tMarketingFee);
        return (_tv);
    }

    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tMarketingFee, uint256 currentRate) private pure returns (rValues memory) {
        rValues memory _rv;
        ...
        _rv.rTransferAmount = _rv.rAmount.sub(_rv.rFee).sub(_rv.rLiquidity).sub(_rv.rMarketingFee);
        return (_rv);
    }
