...
//https://t.me/SHIBAINUGIRL
//SPDX-License-Identifier: MIT

//LIKE WE SAID WE WILL HAVE A LOW MAX TX AT FIRST ALSO I WANTED TO SHOUTOUT CAESARS CALL FOR CAllING US OUT: https://t.me/Caesars_Calls
...
contract SHIBAINUGIRL is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBAINUGIRL";
    string constant _symbol = "SHIBAINUGIRL";
	...
	function SHIBAINUGIRLSniperBan(address user, bool banned) external authorized {
		if (banned) {
    ...
    function SHIBAINUGIRLsetSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
