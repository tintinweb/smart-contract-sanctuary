...
// DiamondPad ($DPAD) 
// Tax 16% Buy | 16% Sell | 30% Sell first 24 hours 
// ADA Rewards 
// Telegram: https://t.me/DPAD_BSC                   
// Website: https://www.diamondpadbsc.com/
...
contract DiamondPad is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa24F238a4ae8b3ff1813704A129268A7869C80Ee); // Marketing Address
    ...
    string private _name = "DiamondPad";
    string private _symbol = "DPAD";
    ...
    uint256 private _buypajekFee = 15;
    uint256 private _buylpPajek = 1;
    
    uint256 private _botNeedsPrevention = 1;
    uint256 private _whaleNeedsPrevention = 29;
