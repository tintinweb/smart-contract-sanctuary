...
// TG: https://t.me/KittyEther
// Tokenomics: 10% REWARDS 3% Buyback 4% Marketing
// Kitty Rules- Show some love and join us
...
contract KittyEther is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KittyEther";
    string constant _symbol = "KittyEther";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 5%
	uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 5% of total supply
    ...
    uint256 public swapThreshold = _totalSupply / 500; // 5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xC06ddDC5054f8f29D7649F1C0e3Fc810709b5c69;
