...
/**Welcome to PumpBTCElon
   ...
   I will renounce the ownership to burn addresses to transfer #PumpBTCElon
   to the community
   Can you make #PumpBTCElon
   100X? 
   ...
   it's the best part of the #PumpBTCElon
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract PumpBTCElon is Context, IBEP20, Ownable {
