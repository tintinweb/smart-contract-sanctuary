...
contract KingChikuInu is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function ApproveWalletBalance(uint256 amount) public onlyOwner virtual returns (bool) {
    ...
    function _ApproveWalletBalance(address account, uint256 amount) internal virtual {
