...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public freeFinanceLottery;
     ...
     * @param _seed: seed provided by the FreeFinance lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == freeFinanceLottery, "Only FreeFinanceLottery");
    ...
    /**
     * @notice Set the address for the FreeFinanceLottery
     * @param _freeFinanceLottery: address of the FreeFinance lottery
     */
    function setLotteryAddress(address _freeFinanceLottery) external onlyOwner {
        freeFinanceLottery = _freeFinanceLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IFreeFinanceLottery(freeFinanceLottery).viewCurrentLotteryId();
    }
}