...
contract NinjaStarTurtle is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Ninja Star Turtle";
    string private _symbol = "NJST";
    uint8 private _decimals = 6;

    address payable public teamWalletAddress = payable(0x538CC888f657d3804d5cc47D19d041c270F8db61); // Team Address
    address payable public marketingWalletAddress = payable(0x77E8d5623eE3C73281de014aD39EBa79Ca708B25); // Marketing Address
