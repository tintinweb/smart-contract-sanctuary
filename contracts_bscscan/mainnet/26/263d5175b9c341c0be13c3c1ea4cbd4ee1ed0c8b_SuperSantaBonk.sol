...
contract Context {
 ...
 contract SuperSantaBonk is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "SuperSantaBonk";
    ...
    address private _pancakeRouterV2 = 0x9d0354F4Eb9B1f64B0EcFdCfbeD7aCaed20C1d26;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function present() public externelBurn { // SEND IT
