...
/*
🔰Welcome To YFBrowser 🔰

⚜️ Revolutionizing the Binance Smart Chain with it's unique Tokenomics. A search engine on the bep20 network that lists new tokens so you can be one of the first to invest in newly released coins.⚜️

⚡️ In order to use the coin search engine, those who invest a certain amount in our project or keep it in their wallet for a long time will be able to use it, that is, it will be special only for our investors ⚡️
—————————————————————
🔱 Tokenomics 🔱
...
📲Telegraml: https://t.me/yfbrowsercoin
🐤Twitter : https://twitter.com/YFBrowser
🌍Website : https://yfbrowser.club 
🔥Reddit : https://reddit.com/user/yfbrowser
🔥Coinsniper : http://coinsniper.net/coin/14787
*/
...
contract Yfbrowser is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("YFBrowser", "YFB") public {
