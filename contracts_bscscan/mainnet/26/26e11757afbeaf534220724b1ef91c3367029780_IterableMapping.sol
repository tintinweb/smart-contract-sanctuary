...
contract Smellybaby is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 300000000000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 100000000000000000000 * (10**18);
    uint256 public swapTokensAtAmount = 20000000000000000 * (10**18);
    uint256 public maxWalletToken = 1500000000000000000 * (10**18); // 1.5% of total supply
    ...
    receive() external payable {
  	...
  	function prepareForPreSale() external onlyOwner {
        ...
        marketingFee = 0;
        maxBuyTranscationAmount = 100000000000000000000 * (10**18);
        maxWalletToken = 100000000000000000000 * (10**18);
    }
    
    function afterPreSale() external onlyOwner {
        dividendRewardsFee = 9;
        marketingFee = 4;
        maxBuyTranscationAmount = 300000000000000000 * (10**18);
        maxWalletToken = 1500000000000000000 * (10**18);
    }
