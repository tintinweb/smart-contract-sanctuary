...
/**
  ronaldo
    ...
    I make this ronaldo to hand over it to the community.
   ...
   it's the best part of the ronaldo idea, increasing the liquidity pool automatically, 
...
contract ronaldo is Context, IERC20, Ownable {
    ...
    string private _symbol = "ronaldo";
