...
contract YorkieCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xcCF076c8956C0eCC49f16F97c9A046531D6a11FC); // Marketing Address
    ...
    uint256 private _buypajekFee = 5;
