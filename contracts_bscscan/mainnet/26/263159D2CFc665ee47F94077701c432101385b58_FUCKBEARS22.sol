...
// File: contracts/fuckbears22.sol
...
contract FUCKBEARS22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FUCK BEARS22";
    string constant _symbol = "FUCKBEARS22";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * 10**0 * (10 ** _decimals);//1,000,000 1M

    uint256 public _maxTxAmount = ( _totalSupply * 1 )  / 100;//10,000

    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;//20,000
