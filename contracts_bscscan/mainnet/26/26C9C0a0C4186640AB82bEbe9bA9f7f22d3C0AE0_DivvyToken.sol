...
contract DivvyToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x169a6ed21f9cc5e59E1e13eD8bC2b29662851323); // Marketing Address
    ...
    string private _name = "Divvy";
    string private _symbol = "DIV";
