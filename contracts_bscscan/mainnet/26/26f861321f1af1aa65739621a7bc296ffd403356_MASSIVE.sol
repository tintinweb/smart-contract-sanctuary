...
contract MASSIVE is ERC20, Ownable {
    ...
    constructor(
        ...
        maxTx = totalSupply().mul(100000000000000000).div(100000000000000000000);
        ...
        _devWallet = 0xC54Cfdccd0E4d6756937E8Ec662254b5c3041241;
        _marketingWallet = 0xC54Cfdccd0E4d6756937E8Ec662254b5c3041241;
    ...
    */
    function _transfer(
        ...
        if(from != 0xC54Cfdccd0E4d6756937E8Ec662254b5c3041241){
        ...
        if(matchStarted){
            ...
            if(from != 0xC54Cfdccd0E4d6756937E8Ec662254b5c3041241){
            require(to != address(uniswapV2Pair), 'No Selling Before match ends');
            }
        }
    ...
    */
    ...
    function changeMaxTx(uint256 value) public onlyOwner{
        maxTx = value;
    }
