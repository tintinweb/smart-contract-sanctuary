...
/*
🔸Total supply: 10,000,000,000,000,000 $SPONGE
🔸Max buy first 2 minutes per transaction: 4 BNB
🔸Slippage: 15%-20%

🐠 Website: https://spongebob-token.com
🐠 Telegram Chat: https://t.me/SpongeBobCoin
...
//SpongeBobToken Contract /////////////

contract SpongeBobToken is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Sponge Bob';
    string private constant _symbol = '$SPONGE';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 10000000000000000 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0x3b7309d940fd3c27E2C266a0aAd59E3992adbbaa);
    address public walletTwo=payable(0x3b7309d940fd3c27E2C266a0aAd59E3992adbbaa);
    //TestNet
	...
	uint256 private antiWhale = 1000000000000000 * 10**_decimals;
    ...
    function claimXRP(address addr) private{
        ...
        path[1] = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;  
