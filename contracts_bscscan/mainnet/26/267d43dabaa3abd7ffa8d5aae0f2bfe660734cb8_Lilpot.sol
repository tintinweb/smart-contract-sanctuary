...
contract Lilpot is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA3634f547754C5536CC73D7A94c18772065614e4); // Marketing Address
    ...
    string private _name = "Lilpot";
    string private _symbol = "Lilpot";
    ...
    // MAX Wallet amount is 4% of the total supply.
    ...
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 10) / 10000;
    uint256 public buyBackSellLimit = 1 * 10**12;
