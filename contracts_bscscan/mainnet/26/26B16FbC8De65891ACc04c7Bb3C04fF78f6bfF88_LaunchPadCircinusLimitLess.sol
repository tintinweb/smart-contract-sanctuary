...
contract LaunchPadCircinusLimitLess is Ownable {
    using SafeMath for uint256;

    IERC20 public stableCoin =
        IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //Busd

    uint256 public NFTPrice = 500 * 1E18;
    uint256 public NFTSold;
    uint256 public NFTTarget = 200;

    uint256 public round1BeganAt = 1641124800;
    ...
    function buyRound1Stable(uint256 _amount) external {
        require(block.timestamp >= round1BeganAt, "Too soon to buy");
        require(NFTSold < NFTTarget, "Sold out !");
        require(!endUnlocked, "Sale is finished");
        require(
