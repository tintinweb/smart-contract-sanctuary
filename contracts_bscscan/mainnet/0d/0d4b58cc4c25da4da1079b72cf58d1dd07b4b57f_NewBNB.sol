...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10**18); // 1 USDT minimum auto send
    uint256 public minimumTokenBalanceForDividends = 21 * (10**6); // user must hold 0.021 token
...
contract NewBNB is
    BASEToken("NewBNB", "NewBNB", 5000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    constructor() {
        ...
        marketing = 0x8c9653B5F36CCA406d452C8B6D475111a6348c00;
