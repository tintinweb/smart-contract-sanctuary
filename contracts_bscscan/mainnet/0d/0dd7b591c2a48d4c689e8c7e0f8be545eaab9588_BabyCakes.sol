...
contract BabyCakes is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyCakes';
    string private constant _symbol = '$BabyCakes';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 15000 * 10**_decimals;//

    //Divider for the MaxBalance based on circulating Supply (1.5%)
    uint8 public constant BalanceLimitDivider=5;
    ...
    address public constant TeamWallet=0xf3Db15dB776Ed20c3939E19c25c7B601e78ED9eA;
	...
	uint256 private antiDump = 15000 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;  //CAKE
