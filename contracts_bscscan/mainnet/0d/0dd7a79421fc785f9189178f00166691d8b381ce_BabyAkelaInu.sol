...
contract BabyAkelaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x9905AEB1BC014C9264Ec10617C9eA4313fbbb6e1;
 
    string constant _name = "Baby Akela Inu";
    string constant _symbol = "BABY AKELA";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit hellBound(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event hellBound(uint256 amountBNB, uint256 amountBOG);
}