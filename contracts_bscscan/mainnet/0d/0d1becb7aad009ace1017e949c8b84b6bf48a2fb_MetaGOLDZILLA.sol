...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGEZILLA = IBEP20(0x0975C6E0B7542311C77Ff348730bE5992eE0e14F);
...
contract MetaGOLDZILLA is IBEP20, Auth {
    using SafeMath for uint256;

    address DOGEZILLA = 0x0975C6E0B7542311C77Ff348730bE5992eE0e14F;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MetaGOLDZILLA";
    string constant _symbol = "MGZ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 69000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x94f6D107F2d2e2084f104F50C055eFD6a35D0946;
        ...
        marketingFeeReceiver = 0x926a4153f0DC5C391b215a8a85A3757c0349Ee80;
