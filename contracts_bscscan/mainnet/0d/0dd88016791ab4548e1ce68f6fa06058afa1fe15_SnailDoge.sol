...
/**
 _______  __    _  _______  ___   ___        ______   _______  _______  _______ 
|       ||  |  | ||   _   ||   | |   |      |      | |       ||       ||       |
|  _____||   |_| ||  |_|  ||   | |   |      |  _    ||   _   ||    ___||    ___|
| |_____ |       ||       ||   | |   |      | | |   ||  | |  ||   | __ |   |___ 
|_____  ||  _    ||       ||   | |   |___   | |_|   ||  |_|  ||   ||  ||    ___|
 _____| || | |   ||   _   ||   | |       |  |       ||       ||   |_| ||   |___ 
|_______||_|  |__||__| |__||___| |_______|  |______| |_______||_______||_______|

Snail Doge is the ultimate token on the Binance Smart Chain, inspired by Elon's tweet.
It combines two amazing features Auto rewards and buybacks. 
By simply holding, you will earn $DOGE every 60 minutes. 
The longer you hold, the more you earn. Don't miss out!
...
3% redistribution to all holders in $DOGE
5% to Marketing 
2% to Liquidity Pool

Telegram https://t.me/snaildoge
...
// CHANGE
contract SnailDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Snail Doge";
    string constant _symbol = "SNAILDOGE";
