...
contract DecentralGameLand is StandardToken , MintableToken, BurnableToken, PausableToken {

    string public constant name = 'Decentral Game Land';
        ...
        
    {
        ...
        address(0xE9B3bd95f5f0832bE513C286677d2073f946Bc5A).transfer(950000000000000000 wei);
