...
contract INUTokenBSC is INUTokenDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private INUTokenTeam;
    address private CharityINUToken;
    ...
    string public override name = "INU Token";
    string public override symbol = "INU Token";
    ...
    constructor(uint totalSupplyValue, address INUTokenTeamAddress, address CharityINUTokenAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        INUTokenTeam = INUTokenTeamAddress;
        CharityINUToken = CharityINUTokenAddress;
        
        // split the tokens according to agreed upon percentages
        balances[INUTokenTeam] =  totalSupply * 4 / 100;
        balances[CharityINUToken] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's INUTokenTeam pot
