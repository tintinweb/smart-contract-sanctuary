...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // rewards token address #1
...
// change contract name here to file name #2
contract TestName is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // put rewards CA here #3
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TestName"; //token name #4 
    string constant _symbol = "$TST"; // token tika #5
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 1 )  / 100; //max transaction %

    //max wallet holding of 2%
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; // max wallet %
    ...
    uint256 liquidityFee    = 49; // ammount to LP
    uint256 reflectionFee   = 1; // ammount to rewards
    uint256 marketingFee    = 49; // ammount to marketing wallet
    uint256 public totalFee = 99; //Total Fee
    uint256 feeDenominator  = 100;// must be 100
    ...
    uint8 public cooldownTimerInterval = 1; // In Seconds
