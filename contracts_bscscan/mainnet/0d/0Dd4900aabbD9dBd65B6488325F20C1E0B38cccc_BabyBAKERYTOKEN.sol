...
//     BabyBAKERYTOKEN Smart Contract - https://t.me/BabyBAKERYTOKEN
//
//
//     Tokenomics:
...
// File: contracts/BabyBAKERYTOKENDividendPayingToken.sol
...
// File: contracts/BabyBAKERYTOKEN.sol
...
contract BabyBAKERYTOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BabyBAKERYTOKENDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabyBAKERYTOKEN", "BabyBAKERYTOKEN") {
        ...
        dividendTracker = new BabyBAKERYTOKENDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BabyBAKERYTOKEN: The dividend tracker already has that address");

        BabyBAKERYTOKENDividendTracker newDividendTracker = BabyBAKERYTOKENDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BabyBAKERYTOKEN: The new dividend tracker must be owned by the BabyBAKERYTOKEN token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BabyBAKERYTOKEN: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabyBAKERYTOKEN: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyBAKERYTOKEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyBAKERYTOKEN: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BabyBAKERYTOKEN: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BabyBAKERYTOKEN: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BabyBAKERYTOKEN: Cannot update gasForProcessing to same value");
...
contract BabyBAKERYTOKENDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(false, "_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyBAKERYTOKEN contract.");
    }
