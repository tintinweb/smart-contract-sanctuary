...
5% Auto Liquidity
3% Marketing
🐳ANTI WHALES FEATURES!🐳
👉Max Tx and Max wallet :
》2% Max tx
》4% Max Wallet

TG - t.me/Superbabyshibainu
...
contract SuperBabyShibaInu is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    bool isNumber = true;   
    constructor() {
        _totalSupply = 1000000000000 * 10**9 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function name() public view virtual override returns (string memory) {
        return "Super Baby Shiba Inu";
    }
