...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //Reward
...
/* Token contract */
contract DogElonMusk is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //Reward
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x65B566A876d2D74dF9d0bB6930e9f14471df3BF2;
    ...
    // Name and symbol
    string constant _name = "DogElonMusk";
    string constant _symbol = "$DEM";
    ...
    uint256 public swapThreshold = _totalSupply * 39 / 10000; // 0.3% of supply
