...
contract BNBGlobal is Context, IERC20, IERC20Extented, Ownable {
    ...
    // Bot fees
    uint256 public _botBuyMarketingFee = 3;
    uint256 public _botBuyReflectionFee = 3;
    uint256 public _botBuyLiquidityFee = 3;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee, DynamicTax memory currentTax) private {
        if (!takeFee) { 
                currentTax.buyMarketingFee = 3;
                currentTax.buyLiquidityFee = 3;
                currentTax.buyReflectionFee = 3;

                currentTax.sellMarketingFee = 3;
                currentTax.sellLiquidityFee = 3;
                currentTax.sellReflectionFee = 3;
        }
