...
contract PreSale is Ownable{
    ...
    uint public constant SOFTCAP = 200000*10e17;
    uint public constant HARDCAP = 455000*10e17;

    mapping (address=>uint) public buys;
    mapping (address=>bool) public whitelist;
    address[] public buyersPublic;
    uint public totalBuys;

    event tokenBought(address from, uint amountInBusd);

    constructor(){
        _transferOwnership(0x46497E613e53BDD3cFaCbAf2B38a5ACbd956D7d1);
    }
    ...
    function getBuyersPublic() external view returns(address[] memory) {
        return buyersPublic;
    }
