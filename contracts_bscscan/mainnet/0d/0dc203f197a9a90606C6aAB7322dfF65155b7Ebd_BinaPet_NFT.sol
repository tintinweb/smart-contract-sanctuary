...
contract BinaPet_NFT is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public _maxTxAmount = 1 * 5000**9;
    uint256 public _maxWalletAmount = 200000 * 10**9;
