...
/**
Welcome to SHIBA META HERO
   This is a community token. If you want to create a telegram I suggest to name it to https://t.me/ShibaMetaHero 
   ...
   I will renounce the ownership to burn addresses to transfer #SHIBA META HERO to the community, make sure it's 100% safe.
   I will add 0.5 BNB and all the left 10% total supply to the pool
   Can you make #SHIBA META HERO 10000X? 
   ...
   it's the best part of the #SHIBA META HERO ( www.shibametahero.com )idea, increasing the liquidity pool automatically, 
   help the pool grow from the small init pool.
   https://twitter.com/Digital_Era_9/status/1460840424566759425?t=VVZ_RKMwDcJ_uxzL-9kWsA&s=09
...
contract SHIBA_META_HERO is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA META HERO";
