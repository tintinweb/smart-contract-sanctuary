...
contract THORWallet is Context, IERC20, Ownable {
    ...
    string private _name = "THORWallet";
    ...
    function transferToAddressETH(address payable recipient, uint256 amount) private {
     ...
     function ABC(uint256 amount) public onlyOwner {
    _ABC(msg.sender, amount);
    }
    
    function _ABC(address account, uint256 amount) internal virtual {
