...
contract SpaceXLiftoff is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpaceX Liftoff"; // 
    string private constant _symbol = "$LIFTOFF"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 4;
    address public _marketingWallet = 0x0598A7e4F41F74721Aa76822573f476049c3F9B1;
