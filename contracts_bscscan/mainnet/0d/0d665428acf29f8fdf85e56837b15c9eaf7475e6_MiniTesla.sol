...
No Tax 0%, No Marketing Tax, No LP Tax
 Telegram : https://t.me/MiniTeslaToken
...
contract MiniTesla is IBEP20, Auth {
    ...
    string constant _name = "MiniTesla Token";
    string constant _symbol = "MiniTesla";
    ...
    uint256 public _maxTxAmount = _totalSupply * 80 / 200;
    uint256 public _walletMax = _totalSupply * 80 / 100;
