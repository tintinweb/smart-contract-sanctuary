...
/** TG https://t.me/AlienTokenOfficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //the reward token you want distributed 
...
contract AlienToken is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AlienToken";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "ALIEN";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    uint256 liquidityFee    = 1; //fees. change them to whatever you like. make sure to adjust the totalFee in line 456 to equal total sum of the values in 453,454 and 455.
    uint256 reflectionFee   = 1;
    uint256 marketingFee    = 16;
    ...
    uint8 public cooldownTimerInterval = 100; //this is in seconds. 
