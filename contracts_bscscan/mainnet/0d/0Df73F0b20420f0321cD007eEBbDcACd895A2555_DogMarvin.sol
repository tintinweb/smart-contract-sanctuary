...
contract DogMarvin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Marvin Doge";
    string constant _symbol = "$DogMarvin";
    ...
    uint256 devFee      = 2;
    uint256 totalFee        = marketingFee + reflectionFee + liquidityFee + devFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc2880f0ED318cc3b57FE62F679e52314C0BC0673;
        devFeeReceiver = 0xa0161C37345A3cf77dD961a3aA4d9de92396a1d8;
