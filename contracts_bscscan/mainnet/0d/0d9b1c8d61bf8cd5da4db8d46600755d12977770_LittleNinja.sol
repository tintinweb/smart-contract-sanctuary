...
contract LittleNinja is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x2a9651CDA23D2365171094E08FD98a8924F3104a); // Marketing Address
        
    address payable public teamAddress =
        payable(0x2a9651CDA23D2365171094E08FD98a8924F3104a); // Team Address
        
    address payable public liquidityAddress =
        payable(0x73dEf5b37Ea3EEE0ea3D4200EC853e6016A8F7eC); // Liquidity Address
    ...
    string private constant _name = "LittleNinja";
    string private constant _symbol = "LTN";
