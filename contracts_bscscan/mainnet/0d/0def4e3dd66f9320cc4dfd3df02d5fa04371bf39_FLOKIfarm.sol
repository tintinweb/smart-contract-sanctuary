...
/*
 ___ _    ___  _  _____  __                
| __| |  / _ \| |/ /_ _|/ _|__ _ _ _ _ __  
| _|| |_| (_) | ' < | ||  _/ _` | '_| '  \ 
|_| |____\___/|_|\_\___|_| \__,_|_| |_|_|_|
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4); //Floki
...
contract FLOKIfarm is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Floki Inu Farm";
    string constant _symbol = "FLOKIfarm";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4; //Floki
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newExtraSellFee) external onlyOwner {
