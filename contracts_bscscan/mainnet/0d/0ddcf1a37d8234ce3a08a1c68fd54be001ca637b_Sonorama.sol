...
/**
Sonorama is a decentralized token on the BSC network that aims to 
become a leader in the crypto music industry! 
A Crypto modern Spotify! Famous artists, new albums, Talent Hunters!

Telegram : t.me/SonoramaBSC
Website : https://Sonorama.live
twitter : https://twitter.com/SonoramaBSC
 */
...
contract Sonorama is IBEP20, Ownable {
    ...
    string private constant _name = "Sonorama";
    string private constant _symbol = "$SRM";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 100000000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 100000000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 100000000000 * 10 ** 9;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 100000000000, "Can not reduce below 10K");
        require(maxSell > 100000000000, "Can not reduce below 10K");
