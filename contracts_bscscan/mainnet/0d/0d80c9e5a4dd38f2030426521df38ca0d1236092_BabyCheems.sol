...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x51eEEd0523dD2452Eca99a8aD66823399947d405;
...
contract BabyCheems is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x72E14cb200Cf3f90570fB702B9b5A456DC0F05A6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyCheems";
    string private _symbol = "BabyCheems";
