...
1.0% max transaction (1,000,000,000)
1.0% max hold *(1,000,000,000)
...
contract MiniADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletAddress = 0xaC23522493B66C1107123FbcF7264f824Bc6117d;
    address public _devWalletAddress = 0x54B6abE07975f708fa8533A846188F2cE45eE0C8;
    ...
    constructor() public ERC20("MiniADA", "$MiniADA") {
...
contract MiniADADividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("MiniADA Dividends", "MiniADA_dividends") {
    	claimWait = 3600;
