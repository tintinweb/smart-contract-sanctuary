...
contract HPL is HPLBase {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "HPL::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "HPL::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "HPL::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "HPL::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying HPL (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "HPL::_writeCheckpoint: block number exceeds 32 bits");
...
contract HPLBase is
    ...
    __HPL_ERC20Burnable,
    BlackholePrevention,
    UsingLiquidityProtectionService(0xaB5b38273a4a5Efd5b1cF9FaE1Cb4804B5Bd7c4B)
{
    ...
    function protectionChecker() internal view override returns(bool) {
        return ProtectionSwitch_timestamp(1643327999); // Switch off protection on Thursday, January 27, 2022 11:59:59 PM GMT.
 ...
 */
abstract contract __HPL_ERC20Burnable is Context, __HPL_ERC20 {
    /**
 ...
 */
contract __HPL_ERC20 is Context, IERC20, IERC20Metadata {
