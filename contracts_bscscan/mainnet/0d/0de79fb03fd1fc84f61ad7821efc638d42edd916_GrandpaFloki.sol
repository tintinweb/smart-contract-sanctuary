...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    address public adminAddress = 0x948fdC67b7858E3e24598B947384f816DB7F05eB;
...
contract GrandpaFloki is ERC20, Ownable {
    ...
    address public a80DividendToken = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;
    address public b20DividendToken = 0x338A09a17a7DA2E5c5a6B22344f3a49904224C79;
    ...
    address public toBurnGrandpaFlokiAddress;
    uint256 public toBurnGrandpaFlokiFee;
    ...
    constructor() ERC20("GrandpaFloki Token", "GFLOKI") {
       a80DividendTracker = new A80DividendTracker();
        ...
        a80DividendToken = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;
        b20DividendToken = 0x338A09a17a7DA2E5c5a6B22344f3a49904224C79;
    ...
    function afterPreSale() external onlyOwner {
        a80DividendRewardsFee = 4;
        b20DividendRewardsFee = 4;
        marketingFee = 3;
        buyBackAndLiquidityFee = 2;
        toBurnGrandpaFlokiFee = 4;
    ...
    function _updateTotalFee() internal {
        totalFees = buyBackAndLiquidityFee.add(marketingFee).add(a80DividendRewardsFee).add(b20DividendRewardsFee).add(toBurnGrandpaFlokiFee);
    }
    ...
    function updateA80DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newA80DividendTracker.owner() == address(this), "must be owned by GrandpaFloki");
    ...
    function updateB20DividendTracker(address newAddress) external onlyOwner {
        ...
        require(newB20DividendTracker.owner() == address(this), "must be owned by GrandpaFloki");
    ...
    function buyBackThunderCakeAndBurn(uint256 amount) private {
        ...
        path[2] = toBurnGrandpaFlokiAddress;
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("A80_Dividend_Tracker", "A80_Dividend_Tracker", 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("B20_Dividend_Tracker", "B20_Dividend_Tracker", 0x338A09a17a7DA2E5c5a6B22344f3a49904224C79) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
