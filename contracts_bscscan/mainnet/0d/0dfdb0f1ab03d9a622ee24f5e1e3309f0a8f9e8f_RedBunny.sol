...
//SPDX-License-Identifier: MIT
 ...
 //Receive $BUNNY in your wallet automatically every few minutes
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUNNY = IBEP20(0xC9849E6fdB743d08fAeE3E34dd2D1bc69EA11a51);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BUNNY.balanceOf(address(this));
        ...
        uint256 amount = BUNNY.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BUNNY.transfer(shareholder, amount);
...
contract RedBunny is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RED BUNNY";
    string constant _symbol = "RedBUNNY";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x4B6422a09A75F9F33B94ab33fEDcf466b8d059eA;
