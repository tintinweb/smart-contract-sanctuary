...
contract RoboFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x156420fc6cbcD52ED25bA0f434682e34F468B624); // Marketing Address
    ...
    string private constant _symbol = "RF";
    ...
    constructor() {
        address newOwner = address(0x156420fc6cbcD52ED25bA0f434682e34F468B624);
        ...
        maxTransactionAmount = _tTotal * 3 / 100; // 5% maxTransactionAmountTxn
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyBurnFee <= 20);
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellBurnFee <= 30);
