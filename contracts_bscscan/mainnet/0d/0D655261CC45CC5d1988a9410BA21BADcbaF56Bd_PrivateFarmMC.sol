...
contract BYieldToken is BEP20('BYield Token', 'bYield') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BYIELD::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BYIELD::delegateBySig: invalid nonce");
        require(now <= expiry, "BYIELD::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BYIELD::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BYIELDs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "BYIELD::_writeCheckpoint: block number exceeds 32 bits");
...
contract Presale is ReentrancyGuard {
    ...
    function buy (uint256 _amount, address beneficiary) public nonReentrant {
        ...
        // Ensure 300,000 BUSD Hardcap is not exceeded
        require (busdReceived +  _amount <= 300000 ether, "Presale hardcap reached");
...
contract PrivateFarmMC is Ownable, ReentrancyGuard {
    ...
    // Total of 4,800 bYield Allocated for Private Farms 
    // Based on Period of 3 days (86400 blocks), equalivant to 0.055 bYield Per Block
    ...
    // Lockup Period for all Withdrawal: 3 days = 86400 Blocks
    uint256 public constant PRIVATE_FARM_LOCKUP_PERIOD = 86400;
    // Lockup Period for all Harvest: 5 days = 144000 Blocks
    // Withdrawal Locked for 3 days, Harvest Lock for 5 days, 2 days after Private Farming has ended
    uint256 public constant HARVEST_LOCKUP_PERIOD = 144000;
