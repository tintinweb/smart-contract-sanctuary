...
/**
   ...
   Welcome to JumpDoge! Bull Market is back, time to make money in crypto, don't miss it!
   
   This is a community token. If you want to create a telegram I suggest to name it to @JumpDogeCoin
...
contract JumpDoge is Context, IERC20, Ownable {
