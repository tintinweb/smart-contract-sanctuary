...
// File: contracts/Priest Shiba.sol
...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000e9 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Priest Shiba";
    string private _symbol = "PRIEST SHIBA";
