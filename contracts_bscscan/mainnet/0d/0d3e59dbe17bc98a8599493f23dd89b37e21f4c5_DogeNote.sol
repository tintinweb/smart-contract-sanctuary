...
/*
TG: 
t.me/DogeNoteOfficial

Website:
https://dogenote.net/

1% Marketing 2% Holders 9% Buyback
*/
...
contract DogeNote is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB44a37d38Cd1eCC37782D347de5b8A039e4D3B5d); // Marketing Address
    ...
    string private _name = "DogeNote";
    string private _symbol = "DOGENOTE";
