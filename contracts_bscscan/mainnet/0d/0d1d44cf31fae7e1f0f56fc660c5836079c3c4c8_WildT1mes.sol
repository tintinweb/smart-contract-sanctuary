...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BTCB = IERC20(0x03fF0ff224f904be3118461335064bB48Df47938);
...
// CHANGE
contract WildT1mes is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address BTCB = 0x03fF0ff224f904be3118461335064bB48Df47938;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Wild T1mes";
    string constant _symbol = "T1MES";
    ...
    uint256 reflectionFee = 500; // 2%
    uint256 devFee = 500; // 5%
    uint256 totalFee = 1000; // Reflection + liquidityFee + devFee for marketing and development
