...
MiniDogeMoon (MIDOGEMOON)

Mini Doge Moon is a community driven token.
Feel free to create tg for this token
Easy Moon with MiniDogeMoon
...
contract MiniDogeMoon is Context, IERC20, Owwnable {
    ...
    string private _symbol = "MIDOGEMOON";
