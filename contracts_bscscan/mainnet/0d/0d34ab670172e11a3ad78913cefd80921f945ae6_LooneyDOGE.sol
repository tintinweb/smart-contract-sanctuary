...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xf3bdd9bb44ccdc48076a1639b940965e13b4c75963b9a3355007f8c6c54a893d is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0xf3bdd9bb44ccdc48076a1639b940965e13b4c75963b9a3355007f8c6c54a893d;
...
contract LooneyDOGE is Context, IERC20, Ownable {
    ...
    string private _name = 'Looney DOGE';
    string private _symbol = 'LOODOG';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256) {
        uint256 tFee = tAmount.div(100).mul(30);
