...
contract HappyNew is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000000; // Total token supply 10M
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tDonationTotal;

    string private _name = "Happy New Token";
    ...
    uint256 public _donationFee = 4; // Tax for marketing wallet
    uint256 private _previousDonationFee = _donationFee;

    uint256 public walletlimit = 200000000000000; // 200K

    uint256 public _maxTxAmount = 100000000000000; // Max Transaction Amount 100K
    uint256 private minimumTokensBeforeSwap = 23500000000000; // 23.5K

    address payable public marketingAddress = 0xeEC3a8B8307E75244Ea8723D63984F008F898a3e; // Marketing Address
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != uniswapV2Pair && to != address(0x10ED43C718714eb63d5aA57B78B54704E256024E)
            ...
            require(amount + balanceOf(address(to)) <= walletlimit , "You have reached the limit of tokens in this wallet");
         }
