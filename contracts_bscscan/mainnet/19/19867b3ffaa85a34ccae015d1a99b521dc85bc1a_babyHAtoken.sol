...
/** BABY HATOKEN ($BTOK) - BRINGING THE METAVERSE TO YOU
* Creating a community that will help other people as they invest and explore the MetaVerse
* Telegram Community - https://t.me/babyHAtoken
* 100% Fair Launch
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xF086D5B9019CC637dAD17b83321D93f84FfaA49b); //HATOK
...
contract babyHAtoken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABY HATOKEN";
    string constant _symbol = "BTOK";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken =   0xF086D5B9019CC637dAD17b83321D93f84FfaA49b;

    uint256 _totalSupply = 2_000_000_000_000_000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x1DeE176CC8B0ee8465A2C7C2d0b74a1005483eE3;  // teamwallet
        lotteryWallet = 0x1DeE176CC8B0ee8465A2C7C2d0b74a1005483eE3;  // lotterywallet
