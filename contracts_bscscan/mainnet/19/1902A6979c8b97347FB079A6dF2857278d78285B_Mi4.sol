...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ISPN4 = IBEP20(0xED52d233416903fA721066D59819B08eF00Fe4B0);
    ...
    uint256 public minDistribution = 0.25 * (10 ** 18);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ISPN4.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(ISPN4);
        ...
        uint256 amount = ISPN4.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ISPN4.transfer(shareholder, amount);
...
contract Mi4 is IBEP20, Auth {
    using SafeMath for uint256;

    address ISPN4 = 0xED52d233416903fA721066D59819B08eF00Fe4B0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "mISPM4test";
    string constant _symbol = "Mi4t";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x55222c14C8A640e30B039a1bbe890bDd4c0713CB;  
        ...
        // NICE!
        autoLiquidityReceiver = 0x1a35528893299E1736329ccb2493CC5F27Bd8170;
