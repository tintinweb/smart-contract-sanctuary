...
contract HellFire is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "HellFire";
    string private _symbol = "HellFire";
    ...
    uint256 private _maxWalletSize = (_tTotal * 40) / 1000000;
