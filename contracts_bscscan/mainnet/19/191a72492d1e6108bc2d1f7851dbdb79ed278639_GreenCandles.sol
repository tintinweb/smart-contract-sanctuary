...
contract GreenCandles is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GreenCandles Token";
    string constant _symbol = "GCT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(800); // 0.25%
