...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDF94Ecd5cF14827E4BD926048a51304cB615C9c4;
...
contract ElonR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFb33C145896AF717f4FAf165164F053D61c2C107;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ElonRoaring";
    string private _symbol = "ElonR";
