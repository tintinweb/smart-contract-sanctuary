...
/**
   ...
   #DELICIOUSPANCAKE
    ...
    I make this #DELICIOUSPANCAKE to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/DELICIOUSPANCAKE_BSC
...
contract DELICIOUSPANCAKE is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "DELICIOUS PANCAKE";
  string private _name = "DCAKE";
