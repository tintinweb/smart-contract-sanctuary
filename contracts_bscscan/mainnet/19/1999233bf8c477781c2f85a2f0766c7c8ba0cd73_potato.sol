...
contract potato is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Potato";
    string private _symbol = "Pot";
    ...
    uint256 public antiSnipingTime = 120 seconds; // can be set only once 
    bool public _tradingOpen = true; //once switched on, can never be switched off.
    ...
    uint256 public minBuy = 0.0000003 ether; // minimum buy is 0.03 Bnb by default can be change later
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        if (
            ...
            if (buyBackEnabled && initialBalance > uint256(buyBackLowerLimit)) {
                ...
                Utils.swapETHForTokens(address(pancakeRouter), burnAddress, initialBalance.div(10));
            }
