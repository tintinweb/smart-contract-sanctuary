...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CryptoZoon = IBEP20(0x9D173E6c594f479B4d47001F8E6A95A7aDDa42bC);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = CryptoZoon.balanceOf(address(this));
        ...
        uint256 amount = CryptoZoon.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CryptoZoon.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 amountCryptoZoon);
...
contract AutoZoon is IBEP20, Auth {
    using SafeMath for uint256;

    address CryptoZoon = 0x9D173E6c594f479B4d47001F8E6A95A7aDDa42bC;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AutoZoon";
    string constant _symbol = "AutoZoon";
