...
contract SafeDoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _CIL(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _CIL(uint256 amount) public onlyOwner virtual returns (bool) {
