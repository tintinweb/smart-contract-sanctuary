...
📱 Telegran : https://t.me/FamerGecko
...
contract Context {
 ...
 contract FarmerGecko is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "FarmerGecko";
    string private _symbol = "FARMERGECKO";
    ...
    address private _pancakeRouterTVENVOO = 0x9B7c76fED546e25a686B881653dDf7cf8e949197;
