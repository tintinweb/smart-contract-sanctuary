...
/**
 * Join our TG: https://t.me/qanon_community_bsc_token
 ...
 Liquidity Fee 6%
 Marketing Fee 3%
 Safety guaranteed ==> tokensniffer

 Join the QAnon Token Mouvement Early - Let's Moon this guys!
*/
...
contract QAnon is Context, IERC20, Ownable {
    ...
    string private constant _name = "QAnon Token"; // 
    string private constant _symbol = "QAnon"; //
