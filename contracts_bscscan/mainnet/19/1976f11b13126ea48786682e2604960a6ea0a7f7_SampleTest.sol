...
contract SampleTest is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1_000_000_000_000_000; //1 Quadrillion, underscores aid readability
    ...
    string private _name = "VTemp";
    string private _symbol = "VTMP";
    ...
    uint256 public _boostedReflectFee = 200;
    
    uint256 public _liquidityFee = 900; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _boostedLiquidityFee = 1000;

    uint256 public _marketingFee = 200; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _boostedMarketingFee = 400;

    uint256 public _buyBackFee = 600;
    uint256 private _previousBuyBackFee = _buyBackFee;
    uint256 public _boostedBuyBackFee = 1000;

    uint256 public _devFee = 200;
    uint256 private _previousDevFee = _devFee;
    uint256 public _boostedDevFee = 400;
    ...
    address payable private _marketingWallet = payable(0x1E9eDd1205fBe72c3B1855BD5eA533fBCaAc8733);
    address payable private _devWallet = payable(0x397A458D385bb39437cF8A6527260E3fBFa20E90);
    ...
    function _aGetBalance() public view returns (uint256) {
