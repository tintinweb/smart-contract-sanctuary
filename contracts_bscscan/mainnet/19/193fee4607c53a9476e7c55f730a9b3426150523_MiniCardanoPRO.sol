...
contract MiniCardanoPRO is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 1000000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal;

    string private _name = "Mini Cardano Pro";
    string private _symbol = "MiniADApro";
    ...
    uint256 public _maxTxAmount = 1000000000000000000000000 * 10**9;
