...
/*
TeleCrypt is a truly rug-proof community-driven project with a unique transaction fee structure focused on providing holders with safety and LP AutoLiquify methods. We are confident the price will rise rapidly as we grow!
...
contract heroInu is Context, IERC20, Ownable {
    ...
    string private _name = "TeleCrypt";
    string private _symbol = "TYLER";
