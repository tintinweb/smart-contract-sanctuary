...
contract Pokemoon is IBEP20, Ownable
{
    ...
    string private constant _name = "Pokemoon";
    string private constant _symbol = "Pokemoon";
    uint8 private constant _decimals = 8;
    uint256 public constant InitialSupply=  1000000000000000 * 10**_decimals;


    uint256 private constant DefaultLiquidityLockTime= 0;
    
    address public constant TeamWallet=0xE223eaeE557bfE032d1e70371214F0986e93e29e;
    address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = 3000000000000000 * 10**_decimals;
    uint256 public  sellLimit = 1000000000000000 * 10**_decimals;
    uint256 public  buyLimit = 3000000000000000 * 10**_decimals;
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function removeTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyOwner{
    ...
    function removeLimit(uint256 newBalanceLimit, uint256 newSellLimit, uint256 newBuyLimit) public onlyOwner{
