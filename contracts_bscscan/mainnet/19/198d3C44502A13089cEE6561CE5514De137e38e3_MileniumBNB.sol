...
/**
   #MileniumBNB
    ...
    I suggest a telegram group name for you to create: https://t.me/MileniumBNB
   ...
   I will renounce the ownership to burn addresses to transfer #MileniumBNB to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 49.5% total supply to the pool
   Can you make #MileniumBNB 10000000X? 
   ...
   it's the best part of the #MileniumBNB idea, increasing the liquidity pool automatically, 
...
contract MileniumBNB is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("MileniumBNB", "MileniumBNB") {
