...
contract Ownex is Context, IERC20, Ownable {
using SafeMath for uint256;
using Address for address;
address payable public marketingWalletAddress =
payable(0x25DE5F6bE141217e6B4724321EB7A09002226944); // Marketing Wallet Address
address payable public LiquidityWalletAddress =
payable(0x46e8726daF5e42C126f25B81FA86edc7cF2124B1); // Liquidity Wallet Address
address payable public CharityWalletAddress =
payable(0x82e7473DDAa87387EDdF6e26FBDBE18324594B26); // Charity Wallet Address
...
string private _name = "Ownex";
string private _symbol = "OWN";
uint8 private _decimals = 9;
uint256 public _burnFee = 0; //0% Burn
uint256 public _liquidityFee = 300; //2.5% Goes to Liquidity Wallet from every transaction
uint256 public _marketingFee = 300; //2.5% Goes to Marketing Wallet from everytransaction
