...
// CHANGE
contract DegensApe is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Degens Ape";
    string constant _symbol = "$DegensApe";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xCF22F83EbDA12FE2C3e04AdBF704D82E85567fFD);
