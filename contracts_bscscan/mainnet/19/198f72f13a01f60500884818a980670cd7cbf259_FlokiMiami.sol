...
| $$      | $$| $$  | $$| $$_  $$ | $$| $$\  $ | $$  | $$  | $$  | $$| $$\  $ | $$  | $$  
| $$      | $$|  $$$$$$/| $$ \  $$| $$| $$ \/  | $$ /$$$$$$| $$  | $$| $$ \/  | $$ /$$$$$$
|__/      |__/ \______/ |__/  \__/|__/|__/     |__/|______/|__/  |__/|__/     |__/|______/
...
// CHANGE
contract FlokiMiami is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiMiami";
    string constant _symbol = "MiamiFloki";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // 1% MAX 35,000,000
    uint256 public _maxWalletSize = (_totalSupply * 30) / 1000; // 3% MAX 35,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x0000000000000000000000000000000000000000);
