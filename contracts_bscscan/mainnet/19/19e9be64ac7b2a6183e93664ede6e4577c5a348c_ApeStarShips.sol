...
contract ApeStarShips is Context, IERC20, Ownable {
    ...
    string private _name = "Ape Starships";
    string private _symbol = "aSTARSHIPs";
    ...
    uint256 private minimumTokensBeforeSwap = 500000000; 
