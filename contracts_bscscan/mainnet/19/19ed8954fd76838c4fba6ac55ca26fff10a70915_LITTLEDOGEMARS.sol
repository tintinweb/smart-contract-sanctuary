...
contract LITTLEDOGEMARS is Context, IERC20, Ownable {
    ...
    string private _name = "LITTLE DOGE MARS";
    string private _symbol = "LITTLEDOGEMARS";
    ...
    uint256 public _buyLiquidityFee = 5; //MARKETING 3% + BUYBACK 2%
    
    uint256 public _sellTaxFee = 4; //TO HOLDER
    uint256 public _sellLiquidityFee = 6; //MARKETING 3% + BUYBACK 3%
