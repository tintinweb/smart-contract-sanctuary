...
The most anticipated launch; FRIP The long term project that returns the HODLers in XRP , The Ripple Rewards in FRIP are the highest on any coin till now on BSC.
FRIP has Huge Marketing and a Based Team working on it to assure us the MOON.
...
Website : FlaminXRP.com
Twitter : https://twitter.com/FlaminXRP
Telegram : https://t.me/FlaminXRPbsc
...
contract FlaminXRP is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlaminXRP";
    string constant _symbol = "FRIP";
