...
// 💎 Earn reward in BUSD and USDT
// 
//  8% - Earn BUSD 
//  8% - Earn USDT
// 
//  Telegram: https://t.me/EarnBUSDT
// 
// BUY IN PANCAKESWAP:
// https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x19bb3264f73aD43E751FC1B42D2320Be685B53fC
...
contract EarnBUSDT is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EarnBUSDT";
    string constant _symbol = "EarnBUSDT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 90000000; 
