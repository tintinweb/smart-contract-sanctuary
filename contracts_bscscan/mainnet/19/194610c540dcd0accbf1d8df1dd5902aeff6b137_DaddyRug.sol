...
contract DaddyRug is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "RUGME";
    ...
    event MaxWaleltCheckOnAccountEnabled(address account);
    event MaxWaleltCheckOnAccountDisabled(address account);
    ...
    function excludeAddressFromMaxWalletCheck(address account) external onlyOwner() {
        ...
        emit MaxWaleltCheckOnAccountEnabled(account);
    }
    ...
    function includeAddressFromMaxWalletCheck(address account) external onlyOwner() {
        ...
        emit MaxWaleltCheckOnAccountDisabled(account);
    }
