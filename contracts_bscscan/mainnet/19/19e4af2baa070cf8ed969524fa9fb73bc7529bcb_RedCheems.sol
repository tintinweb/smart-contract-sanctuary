...
• Sell tax = 15%
———————————————————-
🔗 : https://t.me/RedCheemsBSC
🐤 : https://twitter.com/RedCheemsBSC
🌐 :  redcheems.online
*/
...
contract RedCheems is IBEP20, Auth {
    ...
    address DEV  = 0x8040794B35815D3E8E73cFb073e02B6299E31bC3; // 35
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 200 / 10000;  // 3% max or 3M
