...
contract MetaUniCorn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaUniCorn";
    string constant _symbol = "MetaUniCorn";
    ...
    function MetaUniCornLaunchStatus(uint256 amount) external authorized {
        _maxTxAmount = amount;
	...
	function MetaUniCornSniperBan(address user, bool banned) external authorized {
		if (banned) {
    ...
    function MetaUniCornsetSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
