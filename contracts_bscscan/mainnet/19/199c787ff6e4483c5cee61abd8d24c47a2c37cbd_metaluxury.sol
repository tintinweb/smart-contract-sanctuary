...
/**
 *
  Telegram : https://t.me/metaluxury
  Website : https://metaluxury.finance/
*/
...
contract metaluxury is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Luxury";
    string private _symbol = "MLX";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xb38C53856cEad1ab369B8715A7BE281d90C3CCD5);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 100 * 10**9 * 10**_decimals;
