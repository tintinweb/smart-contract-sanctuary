...
FUCK SIMP MAN, HONEYPOTTED THE SHIT OUT OF US.
THE END OF PORN TOKEN.
LET'S MAKE IT ALL BACK.
@FUCKSIMPTOKEN
...
contract FUCKSIMPTOKEN is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "FUCKSIMPTOKEN";
    string constant _symbol = "FUCKSIMP";
