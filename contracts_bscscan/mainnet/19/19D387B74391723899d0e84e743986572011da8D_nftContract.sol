...
contract nftContract is ERC721Full, Whitelist {
    ...
    IERC20 tokenContract = IERC20(address(0x6d162679a01B0Fbdc7fe551beC713aA0D52bB89a));
...
;
    ...
    function mint1(
        ...
        if(isWhitelisted(msg.sender)){
            require(tokenContract.transferFrom(msg.sender,address(this),mint1PackPrice/2*10**18), 'Could not transfer tokens from your address to this contract');
            remove(msg.sender);
        }
        else{require(tokenContract.transferFrom(msg.sender,address(this),mint1PackPrice*10**18), 'Could not transfer tokens from your address to this contract');}
    ...
    function mint3(
        ...
        require(this.totalSupply() < maxSupply, "You cannot mint any more item since you already reached the maximum supply.");
        if(isWhitelisted(msg.sender)){
            require(tokenContract.transferFrom(msg.sender,address(this),mint3PackPrice/2*10**18), 'Could not transfer tokens from your address to this contract');
            remove(msg.sender);
        }
        else{require(tokenContract.transferFrom(msg.sender,address(this),mint3PackPrice*10**18), 'Could not transfer tokens from your address to this contract');}
        //require(msg.sender ==owner, "Only owner can of this contract can mint, you are trying to some fraud.");
    ...
    function mint5(
        ...
        require(tokenContract.transferFrom(msg.sender,address(this),mint5PackPrice*10**18), 'Could not transfer tokens from your address to this contract');
        if(isWhitelisted(msg.sender)){
            require(tokenContract.transferFrom(msg.sender,address(this),mint5PackPrice/2*10**18), 'Could not transfer tokens from your address to this contract');
            remove(msg.sender);
        }
        else{require(tokenContract.transferFrom(msg.sender,address(this),mint5PackPrice/2*10**18), 'Could not transfer tokens from your address to this contract');}
        //require(msg.sender ==owner, "Only owner can of this contract can mint, you are trying to some fraud.");
