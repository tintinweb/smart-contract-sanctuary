...
contract BNBSparkBUSD {
	...
	uint256[] public INVEST_MIN_AMOUNT = [10 ether, 5000 ether, 10000 ether, 25000 ether]; 
	uint256[] public INVEST_MAX_AMOUNT = [4999 ether, 9999 ether, 24999 ether, 50000 ether]; 
	...
	function invest(address referrer, uint8 plan , uint256 amount) public {
		...
		require(amount >= INVEST_MIN_AMOUNT[plan],"invalid min amount");
		require(amount <= INVEST_MAX_AMOUNT[plan],"invalid max amount");
