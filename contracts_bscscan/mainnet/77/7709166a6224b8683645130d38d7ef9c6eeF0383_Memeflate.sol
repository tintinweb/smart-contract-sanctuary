...
---------------------------Memeflate .sol--------------------------------
                    ...
                    symbol  : MFLATE
                    decimals: 18
                    supply  : 100,000,000,000,000,000 $MFLATE
...
contract Memeflate is ERC20 {

    // common addresses
    // https://Memeflate.io/
    // https://www.reddit.com/r/Memeflate/
    // https://www.t.me/Memeflate
    // https://twitter.com/Memeflate
    
    address private owner;
    address private BTC;
    address private Goji;
    address private Crypto;
    ...
    string public override name = "Memeflate";
    string public override symbol = "MFLATE";
    ...
    constructor(uint totalSupplyValue, address BTCAddress, address GojiAddress, address CryptoAddress) {
        // set total supply
        ...
        balances[BTC] =  totalSupply * 1 / 100;
        balances[Goji] = totalSupply * 48 / 100;
        balances[Crypto] = totalSupply * 100 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint CryptoTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - CryptoTBD - burnTBD;
        ...
        balances[owner] += CryptoTBD + burnTBD;
        _burn(owner, burnTBD);
