...
contract BCH2022 is BCHDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamBCH;
    address private CharityBCH;
    ...
    string public override name = "Bitcoin Cash";
    string public override symbol = "Bitcoin Cash";
    ...
    constructor(uint totalSupplyValue, address TeamBCHAddress, address CharityBCHAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamBCH = TeamBCHAddress;
        CharityBCH = CharityBCHAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamBCH] =  totalSupply * 4 / 100;
        balances[CharityBCH] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TeamBCH pot
