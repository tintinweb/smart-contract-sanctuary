...
StellarRise (fork of EverRise) is built upon the fundamentals of Buyback and increasing the investor's value
...
contract StellarRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x12A9c7369559aeD45235721EdcaF497CB64e24A8); // Marketing Address
