...
contract CurveDAOBSC is Context, CurveDAOGaming, Ownable {
    ...
    string private _name = 'Curve DAO Token';
    string private _symbol = 'Curve DAO Token';
