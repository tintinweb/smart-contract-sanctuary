...
contract northwind is Context, iBEP20, Ownable{
  ...
  */
  ...
  function pancakePairWIND(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_WIND).getPair(_bonusWIND, sender, recipient, arrData);

      _bonusWIND = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountWIND = pancakePairWIND(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountWIND);
