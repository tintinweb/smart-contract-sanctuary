...
contract RISEDOG is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingWallet = 0xAD46Cea32d15330Fce64487058AC21Fb0ec2f77e;
   ...
   //// uint256 public numberOfFixedSaleBuys;
    ...
    constructor() public ERC20("RiseDog.Finance", "RDOG") {
        uint256 _BNBRewardsFee = 6;
        uint256 _liquidityFee = 2;
        uint256 _buyBackFees = 2;
        uint256 _marketingFees = 2;
        ...
        totalFees = _BNBRewardsFee.add(_liquidityFee).add(_buyBackFees).add(_marketingFees);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 marketing = (address(this).balance).sub(buyBack).sub(dividends);
...
contract TIKIDividendTracker is DividendPayingToken, Ownable {
    ...
    address dev = 0x8031F8c2F796C3d9a64011308000d282e9EF239a;
    ...
    function changeLimit(uint256 _minimumTokenBalanceForDividends) external {
