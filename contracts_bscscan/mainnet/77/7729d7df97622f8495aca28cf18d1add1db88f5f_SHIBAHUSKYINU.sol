...
contract SHIBAHUSKYINU is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("SHIBAHUSKYINU ", "SHIBAHUSKYINU") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBAHUSKYINU";
    string private _symbol = "SHIBAHUSKYINU";
