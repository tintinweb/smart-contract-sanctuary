...
Welcome To SmokingEther,

Hold SmokingEther To Earn 8% ETH 

Join Us At https://t.me/SmokingEther
...
contract SmokingEther is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SmokingEtherDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("SmokingEther", "SETH") {
        _ETHRewardsFee = 8;
        _liquidityFee = 4;
		_marketingFee = 4;
        ...
        maxSellTransactionAmount = 2000000000 * (10**18);
        swapTokensAtAmount = 20000000 * (10**18);
        _maxWalletToken = 5000000000 * (10**18); // 5% of total supply


    	dividendTracker = new SmokingEtherDividendTracker();
    	antiBotEnabled = true;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "SmokingEther: The dividend tracker already has that address");

        SmokingEtherDividendTracker newDividendTracker = SmokingEtherDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "SmokingEther: The new dividend tracker must be owned by the SmokingEther token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SmokingEther: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SmokingEther: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SmokingEther: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SmokingEther: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SmokingEther: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "SmokingEther: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "SmokingEther: Cannot update gasForProcessing to same value");
...
contract SmokingEtherDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("SmokingEtherDividend_Tracker", "SmokingEther_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "SmokingEther_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "SmokingEther_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SmokingEther contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "SmokingEther_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SmokingEther_Dividend_Tracker: Cannot update claimWait to same value");
