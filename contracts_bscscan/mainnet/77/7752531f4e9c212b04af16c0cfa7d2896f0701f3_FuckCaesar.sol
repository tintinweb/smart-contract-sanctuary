...
// https://t.me/fuckcaesarlol
// 0% buy, 10% sell all to liquidity to make the price floor more fair for later investors
// 2% max wallet
...
contract FuckCaesar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FuckCaesar";
    string private _symbol = "FuckCaesar";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x80F4740bF46C1fCa57980d88A0F435221d33CAC2); // Marketing Address
    address payable public BuybackWalletAddress = payable(0x80F4740bF46C1fCa57980d88A0F435221d33CAC2); // Buyback Wallet Address
