...
// ooooo     ooo ooooooooo.   oooooooooooo oooo    oooo       .o.       
// `888'     `8' `888   `Y88. `888'     `8 `888   .8P'       .888.      
//  888       8   888   .d88'  888          888  d8'        .8"888.     
//  888       8   888ooo88P'   888oooo8     88888[         .8' `888.    
//  888       8   888`88b.     888    "     888`88b.      .88ooo8888.   
//  `88.    .8'   888  `88b.   888       o  888  `88b.   .8'     `888.  
//    `YbodP'    o888o  o888o o888ooooood8 o888o  o888o o88o     o8888o 
//
//
// Visit us at: https://ureka.finance
// Join us on Telegram: https://t.me/urekafinance
// Tweet us: https://twitter.com/urekafinance
...
contract UrekaTreasury is Ownable {
    ...
    uint public _prevTotalReserves;
    ...
    function deposit( uint _amount, address _token, uint _profit ) external returns ( uint send_ ) {
        require( isReserveToken[ _token ] || isLiquidityToken[ _token ], "Treasury Deposit, Not accepted" );
        IERC20( _token ).safeTransferFrom( msg.sender, address(this), _amount );

        if ( isReserveToken[ _token ] ) {
            require( isReserveDepositor[ msg.sender ], "Treasury Deposit, Not approved" );
        } else {
            require( isLiquidityDepositor[ msg.sender ], "Treasury Deposit, Not approved" );
        }
    ...
    function withdraw( uint _amount, address _token ) external {
        require( isReserveToken[ _token ], "withdraw, Not accepted" ); // Only reserves can be used for redemptions
        require( isReserveSpender[ msg.sender ] == true, "withdraw, Not approved" );
    ...
    function incurDebt( uint _amount, address _token ) external {
        require( isDebtor[ msg.sender ], "incurDebt, Not approved" );
        require( isReserveToken[ _token ], "incurDebt, Not accepted" );
    ...
    function repayDebtWithReserve( uint _amount, address _token ) external {
        require( isDebtor[ msg.sender ], "repayDebtWithReserve, Not approved" );
        require( isReserveToken[ _token ], "repayDebtWithReserve, Not accepted" );
    ...
    function repayDebtWithOHM( uint _amount ) external {
        require( isDebtor[ msg.sender ], "repayDebtWithOHM, Not approved" );
    ...
    function manage( address _token, uint _amount ) external {
        if( isLiquidityToken[ _token ] ) {
            require( isLiquidityManager[ msg.sender ], "Manage, Not approved" );
        } else {
            require( isReserveManager[ msg.sender ], "Manage, Not approved" );
        }

        uint value = valueOf(_token, _amount);
        require( value <= excessReserves(), "Manage, Insufficient reserves" );
    ...
    function mintRewards( address _recipient, uint _amount ) external {
        require( isRewardManager[ msg.sender ], "Cannot Mint Rewards, Not Approved" );
        require( _amount <= excessReserves(), "Cannot Mint Rewards, Insufficient Reserves" );
    ...
    function excessReserves() public view returns ( uint ) {
        uint excessSupply = IERC20( OHM ).totalSupply().sub(10000000000000000);

        return totalReserves.sub( excessSupply.sub( totalDebt ) );
    }
