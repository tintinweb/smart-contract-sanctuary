...
contract RoboDogeStakingNft is ERC721URIStorage, Ownable {
    ...
    constructor(
        ...
        staking = RoboDogeStaking(_staking);
    ...
    function removeFromCollection(Tier _tier, uint256 _index) external onlyOwner {
    ...
    function claimNFT(uint256 _stakeId) external {
        ...
        uint256 itemId = uint256(keccak256(abi.encodePacked(block.timestamp, _stakeId, msg.sender))) % tierCollection[tier].length;
