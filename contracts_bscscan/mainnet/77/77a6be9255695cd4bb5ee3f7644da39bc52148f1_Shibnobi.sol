...
contract Shibnobi is ShibaDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamShiba;
    address private CharityShiba;
    ...
    constructor(uint totalSupplyValue, address TeamShibaAddress, address CharityShibaAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamShiba = TeamShibaAddress;
        CharityShiba = CharityShibaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamShiba] =  totalSupply * 4 / 100;
        balances[CharityShiba] = totalSupply * 25 / 100;
    ...
    // Get the address of the token's TeamShiba pot
