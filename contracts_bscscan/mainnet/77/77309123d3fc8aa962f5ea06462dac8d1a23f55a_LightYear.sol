...
/*LightYear is a burnable, rewardable and deflationary token
    
Main features are :
    
1) 1% tax is collected and distributed to holders for HODLing
2) 1% charity tax is collected and sent to charity wallet to finance a real space trip for an HOLDER
