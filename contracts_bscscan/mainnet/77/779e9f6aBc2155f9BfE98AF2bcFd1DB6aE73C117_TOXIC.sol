...
Official Telegram - https://t.me/tokentoxic
...
import "./TOXICDividendTracker.sol";
...
contract TOXIC is ERC20, Ownable {
    ...
    TOXICDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Token Toxic", "TOXIC") {

    	dividendTracker = new TOXICDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "TOXIC: The dividend tracker already has that address");

        TOXICDividendTracker newDividendTracker = TOXICDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "TOXIC: The new dividend tracker must be owned by the Token Toxic contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TOXIC: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TOXIC: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TOXIC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TOXIC: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TOXIC: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TOXIC: Cannot update gasForProcessing to same value");
