...
contract CatWoman is Context, IERC20, Ownable {
    ...
    string private constant _name = "CatWoman";
    string private constant _symbol = "CW";
    ...
    constructor() {
        address newOwner = address(0x309801D1c876AD9daf65D7E8557bC9b9d996E0BB); // 0x309801D1c876AD9daf65D7E8557bC9b9d996E0BB
        ...
        marketingAddress1 = payable(0xAaB015D09332e4D731E1d798EaF5Cbb9470AC333); // Marketing 1 Address
        marketingAddress2 = payable(0x1837122d7c701CFA7AB49A67b51f3a096fEf7CC2); // Marketing 2 Address
        marketingAddress3 = payable(0x3D5726f19E7ac74f8e9AF90a5148BC51eC887BCC); // Marketing 3 Address 
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(marketingAddress1).call{value: ethForMarketing / 3}("");
        (success,) = address(marketingAddress2).call{value: ethForMarketing / 3}("");
        (success,) = address(marketingAddress3).call{value: ethForMarketing / 3}("");
    }
    ...
    function setMarketingAddress1(address _marketingAddress) external onlyOwner {
        require(_marketingAddress != address(0), "_marketingAddress address cannot be 0");
        _isExcludedFromFee[marketingAddress1] = false;
        marketingAddress1 = payable(_marketingAddress);
        _isExcludedFromFee[marketingAddress1] = true;
        emit UpdatedMarketingAddress(_marketingAddress);
    }

    function setMarketingAddress2(address _marketingAddress) external onlyOwner {
        require(_marketingAddress != address(0), "_marketingAddress address cannot be 0");
        _isExcludedFromFee[marketingAddress2] = false;
        marketingAddress2 = payable(_marketingAddress);
        _isExcludedFromFee[marketingAddress2] = true;
        emit UpdatedMarketingAddress(_marketingAddress);
    }

    function setMarketingAddress3(address _marketingAddress) external onlyOwner {
        require(_marketingAddress != address(0), "_marketingAddress address cannot be 0");
        _isExcludedFromFee[marketingAddress3] = false;
        marketingAddress3 = payable(_marketingAddress);
        _isExcludedFromFee[marketingAddress3] = true;
        emit UpdatedMarketingAddress(_marketingAddress);
    }
