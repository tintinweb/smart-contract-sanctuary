...
// 
//
// 📱 Telegram:https://t.me/floki22bsc
// 🌎 Website:www.floki22.net
// 🌐 Twitter: https://twitter.com/floki22bsc
// 
//
/**
...
contract Floki22 is ERC20, Ownable, Shared {
   ...
   address public marketingWalletAddress = 0x96dD2F8A8Aa814faB068AC940B09F81E7510307C;
   address public devWalletAddress = 0x78319f16a8130C565c30Fc3359048aF3F8c40A13;
   address public buybackWallet = 0xd592849d7EC2C1dE11B903A66eAdD4F455591094;
   ...
   constructor() ERC20("Floki22", "$FLOKI22") {
       ...
       */
       _mint(owner(), 1_000_000_000 * 10**18);
        maxTxAmount = totalSupply() / 250; // 0.5%
   ...
   function updateUniswapV2Router(address newAddress) public onlyOwner {
       require(newAddress != address(uniswapV2Router), "Floki22: The router already has that address");
   ...
   function setMarketingWallet(address payable wallet) external onlyOwner{
       require(marketingWalletAddress != address(0), "Floki22: Can't set marketing wallet to the zero address");
       marketingWalletAddress = wallet;
   }
  
   function setDevWallet(address payable wallet) external onlyOwner{
       require(devWalletAddress != address(0), "Floki22: Can't set developer wallet to the zero address");
       devWalletAddress = wallet;
   }
  
    function setbuybackWallet(address payable wallet) external onlyOwner{
       require(buybackWallet != address(0), "Floki22: Can't set buyback wallet to the zero address");
       devWalletAddress = wallet;
   }
   ...
   function setMaxTxPermille(uint256 maxTxPermille) external onlyOwner {
       require (maxTxPermille > 0, "Floki22: Can't set max Tx to 0");
   ...
   function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
       require(pair != uniswapV2Pair, "Floki22: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
   ...
   function _setAutomatedMarketMakerPair(address pair, bool value) private {
       require(automatedMarketMakerPairs[pair] != value, "Floki22: Automated market maker pair is already set to that value");
   ...
   function _transfer(
       ...
       require (tradingOpened || isExcludedFromFees[from], "Floki22: Trading paused");
       require(from != address(0), "ERC20: transfer from the zero address");
       require(to != address(0), "ERC20: transfer to the zero address");
       require(isBlacklistedUntil[from] < block.timestamp && isBlacklistedUntil[to] < block.timestamp, "Floki22: Blacklisted address");
       ...
       uint256 totalFees = liquidityFee + marketingFee + devFee + buybackFee;
       ...
       if( canSwap &&
           ...
           swapAndSendToFee(buybackTokens, buybackWallet);
