...
*** Telegram =https://t.me/BabySquidMooon
...
contract BabySquidMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x7E4597De842d3Da041cE6AC855758933096325BA); // Marketing Address
        
    address payable public teamAddress =
        payable(0x0E5Fba8a3Bf2D5989b46399A6944C44BD12c6d2D); // Team Address
        
    address payable public liquidityAddress =
        payable(0x32Cbb55d170559B94fD5B84E99d887d392a61D84); // Liquidity Address
    ...
    uint256 public maxBuyAmount = _tTotal.mul(8).div(100);
    uint256 public maxSellAmount = _tTotal.mul(4).div(100);

    bool public limitsInEffect = false;
    
    string private constant _name = "BabySquidMoon";
