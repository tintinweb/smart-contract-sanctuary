...
contract BabyFistDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyFistDoge";
    string private _symbol = "BabyFistDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4d709F38ca62f4bd580A807CADe932BA6A3B4BFf);
    address payable public teamWalletAddress = payable(0x4d709F38ca62f4bd580A807CADe932BA6A3B4BFf);
	address public OwnerAddress =0x4d709F38ca62f4bd580A807CADe932BA6A3B4BFf;
