...
// $ELFCHEEMS proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN $ELFCHEEMS With the auto-claim feature,
// simply hold $ELFCHEEMS and you'll receive Reflections automatically in your wallet.
// 
// Hold ElfCheems and get rewarded in $ELFCHEEMS on every transaction!
//
//
// 📱 Telegram: https://t.me/ElfCheems
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0BA6b52FA8C4C78861F7DF33c6ad5e6799D4D7cC;
...
contract ELFCHEEMS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD0AFD630dE96D2CF4f496Da0AE1ee10EF68c2525;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ElfCheems";
    string private _symbol = "ELFCHEEMS";
