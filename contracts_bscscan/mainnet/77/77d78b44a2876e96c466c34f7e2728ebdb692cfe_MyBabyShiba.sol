...
/**
    ...
    My Baby Shiba Token - 0% Fee Token Like Mini Fellas
    Twitter : twitter.com/mybabyshibaBSC
    Web : http://www.mybabyshiba.space
    Tg : t.me/mybabyshibabsc
...
contract MyBabyShiba is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "My Baby Shiba";
    string private constant _symbol   = "$MyBabyShiba";
