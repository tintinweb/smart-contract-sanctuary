...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    /*
    * {_maxTotalSupply} Limit supply to 50 billion.
    */
    uint256 private _maxTotalSupply = 500000000000000000000;
    
    /*
    * {_burnRate} Tax: 1% of tax for social causes
    * {_walletSocialCauses} Wallet social causes
    * 0x65C686F949fA493F9B42E344d7EaEfaA2660C5af
    */
    uint private _burnRate = 1;
    address private _walletSocialCauses = 0x65C686F949fA493F9B42E344d7EaEfaA2660C5af;
    ...
    function _transfer(
        ...
        uint valueToBurn = (amount * _burnRate / 100);
        
        _balances[recipient] += amount - valueToBurn;
        
        _balances[_walletSocialCauses] += valueToBurn;
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(_totalSupply <= _maxTotalSupply, "ERC20: this value exceeds the total limit");
...
contract LGBTToken is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("LGBT Token", "LGBT") ERC20Permit("LGBT Token") {}
