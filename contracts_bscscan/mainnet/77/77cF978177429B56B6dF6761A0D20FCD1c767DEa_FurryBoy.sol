...
contract FurryBoy is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'FurryBoy';
    ...
    address public TeamWallet=payable(0xF996C4786b1676b885cdb00b844202ffC23b077A);
    address walletTwo=payable(0x64E0764A0B83736745D12fA462c49069a4fe0Df6);
    //TestNet
    ...
    constructor () {
        ...
        _stakingTax=80;
         ...
         //excludes Pancake Router, pair, contract and burn address from taxes
