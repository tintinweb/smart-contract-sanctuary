...
contract Green_Shiba is Context, IERC20, Ownable {
    ...
    string private _name = "Green Shiba";
    string private _symbol = "GRSHIBA";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x73ae44625ad0dE7101944049807168d0B4259114);
    address public marketingWalletToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //reward bnb
