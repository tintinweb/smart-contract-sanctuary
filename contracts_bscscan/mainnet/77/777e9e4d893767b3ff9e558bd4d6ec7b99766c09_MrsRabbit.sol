...
🔥 FAIRLAUNCH | 📆 August 21 |⏱15.30 UTC

🎖 DOUBLE REWARD BNB & MRS 💕

💘Website : mrsrabbit.finance
💘Telegram: @mrsrabbit_token
...
contract MrsRabbit is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x039a958AefE7D451cefA6c36738eF9900984c23d); // Marketing Address
    ...
    string private _name = "MrsRabbit";
    ...
    uint256 private _pajekFee = 1;
    uint256 private _previouspajekFee = _pajekFee;
    
    uint256 private _lpPajek = 12;
    ...
    uint256 private _mentokanJumlah = 3 * 10**6 * 10**9;
    uint256 private minTknBfrSwp= 2 * 10**6 * 10**9; 
