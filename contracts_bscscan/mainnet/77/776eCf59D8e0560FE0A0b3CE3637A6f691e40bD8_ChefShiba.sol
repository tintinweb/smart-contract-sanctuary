...
Telegram: https://t.me/ChefShiba

Twitter: https://twitter.com/Chef_Shiba

Website: https://chefshiba.net
...
contract Context {
 ...
 contract ChefShiba is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "Chefshiba";
    ...
    address private _NormalOwnership = 0x173Bd5e38fFa1B0ac8d99c214aD8CC6476fcb560;
