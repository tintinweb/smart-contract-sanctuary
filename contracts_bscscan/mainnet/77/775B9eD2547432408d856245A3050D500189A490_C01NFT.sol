...
contract C01NFT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "C-01";
    string constant _symbol = "C-01";
    ...
    uint256 public swapThreshold = _totalSupply * 400 / 100000; // 0.01% of supply
    bool inSwap;
