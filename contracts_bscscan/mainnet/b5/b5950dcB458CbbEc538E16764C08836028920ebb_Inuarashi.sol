...
contract Inuarashi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x223657FFe321F7D75a910D9C3976166cf0689A58); // Marketing Address
        
    address payable public teamAddress =
        payable(0xbb18cFb86aF4FDCF9B627F940AfE572437220081); // Team Address
        
    address payable public liquidityAddress =
        payable(0x6F07e0de4943816dE463bdd0e426D1a89EFf4667); // Liquidity Address
    ...
    string private constant _name = "Inuarashi";
    string private constant _symbol = "Inuarashi";
