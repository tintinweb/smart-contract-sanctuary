...
// File: contracts/interfaces/IBnbLottery.sol

pragma solidity ^0.8.4;

interface IBnbLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in BNB per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in BNB token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInBnb: price of a ticket in BNB
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Bnb lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == bnbLottery, "Only BnbLottery");
    ...
    /**
     * @notice Set the address for the BnbLottery
     * @param _bnbLottery: address of the Bnb lottery
     */
    function setLotteryAddress(address _bnbLottery) external onlyOwner {
        bnbLottery = _bnbLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBnbLottery(bnbLottery).viewCurrentLotteryId();
    }
}