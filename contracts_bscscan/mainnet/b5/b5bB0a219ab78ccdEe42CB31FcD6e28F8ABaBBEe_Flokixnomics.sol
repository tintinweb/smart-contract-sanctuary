...
contract Flokixnomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Flokixnomics";
    string constant _symbol = "FLOKIXN";
    ...
    // Anti-Bot v2
    uint256 public maxRoomRent = 4000000000;
