...
/**
 * TG: https://t.me/CrazyGoblinAVAX
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * CrazyGoblinAVAX gathers CrazyGoblinAVAX and delivers direct to your wallet!!!!
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x1CE0c2827e2eF14D5C4f29a091d735A204794041); //the reward token you want distributed 
...
contract CrazyGoblinAVAX is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x1CE0c2827e2eF14D5C4f29a091d735A204794041; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CrazyGoblinAVAX";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "GoblinAVAX";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x4110C6A3472dc4B335dbC55c622e022993B1b7B0;
