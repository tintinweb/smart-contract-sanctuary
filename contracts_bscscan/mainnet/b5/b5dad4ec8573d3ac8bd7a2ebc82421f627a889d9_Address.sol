...
contract LittleAngryBunny is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Little Angry Bunny v3";
    string private _symbol = "LAB v3";
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xe2894e8D69C4AAd7721EAcd87799575973CF2953); // binance PANCAKE V2
