...
contract FirstGoldDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FirstGoldDoge";
    string private _symbol = "FirstGoldDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x98128f829DEde31153c2aCb4d0F59CF8095c5e6a); // Marketing Address
    address payable public teamWalletAddress = payable(0x71F42B1BC5aE541b2E98DD6d4739a308402643e6); // Team Address
