...
/**
 ...
 Telegram https://t.me/AlphaToken2k22
...
/* Token contract */
contract AlphaToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x9bcA5299C55aA0a840604eE1776d587BBdFA1c7b;
    ...
    // Name and symbol
    string constant _name = "AlphaToken";
    string constant _symbol = "ATH";
    uint8 constant _decimals = 9;

    // Total supply
    uint256 _totalSupply = 100000 * 10**15 * 10**_decimals;

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 4 / 100; // 4%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x04A6b4d89cA0b823B303248999C2B3559E221a22;
