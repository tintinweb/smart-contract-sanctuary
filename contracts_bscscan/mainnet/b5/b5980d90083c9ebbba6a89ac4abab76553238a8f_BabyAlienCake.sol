...
import "./BabyAlienCake-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyAlienCake` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyAlienCake(Env.Testnet)` or `BabyAlienCake(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyAlienCake";
     ...
     */
    address internal tipToTheDev =0xF2d76A2A093185e5F0c040D44298636D1958667f;
...
contract BabyAlienCake is SafeToken{
