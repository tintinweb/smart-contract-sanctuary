...
contract MusK_must_go is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x3564Cf53874982c6c0861D44Fa65E46C0aa31447); // Marketing Address

    address payable public teamAddress =
        payable(0x3564Cf53874982c6c0861D44Fa65E46C0aa31447); // Team Address

    address payable public liquidityAddress =
        payable(0x3564Cf53874982c6c0861D44Fa65E46C0aa31447); // Liquidity Address
    ...
    string private constant _name = "Musk_must_go";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 40 / 1000; // 3% maxWalletToken
