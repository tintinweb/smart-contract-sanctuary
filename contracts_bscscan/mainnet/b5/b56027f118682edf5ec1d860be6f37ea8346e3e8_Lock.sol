...
contract Lock is ReentrancyGuard {
    ...
    function lockTokens(
        ...
        require(block.timestamp < _endDate, "endDate should be bigger than now");
        ...
        pool = LockInfo(block.timestamp, _endDate, _amount, _tokenAddress, msg.sender);
        poolCount = 1;
    }
    ...
    function getTokens() external onlyManager nonReentrant {
        require(block.timestamp > pool.endDate);
