...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x335CcFdbaD17F391AE4F86Bb406ef86372614bA1;
...
contract TiBearToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb4de4A8f2c093Da7CF250f9cfC9938dd69011F4A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TiBearToken";
    string private _symbol = "TiBear";
