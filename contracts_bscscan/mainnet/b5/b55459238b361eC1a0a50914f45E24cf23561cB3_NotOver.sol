...
NOTOVER TOKEN - For the love to crypto, internet and new technologies

 Let's show them, this is not over yet !!! Cryptocurrency for life !!!

Telegram https://t.me/notovertoken
...
contract NotOver is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NotOver";
    string private _symbol = "NOVER";
