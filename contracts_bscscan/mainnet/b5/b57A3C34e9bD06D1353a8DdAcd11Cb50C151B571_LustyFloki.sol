...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 nativeToken = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
...
contract LustyFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LustyFloki ";
    string constant _symbol = "LFLOKI";
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        if (launchedAt + 10 >= block.number){
               require(amount <= _maxTxAmount.div(10) || isTxLimitExempt[sender], "TX Limit Exceeded");
           }
        else{
    ...
    function forceSwap() external authorized {
        swapBack(msg.sender);
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _sellFactor, uint256 _sellFee, uint256 _feeDenominator) external authorized {
