...
/*
//
BABYMINICAKE is the new Binance Smart Chain (BSC) 
token which rewards holders on every transaction.
...
contract BABYMINICAKE is Context, IERC20, Ownable {
    ...
    string private _name = "BABYMINICAKE";
    string private _symbol = "BABYMINICAKE";
    ...
    uint256 public _Maxperwallet = _tTotal*3/100;
    ...
    address _marketingWallet = 0x9Dee8F5801FF9315FBbC2E4Ce1c40413Ea9989E3;
