...
/*
METASCORE
Rug Pull Meta Scanner
The most advanced
tool to invest in
DeFi Safely.
For crypto investors who want to secure their investments, 
discover safe projects, minimize their risks and avoid DeFi scams
BVB P2P TAPROOT 
*/
...
interface ScoreSafe {
  ...
  /**
   * @dev ScoreOwn `amount` tokens from the caller's account to `recipient`.
   *
  ...
  /**
   * @dev ScoreOwn `amount` tokens from `sender` to `recipient` using the
...
contract MetaScore is ScoreSafe, Context, ScoreOwn  {
  
    // common addresses
    address public _owner;
    address public TeamCritic;
    address public AppCritic;
    ...
    string public override name = "MetaScore";
    string public override symbol = "MetaScore";
    ...
    constructor(uint totalSupplyValue, address TeamCriticAddress, address AppCriticAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamCritic = TeamCriticAddress;
        AppCritic = AppCriticAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamCritic] =  totalSupply * 45 / 100;
        balances[AppCritic] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's ScoreOwn pot
