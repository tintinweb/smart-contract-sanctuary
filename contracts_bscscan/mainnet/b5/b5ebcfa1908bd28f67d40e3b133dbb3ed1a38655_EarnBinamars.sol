...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BINAMARS = IBEP20(0x46880afc2E6FA41bBbE9787c082f7c23F795465E);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BINAMARS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BINAMARS);
        ...
        uint256 amount = BINAMARS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BINAMARS.transfer(shareholder, amount);
...
contract EarnBinamars is IBEP20, Auth {
    using SafeMath for uint256;

    address BINAMARS = 0x46880afc2E6FA41bBbE9787c082f7c23F795465E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Earn Binamars";
    string constant _symbol = "EBMARS";
