...
Official Telegram group : https://t.me/mysterycrazyTOKEN
...
import "./cFlokiDividendTracker.sol";

contract cFloki is ERC20, Ownable {
    ...
    cFlokiDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Crazy Floki", "cFloki") {

    	dividendTracker = new cFlokiDividendTracker();

        _marketingWalletAddress = 0x3d09d79A92bFC6237f03D1D1e1934C036b9cFf62;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "cFloki: The dividend tracker already has that address");

        cFlokiDividendTracker newDividendTracker = cFlokiDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "cFloki: The new dividend tracker must be owned by the cFloki token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "cFloki: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "cFloki: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "cFloki: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "cFloki: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "cFloki: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "cFloki: Cannot update gasForProcessing to same value");
