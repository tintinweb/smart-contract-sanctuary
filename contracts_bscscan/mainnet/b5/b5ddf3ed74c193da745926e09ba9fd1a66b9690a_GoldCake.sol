...
//
// GoldCake proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN Cake tokens! With the auto-claim feature,
// simply hold GoldCake and you'll receive cake! coins automatically in your wallet.
// 
// Hold GoldenCake and get rewarded in  cakes on every transaction!
//
//
// 📱 Telegram: https://t.me/GoldCakeBSC
// 
// 
//
...
contract GoldCake is ERC20, Ownable {
    ...
    uint256 public BAKERewardsFee = 22;
    ...
    address public _marketingWalletAddress = 0x72301a54E1f988b872af3F6292F6c838dDDc085C;
    address public _teamWalletAddress = 0x72301a54E1f988b872af3F6292F6c838dDDc085C;
    ...
    constructor() public ERC20("GoldCake", "GoldCake") {
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        require(value >= 2000000000 * (10**18), "GoldCake: Minimum max wallet limit is 2 percent");
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this) &&
            ...
            require(contractBalanceRecipient + amount <= _maxWalletLimit, "GoldCake: Exceeds maximum wallet token amount");
        }
...
contract BABYBAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address token) public DividendPayingToken("GoldCake_Dividen_Tracker", "GoldCake_Dividend_Tracker",token) {
    	claimWait = 3600;
