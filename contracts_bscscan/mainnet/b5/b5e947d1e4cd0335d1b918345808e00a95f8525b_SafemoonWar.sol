...
contract SafemoonWar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SafemoonWar";
    string private _symbol = "SafemoonWar";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x964072bD2d3dDc57B742CD073ed9bD26915bc286); // Marketing Address
    address payable public ProjectWalletAddress = payable(0x964072bD2d3dDc57B742CD073ed9bD26915bc286); // Project Wallet Address
    ...
    uint256 public _maxTxAmount = 100000000000000 * 10**9; // 2%
