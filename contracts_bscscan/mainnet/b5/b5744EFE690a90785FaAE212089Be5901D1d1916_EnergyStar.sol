...
EnergyStar The simple choice for saving energy.
...
EPA ensures that each product that earns the label is independently certified to deliver the efficiency performance and savings that consumers have come to expect. 
It’s that integrity that led Americans to purchase more than 300 million ENERGY STAR certified products in 2019 and more than 300 million ENERGY STAR certified light bulbs, with a market value of more than $100 billion. 
In fact, an average of 800,000 ENERGY STAR certified products was sold every day in 2019, bringing the total to more than 7 billion products sold since 1992
...
contract          EnergyStar                                                             is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Energy Star", "ESTAR") {
