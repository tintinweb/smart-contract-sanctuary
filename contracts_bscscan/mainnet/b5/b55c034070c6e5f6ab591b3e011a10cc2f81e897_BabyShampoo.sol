...
/*
    ...
    Taxes:
    - 2% marketing and team
    - 2% burn
    - 5% holders

    - comment info
    - Shampoo contarct verefied 
*/
...
contract BabyShampoo is Context, ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Baby Shampoo";
    string private _symbol = "BabyShampoo";
