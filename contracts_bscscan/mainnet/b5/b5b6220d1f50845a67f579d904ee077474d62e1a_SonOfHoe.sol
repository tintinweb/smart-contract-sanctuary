...
SonOfBitch  @Sonofhoe join in the tg! Stealth launching in a minutes!
...
contract SonOfHoe is IBEP20, Auth {
    ...
    string constant _name = "SonOfHoe";
    string constant _symbol = "SOH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100;  //1% max wallett
    ...
    address private marketingFeeReceiver = 0x72a2e51C84f86E694E4159FBeE934984a134db9a;
    address private developmentFeeReceiver = 0x1c0317e7FB7c04d18ED63fC20D1DA745837c0246;
