...
contract Bonked_Mole is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xaE615B8B3b9aB2e1322C25EdB31799a2AbdFF326); 
    ...
    string private _name = "Bonked Mole";
    ...
    uint256 public _maxTxAmount = 20 * 10**6 * 10**9; // 20 Million, or 100% of total supply
