...
abstract contract TimedCrowdsale is Crowdsale {
    ...
    constructor () {
        ...
        closingTime = block.timestamp+3600*24*3;
    }
...
contract PublicPresale is Crowdsale, TimedCrowdsale
{
    ...
    uint public allocationCap = 500*1e18;
    uint public hardCap = 10000*1e18;

    // token 0x0083a5a7e25e0Ee5b94685091eb8d0A32DfF11D4
    // busd 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    constructor()
    Crowdsale(1,100*1e9, address(this), IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56), IERC20(0x0083a5a7e25e0Ee5b94685091eb8d0A32DfF11D4))  
    {
