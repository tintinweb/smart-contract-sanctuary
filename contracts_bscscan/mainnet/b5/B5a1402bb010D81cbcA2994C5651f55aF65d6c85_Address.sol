...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Shibmas";
    string private _symbol = "$SBM";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x0900682a829622C61AE94EAA87Dd0E3d7D818563); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x0900682a829622C61AE94EAA87Dd0E3d7D818563); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 0; //5 * 10**6 * 10**9;
