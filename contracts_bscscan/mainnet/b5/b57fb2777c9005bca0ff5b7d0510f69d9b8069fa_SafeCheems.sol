...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 MATIC = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71); //the reward token you want distributed
...
contract SafeCheems is IBEP20, Auth {
   using SafeMath for uint256;
 
   address MATIC = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71; //Input the token address of whatever your reward is. leave 431,432,433 as is.
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "SafeCheems";
   string constant _symbol = "ATM";
   uint8 constant _decimals = 4;
 
   uint256 _totalSupply = 1 * 1000000000000000 * (1 ** _decimals);
