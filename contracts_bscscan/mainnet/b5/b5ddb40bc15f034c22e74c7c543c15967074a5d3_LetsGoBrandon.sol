...
/  |                  /  |              /      \           /       \                                    /  |                    
$$ |        ______   _$$ |_    _______ /$$$$$$  |  ______  $$$$$$$  |  ______   ______   _______    ____$$ |  ______   _______  
$$ |       /      \ / $$   |  /       |$$ | _$$/  /      \ $$ |__$$ | /      \ /      \ /       \  /    $$ | /      \ /       \ 
$$ |      /$$$$$$  |$$$$$$/  /$$$$$$$/ $$ |/    |/$$$$$$  |$$    $$< /$$$$$$  |$$$$$$  |$$$$$$$  |/$$$$$$$ |/$$$$$$  |$$$$$$$  |
$$ |      $$    $$ |  $$ | __$$      \ $$ |$$$$ |$$ |  $$ |$$$$$$$  |$$ |  $$/ /    $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |
...
www.letsgobrandon.capital
https://t.me/LetsGoBrandonCapital
...
//Contract
contract LetsGoBrandon is IBEP20, Ownable {
    ...
    string private constant _name = 'LetsGoBrandon';  
    string private constant _symbol = '#LGB';    
    ...
    uint8 private constant MaxWalletDivider=50; //2% = 2,000,000,000,000
    uint16 private constant SellLimitDivider=50; //2% = 2,000,000,000,000
    uint8 public constant MaxTax=10;        //This is the max tax that can be set by a user - prevents honeypot
    ...
    address public AntiMandate=0x000000000000000000000000000000000000dEaD;  //address used for burns
    ...
    address public MainReward=0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;   // BNB Rewards
...
//constructor
    constructor () {
        ...
        //starting bot tax distribution. By default, 80% of tax from bots go to liquidity
        _buyBackTax=0;
        _devTax=10;
        _burnTax=10;
        _marketingTax=0;
        ...
        _excludedFromStaking.add(AntiMandate);
...
//claims
    ...
    function BreadLineReward() public {
...
//transfers
    ...
    //burning can be done via direct transfer to AntiMandate. Burn function gives transparency
    function BurnTokens (uint256 amount) public{
        ...
        _addToken(AntiMandate, convertedAmount);
        _circulatingSupply-=convertedAmount;
        emit Transfer(msg.sender,AntiMandate,convertedAmount);
    }
