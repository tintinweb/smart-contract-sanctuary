...
contract MrTesterTwo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MrTesterTwo";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    uint256 totalRange = 12;
    uint256 bottomRange  = 100;
    IDEXRouter public router;
    address public pair;
    uint256 public launchedAt;
    uint256 reverseRange   = 2;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xD02c0CCd13b1b396a9215482E447583f7Ff6BDee;
