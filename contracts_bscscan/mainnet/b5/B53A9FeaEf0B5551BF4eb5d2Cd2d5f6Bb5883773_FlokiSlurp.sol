...
/**
  ...
  Welcome FlokiSlurp
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @FlokiSlurp
   ...
   I will renounce the ownership to burn addresses to transfer #FlokiSlurp to the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 10% total supply to the pool
   Can you make #FlokiSlurp 10000X? 
...
contract FlokiSlurp is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiSlurp";
    string private _symbol = "FSLRUP";
