...
contract MegaShibaZilla is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0xD6180febd94BA0137A82c7C126E2CE6d9c59fb28);
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function excludeAntiwhale(address acc) public onlyOwner {
        _isExcludedAntiwhale[acc] = true;
    }
    function includeAntiwhale(address ac) public onlyOwner {
        _isExcludedAntiwhale[ac] = false;
    }
