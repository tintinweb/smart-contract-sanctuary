...
contract Matata is Context, IERC20, Ownable {
    ...
    uint256 private _maxSupply = _tTotal * 50;

    string private _name = "Hakuna Matata";
    string private _symbol = "MATATA";
    ...
    address public marketingWallet = 0xb5Fa2C00eb9a520962f6C1b6233574EdAbF7Bcc0;
