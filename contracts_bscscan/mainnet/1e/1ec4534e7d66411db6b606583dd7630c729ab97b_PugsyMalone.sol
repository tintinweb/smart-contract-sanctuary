...
4% rewards Fees in BUSD - directly auto claimed into your wallet just by holding our Tokens !
4% to marketing
4% to liquidity pool
2% charity
...
contract PugsyMalone is ERC20, Ownable {
    ...
    uint256 public totalFees = RewardTokenRewardsFee.add(liquidityFee).add(marketingFee).add(charityFee);
    ...
    constructor() public ERC20("Pugsy Malone", "$PUGSY") {

    	dividendTracker = new DividendTracker();

        _marketingWalletAddress = address(0x41FA041F18cA41bB57480656452CA80d393cE1B1);

        _charityWalletAddress = address(0x123cc742c9AE7aFC81D4902F559967D198c71616);
    ...
    function setRewardTokenRewardsFee(uint256 value) external onlyOwner{
        ...
        totalFees = RewardTokenRewardsFee.add(liquidityFee).add(marketingFee).add(charityFee);
    }
    ...
    function changeMaxWallet(uint256 value) public onlyOwner {
         maxWalletTokens = value * 10**18;
    }
