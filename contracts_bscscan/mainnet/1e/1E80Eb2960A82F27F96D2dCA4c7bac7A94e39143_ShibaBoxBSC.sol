...
/**
   #shibaboxbsc
   Please read the contract carefully. Crypto is a high risk investment
...
contract ShibaBoxBSC is Context, IERC20, Ownable {
    ...
    uint256 private _tshibaboxTotal;

    string private _name = "ShibaBoxBSC";
    string private _symbol = "SHIBOX";
    ...
    uint256 public _shibaboxFee = 12;
    uint256 private _previousshibaboxFee = _shibaboxFee;
    
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**6 * 10**9; 
    
    address payable public shibaboxWallet = 0x00bc2aa1281BBBd3B9Af8A39b69eB39d0F6AE501; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tshibaboxTotal = _tshibaboxTotal.add(address(this).balance);
        TransferCharityETH(shibaboxWallet, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_shibaboxFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _shibaboxFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousshibaboxFee = _shibaboxFee;
    ...
    function restoreAllFee() private {
        ...
        _shibaboxFee = _previousshibaboxFee;
    }
    ...
    function setshibaboxFeePercent(uint256 shibaboxFee) external onlyOwner() {
        _shibaboxFee = shibaboxFee;
    }
