...
contract SONOFBNB is Context, IERC20, Ownable {
    ...
    string private _name = "SON OF BNB";
    string private _symbol = "SOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4ae1BfE205A1eF5af904A7E30df29992bD8045db); // Marketing Address
    address payable public DevWalletAddress = payable(0xCa784e227DA349a7e75Dd52851D324f90d7D3477); // Dev Address
