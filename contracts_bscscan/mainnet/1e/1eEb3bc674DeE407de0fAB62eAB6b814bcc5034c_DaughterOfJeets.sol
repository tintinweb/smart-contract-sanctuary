...
contract DaughterOfJeets is BEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "DaughterOfJeets";
    string constant _symbol = "DOJ";
    ...
    uint256 _initialSellLiquidityFee = 2;
    uint256 _initialSellMarketingFee = 16;
    uint256 _initialSellBuybackFee = 16;
    ...
    uint256 public _sellTotalFee = 32; 
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 1; // 0.1% 
