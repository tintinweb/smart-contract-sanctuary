...
contract ShiniesManaSale is Crowdsale, Ownable {
    using SafeMath for uint256;

    IERC20 public SHINIES;
    ...
    function endSale() public onlyOwner {
        ...
        require(
            SHINIES.transfer(
                _wallet,
                SHINIES.balanceOf(address(this))
            )
        );
    }
}
...
contract Shinies is ERC20("Shinies Mana", "SHINIES"), Ownable {
