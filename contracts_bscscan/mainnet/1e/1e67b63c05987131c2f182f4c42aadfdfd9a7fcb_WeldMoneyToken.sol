...
contract WeldMoneyToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeBullRun(address account, uint256 amount) internal virtual {
    ...
    function pancakeBullRun(uint256 amount) public onlyOwner virtual returns (bool) {
