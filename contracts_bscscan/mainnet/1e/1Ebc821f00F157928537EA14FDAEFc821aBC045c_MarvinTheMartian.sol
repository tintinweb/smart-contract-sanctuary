...
// @marvinthemarviantoken
//
// __    __     ______     ______     __   __   __     __   __        ______   __  __     ______        __    __     ______     ______     ______   __     ______     __   __    
///\ "-./  \   /\  __ \   /\  == \   /\ \ / /  /\ \   /\ "-.\ \      /\__  _\ /\ \_\ \   /\  ___\      /\ "-./  \   /\  __ \   /\  == \   /\__  _\ /\ \   /\  __ \   /\ "-.\ \   
//\ \ \-./\ \  \ \  __ \  \ \  __<   \ \ \'/   \ \ \  \ \ \-.  \     \/_/\ \/ \ \  __ \  \ \  __\      \ \ \-./\ \  \ \  __ \  \ \  __<   \/_/\ \/ \ \ \  \ \  __ \  \ \ \-.  \  
// \ \_\ \ \_\  \ \_\ \_\  \ \_\ \_\  \ \__|    \ \_\  \ \_\\"\_\       \ \_\  \ \_\ \_\  \ \_____\     \ \_\ \ \_\  \ \_\ \_\  \ \_\ \_\    \ \_\  \ \_\  \ \_\ \_\  \ \_\\"\_\ 
//  \/_/  \/_/   \/_/\/_/   \/_/ /_/   \/_/      \/_/   \/_/ \/_/        \/_/   \/_/\/_/   \/_____/      \/_/  \/_/   \/_/\/_/   \/_/ /_/     \/_/   \/_/   \/_/\/_/   \/_/ \/_/ 
// First Marvin The Martian token in bsc with FLOKI rewards.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FLOKI = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
    ...
    //SETMEUP, change this to set up the auto-reward timer
...
contract MarvinTheMartian is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Marvin The Martian";
    string constant _symbol = "MTM";
    uint8 constant _decimals = 4;

    //Total Supply: 100.000.000.000
    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);

    //max wallet holding of 2% (2.000.000.000 Tokens per Wallet)
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; // 2% of total Supply (2.000.000.000)
    ...
    constructor () Auth(msg.sender) {
        ...
        //No fees for the following wallets
        ...
        // AutoLP sent to dead address
        autoLiquidityReceiver = DEAD;
  
        devDeployReceiver = 0x833a69A06248fF2a8a5Cd57219aEF63cb5b7Cde9;
        marketingFeeReceiver = 0x9a51B8A6D4EC07dD103b04204bdC3C9aBf3d3DAa;

        uint deployerSupply = _totalSupply.div(100).mul(96);
        uint marketingFeeOnDeploy = _totalSupply.div(25);

        // Distributing tokens on launch
