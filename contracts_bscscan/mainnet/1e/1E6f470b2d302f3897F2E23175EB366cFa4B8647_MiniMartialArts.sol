...
MiniMartialArts Token
 
 6% ETH REWARDS
 1% Buy Back | 3% Liquidity | 4% Marketing
 1% Max Wallet 10B tokens
 
 TG: https://t.me/MiniMartialArts
...
contract MiniMartialArts is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniMartialArts";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xa249A3a0E31411db636D21f038C24A0b8afd14b3;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // cooldown timer, so a bot doesnt do quick trades! 10sec gap between 2 trades.
        if (sender == pair &&
            buyCooldownEnabled &&
            !isTimelockExempt[recipient]) {
            require(cooldownTimer[recipient] < block.timestamp,"Please wait for 10sec between two buys");
