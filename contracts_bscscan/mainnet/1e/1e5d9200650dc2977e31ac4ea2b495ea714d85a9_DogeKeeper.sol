...
/**
🗝DogeKeeper🐶 Guranteed Reward regardless of the market condition 

🐶This is the token keeper that will be going to protect all meme tokens in BSC. This is the first of its kind and will be the next one that people will FOMO in. It will revolutionize crypto space by making its decentralized exchange for all meme tokens as its use case, Furthermore,  develop a gaming app and more utilities along the way. 

✅Why we moon?

🔰Decentralize Exchange in the first quarter of 2022 
🔰DogeKeeper gaming app where people can burn tokens and get rewards while playing it 
🔰Experience core team in the field of software development 
🔰Easy to understand tokenomics 
🔰Great marketing that will pump the chart by building international groups and collaboration with many influencers 
🔰TechRate and Certik Audit in the first phase of the roadmap 
🔰 Coingecko and Coinmarketcap 

⏰Fair Launch - TBA
🎯2% BUSD reflection 
🎯2% goes to DogeKeeper marketing
🎯2% will go to its liquidity 
🎯5% Development fee 

❇️Telegram: https://t.me/DogeKeeper
❇️Website: https://DogeKeeper.net
*/
...
contract DogeKeeper is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    address DevWallet  =  payable(msg.sender); // Eco Address;

    string constant _name = "DogeKeeper";
    string constant _symbol = "$DogeKeeper";
