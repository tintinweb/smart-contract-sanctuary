...
/**
 * SpaceXUni is here to take you on a Moon Mission!
 * The onboard entertainment delivers you Uni rewards!!!
 * https://t.me/SpaceXUNII
 * https://twitter.com/Spacexunii?s=09
 * Total Tax 20% Buy & Sell to reward Diamond SpaceXUni Hands
*/
...
contract SpaceXUni is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SpaceXUni";
    string constant _symbol = "SpaceXUni";
    ...
    uint256 public swapThreshold = _totalSupply / 90000; // 0.05%
    bool inSwap;
