...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SM = IBEP20(0xF315cfC8550F6FcA969D397cA8b807C5033fA122);
...
contract BabyGat is IBEP20, Auth {
    using SafeMath for uint256;


    address SM = 0xF315cfC8550F6FcA969D397cA8b807C5033fA122;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyGat";
    string constant _symbol = "BabyGat";
