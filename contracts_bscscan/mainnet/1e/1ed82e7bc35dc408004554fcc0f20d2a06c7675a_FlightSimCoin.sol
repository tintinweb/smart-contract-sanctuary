...
// File: contracts/Fsxc.sol

pragma solidity 0.6.12;

contract FlightSimCoin is BEP20 {
    ...
    /**
     * @notice Constructs the FlightSimCoin contract.
     */
    constructor() public BEP20("Flight Sim Coin", "FSXC") {
    ...
    /// @dev overrides transfer function to meet tokenomics of FSXC
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == BURN_ADDRESS ||
            ...
            require(amount == sendAmount + taxAmount, "FSXC::transfer: Tax value invalid");
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOperator {
        require(_transferTaxRate <= MAXIMUM_TRANSFER_TAX_RATE, "FSXC::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate.");
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "FSXC::transferOperator: new operator is the zero address");
        emit OperatorTransferred(_operator, newOperator);
        _operator = newOperator;
    }
    
    function setWhitelist(uint _number, address _address) public onlyOperator {
        require(_number <= 5 && _number >= 1, "FSXC::setWhitelist: _number must be 1~5");
        if (_number == 1)
