...
/**
 * Hello CatenomicsUSDT Community
 * 
 * TG: https://t.me/CatenomicsUSDT
 * 
 * 
 * CatenomicsUSDT token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract DividendDistributor is IDividendDistributor {
    ...
    event Deposit(uint256 amountBNB, uint256 amountUSDT);
...
contract CatenomicsUSDT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CatenomicsUSDT";
    string constant _symbol = "CatenomicsUSDT";
