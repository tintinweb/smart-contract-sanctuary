...
contract BabyEarnAmazon is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyEarnAmazon";
    string constant _symbol = "BEA";
