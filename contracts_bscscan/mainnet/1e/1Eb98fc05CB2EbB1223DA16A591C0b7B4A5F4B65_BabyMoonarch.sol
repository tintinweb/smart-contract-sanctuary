...
/**
     Welcome to BabyMoonarch. Here you will earn massive MOONARCH rewards for holding. 
     This is a perfect token for all gem and 100x hunters!
     
     If you have not used Moonarch yet, Check it out. Its the best way to find the next 100x
     
     Tokens pay out every 5 minutes with enough volume, 
     Or you can purchase or sell one token and look in your BSC scan to see your rewards. 
     
     Join the TG - https://t.me/BabyMoonarch
     */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0xaf96a19c2DD4a0f6B077D9481fCc8C9102FAa141);
...
contract BabyMoonarch is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "CAKE";

    string constant _name = "BabyMoonarch";
    string constant _symbol = "BabyMoonarch";
