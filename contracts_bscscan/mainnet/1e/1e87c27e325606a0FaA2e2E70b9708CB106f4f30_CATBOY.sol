...
Do you all see the pump that's been going on today in Catgirl & Catbread ? Or do you miss each one of them ?
Don't you worry, I missed them too, Catboy (Catgirl brother) is here so we can redeem ourselves.

😺 Liquidity will be locked in Mudra to make sure the safety of the investors !
😺 Low starting market cap to make it possible for all of you to make a huge gains !
😺 Contract copied from Catgirl, SAFU !

Join the felines family, @catboybsc
...
contract CATBOY is IBEP20, Context {
    using SafeMath for uint256;
