...
/**
Telegram : https://t.me/BaseDoge

   BaseDoge master made a lot of monies on the Ethereum network. 
   So they decided to recreate BaseDoge on BSC, with a fairer launch so everyone can play with BaseDoge without fear of dusty dogs dumping on them.
   
   BaseDoge was launched on the eth network with 10 eth starting liquidity at a price of about $300 per eth. 
   BaseDoge will do the same on BSC but with a  starting 2 BNB price .! 
   BaseDoge will also implement a passive yield mechanic where 5% of each transaction is distributed to holders,
   making for an upgraded meme token with lower network fees!
   
   website: UnderaConstruction
   telegram: https://t.me/BaseDoge
...
contract BaseDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BASE DOGE";
