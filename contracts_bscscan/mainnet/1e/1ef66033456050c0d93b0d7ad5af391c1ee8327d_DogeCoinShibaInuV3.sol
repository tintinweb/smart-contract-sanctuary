...
/**
    ...
    */
    ...
    contract DogeCoinShibaInuV3 is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "Doge Coin Shiba Inu V3";
        string constant _symbol = "DogeCoinShibaInuV3";
