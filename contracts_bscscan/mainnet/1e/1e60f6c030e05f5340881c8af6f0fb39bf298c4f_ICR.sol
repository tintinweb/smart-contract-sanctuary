...
2% Marketing + lottery fee sent to 
...
contract ICR is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**9 * 10**18;           // 100 Billion Total Supply.
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Investment Commercial Real Estate";
    ...
    address public marketingWallet = 0xd8119AF2393060C517f282fDC955857f4C65d2b8;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //If burnAddress has >= 400 Billion
        //don't take burnFee
        if(balanceOf(address(0)) < 80 * 10**9 * 10**9){
