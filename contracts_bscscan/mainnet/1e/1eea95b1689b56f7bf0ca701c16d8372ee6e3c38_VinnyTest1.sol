...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xA05D38E684dBbD3d3F8cdb02Ef8f024B73c9eF9f;
...
contract VinnyTest1 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xA05D38E684dBbD3d3F8cdb02Ef8f024B73c9eF9f; // For weekly burn
    address payable public marketingAddress = payable(0xA05D38E684dBbD3d3F8cdb02Ef8f024B73c9eF9f); // Marketing address for promotion of this great project
    ...
    string private _name = "Vinny Test1";
    string private _symbol = "VT1";
    ...
    uint256 public _maxBuyAmount = 1 * 10**11 * 10**9;
    uint256 public _maxSellAmount = 1 * 10**11 * 10**9;
    uint256 public _maxWhaleAmount = 1 * 10**10 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 5 * 10**9 * 10**9; // 0.5%
    uint256 public numTokensMinimumSellToAddToLiquidity = 5 * 10**10 * 10**9; // 5%
    ...
    function setMinimumMaxSellToAddLiquidity(uint256 maxTxAmount) external onlyOwner {
        numTokensMinimumSellToAddToLiquidity = maxTxAmount;
    }
