...
contract PlayRICHToken is Context, IBEP20, Ownable {
  ...
  constructor() {
    _name = "Playrich Token [playrich.gg]";
    _symbol = "PLAYR";
    _decimals = 6;
  ...
  /**
   * @dev Destroys `amount`from owner wallet
   * Only the Owner wallet can be burned
   * No Participant can burn his tokens unless manually transferring to 0x0
   */
  function burnOwnerWallet(uint256 amount)
    public
    onlyOwner
    returns (bool)
  {
