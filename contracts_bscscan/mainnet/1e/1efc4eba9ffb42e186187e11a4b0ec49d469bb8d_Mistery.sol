...
contract Mistery is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4A661eb8f426E79601e5530E35625527b67E5d67); // Marketing Address
    ...
    string private _name = "Mistery Token";
    string private _symbol = "Mistery";
...
uint256 public _taxFee = 0;
    ...
    uint256 public _maxTxAmount = 100000 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = _tTotal * 2 / 1000; 
