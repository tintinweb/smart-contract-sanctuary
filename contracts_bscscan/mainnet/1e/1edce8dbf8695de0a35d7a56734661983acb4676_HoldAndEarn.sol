...
/**
 Hold And Earn Cardano
 Welcome to HoldAndEarn, The first Token to give ADA rewards to shareholders
 Tokenomics: 5% REWARDS 3% LIQUIDITY 2% Marketing
 slippage 10%-15
*/
...
contract HoldAndEarn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Hold And Earn";
    string constant _symbol = "HAE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 10; // 1%
    ...
    uint256 targetLiquidityDenominator = 10;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x293A8801228F3198F44Be15B4E2C19712b6e2b4E;
