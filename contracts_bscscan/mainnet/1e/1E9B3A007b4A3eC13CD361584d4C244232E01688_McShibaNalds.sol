...
//Just launched in McShibaNalds $MCSHIBA. We have created a token so rewarding for everyone.
//Low Mcap
//Liq 0.3BNB
//Pottential Moon
//Lp lock and Renounced
//McShibaNalds  Hold we will To the moon
//telegram : @McShibaNalds 
...
contract McShibaNalds  is Context, IERC20, Ownable {
    ...
    string private _name = "McShibaNalds ";
    string private _symbol = "MCSHIBA ";
