...
Inu Kuso is Japanese for Dog Shit. We are the ultimate Inu shitcoin yet our usecase is sure to surprise and amaze.

Stealth launched on January 23, 2022
...
contract INUKUSO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'Inu Kuso';
    string private constant _symbol = 'INUKUSO';
    ...
    uint256 public sT = 80000 * (10 ** _decimals);
    bool LFG = false;
