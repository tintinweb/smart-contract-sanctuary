...
contract XRPTERMINATOR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xD23656c2C550B4438e7eBA8067c937de9afF0d9a); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0x10a1B2607bd4f3cC63341FD82E1CA8b7fDb289CA); // xrp Address
    ...
    string private _name = "XRPTERMINATOR";
    string private _symbol = "XRPTERMINATOR";
