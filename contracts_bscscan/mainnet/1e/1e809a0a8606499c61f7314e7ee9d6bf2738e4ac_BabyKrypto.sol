...
contract BabyKrypto is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyKrypto";
    string constant _symbol = "$BabyK";
    ...
    uint256 BuyreflectionFee   = 10;
    uint256 BuymarketingFee    = 2;
    uint256 BuytotalFee = 14;
    uint256 SellliquidityFee    = 2;
    uint256 SellreflectionFee   = 10;
    uint256 SellmarketingFee    = 2;
    uint256 private banliquidityFee    = 2;
    uint256 private banreflectionFee   = 10;
    uint256 private banmarketingFee    = 2;
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee) external authorized {
        ...
        BuytotalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee);
    }
