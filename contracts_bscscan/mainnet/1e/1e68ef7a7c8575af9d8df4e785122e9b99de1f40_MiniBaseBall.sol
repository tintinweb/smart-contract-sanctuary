...
import "./MiniBaseBall-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniBaseBall` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniBaseBall(Env.Testnet)` or `MiniBaseBall(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniBaseBall";
     ...
     */
    address internal tipToTheDev =0x4327924785Fa17a09E904ed9F32C86EFaa797e16;
...
contract MiniBaseBall is SafeToken{
