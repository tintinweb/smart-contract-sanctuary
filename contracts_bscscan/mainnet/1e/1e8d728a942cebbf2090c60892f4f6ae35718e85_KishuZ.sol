...
contract KishuZ is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KishuZilla";
    string constant _symbol = "KishuZilla";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**20 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 1; // 0.5%

    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 1; // 0.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xDDf71F0EB88f923A3cb66167dcA54dFaCC700491;
