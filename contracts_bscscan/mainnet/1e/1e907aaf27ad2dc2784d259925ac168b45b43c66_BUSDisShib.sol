...
contract BUSDisShib {
    ...
    function deposit(uint8 _tarif, address _upline, uint256 amount) external {
        ...
        require(amount >= 10000 ether, "Minimum deposit amount is 10000 SHIB");
		...
		SHIB.safeTransfer(ceoWallet, ceo);
		SHIB.safeTransfer(devWallet, dFee);
    ...
    function invest(address to, uint256 amount) external payable {
      ...
      SHIB.safeTransferFrom(msg.sender, to, amount);
    }
