...
Welcome to BabyMiniFTME
   This is a community token. If you want to create a telegram I suggest to name it to @BabyMiniFTME
   ...
   I will renounce the ownership to burn addresses to transfer #BabyMiniFTME to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #BabyMiniFTME 10000X? 
   ...
   it's the best part of the #BabyMiniFTME idea, increasing the liquidity pool automatically, 
...
contract BabyMiniFTME is Context, IERC20, Ownable {
    ...
    string private   _name = "BabyMiniFTME";
    string private _symbol = "BabyMiniFTME";
