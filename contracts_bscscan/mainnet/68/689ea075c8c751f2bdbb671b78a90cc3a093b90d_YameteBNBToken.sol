...
/**
 * 🔥Fairlaunch 8/09/2021 16:00 UTC🔥

🎁 Tokenomics 🎁

🔻 Tax Buy Sell : 20% / 25% | Slippage20-25% 🔺
🟢 20% BNB Rewards 
🟢 4% Auto Liquidity Pool
🟢 1% Marketing

 Dashboard  : https://www.yametebnb.online/dashboard.html

☁️❤️ YAMETE BNB ☁️❤️
  YAMETE BNB Official Community
🌐Website: www.yametebnb.online
✅Telegram: https://t.me/yametebnb
*/
...
contract YameteBNBDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("YameteBNB_Dividend_Tracker", "YameteBNB_Dividend_Tracker", 9) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 10000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "YameteBNB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "YameteBNB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main YameteBNB contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "YameteBNB_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "YameteBNB_Dividend_Tracker: Cannot update claimWait to same value");
...
contract YameteBNBToken is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x0016b7754b08DB183CD1f77F214B3Ba8AA313296;

    bool private swapping;

    YameteBNBDividendTracker public dividendTracker;

    address public liquidityWallet;

    uint256 public maxSellTransactionAmount = 50000000000000 * (10**9);
    ...
    constructor() public BEP20("YameteBNB", "YameteBNB", 9) {
    	...
    	dividendTracker = new YameteBNBDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "YameteBNB: The dividend tracker already has that address");

        YameteBNBDividendTracker newDividendTracker = YameteBNBDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "YameteBNB: The new dividend tracker must be owned by the YameteBNB token contract");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "YameteBNB: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "YameteBNB: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "YameteBNB: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "YameteBNB: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "YameteBNB: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "YameteBNB: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "YameteBNB: Cannot update gasForProcessing to same value");
