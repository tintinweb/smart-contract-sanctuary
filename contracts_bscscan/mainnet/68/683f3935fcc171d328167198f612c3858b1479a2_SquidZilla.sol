...
contract SquidZilla is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = 690000000000000000 * (10 ** _decimals);
    uint256 public _walletMax = 690000000000000000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = 690000000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x239608E26b9Bdbf26F5D8B47F9ec782D64376c8b;
        devWallet = 0x0220e4Ce1AF327FfE196CD2128681B6a54EC2B0C;
