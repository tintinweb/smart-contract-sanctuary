...
// Romeo-Cheems looking for a wife
// https://t.me/Romeocheems
...
contract RomeoCheems is Context, IERC20, Ownable {
    ...
    string private _name = "Romeo Cheems";
    string private _symbol = "$Romeo";
    ...
    uint256 public swapTokensAtAmount = 6000000000000 * 10**9;
    uint256 public _maxTxAmount = 6000000000000000 * 10**9;
