...
contract ColonelDoge is Context, IERC20 {
    ...
    string private _name = "ColonelDoge";
    string private _symbol = "ColonelDoge";
    ...
    uint256 private maxTakeawayFee = 800;
    ...
    address payable private _takeawayWallet = payable(0xe420A9403693A01FEA06E6eeC43DE2a3745aa63E);
