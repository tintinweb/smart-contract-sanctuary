...
/**
 ...
 Welcome to ApeTaliban 👳🏽‍♀️🐵
 
 -Total supply: 100,000,000 Tokens
*Ownership Renounced
*Rug-proof
*10% tax where 
*5% is added back into liquidity
*2% is redistributed to all holders 
*1% to marketing.
---------------------------------------
📲 Telegram: https://t.me/apetaliban
---------------------------------------
...
contract ApeTaliban is BSC, Math {
    string public name =  "ApeTaliban" ;
    string public symbol =  "ISIS";
    uint8 public decimals = 9;
    uint public _totalSupply = 1*10**8 * 10**9;
