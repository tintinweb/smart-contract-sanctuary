...
* ($BZC)
*
* PASSIVE INCOME Z CASH REWARDS FOR HOLDING 
* 
* Stealth Launch
* Contract Verified
* LP Locked
...
* Max per Holder: 15 000 000
* Max sell: 10 000 000
* Max buy:  10 000 000
* 
*https://t.me/babyZCASHbsc
* 
*/
...
contract babyZCASH is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'babyZCASH';
    string private constant _symbol = '$BZC';
    ...
    address public constant TeamWallet=0x4176e5F344B61e88C5633db6F82873A0563A3A04;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x1Ba42e5193dfA8B03D15dd1B86a3113bbBEF8Eeb;  //ZCASH
