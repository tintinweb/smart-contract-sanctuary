...
contract Burning is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 2500000 * 10**6 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 1500000 * 10**6 * 10**18;
