...
Telegram: @Meta_Warfare
Website: https://metawarfare.online
WAR HAS BEGUN !
/**
...
contract MetaWarfare is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MetaWarfare", "MWF") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x25167C70c2738d47a1f6cb040ABeCD458fdda0F9;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "MetaWarfare: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "MetaWarfare: The new dividend tracker must be owned by the MetaWarfare token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("MetaWarfare_Dividend_Tracker", "MetaWarfare_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 150000 * (10**18); //must hold 150,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "MetaWarfare_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "MetaWarfare_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "MetaWarfare_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "MetaWarfare_Dividend_Tracker: Cannot update claimWait to same value");
