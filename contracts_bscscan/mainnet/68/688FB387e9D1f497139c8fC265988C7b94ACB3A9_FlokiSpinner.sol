...
/*
Floki Spinner  - 4200 NFTs + Casino Wheel + Buyback Token!

Reunite Floki with Elon! Come spin the wheel and win yourself an NFT or cash prize! Backed by Revolutionary buyback token!

 -AUDIT & KYC BY DESSERTSWAP + CONTRACT BEFORE LAUNCH! SAFUSAFUSAFU!!

 -LIQUIDITY LOCKED DXSALE

-ANTI SNIPE  MECHANICS - YOUVE BEEN WARNED, NO SERIOUSLY!

 -BUYBACK WALLET ALWAYS EMPTY BECAUSE WE DONT LIKE DIPS!
-JACKPOT TAX! SPIN THE WHEEL AND HELP FLOKI FIND HER MASTER!
-PANCAKE NFT MARKETPLACE COMING SOON!

Tokenomics:

Our taxes include fees for Marketing & Development, Buyback & Liquidity Algorithm, Jackpot Fund and ongoing operations.

-Buy 12% Sell 20% (Taxes reduce 50% on DAY 7 for longevity of project)

🌐 flokispinner.com
☎️ t.me/flokispinner
🐦 twitter.com/flockispinner
*/
...
contract FlokiSpinner is ERC20, Ownable {
    ...
    constructor() ERC20("Floki Spinner", "FLOKISPIN")  {
