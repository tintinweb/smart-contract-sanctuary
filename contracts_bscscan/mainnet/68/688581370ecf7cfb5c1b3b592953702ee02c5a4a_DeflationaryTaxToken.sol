...
/*
BigDollarDoge ($bdoge) - - Earn Dogecoin by holding Ddoge
------------------------------------

website - http://bigdollardoge.com/
Join Telegram - https://t.me/bigdollardoge
Twitter - https://twitter.com/bigdollardoge
...
contract DeflationaryTaxToken {
    ...
    constructor(string memory _name, string memory _symbol, uint _dec, uint _supply, uint _dogerewards, address _address1, uint _tax2, address _address2, uint _deflation, uint _minSupply, address _owner) {
        name = _name;
        symbol = _symbol;
        decimals = _dec;
        totalSupply = _supply * 10 ** decimals;
        initialSupply = _supply * 10 ** decimals;
        dogerewards = _dogerewards;
        tax2 = _tax2;
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        if (dogerewards > 0) {
            uint tax1Amount = value * dogerewards / 1000;
