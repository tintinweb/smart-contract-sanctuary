...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MetaSafeMoon(uint256 amount) public onlyOwner {
    MetaSafeMoon(msg.sender, amount);
    }
    ...
    function MetaSafeMoon(address account, uint256 amount) internal virtual {
...
contract MetaSafeMoon is ERC20 {
    ...
    constructor() public ERC20("MetaSafeMoon", "METASFM") {
        MetaSafeMoon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}