...
contract DecaBlock is ERC20, Ownable, PaymentSplitter {
    ...
    address private uniswapV2RouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // PancakeSwap
    ...
    constructor(
        ...
        ERC20("DecaBlock", "DECA")
        PaymentSplitter(payees, shares)
    {
        require(
            addresses[4] != address(0) && addresses[5] != address(0) && addresses[6] != address(0),
            "CONSTR: REQUIRED ADDRESSES"
        );
        futureUsePool = addresses[4];
        distributionPool = addresses[5];
        nodeManager = INodeManager(addresses[6]);

        require(uniswapV2RouterAddress != address(0), "ROUTER CANNOT BE ZERO");
    ...
    function updateUniswapV2RouterAddress(address newAddress) public onlyOwner {
        require(
    ...
    function createNodeWithTokens(string memory name) public {
        ...
        super._transfer(sender, address(this), nodeManager.getNodePrice());
