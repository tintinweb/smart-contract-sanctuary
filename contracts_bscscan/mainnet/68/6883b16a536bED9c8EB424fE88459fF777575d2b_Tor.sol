...
(Заменить на любую инфомраци о проекте)
...
contract Tor is Context, IERC20, Ownable {
    ...
    address public _marketingAndDev = address(0x79ED2891C416e9b130b3b48e5101C9E2A505C621);
    ...
    uint256 public marketingAndDevelopment = 2;
