...
contract PlayrToken is Context, ERC721Burnable, ERC721EnumerableEx, ERC721StagedSale, ERC721Discounted {
     ...
     * Token price
     */
    uint256 public tokenPrice = 0.6 ether;
    ...
    {
        {
            uint256[] memory stages = new uint256[](5);
