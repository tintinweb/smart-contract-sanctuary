...
/**
   ...
   Welcome to LittlePolygon
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittlePolygon
...
contract LittlePolygon is Context, IERC20, Ownable {
    ...
    string private _name = "Little Polygon";
    string private _symbol = "LTMATIC";
