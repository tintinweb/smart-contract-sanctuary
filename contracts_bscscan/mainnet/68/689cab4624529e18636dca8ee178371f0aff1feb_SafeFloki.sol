...
Welcome to the safest Floki on BSC.
LP LOCKED for a week on mudra, check after launch.
I will renounce ownership as well, contract will be fully locked. Verfied also, no funny business.
Antibot burning function of 4%.

Set slippage to 5% to make sure your transaction is completed.
*/
...
contract SafeFloki is ERC20 {
    ...
    constructor() public ERC20("SafeFloki", "SAFLOKI") {
