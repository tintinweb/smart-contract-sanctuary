...
contract WrappedCryptoKitties is IBEP20 {
    ...
    string public override name = "Wrapped CryptoKitties";
    string public override symbol = "wCryptoKitties";
