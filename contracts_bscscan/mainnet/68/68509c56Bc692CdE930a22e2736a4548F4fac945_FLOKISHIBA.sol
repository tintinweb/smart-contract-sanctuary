...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB26178fdDf35982Bf75694ee24182fa6e4aC104b;
...
contract FLOKISHIBA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB26178fdDf35982Bf75694ee24182fa6e4aC104b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FLOKIAHIBA";
    string private _symbol = "FSHI";
