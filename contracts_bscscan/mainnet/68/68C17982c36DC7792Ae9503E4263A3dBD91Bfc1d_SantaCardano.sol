...
contract SantaCardano is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SantaCardano";
    string constant _symbol = "SADA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 100 ) / 100; // 4%
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 100; // 4%
