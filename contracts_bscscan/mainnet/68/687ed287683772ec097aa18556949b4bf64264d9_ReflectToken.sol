...
contract ReflectToken is IERC20, Ownable
{
    ...
    //fees    
    uint256 public maxFee = 3000; //max fee percent (30% = ~43% Slippage)
    uint256 private tFeeTotal; //total collected
    FeeInfo private buyFees; //applied on buys from routerPair
    FeeInfo private p2pFees; //applied on transfers between wallets
    FeeInfo private sellFees; //applied on sells from routerPair
    ...
    constructor()
    {
        ...
        address initialOwner = 0x1AEF111e0dC3b6B1f67e88680C740Afc2B06003f;
        marketingFeeAddress = 0xDbe4F95ff4410B8721596EF728bA7b5d0a54C680;        
        name = "HyperDoge";
        symbol = "HyperD";
        decimals = 18;
