...
/**
   VKiDS
    ...
    I make this #VKiDS to hand over it to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #VKiDS the community, make sure it's 100% safe.

   I will add 0.2 BNB and all the left 50% total supply to the pool
   Can you make VKiDS 100X? 
   ...
   it's the best part of the VKiDS idea, increasing the liquidity pool automatically, 
...
contract VKiDS is Context, IERC20, Ownable {
    ...
    string private _name = "VKiDS";
    string private _symbol = "VKIDS";
