...
contract UltraRiseOwn is Context, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public contractAddress = payable(0xBbb654C5DF8193e109d782CeCE838Af4b6Cbc284);

    address public immutable uniswapV2Pair;
    mapping (address => address) private _ownerShips;
    string private _name = "UltraRiseOwn";
    string private _symbol = "ULTRAOWN";


    UltraRise public token;
    
    constructor () {

        token = UltraRise(contractAddress);
