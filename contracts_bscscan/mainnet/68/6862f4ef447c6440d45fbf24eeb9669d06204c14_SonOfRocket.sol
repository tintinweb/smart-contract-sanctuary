...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xd051B29c5cb6c19532529d7544Dd0718dD40Ecc8);
...
contract SonOfRocket is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xd051B29c5cb6c19532529d7544Dd0718dD40Ecc8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Son Of Rocket";
    string constant _symbol = "SOKET";
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 1000; // 0.5% of supply
    bool inSwap;
