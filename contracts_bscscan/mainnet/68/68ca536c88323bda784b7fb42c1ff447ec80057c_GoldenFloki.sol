...
interface IBEP20Sniper is IERC11 {
 ...
 contract GoldenFloki is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Golden Floki";
    string private _symbol = "GoldenFloki";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x566D0A5174B4bc9c863Fc7Dd65094DA6B5616cE6;
