...
contract BabyGreenestChart is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "BabyGreenestChart";
    string private _symbol = "BabyGreenestChart";
