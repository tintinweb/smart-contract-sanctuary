...
+  Marketing, airdop:  5.000.000.000.000 (5%)
 ...
 16% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold $BabyMessi tokens, earn BNB. 
...
contract BabaBoi is IERC20, Ownable {
    ...
    string constant _name = "$BabyMessi";
    string constant _symbol = "$BabyMessi";
