...
// MetaCoreX [The Core X MEtaverse]
// Telegram: https://t.me/MetaCoreXx
...
contract MetaCoreX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000 * 10**6 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MetaCoreX";
