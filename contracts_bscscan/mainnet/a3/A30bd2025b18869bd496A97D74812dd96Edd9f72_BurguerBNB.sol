...
// | $$  \ $$| $$  | $$| $$     | $$  | $$| $$  | $$| $$_____/| $$            | $$  \ $$| $$\  $$$| $$  \ $$
// | $$$$$$$/|  $$$$$$/| $$     |  $$$$$$$|  $$$$$$/|  $$$$$$$| $$            | $$$$$$$/| $$ \  $$| $$$$$$$/
// |_______/  \______/ |__/      \____  $$ \______/  \_______/|__/            |_______/ |__/  \__/|_______/
//                              /$$  \ $$
//                             |  $$$$$$/
//                              \______/

// Made with love by The Bakery Token & Tokens Guardians


// BurguerBNB BEP20 Token Available on PancakeSwap
// https://t.me/BurguerBNB <--- Telegram
...
contract BurguerBNBDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BurguerBNB_Dividend_Tracker", "BurguerBNB_Dividend_Tracker", 9) {
    	claimWait = 14400;
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 10000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "BurguerBNB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BurguerBNB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BurguerBNB contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BurguerBNB_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BurguerBNB_Dividend_Tracker: Cannot update claimWait to same value");
...
contract BurguerBNB is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x8fFAeC0D8dED162bBb73cda3Ed664F3f67D13533;

    bool private swapping;

    BurguerBNBDividendTracker public dividendTracker;
    ...
    constructor() public BEP20("BurguerBNB", "BurguerBNB", 9) {
    	...
    	dividendTracker = new BurguerBNBDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BurguerBNB: The dividend tracker already has that address");

        BurguerBNBDividendTracker newDividendTracker = BurguerBNBDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BurguerBNB: The new dividend tracker must be owned by the BurguerBNB token contract");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "BurguerBNB: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BurguerBNB: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "BurguerBNB: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BurguerBNB: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BurguerBNB: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BurguerBNB: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BurguerBNB: Cannot update gasForProcessing to same value");
