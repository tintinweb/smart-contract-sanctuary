...
contract GreenYoshi is Context, IERC20, Ownable {
    ...
    string private constant _name = "GreenYoshi";
    string private constant _symbol = "GYS";
    ...
    uint256 public _maxTxAmount = 5 * 10**8  * 10**_decimals;  
