...
contract SuCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name ="$howUp";
    string constant _symbol = "SuCoin";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x86C2C44208977Ac31a19170DBdA6CC378271C472;  // teamwallet
