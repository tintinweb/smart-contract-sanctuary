...
Tokenomics: 
⭐️100,000,000,000 UPPLY
👑15% ETH reflection
👑3% liquidity reflection
👑2% Marketing fees
...
contract WOODETH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WOOD ETH";
    string constant _symbol = "$WOODETH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**11 * 10**9;
    uint256 public _maxTxAmount = 1 * 10**11 * 10**9;
    uint256 public _maxWallet = 1 * 10**11 * 10**9;
    uint256 public _mantidump = 1 * 10**11 * 10**9;
    uint256 public _mantiwhale = 1 * 10**11 * 10**9;
    ...
    uint256 public _ETHREWARD = 15;
    uint256 marketingFee = 1975;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xe95951dc0985BdB68eE78d18B7BaF86f86Cebb00;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(_ETHREWARD ).div(totalBNBFee);
