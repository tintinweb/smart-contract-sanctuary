...
/**
  Little sister of TetherBlack! If you miss TetherBlack train, it's time to join BabyTetherBlack's 100x jorney!
*/
...
contract BabyTetherBlack is Context, IERC20, Ownable {
    ...
    string private _name = "BabyTetherBlack";
