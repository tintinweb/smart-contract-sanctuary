...
contract PrivateAVesting is MultiLinearVesting{
    /// Private B vesting:
    /// 10% unlock on TGE
    /// 9% unlock 1 month later
    /// 7 months of linear vesting of what's left after that
    uint256 tgePercent_ = 80;
    uint256 oneMonthAfterTGEPercent_ = 70;
    uint256 cycles_ = 8; // liner vesting over 3 months after unlock ends.
    ...
    constructor(address tokenAddress) MultiLinearVesting(tokenAddress, cycles_,  tgePercent_, oneMonthAfterTGEPercent_){
        InitialVestingData [2] memory tmp = [
        InitialVestingData(0x4AAb257CA9b6EE25aFc83ed47AC5639061c06aBC, 1_000_000 ether),
        InitialVestingData(0xB2821Cf25350A0e600733f3018ccA4609E6224b3, 546_451 ether)
        ];
