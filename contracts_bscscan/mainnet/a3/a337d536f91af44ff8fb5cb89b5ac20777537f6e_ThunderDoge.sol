...
// $TDOGE Token Official Contract.
// Deployed By @DonThunderDoge
// $TDOGE ~ Revolutionize. Customize. Get your unique wallet.

// Telegram: t.me/ElectricDogeOfficial
// Twitter: twitter.com/thunderdogeofficial


// #features:
// 4% of all transcations made are automatically redistributed to all $TDOGE holders.
// 2% of all transactions made are reflected to the $TDOGE Marketing wallet
...
contract ThunderDoge is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Thunder Doge';
    ...
    function whaleLimit(address _who, uint amount) internal{
        ...
        if(balanceOf(_who) > _applyPercent(totalSupply(),WHALE_DEF) && !_isExcluded[_who]){
            ...
            require(amount <= whales[_who].budget, "As a whale, (owner of more than 1% of supply) you are limited to transact 1% of your coins per 24hrs");
    ...
    function setAsMarketingAccount(address account) external onlyOwner() {
        require(account != 0x315AEEFdB86A6dD4c77e03Ca6C80aDFD955B6cFb, 'The Uniswap router can not be the marketing account.');
