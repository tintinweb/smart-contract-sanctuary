...
contract Gaytest is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet1 = payable(0x2dd15bB3489594D7d22D09FBe57cED89AE58eFd4);
    address payable private _marketingWallet2 = payable(0xb8AE6ce5AB36Fd2D75822D45b0C86bb9fAD5D546);    
    ...
    constructor (uint256 _snipeBlockAmt, uint256 _gasPriceLimit) payable {
        ...
        _isExcluded[_marketingWallet2] = true;
        _excluded.push(_marketingWallet1);
        _isExcluded[lpPair] = true;
        _excluded.push(lpPair);
        // DxLocker Address (BSC)
        _isExcludedFromFee[0xB01D713eBb927924a3fc830CC2d5bD24d866E056] = true;
        _isExcluded[0xB01D713eBb927924a3fc830CC2d5bD24d866E056] = true;
        _excluded.push(0xB01D713eBb927924a3fc830CC2d5bD24d866E056);
 
        // Approve the owner for PancakeSwap, timesaver.
        _approve(_msgSender(), _routerAddress, _tTotal);
 
        // Ever-growing sniper/tool blacklist against gay bot users
    ...
    function setMarketingWallet(address payable newWallet) external onlyOwner {
        _marketingWallet1 = payable(newWallet);
    }
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'We can not exclude Pancakeswap router wadfak.');
...
,        address to,
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 splitbal = (fromSwap.sub(liquidityBalance)).div(2);
 
        _marketingWallet1.transfer(splitbal);
        _marketingWallet2.transfer(splitbal);
    }
