...
https://ninjaswap.app
*/
// Volterra  Sales at ninjaSwap
// token contract : 0xc8d78a779339823605ace31a958047002631ecd2
// decimals : 9
// token owner address : 0xC41C718315eF1D00Aa0ABa995B83e6984486A67C
...
contract NinjaStarter is ReentrancyGuard, Ownable, Pausable {
  ...
  uint256 public offeringAmount = 10000000 * 1e18;

  // offering token price in BUSD
  uint256 public buyPrice = 42500000000000000;
  ...
  function buywithBNB(address _beneficiary) public payable whenNotPaused nonReentrant {
    ...
    if (tokensToBePurchased > (offeringToken.balanceOf(address(this))).mul(10**9)) {
      tokensToBePurchased = offeringToken.balanceOf(address(this)).mul(10**9);
    }
    ...
    offeringToken.safeTransfer(address(msg.sender), tokensToBePurchased.div(10**9));
  ...
  function getEstimatedTokensBuyWithBNB(uint256 _bnbAmount) public view returns (uint256) {
  ...
  function setFee(uint16 _fee) public onlyOwner {
    require(_fee <= 3000, 'invalid fee basis points'); // max 3%
    fee = _fee;
  }
