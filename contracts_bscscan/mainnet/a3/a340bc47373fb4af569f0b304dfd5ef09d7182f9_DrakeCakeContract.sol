...
//@dev tg: @GhostCryptoOG
//SPDX-License-Identifier: MIT
//@dev dc: nicremo#2536
//@tggroup tg: drakecake
...
contract DrakeCakeContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DrakeCake";
    //change the token symbol
    string constant _symbol = "DrakeCake";
    //dont change that
    ...
    address public marketingFeeReceiver = 0xccD3e84bEA982680a0e3a494C0195BeA774Fb85D;
