...
contract Mestre is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ScorpionSMoney";
    string constant _symbol = "Money/ADA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; // 5000 unidade
    ...
    uint256 public swapThreshold = _totalSupply / 1000; // = 1000 unidades
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x83D2C542aACcb544af5f312e160bFddF57c83937;
    ...
    function setFees(uint256 _sellliquidityFee, uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
    ...
    function setFeeReceivers(address _autosellLiquidityReceiver, address _autoLiquidityReceiver, address _marketingFeeReceiver) external authorized {
        autoLiquidityReceiver = _autosellLiquidityReceiver;
