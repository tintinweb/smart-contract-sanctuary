...
/**
💎RaveNomics💎 | 🔥 StealthLaucnh 🔥 | Low Market Cap | Good Moon Shot

// https://t.me/RaveNomics
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RAVEN = IBEP20(0xcD7C5025753a49f1881B31C48caA7C517Bb46308);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RAVEN.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(RAVEN);
        ...
        uint256 amount = RAVEN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RAVEN.transfer(shareholder, amount);
...
contract RaveNomics is IBEP20, Auth {
    using SafeMath for uint256;

    address RAVEN = 0xcD7C5025753a49f1881B31C48caA7C517Bb46308;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "RaveNomics";
    string constant _symbol = "RVN";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x2a449747CBCfddd30115fd7c8676a12857CdA783;
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 10000000000000000);
        _maxTxAmount = amount;
    }
