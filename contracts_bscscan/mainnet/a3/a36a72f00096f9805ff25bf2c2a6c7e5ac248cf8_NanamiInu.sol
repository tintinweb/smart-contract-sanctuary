...
library Address{
 ...
 contract NanamiInu is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 100_000_000_000_000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 50_000_000_000 * 10**9;
    uint256 public maxBuyLimit = 1_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 500_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 1_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x386a322c4446827F443387C8b35bc4FEdf49933f;
    address public donationWallet = 0x126198793E44E72Bf10E42a6DE4A6c66bFB15138;

    string private constant _name = "Nanami Inu";
    string private constant _symbol = "NANAMI";
