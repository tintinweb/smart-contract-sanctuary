...
import "./BabyZooshi-imports.sol";

/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyZooshi` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyZooshi(Env.Testnet)` or `BabyZooshi(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyZooshi";
    string internal constant SYMBOL = "BZOO";
...
contract BabyZooshi is SafeToken{
