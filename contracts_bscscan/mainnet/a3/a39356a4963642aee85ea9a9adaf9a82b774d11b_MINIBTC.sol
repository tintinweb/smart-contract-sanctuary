...
/* contacts let = "name MINIBTC" id =1000000000000000 
getAmountOut(minibtc)
...
// File: contracts\minibtc.sol

contract MINIBTC is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "MINI BTC";
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0x91959A48e19658e17F1F1c4BaB73b8d600887cc8); // A percentage of the BNB pool will go to the charity address
	...
	// TEAM
	address payable private constant _teamAddress = payable(0x91959A48e19658e17F1F1c4BaB73b8d600887cc8);
