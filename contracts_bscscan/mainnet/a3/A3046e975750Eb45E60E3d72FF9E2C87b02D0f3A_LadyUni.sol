...
The Luniverse is the all encompassing ecosystem that houses $LUNI.
The Luniverse consists of Lady Uni, Astrolady, the Lunicorns and of course Luni Park
Every Lunicorn is special in their own way!!
We created a simple rarity system in order to rank every Unicorn from the common one all the way through to legendary. There are 5.000 Lunicorns available to mint. You can mint directly on the website, with 100 total different traits that makes every Unicorn unique. Will you be the lucky Luni Gang member that will mint a legendary Unicorn?!
...
━━━━━━━━━━━━━━━━━━━
Telegram: https://t.me/LadyUni_Official
Website: https://www.ladyuni.love/
*/
...
contract LadyUni is ERC20, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function refNFT(uint256 value) external onlyOwner{
