...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #C98Wheel  

    I make this #C98Wheel to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/C98WheelToken
   ...
   I will renounce the ownership to burn addresses to transfer #C98Wheel to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #C98Wheel 10000000X? 
   ...
   it's the best part of the #C98Wheel idea, increasing the liquidity pool automatically, 
...
contract C98Wheel is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("C98Wheel", "C98Wheel") {
