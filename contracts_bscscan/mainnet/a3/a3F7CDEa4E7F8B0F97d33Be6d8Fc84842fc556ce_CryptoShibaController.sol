...
contract CryptoShibaController is Ownable{
    ...
    constructor (){
        ...
        monsters[0] = Monster({
            _hp: 200, 
            _successRate: 80, 
            _rewardTokenFrom: 120000, 
            _rewardTokenTo: 140000,
            _rewardExpFrom: 2, 
            _rewardExpTo: 2});
        monsters[1] = Monster({
            _hp: 250, 
            _successRate: 70, 
            _rewardTokenFrom: 140000, 
            _rewardTokenTo: 160000, 
            _rewardExpFrom: 6, 
            _rewardExpTo: 6});
        monsters[2] = Monster({
            _hp: 400, 
            _successRate: 50, 
            _rewardTokenFrom: 160000, 
            _rewardTokenTo: 180000, 
            _rewardExpFrom: 8, 
            _rewardExpTo: 8});
        monsters[3] = Monster({
            _hp: 600, 
            _successRate: 30, 
            _rewardTokenFrom: 180000, 
            _rewardTokenTo: 200000, 
            _rewardExpFrom: 12, 
            _rewardExpTo: 12});  
    }
