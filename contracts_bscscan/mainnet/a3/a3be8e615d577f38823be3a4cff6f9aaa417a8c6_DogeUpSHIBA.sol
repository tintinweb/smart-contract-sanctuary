...
Get early to 1000X
	...
	contract DogeUpSHIBA is Context, IERC20, Ownable {
		...
		string private _name = "DogeUpSHIBA";
		string private _symbol = "DUP";
		...
		uint256 public _maxTxAmount = 8* 10**12 * 10**9;
