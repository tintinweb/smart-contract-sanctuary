...
//https://t.me/BezosCakeOfficial
//25% tax
//10% rewards distributed amongst holders
//7% to liquidity
//8% to marketing
//
//
...
contract BezosCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bezos Cake";
    string constant _symbol = "$BCAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20; // 2%
    ...
    uint256 public swapThreshold = _totalSupply / 2; // 5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6223689e1F8214eD96cE870756BDEcb24Dd3117c;
