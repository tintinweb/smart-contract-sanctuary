...
contract tbpf is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "tbpf";
    string constant _symbol = "tbpf";
    ...
    address marketingFeeReceiver = address(0xCC520b87E6240Aa157BC11ff4B43f060C2Ae56d9);
