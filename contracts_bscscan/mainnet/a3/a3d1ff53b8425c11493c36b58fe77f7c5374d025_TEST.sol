...
contract TEST is AccessControl, Context, IBEP20, Ownable {
    ...
    address private immutable liquidityWallet = 0x782Dd8315ff3B47eA529c8DdDBC3dB0b52dd583e;
    bool inSwapAndLiquify;
    bool private _penaltiesEnabled = false;

    uint256 public _maxTxAmount = _total.div(10**2).mul(2); // 2% of total supply
    uint256 public _numTokensSellToAddToLiquidity = _total.div(10**3).mul(5); // 0.5% total supply
    uint256 public _maxWalletToken = _total.div(10**2).mul(6); // 6% total supply
