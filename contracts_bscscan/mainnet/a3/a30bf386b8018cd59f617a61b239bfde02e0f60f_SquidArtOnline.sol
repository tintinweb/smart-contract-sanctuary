...
// CHANGE
contract SquidArtOnline is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Squid Art Online";
    string constant _symbol = "SAO";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xF6F25De2753D2b9EDa6402d86B1DEE9Ab7403584);
