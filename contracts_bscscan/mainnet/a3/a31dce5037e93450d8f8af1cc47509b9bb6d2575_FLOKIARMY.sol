...
contract FLOKIARMY is Context, IBEP20, Ownable {
    ...
    string public constant name     = "FLOKIARMY";
    string public constant symbol   = "FLOKIARMY";
    ...
    uint256 public _marketingFeeSell = 4000; 
