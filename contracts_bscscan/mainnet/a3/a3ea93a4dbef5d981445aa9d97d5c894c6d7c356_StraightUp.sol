...
/**
FIND US :  https://t.me/StraightUpBSC
*/
 ...
 contract StraightUp is IBEP20, Auth {
     
     using SafeMath for uint256;
 
     string constant _name = "StraightUp";
     ...
     constructor () Auth(msg.sender) {
         ...
         // NICE!
         autoLiquidityReceiver = 0x2D9D71950D096Dd7A2e3258416E15B6d7ED65a94;
         Burnwallet = 0x000000000000000000000000000000000000dEaD; 
         Burnfee = 0x000000000000000000000000000000000000dEaD;
     ...
     function changeFeeReceivers(address newLiquidityReceiver, address newBurnwallet, address newBurnfee) external authorized {
     ...
     function swapBack() internal lockTheSwap {
         ...
         (bool tmpSuccess,) = payable(Burnwallet).call{value: marketingShare, gas: 30000}("");
         (bool tmpSuccess1,) = payable(Burnfee).call{value: anothermarketingShare, gas: 30000}("");
