...
/**
Hi and welcome to the DailyDegenCoin brought to you by https://t.me/DailySafeDegenPlays!
This will be our main hub coin that you should hold and earn rewards in BUSD as we generate volume on our daily degen plays.  
Holding the daily degen plays will also give rewards in the main coin. We will also buyback and burn tokens in this coin 🔥
Tokenomics: 6% liquidity, 4% BUSD rewards, 4% marketing, 1% buyback.
https://t.me/DailyDegenCoin
**/
...
contract DailyDegenCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DailyDegenCoin";
    string constant _symbol = "DDC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 5 / 1000; // 5%
