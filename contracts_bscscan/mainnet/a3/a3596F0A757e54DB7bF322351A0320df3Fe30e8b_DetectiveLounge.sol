...
/**
This launch is brought to you by @DetectiveCalls, @DetectiveBSCApelounge & @ApeLoungeToken . 
*/
...
library Address{
 ...
 contract DetectiveLounge is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6Dc72781128fEa9D4C4000f45E2ad3969f26C94E;
    address public donationWallet = 0x62dD81f7449Ea27b556F83A3c004312E03F2D63b;

    string private constant _name = "Detective Lounge";
    string private constant _symbol = "DCL";
    ...
    Taxes public taxes = Taxes(2, 7, 3, 3);
    Taxes public sellTaxes = Taxes(1, 7, 5, 4);
