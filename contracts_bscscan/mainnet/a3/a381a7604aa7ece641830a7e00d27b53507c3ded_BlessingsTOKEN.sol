...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 35 * 60;
...
contract BlessingsTOKEN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BlessingsTOKEN";
    string constant _symbol = "JESUS";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 10000; // 0.5% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x9893001240aF48a55dc6D13396186dFe0Bfe3c3a;
