...
contract TomBaby is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xDD4bD61a283EDA1093238A3C6faA8712D9b8Dd35); // Marketing Address
    ...
    string private _name = "TomBaby";
    string private _symbol = "TomBaby";
