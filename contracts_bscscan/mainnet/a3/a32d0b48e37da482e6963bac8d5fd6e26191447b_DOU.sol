...
contract DOU is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xFf4ccC685a67e9B7Cc92309467CDfe946ACfEA50); // Marketing Address
    ...
    string private _name = "DOU";
    string private _symbol = "DOU";
