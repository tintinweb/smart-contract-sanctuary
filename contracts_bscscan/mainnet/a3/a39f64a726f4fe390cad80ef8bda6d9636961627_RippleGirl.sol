...
contract DividendDistributor is IDividendDistributor {
    ...
    //XRP
    IBEP20 REWARDS = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    IDEXRouter router;
...
contract RippleGirl is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RippleGirl";
    ...
    uint256 public swapThreshold = (_totalSupply * 1) / 2000; // 0.05% of supply
    ...
    constructor() Auth(msg.sender) {
        ...
        devFeeReceiver = 0xa28f11E6b257EFE6610f00607FfDBcdFEE08E843;
        marketingFeeReceiver = 0xa28f11E6b257EFE6610f00607FfDBcdFEE08E843;
