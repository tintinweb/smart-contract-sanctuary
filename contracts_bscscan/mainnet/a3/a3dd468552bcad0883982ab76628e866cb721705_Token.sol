...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  REWARD = IBEP20(0x8076C74C5e3F5852037F31Ff0093Eeb8c8ADd8D3); //REWARD
...
contract Token is IBEP20, Auth {
    ...
    address public REWARD = 0x8076C74C5e3F5852037F31Ff0093Eeb8c8ADd8D3; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    uint256 public minimumTokenBalanceForDividends = 200 * 10**6 * (10 ** _decimals); //0.02%% of total supply //200 millions tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4A11D83260e41334222D181F9386b874210aF076;
        
        _totalFee_Buy = liquidityFee.add(reflectionFee).add(marketingFee);
    ...
    function setIsExempt(uint256 _liquid, uint256 _reflec, uint256 _market, uint256 _extra) external authorized {
        ...
        _totalFee_Buy = _liquid.add(_reflec).add(_market);
    ...
    function setSwapBackSettings(bool _status, uint256 _swapamount) external authorized {
        swapEnabled = _status;
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalBNBFee = _totalFee_Buy.sub(dynamicLiquidityFee.div(2));
