...
contract MasterAccount is Ownable, ReentrancyGuard {
    ...
    event UpdateEmissionRate(address indexed user, uint256 defiPerBlock);
    ...
    function updatePool(uint256 _pid) public {
        ...
        defi.mint(address(defichip), defiReward);
    ...
    function enterStaking(uint256 _amount) public nonReentrant {
        ...
        defichip.mint(msg.sender, _amount);
    ...
    function leaveStaking(uint256 _amount) public nonReentrant {
        ...
        defichip.burn(msg.sender, _amount);
    ...
    function safeDefiTransfer(address _to, uint256 _amount) internal {
        defichip.safeDefiTransfer(_to, _amount);
    }
    ...
    function updateEmissionRate(uint256 _defiPerBlock) public onlyOwner {
        massUpdatePools();
        defiPerBlock = _defiPerBlock;
        emit UpdateEmissionRate(msg.sender, _defiPerBlock);
    }
}
