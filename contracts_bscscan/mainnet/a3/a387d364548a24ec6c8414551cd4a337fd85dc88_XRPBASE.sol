...
*    
*
*   BROUGHT TO YOU BY INKED UP DEV
* 
* 
* Contract Verified
* LP Locked
* ANTI BOT MEASURES
* 15% Buy
* 30% Sell - than will go to 20% after 1 hour
...
contract XRPBASE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'XRPBASE';
    string private constant _symbol = '$XRPB';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 5000 * 10**_decimals;//

    //Divider for the MaxBalance based on circulating Supply (4.0%)
    ...
    uint16 public constant MaxSellLockTime= 1800;
    ...
    //DevWallets
    address public TeamWallet=payable(0xbbE61c5cE060e8307cFf7F80665C686edeE0Ba67);
    address public walletTwo=payable(0x8C64c43161a3958591d68469Ee13709299dFD408);
    //TestNet
	...
	uint256 private antiWhale = 50 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;  //XRP
