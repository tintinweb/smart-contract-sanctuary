...
\/    \/\___/ \___/|_| |_\__/\___/ \___/|_| |_|
    ...
    Telegram: MoonSoonTG
    MoonSoon Token features:
   ⤏ 3% fee distributed to all holders every transaction
   ⤏ 7% fee auto added to the liquidity pool every transaction
   ⤏ Liquidity pool is locked 
   ⤏ Ownership will be renounced immediatly after launch.
...
contract MoonSoon is Context, IERC20, Ownable {
    ...
    string private _name = "MoonSoon (t.me/MoonSoonTG)";
