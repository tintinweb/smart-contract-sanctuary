...
contract SpongeCheems is IBEP20, Auth {
    ...
    string constant _symbol = "SPONGEC";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x8660AF6559E1eF6D1bf1F9f6EBf49e60EA195971;
        marketingWallet = 0x4641d8D24083382D73296C0F80e2C6BeDcCde074;
        devWallet = 0x4641d8D24083382D73296C0F80e2C6BeDcCde074;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair &&
            ...
            require(cooldownTimer[sender] < block.timestamp,"Du kannst nicht verkaufen AMK");
