...
/**
   Website - blackappletoken.com ( MAIN CONTRACT )
   BAPL Features
   SET SLIPPAGE TO 11% or higher
   3% fee auto added to liquidity
   7% fee auto distributed to all hodlers
   1% fee auto distributed to the charity wallet
   0% fee auto sent to the burn address, We will be doing strategic burns to safeguard token holders and ensure stability of the project
   Burns will grow exponentially as every transaction has a burn that also gets reflected tokens
*/
...
contract Blackapple is Context, IERC20, Ownable {
    ...
    string private _name = "Blackapple";
    string private _symbol = "BAPL";
    ...
    address public charityWallet = 0xc75Ce2c0e9456db2713F05f97Ab051197Af9bEea;
    ...
    uint256 private numTokensSellToAddToLiquidity = 571428570 * 10**9;
