...
/**
    ...
    Supply : 1,000,000,000,000,000 | 85% token burn | Verified contract
    No dev wallet | Ownership renounced | Liquidity locked forever
...
contract MoonFlokiMessiah is Context, IERC20, Ownable {
    ...
    string private _name = "MoonFlokiMessiah";
    string private _symbol = "MOONFM";
