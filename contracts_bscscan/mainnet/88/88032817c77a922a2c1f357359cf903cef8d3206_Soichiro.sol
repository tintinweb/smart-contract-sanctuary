...
/**
 *Soichiro
 Soichiro Honda was a Japanese engineer and industrialist. In 1948, 
 he established Honda Motor Co., Ltd. and oversaw its expansion from a wooden shack manufacturing 
 bicycle motors to a multinational automobile and motorcycle manufacturer. 
 Wikipedia
Born: November 17, 1906, Kōmyō
Died: August 5, 1991, Tokyo, Japan
Nationality: Japanese
 
 Token Features : 5% tax fees and 3% Create Blackhole Burn the supply
 LP BURN AT Launch
 Good Hunting
*/
...
contract Soichiro is IBEP20 {
    ...
    string public override name = "Soichiro";
    string public override symbol = "Soichiro";
