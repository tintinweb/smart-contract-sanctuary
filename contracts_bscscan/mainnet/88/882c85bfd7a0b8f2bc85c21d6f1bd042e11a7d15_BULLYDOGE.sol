...
* 20% for Marketing
*
* Total Supply 200 000  (95% Locked LP 5% marketing wallet)
* Max per Holder: 4000
* Max sell: 400
* Max buy: 800
*
* Sell Cool Down: 15 mins
*
* Stealth Launch

* Earn DOGE for holding
*
* TG:https://t.me/BULLYDOGE
*
*/
...
contract BULLYDOGE is IBEP20, Ownable
{
    ...
    uint256 public constant InitialSupply= 200000 * 10**_decimals;//equals 200000 token
    ...
    address public constant TeamWallet=0xE149b381d8Bf8aA20eAdfbbCB7795381c14A82Be;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;  //Binance-Peg DAI Token
