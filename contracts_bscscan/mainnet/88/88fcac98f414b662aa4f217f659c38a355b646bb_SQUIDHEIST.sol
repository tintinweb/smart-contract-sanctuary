...
contract Context {
 ...
 contract SQUIDHEIST is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "SquidHEIST";
    string private _symbol = "SQDHEIST";
    ...
    address private AllocateFee2 =0x768F172F885B5a403A413820EA86F1F8AfA1fc8f;
