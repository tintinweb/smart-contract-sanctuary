...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD5c9B110913D0EC1F052ebEEfbD0D6584CABF4BF;
...
contract ALMOSTCERTAINLYARUGPULL is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0F776d1D099789Ee596F9D9AD0D6aeb28671C079;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ALMOSTCERTAINLYARUGPULL";
    string private _symbol = "WENRUG";
