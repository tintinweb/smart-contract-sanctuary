...
CakeShoot - Hold and get rewarded in $CAKE
Total 16% Taxes
7% reward cake
2% marketing/contest for holders
7% LP
Telegram: https://t.me/CakeShoot
Stealth Launch UTC 1400
...
// CHANGE
contract CakeShoot is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CakeShoot";
    string constant _symbol = "CakeShoot";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 10,000,000,000
