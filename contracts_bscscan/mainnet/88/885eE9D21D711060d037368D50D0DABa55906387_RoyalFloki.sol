...
contract RoyalFloki is IBEP20, Auth {
    ...
    address BNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //reward
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;  //Dead
    address ZERO = 0x0000000000000000000000000000000000000000;   //Zero
    ...
    uint256 public swapThreshold = _totalSupply * 400 / 100000; // Token will add to Lp
    bool inSwap;
