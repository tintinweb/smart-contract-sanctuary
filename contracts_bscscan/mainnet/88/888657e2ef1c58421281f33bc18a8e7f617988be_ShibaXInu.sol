...
|  $$$$$$ | $$__  $$| $$| $$__  $$ |____  $$       \  $$$$/         | $$  | $$__  $$| $$  | $$
 ...
 /$$  \ $$| $$  | $$| $$| $$  | $$ /$$__  $$       /$$/\  $$        | $$  | $$  | $$| $$  | $$
|  $$$$$$/| $$  | $$| $$| $$$$$$$/|  $$$$$$$      | $$  \ $$       /$$$$$$| $$  | $$|  $$$$$$/
 \______/ |__/  |__/|__/|_______/  \_______/      |__/  |__/      |______/|__/  |__/ \______/ 
...
contract ShibaXInu is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "ShibaX Inu";
    ...
    uint256 public numTokens =  1500000000000 * 10**9;  //0.15%
    uint256 public numTokensToSell = 1000000000000 * 10**9;  //0.1%
    ...
    constructor() {
        ...
        _maxTxAmount = 10000000000000 * 10**9; // 0.5%
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromMAxTx[from] && !_isExcludedFromMAxTx[to]) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router)) {//buys
                ...
                if(previousClose == 0) { // at launch, set previousClose to 10% of starting price
                    updatePreviousClose(currentPrice);
                    previousClose = previousClose.mul(1).div(10);
                }
            }
            ...
            if (!inSwap && from != uniswapV2Pair && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) { //sells, transfers (except for buys)
                ...
                if (contractTokenBalance > numTokens && swapEnabled) {
                    swapTokensForEth(numTokensToSell);
                }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        (,,, uint256 tTransferAmount,,,) = _getValuesBuy(amount);
    ...
    function setNumTokens(uint256 _numTokens, uint256 _numTokensToSell) external onlyOwner() {
    ...
    function setAuthorized(address authorized, bool enable) external onlyOwner() {
        _isAuthorized[authorized] = enable;
    }
    ...
    function setPreviouClose(uint256 _previousClose) external onlyOwner() {
