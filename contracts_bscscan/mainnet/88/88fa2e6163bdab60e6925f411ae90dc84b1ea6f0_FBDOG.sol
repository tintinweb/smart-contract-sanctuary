...
contract FBDOG is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 76400000000 * 10**5;
    ...
    address public ownerAddres = address(0x4418738803A470B7e16467519D0c1252864F9C48);
    ...
    uint256 public _maxTxAmount = 76400000000 * 10 **5;
    uint256 private numTokensSellToAddToLiquidity = 76400000000 * 10 **5;
