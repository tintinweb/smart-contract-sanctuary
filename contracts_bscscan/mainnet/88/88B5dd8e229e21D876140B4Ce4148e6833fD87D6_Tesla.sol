...
contract Tesla is IBEP20, Auth {
    ...
    uint256 _totalSupply = 100000000000000 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000000000000000 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 100000000000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xb376F66E136193A29D0706424c655D0Ba3c58a69;
        devWallet = 0x06E512B64aBd70d4324D47cd3Df868A9bbfCA081;
