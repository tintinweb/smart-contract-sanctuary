...
// File: contracts/interfaces/IMuskySwapLottery.sol

pragma solidity ^0.8.4;

interface IMuskySwapLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in MKD per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in MKD token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInMKD: price of a ticket in MKD
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public muskySwapLottery;
     ...
     * @param _seed: seed provided by the MuskySwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == muskySwapLottery, "Only MuskySwapLottery");
    ...
    /**
     * @notice Set the address for the MuskySwapLottery
     * @param _muskySwapLottery: address of the muskySwap lottery
     */
    function setLotteryAddress(address _muskySwapLottery) external onlyOwner {
        muskySwapLottery = _muskySwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IMuskySwapLottery(muskySwapLottery).viewCurrentLotteryId();
    }
}