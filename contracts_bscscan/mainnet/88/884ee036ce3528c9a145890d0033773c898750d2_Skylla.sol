...
// change "name1" into ur name
    contract Skylla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Skylla";
    string private _symbol = "SKYLLA";
    ...
    uint256 internal _tokenTotal = 269_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0x56C37d62e14Be4029b8214fBb5175D6B4dfFBdE0;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
