...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5a81d7F811d5338b5f7a2A1566827E141D95f499;
...
contract DOGEDEX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x165EBC57F1891C68bAa4320568C39C55c918A1b1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Dogedex";
    string private _symbol = "DOGEDEX";
