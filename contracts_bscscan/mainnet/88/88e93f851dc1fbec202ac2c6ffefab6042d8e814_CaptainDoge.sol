...
// LFG https://t.me/captaindogeofficial
...
contract CaptainDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Captain Doge";
    string constant _symbol = "CDOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 10) / 10; // 100% of Total Supply. Change Later
    uint256 public _maxWalletSize = (_totalSupply * 10) / 10; // 100% of Total Supply. Change Later
    ...
    uint256 marketingFee = 1000;  //10%
    uint256 totalFee = 1400; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xeDDBDb1e4c0dB4c4A7da629f30F9aEA000A56990);
        marketingFeeReceiver = address(0x4Fd654BE12206f0554196141F12fc1B7A6B834d9);
    ...
    function setTxLimit(uint256 amount, uint256 divisor) external onlyOwner {
        require(amount > 0 && divisor > 0 && divisor <= 10000);
        _maxTxAmount = _totalSupply.mul(amount).div(divisor);
    }
