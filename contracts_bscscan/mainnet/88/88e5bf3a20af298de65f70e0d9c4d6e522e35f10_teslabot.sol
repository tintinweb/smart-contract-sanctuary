...
/**
   ...
   #Tesla Bot Robot (TeslaBot)

   Tesla unveiled plans for a human sized robot called Tesla Bot.
   This 125 lbs robot is made to navigate through a world build for humans
...
contract teslabot is Context, IERC20, Ownable {
    ...
    string private _name = "Tesla Bot Robot";
