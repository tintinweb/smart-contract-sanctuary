...
You can purchase our coins and can hold it,
so that you can earn the BNB rewards.
By stacking our coins, the initial stack rewards
will get a lot of high percentage in BNB coins.
Follow us on Telegram / Twitter channels.
Thanks for your support!

Please follow us for more info.

Our website : https://www.shibacattoken.com/
Twitter : https://twitter.com/Shiba_Cat_Token
Telegram : https://t.me/shibacattoken
...
contract SHIBACAT is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 100 * 10**7 * 10**4; // 1M
    ...
    uint256 public _maxTxAmount = 100 * 10**7 * 10**4; // 1M
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 100 * 10**7 * 10**4; // 1M
