...
contract FegX is ERC20, Ownable {
    ...
    uint256 public floorIncreasePercentage;
    uint256 public floorIncreaseEveryTimeInSeconds = 180;
    ...
    function apeTimeMonitoring(uint256 _currPrice) private{
        ...
        if(previousApeTime > 0 && block.timestamp - previousApeTime > floorIncreaseEveryTimeInSeconds){
