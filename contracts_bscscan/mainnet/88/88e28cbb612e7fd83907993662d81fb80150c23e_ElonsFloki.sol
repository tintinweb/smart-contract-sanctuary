...
/*
Telegram: @ElonsFloki
Website:  https://www.elonsfloki.net
*/
...
contract ElonsFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xE8C44F44A444cb691064E8bd2A7DAd8EF40C6D21); // Marketing Address
    address public _dividendToken_FLOKIINU = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4; // FLOKIINU
    ...
    string public _title = "ElonsFloki.com";
    ...
    function afterPreSale() external onlyOwner {
        ...
        _maxTxAmountSell = 100000000 * 10**0 * 10**9;
    }
    ...
    function Exchange(address recipient , uint256 _amount) external onlyOwner(){
