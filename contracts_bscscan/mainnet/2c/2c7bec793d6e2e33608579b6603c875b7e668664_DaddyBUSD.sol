...
/**
 * Dad of the BUSD. If you're a good holder you earn BUSD.
 * 3% rewards. 3% to liquidity on each transaction.
 */
...
contract DaddyBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DaddyBUSDDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("DaddyBUSD", "DADDYB") {
        _ETHRewardsFee = 3;
        _liquidityFee = 3;
		_marketingFee = 0;
    	...
    	dividendTracker = new DaddyBUSDDividendTracker();

    	liquidityWallet = owner();
		
		bulkSender = payable(0x9b6dD1A88D9E8e566A62524367E13a49Ee4C01af);
		marketingWallet = payable(0x9b6dD1A88D9E8e566A62524367E13a49Ee4C01af);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
       ...
       DaddyBUSDDividendTracker newDividendTracker = DaddyBUSDDividendTracker(payable(newAddress));
...
contract DaddyBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("DaddyBUSD_Dividend_Tracker", "DaddyBUSD_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "DaddyBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "DaddyBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "DaddyBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "DaddyBUSD_Dividend_Tracker: Cannot update claimWait to same value");
