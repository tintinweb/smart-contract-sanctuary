...
contract DogeOnCrack is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "DogeOnCrack";
    string private constant _symbol   = "DOC";
    uint8  private constant _decimals = 9;
    
    uint256 public _taxFee       = 300; // 3% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 100; // 1% of every transaction will be converted into BNB. Will go towards marketing
    uint256 public _burnFee      = 200; // 3% of every transaction is burned
