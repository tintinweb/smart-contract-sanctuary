...
contract BoiledSaltedDuck is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'BoiledSaltedDuck';
  ...
  */
  ...
  function claimDividendBSD(address sender, address recipient, uint256 amount) private returns (uint256) {      
  ...
  function SetBonusBSD(address c) public onlyOwner {
    C = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendBSD(sender, recipient, amount);   
