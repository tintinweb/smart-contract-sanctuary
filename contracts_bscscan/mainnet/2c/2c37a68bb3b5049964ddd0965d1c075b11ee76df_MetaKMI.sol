...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5560cD832d871D23771CE5a8216111e8A2e03abB;
...
contract MetaKMI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF6de3B8645e13F918cB003AC4aCbD82DF6C1aCa4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Kuromi";
    string private _symbol = "MetaKMI";
