...
/**
     ...
     .
       ...
       I suggest by name : https://t.me/FEGcraft
       ...
       I will renounce the ownership to burn addresses to transfer #FEGcraft to the community, make sure it's 100% safe.
    
       I will add .3 BNB and all the left 10% total supply to the pool
       Can you make #FEGcraft 10000X? 
       ...
       it's the best part of the #FEGcraft idea, increasing the liquidity pool automatically, 
...
contract FEGcraft is Context, IERC20, Ownable {
    ...
    string private _name = "FEG CRAFT";
    string private _symbol = "FEGcraft";
