 ...
 *      - Functionality for max transaction size has been added (1% of total supply)
...
contract SpiderDoge is Context,IBEP20,Ownable {
    ...
    string private constant _name = "SpiderDoge";
