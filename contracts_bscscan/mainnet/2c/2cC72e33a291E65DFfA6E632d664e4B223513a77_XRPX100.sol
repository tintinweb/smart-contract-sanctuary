 ...
 * 
 https://t.me/XRPx1000
 HOLD AND WIN INSANE REWARDS IN XRP
 QUESTO TOKEN È CREATO DA SVILUPPATORI ITALIANI
 */
library SafeMath {
...
contract XRPX100 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "XRPX100";
    string constant _symbol = "XRPX100";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 20000000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xE63a3C380dc66e47182180E02B631E27B7bDA880; //WALLET DEV
