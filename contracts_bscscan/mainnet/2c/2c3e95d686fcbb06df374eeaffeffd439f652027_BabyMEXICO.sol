...
/**
 ...
 @BabyMexico proposes an innovative feature in its contract.

 DIVIDEND YIELD PAID IN BNB! With the auto-claim feature,
 simply hold @BabyMexico and you'll receive BNB automatically in your wallet.
 
 Hold @BabyMexico and get rewarded in BNB on every transaction!

 telegram: https://t.me/BabyMexicoToken
 
 webside: https://babymexico.net/
...
contract BabyMEXICO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMexico";
    string constant _symbol = "BABYMEX";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa719316848fe9b69863d32e779a979D9287DcEE9;
