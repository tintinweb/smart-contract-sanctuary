...
Telegram: https://t.me/killerbeantoken
...
contract Context {
 ...
 contract KillerBeanInu is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "KillerBeanInu";
    string private _symbol = "KILLERBEAN";
    ...
    address private _NormalOwnership = 0x7A3F75EB66186bDd670ca04502370AbB684f7872;
