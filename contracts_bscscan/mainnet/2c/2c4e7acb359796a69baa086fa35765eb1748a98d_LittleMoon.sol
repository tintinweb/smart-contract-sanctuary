...
Little Moon 
is an defi project, goal achieving success on the Binance Smart Chain.
we want to become one of the greatest in meme history. our task is to increase your investments and to realize our dreams together.

 5% for the Liquidity pool
 3% redistributed between all holders
 1% Burn
 2% Marketing
...
contract LittleMoon is Context, IERC20, Ownable {
    ...
    string private _name = "LittleMoon";
    string private _symbol = "LittleMoon";
