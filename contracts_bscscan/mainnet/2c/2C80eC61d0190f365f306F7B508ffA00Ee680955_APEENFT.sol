...
contract APEENFT is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 486386386; //963 million
    ...
    string private _name = "APEE NFT";
    string private _symbol = "APEENFT";
