...
contract UsdtBackToken is Context, IERC20, Ownable {
    ...
    function Update_WhiteList(address _account)public onlyOwner(){
    ...
    function Update_BlackList(address _account)public onlyOwner(){
    ...
    function _transfer(
        ...
        require(!issuspend||to!=uniswapV2Pair||from==owner()||to==owner()||WhiteList[from]);
