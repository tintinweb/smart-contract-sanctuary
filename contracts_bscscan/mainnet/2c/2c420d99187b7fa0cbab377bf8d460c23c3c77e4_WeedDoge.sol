...
| $$$/ \  $$$| $$      | $$      | $$  | $$| $$  | $$| $$  | $$| $$  \ $$| $$      
| $$/   \  $$| $$$$$$$$| $$$$$$$$| $$$$$$$/| $$$$$$$/|  $$$$$$/|  $$$$$$/| $$$$$$$$
|__/     \__/|________/|________/|_______/ |_______/  \______/  \______/ |________/
                                                                                   

 TG: https://t.me/WeedDoge
 
 Hodl $WeedDoge and get DOGE automatically in your wallet every hour or so!
 $DOGE: 0xbA2aE424d960c26247Dd6c32edC70B295c744C43
 
 # of Tokens: 100,000,000,000 (100 Billion)
 Max Wallet Size = 2,500,000,000 (2.5 Billion or 2.5%)
 Max Transaction Size = 500,000,000 (500 million or 0.5%)
 
 Reflection/Taxes: 4% in DOGE, 2% in Liquidity, 4% to Marketing
 
 Buy Slippage: 10-12% (16% should be OK)

 *** THE MAX A WALLET CAN HAVE IS 2,500,000,000! THAT IS 3%! YOU CAN SELL A MAX OF 0.5%! ***
...
// CHANGE
contract WeedDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Weed Doge";
    string constant _symbol = "WeedDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 200; // 0.5% MAX 500,000,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 200; // 2.5% MAX 2,500,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x7d9F9458de76976f7f8BB412f4196EeA17E09D96);
