...
contract NTK is
    BASEToken("NANOTOKEN", "NTK", 1700 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    constructor() {
        ...
        marketing = 0xaD3dCB9fEB517f33F377e3CaF38a596135260AC4;
    ...
    function swapBack() internal swapping {
            ...
            )
        {
          ...
          //(tmpSuccess,) = payable(marketing).call{value: amountBNBMarketing, gas: 30000}("");
