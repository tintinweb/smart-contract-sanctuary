...
// CHANGE
contract LazyShiba is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "LazyShiba";
        string constant _symbol = "$LS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 3% MAX 30,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xE84476420197E6d5bE208eD1cF5B518E05Ad294D);
