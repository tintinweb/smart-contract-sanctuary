...
contract Axolotl is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xB7D9Ca1Fa452525B0D5dC7f78f81d747CfEF670D); // Marketing Address
    ...
    uint256 private _tTotal = 600000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Axolotl";
    string private _symbol = "Axolotl";
    ...
    uint256 public _maxTxAmount = 600000000 * 10**2 * 10**9;
