...
contract ClassicCardano is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ClassicCardanoDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0xB3119c1CF59C454b66eA54f653c3fF8F8cc506a7;
    ...
    constructor() public ERC20("Classic Cardano", "$$ClassCardano") {

    	dividendTracker = new ClassicCardanoDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ClassicCardanoDividendTracker newDividendTracker = ClassicCardanoDividendTracker(payable(newAddress));
...
contract ClassicCardanoDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("ClassicCardano Dividends", "ClassicCardano_dividends") {
    	claimWait = 3600;
