...
MoonMaxADA - Hold and get rewarded in $ADA
Total 20% Taxes
12% ADA REWARDS, 5% AUTO-LP, 3% Marketing Fund
Telegram: https://t.me/MoonMaxADA
...
// CHANGE
contract MoonMaxADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MoonMaxADA";
    string constant _symbol = "MMADA";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xba7DF68faE9F2855C4DD553340FcaDaAA1cC03e9);
