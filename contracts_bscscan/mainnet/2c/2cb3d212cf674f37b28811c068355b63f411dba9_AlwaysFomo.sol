...
contract AlwaysFomo is Context, IERC20, Ownable {
    ...
    string private constant _name = "AlwaysFomo";
    ...
    address payable public charityAddress = payable(0xcE1Ec86C1A0d11329B60C503501c1A223B729Aaa);
