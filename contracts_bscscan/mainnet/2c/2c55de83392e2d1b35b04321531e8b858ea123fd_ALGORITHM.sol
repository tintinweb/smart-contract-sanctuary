...
ALGORITHM CHAIN and a framework for building and connecting Binance Smart Chain-compatible blockchain networks. Aggregating scalable solutions on Binance Smart Chain supporting a multi-chain Binance Smart Chain ecosystem.Our mission is to bring a higher concentration of volume into a less saturated environment, with an emphasis on efficiency of exploration in blockchain technology.

Check our Website : https://algorithmchainbsc.com/
*/
...
contract ALGORITHM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ALGORITHM CHAIN";
    string private _symbol = "ALGORITHM";
    ...
    // Max Tx amount to be 5 trillion
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to] && cooldownEnabled) {
                ...
                buycooldown[to] = block.timestamp + (20 seconds);
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // The remaining BNB balance is to be sent to the marketing wallet
