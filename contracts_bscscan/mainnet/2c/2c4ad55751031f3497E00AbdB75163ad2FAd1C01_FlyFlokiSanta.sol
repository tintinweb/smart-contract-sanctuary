...
contract FlyFlokiSanta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlyFlokiSanta";
    string private _symbol = "FlyFlokiSanta";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE8A437c19E85336f5ea8a933120091627d71Bc9E); // Marketing Address
    address payable public teamWalletAddress = payable(0x356d2Eb8599341e24E1dD573BAF6F6c850419366); // Team Address
    ...
    uint256 public _buyLiquidityFee = 24;
    uint256 public _buyMarketingFee = 25;
    uint256 public _buyTeamFee = 50;
