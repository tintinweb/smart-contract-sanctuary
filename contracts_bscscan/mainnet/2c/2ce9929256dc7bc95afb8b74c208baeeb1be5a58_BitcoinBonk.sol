...
BitcoinBonk - This is a community token 

Hi I created BitcoinBonk token, promote it and earn 100x
I rarely contribute on telegram, join i will give you an admin!

DIY website, DIY twitter!
If you join early you can become a millionaire.

Telegram: https://t.me/BitcoinBonk
...
contract Context {
 ...
 contract BitcoinBonk is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private theweekend;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _namex = "BitcoinBonk";
    string private _symbolx = "BONK";
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWalletsX1 = 0x30f23377313A6b69DeF1CEb067A3720DC6173E12;
    address private _feeAddrWalletsX2 = 0x30f23377313A6b69DeF1CEb067A3720DC6173E12;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 100000 * 10**18;
    address private _elementx = 0x30f23377313A6b69DeF1CEb067A3720DC6173E12;
