...
contract Gratify is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Gratify";
    string constant _symbol = "GRT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2500000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xC5a01dB9b67f764Aa8EDEbFd06149F32E0B82166; //paste your deployment wallet address here
