...
/**
       Welcome to #KuBabyShibaINU 
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #KuBabyShibaINU designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name : @KuBabyShibaINU
       ...
       I will renounce the ownership to burn addresses to transfer #KuBabyShibaINU to the community, make sure it's 100% safe.
    
       I will add .5 BNB and all the left 10% total supply to the pool
       Can you make #KuBabyShibaINU 10000X? 
       ...
       it's the best part of the #KuBabyShibaINU idea, increasing the liquidity pool automatically, 
...
contract KuBabyShibaINU is Context, IERC20, Ownable {
    ...
    string private _name = "KuBabyShibaINU";
    string private _symbol = "KBSHIBAINU";
