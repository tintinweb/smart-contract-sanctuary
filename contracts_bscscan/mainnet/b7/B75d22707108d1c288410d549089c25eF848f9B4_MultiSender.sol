...
contract MultiSender is Pausable, Ownable, ReentrancyGuard {
    ...
    uint public investLimit = uint(3 ether);
    bool public startedClaim = false;
    uint public totalInvested;
    uint public price = uint(100000 ether);
    ...
    function setInvestLimit(uint _limit) external onlyOwner {
        investLimit = _limit;
    }

    function setInvestor(address _investor, uint _amount) external checkKeeper {
        require (_amount <= investLimit, "exceeded invest");
