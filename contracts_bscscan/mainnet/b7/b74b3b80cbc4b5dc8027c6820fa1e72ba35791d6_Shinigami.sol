...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x057DadAf09B0fc7a65731c02a6937b68AA32Cbde;
...
contract Shinigami is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x670d636B8962644690B0a6190Ea874A86c6e5352); 
    address payable private Wallet_Token_Burn = payable(0x057DadAf09B0fc7a65731c02a6937b68AA32Cbde); 
    address payable private Wallet_Dev = payable(0x057DadAf09B0fc7a65731c02a6937b68AA32Cbde); 
    ...
    string private _name = "Shinigami Eyes"; 
    string private _symbol = "$Eyes";  
