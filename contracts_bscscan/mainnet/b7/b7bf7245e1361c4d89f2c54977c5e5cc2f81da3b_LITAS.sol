...
/**
LTU:
Litas ($LIC) tai senoji, lietuvių širdyse giliai įstrigusi valiuta. Šis BEP-20 Tokenas buvo sukurtas Lito garbei bei siekiui įamžinti nepamirštamus ir unikalius mūsų tautos prisiminimus, "perliukus"... 
   
ENG:   
Litas ($LIC) is previous Lithuania currency, stuck in every Lithuanian heart. This BEP-20 Token was created to perpetuate this memoriable currency of our country and some other unique memories.
*/
...
contract LITAS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x7e09bAa18f128811f3C7D1cF76550334FD12ef4C); // Marketing Address
