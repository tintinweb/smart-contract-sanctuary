...
contract RSGPcontract is IBEP20, Auth { //CHANGE THIS
    using SafeMath for uint256;
    ...
    string constant _name = "RuneScape Gold Pieces";
    string constant _symbol = "RSGP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2147483647 * (10 ** _decimals);
