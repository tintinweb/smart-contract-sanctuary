...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    mapping (uint256 => bool) private isReviewed;
...
// File: contracts/KingLive721.sol
...
contract KingLive721 is ERC721Pausable, AccessControl {
    ...
    function create(string memory _tokenURI) public payable returns (uint256 tokenId) {
        ...
        emit Create(msg.sender,tokenId,_tokenURI);
    }
