...
* ($BCO)
*
* PASSIVE INCOME USDT REWARDS FOR HOLDING 
* 
* Stealth Launch
* Contract Verified
* LP Locked
...
* Total Supply: 8 000 000 000 (100% Locked)
* Max per Holder: 24 000 000
* Max sell:   12 000 000
* Max buy:  20 000 000
* 
*
* https://t.me/babyCoinbase
*/
...
//BABY COINBASE Contract /////////////

contract BCOIN is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BCOIN';
    string private constant _symbol = 'BCO';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 8000000000 * 10**_decimals;//
    ...
    address public constant TeamWallet=0xD30b542d3CE6D41839B32dC861C5f912828532A5;
	...
	uint256 private antiDump = 12000000 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x55d398326f99059fF775485246999027B3197955;  //USDT TETHER
