...
/**
       ...
       Welcome to #BabyFreedom 
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BabyFreedom designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name : @BabyFreedomOfficial
       ...
       I will renounce the ownership to burn addresses to transfer #BabyFreedom to the community, make sure it's 100% safe.
    
       I will add .5 BNB and all the left 10% total supply to the pool
       Can you make #BabyFreedom 10000X? 
    
       1,000,000,000,000.000 total supply
       30,000,000,000,000 tokens limitation for trade, which is 0.5% of the total supply
       ...
       it's the best part of the #BabyFreedom idea, increasing the liquidity pool automatically, 
...
contract BabyFreedom is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Freedom";
    string private _symbol = "BABYFRDM";
    ...
    uint256 private minimumTokensBeforeSwap = 15000 * 10**6 * 10**9; 
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private liquidAddress = 0xFc96DEe6774f677aB7ac63536600366Dc26E3EFA;
