...
/**
 * tweetydoge 
 * the doge and twitter revolution has just begun
 * https://t.me/tweetydoge
 * https://twitter.com/dogetweety
 * Total Tax 14% Buy & Sell to reward Diamond tweetydoge Hands
*/
...
contract tweetydoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "tweetyDoge";
    string constant _symbol = "TweetyD";
