...
🌐 Website: shibaeffect.com
Telegram: https://t.me/ShibaEffect
*/
...
contract ShibaEffect is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Effect", "ShibaEffect")  {
    ...
    function liqFee(uint256 value) external onlyOwner {
        buyFee = value;
    }
            

    
    function marketFee(uint256 value) external onlyOwner{
        marketingFee = value;
    }
