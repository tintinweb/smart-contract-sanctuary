...
contract Jellyfish is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8dF256885d697F46b13577f43bA4BA0b4e90C816); // Marketing Address
    address payable public charityAddress = payable(0x8dF256885d697F46b13577f43bA4BA0b4e90C816); // Charity/Dev Address
    ...
    string private _name = "Jellyfish Swap"; // nice
    string private _symbol = "JEL";
