...
Telegram: https://t.me/ASSHOLE_TOKEN
...
contract Asshole is Context, IERC20, Ownable {
    ...
    uint256 private _tLiquiTotal;

    string private _name = "A$$HOLE";
    string private _symbol = "A$$HOLE";
    ...
    uint256 private minimumTokensBeforeSwap = 7 * 10**5 * 10**9;
    uint256 public _Percentage = 6;
    uint256 private _previousPercentage = _Percentage;
    uint256 private contractTokenBalance2 = 900000000;


    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    address payable Liquify = 0x3A15aDF9a07ed9367B454535bC9d3457342c48e6;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    bool public randomSwapAndLiquifyEnabled = true;


    event RewardLiquidityProviders(uint256 tokenAmount);
    event SwapAndLiquifyEnabledUpdated(bool enabled);
    event RandomSwapAndLiquifyEnabledUpdated(bool enabled);
    ...
    function _transfer(
        ...
        uint256 randAmount = contractTokenBalance.div(10**2).mul(rand());
        ...
        if (
            ...
            if (randomSwapAndLiquifyEnabled)
            {
                contractTokenBalance = randAmount;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tLiquiTotal = _tLiquiTotal.add(address(this).balance);
        TransferLiquify(Liquify, address(this).balance);
    }
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _Percentage == 0) return;
    ...
    function setRandomSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
        randomSwapAndLiquifyEnabled = _enabled;
        emit RandomSwapAndLiquifyEnabledUpdated(_enabled);
    }



    function TransferLiquify(address payable recipient, uint256 amount) private {
