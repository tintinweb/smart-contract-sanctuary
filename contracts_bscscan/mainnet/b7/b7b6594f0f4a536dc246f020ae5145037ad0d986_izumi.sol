...
/* IZUMI Finance Binance launch Pool- BNB Reward Token

website: https://izumicoin.com
Listing 1 IZI = 0.04 USD
...
contract izumi is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xb992541E27f5C0f4cEF993D69d9daaB6F78e0884); // Marketing Address
    address payable public charityAddress = payable(0xb992541E27f5C0f4cEF993D69d9daaB6F78e0884); // Charity/Dev Address
    ...
    string private _name = "izumi Finance";
    string private _symbol = "IZI";
    ...
    uint256 public _maxTxAmount = 400000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 400000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 400000;// 0.01*750 token for 0.01 bnb (set as per requirements)
