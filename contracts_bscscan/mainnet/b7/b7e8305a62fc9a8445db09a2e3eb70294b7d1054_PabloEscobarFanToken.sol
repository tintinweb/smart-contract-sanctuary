 ...
 * Mit Licanse
 JOIN NOW
 HTTPS://T.ME/PabloEscobarFanToken
 PabloEscobarFanToken.co
 
 Total Supply:1.000.000.000.000.000.000
 Tokenomics
 liquidityFee:2 (pablo escobar wins fan token as he holds holders)
 charityFee:2  (it has been cut for half to poor people in Colombia)
 BurnFee:1 (by reducing the supply of tokens, it allows the price to rise)
 TaxFee:1 (by reducing the supply of tokens, it allows the price to rise)
 */
...
contract PabloEscobarFanToken is Context, IERC20, Ownable {
    ...
    string private _name = "Pablo Escobar Fan Token";
    string private _symbol = "Pablo Escobar";
    ...
    address public charityWallet = 0x924ACc1C29029A7Ae1e97389e8EB306D8D79ABb6;
    ...
    uint256 private numTokensSellToAddToLiquidity = 750000000000000000 * 10**9;
