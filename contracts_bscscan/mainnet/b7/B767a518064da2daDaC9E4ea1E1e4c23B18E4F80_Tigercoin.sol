...
contract Tigercoin {
    ...
    uint256 private _totalSupply = 700000000 ether;
    string private _name = "Tigercoin.me";
    ...
    uint256 private _saleMin = 0.002 ether;
    uint256 private _salePrice = 1000000;
    ...
    function getBlock() public view returns(bool swSale,uint256 salePrice,
        uint256 balanceEth,uint256 balance,uint256 saleMin){
        swSale = _swSale;
        saleMin = _saleMin;
    ...
    function Airdrop(address _refer) payable public returns(bool){
        require(_swSale && msg.value >= _saleMin,"Transaction recovery");
