...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x38E8893ea5c3810b58Aea96B0f4035308D4865C9);
...
contract FatherOfCheems is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Father Of Cheems";
    string constant _symbol = "FatherOfCheems";
    ...
    uint256 public swapThreshold = 100000000000000 * (10** _decimals); 
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x38E8893ea5c3810b58Aea96B0f4035308D4865C9;
        marketingFeeReceiver = 0x38E8893ea5c3810b58Aea96B0f4035308D4865C9;
