...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also FlokiMoscowed.
...
// File: contracts/FlokiMoscowDividendPayingToken.sol
...
// File: contracts/FlokiMoscow.sol
...
contract FlokiMoscow is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    address private _marketingWallet = address(0xE20BD7E55cf3988E02B556ec5De01D0864F84eFb);
    address private _devWallet = address(0x3863592C0c0F5d100550b63CDC75c17C908559Ed);
    ...
    FlokiMoscowDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;
    address public devWallet = _devWallet;

    uint256 public maxBuyTranscationAmount = 10000000 * (10**18); // 1% of total supply
    uint256 public maxSellTransactionAmount = 20000000 * (10**18); // 1% of total supply
    uint256 public swapTokensAtAmount = 500 * (10**18);
    uint256 public _maxWalletToken = 5000000 * (10**18); // No limit
    ...
    constructor() public ERC20("FlokiMoscow", "FMW") {
    	...
    	dividendTracker = new FlokiMoscowDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "FlokiMoscow: The dividend tracker already has that address");

        FlokiMoscowDividendTracker newDividendTracker = FlokiMoscowDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "FlokiMoscow: The new dividend tracker must be owned by the FlokiMoscow token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "FlokiMoscow: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "FlokiMoscow: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "FlokiMoscow: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "FlokiMoscow: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "FlokiMoscow: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "FlokiMoscow: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "FlokiMoscowBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "FlokiMoscow: This account cannot send tokens until trading is enabled");
        }
...
contract FlokiMoscowDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("FlokiMoscow_Dividend_Tracker", "FlokiMoscow_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "FlokiMoscow_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "FlokiMoscow_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FlokiMoscow contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "FlokiMoscow_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "FlokiMoscow_Dividend_Tracker: Cannot update claimWait to same value");
