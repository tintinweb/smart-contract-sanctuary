...
contract BABYPOLYGON is Context, IERC20, Ownable {
    ...
    string private _name = "BABY POLYGON";
    string private _symbol = "BPOLYGON";
    ...
    uint256 private constant _Burn_FEE = 500; // 3%
