...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6D3955EE83d288DFCC663acEb0f43CEc1C7C2F3B;
...
contract Divinetoken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE99AfeCAF187eE86A95C3619a3f351b1A564BB13;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 20000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Divinetoken";
    string private _symbol = "DIVI";
