...
6% rewards Fees in ADA - directly auto claimed into your wallet just by holding DeFino INU Tokens !
5% to marketing and 5% to liquidity pool.
Diamond hands will be rewarded !!

Official Telegram group : https://DeFinoINUOfficial
...
import "./DeFIUDividendTracker.sol";

contract DeFIU is ERC20, Ownable {
    ...
    DeFIUDividendTracker public dividendTracker;
    ...
    uint256 public liquidityFee = 88;
    ...
    constructor() public ERC20("DeFino INU", "DeFIU") {

    	dividendTracker = new DeFIUDividendTracker();

        _marketingWalletAddress = 0x77BA35cd37ea5881311909d7B5959d997939FcFD;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "DeFIU: The dividend tracker already has that address");

        DeFIUDividendTracker newDividendTracker = DeFIUDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "DeFIU: The new dividend tracker must be owned by the DeFIU token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DeFIU: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "DeFIU: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DeFIU: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DeFIU: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "DeFIU: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "DeFIU: Cannot update gasForProcessing to same value");
