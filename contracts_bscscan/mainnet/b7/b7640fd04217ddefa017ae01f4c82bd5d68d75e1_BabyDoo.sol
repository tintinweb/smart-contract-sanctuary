...
//
// $BABYDOO proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN BUSD! With the auto-claim feature,
// simply hold BABYDOO and you'll receive $BUSD automatically in your wallet.
// 
// Buy BABYDOO and get rewarded in $BUSD on every transaction!
//
//
// 📱 Telegram: https://t.me/BabyDooBSC
// 🌎 Website: https://www.BabyDoo.Finance
...
contract BabyDoo is ERC20, Ownable {
    ...
    constructor() ERC20("BabyDoo", "BABYDOO") {
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    require(sellFeeIncreaseFactor >= 100 && sellFeeIncreaseFactor <= 200, "BabyDoo: Sell transaction multipler must be between 100 (1x) and 200 (2x)");
  	    sellFeeIncreaseFactor = multiplier;
  	}
  	
  	function setMarketingDivisor(uint256 divisor) external onlyOwner {
  	    require(marketingDivisor >= 0 && marketingDivisor <= 100, "BabyDoo: Marketing divisor must be between 0 (0%) and 100 (100%)");
    ...
    function triggerBuyBack(uint256 amount) public onlyOwner {
        require(!swapping, "BabyDoo: A swapping process is currently running, wait till that is complete");
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "BabyDoo: The new dividend tracker must be owned by the FLOKIBUSD token contract");
    ...
    function updateDividendRewardFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "BabyDoo: Dividend reward tax must be between 0 and 10");
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(newBuyBackWallet != buyBackWallet, "BabyDoo: The liquidity wallet is already this address");
...
contract BabyDooDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BabyDoo_Dividend_Tracker", "BabyDoo_Dividend_Tracker") {
    	claimWait = 3600;
