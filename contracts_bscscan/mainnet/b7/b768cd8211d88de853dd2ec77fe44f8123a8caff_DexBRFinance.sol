...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 28;
...
contract DexBRFinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DexBR";
    string constant _symbol = "DexBR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 21000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100000* _totalSupply / 1;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x49a71CAbe4Bb00cf6c5DDCC9b0C6aB1Fb033Cd6B;
        charityFeeReceiver = 0x3297218f77cdaB370765F0f5362FC0E4140ee88e;
