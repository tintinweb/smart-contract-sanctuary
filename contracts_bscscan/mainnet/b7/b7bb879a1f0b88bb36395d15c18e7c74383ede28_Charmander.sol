...
/*
    ...
    CharmanderTOKEN - 10% BUSD Redistribution - Auto Claim BUSD by just holding!
    
    10% Auto Rewards in BUSD added to holder wallets 
    ...
    📌   Anti-Dump mechanis
    📌   10% BUSD Will be Added to holder’s wallets
    
    We will add 1 BNB to liquidity and burn and renounce ownership after launch.
...
contract Charmander is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "CharmanderTOKEN";
    string private constant _symbol   = "$CharmanderTOKEN";
