...
Telegram: https://t.me/Cheems_Pro
*/
...
contract CP is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _excludedFromFee;
    uint256 public _decimals = 9;
    uint256 public _totalSupply = 10101010 * 10 ** _decimals;
    uint256 public _maxTxAmount = 404040 * 10 ** _decimals;
    uint256 public _fee = 7;
    string private _name = "Cheems Pro";
    string private _symbol = "CHEEMSPRO";
