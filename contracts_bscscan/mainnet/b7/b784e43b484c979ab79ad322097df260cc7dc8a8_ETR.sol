...
contract ETR is IERC20, Ownable {
    ...
    constructor() {
        ...
        _rOwned[_fund1Address] = _rTotal.div(1000).mul(5);
        _owner = msg.sender;
        ...
        emit Transfer(address(0), tokenOwner, _tTotal.div(1000).mul(10));
        emit Transfer(address(0), tokenOwner, _tTotal.div(1000).mul(5));
    }
