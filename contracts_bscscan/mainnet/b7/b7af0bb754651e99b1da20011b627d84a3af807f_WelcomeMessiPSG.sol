...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PSG = IBEP20(0x9c28204D9802B9D9f8d19EBf374c5bb533c69D60);
    address WBNB = 0x9c28204D9802B9D9f8d19EBf374c5bb533c69D60;
    IDEXRouter router;
...
contract WelcomeMessiPSG is IBEP20, Auth {
    using SafeMath for uint256;


    address PSG = 0x9c28204D9802B9D9f8d19EBf374c5bb533c69D60;
    address public WBNB = 0x9c28204D9802B9D9f8d19EBf374c5bb533c69D60;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "WelcomeMessiPSG";
    string constant _symbol = "WMPSG";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 500000000000; // 0.5%
    ...
    uint256 public swapThreshold = _totalSupply / 200000000; // 0.005%
    bool inSwap;
