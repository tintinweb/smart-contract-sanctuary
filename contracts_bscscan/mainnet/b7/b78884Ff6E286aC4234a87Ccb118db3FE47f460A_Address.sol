...
contract Night1001 is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1000000000001 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = '1001 Night Token';
    string private _symbol = '1001N';
