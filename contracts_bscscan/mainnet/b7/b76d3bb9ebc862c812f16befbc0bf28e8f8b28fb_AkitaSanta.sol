...
/*
    ...
    🚀 Join us on the safest meme coin sphere, tired of getting rugged? tired of getting honeypot? 
    Baby Yoshi is here with LP locked, owner renounced and no initial dev wallet 😲 
    this may be the safest token there to offer. Join us on our journey with the community ❤️ to the moon. 
    Together. 🌕🚀
    
    🚂 Join us on the hype train
    https://twitter.com/BabyYoshiBSC
    https://t.me/BabyYoshiBSC
*/
...
abstract contract AntiBot is Tokenomics {
    ...
    uint256 public antiBotDuration = 7 minutes;
