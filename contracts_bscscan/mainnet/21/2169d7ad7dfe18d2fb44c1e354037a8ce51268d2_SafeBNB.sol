...
contract SafeBNB is ERC20Interface, babyMath {
    string public name = "Safe BnB";
    string public symbol = "SAFEBNB";
    uint8 public decimals = 18;
    uint256 public _totalSupply = 100000000000000000000000000; // 2 billion SIM in supply
