...
// File: contracts/AndreaLorenzon.sol

pragma solidity ^0.8.0;
pragma abicoder v2;

/**
 * @title Andrea Lorenzon
 * @notice Andrea Lorenzon NFT collection
 */
contract AndreaLorenzon is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        require((_maxSupply == 20) || (_maxSupply == 200) || (_maxSupply == 2000), "Operations: Wrong max supply");
