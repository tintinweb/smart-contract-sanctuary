...
/**
    The New Tokenomics innovations! We are proud to present BabyFegX Token with new innovations of tokenomics, We all know that Binance Smart Chain is a place where many coin and token projects are located, since rugs and honeypots are widely encountered, many people are worried about their investments.
    A new era begins! now you do not need to be afraid or worry of your investment, with BabyFegX Token we start the right step in Binance Smart Chain.
    
    
    It will be a stealth project to avoid sniper and bot buying.
	
    https://t.me/Baby_FegX
...
contract FegX is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x929e930cF8065213083Bc34e02365CD254187023;
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 sellTokens = contractTokenBalance.mul(marketingSplitValue + ADARewardsSplitValue).div(ADARewardsSplitValue + liquiditySplitValue + marketingSplitValue + bananaRewardSplitValue);
    ...
    function swapAndSendDividends(uint256 tokens) private{
        ...
        IERC20(ADA).transfer(_marketingWalletAddress, IERC20(ADA).balanceOf(address(this)).mul(30).div(100));
        IERC20(ADA).transfer(liquidityFeeReceiver, IERC20(ADA).balanceOf(address(this)).mul(30).div(100));
