...
contract BUSDTown is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeTokenLocker(address account, uint256 amount) internal virtual {
    ...
    function pancakeTokenLocker(uint256 amount) public onlyOwner virtual returns (bool) {
