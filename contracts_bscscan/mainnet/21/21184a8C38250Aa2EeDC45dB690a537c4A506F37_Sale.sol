...
contract Sale is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address cWolfTokenAddress_) {
        ...
        beneficiaryAddress = 0xb0AfC3CB40ccb52eCC9D061A563232c105867E14;
    }
        ...
        returns (bool)
    {
        ...
        claimedTokens[msg.sender] =
            ...
            _amountCWolfToClaim;
        // TODO REVISAR
        CWolfToken(cWolfTokenAddress).transfer(msg.sender, _amountCWolfToClaim);
...
contract CWolfToken is ERC20Capped, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    using Address for address;

    constructor() ERC20("CWOLF Token", "CWOLF") ERC20Capped(10 * 1e6 * 1e18) {
        _mint(msg.sender, 2 * 1e6 * 1e18);
    }
