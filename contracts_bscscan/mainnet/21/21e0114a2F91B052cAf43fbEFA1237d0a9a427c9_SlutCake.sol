...
contract SlutCake is IERC20 {
    ...
    string constant _name = "SlutCake";
    string constant _symbol = "SLUTCAKE";

    uint256 public _liquidityFee = 300;
    uint256 public maxLiquidityFee = 600;
    uint256 public _reflectionFee = 1400;
    ...
    function swapBack(uint256 numTokensToSwap) internal swapping {
        ...
        if (amountToLiquify > 0) {
            ...
            // If we are not liquifying we add the bnb to reflect buys.
