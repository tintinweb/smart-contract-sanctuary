...
contract DontbuythisDividendDistributor is IDividendDistributor {
...
contract Dontbuythis is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "The Dontbuythis Token";
    string constant _symbol = "THEDontbuythis";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 15**8* (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; // 1% (Change after deploy)
    uint256 public _maxSellTxAMount = _totalSupply / 100; // 1% (Change after deploy)
    uint256 public _maxHoldAmount = _totalSupply / 100; // 1% (Change after deploy)
    ...
    */
    ...
    uint256 public liquidityFee = 200; //all these are changeable after deployment
    ...
    uint256 public sellpremium = 400; 
    ...
    DontbuythisDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new DontbuythisDividendDistributor(address(router));
    ...
    function setDistributor(DontbuythisDividendDistributor dist)external authorized {
        distributor = dist;
    }
