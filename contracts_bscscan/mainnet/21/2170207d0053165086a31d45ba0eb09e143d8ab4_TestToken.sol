...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
...
contract TestToken is ERC20, Ownable {
    ...
    address public immutable BUSD = address(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    address private _marketingWallet = address(0xe1056070d797414fa9d6A4C4c0746Acb9C931715);
    ...
    uint256 public maxBuyTranscationAmount = 500000 * (10**18); // 5% of total supply
    uint256 public maxSellTransactionAmount = 100000 * (10**18); // 1% of total supply
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "TestToken: The new dividend tracker must be owned by the flokiETH token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TestTokenBSC: Account is already the value of 'excluded'");
