...
contract growBNB is Context, IBEP20, Ownable {
    ...
    function GetSwapSeconds() public view returns(uint256) {
        return _intervalSecondsForSwap.div(1);
    }
