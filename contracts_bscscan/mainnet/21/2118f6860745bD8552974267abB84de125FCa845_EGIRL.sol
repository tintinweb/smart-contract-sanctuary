...
/**
 welcome to ExplorerGirl, buckle up for this next moon shot, pure hype for the launch with some big name callers coming in! 
 LP will be locked and contract renounced to ensure the saftey of everyones funds join the TG for more info - https://t.me/ExplorerGirlBSC
...
contract EGIRL is IBEP20, Auth {
    ...
    string constant _name = "ExplorerGirl";
    string constant _symbol = "EGIRL";
