...
////////////////////////////////
 /**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #DOGENIE

    I make this #DOGENIE to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/DOGENIE_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #DOGENIE to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #DOGENIE 10000000X? 
   ...
   it's the best part of the #DOGENIE idea, increasing the liquidity pool automatically, 
...
contract DOGENIE is Context, IERC20, Ownable, Pausable {
