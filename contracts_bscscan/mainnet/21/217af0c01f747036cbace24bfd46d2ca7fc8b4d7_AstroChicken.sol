...
contract Context {
 ...
 contract AstroChicken is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloAJZU;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "AstroChicken";
    string private _symbol = "ASTROCHICKEN";
    ...
    address private _MarketingWalletAJZU = 0x621a49Ef9288cEa4056E76D383B91F0b282d9094;
