...
/**
   ...
   Welcome to PINKYDOGE
   
   This is a community token. If you want to create a telegram I suggest to name it to @PINKYDOGEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #PINKYDOGE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #PINKYDOGE 10000X? 
   ...
   it's the best part of the #PINKYDOGE idea, increasing the liquidity pool automatically, 
...
contract PINKYDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "PINKYDOGE";
