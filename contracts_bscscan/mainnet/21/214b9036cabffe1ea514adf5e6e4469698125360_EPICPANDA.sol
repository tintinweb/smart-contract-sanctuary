...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x04d59087b01bE1dd26beFe938534A7323eea9408;
...
contract EPICPANDA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0D1424F982db32808F7287C537462b877E92832a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "EPICPANDA";
    string private _symbol = "EPANDA";
    ...
    uint256 public _maxTxAmount = 25000000000000 * 10**18;
