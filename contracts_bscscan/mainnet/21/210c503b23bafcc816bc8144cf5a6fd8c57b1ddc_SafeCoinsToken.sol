...
contract SafeCoinsToken is Context, IERC20, Ownable {
    ...
    address private _marketingAndDevelopmentWalletAddress = 0x0EDD142bdC76d4FCC30D5Caa711E29678a4622d8;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1 * 10**10 * 10**10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SafeCoins.app";
    string private _symbol = "SafeCoins";
    ...
    constructor () {
        ...
        _isExcludedFromFee[_marketingAndDevelopmentWalletAddress] = true;
    ...
    function _takeFundOrBurn(address sender, address recipient, uint256 tFundOrBurn) private {
        ...
        if (sender.isContract() != true && recipient.isContract() != true) {
            ...
            _rOwned[_marketingAndDevelopmentWalletAddress] = _rOwned[_marketingAndDevelopmentWalletAddress].add(rFundOrBurn);
            if(_isExcluded[_marketingAndDevelopmentWalletAddress])
                _tOwned[_marketingAndDevelopmentWalletAddress] = _tOwned[_marketingAndDevelopmentWalletAddress].add(tFundOrBurn);
        }
    }
