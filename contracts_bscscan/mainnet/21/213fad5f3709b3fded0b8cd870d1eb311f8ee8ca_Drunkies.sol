...
contract Drunkies is ERC20Detailed, Ownable {
    ...
    uint256 public antiSniperPercentage = 95;
    ...
    constructor() ERC20Detailed("Drunkies", "$TS", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0xb2E1F413Ea80B19Ea7A9A3a244Cf2b319333A66A;
        ecosystemFeeReceiver = 0xe8F4eB4b73aC347951B0421443f21868df55C5d7;
        buyBackFeeReceiver = 0xE90f26832dDCa6fB1b5224465695b5D722b0eB41;
