...
/**
   ...
   #This is just the clone of Safemoon
   
   #It is a birthday gift for my daughter because it is just cool right ?
   
   #So Happy 5th Birthday Sara (born 4/12/2016 )

   #This has no other purpose than to be a worthless birthday gift for 5 year old young lady
   #
 */
...
contract BigNomo is Context, IERC20, Ownable {
    ...
    string private _name = "BigNomo";
    string private _symbol = "BIGNOMO";
