...
contract BabyDot is BSC, Math {
    string public name =  "Baby Dot" ;
    string public symbol =  "BDOT";
    ...
    function _transfer(address from, address to, uint tokens) private returns (bool success) {
        uint amountToBurn = Div(tokens, 20); // 5% of the transaction shall iyan be burned
