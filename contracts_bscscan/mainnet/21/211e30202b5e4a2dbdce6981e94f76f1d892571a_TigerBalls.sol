...
// Born To Bring Back Community Tokens 1000X Moonshots
// https://t.me/officialTigerballs
...
contract TigerBalls is Context, IERC20, Ownable {
    ...
    address public devWallet = 0xA951C4818ca42D427b03A9070dD67B09f6b41435;
    ...
    uint256 public _maxTxAmount = 50 * 10**9 * 10**9; //5% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**7 * 10**9;
    uint256 public _maxWalletToken = 10 * 10**10* 10**9;
