...
*    ($SINU)
*
*   Be rewarded with Sushi Swap for holding!!!! 
* 
* Fair Launch
* Contract Verified
* LP Locked
...
contract SUSHIINU is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SUSHIINU';
    ...
    uint16 public constant MaxBuyLockTime= 10;
    ...
    //DevWallets
    address public TeamWallet=payable(0x376A67BFc7F42D5C07f9F1F6425e8c94567CC11F);
    address public walletTwo=payable(0x19A204Ff293e4FB65DBFD44ed8b3c91420b3eb88);
    //TestNet
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x947950BcC74888a40Ffa2593C5798F11Fc9124C4;  //Sushi Swap
