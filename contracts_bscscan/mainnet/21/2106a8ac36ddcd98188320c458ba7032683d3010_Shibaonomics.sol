...
contract Shibaonomics is Context, iBEP20, Ownable {
  ...
  */
   ...
   * Requirements:
   *
   * - `recipient` cannot be the burnouut.
   ...
   * Requirements:
   *
   * - `spender` cannot be the burnouut.
   */
   ...
   *
   * Requirements:
   * - `sender` and `recipient` cannot be the burnouut.
 ...
 /**
  ...
  function _BurnTx(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: send to the burnouut");
   ...
   * total supply.
   *
   * Emits a {Transfer} event with `to` set to the burnouut.
   *
   * Requirements
   *
   * - `account` cannot be the burnouut.
   * - `account` must have at least `amount` tokens.
   */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: burn from the burnouut");
   ...
   * Requirements:
   *
   * - `owner` cannot be the burnouut.
   * - `spender` cannot be the burnouut.
   */
  function _approve(address owner, address spender, uint256 amount) internal {
    require(owner != address(0), "BEP20: approve from the burnouut");
    require(spender != address(0), "BEP20: approve to the burnouut");
