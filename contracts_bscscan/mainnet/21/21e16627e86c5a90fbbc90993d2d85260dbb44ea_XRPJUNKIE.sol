...
* 
* LAUNCHING MANY CONTRACTS AS DECOYS SO MAKE SURE 

* TO ONLY BUY CONTRACT THAT IS IN TELEGRAM
* 
*            https://t.me/XrpJunkie

* Total Supply:    20 Million
* Max per Holder:  300 Thousand
* Max sell:   150 Thousand
* Max buy:    150 Thousand
* 
*                      
* 
*/
...
contract XRPJUNKIE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'XRPJUNKIE';
    string private constant _symbol = '$XJK';
    ...
    uint16 public constant SellLimitDivider=132;
    ...
    uint16 public constant MaxSellLockTime= 5;
    ...
    uint16 public constant MaxBuyLockTime= 5;
    ...
    address public walletTwo=payable(0xc1752116Dc382e612264Fa8EC0E2141Bf8B54ae3);
    //TestNet
	...
	uint256 private antiWhale = 150000 * 10**_decimals;
