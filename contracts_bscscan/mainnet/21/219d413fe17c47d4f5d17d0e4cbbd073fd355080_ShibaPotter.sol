...
/**
 *  Shiba Potter has come to defeat the evil Fuddermort
 * 
 */
...
contract ShibaPotter is Context, IERC20, Ownable {
    ...
    string private _name = "Shib Potter";
    string private _symbol = "Shib Potter";
