...
contract Bremen is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "OrbitalSpaceX";
    string private constant _symbol = "OrbS";
    ...
    uint private constant _tTotal = 10000000000000 * 10**9;
    ...
    address payable private _marketingAddress = payable(0xfc8BD328854F1859c67373c21E7788138768Bd18);
    ...
    uint public _maxTxAmount = 10000000000000000 * 10**9;
    uint public _maxWalletSize = 10000000000000000 * 10**9;
    uint public _swapTokensAtAmount = 100000000000000 * 10**9;
