...
/**
   ...
   1% distribute to a holders wallet 
   ttl supply = 74,325
   decimals 18
*/
...
contract GTR is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 74325 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Skyline Classic";
    ...
    uint256 public maxWalletToken = 74325 * (10**18);
    ...
    uint256 public _maxTxAmount = 74325 * 10**18;
