...
contract YoshiZilla is Context, IERC20, Ownable {
    ...
    string private _name = "YOSHIZILLA";
    string private _symbol = "YOSHIZILLABSC";
    ...
    address payable private _marketingWallet = payable(0xac4f6b38fd85b15F4c2165433914eAE3F422FfD4);
    address payable private _devWallet = payable(0xac4f6b38fd85b15F4c2165433914eAE3F422FfD4);
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xac4f6b38fd85b15F4c2165433914eAE3F422FfD4] = true;
        _isExcluded[0xac4f6b38fd85b15F4c2165433914eAE3F422FfD4] = true;
        _excluded.push(0xac4f6b38fd85b15F4c2165433914eAE3F422FfD4);
