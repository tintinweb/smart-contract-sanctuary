...
contract Winx is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 100000000000000000000000 * 10**9;
  string private _symbol = "Winx Token";
  string private _name = "Winx";
