...
contract NanoPajeet is Context, IERC20, Ownable { 
    ...
    string private _name = "NanoPajeet"; 
    string private _symbol = "NPAJ"; 
    ...
    address public devWallet = 0x0c23f6543A0FC57D3f1Eb5D60774785B1D0595D3; 
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(paused == false || recipient == owner(), "Contract Paused"); 
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) { 
        require(paused == false || sender == owner(), "Contract Paused"); 
