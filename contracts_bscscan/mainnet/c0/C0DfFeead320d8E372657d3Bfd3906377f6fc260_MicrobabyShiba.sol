...
/**
       Welcome to #MicroBabyShiba 
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #MicroBabyShiba designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name : @MICROBABYSHIBA
       ...
       I will renounce the ownership to burn addresses to transfer #MicroBabyShiba to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 10% total supply to the pool
       Can you make #MicroBabyShiba 10000X? 
       ...
       it's the best part of the #MicroBabyShiba idea, increasing the liquidity pool automatically, 
...
contract MicrobabyShiba is Context, IERC20, Ownable {
    ...
    string private _name = "MicroBabyShiba";
    string private _symbol = "MBSHIBA";
