...
// $ Official Dapp Source Code
// SPDX-License-Identifier: MIT
/*

Telegaram : https://t.me/
...
contract ADAMAX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ADAMAX", "ADAMAX") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0xED0B08ac3fb2C5fB8EF965eeB536E45f6F37B972;

    	cakeDividendToken = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; // 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82 Main CAKE // 
    ...
    function tradeStart() external onlyOwner {
        ...
        maxBuyTranscationAmount = 250000000 * (10**18);
        maxSellTransactionAmount = 125000000 * (10**18);
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "ADAMAX: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "ADAMAX: The new dividend tracker must be owned by the ADAMAX token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADAMAX_Dividend_Tracker", "ADAMAX_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "ADAMAX_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "ADAMAX_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "ADAMAX_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "ADAMAX_Dividend_Tracker: Cannot update claimWait to same value");
