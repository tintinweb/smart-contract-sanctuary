...
contract BKCToken is Pausable {
    ...
    address public tax_address = 0x0413bb42C8F72c73799a822bd8A202A389d92636;
    address public charity_address = 0x9cbC37eB2a5846Da9E1Cb2012372c80C4A92B599;
    address public burn_address = 0x0FcB0030516882C4843C832823619e0DAA2C0102;
    ...
    constructor(
        ...
        name = "BKCToken";                                   // Set the name for display purposes
    ...
    function _transfer(address _from, address _to, uint _value) internal {
        ...
        assert(balanceOf[_from] + balanceOf[_to]  + taxvalue + charityvalue + burnvalue == previousBalances);
    }
