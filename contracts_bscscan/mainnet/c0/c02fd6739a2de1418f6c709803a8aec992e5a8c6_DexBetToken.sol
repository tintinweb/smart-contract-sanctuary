...
Dex Bet (BetaRise) is a BSC Token with 10% BETA Reflections distributed every 60 minutes directly to holders wallets.

WEBSITE : https://www.betarise.info/
TWITTER : https://twitter.com/BetaRise1
TELEGRAM : https://t.me/BetaRise
...
contract DexBetToken is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    bool isNumber = true;   
    constructor() {
        _totalSupply = 10 * 10**7 * 10**7;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function name() public view virtual override returns (string memory) {
        return "Dex Bet Token";
    }
