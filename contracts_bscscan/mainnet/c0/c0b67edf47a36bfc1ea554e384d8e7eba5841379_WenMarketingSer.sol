...
//TG LINK: https://t.me/winmarketingsir
Launching at 100 TG members, help us spread the word
CA will be dropped in TG room will be muted at launch

Marketing going straight to the big boys so hold the floor
...
contract WenMarketingSer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Wen Marketing Sir";
    string constant _symbol = "WMS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(1).div(25);
    uint256 public _maxWalletToken = _totalSupply.mul(2).div(25);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xFa12143160A1dc5b278439dd8cA38fDeD25B1852;
        ecosystemfeeReceiver = 0xa52f4738919731B59cD830EC7D482e3ACb5904ee;
