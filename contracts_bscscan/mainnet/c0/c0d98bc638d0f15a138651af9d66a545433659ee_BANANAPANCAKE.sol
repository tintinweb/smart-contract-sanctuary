...
/*
 Token Name : Banana Pancake
 Symbol : $BPANCAKE

 - Total Supply: 50,000,000 $BCAKE
 - Burnt : 30,000,000 $BCAKE
 - Max Tx 1,500,000 $BCAKE
 - Max Wallet Size: 1,500,000 $BCAKE
...
contract BANANAPANCAKE is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 15 * 10**5 * 10**9; // Max Transaction: 1,500,000 
    uint256 private _numTokensSellToAddToLiquidity = 10 * 10**5 * 10**9; // Number of tokens to sell before Liquidity gets added: 100,000 (0.2%)
    uint256 public _maxWalletToken = 15 * 10**5 * 10**9; // Max Wallet: 1,500,000 
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'Banana Pancake';
    string private _symbol = 'BPANCAKE';
