...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xC9301A63624bC0290aE76eBe5d4f82d628dC1896);
...
contract Hyper is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA  = 0xC9301A63624bC0290aE76eBe5d4f82d628dC1896;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Hyper Token Defi";
    string constant _symbol = "HTD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 55000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 1; // no limit;
    uint256 public _maxWalletToken = _totalSupply / 1; // no limit;
    ...
    uint256 public swapThreshold = _totalSupply / 100000; //0,001% = 550 unidades
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x3841091a08bdBaCa38B739C36DB177d241EA4C3C;
