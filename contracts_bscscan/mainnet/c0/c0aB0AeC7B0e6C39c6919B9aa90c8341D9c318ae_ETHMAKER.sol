...
abstract contract Auth {
     ...
     */
    /**
     * 将所有权转移到新的地址。呼叫者必须是所有者。留下旧的所有者授权。
     */
...
contract ETHMAKER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ETHMAKER";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x88fD0789fE0531C806c15F9d6BE778f6913C4673; //WALLET DEV
