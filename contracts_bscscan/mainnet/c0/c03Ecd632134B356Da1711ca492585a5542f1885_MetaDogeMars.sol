...
contract MetaDogeMars is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Doge Mars";
    string private _symbol = "METADOGERS";
    ...
    uint256 private minimumTokensBeforeSwap = 514545 * 10**6 * 10**9; 
