...
/**
 *BabyVenomDoge - To kill all pajeet devs!!!
*/
...
contract BabyVenomDoge is Context,IBEP20,Ownable {
    ...
    string private constant _name = "BabyVenomDoge";
    string private constant _symbol = "BVEDOG";
