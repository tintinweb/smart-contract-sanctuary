...
contract LoganInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x547B8FA4dD32d939DFe7024A0380e550C078a509;
 
    string constant _name = "Logan Inu";
    string constant _symbol = "LOGAN";
