...
/**
UNIPANCAKE
An innovative dual-dividend yield token that rewarding holders with $UNISWAP and $CAKE
Simply hold $UniPan and earn $UNISWAP (Binance Peg) & $CAKE at the same time every 30 minutes !
...
contract UNIPANCAKE is Context, IERC20, Ownable {
    ...
    string private _name = "UNIPANCAKE";
    string private _symbol = "UNIPANCAKE";
    uint256 public _taxFee = 5;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _UniRewards = 4;
    uint256 private _previousUniRewards = _UniRewards;
    uint256 public _CakeRewards = 4;
    uint256 private _previousCakeRewards = _CakeRewards;    
    ...
    address _marketingWallet = 0x416c87ED7f7c7a159c3CA7723E3B70bc4761DDf0;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // Max TX amount is 2% of the total supply.
    uint256 private maxTx = 20000000; // Less fields to edit
    uint256 private maxTxDivisor = 1;
    uint256 private _maxTxAmount = (_tTotal * maxTx) / maxTxDivisor;
    uint256 private _previousMaxTxAmount = _maxTxAmount;
    uint256 public maxTxAmountUI = (startingSupply * maxTx) / maxTxDivisor; // Actual amount for UI's
    // 2% of Total Supply
    ...
    function setMaxTxPercent(uint256 _maxTx) external onlyOwner() {
        require(_maxTx >= 1); // Cannot set to 0.
        _maxTxAmount = _tTotal.mul(_maxTx).div(
