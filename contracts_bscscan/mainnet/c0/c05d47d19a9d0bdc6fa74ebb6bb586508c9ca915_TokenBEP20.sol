...
*/
// Welcome To Trump.tokenic Token Platform
// Trump.tokenic platform allows users to easily deposit BEP20 tokens (ANY tokens) into an NFT. Trump.tokenic token is the governance token of the platform.
...
contract Trumptokenic  is TokenBEP20 {
