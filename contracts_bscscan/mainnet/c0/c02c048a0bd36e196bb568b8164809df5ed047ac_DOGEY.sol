...
contract DOGEY is Context, IERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public safeManager;
    address payable public marketingAddress =
        payable(0xAB234010C4229C18D91Cd3f325B7a5DBaD949191); // Marketing Address
    ...
    // 0.5%
    uint256 public _maxTxAmountForSell = _tTotal.mul(5).div(1000);
