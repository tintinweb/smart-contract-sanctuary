...
/*
 *  Cumsock
 *  Current website: https://cumsock.co/
 *  TG: https://t.me/CumSockOfficial
*/
...
contract CumsockDividendDistributor is IDividendDistributor {
...
contract CUMSOCK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    */
    ...
    CumsockDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new CumsockDividendDistributor(address(router));
    ...
    function setDistributor(CumsockDividendDistributor dist)external authorized {
        distributor = dist;
    }
