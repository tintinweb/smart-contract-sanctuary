...
/**
Baby AlaskaInu is a yield-generating charitable cryptocurrency that runs on the Binance Smart Network.
...
Far beyond being a meme currency, one of my purposes is
to allocate part of the funds raised to the main Brazilian foundations fighting Covid-19.
...
Tokenmonic features are a global 8% tax on transfers, buying and selling, which are distrubuted in the following fashion:
  ...
  *
  *
  * Website: https://realbabyalaska.com/
  * Telegram: https://t.me/joinchat/zuj7OZDp5u40YjRh
  *
  *
 */
...
contract BABYA is Context, IERC20, Ownable {
    ...
    string private _name = "Baby AlaskaInu";
    string private _symbol = "BABYA";
