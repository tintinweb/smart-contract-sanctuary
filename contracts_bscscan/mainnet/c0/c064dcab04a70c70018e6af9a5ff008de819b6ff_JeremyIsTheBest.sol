...
//We are growing quickly and our Telegram t.me/RugSeekers our Discord https://discord.gg/xuxwRjYW with our Twitter @RugSeekers are our connection to investors as well as other projects. We will offer rewards to investors who aid in the fight and a reward reflection which benefits the victims of corruption. 
...
contract JeremyIsTheBest is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = "JeremyIsTheBest";
    string constant _symbol = "TestSeekii";
    ...
    // total fees
    uint256 totalFeeSells = 1500;
    uint256 totalFeeBuys = 1500;
    uint256 feeDenominator = 10000;
    // receiving addresses
    address public autoLiquidityReceiver;
    // to be replaced with Gnosis V2 BSC MultiSignature Wallet
    address public ScamSeekersFeeReceiver = 0x0261B7dc0ff64b16479d44cED8C09A0Feab79eca ;
    // to be replaced with Gnosis V2 BSC MultiSignature Wallet
    address public marketingFeeReceiver = 0xb2DE70003BAbe795337Ca885f71d280A886e138a ;
    // to be replaced with Gnosis V2 BSC MultiSignature Wallet
    address private DeveloperFeeReceiver = 0x6199B759e278A51C514F8c57Fd54eb114ff3fe73 ;
    ...
    bool public allowTransferToScamSeekers = true;
    bool public allowTransferToMarketing = true;
    bool public allowTransferToDeveloper = true;
    // gas for distributor
    DividendDistributor distributor;
    uint256 distributorGas = 500000;
    // in charge of swapping
    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply.div(10000); // 0.1% or 1 Billion to start
    // true if our threshold decreases with circulating supply
    bool public canChangeSwapThreshold = true;
    uint256 public swapThresholdPercentOfCirculatingSupply = 10000;
    bool inSwap;
    ...
    uint256 public totalBNBScamSeekers =0;
    uint256 public totalBNBDyorReflections = 0;
    uint256 public totalBNBDeveloper = 0;
