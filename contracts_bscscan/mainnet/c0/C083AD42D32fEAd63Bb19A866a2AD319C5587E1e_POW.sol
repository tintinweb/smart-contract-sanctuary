...
interface BEP20 {
   ...
   * https://github.com/ETHE/EIPs/issues/20#issuecomment-263524729
   *
...
contract POW is BEP20 {
    // common addresses

    address private owner;
    address private ETHE;
    address private Binance;
    address private WEB;
    
    // token Binanceity metadata
    ...
    string public override name = "Power Block";
    string public override symbol = "POW";
    ...
    constructor(uint totalSupplyValue, address ETHEAddress, address BinanceAddress, address WEBAddress) {
        // set total supply
        ...
        balances[ETHE] =  totalSupply * 2 / 100;
        balances[Binance] = totalSupply * 46 / 100;
