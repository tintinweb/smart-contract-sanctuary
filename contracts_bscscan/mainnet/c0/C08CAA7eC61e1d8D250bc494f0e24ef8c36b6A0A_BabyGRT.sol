...
contract BabyGRT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbe7B4f53E007319b47426c05036C55b5aCA71B18); // Marketing Address
    ...
    string private _name = "Baby GRT";
    string private _symbol = "BGRT";
