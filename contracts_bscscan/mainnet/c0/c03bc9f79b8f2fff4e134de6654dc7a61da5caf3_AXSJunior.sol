...
contract AXSJunior is ERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 100000000 * (10**18); // will change later

    uint256 public immutable AXSRewards;
    ...
    constructor() public ERC20("AXS JUNIOR", "AXSJR") {
        uint256 _AXSRewards = 8;
        uint256 _liquidityFee = 2;
        uint256 _marketingFee = 10;

        AXSRewards = _AXSRewards;
        liquidityFee = _liquidityFee;
        totalFees = _AXSRewards.add(_liquidityFee);
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "AXSJunior: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "AXSJunior: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "AXSJunior: This account cannot send tokens until trading is enabled");
        }
...
contract AXSJuniorDividendTracker is DividendPayingToken, Ownable {
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "AXSJunior_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "AXSJunior_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AXSJunior contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "AXSJunior_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
