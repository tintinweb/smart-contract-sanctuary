...
/**
 * TG: https://t.me/SpaceMonkeyADA
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * SpaceMonkeyADA gathers SpaceMonkeyADA and delivers direct to your wallet!!!!
*/
...
contract SpaceMonkeyADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SpaceMonkeyADA";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "FakeTaxi";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xE9C17a619098D5aF8b2E7A294C968771aa9D9806;
