...
/**
 * TG: https://t.me/UnicornBUSD
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * UnicornBUSD gathers UnicornBUSD and delivers direct to your wallet!!!!
*/
...
contract UnicornBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "UnicornBUSD";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "UnicornBUSD";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xd030DcD1559502dC3f60d87FEb54374cC9a1f829;
