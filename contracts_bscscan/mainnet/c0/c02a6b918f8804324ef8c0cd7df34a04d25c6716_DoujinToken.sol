...
/**
 *DoujinToken | a community-driven project
  *DoujinToken is an NFT platform and Comics platform based on the Binance Smart Chain
  Low Tax Just 5%
https://t.me/DOUJINTOKEN
*/
...
contract DoujinToken is Context, IBEP20, Ownable {
    ...
    string private _name     = "DoujinToken";
    string private _symbol   = "Doujinshi";
    ...
    uint256 private _minTokenBalance = 1000000000000 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        if (marketingFee > 0) {
            payable(0x109179dB7572647A9929980F585E4fEa7Ec512a0).transfer(marketingFee);
            emit MarketingFeeSent(0x109179dB7572647A9929980F585E4fEa7Ec512a0, marketingFee);
        }
