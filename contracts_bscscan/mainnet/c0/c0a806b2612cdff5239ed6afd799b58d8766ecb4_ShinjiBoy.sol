...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REFLECTION = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD
...
contract ShinjiBoy is IBEP20, Auth {
    using SafeMath for uint256;
 
    address REFLECTION = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    ...
    address _marketingAdr = 0xC66F5d18c2b94bd96F7f207421449215B74cbcE0;
 
    string constant _name = "ShinjiBoy";
    string constant _symbol = "ShinjiBoy";
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit bottedRemover(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event bottedRemover(uint256 amountBNB, uint256 amountBOG);
}