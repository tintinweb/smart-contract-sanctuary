...
/**
Tigertar Inu is deployed on Binance Smart Chain (BSC). We have deployed a contract, which reward our holders. 
Tigertar Inu (TGI) is a project inspired by an experienced & professional team. With holding this token you can enjoy the passive income, 
which will be distributed automatically to your wallet as ETH. 
Another feature, which is implemented in our contract, are the low fees for buys and sells.
https://tigertarinu.com/
https://github.com/AuditRateTech/Smart-Contract-Audits/blob/main/Tigertar_Inu_0x862130C0c2F8CaE48F4c87788Bd107D66ed5a803.pdf
*/
...
contract TigertarInu is TGIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TGITeam;
    address private CharityTGI;
    ...
    string public override name = "Tigertar Inu";
    string public override symbol = "TGI";
    ...
    constructor(uint totalSupplyValue, address TGITeamAddress, address CharityTGIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TGITeam = TGITeamAddress;
        CharityTGI = CharityTGIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TGITeam] =  totalSupply * 45 / 100;
        balances[CharityTGI] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's TGITeam pot
