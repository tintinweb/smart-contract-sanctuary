...
contract JeetsTakeItEasy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JeetsTakeItEasy";
    string private _symbol = "JTIE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x29CeB0CA6C2FcaBc1e1929506D75668a9217B500); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x29CeB0CA6C2FcaBc1e1929506D75668a9217B500); // BuyBack Address
