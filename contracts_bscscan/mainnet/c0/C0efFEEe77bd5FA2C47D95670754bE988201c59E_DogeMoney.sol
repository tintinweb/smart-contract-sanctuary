...
contract DogeMoney is Context, IERC20, Ownable, specialEvent  {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa18dd89b194533CBcA2264Daf84a08D91e29CC5A); // Marketing Address
    ...
    string private _name = "DogeMoney";
