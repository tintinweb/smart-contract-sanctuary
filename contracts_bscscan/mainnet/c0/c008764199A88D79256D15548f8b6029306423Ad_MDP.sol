...
contract MDP is ERC20, Ownable {
    ...
    event SetDividendToken(address indexed divToken);
    ...
    receive() external payable {
  	...
  	function prepareForPreSale() external onlyOwner {
        ...
        maxWalletToken = 100000000000 * (10**9);
    }
    ...
    function setDividendToken(address divToken) public onlyOwner {
        ...
        emit SetDividendToken(divToken);
    }
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MDP: _gasForProcessing must be between 200,000 and 500,000");
