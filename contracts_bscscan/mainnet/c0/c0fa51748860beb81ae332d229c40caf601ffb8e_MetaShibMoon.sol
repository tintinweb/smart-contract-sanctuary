...
contract MetaShibMoon is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSellToAddToLiquidity = 600000000 * 10**18;
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, address charityWallet_) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
    ...
    function changeFee(uint256 taxFee, uint256 liquidityFee, uint256 burnFee) public onlyOwner {
        _previousTaxFee = _taxFee;
        _taxFee = taxFee;
        _previousLiquidityFee = _liquidityFee;
