...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @HeroDogeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #HeroDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #HeroDogeCoin 10000X? 
...
contract HeroDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Hero Doge";
