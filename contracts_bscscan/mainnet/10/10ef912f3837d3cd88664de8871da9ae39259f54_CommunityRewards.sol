...
contract CommunityRewards is owned{
    ...
    */
     ...
     *lock tokens
    */
    function Deposit(address _tokenAddress, uint256 _amount, uint256 _Deposit) public returns (uint256 _id) {
        require(_amount > 0, 'token amount is Zero');
        require(_Deposit < 1000000000000000, 'Enter an unix timestamp in seconds, not miliseconds');
        ...
        lockedToken[_id].vestingTime = _Deposit-block.timestamp;
