...
contract URC is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 4;  uint256 private _previousTaxFee = _taxFee;
  
    uint256 public _burnFee = 4; uint256 private _previousBurnFee = _burnFee;
  
    uint256 public _liquidFee = 8; uint256 private _previousLiquidFee = _liquidFee;

    
    uint256 public _maxTxAmount = 100 * 10**3 * 10**18;
