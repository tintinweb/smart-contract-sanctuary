...
contract BinanceWEB is BinanceAPP {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "BinanceWEB: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BinanceWEB: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract PinkShibaSnap is BinanceAPP, BinanceGames, BinanceWEB {
    ...
    string private _name = 'Pink Snap Shiba';
    string private _symbol = 'PINKSHIBAS';
