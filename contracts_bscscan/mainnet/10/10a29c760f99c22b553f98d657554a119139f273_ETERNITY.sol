...
contract ETERNITY is BaseErc20, Taxable, Dividends, AntiSniper {
    using SafeMath for uint256;
    ...
    constructor () {
        owner = msg.sender;
        // owner = 0x6570fe5065e3AF26404DB421cDEA068fF379D3fA;
        symbol = "ETERNITY"; 
        name = "ETERNITY";
        ...
        //configurePinkAntiBot(0x303F6279A30A832Dde961430CB997D2a1b904887); // TESTNET
        // configurePinkAntiBot(0x6570fe5065e3AF26404DB421cDEA068fF379D3fA); // MAINNET
        ...
        taxDistributor.createWalletTax("1", 0, 500, 0xA5F5c8085BeA383b324ce5fe32254c241a51251e);
        taxDistributor.createWalletTax("2", 0, 500, 0x4038a203638EAAEB5C8638B25C62fa61237109fc);
        // taxDistributor.createWalletTax("Development", 100, 100, 0x76fc754F3BDd09E2F7648304780A25Cb57dBaCB8);
