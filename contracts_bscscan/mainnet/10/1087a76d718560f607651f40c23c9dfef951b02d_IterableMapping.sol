...
contract APPLEDividendTracker is DividendPayingToken, Ownable {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "APPLE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");	
...
contract APPLE is ERC20, Ownable, SafeToken, LockToken {
    ...
    constructor() ERC20("AppleSwap", "APPLE") {
        ...
        MarketingFee = 4;
        MarketingWallet = payable(0x9700F51C88D60F659D34aC70531636410bC66D51);

        totalFees = BNBRewardsFee.add(liquidityFee).add(MarketingFee); // total fee transfer and buy

    	dividendTracker = new APPLEDividendTracker();
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Test 
