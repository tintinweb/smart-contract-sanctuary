...
/**
  ...
  DIVIDEND YIELD PAID IN TRON! With the auto-claim feature every 30-60mins!
    Simply hold Mini TRON and you'll receive TRON automatically in your wallet.
    Hold Mini TRON, Trade Mini TRON and get rewarded in TRON on every transaction!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TRON = IBEP20(0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TRON.balanceOf(address(this));
        ...
        uint256 amount = TRON.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TRON.transfer(shareholder, amount);
...
contract MINITRX is IBEP20, Auth {
    using SafeMath for uint256;

    address TRON = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MINITRX";
    string constant _symbol = "MINITRX";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1715a6AeC7A96Bb26e102a92A5b497E8381FF395;
