...
contract BITCHCOIN is IBEP20, Auth {
    ...
    string constant _name = "BITCHCOIN";
    string constant _symbol = "BTC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 200; //2% 
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; //4%
    ...
    address private marketingFeeReceiver = 0x43Ecf743b206B3c2C13341F7f4B94eDda93cCc80;
    address private developmentFeeReceiver = 0x7Fc677B92780113Ca677645C05a28cb670943035;
