...
contract YSLOptPancake is YSLOpt {
    ...
    function restorePool() external onlyRole(STRAT_ROLE) {
        apeSwap = 0xC0788A3aD43d79aa53B09c2EaCc313A787d1d607;
        pancakeMaster = 0x73feaa1eE314F8c655E354234017bE2193C9E24E;
        pancakeSwap = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        ...
        address[] memory mem1 = new address[](2);
        address[] memory mem2 = new address[](1);
        mem1[0] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        mem1[1] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
        mem2[0] = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;

        path0 = mem1;
        path1 = mem2;

        lockContract = 0x61a3f8361cf8546F1C28371F3F271C939AD46ebd;

        want = IERC20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
        id = 389;
