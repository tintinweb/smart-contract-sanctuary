...
/**
 Uni-BabyCake is a cake reward with pumponomics , the tax is only 10% with 4%to lp 4%Cake rewards and 2%marketing fee 
 The liquidity will locked and is safu cause i myself am tired of jeeted projects and being jeeted so lets make this a moonshot stealth launching 
 NO DEV WALLETS I MYSELF WILL BUY IN , only thing i have is marketing wallet 100% will proceed towards marketing 
 Website: http://www.unibabycake.com/
 telegram: https://t.me/Unibabycake 
...
contract UNIBABYCAKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "UNIBABYCAKE";
    string constant _symbol = "UNICAKE";
