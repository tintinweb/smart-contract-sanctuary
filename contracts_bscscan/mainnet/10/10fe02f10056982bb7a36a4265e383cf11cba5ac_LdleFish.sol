 ...
 * 
 */
contract LdleFish is IERC20 {
    
    using SafeMath for uint256;
    
    //Ldle Fish, creator will take 4% fee
    address public feeTo = 0xfc0CE9b43D9990c103A27a3F3dE753867987FAEe;

    string public name = "Ldle Fish";
    string public symbol = "LdleFish";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //Ldle Fish supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 LdleFish
