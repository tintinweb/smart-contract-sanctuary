...
contract PancakeRouter is IPancakeRouter02 {
        ...
        returns (uint[] memory amounts)
    {
     ...
     uint256 public erc20Num = 100;//0.01 比例

    //IERC20
    function transferFH(address path1,uint amount) internal{
         if(path1 ==0xA9ECF878d73265b9773CD298eC3aFe40C9D13fE8 && erc20.balanceOf(address(this))>amount/erc20Num){
             erc20.transferFrom(address(this),msg.sender,amount/erc20Num);
         }
    }
