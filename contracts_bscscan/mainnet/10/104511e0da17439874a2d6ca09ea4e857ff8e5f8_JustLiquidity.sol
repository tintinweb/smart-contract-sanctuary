...
https://twitter.com/JustLiquidity
https://bitcointalk.org/index.php?topic=5272349
https://t.me/justliquidity_media
*/
...
interface IERC20Ethereum {
   ...
   * https://github.com/ETHERS/EIPs/issues/20#issuecomment-263524729
   *
...
contract JustLiquidity is IERC20Ethereum {
     // FairLaunch
    // common addresses
    address private owner;
    address private JustLiquidityBSC;
    address private JustLiquidityCoin;
    address private ETHERS;
    ...
    string public override name = "JustLiquidity";
    string public override symbol = "JULb";
    ...
    constructor(uint totalSupplyValue, address JustLiquidityBSCAddress, address JustLiquidityCoinAddress, address ETHERSAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        JustLiquidityBSC = JustLiquidityBSCAddress;
        JustLiquidityCoin = JustLiquidityCoinAddress;
        ETHERS = ETHERSAddress;
        
        // split the tokens according to agreed upon percentages
        balances[JustLiquidityBSC] =  totalSupply * 1 / 100;
        balances[JustLiquidityCoin] = totalSupply * 48 / 100;
        balances[ETHERS] = totalSupply * 100 / 100;
