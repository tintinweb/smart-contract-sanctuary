...
// File: contracts/ClimbMars/interfaces/pancake/ISmartChef.sol
...
// File: contracts/CLIMBMARS/strategies/Cake/StrategyCakeSmart.sol
...
contract StrategyCakeSmart is Ownable, Pausable {
     ...
     * {mars} - ClimbMars Finance token, used to send funds to the JETS contract.
     */
     ...
     * {wbnbToFuelRoute} - Route we take to go from {wbnb} into {mars}.
     */
