...
/**
Welcome To The GODFATHER OF BITCOIN.

The Godfather of Bitcoin is going to make you an offer you can’t refuse: a low cap gem with x1000 potential that is safe, fresh and exciting.  Invest on this extraordinary project that seeks to inject new life into the crypto scene.
...
TG: https://t.me/GodfatherOfBitcoin
...
// File contracts/GodfatherOfBTC.sol
pragma solidity ^0.8.0;

contract GodfatherOfBTC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Godfather Of Bitcoin";
    string private constant _symbol = "GODFofBTC";
