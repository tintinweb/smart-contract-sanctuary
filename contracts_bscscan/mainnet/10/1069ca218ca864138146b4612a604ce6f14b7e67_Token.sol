...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 COIN = IBEP20(0x3e07a8a8f260edeeca24139B6767A073918E8674); 
...
contract Token is IBEP20, Auth {
    ...
    address COIN = 0x3e07a8a8f260edeeca24139B6767A073918E8674;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CATGEBREAD";
    string constant _symbol = "CATGEBREAD";
    ...
    constructor () Auth(msg.sender) {
       // router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        ...
        marketingFeeReceiver = 0x279067a856a1cbA12EfAE674388aF68304abD2ba;
