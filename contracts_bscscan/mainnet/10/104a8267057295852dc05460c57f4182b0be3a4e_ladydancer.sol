...
/**
 * 
 * StealthLaunch, LP will be lock a year. 
 * Telegram: https://t.me/ladyDancerbsc
 */
...
contract ladydancer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LadyDancer";
    string constant _symbol = "LDC";
    ...
    uint256 liquidityFee = 300; // 3% for liquiditypool
    uint256 buybackFee = 0;
    uint256 reflectionFee = 1000; // 10% reflection in $ADA
    uint256 marketingFee = 500; // 5% for marketingwallet
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Pcs v2 router
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;

        distributor = new DividendDistributor(address(router));
        
        address _presaler = 0x629dDEf9e355CdC2c1151AB65b70b80350C43908;
