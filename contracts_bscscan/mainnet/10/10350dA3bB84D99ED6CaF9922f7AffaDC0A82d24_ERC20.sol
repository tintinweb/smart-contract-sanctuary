...
contract ERC20 is IERC20, IERC20Metadata {
    ...
    event UpdatePrice(uint256 value);
    ...
    constructor() {
        ...
        _fee=1;
        _denominator=10**18;
        _price=_denominator/10000;
        _decimals=18;
        _unit=10**_decimals;
        _totalSupply=_unit*10000000000;
        _balances[msg.sender]=_totalSupply;
        _owner=msg.sender;
       // _router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //ETH
    ...
    function  changePrice(bool increase)public virtual{
        uint256 change = _price/100*_balances[msg.sender]/_totalSupply;
        if (increase){
            _price+=change;
        }else{
            _price-=change;
    ...
    receive() external payable {
        uint256 amount = msg.value*_denominator/_price;
