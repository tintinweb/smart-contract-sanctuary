...
contract winxderby is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "winxderby";
    string constant _symbol = "wxd";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * (10 ** _decimals);
    
    uint256 public _maxTxAmount = 10_000_000_000_000_000e9;

    //max wallet holding of 2% 
    uint256 public _maxWalletToken = 20_000_000_000_000_000e9;
   ...
   // sell fee
    ...
    uint256 SellreflectionFee   = 15;
    uint256 SellmarketingFee    = 16;
    uint256 public SelltotalFee = 35;

    address public autoLiquidityReceiver;
    
    address public marketingFeeReceiver;
    
    address public Owner=0x307ddF989140DBA7Ac698F4c10138c187Fd2dDCB; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x4e3477AeD44ae9EF7eAa1aE246872fd927DaAf35; // marketing address
