...
/**
/*
ShibaDude - Fair Launching Nov 29th
Join our TG: https://t.me/ShibaDude
...
Sell Tax 15% (to prevent dumpers, will be decreased to 10% at $100,000 Marketcap)
    🌀 5% Marketing
    🥯 10% Auto Liquidity
    
Tokenomics
    💵 0.50% Max Buy Tx ( 1,000,000 )
    💰 5% Max Bag ( 5,000,000,000 )
...
/* Token contract */
contract ShibaDude is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "ShibaDude";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 250 / 10000; // 0.20% or 250k tokens
