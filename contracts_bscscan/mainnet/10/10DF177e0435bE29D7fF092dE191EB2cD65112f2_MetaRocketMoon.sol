...
contract MetaRocketMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "META ROCKET MOON";
    string private constant _symbol = "MetaRM";
    ...
    //Buy Fee
    uint private _LiqFeeOnBuy = 2;
    uint private _taxFeeOnBuy = 7;
    
    //Sell Fee
    uint private _LiqFeeOnSell = 2;
    uint private _taxFeeOnSell = 7;
