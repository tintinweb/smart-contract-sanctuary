 ...
 *
 * No Dev Wallet
 * Its a community owned token
 * https://t.me/HawkEyeGlobalOfficial
 */
...
contract BabyBoston is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Baby Boston";
    string private _symbol = "BBO";
    uint8 private _decimals = 9;
    uint256 public _rewardFee = 2;
    uint256 public _burnFee = 2;
    uint256 public _smFee;
    uint256 private _tTotal = 1000000000000 * 10 ** _decimals;
    uint256 public _maxTxAmount = 9000000000 * 10 ** _decimals;
    ...
    constructor() {
        ...
        _smFee = 4;
        stsmf = 10000000000 * 10 ** _decimals;
        _smfA = payable(0x6F5B42c1992140BD6c2c896940e5eD9d5610fD7d);
