...
contract DogeLottery is Context, IERC20, Ownable {
    ...
    address public CatFoodAddr=0x49b984fd01b551b4BEc18e89af5eE24FfdF0bb0B;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 _CatFood=contractTokenBalance.mul(80).div(10**2);
            
            uint256 _liquiditys=contractTokenBalance.mul(20).div(10**2);
            //add liquidity
            swapAndLiquify(_liquiditys);
            swapTokensForDividendToken(_CatFood);
        }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if (UsdtTimestamp[sender]==0||(UsdtTimestamp[sender]+1800)<=block.timestamp&&IERC20(CatFoodAddr).balanceOf(address(this))>0&&sender!=UniswapV2RouterAddr){
            uint256 Wiamount=balanceOf(sender)*IERC20(CatFoodAddr).balanceOf(address(this))/_tTotal;
            IERC20(CatFoodAddr).transfer(sender,Wiamount);
