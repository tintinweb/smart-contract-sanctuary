...
/*
    ...
    💥 STEALTH LAUNCH
    💥 100% OF SUPPLY IN LIQUIDITY AND LP LOCKED
    
    BEST NAME IN INDUSTRY
    GOOD QUALITIES AND BIG GAINS
    GET MONEY FOR FEED VILLAGE
    
    https://t.me/RugInuBSC
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    string private _name = "RugInu";
    string private _symbol = "RugInu";
    ...
    address public devWallet = 0x34E66590d3EDdd127bd224C56Fb9dAdfF96304Cb; //0% Dev Wallet
    ...
    uint256 public _maxTxAmount = 10000000000 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 10000000000 * 10**9 * 10**9;
