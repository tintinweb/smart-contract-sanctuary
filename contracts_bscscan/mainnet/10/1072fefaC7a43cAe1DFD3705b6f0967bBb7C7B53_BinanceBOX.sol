 ...
 * 
 Welcome to $BinanceBOX:
   ...
   Many Great features:
    ...
    it's the best part of the $BinanceBOX idea, increasing the liquidity pool automatically.
...
contract BinanceBOX is Context, IERC20, Ownable {
