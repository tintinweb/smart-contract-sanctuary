...
contract OneCent is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000 * 10**9; //1 trillion tokens
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "1 Cent";
    string private _symbol = "1Cent";
    ...
    address public charityWallet = 0x7d7108cAE0255BD00cc4788F9a8eBF2322479703;
    ...
    constructor () public {
        ...
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);  ---TEST
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     //to recieve BNB from pamcakeV2Router when swaping
    ...
    function _transfer(
        ...
        uint256 contractTokenBalance = balanceOf(address(this));      //balance of the lp owner address.  
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for BNB
        swapTokensForEth(half); // <- this breaks the BNB -> 1CENT swap when swap+liquify is triggered
    ...
    function setTradeStatus(uint status) external onlyOwner() {
         tradeStatus = status;
    }
