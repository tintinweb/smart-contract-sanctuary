...
contract IWILLRUG is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    IWILLRUGDividendTracker public dividendTracker;
    ...
    uint256 public ADARewardsRewardsFee = 8;
    ...
    bool public txRestrictionsActive = false;
    uint256 public _maxTxAmount = 5000000000 * (10**18); // Max Transaction: 5.0%
    uint256 public _maxWalletToken = 5000000000 * (10**18); // Max Wallet: 5.0%

    address public _marketingWalletAddress = 0x4776f10Ff66EE9fa772F29E33B548E7c311A0C69;
    address public _devWalletAddress = 0xfB3C8Eb74158b456e4f82B2f8F6D1A5E6Ce6941b;
    ...
    constructor() public ERC20("IWILLRUG", "$IWR") {

    	dividendTracker = new IWILLRUGDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        IWILLRUGDividendTracker newDividendTracker = IWILLRUGDividendTracker(payable(newAddress));
...
contract IWILLRUGDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("IWILLRUG Dividends", "IWILLRUG_dividends") {
    	claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "iterationsUntilProcessedRewards Dividends: claimWait must be updated to between 1 and 24 hours");
