...
RedSafemoon is a hyper deflationary token that rewards buyers with Safemoon for holding every 60 minutes. 
Anti-whale and anti-dump mechanics implemented to ensure a level playing field so that everyone can be a winner.
...
50% LP
No dev wallets
Ownership will be renounced on release
LP Burned on release (link will be provided)


Telegram: https://t.me/RedSafemoon
