...
/**
HOLD $EARNIE & EARN $BNB EVERY HOUR!

$EARNIE is the highest paying yield generation token.
Simply hold your $EARNIE to earn $BNB.
We have added some features aswell to keep it healthy and ensure longevity of the token, such as a Buy Back system called KRAKEN and an Anti-Whale system.

Tokenomics:
- Buying fee: 5%
To KRAKEN on each buy transaction: 2%
Reward per buy transaction in $BNB: 3%

- Selling fee: 25%
To KRAKEN on each sell transaction: 15%
Reward per sell transaction in $BNB: 10%

- To marketing wallet on each transaction: 1%
*/
...
contract EARNIE is Context, IERC20, Ownable {
