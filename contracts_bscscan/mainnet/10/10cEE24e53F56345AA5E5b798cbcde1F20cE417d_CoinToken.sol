...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply,bool _maxwalletholdEnabled, uint256 _maxwallethold, uint256 _txFee,uint256 _lpFee, uint256 _mFee, uint256 _MAXAMOUNT,uint256 SELLMAXAMOUNT, address _marketingAddress, address routerAddress,address tokenOwner) {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
    ...
    function setmaxwallethold(uint256 _maxwallethold) external onlyOwner() {
        maxwallethold = _maxwallethold;
    }
