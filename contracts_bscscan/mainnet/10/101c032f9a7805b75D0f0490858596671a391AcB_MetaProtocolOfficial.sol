...
/**
    * Telegram : https://t.me/MetaProtocolOfficial
*/
...
contract MetaProtocolOfficial is IBEP20, Auth {
    ...
    string constant _name = "Meta Protocol";
    string constant _symbol = "MProtocol";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 100;
    uint256 public _maxWalletSize = (_totalSupply * 40) / 100;
    ...
    address private marketingFeeReceiver = 0xbE46A152F8840aE738335a4b8C490711a4dAd64C;
    address private buybackFeeReceiver = 0xC5352eeC3CFbADCB2eD63F4cAe4a2723F0f59Cf7;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBcharity = amountBNB.mul(buybackFee).div(totalBNBFee);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);


        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        require(MarketingSuccess, "receiver rejected ETH transfer");
        (bool charitySuccess, /* bytes memory data */) = payable(buybackFeeReceiver).call{value: amountBNBcharity, gas: 30000}("");
