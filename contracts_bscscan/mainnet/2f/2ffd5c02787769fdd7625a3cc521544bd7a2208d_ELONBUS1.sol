...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x42a5cf25762A8DdCF1cfE7841EB785fD8f63B1dC;
...
contract ELONBUS1 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdac7855Ab2F8dBAa093E53E1B544E796DBCF5a74;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ELONBUS1";
    string private _symbol = "EBUS";
