...
/**
 ...
 Going back to the basics while keeping everything bullish, with our bullinomics.
 
      Telegram - https://t.me/lilBullishAF
...
contract lilBullishAF is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "lilBullishAF";
    string private _symbol = "LBAF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28207C0eE8a7865E9bD763a3F82F2cd46CCdDfD2); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x190D74ABF0D43A16991c5131024B56a04967e573); // buyback Address
