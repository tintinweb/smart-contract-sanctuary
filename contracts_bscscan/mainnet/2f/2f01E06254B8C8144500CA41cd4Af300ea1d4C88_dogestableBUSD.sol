...
// DogeStableBUSD @ t.me/DogeStableBUSD
...
// File: contracts/dogestableBUSDDividendPayingToken.sol
...
// File: contracts/dogestableBUSD.sol
...
contract dogestableBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    address private _marketingWallet = address(0x109A51b6dA373390875BfAEEc368F8626a107DB1);
    address private _devWallet = address(0x8422fA21D818cca9C861047A6aC0F6c94d18e620);

    bool private swapping;
    bool public airdrop;

    dogestableBUSDDividendTracker public dividendTracker;
    ...
    uint256 public _maxWalletToken = 20 * (10**18); // 2% totalSupply
    ...
    constructor() public ERC20("dogestableBUSD", "dogestableBUSD") {
    	...
    	dividendTracker = new dogestableBUSDDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "dogestableBUSD: The dividend tracker already has that address");

        dogestableBUSDDividendTracker newDividendTracker = dogestableBUSDDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "dogestableBUSD: The new dividend tracker must be owned by the dogestableBUSD token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "dogestableBUSD: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "dogestableBUSD: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "dogestableBUSD: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "dogestableBUSD: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "dogestableBUSD: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "dogestableBUSD: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "dogestableBUSD: This account cannot send tokens until trading is enabled");
        }
...
contract dogestableBUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("dogestableBUSD_Dividend_Tracker", "dogestableBUSD_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "dogestableBUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "dogestableBUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main dogestableBUSD contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "dogestableBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "dogestableBUSD_Dividend_Tracker: Cannot update claimWait to same value");
