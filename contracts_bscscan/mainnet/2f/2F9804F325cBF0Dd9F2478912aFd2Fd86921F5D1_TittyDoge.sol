...
contract TittyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "TittyDoge";
    string private _symbol = "TITTY";
    ...
    address payable public _paradiseAddress = 0xC57809420282be2E012065B1f42BdBA27050a45f;
    address payable public _marketingAddress = 0xD8305cbbC118C3fF4c267875811faA7A5B2616ea;
    ...
    uint256 private minimumTokensBeforeSwap = 5 * 10**11 * 10**9; 
