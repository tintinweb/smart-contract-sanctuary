...
contract RocketShibaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x13B19708eeEa6a9b0E6D036C2A525a129feF2285); // Marketing Address 
    ...
    string private _name = "RocketShibaInu";
