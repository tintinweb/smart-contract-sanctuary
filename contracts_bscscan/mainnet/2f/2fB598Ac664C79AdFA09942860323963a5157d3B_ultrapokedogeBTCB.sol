...
Telegram: https://t.me/ultrapokedogeBTCB
...
contract ultrapokedogeBTCB is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "BTCB";

    string constant _name = "UltraPokeDogeBTCB";
    string constant _symbol = "PokeDoge";
