...
/**
   ...
   Welcome to LittleBitDoge
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBitDogeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBitDoge to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBitDoge idea, increasing the liquidity pool automatically, 
...
contract LittleBitDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Little Bit Doge";
    string private _symbol = "LTBITDOGE";
