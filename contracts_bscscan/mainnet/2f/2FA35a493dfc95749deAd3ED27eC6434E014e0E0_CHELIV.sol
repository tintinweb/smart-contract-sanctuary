...
contract CHELIV is Context, IERC20, Ownable {
    ...
    string private _name = "CHELIV";
    string private _symbol = "CHELIV";
    ...
    address payable public marketingWallet = payable(0xeC3d99b7903533365cC627BF393762b7E4aFBf7e);
    ...
    uint256 public numTokensSellToAddToLiquidity = 20000000000 * 10**9;
