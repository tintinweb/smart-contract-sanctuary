...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #BabyYooshi

    I make this #BabyYooshi to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BabyYooshi_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #BabyYooshi to the community, make sure it's 100% safe.

   I will add 6 BNB and all the left 49.5% total supply to the pool
   Can you make #BabyYooshi 10000000X? 
   ...
   it's the best part of the #BabyYooshi idea, increasing the liquidity pool automatically, 
...
contract BabyYooshi is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "BabyYooshi";
