...
// File contracts/HappyNewCheems.sol
pragma solidity ^0.8.0;

contract HappyNewCheems is Context, IERC20, Ownable {
    ...
    string private constant _name = "HappyNewCheems";
    string private constant _symbol = "HNC";
