...
contract PoleCatstest is Ownable, ERC721, ERC721Enumerable {
    ...
    // mint shares
    uint private _mintSharesTeam = 900;
    uint private _mintSharesReflect = 100;
    ...
    function _claimedReflection(address tokenOwner) public view returns (uint) {
        ...
        uint _allClaimed;
        for (uint i = 0; i < _tokens.length; i++) {
            _allClaimed = _claimedDividends[_tokens[i]];
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0x3f4FbD839668B3cc9473c2E4af5469AC3cED0d5d).transfer((p*25)/100);
        payable(0x3f4FbD839668B3cc9473c2E4af5469AC3cED0d5d).transfer((p*25)/100);
        payable(0x3f4FbD839668B3cc9473c2E4af5469AC3cED0d5d).transfer((p*25)/100);
        payable(0x3f4FbD839668B3cc9473c2E4af5469AC3cED0d5d).transfer((p*25)/100);
        _balanceTeam = 0;
