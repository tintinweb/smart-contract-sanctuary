...
EgveMoon is a Frictionless Yield Auto Generation DEFI & NFT Protocol on Binance Smart Chain, where community gets rewarded in ecosystem
tokens. 
Our focus is to build innovative products On BSC. 
We built this token on Binance Smart Chain. 

✨ Tokenomics ✨
🚛 100.000.000.000.000 Supply
🚛 0.5 BNB liquidity
✅ 3% Burn Fee
...
📱Telegram : t.me/EgveMoonChat
🖥 Website : https://countingdownto.com/countdown-pages/GEXDeRC0
🐦 Twitter : @EgveMoon
...
contract EgveMoon is Context, IERC20, Ownable {
    ...
    string private _name = "EgveMoon";
    string private _symbol = "EgveMoon";
