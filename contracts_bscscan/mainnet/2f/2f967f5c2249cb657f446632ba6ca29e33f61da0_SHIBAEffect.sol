...
/**
              SHIBAEffect  ~ 7% SHIB rewards ~  
 
Website: https://shibaeffect.com
Telegram: https://t.me/ShibaEffect
FAIRLAUNCH ON PANCAKESWAP on Dec 23th at 21:00 utc
7% SHIB rewards
1% Liquidity Pool / Burn
5% Marketing
1T supply ♠ 20B max tx ♠ 50B max wallet ♠
 */
...
contract SHIBAEffect is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SHIBAEffect";
    string constant _symbol = "SHIBAEffect";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x749F23Cf55C0e3843aD0538ECDbDF17398749F53;
        ...
        marketingFeeReceiver = 0xFf2531FB155BFb1209Bbaa67a9a3E7b024D3f9fc;
