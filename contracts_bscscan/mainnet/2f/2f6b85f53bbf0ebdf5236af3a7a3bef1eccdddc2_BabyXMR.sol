...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @BabyXMR
   ...
   I will renounce the ownership to burn addresses to transfer #BabyXMR to the community, make sure it's 100% safe.
   ...
   it's the best part of the #BabyXMR idea, increasing the liquidity pool automatically, 
...
contract BabyXMR is Context, IERC20, Ownable {
    ...
    string private _name = "Baby XMR";
    string private _symbol = "BabyMonero";
