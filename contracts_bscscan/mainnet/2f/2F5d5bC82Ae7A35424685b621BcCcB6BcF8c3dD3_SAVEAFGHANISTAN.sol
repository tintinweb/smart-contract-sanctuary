...
/**
 * https://t.me/SAFEAfghanistan
 * 
 * EThereum Rewards for Charity. Afghanistan needs our help. 4% of each transaction will be send it for charity projects
 */
library SafeMath {
...
contract SAVEAFGHANISTAN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SAVEAFGHANISTAN";
    string constant _symbol = "SAFG";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8DC6D91871CF3913F13632BBA920c6B07d1A9d1d; //WALLET DEV
