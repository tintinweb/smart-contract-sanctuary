...
❣️🌙MoonGirl the newest most hyped and cutest token that's going to hit the moon🌙❣️


Telegram = https://t.me/moongirlBSCTOKEN
...
contract MoonGirl is IERC20, Ownable {
    ...
    string constant _name = "MoonGirl";
    string constant _symbol = "MNGRL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% MAX 40,000,000
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100; // 3% MAX 30,000,000
    ...
    uint256 liquidityFee = 600; // 5%
    uint256 buybackFee = 500;   // 4% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 300; // 3%
    uint256 totalFee = 1100; // liquidityFee + Buyback + devFee
    ...
    uint256 public swapThreshold = _totalSupply / 300; // 0.2%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x972c7202262535Bb03b7682aD418BAe783e16F0C);
