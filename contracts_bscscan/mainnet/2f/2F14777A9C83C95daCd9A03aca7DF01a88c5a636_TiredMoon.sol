...
contract TiredMoon is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xC54d063AC3738D84910298C3abD8280e6C274413); // Marketing Address
    ...
    string private _name = "Tired Moon";
