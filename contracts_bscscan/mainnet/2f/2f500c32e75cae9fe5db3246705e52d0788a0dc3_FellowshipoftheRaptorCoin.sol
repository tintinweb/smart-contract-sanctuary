...
/**
   ...
   I make this #DOGEFATHER to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/FellowshipoftheRaptorCoinBSC
   ...
   I will renounce the ownership to burn addresses to transfer #FellowshipoftheRaptorCoin to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49% total supply to the pool
   Can you make #FellowshipoftheRaptorCoin 1000X? 
   ...
   it's the best part of the #FellowshipoftheRaptorCoin idea, increasing the liquidity pool automatically, 
...
contract FellowshipoftheRaptorCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Fellowship of the Raptor Coin";
    string private _symbol = "THERAPTOR";
