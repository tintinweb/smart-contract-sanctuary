...
contract WOWSummitLeague is ERC721 {
    ...
    modifier onlyAuction() {
        require(msg.sender == auction, "WOWSummitLeague: wrong contract");
        _;
    }
    ...
    constructor() public ERC721("WOWSummit League", "WOWSummitLeague") {
        dev = msg.sender;
    }
    ...
    function addAuction(address _auctionAddress) public {
        require(msg.sender == dev, "WOWSummitLeague: Wrong call");
        require(
            auction == address(0),
            "WOWSummitLeague: Auction contract already added"
        );
