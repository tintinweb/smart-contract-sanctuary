...
contract  MuskGreenCap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Musk Green Cap";
    string private _symbol = "MGC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6691c1db69F1460b2c469EC5082CdbbB4A3FBc4b); // Marketing Address
