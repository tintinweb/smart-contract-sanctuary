...
/**
 * BaBakeryLove - Love's sweet bakes bring all the boys to the yard!
...
contract BakeryLove is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BakeryLove";
    string constant _symbol = "BKL";
