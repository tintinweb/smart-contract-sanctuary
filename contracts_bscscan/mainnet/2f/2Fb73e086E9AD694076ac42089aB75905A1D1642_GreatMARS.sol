...
/**
Let’s be ready  there!🚀 with their insane features they will stand out no matter what!
...
👉🏼Follow on Twitter https://twitter.co/MarssGreat

👉🏼 Network
https://great-mars.com/
...
library Address{
 ...
 contract GreatMARS is Context, IERC20, Ownable {
    ...
    uint256 private initialsupply = 10000000000000000;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 10000000000000000 * 10**9;
    uint256 public maxBuyLimit = 10000000000000000 * 10**9;
    uint256 public maxSellLimit = 10000000000000000 * 10**9;
    uint256 public maxWalletLimit = 10000000000000000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x8Fc2e73547295fe14AaedfDc7c87fE92328e3583;
    address public donationWallet = 0x62dD81f7449Ea27b556F83A3c004312E03F2D63b;

    string private constant _name = "Great MARS";
    ...
    Taxes public taxes = Taxes(2, 5, 3, 3);
    Taxes public sellTaxes = Taxes(2, 8, 5, 4);
