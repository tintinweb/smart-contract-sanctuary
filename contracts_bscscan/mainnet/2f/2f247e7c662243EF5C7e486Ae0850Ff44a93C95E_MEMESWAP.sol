...
contract MEMESWAP is Context, IBEP20, Ownable {
    ...
    address _burnADDRESS = 0x0000000000000000000000000000000000000001;   
    ...
    string private _name = 'MemecoinSwap Token';
    string private _symbol = 'MEMESWAP';
