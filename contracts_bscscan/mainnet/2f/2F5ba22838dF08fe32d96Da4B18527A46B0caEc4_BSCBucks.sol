...
/**
 * 
BSCBucks. Purchase this token to passively earn Dolers for your village, sir.

t.me/BSCBucks

Tokenomics: 

1 Billion total suuply
Anti-whale: 2% max wallet
Anti bot: 1% Max tx and 30 second cooldown between each transaction
 - 8% BUSD rewards for holders
 - 3% to liquidity
 - 7% for advertising support
 **/
...
contract BSCBucks is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BSCBucks";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "Dolers";
