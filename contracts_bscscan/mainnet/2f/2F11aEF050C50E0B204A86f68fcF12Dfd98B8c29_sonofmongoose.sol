...
//Lp Locked
//OwnershibRenounced
//Telegram : t.me/sonofmongoose
//$SOM next Moonshot Already to the Moon
...
contract sonofmongoose is Context, IERC20, Ownable {
    ...
    string private _name = "Son Of Mongoose";
    ...
    uint256 public maxBuyTranscationAmount = 5000000 * 10**9;
    uint256 public maxSellTransactionAmount = 1000000 * 10**9;
    uint256 public _maxWalletToken = 5000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 682741 * 10**9; 
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private liquidAddress = 0x4f1a3ab6e34E2CE445B6D922F5F5aD3BBC968884;
