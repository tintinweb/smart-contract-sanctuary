...
/**
 * - 14 days Liquidity Lock (will send and pin mudra link in the TG)
    

 # of Tokens: 1,000,000,000
 Max Wallet Size = 20,000,000
 Max Transaction Size = 10,000,000 

 Reflection/Taxes: 5% in BUSD, 5% in Marketing, 5% in Liquidity,
 Buy Slippage: 21-23% 

 *** THE MAX A WALLET CAN HAVE IS 2,000,000! THAT IS 2%! ***
...
// CHANGE
contract ThanosFloki is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ThanosFloki";
    string constant _symbol = "TFL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 6) / 1000; // 1% MAX 
    uint256 public _maxWalletSize = (_totalSupply * 10) / 1000; // 2% MAX
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xD38f44460abcd3c75CC2Ca75a62F0140bE67921A);
