...
TG: https://t.me/TetherPrint
Twitter: @TetherPrint
Website:  http://www.tetherprint.com
...
contract TetherPrint is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TetherPrint";
    string constant _symbol = "TPRINT";
    ...
    uint256 public swapThreshold = _totalSupply * 20 / 10000; // 0.02% of supply
    bool inSwap;
