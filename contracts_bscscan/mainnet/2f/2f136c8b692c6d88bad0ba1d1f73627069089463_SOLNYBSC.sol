...
contract SOLNYBSC is SOLNYDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SOLNYTeam;
    address private CharitySOLNY;
    ...
    string public override name = "Solana New Year";
    string public override symbol = "SOLNY";
    ...
    constructor(uint totalSupplyValue, address SOLNYTeamAddress, address CharitySOLNYAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SOLNYTeam = SOLNYTeamAddress;
        CharitySOLNY = CharitySOLNYAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SOLNYTeam] =  totalSupply * 20 / 100;
        balances[CharitySOLNY] = totalSupply * 28 / 100;
        
        balances[_owner] = totalSupply * 52 / 100;
    }
    ...
    // Get the address of the token's SOLNYTeam pot
