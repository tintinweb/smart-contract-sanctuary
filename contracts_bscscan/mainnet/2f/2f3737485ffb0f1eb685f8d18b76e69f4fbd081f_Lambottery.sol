...
LotteryHelper {
    ...
    string constant _name = "Lambot";
    string constant _symbol = "LAM";
    ...
    address public weeklyLottoWallet = 0x9392e9DC387a764775A26c0fCe33Da87F239746A;
    ...
    function callAfterDeploy() external onlyOwner {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (liquidityIsAdded) {
            ...
            if (!done) {
                ...
                if(shouldSwapBack(sender, _balances[address(this)])){
