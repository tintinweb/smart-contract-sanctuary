...
/**
 *                                               
Telegram . https://t.me/ChikuShibosu
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x2C14CBffD9963C17fF65028C52f75Ea6f14205Ff);
...
contract ChikuShibosu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address REWARD = 0x2C14CBffD9963C17fF65028C52f75Ea6f14205Ff;

    string constant _name = "ChikuShibosu";
    string constant _symbol = "ChikuShibosu";
    uint8 constant _decimals = 4;

   
    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals); //total supply 1,000,000,000,000
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; //max transaction of 20,000,000,000%
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; // max wallet of 20,000,000,000%
    ...
    bool public tradingDefault = true;
