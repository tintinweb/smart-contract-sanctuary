...
contract Ownable is Context {
    address private _owner = 0xFAef774fd991C15ddDA0E8F8Eddee05Db2fCA525;
...
contract SBReddoge is Context, IBEP20, Ownable {
    ...
    address payable public _marketingAddress = payable(0x34991581AabA6d73A764f613C08a6eb28765ca53);
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD);

    string private _name = "SBReddoge";
    string private _symbol = "SBReddoge";
    ...
    uint256 public durationBetweenEachBuyback = 300;

    uint256 public _tokenFee = 20; 
	...
	uint256 private _transactionLockTime = 30; 
