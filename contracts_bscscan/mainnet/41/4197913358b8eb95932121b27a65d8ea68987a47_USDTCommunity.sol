...
contract USDTCommunity {
    using SafeMath for uint256;
    address usdt = 0x55d398326f99059fF775485246999027B3197955;
    IBEP20 token;
    uint256 public constant INVEST_MIN_AMOUNT = 10 ether; // 5 usdt
    uint256[] public REFERRAL_PERCENTS = [70, 10, 5, 3, 2];
    uint256 public constant PROJECT_FEE = 250;
    ...
    constructor() public {
        ...
        plans.push(Plan(10000, 80));
        plans.push(Plan(30, 160));
        plans.push(Plan(55, 140));
        plans.push(Plan(90, 120));
    }
    ...
    function withdraw() public {
        ...
        IBEP20(usdt).transfer(commissionWallet, fee2);
