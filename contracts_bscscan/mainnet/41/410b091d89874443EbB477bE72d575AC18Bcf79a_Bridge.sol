...
contract Bridge is Pausable, AccessControl, SafeMath {
     ...
     */
    constructor (uint8 chainID, address[] memory initialRelayers, uint initialRelayerThreshold, uint256 fee, uint256 expiry, uint256 amountLimit) public {
        _chainID = chainID;
    ...
    /**
        ...
        @notice Only callable by admin.
        @param newAmountLimit Value {_amountLimit} will be updated to.
     */
    function adminChangeAmountLimit(uint newAmountLimit) external onlyAdmin {
        require(_amountLimit != newAmountLimit, "Current limit is equal to new limit");
        _amountLimit = newAmountLimit;
    }
    ...
    function deposit(uint8 destinationChainID, bytes32 resourceID, bytes calldata data) external whenNotPaused {
        ...
        // }
        // require(amount <= _amountLimit, "amount limit");
