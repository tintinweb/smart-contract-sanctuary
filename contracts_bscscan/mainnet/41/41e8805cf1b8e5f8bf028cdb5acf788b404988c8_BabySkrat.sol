...
contract BabySkrat is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Skrat";
    string constant _symbol = "BabySkrat";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 1000; // 100% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 200) / 1000; // 200%
