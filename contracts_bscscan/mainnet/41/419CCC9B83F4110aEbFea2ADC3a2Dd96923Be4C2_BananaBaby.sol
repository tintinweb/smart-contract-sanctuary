...
import "./BananaBabyDividendPayingToken.sol";

/**
BananaBaby!  - -  $BABA is a crypto coin that gives 8% BANANA in rewards. with the emergence of rewards token, We want to create new hype that differ us with others ! 


 🍌 FAIR Launch  🍌

📍 Why should you invest in BananaBaby!
...
💛Huge Marketing 
💛Liq Locked, 100% Safu
💛Doxxing and Audit planned 


📍 Vision📍

Our vision is to create market for all of the community, where holders Earn 8% in reflection of ApeSwapFinance Banana ($$Banana) as a Rewards.

Tokenomics :
✅ TOKEN NAME:  Banana Baby
✅ TOKEN SYMBOL:  $BABA
✅ Total Supply : 
✅ 8% $BANANA per transaction for holders  in 60 mins
✅ 3% transaction Marketing/Buyback
✅ 3% liquidity
✅ 2% team fund
...
💬 Telegram Community:
https://t.me/BananaBabyOfficial

💻 Website:
 http://www.BananaBaby.org

🐦 Twitter:
https://twitter.com/bananababytoken/status/1431379604573507585?s=21
*/
contract BananaBaby is ERC20, Ownable {
    using SafeMath for uint256;

    IPancakeSwapV2Router02 public PancakeSwapV2Router;
    address public immutable PancakeSwapV2Pair;

    address public immutable BANANA = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); // CAKE
    ...
    uint256 private _FeeFactor = 1000000000 * (10**18); 
    ...
    constructor() ERC20("BananaBaby", "BABA") {
