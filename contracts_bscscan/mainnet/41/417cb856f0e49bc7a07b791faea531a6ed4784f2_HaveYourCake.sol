...
This is a token with high CAKE rewards!

Total Supply: 1000.000000000
Total LP: 1000.000000000
...
tg:  https://t.me/HaveYourCake
web: https://www.eat-it.us/
*/
...
contract HaveYourCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "HaveYourCake";
    string constant _symbol = "EatItToo!";
    ...
    function ProlongLiquidityLockInSeconds(uint256 secondsUntilUnlock) public onlyOwner{
    ...
    function ReleaseLiquidity() public onlyOwner {
        ...
        uint256 amount = liquidityToken.balanceOf(address(this));
            ...
            liquidityToken.transfer(autoLiquidityReceiver, amount);

    }

    //Releases all remaining BNB on the contract wallet, so BNB wont be burned
    //Can only be called after Liquidity unlocks
    function RecoverRemainingBNB() public onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
        (bool sent,) =autoLiquidityReceiver.call{value: (address(this).balance)}("");
        require(sent);
    }
