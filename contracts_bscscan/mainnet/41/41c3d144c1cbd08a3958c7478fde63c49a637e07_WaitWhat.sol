...
contract WaitWhat is IBEP20, Auth {
    ...
    function setFees(uint256 _liquidityFee, uint256 _burnFee, uint256 _stakingFee, uint256 _nftStakingFee, uint256 _feeDenominator, uint256 _sellMultiplier, uint256 _sellDenominator) external authorized {
