...
contract $SuckItElon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb35ca08d86Bc4D32d35f5e83A36D908283d194FC); // Marketing Address
    ...
    string private _name = "$SuckItElon";
