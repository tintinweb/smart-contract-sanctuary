...
//
// GamesRewards proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN Skill and Plantsvsundead! With the auto-claim feature,
// simply hold GamesRewards and you'll receive Skill and Plantsvsundead! coins automatically in your wallet.
// 
// Hold hold$GamesRewards and get rewarded in  Skill and Plantsvsundead on every transaction!
//
//
// 📱 Telegram: https://t.me/GamesRewards
// 
// 
//
...
contract GamesRewards is ERC20, Ownable {
    ...
    address[] public  TOKENARR = [0x31471E0791fCdbE82fbF4C44943255e923F1b794,0x154A9F9cbd3449AD22FDaE23044319D6eF2a1Fab]; 
    ...
    constructor() public ERC20("GamesRewards", "GamesRewards") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "GamesRewards: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GamesRewards: Account is already the value of 'excluded'");
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        require(value >= 2000000000 * (10**18), "Babypoocoin: Minimum max wallet limit is 2 percent");
        _maxWalletLimit = value;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "GamesRewards: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "GamesRewards: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        require(newValue != gasForProcessing, "GamesRewards: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this) &&
            ...
            require(contractBalanceRecipient + amount <= _maxWalletLimit, "GamesRewards: Exceeds maximum wallet token amount");
        }
...
contract BABYBAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address token) public DividendPayingToken("GamesRewards_Dividen_Tracker", "GamesRewards_Dividend_Tracker",token) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "GamesRewards_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "GamesRewards_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GamesRewards contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "GamesRewards_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "GamesRewards_Dividend_Tracker: Cannot update claimWait to same value");
