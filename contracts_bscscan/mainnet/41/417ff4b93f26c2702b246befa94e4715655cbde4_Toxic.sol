...
/**
☠️ Token Toxic ☠️
The BSC is polluted ! Toxic Token is there to clean it !
New project by Koko' Squad.
...
TG: https://t.me/tokentoxic

We are currently developping with our community developers a new all in one scanner for smart contract into the BSC to improve quality of life of all investors.
Website -> https://tokentoxic.online/
Alpha version token scanner -> https://tokentoxic.online/scan

💎 FAIR LAUNCH TODAY 19H UTC 💎
*/
...
// CHANGE
contract Toxic is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "TOXIC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // NO MAX
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // NO MAX
    ...
    uint256 liquidityFee = 1000; // 10%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 200; // 6%
    uint256 devFee = 300; // 5%
    uint256 totalFee = 1600; // liquidityFee + reflectionFee + devFee
    uint256 feeDenominator = 10000;
    uint256 public _sellMultiplier = 1; // 3x for sells in the first hour... manually handled
