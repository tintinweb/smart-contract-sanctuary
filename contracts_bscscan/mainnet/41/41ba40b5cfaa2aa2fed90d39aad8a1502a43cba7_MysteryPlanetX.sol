...
Presented By @OldCryptoMage

Welcome to Mystery Planet X
...
contract MysteryPlanetX is IBEP20, Auth {
    using SafeMath for uint256;
//dont change
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Mystery Planet X";
    string constant _symbol = "PlanetX";
