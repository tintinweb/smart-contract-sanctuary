...
contract BNBDoge is Context, IERC20, Ownable {
    ...
    string private _name = "BNB Doge Inu";
    string private _symbol = "BNBDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9151AE949689cA1003cA1Be4278D6563f960715A); // Marketing Address
    address payable public teamWalletAddress = payable(0xa752d9C2234885B1cb92255FEF0Df4bac073002B); // Team Address
