...
contract SonOfWhale is Context, IERC20, Ownable {
    ...
    string private _name = "Son Of Whale";
    string private _symbol = "SoW";
    ...
    function _setMaxBalance(uint256 maxBalance) external onlyOwner() {
        require(maxBalance < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = maxBalance;
    }
}