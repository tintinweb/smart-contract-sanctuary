...
contract Staking is Ownable {
    ...
    constructor(uint256 _startBlock, uint256 _totalTokens, IERC20 _depositToken, IERC20 _rewardToken) {
        ...
        endBlock = startBlock + 201600; // 1 year is approx. 10368000 blocks
        totalTokens = _totalTokens;
        tokensPerBlock = totalTokens*precisionLevel / 201600; // precision level??
        depositToken = _depositToken;
        rewardToken = _rewardToken;
        lastDepositBlock = endBlock - 600;
    }    
    ...
    function deposit(uint256 _amount) public {
        ...
        stakingWallets[msg.sender]._2Claim = stakingWallets[msg.sender].unlockBlock + 100; // 14 days
