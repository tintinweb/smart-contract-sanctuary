...
/*
 * Super ADA reflection token 
 * Completely RUG proof
 * Liquidity locked for 6 months
 * 10% ADA rewards distributed amongst holders
 * ADA rewards increases over time
 * Auto claim rewards every 24h
 * 2% auto burn tokens with every buy/sell
 * only 2% marketing fees (decrease over time)
 * superadatoken.io
 */
...
// File contracts/lib/SafeToken.sol
...
// File contracts/lib/LockToken.sol
...
// File contracts/lib/DividendDistributor.sol
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 24 hours; // min 24 hour delay
    ...
    function claimDividendForShareholder(address shareholder) external {
        distributeDividend(shareholder);
    }
...
// File contracts/MiniCardano.sol


pragma solidity ^0.8.6;
contract SuperADA is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Super ADA";
    ...
    function claimDividend() external {
        distributor.claimDividendForShareholder(msg.sender);
    }
