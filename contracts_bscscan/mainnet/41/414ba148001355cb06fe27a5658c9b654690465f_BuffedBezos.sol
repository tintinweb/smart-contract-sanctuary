...
// TELEGRAM: https://t.me/BuffedBezos
// 100% STEALTH
...
contract BuffedBezos is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 77000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Buffed Bezos";
    string private _symbol = "BUBE";
    ...
    uint256 public _maxWallet = 77000000000000 * 10**9;
    uint256 public _maxTxAmount = 77000000000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 77000000000000 * 10**9; 
