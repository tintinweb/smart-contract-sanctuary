...
/**
    ...
    2.5% fees auto add to marketing/owner wallet.
...
contract HouseofCardz_Token is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "HouseofCardz";
    ...
    uint256 internal _tokenTotal = 750000000000 *10**12; // 750 Billion totalSupply
    ...
    uint256 public _charityFee = 250; // 250 = 2.5%
    
    uint256 public _taxFeeTotal;
    uint256 public _charityFeeTotal;
    
    address public charityAddress = 0xd54e3d618660D7249cCccAaa0590dF43BCf712B3; // Owner Wallet
