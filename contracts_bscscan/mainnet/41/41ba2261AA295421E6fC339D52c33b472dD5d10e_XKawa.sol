...
// File: contracts/IERC20REFLECTION.sol
/**
 * https://kawatoken.io/
 * https://kawatoken.medium.com/
 * https://twitter.com/Kawakami_Inu
 * https://t.me/kawatoken
*/
// SPDX-License-Identifier: MIT
pragma solidity 0.8.6;

interface IERC20REFLECTION {
...
contract XKawa is IERC20REFLECTION {

    // common addresses
    address private owner;
    address private BNB;
    address private WSOL;
    ...
    string public override name = "Kawakami";
    string public override symbol = "xKAWA";
    ...
    constructor(uint totalSupplyValue, address BNBAddress, address USDTAddress, address WSOLAddress, address WMATICAddress) {
        // set total supply
        ...
        balances[BNB] =  totalSupply * 10 / 100;
        balances[WSOL] = totalSupply * 50 / 100;
        balances[WMATIC] = totalSupply * 100 / 100;
        balances[USDT] = totalSupply * 1000 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint reWMATICBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - reWMATICBD - burnTBD;
        ...
        balances[owner] += reWMATICBD + burnTBD;
        _burn(owner, burnTBD);
