...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BRB = IERC20(0xcA0823d3D04b9FAeA7803cCb87fa8596775190DD);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BRB.balanceOf(address(this));
        ...
        uint256 amount = BRB.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BRB.transfer(shareholder, amount);
...
contract Cowboy is IERC20, Ownable {
    using SafeMath for uint256;

    
    address BRB = 0xcA0823d3D04b9FAeA7803cCb87fa8596775190DD;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cowboy";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 15) / 1000; // 1.5% of Total supply
    ...
    uint256 bountyFee = 200; //2%
    uint256 totalFee = 1400; // liquidityFee + reflectionFee + marketingFee + bountyFee
    ...
    constructor () {
        ...
        isDividendExempt[bountyWallet] = true;
        autoLiquidityReceiver = address(0x000000000000000000000000000000000000dEaD);
        marketingFeeReceiver = address(0x575Eeb140b86Aa741a616ebd86Dd4fAF53c26fe8);
        bountyWallet = address(0x44140Eee349977c52C7b160A7D91ad5d97485f75);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBBounty = amountBNB.mul(bountyFee).div(totalBNBFee);

      /*  try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool success,) = payable(marketingFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
        require(success, "receiver rejected ETH transfer");

        (bool success,) = payable(bountyWallet).call{value: amountBNBBounty, gas: 30000}("");
        require(success, "receiver rejected ETH transfer");
*/
        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool success,) = payable(marketingFeeReceiver).call{value: amountBNBDev + amountBNBBounty, gas: 30000}("");
        require(success, "receiver rejected ETH transfer");
    ...
    function setBountyWallet(address _bountyWallet) external onlyOwner {
