...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SM = IBEP20(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167);
...
contract blueFEG is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SM = 0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GAYFEG";
    string constant _symbol = "HIV";
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 0.005%
    bool inSwap;
