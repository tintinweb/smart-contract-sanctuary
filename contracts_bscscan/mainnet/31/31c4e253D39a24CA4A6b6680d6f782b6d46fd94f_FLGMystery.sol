...
/**
 ...
 Earn Mystery Reward - Random token rewards in every hour
 
 https://t.me/FLGMystery
...
contract FLGMystery is ERC20, Ownable {
    // CONFIG START
    
    // TOKEN
    string tokenName = "FLG Mystery";
    string tokenSymbol = "FLGM";
    uint256 tokenTotalSupply = 100_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0xB687378aEf684420d709f840f9227168e6054cD2;
    ...
    uint256 txCooldown = 1; // Amount of blocks that has to pass between transactions of a wallet
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded[account], "FLGM: Account already excluded");

        isExcluded[account] = true;
    }

    function unExclude(address account) public onlyOwner {
        require(isExcluded[account], "FLGM: Account is not excluded");
