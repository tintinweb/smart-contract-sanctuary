...
contract TokenERC20 is ERC20Interface, Owned{
  ...
  constructor() public {
    ...
    balances[owner] = 300000000000000*10**uint(decimals);
    balances[address(this)] = 700000000000000*10**uint(decimals);
    emit Transfer(address(0), owner, 300000000000000*10**uint(decimals));
    emit Transfer(address(0), address(this), 700000000000000*10**uint(decimals));
  }
...
contract Century is TokenERC20 {
