...
/**
Floki Classic Fork Floki coin
Anti dump / whale function, there is a fixed max buy/sell.
No rug, renounced ownership, liquidity pool transferred to Lock wallet
 */
...
contract FlokiClassic is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Floki Classic";
    string private _symbol = "FLOKIC";
    ...
    uint256 public _maxTxAmount = 50000000000000000000000 * 10**9;
