...
contract BabyMarvinInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xADd2e7f109d6C34910d430A85226b4953f73b128); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x2251c680D6862F5E634F7c02c7209C5EEf8f56ae); // buyback Address
    ...
    uint256 public _walletMax = 5000000000000 * 10**9; // 2%
