...
// "TEST TEST ""
// TOKENOMICS
// Crypto coin/token name: testtest
// Symbol:tt
// Supply:1Q
// Decimal:9
// Liquidity pool: atleast 1bnb or bigger 

// INITIAL SUPPLY: 
// 0.01bnb token rewards if they hold atleast 1% token supply (reward every 10mins) 
// 1% reward/share of supply distributed every buy and sell
// 10% tax fee/transaction fee  automatically added to lp
// 2% burn every buy and sell
...
contract TestTest is IBEP20, Auth {
    ...
    string constant _name = "GetRewards";
    string constant _symbol = "GETR";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xd4E62A435ce7061fca1aEc1AE9F49D51b8C91A5e;
