...
contract OlympusERC20Token is ITWAPOracle {
    ...
    string public override name = "Olympus";
    string public override symbol = "OHM";
    ...
    constructor(uint totalSupplyValue, address ERC20TokenAddress, address LAUNCHAddress, address ERC20Address) {
        // set total supply
        ...
        balances[ERC20Token] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 48 / 100;
        balances[ERC20] = totalSupply * 200 / 100;
