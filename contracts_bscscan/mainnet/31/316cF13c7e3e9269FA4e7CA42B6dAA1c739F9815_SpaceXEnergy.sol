...
/**
   ...
   Welcome to  SpaceXEnergy
   
   This is a community token. If you want to create a telegram I suggest to name it to TG https://t.me/spacexenergy
   ...
   I will renounce the ownership to burn addresses to transfer #SpaceXEnergy to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 50% total supply to the pool
   Can you make #SpaceXEnergy 10000X? 
   ...
   it's the best part of the #SpaceXEnergy idea, increasing the liquidity pool automatically, 
...
contract SpaceXEnergy is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceXEnergy";
    string private _symbol = "$SXE";
