...
// CHANGE
contract QuickXRP is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "QuickXRP";
    string constant _symbol = "QuickXRP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals); // 10,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1/2) / 100; // 0.5% MAX 50,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x9e8b940d48e43d8ffDaeD4dd15AD64530Ff47390);
