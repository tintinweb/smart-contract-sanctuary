...
//Experimental code, use it at your own responsability and risk.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  BBT = IBEP20(0xB3670F91E86a96EeDA0c75b1573035A6277226fb);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BBT.balanceOf(address(this));
        ...
        uint256 amount = BBT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BBT.transfer(shareholder, amount);
...
contract babyBBT is IBEP20, Auth {
    using SafeMath for uint256;

    address BBT = 0xB3670F91E86a96EeDA0c75b1573035A6277226fb;
    address WBNB = 0x82190B7e0998cAA0d1B2d07eca951DfaE903B43D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "BabyBBT";
    string constant _symbol = "bDivs";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x52E167308caD0A65B0f945dB7afBf6410bed5e4c;
        marketingFeeReceiver = 0xCc1188a69fdafB6FfBcCc5075004DC2a02a739EB;
