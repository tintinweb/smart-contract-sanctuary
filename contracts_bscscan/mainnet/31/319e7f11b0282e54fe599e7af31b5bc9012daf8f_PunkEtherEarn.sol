...
PEE stands for PunkEtherEarn. Our trusted community is a place where we can PEE in safety.


Join Us At Telegam: https://t.me/PunkEtherEarn
           Website: https://www.pee.digital
           Twitter: @PunkEtherEarn_
...
contract PunkEtherEarn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PunkEtherEarnDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("PunkEtherEarn", "PEE") {
        _ETHRewardsFee = 8;
        _liquidityFee = 2;
		_marketingFee = 6;
        ...
        maxBuyTranscationAmount = 2500000000 * (10**18);
        maxSellTransactionAmount = 100000000000 * (10**18);
        swapTokensAtAmount = 20000000 * (10**18);
        _maxWalletToken = 3500000000 * (10**18); // 5% of total supply


    	dividendTracker = new PunkEtherEarnDividendTracker();
    	antiBotEnabled = true;

    	liquidityWallet = owner();
		
		bulkSender = payable(0x979E44C6253C3B861705621DD0ac37f555025f82);
		marketingWallet = payable(0x8f751d47DF56693d1052f82ea582933345F2805A);
		
		_isExcludedMaxSellTransactionAmount[address(bulkSender)] = true;
		_isExcludedMaxSellTransactionAmount[owner()] = true;

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0xB439d0e753E2DDcDd5598775B1d5915CF8999C7E
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "PunkEtherEarn: The dividend tracker already has that address");

        PunkEtherEarnDividendTracker newDividendTracker = PunkEtherEarnDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "PunkEtherEarn: The new dividend tracker must be owned by the PunkEtherEarn token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "PunkEtherEarn: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "PunkEtherEarn: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PunkEtherEarn: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PunkEtherEarn: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "PunkEtherEarn: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "PunkEtherEarn: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "PunkEtherEarn: Cannot update gasForProcessing to same value");
    ...
    function swapTokensForBUSD(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of PiggyBank
            path,
            recipient,
            block.timestamp
        );
    ...
    function restoreAllFee() external onlyOwner() {
        ...
        _maxWalletToken = 2000000000 * 10**18;
        maxBuyTranscationAmount = 2000000000 * 10**18;
...
contract PunkEtherEarnDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("PunkEtherEarnDividend_Tracker", "PunkEtherEarn_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "PunkEtherEarn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "PunkEtherEarn_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PunkEtherEarn contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "PunkEtherEarn_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PunkEtherEarn_Dividend_Tracker: Cannot update claimWait to same value");
