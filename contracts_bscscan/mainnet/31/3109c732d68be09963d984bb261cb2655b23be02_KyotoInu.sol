...
/**   
   ...
   █▀▄ █▄▄█ █──█ ──█── █──█ 　 ▀█▀ █──█ █──█ 
   ▀─▀ ▄▄▄█ ▀▀▀▀ ──▀── ▀▀▀▀ 　 ▀▀▀ ▀──▀ ─▀▀▀
   Welcome to Kyoto Inu
   
   This is a community token. If you want to create a telegram I suggest to name it to @KyotoInu
   ...
   Burn Token    :  90,000,000,000,000,000 
   Liquidity Lock : 10,000,000,000,000,000 

   I will lock liquidity LPs  forever.
   I will renounce the ownership to burn addresses to transfer #KyotoInu to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make #KyotoInu 10000X? 
   ...
   it's the best part of the #KyotoInu idea, increasing the liquidity pool automatically, 
...
contract KyotoInu is Context, IBEP20, Ownable {
