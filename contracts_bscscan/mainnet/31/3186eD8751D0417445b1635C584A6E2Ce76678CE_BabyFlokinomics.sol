...
// 🐕‍🦺 Baby Flokinomics 🐕‍🦺
// Flokinomics is going up madly when altcoins is dead.
// Every Baby Flokinomics that's born before us already dead.
// We're here to stay, we'll be the only Baby Flokinomics that will stand the test of time.

// 🐶 800$ initial market cap.
// 🐶 Locked liquidity for 3 days, extended everytime 10k is added to the market cap.
// 🐶 Contract forked from the original Flokinomics.
//🐶 Huge marketing in plan.

// @babyflokinomicstoken
...
contract BabyFlokinomics is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Baby Flokinomics", "BFLOKIN", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x96D3Ed347a8A064425f5A0D70519B678f747467A;
