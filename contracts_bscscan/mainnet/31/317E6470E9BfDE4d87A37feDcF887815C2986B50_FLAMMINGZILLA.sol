...
/** 燃烧的齐拉 (FLAMMING ZILLA) -

 Telegaram : https://t.me/flammingzilla
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14C2b9701d48c35E8728FdD1b5A88851B1669FeD;
...
contract FLAMMINGZILLA is Context, IERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0x4B5A327B3c303A61602B20A07ACa9421F6AfbF48;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FLAMMING ZILLA";
    string private _symbol = "FMZ";
