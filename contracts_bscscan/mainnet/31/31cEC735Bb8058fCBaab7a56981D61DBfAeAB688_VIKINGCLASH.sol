...
contract VIKINGCLASH is IBEP20 {
    ...
    string public override name = "VIKING CLASH";
    string public override symbol = "VIKING";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[developmentPot] =  totalSupply * 100 / 100;
        balances[foundersPot] = totalSupply * 100000 / 100;
