...
https://dreendogecoin.net
https://t.me/Green_Doge_Coin

Green Doge
We are a community-oriented DeFi platform that provides ecosystem for private transactions, hyper-deflationary tokenomics and regular charity donations in purpose to support wild forests worldwide.
...
contract GDC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public _marketingAndDev = address(0x0702085E5D6FD12c1CdCBda58BFe3336617d3c21);
    ...
    uint256 private _tTotal = 1 * 10**16;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GREEN DOGE COIN";
    string private _symbol = "GDC";
    ...
    uint256 public marketingAndDevelopment = 0;
    ...
    uint256 public _maxTxAmount = 1 * 10**16;
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**13;
    uint256 public _maxWalletToken = 1 * 10**16;
