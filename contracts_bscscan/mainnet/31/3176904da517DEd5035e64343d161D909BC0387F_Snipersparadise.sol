...
contract Snipersparadise is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47; // reward token
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Snipers Paradise";
    string constant _symbol = "SPA";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 30 / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 3000; // 0.01% of supply
    bool inSwap;
