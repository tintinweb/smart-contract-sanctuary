...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public NATIVE = 0xae9F66BAaA495B5cBD9Ef03cc4E389053eF4Ca00;
    ...
    function updatePool(uint256 _pid) public {
        ...
        VaultToken(NATIVE).mint(owner(), NATIVEReward.mul(ownerNATIVEReward).div(10000));
        VaultToken(NATIVE).mint(address(this), NATIVEReward);
