...
contract PetPals is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2d3e99C2cF7a21e6d0a5FFfc71e3fE825058a65d); // Marketing Address
    ...
    string private _name = "PPAL";
    string private _symbol = "PPLS";
