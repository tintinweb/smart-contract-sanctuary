...
/* 
	...
	* Max Buy: 10,000 (~1.0% of Total Supply)
	* Max Hold: 10,000 (~1.0% of Total Supply)
	*/
	...
	contract CryptoUniverse is Context, IBEP20, Ownable {
	    ...
	    uint256 private constant _tTotal = 10 * 10**5 * 10**9; // 1 Milli
	    ...
	    uint256 public _maxTxAmount = 10 * 10**3 * 10**9; // Max Transaction: 10k (1%)
	    uint256 public _numTokensSellToAddToLiquidity = 300 * 10**6 * 10**9;
	    uint256 public _maxWalletToken = 10 * 10**3 * 10**9; // Max Wallet: 10k (1%)
	    
	    IPancakeRouter02 public immutable pcsV2Router;
	    address public immutable pcsV2Pair;
	
	    string private _name = 'Crypto Universe';
