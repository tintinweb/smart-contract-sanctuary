...
/**
     Project: Be a Trail Blazer, Lead.
*/
...
contract TrailBlazer is Context, IERC20, Ownable {
    ...
    address public constant _burn = address(0x000000000000000000000000000000000000dEaD);
    ...
    string private _name = "Trail Blazer";
    string private _symbol = "TrailBlazer";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2; // 2% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 5; // 5% added to liquidity 
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _burnFee = 2; // 2% burn fee
    uint256 private _previousBurnFee = _burnFee;
    
    uint256 public marketingAndDevelopment = 1; // 1% Marketing and Development
    ...
    uint256 public _maxTxAmount = 500000000000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 500000000000000000 * 10**9;
    uint256 public _maxWalletToken = 500000000000000000 * 10**9;
    ...
    constructor (address marketingAndDev) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Change router address accordingly
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && to != uniswapV2Pair){
            ...
            require(BalanceRecepient + amount <= _maxWalletToken,
                "Exceeds maximum wallet token amount (100000000000000000)"
            );
        }
