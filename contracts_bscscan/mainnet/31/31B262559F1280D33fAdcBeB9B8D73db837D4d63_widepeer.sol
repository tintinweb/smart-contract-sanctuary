...
contract widepeer is Context, IERC20, Ownable, LockToken {
    ...
    uint256 private _tTotal = 313000000000 * (10**9);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "widepeer";
    string private _symbol = "widep";
    ...
    address public charityWallet = 0x646a16e4EDd748F22328af08caBcBc613899f3E8;
    address public marketingWallet = 0xD65f86C8e65aA5Dc3949374046D65CdCacA42ca5;

    uint256 public _marketingFee = 3;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private _previousCharityFee = _charityFee;
    uint256 public totalFeesTax= _taxFee.add(_liquidityFee).add(_charityFee).add(_marketingFee).add(_burnFee);
...
//charity
    ...
    function setCharityFeePercent(uint256 charityFee) external onlyOwner() {
        ...
        totalFeesTax = _taxFee.add(_charityFee).add(_marketingFee).add(_liquidityFee).add(_burnFee);
