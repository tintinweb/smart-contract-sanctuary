...
/**
 *BabyEliphie BSC Token
 * Trading in crypto is subject to high risk.
 * Please invest only after you research.
 * TG : https://t.me/BabyEliphie
*/
...
contract BabyEliphie is Context,IBEP20,Ownable {
    ...
    string private constant _name = "BabyEliphie";
    string private constant _symbol = "BBEPE";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 1000000000000 * 10**9;
