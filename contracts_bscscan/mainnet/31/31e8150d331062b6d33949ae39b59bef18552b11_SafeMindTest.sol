...
/*
SafeMindTest is a fork of DogeX.
...
contract SafeMindTest is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SafeMindTest";
    string private constant _symbol = "SafeMindTest";
    ...
    address payable constant private _marketingAddress = payable(0xd62602a807108e2a2C411296179Bfbd6D81C3069);
    address payable constant private _buybackAddress = payable(0xc9f2d4B61878568dc8Eb117ef25d8b7aD7a7DbaB);
    address payable constant private _projectMaintainence = payable(0x880c0E743537517C77C87c0910E2ecc907c0dCb8);
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//shibax
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//shibax
