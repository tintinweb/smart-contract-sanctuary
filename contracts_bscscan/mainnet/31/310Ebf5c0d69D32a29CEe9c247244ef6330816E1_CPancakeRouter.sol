...
contract CPancakeRouter {
    ...
    function swapExactTokensForTokens(
        ...
        uint[] memory amountsFee = IPancakeRouter02(pancakeRouter).getAmountsOut(feeAmount, _path);
        IBEP20(_path[0]).safeTransferFrom(msg.sender, address(this), _amountIn);
        IBEP20(_path[0]).safeApprove(pancakeRouter, _amountIn);
        amounts = IPancakeRouter02(pancakeRouter).swapExactTokensForTokens(_amountIn.sub(feeAmount), _amountOutMin.sub(amountsFee[amountsFee.length - 1]), _path, _to, _deadline);
        ...
        returns (uint[] memory amounts)
    {
        ...
        IBEP20(_path[0]).safeTransferFrom(msg.sender, address(this), _amountIn);
        IBEP20(_path[0]).safeApprove(pancakeRouter, _amountIn);
        amounts = IPancakeRouter02(pancakeRouter).swapExactTokensForETH(_amountIn.sub(feeAmount), _amountOutMin.sub(amountsFee[amountsFee.length - 1]), _path, _to, _deadline);
        IBEP20(_path[0]).safeTransfer(IClimbFeeStrategy(climbStrategy).feeAddress(), feeAmount);
    }
    ...
    function swapTokensForExactTokens(
        ...
        IBEP20(_path[0]).safeApprove(pancakeRouter, amounts[0]);
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        IBEP20(_path[0]).safeTransferFrom(msg.sender, address(this), _amountIn);
        IBEP20(_path[0]).safeApprove(pancakeRouter, _amountIn);
        uint[] memory feeAmounts = IPancakeRouter02(pancakeRouter).getAmountsOut(feeAmount, _path);
        IPancakeRouter02(pancakeRouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(
            _amountIn.sub(feeAmount),
            _amountOutMin.sub(feeAmounts[feeAmounts.length - 1]),
            _path,
            _to,
            _deadline
        );
    ...
    function swapExactETHForTokensSupportingFeeOnTransferTokens(
        ...
        payable
    {
        IPancakeRouter02(pancakeRouter).swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
            _amountOutMin,
            _path,
            _to,
            _deadline
