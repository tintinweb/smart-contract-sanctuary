...
//
// TG: t.me/shibucci
// TG China: t.me/shibucciCN
// Website: www.shibucci.com
// Twitter: twitter.com/shibucciBSC
// Instagram: instagram.com/shibucciBSC
//
// SHIBUCCI next Level Token, NFTs, Flexible Tokenomics, Shiba Inu Rewards and more!
// First Clothing Line in Binance Smart Chain!
// Anti Bot, dont buy with Bots! NO REFUND
//
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); // SHIB
...
contract Shibucci is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibucci", "SUCCI") {
    	...
    	marketingWallet = address(0xfd6ad9Ab265037Cd95f1479f8E712F6069B3aa87); // set as marketing wallet
        liquidityWallet = address(0x4ecfFe344EDf5A2ed8BF1382CB914357ca3580e5); // liquidity will go to dead address at first, can update later if needed.
    ...
    function updateFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _burnFee) external onlyOwner {
        marketingFee = _marketingFee;
        rewardsFee = _rewardsFee;
        liquidityFee = _liquidityFee;
        burnFee = _burnFee;
    ...
    function swapBack(uint256 contractTokenBalance) internal {
        ...
        uint256 amountBNBDev = amountBNBMarketing/10;
    ...
    function buyBackTokens(uint256 bnbAmountInWei) internal {
