...
contract CateWars_NFT is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'CateWars NFT';
    string  private constant _SYMBOL = 'CWARS';
