...
import "./BabyDragonSlayer-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyDragonSlayer` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyDragonSlayer(Env.Testnet)` or `BabyDragonSlayer(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyDragonSlayer";
    string internal constant SYMBOL = "BDS";
     ...
     */
    address internal tipToTheDev =0x7764476b9D97C5C1f47Cf7e95a7c58a2cD0ED10A;
...
contract BabyDragonSlayer is SafeToken{
