...
contract MiniCarbonCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 1* 10**6 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tCommTotal;
    uint256 private _tBurnTotal;
    string private   _name = "Mini Carbon Coin - CNES";
    string private _symbol = "MiniCBC";
    ...
    address private _cWallet = 0xddF3CCF31eeC9BA4ebB4038d08356F8DEecBE700;
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    address private _usdt = 0x793cEa0F1003411396b3A81A77d92Fe37015E7A9;
