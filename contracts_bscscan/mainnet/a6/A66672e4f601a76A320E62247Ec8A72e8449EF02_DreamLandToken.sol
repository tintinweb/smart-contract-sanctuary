...
library SafeMath {
    ...
    function sub(uint av1, uint av2) internal pure returns (uint) {
        return av1 - av2;
    }
    ...
    function sub(uint av1, uint av2, string memory errorMessage) internal pure returns (uint) {
        unchecked {
...
contract DreamLandToken is Contexts, ICOIN, ICOINMetadata {
