...
contract LTCPUP is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x4105692a836c3598Dc5Ee98d8CFef9aCF079d995); // Marketing Address
    ...
    string private _name = "LTCPUP";
    string private _symbol = "LTCPUP";
