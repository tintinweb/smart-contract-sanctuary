...
Sphynomics
Tokenomics 
4% of every transaction will be redistributed to all holders, simply by holding Sphynomics.
...
contract Sphynomics is Context, IERC20, Ownable {
    ...
    string private _name = "Sphynomics";
