...
contract GymMLM is Ownable {
    ...
    constructor() {
        ...
        addressToId[0xA2329bb03D7D7890b5e2B949820bb40d68244BE5] = 1;
        idToAddress[1] = 0xA2329bb03D7D7890b5e2B949820bb40d68244BE5;
        userToReferrer[0xA2329bb03D7D7890b5e2B949820bb40d68244BE5] = 0xA2329bb03D7D7890b5e2B949820bb40d68244BE5;
        currentId = 2;
        levels = [0.1 ether, 0.1 ether, 0.1 ether, 0.1 ether, 1 ether, 3 ether, 10 ether, 20 ether, 30 ether, 50 ether, 60 ether, 70 ether, 80 ether, 100 ether, 200 ether];
        transferOwnership(0xA2329bb03D7D7890b5e2B949820bb40d68244BE5); // deployer address
    }
    ...
    function distributeRewards(
        ...
        if (_wantAddr != 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c) {
        ...
        while (index < length && addressToId[userToReferrer[_user]] != 1) {
            ...
            if (investment[referrer] >= levels[index]) {
                uint256 reward = (_wantAmt * directReferralBonuses[index]) / 100;
                IWETH(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c).withdraw(reward);
