...
contract EMUSK is Context, IERC20, Ownable {
    ...
    uint256 private _fee_team_convert_limit = _supply_total * 1 / 10000;
    uint256 public _fee_marketing_convert_limit = _supply_total * 1 / 10000;

    // Minimum Balance to maintain
    uint256 private _fee_team_min_bal = 0;
    uint256 public _fee_marketing_min_bal = 0;
    
    //refection fee
    uint256 public _fee_reflection = 400; // 4%
    uint256 private _fee_reflection_old = _fee_reflection;
    uint256 private _contractReflectionStored = 0;
    
    // marketing
    uint256 public _fee_marketing = 300; // 3%
    uint256 private _fee_marketing_old = _fee_marketing;
    address payable public _wallet_marketing = payable(0xE384455F786E2eC6ce3556b973F573693a8a71dd);

    // for burn
    uint256 public _fee_burn = 100; // 1%
    ...
    // for team (ignore)
    uint256 private _fee_team = 0; // 0%
    uint256 private _fee_team_old = _fee_team;
    address payable public _wallet_team = payable(0x000000000000000000000000000000000000dEaD);

    // Auto LP
    uint256 public _fee_liquidity = 100; // 1%
    ...
    uint256 public _maxWalletToken = ( _supply_total * 5 ) / 1000;
