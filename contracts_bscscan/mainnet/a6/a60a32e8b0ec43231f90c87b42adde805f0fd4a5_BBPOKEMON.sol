...
contract BBPOKEMON is Context, IERC20, Ownable {
    ...
    string private _name = "BBPOKEMON";
    string private _symbol = "BBPKM";
    ...
    uint256 public _maxWalletAmount = _tTotal / 25;
    ...
    function unsetBot(address account) public onlyOwner {
        _bots[account] = false;
    }
    ...
    function _transfer(
        ...
        require(_bots[from] == false && _bots[to] == false, "Bot detected !");
        if(from != owner() && to != owner())
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
            require(amount + balanceOf(to) <= _maxWalletAmount, "Wallet balance + amount exceeds the maxWalletAmount.");
