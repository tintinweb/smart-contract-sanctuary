...
contract BabyDogePresident is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    uint256 public _maxTxAmount = 1 * 10**2 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**5 * 10**18;
