...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x764f52B0cf161B3bcDF7c4410541790fA0bEFE91;
...
contract AveshWenRug is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x764f52B0cf161B3bcDF7c4410541790fA0bEFE91;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Avesh wen RUG";
    string private _symbol = "AVS";
