...
contract IvoryToken is ERC20, ERC20Burnable, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    using SafeMath for uint256;
    address public admin;
    constructor() ERC20("Ivory Token", "IVYC") ERC20Permit("Ivory Token") {
    ...
    // Functions to add staking to coin
