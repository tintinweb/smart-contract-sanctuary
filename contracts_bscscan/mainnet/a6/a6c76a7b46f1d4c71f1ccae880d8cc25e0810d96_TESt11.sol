...
abstract contract Ownable is Context {
    ...
    constructor () {
        // JAPLO
        _owner = 0x5409d5141e05c6F6148e3d6b8Ad150852Bb8663c;
...
contract TESt11 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5c2E9C4cBBeDd5c236d57D651f54c2DA7977f08E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 6*10**18 * 10**18; //600m
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TEST11";
    string private _symbol = "T11";
