...
contract TT1 is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xC819B5D6f97010a89205c054F929154246C57fD0; //jangan lupa diganti
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        ...
        require(canTrade == true, "Trade not started yet!");
        return _transferFrom(msg.sender, recipient, amount);
    }
    ...
    function getReflectionFee() public view returns (uint){
