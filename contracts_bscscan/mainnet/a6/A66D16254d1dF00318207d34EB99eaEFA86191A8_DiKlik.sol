...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcacb2f725f1486a9b4ae220EA8aab68224F7c7Fa;
...
contract DiKlik is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0e8e3374b8fbB6F49CF383b832d11c28d7eb3983;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DiKlik";
    string private _symbol = "DKLK";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "DKLK: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "DKLK: decreased allowance below zero"));
        return true;
    }
