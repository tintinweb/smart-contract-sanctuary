...
contract DogeEuro is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge Euro";
    string constant _symbol = "$DE";
    ...
    uint256 public swapThreshold = _totalSupply * 393 / 100000; // 0.39% of total supply
    bool inSwap;
