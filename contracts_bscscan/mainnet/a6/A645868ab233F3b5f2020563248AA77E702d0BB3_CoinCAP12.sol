...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xde6518bef74a24b5618D22295715cF0BC7fdc76d);
...
contract CoinCAP12 is IBEP20, Auth {
    using SafeMath for uint256;

    address DOJAO = 0xde6518bef74a24b5618D22295715cF0BC7fdc76d;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TESTE 2";
    string constant _symbol = "TESTESUB2";
    ...
    uint256 public swapThreshold = _totalSupply / 50; 
    bool inSwap;
