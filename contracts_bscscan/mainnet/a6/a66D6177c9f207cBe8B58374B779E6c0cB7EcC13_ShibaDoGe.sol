...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    address public devWallet = 0xa5d5d66fDCFaC39aad81F4ab0751E6f2331b7230; 
    ...
    uint256 private numTokensSellToAddToLiquidity = 243000 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 3000000 * 10**9 * 10**9;
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_taxFee).div(1000**2);
    }

    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee).div(1000**2);
    }
