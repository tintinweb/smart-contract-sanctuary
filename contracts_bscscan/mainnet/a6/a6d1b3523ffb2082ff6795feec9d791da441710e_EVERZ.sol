...
contract EVERZ is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x07d18123E83e9FA97ECe46bB1D64734b441c5C6B;
    ...
    string private _name = "EVER ZILLA";
    string private _symbol = "EVERZ";
    ...
    uint256 private numTokensSellToAddToLiquidity = 690000000000000000000 * 10**6 * 10**9;
