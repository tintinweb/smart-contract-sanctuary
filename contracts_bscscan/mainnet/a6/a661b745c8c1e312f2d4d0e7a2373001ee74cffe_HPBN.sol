...
contract HPBN is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x0000000000000000000000000000000000000000;
    ...
    string private _name = "HyperBurn";
    string private _symbol = "HPBN";
