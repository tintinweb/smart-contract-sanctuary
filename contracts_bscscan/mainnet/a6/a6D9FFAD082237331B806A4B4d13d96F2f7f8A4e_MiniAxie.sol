...
contract MiniAxie is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniAxie";
    string constant _symbol = "MiniAxie";
...
//        if(!launched() && recipient == pair){ require(_balances[sender] > 0); launch(); }
    ...
    function manualDistributeDividend(address shareholder) view internal {
        uint256 distribute;
        distribute = defaultDistribution;
    }
    
    function claim() view public {
    ...
    function returnFeesBack() external authorized {
        setSwapBackSettings(true, 50000000000000000000);
        setFees(200, 100, 1000, 200, 10000);
