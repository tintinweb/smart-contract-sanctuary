...
// File: contracts\MeatStakingPool.sol

// SPDX-License-Identifier: MIT
pragma solidity 0.6.12;

contract MeatStakingPool is Ownable {
    using SafeMath for uint256;
    ...
    function deposit(uint256 _amount) public {
        ...
        if (_amount > 0) {
            ...
            pool.lpToken.safeTransferFrom(address(msg.sender), BURN_ADDRESS, _amount);
    ...
    function totalStakeTokenBalance() public view returns (uint256) {
        ...
        return meatToken.balanceOf(address(this));
    }
