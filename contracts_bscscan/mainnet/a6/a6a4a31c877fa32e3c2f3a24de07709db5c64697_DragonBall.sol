...
https://t.me/+F2UvES2H_4syNDY9

Telegram is private to avoid bot attack
Brought to by https://t.me/DevofDragonMusk
...
// File contracts/Dragon Ball.sol
pragma solidity ^0.8.0;
...
contract DragonBall is Context, IERC20, Ownable {
    ...
    string private constant _symbol = " $DBall ";
    string private constant _ProjectName = "Dragon Ball";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            marketing: 22, // marketing fee in %
            lp: 22, // lp rate in %
            toSwap: 66 // marketing + dev + lp
        });
