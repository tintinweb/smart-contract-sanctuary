...
A shared, immersive, and blockchain-based virtual platform for the making, distribution and sale of Virtual Arts with CMETA as the governance token.
...
🌑 Launch will be 10th of January @ 8pm UTC 🌑
*/
...
contract ZeroHour is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "ZEROHOUR"; //
