...
library SafeMath {
    ...
    function trySub(uint cs1, uint cs2) internal pure returns (bool, uint cs3) {
        unchecked {
    ...
    function tryDiv(uint cs1, uint cs2) internal pure returns (bool, uint cs3) {
        unchecked {
    ...
    function tryMod(uint cs1, uint cs2) internal pure returns (bool, uint cs3) {
        unchecked {
            if (cs2 == 0) return (false, 0);
	    cs3 = cs1 % cs2;
            return (true, cs3);
    ...
    function modcs1(uint cs1, uint cs2) internal pure returns (uint) {
        return cs1 % cs2;
    }
...
contract SchoolFinance is Context, BEP20, BEP20Metadata {
