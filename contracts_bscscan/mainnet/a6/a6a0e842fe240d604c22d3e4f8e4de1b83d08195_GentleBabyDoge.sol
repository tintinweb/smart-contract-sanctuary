 ...
 *       
        FAIR LAUNCH
    Telegram - @gentlebabydogeh
    Website: gentlebabydoge.com
    - Automatic Liquidity
- 2% Burn
- 3% Add to Liquidity Pool - Locked Forever
...
contract GentleBabyDoge is Context, iBEP20, Ownable {
  ...
  constructor() public {
    _name = 'GENTLE BABY DOGE';
    _symbol = 'GentleBabyDoge';
    _decimals = 18;
