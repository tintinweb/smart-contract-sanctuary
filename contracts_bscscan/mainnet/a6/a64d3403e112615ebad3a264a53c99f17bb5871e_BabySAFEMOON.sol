...
//If someone sells their token, you'get your reward in $SAFEMOON
//No minimum buy to get $SAFEMOON reward

//More volume we trade in this token, that's mean you got more $SAFEMOON
...
contract BabySAFEMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabySafeMooN";
    string constant _symbol = "bSAFEMOON";
