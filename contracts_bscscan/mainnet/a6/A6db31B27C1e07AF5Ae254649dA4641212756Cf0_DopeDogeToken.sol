...
contract DopeDogeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xeE8Bc75709cce90C60557f62a22A9B9e56d669B4); // Marketing Address
    ...
    string private _name = "DOPE DOGE";
