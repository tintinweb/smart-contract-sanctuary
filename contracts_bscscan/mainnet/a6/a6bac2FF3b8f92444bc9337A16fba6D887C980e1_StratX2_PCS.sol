...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-SEAL staking vault.
    ...
    address public sealFarmAddress;
    ...
    address[] public earnedToSEALPath;
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(sealFarmAddress, _wantAmt);
...
contract StratX2_PCS is StratX2 {
    constructor(
        ...
        govAddress = 0xf62940E679875A3F1a6c539d18cF635DE3e129BE;
        sealFarmAddress = 0x6b1cD438C152a4c2501375a756c5b7212C62A4CE;
        SEALAddress = 0xa5e5193bc78ffdeA28F9803480A671499D1891b5;

        wantAddress = _wantAddress;
        token0Address = SEALAddress;
        token1Address = wbnbAddress;
        earnedAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        lockerAddress = 0xb60E5515dA9760a208d8fE130890cE40834bdA6b;
        ...
        earnedToSEALPath = [earnedAddress,wbnbAddress,SEALAddress];
        earnedToToken0Path = [earnedAddress,wbnbAddress,SEALAddress];
        earnedToToken1Path = [earnedAddress,wbnbAddress];
        token0ToEarnedPath = [SEALAddress,wbnbAddress,earnedAddress];
        token1ToEarnedPath = [wbnbAddress,earnedAddress];

        buyBackRate = 4000;

        transferOwnership(sealFarmAddress);
    }
}