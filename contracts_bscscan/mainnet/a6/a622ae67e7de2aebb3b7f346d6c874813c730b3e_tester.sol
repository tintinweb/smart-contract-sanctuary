...
contract tester is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 private _maxSellAmountBNB = 100000000; // 0.5 BNB
    uint256 private _minBuyBNB = 10; // 0.001 BNB
    uint256 private _minSellBNB = 10; // 0.001 BNB
    ...
    uint256 public minTokensToSwap = 10 * 10**9; // 0.001 % of supply
    ...
    uint256 constant private _projectMaintainencePercent = 15;
    uint256 private _rafflePercent = 40;
    uint256 private _marketingPercent = 45;
    ...
    address payable private _marketingAddress = payable(0xAf6910146298574a048ad6EfD9D1FC26d67982A8);
    address payable private _raffleAddress = payable(0x0810e9fC43401f407AEC1f86ab5f63F3EDAb3573);
    ...
    address payable public stakingAddress = payable(0xFC333592265c02583660721186d95A96baD8F6b7);
    ...
    constructor() {
        ...
        _isContract[0x78AE434566bbF97ABc4c06388716E2ECc4d08F7a]; // v1 contract
    ...
    function sendETHToFee(uint256 amount) private {
        if(block.timestamp < _firstBlock + (10 days)) {
            address payable addr = payable(0xeF7cAefb4b010e7448E4f1F121B52964df932739); // dev fee lasts for ten days only
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > _tTotal.div(10000000), "Amount must be greater than 0.01% of supply");
    ...
    function updateMinBuySellBNB(uint256 minBuyBNB, uint256 minSellBNB) external onlyOwner() {
        require(minBuyBNB <= 10, "cant make the limit higher than 0.001 BNB");
        require(minSellBNB <= 10, "cant make the limit higher than 0.001 BNB");
        _minBuyBNB = minBuyBNB;
        _minSellBNB = minSellBNB;
    }
    
    function updateMaxSellAmountBNB(uint256 maxSellBNB) external onlyOwner() {
        require(maxSellBNB >= 100000000, "cant make the limit lower than 0.5 BNB");
