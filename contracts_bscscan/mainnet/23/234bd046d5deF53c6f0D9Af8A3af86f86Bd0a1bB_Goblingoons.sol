...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B69DEB9FBe4f887e75463B1b90528399aD0174D;
...
contract Goblingoons is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x4B69DEB9FBe4f887e75463B1b90528399aD0174D);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Goblin Goons";
