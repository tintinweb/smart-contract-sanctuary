...
interface IBEP20Sniper is IERC11 {
 ...
 contract NFTEarth is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "NFT Earth";
    string private _symbol = "NFTE";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0x6A5C6a2EE16F42145038f59517Bae7cde8d3440B;
    address private _water4Africa = 0x6A5C6a2EE16F42145038f59517Bae7cde8d3440B;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0x6A5C6a2EE16F42145038f59517Bae7cde8d3440B;
