...
/* Token contract */
contract testmenow  is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address REWARD = 0x6Ae9701B9c423F40d54556C9a443409D79cE170a;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address Buyback = 0x06a2e3799acd05AB07436ac7250a9526706F1Ba0;
    ...
    string constant _symbol = "testme";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x06AaeCb35C790fD51669584B42C4dA6AEA5dbf1a;
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _buybackFeeBuy, uint256 _rewardFeeBuy, uint256 _marketingFeeBuy, uint256 _feeDenominator) external authorized {
        ...
        totalFeeBuy = _liquidityFeeBuy.add(_buybackFeeBuy).add(_rewardFeeBuy).add(_marketingFeeBuy).add(BuybackFeeBuy);
    ...
    function setSellFees(uint256 _liquidityFeeSell, uint256 _buybackFeeSell, uint256 _rewardFeeSell, uint256 _marketingFeeSell, uint256 _feeDenominator) external authorized {
        ...
        totalFeeSell = _liquidityFeeSell.add(_buybackFeeSell).add(_rewardFeeSell).add(_marketingFeeSell).add(BuybackFeeSell);
        feeDenominator = _feeDenominator;
    }
