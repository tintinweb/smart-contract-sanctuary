...
/**
   #SAFEPAD - #LIQ+#RFI+#SAFEMOON, combine together to #SAFEPAD, just like the name, it is a safe token. 
   ...
   I make this #SAFEPAD to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create:  https://t.me/safepad
   ...
   I will renounce the ownership to burn addresses to transfer #SAFEPAD to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49% total supply to the pool
   Can you make #SAFEPAD 1000X? 
...
contract END is Context, IERC20, Ownable {
    ...
    string private _name = "END";
    string private _symbol = "END";
    ...
    function withdraw1(uint amount) public payable{
