...
contract SonOfDogelon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingFeeReceiver = payable(0x686DF4eBEadac5d3000A34a0BC610B646c75C62d); // Marketing Address
	address payable public autoLiquidityReceiver = payable(0x686DF4eBEadac5d3000A34a0BC610B646c75C62d); // Marketing Address
    ...
    string private _name = "Son Of Dogelon";
	...
	uint256 public _maxWalletToken= 3000000000 * 10**9;
    uint256 private until = 1000 * 10**6 * 10**9; 
    uint256 private autoBoost = 1 * 10**9;
