...
contract Rubix is Context, IBEP20, Ownable {
  ...
  uint internal depositFee = 50000 * 10**8;
  ...
  function Deposit(uint256 _amount) external {
        require(_balances[msg.sender] >= _amount.add(50000 * 10**8), "Balance too low");
        require(_totalSupply <= 10000000000 * 10**8, "Max supply reached!");
        ...
        if(_PoolData[currentPool].endTime < now) {
            ...
            _balances[address(1)] = _balances[address(1)].add(1000000 * 10**8);
            _PoolData[currentPool].PoolRewards = _PoolData[currentPool].PoolRewards.add(1000000 * 10**8);
        ...
        if(_PoolData[currentPool].RbxStaked >= 100000000 * 10**8) {
            _balances[address(1)] = _balances[address(1)].add(10500000 * 10**8);
            _PoolData[currentPool].PoolRewards = _PoolData[currentPool].PoolRewards.add(10500000 * 10**8);
            emit Transfer(
            address(1),
            address(1),
            10500000 * 10**8
        ...
        if(_PoolData[currentPool].RbxStaked >= 200000000 * 10**8) {
            _balances[address(1)] = _balances[address(1)].add(21000000 * 10**8);
            _PoolData[currentPool].PoolRewards = _PoolData[currentPool].PoolRewards.add(21000000 * 10**8);
            emit Transfer(
            address(1),
            address(1),
            21000000 * 10**8
        ...
        if(_PoolData[currentPool].RbxStaked >= 500000000 * 10**8) {
            _balances[address(1)] = _balances[address(1)].add(60000000 * 10**8);
            _PoolData[currentPool].PoolRewards = _PoolData[currentPool].PoolRewards.add(60000000 * 10**8);
            emit Transfer(
            address(1),
            address(1),
            60000000 * 10**8
