...
contract SAFEVENUS is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "SafeVenus";
   string constant _symbol = "SAFEVENUS";
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xAf35DF266857236B09658C69BB6156186b31Bd9B;
