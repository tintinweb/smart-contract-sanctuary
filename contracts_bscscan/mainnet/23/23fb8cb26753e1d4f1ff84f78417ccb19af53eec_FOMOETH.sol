...
contract FOMOETH is ERC20Detailed, ERC20Burnable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 500000000 * (10 ** uint256(DECIMALS));

    constructor () public ERC20Detailed("FOMOETH", "FOMOETH", DECIMALS) {
        _mint(0x125EB60AE8Da02C5250520527Ea316bD673d8b80, 500000000 ether);
