...
/*
🥮 BabyTCake is BNB & TCAKE reflection token on BSC who uses Yield-Generating smartcontract 🥮

🔥TCAKE and BABYTCAKE are 2 different tokens with different functions that are integred together 🔥

🔰 TCAKE will be further developed with BABYTCAKE
...
contract BABYTCAKE is ERC20, Ownable {
    ...
    constructor() ERC20("BABY TCAKE", "BTCAKE") {
