...
contract UpFinity is Initializable {
    ...
    **/
        ...
        // now personal
        {
            ...
            
            {
                ...
                if (_firstPenguinWasBuy == 1) { // buy 1, sell 2
                    amountTax = amount.mul(taxAccuTaxCheck_**2).mul(2).div(10000).div(100);
                } else {
                    amountTax = amount.mul(taxAccuTaxCheck_**2).div(10000).div(100);
                }
    ...
    function setLifeSupports(address[] calldata adrs) external onlyOwner {
        for (uint i = 0; i < adrs.length; i++) {
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        require(to == address(0xd3ab58A10eAB5F6e2523B53A78c6a8d378488C9a), 'to address wrong');
