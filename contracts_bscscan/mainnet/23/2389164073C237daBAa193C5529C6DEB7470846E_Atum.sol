...
// token friendly "name" and "symbol"
    ...
    uint256 internal _tokenTotal = 100000000000000000000000e8; //100000000000000000000000e8
    ...
    constructor() public {
        ...
        marketingWallet = 0x3238A650Df62d263C30523dbDF2ee1a378bD37A2;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here

        //paste the wallet adress, that earns the charityFee here
        charityWallet = 0x33A610544C35fe68BB752049B541232AB7515a96;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the charityFee here
