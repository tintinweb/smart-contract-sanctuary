...
Binance Launchpad: https://launchpad.binance.com/en/subscription/C98_BNB
...
contract Coin98 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8D67e38939c6E9229651a5E0b320777C97EC5A2f); // Marketing Address
    ...
    string private _name = "Coin98";
    string private _symbol = "C98";
