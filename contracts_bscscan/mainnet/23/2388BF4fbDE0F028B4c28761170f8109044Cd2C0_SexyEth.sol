...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //the reward token you want distributed 
...
contract SexyEth is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0x416f178b3647cAb888cA434348599507181b8D31;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Sexy ETH";
    string constant _symbol = "SEXYETH";
