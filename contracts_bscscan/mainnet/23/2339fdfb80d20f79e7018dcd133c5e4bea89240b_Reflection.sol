...
contract Reflection is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**8 * 10**9; //100 milion supply 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "AnonToken"; //Token Name
    string private _symbol = "AT"; //Symbol 
    ...
    address public _marketingWallet = payable(address(0x5D0b12b4780770587067c212a225B0777955e737)); //marketing
    address public _buybackWallet = payable(address(0x61D1833ac404Fcb13C26FE1017b8c72217048933)); //buyback
