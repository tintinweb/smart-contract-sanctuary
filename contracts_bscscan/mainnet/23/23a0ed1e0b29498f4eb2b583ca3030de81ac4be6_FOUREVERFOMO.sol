...
//🔒 Liquidity locked immediately on launch.
//✅Audieted Contract

//Earn $BUSD Just by holding 4EVERFOMO every 30 minutes.
//🛡Contract verified
//🛡Anti-Whale
//🛡Ownership Renounced 
//🛡100% Safu
//
// Telegram: https://t.me/foureverfomo
...
contract FOUREVERFOMO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "4EVERFOMO";
    string constant _symbol = "4EVERFOMO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 100 )  / 100; // 5%
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 100; // 5%
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // 0.5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x108c7414C307E3cD20630554a71AA109cEc6B8a0;
