...
contract ShibaCupCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaCupCake";
    string constant _symbol = "ShibaCC";
	...
	function setWalletBanStatus(address user, bool banned) external authorized {
		if (banned) {
            require(	1628061831 + 3650 days > block.timestamp, "User was put in a cage.");
