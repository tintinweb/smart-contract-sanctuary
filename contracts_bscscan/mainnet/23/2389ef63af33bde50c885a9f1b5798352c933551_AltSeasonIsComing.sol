...
contract AltSeasonIsComing is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AltSeasonIsComing";
    string constant _symbol = "ASIC";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x103DC70172b7FCa1f7De861b68ff5501B129022F);
