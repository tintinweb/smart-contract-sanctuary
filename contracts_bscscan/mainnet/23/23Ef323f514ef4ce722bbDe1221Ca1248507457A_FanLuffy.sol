...
contract FanLuffy is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000000000; //963 million
    ...
    // 0.05% of Total Supply sell to add toliquidity
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 50000) / 10000;
