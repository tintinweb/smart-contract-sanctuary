...
/**
 *MiniSkating is the Revolution in the field of sports based Cryptocurrency. With Skating making it to Olympics this time, we are unstoppable. We wish to keep alive the legacy of our God, our saviour Tony Hawk.
MiniSkating is the latest edition to the newest trend of sport token with bsc, this token is built with moonshot tokenomics hoping to take you to the levels of minifootball please join us in our journey.
...
contract MINISKATING is Context, IERC20, Ownable { 
    ...
    string private _name = "MINI SKATING"; 
    string private _symbol = "MINISKATING"; 
    ...
    address public devWallet = 0x0942Bd4715ABd2E6bb0269c9755d5aDCBE54d339; 
