...
LAUNCHING TODAY 6PM UTC

Dev is well known in the industry and also the owner of @trexcalls, over 15bnb to be spent from his own pocket to moon this

🐯Fairlaunch no private sale
🐯Bullish name
🐯Massive call groups after launch
🐯Huge marketing budget
🐯Listing on CMC as soon as able

https://t.me/tigerchibi
*/
...
contract TigerChibi is Context, IERC20, Ownable {
    ...
    string private constant _name = "TigerChibi"; // 
    string private constant _symbol = "TIGERCHIBI"; //
