...
contract EverDino is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCAD92f84F5C9a7366aC434F55d703fC3a9eeF03C); // Marketing Address
    ...
    string private _name = "EverDino";
    string private _symbol = "EDINO";
