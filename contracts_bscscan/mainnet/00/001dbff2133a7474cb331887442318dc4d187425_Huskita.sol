...
/**
   ...
   Huskita starting the new year with a new trend, LFG

60 second transaction cooldown
...
✴️ Sell tax = 15%       FIRST 60 MINS SELLS WILL BE DOUBLE TAXXED TO AVOID DUMPERS, BE CAREFUL

✴️ Telegram  https://t.me/Huskitainuu
...
/* Token contract */
contract Huskita is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV  = 0x48E55591127ef70696ce7Bf7b4a89E9F7677D364;
    ...
    // Name and symbol
    string constant _name = "Huskita Inu";
    ...
    uint256 GREEDDuration = 6600;
    
    // Dead blocks
    uint256 deadBlocks = 2;

    // Sell amount of tokens when a sell takes place
    uint256 public swapThreshold = _totalSupply * 30 / 10000; // 600,000 tokens or 0.06% of supply
