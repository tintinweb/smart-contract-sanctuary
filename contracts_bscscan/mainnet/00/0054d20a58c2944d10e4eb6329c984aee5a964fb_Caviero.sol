...
// 'Caviero' Smart Contract
//
// OwnerAddress : 0x6a846aEb7748536Be4DBc7Ba65CE153477f64203
// Symbol       : CVR
// Name         : Caviero
// Total Supply : 1,000,000,000,000 CVR
// Decimals     : 18
//
// The MIT Licence.
// 
...
contract Owned {
    ...
    constructor() public {
        owner = 0x6a846aEb7748536Be4DBc7Ba65CE153477f64203;
    }
...
// ----------------------------------------------------------------------------
contract Caviero is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        RATE = 1000000000; // 1 BNB = 100000 CVR 
        DENOMINATOR = 10000;
