...
contract MetaMen is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "MetaMen";                                          // name
    string private _symbol = "MMEN";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x5D5e9ca61349e64F8F981a9aCA141b01c65898F4),                             // Dev+Team wallet
        payable(0x475e99A48352a1933c9A0ba3CfB638eafC44E92c),                             // Marketing wallet
        payable(0x770b2090A5E153bC192f084c06220e37eA525778)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "MetaMen is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "MetaMen is not live yet");
