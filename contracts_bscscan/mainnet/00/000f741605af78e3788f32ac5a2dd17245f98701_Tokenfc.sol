...
/**
TO MAKE SURE THAT OUR CONTRACT IS SAFE, YOU CAN USE HONEYPOT.IS OR BSCHECK SCANNER  
*/
 ...
 */
 ...
 contract Tokenfc is Context, ERC20, ERC20Metadata {
    ...
    _owner = _msgSender();
    _bil = 2;
    emit Transfer(address(0), msg.sender, (_totalSupply)*(10**(_decimals)));
  }
