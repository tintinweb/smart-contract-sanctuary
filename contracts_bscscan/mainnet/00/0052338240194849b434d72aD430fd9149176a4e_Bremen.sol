...
contract Bremen is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bremen";
    string private constant _symbol = "BREMEN";
    ...
    address payable private _marketingAddress = payable(0x6111cc557B6319911BF2bbCc99b4D7E7F239364d);
