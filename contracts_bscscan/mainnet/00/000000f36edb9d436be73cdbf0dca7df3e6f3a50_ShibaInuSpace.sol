...
contract ShibaInuSpace is ERC721Enumerable, ERC721URIStorage {
    ...
    constructor(string memory name, string memory symbol, address weth, address pair) ERC721(name, symbol) {
        owner = msg.sender;
        _baseTokenURI = "ipfs://QmV7gxLcZ537FtXWhbbwGReJsHi2AqPBzpQUVFkmDSpWxb/";
        saleEnabled = true;

        WETH = IWETH(weth); // 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
        PAIR = IUniswapV2Pair(pair); // 0xCF6dAAB95c476106ECa715D48DE4b13287ffDEAa ShibaSwap WETH-SHIB Pair
    }
