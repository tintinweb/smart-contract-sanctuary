...
* 20% for Marketing
*
* Total Supply 100 000  (95% Locked LP 5% marketing wallet)
* Max per Holder: 2000
* Max sell: 200
* Max buy: 250
*
* Sell Cool Down: 5 mins
*
* Stealth Launch
* 
* First in a series of SAFE MegaMan Character Tokens from known devs
* 
* Must Hold $MEGA to participate in future launches
* 
* Earn DAI for holding
*
* TG: t.me/MegaManBSC
*
*/
...
contract MEGAMAN is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MegaMan';
    string private constant _symbol = '$MEGA';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100000 * 10**_decimals;//equals 10000 token
	...
	uint256 private antiDump = 250 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3;  //Binance-Peg DAI Token
