...
contract TestingSolidity is Context, IBEP20, Ownable {
    ...
    address payable public _marketingAndDevelopmentWallet = payable(0x9406d0E15d8F769041d33beE1EdA89d9ff939aDb); // MarketingAndDevelopment Address
    ...
    string private constant _name     = "TestingSolidity";
    string private constant _symbol   = "TSY";
    ...
    function setRouter(address router) public onlyOwner() {
        IPancakeV2Router02 _pancakeV2Router = IPancakeV2Router02(router);
          pancakeV2Pair = IPancakeV2Factory(_pancakeV2Router.factory())
            .createPair(address(this), _pancakeV2Router.WETH());
        pancakeV2Router = _pancakeV2Router;
    ...
    function updateRouter(address _router) public onlyOwner returns(address _pair) {
    ...
    function transferForeignToken(address _token, address _to) public onlyOwner returns(bool _sent){
        // with this condition TestingSolidity token can not be moved but others junks can be removed to clear the contract.
        // other projects send their junk token for promotion. This function will be used to remove those junks.
        // This function can not remove TestingSolidity token from the contract.
