...
contract MarketOracle is Ownable {
    ...
    function getgrvBnbRate() public view returns (uint256, uint256, uint32, uint256) {
        ...
        FixedPoint.uq112x112 memory grvBnbAverage = FixedPoint.uq112x112(uint224(1e18 * (price0Cumulative - grvBnbPrice0CumulativeLast) / (_blockTimestamp - grvBnbBlockTimestampLast)));
    ...
    function getBusdBnbRate() public view returns (uint256, uint256, uint32, uint256) {
        ...
        FixedPoint.uq112x112 memory busdBnbAverage = FixedPoint.uq112x112(uint224(1e6 * (price0Cumulative - wbnbBusdPrice0CumulativeLast) / (_blockTimestamp - wbnbBusdBlockTimestampLast)));
   ...
   function update() external onlyControllerOrOwner {
    ...
    function getData() external view returns (uint256) {
        ...
        uint answer = busdBnbAverage * 1e21 / grvBnbAverage;
