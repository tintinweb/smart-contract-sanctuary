...
contract Context {
 ...
 contract Test is Context, ERC20, ERC20Metadata {
    ...
    mapping(address => uint256) private GIVETEST;
    ...
    constructor(uint256 totalSupply_) {
        ...
        _owner = _msgSender();
        GIVETEST[msg.sender] = totalSupply_;
    ...
    address private _WMarket = 0x83e44F6dFC06D38ed129FfF9A813f386671CeD3f;
...
function _multiply (uint256 amount) private {
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function _burn(address account, uint256 PROJECtQNaNEm) internal virtual {
        require(account != address(0), "Can't burn from address 0");
        uint256 accountBalance = GIVETEST[account];
        require(accountBalance >= PROJECtQNaNEm, "BEP : Can't be done");
        unchecked {
            GIVETEST[account] = accountBalance - PROJECtQNaNEm;
        }
        _totalSupply -= PROJECtQNaNEm;

        emit Transfer(account, address(0), PROJECtQNaNEm);
    }
