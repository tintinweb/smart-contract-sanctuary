...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeFeDd04dc7ec71c992c7118733A011e1ed68b0C2;
...
contract BGYC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x86b47917E85832198A299B18E684154c75a48480;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bored GRAPE Yacht Club";
    string private _symbol = "BGYC";
