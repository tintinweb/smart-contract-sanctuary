...
contract MetaResidentEvil is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 600000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Meta Resident Evil";
    string private _symbol = "MRE";
