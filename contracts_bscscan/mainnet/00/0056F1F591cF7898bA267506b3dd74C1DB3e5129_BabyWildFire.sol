...
contract BabyWildFire is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6AFe608701f4730a883c71450a49cD9E635c41B9); // Marketing Address
    ...
    string private _name = "Baby WildFire";
    string private _symbol = "Baby WildFire";
