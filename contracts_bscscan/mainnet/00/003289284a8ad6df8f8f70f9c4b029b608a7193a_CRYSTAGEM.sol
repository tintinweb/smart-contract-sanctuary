...
//CRYSTAGEM Token is compiled for CRYSTAMON project
//SPDX-License-Identifier: Unlicensed
pragma solidity 0.5.16 ;
interface ICRYSTAGEM20 {
...
contract CrsytagemTransferable is Crystagemtext {
...
contract CRYSTAGEM is Crystagemtext, ICRYSTAGEM20,  CrsytagemTransferable {
  using SafeLogic for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowances;
  string private _name = "CRYSTAGEM Token";
  string private _symbol = "CRYSTAGEM";
