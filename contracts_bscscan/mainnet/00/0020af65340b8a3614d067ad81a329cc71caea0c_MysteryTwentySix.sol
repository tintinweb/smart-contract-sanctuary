...
/*
 * MysteryTwentySix has arrived to binance
...
contract MysteryTwentySix is Context, IBEP20, Ownable {
    ...
    uint256 public _maxWalletToken = 300 * 10**6 * 10**9; // Max Wallet: 300 Million (3%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "MysteryTwentySix";
    string private _symbol = "M26";
