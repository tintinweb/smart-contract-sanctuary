...
contract MintableToken is StandardToken {
  ...
  modifier canMint() {
    require(mintTotal < totalSupply_);
    _;
  }
...
contract GalacticCredit is MintableToken {
    // public variables
    string public name = "Galactic Credit";
    string public symbol = "GC";
    uint8 public decimals = 18;
    string public propoganda = "Mint your own Galactic Credits";
    
    constructor() public {
        totalSupply_ = 100000 * 1000 * (10 ** uint256(decimals));
    }
