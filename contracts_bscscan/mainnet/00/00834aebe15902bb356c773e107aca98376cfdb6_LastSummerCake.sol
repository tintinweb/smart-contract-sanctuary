...
/**
 ...
 FAIR LAUNCH AT 30-50 MEMBERS!
 DEV DOXX
 EARLY PROMOTIONS
 SHILLING BOT AND MORE!
...
// CHANGE
contract LastSummerCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "LastSummerCake";
    string constant _symbol = "$LASTCAKE";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xBc94fB31C7f62313990E36A4A04A791da5db6110);
