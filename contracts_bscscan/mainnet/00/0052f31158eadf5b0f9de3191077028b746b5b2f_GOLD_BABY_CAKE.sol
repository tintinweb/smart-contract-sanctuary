...
Welcome to Gold Baby Cake
   ...
   Many Great features:
    ...
    5. LP send to Liquidity Locker for 50 Years,  if the response is good, I will continue to extend it
    ...
    it's the best part of the $GoldBabyCake idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 0.5 bnb in the pool. 
...
contract GOLD_BABY_CAKE is Context, IERC20, Ownable {
    ...
    string private _name = "Gold Baby Cake";
    string private _symbol = "GBCAKE";
