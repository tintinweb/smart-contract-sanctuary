...
/*
✨Welcome To Retro Games Token Community ✨

⚜️The Crypto Games Marketplace⚜️

🕹 Retro Games is a decentralize token on BSC Network. Things to come including an RGF Platform | Play-to-Earn activities. RGF Marketplace | Buy, Sell & Create! RGF Launchpad | Stake, Swap 🕹
...
💣 Supply: 100 Billion
✅ Audited by TechAudit 

——📱Social networks 📱 ——

➼ RGF Website:
⦿ www.RetroGames.finance

➼ RGF Official Twitter:
https://twitter.com/RetroGamesToken

➼ RGF Official Telegram:
...
contract RetroGamesFinance is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Retro Games Finance", "RGF") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function enableRewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
