...
//
// Copyright of The schain Team
//
//  
//  
//  
//    Solidity Chain empire
//    
//  
//
// united for a better world!
// 
// schain has 7% tax split across 7 protocols
...
/**
 * @dev The official schain smart contract
 */
contract schain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "schain";
    string private _symbol   = "SC";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for schain/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xE385F323a6373B6437be74c1f9a90f742fE5c76B); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion schain will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-schain tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts schain balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns schain tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of schain tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from schain)
