...
contract Hurricane is ERC20, Ownable {
    ...
    constructor() ERC20("Hurricane", "HRRCN") {
        ...
        marketingWallet = address(0x49D75CA0e7beDe48F502Ec40c5d1187ada5118Ad); // set as marketing wallet
        buyBackWallet = address(0x7B3B12435cC40Fb4C56024aA857F6d021D769888); // set as buyback wallet
