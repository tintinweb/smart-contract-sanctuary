...
contract BitHulk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3710EDE7adaB239fD5e67f62Ad9aA0866E672f11); // Marketing Address
    ...
    string private _name = "Bit Hulk";
    string private _symbol = "BitHulk";
