...
/**
  Features:
   ...
   2% fee auto added to marketing wallet
   2% fee auto distributed to all hodlers
   10% rapid burn protocol
*/
...
contract TesterToken is Context, IERC20, Ownable {
    ...
    address payable marketingWallet =
        0x96ec376f506f1650D48FD20FD5E4799cfc09De0a;
    ...
    constructor() public {
        ...
        IUniswapV2Router02 _uniswapV2Router =
            IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // v2 testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 fist_part = contractTokenBalance.div(3);
        uint256 second_part = contractTokenBalance.div(3);
        uint256 third_part =
            contractTokenBalance.sub(second_part).sub(fist_part);

        // Swap 1/3rd of tokens, and send them to charity wallet as bnb
