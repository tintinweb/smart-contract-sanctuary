...
contract Pablo is ERC20, Ownable {
    ...
    address private _marketingWalletAddress = address(0x1F1Ca33f82f0941F38244Dd4A386cC6A88a85d58); // marketing wallet
    address private _devWalletAddress = address(0x1F1Ca33f82f0941F38244Dd4A386cC6A88a85d58); // fee for contract development
    ...
    constructor() ERC20("PabloCoin", "PABLO") {
    ...
    uint256 public maxBuy = 500_000_000 * (10**18);
    uint256 public maxSell = 500_000_000 * (10**18);
    uint256 public maxWallet = 100_000_000_000 * (10**18);
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "PABLOCOIN: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PABLOCOIN: The PanBNBSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amount) external onlyOwner() {
        require(airdropWallets.length == amount.length, "PABLOCOIN: airdropToWallets:: Arrays must be the same length");
        require(airdropWallets.length < 40, "PABLOCOIN: airdropToWallets:: Cannot airdrop more than 40 wallets due to gas limit restrictions");
...
contract PABLOCOINDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("PABLOCOIN_Dividend_Tracker", "PABLOCOIN_Dividend_Tracker") {
    	claimWait = 1200;
    ...
    function withdrawDividend() pure public override {
        require(false, "PABLOCOIN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PABLOCOIN contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "PABLOCOIN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
