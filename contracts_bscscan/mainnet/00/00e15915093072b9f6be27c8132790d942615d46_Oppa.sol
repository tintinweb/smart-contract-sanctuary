...
contract Oppa is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xB7279a97e72fe3DBa23E0d16839613C17D5223F5); // Marketing Address
        
    address payable public buybackAddress =
        payable(0xB7279a97e72fe3DBa23E0d16839613C17D5223F5); // BuyBack Address
        
    address payable public liquidityAddress =
        payable(0xB7279a97e72fe3DBa23E0d16839613C17D5223F5); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100 * 1e15 * 1e4;
    ...
    // seeded with launch values, will be updated to 5, 3, 2, 1 final for both buys and sells
    ...
    function _transfer(
        ...
        uint256 totalTokensToSwap = _liquidityTokensToSwap + _marketingTokensToSwap + _buyBackTokensToSwap;
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 bnbForLiquidity = bnbBalance.sub(bnbForMarketing).sub(bnbForBuyBack);
        ...
        (success,) = address(0xB7279a97e72fe3DBa23E0d16839613C17D5223F5).call{value: bnbForDev}("");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBuybackFee <= 100, "Must keep taxes below 20%");
        emit SetBuyFee(buyMarketingFee, buyLiquidityFee, buyTaxFee, buyBuybackFee);
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBuybackFee <= 100, "Must keep taxes below 30%");
        emit SetSellFee(sellMarketingFee, sellLiquidityFee, sellTaxFee, sellBuybackFee);
    }
