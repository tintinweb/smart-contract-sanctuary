...
contract BABYXRPPLUS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0x25859D808750f3544836B455EA31Fdc7337317f0); // Marketing Address
    address payable public xrpCharityWalletAddress = payable(0x475eD43f821E9336Be7F0e6A1814C14BFcBecaF6); // xrp Address
    ...
    string private _name = "BABYXRPPLUS";
    string private _symbol = "BBYXRPP";
    uint8 private _decimals = 9;

    uint256 public _burnFee = 2;
    uint256 public _liquidityFee = 5;
    uint256 public _marketingFee = 15;
    uint256 public _xrpCharityFee = 15;
