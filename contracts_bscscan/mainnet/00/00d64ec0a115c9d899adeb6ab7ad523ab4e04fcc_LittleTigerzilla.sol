...
contract LittleTigerzilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Little Tiger Zilla";
    string constant _symbol = "LTiger Zilla";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1000 * 10**6* 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x699552612f3aA6Ec2Ed9EA88Bf9EA0b2a442ce7e;
        marketingFeeReceiver = 0x699552612f3aA6Ec2Ed9EA88Bf9EA0b2a442ce7e;
        teamFeeReceiver =0x699552612f3aA6Ec2Ed9EA88Bf9EA0b2a442ce7e ;
        utilityFeeReceiver = 0x699552612f3aA6Ec2Ed9EA88Bf9EA0b2a442ce7e;
