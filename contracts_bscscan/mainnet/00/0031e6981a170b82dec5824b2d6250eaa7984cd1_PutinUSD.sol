...
contract PutinUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PutinUSDDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("PutinUSD", "PUSD") {
        _ETHRewardsFee = 4;
        _liquidityFee = 3;
		_marketingFee = 2;
    	...
    	dividendTracker = new PutinUSDDividendTracker();

    	liquidityWallet = owner();
		
		bulkSender = payable(0x0379E3fc825a9442d904dbf0320C0daf68dC0cD9);
		marketingWallet = payable(0x0379E3fc825a9442d904dbf0320C0daf68dC0cD9);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
       ...
       PutinUSDDividendTracker newDividendTracker = PutinUSDDividendTracker(payable(newAddress));
...
contract PutinUSDDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("PutinUSD_Dividend_Tracker", "PutinUSD_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "PutinUSD_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "PutinUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "PutinUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PutinUSD_Dividend_Tracker: Cannot update claimWait to same value");
