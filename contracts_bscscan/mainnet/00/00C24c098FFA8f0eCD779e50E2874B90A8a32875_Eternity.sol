...
contract Eternity is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 15000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Eternity';
    string private _symbol = 'ETRN';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 4;
    uint256 private _burnFee = 4;
    uint256 private _maxTxAmount = 15000000000000 * 10**18;
