...
/**
 * TELEGRAM: HTTPS://T.ME/VenomFloki
    
       #LIQ+#RFI+#CHEEMS+#FLOKI = #Bee

   #venom FLOKI features:
...
contract VENOMFLOKI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xE5a682a609F98D06176468B4Ae53D6468A531051;
 
    string constant _name = "VENOM FLOKI";
    string constant _symbol = "$VF";
