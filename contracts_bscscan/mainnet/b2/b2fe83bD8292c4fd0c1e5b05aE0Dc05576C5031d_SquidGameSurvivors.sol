...
https://t.me/squidgamesurvivors

                                                 ━╤デ╦︻(▀̿̿Ĺ̯̿̿▀̿ ̿)

Fair Launch Low MC token
...
contract SquidGameSurvivors is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Squid Game Survivors";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 60 ) / 100;
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 1000; // 0.01% of supply
    bool inSwap;
