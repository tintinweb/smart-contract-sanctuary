...
Telegram = https://t.me/BuffedGirl
...
// CHANGE
contract BuffedGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Buffed Girl";
    string constant _symbol = "BuffedGirl";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 40,000,000
    ...
    uint256 buybackFee = 300;   // 0% 
    uint256 reflectionFee = 0; // 6%
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xED545cFd9C5CE3A63FcbE8C7Ab6cFD4c1f046F65);
