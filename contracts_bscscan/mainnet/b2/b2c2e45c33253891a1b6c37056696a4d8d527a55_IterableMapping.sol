...
/**
 *Hello friends, enjoy your stay. 

t.me/mysterioustokenbsc
...
contract NanoADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    NanoADADividendTracker public dividendTracker;
    ...
    uint256 public _maxTxAmount = 500000000 * (10**18); // Max Transaction: 0.5%
    uint256 public _maxWalletToken = 2000000000 * (10**18); // Max Wallet: 2.0%

    address public _marketingWalletAddress = 0xe6506cE78dB77307453c9F8dc3Bd26B71118fD6c;
    address public _devWalletAddress = 0x1B5D0e7B50B46d929D48589e28F3916210be736c;
    ...
    constructor() public ERC20("NanoADA", "$NADA") {

    	dividendTracker = new NanoADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        NanoADADividendTracker newDividendTracker = NanoADADividendTracker(payable(newAddress));
...
contract NanoADADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("NanoADA Dividends", "NanoADA_dividends") {
    	claimWait = 1200;
