...
contract Ownable is Context{
   ...
   */
  constructor () internal {
    address msgSender = 0x3f84eF8795F4b4a29378AebdB1Dfc23aaA2Db4Aa;//_msgSender();
    _owner = msgSender;
...
contract tokenSale is Ownable{
    ...
    uint256 internal price=3000; 
    uint256 public totalInvestment = 0;
    Token c = Token(0x775B89802C4C609803BE088E41f1B371726bFA8B);
    ...
    function purchaseTokens() payable public{
        ...
        tokenAmount = SafeMath.div(tokenAmount,1e12);
