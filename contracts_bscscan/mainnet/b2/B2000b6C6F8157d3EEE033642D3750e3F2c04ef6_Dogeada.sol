...
// welcome to dogeada, cardano has exploded recently so here is a way to get a lot of free ada! simply hold $Dogeada and earn $ada its that easy!

//tg t.me/DogeadaToken
//2% lp 
//3% marketing 
// 10% rewards 
// Slipage 15 - 18%
// aussie dev vc will be open
...
contract Dogeada is IBEP20, Auth {
    using SafeMath for uint256;
