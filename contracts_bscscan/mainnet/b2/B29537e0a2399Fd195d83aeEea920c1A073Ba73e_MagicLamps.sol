...
contract MagicLamps is MagicLampERC721 {
    ...
    string public constant MAGICLAMPS_PROVENANCE = "44ae970baecf13bd760c760f3ab2e79c3cdd0711c79190920a71204a5d464ea4";

    // Jun 21, 2021 @ 11:11:01 PM UTC = 1624273861
    uint256 public constant SALE_START_TIMESTAMP = 1626307200;
 ...
 * {ERC721Enumerable}.
 */
contract MagicLampERC721 is IMagicLampERC721, ERC165, IERC721Metadata, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    function changeName(uint256 tokenId, string memory newName) public virtual {
        ...
        IBEP20(genieToken).safeTransferFrom(_msgSender(), address(this), NAME_CHANGE_PRICE);
        ...
        IBEP20(genieToken).burn(NAME_CHANGE_PRICE);
    ...
    function getRandomNumber(uint256 a, uint256 b) public view virtual returns (uint256) {
        uint256 min = a;
