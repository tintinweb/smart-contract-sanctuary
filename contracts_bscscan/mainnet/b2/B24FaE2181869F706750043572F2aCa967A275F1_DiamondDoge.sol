...
//3% rewards , 2% Liq , 1% marketing/buyback
//https://t.me/diadoge
...
contract DiamondDoge is  Context, IERC20, Ownable {
    ...
    uint256 private _tDiamondDogeTotal;

    string private _name = "Diamond Doge";
    string private _symbol = "DiamondDoge";
    ...
    uint256 public _DiamondDogeFee = 10;
    uint256 private _previousDiamondDogeFee = _DiamondDogeFee;
    
    uint256 public _maxTxAmount = 1000 * 10**9 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**9 * 10**9; 
    
    address payable public DIAMONDDOGE_address = 0x970E0B3BaEb061FB7A56d05FF42BD2C0fec6E676;
   ...
   function deliver(uint256 tAmount) public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tDiamondDogeTotal = _tDiamondDogeTotal.add(address(this).balance);
        TransferCharityETH(DIAMONDDOGE_address, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_DiamondDogeFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _DiamondDogeFee == 0 && _liquidityFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousDiamondDogeFee = _DiamondDogeFee;
    ...
    function restoreAllFee() private {
        ...
        _DiamondDogeFee = _previousDiamondDogeFee;
    ...
    function setDiamondDogeFeePercent(uint256 DiamondDogeFee) external onlyOwner() {
        _DiamondDogeFee = DiamondDogeFee;
    }
