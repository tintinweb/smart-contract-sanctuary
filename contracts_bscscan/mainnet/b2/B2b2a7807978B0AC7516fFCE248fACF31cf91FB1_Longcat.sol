...
contract Longcat is Context, IERC20, Ownable {
    ...
    string private _name = "Longcat";
    string private _symbol = "Loooooooooooooooooooooooooooooooooong";
