...
contract ReefBinance is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x630e4d9942644DAdcaAc4979C1526cB496e3C38D); // Marketing Address
    address payable public charityAddress = payable(0x630e4d9942644DAdcaAc4979C1526cB496e3C38D); // Charity/Dev Address
    ...
    string private _name = "Reef Binance";  // nice
    string private _symbol = "REE";
