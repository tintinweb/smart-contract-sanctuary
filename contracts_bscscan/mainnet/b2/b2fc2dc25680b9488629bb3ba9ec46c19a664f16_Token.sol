...
https://t.me/babymoonarchtoken
                                                                                          
Earn Moonarch Rewards : 0xaf96a19c2DD4a0f6B077D9481fCc8C9102FAa141
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable Token = address(0xaf96a19c2DD4a0f6B077D9481fCc8C9102FAa141); // BSC-Pegged token
...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xa8Ade0Cf4fAEcD4B83de597BbA32F266C4248400;


    // use by default 300,000 gas to process auto-claiming dividends
    uint256 public gasForProcessing = 300000;
    uint256 public maxFee = 49;
    ...
    uint256 public maxBuyTransactionAmount =  2000000000 * (10**18);
    ...
    constructor() public ERC20("BabyMoonarchToken", "BMT") {
