...
contract SpyderBoy is Context, IERC20, Ownable {
    ...
    string private _name = "SpyderBoy";
    string private _symbol = "SpyderBoy";
    ...
    function _Lock(uint256 Lock) external onlyOwner() {
        require(Lock < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = Lock;
    }
}