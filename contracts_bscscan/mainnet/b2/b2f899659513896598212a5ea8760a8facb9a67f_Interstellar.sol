...
contract Interstellar is Context, IERC20, Ownable {
    ...
    string private _symbol = "INTERSTELLAR";
	...
	address payable public MarketingWallet = payable(0x69dE41D0026f29b427bf0F8A957AdBdD6Fd56FB3);
	address payable public buyBackWallet = payable(0x69dE41D0026f29b427bf0F8A957AdBdD6Fd56FB3);
	...
	uint256 public _maxWalletToken = 20000000000 * 10**18; 
