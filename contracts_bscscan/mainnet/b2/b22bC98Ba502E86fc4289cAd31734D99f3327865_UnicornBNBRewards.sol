...
Unicorn Redemption, Unicorn Rewards on steroids
    The tokenomics are carefully crafted for a sustainable liquidity pool.
    
    Buy fee: 6% (7% slippage)
    Sell fee: 21% (27% slippage)

   #Unicorn Redemption features:
 ...
 🎉 Ｐａｙ ｏｕｔ ＢＮＢ ｅｖｅｒｙ ２０ ｍｉｎｕｔｅｓ！！ Ｔｈａｔ＇ｓ ａｗｅｓｏｍｅ
   ...
   I created a black hole so #UnicornRedemption token will deflate itself in supply with every transaction
...
contract UnicornBNBRewards is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Unicorn Redemptions";
    string private _symbol = "UNICRED";
