...
Stealth launch | Next 100x Gem

Initial liquidity 1bnb
Total supply 1,000,000,000,000
So max txn 10,000,000,000 (1% of total supply)
...
contract DaddyDogeX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Daddy DogeX";
    string constant _symbol = "DADDYDOGEX";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xD552d871289395a4c8867f29C8a06f342c7549c0;
