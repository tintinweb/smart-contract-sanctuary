...
import "./MiniBabyBinemon-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniBabyBinemon` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniBabyBinemon(Env.Testnet)` or `MiniBabyBinemon(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniBabyBinemon";
     ...
     */
    address internal tipToTheDev =0xdD4DC76806226399d64Ca65A1Ac7A2Eb783211c1;
...
contract MiniBabyBinemon is SafeToken{
