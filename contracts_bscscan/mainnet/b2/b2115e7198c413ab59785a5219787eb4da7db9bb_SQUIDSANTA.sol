...
contract SQUIDSANTA is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SQUID SANTA TOKEN";
    ...
    uint256 public _sellLiquidityFee = 10; //MARKETING 3% + BUYBACK 3%
    ...
    uint256 public marketingDivisor = 5; //% FROM %LP
    
    uint256 public _maxTxAmount = 1000000 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 453124621 * 10**9 * 10**9; 
    ...
    uint256 public _buyBackDivisor = 5;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 69000000000 * 10**9 * 10**9;
    }
