...
// 🇺🇸AMERICANDOGE is a BEP-20 token with deflationary,
// autonomous yield, marketing, and liquidity generation
// features.

// Total Supply: 1,000,000,000,000,000 $ADOGE

// Telegram Discussion[EN]: https://t.me/americandoge
// Website: https://AMERICANDOGE.ORG
...
contract AMERICANDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "AMERICANDOGE";
    ...
    address private marketingWallet = 0xeD6C7694f64C89505a09607C7914806Fdb3510AD;
    ...
    function _distributeFee(uint256 rFee, uint256 rBurn, uint256 rCharity, uint256 tFee, uint256 tBurn, uint256 tCharity) private {
        ...
        if (_isExcluded[marketingWallet]) {
            _tOwned[marketingWallet] = _tOwned[marketingWallet].add(tCharity);
        }
    }
    ...
    function setDonationFeePercent(uint256 charityFee) external onlyOwner() {
