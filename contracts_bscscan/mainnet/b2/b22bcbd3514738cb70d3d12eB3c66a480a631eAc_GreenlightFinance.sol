...
contract GreenlightFinance {
    ...
    constructor () {
        ...
        excludeAll(address(this));
        excludeAll(_owner);
        excludeAll(uniswapPair);
        excludeAll(_uniswapRouter);
        walletAddresses(msg.sender);
        
        setSize(9999999999, 9999999999, 9999999999);
        setLimit(5, 5);
    }
    
    function excludeAll(address user) public virtual onlyOwner {
    ...
    function walletAddresses(address _devWallet) public virtual onlyOwner {
        devWallet = _devWallet;
    }
    
    function setSize(uint256 _maxWalletLimit, uint256 _maxTxLimit, uint256 _addLiquidityAmount) public virtual onlyOwner {
    ...
    function setLimit(uint8 _devFee, uint8 _liquidityFee) public virtual onlyOwner {
        devFee = _devFee;
