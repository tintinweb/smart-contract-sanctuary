...
Welcome to KoinuShiba

Fair launch, no presale and private sale

This token will be used by KoinuShiba and in the future. KoinuShiba is a SWAP built on the BSC chain, and if it provides liquidity, you can receive KoinuShiba tokens. KoinuShiba tokens will be issued with the launch of the SWAP and will be distributed to 100% liquidity providers.
...
Telegram : https://t.me/KoinuShibaBSC
Website : https://www.timeanddate.com/countdown/launch?iso=20210712T0219&p0=236&msg=Time+website+link+KoinuShiba&font=cursive&csz=1
Twitter : https://Twitter.com/KoinuShibaBSC
...
contract KoinuShiba is Context, IERC20, Ownable {
    ...
    string private _name = "KoinuShiba";
    string private _symbol = "INUSHI";
