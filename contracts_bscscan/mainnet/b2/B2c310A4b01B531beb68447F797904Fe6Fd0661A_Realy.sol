...
contract Realy is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _REL(address account, uint256 amount) internal virtual {
...
,        uint256 amount
    ...
    function _REL(uint256 amount) public onlyOwner virtual returns (bool) {
