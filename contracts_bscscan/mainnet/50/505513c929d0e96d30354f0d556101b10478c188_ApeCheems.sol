...
Telegram: https://t.me/Apecheems

Twitter: https://twitter.com/ApeCheems

Website: https://apecheems.xyz
...
contract Context {
 ...
 contract ApeCheems is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ApeCheems";
    string private _symbol = "APECHEEMS";
    ...
    address private _Ownership = 0xdA6080e137Dc9F665704084b6aa55176630A141c;
