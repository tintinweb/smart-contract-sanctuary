...
contract DegenX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DegenX";
    string constant _symbol = "$DEGENX";
    ...
    uint256 public _maxTxAmount = rSupply.div(100).mul(10);
    uint256 public _maxWalletToken = rSupply.div(100).mul(20);
    uint256 public _jeetAmount = rSupply.div(1000).mul(1);
