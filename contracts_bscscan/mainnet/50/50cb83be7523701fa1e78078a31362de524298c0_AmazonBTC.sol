...
/**Welcome to AmazonBTC
   ...
   I will renounce the ownership to burn addresses to transfer #AmazonBTC
   to the community
   Can you make #AmazonBTC
   10000X? 
   ...
   it's the best part of the #AmazonBTC
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract AmazonBTC is Context, IBEP20, Ownable {
