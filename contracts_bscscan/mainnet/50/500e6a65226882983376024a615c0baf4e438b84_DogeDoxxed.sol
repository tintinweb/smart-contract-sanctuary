...
/**
              Doge Doxxed is the next generation auto earn $Doge & Auto Buy-back .
 */
...
contract DogeDoxxed is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Doge Doxxed";
    string constant _symbol = "DogeDoxxed";
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 50%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x013a05eD791Bd744481ae8d62D42748738Fe5694;
