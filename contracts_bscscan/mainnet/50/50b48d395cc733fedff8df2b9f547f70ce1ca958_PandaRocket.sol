...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4A1F026E63112128B92cd202D1E23061B9362096;
...
contract PandaRocket is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc2F4c9be4E29f75a0BF70A530416Fe885aB1d2B4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Panda Rocket"; 
    string private _symbol = "PRC";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 10;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 130;
