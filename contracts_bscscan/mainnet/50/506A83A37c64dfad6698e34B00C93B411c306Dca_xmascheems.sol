...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB9024f9821C358DF86bdDd6F717Fa3381CEbe073;
...
contract xmascheems is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x99a30E983a952742FE7FBF65e33C6D9299c997eA;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Xmas Cheems";
    string private _symbol = "XMASCHEEMS";
