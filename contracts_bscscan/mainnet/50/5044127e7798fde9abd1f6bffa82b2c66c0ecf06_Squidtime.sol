...
contract Squidtime is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF0C3E85Eb92054534a964dEC0aa2719189e87029); // Marketing Address
    ...
    string private _name = "Squid time";
    string private _symbol = "Squidtime";
