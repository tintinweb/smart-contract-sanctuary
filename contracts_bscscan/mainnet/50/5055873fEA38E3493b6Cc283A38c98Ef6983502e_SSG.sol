...
contract SSG is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 150000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'SafeSquidGame Coin';
    string private _symbol = 'SAFESQUID';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 3;
    uint256 private _burnFee = 3;
    uint256 private _maxTxAmount = 150000000000000 * 10**18;
