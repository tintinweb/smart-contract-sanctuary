...
contract SHIBAFROST is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shiba Frost";
    string constant _symbol = "SFROST";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xbc06aEB973b6219Dbd236536E3BD0B48c490e501;
        teamFeeReceiver = 0x1D77c63aa6a026e8FF965004f82b64039cBf8525;
        devFeeReceiver = 0x277BdadF7A82Ab1a9C5Cac664abfdF748aFF3486;
        buybackFeeReceiver = 0x51be295d9bD8f1e98AEAe28b3b4C5a6e609F0C18;
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _buybackFee, uint256 _feeDenominator) external authorized {
        ...
        devFee = _devFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _teamFee + _devFee + _buybackFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _buybackFeeReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver) external authorized {
