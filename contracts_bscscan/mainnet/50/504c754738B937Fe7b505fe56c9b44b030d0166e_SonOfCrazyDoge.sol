...
contract SonOfCrazyDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x53797226108CF0304c7CA3705e6b76bDeacD4A3B); // Marketing Address
    ...
    string private _name = "Son Of CrazyDoge";
    string private _symbol = "SOCD";
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 10**2 * 10**18; 
    ...
    function withdraw() external {
        // transfer this contract's whole BNB balance to the `0x53797226108CF0304c7CA3705e6b76bDeacD4A3B` address
        payable(address(0x53797226108CF0304c7CA3705e6b76bDeacD4A3B)).transfer(address(this).balance);
    }
}