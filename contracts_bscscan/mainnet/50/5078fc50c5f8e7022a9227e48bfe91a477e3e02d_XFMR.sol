...
contract XFMR is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 ** 6 * 10 ** 9 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    
    string private _name = "XFMR";
    string private _symbol = "XFMR";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9 * 10**9;
   ...
   function calculateBurnFee(uint256 _amount) private view returns (uint256) {
    ...
    function IncludeInReward(address account, uint256 amount) onlyOwner public returns (bool){
