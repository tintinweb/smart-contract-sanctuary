...
contract SafeStakeBNB is IReflectionPool, Auth, Pausable, ReentrancyGuard {
...
//    IBEP20 safeMoon = IBEP20(0xB7f8BC63BbcaD18155201308C8f3540b07f84F5e);
    ...
    function giveStakingReward(address shareholder) internal nonReentrant {
    ...
    receive() external payable {
        ...
        if (!excludeSwapperRole[msg.sender]) {
            setShares(address(this).balance);
        }
    }
    ...
    function setShares(uint amt) internal returns (uint) {
