...
contract Nausica is Context, IERC20, Ownable {
    ...
    string private constant _namea6 = "CHRISTMAS GIFT";
    string private constant _symbola6 = "CG";
    ...
    uint private constant _tTotala6 = 10000000000 * 10**9;
    uint private _rTotala6 = (MAX - (MAX % _tTotala6));
    uint private _tFeeTotal;
    
    //Buy Fee
    uint private _redisFeeOnBuy = 0;
    uint private _taxFeeOnBuy = 0;
    
    //Sell Fee
    uint private _redisFeeOnSell = 0;
    uint private _taxFeeOnSell = 0;
    ...
    uint public _maxTxAmount = 10000000000000 * 10**9;
    uint public _maxWalletSize = 10000000000000 * 10**9;
    uint public _swapTokensAtAmount = 100000000000 * 10**9;
