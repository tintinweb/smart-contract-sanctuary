...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "FoxyInu";
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 50; // 4% of the total supply / TOTAL_SUPPLY / 100
     ...
     */
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 25; // 8% of the total supply / TOTAL_SUPPLY / 50
    ...
    address internal developerAddress = 0xE86DB1c9e687259348b24f1bDC7401EccB5CDf96;
    address internal marketingAddress = 0xA69573733311D66D841a4D0F2188BCfe7A30492a;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 20, developerAddress );
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0x10ED43C718714eb63d5aA57B78B54704E256024E, 'No Pancake.');
    ...
    function removeBotFromBlackList(address account) external onlyOwner() {
        require(_isBlackListedBot[account], "NO BL");
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(!_isBlackListedBot[recipient], "bot no");
        require(!_isBlackListedBot[sender], "bot no");
        require(_isBlacklisted[sender] == false || recipient == address(0), "ban");
        require(_isBlacklisted[recipient] == false, "ban");
...
abstract contract Token is BaseRfiToken, Liquifier, Antiwhale {
...
contract FoxyInu is Token{

    constructor() Token(Env.MainnetV2){
