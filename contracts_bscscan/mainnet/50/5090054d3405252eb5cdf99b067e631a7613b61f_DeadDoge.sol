...
contract DeadDoge is ERC20, Ownable {
    ...
    constructor() ERC20("DeadDoge", "DED") {
    	...
    	buyBackWallet = msg.sender;  // developer address
    ...
    function afterPreSale(uint256 dividenReward, uint256 marketing, uint256 maxTxAmount, uint256 maxWallettoken) external onlyOwner {
        dividendRewardsFee = dividenReward;
        marketingFee = marketing;
        maxBuyTranscationAmount = maxTxAmount *10**18;
        maxWalletToken = maxWallettoken * (10**18);
    }
