...
/**
    Welcome To ShibbyBullish
   
   ‼️ STEALTH LAUNCH ‼️

 
   TELEGRAM:https: https://t.me/ShibbyBulish
   WEBSITE:https://shibbybullish.com/(uploading)
 */
...
contract shibbybullish is Context, IERC20, Ownable {
    ...
    string private _name = "shibbybullish";
    string private _symbol = "ShibBullish";
