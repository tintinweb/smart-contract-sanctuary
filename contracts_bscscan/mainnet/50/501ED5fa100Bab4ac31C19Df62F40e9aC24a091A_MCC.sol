...
contract MCC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xC3e9995159816207E44cef7e139ff7f4e74963B1); // Marketing Address
    ...
    string private _name = "MarsCryptoCat";
    ...
    uint256 private minimumTokensBeforeSwap = 21000 * 10**9; 
    uint256 private buyBackUpperLimit = 1e18;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 _minimumTokensBeforeSwap) external onlyOwner() {
     ...
     function setBuybackUpperLimit(uint256 buyBackLimit) external onlyOwner() {
        buyBackUpperLimit = buyBackLimit * 1e18;
    }
