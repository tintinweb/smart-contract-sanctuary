...
contract Ownable is Context {
    address private _owner = 0x4e8dAd359b1efE9748c6B6A191d9FdAAc336D027;
...
contract engines is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x402fEB91794994152adaF400eB6523E00aCb6E56); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "engines"; // token name
    string private _symbol = "engines"; // token symbol
