...
contract KishimotoInu is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _taxFee = 2;
  uint256 public _maxTxAmount = 49000000000000000000000000;
  uint256 public GeUnlockTime = 0;
  uint256 public _liquidityFee = 8;
  uint256 public _previousTaxFee = 4;
