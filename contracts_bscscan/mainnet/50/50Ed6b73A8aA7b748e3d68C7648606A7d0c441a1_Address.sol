...
contract MetaZillaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3CFD22a2DC3b487e93CDDeE028AaB1A57cC76732); // Marketing Address
    ...
    string private _name = "MetaZilla Inu";
    string private _symbol = "METZ";
