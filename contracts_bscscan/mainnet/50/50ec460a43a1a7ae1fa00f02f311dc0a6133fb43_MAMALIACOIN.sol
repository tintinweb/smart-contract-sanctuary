...
contract MAMALIACOIN is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Mamalia Coin";
    string private _symbol = "MAMALIACOIN";
    ...
    uint256 public _maxTxAmount = 200000000000000000 * 10**9;
