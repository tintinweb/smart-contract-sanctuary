...
Stealth Launching a sphynx rewards token seems to be the thing - so here we go!

https://t.me/FomoSphynx

10% Buy
20% Sell

Max Wallet: 3%  | Max Buy: 3% | Max Sell: 1%  | 
...
contract FomoSphynx is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'FomoSphynx';
    string private constant _symbol = 'FomoSphynx';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000 * 10**_decimals;//equals 2000000 token
    ...
    //DevWallets
    address public Marketing=payable(0xbd81a5AE253D87C7055bEfFAb37a8b64f01e6EC3);
    address public Booster=payable(0xbd81a5AE253D87C7055bEfFAb37a8b64f01e6EC3);
    //TestNet
	...
	uint256 private MaxBuy = 30000 * 10**_decimals;
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==Booster;
    }
    ...
    uint8 private StakingShareLimits=95;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x2e121Ed64EEEB58788dDb204627cCB7C7c59884c;  // Sphynx 
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(Booster).transfer((amount*3)/5);
    } 
    ...
    function TeamChangeBooster(address newBooster) public onlyOwner{
      Booster=payable(newBooster);
    }
