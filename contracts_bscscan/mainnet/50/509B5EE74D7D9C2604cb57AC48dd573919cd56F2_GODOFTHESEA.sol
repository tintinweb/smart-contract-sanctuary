...
contract GODOFTHESEA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GODOFTHESEA";
    string constant _symbol = "BABYPOS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20; // 1.5%
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 1.5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x0498ED434fEd242cbCFa2118935B515218d1a318;
