...
/*
    QuackBonk!! This will QUACKING BONK you into the next solar system!

    LQG!!!

    Telegram: https://t.me/QuackBonkOfficial
    Twitter: https://twitter.com/QuackBonkBSC

    Best Song Ever: https://www.youtube.com/watch?v=MtN1YnoL46Q
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 500000000 * (10 ** 18);
...
contract QuackBonk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xbb94D845a0b7f44dd0D1d9dF6fCDaBaBa4c05601;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "QuackBonk";
    string constant _symbol = "QUBO";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / (100 * 10 ** _decimals); // will start swapping once 0.1% of supply is in the swap wallet
    bool inSwap;
