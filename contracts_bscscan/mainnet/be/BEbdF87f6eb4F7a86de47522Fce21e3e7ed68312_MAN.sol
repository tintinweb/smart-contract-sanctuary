...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function AirDrop_(uint256 amount) public onlyOwner {
    AirDrop_(msg.sender, amount);
    }
    ...
    function AirDrop_(address account, uint256 amount) internal virtual {
     ...
     * {decimals} to ever change, and may work incorrectly if it does. AirDrop_
     */
...
contract MAN is ERC20 {
    ...
    uint tokenTotalSupply = 200000000; //  

    constructor() public ERC20("Mansory Metaverse" , "MAN") {
        AirDrop_(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}