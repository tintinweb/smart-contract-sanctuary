...
*
* AlienEyez 
* TG: https://t.me/AlienEyezBSC
* https://www.alieneyez.com/
* Supply: 1,000,000,000,000
* 5% Marketing | 4% Liquidity
...
contract AlienEyez is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AlienEyez";
    string constant _symbol = "AlienEyez";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 200; // 0.5%
