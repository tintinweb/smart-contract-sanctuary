...
contract MagicRewards is IBEP20 {
    ...
    string public override name = "MagicRewards";
    string public override symbol = "MagicRewards";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[foundersPot] = totalSupply * 1000 / 100;
