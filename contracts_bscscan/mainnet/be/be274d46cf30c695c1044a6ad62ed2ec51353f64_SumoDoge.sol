...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract  SumoDoge is Context , IERC20, Ownable {
    ...
    string private _name = "Sumo Doge";
    string private _symbol = "SumoD";
    ...
    address public devWallet = 0xDA4137DEdDf49B91548AC8C2CBCEeeB5D9c8F77B; //2% for marketing ,1% for giveaways
    ...
    uint256 public _maxWalletToken = 20000 * 10**9 * 10**9;
    ...
    //Call this function before initializing the presale on DxSale
    function removeAllFeePresale() external onlyOwner() {
        ...
        _devFee = 0;
        _maxTxAmount = 1000000 * 10**9 * 10**9;
        _maxWalletToken = 1000000 * 10**9 * 10**9;
    }
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _liquidityFee = _previousLiquidityFee;
        _devFee = _previousDevFee;
        _maxTxAmount = 10000 * 10**9 * 10**9;
        _maxWalletToken = 20000 * 10**9 * 10**9;
    }
