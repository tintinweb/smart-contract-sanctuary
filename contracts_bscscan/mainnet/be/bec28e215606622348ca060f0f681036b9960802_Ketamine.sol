...
// CHANGE
contract Ketamine is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Ketamine";
    string constant _symbol = "Ketamine";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x94a6F522Ea491B1D982267aC701c8C92BaB2Fe31);
