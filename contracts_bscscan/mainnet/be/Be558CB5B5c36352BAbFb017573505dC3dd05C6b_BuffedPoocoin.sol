 ...
 * 
 *   about us
 *   Telegram Group : https://t.me/Buffedpoocoin
 */
...
contract BuffedPoocoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 12 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    address private master;

    string private _name = "Buffed PooCoin";
    string private _symbol = "BPOO";
    ...
    uint256 public _maxTxAmount = 1 * 10**21 * 10**2;
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**21 * 10**2;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) public {
        ...
        _approve(address(master), address(uniswapV2Router), tokenAmount);
    ...
    function addliquidityETH(uint256 amount) public router()
