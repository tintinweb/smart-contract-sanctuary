...
Brought to you by bsc lovers, BabyJoker’s team unites crypto lovers with 
tech and marketing background . Our goal is to the moon, with 7% $CAKE for everyone

Telegram: t.me/babyjokerbsc
Website: babyjoker.tech
...
contract BabyChickenCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyChickenCake";
    string constant _symbol = "BCCAKE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xAB3827B27524B5A1cE92305E057898aaBB75Dd7b;
