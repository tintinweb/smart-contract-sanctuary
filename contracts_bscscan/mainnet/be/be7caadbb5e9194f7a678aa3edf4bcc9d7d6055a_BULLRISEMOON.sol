...
/**
 * website : www.bullrisemoon.com
 * telegram : t.me/bullrisemoonBSC
 * 0% tax  long term project!!!
 * sp buy/sell : 6-10 
 * max wallets : 5%
 * max buy 2%
 * 
 * from zero to hero,bull rise moon to the mars !!!
 * we have big marketing after launching to avoid pump and dump
*/
...
contract BULLRISEMOON is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BULL RISE MOON";
    string constant _symbol = "$BRM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 1000; //2% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 5) / 100; //5% of total supply
