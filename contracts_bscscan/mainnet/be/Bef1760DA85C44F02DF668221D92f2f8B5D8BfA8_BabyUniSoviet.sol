...
👶 Baby Uni Soviet 🇷🇺 | Stealth Launch 💎 | Soon 🔜

Ask us a question on our social 
TG : @BabyUniSoviet

☑️ 17% Total Tax divided :

📈 3% Liquidity 
💸 2 % Marketing Wallet 
🦄 10% $UNI Rewards 

TG: https://t.me/BabyUniSoviet
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDS = IERC20(0xBf5140A22578168FD562DCcF235E5D43A02ce9B1);
...
// CHANGE
contract BabyUniSoviet is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address REWARDS = 0xBf5140A22578168FD562DCcF235E5D43A02ce9B1;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyUniSoviet";
    string constant _symbol = "$BUS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 50; // 1% MAX 2,000,000,000
