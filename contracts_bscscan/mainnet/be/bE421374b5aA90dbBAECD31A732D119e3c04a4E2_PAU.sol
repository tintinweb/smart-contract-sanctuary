...
contract PAU is Context, IERC20, Ownable {
    ...
    string private _name = "Pau Coin";
    string private _symbol = "PAU";
    ...
    uint256 public _maxTxAmount = 250;
    uint256 private numTokensSellToAddToLiquidity = 25;
