...
/**
 *Fork of Floki 12-24-2021 this contract can updataed by proxy
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract ORBITALLAUNCHPAD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x735Af51a2bdf97Fb945479B7d59B41040bd0b108); // Marketing Address
    ...
    string private _name = "OrBital Launch Pad";
    string private _symbol = "ORBITALP";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x735Af51a2bdf97Fb945479B7d59B41040bd0b108);
    }
