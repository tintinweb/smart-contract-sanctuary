...
+  Marketing, airdop:  5.000.000.000.000 (5%)
 ...
 16% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold $UNIOL tokens, earn BNB. 
...
contract UnicOfLove is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Unicorns Of Love";
    string constant _symbol = "UNICOFLOVE";
