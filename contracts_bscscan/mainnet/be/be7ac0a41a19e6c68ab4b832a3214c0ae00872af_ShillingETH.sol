...
// CHANGE
contract ShillingETH is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ShillingETH";
    string constant _symbol = "ShillingETH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% MAX 5,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 5,000,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x766c50Dd95B0f5ac285527d135A14cE7f2672021);
