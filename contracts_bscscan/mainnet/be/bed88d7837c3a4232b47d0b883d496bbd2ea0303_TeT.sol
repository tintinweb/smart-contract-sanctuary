...
contract TeT is Context, IERC20 {
//contract TeT is Context, IERC20 {
    ...
    string constant private _name = "TeT Coin";
    string constant private _symbol = "EOIN";
...
//===============================================================================================================
    ...
    uint256 public _aAamarketBal;
    uint256 public _aAaliquidityBal;
    uint256 public _aAabuybackBal;
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _aAaliquidityBal = liquidityBalance;
        ...
        if (contractTokenBalance - toLiquify > 0) {
            _aAamarketBal = (address(this).balance * _ratios.liquidityRatio) / (_ratios.marketingRatio + _ratios.buybackRatio);
            _marketingWallet.transfer((address(this).balance * _ratios.liquidityRatio) / (_ratios.marketingRatio + _ratios.buybackRatio));
            _aAabuybackBal = address(this).balance;
