...
contract BillclintonandMonicaLewinskyinu is Context, IERC20, Ownable {
    ...
    string private _name = "BillclintonandMonicaLewinskyinu";
    string private _symbol = "Whitehouse";
