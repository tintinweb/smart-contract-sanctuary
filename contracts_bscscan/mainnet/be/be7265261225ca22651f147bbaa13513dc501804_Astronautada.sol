...
contract Astronautada is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AstronautADA", "AADA") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setEnablemarketingFee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function setEnableBuy(uint256 value) external onlyOwner {
            buyFee = value;
        }
