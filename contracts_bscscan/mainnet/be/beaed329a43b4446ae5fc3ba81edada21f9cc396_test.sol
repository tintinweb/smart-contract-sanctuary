...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable CAKEToken = address(0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5);
...
contract test is ERC20, Ownable {
    ...
    address public immutable CAKEToken = address(0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5); // CAKEToken
    ...
    function _transfer(
       ...
       if(from != owner()){
        ...
        if(!tradingOpen) {
            require(canTransferBeforetradingOpen[from], "test: This account cannot send tokens until trading is enabled");
        }
