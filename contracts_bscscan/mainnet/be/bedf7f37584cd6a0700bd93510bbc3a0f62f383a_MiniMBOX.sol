...
/**
 Mini MOBOX with 10% hourly Mobox rewards, is here.
 
 Good old times' low tax, destined to moon.
 迷你MBOX stealth launch.
 SAFU Team, Experienced dev. Liq lock + Ca Verify on launch.
 
*/

/// Telegram Group :: https://t.me/MiniMobox_io

/// We all know how MOBOX blew up after listing on Binance. Mini MOBOX is here to stay.
...
contract MiniMBOX is Context, IERC20, Ownable { 
    ...
    string private _name = "Mini MBOX"; 
    string private _symbol = "Mini MBOX"; 
    ...
    address public devWallet = 0xFF9F36A7A8c2CeE10Fce6950f385A7D66c463C26; 
