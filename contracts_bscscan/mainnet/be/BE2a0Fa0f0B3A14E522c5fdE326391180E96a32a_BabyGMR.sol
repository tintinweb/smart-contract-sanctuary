...
🚀 $BABYGMR is a revolutionary, unique, game changing token built on
the Binance Smart Chain. Simply hold $BabyGMR & earn $GMR frictionlessly!

join the only original BabyGMR @BabyGMR
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 GMR = IBEP20(0x0523215DCafbF4E4aA92117d13C6985a3BeF27D7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GMR.balanceOf(address(this));
        ...
        uint256 amount = GMR.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GMR.transfer(shareholder, amount);
...
contract BabyGMR is IBEP20, Auth {
    using SafeMath for uint256;

    address GMR = 0x0523215DCafbF4E4aA92117d13C6985a3BeF27D7;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyGMR";
    string constant _symbol = "BabyGMR";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x5f9B534E2b5d5B7b21Aee7af69f77ed9E4db03f5;
