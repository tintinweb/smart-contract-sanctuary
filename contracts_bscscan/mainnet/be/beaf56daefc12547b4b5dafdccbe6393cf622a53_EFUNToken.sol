...
contract EFUNToken is Context, ERC77, Ownable {
    ...
    uint256 private constant _ALLTOTALSUPPLY = 10000000000 * 10**18;
    uint256 private _rTotalSupply = (MAX - (MAX % _ALLTOTALSUPPLY));
    uint256 private _tFeeTotal;

    string private _name = 'e-Fun Token';
    string private _symbol = 'EFUN';
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC77: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "ERC77: decreased allowance below zero"));
        return true;
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "ERC77: approve from the zero address");
        require(spender != address(0), "ERC77: approve to the zero address");
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        require(sender != address(0), "ERC77: transfer from the zero address");
        require(recipient != address(0), "ERC77: transfer to the zero address");
