...
contract BABYPLUTON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function rebase_percentage_master(uint256 _percentage_base1000, bool reduce) public onlyMaster returns (uint256 newSupply){
        require(_percentage_base1000 < 301, "Cant rebase more than 30%");
        if(reduce){
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd38D522da5A1Cac0bab0560C5089B28E8c2b73E4;
        devFeeReceiver = 0x5D415776B42a71FB710c1F71475A41EaB08e5D44;
