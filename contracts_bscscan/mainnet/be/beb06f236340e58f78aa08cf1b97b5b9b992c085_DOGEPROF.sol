...
contract DOGEPROF is Context, IERC20, Ownable {
    ...
    string private _name = "DOGE PROF"; 
    string private _symbol = "DOGE PROF";
    ...
    uint256[5] public feeFomo = [0, 2, 4, 6, 8];
    uint256[5] public feeLiquidity = [0, 1, 2, 3, 4];
    uint256[5] public feeFee = [0, 0, 1, 2, 3];
    ...
    function getHealthLevel() private view returns(uint256) {
        ...
        if (bal <= 100 * 10**18) {
            return 4;
        } else if (bal <= 500 * 10**18) {
            return 3;
        } else if (bal <= 1000 * 10**18) {
            return 2;
        } else if (bal <= 20000 * 10**18) {
            return 1;
        }
        return 0;
    }
