...
contract MyBNBFarm {
	...
	uint256 public INVEST_MIN_AMOUNT = 968; 
	...
	constructor(address pOwner, address payable pProjectWwallet, address payable pMarkeetingWallet) {
        ...
        plans.push(Plan(7000, 50, 0));                      // Plan 1 = 23% for 7 Days    = ROI 120.75% (after Tax)
        plans.push(Plan(40, 60, 0));                      // Plan 2 = 7% for 30 Days    = ROI 157.5% (after Tax)
        plans.push(Plan(60, 70, 0));                      // Plan 3 = 5% for 50 Days    = ROI 187,5% (after Tax)
        plans.push(Plan(90, 80, 0));    // Plan 4 = 32% for 5 Days    = ROI 120% (after Tax) VIP-Plan with 2 BNB Minimum deposit
	}
