...
/**
   ...
   ONLY A 6% TOTAL TAX FOR THE LIQUIDITY POOL
   __________________________________________
        ...
        Total supply 1.000.000.000
            ...
            1% rewards for brave holders
            0.000% RESERVED COINS
    __________________________________________
    
    Join our community for more Safe Casino Tokens!

    Telegram: https://t.me/safecasinobnb
    
    Website: https://safe-casino.net/
   
   
    Welcome to Safe Casino, the first temporary token on bsc that will allow you to make massive profits with little risk and in a couple of minutes!

    How does Safe Casino work?
    We will announce a Safe Casino token contract every x time. Each Safe Casino token will have a locked liquidity of x minutes, announced in our telegram. 
    During this period of time, you will be able to operate safely. When the time expires, we will remove the liquidity pool and prepare another Safe Casino token.
    During the time that Safe Casino is active, there will be no cheating or scam in the contract. All contracts will be the same, in case we change it we will make sure to announce it.
    Always keep in mind the Safe Casino tokens advertised in this telegram. 
    Of course, investing here is your own responsibility and always check the contract direction of the currency you are buying.
...
contract SafeCasino is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Safe Casino";
