...
// CHANGE
contract KokeshiIdol is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _symbol = "$KIDOL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 100% Max 1000,000,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 100% Max 1000,000,000,000,000,000
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x86f95b8Cb0d795FeC64017B81F0897e04517300D);
