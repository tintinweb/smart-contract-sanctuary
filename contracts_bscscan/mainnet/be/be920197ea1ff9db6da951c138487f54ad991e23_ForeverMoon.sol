...
Rewards ETH for Holding - 10%
 ...
 Telegram : https://t.me/ForeverMoonBSC
 Website : TBA
...
contract ForeverMoon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ForeverMoon";
    string constant _symbol = "FoMooN";
    ...
    uint256 public _maxTxAmount = _totalSupply * 10 / 200; // MAX TX 
    uint256 public _walletMax = _totalSupply * 15 / 100;  //MAX HOLDING
    ...
    uint256 public rewardsFee = 10; // REWARDS
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xDb0E63073692ed4bCCe5dc9F44B13b8eB2380153;
