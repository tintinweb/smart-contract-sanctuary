...
/**
 ...
 - 1day Liquidity Lock (will send and pin mudra link in the TG)
    - If the marketcap is above $100,000, after 3 days we'll lock it for a month and begin unveiling our future plans

 TG: https://t.me/WenRippleSer

 
 Hold $WenRippleSer and get RIPPLE automatically in your wallet every hour or so!
 ...
 You will see 1% of the tokens was airdropped for marketing purposes to the man who has started our website! Woot woot!
 
 Reflection/Taxes: 12% in XRP, 3% in Marketing, 5% in Liquidity
 
 Buy Slippage: 21-23% (12% should be OK)

 *** THE MAX A WALLET CAN HAVE IS 35,000,000! THAT IS 3.5%! YOU CAN SELL A MAX OF 3.5%! ***
...
// CHANGE
contract WenRippleSer is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "WenRippleSer";
    string constant _symbol = "WRS";
    ...
    uint256 totalFee = 2000; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x7BF8D36928Ef82f8f6b0441ee59C910F4F8f3b2f);
