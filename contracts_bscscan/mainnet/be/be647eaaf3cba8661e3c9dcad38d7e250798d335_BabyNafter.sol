...
import "./BabyNafter-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyNafter` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyNafter(Env.Testnet)` or `BabyNafter(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyNafter";
    string internal constant SYMBOL = "BNafter";
     ...
     */
    address internal tipToTheDev =0x9f680F321E335e4971a5A02F31ecc0958693D904;
...
contract BabyNafter is SafeToken{
