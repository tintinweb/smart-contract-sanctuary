...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //change router
    IBEP20 RewardToken = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); //RewardToken
    ...
    uint256 public minPeriod = 1 hours; //period before distribution 
...
contract WaferyCake is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "WaferyCake";
    string constant _symbol = "WFCake";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = 500 * 10**6 * (10 ** _decimals);
    uint256 public _walletMax = 500 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x74B6a7b6d0d851113D861Bf04243E248C17a106D; //liquidityFee
        marketingWallet = 0x48b371e1FEa4F055546eE9869227781Cc896CCbA; //marketing wallet
        devWallet = 0x74B6a7b6d0d851113D861Bf04243E248C17a106D; //dev fee
