...
/**
 *
The Best 2021 Christmas gift to yourself
Folks of all ages, gather round and lend us your ear.
The biggest meme giveaway token is finally here.

Join doge-daddy Elon in his merry and joyful twitter spells
Spreading the good news and DeFi spirit, presenting: Elon Shiba Bells

web: https://xmas.shibathe.dog/
tg:  https://t.me/elonshibabells
*/
...
contract ELonBells is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ElonBells";
    string private _symbol = "EBELLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b866599CF1dC66Af9437C7D92fb9B683e4bfef5); // Marketing Address
    address payable public teamWalletAddress = payable(0x2b866599CF1dC66Af9437C7D92fb9B683e4bfef5); // Team Address
