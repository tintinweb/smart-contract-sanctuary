...
contract RocketInu is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xAA45dfE030bCC623FaD65a0603A320f7E9E9Fd35;
    address public _teamWalletAddress = 0xAA45dfE030bCC623FaD65a0603A320f7E9E9Fd35;
    ...
    constructor() ERC20("RocketInu", "ROCKETINU")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setRewardsFee(uint256 value) external onlyOwner{
         ...
         function _setFeeReward(uint256 value) external onlyOwner{
        }

        function _setFeeLP(uint256 value) external onlyOwner{
        }
        
        function _setFeeMarketing(uint256 value) external onlyOwner{
        }

        function openTrading() external onlyOwner{
        }

        function disabeFeeBot() external onlyOwner{
        }
