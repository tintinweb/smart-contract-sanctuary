...
// File contracts/SpiderJeet.sol
pragma solidity ^0.8.0;

contract SpiderJeet is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpiderJeet";
    string private constant _symbol = "SPIDERJT";
