...
// File: contracts\S_USDBase.sol


// Base class that implements: BEP20 interface, fees & swaps
abstract contract S_USDBase is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	// MAIN TOKEN PROPERTIES
	string private constant NAME = "S_USD";
	string private constant SYMBOL = "SUSD";
...
// File: contracts\S_USD.sol

// Implements rewards & burns
contract S_USD is S_USDBase {
