...
contract BabyKickzInu is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 204248735446 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal;

    string private _name = "Baby Kickz Inu";
    string private _symbol = "Baby KICKZ";
