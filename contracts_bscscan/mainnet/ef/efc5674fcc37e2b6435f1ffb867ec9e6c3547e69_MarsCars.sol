...
contract MarsCars is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xcA56EA9ff0A326Ba499E5Cf47Fce99d253e35D7c);
    address payable private _marketingAddress = payable(0x4761670e3E610a9336287a4A0B73D50DC5E67E6b);
    ...
    string private constant _name = "MarsCars";
    string private constant _symbol = "MarsCars";
