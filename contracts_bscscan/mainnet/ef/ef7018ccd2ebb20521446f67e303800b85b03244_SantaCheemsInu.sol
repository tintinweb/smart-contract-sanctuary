...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 FLOKI = IERC20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
...
// CHANGE
contract SantaCheemsInu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address FLOKI = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Santa Cheems Inu";
    string constant _symbol = "SCINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000000 * (10 ** _decimals); // 100,000,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 1,000,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 2% MAX 2,000,000,000,000,000
    ...
    uint256 totalFee = 1000; // Cheems Rewards + liquidityFee + devFee for marketing and development
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x96834B5aC66E4fE412363b6E6986B9B5aE61566d);
