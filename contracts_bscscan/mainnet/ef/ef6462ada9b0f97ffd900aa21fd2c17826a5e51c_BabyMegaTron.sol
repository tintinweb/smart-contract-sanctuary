...
contract BabyMegaTron is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyMegaTron';
    string private constant _symbol = '$BabyMegaTron';
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B; // TRX
        //
