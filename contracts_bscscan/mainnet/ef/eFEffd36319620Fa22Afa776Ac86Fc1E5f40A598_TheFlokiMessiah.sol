...
contract TheFlokiMessiah is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "TheFlokiMessiah";
    string private _symbol = "TFMessiah";
    ...
    uint256 public _maxTxAmount = 1 * 20000**9;
    uint256 public _maxWalletAmount = 500000 * 10**9;
