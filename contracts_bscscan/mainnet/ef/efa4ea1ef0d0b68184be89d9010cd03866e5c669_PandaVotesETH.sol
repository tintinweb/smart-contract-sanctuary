...
contract PandaVotesETH {

  function name() public pure returns(string memory) { return "PandaVotesETH"; }
  function symbol() public pure returns(string memory) { return "PandaVotesETH"; }
  function decimals() public pure returns(uint8) { return 18; }  

  function totalSupply() public view returns (uint256) {
  IPair pair1 = IPair(0x059fC92273CdF0809ba45f199E0a12d8899Ab402);
  ...
  function balanceOf(address owner) public view returns (uint256) {
    ...
    // LP pair2
    (uint256 lp1_totalpandaA, uint256 lp1_totalpandaB,) = pair1.getReserves();
    (uint256 lp1_userpanda,) = chef.userInfo(0, owner);
