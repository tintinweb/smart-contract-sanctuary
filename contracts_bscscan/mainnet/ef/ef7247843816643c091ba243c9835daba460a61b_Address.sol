...
contract MetaSwapGaz is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2586eF4Ca4d9384C90433A8C1a364Cda8Ef4bEA1); // Marketing Address
    address payable public airdropAddress = payable(0x6c7C4f0Bb0f8b92632A541A57445Ea3DBdD813c2); // Airdrop Address
    ...
    string private _name = "MetaSwapGaz";
    string private _symbol = "#MSZ";
