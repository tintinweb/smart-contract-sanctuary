...
contract GasThrottler {
    ...
    address public gasprice = address(0x72ed646DB46eAfA2d310E9fFC6f7eeBfaFa62310);
...
// File: contracts/BIFI/infra/VGatorFeeBatch.sol
...
contract VGatorFeeBatch is Ownable, GasThrottler {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public wbnb = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    address constant public vgator = address(0xF621D455f803c65F6C19a7e9cd6bEfA93bb7Dbd0);
    ...
    address[] public wbnbToVGatorRoute = [wbnb, vgator];
    ...
    // Main function. Divides VGator's profits.
    function harvest() public onlyEOA gasThrottle {
        uint256 wbnbBal = IERC20(wbnb).balanceOf(address(this));

        uint256 treasuryHalf = wbnbBal.mul(TREASURY_FEE).div(MAX_FEE).div(2);
        IERC20(wbnb).safeTransfer(treasury, treasuryHalf);
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToVGatorRoute, treasury, now);
