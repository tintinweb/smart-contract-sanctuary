...
/**
BURGER Baby - BuBa 
Earn BNBs token every hours, by holdings BURGER Baby 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BURGER = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract BurgerBaby is IBEP20, Auth {
    ...
    address BURGER = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(sender == pair && !authorizations[recipient])
        checkWalletLimit(recipient, sender, amount);
    ...
    function checkWalletLimit(address recipient, address sender, uint256 amount) internal view {
        require(amount + balanceOf(recipient) <= _maxWalletAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
    }
