...
contract EcosyBU is IERC20, Ownable {
    ...
    address public REWARD = 0x3166CD4ec85Cd2bD4fde090cf651eF307C8298c5;



    string constant _name = "EcosyBU";

    string constant _symbol = "EBU";
    ...
    uint256 public buyBusdDividendRewardsFee = 6;

    uint256 public buyEcosydDividendRewardsFee = 1;
    ...
    uint256 public buyTotalFees = 15;

    // sell fees

    uint256 public sellBusdDividendRewardsFee = 6;

    uint256 public sellEcosydDividendRewardsFee = 1;
    ...
    DividendDistributor public ecosyDividendDistributor;
    ...
    constructor() {
        ...
        busdDividendDistributor = new DividendDistributor(address(router), BUSD);

        ecosyDividendDistributor = new DividendDistributor(address(router), REWARD);
        ...
        marketingFeeReceiver = 0xeB0DF55e016AaDBaAD0551eC6ef1200Ff5062746;

        devFeeReceiver = 0x8fA0Bf37a1D209d862d1413848B07D6256c23F8f;
 ...
 // tracker dashboard functions for ecosy reward

    function getHolderDetailsEcosy(address holder)
...

    {
        ...
        return ecosyDividendDistributor.getHolderDetails(holder);

    }



    function getLastProcessedIndexEcosy() public view returns (uint256) {

        return ecosyDividendDistributor.getLastProcessedIndex();

    }



    function getNumberOfTokenHoldersEcosy() public view returns (uint256) {

        return ecosyDividendDistributor.getNumberOfTokenHolders();

    }



    function totalDistributedRewardsEcosy() public view returns (uint256) {

        return ecosyDividendDistributor.totalDistributedRewards();
    ...
    function _transferFrom(
        ...
        if (!isDividendExempt[sender]) {
            ...
            //set ecosy share
             ...
             try
                ...
                ecosyDividendDistributor.setShare(sender, _balances[sender])
        ...
        if (!isDividendExempt[recipient]) {
            ...
            try
                ...
                busdDividendDistributor.setShare(recipient, _balances[recipient])
            ...
            //set ecosy share
             ...
             try
                ...
                ecosyDividendDistributor.setShare(recipient, _balances[recipient])
        ...
        try ecosyDividendDistributor.process(distributorGas) {} catch {}
    ...
    function updateBuyFees(
        ...
        buyEcosydDividendRewardsFee = ecosyReward;
        ...
        buyTotalFees = busdReward.add(marketing).add(liquidity).add(dev).add(ecosyReward);
    ...
    function updateSellFees(
        ...
        sellEcosydDividendRewardsFee = ecosyReward;
        ...
        sellTotalFees = busdReward.add(marketing).add(liquidity).add(dev).add(ecosyReward);
    ...
    function ___claimRewardsEcosy(bool tryAll) public {

        ecosyDividendDistributor.claimDividend();
    ...
    function claimProcessEcosy() public {
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 tokensToRewardBusd = contractTokenBalance
            ...
            .div(buyTotalFees);
             ...
             uint256 tokensToRewardEcosy = contractTokenBalance

            .mul(buyEcosydDividendRewardsFee)
        ...
        if (tokensToRewardBusd > 0) {
            ...
            uint256 swappedTokensAmount = IERC20(BUSD).balanceOf(
        ...
        if (tokensToRewardEcosy > 0) {

            swapTokensForTokens(tokensToRewardEcosy, REWARD);
            ...
            IERC20(REWARD).transfer(
                ...
                address(ecosyDividendDistributor),

                swappedTokensAmount

            );

            try ecosyDividendDistributor.deposit(swappedTokensAmount) {} catch {}
...

    {
        ...
        function setIsDividendExemptEcosy(address holder, bool exempt)
...

    {
        ...
        if (exempt) {
            ...
            ecosyDividendDistributor.setShare(holder, 0);

        } else {

            ecosyDividendDistributor.setShare(holder, _balances[holder]);
    ...
    function setDistributionCriteriaBusd(
        ...
        function setDistributionCriteriaEcosy(
        ...
        ecosyDividendDistributor.setDistributionCriteria(
