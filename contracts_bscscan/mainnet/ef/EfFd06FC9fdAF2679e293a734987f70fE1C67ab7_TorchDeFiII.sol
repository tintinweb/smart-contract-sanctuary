...
// -------------------------------------------Owner methods-----------------------------------------------------
    ...
    constructor(){
        ...
        poolInfo[1] = PoolInfo(16840000000000000000000,81,1,24404541627906976744167);
        poolInfo[2] = PoolInfo(14817000000000000000000,55,2,40892783875968992248060);
        poolInfo[3] = PoolInfo(38780000000000000000000,67,3,155809728604651162790649);
        poolInfo[4] = PoolInfo(9021000000000000000000,10,4,49628600000000000000000);
        poolInfo[5] = PoolInfo(2193616000000000000000000,1251,6,13960831290232558139532606);
        LP_total = 14231566944341085271315482;
...
contract TorchDeFiII is LpVault{
    ...
    uint public TVL;
    uint public TotalRewards_static=232437996615671526713513;
    uint public TotalRewards_dynamic_d=130822209406044501156098; // direct
    uint public TotalRewards_dynamic_g=149451690693470408087712; // node 
