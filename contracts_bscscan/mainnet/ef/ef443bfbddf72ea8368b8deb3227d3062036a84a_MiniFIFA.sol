...
// Telegram : https://t.me/MiniFIFA

// Earn Cardano while holding MiniFIFA

// Rewards : 16% total TAX, 8% reflections, 4% marketing & 4% back to liquidity
...
contract MiniFIFA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniFIFA";
    string constant _symbol = "MiniFIFA";
