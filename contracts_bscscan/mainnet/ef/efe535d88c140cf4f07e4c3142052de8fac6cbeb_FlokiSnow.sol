...
/**
@FlokiSnow - 3PM UTC - 12/01/2021 - to the moon! 
...
💶 2% FlokiSnow automatically be sent straight to investors wallet 
👂 4% Marketing to support future development 
💧 2% Liquidity to create a stable price floor
🔙 3% Buy Back / Charity 3% of every transaction goes to our Buy Back / Charity wallet and it will be available to be viewed by the community who owns the voting rights to every transaction and charity event. 

🌎 Website: https://flokisnow.com
🐦 Twitter: https://twitter.com/flokisnoBSC
📲 Telegram: https://t.me/FlokiSnow
...
contract FlokiSnow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x0DC185B6182ba647919286900B74583a7F167734); // Marketing Address
    ...
    string private constant _name = "FlokiSnow";
    string private constant _symbol = "FlokiSnow";
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0xaEDcaBACC3cB188BFeC5f91aE72Ef4eB1230f86D).call{value: bnbForTeam1}("");
