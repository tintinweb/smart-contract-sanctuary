...
contract PopCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor(address _presaler, address _presaleContract,address marketing,address lp) Auth(msg.sender) {
