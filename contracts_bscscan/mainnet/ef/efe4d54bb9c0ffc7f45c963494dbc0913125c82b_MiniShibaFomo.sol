...
/**
    ...
    clean contract for degen call! (minishibainu fork)
    tax 10%
    5% Reflect to holder
    5% back to liquidity
    3% max wallet
...
contract MiniShibaFomo is Context, IERC20, Ownable { 
    ...
    string private _name = " MiniShibaFomo"; 
    string private _symbol = "MShibF"; 
