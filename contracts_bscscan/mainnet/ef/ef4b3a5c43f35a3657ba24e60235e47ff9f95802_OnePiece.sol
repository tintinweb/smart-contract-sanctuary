...
* *********************************************************************************
*                                                                                                                                                    
* Welcome to the hunt for the One Piece! Destination: Laugh Tale.
* Are you ready to conquer the Grand line and become the next Pirate King?
*
* One Piece $LaughTale
* There is only 1.
* With every transaction 1% will be burned and 2% will go to lp.
* You can only conquer 0,25% (0.0025 tokens) of the treasure each time.
* 
 ...
 * COIN
 */
contract OnePiece is Context, IERC20, Ownable, ReentrancyGuard {
    // Libraries
    ...
    string private _symbol = "Laugh Tale";
    ...
    // Max TX in tokens
    uint256 public _maxSellTxAmount = 0.0025 * 10**18;
    uint256 public _maxBuyTxAmount = 0.0025 * 10**18;

    // Max Wallet in tokens
    uint256 public _maxWalletSize = 2 * 10**18;
