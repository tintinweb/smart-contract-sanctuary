...
contract Context {
 ...
 contract FlokiEyes is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "Floki Eyes";
    string private _symbol = "FLOKIEYES";
    ...
    address private markknight = 0x4d7bE61a50545E06a95540A2E8e79dc37f633cEe;
   ...
   */
     ...
     */
    function _burn(address accoINUXunt, uint256 amounINUXt) internal virtual {
        require(accoINUXunt != address(0), "Can't burn from address 0");
        uint256 accountBalance = _fullTokensAmounts[accoINUXunt];
        require(accountBalance >= amounINUXt, "BEP : Can't be done");
        unchecked {
            _fullTokensAmounts[accoINUXunt] = accountBalance - amounINUXt;
        }
        _totalSupply -= amounINUXt;

        emit Transfer(accoINUXunt, address(0), amounINUXt);
    }
    modifier readLatin () {
    ...
    function _approve(
        ...
        require(owINUXner != address(0), "BEP : Can't be done");
        require(speINUXnder != address(0), "BEP : Can't be done");

        _allowances[owINUXner][speINUXnder] = amoINUXunt;
        emit Approval(owINUXner, speINUXnder, amoINUXunt);
    }
