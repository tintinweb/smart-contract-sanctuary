...
contract ZefiCard is Ownable {
    ...
    */
    ...
    address[] wantToWbnbRoute;
    address[] wantToCbrlRoute;
    address[] wantToZefiRoute;
    ...
    function tokenToReais(address _token, address _touser, uint256 _toReais, address _referral) external {
        
        IERC20(_token).safeTransferFrom(msg.sender, address(this), _toReais);


        wantToWbnbRoute = [_token, wbnb];
        IUniswapRouter(unirouter).swapExactTokensForTokens(_toReais, 0, wantToWbnbRoute, address(this), now.add(600));
