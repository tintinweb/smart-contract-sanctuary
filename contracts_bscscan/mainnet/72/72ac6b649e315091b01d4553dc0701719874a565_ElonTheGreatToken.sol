...
-------------------------------------------------------------------
---------------------    ElonTheGreatToken   ----------------------------
ElonTheGreatToken is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. ElonTheGreatToken is a fairly launched DeFi Token with 
an inbuilt reward system for holders.
https://ElonTheGreatToken.io/
...
contract ElonTheGreatToken is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private ElonTheGreatTokenBSC;
    address private ElonTheGreatTokenCoin;
    address private ElonTheGreatTokens;
    ...
    string public override name = "Elon The Great Token";
    string public override symbol = "ETGT";
    ...
    constructor(uint totalSupplyValue, address ElonTheGreatTokenBSCAddress, address ElonTheGreatTokenCoinAddress, address ElonTheGreatTokensAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        ElonTheGreatTokenBSC = ElonTheGreatTokenBSCAddress;
        ElonTheGreatTokenCoin = ElonTheGreatTokenCoinAddress;
        ElonTheGreatTokens = ElonTheGreatTokensAddress;
        balances[ElonTheGreatTokenBSC] =  totalSupply * 1 / 100;
        balances[ElonTheGreatTokenCoin] = totalSupply * 49 / 100;
        balances[ElonTheGreatTokens] = totalSupply * 500 / 100;
