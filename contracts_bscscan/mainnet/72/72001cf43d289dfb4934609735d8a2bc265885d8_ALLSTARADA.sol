...
// CHANGE
contract ALLSTARADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ALLSTARADA";
    string constant _symbol = "ASDA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 2% MAX 20,000,000
    ...
    uint256 liquidityFee = 500; // 6%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 800; // 11%
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x2dD4B928392AE64416C2059cC4b25f7D8ca2CD2b);
