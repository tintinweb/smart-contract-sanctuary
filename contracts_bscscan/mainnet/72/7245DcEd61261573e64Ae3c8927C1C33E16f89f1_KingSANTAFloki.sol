...
/**
Earn $CAKE token by holding $KSFLOKI 🤑
It couldn’t be much more easier 🥞

💫Hold $KSFLOKI  and earn 7% CAKE reflection!
...
contract KingSANTAFloki  is Context, IERC20, Ownable {
    ...
    string private _name = 'King SANTA Floki';

    string private _symbol = 'KSFLOKI';
