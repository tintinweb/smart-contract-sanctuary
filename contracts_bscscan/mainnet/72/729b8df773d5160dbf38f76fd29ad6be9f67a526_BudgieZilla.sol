...
contract BudgieZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BudgieZilla";
    string private _symbol = "BudgieZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x00e224145B5BBCACB7777892d6770Cee6323D55D); // Marketing Address
    address payable public teamWalletAddress = payable(0x6dEAdDFE0B6b3cB94CbE0831701F094B0Df38b01); // Team Address
