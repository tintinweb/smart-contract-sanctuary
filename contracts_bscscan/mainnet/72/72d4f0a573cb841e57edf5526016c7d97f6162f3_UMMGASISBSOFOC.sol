...
* 4% BUSD Rewards. 
* 4% Toward Liquidity Pool. 
* 1% Charity. 
* 1% Continuous Marketing. 
* 1 Trillion Tokens Token Supply. 

* Telegram: https://t.me/SUMMGSABSOISFOCPB
...
contract UMMGASISBSOFOC is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "SAFE UNVAXXED MICRO META GOOGLE SHIBA ANDROMEDA BABY SON OF INU SANTA FLOKI ORBIT CHEEM PEPE BONK";
    string constant _symbol = "SUMMGSABSOISFOCPB";
    ...
    int256 public _startTimeForSwap;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingWallet = 0xD3866CD17a42905AC1489A3deF76B4261Cf61Cb5;
