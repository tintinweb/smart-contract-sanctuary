...
contract MixSwapReferral is IMixSwapReferral, Ownable {
    using SafeBEP20 for IBEP20;
	//Operator should be Masterchef, to set operator call updateOperator with the masterchef address and 'true' or '1' as argument
