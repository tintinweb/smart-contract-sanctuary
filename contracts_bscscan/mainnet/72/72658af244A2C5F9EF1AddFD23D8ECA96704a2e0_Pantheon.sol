...
/* 
The ancient Greek Gods of the Pantheon return to earth. In these modern and volatile times full of stress, labor and transformation, 
we would like to take a moment to remember the origins of one of the most powerful empires there has ever been. The Greek Empire. 
We will take you into a world of heroes and myths.
...
contract Pantheon is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address MAAA = 0x2C0CED053b6C156Ca164356Defa0ea5f532b1ca8;

    string constant _name = "Pantheon";
    string constant _symbol = "PTH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100 ** 3; // 3%
