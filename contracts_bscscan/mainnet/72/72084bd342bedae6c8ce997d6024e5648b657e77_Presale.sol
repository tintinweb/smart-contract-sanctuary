...
contract Presale is Owned {
    ...
    function setTokenPrice(uint256 _tokenPrice, uint256 _tokenPriceDecimal) external onlyOwner {
    ...
    function buy(uint256 _paidAmount) public {
        ...
        uint tokenAmount = _paidAmount.mul(tokenPrice).mul(10**9).div(10**18).div(10**tokenPriceDecimal);
