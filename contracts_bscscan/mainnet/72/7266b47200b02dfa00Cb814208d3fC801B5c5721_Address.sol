...
/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to creat White designed.
    
    I make this #White to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/WhiteNorthBSC
   ...
   I will renounce the ownership to burn addresses to transfer #White to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 50% total supply to the pool
   Can you make #White 100000X? 

   100,000,000,000,000,000 total supply
   500,000,000,000,000 White max limit for per trade
   ...
   it's the best part of the #White idea, increasing the liquidity pool automatically, 
...
contract WhiteNorth is Context, IERC20, Ownable {
    ...
    string private _name = "WhiteNorth";
