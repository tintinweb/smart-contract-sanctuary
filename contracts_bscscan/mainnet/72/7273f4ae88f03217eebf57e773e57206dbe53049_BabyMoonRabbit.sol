...
// https://t.me/BabyMoonRabbitBSC

// Elon musk's tweet impressed baby moon rabit welcome everyone with plenty of wins
//https://twitter.com/elonmusk/status/1449862940610514954

// Welcome to  Baby Moon Rabbit people who have received this token will be deemed 
//to have accepted all the following conditions
//Because the market cap is low, the Baby Baby Moon Rabbit will rise and fall very quickly,
//so the people who tweet institutions and organizations token holders are not responsible for any damage
...
contract BabyMoonRabbit is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyMoonRabbit";
    string constant _symbol = "BMOONRABBIT";
