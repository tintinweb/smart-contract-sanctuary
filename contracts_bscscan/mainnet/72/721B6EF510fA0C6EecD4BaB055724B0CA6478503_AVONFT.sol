...
contract AVONFT is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    constructor(string memory baseuri,  address cOwner, address minter) Ownable (cOwner)  {
        _setURI(baseuri);
        _minter = minter;
    }
    ...
    function create (
        ...
        _mint(_minter, _id, _initialSupply, _data);
    ...
    function safeTransferFrom(
        ...
        require((from == _minter || to == _minter || escrows[from] || escrows[to]),
