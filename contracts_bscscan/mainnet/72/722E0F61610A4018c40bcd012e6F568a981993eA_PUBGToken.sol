...
/**
PUBG Token ($PUBG) Official Contract


🌐 Website: https://pubg-token.tech/

📞 TG: https://t.me/pubg_token

📲 Twitter: https://twitter.com/PUBG_TOKEN
 */
...
contract PUBGToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0d0EfB6EbEFA54eE0E3e6B3e1e0335f25839084d); // Marketing Address
    ...
    uint256 private _tTotal = 8000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "PUBG Token";
    string private _symbol = "PUBGT";
