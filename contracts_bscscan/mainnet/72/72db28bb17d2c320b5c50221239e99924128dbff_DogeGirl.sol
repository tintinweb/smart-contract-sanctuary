...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TOKEN = IERC20(0xa4FFfc757e8c4F24E7b209C033c123D20983Ad40);
    ...
    uint256 public dividendsPerShareAccuracyFactor = 0;
    ...
    function changeToken(address newToken) external override onlyToken {
        ...
        require(totalDividends == 0 || previousAmount > 0, "Requires at least some of initial token to calculate convertion rate.");
    ...
    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external override onlyToken {
        ...
        minDistribution = _minDistribution * (0);
    }
...
contract DogeGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "cz";

    string constant _name = "DogeGirl";
    string constant _symbol = "DOGEGIRL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 200; //5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 1) / 50; // 10%
