...
/**
  Welcome to DogeBoy Official - here to take over.
  You've seen CatGirl, You've seen CatBoy
  Get ready for DogeBoy Official

  Tokenomics
  12% team
  10% Locked for future development
  5%  Locked Airdrop for Day 7+ Diamondhands
  73% PCS Liquidity

  Official TG https://t.me/dogeboyofficial

  Impersonation is the sincerest form of flattery, do not fall for fakers. Go DogeBoy Official
...
contract DOGEBOY is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x05B56F0c5816939E32E5b8cDB086a6422516d853;
    address public operationsAddress = 0x110dFb61c798B08C3800e73A7Ad9bB4115c8e6EA;
