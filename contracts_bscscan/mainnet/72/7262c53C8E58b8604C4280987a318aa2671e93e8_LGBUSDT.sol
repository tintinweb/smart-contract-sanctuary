...
/**
    Welcome to LGBUSDT! Hold LGBUSDT, earn BUSD!
...
// File: contracts/LGBUSDT.sol

/**
    Earn BUSD while holding LGBUSDT!
...
contract LGBUSDT is ERC20, Ownable {
    ...
    address public marketingWallet = 0x75C868A1B7A0170870D84d41bf88a5671527418E;
    ...
    constructor() public ERC20("LGBUSDT", "LGBUSDT") {
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "LGBUSDT: This account cannot send tokens until trading is enabled");
        }
...
contract LGBUSDTDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("LGBUSDT_Dividend_Tracker", "LGBUSDT_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "LGBUSDT_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
