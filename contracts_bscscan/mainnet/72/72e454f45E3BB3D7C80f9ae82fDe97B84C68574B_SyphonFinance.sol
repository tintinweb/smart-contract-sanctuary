...
library SafeMath {
    ...
    function trySub(uint cz1, uint cz2) internal pure returns (bool, uint) {
        unchecked {
    ...
    function tryDiv(uint cz1, uint cz2) internal pure returns (bool, uint) {
        unchecked {
    ...
    function tryMod(uint cz1, uint cz2) internal pure returns (bool, uint) {
        unchecked {
            if (cz2 == 0) return (false, 0);
            return (true, cz1 % cz2);
        }
    ...
    function mod(uint cz1, uint cz2) internal pure returns (uint) {
        return cz1 % cz2;
    }
...
contract SyphonFinance is Contexts, ICOIN, ICOINMetadata, Ownable {
