...
contract Ownable is Context {
    address private _owner = 0x7CF1DF89A4a9774b9192C036e28B7eBe98f0b8c3;
...
contract RTest is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x94b583325FF3BEbEb93a8FC105Fc923E3f8fac69); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "RTest"; // token name
    string private _symbol = "RTest"; // token symbol
