...
/**
   ...
   Renounced the ownership to burn addresses to transfer #FuckMonopolyCoin
   to the community
   Can you make #FuckMonopolyCoin
   100X? 
   ...
   it's the best part of the #FuckMonopolyCoin
...
contract FuckMonopolyCoin is BEP20 {
    ...
    constructor() public {
	symbol = "FuckMonopolyCoin";
    name = "FuckMonopolyCoin";
    fees = 10;
