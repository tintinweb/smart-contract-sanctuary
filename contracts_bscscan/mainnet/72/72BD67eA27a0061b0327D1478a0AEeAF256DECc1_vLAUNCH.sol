...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RWRD = IERC20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d); // USDC
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //PANCAKESWAP
...
contract vLAUNCH is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "vLAUNCH";
    string constant _symbol = "VLNC";
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe5383C2691DFfAb4AB1F961E030a622f7b9b413c; // marketing
        devFeeReceiver = 0x1D7328d533c5a292874e54Dc95ee53ba0be965f8; // buybacks and giveways
