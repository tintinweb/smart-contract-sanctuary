...
// File contracts/FlokiClaus.sol
pragma solidity ^0.8.0;

contract FlokiClaus is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Claus";
    string private constant _symbol = "FLOKICLAUS";
