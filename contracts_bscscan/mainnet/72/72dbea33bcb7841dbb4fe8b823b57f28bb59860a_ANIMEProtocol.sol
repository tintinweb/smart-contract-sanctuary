...
contract ANIMEProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "ANIME Protocol"; 
    string private _symbol = "ANIME";
    
    // ALL FEES ARE DIVIDED BY 10**2 FOR MORE ACCURACY
    // EXAMPLE: 4 / 100 = 4%
    uint256 private _reflectFee = 0; // Set dynamically
    uint256 public _buyReflectFee = 1;
    uint256 public _sellReflectFee = 1;
    uint256 private maxReflectFee = 10;
    ...
    address payable public _marketingWallet = payable(0xBa81BC5Ba976b5eBfA0d4C138cD5E4D08a53cbb1); //select your marketing address
    address payable public _developerWallet = payable(0x11619fd5B75F9E074b881EE306F0b4c29e0e649f); // development team address
    ...
    constructor (uint256 _snipeBlockAmt) {
        ...
        _isExcludedFromFee[0x11619fd5B75F9E074b881EE306F0b4c29e0e649f] = true;
        _isExcluded[0x11619fd5B75F9E074b881EE306F0b4c29e0e649f] = true;
        _excluded.push(0x11619fd5B75F9E074b881EE306F0b4c29e0e649f);
    ...
    function setBNBRatio (uint256 liquidityRatio, uint256 marketingRatio) internal onlyOwner() {
