...
contract CrystalVision is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5d4a3E5ffa05f061f2C7F4A359fb99C4322aB209); // Marketing Address
    ...
    string private _name = "CrystalVision";
