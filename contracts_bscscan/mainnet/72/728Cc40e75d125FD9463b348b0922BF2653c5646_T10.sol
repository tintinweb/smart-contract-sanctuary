...
contract T10 is Context, IERC20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 5 * 10**5 * 10**18;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isCleaned[from], "Owners!");
