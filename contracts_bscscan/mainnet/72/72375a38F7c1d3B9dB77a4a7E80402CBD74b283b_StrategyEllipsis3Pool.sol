...
// File: contracts/BIFI/interfaces/ellipsis/IEpsLP.sol
...
// File: contracts/BIFI/interfaces/ellipsis/IMultiFeeDistribution.sol
...
// File: contracts/BIFI/strategies/Ellipsis/StrategyEllipsis3Pool.sol
 ...
 */
contract StrategyEllipsis3Pool is Ownable, Pausable {
    ...
    address public constant feeDistribution =
        address(0x4076CC26EFeE47825917D0feC3A79d0bB9a6bB5c);
    address public constant poolLp =
    ...
    function chargeFees() internal {
        uint256 toWbnb = IERC20(eps).balanceOf(address(this)).mul(5).div(1000);
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) = ILpStaker(stakingPool).userInfo(
            poolId,
            address(this)
        );
        return _amount;
