...
MiniShibaSushi ( $MSHIBASU )
stealth launch ~ t.me/minishibasushi
...
contract MiniShibaSushi is Context, IERC20, Owwnable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd4a6840F4215a79a7ee41A82F7bd575196f2eC65); // Marketing Address
    ...
    string private _name = "MiniShibaSushi";
    string private _symbol = "$MSHIBASU";
