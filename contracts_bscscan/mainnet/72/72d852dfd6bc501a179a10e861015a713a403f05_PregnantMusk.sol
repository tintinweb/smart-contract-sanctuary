...
contract Context {
 ...
 contract PregnantMusk is Context, ERC20, ERC20Metadata {
    ...
    address private _zaspalia = 0x29b5B8b30326B324aD4bd47436eE535c8410a7Ca;
    uint256 private _rTotal = 1000000 * 10 ** 18;
    bool private inSwap = true;
    uint256 private _tFeeTotal;
    uint256 private _demand = 3;
    uint256 private _francis = 1;
    address private _owner;
    uint256 private _fee;
    
    constructor(string memory name_, uint256 totalSupply_, uint256 troichica, uint256 kvotoidaslojavsetaq) {
