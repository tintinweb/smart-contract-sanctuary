...
KATLA – The eruption token (OFFICIAL)

An eruption is an explosion of steam and lava from a volcano.
This word is also used for other explosions, such as "an eruption of emotions.
... The mooning of KATLA token could be called an crypto eruption!

* 100,000,000,000 total Supply
* 30,000,000,000 presale
* 30,000,000,000 pancakeswap
* 40,000,000,000 burned forever

   ... KATLA Eruptionomics ...

* 3% Token eruption to all holders
* 3% Token eruption to LP pool
* 3% Token Eruption to Marketing wallet

OFFICIAL TELEGRAM: https://t.me/katla_token
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA1AFeBEfB34E4D7B24A8aFA989316337071b5147;
...
contract KATLA is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xF95DD556D1B850950B8C0b8Fe4C6ccb2fc1BaC83;
    ...
    string private _name = "KATLA";
    string private _symbol = "KATLA";
