...
/*
* InfantFloki BNB. A fork of FlokiBUSD which is a fork of DogeBNB which is another fork of TIKI. Free BNB every 20-30mins depending on volume(Auto Airdropped) It should start at 2-5k marketcap. Early sellers will be punished with tax. 
*/
...
contract InfantFloki is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Infant Floki BNB';
    string  private constant _SYMBOL = 'InfantFloki';
