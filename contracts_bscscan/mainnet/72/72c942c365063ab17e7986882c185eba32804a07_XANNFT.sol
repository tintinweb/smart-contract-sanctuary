...
contract XANNFT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "XANNFT";
    string constant _symbol = "XANNFT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 137 * 10**9 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x24d23a4705174D0792532Abd64FDDBecaCb0D92b;
