...
Telegaram : https://t.me/DOGEception
...
contract Dogeception is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DOGEception", "DDDoge") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0xd84E9c40C560C7BDb6a1646eC30de1cF279363b0;

    	cakeDividendToken = 0xf6441bDB9FA7CB87D4F2eec2D72aebDe6fFee917; //
    ...
    function tradeStart() external onlyOwner {
        ...
        maxSellTransactionAmount = 50000000000 * (10**18);
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "Dogeception: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "Dogeception: The new dividend tracker must be owned by the StellarApe token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("StellarApe_Dividend_Tracker", "StellarApe_Dividend_Tracker", 0x43C934A845205F0b514417d757d7235B8f53f1B9) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "StellarApe_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "StellarApe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "StellarApe_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "StellarApe_Dividend_Tracker: Cannot update claimWait to same value");
