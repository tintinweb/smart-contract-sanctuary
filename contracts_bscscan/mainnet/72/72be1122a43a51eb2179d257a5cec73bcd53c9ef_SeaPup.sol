...
/**
SeaPup Token is a brand new & exciting twist on the most popular & loved meme tokens in the cryptoverse. 
SeaPup will provide its holders incredible rewards & develop to allow for real-world utility that actually makes a difference. 
Those are just a few of the reasons why SeaPup is not only here to stay, 
but has the potential to shine amongst the most cherished crypto characters today. https://linktr.ee/officialseapup
https://github.com/coinscope-co/audits/blob/main/spup/audit.pdf
https://www.seapup.io/
*/
...
contract SeaPup is SPUPDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SPUPTeam;
    address private CharitySPUP;
    ...
    string public override name = "SeaPup";
    string public override symbol = "SPUP";
    ...
    constructor(uint totalSupplyValue, address SPUPTeamAddress, address CharitySPUPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SPUPTeam = SPUPTeamAddress;
        CharitySPUP = CharitySPUPAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SPUPTeam] =  totalSupply * 45 / 100;
        balances[CharitySPUP] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's SPUPTeam pot
