...
/**
   Welcome to ElonStormTrooper
   
   It's a community token, every holder should promote it,
   if you want to pump your investment, you need to do some effort.
   

   Renounced the ownership to burn addresses to transfer #ElonStormTrooper
   to the community
   Can you make #ElonStormTrooper
   100X? 
   ...
   it's the best part of the #ElonStormTrooper
...
contract ElonStormTrooper is BEP20 {
    ...
    constructor() public {
	symbol = "ElonStormTrooper";
    name = "ElonStormTrooper";
    fees = 10;
