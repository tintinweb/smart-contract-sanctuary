...
/**
 * BabyJew is a $KOSHER Rewards / Circumcision NFT Project bringing some of the most pedo and evil KOSHER NFTs to the Jewish Smart Chain!  
 * 
 * https://www.BabyJew.kosher
 * 
 * Come show eat goyim flesh and bomb Palestine!
 * https://www.t.me/BabyJew
*/
...
contract BabyJEW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "BLOODLIBEL";
