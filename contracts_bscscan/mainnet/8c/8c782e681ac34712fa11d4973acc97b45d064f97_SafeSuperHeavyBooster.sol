...
/**
   ...
   Welcome to Safe Super Heavy Booster
   
   This is a community token. If you want to create a telegram I suggest to name it to @SafeSuperHeavyBooster
   Important: I create this because Elon's tweet. The early you create a group that shares the token, the more gain you'll get.
   ...
   5% fee will auto convert to BNB and come to my wallet
   ...
   I will renounce the ownership to burn addresses to transfer #SafeSuperHeavyBooster to the community. Im not going take any token, make sure it's 100% safe.

   I will add .4 BNB and all the left 10% total supply to the pool
   Can you make #SafeSuperHeavyBooster 10000X? 
...
contract SafeSuperHeavyBooster is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Super Heavy Booster";
    string private _symbol = "SAFESHB";
