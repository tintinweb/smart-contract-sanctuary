...
/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #FASTDOGE designed.
   ...
   I will renounce the ownership to burn addresses to transfer #FASTDOGE to the community, make sure it's 100% safe.

   I will add 0.3 BNB and all the left 10% total supply to the pool
   Can you make #FASTDOGE 100000X? 

   1,000,000,000,000,000 total supply
   5,000,000,000,000 FASTDOGE max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #FASTDOGE idea, increasing the liquidity pool automatically, 
...
contract FASTDOGE is Context, IERC20, Ownable {
