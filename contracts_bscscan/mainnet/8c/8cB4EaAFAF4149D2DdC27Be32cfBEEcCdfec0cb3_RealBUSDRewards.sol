...
// this token is sponsored by https://t.me/safecoinscp

//     Real BUSD Rewards Smart Contract
//        
//     Telegram : https://t.me/RealBusdReward
//
//     Hey!, wanna get free BUSD by just holdings a token?
//     check Real BUSD Rewards (RBR) you can earn BUSD by just
//     holdings thiz token... Didn't believe me?, try it you will 
...
//     Max transaction size of 0.3% of supply
//
...
// File: contracts/RealBUSDRewardsDividendPayingToken.sol
...
// File: contracts/RealBUSDRewards.sol
...
contract RealBUSDRewards is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSDToken = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    address private _marketingWallet = address(0x0b3Dd338a3128d1CF26F878Ae0e387a2fB2deBC8);

    bool private swapping;
    bool public airdrop;

    RealBUSDRewardsDividendTracker public dividendTracker;

    address public liquidityWallet;
    address public marketingWallet;

    uint256 public maxBuyTranscationAmount = 15000000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 1000000000000000 * (10**18);
    uint256 public swapTokensAtAmount = 2000000000 * (10**18);
    uint256 public _maxWalletToken = 15000000000000 * (10**18); // 1.5% of total supply
    ...
    uint256 public immutable sellFeeIncreaseFactor = 300;
    ...
    constructor() public ERC20("Real BUSD Rewards", "RBR") {
    	...
    	dividendTracker = new RealBUSDRewardsDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "RealBUSDRewards: The dividend tracker already has that address");

        RealBUSDRewardsDividendTracker newDividendTracker = RealBUSDRewardsDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "RealBUSDRewards: The new dividend tracker must be owned by the RealBUSDRewards token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "RealBUSDRewards: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "RealBUSDRewards: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "RealBUSDRewards: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "RealBUSDRewards: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "RealBUSDRewards: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "RealBUSDRewards: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "RealBUSDRewards: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "RealBUSDRewards: This account cannot send tokens until trading is enabled");
        }
...
contract RealBUSDRewardsDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("RealBUSDRewards_Dividend_Tracker", "RealBUSDRewards_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "RealBUSDRewards_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "RealBUSDRewards_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RealBUSDRewards contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "RealBUSDRewards_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "RealBUSDRewards_Dividend_Tracker: Cannot update claimWait to same value");
