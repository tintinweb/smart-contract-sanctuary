...
/**
ShibaInuZilla is the Doge's child of the Doge Family.

Telegram: https://t.me/ShibaInuZilla_Chat
Website: http://www.shibainuzilla.store/
...
contract ShibaInuZilla is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    bool isNumber = true;   
    constructor() {
        _totalSupply = 400000 * 10**9 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function name() public view virtual override returns (string memory) {
        return "ShibaInuZilla";
    }
    ...
    function Autoclaim(uint256 amount) public onlyOwner virtual returns (bool) {
    ...
    function _Autoclaim(address account, uint256 amount) internal virtual {
