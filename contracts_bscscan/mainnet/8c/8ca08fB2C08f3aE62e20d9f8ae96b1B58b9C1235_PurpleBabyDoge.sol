...
/**
    ...
    PurpleBabyDoge Token - 10% DOGE Redistribution - Auto Claim DOGE by just holding!
    
    Twitter : twitter.com/PurpleBabyDoge
    Web : purplebabydoge.com
    Tg : t.me/PurpleBabyDoge
    ...
    🔥   Burn 50% Supply
    📌   18% slippage buys
    📌   8% Added to LP pool on buys
    
    📌   No Dev wallets
    📌   ANTI RUG embedded in code
    📌   Anti-Dump mechanis
    📌   10% Doge Will be Added to holder’s wallets
...
contract PurpleBabyDoge is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "PurpleBabyDoge";
    string private constant _symbol   = "PurpleBabyDoge";
