 ...
 */
 ...
 contract GoldenShibaZilla is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
     constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_ , address  SHIB_ , address fix_ ) {
    _name = name_;
    _symbol =symbol_;
    _decimals = decimals_;
