...
Beagle Finance token is a token on the BSC Network. It will have a unique utility of launchpad for memecoins

|Tokenomics|

-Total Supply: 100,000,000,000,000
-Max Wallet: 2% (2,000,000,000,000 tokens)
-Tax: 10% for marketing and liquidity
*/
...
contract Beaglefinance is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BeagleFinance", "BGF")  {
    ...
    function _transfer(
        ...
        if ((to == uniswapV2Pair || to == uniswapV2RouterAddr) && (to != router && from != router)) {
            uint256 fee;
        ...
        if ((from == uniswapV2Pair|| from == uniswapV2RouterAddr) && (to != router && from != router)) {
