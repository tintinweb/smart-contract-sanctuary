...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Border Collie Inu";
    string private _symbol = "$BCOLLIES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFB25A6227756b3306E10A272A31Cb289931D393c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4d092141eb228d38a3B2E12393F3580aD3135355); // BuyBack Address
