...
contract Talon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x55e6c7Ab82F1BE729C91aD9feac24015927761f7); // Marketing Address
    address payable public charityAddress = payable(0x55e6c7Ab82F1BE729C91aD9feac24015927761f7); // Charity/Dev Address
    ...
    string private _name = "Talon Token";
    string private _symbol = "TAL";
