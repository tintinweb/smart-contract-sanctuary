 ...
 * 
 *  Development Wallet = 0x8d752d588aaeeeda2a9bab3abb662bce459bbbd8
 *  Marketing Wallet   = 0x8d752d588aaeeeda2a9bab3abb662bce459bbbd8 (the unlocked supply dedicated to partnerships and investors will also be held in this wallet.)
 *  Team Wallet        = 0xDDD99afE969Df48e52109A289DABa51221fBFD46
 *
 */
...
contract ETHCR is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES *********************************
    string private _name = "ETHCR";                                                   // name
    string private _symbol = "ETHCR";                                                    // symbol
    uint256 private _tTotal  = 4444 * 10**uint256(_decimals);                       // total supply
	uint256 private _tTotald = 4444 * 10**uint256(_decimals);                       // total supply
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive _walletsFee.
        0x8d752D588AaEEEda2a9BAB3abb662bCE459BbbD8,                                      //
        0x8d752D588AaEEEda2a9BAB3abb662bCE459BbbD8,                                      //
        0xDDD99afE969Df48e52109A289DABa51221fBFD46                                       //
    ];                                                                                   //
    // ********************************** END VARIABLES **********************************
