...
// File contracts/SHIBADICE.sol
pragma solidity ^0.8.0;

contract SHIBADICE is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBADICE";
    string private constant _symbol = "ShiDi";
