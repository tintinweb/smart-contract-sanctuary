...
/**
   ...
   Welcome to LittleDuckKing
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleDuckKingBSC
...
contract LittleDuckKing is Context, IERC20, Ownable {
    ...
    string private _name = "Little Duck King";
    string private _symbol = "LTDK";
