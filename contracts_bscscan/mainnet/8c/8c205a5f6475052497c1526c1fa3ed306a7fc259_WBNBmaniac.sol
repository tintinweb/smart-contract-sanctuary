...
Giving WBNB rewards like a f*in Maniac

t.me/flyingspaghettimonstercoin
...
contract WBNBmaniac is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WBNB Maniac";
    string constant _symbol = "WBNBmaniac";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(HM) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
