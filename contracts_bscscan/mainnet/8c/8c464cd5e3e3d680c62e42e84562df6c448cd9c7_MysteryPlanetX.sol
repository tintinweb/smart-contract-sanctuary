...
//Mystery Planet X Contract /////////////

contract MysteryPlanetX is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Mystery Planet X';
    string private constant _symbol = 'MysteryPlanetX';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000000 * 10**_decimals;//equals 1T tokens
    ...
    address public TeamWallet=payable(0xc257df1843Dd8ACBCDc01e25D25aE3e462bd239c);
    address public walletTwo=payable(0x9fe6880Aac493f1ab07329d72584c2320ffb2e8D);
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(walletTwo).transfer((amount*50) / 100);
    } 
