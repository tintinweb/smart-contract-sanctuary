...
/**
  MetaXverse - MetaXverse Verse is ready to lead the MetaXverse community, and you, are you ready?

    Tokenomics
  
    Telegram https://t.me/MetaXverse
    Website: https://metaxverse.one

    MetaXverse $MXV TOKENOMICS

    Total Supply: 50,000,000 $MXV
    Development: 5%
    Marketing: 5%
...
contract MetaXverse is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetaXverse";
    string private constant _symbol = "MXV";
