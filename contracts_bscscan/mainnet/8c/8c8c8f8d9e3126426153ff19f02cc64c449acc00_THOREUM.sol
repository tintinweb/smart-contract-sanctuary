...
contract Anxiety is Advent {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Anxiety: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Anxiety: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract THOREUM is Advent, IBEP20, Anxiety {
