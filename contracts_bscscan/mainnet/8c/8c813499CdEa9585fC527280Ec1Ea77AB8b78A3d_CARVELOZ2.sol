...
contract CARVELOZ2 is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 300000 * 10**_decimals;    // 30m - Initial max buy
    uint256 public _maxRxAmount = 100000 * 10**_decimals;    // 10m - Initial max sell
	uint256 public _maxWallet = 3000000 * 10**_decimals;     // 300m - Initial max Wallet	
    uint256 public numTokensToSwap = 100000 * 10**_decimals;
	uint public sellPerSecond = 20;
    ...
    string private constant _name = "CARVELOZ2 Token";
    string private constant _symbol = "CAR2";
...
//        IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
        ...
        marketingAddress = payable(0x1aD34dE6Bec350c48f24136f7ECd80A090Ce2A06);
