...
//Contract
contract MELONxRocket is IBEP20, Ownable {
    ...
    string private constant _name = 'MELONxRocket';  
    string private constant _symbol = 'MLNxR';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 10000000000 * 10**_decimals;
    ...
    uint8 private constant MaxWalletDivider=50; //2% = 200,000,000
    uint16 private constant SellLimitDivider=50; //2% = 200,000,000
    ...
    address public MainReward=0xF28709f1daa6CEE2847C5B9526ceba457331742b;   //MELONx Reward
