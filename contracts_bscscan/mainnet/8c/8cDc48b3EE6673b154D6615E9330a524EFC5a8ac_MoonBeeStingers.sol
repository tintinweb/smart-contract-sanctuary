...
contract Context {
 ...
 contract MoonBeeStingers is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "MoonBeeStingers";
    ...
    address private _MarketingWalletSYLOM = 0x5B176883C56c6f2A1fb5304e6Ea8A6D1fF42343B;
