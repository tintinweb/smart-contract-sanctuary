...
contract AGold is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x157b4e6dD0B7988AB19E891176Bb1ae84b1e1176;
    address public _developmentWalletAddress = 0x5AE6838602E017e6eC1c43634a2718E04Cf631f4;
    address public _ownerwallet = 0xd9fb47a9F9C6011bc5b2685cc9eD8F55BF98A9B7;
...
//        require(newAddress != address(uniswapV2Router), "BabyAnubis: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BabyAnubis: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BabyAnubis: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BabyAnubis: Automated market maker pair is already set to that value");
