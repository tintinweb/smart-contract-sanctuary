...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract MinMooner is Context , IERC20, Ownable {
    ...
    string private _name = "MinMooner";
    string private _symbol = "MinMooner";
    ...
    address public devWallet = 0x9EA3C01c1364Fbf701285A6F4ddd7E23e78eC488; //2% for marketing ,1% for giveaways
    ...
    uint256 public _maxTxAmount = 5 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9;
    uint256 public _maxWalletToken = 20 * 10**9;
