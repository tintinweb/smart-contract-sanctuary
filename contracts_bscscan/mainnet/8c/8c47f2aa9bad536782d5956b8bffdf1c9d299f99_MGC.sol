...
Website (https://themagicchart.com/)
Telegram (https://t.me/MagicChartBSC)
Twitter (http://twitter.com/Magic_Chart/)
Dev Channel (http://t.me/+dnTyEG-P7cFiNmNh)
*/
...
contract MGC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xe8fA2A6Ed266ea91F35BB11C2ffCEf6935E991Da); // Marketing Address
        
    address payable public buybackAddress =
        payable(0xe8fA2A6Ed266ea91F35BB11C2ffCEf6935E991Da); // BuyBack Address
        
    address payable public liquidityAddress =
        payable(0xe8fA2A6Ed266ea91F35BB11C2ffCEf6935E991Da); // Liquidity Address
    ...
    uint256 private constant _tTotal = 1000 * 1e6 * 1e4;
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xe8fA2A6Ed266ea91F35BB11C2ffCEf6935E991Da).call{value: bnbForDev}("");
