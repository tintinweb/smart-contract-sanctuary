...
//Just launched in MiniChowInu. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//MiniChowInu Hold we will To the moon
//telegram : @MiniChowInu
...
contract MiniChowInu is Context, IERC20, Ownable {
    ...
    string private _name = "MiniChowInu";
    string private _symbol = "MiniChowInu";
