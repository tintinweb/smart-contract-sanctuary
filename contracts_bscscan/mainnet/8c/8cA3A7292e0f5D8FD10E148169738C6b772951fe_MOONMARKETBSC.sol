...
/**
 * TELEGRAM: HTTPS://T.ME/MOONMARKETBSC
 * GREAT MARKETING 2% MARKETING BUDGET
 * REWARD
 * 9% CAKE REWARD - 4% LIQUIDITY - 1% MARKETING
 * TOKENOMICS
 * 50% BURN - 48% LIQUIDITY - 2% MARKETING WALLET
 * NO DEV WALLET
 * LIQUIDITY LOCKED USING DEEP LOCKER OR MUDRA LOCKER
*/
...
contract MOONMARKETBSC is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MOONMARKETBSC";
