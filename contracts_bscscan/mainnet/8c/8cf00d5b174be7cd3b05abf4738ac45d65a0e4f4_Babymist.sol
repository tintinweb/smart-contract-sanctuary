...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 MIST = IBEP20(0x68E374F856bF25468D365E539b700b648Bf94B67); 
  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    function deposit() external payable override {
        uint256 balanceBefore = MIST.balanceOf(address(this));
        ...
        uint256 amount = MIST.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MIST.transfer(shareholder, amount);
...
contract Babymist is IBEP20, Auth {
    using SafeMath for uint256;
  
 
     address MIST = 0x68E374F856bF25468D365E539b700b648Bf94B67;  
     address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyMIST";
    string constant _symbol = "BMIST";
