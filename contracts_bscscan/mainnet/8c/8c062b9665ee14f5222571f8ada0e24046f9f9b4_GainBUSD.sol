...
/**
Hold $GainBUSD and Earn BUSD!

Earn BUSD by holding our token $GainBUSD, our token earns you BUSD every time someone buys, sells or transfers their $GainBUSD token.

15% Busd reward claimable every 24 hours. Only for $GainBUSD Holders.
**/
...
contract GainBUSD is Context, IERC20, Ownable {
    ...
    string private _name = "Gain BUSD";
    string private _symbol = "$GAINBUSD";
