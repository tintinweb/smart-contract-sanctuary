...
BabyIronMan | Stealth launch | 10% $BUSD rewards

🔥 0.5 BNB initial LP
🔥 10% $BUSD Token rewards to holders
🔥 2% Buyback
🔥 2% to marketing and team wallets
🔥 1% to locked LP
🔥 LP Locked 100%
🔥 Max Tx Amount: 20,000,000,000,000

Telegram: BabyIronMan
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SM = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract BabyIronMan is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address SM = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    ...
    string constant _name = "BabyIronMan";
    string constant _symbol = "BIM";
...
//        emit Transfer(sender, recipient, amount);
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        if (sender != pair) require(amount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBReflection = amountBNB.mul(400).div(totalBNBFee);
        
        uint256 amountBNBMarketing = amountBNB.mul(500).div(totalBNBFee);
        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        
        uint256 amountBNBdev = amountBNB.mul(500).div(totalBNBFee);
        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        payable(0x81c914E9B6AA25C82c64Af36C15a6fB774F60D87).call{value: amountBNBdev, gas: 30000}("");
