...
contract BigCities is ERC721Enumerable, Ownable, Pausable  {
    ...
    */
    ...
    /**
    * @dev Mints 5 Big Cities for the price of 4
    */
     function mint5BCity() public payable whenNotPaused {
        uint256 numberOfCities = 5;
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
        require(totalSupply().add(numberOfCities) <= MAX_NFT_SUPPLY, "Exceeds MAX_NFT_SUPPLY");
        require(getNFTPrice().mul(numberOfCities - 1) == msg.value, "Ether value sent is not correct");
    ...
    /**
    * @dev Mints 15 Big Cities for the price of 12
    */
     function mint15BCity() public payable whenNotPaused {
        uint256 numberOfCities = 15;
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
        require(totalSupply().add(numberOfCities) <= MAX_NFT_SUPPLY, "Exceeds MAX_NFT_SUPPLY");
        require(getNFTPrice().mul(numberOfCities - 3) == msg.value, "Ether value sent is not correct");
