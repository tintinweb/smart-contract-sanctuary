...
1.Each round lasts for 1 week.

2.The launch and end date will be informed at least 1 day
before launch.

3.The liquidity pool will be locked simultaneously with the
opening of the trade. Our HyperBOT bot which is on
the official channel will inform you of the trade opening
as soon as possible, this can take up to 2 seconds, but
normally it is much faster.

4.Our official channel is on Telegram, and the URL is
https://t.me/hyperdeflationary

5.All contracts will be deflationary and supply tokens will
be burned in every transaction, this means that if
someone sells, the price per token will always be higher
than before the purchase. At the end of the round, the
final liquidity value will always be greater than the initial
one.

6.The community participates with ideas and also has the
right to vote on changes to upcoming contracts.

7. At the end of the contract, the TOP holder, excluding
the dev wallet and LP addresses, will win the liquidity
prize, we will publish the prize payment transaction in
the channel.

8.The liquidity prize will be calculated as follows: we
subtract the final liquidity by the initial liquidity, from
this result we subtract the values of the deploy rates,
pancake liquidity and LP lock, the prize is 50% of this
calculated value.

9.Each new contract may have changes in the behavior
of the token, these decisions will have active
community participation and will be informed in
advance.

10. We will never, EVER put mechanisms in the contract
