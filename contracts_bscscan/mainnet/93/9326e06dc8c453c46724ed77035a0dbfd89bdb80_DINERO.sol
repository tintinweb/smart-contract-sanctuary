...
DINERO is built upon the fundamentals of Buyback and increasing the investor's value
    
Main features are
    
1) 2% tax is collected and distributed to holders for HODLing
2) 15% buyback and marketing tax is collected and 3% of it is sent for marketing fund and othe 12% is used to buyback the tokens
...
contract DINERO is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x214af2e2F3639445a829668f6Da777bcBe1Fc0eB); // Marketing Address
    ...
    string private _name = "DINERO";
    string private _symbol = "DINERO";
