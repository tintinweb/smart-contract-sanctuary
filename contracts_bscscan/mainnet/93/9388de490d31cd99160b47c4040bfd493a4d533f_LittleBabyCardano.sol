...
/**
   ...
   Welcome to LittleBabyCardano
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyCardanoBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyCardano to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyCardano idea, increasing the liquidity pool automatically, 
...
contract LittleBabyCardano is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Cardano";
    string private _symbol = "LTBABYCARDANO";
