...
contract Ownable is Context {
    address private _owner = 0x74f0C2cAa92B07B244b0c8e5a6C06814699a62AD;
...
contract $SHIBXX is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "$SHIBXX"; // token name
    string private _symbol = "$SHIBXX"; // token symbol
	...
	uint256 private _transactionLockTime = 900; //Cool down time between each transaction per address
