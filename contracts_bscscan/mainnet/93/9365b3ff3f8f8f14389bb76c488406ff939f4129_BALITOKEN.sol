...
contract BALITOKEN is BALIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamBALI;
    address private CharityBALI;
    ...
    string public override name = "BALI TOKEN";
    string public override symbol = "BALI TOKEN";
    ...
    constructor(uint totalSupplyValue, address TeamBALIAddress, address CharityBALIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamBALI = TeamBALIAddress;
        CharityBALI = CharityBALIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamBALI] =  totalSupply * 45 / 100;
        balances[CharityBALI] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's TeamBALI pot
