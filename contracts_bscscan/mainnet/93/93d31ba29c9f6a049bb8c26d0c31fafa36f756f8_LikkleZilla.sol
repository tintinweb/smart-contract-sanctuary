...
contract LikkleZilla is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 2000000 * 10**3 * 10**18;
    uint256 public maxSellAmount = 100000000 * 10**3 * 10**18;
    uint256 public swapTokensAtAmount = 100 * 10**3 * 10**18;
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address private operationsAddress = 0xfBE7d2F32F98dB5d9a0969978bC307a268B97162;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "LikkleZilla";
    string private constant _symbol = "$LKLZ";
    ...
    function setFeeRates(uint256 _operations, uint256 _liquidity) external onlyOwner {
        feeRates.operations = _operations;
        feeRates.liquidity = _liquidity;
        emit FeesChanged();
    }

    function setSellFeeRates(uint256 _operations, uint256 _liquidity) external onlyOwner{
