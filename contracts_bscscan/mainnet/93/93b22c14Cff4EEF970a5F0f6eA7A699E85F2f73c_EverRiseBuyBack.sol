...
contract EverRiseBuyBack is Context, Ownable {
    ...
    string private _name = "EverRiseBuyBack";
    string private _symbol = "RISEBB1";


    IEverRise public token;
    
    constructor (address payable tokenAddr, address _router) {
		contractAddress = tokenAddr;
        token = IEverRise(contractAddress);
