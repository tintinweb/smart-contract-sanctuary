...
/**
Sponge bob Token
https://t.me/SpongeBobCoin
https://spongebob-token.com
 */
...
contract Spongebobtoken is IBEP20, Ownable {
    ...
    string private constant _name = "Sponge Bop";
    string private constant _symbol = "Spongebob";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 10000000000000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 10000000000000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 10000000000000000 * 10 ** 9;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 10000000000000000, "Can not reduce below 10K");
        require(maxSell > 10000000000000000, "Can not reduce below 10K");
