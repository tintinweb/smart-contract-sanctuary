...
- 4% 𝘼𝘿𝘿𝙀𝘿 𝙏𝙊 𝙏𝙃𝙀 𝙇𝙄𝙌𝙐𝙄𝘿𝙄𝙏𝙔 𝙋𝙊𝙊𝙇

- 1% 𝘼𝘿𝘿𝙀𝘿 𝙏𝙊 𝙏𝙃𝙀 𝙈𝘼𝙍𝙆𝙀𝙏𝙄𝙉𝙂 𝙒𝘼𝙇𝙇𝙀𝙏
...
contract Context {
 ...
 contract ShibaDab is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ShibaDab";
    string private _symbol = "SHIBADAB";
    ...
    address private _pancakeRouterAPE = 0xbBd553dcdb5021eA7458a854904c5fD7bedB54cB; // Ownership *Click on RenounceOwnership to lose permission of all functions
