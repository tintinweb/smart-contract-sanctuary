...
/**
🚀Cumlite Token🚀 - Excellent marketing plans | rug proof | 
he first LITECOIN reward project that can earn 12% LITECOIN
auto claim rewards every 60 minutes| easy 100x |
Low Market Cap Fair Launch on August 16 at 3pm UTC | based dev | early bird gets the wor


⚙️ TOKENOMICS ⚙️
🏦 100B Total supply
👝 12% LITECOIN auto claim every hour straight to your wallet
🎙 6% Marketing/LP Burn Buyback (marketing, 1 buyback, and 2% liquidity )
⌛️ Fair Launch -  August 16, 2021 3pm UTC
✅ No Dev Wallet
✅ Max buy/sell - 1%
✅ Max wallet - 3%

✅ TG : https://t.me/cumlitecoin
✅ https://t.me/cumlitechinese - Chinese group
✅ Twitter https://twitter.com/cumlitecoin
*/
...
contract CumLiteCoin is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10000 * 10**7 * 10**4; // 100B
    ...
    uint256 public _maxTxAmount = 10000 * 10**7 * 10**4; // 100T
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 10000 * 10**7 * 10**4; // 100B

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "CumLiteCoin";
    string private _symbol = "CLT";
    ...
    function _getAntiDumpMultiplier() private view returns (uint256) {
        ...
        uint256 hour = 60 * 60;
        if (time_since_start < 146 * hour) {
            return (8);
        } else if (time_since_start < 218 * hour) {
            return (5);
        } else if (time_since_start < 362 * hour) {
            return (3);
        } else if (time_since_start < 650 * hour) {
            return (2);
        } else {
            return (1);
        }
