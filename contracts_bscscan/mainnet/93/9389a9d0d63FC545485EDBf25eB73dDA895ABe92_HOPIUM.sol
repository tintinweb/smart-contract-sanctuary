...
/*
   ...
   10% buytax
   10% sell tax
Manifestation party for a greener crypto market
...
contract HOPIUM is IERC20, Ownable {
    ...
    uint256 public _tsxnCap = (_totalSupply * 50) / 1000;       // 1.5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 100) / 1000; // 3% of total supply
