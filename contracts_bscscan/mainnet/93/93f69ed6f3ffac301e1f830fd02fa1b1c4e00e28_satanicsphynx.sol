...
/**
 From the creator of firesphynx
 we've been to the moon
 
 
 Will SatanicSphynx be able to do that again?
...
contract satanicsphynx is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "satanicsphynx";
    string constant _symbol = "satanicsphynx";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xc2fbe6f5f571409CFA82e0353847eFBd888258b9;
