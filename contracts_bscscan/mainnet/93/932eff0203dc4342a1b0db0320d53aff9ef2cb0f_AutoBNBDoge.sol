...
/**
   ...
   Welcome to ChubbyDoge
   
   This is a community token. If you want to create a telegram I suggest to name it to @ChubbyDogeCommunity
...
contract AutoBNBDoge is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'ChubbyDoge';
    string  private constant _SYMBOL = 'CHUBBYDOGE';
