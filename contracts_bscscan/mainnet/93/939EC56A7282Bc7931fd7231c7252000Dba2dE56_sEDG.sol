...
contract sEDG is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sEDG", "sEDG", 9) ERC20Permit() {
    ...
    /**
        @notice increases sEDG supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sEDG
