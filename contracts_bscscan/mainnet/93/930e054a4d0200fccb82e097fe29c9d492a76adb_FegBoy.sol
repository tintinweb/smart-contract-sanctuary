...
/**
    FEGBOY on BSC for all the gorillas that wanted cheap transfers and swaps!
    ...
    I created a black hole so #FegBoy token will deflate itself in supply with every transaction
    50% Supply is burned at start.

    500,000,000,000,000 (0.5%) Max tx amount
...
contract FegBoy is Context, IERC20, Ownable {
    ...
    string private _name = "FegBoy";
    string private _symbol = "FEB";
    ...
    function _setMaxWalletSize(uint256 maxWalletSize) external onlyOwner() {
        require(maxWalletSize < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = maxWalletSize;
    }
}