...
/**
    This is a community token. So there is no official group, every owner must promote it, or create a group for it, if you want to leverage your investment, you need to make some effort.

        Liquidity LPs blocked forever

        Ownership will be waived to transfer this token to the community. 100% secure.
...
contract MiniBabyDogeCoin is Context, IERC20, Ownable {
