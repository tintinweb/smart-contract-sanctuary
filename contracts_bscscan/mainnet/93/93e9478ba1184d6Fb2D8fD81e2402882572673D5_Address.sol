...
//|) /||)| /\  /`|)\ /|)~|~/\|) /||)
//| /-||)|_\/  \,|\ | |  | \/|)/-||\
//Pablo Cryprobar Anonimity Coin (ALPHA)

//WHITEPAPER AND WEBSITE TO BE DEPLOYED - 01.12.21
//AIRDROPS FOR TOP 100 WALLETS - 01.12.21
// SPDX-License-Identifier: Unlicensed
...
contract BEP20Token is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xfF0e57DA63338159dF620c5363ABC2be77F24027); // Marketing Address
    ...
    string private _name = "PabloCryptobar";
