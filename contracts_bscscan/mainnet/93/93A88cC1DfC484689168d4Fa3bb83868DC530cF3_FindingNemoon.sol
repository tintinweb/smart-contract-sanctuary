...
https://t.me/findingnemoon

https://findingnemoon.com
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MATIC = IERC20(0xCC42724C6683B7E57334c4E856f4c9965ED682bD);
...
contract FindingNemoon is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Finding Nemoon";
    string constant _symbol = "NEMOON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 100,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1000; // 1% of Total Supply.
    uint256 public _maxWalletSize = (_totalSupply * 25) / 1000; // 2.5% of Total supply
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x52b972A3288D92EEE474a5cf4f0AA52A66D3f640);
