...
contract SpinAdaStakingContract {
    ...
    uint256[5] public Duration = [30 days, 60 days, 90 days, 180 days,365 days];
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        stakersRecord[msg.sender][index].plan = uint8(timeperiod);
        Stakers[msg.sender].stakeCount++;
        Stakers[msg.sender].stakedPerPlan[timeperiod] = Stakers[msg.sender].stakedPerPlan[timeperiod].add(amount);
        totalStakedPerPlan[timeperiod] = totalStakedPerPlan[timeperiod].add(amount);
    ...
    function unstake(uint256 index) public {
        ...
        Stakers[msg.sender].stakedPerPlan[stakersRecord[msg.sender][index].plan] = Stakers[msg.sender].stakedPerPlan[stakersRecord[msg.sender][index].plan].sub(stakersRecord[msg.sender][index].amount,"user stake");
        totalStakedPerPlan[stakersRecord[msg.sender][index].plan] = totalStakedPerPlan[stakersRecord[msg.sender][index].plan].sub(stakersRecord[msg.sender][index].amount,"total stake");
    ...
    function withdraw(uint256 index) public {
        ...
        Stakers[msg.sender].stakedPerPlan[stakersRecord[msg.sender][index].plan] = Stakers[msg.sender].stakedPerPlan[stakersRecord[msg.sender][index].plan].sub(stakersRecord[msg.sender][index].amount,"user stake");
        totalStakedPerPlan[stakersRecord[msg.sender][index].plan] = totalStakedPerPlan[index].sub(stakersRecord[msg.sender][stakersRecord[msg.sender][index].plan].amount,"total stake");
    ...
    function getUserStakedPerPlan(address user, uint8 plan) public view returns(uint256 amount){
        amount = Stakers[user].stakedPerPlan[plan];
    }
