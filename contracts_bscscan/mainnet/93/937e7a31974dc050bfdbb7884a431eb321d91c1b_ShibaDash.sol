...
contract ShibaDashDividendDistributor is IDividendDistributor {
...
contract ShibaDash is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaDash";
    string constant _symbol = "ShibaDash";
    uint8 constant _decimals = 9;

   uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; // 0.5% (Change after contract deployed)
    ...
    */
    ...
    ShibaDashDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new ShibaDashDividendDistributor(address(router), Shiba);
...
function switchRewardToken(address rewardToken) public onlyOwner {
        Shiba = rewardToken;
        distributor = new ShibaDashDividendDistributor(address(router), rewardToken);
    }	
