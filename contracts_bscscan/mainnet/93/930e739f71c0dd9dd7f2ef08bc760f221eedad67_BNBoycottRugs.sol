...
// BNBoycottRugs
// 6% Reards in WBNB for Holding BNBoycottRugs
// 4% marketing fee
// 2% liquidity fee
//SPDX-License-Identifier: MIT
    ...
    contract BNBoycottRugs is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "BNBoycottRugs";
        string constant _symbol = "BNBoycottRugs";
        ...
        uint256 charityFee = 200; // 1%
        uint256 totalFee = 1200; // 14%
