...
contract Sirio  is Context, IERC20, Ownable {
    ...
    event EnableTradeUpdated(bool enabled);
    ...
    function setEnableTrade(bool _enabled) public onlyOwner {
        EnableTrade = _enabled;
        emit EnableTradeUpdated(_enabled);
    }
