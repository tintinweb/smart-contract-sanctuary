...
contract BinaFarm is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    //Anti-Whale System
    uint256 public maxWalletTokens = 2250000; //1.5% of total supply

    //Anti-Bot Max Buy
    uint256 public maxBuyTranscationAmount = 500000;

    // Max Sell
    uint256 public maxSellTransactionAmount = 500000;
    ...
    address public _marketingWalletAddress = 0x570c952063b21D808855ea628ee55cDf0aC4CcbD;
    address public _developmentWalletAddress = 0x08dd6bcFD82CD063a5c92f82EC1e55fb46731A26;
    address public _ownerWallet = 0x4A5895cAf960E2B6199dEdef39918E84de511002;
    ...
    constructor() public ERC20("BinaFarm", "BinaF") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BinaFarm: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BinaFarm: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BinaFarm: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BinaFarm: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            swapAndSendToFee(_developmentWalletAddress, developmentTokens);
