...
TAKONS1   TOKEN MADE FOR MY FAVORITE COMMUNITY MEMBER !!!!!!
FOR TELEGRAM I SUGGEST TAKONSBSC
*/
...
contract TAKONS1 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public _maxTxAmount = 0.0075 * 10**9;
    uint256 public _maxWalletSize = 0.015 * 10**9;
