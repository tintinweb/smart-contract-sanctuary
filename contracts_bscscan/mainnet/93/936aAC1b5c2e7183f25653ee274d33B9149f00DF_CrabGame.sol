...
https://t.me/CrabGameBsc
STEALTH LAUNCH BY A SAFU TEAM 

 MAX TX 1%
 MAX WALLET 3%

BIG MARKETING PLANNED
*/
...
// CHANGE
contract CrabGame  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CrabGame";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 300,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x705CbA6475E205Ad97557A1B0ac9ba49Fe87B3f8); // Change
