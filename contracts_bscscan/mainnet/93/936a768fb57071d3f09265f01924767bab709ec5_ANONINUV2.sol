...
/* contacts let = "name ANONINUV2" id =1000000000 
getAmountOut(ANONINUV2)
...
// File: contracts\anoninuv2.sol

contract ANONINUV2 is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "ANON INU V2";
	string private constant _symbol = "ANON INU V2";
	...
	constructor (address routerAddress) {
		...
		setClaimRewardGasFeeOptions(_totalTokens / 10000, 1000000000);
