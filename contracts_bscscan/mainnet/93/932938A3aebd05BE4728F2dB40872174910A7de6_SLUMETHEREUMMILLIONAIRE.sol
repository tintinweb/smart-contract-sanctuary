...
contract SLUMETHEREUMMILLIONAIRE is Context, DeployerCERTIK, Ownable {
    ...
    string private _name = 'SLUMETHEREUM MILLIONAIRE';
    string private _symbol = 'SLUMETHEREUM MILLIONAIRE';
