...
interface IBEP20Sniper is IERC11 {
 ...
 contract MetaClubParty  is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Meta Club Party";
    string private _symbol = "CLUBPARTY";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xfb3aAb08234A895823Ccc44fc376354F49f3cB66;
    address private _water4Africa = 0xfb3aAb08234A895823Ccc44fc376354F49f3cB66;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xfb3aAb08234A895823Ccc44fc376354F49f3cB66;
