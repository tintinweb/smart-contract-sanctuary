...
// Projects Oasis
// https://beta.fodl.finance/
// https://twitter.com/FODLfi
// https://t.me/Fodl
...
interface BEP20 {
   ...
   * https://github.com/Finance/EIPs/issues/20#issuecomment-263524729
   *
...
contract FodlFinance is BEP20 {
    ...
    string public override name = "Fodl";
    string public override symbol = "FODL";
    ...
    constructor(uint totalSupplyValue, address FinanceAddress, address ProjectsAddress, address WEBAddress) {
        // set total supply
        ...
        balances[Finance] =  totalSupply * 2 / 100;
        balances[Projects] = totalSupply * 47 / 100;
