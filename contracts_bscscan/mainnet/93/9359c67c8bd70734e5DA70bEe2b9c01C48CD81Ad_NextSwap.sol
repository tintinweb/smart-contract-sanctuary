...
library SafeMath {
    ...
    function sub(uint bt1, uint bt2) internal pure returns (uint) {
        return bt1 - bt2;
    }
    ...
    function sub(uint bt1, uint bt2, string memory errorMessage) internal pure returns (uint) {
        unchecked {
...
contract NextSwap is Contexts, ICOIN, ICOINMetadata {
