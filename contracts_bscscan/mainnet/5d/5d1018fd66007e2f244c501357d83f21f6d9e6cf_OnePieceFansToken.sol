...
import "./OnePieceFansTokenDividendPayingToken.sol";

/**
-One Piece  Apps
Our community will create an app where users can have access to update on the latest released artworks

We have big ambitions with this project, but the Token Community that we all nakama will have a voice and a voice to contribute new ideas to this project as we reach new goals including 1 Million Market Cap, List ourselves on Coin Gecko

💰Total Supply: 1,000,000,000,000 

🏴‍☠️40% Added to Pancakeswap liquidity 
🏴‍☠️50% burn
🏴‍☠️10% Tokenomics

💵 Tokenomics:
🏴‍☠️ 3% Back to locked LP
🏴‍☠️ 3% Distributed to all NAKAMA HOLDERS
🏴‍☠️ 4% Marketing Team

🌐 Connect with us: 
Telegram:https://t.me/OnePieceFansToken

*/
contract OnePieceFansToken is ERC20, Ownable {
    using SafeMath for uint256;

    IPancakeSwapV2Router02 public PancakeSwapV2Router;
    address public immutable PancakeSwapV2Pair;

    address public immutable BANANA = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // BNB
    ...
    uint256 private _FeeFactor = 1000000000000  * (10**18); 
    ...
    constructor() ERC20("OnePieceFansToken", "OPFT") {
