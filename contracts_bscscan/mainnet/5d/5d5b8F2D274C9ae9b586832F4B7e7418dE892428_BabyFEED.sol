...
Welcome to BabyFEED
   This is a community token. If you want to create a telegram I suggest to name it to @BabyFEED
   ...
   I will renounce the ownership to burn addresses to transfer #BabyFEED to the community, make sure it's 100% safe.
   I will add 0.3 BNB and all the left All (100%) total supply to the pool
   Can you make #BabyFEED 10000X? 
   ...
   it's the best part of the #BabyFEED idea, increasing the liquidity pool automatically, 
...
contract BabyFEED is Context, IERC20, Ownable {
    ...
    string private   _name = "BabyFEED";
    string private _symbol = "BabyFEED";
