...
/*
   ...
   3% fee auto add to charity wallet for DEVELOPMENT/ charities
   2% fee auto distribute to all holders
   1% Supply is burned at start.
...
contract MEATPIE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8000 * 10**5 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Meat Pie";
    string private _symbol = "MEATPIE";
    ...
    uint256 public _maxTxAmount = 8000 * 10**5 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 80 * 10**5 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> MEATPIE swap when swap+liquify is triggered
