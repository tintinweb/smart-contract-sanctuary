...
contract SurfDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 21 * 10 ** 10 * 10 ** 18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SurfDoge";
    string private _symbol = "SurfDoge";
    ...
    uint256 public _maxTxAmount = 21 * 10 ** 10 * 10 ** 18;
