...
CREEPY COIN, disrupting Defi and the financial payment transactions 
...
contract CREEPY is DeflationaryERC20 {

    constructor() DeflationaryERC20("BNB", "CREEPY") {

        _mint(msg.sender, 10000000000009e18);  
    }
