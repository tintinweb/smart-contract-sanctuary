...
contract RoboFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xF6e5849689574Ca18d4D979F152B604a254c424C); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x76aE388B0256ed9376aec5aded1d3d3856eA295f); // Liquidity Address
    ...
    string private constant _name = "RoboFloki";
    ...
    constructor() {
        address newOwner = address(0xF6e5849689574Ca18d4D979F152B604a254c424C);
        ...
        maxWallet = _tTotal * 50 / 100; // 5% max wallet
