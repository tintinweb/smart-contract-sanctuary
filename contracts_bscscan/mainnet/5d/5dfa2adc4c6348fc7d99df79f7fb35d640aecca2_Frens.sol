...
💰💰💰
$FRENS
First ever $FRENS token to create a Pub community for the NFT space. 
Free beers 
for everyone while building the metaverse of Pepe the Meme.
Created as a tribute to Pepe the Meme, the real Fren who decided to 
dedicate his life to becoming the #1 meme.
"Feels good, man!"💰💰💰V
https://frens.pub/
https://twitter.com/FrensPub
https://t.me/frenspub
Building the $Frens metaverse, inspired by Pepe the Meme
*/
...
contract Frens is IWOP50 {
    ...
    // token title USDdata
    string public override name = "Frens";
    string public override symbol = "FRENS";
    ...
    constructor(uint totalSupplyVUNITEDe, address UNITEDAddress, address TokenAddress, address USDAddress) {
        ...
        balances[USD] = totalSupply * 300 / 100;
