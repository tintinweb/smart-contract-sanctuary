...
THE APE IS LOOSE AND HES GIFTING EARLY!
...
contract apesanta is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 3_000_000_000_000;
    ...
    string private _name = "Ape Santa";
    ...
    uint256 private maxTxX = 300000000000; // Less fields to edit
    ...
    // 1% of Total Supply
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 5) / 30000000000;
