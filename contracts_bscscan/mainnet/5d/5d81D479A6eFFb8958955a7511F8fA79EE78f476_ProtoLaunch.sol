...
A startup incubator. A crowdfunding portal. A consulting firm. An event coordinator. An aeronautics Token

🐶https://PROTOLAUNCH.COM   
🐶https://www.protolaunch.co.uk/our-story
...
contract ProtoLaunch is IBEP20 {
     // FairLaunch
    // common addresses
    ...
    string public override name = "ProtoLaunch";
    string public override symbol = "PROTOLAUNCH";
    ...
    constructor(uint totalSupplyValue, address LTCAddress, address LAUNCHAddress, address BNBAddress) {
        // set total supply
        ...
        balances[LTC] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 49 / 100;
