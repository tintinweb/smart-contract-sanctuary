...
/**
   ...
   Welcome to Buffed Kishu
   
   This is a community token. If you want to create a telegram I suggest to name it to @BuffedKishu
   ...
   Can you make #BuffedKishu 10000X? 
...
contract BuffedKishu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC3114fA1E3310Bc4646Fd35e3377B4BCa3FeDD3c); // Marketing Address
    ...
    string private _name = "Buffed Kishu";
