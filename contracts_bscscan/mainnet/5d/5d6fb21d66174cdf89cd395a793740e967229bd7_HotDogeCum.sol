...
Easy 100x with this token, FOMO time.
This doge cum is very hot, cum to the mooon
Lets join $HOTDOGCUM

Stealth Launch ~ t.me/hotdogcum
...
contract HotDogeCum is Context, IERC20, Owwnable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x61e2F2FA42D38aC19d07f4b7eC8D43d8Efa62b2e); // Marketing Address
    ...
    string private _name = "HotDogeCum";
    string private _symbol = "$HOTDOGCUM";
