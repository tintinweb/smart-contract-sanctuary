...
//Richest Doge aims to deliver a project with a real and proper use case and utility that will be voted on by the loyal and strong community.


//Telegram: https://t.me/RichestDogeOfficial
//Twitter : https://twitter.com/RichestDoge
//Website : https://www.richestdoge.c
...
contract RichestDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Richest Doge";
    ...
    uint256 public swapThreshold = _totalSupply / 100000; // 10%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x71Bcc925094b9141438D78490C6F8BaDc8c2079b;
