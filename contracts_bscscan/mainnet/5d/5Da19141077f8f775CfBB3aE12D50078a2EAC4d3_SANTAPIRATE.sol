...
/**
*
*JOIN IN OUR GROUPS AND SPREAD THE GEM
*
*WE ARE AT THE BEGINNING 
*
*NO MOON BUT MARS IS COMING
*
*BUY AND HOLD FOR YOUR FUTURE
*
*PUMP PUMP PUMP PUMP
...
contract SANTAPIRATE is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "SANTA PIRATE";
    ...
    address payable private _marketingAddress = payable(0x3e46f2928B4677D336737f853E5FE47cA7D4f6Eb);
    ...
    uint public _swapTokensAtAmount = 1000000000000000000 * 10**9;
