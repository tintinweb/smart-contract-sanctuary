...
/**
   ...
   No telegram group if u want to create telegram group i suggest to name it to @megamanbsc
   ...
   I will renounce the ownership to burn addresses to transfer #Megaman to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #Megaman 10000X? 
   ...
   it's the best part of the #HyperCoin idea, increasing the liquidity pool automatically, 
 ...
 */
 ...
 contract MegaMan is Context, ERC20, ERC20Metadata {
