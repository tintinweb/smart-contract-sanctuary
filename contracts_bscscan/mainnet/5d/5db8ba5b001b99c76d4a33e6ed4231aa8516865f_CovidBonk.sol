...
contract CovidBonk is Context, IERC20, Ownable {
    ...
    string private constant _name = "CovidBonk";
    string private constant _symbol = "CBK";
    ...
    address payable public charityAddress = payable(0x27003f30Ceb40B7E2bECdbAE2715878493c82559);
