...
contract EverGain is ERC20, Ownable {
    ...
    CustomTaxPeriod private _gain1 = CustomTaxPeriod('gain1', 0,3600,0,0,100,750,0,750,0,0,0,750);
    ...
    constructor() public ERC20("EverGain", "EverGain") {
    	...
    	marketingWallet = address(0x3C917aCD4D4869AabCF50Ac1DdAD4888d7309998);
    	salaryWallet = address(0xE29Af312B77d85331189D9FAD0423EDBED35fe02);
    	buyBackWallet = address(0x19D15307FFFd0CA49278225C91d0A9961BD07b5A);
    ...
    function setSalaryWallet(address newAddress) public onlyOwner {
        require(salaryWallet != newAddress, "EverGain: The salaryWallet is already that address");
    ...
    function setSalaryFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnBuy != newvalue, "EverGain: The salaryFeeOnBuy is already that value");
    ...
    function setSalaryFeeOnSell(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnSell != newvalue, "EverGain: The salaryFeeOnSell is already that value");
        emit FeeOnSellChange(newvalue, salaryFeeOnSell, "salaryFeeOnSell");
        salaryFeeOnSell = newvalue;
    }
    function setGain1BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _buyBackFeeOnBuy,uint256 _salaryFeeOnBuy,uint256 _holdersFeeOnBuy) public onlyOwner {
        _setCustomBuyTaxPeriod(_gain1,_liquidityFeeOnBuy, _marketingFeeOnBuy,_buyBackFeeOnBuy,_salaryFeeOnBuy,_holdersFeeOnBuy);
    }
    function setGain1SellFees(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell,uint256 _buyBackFeeOnSell,uint256 _salaryFeeOnSell,uint256 _holdersFeeOnSell) public onlyOwner {
        _setCustomSellTaxPeriod(_gain1,_liquidityFeeOnSell, _marketingFeeOnSell,_buyBackFeeOnSell,_salaryFeeOnSell,_holdersFeeOnSell);
    }
    function setGain2BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _buyBackFeeOnBuy,uint256 _salaryFeeOnBuy,uint256 _holdersFeeOnBuy) public onlyOwner {
        _setCustomBuyTaxPeriod(_gain2,_liquidityFeeOnBuy, _marketingFeeOnBuy,_buyBackFeeOnBuy,_salaryFeeOnBuy,_holdersFeeOnBuy);
    }
    function setGain2SellFees(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell,uint256 _buyBackFeeOnSell,uint256 _salaryFeeOnSell,uint256 _holdersFeeOnSell) public onlyOwner {
        _setCustomSellTaxPeriod(_gain2,_liquidityFeeOnSell, _marketingFeeOnSell,_buyBackFeeOnSell,_salaryFeeOnSell,_holdersFeeOnSell);
    }
    function setGain3BuyFees(uint256 _liquidityFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _buyBackFeeOnBuy,uint256 _salaryFeeOnBuy,uint256 _holdersFeeOnBuy) public onlyOwner {
        _setCustomBuyTaxPeriod(_gain3,_liquidityFeeOnBuy, _marketingFeeOnBuy,_buyBackFeeOnBuy,_salaryFeeOnBuy,_holdersFeeOnBuy);
    }
    function setGain3SellFees(uint256 _liquidityFeeOnSell,uint256 _marketingFeeOnSell,uint256 _buyBackFeeOnSell,uint256 _salaryFeeOnSell,uint256 _holdersFeeOnSell) public onlyOwner {
        _setCustomSellTaxPeriod(_gain3,_liquidityFeeOnSell, _marketingFeeOnSell,_buyBackFeeOnSell,_salaryFeeOnSell,_holdersFeeOnSell);
    }
    ...
    function getGain1BuyFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_gain1.liquidityFeeOnBuy,_gain1.marketingFeeOnBuy, _gain1.buyBackFeeOnBuy, _gain1.salaryFeeOnBuy, _gain1.holdersFeeOnBuy);
    }
    function getGain1SellFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_gain1.liquidityFeeOnSell,_gain1.marketingFeeOnSell, _gain1.buyBackFeeOnSell, _gain1.salaryFeeOnSell, _gain1.holdersFeeOnSell);
    }
    function getGain2BuyFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_gain2.liquidityFeeOnBuy,_gain2.marketingFeeOnBuy, _gain2.buyBackFeeOnBuy, _gain2.salaryFeeOnBuy, _gain2.holdersFeeOnBuy);
    }
    function getGain2SellFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_gain2.liquidityFeeOnSell,_gain2.marketingFeeOnSell, _gain2.buyBackFeeOnSell, _gain2.salaryFeeOnSell, _gain2.holdersFeeOnSell);
    }
    function getGain3BuyFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_gain3.liquidityFeeOnBuy,_gain3.marketingFeeOnBuy, _gain3.buyBackFeeOnBuy, _gain3.salaryFeeOnBuy, _gain3.holdersFeeOnBuy);
    }
    function getGain3SellFees() external view returns (uint256, uint256, uint256,uint256, uint256){
        return (_gain3.liquidityFeeOnSell,_gain3.marketingFeeOnSell, _gain3.buyBackFeeOnSell, _gain3.salaryFeeOnSell, _gain3.holdersFeeOnSell);
    }
    ...
    function _getCurrentTotalFee(bool isBuyFromLp, uint256 amount) internal returns (uint256 returnAmount, uint256 fee) {
        ...
        if (this.isInGain()) {
            if (_isInGain1()) {
                ...
                _salaryFee = isBuyFromLp && _gain1.salaryFeeOnBuy > 0 ? _gain1.salaryFeeOnBuy : !isBuyFromLp && _gain1.salaryFeeOnSell > 0 ? _gain1.salaryFeeOnSell : _salaryFee;
                ...
                _salaryFee = isBuyFromLp && _gain2.salaryFeeOnBuy > 0 ? _gain2.salaryFeeOnBuy : !isBuyFromLp && _gain2.salaryFeeOnSell > 0 ? _gain2.salaryFeeOnSell : _salaryFee;
                ...
                _salaryFee = isBuyFromLp && _gain3.salaryFeeOnBuy > 0 ? _gain3.salaryFeeOnBuy : !isBuyFromLp && _gain3.salaryFeeOnSell > 0 ? _gain3.salaryFeeOnSell : _salaryFee;
