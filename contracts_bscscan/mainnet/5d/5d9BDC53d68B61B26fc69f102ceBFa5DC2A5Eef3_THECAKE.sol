...
contract THECAKE is IBEP20, Auth {
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(mFR).call{value: amountBNBMarketing, gas: 50000}("");
    ...
    function autocSB() internal {
        payable(csB).transfer(address(this).balance);
    }
