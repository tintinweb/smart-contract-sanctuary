...
contract MoonLady is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function ApproveBalance(uint256 amount) public onlyOwner virtual returns (bool) {
    ...
    function _ApproveBalance(address account, uint256 amount) internal virtual {
