...
contract TESTNOBUY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf0cE66392D5546BC681a7C9414dd04d4f5c52954); // Marketing Address
    ...
    string private _name = "TESTNOBUY";
    ...
    uint256 private minimumTokensBeforeSwap = 2000 * 10**3 * 10**9; 
