...
contract TestCoinFinance  {

	using SafeMath for uint256;
	iTestCoin PlatformTokenApp;
	...
	constructor( iTestCoin _TestCoin, pancakeInterface _pancakeRouter, address[] memory _path ) public { 	
	// TBA params testnet: iTestCoin (no quotes), 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 (no quotes), ["0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd", "iTestCoin"]
	// TBA params mainnet: iTestCoin (no quotes), 0x10ED43C718714eb63d5aA57B78B54704E256024E (no quotes), ["0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c", "iTestCoin"] 
	// (array elements in double qotes)
		
		platformAddress=msg.sender;	
		PlatformTokenApp = _TestCoin;
		...
		if (getChainID() == 56) { // TBA mainnet
			...
			NATIVE_DECIMALS = 14; // remove this set
...
/*
	...
	function withdraw(uint256 reinvestOption, uint256 wPercent) public {
		...
		if (reinvestOption==0) {			
			...
			require(tokenBalanceFactor>=1,"rihold"); // 0.1 bnb worth TESTs to hold
