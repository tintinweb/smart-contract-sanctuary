...
contract BopCoin is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "BopCoin";
    string public _symbol= "BOP";
     bool balances1 = true;

    address payable public buybackAddress = payable(0x3bFcfdb39ED9539fe6641AF06BFB7A8254C8948C); // Marketing Address
    uint256 public buybackPercent = 0; 
    
    address public immutable burnAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public burnPercent = 0; 
    
    uint256 public marketingPercent;
    uint256 public redistributionPercent;
    uint256 public burnAmount;
    
    function SetBuyBackAddress(address payable  _buybackAddress) onlyOwner public {
        buybackAddress = _buybackAddress;
    }
    
    function SetBuyBackPercent(uint256 _buybackPercent) onlyOwner public {
    ...
    function SetRedistributionPercent(uint256 _redistributionPercent) onlyOwner public {
        redistributionPercent = _redistributionPercent;
    }
    ...
    function changeOwner(address _owner) onlyOwner public {
     ...
     function SetRedistributionAddress(address account) onlyOwner public {
    ...
    function _transfer(
        ...
        uint256 buybackAmount = amount * buybackPercent / 100; 
        require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            _balances[sender] = senderBalance - amount;
        }
        amount =  amount - buybackAmount - burnAmount;
        _balances[recipient] += amount;
        emit Transfer(sender, recipient, amount);
        
         if (buybackPercent > 0){
          
           _balances[recipient] += buybackAmount;
