...
//NEW YEARS DEGEN GIVEAWAY 2022
//   TELEGRAM: https://t.me/NewYearsDEGEN
//Degen Play for the Degenerates WITH A GIVEAWAY ON NEW YEARS
...
contract NYDG is IBEP20, Auth {
    ...
    address MRKT = 0xe455Ed767A0E22eFcf826Ad8A196FFFE06adB546;

    string constant _name = "New Years DEGEN Giveaway";
    string constant _symbol = "NYDG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 10 )  / 200;
    ...
    uint256 public totalFee = 0; //Total Fee
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = MRKT;
        teamFeeReceiver = MRKT;
        giveawayFeeReceiver = MRKT;
