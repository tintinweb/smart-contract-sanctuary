...
/**
   ...
   Welcome to INDIANRAPTORS
   
   This is a community token. If you want to create a telegram I suggest to name it to @INDIANRAPTORSBSC
   ...
   I will renounce the ownership to burn addresses to transfer #INDIANRAPTORS to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #INDIANRAPTORS 10000X? 
   ...
   it's the best part of the #INDIANRAPTORS idea, increasing the liquidity pool automatically, 
...
contract INDIANRAPTORS is Context, IERC20, Ownable {
    ...
    string private _name = "INDIANRAPTORS";
    string private _symbol = "RAPTORS";
