...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 100_000_000 * 10**9; // must hold 1 billion tokens which equates to 0.01% of the total NenmoDogeCoin supply
  }
...
// File: contracts/INenmoDogeCoin.sol
...
interface INenmoDogeCoin is IERC20, IERC20Metadata {
...
// File: contracts/NenmoDogeCoin.sol
  ...
  ReentrancyGuard
{
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'NenmoDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'NenmoDoge: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'NenmoDogeCoin: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      'NenmoDogeCoin: The new dividend tracker must be owned by the token contract'
    );
