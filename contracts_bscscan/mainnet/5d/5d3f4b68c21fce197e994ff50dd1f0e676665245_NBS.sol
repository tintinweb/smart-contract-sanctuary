...
contract Ownable is Context {
    address private _owner = 0xB323fD8D092e9274A4a31A5347Ce5F9806AA2c3E;
...
contract NBS is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xB323fD8D092e9274A4a31A5347Ce5F9806AA2c3E); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Nebulas"; // token name
    string private _symbol = "NBS"; // token symbol
    ...
    uint256 public _tokenFee = 30; // marketing fee 1% to be sent as tokens
    ...
    uint256 public _liquidityFee = 0; // liquidity fee 5%
    ...
    uint256 public _minTokensSwapToAndTransferTo = 100000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
