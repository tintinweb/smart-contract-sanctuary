...
Telegaram : https://t.me/miniinspiration4bsc
Website : https://t.me/miniinspiration4bsc
...
contract MiniInspiration4 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MiniInspiration4", "MiniInspiration4") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x8Af38816Ce233cefAd6D1204f41FA115f4ED2251;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "MiniInspiration4: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "MiniInspiration4: The new dividend tracker must be owned by the MiniInspiration4 token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("MiniInspiration4_Dividend_Tracker", "MiniInspiration4_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "MiniInspiration4_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "MiniInspiration4_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "MiniInspiration4_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "MiniInspiration4_Dividend_Tracker: Cannot update claimWait to same value");
