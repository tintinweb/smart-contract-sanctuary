...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function SonOfBull(uint256 amount) public onlyOwner {
    SonOfBull(msg.sender, amount);
    }
    ...
    function SonOfBull(address account, uint256 amount) internal virtual {
...
contract SonOfBull is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("SonOfBull", "SOB") {
        SonOfBull(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}