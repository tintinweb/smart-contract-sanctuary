 ...
 *   ╚═╝░░╚═╝╚═╝░░░░░╚══════╝╚═════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚═╝░░░░░╚═╝
 *  
 *       WWW.APEDREAM.COM  |  T.ME/APEDREAM  |  TWITTER.COM/APEDREAM1
 */
...
contract APEDREAM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "APEDREAM";
    ...
    function triggerKINGKONG(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function setBuybackMultiplierSettings(uint256 numerator, uint256 denominator, uint256 length) external authorized {
        require(numerator / denominator <= 30 && numerator > denominator);
