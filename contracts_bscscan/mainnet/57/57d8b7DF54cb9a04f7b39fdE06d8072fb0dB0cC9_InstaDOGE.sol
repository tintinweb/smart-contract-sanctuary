...
/*
InstaDOGE
InstaDOGE 𝖙𝖔𝖐𝖊𝖓 𝖜𝖍𝖊𝖗𝖊 DOGE 𝖛𝖑𝖔𝖌𝖘 𝕹𝕱𝕿 𝖂𝖔𝖗𝖙𝖍

    Is InstaDOGE safe?
    Liquidity lock at start ☑️
    Renouncing at start ☑️

    Telegram: https://t.me/InstaDOGE
    Website: https://www.InstaDOGE.io/
    Twitter: https://twitter.com/InstaDOGE
*/
...
contract PINKSALES is ANTIBOT {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "PINKSALES: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "PINKSALES: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract InstaDOGE is ANTIBOT, IBEP20, PINKSALES {
    ...
    uint256 private constant _allTotalSupply = 1000000000000000000000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'InstaDOGE';
    string private _symbol = 'INSTADOGE';
