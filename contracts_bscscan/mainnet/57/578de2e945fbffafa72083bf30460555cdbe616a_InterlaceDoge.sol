...
/**
   ...
   I make this #InterlaceDoge to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/InterlaceDogeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #InterlaceDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #InterlaceDoge 1000X? 
...
contract InterlaceDoge
 is Context, IERC20, Ownable {
    ...
    string private _name = "Interlace Doge";
    string private _symbol = "InterDOGE";
