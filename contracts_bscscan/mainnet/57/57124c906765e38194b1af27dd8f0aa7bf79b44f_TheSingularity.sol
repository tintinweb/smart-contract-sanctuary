...
//
// Telegram: @TheSingularityToken
//
// ✨The Singularity is $ONE ✨
//
// Everybody can own a part of the singularity but nobody can own it whole. 
// Our goal with this project is to make The Singularity the most expensive token in the world. 
// The total supply is only one token and when you invest you will own a piece of it. 
// The more hodlers the higher the price of the singularity will be.
//
// Join us in making money and history. Enter The Singularity. 
//
// 💥Ticker: $ONE
// 💥Supply: 1
// 💥Starting liquidity: 2 BNB
//
...
contract TheSingularity is Context, IBEP20, Ownable {
    ...
    string private _name = "The Singularity Token";
    ...
    uint256 public _intervalSecondsForSwap = 1 * 1 seconds;
    ...
    address payable public buybackAddress = payable(0xC9cC1F1f54Dd141E9C3C84D056b2F309B9e603f4);
    address payable public lpAddress = payable(0xC9cC1F1f54Dd141E9C3C84D056b2F309B9e603f4);
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 100, "tax too high");
        _taxFee = taxFee;
    }
        
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee < 100, "tax too high");
