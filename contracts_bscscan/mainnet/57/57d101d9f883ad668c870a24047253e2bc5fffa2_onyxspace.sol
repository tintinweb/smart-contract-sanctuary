...
// Cake Rewards  
// Telegram: https://t.me/Onyxspacecake
// Website : https://wwww.onyxspace.com (Under Development)
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also onyxspaceed.
...
// File: contracts/onyxspaceDividendPayingToken.sol
...
contract onyxspace is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    onyxspaceDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("onyxspace", "onyxspace") {
        ...
        dividendTracker = new onyxspaceDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "onyxspace: The dividend tracker already has that address");

        onyxspaceDividendTracker newDividendTracker = onyxspaceDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "onyxspace: The new dividend tracker must be owned by the onyxspace token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "onyxspace: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "onyxspace: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "onyxspace: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "onyxspace: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "onyxspace: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "onyxspace: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "onyxspaceBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "onyxspace: This account cannot send tokens until trading is enabled");
        }
...
contract onyxspaceDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("onyxspace_Dividend_Tracker", "onyxspace_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "onyxspace_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "onyxspace_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main onyxspace contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "onyxspace_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "onyxspace_Dividend_Tracker: Cannot update claimWait to same value");
