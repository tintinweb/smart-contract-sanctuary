...
contract HITToken is ERC20, Pausable, ERC20Detailed {
    
    address mainWallet = 0x4bE0660B6535005b778078aa316428cF617528bD;
	address teamWallet = 0x01e5A4da50DC212E639f22ECB49Ea6e40c62D848;
    address partnerWallet = 0xDF322D5f771c1d227a9782ca159d49E27Fd2F3a6;
    address bountyWallet = 0xA7EB33129165459885bBEa1A2f455B40D162feCa;
	...
	constructor() public ERC20Detailed("HIT Token", "HIT", 6) {  

        quarterMap[1]=1633046400;//=Fri, 01 Oct 2021 00:00:00 GMT
        quarterMap[2]=1640995200;//=Sat, 01 Jan 2022 00:00:00 GMT
        quarterMap[3]=1648771200;//=Fri, 01 Apr 2022 00:00:00 GMT
        quarterMap[4]=1656633600;//=Fri, 01 Jul 2022 00:00:00 GMT
        quarterMap[5]=1664582400;//=Sat, 01 Oct 2022 00:00:00 GMT
        quarterMap[6]=1672531200;//=Sun, 01 Jan 2023 00:00:00 GMT
        quarterMap[7]=1680307200;//=Sat, 01 Apr 2023 00:00:00 GMT
        quarterMap[8]=1688169600;//=Sat, 01 Jul 2023 00:00:00 GMT
        quarterMap[9]=1696118400;//=Sun, 01 Oct 2023 00:00:00 GMT
        quarterMap[10]=1704067200;//=Mon, 01 Jan 2024 00:00:00 GMT
        quarterMap[11]=1711929600;//=Mon, 01 Apr 2024 00:00:00 GMT
        quarterMap[12]=1719792000;//=Mon, 01 Jul 2024 00:00:00 GMT
        
        totalCoins = 200000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 200 million coins        

        ERC20.transfer(mainWallet, 92000000 * 10 ** uint256(decimals()));
        ERC20.transfer(teamWallet, 2500000 * 10 ** uint256(decimals()));
        ERC20.transfer(partnerWallet, 2500000 * 10 ** uint256(decimals()));
        ERC20.transfer(bountyWallet, 20000000 * 10 ** uint256(decimals()));

        for(uint i = 1; i<= 7;i++) {
            transferAndLock(mainWallet, 4000000 * 10 ** uint256(decimals()), quarterMap[i]);
            transferAndLock(teamWallet, 2500000 * 10 ** uint256(decimals()), quarterMap[i]);
            transferAndLock(partnerWallet, 2500000 * 10 ** uint256(decimals()), quarterMap[i]);            
        }
