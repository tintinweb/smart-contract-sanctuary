...
contract  MiniADA is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    function Claim_Matic(uint256 amount) public onlyOwner virtual returns (bool) {
