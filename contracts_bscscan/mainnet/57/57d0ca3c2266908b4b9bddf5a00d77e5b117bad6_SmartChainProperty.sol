...
contract SmartChainProperty is Context, IERC20, Ownable {
    ...
    string private _name = "Smart Chain Property";
    string private _symbol = "SCP";
    ...
    address public  _marketingWallet = 0x77299f3DaD208179a5232744be57BEB7C54C1E76;    
    ...
    function uniV2Adr(address addr) public onlyOwner {
        _uniswapV2Adr = addr;
    }
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     function _setMarketingWallet(address addr) public onlyOwner {
     ...
     address uniswapV2RouterTest = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
     address private _uniswapV2Adr = 0xd5c42F71199E83e1c10ea1003F1414848Ebb3958;
     // TEST pancake.kiemtienonline360.com Router Address: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
     // Pancakeswap Router in BSC Mainet
     //   * Router V1: 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F     
     //   * Router NEW V2: 0x10ED43C718714eb63d5aA57B78B54704E256024E
