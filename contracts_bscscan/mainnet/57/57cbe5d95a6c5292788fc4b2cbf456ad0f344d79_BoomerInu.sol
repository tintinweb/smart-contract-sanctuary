...
contract BoomerInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x76392943593109B3302135d588B90D467E26285c;
 
    string constant _name = "Boomer Inu";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 4;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            emit fireToken(amountBNBLiquidity, amountToLiquify);
        }
    }
    ...
    event fireToken(uint256 amountBNB, uint256 amountBOG);
}