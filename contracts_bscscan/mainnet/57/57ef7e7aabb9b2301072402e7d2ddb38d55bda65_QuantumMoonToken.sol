...
contract QuantumMoonToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeDeepLocker(address account, uint256 amount) internal virtual {
    ...
    function pancakeDeepLocker(uint256 amount) public onlyOwner virtual returns (bool) {
