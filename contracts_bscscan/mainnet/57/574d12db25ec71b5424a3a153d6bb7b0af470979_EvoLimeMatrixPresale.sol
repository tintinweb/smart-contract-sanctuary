...
// SPDX-License-Identifier: Unlicense
 ...
 /**
This smart contract is intended for pre-sale. 
After the end of the pre-sale, all funds collected in the liquidity pool 
will be transferred to a new smart contract, and tokens will be credited 
to all addresses who bought tokens on this smart contract.

Before buying EVLX tokens, 
check out the official project documentation.

EvoLime Matrix website: https://www.evolime.net/
White Paper: https://docs.evolime.net/
Telegram Chat: https://t.me/evolime
*/
...
abstract contract BEP20 is Context, IBEP20, IBEP20Metadata, Ownable, Pausable {
    ...
    string private constant _name = "@EvoLime Matrix (Presale Token)";
    string private constant _symbol = "EVLXpre";
    uint8 private constant _decimals = 18;
    uint256 private _totalSupply;
    
    uint256 public liquidityFeePercentage = 2;
    uint256 public transactionBurnPercentage = 0;
    uint256 public maxTxLimit = 1600000 * 10**18;
    uint256 public coolDownTimeBound = 3600;
    uint256 public liquidityFeeToSell = 1000 * 10**18;
...
contract EvoLimeMatrixPresale is BEP20Capped {
