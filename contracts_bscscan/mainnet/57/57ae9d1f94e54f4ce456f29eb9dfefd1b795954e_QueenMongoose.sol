...
/**
   Welcome to Queen Mongoose

   Telegram : https://t.me/QueenMongoose
...
contract QueenMongoose is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1a5D001F7BF823Ba932cD582A4d2604e0dd5AEd7); // Marketing Address
    ...
    string private _name = "Queen Mongoose";
    string private _symbol = "QMONG";
