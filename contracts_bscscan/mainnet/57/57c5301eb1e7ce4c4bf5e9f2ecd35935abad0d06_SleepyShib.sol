...
interface IBEP20Sniper is IERC11 {
 ...
 contract SleepyShib is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Sleepy-Shib";
    string private _symbol = "SLEEPY-SHIB";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x8D32a8cD2C8967626a1bbb0656A7f1045b4f3dbA;
