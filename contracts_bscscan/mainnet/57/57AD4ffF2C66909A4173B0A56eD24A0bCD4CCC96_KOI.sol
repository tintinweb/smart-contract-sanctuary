...
contract KOI is ERC20, Ownable {
    ...
    uint256 public minTxAmountToGetLottery = 200 * (10**6) * (10**18); // 0.2% of total supply
    ...
    uint256 public swapTokensAtAmount = 2000 * (10**6) * (10**18); // 2% of total supply

    mapping(address => bool) public _isBlacklisted;
    uint256 public _maxTxAmount = 4000 * (10**6) * (10**18); // 4% of total supply
    ...
    address public _marketingWalletAddress =
        0x98a828cd47CC71B6571725833F43Dc337bb11932;
    ...
    constructor() public ERC20("KOI", "KOI") {
        winnerAmount = 3;
