...
contract TestCoin is Context, IERC20, Ownable {
    ...
    address public marketingAdd = 0x30A45e73d3E9b7C74d54B564585a8Be23Fa6A044;
    ...
    constructor () {
        ...
        //exclude owner, death address and this contract from fee
    ...
    function setMarketingFeePercent(uint256 Marketing) external onlyOwner() {
    ...
    function _marketing(uint256 marketing) private {
        uint256 currentRate =  _getRate();
        uint256 rMarketing = marketing.mul(currentRate);
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _Marketing == 0 && _liquidityFee == 0) return;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        emit Transfer(sender, marketingAdd, marketing);
