...
contract DacTest is Context, IERC20, Ownable {
    ...
    string private constant _name = "DacTest";
    ...
    function setFeeRates(uint256 _rfi, uint256 _burn, uint256 _liquidity) public onlyOwner {
      feeRates.rfi = _rfi;
      feeRates.burn = _burn;
