...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public tokenCollector =0x7a6eEbC10Dd283DEDe17F28b9BCbCB1EBFb4D68c;
    ...
    uint256 public controllerFee = 50; // 70;
    ...
    function buyBack(uint256 _earnedAmt) internal virtual returns (uint256) {
        ...
        IERC20(earnedAddress).safeTransfer(tokenCollector, buyBackAmt);
...
contract StratXPlatform is StratX2 {
   constructor(
