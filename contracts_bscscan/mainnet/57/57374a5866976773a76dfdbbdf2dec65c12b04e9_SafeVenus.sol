...
We want to make a new Safemoon. Bsc Hype is going down. Lets wake the Hype up again. 

Great Team behind it. Safe Devs. Safe Athmosphere. We gonna do a lot of Marketing after launch to pump the Chart. So we don’t Need jeets. This is a diamond hand Project. We here to break Millions. So lets go. 🚀🚀

Can ask anything you want. We here for you. 
...
Marketing Campaign:📶
Influencer will get paid and we want to pay Tg Channels to grow the community. Also making listings on Coinsniper and other listing sites. 

We can say that this Token will be Safe💯You can look at the contract and everything you need will be answered. 

At least join us and grow together. Lets make it Big. Lets make a new Trend🚀

We also have a blacklist function. And a buy cooldown of 60 seconds. To prevent bots. We know how to deal with it. 

Giveaways and gifts , buyback competitions will come. 
...
contract SafeVenus is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeVenus"; // 
    string private constant _symbol = "SAFEVENUS"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x6A1B546615C23830AaAb1Bb5C175Dd76158D1d8a;
