...
contract FireSanta is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "FireSanta";
   string constant _symbol = "FireS";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xBFebEe8fF8ebD57cC9A3e5aaF25D8ea34044ce48;
