...
contract BNBrocket is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 25; //per thousand
    uint256 public constant MARKETING_RATE = 25; //per thousand	
    uint256 public constant REFERENCE_RATE = 10;
    uint256 public constant REFERENCE_LEVEL1_RATE = 5;
    uint256 public constant REFERENCE_LEVEL2_RATE = 3;
    uint256 public constant REFERENCE_LEVEL3_RATE = 1;
    ...
    function _init() private {
        ...
        investmentPlans_.push(Objects.Plan(45, 30*60*60*24)); //30 days
        investmentPlans_.push(Objects.Plan(505, 2*60*60*24)); //2 days
        investmentPlans_.push(Objects.Plan(208, 4*60*60*24)); //5 days
        investmentPlans_.push(Objects.Plan(110, 10*60*60*24)); //10 days
    }
