...
// CHANGE
contract GordonFreeman is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Gordon Freeman";
    string constant _symbol = "FREEMAN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX will be remooved after 30 minutes
    ...
    uint256 liquidityFee = 2200; // 22% at launch for a few minutes then will be lowered to counter early dumpers
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 800; // 8% at launch then 6%
    uint256 totalFee = 3000; // liquidityFee + reflectionFee + devFee
