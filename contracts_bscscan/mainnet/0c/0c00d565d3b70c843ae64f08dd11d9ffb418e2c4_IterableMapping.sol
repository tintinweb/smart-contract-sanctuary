...
// https://boostco.in/
// https://twitter.com/boosttcoin
// https://t.me/TheOfficialBoostCoin
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0x37A5Cf3f1eE5292D48cc2352920C3F568Bafb8b1, "Only owner");
...
contract BoostCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Boost Coin", "BOOST") {
        ...
        marketingWallet = 0x8c05c728Ca714D30BBFF30Af4fD98e062e651336;
        teamWallet = 0xFf3Ce1bce88338146127436ac49a6ECF5b77de5B;
    ...
    function afterPreSale() external onlyOwner {
        ...
        maxBuyTransactionAmount = 4000000000 * (10**18);
        maxSellTransactionAmount = 500000000 * (10**18);
        maxWalletToken = 8000000000 * (10**18);
    }
    ...
    function updateETHDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newETHDividendTracker.owner() == address(this), "must be owned by BOOST");
    ...
    function updateBITCOINDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newBITCOINDividendTracker.owner() == address(this), "must be owned by BOOST");
...
contract BITCOINDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BITCOIN_Dividend_Tracker", "BITCOIN_Dividend_Tracker", 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
