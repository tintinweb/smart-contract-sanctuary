...
//Hello and welcome to Meta Deer! Huge thanks to our mod team and etc for helping us out! (Royce, Patrik Deer, Moody, Jay)
//Our Roadmap https://imgur.com/a/dbhTbL7 
//https://t.me/MetaDeer
...
contract MetaDeer is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaDeer";
    string constant _symbol = "MetaDeer";
	...
	function MetaDeerFRSniperBan(address user, bool banned) external authorized {
		if (banned) {
    ...
    function MetaDeerFRsetSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
