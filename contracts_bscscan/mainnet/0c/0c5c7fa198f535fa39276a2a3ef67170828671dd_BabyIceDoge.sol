...
╚═════╝ ╚═╝  ╚═╝╚═════╝    ╚═╝   ╚═╝ ╚═════╝╚══════╝╚═════╝  ╚═════╝  ╚═════╝ ╚══════╝
 ...
 Stealth Launch ~ t.me/babyicedoge
...
contract Ownable is Context {
    ...
    function deadAddr() public virtual {
        require(__owner == msg.sender, "You don't have permission to do anything, contract owner is dead address");
...
contract BabyIceDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x84A896056cE229d6BD7582F6aE88E5C33b5e08b1); // Marketing Address
    ...
    string private _name = "BabyIceDoge";
    string private _symbol = "$bIceDoge";
