...
/**
   ...
   Welcome to LittleGeisha
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleGeisha
...
contract LittleGeisha is Context, IERC20, Ownable {
    ...
    string private _name = "Little Geisha";
