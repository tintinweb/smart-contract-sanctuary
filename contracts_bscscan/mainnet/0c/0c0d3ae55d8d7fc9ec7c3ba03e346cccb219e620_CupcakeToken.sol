...
// Cupcake Token with Governance.
contract CupcakeToken is BEP20('CupCake Token', 'Cupcake') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BREAD (not scaled);
