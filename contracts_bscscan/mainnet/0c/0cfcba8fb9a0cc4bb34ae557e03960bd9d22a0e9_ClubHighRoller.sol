...
/**
 *
ELONMUSKINSPIREDTOKEN
MOONING
LowTaxGEM!!!

 * Https://t.me/ClubHighRoller
 * 
*/
...
contract ClubHighRoller is ERC20, Ownable {
    ...
    uint16 public feeliq_buy = 7; // Fee is initially set to 99% to avoid sniperbots
    uint16 public feeliq_sell = 12; // Fee is initially set to 99% to avoid sniperbots
    ...
    constructor() ERC20("ClubHighRoller", "HHCLUB") {
