...
interface IMARKETPLACE {
    ...
    function onSale(uint256 p_idNFT)
        external
        view
        returns (bool nftOnSale, uint256 priceOnSale,address oldOwnerSale);
   ...
   function buy(uint256 p_idNFT) external returns (bool, bool, uint256);
    ...
    event e_cancelSale(uint256  idNFT, address indexed oldOwner );
  ...
  //  address private immutable TROOPS_ADDRESS;
    ...
    constructor(
      ...
      //  address p_troopsContract
        ...
        ERC721_ADDRESS = 0xc65F2C8Ac7262A9Fbe182C49A5eb810611F86F1D;
        ERC20_ADDRESS = 0xA0c8c80ED6B7F09F885e826386440B2349F0Da7E;
        REWARDS_ADDRESS = 0x73743c41631D81131Ff9de279D2d8E152cACdf68;
        ...
        returns (bool)
    {
        ...
        emit e_sell(msg.sender, p_idNFT, p_price);
...
function cancelSale(uint256 p_idNFT) public override returns (bool, bool, uint256) {
        ...
        require(s_sales[p_idNFT] == false && s_salesPrice[p_idNFT] == 0, 'cant be');
         emit e_cancelSale(p_idNFT,msg.sender);
...
/*    function cancelSale(uint256 p_idNFT) public override returns (bool) {
    ...
    */
    ...
    {
        return (s_sales[p_idNFT], s_salesPrice[p_idNFT],s_oldOwner[p_idNFT]);
