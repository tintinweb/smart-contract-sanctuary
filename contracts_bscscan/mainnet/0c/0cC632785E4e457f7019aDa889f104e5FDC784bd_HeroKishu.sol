...
/**
 * TELEGRAM: HTTPS://T.ME/HeroKishuOfficial
 * Website : HTTPS://HEROKISHU.COM
 * TG2     : HeroKishuDiscussion
 * REWARD
 * TOKENOMICS
 * 56% BURN - 44% LIQUIDITY
 * NO DEV WALLET
*/
...
contract HeroKishu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "HeroKishu";
    string constant _symbol = "HKISHU";
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 3 >= block.number){ return feeDenominator.sub(5); }
