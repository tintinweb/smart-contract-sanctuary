...
contract PajeetPepe is Context, IBEPMEME, Ownable {
    ...
    uint256 private constant _allTotalSupply = 10 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'PajeetPepe';
    string private _symbol = 'PajeetPepe';
