...
all you need to do is hold NanoCardanox to automatically receive $ADA dividends in your wallet.
...
contract NanoCardanoX is Context, IERC20, Ownable {
    ...
    string private _name = "NanoCardanoX";
    string private _symbol = "nanoADA";
