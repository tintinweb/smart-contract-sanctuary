...
// Telegram community https://t.me/QRCATTOKEN
// Ludicrous Speed it's faster than the Speed of Light!
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x113e5c52c2503c86f8498895f1609dc83a88e748bfa7862b33ce3b5ba1acbae5 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x113e5c52c2503c86f8498895f1609dc83a88e748bfa7862b33ce3b5ba1acbae5;
...
contract QRCAT is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    string private _name = 'QRCAT Token ';
    string private _symbol = 'QRCAT';
