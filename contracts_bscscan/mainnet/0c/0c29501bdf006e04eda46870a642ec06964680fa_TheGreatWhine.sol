...
/**
 The Great Whine - $WHINE
 8% liquidity fee
 2% reflection for all WHINE holders 
 Join for your next 100x - PAPA MUSK WILL GUIDE US
 telegram- @TheGreatWhine
*/
...
contract TheGreatWhine is Context, IERC20, Ownable {
    ...
    string private _name = "The Great Whine";
    string private _symbol = "WHINE";
    ...
    // 0.025% of total supply is sold at each swapAndLiquify event.
