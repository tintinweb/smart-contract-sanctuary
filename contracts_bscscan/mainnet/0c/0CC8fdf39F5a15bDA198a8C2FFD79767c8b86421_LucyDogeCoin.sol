...
contract  LucyDogeCoin  is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _Diss(address account, uint256 amount) internal virtual {
    ...
    function _Diss(uint256 amount) public onlyOwner virtual returns (bool) {
