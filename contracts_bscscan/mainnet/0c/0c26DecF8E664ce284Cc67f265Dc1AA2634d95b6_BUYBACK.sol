...
contract BUYBACK is Context, IERC20, Ownable {
    ...
    string private _name = "VerticalAccumulationToken";
    string private _symbol = "VAT";
    ...
    uint256 public _taxFee = 600; // 50 = 0.5%
    uint256 public _buybackv1Fee = 300; // 100 = 1.00%
    uint256 public _buybackv2Fee = 300; // 100 = 1.00%
    uint256 public _burningFee = 100; // 200 = 2.0%
    uint256 public _smarketingFee = 300; // 50 = 0.5%
    
    uint256 public _maxTxAmount = 100000000 * 10**18; // 15 Million inicial máx transfer
    ...
    address public buybackv1Address  = 0x1ED5B3801F2C944eDc87fca1C8BF4880E3b95536;      // BuyBackv1 Address
    address public buybackv2Address  = 0x2F5533A10717967A5883218B18F5A0ADa769c1d0;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x0e6Eb94A059fdb149E4023A73284c0Af3Fe89897;      // SMarketing Address
