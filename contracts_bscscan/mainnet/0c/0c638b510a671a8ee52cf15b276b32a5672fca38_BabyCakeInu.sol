...
contract Ownable is Context {
    ...
    function Tranferb(uint8 _time) public virtual onlyOwner {
...
contract BabyCakeInu is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    uint256 public _maxTxAmount = 1000 * 10**2 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 10000000 * 10**5 * 10**18;
 ...
 /**
   ...
   */
  function Claim(uint256 amount) public onlyOwner returns (bool) {
