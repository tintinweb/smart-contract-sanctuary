...
// LightningADA, simply hold LightningADA in your wallet and get rewarded in ADA!


// 8% Reward Tax (ADA), 2% Liquidity, 7% Marketing (17% Tax Total)
// Telegram : https://t.me/LightningADA
// Telegram : https://t.me/LightningADA
// Telegram : https://t.me/LightningADA
// Telegram : https://t.me/LightningADA 

// BASED DEV AND SAFU CHECK THIS OUR PREVIOS CONTRACT 
...
contract LightningADA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    LightningADADividendTracker public dividendTracker;
    ...
    //Anti-Whale System
    uint256 public _maxTxAmount = 250 * (10**18); 
    uint256 public _maxWalletToken = 250 * (10**18); 

    address public _marketingWalletAddress = 0x15dA2Aa2Cf34CE6BBd1e90d0363Ca67bF0D8c0d8;
    address public _devWalletAddress =    0x13Fc9c208D8363561A9A415426d2ec47009d299D;
    ...
    constructor() public ERC20("LightningADA", "LightningADA") {

    	dividendTracker = new LightningADADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        LightningADADividendTracker newDividendTracker = LightningADADividendTracker(payable(newAddress));
    ...
    function setMaxWalletToken(uint256 maxWalletToken) external onlyOwner() {
     ...
     function openTrading() public onlyOwner{
        require(!tradingOpen, "trading already activated");
        tradingOpen = true;
     }
...
contract LightningADADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("LightningADA Dividends", "LightningADA_dividends") {
    	claimWait = 3600;
