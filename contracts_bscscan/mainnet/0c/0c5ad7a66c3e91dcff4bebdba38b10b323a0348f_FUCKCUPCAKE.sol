...
contract FUCKCUPCAKE is ERC20, Ownable {
    // CONFIG START
    
    // TOKEM
    string tokenName = "FuckCupCake";
    string tokenSymbol = "FUCKCUPCAKE";
    uint256 tokenTotalSupply = 1_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0xECbec8D68cE7aC49B22Df8a985f82457B1f07f7f;
    ...
    // WHALE PROTECTION
    uint256 maxTXAmount = 50_000 * (10**18);
