...
/**
   PitbullCoin
   Pitbull, is the egyptian name of the god of death and the Underworld. In the Crypto space Pitbull comes to protect its holders and to overtake its biggest competitors #DOGE #SHIBA

   Two token features:
   5% fee auto add to the liquidity pool to locked forever when selling
   3% fee auto distribute to all holders (Lower overall penality for buying / selling should resolve cross exchange pricing issues Shiba Inu has)
   ...
   Let's get this coin to 10,000x and Pitbull will protect you and your beloved from the Underworld
 */
...
contract PitbullCoin is Context, IERC20, Ownable {
    ...
    string private _name = "PitbullCoin";
