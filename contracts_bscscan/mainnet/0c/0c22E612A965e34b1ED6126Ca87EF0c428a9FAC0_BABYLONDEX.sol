...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LONDEX = IBEP20(0x2089F0CbE8Aca0950FA8c5Bb04ADe2323AEE832F);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LONDEX.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(LONDEX);
        ...
        uint256 amount = LONDEX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LONDEX.transfer(shareholder, amount);
...
contract BABYLONDEX is IBEP20, Auth {
    using SafeMath for uint256;

    address LONDEX = 0x2089F0CbE8Aca0950FA8c5Bb04ADe2323AEE832F;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyLondex";
    string constant _symbol = "BLDX";
    ...
    address private marketingFeeReceiver = 0xE6a23b5dAbA63a23343192eE67cCFd934037e0d7;
    ...
    constructor (address owner) Auth(msg.sender) {
