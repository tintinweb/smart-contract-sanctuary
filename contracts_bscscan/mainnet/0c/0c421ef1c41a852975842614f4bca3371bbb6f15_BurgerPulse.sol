...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;
        _token = msg.sender;
    }
...
contract BurgerPulse is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "BurgerX";
    string constant _symbol = "BGX";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 2000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 4000000 * (10 ** _decimals);
    ...
    address IDEXPair = 0x6A5336694436C7E951c610daaBfb9bC92daAc16c;
