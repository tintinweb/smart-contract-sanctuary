...
- Initial pancake listing : 100,000,000,000,000 (10%) 
Fees 
- 6% to liquidity
- 3% to holder
- 5% to marketing wallet

Telegram : https://t.me/cakebooster
...
contract CakeBooster is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5DB41BA1758483C38AcdD1d08e7bA45af506c787); // Marketing Address
    ...
    string private _name = "Cake Booster";
    string private _symbol = "CAKEB";
    ...
    uint256 public _maxTxAmount = 500000000 * 10**6 * 10**9; // 10 trillion, or 1% of total supply
