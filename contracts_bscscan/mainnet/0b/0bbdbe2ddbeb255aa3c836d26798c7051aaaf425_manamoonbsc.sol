...
contract manamoonbsc is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "ManaMoon";
    string _symbol = "ManaM";
    ...
    address private marketing = address(0xF7FF31f969C378E0e947A730F0A286C4e7d28de5);
    address private liquidity = address(0x852A499aFC63414FbC34efdb737594E63Eab2F06);
