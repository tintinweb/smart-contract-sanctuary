...
/**
🐶 $BABYSHIBA 🐶- FAIRLAUNCH🚀

What is $BABYSHIBA?
🐶 $BABYSHIBA is a community-driven, meme theme decentralized token powered by Binance Smart Chain (BSC). $BABYSHIBA is fully decentralised and owned by its fun, vibrant community.

🔐 Ownership will be Renounced
💬 Community Driven
🔥 Liquidity Lock with Deeplock
✅ Safe for bscheck
...
50% : BURN address
47% : PCS Liquidity  
3% : DEV wallet (will be used for marketing)
...
contract BabyShibaBSC is Context, IERC20, IERC20Metadata, Ownable {   
