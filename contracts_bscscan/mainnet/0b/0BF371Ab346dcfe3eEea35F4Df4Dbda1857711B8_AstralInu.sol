...
contract AstralInu is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x42147a12BfA173F752776AD7AEfd53D88FF045dC;
   
    uint private startingSupply = 400_000_000_000_000_000;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = startingSupply * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Astral Inu";
    string private _symbol = "Astral INU";
    ...
    function setNumTokensSellToAddToLiquidity(uint256 swapNumber) public onlyOwner {
        numTokensSellToAddToLiquidity = swapNumber * 10 ** 9;
    }
