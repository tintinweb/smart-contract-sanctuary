...
// CHANGE
contract BabyPug is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Pug";
    string constant _symbol = "BABYPUG";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4FB8CE2da8475e06A57d9330A5Ab0Fe4507D7a60);
