...
//Just launched in $CuteBabyBunny. We have created a token so rewarding for everyone.
//Driven Community CuteBabyBunny
//CuteBabyBunny Hold we will To the moon
//telegram : @CuteBabyBunny
...
contract CuteBabyBunny is Context, IERC20, Ownable {
    ...
    string private _name = "CUTEBABYBUNNY";
    string private _symbol = "CuteBabyBunny";
