...
/**
   ...
   Welcome to Lil Shibanomics
   
   This is a community token. If you want to create a telegram I suggest to name it to @LilShibanomicsBSC
   The early you create a group that shares the token, the more gain you'll get.
   ...
   Can you make #LilShibanomicsBSC 10000X? 
...
contract LilShibanomics is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc070C33F8E824D6f906E6a3Faa94fcE8b0975483); // Marketing Address
    ...
    string private _name = "Lil Shibanomics";
    string private _symbol = "LILSHIBA";
