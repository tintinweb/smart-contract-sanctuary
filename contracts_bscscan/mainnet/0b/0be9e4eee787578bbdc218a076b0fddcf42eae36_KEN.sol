...
contract KEN is ERC20, Ownable {
    ...
    uint256 public charityBuyFee = 3;
    uint256 public devBuyFee = 5;
    uint256 public totalBuyFees = 15;
    ...
    address payable public marketingWallet = payable(0x5DbEc1FB38FD7eD997403B1b47E0C037Af32277b);
    address payable public devWallet = payable(0x769273783AF8DA9a98162176C4B76b429358536e);
    address payable public charityWallet = payable(0x7D53989deFe1ECF8F32531C342cCd7cF206C53B5);
    ...
    constructor() ERC20("Kermit Coin", "KEN") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "KEN: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "KEN: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "KEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "KEN: Automated market maker pair is already set to that value");
