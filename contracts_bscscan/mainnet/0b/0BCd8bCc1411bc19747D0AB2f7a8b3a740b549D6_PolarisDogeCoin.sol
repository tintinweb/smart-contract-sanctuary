...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 100_000 * 10**9; // must hold 1 billion tokens which equates to 0.01% of the total PolarisDogeCoin supply
  }
...
// File: contracts/IPolarisDogeCoin.sol
...
interface IPolarisDogeCoin is IERC20, IERC20Metadata {
...
// File: contracts/PolarisDogeCoin.sol
  ...
  ReentrancyGuard
{
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'PolarisDoge: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'PolarisDoge: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'PolarisDogeCoin: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      'PolarisDogeCoin: The new dividend tracker must be owned by the token contract'
    );
