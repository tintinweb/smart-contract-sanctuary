...
/*
    Cake is food! CAKE tokens rewarded to hodlers.
*/
...
contract CakeFood is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CakeFoodDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0xb463E70EB8673B0e427B0ee6dd2465F5eB85A569;
    ...
    constructor() public ERC20("CakeFood", "FOOD") {

    dividendTracker = new CakeFoodDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        CakeFoodDividendTracker newDividendTracker = CakeFoodDividendTracker(payable(newAddress));
...
contract CakeFoodDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("CakeFood_Dividend_Tracker", "CakeFood_Dividend_Tracker") {
    claimWait = 3600;
