...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x482F0F81BAAfBc68bDaf764E8800BBd82F4c9168), // BnbGenesisPool
        address(0x0FB9d416083e049CdcC463A91A92De5Dc6a468b6), // CakeGenesisPool
        address(0x73Ffc91C4A4AdD0D3E5F152Eec850488B388152f), // BananaGenesisPool
        address(0x9ABed3aea5d82526524Ad2d8732b8443F6375083)  // NftartGenesisPool
    ];
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochDibsPrice > dibsPriceCeiling) {
                ...
                if (seigniorageSaved >= bondSupply.mul(bondDepletionFloorPercent).div(10000)) {
                    ...
                    _savedForPiggybank = dibsSupply.mul(_percentage).div(1e15);
                } else {
                    // have not saved enough to pay debt, mint more
                    uint256 _seigniorage = dibsSupply.mul(_percentage).div(1e15);
