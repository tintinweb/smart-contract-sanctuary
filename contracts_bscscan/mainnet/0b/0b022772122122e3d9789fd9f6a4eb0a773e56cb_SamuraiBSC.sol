...
contract SamuraiBSC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 9000000 * 10**5 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SamuraiBSC";
    string private _symbol = "SamuraiBSC";
    ...
    uint256 public _maxTxAmount = 90000000000 * 10**5 * 10**6;
