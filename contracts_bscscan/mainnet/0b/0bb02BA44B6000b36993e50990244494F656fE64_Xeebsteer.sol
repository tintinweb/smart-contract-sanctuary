...
/*
Xeebster,
a defalationary, token burning, auto-liquidfier token that's set to make investors happy to hold!
3% burn,
3% buyback,
3% auto-liquidity
3% marketing/expenses

HODL and become a millionare with us!!
Please look at our whitepaper for what may be possible with our defalationary token.
*/
...
contract Xeebsteer is Context, IBEP20, Ownable {
    ...
    address payable public _externalAddress  = payable(0xAFe8922B2a44add9b11fD0868d5C7651F49742d7);
    address payable public _burnAddress      = payable(0x000000000000000000000000000000000000dEaD);
    address payable public autoLiquidityReceiver = payable(0xaA1f70a9c536253A95c94321E82367e2d52a2136); 
