...
contract AlienAda is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    AlienAdaDividendTracker public dividendTracker;
    ...
    uint256 public _maxWalletToken = 2000000000 * (10**18); // Max Wallet: 2.0%

    address public _marketingWalletAddress = 0xeF458377663b808E776cDF7591D0Ec859227AD03;
    address public _devWalletAddress =    0x79Ac31d982464C5f5771FF7A2F3FAF00B2774D01;
    ...
    constructor() public ERC20("AlienAda", "AlienAda") {

    	dividendTracker = new AlienAdaDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        AlienAdaDividendTracker newDividendTracker = AlienAdaDividendTracker(payable(newAddress));
...
contract AlienAdaDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("AlienAda Dividends", "AlienAda_dividends") {
    	claimWait = 3600;
