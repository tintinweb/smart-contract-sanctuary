...
contract MiniBNBDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x67433Eac50143f39359d6594Fd9608542866043C);
    ...
    string private _name = "MiniBNBDoge";
    string private _symbol = "MiniBNBDoge";
