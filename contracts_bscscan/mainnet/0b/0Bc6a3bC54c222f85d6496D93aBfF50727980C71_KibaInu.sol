...
contract KibaInu is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "KibaInu";
    string constant _symbol = "Kiba";
    ...
    address payable public liquidityFeeReceiver = payable(0x91c38078Dc0F880ae0c7CED9950EAE4b2e2ADd71);
    address payable public marketingFeeReceiver = payable(0x91c38078Dc0F880ae0c7CED9950EAE4b2e2ADd71);
