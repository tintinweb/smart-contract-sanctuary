...
+  Shilling competition:  3.000.000.000 (3%)
+  TikTok challenge:  2.000.000.000 (2%)
 
 14% Transaction Fees
 8% is auto redistributed to all holders In BTC Hold $FLIGHT tokens, earn BTC. 
 Auto Paid For the first time ever, you don’t need to claim your earned BTC. It’s automatically sent to your wallet.
...
contract BabaBoi is IERC20, Ownable {
    ...
    string constant _name = "Flight Coin";
    string constant _symbol = "FLIGHT";
