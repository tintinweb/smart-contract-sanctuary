...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Minance";
    string public constant TOKEN_SYMBOL = "MBNB";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x1E21B93664d438FFB718b0382ED4dEa820FF848d;
    
    uint public constant START_TIME = 1627452000;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[3] memory weiRaisedStartsBounds = [uint(0),uint(100000000000000000000),uint(200000000000000000000)];
        uint[3] memory weiRaisedEndsBounds = [uint(100000000000000000000),uint(200000000000000000000),uint(300000000000000000000)];
        uint64[3] memory timeStartsBounds = [uint64(1627452000),uint64(1627452000),uint64(1627452000)];
        uint64[3] memory timeEndsBounds = [uint64(1635177595),uint64(1635177595),uint64(1635177595)];
        uint[3] memory weiRaisedAndTimeRates = [uint(300),uint(200),uint(100)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(30000 * TOKEN_DECIMAL_MULTIPLIER, 0xD716fa8D7FbEEE2019d0C3E9072e505126B96021, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1635177600)
        CappedCrowdsale(1060000000000000000000)
    ...
    function init() public onlyOwner {
        ...
        address[1] memory addresses = [address(0x4fb74460a04a448ca7f245d36496948d0fc69417)];
        uint[1] memory amounts = [uint(300000000000000)];
