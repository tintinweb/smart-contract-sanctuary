...
// CHANGE
contract GetXRP is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "GetXRP";
    string constant _symbol = "GetXRP";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xFfD83F11a92a2Ab0704449EE2041c78d7EDbae23);
