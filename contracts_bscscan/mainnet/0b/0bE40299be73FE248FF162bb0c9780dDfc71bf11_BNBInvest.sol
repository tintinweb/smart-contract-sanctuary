...
/*   BNBInvest - Community Experimental yield farm on Binance Smart Chain.
 *   The only official platform of original BNBInvest team! All other platforms with the same contract code are FAKE!
 *   Website: https://bnbinvest.io
 *   Telegram Group : @BNBInvest_BSC
 *   Telegram Chanel : @BNBInvest_ANN
 *
 *   [USAGE INSTRUCTION]
 *
