...
contract Paratroopers is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCf628a9cb91175C3B2Cbb4Bb357D263B65636206); // Marketing Address
    ...
    string private _name = "Paratroopers";
    string private _symbol = "TROOP";
