...
/**
 *
  Official Baby Elephant Binance Smart Chain Token
  
  
 * The biggest Baby Elephant meme reflection token and the only one with auto-stake feature.
 * Simply love, hold Baby Elephant tokens in your wallet and watch your baby elephants grow.
...
contract BABYELEPHANT is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BABY ELEPHANT";
