...
/**
 Welcome to IceDoge    @Telegram: https://t.me/IceDoge1
   ...
   I will renounce the ownership to burn addresses to transfer #IceDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make IceDoge 100X? 
   ...
   it's the best part of the #IceDoge A idea, increasing the liquidity pool automatically, 
...
contract IceDoge is BEP20 {
    ...
    constructor() public {
	symbol = "Ice Doge";
    name = "IceDoge (https://t.me/IceDoge1)";
    fees = 10;
