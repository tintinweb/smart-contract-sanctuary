...
contract StrategyV2_ApeSwap is Ownable, ReentrancyGuard, Pausable {
    ...
    address public uniRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // uniswap, pancakeswap etc
    ...
    constructor(
        ...
        if (isAutoComp) {
            ...
            farmContractAddress = 0x5c8D727b265DBAfaba67E050f2f739cAeEB4A6F9;
            pid = _pid;
            earnedAddress = 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95;
    ...
    function workerCompound() public view returns (uint256){
        ...
        uint256 Comp  = IXswapFarm(farmContractAddress).pendingCake(pid, address(this));
        uint256 ToComp = BalanceTokens.add(Comp);
        uint256 buyBackAmt = ToComp.mul(buyBackRate).div(buyBackRateMax);
        ToComp = ToComp.sub(buyBackAmt);
        uint256 fee = ToComp.mul(controllerFee).div(controllerFeeMax);
