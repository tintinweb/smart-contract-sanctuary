...
contract ELONFUNSWAP is Context, IBEP20, Ownable { // change contract name
    ...
    string private _name = "ELONBOT"; // token name
    string private _symbol = "ELONBOT"; // token symbol
    ...
    uint256 public _maxTxAmount = 50000000000 * 10**6 * 10**9; // max allowed tokens tranfer per transaction
    uint256 public _numTokensSellToAndTransfer = 500000 * 10**6 * 10**18; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress            = 2000000000000000 * 10**6 * 10**18; // Max number of tokens that an address can hold
