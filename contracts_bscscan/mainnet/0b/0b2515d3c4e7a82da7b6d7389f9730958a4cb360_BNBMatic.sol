...
—————————————————————
⚡️🔥 BNBMATIC Rewards in auto 5% BNB and 7% MATIC 3% dividends with state-of-the-art mechanics.
...
$BNBMATIC will be the biggest BNB and Matic rewarding token on BSC! ⚡️🔥

—————————————————————
🔰Total Supply: 1 Billion $BNBMATIC
🔰Initial Burn: 300 Million $BNBMATIC
🔰Marketing: 150 Million $BNBMATIC
🔰Giveaways: 100 Million $BNBMATIC
🔰Fees: 50 Million $BNBMATIC
—————————————————————

🌍Website: https://bnbmatic.com
🐤Twitter: https://twitter.com/bnbmatictoken
🔈Telegram: https://t.me/bnbmatictoken
*/
...
contract BNBMatic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address[] public  TOKENARR = [0xCC42724C6683B7E57334c4E856f4c9965ED682bD]; // Matic
    ...
    constructor() ERC20("BNBMatic", "BNBMATIC") {
