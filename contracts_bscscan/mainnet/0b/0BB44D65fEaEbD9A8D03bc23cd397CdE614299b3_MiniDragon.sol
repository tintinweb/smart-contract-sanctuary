...
Mini Dragon got you down? Can't relate to people in the real world?
Fear no more! Mini Dragon has got your back! This token embodies
not only the dream that Elon has for a new financial system, but
also his social deficiencies as well!
 
Mini Dragon Features include:
...
- Burn more than 55% of the initial token supply
...
contract MiniDragon is IBEP20 {
    ...
    string public override name = "Mini Dragon";
    string public override symbol = "MINID";
