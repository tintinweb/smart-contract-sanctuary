...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ComeDoge";
    string private _symbol = "ComeDoge";
    ...
    address public ownerAddres = address(0x6658D81523474C0Da82a1fe9301a243490933574);
    ...
    uint256 public _maxTxAmount = 10000000000000000000 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 10000000000000000000 * 10 **18;
