...
contract CardanoReward is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ADASkyDividendTracker public dividendTracker;
    ...
    uint256 public ADARewardsRewardsFee = 11;
    ...
    address public _marketingWalletAddress = 0x0D22929bFeF8EDEe14C368BB4F75E56bbEdd077b;
    address public _devWalletAddress = 0xFc745837AF53701f3e7cAFB0De3af9d11c2aEB5b;
    ...
    constructor() public ERC20("ADASky", "ADASky") {

    	dividendTracker = new ADASkyDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ADASkyDividendTracker newDividendTracker = ADASkyDividendTracker(payable(newAddress));
...
contract ADASkyDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("ADA Sky Dividends", "ADA Sky_dividends") {
    	claimWait = 3600;
