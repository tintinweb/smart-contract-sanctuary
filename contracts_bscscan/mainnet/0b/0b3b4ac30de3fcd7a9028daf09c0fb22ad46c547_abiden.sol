...
// CHANGE
contract abiden  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "abide(n)";
    string constant _symbol = "abide(n)";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1000; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 3% MAX 300,000
