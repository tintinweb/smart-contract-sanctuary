...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0xc4c6003424585280648882B274E224c46DAB6f48;
        _owner = msgSender;
...
contract CatMoon is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x0AcF137784a59c50C2C52a1ce5f9244303DD6d9A);
    address payable private _marketingAddress = payable(0x9CEec9385B7D3252856e68FC45a4E4CCD7E531b7);
    
    string private constant _name = "babydoraemon";
    string private constant _symbol = "babydoraemon";
    ...
    constructor () {
        _rOwned[0xc4c6003424585280648882B274E224c46DAB6f48] = _rTotal;
        ...
        emit Transfer(address(0x0000000000000000000000000000000000000000), 0xc4c6003424585280648882B274E224c46DAB6f48, _tTotal);
    }
