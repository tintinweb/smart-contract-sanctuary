...
contract Batmoon is BATMOONDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private BATMOONTeam;
    address private CharityBATMOON;
    ...
    string public override name = "Batmoon";
    string public override symbol = "BATMOON";
    ...
    constructor(uint totalSupplyValue, address BATMOONTeamAddress, address CharityBATMOONAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        BATMOONTeam = BATMOONTeamAddress;
        CharityBATMOON = CharityBATMOONAddress;
        
        // split the tokens according to agreed upon percentages
        balances[BATMOONTeam] =  totalSupply * 45 / 100;
        balances[CharityBATMOON] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's BATMOONTeam pot
