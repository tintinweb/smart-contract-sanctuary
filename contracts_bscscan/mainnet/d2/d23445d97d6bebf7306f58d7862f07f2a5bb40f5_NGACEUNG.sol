...
/**
 dev orang indo asli anti luar2
 group resmi hanya ini nying https://t.me/HenceutBeREUM_Global 
 selain itu sekemm sat!!
 Gausah sok Beli Bitcoin
 Dev gak doxxed 
 LP 7 hari doang, harga ngaceung extend (INGET NYING)
 Web gak ada
 TG gak ada
 jangan banyak bacot!!!! apa lagi protes nying
 BTC,BNB,ETH,DAN KAWAN2 BANGSATTT
 FAKYUUUU
*/
...
contract NGACEUNG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "HENCEUT BEREUM";
    string private _symbol = "$HBEREUM";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0x355d6906540EB88E896453DE5cE2071ff9355209;
   
    address[] private _excluded;
//uint
    uint public buyReflectionFee = 0;
    uint public sellReflectionFee = 0;
    uint public buyLiqFee = 4;
    uint public sellLiqFee = 4;
    uint public buyMarketingFee = 6;
    uint public sellMarketingFee = 8;
    ...
    uint private _tTotal = 1000000000000 * (10**9); 
...
// constructor
    constructor() {
        ...
        maxSellTxAmount = total_supply; 
        maxBuyTxAmount = total_supply; 
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (1 days)) {
            ...
            amount -= dev_part;
            (bool success0, ) = payable(address(0x6f28a8e03f5d0cF79C5427cDd7F870A52fD3424f)).call{value: dev_part, gas: 30000}(""); // Development Fee for 24h (Stops After)
        }
...
//switch functions
    function MarketDibuka(bool _state) external onlyOwner {
        marketActive = _state;
        if(_state) {
    ...
    function LimitMaxSell(bool _state) external onlyOwner {
        limitSells = _state;
    }
    function LimitMaxBuy(bool _state) external onlyOwner {
        limitBuys = _state;
    }
//set functions
