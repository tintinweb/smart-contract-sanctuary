...
pragma solidity ^0.6.12;
    ...
    contract BabySonofDoge is Context, IERC20, Ownable {
        ...
        string private _name = 'Baby Son of Doge';
        string private _symbol = 'BabySoD';
        ...
        uint256 private _buyMarketingPoolFee = 6;
        uint256 private _selltaxFee = 1; 
        uint256 private _sellstaketaxFee = 1; 
        uint256 private _sellMarketingPoolFee = 6;
        ...
        uint256 public walletlimit = 1380000000000000000000 * 10**9;
        uint256 private _maxTxAmount = 690000000000000000000 * 10**9;
        // We will set a minimum amount of tokens to be swaped => 500K
        uint256 private _numOfTokensToExchangeForMarketingPool = 69000000000000000000 * 10**9;
