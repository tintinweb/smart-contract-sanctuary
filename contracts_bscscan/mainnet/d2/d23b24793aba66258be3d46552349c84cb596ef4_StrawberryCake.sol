...
import "./StrawberryCake-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `Strawberrycake` at the very bottom **and** the `environment` into which
 * you are deploying the contract `StrawberryCake(Env.Testnet)` or `StrawberryCake(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "StrawberryCake";
    string internal constant SYMBOL = "SBC";
     ...
     */
    address internal tipToTheDev =0xa0a8683b8679D8f5Ad16949DbcFb803044FeDD10;
...
contract StrawberryCake is SafeToken{
