...
contract ShibaVaxBSC is Context, IERC20, Ownable {
    ...
    uint256 private _tshibavaxTotal;

    string private _name = "ShibaVaxBSC";
    string private _symbol = "SHIVAX";
    ...
    uint256 public _shibavaxFee = 12;
    uint256 private _previousshibavaxFee = _shibavaxFee;
    
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**6 * 10**9; 
    
    address payable public shibavaxWallet = 0x00bc2aa1281BBBd3B9Af8A39b69eB39d0F6AE501; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tshibavaxTotal = _tshibavaxTotal.add(address(this).balance);
        TransferCharityETH(shibavaxWallet, address(this).balance);
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_shibavaxFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _shibavaxFee == 0) return;
        
        _previousTaxFee = _taxFee;
        _previousBurnFee = _burnFee;
        _previousshibavaxFee = _shibavaxFee;
    ...
    function restoreAllFee() private {
        ...
        _shibavaxFee = _previousshibavaxFee;
    }
    ...
    function setshibavaxFeePercent(uint256 shibavaxFee) external onlyOwner() {
        _shibavaxFee = shibavaxFee;
    }
