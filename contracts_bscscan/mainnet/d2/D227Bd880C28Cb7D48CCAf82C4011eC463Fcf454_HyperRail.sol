...
/**
     ...
     /   |   \ ___.__.______   ___________  \______   \_____  |__|  |  
    /    ~    <   |  |\____ \_/ __ \_  __ \  |       _/\__  \ |  |  |  
    \    Y    /\___  ||  |_> >  ___/|  | \/  |    |   \ / __ \|  |  |__
     \___|_  / / ____||   __/ \___  >__|     |____|_  /(____  /__|____/
           \/  \/     |__|        \/                \/      \/         
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WBTC = IBEP20(0xd47Ba9A00EB87B9E753c6651e402DAD7D9f1C4Ca);
...
contract HyperRail is IBEP20, Auth {
    using SafeMath for uint256;

    address WBTC = 0xd47Ba9A00EB87B9E753c6651e402DAD7D9f1C4Ca;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Hyper Rail";
    string constant _symbol = "HyRail";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xdF439B8C7b4Fe31ace2FF58f9e6f9db6255FCd5a;
    ...
    function swapBack() internal swapping {
        ...
        (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 3000000}("");
