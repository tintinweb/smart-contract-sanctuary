...
/**
 Telegram: t.me/MiniSoldiers
 Website: www.MiniSoldiersBSC.com/
 Twitter: MiniSoldiersBSC
 Dev for any inquiries: @Genos0x
                                                            ▓▓██████████                        
                                                          ██▒▒▒▒▒▒▒▒▒▒▒▒██                      
                                                          ██▒▒▒▒▒▒▒▒▒▒▒▒██                      
                                                         ██░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒██                    
...
contract MiniSoldiers is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public MarketingAndBuybackWallet;
    ...
    event MarketingAndBuybackWalletUpdated(address indexed newMarketingAndBuybackWallet, address indexed oldMarketingAndBuybackWallet);
    ...
    constructor() ERC20("MiniSoldiers", "MSOLDIERS") {
    	firstDividendTracker = new FIRSTDividendTracker();
 
    	MarketingAndBuybackWallet = 0x4A4E9B5882f575F79f138af73153707c2789B492;
        ...
        excludeFromFees(MarketingAndBuybackWallet, true);
    ...
    receive() external payable {
  	...
  	function updateMarketingAndBuybackWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != MarketingAndBuybackWallet, "MiniSoldiers: The marketing wallet is already this address");
        excludeFromFees(_newWallet, true);
        emit MarketingAndBuybackWalletUpdated(MarketingAndBuybackWallet, _newWallet);
  	    MarketingAndBuybackWallet = _newWallet;
  	}
    ...
    function _transfer(
        ...
        if (!swapping && canSwap && from != uniswapV2Pair) {
            ...
            if (marketingEnabled) {
                ...
                transferToWallet(payable(MarketingAndBuybackWallet), marketingPortion);
            }
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("MiniSoldiers_Dividend_Tracker", "MiniSoldiers_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 3600;
