...
contract Brainiac is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private constant gasPriceLimit = 560 * 1 gwei; // do not allow over x gwei for launch
    ...
    constructor() ERC20("BRAINIACCHESS.network", "BRAIN") {
        address newOwner = address(0x764425cA8b170e7E017Ee4C8cCCA2DE5D88E717d);
        ...
        uint256 _buyProjectFee = 75;
        uint256 _buyLiquidityFee = 0;

        uint256 _sellProjectFee = 75;
    	...
    	projectWallet = address(newOwner); // set as project wallet
    ...
    function buyBackTokens(uint256 ethAmountInWei) external onlyOwner {
        require(ethAmountInWei <= 2 ether, "May not buyback more than 2 ETH in one purchase");
