...
contract SakuraToken is BEP20('SAKURA', 'SAKU') {
    uint256 constant INITIAL_SUPPLY = 100_000_000 * 10**18; // 100M
    constructor(address _fundHolder) public {
        mint(_fundHolder, INITIAL_SUPPLY);
    }
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying SAKURAs (not scaled);
...
contract MasterChef is Ownable {
    ...
    // Update the given pool's SAKURA allocation point and deposit fee. Can only be called by the owner.
    ...
    function updateEmissionRate(uint256 _sakuraPerBlock) public onlyOwner {
        massUpdatePools();
        sakuraPerBlock = _sakuraPerBlock;
    }
}