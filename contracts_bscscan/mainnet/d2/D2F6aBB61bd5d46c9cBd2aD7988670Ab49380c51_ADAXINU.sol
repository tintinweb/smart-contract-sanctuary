...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 400 * (10**9); // user must hold 1,000,000 token
...
contract ADAXINU is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "ADAXINU";
    string constant _symbol = "ADX";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 40000000 * (10**_decimals);
