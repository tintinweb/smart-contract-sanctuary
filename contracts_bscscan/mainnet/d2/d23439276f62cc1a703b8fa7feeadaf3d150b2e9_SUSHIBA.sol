...
Tokenomics
    💵 2% Max Buy Tx ( 2,000,000,000 SUSHIB )
    💵 2% Max Sell Tx ( 2,000,000,000 SUSHIB )
    💰 2% Max Bag ( 2,000,000,000 SUSHIB )
...
/* Token contract */
contract SUSHIBA is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "SUSHIBA.NET";
    string constant _symbol = "SUSHIB";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% on launch or 2Md tokens
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% or 2Md tokens
    uint256 public _maxWalletToken = _totalSupply * 200 / 10000; // 2% or 2Md tokens
