 ...
 * to ensure the safety of our investors, their funds and a healthy environment for AoETH.
 * Three core-team signers and two volunteers of the community are required to approve the call before extra
 * $AoETH can be minted; maleficent actions has to be avoided at any time and a secure and transparent mechanism
 * is required.
 *
 * Token Economics
 *
 ...
 *
 * BUY Tax
 * 4% Marketing ~ 4% Eth ~ 4% liquidity ~ 1% Charity
 *
 * SELL Tax
 * 4% Marketing ~ 4% Eth ~ 4% liquidity ~ 1% Charity
 *
...
contract Ao_ETH is Context, IBEP20, MinterRole, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public externalFee = 100;
    ...
    uint256 public _maxTokensPerAddress         = 10000000 * 10**6 * 10**_decimals; // 1.5%
    ...
    constructor () {
        ...
        isExcludedFromTransactionlock[marketAddress] = true;
