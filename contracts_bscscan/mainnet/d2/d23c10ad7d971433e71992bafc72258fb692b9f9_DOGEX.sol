...
contract DOGEX is Context, IERC20, IERC20Extented, Ownable {
    ...
    string private constant _name = "OnlyUpX";
    string private constant _symbol = "OUX";
    ...
    address payable constant private _marketingAddress = payable(0x211e41646FEC29d16246f93893f713301a02Af7B);
    address payable constant private _buybackAddress = payable(0x211e41646FEC29d16246f93893f713301a02Af7B);
    address payable constant private _projectMaintainence = payable(0x211e41646FEC29d16246f93893f713301a02Af7B);
