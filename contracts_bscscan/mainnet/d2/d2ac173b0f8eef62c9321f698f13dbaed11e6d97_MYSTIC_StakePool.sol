...
contract MYSTIC_StakePool is Ownable{
    ...
    uint256 public Pool = 12000000;
    uint256 public PoolBalance;
    uint256 public tokenDecimal;
    uint256 public poolMinStake = 100000;

    uint256 public poolNumber = 2;
    uint256 public poolRewardPercent = 175;
    uint256 public fullMaturityTime = 60 days; 
    ...
    function PoolStake(uint256  _amount) public returns (bool) {
        ...
        require(_amount >= poolMinStake,"Token lower than minimum limit");
        ...
        uint256 stakeRewards = (((_amount*poolRewardPercent)/100)/365)*60;
    ...
    function claimPool() public returns(bool){
        ...
        require(block.timestamp > users[msg.sender].pool_deposit_time + fullMaturityTime,"Unstake time not reached");
