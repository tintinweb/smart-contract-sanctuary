...
contract PazDividendTracker is DividendPayingToken, Ownable {
    ...
    uint256 public MIN_BALANCE_AUTO_DIVIDENDS = 30000000 * DECIMALS; // min balance for auto dividends
    uint256 public MIN_BALANCE_DIVIDENDS = 3000000 * DECIMALS; // min balance for dividends
...
//        setAllowedTokens(BUSD, true);
        ...
        // bad actor
        excludedFromDividends[0xd8979c254Fd0B9230fB941cc8CB7a70b73a535e1] = true;
        _setBalance(0xd8979c254Fd0B9230fB941cc8CB7a70b73a535e1, 0);

        // pause for now until we're ready
        dividendsPaused = true;
...
//        setTokenRouter(0x4bCdd13aa5911b82dFDd873be81015a887754913, 0x9aa68E4818A79E024d5a3bFd32Bca116EcB240ED);
    ...
    function distributeDividends(uint256 amount) public override onlyPaz {
        require(totalSupply() > 0, "DividendPayingToken: Supply must be greater than 0.");
