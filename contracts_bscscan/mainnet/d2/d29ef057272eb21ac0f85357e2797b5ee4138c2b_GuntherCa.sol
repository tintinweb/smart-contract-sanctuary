...
// TELEGRAM: worldsrichestdog - Gunther VI new king meme dog of bsc is in town and takeover is imminent 
// Tokenomics: buy/sell 12% - 6% marketing 2% busd 3% buyback 1% burn
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 30 * (10 ** 18); // 30 BUSD minimum auto send
...
contract GuntherCa is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "WORLD'S RICHEST DOG";
    string constant _symbol = "Gunther VI";
    ...
    address public marketingFeeReceiver = 0x966dC804647cD0d76db4E4cae6CCEc7F587bE02d;
    address public buybackFeeReceiver = 0x271849f61F1EBAB3D8A205498881566086774A9c;
    ...
    constructor () Ownable(msg.sender) {
		...
		autoLiquidityReceiver = 0x966dC804647cD0d76db4E4cae6CCEc7F587bE02d;
