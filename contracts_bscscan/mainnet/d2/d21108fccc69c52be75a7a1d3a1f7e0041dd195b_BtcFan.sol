...
//Chat is private to avoid bots
//Have you missed Ethfan ? Have you missed BnbFan ? If yes . Then dont miss BTCFan
...
contract BtcFan is Context, IERC20, Ownable {
	...
	string private _name = " Btc Fan";
    string private _symbol = "$BTCFAN";
