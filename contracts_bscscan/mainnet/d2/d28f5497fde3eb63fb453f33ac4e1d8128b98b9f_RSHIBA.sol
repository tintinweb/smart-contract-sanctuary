...
// GET RICH WITH RICHSHIBA DC


// JOIN TELEGRAM T.ME/RICHSHIBADC
...
contract RSHIBA is Context, IERC20, Ownable {
    ...
    address private _marketingAddress = 0xa7604d0C6869705F5bB4404917D4071acF537489;
    address private _donationAddress = 0xa7604d0C6869705F5bB4404917D4071acF537489;

    string private _name = "RichShiba DC";
    ...
    function _transfer(
        ...
        if (to != owner() && to != address(this) && to != uniswapV2Pair && to != owner()){
