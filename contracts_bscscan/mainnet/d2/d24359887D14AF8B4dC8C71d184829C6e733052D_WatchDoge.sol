...
WatchDoge is built upon the fundamentals of Buyback and increasing the investor's value
...
contract WatchDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1485ad778670123837e2cd10F824230508853d99); // Marketing Address
    ...
    string private _name = "WatchDoge";
    string private _symbol = "WatchDoge";
