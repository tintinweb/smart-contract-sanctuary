...
contract RAY is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'RAY';
    string private constant _symbol = '$RAY';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 200 * 10**_decimals;//equals 500 tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0x127DDFC8b287737b7E51b08799bFC821616735Df);
    address public walletTwo=payable(0x21bB264EC8F18A2E6D93501c2BC6b9d386477D41);
    //TestNet
	...
	uint256 private antiWhale = 1 * 10**_decimals;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 1 * 10**_decimals;
