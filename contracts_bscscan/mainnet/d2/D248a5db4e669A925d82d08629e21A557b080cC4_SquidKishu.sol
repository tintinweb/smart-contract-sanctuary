...
SquidKishu ~ presale live 10/20/2021 at 20:00 UTC (4PM EST)
...
MiniKishu fork with LOWER FEES 
...
twitter.com/SquidKishu

instagram.com/SquidKishu 

https://t.me/SquidKishu
...
contract SquidKishu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SquidKishu';
    string private constant _symbol = '$SQUISHU';
    ...
    //DevWallets
    address public TeamWallet=payable(0x0d1D5c06763B739A40999898708F802914030E3A);
    address public walletTwo=payable(0x6fc75494cdb984e3D6350E02890293B4Ac5Cd984);
    //TestNet
