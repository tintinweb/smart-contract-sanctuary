...
$FIREROCKET: The legendary sequel to $Pokelon
...
contract FIREROCKET is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x80415b66FFF659343183D824b6DDDc9481D9e8fF); // Marketing Address
    ...
    string private _name = "FIREROCKET";
    string private _symbol = "FIREROCKET";
