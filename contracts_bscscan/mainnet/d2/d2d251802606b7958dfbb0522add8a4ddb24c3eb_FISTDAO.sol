...
contract FISTDAO is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0xc905db53Ba55DA35eBAaD25305B1C55A6E2f2AFB);
    address public devAddress = address(0xc905db53Ba55DA35eBAaD25305B1C55A6E2f2AFB);
