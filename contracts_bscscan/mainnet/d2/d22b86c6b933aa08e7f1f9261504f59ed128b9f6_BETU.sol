...
/**
 * 
⚡️ BetU is a sports, esports & crypto betting platform, secured by smart contracts and powered by the $BETU token. 
⚡️ With a strong team and developers we are ready to give power back to the people!

🚫Peer to peer betting for better odds and bigger winnings.
🤜Exchange partner ready for after the ICO completion
👀Doxxed Experienced Team
😍Marketing Presence and Brand Ambassadors
💲Upcoming fantasy betting game - No risk, only real rewards.
⚡Get in the public sale for up too 25% discount
👌 Audited by Hacken


🔹With every winning bet #BETU is getting burned.
🔹 The BetU Charity supports vulnerable children impacted by gambling addiction.

Promo video: https://www.youtube.com/watch?v=dcm2ZLfk1Vc 
*/
...
contract BETU is Context, IERC20, Ownable {
