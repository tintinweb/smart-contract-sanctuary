...
Telegram - https://t.me/OfficialBabyBSC
Website - www.Babybsc.com
...
import "./BBSCDividendTracker.sol";

contract BBSC is ERC20, Ownable {
    ...
    BBSCDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("BABY BSC", "BBSC") {

    	dividendTracker = new BBSCDividendTracker();

        _marketingWalletAddress = 0xaD694bf48C10497cF017B3a923e8A494834EE8A9;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BBSC: The dividend tracker already has that address");

        BBSCDividendTracker newDividendTracker = BBSCDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BBSC: The new dividend tracker must be owned by the BBSC token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BBSC: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BBSC: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BBSC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BBSC: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BBSC: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BBSC: Cannot update gasForProcessing to same value");
