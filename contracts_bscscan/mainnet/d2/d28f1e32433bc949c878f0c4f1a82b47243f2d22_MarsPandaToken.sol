...
// File: MarsPandaToken.sol

pragma solidity ^0.6.2;

contract MarsPandaToken is ERC20Capped, ERC20Burnable {
    ...
    constructor()
        public
        ERC20('Mars Panda Token', 'MPT')
        ERC20Capped(88000000000000000000000000)   // Cap at 88 mil token
        { 
