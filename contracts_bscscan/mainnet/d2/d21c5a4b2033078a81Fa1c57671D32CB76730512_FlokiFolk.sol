...
2% marketing fee destinated to help the project

I will burn lock LPs and extend as project grows.
I will renounce the ownership to burn addresses to transfer $FlokiFolk to the community, make sure it's 100% safe.

100,000,000,000,000,000 total supply
500,000,000,000,000 Folk max limit for per trade
...
pragma solidity ^0.6.12;
    ...
    contract FlokiFolk is Context, IERC20, Ownable {
        ...
        string private _name = 'FlokiFolk';
        string private _symbol = '$FlokiFolk';
        ...
        uint256 private _maxTxAmount = 500000000000000e9;
        ...
        function _setmarketingFee(uint256 marketingFee) external onlyOwner() {
            require(marketingFee >= 1 && marketingFee <= 8, 'marketingFee should be in 1 - 8');
