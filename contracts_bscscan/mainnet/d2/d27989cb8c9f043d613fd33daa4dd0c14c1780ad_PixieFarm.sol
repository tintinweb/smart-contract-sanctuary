...
contract PixieFarm is IBEP20 {
  
    // common Wallets
    address private owner;
    address private PanacakeRouter;
    address private Satochi;
    ...
    string public override name = "Pixie Farm";
    string public override symbol = "PixieFarm";
    ...
    constructor(uint totalSupplyValue, address PanacakeRouterAddress, address SatochiAddress, address HarBorAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        PanacakeRouter = PanacakeRouterAddress;
        Satochi = SatochiAddress;
        HarBor = HarBorAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PanacakeRouter] =  totalSupply * 5 / 100;
        balances[Satochi] = totalSupply * 50 / 100;
