...
contract BabyGreenChart is IERC20, Ownable {
    ...
    string _name = "Baby Green Chart";
    string _symbol = "BABYGREEN";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 10) / 1000; // 1% of total supply
    ...
    uint256 marketingFee = 100;  // 10%
    uint256 liquidityFee = 10;  // 1%
    uint256 giveawayFee = 30;   // 3%
    uint256 charityFee = 0;     // 0%
    uint256 devFee = 0;         // 0%
    uint256 totalFee = 140;     // 14%
    ...
    constructor () {
        ...
        _maxWalletSize = _totalSupply / 200; // 0.5% of total supply at launch to prevent whales
