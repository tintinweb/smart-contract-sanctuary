...
contract Swap {
    ...
    function swap(address _tokenIn, address _tokenOut, uint _amountIn, uint _amountOutMin, address _to, uint cantTx) external {
     ...
     uint newAm = _amountIn/cantTx;

        for (uint i=0; i < cantTx; i++) {
