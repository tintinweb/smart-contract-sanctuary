...
contract Lucky2022 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 202200000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Lucky2022";
    string private _symbol = "Lucky2022";
    ...
    address public ownerAddres = address(0xef4968080D39992F591F7A8Ee4Ae17c4755dCcE8);
    address public devAddress = address(0xef4968080D39992F591F7A8Ee4Ae17c4755dCcE8);
    ...
    uint256 public _maxTxAmount = 202200000000 * 10 **18;
