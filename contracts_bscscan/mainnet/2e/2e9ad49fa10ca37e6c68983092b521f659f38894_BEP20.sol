...
contract BEP20 is Context, IBEP20, Ownable {
 ...
 //SPDX-License-Identifier: MIT
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external returns (bool) {
    ...
    _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "Chow Chow Inu: transfer amount exceeds allowance"));
    return true;
  }
  ...
  function _mint(address account, uint256 amount) internal {
    require(account != address(0), "Chow Chow Inu: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "Chow Chow Inu: burn from the zero address");
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    require(owner != address(0), "Chow Chow Inu: approve from the zero address");
    require(spender != address(0), "Chow Chow Inu: approve to the zero address");
