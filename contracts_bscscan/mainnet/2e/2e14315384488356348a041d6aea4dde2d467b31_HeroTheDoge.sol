...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x813dA275E9738a4eEf1Ae95CeB0E838333b9A086;
...
contract HeroTheDoge is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0x2f7964056E100b1e78C8d258c031F85B4D00e78F ;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HeroTheDoge ";
    string private _symbol = "HTDOGE" ;
