...
/**
   ...
   Welcome to DOGERAMEN
   
   This is a community token. If you want to create a telegram I suggest to name it to @DOGERAMENBSC
   ...
   I will renounce the ownership to burn addresses to transfer #DOGERAMEN to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #DOGERAMEN 10000X? 
   ...
   it's the best part of the #DOGERAMEN idea, increasing the liquidity pool automatically, 
...
contract DOGERAMEN is Context, IERC20, Ownable {
    ...
    string private _name = "DOGERAMEN";
