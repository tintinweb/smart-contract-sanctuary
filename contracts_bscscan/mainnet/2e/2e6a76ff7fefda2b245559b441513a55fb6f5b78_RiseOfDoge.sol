...
contract RiseOfDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xdB31144Aa19EB7e45E8C6Da9B478136b4F60629F); // Marketing Address
    ...
    string private _name = "RiseOfDoge";
