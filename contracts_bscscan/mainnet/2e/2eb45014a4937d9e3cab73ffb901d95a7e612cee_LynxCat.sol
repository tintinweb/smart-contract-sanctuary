...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xB6549491dC3Fe9fE36E0DAc20b6aD83f21093cb6); // PHI
...
contract LynxCat is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xB6549491dC3Fe9fE36E0DAc20b6aD83f21093cb6; // PHI
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // address WBNB = 0xae13d989dac2f0debff460ac112a837c89baa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address teamFeeReceiver = 0x36e1E775b8642D7e5F8BEE8bC34d572b6Fba9E74;

    string constant _name = "LynxCat";
    ...
    uint256 public totalFee = 91; //Total Fee
    uint256 feeDenominator  = 100;

    uint256 liquidityFeeBuy    = 12;
    ...
    uint256 giveawayFeeSell     = 20;
    uint256 public totalFeeSell = 91; //Total Fee
    ...
    uint8 public cooldownTimerInterval = 10; // In Seconds
