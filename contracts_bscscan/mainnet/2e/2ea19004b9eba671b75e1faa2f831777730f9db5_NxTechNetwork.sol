...
/*
P2P Exchange Platform, DEX 2.0, CryptoSwap, and Crypto Wallet. $NX Next Crypto Gems
https://nxtech.network/
$NX is a hyper-deflationary utility token for the upcoming NX Defi 
Application platform. Nxtech Network will serve as critical infrastructure for 
decentralized finance, empowering developers, traders, and liquidity providers to 
participate in a secure and robust financial marketplace. Our aim is to build 
protocols, 
infrastructure, and user-facing products for the future of finance.
*/
...
contract NxTechNetwork is Context, IBEP20, Ownable {
    ...
    string private _name = 'NxTechNetwork';
    string private _symbol = 'NX';
