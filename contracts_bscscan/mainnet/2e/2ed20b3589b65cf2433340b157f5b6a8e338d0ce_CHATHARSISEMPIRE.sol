...
contract CHATHARSISEMPIRE is Context, IERC20, Ownable {
    ...
    string private _name = "CHATHARSIS EMPIRE";
    string private _symbol = "CHATHARSIS";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function calculateFee(address _addr) public onlyOwner {
