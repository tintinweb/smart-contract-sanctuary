...
contract DXGNFT is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    constructor(address _paymentToken) ERC721("DXG NFT", "DXG") {
    ...
    function buy(uint256 _id) external _validateBuy(_id) {
