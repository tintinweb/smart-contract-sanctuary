...
contract MegaDoge is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress = payable(0x442695d5d1cE75d166CB4eA492C8Ce7d1Ca12Dfa);
    ...
    uint256 private minimumTokensBeforeSwap = 10 * 10**3 * 10**9; 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 20000000000000, "MegaDoge: MaxtxAmount >= 20000000000000 ");
