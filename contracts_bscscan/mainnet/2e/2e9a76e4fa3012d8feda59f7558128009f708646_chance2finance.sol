...
contract chance2finance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 259333 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tDonationTotal;

    string private _name = "chance2.Finance";
    string private _symbol = "cFin";
    ...
    uint256 public _maxTxAmount = 259333 * 10**9;
    uint256 private minimumTokensBeforeSwap = 200 * 10**9; 
    
    address payable public charityAddress = 0x94C3014c0D532059C24D600d98f28621EB180E3E; 
