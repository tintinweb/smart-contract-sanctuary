...
// File: contracts/DrakeballSuper.sol

pragma solidity ^0.8.0;

contract DrakeBallPlanetN is BEP20 {
    using SafeMath for uint256;
    uint256 public maxSupply = 250 * 10**6 * 10**18;
    
    /**
     * @notice Constructs the DrakeballToken contract.
     */
