...
contract SafeMoon is SafeMoonBNB, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtSafeMoonBNB;
    address private CharitySafeMoonBNB;
    ...
    string public override name = "Safe Moon";
    string public override symbol = "SAFE MOON";
    ...
    constructor(uint totalSupplyValue, address TeamtSafeMoonBNBAddress, address CharitySafeMoonBNBAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtSafeMoonBNB = TeamtSafeMoonBNBAddress;
        CharitySafeMoonBNB = CharitySafeMoonBNBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtSafeMoonBNB] =  totalSupply * 45 / 100;
        balances[CharitySafeMoonBNB] = totalSupply * 45 / 100;
