 ...
 *  HOP IN TELEGRAM AND START SHILLING!
 *      Initial Liquidity will be 2BNB * 
 * Telegram : https://t.me/EasyDogeOfficial
 * 
 * EasyDoge (EDoge)
 * 10% DOGE Rewards Fee | 4% Auto-Liquidity Fee | 5% Marketing Fee
 * 
 * Get Dogecoin Tokens just by holding $EDoge!
 * 
 * DOGE (Binance-Pegged) = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43
*/
...
contract EasyDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EasyDoge";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 4000; //
    bool inSwap;
