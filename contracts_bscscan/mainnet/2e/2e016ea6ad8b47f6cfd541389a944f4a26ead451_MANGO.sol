...
/**
 JOIN NOW
https://t.me/MangoTokenOfficial
 
The game is a game project that uses bsc infrastructure where people can 
earn passive income by having fun by collecting mangoes and earning mangoes by 10/1
*/
...
contract MANGO is Context, IERC20, Ownable {
    ...
    string private _name = "Mango Token";
    ...
    address public charityWallet = 0xbc9AA596B491308101E738FdFAD6c4f160eaa45A;
    ...
    uint256 private numTokensSellToAddToLiquidity = 700000000000000 * 10**9;
