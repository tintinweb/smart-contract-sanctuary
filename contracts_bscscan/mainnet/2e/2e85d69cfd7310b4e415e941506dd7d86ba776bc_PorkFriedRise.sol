...
/**
 ——————————————————————————————————————————————————————————————————————————————————————————————————
 Telegram - https://t.me/PorkFriedRiseBSC
——————————————————————————————————————————————————————————————————————————————————————————————————
PorkFriedRise is a an autostaking, deflationary and completely community driven token! 
——————————————————————————————————————————————————————————————————————————————————————————————————
There is an 12% tax to continuously move this project forward and up!!!:
1% will be reflected back to token holders, earn tokens by simply holding them
5% for marketing fund: Generated funds to go to marketing the token; all will clamor for marketing...well most will cost money :)
5% added back to the liquidity pool: We need this to reduce the price impact and contiuously improve the value of the token
1% will be automatically sent to black hole: To keep burning tokens in circulation leading to an increase in price automatically
——————————————————————————————————————————————————————————————————————————————————————————————————
...
contract PorkFriedRise is Context, IERC20, Ownable {
    ...
    string private _name = "Pork Fried Rise";
    ...
    address public marketingWallet = 0x0d050F93fE92AC25A059C2284A4a96Ee3d84C6C3;
