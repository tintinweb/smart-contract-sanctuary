...
contract AE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x41feA9dBA7D7B0FcF7362F93d2f7058628A5d2D0); // Marketing Address
    address payable public devWalletAddress = payable(0x76C67325627F2beC1589388C89c462AEb5a18fd2); // Dev Address
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _totalLiqFee = 0;
        _prevTotalLiqFee = 0;
        _maxTxAmount = 500000000000000 * 10**6 * 10**9;
    }
