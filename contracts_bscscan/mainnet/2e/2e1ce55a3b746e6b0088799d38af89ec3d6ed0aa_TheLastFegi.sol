...
contract TheLastFegi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxSellTransactionAmount = 1000000000 * (10**18); // 1.5% of total supply
    ...
    constructor() ERC20("TheLastFegi", "FEGI") {
    	...
    	buyBackWallet = 0x9a78f2dDC83Aa293C949634423B1D5B056bF94b6;
