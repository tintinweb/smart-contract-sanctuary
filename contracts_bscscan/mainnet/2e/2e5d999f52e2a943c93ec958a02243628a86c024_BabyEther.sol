...
contract BabyEther is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x13d4C51EFAEB8E3E440922527E8215D8bEcbf6FF); // Marketing Address (deployer)
    ...
    uint256 public _liquidityFee = 6 * 2;
