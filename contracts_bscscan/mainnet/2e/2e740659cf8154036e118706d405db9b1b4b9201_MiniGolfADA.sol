...
/*
Mini Golf Ada ($MGADA) Official Contract


🌐 Website: http://minigolfadabsc.com

📞 TG: https://t.me/MiniGolfada_bsc

📲 Twitter: https://twitter.com/MiniGoLFAda
...
contract MiniGolfADA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xED52606668001403790a7A8979a6071f9cFD28b6); // Marketing Address
    ...
    string private _name = "Mini Golf ADA";
    string private _symbol = "MGADA";
    ...
    uint256 private _botNeedsPrevention = 7;
    ...
    uint256 private minTknBfrSwp= 20 * 10**6 * 10**9; 
    ...
    // Prevent BOT & Whales
    function zPreventWhales() public deadCall {
