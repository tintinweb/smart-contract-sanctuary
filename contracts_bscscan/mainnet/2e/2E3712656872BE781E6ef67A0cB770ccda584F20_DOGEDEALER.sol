...
/**
   ...
   Welcome to DOGEDEALER
   
   This is a community token. If you want to create a telegram I suggest to name it to @DOGEDEALER
   ...
   I will renounce the ownership to burn addresses to transfer #DOGEDEALER to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #DOGEDEALER 10000X? 
   ...
   it's the best part of the #DOGEDEALER idea, increasing the liquidity pool automatically, 
...
contract DOGEDEALER is Context, IERC20, Ownable {
    ...
    string private _name = "DOGEDEALER";
    string private _symbol = "DDEALER";
