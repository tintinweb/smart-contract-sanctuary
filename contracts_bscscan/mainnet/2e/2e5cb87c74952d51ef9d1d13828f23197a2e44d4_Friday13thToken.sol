...
contract Friday13thToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 13 * 10**12 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name   = "Friday13thToken";
    string private _symbol = "FRI13";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 4;   //Frictionless Yield Fee
    ...
    uint256 public _maxTxAmount = 13 * 10**12 * 10**18;
