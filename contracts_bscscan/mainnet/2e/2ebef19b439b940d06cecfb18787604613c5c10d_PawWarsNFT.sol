...
contract PawWarsNFT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PawWarsNFT", "PawWarsNFT") {
        cakeDividendTracker = new CakeDividendTracker();
        thoreumDividendTracker = new ThoreumDividendTracker();

        marketingWallet = 0x93a36c238b355c1AF680adC8d0d2ae015a4d36c1;
        teamWallet = 0xaC507f7eC936C057280E843cf616ba7fa7076b8a;
        cakeDividendToken = 0x08ba0619b1e7A582E0BCe5BBE9843322C954C340;
        thoreumDividendToken = 0x08ba0619b1e7A582E0BCe5BBE9843322C954C340;
