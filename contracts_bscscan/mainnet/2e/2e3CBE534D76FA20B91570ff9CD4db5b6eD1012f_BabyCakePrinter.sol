...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
...
contract BabyCakePrinter is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xdB8D30b74bf098aF214e862C90E647bbB1fcC58c;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyCakePrinter";
    string constant _symbol = "BCPRINTER";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1,000,000,000,000,000
        uint256 public _maxTxAmount = _totalSupply / 60000; // 6%
