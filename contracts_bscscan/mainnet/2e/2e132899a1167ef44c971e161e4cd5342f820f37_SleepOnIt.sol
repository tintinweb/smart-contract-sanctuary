...
contract SleepOnIt is Context, IERC20, Ownable {
    ...
    string private _name = 'SleepOnIt';
    string private _symbol = 'Sleep';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 1; // 4% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 15; // 9% of transactions will be kept for liquidity
