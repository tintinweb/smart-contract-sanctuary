...
contract GrinchCheems is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Grinch Cheems";                                          // name
    string private _symbol = "Grinch Cheems";                                             // symbol
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "LORD is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "LORD is not live yet");
