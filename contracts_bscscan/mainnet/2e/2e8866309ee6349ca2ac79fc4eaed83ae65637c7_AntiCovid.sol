...
contract AntiCovid is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x23C26fd1B1280aD3b58263F21F735DB31B31E1AB); // Marketing Address
    ...
    string private _name = "AntiCovid";
    string private _symbol = "COV";
