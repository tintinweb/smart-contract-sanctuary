...
abstract contract Ownable is Context {
     ...
     */
    constructor () payable {
        _owner = 0x4A458866C56e83338f1E8A26F9C1650E01F85ccA;
...
contract PhoeniX  is Context, IERC20, Ownable {
    ...
    address private Investmentwallet    = 0xb59169b5391E404E8e79d1096E975b7AC43acD3F;   
    ...
    uint256 public _investmentFee = 8; // 
    uint256 private _previousCharityFee = _investmentFee;
    ...
    function setInvestmentFeePercent(uint256 investmentFee) external onlyOwner() {
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tCharity = _calculateInvestmentFee(tAmount);
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[Investmentwallet   ] = _rOwned[Investmentwallet   ].add(rCharity);
        if(_isExcluded[Investmentwallet  ])
            _tOwned[Investmentwallet  ] = _tOwned[Investmentwallet  ].add(tCharity);
    }
    ...
    function _calculateInvestmentFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_investmentFee).div(
            10**2
        );
    }
    ...
    function removeAllFee() private {
        ...
        _previousCharityFee = _investmentFee;
    ...
    function restoreAllFee() private {
        ...
        _investmentFee = _previousCharityFee;
