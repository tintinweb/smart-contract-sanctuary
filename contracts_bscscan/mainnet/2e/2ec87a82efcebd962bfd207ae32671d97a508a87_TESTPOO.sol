...
TOKENOMICS
7% POOCOIN REWARDS plus MARKETING & DEVELOPMENT and AUTO-LIQUIDITY -
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 POOCOIN = IBEP20(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = POOCOIN.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(POOCOIN);
        ...
        uint256 amount = POOCOIN.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            POOCOIN.transfer(shareholder, amount);
...
contract TESTPOO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TESTPOO";
    string constant _symbol = "TPOO";
