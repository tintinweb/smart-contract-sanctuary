...
contract LilShibX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd68BC0Ff66749DC0c08154DB930BED58ea7115Bd); // Marketing Address
    ...
    string private _name = "LilShibX";
    string private _symbol = "LILSHIBX";
