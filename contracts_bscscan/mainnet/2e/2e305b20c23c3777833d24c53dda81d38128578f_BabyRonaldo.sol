 ...
 * Symbol: BABYRONALDO
 * 
 * Website: http://babyronaldo.com/ 
 * Telegram: https://t.me/BabyRonaldoCR7
 * Twitter: https://twitter.com/BabyRonaldoCR7
 * 
 ...
 * Token Economics
 * 
 * $BABYRONALDO is a BTCB Token reflection token (a BEP-20 token pegged to Bitcoin)
 * 
 * BUY Tax
 * 5% marketing ~ 2% liquidity ~ 3% reflection in BTCB
 * 
 * SELL Tax
 * 5% marketing ~ 2% liquidity ~ 8% reflection in BTCB
 * 
 * Reflections will be redistributed in BTCB (pegged to Bitcoin) to the holders by an 
 * automatic claim mechanism. Every hour BTCB rewards will be sent to the holders automatically.
 */
...
contract BabyRonaldo is Context, IBEP20, Ownable { 
    using SafeMath for uint256;
    ...
    address public externalAddress = 0x4712892583b51Db9Da973AD579cED62d42627cf0; 
    address public autoLiquidityReceiver = 0x8cDD991859b1df0B10D95F05d96F3f8ba53D9008;

    string constant _name = "BabyRonaldo";
    string constant _symbol = "BABYRONALDO";
    ...
    uint256 public _maxTxAmount = 2000000 * 10**6 * 10**_decimals; // 0.5%
    uint256 public minTokensBeforeSwapThreshold = _totalSupply / 200000; // 0.0005%
