...
contract IGN is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;

    address deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingAddress = payable(0xAe7801cb078faae97213b7b64918235bdf65b2Ef);
    ...
    uint256 private _tTotal = 21000000000 * 10**15;  //total supply. 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Institute of Humanities"; //token name
    string private _symbol = "IGN"; // token symbol. 
    ...
    uint256 public _maxTxAmount = 2100000000 * 10**15;
    uint256 private minimumTokensBeforeSwap = 21000 * 10**15; 
    ...
    {
        uint256 __totalFee = _liquidityFee.add(_marketingFee);
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 21000000000 * 10**15;
    }
