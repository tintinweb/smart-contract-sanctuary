...
/**
 * TG: https://t.me/PiggyBankETH
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * PiggyBankETH gathers PiggyBankETH and delivers direct to your wallet!!!!
*/
...
contract PiggyBankETH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PiggyBankETH";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "PiggyBankETH";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xFd557493368c5C1affdfA22128826027955357AF;
