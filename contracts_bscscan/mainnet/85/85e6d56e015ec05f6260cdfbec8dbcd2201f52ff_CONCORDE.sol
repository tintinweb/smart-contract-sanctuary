...
contract CONCORDE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CONCORDE";
    string constant _symbol = "CONCORDE";
    ...
    address public ConcordeWallet;
    address public SurpriseFund;
    ...
    constructor () Auth(msg.sender) {
        ...
        BNBTREASURY = msg.sender;
        
        isFeeExempt[autoLiquidityReceiver] = true;
        isFeeExempt[BNBTREASURY] = true;
        isFeeExempt[address(this)] = true;

        isTxLimitExempt[autoLiquidityReceiver] = true;
        isTxLimitExempt[BNBTREASURY] = true;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(BNBTREASURY).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(BNBTREASURY).transfer(amountBNB * amountPercentage / 100);
    }
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver) external onlyOwner {
        ...
        BNBTREASURY = _marketingFeeReceiver;
    }
