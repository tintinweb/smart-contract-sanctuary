...
// WELCOME TO THE JDM COMMUNITY. PLEASE NOTE THIS TOKEN IS FOR ENTERTAINMENT PURPOSES ONLY 
// PLEASE DO YOUR OWN RESEARCH BEFORE SWAPING
// OUR TOKENOMICS ARE 12% FEE. 4% TO DEPLOYERS, 2% TO CHARTIY, 2% BURNED, 2% TO LIQUIDITY ON PANCAKESWAP, 2% REDISTRIBUTED
...
contract JDMCToken is Context, IERC20, Ownable 
{
    ...
    string private _name = "JDM Community Token";
    string private _symbol = "JDMCT";
    ...
    address public charityWallet =  0x3EAeADdb76B5eF3e8542F19A658C15acd8B5CE57;  
    address public developmentWallet =  0x059B9B3E0EA467E61d23D0d635125b6DEC25fA06;
    address public developmenttwoWallet =  0xb929edF244de5c58d67cF4c11A354201E306D0ad;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        if(amtWalletS>0)
        {
           ...
           _transferStandard(sender, developmenttwoWallet, amtWalletS.div(3));
        }
    ...
    function setdevelopmenttwoWallet(address newWallet) external onlyOwner() 
    {
        developmenttwoWallet = newWallet;
    }  
