...
- Token Information
Sell cooldown increases on consecutive sells, 3 sells within a 12 hours period are allowed
...
contract DonutCat is Context, IERC20, Ownable {
    ...
    uint256 private constant minBalance = 10**11 * 10 ** 18;
