...
contract BAKEON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BAKEON", "BAKEON") {
        cakeDividendTracker = new CakeDividendTracker();
        bakeDividendTracker = new BAKEDividendTracker();

        marketingWallet = 0x3cC5bF8C77176141c5F7F3203685e0b0BEcb3B48;
        teamWallet = 0x7FEB049B826c4D015D00f20F4f96CE2baF69525E;
        cakeDividendToken = 0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5;
        bakeDividendToken = 0x580dE58c1BD593A43DaDcF0A739d504621817c05;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newCakeDividendTracker.owner() == address(this), "must be owned by BAKEON");
    ...
    function updateBAKEDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newBAKEDividendTracker.owner() == address(this), "must be owned by BAKEON");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Cake_Dividend_Tracker", "Cake_Dividend_Tracker", 0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5) {
        claimWait = 3600;
...
contract BAKEDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BAKE_Dividend_Tracker", "BAKE_Dividend_Tracker", 0x580dE58c1BD593A43DaDcF0A739d504621817c05) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
