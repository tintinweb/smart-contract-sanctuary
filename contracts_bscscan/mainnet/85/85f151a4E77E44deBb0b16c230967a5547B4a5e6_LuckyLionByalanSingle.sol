...
// File contracts/bsc/interfaces/luckylion/IMasterChef.sol
...
interface IMasterChef {
    ...
    struct PoolInfo {
        ...
        uint256 accLuckyPerShare;
        uint256 harvestTimestamp;
        uint256 farmStartDate;
    }
...
// File contracts/bsc/byalan/luckylion/LuckyLionByalanSingle.sol
...
contract LuckyLionByalanSingle is ByalanIsland, Sailor, IByalan {
    ...
    address public constant LUCKY = 0xc3D912863152E1Afc935AD0D42d469e7C6B05B77;
    address public immutable override want;

    // Third party contracts
    address public constant MASTERCHEF = 0xB6FE67c8a28d50c50f65fDb5847Ee4477c550568;
    uint256 public immutable pid;

    // Routes
    address[] public luckyToWbnbRoute;
        ...
        )
    {
        ...
        luckyToWbnbRoute = [LUCKY, BUSD, WBNB];
    ...
    function chargeFees() internal {
        uint256 toBnb = (IERC20(LUCKY).balanceOf(address(this)) * totalFee) / MAX_FEE;
        IUniswapV2Router02(unirouter).swapExactTokensForETH(toBnb, 0, luckyToWbnbRoute, address(this), block.timestamp);
        ...
        returns (IERC20[] memory rewardTokens, uint256[] memory rewardAmounts)
    {
        ...
        rewardTokens[0] = IERC20(LUCKY);
        rewardAmounts[0] =
            IMasterChef(MASTERCHEF).pendingLucky(pid, address(this)) +
            IERC20(LUCKY).balanceOf(address(this));
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(LUCKY).safeApprove(unirouter, type(uint256).max);
    }

    function _removeAllowances() internal {
        IERC20(want).safeApprove(MASTERCHEF, 0);
        IERC20(LUCKY).safeApprove(unirouter, 0);
    }
