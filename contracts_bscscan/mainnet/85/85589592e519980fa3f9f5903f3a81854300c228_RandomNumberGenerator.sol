...
// File: contracts/interfaces/INSBCLottery.sol

pragma solidity ^0.8.4;

interface INSBCLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in Nsbc per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in Nsbc token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInNsbc: price of a ticket in Nsbc
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the NSBC lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == nsbcLottery, "Only NSBCLottery");
    ...
    /**
     * @notice Set the address for the nsbcLottery
     * @param _nsbcLottery: address of the nsbc lottery
     */
    function setLotteryAddress(address _nsbcLottery) external onlyOwner {
        nsbcLottery = _nsbcLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = INSBCLottery(nsbcLottery).viewCurrentLotteryId();
    }
}