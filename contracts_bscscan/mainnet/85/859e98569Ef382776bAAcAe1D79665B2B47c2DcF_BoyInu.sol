...
((_)_   )\ (()/( (_))   )\ )  /((_) 
 ...
 |___/\___/ \_, ||___||_||_|  \_,_| 
            |__/                    
 https://t.me/BoyInuOfficial
 
 - SUPPLY : 5 Trillion ---- 5 000 000 000 000
 - MAX WALLET : 2% -------- 20 000 000 000 (ANTI DUMP Mechanism)
...
contract BoyInu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BoyInu"; 
    string constant _symbol = "BoyInu";
    ...
    constructor () {
        ...
        marketingfee = address(0x072d6dCF9aD733a2B49f0DEd1b8A577B28297514);
    ...
    function swapBack() internal swapping {
        ...
        (bool success,) = payable(marketingfee).call{value: amountBNBDev, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingfee) external onlyOwner {
