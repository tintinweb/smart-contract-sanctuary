...
/*
*
*   I just want BSC of March back, as a present for this year
*
*   https://boards.4channel.org/biz/thread/44934129
*
*/
...
contract BringBSCBack is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Bought two shitcoins yesterday. My reasoning was 'whoever made these shitcoins will wait aleast a few days before rugging, theres no point in rugging for a few hundred bucks'. Well, I went to sleep and this shit fucking rugged. It's over this board is just a bunch of stinky jeets at this point";
    string constant _symbol = "BringBSCBack";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xFb485881d40BBef3961BE03a64f7ADC3506d288a;
