...
contract BATMAN is IBEP20, Auth {
    ...
    uint256 public limitSwap = _totalSupply * 4 / 10000;
    IDEXRouter router;
    address public pair;
    ...
    function _transferfrom(address sender, address recipient, uint256 amount) internal returns (bool){
        ...
        if(sender == pair &&
            bFreeze &&
            !isTimeloE[recipient]){
            require(bcoolin[recipient] < block.timestamp,"Please wait for cooldown between buys"); 
            bcoolin[recipient] = block.timestamp + bFreezeT;} 
