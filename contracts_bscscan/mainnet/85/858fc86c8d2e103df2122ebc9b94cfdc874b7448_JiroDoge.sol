...
🔥🔥🔥FAIR LAUNCH!🔥🔥🔥
   🔥🔥🔥 100x Potential 🔥🔥🔥
JiroDoge token is a Community based Token builded to provide Smoother and Trouble-free transaction on BSC Network with also built-in Automated Rewards Farming (ARF) system.
...
🐶 Website : https://countingdownto.com/countdown-pages/eaojuFeO
...
contract JiroDoge is Context, IERC20, Ownable {
    ...
    string private _name = "JiroDoge";
    string private _symbol = "JiroDoge";
