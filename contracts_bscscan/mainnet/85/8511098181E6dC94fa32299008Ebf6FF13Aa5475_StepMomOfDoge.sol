...
/**
 ...
 StepMomOfDoge by MarkustheWhale

 @StepMomOfDoge
https://StepMomOfDoge.com/
...
contract StepMomOfDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x65400D9de770911CDA22F96C83e8EFf11C2B73a8); // Marketing Address

    address payable public teamAddress =
        payable(0xd8F6A774E235753c3ddB94091Bd4837E5E4dFF23); // Team Address

    address payable public liquidityAddress =
        payable(0xAE5585bc252a91AE1B0999A23F25f27661205535); // Liquidity Address
    ...
    string private constant _name = "StepMomOfDoge";
    string private constant _symbol = "SMOD";
