...
contract ShibaNet is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "ShibaNet: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ShibaNet: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}
contract ShibaFlix is IBEP20, Context, ShibaNet {
    ...
    string public override name = "Shiba Flix";
    string public override symbol = "Shiba Flix ";
