...
/**
Token:    MetaDollars (MUSD)
Website:  https://metadollars.io
Telegram: https://t.me/MetaDollarsBSC
Twitter:  https://twitter.com/MetaDollarsBSC
Buy:      https://pancakeswap.finance/swap?outputCurrency=0x85c5fbd34dab134b867e39a6709962f54f0c442a
...
MetaDollars (MUSD) is a reward token providing the highest USDC rewards on the Binance Smart Chain. 
...
contract MetaDollars is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "MetaDollars";
    ...
    uint256 public _walletMax = _totalSupply * 3 / 100;   // max wallet 3.000.000.000 tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xF9bCd0068662D9497fe94ff943C95D5daD7C61C0;
        marketingWallet = 0x580770D798F9033A4Eb58f800B69468Eb77860b6;
