...
contract PiggySafe is Context, IERC20, Ownable {
    ...
    string private _name = "PiggySafe";
    ...
    function setCharityAddress(address payable charity) public onlyOwner {
        _charityAddress = 0xA489f9038e75783D8226dd3B610b46C9bD1187a0;
    }
    
    function setMarketingDevAddress(address payable marketing) public onlyOwner {
        _marketingDevAddress = 0x455874152dF4Ad1675EBce2fC22466AebDc46aA2;
    }
