...
contract GrinchBonk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x808844775Dd46b1a760Fdd2aF375EdB97343A16E;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "Grinch Bonk";
    string constant _symbol = "GRINCHBONK";
