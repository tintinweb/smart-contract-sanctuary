...
/**
 * TG: https://t.me/PolkadotPerry is an association coin meant for preserving platypuses, come join us for the ride to the moon !!
...
contract PolkadotPerry is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PolkadotPerry";
    string constant _symbol = "PolkadotPerry";
