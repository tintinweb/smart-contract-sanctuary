...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 Alpaca = IERC20(0x8F0528cE5eF7B51152A59745bEfDD91D97091d2F);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Alpaca.balanceOf(address(this));
        ...
        uint256 amount = Alpaca.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Alpaca.transfer(shareholder, amount);
...
contract Jailtoothpick is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Jailtoothpick";
    string constant _symbol = "JTP";
