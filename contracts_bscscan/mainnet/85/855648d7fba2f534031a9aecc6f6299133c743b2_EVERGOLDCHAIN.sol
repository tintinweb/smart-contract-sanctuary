...
🚨 - Launch on 12th August. 18:00 UTC 🕔
...
Join our Telegram: https://t.me/Evergoldchain

🍀Fees are only ever charged when EverGOLD is sold, never when bought. This helps to make investing easier for those without massive buying power.
...
EVERGOLDCHAIN is ensuring that the rewards continue to flow through a ‘Rewards Pool’. An added tax that gets stored away in a Contract and is able to fund the Rewards Contract (Redistribution) when volume is generally low
...
___
Telegram: https://t.me/Evergoldchain
Twittter: https://twitter.com/EverGOLDChain
Website: https://evergold.finance
...
contract EVERGOLDCHAIN  is Context, IERC20, Ownable {
    ...
    string private _name = "EGOLDCHAIN";
