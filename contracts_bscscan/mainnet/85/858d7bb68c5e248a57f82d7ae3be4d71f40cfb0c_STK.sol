...
contract STK is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xE49F1C0bE4d2FA8e0360eBeB4948ef2563B23AdA); // Marketing Address
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xE49F1C0bE4d2FA8e0360eBeB4948ef2563B23AdA);
    }
