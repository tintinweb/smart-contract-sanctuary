 ...
 * Private allocation for Project "Xp.network" with the code CBAXPNETWORK. Each coin 
 ...
 * The contract will have a public dead wallet 0x282f07F5678a1d06396930014C01eD75f3713Ab0, 
...
contract CBAXPNET is Context, IERC20, Ownable {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "Bees-CBA-XP";
    string private _symbol = "CBAXPNET";
