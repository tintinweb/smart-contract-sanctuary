...
/* 
 Tokenomics: 5% REWARDS 2% LIQUIDITY 4% Marketing
 Extra 5% reflection to reward holders
 Official TG: https://t.me/BULLBUSDbsc
*/ 
...
contract BULLBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BULLBUSD";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xCc7cCc05aF07B9F35554e5B3E335bAb85AB986BB;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling) { return totalFee.add(reflectionFee); }
        return totalFee;
    }
