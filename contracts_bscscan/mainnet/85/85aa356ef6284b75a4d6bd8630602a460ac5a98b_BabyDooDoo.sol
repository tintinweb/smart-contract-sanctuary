...
contract BabyDooDoo is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "BabyDooDoo";
    string private constant _symbol   = "BDD";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 0; // 0% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 500; // 5% of every transaction is kept for liquidity
    uint256 public _marketingFee = 0; // 0% of every transaction is sent to marketing/buyback wallet
