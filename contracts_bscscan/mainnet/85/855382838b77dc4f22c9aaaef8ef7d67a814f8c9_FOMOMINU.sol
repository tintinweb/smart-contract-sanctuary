...
/**
   ...
   Our token/coin will deflate itself in supply with every transaction
...
contract FOMOMINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 841380000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FOMOINU";
