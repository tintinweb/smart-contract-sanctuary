...
contract SEIJUROINU is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Seijuro Inu";
    string constant _symbol = "SEIJURO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2000) / 1000; // 2% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 4000) / 1000; // 4%
