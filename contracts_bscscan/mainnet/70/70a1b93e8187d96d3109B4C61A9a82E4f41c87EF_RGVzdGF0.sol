...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ANON = IBEP20(0xFd78aAEd1e3f2d06DbDE9510C6dC14112eCA896D);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = ANON.balanceOf(address(this));
        ...
        uint256 amount = ANON.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ANON.transfer(shareholder, amount);
...
contract RGVzdGF0 is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xFd78aAEd1e3f2d06DbDE9510C6dC14112eCA896D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "RGVzdGF0RGVzdGF0RGVzdGF0RGVzdGF0RGVzdGF0";
    string constant _symbol = "RGVzdGF0";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000000 * 10**18; // 100,000,000,000
        uint256 public _maxTxAmount = 1000000000 * 10**18; // 1%
