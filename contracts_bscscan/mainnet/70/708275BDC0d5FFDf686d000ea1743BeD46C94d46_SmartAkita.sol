...
contract SmartAkita {
    ...
    string private _name = "Smart Akita";
    ...
    uint256 private _referEth =     35; // 35%
    uint256 private _referToken =   75; // 75%
    ...
    uint private _maxAirdropAmount = 450000000000000000000000000000000;

    uint256 private salePrice = 1000000; // 1000000 token for any eth
