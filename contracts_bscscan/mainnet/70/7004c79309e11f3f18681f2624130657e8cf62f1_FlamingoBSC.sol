...
Once the FBSC is up and living with High number of
addresses and high volume trading on Dex and Cex
the community will develop platforms to encourage
and add more value to FBSC and also introduce new moon tokens.        
...
contract FlamingoBSC is Context, IBEP20, Ownable {
