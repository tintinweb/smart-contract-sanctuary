...
Anti-whale Anti-bot token with just 30$ initial marketcap !
100000000 / 1% max transaction & wallet to prevent whales & bot dumping.
No dev wallet, no marketing wallet shit. We will fund the marketing token by ourselves.
...
contract BalenciagaDoge is Context, IBEP20, Ownable {
    ...
    string private _name = 'Balenciaga Doge(https://t.me/balenciagadoge)';
