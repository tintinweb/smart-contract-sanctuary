...
contract TheDoxxShow is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1_000_000_000; //1 Billion, underscores aid readability
    ...
    string private _name = "The Doxx-24/7 Show";
    ...
    uint256 public _boostedMarketingFee = 1100;
    ...
    address payable private _marketingWallet = payable(0xC6Aa3803C0d799FaDdA5aE90FD85B1630cD6ee9f);
    address payable private _devWallet = payable(0x01E1745A4C975E28b09CCE848665B89CBc90d440);
