...
🔥 Project Features:
    ...
    🔥    50% will be burned
    🦮    40% will be used for listings and liquidity
    🤓    10% will go to the dev team wallet.
    
    🌐 Website  : https://dogelucky.com/
    🌐 Telegram : https://t.me/dogeluckycoin
*/
...
contract DOGELUCKY is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "DLucky";

  string private _name = "DOGE LUCKY";
