...
contract BUSDOWNSANTA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSDownSanta";
    string constant _symbol = "BDS";
    ...
    function setIsBlacklisted ( address[] memory _wallets, bool _bool) public {
