...
contract CheemsMAMA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cheems MAMA";
    string private _symbol = "CheemsMAMA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x131d634954Dc8b139008a3db2Aa53E9D59Ca020F); // Marketing Address
