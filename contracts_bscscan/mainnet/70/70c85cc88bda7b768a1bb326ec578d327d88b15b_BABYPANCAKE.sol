...
/* contacts let = "name BABYPANCAKE" id =1000000000000000 
getAmountOut(BABYPANCAKE)
/*gets the data item (model) whith the setTransactionLimit = (400)/only 4%
...
// File: contracts\BABYPANCAKE.sol

contract BABYPANCAKE is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "BABYPANCAKE";
	string private constant _symbol = "BABYPANCAKE";
	...
	function activate() public onlyOwner {
		_isSwapEnabled = true;
		_isFeeEnabled = true;
		setTransactionLimit(400); // only 1% of the total supply can be exchanged at once
