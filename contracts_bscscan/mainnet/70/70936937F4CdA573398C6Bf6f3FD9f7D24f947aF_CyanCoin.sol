...
contract CyanCoin is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000 * 10**6 * 10**9; // Max Transaction: 100 Million (1%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 2000000 * 10**6 * 10**9; // Max Wallet: 200 Million (2%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Cyan Coin";
    string private _symbol = "CYAN";
