...
contract SATOSHIPresale {
    ...
    uint256 public startDate = 1634256000;                  // 2021/10/15 00:00:00 UTC
    uint256 public endDate = 1636588799;                    // 2021/11/10 23:59:59 UTC
    uint256 public lockDate = 1639180799;                    // 2021/12/10 23:59:59 UTC
    
    uint256 public totalTokensToSell = 40000000 * 10**18;          // 40000000 SATOSHI tokens for sell
    uint256 public satoshiPerBnb = 7250 * 10**18;             // 1 BNB = 7250 SATOSHI
    uint256 public minPerTransaction = 145 * 10**18;         // min amount per transaction (0.02BNB)
    uint256 public maxPerUser = 72500 * 10**18;                // max amount per user (10BNB)
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uint256 allowance = SATOSHI.allowance(address(this), address(uniswapV2Router));
