...
/**
* - SpongeBob-
* SpongeBob is a deflationary token based on the Binance Smart Chain network,  
  whose purpose is to let $SBOB holders gain BNB rewards on every transaction. 
* 
* 10% Fees
* 4% BNB Redistribution fee 
* 3% Added to Liquidity 
* 3% Charity
* 
* Website - https://spongebob.one/
* Join the Telegram - https://t.me/SpongeBob_Token
* 
*/
