...
⚜️ It's time to Beef'n up your pockets! Beefereum is The World’s First Decentralized token that will have a professional trading mechanism that ensures our chart is always at a higher low
‍━━━━━━━━━━━━━━━━━━━
🥩 Tokenomics 
...
🌐 Website: https://beefereum.xyz
📱 Telegram: https://t.me/Beefereum
*/
...
contract Beefereum is ERC20, Ownable {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function buybackTax(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function sellTax(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function liqTax(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
