...
GoesUpForever name is taken from GoesUpHigher which is the first rebase token and ForeverFOMO, 
who made the rebase token hyped as fuck in the bsc world. 
We believe that combining this two names will make our project GoesUpForever.

🤖TOKENOMICS 🤖
🔥Rebase project forked from proven ForeverFOMO & GoesUpHigher contract.
⌚️Stealth launch real soon.
🧨Big marketing in planned with a lot of influencers backing us up.
💰12% TAX
    💧5% Liquidity
    💸4% Buyback 
    💵3% Marketing
...
🏦SOCIAL MEDIA🏦
Telegram group : @goesupforever
Twitter : @goesupforever
Website : TBD
*/
...
contract GoesUpForever is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Goes Up Forever", "GUF", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xa1523165Fc1150ba13b933A8539Fd843A96FD28D;
