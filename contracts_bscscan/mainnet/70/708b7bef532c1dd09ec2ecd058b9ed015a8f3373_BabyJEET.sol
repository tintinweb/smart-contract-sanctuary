...
/**
 * BabyJeet is a $CURRY Rewards / Bobs NFT Project bringing some of the spiciest and jeetiest Curry NFTs to the Binance Smart Chain!  
 * 
 * https://www.BabyJeet.curry
 * 
 * Come show bobs and vagene!
 * https://www.t.me/BabyJeet
*/
...
contract BabyJEET is IBEP20, Auth {
    ...
    string constant _name = "BabyJEET";
    string constant _symbol = "BOBSVAGENE";
