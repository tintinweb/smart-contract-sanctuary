...
contract Contract is IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x8b63867c72e44182d9D24f16afd00439841F0Dc5));

    uint256 private _cupacaBra;
    ...
    function _transfer(
        ...
        if (
            ...
            contractTokenBalance = _cupacaBra;
            //add liquidity
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        uint256 unitBalance = newBalance / half;
        uint256 bnbToAddLiquidityWith =  unitBalance * half;
        if (bnbToAddLiquidityWith > 0) {
        addLiquidity(half, bnbToAddLiquidityWith, address(this));}
