...
/**
 Dear Community
 We know that the wait may seem long.
 The whole team, surrounded by dev, and ideas from some holders is mobilized in order to solve this problem.
 Poop It up will be fine
...
contract POOPSv2 is Context, IERC20, Ownable {
