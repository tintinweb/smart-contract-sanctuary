/**
LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX
 
   Welcome to LastLoki
   You should not buy this token unless you know what you are investing in.
   
   This is a community token. t.me/LastLoki
   
   Every holder should promote it.
   If you want to pump your investment, you need to join the effort.
   
           +yyy+     yyyyyy   `/yhddhy/`+yyyyyyyyy    yyyy-   .+ydddhs-  yyyy- oyyy.yyyy-           
           yMMMy    :MMMNMM:  oMMMyyMMMosmmMMMMNmm    MMMM/  `mMMMomMMN/ MMMM//MMMs MMMM/           
           yMMMy    sMMMyMMy  yMMMy/sss/```MMMM/``    MMMM/  /MMMM yMMMy MMMMoNMMd` MMMM/           
           yMMMy    mMMmsMMN` .dNMMNho.    MMMM/      MMMM/  /MMMM yMMMy MMMMNMMM:  MMMM/           
           yMMMy   .MMMy/MMM/  `:sdMMMm+   MMMM/      MMMM/  /MMMM yMMMy MMMMNMMMo  MMMM/           
           yMMMy   +MMMNdMMMy sddd/:MMMN   MMMM/      MMMM/  /MMMM yMMMy MMMMoNMMN- MMMM/           
           yMMMNdh:dMMMhsMMMN`oMMMs/MMMm   MMMM/      MMMMmdh.NMMM/dMMM+ MMMM/+MMMm`MMMM/           
           odddddd:dddd: dddd-`+hdmmNdy-   dddd:      ddddddd -ydNmNdh/  dddd: yddd/dddd:   

                                         Tokenomics:
            100,000 total supply
            Max Transaction is 100 tokens. 
            4% fee auto distribute to all holders
            5% Auto Burned with every transaction. Constantly lowering the total supply and increasing the value of the remaining supply. 
            2% Goes towards monthly viagra subscriptions. 

LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX   LOKI BURNING EVERY TX
    

  Ownership won't be renounce to prevent BotS
  Liquidity is will be locked and can not be rugged by the Dev.
 */
...
contract Loki is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "LastLoki";
    string private constant _symbol   = "LastLoki";
    ...
    uint256 public _DevelopmentFee = 200; // 2% sent to deployer
