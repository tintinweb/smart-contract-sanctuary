...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BXRP = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BXRP.balanceOf(address(this));
        ...
        uint256 amount = BXRP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BXRP.transfer(shareholder, amount);
...
contract LittleXRP is IBEP20, Auth {
    using SafeMath for uint256;

    address BXRP = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Little XRP";
    string constant _symbol = "LittleXRP";
