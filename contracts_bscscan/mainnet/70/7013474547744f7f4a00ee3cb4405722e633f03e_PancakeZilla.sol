...
//   I make this #PancakeZilla to hand over to the community.
//   Create the community by yourself if you are interested.   
//   I suggest a telegram group name for you to create: @PancakeZilla
...
contract PancakeZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PancakeZilla";
    string constant _symbol = "PancakeZilla";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 9600 * 10**15 * (10 ** _decimals);
