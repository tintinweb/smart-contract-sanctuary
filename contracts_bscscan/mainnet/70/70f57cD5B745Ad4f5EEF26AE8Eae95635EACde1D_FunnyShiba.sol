...
contract FunnyShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Funny Shiba";
    ...
    uint256 public swapThreshold = _totalSupply * 381 / 100000; // 0.38% of supply
    bool inSwap;
