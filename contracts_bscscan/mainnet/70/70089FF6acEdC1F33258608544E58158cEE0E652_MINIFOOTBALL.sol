...
// ----------------------------------------------------------------------------
// MINIFOOTBALL$ Contrato do Token
//
// Sigla             : WVL
// Nome              : MiniFootball Utility Token
// Suplimento Total  : 100.000.000,000000000    -> 100 Milhões
// Decimals          : 9
// 
// ----------------------------------------------------------------------------
//  🌐 Website: https://minifootball.io
//  📢 E-mail: [email protected]
//  📢 Facebook: www.facebook.com/MinifootballBrasil/
//  📸 Instagram: https://instagram.com/minifootballbrasil/
//  🐦 Twitter: https://twitter.com/minifootballbr
//  📢 Telegram: https://t.me/minifootball
// ----------------------------------------------------------------------------
//
...
contract MINIFOOTBALL is Context, IERC20, Ownable {
    ...
    string private constant _name = 'MiniFootball Utility Token'; //  Nome da moeda
    string private constant _symbol = 'FOOTBALL'; // Sigla da moeda
    ...
    uint256 private _tokenTotal = 100000000 * _decimalFactor ;      // Supply: 100M de unidades (FIXO)
    ...
    uint256 private _totalBurn;     // Total de tokens queimados para gerar Desinflação!
