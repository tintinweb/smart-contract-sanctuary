...
contract SantaInu is Context, IERC20, Ownable {
    ...
    uint256 private _charityFeeOnBuy = 2;
    
    uint256 private _redisFeeOnSell = 2;
    uint256 private _taxFeeOnSell = 2;
    uint256 private _charityFeeOnSell = 2;
    
    uint256 private _redisFee = 2;
    uint256 private _taxFee = 2;
    uint256 private _charityFee = 2;
    
    address payable private _developmentAddress = payable(0x925b6de976357109F72215FA78290C390653BFd3);
    address payable private _marketingAddress = payable(0xAA319533cbFb05DfCd54FFdAE48235B97dd73707);
    address payable private _charityAddress = payable(0xd6BF486fC3A1dA6F061A052d23b4285201489D41);
