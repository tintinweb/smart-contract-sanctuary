...
//Buffed Viking Doge -  Justlaunched.
//Low Mcap
//Lp Locked
//OwnershibRenounced
//Telegram : t.me/Buffedvikingdoge
...
contract Buffvikingdoge is Context, IERC20, Ownable {
    ...
    string private _name = "BuffedVikingDoge";
    string private _symbol = "BUFFVIKINGDOGE";
    ...
    uint256 private minimumTokensBeforeSwap = 5014710 * 10**6 * 10**9; 
