...
contract DiamondTree is ERC20, Ownable {
    ...
    uint256 public ADARewardsBuyFee = 6;
    uint256 public ADARewardsSellFee = 10;
    ...
    function updateADARewardsSell(uint256 newValue) public onlyOwner {
        ADARewardsSellFee = newValue;
    }
    function updatesnipeADARewardsSell(uint256 newValue) public onlyOwner {
        snipeADARewardsSellFee = newValue;
    }
    function updatesnipeADARewardsBuy(uint256 newValue) public onlyOwner {
    ...
    function updateFees(
        ...
        emit UpdateFees(dev, liquidity, ADARewardsBuy, ADARewardsSell);
    }
