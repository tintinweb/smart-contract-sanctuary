...
/**
 * https://www.technodoge.com/
 * https://mobile.twitter.com/official_TDOGE
*/
...
contract Technodoge is IBEP20 {
    ...
    string public override name = "Technodoge";
    string public override symbol = "TDOGE";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address marketingAddress) {
        // set total supply
        ...
        marketingPot = marketingAddress;
        
        // split the tokens according to agreed upon percentages
        balances[developmentPot] =  totalSupply * 3 / 100;
        balances[marketingPot] =  totalSupply * 5 / 100;
