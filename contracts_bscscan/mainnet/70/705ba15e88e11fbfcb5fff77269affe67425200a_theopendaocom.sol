...
contract theopendaocom is theopendaoDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private Teamtheopendao;
    address private Charitytheopendao;
    ...
    string public override name = "theopendao.com";
    string public override symbol = "theopendao.com";
    ...
    constructor(uint totalSupplyValue, address TeamtheopendaoAddress, address CharitytheopendaoAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        Teamtheopendao = TeamtheopendaoAddress;
        Charitytheopendao = CharitytheopendaoAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Teamtheopendao] =  totalSupply * 45 / 100;
        balances[Charitytheopendao] = totalSupply * 45 / 100;
