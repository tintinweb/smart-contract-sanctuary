...
contract drauG is ERC20UpgradeSafe, Configurable {

	function initialize(address governor_,address farm) public initializer {
		Governable.initialize(governor_);
		ERC20UpgradeSafe.__ERC20_init("drauG.insure Governance Token", "drauG");
		
		uint8 decimals = 18;
		_setupDecimals(decimals);
		
		_mint(farm,500_0000 * 10 ** uint256(decimals));       
	}
