...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("PPOLLTESTV2", "PPOLLTESTV2") {
    ...
    function _validate(uint _amount, uint _id) internal view {
    ...
    function _trade(uint _id) internal {
        ...
        PancakePoll.transferFrom(msg.sender, _owner, _sellerValue);
        PancakePoll.transferFrom(msg.sender, _contractOwner, _commissionValue);
