...
This PeakyGirl coin is the newest most hyped coin in the market at this moment.
...
LP locked at stealthlaunch

Telegram = https://t.me/PeakyGirlBSC
...
// CHANGE
contract PeakyGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PeakyGirl";
    string constant _symbol = "PeakyGirl";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; // 2% MAX 40,000,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; // 3% MAX 30,000,000
    ...
    uint256 liquidityFee = 1000; // 3%
    uint256 buybackFee = 0;   // 0% 
    uint256 reflectionFee = 0; // 3%
    uint256 devFee = 500; // 3%
    uint256 totalFee = 1500; // liquidityFee + Buyback + devFee = 9%
