...
2) 12% buyback and marketing tax is collected and 6% of it is sent for marketing fund and othe 6% is used to buyback the tokens
...
contract EverRiseX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8925D826e339e85bD3CD378fB7CF4Ee479DF6a32); // Marketing Address
    ...
    string private _name = "EverRiseX";
    string private _symbol = "RISEX";
