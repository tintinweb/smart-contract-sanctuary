...
contract Volume2 is Context, IERC20, Ownable {
    ...
    string private _name = 'Volume2';
    string private _symbol = 'Volume2';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 4; // 4% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 16; // 9% of transactions will be kept for liquidity
