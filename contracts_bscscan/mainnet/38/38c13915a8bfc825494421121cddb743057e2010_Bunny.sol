...
contract Bunny is Context, IERC20, Ownable {
    ...
    string private _name = "Bunny";
    string private _symbol = "Bunny";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDA0eE36743b636002Fbd08485193636c22819D06); // Marketing Address
    address payable public teamWalletAddress = payable(0x16509d4031Ef7Fd7dAe404391dF218B87955c422); // Team Address
    ...
    uint256 public _maxTxAmount = 1 * 10**5 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 1 * 10**5 * 10**6* 10**_decimals;
