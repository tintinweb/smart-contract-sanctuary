...
/* BinanceMatic -  A Matic-backed assets for a stable currency on Binance Smart Chain Network
...
contract BinanceMatic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x60C56163A243019F4a82e0B51383657743c6833c); // Marketing Address
    address payable public charityAddress = payable(0x60C56163A243019F4a82e0B51383657743c6833c); // Charity/Dev Address
    ...
    string private _name = "BinanceMatic";
