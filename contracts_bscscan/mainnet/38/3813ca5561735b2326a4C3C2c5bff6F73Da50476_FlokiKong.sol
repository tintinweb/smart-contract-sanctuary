...
🤝 FlokiSell - Max 2% price impact. Min sell 0.01 BnB.

🤝 FlokiBuy -  Min buy 0.01 BnB.
...
contract FlokiKong is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "FlokiKong";
