...
*Gamestonk token. you are welcome. 10% transaction fees.
...
contract Gamestonk is Context, IERC20, Ownable {
    ...
    string private _name = "Gamestonk Token";

    string private _symbol = "Gamestonk";

    uint8 private _decimals = 18;

   

    uint256 public _distributionFee = 10;
