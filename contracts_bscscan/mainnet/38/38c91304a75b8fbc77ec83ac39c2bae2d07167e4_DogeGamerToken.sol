...
/*I will create this token ad leave to community I will add my wallet to collect 2% of transactions
I suggest https://t.me/GamerDoge_token for the name
Tokenomics: 5% to holders
            3% Dev fee
            8% LP fee
Total supply 100,000,000,000,000 I will burn 30% Lock 30% for 1 day and add the remaining supply for trading
*/
...
contract DogeGamerToken is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1;
    ...
    string private _name = "DogeGamerToken";
    string private _symbol = "DGT";
    ...
    uint256 public _maxWalletToken = 100 * 10**12 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 40 * 10**12 * 10**9;
