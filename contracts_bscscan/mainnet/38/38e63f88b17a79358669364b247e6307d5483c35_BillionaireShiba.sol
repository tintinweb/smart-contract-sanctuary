...
/**
 ...
 5,000,000,000,000 (0.5%) Max Tx amount
...
contract BillionaireShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Billionaire Shiba";
    string private _symbol = "BShib";
    ...
    function _setMaxWallet(uint256 MaxWallet) external onlyOwner() {
        require(MaxWallet < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = MaxWallet;
    }
}