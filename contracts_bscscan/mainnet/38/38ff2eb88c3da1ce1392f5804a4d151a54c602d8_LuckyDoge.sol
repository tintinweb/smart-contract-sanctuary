...
contract LuckyDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x707b680481EFad9Ead56bE75aE60a67F9D27ac09); // Marketing Address
    ...
    string private constant _name = "LuckyDoge";
    string private constant _symbol = "LuckyDoge";
    ...
    constructor(address tokenOwner) {
        require(tokenOwner != address(0), "Address can't be zero");
        _owner = tokenOwner;
    ...
    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        require(address(0) != _marketingAddress, "Address can't be zero");
