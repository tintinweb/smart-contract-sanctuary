...
/*
😺 ShibaBabe 😺  is a new token launching on the Binance Smart Chain.

Its the ultimate token that allows you to earn $SHIB as you HODL! ShibaBabe has an experienced and based Dev team with plenty of experience behind them to see this project grow.

The team are working on NFT's pre launch with these going live within the first few days following launch with 50% of all sales going straight into the chart.
ShibaBabe could be the key to financial freedom.
 

Earn $Shib, join and grow with us as a community! Your active participation is what will keep the coin going to the MOON!
...
contract ShibaBabe is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Babe", "SHIBABABE")  {
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        function setShibRewards(uint256 value) external onlyOwner{
