...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x319FcdFF83744dcc70f64588d45A5cb6A0b0650a;
...
contract BabySPONGS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x319FcdFF83744dcc70f64588d45A5cb6A0b0650a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabySPONGS";
    string private _symbol = "BabySPONGS";
