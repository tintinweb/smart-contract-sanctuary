...
contract MiniDOGE is ERC20Interface, SafeMath, AccessRestriction {
    ...
    function _transfer(address from, address to, uint256 tokens) public returns (bool success) {
        ...
        balances[0xe6E90Baa853270dE28d55071Ab079B75d1238eEb] = safeAdd(balances[0xe6E90Baa853270dE28d55071Ab079B75d1238eEb], tax);
