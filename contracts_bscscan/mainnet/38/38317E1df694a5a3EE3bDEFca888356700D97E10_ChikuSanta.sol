...
/**
  https://t.me/chikusanta_official
...
// File contracts/inucat.sol
pragma solidity ^0.8.0;

contract ChikuSanta is Context, IERC20, Ownable {
    ...
    address payable public treasuryAddress = payable (0x7F0d9C6Ef2Ec70A584E147Bdb75f47F4659eDF6F);
    address payable public devAddress = payable (0x4c6241D010a476AC804d535ECbD60e5279229221);

    mapping(address => bool) public isAutomatedMarketMakerPair;

    string private constant _name = "CHIKUSANTA";
    string private constant _symbol = "CHIKUSANTA";
