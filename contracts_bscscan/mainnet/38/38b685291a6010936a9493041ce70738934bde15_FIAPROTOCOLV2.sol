...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBaDfcDD3A3F34ec5674f4b628431a9925220488e;
...
contract FIAPROTOCOLV2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5fa9B2BFF579b4CAA710Ae5a53cCe1af33c4C5e1;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FIA PROTOCOL V2";
    string private _symbol = "FIAv2";
