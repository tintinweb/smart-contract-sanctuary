 ...
 * 
 Welcome to $EthereumBOX:
   ...
   Many Great features:
    ...
    it's the best part of the EthereumBOX idea, increasing the liquidity pool automatically.
...
contract EthereumBOX is Context, IERC20, Ownable {
