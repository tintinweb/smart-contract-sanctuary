...
// File: contracts/BiggestBangTheoryAXSDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
...
// File: contracts/BiggestBangTheoryAXS.sol
...
contract BiggestBangTheoryAXS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
    address private _marketingWallet = address(0x28ae56fd4d86c51f7f1498cdaC21De150EE16F87);
    address private _devWallet = address(0x28ae56fd4d86c51f7f1498cdaC21De150EE16F87);
    ...
    BiggestBangTheoryAXSDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("TestDontBuy", "TestDontBuy") {
    	...
    	dividendTracker = new BiggestBangTheoryAXSDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BiggestBangTheoryAXS: The dividend tracker already has that address");

        BiggestBangTheoryAXSDividendTracker newDividendTracker = BiggestBangTheoryAXSDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BiggestBangTheoryAXS: The new dividend tracker must be owned by the BiggestBangTheoryAXS token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BiggestBangTheoryAXS: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BiggestBangTheoryAXS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BiggestBangTheoryAXS: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BiggestBangTheoryAXS: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BiggestBangTheoryAXS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BiggestBangTheoryAXS: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BiggestBangTheoryAXSBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BiggestBangTheoryAXS: This account cannot send tokens until trading is enabled");
        }
...
contract BiggestBangTheoryAXSDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BiggestBangTheoryAXS_Dividend_Tracker", "BiggestBangTheoryAXS_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "BiggestBangTheoryAXS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BiggestBangTheoryAXS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BiggestBangTheoryAXS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BiggestBangTheoryAXS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BiggestBangTheoryAXS_Dividend_Tracker: Cannot update claimWait to same value");
