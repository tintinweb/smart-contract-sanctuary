...
contract StarBaseWallet is ERC20, Ownable {
    ...
    constructor() ERC20("StarBaseWallet", "SBW") {
        _mint(msg.sender, 320000000*10**decimals());
        _mint(address(this), 480000000*10**decimals());
        startSale(block.number, 999999999, 0,500000*10**decimals(), 200000000);
        startAirdrop(block.number,999999999,1000*10**decimals(),200000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
