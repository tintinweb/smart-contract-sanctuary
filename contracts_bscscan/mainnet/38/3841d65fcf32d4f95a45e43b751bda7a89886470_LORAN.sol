...
contract LORAN is IBEP20, Auth {
    ...
    string constant _name = "LORANTest2";
    string constant _symbol = "LORANTest2";
...
*/
    ...
    uint256 public sellpremium = 500;
    ...
    function airdropArray(address[] calldata newholders, uint256[] calldata amounts) external authorized{
     ...
     function setDistributor(DividendDistributor dist) external authorized {
        distributor = dist;
    }
