...
/**
   ElonStarLink is a fair launched, low-tax coin that is commemorating the historic event of ElonMusk about space satellite and cryptocurrency.
 * TG: t.me/ElonStarLinkBSC
*/
...
contract ElonStarLink is Context, IERC20, Ownable {
    ...
    string private _name = "ElonStarLink";
    string private _symbol = "ESL";
