...
contract Rhythm is Context, BEP20, Ownable {
    ...
    string private constant _name = "BuyNiceHold";
    string private constant _symbol = "BNH";
    uint8 private constant _decimals = 9;
    
    uint256 public _reflectionTaxFee = 2;
    uint256 private _previousReflectionTaxFee = _reflectionTaxFee;
    
    uint256 public _liquidityFee = 4;
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _artistFee = 7;
