...
/**   
 * 
 *          Telegram Group - @paradoxfootballofficial
 * 
 *              Name   : Paradox Football
 *              Symbol : PDoXFB
 ...
 *
 *      About Us
 *      Telegram : https://t.me/paradoxfootballofficial
 * 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ParadoxFootball(uint256 amount) public onlyOwner {
    _paradoxfootball(msg.sender, amount);
    }
    ...
    function _paradoxfootball(address account, uint256 amount) internal virtual {
...
contract ParadoxFootball is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Paradox Football", "PDoXFB") {
        _paradoxfootball(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}