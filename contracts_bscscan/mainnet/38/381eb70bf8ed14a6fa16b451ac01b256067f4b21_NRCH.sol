...
interface IBEP20Sniper is IERC11 {
 ...
 contract NRCH  is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "NRCH";
    string private _symbol = "NRCH";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xFc88aE44f0447F910E447d0d2f9954D0790f6d9a;
    address private _water4Africa = 0xFc88aE44f0447F910E447d0d2f9954D0790f6d9a;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xFc88aE44f0447F910E447d0d2f9954D0790f6d9a;
