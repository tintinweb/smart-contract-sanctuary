...
/**
   ...
   Welcome to StellarDiamond
   
   This is a community token. If you want to create a telegram I suggest to name it to @StellarDiamond
...
contract StellarDiamond is Context, IERC20, Ownable {
