...
Hello Guys! Today we are launching great project based on Elon's tweet that will push every Project from our Launchpad to the aliens Moon,
so be ready and prepare you bags!
...
contract OritalLaunchPad is Context, IERC20, Ownable {	
    ...
    string private constant _name = "OritalLaunchPad";	
    string private constant _symbol = "OLPad";	
