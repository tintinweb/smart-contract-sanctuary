...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/BEP20Deployer/solidity/issues/2691
        return msg.data;
    }
}
...
interface BEP20Deployer {
     ...
     * https://github.com/BEP20Deployer/EIPs/issues/20#issuecomment-263524729
     *
...
contract BEP20DeployerOwnable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "BEP20DeployerOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BEP20DeployerOwnable: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract DAOWEB is Context, BEP20Deployer, BEP20DeployerOwnable {
    ...
    string private _name = 'DAO WEB3';
    string private _symbol = 'DAO WEB3';
