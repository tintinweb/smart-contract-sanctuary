...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xDB0170e2d0c1CC1b2E7a90313d9B9afA4f250289);
...
contract miniADAPAD is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xDB0170e2d0c1CC1b2E7a90313d9B9afA4f250289;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "miniADAPAD";
    string constant _symbol = "miniADAPAD";
