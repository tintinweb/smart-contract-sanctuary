...
@BSCSafeSniper and @SafeAnalyzerBot team.
...
Telegram Official Chat: @BlueTigerbsc
...
contract BlueTiger is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x6c7AaD32F6bE89fC2828d7B2BD5AEfC2Df8b8947));
    address payable public _teamwallet =
        payable(address(0x556772685F07F27193F3585395100fed21c02F5A));
    address _partnershipswallet =
        payable(address(0x556772685F07F27193F3585395100fed21c02F5A));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Blue Tiger";
