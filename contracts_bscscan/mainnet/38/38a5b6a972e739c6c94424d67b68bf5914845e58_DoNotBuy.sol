...
contract DoNotBuy is Context, IERC20, Ownable {
    ...
    function KillSnipersEnabled(bool _KillSnipers) public onlyOwner {
        KillSnipers = _KillSnipers;
    }
    ...
    function _transfer(
        ...
        require(!KillSnipers, "Trading is paused");
