...
/**
 Welcome to TIGERX!
   ...
   60% Supply burned at the start to create a blackhole
https://t.me/TigerXOfficial
...
`@@ |   \ `\     ` |         | |  _/'  /'  | @@'
 ...
 |__   __(_)                  
    ...
    |_|  |_|\__, |\___|_|     
             __/ |                                 
            |___/ TIGER PROTECTS OUR FLORA AND FAUNA    
...
contract TIGERX is Context, IERC20, Ownable {
    ...
    string private _name ="TIGERX";
    string private _symbol = "TGRX";
