...
contract CardanoPump is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CardanoPumpDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0xa947C84cECa0d7e6cDeedB75D01973A24913eff6;
    address public _devWalletAddress = 0x14b4F7198687eeCA390b2f67d89F0309CcE1f457;
    ...
    constructor() public ERC20("CardanoPump", "CardanoPump") {

    	dividendTracker = new CardanoPumpDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        CardanoPumpDividendTracker newDividendTracker = CardanoPumpDividendTracker(payable(newAddress));
...
contract CardanoPumpDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("CardanoPump Dividends", "CardanoPump_dividends") {
    	claimWait = 3600;
