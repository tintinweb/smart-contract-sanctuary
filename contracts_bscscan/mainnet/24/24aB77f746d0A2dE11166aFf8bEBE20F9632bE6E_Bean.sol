...
Today (Jan. 6th) is the 67th birthday of Rowan Atkinson (aka Mr Bean).
To celebrate the birthday of the iconic character we created Bean Birthday Token. 🚀

🔶BNB🔶 Rewards

✅  https://bean-birthday.com/
✅  https://t.me/Bean_token

⚙️ 13% taxes on each transaction : 6% BNB Rewards ; 3% Marketing ; 4% Liquidity
⚙️ 100M supply, 30% burnt, 70% LP (no dev/team wallet)
⚙️ 2BNB initial LP
...
contract Bean is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Bean Birthday Token";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xEA7E1ee0EEaaCA1666599e67D2dAB27667826b99;
        marketingWallet = 0x401dAfD3AA8eBdaB0ec01c5f6823B435667955D3;
