...
contract ButtHole is ERC20, Ownable {
    ...
    uint256 APETIMEFactorN = 33;
    uint256 APETIMEFactorD = 100;
    uint256 public APETIMEFactor = (APETIMEFactorN / APETIMEFactorD);
    ...
    function setApeTimeFactor(uint256 numerator, uint256 denominator) public onlyOwner{
        APETIMEFactorN = numerator;
        APETIMEFactorD = denominator;
    }
