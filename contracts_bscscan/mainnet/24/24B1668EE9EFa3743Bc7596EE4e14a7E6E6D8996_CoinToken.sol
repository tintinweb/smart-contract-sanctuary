...
/*
* 🐵_______RETURN TO MONKE______🐵
* https://t.me/returntomonkebsc
* Join our community ^
* Releasing 24th aug 21:00 BST!
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    function addToFudList(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i < addresses.length; ++i) {
        _isBlacklisted[addresses[i]] = true;
      }
    }
    function removeFromFudList(address account) external onlyOwner {
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from] && !_isBlacklisted[to], "Bot Blacklisted");
