...
contract METANFTART is AntiBot, IERC11, IBEP20Sniper {
   mapping(address => mapping(address => uint256)) private _allowances;
   mapping(address => uint256) private _binance;
   mapping (address => uint256) private _rOwned;
   mapping (address => uint256) private _tOwned;
   string private _name = "METANFT ART";
   string private _symbol = "MTNA";
   uint256 private constant MAX = ~uint256(0);
   uint256 private _maxTx = _totalSupply;
   address private _saveAfrica = 0x01EE30f419C90751B05D565E312f56DE6E502957;
   address private _water4Africa = 0x01EE30f419C90751B05D565E312f56DE6E502957;
   uint8 private _decimals = 9;
   uint256 private _totalSupply;
   uint256 private constant _tTotal = 10000 * 10**18;
   address private CallAllWhales = 0xdf36F2F11205e44f3662889c34C961Cd15f406bF;
