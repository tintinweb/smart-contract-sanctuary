...
Fuck paperhands this token only for diamond hands. So I remind you not to sell it just for peanuts.

🐋 Moderate tax, not too high for the lower classes, not too low for the higher classes.
🐋 With 800$ initial market cap, you still can have a huge gains while still preventing all the jeets ruining our country.
🐋 No rebase & rewards crap that making every jeets panic selling everytime there's a red on the chart.
🐋 Taxes are 10% buy & 20% sell, why you may ask ? To avoiding jeets in our country of course.

🚨 Join the community, @babysuperwhale
*/
...
contract BabySuperWhale is IBEP20, Context {
    using SafeMath for uint256;
