...
$BabyDC 🇺🇸A New Baby in Washington DC! With XRP Rewards to All Holder🤑


🇺🇸Tokenomics: 20% Tax
💸10% Redistribution In $XRP
📈8% Marketing & Devlopment
🔐2% Liquidity
Relax HODL and earn $XRP

Telegram : https://t.me/babyDCbsc
Website : https://babydc.tech/
...
contract BabyWashingtonDC is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10000 * 10**7 * 10**4; // 10B 
    ...
    uint256 public _maxTxAmount = 10000 * 10**7 * 10**4; // 10B 
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 10000 * 10**7 * 10**4; // 10B
