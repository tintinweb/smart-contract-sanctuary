...
// Space SIP ($SIP) - Space SIP, blockchain-enabled RPG Game, built to allow player PLAY-to-EARN with an EASY-to-PLAY gameplay.
// Telegram: https://t.me/Spacesip                  
// Website: https://sip.space/
...
contract SpaceSip is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xf13bEc08629d1366Cf22a1ef01f07F37B4A5d6Ce); // Marketing Address
