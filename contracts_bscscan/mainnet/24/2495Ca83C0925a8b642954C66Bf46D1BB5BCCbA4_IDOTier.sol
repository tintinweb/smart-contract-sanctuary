...
contract IDOTier is Ownable, IIDOTier {
    ...
    constructor() {
        tiers.push(Tier({ tierId: 1, minPoint: 100 ether, multiplier: 1 })); // iron
        tiers.push(Tier({ tierId: 2, minPoint: 250 ether, multiplier: 2 })); // bronze
        tiers.push(Tier({ tierId: 3, minPoint: 500 ether, multiplier: 4 })); // silver
        tiers.push(Tier({ tierId: 4, minPoint: 1000 ether, multiplier: 6 })); // gold
    }
