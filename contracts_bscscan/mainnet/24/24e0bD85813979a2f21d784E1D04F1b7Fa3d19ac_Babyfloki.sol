...
contract Ownable is Context {
    address private _owner = 0x8cEa31E93A933E634C5a0e75425275f223a773fE;
...
contract Babyfloki is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xf9Ee4E1F3f9691aCbE363d6923806D89B8F8e930); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Babyfloki"; // token name
    string private _symbol = "Babyfloki"; // token symbol
