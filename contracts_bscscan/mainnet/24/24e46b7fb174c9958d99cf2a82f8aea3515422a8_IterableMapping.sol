 ...
 * Telegram Group: https://t.me/TokenRewardFactory
 
 * Providing one of the hottest crypto's as rewards, collect and swap.
 
 * Get ether automatic Ether reward.
...
contract BakeYourEther is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   BakeYourEtherDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("EtherRocket", "ER") {
        _ETHRewardsFee = 4;
        _liquidityFee = 4;
		_marketingFee = 10;
    	...
    	dividendTracker = new BakeYourEtherDividendTracker();
    	antiBotEnabled = true;

    	liquidityWallet = owner();
		
		bulkSender = payable(0xB439d0e753E2DDcDd5598775B1d5915CF8999C7E);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BakeYourEther: The dividend tracker already has that address");

        BakeYourEtherDividendTracker newDividendTracker = BakeYourEtherDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BakeYourEther: The new dividend tracker must be owned by the BakeYourEther token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BakeYourEther: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BakeYourEther: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BakeYourEther: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BakeYourEther: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "BakeYourEther: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BakeYourEther: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BakeYourEther: Cannot update gasForProcessing to same value");
    ...
    function swapTokensForETH(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of BakeYourEther
            path,
            recipient,
            block.timestamp
        );
...
contract BakeYourEtherDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BakeYourEther_Dividend_Tracker", "BakeYourEther_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "BakeYourEther_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BakeYourEther_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BakeYourEther contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "BakeYourEther_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BakeYourEther_Tracker: Cannot update claimWait to same value");
