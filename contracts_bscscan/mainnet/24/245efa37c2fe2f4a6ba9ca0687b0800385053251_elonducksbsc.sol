...
// CHANGE
contract elonducksbsc is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "458 Ducks";
    string constant _symbol = "DUCKS";
    ...
    uint256 liquidityFee = 3; // 3%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 
    uint256 devFee = 7; // 7%
    uint256 totalFee = 10; // liquidityFee + reflectionFee + devFee
