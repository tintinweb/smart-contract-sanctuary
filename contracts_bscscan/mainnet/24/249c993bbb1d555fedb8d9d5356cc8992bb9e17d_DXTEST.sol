...
contract DXTEST is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("DXTEST", "DXTEST", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0xa575d366dAdC28dea2560Fb9bcc786922312B261;
        ecosystemFeeReceiver = 0xa575d366dAdC28dea2560Fb9bcc786922312B261;
        buyBackFeeReceiver = 0xa575d366dAdC28dea2560Fb9bcc786922312B261;

        emit Transfer(address(0x0), msg.sender, _totalSupply);
    }

    function excludePresaleAddresses(address DXrouter, address presale) external onlyOwner {
        presaleAddresses[DXrouter] = true;
        presaleAddresses[presale] = true;
        _isMaxWalletExempt[DXrouter] = true;
        _isMaxWalletExempt[presale] = true;
        _isFeeExempt[DXrouter] = true;
        _isFeeExempt[presale] = true;
    }
    ...
    function _transferFrom(
        ...
        if (sender != owner() && !_isMaxWalletExempt[recipient] && !presaleAddresses[sender]) {
