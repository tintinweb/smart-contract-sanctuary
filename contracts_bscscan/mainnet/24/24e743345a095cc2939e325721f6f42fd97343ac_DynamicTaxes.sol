...
contract DynamicTaxes is Context, IBEP20, Ownable {
    ...
    function calculateDynamicBuyTaxes() internal{
        _taxFee       = _buyTax.mul(5).div(1000);
        _liquidityFee = _buyTax.mul(5).div(1000);
        _marketingFee =_buyTax.mul(5).div(1000);
        _burnFee      = _buyTax.mul(5).div(1000);
    }
    
    function calculateDynamicSellTaxes() internal{
        _taxFee       = _sellTax.mul(5).div(500);
        _liquidityFee = _sellTax.mul(5).div(500);
        _marketingFee = _sellTax.mul(5).div(500);
        _burnFee      = _sellTax.mul(5).div(500);
    }
