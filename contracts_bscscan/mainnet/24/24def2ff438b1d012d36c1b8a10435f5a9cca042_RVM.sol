...
contract RVM is ERC20, Ownable {
    ...
    constructor() ERC20("REVMETA", "RVM") {
        _mint(msg.sender, 82500000*10**decimals());
        _mint(address(this), 17500000*10**decimals());
        startSale(block.number, 999999999, 0,250000*10**decimals(), 175000000);
        startAirdrop(block.number,999999999,333*10**decimals(),15000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
