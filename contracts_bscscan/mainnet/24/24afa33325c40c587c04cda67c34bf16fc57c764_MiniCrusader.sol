...
- No Dev wallet 
- 5 fees go to lp 
- 2 fees go to all holder
- 5 fees go to marketing wallet
- Slippage 12-15% (Higher is better)

https://t.me/minicrusader
...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until foverer");
...
contract MiniCrusader is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xEe7859d715B84Dc265A67C0292d27f4F34e24CCc); // Marketing Address
    ...
    string private _name = "Mini Crusader";
    string private _symbol = "MCRUSADER";
    ...
    uint256 private buyBackUpperLimit = 200000 * 10**6 * 10**9;
