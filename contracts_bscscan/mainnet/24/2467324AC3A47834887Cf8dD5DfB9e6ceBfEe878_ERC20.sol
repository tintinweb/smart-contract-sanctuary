...
contract TaxCollector is Ownable {
  ...
  uint256 public liquidityPercentage = 3125; address public liquidityWallet = 0x7e391Cb3FB85d2d737ff464e11A3036b9c46f18a;
  ...
  uint256 public stakingPercentage = 3125; address public stakingWallet = 0x5aB5829CECB7be1d3da859aD59E7479ACf901bB0;
  function setStacking (uint256 percent_, address wallet_) public onlyOwner { stakingPercentage = percent_; stakingWallet = wallet_; }
  
  uint256 public devPercentage = 1250; address public devWallet = 0x0f771FB097ddC6e85B3fa187eBa51BE72ed4F015;
  function setDev (uint256 percent_, address wallet_) public onlyOwner { devPercentage = percent_; devWallet = wallet_; }
  
  uint256 public rndPercentage = 2500; address public rndWallet = 0xc63e497c9b97f90c0a646AD1fbDF51762491b4fe;
