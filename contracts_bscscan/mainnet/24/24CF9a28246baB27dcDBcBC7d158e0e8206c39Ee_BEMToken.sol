...
/// BEM token
contract BEMToken is ERC20("Bemil V2", "BEM"), Ownable {
    ...
    /// We need mint some BEM in advance
    uint256 public BEMInAdvance;
    ...
    /// @notice We need mint some BEMs in advance
    constructor() public {
        treasuryWalletAddr = _msgSender();
        BEMInAdvance = 1000 * 10**6 * 10**18;

        mint(treasuryWalletAddr, BEMInAdvance);
    }
    ...
    function transferBEMByOwner(address _to, uint256 _amount) external onlyOwner {
