...
contract Harkam is Context, IERC20, Ownable {
    ...
    string private _name = "HAP KKM VIJ";
    string private _symbol = "HKV";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 4; // 3% redistributed among hodlers
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 5; // 3% added to liquidity 
    ...
    uint256 public _maxWalletToken = 3944000 * 10**9;
