...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0xE4FAE3Faa8300810C835970b9187c268f55D998F);
...
contract FreeCate is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FreeCate";
    string constant _symbol = "FREECATE";
    ...
    uint256 public _maxWalletToken = 2000000000000 * (10 ** _decimals);
