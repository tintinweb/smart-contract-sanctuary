...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @ExoDogeBSC
...
contract ExoDoge is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "ExoDoge";
    string private _symbol = "ExoDoge";
