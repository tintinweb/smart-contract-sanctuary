...
Tokenomics:
    *  NO marketing wallet
    *  Max buy size of 1% of supply
    *  Max sell size of 1% of supply
    *  .2 BNB initial liquidity
...
contract CakeDust is Context, IERC20, Ownable {
    ...
    string private _name = "CakeDust";
    string private _symbol = "CakeDust";
