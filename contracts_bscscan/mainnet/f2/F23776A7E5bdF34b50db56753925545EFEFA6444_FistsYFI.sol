...
contract FistsYFI is Context, IERC20, Ownable {
    ...
    string private _name = "Fists YFI";
    string private _symbol = "Fists YFI";
    ...
    address public ownerAddres = address(0x380804500981941f5FdCdc40DFe85379497DAAc3);
    address public devAddress = address(0x93B0851581FCeECCb42aBc12060F0a0e705DeDe1);
    
    address public YFIToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
