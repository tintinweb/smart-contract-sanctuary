...
contract SingleStaking {
    ...
    uint256[4] public Bonus = [5, 12, 20, 45];
    ...
    constructor(address payable _owner, address token1, address token2) {
        ...
        percentDivider = 1000;
        minimumStakeToken = 100000000000;
    }
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 rewardtokenPrice = (amount.mul(KALAVAL)).div(1e18);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address KALA_WBNB = 0x2802A7170bda71798535109a3f1DE56a2206782B; // KALA_WBNB pancake pool address
        IERC20 KALATOKEN = IERC20(0x766dAF75515f2fa57E08E383f473566E6A473838); // KALA Token address 

        uint256 WBNBSUPPLYINKALA_WBNB =(WBNBTOKEN.balanceOf(KALA_WBNB));
        uint256 KALASUPPLYINKALA_WBNB = (KALATOKEN.balanceOf(KALA_WBNB));

        uint256 KALAUSDVAL = (((WBNBSUPPLYINKALA_WBNB.mul(1e18)).div((KALASUPPLYINKALA_WBNB))).mul(BNBPRICE)).div(1e18);
        return KALAUSDVAL;
    }
