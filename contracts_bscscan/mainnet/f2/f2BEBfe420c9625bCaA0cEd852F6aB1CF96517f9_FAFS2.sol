...
contract FAFS2 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FAFS2";
    string constant _symbol = "FAFS2";
    ...
    function setMaxTxFirst15Seconds(uint256 amount) external onlyOwner {
        _maxTxFirst15Seconds = amount;
    }
