...
contract SaitamaDAO is SaitamaETR, Context, Ownable {
    ...
    string public override name = "Saitama DAO";
    string public override symbol = "SAITDAO";
    ...
    constructor(uint totalSupplyValue, address TeamtSaitamaETRAddress, address CharitySaitamaETRAddress) {
        ...
        balances[TeamtSaitamaETR] = totalSupply * 5 / 100;
        balances[CharitySaitamaETR] = totalSupply * 5 / 100;
