...
/**
   ...
   Suprise launch to stop bots and dumps!
   
   Celebrating the new season of Rick and Morty;
   Pickle Rick NFT's
   
   See more on our telegram at Schmeckles.net
...
contract SCHMECKLE is Context, IERC20, Ownable {
    ...
    string private _name = "Schmeckles.net";
    string private _symbol = "SCHMECKLE";
