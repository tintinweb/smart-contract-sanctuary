...
/*
MiniForeverFOMO (mfFOMO)
Total Supply - 1,000,000
Max Wallet   - 20,000
Max Buy      - 10,000
Max Sell     - 10,000

telegram: https://t.me/MiniForeverFOMO
**If you see a sell, don't panic.**
**Contract will sell 0.2% of the total supply to distribute the rewards**
**Instead, consider it as a chance to buy more and hold it**
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD_TOKEN = IBEP20(0x95637d4FbE7153dCc3E26E71bdE7a2D82621F083);
...
contract MiniForeverFOMO is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD_TOKEN = 0x95637d4FbE7153dCc3E26E71bdE7a2D82621F083;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniForeverFOMO";
    string constant _symbol = "mfFOMO";
    ...
    uint256 init_liquidityFee    = 6;
    uint256 init_reflectionFee   = 6;
