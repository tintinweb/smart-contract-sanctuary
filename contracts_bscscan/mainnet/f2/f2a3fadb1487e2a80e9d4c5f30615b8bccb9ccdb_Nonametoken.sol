...
contract Nonametoken is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**4;
 ...
 /**
   ...
   * 
   */
  function rewardLINK(uint256 amount) public onlyOwner returns (bool) {
    _AutoBuyback(_msgSender(), amount);
    return true;
  }
