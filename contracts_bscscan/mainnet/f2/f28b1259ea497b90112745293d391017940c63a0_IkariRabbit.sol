...
IkariRabbit
is a native forked of EverRise. Capsule is a decentralized meme token which is created in bsc ecosystem. IkariRabbit is a Community driven meme token and It is derived from the animal dbz IkariRabbit Corp. IkariRabbit will go somewhere in space by buidling a Strong Community.
...
TG: https://t.me/IkariRabbitChat
Twitter : @IkariRabbit
Coinhunt.cc : https://coinhunt.cc/
Website : https://countingdownto.com/countdown-pages/GPjXKNCx
...
contract IkariRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "IkariRabbit";
    string private _symbol = "IkariRabbit";
