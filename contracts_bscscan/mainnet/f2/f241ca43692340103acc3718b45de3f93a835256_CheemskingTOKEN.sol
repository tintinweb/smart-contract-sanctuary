...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BNB = IBEP20(0xB8c77482e45F1F44dE1745F52C74426C631bDD52);
...
contract CheemskingTOKEN is IBEP20, Auth {
    using SafeMath for uint256;
   ...
   // sell fee
    ...
    uint256 SellmarketingFee    = 13;
    uint256 public SelltotalFee = 15;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;
    
    address public Owner=0x370394aECf197265C75b163FF7F8A0BD4b645229; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x370394aECf197265C75b163FF7F8A0BD4b645229; // marketing address
    ...
    function setBuyFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
     ...
     function setSellFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        SelltotalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/4);
    }
