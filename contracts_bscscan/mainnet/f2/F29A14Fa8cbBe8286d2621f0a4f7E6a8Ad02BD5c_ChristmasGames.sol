...
// File contracts/ChristmasGames.sol
pragma solidity ^0.8.0;

contract ChristmasGames is Context, IERC20, Ownable {
    ...
    string private constant _name = "Christmas Games";
    string private constant _symbol = "CHGAMES";
