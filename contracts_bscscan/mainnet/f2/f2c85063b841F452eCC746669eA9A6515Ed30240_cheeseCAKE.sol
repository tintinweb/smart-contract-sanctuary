...
// cheeseCAKE @ https://t.me/cheeseCAKEbsc
...
// File: contracts/cheeseCAKEDividendPayingToken.sol
...
contract cheeseCAKE is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 1000000000000000 * (10**18); // 1% of total supply
    ...
    constructor() public ERC20("cheeseCAKE", "cheeseCAKE") {
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "cheeseCAKE: The liquidity wallet is already this address");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "cheeseCAKE: This account cannot send tokens until trading is enabled");
        }
...
contract cheeseCAKEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("cheeseCAKE_Dividend_Tracker", "cheeseCAKE_Dividend_Tracker") {
    	claimWait = 3600;
