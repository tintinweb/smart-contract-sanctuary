...
/**
BullDoge
Telegram: https://t.me/bsc_bulldoge

The more BullDoge tokens you hold the bigger your doge rewards are, the bigger the MC even bigger the rewards! For now it's a memecoin, if we reach 1m we'll launch an NFT marketplace

Join the announcements channel, the CA will be there: @mikesdragoncalls
*/
...
contract BullDoge is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 2;
  uint256 private _maxTrxLimit = 10 * 10**2 * 10**12;
  address private _deployer;
  bool reward_status = false;


  constructor() public {
    _totalSupply = 100 * 10**7 * 10**12;
