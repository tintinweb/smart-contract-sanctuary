...
// Contract created specifically for HODL_ELON Token
// If you want me to make your contract, contact me at https://gentokens.com/
...
If you fail to activate your rewards you will not get them. 
Don't come crying at me, it's your tough titties.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf9631AA0eb8b36d64d9b452C5eC743E84A7c16b0;  // 9. ElonSafu Dev
...
contract HODL_ELON is Context, IERC20, Ownable { 
    ...
    mapping (address => bool) private _isSnipe; //XXXXXXX 
    ...
    address payable public Wallet_Dev = payable(0xf9631AA0eb8b36d64d9b452C5eC743E84A7c16b0); // 9. ElonSafu Dev
    address payable public Wallet_Marketing = payable(0x1CE303A8c02Ddd30f84DD93Fbd7FF4f0EE6a4529); // 12. ElonSafu Marketing
    address payable public Fair_Buy_Launch = payable(0x48b32f109A7b735A8Bf3fadf7Be72BA7345c636a); // 23. HODL_ELON
    ...
    constructor () {
        ...
        _preLaunchAccess[Fair_Buy_Launch] = true;
    ...
    */
    ...
    // The meme tokens 
    IERC20 public Meme_Token_1 = IERC20(0xA9667d44B0f9D0fb7541869b59203B86bc867249);
    IERC20 public Meme_Token_2 = IERC20(0xa516338a2Ae891774C8c67E4f974a48F6E1b8D6F);
    IERC20 public Meme_Token_3 = IERC20(0xeF98b948D031F1f4F1EB47B7ae999b314707AcB5);
...
// Don't steal my code! It is not open source. If you want me to make your contract you can contact me via my website.