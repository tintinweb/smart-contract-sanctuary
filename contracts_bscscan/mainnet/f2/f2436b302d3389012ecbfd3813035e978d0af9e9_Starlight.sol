...
contract Starlight is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x99e3968DE12db62887e681BD39F3761904af8293); // Marketing Address
    ...
    string private _name = "Starlight Finance";
    string private _symbol = "STARLIGHT";
