...
contract XLMNT is ERC20Interface, babyMath {
    string public name = "Stellar Network";
    string public symbol = "XLMNT";
    uint8 public decimals = 18;
    uint256 public _totalSupply = 1000000000000000000000000; // 2 billion SIM in supply
