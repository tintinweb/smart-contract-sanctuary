...
/**
    ...
    |__  $$__/                                            |__  $$__/
      ...
      | $$ /$$__  $$| $$      | $$  | $$| $$       /$$__  $$| $$   
      | $$|  $$$$$$$|  $$$$$$$|  $$$$$$/|  $$$$$$$|  $$$$$$$| $$   
      |__/ \_______/ \_______/ \______/  \_______/ \_______/|__/   

    Welcome to TacocaT! Everyone loves TACOS! Not everyone loves CATS!
    We're going to be giving away some ... thing... Maybe PenguinPunk NFTs,
    maybe bUSD, maybe... CAKE?
    ...
    */
    ...
    // CHANGE
    contract TacocaT is IERC20, Ownable {
        using SafeMath for uint256;
        ...
        uint256 public _maxTxAmount = (_totalSupply * 35) / 1000; // 3.5% MAX 20,000,000
        ...
        uint256 giftfee = 400; // 400%
        uint256 totalFee = 2000; // liquidityFee + reflectionFee + giftfee
        ...
        constructor () {
            ...
            giftfeeReceiver = address(0x6B6d9FE31adFf7934CFd978641196f1800fc65d3);
        ...
        function swapBack() internal swapping {
            ...
            uint256 amountBNBDev = amountBNB.mul(giftfee).div(totalBNBFee);
    
            try distributor.deposit{value: amountBNBReflection}() {} catch {}
            (bool success,) = payable(giftfeeReceiver).call{value: amountBNBDev, gas: 30000}("");
        ...
        function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _giftfee, uint256 _feeDenominator) external onlyOwner {
            liquidityFee = _liquidityFee;
            buybackFee = _buybackFee;
            reflectionFee = _reflectionFee;
            giftfee = _giftfee;
            totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_giftfee);
            feeDenominator = _feeDenominator;
            require(totalFee < feeDenominator/4);
        }
    
        function setFeeReceivers(address _autoLiquidityReceiver, address _giftfeeReceiver) external onlyOwner {
