...
/**
// SantaMetaverse
// tg: https://t.me/SantaMetaverseChat
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // rewards token address #1
...
contract SantaMetaverse is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // put rewards CA here #3
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SantaMetaverse"; //token name #4 
    string constant _symbol = "SMETA"; // token tika #5
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 10 )  / 100; //max transaction % #6

    //max wallet holding 
    uint256 public _maxWalletToken = ( _totalSupply * 10 ) / 100; // max wallet %
    ...
    uint256 liquidityFee    = 33; // ammount to LP #7
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x11FD4241322e6Ee42C0D21862e42BdAf5b68bFFE   ;
