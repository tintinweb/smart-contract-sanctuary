...
/*
    ...
    Telegram: https://t.me/fullmetalalchemistbsc
*/
...
contract FullmetalAlchemist is Context, IERC20, Ownable { //CHANGE IT
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fullmetal Alchemist"; //CHANGE IT
    string private _symbol = "FMA"; //CHANGE IT
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe8aa3db99396cf267A22F1cF74bf503f3215D98e); // Marketing Address //CHANGE IT
    address payable public buyBackWalletAddress = payable(0x8a423603c9b05C0256D10724d60364B35CcCDa7F); // buyback Address     //CHANGE IT
    ...
    uint256 private _totalSupply            = 1 * 10**9 * 10**9;    // 1 billion
    uint256 public _maxTxAmount             = 10 * 10**6 * 10**9;   //10 million %1
    uint256 public _walletMax               = 10 * 10**6 * 10**9;  // 10 million %1
    ...
    function setTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuyBackTax, uint256 newExtraFeeOnSell) external onlyOwner() {
     ...
     function setBuyAndSellTaxes(uint256 totalBuyingTax, uint256 totalSellingTax) external onlyOwner() {
        _totalTaxIfBuying = totalBuyingTax;
        _totalTaxIfSelling = totalSellingTax;
    }
