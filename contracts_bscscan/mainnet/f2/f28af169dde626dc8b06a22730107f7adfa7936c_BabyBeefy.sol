...
Countdown: https://countingdownto.com/?c=3768631
TG: https://t.me/BabyBeefyOfficial
Website: https://www.babybeefy.com
Twitter:https://twitter.com/BabyBeefyBSC

3% marketing
8% rewards distributed in Beefy.Finance
3% liquidity
3% buyback

100 billion total supply
2% max transaction/max wallet
1% max sell
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BEEF = IBEP20(0xCa3F508B8e4Dd382eE878A314789373D80A5190A);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BEEF.balanceOf(address(this));
        ...
        uint256 amount = BEEF.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BEEF.transfer(shareholder, amount);
...
contract BabyBeefy is IBEP20, Auth {
    using SafeMath for uint256;

    address BEEF = 0xCa3F508B8e4Dd382eE878A314789373D80A5190A;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBeefy";
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        if(haslaunched == true && launchedAt + 4 >= block.number){
