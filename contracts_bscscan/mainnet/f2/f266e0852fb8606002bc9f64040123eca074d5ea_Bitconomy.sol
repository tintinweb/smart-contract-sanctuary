...
/**
   ...
   I make this #Bitconomy to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/bitconomybsc

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #Bitconomy to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49% total supply to the pool
   Can you make #Bitconomy 1000X? 
...
contract Bitconomy is Context, IERC20, Ownable {
    ...
    string private _name = "Bitconomy";
    string private _symbol = "Bitconomy";
