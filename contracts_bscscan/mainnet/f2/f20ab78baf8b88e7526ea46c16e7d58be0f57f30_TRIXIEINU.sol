...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x78eCda717a48b3F97dd828528f76468DA46B2E2f;
...
contract TRIXIEINU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbf4136F11229984618E45C994570EaC08D5410BD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Trixie Inu";
    string private _symbol = "TRIXIE";
