...
contract BlockMonsters is Context, IERC20, Ownable {
    ...
    string private _name   = "BlockMonsters";
    string private _symbol = "MNSTRS";
    ...
    uint256 private constant _Charity_FEE = 4;    //  Charity Wallet Fee (in bips)
