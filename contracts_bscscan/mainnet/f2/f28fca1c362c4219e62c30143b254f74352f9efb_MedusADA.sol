...
/**
 ...
 // Mystery Fair Launch // MedusADA // Rewards token 


 // Telegram: https://t.me/MedusADA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 FLOKI = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
// CHANGE
contract MedusADA is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address FLOKI = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MedusADA";
    string constant _symbol = "MedusADA";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 3% MAX 30,000,000
    ...
    uint256 buybackFee = 0;   // 2% 
    uint256 reflectionFee = 500; // 5%
    uint256 devFee = 500; // 4%
    uint256 totalFee = 1300; // liquidityFee + reflectionFee + devFee
    uint256 feeDenominator = 10000;
    uint256 public _sellMultiplier = 2; // 2x for sells
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 5M swap
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x571aeDb5B74a7Dc524e92160755Bf68d81c06907);
