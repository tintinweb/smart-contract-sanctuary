...
contract MasterChef is Ownable {
    ...
    uint256 public pepePerBlock = 0.002 ether;
    ...
    function updatePool(uint256 _pid) public {
        ...
        pepe.mint(address(syrup), pepeReward);
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        require(_pid != 0, 'deposit PEPE by staking');
        ...
        if (user.amount > 0) {
            ...
            if (pending > 0) {
                safePepeTransfer(_msgSender(), pending);
            }
        }
        if (_amount > 0) {
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        require(_pid != 0, 'withdraw PEPE by unstaking');
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][_msgSender()];
    ...
    // Stake PEPE tokens to MasterChef
    ...
    // Withdraw PEPE tokens from STAKING.
    ...
    function safePepeTransfer(address _to, uint256 _amount) internal {
        syrup.safePepeTransfer(_to, _amount);
    }
