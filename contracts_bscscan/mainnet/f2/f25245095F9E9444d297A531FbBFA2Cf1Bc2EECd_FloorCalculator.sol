...
contract FloorCalculator is TokensRecoverable
{
    ...
    // add addresses that you have just locked Pi permanently and wont ask for Wizard or pBNB from pool
    ...
    // wrapped BNB = ? 
    // backing token is pBNB 
   
    function calculateSubFloorPBNB(IERC20 wrappedToken, IERC20 backingToken) public view returns (uint256)
    {
