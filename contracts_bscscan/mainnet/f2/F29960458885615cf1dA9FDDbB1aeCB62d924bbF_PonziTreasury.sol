...
contract PonziTreasury is Ownable {
    ...
    constructor (
        ...
        isLiquidityToken[ _PONZIBUSD ] = true;
        liquidityTokens.push( _PONZIBUSD );
        bondCalculator[_PONZIBUSD] = _bondCalculator;
    ...
    function withdraw( uint _amount, address _token ) external {
        ...
        uint value = valueOfToken( _token, _amount );
        IPONZIERC20( PONZI ).burnFrom( msg.sender, value );
    ...
    function incurDebt( uint _amount, address _token ) external {
        ...
        uint maximumDebt = IERC20( sPONZI ).balanceOf( msg.sender ); // Can only borrow against sPONZI held
    ...
    /**
        ...
        @param _amount uint
     */
    function repayDebtWithPONZI( uint _amount ) external {
        require( isDebtor[ msg.sender ], "Not approved" );

        IPONZIERC20( PONZI ).burnFrom( msg.sender, _amount );
...
abstract contract ERC20Permit is ERC20, IERC2612Permit {
    ...
    bytes32 public DOBUSDN_SEPARATOR;
    ...
    function permit(
        ...
        bytes32 _hash = keccak256(abi.encodePacked(uint16(0x1901), DOBUSDN_SEPARATOR, hashStruct));
