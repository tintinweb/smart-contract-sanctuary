...
Website http://squidstar.space/
Telegram https://t.me/squidstarbsc
Twitter https://twitter.com/SquidStarBSC
...
contract SquidStar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Squid Star";
    string private _symbol = "SQS";
    ...
    // Max Tx amount to be 0.5% of supply
    uint256 public _maxTxAmount = 500_000 * 10**9;

    // Liquify when xx tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 90_000 * 10**9;
