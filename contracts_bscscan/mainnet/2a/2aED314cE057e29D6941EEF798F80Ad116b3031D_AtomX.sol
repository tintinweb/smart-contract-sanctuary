...
contract AtomX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress = payable(0x617DB2Bc47fFB9f405C7C38eD894c6a40C3F4D8B); // buyback
    ...
    string private _name = "AtomX";
    string private _symbol = "AtomX";
    ...
    function setLiquidityAddress(address _marketingAddress) external onlyOwner() {
