...
Welcome to the first Multi-Network community of Doge’s Origin.

Japanese BSC Fair Launch
Date: 08/21 17.30 UTC
...
No max buy/sell
Contract Verified
Liquidity Locked DXSale
No team tokens
PancakeSwap V2

Official Social Medias:
Website: https://babyjapanesedoge.com/
Twitter: https://twitter.com/babyjapanesedg
...
contract BabyJapaneseDogeToken is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Japanese Doge";
    string private _symbol = "BJD";
    uint256 private _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 2;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _toHolder = 8;
    ...
    address _marketingWallet = 0xB4821292843baAdfDe69D69996a56797cAF4f78E;
