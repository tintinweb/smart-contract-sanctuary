...
contract BeeNBee is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    //Anti-Whale System
    uint256 public maxWalletTokens =  2250000000000 * (10**9);
    
    mapping(address => bool) public _isBlacklisted;

    string constant _name = "BeeNBee";
    string constant _symbol = "BeeNBee";
    ...
    function removeMaxWallet() public onlyOwner {
         maxWalletTokens = 2250000000000 * 10**9;
