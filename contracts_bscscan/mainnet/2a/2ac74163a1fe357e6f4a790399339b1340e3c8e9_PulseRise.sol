...
contract PulseRise is Context, IERC20, Ownable {
    ...
    string private _name = "PulseRise";
    string private _symbol = "PulseRise";
    ...
    uint256 public _sellBuyback = 15;
    uint256 public _sellrfi = 3;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount - (tFee) - (tBuyback);
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tBuyback, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount - (rFee) - (rBuyback);
    ...
    function setSellFees(uint256 sellBuyback, uint256 sellRfi) external onlyOwner{
