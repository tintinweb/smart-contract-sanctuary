...
contract AkitaBomber is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("AkitaBomber ", "AkitaBomber") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "AkitaBomber";
    string private _symbol = "AkitaBomber";
