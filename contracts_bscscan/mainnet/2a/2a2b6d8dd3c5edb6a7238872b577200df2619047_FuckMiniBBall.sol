...
/**
     Welcome to FUCKMINIBASKETBALL
     Liquidity will be locked.

     Join the TG - https://t.me/FuckMiniBasketHoney
...
contract FuckMiniBBall is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FuckMiniBBall";
    string constant _symbol = "FuckMiniBBall";
