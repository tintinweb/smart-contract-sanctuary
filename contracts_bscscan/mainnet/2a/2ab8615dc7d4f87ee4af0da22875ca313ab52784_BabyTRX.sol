...
contract BabyTRX is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "BabyTRX";
    string private _symbol = "BabyTRX";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xDD3F4Db5Ec357291D377444cAc723288883e7256, 'We can not exclude Uniswap router.');
