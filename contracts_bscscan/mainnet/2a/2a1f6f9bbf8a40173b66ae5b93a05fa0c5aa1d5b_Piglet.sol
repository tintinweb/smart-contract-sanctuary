...
contract Piglet is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x95cdb7c6670EFa27EcB9D8A39381c8e398a518C6); // Marketing Address
    address payable public charityAddress = payable(0x95cdb7c6670EFa27EcB9D8A39381c8e398a518C6); // Charity/Dev Address
    ...
    string private _name = "Piglet Swap"; // nice
    string private _symbol = "PIGL";
