...
all you need to do is hold MilanoCardano to automatically receive $ADA dividends in your wallet.
...
contract MilanoCardano is Context, IERC20, Ownable {
    ...
    string private _name = "MilanoCardano";
    string private _symbol = "miADA";
