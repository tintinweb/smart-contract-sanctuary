...
/*
   DOGEB0T is the First Competitive Liquidity Mining Token with Protective Shield
...
contract DOGEB0T is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public immutable factorsellFee = 200; 
    ...
    constructor() public ERC20("DOGEB0T", "DB0T") {
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[to]) {
                fees = fees.mul(factorsellFee).div(100);
            }
...
contract TDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("DOGEB0T_Dividend_Tracker", "DB0T_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Dividend_Tracker: claimWait must be updated to between 10min and 24 hours");
