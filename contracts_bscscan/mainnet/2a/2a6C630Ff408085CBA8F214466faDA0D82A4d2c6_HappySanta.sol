...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3Eb147c00FF099FB0e9E8B22352F67732376be4e;
...
contract HappySanta is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x61c35A4B11dd2b718693B1B3fa11450859a32cee;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HappySanta";
    string private _symbol = "HSANTA";
