...
░╚════╝░╚══════╝░░░╚═╝░░░╚═╝░░░░░╚═╝╚═╝░░░░░╚═╝░╚════╝░  ╚═════╝░░╚════╝░░╚═════╝░╚══════╝
       ...
       ys             `-:-yo.-:::-.         `:oyoM++ooys+-             os`                
       +y-          .::.`/y: `Nm`.-:-      /yo:`mN` -s/./ys-          .s+                 
       `sy-        -/-  /y+   :Nd. `::   `sy- .dN:   /s/  /h+        -so`                 
         /yo:`    ./-./ss-     .hMy:`:-  oy-:yMh.     -os:`/y:    `-+s/                   
          `:+yso+/-/:s+-         .odNdhy/yshdo.         ./oso+/++os+:`                    
              `.-.-/`                /+:.yy                .o/...`                        
                  `::               ./-  /h/               sy.                            
                   `::`            -/-    /y+`           .sy-                             
                     -::.`     `.-:-`      .oy+:.    `./sy+`                              
...
The Biggest CRYPTO event of the year!
The Biggest Prizes in Crypto History!
Join us to celebrate the TOKYO 2020 Olympic Games with OLYMPIC DOGE and earn rewards in DOGECOIN

-----------------

OlympicDoge is a 2nd layers of TokyoDoge
Website: https://www.tokyodoge.com/
TG: https://t.me/tokyodogecoin
Owner: @linfordc
Dev: @monkey_shanti
Marketing: @STEVENBRADBURY
...
contract OlympicDoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "OlympicDoge";
    string constant _symbol = "OlympicDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 10; // 5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEE27753a674B2062d961241D9b07776BA64aF0B5; //WALLET DEV
