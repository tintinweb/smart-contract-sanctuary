...
🔰This has the potential to be bigger than BabyCake as we are launching a new type of contract🔰

⚡️This is not just another reward token, we have a innovative reward system which calculates chart movement and allocates holders Cake (rewards) or Dough (reflections) based on buys and sells.

 Also we did some upgrades on the 4 sells in a row to avoid fud. ⭐️ 

✅ Like I said I will video dox before launch and see if we can burn LP to proof everyone it’s safe.

✅ We will fairlaunch once the website is ready. Stay tuned for updates and launch date.
