...
/**
   ...
   Welcome Cake Money Doge
   
   This is a community token. If you want to create a telegram I suggest to name it to @CakeMoneyDoge
   ...
   I will renounce the ownership to burn addresses to transfer #CakeMoneyDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #Cake Money Doge 10000X? 
...
contract CakeMoneyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Cake Money Doge";
    string private _symbol = "CAKMONDOG";
