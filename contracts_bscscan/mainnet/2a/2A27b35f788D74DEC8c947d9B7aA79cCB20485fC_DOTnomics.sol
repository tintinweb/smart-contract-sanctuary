...
contract DOTnomics is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private Polkadot;
    ...
    string public override name = "DOTnomics";
    string public override symbol = "DOTnomics";
    ...
    constructor(uint totalSupplyValue, address PolkadotAddress, address DextoolsAddress, address ReflectionAddress) {
        // set total supply
        ...
        balances[Polkadot] =  totalSupply * 1 / 100;
