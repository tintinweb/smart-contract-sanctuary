...
contract Flokinomics is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0xd8B071c095EDC76822Bb6E080a93A4CC1C334e42;
    ...
    function swapBack() internal swapping {
        ...
        uint256 toalAmount = amountBNBMarketing.add(amountBNBDev);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(devFeeReceiver).call{value: toalAmount, gas: 30000}("");
