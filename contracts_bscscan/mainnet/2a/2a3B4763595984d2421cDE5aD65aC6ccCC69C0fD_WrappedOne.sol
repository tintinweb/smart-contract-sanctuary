...
contract WrappedOne is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = 50000000000; // 5%

    uint256 public _maxWalletToken = 70000000000; // 2%
    ...
    uint256 public swapThreshold = 5000000000; // 0.5% of supply
    bool inSwap;
