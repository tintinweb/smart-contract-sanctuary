...
/**
 *  
DOGMOON is a community-driven BEP-20 token focused on creating a play-to-earn NFT PC card game as well as being an innovative deflationary token aiming to 
revolutionize decentralized finance. Our project is built with passion and dedication, concentrating on growth to reward our community.
 We have an exciting future ahead with plans for being a multi-chain bridge integrated into real-world use cases. Whether you will play the DOGMOON P2E NFT-based card game, 
 stake tokens for income, or just hold, $MOON will help you reach your financial goals while being part of a wonderful family.
DOGMOON will serve as an all-rounder incubator for early projects, assisting them with turnkey solutions for a successful launch 
-and rewarding our holders with reflections.

DOGMOONは、コミュニティ主導のBEP-20トークンであり、プレイ・トゥ・アーンのNFT PCカードゲームを創造し、分散型金融の革命を目指す革新的なデフレ・
トークンであることに焦点をあてています。私たちのプロジェクトは、情熱と献身をもって構築され、コミュニティに報いるために成長に集中しています。私たちは、
実世界のユースケースに統合されたマルチチェーンブリッジとなる計画で、エキサイティングな未来が待っています。DOGMOONのP2E NFTベースのカードゲームをプレイするか、
トークンを賭けて収入を得るか、あるいはただ保有するか、$MOONは素晴らしい家族の一員になりながら、あなたの金融目標を達成するお手伝いをします。DOGMOONは
初期プロジェクトのインキュベーターとして、
成功するためのターンキーソリューションで支援し、保有者には反射的に報酬を与える予定です。

TG: https://t.me/BSCdogmoon
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49D6752ab42faADdcFe2DA6856F5D0192C033F63;
...
contract DogMoon is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x49D6752ab42faADdcFe2DA6856F5D0192C033F63;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DogMoon";
    string private _symbol = "DMON";
