...
//Just launched in Santa Venom. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//SantaVenom Hold we will To the moon
//telegram : @SantaVenom
...
contract SantaVenom is Context, IERC20, Ownable {
    ...
    string private _name = "SantaVenom";
    string private _symbol = "SantaVenom";
