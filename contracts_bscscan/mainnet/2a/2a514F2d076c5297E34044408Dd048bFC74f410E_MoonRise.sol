...
contract MoonRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x764bBf16a05E27dc77B91674fEcbf4a176830Ef8); // Marketing Address
    ...
    string private _name = "Mini Nano Doge";
    string private _symbol = "MINInanodoge";
