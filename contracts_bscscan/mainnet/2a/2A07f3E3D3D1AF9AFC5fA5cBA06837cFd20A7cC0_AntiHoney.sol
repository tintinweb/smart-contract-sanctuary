...
//Just launched in $AntiHoney. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//AntiHoney Hold we will To the moon
//telegram : @AntiHoneyBSC
...
contract AntiHoney is Context, IERC20, Ownable {
    ...
    string private _name = "ANTI HONEY";
    string private _symbol = "AntiHoney";
