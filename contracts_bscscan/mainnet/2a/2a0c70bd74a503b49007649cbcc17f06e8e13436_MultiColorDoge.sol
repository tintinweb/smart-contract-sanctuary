...
/**
 Welcome to MultiColorDoge
   
   This is a community token
   Important: The early you create a group that shares the token, the more gain you'll get.
   ...
   I will renounce the ownership to burn addresses to transfer #MultiColorDoge to the community

   I will add 1.5 BNB and all the left 10% total supply to the pool
   Can you make MultiColorDoge 100X? 
   ...
   it's the best part of the #MultiColorDoge idea, increasing the liquidity pool automatically, 
   help the pool grow from the small init pool.
   
   TELEGRAM: https://t.me/MulticolorDoge
*/
...
contract MultiColorDoge is BEP20 {
