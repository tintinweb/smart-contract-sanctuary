...
contract DividendDistributor is IDividendDistributor {
    ...
    contract FlokiMEWN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiMEWN";
    string constant _symbol = "MEWN";
...
//Cooldown and timer functionality
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xbD0284da51B85EA28f09bf56f73213a16b0cbc25;
...
//Cooldown timer, so a bot doesnt do quick trades!
        if (sender == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Please wait before you buy again.");
