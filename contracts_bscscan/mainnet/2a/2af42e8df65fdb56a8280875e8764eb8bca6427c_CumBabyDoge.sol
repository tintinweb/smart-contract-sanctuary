...
/**
   ...
   Welcome Cum Baby Doge
   
   This is a community token. If you want to create a telegram I suggest to name it to @CumBabyDoge
   ...
   I will renounce the ownership to burn addresses to transfer #CumBabyDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #CumBabyDoge 10000X? 
...
contract CumBabyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Cum Baby Doge";
    string private _symbol = "CMDOGE";
