...
/** Facebook Metaverse 2022(X100000)
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1736e81fA1df52ea44A33656Aef1302B68E761eD;
...
contract FacebookMetaTeam2022 is Context, IERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0x2c08f33f7f5c96b0b3882ceC1Fde519D8BBF671C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Facebook Metaverse 2022";
    string private _symbol = "FMR";
