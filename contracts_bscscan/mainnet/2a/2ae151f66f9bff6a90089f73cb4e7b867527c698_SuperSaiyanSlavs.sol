...
// Super Saiyan Slavs
// TG: https://t.me/SuperSaiyanSlavs
// 8% AutoLP
// 1% Marketing Fee
// 1% Auto Burn
...
contract SuperSaiyanSlavs is Context, IERC20, Ownable {
    ...
    string private _name = "SuperSaiyanSlavs";
    string private _symbol = "SSS";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 69 * 10**12 * 10**_decimals;
    
    address payable public marketingAddress = payable(0x8b5Ea8239f126679aeA1B6B16d93eB0F4308d179);
    ...
    constructor () {
        ...
        _liquifyThreshhold = ( _totalSupply * 2 ) / 1000; // Swap at .2%
        _maxBalance = ( _totalSupply * 4 ) / 100;  // 4 is the percentage of max wallet.
