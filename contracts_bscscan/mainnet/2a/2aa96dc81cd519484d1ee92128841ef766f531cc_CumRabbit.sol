...
contract CumRabbit is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**6 * 10**18; //1 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CumRabbit";
    string private _symbol = "CUMRBT";
