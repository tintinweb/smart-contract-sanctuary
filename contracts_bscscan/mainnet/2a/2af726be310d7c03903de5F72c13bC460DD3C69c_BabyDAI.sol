...
contract BabyDAI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5a8A476d8b6f53577A03423C76C1c5d83f6E21c9); // Marketing Address
    ...
    string private _name = "BabyDAI";
    string private _symbol = "BabyDAI";
    ...
    uint256 public _buyBackTimeInterval = 60 minutes;
