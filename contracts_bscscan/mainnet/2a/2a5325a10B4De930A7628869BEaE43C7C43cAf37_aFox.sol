...
Official Telegram group : https://t.me/AlienFoxBsc
...
import "./aFoxDividendTracker.sol";

contract aFox is ERC20, Ownable {
    ...
    aFoxDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("AlienFox", "aFox") {

    	dividendTracker = new aFoxDividendTracker();

        _marketingWalletAddress = 0x1207DD18e2d3939303c11a80610D3FdEb974d43c;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "aFox: The dividend tracker already has that address");

        aFoxDividendTracker newDividendTracker = aFoxDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "aFox: The new dividend tracker must be owned by the AlienFox contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "aFox: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "aFox: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "aFox: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "aFox: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "aFox: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "aFox: Cannot update gasForProcessing to same value");
