...
contract TykeStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // The TYKE TOKEN!
    IBEP20 public immutable tykeToken;
    ...
    constructor(
        ...
        tykeToken = IBEP20(0x0b0930Cc9BF439a4F5fCE2D7f1fc26B288efB2E2);
        rewardToken = IBEP20(0x0b0930Cc9BF439a4F5fCE2D7f1fc26B288efB2E2);
        rewardPerBlock = 20 * 1e18; // 20 per block
        startBlock = block.number;
        bonusEndBlock = 99999999;

        // staking pool
        poolInfo.push(PoolInfo({
            lpToken: IBEP20(0x0b0930Cc9BF439a4F5fCE2D7f1fc26B288efB2E2), // TYKE
            allocPoint: 1000,
        ...
        transferOwnership(0xFA4421b890649aCF5Ce1e73A8fCAf05E7CD2Ca79);
    ...
    function updateRewardPerBlock(uint256 _amount) external onlyOwner {
        require(_amount <= 5000, "Cannot set higher than 50 TYKE per Block");
