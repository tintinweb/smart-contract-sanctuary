...
contract Paaamp is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PAAAMP";
    string constant _symbol = "PMP";
    ...
    // My Lovely Anti Sniper deployed by the Team
    uint256 public maxRoomRent = 50000000000;
    bool public YourAreGoingToDie = false;
    ...
    // lobby manager
    function enable_GoingToDie(bool _status) public onlyOwner {
        YourAreGoingToDie = _status;
    }
