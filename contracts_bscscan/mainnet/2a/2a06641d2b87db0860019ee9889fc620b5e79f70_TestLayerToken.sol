...
// File: contracts/TestLayerToken.sol

pragma solidity 0.6.12;

contract TestLayerToken is BEP20 {
    ...
    /**
     * @notice Constructs the TestLayerToken contract.
     */
    constructor() public BEP20("TestLayerOne", "TEST") {
    ...
    /// @dev overrides transfer function to meet tokenomics of TestLayer
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (blacklist[sender] == true) {
            ...
            require(amount == sendAmount + taxAmount, "TestLayer::transfer: Tax value invalid");
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) public onlyOperator {
        require(_transferTaxRate <= MAXIMUM_TRANSFER_TAX_RATE, "TestLayer::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate.");
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(newOperator != address(0), "TestLayer::transferOperator: new operator is the zero address");
