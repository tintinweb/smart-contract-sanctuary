...
contract RockPaperScissorsToken is Context, IERC20, Ownable {
    ...
    string private _name = "RockPaperScissorsToken";
    string private _symbol = "RPST";
    ...
    uint256 private numTokensSellToAddToLiquidity = 2300000 * 10**6 * 10**9;
