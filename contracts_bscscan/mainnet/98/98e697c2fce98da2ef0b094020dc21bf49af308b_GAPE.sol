...
$GAPE MEME TOKEN 
DONT ASK FOR USECASE AND ENJOY JUICY $FEG REWARD
...
Telegram @greenapebsc
Twitter @greenapebsc
Reddit u/greenape_gape
website : https://greenape.tech
...
contract GAPE is IBEP20, Auth {
    ...
    string constant _name = "GREEN APE";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 100000; // 0.0001% of supply
    bool inSwap;
...
/* Airdrop Begins */
 ...
 function airdrop(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountGAPE);
