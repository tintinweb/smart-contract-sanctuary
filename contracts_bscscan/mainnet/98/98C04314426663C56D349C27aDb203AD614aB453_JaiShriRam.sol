...
/**
A fork of DrunkDoge
With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, JohnyDepp was designed to reward holders and discourage dumping.
You dump early, you lose.

https://t.me/johnydepp

Token Information
1. 2,000,000,000 Total Supply
...
contract JaiShriRam is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"JaiShriRam";
    string private constant _symbol = "JSR";
