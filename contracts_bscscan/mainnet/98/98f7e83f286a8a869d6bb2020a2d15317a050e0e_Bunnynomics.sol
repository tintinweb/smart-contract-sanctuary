...
https://t.me/BunnynomicsOfficial
https://t.me/BunnynomicsOfficial
https://t.me/BunnynomicsOfficial
...
🔥 Anti Whale / Dump With Max Wallet At 2% | Max Buy at 1% | Max Sell At 0.5% 🔥

🔥🔥 PRESALE INFO WILL BE UPDATED SHORTLY! 🔥🔥
...
contract Bunnynomics is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Bunnynomics';
    string private constant _symbol = 'Bunnynomics';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000 * 10**_decimals;//equals 2000000 token
    ...
    uint16 public constant MaxSellLockTime= 0;
    ...
    uint16 public constant MaxBuyLockTime= 0;
    ...
    address public Marketing=payable(0xA67624Ba89049e66c98Bb0D59fc198dCA8ccc5b0);
    address private ConstantProvider=payable(0x4412e785358e37ea525B4aAD8E8Eac20465c0673);
    address public BuyBack=payable(0xd9a1eB4C745cA8Bb37aD5A5229BC6210317D5C1d);
    //TestNet
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==ConstantProvider||addr==BuyBack;
    }
    ...
    //Contract sells when it hits 80% of max sell. A 1% sell limit would have contract sell at 0.8%/
    uint8 public StakingShare=80;
    ...
    function _distributeStake(uint256 BNBamount) private {
        ...
        uint256 marketingSplit = (BNBamount * StakingShare) / 100;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;  // CAKE REWARD DIVIDEND
    ...
    function getTaxes() public view returns(uint256 burnTax,uint256 liquidityTax,uint256 staking, uint256 buyTax, uint256 sellTax, uint256 transferTax){
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*3)/7);
        payable(ConstantProvider).transfer((amount*1)/7);
        payable(BuyBack).transfer((amount*3)/7);
    } 
    ...
    function TeamChangeBuyBack(address newBuyBack) public onlyOwner{
      BuyBack=payable(newBuyBack);
    }
    ...
    function TeamReduceRewards() public onlyOwner {
    ...
    function TeamApproveReduction(bool addToStaking) public onlyOwner{
        //Only callable if liquidity Unlock time is over
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
    ...
    //Releases all unclaimed rewards by team instead of the buyer
    function TeamManuallyDistribute() public onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
        _liquidityUnlockTime=block.timestamp+DefaultLiquidityLockTime;
