...
/**
 *  Telegram: https://t.me/CAKEZilla_Official
 
 * TotalSupply: 1,000,000,000,000,000
 
 * Reflection/Taxes: 
        2% redistribute to holder, 
        3% in Marketing, 
        5% in Liquidity
 
 * Buy Slippage: 12-15% 
 * 
 *      CCCCC         AA      KK     KK  EEEEEEE    
 *    CC     CC      AA AA    KK   KK    EE                             
 *  CC              AA   AA   KK KK      EE                                            
 *  CC             AA     AA  KKK        EEEEEEE                   
 *  CC            AAAAAAAAAA  KK KK      EE                         
 *   CC       CC  AA      AA  KK   KK    EE                             
 *     CCCCCCC    AA      AA  KK     KK  EEEEEEE            
 *  
 */
...
contract CAKEZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA1165921457918dcc6B85CEd53DbD7f74111Af11); // Marketing Address
    ...
    string private _name = "CAKE ZILLA TOKEN";
