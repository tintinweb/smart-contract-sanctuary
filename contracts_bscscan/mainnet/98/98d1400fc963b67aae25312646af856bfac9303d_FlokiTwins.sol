...
// Telegram https://t.me/FlokiTwinsOfficial

// The new Son of Floki.
...
contract FlokiTwins is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiTwins";
    string private _symbol = "FLOKITWINS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC858A6C30c66Bc70d619E0F5d9d6f7EE69357e3F); // Marketing Address
    address payable public BuybackWalletAddress = payable(0xC858A6C30c66Bc70d619E0F5d9d6f7EE69357e3F); // Buyback Wallet Address
    ...
    uint256 public _maxTxAmount = 1500000 * 10**9; // 3%
    uint256 public _walletMax = 3000000 * 10**9; // 5%
