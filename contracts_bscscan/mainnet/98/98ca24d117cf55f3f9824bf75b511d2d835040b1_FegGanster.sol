...
contract FegGanster is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Feg Gangster";
    string public _symbol= "FEGGANSTER";
     bool balances1 = true;
