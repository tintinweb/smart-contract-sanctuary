...
contract TestCA is IBEP20, Ownable {
    ...
    uint BuyTaxDuration= 300 seconds; // Duration of anti sniper
    ...
    uint constant MAXTAXDENOMINATOR=18; // total fees less than 20 %
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint contractToken=_calculateFee(amount, tax, teamTax + marketingTax + liquidityTax);
    ...
    function _swapContractToken(bool ignoreLimits) private lockTheSwap{
        ...
        uint totalTax= liquidityTax + marketingTax + teamTax;
        ...
        uint256 totalFee = marketingTax + teamTax;

        uint256 teamBNB= restBNB * teamTax / (totalFee * 100);
        uint256 marketingBNB = restBNB - teamBNB;
