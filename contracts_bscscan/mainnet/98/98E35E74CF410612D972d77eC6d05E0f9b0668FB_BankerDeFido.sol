...
// Did y'all seeing the Banker Doge pump ? Y'all missed it ? We gotcha buddy !

// 🐕‍🦺 Contract forked straight from Banker Doge.
// 🐕‍🦺 Initial LP will be 0.75
// 🐕‍🦺 LP will be locked for 3 days initially and extended after that.

// 📱Telegram: bankerdefido
...
contract BankerDeFido is Context, IERC20, Ownable {
