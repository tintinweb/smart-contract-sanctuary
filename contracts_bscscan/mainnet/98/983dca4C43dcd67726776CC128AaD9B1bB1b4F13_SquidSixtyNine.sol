...
contract SquidSixtyNine is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 420_000 * 10**_decimals;
    uint256 public maxWalletBalance = 6_900_000 * 10**_decimals;

    string private constant _name = "SquidSixtyNine";
    string private constant _symbol = "S69";
    
    address public devWallet = 0x70a222C2236453d17d952Dbd434928DD19ea7073;
    ...
    function _getValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rAmount, to_return.rTransferAmount, to_return.rRfi, to_return.rDev) = _getRValues(to_return, tAmount, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory s) {
        ...
        s.tDev = tAmount*feeRates.development/100;
        s.tTransferAmount = tAmount-s.tRfi-s.tDev;
        return s;
    }

    function _getRValues(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi, uint256 rDev) {
        ...
        rTransferAmount =  rAmount-rRfi-rDev;
        return (rAmount, rTransferAmount, rRfi,rDev);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        emit Transfer(sender, address(this), s.tDev);
    }


    function swapAndSendToFee(uint256 tokens) private lockTheSwap{
        swapTokensForETH(tokens, devWallet);
    }
