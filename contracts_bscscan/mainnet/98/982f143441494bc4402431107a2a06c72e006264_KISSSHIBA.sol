...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1035E168FEeeBEEb4A879c9b5e78AA466d862a6E;
...
contract KISSSHIBA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x24de931F331377465da09a06D1a7D7313c1B4780;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KISS-SHIBA";
    string private _symbol = "KISHIBA";
