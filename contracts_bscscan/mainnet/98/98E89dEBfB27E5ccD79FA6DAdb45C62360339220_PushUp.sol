...
contract PushUp is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Push up";
    string private _symbol = "PUSHUP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x011888190A75489Aa6E9553392Ff55E2d3e48560); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x11515B71034cfC2253444705f48cd53E36397F65); // buyback Address
