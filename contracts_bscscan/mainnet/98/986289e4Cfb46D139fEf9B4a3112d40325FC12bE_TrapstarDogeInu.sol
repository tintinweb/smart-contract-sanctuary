...
£TRAPSTARDOGEINU is built upon the fundamentals of Buyback and increasing the investor's value
...
contract TrapstarDogeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x91135dB0f703F4162DCeD9884fd6e015E7003a9D); // Marketing Address
    ...
    string private _name = "TrapstarDogeInu";
