...
/**  
            ...
            Welcome everyone to Little Baby Cake the Stealth Launching
            This is a token Community
            I suggest you to create Telegram use username @littlebabycake
            I get the initiative to create this community token, so we can build coin together
              
                    Telegram - @littlebabycake

              Name            : Little Baby Cake
              Symbol          : LTBYC
    ...
    Copyright (c) 2021 littlebabycake
...
contract LittleBabyCake is Context, iBEP20, Ownable {
