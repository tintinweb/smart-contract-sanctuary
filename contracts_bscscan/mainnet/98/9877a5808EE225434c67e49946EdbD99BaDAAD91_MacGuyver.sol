...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        emit OwnershipTransferred(0xe33fDA509895c99768C8c156d197Ce3926fF72Ad, newOwner);
        _owner = newOwner;
    }
...
contract MacGuyver is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "MACGY";
  string private _name = "MacGuyver";
