...
/**
  ...
  ____                   _     ____  _     _ _           
 |  _ \ _ __ _   _ _ __ | | __/ ___|| |__ (_) |__   __ _ 
 | | | | '__| | | | '_ \| |/ /\___ \| '_ \| | '_ \ / _` |
 | |_| | |  | |_| | | | |   <  ___) | | | | | |_) | (_| |
 |____/|_|   \__,_|_| |_|_|\_\|____/|_| |_|_|_.__/ \__,_|
                                                         
 
OFFICIAL DrunkShiba TOKEN

We are a community who want make a legit project under millions of scams.
We decided its not a long time Token.
Because of that we lock the Liquidity so Fund will be safe till then.
...
contract DrunkShiba is Context, IBEP20, Ownable {
