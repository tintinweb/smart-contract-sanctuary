...
contract MINISHIBAWARS is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("MINISHIBA WARS ", "MINISHIBAWARS") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "MINISHIBAWARS";
    string private _symbol = "MINISHIBAWARS";
