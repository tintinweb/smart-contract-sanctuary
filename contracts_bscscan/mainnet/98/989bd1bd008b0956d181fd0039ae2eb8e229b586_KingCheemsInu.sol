...
—————————
Stealth Launch
The Best Christmas coin yet!✅
1000x potential📈
Safe Team and contract🔐
Shilling competition💰
_________
4% BUY tax and 17% SELL tax for the first 2 hour
and will be change to 7% BUY tax and 9% SELL tax after.
...
contract KingCheemsInu is Context, IERC20, Ownable {
    ...
    string private _name = "KingCheemsInu";
    string private _symbol = "KingCheemsInu";
