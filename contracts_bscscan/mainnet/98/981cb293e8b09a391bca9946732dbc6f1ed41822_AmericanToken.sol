...
contract AmericanToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**5 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "AmericanToken";
    string private _symbol = "AMN";
    ...
    uint256 public _maxTxAmount = 50 * 10**5 * 10**9;
