...
/**
   ...
   Welcome Ever Moon Doge
   
   This is a community token. If you want to create a telegram I suggest to name it to @EverMoonDogeBSC
   Important: Elon just calling about Chipmunk. The early you create a group that shares the token, the more gain you'll get.
   ...
   I will renounce the ownership to burn addresses to transfer #EverMoonDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #EverMoonDoge 10000X? 
...
contract EverMoonDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Ever Moon Doge";
    string private _symbol = "EMDOGE";
