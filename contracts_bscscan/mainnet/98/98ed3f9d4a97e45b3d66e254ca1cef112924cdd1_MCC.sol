...
/**
🌇METACOINCITY - AN EXCITING CITY IN METAVERSE - NFT GAME 🌇 🔷MetaCoinCity is a project developed with the aim of creating a modern and optimal urban space in a virtual world. 🔷Here, players will experience a new space where they can buy, sell and build their own houses. 🔷The most special thing is that the project can also bring profit and help generate daily income for them thanks to Play-To-Earn mode.
*/
