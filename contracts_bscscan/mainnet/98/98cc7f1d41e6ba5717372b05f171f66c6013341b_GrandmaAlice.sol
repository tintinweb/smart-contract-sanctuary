...
/**
This is UNIS LOVELACE you bitches. Pronounce my coin properly.

https://t.me/GrandmaAlice
 
 $ALICE: 0xAC51066d7bEC65Dc4589368da368b212745d63E8
 
 Reflection/Taxes: 10% in ALICE, 3% in Liquidity, 3% to Developer
...
// CHANGE
contract GrandmaAlice is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "GrandmaAlice";
    string constant _symbol = "$GALICE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); 
    uint256 public _maxTxAmount = (_totalSupply * 20) / 2; 
    uint256 public _maxWalletSize = (_totalSupply * 50) / 5; 
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xd441b6DA47008fb02008757924113Cdf847A469a);
