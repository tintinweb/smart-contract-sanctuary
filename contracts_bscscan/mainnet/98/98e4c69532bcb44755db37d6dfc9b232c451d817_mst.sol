...
contract mst is IBEP20, Ownable {
    ...
    address marketingFeeReceiver = 0x6BdB8F128Ad8676B4A78bEe65020339E40691aF7;

    string constant _name = "MST";
    string constant _symbol = "MSTRRR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * (10 ** _decimals);
    uint256 public _maxWalletSize = (_totalSupply * 15) / 100; 
    ...
    uint256 _BUYtotalFee = 4;

    uint256 _SELLliquidityFee = 2;
    uint256 _SELLmarketingFee = 2;
    uint256 _SELLtotalFee = 4;
