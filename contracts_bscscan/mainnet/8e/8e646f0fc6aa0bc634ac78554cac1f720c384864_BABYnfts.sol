...
contract BABYnfts is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420000000000000 * 10**9; //420,000,000,000,000
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**9; //max tokens buy/sell/transfer per transaction
    uint256 public _maxWalletLimit = 10000000000 * 10**9; // 1% of the supply antiwhale
    uint256 public _maxSoldin24Hrs = 1000000000 * 10**9; // 0.1% of the supply
    uint256 private numTokensSellToAddToLiquidity = 25000000 * 10**9; //taxed token swapped for bnb to add liquidity and various tax
