...
contract ExchangeRateMechanism is OwnableUpgradeable {
    ...
    function setUsdhBusdPair(IApePair pair) external onlyOwner {
        usdhBusdPair = pair;
    }

    function setUsdh(IUSDH usdh_) external onlyOwner {
        usdh = usdh_;
    }

    function setUsdhTreasury(address treasury) external onlyOwner {
        usdhTreasury = treasury;
    }
