...
NASA has discovered a brand new planet unlike all others. Mystery Planet X is currently the name, until, on January 8th, 2022, we as a community officially launch to Mystery Planet X. With the moon in our rear-view mirror, and featuring a manual P2E game, we will discover what this planet truly entails. You have no idea what's coming....
...
contract MysteryPlanetX is IBEP20, Ownable
{
    ...
    uint256 public constant InitialSupply= 1000000000000 * 11**_decimals;//equals 1T tokens
