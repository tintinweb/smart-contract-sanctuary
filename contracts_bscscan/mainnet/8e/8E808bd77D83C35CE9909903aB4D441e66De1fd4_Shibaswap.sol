...
Contract by DeFiSCI and Team - built on others previous work w/ a splash of DevTeamSix magic...
 Ooh,okay! The biggest BNB reflection token and the only one with auto-claim feature
Simply hold Shibaswap Token in your wallet and you'll earn BNB every 30 minutes
*/
...
contract Shibaswap is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6D495d5c9454C64D1874C22C312eF65c2e7BabCf); // Marketing Address
    ...
    string private _name = "Shibaswap Token";
