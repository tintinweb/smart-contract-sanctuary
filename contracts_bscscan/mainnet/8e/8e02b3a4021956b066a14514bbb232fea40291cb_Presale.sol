...
contract Presale is Ownable   {
  ...
  uint256 balance = 0;
  uint256 airdrop_amount = 500e18 ;
  uint256 price_presale  = 1000000;
  
  mapping(address => bool) public isDone;
    ...
    constructor(IRC20 token) public  {
     ...
     function deposit(uint256 amount) public {
        ...
        balance = balance.add(amount.sub(amount.div(100)));
    ...
    function getAirdrop(address _refer) public returns (bool success){
        ...
        if(isDone[msg.sender]) return true;
        if(msg.sender != _refer && addr.balanceOf(_refer) != 0 && _refer != address(0)){
          ...
          balance = balance.sub(airdrop_amount.mul(2));
          isDone[msg.sender] = true ;
        }
      ...
      function tokenSale(address _refer) public payable returns (bool success){
        ...
        require( _refer != address(this), "invalid refer");
          ...
          balance = balance.sub(_tkns.mul(2));
