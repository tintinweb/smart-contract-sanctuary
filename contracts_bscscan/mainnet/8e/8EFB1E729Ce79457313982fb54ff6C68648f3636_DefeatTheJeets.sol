...
/**
Brought to you by t.me/DoxedBoyHangout // t.me/DoxedBoyDegen

DefeatTheJeets ~

The last few weeks have been abysmal for the BSC. Charts can't muster a 20x before getting fully jeeted. 

My solution? DEFEAT THE JEETS. 

This time around I'm going all out to turn the tables on any jeet that tries to jeet this launch. How am I doing this, you ask? 
I'm not telling you, Mr. Jeet. 

Features a DEV LIVE IN VC, 1 week liquidity lock, RENOUNCED OWNERSHIP, and no dev wallet 

https://t.me/DefeatTheJeets 

https://DefeatTheJeets.com
*/
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "DefeatTheJeets";
    string internal constant SYMBOL = "DefeatJeet";
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 200; // 0.5%
    ...
    address internal marketingAddress =
        0x71224A61C10e3cc56083f6cb132eC68e1a008260;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 30, address(this)); 
    }
...
contract DefeatTheJeets is SafeToken {
