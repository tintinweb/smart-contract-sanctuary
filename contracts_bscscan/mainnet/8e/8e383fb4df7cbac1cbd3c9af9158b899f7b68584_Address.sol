...
contract ZZprotocol is Context, IERC20, Ownable {
	...
	string private _name = "ZZ Protocol";
	string private _symbol = "ZZP";
	uint8 private _decimals = 9;
	
	uint256 public _taxFee = 4;
	uint256 private _previousTaxFee = _taxFee;
	
	uint256 public _devFee = 3; // 1% to charity wallet
	uint256 private _previousDevFee = _devFee;
	address public charityWallet = address(0x995d472C217c44dd22b684eE4f97963a77ee4a5F); // Gamer Protocol
	...
	uint256 public _maxWalletToken = 500000 * 10**6 * 10**9; // 0.25% of total supply after burn
