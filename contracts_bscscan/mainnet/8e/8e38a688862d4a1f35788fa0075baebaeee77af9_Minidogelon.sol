...
/*
MELON is a new reflection token combined with reward system & an anti-bot protocol. Thanks Reward system, hold $MELON and receive automatic 5% rewards in $DOGE while being safe from bots. Team has prepared huge marketing campaign to shill your bags and reach the moon and beyond!

We kindly invite you to join our flight!

Tg: https://t.me/minidogelonchat
*/
...
contract Minidogelon is ERC20, Ownable {
    ...
    constructor() ERC20("MiniDogelon", "MELON")  {
    ...
    uint256 public liquidityFee = 3;
        ...
        function setDOGErewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
