...
contract MelloNFT is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant MAX_PRESALE_ITEMS = 400;
    uint256 public constant PRICE = 1 ether;
    uint256 public constant MAX_MINT = 20;
    uint256 public constant MAX_MINT_PRESALE = 5;
    address public constant devAddress = 0xE7Dd39194166aa3966bb8e9b585AD8dD7DfE2787;
    string public baseTokenURI;

    event CreateNft(uint256 indexed id);

    constructor(string memory baseURI) ERC721("Mello NFT", "MELLONFT") {
        setBaseURI(baseURI);
        presale = false;
        sale = false;
    }
