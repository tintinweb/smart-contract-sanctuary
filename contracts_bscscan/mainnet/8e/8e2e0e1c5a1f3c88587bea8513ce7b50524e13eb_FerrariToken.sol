...
contract FerrariToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 599000000 * 10**18;
    ...
    address payable public marketingWallet = payable(0x2A08358d309c59Fd59870227D159dede05e9ADd0);
    ...
    uint256 public numTokensSellToAddToLiquidity = 599000 * 10**18;
    uint256 public _maxTxAmount = 59900000 * 10**18;
