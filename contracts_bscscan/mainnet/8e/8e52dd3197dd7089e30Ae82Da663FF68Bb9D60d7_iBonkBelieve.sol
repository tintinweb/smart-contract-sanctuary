...
/*
* WARNING** THIS IS MY FIRST TOKEN EVER CREATED ! ONLY BUY THIS IF YOU ARE A TRUE BONK BELIEVER** !!!
* Tax Fee: 2 % Redistributed to holders
* Liquidity Fee: 2 % 
* Marketing wallet: 2 % 
* Burn Fee: 2 % 
* Telegram: t.me/ibonkbelieve
*/
...
contract iBonkBelieve is Context, IERC20, Ownable {
    ...
    string private _name = "iBonkBelieve";
    string private _symbol = "BELIEF";
    ...
    address public marketingWallet = 0xcBfC73F73656527CdAD516c0e0a531F6cf46E392 ;
    ...
    uint256 public numTokensSellToAddToLiquidity = 3700 * 10**18;
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 burnFee, uint256 marketingFee) external onlyOwner() {
        _taxFee = taxFee;
