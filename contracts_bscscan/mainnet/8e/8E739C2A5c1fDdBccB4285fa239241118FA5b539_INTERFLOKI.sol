...
The brand new long term project from experienced devs
Tokenomics:
5% liquidity
5% reflection
...
contract INTERFLOKI is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xFe89AF62D5C1Ae22EDb7aC95EAe1340B4eE01661;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "INTERFLOKI";
    string private _symbol = "IFLOKI";
