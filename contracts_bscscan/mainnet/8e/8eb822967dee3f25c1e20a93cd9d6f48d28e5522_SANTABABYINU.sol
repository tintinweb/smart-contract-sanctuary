...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x2349c707534995A43eB0f29ab1F631fE39Af9426;
        _token = msg.sender;
    }
...
contract SANTABABYINU is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x2349c707534995A43eB0f29ab1F631fE39Af9426;
    address MarketingWalletTwo = 0x2349c707534995A43eB0f29ab1F631fE39Af9426;

    string constant _name = "SANTA BABYINU";
    string constant _symbol = "SBB";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 15000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 45000000 * (10 ** _decimals);
    ...
    address IDEXPair = 0x2349c707534995A43eB0f29ab1F631fE39Af9426;
