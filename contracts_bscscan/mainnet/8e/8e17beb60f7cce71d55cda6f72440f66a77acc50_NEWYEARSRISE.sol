...
Once the year ends, we all believe that the market will be bullish and reach new highs. Let us all work together for it!
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x456973b70dA2B2c93007d850E8f23fCa31f994Cd;
...
contract NEWYEARSRISE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x456973b70dA2B2c93007d850E8f23fCa31f994Cd);
    ...
    */
    ...
    string private _name = "New Years Rise"; 
    string private _symbol = "NYRISE";  
    ...
    uint256 private maxPossibleFee = 28 ; 


    // Setting the initial fees
    uint256 private _TotalFee = 14;
    uint256 public _buyFee = 14;
    uint256 public _sellFee = 14;
    ...
    */
    ...
    Max total fee is limited to 24% (for buy and sell combined)
    Launch fees are set to 12% buy 12% sell
