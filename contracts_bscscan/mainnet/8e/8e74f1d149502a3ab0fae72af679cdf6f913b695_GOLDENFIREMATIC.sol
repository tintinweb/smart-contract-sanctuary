...
contract GOLDENFIREMATIC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GOLDENFIREMATIC";
    string constant _symbol = "$GFM";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xfEb145Ea2d396bEF0A1c0AD0a0CF080AD2ab016f;
