...
contract LightningHand is Context, IERC20, Ownable {
    ...
    address private _MarketingWalletAddress = 0xDa050bfa1DE34f9f7d8167D9398A0B0eb2d890fC;
    ...
    function ChangeMarketingWalletAddress(address NewWallet) external onlyOwner{
