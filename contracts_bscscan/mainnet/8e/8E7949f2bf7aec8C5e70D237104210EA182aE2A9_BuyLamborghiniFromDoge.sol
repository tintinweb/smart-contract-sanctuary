...
/**
Buy Lamborghini From Doge
    
   This is a community token. Telegrams @Buy Lamborghini From Doge  Important: The early you create a group that shares the token, the more gain you got.
...
🔥TOTAL SUPPLY 1,000,000,000,000,000 LAMBODOGE
🔥BURN SUPPLY 90% LAMBODOGE
🔥NO DEV TOKEN
   ...
   I will renounce the ownership #LAMBODOGE to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #LAMBODOGE 10,000 X? 
   ...
   it's the best part of the #Buy Lamborghini From Doge idea, increasing the liquidity pool automatically, 
...
contract BuyLamborghiniFromDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Buy Lamborghini From Doge";
