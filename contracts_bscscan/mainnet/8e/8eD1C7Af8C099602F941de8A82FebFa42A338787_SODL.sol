...
/**
     Welcome to SODL. Here you can hodl if you want. But wouldnt you rather sodl for profit?
     If you hodl, You will get 14% of the transactions payable in Binance Pegged BTC.
     If you sodl you will be charged 20% tax
     
     Liquidity locked for 30 days. 

     Join the TG - https://t.me/sodlbsc
     */
...
contract SODL is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SODL";
    string constant _symbol = "SODL";
