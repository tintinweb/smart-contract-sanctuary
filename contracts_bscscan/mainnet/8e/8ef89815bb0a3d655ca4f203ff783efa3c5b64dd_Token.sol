...
//  https://t.me/DogePupBSC is where the community of this token resides.

/**
Tokenomics: 
7% fee goes to liquidity;
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'Angry Cow';
    string private _symbol = '$AngryCow';
    uint8 private _decimals = 18;
    
    
        uint256 public                _taxFee = 3; // 2% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 7; // 8% of transactions will be kept for liquidity
