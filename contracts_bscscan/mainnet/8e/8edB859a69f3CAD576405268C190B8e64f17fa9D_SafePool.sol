...
contract SafePool is Ownable {
    ...
    function swapForToken(address addr_) public onlyOwner {
        address[] memory path = new address[](2);
        path[1] = IDD;
        path[0] = U;
        router.swapExactTokensForTokens(IERC20(U).balanceOf(address(this)), 0, path, addr_, block.timestamp + 360);
    }
    ...
    function addLiquidityAuto(uint amount_) public {
