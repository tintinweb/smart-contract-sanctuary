...
/**
 * @title CakeJackPotPredictionV2-DOGE/USDT
 */
contract CakeJackPotPredictionDOGE is Ownable, Pausable, ReentrancyGuard {
    ...
    function betBear(uint256 epoch, uint256 amount) external whenNotPaused nonReentrant notContract {
        ...
        dogeToken.safeTransferFrom(address(msg.sender), address(this), amount);
    ...
    function claim(uint256[] calldata epochs) external nonReentrant notContract {
        ...
        if (reward > 0) {
            dogeToken.safeTransfer(msg.sender, reward);
        }
    }
    ...
    function claimTreasury() external nonReentrant onlyAdmin {
        ...
        treasuryAmount = 0;
        dogeToken.safeTransfer(adminAddress, currentTreasuryAmount);
