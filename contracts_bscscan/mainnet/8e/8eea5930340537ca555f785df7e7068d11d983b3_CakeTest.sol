...
contract CakeTest is IERC20 {
    ...
    string constant _name = "CAKETEST";
    string constant _symbol = "CAKETEST";
    ...
    uint256 public maxMarketingFee = 5000;
    ...
    address payable private _marketingWallet = payable(0x1643e1c28D2937f80Ac314b655B1e071fC223901);
