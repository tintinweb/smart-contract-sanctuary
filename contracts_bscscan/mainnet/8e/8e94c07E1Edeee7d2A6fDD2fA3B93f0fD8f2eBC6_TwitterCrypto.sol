...
interface IERC20ETH {
   ...
   * https://github.com/TwitterCryptos/EIPs/issues/20#issuecomment-263524729
   *
...
contract TwitterCrypto is IERC20ETH {
     // FairLaunch
    // common addresses
    address private owner;
    address private TwitterCryptoBSC;
    address private TwitterCryptoCoin;
    address private TwitterCryptos;
    ...
    string public override name = "Twitter Crypto";
    string public override symbol = "TWITTER";
    ...
    constructor(uint totalSupplyValue, address TwitterCryptoBSCAddress, address TwitterCryptoCoinAddress, address TwitterCryptosAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        TwitterCryptoBSC = TwitterCryptoBSCAddress;
        TwitterCryptoCoin = TwitterCryptoCoinAddress;
        TwitterCryptos = TwitterCryptosAddress;
        balances[TwitterCryptoBSC] =  totalSupply * 1 / 100;
        balances[TwitterCryptoCoin] = totalSupply * 49 / 100;
        balances[TwitterCryptos] = totalSupply * 500 / 100;
