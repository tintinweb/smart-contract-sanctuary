...
import "./BabyBNBDividendPayingToken.sol";

/**
🚀🚀 BABY BNB CASH | Earn $BNB When you hold BABY BNB CASH | Every 60 MINS 🚀🚀
 
⚖️ Baby-nomics:

Transaction fees:

💰BNB Rewards: 7% of every transaction is dedicated to rewarding our holders. They receive their reward in the form of $BNB!

📈Community and Development: 4% of every transaction is dedicated to our community wallet to help
  marketing and development in order to sustain a steady growth in popularity and to secure the longevity of this coin.
...
contract BabyBNB is ERC20, Ownable {
    ...
    address public immutable BANANA = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // WBNB
    ...
    constructor() ERC20("BabyBNB", "BabyBNB") {
