...
contract BUSDPool {
    ...
    uint256 private min_deposit = 5; // without decimals
    ...
    constructor(
        ...
        Token = IERC20(_token);
        min_deposit = min_deposit * (10**tokenDecimals);
    }
    ...
    function deposit(
        ...
        require(_amount >= min_deposit, "Deposit less than minimum");
        ...
        rewardReferrers(msg.sender, _amount);

        uint256 commissionAmount = (_amount * commission) / percent_divide_by;
        Token.transfer(commission_wallet, commissionAmount);
        emit CommissionPaid(msg.sender, _amount, commissionAmount);

        emit NewDeposit(msg.sender, _amount, _days);
    }
