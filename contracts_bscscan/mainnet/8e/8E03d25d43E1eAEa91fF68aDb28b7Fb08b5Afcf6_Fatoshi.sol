...
contract Fatoshi is IERC20 {
    ...
    string constant private _name = "FatSatoshi";
    string constant private _symbol = "FATOSHI";
    ...
    address payable public _marketingWallet = payable(0xf7b98Bbf13903B28876CE0DB900da4fb3001a3ee);
...
//===============================================================================================================
    ...
    function setBlacklistEnabled(address account, bool enabled) external onlyOwner {
        ...
        _isDividendExcluded[account] = enabled;
    }

    function setBlacklistEnabledMultiple(address[] memory accounts, bool enabled) external onlyOwner {
        antiSnipe.setBlacklistEnabledMultiple(accounts, enabled);
        for(uint256 i = 0; i < accounts.length; i++){
            _isDividendExcluded[accounts[i]] = enabled;
        }
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            if(scalingMaxTxEnabled) {
                if (block.number - tradingEnabledBlock <= 100) {
                    require(amount <= maxTxAmtBlock1, "Transfer amount exceeds the maxTxAmount.");
                } else if (block.number - tradingEnabledBlock <= 200) {
