...
TG: https://t.me/EvergreenBUSD

Web : www.EvergreenBUSD.xyz 


10% reward in BUSD will be automatically go to your wallet every 30 min so what you waiting for and join us in the journey to make Evergreen BUSD stay green and green only.
...
// CHANGE
contract EvergreenBUSD is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "EVERGREEN BUSD";
