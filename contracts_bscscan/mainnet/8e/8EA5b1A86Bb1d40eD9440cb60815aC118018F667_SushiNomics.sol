...
//Just launched in $SushiNomics. We have created a token so rewarding for everyone.
//SushiNomics Hold we will Tothemoon
//Tg : t.me/SushiNomicsBsc
...
contract SushiNomics is Context, IERC20, Ownable {
    ...
    string private _name = "SUSHI NOMICS";
    string private _symbol = "SushiNomics";
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private liquidAddress = 0xB56926aC8954352eBa274A2cd7bab03F7Db10d3f;
