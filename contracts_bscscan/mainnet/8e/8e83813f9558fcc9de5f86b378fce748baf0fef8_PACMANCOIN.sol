...
/**
Pac-ManCoin
Fair launch at 17:30 PM UTC

Welcome to the world of the big yellow ball!
...
TG:https://t.me/PACMAN_TOKEN
Website: https://pacmancoin.info/
...
contract PACMANCOIN is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "Pac-ManCoin";
    string private _symbol = "PAC-MAN";
    ...
    uint256 public _maxSellTransactionAmount = 15000 * 10**9; // can't sell more than this
    uint256 public _maxWalletToken = 2900000000 * 10**9; // can't buy or accumulate more than this
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**9;
