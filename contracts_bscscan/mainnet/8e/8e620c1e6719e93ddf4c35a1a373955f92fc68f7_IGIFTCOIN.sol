...
/**
 ______   ______   ______  ________  ________         ______    ______   ______  __    __ 
|      \ /      \ |      \|        \|        \       /      \  /      \ |      \|  \  |  \
 \$$$$$$|  $$$$$$\ \$$$$$$| $$$$$$$$ \$$$$$$$$      |  $$$$$$\|  $$$$$$\ \$$$$$$| $$\ | $$
  | $$  | $$ __\$$  | $$  | $$__       | $$         | $$   \$$| $$  | $$  | $$  | $$$\| $$
  | $$  | $$|    \  | $$  | $$  \      | $$         | $$      | $$  | $$  | $$  | $$$$\ $$
...
contract IGIFTCOIN is Context, IBEP20, Ownable {
    ...
    address public _charityWalletAddress = 0xBfA4b46CeaDD52206e4434BF162EAD3785e4182b;    
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 88800000 *  10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "IGIFT COIN";
    string private _symbol = "IGC";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 1; // Refelection/ Distributon 
    ...
    uint256 public _maxTxAmount = 888000 *  10**18;
    uint256 private numTokensSellToAddToLiquidity = 888000  * 10**18;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //pancake swap router       
