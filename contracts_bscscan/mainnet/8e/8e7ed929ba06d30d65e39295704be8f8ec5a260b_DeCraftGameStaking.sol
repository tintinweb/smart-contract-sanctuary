...
contract DeCraftGameStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // DeCraftGame Token Contract Address
    address public constant tokenAddress = 0x1A4Dd9d02738E9B39fAc09606AA2CA4Af13Db872;
    ...
    // unstaking possible after 6 Months
    uint public constant cliffTime = 180 days;
