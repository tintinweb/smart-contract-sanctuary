...
contract YellowDude is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x68986fEf735464B8d291a843b88Bacc800c5277E); // Marketing Address
    ...
    string private _name = "YellowDude";
    string private _symbol = "YellowDude";
