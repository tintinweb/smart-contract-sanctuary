...
contract FOMC is Context, IERC20, Ownable {
    ...
    string private _name = "Fear Our Market Cap";
    ...
    constructor() {
        ...
        ); //BSC Testnet PCS Router Address -- the above is Testnet!
    ...
    function upliftTxAmount(uint256 _amount) external onlyOwner {
_maxTxAmount = _amount * 10**9;
    ...
    {
        require(
            SwapThresholdAmount > 1,
            "Swap Threshold Amount cannot be less than 1"
        );
