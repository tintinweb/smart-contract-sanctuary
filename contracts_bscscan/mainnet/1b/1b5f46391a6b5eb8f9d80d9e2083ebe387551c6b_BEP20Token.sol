...
library SafeMath {
  ...
  */
  ...
  /**
  * @dev Subtracts two or 2 numbers, throws on overflow (i.e. if subtrahend is greater than minuend).
  */
...
contract MintableToken is StandardToken, Ownable {
   ...
   * @param _amount The amount of tokens to mint. Aftersome time
...
contract BEP20Token is PausableToken, MintableToken {
    // public variables
    string public name = "PusyCoin";
    string public symbol = "PUSY";
    uint8 public decimals = 18;

    constructor() public {
        totalSupply_ = 999999999999 * (10 ** uint256(decimals));
    }
