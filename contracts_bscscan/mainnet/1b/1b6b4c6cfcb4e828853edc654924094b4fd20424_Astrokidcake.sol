...
a little kid who wants to go to the moon and reach for the stars in a distant galaxy, we just need to give support by buying $ASTROKID and getting $CAKE

🚀 TOKENOMIC 🚀

☄️ 11% Reflection
☄️ 5% Automatic to liquidity
☄️ 1M Total Supply
☄️ Buyback after 30 minute

Social Media Information


💬 Telegram : https://t.me/Astrokidcake
💬Website : https://www/astrokidcake.com ( Under Development )
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also Astrokidcakeed.
...
// File: contracts/AstrokidcakeDividendPayingToken.sol
...
// File: contracts/Astrokidcake.sol
...
contract Astrokidcake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable Cake = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    address private _marketingWallet = address(0xCe71ac4d737820C8Cf26C894b16c8fb66D27FfE3);
    address private _devWallet = address(0xCe71ac4d737820C8Cf26C894b16c8fb66D27FfE3);
    ...
    AstrokidcakeDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Astrokidcake", "Astrokidcake") {
        ...
        dividendTracker = new AstrokidcakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Astrokidcake: The dividend tracker already has that address");

        AstrokidcakeDividendTracker newDividendTracker = AstrokidcakeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Astrokidcake: The new dividend tracker must be owned by the Astrokidcake token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Astrokidcake: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Astrokidcake: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Astrokidcake: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Astrokidcake: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Astrokidcake: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Astrokidcake: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "AstrokidcakeBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "Astrokidcake: This account cannot send tokens until trading is enabled");
        }
...
contract AstrokidcakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Astrokidcake_Dividend_Tracker", "Astrokidcake_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "Astrokidcake_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "Astrokidcake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Astrokidcake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Astrokidcake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Astrokidcake_Dividend_Tracker: Cannot update claimWait to same value");
