...
NanoPUG is the BIGGEST smallest BSC token
...
contract NanoPUG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe68838C2c68D8d59Ed750E4E5B900dCFE4647421); // Marketing Address
    ...
    string private _name = "NanoPUG";
    string private _symbol = "NanoPUG";
    ...
    function transferForeignToken() external onlyOwner {
