...
/*
https://t.me/midnightflokiofficial
http://midnightfloki.com/
https://twitter.com/MidnightFloki
*/
...
contract MIDNIGHTFLOKI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Midnight Floki";
    string constant _symbol = "MIFLOKI";
    ...
    // Anti-Bot v2
    uint256 public maxRoomRent = 3900000000000000000;
    ...
    uint256 _totalSupply = 7800000000000000000000 * 10**_decimals;//equals 750B tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x5aD43aED5174D0897647db22444C06fdEf8E1F13;
        marketingFeeReceiver = 0x81e87cE7b80F3dF526daA65f0851Cced0B4E8785;
        buyBackFeeReceiver = 0x81e87cE7b80F3dF526daA65f0851Cced0B4E8785;
		ecoFeeReceiver = 0xC482F93921C5125e98C1663F174c75FeA62b3164;
    ...
    function set_max_roomrent(uint256 _rent_withoutdecimal) public onlyOwner {
        maxRoomRent = _rent_withoutdecimal * 10**15;
    }
