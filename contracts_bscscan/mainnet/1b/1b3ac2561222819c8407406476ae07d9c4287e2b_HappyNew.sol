...
contract HappyNew is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000000000; // Total token supply
    ...
    uint256 public walletlimit = 10000000000000000000; // 10B

    uint256 public _maxTxAmount = 5000000000000000000; // Max Transaction Amount 5B
    uint256 private minimumTokensBeforeSwap = 203000000000000000; // 203M

    address payable public marketingAddress = 0xeEC3a8B8307E75244Ea8723D63984F008F898a3e; // Charity Address
