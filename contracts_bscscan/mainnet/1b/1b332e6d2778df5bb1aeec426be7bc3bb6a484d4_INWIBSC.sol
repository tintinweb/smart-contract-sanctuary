...
contract INWIBSC is INWIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private INWITeam;
    address private CharityINWI;
    ...
    string public override name = "inwi";
    string public override symbol = "INWI";
    ...
    constructor(uint totalSupplyValue, address INWITeamAddress, address CharityINWIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        INWITeam = INWITeamAddress;
        CharityINWI = CharityINWIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[INWITeam] =  totalSupply * 4 / 100;
        balances[CharityINWI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's INWITeam pot
