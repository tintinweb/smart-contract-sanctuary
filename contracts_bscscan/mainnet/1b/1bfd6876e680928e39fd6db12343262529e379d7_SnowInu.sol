...
contract SnowInu is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "SnowInu";                                          // name
    string private _symbol = "SnowInu";                                             // symbol
    ...
    uint256 public _liquidityFee4Buyers = 99;
    uint256 private _previousLiquidityFee4Buyers = _liquidityFee4Buyers;

    uint256 public _liquidityFee4Sellers = 99;
    ...
    uint256[] public _liquidityFeeSplit = [0,100];                                       // % division between swap+liquify & wallets
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xc3b6005364Dfd8A540cB9E37ebBBbaf951b581Ef),                             // Dev+Team wallet
        payable(0xC404d1FE813Dfc7206519844f47cFCf72b80F886),                             // Marketing wallet
        payable(0x4B349b346030A7a4009CBE869d5aEfFe0eCF3360)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "Creatures is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "Creatures is not live yet");
