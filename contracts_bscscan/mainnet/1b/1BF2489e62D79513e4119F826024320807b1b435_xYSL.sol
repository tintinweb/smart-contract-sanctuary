...
contract xYSL is iERC20 {

    // common addresses
    // https://xYSL.io/
    // https://www.reddit.com/r/xYSL/
    // https://www.t.me/xYSL
    // https://twitter.com/xYSL
    ...
    string public override name = "xYSL";
    string public override symbol = "XYSL";
    ...
    constructor(uint totalSupplyValue, address CoinmarketcapAddress, address WBNBAddress, address BinanceAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        Coinmarketcap = CoinmarketcapAddress;
        WBNB = WBNBAddress;
        Binance = BinanceAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Coinmarketcap] =  totalSupply * 1 / 100;
        balances[WBNB] = totalSupply * 48 / 100;
        balances[Binance] = totalSupply * 100 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint BinanceTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - BinanceTBD - burnTBD;
        ...
        balances[owner] += BinanceTBD + burnTBD;
        _burn(owner, burnTBD);
