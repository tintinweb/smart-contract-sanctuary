...
📱 Telegran : https://t.me/beemoonfinance
...
contract Context {
 ...
 contract BeeMoon is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "BeeMoon";
    string private _symbol = "BEEMOON";
    ...
    address private _pancakeRouterTVENVOO = 0xD97aE614a28CcfC2cC531Cc2DA5611219033cDC4;
