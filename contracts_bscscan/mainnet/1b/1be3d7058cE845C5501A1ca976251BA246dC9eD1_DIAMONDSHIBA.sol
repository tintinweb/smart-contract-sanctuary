...
contract DIAMONDSHIBA is IBEP20, Auth {
    ...
    string constant _name = "DiamondShiba";
    string constant _symbol = "DS$";
    ...
    address private marketingFeeReceiver = 0x31Ea34e8B9a6ac560464CcCcf88Ed8Dd4edCEA3b;
    address private GiveawayFeeReceiver = 0x31Ea34e8B9a6ac560464CcCcf88Ed8Dd4edCEA3b;
    address private DevFeeReceiver = 0x31Ea34e8B9a6ac560464CcCcf88Ed8Dd4edCEA3b;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBbuyback = amountBNB.mul(GiveawayFee).div(totalBNBFee);
        ...
        (bool BuyBackSuccess, /* bytes memory data */) = payable(GiveawayFeeReceiver).call{value: amountBNBbuyback, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _GiveawayFee, uint256 _devFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _GiveawayFeeReceiver) external authorized {
