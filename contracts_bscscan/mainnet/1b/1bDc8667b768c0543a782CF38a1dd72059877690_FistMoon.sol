...
contract FistMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FistMoon";
    string private _symbol = "FTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe69D1E8481FBB0e36E2Aca8420285dbfe9A987e7); // Marketing Address
    address payable public teamWalletAddress = payable(0x0c6ED1bEF9970C0E9A2a6ff3654aEe858b21a7Ac); // Team Address
