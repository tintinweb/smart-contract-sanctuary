...
Telegram : https://t.me/ProAdviceBSC
...
contract Context {
 ...
 contract ProAdvice is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private komunalen;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "ProAdvice";
    string private _symbol = "PRO-ADVICE";
    ...
    address private _dasesprem = 0x6d7BDaaE1bc49c6C14E451A22FD80B5e254f959a;
