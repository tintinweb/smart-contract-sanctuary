...
contract MoonNotLocked is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xc40134d13DcCd97caaF3DCB5334FEb044646AFeF;

    string private constant _name = "MoonNotLocked";
    string private constant _symbol = "MNL";
    ...
    Taxes public taxes = Taxes(0,6,3,0);
