...
contract SolanaPlus is Context, IERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x68F0548454000311a39F30590D26F012211020c5); // Marketing Address
    ...
    string private _name = "Solana Plus";
    string private _symbol = "SOLANAPLUS";
