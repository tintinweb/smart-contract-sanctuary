...
// simply hold $GIGABIER and you'll receive DOGE automatically in your wallet.
// 
// Hold GIGABIER and get rewarded in DOGE on every transaction!
//
...
contract GigaBier is ERC20, Ownable {
    ...
    GigaBierDividendTracker public dividendTracker;
    ...
    address payable public marketingWalletAddress = 0x2E4F6Bc9cC33b68988551Fe2a9E7F4A813b7441a;
    ...
    constructor() public ERC20("GigaBier", "GIGABIER") {

    	dividendTracker = new GigaBierDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "GigaBier: The dividend tracker already has that address");

        GigaBierDividendTracker newDividendTracker = GigaBierDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "GigaBier: The new dividend tracker must be owned by the GigaBier token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "GigaBier: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GigaBier: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "GigaBier: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "GigaBier: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 600000, "GigaBier: gasForProcessing must be between 200,000 and 600,000");
        require(newValue != gasForProcessing, "GigaBier: Cannot update gasForProcessing to same value");
...
contract GigaBierDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("GigaBier_Dividen_Tracker", "GigaBier_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "GigaBier_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "GigaBier_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GigaBier contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "GigaBier_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "GigaBier_Dividend_Tracker: Cannot update claimWait to same value");
