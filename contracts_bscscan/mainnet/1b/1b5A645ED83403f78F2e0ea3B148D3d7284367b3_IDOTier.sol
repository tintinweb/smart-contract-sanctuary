...
contract IDOTier is Ownable, IIDOTier {
    ...
    constructor() {
        tiers.push(Tier({ tierId: 1, minPoint: 250 ether, multiplier: 1 })); // bronze
        tiers.push(Tier({ tierId: 2, minPoint: 500 ether, multiplier: 2 })); // silver
        tiers.push(Tier({ tierId: 3, minPoint: 1000 ether, multiplier: 3 })); // gold
    }
