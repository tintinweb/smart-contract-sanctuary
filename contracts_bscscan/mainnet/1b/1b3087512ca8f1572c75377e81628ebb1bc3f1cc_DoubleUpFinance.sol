...
contract DoubleUpFinance is Context, IERC20, Ownable {
    ...
    string private _name = "Double Up Finance";
    string private _symbol = "DUF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE7083c29Cc12fAb111591Efd14E30e8e8D42a121); // Marketing Address
    address payable private buyBackWalletAddress = payable(0xE7083c29Cc12fAb111591Efd14E30e8e8D42a121); // buyback Address
    ...
    uint256 public _walletMax = 300000000000000 * 10**9; // 30%
    uint256 private minimumTokensBeforeSwap = 2198006500000 * 10**9; 
