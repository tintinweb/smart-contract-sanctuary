...
Telegram = https://t.me/DiamondGirlbsc
...
// CHANGE
contract DiamondGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DiamonGirl";
    string constant _symbol = "DiamondGirl";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100; // 2% MAX 40,000,000
    ...
    uint256 buybackFee = 400;   // 4% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 400; // 4%
    uint256 totalFee = 1200; // liquidityFee + Buyback + devFee
    ...
    uint256 public swapThreshold = _totalSupply / 3000; // 0.2%
    bool inSwap;
