...
contract BUSDDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor(address _dividentToken) DividendPayingToken("Boda_Busd_Dividend_Tracker", "Boda_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 3000000000 * (10**18); //must hold 3000,000,000+ tokens
    }
...
contract BodaV2 is ERC20, Ownable {
    ...
    constructor() ERC20("BODA", "BODAV2") {
    	...
    	marketingWallet = 0x4ee203B290FfC22293CE56Cd303bAE85C4869828; 
    ...
    function airdrop(address recipient, uint256 amount) public onlyOwner returns (bool) {
        amount = amount * (10**18);
        _transfer(_msgSender(), recipient, amount);
        return true;
    }
