...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 private _burnFee = 5; // 0% burn

    uint256 private _marketingFee = 3; // 5% marketing
    uint256 private _developmentFee = 2; // 3% developer
    ...
    address payable private _marketingWalletAddress = payable(0x43abD1340927cCb2eE01b92c3543D708bbd030b2);
    address payable private _developmentWalletAddress = payable(0x0a3c3032Ee48073036a72fe372Ac845cd085EEcd);
