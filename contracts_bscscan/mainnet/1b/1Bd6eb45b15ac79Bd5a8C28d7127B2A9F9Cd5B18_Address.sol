...
contract SonOfOlympus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SonOfOlympus";
    string private _symbol = "SOO";
    ...
    uint256 internal _tokenTotal = 10000000000 *10**18; // 10 Billion totalSupply
    ...
    uint256 public _taxFee = 500; // 50 = 0.5%
    uint256 public _buybackv1Fee = 100; // 100 = 1.00%
    uint256 public _buybackv2Fee = 100; // 100 = 1.00%
    uint256 public _burningFee = 100; // 200 = 2.0%
    uint256 public _smarketingFee = 200; // 50 = 0.5%
    
    uint256 public _maxTxAmount = 50000000 * 10**18; // 20 Million inicial máx transfer
    ...
    address public buybackv1Address  = 0xb1E9015dEDFE09607E753A95A027337e8bC7D636;      // BuyBackv1 Address
    address public buybackv2Address  = 0xb1E9015dEDFE09607E753A95A027337e8bC7D636;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0xb1E9015dEDFE09607E753A95A027337e8bC7D636;      // SMarketing Address
