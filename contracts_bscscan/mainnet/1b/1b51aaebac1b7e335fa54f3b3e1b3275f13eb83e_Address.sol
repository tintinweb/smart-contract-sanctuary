...
contract bunny_character is ERC721Enumerable, Ownable{
    ...
    constructor(address _beneficiary) ERC721("PotatoPunks", "PotatoPunks") {
        _baseTokenURI = "https://potato.codes/api/";
    ...
    function getPrice(uint256 _id) public pure returns (uint256) {  //price 1 NFC  
        if (_id > 7) {
            return 0.000004e18;
        }else if (_id > 5) {
            return 0.000003e18;
    ...
    function mint_character() public payable returns (uint256){
        require(totalSupply() <= 10, "enough minting");  //celkový počet
