 ...
 *                NEXT 100X GEM!
 * 
 * Dividend Token that reward $CAKE every 30 minutes!
 *      Fees on Buy: 16% / Fees on Sell: 20%
 *                          
 * 
 *          https://t.me/LemonCakesBSC
 * 
 * 
*/
...
contract LemonCakes is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Lemon Cakes";
    string constant _symbol = "LMCS";
