...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 O3 = IERC20(0xEe9801669C6138E84bD50dEB500827b776777d28);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = O3.balanceOf(address(this));
        ...
        uint256 amount = O3.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            O3.transfer(shareholder, amount);
...
contract BabyO3 is IERC20, Ownable {
    using SafeMath for uint256;

    address O3 = 0xEe9801669C6138E84bD50dEB500827b776777d28;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyO3";
    string constant _symbol = "BabyO3";
