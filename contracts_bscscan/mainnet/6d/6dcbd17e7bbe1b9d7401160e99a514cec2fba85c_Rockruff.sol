...
/**
    Rockruff Inu, The Liquidity Pool will be locked right at launch and extended a certain mcap, so you don't have to worry about getting Scam
	
	It will be a stealth project to avoid sniper and bot buying.

    Telegram: https://t.me/RockruffToken
...
library Address{
 ...
 contract Rockruff is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 750_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xa165D1C0746A20e1ddFd5431C7E78Ba560c9D418;
    address public teamWallet = 0xbc0cb731EF3A22AcD370E1E14Ad9E3e5b5EFEaF1;

    string private constant _name = "Rockruff Inu";
    string private constant _symbol = "Rockruff";
    ...
    Taxes public taxes = Taxes(1, 6, 2, 2);
    Taxes public sellTaxes = Taxes(1, 6, 2, 2);
