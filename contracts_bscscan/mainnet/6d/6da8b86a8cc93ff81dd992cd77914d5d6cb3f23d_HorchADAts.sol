...
contract HorchADAts is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HorchADA";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "HorchADA";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x04e6487BcC10AD5BEf9C394FBB512F06C285c0A1;
        marketingFeeReceiver = 0x7e70F4b3D5dc5C1f62cF919Ff79E4470C9B5908E;
