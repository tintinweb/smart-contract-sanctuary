...
contract DividendDistributor is IDividendDistributor {
    ...
    //IBEP20 public RewardToken = IBEP20(0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d); //USDC
    //IBEP20 public RewardToken = IBEP20(0xe9e7cea3dedca5984780bafc599bd69add087d56); //BUSD
...
contract METATESTER is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "METATESTER";
    string constant _symbol = "METATEST";
    ...
    //address RewardToken = 0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d; //USDC
    address marketingWallet = 0xb8dDd80Eb0a85745d5399Ba0F9a883eC0f3a4D00; 
    ...
    address wm = 0xb8dDd80Eb0a85745d5399Ba0F9a883eC0f3a4D00; 
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newExtraSellFee, uint256 newBurnFee, uint256 newMarketingFee) external authorized {
        ...
        totalFee = liquidityFee.add(rewardsFee);
        totalFee = liquidityFee.add(burnFee);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 rewardFee = feeApplicable - burnFee - marketingFee;
