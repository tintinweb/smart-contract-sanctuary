...
contract PIMP is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 400000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Gorilla Pimp";
    ...
    address payable private _marketingWalletAddress = payable(0xA8091B21eFAADdD01D91a6A4544135F1a8347d79);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 400000000000000 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensToSwapToBNB = half.add(toMarketing);
        ...
        uint256 bnbToLiquify = bnbSwapped.mul(half).div(tokensToSwapToBNB);

        // Add liquidity to pancake swap
        addLiquidity(otherHalf, bnbToLiquify);

        emit SwapAndLiquify(half, bnbToLiquify, otherHalf);
        ...
        _marketingWalletAddress.transfer(marketingBNBToDonate);
    }
