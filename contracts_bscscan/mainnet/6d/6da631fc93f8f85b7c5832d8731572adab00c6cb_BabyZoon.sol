...
import "./BabyZoon-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyZoon` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyZoon(Env.Testnet)` or `BabyZoon(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyZoon";
    string internal constant SYMBOL = "BZoon";
     ...
     */
    address internal tipToTheDev =0xC7A4daE181Cf4714d804F04da14481c3E98a0939;
...
contract BabyZoon is SafeToken{
