...
contract FlixSwap is IBEP20, Context, Swap {
  
    // common addresses
    address private _owner;
    address private ShibaTeam;
    address private FlixGame;
    ...
    string public override name = "Flix Swap";
    string public override symbol = "Swap Flix";
    ...
    constructor(uint totalSupplyValue, address ShibaTeamAddress, address FlixGameAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        ShibaTeam = ShibaTeamAddress;
        FlixGame = FlixGameAddress;
        
        // split the tokens according to agreed upon percentages
        balances[ShibaTeam] =  totalSupply * 5 / 100;
        balances[FlixGame] = totalSupply * 5 / 100;
    ...
    // Get the address of the token's ShibaTeam pot
