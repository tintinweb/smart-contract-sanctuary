...
//Telegram will be created after launch
//cms will be posted after launch
//NO FAIRLAUNCH
//NO STEALTH LAUNCH
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 VXS = IBEP20(0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = VXS.balanceOf(address(this));
        ...
        uint256 amount = VXS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            VXS.transfer(shareholder, amount);
...
contract BabyVenus is IBEP20, Auth {
    using SafeMath for uint256;

    address VXS = 0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyVenus";
    string constant _symbol = "$BVENUS";
    ...
    uint256 public swapThreshold = _totalSupply / 500000; // 5%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6CC38bE2F748737ab658381BadaCEc5165126cb3;
