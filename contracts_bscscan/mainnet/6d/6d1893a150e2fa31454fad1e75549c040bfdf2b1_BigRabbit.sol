...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24e620bF6236a2Ff5d90169A3c0a84c92DCa8064;
...
contract BigRabbit is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0eC19B211CF1289F3615b8B2A6320161374d92C9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BIG RABBIT";
    string private _symbol = "BGRBT";
    ...
    uint256 private numTokensSellToAddToLiquidity = 40000000000000000000000 * 10**18;
