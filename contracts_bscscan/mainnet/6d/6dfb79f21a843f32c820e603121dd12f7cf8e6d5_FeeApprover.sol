...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        tokenBakerySwapPair = IBakerySwapFactory(address(0x01bF7C66c6BD861915CdaaE475042d3c4BaE16A7)).getPair(WBNBAddress,tcoreTokenAddress);
        ...
        )
    {
        ...
        if(sender == tcoreVaultAddress || sender == tokenBakerySwapPair ) {
