...
/**
 *Launched by Crypto Advice (t.me/Crypto_Advices)
 */
/**
 *Official Telegram of Cinutopia : t.me/Cinutopiabsc
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71);
...
contract Cinutopia is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0xdFE6891ce8E5a5c7Cf54fFdE406A6C2C54145F71;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cinutopia";
    string constant _symbol = "CTOPIA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000000;
    uint256 public _maxTxAmount = _totalSupply * 2 / 1000; // 200 000 tokens per tx to launch 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x893883Ed694ce95940a2e573A222943d0d835492;
