...
/**
   ...
   4% fee auto moved to Marketing fee
...
contract ToySHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "ToySHIBA";
    string private _symbol = "ToySHIBA";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
    	...
    	function setWallets(address payable charity, address payable marketing) public onlyOwner() {
