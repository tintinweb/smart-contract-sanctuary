...
contract Ownable is Context {
    address private _owner = 0x49ED972961aA704ce26981BD45F7c7bffE79ac9A;
...
contract FetionToken is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xb4C1aDd47F941208c4A82C2DD17C0467814d4cf2); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Fetion Token"; // token name
    string private _symbol = "Fetion"; // token symbol
    ...
    uint256 public _liquidityFee = 40; // liquidity fee 5%
    ...
    uint256 public _minTokensSwapToAndTransferTo = 5 * 10**4 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
