...
/**
 * 
 LAMBOTTERY is more than just a Binance Smart Chain lottery token awarding our holders, we are a revolution. Countless scams and cons have caused many of our investors to lose money, and we have created a safe haven for all investors to not only invest safely but also have a strong chance of winning our hourly / daily and weekly draws. All you have to do is HODL and your chances increases with every passing moment. 
*/
...
contract LAMBOTTERY is Context, IERC20, Ownable {
