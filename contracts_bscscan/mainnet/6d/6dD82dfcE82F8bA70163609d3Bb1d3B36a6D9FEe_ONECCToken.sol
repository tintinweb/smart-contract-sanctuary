...
contract ONECCToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 1000000000000000000000000000000* 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'Mini fox rabbit';
    string private _symbol = 'Mini fox rabbit';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = 0x4C4B0553207C356B940c3b2060BE884F4E9FaA41;
