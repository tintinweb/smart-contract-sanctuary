...
/**
   ...
   #PIG+#SAFEMOON+#SHIBA+#DOGE+#EVERRİSE, combine together to #SHIBAPOOP

    I make this #SHIBAPOOP to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/SHIBAPOOP_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #SHIBAPOOP to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49.5% total supply to the pool
   Can you make #SHIBAPOOP 10000000X? 
   ...
   it's the best part of the #SHIBAPOOP idea, increasing the liquidity pool automatically, 
...
contract SHIBAPOOP is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "SHIBAPOOP";
  string private _name = "SHIBAPOOP";
