...
contract BABYSHIBTRILLIONAIRE is IBEP20, BSTAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABY SHIB TRILLIONAIRE";
    string constant _symbol = "BST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10 ** 15 * (10 ** _decimals); // 1 Quadrillion
    uint256 public _maxTxAmount = _totalSupply / 1000; // 0.1%

    // @dev  added max hold so that no single wallet can hold more than 1%.
    uint256 public _maxHold = _totalSupply / 100; // 1 %
    ...
    address public marketingFeeReceiver = 0x84CA6b99e2c0af7f5B5c6cb2b57c1aDA8E185f05;
    address public buybackFeeReceiver = 0x99B5bafF586FcECe57d32DdFC4461FcBF6C9FAC5;
    ...
    constructor () BSTAuth(msg.sender) {
