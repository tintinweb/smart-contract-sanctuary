...
contract BinaryMystery is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BinaryMystery";    
    string constant _symbol = "BINA";
    ...
    uint256 public totalFee = liquidityFee.add(marketingFee).add(reflectionFee);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xf0c5502de3897bd86A1Ab3608415b296EA6bFe15; 
        marketingFeeReceiver = 0xf0c5502de3897bd86A1Ab3608415b296EA6bFe15; 
    ...
    function swapBack() internal swapping {
        ...
        sendToWallet(payable(marketingFeeReceiver), amountBNBMarketing);
    ...
    function sendToWallet(address payable recipient, uint256 amount) private {
