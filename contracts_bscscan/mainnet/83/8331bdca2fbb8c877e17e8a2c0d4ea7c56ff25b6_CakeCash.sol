...
/**
  ...
  Welcome to CakeCash token!
  
  Telegram--> https://t.me/cakecashbsc
  ...
  Telegram--> https://t.me/cakecashbsc
   ...
   I will add 0.5 BNB and all the left 80% total supply to the pool
   Can you make #CakeCash 100X? 
...
contract CakeCash is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "CakeCash";
  string constant tokenSymbol = "CakeCash";
