...
Corgi Pug is built upon the fundamentals of Buyback and increasing the investor's value
...
contract CORGIPUG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x16629A82BA78cF4e82192D59bf9dE3aFBeF13DeC); // Marketing Address
    ...
    string private _name = "Corgi Pug";
    string private _symbol = "CORGIPUG";
