...
// Website: http://flokionspacex.com/
// Twitter: https://twitter.com/FlokiSpacex
...
contract FlokiOnSpaceX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki on SpaceX";
    string constant _symbol = "FOX";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1000 * 10**10 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x767b33989919d6c3e9Fd33e878ae1484b7717fC9;
        teamFeeReceiver = 0x23187C74277c10E4219957fA6F8f989147563B70;
        charityFeeReceiver = 0xd726deD16464f02fB3C9EFF05Fa656a8Fb3A6769;
