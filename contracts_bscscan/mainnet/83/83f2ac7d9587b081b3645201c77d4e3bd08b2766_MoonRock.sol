...
Tokenomics:
• Total Supply: 1,000,000,000,000,000 MROCK
• Pancakeswap Liquidity : 250,000,000,000,000 MROCK
• Presale : 250,000,000,000,000 MROCK
• Burned: 500,000,000,000,000 MROCK
• Liquidity Locked

Taxes:
MoonRock features a 10% buy and sell tax.
...
MoonRock is the first ever cryptocurrency to feature an automatic price impact trigger that routinely repurchases
tokens to prevent mass sell-offs that cause large price drops. Serving as a hyper-deflationary token on the Binance
Smart Chain, MoonRock rewards investors for holding tokens while leveraging its proprietary buy-back system.
