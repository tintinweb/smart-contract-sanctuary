...
contract ElonPixels is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonPixels"; // 
    string private constant _symbol = "ELP"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public _marketingWallet = 0xB1d6DF5466A63dB09408A0CEEFAA1CA31F2EFA7c;
