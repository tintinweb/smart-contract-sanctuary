...
/**
	DigiArtTrade Coin (DAT) 
	Tokenomics: 
	2% fee auto add to the Liquidity Pool 
	1% distribute to the Charity Wallet 
	2% of transaction fee will go to Holders
	Total Supply: 42,000,000,000 (42 Million)
	----------
    PIX-O-BITS is the international union of artists that collaborating to create the most unique and rare NFT-Collections on the planet.
    DigiArtTrade Coin on BEP-20 is the official currency of PIX-O-BITS community — DAT, it has many use-cases and some of them are: 
    Minting NFT’s
    Trading on DEX
    LP Staking & Farming
    Artists payouts & rewards
    Community airdrops & activity rewards
    Money for all our play2earn games projects (soon in 2022)
    ---------
	Telegram: https://t.me/pixobits
	Website: https://pixobits.net
*/
...
contract Datcoin is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xdE8F845053771Fa626de7367857FcC9711f14Fe1;
    ...
    string private _name = "DigiArtTrade Coin";
