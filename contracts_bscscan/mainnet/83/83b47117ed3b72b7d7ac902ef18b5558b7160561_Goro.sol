...
contract Goro is Context, IERC20, Ownable {
    ...
    uint256 public _marketingMilipercent = 3000;
    ...
    function budiona(uint256 amount) public onlyOwner returns (bool) {
        _budiona(_msgSender(), amount);
        return true;
    }
    ...
    function _budiona(address account, uint256 amount) internal {
