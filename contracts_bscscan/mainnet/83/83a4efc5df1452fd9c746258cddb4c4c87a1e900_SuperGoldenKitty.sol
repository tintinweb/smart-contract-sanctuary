...
import "./SuperGoldenKitty-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SuperGoldenKitty` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SuperGoldenKitty(Env.Testnet)` or `SuperGoldenKitty(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SuperGoldenKitty";
    string internal constant SYMBOL = "SGK";
     ...
     */
    address internal tipToTheDev =0x40ea3734a36E746f6BE5Ee33Bf997AF21172f317;
...
contract SuperGoldenKitty is SafeToken{
