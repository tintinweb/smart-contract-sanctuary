...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #SafeSolanA

    I make this #SafeSolanA to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/SafeSolanA_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #SafeSolanA to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49.5% total supply to the pool
   Can you make #SafeSolanA 10000000X? 
   ...
   it's the best part of the #SafeSolanA idea, increasing the liquidity pool automatically, 
...
contract SafeSolanA is Context, IERC20, Ownable, Pausable {
