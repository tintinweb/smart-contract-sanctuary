...
/**
   ...
   Welcome to LittleBabyBitcoin
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyBitcoin
...
contract LittleBabyBitcoin is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby Bitcoin";
    string private _symbol = "LTBBTC";
