...
contract Waiv is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'WAIV';
    string  private constant _SYMBOL = 'WAIV';
    ...
    uint256 private     _TAX_FEE = 20; // 0.2% BACK TO HOLDERS
    uint256 private    _BURN_FEE = 0; // 0% BURNED
    uint256 private _CHARITY_FEE = 60; // 0.6% TO CHARITY WALLET
