...
contract BABC is IERC721, ITRC165, IERC721Metadata, IERC721Enumerable {
    using EnumerableSet for EnumerableSet.UintSet;

    string internal _name = "Bored Apes Binance Club";
    string internal _symbol = "BABC";

    uint256 internal totalMinted = 0;

    uint256 public constant MINTING_LIMIT = 10000;

    uint256 public mintingPrice = 2e17;
    ...
    string public uri = 'https://www.boredapebinanceclub.com/api/v1/apes/ape/';
