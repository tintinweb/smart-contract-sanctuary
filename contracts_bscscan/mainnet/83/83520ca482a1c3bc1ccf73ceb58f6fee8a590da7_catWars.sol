...
contract catWars is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xcc35651034741Be525dB60AA11562Ff6E0D09C71); // Marketing Address
    ...
    string private _name = "Cat Wars";
    string private _symbol = "CWARS";
