...
//
// FLOKISHIBADOGE
// $FSD has 7% tax split across 7 protocols
...
contract FLOKISHIBADOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "FlokiShibaDoge";
    string private _symbol   = "FSD";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for FSD/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x45F02606f981873c6c73004E57Cb5981BE50cC51); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $FSD will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-FSD tokens that are stuck as to not interfere with the liquidity
     */
    ...
    /**
     * @notice Burns FSD tokens straight to the burn address
     */
