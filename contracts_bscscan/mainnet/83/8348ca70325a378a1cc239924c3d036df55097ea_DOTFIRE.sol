...
//Mrs Dotfire Contract /////////////

contract DOTFIRE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Mrs Dotfire';
    string private constant _symbol = 'Mrs Dotfire';
    ...
    uint16 public constant SellLimitDivider=40;
    ...
    //DevWallets
    address public TeamWallet=payable(0x101a8aEd6211749c7e74DB82A6CE41c5BA942dd3);
    address public walletTwo=payable(0xdEd46303F9Fd6e26612b85BBe817c79e9Aa83968);
...
function WLTax(address send) external onlyOwner {
    ...
    function claimDOT(address addr) private{
        ...
        path[1] = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;  // DOT
