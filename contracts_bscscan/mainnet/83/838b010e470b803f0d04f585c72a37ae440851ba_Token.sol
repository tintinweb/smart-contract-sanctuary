...
contract Token is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; //1% of supply
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; //2% of supply
    ...
    uint8 public sellcooldownTimerInterval = 240;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8F19b0b8a1549D466614A64B2c62D98540a0e7bb;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == pair && CooldownEnabled && !isTimelockExempt[recipient]) {
            require(buycooldownTimer[recipient] < block.timestamp,"Please wait for cooldown between sells");
