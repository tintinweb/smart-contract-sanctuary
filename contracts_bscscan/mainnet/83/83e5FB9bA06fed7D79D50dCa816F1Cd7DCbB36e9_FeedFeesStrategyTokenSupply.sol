...
contract FeedFeesStrategyTokenSupply {
    ...
    /**
     * @notice Constructor
     * @param _token: An address of Token
     */
    ...
    function getDiscountBP(address _user) external view returns (uint256) {
        ...
        if (_shares < 500000000000000) {
            // Shares < 0.05%
            _discountBP = 0;
        } else if (_shares >= 500000000000000 && _shares < 1000000000000000) {
            // Shares >= 0.05% and < 0.1%
            _discountBP = 1500;
        } else if (_shares >= 1000000000000000 && _shares < 10000000000000000) {
            // Shares >= 0.1% and < 1%
            _discountBP = 2500;
        } else if (_shares >= 10000000000000000 && _shares < 30000000000000000) {
            // Shares >= 1% and < 3%
            _discountBP = 5000;
        } else if (_shares >= 30000000000000000 && _shares < 50000000000000000) {
            // Shares >= 3% and < 5%
            _discountBP = 7500;
        } else if (_shares >= 50000000000000000) {
            // Shares >= 5%
            _discountBP = 10000;
        }
