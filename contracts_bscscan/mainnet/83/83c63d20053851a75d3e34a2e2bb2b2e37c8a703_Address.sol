...
contract Cuccu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0xBdD443E2c7CFE38334bce3460781F05bEDEe97e5); 
    ...
    uint256 private _tTotal = 6900000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cuccu";
    string private _symbol = "Cuccu";
