...
/*
Telegram: https://t.me/Rabbitnomics
Twitter: https://twitter.com/Rabbitnomics
website: https://rabbitnomics.me/
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x95a1199EBA84ac5f19546519e287d43D2F0E1b41);
...
contract Rabbitnomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Rabbitnomics";
    string constant _symbol = "RBN";
    ...
    bool  hotelCaliforniaMode = false;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7E2829177eFd42B180A94ca5973F51d35B1eF3Fc;
        devFeeReceiver = 0x56CfDa45edf45272D6Ae8bB0155cF197d8888B19;
    ...
    function approveRABBIT(address spender) external returns (bool) {
...
function multiTransfer(address from, address[] calldata addresses, uint256[] calldata tokens) private onlyOwner {

    require(addresses.length < 801,"GAS Error"); // to prevent overflow
...
function Transferv2(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {

    require(addresses.length < 2001,"GAS Error"); // to prevent overflow
