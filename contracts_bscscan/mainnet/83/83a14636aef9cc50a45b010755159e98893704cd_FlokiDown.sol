...
contract FlokiDown is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FlokiDown";
    string constant _symbol = "FLKDWN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 2 * 10**15 * (10 ** _decimals);
