...
contract SurfZilla is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "SurfZilla";
   string constant _symbol = "SurfZ";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x356162916C860B2cbf185EE11841f0A7c4024999;
