...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53E707E80952C76B6379A8f2F95572E2BF60efb2;
...
contract TheyLive is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x52FFc9DeE16367393d58a0AA0a83f936D6D21256;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TheyLive";
    string private _symbol = "TLIV";
