...
contract CommunityWalletLock is owned{
    ...
    */
     ...
     *lock tokens
    */
    function DevWalletLock(address _tokenAddress, uint256 _amount, uint256 _unlockTime) public returns (uint256 _id) {
        require(_amount > 0, 'token amount is Zero');
        require(_unlockTime < 1634239105, 'Enter an unix timestamp in seconds, not miliseconds');
