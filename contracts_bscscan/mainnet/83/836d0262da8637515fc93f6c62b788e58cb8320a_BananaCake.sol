...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function distributeDividends(uint256 amount) public {
        require(msg.sender == 0x7243Ab661dD995eB1d078e83a78b0c0B00B9E4Dc, "Only owner"); // todo: replace address with BananaCake address
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Cake_Dividend_Tracker", "Cake_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) { // todo: replace with Cake token address
        claimWait = 3600;
...
contract BananaDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("Banana_Dividend_Tracker", "Banana_Dividend_Tracker", 0x603c7f932ED1fc6575303D8Fb018fDCBb0f39a95) { // todo: replace with Banana token address
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
...
contract BananaCake is ERC20, Ownable {
    ...
    constructor() ERC20("BananaCakeTest", "BANACAKE01") {
