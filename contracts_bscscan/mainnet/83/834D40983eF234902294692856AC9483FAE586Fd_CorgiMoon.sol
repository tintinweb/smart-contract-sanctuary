...
contract CorgiMoon is Context, IERC20, Ownable {
    ...
    string private _name = "CorgiMoon";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10**8 * 10**9;
