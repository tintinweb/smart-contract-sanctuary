...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract EarnCake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xdE4219406c61dF41cC88AA165AecaA6c8e02934E); // Marketing Address
    address payable public CharityWalletAddress = payable(0xdE4219406c61dF41cC88AA165AecaA6c8e02934E); // Cake Address
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(forWallets > 0 && _marketingFee.add(_CakeFee) > 0)
        {
            ...
            if(CakeWalletShare > 0)
                transferToAddressETH(CharityWalletAddress, CakeWalletShare);
        }
