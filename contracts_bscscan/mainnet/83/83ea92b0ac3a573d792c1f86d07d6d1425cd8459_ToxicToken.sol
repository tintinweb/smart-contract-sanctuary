...
/**
 * 
🔥ToxicToken | Secure & Advance Cryptocurrency Wallet Crafted for Simplicity.

🚀ToxicToken Wallet

ToxicToken is a decentralised Binance Smartchain & Ethereum based Web3 Mobile Wallet. The app works with several crypto tokens and blockchain wallets. It enables users to store, send and receive Smart Chain & Ethereum based tokens on the go.
...
ToxicToken offers a seamless user experience. As we believe that ease of use is vital in the adoption of cryptocurrencies, the highly intuitive and user-friendly mobile application for accessing the blockchain.

✅ ToxicToken & Usecase

TokenToxic will be the preferred token in our ecosystem. As the preferred token we plan to use the TokenToxic Token for staking, governance, paying transaction fees and gaining eligibility in TokenToxic launch pool. Let’s understand them in details. 
...
contract ToxicToken is Context, IERC20, Ownable {
