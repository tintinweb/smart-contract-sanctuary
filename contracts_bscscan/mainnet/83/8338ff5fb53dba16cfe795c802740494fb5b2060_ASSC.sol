...
contract ASSC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x727f357D3f239365AC07a5e23a4f6E10197b1CbE);
    address payable public devAddress = payable(0xAb8d2d8ae33e761eAFD14770a49E3c207BE2BEa1);
    ...
    string private _name = "ASSASSIN'S CREED TOKEN";
    string private _symbol = "ASSC";
