...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 DogeZilla = IERC20(0x7A565284572d03EC50c35396F7d6001252eb43B6);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DogeZilla.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(DogeZilla);
        ...
        uint256 amount = DogeZilla.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DogeZilla.transfer(shareholder, amount);
...
// CHANGE
contract WAGMI is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address DogeZilla = 0x7A565284572d03EC50c35396F7d6001252eb43B6;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "We Are Going to Make It";
    string constant _symbol = "WAGMI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 25) / 1000; // 2.5% MAX 25,000,000
    ...
    uint256 marketingFee = 500; // 5%
    uint256 totalFee = 1200; // liquidityFee + reflectionFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x4af74D91e02C1876e68f79A6960B6302fC4d498a);
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 1 >= block.number){ return feeDenominator.sub(10000); }
