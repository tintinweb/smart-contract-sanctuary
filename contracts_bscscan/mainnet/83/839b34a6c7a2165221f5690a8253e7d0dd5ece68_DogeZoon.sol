...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xE538d0579314B55d6556ab988EE97bCe885c25e5;
        _token = msg.sender;
    }
...
contract DogeZoon is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x8d7EebE465735a278EecEc9f18b30226c390c7F0;

    string constant _name = "DogeZoon";
    string constant _symbol = "DogeZoon";
    ...
    address IDEXPair = 0xE538d0579314B55d6556ab988EE97bCe885c25e5;
