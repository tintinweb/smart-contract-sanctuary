...
contract KittyFamily is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KittyFamily";
    string private _symbol = "KittyFamily";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2a9399bB3274ec05002Bb1C4fEBc26e140113816); // Marketing Address
    address payable public teamWalletAddress = payable(0x4e9b43757c6C31f1b14db42C57cC4da8EEad96c1); // Team Address
