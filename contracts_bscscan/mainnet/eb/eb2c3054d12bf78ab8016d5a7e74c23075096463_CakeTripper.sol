...
Be ready to post the shill message everywhere 🤑

🧁The Cake Tripper baked just for you with love🧁
🍰The $CTrip will be baked and launched on September 11th 16pm30 UTC🍰

A unique $CAKE REWARDS TOKEN !
🍽Hold $CTrip and earn $CAKE!🍽

⛔️ NO WHITELIST, NO PRIVATE SALE, NO PRESALE!⛔️ 

💎 Highest automatic $CAKE rewards 💎 

💰Tokenomics

* Total Supply 1,000,000,000 :
    - PancakeSwap Liquidity : 94% (locked with dxsale)
...
For more info, join us in our bakery !
...
contract CakeTripper is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("CakeTripper", "cTrip") {
