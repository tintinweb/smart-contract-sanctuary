...
/**
Brother Cheems Inu - Stealh launch 

Reflection and Buyback!
Work with us like a brother!
...
Telegram  : https://t.me/BrotherCheemsInu

✨We are brother and will rule all meme token here! Yeah we are that great!✨

WHY SHOULD BUY?
- BrotherCheemsInu will pay out 3% reflection off every transactions to its diamond handed holders.
- The development team is experienced
- A buyback wallet has been attributed to always easily eat those dips and have an healthy chart
- Great marketing plan (Calls after launch in twitter and telegram)
...
contract BrotherCheemsInu is Context, IERC20, Ownable {
    ...
    string private _name = "BrotherCheemsInu";
    string private _symbol = "BrotherCINU";
