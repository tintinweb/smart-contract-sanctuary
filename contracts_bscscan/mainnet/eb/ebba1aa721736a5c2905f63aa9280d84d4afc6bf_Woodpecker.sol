...
contract Woodpecker is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3313E889308d5F240eD7407fD6cAcEF9620fffe5); // Marketing Address
    address payable public charityAddress = payable(0x3313E889308d5F240eD7407fD6cAcEF9620fffe5); // Charity/Dev Address
    ...
    string private _name = "Woodpecker Token"; // nice
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 8000000000000000000; // nice Claim 8 (0.01 BNB = 80) 
