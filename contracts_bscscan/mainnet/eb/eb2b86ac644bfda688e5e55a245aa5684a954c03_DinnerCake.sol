...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also DinnerCakeed.
...
// File: contracts/DinnerCakeDividendPayingToken.sol
...
contract DinnerCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable Cake = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    address private _marketingWallet = address(0xE14757E0A943e7f4889fe06166CccF5EB11e01a3);
    address private _devWallet = address(0xE14757E0A943e7f4889fe06166CccF5EB11e01a3);
    ...
    DinnerCakeDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("DinnerCake", "DinnerCake") {
        ...
        dividendTracker = new DinnerCakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "DinnerCake: The dividend tracker already has that address");

        DinnerCakeDividendTracker newDividendTracker = DinnerCakeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "DinnerCake: The new dividend tracker must be owned by the DinnerCake token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DinnerCake: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DinnerCake: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DinnerCake: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "DinnerCake: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "DinnerCake: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "DinnerCake: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "DinnerCakeBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "DinnerCake: This account cannot send tokens until trading is enabled");
        }
...
contract DinnerCakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("DinnerCake_Dividend_Tracker", "DinnerCake_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "DinnerCake_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "DinnerCake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DinnerCake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "DinnerCake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "DinnerCake_Dividend_Tracker: Cannot update claimWait to same value");
