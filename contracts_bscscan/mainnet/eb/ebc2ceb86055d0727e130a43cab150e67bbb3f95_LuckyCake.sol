 ...
 * LUCKYCAKE 
 * =========================================
 * GET REFLECTION 10% FROM OTHERS EVERYTIME THERE ARE SELLERS
 * TELEGRAM GROUP : https://t.me/LuckyCakey
 * READ MORE ON TELEGRAM GROUP.
 * No Buying Tax
 * Sell tax will be between 6% or 60% depends on your luck!
...
contract LuckyCake is Context, IBEP20, Ownable {
    ...
    string private _name = "LuckyCake";
    string private _symbol = "LUCKYC";
    ...
    function luckyblock() public view returns (uint256) {
        return block.number;
    }
    function luckydecision() public view returns (bool) {
        if ( block.number % 2 == 0 ){
            return true;
        }else{
            return false;
    ...
    function _getAntiDumpMultiplier() private view returns (uint256) {
        ...
        if (time_since_start < 3 * hour) {
            ...
            if (block.number % 2 == 0){
                return (1); // YOU ARE LUCKY IF ITS NOT AN ODD NUMBER BLOCK!!
            }else{
                return (10); // YOU ARE FUCKED UP IF ITS AN ODD NUMBER BLOCK!!
            }
        } else {
           return (1); 
        } 
