...
contract WUSDMaster is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;
    
    IWUSD public wusd = IWUSD(0xc42825BdB7ded1DaF499D423161Edd2f2b3B6a78);
    IERC20 public usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IERC20 public wex = IERC20(0xa9c41A46a6B3531d28d5c32F6633dd2fF05dFB90);
    IWswapRouter public wswapRouter = IWswapRouter(0xD48745E39BbED146eEC15b79cBF964884F9877c2);
    address public treasury = 0x999e77396E78e0B842f2b4622E3Ef3164218b7a6;
    
    address[] swapPath = [address(usdt), address(wex)];
    
    uint public wexPermille = 100;
    uint public treasuryPermille = 10;
    
    bool isUsdtWithdrawInitiated = false;
    uint256 usdtWithdrawTimestamp;
    uint256 usdtWithdrawAmount;
    uint256 usdtWithdrawLockupPeriod = 5 minutes;
    ...
    function setWexPermille(uint _wexPermille) external onlyOwner {
        require(_wexPermille < 200, 'wexPermille too high!');
    ...
    function stake(uint256 amount) external nonReentrant {
        ...
        IWswapRouter(wswapRouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(
            wexAmount,
            0,
            swapPath,
            address(this),
    ...
    function initiateUsdtWithdraw(uint256 timestamp, uint256 amount) external onlyOwner{
    ...
    function withdrawWex(uint256 amount) external onlyOwner{
