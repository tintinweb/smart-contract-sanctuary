...
contract MoonKraken is IBEP20, Ownable {
  ...
  function pauseSell() public view returns (bool) {
    return _pauseSell;
  }

  function pauseBuy() public view returns (bool) {
    return _pauseBuy;
  }
  ...
  function enableBlacklist() public virtual onlyOwner {
    _blacklisting = true;
  }

  function disableBlacklist() public virtual onlyOwner {
    _blacklisting = false;
  }
  ...
  function enableWhitelist() public virtual onlyOwner {
    _whitelisting = true;
  }

  function disableWhitelist() public virtual onlyOwner {
    _whitelisting = false;
  }

  function addwWhitelist (address account) public virtual onlyOwner {
    _isWhitelisted[account] = true;
  }

  function removewWhitelist (address account) public virtual onlyOwner {
  ...
  function _beforeTokenTransfer(
    ...
    if (_pauseSell) require(to == address(this), "Coin Contract : Sell is paused.");
    if (_pauseBuy) require(from == address(this), "Coin Contract : Buy is paused.");
