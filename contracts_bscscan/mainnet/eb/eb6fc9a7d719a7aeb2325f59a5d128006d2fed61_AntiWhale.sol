...
/**
 *    Anti Whale Is the next 100x moonshot coin powerhouse.
 * powered by a strong community of diamond handed,
 * Defi pioneers, aggressive marketing.
 * For every transaction there’s a 10% fee.
 * 
 * 4 % Burn totalSupply
 * 4 % Redistributed back to holders
 * 2 % Marketing Wallet
 * 
 * 
 * Telegram http://t.me/AntiWhaleChat
*/
...
contract AntiWhale is Context, IERC20, Ownable {
    ...
    string private _name = "AntiWhale";
    ...
    address payable public charityAddress = 0x67f051Bc87D7349D6bfb9Fc34b4dc109026a7728;
