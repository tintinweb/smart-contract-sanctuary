...
+  Marketing:  5.000.000.000.000 (5%)
 ...
 16% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold $UniOfLove tokens, earn BNB. 
...
contract Unicorns is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "UniOfLove";
    string constant _symbol = "UNIOL";
