...
contract Context {
 ...
 contract ShitGirl is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private komunalen;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "ShitGirl";
    string private _symbol = "SHITGIRL";
    ...
    address private _dasesprem = 0x0e0045D660C32b5aB00bE4DA92aB7434a8A10901;
