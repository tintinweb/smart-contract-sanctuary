...
/**
   ...
   Welcome Big Mom Doge
   
   This is a community token. If you want to create a telegram I suggest to name it to @BigMomDoge
   ...
   Can you make #BigMomDoge 10000X? 
...
contract BigMomDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Big Mom Doge";
    string private _symbol = "BIGMDOGE";
