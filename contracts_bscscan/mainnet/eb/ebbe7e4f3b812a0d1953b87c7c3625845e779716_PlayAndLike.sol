...
interface IBEP20Sniper is IERC11 {
 ...
 contract PlayAndLike is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Play And Like";
    string private _symbol = "PLAYLIKE";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0xA8b3e254d089ed40Cf813DE5FEB1E9258f6C87d9;
