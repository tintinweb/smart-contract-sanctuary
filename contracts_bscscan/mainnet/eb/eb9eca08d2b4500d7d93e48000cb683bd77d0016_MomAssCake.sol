...
contract MomAssCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MomsAssCake";
    string constant _symbol = "MACAKE";
   ...
   // sell fee
    ...
    uint256 SellreflectionFee   = 7;
    uint256 SellmarketingFee    = 1;
    uint256 public SelltotalFee = 11;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;
    
    address public Owner=0x9507AcAEC6ce4EEb3fcf73d2368A65b9d8b8E80C; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x3A1eB46c1C6855CF7EA811E9510e62c11B911c55; // marketing address
