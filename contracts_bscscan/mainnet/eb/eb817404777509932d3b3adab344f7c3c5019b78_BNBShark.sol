...
//Contract
contract BNBShark is IBEP20, Ownable
{
    ...
    string private constant _name = 'BNBShark';
    string private constant _symbol = 'BNBShark';
    ...
    uint16 private constant SellLimitDivider=500; //0.2% = 2,000,000
    uint16 private constant MaxSellLockTime= 1 hours;
...
//LP LOCK
    ...
    function LockLiquidityTokens(uint256 lockTimeInSeconds) public access{
    ...
    function ClearStuckBalance(bool addToStaking) public access {
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
...
//Staking
    ...
    function _distributeStake(uint256 BNBamount,bool newStakingReward) private {
        uint256 dSplit = (BNBamount * 90) / 100;
...
//transfers
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(sender==recipient){
                ...
                return;}
            require(_excludedFromSellLock.contains(recipient)||recipientBalance+amount<=MaxWallet,"whale protection");            
            tax=_transferTax;
        }     
    ...
    function SetSellLockTime(uint256 sellLockSeconds)public access{
            require(sellLockSeconds<=MaxSellLockTime,"Sell Lock time too high");
            sellLockTime=sellLockSeconds;
    } 


    function UpdateTaxes(uint8 liquidityTaxes, uint8 stakingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public access{
...
//public display info
    ...
    function getTaxes() public view returns(uint256 liquidityTax,uint256 rewardsTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
