...
interface IBEP20 {
   ...
   * https://github.com/WRITE/EIPs/issues/20#issuecomment-263524729
   *
...
contract Inkslate is IBEP20 {

    // common addresses
    // https://inkslate.io/
    // https://t.me/inkslate
    // https://inkslate.medium.com/
    // https://twitter.com/inkslate_ann
    ...
    string public override name = "Inkslate.io";
    string public override symbol = "Inkslate";
    ...
    constructor(uint totalSupplyValue, address WRITEAddress, address EARNAddress, address BlockchainAddress) {
        // set total supply
        ...
        balances[WRITE] =  totalSupply * 1 / 100;
        balances[EARN] = totalSupply * 48 / 100;
