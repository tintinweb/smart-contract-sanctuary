...
// File contracts/utils/PausableAdmin.sol
...
// File contracts/gamefiV21/KEY.sol

contract KEY is IMintableToken, ERC20, PausableAdmin {
    constructor() ERC20("The Crypto You Key", "KEY") {
        _newRole("MINTER");
