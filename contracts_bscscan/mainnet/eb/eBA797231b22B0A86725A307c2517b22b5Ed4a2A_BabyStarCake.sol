...
/**
    ...
    BabyStarCake  Tokenomics:

    Reflection: 10% of $CAKE
    Marketing 2%
    Auto LP 1%
    Total fee: 13%

    Total Supply: 1,000,000 BabyStarCake
    Max Transaction: 5,000 BabyStarCake
...
contract BabyStarCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyStarCake";
