...
contract BOTC is IBEP20, Auth {
    ...
    address MarketingWalletTwo = 0x15A4397727b7857035eE6D48812c2527e566279C;

    string constant _name = "BOTC";
    string constant _symbol = "BOTC";
    ...
    uint256 public _maxWalletToken = 10000000000000 * (10 ** _decimals);
