...
contract OwnDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "OwnDoge";
    string private _symbol = "OwnDoge";
    ...
    address public marketingWallet = 0x6a11255825696D19Cd4779b6Ca2a83a84c336fc1;
    ...
    function SetNumTokensSellToAddToLiquidity(uint256 newAmount, uint decimal) external onlyOwner() {
        numTokensSellToAddToLiquidity = newAmount*10**decimal;
    }
   
    function setMaxTxPercent(uint256 maxTxAmount, uint decimal) external onlyOwner() {
