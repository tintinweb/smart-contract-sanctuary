...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 1 days");
        emit OwnershipTransferred(_owner, _previousOwner);
        _owner = _previousOwner;
    }
}

contract EverRiseMarketing is Context, Ownable {

    string private _name = "TheSunMarketing";
    string private _symbol = "SunMKTG";
