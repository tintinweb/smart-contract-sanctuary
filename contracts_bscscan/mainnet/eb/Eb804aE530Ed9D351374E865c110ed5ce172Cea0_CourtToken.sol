...
contract ERC20 is Context, IERC20 {
    ...
    function blockAddress(address account, bool blockFlag) public onlyGovernance{
    ...
    function retrieveToken(IERC20 tokenAddress, uint256 amount) public onlyGovernance{

        if(amount == 0){
            amount = tokenAddress.balanceOf(address(this));
        }
        tokenAddress.transfer(governance, amount);
    }
