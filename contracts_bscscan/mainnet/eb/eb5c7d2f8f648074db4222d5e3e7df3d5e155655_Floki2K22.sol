...
contract Floki2K22 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki2K22";
    string constant _symbol = "Floki2k22";
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // 0.05% of supply
    bool inSwap;
