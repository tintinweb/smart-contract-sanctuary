...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x62DbDC3f968351a2d66F9424C6D4d9f338CadA8D;
...
contract RevShiba is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa785f394F7E0D5Eb8ba9d00D370eDDf124dEbF2e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ReverendShiba";
    string private _symbol = "RevShiba";
