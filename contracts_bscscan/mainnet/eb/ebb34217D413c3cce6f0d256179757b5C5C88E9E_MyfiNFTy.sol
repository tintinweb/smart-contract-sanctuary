...
contract MyfiNFTy is Context, IBEP20, Ownable {
    ...
    string private _name = "MyfiNFTy"; // Name
    string private _symbol = "$Myfi";  // ticker/symbol
    uint8 private _decimals = 9; // deciamls 9
    uint256 private _totalSupply = 50 * 1e9 * 1e9; // 50 billion
