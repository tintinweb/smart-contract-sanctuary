...
REWARDS REWARDS REWARDS REWARDS REWARDS REWARDS REWARDS REWARDS 
      ...
      Earn USDC Tokens holding GETUSDC Tokens
15% Total FEE - 13% For rewards 1% For liq 1% For marketing
Get paid every 15 minutes in USDC Tokens 
LP Locked and NO DEV WALLET >> Stealth Launch

TELEGRAM: https://t.me/GETUSDCrewards
Website: https://getusdcrew.money
*/
...
contract GET_USDC_Rewards is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GET_USDC_Rewards";
    string constant _symbol = "GETUSDC";
