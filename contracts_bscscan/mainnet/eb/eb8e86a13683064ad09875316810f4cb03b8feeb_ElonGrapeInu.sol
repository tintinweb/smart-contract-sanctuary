...
/**
🟣Welcome everyone ElonGrapeInu community! 👋🏻

The next 100x tweet by Elon! the moonshot is at our fingertips and will be the degen of the day. 

⏰Stealth Launch > 1/16/2021 - 4PM - 5PM UTC 

TOKENOMICS 
📍3% Reflection to reward holders 
📍3% Marketing to create a bullish chart 
📍3% Liquidity to have a stable pricefloor 

More development along the way! Lets moon it and be rich 

TG: https://t.me/ElonGrapeInu
*/
...
contract ElonGrapeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonGrapeInu";
    string private constant _symbol = "$EGI";
...
//   Changeable /lower/higher after the launch  
 ...
 //  Changeable /lower/higher after the launch  
    ...
    uint256 public _maxWalletToken = 4000000000 * (10**18); // 4%
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0x56847bCE5B3CC0A9e447F32f6fc68a878Ab312Cc).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0x56847bCE5B3CC0A9e447F32f6fc68a878Ab312Cc).call{value: bnbForTeam2}("");
