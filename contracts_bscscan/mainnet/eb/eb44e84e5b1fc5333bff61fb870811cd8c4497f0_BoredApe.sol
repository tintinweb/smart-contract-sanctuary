...
Following the latest... Nah Just Bored

✅ Newest hype
✅ Safe dev and project
✅ Stealth launch
...
TG = https://t.me/BoredApeofficial
...
/* Token contract */
contract BoredApe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Bored Ape";
    string constant _symbol = "BoredApe";
    ...
    // Max wallet and TX
    uint256 public _maxTxAmount = _totalSupply * 50 / 10000;  // 0.5% max or 2M
    uint256 public _maxWalletToken = _totalSupply * 400 / 10000; // 4% or 4M tokens
    ...
    // Dead blocks
    uint256 deadBlocks = 5;

    // Sell amount of tokens when a sell takes place
    uint256 public swapThreshold = _totalSupply * 2 / 10000; // 0.2% of supply
