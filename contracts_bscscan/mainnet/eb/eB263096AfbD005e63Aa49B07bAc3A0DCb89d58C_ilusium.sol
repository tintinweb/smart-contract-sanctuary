...
// https://t.me/ilusium_pr
// $ilusium Coin proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN ilusium ! With the auto-claim feature,
// simply hold$ ilusium Coin and you'll receive ilusium Coin automatically in your wallet.
// 
// Hold ilusium Coin and get rewarded in ilusium Coin on every transaction!
//
//
// 
// 
...
contract ilusium is ERC20 {

    uint tokenTotalSupply = 100000000000; // 100 Million Token Supply

    constructor() public ERC20("Ilusium Project", "ILUSIUM") {
