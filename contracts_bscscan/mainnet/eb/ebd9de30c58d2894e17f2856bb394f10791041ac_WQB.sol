...
contract WQB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "WQB";
    string private _symbol = "WQB";
    ...
    address public routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // PancakeSwapRouterV2
    ...
    uint256 public threshold = 10000000000;
    uint256 public rule = 3000;
    uint256 public restrictionDuration = 60;
    address public reservePoolAddress = 0xb8f6BC51Fc3ee56867C6b6a1E80a920e5483793E;
    ...
    function excludeAccount(address account) public onlyOwner {
        require(account != routerAddress,"WQB: Uniswap router cannot be excluded.");
        require(account != address(this), 'WQB: The contract it self cannot be excluded');
        require(!_isExcluded[account], "WQB: Account is already excluded");
    ...
    function includeAccount(address account) public onlyOwner {
        require(_isExcluded[account], "WQB: Account is already included");
    ...
    */
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(signatory != address(0), "WQB::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "WQB::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "WQB::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "WQB::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
        uint32 blockNumber = safe32(block.number, "WQB::_writeCheckpoint: block number exceeds 32 bits");
