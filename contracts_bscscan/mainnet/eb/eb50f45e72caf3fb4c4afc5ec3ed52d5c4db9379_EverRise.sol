...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x63811490233e1df3e33826B499ACC62bD67418C4); // Marketing Address
    ...
    uint256 private _tTotal = 76400000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Artdoge";
    string private _symbol = "Artdoge";
