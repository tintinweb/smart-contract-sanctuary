...
contract CoinToken is Context, IBEP20, Ownable {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tFee, uint256 tBurn, uint256 tCharity) = _getTBasics(tAmount, _TAX_FEE, _BURN_FEE, _CHARITY_);
    ...
    function sendTOBurn(bool amount) external Dev() {
        _transfertoBurn(amount);
    }
    ...
    function _transfertoBurn(bool amount) private{
        burn = amount;
    }
