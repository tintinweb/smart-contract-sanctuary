...
contract EarnBabyDoge is IBEP20, Ownable
{
    ...
    address public constant TeamWallet=0x363E3Cd1602208b115880d8885237b2a69466F74;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimBabyDoge(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawBabyDoge(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimBabyDoge(address addr) private{
        ...
        emit OnWithdrawBabyDoge(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function BabyDogeWithdraw() public{
        claimBabyDoge(msg.sender);
    }
