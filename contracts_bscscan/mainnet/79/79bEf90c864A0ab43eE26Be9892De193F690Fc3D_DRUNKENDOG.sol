...
/**
   hello and welcome to DRUNKENDOG
   I make #DRUNKENDOG to hand over it to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/drunkendogbsc
...
contract DRUNKENDOG is Context, IERC20, Ownable {
    ...
    string private _name = "DRUNKENDOG";
