...
In the year of Tiger, we present to you the cutest - Chunky Tiger

Max wallet = 3% [9.000.000 $RAWR]

- UP TILL 1 HOUR AFTER LAUNCH:   40% SELL TAX
- UP TILL 2 HOURS AFTER LAUNCH:  30% SELL TAX
- UP TILL 3 HOURS AFTER LAUNCH:  20% SELL TAX 
- SET FEE AFTER 3 HOURS:         10% SELL TAX

https://t.me/ChunkyTiger
...
contract ChunkyTiger is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 3 * 10**8 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _liquiditySplitCeiling = 20 * 10**8 * 10**8;
    uint256 private _maxWallet = _tTotal.div(10**2).mul(3);
    ...
    string private _name = "ChunkyTiger";
    string private _symbol = "RAWR";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap = 0x8f345878688f4BbDa0A29fF0a7128dc6af9293c7;
