...
contract JungleFEG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xee2500F5e4B0D0461ea4f630db184EC2dae00D8A); // Marketing Address
        
    address payable public teamAddress =
        payable(0x07ce7e8A730E8b8F7806eB6f30391079d0619989); // Team Address
        
    address payable public liquidityAddress =
        payable(0x07ce7e8A730E8b8F7806eB6f30391079d0619989); // Liquidity Address
    ...
    string private constant _name = "JungleFEG";
    string private constant _symbol = "JFEG";
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(teamAddress).transfer(amountBNB * amountPercentage / 100);
    }
}