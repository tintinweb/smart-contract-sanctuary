...
contract SantaClaus is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000 * 10**6 * 10**9; // 100 quadrillion
    ...
    address payable private _developmentAddress = payable(0x8cb79C64526320f1aD911559e9161d144A80a97e);
    address payable private _marketingAddress = payable(0x8089411C8cf58C088c66463340A5359059eddB02);
    
    string private constant _name = "SantaClaus";
    string private constant _symbol = "SantaClaus";
