...
contract abeg is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x54A78960e36bf46FCafBcafFe80B99D68a682406); // Marketing Address
    ...
    string private _name = "abeg";
    string private _symbol = "$abeg";
