...
contract DogeBrother is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x176eBF215C047Cb7c4206f9CBeeCF2C2232838c6); // Marketing Address
    ...
    uint256 private _tTotal = 100000000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DogeBrother";
    string private _symbol = "DogeBrother";
