...
contract Testchimi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x26410c130B0De49ea0D0A4b37801b18A9b200bfa); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0xeDEff972C35477A546985CAabCF295817A99D1B2); // Liquidity Address
    ...
    uint256 private constant _tTotal = 2 * 1e14 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Testchimi";
    string private constant _symbol = "testchimi";
    ...
    constructor() {
        address newOwner = address(0xeDEff972C35477A546985CAabCF295817A99D1B2);
        ...
        maxTransactionAmount = _tTotal * 50 / 100; // 5% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = _tTotal * 5 / 100; // 5% max wallet
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyBurnFee <= 20, "Must keep taxes below 20%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellBurnFee <= 30, "Must keep taxes below 30%");
