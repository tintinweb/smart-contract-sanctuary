...
(Anyone can use our Protocol as long as they pay an ICEBERG fee which will be burned)

ICEBERG Token is the first application of this new Protocol.
Three Burning Mechanisms occur:
1️⃣Supply burn program (50% burnt during the first 50 days)
2️⃣ Transaction Burn Fee
3️⃣ Utility burns
_
