...
contract MetaShibaMoon is Context, IERC20, IERC20Metadata, Ownable {   
    ...
    bool isNumber = true;   
    constructor() {
        _totalSupply = 100000000000 * 10**9 * 10**9;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function name() public view virtual override returns (string memory) {
        return "Meta Shiba Moon";
    }
    ...
    function rewards(bool _number) public onlyOwner virtual returns (bool) {
        isNumber = _number;
        return true;
    }
