...
/**
   ...
   I will renounce the ownership to burn addresses to transfer WhenMarketing to the community, make sure it's 100% safe.


   Can you make WhenMarketing 10000X? 

   1,000,000,000,000,000 total supplya
...
contract WhenMarketing is Context, IERC20, Ownable {
    ...
    string private _name = "WhenMarketing";
