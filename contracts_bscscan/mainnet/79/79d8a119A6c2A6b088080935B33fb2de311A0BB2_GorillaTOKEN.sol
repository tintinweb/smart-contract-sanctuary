...
contract GorillaTOKEN is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "GorillaTOKENv2";
	...
	function _transferToExcluded(address sender, address recipient, uint256 tAmount) private {
		(uint256 rAmount, uint256 rTransferAmount, uint256 rHODLrFee, uint256 tTransferAmount, uint256 tHODLrFee, uint256 tBurn, uint256 tCharity) = _getValues(tAmount);
		_rOwned[sender] = _rOwned[sender].sub(rAmount);
