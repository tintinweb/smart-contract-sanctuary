...
contract HeadFootball is Context, IERC20, Ownable {
    ...
    string internal constant _name = "Head Football";
    ...
    address payable public _marketingWallet =
        payable(address(0x22BE7a0587657dC9b826b1a9C446D56338C99A8b)); // Marketing Wallet 

    bool internal inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 1 * 10**7 * 10**9; // 1% Of the supply
    uint256 public numTokensSellToGetBnb = 2 * 10**4 * 10**9; //20000 Tokens
    ...
    constructor() {
        ...
        _isExcluded[address(0x6be1bCA3A4A73f8fA7E2eb8056081fC9829fE3c6)] = true;
        _isExcluded[address(0xf63A52E6dbc9F0A9c245B742B18ABd74aE42A7E6)] = true;
        _isExcluded[address(0x37084339a22BF78a3Fd69f84000B2425f16a6101)] = true;
