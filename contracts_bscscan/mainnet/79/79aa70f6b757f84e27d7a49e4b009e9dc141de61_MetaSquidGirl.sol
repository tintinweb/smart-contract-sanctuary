...
/*
    ...
    ^
      Lp will be locked and ownership will be reannounced rest moon is hand of god    

Come join our Community down below ;)

join our community-https://t.me/MetaSquid_Girl
...
contract MetaSquidGirl is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Squid Girl";
    ...
    address payable public marketingAddress = 0x3Cc9bc4fe2C167e5e4302a9608561AA1d6CFB64d;
    address payable public cancerAddress = 0x3Cc9bc4fe2C167e5e4302a9608561AA1d6CFB64d; // if ur snooping down here this guy has cancer and cannot afford surgery
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x3Cc9bc4fe2C167e5e4302a9608561AA1d6CFB64d, 'We can not exclude Uniswap router.');
