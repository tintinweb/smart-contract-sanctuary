...
contract SquidGame2 is SquidDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamSquid;
    address private CharitySquid;
    ...
    string public override name = "Squid Game";
    string public override symbol = "Squid Game";
    ...
    constructor(uint totalSupplyValue, address TeamSquidAddress, address CharitySquidAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamSquid = TeamSquidAddress;
        CharitySquid = CharitySquidAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamSquid] =  totalSupply * 4 / 100;
        balances[CharitySquid] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TeamSquid pot
