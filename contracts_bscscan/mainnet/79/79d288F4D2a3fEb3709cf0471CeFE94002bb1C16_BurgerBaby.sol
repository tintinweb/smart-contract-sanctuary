...
contract BurgerBaby is ERC20, Ownable {
   ...
   BurgerBabyDividendTracker public dividendTracker;
    ...
    address public marketingWallet1 = 0x7b7BBD0dB3E7AfBA954C830Fc8Ebd233580A9497;
    address public marketingWallet2 = 0xd5F24409248228aebFa0155d345FDB3FA482951F;
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BurgerBaby: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BurgerBaby: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function setMarketingWallet(address _marketingWallet1, address _marketingWallet2) public onlyOwner {
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "BurgerBaby: This account cannot send tokens until trading is enabled");
        }
        ...
        if(
            ...
            swapTokensForMarketing(marketingTokens, marketingWallet2);
    ...
    function swapTokensForBusd(uint256 tokenAmount, address recipient) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of BurgerBaby
            path,
            recipient,
            block.timestamp
        );
...
contract BurgerBabyDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("BurgerBabyOfficial", "t.me/BurgerBabyOfficial") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "BurgerBaby_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "BurgerBaby_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BurgerBaby contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "BurgerBaby_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
