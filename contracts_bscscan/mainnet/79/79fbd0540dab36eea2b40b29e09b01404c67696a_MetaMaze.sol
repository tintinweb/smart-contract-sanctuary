...
contract MetaMaze is Context, IERC20, Ownable {
  ...
  string private _name = 'MetaMaze';
  string private _symbol = 'METAMAZE';
  ...
  address payable public _METAMAZEWalletAddress;
  ...
  constructor(
    address payable METAMAZEWalletAddress,
    address payable marketingWalletAddress
  ) {
    _METAMAZEWalletAddress = METAMAZEWalletAddress;
  ...
  function sendETHToTeam(uint256 amount) private {
    _METAMAZEWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _setMETAMAZEWallet(address payable METAMAZEWalletAddress) external onlyOwner {
    _METAMAZEWalletAddress = METAMAZEWalletAddress;
  }
