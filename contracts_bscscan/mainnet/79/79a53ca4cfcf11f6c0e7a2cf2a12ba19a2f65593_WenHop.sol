...
/**
 * 
 * Wen Hop, just like Elon Musk. https://twitter.com/AlexSvanArt/status/1418252226183770127?s=19
 * 
 * Telegram @WenHopBSC
 *
 */
...
contract WenHop is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd5932C74DF7A5878a2b5B424b6AcA477B88Dc579); // Marketing Address
    ...
    string private _name = "WenHop";
    string private _symbol = "WENHOP";
