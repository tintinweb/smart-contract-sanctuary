...
contract VORTEX is ERC721Enumerable, Ownable {
  ...
  function buyNFT(uint256 amount) public payable {
    require(openToPublic, "VORTEX: Not open to public yet");
    require(globalId < 10000, "VORTEX: All minted");
    require(msg.value == amount * regularPrice, "VORTEX: Incorrect value sent");
    require(globalId + amount <= 10000, "VORTEX: Cannot mint amount");
    require(amount > 0 && amount <= 20, "VORTEX: Max 20 per transaction");
  ...
  function mintNFT(uint256 amount, address to) public onlyOwner {
    require(teamMintCount < 100, "VORTEX: Team mint max 100");
    require(
      teamMintCount + amount <= 100,
      "VORTEX: Amount + team mint count invalid"
    );
