...
/**
 * CATHOSI OFFICIAL BEER Cryptographic Project
 * 
 * First Spanish Beer project
 * 
 * 
 * FEEs 10%
 *
...
import "./beer1-imports.sol";

/**
 * Thank you for trusting the CATHOSI project. 
 */
abstract contract Tokenomics {
    ...
    string internal constant NAME = "CATHOSI OFFICIAL BEER";
    string internal constant SYMBOL = "CTS";
    ...
    uint256 internal constant TOTAL_SUPPLY = 10000000000000 * ZEROES;
    ...
    address internal marketing = 0xffe26e0d9B336283D0F966eAc86a3f5Ec938f1d0;
    address internal burnAddress = 0xf29bBa060F87ee7bDC1B9a8807320587459DD75f;
    address internal desarrollo = 0xD12285e4E9aef38Be284d3a502f4e7E12f8C3729;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 30, marketing );
        _addFee(FeeType.Burn, 10, burnAddress );
        _addFee(FeeType.External, 20, desarrollo );
