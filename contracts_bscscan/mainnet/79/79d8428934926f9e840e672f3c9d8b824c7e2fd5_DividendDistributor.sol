...
/**
 *Submitted for verification at bscscan on 2021-12-09
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    function deposit() external payable override onlyToken {
        ...
        path[0] = WBNB;
        path[1] = address(EP); //wETH address
...
contract Token is IBEP20, Auth {
    ...
    address EP = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; 
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ETHPrintoooooor";
    ...
    address public autoLiquidityReceiver=0xEA907CdAF6B474a983aD50EC57fad56db8c83aA9;
    address public marketingFeeReceiver=0xEA907CdAF6B474a983aD50EC57fad56db8c83aA9;
