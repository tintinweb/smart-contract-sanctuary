...
contract lotto is Context, IERC20, Ownable {
    ...
    uint256 private _minLottoBalance = 10000000000000000;

    string private _name = "ClonIt";
    string private _symbol = "ClonIt";
    ...
    address public ownerAddress = address(0x8AE73eDc7a810E96f97815FB32de1D50CC9FB538);
