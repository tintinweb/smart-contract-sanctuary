...
contract DragonSlayer is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBC30464CB0ACc1baD3278a8b51666899d1b52410); // Marketing Address
    ...
    string private _name = "DragonSlayer";
    string private _symbol = "DRS";
