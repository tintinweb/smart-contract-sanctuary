...
contract Staking is WhitelistedRole {
    ...
    constructor(address CluiserLandTokenAddr16, uint256 newMinimum, uint256 newMedium, uint256 newMaximum, uint256 newMinPercent, uint256 newMedPercent, uint256 newMaxPercent, uint256 settingsLimit, uint256 newFeePercent, uint256 newFeePeriod) public Ownable(msg.sender) {
        require(CluiserLandTokenAddr16 != address(0));

        token = IERC20(CluiserLandTokenAddr16);
