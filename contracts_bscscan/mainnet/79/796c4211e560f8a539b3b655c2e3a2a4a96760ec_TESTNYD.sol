...
contract TESTNYD is ERC20, Ownable {
    ...
    constructor() ERC20("TESTNYD", "TESTNYD") {
        ...
        uint256 totalSupply = 1 * 1e11 * 1e18; // 100 billion
        ...
        maxWallet = totalSupply * 10 / 1000000; // 0.5% max wallet
        ...
        marketingWallet = 0x9434c14ce447c02a8B53f819F3D472880CB76745; // set as marketing wallet
        buyBackWallet = 0xBe4cE2CF5120Baf3f987a0Bfe0942cD5B851605d; // set as buyback wallet
