...
/**
 Welcome to  BabyCmoon
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyCmoonTg
   ...
   I will renounce the ownership to burn addresses to transfer #BabyCmoon to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 50% total supply to the pool
   Can you make #BabyCmoon 10000X? 
   ...
   it's the best part of the #BabyCmoon idea, increasing the liquidity pool automatically, 
...
contract BabyCmoon  is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Community Moon";
    string private _symbol = "BABYCMOON";
