...
/*
 * Don't worry, summer is here
 *
 * Don't pump and dump the chilled out Island Doge
 *
 * Total Supply: 15 Billion (Don't get greedy hun)
 * Max Buy: 100 Million (~0.66% of Total Supply)
 * Max Hold: 200 Million (~1.3% of Total Supply)
 *
 * READ THIS CAREFULLY:
 * Sell within 12 minutes : 40% burn (30% Back to the Liquidity Pool, 10% Redistributed to Holders)
 * Sell within 1  hour   : 32% burn (24% Back to the Liquidity Pool, 8% Redistributed to Holders)
 * Sell within 3  hours  : 24% burn (18% Back to the Liquidity Pool, 6%  Redistributed to Holders)
 * Sell within 7  hours  : 16% burn (12% Back to the Liquidity Pool, 4%  Redistributed to Holders)
 * Standard burn        : 8% burn  (6% Back to the Liquidity Pool, 2%  Redistributed to Holders)
 *
 * this is a community coin
 * Feel free to make a group for this, the coin is not going anywhere. 
 *
 */
...
contract ISLANDDOGE is Context, IBEP20, Ownable {
    ...
    string private _name = "ISLANDDOGE";
    string private _symbol = "DOGEISLE";
