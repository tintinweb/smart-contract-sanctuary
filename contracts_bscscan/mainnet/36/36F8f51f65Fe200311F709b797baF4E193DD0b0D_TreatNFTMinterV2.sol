...
contract TreatNFTMinterV2 is ERC1155Tradable {
    ...
    function addTreatReferrer(address treatmodel, address referrer) public onlyWhitelistAdmin {
    ...
    function updateNftCreator(uint256 _id, address _creatorAddress) external onlyWhitelistAdmin {
