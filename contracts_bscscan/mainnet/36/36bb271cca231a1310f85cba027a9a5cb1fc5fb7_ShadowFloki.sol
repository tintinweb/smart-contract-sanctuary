...
/**
   ...
   Welcome to Shadow Floki - combine together to #ShadowFloki.
   ...
   I make this #ShadowFloki to hand over to the community.
   Create the community by yourself if you are interested.   
   
   Great features:
   10% fee auto send to burn address, reduce total supply each single tx

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #Ferrari to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 50% total supply to the pool
   Can you make #ShadowFloki 1000X? 
...
contract ShadowFloki is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "$ShFl";
  string constant tokenSymbol = "Shadow Floki";
