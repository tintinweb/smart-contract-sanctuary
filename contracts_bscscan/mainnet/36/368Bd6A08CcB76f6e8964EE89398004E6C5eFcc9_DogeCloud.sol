...
contract DogeCloud is ERC20Detailed, ERC20Burnable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 5800000 * (10 ** uint256(DECIMALS));

    constructor () public ERC20Detailed("DogeCloud", "DogeCloud", DECIMALS) {
        _mint(0xef527103824FFB824c246A3D91A41af9fEd9aBE0, 5800000 ether);
