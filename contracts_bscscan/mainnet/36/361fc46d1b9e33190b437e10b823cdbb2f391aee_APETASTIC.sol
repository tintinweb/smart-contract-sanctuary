...
Other features
max wallet size (each wallet can only hold 2.5% of supply).
*/
...
contract APETASTIC is Context, IERC20, Ownable {
    ...
    string private _name = "APETASTIC";
    ...
    address public burnAddress = 0x6E1Dc77982C18F82AD7Ef5fD2f7766541DD3f272;
    address payable private _marketingWallet = payable(0x28d0BCd19d92dA883C1db78f1810006De13fcdD7);
    address payable private _devWallet = payable(0x6E1Dc77982C18F82AD7Ef5fD2f7766541DD3f272);
