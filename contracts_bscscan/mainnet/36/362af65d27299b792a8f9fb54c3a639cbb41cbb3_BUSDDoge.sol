...
//        BUSDDoge Smart Contract
//
//        Telegram: https://t.me/BUSD_Doge
//
//     Earn BUSD while holding BUSDDoge! Passive Income, not bad eh?
//
//     Tokenomics:
//     10% BUSD reflection
...
// File: contracts/BUSDDogeDividendPayingToken.sol
...
contract BUSDDoge is ERC20, Ownable {
    ...
    constructor() public ERC20("BUSDDoge", "BUSDDoge") {
...
contract BUSDDogeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("BUSDDoge_Dividend_Tracker", "BUSDDoge_Dividend_Tracker") {
    	claimWait = 1800;
