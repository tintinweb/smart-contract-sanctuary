...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x72DcCd7A95059957456EE86e29A3d735B6c30080;
...
contract EkaInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x522684297801f82719474eeBCA9087bCff1c5909;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Eka Inu";
    string private _symbol = "EKA";
