...
Audit
Sale Live
aika Verse is an upcoming RPG Play-to-earn strategy game of space exploration, territorial conquest, political domination, and more that built on Binance Smart Chain (BSC). 
aika Verse has two types of combat: PVE (Player vs Environment) and PVP (Player vs Player), where you can farm items and aika Tokens that will allow you 
to advance in the game and develop aika verse's economy. 
aika Verse is RPG Play-to-Earn Metaverse NFTs Staking Web3

Beta V1 PLZ dont Buy .. Wait for the presale to end. this is Beta
Pinksale lock token And LP
MAX TX 1%
 ...
 * the owner.
 */
contract HEXOwnable is HEXContext {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "HEXOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "HEXOwnable: new owner is the zero address");
...
contract AikaVerse is HEXContext, HEXDeployer, HEXOwnable {
    ...
    uint256 public _maxTxAmount = 10_000_000_000 * 10**9; // 1%
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100_000_000 * 10**9; //
    string private constant _name = "Aika Verse"; // 
    string private constant _symbol = "Aika Verse"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x40393C136eBE5305C86144cFbcDF85B9a60bBf57;
