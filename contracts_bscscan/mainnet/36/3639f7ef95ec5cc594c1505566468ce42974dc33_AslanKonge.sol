...
/**                                          ASLANKONGE IS THE FUTURE
 AslanKonge is the ruler of the cryptocurrency world and the King of DeFi.
 KongeFi Launchpad, Esports Integration, The High Rewarding System, Fully Doxxed Team, 
 Community Airdrops and much more things to come. Earn up to 20% in $BUSD simply by holding at least 200,000 KONGE. 
 
 Join us on telegram for updates:
 https://t.me/AslanKonge
 
 Website:
 https://aslankonge.com/
...
contract AslanKonge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AslanKonge";
    string constant _symbol = "KONGE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xe73641482aFb6B53f5A4D5A1Bf419EeD64C924CB;
