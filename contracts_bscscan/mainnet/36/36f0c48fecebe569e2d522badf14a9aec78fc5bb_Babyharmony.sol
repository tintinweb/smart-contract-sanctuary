...
The first Harmony Reflection Token. Get rewarded in $ONE on every transaction
10% Buy Tax/ 11% Sell Tax
🔥7% Rewards in $ONE
💲Huge Marketing Plans!
🔒LP/Dev Wallet locked 1 year
✅ Trusted team from $BabyCake 
🔜 Audit by TechRate

✅SAFU:
Liquidity and Dev wallet are locked for 1 year before launch

🐳🚫Anti-Whale:
Max Wallet 2%
Max Transactions 0,2%
...
-Experienced DEV
-Multi-deployment
-CA released at launc

TG: https://t.me/babyharmonymainchat
*/
...
contract Babyharmony is ERC20, Ownable {
    ...
    constructor() ERC20("BabyHarmony", "BABYHARMONY")  {
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function setLiqFee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
