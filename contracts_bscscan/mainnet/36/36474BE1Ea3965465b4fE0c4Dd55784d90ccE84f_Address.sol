...
contract Boss_Baby_Dogecoin_BSC is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'NERDDOGE';
    string  private constant _SYMBOL = 'NERDDOGE';
    ...
    uint256 private _CHARITY_FEE = 300; // 3% TO CHARITY WALLET
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x20206168Da60B08DcA0487D83472123d02683B16, 'We can not exclude Uniswap router.');
    ...
    function setAsCharityAccount(address account) external onlyOwner() {
        require(account != 0xE35D554802F1342d01fD13a94cEFC837271c872B, 'The Uniswap router can not be the charity account.');
