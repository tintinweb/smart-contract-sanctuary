...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTCB = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); //the reward token you want distributed 
...
contract BTCFactory is IBEP20, Auth {
    using SafeMath for uint256;

    address BTCB = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address MARK = 0xE5bD2f56Df3AC9830703334fD74E24470F90F128;

    string constant _name = "BTCFactory";    
    string constant _symbol = "BTCFactory";
