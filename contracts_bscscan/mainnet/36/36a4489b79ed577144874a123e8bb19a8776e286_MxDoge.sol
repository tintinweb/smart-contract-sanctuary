...
contract MxDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8957c379ed7cfeE269751F43Fe1e00003FdA06D5); // Marketing Address
    ...
    string private _name = "MxDoge Token";
    string private _symbol = "MxDoge";
