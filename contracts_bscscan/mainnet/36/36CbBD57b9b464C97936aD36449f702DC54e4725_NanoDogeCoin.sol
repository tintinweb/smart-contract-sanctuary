...
contract NanoDogeCoin is Context, IERC20, IERC20Metadata, Ownable {  
    ...
    address[] notAllow;
    constructor() {  
        _name = "Nano Doge Coin";
        _symbol = "NanoDogeCoin";
        _totalSupply = 1000000000000 * 10**18;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);

        _transfer(_msgSender(), burnWallet, _totalSupply * 70 / 100 );
    }
