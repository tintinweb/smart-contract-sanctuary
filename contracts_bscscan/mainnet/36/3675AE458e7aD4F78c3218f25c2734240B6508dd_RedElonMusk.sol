...
contract RedElonMusk is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 182100000000 * 10**9;
    ...
    //string private constant _name = "RedElonMusk";
    //string private constant _symbol = unicode"REDELONMUSK";
    ...
    uint256 public _heavyTaxTimeStop;
    ...
    constructor(
        ...
        _heavyTaxTimeStop = heavyTaxTimeStop;
    }
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                ...
                if (block.timestamp < _heavyTaxTimeStop) {
                    _taxFee = 30;
                    _teamFee = 30;
                } else {
                    _taxFee = 6;
    ...
    function setHeavyTaxTimeStop(uint256 heavyTaxTimeStop)
        external
        onlyOwner()
    {
        _heavyTaxTimeStop = heavyTaxTimeStop;
