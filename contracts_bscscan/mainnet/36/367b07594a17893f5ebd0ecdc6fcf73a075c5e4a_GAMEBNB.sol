...
contract Ownable is Context {
  ...
  constructor () internal {
   ...
   /**
      12% BETA ;0xbe1a001fe942f96eea22ba08783140b9dcc09d28 rewards on internal tx back to holder
...
contract GAMEBNB is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 15;
  uint256 public _feeLiq = 3;
  uint256 public _feeRewards = 10;
