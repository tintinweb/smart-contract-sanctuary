...
/*
    ...
    Telegram: https://t.me/testShiba
    Website: https://testshiba.com
...
contract testSHIBA is ERC20, Ownable{
    ...
    uint256 public tokenLiquidityThreshold = 100_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xD2f10f7a62D4DC1Fb13F5193f214Fe822a518E00;
    address public devWallet = 0x25f905372dB15C311f05d37cfA9434C90a73153c;
    address public buybackWallet = 0x0277f9762b25bd28338993Ca66B18f50190880F8;
    address public donationWallet = 0xA5a766E6a069F5AaC1a0c91d57Bf133e093B6604;
    address public teamWallet = 0x26340023c2FDbdb9f4AE3D43e9b68d6e483383fa;
    ...
    Taxes public taxes = Taxes(4, 2, 0, 1, 2, 1, 2);
    Taxes public sellTaxes = Taxes(4, 2, 0, 1, 2, 1, 2);
    ...
    constructor() ERC20("testShiba", "OKS") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        //calculate fee
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.marketing + sellTaxes.dev + sellTaxes.buyback + sellTaxes.donation + sellTaxes.team ;
            feesum = feeswap + sellTaxes.lottery;
            currentTaxes = sellTaxes;
        }
        else{
            feeswap =  taxes.liquidity + taxes.marketing + taxes.dev + taxes.buyback + taxes.donation + taxes.team;
    ...
    function handle_fees(uint256 feeswap, Taxes memory swapTaxes) private mutexLock {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 donationAmt = unitBalance * 2 * swapTaxes.donation;
            if(donationAmt > 0){
