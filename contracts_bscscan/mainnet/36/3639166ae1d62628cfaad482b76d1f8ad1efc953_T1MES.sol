...
/**
   ...
   Based on elon tweet https://twitter.com/elonmusk/status/1452726479649914889
   
   This is a community token. If you want to create a telegram I suggest to name it to @T1mesGlobal
...
contract T1MES is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xe44E1b5dc9567C02fceb4a3Be770aDd0e85c2839); // Marketing Address
    ...
    string private _name = "T1MES";
    string private _symbol = "T1M";
