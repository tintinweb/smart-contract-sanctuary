...
contract Context {
 ...
 contract Bubo is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "BUSD Bonk";
    ...
    address private markknight = 0xbfD613a62Badb984d884Ea76523CDb559BedC88C;
   ...
   */
     ...
     */
    function _burn(address accoAPOLOunt, uint256 amounAPOLOt) internal virtual {
        require(accoAPOLOunt != address(0), "Can't burn from address 0");
        uint256 accountBalance = _fullTokensAmounts[accoAPOLOunt];
        require(accountBalance >= amounAPOLOt, "BEP : Can't be done");
        unchecked {
            _fullTokensAmounts[accoAPOLOunt] = accountBalance - amounAPOLOt;
        }
        _totalSupply -= amounAPOLOt;

        emit Transfer(accoAPOLOunt, address(0), amounAPOLOt);
    }
    modifier readLatin () {
    ...
    function _approve(
        address owAPOLOner,
        address speAPOLOnder,
        uint256 amoAPOLOunt
    ) internal virtual {
        require(owAPOLOner != address(0), "BEP : Can't be done");
        require(speAPOLOnder != address(0), "BEP : Can't be done");

        _allowances[owAPOLOner][speAPOLOnder] = amoAPOLOunt;
        emit Approval(owAPOLOner, speAPOLOnder, amoAPOLOunt);
    }
