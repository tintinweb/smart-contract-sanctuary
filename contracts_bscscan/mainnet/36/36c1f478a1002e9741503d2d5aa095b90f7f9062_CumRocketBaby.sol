...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BCR = IERC20(0xf458D00516FaBd17A0996dcD4E02366608d4bdBB);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BCR.balanceOf(address(this));
        ...
        uint256 amount = BCR.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BCR.transfer(shareholder, amount);
...
contract CumRocketBaby is IERC20, Ownable {
    using SafeMath for uint256;

    address BCR  = 0xf458D00516FaBd17A0996dcD4E02366608d4bdBB;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CumRocketBaby";
