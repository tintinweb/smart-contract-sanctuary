...
////////////////////////////////
 /**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #EtherBack

    I make this #EtherBack to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/EtherBack_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #EtherBack to the community, make sure it's 100% safe.

   I will add 2 BNB and all the left 49.5% total supply to the pool
   Can you make #EtherBack 10000000X? 

   1,000,000,000,000,000 total supply
   50,000,000,000,000 tokens limitation for trade
   0.5% tokens for dev
   ...
   it's the best part of the #EtherBack idea, increasing the liquidity pool automatically, 
...
contract EtherBack is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "ETHBACK";
  string private _name = "EtherBack";
