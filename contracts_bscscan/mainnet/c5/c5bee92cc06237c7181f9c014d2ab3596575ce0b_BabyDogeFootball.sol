...
import "./BabyDogeFootball-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyDogeFootball` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyDogeFootball(Env.Testnet)` or `BabyDogeFootball(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyDogeFootball";
    string internal constant SYMBOL = "BDF";
     ...
     */
    address internal tipToTheDev =0x6bD167F1eE2B0d4bBDc31CA9f309b78bE62495f9;
...
contract BabyDogeFootball is SafeToken{
