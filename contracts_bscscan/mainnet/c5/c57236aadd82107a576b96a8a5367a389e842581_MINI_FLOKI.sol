...
contract MINI_FLOKI is IERC20 {
    ...
    address private charity = 0x8B99F3660622e21f2910ECCA7fBe51d654a1517D;
    ...
    constructor () {
        ...
        _transfer(address(this), charity, _initialSupply*3/100);
         _transfer(address(this), dead, _initialSupply*47/100);
