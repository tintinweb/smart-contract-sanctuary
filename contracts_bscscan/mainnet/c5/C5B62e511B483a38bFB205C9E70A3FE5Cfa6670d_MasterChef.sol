...
// PlushBearToken with Governance.
contract PlushBearToken is BEP20 {
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    constructor(
        PlushBearToken _pbear,
        uint256 _startBlock,
        uint256 _pbearPerBlock
    ) public {
        panther = _pbear;
        startBlock = _startBlock;
        pantherPerBlock = _pbearPerBlock;
    ...
    function updateEmissionRate(uint256 _pbearPerBlock) public onlyOwner {
        massUpdatePools();
        emit EmissionRateUpdated(msg.sender, pantherPerBlock, _pbearPerBlock);
        pantherPerBlock = _pbearPerBlock;
    }
