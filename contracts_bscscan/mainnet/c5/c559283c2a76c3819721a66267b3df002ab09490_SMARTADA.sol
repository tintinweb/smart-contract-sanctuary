...
SmartADA is an ADA-Reflectionary token. By holding SmartADA, you receive ADA based off every network transaction! With thanks to Binance’s ADA-PEG, You can receive ADA directly to your wallet, without needing to download or install any ADA Native Software

TG: https://t.me/SmartADAofficial
Website: https://smartada.digital
...
contract SMARTADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SMARTADA";
