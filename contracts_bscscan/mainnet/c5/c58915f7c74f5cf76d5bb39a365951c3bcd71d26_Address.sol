...
contract MiniGoat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x70A15dbce870b1adc10b58124D339A2a076FA2A7); // Marketing Address
    ...
    string private _name = "NasaDoge";
    string private _symbol = "NasaDoge";
