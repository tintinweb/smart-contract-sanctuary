...
/**
From the shadows, a master of stealth and sabotage emerges, 
unleashing a feline frenzy upon any challenger that dares stand in its way. 
In a world of generic mutts, Kitty Ninja reigns supreme!
...
contract KittyNinjaBSC is KittyNinjaETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtKittyNinjaETR;
    address private CharityKittyNinjaETR;
    ...
    string public override name = "KittyNinja";
    string public override symbol = "KINJA";
    ...
    constructor(uint totalSupplyValue, address TeamtKittyNinjaETRAddress, address CharityKittyNinjaETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtKittyNinjaETR = TeamtKittyNinjaETRAddress;
        CharityKittyNinjaETR = CharityKittyNinjaETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtKittyNinjaETR] = totalSupply * 4 / 100;
        balances[CharityKittyNinjaETR] = totalSupply * 4 / 100;
