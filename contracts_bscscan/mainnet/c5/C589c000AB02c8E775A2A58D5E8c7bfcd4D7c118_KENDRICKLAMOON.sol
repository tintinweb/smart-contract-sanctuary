...
contract DividendDistributor is IDividendDistributor {
    ...
    contract KENDRICKLAMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KENDRICKLAMOON";
    string constant _symbol = "LAMOON";
...
//Cooldown and timer functionality
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xf260BcD2BFDC082c9aD4Ab9B726f23C1f585646A;
