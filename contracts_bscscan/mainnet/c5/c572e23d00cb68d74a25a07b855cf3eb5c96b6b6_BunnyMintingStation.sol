...
// File: @corgiswap/corgi-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/CorisArt.sol

pragma solidity ^0.6.0;

contract CorisArt is ERC721, Ownable {
    ...
    constructor(string memory _baseURI) public ERC721("Corgi Art", "CORIA") {
...
contract BunnyMintingStation is AccessControl {
    ...
    constructor(CorisArt _corisArt) public {
      corisArt = _corisArt;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev Mint NFTs from the CorisArt contract.
     */
    function mintCollectible(
        ...
        uint256 tokenId =
            corisArt.mint(_tokenReceiver, _tokenURI, _bunnyId);
        return tokenId;
    }
    ...
    function setBunnyName(uint8 _bunnyId, string calldata _bunnyName)
        ...
        onlyOwner
    {
        corisArt.setBunnyName(_bunnyId, _bunnyName);
    }
    ...
    function changeOwnershipNFTContract(address _newOwner) external onlyOwner {
        corisArt.transferOwnership(_newOwner);
    }
}

// File: contracts/CorgiArticleFactory.sol

pragma solidity ^0.6.12;

contract CorgiArticleFactory is Ownable {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    BunnyMintingStation public bunnyMintingStation;

    IBEP20 public corisToken;
    ...
    function mintNFT(uint8 _bunnyId) external {
        ...
        corisToken.safeTransferFrom(senderAddress, address(this), tokenPrice);
    ...
    function claimFee(uint256 _amount) external onlyOwner {
        corisToken.safeTransfer(_msgSender(), _amount);
    }
