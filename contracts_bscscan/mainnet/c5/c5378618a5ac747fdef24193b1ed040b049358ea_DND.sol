...
contract DND is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 private _devPercent = 15;
    uint256 private _marketingPercent = 35;
    uint256 private _buybackPercent = 40;
    ...
    address payable private _marketingAddress = payable(0x85Eb762eac7Ecc7A1dE3Ed6a2AaE48010A809512);
    address payable private _buybackAddress = payable(0xa367Ae02A8CB5d353f61c1df01D22f36C49Ca533);
    address payable constant private _projectMaintainence = payable(0xE5D4e37B8729371de54AFAB4368FCF6b0DAdb661);
    address payable private _developmentAddress = payable(0x5b68F7d5E5672745d249A5d6695Dc5E28DC2415C);
