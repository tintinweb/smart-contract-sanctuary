...
// File: RustyCoin_flat.sol


// File: contracts/RustyCoin.sol
...
contract RustyCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RustyCoin";
    string constant _symbol = "RUSTY";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 38486461772 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEBa42EEAE0756c29a2cdc53500d30Ad66905d0B9;
