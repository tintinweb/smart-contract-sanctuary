...
// Telegram : https://t.me/safebabycaketoken
...
library SafeMath {
    ...
    function tryMul(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        ...
        // benefit is lost if 'b' is also safebabycakeed.
...
// File: contracts/safebabycakeDividendPayingToken.sol
...
// File: contracts/safebabycake.sol
...
contract safebabycake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable Cake = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    address private _marketingWallet = address(0x605027Ea1cfcC633c6F1A0f2aeE451049b21FCf7);
    address private _devWallet = address(0x605027Ea1cfcC633c6F1A0f2aeE451049b21FCf7);
    ...
    safebabycakeDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("safebabycake", "safebabycake") {
        ...
        dividendTracker = new safebabycakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "safebabycake: The dividend tracker already has that address");

        safebabycakeDividendTracker newDividendTracker = safebabycakeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "safebabycake: The new dividend tracker must be owned by the safebabycake token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "safebabycake: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "safebabycake: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "safebabycake: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "safebabycake: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "safebabycake: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "safebabycake: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "safebabycakeBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "safebabycake: This account cannot send tokens until trading is enabled");
        }
...
contract safebabycakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("safebabycake_Dividend_Tracker", "safebabycake_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "safebabycake_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "safebabycake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main safebabycake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "safebabycake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "safebabycake_Dividend_Tracker: Cannot update claimWait to same value");
