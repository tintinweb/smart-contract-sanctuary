...
contract TURISTO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "TURISTO";
    string private _symbol = "TURISTO";
    ...
    function recoverContractBNB(uint256 recoverRate) public onlyOwner{
        ...
        if(bnbAmount > 0){
            payable(msg.sender).transfer(bnbAmount.mul(recoverRate).div(100));
        }
    }
