...
contract RetardedDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Retarded Doge";
    string private _symbol = "REDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFe373AE9bD62bC0623667172951180fb4C7160E5); // Marketing Address
    address payable public rewardWalletAddress = payable(0xFe373AE9bD62bC0623667172951180fb4C7160E5); // reward Address
