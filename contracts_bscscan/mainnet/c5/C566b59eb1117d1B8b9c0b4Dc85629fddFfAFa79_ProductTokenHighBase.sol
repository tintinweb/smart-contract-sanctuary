...
/**
  ...
  */
contract ProductTokenCore is ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  */
  ...
  /// @dev during buy, 4% of price will be charge as fee
  uint256 public constant FEE_RATE_IN_BUY = 4e24;

  /// @dev during sell, 2% of price will be charge as fee
  uint256 public constant FEE_RATE_IN_SELL = 2e24;
  ...
  */
  function initialize(
    ...
    __ProductToken_init_unchained(_bondingCurve, _productNft, _reserveRatio, _maxTokenCount, _supplyOffset, _baseReserve);
  ...
  */
  function _tradein(uint32 amount_) internal virtual {
    ...
    nft.mintBatch(_msgSender(), tradeinCount, amount_);
