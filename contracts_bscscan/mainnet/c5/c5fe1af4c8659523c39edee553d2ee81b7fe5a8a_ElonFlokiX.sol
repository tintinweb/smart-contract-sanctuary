...
TG: https://t.me/Elon_FlokiX
Calls TG: https://t.me/Vk_Familia
...
---------------------------------
✅First 20 mins: 4x tax for sells
✅Second 20 mins: 3x tax for sells
✅Next 20 mins: 2x tax for sells


Made the toko like this ☝️☝️☝️ just to keep the chart from dumping fast in the first hour


(( Then the sell tax will stay at 2x there will be a happy min every 20 mins the selling tax will be at the normal rate ))

Max tx will be increased to 1% = 10,000,000

💰💰 After 50k all the fees will be at a normal rate and gonna activate the buyback

⛔️>>>>>> U can always check the selling tax here: https://honeypot.is/
...
// CHANGE
contract ElonFlokiX is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Elon FlokiX";
    string constant _symbol = "$FlokiX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1/2) / 100; // 0.5% MAX 5,000,000
    ...
    uint256 public _sellMultiplier = 4; // 4x for sells in the first 15 mins... manually handled
