...
contract zhubajie is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "zhubajie";
    string constant _symbol = "ZBJ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 10; //1% of total supply
