...
/**
    Welcome to the best hype coin RaptorDogeZilla
    A dog with the speed of a raptor and the power of a godzilla.
    RAPTOR + DOG + GODZILLA = RAPTORDOGEZILLA
    Stealth launched! Beware of Scams!
    RaptorDogeZilla is a meme token founded by a dedicated team.
    A diverse group dedicated to take RaptorDogeZilla to a million marketcap with the help of the community.
    RaptorDogeZilla is the coin that does it different.
    We can promise marketing stunts you have never seen before.
*/
...
contract RaptorDogeZilla is Context, IERC20, Ownable { 
    ...
    string private _name = " RaptorDogeZilla"; 
    ...
    address public devWallet = 0x5E0963fAa5641DC32057F5048B34E89eBe8DdF57; 
