...
// CHANGE
contract KishuPunks is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "KishuPunks";
    string constant _symbol = "KISHUPUNKS";
    ...
    uint256 reflectionFee = 0; // 2%
    uint256 devFee = 600; // 6%
    uint256 totalFee = 800; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x19817f286B1DaC1c587F503570D22a566df7ed5E);
