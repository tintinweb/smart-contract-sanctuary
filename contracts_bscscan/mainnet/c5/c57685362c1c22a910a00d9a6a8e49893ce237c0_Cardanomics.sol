...
contract Cardanomics is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Cardanomics";
    string public _symbol= "CARDANOMICS";
     bool balances1 = true;

    address payable public charityAddress = payable(0x15A82e4e60C4F675bfD38D2496097B3348f57B6D); // Marketing Address
