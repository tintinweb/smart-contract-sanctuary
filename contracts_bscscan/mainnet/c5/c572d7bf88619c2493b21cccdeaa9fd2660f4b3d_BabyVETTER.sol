...
// TG: https:https://t.me/babyvetterofficial
// WEBSITE: https://babyvetter.ai
...
contract BabyVETTER is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "$Baby VETTER.ai";
   string constant _symbol = "$BabyVETTER";
...
uint256 reflectionFee = 100;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x86585075c63d4fD3aDD9eDF38dAf945a8E34dcFf;
