...
╚═╝  ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝      ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
 ...
 TG: https://t.me/AstroCakeToken
 
 Hodl $ASTROCAKE and get CAKE automatically in your wallet every hour or so!
 $CAKE: 0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82
 
 # of Tokens: 1,000,000,000,000 (1 TRILLION)
 Max Wallet Size = 30,000,000,000 (3%)
 Max Transaction Size = 30,000,000,000 (3%)
 
 Reflection/Taxes: 12% in CAKE, 7% in Liquidity, 1% Marketing
 
 Buy Slippage: 11-13% (12% should be OK)

 *** THE MAX A WALLET CAN HAVE IS 30,000,000,000! THAT IS 3%! YOU CAN SELL A MAX OF 3%! ***
...
// CHANGE
contract ASTROCAKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ASTRO CAKE";
    string constant _symbol = "ACAKE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 3% MAX 
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 3% MAX 
