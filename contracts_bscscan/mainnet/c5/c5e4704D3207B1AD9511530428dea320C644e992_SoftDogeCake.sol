...
/**
🔥 Buy & Sell Tax: 16% 
💰 5% $DOGE Redistribution
💰 5% $CAKE Redistribution
💰 3% Marketing  
💴 3% Liquidity

SoftDogeCake is a Token inspired by DOGE achievements,
based on the idea of trying to create a small community
that can provide all necessaries needed to create an DOGE
version in Low Market Cap world. Our $SADA token will be having
10% of DOGE&$CAKE reflection to all Holders. All safety measure will be provided as well
to gain the investors trust, which is the only thing we need for taking this to an other level.
EARN DOGE BY HOLDING $SDCAKE.
And please keep in mind, SoftDogeCake is a token to hold
*/
...
contract SoftDogeCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SoftDogeCake";
    string constant _symbol = "SDCAKE";
