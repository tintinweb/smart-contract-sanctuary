...
/**
 *           Baby Shiba Noodles
 *      SHIBA MEME - MOON DREAM.
 * Baby Shiba Noodles is your friendly reliable companion. 
 * All you need to do is feed him with lots of noodles and be rewarded with his love, protection and reflections!
 * 
 * Dividend Token that reward $BNB every 30 minutes!
 *      Fees on Buy: 10% / Fees on Sell: 16%
 *                          
 * 
 *      https://t.me/babyshibanoodles
 * 
 * 
*/
...
contract BabyShibaNoodles is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyShibaNoodles";
    string constant _symbol = "BBSN";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x68608C828C3c87c42A02a6f8827762a2a33613E4;
