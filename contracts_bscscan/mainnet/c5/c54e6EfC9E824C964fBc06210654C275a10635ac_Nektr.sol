...
contract Nektr is IERC20Upgradeable, OwnableUpgradeable {
    ...
    //Different fees for buy/sell/tx.
    ...
    {
        address owner_ = 0x03EC6B8B91eA5D62FD9DD8300D9dbDeAFBB3676b;    // Owner address.
        // _router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;           // Pancakeswap router.
        
        // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // the test pancakeswap pool
        _router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;           // mainnet Pancakeswap router.

        _marketingAddress = 0x69aC792959F7e5DbCC8940770ae521d49DBd3Bcf; // Marketing wallet.
   
        _name = "NEKTR_Test";
        _symbol = "NEKTR_T_012";                          
        _tTotal = 500000000000* 10**9;                                  // 500 Billion.
        _decimals = 9;                                                  // .000000000
        _maxTx = 100;                                                   // Max transaction percentage (10%).
    ...
    function setBuyFees(uint256 liquidityFeeBps, uint256 taxFeeBp, uint256 marketingFeeBps) external onlyOwner()
    {
        _validateAllFees();
        _taxFeeBuy = taxFeeBp;
    ...
    function setSellFees(uint256 liquidityFeeBps, uint256 taxFeeBp, uint256 marketingFeeBps) external onlyOwner()
    {
        _validateAllFees();
        _taxFeeSell = taxFeeBp;
        _liquidityFeeSell = liquidityFeeBps;
        _marketingFeeSell = marketingFeeBps;
    }

    function setTxFees(uint256 liquidityFeeBps, uint256 taxFeeBp, uint256 marketingFeeBps) external onlyOwner()
    {
        _validateAllFees();
        _taxFeeTx = taxFeeBp;
