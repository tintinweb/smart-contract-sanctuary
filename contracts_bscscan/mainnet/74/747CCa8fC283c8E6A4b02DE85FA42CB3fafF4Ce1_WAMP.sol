...
contract WAMP is ERC20, Ownable {
    ...
    constructor() public ERC20("Wakanda Empire", "WAMP") {
        ...
        address _bounceFixedSaleWallet = 0x39dE9b5de8240E7FDcb6b047C8607F2299Dc2eB1;
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "WAMP: The router already has that address");
    ...
    function _transfer(
        ...
        if(isFixedSaleBuy) {
            require(block.timestamp >= fixedSaleStartTimestamp, "WAMP: The fixed-sale has not started yet.");
            ...
            if(!openToEveryone) {
                require(fixedSaleEarlyParticipants[to], "WAMP: The fixed-sale is only available to certain participants at the start");
            }
...
contract WAMPDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("WAMP_Dividend_Tracker", "WAMP_Dividend_Tracker") {
    	claimWait = 3600;
