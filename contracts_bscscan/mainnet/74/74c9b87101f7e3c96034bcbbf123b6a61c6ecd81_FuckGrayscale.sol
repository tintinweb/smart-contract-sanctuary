...
FUCK GRAYSCALE is the BIGGEST  BSC token
...
contract FuckGrayscale is Context, IERC20, Ownable {
    ...
    string private _name = "Fuck Grayscale";
    string private _symbol = "FUCK GRAYSCALE";
