...
Auto Paid Every 1 HR
 4% Liquidity 
 1% Marketing 

RealMoonCake  Official Community
🌐Website: http://realmooncake.me/
✅Telegram: tttps://t.me/realmooncake
✅Twitter: twitter.com/Realmoon_cake
*/
...
contract RealMoonCakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("RealMoonCake_Dividend_Tracker", "RealMoonCake_Dividend_Tracker", 9) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1000000 * (10**9); //must hold 10000000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "RealMoonCake_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "RealMoonCake_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RealMoonCake contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "RealMoonCake_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "RealMoonCake_Dividend_Tracker: Cannot update claimWait to same value");
...
contract RealMoonCake is BEP20, Ownable {
    using SafeMath for uint256;

    IPancakeswapV2Router02 public pancakeswapV2Router;
    address public immutable pancakeswapV2Pair;
    address public marketingWallet = 0x4Ca96448Ce4066E58b3ea70668b752fD0310edbF;

    bool private swapping;

    RealMoonCakeDividendTracker public dividendTracker;
    ...
    constructor() public BEP20("RealMoonCake", "RMC", 9) {
        ...
        totalFees = _CakeRewardsFee.add(_liquidityFee).add(_marketingFee);


    	dividendTracker = new RealMoonCakeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "RealMoonCake: The dividend tracker already has that address");

        RealMoonCakeDividendTracker newDividendTracker = RealMoonCakeDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "RealMoonCake: The new dividend tracker must be owned by the RealMoonCake token contract");
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "RealMoonCake: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "RealMoonCake: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "RealMoonCake: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "RealMoonCake: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "RealMoonCake: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "RealMoonCake: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "RealMoonCake: Cannot update gasForProcessing to same value");
