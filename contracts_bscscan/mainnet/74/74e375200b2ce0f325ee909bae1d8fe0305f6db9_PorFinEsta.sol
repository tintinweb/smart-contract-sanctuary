...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x515549e05108A98aA812A9F7cf20ADbA8BbCb22b;
...
contract PorFinEsta is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x983231d6944a23d6afaE7E999Fc0e1CeD122f4b9); 
    address payable private Wallet_Token_Burn = payable(0x1152b48A51adc0951B273373aA78Fa223197536a); 
    address payable private Wallet_Dev = payable(0x515549e05108A98aA812A9F7cf20ADbA8BbCb22b); 
    ...
    string private _name = "PorFinEsta"; 
    string private _symbol = "PorFin";  
