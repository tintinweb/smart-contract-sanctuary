 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/YukiInuToken
 * 
 * 
 * YukiInu token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract YukiInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "YukiInu";
    string constant _symbol = "YUKI";
