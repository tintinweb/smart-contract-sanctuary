...
/**
WE ONLY CREATE SECURE CONTRACTS. YOUR INVESTMENT IS OUR RESPONSIBILITY
    
      Earn ADA Reflective and Rewards with Buy Back
...
contract WINADA is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WINADA";
    string constant _symbol = "WINADA";
