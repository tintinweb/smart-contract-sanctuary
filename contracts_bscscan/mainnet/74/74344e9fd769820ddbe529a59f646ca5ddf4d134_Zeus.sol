...
contract DividendDistributor is IDividendDistributor {
    ...
    address public ZEUS = 0xDAD6d006aB190E536e2d256526d038d67303F577;
...
contract Zeus is IBEP20, Auth {
    ...
    address ZEUS = 0xDAD6d006aB190E536e2d256526d038d67303F577;
    ...
    constructor () Auth(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(ZEUS, address(this));
        _allowances[address(this)][address(router)] = uint256(-1);

        distributor = new DividendDistributor(address(router), 0x8b0E5F2342A509E96e9122e0De86c2976d1ce31A);
