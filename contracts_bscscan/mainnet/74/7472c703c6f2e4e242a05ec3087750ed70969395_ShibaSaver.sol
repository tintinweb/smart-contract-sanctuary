...
// CHANGE
contract ShibaSaver is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaSaver";
    string constant _symbol = "SHSA";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xAd1456E2d796D70bba51cfD02BfA6E5538b0D925);
