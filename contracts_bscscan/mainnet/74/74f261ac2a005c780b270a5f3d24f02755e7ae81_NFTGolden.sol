...
contract NFTGolden is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC8d9fd5DE61653B766767F78d1123c565A461057); // Marketing Address
    ...
    string private _name = "NFT Golden";
    string private _symbol = "NFTGolden";
