...
/**
      ...
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #HachiDog designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name : @MINIBABYINU
       ...
       I will renounce the ownership to burn addresses to transfer #MiniBabyINU to the community, make sure it's 100% safe.
    
       I will add 1 BNB and all the left 10% total supply to the pool
       Can you make #MiniBabyINU 10000X? 
       ...
       it's the best part of the #MiniBabyINU idea, increasing the liquidity pool automatically, 
...
contract HachiDog is Context, IERC20, Ownable {
    ...
    string private _name = "MiniBabyINU";
    string private _symbol = "MBABYINU";
