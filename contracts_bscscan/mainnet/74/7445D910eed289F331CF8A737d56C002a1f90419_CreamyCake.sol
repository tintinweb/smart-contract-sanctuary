...
Tokenomics: 14% REWARDS 7% Tokenomics ( Marketing, Liq)
Earn $CAKE by hodling CreamyCake
https://t.me/creamycakebsc
...
contract CreamyCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CreamyCakeDividendTracker public dividendTracker;
    ...
    constructor(address deployer) ERC20("CreamyCake", "$CREAMY") {
        uint256 _dividendRewardsFee = 14;
        uint256 _tokenomicFee = 7;

        dividendRewardsFee = _dividendRewardsFee;
        tokenomicFee = _tokenomicFee;
        totalFees = _dividendRewardsFee.add(_tokenomicFee);

        dividendTracker = new CreamyCakeDividendTracker();

        dividendLpWallet = 0xD0d48002cb869c93b56fb396174eb13757B82300;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        CreamyCakeDividendTracker newDividendTracker = CreamyCakeDividendTracker(
            payable(newAddress)
        );
...
contract CreamyCakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
