...
contract CatLootPool is Ownable, ReentrancyGuard, IERC721Receiver, ERC721Holder {
    ...
    function currentClaimPrice() public view returns (uint256){
        uint256 decay = (block.number - lastClaimBlock) * multiplier;
        if (decay >= minimumPrice) {
            return minimumPrice * 1e18;
        }
    ...
    function setMultipler(uint256 newMultiplier) public onlyOwner {
    ...
    function setMinimumPrice(uint256 newMinimum) public onlyOwner {
