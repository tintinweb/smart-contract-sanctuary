...
contract BurningMoonDividentNFT is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    ...
    // Token name
    string private _name="MoonX Trailblazer";
    // Token symbol
    string private _symbol="MoonX Trailblazer";
    ...
    address constant TokenAddress=0x053F574B35eB29dEB6817bD8B3f8c848c6aBbe53;//MoonX
    //TestNet
    ...
    function _distributeBNB(uint amount) private{
        ...
        if(amount<=0) return;
            uint256 BMAmount=amount*95/100;
    ...
    function MintTo(address[] memory accounts) public onlyOwner{
    ...
    function _mint(address to) private returns(uint){
