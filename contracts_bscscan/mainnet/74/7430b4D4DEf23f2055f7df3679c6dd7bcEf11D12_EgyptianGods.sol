...
contract EgyptianGods is ERC20, Ownable {
    using SafeMath for uint256;
    uint256 public constant PERCENT_DIVIDER = 10000;

    // Transfer tax rate in basis points. (default 5%)
    uint256 public constant transferTaxRate = 500;
    address constant public feeAddress = address(0xc8C78624A99f7F85A9c6aE665E92b983077A1160);

    //whitelist
    mapping(address => bool) private isWhitelist;

    constructor() ERC20("Egyptian Gods NFT", "EGYPT") {
        _mint(msg.sender, 20000000 * 10 ** decimals());
        isWhitelist[msg.sender] = true;
        isWhitelist[feeAddress] = true;
    }

    /// @dev overrides transfer function to meet Tokenomics of EGYPT
    ...
    function setWhitelist(address Addrss, bool _bool) onlyOwner external {
