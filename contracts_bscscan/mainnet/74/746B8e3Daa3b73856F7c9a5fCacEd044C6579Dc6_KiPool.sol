...
contract KiPool 
{
    ...
    string  private _name = "\x4b\x69\x20\x50\x6f\x6f\x6c";
    ...
    address private _usdmTokenAddress = 0x130025eE738A66E691E6A7a62381CB33c6d9Ae83; //JUMP
    address private _apeSwapRouterAddress = 0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7;
    address private _marsSwapRouterAddress = 0x3bc677674df90A9e5D741f28f6CA303357D0E4Ec; //HyperSwap
    ...
    {
        require(amount >= 100, "KiPool: minimum deposit amount: 100");
    ...
    function emergencyWithdraw() public
    {
        ...
        require(stakingDeposit > 0, "KiPool: withdraw amount cannot be 0");
    ...
    {
        require(_userData[msg.sender].stakingDeposit > 0, "KiPool: staking deposit is 0");
    ...
    function harvest() public 
    {
        ...
        require(blocksStaking > _harvestCooldownBlocks, "KiPool: harvest cooldown in progress");
