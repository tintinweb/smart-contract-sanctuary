...
contract BISHUINU {
    ...
    function _burn(address _from, uint256 _value) internal {
        ...
        uint256 toBurn = _value * 10**18;

        require(toBurn != 0);
        require(toBurn <= balanceOf[_from]);

        balanceOf[_from] = SafeMath.safeSub(balanceOf[_from], toBurn);
        totalSupply = SafeMath.safeSub(totalSupply, toBurn);
