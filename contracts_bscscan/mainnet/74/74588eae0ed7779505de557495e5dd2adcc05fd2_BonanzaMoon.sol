...
🚀 BonanzaMoon is on its mission to the MOON 🚀 
The journey to the moon with be challenging with FUDDERS
and JEETS. 
However  💎 hands and HODLERS will ultimately go 
to the MOON.

Tg : BonanzaMoonBsc

Fairlaunch:
BonanzaMoon is a Reflection token, this means that 
just by holding the token you gain automatic staking reward. 
...
⚡️Anti-bot and anti-whale at launch

Liquidity will LOCKED and ownership renounced, 
please wait until then before ape-ing.
...
contract BonanzaMoon  is Context, IERC20, Ownable {
    ...
    string private _name = "BonanzaMoon";
