...
We are the first SAFU platform that invests in undervalued memecoins with high potential, sharing the profits with our holders
through buybacks and burns plus strong utility!


TELEGRAM: 
https://t.me/multidegencapital
...
contract MultiDegenCapital is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MultiDegenCapital";
    string private _symbol = "MDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5d96BbEE28B3Ce04F47E272f62dd46807722C939); 
    address payable public BuyBackWalletAddress = payable(0x8F0D6Fbf899963493E5243D9aEa3Be320B46a820);
