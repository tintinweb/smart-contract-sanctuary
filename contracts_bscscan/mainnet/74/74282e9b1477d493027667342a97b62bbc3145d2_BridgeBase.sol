...
contract BridgeBase is Context, Ownable {
    ...
    address shih;
    address system = address(0xcbEe3a4cE1725efBAa9c213d1839D5F462A96486);
    address bridgeFeesAddress = address(0xc25Dc58cEAacA1CeD62a0364f0C77e0C3E678990);
    ...
    constructor()  {
        _processedFees[1] = 0.1 ether;
    }
   
   function updateShihContract(address _shih) external onlyOwner {
       shih = _shih;
   }
