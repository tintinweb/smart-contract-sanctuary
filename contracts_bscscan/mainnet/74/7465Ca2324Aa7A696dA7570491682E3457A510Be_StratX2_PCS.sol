...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-CORN staking vault.
    ...
    address public cornDefiAddress;
    address public CORNAddress;
    ...
    address[] public earnedToCORNPath;
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(cornDefiAddress, _wantAmt);
...
contract StratX2_PCS is StratX2 {
    constructor(
        ...
        govAddress = 0xDb0113773a0AD55BA31A4D0d0eD29A64639430ea;
        cornDefiAddress = 0x78c1a7E609852724b43CAc5a1D173da6f0EE6779;
        CORNAddress = 0xba8aeAbca4f1C55973582a7f7D76d61A75e370fA;

        wantAddress = _wantAddress;
        token0Address = CORNAddress;
        token1Address = wbnbAddress;
        earnedAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        lockerAddress = 0x300076e67029d5e97a0CeBDFb371327Fb0bf6D12;
        ...
        earnedToCORNPath = [earnedAddress,wbnbAddress,CORNAddress];
        earnedToToken0Path = [earnedAddress,wbnbAddress,CORNAddress];
        earnedToToken1Path = [earnedAddress,wbnbAddress];
        token0ToEarnedPath = [CORNAddress,wbnbAddress,earnedAddress];
        token1ToEarnedPath = [wbnbAddress,earnedAddress];

        buyBackRate = 4000;

        transferOwnership(cornDefiAddress);
    }
}