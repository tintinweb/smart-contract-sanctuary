...
contract LunarM is ERC20, Ownable {
    ...
    LunarMDividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x69C16a8bf2EFA040174c2649274a4FD4dc9e5956;
    
    uint256 public swapTokensDivisor = 10000;
    ...
    constructor() ERC20("LunarMoon", "LunarM") {

    	dividendTracker = new LunarMDividendTracker();
    ...
    /// @notice Withdraw tokens sent by mistake. Impossible to withdraw LunarM tokens
    /// @param tokenAddress The address of the token to withdraw
    function rescueBEP20Tokens(address tokenAddress) external onlyOwner{
        require(tokenAddress != address(this), "Impossible to withdraw LunarM tokens");
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LunarM: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function setMaxSellDivisor(uint256 newMaxSell) external onlyOwner{
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "LunarM: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "LunarM: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "LunarM: Cannot update gasForProcessing to same value");
   ...
   //////////////////////
    ...
    function getswapTokensDivisor() external view returns(uint256) {
        return (_totalSupply / swapTokensDivisor / 10**9);
    }
   ...
   /**
    ...
    function _transfer(address from, address to, uint256 amount) internal override{
		...
		uint256 swapTokensAtAmount = _totalSupply / swapTokensDivisor;
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        // Send BNB to dividends
        uint256 dividends = unitBalance * 2 * BNBRewardsFee;
        (bool success2,) = address(dividendTracker).call{value: dividends}("");
...
contract LunarMDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()  DividendPayingToken("LunarM_Dividen_Tracker", "LunarM_Dividend_Tracker") {
    	claimWait = 3600;
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "LunarM_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "LunarM_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LunarM contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "LunarM_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "LunarM_Dividend_Tracker: Cannot update claimWait to same value");
