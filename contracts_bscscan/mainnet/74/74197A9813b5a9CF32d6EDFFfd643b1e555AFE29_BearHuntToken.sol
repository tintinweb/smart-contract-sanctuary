...
contract BearHuntToken is Context, IERC20, Ownable {
    ...
    uint256 private constant MAX_EXCLUDED = 10;
    ...
    // 10,000,000,000,000 BHUNT Max tx amount
    ...
    function excludeFromReward(address account) public onlyOwner {
        ...
        require(_excluded.length <= MAX_EXCLUDED, "MAX_EXCLUDED reached");
    ...
    function includeInReward(address account) external onlyOwner {
        require(_isExcluded[account], "Account isn't excluded");
    ...
    function setRouterAndPair(address _router, address _pair) public onlyOwner {
        ...
        require(_pair == pairAddress, "Incorrect pair address");
    ...
    function _takeDev(uint256 tDev, uint256 currentRate) private {
        uint256 rDev = tDev.mul(currentRate);
