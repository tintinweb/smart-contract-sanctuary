...
contract BABYMETASHIBA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Meta Shiba";
    string constant _symbol = "BABYMSHIB";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 1.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x83e1904a9Cb681983C91Cd1e3887F0f3FcEE7a45;
