...
contract SweetyInu is Context, IERC20, Ownable {
    ...
    uint256 private minimumTokensBeforeSwap = 50000 * 10**5 * 10**9; 
    
    address payable public charityAddress = 0x753181ad70AF2F30fD137EC5fAB440D32c10914f; // Charity Address
