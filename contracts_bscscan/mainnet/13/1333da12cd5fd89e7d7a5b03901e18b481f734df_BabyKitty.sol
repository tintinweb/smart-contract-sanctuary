...
contract BabyKitty is Context, IERC20, Ownable {
    ...
    string private _name = "WEB16";
    string private _symbol = "WEB16";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x480743f4c90122364E80bd2549960d1306c93CF6); // Marketing Address
    address payable public teamWalletAddress = payable(0x424C9fae2Da38A4aA7AF314A3035Ba53bc484E5B); // Team Address
