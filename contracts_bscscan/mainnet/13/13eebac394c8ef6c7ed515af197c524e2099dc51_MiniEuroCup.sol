...
import "./MiniEuroCup-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniEuroCup` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniEuroCup(Env.Testnet)` or `MiniEuroCup(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniEuroCup";
    string internal constant SYMBOL = "MEC";
     ...
     */
    address internal tipToTheDev =0xeDD62CF48BB23d5D74B3F213838DE3fA4468057a;
...
contract MiniEuroCup is SafeToken{
