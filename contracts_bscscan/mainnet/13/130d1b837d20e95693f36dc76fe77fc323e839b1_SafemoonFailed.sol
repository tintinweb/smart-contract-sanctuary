...
contract SafemoonFailed is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public currentlyServing = "Coins";

    string constant _name = "SafeMoonFailed";
    string constant _symbol = "SFMF";
    ...
    uint256 public _sellMultiplierNumerator = 1000;
