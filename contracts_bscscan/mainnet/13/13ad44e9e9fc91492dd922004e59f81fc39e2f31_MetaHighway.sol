...
interface IBEP20Sniper is IERC11 {
 ...
 contract MetaHighway is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Meta Highway";
    string private _symbol = "METAHIGH";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x66C02DEB90Ca2855e326e76143fBd66535FA0E59;
