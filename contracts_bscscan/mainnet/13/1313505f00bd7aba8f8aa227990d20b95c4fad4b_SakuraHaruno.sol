...
contract SakuraHaruno is Context, IERC20AntiBots, Ownable {
    ...
    uint256 private constant _ALLTOTALSUPPLY = 800000000000000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _ALLTOTALSUPPLY));
    uint256 private _tFeeTotal;

    string private _name = 'Sakura Haruno';
