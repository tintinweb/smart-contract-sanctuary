...
contract NFTMinter is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    event BusMinted(address indexed user, uint busLevel);
    event PlayerMinted(address indexed user, uint rarity, uint squidEnergy);
    ...
    function buyPlayer() public notContract nonReentrant whenNotPaused {
        ...
        playerNFT.mint(msg.sender, squidEnergy * 1e18, 0, rarity);
        emit PlayerMinted(msg.sender, rarity, squidEnergy * 1e18);
    }
