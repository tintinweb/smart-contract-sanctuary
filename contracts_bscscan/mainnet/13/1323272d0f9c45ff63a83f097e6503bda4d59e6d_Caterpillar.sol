...
contract Caterpillar is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x274aaEe58D0465E4B963CCc67bF73BbeCf4cce90); // Marketing Address
    address payable public charityAddress = payable(0x274aaEe58D0465E4B963CCc67bF73BbeCf4cce90); // Charity/Dev Address
    ...
    string private _name = "Caterpillar Swap"; // nice
