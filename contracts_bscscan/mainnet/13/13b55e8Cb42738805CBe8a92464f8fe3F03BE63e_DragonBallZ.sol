...
/**
   ...
   This is a community token. Telegrams @DragonBallZBSC   Important: The early you create a group that shares the token, the more gain you got.
   ...
   I will renounce the ownership #DragonBallZ to the community, make sure it's 100% safe.

   I will add .5 BNB.
   Can you make #DragonBallZ 10000X? 
   ...
   it's the best part of the #BabyTitans idea, increasing the liquidity pool automatically, 
...
contract DragonBallZ is Context, IERC20, Ownable {
    ...
    string private _name = "DragonBallZ";
    string private _symbol = "DragonBallZ";
