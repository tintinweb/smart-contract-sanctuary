...
Official Telegram group : https://t.me/ProtocolLaunches 
...
import "./PTFDividendTracker.sol";

contract PTF is ERC20, Ownable {
    ...
    PTFDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("Protocol Floki", "PTF") {

    	dividendTracker = new PTFDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "PTF: The dividend tracker already has that address");

        PTFDividendTracker newDividendTracker = PTFDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "PTF: The new dividend tracker must be owned by the Protocol Floki contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "PTF: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "PTF: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PTF: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PTF: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "PTF: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "PTF: Cannot update gasForProcessing to same value");
