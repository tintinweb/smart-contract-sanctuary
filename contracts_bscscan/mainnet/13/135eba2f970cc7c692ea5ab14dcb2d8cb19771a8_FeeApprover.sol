...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        address _dllVaultAddress
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        dllTokenAddress = _DLLAddress;
        WBNBAddress = _WBNBAddress;
        tokenPancakeswapPair = IPancakeswapFactory(address(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73)).getPair(WBNBAddress,dllTokenAddress);
        dllVaultAddress = _dllVaultAddress;
        feePercentX100 = 50;
        paused = false; // We start paused until sync post LGE happens.
    }

    address tokenPancakeswapPair;
    IPancakeswapFactory public PancakeswapFactory;
    address internal WBNBAddress;
    address dllTokenAddress;
    address dllVaultAddress;
    ...
    function setDllVaultAddress(address _dllVaultAddress) public onlyOwner {
        dllVaultAddress = _dllVaultAddress;
    }

    function sync() public {
        uint256 _LPSupplyOfPairTotal = IERC20(tokenPancakeswapPair).totalSupply();
