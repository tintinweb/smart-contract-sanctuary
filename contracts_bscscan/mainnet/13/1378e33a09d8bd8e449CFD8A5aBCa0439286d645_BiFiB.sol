...
contract BEP20TokenImplementationV1 is BSCContext, IBEP20, Initializable {
     ...
     */
    function initialize(string memory name, string memory symbol, uint8 decimals, uint256 amount, bool mintable, address owner) internal initializer {
        _owner = owner;
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
    ...
    */
    ...
    function ownershipAccept() public returns (bool) {
        require(_pendingOwner == _msgSender(), "Ownable: only pending owner");
...
// File: contracts/deploy/BiFiB.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.0;

contract BiFiB is BEP20TokenImplementationV1 {
    constructor() BEP20TokenImplementationV1() {
        ...
        initialize("BiFi BSC", "BiFiB", 18, 0, true, msg.sender);
    }
}