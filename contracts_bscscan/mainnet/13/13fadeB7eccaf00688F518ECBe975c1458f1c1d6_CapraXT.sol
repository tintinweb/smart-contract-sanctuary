...
contract DividendDistributor is IDividendDistributor {
    ...
    function setRewardToken(address rewardToken) public onlyToken {
        RewardToken = IBEP20(rewardToken);
    }
...
contract CapraXT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Capra XT";
    string constant _symbol = "CAPRA";
    ...
    uint256 public _maxTxAmount = _totalSupply.div(1000);
    ...
    function setRewardToken(address rewardToken) public onlyOwner {
        ...
        dividendDistributor.setRewardToken(rewardToken);
    }
