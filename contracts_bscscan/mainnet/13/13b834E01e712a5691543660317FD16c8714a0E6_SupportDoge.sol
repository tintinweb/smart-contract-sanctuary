...
*
 ...
 _____                                    _   ______                     
/  ___|                                  | |  |  _  \                    
\ `--.  _   _  _ __   _ __    ___   _ __ | |_ | | | |  ___    __ _   ___ 
 `--. \| | | || '_ \ | '_ \  / _ \ | '__|| __|| | | | / _ \  / _` | / _ \
/\__/ /| |_| || |_) || |_) || (_) || |   | |_ | |/ / | (_) || (_| ||  __/
\____/  \__,_|| .__/ | .__/  \___/ |_|    \__||___/   \___/  \__, | \___|
              | |    | |                                      __/ |      
              |_|    |_|                                     |___/       

    🎉 https://supportdoge.finance/

Support Doge ($SUPD) Is a decentralized BSC chain cryptocurrency aims
to make this world more professional and fun with instant rewards for holders .
With SD Terminal And SDogeBets the decentralized world will definitely 
be more organized and fun !
...
contract SupportDoge is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "SupportDoge";
    string private _symbol = "Supd";
