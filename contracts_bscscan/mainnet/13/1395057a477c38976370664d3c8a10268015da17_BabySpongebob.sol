...
/**
Hi! BabySpongebob token is here

💥Telegram: https://t.me/dogepunksnft
...
Check out right now, get in while it's still cheap to do so, right before we get to the moon, HODL and enjoy it !
...
🔥 5% Auto burn
📠 4%DogePunksNFT Rewarded every hour
📣 2% LP
✨ Liquidity Burned
...
contract BabySpongebob is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "BabySpongebob";
  string constant tokenSymbol = "BabySpongebob";
