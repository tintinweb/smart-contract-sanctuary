...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7667d80D897d6b79f24383656FB57BAE62e639fe;
...
contract TARZANDOGE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x555b56E6F177626eA3cd5D9b88E78D0140891c1D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TARZANDOGE";
    string private _symbol = "TZD";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 170;
