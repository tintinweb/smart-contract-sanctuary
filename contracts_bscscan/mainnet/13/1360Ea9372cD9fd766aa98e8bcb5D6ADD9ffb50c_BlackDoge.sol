...
contract Ownable is Context {
    address private _owner = 0x0f2A4C9D1879B4ac602595bbE71b9d23f045064f;
...
contract BlackDoge is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Black Doge Token"; // token name
    string private _symbol = "Black Doge"; // token symbol
