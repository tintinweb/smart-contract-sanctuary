...
/**
//‼️Mini BUSD is hyper-deflationary BUSD rewards and community driven token based on binance smart chain network. Earn BUSD in every hour just by holding MiniBUSD in your wallet.‼️

//Tokenomics :
//1,000,000,000 MiniBUSD Supply
//10% BUSD Rewards
//3% LP
//5% Buyback

//Tokenomics thats bound to make miniBUSD moon.
//Early buyers will get insanely rewarded.

/Automatic BUSD Rewards (10%)
...
️Twitter : https://www.twitter.com/miniibusd?
*/
...
contract MINIBUSD is ERC20, Ownable {
    ...
    constructor() ERC20("MINIBUSD", "MINIBUSD") {
    	...
    	buyBackWallet = 0x546D93B7fd8A56782873F2708ac21d6f2F203B77;
    	
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0xC3CAAB84CBf78B5e8073d3CC278CeAd850244a89
    ...
    receive() external payable {
  	...
  	function setSellTransactionMultiplier(uint256 multiplier) external onlyOwner {
  	    require(sellFeeIncreaseFactor >= 100 && sellFeeIncreaseFactor <= 200, "MINIBUSD: Sell transaction multipler must be between 100 (1x) and 200 (2x)");
  	    sellFeeIncreaseFactor = multiplier;
  	}
  	
  	function setMarketingDivisor(uint256 divisor) external onlyOwner {
  	    require(marketingDivisor >= 0 && marketingDivisor <= 100, "MINIBUSD: Marketing divisor must be between 0 (0%) and 100 (100%)");
    ...
    function triggerBuyBack(uint256 amount) public onlyOwner {
        require(!swapping, "MINIBUSD: A swapping process is currently running, wait till that is complete");
    ...
    function updateDividendRewardFee(uint8 newFee) public onlyOwner {
        require(newFee >= 0 && newFee <= 10, "MINIBUSD: Dividend reward tax must be between 0 and 10");
    ...
    function updateBuyBackWallet(address newBuyBackWallet) public onlyOwner {
        require(newBuyBackWallet != buyBackWallet, "MINIBUSD: The liquidity wallet is already this address");
...
contract MINIBUSDDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("MINIBUSD_Dividend_Tracker", "MINIBUSD_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "MINIBUSD_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
