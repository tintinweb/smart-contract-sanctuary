...
Our destination for decentralisation - Crypto Island

Website: https://travcoin.io
TG Global: https://t.me/TravcoinChat


Hold And Play Games TravPlay
*/
...
contract travplay is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xaB1a153820F9328F77426f8e41B649A093250A00); // Marketing Address
    ...
    string private _name = "TTravPlay";
    string private _symbol = "Travplay";
    ...
    uint256 public _maxTxAmount = 1 * 10**15 * 10**12;
    ...
    bool private _whitelisting = true;
