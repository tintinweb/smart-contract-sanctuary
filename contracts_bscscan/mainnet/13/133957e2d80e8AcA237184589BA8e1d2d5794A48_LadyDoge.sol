...
contract LadyDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x56Aa1DAE184483D61e120F53DF4Aae7BCfaEeB84); 
    ...
    string private _symbol = "LadyDoge";
    ...
    uint256 public _maxBuyAmount = 400000000 * 10**6 * 10**9;
    uint256 public _maxJAmount = 40000000 * 10**6 * 10**9;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(to == uniswapV2Pair){
                ...
                if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
                    require(amount <= _maxJAmount, "Transfer amount exceeds the maxTxAmount.");
                }
            }
    ...
    function setMaxJAmount(uint256 maxTxAmount) external onlyOwner {
        _maxJAmount = maxTxAmount;
    }
