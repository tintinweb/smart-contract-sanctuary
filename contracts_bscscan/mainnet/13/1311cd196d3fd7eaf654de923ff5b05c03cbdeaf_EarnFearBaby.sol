...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 Fear = IERC20(0x9Ba6a67a6F3b21705a46B380A1B97373a33da311);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Fear.balanceOf(address(this));
        ...
        uint256 amount = Fear.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Fear.transfer(shareholder, amount);
...
contract EarnFearBaby is IERC20, Ownable {
    using SafeMath for uint256;

    address Fear  = 0x9Ba6a67a6F3b21705a46B380A1B97373a33da311;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "EarnFearBaby";
    string constant _symbol = "EFear";
