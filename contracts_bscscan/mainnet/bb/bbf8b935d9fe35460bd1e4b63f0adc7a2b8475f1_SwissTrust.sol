...
contract SwissTrust is Context, IERC20, Ownable {
    ...
    string private _name = "Swiss Trust";
    ...
    address payable public  marketingWallet = payable(0x31278956708CFee494F00465ee2C0f14ca6cB1d7);
    ...
    constructor() {
        _rOwned[0xb02C5c7Bd9984c8282c290342BC178DCA49600AB] = _rTotal;
        ...
        _isExcludedFromFee[0xb02C5c7Bd9984c8282c290342BC178DCA49600AB] = true;
        _isExcludedFromFee[marketingWallet] = true;
        _isExcludedFromFee[address(this)] = true;
        
        emit Transfer(address(0), 0xb02C5c7Bd9984c8282c290342BC178DCA49600AB, _tTotal);
    }
    ...
    function _transfer(
        ...
        if (
            ...
            // send to marketing
            swapAndAndSendToMarketing(contractTokenBalance);
        }
        
        //transfer amount, it will take tax, burn, marketing
        _tokenTransfer(from,to,amount);
    }

    function swapAndAndSendToMarketing(uint256 contractTokenBalance) private lockTheSwap {
    ...
    function setFeePercent(uint256 taxFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
        _taxFee = taxFee;
