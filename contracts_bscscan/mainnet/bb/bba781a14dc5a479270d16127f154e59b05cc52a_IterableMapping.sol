...
contract RewardDOGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20 ("RewardDOGE", "RewardDOGE") {
        _ETHRewardsFee = 7;
        _liquidityFee = 4;
		_marketingFee = 3;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "RewardDOGE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "RewardDOGE: The liquidity wallet is already this address");
...
contract RewardDOGEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("RewardDOGE_Tracker", "RewardDOGE_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "RewardDOGEDividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RewardDOGE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "RewardDOGE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
