...
//Just launched in HappyChristmas. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//HappyChristmas Hold we will To the moon
//telegram : @HappyChristmasBsc
...
contract HappyChristmas is Context, IERC20, Ownable {
    ...
    string private _name = "HappyChristmas";
    string private _symbol = "HappyChristmas";
