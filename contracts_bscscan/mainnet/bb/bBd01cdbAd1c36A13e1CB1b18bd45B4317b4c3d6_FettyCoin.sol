...
contract FettyCoin is IERC20 {
    ...
    string constant private _name = "FettyCoin";
    string constant private _symbol = "FettyCoin";
    ...
    // SHIBA INU MAINNET TOKEN CONTRACT
    address private SHIBA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing1: payable(0xD32A50215FF92f3033b5c8F30e65D7CaAa3F74F0),
        marketing2: payable(0xBb5968eDD41EE662188a86b40B7026463F900F12),
        buyback: payable(0x6de7E28F0FB61C99c8A48B4B98FAEA00347703f6),
        team: payable(0xaE60e161f5a9D37010409b5d181129508eA7447B),
        development: payable(0x0783ec9c6286C027AF8cd876b00d587348FC58cD)
        });

    uint256 private maxTPercent = 125;
    uint256 private maxTDivisor = 100000;
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing1, uint16 marketing2, uint16 buyback, uint16 team, uint16 development) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.liquidity = liquidity;
        _ratios.marketing1 = marketing1;
        _ratios.marketing2 = marketing2;
        _ratios.buyback = buyback;
        _ratios.team = team;
        _ratios.development = development;
        _ratios.total = rewards + liquidity + marketing1 + marketing2 + buyback + team + development;
    }

    function setWallets(address payable marketing1, address payable marketing2, address payable buyback, address payable team, address payable development) external onlyOwner {
        _taxWallets.marketing1 = payable(marketing1);
        _taxWallets.marketing2 = payable(marketing2);
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        if(address(this).balance > 0){
            _taxWallets.marketing1.transfer(((amountBNB - (amountBNBLiquidity + amountBNBReflection)) * _ratios.marketing1) / (_ratios.total - (_ratios.liquidity + _ratios.rewards)));
            _taxWallets.marketing2.transfer(((amountBNB - (amountBNBLiquidity + amountBNBReflection)) * _ratios.marketing2) / (_ratios.total - (_ratios.liquidity + _ratios.rewards)));
            _taxWallets.buyback.transfer(((amountBNB - (amountBNBLiquidity + amountBNBReflection)) * _ratios.buyback) / (_ratios.total - (_ratios.liquidity + _ratios.rewards)));
            _taxWallets.team.transfer(((amountBNB - (amountBNBLiquidity + amountBNBReflection)) * _ratios.team) / (_ratios.total - (_ratios.liquidity + _ratios.rewards)));
            _taxWallets.development.transfer(address(this).balance);
        }
    }
