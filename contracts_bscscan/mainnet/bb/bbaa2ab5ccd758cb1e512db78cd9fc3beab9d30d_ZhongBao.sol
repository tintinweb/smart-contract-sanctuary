...
contract ZhongBao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ZhongBao";
    string private _symbol = "ZhongBao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x51c47831987637815B7291f8b5F2f5F9aBe5c1eF); // Marketing Address
    address payable public teamWalletAddress = payable(0x6260d25D3a3BaB5096c45e3940536628B0A62Ce7); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1200 * 10**3; 
