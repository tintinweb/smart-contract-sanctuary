...
/*
 ...
 // 4% LIQUIDITY
 // 4% MARKETING 
 //Blocklens is the lens of the blockchain
 // The next multidimensional tokens with passive rewards tokenomics
...
contract Blocklens is IBEP20, Auth {
    ...
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; //4% of total supply 
    ...
    address private marketingFeeReceiver = address(0x95907E8D9c06B4d5c1A1885f07b0cDa2A05167f3);
