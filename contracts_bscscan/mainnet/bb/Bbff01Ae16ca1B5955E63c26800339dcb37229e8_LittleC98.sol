 ...
 *C98 REWARDS
 * 
 * CHECK IN OUR TELEGRAM CHANNEL OUR CONTRACTS SCAMMERS USED OUR CHANNEL TO UPLOADA FAKE CONTRACT
 * 
...
contract LittleC98 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LittleC98";
    string constant _symbol = "L98";
