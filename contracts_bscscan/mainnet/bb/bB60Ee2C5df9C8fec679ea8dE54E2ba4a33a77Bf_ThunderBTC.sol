...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 1 * (10 ** 12); // Reward Token Decimal
...
contract ThunderBTC is IBEP20, Auth {
    ...
    uint256 public _maxWalletToken = 80000000000 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = 200000000 * (10 ** _decimals);
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
