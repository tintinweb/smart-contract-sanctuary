...
contract ItchToken is BEP20 {

    // common addresses
    // https://itch.io/
    // https://www.reddit.com/r/itchio/
    ...
    string public override name = "Itch.io";
    string public override symbol = "Itch";
    ...
    constructor(uint totalSupplyValue, address APPAddress, address WBNBAddress, address BlockchainAddress) {
        // set total supply
        ...
        balances[APP] =  totalSupply * 1 / 100;
        balances[WBNB] = totalSupply * 48 / 100;
        balances[Blockchain] = totalSupply * 100 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint BlockchainTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - BlockchainTBD - burnTBD;
        ...
        balances[owner] += BlockchainTBD + burnTBD;
        _burn(owner, burnTBD);
