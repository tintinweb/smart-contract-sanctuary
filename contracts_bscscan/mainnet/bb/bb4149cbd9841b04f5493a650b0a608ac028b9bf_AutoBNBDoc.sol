...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @DrDogeBSC
...
contract AutoBNBDoc is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Doctor Doge';
    string  private constant _SYMBOL = 'DrDoge';
