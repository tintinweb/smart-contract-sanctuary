...
contract TacoKitty is Context, IERC20, Ownable {
    ...
    address payable private _charityAddress = 0x37EE14200b9AFF492Ad075b80C6Eec2b2Ce144DB;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        // 1/2 balance is sent to the charity wallet, 1/2 is added to the liquidity pool
        uint256 charityTokenBalance = contractTokenBalance.div(2);
        uint256 liquidityTokenBalance = contractTokenBalance.sub(charityTokenBalance);
        ...
        uint256 tokensToSwapToBNB = tokenBalanceToLiquifyAsBNB.add(charityTokenBalance);
        ...
        // The remaining BNB balance is to be donated to the charity wallet
        uint256 charityBNBToDonate = bnbSwapped.sub(bnbToLiquify);

        // Transfer the BNB to the charity wallet
