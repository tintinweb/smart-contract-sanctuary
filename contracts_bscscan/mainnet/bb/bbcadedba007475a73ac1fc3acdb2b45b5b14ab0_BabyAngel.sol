...
contract BabyAngel is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x6670F67c6E88Cb9A74DdB4a21f5Dd762B0000000); // Marketing Address
    ...
    string private _name = "BabyAngel";
    string private _symbol = "BabyAngel";
