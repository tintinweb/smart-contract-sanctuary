...
Why Poo coin? Why not, It has a limited 6,224,790 total supply left as of this date.
Who would have thought Elon Musk have a new favourite. Lfg!
...
contract Poo_Baby is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public swapThreshold = _totalSupply * 0 / 10000; // 0.00% of supply
    bool inSwap;
