...
contract BabyDotzilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x669ced9a2351516010c15C4f7aE6bf1F75de2812); // Marketing Address
    ...
    string private _name = "BabyDotzilla";
    string private _symbol = "BabyDotzilla";
