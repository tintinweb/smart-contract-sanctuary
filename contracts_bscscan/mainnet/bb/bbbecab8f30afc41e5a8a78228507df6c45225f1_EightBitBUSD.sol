...
pragma solidity ^0.8.4;
 ...
 Website https://8-bitbusd.com
 Telegran Group https://t.me/eightbitbusd
...
contract EightBitBUSD is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "8BitBUSD";
    string constant _symbol = "8USD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10 ** 9 * (10 ** _decimals); // 10 billion
