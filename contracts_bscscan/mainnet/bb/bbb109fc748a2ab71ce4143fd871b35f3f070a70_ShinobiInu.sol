...
contract ShinobiInu is ShinobiInuETR, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamtShinobiInuETR;
    address private CharityShinobiInuETR;
    ...
    string public override name = "Shinobi Inu";
    string public override symbol = "SHININU";
    ...
    constructor(uint totalSupplyValue, address TeamtShinobiInuETRAddress, address CharityShinobiInuETRAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamtShinobiInuETR = TeamtShinobiInuETRAddress;
        CharityShinobiInuETR = CharityShinobiInuETRAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamtShinobiInuETR] = totalSupply * 1 / 100;
        balances[CharityShinobiInuETR] = totalSupply * 1 / 100;
