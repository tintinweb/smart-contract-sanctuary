...
/**
   ...
   Welcome to Baby Mana
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyManaToken
...
contract BabyMana is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2ba49c8364460BB24c0bBF3D41447482F1fD503d); // Marketing Address
    ...
    string private _name = "Baby Mana";
