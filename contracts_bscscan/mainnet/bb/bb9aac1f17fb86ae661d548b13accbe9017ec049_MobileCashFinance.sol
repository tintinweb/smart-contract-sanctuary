...
contract MobileCashFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA4f716EF93b2ae744315a5d47ef1EbeECaaB702c); // Marketing Address
    ...
    string private _name = "MobileCashFinance";
