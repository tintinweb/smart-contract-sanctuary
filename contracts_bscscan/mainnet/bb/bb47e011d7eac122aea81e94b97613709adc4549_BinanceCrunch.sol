...
Binance Crunch - $CRUNCH will be fair-launching on Pancakeswap Thursday, August 26 at 1PM EST! 

Binance Crunch is the world's first multi-reflectionary token on the Binance Smart Chain. Earn CAKE, BNB & BUSD by holding $CRUNCH.

Total Supply: 1 Billion CRUNCH
Starting Market Cap: $40,000 
Listing Price: $0.00004
Fair Launch: No Pre-sale & No Team Tokens

Binance Crunch Official links

Website (https://binancecrunch.io/)
Announcements (https://t.me/generalshills)
Instagram (https://www.instagram.com/Binance_crunch)
Telegram (https://t.me/Binance_Crunch)
...
contract BinanceCrunch is Context, IERC20, Ownable {
    ...
    string private _name = "Binance Crunch";
    string private _symbol = "CRUNCH";
    uint256 public _taxFee = 3;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 3;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _toHolder = 9;
    ...
    uint256 private _ProjectX = 0;
    uint256 private _previousProjectX = _ProjectX;
    ...
    address _marketingWallet = 0x6c4fb98B690465D0ef8ca8fE6448E6A71E5523B4;
