...
contract SQUIDDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("SQUID_Dividend_Tracker", "SQUID_Dividend_Tracker") {
        claimWait = 3600;
...
contract SquidGame is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 200 * 10**5 * (10**18);
    ...
    constructor() ERC20("SQUID GAME", "SQUID") {
        BNBRewardsFee = 4;
        liquidityFee = 4;
        extraFeeOnSell = 90; // extra fee on sell
        marketingFee = 1;
        marketingWallet = payable(0x55dCdE516c362d7ABd436Db3B501DD31e94C9180);
