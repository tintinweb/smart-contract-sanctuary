 ...
 *                                   |___/ 
 *
 * Old Baby: a next generation meme token
 * 
 * Created in celebration of Bruno Diferente
 *
 * oldbaby.cc
 *
 * t.me/OldBabyCoin
 *
 * Recommended Slippage - 11-12%
 *
 * 4% Liquidity Tax
 *
 * 3% Marketing Tax
...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    uint256 private MAX = 1000000e18;
...
contract OldBaby is DeflationaryERC20 {

    constructor() DeflationaryERC20("OldBaby", "OLDBABY") {
