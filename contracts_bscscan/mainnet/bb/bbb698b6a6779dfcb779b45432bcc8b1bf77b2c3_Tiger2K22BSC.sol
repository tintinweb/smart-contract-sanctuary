...
contract Tiger2K22BSC is IBEP20, Auth {
    ...
    string constant _name = "Tiger2K22BSC";
    string constant _symbol = "T2B";
    ...
    address private marketingFeeReceiver = 0xE7A4CaA66A38B6fB2435ad5cff5BB16FA415Cfdc;
