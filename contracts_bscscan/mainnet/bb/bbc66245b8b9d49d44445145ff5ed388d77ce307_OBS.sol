...
/**
What is Obsidium?
Obsidium is an ecosystem, serverless, cross-chain, layer-2 solution that
fuel the crypto space with DeFi, AMM & NFTs. It's benefits include
infinite scalability, high throughput sub-second confirmation time, and
fees at a tenth of a cent.

OBSIDIUM MISSION
Facilitate education, research, and continued development of the OBS
Ecosystem to increase understanding of the public benefit of an
incentive driven metaverse ecosystem.
*/
