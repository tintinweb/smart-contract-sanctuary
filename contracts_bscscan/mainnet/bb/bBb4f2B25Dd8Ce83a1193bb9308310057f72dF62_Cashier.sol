...
contract Cashier {
    ...
    address token1 = address(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); // Binance pegged Cardano
    ...
    uint256 public minReflection = 1 * (10 ** 18);
    ...
    function setToken(address token) public onlyToken {
        _token = token;
    }
