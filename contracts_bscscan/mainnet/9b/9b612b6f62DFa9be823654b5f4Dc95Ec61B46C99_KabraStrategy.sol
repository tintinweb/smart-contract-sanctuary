...
// File: contracts/KabraStrategy.sol


pragma solidity 0.6.12;

contract KabraStrategy is Ownable, ReentrancyGuard, Pausable {
    ...
    address public KabraMasterAddress;
    ...
    constructor(
        ...
        KabraMasterAddress = _KabraMasterAddress;
        ...
        transferOwnership(KabraMasterAddress);
    }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(KabraMasterAddress, _wantAmt);
