...
import "../CEtherV0_02.sol";

/**
 * @title Ola's ONativeDelegate Contract
 * @notice OTokens which wrap a native coin underlying and are delegated to
 * @author Ola
 */
contract ONativeDelegateV0_02 is CEtherV0_02, CDelegateInterface {
    /**
...
import "../0.01/CEtherV0_01.sol";

/**
 * @title Ola's CEther Contract V0.02
 * @notice CToken which wraps Ether (Native coin)
 * @author Ola
 * -- Changes form V0.01 : NONE
 */
contract CEtherV0_02 is CEtherV0_01, CEtherStorageV0_02 {}
