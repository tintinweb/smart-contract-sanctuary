...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcbB0daB0e1E7aeECFdcF509c92730f52f1519A6F;
...
contract HUMANOID is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x745175b684D2bCC42485EeE7c3cB3ba8cE9116DC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HUMANOID";
    string private _symbol = "HUMANOID";
