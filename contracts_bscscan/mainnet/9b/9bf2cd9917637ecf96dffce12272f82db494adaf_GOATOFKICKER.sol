...
Telegram : https://t.me/mysterytokenBSC1


Did you miss out on bullish af? Don’t miss on this gem! $TheGoat

Back to the origins! Stop with all of these holders rewards, whale buyback functions and earn with low gains with taxes that go over 15%🤦

$TheGoat just need 10% slippage for liquidity to help with a healthier chart, all of the liquidity will be locked. 

Stealth Launched Liquidity of 3 is provided by the dev in order to make it fair for everyone!

has an amazing team that works hard for a successful coin - We are part of our community and won't let the project behind!

We need a good community support, so we can grow together. The road to success will be easy just because of you! Thank you for being here! ❇️
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function Dead() public virtual onlyOwner {
...
contract GOATOFKICKER is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("GOAT OF KICKER", "TheGoat") {
