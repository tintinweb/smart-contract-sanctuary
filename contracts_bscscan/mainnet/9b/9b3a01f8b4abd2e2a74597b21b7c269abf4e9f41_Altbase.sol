...
contract Altbase is ERC20, Ownable {
    /*
    ...
    */
    ...
    uint128 public minTokensBeforeSwap = 100_000 * 10**18; // 100k mininum
    ...
    ) public ERC20("Altbase", "ALTB") {
        // mint tokens which will initially belong to deployer
        // deployer should go seed the pair with some initial liquidity
        _mint(msg.sender, 935_312_500 * 10**18);
        
        _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);  // kovan uni
    ...
    */
    function _transfer(
        ...
        if(_paused){
            require(_isExcludedFromFee[from], 'Contract currently paused');
        }
