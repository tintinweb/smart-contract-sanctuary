...
/**
       Welcome to #HamburgerShiba 
     .
      
       This is a community token. If you want to create a telegram.
       I suggest by name : https://t.me/HamburgerShiba
       ...
       I will renounce the ownership to burn addresses to transfer #HamburgerShiba to the community, make sure it's 100% safe.
    
       I will add .3 BNB and all the left 10% total supply to the pool
       Can you make #HamburgerShiba 10000X? 
       ...
       it's the best part of the #HamburgerShiba idea, increasing the liquidity pool automatically, 
...
contract HamburgerShiba is Context, IERC20, Ownable {
    ...
    string private _name = "HAMBURGER SHIBA";
    string private _symbol = "HamburgerShiba";
