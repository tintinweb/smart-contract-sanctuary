...
/***** MANY THANKS FROM THE WenDoge TEAM
 WenDoge
******/
...
contract WenDoge is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "WenDoge";
    string private _symbol = "WenDoge";
    ...
    // Innovation for protocol, dapps, and staking by the WenDoge Team!
    ...
    uint256 public _liquidityFee = 15; // 4% will be added pool, 11% will be converted to BNB for a reward
