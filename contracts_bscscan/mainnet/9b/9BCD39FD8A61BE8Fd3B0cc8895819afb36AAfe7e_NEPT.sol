...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x637cb6cf4845D20448B9B592c68CB41cCD6cCFfb;
...
contract NEPT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1DdE61C71F88Aba8A723022010DFf4AE60F787d8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Mechanium";
    string private _symbol = "MECHA";
