...
Hold and you will earn USDT. 

WEBSITE: https://stopviolenceproject.org
TG: https://t.me/SVPgroup

Liquidity Fee = 3%.
Buy back Fee = 3%.
Reflection Fee (USDT FOR HOLDERS) = 6%.
Marketing Fee = 3% (To be used for SVYGOLD)
TOTAL FEES: 15%
*/
...
contract SVYHODL is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SVYHODL";
    string constant _symbol = "SVYHODL";
