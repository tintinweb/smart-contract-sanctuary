...
contract FookAllINUS is Context, IERC20, Ownable {
    ...
    string private _name = "Fook All";
    string private _symbol = "INUs";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1000 * 10**9 * 10**_decimals;
    
    address payable public infinityAddress = payable(0x6c1689f7a5dc34D94Bf2223704a15eb18F69E0a7);
    ...
    constructor () {
        ...
        _liquifyThreshhold = 1000 * 10**9 * 10**_decimals;
        _maxBalance = _totalSupply * 2 / 100;
    ...
    function setInfinityTaxAddr(address payable newInfinityAddress) external onlyOwner() {
    ...
    function setMaxBalPercent(uint256 newMaxBalance) external onlyOwner(){
        // Minimum _maxBalance is 0.5% of _totalSupply 
        require(newMaxBalance >= _totalSupply.mul(5).div(1000));
        _maxBalance = _totalSupply * newMaxBalance /100;
    }
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        // Transfer sold Token to infinityTaxWallet
