...
//Just launched in $AnonimousShiba. We have created a token so rewarding for everyone.
//AnonimousShiba Hold we will Tothemoon
//Tg : t.me/AnonimousShiba
...
contract AnonimousShiba is Context, IERC20, Ownable {
    ...
    string private _name = "ANONIMOUS SHIBA";
    string private _symbol = "AnonimousShiba";
