...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TKO = IBEP20(0x9f589e3eabe42ebC94A44727b3f3531C0c877809);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = TKO.balanceOf(address(this));
        ...
        uint256 amount = TKO.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            TKO.transfer(shareholder, amount);
...
contract BabyTKO is IBEP20, Auth {
    using SafeMath for uint256;

    address TKO = 0x9f589e3eabe42ebC94A44727b3f3531C0c877809;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby TokoCrypto";
    string constant _symbol = "BabyTKO";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xdF72f000444Fe573fC8C85EBcA20a5B40eC5107c;
