...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 10 * _feeBurn);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 10 * _feeBurn);
...
contract aaa is ERC20 {
    ...
    constructor() public ERC20("aaa aa", "aaa") {
