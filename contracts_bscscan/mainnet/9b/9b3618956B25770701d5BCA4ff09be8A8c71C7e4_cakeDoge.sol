...
contract cakeDoge is ERC20, Ownable {
    ...
    constructor() public ERC20("cakeDoge", "cakeDoge") {
...
contract cakeDogeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("cakeDogeDividendTracker", "cakeDogeDividendTracker") {
        claimWait = 3600;
