...
contract CityDoge is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    {        
        ...
        marketingWallet = payable(0x86109DCE8B5eE12BA0fA2a9dc824acd592b68211);
        _maxTxAmount = _tTotal;
        _maxWalletAmount = _tTotal.mul(5).div(100);
        numTokensSellToAddToLiquidity = _tTotal.mul(1).div(1000000);
