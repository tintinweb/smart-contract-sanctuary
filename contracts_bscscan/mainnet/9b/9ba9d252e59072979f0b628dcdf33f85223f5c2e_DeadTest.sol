...
contract DeadTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x4B6b94aC110fcA314069ddfFF1e5f1194e5FDBAF); // Marketing Address
        
    address payable public teamAddress =
        payable(0x2b1f2F465D8C15241558063AbFe80fb2bec34d42); // Team Address
        
    address payable public liquidityAddress =
        payable(0xfaE60784832FAF108b17bCa18fc8F79f09cA2A27); // Liquidity Address
    ...
    string private constant _name = "DeadTest";
