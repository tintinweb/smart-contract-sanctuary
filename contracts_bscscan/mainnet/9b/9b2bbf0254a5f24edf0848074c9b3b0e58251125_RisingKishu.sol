...
contract RisingKishu is Context, IERC20, Ownable {
    ...
    string private _name = "Rising Kishu";
    string private _symbol = "RisingKishu";
    ...
    function _claimNFT(uint256 claimNFT) external onlyOwner() {
        require(claimNFT < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = claimNFT;
    }
}