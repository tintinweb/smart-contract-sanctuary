...
contract ButcherDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xcFF17aa72D29c1b3Bb3B3538C059D4145859EaeD); // Marketing Address
    ...
    string private _name = "ButcherDoge";
