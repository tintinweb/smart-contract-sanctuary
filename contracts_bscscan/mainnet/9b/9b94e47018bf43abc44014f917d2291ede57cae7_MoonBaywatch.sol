...
/**
    ...
    I make this #MoonBaywatch to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/MoonBaywatchBSC
 ...
 * 3) 5% burn tax for constant token burn keeps a high floor price
   ...
   it's the best part of the #MoonBaywatch idea, increasing the liquidity pool automatically, 
...
contract MoonBaywatch is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8AC3b03fED9332CEf2360C4159F44579Fb2c37F8); // Marketing Address
    ...
    string private _name = "MoonBaywatch";
    string private _symbol = "MBW";
