...
PancakeSwap V2
Our JieruShiba links:

web: https://countingdownto.com/countdown-pages/oZhOvW2a
twitter: @JieruShiba
TG: @JieruShibaChat


   I make this #JieruShiba to hand over it to the community.
...
contract JieruShiba is Context, IERC20, Ownable {
    ...
    address private _donationWalletAddress = 0x4E6c4f9c1a098d31840350aeFc6fc5c59Dfea1a1;
    ...
    string private _name = "JieruShiba";
    ...
    uint256 public _maxTxAmount = 900000000000 * 10**6 * 10**9;
