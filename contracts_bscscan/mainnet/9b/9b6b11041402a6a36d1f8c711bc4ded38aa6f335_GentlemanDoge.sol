...
contract GentlemanDoge is Context, IERC20, Ownable {
    ...
    address private _marketingAddress = 0xbc9473Aa7feBb0B9B8236919e5660c4Cb5019F9f;
    address private _burnAddress = 0x0000000000000000000000000000000000000000;

    string private _name = "Gentleman Doge";
    string private _symbol = "GMD";
    ...
    uint256 public _maxTxAmount = 500000000 * 10**5 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 50000000 * 10**5 * 10**9;
    ...
    function deliver(uint256 tAmount) public {
        ...
        (uint256 rAmount,,) = _getRValues(tAmount, tFee, tLiquidity, tMarketing, tBurn, _getRate());
    ...
    function reflectionFromToken(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
        ...
        (,uint256 tFee, uint256 tLiquidity, uint256 tMarketing, uint256 tBurn) = _getTValues(tAmount);
        (uint256 rAmount, uint256 rTransferAmount,) = _getRValues(tAmount, tFee, tLiquidity, tMarketing, tBurn, _getRate());
