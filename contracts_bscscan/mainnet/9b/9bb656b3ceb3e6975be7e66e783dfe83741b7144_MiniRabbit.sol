...
*                     (\_/)
                     ...
                     / >🚀                                                                                                            
*
*    Telegram: @minirabbitofficial
* 
*    MiniRabbit token features:
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // for accounts without code, i.e. `keccak256('')`A
        bytes32 codehash;
...
contract MiniRabbit is Context, IERC20, Ownable {
    ...
    string private _name = "MiniRabbit";
