...
/**
--------WELCOME to MetaHypeBUSD
--------Website TBA
--------Telegram https://t.me/MetaHypeBUSD
--------4% BUSD Rewards
--------4% Liqudity
--------4% Marketing

    All LP Tokens sent to burn adress.
*/
...
contract MetaHypeBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x42AC27b5E4fbAa732873f409f3427E56CF3421f1;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "MetaHypeBUSD";
    string constant _symbol = "MHB";
