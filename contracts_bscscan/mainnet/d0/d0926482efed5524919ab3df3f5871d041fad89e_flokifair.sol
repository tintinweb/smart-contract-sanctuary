...
contract flokifair is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public fairburnaddress = payable( 0x000000000000000000000000000000000000dEaD); // Fairburn Address
    ...
    string private _name = "flokifair";
    ...
    uint256 public fairburnDivisor = 3;
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // Send to Fairburn address
        transferToAddressETH(fairburnaddress, transferredBalance.mul(fairburnDivisor).div(100));
    ...
    function setfairburnaddress(address _fairburnaddress) external onlyOwner {
        fairburnaddress = payable(_fairburnaddress);
    }
