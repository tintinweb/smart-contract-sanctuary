...
MINT is the native governance token of the Mintea ecosystem

Mintea is the first fully-featured cross-chain NFT platform that allows creators to mint NFTs in minutes,
auction them or raise liquidity so that they may be traded via in-game marketplaces or on AMMs such as
PancakeSwap and Uniswap.
Mintea is empowering both digital creators and collectors with next-gen tools and services to introduce
digital art and NFTs to the mainstream collector audience.

The Mintea Marketplace, featuring exclusive artist drops,
offers collectors the opportunity to discover and invest in works
by emerging and established creative talent.
1. Participate in vote and governance
2. You will be able to stake MINT and earn rewards.
3. Earn trading fees from provided liquidity on DEXes.
4. Crosschain token on ETH and Polygon and Solana
5. Trade MINT without price impact.

Website  : https://www.mintea.app
Telegram : https://t.me/MinteaOfficial
Twitter  : https://twitter.com/MinteaOfficial

Copyright (c) 2021 MINTEA.APP
...
contract MINTEA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF115a15057cCf06D3Fa4b52d4e87A4d7986A15FD); // Marketing Address
    ...
    uint256 private _sellTaxFee = 7;
    uint256 private _sellLiquidityFee = 11;
