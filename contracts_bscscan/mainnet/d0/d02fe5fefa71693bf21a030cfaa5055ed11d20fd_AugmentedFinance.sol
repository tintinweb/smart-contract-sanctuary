...
contract AugmentedFinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FanDome";
    string constant _symbol = "FanDome";
    ...
    uint256 public _maxTxAmount = rSupply.div(100).mul(15);
    uint256 public _maxWalletToken = rSupply.div(100).mul(10);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x5a3356BBEa207DDC79E2c12FEd7F66d1fCA324c9;
        marketingFeeReceiver = 0xf83fA36C2305C2320892a19B115a7F45F42392aA;
        devFeeReceiver = 0x5a3356BBEa207DDC79E2c12FEd7F66d1fCA324c9;
