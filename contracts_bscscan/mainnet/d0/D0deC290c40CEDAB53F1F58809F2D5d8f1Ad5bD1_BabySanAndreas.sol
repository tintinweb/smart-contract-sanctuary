...
/**
 *  Telegram : https://t.me/babysanandreas1
 * 
 * BabySanAndreas it's a BSC Token that will create history for CITY Related Tokens! BabyLondon reached 5MIL Mcap in less than 2 days!
 * 
 * 
 * I will DOXX on LIVE VIDEO SESSION on the TG after 10K MCAP!
 * 
 *  Checkout the TG group for more!
 * 
 *  
 *  
 * 
...
contract BabySanAndreas is Context, IERC20, Ownable {
    ...
    string private _name = "BabySanAndreas";
    string private _symbol = "BabySanAndreas";
