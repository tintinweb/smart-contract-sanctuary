...
contract BlazeBurger is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Blaze burger";
    string constant _symbol = "Btoken";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply = 200000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 200; //1.5% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 2) / 100; //1.5% of total supply
    ...
    function swapBack() internal swapping {
        ...
        uint256 burnAmt = amountBNB.mul(_burnFee).div(totalBNBFee);
