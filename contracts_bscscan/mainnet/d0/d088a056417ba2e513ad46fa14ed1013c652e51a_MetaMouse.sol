...
contract MetaMouse is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "MetaMouse";                                          // name
    string private _symbol = "MOUS";                                             // symbol
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "MetaMouse is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "MetaMouse is not live yet");
