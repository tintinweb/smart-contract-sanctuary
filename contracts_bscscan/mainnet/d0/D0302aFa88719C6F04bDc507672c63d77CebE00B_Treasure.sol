...
contract Treasure is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "Treasure";
    string constant public symbol = "Treasure";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 30, "Treasure: transaction fee percentage exceeds 30");
        require(feePercentage_ >= 0, "Treasure: transaction fee percentage equals 0");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "Treasure: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "Treasure: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "Treasure: transfer called from blacklisted address");
