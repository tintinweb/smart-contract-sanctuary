...
/**
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to creat SHOD designed.
   ...
   it's the best part of the #SHOD idea, increasing the liquidity pool automatically, 
...
contract CryptoShod is Context, IERC20, Ownable {
    ...
    string private _name = "CryptoShod";
    string private _symbol = "SHOD";
