...
CryptoTrustData
Crypto TrustData is a platform that has the ability to collect and analyze data based on blockchain technology.
In this application, users remain completely anonymous and obtain CTD by doing surveys analysis and bussiness requirements.
Only tell us you gender, age and location and we will show you the surveys available for you.

With CTD transform your data into profit
By analyzing the data, you have the possibility of obtaining benefits and ensuring that your company can maximize its results,
achieving substantial growth with this analysis.

https://cryptotrustdata.com/
https://t.me/CryptoTrustData
*/
...
contract cryptotrustdata is Context, IERC20, Ownable {
    ...
    address _marketingWallet = 0xaC890e4311B9bB3a36955EdD28B12eD5D806ec7c;
