...
contract BnbFan2k22 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x5d1cd19b8119188d8d2E816642d3d489024E3294); // Marketing Address
        
    address payable public teamAddress =
        payable(0xC224Bc3EC2D9dF33CeC52e52c8cFC2BffAA0201c); // Team Address
    ...
    string private constant _name = "BnbFan2k22";
    string private constant _symbol = "BnbFan2k22";
    
    uint8 private constant _decimals = 18;
    
    uint256 private constant BUY = 15;
    uint256 private constant SELL = 15;
