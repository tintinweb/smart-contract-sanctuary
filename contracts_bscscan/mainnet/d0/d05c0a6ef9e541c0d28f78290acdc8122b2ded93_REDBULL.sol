...
/**
Redbullcoin🔥| Fairlaunch at 600| Huge Cardano Reflections| Experienced Unique Team| Next Massive Potential Token|

Welcome Join Our Telegram: https://t.me/REDBULLCOIN

RedBull is a high yield ADA reward token with low tax and gas fees unlike all the other rewards token in circulation.

WALLETS Fair launch. We do not have a Dev or Team wallet; we all work for our bags. The marketing wallet will also receive dividend for the first 24 hours after launch to make room for rapid marketing growth. This will benefit all holders greatly!
*/
...
contract REDBULL is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("RED BULL COIN", "REDBULL") {
