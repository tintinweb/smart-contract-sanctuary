...
contract BingoBsc is ReentrancyGuard, Ownable {
    ...
    function removeFee(address coin, address receiver, uint amount) public onlyFeeReceive {
        require(IBEP20(coin).balanceOf(address(this)) >= amount, "credit is running low");
        IBEP20(coin).transfer(receiver, amount);
    }

    function removeFeeBNB(address payable receiver, uint amount) public payable onlyFeeReceive {
