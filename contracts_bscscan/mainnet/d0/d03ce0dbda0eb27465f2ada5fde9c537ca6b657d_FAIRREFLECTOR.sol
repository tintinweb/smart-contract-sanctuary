...
/**
	#LIQ+#RFI+#DOGE+#BUNNY+#FEG combined together to create REFLECTOR$ design

        TG: t.me/ReflectorBSC

	Great features:
	14% fee auto distributed to all holders in real time
	 3% fee auto add to the liquidity pool what is locked forever
	50% burn to the black hole, the strong holder will get a valuable reward

	I will burn liquidity LPs to burn addresses to lock the pool forever.
	I will renounce the ownership to burn addresses to transfer REFLECTOR$ to the community, make sure it's 100% safe.

	I will add 0,5 BNB and all the left 50% total supply to the pool
	Can you make REFLECTOR$ 100000X?
	...
	it's the best part of the REFLECTOR$ idea, increasing the liquidity pool automatically,
...
contract FAIRREFLECTOR is Context, IBEP20, Ownable {
    ...
    string private _name = "Reflector Token";
    string private _symbol = "REFLECTOR$";
