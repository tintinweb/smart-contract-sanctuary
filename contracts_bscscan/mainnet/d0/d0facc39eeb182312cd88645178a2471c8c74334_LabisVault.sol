...
interface IMasterChef {
    ...
    function pendingLabis(uint256 _pid, address _user) external view returns (uint256);
...
// File: contracts/LabisVault.sol

pragma solidity 0.6.12;

contract LabisVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingLabis(0, address(this));
