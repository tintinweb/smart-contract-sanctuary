...
/**
STEALTH LAUNCH - SQUID GAME BUSD

ADD ADDRESS BUSD ON YOUR WALLET 0xe9e7cea3dedca5984780bafc599bd69add087d56

It's called SQUIDGAMEBUSD and it automatically reflects BUSD right into your wallet

Their is an AUTO buyback mechanism which buyback SQUIDGAMEBUSD with each and every transaction constantly raising the price floor!
...
contract SQUIDGAMEBUSD is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "SQUID GAME BUSD";
    string constant _symbol = "SGBUSD";
    ...
    uint256 private swapThreshold = _totalSupply / 5000; // 0.02%
    bool inSwap;
