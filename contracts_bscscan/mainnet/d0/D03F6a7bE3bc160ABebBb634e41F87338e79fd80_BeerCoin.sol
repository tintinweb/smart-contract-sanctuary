...
/**
 ...
 ______   _______  _______  _______  _______  _______ _________ _       
(  ___ \ (  ____ \(  ____ \(  ____ )(  ____ \(  ___  )\__   __/( (    /|
| (   ) )| (    \/| (    \/| (    )|| (    \/| (   ) |   ) (   |  \  ( |
| (__/ / | (__    | (__    | (____)|| |      | |   | |   | |   |   \ | |
|  __ (  |  __)   |  __)   |     __)| |      | |   | |   | |   | (\ \) |
| (  \ \ | (      | (      | (\ (   | |      | |   | |   | |   | | \   |
| )___) )| (____/\| (____/\| ) \ \__| (____/\| (___) |___) (___| )  \  |
|/ \___/ (_______/(_______/|/   \__/(_______/(_______)\_______/|/    )_)
...
4% - BeerCoin reward pool
5% - Liquidity fee 
2%  - Marketing + buyback functions
11% - Total fees.


 I make this #BeerCoin to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BeerCoin_BSC
...
contract BeerCoin is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "🍻BeerCoin";
  string private _name = "BeerCoin";
