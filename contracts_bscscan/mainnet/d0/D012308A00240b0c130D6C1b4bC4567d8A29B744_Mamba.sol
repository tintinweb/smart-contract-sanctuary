...
contract Mamba is Context, IERC20, Ownable {
    ...
    string private _name = "MAMBA Trial 1";
    string private _symbol = "MMBT1";
    ...
    constructor() public {
        ...
        marketingWallet = 0xC9ba000Ac46bec8aADD8caCd066207e0aE3dDDff;
        ...
        )
    {
        ...
        uint256 tMarketFee = 0;
        if (tFee > 0) {
            tMarketFee = calculateMarketFee(tAmount);
        }
        uint256 tLiquidity = calculateLiquidityFee(tAmount);
        uint256 tTransferAmount = tAmount.sub(tFee).sub(tLiquidity).sub(
            tMarketFee
        );
        return (tTransferAmount, tFee, tLiquidity, tMarketFee);
    }
        ...
        )
    {
        ...
        uint256 rMarketFee = 0;
        if (rFee > 0) {
            rMarketFee = tMarketFee.mul(currentRate);
        }
