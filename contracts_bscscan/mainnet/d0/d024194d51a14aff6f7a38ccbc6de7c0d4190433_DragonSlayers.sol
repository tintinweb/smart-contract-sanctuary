...
// File: contracts\Dragon Slayers

contract DragonSlayers is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "Dragon Slayers";
	string private constant _symbol = "DSL";
	...
	// CHARITY
	address payable private constant _charityAddress = payable(0xE48E0a95564CDa7625aFF09b2f23c5C0BDA0e07B); // A percentage of the BNB pool will go to the charity address
	...
	// BUYBACK
	address payable private constant _buybackAddress = payable(0xae3A6bAd4Eb25DCC1F5A1162d16eA81922029C9d); // A percentage of the BNB pool will go to the charity address
