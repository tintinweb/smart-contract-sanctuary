...
abstract contract BEP20e is OwnerRole, MinterRole, OperatorRole {
    ...
    uint256 public antiWhaleTxAmountRate = 100; // 1%
...
contract ERIKToken is BEP20e {
    constructor(address _router, IReferral _referral) public BEP20e('ERIK', 'ERIK', _router, _referral) {
