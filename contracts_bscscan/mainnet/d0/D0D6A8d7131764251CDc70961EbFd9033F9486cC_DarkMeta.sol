...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC26FAa36031513D844bAde53003666F8F194787B;
...
contract DarkMeta is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x62f09DCe5e4c3bB415da53F7fAfE6f0c45976235;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DarkMeta";
    string private _symbol = "DKMT";
