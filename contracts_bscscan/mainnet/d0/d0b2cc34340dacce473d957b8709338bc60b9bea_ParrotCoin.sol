...
contract ParrotCoin is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x101a9d8b862C227bb2ad356c58a0C67C6558Cbb1); // Marketing Address
    address payable public charityAddress = payable(0x101a9d8b862C227bb2ad356c58a0C67C6558Cbb1); // Charity/Dev Address
    ...
    string private _name = "Parrot Coin";  // nice
    string private _symbol = "PARR";
