...
Moon with KUMA2K22
Hold KUMA to make KUMA in the year of KUMA

Lets KUMA.

Join us: https://t.me/+4oJbnFv1C4FjOTMx
...
contract KUMA2K22 is IBEP20, Ownable {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "KUMA2K22";
    string constant _symbol = "KUMA2K22";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 2022*10**_decimals; 

    uint256 public _maxTxAmount = _totalSupply.div(1000).mul(20);
    uint256 public _maxSellTxAmount = _totalSupply.div(1000).mul(10);
