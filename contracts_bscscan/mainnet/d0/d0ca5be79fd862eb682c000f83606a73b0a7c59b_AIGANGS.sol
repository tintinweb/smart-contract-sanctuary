...
contract AIGANGS is ERC721Enumerable, ReentrancyGuard, Ownable {
    //insert stuff here

    using Strings for uint256;

    uint public minted = 0;
    uint public constant max_mintable = 6220;
    uint256 public LATEST_CLAIMED_ID;
    uint public chestLoot = 5000000000000000000000 wei; //5000 KAI
    uint public claimPrice = 999000000000000000000 wei; //1000 KAI

    address public AIGANGToken = address(0);
    ...
    string base_uri = "https://dpaint.eyeq.tech/art/";
    ...
    function burn(uint256 tokenId) public virtual {
        ...
        if (tokenId % 55==0){
            ...
            MyToken(AIGANGToken).mint(_msgSender(), 5000000000000000000); // 5 AIGANG
        }
    }
   ...
   function getBalance() external view returns(uint){
    ...
    constructor() ERC721("AIGANGS", "AIGANGS") Ownable() {}
}
