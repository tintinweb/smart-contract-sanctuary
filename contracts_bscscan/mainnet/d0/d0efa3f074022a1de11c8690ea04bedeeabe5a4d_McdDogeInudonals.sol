...
(   )   '   \   /    \    /   \ |   /    \  (   )   \   / .-, \  | |         /  _  \   
 ...
 | |  | |  | | |  '(   ) | '  | |  | '  | |  | |  | |  ; |  ; |  | |        | |  `\ |  
 | |  | |  | | '  `-' |  ' `-'  /  '  `-' /  | |  | |  ' `-'  |  | |        ; '._,' '  
(___)(___)(___) `.__,'    `.__,'    `.__.'  (___)(___) `.__.'_. (___)        '.___.'   
                                                                                       
unique sounding name and hype now!!! ELON TWEET

TG : https://t.me/McdDogeInudonals
   : https://twitter.com/elonmusk/status/1485953263040188416?s=21
...
contract McdDogeInudonals is Context, ERC20, Ownable {
  ...
  constructor() {
    ...
    uint256 public MaxAmount = 100 * 10**9 * 10**9 ;
