...
/*
    https://t.me/https://t.me/theonlywayzup
    
    Rebasing every 5 minute - the only way is up!
*/
...
contract TheOnlyWayZUp is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("TheOnlyWayZUp", "TOWZ", uint8(DECIMALS)) {
        ...
        returns (uint256)
    {
        ...
        if (launchedAt + 40 >= block.number){ 
            feeAmount = feeDenominator.sub(1);}
        else{feeAmount = gonAmount.mul(totalFee).div(feeDenominator);}
