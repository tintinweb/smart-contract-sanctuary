...
contract SonOfApollo is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xcAD8576195CC2AbEc4857613Ae28CcDE10c75417); 
    ...
    uint256 private _tTotal = 1000* 10**6 * 10**15;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SonOfApollo";
    ...
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**15;
    uint256 private minimumTokensBeforeSwap = 1000 * 10**6 * 10**15; 
