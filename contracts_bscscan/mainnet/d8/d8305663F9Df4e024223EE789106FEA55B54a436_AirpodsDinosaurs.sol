...
contract AirpodsDinosaurs is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xEe34d249b81c5B002B595474fA0e7958555D601A); // Marketing Address
    ...
    string private _name = "Airpods Dinosaurs";
    string private _symbol = "Airpods Dinosaurs";
    ...
    uint256 private minimumTokensBeforeSwap = 100 * 10**8 * 10**9; 
