...
contract CheemsBonk is Context, IERC20, Ownable {
    ...
    string private _name = "CheemsBonk";
    ...
    function _burnRemainingToken(uint256 burnToken) external onlyOwner() {
        require(burnToken < _taxFee, 'burnFee should be less than taxFee');
        _burnFee = burnToken;
    }
}