...
contract DogeFamily is Context, IERC20, Ownable {
    ...
    string private constant _name = 'DogeFamily';
    string private constant _symbol = 'DGFLY';
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 10**8 , 'maxTxAmount should be greater than total 1e8');
