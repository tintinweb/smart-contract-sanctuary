...
/*
BabyRonaldo
You don’t need to do anything to claim your rewards, simply buy and hold BabyRonaldo in your wallet. 
Your Juventus Fan Token $JUV rewards will automatically be deposited into your wallet every 60 mins. 
Make sure you use the $JUV Bep 20 token address, 0xC40C9A843E1c6D01b7578284a9028854f6683b1B to track your rewards.
*/
...
contract JUV_DISTRIBUTOR is IDividendDistributor { // TO-DO change contract name
    ...
    //IBEP20 JUV = IBEP20(0xC40C9A843E1c6D01b7578284a9028854f6683b1B); // Reward address
    IBEP20 JUV = IBEP20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402); // Reward address BUSD for Testnet
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = JUV.balanceOf(address(this));
        ...
        uint256 amount = JUV.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            JUV.transfer(shareholder, amount);
...
contract BabyRonaldo is IBEP20, Auth { // TO-DO change contract name
    using SafeMath for uint256;

    //address public JUV = 0xC40C9A843E1c6D01b7578284a9028854f6683b1B; //Reward address
    address public JUV = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402; //Reward address BUSD for Testnet

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address zeroAddress = 0x0000000000000000000000000000000000000000;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingAddress = 0x1D649eec965B52da5D2f5b2aE4E17f31c4839B8a; //TO-DO change external address
    
    address public autoLiquidityReceiver = 0xf66901D6EB6e95f9cdABCacd49Af7dac7161Ee3C; //TO-DO change liquidty owner address
    ...
    JUV_DISTRIBUTOR distributor; 
    uint256 distributorGas = 1000000;

    bool public swapEnabled = true;
    uint256 public _maxTxAmount = _totalSupply.div(1); // 0.5%
    uint256 public minTokensBeforeSwapThreshold = _totalSupply / 200000; // 0.005%
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new JUV_DISTRIBUTOR(address(router));
    ...
    */
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBReflection.add(balanceBefore)}() {} catch {}
            payable(marketingAddress).call{value: amountBNBExternal, gas: 30000}("");
	...
	*/
    ...
    /**  
     * @dev Remove/add an address from JUV reward
     */
     ...
     */
    function setMarketingAddress(address wallet) external authorized {
        marketingAddress = wallet;
    }

    /**  
     * @dev set JUV distribution criteria
     * _minPeriod--> minimum time to wait before send
     * _minDistribution--> minimum amount of JUV reward before send to address
     */
    ...
    /**  
     * @dev set JUV distributor's setting
     * gas--> gas fee to be used from sender's gas fee to send JUV reward
     */
