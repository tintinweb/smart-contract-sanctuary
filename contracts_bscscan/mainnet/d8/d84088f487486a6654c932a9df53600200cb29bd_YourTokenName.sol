...
contract YourTokenName is IBEP20, Ownable
{
    ...
    string private constant _name = "DemonDoge";
    string private constant _symbol = "DMDO";
    ...
    function changeTaxfee(uint8 buyTax, uint8 sellTax) public onlyOwner{
        _buyTax=buyTax;
        _sellTax=sellTax;
    }
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function SetupEnableRewards() public onlyOwner{
        tradingEnabled=true;
    }

    function SetupDisableRewards() public onlyOwner{
