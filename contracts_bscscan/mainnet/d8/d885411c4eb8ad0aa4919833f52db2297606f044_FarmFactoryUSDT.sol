...
/**
 ...
 ^   2) Contribute to the contract with at least the minimum amount of usdt required + Blockchain Fees
 ...
 ^   - Minimum deposit: 10 usdt, 200000 usdt max deposit per wallet due for anti ANTI_WHALE protection
...
contract FarmFactoryUSDT is Context, Ownable {
    using SafeMath for uint256;

    address usdt = 0x55d398326f99059fF775485246999027B3197955;
    IBEP20 token;

    uint256 public constant INVEST_MIN_AMOUNT = 1 ether;// 1 usdt
    ...
    uint256 public constant ANTI_WHALE = 200000 ether;// 200000 usdt
    ...
    function invest(address referrer, uint8 plan, uint256 _amount) public payable {
      ...
      require(totalDeposits < ANTI_WHALE, "Deposit limit reached (200,000 usdt)");
