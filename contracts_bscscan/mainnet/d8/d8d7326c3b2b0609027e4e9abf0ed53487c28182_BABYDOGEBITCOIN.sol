...
/**
💥 BABY DOGE BITCOIN TOKENOMICS 💥

Total supply: 100,000,000,000
Slippage: Buy: 14-20 | Sell: 14-20

💰 Chainism: Dividend
💰 Huge amount of reflection (10%) auto claim in your wallet every 1 hour
💰 3% fees allocated for Marketing
🎗 2% to Liquidity
❌ Anti whales & Anti bots

WHALE PREVENTION
- maxBuyPerTransactionAmount = 500,000,000 = 0.5%
- maxWalletToken = 2,000,000,000 = 2%

BOT PREVENTION
- No sniper bot can buy this token. 
- And if anyone use bot to buy, they will lose all their BNB.

MINIMUM HOLD
- I recommend holding at least 10,000 $BDBTC tokens to see rewards

WHITELIST
- Whitelisted people only can buy max wallet of 250,000,000 = 0.25% at whitelist time (Don't try to buy more or you just waste your gas fee)
- This to prevent whitelisted people buy too much and then dump on Public Launch. We really do not want it happen. They still need to buy on public if they want to get max wallet
...
contract BABYDOGEBITCOIN is Context, IERC20, IERC20Metadata, Ownable {   
