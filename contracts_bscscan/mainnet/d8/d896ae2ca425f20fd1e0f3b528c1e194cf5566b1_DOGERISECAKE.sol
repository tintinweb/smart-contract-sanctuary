...
// CHANGE
contract DOGERISECAKE is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeRiseCake";
    string constant _symbol = "DOGCE";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x2c1032446EdFE988a6f4Fd1E7292C5926dF5A7EC);
