...
interface Strategy {
    ...
    function harvest() payable external;
...
contract Controller {
    ...
    event GovernorUpdate(address indexed previousGovernor, address indexed newGovernor);
    ...
    event StrategyApproved(address indexed token, address indexed strategy);
    event StrategyRevoked(address indexed token, address indexed strategy);
    event StrategyAdded(address indexed token, address indexed strategy);
    event AllWithdrwal(address indexed token);
    event TokenStuckEvent(address indexed token, uint amount);
    event StrategyTokenStuckEvent(address indexed strategy, address indexed token);
    event WithdrawStrategyToken(address indexed token, uint indexed amount);
    event EarnToken(address indexed token, uint indexed amount);
    ...
    function setGovernance(address _governance) external {
        ...
        address previousGovernor = governance;
        governance = _governance;
        
        emit GovernorUpdate(previousGovernor, _governance);
    }
    ...
    function approveStrategy(address _token, address _strategy) external {
        ...
        emit StrategyApproved(_token, _strategy);
    }
    ...
    function revokeStrategy(address _token, address _strategy) external {
        ...
        emit StrategyRevoked(_token, _strategy);
    }
    ...
    function harvest2(address _token)public{
        address _strategy = strategies[_token];
        Strategy(_strategy).harvest2();
    }
    ...
    function inCaseTokensGetStuck(address _token, uint _amount) external {
        ...
        emit TokenStuckEvent(_token, _amount);
    }
    ...
    function inCaseStrategyTokenGetStuck(address _strategy, address _token) external {
        ...
        emit StrategyTokenStuckEvent(_strategy, _token);
    }
    ...
    function withdraw(address _token, uint _amount) external {
        ...
        emit WithdrawStrategyToken(_token, _amount);
    }
