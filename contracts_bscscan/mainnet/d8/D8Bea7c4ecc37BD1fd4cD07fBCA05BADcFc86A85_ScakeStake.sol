...
//    IBEP20 cake = IBEP20(0xB7f8BC63BbcaD18155201308C8f3540b07f84F5e);
    ...
    function enterStaking(uint256 amount) external whenNotPaused {
        ...
        if (address(tokenPool.stakingToken) == address(sCake)) {
            ...
            if (!lockerExists) {
                ...
                locker = new ReflectionLocker02(msg.sender, sCake, sCake.distributorAddress(), address(cake));
                ...
                sCake.setIsFeeExempt(lockerAdd, true);
    ...
    function emergencyWithdraw() external {
        if (address(tokenPool.stakingToken) == address(sCake)) {
            ...
            sCake.transfer(msg.sender, amtClaimed);
        } else {
            tokenPool.stakingToken.transfer(msg.sender, shares[msg.sender].amount);
        }
        removeShareHolder();
