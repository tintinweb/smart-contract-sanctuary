...
contract TwoDogsOneBowl is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2b1460427a5d333E23C32bA397Eb2B7bc2bCa57B); // Marketing Address
    ...
    string private _name = "2Dogs1Bowl";
    string private _symbol = "2D1B";
