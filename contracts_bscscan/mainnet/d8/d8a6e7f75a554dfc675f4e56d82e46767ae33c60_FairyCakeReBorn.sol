...
contract FairyCakeReBorn is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FairyCakeRB";
    string constant _symbol = "FCAKER";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x48A7f24b5b296f69d6186cDaE17D69116eaF92AC;
