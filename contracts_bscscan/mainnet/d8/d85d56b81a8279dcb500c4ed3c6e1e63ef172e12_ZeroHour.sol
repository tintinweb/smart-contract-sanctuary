...
/**
 * FAIR LAUNCH - 10th January 2022

Zero Hour 

A SUPER MASSIVE BUYBACK PROJECT EVER ON BSC ! 

BIG THINGS YET TO COME AFTER LAUNCH 
...
contract ZeroHour is Ownable, IBEP20 {
 
    string private _name = "ZeroHour";
    string private _symbol = "ZEROHOUR";
    ...
    function enableTrading() public onlyOwner {
     ...
     function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_excluded[sender] || _excluded[recipient]) {
            ...
            if (recipient == _pancakePairAddress) taxFee = amount * 8 / 100;
            else if (sender == _pancakePairAddress) taxFee = amount * 6 / 100;
            _balances[sender] -= amount;
