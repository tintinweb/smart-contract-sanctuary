...
/**
   ...
   Welcome to LittleEthereum
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleEthereumCommunity
...
contract LittleEthereum is Context, IERC20, Ownable {
    ...
    string private _name = "Little Ethereum";
    string private _symbol = "LTETH";
