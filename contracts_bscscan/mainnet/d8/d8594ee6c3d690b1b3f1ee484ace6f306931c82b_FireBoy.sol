...
contract FireBoy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FireBoy";
    string private _symbol = "FIREBOY";
