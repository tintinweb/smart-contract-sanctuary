...
Websites : https://www.presidentdoge.com/

President Doge is the meme dog that ruled them all. 
He has come a long way and he is now the President of the World. 
President Doge is the most powerful, authoritative and influential dog on the Blockchain. A
ll those other sweet puppy dogs are his slaves now.
...
contract PresidentDoge is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 80000* 10**9;

  string private _symbol = "President";

  string private _name = "President Doge";
