 ...
 * ¡¡¡¡ FAIRLAUNCH !!!!
 * 
 * ¡The double reward token! 
 * 
 * Buy this token to receive BTC and ETH at the same time 
 * in your wallet automatically every few minutes.
*/
...
contract REWARDSBTCETH is IBEP20,  Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "REWARDSBTCETH";
    string constant _symbol = "RBE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 8000 * (10 ** _decimals);
