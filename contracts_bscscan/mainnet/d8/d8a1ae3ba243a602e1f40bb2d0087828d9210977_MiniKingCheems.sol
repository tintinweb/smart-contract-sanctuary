...
/**
MiniKingCheems is here to give gifts on Christmas Eve!
Come join and get the best surprise at the end of this year.
will it be a lambo or a ticket to mars?

LP locked until january.
Tokenomics
 Marketing fee 9%
 100% of tax transaction will be rotated for FOMO to boost MiniKingCheems!
    Tokenomics
...
contract MiniKingCheems is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniKingCheems";
    string constant _symbol = "Cheems Mini King";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 1; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x640dF17C14295e69031708C5A089F7Af30955A03;
