...
contract SunshineProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Sunshine-Protocol";
    string private _symbol = "SUNS";
    ...
    uint256 internal _tokenTotal = 10_000_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0x36d4cB06411A325286d399d630775Da008600D3B;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
