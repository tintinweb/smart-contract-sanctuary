...
contract SuperBabyDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperBabyDoge";
    string private _symbol = "SuperBabyDoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa976208251BC8437fc0f36f2fbC2e208d2201346);
    address payable public teamWalletAddress = payable(0xa976208251BC8437fc0f36f2fbC2e208d2201346);
	address public OwnerAddress =0xa976208251BC8437fc0f36f2fbC2e208d2201346;
    ...
    uint256 public _walletMax = 10000000000000 * 10**_decimals;
