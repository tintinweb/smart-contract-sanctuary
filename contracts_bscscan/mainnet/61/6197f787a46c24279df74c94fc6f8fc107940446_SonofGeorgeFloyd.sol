...
contract SonofGeorgeFloyd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Son of George Floyd";
    string private _symbol = "$SOG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04C37f95CF1D480B0f1158c1C46f826150bc2982); // Marketing Address
