...
Meet BabyDoge's twin brothers

╔╗ ┌─┐┌┐ ┬ ┬╔╗ ┌─┐┌┐ ┬ ┬╔╦╗┌─┐┌─┐┌─┐
╠╩╗├─┤├┴┐└┬┘╠╩╗├─┤├┴┐└┬┘ ║║│ ││ ┬├┤ 
╚═╝┴ ┴└─┘ ┴ ╚═╝┴ ┴└─┘ ┴ ═╩╝└─┘└─┘└─┘

Mamadoge has been busy and gave birth to his new siblings.
BUT Papadoge is suspicious because he saw Uncledoge and Mamadoge being very close lately
Who is the father Papadoge or Uncledoge? Or was it the sneaky SnoopDoge back to his old shenanigans….

$Babybabydoge is a new low tax deflationary token. 
5% of each transaction will be used to pay for marketing and later to buy back then burn tokens. 
This is good for investors because it means that the tax is either being used to pay for people to hear about the token or used to make it more scarce.

Social Media:   
Website: https://www.babybabydoge.io/
Telegram: https://t.me/BBDoge
Twitter: https://twitter.com/DogeBabybaby
...
contract BabyBabyDoge is IBEP20, Auth {
    ...
    string constant _symbol = "BabyBabyDoge";
