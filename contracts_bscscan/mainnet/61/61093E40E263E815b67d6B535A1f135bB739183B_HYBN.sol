...
contract HYBN is Ownable {
    ...
    constructor(address  owner,IBEP20 _hbcToken, HBCICO _oldctr) public {
        developerAccount_ = owner;
        marketingAccount_ = owner;
        referenceAccount_ = owner;
        hbcToken=_hbcToken;
        oldctr=_oldctr;
        _init(owner);
    }
    ...
    function _init(address _owner) private {
        latestReferrerCode = REFERRER_CODE;
        address2UID[_owner] = latestReferrerCode;
        uid2Investor[latestReferrerCode].addr = _owner;
