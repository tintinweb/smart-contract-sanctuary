...
contract SisterShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " Sister Shiba";
    string constant _symbol = "SSHIB";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x247fC83f893606C3A6b2EE69539b86F31211222C;
