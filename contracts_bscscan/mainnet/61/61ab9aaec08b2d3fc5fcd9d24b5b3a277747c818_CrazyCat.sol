...
contract CrazyCat is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "CrazyCat";                                          // name
    string private _symbol = "CCAT";                                             // symbol
    uint256 private _tTotal = 420 * 10**9 * 10**uint256(_decimals);          // total supply
    ...
    uint256 public defaultLiquidityFee = 8;
    uint256 public _liquidityFee = defaultLiquidityFee;
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _liquidityFee4Buyers = 8;
    ...
    uint256[] public _liquidityFeeSplit = [40,60];                                       // % division between swap+liquify & wallets
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xB8C229B29BD668769B11031069c4b47B7002401B),                             // Dev+Team wallet
        payable(0x8e7EBA26208Acd4D274a89b98A4519D7be3DF07b),                             // Marketing wallet
        payable(0xfbf6e5841831fad7D051Bc959572EE15c67dD3C4)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x954eab2b73d5AD0d0d2aE9de0604B6187aC9dAa9, 'We can not exclude Uniswap router.');
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "CrazyCat is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "CrazyCat is not live yet");
