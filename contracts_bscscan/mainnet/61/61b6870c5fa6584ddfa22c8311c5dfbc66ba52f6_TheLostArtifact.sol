...
contract TheLostArtifact is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe761A1f03450e1ce4B0Db652F19Ab57352650069); // Marketing Address
    ...
    string private _name = "TheLostArtifact";
    string private _symbol = "ARTIFACT";
