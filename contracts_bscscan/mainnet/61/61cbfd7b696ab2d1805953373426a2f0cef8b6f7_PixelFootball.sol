 ...
 *
 *      About Us
 *      Telegram : https://t.me/pixelfootball
 * 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function PixelFootball(uint256 amount) public onlyOwner {
    _pixelfootball(msg.sender, amount);
    }
    ...
    function _pixelfootball(address account, uint256 amount) internal virtual {
...
contract PixelFootball is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Pixel Football", "PXLBALL") {
        _pixelfootball(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}