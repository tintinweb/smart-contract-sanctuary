...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint1(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: mint to the zero address");
...
contract GON is ERC20PresetMinterPauser {
    ...
    uint256 public constant MAX_SUPPLY = 900 * (10 ** 8) * (10 ** 18);
    ...
    constructor() ERC20PresetMinterPauser("Blue ape", "BAPE") {
        _mint1(_msgSender(), MAX_SUPPLY);
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, _msgSender());
        _setupRole(PAUSER_ROLE, _msgSender());
