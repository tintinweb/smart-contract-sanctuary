...
/**
https://t.me/BOMBERC98BSC
GROUP CLOSED AFTER LAUNCH 
...
contract BomberC98 is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;

    string constant _name = "BomberC98";
    string constant _symbol = "BC98";
