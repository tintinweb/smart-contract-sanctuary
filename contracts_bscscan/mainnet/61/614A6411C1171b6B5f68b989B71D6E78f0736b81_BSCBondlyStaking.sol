...
import "./interfaces/IBSCBondlyStaking.sol";

contract BSCBondlyStaking is
    IBSCBondlyStaking,
    OwnableUpgradeable,
    ...
    PausableUpgradeable
{
    ...
    function _calculateAnnualReward() public view returns (uint256) {
        ...
        return rewardPerBlock.mul(1e18).mul(SECONDS_PER_YAER).div(totalStaked).div(3);
    }
}
