...
contract MiniNinjaNFT is Context, IERC20, Ownable {
    ...
    string private _name = "Mini Ninja NFT";
    string private _symbol = "MiniNinja";
    ...
    uint256 public _taxgamefee = 7;
    address public gamewallet = 0x8E9f84BeFdB022FDf33Dbff70026dd4542fEdca3;
    uint256 private _previoustaxgamefee = _taxgamefee;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 marketingAmt = amount.mul(_taxgamefee).div(100);
        ...
        _transferStandard(sender, gamewallet, marketingAmt);
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _taxgamefee = 7;
        _previoustaxgamefee = _taxgamefee;
        inSwapAndLiquify = true;
    ...
    function setgamewallet(address newWallet) external onlyOwner() {
