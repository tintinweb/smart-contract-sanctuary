 ...
 * 
 ...
 OneShiba is a community token that not also give you rewards by holding OneShiba 
 but all the decision that OneShiba made will discussed with developer and the community 
 so we have the best outcome. 
 
 BUY OneShiba EARN $ONE                                                                                                               

 Join our Telegram : https://t.me/OneShiba
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 HARMONYONE = IERC20(0x03fF0ff224f904be3118461335064bB48Df47938);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = HARMONYONE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(HARMONYONE);
        ...
        uint256 amount = HARMONYONE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            HARMONYONE.transfer(shareholder, amount);
...
contract OneShiba is IERC20, Ownable {
    using SafeMath for uint256;

    address HARMONYONE = 0x03fF0ff224f904be3118461335064bB48Df47938; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ONESHIBA"; 
    string constant _symbol = "ONESHIBA";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xAcee4346a0dA1851fB82B7D99fB970a499Df0C42);
