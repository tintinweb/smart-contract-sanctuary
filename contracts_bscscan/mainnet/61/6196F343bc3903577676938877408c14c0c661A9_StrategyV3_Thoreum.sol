...
abstract contract StrategyV3 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public feeAddress = 0x34Eb1B0ebf95c751298d8DbAD90f40dcB5C52827;
    ...
    function setFeeAddress(address _address) public onlyAllowGov {
        feeAddress = _address;
    }
...
contract StrategyV3_Thoreum is StrategyV3 {
    ...
    function _farm() internal override virtual {
        ...
        IThoreumFarm(farmContractAddress).deposit(pid, wantAmt, feeAddress);
    }
