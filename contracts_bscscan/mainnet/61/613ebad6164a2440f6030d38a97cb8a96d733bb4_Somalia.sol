...
contract Somalia is Context, IBEP20, Ownable {
    ...
    string private _name = "helo am 48 year man from somalia sorry for my bad england i selled my wife for internet connection for making bsc token and i want to become the goodest dev i make token with liquidity from selling my 6 cows and 2 pigs so plese buy this token for my whole village to have some food and water";
    string private _symbol = "SOMALIA";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        address marketingswap =0xF524b87160E3Aa4896Cd49F019A15d56cCa49aBd;
