...
contract DogeWeed is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 6000000 * 10**9; // Max Transaction: (3%)
    uint256 public _numTokensSellToAddToLiquidity = 500000 * 10**9;
    uint256 public _maxWalletToken = 200000000 * 10**9; // Max Transaction: (100%)
