...
contract RaquelToken2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd70E36DeB7D111DE7E70c8529aEB580C4F6e4699); // Marketing Address
    ...
    string private _name = "RaquelToken1";
    string private _symbol = "RaqueLL";
