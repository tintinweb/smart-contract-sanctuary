...
contract MetaHeist is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "MetaHeist";
    string _symbol = "MetaHeist";
    uint8 constant _decimals = 9;
    uint256 public _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxWallet = _totalSupply.mul(200).div(200); 
    ...
    address private marketing = address(0x1b4A5848Daf815A81c16C984ecdb4A97E896aFf6);
