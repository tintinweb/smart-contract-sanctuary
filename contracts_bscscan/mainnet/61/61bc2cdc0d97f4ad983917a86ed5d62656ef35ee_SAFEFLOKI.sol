...
*/
/**
 *Shiba V2 iS BEST TOKEN Elon musk pump soooon !!!
*/
...
contract SAFEFLOKI is Context, IBEP20, Ownable {
    ...
    string public constant name     = "SAFEFLOKI";
    string public constant symbol   = "SAFEFLOKI";
