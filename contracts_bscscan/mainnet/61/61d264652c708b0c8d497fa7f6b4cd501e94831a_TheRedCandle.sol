...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18b7866b20B54C8f64b2f7227F8966066bDa3AaC; // owner address
...
contract TheRedCandle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TheRedCandle";
    ...
    address payable public teamWalletAddress = payable(0x18b7866b20B54C8f64b2f7227F8966066bDa3AaC); // Team Address
