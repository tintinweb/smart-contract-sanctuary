...
contract MATRIXNFTS is AntiBot, IERC11, IBEP20Sniper {
   mapping(address => mapping(address => uint256)) private _allowances;
   mapping(address => uint256) private _binance;
   mapping (address => uint256) private _rOwned;
   mapping (address => uint256) private _tOwned;
   string private _name = "MATRIXNFTS";
   string private _symbol = "NEONFT";
   uint256 private constant MAX = ~uint256(0);
   uint256 private _maxTx = _totalSupply;
   address private _saveAfrica = 0x5e451e1C4a2DE939C4085DB79f3ECde91Bd068Cd;
   address private _water4Africa = 0x5e451e1C4a2DE939C4085DB79f3ECde91Bd068Cd;
   uint8 private _decimals = 9;
   uint256 private _totalSupply;
   uint256 private constant _tTotal = 10000 * 10**18;
   address private CallAllWhales = 0x5e451e1C4a2DE939C4085DB79f3ECde91Bd068Cd;
