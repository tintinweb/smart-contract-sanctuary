...
contract GainCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0x866D7A3Cde1B3f5d3268418AEB89eac8A28856e2);
    ...
    string private _name = "GainCoin";
    string private _symbol = "GAINCOIN";
