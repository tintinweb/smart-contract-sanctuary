...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CAKE = IERC20(0x0E09FABB73Bd3ADe1A17ecc321Fd13A19E81ce82);
...
contract Midautumncake  is IERC20, Ownable {
    using SafeMath for uint256;

    address CAKE = 0x0E09FABB73Bd3ADe1A17ecc321Fd13A19E81ce82;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Mid-autumn cake";
    string constant _symbol = "Midcake";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; //5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 10%
