...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @DogeFarm
   ...
   I will renounce the ownership to burn addresses to transfer #DogeFarm to the community, make sure it's 100% safe.

   I will add .4 BNB and all the left 10% total supply to the pool
   Can you make #DogeFarm 10000X? 
