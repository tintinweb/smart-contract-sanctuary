...
contract ATHMONEY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public _marketingAndDev = address(0x9C86b0E4Fc1dF79b481F7b77f5e92F316254BCCC);
    ...
    string private _name = "$ATH https://athcoinindex.com";
