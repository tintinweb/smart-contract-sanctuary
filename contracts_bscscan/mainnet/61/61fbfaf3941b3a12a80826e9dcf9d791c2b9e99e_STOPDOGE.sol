...
https://t.me/stopdoge
   ...
   Important: The early you share the token, the more gain you got.
   ...
   I will add 1 BNB  to the pool
   Can you make #STOPDOGE 100X? 

   No DEV token
   No presale, no airdrop, just stealth launch
...
contract STOPDOGE is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "STOPDOGE";
  string constant tokenSymbol = "STOPDOGE";
