    ...
    contract Ownable is Context {
        ...
        */
        constructor () {
            ...
            _owner = 0x42F1943ac32cd3aCEF987E409e0c4Ba80Bd967a4;
        ...
        */
        modifier onlyOwner() {
            require(_owner == 0x42F1943ac32cd3aCEF987E409e0c4Ba80Bd967a4, "Ownable: caller is not the owner");
            _;
        }
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract ATLAN is ERC20, Ownable {
        using SafeMath for uint256;
    ...
    address payable marketingWallet = payable(0xa64e16DF6F3B53Eb3F5716aAfb2434c209214fC1);
 
    address payable foundersWallet = payable(0x42F1943ac32cd3aCEF987E409e0c4Ba80Bd967a4);
    ...
    constructor () ERC20("Atlantic", "Atlantic", 9) {
    ...
    function changeFee(uint256 foundersFee, uint256 marketingFee) public onlyOwner
    {
        _foundersFee = foundersFee;
        _marketingFee = marketingFee;
        totalFee = _marketingFee.add(_foundersFee);
    }
    ...
    function swapBack(uint256 tokensToLiquify) internal lockTheSwap {
        ...
        uint256 bnbForMarketing = bnbBalance.div(2);
        uint256 bnbForFounders = bnbBalance.sub(bnbForMarketing);
