...
contract GalacticDoge is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xF0A0aF7E30EcC707F6A652F1E150D2a416941E87); // Marketing Address
    address payable public charityAddress = payable(0xF0A0aF7E30EcC707F6A652F1E150D2a416941E87); // Charity/Dev Address
    ...
    string private _name = "Galactic Doge Swap"; // nice
    string private _symbol = "GAD";
