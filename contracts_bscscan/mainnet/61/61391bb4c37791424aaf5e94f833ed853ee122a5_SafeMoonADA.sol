...
contract SafeMoonADA is ERC20Detailed, Ownable {
    ...
    uint256 public antiSniperPercentage = 90;
    ...
    constructor() ERC20Detailed("SafeMoonADA", "SFM", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0x78CBaf9f047f548E37Ee8832c17730B5F1Ef6B3C;
        ecosystemFeeReceiver = 0x78CBaf9f047f548E37Ee8832c17730B5F1Ef6B3C;
        buyBackFeeReceiver = 0x78CBaf9f047f548E37Ee8832c17730B5F1Ef6B3C;
        ...
        returns (uint256)
    {
        ...
        if(!isSell && antiSniper && block.timestamp<LaunchTimestamp+BuyTaxDuration){
