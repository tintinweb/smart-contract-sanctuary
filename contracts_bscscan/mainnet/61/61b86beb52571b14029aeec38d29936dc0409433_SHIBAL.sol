...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167);
...
contract SHIBAL is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SHIBAL";
    string constant _symbol = "SHIBAL";
    ...
    uint256 public swapThreshold = 5000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x4893d1c9135B13b9A5fEBA348fb91B000909D160;
        marketingWallet = 0xe7974Af017cF1738a632f8A45e4A1914e2247aDa;
        marketingwallettwo = 0xe7974Af017cF1738a632f8A45e4A1914e2247aDa;
