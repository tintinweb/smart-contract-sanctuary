...
/**
   ...
   Welcome to DOGEMOONBAG
   
   This is a community token. If you want to create a telegram I suggest to name it to @DOGEMOONBAGBSC
   ...
   I will renounce the ownership to burn addresses to transfer #DOGEMOONBAG to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 10% total supply to the pool
   Can you make #DOGEMOONBAG 10000X? 
   ...
   it's the best part of the #DOGEMOONBAG idea, increasing the liquidity pool automatically, 
...
contract DOGEMOONBAG is Context, IERC20, Ownable {
    ...
    string private _name = "DOGEMOONBAG";
