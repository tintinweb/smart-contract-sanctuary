...
contract DogeAngels is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Angels";
    string private _symbol = "DogeAngels";
    ...
    address payable public marketingWallet = payable(0x3C427DE01BAE1129c812AC8cca5f3586414FCF36);
    ...
    uint256 public swapTokensAtAmount = 20000000000 * 10**9;
