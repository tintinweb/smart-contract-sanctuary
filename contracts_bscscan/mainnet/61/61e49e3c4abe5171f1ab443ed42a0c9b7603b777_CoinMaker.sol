...
// CHANGE
contract CoinMaker is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "CoinMakerBSC";
    string constant _symbol = "COINMAKER";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x0269A48EdfA49f05d0fd5bBdE8Bfcb3acdD41b39);
