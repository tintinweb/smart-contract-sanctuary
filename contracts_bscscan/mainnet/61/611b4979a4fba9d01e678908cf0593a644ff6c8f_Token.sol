...
contract Ownable is Context {
    ...
    constructor() {
        _owner = _msgSender();
        _signer1 = 0x20F8C70A642bf0B5F795431fe93F9e21c0f93fD0;
        _signer2 = 0x8d7fC41066F30a0ba38483878f97116b042e7EC5;
...
contract Token is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "MetaOmen";
    string private _symbol = "MetaO";
    ...
    uint256 public _poolFee = 10; // 1% will be added to pool for BNB reward

    uint256 public _weeklyLotteryFee = 20; // 5% will go to the charity address

    uint256 public _monthlyLotteryFee = 30; // 5% will go to the dev address
