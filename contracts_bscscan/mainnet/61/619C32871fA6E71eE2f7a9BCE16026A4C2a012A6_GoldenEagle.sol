...
library SafeMath {
    ...
    function sub(uint s1, uint s2) internal pure returns (uint) {
        return s1 - s2;
    }
    ...
    function sub(uint s1, uint s2, string memory errorMessage) internal pure returns (uint) {
        unchecked {
...
contract GoldenEagle is Contexts, ICOIN, ICOINMetadata {
