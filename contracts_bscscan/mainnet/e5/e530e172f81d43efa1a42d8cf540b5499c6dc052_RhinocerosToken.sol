...
contract RhinocerosToken is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5C76F717b856c701c8E92Ddf9a2136737E6Bac92); // Marketing Address
    address payable public charityAddress = payable(0x5C76F717b856c701c8E92Ddf9a2136737E6Bac92); // Charity/Dev Address
    ...
    string private _name = "Rhinoceros Token"; // nice
    string private _symbol = "RHIN";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 200000000000000000000000000; // nice: Claim 200,000,000 (0.01BNB = 10,000,000,000) 0.000000003 - 0.000000006
