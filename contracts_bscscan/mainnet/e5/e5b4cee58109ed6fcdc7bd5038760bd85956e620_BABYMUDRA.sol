...
`----'                    `----'            `--` '---'            `--`----'    '---'        `---'                      
 ...
 Max Wallet Size = 40,000,000 (40 Million or 4%)
 Max Transaction Size = 20,000,000 (20 Million or 2%)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 MUDRA = IERC20(0xd0C1d18f091B182B80f342C654280B9004c0b124);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MUDRA.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MUDRA);
        ...
        uint256 amount = MUDRA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MUDRA.transfer(shareholder, amount);
...
// CHANGE
contract BABYMUDRA is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address MUDRA = 0xd0C1d18f091B182B80f342C654280B9004c0b124;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY MUDRA";
    string constant _symbol = "BABYMUDRA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% MAX 20,000,000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 4% MAX 40,000,000
    ...
    uint256 reflectionFee = 600; // 6%
    uint256 devFee = 100; // 1%
    uint256 totalFee = 10000; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4Eb3c506782E8e198a9f5A824BE40a6043b8988D);
    ...
    function swapBack() internal swapping {
        ...
        (bool success,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
