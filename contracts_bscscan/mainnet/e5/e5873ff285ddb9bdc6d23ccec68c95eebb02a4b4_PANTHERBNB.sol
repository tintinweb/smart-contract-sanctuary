...
All info can be found on TG: https://PantherBNB
...
contract PANTHERBNB is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x014C59b47245A940086EA8817d4C6d04eCFCDd9f;
    ...
    string private _name = "PANTHERBNB";
    string private _symbol = "PTHBNB";
    ...
    function _transfer(
        ...
        if (limitTheWhales) {
            if(from != owner() && to != owner()) {
                require(amount <= (totalSupply()) * (15) / (10**2), "Transfer amount exceeds the 15% of the supply.");
            }
