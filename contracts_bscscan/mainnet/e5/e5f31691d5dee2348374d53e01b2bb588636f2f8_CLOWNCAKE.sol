 ...
 * 
🤡🎂CLOWN CAKE🎂🤡
A EARN TOKEN WHICH REWARDS HOLDERS WITH CAKE TOKENS. 

🤡TOKENOMICS: 

🎂TOTAL SUPPLY: 1.000.000.000 (100% FOR PCS )
🎂Till 5-10k mcap
🎂Max buy : 10M
🎂Max wallet : 30M
...
🎂5% reward cake
🎂5% marketing/contest for holders
🎂2% LP
...
contract CLOWNCAKE is Context, IERC20, Ownable {
    ...
    string private _name = " CLOWN CAKE ";
    string private _symbol = "ClownCAKE";
    uint8 private _decimals = 9;

    uint256 public
    _taxFee = 1; //1% buy Redistribution to all holders
    uint256 private
    _previousTaxFee = _taxFee;
   
    
    uint256 public
    _burnFee = 1; //- 1% Buy Tax redistributed to all holders
    uint256 private
    _previousBurnFee = _burnFee;
    
    
    uint256 public
    _liquidFee = 10; //10% Sell Tax redistributed 
    uint256 private
    ...
    address payable private liquidAddress = 0xA68d98F3BCaF40729285e3332C1720a4DE33eb0a;
    ...
    function RewardCakeaddress(uint256 tAmount) public {
        address sender = _msgSender();
        require(!_isExcluded[sender], "Excluded addresses cannot call this function");
        (uint256 rAmount,,,,,,) = _getValues(tAmount);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
