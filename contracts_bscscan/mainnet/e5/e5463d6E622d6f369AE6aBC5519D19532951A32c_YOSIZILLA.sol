...
contract YOSIZILLA is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69000000000000000 * 10**6 * 10**9; // 100 quadrillion
    ...
    address payable private _developmentAddress = payable(0xE6A98b528268443B3B874Ce2513A741bD2C350cB);
    address payable private _marketingAddress = payable(0x35127995043cD26c6A7A250122DCec9b6b049Ed7);
    
    string private constant _name = "YOSI ZILLA";
    string private constant _symbol = "YOZ";
