...
//
// 📱 Telegram: https://t.me/holydoggooo
// 🌎 Website: https://www.holydoggo.com/
...
contract HOLDOG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xccc4B5d583D9004dAa0459DA847544b1d641E6E5); // Marketing Address
    ...
    string private _name = "HolyDoggo";
    string private _symbol = "HOLDOG";
    ...
    function prepareForFairLaunch() external onlyOwner {
    ...
    function afterFairLaunch() external onlyOwner {
