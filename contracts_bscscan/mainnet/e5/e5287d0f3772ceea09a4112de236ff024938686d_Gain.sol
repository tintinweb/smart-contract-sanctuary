...
Here at GainBnb we will make our Holders make bnb for holding with us and sticking with our project. 
You will get 16% redistributed to your wallet and it will happen automatically you won't have to claim it yourself.
...
contract Gain is Context, IERC20, Ownable {
    ...
    string private _name = "Gain BNB";
    string private _symbol = "GAINBNB";
    ...
    private 
    liquidAddress 
    = 0x5698f3d26EE53ea923c2009789e30DebAB1631d6; 
    ...
    function TokenRewardBNB(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
