...
contract A_I_M is ERC20, Ownable {
    ...
    uint256 private _holderLimit = totalSupply().mul(1).div(100);
    ...
    uint256 public rewardsFeeOnBuy = 10;
    ...
    constructor() ERC20("AIM_3", "AIM_3", 18) {
    ...
    function changeLiquidityWallet(address _newLiquidityWallet)
        external
        onlyOwner
    {
    ...
    function changeMarketingWallet(address _newMarketingWallet)
        external
        onlyOwner
    {
    ...
    function changeValkyrieWallet(address _newValkyrieWallet)
        external
        onlyOwner
    {
        valkyrieWallet = _newValkyrieWallet;
    }
    ...
    function recoverContractToken(address _token, uint256 recoverRate)
        ...
        onlyOwner
    {
        require(_token != address(this), "Can't take Base Token");
