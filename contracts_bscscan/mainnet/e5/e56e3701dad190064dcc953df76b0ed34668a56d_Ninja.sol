...
contract Ninja is IBEP20, Auth {
    ...
    string constant _name = "Ninja #BabyDoge";
    string constant _symbol = "#BabyDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 420000 * 10**6  * 10**6 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xB62d4a700fEd8a02e5039B4331125eE82DD8049E;
        marketingFeeReceiver = 0x426cc9CeAC7Cebf3780aCdE3944dbAf92359932A;
        teamFeeReceiver = 0xaABEbA8F99ad5f6F013EB25f95879Fe8e2BA70E0;
