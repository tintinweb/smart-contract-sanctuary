...
contract test is IBEP20, Auth {
    ...
    function setIsCaWl(address holder, bool _isCaWl) external authorized {
        isCaWl[holder] = _isCaWl;
    }
        ...
        returns (bool)
    {
        ...
        if (plan == 1) {
            ...
            if (bUSDI.transfer(address(this), fee)) {
    ...
    function migrateToNewToken(uint256 _inputAmt, uint256 mode) external {
        ...
        if (mode == 1) {
            ...
            oldToken.transfer(address(this), _inputAmt);
            ...
            oldTokenAdaMini.transfer(address(this), _inputAmt);
            emit Transfer(address(this), msg.sender, _inputAmt.div(10));
        }
    }
