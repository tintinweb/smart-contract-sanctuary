...
contract SantaPunk is Context, IBEP20, Ownable {
  ...
  string private constant _name = "Santa Punk";
  string private constant _symbol = "SANTAPUNK";
  uint8 private _decimals = 18;
  uint256 private _totalSupply = 100000000000 * 10 ** _decimals;

  address internal _marketingAddress;

  uint8 internal _buyTax = 9; //
  uint8 internal _sellTax = 9; //
