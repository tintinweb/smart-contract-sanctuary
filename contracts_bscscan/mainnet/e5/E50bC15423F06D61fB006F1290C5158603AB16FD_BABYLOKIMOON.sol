...
/**
       Welcome to #Baby Loki Moon
       
      Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BABYLOKIMOON designed.
      
       This is a community token. If you want to create a telegram.
       I suggest by name @ BABYLOKIMOON
       ...
       I will renounce the ownership to burn addresses to transfer #BABYLOKIMOON to the community, make sure it's 100% safe.
    
       I will add .2 BNB and all the left 90% total supply to the pool
       Can you make #BABYLOKIMOON 10000X? 
       ...
       it's the best part of the #BABYLOKIMOON idea, increasing the liquidity pool automatically, 
...
contract BABYLOKIMOON is Context, IERC20, Ownable {
    ...
    string private _name = "BabyLokiMoon";
    string private _symbol = "BABYLOKIMOON";
