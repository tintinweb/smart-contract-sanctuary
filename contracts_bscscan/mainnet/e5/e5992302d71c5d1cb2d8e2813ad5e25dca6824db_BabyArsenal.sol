...
import "./BabyArsenal-imports.sol";

/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `BabyArsenal` at the very bottom **and** the `environment` into which
 * you are deploying the contract `BabyArsenal(Env.Testnet)` or `BabyArsenal(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BabyArsenal";
    string internal constant SYMBOL = "BARSEN";
     ...
     */
    address internal tipToTheDev = 0xe16B46c850A1781E5A4428293B3295DfE0d63751;
...
contract BabyArsenal is SafeToken{
