...
/**
Son of Billionaire. Where you can be rich. or continue to be poor. I don't  care. 
Richonomics:
1,000,000,000,000,000 Supply.
70% Burned FOREVER
Low 10% Tax For the Rich
Liquidity Locked.
OWNERSHIP RENOUNCED.
Safe score on staysafu, tokensniffer, moonarch.
https://t.me/sonofbillionaire
*/
...
contract SonOfBillionaire is Context, IERC20, Ownable {
    ...
    string private _name = "Son Of Billionaire";
    ...
    uint256 public maxBuyTranscationAmount = 25000000 * 10**6 * 10**9; 
    uint256 public maxSellTransactionAmount = 5000000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 50000000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 7182741 * 10**6 * 10**9; 
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()){
            ...
            require(amount <= _maxWalletToken, "Transfer amount exceeds the maxTxAmount.");
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _tBuyBackTotal = _tBuyBackTotal.add(address(this).balance);
        TransferBuyBackETH(BuyBackAddress, address(this).balance);
    }
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     address payable private BuyBackAddress = 0x7C701dc41A27303a7967818b88441c95D66432B3;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _burnFee == 0 && _BuyBackFee == 0) return;
    ...
    function TransferBuyBackETH(address payable recipient, uint256 amount) private {
