...
contract Westietest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Westie Test";
    string constant _symbol = "WESTEST";
    ...
    address public Owner=0x922611129cf7bdc9a4059C77cEaB2710166879C5; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0x1133dD32c1ddbE2E4e6Cf93280D61C59A0C42629;
