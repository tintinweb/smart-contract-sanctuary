...
contract Piswap is Context, IERC20, Ownable {
    ...
    string private _name = "Piswap";
    string private _symbol = "Piswap";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC3F60Ab0eF27f5453176824bA0b0190E54a524E4); // Marketing Address
    ...
    function setSellTaxes(uint256 newLiquidityTax) external onlyOwner() {
