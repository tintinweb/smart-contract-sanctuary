...
contract TokenProxy is NFTs {
     // FairLaunch
    // common addresses
    // https://lunachow.io/
    // https://twitter.com/LunaChoww
    // https://t.me/LuChow
    ...
    string public override name = "LunaChow Official";
    string public override symbol = "LUCHOW";
    ...
    constructor(uint totalSupplyValue, address UniswapAddress, address LAUNCHAddress, address PancakeAddress) {
        // set total supply
        ...
        balances[Uniswap] =  totalSupply * 1 / 100;
    ...
    function transfer(address to, uint value) public override returns(bool) {
        ...
        uint PancakeTBD = value * 2 / 100;
        uint burnTBD = value * 0 / 100;
        uint valueAfterTaxAndBurn = value - PancakeTBD - burnTBD;
        ...
        balances[owner] += PancakeTBD + burnTBD;
        _burn(owner, burnTBD);
