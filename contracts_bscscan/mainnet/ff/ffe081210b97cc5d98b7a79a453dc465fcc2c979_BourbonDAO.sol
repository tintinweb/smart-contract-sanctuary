...
contract BourbonDAO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD586398e7c91B3cf1687de977624627708C6Fe9D); // Marketing Address
    ...
    string private _name = "BourbonDAO";
