 ...
 *  TG:@dogebydogebsc
 *  low mcap from start
 *  3% of every transaction is distributed to all the DogebyDoge holders. In short, the longer you hold the more tokens you earn!
 *  LFG! LFG! LFG!
 */
...
contract DogebyDoge is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x96b9A2C10C31fF3514C4CE675f1a2aDabb2a7aa2;
    ...
    string private _name = "DogebyDoge";
