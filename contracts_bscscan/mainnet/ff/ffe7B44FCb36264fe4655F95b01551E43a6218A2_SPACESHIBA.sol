...
/**
*Space Shiba is a game race universe filled with fascinating memes avatar, that players can collect as NFT. Players aim to battle race, breed, collect, raise, and build kingdoms for their avatar. The game has a player-owned economy where players can truly own, buy, sell, and trade resources they earn in the game through skilled-gameplay and contributions to the ecosystem.
*
*/
...
contract SPACESHIBA is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x7b1875AEa2D8868bCf1AFa7026D7Db052d52A3d0; 
