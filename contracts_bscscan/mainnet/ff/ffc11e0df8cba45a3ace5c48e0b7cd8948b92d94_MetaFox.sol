...
contract MetaFox is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meta Fox";
    string private constant _symbol = "MetaFX";
    ...
    //Buy Fee
    uint private _LiqFeeOnBuy = 10;
    uint private _taxFeeOnBuy = 2;
    
    //Sell Fee
    uint private _LiqFeeOnSell = 10;
    ...
    address payable private _marketingAddress = payable(0x7e03b4442632C43a7A651453d78A4c0702A93bA0);
