...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LINK = IBEP20(0xecc62bd353EDd64Ed31595DbC4C92801aF1e2af0); 
...
contract BABYCYBERDOGE is IBEP20, Auth {
    using SafeMath for uint256;

    address LINK = 0xecc62bd353EDd64Ed31595DbC4C92801aF1e2af0; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABYCYBERDOGE";
    string constant _symbol = "BCD";
