...
contract Ownable is Context {
    address private _owner = 0x19D2D86061a8cf52FB629Ce95673B19a6C433987;
...
contract Sometimes is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Sometimes"; // token name
    string private _symbol = "Sometimes"; // token symbol
