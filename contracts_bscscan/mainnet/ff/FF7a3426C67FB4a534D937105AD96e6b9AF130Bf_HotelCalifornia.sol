...
contract HotelCalifornia is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HotelCalifornia";
    string constant _symbol = "HCALI";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 14 / 200;

    //max wallet holding of 1% 
    uint256 public _maxWalletToken = ( _totalSupply * 14 ) / 200;
    ...
    uint256 reflectionFee   = 25;
    uint256 marketingFee    = 5;
    uint256 public totalFee = 32;
