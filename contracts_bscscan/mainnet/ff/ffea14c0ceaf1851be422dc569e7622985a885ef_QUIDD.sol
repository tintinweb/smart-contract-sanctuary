...
contract QUIDD is Operator {
    ...
    string private _name = "QUIDD";//#币名
    string private _symbol = "QUIDD";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x587C7309bB85061080205B6Ec51752642af519eD),true);
    }
