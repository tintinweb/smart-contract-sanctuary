...
contract GoldGrainToken is BEP20, MinterRole {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (sender == owner() || recipient == owner() || isCommunity[sender] || isCommunity[recipient]) {
            super._transfer(sender, recipient, amount);
        } else {
            require(openTrading == true, "Trading is not open yet");
            super._transfer(sender, recipient, amount);
        }
    }
    ...
    function setIsCommunity(address _account, bool _trueOrFalse) public onlyOperator {
        isCommunity[_account] = _trueOrFalse;
    }
    ...
    function setOpenTrading(bool _opened) public onlyOperator {
        openTrading = _opened;
    }
