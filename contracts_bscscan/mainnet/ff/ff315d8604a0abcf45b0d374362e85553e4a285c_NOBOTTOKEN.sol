...
contract NOBOTTOKEN is ERC20, Ownable {
    // CONFIG START
    
    // TOKEM
    string tokenName = "NoBotCoin2";
    string tokenSymbol = "NOBOT2";
    uint256 tokenTotalSupply = 1_000_000 * (10**18);
    
    // ADRESSES
    address marketingWallet = 0x980678A38deE7fC79f2840E3DF002cf9A694820E;
    ...
    // BOT PREVENTION
    uint256 flagLimit = 3; // After launch, every buyer in x amount of blocks gets flagged
    
    // WHALE PROTECTION
    uint256 maxTXAmount = 20_000 * (10**18);
