...
contract SlpBinance is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3B77376fbC5577951CCD5e45E95DFD4779516A22); // Marketing Address
    address payable public charityAddress = payable(0x3B77376fbC5577951CCD5e45E95DFD4779516A22); // Charity/Dev Address
    ...
    string private _name = "Slp Binance";  // nice
    string private _symbol = "SLP";
