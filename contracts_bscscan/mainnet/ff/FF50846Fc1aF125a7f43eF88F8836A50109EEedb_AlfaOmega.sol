...
contract AlfaOmega is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0x18CCEE798b79b2D6a6be89Ba31b0184f27E22eD6;
    address private _burnAddress = 0x0000000000000000000000000000000000000001;

    string private _name = "Alfa-Omega";
    string private _symbol = "A-O";
    ...
    uint256 public _devFee = 6; // MArketing fee 3% and pálinka fee 3% //
