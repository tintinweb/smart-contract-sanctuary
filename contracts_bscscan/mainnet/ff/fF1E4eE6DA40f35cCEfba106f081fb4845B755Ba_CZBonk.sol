...
contract CZBonk is Context, IERC20, Ownable {
    ...
    string private constant _name = "CZvsELON"; // 
    string private constant _symbol = "CZvsELON"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address public _marketingWallet = 0x180da5F2D42bD506B00b762C1Ce69f0Dc972134F;
