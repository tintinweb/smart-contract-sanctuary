...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x54A80eC3a171989dF0DB769d0322167C6aB9514C;
...
contract WolfBoyZilla is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe063fDa4fEf5bEDC20d83F65181F26a99D5383Bd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WolfBoyzilla";
    string private _symbol = "WBZ";
