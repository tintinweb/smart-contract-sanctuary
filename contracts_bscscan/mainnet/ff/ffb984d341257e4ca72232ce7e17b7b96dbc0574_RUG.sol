...
contract RUG is ERC20, Ownable {
    ...
    constructor() ERC20("IWillRugIT", "TEST") {
    	...
    	marketingWallet = 0x29db91daf47be04Eac0D50B6B296866FcCea1d3D; // set as marketing wallet
    	buyBackWallet = 0x4A6a08ceE99eB3EFF26F062DAbCC4Ea0D5EA3428; // set as buyback wallet
