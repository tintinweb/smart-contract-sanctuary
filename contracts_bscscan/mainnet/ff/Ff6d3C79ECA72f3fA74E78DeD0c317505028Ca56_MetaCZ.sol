...
/*
Telegram: https://t.me/MetaCZ
Website: https://metacz.app/
Twitter: https://twitter.com/metaczbsc
Tokenomics: 5% BNB rewards, 7% Marketing fee, 3% Auto-liquidity fee
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WBNB20 = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = WBNB20.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(WBNB20);
        ...
        uint256 amount = WBNB20.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            WBNB20.transfer(shareholder, amount);
...
contract MetaCZ is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaCZ";
    string constant _symbol = "METACZ";
