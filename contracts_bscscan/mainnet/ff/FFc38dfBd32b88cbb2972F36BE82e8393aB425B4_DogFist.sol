...
contract Ownable is Context {
    address private _owner = 0xd6b504e3b9F72b587272ecE94EBc8c75a4A7996C;
...
contract DogFist is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x5e5D3f2abDd1d50E1B83F3321c6a6E478BCFA3B1); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Dog Fist"; // token name
    string private _symbol = "Dog Fist"; // token symbol
