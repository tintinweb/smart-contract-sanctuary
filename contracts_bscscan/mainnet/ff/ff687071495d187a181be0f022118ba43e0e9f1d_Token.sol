...
contract Token is IERC20, Ownable {
    ...
    /** MAX TX/WALLETS */
    uint256 public _maxBuyTxAmount = (_totalSupply * 100) / 10000; // 1.0% of supply
    uint256 public _maxSellTxAmount = (_totalSupply * 50) / 10000; // 0.5% of supply
    uint256 public _maxWalletSize = (_totalSupply * 150) / 10000; // 1.5% of supply
    ...
    constructor() {
        ...
        marketingFeeReceiver = payable(0xb2b6EBA92ff089f2969390b5A832D808D5069330);
