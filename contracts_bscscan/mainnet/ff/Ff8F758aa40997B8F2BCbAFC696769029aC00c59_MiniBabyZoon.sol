...
contract MiniBabyZoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniBabyZoon";
    string constant _symbol = "MBZ";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1f04810863C1CbfB556656b128a96B1f0FeDDBdb;
    ...
    function afterAirdrop(bool done) external authorized {
