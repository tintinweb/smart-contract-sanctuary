...
contract RoyalBunnies is ERC721, Ownable {
    // max supply
    ...
    // Base URI of Royal Bunnies NFTs
    string private _RbaseURI;
    ...
    constructor() ERC721("Royal Bunnies", "Bunny") {
        _RbaseURI = "https://gateway.pinata.cloud/ipfs/";
        currentTokenID = 0;
        for (uint256 i = 1; i <= 21; i++) {
            string memory uri = string(
                abi.encodePacked(
                    "QmQJo8cSACAJFm5Wv6RUDC7hVJivDRe3qBnHTZTebdUK9E/",
                    Strings.toString(i),
                    ".json"
                )
            );
    ...
    function mint(address account, string memory uri) public {
        ...
        require(tokenId <= maxSupply, "Max supply already minted!");
    ...
    function mintBatch(address account, string[] memory uris) public {
