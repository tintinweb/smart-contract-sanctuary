...
contract TokenReceiver {
    ...
    address private _REX_address = 0x5E0B09b04d6990E76DFE9BF84552a940FD0BE05E;
    ...
    function stakeForMe(uint256 ammount,uint32 stakeDays) external {
        ...
        IERC20(_REX_address).transferFrom(from, address(this), ammount);
        (bytes16 stakeID,) = IStaking(_REX_address).createStake(ammount,stakeDays,"no_name");
