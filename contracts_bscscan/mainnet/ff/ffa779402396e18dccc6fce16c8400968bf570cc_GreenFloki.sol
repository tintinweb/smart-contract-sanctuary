...
contract GreenFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x4c1cc5164723BCe2702FB347C9FBC0CEd7a1FF69); // Marketing Address
    ...
    uint256 public maxBuyAmount = 10000000000000;
    uint256 public maxSellAmount = 30000000000000;
 ...
 // This will be adjust to avoid dump in the first few minutes
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0x4c1cc5164723BCe2702FB347C9FBC0CEd7a1FF69).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0x4c1cc5164723BCe2702FB347C9FBC0CEd7a1FF69).call{value: bnbForTeam2}("");
