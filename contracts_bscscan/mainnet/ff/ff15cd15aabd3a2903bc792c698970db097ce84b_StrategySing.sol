...
contract StrategySing is StratManager, FeeManager, GasThrottler {
    ...
    function harvestWithCallFeeRecipient(address callFeeRecipient) external virtual gasThrottle {
    ...
    function addLiquidity() internal {
        ...
        IERC20(output).safeTransfer(address(this), 0);
