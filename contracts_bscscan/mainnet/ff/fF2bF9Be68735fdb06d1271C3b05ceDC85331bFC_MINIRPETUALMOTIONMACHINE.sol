...
contract Ownable is Context {
    address private _owner = 0xec8C49c2482a87d5e074E2eB39CC4b4Ea75583e0;
...
contract MINIRPETUALMOTIONMACHINE is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x47D4A0902605411c23aDd080764f8dFe35759dcE); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Mini Perpetual Motion Machine"; // token name
    string private _symbol = "MPMM"; // token symbol
