...
contract MOTHERCAKE is IBEP20, Ownable {
  ...
  constructor(){
    ...
    _name = "MOTHERCAKE";
    _synmbols = "MOTHERCAKE";
    _initSupply = 1000000000000000;
    _decimalsMul = 9;
    _decimals = 9;
  ...
  function _burn(address account, uint256 amount) internal virtual {
    ...
    require(account != _burnaddress, "ERC20: burn from the dead address");
  ...
  function _beforeTokenTransfer(
    ...
    if (_pauseSell) {
      require(from == address(this), "Coin Contract : Sell is paused.");
    }
