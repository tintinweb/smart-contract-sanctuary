...
/**
 Welcome to BabyChelsea Token
 Earn 8% BUSD Reflection From holding BabyChelsea Token
...
contract BabyChelsea is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyChelsea";
    string constant _symbol = "BCHEL";
    uint8 constant _decimals = 9;

     uint256 _totalSupply = 2000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100; //500
	uint256 public _maxWalletToken = _totalSupply / 25; // 2500;
    ...
    // SETMEUP
    address _presaler = 0xa24C85Ac98857ADFC212215e1215A0A69A399055;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = payable(0xa24C85Ac98857ADFC212215e1215A0A69A399055);
