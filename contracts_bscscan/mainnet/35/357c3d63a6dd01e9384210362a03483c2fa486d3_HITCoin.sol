...
contract HITCoin is ERC20, Pausable, ERC20Detailed {
    
    address mainWallet = 0xb912C95F886E127e94024649c6926807f78B3506;
	address teamWallet = 0xBdf2EA10dCff2E06DC60Dd2a3d81CECBd5772275;
    address partnerWallet = 0x5370C3e10EC070914c94f1d4F3D87048B1AE5e8e;
    address privateSaleWallet = 0xF1cb20800a84186eDA1A9884Af1909cfb486E8a3;
    address publicSaleWallet = 0x66143074Eb13d71FbCE32c4188cc0B2ca1ab0413;
    address airdropWallet = 0xB520773109CdBE0787ec03A5f4bE8303bC621eFB;
	...
	constructor() public ERC20Detailed("HIT Coin", "HIT", 6) {  

        quarterMap[1]=1640995200;//=Sat,  01 Jan 2022 00:00:0 GMT
        quarterMap[2]=1648771200;//=Fri,  01 Apr 2022 00:00:0 GMT
        quarterMap[3]=1656633600;//=Fri,  01 Jul 2022 00:00:0 GMT
        quarterMap[4]=1664582400;//=Sat,  01 Oct 2022 00:00:0 GMT
        quarterMap[5]=1672531200;//=Sun,  01 Jan 2023 00:00:0 GMT
        quarterMap[6]=1680307200;//=Sat,  01 Apr 2023 00:00:0 GMT
        quarterMap[7]=1688169600;//=Sat,  01 Jul 2023 00:00:0 GMT
        quarterMap[8]=1696118400;//=Sun,  01 Oct 2023 00:00:0 GMT
        quarterMap[9]=1704067200;//=Mon,  01 Jan 2024 00:00:0 GMT
        quarterMap[10]=1711929600;//=Mon,  01 Apr 2024 00:00:0 GMT
        quarterMap[11]=1719792000;//=Mon,  01 Jul 2024 00:00:0 GMT
        quarterMap[12]=1727740800;//=Tue,  01 Oct 2024 00:00:0 GMT
        quarterMap[13]=1735689600;//=Wed,  01 Jan 2025 00:00:0 GMT
        quarterMap[14]=1743465600;//=Tue,  01 Apr 2025 00:00:0 GMT
        quarterMap[15]=1751328000;//=Tue,  01 Jul 2025 00:00:0 GMT
        quarterMap[16]=1759276800;//=Wed,  01 Oct 2025 00:00:0 GMT
        quarterMap[17]=1767225600;//=Thu,  01 Jan 2026 00:00:0 GMT
        quarterMap[18]=1775001600;//=Wed,  01 Apr 2026 00:00:0 GMT
        quarterMap[19]=1782864000;//=Wed,  01 Jul 2026 00:00:0 GMT
        quarterMap[20]=1790812800;//=Thu,  01 Oct 2026 00:00:0 GMT
        quarterMap[21]=1798761600;//=Fri,  01 Jan 2027 00:00:0 GMT
        quarterMap[22]=1806537600;//=Thu,  01 Apr 2027 00:00:0 GMT
        quarterMap[23]=1814400000;//=Thu,  01 Jul 2027 00:00:0 GMT
        quarterMap[24]=1822348800;//=Fri,  01 Oct 2027 00:00:0 GMT
        quarterMap[25]=1830297600;//=Sat,  01 Jan 2028 00:00:0 GMT
        quarterMap[26]=1838160000;//=Sat,  01 Apr 2028 00:00:0 GMT
        quarterMap[27]=1846022400;//=Sat,  01 Jul 2028 00:00:0 GMT
        quarterMap[28]=1853971200;//=Sun,  01 Oct 2028 00:00:0 GMT
        quarterMap[29]=1861920000;//=Mon,  01 Jan 2029 00:00:0 GMT
        quarterMap[30]=1869696000;//=Sun,  01 Apr 2029 00:00:0 GMT
        quarterMap[31]=1877558400;//=Sun,  01 Jul 2029 00:00:0 GMT
        quarterMap[32]=1885507200;//=Mon,  01 Oct 2029 00:00:0 GMT
        quarterMap[33]=1893456000;//=Tue,  01 Jan 2030 00:00:0 GMT
        quarterMap[34]=1901232000;//=Mon,  01 Apr 2030 00:00:0 GMT
        quarterMap[35]=1909094400;//=Mon,  01 Jul 2030 00:00:0 GMT
        quarterMap[36]=1917043200;//=Tue,  01 Oct 2030 00:00:0 GMT
        quarterMap[37]=1924992000;//=Wed,  01 Jan 2031 00:00:0 GMT
        quarterMap[38]=1932768000;//=Tue,  01 Apr 2031 00:00:0 GMT
        quarterMap[39]=1940630400;//=Tue,  01 Jul 2031 00:00:0 GMT

        totalCoins = 10000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 10 million coins        
        
        ERC20.transfer(mainWallet, 125000 * 10 ** uint256(decimals()));
        ERC20.transfer(teamWallet, 83337 * 10 ** uint256(decimals()));
        ERC20.transfer(partnerWallet, 83337 * 10 ** uint256(decimals()));
        ERC20.transfer(privateSaleWallet, 1000000 * 10 ** uint256(decimals()));
        ERC20.transfer(publicSaleWallet, 1000000 * 10 ** uint256(decimals()));
        ERC20.transfer(airdropWallet, 1000000 * 10 ** uint256(decimals()));

        for(uint i = 1; i<= 39; i++) {
            transferAndLock(mainWallet, 125000 * 10 ** uint256(decimals()), quarterMap[i]);
        }
        
        for(uint i = 1; i<= 11; i++) {
            transferAndLock(teamWallet, 83333 * 10 ** uint256(decimals()), quarterMap[i]);
            transferAndLock(partnerWallet, 83333 * 10 ** uint256(decimals()), quarterMap[i]);            
        }
    }
	...
	function transferAndLock(address _receiver, uint256 _amount, uint256 _releaseDate) public whenNotPaused returns (bool success) {
	    require(msg.sender == mainWallet || msg.sender == teamWallet || msg.sender == partnerWallet || msg.sender == privateSaleWallet ||
	            msg.sender == publicSaleWallet || msg.sender == airdropWallet || msg.sender == owner());
