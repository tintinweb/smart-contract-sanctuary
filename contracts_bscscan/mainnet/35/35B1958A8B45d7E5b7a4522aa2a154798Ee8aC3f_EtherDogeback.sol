...
/**
EtherDogeBack (EtherDoge) [BSC] - EtherDoge reward
*/
...
contract EtherDogeback is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EtherDogeback", "EtherDogeback") {
    	ethDividendTracker = new EthDividendTracker();
    	dogeBackDividendTracker = new DogeBackDividendTracker();

    	marketingWallet = 0xd491BfD401cF2c7e8DF1C724e515C348E4852a29;
    	teamWallet = 0xce61c80f7EdD292cB5f636BB45aC4244e42E7A2B;
    	ethDividendToken = 0x331883AB4f76054aaFC1F05E5fbf5915dF55c5FD;
        dogeBackDividendToken = 0x9bCcab5C2d4ACbbA467F8819779C76F9D08a29AC;
