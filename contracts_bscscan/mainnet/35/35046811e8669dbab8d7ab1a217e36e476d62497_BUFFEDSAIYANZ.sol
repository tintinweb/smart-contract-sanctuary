...
contract BUFFEDSAIYANZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUFFEDSAIYANZ";
    string private _symbol = "BSAIYANZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xeEe91ED9d45DB4FA6617e111e11e1B361A218325); // Marketing Address
    address payable public BuybackWalletAddress = payable(0xeEe91ED9d45DB4FA6617e111e11e1B361A218325); // Buyback Wallet Address
