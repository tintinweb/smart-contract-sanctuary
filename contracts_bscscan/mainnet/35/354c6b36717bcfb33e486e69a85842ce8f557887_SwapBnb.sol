...
contract SwapBnb{
    ...
    address public useToken = 0x55d398326f99059fF775485246999027B3197955;
    address public target = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address[]  path;
    constructor (){
        path.push(useToken);
        path.push(target);
    ...
    function swap() external {
        pancakeRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                IERC20(useToken).balanceOf(address(this)),
