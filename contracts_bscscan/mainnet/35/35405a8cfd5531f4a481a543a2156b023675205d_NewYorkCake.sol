...
contract NewYorkCake is Context, IERC20, Ownable {
    ...
    string private _name   = "NewYorkCake";
    string private _symbol = "NYCAKE";
    uint8 private _decimals = 18;
    
    uint256 public _taxFee = 6;   //Frictionless Yield Fee
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2;   // BURN/Liquidity fee
    ...
    uint256 private constant _Charity_FEE = 10;    //  Charity Wallet Fee (in bips)
