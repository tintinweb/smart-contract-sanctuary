 ...
 *                                                  
 *     10% buy tax
 *     10%+anti-red-dildo-tax % sell Fee                         
 *     
...
contract GoodBoyPointsbsc is IBEP20 {
    ...
    string constant _name = "Not a rug";
    string constant _symbol = "NRUG";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000 * 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 100 * 1000000 * (10 ** _decimals);     // 10%
    uint256 public _maxWalletToken = 300 * 1000000 * (10 ** _decimals);  // 30%
    ...
    uint256 public BuyFee = 120; //  buy 
    uint256 public totalFee = 200; //  sell 
    ...
    constructor ()  {
        address marketingFeeReceiver = 0xD1ED4DeCC80BDB3871923cdEA04a86B4E8963aaF;
         owner = msg.sender;
