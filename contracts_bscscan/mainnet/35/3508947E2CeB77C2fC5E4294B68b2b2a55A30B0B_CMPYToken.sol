...
contract CMPYToken is Context, IERC20, Ownable {
    ...
    string private _name = "CMPY";
    string private _symbol = "CMPY";
    ...
    address public MarketingWallet = 0xAD59783Edad7611565f7fD261F82A858018AbE1C;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 burnAmt = amount.mul(_burnFee).div(PERCENT);
        uint256 MarketingAmt = amount.mul(_MarketingFee).div(PERCENT);
