...
/**
BabyLoud Bsc : Made as other BabyLoud Group was pissing me off because of not launching at good time and giving vauge launch time answers

Telegram : https://t.me/babyboorio
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BLUD = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BLUD.balanceOf(address(this));
        ...
        uint256 amount = BLUD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BLUD.transfer(shareholder, amount);
...
contract BabyBoorio is IBEP20, Auth {
    using SafeMath for uint256;

    address BLUD = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyBoorio";
    string constant _symbol = "BABYBOORIO";
