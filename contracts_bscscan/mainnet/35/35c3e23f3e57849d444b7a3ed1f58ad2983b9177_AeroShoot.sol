...
Telegram: https://t.me/Aeroshoot

Twitter: https://twitter.com/AeroShootBSC
...
contract Context {
 ...
 contract AeroShoot is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "AeroShoot";
    string private _symbol = "AEROSHOOT";
    ...
    address private _FalseRed = 0x0C9687559eDfc3b64Ca5ACeDfeA80e2659033409; // Ownership Address
