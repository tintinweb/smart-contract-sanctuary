...
contract DegenX is Context, IERC20, Ownable {
    ...
    uint8 public minMxTxPercentage = 4;         // Transaction allowed as % of supply (1-100). Anti-Whale mechanics
    uint8 public minMxWalletPercentage = 4;     // The maximum supply % that a wallet can hold (1-100). Anti-Whale mechanics
    uint8 public maxBuybackFee = 4;            // Transaction fee % that would be used to buyback tokens on sell (Hyper-deflation) (0-10)
