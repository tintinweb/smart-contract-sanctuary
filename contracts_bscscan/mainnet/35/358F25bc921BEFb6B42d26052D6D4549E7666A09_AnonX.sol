...
/*
 * We are Anonymous (ANON-X)
 *
 * Renouncing Ownership + Locking Liquidity.
 *
 * Total Supply: 1 Quadrillion
 * Max Buy: 100 Billion (~0.66% of Total Supply)
 * Max Hold: 200 Billion (~1.3% of Total Supply)
 *
 * READ THIS CAREFULLY:
...
contract AnonX is Context, IBEP20, Ownable {
    using SafeMath for uint256;

//    address private charityWalletAddress = 0x79649ebD6F74B7BC5418795F9525a19bAbd17577;
    ...
    uint256 public _maxTxAmount = 100 * 10**9 * 10**9; // Max Transaction: 100 Billion (0.6%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 200 * 10**9 * 10**9; // Max Wallet: 200 Billion (1.3%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "Legion-Z";
    string private _symbol = "LNZ";
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                ...
                "Exceeds maximum wallet token amount (1,000,000,000)"
            );
        }
