...
contract LazyDogeAXS is Context, IERC20, Ownable {
    ...
    string private _name = "LazyDogeAXS";
    string private _symbol = "LDA";
    ...
    uint256 private constant _Burn_FEE = 500; // 1%
	uint256 private minimumTokensBeforeSwap = 2000000000000 * 10**9;
  ...
  function getBurnWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x8c946BFf4dbF7d2ce50732952Ff54a6f763189B6, 'We can not exclude Uniswap router.');
