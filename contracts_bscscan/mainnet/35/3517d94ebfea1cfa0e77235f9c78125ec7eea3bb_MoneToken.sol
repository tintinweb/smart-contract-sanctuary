...
contract MoneToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xba2a74bC721bD1177339500298D239486E9d9f0c); // Marketing Address
    ...
    string private _name = "MoneToken";
    string private _symbol = "Mone$";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xba2a74bC721bD1177339500298D239486E9d9f0c);
    }
