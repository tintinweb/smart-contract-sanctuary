...
contract GlowSwapper is ReentrancyGuard {
    IPancakeRouter02 router;
    address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address constant Valor = 0xef3725d9e4B9d758483C86bE917AB7321DC2830C; // Glow Token
