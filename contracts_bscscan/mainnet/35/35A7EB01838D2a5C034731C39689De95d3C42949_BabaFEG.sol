...
https://t.me/BABAFEGCOINBSC

https://www.babyfegcoin.net/

Since 2021, Hold BABA FEG COIN Earn BABY FEG COIN and MUM FEG COIN
...
contract BabaFEG is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABA FEG COIN";
    string constant _symbol = "$BABAFEGCOIN";
    ...
    constructor() RSunAuth(msg.sender) {
        ...
        marketingFeeReceiver = address(0x6e253B254Bb27589492AADfCB22Ed315416F6A54);
        charityFeeReceiver = address(0x760068F5bcB3Cc230537778a0E29D4d041257FEB);
