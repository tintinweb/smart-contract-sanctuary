...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x62dD69fBDDeD5A0Cf6e009cc8Ef2e5791174D782;
...
contract RAKASOCKET is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x62dD69fBDDeD5A0Cf6e009cc8Ef2e5791174D782;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RAKASOCKET";
    string private _symbol = "RST";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 110;
