...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x161C3A337019920c3F29e20627A32e958D8a6856);
    ...
    function setDistributionCriteria(uint256 newMinPeriod, uint256 newMinDistribution) external override handToken {
        minPeriod = newMinPeriod;
        minDistribution = newMinDistribution;
    }

    function setShare(address shareholder, uint256 amount) external override handToken {
    ...
    function deposit() external payable override handToken {
    ...
    function process(uint256 gas) external override handToken {
    ...
    function claimDividend(address shareholder) external handToken{
        distributeDividend(shareholder);
    }
    
    function rescueDividends(address to) external handToken {
        RewardToken.transfer(to, RewardToken.balanceOf(address(this)));
    }
    
    function setRewardToken(address _rewardToken) external handToken{
...
contract TRAVLADDSSAFUREWARDS is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TRAVLADDS SAFU REWARDS";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x161C3A337019920c3F29e20627A32e958D8a6856;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = _totalSupply * 5 / 1000; // 1,5% of total supply.
    uint256 public _walletMax = _totalSupply * 10 / 1000; // 2,5% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xcaD085A8e9ACa539cA6A24C0F8bD20654a8aCb46;
