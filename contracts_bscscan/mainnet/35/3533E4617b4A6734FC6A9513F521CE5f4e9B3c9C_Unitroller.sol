...
contract ComptrollerV5Storage is ComptrollerV4Storage {
    ...
    /// @notice The rate at which the flywheel distributes Atlantis to LP Vault, per block
    uint public atlantisLPVaultRate;

    // address of LP Vault
    address public lpVaultAddress;

    // start block of release to LP Vault
    uint256 public lpVaultReleaseStartBlock;

    // minimum release amount to LP Vault
    uint256 public lpVaultMinReleaseAmount;
}
