...
//https://t.me/ukraineinvaders
//United against the pajeets invaders !
...
// CHANGE
contract UkraineInvaders is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Ukraine Invaders";
    string constant _symbol = "INVADERS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 3) / 100; // 5% MAX 300,000
