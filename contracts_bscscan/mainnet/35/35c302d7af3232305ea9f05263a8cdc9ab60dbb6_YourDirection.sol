...
/**
   ...
   5% fee auto distributed to Marketing wallet
   8% fee auto distributed to Admin wallet
   3% fee auto distributed to Dev wallet
...
contract YourDirection is Context, IERC20, Ownable {
    ...
    uint256 public _fundingFee = 16;
    uint256 private _previousFundingFee = _fundingFee;
    
    address  public AdminAddress = 0xda619830A0F2d65AD780e08E125e9DBB8eb9985F;
    address  public MarketingAddress = 0x6B5A701E21a7653141C7A85deE4462A1a0784C0f;
    address  public DevWallet = 0x2900BFbbE329Be6787Ba99C35338C8Ea5A976840;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 fundingPiece = fundingAmt.div(16);
        ...
        //Send transfers to burn Admin and Marketing wallets
        _transferStandard(sender, address(0), burnAmt);
        _transferStandard(sender, AdminAddress, fundingPiece.mul(8));
        _transferStandard(sender, MarketingAddress, fundingPiece.mul(5));
        _transferStandard(sender, DevWallet, fundingPiece.mul(3));
