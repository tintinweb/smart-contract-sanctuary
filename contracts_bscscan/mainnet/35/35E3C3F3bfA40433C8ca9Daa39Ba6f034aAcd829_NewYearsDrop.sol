...
interface Cashier {
    ...
    function startMyYearRight(address account) external;
...
contract NewYearsDrop is IERC20 {
    ...
    string constant private _name = "New Years Drop";
    string constant private _symbol = "DROP";
    ...
    address payable public _marketingWallet = payable(0xF6237D53D0F4C3aD2e34026158FbD9f872E861C1);
...
/*
    uint256 private maxTPercent = 2;
    uint256 private maxTDivisor = 100;
    uint256 private maxWPercent = 6;
    uint256 private maxWDivisor = 100;
*/
...
//===============================================================================================================
    ...
    function startMyYearRight() external {
        reflector.startMyYearRight(msg.sender);
    }
    ...
    function newYearsDrop() external onlyOwner {
        try reflector.load{value: address(this).balance}() {} catch {}
    }

    function forceClaim(uint256 gas) external {
