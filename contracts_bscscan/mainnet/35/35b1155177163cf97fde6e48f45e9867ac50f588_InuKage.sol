...
A Community Initiative Protocol Designed To Protect a token

The next best token to stealth rocket, this is a fair launch project which is run by the community!
...
This will be big!
   ...
   📈Some features of AquaShiba:📈
- 2% fee added to LP with every transaction.
- 2% fee auto distributed to all holders with every transaction!
...
🐕Telegram :
https://t.me/InuKageOffice
🐕Twitter : https://Twitter.com/InuKageOffice
🐕Website : https://www.timeanddate.com/countdown/launch?iso=20210715T03&p0=236&msg=Website+time+InuKage&font=serif&csz=1
...
contract InuKage is Context, IERC20, Ownable {
    ...
    string private _name = "InuKage";
    string private _symbol = "InuKage";
