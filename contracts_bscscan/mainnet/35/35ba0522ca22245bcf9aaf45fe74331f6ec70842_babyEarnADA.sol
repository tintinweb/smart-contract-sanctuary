...
/**
    babyEarnADA
    20% ADA Rewards , 3% Liquidity , 2% Marketing
    Stealth launch at 5pm UTC
    Based DEV
    TG: https://t.me/babyEarnADA
...
// CHANGE
contract babyEarnADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "babyEarnADA";
    string constant _symbol = "babyEarnADA";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x0A9df64bE0bf1016C02d4B592dA54d714E65e84C);
