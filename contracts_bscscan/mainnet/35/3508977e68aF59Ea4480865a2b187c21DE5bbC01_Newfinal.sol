...
contract Newfinal is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xB18C7741E55fE0c477235E205ffbc6fA67D29Ca9); // Marketing Address

    address payable public teamAddress =
        payable(0x3D7382C5648B35c8442D7aCbfe430a51671365f0); // Mining Address

    address payable public liquidityAddress =
        payable(0x41bf57f267c2Af60Ba2bc49f61d4eF744912E40f); // Liquidity Address
    ...
    string private constant _name = "NewFinal";
    string private constant _symbol = "NFN";
