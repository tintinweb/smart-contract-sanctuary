...
/**
 *BabyFirefox BSC Token
 * 8% back to holders
 * 4% Liquidity Fee
 * 4% Marketing fee
 * 100,000,000 total supply 
 * initial liquidity 1 BNB
 * 100% tokens to pancakeswap pool.
 * TG: https://t.me/BabyFireFoxBSC
*/
...
contract BabyFireFox is Context,IBEP20,Ownable {
    ...
    string private constant _name = "BabyFireFox";
    string private constant _symbol = "BYFFOX";
