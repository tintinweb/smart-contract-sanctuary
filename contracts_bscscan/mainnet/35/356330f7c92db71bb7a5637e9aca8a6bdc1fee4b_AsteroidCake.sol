...
/*
Asteroid Cake.
Asteroid Cake has come from the deepest part of the galaxy in search of new planets to live on.
Will your planet be the next goal? Conquer Asteroid Cake and create an environment in which he is satisfied, 
Asteroid in return, will give you $ CAKE

https://t.me/asteroidcake
*/
...
contract AsteroidCake is Context, IERC20, Ownable {
    ...
    string private _name = "Asteroid Cake";
    string private _symbol = "Asteroid Cake";
    ...
    address _marketingWallet = 0x44dE4C5f5D11A57c574F61B31A44a5Cae0081a25;
