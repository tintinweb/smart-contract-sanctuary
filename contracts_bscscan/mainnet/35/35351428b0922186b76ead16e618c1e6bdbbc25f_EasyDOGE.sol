...
$EasyDOGE proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN DOGE! With the auto-claim feature,
// simply hold $EasyDOGE and you'll receive DOGE automatically in your wallet.
//
// Hold $EasyDOGE and get rewarded in DOGE on every transaction!
...
contract EasyDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "EasyDOGE";
    string private _symbol = "easyDOGE";
