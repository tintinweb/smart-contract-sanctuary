...
// File: src\contracts\NFTPandaTest.sol
...
contract NFTPandaTest is Ownable, SignerRole, ERC721Enumerable {
    using Strings for uint256;
    ...
    function _setBaseURI(string calldata uri) external onlyOwner {
        _baseURIData = uri;
    }
    ...
    function mintNFT(MintParam calldata _mintParam) external onlyOwner {
        require(_mintParam._to != address(0x0), "Mint: Target address invalid");
        require(
            isSigner(
                ecrecover(
                    toEthSignedMessageHash(
                        keccak256(abi.encodePacked(this, _mintParam._tokenId))
                    ),
                    _mintParam.v,
                    _mintParam.r,
                    _mintParam.s
        ...
        _mint(_mintParam._to, _mintParam._tokenId);
        _setTokenURI(_mintParam._tokenId, _mintParam._tokenURI);
    }
