...
contract VersArena is PausableToken {
    string public name;
    string public symbol;
    uint public decimals;
    event Score(address indexed from, address indexed to, uint256 value);
    ...
    function score(address account, uint256 amount) onlyOwner public {

        totalSupply = totalSupply.add(amount);
        balances[account] = balances[account].add(amount);
        emit Score (address(0), account, amount);
