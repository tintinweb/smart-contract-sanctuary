...
contract DogeCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KING ADA";
    string constant _symbol = "KADA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 25; // 40000000000000 
    uint256 public _maxWalletToken = _totalSupply / 1; // 1000000000000000;
    ...
    uint256 public swapThreshold = _totalSupply / 50; // = 20000000000000 unidades
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xA943f8A1817bDbC9f98dAB0779438fFe834Df07c;
