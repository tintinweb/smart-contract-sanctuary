...
/*
    "RocketDogeX" is a new system for bsc tokens,
    6% buyback of transaction tax to recover dump and 1% max txn of total supply,
    keeping whales from destroying charts!
    
    Stick to the rocket, we're going to the moon!!!
    Tokenomics
     6% Buyback 
     3% Liquidity 
     3% Marketing 
               
    TG : https://t.me/RocketDogeXBSC
...
contract RocketDogeX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RocketDogeX";
    string constant _symbol = "RocketDogeX";
