...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable ETH = address(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
...
contract PolkaPup is ERC20, Ownable {
    ...
    POLKAPUPDividendTracker public dividendTracker;
    ...
    uint256 private marketingETHFee;
    ...
    constructor() ERC20("Polkapup", "POLKAPUP") {
        ...
        dividendTracker = new POLKAPUPDividendTracker();



        liquidityWallet = owner();

        marketingWallet = address(0x86dF155E4Ae08c284b7698dE8CC8a1BD37Cf2102);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newAddress != address(dividendTracker), "POLKAPUP: The dividend tracker already has that address");



        POLKAPUPDividendTracker newDividendTracker = POLKAPUPDividendTracker(payable(newAddress));



        require(newDividendTracker.owner() == address(this), "POLKAPUP: The new dividend tracker must be owned by the POLKAPUP token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        ...
        require(newAddress != address(uniswapV2Router), "POLKAPUP: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        ...
        require(_isExcludedFromFees[account] != excluded, "POLKAPUP: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        ...
        require(pair != uniswapV2Pair, "POLKAPUP: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        require(automatedMarketMakerPairs[pair] != value, "POLKAPUP: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        ...
        require(newLiquidityWallet != liquidityWallet, "POLKAPUP: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        require(newValue >= 200000 && newValue <= 500000, "POLKAPUP: gasForProcessing must be between 200,000 and 500,000");

        require(newValue != gasForProcessing, "POLKAPUP: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            ...
            require(canTransferBeforeTradingIsEnabled[from], "POLKAPUP: This account cannot send tokens until trading is enabled");
...
contract POLKAPUPDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("POLKAPUP_Dividend_Tracker", "POLKAPUP_Dividend_Tracker") {
    ...
    function _transfer(address, address, uint256) pure internal override {
        ...
        require(false, "POLKAPUP_Dividend_Tracker: No transfers allowed");
    ...
    function withdrawDividend() pure public override {
        ...
        require(false, "POLKAPUP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main POLKAPUP contract.");
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        ...
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "POLKAPUP_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");

        require(newClaimWait != claimWait, "POLKAPUP_Dividend_Tracker: Cannot update claimWait to same value");
