...
//ElonShibaSperm v0.1 25/12/2021 
...
contract ElonShibaSperm is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    string private NAME_CONTRACT="ElonShibaSperm";
    string private NICK_CONTRACT="ESS";
    ...
    ElonShibaSpermDividendTracker public dividendTracker;
   ...
   // uint256 private _previousTotalFees = totalFees;
    ...
    constructor() public ERC20(NAME_CONTRACT, NICK_CONTRACT) {
    	...
    	dividendTracker = new ElonShibaSpermDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ElonShibaSpermDividendTracker newDividendTracker = ElonShibaSpermDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the ElonShibaSperm token contract");
...
contract ElonShibaSpermDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("ElonShibaSperm_Dividen_Tracker", "ElonShibaSperm_Dividend_Tracker") {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 400000 * (10**9);
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "ElonShibaSperm_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "ElonShibaSperm_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ElonShibaSperm contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "ElonShibaSperm_Dividend_Tracker: claimWait must be updated to between 20 mins and 24 hours");
        require(newClaimWait != claimWait, "ElonShibaSperm_Dividend_Tracker: Cannot update claimWait to same value");
