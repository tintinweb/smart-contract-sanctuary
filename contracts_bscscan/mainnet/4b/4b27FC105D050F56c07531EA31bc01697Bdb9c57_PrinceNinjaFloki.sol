...
contract PrinceNinjaFloki is IBEP20, Ownable {
    ...
    // Fee Receiver
    address private marketingFeeReceiver = 0x9491b1C51DF137cE5bA4b8f6B796b6cdC0f3f6cf;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 4; // 0.1%
    uint256 public maxSwapSize = _totalSupply / 100 * 100; //1%
