...
contract GINTAMAINU is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Gintama Inu";
    string constant _symbol = "GinTama";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1000) / 10000; // 1% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 2000) / 10000; // 2%
