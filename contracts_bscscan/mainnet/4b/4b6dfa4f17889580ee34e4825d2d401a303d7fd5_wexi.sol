...
/* contacts let = "name wexi" id =1000000000000000 
getAmountOut(wexi)
...
// File: contracts\wexi.sol

contract wexi is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "WEXI";
	...
	uint256 private constant _totalTokens = 7000000 * 10**_decimals;	//7 million total supply
	...
	// CHARITY
	address payable private constant _charityAddress = payable(0xe16E72964Ef7fF2B295364426160b1f0D300cD3d); // A percentage of the BNB pool will go to the charity address
	...
	constructor (address routerAddress) {
		...
		uint256 _tokenForBurn = _totalTokens * 5 / 100;
