...
contract Tester is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 4 * 10**9 * 10**_decimals;
    ...
    feeRatesStruct public feeRates = feeRatesStruct(
     {rfi: 2,
      liquidity: 3,
      research: 2,
      dev: 0}); //32 bytes - perfect, as it should be
    ...
    uint256 public _maxTxAmount = 5 * 10**5  * 10**_decimals;  
