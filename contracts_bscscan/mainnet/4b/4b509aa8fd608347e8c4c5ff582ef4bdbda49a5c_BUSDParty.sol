...
/**
 * BUSDParty. Welcome to the party! Earn BUSD just by buying in and holding.
 */
...
contract BUSDParty is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   BUSDPartyDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("BUSDParty", "BUSDP") {
        _ETHRewardsFee = 2;
        _liquidityFee = 5;
		_marketingFee = 1;
    	...
    	dividendTracker = new BUSDPartyDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BUSDPartyDividendTracker newDividendTracker = BUSDPartyDividendTracker(payable(newAddress));
...
contract BUSDPartyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("BUSDParty_Dividend_Tracker", "BUSDParty_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "BUSDParty_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "BUSDParty_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BUSDParty contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "BUSDParty_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "BUSDParty_Dividend_Tracker: Cannot update claimWait to same value");
