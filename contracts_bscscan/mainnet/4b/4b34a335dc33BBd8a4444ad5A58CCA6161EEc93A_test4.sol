...
contract test4 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = (_totalSupply * 1) / 200; //0.3% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 1) / 66; // 1.5% of total supply
