...
*    5% fee on each tx, distributed to the marketing wallet
*    30% of supply is burned at the start
*
*    Max wallet is 50,000,000 (5%)    
*    Max transaction is 20,000,000 (2%)
*   
*/
...
contract test is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = 20000000 * (10 ** _decimals);     // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        isMaxWalletTokenExempt[DEAD] = true;                      // // address(router); DEAD; ZERO; pair;
