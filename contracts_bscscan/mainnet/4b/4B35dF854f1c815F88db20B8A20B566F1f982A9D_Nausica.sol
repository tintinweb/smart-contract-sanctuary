...
contract Nausica is Context, IERC20, Ownable {
    ...
    string private constant _namea6 = "Nausica";
    string private constant _symbola6 = "NAUSICA";
    ...
    uint private constant _tTotala6 = 1000000000000 * 10**9;
    ...
    address payable private _marketingAddress = payable(0x43Da353e9993bfB2Da15CD0CF78436547C21E05F);
