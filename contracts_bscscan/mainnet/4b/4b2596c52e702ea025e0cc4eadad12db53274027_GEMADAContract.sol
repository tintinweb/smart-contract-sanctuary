...
//Community Telegram: t.me/gemada_official
//Announcements Telegram: t.me/gemada_ann
//Website: www.gemada.net
//HOLD GEMADA & EARN 8% OF DAILY VOLUME IN Cardano (ADA)
//Taxes: Rewards: 8% , Marketing & Development: 5% , liquidity: 2%
//AntiDump System: Max Wallet: 3% , Max Transaction: 0.5% (might change due to market situation)
...
contract DividendDistributor is IDividendDistributor {
    ...
    //The auto-rewarded token (Cardano (ADA))
    IBEP20 REWARD = IBEP20(0x651a89fed302227d41425235F8E934502FB94C48);
    //dont change that (:
...
contract GEMADAContract is IBEP20, Auth {
    using SafeMath for uint256;

    //The auto-rewarded coin (Cardano (ADA))
    address REWARD = 0x651a89fed302227d41425235F8E934502FB94C48;
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    address public marketingFeeReceiver = 0x4C04C099a76Ad893dFdb93c251A07f7d64b3FAf3; 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x4C04C099a76Ad893dFdb93c251A07f7d64b3FAf3;
