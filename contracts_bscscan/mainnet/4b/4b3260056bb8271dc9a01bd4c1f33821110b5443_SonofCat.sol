...
contract SonofCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAe5162f64ceA2e7802cFAC53fb030f87D211a2f4); // Marketing Address
    ...
    string private _name = "SonofCat";
    string private _symbol = "SonofCat";
