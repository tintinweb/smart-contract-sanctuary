...
contract MiniBabyFloki is Context, IERC20, Ownable {
    ...
    string private _name = "MiniBabyFloki";
    string private _symbol = "MBF";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 4; // Manually adjust prior to renouncing...
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 5; // Manually adjust prior to renouncing...
