...
/*
🟢Zunomics Finance Token 🟢

🟩 @ZunomicsFinance  🟩

Welcome to  Zunomics Finance Token people who have received this token will be deemed to have accepted all the following conditions

Because the market cap is low, the Baby Zunomics Finance Token will rise and fall very quickly, 
so the people who tweet institutions and 
organizations token holders are not responsible for any damage

Inspired by the Zu Finance In project and its rise, baby Zu Finance is born as a gem
...
contract ZunomicsFinance is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "ZunomicsFinance Token";
    string constant _symbol = "ZUNOMICS";
