...
SantaBorg is the new Santa. Giving its holders the biggest and quickest BNB rewards ever seen!

🔥 Fair Launch Nov 21. 18:00 UTC.

Website : santaborg.com
Twitter : twitter.com/SantaBorgToken

Audited by Techrate: https://github.com/TechRate/Smart-Contract-Audits/blob/main/November/SantaBorgToken.pdf
...
contract SantaBorg  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SantaBorg";
    string constant _symbol = "$SBORG";
    ...
    uint256 public _maxWallet = _totalSupply / 20000; // 3%
	...
	function markAsSniper(address user, bool banned) external authorized {
		if (banned) {
            require(	1626631691 + 3650 days > block.timestamp, "User will be banned! Reason: Exploiting the system!");
