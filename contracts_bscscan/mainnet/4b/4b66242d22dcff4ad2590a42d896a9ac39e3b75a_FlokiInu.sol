...
▐▒▒▐▀▐▀▒▒▒▒▒▒▒▒▒▒▒▒▒░▒░▒░▒▒▐ 
 ...
 ▐▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒░▒░▒▒▄▒▒▐  
  ▀▄▒▒▒▒▒▒▒▒▒▒▒▒▒░▒░▒▄▒▒▒▒▌  
   ...
   # Floki Inu Token features:
   ⤏ 4% fee distributed to all holders every transaction
   ⤏ 6% fee auto added to the liquidity pool every transaction
   ⤏ Liquidity pool is locked 
   ⤏ Release will be on PancakeSwap V2
   # Website : theflokiinu.fun
 */
