...
//Daily Bread Contract 


// 10% tax over every Transfer
// 3% fee for reward
// 1% fee burned 
// 1% fee for liquidity pool
...
contract DailyBread is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7777000e9; //7.777.000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DailyBread";
    ...
    uint256 public _maxTxAmount = 7777000 * 10**9 * 10**9;
