...
Official Telegram group : https://https://t.me/capturethedoge
...
import "./CAPDDividendTracker.sol";

contract CAPD is ERC20, Ownable {
    ...
    CAPDDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("CaptureTheDOGE", "CAPD") {

    	dividendTracker = new CAPDDividendTracker();

        _marketingWalletAddress = 0x78Acf2BD9188444Ac05f65B7132fd6Bb868e2594;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "CAPD: The dividend tracker already has that address");

        CAPDDividendTracker newDividendTracker = CAPDDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "CAPD: The new dividend tracker must be owned by the CAPD token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "CAPD: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "CAPD: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "CAPD: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "CAPD: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "CAPD: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "CAPD: Cannot update gasForProcessing to same value");
