...
🚀🐶  STEALTH LAUNCH SOON KotaroAlice 🚀🐶

Stealth launch a lowcap marketcap 💎. Diamond holders will get good rewards,the higher the MCap goes, the more your profit!.
...
contract KotaroAlice is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA858903BA432BCFD6A1C673334DaCa5c96D578de); // Marketing Address
    ...
    string private _name = "KotaroAlice";
    string private _symbol = "KotaroAlice";
