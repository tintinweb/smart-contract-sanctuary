...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the FOX lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == FOXLottery, "Only FOXLottery");
    ...
    /**
     * @notice Set the address for the FOXLottery
     * @param _FOXLottery: address of the FOX lottery
     */
    function setLotteryAddress(address _FOXLottery) external onlyOwner {
        FOXLottery = _FOXLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IFOXLottery(FOXLottery).viewCurrentLotteryId();
    }
}