...
contract Lock {
    IBEP20 public esct = IBEP20(address(0xd0bedf54Bb3a002024a0F131363019ADf8e19428));
    uint public openTime;
    mapping(address=>uint) public balances;
    
    constructor(){
        openTime = block.timestamp + 20 minutes; //365 days;
    }
    ...
    function lock(uint amount) external{
        ...
        balances[msg.sender] += (nowBalance-beforeBalance);
    }
    
    function withdraw() external {
        require(block.timestamp >= openTime, "locked");
