...
/**
 * https://t.me/OfficialRamenGirl
 ❎ No Presale
✅ Stealt* Launched
✅ Contract Verified Upon Launch
🔥 LP will be LOCKED
🤖 Anti-Bot Mechanics
...
contract RamenGirl is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 10 * 10**4 * 10**9; // Max Transaction: 100 thousand (1%)
    uint256 public _numTokensSellToAddToLiquidity = 10 * 10**4 * 10**9;
    uint256 public _maxWalletToken = 20 * 10**5 * 10**9; // Max Wallet: 2million (10%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'RamenGirl';
    string private _symbol = 'RamenGirl';
