...
Genie Token ($GENIETOKEN) Official Contract 
...
3% Liquidity
3% Lottery In BNB
10% BNB Rewards Distribution   

TG: https://t.me/genietokenofficial

Website: genietoken.io

Twitter: https://twitter.com/genietokenbsc
 **/
...
contract GenieToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4392686352f2af9495EE88bdb6D48208a073a3C3); // Marketing Address
    ...
    string private _name = "Genie Token";
    string private _symbol = "$GENIETOKEN";
    ...
    uint256 private _buypajekFee = 25;
    uint256 private _buylpPajek = 5;
    
    uint256 private _botNeedsPrevention = 17;
