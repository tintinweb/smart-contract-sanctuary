...
/**
 *
  Official BABY PUG INU Binance Smart Chain Token
...
contract BABYPUGINU is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BABY PUG INU";
  string private _name = "BABY PUG INU";
