...
/* Token contract */
contract CheemsMas is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "CheemsMas";
    string constant _symbol = "CheemsMas";
    ...
    uint256 public _maxWalletToken = _totalSupply * 300 / 10000; // 4% or 5m tokens
