...
contract Xposed is Context, IERC20, IERC20Extented, Ownable {
  ...
  */
  ...
  string public _name = "Xposed";
  string public _symbol = "xPSD";
  ...
  uint256 public maxWallet = 1500000 * 10**9;
  uint256 public _whalePenaltyAmount = 1000000 * 10**9; // 75% of maxWallet
    
  uint256 private buyBackUpperLimit = 1700000 * 10**9;
