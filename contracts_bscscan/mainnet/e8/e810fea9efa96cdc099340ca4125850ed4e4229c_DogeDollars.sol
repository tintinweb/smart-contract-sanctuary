...
// SPDX-License-Identifier: MIT
 ...
 /**
    ...
    Win BNB by holding. For more information, check out our Telegram group: https://t.me/DOGEDOLLARSS
    
    Tokenomics:

    Tax:
    3% Instant Token Giveaway
    3% BNB Giveaway pool
    3% Marketing wallet
    3% Burn baby, burn!
    
    Additional tax on sells:
    3% BNB Giveaway pool
    3% Marketing wallet
    
    Post-lottery paper hand burn mechanic:
    Any sells within the 36 hours following a lottery will incur an additional 20% burn tax to bolster the token price for holders!

    How to win Tokens:
    Simply hold DOGE$S! The 3% token tax is awarded to a winner with EVERY SINGLE TRANSACTION! Yes, you have a chance to win extra tokens with every buy or sell of DogeDollars that takes place. Cross your fingers when a big buy comes in, or a big sell goes out - you might be the lucky recipient of 3% of that transaction in DOGE$S!

    How to win BNB:
    Simply hold DOGE$S! BNB draws are held twice a week - Sunday and Wednesday. 
    
    https://t.me/DOGEDOLLARSS
...
contract DogeDollars is Context, IBEP20, Ownable {
    ...
    address payable private _bnblotterywallet;
    ...
    address private constant _potAddress = 0x4EA12F6d1D1aC4AF194052CcFf5E76390370D1f5;
    ...
    constructor (address payable charityWalletAddress, address payable bnblotterywallet) {
...
//    }
    ...
    function addLiquidity(uint256 bnbAmount) private {
         _marketingWallet.transfer(bnbAmount.div(2));
         _bnblotterywallet.transfer(bnbAmount.div(2));
    }
