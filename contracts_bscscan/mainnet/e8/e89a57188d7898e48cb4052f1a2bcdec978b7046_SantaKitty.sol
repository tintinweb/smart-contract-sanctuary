...
contract SantaKitty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SantaKitty";
    string private _symbol = "SantaKitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x49938D2A744Eb896659357A9CDCe2E557De0C6E0); // Marketing Address
    address payable public teamWalletAddress = payable(0x852cdD6b3F40075bF30D4546918bCa6Fc1cEd6F7); // Team Address
