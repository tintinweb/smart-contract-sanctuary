...
contract SonOfCrypto is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8b9b898D05571Bba2d03AF12b7dD7cEa0625fb62); // Marketing Address
    ...
    string private _name = "SonOfCrypto";
