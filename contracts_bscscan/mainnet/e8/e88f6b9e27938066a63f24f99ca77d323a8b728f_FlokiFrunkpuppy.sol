...
/*
🐶🐶 Hello from Floki FrunkPuppy 🐶🐶

‍━━━━━━━━━━━━━━━━━━━

🐶 Floki FrunkPuppy  🐶 is an Elon's tweet inspired memecoin deployed on BSC network! Floki FrunkPuppy has next gen Tokenomics sporting REBASE + BUYBACKS + BNB Rewards in a single Package. This means you earn BNB  just by holding it! 🔥

🐶 With the recent hype going all around these Floki related coins and REBASE tokens, we will be the next one to blow up ☄️

🌟 Token distribution: 
      • 100% SENT TO PCS POOL
      • 0 team tokens 
...
⛔️ No Presale
⛔️ No Private Sale
🔒 100% LP Locked for 100 days
✔️ Legit Stealth Launch

📊 Tokenomics 📊:
🐕 MaxTotal Supply: 1,000,000,000,000
🐕 Team tokens: 0

Join our TG: https://t.me/FlokiFrunkPupBSC
*/
...
contract FlokiFrunkpuppy is ERC20, Ownable {
    ...
    constructor() ERC20("Floki FrunkPuppy", "FLKIPUP") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setBNBRewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
