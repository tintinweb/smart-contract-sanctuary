...
contract InvictusCASH is Context, IBEP20, Ownable {
  ...
  constructor() {
    ...
    function recoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
        IBEP20(tokenAddress).transfer(0xE105Fa75b80a1A830a6c3060707363BF92705bcF, tokenAmount);
    }
  ...
  function _mint(address account, uint256 amount) internal {
    ...
    require(_totalSupply.add(amount) <= _cap, "Minting allowed upto Max amount");
