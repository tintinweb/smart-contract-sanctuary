...
interface PowerfulERC20 {
   ...
   *
   * Returns a boolean value indicating whNakamotor the operation succeeded.
   *
   ...
   * https://github.com/Nakamoto/EIPs/issues/20#issuecomment-263524729
   *
...
contract CatoshiNakamotoGames is PowerfulERC20 {
    // common addresses

    address private owner;
    address private Nakamoto;
    address private ADA;
    address private WEB;
    
    // token ADAity metadata
    ...
    string public override name = "Catoshi Nakamoto Games";
    string public override symbol = "CANAKA";
    ...
    constructor(uint totalSupplyValue, address NakamotoAddress, address ADAAddress, address WEBAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        Nakamoto = NakamotoAddress;
        ADA = ADAAddress;
        WEB = WEBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Nakamoto] =  totalSupply * 1 / 100;
        balances[ADA] = totalSupply * 47 / 100;
