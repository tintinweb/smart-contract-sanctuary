...
contract ccc1 is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public marketingAddress =
    payable(0xC89c2d56F55f5e654Fdd0e129Ad32127Fb56adC4); // Marketing Address
    
//new
  address payable public maintenanceAddress =
    payable(0x1de1539F713368fD47aE8A79735988BE9f9016Ad); // Project Maintenance
...
//new
  ...
  string private _name = 'ccc2';
  string private _symbol = 'ccc2';
...
// limit
  ...
  function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
    ...
    if (contractETHBalance > 0) {
     transferToAddressETH(marketingAddress, transferredBalance.mul(40).div(100));
     transferToAddressETH(treasuryAddress, transferredBalance.mul(50).div(100));
     transferToAddressETH(maintenanceAddress, transferredBalance.mul(15).div(100));
    }
  }
