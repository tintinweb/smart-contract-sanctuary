...
/**
 * https://daddybezos.com/
 * https://twitter.com/daddybezos
 * https://t.me/DaddyBezos
*/
...
interface IERc20Metadata is IERc20 {
 ...
 contract DaddyBezos is Context, IERc20, IERc20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private amartisa;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "DaddyBezos";
    string private _symbol = "DaddyBezos";
    uint256 private constant MAX = ~uint256(0);
//https://coinmarketcap.com/currencies/daddybezos/
    ...
    address private _taktak = 0x6409b0d2b689510391B1cC343F9957ae004268F5;
