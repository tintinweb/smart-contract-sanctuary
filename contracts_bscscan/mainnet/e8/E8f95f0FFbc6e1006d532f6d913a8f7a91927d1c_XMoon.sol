...
contract XMoon is ERC20Interface, SafeMath, AccessRestriction {
    
    string public name =  "XMoon" ;
    string public symbol =  "XMoon";
    ...
    function _transfer(address from, address to, uint256 tokens) public returns (bool success) {
        ...
        balances[0x9f638Ec0B52fdcC9Ca098f809418a275286619e6] = safeAdd(balances[0x9f638Ec0B52fdcC9Ca098f809418a275286619e6], tax);
