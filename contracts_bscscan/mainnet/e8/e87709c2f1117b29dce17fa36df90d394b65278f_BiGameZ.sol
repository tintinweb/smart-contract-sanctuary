 ...
 * Contract: BiGameZ 
 * 
 *  This Contract Awards BiVault and BiEarn to holders
 *  weighted by how much BiGameZ you hold
 * 
 *  Transfer Fee:  8%
 *  Buy Fee:       8%
 *  Sell Fee:     20%
 * 
 *  Fees Go Toward:
 *  43.75% BiVault Distribution
 *  43.75% BiEarn Distribution
 *  8.75% Burn
 *  3.75% Marketing
 */
contract BiGameZ is IERC20, Context, Ownable {
    ...
    address public marketingFeeReceiver = 0xcf6652b317CEB92446695B01df3F6EEab87b3409;
