...
//import "./libs/token/BEP20/BEP20Token.sol";
//import "./interfaces/ISellToken.sol";

// Token with Governance.
contract YamToken is BEP20Token, Initializable {
    ...
    constructor() public BEP20Token('Yam Token', 'YAM') {
    }
    ...
    */
    function withdrawFunc(address recipient, address token) public onlyOwner {
        BEP20Token(token).transfer(recipient, BEP20Token(token).balanceOf(address(this)));
    }
