...
contract SumatoInu is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 1000000000 * 10**6 * 10**9;
    uint256 public maxSellAmount = 1000000000 * 10**6 * 10**9;
    uint256 public swapTokensAtAmount = 1 * 10**6 * 10**9;
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public operationsAddress = 0x67659E1294fF79c63Dd598902A7fF1018aB9d5b1;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Sumato inu";
