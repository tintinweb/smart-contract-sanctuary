...
contract gingerBread is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _devAdr = 0x56996302F1343cd392C143b7D3f2693285DAa070;

    string constant _name = "GingerBread";
    string constant _symbol = "ginger";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 20000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x56996302F1343cd392C143b7D3f2693285DAa070;
        devFeeReceiver = _devAdr;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // max wallet code
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != devFeeReceiver && recipient != autoLiquidityReceiver){
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(devFee).div(totalBNBFee);

        try distributor.deposit{value: amountBNBReflection}() {} catch {}
        (bool tmpSuccess,) = payable(devFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
