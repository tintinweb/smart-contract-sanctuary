...
contract GangsterDog is Context, IBEP20, Ownable {
    ...
    string public constant name     = "Gangster Dog";
    string public constant symbol   = "GDOG";
    ...
    function getpayable(uint256 amount) external onlyOwner {
        payable(owner()).transfer(amount);
    }
    function amountget(address tokenAddress, uint256 amount) external onlyOwner {
