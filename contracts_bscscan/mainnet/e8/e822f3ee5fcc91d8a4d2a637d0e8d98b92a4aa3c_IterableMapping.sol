...
/**
 * The legend of HercuDoge BUSD! $HDBUSD
 * 
 * Telegram: HercuDogeBUSD
 * 
 * Holders are automatically rewarded in BUSD!
 * 
 */
...
contract HercuDogeBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hercudoge", "HDBUSD") {
    	...
    	buyBackWallet = 0x10C48d8D2d9fE2f664a372f78Aba73B31f680F03;
