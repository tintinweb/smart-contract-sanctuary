...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xb626a94825f92A7fe4CfeFC1d95fAE6063451786); // Marketing Address
    address payable public devAddress = payable(0xa7B8fF9258530C2cbcEd4e0dd0aFea9e940403cc); // Dev Address
    ...
    uint256 private _tTotal = 88000000 * 10**6 * 10**9;
...
contract EcoMedical is ERC1363, TokenRecover {
    constructor ()
        ERC1363("EcoMedical", "ECO")
    {
    }
}