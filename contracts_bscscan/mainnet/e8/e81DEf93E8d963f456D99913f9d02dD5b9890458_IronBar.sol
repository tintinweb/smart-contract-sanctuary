...
contract IronBar is IERC20, PriceConsumerV3 {
    ...
    uint256 private _cap =  100000000 *(10**uint256(_decimals));
    uint256 private _initialSupply = 90000000*(10**uint256(_decimals));
    ...
    */
    ...
    function mint(address account, uint256 value) external onlyOwner {
        uint256 amount = value*(10**uint256(_decimals));
        _mint(account,amount);
    }
    
    function _mint(address account, uint256 value) internal {
        require(_totalSupply.add(value)<= _cap, "total supply exceeds cap value");
