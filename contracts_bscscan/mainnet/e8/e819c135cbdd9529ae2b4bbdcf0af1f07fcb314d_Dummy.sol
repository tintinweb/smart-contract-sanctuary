...
contract Dummy is ERC20, Ownable {
	...
	address payable public marketingWalletAddress = 0x3C0cdaed29D4c8958f2475F8Be9f0Ee98Cb88C44;
	address payable public developmentWalletAddress = 0x5BDD3685816E558Ab4Df75Aeb4e044c65F86a260;
    address public BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    uint256 public swapTokensAtAmount = 1000000000 * (10**4);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "DMMY: The dividend tracker already has that address");
        DMMYDividendTracker newDividendTracker = DMMYDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "DMMY: The new dividend tracker must be owned by the DMMY token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DMMY: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DMMY: The PanCakeSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DMMY: Automated market maker pair is already set to that value");
...
contract DMMYDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("DMMY_Dividen_Tracker", "DMMY_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function withdrawDividend() public override {
        require(false, "DMMY_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DMMY contract.");
    }
