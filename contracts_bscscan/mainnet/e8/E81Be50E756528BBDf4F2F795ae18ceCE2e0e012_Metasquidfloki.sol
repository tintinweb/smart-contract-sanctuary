...
/*
Meta Squid Floki was created by a simple concept combining the best of a TV concept and tokenomics and creating a token that allows ANYONE and EVERYONE to become very RICH without having to compromise your life. This is a fan made token using the best in the spirit of the show and not licensed by Netflix
...
contract Metasquidfloki is ERC20, Ownable {
    ...
    constructor() ERC20("MetaSquidFloki", "MSF")  {
    ...
    function setAutoLP(uint256 value) external onlyOwner{
        marketingFee = value;
    }
    ...
    function updateETHrewards(uint256 value) external onlyOwner {
        buyFee = value;
    }
