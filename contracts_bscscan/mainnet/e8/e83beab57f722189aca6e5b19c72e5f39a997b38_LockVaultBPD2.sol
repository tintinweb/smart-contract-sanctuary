...
contract LockVaultBPD2 is Ownable {
    using SafeMath for uint;
    
    address public constant tokenAddress = 0xA8eE35d43ddB153907EAE2209BAeB62632c1D77f;
    
    uint public constant tokensLocked = 80000000000000000e18;          // 80,000,000,000,000,000 Tokens
    uint public constant unlockRate   = 2000000000000000e18;           // 200,000,000,000,000 Once in a Months
    uint public constant lockDuration = 120 days;                      // Before 120 Days, Its impossible to unlock...
    ...
    // function to allow admin to claim *any* ERC20 tokens sent to this contract mistakenly
