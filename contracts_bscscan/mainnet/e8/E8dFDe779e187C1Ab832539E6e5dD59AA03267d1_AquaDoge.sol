...
/**
* 
    🔱 AQUADOGE 🐕 REWARDS 🤑 FAIR LAUNCH 🚀

    🚀LAUNCH AUGUST 03 - 21:00 UTC
    🤑HOLD $AQUADG & EARN $CAKE

    TG : https://t.me/AquaDogeRewards
*
**/
...
contract AquaDoge is ERC20Interface, Owned {
    using SafeMath for uint256;

    address private _router;
    string public symbol = "$AQUADG";
    string public name = "AquaDoge";
    uint8 public decimals = 18;
    uint256 DEC = 10**uint256(decimals);
    uint256 public _totalSupply = 1000000000000 * DEC;
