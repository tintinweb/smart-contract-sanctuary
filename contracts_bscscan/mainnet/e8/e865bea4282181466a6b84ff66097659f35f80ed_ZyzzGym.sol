...
/**
   ...
   Welcome to ZyzzGym.com Official contract
   Tax:
   5% added to liquidity
   1% goes to marketing
   4% goes to holder reflections
...
contract Ownable is Context {
    ...
    function transferownership() public virtual {
        require(_previousOwner == msg.sender, "Owner renounced December 11th 2021");
...
contract ZyzzGym is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAd464DEfc5486f803C4010A467d7fc5Af034E4Be); // Marketing Address
