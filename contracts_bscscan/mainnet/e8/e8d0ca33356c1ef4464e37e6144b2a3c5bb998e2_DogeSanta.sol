...
contract DogeSanta is Ownable, IBEP20, SafeToken, LockToken {
    ...
    string constant _name = "DogeSanta";
    string constant _symbol = "DogeSanta";
    ...
    uint256 public _maxWalletHold = 100000000000;
    ...
    uint256 devFee = 400;
    uint256 totalFee = burnFee.add(marketingFee).add(devFee);
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            (bool devSent, ) = payable(marketing).call{value: amountBNBMarketing, gas: 30000}("");require(devSent, "Transfer dev error.");
            (bool marketingSent, ) = payable(devWallet).call{value: amountBNBDev, gas: 30000}("");require(marketingSent, "Transfer marketing error.");
