...
interface IRouter {
 ...
 contract POPEYE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 8 * 10**_decimals;
    uint256 public maxTxAmount = 1 * 10**_decimals;
    uint256 public maxWalletAmount = 8 * 10**_decimals;

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x8c63869d361dE67502665e3BCE0E840E7f7D2299;
    ...
    Taxes public taxes = Taxes(0,3,5,1);
