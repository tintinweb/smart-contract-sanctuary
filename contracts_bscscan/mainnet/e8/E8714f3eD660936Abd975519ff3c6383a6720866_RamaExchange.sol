...
contract RamaExchange{
    ...
    event onBuy(uint256 amount,uint256 busdAmound);
    ...
    function buyToken(uint256 amount) public   {
        ...
        uint256 _tokens = calculateTokens(amount);
        safeTransferTokens(msg.sender,_tokens);
    ...
    function safeTransferTokens(address to,uint256 noOfTokens)internal{
        require(getTokenBalance()>= noOfTokens,"Contract has no balance");
        token.transfer(to,noOfTokens);
