...
contract DragonToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DragonToken";
   ...
   // sell fee
    ...
    address public Owner=0x45850569bE856826ad393d2E2dC4fc3ae199543B; // owner address
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 500000; // 0.1% of supply
    bool inSwap;
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver = 0xB790c049867Be49Ed176BF94b2c94a32Cd874869; // marketing address
