...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5b9960953E98710c3457d1e8f75691C7990bA34e;
...
contract CATGODDESS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0b40315dF560Db69DB5628C90C3b1a7a4797d844;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cat Goddess";
    string private _symbol = "CATGDS";
