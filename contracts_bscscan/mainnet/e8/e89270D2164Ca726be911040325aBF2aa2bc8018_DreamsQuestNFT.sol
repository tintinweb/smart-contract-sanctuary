...
Dreams Quest is a decentralised play-to-earn RPG game using 
dynamic NFTs to create unknown factors that will affect character
attributes in-game, and post-game outcomes will dynamically change 
the NFT card attributes and write them on the blockchain 
(the ethereal scribes) to show game history for each card.
...
Telegram   : https://t.me/dreamsquestnftann
Facebook   : https://www.facebook.com/DreamsQuestNFT
Reddit     : https://www.reddit.com/r/dreamsquestnft/
Instagram  : https://www.instagram.com/dreamsquestnft/
LinkedIn   : https://www.linkedin.com/company/dreamsquest/
DISCORD    : https://discord.com/invite/A7Nd7nR7sG
Website    : https://dreamsquest.demo.bananahouse.pl/
⚔️Only use official links…robbers are everywhere, don’t get scammed

*/
pragma solidity ^0.8.6;

interface GamingNFTs {
   ...
   * https://github.com/DQNFTs/EIPs/issues/20#issuecomment-263524729
   *
...
contract DreamsQuestNFT is GamingNFTs {
     // FairLaunch
    // common addresses
    address private owner;
    address private DQNFTBSC;
    address private DQNFTCoin;
    address private DQNFTs;
    ...
    string public override name = "Dreams Quest NFT";
    string public override symbol = "DQNFT";
    ...
    constructor(uint totalSupplyValue, address DQNFTBSCAddress, address DQNFTCoinAddress, address DQNFTsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        DQNFTBSC = DQNFTBSCAddress;
        DQNFTCoin = DQNFTCoinAddress;
        DQNFTs = DQNFTsAddress;
        balances[DQNFTBSC] =  totalSupply * 1 / 100;
        balances[DQNFTCoin] = totalSupply * 49 / 100;
        balances[DQNFTs] = totalSupply * 500 / 100;
