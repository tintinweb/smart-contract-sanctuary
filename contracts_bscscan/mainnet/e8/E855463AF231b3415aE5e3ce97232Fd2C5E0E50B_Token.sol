...
contract Token is BEP20 {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _initialSupply, address _fundHolder) BEP20(_name, _symbol) public {
        mint(_fundHolder, _initialSupply);
    }
