...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PETS = IBEP20(0x2C14CBffD9963C17fF65028C52f75Ea6f14205Ff);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PETS.balanceOf(address(this));
        ...
        uint256 amount = PETS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PETS.transfer(shareholder, amount);
...
contract yourcoin is IBEP20, Auth {
    using SafeMath for uint256;

    address PETS = 0x2C14CBffD9963C17fF65028C52f75Ea6f14205Ff;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Use Me Abuse Me";
    string constant _symbol = "UMAM";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 5000000 * (10 ** _decimals);
    uint256 _burntSupply = (_totalSupply * 0) /100;
    uint256 _liqSupply = (_totalSupply * 100) /100;
    ...
    address private marketingFeeReceiver = 0x4bcD54459b7229199295dD69342c75913686bfDa;
    address private buybackFeeReceiver = 0x4bcD54459b7229199295dD69342c75913686bfDa;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling) { return totalFee.mul(multiplier); }
        return totalFee;
    }
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        reflectionFee = _reflectionFee;
        buybackFee = _buybackFee;
        marketingFee = _marketingFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_marketingFee).add(_reflectionFee);
