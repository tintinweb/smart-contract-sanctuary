...
contract CyberFlow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0); // Marketing Address
    ...
    string private _name = "CyberFlow";
    string private _symbol = "FLOW";
