...
contract SevenKnights is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x0190a5Ff5642AECc5C71957DD154b3F09e0f620d;
    ...
    string private _name = "SevenKnights";
    string private _symbol = "SKnights";
    ...
    uint256 public _maxTxAmount = 1000000000000000000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 800000000000000000000000 * 10**6 * 10**18;
