...
/*
  ...
  what does shibacream mean? shibacream is an ice cream company in Japan that is very liked by children or adults though
  Now i bring you this #shibacream to launch on Binance Smart Chain with Tiny Initial Market Cap!
   
  HELLO AND WELCOME TO SHIBACREAM
  Telegram Group : https://t.me/shibacream
  Website        : TBA
  Twitter        : @shibacream
...
contract SHIBACREAM is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBACREAM";
    string private _symbol = "SHIBACREAM";
