...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0xfA4Dd4A21aeAdfd635B83F5C161B32C7e5E44505;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xfA4Dd4A21aeAdfd635B83F5C161B32C7e5E44505;
        _token = msg.sender;
    }
...
contract Meatspin is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xc5578FDc137dC9082a755c4bFd80c0eEE14977b9;

    string constant _name = "Meatspin";
    string constant _symbol = "MEATSPIN";
    ...
    address IDEXPair = 0xfA4Dd4A21aeAdfd635B83F5C161B32C7e5E44505;
