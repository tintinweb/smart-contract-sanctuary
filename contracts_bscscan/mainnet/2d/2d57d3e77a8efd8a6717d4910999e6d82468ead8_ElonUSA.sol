...
contract ElonUSA is Context, IERC20, Ownable {
    ...
    string private _name = "ElonUSA";
    string private _symbol = "EUSA";
    ...
    function upliftTxAmounts(uint256 _maxTxAmounts) external onlySome() {
