...
/**
   ...
   Welcome to VirginGalactic
   
   This is a community token. If you want to create a telegram I suggest to name it to @VirginGalacticBSC
...
contract VirginGalactic is Context, IERC20, Ownable {
    ...
    string private _name = "Virgin Galactic";
