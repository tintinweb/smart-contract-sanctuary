...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  SpacePort = IBEP20(0x7f60375245cbF30A4F1FFd1278e3601FadCa2C4D);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = SpacePort.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        path[1] = address(SpacePort);
        ...
        uint256 amount = SpacePort.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            SpacePort.transfer(shareholder, amount);
...
contract BabySpacePort is IBEP20, Auth {
    using SafeMath for uint256;

    address SpacePort = 0x7f60375245cbF30A4F1FFd1278e3601FadCa2C4D;
    address WBNB = 0x82190B7e0998cAA0d1B2d07eca951DfaE903B43D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "BabySpacePortUniverse";
    string constant _symbol = "SPUB";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xD74Cfdb1D823588219B009047c0bd0bE8321181B;
        marketingFeeReceiver = 0xD74Cfdb1D823588219B009047c0bd0bE8321181B;
