...
/**
    ...
    __  __ __  ______    ___         __  __ __    ___    ___  ___ ___  _____
   /  ]|  |  ||      |  /  _]       /  ]|  |  |  /  _]  /  _]|   |   |/ ___/
  /  / |  |  ||      | /  [_       /  / |  |  | /  [_  /  [_ | _   _ (   \_ 
 /  /  |  |  ||_|  |_||    _]     /  /  |  _  ||    _]|    _]|  \_/  |\__  |
/   \_ |  :  |  |  |  |   [_     /   \_ |  |  ||   [_ |   [_ |   |   |/  \ |
\     ||     |  |  |  |     |    \     ||  |  ||     ||     ||   |   |\    |
 \____| \__,_|  |__|  |_____|     \____||__|__||_____||_____||___|___| \___|
...
contract CuteCheems is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2dB11A761Ef4ecd42628461dF0517fC62c73c08F); 
    ...
    uint256 private _tTotal = 1000* 10**6 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CuteCheems";
    string private _symbol = "CUTECHEEMS";
    ...
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**12;
    uint256 private minimumTokensBeforeSwap = 1000 * 10**6 * 10**12; 
