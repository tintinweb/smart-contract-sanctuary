...
contract Sprotocol {
    ...
    constructor(address allocationsContract) public
    {
        ...
        totalSupply = 10000000*10**18;    // initial supply: 10000000 WTSD 
        name = "Sprotocol";               // Synchronized Protocol´s display name
        symbol = "WTSD";                  // symbol for display purposes
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        require(to != address(this),"Molecules contract can't receive WTSD.");
