...
contract NFUNK is Context, IERC20, Ownable {
    ...
    string private _name = "NFUNKTEST";
    string private _symbol = "NFUNKTEST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x391b3803d769f7D8E30f72Ba6fDdCC6b927453E8); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x3a3eeC65296017533C3c832aBAa110725A1898DF); // buyback Address
    ...
    uint256 private _totalSupply = 1 * 10**9 * 10**9; //1B _totalSupply
    uint256 public _maxTxAmount = 5 * 10**6 * 10**9; //25% - of Max Wallet 5M
    uint256 public _walletMax = 20 * 10**6 * 10**9; //2% 20M
