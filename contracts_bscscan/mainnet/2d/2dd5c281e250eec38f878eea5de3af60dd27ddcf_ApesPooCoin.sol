...
contract ApesPooCoin is IBEP20, Auth {
    using SafeMath for uint256;

    address POOCOIN = 0xB27ADAfFB9fEa1801459a1a81B17218288c097cc;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x4aFb6a71103e57Ace17C94FbA6245A63eAcf7e79;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ApesPooCoin";
    string constant _symbol = "ApesPoo";
