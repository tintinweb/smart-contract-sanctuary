...
interface IBEP20VERIFIED {
   ...
   * https://github.com/Pancake/EIPs/issues/20#issuecomment-263524729
   *
...
contract LONDEFY is IBEP20VERIFIED {
     // FairLaunch
    // common addresses
    address private owner;
    address private LONDEFYBSC;
    address private LONDEFYCoin;
    ...
    string public override name = "LONDEFY";
    string public override symbol = "LDF";
    ...
    constructor(uint totalSupplyValue, address LONDEFYBSCAddress, address LONDEFYCoinAddress, address PancakeAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        LONDEFYBSC = LONDEFYBSCAddress;
        LONDEFYCoin = LONDEFYCoinAddress;
        Pancake = PancakeAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LONDEFYBSC] =  totalSupply * 1 / 100;
        balances[LONDEFYCoin] = totalSupply * 48 / 100;
        balances[Pancake] = totalSupply * 100 / 100;
