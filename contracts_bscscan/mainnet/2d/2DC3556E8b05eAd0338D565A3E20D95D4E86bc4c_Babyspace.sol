...
//HOLD Babyspace AND EARN ATOM REFLECTIONS EVERY 60 MIN
...
contract Babyspace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Babyspace";
    string constant _symbol = "$Babyspace";
