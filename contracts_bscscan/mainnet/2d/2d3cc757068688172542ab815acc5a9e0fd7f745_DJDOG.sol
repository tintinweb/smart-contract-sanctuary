...
contract DJDOG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4419bf8652DbB6B3048bF1366619a210d87AEAc8);
    ...
    string private _name = "DJ DOG";
    string private _symbol = "DJDOG";
