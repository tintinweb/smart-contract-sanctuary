...
contract Yellowcoin is IERC20, Ownable, Pausable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant public name = "Yellowcoin";
    string constant public symbol = "Yellowcoin";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 30, "Yellowcoin: transaction fee percentage exceeds 30");
        require(feePercentage_ >= 0, "Yellowcoin: transaction fee percentage equals 0");
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "Yellowcoin: transfer from blacklisted address");
        require(!isBlacklisted[recipient], "Yellowcoin: transfer to blacklisted address");
        require(!isBlacklisted[tx.origin], "Yellowcoin: transfer called from blacklisted address");
