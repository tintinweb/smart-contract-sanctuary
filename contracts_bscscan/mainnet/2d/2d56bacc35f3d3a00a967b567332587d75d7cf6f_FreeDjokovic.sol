...
contract FreeDjokovic is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 1000000000 * 10 ** 18;
    string private _name = "Free Djokovic Token";
    string private _symbol = "FreeDjokovic";
    uint8 private _decimals = 18;
    // mia altra address
    address public rewardAddress = 0x32b47C3d1a8fbF57c31e233571497f0EA11eb669;
    ...
    constructor() {
        ...
        // questa giu e' la rete TEST, quello su rete Effettiva
