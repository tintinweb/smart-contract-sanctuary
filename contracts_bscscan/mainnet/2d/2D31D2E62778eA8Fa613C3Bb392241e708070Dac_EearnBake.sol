...
contract EearnBake is Context, IERC20, Ownable {
    ...
    string private _name = "Eearn Baby Bake";
    string private _symbol = "EARNBAKE";
    ...
    uint256 private constant _Burn_FEE = 1000; // 1%
