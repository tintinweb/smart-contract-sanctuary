...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable ADAToken = address(0x250632378E573c6Be1AC2f97Fcdf00515d0Aa91B);
...
contract CUPCAKE is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 200000000000000 * (10**18); //20% of total supply
    uint256 public maxSellTransactionAmount = 0 * (10**18);
    uint256 public swapTokensAtAmount = 2000000000 * (10**18);
    uint256 public _maxWalletToken = 1000000000000 * (10**18); // 0.1% of total supply
