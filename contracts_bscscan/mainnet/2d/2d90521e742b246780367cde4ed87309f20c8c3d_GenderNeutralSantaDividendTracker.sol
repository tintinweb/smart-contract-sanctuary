...
https://t.me/GenderNeutralSanta 
Santa is coming home to the BSCnetwork. 
*/
...
contract Santa is ERC20, Ownable {
    ...
    GenderNeutralSantaDividendTracker public dividendTracker;
    ...
    uint256 public ADARewardsRewardsFee = 4;
    ...
    address public _marketingWalletAddress = 0x927DC13950f03DdB1f9519711DCBC9267bF12ca0;
    address public _devWalletAddress = 0xdadBce6Ce4722A65c626961d58b0415dDcD5f2d7;
    ...
    constructor() public ERC20("Gender Neutral Santa", "GENES") {

    	dividendTracker = new GenderNeutralSantaDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        GenderNeutralSantaDividendTracker newDividendTracker = GenderNeutralSantaDividendTracker(payable(newAddress));
...
contract GenderNeutralSantaDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Gender Neutral Santa Dividends", "Gender Neutral Santa_dividends") {
    	claimWait = 3600;
