...
Initial Supply: 6900000 tokens
Max Wallet: 1%

Tax: 
10% buy
40% sell at launch, will be lowered after launch, just to fuck the bots
...
//SupremeCheems Contract /////////////

contract SupremeCheems is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SupremeCheems';
    string private constant _symbol = 'SUP';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 6900000 * 10**_decimals;//equals 500B tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0xc8A4333F4CcA1b2dA984F0E6E7d98234BAec1359);
    address public devWallet=payable(0xe6497e1F2C5418978D5fC2cD32AA23315E7a41Fb);
    //TestNet
	...
	uint256 private antiWhale = 69000 * 10**_decimals;
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==TeamWallet||addr==devWallet;
    }
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = contractBalance / 10;
        if(contractBalance<_circulatingSupply/10000){
            tokenToSwap = _circulatingSupply/10000;
        }
        ...
        //Get the BNB balance after LP generation to get the Marketing tax
        marketingBalance += (address(this).balance);
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(TeamWallet).transfer((amount*83) / 100);
        payable(devWallet).transfer((amount*16) / 100);
    } 
    ...
    function TeamSetTaxes(uint8 burnTaxes, uint8 liquidityTaxes, uint8 marketingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyOwner{
    ...
    function TeamIncreaseLockLiquidityInSeconds(uint256 secondsUntilUnlock) public onlyOwner{
