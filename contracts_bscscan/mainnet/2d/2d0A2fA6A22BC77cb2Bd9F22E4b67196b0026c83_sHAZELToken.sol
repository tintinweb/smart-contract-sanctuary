...
contract sHAZELToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked HAZEL", "sHAZEL", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHAZEL supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHAZEL
