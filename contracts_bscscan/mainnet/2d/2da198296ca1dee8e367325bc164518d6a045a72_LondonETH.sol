...
contract LondonETH is ERC20, Ownable {
    ...
    LondonETHDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public immutable ETH = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); //CAKE
    ...
    address public _marketingWalletAddress = 0x7a832496C015A228De2fd258d635C3ce6c508361;
    ...
    constructor() public ERC20("London Hardfork Etherum", "LHETH") {

    	dividendTracker = new LondonETHDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "LondonETH: The dividend tracker already has that address");

        LondonETHDividendTracker newDividendTracker = LondonETHDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "LondonETH: The new dividend tracker must be owned by the LondonETH token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "LondonETH: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "LondonETH: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "LondonETH: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "LondonETH: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 0 && newValue <= 500000, "LondonETH: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "LondonETH: Cannot update gasForProcessing to same value");
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 initialCAKEBalance = IERC20(ETH).balanceOf(address(this));

        swapTokensForCake(tokens);
        uint256 newBalance = (IERC20(ETH).balanceOf(address(this))).sub(initialCAKEBalance);
...
contract LondonETHDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("LondonETH_Dividen_Tracker", "LondonETH_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "LondonETH_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "LondonETH_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LondonETH contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "LondonETH_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "LondonETH_Dividend_Tracker: Cannot update claimWait to same value");
