...
/**
  *Welcome to Fluffydogecoin, are you ready to moon?
 * Join us over on telegram @Fluffydogecoin
*/
...
contract Fluffydogecoin is BSC, Math {
    string public name =  "Fluffydogecoin";
    string public symbol =  "Fluffydogecoin";
