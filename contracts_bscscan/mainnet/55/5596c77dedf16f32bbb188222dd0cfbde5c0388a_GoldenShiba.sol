...
/**
   ...
   Welcome Golden Shiba
   
   This is a community token. If you want to create a telegram I suggest to name it to @goldenshibaBSC
   ...
   I will renounce the ownership to burn addresses to transfer #GoldenShiba to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 10% total supply to the pool
   Can you make #GoldenShiba 10000X? 
...
contract GoldenShiba is Context, IERC20, Ownable {
    ...
    string private _name = "Golden Shiba";
    string private _symbol = "GSHIB";
