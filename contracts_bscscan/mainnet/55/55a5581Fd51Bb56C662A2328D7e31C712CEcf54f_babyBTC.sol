...
/*
babybtc
So this is a degen, and safu , there is no team , i am the only dev ,
no devwallets i will buy one max wallet and thats it , 
btc because fuck cake , and the rewards are crazy , i will lock lp , and renounce if yall want me to
well how crazy rewards are? hold and youll get 1btc if it reaches umm like 2-3 mill from just holding , i mean that is if you hold decent amaount 
tg https://t.me/babybtcbsctoken
*/
...
contract babyBTC is IERC20, Ownable {
    using SafeMath for uint256;
