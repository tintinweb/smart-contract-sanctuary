...
// Earn Kurai Metaverse by holding Baby Kurai 
// Name: Baby Kurai
// Symnol; BBYKURAI
// Decimal: 9
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  KURAI = IBEP20(0x027b19B319f4381F20060606459C055c14791db1);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = KURAI.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(KURAI);
        ...
        uint256 amount = KURAI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            KURAI.transfer(shareholder, amount);
...
contract BabyKurai is IBEP20, Auth {
    using SafeMath for uint256;

    address KURAI = 0x027b19B319f4381F20060606459C055c14791db1;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby Kurai";
    string constant _symbol = "BBYKURAI";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x81B29d3ba5da67562af312896c0c8ae0c2147432;
