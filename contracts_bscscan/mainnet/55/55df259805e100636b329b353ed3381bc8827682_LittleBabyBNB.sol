...
/**
   ...
   Welcome to LittleBabyBNB
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyBNBBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyBNB to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyBNB idea, increasing the liquidity pool automatically, 
...
contract LittleBabyBNB is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby BNB";
    string private _symbol = "LTBABYBNB";
