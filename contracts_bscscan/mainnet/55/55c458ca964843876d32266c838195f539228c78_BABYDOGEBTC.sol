...
/**
    BABY DOGE BTC - The Bitcoin reflection token! 
    Simply hold Baby Doge BTC tokens in your wallet to earn free Bitcoin.
*/
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//BABYDOGEBTC Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BABYDOGEBTC is IBEP20, Ownable
{
	...
	address _BTCBTokenAddress = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    ...
    //Token Info 
    string private constant _name = 'BABY DOGE BTC';
    string private constant _symbol = 'BABYDOGEBTC';
    uint8 private constant _decimals = 9;
    uint8 private constant _ZEROES = 0;
    uint256 public constant InitialSupply= 100 * 10**7 * 10**_decimals; //equals 100.000.000 token
    ...
    address public constant TeamWallet=0x943748E4ae760C67F6C0b3d47aFE212274200bEB;
    ...
    uint8 public constant MaxTax=16;
    ...
    constructor () {
       ...
       emit Transfer(address(0), address(this),injectBalance);
        ...
        _buyTax=16;
        _sellTax=16;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=16;
        //97% gets burned
        _burnTax=2;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimFarmedToken(sender, _BTCBTokenAddress);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
	...
	function BUSDWithdraw() public {
		claimFarmedToken(msg.sender, _BTCBTokenAddress);
	}
