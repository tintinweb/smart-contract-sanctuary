...
contract BeePool is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address FREEETH = 0x64260D965be21d7dD8293e9b77177F81627f917A;
    ...
    string private _name = "BeePool";
    string private _symbol = "BeePool";
    ...
    constructor() {
        ...
        _isExcludedFromFee[FREEETH] = true;
        _isExcludedFromReward[FREEETH] = true;
    ...
    function _transferBurn(uint256 tBurn) private {
        uint256 currentRate = _getRate();
        uint256 rBurn = tBurn.mul(currentRate);
        _rOwned[FREEETH] = _rOwned[FREEETH].add(rBurn);
        if (_isExcludedFromReward[FREEETH]) _tOwned[FREEETH] = _tOwned[FREEETH].add(tBurn);
    }
    ...
    function _transferFromExcluded(
        ...
        emit TransferBurn(sender, FREEETH, tBurn);
