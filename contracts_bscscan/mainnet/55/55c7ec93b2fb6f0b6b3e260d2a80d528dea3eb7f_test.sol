...
contract test is IERC20, Ownable {
    ...
    // LIMITTER
    uint256 public _maxBuyTxAmount = (_totalSupply * 10) / 1000; // 1.0% MAX 1,000,000,000
    uint256 public _maxSellTxAmount = (_totalSupply * 2) / 1000; // 0.25% MAX 250,000,000
    uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; // 4% MAX 4,000,000,000
    ...
    uint256 reflectionFee = 200; // 10%
    uint256 devFee = 800; // 7%
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x26a738214711bd213828dEb2BF14e1c5D1174B6c);
