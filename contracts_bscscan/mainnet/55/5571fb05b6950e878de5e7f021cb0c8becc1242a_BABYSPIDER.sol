...
/**
   ...
   Welcome to BABYSPIDER
   
   This is a community token. If you want to create a telegram I suggest to name it to @BABYSPIDERBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BABYSPIDER to the community, make sure it's 100% safe.

   I will add .1 BNB and all the left 10% total supply to the pool
   Can you make #BABYSPIDER 10000X? 
   ...
   it's the best part of the #BABYSPIDER idea, increasing the liquidity pool automatically, 
...
contract BABYSPIDER is Context, IERC20, Ownable {
    ...
    string private _name = "BABYSPIDER";
    string private _symbol = "BABYSPIDER🕷";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x8a7B5E08a9ABC50117A8C9246C2f8EF2FC6366aa, 'We can not exclude Uniswap router.');
