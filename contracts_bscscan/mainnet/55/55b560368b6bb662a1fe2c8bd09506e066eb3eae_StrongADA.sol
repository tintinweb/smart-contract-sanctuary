...
StrongADA is a Token inspired by CARDANO achievements,
based on the idea of trying to create a small community
that can provide all necessaries needed to create an ADA
version in Low Market Cap world. Our $SADA token will be having
12% of ADA reflection to all Holders. All safety measure will be provided as well
to gain the investors trust, which is the only thing we need for taking this to an other level.
EARN ADA BY HOLDING $SADA.
And please keep in mind, StrongADA is a token to hold
...
contract StrongADA is Context, IBEP20, Ownable {
