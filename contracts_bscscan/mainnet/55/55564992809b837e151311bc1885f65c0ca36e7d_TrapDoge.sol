...
/**
 Welcome to TrapDoge
   ...
   I will renounce the ownership to burn addresses to transfer #TrapDoge to the community

   I will add 1.3 BNB and all the left 10% total supply to the pool
   Can you make TrapDoge 100X? 
   ...
   it's the best part of the #TrapDoge idea, increasing the liquidity pool automatically, 
