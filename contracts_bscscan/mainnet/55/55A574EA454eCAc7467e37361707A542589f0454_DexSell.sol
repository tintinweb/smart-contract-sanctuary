...
/**
  _             _                     _                       _            _                               _        
 | |_    ___   | | __   ___   _ __   | |__     __ _   _ __   | | __     __| |   ___  __  __  ___    __ _  | |   ___ 
 | __|  / _ \  | |/ /  / _ \ | '_ \  | '_ \   / _` | | '_ \  | |/ /    / _` |  / _ \ \ \/ / / __|  / _` | | |  / _ \
 | |_  | (_) | |   <  |  __/ | | | | | |_) | | (_| | | | | | |   <    | (_| | |  __/  >  <  \__ \ | (_| | | | |  __/
  \__|  \___/  |_|\_\  \___| |_| |_| |_.__/   \__,_| |_| |_| |_|\_\    \__,_|  \___| /_/\_\ |___/  \__,_| |_|  \___|
...
contract DexSell {
  ...
  uint public constant _duration = 1 minutes;
  uint public immutable _end;
  ...
  function swapBNBToToken() external payable  {
    ...
    bnbp.div(100000000);
      ...
      uint price = dolarRate * bnbp;
      uint tokenAmount = amountBuy.mul(price);

      _walletSale.transfer(amountBuy);
      IERC20(_sellToken).transfer(msg.sender, tokenAmount);
  }

  function swapUsdToToken(uint usdtAmount) external {
    uint price = dolarRate;
    uint tokenAmount = usdtAmount.mul(price);
    IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7).transferFrom(msg.sender, address(this), usdtAmount);

    IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7).transfer(_walletSale, usdtAmount);    
    IERC20(_sellToken).transfer(msg.sender, tokenAmount);
  }  
