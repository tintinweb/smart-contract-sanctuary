...
contract Strategy_BANANA_BNB {
    // This strategy is for BSC network. BANANA - BNB pair. 
    // RewardToken = "cake" internally, but a symbol is BANANA
    ...
    address public constant farm = 0x5c8D727b265DBAfaba67E050f2f739cAeEB4A6F9;
    address public router = 0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7;
    // ------------>        END          <--------------
    ...
    function _swapToYELs(uint256 _percent) internal returns (uint256 newYelBalance){ 
        ...
        _approveToken(WBNB, router);
        _swapWBNBToToken(router, YELtoken);
