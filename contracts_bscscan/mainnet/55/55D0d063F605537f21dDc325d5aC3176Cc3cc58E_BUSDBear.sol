...
/**
💵 BUSD BEAR 💵
TELEGRAM: https://t.me/BUSDBear

BUSD Bear is tired of changing prices. He hates them! This is exactly the reason why when you buy the BUSD Bear, 
you will ONLY get your hourly reflections in BUSD so that you always know how much money you got. 

BUSD Bear hates taxes too. That is why his taxes are only 10% on each transaction with 7% for reflection and 3% for 
automatic liquidity which helps stabilize the price floor. In other words 60% of the taxes are given back to the community!

Our plan is simple: Stealth launch and then go CRAZY on marketing. 
...
contract BUSDBear is Context, IBEP20, Ownable {
    ...
    string private _name = "BUSD Bear";
    string private _symbol = "BUSDB";
    ...
    uint256 public _liquidityFee = 3; //consists of buyback + liq + dividends tax 
    ...
    uint256 public _intervalSecondsForSwap = 1 * 5 seconds;

    // Fee per address

    uint256 public _maxWallet = 50000000000000 * 10**9;
    ...
    address payable public buybackAddress = payable(0xf54cF8Bc3Bd99eE95A917A834fcF36b6F3b6A1EA);
    address payable public lpAddress = payable(0xf54cF8Bc3Bd99eE95A917A834fcF36b6F3b6A1EA);
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 101, "tax too high");
        _taxFee = taxFee;
    }
        
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        require(liquidityFee < 101, "tax too high");
