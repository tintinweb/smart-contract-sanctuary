...
contract Crowdsale {
    ...
    constructor () public {
        _rate = 200;
        _wallet = 0xF646C43Eaf00A38b401bA2e49C7dDCBDffC001f2;
        _token = IERC20(0x5505c15752F11F17e0c090756875a19A81C3865a);
        owner = 0x1E242438c9026c5fb71B5914B2d04D8015209e93;
    }
modifier onlyOwner(){
    ...
    function buyTokens() public payable {
        require(msg.value >= 0.25 ether,"Value must be greater than or equal to 0.5 ethers");
