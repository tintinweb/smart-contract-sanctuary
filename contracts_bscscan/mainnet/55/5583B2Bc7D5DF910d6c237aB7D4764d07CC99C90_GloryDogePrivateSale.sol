 ...
 */
contract GloryDogePrivateSale is Context, Ownable {
    ...
    uint256 private _privateSaleCap = 200 * 10**_decimals;
    uint256 private _minContribution = (1 * 10**_decimals) / 10;
    uint256 private _maxContribution = 3 * 10**_decimals;
    uint256 private _amountPerBNB = 240000000000 * 10**_decimals;
    ...
    constructor(address gloryDogeContract_) {
    ...
    function claimTokens() public {
        ...
        uint256 _contribution = _contributions[_msgSender()];
