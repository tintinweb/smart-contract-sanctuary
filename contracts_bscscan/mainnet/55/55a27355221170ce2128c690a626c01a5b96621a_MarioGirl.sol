...
contract MarioGirl is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "MarioGirl";
   string constant _symbol = "MarioG";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xc5a9A3FD8382DcFd4af276BFd5Ba778211079d77;
