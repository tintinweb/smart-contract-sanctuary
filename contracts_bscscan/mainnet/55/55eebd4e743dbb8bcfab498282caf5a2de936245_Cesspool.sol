...
/*
 *  Cesspool Token
 *  Current website: https://cesspooltoken.com
 *  TG: https://t.me/cesspooltoken
*/
...
contract CesspoolDividendDistributor is IDividendDistributor {
...
contract Cesspool is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "The Cesspool Token";
    string constant _symbol = "THECesspool";
    ...
    */
    ...
    CesspoolDividendDistributor public distributor;
    ...
    constructor (
        ...
        distributor = new CesspoolDividendDistributor(address(router));
    ...
    function setDistributor(CesspoolDividendDistributor dist)external authorized {
        distributor = dist;
    }
