...
contract ApolloSpaceToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1100000000 * 10**3 * 10**9;
    ...
    uint256 public _maxTxAmount = 1100000000 * 10**3 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 550000 * 10**3 * 10**9;
