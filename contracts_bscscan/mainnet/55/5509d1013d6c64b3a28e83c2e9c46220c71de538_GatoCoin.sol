...
/**
 *  http://gatocoin.finance/
 *  http://gatocoin.finance/
 +-+-+-+ +-+-+-+-+-+-+-+-+-+-+
 |B|u|y| |$|G|a|t|o|C|o|i|n|t|   
 +-+-+-+ +-+-+-+-+-+-+-+-+-+-+
                                 http://gatocoin.finance/
                                 http://gatocoin.finance/
 * /
...
/**
  ...
  / ____|     | |       / ____|    (_)       |  ____(_)                           
 | |  __  __ _| |_ ___ | |     ___  _ _ __   | |__   _ _ __   __ _ _ __   ___ ___ 
 | | |_ |/ _` | __/ _ \| |    / _ \| | '_ \  |  __| | | '_ \ / _` | '_ \ / __/ _ \
 | |__| | (_| | || (_) | |___| (_) | | | | |_| |    | | | | | (_| | | | | (_|  __/
  \_____|\__,_|\__\___/ \_____\___/|_|_| |_(_)_|    |_|_| |_|\__,_|_| |_|\___\___|
...
/**
    ...
    1% Burn (sent to a dead wallet)- 0x000000000000000000000000000000000000dEaD
    2%  development wallet (accessible by the Dev team)
*/
...
contract GatoCoin is Context, IBEP20, Ownable, Pausable {
    ...
    string private _name = "GatoCoin";
    string private _symbol = "Gato";
    ...
    uint256 public _GatoDevTeam = 2;
    uint256 private _previousGatoDevTeam = _GatoDevTeam;

    uint256 public _GatoMarketingTeam = 4;
    uint256 private _previousGatoMarketingTeam = _GatoMarketingTeam;
    ...
    address public _GatoDevAddress = 0x0d4842b5C54E3116c5d6BfA598066D1592848dC0;
    address public _GatoMarketingAddress = 0x38390CD2176bbcf5205B6D97a79A502aD9958DF7;
    ...
    function setGatoDevAddress(address account) external onlyOwner() {
        _GatoDevAddress = account;
    }

    function setGatoMarketingAddress(address account) external onlyOwner() {
        _GatoMarketingAddress = account;
    }
    ...
    function setGatoDevTeamPercent(uint256 fee) external onlyOwner() whenNotPaused {
        _GatoDevTeam = fee;
    }

    function setGatoMarketingTeam(uint256 fee) external onlyOwner() whenNotPaused {
        _GatoMarketingTeam = fee;
    }

    function setBurnFeePercent(uint256 burnFee) external onlyOwner() whenNotPaused {
        _burnFee = burnFee;
    }
    ...
    function calculateGatoDevTeam(uint256 _amount) private view returns (uint256){
        return _amount.mul(_GatoDevTeam).div(
           10**2
        );
    }

    function calculateGatoMarketingTeam(uint256 _amount) private view returns (uint256){
        return _amount.mul(_GatoMarketingTeam).div(
           10**2
        );
    }
    ...
    function removeAllFee() private {
        ...
        _previousGatoDevTeam = _GatoDevTeam;
        _previousGatoMarketingTeam = _GatoMarketingTeam;
        _previousBurnFee = _burnFee;

        _taxFee = 0;
        _liquidityFee = 0;
        _GatoDevTeam = 0;
        _GatoMarketingTeam = 0;
        _burnFee = 0;
    }
    ...
    function restoreAllFee() private {
        ...
        _GatoDevTeam = _previousGatoDevTeam;
        _GatoMarketingTeam = _previousGatoMarketingTeam;
    ...
    function _transfer(
        ...
        if (takeFee){
            uint256 toDevMarket = calculateGatoDevTeam(amount);
            uint256 toLottery = calculateGatoMarketingTeam(amount);
            ...
            _tokenTransfer(from, _GatoDevAddress, toDevMarket, false);
            _tokenTransfer(from, _GatoMarketingAddress, toLottery, false);
            _burnToken(toBurn);
