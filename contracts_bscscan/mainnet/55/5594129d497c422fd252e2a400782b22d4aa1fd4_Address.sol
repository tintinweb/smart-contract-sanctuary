...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4795A27b6ed84B343A6C9bf5051CfC9e4eE04B5c;
...
contract FlokiMoonBSC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA7D01DFFCd4204cAb62496bf07b925A151c49363;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Floki Moon BSC";
    string private _symbol = "FMBSC";
