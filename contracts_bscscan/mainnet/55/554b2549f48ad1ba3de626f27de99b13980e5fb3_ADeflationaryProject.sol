...
/**
     * 4% of them are transferred to the black hole and destroyed permanently
     * 4% as a dividend for the address holding the token
     * 2% automatically returns to the Liquidity pool
     */
