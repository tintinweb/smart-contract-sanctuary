...
contract Ownable is Context {
    address private _owner = 0xfE6D8dA4Cd7f026952de92eC6F56BCCb60e03b31;
...
contract UAW is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x10C09B019C4db2195F0e69B01fdcA5AA7D6b3F2F); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "UAW"; // token name
    string private _symbol = "UAW"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 3000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
