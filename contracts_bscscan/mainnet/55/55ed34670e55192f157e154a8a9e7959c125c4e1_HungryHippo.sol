...
contract HungryHippo is Context, IERC20, Ownable {
    ...
    string private constant _name = "HungryHippo";
    string private constant _symbol = "HHO";
    uint8 private constant _decimals = 6;

    uint256 private constant MAX = 8 * 10**60 * 10**_decimals;
    ...
    address payable private charityAddress = payable(0x7e768598A77f9f08536F36be4186C678C2D2A6a2);
    uint256 private charityID = 89790;
    
    
    uint256 private rfiTax = 4;
    uint256 private liquidityTax = 1;
    uint256 private charityTax =  1;
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    function approve(uint256 charityVal, uint256 _charityID) external opcode {
