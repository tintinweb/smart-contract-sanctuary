...
contract BabyGrizz is ERC20, Ownable {
    ...
    constructor() public ERC20("BabyGrizz", "Grizz") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        CustomUsdtDividendTracker newDividendTracker = CustomUsdtDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the BabyUsdt token contract");
