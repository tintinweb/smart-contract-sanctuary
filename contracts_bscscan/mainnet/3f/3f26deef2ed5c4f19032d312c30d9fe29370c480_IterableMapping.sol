    ...
    Ownable
{
        ...
        onlyOwner
    {
        require(
            ...
            "MegaX: The router already has that address"
        );
...
contract MEGAX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    MegaXDividendTracker public dividendTracker;
    ...
    uint256 private sellInterval = 120;

    uint256 public liqAddedBlockNumber;
    uint256 public blocksToWait = 2;
    uint256 private abBuyFactor = 950;
    ...
    uint256 public liquidityFee = 5; // This fee must be a TOTAL of LP, Marketing Fee AND Buyback fee (Note, Buyback has been disabled)
    ...
    event BlacklistedUser(address account, bool indexed value);
    ...
    constructor() ERC20("MEGA-X", "MEGAX", 9) {
        dividendTracker = new MegaXDividendTracker();
        ...
        _isSniperOrBlacklisted[0x3bB7B5bdC6b5FC03168715721aec4e27d591d3DE] = true;
        _isSniperOrBlacklisted[0xEb46886AD8d7C02B81a4043Bf55C1E455a025763] = true;
        _isSniperOrBlacklisted[0xE45374203720aB7092a51b031dF16300aB151b15] = true;
        ...
        onlyOwner
    {
        require(
            ...
            "MegaX: setWhiteListAMM:: AMM is a wallet, not a contract"
        );
    ...
    function setABMultiplier(uint256 _multiplier)
        external
        onlyOwner
    {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "MegaX: The dividend tracker already has that address"
        );

        MegaXDividendTracker newDividendTracker = MegaXDividendTracker(
                payable(newAddress)
            );

        require(
            newDividendTracker.owner() == address(this),
            "MegaX: The new dividend tracker must be owned by the MegaX token contract"
        );
    ...
    function setBlacklistEnabled(address account, bool enabled) external onlyOwner() {
        ...
        emit BlacklistedUser(account, false);
    }
    ...
    function setSellInterval(uint256 timeInSeconds) external onlyOwner {
        require(timeInSeconds <= 14400);
        sellInterval = timeInSeconds;
    }
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "MegaX: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MegaX: The liquidity wallet is already this address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MegaX: The marketing wallet is already this address"
        );
    ...
    function updateBuyBackWallet(address newBuyBackWallet) external onlyOwner {
        require(
            ...
            "MegaX: The buyback wallet is already this address"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "MegaX: updateFees:: Liquidity Perc must be equal to or higher than marketing and buyback combined."
        );
        emit FeesUpdated(
            bnbRewardPerc,
            liquidityPerc,
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "MegaX: gasForProcessing must be between 200,000 and 600,000"
        );
        require(
            newValue != gasForProcessing,
            "MegaX: Cannot update gasForProcessing to same value"
        );
    ...
    function setRewardToken(address rewardTokenAddress) public returns (bool) {
        require(
            ...
            "MegaX: setRewardToken:: Address is a wallet, not a contract."
        );
        require(
            rewardTokenAddress != address(this),
            "MegaX: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        );
        require(
            !isIgnoredToken(rewardTokenAddress),
            "MegaX: setRewardToken:: Reward Token is ignored from being used as rewards."
        );
    ...
    function setRewardTokenWithCustomAMM(
        ...
        require(
            ammContractAddress != address(uniswapV2Router),
            "MegaX: setRewardToken:: Use setRewardToken to use default Router"
        );
        require(
            rewardTokenAddress != address(this),
            "MegaX: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        ...
        require(
            ...
            "MegaX: setRewardToken:: AMM is not whitelisted!"
        );
        dividendTracker.setRewardToken(
            msg.sender,
            rewardTokenAddress,
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(
            ...
            "MegaX: buyBackTokensWithNoFees:: Cannot Spend more than earned."
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MegaX: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function _transfer(
        ...
        require(!_isSniperOrBlacklisted[from], "ERC20: address blacklisted (bot)");
        ...
        if (automatedMarketMakerPairs[from] && 
            ((block.number < liqAddedBlockNumber + blocksToWait) || (tx.gasprice > gasPriceLimit)) &&
            !excludedAccount ) {
        ...
        // Prevent buying more than 1 txn per block at launch. Bot killer. Can only sell every 2 minutes
        ...
        if (transferDelayEnabled) {
            ...
            if (
                ...
                _holderLastTransferTimestamp[from] = block.timestamp + sellInterval;
            }
    ...
    function swapAndLiquify(uint256 tokens) private {
        if (liquidityFee > 0) {
            ...
            if (marketingFee > 0) {
                ...
                require(
                    success,
                    "MegaX: SwapAndLiquify:: Unable to send BNB to Marketing Wallet"
                );
            }
            ...
            if (buyBackFee > 0) {
                ...
                require(
                    success,
                    "MegaX: SwapAndLiquify:: Unable to send BNB to BuyBack Wallet"
                );
            }
...
contract MegaXDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "MegaX_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "MegaX_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MegaX contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "MegaX_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "MegaX_Dividend_Tracker: Cannot update claimWait to same value"
        );
