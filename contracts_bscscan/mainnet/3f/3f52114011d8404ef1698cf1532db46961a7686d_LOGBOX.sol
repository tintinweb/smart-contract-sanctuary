...
contract LOGBOX is Context, IERC20, Ownable {
    ...
    string private _name = "LOG BOX";
    string private _symbol = "LOGX";
    ...
    address public ownerAddres = address(0x72d08E1b2Ed976c94aaAd29FcA97Fed33b31d71c);
    address public devAddress = address(0x72d08E1b2Ed976c94aaAd29FcA97Fed33b31d71c);
    ...
    uint256 public feeAllTotal = 1 * 10 **9;
