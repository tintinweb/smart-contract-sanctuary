 ...
 */
contract VenusBNBVault is ERC20, Ownable {
    ...
    {
        return IVenusStrategy(strategy).getDividendsCollected();
    }
    ...
    {
        return IVenusStrategy(strategy).getVaultTokensSwappedFor();
    }
    ...
    {
        return IVenusStrategy(strategy).getAPR();
    }
    ...
    {
        return IVenusStrategy(strategy).getReinvestmentPeriods();
    }
    ...
    {
        return IVenusStrategy(strategy).getInitialBalanceForAPR();
    }
    ...
    function inCaseTokensGetStuck(address _token) external onlyOwner {
        require(_token != address(wbnb), "!token");
