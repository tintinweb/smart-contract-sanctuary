...
/*
🥮 Welcome to The FruitCake Token
The sweet taste of fresh and juicy fruit. We added them to a delicious cake. This is how we made FRUITCAKE! 🥮

🍧 Based Dev
🎂 Based Team
🍰 Insane Rewards 15% In CAKE
🍡 Great Marketing In Bound
🍪 Huge Listings Are Coming Soon After Launch (CG & CMC)
🍨 Major Influencers At Launch
🍭 Liquidity Will Be Locked At Launch

📱TG: https://t.me/fruitcakeofficial
*/
...
contract Fruitcake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FruitCake", "FruitCake") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setPercentagerewardsFee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function setLiquidity(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function set_enableBuy_fee(uint256 value) external onlyOwner {
            buyFee = value;
        }
