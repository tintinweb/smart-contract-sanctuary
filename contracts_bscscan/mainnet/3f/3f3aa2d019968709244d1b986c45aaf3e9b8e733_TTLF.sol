...
contract TTLF is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x3CEBDBEdEB1e334F21d15b48b0C5504c1FB91e2c;
    string constant _name = "Talea Floki";
    string constant _symbol = "TTLF";
    uint8 constant _decimals = 8;
    uint256 _totalSupply = 420  * (10 ** _decimals);
    uint256 public _maxTxAmount = 5  * (10 ** _decimals);     // 1%
    uint256 public _maxWalletToken = 10  * (10 ** _decimals);  // 4%
    ...
    uint256 public SellBaseFee = 42;
    uint256 public burnRate = 42;
    ...
    constructor ()  {
        address marketingFeeReceiver = 0x3CEBDBEdEB1e334F21d15b48b0C5504c1FB91e2c;
        owner = msg.sender;
