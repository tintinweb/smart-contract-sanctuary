...
contract InterPrizes is IERC20 {
    ...
    uint256 private constant startingSupply = 200_000; // 200K

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "InterPRIZES";
    string constant _symbol = "iPRIZES";
    ...
    uint256 public _transferReflectionFee = 700;
    uint256 public _transferLiquidityFee = 300;
    uint256 public _transferMarketingFee = 200;
    uint256 public _transferDevFee = 200;

    uint256 constant public maxReflectionFee = 1500;
    uint256 constant public maxLiquidityFee = 600;
    uint256 constant public maxMarketingFee = 600;
    uint256 constant public maxDevFee = 600;
    ...
    address payable private _marketingWallet = payable(0x7DaC978945790E0281c1E30561DA564503427f11);
    address payable private _devWallet = payable(0x58BF2a4e33F2eC431d8D4B650Fd263bc3461C0f5);
    ...
    Cashier reflector;
    uint256 reflectorGas = 60000;

    bool public swapAndLiquifyEnabled = false;
    bool public processReflect = false;
    uint256 private swapThreshold = _tTotal / 400;
    uint256 private swapAmount = _tTotal * 5 / 2000;
    ...
    constructor (uint _gasPriceLimit, address cInitializer) payable {
        ...
        _isFeeExcluded[0x20EBCE2f203c9FCD23779fde67299Bd884b10035] = true;
        _isDividendExcluded[0x20EBCE2f203c9FCD23779fde67299Bd884b10035] = true;
