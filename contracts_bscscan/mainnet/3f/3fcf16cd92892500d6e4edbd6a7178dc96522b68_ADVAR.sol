 ...
 * 
Launchpad
Scanner for detecting faulty and suspicious contracts
Contract audits
ADVAR token creator
ADVAR bulk token sender for BSC, Solana, eth networks
Bridging to other chains like Solana and Ethereum. 
*/
...
contract ADVAR is Context, IERC20, Ownable {
