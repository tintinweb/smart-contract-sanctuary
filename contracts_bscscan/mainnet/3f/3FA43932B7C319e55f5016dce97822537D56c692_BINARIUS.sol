...
/**
   # BINARIUS FINANCE is a decentralized & deflationary BEP-20 token  wich aims to create an online cryptocurrency trading platform using BINARIUS token as our main trading cryptocurrency. 
   # Check out our website for more information:
   # Website: binarius.xyz

   ------------------------------------------------------
   # Total supply: 1 quadrillion (1,000,000,000,000,000)
   # Burned: 500 trillion (500.000.000.000.000)
   ------------------------------------------------------
   #  4% fee auto add to the liquidity 
   #  2% fee auto distribute to all holders
   #  2% fee auto add to the expenses related to the token.
...
contract BINARIUS is Context, IERC20, Ownable {
    ...
    address public _charityWalletAddress = 0x9d53a4ACb41Ba3eEca18E44Ac0B80fD870B0B443;
    ...
    string private constant _name = "BINARIUS FINANCE";
