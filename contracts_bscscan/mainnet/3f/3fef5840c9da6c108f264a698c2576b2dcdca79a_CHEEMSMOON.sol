...
https://t.me/CHEEMSMOON_Official


3% fee auto add to the liquidity pool to locked
3% fee auto distribute to all holders
8% marketing fee destinated to help the project

I will burn lock LPs and extend as project grows.
I will renounce the ownership to burn addresses to transfer $CHEEMSMOON to the community, make sure it's 100% safe.

100,000,000,000,000,000 total supply
500,000,000,000,000 FomoCheems max limit for per trade
...
pragma solidity ^0.6.12;
    ...
    contract CHEEMSMOON is Context, IERC20, Ownable {
        ...
        string private _name = 'CHEEMSMOON';
        ...
        uint256 private _maxTxAmount = 5000000000000000000000000000000000000000000e9;
