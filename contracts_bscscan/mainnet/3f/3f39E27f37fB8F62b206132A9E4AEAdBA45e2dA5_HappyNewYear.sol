...
contract HappyNewYear is ERC20Detailed, ERC20Burnable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 15000000 * (10 ** uint256(DECIMALS));

    constructor () public ERC20Detailed("Happy New Year!", "Happy New Year!", DECIMALS) {
        _mint(0xEF902D37d65265A21Af2Ce4aA4b3960609a5f55f, 15000000 ether);
