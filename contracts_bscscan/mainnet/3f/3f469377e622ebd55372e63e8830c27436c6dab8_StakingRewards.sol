...
contract StakingRewards is Owned, Pausable {
    ...
    uint256 public minimunStake1 = 500 *1e18;
    uint256 public minimunStake2 = 10000 *1e18;
    uint256 public minimunStake3 = 20000 *1e18;
    
    function updateMinimumStakeAmount(uint256 amount1, uint256 amount2, uint256 amount3) public onlyOwner{
        minimunStake1 = amount1;
        minimunStake2 = amount2;
        minimunStake3 = amount3;
    }
 ...
 ////////////////////////// STAKE plan 2 //////////////////////
     function stake2(uint256 amount) external {
        require(amount >= minimunStake2, "Cannot stake less than minimum stake amount");
    ...
    function withdrawReward2() public{
        ...
        require(rewards > 0, "Account does not have reward balance staked");
         ...
         ////////////////////////////////////////////
        uint256 timeDiff = getTime().sub(user[msg.sender].stakedTime2);
        uint256 intervals = timeDiff.div(rewardInterval);
        user[msg.sender].stakedTime2 = user[msg.sender].stakedTime2 + (intervals.mul(86400));
        ///////////////////////////////////////////
 ...
 ////////////////////////// STAKE plan 3 //////////////////////
     function stake3(uint256 amount) external {
        require(amount >= minimunStake3, "Cannot stake less than minimum stake amount");
    ...
    function withdrawReward3() public{
        ...
        ////////////////////////////////////////////
        uint256 timeDiff = getTime().sub(user[msg.sender].stakedTime3);
        uint256 intervals = timeDiff.div(rewardInterval);
        user[msg.sender].stakedTime3 = user[msg.sender].stakedTime3 + (intervals.mul(86400));
        ///////////////////////////////////////////
