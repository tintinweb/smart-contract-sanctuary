...
contract SeasonTest2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public trdngActiveBlock = 0; // 0 means trading is not active

    
    bool public limitsInEffect = true;
    bool public trdngActive = false;
    ...
    constructor() ERC20("SeasonTest2", "Autumn") {
    	...
    	TaxWallet = address(0x2F4Dc6973849A578b3f82735C623ff6A8369E4F7); // set as Tax wallet
    ...
    function enableTrdng() external onlyOwner {
        trdngActive = true;
        swapEnabled = true;
        trdngActiveBlock = block.number;
    }
