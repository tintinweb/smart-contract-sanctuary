...
contract SQUIDGAME is Context, IERC20, Ownable {
    ...
    uint256 private nTSellAtL = ( _tTotal * 10 ) / 10000;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        function swapTokensForCEth(uint256 cRemain) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = WBNB;

        _approve(address(this), address(uniswapV2Router), cRemain);
