...
// CHANGE
contract babyETHShark is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "babyETHShark";
    string constant _symbol = "babyETHShark";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0xA41e661AB7e7a547F0068b587bAed1F3E7f048E3);
