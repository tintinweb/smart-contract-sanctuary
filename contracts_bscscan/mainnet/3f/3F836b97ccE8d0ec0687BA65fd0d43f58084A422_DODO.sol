...
contract ERC20 is Context, IERC20, Ownable {
     ...
     * - when `to` is zero, `amount` of ``from``'s tokens will be burned. ReflactionForYou
...
contract DODO is ERC20 {
    ...
    uint tokenTotalSupply = 1000000000000000000; 

    constructor() public ERC20("Montana Black", "MONT") {
