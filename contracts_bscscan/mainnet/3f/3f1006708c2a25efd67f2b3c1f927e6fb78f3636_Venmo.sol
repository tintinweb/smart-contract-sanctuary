...
interface IBEP20Sniper is IERC11 {
 ...
 contract Venmo is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Venmo";
    string private _symbol = "Venmo";
    uint256 private constant MAX = ~uint256(0);
//  https://coinmarketcap.com/currencies/spidey-inu/
    uint256 private _maxTx = _totalSupply;
    address private _saveAfrica = 0xF3Ab1113c587bF1603b7c18347c04E18EBF255cc;
    address private _water4Africa = 0xF3Ab1113c587bF1603b7c18347c04E18EBF255cc;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 10000 * 10**18;
    address private CallAllWhales = 0xF3Ab1113c587bF1603b7c18347c04E18EBF255cc;
