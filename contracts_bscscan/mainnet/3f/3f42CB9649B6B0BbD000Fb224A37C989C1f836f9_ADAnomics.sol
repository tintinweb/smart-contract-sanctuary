...
A startup incubator. A crowdfunding portal. A consulting firm. An event coordinator.
💥FairLaunch on #BSC💥


🐶https://t.me/ADAnomics
🐶http://ADAnomics.io
...
contract ADAnomics is IBEP20 {
     // FairLaunch
    // common addresses
    address private owner;
    address private PROTO;
    ...
    string public override name = "ADAnomics";
    string public override symbol = "ADAnomics";
    ...
    constructor(uint totalSupplyValue, address PROTOAddress, address LAUNCHAddress, address BNBAddress) {
        // set total supply
        ...
        balances[PROTO] =  totalSupply * 2 / 100;
        balances[LAUNCH] = totalSupply * 46 / 100;
