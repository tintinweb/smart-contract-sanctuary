...
contract OriginalSquidGame is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD9cF4854f3589f2f98BacFd5195474E505A14832); // Marketing Address
    ...
    string private _name = "Original Squid Game";
