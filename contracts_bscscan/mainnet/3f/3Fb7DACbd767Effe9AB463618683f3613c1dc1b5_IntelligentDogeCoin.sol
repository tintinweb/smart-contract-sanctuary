...
contract IntelligentDogeCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0xBA2EaBa974133819A07d2eBa569CaE776F9DB4cf); 
    ...
    string private _name = "IntelligentDogeCoin";
