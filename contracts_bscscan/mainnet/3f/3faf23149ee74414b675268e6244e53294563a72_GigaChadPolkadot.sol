...
/**
 * TG: https://t.me/GigaChadPolkadot The only real Chad token out there, come get that GigaChad Cock by holding some Dot
 * Max Wallet 3% Slippage buys 20 to 25% to be sure and 18% sells
 * 18% Buy Fee Distrubuted
 * 18% Sell Fee Distributed
...
contract GigaChadPolkadot is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "GigaChadPolkadot";
    string constant _symbol = "GigaChadPolkadot";
