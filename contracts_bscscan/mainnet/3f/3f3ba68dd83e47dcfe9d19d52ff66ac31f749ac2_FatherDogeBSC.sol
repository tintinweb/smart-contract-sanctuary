...
/**
    ...
    Welcome to FatherDogeBSC
   
   This is a community token. If you want to create a telegram I suggest to name it to @FatherDogeBSC
   Important: The early you create a group that shares the token, the more gain you got.
    
	I will add 0.35 BNB and all the left 25% total supply to the pool!
	
	
    features : 
    1. Auto reward to holder
    2. Auto increase liquidity when selling
    3. liquidity Burn 100%, make it SAFE
    4. 75% Token supply Burn
 ...
 */
	...
	contract FatherDogeBSC is Context, IERC20, Ownable {
		...
		string private _name = "FatherDogeBSC";
		string private _symbol = "FSC";
