...
contract UnrealizedGains is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = _tTotal.mul(30).div(100);
    uint256 public maxSellAmount = _tTotal.mul(30).div(100);
    uint256 public swapTokensAtAmount = 2100000 * 10**_decimals;
    uint256 public _maxWalletSize = 300000000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0xE0fd2Ea7AeF11802645AB073A5B7e99E3Ff2C5AD;
    address public operationsAddress = 0xE0fd2Ea7AeF11802645AB073A5B7e99E3Ff2C5AD;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "UnrealizedGains";
    string private constant _symbol = "URGAINS";
