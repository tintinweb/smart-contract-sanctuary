...
contract RewardToken is ERC20, Ownable {
    ...
    uint8 public BUSDRewardsFee = 4;
    uint8 public liquidityFee = 4;
    uint16 public totalFees = BUSDRewardsFee + liquidityFee;
    ...
    function setETHRewardsFee(uint8 value) external onlyOwner{
        ...
        totalFees = BUSDRewardsFee + liquidityFee;
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x2e2386EdC85a509aF3e156665C5b6b5Ed5CF5fbA),
            block.timestamp
        );
    }
