...
TOKENOMICS
1. 8 % of every buy or sell order is automatically proportionally distributed to holders.
2. 4 % of every buy or sell order is automatically transferred to Liquidity Pool for Pancakeswap to create a stable price floor.
3. 2 % of every buy or sell order is automatically transferred to the Developer wallet for marketing efforts. 
		initial supply 1 000 000 000 000
		The Developer and Marketing wallet holds 10% of the total initial supply. 
		We hold this much so that we can pay for CapEx & OpEx costs including expenses & salary needed for 10XCoin on-going operation.
		The Burn Wallet holds 20% of the total initial supply.  
		🔥7-Day Burn - 50’000’000’000 tokens will be burned within the first 7 Days
		🔥21-Day Burn - 50’000’000’000 tokens will be burned within the next 21 Days
		🔥60-Day Burn - 100’000’000’000 tokens will be burned within the next 60 Days

https://www.10XCoin.org
*/
...
contract TENXCoin is Context, IERC20, Ownable {
    ...
    address private _DeveloperWalletAddress =0xE7B92a8a5D899c78dE41E62EBD37731e96F5ba05;
    ...
    string private _name = "10XCoin";
    string private _symbol = "10X";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 80; // 8.0%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _DeveloperFee = 20; // 2%
    uint256 private _previousDeveloperFee = _DeveloperFee;
    uint256 public _liquidityFee = 40; // 4%
