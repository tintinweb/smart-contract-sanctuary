...
contract TinyDice is Context, IERC20, Ownable {
    ...
    string private _name = "TinyDiceToken";
    ...
    uint256 public _buybackv2Fee = 500; // 100 = 1.00%
    uint256 public _burningFee = 20; // 200 = 2.0%
    ...
    address public buybackv1Address  = 0x9a271B46021507BeDE6b971CEe1feE3785534d87;      // BuyBackv1 Address
    address public buybackv2Address  = 0x9a271B46021507BeDE6b971CEe1feE3785534d87;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x9a271B46021507BeDE6b971CEe1feE3785534d87;      // SMarketing Address
