...
/**
 * TELEGRAM: HTTPS://T.ME/PoppaDoge
 * Website : Under construction
 * REWARD
 * 7% DOGE - 4% LIQUIDITY - 2% MARKETING
 * TOKENOMICS
 * 50% BURN - 46% LIQUIDITY - 4% MARKETING WALLET
 * NO DEV WALLET
*/
...
contract PopPaDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PopPaDoge";
    string constant _symbol = "PPD";
