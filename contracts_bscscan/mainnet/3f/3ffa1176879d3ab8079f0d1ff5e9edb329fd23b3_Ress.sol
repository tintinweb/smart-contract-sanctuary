...
contract Ress is Context, IERC20, Ownable {
    ...
    constructor () public {
        address tokenOwner = 0xe60cd405864D82Ce53C1ba8Bb9aB0A60a76AC84c;
        marketingAddress = 0x2e8529Dd9536b668907167A5Ba77bF5569dC3d0d;
        ...
        _maxTxAmount = 10000000000000000 * 10 ** _decimals;
        numTokensSellToAddToLiquidity = 5000000000000 * 10 ** _decimals;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xe60cd405864D82Ce53C1ba8Bb9aB0A60a76AC84c,
            block.timestamp
        );
    }
