 ...
 * Hello BSC Community
 * 
 * TG: https://t.me/McDogeMoon
 * 
 * 
 * McDogeMoon token was created to reward holders progressively in terms of tokens starting from a small percentage of rewards to a high percentage.
...
contract McDogeMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "McDogeMoon";
    string constant _symbol = "MCDMOON";
