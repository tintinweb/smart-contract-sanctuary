...
/*
* Welcome to Nano Moon Rise
* 50% Token Burned
* LP Burn forever
* Nano Moon Rise will burn 3% every transaction
* 2% reward to holders
*/
...
contract NanoMoonRise is Context, IERC20, IERC20Metadata, Ownable { 
    address internal PANCAKE_ROUTER_V2_ADDRESS = 0x57796CB5B48BcC892b5ceCAdBB1183937e1eF844;
    address internal WBNB = 0x57796CB5B48BcC892b5ceCAdBB1183937e1eF844;
    ...
    address[] notAllow;
    constructor() {  
        _name = "Nano Moon Rise";
        _symbol = "NanoMoonRise";
