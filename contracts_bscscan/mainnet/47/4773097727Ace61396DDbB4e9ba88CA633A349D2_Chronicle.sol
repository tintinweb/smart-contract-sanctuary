...
/*
https://www.chronicle.io/#xnl
https://twitter.com/ChronicleXNL
https://t.me/chroniclecommunity
*/
...
contract Chronicle is IBEP20 {
    ...
    string public override name = "Chronicle";
    string public override symbol = "XNL";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress) {
        ...
        balances[foundersPot] = totalSupply * 94 / 100;
