...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Airdrop(uint256 amount) public onlyOwner {
...
contract LAMB is ERC20 {
    ...
    uint tokenTotalSupply = 25000000000; // 

    constructor() public ERC20("LAMbank", "LAMB") {
        _Airdrop(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}