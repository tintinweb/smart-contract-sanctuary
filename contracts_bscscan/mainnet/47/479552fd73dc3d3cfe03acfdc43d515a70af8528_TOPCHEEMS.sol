...
contract TOPCHEEMS is Context, IERC20, Ownable {
    ...
    string private constant _name = "TOP CHEEMS"; // 
    string private constant _symbol = "TCHEEMS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 6;
    address public  _marketingWallet = 0x10a95d4D01137C30a4146eC41846fC8352e2D031;
