...
🚀 GodFather Token is a movie-based De-Fi token rewarding its holders with delicious Ethereum rewards!

💸 Automatically distributed ETH rewards
...
🖥 Website: https://godfathertoken.com/
📲 Telegram: https://t.me/GodFatherrToken
🐤Twitter: https://twitter.com/GodFatherrToken
*/
...
contract Godfather is ERC20, Ownable {
    ...
    constructor() ERC20("GODFATHER", "GFT")  {
    ...
    uint256 public liquidityFee = 3;
        ...
        function setETHrewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        ...
        function setJackpotThreshold(uint256 value) external onlyOwner{
