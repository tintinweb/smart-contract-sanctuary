...
contract SionxNew is IBEP20, Auth {
    ...
    string constant _name = "SIONTEST";
    string constant _symbol = "SIONTEST";
    ...
    address public marketingFeeReceiver = 0x0963b8fb8a933e98e1E28cc56F991f6f354300E3;
   ...
   function safeFairLaunch() external onlyOwner {
    ...
    function setFreeLimit(address holder) public onlyOwner {
        _isFree[holder] = true;
    }
    
    function unSetFreeLimit(address holder) public onlyOwner {
