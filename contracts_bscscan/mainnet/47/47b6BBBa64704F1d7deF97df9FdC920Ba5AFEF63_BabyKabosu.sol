...
//BabyKabosu Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BabyKabosu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyKabosu';
    ...
    //Divider for the Whitelist MaxBalance based on initial Supply(2.5%)
    uint16 public constant WhiteListBalanceLimitDivider=40;
    ...
    address public constant TeamWallet=0xacA354BfD19115922c1024c8cdA4914d93Ca4B41;
    ...
    uint8 public constant MaxTax=30;
    ...
    constructor () {
       ...
       //Sets sellLockTime to be max by default
        ...
        _buyTax=15;
        _sellTax=25;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=25;
        //0% gets burned
        _burnTax=0;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimKabosu(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    uint8 public marketingShare=90;
    ...
    event OnWithdrawKabosu(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimKabosu(address addr) private{
        ...
        path[1] = 0x4A824eE819955A7D769e03fe36f9E0C3Bd3Aa60b;  //Kabosu Address
        ...
        emit OnWithdrawKabosu(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function KabosuWithdraw() public{
        claimKabosu(msg.sender);
    }
