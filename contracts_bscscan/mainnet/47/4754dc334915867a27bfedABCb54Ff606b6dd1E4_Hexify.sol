...
contract Hexify {
    string  private _name = 'Hexify';
    string  private _symbol = 'HEXI';
    uint256 private _totalSupply = 3000000000;
    ...
    constructor () {
        ...
        setLimits(9999999999, 9999999999, 3000000);
        setFees(6, 6);
    }
