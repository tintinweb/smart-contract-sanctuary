...
/**
Santa Hero 🎅🏻 is a community-driven reflections token on the Binance Smart Chain. Holders are rewarded 5% in BUSD (1,000,000 or more $HERO) while the projects main goal is to put smiles on the less fortunate faces 🎁. We will be using our amazing tax system to donate to charities and to the Children's Christmas Toy Drive. With our very hard working marketing team & a united community we can make the impossible possible! 💗 
*/
