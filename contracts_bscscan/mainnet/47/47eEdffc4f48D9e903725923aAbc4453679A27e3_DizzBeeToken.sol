...
contract DizzBeeToken is Context, IERC20, Ownable {
    ...
    string private _name = 'DizzBee Token';
    ...
    address payable private _marketingWalletAddress = payable(0x1E811FC9CadCb9b0EdAB88FB9f236ADc7573B1c1);
    ...
    uint256 private _maxTxAmount = 1000000000 * 10**6 * 10**18;
    // We will set a minimum amount of tokens to be swapped
    uint256 private _numTokensSellToAddToLiquidity = 500 * 10**6 * 10**18;
