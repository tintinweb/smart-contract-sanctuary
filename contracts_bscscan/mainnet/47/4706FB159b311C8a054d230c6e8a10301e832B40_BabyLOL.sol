...
abstract contract Auth {
     ...
     */
    modifier authorized() {
        require(isTeam(msg.sender), "!Not Team"); _;
    }
     ...
     */
    function isTeam(address adr) public view returns (bool) {
        return team[adr];
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LOL = IBEP20(0x064ef50Bbd2E9C306759d507e29Cf988d8Fa9d68);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LOL.balanceOf(address(this));
        ...
        uint256 amount = LOL.balanceOf(address(this)) - (balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LOL.transfer(shareholder, amount);
...
contract BabyLOL is IBEP20, Auth {
    ...
    address LOL = 0x064ef50Bbd2E9C306759d507e29Cf988d8Fa9d68;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    string constant _name = "BabyLOL";
    string constant _symbol = "BLOL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 _marketingSupply = (_totalSupply * 3) /100;
    uint256 _liqSupply = (_totalSupply * 97) /100;
    ...
    constructor () Auth(msg.sender) {
        ...
        _balances[marketingFeeReceiver] = _marketingSupply;
        emit Transfer(address(0), _owner, _liqSupply);
        emit Transfer(address(0), marketingFeeReceiver, _marketingSupply);
    }
   ...
   function setMaxWalletPercentage(uint256 percentage) external onlyOwner {
        ...
        _maxWalletSize = _totalSupply / 100 * percentage;
    }
