...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE6f73Dc9bE7e546ec700725ea996E285Aaa5922C;
...
contract HoundToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xAcaF01269C8c9a63E6A73935514Db517b1e0EBE0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HoundToken";
    string private _symbol = "Hound";
