...
/**
 Welcome to MiniTeslaDoge    @Telegram:  https://t.me/MiniTeslaDoge
   ...
   I will renounce the ownership to burn addresses to transfer #MiniTeslaDoge to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make MiniTeslaDoge 100X? 
   ...
   it's the best part of the #MiniTeslaDoge A idea, increasing the liquidity pool automatically, 
...
contract MiniTeslaDoge is BEP20 {
    ...
    constructor() public {
	symbol = "Mini Tesla Doge";
    name = "MiniTeslaDoge (https://t.me/MiniTeslaDoge)";
    fees = 10;
