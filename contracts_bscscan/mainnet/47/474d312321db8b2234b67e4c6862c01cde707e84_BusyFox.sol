...
/**
💰Busy Fox💰 official Fair Launch is on the way on BSC July 25th, 14:00 UTC
...
📌TELEGRAM:
https://t.me/busy_fox_token

📌TWITTER:
https://twitter.com/busy_fox_token
...
contract BusyFox is Context, IERC20, Ownable {
    ...
    string private _name = "Busy Fox";
    string private _symbol = "BzFox";
    ...
    uint256 public _maxTxAmount = 500 * 10**9 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 500 * 10**9 * 10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "BzFox::transfer: Mkt value invalid"
            );
