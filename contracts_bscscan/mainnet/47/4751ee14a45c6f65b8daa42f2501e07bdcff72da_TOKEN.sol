...
contract TOKEN is Operator {
    ...
    string private _name = "TOKEN";//#币名
    string private _symbol = "TOKEN";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x650a57b1dd1dEF019E8A3E39E743c4BBa8727AF4),true);
    }
