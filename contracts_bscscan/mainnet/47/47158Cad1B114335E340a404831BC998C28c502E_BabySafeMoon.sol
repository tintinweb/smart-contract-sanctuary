...
contract BabySafeMoon is ERC20Detailed, ERC20Burnable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 6800000 * (10 ** uint256(DECIMALS));

    constructor () public ERC20Detailed("BabySafeMoon", "BabySafeMoon", DECIMALS) {
        _mint(0x60bEFe38CF819e3D18213501920f317BaFddA56F, 6800000 ether);
