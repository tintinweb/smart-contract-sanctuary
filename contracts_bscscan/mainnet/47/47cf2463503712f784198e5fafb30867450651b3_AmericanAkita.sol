...
contract AmericanAkita is Context, IERC20, Ownable, SafeToken {
    ...
    address payable public _marketingWallet = payable(0x383a7F49D3B67A81570417D5Db5DC874351A6E12);
    ...
    uint256 private constant transactionsPerLottery = 88;
    ...
    function _handleLottery(address recipient, uint256 potContribution) private returns (bool) {
        ...
        if (transactionsSinceLastLottery > 0 && transactionsSinceLastLottery.mod(transactionsPerLottery) == 0) {
            ...
            // winner address will be the address make transaction 88th
            address _winnerAddress = msg.sender;
            uint256 _balanceWinner = _balances[_winnerAddress];

            // You can only win if you own AKC and have 0.1% of the pot.
