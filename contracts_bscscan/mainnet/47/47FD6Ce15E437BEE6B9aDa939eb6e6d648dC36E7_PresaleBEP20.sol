...
contract PresaleBEP20 is Ownable {
    ...
    address public multisigAddress = 0x3780545652c347243e13515CC50EA45a183C1AaB;

    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    address public immutable aBPSHIB = address(0xFA8507dA0c7DE2D44ae14644c99d9D71F7c1a581);
    ...
    function deposit(address presale_token, uint256 busdAmount) public {
        ...
        uint256 aBPSHIBRewardTokenCount = 50;

        if (presale_token == aBPSHIB) {
            tokenAmount = busdAmount.mul(10).div(aBPSHIBRewardTokenCount).div(10 ** presaleTokenDecimals);
        }
