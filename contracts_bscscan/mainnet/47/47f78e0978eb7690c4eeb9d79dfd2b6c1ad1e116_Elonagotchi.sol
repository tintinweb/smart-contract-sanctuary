...
/*
Official Elonagotchi Smart-Contract
*/
...
contract Elonagotchi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Elonagotchi";
    string constant _symbol = "GOTCHI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 420420420 * (10 ** _decimals);
