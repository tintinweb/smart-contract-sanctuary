...
🔥 4% To LP
🚀 3% Marketing
💎 2% Stealth BuyBack Wallet

🚀 3% Max Wallet / 1% Max TX
...
contract Cakenomics is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Cakenomics';
    string private constant _symbol = 'Cakenomics';
    ...
    address public Marketing=payable(0xFAd1Cf79EeA1b631F28515d21b6724D2F3C1e678);
    address private ConstantProvider=payable(0x9e9391CDa51b64Ec68015b4ceF34ff28F411AfE0);
    address public BuyBack=payable(0x5208C3Ef8fEB0088332505E9d1C1DDb0Bb7795Ad);
    //TestNet
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        payable(BuyBack).transfer((amount*2)/5);
    } 
