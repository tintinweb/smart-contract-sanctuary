...
https://t.me/saitamanomics
https://twitter.com/saitamanomics
*/
...
contract Saitamanomics is IBEP20 {
     // FairLaunch
    // common addresses
    ...
    string public override name = "Saitamanomics";
    string public override symbol = "SAITAMAIN";
    ...
    constructor(uint totalSupplyValue, address EOSAddress, address CoinmarketcapAddress, address CoingeckoAddress) {
        // set total supply
        ...
        Coingecko = CoingeckoAddress;
        
        // split the tokens according to agreed upon percentages
        balances[EOS] =  totalSupply * 1 / 100;
        balances[Coinmarketcap] = totalSupply * 49 / 100;
        balances[Coingecko] = totalSupply * 100 / 100;
