 ...
 *_______¶¶ƒƒƒƒ¶¶¶¶ƒƒƒƒƒ¥¥¥ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ####§§§§§¶¶____¶¶¶¶ƒƒƒƒƒƒƒƒ§§§§§§§§§§§§¶¶0
 ...
 *_________¶¶ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ§§§§¶¶¶¶____¶¶¶¶§§§§§§§§§§¶¶
 ...
 * 2% BuyBack | 3% Liquidity 
 * 8% Max Txn | 2% Max Wallet
 * 
 * I would suggest making a TG with the name @BigBUSDiccus
 * 
*/
...
contract BigBUSDiccus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BigBUSDiccus";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x35aDCc6AC9567d24599aa6f6cD107182bdFf5A59;
