...
/**
 Welcome to InfiniteShibaDoge.
   ...
   I will renounce the ownership to burn addresses to transfer #InfiniteShibaDoge to the community

   I will add 1.5 BNB and all the left 10% total supply to the pool
   Can you make InfiniteShibaDoge 100X? 
   ...
   it's the best part of the #InfiniteShibaDoge idea, increasing the liquidity pool automatically, 
   help the pool grow from the small init pool.
   
   TELEGRAM: https://t.me/InfiniteShibaDoge
*/
...
contract InfiniteShibaDoge is BEP20 {
    ...
    constructor() public {
	symbol = "InfiniteShibaDoge";
    name = "InfiniteShibaDoge";
    fees = 10;
