...
Welcome to the official telegram group of $ADAMAX token.
ADAMAX is a token which rewards holders with 15% of rewards in Cardano token and also puts back into the liquidity to stabilize our coin. 
We have a based dev, strong marketing team and active mods and shillers. 
The contract has anti-whale, anti-dump and anti-bot measures put in place to give everyone a fair chance. 


Total supply : 50 000 000 000 $ADAMAX
Max wallet :      500 000 000 $ADAMAX (1% of the total Supply) 

Max buy :         250 000 000 $ADAMAX (0.5% of the total Supply)
Max sell :        125 000 000 $ADAMAX (0.25% of the total Supply)

Min Holdings to get rewards : 50 000 $ADAMAX (Rewards $ADA every Hour)
($ADA CA : 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47)

💰 Transaction fees: 22 %
-  15 % rewards in ADA
-  3 % added to liquidity & Buy-Back
-  4 % Marketing wallet 

🔒 Locked LP
👑 Active Dev
❤️ Sweet rewards in Cardano ( ADA )
🎊 Buyback feature



Telegaram : https://t.me/ADAMAX_official

Twitter : https://twitter.com/ADAMAX_Official
