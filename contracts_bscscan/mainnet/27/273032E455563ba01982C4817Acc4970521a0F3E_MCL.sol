...
contract ERC20 is Context, IERC20, Ownable {
     ...
     * Calling conditions:
     *
     * - when `from` and Q`to` are both non-zero, ` of ``from``'s tokens
...
contract MCL is ERC20 {

    uint tokenTotalSupply = 10000000000000000; // 100 Million 

    constructor() public ERC20("PUMPers", "PPERS") {
