...
/**
    ...
    uint256 private _tTotal = 3100000000000000  * 10**9;    // so hien tai la 1 trieu ty token
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Super Loki Coin";           // sua lai ten cua token
    string private _symbol = "SLK";                       // sua lai ky hieu cua token
