...
/**
   ...
   Welcome to NFTSPACEJAM
   
   
   
   This is a community token. If you want to create a telegram I suggest to name it to TG: @NftSpaceJamBsc
   ...
   91% burn to the black hole, with such big black hole and 5% fee, the strong holder will get a valuable reward

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #NFTSPACEJAM to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 9% total supply to the pool
   Can you make #NFTSPACEJAM 10000X? 
   ...
   it's the best part of the #NFTSPACEJAM idea, increasing the liquidity pool automatically, 
...
contract NftSpaceJam is Context, IERC20, Ownable {
    ...
    string private _name = "NftSpaceJam";
    string private _symbol = "NFTSJ";
