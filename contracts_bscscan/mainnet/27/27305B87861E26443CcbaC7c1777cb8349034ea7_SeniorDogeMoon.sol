...
/**
   ...
   Welcome to SeniorDogeMoon
  
   
   This is a community token. If you want to create a telegram I suggest to name it to @SeniorDogeMoonBSC
   ...
   I will renounce the ownership to burn addresses to transfer #SeniorDogeMoon to the community, make sure it's 100% safe.

   I will add .3 BNB and all the left 10% total supply to the pool
   Can you make #SeniorDogeMoon 10000X? 

   1,000,000,000,000,000 total supply
   5,000,000,000,000 SeniorDogeMoon limitation for SELL, which is 0.5% of the total supply
   ...
   it's the best part of the #SeniorDogeMoon idea, increasing the liquidity pool automatically, 
...
contract SeniorDogeMoon is Context, IERC20, Ownable {
    ...
    string private _name = "SeniorDogeMoon";
