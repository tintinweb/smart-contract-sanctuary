...
https://t.me/NewYearApe



Welcome to NewYearApe, presented by @ApeLoungeToken
(Daily Degen Play)
...
/* Token contract */
contract NewYearsApe  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x69C3ebcee285daA84d8470De1c1e79be4F9DBE42;
    ...
    // Name and symbol
    string constant _name = "NewYearApe";
    string constant _symbol = "NYA";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 0.20% or 250k tokens
    uint256 public _maxWalletToken = ( _totalSupply * 10000) / 10000; // 5% or 5m tokens
