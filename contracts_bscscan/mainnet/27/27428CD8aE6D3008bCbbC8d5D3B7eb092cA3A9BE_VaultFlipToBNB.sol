...
contract VaultFlipToBNB is VaultController, IStrategy, RewardsDistributionRecipientUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function withdrawGetRewardToken(uint, address, address) external override onlyWhitelisted {
        revert("N/A");
    }
    ...
    // function setMinter(IAMVMinterV2 newMinter) override public onlyOwner {
