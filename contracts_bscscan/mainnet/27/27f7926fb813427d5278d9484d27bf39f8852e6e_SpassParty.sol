...
// CHANGE
contract SpassParty is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SpassParty heute";
    string constant _symbol = "SpassParty";
    ...
    uint256 reflectionFee = 1000; // 10% I will keep a marketing wallet and use rewards to pay for influencers
    uint256 devFee = 0; // 0%
    ...
    uint256 public swapThreshold = _totalSupply / 8000; // 0.05%
    bool inSwap;
