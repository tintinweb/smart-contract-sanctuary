...
/**
 * BabyCOTI(BBYCOTI)
 * The 1st COTI based rewards token
 * Get rewarded in COTI
 * 
 *
 *    ██████   █████  ██████  ██    ██  ██████  ██████  ████████ ██ 
 *    ██   ██ ██   ██ ██   ██  ██  ██  ██      ██    ██    ██    ██ 
 ...
 *                                                                  
 * 
 * Telegram - https://t.me/BabyCOTI
 * Website - https://babycoti.site
 * Twitter - https://twitter.com/babycoticrypto
 * 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REW = IBEP20(0xAdBAF88B39D37Dc68775eD1541F1bf83A5A45feB);
...
contract BabyCOTI is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0xAdBAF88B39D37Dc68775eD1541F1bf83A5A45feB;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyCOTI";
    string constant _symbol = "BBYCOTI";
    ...
    bool public activateCOTI = false;
    ...
    constructor () Auth(msg.sender) {
        ...
        // Tax addresses
        autoLiquidityReceiver = 0x0C0308C0167ba2B27A4bf989a2b0370648f43F4F;
        marketingFeeReceiver = 0x5220E4FCA326a8a76d7EAF282452136661046523;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(activateCOTI,"BabyCOTI is not yet activated");
        }
    ...
    // Activate COTI
    function startCOTI(bool _status) public onlyOwner {
        activateCOTI = _status;
    }
