...
contract WallStreetCapital is IBEP20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "Wall Street Capital";
    string constant _symbol = "$WSC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xB23069A442451b285CB78BC06Cf155D3377d850F;
        developmentWallet = 0xEB3b76C60a16Fac5957D48872744aF18aa860450;
        devWallet = 0xdadBce6Ce4722A65c626961d58b0415dDcD5f2d7;
        liquidityWallet = 0xdadBce6Ce4722A65c626961d58b0415dDcD5f2d7;
        treasuryWallet = 0x1717801337b59a8eF6B38Adb305F93024A8FE08A;
    ...
    function setWallets(address _marketingWallet, address _developmentWallet, address _treasuryWallet) external authorized {
    ...
    function seFees(uint256 _marketingFee, uint256 _developmentFee, uint256 _liquidityFee, uint256 _treasuryFee, 
    ...
    function manualSwap(uint256 amount) external swapping authorized{
        ...
        sendToWallet(payable(marketingWallet), amountBNBTreasury, payable(swap));
