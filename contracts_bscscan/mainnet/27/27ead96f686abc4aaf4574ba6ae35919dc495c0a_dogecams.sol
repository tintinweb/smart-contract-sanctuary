...
//Website: https://dogecamslive.io/
//TG: https://t.me/dogecams
...
contract dogecams is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

   string constant _name = "DogeCams";
    string constant _symbol = "DCAMS";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply * 6 / 1000;
