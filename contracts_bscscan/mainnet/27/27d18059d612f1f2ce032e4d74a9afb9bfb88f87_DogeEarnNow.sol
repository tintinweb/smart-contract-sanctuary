...
*Welcome To DogeEarnNow
   
   This is a community token. If you want to create a telegram I suggest to name it to @DogeEarnNowBSC
  
   You can passively earn $DOGE just by holding DogeEarnNow
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract DogeEarnNow is Context , IERC20, Ownable {
    ...
    string private _name = "HUMANR";
    string private _symbol = "HUMANR";
