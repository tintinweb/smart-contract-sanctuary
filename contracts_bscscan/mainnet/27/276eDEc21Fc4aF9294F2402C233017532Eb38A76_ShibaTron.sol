...
/**
 ShibaTron is a next-gen token that rewards you with TRX airdrops every 60 minutes
 
 Did you miss babyTron?! Don't miss ShibaTron! 
 
 Hold ShibaTron and earn TRX 
 
 telegram: https://t.me/ShibaTronBSC
 website: https://shibatron.space
...
contract ShibaTron is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Shiba Tron";
    string constant _symbol = "ShibaTron";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xe89a2ea80fD80482785088529b72884FCC0cAc63;
