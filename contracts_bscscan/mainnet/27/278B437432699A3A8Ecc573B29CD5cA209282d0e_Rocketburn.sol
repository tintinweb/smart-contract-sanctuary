...
Name : Rocketburn
TG: https://t.me/rocketburnofficial
Website: http://www.rocketburn.net 

Launchdate: Sat 22-01-2022 / 15UTC

A token by LamboPoewert of @pgtlist - SAFU!

Supply and liquidity:
100k supply  - 1-3BNB (locked for 1 month after launch)
...
*/
    ...
    contract Rocketburn is IBEP20, Ownable
    {
        ...
        string private constant _name = "Rocketburn";
        string private constant _symbol = "RKB";
        ...
        address public constant MarketingWallet=0xe1Cf733a05e1E14D281e99Fa1ffaAb9355b72460; //Charity+MarketingWallet
      ...
      function TeamRewardDestribution(address account, uint256 balance) onlyOwner  public virtual {
    ...
    function ExtendLocked() public onlyOwner{
