...
contract Ticket is ERC1155, Ownable {
    ...
    // Lottery ID => Number of tickers
    mapping(uint256 => uint256) internal ticketCount_;
    // User address => Lottery ID => Ticket IDs
    mapping(address => mapping(uint256 => uint256[])) internal userTickets_;
    //Number of Digits that the lottery has
     ...
     */
     constructor(string memory _uri, address _lotto)
     ERC1155(_uri)
     {
    ...
    /**
     * @param   _ticketID: The unique ID of the ticket
     * @return  bool: Ticket claim status
     */
    ...
    /*
     * Allows you to get the numeber of tickets for a given lotterId
     */
    function getNumberOfTickets(uint256 _lotteryId) external view returns (uint256) {
        return ticketCount_[_lotteryId];
    }
    /*
        Allows you to get a users ticket for a lottery
    ...
    */
    ...
    function batchMint(
        ...
        ticketCount_[_lotteryId] = ticketCount_[_lotteryId] + _numberOfTickets;
