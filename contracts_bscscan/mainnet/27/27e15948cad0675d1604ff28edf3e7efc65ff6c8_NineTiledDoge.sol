...
contract NineTiledDoge is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "NineTiledDoge";
    string private _symbol = "NTD";
    ...
    uint256 private _maxWalletSize = 1000000000000000 * 10**9;
