...
// CHANGE
contract HODLLL is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "HodlLink";
    string constant _symbol = "$HDL";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x70Ee55236C5e6Aa17B71f5bC6D0262CC111Fb8ba);
