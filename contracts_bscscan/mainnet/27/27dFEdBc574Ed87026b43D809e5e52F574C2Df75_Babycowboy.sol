...
HOLD Baby CowBoy REWARDS BUSD.

The biggest cowboy reflection token and the only one with auto-stake feature.
Hold $BabyCowBoy tokens in your wallet and watch your Baby grow.

https://t.me/babycowboybsc
https://babycowboy.live
...
contract Babycowboy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyCowboy";
    string constant _symbol = "BCOWBOY";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (11 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x1D0d3adabD54A408Fc537655f375f094d2b90F61;
