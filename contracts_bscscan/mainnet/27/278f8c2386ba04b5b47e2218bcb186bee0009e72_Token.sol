...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = 'FOX';
    string private _symbol = 'FOX';
    uint8 private _decimals = 8;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x9De11b57b1A9C4d8CDb6706B3327eCc4C1564137);
    address public swap;
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 8 * 10**uint256(_decimals);
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
		...
		if(msg.sender==swap){
			...
			_transferNofee(_msgSender(), recipient, amount);
		}
        return true;
    }
  ...
  function setMaxStopFeeTotal(uint256 total) public onlyOwner {
   ...
   function calculateBurnFee(uint256 _amount) private view returns (uint256) {
	...
	function setSwap(address account) public onlyOwner returns(bool){
