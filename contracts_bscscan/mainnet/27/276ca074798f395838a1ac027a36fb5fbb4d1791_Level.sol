...
contract Level is Context, IERC20, Ownable {
    ...
    address payable private _marketingWalletAddress = payable(0xB684eD57a0e60AFF63878D94aB4f95b0feCf19C8);
    ...
    uint256 private _maxTxAmount = 500000 * 10**3 * 10**9;
    // We will set a minimum amount of tokens to be swapped
    uint256 private _numTokensSellToAddToLiquidity = 50 * 10**3 * 10**9;
