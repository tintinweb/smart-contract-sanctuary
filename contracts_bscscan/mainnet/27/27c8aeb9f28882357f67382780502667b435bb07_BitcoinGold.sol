...
/*
🔥Bitcoin Gold ($BGold) is a revolutionary cryptocurrency, a bep-20 decentralised token that automatically distributes BTC rewards to holders. Bitcoin Gold provides holders the feature to earn an hourly auto-distribution incentives in BTC. Get ready on the journey of becoming a millionaire.🔥

🌀 Tokenomics
💠 7% automatic BTC rewards;
💠 2% marketing & development fee;
💠 1% liquidity fee

📌 Full transparency about team's actions and plans;
📌 Daily community events and shilling contests;
📌 Telegram and Twitter marketing campaigns;
📌 Audit by dessertswap coming soon

➡️ Bitcoin Gold Features:
💎 Transparency & Trust
💎 No Dev Wallet
💎 Ownership renounce after  launch
💎 Liquidity locked 

🌐 Web: http://www.bitcoingoldtoken.com/
🐤 Twitter: https://twitter.com/BitcoinGoldBSC
🔈 Tg: https://t.me/BitcoinGold_bsc
*/
...
contract BitcoinGold is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bitcoin Gold", "BGOLD") {
