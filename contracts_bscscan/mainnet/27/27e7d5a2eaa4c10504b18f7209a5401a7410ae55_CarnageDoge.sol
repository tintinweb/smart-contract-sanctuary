...
Carnage Doge ($CARNAGE )
https://t.me/carnagedoge ~ Stealth Launch                                                                                                                                             
...
contract CarnageDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2d0Df848140B160941e05d761aCeCD307f29E929); // Marketing Address
    ...
    string private _name = "CarnageDoge";
    string private _symbol = "$CARNAGE";
