...
NanoDogeInu
MiniDOGE fork
Telegram: https://t.me/NanoDogeInu
*/
...
// File contracts/NanoDogeInu.sol
...
contract NanoDogeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x0A1f8DAE6Fb1ef10d2aa8dB3618a98b0985ac9E3); // Marketing Address
    ...
    string private _name = "NanoDogeInu";
    ...
    constructor (address router, address advertisingWallet) {

        _rOwned[_msgSender()] = _rTotal;

        marketingAddress = payable(advertisingWallet);
