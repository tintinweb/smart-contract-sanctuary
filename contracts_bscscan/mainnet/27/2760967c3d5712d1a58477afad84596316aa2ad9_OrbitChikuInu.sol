...
// File contracts/OrbitChikuInu.sol
pragma solidity ^0.8.0;

contract OrbitChikuInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "OrbitChikuInu";
    string private constant _symbol = "ORBITCHIKU";
