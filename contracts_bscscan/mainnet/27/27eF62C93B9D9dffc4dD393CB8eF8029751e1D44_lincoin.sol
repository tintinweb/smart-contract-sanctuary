...
import "./lincoin-imports.sol";

/**
 * Gracias por participar en el proyecto LINCOIN 
 */
abstract contract Tokenomics {
    ...
    string internal constant NAME = "LINCOIN";
    string internal constant SYMBOL = "LINC";
    ...
    uint256 internal constant TOTAL_SUPPLY = 65000000 * ZEROES;
    uint256 internal _reflectedSupply = (MAX - (MAX % TOTAL_SUPPLY));

    /**
     * 
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 10; // 
    
    /**
     * 
     * 
     */
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 10; // 
    ...
    address internal marketing = 0x2DA7764f47073370c0b248C8fF26c41Ee7934716;
    address internal fundacion = 0xA963D04AbfE9Aa4eA52b8c07f0A10956D7399Ec8;
    address internal burnAddress = 0x000000000000000000000000000000000000dEaD;


    /**
     * No Editar sin conocer la configuración total del proyecto. Puede producir error fatal del mismo.
     */
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 20, fundacion );
