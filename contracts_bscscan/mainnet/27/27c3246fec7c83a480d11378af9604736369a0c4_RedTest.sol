...
contract RedTest is Context, IBEP20, Ownable {
    ...
    address payable public _charityWallet = payable(0xEC3c0924DE7f032E9D70F5D5fA7a0D4e25f5A34f); // Charity Address
    ...
    string private constant _name     = "RedTest";
    string private constant _symbol   = "REDTEST";
