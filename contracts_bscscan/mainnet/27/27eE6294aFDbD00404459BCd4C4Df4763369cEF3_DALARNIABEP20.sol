...
/**
Mines of Dalarnia is an action-adventure game. Players mine and combine various in-game items, 
improving their skills and gear to unlock the MoD universe's secrets while fighting enemies and 
searching for rare relics and artifacts.
*/
 ...
 */
contract DALARNIABEP20 {
    using SafeMath for uint256;

    uint256 private _totalSupply = 8000000000*10**18;
    string private _name = "Dalarnia";
