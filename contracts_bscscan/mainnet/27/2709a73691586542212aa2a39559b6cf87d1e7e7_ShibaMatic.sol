...
import "./ShibaMatic-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `ShibaMatic` at the very bottom **and** the `environment` into which
 * you are deploying the contract `ShibaMatic(Env.Testnet)` or `ShibaMatic(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "ShibaMatic";
    string internal constant SYMBOL = "SMATIC";
     ...
     */
    address internal tipToTheDev = 0x9457F811923BD2480b3078Ed014d916317cc5299;
...
contract ShibaMatic is SafeToken{
