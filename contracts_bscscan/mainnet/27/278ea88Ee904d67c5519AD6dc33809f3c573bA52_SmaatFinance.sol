...
interface AutoSniper is IERC11 {
    /**
 ...
 contract SmaatFinance is AntiBot, IERC11, AutoSniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Smaat Finance";
    string private _symbol = "SMAAT";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x7b299295286f301b3A88208392AE405AD45D4D7F;
