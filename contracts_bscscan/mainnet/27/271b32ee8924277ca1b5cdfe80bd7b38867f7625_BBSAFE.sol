...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x62175af6D9B045D8435CDeDd9Bf542c7bcc56dCC); // SAFE
...
contract BBSAFE is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x62175af6D9B045D8435CDeDd9Bf542c7bcc56dCC; // SAFE
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // address WBNB = 0xae13d989dac2f0debff460ac112a837c89baa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address teamFeeReceiver = 0x6cb39c7eD3Fe1A951Ed878c55718B6AE49Bc8B85;

    string constant _name = "Baby Safe";
    string constant _symbol = "Baby Safe Rewards";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 12 )  / 200;

    //max wallet holding of 0.5%
    uint256 public _maxWalletToken = ( _totalSupply * 12 ) / 200;
