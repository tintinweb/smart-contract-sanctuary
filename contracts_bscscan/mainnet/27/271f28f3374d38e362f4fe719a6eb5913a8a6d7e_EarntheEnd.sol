...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 theEnd = IBEP20(0xC58D7e546DE9214d54b52063F1601FD90eb1F84a);
...
contract EarntheEnd is IBEP20, Auth {
    using SafeMath for uint256;

    address theEnd = 0xC58D7e546DE9214d54b52063F1601FD90eb1F84a;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SubTokenTheEnd";
    string constant _symbol = "STE";
    uint8 constant _decimals = 18;
    uint256 public queima = 1; 
    uint256 public _maxQtd = 20 * 10**18;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xD05196457E5DB963608a3B09c71B8082C03937B7;
