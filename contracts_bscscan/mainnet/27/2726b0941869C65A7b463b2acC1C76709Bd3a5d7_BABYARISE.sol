...
// BABYARISE
// 10% TAX: 2% redistributed to the holders, 3% to the marketing wallet and 5% for the buyback wallet.
...
contract BABYARISE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xA668f483065B18a1Bb8732a02eD3180FD37d5C2B); // Marketing Address
    ...
    string private _name = "BABYARISE";
    string private _symbol = "BABYARISE";
