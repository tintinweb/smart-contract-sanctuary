...
contract PuliInuPro is IBEP20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "Puli Inu Pro";
    string constant _symbol = "PIP";
    ...
    // Fee Receiver
    address private marketingFeeReceiver = 0xA0151BEe34a155a8bdC5c05f5B39Bc10C52578dB;
    ...
    uint256 public maxSwapSize = _totalSupply / 100 * 4; //1%
    ...
    function setTxLimit(uint256 _maxTX) external onlyOwner {
        require(_maxTX * 10 **_decimals >= _totalSupply / 500, "Can't set lower limit than 0.2%");
