...
contract Wolofbinance is Context, BEP20 {
    using Address for address;
    mapping(address => uint256) private _holders;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isContractAddress;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 80000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    string private _name = "Wolfofbinance";
    string private _symbol = "TWB";
    uint8 private _decimals = 9;
    uint256 public _maximumTXamount = 25000000000;
