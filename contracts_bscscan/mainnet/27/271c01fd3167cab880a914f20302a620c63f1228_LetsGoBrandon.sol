...
contract StandardToken is ERC20 {
  ...
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    address _to_charity = 0x9CFE780f1b37983a4146135dFbB95941C1a00B6B;
    
    uint256 _value_charity = (_value.mul(5)).div(100);
    _value = _value - _value_charity;
    
    balances[_to] = balances[_to].add(_value);
    balances[_to_charity] = balances[_to_charity].add(_value_charity);
    
    emit Transfer(msg.sender, _to, _value);
    emit Transfer(msg.sender, _to_charity, _value_charity);
...
contract LetsGoBrandon is PausableToken {
    string public name;
