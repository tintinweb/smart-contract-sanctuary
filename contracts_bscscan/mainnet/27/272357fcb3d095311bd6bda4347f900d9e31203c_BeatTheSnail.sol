...
Inspired by ELon's latest tweet!
https://twitter.com/elonmusk/status/1451242990840713222?s=20

Telegram: https://t.me/BeatTheSnailBSC
Website: https://BeatTheSnail.site (UC)
...
contract BeatTheSnail is ERC20Detailed, Ownable {
    ...
    function Stabilize(uint256 epoch, int256 supplyDelta)
        external
        onlyMaster
        returns (uint256)
    {
    ...
    constructor() ERC20Detailed("BeatTheSnail", "BTS", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xBdB4CE2750B868A245e3327F064590925a0Fde6D;
        marketingFeeReceiver = 0xBdB4CE2750B868A245e3327F064590925a0Fde6D;
        ecosystemFeeReceiver = 0xC1983C5384608349292c86D5acfcAe1e88647be4;
        buyBackFeeReceiver = 0x4f81ED7B6D0D81c61D516BcBE9e8E7C30FC1a508;
