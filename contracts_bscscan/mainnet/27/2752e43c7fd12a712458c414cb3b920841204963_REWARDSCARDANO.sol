...
contract REWARDSCARDANO is Context, IERC20, Ownable {
    ...
    string private _name = "Rewards Cardano";
    string private _symbol = "REWARDS CARDANO";
    uint256 private _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 private _liquidityFee = 0;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private _toHolder = 0;
    ...
    address _marketingWallet = 0xF43b5Dc6653EBB287156bbE7753d3dC6343EE809;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    // Max TX amount is 1% of the total supply.
    uint256 private maxTxX = 300000000; // Less fields to edit
