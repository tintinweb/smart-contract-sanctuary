...
contract GolanInu is Context, IBEP20 {
    ...
    string private _name = "Golan Inu";
    string private _symbol = "GOLAN";
    ...
    uint256 public _sellDevelopmentFee = 100;
    
    uint256 public _transferReflectFee = 200;
    uint256 public _transferLiquidityFee = 200;
    uint256 public _transferMarketingFee = 500;
    uint256 public _transferDevelopmentFee = 100;
    ...
    IPancakeV2Router02 public dexRouter;
    address public lpPair;
    address private _routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    address public ZERO = 0x0000000000000000000000000000000000000000;
    address payable private _marketingWallet = payable(0x9242BDc94999370029F598c7607b90D7751Ef204);
    address payable private _developmentWallet = payable(0x52782e568D133580ae86d6B7c22A3F7D84318df9);
    ...
    constructor () payable {
        ...
        _owner = msg.sender;
        dexRouter = IPancakeV2Router02(_routerAddress);
        lpPair = IPancakeV2Factory(dexRouter.factory()).createPair(dexRouter.WETH(), address(this));
        lpPairs[lpPair] = true;
    ...
    function setNewRouter(address newRouter) public onlyOwner() {
        IPancakeV2Router02 _newRouter = IPancakeV2Router02(newRouter);
        address get_pair = IPancakeV2Factory(_newRouter.factory()).getPair(address(this), _newRouter.WETH());
        if (get_pair == address(0)) {
            lpPair = IPancakeV2Factory(_newRouter.factory()).createPair(address(this), _newRouter.WETH());
        }
        else {
            lpPair = get_pair;
        }
