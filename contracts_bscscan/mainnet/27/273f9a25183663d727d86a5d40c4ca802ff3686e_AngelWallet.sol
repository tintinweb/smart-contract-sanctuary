...
pragma solidity ^0.4.24;
  ...
  contract AngelWallet is PausableToken {
      ...
      constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply) public {
          ...
          //Team 36600000
          balances[address(0x46F462FB81aF47C07975829096AcDf75Abe8A8b3)] = 109800000* 10**_decimals;
          emit Transfer(address(0), address(0x46F462FB81aF47C07975829096AcDf75Abe8A8b3), 109800000* 10**_decimals);
          ...
          //Partner 36600000
          balances[address(0x0a752Be924305a3a500d52ceb209AbeAc8EF17dA)] = 36600000* 10**_decimals;
          emit Transfer(address(0), address(0x0a752Be924305a3a500d52ceb209AbeAc8EF17dA), 36600000* 10**_decimals);               
          //Partner 36600000
          balances[address(0x835FF96Bb36573E9Cd61e81681914bDb29500122)] = 36600000* 10**_decimals;
          emit Transfer(address(0), address(0x835FF96Bb36573E9Cd61e81681914bDb29500122), 36600000* 10**_decimals);                  
          //Liquidity 73200000
