...
/**
 * Testing out how to make a Token. 
 * I don't recommend you buy unless you really feel like it.
 * This token is not a scam but I have no idea what I am doing. 
 * If this token becomes big I will hire professional help.
 * Big means market cap > 10 million.
 * 
 * 
 * 100,000,000 Total Supply
 * 1,000,000 Max Tx
 *  
 * 1% back into liquidity
 */
...
contract DoNotBuy is Context, IBEP20, Ownable {
    ...
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**3 * 10**9;
