...
contract DBTCoken is Context, IERC20, Ownable {
    ...
    string private _name = "中国加油";
    string private _symbol = "中国加油";
    ...
    address public ownerAddres = address(0xF36A1f34FcdE405Bd4d58D2273d959D77b393C20);
    address public devAddress = address(0xF36A1f34FcdE405Bd4d58D2273d959D77b393C20);
