...
contract LinePay is Context, IERC20 {
    ...
    struct TaxWallets {
        ...
        address payable teamfunds;
        address payable buyback;
        address liquidityReceiver;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x9B916dE590ba6B5e0a5ecf3bCbF609A3e161aA3f),
        teamfunds: payable(0x468F6908452a33AE7E2510389Ba9c514923ACF69),
        buyback: payable(0x433aDf2af5602A516CA32425279BCA7850c8d139),
        liquidityReceiver: 0x56421324E18C7e68f9d2E03E0fA683aFc037AA80
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 teamfunds, uint16 buyback) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.teamfunds = teamfunds;
        _ratios.buyback = buyback;
        _ratios.total = liquidity + marketing + teamfunds + buyback;
    }
    ...
    function setWallets(address payable marketing, address payable teamfunds, address payable buyback) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.teamfunds = payable(teamfunds);
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 teamfundsBalance = (amtBalance * ratios.teamfunds) / ratios.total;
        uint256 buybackBalance = (amtBalance * ratios.buyback) / ratios.total;
        uint256 marketingBalance = amtBalance - (teamfundsBalance + buybackBalance);
        if (teamfundsBalance > 0) {
            _taxWallets.teamfunds.transfer(teamfundsBalance);
        }
        if (buybackBalance > 0) {
