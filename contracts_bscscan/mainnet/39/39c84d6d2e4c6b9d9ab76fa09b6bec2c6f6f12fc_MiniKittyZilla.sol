...
contract MiniKittyZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniKittyZilla";
    string private _symbol = "MiniKittyZilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x296f20246BCFC892C1f5F05A5c6C1741e0198376); // Marketing Address
    address payable public teamWalletAddress = payable(0x63B7e3B6B5De027d88eab158A9ED7f1d72B4e446); // Team Address
