...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ninfak(address account, uint256 amount) internal virtual {
...
contract NINFAK  is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("NINFAK", "NINFAK") {
        _ninfak(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}