...
Welcome a to project RainbowDOT

RainbowDOT a community created project that strives to provide secure and user friendly system to help create financial freedom for investors with the added benefit of helping others along the way. 
Features such as a liquidity lock, dev wallet locks, and fair launch make this a safe and fun way to earn passive income just by holding..
...
✅ Telegram : https://t.me/RainbowDOT
✅ Twitter : https://Twitter.com/RainbowDotChat
✅ Website : https://yourcountdown.to/time-launch-website-rainbowdot-rainbow-1627200393
...
contract RainbowDOT is Context, IERC20, Ownable {
    ...
    string private _name = "RainbowDOT";
