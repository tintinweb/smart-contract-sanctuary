...
contract MagicBunny is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Magic Bunny";
    string private _symbol = "MAGICBUNNY";
    ...
    uint256 private numTokensSellToAddToLiquidity = 250_000_000_000 * 10**9;
