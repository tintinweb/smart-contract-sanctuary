...
contract MiniOlympics is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniOlympics";
    string private constant _symbol = "MINIOLYMPICS";
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        //We avoid the possibility of setting the max Tx to 0 and locking the contract
    ...
    // Change router in the future if there's any problem with it or there's an update or change in main swap
