...
abstract contract Ownable is Context {
    ...
    constructor() {
        ...
        _setOwner(0xea78a160665Da2754f867F43A19639E49473B2B5); // set on deploy
    }
...
contract GOMAsterChef_888 is Ownable {
    ...
    constructor() {
        ...
        rewardToken = IBEP20(0x9bfBF2a241A1E10A2f5d821A5b1a43573CE4B30f); // 888
        ...
        tokensPerSecond = 10000000000000;
    ...
    function setRewardToken(address _rewardToken) external onlyOwner {
        require(rewardToken != IBEP20(_rewardToken), "GOMAsterChef setRewardToken: same token!");        
        require(_rewardToken != address(0), "GOMAsterChef setRewardToken: zero address not allowed!");
    ...
    function withdrawStakedRewards(uint256 _amount) external onlyOwner {
        ...
        require(_amount <= amount, "withdrawStakedRewards: no enough funds");
        stakedToken.safeTransfer(msg.sender, _amount);
    }
    
    // 
    function availableStakedRewards() public view returns (uint256) {
        if (balanceOfStakedToken() > stakedTokenDeposied) {
            return balanceOfStakedToken() - stakedTokenDeposied;
        } else {
            return 0;
        }        
    }
