...
contract CarolBaskinToken is Context, IERC20, Ownable {
    ...
    string private _name = "Carole Baskin Token";
    ...
    address public marketingAddress = 0x26183DEF2D8fA5144c7A1F94bE25f3A11ed2e106;
    
    uint256 public _charityFee = 2;
    uint256 private _previousCharityFee;
    address public charityAddress = 0x6e4e70b45eaDEBDB0C5a8e9D8149B14CED2dEE4d;
    
    uint256 public _buybackFee = 4;
    uint256 private _previousBuybackFee;
    
    uint256 public _sellBuyback = 4;
    uint256 public _sellrfi = 2;
    uint256 public _sellMarketing = 4;
    uint256 public _sellCharity = 2;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbCharity = (address(this).balance - initBalance) * _charityFee / (_buybackFee + _charityFee);
        payable(marketingAddress).transfer(bnbMarketing);
        payable(charityAddress).transfer(bnbCharity);
    }
    ...
    function calculateSwapFee(uint256 _amount) private view returns (uint256) {
        return _amount * (_buybackFee + _marketingFee + _charityFee) / (
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_taxFee == 0 && _buybackFee == 0 && _marketingFee == 0 && _charityFee == 0) return;
    ...
    function setSellFees(uint256 sellBuyback, uint256 sellRfi, uint256 sellMarketing, uint256 sellCharity) external onlyOwner{
        _sellBuyback = sellBuyback;
        _sellrfi = sellRfi;
        _sellMarketing = sellMarketing;
        _sellCharity = sellCharity;
    }
