...
abstract contract Auth {
    ...
    /**
     * Renounce ownership to new address. Caller must be owner.
     */
...
contract CaesarTheDumper is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CAESAR THE DUMPER";
    string constant _symbol = "CTD";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEC17BDB422672f92d7AAB1EC790C54528a893A74;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        uint256 multiplier = isSell ? sellMultiplier : 1;
