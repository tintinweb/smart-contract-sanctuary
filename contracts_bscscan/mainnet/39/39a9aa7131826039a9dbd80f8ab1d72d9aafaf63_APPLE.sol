...
Apple Meta is a decentralized token that is evolving into a vibrant ecosystem of wealth generation!
We are committed to making Apple Meta a vital part of the MetaVerse revolution for years to come. APPLE will officially launch on January 25, 2022.
Start the year with your superheroes! Apple Meta is going to launch a 3D NFT collection about the superheroes, pick your favorite superheroes!   

Website https://apple-metaversebsc.com/
Telegram https://t.me/Apple_MetaverseBsc
Twitter: https://twitter.com/AppleMeta_Real
WhitePaper: https://apple-metaversebsc.com/whitepaper.pdf
...
contract APPLE is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xF9cd84FE0e2b70053a58761A5Bc7cf6F1Fd9d63c); // Marketing Address
        
    address payable public buybackAddress =
        payable(0xF9cd84FE0e2b70053a58761A5Bc7cf6F1Fd9d63c); // BuyBack Address
        
    address payable public liquidityAddress =
        payable(0xF9cd84FE0e2b70053a58761A5Bc7cf6F1Fd9d63c); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10000 * 1e6 * 1e4;
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xF9cd84FE0e2b70053a58761A5Bc7cf6F1Fd9d63c).call{value: bnbForDev}("");
