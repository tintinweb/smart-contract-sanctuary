...
~ ANTI-WHALE CONTROL FEATURES:
  ...
  Max withdraw amount of 50 SOL per day.
...
contract solmoonfarm {
	using SafeMath for uint256;

	IERC20 public erctoken;
	address token = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; /** SOL **/
	/** default percentages **/
	...
	uint256 public MAX_WITHDRAW = 50 ether;
	...
	uint256 public LOTTERY_TICKET_PRICE = 10 * 1e16; /** 0.1 SOL **/
	...
	constructor(address ownerAddress, address payable projectAddress, address payable marketingAddress, address payable communityAddress) {
        ...
        plans.push(Plan(200, 30, 10 * 1e16, 0, 0, 0, 0, true));
        plans.push(Plan(40,  70, 10 * 1e16, 0, 0, 0, 0, true));
        plans.push(Plan(60,  65, 10 * 1e16, 0, 0, 0, 0, true));
        plans.push(Plan(80,  60, 10 * 1e16, 0, 0, 0, 0, true));
	}
