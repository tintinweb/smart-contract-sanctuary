...
contract DODZila is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 100000000000000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 9;
    uint256 MAX_LOCK   = 10000000000000 * 10 ** 9;
    ...
    // Transfer fee
    uint256 public sellFeeRate = 9;
    uint256 public buyFeeRate = 9;


    constructor() ERC20("DODZila", "DODZila") {
