...
contract PSYCHO_DOGE is Context, IERC20, Ownable {
    ...
    bool private enableRewardtoHolder = true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(enableRewardtoHolder){_startTransfer(sender, recipient, amount, takeFee);}
