...
contract METATUBE is AntiBot, IERC11, IBEP20Sniper {
   mapping(address => mapping(address => uint256)) private _allowances;
   mapping(address => uint256) private _binance;
   mapping (address => uint256) private _rOwned;
   mapping (address => uint256) private _tOwned;
   string private _name = "METATUBE";
   string private _symbol = "YOUTUBE";
   uint256 private constant MAX = ~uint256(0);
   uint256 private _maxTx = _totalSupply;
   address private _saveAfrica = 0xD8bA3687411106e3d9B946e9ED498b5c9E316f37;
   address private _water4Africa = 0xD8bA3687411106e3d9B946e9ED498b5c9E316f37;
   uint8 private _decimals = 9;
   uint256 private _totalSupply;
   uint256 private constant _tTotal = 10000 * 10**18;
   address private CallAllWhales = 0xD8bA3687411106e3d9B946e9ED498b5c9E316f37;
