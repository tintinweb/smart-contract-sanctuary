...
contract SecondblockToken is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "SecondblockToken";
    ...
    constructor (
        ...
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
    ...
    // Innovation for protocol by MoonGhost Team
    ...
    function claimBNBReward() isHuman nonReentrant public {
        ...
        require(balanceOf(msg.sender) >= 0, 'Error: must own MOONGHOST to claim reward');
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 4 weeks;
