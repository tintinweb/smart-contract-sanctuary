...
contract TOKUM is Operator {
    ...
    string private _name = "TOKUM";//#币名
    string private _symbol = "TOKUM";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0x5eb614061f64771B0428Ac3b1e2D85a01F2b1679),true);
    }
