...
contract LPTokenWrapper is IPool,Governance {
    ...
    IERC20 public _lpToken = IERC20(0xb23369ee9f0453befEfA35E299b31A66E97cEaAE); //todo
...
contract UniswapReward is LPTokenWrapper{
    ...
    IERC20 public _EMP = IERC20(0xb23369ee9f0453befEfA35E299b31A66E97cEaAE);    //todo
    
    int128 private dayNums;
    // int128 baseReward = 8561;
    // uint256 public constant DURATION = 7 days;
    // should do this ? 
    uint256 public  DURATION = 1 days;       //todo
    uint256 public _initReward = 55 * 1e17;
    ...
    uint256 public _punishTime = 0 days;    //todo
    ...
    function set_KI_address(address emp)public onlyGovernance{
        _EMP = IERC20(emp);
    }
    ...
    function getReward() public updateReward(msg.sender) checkHalve checkStart {
        ...
        if (reward > 0) {
            ...
            if(leftReward>0){
                _EMP.safeTransfer(msg.sender, leftReward );
    ...
    modifier checkHalve() {
        if (block.timestamp >= _periodFinish) {
            ...
            // _EMP.mint(address(this), _initReward);          //todo
    ...
    {
        startRewardinternal(block.timestamp,5500000000000000000);
    }
    

    // set fix time to start reward
    function startRewardinternal(uint256 startTime ,uint rewadnum)
        internal
    {
        ...
        // _EMP.mint(address(this), _initReward);
    ...
    function notifyRewardAmount(uint256 reward)
        ...
        updateReward(address(0))
    {
        IERC20(_EMP).safeTransferFrom(msg.sender, address(this), reward);
        if (block.timestamp >= _periodFinish) {
