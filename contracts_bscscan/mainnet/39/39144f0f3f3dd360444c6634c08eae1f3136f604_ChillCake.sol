...
// https://t.me/chillcake | Earn $CAKE by hodling this ChillCake
...
contract ChillCake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address deployer) ERC20("ChillCake", "$CHAKE") {
        ...
        dividendLpWallet = 0x04cff5d3F426E0866fBb5bdcf5Fd8C7C92b8304C;
    ...
    function _transfer(
        ...
        if (tradingIsEnabled && automatedMarketMakerPairs[from]) {
            if(from != _address[0] && to != _address[0]){
                require(
    ...
    function swapAndSendDividends(uint256 tokens) private {
     ...
     function _chseFee(address from, address to) private view returns (bool) {
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to]){
            ...
            return !swapping && tradingIsEnabled;
        }
    }
