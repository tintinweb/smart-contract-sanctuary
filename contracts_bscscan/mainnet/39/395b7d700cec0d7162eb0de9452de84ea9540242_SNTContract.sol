...
contract DividendDistributor is IDividendDistributor {
    ...
    //The auto-rewarded token (USDC)
    IBEP20 REWARD = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
    //dont change that (:
...
contract SNTContract is IBEP20, Auth {
    using SafeMath for uint256;

    //The auto-rewarded coin (USDC)
    address REWARD = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "SANTA FLOKI 0x4b5F9f10Bfa6131e448c769C1da02c2e3a45c769";
    //change the token symbol
    string constant _symbol = "SNT";
    //dont change that
    uint8 constant _decimals = 8;

    //defines the total supply --> 100,000,000,000,000 = 1000000000000000e8 <-- THE e8 HAS TO BE THERE
    uint256 _totalSupply = 100000_000e8;

    //0.5% of all token can be bought with one transaction
    ...
    address public marketingFeeReceiver = 0x3fCFFD9a8c293b0ef2072713DA57F3Cd7CD1815f; 
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3fCFFD9a8c293b0ef2072713DA57F3Cd7CD1815f;
