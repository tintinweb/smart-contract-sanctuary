...
/**
$MarioRise
Telegram : https://t.me/MarioRise

The official contract will be sent out a few minutes before the fair launch. Yes some bots might snipe it but at least we know that everyone will be able to verify it and make sure its safe.

- Very thought-out tokenomics :
...
contract MarioRise is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "MRise";

  string private _name = "MarioRise";
