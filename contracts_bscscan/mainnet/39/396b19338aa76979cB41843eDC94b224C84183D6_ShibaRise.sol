...
/**
   ...
   #PIG+#SAFEMOON+#SHIBA+#DOGE+#EVERRİSE, combine together to #ShibaRise

    I make this #ShibaRise to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/ShibaRise_BSC
   ...
   I will renounce the ownership to burn addresses to transfer #ShibaRise to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49.5% total supply to the pool
   Can you make #ShibaRise 10000000X? 
   ...
   it's the best part of the #ShibaRise idea, increasing the liquidity pool automatically, 
...
contract ShibaRise is Context, IERC20, Ownable, Pausable {
