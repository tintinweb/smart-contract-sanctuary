...
contract FWT is Context, IERC20, Ownable {	
    ...
    string private constant _name = "FWT";	
    string private constant _symbol = "FWT";	
    uint8 private constant _decimals = 18;	
    	
    uint256 public _Prizepoolfee = 0;	
    uint256 private _previousFundFee = _Prizepoolfee;	
   ...
   function excludedFromFundFee(address account) external onlyOwner {	
    ...
    function setFundFeePercent(uint256 _fundFeePercent) external onlyOwner() {	
        _previousFundFee = _Prizepoolfee;	
        _Prizepoolfee = _fundFeePercent;	
        emit FundFee(_previousFundFee,_Prizepoolfee);	
    }	
    	
    	
    function Prizepoolcontract(address _account) external onlyOwner() {	
    ...
    function _transfer(	
        ...
        if(_isExcludedFromFundFee[from]){	
         ...
         //send 1% to owner 	
        uint256 _amountSentToOwner = amount.mul(_Prizepoolfee).div(10**2);	
