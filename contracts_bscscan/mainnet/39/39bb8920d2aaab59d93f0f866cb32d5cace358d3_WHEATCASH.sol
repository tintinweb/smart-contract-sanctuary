...
contract WHEATCASH is Context, IERC20, Ownable {
    ...
    string private _name = 'WHEAT CASH';
    string private _symbol = 'WTK';
    ...
    address public burnAdd = 0xd6d37C3d56d6C346cF85938DE377E1A457DEF23D;
    
    uint private _max_tx_size = 60 * 10**8 * 10**9;
