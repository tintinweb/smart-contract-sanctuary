...
/*
    ...
    -Initial #LP will be #3BNB and #LP will #burn when launched
    -#TaxFee '0' - NoTransactionsFee (We will not rob you with high transaction fees.)
    -No #Marketing and #Developer wallets(No-FreeTransactions!!!)
    -#Ownership will be renounced.

    Let's join us ; t.me/LazyBonesNFTio
...
contract LazyBonesNFT is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "LazyBonesNFT";
    string private constant _symbol   = "LAZY";
