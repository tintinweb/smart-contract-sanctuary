...
Since 2021, Hold GRANNY FEG Earn BABY FEG COIN and MUM FEG COIN
...
contract GrannyFEG is IBEP20, RSunAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "GRANNY FEG COIN";
    string constant _symbol = "$GRANNYFEG";
