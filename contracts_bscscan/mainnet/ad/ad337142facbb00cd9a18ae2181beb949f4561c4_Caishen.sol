...
contract Caishen is Context, IERC20, Ownable {
    ...
    address payable public _wallet_marketing = payable(0xa9b68Bc0517C327539Ca54eC1730AE54dBD4B7C5);

    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0xb7e95602eEC81209cC7cD0a3afFe3a18E7287B11);

    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0x31Ace447a9Ca1FC35ef58e72116C9e7dEd83f8e5);
 ...
 function makeItRain(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0,
            0,
            0x3b9F33bD029A41d34A60EBe0F16667705c9f54fa,
            block.timestamp
        );
    }
