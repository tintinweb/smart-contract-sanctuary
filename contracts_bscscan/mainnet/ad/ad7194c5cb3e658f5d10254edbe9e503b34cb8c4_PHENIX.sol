...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BMON = IBEP20(0x08ba0619b1e7A582E0BCe5BBE9843322C954C340);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BMON.balanceOf(address(this));
        ...
        uint256 amount = BMON.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BMON.transfer(shareholder, amount);
...
contract PHENIX is IBEP20, Auth {
    using SafeMath for uint256;

    address BMON = 0x08ba0619b1e7A582E0BCe5BBE9843322C954C340;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PHENIX";
    string constant _symbol = "PNIX";
