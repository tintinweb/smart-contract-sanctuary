...
import "./SuperMiniCake-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SuperMiniCake` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SuperMiniCake(Env.Testnet)` or `SuperMiniCake(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SuperMiniCake";
    string internal constant SYMBOL = "SMC";
     ...
     */
    address internal tipToTheDev =0x38F6B89116655552272ec6657820801BCfacFb91;
...
contract SuperMiniCake is SafeToken{
