...
// CHANGE
contract TARKOV  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Tarkov";
    string constant _symbol = "TARKOV";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 1000; // 3% MAX 300,000
    ...
    uint256 liquidityFee = 300; // 2%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; //
    uint256 devFee = 700; // 0%
    uint256 totalFee = 1000; // liquidityFee + reflectionFee + devFee
