...
contract DigitalHuman is Context, IERC20, Ownable {
    ...
    string private _name = "Digital Human";
    string private _symbol = "DIGITALHUMAN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000 * 10**9 * 10**_decimals;
    
    address payable public marketingAddress = payable(0xc0e214620FCf93F262c25652d44322d6b7E36eb0);
