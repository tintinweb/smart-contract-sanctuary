...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 USDT = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    uint256 public minDistribution = 100 * (10 ** 12);
...
/* Token contract */
contract Parafloki is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address USDT = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xdC64Ae053d65Df8aAbbe2EdF37867a61d4fAA0cE;
    ...
    // Name and symbol
    string constant _name = "Para Floki";
    string constant _symbol = "PARAFLOKI";
    ...
    uint256 public swapThreshold = _totalSupply * 150 / 10000; // 2% of supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xeedADFd36F653a6757C60482e207930894F46670;
