...
// CHANGE
contract Marketing is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Marketing";
    string constant _symbol = "$Marketing";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 5,000,000
    ...
    uint256 devFee = 800; // 6%
    uint256 totalFee = 1200; // liquidityFee + marketingFee + devFee
    uint256 feeDenominator = 10000;
    uint256 public _sellMultiplier = 2; // 3x for sells
    ...
    uint256 public swapThreshold = _totalSupply / 500; // 0.4%
    bool inSwap;
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xD8e2F61613efB1bc1a5D3dfAC350bA180FE0F420);
