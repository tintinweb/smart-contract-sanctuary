...
// Tocino features:
//  2% Transaction - reflection fee
//  4% Development fee goes in to marketing wallet
//  2% Liquidity fee goes into liquidity pool every transaction
//  Total Tax 8%
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x137684147ec2c2A07177ba7086f74A9496F19D5e;
...
contract TocinoTokenRoulette is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xFF694d9647Eb73EA36f3849FDe5EF880940b9B96;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TocinoTokenRoulette";
    string private _symbol = "RLT";
