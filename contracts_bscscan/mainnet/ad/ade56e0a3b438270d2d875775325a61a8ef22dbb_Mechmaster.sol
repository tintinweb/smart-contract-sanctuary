...
contract Mechmaster is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x8fCFc5F6f9218e92DA7d1D56DAC4545216C562bF); // Marketing Address
    address payable public charityAddress = payable(0x8fCFc5F6f9218e92DA7d1D56DAC4545216C562bF); // Charity/Dev Address
    ...
    uint256 private _tTotal = 650000000 * 10**18; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MechMaster"; // nice
    string private _symbol = "MECH";
    ...
    uint256 public _maxTxAmount = 85000 * 10**18;  
    uint256 private minimumTokensBeforeSwap = 85000 * 10**18;
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 650000000000000000000; // nice: Claim 650 (0.01 BNB = 8500) 
    ...
    uint256 private salePrice = 850000; 
