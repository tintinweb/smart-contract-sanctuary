...
contract PoorPepe is Context, IBEPMEME, Ownable {
    ...
    uint256 private constant _allTotalSupply = 1 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'PoorPepe';
    string private _symbol = 'PoorPepe';
