...
contract PuberTitties is Context, IERC20, Ownable {
    ...
    string private _name = 'PuberTitties';
    string private _symbol = 'PuberTits';
    uint8 private _decimals = 18;
    
    
    uint256 public                _taxFee = 8; // 4% of transactions will be redistributed among holders
