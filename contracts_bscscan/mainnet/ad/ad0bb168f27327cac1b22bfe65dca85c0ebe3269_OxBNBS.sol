...
//  OxBNBS - Rewards you in BNB every 30 Mins.   Min of 1000 Tokens to hold for rewards.
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 30 * 1 minutes;// 1 hours;
    uint256 public minDistribution = 1 * (1 ** 18);//(10 ** 18) 10,000;
...
contract OxBNBS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "OxBNBS";
    string constant _symbol = "OXBNBS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);  //uint256 _totalSupply = 2917000000000 * (10 ** _decimals);
