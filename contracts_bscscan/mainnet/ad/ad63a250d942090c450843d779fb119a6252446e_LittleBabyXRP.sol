...
/**
   ...
   Welcome to LittleBabyXRP
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleBabyXRPBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LittleBabyXRP to the community, make sure it's 100% safe.
   ...
   it's the best part of the #LittleBabyXRP idea, increasing the liquidity pool automatically, 
...
contract LittleBabyXRP is Context, IERC20, Ownable {
    ...
    string private _name = "Little Baby XRP";
    string private _symbol = "LTBABYXRP";
