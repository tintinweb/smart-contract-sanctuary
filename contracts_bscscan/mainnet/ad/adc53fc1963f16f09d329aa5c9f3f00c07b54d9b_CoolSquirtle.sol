...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract CoolSquirtle is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x17969fc3a31C747e36821dce99C04Fb57a90d1f1); // Marketing Address

    address payable public teamAddress =
        payable(0xfDA35A9685c1522bBF7557Be7f9360c064335e9C); // Team Address

    address payable public liquidityAddress =
        payable(0xfDA35A9685c1522bBF7557Be7f9360c064335e9C); // Liquidity Address
    ...
    string private constant _name = "CoolSquirtle";
