...
contract LUNAGIRL is Context, IERC20, Ownable {
    ...
    //change that
    uint8 public maxLiqFee = 4;                // Transaction fee % that would be used to add liquidity (0-10)
    ...
    uint8 public minMxTxPercentage = 6;         // Transaction allowed as % of supply (1-100). Anti-Whale mechanics
    uint8 public minMxWalletPercentage = 6;     // The maximum supply % that a wallet can hold (1-100). Anti-Whale mechanics
