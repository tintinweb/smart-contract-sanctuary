...
/*     @@@@@@   @@@@@@   @@@@@@   @@@@@@            @
       ...
       Anti Bot & Anti whale mechanism
       
       Max wallet holding     30000000000000
       Max Transaction amount 20000000000000
       ...
       Telegram - https://t.me/doge1officialchat
       Twitter - https://twitter.com/doge1tomoon
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0D3B7fd43eEe138868316f4E6E4AFe254F65Aa55;
...
contract DOGE1 is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x1EaC28E990a1Ca4D4af6c8a6CA324C3581E06804);
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x1EaC28E990a1Ca4D4af6c8a6CA324C3581E06804)] = true;
    ...
    function feeSetDev(uint256 promoFee) external onlyOwner() {
        _promoFee = promoFee;
    }
    ...
    function _transfer(
        ...
        if (to != owner() && to != address(this)  && to != address(0x000000000000000000000000000000000000dEaD) && to != uniswapV2Pair && to != _promotionsWalletAddress){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Buying limit reached");}
