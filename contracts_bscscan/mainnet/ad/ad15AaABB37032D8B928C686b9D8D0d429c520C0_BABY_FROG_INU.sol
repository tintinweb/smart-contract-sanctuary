...
BABY FROG INU
   ...
   This is a community token. Telegrams @BABY FROG INU  Important: The early you create a group that shares the token, the more gain you got.
...
🔥TOTAL SUPPLY 1,000,000,000,000,000 BABY FROG
🔥BURN SUPPLY 90% BABY FROG
🔥NO DEV TOKEN
   ...
   I will renounce the ownership #BABY FROG to the community, make sure it's 100% safe.

   I will add .2 BNB.
   Can you make #BABY FROG 10,000 X? 
   ...
   it's the best part of the #BABY FROG INU idea, increasing the liquidity pool automatically, 
...
contract BABY_FROG_INU is Context, IERC20, Ownable {
    ...
    string private _symbol = "BABY FROG";
