...
/* Token contract */
contract SonOfBabyZilla is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Son Of Baby Zilla";
    string constant _symbol = "SOBZ";
    ...
    uint256 public swapThreshold = _totalSupply * 20 / 10000; // 200.000 tokens or 0.02% of supply
