...
contract MorrallaToken is Ownable, BEP20('Nueva Morralla', 'MORRALLA') {
    // set max supply
    uint256 constant private _maxTotalSupply = 15768000 ether;  // 1.5 annos de emicion 
