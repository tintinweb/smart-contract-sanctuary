...
contract Test is IBEP20, Auth {
    ...
    string constant _name = "TestNOBUY";
    ...
    uint256 public _walletMax = _totalSupply * 10 / 500; // 2% of total supply
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xb2F0D477f10029E831CefdDFCF4f90F576374E62;  // Test Marketing, Support, and Charity
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
        require(canTrade || sender == owner, "Trading is not enabled yet.");
