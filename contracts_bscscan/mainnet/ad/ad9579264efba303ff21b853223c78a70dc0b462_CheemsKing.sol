...
contract CheemsKing is Context, IERC20, Ownable {
    ...
    string private constant _name = "CheemsKing"; // 
    string private constant _symbol = "CheemsKing"; //
