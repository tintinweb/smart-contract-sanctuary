...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #BabyMcDonalds  

    I make this #BabyMcDonalds to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BabyMcDonaldsBSC
   ...
   I will renounce the ownership to burn addresses to transfer #BabyMcDonalds to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49.5% total supply to the pool
   Can you make #BabyMcDonalds 10000000X? 
   ...
   it's the best part of the #BabyMcDonalds idea, increasing the liquidity pool automatically, 
...
contract BabyMcDonalds is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("BabyMcDonalds", "BMD") {
