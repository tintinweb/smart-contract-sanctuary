...
contract OpenZilla is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint256;

    uint256 MAX_TOTAL_SUPPLY         = 1000 * 10 ** 9;
    uint256 MAX_TOKENS_FOR_REWARDS   = 0 * 10 ** 9;
    uint256 MAX_LOCK   = 1000 * 10 ** 9;
    ...
    constructor() ERC20("OpenZilla", "BPOOL") {
        addressForMarketing =address(0x5452E70981DdC740993f0d3e70D2fD8C15110F20);
