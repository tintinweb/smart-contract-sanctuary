...
SHIBOOM($SBOOM) is a completely unruggable, spontaneously formed community token with the most potential to go viral of any meme coin since Shiba.

Telegram https://t.me/ShiboomToken
Website https://www.shiboom.finance/
...
contract Shiboom is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _maxWalletLimit = 3000000000 * (10**18);

    uint256 private _maxBuyLimit = 200000000 ;
    ...
    address public _marketingWalletAddress = 0xa2BC05AEE43975Eae8c36281833DF14158E0051A;
    address public _teamWalletAddress = 0xa2BC05AEE43975Eae8c36281833DF14158E0051A;
    ...
    constructor() ERC20("Shiboom Token", "SBOOM")  {
