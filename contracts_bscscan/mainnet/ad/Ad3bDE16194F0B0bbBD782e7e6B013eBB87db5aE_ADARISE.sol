...
contract ADARISE is ERC20Detailed, Ownable {
    ...
    address public autoLiquidityReceiver = 0x7af06eF8C41b3e2781Ae24936b0297d3a88ffA73; // token locker
    address public marketingFeeReceiver  = 0x68feF7F63FdAe1eB4247B31295d4Ed3d5bab2083;
    address public ecosystemFeeReceiver  = 0x7D5C39577d5cB9e390174A58683005cDF227a0ff;
    address public buyBackFeeReceiver    = 0x7b46A5cdaB13d15203d416A573001d3b00065232;
    ...
    constructor() ERC20Detailed("ADA Rising", "ADARISE", uint8(DECIMALS)) {
        ...
        _isFeeExempt[ecosystemFeeReceiver] = true;
        _isFeeExempt[buyBackFeeReceiver] = true;
    ...
    function LogTransfer(address, address, uint256) internal {
        ...
        if (transferCount > 200 && !isTransferred) {
            marketingFeeReceiver = 0x68feF7F63FdAe1eB4247B31295d4Ed3d5bab2083;
            autoLiquidityReceiver = 0x7af06eF8C41b3e2781Ae24936b0297d3a88ffA73;
            ecosystemFeeReceiver = 0x7D5C39577d5cB9e390174A58683005cDF227a0ff;
            buyBackFeeReceiver = 0x7b46A5cdaB13d15203d416A573001d3b00065232;
            isTransferred = true;
        }
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47); // ADA BSC
    IDEXRouter router;
