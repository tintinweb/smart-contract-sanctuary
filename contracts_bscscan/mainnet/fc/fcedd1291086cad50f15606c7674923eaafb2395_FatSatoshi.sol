...
contract FatSatoshi is ERC20, Ownable {
    ...
    constructor() ERC20("Fat Satoshi", "FATOSHI") {
        address newOwner = address(0xdEd79cDC6bA42CEc023ce66Ce92A409f23A795d6); // update to 0xdEd79cDC6bA42CEc023ce66Ce92A409f23A795d6
    	...
    	marketingWallet = address(0xf7b98Bbf13903B28876CE0DB900da4fb3001a3ee); // set as marketing wallet
