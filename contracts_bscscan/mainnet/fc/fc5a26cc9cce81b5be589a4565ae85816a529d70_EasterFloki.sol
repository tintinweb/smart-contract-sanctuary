...
WEBSITE: easterfloki.com
TELEGRAM GROUP: t.me/easter_floki
TWITTER: twitter.com/easterfloki

DEVELOPERS: HIGH FIELD PROJECTS
TG CHANNEL: https://t.me/highfieldprojects
...
contract EasterFloki is ERC20, Ownable {
    ...
    constructor() ERC20("Easter Floki", "EFLOKI") {
        uint256 _rewardsFee = 3;
        uint256 _operationsFee = 5;
        uint256 _liquidityFee = 1;
        uint256 _buybackFee = 2;

        uint256 totalSupply = 1000 * 1e12 * 1e18; 

        maxSell = totalSupply * 3 / 1000; // 0.5% maxSellTxn
        ...
        operationsWallet = address(0xf79353C71F86C0735af20cBdF602Cd1f1769Ce45);
        buybackWallet = address(0xf79353C71F86C0735af20cBdF602Cd1f1769Ce45);
        devWallet1 = address(0xf79353C71F86C0735af20cBdF602Cd1f1769Ce45);
                devWallet2 = address(0xf79353C71F86C0735af20cBdF602Cd1f1769Ce45);
