...
(_______)                                (_______)     | |     (______)                  
 _____ ___   ____ _____ _   _ _____  ____ _     _ ____ | |_   _ _     _ ___  _ _ _ ____  
|  ___) _ \ / ___) ___ | | | | ___ |/ ___) |   | |  _ \| | | | | |   | / _ \| | | |  _ \ 
| |  | |_| | |   | ____|\ V /| ____| |   | |___| | | | | | |_| | |__/ / |_| | | | | | | |
|_|   \___/|_|   |_____) \_/ |_____)_|    \_____/|_| |_|\_)__  |_____/ \___/ \___/|_| |_|
                                                         (____/                          
*/

/*
What is OnlyDOWN?
OnlyDOWN is a unique token which starting supply is super low and increasing constantly resulting in red charts.

Why red charts?
There have been always pumpers and dumpers seeing ath in the charts. So noone will be able to see aths in the chart but will be able to see their increasing bnbs and supply.

What makes it special?
The special thing is that community will decide when to stop increasing supply and by then we will have super bullish all green candles. And it will be surprise for all who follow only charts except marketcap and supply.
*/
...
contract ForeverOnlyDOWN is ERC20Detailed, Ownable {
    ...
    uint256 public totalFee =
        ecosystemFee.add(liquidityFee).add(marketingFee).add(teamFee);
    ...
    constructor() ERC20Detailed("ForeverOnlyDOWN", "ForeverOnlyDOWN", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x22F87eBf753A0465637014513C36894bF30ECE12;
        marketingFeeReceiver = 0x3d463AB8cFE6b4097eDdF871e6D6722979d30D5e;
        ecosystemFeeReceiver = 0x5D0e53e3BF3eb98C085682c7Cbad7ee95Dc6692B;
        teamFeeReceiver = 0x4331918d26F5127DF374F3a6D6e5A0Ecf42B7330;
    ...
    function setFees(
        ...
        totalFee = ecosystemFee.add(liquidityFee).add(marketingFee).add(teamFee);
