...
contract machete is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "machete";
    string private _symbol = "machete";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xAd58480db2Aff6eE08a33694B502888EC9066666); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x7d86a6E1E7E23A59a20EB8941715581aAb24668F); // buyback Address
    ...
    uint256 private _totalSupply            = 10000000 * 10**3 ;
    uint256 public _maxTxAmount             = 10000000 * 10**3;
    uint256 public _walletMax               = 10000000 *  10**3;
