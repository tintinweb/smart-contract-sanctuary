...
/**
Compile using v0.7.6+
Optomization should be turned on

prepareForPreSale: Removes transaction and wallet limits.
You shouldn't need to use it for regular deployments, but it can be useful in emergencies and also when removing LP

and afterPreSale: Resets the transaction and tax limits to the original setting.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RWRD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //Reward Token (DOT)
...
contract ShiBUSD is IERC20, Ownable {
    using SafeMath for uint256;

    address RWRD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;  //Reward Token (BUSD)
    // ADA: 0x3ee2200efb3400fabb9aacf31297cbdd1d435d47
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ShiBUSD";
    string constant _symbol = "ShiBUSD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 200; //0.5% of total supply
    uint256 public maxWalletToken = 15000000 * (10 ** _decimals); // 1.5% of total supply
    ...
    function prepareForPreSale() external onlyOwner {
      _maxTxAmount = _totalSupply; //0.2% of total supply
      maxWalletToken = _totalSupply; // 2% of total supply
    }

    function afterPreSale() external onlyOwner {
      _maxTxAmount = (_totalSupply * 1) / 200; //0.5% of total supply
      maxWalletToken = 15000000 * (10 ** _decimals); // 1.5% of total supply
    }
