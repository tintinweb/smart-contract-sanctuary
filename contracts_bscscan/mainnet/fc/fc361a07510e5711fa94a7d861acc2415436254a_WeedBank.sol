...
contract WeedBank is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4200000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Weed.Bank";
    string private _symbol = "WDBANK";
    ...
    uint256 public _maxTxAmount = 4200000000000000 * 10**18;
    ...
    function prepareForPresale() external onlyOwner() {
       ...
       _maxTxAmount = 4200000000000000 * 10**18;
