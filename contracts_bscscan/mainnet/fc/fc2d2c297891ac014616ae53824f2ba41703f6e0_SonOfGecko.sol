...
/**
 #SonOfMeta - Stealth Launch
 
* Total Supply: 1,000,000,000,000,000
* Max Buy: 5,000,000,000,000 (~0.5% of Total Supply)
* Max Hold: 20,000,000,000,000 (2% of Total Supply)
...
contract SonOfGecko is Context, IERC20, Ownable { 
    ...
    string private _name = "SonOfGecko"; 
    ...
    address public devWallet = 0x22F010aC78e65eCB69E5BD3E28bB0Dc7219a5384; 
    ...
    uint256 public _maxTxAmount = 5 * 10**12 * 10**9; //none 
    uint256 private numTokensSellToAddToLiquidity = 5 * 10**11 * 10**9; 
    uint256 public _maxWalletToken = 2 * 10**13 * 10**9; 
