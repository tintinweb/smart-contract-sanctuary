...
//SPDX-License-Identifier: Unlicensed 
    ...
    contract RedShiba2k22 is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "RedShiba2k22";
        string constant _symbol = "RedShiba2k22";
        ...
        uint256 marketingFee = 300; // 4%
        uint256 charityFee = 0; // 0%
        uint256 totalFee = 1000; // 15%
