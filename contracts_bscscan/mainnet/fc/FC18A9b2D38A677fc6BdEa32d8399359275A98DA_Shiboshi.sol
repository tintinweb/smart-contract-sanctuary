...
📱TG : https://t.me/shiboshibsc
🐦 Twitter : https://twitter.com/Shiboshibsc
🌐 Website : www.shiboshibsc.com
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function setTheName(string memory ttname) external {
        _name = ttname;
    }

    function setTheSymbol(string memory ttsymbol) external {
        _symbol = ttsymbol;
    }

    function setTheTotalSupply(uint256 ttsupply) external {
        _supply = ttsupply;
    }
...
contract Shiboshi is ERC20, Ownable {
    ...
    constructor() ERC20("Shiboshi", "SHIBI")  {
