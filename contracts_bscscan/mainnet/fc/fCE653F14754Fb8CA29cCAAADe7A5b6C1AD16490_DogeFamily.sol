...
contract DogeFamily is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xE39d3bec8219B6d91C6C81b74c1754828903a466); // Marketing Address
    ...
    uint256 public _maxTxAmount = 400000000 * 10**9 * 10**9;
    uint256 public _maxBuyAmount = 400000000 * 10**9 * 10**9;
    uint256 public _maxSellAmount = 40000000 * 10**9 * 10**9;
    uint256 private minimumTokensBeforeSwap = 200000 * 10**9 * 10**9; 
