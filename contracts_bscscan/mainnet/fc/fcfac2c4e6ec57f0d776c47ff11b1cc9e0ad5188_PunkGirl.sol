...
Telegram = https://t.me/PunkGirlBsc
...
// CHANGE
contract PunkGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PunkGirl";
    string constant _symbol = "PunkGirl";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 2% MAX 40,000,000
