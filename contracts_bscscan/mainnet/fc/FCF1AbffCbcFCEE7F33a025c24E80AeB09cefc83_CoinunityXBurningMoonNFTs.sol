...
contract CoinunityXBurningMoonNFTs is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    ...
    constructor() {
        ...
        NFTPrototypes.push(NFTData("Base Card", "QmNyCp3whkqAMc8fqUqhyWsQywVA8UJNatTxtWSq1YNXem"));
        NFTPrototypes.push(NFTData("VotingPower +10", "QmcQewxJtiui6ucnjHF4qG2JJGrMYjji7V8CCmUNL6HNVK"));
        NFTPrototypes.push(NFTData("VotingPower +20", "QmNon6b5FRM8C4keSJHnEys1KsJJEfVXvATxUxZXwyGbAw"));
        NFTPrototypes.push(NFTData("VotingPower +40", "QmQgbNmzwKu8DeYyyk7Tbx1CyadnK6sz4KJCqPbVLWuoiC"));
        NFTPrototypes.push(NFTData("VIP Level 2", "Qmf87GeTgihTiJfRWsn9YR88dqBCzcdDEbpNRL92wLBA6U"));
        NFTPrototypes.push(NFTData("50k MetaBurn", "QmTA3Kzyz5Hz3PrBk4SH1yq2YP8zmrFsepBN2wnAmbEFFJ"));
    ...
    function _distributeBNB(uint amount) private{
        ...
        uint RewardsAmount=amount*40/100;
