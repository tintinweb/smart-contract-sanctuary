...
contract KinnBTC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    KinnBTCDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("KinnBTC", "$Kin") {

    	dividendTracker = new KinnBTCDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        KinnBTCDividendTracker newDividendTracker = KinnBTCDividendTracker(payable(newAddress));
...
contract KinnBTCDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("KinnBTC Dividends", "KinnBTC_dividends") {
    	claimWait = 3600;
