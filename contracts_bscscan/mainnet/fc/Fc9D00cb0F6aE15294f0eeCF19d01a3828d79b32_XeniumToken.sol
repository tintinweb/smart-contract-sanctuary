...
contract XeniumToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x21A395524E60c212BA409eCbE2400fDa2738d8eC); // Marketing Address
    ...
    string private _name = "Xenium Token";
    string private _symbol = "XENT";
