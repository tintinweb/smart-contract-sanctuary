 ...
 * 
 * Tokenomics:
 * 7% buy tax: Liq: 1% Marketing: 1% Buyback: 1%  BUSD Rewards: 4%
 * 21% sell tax: Liq: 1% Marketing: 9% Buyback: 1%  BUSD Rewards: 10%
 * Anti-dump / whale features 
 * Max Buy/Wallet  3%            30,000  tokens
 * Max Sell        0.5%          5,000   tokens
*/ 
...
/* Token contract */
contract Unsafemoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "UNSAFEMOON";
    string constant _symbol = "USFM";
