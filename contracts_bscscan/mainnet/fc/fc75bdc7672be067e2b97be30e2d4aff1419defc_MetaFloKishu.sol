...
// Meta FloKishu Token
// https://Metaflokishu.com
// [email protected]
// https://twitter.com/Meta_flokishu

// Tokenomics of our token (Taxation) - total taxation is 12% Tax
// 5% Reflections
// 3% LP
// 4% Marketing
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb08C4C7a2D97Ded294709C62225f80425993974E;
...
contract MetaFloKishu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x83918E10ef2E30CcAE79E65B07C6Ae1cb70729C0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta FloKishu";
    string private _symbol = "MetaFlo";
