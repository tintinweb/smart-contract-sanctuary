...
Tg Link: https://t.me/TaxAvoidanceBSCElon

Elon Tweet Stealth Launch
...
// CHANGE
contract TaxAvoidance  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "TaxAvoidanceElon";
    string constant _symbol = "TA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100; // 5% MAX 500,000
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100; // 5% MAX 500,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xF6f5FC16d8435a23E4a577ee0b9E5D4214c9A3a9); // Change
