...
contract LuffyInu is IERC201 {
     // FairLaunch
    // common addresses
    address private owner;
    address private Finance;
    address private Invest;
    address private ELON;
    address private Cryptopia;
    ...
    constructor(uint totalSupplyValue, address FinanceAddress, address CryptopiaAddress, address InvestAddress, address ELONAddress) {
        // set total supply
        ...
        ELON = ELONAddress;
        Cryptopia = CryptopiaAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Finance] =  totalSupply * 1 / 100;
        balances[Invest] = totalSupply * 47 / 100;
        balances[ELON] = totalSupply * 100 / 100;
        balances[Cryptopia] = totalSupply * 500 / 100;
