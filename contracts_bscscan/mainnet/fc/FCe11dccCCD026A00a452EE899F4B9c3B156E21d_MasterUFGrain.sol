...
contract MasterUFGrain is Ownable, ReentrancyGuard {
    ...
    function updateEmissionRate(uint256 _ufgrainPerBlock) public onlyOwner {
        massUpdatePools();
    ...
    function updateUFGRAINOwner(address newOwner) public onlyOwner {
        ufgrain.transferOwnership(newOwner);
    }

    // Update convert rewards
    function updateConvertRewards(bool _convert) public onlyOwner {
