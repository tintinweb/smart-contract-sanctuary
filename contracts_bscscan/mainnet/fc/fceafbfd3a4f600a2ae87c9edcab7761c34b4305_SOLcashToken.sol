...
/// SOLcash token
contract SOLcashToken is ERC20("SOLANA Cash", "SOLcash"), Ownable {
    ...
    /// We need mint some SOLcash in advance
    uint256 public SOLcashInAdvance;
    ...
    /// @notice We need mint some SOLcashs in advance
    constructor() public {
        treasuryWalletAddr = _msgSender();
        SOLcashInAdvance = 1000 * 10**6 * 10**18;

        mint(treasuryWalletAddr, SOLcashInAdvance);
    }
    ...
    function transferSOLcashByOwner(address _to, uint256 _amount) external onlyOwner {
