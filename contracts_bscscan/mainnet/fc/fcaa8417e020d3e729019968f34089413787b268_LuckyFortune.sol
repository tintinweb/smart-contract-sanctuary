...
// File: contracts/CommunityBoost.sol

/**
 
/*

Join our telegram to get involved within the community! - https://t.me/CommunityBoostBSC




Buy fees - 2% redistributed to community holders, 4% marketing wallet and 6% to the community boost buyback function.
Sell fees - 7% redistributed to community holders, 4% marketing wallet and 7% to the community boost buyback function.
...
contract LuckyFortune is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0f62C537ceED2f056BcB8f9874440756877B5Af4); // Marketing Address
    ...
    string private _name = "CommunityBoost";
    string private _symbol = "ComB0";
