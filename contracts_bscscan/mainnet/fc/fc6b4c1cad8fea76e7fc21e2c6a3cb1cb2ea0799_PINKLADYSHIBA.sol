...
Twitter: https://twitter.com/pinkladyshiba
...
contract PINKLADYSHIBA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PinkLadyShiba";
    string private _symbol = "PLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6a370d9D3A047632B7EfbC8463884B80053CC5FA); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xA88B9F3B09f2CEf01F76E373FB4a34C943C0CF83); // buyback Address
    ...
    uint256 public _maxTxAmount = 40000000000 * 10**9; // 4%
    uint256 public _walletMax = 50000000000 * 10**9; // 5%
    uint256 private minimumTokensBeforeSwap = 8400000000 * 10**9; 
