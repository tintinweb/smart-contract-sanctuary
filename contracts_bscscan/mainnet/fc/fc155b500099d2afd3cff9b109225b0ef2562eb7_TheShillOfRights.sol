...
// CHANGE
contract TheShillOfRights is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "TheShillOfRights";
    string constant _symbol = "TSOR";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 25; // 3% MAX 30,000,000
    uint256 public _maxWalletSize = (_totalSupply * 1) / 25; // 3% MAX 30,000,000
    ...
    uint256 totalFee = 1500; // liquidityFee + marketingFee
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0xB064098f81Fbfd6892C84e737b61D1F6853C3026);
