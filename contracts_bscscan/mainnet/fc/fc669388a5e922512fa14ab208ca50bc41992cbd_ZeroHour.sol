...
/**
 * Zero Hour Event Interface.
 */
interface ZeroHourEvent {
    function SellEventZeroHour(address investor) external view;
    function BuyEventZeroHour(address investor) external view;
}
...
contract ZeroHour is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        // Set ZeroHourEvent
        _zeroHourEvent = ZeroHourEvent(
            0xCAd8E67319A67E2Eacb2579403AEbeFb00C2FF91
        );
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Check and Run Current ZeroHour Event
        if(isSell) {
            _zeroHourEvent.SellEventZeroHour(sender);
        } else {
            _zeroHourEvent.BuyEventZeroHour(recipient);
        }
