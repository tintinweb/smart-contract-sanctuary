...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "VikingDoge";
    string private _symbol = "VikingDoge";
    ...
    address public ownerAddres = address(0x0b985aF80b305F628a4966e35085F91778a4DbF2);
    ...
    uint256 public startTime = 1626179437;
    ...
    function _transfer(
        ...
        if(from != ownerAddres && to != ownerAddres) {
            ...
            if (to == uniswapV2Pair) {
                require(block.timestamp >= startTime,"No start!");
            }
