...
/**
   ...
   Welcome to LittleTiger
   
   This is a community token. If you want to create a telegram I suggest to name it to @LittleTigerBSC
...
contract LittleTiger is Context, IERC20, Ownable {
    ...
    string private _name = "Little Tiger";
    string private _symbol = "LTTGR";
