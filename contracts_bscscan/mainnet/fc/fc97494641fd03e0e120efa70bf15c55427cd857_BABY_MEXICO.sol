...
Welcome to BabyMexicoCity
   This is a community token. If you want to create a telegram I suggest to name it to @BabyMexicoCityChat
   ...
   I will add 2 BNB and left it to the pool
   Can you make #BabyMexicoCity 10000X? 
   ...
   it's the best part of the #BabyMexicoCity idea, increasing the liquidity pool automatically, 
...
contract BABY_MEXICO is Context, IERC20, Ownable {
    ...
    string private   _name = "BabyMexicoCity";
    string private _symbol = "BAMEX";
