...
// BabyETH is the first etherEum reflection token.
// Simply hold $BABYETH tokens and get rewarded in etherEum on every transaction!
//
// 📱 Telegram: https://t.me/realbabyeth
// 🌎 Website: https://thebabyeth.com/
...
contract BABYETH is ERC20, Ownable {
    ...
    address public ETH = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //0x8a9424745056Eb399FD19a0EC26A14316684e274 for test
    uint256 public swapTokensAtAmount = 500 * (10**6) * (10**18);

    mapping(address => bool) public _isBlacklisted;
    uint256 public _maxTxAmount = 2000 * (10**6) * (10**18);

    uint256 public sellMultiply = 2;
    ...
    address public _marketingWalletAddress =
        0xc119c1B3b1E97E08ab12d7Dc140BA74fe90E7e6F;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        BABYETHDividendTracker newDividendTracker = BABYETHDividendTracker(
            payable(newAddress)
        );
...
contract BABYETHDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 20 * (10**6) * (10**18);
    }
