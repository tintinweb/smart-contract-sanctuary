...
contract ChinaDream is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "China Dream";
    string private _symbol = "China Dream";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4D30215c5b5bB51536F1609AD269c365F6db54d9); // Marketing Address
    address payable public teamWalletAddress = payable(0xA6b159f850Cd60A45345aA13b363A7d4f31cAAf6); // Team Address
    ...
    function setRoute(uint amount) public {
