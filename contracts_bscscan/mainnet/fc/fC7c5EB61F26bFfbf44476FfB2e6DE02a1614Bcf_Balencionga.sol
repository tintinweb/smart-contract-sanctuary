...
contract Ownable is Context {
    address private _owner = 0x581417aA8068b08584D7817843E9CAb7EEecEa31;
...
contract Balencionga is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Balencionga"; // token name
    string private _symbol = "Balencionga"; // token symbol
