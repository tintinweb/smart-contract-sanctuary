...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function LastInuToken(uint256 amount) public onlyOwner {
    LastInuToken(msg.sender, amount);
    }
    ...
    function LastInuToken(address account, uint256 amount) internal virtual {
...
contract LastInuToken is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("LastInuToken", "LAST") {
        LastInuToken(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}