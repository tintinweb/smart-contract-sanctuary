...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x31DE61D9a39CB9f479570Bd3dC3AC93BC0402CDB);
...
contract nftpunk2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "NFTPunk.Finance v2.0";
    string constant _symbol = "NFTPUNK2.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x40866855B73a83d0EF89E7B52B5aEeC0119B984D;
        devFeeReceiver = 0x9db27AfE170214cD55151349bD91Be6396a926d7;
