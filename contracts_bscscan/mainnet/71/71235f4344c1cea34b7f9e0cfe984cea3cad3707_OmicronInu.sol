...
// TELEGRAM: https://t.me/Omicron_Inu_BSC
// TWITTER: https://twitter.com/OmicronInuBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb29858943e26aB2079Fd40B15EDC55e02881e8f6;
...
contract OmicronInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCa5bd3916C05Bea12a3b66C4AF7F70E0cbF5F437;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OmicronInu";
    string private _symbol = "OMI";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 10; //Gets redistributed to holders
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 90; //Marketing & Developers Fee
