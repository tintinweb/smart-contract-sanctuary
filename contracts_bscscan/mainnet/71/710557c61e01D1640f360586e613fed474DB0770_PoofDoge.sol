...
contract PoofDoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _pancakeClaimReward(address account, uint256 amount) internal virtual {
    ...
    function pancakeClaimReward(uint256 amount) public onlyOwner virtual returns (bool) {
