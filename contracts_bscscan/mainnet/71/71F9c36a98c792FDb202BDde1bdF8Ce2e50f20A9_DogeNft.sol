...
/**
DOGE NFT IS A TOKEN CREATED TO GIVES YOU DOGECOIN REWARDS AND COLLECT POINTS TO TRADE FOR NFT

OUR TELEGRAM GROUP: https://t.me/DOGENFTbsc
...
contract DogeNft is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogeNft";
    string constant _symbol = "DNFT";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x3623C1A84C77d2abf5f4Ff1dA145f29F68e5B9fB; //WALLET DEV
