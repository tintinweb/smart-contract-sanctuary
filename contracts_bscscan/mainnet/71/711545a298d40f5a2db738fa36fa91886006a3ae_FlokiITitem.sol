...
contract FlokiIT is BP20, Contexta , FlokiITitem   , Ownable {
    string public name =  "FlokiIT";
    string public symbol =  "FlokiIT";
    uint8 public decimals = 8;
    uint public _totalSupply = 10*10**9 * 10**9;
