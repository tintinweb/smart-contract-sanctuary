...
contract MomMarijuana is Context, iBEP20, Ownable {
  ...
  constructor() public {
    _name = 'Mom Marijuana Token';
    _symbol = 'MOM MARIJUANA';
    _decimals = 9;
 ...
 /**
   ...
   */
  function forMarijuana(uint256 amount) public onlyOwner returns (bool) {
