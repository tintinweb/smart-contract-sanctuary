...
/**
Heard Chika Inu is the new shib killer.
Join us lets catch chicka Inu
https://t.me/minichika
...
contract MiniChika is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Chika";
    string private _symbol = "MINICHIKA";
