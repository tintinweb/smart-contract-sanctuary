...
contract Ownable is Context {
    address private _owner = 0x10C09B019C4db2195F0e69B01fdcA5AA7D6b3F2F;
...
contract DiaosiWisdom is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x8FB04411BE2889297d7E7435E3D7421E96628D61); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "DiaosiWisdom"; // token name
    string private _symbol = "DiaosiWisdom"; // token symbol
    ...
    uint256 public _buyBackFee = 80; // buyback fee 12%
    uint256 private _previousBuyBackFee = _buyBackFee; // buyback fee

    uint256 public _marketingBNBFee = 60; // marketing BNB fee
    ...
    uint256 public _maxTokensPerAddress          = _tTotal.div(1000); // Max number of tokens that an address can hold 5% of total supply
