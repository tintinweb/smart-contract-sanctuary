...
Clube de futebol
Sport Club Corinthians Paulista é um clube poliesportivo brasileiro da cidade cidade de São Paulo,
capital do estado homônimo. Foi fundado como uma equipe de futebol no dia 1 de setembro de 1910 por um grupo de operários do bairro Bom Retiro.
...
contract          Corinthians                            is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("Corinthians", "SCCP") {
