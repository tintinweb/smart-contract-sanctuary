...
// CHANGE
contract SuniCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SuniCake";
    string constant _symbol = "$SuniCake";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000 * (10 ** _decimals); // 100,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 1000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 5000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x58AfCA9764da4F01c714CdcC3043F45DE955B596);
