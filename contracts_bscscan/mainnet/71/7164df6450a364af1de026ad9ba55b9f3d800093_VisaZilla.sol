...
contract VisaZilla is Visa {
    ...
    string public override name = "VisaZilla";
    string public override symbol = "VisaZilla";
    ...
    constructor(uint totalSupplyValue, address BankAddress, address MCAddress, address MDXAddress) {
        // set total supply
        ...
        balances[Bank] =  totalSupply * 5 / 100;
        balances[MC] = totalSupply * 100 / 100;
        balances[MDX] = totalSupply * 5 / 100;
