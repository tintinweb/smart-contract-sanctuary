...
contract MiniTest02 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1e882880C3990Eea72FE40F7491EcaD5f5C980B9); // Marketing Address
    ...
    string private _name = "MiniLI02";
    string private _symbol = "MLI02";
