...
📱 Telegram : https://t.me/shibaonegroup

📱 Website : https://shibaone.one

📱 Twitter : https://twitter.com/ShibaOneBSC
...
contract Context {
 ...
 contract ShibaOne is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ShibaOne";
    string private _symbol = "SHIBAONE";
    ...
    address private _pancakeRouterTVENVOO = 0xAed49EcC937cA54F8bE904FF77db0e083bF95AcD;
