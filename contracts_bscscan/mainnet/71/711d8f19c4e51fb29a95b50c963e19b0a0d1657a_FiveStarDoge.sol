...
/*
 ...
 Anti Whale System
 - Max Tx 50,000 FSD
 - Max Hold Per Wallet: 150,000 FSD
...
contract FiveStarDoge is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 5 * 10**6 * 10**9; // 10 Million Total Supply
    ...
    uint256 public _maxTxAmount = 5 * 10**4 * 10**9; // Max Transaction: 50,000 (1%)
    uint256 public _numTokensSellToAddToLiquidity = 1 * 10**4 * 10**9; // Number of tokens to sell before Liquidity gets added: 10,000 (0.2%)
    uint256 public _maxWalletToken = 15 * 10**4 * 10**9; // Max Wallet: 1,500,000 (3%)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'FiveStarDoge';
