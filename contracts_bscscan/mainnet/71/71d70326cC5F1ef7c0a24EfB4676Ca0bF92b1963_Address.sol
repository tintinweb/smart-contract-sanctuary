...
contract babydog is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x45a1ffD533ed357618668188edE20A15A3f07B88); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x55A2427a291D27253dEa959AB3e2e7830aADEc95); // Liquidity Address
    ...
    string private constant _name = "Baby dog";
    string private constant _symbol = "babydog";
    ...
    constructor() {
        address newOwner = address(0x55A2427a291D27253dEa959AB3e2e7830aADEc95);
