...
contract FuckKrakenRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x062AABAcC386cAb3B1747806b448ddF55cCA476e); // Marketing Address
    ...
    string private _name = "FuckKrakenRise";
    string private _symbol = "FKRISE";
