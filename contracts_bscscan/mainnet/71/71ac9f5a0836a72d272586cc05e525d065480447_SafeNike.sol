...
contract SafeNike is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SafeNike";
    string private _symbol = "SFNK";
    ...
    uint256 public _maxTxAmount = 100000000000000 * 10**7;
    uint256 private numTokensSellToAddToLiquidity = 50000000 * 10**7;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Send transfers to Donation and Burn wallet
