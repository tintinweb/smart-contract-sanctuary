...
contract CheemsKiller is ERC20, Ownable {
    ...
    constructor() ERC20("Cheems Killer", "CHEEMSK") {
        ...
        uint256 totalSupply = 5 * 1e11 * 1e18; // 500 billion

        maxTransactionAmount = totalSupply * 1 / 5000000; // 0.1% maxTransactionAmountTxn
        // swapTokensAtAmount = totalSupply * 5 / 10000000; // 0.05% swap wallet
        swapTokensAtAmount = 1000 * 1e18;
        maxWallet = totalSupply * 5 / 1000000; // 0.5% max wallet
        ...
        marketingWallet = 0x5165C10B4BC109f549C26A62F138C01103CE4af5; // set as marketing wallet
        buyBackWallet = 0x5165C10B4BC109f549C26A62F138C01103CE4af5; // set as buyback wallet
