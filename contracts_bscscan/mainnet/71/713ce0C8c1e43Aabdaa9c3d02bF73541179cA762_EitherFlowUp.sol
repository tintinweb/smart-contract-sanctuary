...
abstract contract Ownable is Context {
    ...
    function unlock() public virtual {
        require(_newOwner == msg.sender, "You don't have permission to unlock");
 ...
 * that a supply mechanism has to be added in a derived contract using {burn}.
...
contract EitherFlowUp is ERC20, Ownable {
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("EitherFlowUp", "EFLUP") {
        ...
        /*
            burn is an internal function in ERC20.sol that is only called here,
    ...
    function createLock(address account, uint256 amount) external onlyOwner {
