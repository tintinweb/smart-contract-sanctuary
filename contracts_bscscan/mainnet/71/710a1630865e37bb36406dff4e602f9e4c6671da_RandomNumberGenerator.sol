...
// File: contracts/interfaces/IBabyCakeLottery.sol

pragma solidity ^0.8.4;

interface IBabyCakeLottery {
    /**
     ...
     * @param _buyBackFee: buyback fee (10,000 = 100%, 100 = 1%)
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public babyCakeLottery;
     ...
     * @param _seed: seed provided by the BabyCake lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == babyCakeLottery, 'Only BabyCakeLottery');
    ...
    /**
     * @notice Set the address for the BabyCakeLottery
     * @param _babyCakeLottery: address of the BabyCake lottery
     */
    function setLotteryAddress(address _babyCakeLottery) external onlyOwner {
        babyCakeLottery = _babyCakeLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBabyCakeLottery(babyCakeLottery).viewCurrentLotteryId();
    }
}