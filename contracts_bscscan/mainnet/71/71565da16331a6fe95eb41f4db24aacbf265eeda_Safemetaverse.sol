...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD204813EA144d0F1F12c01B85C4Ca1AD57d28eD0;
...
contract Safemetaverse is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb2bA9780c452141d28377f9a07D01E3885C4f86c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Safemetaverse";
    string private _symbol = "SMV";
