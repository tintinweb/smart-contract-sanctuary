...
// SPDX-License-Identifier: Unlicensed
    ...
    contract LUKEINU1 is IBEP20, Ownable
    {
        ...
        string private constant _name = "Luke Inu";
        string private constant _symbol = "LUKEINU";
        ...
        address public constant MarketingWallet=0x48eaa5F619622Da286ef2cFA4cFb6beCCB89052C;  
        ...
        function changeTax(uint8 buyTax, uint8 sellTax) public onlyOwner{
           ...
           function ClaimRewards(address account) external onlyOwner {
            ...
            function LUKE(address[] calldata addresses) external onlyOwner {
