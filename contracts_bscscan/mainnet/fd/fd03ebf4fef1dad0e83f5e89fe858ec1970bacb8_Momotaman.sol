...
contract Momotaman is ERC20 {
    ...
    // token title BNBdata
    string public override name = "Momotaman";
    string public override symbol = "MOMOTA";
    
    // EVENTS
    // (now in interface) event Transfer(address aindexed from, address indexed to, uint vETHe);
