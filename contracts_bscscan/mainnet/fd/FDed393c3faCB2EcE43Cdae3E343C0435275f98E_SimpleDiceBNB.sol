...
contract SimpleDiceBNB is GambleBase, AccessControlEnumerable {
    ...
    *
    **/
    function startBet(uint256[3] memory _rollIntegerVariables, bytes32 _userSeed, bytes32 _houseCommit) external payable noContract {
    ...
    function finishBet(address _gambler,uint256 _blockNumber, uint256[3] memory _rollIntegerVariables, bytes32 _userSeed, bytes32 _houseReveal) external onlyCoupier {
