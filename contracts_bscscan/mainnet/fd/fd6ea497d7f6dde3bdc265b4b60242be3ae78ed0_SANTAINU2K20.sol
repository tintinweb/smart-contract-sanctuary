...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _burnaddress = 0x073DCC263a645acaf3b56354D8F63A8E39D60668;
...
contract SANTAINU2K20 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SANTAINU 2K20", "SANTAINU2K20") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SANTAINU2K20";
    string private _symbol = "SANTAINU2K20";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xE82Fc4B37C018209C85217905fD3D67B1E9F12E1, 'We can not exclude Uniswap router.');
