...
contract BabyCaptainBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Captain BNB";
    string constant _symbol = "BABYCAPTBNB";
    uint8 constant _decimals = 9;

    uint256 public _totalSupply = 2000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 200; //1% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 2) / 100; //10% of total supply
    ...
    uint256 public swapThreshold = _totalSupply / 500000; // 0.05% of supply
    bool inSwap;
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount, uint256 _timeBetweenDividendSwap) external authorized {
        swapDividendEnabled = _enabled;
        swapThreshold = _amount;
        timeBetweenDividendSwap = _timeBetweenDividendSwap;
    }
