...
contract _WebFinanceCoin is ERC20, ERC20Detailed, ERC20Burnable {
    constructor() ERC20Detailed('PerfectMoneyBag(MONEY)', 'PMB', 18)  {
        _mint(msg.sender, 130000000 * 10 ** 18);
    }
...
contract WebFinanceCoin is Ownable,_WebFinanceCoin{
