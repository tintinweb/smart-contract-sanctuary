...
contract babycattle is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xe6A23F7D540c7d453df42391c6025A1d96ACFd1c); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0xe6A23F7D540c7d453df42391c6025A1d96ACFd1c); // Liquidity Address
    ...
    uint256 private constant _tTotal = 9000000000000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Baby Cattle";
    string private constant _symbol = "babycattle";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 5 / 100000000000000; // 0.05%
    ...
    constructor() {
        address newOwner = address(0xe6A23F7D540c7d453df42391c6025A1d96ACFd1c);
