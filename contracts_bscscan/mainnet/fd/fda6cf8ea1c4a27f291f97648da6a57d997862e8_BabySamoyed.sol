...
https://t.me/babysamoyedtoken

Liquidity fee : 3%
Buyback : 3%
Marketing : 6% 
Lottery : 1% Random Giveaway every 1 hours holder who not sell the token

Max wallet 2% Will Increase as we hit a higher MC
Max tx 1% 

Lottery BNB To holders, If holders don't sell the any tokens 
...
contract BabySamoyed is ERC20, Ownable {
    ...
    address payable private buybackWallet = payable(address(0xAB75b9Cd4f1414A929178Dd6291887313ef81A3f));
    address payable public marketingFeeWallet = payable(0x68203b4e14d11BbEbB79A4Feda96503856379527);
    
    //Lottery
    address payable [] public participants;
    address public lastWinner;
    uint256 public currentLotteryRound;
    uint256 public roundResetEvery = 3600;
    uint256 public lotteryMinParticipant = 3;
    uint256 public lotteryPrizePool;
    uint256 public minTokenBuyForTicket = 100000000 * (10**18);
    uint256 public nextRound = block.timestamp + roundResetEvery;
    

    constructor() public ERC20("Baby Samoyed", "BabySamo") {
