...
/**
Present By PythagorasDev
OUR TELEGRAM : https://t.me/LuckyTigerInu
*/
...
contract LuckyTigerInuTEST is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x15b87337093B2686b74533D60401B349580F26dB); // Marketing Address
    ...
    string private _name = "Lucky Tiger Inu TEST";
    ...
    uint256 public _maxTxSellAmount = 20000000 * 10**6 * 10**9;
    uint256 public _maxTxBuyAmount = 20000000 * 10**6 * 10**9;
