...
// SPDX-License-Identifier: Unlicensed
    ...
    contract BABYKISHU is IBEP20, Ownable
    {
        ...
        string private constant _name = "Baby Kishu";
        string private constant _symbol = "BKISHU";
        uint8 private constant _decimals = 9;
        uint256 public constant InitialSupply= 100_000_000_000 * 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 0;
        
        address public constant TeamWallet=0x1b132d58232A47280832fD43bF9056DA1Af12954; //TEAMWALLET
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _circulatingSupply =InitialSupply;
        uint256 public  balanceLimit = 30_000_000_000 * 10**_decimals;
        uint256 public  sellLimit = 5_000_000_000 * 10**_decimals;
        uint256 public  buyLimit = 30_000_000_000 * 10**_decimals;
        ...
        constructor () {
            ...
            _burnTax=0;       // 
            _liquidityTax=12;  //liquidity+stake
            _stakingTax=1;    //
            _marketingTax=10;
        ...
        function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
            ...
            uint8 tax1 = _stakingTax + _liquidityTax;
            uint256 contractToken=_calculateFee(amount, tax, tax1);
    ...
    function SetReward() public onlyOwner{
