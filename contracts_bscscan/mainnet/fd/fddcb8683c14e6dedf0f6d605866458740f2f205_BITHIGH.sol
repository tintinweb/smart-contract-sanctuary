...
$APR (ApolloRebase) is an elastic supply token designed to increase in price every 8 hours using rebase protocol.
...
contract BITHIGH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BITHIGH";
    string constant _symbol = "BITHIGH";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x19646DBC05bA6F7D3c950EAf4Fc7A615240582b7;
        devFeeReceiver = 0xcBce3EB5273691A79D2f9b9f531359D75fDffFd9;
