...
//         ______       _____    ____      _____        ______        _____     _____                ______         _____    ____  _____   ______    ____   ____ 
...
//|    \    \___|/ |    ||    |||    ||    | |    ||     /___/|  |    |\    \ |     // \  \   \ |     /___/|  |    |\    \  |    |   |      \ |    ||    | |    |
//|    |\     \    |    ||____|/|    ||    | |    ||     \____|\ |    | |    ||    |/   \ |    ||     \____|\ |    | |    | |    |   |    |\ \|    ||    | |    |
//|\ ___\|_____|   |____|       |____||____|/____/||____ '     /||____| |____||\ ___/\   \|   /||____ '     /||____|/____/| |____|   |____||\_____/||\___\_|____|
//| |    |     |   |    |       |    ||    /    | ||    /_____/ ||    | |    || |   | \______/ ||    /_____/ ||    /     || |    |   |    |/ \|   ||| |    |    |
// \|____|_____|   |____|       |____||____|____|/ |____|     | /|____| |____| \|___|/\ |    | ||____|     | /|____|_____|/ |____|   |____|   |___|/ \|____|____|
//    \(    )/       \(           \(    \(    )/     \( |_____|/   \(     )/      \(   \|____|/   \( |_____|/   \(    )/      \(       \(       )/      \(   )/  
//     '    '         '            '     '    '       '    )/       '     '        '      )/       '    )/       '    '        '        '       '        '   '   
//                                                         '                              '             '                                                        
// SpiderWebInu (WEB)
// 1B Supply
// https://t.me/spiderrinu
...
//Contract
contract SpiderWebInu is IBEP20, Ownable {
    ...
    string private constant _name = 'SpiderWebInu';  
    ...
    uint8 private constant MaxWalletDivider=33; //3% = 30,303,030
    uint16 private constant SellLimitDivider=80; //1.25% = 12,500,000
    uint8 public constant MaxTax=20;        //This is the max tax that can be set by a user - prevents honeypot
    //tax distribution
    uint8 private _devTax=40;
    ...
    address public MiscReward=0x2480334963D06Dc39dd148f504a13ef3E6D8d896;   //Only MiscReward can be changed to BNB
