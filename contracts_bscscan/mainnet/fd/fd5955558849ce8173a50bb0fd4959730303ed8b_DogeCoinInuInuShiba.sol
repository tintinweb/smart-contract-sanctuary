...
/**
    ...
    */
    ...
    contract DividendDistributor is IDividendDistributor {
        ...
        IBEP20 BMATIC = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
        ...
        function deposit() external payable override onlyToken {
            uint256 balanceBefore = BMATIC.balanceOf(address(this));

            address[] memory path = new address[](2);
            path[0] = WBNB;
            path[1] = address(BMATIC);
            ...
            uint256 amount = BMATIC.balanceOf(address(this)).sub(balanceBefore);
        ...
        function distributeDividend(address shareholder) internal {
            ...
            if(amount > 0){
                ...
                BMATIC.transfer(shareholder, amount);
    ...
    contract DogeCoinInuInuShiba is IBEP20, Auth {
        using SafeMath for uint256;

        address BMATIC = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
        address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        address DEAD = 0x000000000000000000000000000000000000dEaD;
        address ZERO = 0x0000000000000000000000000000000000000000;

        string constant _name = "Doge Coin Inu Inu Shiba";
        string constant _symbol = "DogeCoinInuInuShiba";
