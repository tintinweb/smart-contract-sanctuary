...
🥞 Let's make the Biggest Cake in the world together! 🥞
t.me/babycakeback_Official
...
Max buy limit: 0.6 BNB at launch and Total 5% token
Max sell limit: 0.5% Total Token/ 1 transaction
...
contract Babycakeback is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 5;    // Cake Rewards
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 3;   // Liquidity Fee
