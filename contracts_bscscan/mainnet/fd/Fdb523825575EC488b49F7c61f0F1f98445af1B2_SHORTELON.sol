...
contract SHORTELON is Context, IBEP20, Ownable { // change contract name
    ...
    address payable public _marketingAddress = payable(0x5f7E7E90CbF55cE66bCd2AB44787d324cD624B43); // Marketing Address
    ...
    string private _name = "SHORTELON"; // token name
    string private _symbol = "SHORTELON"; // token symbol
