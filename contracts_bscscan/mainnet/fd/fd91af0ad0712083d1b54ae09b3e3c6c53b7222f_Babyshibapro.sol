...
contract Babyshibapro is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "Baby Shiba Pro";
  string private _name = "Baby Shiba Pro";
