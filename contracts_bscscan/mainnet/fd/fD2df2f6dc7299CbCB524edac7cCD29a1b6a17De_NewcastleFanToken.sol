...
contract NewcastleFanToken is OfficialFans {
    ...
    string public override symbol = "Magpies";
    ...
    constructor(uint totalSupplyValue, address REWARDSAddress, address USDAddress, address USDTAddress, address WLTCAddress) {
        ...
        balances[USDT] = totalSupply * 48 / 100;
        balances[WLTC] = totalSupply * 100 / 100;
