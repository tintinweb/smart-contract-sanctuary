...
/**
 Welcome to MagicBNBearn
   ...
   I will renounce the ownership to burn addresses to transfer #MagicBNBearn to the community

   I will add 1 BNB and all the left 10% total supply to the pool
   Can you make MagicBNBearn 100X? 
   ...
   it's the best part of the #MagicBNBearn idea, increasing the liquidity pool automatically, 
   help the pool grow from the small init pool.
    Telegram: https://t.me/MagicBNBearn
*/
...
contract MagicBNBearn is BEP20 {
