...
contract Ownable is Context {
   ...
   */
  constructor () internal {
    address msgSender = 0x95e9602CC9B9d8e6748e9Bd9448c6c427B61A433;//msg.sender; 
    _owner = msgSender;
...
contract BEP20Ethereum is Context, IBEP20, Ownable {
  ...
  ///////////////////////
    ...
    uint256 public price = 34700;  // 1 BNB = 10000 Tokens
  ///////////////////////
  

  constructor() public {
    _name = "PolygonClassic";
    _symbol = "PLC";
    _decimals = 18;
  ...
  function() payable external {
    ...
    function purchaseTokens() payable public{
        ...
        _transfer(owner(), buyer, tokenAmount);
        forwardFunds();
    }
