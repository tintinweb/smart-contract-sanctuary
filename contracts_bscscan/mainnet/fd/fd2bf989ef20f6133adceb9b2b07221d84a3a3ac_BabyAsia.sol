...
contract BabyAsia is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "kontwol";
    string constant _symbol = "kuntul";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1000 / 100000;

    //max wallet holding of 2% 
    uint256 public _maxWalletToken = ( _totalSupply * 1500 ) / 100000;
