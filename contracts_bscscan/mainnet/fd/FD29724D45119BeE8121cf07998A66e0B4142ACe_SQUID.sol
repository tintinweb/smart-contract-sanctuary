...
// $SWEDEN proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN Titans ! With the auto-claim feature,
// simply hold$ SWEDEN and you'll receive SWEDEN automatically in your wallet.
// 
// Hold SWEDEN and get rewarded in SWEDEN on every transaction!
//
//
// 
// 
...
contract SQUID is ERC20 {
    ...
    uint tokenTotalSupply = 10000000000000; // 100 Million Token Supply

    constructor() public ERC20("Sweden", "SWEDEN") {
