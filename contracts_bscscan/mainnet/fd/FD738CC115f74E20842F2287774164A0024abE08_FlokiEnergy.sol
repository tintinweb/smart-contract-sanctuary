...
contract FlokiEnergy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki Energy";
    ...
    address public autoLiquidityReceiver = 0xCdf9c81c65A8a3D5C683540A8AE0619882a54Ac9;
    address public marketingFeeReceiver = 0xCdf9c81c65A8a3D5C683540A8AE0619882a54Ac9;
 
    uint256 targetLiquidity = 20;
    uint256 targetLiquidityDenominator = 100;
 
    IDEXRouter public router;
    address public pair = 0xEd5D6BE11a9D50a763460E013D28Dc9C92885905;
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(0x3362D9061ddc6Ce69efEE020eB5D9C0F23a2Db02).transfer(amountBNB * amountPercentage / 100);
    }
