...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 JADE = IBEP20(0x330F4fe5ef44B4d0742fE8BED8ca5E29359870DF);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = JADE.balanceOf(address(this));
        ...
        uint256 amount = JADE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            JADE.transfer(shareholder, amount);
...
contract BabyJade is IBEP20, Auth {
    using SafeMath for uint256;

    address JADE = 0x330F4fe5ef44B4d0742fE8BED8ca5E29359870DF;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BabyJade";
    string constant _symbol = "BADE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x02045B85459d78Ce3657661A058b1a5477E2D177;
