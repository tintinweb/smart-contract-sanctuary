...
contract HappyApesFamily is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf9BFF7635AAc135f7657aA1e648cfCe621945ea5); // Marketing Address
    ...
    uint256 private _tTotal = 100000 * 10**8 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Happy Apes Family";
    string private _symbol = "HAF";
    ...
    uint256 private minimumTokensBeforeSwap = 5 * 10**8 * 10**18; 
    uint256 public buyBackSellLimit = 5 * 10**8 * 10**18;
