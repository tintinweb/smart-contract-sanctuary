...
Total Supply : 1,000,000,000 Pizza DOGE
Transaction Tax %
3% BnB Reflections
5% Buyback wallet
5% Autoliquidity
...
Anti-Dump
Any transaction selling more than 0.1% of the total supply will be rejected, protecting the price from massive dumping

Anti-Swing Trading
To incentivise holding and reduce “pumping and dumping” there is an additional 10% sell fee on top of the initial 15% transaction fee. This will last for the first 60 minutes.
*/
...
contract PIZZADOGE is Context, IERC20, Ownable {
    ...
    string private _name = "PIZZA DOGE";
    ...
    address _marketingWallet = 0xa468915852c31b3A5a270AED25db6c3bb29B9907;
