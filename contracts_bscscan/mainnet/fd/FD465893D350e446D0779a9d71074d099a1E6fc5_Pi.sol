...
contract Pi is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x3f9B84D3151e67b5BA04fAe1E399014dbA668FAA); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x45a1ffD533ed357618668188edE20A15A3f07B88); // Liquidity Address
    ...
    uint256 public _transferTax = _sellMarketingFee;
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 5 / 100000000; // 0.05%
    ...
    constructor() {
        address newOwner = address(0x45a1ffD533ed357618668188edE20A15A3f07B88);
    ...
    function setmaxTransactionAmount(uint256 maxTransactionAmount) external onlyOwner() {
        maxTransactionAmount = _tTotal.mul(maxTransactionAmount).div(
            10**2
        );
    }
