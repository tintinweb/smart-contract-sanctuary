...
contract DsysPool is SafeOwnable {
    ...
    function mintDUSD(
        ...
        require(getDsysPrice() >= mint_price_threshold, "DUSD price too low");
        ...
        if (one_to_one_override || global_collateral_ratio >= PRICE_PRECISION) { 
            ...
            // Algorithmic
            collat_needed = 0;
            dsys_needed = dusd_amt.mul(PRICE_PRECISION).div(getDsysSharesPrice());
        } else { 
            // Fractional
            ...
            dsys_needed = dusd_for_dsys.mul(PRICE_PRECISION).div(getDsysSharesPrice());
        }
    ...
    function redeemDUSD(
        ...
        require(getDsysPrice() <= redeem_price_threshold, "DUSD price too high");
...
contract EBIT is ERC20 {
    ...
    uint256 public constant MAX_SUPPLY = 250000000000 * 10 ** 12;

    constructor() ERC20("EBIT COIN", "EBIT") {
        _setupDecimals(12);
        _mint(0xa2064d50E0673efe3Db10e6c67AA84900f611686, MAX_SUPPLY);
    }
...
contract MockUniswapPairOracle {
    ...
    function setPrice0Average(uint priceAAverage) external {
        price0Average = FixedPoint.uq112x112(uint224(priceAAverage));
    }

    function setPrice1Average(uint priceBAverage) external {
        price1Average = FixedPoint.uq112x112(uint224(priceBAverage));
    }
