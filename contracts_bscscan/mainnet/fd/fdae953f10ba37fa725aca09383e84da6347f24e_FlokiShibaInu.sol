...
contract FlokiShibaInu is IERC20 {
    ...
    string constant _name = "Floki Shiba Inu";
    string constant _symbol = "FLOKISHIBAINU";
    ...
    address payable private _marketingWallet = payable(0x1f871dB2C06B88Df5127f4430088193be0EAf623);

    // Max Buy TX amount is 1% of the total supply.
    uint256 private buyMaxTxPercent = 10; // Less fields to edit
    uint256 private buyMaxTxDivisor = 1000;
    ...
    // Max Sell TX amount is 0.5% of the total supply.
    uint256 private sellMaxTxPercent = 5; // Less fields to edit
...
function setTaxesBuy(uint256 liquidityFee, uint256 reflectionFee, uint256 marketingFee) external onlyOwner {
        ...
        require(liquidityFee + reflectionFee + marketingFee <= 50000);
