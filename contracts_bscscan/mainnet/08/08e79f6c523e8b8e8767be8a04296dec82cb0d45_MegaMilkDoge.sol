...
🩱Welcome to BigBoobs Fetish Fans club 🩱
MegaMilkDoge STEALTH LAUNCHING ‼️

👙LP locked 1year
🩱Ownership Renounce
👙10% Reflections Cardano token

🩱TELEGRAM : https://t.me/MegaMilkDoge
...
contract MegaMilkDoge is Context, IBEP20, Ownable {
  using SafeMath for uint256;

  uint256 public _rewardPercent = 2;
  uint256 private _maxTrxLimit = 10 * 10**9 * 10**12;
  address private _deployer;
  bool reward_status = false;


  constructor() public {
    _totalSupply = 1000 * 10**9 * 10**12;
