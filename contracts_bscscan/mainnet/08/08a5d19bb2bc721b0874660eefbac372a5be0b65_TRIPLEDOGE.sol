...
/*                       
        🐶🐶🐶             WELCOME TO TRIPLEDOGE BSC           🐶🐶🐶


        Projects : TRIPLE DOGE    
        Symbol : TDOGE
        ...
        REWARD 6 % (BABY DOGE + SHIBA + AKITA)
        LIQUIDITY 3%
        MARKETING 5%
        
        TOTAL TAX 14%

        JOIN TELEGRAM HERE : https://t.me/tripledogebsc 
...
contract DividendDistributor {
    ...
    IERC20 BABYDOGE = IERC20(0xc748673057861a797275CD8A068AbB95A902e8de); // Baby Doge Reward
    IERC20 Akita = IERC20(0xFfb6a98c33937F0239fE20C9a38985Ac14f55b7F); //Akita Reward
    IERC20 Shiba = IERC20(0xB4a81261b16b92af0B9F7C4a83f1E885132D81e4); //Shiba Reward
...
contract TRIPLEDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TRIPLE DOGE";
    string private _symbol = "TDOGE";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * 10**9;
    
    address payable public marketingWalletAddress = payable(0x9a81D7ed25E98154fEB12d30726eFb4509E72dfE); 
    address payable public rewardsWalletAddress = payable(0x1230b31B11Fc0834f01BcFC1688e04CA02Fc1Aaa); 
