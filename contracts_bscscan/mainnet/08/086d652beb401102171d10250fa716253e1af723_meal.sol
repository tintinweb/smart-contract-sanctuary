...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xc59E6C9e44EfD2dFaBb567ba59e4722123d6e079;
...
contract meal is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x16081815a34183823DA45c7987F058093F9752aC;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 89000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "meal";
    string private _symbol = "meal";
