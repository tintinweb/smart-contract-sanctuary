...
contract FLOKICORN is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FLOKICORN";
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 3 >= block.number){ return feeDenominator.sub(3); }
