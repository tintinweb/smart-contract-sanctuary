...
/**
   ...
   TELEGRAM: https://t.me/MrBinanceBSC
   9% IN REWARDCOIN REWARDS!
   3% AUTO LOCK IN LP!
   3% MARKETING WALLET!
*/
...
contract MrBinance is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "MrBinance";
    string constant _symbol = "$MRBINANCE";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xc9f508e7c16C3299f34595be1Ac1F3b7b06f1688);
