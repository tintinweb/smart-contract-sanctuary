...
/*
😈GRINCH TOKEN😈
A Degen Play By @DetectiveBSCApeLounge

T'is the season to be greedy! The Apes at @DetectiveBSCApeLounge is going to steal Christmas this year! Come join us with the most STACKED tokenomics ever seen in BSC. 

Starting Liquidity : 10 BNB
...
Tokenomics
    💵 1.0% Max Buy Tx ( 1,000,000 $GRINCH)
    💵 0.25% Max Sell Tx ( 200,000 $GRINCH)
    💰 5% Max Bag ( 5,000,000,000 $GRINCH )
...
/* Token contract */
contract GRINCH is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "GRINCH";
    string constant _symbol = "GRINCH";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 1000 / 10000; // 1.0% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 25 / 10000; // 0.25% or 250k tokens
