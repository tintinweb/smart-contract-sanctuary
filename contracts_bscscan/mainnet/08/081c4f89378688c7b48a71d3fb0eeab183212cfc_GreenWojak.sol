...
contract GreenWojak is ERC20, Ownable {
    ...
    constructor() ERC20("Green Wojak", "GRWJ") {

        marketingWallet = 0x531273487c3e44d781aFcc5Bb129B8985bc039ea;
        rewardsWallet = 0xf4DBCF52980640A26447bF659052e10fa9FfF816;
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0x531273487c3e44d781aFcc5Bb129B8985bc039ea); // dev fee lasts for one day only
