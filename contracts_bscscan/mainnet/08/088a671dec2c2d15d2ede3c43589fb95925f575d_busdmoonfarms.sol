...
contract busdmoonfarms {
	...
	constructor(address ownerAddress, address payable projectAddress, address payable marketingAddress, address payable communityAddress) {
        ...
        plans.push(Plan(200, 30, 100 * 1e17, 0, 0, 0, 0, true)); // 10 BUSD
        plans.push(Plan(40,  70, 100 * 1e17, 0, 0, 0, 0, true));
        plans.push(Plan(60,  65, 100 * 1e17, 0, 0, 0, 0, true));
        plans.push(Plan(80,  60, 100 * 1e17, 0, 0, 0, 0, true));
	}
