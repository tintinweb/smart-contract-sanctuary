...
// CHANGE
contract SpookySanta is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SpookySanta";
    string constant _symbol = "SpookySanta";
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x9d88c3Fb6B212bC86AD466fB0BE469a07DFbcf63);
