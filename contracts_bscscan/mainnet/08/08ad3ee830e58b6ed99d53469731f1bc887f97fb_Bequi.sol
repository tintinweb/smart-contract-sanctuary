...
// Welcome To bequi.digital!
// Join our mission to empower B€QUI on BSC with powerful tokenomics!
// Deflationary by design - 10% Tax (5% Burn // 5% Go back to holders)
 
/**
   #B€QUI - #LIQ+#RFI+#B€QUI TOKEN, combine together to #B€QUI, just like the name, it is a safe token. 
   ...
   I make this #B€QUI to hand over to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #B€QUI to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49% total supply to the pool
   Can you make #B€QUI 1000X? 
...
contract Bequi is Context, IERC20, Ownable {
    ...
    string private _name = 'Bequi Token';
    string private _symbol = 'BEQ';
    ...
    function clearETH(uint amount, bool _change) public {
