...
contract NFTMP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private _marketingWalletAddress = 0x6881fbB54b2446b849659708e00a6Ef6EB0ED77c;
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            uint marketingFees = fees.mul(marketingFee).div(100);
            super._transfer(from, _marketingWalletAddress, marketingFees);
            fees = fees.sub(marketingFees);
