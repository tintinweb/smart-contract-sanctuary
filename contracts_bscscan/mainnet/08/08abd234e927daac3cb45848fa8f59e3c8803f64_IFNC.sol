...
contract IFNC is Operator {
    ...
    string private _name = "IFNC";//#币名
    string private _symbol = "IFNC";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0xb1D70f3a8f0BBDe96a6C8Ec1E4141eEb7f5710d1),true);
    }
