...
The one and only buyback+rebase token Elon approves of.

10 % Buytax
20 % SellTax

100 % of tax revenues to buybacks until community decides otherwise! We can do Shiba rewards... 

TG: https://t.me/ShibaBuyback
...
contract ShibaBuyBack is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaBuyBack";
    string constant _symbol = "$SBB";
