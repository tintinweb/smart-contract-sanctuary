...
contract Mamba is ERC20, Ownable {
    ...
    constructor() ERC20("MAMBA Trial 1", "MMBT1") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        contractWallet = 0xaABa2D2a2078ec9cd47a530a6a1E824390727Df8;
        marketingWallet = 0xD9ca15459AA46D8d19Cd4854679E4A783C930675;
        ...
        */
        _mint(contractWallet, 1000 * (10**6) * (10**18));
    }
