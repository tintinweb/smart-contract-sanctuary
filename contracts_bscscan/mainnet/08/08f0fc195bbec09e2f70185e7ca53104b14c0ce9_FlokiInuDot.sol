...
/**
 *
 BULLISH REASONS TO HODL $FLOKIINUDOT
- Passive income just for HODLING, earn $DOT for every buy and sell that happens 24/7 
- $DOT Rewards distributed every 60 minutes OR send (1) $FLOKIINUDOT to your own address to trigger the rewards early
- DEV DOXXED

https://t.me/flokiinudot
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
...
contract FlokiInuDot   is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FLOKIINUDOT";
    string constant _symbol = "INUDOT";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402;

    uint256 _totalSupply = 10 * 10**4 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xf11ABDA6A826368Aa80c8C9Fb33bfe035e384C35;
