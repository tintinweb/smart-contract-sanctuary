...
MiniBullADA Token
Rewards BullADA for Holding - 10%
 3% Marketing | 2% LP
 
 TG: https://t.me/MiniBullADA
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1B755B65e99AEC0Ff46afA396cf1f610e531449b);
...
contract MiniBullADA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Mini Bull ADA";
    string constant _symbol = "MiniBullADA";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x1B755B65e99AEC0Ff46afA396cf1f610e531449b;
