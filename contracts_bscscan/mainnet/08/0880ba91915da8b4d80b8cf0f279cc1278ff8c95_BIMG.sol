...
/**
 * 
We are excited to Announce you the launch of the first Play To Earn Multi-player FPS on Binance Smart Chain !

AAA Graphic.
Graphic menu settings.

3 Game modes: Team Deathmatch, Free For All, and Capture of Flag, and 4 Upcoming: Demolition, Elimination, Cover Point, and Gun Race.

8 different types of weapons: Rifle, Sniper, Shotgun, Pistol, Grenade, Molotov, Grenade Launcher, and Knife. Advanced weapon system all for mint as NFTs. 
*/
...
contract BIMG is Context, IERC20, Ownable {
