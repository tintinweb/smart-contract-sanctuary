...
Telegaram : https://t.me/cakedough
...
contract CakeDough is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CakeDough", "CakeDough") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x5eE468E77CfFd1674384bA9Fc72C05E7b77dad86;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "CakeDough: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "CakeDough: The new dividend tracker must be owned by the CakeDough token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("CakeDough_Dividend_Tracker", "CakeDough_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "CakeDough_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "CakeDough_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "CakeDough_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "CakeDough_Dividend_Tracker: Cannot update claimWait to same value");
