...
contract PresidentDoge  is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 100000000000000 * 10**9; // Max Transaction: (5%)
    uint256 public _numTokensSellToAddToLiquidity = 100000000000000 * 10**9;
    uint256 public _maxWalletToken = 100000000000000 * 10**9; // Max Transaction: (10%)
