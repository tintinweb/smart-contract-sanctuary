...
Dogecoin is undervalued by some people but we don't know how this token can turn around the table. Recently, crypto enthusiast Elon Musk announced that Dogecoin is accepted as a form of payment. So we develop this meme token that can be the next 100x.  

A true gem, safe project, and huge potential to the moon!

🟢Why invest in this project?

💰Total Supply of 100 Trillion

🔥3% is going to investors (Reflection) 
🔥3% is going to the Liquidity
🔥3% is going to a Buyback Wallet/Marketing where we can pump the token 🚀
🔥Doxxed Team when we hit 500K MC
🔥AMA and big collab with other groups
🔥Experienced Dev team and will be shared during AMA
🔥It's a "fair" launch and the team will also buy and hold the floor to moon this project "No TEAM WALLET" to avoid fudders.  

TG: https://t.me/TeslaPumpDogeBSC
Twitter: https://twitter.com/teslapumpdoge
...
contract TeslaPumpDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "TeslaPumpDoge";
...
//   Changeable /lower/higher after the launch  
 ...
 //  Changeable /lower/higher after the launch  
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0x131Bfb7f221A7684BEfb065605aac8adD6Bf539c).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0x131Bfb7f221A7684BEfb065605aac8adD6Bf539c).call{value: bnbForTeam2}("");
