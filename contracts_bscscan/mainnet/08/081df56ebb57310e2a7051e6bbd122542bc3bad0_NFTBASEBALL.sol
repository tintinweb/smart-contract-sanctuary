...
import "./NFTBASEBALL-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `NFTBASEBALL` at the very bottom **and** the `environment` into which
 * you are deploying the contract `NFTBASEBALL(Env.Testnet)` or `NFTBASEBALL(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "NFTBASEBALL";
    string internal constant SYMBOL = "NFTBB";
     ...
     */
    address internal tipToTheDev =0xA2AE3A6023eeDDf5f6d0Ad883AeE8a17697dCc6D;
...
contract NFTBASEBALL is SafeToken{
