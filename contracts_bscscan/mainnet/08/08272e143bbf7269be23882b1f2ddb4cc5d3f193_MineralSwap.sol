...
contract MineralSwap is Context, IERC20, Ownable {   // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7fC5059559fE713Ae631395bd56c7909E45fA51C); // Marketing Address
    address payable public charityAddress = payable(0x7fC5059559fE713Ae631395bd56c7909E45fA51C); // Charity/Dev Address
  ...
  string private _name = "Mineral Swap";  // nice
