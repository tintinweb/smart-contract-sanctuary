...
contract H2OToken is IERC20 {
    
    using SafeMath for uint256;
    
    //H2O DAO token, creator will take 6% fee
    address public feeTo = 0x1230bE46B7314A1475D92A93b51AB765e609d949;

    string public name = "H2O DAO";
    string public symbol = "H2O";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //H2O DAO token supply max length
    ...
    constructor() {
       mint(msg.sender, 2800000000 * (10 ** decimals));
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 H2O
