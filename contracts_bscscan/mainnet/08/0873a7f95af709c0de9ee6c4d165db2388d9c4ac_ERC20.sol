...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address private _marketingTaxAddress =
        0xfA7c1dE8141f52549A8021EfEaF36e140E73b0eD;
    address private _keyBoxTaxAddress =
        0x124b8f0De1b5512C3c1f9077f9787c9c7b02767A;
    ...
    constructor(
        ...
        _taxSwapThreshold = 5 * 10**5 * 10**decimals();
    ...
    function enableTransferLimit() public onlyOwner {
        ...
        _maxTransferLimit = _totalSupply / 200;
    ...
    function _transfer(
        ...
        if (
            ...
            if( !_excludedTransferLimit[sender] || !_excludedTransferLimit[recipient] )
