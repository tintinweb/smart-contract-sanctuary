...
contract Ownable is Context {
    address private _owner = 0xCF517531fc5fafa3a656c548Aab839A7D8c0Cf6c;
...
contract Tragically is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Tragically"; // token name
    string private _symbol = "Tragically"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 9000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
