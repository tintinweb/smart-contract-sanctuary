...
/**
 AuntTron is a next-gen token that rewards you with TRX airdrops every 60 minutes
 
 Did you miss babyTron?! Don't miss AuntTron! 
 
 Hold SisterTron and earn TRX 
...
contract AuntTron is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AuntTron";
    string constant _symbol = "AuntTron";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x45ed7d114D5C0F580C0987870434bea587FF6014;
