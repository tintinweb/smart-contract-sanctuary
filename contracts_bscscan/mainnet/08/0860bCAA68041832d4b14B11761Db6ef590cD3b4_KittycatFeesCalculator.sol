...
contract KittycatFeesCalculator is Ownable, IFeesCalculator {
    using SafeMath for uint256;

    uint256 public ethMin = 1 ether;
    uint256 public tokenMin = 50000000 ether;      
    uint256 public ethMax = 2 ether;       
    uint256 public tokenMax = 100000000 ether;    
    uint256 public liquidityPercent = 50;   // 0.5%

    uint8 public PAYMENT_MODE_BNB_LP_TOKEN = 0;
    uint8 public PAYMENT_MODE_KYC_LP_TOKEN = 1;
    uint8 public PAYMENT_MODE_BNB_MAX = 2;
    uint8 public PAYMENT_MODE_KYC_MAX = 3;
    ...
    *                       1 - pay fees in minKYC + LP token,
    *                       2 - pay fees fully in maxBNB,
    *                       3 - pay fees fully in maxKYC
    */
    function calculateFees(address /* lpToken */, uint256 amount, uint256 /* unlockTime */,
        ...
        if (paymentMode == PAYMENT_MODE_KYC_LP_TOKEN) {
    ...
    */
    function calculateIncreaseAmountFees(address /* lpToken */, uint256 amount, uint256 /* unlockTime */,
        ...
        if (paymentMode == PAYMENT_MODE_KYC_MAX) {
            return (0, tokenMax, 0);
        }
