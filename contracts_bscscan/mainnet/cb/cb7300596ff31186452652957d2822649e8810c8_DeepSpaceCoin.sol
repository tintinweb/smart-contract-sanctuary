...
contract DeepSpaceCoin is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;

    address deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingAddress = payable(0xbFA0F80b9cBf536499A5Dbf3F7F245ee9228ACBf);
    ...
    string private _name = "Deep Space Coin"; //token name
    string private _symbol = "DEEPS"; // token symbol. 
