...
import "../../../interfaces/targetVaults/protocols/IDoppleFarm.sol";
import "../../../interfaces/targetVaults/protocols/IDoppleSwap.sol";
import "../TargetVault.sol";

contract TargetVaultDopple is TargetVault {
     ...
     */
    IDoppleFarm public doppleStaking;
    ...
    constructor(
        ...
        doppleStaking = IDoppleFarm(_doppleStaking);
        pid = _pid;
        ...
        tokenToBuyBackPath = [_token, wBNB, buyBackToken];
        rewardTokenToTokenPath = [rewardToken, _token];
    }
    ...
    function harvest() external virtual {
        ...
        if (doppleStaking.pendingDopple(pid, address(this)) > 0) _harvest();
    }
