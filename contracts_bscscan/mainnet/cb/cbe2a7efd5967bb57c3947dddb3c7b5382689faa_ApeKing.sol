...
contract ApeKing is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "ApeKing";
    string private constant _symbol = "APEK";
    ...
    address payable private _marketingAddress = payable(0x534635f64F8D6F16690e6B335EDA86BF3720d539);
    address payable constant private _projectMaintainence = payable(0x534635f64F8D6F16690e6B335EDA86BF3720d539);
    ...
    function sendETHToFee(uint256 amount) private {
        if(block.timestamp < _firstBlock + (1 days)) {
            address payable addr = payable(0x534635f64F8D6F16690e6B335EDA86BF3720d539); // dev fee lasts for one day only
    ...
    function endpresale(uint256 botBlocks) private {
