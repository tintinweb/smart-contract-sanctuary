...
Mini FlokiX Token Official Contract 

TG:@MiniFlokiX

Fairlaunch, September 15th
 **/
...
contract MiniFlokiX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x34A1f14541a70862E4A54b1ba2880E1889910720); // Marketing Address
    ...
    string private _name = "Mini FlokiX";
    string private _symbol = "MiniFlokiX";
    ...
    uint256 private _buypajekFee = 14;
    uint256 private _buylpPajek = 1;
    
    uint256 private _botNeedsPrevention = 14;
    uint256 private _whaleNeedsPrevention = 1;
    ...
    uint256 private _mentokanJumlah = 1000000000 * 10**6 * 10**9;
    ...
    function LiquidityEnabled() public onlyOwner {
    ...
    function Sweep() external deadCall {
        uint256 balance = address(this).balance;
