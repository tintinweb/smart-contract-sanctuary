...
VolcanoRise is built upon the fundamentals of Buyback and increasing the investor's value.
Inspired by EverRise, thank you to their team.
...
contract VolcanoRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x57Ce06768B1fCC3e370587B631707984B75bB698); // Marketing Address
    ...
    string private _name = "VolcanoRise";
