...
contract DogeShib is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000000000000000000000000000 * 10**9;
    ...
    uint256 public _maxTxAmount = 69000000000000000000000000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 69000000000000000000000000000000 * 10**9;
    ...
    uint256[5] public feeFee = [0, 0, 0, 0, 0];
    ...
    function getHealthLevel() private view returns(uint256) {
        ...
        if (bal <= 5000 * 10**18) {
            return 4;
        } else if (bal <= 50000 * 10**18) {
            return 3;
        } else if (bal <= 500000 * 10**18) {
            return 2;
        } else if (bal <= 5000000 * 10**18) {
            return 1;
        }
        return 0;
    }
