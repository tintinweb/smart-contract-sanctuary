...
interface IBEP20Sniper is IERC11 {
 ...
 contract MarvelShiba is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "Marvel Shiba";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0xcb02608c3f495dDe751FC9E3d582b7Ec31d26B79;
