...
/**
   ...
   Welcome to LuckyMini
   
   This is a community token. If you want to create a telegram I suggest to name it to @LuckyMini
   ...
   I will renounce the ownership to burn addresses to transfer #miniMOON to the community, make sure it's 100% safe.

   I will add 4 BNB and all the left 10% total supply to the pool
   Can you make #LuckyMini 10000X? 
...
contract LuckyMini is Context, IERC20, Ownable {
    ...
    string private _name = 'LuckyMini';
    string private _symbol = 'LuckyMini';
