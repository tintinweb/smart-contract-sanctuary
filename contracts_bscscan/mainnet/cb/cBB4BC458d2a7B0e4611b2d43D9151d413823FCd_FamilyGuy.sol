...
🔸 Token Name: Family Guy
🔸 Token Symbol: $GUY
🔸 Max Supply: 1,000,000,000,000,000 $GUY
🔸 Token Address: TBA 20.12.2021 21:00 UTC
🔸 Reflective
    🔸 8% Bnb rewards
    🔸 2% put in liquidity and locked (will be used to buyback and burn)
    🔸 2% development
    🔸 4% marketing
...
📈 Poocoin chart: Coming after the listing 
🦎 CoinGecko: Request made directly after listing and should be available within 3 days
🔹 CMC: Request made directly after listing and should be available within 7 days
🛡 Audit Report: Scheduled for end of May
...
🔄 Create token
🔄 BSCScan token verified
🔄 Youtube promotion
🔄 Twitter promotion
🔄 Update BSCScan information
🔄 Coingecko apply
🔄 Blockfollio
🔄 TikTok promotion
🔄 Token burn
...
❄️Website: https://www.familyguymeme.com/
❄️Telegram Chat: https://t.me/familyguycrypto
*/
...
contract FamilyGuy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Family Guy", "GUY")  {
    ...
    function developmentTax(uint256 value) external onlyOwner{
        marketingFee = value;
    }
    ...
    function BNBreward(uint256 value) external onlyOwner {
        buyFee = value;
    }
