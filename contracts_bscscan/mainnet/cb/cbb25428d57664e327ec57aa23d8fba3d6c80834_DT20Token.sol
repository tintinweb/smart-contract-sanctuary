...
contract DT20Token is IERC20Token, Ownable {
    ...
    function issueMultiAddress(address[] memory accounts, uint256[] memory amounts) external onlyIssuer {
        require(accounts.length == amounts.length, "two array length not equal");
