...
contract ProfitProphet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingAddress = 0x6CA78659fd8C53bd7F5BC5b742C3938C06661646;
    ...
    string private _name = "ProfitProphet";
