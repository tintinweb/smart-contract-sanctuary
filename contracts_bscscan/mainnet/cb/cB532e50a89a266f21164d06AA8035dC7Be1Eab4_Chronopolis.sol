...
contract Chronopolis is Context, IERC20, Ownable {
    
    using SafeMath for uint;

    string private constant _name = "Chronopolis";
    string private constant _symbol = "CHRONOPOLIS";
    ...
    uint private _taxFeeOnBuy = 6;
    
    //Sell Fee
    uint private _redisFeeOnSell = 1;
    uint private _taxFeeOnSell = 5;
    ...
    address payable private _marketingAddress = payable(0x15831042809EBC9c83CfF7847A821d39506d80FD);
