...
contract BubblePop is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x51CbA4dFb29A62Bff6781BB30b8fF7008968F061); // Marketing Address
    ...
    string private _name = "BubblePop";
