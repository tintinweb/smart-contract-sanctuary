...
// CHANGE
contract TigerMETA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Why is every tiger name taken I cant even have a good tiger name for my token now even tho I planned it before I was gonna take tigergirl when I saw it dumped but then it pumped again wtf  I cant even have a good tiger token now   Ughh I hate bsc";
    string constant _symbol = "STUPIDTIGERMETA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100; // 5% MAX 500.000
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 3% MAX 500,000
    ...
    uint256 buybackFee = 200;   // 3% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 500; // 8%
    uint256 totalFee = 900; // liquidityFee + Buyback + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x8cec52c433D065dE3d1C40a63D8E54BEe1469435);
