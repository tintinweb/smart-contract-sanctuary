...
//Welcome 
//Join the telegram community at: https://t.me/TheGoldenTicketBSC
//Make sure you only buy the PINNED contract in TG!
...
contract TheGoldenTicket is IBEP20, Auth {
    ...
    string constant _name = "TheGoldenTicket";
    string constant _symbol = "GOLDENTICKET";
    ...
    address public marketingFeeReceiver = 0x2d58EeADBa4269ca499bb37DF63DFD3e67431938;
    address public buybackFeeReceiver = 0x2d58EeADBa4269ca499bb37DF63DFD3e67431938;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function changemaxTxAmountSell(uint256 amount) external onlyOwner {
        _maxTxAmountSell = amount;
    }
    function changecoolDown(uint256 amount) external onlyOwner {
        _coolDown = amount;
    }
