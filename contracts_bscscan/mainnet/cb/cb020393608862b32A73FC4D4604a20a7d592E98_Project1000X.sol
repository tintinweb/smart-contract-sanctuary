...
// change "name1" into ur name
    contract Project1000X is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Project1000x";
    string private _symbol = "P1000x";
    ...
    constructor() public {
        ...
        marketingWallet = 0xA69a5F1b8eF4625a408Bd888cd40511E1E700026;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
