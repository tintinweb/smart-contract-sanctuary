...
https://mobile-legends.fandom.com/wiki/Boommander

A fascinating competition called Boommander is now trending in Laladona, and many Little Commanders have become its fans.
The rules are simple: collect Fluffy growing in the oasis near the Tree of Origin and cast these explosive puffballs at others.
Can you dodge the attacks and blast your opponent? Join Boommander and try it out now!
...
contract          BOOMMANDER                             is ERC20 {

    uint tokenTotalSupply = 1000000000000;

    constructor() public ERC20("BOOMMANDER", "BOOM") {
