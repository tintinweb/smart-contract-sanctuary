...
// Social trading platform to connect investors to traders.
//
// 2gather is a P2P platform that introduces blockchain technology and leads investors to an optimized investment strategy.
// Select and follow professional traders to adapt their trading strategies.
// 
//
//
...
//--------------------------------------------------------------------------------------
//
// 📱 Telegram: https://t.me/Chat2gather
//  WEBSITE: https://www.2-gather.com/
//   
//
//--------------------------------------------------------------------------------------
...
contract TwoGather is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x91193350427f803e90E5fCAbBd1bbfD6cE596FB4); // Marketing Address
    ...
    uint256 public _maxTxAmount = 20 * 10**4;
    uint256 private minimumTokensBeforeSwap = 50 * 10**4; 
