...
/**
              Seattle Cake is the next generation auto reflection earn $Cake & Auto Buy-back features by Seattle Cake .
 */
...
contract SeattleCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Seattle Cake";
    string constant _symbol = "SeattleCake";
