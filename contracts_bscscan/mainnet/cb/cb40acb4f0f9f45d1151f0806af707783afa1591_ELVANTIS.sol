...
/**
Elvantis #Metaverse Revolution. Art Beyond Limitation #CrossChain 

Website: https://elvantis.com/
Telegram News: @ELVANTISNEWS t.me/ELVANTIS
...
contract ELVANTIS is IBEP20, Ownable {
    ...
    uint256 private constant _tTotalSupply = 150000000 * 10 ** 9; 
    uint256 private _buyMaxTxAmount = 150000000 * 10 ** 9; 
    uint256 private _sellMaxTxAmount = 15000000 * 10 ** 9;
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 150000000, "Can not reduce below 10K");
        require(maxSell > 150000000, "Can not reduce below 10K");
