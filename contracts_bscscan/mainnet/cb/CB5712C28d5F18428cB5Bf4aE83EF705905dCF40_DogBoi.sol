...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x79eBC9A2ce02277A4b5b3A768b1C0A4ed75Bd936);
...
contract DogBoi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DogBoi";
    string constant _symbol = "DBOI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x59556699449f16aAEAb1FC52F571d1d9c32d6EEA;
        devFeeReceiver = 0x747a8FfDA17c2d2aDd65191311333d12df4632e4;
    ...
    function setMaxWalletPercent_base100000(uint256 maxWallPercent_base100000) external onlyOwner() {
        _maxWalletToken = rSupply.div(100000).mul(maxWallPercent_base100000);
    }

    function setMaxTxPercent_base100000(uint256 maxTXPercentage_base100000) external onlyOwner() {
        _maxTxAmount = rSupply.div(100000).mul(maxTXPercentage_base100000);
    }
