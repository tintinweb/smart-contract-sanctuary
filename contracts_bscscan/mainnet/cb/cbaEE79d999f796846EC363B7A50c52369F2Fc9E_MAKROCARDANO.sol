...
contract MAKROCARDANO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MAKRO CARDANO";
    string constant _symbol = "MAKRO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply =  1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 20; // 1%
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 2%
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x06A90F94db6cAB0fc5f19EBF53a2Bb449f5ED5f8;
