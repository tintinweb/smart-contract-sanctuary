...
contract SpaceXCoin is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x9a357A77dA00732e6e8997eE05Ab2E0D84A667fB;
    ...
    string private _name = "SpaceX Coin";
    ...
    uint256 public maxWalletToken = 1000000000 * (10**9); // It is applied to all public and private wallets to keep the distribution process transparent and to discourage whales! 
