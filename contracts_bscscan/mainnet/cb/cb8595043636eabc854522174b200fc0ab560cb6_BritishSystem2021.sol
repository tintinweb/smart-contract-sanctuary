...
/*
 ...
 Welcome to British System 2021
 
Inspired by Elon Twitt
https://twitter.com/elonmusk/status/1413013632464662528
   
   This is a community token.I will add liquidity 5 minutes from now.
   If you want to create a telegram I suggest to name it to @BRITISHSYSTEM2021
   Important: The early you create a group that shares the token, the more gain you got.
   And i'll BURN LP and Renounce Ownership ASAP!
   ...
   I will renounce the ownership to burn addresses to transfer #BRITISHSYSTEM2021 to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #BRITISHSYSTEM2021 10000X? 
   ...
   it's the best part of the #BRITISHSYSTEM2021 idea, increasing the liquidity pool automatically, 
...
contract BritishSystem2021 is Context, IERC20, Ownable {
    ...
    string private _name = 'BritishSystem2021';
    string private _symbol = 'BS2021';
