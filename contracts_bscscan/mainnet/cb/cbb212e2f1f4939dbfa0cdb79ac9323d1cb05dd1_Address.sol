...
contract HPALWARLOCK is Context, IBEP20, Ownable {
    ...
    address payable public _marketingAndDevelopmentWallet = payable(0x5c57CE95F023bcF5B92d713Ae13E94e27948C2F9); // MarketingAndDevelopment Address
    ...
    string private constant _name     = "HPALWARLOCK";
    string private constant _symbol   = "HPW";
    ...
    function transferForeignToken(address _token, address _to) public onlyOwner returns(bool _sent){
        // with this condition HPALWAR token can not be moved but others junks can be removed to clear the contract.
        // other projects send their junk token for promotion. This function will be used to remove those junks.
        // This function can not remove HPALWAR token from the contract.
