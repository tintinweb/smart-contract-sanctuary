...
contract iSpace is Context, IERC20, Ownable {
    ...
    string private _name = "Infinity Space";
    string private _symbol = "iSpace";
    ...
    uint256 public _maxTxAmount = 2 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**7 * 10**9;
    uint256 public _maxWalletToken = 1 * 10**10* 10**9;
