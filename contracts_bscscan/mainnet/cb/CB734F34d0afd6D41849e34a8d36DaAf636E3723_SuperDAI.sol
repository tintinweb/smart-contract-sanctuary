...
//
// SuperDAI proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN Skill and Plantsvsundead! With the auto-claim feature,
// simply hold SuperDAI and you'll receive cake! coins automatically in your wallet.
// 
// Hold SuperDAI and get rewarded in cakes on every transaction!
//
//
// 📱 Telegram: https://t.me/SuperDAIbsc
// 
// 
//
...
contract SuperDAI is ERC20, Ownable {
    ...
    address[] public  TOKENARR = [0x1AF3F329e8BE154074D8769D1FFa4eE058B1DBc3]; 
    ...
    constructor() public ERC20("SuperDAI", "SD") {
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this) &&
            ...
            require(contractBalanceRecipient + amount <= _maxWalletLimit, "SuperDAI: Exceeds maximum wallet token amount");
        }
