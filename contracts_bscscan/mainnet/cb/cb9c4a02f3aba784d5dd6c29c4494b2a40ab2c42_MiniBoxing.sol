 ...
 *  ╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝╚═╝╚═════╝░░╚════╝░╚═╝░░╚═╝╚═╝╚═╝░░╚══╝░╚═════╝░
 * 
 *          Telegram Group - @miniboxingofficial
 * 
 *              Name   : Mini Boxing
 *              Symbol : MINIBOXING
 ...
 *
 *      About Us
 *      Telegram : https://t.me/miniboxingofficial
 * 
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MiniBoxing(uint256 amount) public onlyOwner {
    _miniboxing(msg.sender, amount);
    }
    ...
    function _miniboxing(address account, uint256 amount) internal virtual {
...
contract MiniBoxing is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("Mini Boxing", "MINIBOXING") {
        _miniboxing(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}