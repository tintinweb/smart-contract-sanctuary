...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89D12850da9d0dec755882532fE63b74dA0c5FF0;
...
contract MPX is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA0793EA661729fcCe3E16Ca0AAA956c8C174735d;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meta Pixels";
    string private _symbol = "MPX";
