...
contract SerWenMoon is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1_000_000_000_000_000; //100 Trillion, underscores aid readability
    ...
    string private _name = "SerWenMoon";
    string private _symbol = "SWM";
    ...
    uint256 public _marketingFee = 50; // 4%, divisor is 1000
    ...
    address payable private _marketingWallet = payable(0x509ABF598Db33aCfffbf81FC7c251ba9b75bc3dC);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;
    
    // Max TX amount is 1.5% of the total supply.
    uint256 private maxTxPercent = 900; // Less fields to edit
    ...
    uint256 private maxWalletPercent = 900; // Less fields to edit
    ...
    // Set to 0.8%.
    uint256 private doubleTaxPercent = 900; // Less fields to edit
