...
/**
 * Puggy Potter aims to create a community that tax friendly and great passive income. Inspiring to be a successful, community-driven, and charity-driven project, 
   Puggy Potter is ready to be your latest moonshot token
...
contract PuggyPotter is IBEP20, Auth {
    ...
    string constant _name = "PuggyPotter";
    string constant _symbol = "PuggyPotter";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;
    uint256 public _maxWalletSize = (_totalSupply * 7) / 100;
    ...
    address private marketingFeeReceiver = 0x8360b118a52FAac4E49043F01f0338460A8De73c;
    address private DevelopmentFeeReceiver = 0x8360b118a52FAac4E49043F01f0338460A8De73c;
