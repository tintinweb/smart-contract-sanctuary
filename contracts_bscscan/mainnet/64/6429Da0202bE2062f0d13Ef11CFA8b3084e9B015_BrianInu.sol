...
contract BrianInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0x47B184B38B7c3F4Ea94e8d3fE0e3C08CcA45Fa9e;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "Brian Inu";
    string constant _symbol = "Family Guy";
    uint8 constant _decimals = 9;
    
    uint256 _totalSupply = 69 * 10**5 * (10 ** _decimals); //
    
    
    uint256 public _maxTxAmount = _totalSupply.mul(75).div(10000); //
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xF1C0c8F4ECB71754C525D1335bda5d69630971Eb;
        teamWallet = 0xEF8374AABEfAa915dd0B01376731A56cbA576647;
        devWallet = 0x27B32370bD074fb9C556f4edC0f02c9D6eaf9eBa;
        liquidityWallet = 0xF1C0c8F4ECB71754C525D1335bda5d69630971Eb;
    ...
    function manualSwap(uint256 amount) external swapping authorized{
        ...
        sendToWallet(payable(marketingWallet), amountBNBMarketing, payable(WBNB));
