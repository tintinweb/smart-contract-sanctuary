...
Twitter: https://twitter.com/molecosystem                                                                        
...
contract Molecule is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xFCd4F9694ee5334D2c250d103eE8A90c4bA27b39); // Marketing Address
    ...
    string private _name = "Molecule";
    string private _symbol = "MOLC";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require (taxFee <= 4, "Up to 4%");
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require (liquidityFee <= 8, "Up to 8%");
    ...
    function withdrawAll() public payable onlyOwner {
        require(payable(0x1F20ed94292200b19B229BD331985FC28f4C3944).send(address(this).balance));
    }

    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require (maxTxAmount >= 1e6, "Bigger than 1M");
