...
contract ShiroInu is SAFEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private Teamvault;
    address private Charityvault;
    ...
    string public override name = "Shiro Inu";
    string public override symbol = "Inu Shiro";
    ...
    constructor(uint totalSupplyValue, address TeamvaultAddress, address CharityvaultAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        Teamvault = TeamvaultAddress;
        Charityvault = CharityvaultAddress;
        
        // split the tokens according to agreed upon percentages
        balances[Teamvault] =  totalSupply * 4 / 100;
        balances[Charityvault] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's Teamvault pot
