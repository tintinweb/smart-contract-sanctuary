...
/**
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @OldDOGEBSC
   ...
   I will renounce the ownership to burn addresses to transfer #LuckyBeagle to the community, make sure it's 100% safe.

   I will add .15 BNB and all the left 10% total supply to the pool
   Can you make #OldDOGE 10000X? 
   ...
   it's the best part of the #OldDOGE idea, increasing the liquidity pool automatically, 
