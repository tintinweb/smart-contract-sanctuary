...
/*
Join our community t.me/ElonXmas
...
library Address {
     ...
     * [IMPORTANT]
     * ====
     * CYBERCHEEMS TEAM FULLY DOXXED, KYC available to everyone!
     * It is unsafe to assume that an address for which this function returns
     * false is an externally-owned account (EOA) and not a contract.
     * Don't make any trade if you're not able to take a risk on crypto currencies
...
contract ElonXmas is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ElonXmas";
    string constant _symbol = "EXMAS";
    ...
    address payable public liquidityFeeReceiver = payable(0xfD4672E1f34Fa04bBB5a9f3f9Ac0d3eD71363E01);
    address payable public marketingFeeReceiver = payable(0xfD4672E1f34Fa04bBB5a9f3f9Ac0d3eD71363E01);
