...
contract Ownable is Context {
    address private _owner = 0x35A3892cc4A48d77aE014C1f77033b8C71d49EbB;
...
contract YouRicher is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x1C17875a2C0b7Bb263f19E7187CA5d96ccc0a555); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "YouRicher"; // token name
    string private _symbol = "RICHER"; // token symbol
    ...
    uint256 public _tokenFee = 0; // marketing fee 0% to be sent as tokens
    uint256 private _previousTokenFee = _tokenFee; // marketing tokens fee
    
    uint256 public _buyBackFee = 20; // buyback fee 2%
    ...
    uint256 public _liquidityFee = 90; // liquidity fee 9%
