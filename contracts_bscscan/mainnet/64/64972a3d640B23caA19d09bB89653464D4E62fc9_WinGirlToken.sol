...
WinGirl is a P2E (play-to-earn) utility token, which is built on the newest and the safest pragma solidity version.
...
-5% buy tax.
-2% sell tax.
-WinGirl's liquidity is locked for 1 year on Mudra LP locker. 
/**
...
contract WinGirlToken is Context, IERC20, IERC20Metadata, Ownable {   
