...
/**
   ...
   10% fee auto distribute Btc,Eth,Cake,Bnb to all holders
...
contract BabyTigerGame is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x972d33172cd9Ffe5da022C9D52849730668b9BCa;
    ...
    string private _name = "Baby Tiger Game";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xd0b87fC8f224282F27af8d005107394D7405447F, 'We can not exclude Uniswap router.');
