...
/*
Telegram: https://t.me/BabyBatGirl

BabyBatGirl has stealth launched onto the blockchain!

Maximum buy and sell: 0.5% - 500.000.000 Tokens
Maximum wallet size: 3% - 3.000.000.000 Tokens

Tokenomics:

* 10% Added to Liquidity
* 5% BAT Token distribution
* 3% Marketing wallet

Total Fees: 18%

Adress to add BAT to your wallet: 0x101d82428437127bF1608F699CD651e6Abf9766E
...
contract $BabyBatGirl is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("$BabyBatGirl", "$BabyBatGirl") {
    	firstDividendTracker = new FIRSTDividendTracker();
 
    	marketingWallet = 0x8d1211558eA608e98f0CF5B4eBAdF3D71bA0b230;
    	firstDividendToken = 0x101d82428437127bF1608F699CD651e6Abf9766E; //BAT
    ...
    function ReadyForLaunch() external onlyOwner {
        maxSellTransactionAmount = 500000000 * (10**9); //0.5%
        maxBuyTranscationAmount = 500000000 * (10**9); //0.5%
...
contract FIRSTDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("$Lovely_Dividend_Tracker", "$Lovely_Dividend_Tracker", 0x101d82428437127bF1608F699CD651e6Abf9766E) { //BAT
    	claimWait = 3600;
