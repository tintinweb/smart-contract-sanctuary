...
╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰╯
 ...
 Dev Safu
 Low Tax 
 Our Group https://t.me/safemarketplace
 twitter official https://twitter.com/SafeMrketplace
...
contract Safemarketplace is Context, IERC20, Ownable {
    ...
    string private _name = "Safe Marketplace";
    string private _symbol = "SafeMark";
    ...
    constructor (address m, uint8 lf, uint8 mf, uint8 bf) {
        marketingAddress = payable(m);
        ...
        _liquifyThreshhold = _totalSupply / 1000; // 0.1%
        _maxBalance = _totalSupply / 20; // 5%
