...
Telegram = https://t.me/DragonBratbsc
...
// CHANGE
contract DragonBrat is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Dragon Brat";
    string constant _symbol = "Dragon Brat";
    ...
    uint256 public _sellMultiplier = 1; // 1x for sells
    ...
    uint256 public swapThreshold = _totalSupply / 100; // 0.2%
    bool inSwap;
