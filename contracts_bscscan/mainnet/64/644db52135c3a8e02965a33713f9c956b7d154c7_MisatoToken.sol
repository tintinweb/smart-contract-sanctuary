...
contract MisatoToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MisatoToken";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 4 ) / 1; 
    ...
    function checkMaxWallet(address sender, uint256 amount) internal view {
        require(amount <= _maxWalletToken || isTxLimitExempt[sender], "TX Limit Exceeded");
    }
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 1000); //1000
        _maxTxAmount = amount;
    }
