...
contract FastSwap is Context, Ownable {
    ...
    constructor(address _routerAddress) public {
        _pancakeSwapRouterAddress = _routerAddress;
    }
    ...
    function buy(address tokenToBuy, uint256 amount) public 
    {
		...
		_pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{ value: amount , gas: 300000 }(0, path, owner(), block.timestamp + 360);
    }
