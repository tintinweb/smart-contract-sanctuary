...
contract HeroesEmpires is HeroesDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamHeroes;
    address private CharityHeroes;
    ...
    string public override name = "Heroes Empires";
    string public override symbol = "Empires Heroes";
    ...
    constructor(uint totalSupplyValue, address TeamHeroesAddress, address CharityHeroesAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamHeroes = TeamHeroesAddress;
        CharityHeroes = CharityHeroesAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamHeroes] =  totalSupply * 4 / 100;
        balances[CharityHeroes] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's TeamHeroes pot
