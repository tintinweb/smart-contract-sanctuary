...
contract DogeFather2k22 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DogeFather 2k22";
    string private _symbol = "DogeFather2k22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe893F334411Adec8bC0f61B26fBC9f44F04B85e1); // Marketing Address
    address payable public DevWalletAddress = payable(0xcAb5597697aeea6C68e4F4943328fB4C06cbe85E); // Dev fee
    ...
    uint256 private _totalSupply = 100000 * 10**9; // 1 Billion
