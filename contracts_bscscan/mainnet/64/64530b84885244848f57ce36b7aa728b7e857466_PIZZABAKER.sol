...
https://t.me/PIZZABAKER

NO RUG! NO SCAM! STEALTH°!
HYPE THIS PROJECT
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BAKE = IERC20(0xE02dF9e3e622DeBdD69fb838bB799E3F168902c5);
...
// CHANGE
contract PIZZABAKER is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "PIZZABAKER";
    string constant _symbol = "PIZZABAKER";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x57f6B27856833c61d4dBfa32db9011C88cA613a5);
