...
/**
Telegram : https://t.me/HoneyBabyBear

   #HONEY_BABY_BEAR features:
...
contract HONEY_BABY_BEAR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "HONEY BABY BEAR";
    string constant _symbol = "$HBB";
