...
contract SuperstarShiba is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'SuperstarShiba';
    string  private constant _SYMBOL = 'SuperstarShiba';
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000000000  * _DECIMALFACTOR;
