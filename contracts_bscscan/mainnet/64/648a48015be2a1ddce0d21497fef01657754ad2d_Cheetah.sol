...
contract Cheetah is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x368c685a60C7D3Cd5efdc2A807B2f189A460EEeB); // Marketing Address
    address payable public charityAddress = payable(0x368c685a60C7D3Cd5efdc2A807B2f189A460EEeB); // Charity/Dev Address
    ...
    string private _name = "Cheetah Swap";
