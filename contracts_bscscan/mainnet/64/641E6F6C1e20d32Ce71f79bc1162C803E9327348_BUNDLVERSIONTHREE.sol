...
contract BUNDLVERSIONTHREE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmountBuy = 5000 * 10**6 * 10**9;
    uint256 public _maxTxAmountSell = 250 * 10**6 * 10**9;
...
function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
    ...
    function launch() external onlyOwner {
        ...
        _burnFee = 2;
        _liquidityFee = 10;
        _maxTxAmountBuy = 5000000000 * 10**9;
