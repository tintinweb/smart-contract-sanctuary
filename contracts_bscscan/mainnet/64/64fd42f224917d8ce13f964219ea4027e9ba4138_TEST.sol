...
contract TEST is IERC20Metadata, Ownable {
    ...
    address public jackpotWallet = 0x3f130199a44A3756d8C9b2E19Ca7B07F5b4DfE6d; // Jackpot Address
    address public devWallet = 0x0b609c9ce3a7acd14e3309f67b38B9ee5DFA41d8; // Dev Address
    ...
    uint256 public devPortionOfSwap = 30;
    ...
    uint256 public sellingJackpotFee = 3;
    uint256 public buyingJackpotFee = 3;
    
    uint256 public sellingDevFee = 3;
    uint256 public buyingDevFee = 3;
    
    uint256 public antiBotFee = 99;
    
    uint256 public buyersTotalFees = buyingMarketingFee.add(buyingRfiFee).add(buyingLpFee).add(buyingJackpotFee).add(buyingDevFee);
    uint256 public sellersTotalFees = sellingMarketingFee.add(sellingRfiFee).add(sellingLpFee).add(sellingJackpotFee).add(sellingDevFee);
