...
contract Manager is Ownable  {
    ...
    uint256 constant public feeEvolve = 200 * 10 ** 18;
    uint256 constant public priceEgg = 1500 * 10 ** 18;
    uint256 constant public feeMarketRate = 15;
    uint256 constant public generation = 0;

    uint256 public feeChangeTribe = 999 * 10**6 * 10**18;

    uint256 public timeLimitBattle = 2 * 60 * 60;

    uint256 public rateBattleReward = 1 * 10 ** 18;
