...
Welcome to the RocketMan Community Group❗️

👉What is RocketMan?

The RocketMan Marketplace is a NFT platform built on the Binance smart chain, made for social media personalities who want to create digital collectibles of their likeness. RocketManRCM is a marketplace for social media users to create NFT’s of their items or images and sell them on the platform. 

RocketMan NFT Marketplace users are able to add single or multiple items on the market place to sell. Users looking to purchase on the marketplace must also be registered to the RocketMan NFT Marketplace

For more information visit the website below ⬇️⬇️⬇️

http://www.RocketMan.art/

Big announcements soon, Including airdrops, stay tuned❗️

📣Media Links📣
🌍 Website: http://www.RocketMan.art/
🎉 Twitter: https://twitter.com/RocketMan_Group
💎 Telegram : https://t.me/RocketManRCM
...
contract RocketMan is Context, BEP20 {
    ...
    string private _name = "RocketMan";
    string private _symbol = "RCM";
