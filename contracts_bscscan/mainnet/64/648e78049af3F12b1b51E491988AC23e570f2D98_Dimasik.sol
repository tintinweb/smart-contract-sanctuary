...
contract Dimasik is Owner{
    ...
    constructor(
        ...
        IdoName=_name;
        require(_saleStart > block.timestamp && _saleEnd > _saleStart,"Invalid date");
    ...
    function  Registration() public payable
    {
        ...
        require(!UserPurchases[msg.sender].Registered, "You are already registered!");
    ...
    function BuyTokens(uint256 amount) external _hasAllowance(msg.sender, amount)
    {
        ...
        require(block.timestamp <= SaleEnd, "Sale Ended");
        require(UserPurchases[msg.sender].Registered, "You are not registred!");
