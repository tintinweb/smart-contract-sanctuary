...
contract $Monopolio is Operator {
    ...
    string private _name = "$Monopolio";//#币名
    string private _symbol = "$Mono";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 1000000000000000 * 1e9;//#总币量
    ...
    constructor () public {
        ...
        setWhiteList(address(0x95fBD783839e532fB14e9C7752Cab1cf43CF70B7),true);
    }
