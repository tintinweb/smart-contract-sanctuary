...
/**Welcome to LandingFalcon
   ...
   I will renounce the ownership to burn addresses to transfer #LandingFalcon
   to the community
   Can you make #LandingFalcon
   100X? 
   ...
   it's the best part of the #LandingFalcon
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract LandingFalcon is Context, IBEP20, Ownable {
