...
// File: @Holdexswap/Holdex-swap-lib/contracts/math/SafeMath.sol
...
// File: @Holdexswap/Holdex-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: @holdexswap/holdex-swap-lib/contracts/utils/Address.sol
...
// File: @holdexswap/holdex-swap-lib/contracts/token/BEP20/SafeBEP20.sol
...
// File: @holdexswap/holdex-swap-lib/contracts/utils/ReentrancyGuard.sol
...
// File: contracts/interfaces/IHoldexProfile.sol

pragma solidity ^0.6.0;

/** @title IHoldexProfile.
 */
interface IHoldexProfile {
     ...
     * Callable only by owner admins.
     */
    function updateNumberHoldex() external;
...
// File: contracts/HoldexPointCenterIFO.sol

pragma solidity ^0.6.12;

/** @title HoldexPointCenterIFO.
@dev It is a contract for users to collect points
for IFOs they participated in.
*/
contract HoldexPointCenterIFO is Ownable {
    IHoldexProfile holdexProfile;
    ...
    constructor(address _holdexProfileAddress, uint256 _maxViewLength) public {
        holdexProfile = IHoldexProfile(_holdexProfileAddress);
    ...
    function getPoints(address _contractAddress) external {
        ...
        bool isUserActive = holdexProfile.getUserStatus(senderAddress);
        ...
        holdexProfile.increaseUserPoints(
            senderAddress,
