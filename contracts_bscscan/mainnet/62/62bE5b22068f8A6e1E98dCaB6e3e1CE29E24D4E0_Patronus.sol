...
abstract contract Ownable is Context {	
    ...
    uint256 public _lockTime = 14 days;
...
contract Patronus is Context, IBEP20, Ownable {
   ...
   uint256 public MaxBBackAmount = 3 * 10**17;
   uint256 public BBackThreshold = 10;
   //end skizzo
	...
	uint256 private _taxFee = _taxFeeL0;
   	uint256 public _BNBFeeL0 = 8;
	uint256 private _BNBFee = _BNBFeeL0;

	uint256 private _feeDurationHalf =  ((3*24*3600)-1800);//1800; seconds
	uint256 private _feeDurationMax =  (3*24*3600);//3 * 24 * 3600; seconds
	uint256 private feeMultiplier = 0; 
	
	// fast sell
	uint256 public _taxFeeL1 = 7; 
    uint256 public _BNBFeeL1 = 8 ; 
	
	//bot sell
	uint256 public _taxFeeL2 = 15; 
    uint256 public _BNBFeeL2 = 10; 	


    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
	address payable public fundraisingAddress = payable(0x9bf057593EfEC4Ff45aa8879046ceC8EF343b048);
    
    uint256 private fundDivisor = 50; // %funds sent to fundraising address
    ...
    uint256 private minTokensBeforeSwap = 2500000 * 10 ** 18;
...
//end modded
    ...
    function rescueBNBStuckinContract() external onlyOwner {
       fundraisingAddress.transfer(address(this).balance);
    }
