...
Telegram: NoRewardNoProblem

Aren't you already tired of all the reward tokens?
High fees, unrenounced ownership and low profit doesn’t sound too great… 
They usually end up being a rug, too.

No Reward No Problem solves this issue by providing you a safe token, 
which has really low fees, renounced ownership and LP locked for a month. 
...
🚫 Every TX burns a small % of the supply
...
contract NoRewardNoProblem is Context, iERC20, Ownable {
