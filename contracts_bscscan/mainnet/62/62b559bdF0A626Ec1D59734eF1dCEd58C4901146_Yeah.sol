...
contract Ownable is Context {
    address private _owner = 0x1c5153e0F361c55d7883Aa87f0bdEf954c208925;
...
contract Yeah is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x60c8B7E30be196B82f8Dc30b7395B8f20a507F50); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Yeah"; // token name
    string private _symbol = "Yeah"; // token symbol
    ...
    uint256 public _minTokensSwapToAndTransferTo = 10 * 10**0 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
