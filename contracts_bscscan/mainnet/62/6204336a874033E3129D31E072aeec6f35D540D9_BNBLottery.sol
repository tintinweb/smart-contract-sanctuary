...
contract BNBLottery is ReentrancyGuard, IBNBLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        require(msg.value >= amountCakeToTransfer, "insufficient BNB balance");
    ...
    function claimTickets(
        ...
        payable(msg.sender).transfer(rewardInCakeToTransfer);
        ...
        nonReentrant
    {
        ...
        payable(dev).transfer(amountToWithdrawToTreasury/2);
        payable(treasuryAddress).transfer(amountToWithdrawToTreasury/2);
