...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0xAe2DF9F730c54400934c06a17462c41C08a06ED8);
...
contract BABYDOGEBONK is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0xAe2DF9F730c54400934c06a17462c41C08a06ED8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABYDOGEBONK";
    string constant _symbol = "BBDOBO";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x22Bb3791eDf6a6c309e011CF6Bed7F1DB362fCa4;
