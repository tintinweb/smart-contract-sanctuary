...
contract MetaZero is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0xD9ed27812512631904d34ac802e85B7788469330); // Marketing Address
    ...
    string private _name = "MetaZero";
    string private _symbol = "MetaZero";
