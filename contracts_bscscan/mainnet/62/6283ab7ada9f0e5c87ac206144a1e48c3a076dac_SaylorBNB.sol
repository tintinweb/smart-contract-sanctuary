...
contract SaylorBNB is SBNBDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamSBNB;
    address private CharitySBNB;
    ...
    string public override name = "SaylorBNB";
    string public override symbol = "SBNB";
    ...
    constructor(uint totalSupplyValue, address TeamSBNBAddress, address CharitySBNBAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamSBNB = TeamSBNBAddress;
        CharitySBNB = CharitySBNBAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamSBNB] =  totalSupply * 4 / 100;
        balances[CharitySBNB] = totalSupply * 25 / 100;
    ...
    // Get the address of the token's TeamSBNB pot
