...
/**
 ...
 USE YOUR SNIPE BOT ON THIS CONTRACT AND WATCH YOUR MONEY DISAPPEAR
...
contract BCP is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 3;
  uint256 public _feeLiq = 2;
  uint256 public _feeHolders = 2;
  uint256 public _devWallet = 3;
