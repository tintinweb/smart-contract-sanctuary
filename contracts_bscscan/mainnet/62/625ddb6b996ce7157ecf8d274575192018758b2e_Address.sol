...
// CHANGE
contract RoaringApe is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Roaring Ape";
    ...
    uint256 buybackFee = 400;   // 2% 
    uint256 reflectionFee = 0; // 0%
    uint256 devFee = 800; // 5%
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x9cEb13b12563F79A895FD0dDAff25D43550B6473);
