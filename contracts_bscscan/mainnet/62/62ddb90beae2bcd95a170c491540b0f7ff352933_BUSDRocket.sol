...
/**
 🚀🚀BUSDRocket, Hold BUSDrocket Earn BUSD Automatically every 30 Minutes🚀🚀

$BUSDrocket is the ultimate all-in-one token, providing the very best in cutting edge code we have created a token that rewards hodlers like never before.

A hyper-deflationary token with automatic distribution of rewards. Fully customisable to the user, $BUSDrocket provides a unique, new and exciting way to safely invest your finances.

🚀Advantages of BUSDrocket🚀
The buy-back wallet consists of BUSD that is taken from the tax on buy/sell transactions. When an individual sells, they add tokens to the liquidity pool while taking BNB. The buy-back wallet will be manually controlled to give our holders a rightful say in when it is implemented. The true definition of a community token..
...
contract BUSDRocket is Context, IERC20, Ownable {
    ...
    string private _name = "BUSDRocket";
    string private _symbol = "BUSDRocket";
