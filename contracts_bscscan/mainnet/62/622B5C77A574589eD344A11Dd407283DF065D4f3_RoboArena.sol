/**
   ...
   #RoboArena features:
    ...
    Buy Tax:
    7% AXIE Rewards every hour
    5% Mega Boost (3% Buy Back, 2% Liquidity)
    3% Marketing
    
    Sell Tax:
    10% AXIE Rewards every hour
    5% Mega Boost (3% Buy Back, 2% Liquidity)
    3% Marketing
    
    Telegram: https://t.me/roboarena
...
contract RoboArena is Context, IERC20, Ownable, Initializable {
    ...
    string private _name = "RoboArena";
    string private _symbol = "ROBOARENA";
    ...
    function rewardTokens(uint256 amount) private lockTheSwap {
    	if (amount > 0) {
    	    swapETHForTokens(amount, AXIE, address(this));
	    }
    }
...
contract AXIEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("AXIE_Dividen_Tracker", "AXIE_Dividend_Tracker") {
    	claimWait = 3600;
