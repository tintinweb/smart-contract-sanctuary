...
// CHANGE
contract Regretamine is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Regretamine";
    string constant _symbol = "Regretamine";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 25) / 1000; // 2.5% MAX
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x9dA700326e2eF12594DF2A072e07139bC49386Bb);
