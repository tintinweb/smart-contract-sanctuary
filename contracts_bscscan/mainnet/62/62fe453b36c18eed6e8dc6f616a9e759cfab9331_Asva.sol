...
contract Ownable is Context {
    ...
    function recoverOwnership(address newOwner) public virtual onlyOwner {
...
contract Asva is Context, IERC20, Ownable {  // nice
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe5F225b3465a662a19D81d70aA5738F25Fa3626d); // Marketing Address
    address payable public charityAddress = payable(0xe5F225b3465a662a19D81d70aA5738F25Fa3626d); // Charity/Dev Address
    ...
    uint256 private _tTotal = 10000000 * 10**18; // nice
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Asva finance";
    string private _symbol = "ASVA";
    ...
    uint256 public _maxTxAmount = 12000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 12000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 12000000000000000000; // nice Claim: 12 (0.01BNB = 1200)
