...
contract check is Context, IERC20, Ownable {
    ...
    string private _name = 'DemonDoge';
    string private _symbol = '$DDOGE';
    uint8 private _decimals = 18;
    
    
        uint256 public                _taxFee = 1; // 2% of transactions will be redistributed among holders
    uint256 public          _liquidityFee = 10; // 9% of transactions will be kept for liquidity
