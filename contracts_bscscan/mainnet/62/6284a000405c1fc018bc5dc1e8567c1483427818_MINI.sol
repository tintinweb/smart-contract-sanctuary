...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 META = IBEP20(0xD40bEDb44C081D2935eebA6eF5a3c8A31A1bBE13);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = META.balanceOf(address(this));
        ...
        uint256 amount = META.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            META.transfer(shareholder, amount);
...
contract MINI is IBEP20, Auth {
    using SafeMath for uint256;

    address META = 0xD40bEDb44C081D2935eebA6eF5a3c8A31A1bBE13;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MINI";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x94Cd6993B4609464a5e6b2601881D71935D7b695;
