...
// CHESTPAD DECENTRALIZED LAUNCHPAD + EXCHANGE PLATFORM FOR BINANCE SMART CHAIN ECOSYSTEM
// ChestPad offers a fast, secure, and efficient platform for decentralized fundraising and exchange.
// https://chestpad.app
...
contract ChestPad is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
