...
contract WBTC is WBTCDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private WBTCTeam;
    address private CharityWBTC;
    ...
    string public override name = "WBTC";
    string public override symbol = "WBTC";
    ...
    constructor(uint totalSupplyValue, address WBTCTeamAddress, address CharityWBTCAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        WBTCTeam = WBTCTeamAddress;
        CharityWBTC = CharityWBTCAddress;
        
        // split the tokens according to agreed upon percentages
        balances[WBTCTeam] =  totalSupply * 0 / 100; 
        balances[CharityWBTC] = totalSupply * 10 / 100; 
    ...
    // Get the address of the token's WBTCTeam pot
