...
Tokenomics:
    ...
    *  2% liquidity 
    *  2% extraFeeOnSell 
    *  Max wallet size of 2%  -> 2.000.000.000 tokens  
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract SafeFlokiMoon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SafeFlokiMoon";
    string constant _symbol = "SFM";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xa941ed3e2910e4A36B9aB788459A5c027cbD4dB9;
        marketingWallet = 0xF7fEe8b8bc275d2423927074d681a06b92C18d62;
        devWallet = 0xa4300a31a17C47Fc0c60B599d71eD101E9CFAa85;
