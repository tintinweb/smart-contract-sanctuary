...
contract ELPAPOBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7E21fDc91B4Bb86b31b98A04fd160B853Ed0F6Fe); // Marketing Address
    ...
    string private _name = "ELPAPO";
    string private _symbol = "PAPO";
