...
contract BabyApeWorld is ERC721, Ownable {

    uint public mintPrice = 0.03 ether;
    uint public giveawayMaxItems = 100;
    uint public preMintMaxItems = 30;
    uint public maxItems = 969;
    ...
    constructor() ERC721("BabyApeBanana World", "ApeMe") {}
    ...
    function withdrawAll() external onlyOwner {
        ...
        sendEth(0x8669554246C7Cd9Aad4375793650DA31e78961Ad, amount1);
        sendEth(0x6E1fd9869092DE5747621EC44f7E080A8eD788CE, amount2);
    }

    function withdrawToDAO() external onlyOwner {
        sendEth(0x8669554246C7Cd9Aad4375793650DA31e78961Ad, 10 ether);
    }
