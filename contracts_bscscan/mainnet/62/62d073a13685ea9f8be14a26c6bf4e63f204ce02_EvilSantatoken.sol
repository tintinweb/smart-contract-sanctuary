...
Telegram = https://t.me/EvilSantatoken
...
// CHANGE
contract EvilSantatoken is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "EvilSanta Token";
    string constant _symbol = "EST";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 3% MAX 30,000,000
