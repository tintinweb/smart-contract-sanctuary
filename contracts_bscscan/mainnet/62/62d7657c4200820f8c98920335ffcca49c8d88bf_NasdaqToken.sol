...
/* Nasdaq -  Trade, earn, and win crypto on the most popular decentralized platform on binance smart chain
...
contract NasdaqToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x68498E73BE18595D4c0351D3de80b06aF1d2F86E); // Marketing Address
    address payable public charityAddress = payable(0x68498E73BE18595D4c0351D3de80b06aF1d2F86E); // Charity/Dev Address
    ...
    string private _name = "Nasdaq Token";
    string private _symbol = "NAS";
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 800000000000000000000000000; // 800,000,000; token will be given on airdrop
