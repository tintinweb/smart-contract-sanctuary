...
contract NiceApe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa14704D5A12Eb0f20906914ce3A73bCE28F11F03); // Marketing Address
    ...
    string private _name = "NiceApe";
    string private _symbol = "NiceApe";
