...
/**
 * #BFSHIB token features
 * Name : Baby Floki SHIBA
 * symbol : BFSHIB
 * totalSupply : 1,000,000,000,000,000 BFSHIB // 1 Quadrillion
 * Decimals : 9
 * 
 * ###Buy
 * Redistribution to holders : 3%
 * Auto lp : intially zero "0" // can be changed by the owner afterwards
 * Auto Burn : 5%
 * 
 * ###Sell
 ...
 * 
 * ###
 * Marketing fee : 5% //at address 0xd802389806aBc05e5b59Bf41787b5C3f9ebA3E8f
 * Manual Burn // To burn a specific amount of token intially
 * 
 */
...
contract BabyFlokiShiba is Context, IERC20, Ownable {
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
       ...
       // transferToAddressETH(deadAddress, transferredBalance.mul(burnFee).div(100));
    ...
    function setSellFee(uint256 sellTaxFee, uint256 sellLiquidityFee, uint sellBurnFee) external onlyOwner {
    ...
    function setAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee, uint _addressBurnFee) external onlyOwner {
