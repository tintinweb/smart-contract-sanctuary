...
contract Sale is Ownable {
    address public immutable TROO = address(0x5726700604F09a23C0ca629A227EF97BCD55984D); //TROO
    ...
    function deposit() public payable {
        ...
        uint256 balance = IERC20(TROO).balanceOf(address(this));
        require(balance >= 1, "Not enough TROO in contract");

        IERC20(TROO).transfer(msg.sender, 1);
