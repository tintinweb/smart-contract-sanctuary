...
/**
   ...
   Welcome to SHIBAGAMING
   
   This is a community token. If you want to create a telegram I suggest to name it to @SHIBAGAMINGBSC
   ...
   I will renounce the ownership to burn addresses to transfer #SHIBAGAMING
   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #SHIBAGAMING 10000X? 
   ...
   it's the best part of the #SHIBAGAMING idea, increasing the liquidity pool automatically, 
...
contract SHIBAGAMING is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBAGAMING";
    string private _symbol = "SHIBAGAMING";
