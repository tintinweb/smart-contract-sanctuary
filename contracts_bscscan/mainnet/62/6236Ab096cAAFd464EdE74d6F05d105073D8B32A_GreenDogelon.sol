...
contract GreenDogelon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GreenDogelon";
    string constant _symbol = "GREEN DOGELON";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x79df6b5eAee65d0e2aACFAa84AD41a754FcFF404;
