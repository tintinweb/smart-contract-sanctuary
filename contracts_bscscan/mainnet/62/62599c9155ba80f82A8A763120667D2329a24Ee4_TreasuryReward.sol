...
contract TreasuryReward is Ownable {
    ...
    function voteLuckyAccount() public {
        require(block.timestamp > LaunchTime + LaunchPeriod * DAY2SEC, "Not yet finished the minting");
    ...
    function isLive() public view returns(bool) {
        bool bLive;
        if(block.timestamp > LaunchTime + LaunchPeriod * DAY2SEC && luckyAccounts.length < MAX_LUCKY_COUNTS)
            bLive = true;
        return bLive;
    }
