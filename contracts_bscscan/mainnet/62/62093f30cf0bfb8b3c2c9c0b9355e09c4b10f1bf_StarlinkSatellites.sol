...
// CHANGE
contract StarlinkSatellites is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "1469 Starlink Satellites";
    string constant _symbol = "1469";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // 1% MAX 100,000
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 5% MAX 300,000
    ...
    uint256 devFee = 9; // 9%
    uint256 totalFee = 13; // liquidityFee + reflectionFee + devFee
