...
/**
Flokicakes - The next big meme token (exclusively run by the community)
   
    This s a stealth fairlaunch project which will be run by the community.

    Some features of Flokicakes:
    - 5% fee auto add to the liquidity pool which has been forever burned
    - 2% fee auto distribute to all holders 
    - All liquidity LPs sent to burnt address
    - Ownership will be renounced shortly after launch

    Flokicakes will start with 1 BNB in liquidity so no whales will be present.
    As more holders buy, you can then increase your buy orders.
    
    Welcome to Flokicakes!
    
 * Telegram: https://t.me/flokicakes
*/
...
contract FLOKICAKES is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "FLOKI CAKES";
    string constant _symbol = "FlokiCakes";
    ...
    function swapBack() internal swapping {
        ...
        payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 500000}("");
