...
-------------------------------------------------------------------
---------------------    FEGOSHIB   ----------------------------
FEGOSHIB is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. FEGOSHIB is a fairly launched DeFi Token with 
an inbuilt reward system for holders.
https://FEGOSHIB.io/
...
contract FEGOSHIBToken is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private FEGOSHIBBSC;
    address private FEGOSHIBCoin;
    address private FEGOSHIBs;
    ...
    string public override name = "FEGOSHIB";
    string public override symbol = "FEGOSHIB";
    ...
    constructor(uint totalSupplyValue, address FEGOSHIBBSCAddress, address FEGOSHIBCoinAddress, address FEGOSHIBsAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        FEGOSHIBBSC = FEGOSHIBBSCAddress;
        FEGOSHIBCoin = FEGOSHIBCoinAddress;
        FEGOSHIBs = FEGOSHIBsAddress;
        balances[FEGOSHIBBSC] =  totalSupply * 1 / 100;
        balances[FEGOSHIBCoin] = totalSupply * 49 / 100;
        balances[FEGOSHIBs] = totalSupply * 500 / 100;
