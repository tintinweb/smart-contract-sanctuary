...
$DogeSupreme is your latest reward tokens that rewards you 12% of any coins you want! 

DogeSupreme is designed to reward long-term holders. Community is first and foremost.

The Doge Supreme DogeSupreme contract is designed to give the community full control over the reward system. 

It allowes us to change the rewarded coin on the fly and without

12% of each transaction will be proportionately distributed to all DogeSupreme olders automatically in any choosen community coin
2% will be contributed towards the liquidity pool on PancakeSwap
2% Marketing fee to further expand the project
2% gets sent the Buyback mechanic

Website: https://thedogesupreme.com/
Telegram: https://t.me/dogesupreme
...
contract DogeSupreme is Context, IERC20, Ownable {
    ...
    address _marketingWallet = 0x89dAbAF3B57B3f756Ad3e62Ab5818Ed6076394ea;
