...
/**
   ...
   Welcome to Fancy Doge
   
   This is a community token. If you want to create a telegram I suggest to name it to @FancyDogeBsc
   ...
   I will renounce the ownership to burn addresses to transfer #FancyDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #FancyDoge 10000X? 
   ...
   it's the best part of the #FancyDoge idea, increasing the liquidity pool automatically, 
...
contract FancyDoge is Context, IERC20, Ownable {
    ...
    string private _name = "FancyDoge";
    string private _symbol = "FancyDoge";
