...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x5E12bB6DDd9214923d6c837dDF1FfB9c90f18883);
...
contract NanoUp is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "NanoUp";
    string constant _symbol = "NUP";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x5E12bB6DDd9214923d6c837dDF1FfB9c90f18883;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xD558a1acAa132529CEf262E80322b4AE4baFf0D5;
