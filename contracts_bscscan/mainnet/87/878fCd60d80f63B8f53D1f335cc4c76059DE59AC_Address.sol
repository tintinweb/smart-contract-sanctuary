...
/*
   ...
   Tokenomics
   8% fee auto added to the LP every transaction
   2% fee auto distributed to Holders
...
contract GASPA is Context, IERC20, Ownable {
    ...
    string private _name = "GASPA";
    string private _symbol = "GASPA";
    ...
    uint256 private _marketingPercentageOfLiquidity = 33;
    ...
    uint256 public _maxTxAmount = 10000 * 10**6 * 10**9; // Max Transaction: 10B (1%)
    uint256 public _maxWalletToken = 10000 * 10**6 * 10**9; // Max Wallet: 10B (1%)
    uint256 private numTokensSellToAddToLiquidity = 2500 * 10**6 * 10**9; // Liquidity sells 2.5B (0.25%)
