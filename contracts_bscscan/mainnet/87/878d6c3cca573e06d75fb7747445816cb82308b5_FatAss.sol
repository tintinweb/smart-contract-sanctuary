...
contract FatAss is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FAT ASS";
    string constant _symbol = "t.me/FatAssBSC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x681e6e97394C79daC4Fd8e95849585A929aB07d2;  // teamwallet
        lotteryWallet = 0x681e6e97394C79daC4Fd8e95849585A929aB07d2;  // lotterywallet
