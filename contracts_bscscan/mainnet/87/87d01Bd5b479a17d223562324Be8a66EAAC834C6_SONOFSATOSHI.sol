...
contract SONOFSATOSHI is IBEP20, Auth {
    ...
    string constant _name = "Son of Satoshi";
    ...
    uint256 _totalSupply = 21000000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply * 2 / 800; // 52500 tokens per trx
    uint256 public _walletMax = _totalSupply * 1 / 100;   // max wallet 210000 tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS
        autoLiquidityReceiver = 0x5614B0C8dC62C1b600F564e45b180599bb1dCF3f;
        marketingWallet = 0x9E573d975bf486a81cecB17fBE87C225fbb711E6;
