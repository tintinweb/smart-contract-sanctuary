...
/** 
  ...
  // Mystery Fair Launch Monday 11th October 20h00 UTC // MedusADA // Rewards token 
...
contract MedusADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 2500; // 0.4% of supply
    bool inSwap;
