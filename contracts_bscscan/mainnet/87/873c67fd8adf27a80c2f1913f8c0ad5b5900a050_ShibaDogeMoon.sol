...
contract ShibaDogeMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaDogeMoon.com";
    string constant _symbol = "SDM";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 100; // 500 000 tokens per tx to launch 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x4Cf5e0b94725D5D88C5BE1C0B4D83da045b15790;
