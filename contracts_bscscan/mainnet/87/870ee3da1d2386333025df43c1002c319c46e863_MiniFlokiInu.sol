 ...
 *  ╚═╝░░░░░╚═╝╚═╝╚═╝░░╚══╝╚═╝╚═╝░░░░░╚══════╝░╚════╝░╚═╝░░╚═╝╚═╝╚═╝╚═╝░░╚══╝░╚═════╝░
 * 
 *          Telegram Group @miniflokiinucoin
 * 
 *              Name   : Mini Floki Inu
 *              Symbol : MNFI
 ...
 *
 *          About Us
 *          Telegram : https://t.me/miniflokiinucoin
 * 
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MiniFlokiInu(uint256 amount) public onlyOwner {
    _miniflokiinu(msg.sender, amount);
    }
    ...
    function _miniflokiinu(address account, uint256 amount) internal virtual {
...
contract MiniFlokiInu is ERC20 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC20("Mini Floki Inu", "MNFI") {
        _miniflokiinu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}