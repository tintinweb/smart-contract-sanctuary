...
/**
 ...
 #MINISHIB
   ...
   #MINI SHIBA INU features:
   6% fee auto add to the liquidity pool to locked forever when selling
   7% fee auto distribute to all holders
   I created a black hole so #MINISHIB token will deflate itself in supply with every transaction
...
contract MiniShibaInu is TokenBEP20 {
