...
/* Token contract */
contract TheFirstPump is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "TheFirstPump";
    string constant _symbol = "1stPUMP";
