...
contract InspeerToken is BEP20 {
    ...
    // Min amount to liquify. (default 10 INSPs)
    uint256 public minAmountToLiquify = 10 ether;
    // The swap router, modifiable. Will be changed to Insp's router when our own AMM release
    ...
    /**
     * @notice Constructs the InspToken contract.
     */
    ...
    /// @dev overrides transfer function to meet tokenomics of INSP
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        // generate the insp pair path of token -> weth
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Insps (not scaled);
