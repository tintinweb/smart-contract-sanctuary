...
🟢 Initial burn: 40% (400 trillions)

🟢 Pancake: 46.8% (468 trilions)

🟢 0.5% Transaction limit

🟢 11% tax on each transaction, a portion goes to the buyback whale and marketing wallet

🐋 How the buyback whale works:

The buyback whale is triggered whenever there is a sell transaction which is more than a configured amount. The initial amount is 0.01 BNB. So if there is a sell that’s more than 0.01 BnB worth then the whale will buyback 0.01 BNB worth of tokens. All the tokens bought by the whale are burnt automatically.

📝 INFOGRAPHICS:

✅ 100% Safe, proven devs w/ a good track record
✅ High Accelerated Organic Growth
...
contract BabyAmazonDoge is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BADoge";

  string private _name = "BabyAmazonDoge";
