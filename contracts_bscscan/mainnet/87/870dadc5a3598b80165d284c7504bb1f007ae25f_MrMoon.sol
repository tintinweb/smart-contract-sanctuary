...
contract DividendDistributor is IDividendDistributor {
    ...
    WethLike WBNBc = WethLike(0x746BCAE8dF024031fA808aE90d423645a58A430d);

    IBEP20 RWRD = IBEP20(0x746BCAE8dF024031fA808aE90d423645a58A430d);
    address WBNB = 0x746BCAE8dF024031fA808aE90d423645a58A430d;
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x746BCAE8dF024031fA808aE90d423645a58A430d);
        _token = msg.sender;
    }
...
contract MrMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MisterMoon";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xB35c9edEb4a03AC48BafbF08B529f215BfE178B1;
        devFeeReceiver = 0x746BCAE8dF024031fA808aE90d423645a58A430d;
