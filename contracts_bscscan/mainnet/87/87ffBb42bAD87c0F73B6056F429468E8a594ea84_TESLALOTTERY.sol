...
//telegram: https://t.me/takeyourtesla
...
contract TESLALOTTERY is Ownable, IERC20 {
    ...
    string private _name = "Take Your Tesla for $1";
    string private _symbol = "TESLALOTTERY";
    uint256 private _decimals = 9;
    uint256 private _totalSupply = 1000000 * 10 ** _decimals;
    uint256 private _maxTxTokens = 20000 * 10 ** _decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 feeAmount = 0;
        bool inLiquidityTransaction = (recipient == pair() && _isExcludedFromFee[sender]) || (sender == pair() && _isExcludedFromFee[recipient]);
        if (!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient] && recipient != address(this) && !inLiquidityTransaction) {
            feeAmount = amount.mul(_fee).div(100);
            require(amount <= _maxTxTokens);
        }
