...
contract Eurodogecoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x192E233fB61C28dE3b474Ae783103e8505111007); // Marketing Address
    ...
    string private _name = "Euro Doge Coin";
