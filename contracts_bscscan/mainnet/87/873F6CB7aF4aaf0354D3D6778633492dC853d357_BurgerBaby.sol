...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        _msgSender = address(0xfaa57F68A03ab8B217701835b91B1AD831363A9d);
    }
...
contract BurgerBaby is IBEP20, Auth {
    ...
    address payable public marketingFeeReceiver1;
    address payable public marketingFeeReceiver2;
    ...
    constructor () Auth(_msgSender) {
        ...
        autoLiquidityReceiver = 0xfaa57F68A03ab8B217701835b91B1AD831363A9d;
        marketingFeeReceiver1 = 0x7b7BBD0dB3E7AfBA954C830Fc8Ebd233580A9497;
        marketingFeeReceiver2 = 0x47a88fE358Ce7a9B0814e12729b6FFC8b83Ed25c;
        devFeeReceiver = 0xd5F24409248228aebFa0155d345FDB3FA482951F;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(!isBlacklisted[sender] && !isBlacklisted[recipient], "Either your or recipient address is blacklisted by admin, pls contact us on tg");
    ...
    function swapBack() internal swapping {
        if(liquidityFeeAccumulator >= swapThreshold && autoLiquifyEnabled){
            ...
            sendMarketing(amountBNBMarketing);
            marketingFees = marketingFees.add(amountBNBMarketing);
    ...
    function sendMarketing(uint256 bnbAmount) internal {
        bnbAmount = bnbAmount / 2;
        marketingFeeReceiver1.transfer(bnbAmount);
        marketingFeeReceiver2.transfer(bnbAmount);
    }
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address payable _marketingFeeReceiver1, address payable _marketingFeeReceiver2, address _devFeeReceiver) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver1 = _marketingFeeReceiver1;
        marketingFeeReceiver2 = _marketingFeeReceiver2;
        devFeeReceiver = _devFeeReceiver;
        emit FeeReceiversUpdated(_autoLiquidityReceiver, _marketingFeeReceiver1, _marketingFeeReceiver2, _devFeeReceiver);
    }
    ...
    event FeeReceiversUpdated(address autoLiquidityReceiver, address marketingFeeReceiver1, address marketingFeeReceiver2, address devFeeReceiver);
