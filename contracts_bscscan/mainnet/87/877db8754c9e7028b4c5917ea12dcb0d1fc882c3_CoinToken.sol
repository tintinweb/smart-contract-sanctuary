...
/**
 *Submitted for verification at hecoinfo.com on 2021-08-01
*/

/**
 *Submitted for verification at hecoinfo.com on 2021-07-20
*/

// SPDX-License-Identifier: AzureDragon
/**
 *Submitted for verification at hecoinfo.com on 2021-07-23
*/

/**
   # Azure Dragontoken
   
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #AD  

    I make this #Azure Dragon to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create:https://0.plus/KuMFZ4FjZjk1

   Great features:
   5% fee auto add to the liquidity pool to locked forever when selling
   6% fee auto distribute to all holders
   5% For the Fund for Protection Fund ➕ prize pool activities
   40% burn to the black hole, with such big black hole and 3% fee, the strong holder will get a valuable reward
   ...
   Can you make #Azure Dragon 100X? 
   ...
   it's the best part of the #AD idea, increasing the liquidity pool automatically, 
...
contract CoinToken is Context, IBEP20, Ownable {
    ...
    uint256 private _MAX = ~uint256(1000000000000);
