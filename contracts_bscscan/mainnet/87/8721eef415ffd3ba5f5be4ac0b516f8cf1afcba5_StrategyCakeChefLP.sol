...
// File: contracts\interfaces\pancake\IMasterChef.sol
...
// File: contracts\pools\ALU-BNB\Common\StratManager.sol
...
// File: contracts\pools\ALU-BNB\Common\FeeManager.sol
...
abstract contract FeeManager is StratManager {
    ...
    uint public plutusFee = MAX_FEE - STRATEGIST_FEE - callFee;

    function setCallFee(uint256 _fee) external onlyManager {
        require(_fee <= MAX_CALL_FEE, "!cap");
        
        callFee = _fee;
        plutusFee = MAX_FEE - STRATEGIST_FEE - callFee;
    }
...
// File: contracts\pools\ALU-BNB\Common\StrategyCommonChefLP.sol
...
// File: contracts\pools\ALU-BNB\StrategyCakeChefLP.sol
