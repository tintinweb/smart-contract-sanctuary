...
*
* Hold and claim Dogecoin(Doge)
*
* A max wallet will need 10 hours to dump
*
* TG: t.me/bscNanoDoge
* 
*/
...
contract NanoDoge is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'NanoDoge';
    string private constant _symbol = 'NanoDoge';
    ...
    address public constant TeamWallet=0x691AD6573425E8fDC0f7605f862719f6Bc7e70dE;
    ...
    function claimDOGE(address addr) private{
        ...
        path[1] = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;  //Binance-Peg Dogecoin
