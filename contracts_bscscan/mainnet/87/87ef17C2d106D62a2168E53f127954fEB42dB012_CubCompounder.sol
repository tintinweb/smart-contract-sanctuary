...
contract CubCompounder is Ownable, ReentrancyGuard, Pausable {
    // Maximize yield in Cub Finance: https://cubdefi.com
    // Fork of AUTO StratX contract, https://bscscan.com/address/0x65168c89a16fbed4e2e418d5245ff626bd66874b#code, modified for CUB Compounding
    ...
    address public CUBAddress; // cub token address
    ...
    constructor(
        ...
        uint256 _pid,
        address _wantAddress, // CUB-WBNB pancakeswap pool
        address _token0Address, // CUB (or some other token)
        ...
        earnedToCUBPath = [earnedAddress, wbnbAddress, CUBAddress];
        if (wbnbAddress == earnedAddress) {
            earnedToCUBPath = [wbnbAddress, CUBAddress];
        }
