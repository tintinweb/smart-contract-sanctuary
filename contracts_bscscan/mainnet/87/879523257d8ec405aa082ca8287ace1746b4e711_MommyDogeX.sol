...
MommyDogeX | Launching in Now! 
Hi there guys ! Today I will be bringing attention 
to a brand new project that I have come acrross! It is called 
MommyDogeX and for me it ticks all the boxes and things I look 
for when researching and investing into a new project!
...
MommyDogeX Tokenomics

MommyDogeX is a hyper-deflationary token, all holders will be rewarded for holding tokens via static reflection.
...
contract MommyDogeX is Context, ERC20Detailed, Ownable {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "MommyDogeX";
  string constant tokenSymbol = "MommyDogeX";
