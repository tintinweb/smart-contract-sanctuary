...
Please Do your own Telegram and logo !
liquidty will be locked for 7 days , will be extended to 3 months once crossed 500k mcap
Legit dev, this is an opprtunity for whoever miss Shibx
Ill be paying for marketing , and cmc listing if community hold .
Let's do it guys 
We reach 1 million mcap , dev will be with you in the chat and voice chat 
...
contract ShibXX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibXX";
    string constant _symbol = "$ShibXX";
