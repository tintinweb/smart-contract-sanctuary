...
Sushi Traveller  (SUSHIT)  is a community based meme token. 

Telegram: t.me/SushiTraveller
Website: SushiTraveller.com
...
contract Sushitraveller is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sushi Traveller";
    string constant _symbol = "SUSHIT";
