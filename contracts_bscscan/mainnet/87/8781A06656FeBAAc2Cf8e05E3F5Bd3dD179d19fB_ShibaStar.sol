...
/**
Welcome to ShibaStar
   
   This is a community token. If you want to create a telegram I suggest to name it to @ShibaStar
   ...
   I will renounce the ownership to burn addresses to transfer #ShibaStar to the community, make sure it's 100% safe.

   I will add 2.0 BNB and all the left 10% total supply to the pool
   Can you make #ShibaStar 10000X? 
   ...
   it's the best part of the #ShibaStar idea, increasing the liquidity pool automatically, 
...
contract ShibaStar is Context, IBEP20, Ownable {
    ...
    // to receive BNB from uniswapV2Router
    ...
    function _transfer(
        ...
        */
        ...
        bool takeFee = true;
        // if sender or recipient is excluded, remove the fee
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            takeFee = false;
        }
        
        // initiate transfer, it will take tax & liquidity fee
