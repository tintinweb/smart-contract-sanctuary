...
/*
  ...
  Welcome to GaMeRshiba
   
   This is a community token. If you want to create a telegram I suggest to name it to @GMRshiba
   ...
   I will renounce the ownership to burn addresses to transfer #GMRshiba to the community, make sure it's 100% safe.
   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #GMRshiba 10000X? 
...
contract GamerShiba is Context, IBEP20, Ownable {
    ...
    string private constant _symbol   = "GMRshiba";
