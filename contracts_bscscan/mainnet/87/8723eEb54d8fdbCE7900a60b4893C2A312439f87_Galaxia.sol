...
// Galaxia with Governance.
contract Galaxia is BEP20("Galaxia", "GLX") {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying GLXs (not scaled);
