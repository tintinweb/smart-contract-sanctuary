...
contract CheemsDad is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable private marketingAddress =
        payable(0x1ECB681e032BDd56F6A9Ad79Af9Da0c228498211); // Marketing Address
        
    address payable private teamAddress =
        payable(0x1ECB681e032BDd56F6A9Ad79Af9Da0c228498211); // Team Address
        
    address payable private liquidityAddress =
        payable(0x1ECB681e032BDd56F6A9Ad79Af9Da0c228498211); // Liquidity Address
    ...
    string private constant _name = "CheemsDad";
    string private constant _symbol = "CheemsDad";
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 99, "Must keep taxes below 99%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 99, "Must keep taxes below 99%");
