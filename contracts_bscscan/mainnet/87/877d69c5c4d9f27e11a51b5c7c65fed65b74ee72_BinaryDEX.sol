...
interface IERC20 {
    ...
    /**
     * @dev Mgoves `amount` tokens from `sender` to `recipient` using the
...
// File: contracts/binarydex.sol


pragma solidity ^0.8.0;

contract BinaryDEX is ERC20, Ownable {
    ...
    constructor() ERC20("BinaryDEX", "BDX") {
