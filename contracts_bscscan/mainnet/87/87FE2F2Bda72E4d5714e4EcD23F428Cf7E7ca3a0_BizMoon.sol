...
contract Context {
 ...
 contract BizMoon is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private superfloSYLOM;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "BizMoon";
    string private _symbol = "BIZMOON";
    ...
    address private _MarketingWalletSYLOM = 0x67d4F1712F39D6cDbF9b2C3A1F2728E7E2C29FB5;
