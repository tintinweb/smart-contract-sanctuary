...
contract test is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x8F5C94abBf3F5D00a781b897309dACD4eE7B2572;
    address public _liqWallet = 0xF932d3D4578f0eA500A3511b702Eb711578082f0;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "test: The PanADASwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 ADAtokens = contractTokenBalance.mul(7).div(totalFees);
            swapAndSendToFee(ADAtokens);

            uint256 swapTokens = contractTokenBalance.mul(10).div(totalFees);
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(ADA).transfer(_marketingWalletAddress, newBalance.mul(7).div(10));
        IERC20(ADA).transfer(_liqWallet, newBalance.mul(3).div(10));
    }
