...
/**
 ...
 Hodl $xADA and get ADA automatically in your wallet every hour or so!
 ...
 Buy Slippage: 13-15% (15% should be OK)
...
// CHANGE
contract xADA is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "xADA";
    string constant _symbol = "xADA";
    ...
    uint256 public _sellMultiplier = 3; // Change this to 2 for 2X or 3 for 3X (Max)
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x01255f9a37d65E4aD8f28c11d223a3239Fb044D7);
