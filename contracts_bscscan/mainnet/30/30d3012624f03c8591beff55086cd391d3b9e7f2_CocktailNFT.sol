...
// File contracts/CocktailNFT.sol
...
contract CocktailNFT is ERC721, OwnableAndWhitelistble {
    ...
    constructor() ERC721(_name, _symbol) {
        ...
        // setSpecialCocktailInfo('Gold', 5, 10, 10000, 0);
        // setSpecialCocktailInfo('Silver', 5, 10, 10000, 0);
        // setSpecialCocktailInfo('Bronze', 5, 10, 10000, 0);
    ...
    function mintCustom(
        ...
        for (uint256 i = 0; i < amount; i++) {
            ...
            if (randomSpecial > specialCocktailsInfo[rarity].numenator) {
                ...
                console.log('Len:', defaultCocktails[rarity].length);
                console.log('RND:', randomIndex);
                ...
                console.log('Len:', specialCocktails[rarity].length);
                console.log('RND:', randomIndex);
