...
TWITTER - https://twitter.com/getADAhereBSC

TELEGRAM - https://t.me/getADAhere
...
contract getADAhere is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "getADAhere";
    string constant _symbol = "GADAH";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 250;
...
/* if you see this dm a mod ''PingMeDaddy''*/ 
