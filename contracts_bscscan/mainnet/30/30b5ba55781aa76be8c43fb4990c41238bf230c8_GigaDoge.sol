...
contract maxBuy is Ownable {
  event maxBuyOn();
  event maxBuyOff();
  bool public special = false;
  modifier ifMaxBuyOff() {
    require(!special);
    _;
  }
  modifier ifMaxBuyOn() {
  ...
  function TurnMaxBuyOn() onlyOwner ifMaxBuyOff public {
    special = true;
    emit maxBuyOn();
  }
  function TurnMaxBuyOff() onlyOwner ifMaxBuyOn public {
    special = false;
    emit maxBuyOff();
  }
}
...
contract GigaDoge is Context, IERC20, Ownable, maxBuy  {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x32ad9072376e05a135b43c3E2B123dD819E6E53d); // Marketing Address
    ...
    string private _name = "GIGA DOGE";
    string private _symbol = "GIGADOGE";
