...
/**
 * 
BNB PAD IS THE FIRST DECENTRALIZED & BINANCE CHAIN IDO LAUNCH PAD, WHERE ONLY HIGHLY VETTED PROJECTS TRADE


BNB PAD Requires investors to hold x numbers of BNBPAD COINS to Be eligible for IDO listing on our platform. 


We reward HOLDERS with 5% BNB on Every buy and 10% BNB on every sell. 
*/
...
contract BNBPAD is Context, IERC20, Ownable {
