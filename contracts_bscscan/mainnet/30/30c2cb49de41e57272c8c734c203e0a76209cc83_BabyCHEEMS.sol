...
/**
Baby CHEEMS
https://t.me/BabyCheemsBSC

A Play by @DetectiveBSCApeLounge

A degen, ape, moonshot play brought to you by @DetectiveBSCApeLounge

High risk, High reward. Not an investment, just a safe place for apes and degens.

Fair launch + Anti Snipe. Liq will be locked for 3 days. Extend at 100k MC
...
/* Token contract */
contract BabyCHEEMS is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x245dC0f1983A416684A7f396496Cabcb7A1e67ab;
    ...
    // Name and symbol
    string constant _name = "BabyCHEEMS";
    string constant _symbol = "BabyCHEEMS";
    ...
    uint256 public _maxWalletToken = _totalSupply * 200 / 10000; // 5% or 5m tokens
