...
contract ExitLandGameSmallMedium {
    ...
    uint256 MAX_PLAYER=10000;
    uint256 PRICE_GWEI=55900000;
    uint256 PRICE_NO_FEE_GWEI=50000000;
    ...
    function joinGame() public payable {
        ...
        require(msg.value == PRICE_GWEI * 10 ** 9, "You need to send only 0.109 BNB.");
