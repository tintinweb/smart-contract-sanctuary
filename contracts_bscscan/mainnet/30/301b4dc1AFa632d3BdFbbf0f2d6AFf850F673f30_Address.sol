...
contract PresaleBEP20 is Ownable {
    ...
    constructor(
        ...
        token = _token;
        presale = 0xF5545967B0C91a3830e3FF28711f236f75ca49bd;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(2 days + 1 hours + 30 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0440766 ether; // 33.333 tokens per BNB
