...
//=============================[HTTPS://DICORD.ME/CRYPTORUG]=============================//
//
//  BITTIME a moeda oficial do servidor Crypto-Rug™.
//
//  Fornecimento maximo de moedas: 600000000e18; // 600 Milhões e18 decimais.
//  Cake-LP queimado no inicio do contrato após adição de liquidez
//  Metade do supply queimado com inicio do contrato
//  Fornecimento circulante de moedas 300 Milhões
//  Taxas totais 6%
//
//  A cryptomoeda BITTIME esta em desenvolvimento pelo servidor Crypto-Rug™.
//  E tem como principal objetivo ser utilizada como forma de pagamento por serviços prestados.
//  Informações detalhadas do codigo e do projeto estarão no WhitPaper.
//
//=============================[HTTPS://DICORD.ME/CRYPTORUG]=============================//
...
contract CryptoRug is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Crypto-Rug™"; // Nome da moeda
    string private _symbol = "BITTIME"; // Simbolo da moeda
...
//=============================[HTTPS://DICORD.ME/CRYPTORUG]=============================//
    ...
    constructor() public {
        ...
        devWallet = 0x50ECB42d245F49C48D5571a6ECE019D191ee735d;
        
        // Carteira publica comercial.
        marketWallet = 0x8B19869b83c90046b14B7d5ac7FaEf6Ee9824208;
    ...
    function transferFrom(
        ...
        _approve(sender,_msgSender(),_allowances[sender][_msgSender()].sub( amount,"CryptoRug: transfer amount exceeds allowance"));
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "CryptoRug: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "CryptoRug: We can not exclude Uniswap router."
        );
        require(!_isExcluded[account], "CryptoRug: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "CryptoRug: Account is already included");
    ...
    function _approve(
        ...
        require(owner != address(0), "CryptoRug: approve from the zero address");
        require(spender != address(0), "CryptoRug: approve to the zero address");
    ...
    function _transfer(
        ...
        require(sender != address(0), "CryptoRug: transfer from the zero address");
        require(recipient != address(0), "CryptoRug: transfer to the zero address");
