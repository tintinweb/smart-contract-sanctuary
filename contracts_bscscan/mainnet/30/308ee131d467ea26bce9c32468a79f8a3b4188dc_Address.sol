...
contract Orica is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingAddress = payable(0xBb8aF55f57809288b0FeCF93827538F659aaFbFf); // Marketing Address
    ...
    string private _name = "Orica NFT";
    string private _symbol = "ORICANFT";
