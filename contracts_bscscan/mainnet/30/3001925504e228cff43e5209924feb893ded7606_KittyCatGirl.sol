...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 BabyWhale = IBEP20(0x61C04950d3c14947e223c32eCDf76326ff542949); // doge address (changable to any)
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = BabyWhale.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(BabyWhale);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = BabyWhale.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           BabyWhale.transfer(shareholder, amount);
...
contract KittyCatGirl is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BabyWhale = 0x61C04950d3c14947e223c32eCDf76326ff542949; // doge address (changeable to any)
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "KittyCatGirl";
   string constant _symbol = "KTYGRL";
...
uint256 reflectionFee = 400;
   ...
   uint256 public swapThreshold = _totalSupply / 1000; // 0.025%
   bool inSwap;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xBfC6ebf29D7102D26A32e22e30F21B1D26F50E75;
