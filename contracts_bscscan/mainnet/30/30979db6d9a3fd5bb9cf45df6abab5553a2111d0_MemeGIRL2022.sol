...
contract MemeGIRL2022 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MemeGIRL2022";
    string private _symbol = "New Wife";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2e2EcEc982040Cf157DFA537416Ad7bdD671242c); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x2e2EcEc982040Cf157DFA537416Ad7bdD671242c); // buyback Address
