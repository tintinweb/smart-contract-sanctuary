...
/**
                                      ...
                                      Welcome to Crypto King ElON ($KINGELON)


Telegram: https://t.me/CryptoKingElon
...
Crypto King ElON is built by strong team of crypto experts that aim to build a sustainable token, devs are always active 24/7 in chat, and in call to answer any and every single question!

Check out $KINGELON right now, get in while it's still cheap to do so, right before we get to the moon, HODL and enjoy it !
...
contract CryptoKingElon is Context, ERC20Detailed, Ownable {
  ...
  string constant tokenName = "Crypto King Elon";
  string constant tokenSymbol = "King Elon";
