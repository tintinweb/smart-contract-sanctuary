...
/**
DEFIDOCOIN - Coinbase-pet-based meme token
            __
(\,--------'()'--o
 (_    ___    /~"
  (_)_)  (_)_)

DEFIDO TO THE THE MOON
https://t.me/DeFidoCoinOfficial
*/
...
contract DefidoCoin is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        _symbol = 'DeFido';
        _decimals = 9;
        uint256 amountOfTokenWei = 100000000000000000;
        _tTotal = amountOfTokenWei;
        _rTotal = (MAX - (MAX % _tTotal));
        address tokenOwner = 0x6dc3eAFEfF455c0B6cdf47e1F9471EE1e8ab40c8;
