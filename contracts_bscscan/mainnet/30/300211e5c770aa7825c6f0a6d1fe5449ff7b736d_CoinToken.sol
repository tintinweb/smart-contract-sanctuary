...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee,uint256 _lpFee,address routerAddress,address tokenOwner) public {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
       ...
       // _maxTxAmount = _MAXAMOUNT * 10 ** _decimals;
        ...
        _maxTxAmount = 300000000000000000000000000;
        numTokensSellToAddToLiquidity = 210000000000000000000000;
