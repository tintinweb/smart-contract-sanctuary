...
/**
 ...
 TG link: https://t.me/fuckcaesarlol
...
Caesar is a captain shitbird who charges people thousands of dollars for a call, and sits on his lazy ass making upwards
 of tens of thousands of dollars a day for telling people to buy tokens that suck half the time anyway. 
He buys into tokens early and calls on them after to profit off his investors, because making 7BNB for the three minutes 
it takes to write a call isn't enough?
It's time this abomination in the BSC space comes to a halt and everybody stops sucking his dick, 
let's launch one for the people, shall we?
...
contract FuckCaesar is Context, IERC20, Ownable {
    ...
    string private _name = "Fuck Caesar";
    string private _symbol = "FUCKCAESARLOL";
