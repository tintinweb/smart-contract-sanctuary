...
contract NFTFactoryV2 is Ownable {
     ...
     */
    function setBunny(uint8 bunnyId,string calldata _bunnyJson
    ) external onlyOwner {
     ...
     * Only the owner can set it.
     */
    function setBunnyNames(uint8 bunnyId,
     ...
     * Only the owner can set it.
     */
    function updateTokenPrice(uint8 bunnyId, uint256 _newTokenPrice) external onlyOwner {
