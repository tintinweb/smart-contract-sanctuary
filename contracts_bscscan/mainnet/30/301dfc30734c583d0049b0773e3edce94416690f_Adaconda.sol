...
// CHANGE
contract Adaconda is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Adaconda";
    string constant _symbol = "Adaconda";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 3% MAX 40,000,000
