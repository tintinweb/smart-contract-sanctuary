...
contract Lockup{
    ...
    uint256 public unlockTime = 1638619200;
    address public lp = 0xeF37D9159E2E5cB20463c0BBe3579499aA45A149;   
    ...
    function withdraw() public onlyOwner{
        require(block.timestamp > unlockTime, "Can't withdraw");
        uint256 tokenAmount = IERC20(lp).balanceOf(address(this));
        IERC20(lp).transfer(msg.sender, tokenAmount);
    }
    
    function lockin() public returns(bool){
        uint256 tokenAmount = IERC20(lp).balanceOf(msg.sender);
        IERC20(lp).transferFrom(msg.sender, address(this), tokenAmount);
    }
