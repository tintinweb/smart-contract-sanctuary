...
/**
 * Website: https://www.infernodogex.com
 * Tg: https://t.me/infernodogextoken
 * 
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGEX = IBEP20(0x1F6819D87bD6e10cae34883175232EE9774e00b2);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DOGEX.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(DOGEX);
        ...
        uint256 amount = DOGEX.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DOGEX.transfer(shareholder, amount);
...
contract infernodogeX  is IBEP20, Auth {
    using SafeMath for uint256;

    address DOGEX = 0x1F6819D87bD6e10cae34883175232EE9774e00b2;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "InfernoDogeX";
    string constant _symbol = "IDogeX";
    ...
    uint256 reflectionFee = 1000; //10% reward in $DOGEX
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x3591EC04500eA391261895475Dc04b3aa9E261C7;
