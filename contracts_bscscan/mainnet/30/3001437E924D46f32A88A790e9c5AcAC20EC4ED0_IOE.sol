...
contract IOE is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x3a14F8EfC456759D6d5FA6eBf38e7a3a240F0205;
	
	address private _burnWalletAddress = 0x000000000000000000000000000000000000dEaD;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10500000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Internet Of Everything";
    string private _symbol = "IOE";
	...
	uint256 private numTokensBurn = 9950000 * 10**9;
