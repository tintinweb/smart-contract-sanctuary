...
contract parallel is Operator {
    ...
    string private _name = "parallel";//#币名
    string private _symbol = "parallel";//#币简称
    ...
    constructor () public {
        ...
        setWhiteList(address(0xba259759254b5D3B21EC8f677bB7347d37042395),true);
    }
