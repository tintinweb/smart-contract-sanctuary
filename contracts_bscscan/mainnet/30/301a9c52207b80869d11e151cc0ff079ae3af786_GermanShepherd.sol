...
https://t.me/GermanShepherdToken
...
// CHANGE
contract GermanShepherd is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "GermanShepherd";
    string constant _symbol = "GermanShepherd";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // Max 2% 20,000,000
    ...
    constructor () {
        ...
        shillFeeReceiver = address(0x5Bfe25C2395105091EC20dbf8aD9aB0E45AE3531);
