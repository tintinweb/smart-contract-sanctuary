...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC80402F3134bfC74f35560637acb37b1373A3ba9;
...
contract AXOLIUM is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x23cbe97D118Be8F72830677936C103b2a8eE885f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "AXOLIUM";
    string private _symbol = "AXOLIUM";
