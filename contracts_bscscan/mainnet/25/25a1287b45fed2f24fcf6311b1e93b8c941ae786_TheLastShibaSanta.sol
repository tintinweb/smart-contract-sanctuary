...
contract TheLastShibaSanta is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x294e7E477b54457ae8D5aeCAA6984bBB5494AAcD); // Marketing Address
    ...
    string private _name = "TheLastSHibaSanta";
    string private _symbol = "TheLastShibaSanta";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**9 * 10**9; // 10 trillion, or 1% of total supply
    uint256 private minimumTokensBeforeSwap = 2500000 * 10**9 * 10**9; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 10000000 * 10**9 * 10**9;
    }
