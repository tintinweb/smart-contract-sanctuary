...
/**
 *
  Official Trust Shiba Inu Binance Smart Chain Token
  
  
  We are occupy to the moon with Trust Shiba Inu. Would you like to come with us?
...
contract TRUSTSHIBA is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "TRUST SHIBA INU";
  string private _name = "Trust Shiba Inu";
