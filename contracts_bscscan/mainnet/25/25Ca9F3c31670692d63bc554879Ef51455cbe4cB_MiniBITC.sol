...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TOKEN = IBEP20(0xDeb9e5D630CEa02cf83258aAf5bAD933F7a43AE7);
...
contract MiniBITC is IBEP20, Auth {
    using SafeMath for uint256;

    address TOKEN = 0xDeb9e5D630CEa02cf83258aAf5bAD933F7a43AE7;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MINIBITC";
    string constant _symbol = "MBITC";
