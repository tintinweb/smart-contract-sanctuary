...
contract BiswapByalanLP is ByalanIsland, Sailor, GasThrottler, IByalan, ReentrancyGuard {
    ...
    function chargeFees() internal nonReentrant {
        ...
        uint256 callFeeAmount = (bnbBal * callFee) / MAX_FEE;
        ...
        uint256 kswFeeAmount = (bnbBal * kswFee) / MAX_FEE;
    ...
    function balanceOfMasterChef() public view override returns (uint256) {
