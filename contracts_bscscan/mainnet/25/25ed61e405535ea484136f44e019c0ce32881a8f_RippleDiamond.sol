...
/**
   ...
   Welcome to RippleDiamond
   
   This is a community token. If you want to create a telegram I suggest to name it to @RippleDiamond
...
contract RippleDiamond is Context, IERC20, Ownable {
    ...
    string private _name = "Ripple Diamond";
