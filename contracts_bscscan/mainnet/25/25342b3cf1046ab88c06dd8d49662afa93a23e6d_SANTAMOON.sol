 ...
 *
 * 
 * Santamoon collects funds to rewards it's holders for christmas
   
     #SANTAMOON features:
   3% fee auto distribute to all holders
   7% Marketingwallet to fund marketing activities, CEX listings, Providing LP
   No team or dev wallet
   
   Telegram channel: https://t.me/SantaMoon_BSC
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x980864382183a9bA4B5fa1E13740496C64ac4a93;
...
contract SANTAMOON is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x210bC6A715f7f58303B6DfFc42D0EFc089849cA0;
    ...
    string private _symbol = "SANTAMOON";
