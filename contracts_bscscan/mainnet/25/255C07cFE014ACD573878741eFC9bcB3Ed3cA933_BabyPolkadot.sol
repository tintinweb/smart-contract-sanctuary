...
/**
   ...
   Welcome to BabyPolkadot
   
   This is a community token. If you want to create a telegram I suggest to name it to @BabyPolkadot
...
contract BabyPolkadot is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Polkadot";
    string private _symbol = "BabyPol";
