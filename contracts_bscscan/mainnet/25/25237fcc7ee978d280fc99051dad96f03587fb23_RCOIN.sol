...
* 
* 
* Suoer Fuckin Stealth Launch
* 
* 30 min cooldown between sells to prevent jeets from dumping
* Will remove it at the 1 hour mark
...
//RAUNCHYDOGE Contract /////////////

contract RCOIN is IBEP20, Ownable
{
    ...
    address public constant TeamWallet=0xEd6A9e12a104ffB74B7C488D247AA58C6ACD407E;
	...
	uint256 private antiDump = 100 * 10**_decimals;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;  //DOGECOIN
