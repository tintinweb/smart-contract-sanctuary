...
/**
  ...
  * BLEUFI INU
  * TOKENOMICS
  * BLEUFI INU IS A COMMUNITY DRIVEN PROJECT WITH
  * LOW MARKETCAP,
  * LIQUIDITY LOCKED.
  * 100 % LEGIT PROJECT
  * JUST NORMAL PEOPLE TRYING TO MAKE A SUCCESSFULL CRYPTOCURRENCY.
  * SO JOIN US AND BE THE PART OF A SUCCESSFUL PROJECT.
  * TELEGRAM: T.ME/BleuFiInu
  * REDDIT:u/bleufiinu
  * 50% BURN - 47% LIQUIDITY - 3% MARKETING WALLET
  * NO DEV WALLET
*/
...
contract BLEUFIINU is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BLEUFI INU";
    string constant _symbol = "BUFI";
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 2 >= block.number){ return feeDenominator.sub(2); }
