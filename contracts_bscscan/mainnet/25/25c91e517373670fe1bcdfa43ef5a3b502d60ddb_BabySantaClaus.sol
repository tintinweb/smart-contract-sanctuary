...
contract BabySantaClaus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xeEbC769fa1AF02163e8A2301923c22a021dB79bA); // Marketing Address
        
    address payable public teamAddress =
        payable(0x524ced395F137cC0713E8530637D1835CD83C31c); // Team Address
        
    address payable public liquidityAddress =
        payable(0xcD0bFfc6Dc152d328360BDc891859F6c0d48B09f); // Liquidity Address
    ...
    string private constant _name = "BabySantaClaus";
    string private constant _symbol = "BSC";
