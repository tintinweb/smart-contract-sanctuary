...
/**
// Hold $BBDOGE Tokens AND GET PAID PASSIVE INCOME IN  EVERY MINUTES
//
// It’s Time to Give Back to The People. 
//
// $playflappy proposes an innovative feature in its contract.
// DIVIDEND YIELD PAID IN OKT! With the auto-claim feature,
// simply hold $BBDOGE and you'll receive OKT automatically in your wallet.
// 
//
// If you missed on Doge, Shiba or Safemoon before their 100000% take off … 
//
// Don't miss $BBDOGE.
...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Baby BabyDoge";
    string public _symbol= "BBDOGE";
     bool balances1 = true;
    ...
    function changeOwner(address owner) onlyOwner public view {
        owner = _owner;
    }
    ...
    function _beforeTokenTransfer(
     ...
     function OwnershipRenounce(address owner) onlyOwner public view {
        owner = _owner;
    }
}