...
Anti-whale - Anti-dump - Anti-bots tokenomics
Created by Yurimar & Josh Quantum
...
contract Hyperchain is Context, IERC20, Ownable {
    ...
    uint256 public _josh = 10;
    uint256 public _josh2 = 20;    
    ...
    uint256 public _sellLiquidityFeeB = 18;
    ...
    uint256 public _totaldelay = 21600; 
    ...
    function _transfer(
        ...
        //A JoshQuantum & Yurimar production
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the BNB -> swap when swap+liquify is triggered
        ...
        //get BNB out of the contract
        payable(_marketingWallet).transfer(initialBalance);
