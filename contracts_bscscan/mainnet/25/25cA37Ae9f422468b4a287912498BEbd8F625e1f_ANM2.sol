...
contract Ownable is Context {
    address private _owner = 0xc45595a73b7157D63Bc17e06140f6954A439573B;
...
contract ANM2 is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x6C30a944486F8a68E51e5bc1Eb339B18847561ea); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Anonymous Finance 2.0"; // token name
    string private _symbol = "ANM2.0"; // token symbol
    ...
    uint256 public _buyBackFee = 0; // buyback fee 12%
