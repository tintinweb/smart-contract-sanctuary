...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD360f5fc4aE214A69AB8A8e4dCC4073835375951;
...
contract MetaWage is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8E9206DfDe110A7F163f15Acb12f4943C68ED1B4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MetaWage";
    string private _symbol = "MWAGE";
