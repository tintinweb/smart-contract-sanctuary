...
/*
TRE is the Turtle Finance platform governance token.
hich can be used for community voting and revenue acceleration after the Turtle DAO governance function is launched.
...
Whitepaper - https://bullmark.gitbook.io/turtle-finance
...
contract TurtleFinance is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd8c91dF8430868926Bc661B5327Ca73B13D5429C); // Marketing Address
    ...
    string private _name = "Turtle Finance";
