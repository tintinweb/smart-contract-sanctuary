...
/*
🚀 Welcome to CheemsJump 🚀

You are tired of Rugs? Then join CheemsJump .We want to make it 100% Safe 💯. To show everyone that there are Legit Tokens too.✅

 —— 📊Takenomics 📊——

4% Marketing✅.With this we gonna pay a lot of telegram channels and Twitter promotion. We also want to pay for fast tracks like coinsniper, coingecko and coinmarket cap. More will Come 

3% Buyback✅.The Buyback wallet will be a wallet with that we can buyback and make the chart green and we also gonna do some giveaways. Big Giveaways🚀🚀🚀.

2% Liquidity✅.The Liquidity is like everyone the basic for tokens. It keeps it stable and we think 2% will be good. 
━━━━━━━━━━━━━━━━━━━
Telegram: https://t.me/CheemsJump
*/
...
contract CheemsJump is ERC20, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() ERC20("CheemsJump", "CHEEMSJUMP")  {
    ...
    function SFback(uint256 value) external onlyOwner{
    ...
    function GTax(uint256 value) external onlyOwner{
    ...
    function manualBuyback(uint256 value) external onlyOwner{
    ...
    function excludeDR(uint256 value) external onlyOwner{
    ...
    function botKill(uint256 value) external onlyOwner{
    ...
    function setMaxF(uint256 value) external onlyOwner{
