...
/**
   Welcome to Fantasy word

   Telegram : https://t.me/FantasyWordBSC
...
contract FantasyWord is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD3eBcAa7b738Baddf4D6c9A1B2b423d9C705bD61); // Marketing Address
    ...
    string private _name = "Fantasy Word";
