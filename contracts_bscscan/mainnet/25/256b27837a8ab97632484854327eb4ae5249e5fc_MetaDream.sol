...
contract MetaDream is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaDream";
    string private _symbol = "MetaDream";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF72Dd79C044dc8523A4F66CDC1360C4c616cBBB6); // Marketing Address
    address payable public teamWalletAddress = payable(0x0c10c24fac9359973e9BC31c4CfAeC4BBfC886Ef); // Team Address
