...
contract MiniZooshi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Mini Zooshi";
    string private _symbol = "MiZo";
    ...
    uint256 private numTokensSellToAddToLiquidity = 6999999999999 * 10 ** 9;
    ...
    constructor () public {
        ...
        _mgr = _msgSender();
        _rliquidityFee = _liquidityFee;
        _previousLiquidityFee = _liquidityFee;
        _marketingAddress = payable(0x49227e50Eb99c55Cca7e2438Bb23751E43582429);
