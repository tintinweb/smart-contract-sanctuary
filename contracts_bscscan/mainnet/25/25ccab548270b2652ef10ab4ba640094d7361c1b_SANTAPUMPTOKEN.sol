...
contract SANTAPUMPTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xEAb2EB629171bf73650aCc4ab33D70A5cA4cE1FB); // Marketing Address
    ...
    string private _name = "SANTA PUMP TOKEN";
