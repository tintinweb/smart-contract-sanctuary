...
contract SHIBFINITY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000000 * 10**3 * 10**18; ///50000000000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxBuyAmount = 7500 * 10**3 * 10**18;
    uint256 public maxSellAmount = 7500 * 10**3 * 10**18;
    uint256 public swapTokensAtAmount = 500 * 10**3 * 10**18;
    uint256 public buyBackUpperLimit = 1 * 10**18;


    address public marketingAddress = 0x8264fa43Cc413c93D7c2C829F99286f3dFA08AAF;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "SHIBFINITY";
    ...
    function setFeeRates(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _buyback) external onlyOwner {
        feeRates.rfi = _rfi;
    ...
    function setSellFeeRates(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _buyback) external onlyOwner{
    ...
    function _getValues(uint256 tAmount, bool takeFee, bool isSale) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rAmount, to_return.rTransferAmount, to_return.rRfi,to_return.rMarketing, to_return.rLiquidity, to_return.rBuyback) = _getRValues(to_return, tAmount, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getRValues(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi, uint256 rMarketing, uint256 rLiquidity, uint256 rBuyback) {
