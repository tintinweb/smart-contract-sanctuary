...
/**
--------WELCOME to NoScamToken

Tired of being scammed every day in Crypto ?

The only Secure and Safest Project to Invest is here.

🚀 NoScamToken (BITCOIN/BNB) 🚀
💫 STEALTH LAUNCHED!
✨✨New 1000x Token✨✨
💯 SAFU
🎅 Fully Doxxed Dev Owner
👨💻 RENOUNCED OWNERSHIP : ***WILL BE RENOUNCED AFTER LAUNCH***
🔒 LP send to DEAD address 
💯 LOW MC
💸 BSCHECK - 100% SAFE ✅

--------Telegram https://t.me/noscamtoken
--------Website https://www.noscamtoken.com/
--------https://www.facebook.com/safestcrypto
--------https://twitter.com/NoScamToken

        TOKENOMICS

--------4% Reflections to all Holders
--------4% Liqudity
--------8% Marketing

--------All LP Tokens will NOT be LOCKED but will be sent to burn DEAD address.

NoScamToken (BITCOIN/BNB) is a very safe and simple Community driven Token design for you. 

Hold it in your wallet, Shill it, be part of the team and watch your tokens amount grow.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x666B05b1499Bc81C5f2576238708aD6e2D094893;
...
contract NoScamToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x06481FCAC08F054D0015127201d7847b6D6e4144;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NoScamToken";
