...
contract DOXED is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000 * 9**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 500000000 * 9**_decimals;
    uint256 public maxTxAmount = 150000000000 * 9**_decimals;
    ...
    function updatMaxTxAmt(uint256 amount) external onlyOwner{
        maxTxAmount = amount * 9**_decimals;
    }

    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner{
        swapTokensAtAmount = amount * 9**_decimals;
    }
