...
/**
🔥FAIRLAUNCH MidNight XRP🌒 
⏱️Launching 14.08.21 19.00 UTC🔥

ℹ️Token Information

❌No Presale
✅ Earn XRP just by holding
...
3% liquidity
5% marketing wallet
🎯 All holders will earn xrp just by holding🔥🔥

✉️ Telegram: https://t.me/MidNightXRPofficial
✉️ Turkish Community: https://t.me/MidNightXRPTr 🇹🇷
🖥️ Website : https://midnightxrp.com
...
contract  MidNightXRP is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10000 * 10**7 * 10**4; // 1M
    ...
    uint256 public _maxTxAmount = 10000 * 10**7 * 10**4; // 1M
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**4;
    uint256 public _maxWalletToken = 10000 * 10**7 * 10**4; // 1M
