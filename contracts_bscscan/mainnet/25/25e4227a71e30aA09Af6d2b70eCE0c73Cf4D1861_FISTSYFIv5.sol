...
contract FISTSYFIv5 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FISTS YFIv5";
    string private _symbol = "FISTS YFIv5";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x93B0851581FCeECCb42aBc12060F0a0e705DeDe1); // Marketing Address
    address payable public teamWalletAddress = payable(0x7374Ba519087531bF844DB63857B1c095AFEACAA); // Team Address
    ...
    uint256 public _teamShare = 12;

    uint256 public _totalTaxIfBuying = 12;
    uint256 public _totalTaxIfSelling = 12;
    uint256 public _totalDistributionShares = 12;

    uint256 private _totalSupply = 99 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**_decimals; 
    uint256 public _walletMax = 99 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 99 * 10**3; 
