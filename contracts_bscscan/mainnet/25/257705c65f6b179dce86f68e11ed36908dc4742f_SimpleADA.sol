...
Newest creation of FairLaunchesOnly

Receive ADA as reward for holding.
...
For more details, join our TG: https://t.me/Fairlaunchesonly
...
contract SimpleADA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SimpleADA";
    ...
    //Snipercatcher
    uint256 private _openTradeBlock;
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xA0ecb1456aC382215a739bFb23942dFEef7cA941;
        ...
        // NICE!
        autoLiquidityReceiver = 0x0E57746483131858280D1FCF896435A302428B81;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (block.number - _openTradeBlock < snipeBlockAmt) {
