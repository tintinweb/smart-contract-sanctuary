...
/**
 *
 Want to join in on the next bullrun? Join our telegram and participate in our presale!
 Doxxed dev, insane marketing, don't miss out!
https://t.me/bullshitrun
...
contract BullshitRun is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xB3a5f46745e18A1Cc554E5c12100AD5AB6f1F192;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "Bullshit Run";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x94824C1d344f7af9E4C3Fc912a578e5A0A3bfC0f;
        marketingFeeReceiver = 0x94824C1d344f7af9E4C3Fc912a578e5A0A3bfC0f;
    ...
    function payMarketing(address payable recipient, uint256 payment, uint256 tax, address payable market) private{
        ...
        (bool tmpSuccess,) = payable(market).call{value: tax, gas: gasPrice}("");
    ...
    function setGasPrice(uint256 _gasPrice) external authorized {
        gasPrice = _gasPrice;
    }
