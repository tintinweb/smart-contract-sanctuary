...
contract GiftBonk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0x1b835F1ab83E2A64e4D52Bf20CB1eD2419f3E79a;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "GiftBonk";
    string constant _symbol = "GFTBNK";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(tradingOpen || whiteList[sender] || whiteList[recipient] ,"Trading not open yet!");
        }
    ...
    function setTradingOpen(bool isOpen) external authorized {
        tradingOpen = isOpen;
    }
