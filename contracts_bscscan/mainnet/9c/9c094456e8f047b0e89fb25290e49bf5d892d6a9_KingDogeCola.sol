...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 1 Year");
...
contract KingDogeCola is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingAddress = payable(0x4bF7491cf6AB4E926864D728bB2a317292a9F723); // Marketing Address
    ...
    string private _name = "KingDogeCola";
    string private _symbol = "KINGDOGECOLA";
