...
/**
 * @title HarvestMoonTicket contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract HarvestMoonTicket is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public MAX_TICKET_SUPPLY;
    ...
    constructor(string memory name, string memory symbol, uint256 maxSupply, uint256 _mintPrice) ERC721(name, symbol) {
        MAX_TICKET_SUPPLY = maxSupply;
        mintPrice = _mintPrice;
        saleIsActive = false;
        wallet = 0xdcab82AE4710e4CB0ed05472068594fbB9866132;
    }
    ...
    */
    function mint() external payable {
        ...
        require(totalSupply().add(1) <= MAX_TICKET_SUPPLY, "Purchase would exceed max supply of Waifus");
     ...
     * Mint by owner
     */
    function adminReserve(address _to, uint256 _numberOfTokens) external onlyOwner {
