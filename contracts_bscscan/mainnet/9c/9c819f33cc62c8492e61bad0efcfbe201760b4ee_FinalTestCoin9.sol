...
contract FinalTestCoin9 is Context, IBEP20, Ownable {
    ...
    string private constant _name = "FinalTestCoin9 v29";
    string private constant _symbol = "FTC9";
    ...
    function setRouter(address newRouter) public {
        ...
        // address payable _pancakeFactory = payable(newFactory);
