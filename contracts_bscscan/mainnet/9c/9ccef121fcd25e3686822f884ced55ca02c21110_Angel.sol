...
contract Ownable is Context {
    address private _owner = 0x602D5a5541Bb06117d517f019CFBBaf0fC8CafaD;
...
contract Angel is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x71dbd4BBc9D301F86BDFC6802735dBc2F4116a55); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Angel"; // token name
    string private _symbol = "Angel"; // token symbol
    ...
    uint256 public _buyBackFee = 10; // buyback fee 12%
    ...
    uint256 public _liquidityFee = 80; // liquidity fee 3%
    ...
    uint256 public _minTokensSwapToAndTransferTo = 10000 * 10**6 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
    uint256 public _maxTokensPerAddress          = _tTotal.div(10); // Max number of tokens that an address can hold 5% of total supply
