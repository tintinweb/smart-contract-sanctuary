...
/*
    ...
    I make this #HACKER to hand over it to the community .
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/CryptoHacker
...
Great features:
   ...
   I will renounce the ownership to burn addresses to transfer #HACKER to the community, make sure it's 100% safe.

   I will add 1 BNB and all the left 49.5% total supply to the pool
   Can you make #HACKER 10000000X? 
   ...
   it's the best part of the #HACKER idea, increasing the liquidity pool automatically, 
...
contract CryptoHacker is Context, IERC20, Ownable {
    ...
    string private _name = 'CryptoHacker';

    string private _symbol = 'HACKER';
