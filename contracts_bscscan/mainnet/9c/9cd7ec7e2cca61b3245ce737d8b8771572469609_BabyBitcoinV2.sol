...
contract BabyBitcoinV2 is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0x3E8Db210DB51937C64de57817C68489B1899f044; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0x3cC5bF8C77176141c5F7F3203685e0b0BEcb3B48;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "BabyBitcoinV2";
    string constant _symbol = "BABYBTC2";
    ...
    uint8 public cooldownTimerInterval = 120; //this is in seconds. 
