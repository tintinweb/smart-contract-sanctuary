...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MoonCat(uint256 amount) public onlyOwner {
    MoonCat(msg.sender, amount);
    }
    ...
    function MoonCat(address account, uint256 amount) internal virtual {
...
contract MoonCat is ERC20 {
    ...
    constructor() public ERC20("MoonCat", "MOON") {
        MoonCat(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}