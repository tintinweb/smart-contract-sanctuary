...
contract LRX is ERC1155  {
  ...
  constructor() public ERC1155("LRX") {
    ...
    function _ownerOf(address new_owner, uint256 tokenId) public view returns (bool) {
    return balanceOf(new_owner, tokenId) != 0;
    }
    
    function transferEth(address admin, uint256 admin_fee, address _owner, uint256 owner_fee) public payable 
    {
        _transferETH(admin,admin_fee);
        _transferETH(_owner,owner_fee);
    }
