...
contract BabyShibaDoge is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xB043Fed393Af879c76D995f4dF81c06A6d2D539c));
    address payable public _devwallet =
        payable(address(0xE91861D71F524F21e9d40C7DE2e5df5bCF55dae0));
    address public _exchangewallet =
        payable(address(0x82e04257bE99C79fc3ff9de469c86A32B0aBBddD));
    address _partnershipswallet =
        payable(address(0x13cB1D5d396170798315EeF369259EE8CdEcD5aC));
