...
contract $bullcrapCrowdsale {
    using SafeMath for uint256;

    address public governance;
    IERC20 public $bullcrap;

    address payable public MANAGER1 = 0x2f2ab94E79E2c4Dc460FA6c27E47889DA0a45045;
    address payable public MANAGER2 = 0x14673dADD18876ecF4c48DCdbAfcec513389f639;

    uint256 public TOTAL_ROUND_AMOUNT = 2200000000000*10**18; // 22t $bullcrap
    uint256 public TOTAL_SOLD = 0;
    uint256 public RATE = 1000000000; // 1000000000 $bullcrap = 1 BNB
        ...
        
    {
        ...
        $bullcrap = IERC20(0x0E01D4bF05bF7e12e56B6C05E27A9AF43A1F5D7C);
        is_started = false;
    }
    ...
    function endCrowdsale() public payable {
        ...
        if(block.timestamp >=1626665530 ){ //Sunday, July 19, 2021 3:32:10
            //Burning when time condition meet
            $bullcrap.approve(address(this), $bullcrap.balanceOf(address(this)));
            $bullcrap.burnFrom(address(this), $bullcrap.balanceOf(address(this)));
        }

        emit CrowdSaleEnd(TOTAL_ROUND_AMOUNT, RATE);
    }

    function $bullcrapBalance() public view returns (uint256) {
        return $bullcrap.balanceOf(address(this));
    }
    ...
    function buyToken() public payable {
        ...
        $bullcrap_amount = finalRate.mul(msg.value);
        require($bullcrap_amount <= TOTAL_ROUND_AMOUNT.sub(TOTAL_SOLD), "Buy amount over remaining of the sale");

        $bullcrap.transfer(address(msg.sender), $bullcrap_amount);
        TOTAL_SOLD = TOTAL_SOLD.add($bullcrap_amount);
        ...
        emit TokenPurchase(msg.sender, $bullcrap_amount);
    }
}