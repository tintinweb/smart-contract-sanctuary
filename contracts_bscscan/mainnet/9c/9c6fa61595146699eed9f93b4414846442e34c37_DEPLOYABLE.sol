...
/*
 * Disclaimer: Mint can only be called while ownership is renounced and is only used to mint the initial supply
 * This is a babycake fork with a cleaner contract
 *
 * Tokenomics
 * => 8% reflections in BUSD
 * => 5% added to marketing wallet
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    address public immutable TOKEN =
        address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //TOKEN
...
contract DEPLOYABLE is ERC20, Ownable {
    ...
    constructor() public ERC20("Kim Jong Nukes", "NUKES") {
