...
contract FEGV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "FEG V2"; // 
    string private constant _symbol = "FEGV2"; //    

    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 public _liquidityFee = 6;
    address private _marketingWallet = 0x1cC8332091a435Da1a2e2754B6e8fbE66384D6cA;
