...
Telegram https://t.me/crypto2022bsc
...
contract Crypto2022 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Crypto 2022";
    string constant _symbol = "Crypto2022";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 100 * 10**9 * 10**_decimals;

    uint256 public _maxTxAmount = 1 * 10**9 * 10**_decimals;
    uint256 public _maxWalletToken = 3 * 10**9 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x6bb391fC05aDAC6fEc392b931a640dC4ddD7bBF1;
        marketingFeeReceiver = 0xe198c01BFCB918fc9EB1741aFEc40F156E651e08;
        teamFeeReceiver = 0x311D42e893b62eE521e1A3BD95ca296327234AC6;
        utilityFeeReceiver = 0xfB8f31525f8EbB287d97E9e271766AA9Eba8666a;
