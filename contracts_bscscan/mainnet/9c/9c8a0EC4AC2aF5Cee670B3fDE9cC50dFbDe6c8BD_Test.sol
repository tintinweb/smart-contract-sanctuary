...
contract MND_DISTRIBUTOR is IDividendDistributor { // TO-DO change contract name
    ...
    IBEP20 MND = IBEP20(0x71FB8EE0A7dd60379145bcb22BBC4064D9585c05); // Reward address
...
contract Test is IBEP20, Auth { // TO-DO change contract name
    using SafeMath for uint256;

    address public MND = 0x71FB8EE0A7dd60379145bcb22BBC4064D9585c05; //Reward address
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address zeroAddress = 0x0000000000000000000000000000000000000000;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public externalAddress = 0x6A8f1CE2B9542698a65b401E0259e4e6344874b8; //TO-DO change external address
    address public autoLiquidityReceiver = 0x6A8f1CE2B9542698a65b401E0259e4e6344874b8; //TO-DO change liquidty owner address

    string constant _name = "Test";
    string constant _symbol = "Test";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500000000 *10**6 * (10 ** _decimals);
    ...
    uint256 public _maxTokensPerAddress         = 10000000 * 10**6 * 10**_decimals; // Max number of tokens that an address can hold
	...
	*/
    ...
    /**  
     * @dev Remove/add an address from MND reward
     */
    ...
    /**  
     * @dev set MND distribution criteria
     * _minPeriod--> minimum time to wait before send
     * _minDistribution--> minimum amount of MND reward before send to address
     */
    ...
    /**  
     * @dev set MND distributor's setting
     * gas--> gas fee to be used from sender's gas fee to send MND reward
     */
	...
	*/
    ...
    function blacklistSingleWallet(address account) external authorized {
        ...
        setIsDividendExempt(account, true); // also remove MND reward for address
    }
    ...
    function blacklistMultipleWallets(address[] calldata accounts) external authorized {
        ...
        for (uint256 i; i < accounts.length; ++i) {
            ...
            setIsDividendExempt(accounts[i], true); // also remove MND reward for address
        }
    }
    ...
    function unBlacklistSingleWallet(address account) external authorized {
        ...
        setIsDividendExempt(account, false); // also includes in MND reward for address
    }
    ...
    function unBlacklistMultipleWallets(address[] calldata accounts) external authorized {
        ...
        for (uint256 i; i < accounts.length; ++i) {
            ...
            setIsDividendExempt(accounts[i], false); // also includes in MND reward for address
        }
    }
