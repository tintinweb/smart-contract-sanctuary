...
https://t.me/ApeLoungeGiveawayToken

Merry Christmas to everyone. Please read the pinned messages + Website for information about DDP.

What is a DDP?

DDP (Daily Degen Play) is the foundation of $APL's ecosystem. The team over at @DetectiveBSCApeLounge launches a DDP everyday that rewards it's participants in $APL token. This structure ensures that $APL will also have constant buying pressure throughout its lifetime.

Truly the first of its kind in BSC

#APL


10% Buy/Sell Tax
 5% ApeLoungeToken Rewards
 5% Giveaway tax - will choose a random percentage out of 100% and whichever wallet is the closest, will win. 5 Winners x 20% of the fees.
  

 Super degen, 0 Marketing money, Community based.

 I won't be as active since its the holiday. The 5% giveaway will be determined at the end of the Lock period. You will be able to track the amount of
 funds in the Giveaway in the Giveaway wallet (0xbDe803108A9e0bf2b78E209653426eA8c9f496B0)

 Work together, bring some volume and have fun!
...
/* Token contract */
contract ApeLoungeGiveaway is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "ApeLoungeGiveaway";
    string constant _symbol = "APLG";
