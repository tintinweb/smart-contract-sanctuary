...
contract Sneaky is Context, IERC20, Ownable {
    ...
    string private _name = "Sneaky";
    string private _symbol = "Sneaky";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x073fC18099eE6Db03c9EA8fCf2DE90906C074d92); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x83657dee5eF8B7ba1022848a7da0561194540bc2); // BuyBack Address
