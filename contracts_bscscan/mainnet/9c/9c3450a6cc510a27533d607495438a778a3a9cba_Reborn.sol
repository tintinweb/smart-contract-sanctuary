...
contract Reborn is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xa90C5809eDef7B218Ff646ad702AE33802bf2b72); // Marketing Address
    ...
    uint256 private _tTotal = 161803199* 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Reborn Protocol";
    string private _symbol = "RBN";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xa90C5809eDef7B218Ff646ad702AE33802bf2b72);
    }
    
    function openTrading() external onlyOwner() { //Trading can only be opened
        _liquidityFee=4;
        _taxFee=4;
        tradingOpen = true;
    ...
    //avoiding bots from draining the transactions. 
