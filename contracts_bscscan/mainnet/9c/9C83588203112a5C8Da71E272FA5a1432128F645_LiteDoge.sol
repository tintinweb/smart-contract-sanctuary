/**
   Welcome to ShitDogeToken
   
   site on progress ==? http://shitdogetoken.com 
...
contract LiteDoge is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "ShitDogeToken";
    string private constant _symbol   = "ShitDoge";
    uint8  private constant _decimals = 8;
    
    uint256 public _taxFee       = 500; // 5% of every transaction is redistributed to holders
    uint256 public _burnFee      = 500; // 2% of every transaction is burned
    uint256 public _DevelopmentFee = 300; // 3% of every transaction is sent to Development wallet
