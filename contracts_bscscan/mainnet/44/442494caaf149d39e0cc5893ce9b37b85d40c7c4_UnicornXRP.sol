...
/**
 * TG: https://t.me/UnicornXRP
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * UnicornXRP gathers UnicornXRP and delivers direct to your wallet!!!!
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); //the reward token you want distributed 
...
contract UnicornXRP is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "UnicornXRP";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "UnicornXRP";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x8939702e1F8eF9B9fDb9f6Bb4548B4F8884393F6;
