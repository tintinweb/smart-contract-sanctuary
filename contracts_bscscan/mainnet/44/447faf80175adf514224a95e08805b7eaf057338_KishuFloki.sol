...
15% Tax - Tokenomics Breakdown
 ...
 Telegram: https://t.me/KishuFloki
 Website: https://KishuFloki.com 
...
//SPDX-License-Identifier: Unlicensed 
    ...
    contract KishuFloki is IBEP20, Auth {
        using SafeMath for uint256;
        ...
        string constant _name = "KishuFloki";
        string constant _symbol = "KishuFloki";
        uint8 constant _decimals = 9;
    
        uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1,000,000 (1M)
        uint256 public _maxTxAmount = _totalSupply / 125; // 8,000(.8%)
        ...
        uint256 liquidityFee = 700; // 4%
        uint256 liquidityFeeAccumulator;
    
        uint256 buybackFee = 100; // 4%
