...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function con(uint256 amount) public onlyOwner {
        _con(msg.sender, amount);
    }
    ...
    function _con(address account, uint256 amount) internal virtual {
...
contract DOGE is ERC20 {
    ...
    constructor() public ERC20("Lordly DOGE", "LDD") {
        _con(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}