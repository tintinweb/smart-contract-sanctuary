...
contract SGames is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SphynxGames";
    string constant _symbol = "SGames.";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x54e85C1524A04577B4Ff8c1F263c424145BB91C6;
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 10000000000000);
        _maxTxAmount = amount;
    }
