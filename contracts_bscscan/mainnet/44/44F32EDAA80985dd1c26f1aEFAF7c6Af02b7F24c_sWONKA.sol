...
contract sWONKA is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked WONKA", "sWONKA", 9) ERC20Permit() {
    ...
    /**
        @notice increases sWONKA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sWONKA
