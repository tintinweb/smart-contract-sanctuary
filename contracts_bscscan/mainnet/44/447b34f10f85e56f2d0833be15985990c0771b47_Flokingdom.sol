...
contract Flokingdom is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xC4A9E84A19a17db2E150BB8dA690323D0809bDF9); // Marketing Address
    ...
    string private _name = "FLOKINGDOM ";
    string private _symbol = "FKT";
    ...
    uint256 public _maxTxAmount = 7000000 * 10**6 * 10**9;
