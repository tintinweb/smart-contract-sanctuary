...
/***** INFINITEBULL (INFB) - THE ONLY ONE 
******/
...
contract INFINITEBULL is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "INFINITEBULL";
    string private _symbol = "INFB";
    ...
    // Innovation for protocol by INFINITEBULL
