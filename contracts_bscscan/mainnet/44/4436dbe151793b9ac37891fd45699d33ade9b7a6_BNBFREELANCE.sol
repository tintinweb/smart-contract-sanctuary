...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xadafDe1a3FbC868c10F962F544bCc8A42B6844a2); // Marketing Address
    address payable public devAddress = payable(0x198785680b9461d996AAEA366b0ABcAaA6De5B93); // Dev Address
    ...
    uint256 public _taxFee = 0;  // rewards to holder
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 0;   // Marketing + dev + buyback
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public devAndMarketingDivisor = 0;
...
contract BNBFREELANCE is ERC1363, TokenRecover {
    constructor ()
        ERC1363("BNBFREELANCE", "$BNBF")
    {
    }
}