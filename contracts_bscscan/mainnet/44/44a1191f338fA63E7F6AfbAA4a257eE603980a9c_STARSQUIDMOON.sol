...
contract STARSQUIDMOON is IERC20Metadata, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address private marketingWallet = 0xB12aee5061737E63562a40D24a28433E905a8c2e; // Marketing Address
    address private jackpotWallet = 0xe5A6E3FA56097b4cc5217094Ac499B2088C3Cb89; // Jackpot Address
    address private devWallet = 0xFE69Fc0d5A83D1f0E927a8534bDbb84Dc75Ef9f7; // Dev Address
    address internal deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public presaleAddress = address(0);
    
    string constant _name = "STARSQUIDMOON";
    string constant _symbol = "SQUIDMOON";
    ...
    uint256 private sellingMarketingFee = 7;
    uint256 private buyingMarketingFee = 5;
    
    uint256 private sellingRfiFee = 2;
    uint256 private buyingRfiFee = 2;
    
    uint256 private sellingLpFee = 2;
    uint256 private buyingLpFee = 2;
    
    uint256 private sellingJackpotFee = 1;
    uint256 private buyingJackpotFee = 1;
    ...
    function updateBuyingJackpotFee (uint256 newFee) external onlyOwner {
     ...
     function updateBuyingDevFee (uint256 newFee) private onlyOwner {
        buyingDevFee = newFee;
        calcBuyersTotalFees();
    }
