...
$$ |  $$ |  $$ |   $$ |  $$\         $$ | $$ |\$$$ |$$ |\$$$ |$$ |\$$\        $$ |      $$ |  $$ |   $$ |    
$$$$$$$  |  $$ |   \$$$$$$  |      $$$$$$\\$$$$$$  /\$$$$$$  /$$ | \$$\       $$$$$$$$\  $$$$$$  |   $$ |    
\_______/   \__|    \______/       \______|\______/  \______/ \__|  \__|      \________| \______/    \__|    
...
// Let's celebrate Bitcoin ATH together with our favorite dog!
// Telegram: t.me/BtcInuOfficial
...
contract DividendDistributor is IDividendDistributor {
    ...
    function sendBTCToFee(uint256 amount) private {
    ...
    function manualSend() external {
        uint256 amount = BTC.balanceOf(address(this));
        sendBTCToFee(amount);
    }
}

contract BTC100KEOY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BTC 100K EOY";
    string constant _symbol = "BTC100K";
    ...
    constructor () Auth(msg.sender) {
        ...
        devDeployReceiver = 0xb9BB5ce291298B6168B273d422b92c537110BCf6;
        marketingFeeReceiver = 0x600D705a511CE2e66E508465a53981F8be53d1B3;
