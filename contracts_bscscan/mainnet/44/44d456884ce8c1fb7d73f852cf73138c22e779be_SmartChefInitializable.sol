...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    // The address of the smart chef factory
    address public feeAddress = 0xa34130DC361b374d038916a3D9d178c9A8C8a561;
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        if (_amount > 0) {
            ...
            uint256 depositedamount = stakedToken.balanceOf(address(this)).sub(beforestakedtokentotalsupply);
