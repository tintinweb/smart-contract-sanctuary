 ...
 * Telegram：https://t.me/CorporateFloki
...
contract CorporateFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xB1f9DD6b335E797cF24B27457e98989Ba4a79D19); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0xB1f9DD6b335E797cF24B27457e98989Ba4a79D19); // Liquidity Address
...
; // dead address
    ...
    string private constant _name = "Corporate Floki";
    string private constant _symbol = "Corporate Floki";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 3 / 1000; // 0.3%
    ...
    constructor() {
        address newOwner = address(0xB1f9DD6b335E797cF24B27457e98989Ba4a79D19);
        ...
        maxTransactionAmount = _tTotal * 100 / 10000; // 1% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 3 / 1000; // 0.3% swap tokens amount
        maxWallet = _tTotal * 200 / 10000; // 2% max wallet
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                if(boughtEarly[from]  && earlyBuyPenaltyEnd <= block.number){
                    _taxFee = _taxFee * 2;
                    _liquidityFee = _liquidityFee * 15;
                }
