...
import "./LittleBinaPet-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `LittleBinaPet` at the very bottom **and** the `environment` into which
 * you are deploying the contract `LittleBinaPet(Env.Testnet)` or `LittleBinaPet(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "LittleBinaPet";
    string internal constant SYMBOL = "LBP";
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 1; // 1% of the total supply
     ...
     */
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 1; // 2% of the total supply
     ...
     */
    address internal tipToTheDev = 0xD08fE78D3244e898173483C73cBFC774F9112897;
...
contract LittleBinaPet is SafeToken{
