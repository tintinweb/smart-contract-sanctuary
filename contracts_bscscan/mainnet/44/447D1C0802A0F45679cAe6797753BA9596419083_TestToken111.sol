...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x870E0FDC4DfA0b0e4db33B427F1224Bb054C9388;
...
contract TestToken111 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0200facF1E1dECEb6152BE8866C069F5596d0499;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "q Test Token";
    string private _symbol = "TestToken111";
