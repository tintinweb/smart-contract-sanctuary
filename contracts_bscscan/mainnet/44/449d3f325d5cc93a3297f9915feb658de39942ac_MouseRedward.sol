...
import "./MouseRedward-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MouseRedward` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MouseRedward(Env.Testnet)` or `MouseRedward(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MouseRedward";
    string internal constant SYMBOL = "MRWD";
     ...
     */
    address internal tipToTheDev = 0x3d3d98C6f5a5ACC96B7D157c3F71237a7346716e;
...
contract MouseRedward is SafeToken{
