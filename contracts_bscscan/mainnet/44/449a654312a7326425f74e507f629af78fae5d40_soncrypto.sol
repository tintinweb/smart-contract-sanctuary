...
contract soncrypto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Son Of Crypto";
    string private _symbol = "SOC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x86e482cc0C6D3e7804E3974FD8B543381170495a); // Marketing Address
    address payable private buyBackWalletAddress = payable(0x259E64496F2aC99c5197c7252D98701a29328FC0); // buyback Address
    ...
    uint256 public _walletMax = 30000000000 * 10**9; // 3%
    uint256 private minimumTokensBeforeSwap = 2000000000 * 10**9; 
