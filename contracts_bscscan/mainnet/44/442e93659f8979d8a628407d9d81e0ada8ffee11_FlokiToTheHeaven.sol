...
contract FlokiToTheHeaven is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki To The Heaven";
    string private _symbol = "$FLOKIH";
    ...
    address payable public marketingWalletAddress = payable(0xDE51a918fcC99AB80060abB3d000f5553901eE49); 
    address payable public rewardsWalletAddress = payable(0xD242f0B9C9162be2c9599680d51CA1E200534B2b); 
