...
*/
// TG - https://t.me/TheChristmasFlokiTG
...
contract ChristmasFloki is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0xBfAfeF0f5435c01cBa41AEa4d63BC4B816F23BEB); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x2221dEd4fCf0dFbB12c7b90b451998774eb84839); // Ecosystem Wallet
    address payable private devWallet = payable (0x583bC868bcA4d5eF6F783a26dccc5D91004D44a7); // dev Wallet
    ...
    string private _name = "Christmas Floki";
    string private _symbol = "CF";

    uint256 public _maxWalletToken = _tTotal.div(1000).mul(20); //2% for first few mins

    uint256 public _buyLiquidityFee = 30; //3%
    uint256 public _buyDevFee = 30;     //3% 
    ...
    uint256 public _sellDevFee = 30;   //1%
    ...
    uint256 public swapThreshold = _tTotal.div(10000).mul(20); //2%
