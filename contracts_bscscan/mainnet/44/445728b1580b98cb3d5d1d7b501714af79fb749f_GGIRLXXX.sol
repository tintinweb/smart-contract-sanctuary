...
contract GGIRLXXX is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "GGIRLXXX";
   string constant _symbol = "GGXXX";
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xF830021688D73dFBab0e4fc056a8ffaE8d6c97C6;
