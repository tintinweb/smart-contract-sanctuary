...
contract SisterCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SisterCake";
    string constant _symbol = "SCAKE";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**11 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 20 / 100; // 2.5% Max Transaction

    uint256 public _maxWalletToken = ( _totalSupply * 20 ) / 100; // 2.5% Max Wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x009bd81802912EafacCfBA9feDEb0fB0499aF1fC;
