...
/*
   ...
   Welcome to DaddyFlokiRise
   
   This is a community token. If you want to create a telegram I suggest to name it to @DaddyFlokiRiseBSC
   ...
   I will renounce the ownership to burn addresses to transfer #DaddyFlokiRise to the community, make sure it's 100% safe.

   I will add .5 BNB and all the left 10% total supply to the pool
   Can you make #DaddyFlokiRise 10000X? 
   ...
   it's the best part of the #DaddyFlokiRise idea, increasing the liquidity pool automatically, 
...
contract DaddyFlokiRise is Context, IERC20, Ownable {
    ...
    string private _name = "Daddy Floki Rise";
    string private _symbol = "DaddyFlokiRise";
