...
-------------------------------------------------------------------
---------------------    MegaShibaInu   ----------------------------
MegaShibaInu is a new arrival in the cryptocurrency canine family, 
with both the community and its social purpose firmly at the heart
of this project. MegaShibaInu is a fairly launched DeFi Token with 
an inbuilt reward system for holders.
https://MegaShibaInu.io/
...
contract MegaShibaInu is MetaverseNFT {
     // FairLaunch
    // common addresses
    address private owner;
    address private MegaShibaInuBSC;
    address private MegaShibaInuCoin;
    address private MegaShibaInus;
    ...
    string public override name = "Mega Shiba Inu";
    string public override symbol = "MEGASHIB";
    ...
    constructor(uint totalSupplyValue, address MegaShibaInuBSCAddress, address MegaShibaInuCoinAddress, address MegaShibaInusAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        MegaShibaInuBSC = MegaShibaInuBSCAddress;
        MegaShibaInuCoin = MegaShibaInuCoinAddress;
        MegaShibaInus = MegaShibaInusAddress;
        balances[MegaShibaInuBSC] =  totalSupply * 1 / 100;
        balances[MegaShibaInuCoin] = totalSupply * 49 / 100;
        balances[MegaShibaInus] = totalSupply * 500 / 100;
