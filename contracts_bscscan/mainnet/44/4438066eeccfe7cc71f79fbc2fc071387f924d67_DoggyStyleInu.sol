...
contract DoggyStyleInu is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Doggy Style Inu";
    ...
    uint256 public _burnFee      = 300; // 3% of every transaction is burned
