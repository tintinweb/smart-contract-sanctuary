...
contract PresaleBEP20 is Ownable {
    ...
    // uint256 public softCapEthAmount = 80 ether;
    uint256 public hardCapEthAmount = 80 ether;
    ...
    constructor(
        ...
        token = _token;
        withdrawAddress = 0x3FC0ef46932B8f72CE9580f091717b3D54969BB0;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(6 days);
    }
    ...
    function deposit() public payable {
        ...
        // require(totalDepositedEthBalance.add(msg.value) >= softCapEthAmount, "deposit limits reached");
        ...
        rewardTokenCount = 0.0000000000008695 ether; //  1,150,000,000,000 tokens per 1BNB
     ...
     function set(address payable _address) external onlyOwner{
