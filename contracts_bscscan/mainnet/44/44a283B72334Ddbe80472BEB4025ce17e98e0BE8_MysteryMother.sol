...
/*
Mystery Mother is the first coin launching off of the MysteryHouse launchpad, stealth launch!

Joining the MysteryFamily, MysteryMother uses its fetch tokenomic to transfer wealth from one family member to another!

Check the website and telegram for more info!
...
contract MysteryMother is BEP20 {
    ...
    constructor() public {
        ...
        decimals             = 9;
        totalSupply = 1000000000 * 10**6 * 10;
