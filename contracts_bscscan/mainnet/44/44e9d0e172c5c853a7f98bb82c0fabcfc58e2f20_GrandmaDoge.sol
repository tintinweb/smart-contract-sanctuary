...
/*
    Welcome to Grandma Doge
   
   Telegram: https://t.me/Grandma_Doge
   ...
   I will renounce the ownership to burn addresses to transfer #GrandmaDoge to the community

   I will add 2 BNB and all the left 10% total supply to the pool
   Can you make Grandma Doge Token 100X? 
   ...
   it's the best part of the #GrandmaDoge idea, increasing the liquidity pool automatically, 
...
contract GrandmaDoge is Context, IBEP20, Ownable {
