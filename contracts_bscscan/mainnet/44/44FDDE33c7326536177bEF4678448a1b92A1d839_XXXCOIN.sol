...
// Telegram- t.me/XXXOfficial
// Website- https://XXX.Finance
// Twitter- https://twitter.com/XXXBSC
// EARN BUSD EVERY HOUR AUTOMATICALLY
...
contract XXXCOIN is IERC20, Ownable {
    ...
    string public currentlyServing = "BUSD";

    string constant _name = "XXXCOIN";
    string constant _symbol = "XXXCOIN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; //0.5% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 3 / 2) / 100; // 1.5% of total supply
    ...
    uint256 public _sellMultiplierNumerator = 0;
