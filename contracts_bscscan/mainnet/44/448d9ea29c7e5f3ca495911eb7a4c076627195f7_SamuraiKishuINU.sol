...
contract SamuraiKishuINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "SamuraiKishuINU";	
    ...
    function setBurnFeePercent(uint256 _burnPercent) external onlyOwner() {	
        ...
        emit BurnFee(_previousburnFee,_burnFee);	
    }	
    ...
    function _transfer(	
       ...
       //Excluding from FundFee also excludes from Burnfee 	
        ...
        //send burn
        uint256 _amountToBurn = _remainingAmount.mul(_burnFee).div(10**2);	
        uint256 _remainingAmountAfterBurn =  amount.sub(_amountToBurn);	   	


        _tokenTransfer(from,_fundWallet,_amountSentToOwner,takeFee);
        _tokenTransfer(from,address(0),_amountToBurn,takeFee);
        //transfer amount, it will take tax, burn, liquidity fee	
        _tokenTransfer(from,to,_remainingAmountAfterBurn,takeFee);	
