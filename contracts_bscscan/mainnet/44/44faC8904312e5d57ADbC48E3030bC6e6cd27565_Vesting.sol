...
contract BlocVaultToken is Context, IERC20, Ownable {
    ...
    // General Info
    string private _name     = "BlocVault";
    string private _symbol   = "BVLT";
    ...
    address payable public _marketingAddress = payable(0x56c4Cf090142c394Ee0f3e873d8e878A1872346f); // Marketing address used to pay for marketing
    address payable public _developmentAddress = payable(0x32924bC598aB210F8a22228DB3A97F9806045D32); 
    ...
    address payable public _vestingAddress = payable(0x3cfd27776Dd8fC466C66D8c06b4461414f9936e9); 
    ...
    uint256 public  _preSellTaxFee  = 12; // 12% tax 
    ...
    function transfer_normal(address sender, address recipient, uint256 tAmount) external returns (bool){
        _tokenTransfer_normal(sender, recipient, tAmount);
        return true;
    }
    ...
    function setDevelopAddress(address developAddress) external onlyOwner() {
        _developmentAddress = payable(developAddress);
    }
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        transferBNBToAddress(_developmentAddress, devleopBNB);
...
contract Vesting is Ownable {
    ...
    BlocVaultToken private tokenBVT;
    // Timer Constants 
    uint private constant DAY = 86400; // How many seconds in a day
    ...
    mapping (address => bool) private _isCanChange;
    // address[] private vesting_list;
    uint vesting_count;

    constructor(BlocVaultToken _token) {
        tokenBVT = _token;
    }
    ...
    function setCanChange(address vestingAddress) external onlyOwner() {
        _isCanChange[msg.sender] = true;
    }
...
//       _vesting_info[msg.sender] = VESTINGINFO(block.timestamp.add(DAY.mul(lockdays)), amount, lockdays);
    ...
    function claim_vest() public returns(bool){
        bool state = false;
        require(_isVesting[msg.sender] == true, "address is available");
        ...
        if(lockdeadline > block.timestamp || _isCanChange[msg.sender] == true){
