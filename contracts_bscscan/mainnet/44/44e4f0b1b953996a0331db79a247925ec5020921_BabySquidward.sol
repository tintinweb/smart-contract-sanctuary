...
Telegram = https://t.me/BabySquidward
...
// CHANGE
contract BabySquidward is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabySquidward";
    ...
    uint256 buybackFee = 400;   // 0% 
    uint256 reflectionFee = 0; // 6%
    uint256 devFee = 600; // 4%
    uint256 totalFee = 1400; // liquidityFee + Buyback + devFee
