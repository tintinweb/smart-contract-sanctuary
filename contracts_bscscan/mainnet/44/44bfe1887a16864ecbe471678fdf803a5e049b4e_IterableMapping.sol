...
contract MiniUSDC is ERC20, Ownable {
    ...
    constructor() ERC20("MiniUSDC", "MiniUSDC") {       
        ...
        marketingWallet = address(0x55FB686f1800A0a937aB64c9614073f93A4fE9E6); // set to marketing wallet
        teamWallet = address(0x8158D95Cf72F9f9DC4b645cbA50eebc4944445D3); // set to team Wallet
    ...
    function afterPreSale() external onlyOwner {
        maxSell = _totalSupply * 5 / 1000; // 0.5% maxSellTxn
        swapTokensAtAmount = _totalSupply * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = _totalSupply; // no max Wallet for this contract
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        (success,) = address(owner()).call{value: devAmt}("");
