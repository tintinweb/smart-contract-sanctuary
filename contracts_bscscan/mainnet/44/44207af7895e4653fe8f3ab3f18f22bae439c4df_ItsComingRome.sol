...
rocketmuscle Italy won the title, now it's time for this coin to make all other coins look weak rocketmuscle_tone2  PUMP IT UP!!! rocketmuscle

5% of each transaction back to holders 
5% into lp
20% burn, 20 minutes after launch
HE SHOOTS, HE SCORES!!
GOOOOOAAAAAAALLLLLLL!!!!!  soccer️soccer️soccer️goalgoalgoal

Join the new group here point_right t.me/itscominrome
...
contract ItsComingRome  is Context, IERC20, Ownable {
    ...
    string private _name = "ItsComingRome";
    string private _symbol = "ICR";
