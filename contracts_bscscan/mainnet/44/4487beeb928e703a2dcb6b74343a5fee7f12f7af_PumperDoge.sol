...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownable: caller isnt the owner");
        _;
    }
...
contract PumperDoge is Context, IERC20, Ownable {
    ...
    string private _name = "PumperDoge";
    string private _symbol = "PRDOGE";
    ...
    address payable private _marketingWallet = payable(0x830A5A9392Bc364d71C7558D2b9111C8EC286F5F);
