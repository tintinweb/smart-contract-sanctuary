...
/*
    ...
    - 10% rewards for holders

    
    - Piggy Contract is verified and audited
*/
...
contract BiggyPiggy is Context, ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BiggyPiggy";
    string private _symbol = "Piggy";
    uint8 private _decimals = 18;

    uint256 private _tTotal = 100000000 * 10**21;
    ...
    /* For math div function */
    uint8 private _divider = 100;
    
    /*  redistributed among hodlers */
