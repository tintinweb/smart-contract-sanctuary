...
contract SURFMOONFarmer {
    IERC20 public token_SURFMOON;
    using SafeMath for uint256;
    address erctoken = address(0xc47f53c425d08f8457471538Ae641655814bEAe8); //SURFMOON
    ...
    constructor() {
        ...
        ceoAddress2=address(0x6369f2e7A992Fa6A955877Cb4154D981ebc27fFF);
        ceoAddress3=address(0x3ef95498a0E41a232e72487daA464a014500947a);

        token_SURFMOON = IERC20(erctoken);
    ...
    function invest(
        ...
        token_SURFMOON.transferFrom(address(msg.sender), address(this), amounterc);

        // dev fee
        uint256 fee = amounterc.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);

        token_SURFMOON.transfer(ceoAddress, fee);
        token_SURFMOON.transfer(ceoAddress2, fee);
        token_SURFMOON.transfer(ceoAddress3, fee);
    ...
    function withdraw() public {
        ...
        token_SURFMOON.transfer(msg.sender, totalAmount);
