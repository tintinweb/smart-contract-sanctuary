...
contract BIMPVestingFund4{
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Address of BIMP token
    IERC20 public immutable bimp;
    ...
    // Num of stages
    uint8 public constant NUM_STAGES = 12;
     ...
     * @param _bimp Address of BIMP Token that will be locked on contract.
    ...
    constructor (
        ...
        require(_bimp != address(0), "Illegal address");
    ...
    function getAvailableTokensToRelease () public view returns (uint256 tokensToSend) {
        ...
        if (tokensUnlockedPercentage >= 100) {
            tokensToSend = bimp.balanceOf(address(this));
        } else {
    ...
    function initVestingStages () internal {
        stages[0].date = 1630461600;
        stages[1].date = 1633053600;
        stages[2].date = 1635732000;
        stages[3].date = 1638324000;
        stages[4].date = 1641002400;
        stages[5].date = 1643680800;
        stages[6].date = 1646100000;
        stages[7].date = 1648778400;
        stages[8].date = 1651370400;
        stages[9].date = 1654048800;
        stages[10].date = 1656640800;
        stages[11].date = 1659319200;


        stages[0].tokensUnlockedPercentage = 30;
        stages[1].tokensUnlockedPercentage = 50;
        stages[2].tokensUnlockedPercentage = 60;
        stages[3].tokensUnlockedPercentage = 68;
        stages[4].tokensUnlockedPercentage = 74;
        stages[5].tokensUnlockedPercentage = 79;
        stages[6].tokensUnlockedPercentage = 83;
        stages[7].tokensUnlockedPercentage = 87;
        stages[8].tokensUnlockedPercentage = 91;
        stages[9].tokensUnlockedPercentage = 94;
        stages[10].tokensUnlockedPercentage = 97;
        stages[11].tokensUnlockedPercentage = 100;
    ...
    function release () external {
        ...
        require(
            ...
            "BIMPfiVesting: current time is before first release time"
        );
        ...
        require(tokensToSend > 0, "BIMPfiVesting: no tokens to release");
    ...
    function setInitialTokensBalance () private {
        initialTokensBalance = bimp.balanceOf(address(this));
    }
    ...
    function sendTokens (uint256 tokensToSend) private {
        ...
        bimp.safeTransfer(destinationAddress, tokensToSend);
        // Raising event
