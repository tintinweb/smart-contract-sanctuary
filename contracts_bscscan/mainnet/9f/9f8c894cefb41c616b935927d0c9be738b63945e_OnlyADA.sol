...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BSC = IERC20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
contract OnlyADA is IERC20, Ownable {
    using SafeMath for uint256;

    address BSC = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "OnlyADA";
    string constant _symbol = "$OnlyADA";
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xf672950d5106683f7954f1517cD544508e4cF9b2);
