...
library Address{
 ...
 contract PumpBobby is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x1f61CAB95c9b96DA37C0F7b72eBFc352Dd636B9F;
    address public donationWallet = 0xC736D4416e1a1d41B22Bf306bE9c77B1d60B9e94;

    string private constant _name = "PumpBobby";
    string private constant _symbol = "PumpBobby";
    ...
    Taxes public taxes = Taxes(1, 5, 1, 2);
    Taxes public sellTaxes = Taxes(1, 5, 1, 2);
