...
# Social Media
- Telegram : t.me/SpaceJack_Token
- Website : https://space-jack.com/
- Twitter : twitter.com/SpaceJack_Token
...
contract SpaceJack is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0xebB2BDc6D598Bc2BC6C66985f8eCe35DE8525648;
    ...
    string private _name = "SpaceJack";
    string private _symbol = "SPJ";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "SPJ::transfer: Mkt value invalid"
            );
