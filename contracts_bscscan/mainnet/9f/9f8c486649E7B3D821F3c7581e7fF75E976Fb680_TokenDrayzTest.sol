...
contract TokenDrayzTest is IBEP20, Ownable
{
    ...
    string private constant _name = "TokenDrayzTest";
    ...
    address public constant TeamWallet=0xa74cEd96697ed669DA231a0A911389fC557c2C69;
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function TeamDisableSellLock(bool enabled) public onlyOwner{
        sellLockDisabled=enabled;
    }

    function TeamEnableSellLock(bool disabled) public onlyOwner{
        sellLockEnabled=disabled;
    }
