...
contract VyperDoge is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = 0x6c8B6Bbb2b525Ab36DDBb56Bf642592AEde57D14;
    address payable public expensesAddress = 0x28dFC283AA3930233767449B26eF6a0f92ab8871;
    address payable public devAddress = 0x31f99f1707C2b89A8DF1c3ed86198BbC2C837efa; // Dev Address, used only in phase 1 sells
    ...
    string private _name = "VyperDoge";
    string private _symbol = "VyperDoge";
    ...
    // Innovation for protocol by SHIELD Team
    ...
    function getDaysSinceInit() public view returns (uint256) {
        ...
        uint256 dayLength = 86400; // TODO: main
