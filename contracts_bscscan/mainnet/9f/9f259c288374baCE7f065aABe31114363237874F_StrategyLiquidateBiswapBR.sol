...
// File: contracts/StrategyLiquidateBiswapBR.sol
...
contract StrategyLiquidateBiswapBR is Ownable, ReentrancyGuard, Strategy {
    ...
    constructor(IBiswapRouter02 _router, ISwap _swap) public {
        ...
        nonReentrant
    {
        ...
        swap.swapQuery(fToken.myBalance(), fToken, baseToken);
