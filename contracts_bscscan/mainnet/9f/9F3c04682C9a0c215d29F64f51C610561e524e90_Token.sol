...
contract Token {
    ...
    string public name = "TPMR8 FINANCE";
    string public symbol = "TPMR8";
    
    uint public numeroDeMoedas = 1000000000000;
    uint public casasDecimais = 8;
    
    uint public burnRate = 1; //Queima x% dos token transferidos de uma carteira para carteira de liquidez
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        balances[0xB166701F46A71093c51a28f972e0742e0A97A888] += valueToBurn;
