...
Baby Inu Doge ($BIDOGEL)

Easy 100x with Baby Inu Doge

=============================
1 Quadrillion Total Supply
60% Burned 40% Locked as LP

- 5% Reward distributed to all of hodlers.
- 9% LP Tax ( Auto Buyback & Mkt ) 
- Ownership Renounced
- LP locked for 1 week

Use Higher Slippage if you get transaction reverted
...
contract BabyInuDoge is Context, IERC20, Owwnable {
    ...
    string private _name = "BabyInuDoge";
    string private _symbol = "$BIDOGE";
