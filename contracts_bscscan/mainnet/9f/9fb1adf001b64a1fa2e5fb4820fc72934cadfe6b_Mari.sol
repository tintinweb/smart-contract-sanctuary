...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? MariRouter(_router)
            : MariRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = msg.sender;
    }
...
contract Mari is IBEP20, Auth {
    ...
    // SETMEUP
    address _admin = 0x0D3B7fd43eEe138868316f4E6E4AFe254F65Aa55;
    ...
    constructor () Auth(msg.sender) {
        router = MariRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
