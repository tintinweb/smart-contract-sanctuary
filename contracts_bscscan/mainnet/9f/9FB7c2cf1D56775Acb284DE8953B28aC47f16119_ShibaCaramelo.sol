...
SHIBA CARAMELO OFICIAL

- Supply baixo 1.000.000.000
- Queima 50% metade 
- 3% Retorna pancakeswap 
- 2% Volta para HOLDER 
- 1% Vai queimar carteira  

Telegram: https://t.me/SHIBACARAMELOBR
...
contract ShibaCaramelo is BSC, Math {
    string public name =  "Shiba Caramelo";
    string public symbol =  "SHIBACARAMELO";
    uint8 public decimals = 9;
    uint public _totalSupply = 1*10**7 * 10**9;
