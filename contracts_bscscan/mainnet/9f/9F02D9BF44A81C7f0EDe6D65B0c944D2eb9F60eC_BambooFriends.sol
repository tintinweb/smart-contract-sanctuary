...
contract BambooFriends is Ownable, ReentrancyGuard {
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        if (hasDepositMin) {
            require(_amount >= minimumDeposit, "Deposit amount not reach the minimum");
        }
    ...
    /*
     * @notice Admin functions to setup pool
     */
    ...
    /*
     * @notice Sets the manager account
     ...
     * @dev This function is only callable by owner.
     */
    function poolSetStart(uint256 _startBlock) public onlyManager {
        require(block.number < startBlock, "Pool has started");
     ...
     * @dev This function is only callable by owner.
     */
    function poolSetDuration(uint256 _durationBlocks) public onlyManager {
        require(block.number < startBlock, "Pool has started");
     ...
     * @dev This function is only callable by owner.
     */
    function poolSetStartAndDuration(uint256 _startBlock, uint256 _durationBlocks) public onlyManager {
     ...
     * @dev This function is only callable by owner.
     */
    function poolCalcRewardPerBlock() public onlyManager {
     ...
     * @dev This function is only callable by owner.
     */
    function poolSetRewardMaxTxAmount(uint256 _maxTxAmount) public onlyManager {
