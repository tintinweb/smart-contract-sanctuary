...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;
...
contract Metafomo1 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "METAFOMO";
    string constant _symbol = "METAFOMO";
    ...
    uint256 public _maxTxAmount = 50000000000000 * 10**6 * (10 ** _decimals);
    ...
    uint256 public swapThreshold = 1000000000000000000000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x3a510D61f9B811C802E9472Faea16F58eb223350;
        devWallet = 0x3a510D61f9B811C802E9472Faea16F58eb223350;
