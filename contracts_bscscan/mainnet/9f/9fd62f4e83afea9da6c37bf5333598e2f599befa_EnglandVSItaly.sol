...
contract EnglandVSItaly is Context, IERC20, Ownable {
    ...
    string private _name = "England VS Italy";
    string private _symbol = "ENGLANDVSITALY";
