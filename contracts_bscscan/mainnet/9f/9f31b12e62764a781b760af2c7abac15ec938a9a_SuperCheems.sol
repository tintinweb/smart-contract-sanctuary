...
/*
    Launched by Gemini Creations

    Total Fees: 14%
    2% fee is added to the SuperCheems developer wallet as BNB *Note the team will not be selling tokens*
    6% fee is added to the SuperCheems marketing wallet as BNB *Note the team will not be selling tokens*
...
function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    contract SuperCheems is Context, IERC20, Ownable {
...
function swapTokensForEth(uint256 tokenAmount) private {
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "SuperCheems: cannot burn from zero address");
    require(_balances[account] >= amount, "SuperCheems: Cannot burn more than the account owns");
