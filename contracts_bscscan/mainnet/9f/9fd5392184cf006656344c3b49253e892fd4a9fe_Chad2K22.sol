...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract Chad2K22 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xE190B974f93b5fc33bDd578E43fC72a94234d372); // Marketing Address

    address payable public teamAddress =
        payable(0x1c16421B2BA575F36b538398ACAd7738b92a3a40); // Team Address

    address payable public liquidityAddress =
        payable(0x1c16421B2BA575F36b538398ACAd7738b92a3a40); // Liquidity Address
    ...
    string private constant _name = "Chad2K22";
