...
/**
 * @dev The official KiZiToken smart contract
 */
contract KiZiToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "KiZi Token";
    string private _symbol   = "KiZi";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xaFD0bdF0821036117baA856e7FF3abB2942aBDe9); // Marketing address used to pay for marketing
    ...
    uint256 public  _sellTaxFee       = 50; // 50% tax 
    uint256 public  _whaleSellTaxFee  = 100; // 100% tax 
    uint256 private _previousTaxFee;
    
    // Token Limits
    uint256 public _maxTxAmount        = 500 * 10**6 * 10**9;  // 500 Million
    uint256 public _tokenSwapThreshold = 100 * 10**6 * 10**9; // 100 Million
    
    // Timer Constants 
    uint private constant DAY = 86400; // How many seconds in a day
    
    // Anti-Whale Settings 
    uint256 public _whaleSellThreshold = 50 * 10**6 * 10**9; // 50 Million
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**6 * 10**9; // 1 Million $KiZi will be used to buy at maximum in any one trade
    uint256 public _buybackBNBPercentage = 10;                 // 10% of BNB is used to buyback tokens
    ...
    /**
     * @notice Withdraws non-KiZi tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts KiZi balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns KiZi tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of KiZi tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from KiZi )
