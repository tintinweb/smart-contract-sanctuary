...
// @SamoyedInu_BSC is the telegram.
// sit down and relax
...
contract SamoyedInu is Context, IERC20, Ownable {
    ...
    payable(0x17e385Bb6bdEeAa2EB64653AeBDad3554ccFB002);
    ...
    string private constant _symbol = "SamoyedInu";
...
maxTransactionAmount = _tTotal * 30 / 1000; // 3% maxTransactionAmountTxn
maxWalletAmount = _tTotal * 30 / 1000; // 3% maxWalletToken
