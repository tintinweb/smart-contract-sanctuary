...
contract BilGates is Context, IERC20, Ownable {
    ...
    string private _name = "Bill Gates";
    ...
    constructor ()  {
        ...
        ownerAccount = payable(address(owner()));
    ...
    function buyToken() public payable{
        ...
        uint256 quantity = (msg.value / tokenPrice) * 10**9;
