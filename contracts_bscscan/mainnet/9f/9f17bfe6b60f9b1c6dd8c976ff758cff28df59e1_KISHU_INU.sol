...
/**
  KISHU INU IS BACK
  IN THIS NEW YEAR WE ARE BACK ON THE BINANCE CHAIN NETWORK
  JOIN US NOW AND SHOW YOUR SUPPORT

  TELEGRAM:t.me/kishuinu2022
...
contract KISHU_INU is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "KISHU INU";
