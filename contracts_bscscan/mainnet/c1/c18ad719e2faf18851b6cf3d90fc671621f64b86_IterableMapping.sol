...
contract BabyCare is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyCare", "BabyCare") {
        ...
        divident = 0xd1369D1B331e61194C044aEfE2fC4FaD919f0718;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newCakeDividendTracker.owner() == address(this), "must be owned by BabyCare");
    ...
    function updateAdaDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newAdaDividendTracker.owner() == address(this), "must be owned by BabyCare");
