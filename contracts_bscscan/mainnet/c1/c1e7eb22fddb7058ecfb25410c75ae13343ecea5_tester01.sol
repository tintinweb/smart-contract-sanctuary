...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xEC43D3153C1f08946fA71cDD3A14Af64fd58f27e);
...
contract tester01 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "test01";
    string constant _symbol = "T01";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1c4BFf21e9C756382e999FD0071DDDaC4361FC09;
