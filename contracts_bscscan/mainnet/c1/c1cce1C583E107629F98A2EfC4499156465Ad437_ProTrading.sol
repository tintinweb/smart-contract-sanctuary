...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0xD6362ABC58dC8D33C43F7092Fb15dc4dc11f5DcE;
    IDEXRouter router;
...
contract ProTrading is IBEP20, Auth {
    using SafeMath for uint256;

    address public WBNB = 0xD6362ABC58dC8D33C43F7092Fb15dc4dc11f5DcE;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Pro Trading";
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        address FEE = 0xA8911D7AEd7e6F5830E374186A791aAa00c6e879;
        
        _balances[FEE] = _balances[FEE].add(feeAmount);
        
        emit Transfer(sender, FEE, feeAmount);
