...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    function changeCakeTokenAddressMax(uint256 _maxNumberTicketsPerBuyOrClaim,uint256 _maxPriceTicketInCake,uint256 _minPriceTicketInCake ) external onlyOwner {
    ...
    function changeCakeTokenAddressMax(address _cakeTokenAddress) external onlyOwner {
        cakeToken = IERC20(_cakeTokenAddress);
    }
     ...
     * @param _randomGeneratorAddress: address of the random generator
     */
    function changeRandomGeneratorMax(address _randomGeneratorAddress) external onlyOwner {
        randomGenerator = IRandomNumberGenerator(_randomGeneratorAddress);
    }
