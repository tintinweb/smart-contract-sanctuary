...
https://t.me/sonofcheemsofficial
...
// CHANGE
contract SonOfCheems is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1_000_000_000_000_000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 100% MAX
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // 2% MAX 20_000_000_000_000
    ...
    uint256 totalFee = 1000; // Cheems Inu Rewards + liquidityFee + devFee for marketing and development
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x2d421aD727E21244596Cd6C934AeB4c5fB4922E1);
