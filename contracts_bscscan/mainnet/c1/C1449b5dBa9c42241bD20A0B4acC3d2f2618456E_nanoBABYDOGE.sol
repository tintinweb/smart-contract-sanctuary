...
// File: contracts/nanoBABYDOGEDividendPayingToken.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  address public immutable BUSD = address(0xc748673057861a797275CD8A068AbB95A902e8de);
...
// File: contracts/nanoBABYDOGE.sol
...
contract nanoBABYDOGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0xc748673057861a797275CD8A068AbB95A902e8de);
    address private _liqAdd = address(0x8447E8C44A2070a9a9D9AC697169307655eC9F5b);
    address private _LPadd = address(0x765444ABA7eA9264d43a55bae095C58bB92EA5E6);

    bool private swapping;
    bool public airdrop;

    nanoBABYDOGEDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("nanoBABYDOGE", "nBABYDOGE") {
    	...
    	dividendTracker = new nanoBABYDOGEDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "nanoBABYDOGE: The dividend tracker already has that address");

        nanoBABYDOGEDividendTracker newDividendTracker = nanoBABYDOGEDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "nanoBABYDOGE: The new dividend tracker must be owned by the nanoBABYDOGE token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "nanoBABYDOGE: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "nanoBABYDOGE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "nanoBABYDOGE: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "nanoBABYDOGE: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "nanoBABYDOGE: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "nanoBABYDOGE: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "nanoBABYDOGE: This account cannot send tokens until trading is enabled");
        }
...
contract nanoBABYDOGEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("nanoBABYDOGE_Dividend_Tracker", "nanoBABYDOGE_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "nanoBABYDOGE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "nanoBABYDOGE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main nanoBABYDOGE contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "nanoBABYDOGE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "nanoBABYDOGE_Dividend_Tracker: Cannot update claimWait to same value");
