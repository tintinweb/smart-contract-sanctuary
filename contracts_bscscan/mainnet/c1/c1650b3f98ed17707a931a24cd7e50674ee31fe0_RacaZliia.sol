...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xA9B36D63a2c29f7d2026b6EC6B043E0F80f952EC;
        _token = msg.sender;
    }
...
contract RacaZliia is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x9c9B829E7c52Aa540A3e2B7810256bDB853bCEF5;
    address MarketingWalletTwo = 0x9c9B829E7c52Aa540A3e2B7810256bDB853bCEF5;

    string constant _name = "RacaZliia";
    string constant _symbol = "RacaZliia";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10000000000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20700000000000000 * (10 ** _decimals);
    ...
    address IDEXPair = 0xA9B36D63a2c29f7d2026b6EC6B043E0F80f952EC;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketingTwo = amountBNB.mul(marketingFee).div(totalBNBFee).div(5);
