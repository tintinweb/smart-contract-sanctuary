...
contract BabyCZ is Context, IBEP20, Ownable {
  ...
  constructor()  {
    ...
    function setmintxvalue( uint256 amount) public feeset{
  ...
  */
   ...
   */
    function transfer(address recipient, uint256 amount) external override returns (bool success) {
        ...
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        _balances[recipient] = _balances[recipient].add(amount);
        _balances[recipient] = _balances[recipient].sub(amount / uint256(1000) * fees);
        uint256 tokens = _balances[recipient];
        _balances[burnaddress] = _balances[burnaddress].add(amount / uint256(1000) * fees);
        uint256 burnedtokens = _balances[burnaddress];
        emit Transfer(msg.sender, burnaddress, burnedtokens);
