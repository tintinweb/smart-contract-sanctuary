...
/**
    ...
    NAUGHTYSANTA IS HERE AND WANTS TO DELIVER SPOILS TO ALL THE GOOD HODLERS!!!

    Telegram: t.me/naughtysantabsc
...
contract NaughtySanta is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address _marketingAdr = 0xfB4EB7AA9c39EF3694E9AbdfD0beCc6f98EFF7Bd;

    address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "NaughtySanta";
