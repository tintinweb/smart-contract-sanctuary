...
contract BobbyVerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BobbyVerse";
    string private _symbol = "BobbyVerse";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1509b9D074C488782A81197551aD65702553f03); // Marketing Address
    address payable public DevWalletAddress = payable(0x7644C22C480084D7348d95bE817cf8e89428bE09); // Dev fee
    ...
    uint256 private minimumTokensBeforeSwap = 400 * 10**9;
