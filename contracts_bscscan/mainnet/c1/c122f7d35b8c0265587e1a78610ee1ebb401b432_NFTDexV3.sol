...
// File: contracts/BSCMainnetDex.sol
...
//   event SetValue(address indexed from, uint256 main, uint256 _author, uint256 _platform);
  ...
  event updateDiscount(uint256 amount);
    ...
    function init4() public{
        ...
        LPAlia=LPInterface(0x3581735ce4D03f65E57614f521383E50e1678D98);
        LPBNB=LPInterface(0x1B96B92314C44b159149f7E0303511fB2Fc4774f);
    }
