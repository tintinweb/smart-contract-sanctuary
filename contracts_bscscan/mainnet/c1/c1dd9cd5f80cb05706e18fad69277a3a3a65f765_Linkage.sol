...
// https://linkage.finance
// Linkage is an all in one platform built on Binance Smart Chain
// Linkage Swap - Linkage Decentralized Exchange
// Linkage Chart - Decentralized Aggregator
// Linkage Game - An MMORPG Play to Earn platform
// Linkage Casino - Betting platform for BEP20 tokens and BNB
...
contract Linkage is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFf9d5a3573F995fEcbce2207b44328AbB2Fb984D); // Marketing Address
    ...
    string private _name = "Linkage";
    string private _symbol = "LNKG";
