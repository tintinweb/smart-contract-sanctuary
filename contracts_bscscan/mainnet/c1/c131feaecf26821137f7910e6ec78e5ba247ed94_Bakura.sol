...
contract Bakura is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bakura";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 1 / 1000; // 0.1% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount

        marketingAddress = payable(0x2F20339C9Ba15a5A38C918Bc5451d04788917334); // Marketing Address
        liquidityAddress = payable(address(owner())); // Liquidity Address
        ...
        onlyOwner
    {
        ...
        emit SetBuyFee(buyTaxFee, buyLiquidityFee, buyMarketingFee);
    }
        ...
        onlyOwner
    {
        ...
        emit SetSellFee(sellTaxFee, sellLiquidityFee, sellMarketingFee);
    }
