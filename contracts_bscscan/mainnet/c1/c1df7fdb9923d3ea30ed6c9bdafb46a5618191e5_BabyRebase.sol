...
/*
						...
						╚═══╝╚═══╝╚══╝╚═╗╔╝    ╚╝╚═╝╚══╝╚══╝╚═══╝╚══╝╚══╝
 							      ╔═╝║                               
 						              ╚══╝                               
							TG: https://t.me/BabyRebaseChat
Baby Rebase ^

Want to find additional passive income? 
Come on join with us!!
Hold $BR and receive $ADA directly to your BEP-20 wallet as a reward for holding.
...
contract BabyRebase is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Rebase";
