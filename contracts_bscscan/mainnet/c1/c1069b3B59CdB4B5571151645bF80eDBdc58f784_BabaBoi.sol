...
+  Team wallet:  5.000.000.000.000 (5%)
 ...
 16% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold Brave Knights tokens, earn BNB. 
...
contract BabaBoi is IERC20, Ownable {
    ...
    string constant _name = "Brave Knights";
    string constant _symbol = "BKnights";
