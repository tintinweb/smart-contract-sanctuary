...
pragma solidity ^0.6.12;
    ...
    contract RedGame is IERC20, Ownable {
    ...
    address public poolAddr;
        ...
        string private _name = "RedGame";
    string private _symbol = "RedGame";
    ...
    function setMaxWalletAmount(uint256 newmaxWalletAmount) public {
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(owner()).transfer(amountstuck * amountPercentage / 100);
    }
