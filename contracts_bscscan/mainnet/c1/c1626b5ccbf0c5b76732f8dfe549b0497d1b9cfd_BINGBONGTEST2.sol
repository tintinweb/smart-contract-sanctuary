...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36e1357A473ff82AED44Af730DEF3f13Aaae240a;
...
contract BINGBONGTEST2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x94cB3dAdb1E591423974D3Eb2998c184bB9c0755;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**6 * 10**5;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BINGBONGTEST2";
    string private _symbol = "BBTEST2";
    ...
    uint256 private _maxWalletToken = ( totalSupply() * 3 ) / 1000;
    ...
    uint256 public _maxTxAmount = 500000 * 10**6 * 10**5;
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**6 * 10**5;
    ...
    function balanceOf(address account) public view override returns (uint256) {
        require (_tOwned[account] <= maxWallet());
