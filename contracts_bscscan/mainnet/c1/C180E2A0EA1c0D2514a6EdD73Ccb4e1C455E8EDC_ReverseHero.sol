...
contract Ownable is Context {
    address private _owner = 0x7a71e0AB3337B007596901680A6B904e2953712B;
...
contract ReverseHero is Context, IBEP20, Ownable {
    ...
    address payable public _marketingWallet = payable(0xE439F958Fd9dd99ecc9e8742D3B4E21ae9A0878E);
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD);

    string private _name = "Reverse Hero";
    ...
    uint256 public durationBetweenEachBuyback = 7200;
	...
	uint256 private _transactionLockTime = 50; 
