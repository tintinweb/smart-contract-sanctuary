...
contract Doge555 is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 555 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tHODLrRewardsTotal;

    string private _name = "Doge555";
    string private _symbol = "DOGE555";
    ...
    uint256 public _maxTxAmount = 0.3 * 10**9;
    uint256 public _maxWalletSize = 1.5 * 10**9;
    ...
    function setMaxWalletPercentThousandths(uint256 maxWalletPercent) external onlyOwner() {
        _maxWalletSize = _tTotal.mul(maxWalletPercent).div(10**3);
    }
