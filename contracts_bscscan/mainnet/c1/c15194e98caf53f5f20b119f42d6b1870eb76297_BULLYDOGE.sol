...
contract BULLYDOGE is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BULLYDOGE';
    string private constant _symbol = 'BULLYD';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 30000 * 10**_decimals;//equals  30000 token

    //Divider for the MaxBalance based on circulating Supply (1.5%)
    uint8 public constant BalanceLimitDivider=150;
    //Divider for sellLimit based on circulating Supply (0.1%)
    uint16 public constant SellLimitDivider=15;
    ...
    address public constant TeamWallet=0x336329d30FB0FBB03f873A4720B69a802B0DFF49;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;  //DOGE Token
