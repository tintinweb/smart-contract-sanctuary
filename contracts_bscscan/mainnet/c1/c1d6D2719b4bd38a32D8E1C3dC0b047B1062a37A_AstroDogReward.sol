...
contract AstroDogReward is IBEP20 {
    ...
    string public override name = "AstroDog";
    string public override symbol = "ADOG";
    
    // EVENTS
    // (now in interface) event Transfer(address indexed from, address indexed to, uint256 value);
    // (now in interface) event Approval(address indexed owner, address indexed spender, uint256 value);
    
    // On init of contract we're going to set the admin and give them all tokens.
    constructor(uint256 totalSupplyValue, address developmentAddress, address foundersAddress) {
        // set total supply
        ...
        balances[foundersPot] = totalSupply * 7 / 100;
    ...
    function transfer(address to, uint256 value) public override returns(bool) {
        ...
        uint256 taxTBD = value * 3 / 100;
        uint256 burnTBD = value * 0 / 100;
        uint256 valueAfterTaxAndBurn = value - taxTBD - burnTBD;
