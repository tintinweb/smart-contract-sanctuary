...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 private REWARD = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274);
...
contract SBK is IBEP20, Auth {
    using SafeMath for uint256;
   
    address REWARD   = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB     = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD     = 0x000000000000000000000000000000000000dEaD;
    address ZERO     = 0x0000000000000000000000000000000000000000;

    string constant _name = "ShibaBlack";
    string constant _symbol = "SBK";
    uint8 constant _decimals = 9;
   
    uint256 _totalSupply = 500000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 12500

    //max wallet holding of 6%
    uint256 public _maxWalletToken = ( _totalSupply * 6 ) / 100;//30000
    ...
    uint256 marketingdevelopmentFee = 500;
    uint256 totalFee = 1200;
    uint256 burnFee = 100;
    uint256 extraFeeOnSell = 200;
    ...
    uint256 public swapThreshold = _totalSupply / 40; //12500
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _inicial = 0x3B59a3c92D712A145C1B687a2350EF1D2354Bab4; 
