...
contract TCO2Token is PausableToken, MintableToken {
    // public variables
    string public name = "TCO2 Token";
    string public symbol = "TCO2";
    uint8 public decimals = 6;

    constructor(address initAcccount) public {
        totalSupply_ = 100000000 * (10 ** uint256(decimals));
        balances[initAcccount] = totalSupply_;
    }
