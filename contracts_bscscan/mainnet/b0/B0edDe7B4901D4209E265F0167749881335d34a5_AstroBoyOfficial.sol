...
Telegram: https://t.me/AstroBoyOfficial

JOIN THE TELEGRAM AND HELP TAKE THIS TO THE MOON. 

LP LOCKED. ANTI-BOT, ANTI-WHALE, ANTI-DUMP. SAFU.

TOKENOMICS
5% XRP REWARDS plus MARKETING & DEVELOPMENT and AUTO-LIQUIDITY -

BOTS OR THOSE TRYING TO MANIPULATE THE CHART REKT-ING OTHERS MAY FIND THEIR WALLETS BLACKLISTED THIS IS A SAFU COMMUNITY PROJECT
...
contract AstroBoyOfficial is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Astro Boy";
    string constant _symbol = "OSA";
