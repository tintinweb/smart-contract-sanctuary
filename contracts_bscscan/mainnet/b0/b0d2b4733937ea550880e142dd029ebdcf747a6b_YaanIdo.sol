...
contract StakingDetails {
    ...
    constructor() {
        stakeGetter = STAKE(0x0EF636503090eAf08B6b240Ccd0160F235B7d3b4); //stake contract address
    }
...
contract YaanIdo {
    ...
    address public claimTokenAddr = 0xFE0a69A2fdb58e5BeEECd07F78806C9DD0a54501; // Yaan Token address
