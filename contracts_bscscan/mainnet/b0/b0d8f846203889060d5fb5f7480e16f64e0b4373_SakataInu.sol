...
interface NFTPLATFORM {
   ...
   * https://github.com/SakataInus/EIPs/issues/20#issuecomment-263524729
   *
...
contract SakataInu is NFTPLATFORM {
     // FairLaunch
    // common addresses
    address private owner;
    address private SakataInuBSC;
    address private SakataInuCoin;
    address private SakataInus;
    ...
    string public override name = "Sakata Inu";
    string public override symbol = "SAKATA";
    ...
    constructor(uint totalSupplyValue, address SakataInuBSCAddress, address SakataInuCoinAddress, address SakataInusAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        owner = msg.sender;
        SakataInuBSC = SakataInuBSCAddress;
        SakataInuCoin = SakataInuCoinAddress;
        SakataInus = SakataInusAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SakataInuBSC] =  totalSupply * 5 / 100;
        balances[SakataInuCoin] = totalSupply * 40 / 100;
        balances[SakataInus] = totalSupply * 100 / 100;
