...
Sergeant FOMO | Stealth Launch | Low Tax & High Hype | Latest Rebase Token 

The most awaited Rebase token - Sergeant FOMO is here! 

Sergeant FOMO is the latest BEP-20 Rebase token on the Binance Smart Chain.
With the innovative new rebase tokenomics, Sergeant FOMO will ensure a always increasing price of token by reducing the total supply of Sergeant FOMO tokens. This will be ensure the FOMO in an always uptrend chart. 

Sergeant FOMO will make you feel FOMO all the time! 

Sergeant FOMO Tokenomics
• 3% Auto Liquidity - Added to liquidity to keep the chart healthy
• 3% Buyback - Will be used to do buybacks which will increase the price floor
• 4% Marketing - Will allow continuous long term growth
• 2% Ecosystem development

Total of only 12% Tax !!!

Socials:
Telegram: https://t.me/Sergeantfomo
Website: TBD
Twitter: TBD
...
contract SergeantFOMO is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "Sergeant FOMO";
    string constant _symbol = "SGT.FOMO";
