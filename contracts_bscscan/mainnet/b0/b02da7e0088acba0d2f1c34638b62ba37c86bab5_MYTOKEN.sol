...
/**
 	...
 	Total Fees: 13%
 	4% fee is added to the platform wallet as BNB *Note the team will not be selling tokens*
 	3% fee is added to the marketing wallet as BNB *Note the team will not be selling tokens*
