...
/**
       ...
       Welcome to  ASTRAGIRL
   
   This is a community token. If you want to create a telegram I suggest to name it to @ASTRAGIRL
   ...
   it's the best part of the #ASTRAGIRL idea, increasing the liquidity pool automatically, 
...
contract ASTRAGIRL is Context, IERC20, Ownable {
    ...
    string private _name = "ASTRAGIRL";
    string private _symbol = "ASTRAGIRL";
