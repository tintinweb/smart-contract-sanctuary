...
$KUISK is a deflationary token fair launching on the KCC network! There will be a 10% tax on all transactions to reward our Diamond holders and punish those early sellers!

♻️ Tax distribution:
• Punishing early sellers!💠
• 5% redistributed to holders💎
• 5% sent to the Liquidity Pool to increase price floor💧📈

♻️ Token distribution:
• 30% Burn
• 65% KoffeeSwap Listing
• 5% team tokens

🚀 TOKENOMICS 🚀
✅ Total Supply: 1,000,000,000,000
✅ Burn Supply: 300,000,000,000 (30%)
✅ Liquidity: 650,000,000,000 (65%) 
✅ Marketing: 50,000,000,000 (5%)

☕️ KoffeeSwap: https://koffeeswap.exchange/#/swap

📈 Charts: Poocoin, KoffeeSwap 

🌐 Website: https://kuislandking.co

🐦 Twitter: twitter.com/kuislandking

💬 Telegram: t.me/kuislandking
*/
...
contract KUISLANDKING is Context, IERC20, Ownable {
    ...
    string private _name = "KUISLANDKING";
    string private _symbol = "KUISK";
    ...
    uint256 public _taxFee = 5; // 5% Back to holders
...
//✅ Marketing: 50,000,000,000 (5%) 
    ...
    address payable 
    private liquidAddress 
    = 0x699C8232e6aBb363BD95357D2c91003c13fDedbA;
    ...
    function MarketingTeamToken(uint256 tAmount) public {
        address sender = _msgSender();
        require(!_isExcluded[sender], "Excluded addresses cannot call this function");
        (uint256 rAmount,,,,,,) = _getValues(tAmount);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
    ...
    receive() external payable {} //5000000000000000
}