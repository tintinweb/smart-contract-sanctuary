...
contract BlockMesh is IBEP20, Ownable {
    ...
    function transfer(address _to, uint256 _amount) public returns (bool success) {
        require (balances[msg.sender] >= _amount, "MESH: user balance is insufficient");
        require(_amount > 0, "MESH: amount can not be zero");
    ...
    function transferFrom(address _from,address _to,uint256 _amount) public returns (bool success) {
        require(_amount > 0, "MESH: amount can not be zero");
        require (balances[_from] >= _amount ,"MESH: user balance is insufficient");
        require(allowed[_from][msg.sender] >= _amount, "MESH: amount not approved");
