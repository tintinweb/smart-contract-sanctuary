...
/**
 💲FunkyApe, Imagine on developing a community which relies on a secure and sustained asset. FunkyApe collectively rewards community holders. Relive the Hype by starting at a low market cap with us. Build a foundation where everyone will HOLD for the long-term gains. 


earn CAKE by Hold $FAPE, auto distributed per 60 minutes 

Tokenomics
Project Name   : Funky Ape
Ticker                  : $FAPE
...
contract FunkyApe_BSC is Context, IERC20, IERC20Metadata, Ownable {   
