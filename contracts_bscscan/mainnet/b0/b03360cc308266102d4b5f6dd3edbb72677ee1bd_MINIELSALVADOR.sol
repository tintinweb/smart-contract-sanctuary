...
/**
     Viva Crypto & El Salvador!
     
     Telegram: @MiniElSalvador
     
Mini El Salvador is here to show that crypto is still alive!

We have great Anti-Bot features and Anti-Dump tokenomics that work!

Total supply is only 1000 tokens
Max sell is 15 (1.5%) tokens to prevent dumping
5% BNB reflection to holders
...
contract MINIELSALVADOR is Context, IERC20, Ownable, Janitable {
    ...
    string private _name = "Mini El Salvador";
    string private _symbol = "ElSalvador";
    ...
    uint256 public _maxSellTransactionAmount = 15 * 10**9; // can't sell more than this
    uint256 public _maxWalletToken = 900 * 10**9; // can't buy or accumulate more than this
