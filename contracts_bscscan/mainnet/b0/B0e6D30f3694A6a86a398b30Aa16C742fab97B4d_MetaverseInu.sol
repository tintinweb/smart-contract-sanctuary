...
contract MetaverseInu is Context, ERC20, ERC20Burnable {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        uint256 burnFee = calculateBurnFees(amount);
        uint256 tAmount = amount.sub(burnFee);

        burnFrom(sender, burnFee);
    ...
    /* Calculate burn fees */
    function calculateBurnFees(uint256 amount) private view returns (uint256) {
