...
contract OpenDAO is OpenDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private TeamOpen;
    address private CharityOpen;
    ...
    string public override name = "Open DAO";
    string public override symbol = "Open DAO";
    ...
    constructor(uint totalSupplyValue, address TeamOpenAddress, address CharityOpenAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        TeamOpen = TeamOpenAddress;
        CharityOpen = CharityOpenAddress;
        
        // split the tokens according to agreed upon percentages
        balances[TeamOpen] =  totalSupply * 45 / 100;
        balances[CharityOpen] = totalSupply * 45 / 100;
    ...
    // Get the address of the token's TeamOpen pot
