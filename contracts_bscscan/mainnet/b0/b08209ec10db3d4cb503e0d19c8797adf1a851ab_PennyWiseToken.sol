...
In PennyWise Token, we believe that, people who love Penny Wise will have passive income. With great tokenomics, a beautiful logo and an outstanding community, we will be on the moon

Upcoming FairLaunch On Binance Smart Chain 🚀

• Earn BUSD While Holding.
• Restrictions in max wallet and max transaction to protect the chart.
...
Total Supply 100B
Max buy or sell per txn : 500,000,000 ( 0.5%)
Max wallet: 1,500,000,000 (1.5%)
...
contract PennyWiseToken is Context, IERC20, Ownable {
    ...
    string private _name = "PennyWise Token";
    string private _symbol = "$PennyWise";
