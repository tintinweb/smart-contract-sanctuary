...
// File contracts/Interfaces/SplitterInterface.sol
...
// File contracts/SplitterContract.sol
...
contract SplitterContract is AccessControl, SplitterInterface {
    ...
    function splitFunds() public override returns (bool) {
        ...
        for (uint i=0; i<_participantCount; i++) {
            ...
            console.log("Participant: %s, sending: %s to: %s", currentParticipant.id, currentSendingAmount, currentParticipant.destinationAddress);
        }
        return true;
    }
