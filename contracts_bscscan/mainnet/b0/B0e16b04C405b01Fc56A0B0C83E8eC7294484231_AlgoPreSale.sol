...
contract AlgoPreSale is Owned {
    using SafeMath for uint256;
    
    bool public isPresaleOpen;
    
    address public tokenAddress = 0x66A6606F4B7FF09b078B2DBA848581833005737F;
    uint256 public tokenDecimals = 18;
    
    uint256 public tokenRatePerEth = 28700000000000000000000;
    uint256 public rateDecimals = 0;
    
    uint256 public minEthLimit = 1e17; // 0.1 BNB
    uint256 public maxEthLimit = 3e17; // 0.5 BNB
