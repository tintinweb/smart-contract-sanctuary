...
contract MiniBitcoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MiniBitcoin";
    ...
    uint256 public _maxTxAmount = _totalSupply / 10; //1.25% of total supply
    uint256 public _walletMax = _totalSupply / 10; // 2.5% of total supply
