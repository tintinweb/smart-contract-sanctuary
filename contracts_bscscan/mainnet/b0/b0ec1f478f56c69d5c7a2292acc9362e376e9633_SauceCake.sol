...
/**
 telegram : https://t.me/SauceCake
totalSupply : 100,000,000,000 
max wallet/holders : 5%

Tokenomics : 
10% Reflection, 2% LP, 2% Marketing
*/
...
contract SauceCake is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "SauceCake";
    ...
    uint256 public _maxWalletSize = (_totalSupply * 50) / 100; // 5% MAX 5,000,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x6D506B302d94Bea31BE0d706d056E9c2F4f18F06);
