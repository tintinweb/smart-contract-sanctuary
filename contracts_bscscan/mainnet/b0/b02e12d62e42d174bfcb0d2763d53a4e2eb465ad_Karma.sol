...
abstract contract Auth {
    ...
    constructor() {
        authorizations[0x2AEBE3199ffa065438BbF46B9756Ea0303b86Bb4] = true;
        owner = 0x2AEBE3199ffa065438BbF46B9756Ea0303b86Bb4;
    }
    modifier onlyOwner() {
...
interface KARMAFactory {
    function createPair(address tokenA, address tokenB) external returns (address pair);
}

interface KARMARouter {
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor () {
        router = KARMARouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        _token = msg.sender;
    }
...
contract Karma is IBEP20, Auth {
    ...
    constructor () {
        router = KARMARouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        pair = KARMAFactory(router.factory()).createPair(WBNB, address(this));
