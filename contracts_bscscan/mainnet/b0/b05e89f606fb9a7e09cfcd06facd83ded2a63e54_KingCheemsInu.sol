...
contract KingCheemsInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Cheems Inu";
    string private _symbol = "KCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE174334e665638D45a6aa93959688f9B7542b990); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE174334e665638D45a6aa93959688f9B7542b990); // BuyBack Address
    ...
    uint256 public _walletMax = 5000 * 10**3 * 10**9;
