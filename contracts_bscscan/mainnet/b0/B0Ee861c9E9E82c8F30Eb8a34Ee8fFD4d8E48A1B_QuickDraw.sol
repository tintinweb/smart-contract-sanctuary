...
contract QuickDraw is IBEP20, Ownable {
    ...
    constructor (address _uniswapV2RouterAddr, address marketingWallet) {
        ...
        _isExcludedFromMaxHold[_marketingWallet] = true;
    ...
    /**
     * @notice Sell tokens into BNB and pair with quickdraw for liquidity
     *
     ...
     *
     * @param tLiquidity the amount of stadnard tokens to be be added to the contract
     */
    ...
    /**
     * @notice Send the marketing fee to the marketing wallet
     *
     * @param marketingFee the amount of stadnard tokens to be sent to the marketing wallet
     */
    function _takeMarketingFee(uint256 marketingFee) private {
        // Transfer the taxed tokens to the marketing wallet
        _rOwned[_marketingWallet] += marketingFee * _getRate();
