...
+  Marketing, airdops:  11.000.000.000.000 (11%)
 ...
 14% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold HeliorSwap tokens, earn BNB. 
...
contract BabaBoi is IERC20, Ownable {
    ...
    string constant _name = "Helior";
    string constant _symbol = "HELIOR";
