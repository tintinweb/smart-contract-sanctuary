...
contract KNH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KNH";
    string private _symbol = "KNH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6FA276d27e66df97Bba78CcEd0fde36864fE10A1); // Marketing Address
    address payable public teamWalletAddress = payable(0x7Dbd9d02E7a0F270f8b3515C9e8C69307a9d2684); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 6000 * 10**3; 
