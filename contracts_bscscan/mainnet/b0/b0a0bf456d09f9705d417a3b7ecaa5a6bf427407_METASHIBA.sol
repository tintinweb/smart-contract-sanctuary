...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = RWD.balanceOf(address(this));
        ...
        uint256 amount = RWD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            RWD.transfer(shareholder, amount);
...
contract METASHIBA is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "METASHIBA";
    string constant _symbol = "MSHIB";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 500 000 tokens per tx to launch 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xf2663360b989835A569B721d58ED4636b1aC6841;
