...
+  Team wallet:  5.000.000.000.000 (5%)
 ...
 16% Transaction Fees
 10% is auto redistributed to all holders In BNB Hold BIG DICK CLUB tokens, earn BNB. 
...
contract BabaBoi is IERC20, Ownable {
    ...
    string constant _name = "BIG DICK CLUB";
    string constant _symbol = "BIGDICKCLUB";
