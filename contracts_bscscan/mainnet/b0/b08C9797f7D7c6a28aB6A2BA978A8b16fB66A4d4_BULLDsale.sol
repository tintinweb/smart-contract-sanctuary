...
// 𝒘𝒊𝒏 30𝑲 𝒊𝒏 𝑩𝑵𝑩
// Buy any amount of $BULLD during the presale for a chance to win.
// >> daobull.org
//The best play-to-earn project with NFT supermarket
/*
**/
...
contract BULLDsale is Ownable {
  using SafeMath for uint256;
  IERC20 token;
  string public constant Info = "This is the official Presale contract for BULL DAO";
  uint256 public constant RATE = 5000; //number of tokens per ether
  uint256 public constant CAP = 3000;  //Number of ether accepted until the sale ends
