...
/**
   ...
   #SBL Deflationary BEP-20 Token
   #Shibalance crypto wallet

   #SBL deflationary features:
   4% fee auto add to the liquidity pool to locked forever
   4% fee auto distribute to all holders
   2% fee auto send to burn address (0x0)
   I created a black hole so #SBL token will deflate itself in supply with every transaction
...
contract SBL is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBALANCE";
