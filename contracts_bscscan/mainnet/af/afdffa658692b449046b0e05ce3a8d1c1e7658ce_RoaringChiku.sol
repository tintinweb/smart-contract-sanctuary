...
contract RoaringChiku is IBEP20, Auth {
    ...
    string constant _name = "RoaringChiku";
    string constant _symbol = "ROARCHIKU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2000) / 200;
    uint256 public _maxWalletSize = (_totalSupply * 300) / 100;
    ...
    address private marketingFeeReceiver = 0xE5B0Acb40140E724A156Ea3805a5C1e8377159ac;
    address private developmentFeeReceiver = 0xE5B0Acb40140E724A156Ea3805a5C1e8377159ac;
