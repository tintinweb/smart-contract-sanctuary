...
contract HypeOnHype is ERC20, Ownable {
    ...
    uint16 public feeliq_buy = 5; // Fee is initially set to 99% to avoid sniperbots
    uint16 public feeliq_sell = 10; // Fee is initially set to 99% to avoid sniperbots
    ...
    constructor() ERC20("HypeOnHype", "HOH") {
