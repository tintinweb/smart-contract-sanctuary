...
Bundl Token ( $BUNDL ) Official Contract
...
contract BundlToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x479e69cEc38E3F2003B73969A1c218343F6Dad6A); // Marketing Address
    ...
    string private _name = "Bundl Token";
