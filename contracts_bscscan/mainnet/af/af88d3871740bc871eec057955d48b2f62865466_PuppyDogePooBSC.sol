 ...
 * 
 *
 * Renouncing Ownership + Burning Liquidity Forever
 *
 * Hyper-Deflationary Features:
 *
 * Total Supply: 10 Trillion
 * Initial Burn: 100 Billion (10%)
 * Max Tx: 100 Billion (~1.0% of Total Supply)
 * Max Wallet: 200 Billion (~2% of Total Supply)
 * 20% LP Tax
 *
 * Telegram: t.me/PuppyDogePooBSC
 * 
 */
...
contract PuppyDogePooBSC is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 10000 * 10**9 * 10**9; // 10 Trillion
    ...
    uint256 public _maxTxAmount = 100000 * 10**6 * 10**9; // Max Transaction: 100 Billion (1.0%)
    uint256 public _numTokensSellToAddToLiquidity = 50000 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 200000 * 10**6 * 10**9; // Max Wallet: 200 Billion (2.0%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "PuppyDogePoo";
    string private _symbol = "PuppyPoo";
