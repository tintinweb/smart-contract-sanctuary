...
contract FISTBTC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 888 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "FISTBTC";
    string private _symbol = "FISTBTC";
    ...
    address public ownerAddres = address(0xFfCc7615F91ab46d52A73EF84F2af272E6843183);
    address public devAddress = address(0xFfCc7615F91ab46d52A73EF84F2af272E6843183);
    
    address public FISTBTC = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    ...
    uint256 public feeAllTotal = 1 * 10 **18;
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || _tTotal.sub(_tFeeTotal) <= feeAllTotal){
            takeFee = false;
        }
    ...
    function swapTokensForDividendToken(uint256 tokenAmount) private {
        if (tokenAmount > 0) {
            ...
            IERC20(busdToken).transfer(address(devAddress), dividends);
        }  
    }
}