...
contract SuperFOMO is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("SuperFOMO", "SUMO", uint8(DECIMALS)) {
    ...
    function setAntiDamp(uint256 _amount, uint256 _cooldownPeriod,  bool _antiDamp) external onlyOwner{
        antiDamp = _antiDamp;
    ...
    function setFees(
        ...
        require(sellFee <= feeDenominator / 4, "Sell fee too high");
    }
