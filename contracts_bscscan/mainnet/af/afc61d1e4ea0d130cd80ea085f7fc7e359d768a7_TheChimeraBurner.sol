...
contract TheChimeraBurner is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x77E795599d20429D5Db547B48c7Df9d51a36a8ce); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x9c08aB9984b9485415e0f4C94532A002E4c0CD88); // Liquidity Address
    ...
    string private constant _name = "The Chimera Burner";
    ...
    constructor() {
        ...
        maxWallet = _tTotal * 3 / 100; // 5% max wallet
