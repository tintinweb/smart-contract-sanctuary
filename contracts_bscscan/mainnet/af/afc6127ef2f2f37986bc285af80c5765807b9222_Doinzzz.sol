...
contract Doinzzz is ERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        if(AMMPairs[recipient] && sender != address(_uniswapV2Router) && sender != owner())
            require(tradingEnabled, "Doinzzz: trading is disabled");

        super._transfer(sender,recipient,amount);
    }

    function initSwap() private onlyOwner {
        // init Router
