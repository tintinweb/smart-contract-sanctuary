...
/**
* CakeMistress - Hodl CakeMistress and get rewarded directly with BNB!
*
*
* ░█████╗░░█████╗░██╗░░██╗███████╗███╗░░░███╗██╗░██████╗████████╗██████╗░███████╗░██████╗░██████╗
* ██╔══██╗██╔══██╗██║░██╔╝██╔════╝████╗░████║██║██╔════╝╚══██╔══╝██╔══██╗██╔════╝██╔════╝██╔════╝
...
*
*
* Telegram https://t.me/CakeMisstressFinance
*
*/
...
contract Ownable is Context {
    ...
    */
    ...
    function unlock() public virtual {
        ...
        require(now > _lockTime , "Contract is locked until 7 minutes");
...
contract CAKEMTRS is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string private _name = "CAKE MISSTRESS";
    string private _symbol = "CAKEMTRS";
    ...
    uint256 public rewardCycleBlock = 7 minutes;
    ...
    function activateContract() public onlyOwner {
        // reward claim
        disableEasyRewardFrom = block.timestamp + 4 hours;
