...
contract Dummy is ERC20, Ownable {
	...
	address payable public marketingWalletAddress = 0x34B5827613354c33bb7D62df5e0761b99c33e1D0;
	address payable public developmentWalletAddress = 0x20D2E86d6548F756D7935c67D776299C18beAAb9;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
		...
		if( canSwap && !swapping && automatedMarketMakerPairs[to] && swapAndLiquifyEnabled) {
			...
			if(liqudityPart > 0) 
			{
			    addLiquidity(tokenToLiqudityHalf, liqudityPart);
				liquidityFeeTotal = liquidityFeeTotal.sub(swapTokensAtAmount.mul(tokenToLiqudity).div(tokenToSwap));
			}
