...
/**
CRYPTO GUARDS OFFICIAL

https://t.me/CryptoGuardsGlobal
www.cryptoguards.me
 */
...
contract CryptoGuards is IBEP20, Ownable {
    ...
    string private constant _name = "Crypto Guards";
    string private constant _symbol = "CCAR";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalSupply = 1000000 * 10 ** 9; 
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function newMaxTxnLimits(uint256 maxBuy, uint256 maxSell) public onlyOwner {
        require(maxBuy > 1000000, "Can not reduce below 10K");
        require(maxSell > 1000000, "Can not reduce below 10K");
