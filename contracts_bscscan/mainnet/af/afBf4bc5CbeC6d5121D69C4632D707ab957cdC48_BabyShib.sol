...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3060bB9Ea8102a353a1d9b8040901ddc77751D52;
...
contract BabyShib is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0xF55DDC46f22590aAa570f08659978a8A6038218E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Shib";
    string private _symbol = "BABYSHB";
