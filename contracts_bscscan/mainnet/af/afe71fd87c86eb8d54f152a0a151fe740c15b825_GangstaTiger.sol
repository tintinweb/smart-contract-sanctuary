...
/*
    #GangstaTiger
    Total Fees: 11%
    2% fee to developer wallet *Note the team will not be selling tokens*
    6% fee to marketing wallet *Note the team will not be selling tokens*
    3% is added to LP
    */
...
contract GangstaTiger is Context, IERC20, Ownable {
    ...
    address payable  _marketingAddress = 0x20927b27784ef97550D2015C918cfAC82532b59f;
    address payable  _developerAddress = 0xcE787A590095c29CBdFa96Cebc487b7378f8c12D;
    ...
    string private _name = "Gangsta Tiger";
    string private _symbol = "GTI";
    ...
    uint256 public _maxWallet = 20000000 * 10**9; //2% of TS
    uint256 public _maxTxAmount = 10000000 * 10**9; //0.5% of TS
    // set this number to adjust the rate of swaps
    uint256 public numTokensSellToAddToLiquidity = 2500000* 10**9;
  
    uint256 private _rateLimitSeconds = 10;
    ...
    constructor () public  {
        ...
        _marketingAddress = 0x20927b27784ef97550D2015C918cfAC82532b59f;
        _developerAddress = 0xcE787A590095c29CBdFa96Cebc487b7378f8c12D;
    ...
    */
    function _burn(address account, uint256 amount) internal {
        require(account != address(0), "Gangsta Tiger: cannot burn from zero address");
        require(_balances[account] >= amount, "Gangsta Tiger: Cannot burn more than the account owns");
