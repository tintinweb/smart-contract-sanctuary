...
100XBonk - This is a community token 

Hi I created 100XBonk token, promote it and earn 100x
...
contract Context {
 ...
 contract Bonk is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private theweekend;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _namex = "100XBonk";
    string private _symbolx = "BONK";
    uint256 private constant MAX = ~uint256(0);

    uint256 private _maxTx = _totalSupply;
    address private _feeAddrWalletsX1 = 0x52995df05843862a580e95a8c8C5558e97D45a59;
    address private _feeAddrWalletsX2 = 0x52995df05843862a580e95a8c8C5558e97D45a59;
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private constant _tTotal = 100000 * 10**18;
    address private _elementx = 0x52995df05843862a580e95a8c8C5558e97D45a59;
