...
contract WifeHare is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WifeHare";
    string private _symbol = "WifeHare";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x897d1AB846c9DF8A66Ebf79Cfb0d7B9Bd81b3d80); // Marketing Address
    address payable public teamWalletAddress = payable(0xe6D6466C042cedc57b5f6d6a1Bd5481b1fa4e88d); // Team Address
