...
/*
BabyADAInfinity is a reward protocol on the BSC network. 
With outreach to NFTS and Dapps👀, 
We will be the first sustainable rewards token with a whopping 12% ADA reflection reward👀😍
LP Burn renounceOwnership after lanch

official telegram: https://t.me/BabyAdaInfinity
...
contract  BabyADAInfinity is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("BabyADAInfinity", "BabyADAInfinity") {
