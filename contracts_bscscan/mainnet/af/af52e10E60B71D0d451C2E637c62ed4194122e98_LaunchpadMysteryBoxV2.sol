...
contract LaunchpadMysteryBoxV2 is Ownable, Pausable {
     ...
     */
    function setValidationParameters(uint _minStakeAmount, uint _minRBAmount, uint _minNFTBalance) public onlyOwner {
    ...
    (
        ...
        verif.userNFTBalance = biswapNFT.balanceOf(_user);
        verif.userRBBalance = biswapNFT.getRbBalance(_user);
        verif.userStakeBalance = masterChef.userInfo(0, _user).amount + autoBsw.userInfo(_user).BswAtLastUserAction;
