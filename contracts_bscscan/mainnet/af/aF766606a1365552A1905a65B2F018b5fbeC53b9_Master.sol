...
contract Master is Ownable {
    ...
    // Market oracle provides the qtm/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _qtm) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = qtm.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && qtm.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(qtm.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return qtm.totalSupply().toInt256Safe()
