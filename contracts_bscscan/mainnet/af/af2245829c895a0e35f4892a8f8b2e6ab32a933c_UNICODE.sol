...
/**   
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @UnicodeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #UNICODE to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #UNICODE 10000X? 
   ...
   it's the best part of the #UNICODE idea, increasing the liquidity pool automatically, 
...
contract UNICODE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 4500000000000 * 10**18;
