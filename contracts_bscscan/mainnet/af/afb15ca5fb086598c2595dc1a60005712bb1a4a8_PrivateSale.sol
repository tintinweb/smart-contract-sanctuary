...
contract PrivateSale is Ownable{
    ...
    uint256 internal price=40000; 
    uint256 public minPrice=5*1e18;
    uint256 public maxPrice=10*1e18;
    uint256 public minInvestment=5*1e18;
    ...
    function purchaseTokens() payable public{
        require(totalInvestment <= 250*1e18,"preSale Limit Reached!");
        ...
        user[msg.sender].nextClaimAmount = SafeMath.div(user[msg.sender].lockedAmount,4);
