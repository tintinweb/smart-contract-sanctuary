...
contract ERC20 is Context, IERC20 {
    ...
    /**
     * @dev Returns the symbol of the token, usually a shorter version of thea
     * name.
     */
...
contract adamantium is ERC20, Ownable {
    ...
    address public thunderCakeDividendToken;
    ...
    bool public thunderCakeDividendEnabled = false;

    bool public sendThunderCakeInTx = true;
    bool public sendCakeInTx = true;

    CakeDividendTracker public cakeDividendTracker;
    ThunderCakeDividendTracker public thunderCakeDividendTracker;
    ...
    uint256 public thunderCakeDividendRewardsFee;
    uint256 public previousThunderCakeDividendRewardsFee;
    ...
    event UpdateThunderCakeDividendTracker(address indexed newAddress, address indexed oldAddress);
    ...
    event ThunderCakeDividendEnabledUpdated(bool enabled);
    ...
    event ProcessedThunderCakeDividendTracker(
        uint256 iterations,
        uint256 claims,
        uint256 lastProcessedIndex,
        bool indexed automatic,
    ...
    constructor() ERC20("adamantium", "adam") {
        cakeDividendTracker = new CakeDividendTracker();
        thunderCakeDividendTracker = new ThunderCakeDividendTracker();

        marketingWallet = 0x11fa970ad8305cc20Ef45b52dcf4B933cA45C2CC;
        teamWallet = 0x489102d09d2E66239C65103A88C65b77D7c81534;
        cakeDividendToken = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        thunderCakeDividendToken = 0xce4A4A15FcCD532eAd67BE3ECf7e6122c61D06bb;
        ...
        excludeFromDividend(address(thunderCakeDividendTracker));
    ...
    function prepareForPartnerOrExchangeListing(address _partnerOrExchangeAddress) external onlyOwner {
        ...
        thunderCakeDividendTracker.excludeFromDividends(_partnerOrExchangeAddress);
    ...
    function updateThunderCakeDividendToken(address _newContract) external onlyOwner {
        thunderCakeDividendToken = _newContract;
        thunderCakeDividendTracker.setDividendTokenAddress(_newContract);
    }

    function updateMinThunderCakeBeforeSendDividend(uint256 _newAmount) external onlyOwner {
        thunderCakeDividendTracker.setMinTokenBeforeSendDividend(_newAmount);
    }
    ...
    function getMinThunderCakeBeforeSendDividend() external view returns (uint256) {
        return thunderCakeDividendTracker.minTokenBeforeSendDividend();
    }
    ...
    function setSendThunderCakeInTx(bool _newStatus) external onlyOwner {
        sendThunderCakeInTx = _newStatus;
    }
    ...
    function afterPreSale() external onlyOwner {
        cakeDividendRewardsFee = 1;
        thunderCakeDividendRewardsFee = 1;
        marketingFee = 5;
        ...
        thunderCakeDividendEnabled = true;
    ...
    function setBuyBackAndLiquifyEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            ...
            totalFees = buyBackAndLiquidityFee.add(marketingFee).add(thunderCakeDividendRewardsFee).add(cakeDividendRewardsFee);
            buyBackAndLiquifyEnabled = _enabled;
        }
    ...
    function setCakeDividendEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            ...
            totalFees = cakeDividendRewardsFee.add(marketingFee).add(thunderCakeDividendRewardsFee).add(buyBackAndLiquidityFee);
            cakeDividendEnabled = _enabled;
        }
    ...
    function setThunderCakeDividendEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            previousThunderCakeDividendRewardsFee = thunderCakeDividendRewardsFee;
            thunderCakeDividendRewardsFee = 0;
            thunderCakeDividendEnabled = _enabled;
        } else {
            thunderCakeDividendRewardsFee = previousThunderCakeDividendRewardsFee;
            totalFees = thunderCakeDividendRewardsFee.add(marketingFee).add(cakeDividendRewardsFee).add(buyBackAndLiquidityFee);
            thunderCakeDividendEnabled = _enabled;
        }

        emit ThunderCakeDividendEnabledUpdated(_enabled);
    }
    ...
    function setMarketingEnabled(bool _enabled) external onlyOwner {
        if (_enabled == false) {
            ...
            totalFees = marketingFee.add(thunderCakeDividendRewardsFee).add(cakeDividendRewardsFee).add(buyBackAndLiquidityFee);
            marketingEnabled = _enabled;
        }
    ...
    function updateThunderCakeDividendTracker(address newAddress) external onlyOwner {
        ThunderCakeDividendTracker newThunderCakeDividendTracker = ThunderCakeDividendTracker(payable(newAddress));

        require(newThunderCakeDividendTracker.owner() == address(this), "must be owned by ThunderCake");

        newThunderCakeDividendTracker.excludeFromDividends(address(newThunderCakeDividendTracker));
        newThunderCakeDividendTracker.excludeFromDividends(address(this));
        newThunderCakeDividendTracker.excludeFromDividends(address(uniswapV2Router));
        newThunderCakeDividendTracker.excludeFromDividends(address(deadAddress));

        emit UpdateThunderCakeDividendTracker(newAddress, address(thunderCakeDividendTracker));

        thunderCakeDividendTracker = newThunderCakeDividendTracker;
    }
    ...
    function updateThunderCakeDividendRewardFee(uint8 newFee) external onlyOwner {
        require(newFee <= MAX_FEE_RATE, "wrong");
        thunderCakeDividendRewardsFee = newFee;
        totalFees = thunderCakeDividendRewardsFee.add(cakeDividendRewardsFee).add(marketingFee).add(buyBackAndLiquidityFee);
    }

    function updateMarketingFee(uint8 newFee) external onlyOwner {
        require(newFee <= MAX_FEE_RATE, "wrong");
        marketingFee = newFee;
        totalFees = marketingFee.add(cakeDividendRewardsFee).add(thunderCakeDividendRewardsFee).add(buyBackAndLiquidityFee);
    }

    function updateBuyBackAndLiquidityFee(uint8 newFee) external onlyOwner {
        require(newFee <= MAX_FEE_RATE, "wrong");
        buyBackAndLiquidityFee = newFee;
        totalFees = buyBackAndLiquidityFee.add(cakeDividendRewardsFee).add(thunderCakeDividendRewardsFee).add(marketingFee);
    }
    ...
    function excludeFromDividend(address account) public onlyOwner {
        ...
        thunderCakeDividendTracker.excludeFromDividends(address(account));
    }
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        ...
        if(value) {
            ...
            thunderCakeDividendTracker.excludeFromDividends(pair);
        }
    ...
    function updateMinimumBalanceForDividends(uint256 newMinimumBalance) external onlyOwner {
        ...
        thunderCakeDividendTracker.updateMinimumTokenBalanceForDividends(newMinimumBalance);
    }

    function updateClaimWait(uint256 claimWait) external onlyOwner {
        cakeDividendTracker.updateClaimWait(claimWait);
        thunderCakeDividendTracker.updateClaimWait(claimWait);
    }
    ...
    function getThunderCakeClaimWait() external view returns(uint256) {
        return thunderCakeDividendTracker.claimWait();
    }
    ...
    function getTotalThunderCakeDividendsDistributed() external view returns (uint256) {
        return thunderCakeDividendTracker.totalDividendsDistributed();
    }
    ...
    function withdrawableThunderCakeDividendOf(address account) external view returns(uint256) {
        return thunderCakeDividendTracker.withdrawableDividendOf(account);
    }
    ...
    function thunderCakeDividendTokenBalanceOf(address account) external view returns (uint256) {
        return thunderCakeDividendTracker.balanceOf(account);
    }
    ...
    function getAccountThunderCakeDividendsInfo(address account)
    external view returns (
        address,
        int256,
        int256,
        ...
        uint256,
        uint256) {
        return thunderCakeDividendTracker.getAccount(account);
    }
    ...
    function getAccountThunderCakeDividendsInfoAtIndex(uint256 index)
    external view returns (
        address,
        int256,
        int256,
        ...
        uint256,
        uint256) {
        return thunderCakeDividendTracker.getAccountAtIndex(index);
    }
    ...
    function processDividendTracker(uint256 gas) external onlyOwner {
        ...
        (uint256 thunderCakeIterations, uint256 thunderCakeClaims, uint256 thunderCakeLastProcessedIndex) = thunderCakeDividendTracker.process(gas);
        emit ProcessedThunderCakeDividendTracker(thunderCakeIterations, thunderCakeClaims, thunderCakeLastProcessedIndex, false, gas, tx.origin);
    }
    ...
    function claim() external {
        ...
        thunderCakeDividendTracker.processAccount(payable(msg.sender), false);
    }
    ...
    function getLastThunderCakeDividendProcessedIndex() external view returns(uint256) {
        return thunderCakeDividendTracker.getLastProcessedIndex();
    }
    ...
    function getNumberOfThunderCakeDividendTokenHolders() external view returns(uint256) {
        return thunderCakeDividendTracker.getNumberOfTokenHolders();
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if (!swapping && contractTokenBalance >= swapTokensAtAmount) {
                ...
                if (thunderCakeDividendEnabled) {
                    uint256 sellTokens = contractTokenBalance.div(totalFees).mul(thunderCakeDividendRewardsFee);
                    swapAndSendThunderCakeDividends(sellTokens.sub(1300));
                }
        ...
        try thunderCakeDividendTracker.setBalance(payable(from), balanceOf(from)) {} catch {}
        try cakeDividendTracker.setBalance(payable(to), balanceOf(to)) {} catch {}
        try thunderCakeDividendTracker.setBalance(payable(to), balanceOf(to)) {} catch {}
        ...
        if(!swapping) {
            ...
            if(rand() <= cakeDividendPriority) {
                ...
                if( thunderCakeDividendEnabled && sendThunderCakeInTx ){
                    try thunderCakeDividendTracker.process(gas) returns (uint256 iterations, uint256 claims, uint256 lastProcessedIndex) {
                        emit ProcessedThunderCakeDividendTracker(iterations, claims, lastProcessedIndex, true, gas, tx.origin);
                    }
                    catch {
    ...
    function swapAndSendThunderCakeDividends(uint256 tokens) private {
        swapTokensForDividendToken(tokens, address(this), thunderCakeDividendToken);
        uint256 thunderCakeDividends = IERC20(thunderCakeDividendToken).balanceOf(address(this));
        transferDividends(thunderCakeDividendToken, address(thunderCakeDividendTracker), thunderCakeDividendTracker, thunderCakeDividends);
    }
...
contract ThunderCakeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    using IterableMapping for IterableMapping.Map;
    ...
    constructor() DividendPayingToken("ThunderCake_Dividend_Tracker", "ThunderCake_Dividend_Tracker", 0xce4A4A15FcCD532eAd67BE3ECf7e6122c61D06bb) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
