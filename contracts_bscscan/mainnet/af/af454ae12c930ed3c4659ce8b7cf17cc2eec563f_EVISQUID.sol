...
// OpenZeppelin  v4.3.2 (token/ERC20/ERC20.sol)
...
contract Ownable is Context {
    address private _owner = 0x3eC33690f26cFC59A1a968Dc38eB747735167DE4;
...
contract EVISQUID is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0x3eC33690f26cFC59A1a968Dc38eB747735167DE4); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "EVI-SQUID"; // token name
    string private _symbol = "EVI-SQUID"; // token symbol
	...
	uint256 private _transactionLockTime = 4; //Cool down time between each transaction per address
    ...
    uint256 public _maxTxAmount = _tTotal.div(100000); // max allowed tokens tranfer per transaction
