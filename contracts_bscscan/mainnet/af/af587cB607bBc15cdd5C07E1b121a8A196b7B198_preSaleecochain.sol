...
contract preSaleecochain{
    ...
    constructor(IBEP20 _token) public {
        ...
        tokenPerUsd = 35000000;
        minAmount = 0.1 ether;
        maxAmount = 5 ether;
        preSaleTime = block.timestamp + 17 days;
        reffralpercent = 10;
    ...
    // to buy ecochain token during preSale time => for web3 use
    function buyTokenecochain(address _referrer) payable public {
    ...
    function setPreSaleAmount(uint256 _minAmount, uint256 _maxAmount, uint256 _refPercent) external onlyOwner{
        minAmount = _minAmount;
        maxAmount = _maxAmount;
        reffralpercent = _refPercent;
    }
