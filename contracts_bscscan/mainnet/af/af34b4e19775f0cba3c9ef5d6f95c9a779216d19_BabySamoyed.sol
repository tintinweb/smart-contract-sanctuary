...
Twitter : https://twitter.com/babysamoyedbsc
Website : https://babysamoyed.live
Telegram : https://t.me/babysamoyedtoken
*/
...
contract BabySamoyed is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _maxWalletLimit = 2000000000 * (10**18);

    uint256 private _maxBuyLimit = 1000000000 ;


    uint256 private _feeLP = 3;
    uint256 private _feeMarketing = 6;
    uint256 private _feeDevelopment = 3;
    ...
    address public _marketingWalletAddress = 0x7ECADD5Ca4B91C4f7Cdc5A1314b98044A30a75D0;
    address public _teamWalletAddress = 0x7ECADD5Ca4B91C4f7Cdc5A1314b98044A30a75D0;
    ...
    constructor() ERC20("BabySamoyed", "BABYSAMO")  {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function setFeeReward() external onlyOwner{
        }

        function setFeeBuyback() external onlyOwner{
        }
