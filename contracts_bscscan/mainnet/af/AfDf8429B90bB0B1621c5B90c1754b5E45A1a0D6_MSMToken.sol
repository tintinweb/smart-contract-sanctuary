...
contract MSMToken is ERC20("Master Staking Mobile", "MSM"), Ownable {
    
    /**
    * Additions to the MSM token to have it burn and mint tokens on tx's
    * 
    */
    /// @dev This address is will be used to send 0.1% of the MSM tokens to.
    ...
    */
    ...
    // MSM token emits 0.6% to the project development team

    address public burnAddress = 0x000000000000000000000000000000000000dEaD;

    /// @dev These are used to calcualte how much of the token is to be distributed.
    uint constant public BURN_FEE = 0;
    uint constant public REWARD_FEE = 600;
    uint constant public MAX_FEE = 100000;
    uint256 constant public HARD_CAP = 54000 * 1e18;
    ...
    modifier checkHardCap(uint256 amount) {
        require(totalSupply().add(amount) <= HARD_CAP, "Supply is greater than 54k!");
        _;
    }
