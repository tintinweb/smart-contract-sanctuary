...
contract GooseBSC is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "GooseBSC";
    ...
    address payable public marketingWallet = payable(0x713E2D9f737A4eDC9F7eA6FfE54C902dFd580EFE);
    address payable public treasury = payable(0xB8C21fa6933eAd65caB48dd51B67078E2a81FFD8);
