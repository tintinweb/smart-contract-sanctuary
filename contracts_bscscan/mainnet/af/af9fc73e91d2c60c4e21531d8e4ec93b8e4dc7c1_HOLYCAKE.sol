...
/* contacts let = "name HOLYCAKE" id =1000000000000000 
getAmountOut(HOLYCAKECAKE)
/*gets the data item (model) whith the setTransactionLimit = (500)/only 5%
...
// File: contracts\HOLYCAKEAKE.sol

contract HOLYCAKE is Context, IERC20Metadata, Ownable, ReentrancyGuard {
	uint256 private constant MAX = ~uint256(0);
	
	// MAIN TOKEN PROPERTIES
	string private constant _name = "HOLY CAKE";
	string private constant _symbol = "HOLY CAKE";
	...
	function activate() public onlyOwner {
		_isSwapEnabled = true;
		_isFeeEnabled = true;
		setTransactionLimit(500); // only 1% of the total supply can be exchanged at once
