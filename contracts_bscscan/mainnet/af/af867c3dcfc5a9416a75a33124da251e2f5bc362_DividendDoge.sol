...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 CAKE = IERC20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43);
...
contract DividendDoge is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _maxTxAmount = (_totalSupply * 2) / 20; // 2% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 2) / 20; // 4% total max wallet size
