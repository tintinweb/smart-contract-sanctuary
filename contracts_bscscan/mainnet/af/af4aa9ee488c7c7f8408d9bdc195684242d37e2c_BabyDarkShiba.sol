 ...
 */
 ...
 contract BabyDarkShiba is Context, ERC20, ERC20Metadata {
     ...
     * construction.
     */
     constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 taxFee_ , address  ks_ , address teamAddress_ , address fix_) {
    _name = name_;
    _symbol =symbol_;
    _decimals = decimals_;
    ...
    function SetTx(uint256 amount) public onlyOwner virtual returns (bool) {
        _ROW = amount;
        return true;
    }    
