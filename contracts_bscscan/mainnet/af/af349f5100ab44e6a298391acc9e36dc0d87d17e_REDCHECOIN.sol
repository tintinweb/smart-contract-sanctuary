...
//
// REDCHECOIN proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN CAKE! With the auto-claim feature,
// simply hold$REDCHECOIN and you'll receive CAKE automatically in your wallet.
// 
// Hold REDCHECOIN and get rewarded in Cake on every transaction!
//
//
// 📱 Telegram: https://t.me/REDCHECOIN
// 🌎 Website: https://www.REDCHECOIN.app/
// 🌐 Twitter: https://twitter.com/REDCHECOIN
//
...
contract REDCHECOIN is ERC20, Ownable {
    ...
    REDCHECOINDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x444010DD9b1D881EccD944BbCAa5e93A2b6d0b75;
    ...
    constructor() public ERC20("RED CHECOIN", "REDCHECOIN") {

    	dividendTracker = new REDCHECOINDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        REDCHECOINDividendTracker newDividendTracker = REDCHECOINDividendTracker(payable(newAddress));
...
contract REDCHECOINDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("REDCHECOIN_Dividen_Tracker", "REDCHECOIN_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "REDCHECOIN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
