...
/**
This token will be launched for the community.
Ownership will be renounced.
Liquidity will be locked.
telegram group @skadibsc.

This coin can 100x easily.
The marketing wallet will pay for poocoin adverts as soon as there is enough BNB in it.

100,000,000,000 total supply
50,000,000,000 of total supply burned

Tokenomics are as follows:
50% of total supply burned
10% Tax
4% Fee Auto Added to Liquidity
3% Redistributed Amongst Holders
3% fee auto added to marketing wallet
...
contract SKADI is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x7b6657e646249422a25d3300601C9E519aB4BAF5;
