...
contract KoinStation is Context, IERC20, Ownable {
    ...
    string private _name = "KoinStation";
    string private _symbol = "KOINS";
    ...
    address  public MarketingWallet = 0xC5Fe63765f2cCD49F0eE08A193758cD0dEE414F6;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Restore tax, liquidity, burn and marketing fees
    ...
    function setMarketingFee(uint256 newVal) external onlyOwner() {
        _marketingFee = newVal;
    }
