...
contract test2 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x34B8E4D3b853A64DbA12929Cf89c01D93dD233d5); // Marketing Address
    ...
    uint256 public _buyBackRangeRate = 50;
    ...
    uint256 private minimumTokensBeforeSwap = 600 * 10**6 * 10**9; 
