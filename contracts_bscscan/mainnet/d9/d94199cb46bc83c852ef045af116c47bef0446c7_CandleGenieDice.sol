...
contract CandleGenieDice is Ownable, ReentrancyGuard 
{
    ...
    address diceRollControllerAddress;    
    ...
    {
        require(msg.sender == diceRollControllerAddress || msg.sender == address(diceRandomSource), "Only roll controller contract allowed");
        _;
    }
