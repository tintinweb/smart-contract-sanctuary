...
contract CoinaryToken is BotProtected {
 
    mapping (address => uint) public balanceOf;
    mapping (address => mapping (address => uint)) public allowance;
 
    uint constant public decimals = 18;
    uint public totalSupply = 251000000000000000000000000;
    string public name = "Coinary Token";
    string public symbol = "CYT";
    IUniswapV2Router02 public pancakeRouter = IUniswapV2Router02(0xcF0feBd3f17CEf5b47b0cD257aCf6025c5BFf3b7);
