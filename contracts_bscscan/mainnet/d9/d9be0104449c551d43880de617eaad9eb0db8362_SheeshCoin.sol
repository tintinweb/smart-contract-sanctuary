...
contract SheeshCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Sheesh Coin";
    string constant _symbol = "SHEESHCOIN";
...
//        emit Transfer(sender, recipient, amount);
    ...
    function triggerSheeshBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Sheesh Coin has already launched towards the moon!");
