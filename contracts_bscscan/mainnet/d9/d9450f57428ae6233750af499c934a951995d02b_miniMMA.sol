...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MiniBaby(uint256 amount) public onlyOwner {
    _minibaby(msg.sender, amount);
    }
    ...
    function _minibaby(address account, uint256 amount) internal virtual {
...
contract miniMMA is ERC20 {
    ...
    constructor() public ERC20("mini MMA NFT", "MMA") {
        _minibaby(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}