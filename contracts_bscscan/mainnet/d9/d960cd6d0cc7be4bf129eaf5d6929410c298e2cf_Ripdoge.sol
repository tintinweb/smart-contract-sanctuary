...
/*
Ripdoge is built upon the fundamentals of Buyback and increasing the investor's value
...
contract Ripdoge is Context, IERC20, Ownable {
    ...
    string private _name = "Ripdoge";
    string private _symbol = "Ripdoge";
