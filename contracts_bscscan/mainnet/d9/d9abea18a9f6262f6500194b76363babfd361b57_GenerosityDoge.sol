...
/**
   ...
   I make this #GenerosityDoge to hand over to the community.
   Create the community by yourself if you are interested.   
   I suggest a telegram group name for you to create: https://t.me/GenerosityDogeBSC
   ...
   I will renounce the ownership to burn addresses to transfer #GenerosityDoge to the community, make sure it's 100% safe.

   I will add .2 BNB and all the left 10% total supply to the pool
   Can you make #GenerosityDoge 1000X? 
...
contract GenerosityDoge
 is Context, IERC20, Ownable {
    ...
    string private _name = "Generosity Doge";
