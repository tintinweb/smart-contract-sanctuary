...
contract Seismic is ERC20, Ownable {
    ...
    uint128 public minTokensBeforeSwap = 1 * 10**6 * 10**18;
    ...
    constructor(
    ...
    ) public ERC20("Seismic", "SCB") {

        _mint(address(0xdAC240b6f33817E1a30Dac55837C8d7e7AC036fC), 1 * 10**8 * 10**18);
        ...
        _marketingWallet = 0x22F41aB06c75c0F7321F6970C0c1C93Af21069De;
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !inSwapAndLiquify) {
            ...
            super._transfer(from, _marketingWallet, devAmount);
