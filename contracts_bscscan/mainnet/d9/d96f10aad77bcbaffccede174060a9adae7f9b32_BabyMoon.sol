...
/**
        Tokenomics: 
        10% fee goes to liquidity.
        90% burn to dead address.
        Ownership renounced.
        Automatic Burncycle function added for increasing of token value.
*/
...
contract BabyMoon is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'BabyMoon';
