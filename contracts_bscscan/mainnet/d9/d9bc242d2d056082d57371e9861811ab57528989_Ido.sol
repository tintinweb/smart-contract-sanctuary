...
contract Ido {
    ...
    // address buyTokenAddr = ; // Mainnet
    address buyTokenAddr = 0xF3FD85Ec9eAf17e469Ebad5D6027282ebc7a5eF2; // Mainnet Yug token address
    ...
    function buyToken() public payable returns(bool) {
        ...
        uint tokens = (msg.value * priceOfBNB / 10000) / buyPrice;
    ...
    function getTokens(uint bnbAmt) public view returns(uint tokens) {
        uint priceOfBNB = priceConsumerV3.getThePrice();
        tokens = (bnbAmt * priceOfBNB / 10000) / buyPrice;
        return tokens;
    }
