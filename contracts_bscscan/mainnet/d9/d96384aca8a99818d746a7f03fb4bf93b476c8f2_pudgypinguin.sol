...
contract pudgypinguin is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "pudgypinguin";
...
//     _approve(accoun mt, _msgSender(), _allowances[account][_msgSender()].sub(amount, "burn amount is too low"));
//   }
