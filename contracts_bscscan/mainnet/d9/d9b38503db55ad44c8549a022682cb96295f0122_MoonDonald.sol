...
// Official Telegram Group: MoonDonald
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBDcaf4A0068B4689093eC38D593E835BE8aeE135;
...
contract MoonDonald is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBEaAe0469C74b22E7dF0D8405aD096964e2cE429;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MoonDonald";
    string private _symbol = "MoonDonald";
