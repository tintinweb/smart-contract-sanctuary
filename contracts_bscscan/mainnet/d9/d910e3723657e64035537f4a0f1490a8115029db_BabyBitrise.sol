...
contract BabyBitrise is IERC20 {
    ...
    uint256 public _buyMarketingFee = 2500;
    uint256 public _buyBackFees = 0;
    uint256 public _buyLottoFee = 500;
    ...
    uint256 public _sellLottoFee = 300;
    ...
    //Set this
    address payable private _buyBackAddress = payable(0x5Ad6CCAb22bAa081b149b0f87E09d142e39D3B3F) ;
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _tTotal - (balanceOf(_buyBackAddress) + balanceOf(ZERO));
    }
    ...
    function takeTaxes(address sender, uint256 amount) internal returns (uint256) {
        ...
        _tOwned[_buyBackAddress] += buyBackAmount;
        emit Transfer(sender, _buyBackAddress, buyBackAmount);
