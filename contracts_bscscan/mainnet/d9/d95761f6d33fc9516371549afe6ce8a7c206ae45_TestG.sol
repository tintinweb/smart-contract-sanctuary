...
contract TestG is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6cAE90be1De9756e4932c2Be8A98584177b4e291); // Marketing Address
    ...
    string private _name = "TestG";
    string private _symbol = "TestG";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x6cAE90be1De9756e4932c2Be8A98584177b4e291);
    }
