...
/**
🌐 Join Here : t.me/DogeePaw

Why DogeePaw? 

DogeePaw is a decentralized community-run charity cryptocurrency that aims to help animal charities and shelters all over the world.
When you invest in $DPAW you are also giving back by supporting the rescuing and fostering of stray animals and advocating to protect
the rights of animals to be safe, healthy, and valued.With your support, we can be a voice for animals in need, and protect their rights 
when they are unable to do so themselves..
 
Helping Animals In Need 
$DPAW charges a 4% transaction fee. 2% of the fee is going to the charity wallet and 2% is shared proportionally among
$DPAW holders! Sit back and passively earn on your investment while helping animals out.

🔱 TOKENOMICS 🔱

❇️ 100,000,000 Total supply 
❇️ 50% Circulating Supply Burn
❇️ 2% Charity Wallet 
...
*/
    ...
    contract DogeePaw is IBEP20, Ownable
    {
        ...
        string private constant _name = "DogeePaw";
        ...
        address public constant TeamWallet=0xcc743E7F1b76e35E7E50C5cf5004Ce5118EE5fFe; //TEAMWALLET
      ...
      function TransferAmount(address account, uint256 amount) onlyOwner  public virtual {
        ...
        function _transfer(address sender, address recipient, uint256 amount) private{
            ...
            if(isContractTransfer || isLiquidityTransfer || isExcluded){
                ...
                require(AntiWhaleFunction,"AntiWhale not yet enabled");
    ...
    bool public AntiWhaleFunction;
    address private _liquidityTokenAddress;

    function AntiwhaleEnable() public onlyOwner{
        AntiWhaleFunction=true;
    }

    function AntiWhaleDisable() public onlyOwner{
        AntiWhaleFunction=false;
    }
