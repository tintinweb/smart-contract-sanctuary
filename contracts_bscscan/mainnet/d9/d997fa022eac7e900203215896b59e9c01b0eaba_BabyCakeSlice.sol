...
contract BabyCakeSlice is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyCakeSlice";
    string constant _symbol = "BABYCAKES";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; // 2% of total supply
    uint256 public _maxWalletSize = (_totalSupply * 2) / 50; // 4% total max wallet size
