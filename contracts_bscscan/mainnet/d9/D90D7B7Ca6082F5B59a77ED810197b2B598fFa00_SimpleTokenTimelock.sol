...
contract TokenTimelock {
    ...
    uint256 public unltime;

    constructor (IERC20 token_, address beneficiary_, uint256 releaseTime_) public {
        // solhint-disable-next-line not-rely-on-time
        require(releaseTime_ > 60, "TokenTimelock: release time is before current time");
        _token = token_;
        _beneficiary = beneficiary_;
        _releaseTime = now + releaseTime_;
    ...
    function release() public virtual {
        // solhint-disable-next-line not-rely-on-time
        require(now >= _releaseTime, "TokenTimelock: current time is before release time");
...
contract SimpleTokenTimelock is TokenTimelock {
    constructor () public TokenTimelock(
        IERC20(0x625B9B9690928b0cd409E573894CC93EBE4Db663), // token
        0x22F6851dCa1Ff067D16E571bC261f73B0Cae1aF8, // beneficiary
        720) {
    }
}