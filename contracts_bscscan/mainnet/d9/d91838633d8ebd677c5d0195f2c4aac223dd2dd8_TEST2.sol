...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xB00a4aA12E7043c23C06962b1cb28Ca576aD7713);
...
contract TEST2 is IBEP20, Auth {
    ...
    string constant _symbol = "TEST2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * 10**6 * 10**9;
    ...
    uint256 public buybackFee = 40;
    uint256 public totalFees = BNBRewardsFee.add(buybackFee);

    address payable public buybackWallet = payable(0xB00a4aA12E7043c23C06962b1cb28Ca576aD7713);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xB00a4aA12E7043c23C06962b1cb28Ca576aD7713;
        marketingFeeReceiver = 0xB00a4aA12E7043c23C06962b1cb28Ca576aD7713;
        ecosystemfeeReceiver = 0xB00a4aA12E7043c23C06962b1cb28Ca576aD7713;
    ...
    function setFee(uint256 _bnbRewardFee, uint256 _buybackFee) public onlyOwner {
        BNBRewardsFee = _bnbRewardFee;
        buybackFee = _buybackFee;

        totalFees = BNBRewardsFee.add(buybackFee); 
    }
