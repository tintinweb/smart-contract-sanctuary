...
/**
    🧁 Golden Cat Cake Token 🧁

    Our Cake Wallet is a CAKE reward pool that will constantly be filled with CAKE tokens from every transactions made by anyone trading $GCC, in the same time, 
    you get to claim your CAKE reward daily too, depending on the amount of $GCC that you hold from the total supply. 
    For example, if you are holding 5% of the $GCC liquidity and the reward pool has 10,000 CAKE, your reward will be 500 CAKE. Simple as that, 
    but please take note that if you fail to claim your daily CAKE token, 
    you are not able to stake the cake for the following day.

    Buy 7%
    🧁 4% – to Cake Wallet Rewards
    🧁 1% – to Cake Wallet Insurance
    🧁 1% – Marketing & Development
    🧁 1% – Liquidity Pool

    Sell 13%
    🧁 5% – to Cake Wallet Rewards
    🧁 2% – to Cake Wallet Insurance
    🧁 4% – Marketing & Development
    🧁 2% – Liquidity Pool

    TG: @GoldenCatCakeToken
...
contract GoldenCatCakeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x257B7653cCD2fc74884dC4970e207aE1Ed95874c); // Marketing Address
    ...
    uint256 public maxBuyAmount = 1000000000000000;
    uint256 public maxSellAmount = 1000000000000000;

    bool public limitsInEffect = false;
    
    string private constant _name = "GoldenCatCake";
 ...
 // This will be adjust to avoid dump in the first few minutes
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(0x257B7653cCD2fc74884dC4970e207aE1Ed95874c).call{value: bnbForTeam1}("");
        (success,) = address(marketingAddress).call{value: bnbForCharity}("");
        (success,) = address(0x257B7653cCD2fc74884dC4970e207aE1Ed95874c).call{value: bnbForTeam2}("");
