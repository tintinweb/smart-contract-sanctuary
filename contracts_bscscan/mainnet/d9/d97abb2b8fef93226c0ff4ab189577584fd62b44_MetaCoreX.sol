...
contract MetaCoreX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**2 * 10**8;
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**2 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**2 * 10**8;
