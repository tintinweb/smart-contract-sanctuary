...
pragma solidity ^0.8.0;
contract TPGFinance is ERC20, Ownable {
    ...
    constructor() ERC20("TPG.Finance", "TPG") {
        _mint(msg.sender, 100000000*10**decimals());
        startSale(block.number, 999, 0,1000000*10**decimals(), 15000000);
        startAirdrop(block.number,9,500*10**decimals(),5000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
