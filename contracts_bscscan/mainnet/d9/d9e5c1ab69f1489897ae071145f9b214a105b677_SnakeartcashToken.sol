...
// File: contracts/Snakeartcash.sol
...
// Snakeartcash with Governance.
contract SnakeartcashToken is BEP20("Snake Art Cash", "SARC"), Ownable {
    uint256 private _cap = 100000000e18;
    uint256 private _initial_supply = 100000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "SARC::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "SARC::delegateBySig: invalid nonce");
        require(now <= expiry, "SARC::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SARC::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SARC::_writeCheckpoint: block number exceeds 32 bits");
