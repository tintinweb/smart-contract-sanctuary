...
contract MetaGirl is ERC20, Ownable {
    ...
    uint16 public feeliq_buy = 8; // Fee is initially set to 3% to avoid sniperbots
    uint16 public feeliq_sell = 12; // Fee is initially set to 49% to avoid sniperbots
    ...
    constructor() ERC20("MetaGirl", "METAG") {
