...
// CHANGE
contract StarGirl is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Star Girl";
    string constant _symbol = "StarGirl";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100; // 2% MAX 40,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xA2C7E361d4e91b1Fc47943e259c5B87eCeF8FF85);
