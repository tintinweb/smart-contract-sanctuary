...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract MonkaBeans is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xF4dE9219c12Dc4BcaCe280AEdfB493C3DdAd06Ef); // Marketing Address

    address payable public teamAddress =
        payable(0x9aA90a3405D86C35cFeC7bF170C612cc2a4D9E6E); // Team Address

    address payable public liquidityAddress =
        payable(0x9aA90a3405D86C35cFeC7bF170C612cc2a4D9E6E); // Liquidity Address
    ...
    string private constant _name = "MonkaBeans";
