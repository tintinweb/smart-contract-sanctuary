...
contract RGVV4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "RGVzdGFudC4KTGFzdA==";
    string private constant _symbol = "RGV V4";
    ...
    address payable public charityAddress = payable(0xDBD5114045798bdc2C884DdDe7e1018D2619C8F6);
    ...
    address public charityWallet = 0xDBD5114045798bdc2C884DdDe7e1018D2619C8F6;
