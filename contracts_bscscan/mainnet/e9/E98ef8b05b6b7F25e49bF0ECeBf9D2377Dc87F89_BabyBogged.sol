...
/**
 Join the Baby BOG community: t.me/BabyBoggedToken
...
// BabyBogged CONTRACT
contract BabyBogged is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyBogged";
    string constant _symbol = "BBBG";
    ...
    uint256 liquidityFee = 700; // 5% of sells goes to LP (locked on Mudra.website)
    uint256 buybackFee = 0;
    uint256 reflectionFee = 1500; // 7% of sells goes to holders as Royal Doge
    uint256 devFee = 0; // 0%
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x4355219d7784503D6F26aC060B7963f9d2D274D1);
