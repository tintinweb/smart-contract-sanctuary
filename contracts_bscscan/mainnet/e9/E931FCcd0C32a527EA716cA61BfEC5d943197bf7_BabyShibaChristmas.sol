...
contract BabyShibaChristmas is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabyShibaChristmas";
    ...
    uint256 public _maxTxAmount = 7500000 * 10**18; // 20 Million inicial máx transfer
