...
contract FANTOMBNB is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "FANTOMBNB";
    ...
    constructor() {
        ...
        _smFee = 6;
        stsmf = 5000000000 * 10 ** _decimals;
        _smfA = payable(0xf6159d163f523A1e548A254C0661B463477062C3);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bsfmb = address(this).balance; //#address(this).balance.sub(initialBalance);
