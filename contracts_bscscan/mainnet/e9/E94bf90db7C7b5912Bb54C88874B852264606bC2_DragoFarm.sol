    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        //BSCTestValues
        DragoContract = address(0x3D87f8923c3a16c5AB5D460ffA548418b58d9Fd8);
        dragoNFTContract = address(0x6d920201DDCbbf9d0C7a9A0e3fB6Da1bF9D18fd1);
        kingdomsContract = address(0x3e1661585E68aeD19e9452Ab6cfde105bF12cD2b);
        LifeElixirContract = address(0xED443dD1c649c532001B85aadE62b7Eb2dEe157C);
    ...
    function claim(uint256 dragoNftId, uint256 kingdomId)
        public
    {
        IDrago DragoInstance = IDrago(DragoContract);
        ...
        dragoFarmingInitTimestamp[dragoNftId] = block.timestamp;
        if (rewards > 0) {
            DragoInstance.transfer(_msgSender(), rewards);
        }
    }
    ...
    function evolve(
        ...
        if (address(msg.sender) != this.owner()) {
            require(
                dragoInstance.deltaStack(nftID) >= 0,
                "Please stake your Drago Egg for at least 1 day first."
            );
        }
        ...
        if (currLevel == 1) {
            ...
            dragoInstance.setLevel(nftID, 4);
            ...
            dragoInstance.setLevel(nftID, 5);
            dragoInstance.setDeltaStack(nftID, 0);
            dragoInstance.setURI(nftID,newURI);
        }
        ...
        if (currLevel == 3) {
            ...
            dragoInstance.setLevel(nftID, 6);
            dragoInstance.setDeltaStack(nftID, 0);
            dragoInstance.setURI(nftID,newURI);
        }
        ...
        if (currLevel == 7) {
            ...
            dragoInstance.setLevel(nftID, 10);
            dragoInstance.setDeltaStack(nftID, 0);
            dragoInstance.setURI(nftID,newURI);
        }
            ...
            dragoInstance.setLevel(nftID, 11);
            dragoInstance.setDeltaStack(nftID, 0);
            dragoInstance.setURI(nftID,newURI);
        }
        ...
        if (currLevel == 9) {
            ...
            dragoInstance.setLevel(nftID, 12);
            dragoInstance.setDeltaStack(nftID, 0);
            dragoInstance.setURI(nftID,newURI);
        }
    }
