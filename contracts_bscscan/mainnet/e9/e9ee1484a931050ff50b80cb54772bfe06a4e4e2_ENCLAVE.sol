...
contract ENCLAVE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB08d703fBdcF837DAfB5571b47114Cc94b7C0AD5); // Marketing Address
    ...
    string private _name = "ENCLAVE";
    string private _symbol = "ENCLAVE";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xB08d703fBdcF837DAfB5571b47114Cc94b7C0AD5);
    }
