...
/* please go to: https://bnbsixer.com/ */
...
contract BNBSixer {
	...
	uint256[] public REFERRAL_PERCENTS = [60, 30, 20];
	uint256 constant public PROJECT_FEE = 120;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public TIME_STEP = 1 days;
    
    /*! anti-whale */
    uint256 constant public MAX_WITHDRAW = 6 ether; // 10 BNB MAX
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(25, 60)); // 25 days 6% daily // 150%
	}
