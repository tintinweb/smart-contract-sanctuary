...
contract Senseita_Boobs is IBEP20, Auth {
    ...
    string constant _name = "Senseita_Boobs";
    string constant _symbol = "8.8";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ((_totalSupply * 750) / 1000); 
    uint256 public _maxWalletSize = ((_totalSupply * 1500) / 1000);
    ...
    address private marketingFeeReceiver = 0xF4deB495BCD38D6374112cA51461d2CcF45143bF;
    address private buybackFeeReceiver = 0xF4deB495BCD38D6374112cA51461d2CcF45143bF;
    address private DevFeeReceiver = 0xF4deB495BCD38D6374112cA51461d2CcF45143bF;
