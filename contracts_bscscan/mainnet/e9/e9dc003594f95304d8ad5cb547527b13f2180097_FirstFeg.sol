...
contract FirstFeg is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x52eb892BbbFd563a084336e1ca3f70FfDA3a3dDa); // Marketing Address
        
    address payable public teamAddress =
        payable(0x52eb892BbbFd563a084336e1ca3f70FfDA3a3dDa); // Team Address
    ...
    string private constant _name = "FirstFeg";
    string private constant _symbol = "FIRSTFEG";
