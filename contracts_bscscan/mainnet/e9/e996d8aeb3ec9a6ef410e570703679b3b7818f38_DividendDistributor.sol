...
contract Paviliun is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Paviliun";
    string constant _symbol = "PVUN";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 10**14 * (10 ** _decimals);
    ...
    address public marketingAddress = 0xaa47609A875CF1b895D14A4Bf1096fB22c081311;
