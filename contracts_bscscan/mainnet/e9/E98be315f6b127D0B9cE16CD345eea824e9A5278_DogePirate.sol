...
/**
 * Website: https://dogepirate.finance
 * Telegram : https://t.me/OfficialPirateDOGE
 * Twitter: https://twitter.com/PirateDOGEtoken
 */
...
contract DogePirate is ERC20, Ownable {
    ...
    constructor() ERC20("Doge Pirate", "DOGEPIRATE") {
        _mint(msg.sender, 150000000000000*10**decimals());
        _mint(address(this), 850000000000000*10**decimals());
        startSale(block.number, 999999999, 0,50000000000*10**decimals(), 2000000000000);
