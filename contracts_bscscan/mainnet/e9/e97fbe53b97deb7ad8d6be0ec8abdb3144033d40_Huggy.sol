...
// Begin sauce.
contract Huggy is Context, IERC20, Ownable {
    ...
    string private  _name               = "HuggyStealth";
    string private  _symbol             = "$HuggySt";
    ...
    address payable public _wallet_marketing = payable(0x8F6Eef1Bd290177922Df0a4fe0E9D056C06EcA30);

    // for burn
    uint256 public _fee_burn = 0;
    uint256 private _fee_burn_old = _fee_burn;
    address payable public _wallet_burn = payable(0x8F6Eef1Bd290177922Df0a4fe0E9D056C06EcA30);

    // for buyback
    uint256 public _fee_buyback = 0;
    uint256 private _fee_buyback_old = _fee_buyback;
    address payable public _wallet_buyback = payable(0x8F6Eef1Bd290177922Df0a4fe0E9D056C06EcA30);
