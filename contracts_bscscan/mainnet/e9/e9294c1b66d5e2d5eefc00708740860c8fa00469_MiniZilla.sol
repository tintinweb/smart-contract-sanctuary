...
contract MiniZilla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xf13eac87FbA5D924388B37999D29cb80c8747Edc); // Marketing Address
    ...
    string private _name = "MiniZilla";
    string private _symbol = "MiniZilla";
