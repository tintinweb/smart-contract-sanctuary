...
contract FlokiGang is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Floki Gang";
    string private constant _symbol = "$FGA";
    ...
    address payable constant private _marketingAddress = payable(0x2c7d46295988D2CD1a2F7073dA652E8CD26ed140);
    address payable constant private _buybackAddress = payable(0x2c7d46295988D2CD1a2F7073dA652E8CD26ed140);
    address payable constant private _projectMaintainence = payable(0x2c7d46295988D2CD1a2F7073dA652E8CD26ed140);
    ...
    address public _oraclePriceFeed = 0x2c7d46295988D2CD1a2F7073dA652E8CD26ed140;//rinkeby 0x8A753747A1Fa494EC906cE90E9f37563A8AF630e;// bnb testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;// bnb pricefeed 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE;
    ...
    function getTokenPrice() external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//Floki Gang
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//Floki Gang
