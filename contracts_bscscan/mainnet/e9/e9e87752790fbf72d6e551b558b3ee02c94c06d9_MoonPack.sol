...
Telegaram : https://t.me/moonpackbsc
Website : https://t.me/moonpackbsc
...
contract MoonPack is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MoonPack", "MoonPack") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x157Dc865f0B637856fb11c2bDaF70212033524FA;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "MoonPack: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "MoonPack: The new dividend tracker must be owned by the MoonPack token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("MoonPack_Dividend_Tracker", "MoonPack_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "MoonPack_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "MoonPack_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "MoonPack_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "MoonPack_Dividend_Tracker: Cannot update claimWait to same value");
