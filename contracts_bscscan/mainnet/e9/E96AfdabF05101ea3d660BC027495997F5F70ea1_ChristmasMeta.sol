...
contract ChristmasMeta is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x4dde79E98fbB40B8719e3Ff033a4e025F44Ab0be); // Marketing Address

    address payable public teamAddress =
        payable(0x00000b62fB3D7CAFbFA196637eaB3AfA0bC09c88); // Team Address

    address payable public liquidityAddress =
        payable(0x8d8eCbcd58D13f00bb379B772DbEb616BbFb46b4); // Liquidity Address
    ...
    string private constant _name = "ChristmasMeta";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 100 / 100; // 1% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 2 / 100; // 2% maxWalletToken
