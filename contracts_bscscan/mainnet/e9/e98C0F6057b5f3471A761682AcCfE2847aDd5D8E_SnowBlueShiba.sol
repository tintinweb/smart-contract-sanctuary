...
//Just launched in SnowBlueShiba. We have created a token so rewarding for everyone.
//Pottential Moon
//Lp lock and Renounced
//SnowBlueShiba Hold we will To the moon
//telegram : @SnowBlueShiba
...
contract SnowBlueShiba is Context, IERC20, Ownable {
    ...
    string private _name = "SnowBlueShiba";
    string private _symbol = "SnowBlueShiba";
