...
contract Bremen is Context, IERC20, Ownable {
    ...
    string private constant _name = "Crew2S";
    string private constant _symbol = "C2S";
    ...
    address payable private _marketingAddress = payable(0xB85FcD2a7e8b755642a6fEB82aE9b1e2a30c06ca);
