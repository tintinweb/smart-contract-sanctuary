...
contract WDB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xB77d102BC174fD3675fc5b464466EA02AaCC2fc8); // Marketing Address
    ...
    string private _name = "WDB";
    string private _symbol = "WDB";
