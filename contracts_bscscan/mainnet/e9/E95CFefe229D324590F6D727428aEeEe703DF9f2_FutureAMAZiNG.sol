...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #FutureAMAZiNG  

    I make this #FutureAMAZiNG to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/FutureAMAZiNG
   ...
   I will renounce the ownership to burn addresses to transfer #FutureAMAZiNG to the community, make sure it's 100% safe.

   I will add 0.4 BNB and all the left 49.5% total supply to the pool
   Can you make #FutureAMAZiNG 10000000X? 
   ...
   it's the best part of the #FutureAMAZiNG idea, increasing the liquidity pool automatically, 
...
contract FutureAMAZiNG is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("FutureAMAZiNG", "FutureAMAZiNG") {
