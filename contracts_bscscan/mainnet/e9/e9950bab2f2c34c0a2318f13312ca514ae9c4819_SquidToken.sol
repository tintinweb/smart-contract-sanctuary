    ...
    OwnableUpgradeable
{
    ...
    modifier onlyOwnerOrMinter() {
        require(
            ...
            "Only owner or minter!"
        );
        _;
    }

    function initialize() public initializer {
        __ERC20_init("SQUID Token", "SQUID");
        __Ownable_init();
    ...
    function mint(address _receiver, uint256 amount) public onlyOwnerOrMinter {
        _mint(_receiver, amount * 10**decimals());
    }
}