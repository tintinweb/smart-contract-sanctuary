...
interface IBEP20Sniper is IERC11 {
 ...
 contract PlayGirl is AntiBot, IERC11, IBEP20Sniper {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _binance;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    string private _name = "PlayGirl";
    string private _symbol = "PLAYGIRL";
...
//  https://coinmarketcap.com/currencies/spidey-inu/
    ...
    address private CallAllWhales = 0x846312bCfC78008F022D53F43298CfdCcC8919C2;
