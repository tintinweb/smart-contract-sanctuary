...
contract QueenDoge is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x243F0D8A37b76d8ACe3d7A9BBB9083A5C2a2D5Fc; // Marketing address for Queen Doge

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**3 * 10**9; // 1 trillion
    ...
    // Liquify when 250 million tokens are stored
    uint256 private numTokensSellToAddToLiquidity = 250000 * 10**3 * 10**9;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // of BNB and QueenDoge into the LP
