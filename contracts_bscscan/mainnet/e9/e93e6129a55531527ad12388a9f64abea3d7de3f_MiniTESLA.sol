...
2% tokens dev farming wallet (will not sell)
3% tokens marketing wallet (will not sell)
...
max wallet 3%
max trx 1%
cooldown before second trade is 90 secs 


TG: https://t.me/Mini_Tesla
...
contract MiniTESLA is IBEP20, Auth {
    ...
    string constant _name = "MiniTESLA";
