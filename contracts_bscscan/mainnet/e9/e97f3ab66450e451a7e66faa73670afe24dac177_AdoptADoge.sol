...
contract AdoptADoge is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "AdoptADoge";                                          // name
    string private _symbol = "ADOPTDOGE";                                             // symbol
    uint256 private _tTotal = 1 * 10**9 * 10**uint256(_decimals);          // total supply
    ...
    uint256[] public _liquidityFeeSplit = [35,65];                                       // % division between swap+liquify & wallets
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xF4879e50fe3843DfA7EA7fcEe0095Bc823bfF931),                             // Dev+Team wallet
        payable(0x83A5c9C857BD4fF88517E3ab87F8Bcbc95834A02),                             // Marketing wallet
        payable(0x443221C19DE440af64a2b0c066977221aa395F5A)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xb0c05fC5DEfd75f63F050BbCa836A52866cED0cB, 'We can not exclude Uniswap router.');
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "AdoptADoge is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "AdoptADoge is not live yet");
