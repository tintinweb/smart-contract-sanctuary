...
/*
70% supply burned at start
All holders get reflections
www.terminatortoken.com domain reserved, website incoming 12/3/2021
All kinds of Terminator and Schwarzenegger related NFT's and memes.
5% team
5% marketing
10% goes to 5 early investors who are funding early development. 

https://twitter.com/TerminatorTokenBSC
https://www.facebook.com/TerminatorTokenBSC
https://t.me/TerminatorTokenBSC
*/
...
contract Terminator is Context, IBEP20, Ownable {
    ...
    uint256 private constant _allTotalSupply = 100000000 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Terminator Token';
    string private _symbol = 'TRM';
