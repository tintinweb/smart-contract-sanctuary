...
/*
   ...
   Tokenomics:
   6% fee auto added to the LP every transaction
   2% to Marketing
   4% fee auto distributed to Holders
   
   https://t.me/CosmonautBSC
...
contract Cosmonaut is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000 * 10**9 * 10**9; // Total Supply: 10T
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cosmonaut";
    string private _symbol = "COSMONAUT";
    ...
    uint256 private _marketingPercentageOfLiquidity = 70;
    ...
    uint256 public _maxTxAmount = 25000 * 10**6 * 10**9; // Max Transaction: 25B (0.25%)
    uint256 public _maxWalletToken = 200000 * 10**6 * 10**9; // Max Wallet: 200B (2%)
    uint256 private numTokensSellToAddToLiquidity = 25000 * 10**6 * 10**9; // Liquidity sells 25B (0.25%)
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _maxWalletToken = 10000 * 10**9 * 10**9; // Total Supply: 10T
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 1;
        _liquidityFee = 11;
        _maxTxAmount = 25000 * 10**6 * 10**9;
        _maxWalletToken = 200000 * 10**6 * 10**9; // Max Wallet: 200B (2%)
    }
