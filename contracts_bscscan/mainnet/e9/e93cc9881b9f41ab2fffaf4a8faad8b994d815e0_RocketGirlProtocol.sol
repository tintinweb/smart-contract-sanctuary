...
contract RocketGirlProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE7083c29Cc12fAb111591Efd14E30e8e8D42a121); // Marketing Address
    ...
    string private _name = "RocketGirlProtocol";
    string private _symbol = "RGP";
...
uint256 public _taxFee = 2;
    ...
    uint256 private minimumTokensBeforeSwap = 2000000 * 10**6 * 10**9; 
