...
/**
 DID YOU MISSED SON OF SAFEMOON MOONSHOT? We proudly present you Son Of EVERRISE!
Son Of EverRise is Launching on Binance Smart Chain today with big marketing post launch!

Tokenomics :
1M low supply - 1$ soon!!!
- 5% LP
- 5% Marketing
- 5% Rewards
...
contract SonOfEverrise is Context, IBEP20, Ownable {
    ...
    string public constant name     = "SonOfEverrise";
    string public constant symbol   = "SonOfEverrise";
    uint8  public constant decimals = 18;
    
    // transfer fee
    uint256 public _taxFeeTransfer       = 300;
    uint256 public _liquidityFeeTransfer = 400; 
    uint256 public _marketingFeeTransfer = 300; 

    // buy fee
    uint256 public _taxFeeBuy       = 400; 
    uint256 public _liquidityFeeBuy = 500; 
