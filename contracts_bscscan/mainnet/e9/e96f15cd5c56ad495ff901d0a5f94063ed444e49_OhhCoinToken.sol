...
contract OhhCoinToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x366cEa2578B259683Ad3e1255796291D5163482f); // Marketing Address
    ...
    string private _name = "OhhCoin XXI";
    string private _symbol = "OHHXXI";
    ...
    uint256 public _maxTxAmount = 1000 * 10**2 * 10**9;
    uint256 private minimumTokensBeforeSwap = 200 * 10**2 * 10**9; 
