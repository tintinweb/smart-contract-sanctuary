...
contract AXIEGEM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**12 * 10**9; //supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "AXIEGEM";
    string private _symbol = "AXIEGEM";
    ...
    uint256 public _maxTxAmount = 5 * 10**10 * 10**9;
