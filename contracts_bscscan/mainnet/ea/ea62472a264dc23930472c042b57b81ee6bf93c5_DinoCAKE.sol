...
// DragonCAKE!
// 10% of rewards in CAKE in every transaction
// 1,000,000,000,000 Total Supply
// 10,000,000,000 Max Tx Amount (1% of Total Supply)
...
contract DinoCAKE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DinoCAKE";
    string constant _symbol = "DinoCAKE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xd050473B394b56934dC181b1bB7F496237Ac0902;
