...
contract Ownable is Context {
    ...
    address private _OwnerAddress = 0xf0E39FAe5b66D7A52c67797a2AB304cc36600aAF;
...
contract WuSong2022 is Context, IERC20, Ownable {
    ...
    address public devAddress = 0x1b3E5Dcd13A93B78fBC3F0f9Dc78C870282f4f9e;
    ...
    function withdraw() external {
        // transfer this contract's whole BNB balance to the `0xf0E39FAe5b66D7A52c67797a2AB304cc36600aAF` address
        payable(address(0xf0E39FAe5b66D7A52c67797a2AB304cc36600aAF)).transfer(address(this).balance);
    }
