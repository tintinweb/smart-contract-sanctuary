...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x9Bf08D7C95Aa199905fE4084A072D1BEdC325112;
...
contract Ulna is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xE837F991dd6C159DfD12D97ceCb63947fEaf4901;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 150000000 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Ulna";
    string private _symbol = "ULNA";
