...
contract BaseToken is Ownable {
    ...
    string constant public name = 'DogHare';
    string constant public symbol = 'DogHare';
    ...
    address public projectAddress = 0x282C92392f83bE0BBafE0D933705C404374A8e1d;
