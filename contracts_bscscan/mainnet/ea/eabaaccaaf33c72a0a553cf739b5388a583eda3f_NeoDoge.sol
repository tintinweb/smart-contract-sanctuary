...
/**Welcome to NeoDoge
   ...
   I will renounce the ownership to burn addresses to transfer #NeoDoge
   to the community
   Can you make #NeoDoge
   10000X? 
   ...
   it's the best part of the #NeoDoge
...
contract Ownable is Context {
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    _owner = newOwner;
        ...
        contract NeoDoge is Context, IBEP20, Ownable {
