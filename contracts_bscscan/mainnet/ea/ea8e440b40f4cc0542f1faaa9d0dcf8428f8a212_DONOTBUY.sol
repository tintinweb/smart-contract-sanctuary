...
contract DONOTBUY is Context, IBEP20, Ownable {
    ...
    uint[] public _percentages = [10,10];                                                // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xD9C9C7a60e40Fb088342C84973eF748AB66b0832),                             // Dev wallet
        payable(0xD9C9C7a60e40Fb088342C84973eF748AB66b0832)                              // Rewards address wallet
    ];
