...
// Telegram: https://t.me/RAMENFLOKI
...
contract RAF is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeCast for int256;
  
    string private _name = "Ramen Floki";
    ...
    uint256 public _buyBackFee= 1400;
    ...
    uint256 public initialSellLimit = 1000; 
