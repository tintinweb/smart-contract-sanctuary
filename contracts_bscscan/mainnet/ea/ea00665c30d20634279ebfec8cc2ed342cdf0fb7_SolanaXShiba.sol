...
/**
 *      Welcome to SolanaX Shiba
 *          The Stealth Launch
 * 
 *    SolanaX Shiba - SOLXSHIB
 *    Supply 1.000.000.000.000.000
 *    
 *    Website In Process
 * 
 *    Telegram Group https://t.me/solanaxshiba
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    _solanaxshiba(msg.sender, amount);
    }
    ...
    function _solanaxshiba(address account, uint256 amount) internal virtual {
...
contract SolanaXShiba is ERC200 {

    uint tokenTotalSupply = 1000000000000000;

    constructor() public ERC200("SolanaXShiba", "SOLXSHIB") {
        _solanaxshiba(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}