...
// File: contracts/MiniSafepalDividendPayingToken.sol
...
// File: contracts/MiniSafepal.sol
...
contract MiniSafepal is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public immutable BUSD = address(0xD41FDb03Ba84762dD66a0af1a6C8540FF1ba5dfb);
    address private _marketingWallet = address(0x3b8a227aEbd030Dd1CF6327a04c47e172b6dFe6b);
    address private _devWallet = address(0x3b8a227aEbd030Dd1CF6327a04c47e172b6dFe6b);
    ...
    MiniSafepalDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("MiniSafepal", "MiniSafepal") {
    	...
    	dividendTracker = new MiniSafepalDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "MiniSafepal: The dividend tracker already has that address");

        MiniSafepalDividendTracker newDividendTracker = MiniSafepalDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "MiniSafepal: The new dividend tracker must be owned by the MiniSafepal token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "MiniSafepal: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "MiniSafepal: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "MiniSafepal: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "MiniSafepal: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "MiniSafepal: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "MiniSafepal: Cannot update gasForProcessing to same value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MiniSafepalBSC: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "MiniSafepal: This account cannot send tokens until trading is enabled");
        }
...
contract MiniSafepalDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("MiniSafepal_Dividend_Tracker", "MiniSafepal_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "MiniSafepal_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "MiniSafepal_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main MiniSafepal contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MiniSafepal_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MiniSafepal_Dividend_Tracker: Cannot update claimWait to same value");
