...
contract NETSWAP is Context, ERC20, Ownable {
    ...
    // Address that include in NETSWAP LP list
    mapping(address => bool) private _includeInNETLpList;
    ...
    string private _name = "NETSWAP";
    string private _symbol = "NETSWAP";
    ...
    // Minimum NET sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInNETLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInNETLpList(address _address) public view returns (bool) {
        return _includeInNETLpList[_address];
    }

    function setIncludeInNETLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInNETLpList[_address] = _isIncludedOrNot;
    }
