...
contract DiamondPump is Context, IERC20, Ownable {
    ...
    string private _name = "DiamondPump";
    string private _symbol = "DPUMP";
    uint8 private _decimals = 18;

    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _prizeFee = 50;
    ...
    function updateMinTokenToSellAmount (uint256 _amount)public onlyOwner{
