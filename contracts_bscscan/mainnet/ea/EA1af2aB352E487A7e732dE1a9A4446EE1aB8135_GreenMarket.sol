 ...
 *Submitted for verification at BscScan.com on 2022-01-21
 ...
 t.me/greenmarketbsc
COME JOIN US ON A REVOLUTION WHILE WE MAKE THE RED MARKET GREEN AGAIN
> t.me/greenmarketbsc
...
contract GreenMarket is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GreenMarket";
    string constant _symbol = "WGMI";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 200; // 1%

    uint256 public _maxWalletToken = ( _totalSupply * 6 ) / 200; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8D8B16A8F8ba5aBD80116FCca210c7cF4f47AE1A;
