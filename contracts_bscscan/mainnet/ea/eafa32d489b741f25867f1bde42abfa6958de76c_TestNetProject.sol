...
Website:
Twitter:
Security: LP Locked, Anti-bot, Anti-whale
...
contract TestNetProject is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TestNetProject";
    string constant _symbol = "TNP";
    ...
    constructor () Auth(msg.sender) {
        ...
        // No timelock / Dividend for these people
