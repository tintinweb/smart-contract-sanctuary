...
contract SCANBRAVO is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // Contrato BUSD
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // Contrato WBNB
    address DEAD = 0x9685727f8263B8403EE762F4BFB620Ad3008bBC1; // Endereço de queima
    address ZERO = 0x9685727f8263B8403EE762F4BFB620Ad3008bBC1; // Endereço de queima

    string constant _name = "SCANBRAVO";
    string constant _symbol = "SCAN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 44000000 * (10 ** _decimals); // Supply
    uint256 public _maxTxAmount = _totalSupply / 10; // 2,5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8f01CC459E889F99e975Db66661299ac2c5D4e53; // carteira de pré venda (coloque uma sua mesmo se não tiver pré venda)
