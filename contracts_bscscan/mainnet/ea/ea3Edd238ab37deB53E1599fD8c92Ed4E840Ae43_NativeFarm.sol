...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public constant NATIVE = 0x391E6A3C129b4c850263239dCE413eD0eeE5eDC9;
    // Owner reward per block: 10% ==> 11.11%
    uint256 public constant ownerNATIVEReward = 1111;
    // Native total supply: 1.690420 mil = 1690420e18
    uint256 public constant NATIVEMaxSupply = 1690420e18;
    // Natives per block: (0.107205733 - owner 10%)
    uint256 public constant NATIVEPerBlock = 107205733000000000; // NATIVE tokens created per block
    // Approx 15/7/2021
    uint256 public constant startBlock = 11602229; // https://polygonscan.com/block/16884696
