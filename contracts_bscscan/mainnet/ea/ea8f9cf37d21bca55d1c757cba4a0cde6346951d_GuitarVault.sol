...
// File: contracts\GuitarVault.sol
...
interface IMasterChef {
    ...
    function pendingGuitar(uint256 _pid, address _user) external view returns (uint256);
...
contract GuitarVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingGuitar(0, address(this));
