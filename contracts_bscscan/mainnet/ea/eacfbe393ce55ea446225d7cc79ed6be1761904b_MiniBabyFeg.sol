...
MiniBabyFeg is a BEP20 token on BSC network, Due to its mini size, it was abandoned by its parents. In Search for his parent FEG. 
Help MiniBabyFeg find his parents and earn 10% FEG rewards by holding the token. 
MiniBabgFeg is one of the newest and most attentive Crypto Currencies Solely focus on community and with the goal of creating an awesome community driven token. 
MiniBabyFeg Token is a newly designed decentralized finance (Defi) structured where holders automatically receive reward without staking.E

💎Our Tokenomic💎
🔥10% FEG Rewards to holders
🔥3% Buy Back
🔥4% Marketing
...
contract MiniBabyFeg is Context, IERC20, Ownable {
    ...
    string private _name = "MiniBabyFeg";
    string private _symbol = "MiniBabyFeg";
    uint256 public _taxFee = 18;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 1;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _toHolder = 10;
    ...
    address _marketingWallet = 0xb4A0DeBa95CD14888E6Ff839Fe13F72715126af4;
