...
contract PumpDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDa56561d7d88A6708BB7f5133239da6b58105Afa); // Marketing Address
    ...
    uint256 private _tTotal = 1 * 10**3 * 10**6 * 10**9;
    ...
    uint256 private buyBackUpperLimit = 10000000000000000;
