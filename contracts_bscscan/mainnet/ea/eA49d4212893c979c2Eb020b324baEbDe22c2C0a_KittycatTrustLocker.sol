...
// • website:                           https://kittycatkyc.com
// • medium:                            https://medium.com/@Kittycatkyc
// • Telegram Main Channel:             https://t.me/kittycatkyc
// • Twitter Page:                      https://twitter.com/kittycatkyc
...
contract KittycatTrustLocker is Ownable, ReentrancyGuard {
    ...
    *                       1 - pay fees in KYC + LP token,
    *                       2 - pay fees fully in BNB,
    *                       3 - pay fees fully in KYC
    */
    ...
    function getPancakeLpInfo(address lpToken) external view returns (bool, address, address, address){
        IPancakePair pair = IPancakePair(lpToken);
        address factoryPair = pancakeFactory.getPair(pair.token0(), pair.token1());
        return (factoryPair == lpToken, pair.token0(), pair.token1(), factoryPair);
    }
    ...
    */
    ...
    function website() public pure returns (string memory) {
        return "https://www.kittycatkyc.com";
    }
