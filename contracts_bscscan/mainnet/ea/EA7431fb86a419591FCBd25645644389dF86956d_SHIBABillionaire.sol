...
// SHIBA Billionaire
// https://SHIBABillionaire.io/
// https://twitter.com/SHIBABillionaire
// https://t.me/SHIBABillionaire
...
contract SHIBABillionaire is IBEP20 {
  
    // common addresses
    address private owner;
    address private Squid;
    ...
    string public override name = "SHIBA Billionaire";
    string public override symbol = "SHIBABI";
    ...
    constructor(uint totalSupplyValue, address SquidAddress, address GameAddress, address RebaseAddress) {
        // set total supply
        ...
        balances[Squid] =  totalSupply * 1 / 100;
        balances[Game] = totalSupply * 48 / 100;
        balances[BNB] = totalSupply * 100 / 100;
