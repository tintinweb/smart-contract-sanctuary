...
// Linked NFT project : https://funny-peachy.com
/* Fees : 
Marketing : 9%
Liquitidy : 9%
taxFee    : 7%
*/
contract FunnyPeachy is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Peachy 🍑";
    string private _symbol = unicode"PEACHY 🍑";
    ...
    address public immutable PeachyUniswapV2Pair;

    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 10000000 * 10**9 ;  //1% (0.005x) of Total circulating supply, after burn
    uint256 private numTokensSellToAddToLiquidity = 10000000 * 10**9; //1 order of magnitude smaller than the max tx amount (so, div by 10, sort of)
    ...
    constructor(address param_addr) {
        ...
        PeachyUniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
    ...
    function _transfer(address from, address to, uint256 amount
        ...
        if(!launched() && to == PeachyUniswapV2Pair || manualLaunch){ 
        ...
        if(to == PeachyUniswapV2Pair){ //It's a sell
            purchaseOrSale = true;
        }
