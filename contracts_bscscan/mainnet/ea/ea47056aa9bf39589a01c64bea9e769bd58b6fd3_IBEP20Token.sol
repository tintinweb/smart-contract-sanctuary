...
interface IBEP20 {
  ...
  */
  ...
  /**
   * @dev Returns the ibep token owner.
   */
...
contract IBEP20Token is Context, IBEP20, Ownable {
  ...
  */
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    _approve(account, _msgSender(), _allowances[account][_msgSender()].sub(amount, "IBEP20: burn amount exceeds allowance"));
  }
}