...
contract Master is Ownable {
    ...
    // Market oracle provides the baby/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _baby) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = baby.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && baby.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(baby.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return baby.totalSupply().toInt256Safe()
