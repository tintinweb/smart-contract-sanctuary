...
contract MetaverserNFT is IMarketplaceAssets,ERC721URIStorage,ERC721Enumerable,Ownable,ERC721Holder {
    ...
    constructor() ERC721("Metaverset Open World", "MOW") { 
...
contract MarketplaceAssets is IMarketplaceAssets,Ownable,ERC721Holder {
   ...
   modifier notPause() {
    ...
    function synctContractData() private {
        uint256 _to = MetaverserNFT(nftContract).totalSupply();
        totalSupply = _to;
        ...
        emit synctContractDataEvent(msg.sender,nftContract,_to) ;   
