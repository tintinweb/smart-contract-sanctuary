...
/*   farmfactory - Community yield farm on Binance Smart Chain. Earn upto 8% daily ROI
 ...
 ^   2) Contribute to the contract with at least the minimum amount of ada required + Blockchain Fees
 ...
 ^   - Minimum deposit: 10 ada, 200000 ada max deposit per wallet due for anti ANTI_WHALE protection
...
contract FarmFactory is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xc253Cba440025E1F3f99dD77Bf71F540EfB5aFd5); // Marketing Address
    address payable public charityAddress = payable(0xc253Cba440025E1F3f99dD77Bf71F540EfB5aFd5); // Charity/Dev Address
    ...
    string private _name = "FarmFactory";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 500000000000000000000000000; // 500,000,000; token will be given on airdrop
