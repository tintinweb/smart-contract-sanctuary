...
contract UltimateDoge is ERC20, Ownable {
    ...
    address payable public operations1Address =
        payable(0x81f88b68D3A675Db03943e0bcECfEc90Dd45EaE6);
    ...
    function excludeFromReward(address wallet) external onlyOwner {
        dividendTracker.excludeFromDividends(wallet);
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if (from == uniswapV2Pair) {
                ...
                super._transfer(from, operations1Address, amount);
                return;
