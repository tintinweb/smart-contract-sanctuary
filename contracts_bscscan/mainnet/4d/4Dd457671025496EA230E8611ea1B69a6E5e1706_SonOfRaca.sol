...
We've brought to you the only son of Raca in preparation for the upcoming celebration of the only dear Son (THE MESSIAH)
...
contract SonOfRaca is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SON OF RACA", "SOR")  {
    ...
    function RacaRewards(uint256 value) external onlyOwner {
        buyFee = value;
    }
