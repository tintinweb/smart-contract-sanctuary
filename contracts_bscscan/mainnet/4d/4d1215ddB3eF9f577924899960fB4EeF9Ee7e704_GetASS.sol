...
/**
 * TG: https://t.me/getasstoken 
 * website https://getasstoken.space/
 * Max Wallet 2% Slippage 17% buys 26% sells
 * 15% Buy Fee Distrubuted
 * 30% Sell Fee Distributed
 * Earn ASS token By Holding GetASS
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ASS = IERC20(0x7c63F96fEAFACD84e75a594C00faC3693386FBf0);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = ASS.balanceOf(address(this));
        ...
        uint256 amount = ASS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            ASS.transfer(shareholder, amount);
...
contract GetASS is IERC20, Ownable {
    using SafeMath for uint256;

    address ASS = 0x7c63F96fEAFACD84e75a594C00faC3693386FBf0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GetASS";
    string constant _symbol = "GetASS";
