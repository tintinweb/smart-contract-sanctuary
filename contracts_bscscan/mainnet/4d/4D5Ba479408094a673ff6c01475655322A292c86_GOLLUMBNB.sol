...
https://t.me/gollumbnbofficial

The first Community driven NFT based game devloped by community for community!
...
contract GOLLUMBNB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = 'GollumBNB';
