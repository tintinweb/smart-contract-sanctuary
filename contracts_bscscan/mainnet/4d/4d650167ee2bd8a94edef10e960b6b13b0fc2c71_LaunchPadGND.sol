...
contract Sale is Context, ReentrancyGuard {
    ...
    constructor (uint256 rate, address payable wallet, IERC20 token,uint256 _bonusMultiplier, uint256 _tokensUnlockingTime, uint256 _tokensUnlockingTime2) public {
        require(rate > 0);
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(weiAmount >= 5000000000000000, "Min. amount is 0.005 bnb"); /** min bnb */
        require(weiAmount <= 350000000000000000, "Max. amount is 0.350 bnb"); /** max bnb */
        require(_contributions[beneficiary].add(weiAmount) <= 350000000000000000, "Cap exceeded");
        this;                
    }
...
contract PostDelivery is Timed{
     ...
     */
    function _processPurchase(address beneficiary, uint256 tokenAmount) internal {
        uint256 vest = tokenAmount.mul(45).div(100);
        uint256 vest2 = tokenAmount.mul(55).div(100);
...
contract LaunchPadGND is Sale, TokenRecover, PostDelivery{
    ...
    constructor(
        ...
        Sale(rate, wallet, token, _bonusMultiplier, tokensUnlockingTime, tokensUnlockingTime2)
        public
    { }
}