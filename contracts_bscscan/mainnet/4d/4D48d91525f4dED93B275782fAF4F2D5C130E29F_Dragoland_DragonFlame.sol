...
contract Dragoland_DragonFlame is
    Initializable,
    ERC20Upgradeable,
    PausableUpgradeable,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC20_init("Dragoland_DragonFlame", "Dragoland_DragonFlame");
        __Pausable_init();
        __Ownable_init();
    ...
    function setup() public onlyOwner {
        ...
        collateral = address(0x70D542e94a70081a15a555eCFA1Ba4BFB9217FBb);
        _mint(msg.sender, 1 * 10**decimals());

        //A-Play2Earn Rewards Ecosystem
        feeMap[1].receiver = 0x70D542e94a70081a15a555eCFA1Ba4BFB9217FBb; //To Rewards Ecosystem Contract
        feeMap[1].fee = 50;
